...
void func_1(int iParam0)//Position - 0x316
{
	...
	if (Global_114135.f_9089 || func_9(0))
	{
		iVar0 = func_8();
		if (!func_2(iVar0))
		{
...
int func_2(int iParam0)//Position - 0x35B
{
	...
	func_3(&(Global_114135.f_2367.f_539), iVar1);
...
void func_3(var uParam0, int iParam1)//Position - 0x46B
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_5(Global_114135.f_18537[iVar0], &Var2, &fVar5))
			{
...
void func_11(bool bParam0, int iParam1)//Position - 0x1140
{
	...
	if (bParam0)
	{
		if ((func_9(0) && Global_79786.f_1 == 1) && func_12(Global_79786))
		{
		}
		else
		{
...
void func_50()//Position - 0x25B9
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_53(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_51(iVar0) && (!func_43(14) || Global_113083))
			{
...
int func_75(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x2A9A
{
	...
	{
		StringCopy(&(Global_22684[iVar0 /*6*/]), (*uParam2)[iVar0], 24);
		StringCopy(&(Global_23046[iVar0 /*6*/]), (*uParam3)[iVar0], 24);
		iVar0++;
	}
	...
	{
		StringCopy(&(Global_22865[iVar1 /*6*/]), (*uParam4)[iVar1], 24);
		StringCopy(&(Global_23227[iVar1 /*6*/]), (*uParam5)[iVar1], 24);
		iVar1++;
	}
	return 1;
}
...
bool func_76(int iParam0, var uParam1, int iParam2, char* sParam3, var uParam4, var uParam5, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11)//Position - 0x2B2C
{
	...
	func_85(iParam0);
	Global_22477 = 1;
	StringCopy(&Global_22573, sParam6, 24);
	Global_22424 = 3;
...
struct<4> func_94(var uParam0, var uParam1, int iParam2, bool bParam3)//Position - 0x385E
{
	...
	if (bParam3)
	{
		func_95(&(Global_114135.f_19965), iVar4, 1);
	}
...
struct<4> func_105(int iParam0, int iParam1, bool bParam2, var uParam3)//Position - 0x3DEE
{
	...
	if ((((!func_110(&(Global_114135.f_19965), 8) && iParam1) && iParam0 != 4) && func_108(3) > 0) && MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.75f)
	{
		bVar4 = 8;
		*uParam3 = 4;
	}
	else
	{
		...
		if (!func_110(&(Global_114135.f_19965), 3) && ((((func_108(8) > 0 || func_108(9) > 0) && func_108(7) > 0) && iParam1) && iParam0 != 4))
		{
		...
		if (((!func_110(&(Global_114135.f_19965), 8) && iParam1) && func_108(3) > 0) && iParam0 != 4)
		{
	...
	if (bParam2)
	{
		func_106(&(Global_114135.f_19965), bVar4, 1);
	}
...
{
	if (Global_98124 != 0 && (MISC::GET_GAME_TIMER() - Global_98124) < 1800000)
	{
		return 0;
	}
	HUD::REQUEST_ADDITIONAL_TEXT("SHRINK", 0);
	...
	func_122(uParam0, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	func_122(uParam0, 1, 0, "FRIEDLANDER", 0, 1);
	Global_98124 = MISC::GET_GAME_TIMER();
	return 1;
}
...
int func_126(var uParam0, var uParam1, var uParam2)//Position - 0x4B5A
{
	...
	iVar0 = func_128(&(Global_114135.f_19965));
	switch (iVar0)
	{
		case 0:
