...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_78 = func_441(60);
	uLocal_79 = func_441(14);
	...
	iLocal_92 = func_407();
	iLocal_93 = func_406(1855.08f, 4755.85f, 36.81f, 25f);
	...
	if (func_417())
	{
		if (func_379() == 0)
		{
			func_378(Local_83, fLocal_84, 1, 0);
			func_377(1);
			func_376(&Local_81, 0, 1);
			func_375();
	...
	while (true)
	{
		...
		func_352(Local_81.f_9, 0, 0, 0, 0, 0);
		...
		{
			if (func_349(PLAYER::PLAYER_PED_ID()) == iLocal_89)
			{
...
void func_11()//Position - 0x651
{
	...
	while (func_349(PLAYER::PLAYER_PED_ID()) == iLocal_89)
	{
		SYSTEM::WAIT(0);
		HUD::HIDE_HUD_COMPONENT_THIS_FRAME(2);
...
int func_13(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x7C1
{
	...
	else
	{
		...
		iVar2 = 0;
		func_19(&iVar2);
		iVar3 = func_18(Var1, Global_113648.f_7690.f_765[iVar2 /*10*/]);
		if (iVar3 == 2)
		{
			func_16(Global_113648.f_7690.f_765[iVar2 /*10*/]);
		...
		else if (iVar3 == 1)
		{
			...
			{
				if (!func_14(Global_113648.f_7690.f_765[iVar2 /*10*/]))
				{
					Global_113648.f_7690.f_765[iVar2 /*10*/] = { Var1 };
					func_15(&Var1);
					return 1;
...
int func_14(struct<9> Param0, var uParam1)//Position - 0x9E0
{
	if (Param0.f_8 == 0)
	{
		return 0;
...
int func_18(struct<4> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, struct<4> Param7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13)//Position - 0xA64
{
	int iVar0;
	int iVar1;
...
void func_232()//Position - 0x277D5
{
	switch (Local_434.f_1)
	{
		...
		case 1:
			...
			else if (func_234(Local_298[0 /*8*/]))
			{
				if (func_233(PLAYER::PLAYER_PED_ID(), Local_298[0 /*8*/], 1) >= 50f)
				{
...
int func_239(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0x27C71
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	{
		Var1 = { func_241(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_240(Var1, Var0);
...
float func_240(struct<3> Param0, struct<3> Param1)//Position - 0x27CFF
{
...
void func_243()//Position - 0x27D6E
{
	...
	if (Local_434.f_1 == 0)
	{
		func_295("Doing setup for RockScene:", iLocal_283);
		func_293(1);
		func_292();
		...
		if (func_350(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (iLocal_283 == 0)
			{
				...
				if (func_234(Local_301.f_0))
				{
					iLocal_303 = func_274(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_DIGISCANNER"), 1, 0, 0, 0, 0, 0, 0);
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_303, "Artefact_Detector", 0, 0, 0);
				}
				if (func_234(Local_293[iLocal_283 /*43*/].f_1))
				{
			...
			func_265(Local_293[iLocal_283 /*43*/].f_25, Local_293[iLocal_283 /*43*/].f_28, Local_293[iLocal_283 /*43*/].f_31, Local_293[iLocal_283 /*43*/].f_32, Local_293[iLocal_283 /*43*/].f_35, func_273(), 1, 1, 1, 0, 0);
			func_260(Local_293[iLocal_283 /*43*/].f_2, 1, 0, 1, 1, 1, 1, 0, 1, 1, 1);
		}
		func_295("Finished setup, moving to run loop for RockScene #:", iLocal_283);
		Local_434.f_1 = 1;
	}
	if (Local_434.f_1 == 1)
	{
		...
		else
		{
			...
			if (Local_434.f_2 == -1)
			{
				...
				Local_434.f_1 = 3;
				iLocal_283++;
				func_295("END CUTSCENE: iCurrentRock = ", iLocal_283);
			}
		}
	}
	if (Local_434.f_1 == 3)
...
void func_255()//Position - 0x288F3
{
	if (func_234(Local_298[1 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Jimmy_Boston", 0))
		{
			if (iLocal_283 >= 2)
			{
				if (func_234(Local_81.f_28[1]) && func_291(iLocal_292))
				{
...
void func_256()//Position - 0x289AF
{
	if (func_234(Local_298[0 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Marnie", 0))
		{
			if (iLocal_283 >= 2)
			{
				if (func_234(Local_81.f_28[0]) && func_291(iLocal_292))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_435);
...
void func_260(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x28C44
{
	int iVar0;
...
void func_265(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x28EA9
{
	func_266(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_266(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x28ED3
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_270(iVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_270(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x29439
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_271(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_271(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_271(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_271(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_271(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_271(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_271(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_271(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_271(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_271(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_271(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_271(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_271(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_271(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_271(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_271(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4))
		{
			return 1;
		}
	}
...
int func_271(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x2972F
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_274(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2985F
{
	...
	while (func_278(iVar2, iVar6) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_278(iVar2, iVar6)))
			{
				if (func_277(func_278(iVar2, iVar6)))
				{
					iVar7 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_278(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_278(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
		{
			...
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iVar1, func_278(iVar2, iVar8));
				func_275(iVar1, func_278(iVar2, iVar8));
			}
		}
		iVar8++;
	}
...
void func_298(int iParam0, var uParam1, int iParam2)//Position - 0x2B1E4
{
	...
	while (iVar0 < 12)
	{
		...
		{
			if (func_59(iVar4, func_99(iVar0), func_83(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_99(iVar0)), &iVar1))
			{
				Var3 = { func_101(iVar4, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
				iVar5 = 1;
			}
			if (func_66(iVar4, func_99(iVar0), func_83(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_99(iVar0)), &iVar1))
			{
				Var3 = { func_101(iVar4, 1, uParam1->f_62, -1) };
...
void func_306()//Position - 0x2BE5C
{
	...
	if (Local_434.f_1 == 0)
	{
		func_295("Doing setup for FindRock section:", iLocal_283);
		...
		func_333(&uLocal_98, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		func_333(&uLocal_98, 5, Local_298[1 /*8*/], "JIMMYBOSTON", 0, 1);
		func_333(&uLocal_98, 4, Local_298[0 /*8*/], "MARNIE", 0, 1);
		if (iLocal_283 == 0)
		{
		...
		func_295("Finished setup, moving to run loop for rock #:", iLocal_283);
		Local_434.f_1 = 1;
	}
	if (Local_434.f_1 == 1)
	{
		...
		else if (!func_331(&uLocal_356, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
		{
			func_242(6);
			Local_434.f_9 = 8;
			Local_434.f_1 = 3;
		...
		else
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Local_293[iLocal_283 /*43*/].f_1))
			{
				if (iLocal_283 == 0)
				{
					if (func_233(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_1, 1) < 100f)
					{
						if (!CUTSCENE::HAS_CUTSCENE_LOADED())
						{
					...
					else if (func_233(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_1, 1) > 120f)
					{
						if (CUTSCENE::HAS_CUTSCENE_LOADED())
						{
				...
				else if (func_233(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_1, 1) < 100f)
				{
					if (!CUTSCENE::HAS_CUTSCENE_LOADED())
					{
			...
			{
				func_325(&iLocal_94);
				if (!func_331(&uLocal_304, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
				{
					iLocal_269 = 0;
					AUDIO::STOP_SCRIPTED_CONVERSATION(false);
					HUD::CLEAR_PRINTS();
				...
				{
					if (MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_36, sLocal_91) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_36, 7, 0, 0, 0))
					{
						if (!MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_36, sLocal_91))
						{
							if (func_234(iLocal_291))
							{
				...
				{
					if (!func_285() && (MISC::GET_GAME_TIMER() - iLocal_288) >= 7500)
					{
						if ((MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_37, sLocal_91) || !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_291, 30f, 30f, 30f, false, true, 0)) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_37, 7, 0, 0, 0))
						{
				...
				else if (iLocal_268 == 0 && !func_309(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_2, 9f, 1))
				{
					if (func_309(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_2, 20f, 1))
					{
						if (!iLocal_273)
						{
							if (!func_285())
							{
								if (func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_42, 7, 0, 0, 0))
								{
									if (func_234(iLocal_291))
									{
										TASK::TASK_LOOK_AT_ENTITY(iLocal_291, PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
					...
					{
						if (func_308(PLAYER::PLAYER_PED_ID(), iLocal_291, 30f, 1) || iLocal_283 == 2)
						{
							if (!func_285() && (MISC::GET_GAME_TIMER() - iLocal_286) > 15000)
							{
								if (bLocal_266)
								{
									if (iLocal_282 == 0)
									{
										...
										{
											if (MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_40, sLocal_91) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_40, 7, 0, 0, 0))
											{
												if (func_350(iLocal_291))
												{
									...
									{
										if (MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_40, sLocal_91) || func_311(&uLocal_98, "EPS4AUD", "EPS4_HASSIG", 7, 0, 0, 0))
										{
											iLocal_286 = MISC::GET_GAME_TIMER();
											iLocal_414++;
										}
								...
								{
									if (MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_41, sLocal_91) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_41, 7, 0, 0, 0))
									{
										if (func_350(iLocal_291))
										{
											TASK::TASK_LOOK_AT_ENTITY(iLocal_291, PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
				...
				if (iLocal_283 == 0)
				{
					if (iLocal_415 < 5)
					{
						if (((MISC::GET_GAME_TIMER() - iLocal_417) > 7500 && !func_285()) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (func_234(Local_298[0 /*8*/]))
							{
								if (func_233(Local_298[0 /*8*/], PLAYER::PLAYER_PED_ID(), 1) < 4f)
								{
									if (func_311(&uLocal_98, "EPS4AUD", "EPS4_NEARM", 6, 0, 0, 0))
									{
										iLocal_415++;
										iLocal_417 = MISC::GET_GAME_TIMER();
									}
				...
				else if (iLocal_283 == 1)
				{
					if (iLocal_415 < 4)
					{
						if (((MISC::GET_GAME_TIMER() - iLocal_417) > 7500 && !func_285()) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (func_234(Local_298[1 /*8*/]))
							{
								if (func_233(Local_298[1 /*8*/], PLAYER::PLAYER_PED_ID(), 1) < 4f)
								{
									if (func_311(&uLocal_98, "EPS4AUD", "EPS4_NEARJ", 6, 0, 0, 0))
									{
										iLocal_415++;
										iLocal_417 = MISC::GET_GAME_TIMER();
									}
					...
					if (iLocal_415 < 3)
					{
						if (((MISC::GET_GAME_TIMER() - iLocal_417) > 7500 && !func_285()) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (func_234(Local_298[1 /*8*/]))
							{
								if (func_233(Local_298[1 /*8*/], PLAYER::PLAYER_PED_ID(), 1) < 4f)
								{
									if (func_311(&uLocal_98, "EPS4AUD", "EPS4_NEARJP", 6, 0, 0, 0))
									{
										iLocal_415++;
										iLocal_417 = MISC::GET_GAME_TIMER();
									}
					...
					if (iLocal_416 < 4)
					{
						if (((MISC::GET_GAME_TIMER() - iLocal_417) > 7500 && !func_285()) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (func_234(Local_298[0 /*8*/]))
							{
								if (func_233(Local_298[0 /*8*/], PLAYER::PLAYER_PED_ID(), 1) < 4f)
								{
									if (func_311(&uLocal_98, "EPS4AUD", "EPS4_NEARMP", 6, 0, 0, 0))
									{
										iLocal_416++;
										iLocal_417 = MISC::GET_GAME_TIMER();
									}
				...
				else if (!func_309(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_2, (9f + 2f), 1))
				{
					iLocal_267 = 0;
				}
			}
			else
			{
				...
				{
					iLocal_94 = func_307(Local_82, 5, 0);
				}
				bLocal_266 = Local_301.f_1;
				if (func_331(&uLocal_304, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
				{
				...
				else if (iLocal_274 == 0)
				{
					if (iLocal_283 < 2)
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_291, 30f, 30f, 30f, false, true, 0))
						{
							...
							{
								if (MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_38, sLocal_91) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_38, 7, 0, 0, 0))
								{
									iLocal_274 = 1;
								}
							}
				...
				else if (iLocal_275 == 0)
				{
					if (iLocal_283 < 2)
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_291, 30f, 30f, 30f, false, true, 0))
						{
							if ((!func_285() && (MISC::GET_GAME_TIMER() - iLocal_288) >= 7500) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
							{
								if (MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_39, sLocal_91) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_39, 7, 0, 0, 0))
								{
									iLocal_275 = 1;
								}
							}
					...
					else if ((!func_285() && (MISC::GET_GAME_TIMER() - iLocal_288) >= 7500) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
						if (MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_39, sLocal_91) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_39, 7, 0, 0, 0))
						{
							iLocal_275 = 1;
...
int func_307(struct<3> Param0, int iParam1, bool bParam2)//Position - 0x2D1E9
{
	int iVar0;
...
bool func_309(int iParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x2D239
{
	...
	switch (uParam0->f_1)
	{
		...
		case 4:
			...
			else if (uParam0->f_2 == 1)
			{
					...
					if (!iLocal_280)
					{
						if ((MISC::GET_GAME_TIMER() - iLocal_418) > 6000)
						{
							...
							if (!func_285() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
							{
								if (*uParam0 == Local_298[1 /*8*/])
								{
									func_311(&uLocal_98, "EPS4AUD", "EPS4_DAWDJ", 7, 0, 0, 0);
								}
								else
								{
									func_311(&uLocal_98, "EPS4AUD", "EPS4_DAWDM", 7, 0, 0, 0);
								}
							}
							iLocal_280 = 1;
						}
				...
				{
					if ((((MISC::GET_GAME_TIMER() - iLocal_419) > 7500 && !func_285()) && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && !iLocal_267)
					{
						if (*uParam0 == Local_298[1 /*8*/])
						{
							if (func_311(&uLocal_98, "EPS4AUD", "EPS4_MESSJ", 7, 0, 0, 0))
							{
								iLocal_419 = MISC::GET_GAME_TIMER();
							}
						}
						else if (func_311(&uLocal_98, "EPS4AUD", "EPS4_MESSM", 7, 0, 0, 0))
						{
							iLocal_419 = MISC::GET_GAME_TIMER();
						}
					}
				...
				{
					if ((((iLocal_420 < 4 && !func_285()) && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && !iLocal_267) && !func_351())
					{
						if (*uParam0 == Local_298[1 /*8*/])
						{
							if (func_311(&uLocal_98, "EPS4AUD", "EPS4_PROMPTJ", 7, 0, 0, 0))
							{
								iLocal_421 = MISC::GET_GAME_TIMER();
								iLocal_420++;
							}
						}
						else if (func_311(&uLocal_98, "EPS4AUD", "EPS4_PROMPTM", 7, 0, 0, 0))
						{
							iLocal_421 = MISC::GET_GAME_TIMER();
							iLocal_420++;
						}
		...
		else if (func_350(iLocal_300))
		{
			if (TASK::IS_PED_GETTING_UP(iLocal_300) || PED::IS_PED_ON_FOOT(iLocal_300))
			{
				if (!func_285() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
					...
					{
						if (func_311(&uLocal_98, "EPS4AUD", "EPS4_JKNOCK", 7, 0, 0, 0))
						{
							iLocal_299 = 0;
							iLocal_300 = 0;
						}
					}
					else if (func_311(&uLocal_98, "EPS4AUD", "EPS4_MKNOCK", 7, 0, 0, 0))
					{
						iLocal_299 = 0;
						iLocal_300 = 0;
					}
...
bool func_331(var uParam0, struct<2> Param1, Vector3 vParam2)//Position - 0x2E6CF
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_343()//Position - 0x2EB81
{
	...
	if (Local_434.f_1 == 0)
	{
		...
		if (func_281(1, 1093140480, 0))
		{
			...
			if (func_350(Local_81.f_28[1]))
			{
				ENTITY::FREEZE_ENTITY_POSITION(Local_81.f_28[1], false);
				if (func_234(WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(Local_81.f_28[1], 1)))
				{
					iLocal_303 = func_274(Local_81.f_28[1], joaat("WEAPON_DIGISCANNER"), 1, 0, 0, 0, 0, 0, 0);
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_303, "Artefact_Detector", 0, 0, 0);
				}
...
int func_346(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)//Position - 0x2EFFA
{
	bool bVar0;
	float fVar1;
...
void func_348()//Position - 0x2F076
{
	...
	if (Local_434.f_1 == 0)
	{
		...
		if (!func_416(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.6212f, 4698.7344f, 41.36862f, 1831.1576f, 4680.1914f, 32.426258f, 16.5f, false, true, 0))
		{
			...
			func_333(&uLocal_98, 4, Local_81.f_28[0], "MARNIE", 0, 1);
			if (func_340())
			{
				Local_434.f_1 = 1;
			}
	...
	if (Local_434.f_1 == 1)
	{
		...
		if (!func_416(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.6212f, 4698.7344f, 41.36862f, 1831.1576f, 4680.1914f, 32.426258f, 16.5f, false, true, 0))
		{
			if (func_233(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 1) >= 3f)
			{
				if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
				{
					if (!iLocal_263)
					{
						if (func_234(Local_81.f_28[0]))
						{
			...
			if (!iLocal_264)
			{
				if (func_350(Local_81.f_28[0]) && !func_285())
				{
			...
			else if (func_350(Local_81.f_28[0]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 3))
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.25f)
					{
						if (!iLocal_265)
						{
							if (func_311(&uLocal_98, "EPS4AUD", "ESP4_RCL", 8, 0, 0, 0))
							{
					...
					if (func_233(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 1) <= 1.5f)
					{
						PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
						TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					}
...
void func_352(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2F463
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_354(Global_78814, Global_78816, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_355(iVar1), 8);
					break;
			}
			break;
...
void func_378(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x3038F
{
	if (func_417())
	{
...
int func_380(var uParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4)//Position - 0x3044E
{
	if (iParam3 != 0)
	{
		*uParam0 = iParam3;
...
void func_385()//Position - 0x30639
{
	...
	func_389(&uLocal_304);
	func_388(&uLocal_304, 1897.42f, 4596.51f, 36.4f);
	func_388(&uLocal_304, 1912.2f, 4676.93f, 39.44f);
	func_388(&uLocal_304, 1886.09f, 4733.68f, 39.48f);
	func_388(&uLocal_304, 1800.24f, 4820.64f, 40.96f);
	func_388(&uLocal_304, 1796.556f, 4893.541f, 40.4741f);
	func_388(&uLocal_304, 1782.6514f, 4916.3325f, 41.4418f);
	func_388(&uLocal_304, 1746.5521f, 4942.362f, 42.8677f);
	func_388(&uLocal_304, 1702.5366f, 4893.8237f, 36.7751f);
	func_388(&uLocal_304, 1707.2734f, 4814.8096f, 40.9407f);
	func_388(&uLocal_304, 1729.46f, 4655.21f, 42.61f);
	func_388(&uLocal_304, 1772.0504f, 4602.1426f, 36.457f);
	func_387(&uLocal_304);
	func_386(&uLocal_356, &uLocal_304, 20f);
}
...
void func_386(var uParam0, var uParam1, float fParam2)//Position - 0x30B13
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_331(uParam1, *(uParam1[iVar1 /*3*/]) + Var5))
		{
			Var5 = { -Var5 };
		}
...
int func_390(struct<3> Param0, float fParam1, int iParam2)//Position - 0x30D18
{
	int iVar0;
...
void func_397(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x30E71
{
	int iVar0;
...
void func_398(struct<3> Param0, float fParam1)//Position - 0x30EAF
{
	int iVar0;
...
void func_400(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x30F02
{
	int iVar0;
...
void func_401(int iParam0, struct<3> Param1, struct<3> Param2)//Position - 0x30F40
{
	int iVar0;
...
int func_406(struct<3> Param0, float fParam1)//Position - 0x31089
{
	struct<3> Var0;
...
int func_409(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0x31316
{
	if (func_410(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_410(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0x31372
{
	int iVar0;
...
void func_418()//Position - 0x3154E
{
	...
	if (func_234(Local_298[0 /*8*/]) && func_234(Local_298[1 /*8*/]))
	{
	...
	func_419(&(Local_298[0 /*8*/]), 1, 1, 1);
	func_419(&(Local_298[1 /*8*/]), 1, 1, 1);
...
int func_423(char* sParam0, int iParam1, int iParam2)//Position - 0x3184B
{
	...
	if (func_429())
	{
		...
		{
			iVar2 = func_424(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
