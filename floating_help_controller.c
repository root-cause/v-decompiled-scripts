		...
		if (Global_112300[iVar0 /*28*/].f_21 != 0)
		{
			...
			else if (func_3(iVar0))
			{
				if (Global_112300[iVar0 /*28*/].f_21 != -1)
				{
					...
					{
						Global_112300[iVar0 /*28*/].f_21 = (Global_112300[iVar0 /*28*/].f_21 + SYSTEM::ROUND((MISC::GET_FRAME_TIME() * 1000f)));
				...
				if (Global_112300[iVar0 /*28*/].f_24.f_2 != 9999f)
				{
					...
					{
						if (!ENTITY::IS_ENTITY_DEAD(Global_112300[iVar0 /*28*/].f_23, false))
						{
			...
			else if ((MISC::GET_GAME_TIMER() - Global_112300[iVar0 /*28*/].f_22) > 1000)
			{
				func_2(iVar0);
			}
		}
