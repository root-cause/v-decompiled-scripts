...
bool func_19(int iParam0)//Position - 0x174B
{
	return iParam0 < 3;
}

int func_20(int iParam0)//Position - 0x1757
{
	int iVar0;
	int iVar1;
...
int func_21(int iParam0)//Position - 0x1794
{
	if (func_19(iParam0))
	{
...
var func_22(int iParam0)//Position - 0x17B9
{
...
bool func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B4B
{
...
var func_38(int iParam0, int iParam1)//Position - 0x1F11
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_39()//Position - 0x1F29
{
	return -1;
}
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21E7
{
...
void func_48(char[4] cParam0)//Position - 0x223D
{
	int iVar0;
...
void func_49(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2278
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_51(var uParam0)//Position - 0x234B
{
}

void func_52(var uParam0, int iParam1, float fParam2)//Position - 0x2353
{
}
...
void func_55(var uParam0)//Position - 0x23E0
{
}

void func_56(char* sParam0)//Position - 0x23E8
{
...
void func_70(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x26A3
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x298C
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0)//Position - 0x2AD2
{
	if (func_77(iParam0))
	{
...
int func_76(int iParam0)//Position - 0x2AF6
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x2B26
{
...
void func_79(int* iParam0)//Position - 0x2C0E
{
	if (iLocal_445 == 1)
	{
...
void func_80(int* iParam0, int iParam1, bool bParam2)//Position - 0x2C2D
{
	if (iLocal_445 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_81(int iParam0, bool bParam1, int iParam2)//Position - 0x2C80
{
	int iVar0;
...
int func_82(int iParam0, bool bParam1, bool bParam2)//Position - 0x2CCA
{
	int iVar0;
...
float func_83(bool bParam0, float fParam1, float fParam2)//Position - 0x2D6E
{
	if (bParam0)
	{
		return fParam1;
...
float func_84(int iParam0, int iParam1, bool bParam2)//Position - 0x2D85
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_85(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2DE3
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_86(struct<3> Param0, struct<3> Param3)//Position - 0x2E74
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_87(struct<3> Param0)//Position - 0x2E95
{
	float fVar0;
	float fVar1;
...
int func_88(int iParam0)//Position - 0x2ED4
{
	var uVar0;
...
int func_95()//Position - 0x2F6A
{
	return 1;
}

float func_96(int iParam0, int iParam1)//Position - 0x2F73
{
...
void func_100(var uParam0, var uParam1)//Position - 0x3099
{
...
int func_102(int iParam0)//Position - 0x311C
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_105()//Position - 0x3151
{
	...
	StringCopy(&Local_232, "PBBB", 8);
	StringCopy(&Local_234, "BILLBINDER", 16);
	...
	bLocal_434 = !Global_4;
	iLocal_250 = 8;
	sLocal_301 = "PBBB_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to Bill Binder. */;
	StringCopy(&Local_310, "PBBB_CONV_GM", 16);
	StringCopy(&Local_314, "PBBB_CONV_GT", 16);
	StringCopy(&Local_318, "PBBB_CONV_GF", 16);
	StringCopy(&cLocal_322, "special_ped@bill@base", 64);
	StringCopy(&cLocal_338, "special_ped@bill@intro", 64);
	iLocal_249 = 2;
	iLocal_253[0] = 7;
	iLocal_253[1] = 5;
	iLocal_253[2] = 5;
...
int func_106(int iParam0)//Position - 0x3229
{
...
int func_110()//Position - 0x32AB
{
	return 1;
}

bool func_111(var uParam0)//Position - 0x32B4
{
	return func_112(Global_114135.f_20121, uParam0);
}

bool func_112(var uParam0, var uParam1)//Position - 0x32C9
{
	return (uParam0 && uParam1) != 0;
}

int func_113(char* sParam0)//Position - 0x32D8
{
...
void func_115(int* iParam0)//Position - 0x34CE
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
