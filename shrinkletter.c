	...
	while (true)
	{
		switch (iLocal_50)
		{
			...
			case 1:
				...
				func_42(&Var0);
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
				while (!func_13(&uLocal_68, &iLocal_69, &uLocal_52))
				{
					func_43();
					SYSTEM::WAIT(0);
				}
				func_12(&iLocal_70);
				func_11(&iLocal_70, 0, 0, 0, 1);
				func_10(&iLocal_70, "CONTINUE", 2, 201, 1, 1, 0);
				func_9(&iLocal_70, 1);
				func_8(&iLocal_70, 1);
			...
			case 2:
				GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(1);
				GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_51, 255, 255, 255, 255, 0);
				func_1(&iLocal_70, 1128792064, 1, 0, 1, 1065353216);
...
void func_1(int* iParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)//Position - 0x3AE
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
float func_4(bool bParam0, float fParam1, float fParam2)//Position - 0x687
{
	if (bParam0)
	{
		return fParam1;
...
void func_5(char* sParam0)//Position - 0x69E
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
}

bool func_6(var uParam0, int iParam1)//Position - 0x6AC
{
	return (uParam0 && iParam1) != 0;
}

int func_7(var uParam0)//Position - 0x6BB
{
	if (*uParam0 != 0)
	{
...
void func_8(int* iParam0, bool bParam1)//Position - 0x6E2
{
	if (bParam1)
	{
...
void func_9(int* iParam0, bool bParam1)//Position - 0x706
{
	if (bParam1)
	{
...
int func_10(int* iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x72C
{
	int iVar0;
	int iVar1;
...
void func_11(int* iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x7F5
{
	if (*iParam0 == 0)
	{
...
void func_12(int* iParam0)//Position - 0x86F
{
	if (*iParam0 != 0)
	{
...
int func_13(var uParam0, int* iParam1, var uParam2)//Position - 0x892
{
	var* uVar0;
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			DATAFILE::DATADICT_SET_INT(uVar0, "in", *uParam2);
			DATAFILE::DATADICT_SET_STRING(uVar0, "st", &(uParam2->f_1));
			DATAFILE::DATADICT_SET_STRING(uVar0, "mp", &(uParam2->f_2));
			DATAFILE::DATADICT_SET_STRING(uVar0, "ms", &(uParam2->f_3));
			DATAFILE::DATADICT_SET_STRING(uVar0, "sc", &(uParam2->f_5));
			DATAFILE::DATADICT_SET_STRING(uVar0, "pr", &(uParam2->f_6));
			DATAFILE::DATADICT_SET_STRING(uVar0, "fa", &(uParam2->f_7));
			DATAFILE::DATADICT_SET_STRING(uVar0, "sm", &(uParam2->f_8));
			DATAFILE::DATADICT_SET_STRING(uVar0, "kp", &(uParam2->f_9));
			DATAFILE::DATADICT_SET_STRING(uVar0, "sv", &(uParam2->f_10));
			DATAFILE::DATADICT_SET_STRING(uVar0, "yo", &(uParam2->f_11));
			DATAFILE::DATADICT_SET_STRING(uVar0, "fi", &(uParam2->f_12));
			DATAFILE::DATADICT_SET_STRING(uVar0, "rc", &(uParam2->f_13));
			DATAFILE::DATADICT_SET_STRING(uVar0, "co", &(uParam2->f_14));
			DATAFILE::DATADICT_SET_INT(uVar0, "su", uParam2->f_15);
...
int func_14(int* iParam0, int iParam1)//Position - 0x9DD
{
...
int func_22(int iParam0)//Position - 0xB68
{
...
int func_29(int iParam0, int iParam1)//Position - 0xFC5
{
...
int func_34(int iParam0)//Position - 0x134B
{
	if (iParam0 < 9)
	{
		return BitTest(Global_114372.f_18106.f_175[iParam0 /*19*/].f_18, 0);
	}
	return 0;
}
...
int func_36(int iParam0)//Position - 0x13E8
{
	...
	{
		case 0:
			return Global_114372.f_10052.f_90[0];
			break;
		
		case 1:
			return Global_114372.f_10052.f_90[1];
			break;
		
		case 2:
			return Global_114372.f_10052.f_90[2];
			break;
	}
	return 0;
}
...
int func_49(int iParam0)//Position - 0x18EE
{
	if (iParam0 == 1)
	{
...
void func_51(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x1954
{
	if (bParam0)
	{
...
bool func_53(int iParam0, int iParam1)//Position - 0x1ABB
{
	bool bVar0;
...
int func_54(int iParam0, bool bParam1)//Position - 0x1B14
{
	int iVar0;
	int iVar1;
...
int func_55()//Position - 0x1B55
{
	return Global_1574925;
}

int func_56(var uParam0)//Position - 0x1B61
{
	int iVar0;
...
int func_57(int iParam0)//Position - 0x1B83
{
...
bool func_58()//Position - 0x1BC2
{
	return BitTest(Global_2621446, 3);
}

int func_59(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x1BD0
{
	int iVar0;
...
void func_60(int iParam0)//Position - 0x1C03
{
	if (iParam0 == 1)
	{
