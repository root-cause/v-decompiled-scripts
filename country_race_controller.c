...
void func_8()//Position - 0x3ED
{
	...
	StringIntConCat(&Var0, Global_114135.f_25077 + 1, 16);
	func_9(&Var0, -1);
}
...
void func_13()//Position - 0x49C
{
	...
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("country_race")) == 0)
	{
		if (SCRIPT::HAS_SCRIPT_LOADED("Country_Race"))
		{
			if (iLocal_154 == 2)
			{
				iLocal_154 = func_17(&Global_114133, 2, 9, 0, 0);
			}
				...
				if (func_38())
				{
					...
					if (((!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !func_31(1)) && !func_30(0)) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("appinternet")) == 0)
					{
						if (PAD::IS_CONTROL_JUST_PRESSED(2 /*FRONTEND_CONTROL*/, 51 /*INPUT_CONTEXT*/))
						{
							...
							ENTITY::SET_ENTITY_INVINCIBLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), true, false);
							HUD::HIDE_HELP_TEXT_THIS_FRAME();
							iLocal_153 = 1;
						}
					}
...
bool func_25(char* sParam0)//Position - 0xB40
{
...
int func_30(int iParam0)//Position - 0xBE0
{
	if (iParam0 == 1)
	{
...
int func_34(int iParam0)//Position - 0xD2A
{
	if (func_61(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_36(int iParam0, char* sParam1, int iParam2)//Position - 0xD6F
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iParam0, sParam1, func_37(iParam2), 1);
}

int func_37(int iParam0)//Position - 0xD86
{
	int iVar0;
...
int func_39(int iParam0)//Position - 0x145C
{
	switch (iParam0)
	{
		case joaat("police"):
...
int func_40(int iParam0)//Position - 0x1504
{
	if (func_61(iParam0))
	{
...
int func_43()//Position - 0x15C5
{
	if ((!Global_114135.f_25077.f_9 && !Global_114135.f_25077.f_8) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_60()) < 84100f)
	{
...
void func_45(int iParam0)//Position - 0x187B
{
...
void func_51()//Position - 0x1A71
{
	if (func_61(iLocal_156))
	{
		if ((!PED::IS_PED_FLEEING(iLocal_156) && !PED::IS_PED_IN_COMBAT(iLocal_156, 0)) && !PED::IS_PED_RAGDOLL(iLocal_156))
		{
			...
			if (func_52(iLocal_155) || Global_114135.f_25077.f_9)
			{
...
int func_52(int iParam0)//Position - 0x1B25
{
	int iVar0;
	float fVar1;
...
int func_53(int iParam0, int iParam1, bool bParam2)//Position - 0x1B98
{
	int iVar0;
...
float func_55(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x1C82
{
	struct<3> Var0;
...
int func_58(int iParam0)//Position - 0x1E12
{
	int iVar0;
...
int func_59(int iParam0, int iParam1)//Position - 0x1E7A
{
	int iVar0;
...
int func_61(int iParam0)//Position - 0x1EDB
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
