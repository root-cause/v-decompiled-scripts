...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_39 = 49;
	iLocal_40 = 64;
	Local_59 = { -1124.3922f, -514.70013f, 33.21493f };
	fLocal_62 = 200f;
...
void func_6(int iParam0)//Position - 0x321
{
	...
	{
		case 0:
			Global_113969.f_25076 = 1;
			Global_113969.f_25076.f_3 = 1;
			break;
		
		case 1:
			Global_113969.f_25076 = 2;
			Global_113969.f_25076.f_4 = 1;
			break;
		
		case 2:
			Global_113969.f_25076 = 3;
			Global_113969.f_25076.f_5 = 1;
			break;
		
		case 3:
			Global_113969.f_25076 = 4;
			Global_113969.f_25076.f_6 = 1;
			break;
		
		case 4:
			Global_113969.f_25076 = 0;
			Global_113969.f_25076.f_7 = 1;
			break;
	}
}
...
void func_8()//Position - 0x3ED
{
	...
	StringIntConCat(&Var0, Global_113969.f_25076 + 1, 16);
	func_9(&Var0, -1);
}

void func_9(char* sParam0, int iParam1)//Position - 0x414
{
...
void func_12(var uParam0)//Position - 0x45F
{
	if (*uParam0 == -1)
	{
		return;
...
void func_13()//Position - 0x49C
{
	...
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("country_race")) == 0)
	{
		if (SCRIPT::HAS_SCRIPT_LOADED("Country_Race"))
		{
			if (iLocal_154 == 2)
			{
				iLocal_154 = func_17(&Global_113967, 2, 9, 0, 0);
			}
			else if (iLocal_154 == 1)
			{
				func_15(&iLocal_156, 0);
				func_14(&iLocal_155, 0);
				SYSTEM::START_NEW_SCRIPT("Country_Race", 5050);
...
void func_14(int* iParam0, bool bParam1)//Position - 0x537
{
...
void func_15(int* iParam0, bool bParam1)//Position - 0x59B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_17(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x662
{
	int iVar0;
...
void func_18(var uParam0, int iParam1)//Position - 0x799
{
	int iVar0;
...
bool func_19(int iParam0)//Position - 0x7E8
{
	return func_20(iParam0, Global_44042);
}

int func_20(int iParam0, int iParam1)//Position - 0x7F9
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_21(int iParam0)//Position - 0x9DA
{
	if (Global_44042 == 15)
	{
		return 0;
...
void func_23()//Position - 0xA0A
{
	if (func_43())
	{
		...
		{
			PAD::DISABLE_CONTROL_ACTION(0 /*PLAYER_CONTROL*/, 74 /*INPUT_VEH_HEADLIGHT*/, true);
			PED::SET_IK_TARGET(iLocal_156, 1, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 0, 150, 400);
			if (func_41())
			{
				if (func_38())
				{
...
bool func_25(char* sParam0)//Position - 0xB3E
{
...
int func_30(int iParam0)//Position - 0xBDE
{
	if (iParam0 == 1)
	{
...
{
	if (((((CAM::GET_FOLLOW_VEHICLE_CAM_VIEW_MODE() != 3 && CAM::GET_FOLLOW_VEHICLE_CAM_VIEW_MODE() != 4) && !CAM::IS_GAMEPLAY_CAM_LOOKING_BEHIND()) && PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) && func_34(iLocal_156)) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 20f)
	{
		if (iLocal_158)
		{
			if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
			{
				CAM::SET_GAMEPLAY_ENTITY_HINT(iLocal_156, 0f, 0f, 0f, true, 2000, 2000, 2000, 0);
				iLocal_158 = 0;
			}
		}
	}
...
int func_34(int iParam0)//Position - 0xD28
{
	if (func_61(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_35()//Position - 0xD48
{
	...
	{
		func_36(iLocal_156, "PRERACE_CHAT", 11);
		iLocal_157 = MISC::GET_GAME_TIMER();
	}
}

void func_36(int iParam0, char* sParam1, int iParam2)//Position - 0xD6D
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iParam0, sParam1, func_37(iParam2), 1);
}

int func_37(int iParam0)//Position - 0xD84
{
	int iVar0;
...
int func_39(int iParam0)//Position - 0x145A
{
	switch (iParam0)
	{
		case joaat("police"):
...
int func_40(int iParam0)//Position - 0x14EA
{
	if (func_61(iParam0))
	{
...
int func_43()//Position - 0x15AB
{
	if ((!Global_113969.f_25076.f_9 && !Global_113969.f_25076.f_8) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_60()) < 84100f)
	{
		Global_113969.f_25076.f_9 = func_54();
		func_51();
		if (!Global_113969.f_25076.f_9)
		{
			if (func_61(iLocal_156) && func_61(iLocal_155))
			{
	...
	else
	{
		...
		{
			func_15(&iLocal_156, 1);
			func_14(&iLocal_155, 1);
			if (Global_113969.f_25076.f_9)
			{
				Global_113969.f_25076.f_9 = 0;
			}
			if (Global_113969.f_25076.f_8)
			{
				Global_113969.f_25076.f_8 = 0;
			}
		}
		if (Global_113969.f_25076.f_9)
		{
...
void func_44(bool bParam0)//Position - 0x174B
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_155) && !ENTITY::DOES_ENTITY_EXIST(iLocal_156))
	{
		...
		{
			iLocal_155 = VEHICLE::CREATE_VEHICLE(func_50(), func_49(), func_48(), true, true, false);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_155, 5f);
			if (Global_113969.f_25076 == 4)
			{
				VEHICLE::SET_VEHICLE_LIVERY(iLocal_155, 0);
				VEHICLE::SET_VEHICLE_COLOURS(iLocal_155, 44, 83);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(iLocal_155, 111, 111);
			}
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_155, 3);
			VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(iLocal_155, false, 0);
			VEHICLE::SET_VEHICLE_DISABLE_TOWING(iLocal_155, true);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_50());
			iLocal_156 = PED::CREATE_PED(26, joaat("A_M_Y_MotoX_02"), func_47(), func_46(), true, true);
			func_45(iLocal_156);
			AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_156, "A_M_Y_RACER_01_WHITE_MINI_01");
			TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_156, "WORLD_HUMAN_STAND_IMPATIENT", -1, true);
...
float func_46()//Position - 0x19A1
{
	return 294.2507f;
}

Vector3 func_47()//Position - 0x19AE
{
	return 1965.2484f, 3114.886f, 46.1663f;
}

float func_48()//Position - 0x19C5
{
	return 194.8257f;
}

Vector3 func_49()//Position - 0x19D2
{
	return 1964.0383f, 3114.6345f, 46.1319f;
}

int func_50()//Position - 0x19E9
{
	switch (Global_113969.f_25076)
	{
		case 0:
...
void func_51()//Position - 0x1A57
{
	if (func_61(iLocal_156))
	{
		if ((!PED::IS_PED_FLEEING(iLocal_156) && !PED::IS_PED_IN_COMBAT(iLocal_156, 0)) && !PED::IS_PED_RAGDOLL(iLocal_156))
		{
			if (!func_53(iLocal_156, joaat("SCRIPT_TASK_START_SCENARIO_IN_PLACE"), 1))
			{
				TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_156, "WORLD_HUMAN_STAND_IMPATIENT", -1, true);
			}
			if (func_52(iLocal_155) || Global_113969.f_25076.f_9)
			{
				PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(iLocal_156);
				TASK::TASK_COMBAT_PED(iLocal_156, PLAYER::PLAYER_PED_ID(), 0, 16);
			}
			fLocal_159 = ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID());
		}
		else if (PED::IS_PED_RAGDOLL(iLocal_156))
		{
			if (!func_53(iLocal_156, joaat("SCRIPT_TASK_COMBAT"), 1))
			{
				PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(iLocal_156);
				TASK::TASK_COMBAT_PED(iLocal_156, PLAYER::PLAYER_PED_ID(), 0, 16);
			}
...
int func_52(int iParam0)//Position - 0x1B0B
{
	int iVar0;
	float fVar1;
	...
	if (func_61(iParam0))
	{
		if ((func_61(iVar0) && fLocal_159 != 0f) && fLocal_159 >= 9f)
		{
			fVar1 = ENTITY::GET_ENTITY_SPEED(iVar0);
			if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(iParam0, iVar0) && fVar1 <= (fLocal_159 * 0.5f))
			{
				return 1;
			}
		}
...
int func_53(int iParam0, int iParam1, bool bParam2)//Position - 0x1B7E
{
	int iVar0;
...
int func_54()//Position - 0x1BC4
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_156))
	{
		...
		else if (PED::IS_PED_FLEEING(iLocal_156))
		{
			return 1;
		}
		else if (PED::IS_PED_IN_COMBAT(iLocal_156, 0))
		{
			return 1;
		}
		else if (PED::IS_PED_RAGDOLL(iLocal_156))
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_155))
	{
		...
		{
			if (func_55(iLocal_155, func_49(), 1) > 2f)
			{
				return 1;
			}
			if (WEAPON::HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(PLAYER::PLAYER_PED_ID(), iLocal_155, 0, -1))
			{
				return 1;
			}
		}
...
float func_55(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x1C68
{
	struct<3> Var0;
...
int func_58(int iParam0)//Position - 0x1DF8
{
	int iVar0;
...
int func_59(int iParam0, int iParam1)//Position - 0x1E60
{
	int iVar0;
...
Vector3 func_60()//Position - 0x1EAA
{
	return 1967.042f, 3116.0051f, 45.8901f;
}

int func_61(int iParam0)//Position - 0x1EC1
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_62(bool bParam0)//Position - 0x1EE2
{
	struct<4> Var0;
	...
	if (func_61(iLocal_156))
	{
		if (func_53(iLocal_156, joaat("SCRIPT_TASK_START_SCENARIO_AT_POSITION"), 1) || func_53(iLocal_156, joaat("SCRIPT_TASK_START_SCENARIO_IN_PLACE"), 1))
		{
			TASK::TASK_WANDER_STANDARD(iLocal_156, 40000f, 0);
		}
	}
	func_15(&iLocal_156, bParam0);
	func_14(&iLocal_155, bParam0);
	if (bParam0)
	{
