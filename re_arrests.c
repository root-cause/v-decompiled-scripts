...
void func_19(bool bParam0)//Position - 0x2677
{
	bool bVar0;
	char cVar1[64];
	...
	else if (BitTest(Global_114372.f_20567.f_471, bParam0) || BitTest(Global_2359296[func_21() /*5569*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_114372.f_20567.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_21() /*5569*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
char* func_20(bool bParam0)//Position - 0x27F1
{
	switch (bParam0)
	{
		case 0:
...
int func_23(int iParam0, var uParam1)//Position - 0x292F
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_24(uParam1));
}

int func_24(var uParam0)//Position - 0x2944
{
	int iVar0;
	int iVar1;
...
void func_26(int iParam0, bool bParam1, int iParam2)//Position - 0x2984
{
	if (iParam2 == -1)
	{
		iParam2 = func_25();
...
int func_28(int iParam0)//Position - 0x29C2
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	return BitTest(Global_2359296[func_21() /*5569*/].f_681.f_10, iParam0);
}
...
int func_34(var uParam0, int iParam1)//Position - 0x2D1C
{
	int iVar0;
	var uVar1[78];
...
void func_39(var uParam0, float fParam1)//Position - 0x2E9D
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
int func_44(int iParam0)//Position - 0x2F13
{
	switch (iParam0)
	{
		case 60:
...
int func_50(int iParam0)//Position - 0x30B7
{
	return Global_2139[iParam0 /*29*/].f_17;
}

int func_51()//Position - 0x30C8
{
	func_52();
...
void func_52()//Position - 0x30E1
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_55(Global_114372.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_53(iVar0) && (!func_45(14) || Global_113320))
			{
...
bool func_53(int iParam0)//Position - 0x31DE
{
	return iParam0 < 3;
}

int func_54(int iParam0)//Position - 0x31EA
{
	int iVar0;
	int iVar1;
...
int func_55(int iParam0)//Position - 0x3227
{
	if (func_53(iParam0))
	{
...
var func_56(int iParam0)//Position - 0x324C
{
	return Global_2139[iParam0 /*29*/];
}

int func_57()//Position - 0x325B
{
	float fVar0;
	int iVar1;
	int iVar2;
...
int func_73(int iParam0, int iParam1)//Position - 0x3FBD
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
bool func_75(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x414C
{
...
int func_76(char* sParam0, int iParam1, bool bParam2)//Position - 0x419A
{
	Global_22167 = 0;
...
var func_80(int iParam0, int iParam1)//Position - 0x4512
{
	return BitTest(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_81()//Position - 0x452A
{
	return -1;
}
...
void func_89(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x47EC
{
...
int func_92(float fParam0)//Position - 0x48A5
{
	var uVar0;
	struct<3> Var1;
...
float func_93(struct<3> Param0, struct<3> Param3)//Position - 0x48D5
{
...
int func_95(int iParam0)//Position - 0x48FF
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_97(float fParam0)//Position - 0x4A02
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
int func_98(int iParam0)//Position - 0x4AAC
{
	if (func_103())
	{
		Global_114362 = 1;
		Global_114359 = MISC::GET_GAME_TIMER();
		if (func_102(Global_114361))
		{
			func_99(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /* GXT: Random Event */);
		if (iParam0 && func_102(Global_114361))
		{
...
void func_100(char* sParam0, int iParam1)//Position - 0x4BDA
{
...
int func_102(int iParam0)//Position - 0x4C35
{
	switch (iParam0)
	{
		case 29:
...
int func_103()//Position - 0x4C64
{
	switch (func_104(&Global_32888, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
bool func_106(int iParam0)//Position - 0x4E20
{
	return func_107(iParam0, Global_43922);
}

int func_107(int iParam0, int iParam1)//Position - 0x4E31
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_108(int iParam0)//Position - 0x5012
{
	if (Global_43922 == 15)
	{
		return 0;
...
int func_110(int iParam0, bool bParam1, int iParam2)//Position - 0x5152
{
	int iVar0;
...
int func_111(int iParam0, bool bParam1, bool bParam2)//Position - 0x519C
{
	int iVar0;
...
float func_112(bool bParam0, float fParam1, float fParam2)//Position - 0x5240
{
	if (bParam0)
	{
		return fParam1;
...
void func_115(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x57B4
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
int func_134(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x7604
{
...
int func_135(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x77DE
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (!func_171(Global_114372.f_24998.f_43[iParam3]))
		{
			return 0;
		}
...
bool func_136(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x7B78
{
	if (bParam6)
	{
...
bool func_137(int iParam0)//Position - 0x7BBF
{
	int iVar0;
...
int func_138(int iParam0)//Position - 0x7BE0
{
...
int func_149(bool bParam0, int iParam1, int iParam2)//Position - 0x7FB2
{
	if (bParam0)
	{
		return iParam1;
...
int func_151(int iParam0, int iParam1)//Position - 0x7FD6
{
	int iVar0;
	int iVar1;
...
int func_159(int iParam0)//Position - 0x82E5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_160(int iParam0, bool bParam1)//Position - 0x83C1
{
...
int func_161(int iParam0)//Position - 0x83E1
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_169()) || Global_113419) || Global_32831) || func_168()) || func_88(8, -1)) || func_167()) || func_166()) || func_165()) || func_164()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_169()) || Global_32831) || func_168()) || func_88(8, -1)) || func_165()) || func_167()) || func_166()) || func_164()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_169()) || Global_113419) || Global_32831) || func_168()) || func_88(8, -1)) || func_165()) || func_167()) || func_166()) || func_164()) || Global_114372.f_7691.f_919[iVar0] == 5) || Global_44469 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_169()) || Global_113419) || Global_32831) || func_168()) || func_88(8, -1)) || func_167()) || func_166()) || func_164()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_169() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_88(8, -1)) || func_164()) || func_163()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_169()) || Global_32831) || func_168()) || func_88(8, -1)) || func_166()) || func_165()) || func_164()) || Global_114372.f_7691.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_169()) || Global_113419) || Global_32831) || func_168()) || func_88(8, -1)) || func_165()) || func_163()) || func_167()) || func_166()) || func_164())
						{
							return 0;
						}
						break;
...
var func_162()//Position - 0x8AFE
{
	return Global_101431.f_1;
}

int func_163()//Position - 0x8B0C
{
	if (Global_98294 != -1)
	{
...
var func_168()//Position - 0x8B95
{
	return Global_1575079;
}

int func_169()//Position - 0x8BA1
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_172(int iParam0, int iParam1, int iParam2)//Position - 0x8BF7
{
	int iVar0;
	int iVar1;
...
int func_173(int iParam0)//Position - 0x8CDB
{
	if (!func_53(iParam0))
	{
		return 7;
...
int func_174(int iParam0)//Position - 0x8CFF
{
	int iVar0;
	int iVar1;
...
int func_176(bool bParam0)//Position - 0x8D9B
{
...
void func_179(int iParam0)//Position - 0x900A
{
	...
	if (func_191())
	{
		...
		func_183(30000);
		StringCopy(&cVar0, func_182(Global_114361, 1), 64);
		if (func_181(Global_114361) > 0)
		{
...
int func_191()//Position - 0x988F
{
	if ((Global_114361 == func_133() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_114362)
	{
		return 1;
	}
	return 0;
...
void func_197()//Position - 0x9B1B
{
	...
	{
		func_46(13, SYSTEM::FLOOR(Global_114372.f_10197.f_3853));
	}
...
void func_202(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0xA3BC
{
	int iVar0;
...
int func_204(int iParam0)//Position - 0xA6A7
{
	int iVar0;
	int iVar1;
