		...
		if (!PED::IS_PED_INJURED(iLocal_55))
		{
			switch (iLocal_52)
			{
					...
					if (SYSTEM::TIMERA() > 2000)
					{
						if (iVar5 || iLocal_278 == 1)
						{
							if (!func_89())
							{
								...
								{
									TASK::TASK_SHOOT_AT_COORD(0, Local_68.f_0, Local_68.f_1, (Local_68.f_2 + 4f), 1000, joaat("FIRING_PATTERN_SINGLE_SHOT"));
								}
				...
				case 6:
					...
					{
						VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(iLocal_57, true);
					...
					if (!PED::IS_PED_INJURED(iLocal_54))
					{
						...
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_57, false))
						{
							...
							else if (iLocal_63)
							{
								...
								{
									TASK::TASK_GOTO_ENTITY_OFFSET_XY(iLocal_55, iLocal_57, 60000, 0.5f, Local_295.f_0, Local_295.f_1, 1f, 1);
									iLocal_285 = 1;
								}
								else if (fVar6 < 3f)
								{
...
int func_10()//Position - 0x13E9
{
	...
	{
		if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(ENTITY::GET_ENTITY_COORDS(iLocal_54, false), 1, &Var0, 1, 3f, 0f))
		{
			if (VEHICLE::GENERATE_VEHICLE_CREATION_POS_FROM_PATHS(&Var0, &Var6, &uVar9, 0f, 180f, 50f, 1, 1, 1))
			{
				...
				PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(ENTITY::GET_ENTITY_COORDS(iLocal_54, false), 1, &Var0, 1, 3f, 0f);
					...
					switch (iLocal_247)
					{
						...
						case 1:
							...
							else
							{
								...
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_54, false), 2f, -1, 3f, 0, 40000f);
								TASK::CLOSE_SEQUENCE_TASK(iLocal_73);
								TASK::TASK_PERFORM_SEQUENCE(iLocal_55, iLocal_73);
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_73);
								iLocal_247 = 2;
...
float func_92(struct<3> Param0, struct<3> Param3)//Position - 0x48D7
{
...
{
	switch (func_103(&Global_32223, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_112()//Position - 0x5259
{
	...
	if (iLocal_53 == 1)
	{
		...
		fVar9 = 220.0087f;
		Local_279 = { 2378.2844f, 4863.027f, 32.508835f };
		Local_282 = { 2512.7974f, 4998.5864f, 90.12283f };
	...
	else if (iLocal_53 == 2)
	{
		...
		fVar9 = 75.5943f;
		Local_279 = { 2543.1345f, 2683.9172f, 0.307461f };
		Local_282 = { 2597.6025f, 2408.885f, 121.90103f };
	...
	if ((((((STREAMING::HAS_MODEL_LOADED(iVar0) && STREAMING::HAS_MODEL_LOADED(iVar1)) && STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_binbag_01"))) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_258)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_259)) && STREAMING::HAS_CLIP_SET_LOADED("MOVE_M@BAIL_BOND_NOT_TAZERED")) && STREAMING::HAS_CLIP_SET_LOADED("MOVE_M@BAIL_BOND_TAZERED"))
	{
		...
		if (SYSTEM::VDIST(2411.32f, 4958.76f, 45.19f, Local_65) < 10f)
		{
			iLocal_53 = 1;
			TASK::OPEN_SEQUENCE_TASK(&iLocal_73);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD_ADVANCED(0, 2473.2544f, 4901.6514f, 43.1488f, 3f, -1, 2f, 1, Local_250, 40000f);
			TASK::TASK_SMART_FLEE_PED(0, iLocal_54, 150f, -1, false, false);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_73);
			TASK::TASK_PERFORM_SEQUENCE(iLocal_55, iLocal_73);
			PED::SET_PED_KEEP_TASK(iLocal_55, true);
		...
		else
		{
			iLocal_53 = 2;
			TASK::OPEN_SEQUENCE_TASK(&iLocal_73);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD_ADVANCED(0, 2531.445f, 2521.7493f, 38.2072f, 3f, -1, 2f, 1, Local_250, 40000f);
			TASK::TASK_SMART_FLEE_PED(0, iLocal_54, 150f, -1, false, false);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_73);
			TASK::TASK_PERFORM_SEQUENCE(iLocal_55, iLocal_73);
			PED::SET_PED_KEEP_TASK(iLocal_55, true);
...
void func_117(int iParam0, var uParam1)//Position - 0x5968
{
	switch (iParam0)
	{
		...
		case 5:
			func_118(uParam1, "Barry3A", func_120(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_119(iParam0), 0, 1);
			break;
		...
		case 8:
			func_118(uParam1, "Dreyfuss1", func_120(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_119(iParam0), 0, 0);
			break;
		...
		case 38:
			func_118(uParam1, "Nigel1A", func_120(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_119(iParam0), 1, 1);
			break;
		...
		case 49:
			func_118(uParam1, "Paparazzo3A", func_120(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_119(iParam0), 0, 1);
			break;
		...
		case 58:
			func_118(uParam1, "Tonya1", func_120(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_119(iParam0), 0, 1);
			break;
...
int func_134(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x77E4
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
bool func_135(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x7B7E
{
	if (bParam6)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_168()) || Global_32166) || func_167()) || func_87(8, -1)) || func_164()) || func_166()) || func_165()) || func_163()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_168()) || Global_112695) || Global_32166) || func_167()) || func_87(8, -1)) || func_166()) || func_165()) || func_163()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_168() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_87(8, -1)) || func_163()) || func_162()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_168()) || Global_32166) || func_167()) || func_87(8, -1)) || func_165()) || func_164()) || func_163()) || Global_113648.f_7690.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_168()) || func_165()) || Global_112695) || Global_32166) || func_167()) || Global_44446) || func_87(8, -1)) || func_164()) || func_162()) || func_163()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_194(int iParam0, int iParam1)//Position - 0x9937
{
	...
	if (iParam1 <= func_180(iParam0))
	{
		...
		if (!func_203(51))
		{
			func_200("RE_REWARD" /* GXT: Some Random Events will reward the player with stat boosts or money. */, 1, 0, 4000, 10000, func_122(), 0, 138, 0);
			func_199(51);
		}
		if (func_101(iParam0))
		{
