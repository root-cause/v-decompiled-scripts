					...
					if (SYSTEM::TIMERA() > 2000)
					{
						if (iVar5 || iLocal_276 == 1)
						{
							if (!func_90())
							{
								...
								{
									TASK::TASK_SHOOT_AT_COORD(0, Local_66.f_0, Local_66.f_1, (Local_66.f_2 + 4f), 1000, joaat("FIRING_PATTERN_SINGLE_SHOT"));
								}
...
void func_3(bool bParam0)//Position - 0xC83
{
	char* sVar0;
	char* sVar1;
	char* sVar2;
...
void func_13()//Position - 0x1C92
{
	Global_20711 = 0;
	func_14();
}

void func_14()//Position - 0x1CA2
{
...
void func_15(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x1CC6
{
	int iVar0;
	int iVar1;
...
int func_16(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x1D98
{
	float fVar0;
	bool bVar1;
	int iVar2;
...
void func_17(bool bParam0)//Position - 0x2397
{
	int iVar0;
	int iVar1;
...
void func_18(int iParam0)//Position - 0x2619
{
	int iVar0;
...
void func_19(bool bParam0)//Position - 0x2673
{
	bool bVar0;
	char cVar1[64];
	...
	else if (BitTest(Global_113810.f_20567.f_471, bParam0) || BitTest(Global_2359296[func_21() /*5568*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_21() /*5568*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
char* func_20(bool bParam0)//Position - 0x27ED
{
	switch (bParam0)
	{
		case 0:
...
void func_22(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x28FD
{
	int iVar0;
...
int func_23(int iParam0, var uParam1)//Position - 0x2920
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_24(uParam1));
}

int func_24(var uParam0)//Position - 0x2935
{
	int iVar0;
	int iVar1;
...
int func_25()//Position - 0x2969
{
	return Global_1574918;
}

void func_26(int iParam0, bool bParam1, int iParam2)//Position - 0x2975
{
	if (iParam2 == -1)
	{
		iParam2 = func_25();
...
void func_27(int iParam0)//Position - 0x2993
{
	func_48(93, iParam0);
	func_48(29, iParam0);
	func_48(30, iParam0);
...
int func_28(int iParam0)//Position - 0x29B3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_29(int iParam0, int iParam1)//Position - 0x2B53
{
	int iVar0;
	var uVar1;
...
bool func_30(int iParam0, int iParam1)//Position - 0x2B82
{
	if (iParam1 == -1)
	{
		iParam1 = func_25();
...
int func_31(bool bParam0)//Position - 0x2B9E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_32(int iParam0, int iParam1)//Position - 0x2C55
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_33(int iParam0, int iParam1)//Position - 0x2C70
{
...
int func_34(var uParam0, int iParam1)//Position - 0x2D0D
{
	int iVar0;
	var uVar1[78];
...
int func_35(var uParam0, int iParam1)//Position - 0x2DBE
{
	int iVar0;
...
bool func_36(var uParam0, int iParam1)//Position - 0x2E39
{
	return (*uParam0)[iParam1] == 78;
}

void func_37(var uParam0)//Position - 0x2E4A
{
	int iVar0;
...
void func_38(var uParam0, int iParam1)//Position - 0x2E7E
{
	(*uParam0)[iParam1] = 78;
}

void func_39(var uParam0, float fParam1)//Position - 0x2E8E
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_40(var uParam0)//Position - 0x2EAB
{
	return uParam0->f_80;
}

bool func_41(var uParam0, int iParam1)//Position - 0x2EB7
{
	return func_42(uParam0, iParam1) != -1;
}

int func_42(var uParam0, int iParam1)//Position - 0x2EC9
{
	int iVar0;
...
bool func_43(var uParam0)//Position - 0x2EF6
{
	return uParam0->f_79 == 1;
}

int func_44(int iParam0)//Position - 0x2F04
{
	switch (iParam0)
	{
		case 60:
...
bool func_45(int iParam0)//Position - 0x2F54
{
	return Global_43377 == iParam0;
}

int func_46(int iParam0, int iParam1)//Position - 0x2F62
{
	int iVar0;
...
void func_47(int iParam0, int iParam1)//Position - 0x2FB3
{
	int iVar0;
...
void func_48(int iParam0, int iParam1)//Position - 0x2FD6
{
	int iVar0;
...
int func_50(int iParam0)//Position - 0x30A8
{
	return Global_2058[iParam0 /*29*/].f_17;
}

int func_51()//Position - 0x30B9
{
	func_52();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_52()//Position - 0x30D2
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_55(Global_113810.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_53(iVar0) && (!func_45(14) || Global_112760))
			{
...
bool func_53(int iParam0)//Position - 0x31CF
{
	return iParam0 < 3;
}

int func_54(int iParam0)//Position - 0x31DB
{
	int iVar0;
	int iVar1;
...
int func_55(int iParam0)//Position - 0x3218
{
	if (func_53(iParam0))
	{
...
var func_56(int iParam0)//Position - 0x323D
{
	return Global_2058[iParam0 /*29*/];
}

int func_57()//Position - 0x324C
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_59()//Position - 0x378D
{
	Global_20711 = 0;
	func_60();
}

void func_60()//Position - 0x379D
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22856 = 0;
...
void func_63(var uParam0, int iParam1)//Position - 0x3A25
{
...
void func_64(int iParam0)//Position - 0x3A42
{
	if (!PED::IS_PED_INJURED(iLocal_52))
	{
		ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_52);
...
void func_66()//Position - 0x3C77
{
	Global_20711 = 0;
	func_67();
}

void func_67()//Position - 0x3C87
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22856 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_73(int iParam0, int iParam1)//Position - 0x3FAD
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
bool func_75(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x413B
{
...
int func_76(char* sParam0, int iParam1, bool bParam2)//Position - 0x4189
{
	Global_21846 = 0;
...
bool func_79(int iParam0)//Position - 0x44F1
{
	return func_80(iParam0, 20);
}

var func_80(int iParam0, int iParam1)//Position - 0x4501
{
	return BitTest(Global_1895156[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_81()//Position - 0x4519
{
	return -1;
}

void func_82()//Position - 0x4522
{
	int iVar0;
...
bool func_88(int iParam0, int iParam1)//Position - 0x47A3
{
	switch (iParam0)
	{
		case 5:
...
void func_89(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x47DB
{
...
int func_92(float fParam0)//Position - 0x4894
{
	var uVar0;
	struct<3> Var1;
...
float func_93(struct<3> Param0, struct<3> Param3)//Position - 0x48C4
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

int func_94()//Position - 0x48E5
{
	return 0;
}

int func_95(int iParam0)//Position - 0x48EE
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_97(float fParam0)//Position - 0x49F1
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
int func_98(int iParam0)//Position - 0x4A9B
{
	if (func_103())
	{
		Global_113800 = 1;
		Global_113797 = MISC::GET_GAME_TIMER();
		if (func_102(Global_113799))
		{
			func_99(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /* GXT: Random Event */);
		if (iParam0 && func_102(Global_113799))
		{
...
void func_99(int iParam0)//Position - 0x4AEE
{
	switch (iParam0)
	{
		case 0:
...
void func_100(char* sParam0, int iParam1)//Position - 0x4BC9
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

char* func_101(int iParam0)//Position - 0x4BE0
{
	char* sVar0;
...
int func_102(int iParam0)//Position - 0x4C24
{
	switch (iParam0)
	{
		case 29:
...
int func_103()//Position - 0x4C53
{
	switch (func_104(&Global_32343, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_104(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x4C89
{
	int iVar0;
...
void func_105(var uParam0, int iParam1)//Position - 0x4DC0
{
	int iVar0;
...
bool func_106(int iParam0)//Position - 0x4E0F
{
	return func_107(iParam0, Global_43377);
}

int func_107(int iParam0, int iParam1)//Position - 0x4E20
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_108(int iParam0)//Position - 0x5001
{
	if (Global_43377 == 15)
	{
		return 0;
...
int func_110(int iParam0, bool bParam1, int iParam2)//Position - 0x5141
{
	int iVar0;
...
int func_111(int iParam0, bool bParam1, bool bParam2)//Position - 0x518B
{
	int iVar0;
...
float func_112(bool bParam0, float fParam1, float fParam2)//Position - 0x522F
{
	if (bParam0)
	{
		return fParam1;
...
int func_113()//Position - 0x5246
{
	...
	if (iLocal_51 == 1)
	{
		...
		fVar9 = 220.0087f;
		Local_277 = { 2378.2844f, 4863.027f, 32.508835f };
		Local_280 = { 2512.7974f, 4998.5864f, 90.12283f };
	...
	else if (iLocal_51 == 2)
	{
		...
		fVar8 = 90.5639f;
		Var5 = { 2586.0051f, 2541.4102f, 31.0379f };
		fVar9 = 75.5943f;
		Local_277 = { 2543.1345f, 2683.9172f, 0.307461f };
		Local_280 = { 2597.6025f, 2408.885f, 121.90103f };
	...
	if ((((((STREAMING::HAS_MODEL_LOADED(iVar0) && STREAMING::HAS_MODEL_LOADED(iVar1)) && STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_binbag_01"))) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_256)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_257)) && STREAMING::HAS_CLIP_SET_LOADED("MOVE_M@BAIL_BOND_NOT_TAZERED")) && STREAMING::HAS_CLIP_SET_LOADED("MOVE_M@BAIL_BOND_TAZERED"))
	{
		...
		if (SYSTEM::VDIST(2411.32f, 4958.76f, 45.19f, Local_63) < 10f)
		{
			iLocal_51 = 1;
			TASK::OPEN_SEQUENCE_TASK(&iLocal_71);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD_ADVANCED(0, 2473.2544f, 4901.6514f, 43.1488f, 3f, -1, 2f, 1, Local_248, 40000f);
			TASK::TASK_SMART_FLEE_PED(0, iLocal_52, 150f, -1, false, false);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_71);
			TASK::TASK_PERFORM_SEQUENCE(iLocal_53, iLocal_71);
			PED::SET_PED_KEEP_TASK(iLocal_53, true);
		...
		else
		{
			iLocal_51 = 2;
			TASK::OPEN_SEQUENCE_TASK(&iLocal_71);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD_ADVANCED(0, 2531.445f, 2521.7493f, 38.2072f, 3f, -1, 2f, 1, Local_248, 40000f);
			TASK::TASK_SMART_FLEE_PED(0, iLocal_52, 150f, -1, false, false);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_71);
			TASK::TASK_PERFORM_SEQUENCE(iLocal_53, iLocal_71);
			PED::SET_PED_KEEP_TASK(iLocal_53, true);
...
void func_115(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x57A3
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
int func_117(float fParam0, bool bParam1)//Position - 0x58A0
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_118(int iParam0, var uParam1)//Position - 0x5951
{
	switch (iParam0)
	{
		case 0:
...
int func_120(int iParam0)//Position - 0x6C29
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_121(int iParam0)//Position - 0x6F6F
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_122(int iParam0)//Position - 0x6FA7
{
	struct<2> Var0;
...
bool func_126()//Position - 0x7489
{
	return Global_113528 > 0;
}

int func_127()//Position - 0x7497
{
	if (Global_97735 != -1)
	{
		return 1;
...
void func_130(int iParam0)//Position - 0x7555
{
	if (iParam0 == -1)
	{
		iParam0 = func_133();
...
void func_132(int iParam0)//Position - 0x75C8
{
	Global_113799 = iParam0;
}

int func_133()//Position - 0x75D6
{
	struct<16> Var0;
	var uVar16;
...
int func_134(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x75F3
{
...
int func_135(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x77CD
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (!func_171(Global_113810.f_24998.f_43[iParam3]))
		{
			return 0;
		}
...
bool func_136(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x7B67
{
	if (bParam6)
	{
...
bool func_137(int iParam0)//Position - 0x7BAE
{
	int iVar0;
...
int func_138(int iParam0)//Position - 0x7BCF
{
	return func_139(iParam0, 1);
}

int func_139(int iParam0, int iParam1)//Position - 0x7BDE
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_140(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x7C31
{
	func_141(func_152(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_141(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x7C4F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_142(float fParam0, float fParam1, float fParam2)//Position - 0x7E50
{
	float fVar0;
...
int func_143(int iParam0, int iParam1)//Position - 0x7E92
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_144(int iParam0)//Position - 0x7F34
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_145(int iParam0)//Position - 0x7F47
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_146(int iParam0)//Position - 0x7F5A
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_147(int iParam0)//Position - 0x7F6D
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_148(int iParam0)//Position - 0x7F7F
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_149(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_149(bool bParam0, int iParam1, int iParam2)//Position - 0x7FA1
{
	if (bParam0)
	{
		return iParam1;
...
int func_150(int iParam0)//Position - 0x7FB8
{
	return iParam0 & 15;
}

int func_151(int iParam0, int iParam1)//Position - 0x7FC5
{
	int iVar0;
	int iVar1;
...
void func_153(var uParam0, int iParam1)//Position - 0x8117
{
	if (iParam1 <= 0)
	{
		return;
...
void func_154(var uParam0, int iParam1)//Position - 0x819D
{
...
void func_155(var uParam0, int iParam1)//Position - 0x81D0
{
	int iVar0;
	int iVar1;
...
void func_156(var uParam0, int iParam1)//Position - 0x8221
{
...
void func_157(var uParam0, int iParam1)//Position - 0x825B
{
...
void func_158(var uParam0, int iParam1)//Position - 0x8296
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_159(int iParam0)//Position - 0x82D2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_160(int iParam0, bool bParam1)//Position - 0x83AE
{
...
int func_161(int iParam0)//Position - 0x83CE
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_169()) || Global_112857) || Global_32286) || func_168()) || func_88(8, -1)) || func_167()) || func_166()) || func_165()) || func_164()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_169()) || Global_32286) || func_168()) || func_88(8, -1)) || func_165()) || func_167()) || func_166()) || func_164()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_169()) || Global_112857) || Global_32286) || func_168()) || func_88(8, -1)) || func_165()) || func_167()) || func_166()) || func_164()) || Global_113810.f_7691.f_919[iVar0] == 5) || Global_43924 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_169()) || Global_112857) || Global_32286) || func_168()) || func_88(8, -1)) || func_167()) || func_166()) || func_164()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_169() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_88(8, -1)) || func_164()) || func_163()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_169()) || Global_32286) || func_168()) || func_88(8, -1)) || func_166()) || func_165()) || func_164()) || Global_113810.f_7691.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_169()) || Global_112857) || Global_32286) || func_168()) || func_88(8, -1)) || func_165()) || func_163()) || func_167()) || func_166()) || func_164())
						{
							return 0;
						}
						break;
...
var func_162()//Position - 0x8AEB
{
	return Global_100872.f_1;
}

int func_163()//Position - 0x8AF9
{
	if (Global_97735 != -1)
	{
...
bool func_166()//Position - 0x8B60
{
	return Global_100885.f_394 > 0;
}

bool func_167()//Position - 0x8B71
{
	return Global_100885.f_393 > 0;
}

var func_168()//Position - 0x8B82
{
	return Global_1575063;
}

int func_169()//Position - 0x8B8E
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_171(int iParam0)//Position - 0x8BD2
{
	return func_151(func_152(), iParam0);
}

int func_172(int iParam0, int iParam1, int iParam2)//Position - 0x8BE4
{
	int iVar0;
	int iVar1;
...
int func_173(int iParam0)//Position - 0x8CC8
{
	if (!func_53(iParam0))
	{
		return 7;
...
int func_174(int iParam0)//Position - 0x8CEC
{
	int iVar0;
	int iVar1;
...
int func_176(bool bParam0)//Position - 0x8D88
{
...
void func_179(int iParam0)//Position - 0x8FF7
{
	char cVar0[64];
	...
	if (func_191())
	{
		...
		func_183(30000);
		StringCopy(&cVar0, func_182(Global_113799, 1), 64);
		if (func_181(Global_113799) > 0)
		{
	...
	func_180(&Global_32343);
	Global_113800 = 0;
	func_132(-1);
}

void func_180(var uParam0)//Position - 0x90A9
{
	if (*uParam0 == -1)
	{
		return;
...
int func_181(int iParam0)//Position - 0x90E6
{
	int iVar0;
...
char* func_182(int iParam0, bool bParam1)//Position - 0x9197
{
	switch (iParam0)
	{
		case 0:
...
void func_183(int iParam0)//Position - 0x93E0
{
	Global_43928 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_184(int iParam0)//Position - 0x93F2
{
	func_185(iParam0, 0, func_190(iParam0));
}

void func_185(int iParam0, int iParam1, int iParam2)//Position - 0x9407
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_186(var uParam0)//Position - 0x9436
{
	struct<16> Var0;
	int iVar16;
...
void func_187(int iParam0, var uParam1)//Position - 0x9507
{
	Global_113810.f_24998.f_43[iParam0] = *uParam1;
}

void func_188(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x951F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_189(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x96A1
{
...
int func_190(int iParam0)//Position - 0x96D9
{
	int iVar0;
...
int func_191()//Position - 0x987C
{
	if ((Global_113799 == func_133() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_113800)
	{
		return 1;
	}
	return 0;
...
void func_193()//Position - 0x98C6
{
	func_194();
}

int func_194()//Position - 0x98D3
{
	if (func_176(0))
	{
		return 0;
...
void func_195(int iParam0, int iParam1)//Position - 0x991E
{
	if (iParam0 == -1)
	{
		iParam0 = func_133();
	...
	if (iParam1 <= func_181(iParam0))
	{
		...
		if (!func_204(51))
		{
			func_201("RE_REWARD" /* GXT: Some Random Events will reward the player with stat boosts or money. */, 1, 0, 4000, 10000, func_123(), 0, 138, 0);
			func_200(51);
		}
		if (func_102(iParam0))
		{
...
void func_196(int iParam0, var uParam1, var uParam2)//Position - 0x9A22
{
	bool bVar0;
...
void func_197()//Position - 0x9B08
{
	...
	{
		func_46(13, SYSTEM::FLOOR(Global_113810.f_10197.f_3853));
	}
...
int func_198()//Position - 0x9FC6
{
	return Global_32283;
}

int func_199(int iParam0, int iParam1)//Position - 0x9FD1
{
	switch (iParam0)
	{
		case 0:
...
void func_200(int iParam0)//Position - 0xA345
{
	int iVar0;
	int iVar1;
...
void func_201(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0xA387
{
	func_202(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_202(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0xA3A9
{
	int iVar0;
...
int func_204(int iParam0)//Position - 0xA694
{
	int iVar0;
	int iVar1;
...
void func_205(int iParam0, int iParam1)//Position - 0xA6D4
{
	MISC::SET_BIT(&(Global_113810.f_24998.f_8[iParam0]), iParam1);
}

int func_206()//Position - 0xA6EF
{
	return 1;
}

void func_207(int iParam0)//Position - 0xA6F8
{
	Global_113796 = iParam0;
}

void func_208()//Position - 0xA706
{
