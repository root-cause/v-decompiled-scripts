...
void func_22()//Position - 0xA22
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_24(Global_114370.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_26(iVar0) && (!func_15(14) || Global_113320))
			{
		...
		if (!PED::IS_PED_INJURED((*iParam0)[iVar0]))
		{
			switch ((*iParam1)[iVar0])
			{
				case 100:
					...
					{
						TASK::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_98701, &cLocal_370, &(Local_386[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
						(*iParam1)[iVar0] = 101;
					}
				...
				case 101:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98702))
					{
						TASK::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_98702, &cLocal_370, &(Local_419[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
				...
				case 102:
					if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_370) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_370, &(Local_419[iVar0 /*16*/]), 2))
					{
						...
						{
							if (fVar2 < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_98702))
							{
...
int func_29(int iParam0, float fParam1)//Position - 0x1637
{
	...
	while (iVar0 < 263)
	{
		...
		{
			if (Global_33208[iVar0 /*23*/].f_16 == 9)
			{
			}
			else
			{
				...
				if (BitTest(Global_33208[iVar0 /*23*/].f_11, 19))
				{
					iVar5 = 3;
					iVar4 = 0;
					while (iVar4 < iVar5)
...
int func_48(int iParam0, int iParam1)//Position - 0x1EB8
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_49(Global_101113) && iParam1 != 0)
		{
			Global_101113 = 0;
		}
	}
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114370.f_2366.f_539.f_2310[0];
			StringCopy(sParam2, func_67(Global_114370.f_2366.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_114370.f_2366.f_539.f_2310[1];
			StringCopy(sParam2, func_67(Global_114370.f_2366.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_114370.f_2366.f_539.f_2310[2];
			StringCopy(sParam2, func_67(Global_114370.f_2366.f_539.f_2314[2]), 32);
			return 1;
			break;
