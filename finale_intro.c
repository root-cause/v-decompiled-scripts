		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2.f_0, Param2, fParam3, true, true, false);
				...
				func_76(iParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
int func_25(int iParam0)//Position - 0x3FAE
{
	...
	if ((!func_26(PLAYER::PLAYER_ID()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger"))
	{
		return 0;
	}
	return 1;
...
int func_26(int iParam0)//Position - 0x3FEF
{
	if (iParam0 != func_19())
	{
...
int func_27(int iParam0)//Position - 0x4016
{
...
int func_28(int iParam0)//Position - 0x4045
{
...
int func_29(int iParam0)//Position - 0x40F6
{
	int iVar0;
...
int func_30(int iParam0)//Position - 0x416D
{
	switch (iParam0)
	{
		case joaat("mule"):
...
int func_31(int iParam0)//Position - 0x41BD
{
	if (iParam0 == func_19())
	{
		return 0;
...
int func_32(int iParam0, bool bParam1)//Position - 0x41F6
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_33(int iParam0)//Position - 0x4251
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x428A
{
	if (iParam1 == 0)
	{
...
int func_43(int iParam0, int iParam1)//Position - 0x4791
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_44(int iParam0)//Position - 0x4B70
{
	if (iParam0 != func_19())
	{
		if (func_18(iParam0, 1, 1))
...
int func_45(int iParam0)//Position - 0x4BCF
{
	if (iParam0 != func_19())
	{
		if (func_18(iParam0, 1, 1))
...
int func_46(int iParam0)//Position - 0x4C2F
{
	if (iParam0 != func_19())
	{
		if (func_18(iParam0, 1, 1))
...
int func_47(int iParam0, bool bParam1, var uParam2)//Position - 0x4C76
{
	bool bVar0;
...
int func_48(int iParam0)//Position - 0x50C2
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_49(int iParam0, int iParam1)//Position - 0x50EB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_50(int iParam0, var uParam1)//Position - 0x52ED
{
	int iVar0;
...
int func_52(int iParam0)//Position - 0x5648
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_54(int iParam0)//Position - 0x5719
{
...
int func_55(int iParam0)//Position - 0x57F6
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_56(int iParam0, bool bParam1, int iParam2)//Position - 0x59A8
{
	int iVar0;
	struct<2> Var1;
...
int func_57(int iParam0)//Position - 0x5B2A
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_59(int iParam0, int iParam1)//Position - 0x5C0D
{
	int iVar0;
	int iVar1;
...
int func_62()//Position - 0x926C
{
	return 0;
}

int func_63()//Position - 0x9275
{
	return 1;
}

int func_64()//Position - 0x927E
{
	return 1;
}

int func_65()//Position - 0x9287
{
...
int func_67(int iParam0)//Position - 0x9358
{
	int iVar0;
	char* sVar1;
...
int func_68(int iParam0)//Position - 0x939F
{
	int iVar0;
...
int func_69(int iParam0)//Position - 0x941B
{
	int iVar0;
...
int func_70(int iParam0)//Position - 0x9503
{
	int iVar0;
...
int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x9566
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	iVar0 = 0;
	while (func_72(iParam1, iVar0, &sVar1, &iVar2))
	{
...
int func_72(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x95D4
{
...
void func_73(int iParam0, int iParam1)//Position - 0x96AD
{
	int iVar0;
...
bool func_75(int iParam0)//Position - 0x975A
{
...
int func_77(int iParam0)//Position - 0x9943
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_79(int iParam0, int iParam1)//Position - 0x9A76
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_80(int iParam0, int iParam1)//Position - 0x9B5F
{
	int iVar0;
...
int func_81(int iParam0, int iParam1, int iParam2)//Position - 0x9BC1
{
...
int func_82()//Position - 0x9BE5
{
	return 0;
}

int func_83(var uParam0, int iParam1)//Position - 0x9BEE
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_84(int iParam0, var uParam1, int iParam2)//Position - 0x9C2F
{
	int iVar0;
...
bool func_85(int iParam0)//Position - 0x9E8B
{
	return iParam0 < 3;
}

int func_86(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x9E97
{
	int iVar0;
	struct<82> Var1;
	int iVar2;
...
void func_87(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x9F5C
{
	func_88(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_88(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x9F85
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_96(iVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_89(struct<3> Param0)//Position - 0xA37B
{
...
int func_93(int iParam0)//Position - 0xA4C9
{
	int iVar0;
	int iVar1;
...
int func_94(int iParam0)//Position - 0xA506
{
	if (func_85(iParam0))
	{
...
var func_95(int iParam0)//Position - 0xA52B
{
	return Global_2028[iParam0 /*29*/];
}

int func_96(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0xA53A
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_97(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_97(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_97(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_97(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_97(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_97(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_97(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_97(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_97(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_97(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_97(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_97(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_97(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_97(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_97(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_97(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4))
		{
			return 1;
		}
	}
...
int func_97(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0xA830
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_98(struct<3> Param0)//Position - 0xA8E4
{
	float fVar0;
	float fVar1;
...
void func_99(int iParam0)//Position - 0xA923
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_100(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0xA988
{
	func_88(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

bool func_101(struct<3> Param0, int iParam1)//Position - 0xA9B2
{
	return func_102(Global_104212.f_2890.f_12.f_66, Param0, iParam1);
}

int func_102(int iParam0, struct<3> Param1, int iParam2)//Position - 0xA9CF
{
	struct<3> Var0;
	struct<3> Var1;
...
Vector3 func_103()//Position - 0xAA39
{
	return 2.55f, 5.665f, 2.55f;
}

void func_104(struct<3> Param0, float fParam1, bool bParam2)//Position - 0xAA50
{
	int iVar0;
...
int func_109(int iParam0, int iParam1)//Position - 0xAD73
{
	int iVar0;
...
int func_111(int iParam0, int iParam1)//Position - 0xADF1
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_112(var uParam0, int iParam1)//Position - 0xAE11
{
	int iVar0;
	int iVar1;
...
bool func_113(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0xC502
{
	if (bParam2)
	{
...
int func_114(int iParam0, int iParam1)//Position - 0xC549
{
	struct<82> Var0;
...
int func_115(int iParam0, int iParam1, int iParam2)//Position - 0xC58B
{
	int iVar0;
...
void func_117(char* sParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC659
{
	struct<50> Var0;
	int iVar1;
...
void func_118(int iParam0, var uParam1, int iParam2)//Position - 0xC714
{
	int iVar0;
	var uVar1;
	struct<50> Var2;
	...
	while (iVar0 < 12)
	{
		...
		{
			if (func_199(iVar4, func_201(iVar0), func_200(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_201(iVar0)), &uVar1))
			{
				Var3 = { func_130(iVar4, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
				iVar5 = 1;
			}
			if (func_128(iVar4, func_201(iVar0), func_200(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_201(iVar0)), &uVar1))
			{
				Var3 = { func_130(iVar4, 1, uParam1->f_62, -1) };
	...
	while (iVar0 < 9)
	{
		...
		{
			if (func_199(iVar4, 14, func_120(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var3 = { func_130(iVar4, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
			...
			if (func_128(iVar4, 14, func_120(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var3 = { func_130(iVar4, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = Var3.f_3;
				(*uParam1)[1] = Var3.f_4;
	...
	if (iVar6 || iVar5)
	{
		iVar7 = func_200(iParam0, uParam1->f_13[1], (*uParam1)[1], 1);
		iVar8 = func_200(iParam0, uParam1->f_13[2], (*uParam1)[2], 2);
		iVar9 = func_119(iVar4, iVar8, iVar7);
		if (iVar9 != -99)
		{
			Var3 = { func_130(iVar4, 0, iVar9, -1) };
...
int func_119(int iParam0, int iParam1, int iParam2)//Position - 0xC989
{
	switch (iParam0)
	{
...
int func_120(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCAE0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_121(int iParam0, int iParam1)//Position - 0xCBDC
{
	int iVar0;
...
int func_122(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCD1A
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		if (iVar4 != -1)
		{
			return (func_123(iParam0, func_124(iParam2)) + iVar4);
		}
	}
	return -99;
}

int func_123(int iParam0, int iParam1)//Position - 0xCDD5
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_124(int iParam0)//Position - 0xD17C
{
	switch (iParam0)
	{
		case 0:
...
int func_125(int iParam0)//Position - 0xD22C
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_126(int iParam0)//Position - 0xD28D
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_128(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0xD372
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xD5FC
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
struct<14> func_130(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD637
{
	func_198();
...
void func_132(int iParam0)//Position - 0xD779
{
	...
	switch (iParam0)
	{
		...
		default:
			func_144(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_133(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_133(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xE9F0
{
	var uVar0;
	int iVar1;
...
int func_135(int iParam0, int iParam1)//Position - 0xF19A
{
	switch (iParam1)
	{
		case 0:
...
int func_136(int iParam0, int iParam1, int iParam2)//Position - 0xF595
{
	int iVar0;
	var uVar1;
...
int func_137(var uParam0)//Position - 0xF5D2
{
	int iVar0;
	int iVar1;
...
var func_138()//Position - 0xF606
{
	return Global_1574918;
}

int func_139(int iParam0, int iParam1)//Position - 0xF612
{
	switch (iParam1)
	{
		case 0:
...
int func_140(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xFA0D
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_141(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x108B2
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_142(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x108F1
{
	int iVar0;
...
void func_144(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x131D4
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_133(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_133(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_124(iParam0));
			if (iVar11 > iVar10)
			{
...
int func_199(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x24672
{
	int iVar0;
...
int func_200(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x24979
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_202(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x24A80
{
	int iVar0;
	int iVar1;
...
int func_203(int iParam0, var uParam1)//Position - 0x24C20
{
	int iVar0;
	var uVar1;
	
	iVar0 = Global_2848280[iParam0 /*3*/][func_137(uParam1)];
...
void func_204(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x24C4C
{
	int iVar0;
...
void func_205(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x25195
{
	int iVar0;
...
int func_210(int iParam0)//Position - 0x255AA
{
	int iVar0;
	int iVar1;
...
void func_211(var uParam0, int iParam1)//Position - 0x256BA
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_213(Global_113648.f_18535[iVar0], &Var2, &fVar3))
			{
...
int func_213(int iParam0, var uParam1, float fParam2)//Position - 0x2588E
{
	switch (iParam0)
	{
		case 11:
