...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		func_434("Force cleanup [TERMINATING]");
		func_415(1);
		func_402();
	}
	if (func_401())
	{
		Global_78935 = 1;
		iLocal_92 = 0;
		while (!func_391(&Local_96))
		{
			SYSTEM::WAIT(0);
		}
		func_390(&Local_96, 0, 1);
		Global_78935 = 0;
	}
	func_383(50, 1, 0);
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		func_367(Local_96.f_9, 0, 0, 0, 0, 0);
...
void func_70(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x5CBF
{
	int iVar0;
...
int func_71(int iParam0, var uParam1)//Position - 0x5CE2
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_72(uParam1));
}

int func_72(var uParam0)//Position - 0x5CF7
{
	int iVar0;
	int iVar1;
...
int func_73(int iParam0, int iParam1)//Position - 0x5D2B
{
	int iVar0;
	var uVar1;
...
bool func_74(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x5D5A
{
	int iVar0;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8759
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_76(int iParam0)//Position - 0x95FC
{
	if (!BitTest(Global_78472[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9644
{
	int iVar0;
...
int func_78(int iParam0)//Position - 0x96EF
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_79(int iParam0, int iParam1)//Position - 0x979F
{
	int iVar0;
	struct<10> Var1;
...
void func_80(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA0CE
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_81(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xA1F8
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_82(int iParam0, int iParam1)//Position - 0xA240
{
	int iVar0;
	struct<17> Var1;
...
void func_83(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC08A
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
int func_84(int iParam0)//Position - 0xC274
{
	switch (iParam0)
	{
		case 0:
...
void func_85(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xC324
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC395
{
	func_150();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_87(int iParam0, int iParam1)//Position - 0xC3E7
{
	switch (iParam0)
	{
		case 0:
...
void func_88(int iParam0)//Position - 0xC4D7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_89(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD74E
{
	var uVar0;
	int iVar1;
...
bool func_90(int iParam0, int iParam1, var uParam2)//Position - 0xDAF0
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_91(int iParam0, int iParam1)//Position - 0xDEF5
{
	switch (iParam1)
	{
		case 0:
...
int func_92(int iParam0, int iParam1)//Position - 0xE2F0
{
	switch (iParam1)
	{
		case 0:
...
int func_93(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE6EB
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_94(int iParam0)//Position - 0xE729
{
	return Global_43377 == iParam0;
}

int func_95(int iParam0)//Position - 0xE737
{
	switch (iParam0)
	{
		case -1:
...
void func_96(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE80B
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_97(int iParam0)//Position - 0xEA92
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_98(int iParam0)//Position - 0xEBE9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_99(int iParam0)//Position - 0xF0F7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(int iParam0)//Position - 0xF16C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_101(int iParam0)//Position - 0xF1E0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_102(int iParam0)//Position - 0xF2C7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_103(int iParam0)//Position - 0xF62A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_104(int iParam0)//Position - 0xF83B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0xFA6B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(int iParam0)//Position - 0xFB7B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0)//Position - 0x1051C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0x1108F
{
	if (iParam0 < 136)
	{
		func_110(iParam0);
...
void func_109(int iParam0)//Position - 0x110C4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0)//Position - 0x11CC8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0x12BD6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0x12D03
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0, int iParam1)//Position - 0x12E01
{
	switch (iParam0)
	{
		case 0:
...
void func_114(int iParam0)//Position - 0x12EF1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0x143E4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x14535
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0x14A40
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x150AE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x15122
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0x151F2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0x15722
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0x158B9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0x160B7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0x161C7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0x170F2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x17DAF
{
	if (iParam0 < 107)
	{
		func_129(iParam0);
...
void func_127(int iParam0)//Position - 0x17DF5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
			...
			if (((((iLocal_459 && !func_222(Local_96.f_28[0], joaat("SCRIPT_TASK_ENTER_VEHICLE"))) && !func_222(Local_96.f_28[0], joaat("SCRIPT_TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT"))) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_96.f_35[0], -1, false)) && !PED::IS_PED_FLEEING(Local_96.f_28[0])) && !iLocal_387)
			{
				if (!func_307() && !func_253())
				{
					...
					if (bVar0 || bParam0)
					{
						...
						if (bParam1)
						{
							TASK::TASK_ENTER_VEHICLE(Local_96.f_28[0], Local_96.f_35[0], 20000, -1, 2f, 1, 0);
						}
						else
						{
							TASK::TASK_ENTER_VEHICLE(Local_96.f_28[0], Local_96.f_35[0], 20000, -1, 1f, 1, 0);
						}
						if (func_210(Local_96.f_28[1]))
						{
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_96.f_28[1], Local_96.f_28[0], -1);
						...
						if ((((func_210(Local_96.f_28[2]) && !PED::IS_PED_FLEEING(Local_96.f_28[2])) && !iLocal_385) && !iLocal_463) && !PED::IS_PED_RAGDOLL(Local_96.f_28[2]))
						{
							if (bParam0 || (func_219(Local_96.f_35[1]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_96.f_35[1], true)))
							{
								...
								else if (func_219(Local_96.f_35[0]))
								{
									...
									TASK::TASK_ENTER_VEHICLE(0, Local_96.f_35[0], 20000, 0, 2f, 1, 0);
									TASK::CLOSE_SEQUENCE_TASK(iVar2);
									TASK::TASK_PERFORM_SEQUENCE(Local_96.f_28[2], iVar2);
									TASK::CLEAR_SEQUENCE_TASK(&iVar2);
								}
							...
							{
								TASK::TASK_ENTER_VEHICLE(Local_96.f_28[2], Local_96.f_35[1], 20000, 0, 1f, 1, 0);
							}
						}
...
void func_310()//Position - 0x2BCB5
{
	int iVar0;
	...
	if (func_210(Local_96.f_28[1]))
	{
		if ((((!func_222(Local_96.f_28[1], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) && !PED::IS_PED_FLEEING(Local_96.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_96.f_28[1], 0)) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_479)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_96.f_28[1], false))
		{
			...
			{
				PATHFIND::SET_ROADS_IN_ANGLED_AREA(Local_471, Local_474, fLocal_477, false, true, true);
				TASK::TASK_ENTER_VEHICLE(0, Local_96.f_35[1], 20000, -1, 2f, 1, 0);
			}
...
void func_311(int* iParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, bool bParam5, int iParam6)//Position - 0x2BDA3
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if (bParam5)
...
int func_312(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x2BE4F
{
	int iVar0;
	bool bVar1;
...
void func_313()//Position - 0x2BEA1
{
	switch (iLocal_325)
	{
		case 0:
			...
			if (MISC::GET_GAME_TIMER() > iLocal_356)
			{
				...
				if (func_350(1, 1093140480, 0))
				{
					...
					if (func_219(Local_96.f_35[0]))
					{
						func_347(Local_96.f_35[0], Local_419, fLocal_428, 0, 1);
						VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_96.f_35[0], 5f);
						VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_96.f_35[0], 1);
					}
					if (func_219(Local_96.f_35[1]))
					{
						func_347(Local_96.f_35[1], Local_422, fLocal_429, 0, 1);
						VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_96.f_35[1], 5f);
						VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_96.f_35[1], 1);
					}
					func_339(Local_326, Local_329, fLocal_332, -500.71f, 241.83f, 82.46f, 262.59f, 1, 1, 1, 0, 0);
					func_336(-484.2f, 229.68f, 82.21f, 1, 1, 1, 0, 1, 1, 1, 1, 1, 1);
...
void func_314(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2C3EA
{
	int iVar0;
...
void func_315(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2C494
{
	if (bParam0)
	{
...
bool func_317(int iParam0, int iParam1)//Position - 0x2C5FB
{
	bool bVar0;
...
int func_318(int iParam0, bool bParam1)//Position - 0x2C654
{
	int iVar0;
	int iVar1;
...
int func_319(var uParam0)//Position - 0x2C695
{
	int iVar0;
...
int func_320(int iParam0)//Position - 0x2C6B7
{
...
bool func_321()//Position - 0x2C6F6
{
	return BitTest(Global_2621446, 3);
}

int func_322(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x2C704
{
	int iVar0;
...
void func_323(int iParam0)//Position - 0x2C737
{
	if (iParam0 == 1)
	{
...
void func_324()//Position - 0x2C75A
{
	iLocal_388 = PED::CREATE_SYNCHRONIZED_SCENE(Local_399, Local_402, 2);
	PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_388, false);
	PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_388, false);
...
void func_325()//Position - 0x2C827
{
	func_330(0);
	func_329();
	func_326();
...
void func_326()//Position - 0x2C83C
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
int func_327(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2C894
{
...
void func_328(int iParam0)//Position - 0x2CA2C
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_329()//Position - 0x2CA58
{
...
void func_330(int iParam0)//Position - 0x2CAA9
{
	if (func_335())
	{
		return;
...
void func_331(int iParam0)//Position - 0x2CADC
{
	if (func_335())
	{
		return;
...
void func_332(bool bParam0, bool bParam1)//Position - 0x2CB66
{
	if (bParam0)
	{
		if (func_334(0))
...
bool func_333()//Position - 0x2CBDA
{
	return BitTest(Global_1963795, 5);
}

int func_334(int iParam0)//Position - 0x2CBE8
{
	if (iParam0 == 1)
	{
		if (Global_20500.f_1 > 3)
...
bool func_335()//Position - 0x2CC3F
{
	return BitTest(Global_1963795, 19);
}

void func_336(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x2CC4E
{
	int iVar0;
...
Vector3 func_337(int iParam0)//Position - 0x2CE0C
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_338(bool bParam0)//Position - 0x2CE1F
{
	int iVar0;
...
void func_339(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x2CE5E
{
	func_340(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_340(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2CE87
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_341(struct<3> Param0)//Position - 0x2D27D
{
...
int func_342(int iParam0, int iParam1, bool bParam2)//Position - 0x2D2A7
{
	int iVar0;
	char* sVar1;
	int iVar9;
	...
	iVar0 = 0;
	while (func_343(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_343(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2D315
{
...
int func_344(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2D3EE
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_345(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2D6E4
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_346(int iParam0)//Position - 0x2D798
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_347(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2D7FD
{
	bool bVar0;
	float fVar1;
...
void func_348(int iParam0, bool bParam1)//Position - 0x2D859
{
...
void func_349()//Position - 0x2D895
{
	int iVar0;
...
int func_350(int iParam0, float fParam1, int iParam2)//Position - 0x2D8B5
{
	int iVar0;
...
bool func_351()//Position - 0x2D989
{
	bool bVar0;
...
void func_352(char* sParam0, bool bParam1)//Position - 0x2D9AC
{
	func_338(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_353()//Position - 0x2D9C2
{
	switch (iLocal_325)
	{
		case 0:
			...
			if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				if (func_210(PLAYER::PLAYER_PED_ID()))
				{
					func_366(&uLocal_158, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
				}
				func_365();
		...
		case 2:
			if (func_401())
			{
				func_364(Local_430, fLocal_433, 1, 0);
				func_354();
			}
			else
			{
...
void func_354()//Position - 0x2DC30
{
	func_362(1, 1);
	iLocal_324 = 1;
	iLocal_325 = 2;
	...
	if (func_210(PLAYER::PLAYER_PED_ID()) && !func_361())
	{
		func_359(PLAYER::PLAYER_PED_ID(), Local_430);
	...
	{
		func_356(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1112014848, 12, 5000, 0, 0);
	}
	func_355(1, 1, 1);
}

void func_355(int iParam0, int iParam1, int iParam2)//Position - 0x2DD80
{
...
void func_356(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x2DDB4
{
	int iVar0;
	int iVar1;
...
void func_357()//Position - 0x2DE24
{
	Global_23251.f_6 = 1;
}

void func_358(int iParam0, int iParam1, int iParam2)//Position - 0x2DE32
{
	if (func_401() && func_361())
	{
...
Vector3 func_359(int iParam0, struct<3> Param1)//Position - 0x2DEF6
{
	var uVar0;
...
bool func_360(int iParam0)//Position - 0x2DF3C
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
bool func_361()//Position - 0x2DF5A
{
	return BitTest(Global_100833.f_20, 13);
}

void func_362(bool bParam0, bool bParam1)//Position - 0x2DF6B
{
	if (bParam0)
	{
		func_363(0, 1, 1);
	...
	func_336(0f, 0f, 0f, 0, 0, 0, 1, 1, 1, bParam1, 1, 1, 1);
}

void func_363(bool bParam0, int iParam1, int iParam2)//Position - 0x2DF9E
{
	bool bVar0;
...
void func_364(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2DFFD
{
	if (func_401())
	{
...
void func_365()//Position - 0x2E092
{
	if (func_210(Local_96.f_28[0]))
	{
		PED::SET_PED_MONEY(Local_96.f_28[0], 2000);
		PED::SET_PED_DIES_WHEN_INJURED(Local_96.f_28[0], true);
		func_366(&uLocal_158, 3, Local_96.f_28[0], "BEVERLY", 0, 1);
	}
	if (func_210(Local_96.f_28[1]))
	{
		func_366(&uLocal_158, 4, Local_96.f_28[1], "Pap4Cameraman", 0, 1);
	}
}

void func_366(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2E0F8
{
...
void func_367(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2E193
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_369(Global_78945, Global_78947, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_368(char* sParam0)//Position - 0x2E478
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_369(int iParam0, int iParam1, int iParam2)//Position - 0x2E48B
{
	struct<2> Var0;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_370(iVar2), 8);
					break;
			}
			break;
...
char* func_370(int iParam0)//Position - 0x2E562
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_371(int iParam0)//Position - 0x2E6B5
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_372(int iParam0)//Position - 0x2E6E9
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_373(int iParam0)//Position - 0x2E71D
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_374(int iParam0)//Position - 0x2E751
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_375(int iParam0)//Position - 0x2E785
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_376(int iParam0)//Position - 0x2E7C3
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_377(int iParam0)//Position - 0x2E7F7
{
	struct<2> Var0;
...
int func_378(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2E860
{
	if (((!func_380(0) || Global_78960) || Global_78948 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78944)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_334(0)) || func_379(1))
			{
			}
			else
			{
...
bool func_379(bool bParam0)//Position - 0x2E978
{
	if (bParam0)
	{
...
int func_380(int iParam0)//Position - 0x2E9A1
{
	if (Global_43377 == 15)
	{
		return 0;
...
bool func_381(int iParam0)//Position - 0x2E9C3
{
	return func_382(iParam0, Global_43377);
}

int func_382(int iParam0, int iParam1)//Position - 0x2E9D4
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_383(int iParam0, int iParam1, bool bParam2)//Position - 0x2EBB5
{
	int iVar0;
	...
	if (Global_117[iParam0 /*10*/].f_8 != 172)
	{
		...
		if (iParam1 == 4)
		{
			...
			func_388(iParam0, 1, 1);
			func_388(iParam0, 2, 1);
		}
		else
		{
			if (func_387(iParam0, iParam1) == 1 && func_386(iParam0, iParam1) == 1)
			{
				bParam2 = false;
			}
			iVar0 = iParam1;
			func_389(iParam0, iVar0, 1);
			func_388(iParam0, iVar0, 1);
		...
		if (bParam2)
		{
			if (!Global_78689)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9029[iParam1 /*4*/] = { func_385(iParam0) };
					...
					{
						Global_8980[1 /*6*/] = { func_385(iParam0) };
...
void func_384()//Position - 0x2ED33
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
struct<4> func_385(int iParam0)//Position - 0x2EDB0
{
	return Global_2058[iParam0 /*29*/].f_3;
}

int func_386(int iParam0, int iParam1)//Position - 0x2EDC3
{
...
int func_387(int iParam0, int iParam1)//Position - 0x2EDED
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_388(int iParam0, int iParam1, int iParam2)//Position - 0x2EE17
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_389(int iParam0, int iParam1, int iParam2)//Position - 0x2EE5C
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_390(var uParam0, bool bParam1, bool bParam2)//Position - 0x2EEA1
{
	int iVar0;
...
int func_391(var uParam0)//Position - 0x2EF96
{
	int iVar0[7];
	char* sVar8;
	int iVar9;
	...
	switch (iLocal_92)
	{
		...
		case 1:
			if (!func_400(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar8))
			{
				return 0;
			}
			iLocal_92 = 2;
		...
		case 2:
			...
			{
				if (func_397(&(uParam0->f_28[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
			...
			{
				func_395(&(uParam0->f_28[1]), iVar0[3], -498.16565f, 228.62839f, 82.09948f, 292.9763f, 26);
			...
			{
				func_395(&(uParam0->f_28[2]), iVar0[4], -498.30902f, 227.91116f, 82.105995f, 296.4216f, 26);
			...
			{
				func_393(&(uParam0->f_35[0]), iVar0[1], -497.99f, 224.97f, 82.67f, 266.5f);
			...
			{
				func_393(&(uParam0->f_35[1]), iVar0[2], -501.55f, 230.7f, 83.1f, 233.93f);
			...
			{
				func_392(&(uParam0->f_41[0]), iVar0[5], -490.11f, 233.15f, 82.1f, 0f);
			...
			{
				func_392(&(uParam0->f_41[1]), iVar0[6], -490.11f, 233.15f, 82.1f, 0f);
...
void func_392(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x2F553
{
	func_227(iParam0);
...
void func_393(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x2F57A
{
	func_394(iParam0);
...
void func_394(int* iParam0)//Position - 0x2F5BC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_395(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x2F658
{
	func_396(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_396(int* iParam0)//Position - 0x2F679
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_397(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x2F6BA
{
	if (func_398(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_398(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2F716
{
	int iVar0;
...
int func_399(var uParam0, int iParam1)//Position - 0x2F7A4
{
	int iVar0;
...
int func_400(int iParam0)//Position - 0x2F7EA
{
	int iVar0;
...
void func_402()//Position - 0x2F83F
{
	func_349();
	if (func_414())
	{
	...
	func_403(&Local_96, 0, 0, 0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_403(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2F863
{
	func_409(uParam0, iParam1);
	func_406(uParam0, bParam2);
	func_404(uParam0, bParam3);
}

void func_404(var uParam0, bool bParam1)//Position - 0x2F883
{
	func_405(&(uParam0->f_41), bParam1);
}

void func_405(var uParam0, bool bParam1)//Position - 0x2F895
{
	int iVar0;
...
void func_406(var uParam0, bool bParam1)//Position - 0x2F8D3
{
	func_407(&(uParam0->f_35), bParam1);
}

void func_407(var uParam0, bool bParam1)//Position - 0x2F8E5
{
	int iVar0;
...
void func_408(int* iParam0)//Position - 0x2F922
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_409(var uParam0, int iParam1)//Position - 0x2F95A
{
	func_410(&(uParam0->f_28), iParam1);
}

void func_410(var uParam0, int iParam1)//Position - 0x2F96C
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_411(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_411(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2F9AD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_412()//Position - 0x2F9FD
{
	int iVar0;
	int iVar1;
	...
	if (func_210(Local_96.f_28[1]) && !FIRE::IS_ENTITY_ON_FIRE(Local_96.f_28[1]))
	{
		if (func_210(PLAYER::PLAYER_PED_ID()))
		{
			...
			else if (!PED::IS_PED_FLEEING(Local_96.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_96.f_28[1], true))
			{
				func_298();
				PED::SET_PED_FLEE_ATTRIBUTES(Local_96.f_28[1], 128, true);
				func_413(&(Local_96.f_28[1]), 500, 0);
			}
		}
		else
		{
	...
	if (func_210(Local_96.f_28[2]) && !FIRE::IS_ENTITY_ON_FIRE(Local_96.f_28[2]))
	{
		...
		if (func_210(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				PED::SET_PED_FLEE_ATTRIBUTES(Local_96.f_28[2], 128, true);
				func_413(&(Local_96.f_28[2]), 350, 1);
			}
		}
		else
		{
	...
	func_411(&(Local_96.f_28[0]), 1, 0, 1);
	func_411(&(Local_96.f_28[1]), 1, 0, 1);
	func_411(&(Local_96.f_28[2]), 1, 0, 1);
	func_408(&(Local_96.f_35[0]));
	func_408(&(Local_96.f_35[1]));
	PATHFIND::SET_ROADS_BACK_TO_ORIGINAL_IN_ANGLED_AREA(Local_471, Local_474, fLocal_477, 1);
	func_214();
}

void func_413(var uParam0, int iParam1, int iParam2)//Position - 0x2FD18
{
	int iVar0;
...
void func_415(bool bParam0)//Position - 0x2FE2E
{
	int iVar0;
	...
	if (!func_432())
	{
		...
		{
			func_163(iVar0, 1, 0);
			func_416(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_112897[iVar0 /*10*/].f_9 == -1)
...
void func_416(char* sParam0, int iParam1)//Position - 0x2FEFE
{
	if (Global_100833 != 12)
	{
		if (func_417(sParam0, 6, iParam1))
		{
...
int func_417(char* sParam0, int iParam1, int iParam2)//Position - 0x2FF26
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_418(char* sParam0)//Position - 0x300B9
{
...
int func_419()//Position - 0x3010F
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_420(&(Global_100833.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_420(char* sParam0, bool bParam1)//Position - 0x30133
{
	int iVar0;
	int iVar1;
	
	iVar0 = MISC::GET_HASH_KEY(sParam0);
	iVar1 = func_421(iVar0, 1);
	if (iVar1 == -1 && !bParam1)
	{
	}
	return iVar1;
...
int func_421(int iParam0, bool bParam1)//Position - 0x3015D
{
	int iVar0;
...
int func_423()//Position - 0x301E3
{
	...
	{
		if (func_418(&(Global_100833.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_424(bool bParam0)//Position - 0x3024F
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_425(int iParam0)//Position - 0x30263
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_426(int iParam0)//Position - 0x3029D
{
	if (iParam0 == 1)
	{
...
void func_427()//Position - 0x302D7
{
	Global_23251.f_5 = 1;
}

void func_428()//Position - 0x302E5
{
	Global_23251.f_5 = 0;
}

void func_429(bool bParam0)//Position - 0x302F3
{
	if (bParam0)
	{
		func_430();
...
void func_430()//Position - 0x30356
{
...
void func_431()//Position - 0x3037F
{
	Global_94989 = 0;
	Global_94990 = 0;
}

int func_432()//Position - 0x30391
{
...
void func_433()//Position - 0x303CF
{
	Global_100868 = 1;
...
void func_434(char* sParam0)//Position - 0x304BE
{
...
void func_435(var uParam0)//Position - 0x304D0
{
	func_436(&(uParam0->f_28));
	func_436(&(uParam0->f_35));
	func_436(&(uParam0->f_41));
}

void func_436(var uParam0)//Position - 0x304F0
{
	int iVar0;
...
int func_437(int iParam0)//Position - 0x3052A
{
	if (!func_155(iParam0))
	{
		return func_154(iParam0);
