...
int func_83()//Position - 0x23E2
{
	if (Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_318.f_9 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("nightclub_ground_floor_seats", Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_318.f_9, true, 0))
		{
			return 0;
		}
...
{
	func_85(0, &uLocal_93, 0, 2);
	func_85(1, &uLocal_93, 1, 1);
	func_85(2, &uLocal_93, 2, 2);
	func_85(3, &uLocal_93, 3, 1);
	func_85(5, &uLocal_93, 5, 1);
	func_85(6, &uLocal_93, 6, 2);
	func_85(7, &uLocal_93, 7, 1);
	func_85(8, &uLocal_93, 8, 2);
	func_85(9, &uLocal_93, 9, 1);
}
