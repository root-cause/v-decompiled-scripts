...
int func_83()//Position - 0x23E2
{
	if (Global_2657589[PLAYER::PLAYER_ID() /*466*/].f_321.f_10 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("nightclub_ground_floor_seats", Global_2657589[PLAYER::PLAYER_ID() /*466*/].f_321.f_10, true, 0))
		{
			return 0;
		}
...
void func_84()//Position - 0x2456
{
	...
	func_85(3, &uLocal_95, 3, 1);
	func_85(5, &uLocal_95, 5, 1);
	func_85(6, &uLocal_95, 6, 2);
	func_85(7, &uLocal_95, 7, 1);
	func_85(8, &uLocal_95, 8, 2);
	func_85(9, &uLocal_95, 9, 1);
}
