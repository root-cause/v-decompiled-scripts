		...
		switch (iLocal_248)
		{
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_435))
				{
					if (bLocal_502)
					{
						Global_114080[iLocal_249] = uLocal_501;
					}
					else
					{
...
void func_2(int iParam0)//Position - 0x1204
{
	int iVar0;
...
int func_4(int iParam0, bool bParam1)//Position - 0x1296
{
	int iVar0;
...
int func_5(int iParam0)//Position - 0x134E
{
	if (iParam0 == 1)
	{
...
void func_6(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x13A5
{
	int iVar0;
...
void func_9()//Position - 0x1515
{
	...
	{
		ENTITY::DETACH_ENTITY(iLocal_446, true, true);
		ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&iLocal_446);
	}
}
...
bool func_19(int iParam0)//Position - 0x1754
{
	return iParam0 < 3;
}

int func_20(int iParam0)//Position - 0x1760
{
	int iVar0;
	int iVar1;
...
int func_21(int iParam0)//Position - 0x179D
{
	if (func_19(iParam0))
	{
...
var func_22(int iParam0)//Position - 0x17C2
{
...
bool func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B3F
{
...
var func_38(int iParam0, int iParam1)//Position - 0x1F05
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_39()//Position - 0x1F1D
{
	return -1;
}
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21DB
{
...
void func_48(char[4] cParam0)//Position - 0x2231
{
	int iVar0;
...
void func_49(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x226C
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_51(var uParam0)//Position - 0x233F
{
}

void func_52(var uParam0, int iParam1, float fParam2)//Position - 0x2347
{
}
...
void func_55(var uParam0)//Position - 0x23D4
{
}

void func_56(char* sParam0)//Position - 0x23DC
{
...
void func_70(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2697
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x2980
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0)//Position - 0x2AC6
{
	if (func_77(iParam0))
	{
...
int func_76(int iParam0)//Position - 0x2AEA
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x2B1A
{
...
void func_79(int* iParam0)//Position - 0x2C02
{
	if (iLocal_445 == 1)
	{
...
void func_80(int* iParam0, int iParam1, bool bParam2)//Position - 0x2C21
{
	if (iLocal_445 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_81(int iParam0, bool bParam1, int iParam2)//Position - 0x2C74
{
	int iVar0;
...
int func_82(int iParam0, bool bParam1, bool bParam2)//Position - 0x2CBE
{
	int iVar0;
...
float func_83(bool bParam0, float fParam1, float fParam2)//Position - 0x2D62
{
	if (bParam0)
	{
		return fParam1;
...
float func_84(int iParam0, int iParam1, bool bParam2)//Position - 0x2D79
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_85(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2DD7
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_86(struct<3> Param0, struct<3> Param3)//Position - 0x2E68
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_87(struct<3> Param0)//Position - 0x2E89
{
	float fVar0;
	float fVar1;
...
int func_88(int iParam0)//Position - 0x2EC8
{
	var uVar0;
...
int func_95()//Position - 0x2F5E
{
	return 1;
}

float func_96(int iParam0, int iParam1)//Position - 0x2F67
{
...
void func_100(var uParam0, var uParam1)//Position - 0x308D
{
...
int func_102(int iParam0)//Position - 0x3110
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
{
	PED::SET_PED_COMPONENT_VARIATION(iLocal_238, 1, 0, 0, 0);
	PED::SET_PED_COMPONENT_VARIATION(iLocal_238, 11, 0, 0, 0);
	PED::SET_PED_PROP_INDEX(iLocal_238, 1, 0, 0, false, 1);
	PED::SET_PED_PROP_INDEX(iLocal_238, 0, 0, 0, false, 1);
	iLocal_446 = OBJECT::CREATE_OBJECT(joaat("prop_cs_protest_sign_01"), ENTITY::GET_ENTITY_COORDS(iLocal_238, true), true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_446, iLocal_238, PED::GET_PED_BONE_INDEX(iLocal_238, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
}

void func_105()//Position - 0x31A5
{
	iLocal_34 = joaat("U_M_M_Griff_01");
	StringCopy(&Local_232, "PBGR", 8);
	StringCopy(&Local_234, "GRIFF", 16);
	StringCopy(&Local_200, "Special_Ped@griff", 64);
	StringCopy(&Local_216, "Base", 64);
	bLocal_434 = !Global_4;
	iLocal_250 = 8;
	sLocal_301 = "PBGR_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to Griff. */;
	StringCopy(&Local_310, "PBGR_CONV_GM", 16);
	StringCopy(&Local_314, "PBGR_CONV_GT", 16);
	StringCopy(&Local_318, "PBGR_CONV_GF", 16);
	StringCopy(&cLocal_322, "special_ped@griff@base", 64);
	StringCopy(&cLocal_338, "special_ped@griff@intro", 64);
	iLocal_249 = 4;
	iLocal_253[0] = 8;
	iLocal_253[1] = 7;
	iLocal_253[2] = 8;
...
int func_109()//Position - 0x32A2
{
	return 1;
}

bool func_110(var uParam0)//Position - 0x32AB
{
	return func_111(Global_114135.f_20121, uParam0);
}

bool func_111(var uParam0, var uParam1)//Position - 0x32C0
{
	return (uParam0 && uParam1) != 0;
}

int func_112(char* sParam0)//Position - 0x32CF
{
...
void func_113(int iParam0)//Position - 0x33F6
{
	...
	if (iLocal_239)
	{
		...
		if (MISC::ARE_STRINGS_EQUAL(&uVar0, &Local_497))
		{
			func_13();
		}
		if (iParam0 == 1)
...
void func_114(int* iParam0)//Position - 0x34C5
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_117()//Position - 0x3515
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_446))
	{
		OBJECT::DELETE_OBJECT(&iLocal_446);
	}
}
