...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_283 = 49;
	iLocal_284 = 64;
	Local_210 = { ScriptParam_333.f_1[0 /*3*/] };
	func_118();
	...
	if (MISC::GET_GAME_TIMER() < Global_32223 + 10000 && !func_106())
	{
		func_113(0);
	}
	...
	iLocal_208 = PED::CREATE_PED(25, iLocal_36, Local_210, ScriptParam_333.f_17[0], false, true);
	func_103();
	...
	while (iVar0 == 1)
	{
		...
		switch (iLocal_216)
		{
			...
			case 5:
				...
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_208, Local_210, 1f, -1, 1f, 1024, ScriptParam_333.f_17[0]);
					iLocal_216 = 6;
				}
				break;
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_266))
				{
					if (bLocal_330)
					{
						Global_113331[iLocal_217] = uLocal_329;
					}
					else
					{
...
void func_9()//Position - 0x1515
{
	...
	{
		ENTITY::DETACH_ENTITY(iLocal_277, true, true);
...
float func_86(struct<3> Param0, struct<3> Param1)//Position - 0x2E68
{
...
void func_104()//Position - 0x313D
{
	...
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_277, iLocal_208, PED::GET_PED_BONE_INDEX(iLocal_208, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
}
...
void func_105()//Position - 0x31A3
{
	...
	bLocal_265 = !Global_3;
	iLocal_218 = 8;
	sLocal_226 = "PBGR_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to Griff. */;
...
int func_109()//Position - 0x32A0
{
	return 1;
}

bool func_110(var uParam0)//Position - 0x32A9
{
	return func_111(Global_113386.f_20117, uParam0);
}

bool func_111(var uParam0, var uParam1)//Position - 0x32BE
{
	return (uParam0 && uParam1) != 0;
}

int func_112(char* sParam0)//Position - 0x32CD
{
...
void func_113(int iParam0)//Position - 0x33F4
{
	var uVar0;
...
void func_114(int* iParam0)//Position - 0x34C3
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_115()//Position - 0x34E3
{
	struct<6> Var0;
...
void func_116()//Position - 0x3507
{
	func_117();
}

void func_117()//Position - 0x3513
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_277))
	{
