...
void func_57()//Position - 0x66E4
{
	...
	{
		if (func_61(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_60(PLAYER::PLAYER_PED_ID());
			if (func_59(iVar0) && (!func_58(14) || Global_113083))
			{
				if (Global_114135.f_2367.f_539.f_4321 != iVar0 && func_59(Global_114135.f_2367.f_539.f_4321))
				{
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x6F24
{
	...
	if (iParam5 == 0)
	{
		Global_79322[1 /*14*/] = { func_124(iVar10, iParam1, iParam2, -1) };
		if (!func_123(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_79322[1 /*14*/] = { func_124(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_79322[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_79322[1 /*14*/] = { func_124(iVar10, 14, uVar28[iVar1], -1) };
							func_91(iParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
							func_114(14);
							if (Global_79320 == 1)
							{
								iVar2 = 0;
			...
			{
				Global_79322[1 /*14*/] = { func_124(iVar10, iVar0, func_80(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_79322[1 /*14*/] = { func_124(iVar10, 14, uVar69[iVar1], -1) };
			func_91(iParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
			func_114(14);
			if (Global_79320 == 1)
			{
...
int func_72(int iParam0, int iParam1, int iParam2)//Position - 0x7735
{
	...
	{
		if (!func_188(iParam0, Global_114135.f_2367.f_539[iVar0 /*65*/].f_64, Global_114135.f_2367.f_539[iVar0 /*65*/].f_63))
		{
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8040
{
	...
	{
		if (!func_188(iParam0, Global_114135.f_2367.f_539[iVar0 /*65*/].f_61, Global_114135.f_2367.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_107(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[0], Global_114135.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_107(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[1], Global_114135.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_107(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[2], Global_114135.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
int func_122(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x10D31
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_123(int iParam0)//Position - 0x11BD4
{
	if (!BitTest(Global_79322[1 /*14*/].f_6, 0))
	{
		return 0;
...
void func_126(int iParam0)//Position - 0x11D5E
{
	...
	func_127(&(Global_79322[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_127(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x12FD5
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_120(func_130(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_120(func_129(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_120(iVar1, Global_79319);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_131(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x13F72
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_133(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x140CD
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_127(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_127(&(Global_79322[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_127(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79520)
		{
			...
			func_127(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_188(int iParam0, int iParam1, int iParam2)//Position - 0x25663
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_79322[1 /*14*/] = { func_124(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_79322[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_188(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_188(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_79322[2 /*14*/] = { func_124(iVar0, 14, iVar4, -1) };
									if (Global_79322[2 /*14*/].f_12 == iVar3)
									{
										if (func_188(iParam0, 14, iVar4))
										{
											if (!func_77(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_79322[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_79322[2 /*14*/] = { func_124(iVar0, iVar2, iVar1, -1) };
						if (!func_77(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_79322[2 /*14*/])))
						{
							return 0;
						}
					}
...
int func_194(var uParam0)//Position - 0x25AFE
{
	int iVar0;
...
int func_195(int iParam0)//Position - 0x25B20
{
...
int func_197(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x25B6D
{
	int iVar0;
...
int func_201(var uParam0, bool bParam1)//Position - 0x25C5E
{
...
int func_203(var uParam0, int iParam1, int iParam2, char* sParam3, char* sParam4)//Position - 0x25FF5
{
	if (BitTest(uParam0->f_113, iParam1) || BitTest(uParam0->f_114, iParam1))
	{
		return 1;
...
int func_211(int iParam0)//Position - 0x262B3
{
	if (iParam0 == 1)
	{
...
int func_217(bool bParam0)//Position - 0x26A44
{
...
void func_219(int iParam0, bool bParam1, int iParam2)//Position - 0x26ABD
{
	if (iParam2 == -1)
	{
		iParam2 = func_119();
...
int func_221(var uParam0, bool bParam1)//Position - 0x26B00
{
...
int func_223(int iParam0, int iParam1, int iParam2)//Position - 0x26D3D
{
...
void func_227(bool bParam0)//Position - 0x2764C
{
	bool bVar0;
	char cVar1[64];
...
char* func_228(bool bParam0)//Position - 0x277C6
{
	switch (bParam0)
	{
		case 0:
...
int func_231(int iParam0)//Position - 0x278F6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_236(var uParam0, int iParam1)//Position - 0x27C21
{
	int iVar0;
	var uVar1[78];
...
void func_241(var uParam0, float fParam1)//Position - 0x27DA2
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
int func_246(int iParam0)//Position - 0x27E18
{
	switch (iParam0)
	{
		case 60:
...
int func_250(int iParam0)//Position - 0x27F5D
{
	return Global_2201[iParam0 /*29*/].f_17;
}

void func_251(int iParam0, int iParam1, int iParam2, float fParam3)//Position - 0x27F6E
{
	int iVar0;
	int iVar1;
	float fVar2;
...
var func_253(int iParam0)//Position - 0x28003
{
	var uVar0;
...
int func_255(int iParam0)//Position - 0x28058
{
	if (!func_194(iParam0))
	{
		return 0;
...
void func_256(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x28077
{
	int iVar0;
...
int func_257(int iParam0)//Position - 0x28121
{
	if (func_26(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_259(int iParam0)//Position - 0x281EC
{
	if (*iParam0 != -1)
	{
