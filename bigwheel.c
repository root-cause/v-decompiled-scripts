...
void func_1(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, float fParam7, bool bParam8)//Position - 0x1E7
{
	...
	{
		iParam0->f_14 = (iParam0->f_14 + func_2(((((Var6.f_0 - iParam0->f_14) * 0.05f) * fVar5) * fParam7), -3f, 3f));
		iParam0->f_14.f_1 = (iParam0->f_14.f_1 + func_2(((((Var6.f_1 - iParam0->f_14.f_1) * 0.05f) * fVar5) * fParam7), -3f, 3f));
		iParam0->f_14.f_2 = (iParam0->f_14.f_2 + func_2(((((Var6.f_2 - iParam0->f_14.f_2) * 0.05f) * fVar5) * fParam7), -3f, 3f));
	}
	if (iParam0->f_26)
	{
...
void func_6(struct<3> Param0, struct<3> Param1, var uParam2, var uParam3, int iParam4)//Position - 0xAC0
{
	struct<3> Var0;
...
void func_7(struct<3> Param0, var uParam1, var uParam2, int iParam3)//Position - 0xAE3
{
	float fVar0;
...
void func_15(bool bParam0)//Position - 0xE40
{
	...
	if (func_30(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (bLocal_176)
		{
			...
			func_18(&Local_178, Var0, ENTITY::GET_ENTITY_ROTATION(PLAYER::PLAYER_PED_ID(), 2), 50f, Local_178.f_20, Local_178.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
...
void func_18(var uParam0, struct<3> Param1, struct<3> Param2, float fParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, float fParam10, bool bParam11)//Position - 0x1020
{
	uParam0->f_1 = { Param1 };
	uParam0->f_4 = { Param2 };
	uParam0->f_7 = fParam3;
...
void func_31()//Position - 0x14FC
{
	...
	func_43(64, 1, 0, 1, 0);
	func_41(&uLocal_188, -1703.854f, -1082.2223f, 42.006f, -8.3096f, 0f, -111.8213f, 0, 0);
	func_33();
	if (func_30(PLAYER::PLAYER_PED_ID()))
	{
		ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), true, false);
...
void func_41(var uParam0, struct<3> Param1, struct<3> Param2, int iParam3, int iParam4)//Position - 0x1D34
{
	func_42(uParam0);
...
void func_52(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x6165
{
	func_53(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_53(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x618E
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_63(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x686C
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_64(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x6B62
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x6F24
{
	...
	if (iParam1 == 12)
	{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_123(iVar10, 14, uVar12[iVar1], -1) };
		...
		if (iParam7 == 1)
		{
			Var14 = { func_123(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var14 = { func_123(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var14 = { func_123(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var14 = { func_123(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var14 = { func_123(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_123(iVar10, 14, uVar15[iVar1], -1) };
			func_91(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_114(14);
			if (Global_78339 == 1)
			{
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9EFE
{
	...
	else
	{
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_81(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
void func_125(int iParam0)//Position - 0x11861
{
	...
	func_126(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_132(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x13B8B
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_126(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_126(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_81(iParam0));
			if (iVar11 > iVar10)
			{
