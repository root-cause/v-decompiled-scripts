...
void func_7()//Position - 0x288
{
	if (Global_20488)
	{
		func_8(Global_20481, "SET_SOFT_KEYS", 2f, 0f, 13f, -1f, -1f, "CELL_201" /* GXT: CALL */, 0, 0, 0, 0);
		func_8(Global_20481, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, "CELL_213" /* GXT: NO */, 0, 0, 0, 0);
	}
	else
	{
...
void func_10()//Position - 0x3DF
{
	...
	if (func_18() == 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			func_14(Global_20481, "DISPLAY_VIEW", 23f, SYSTEM::TO_FLOAT(1), -1082130432, -1082130432, -1082130432);
		}
	}
...
{
	fLocal_23 = (Global_4542491[iParam0 /*3*/] - Local_18.f_0);
	fLocal_24 = (SYSTEM::COS(((3.14159f / 180f) * Local_18.f_0)) * (Global_4542491[iParam0 /*3*/].f_1 - Local_18.f_1));
...
{
	fLocal_27 = SYSTEM::SQRT(SYSTEM::VDIST2(Global_4542491[iParam0 /*3*/], Local_18));
	fLocal_28 = (Global_4542491[iParam0 /*3*/].f_2 - Local_18.f_2);
	return fLocal_27;
}

float func_13(int iParam0)//Position - 0x717
{
	fLocal_26 = SYSTEM::SQRT((((Global_4542491[iParam0 /*3*/] - Local_18.f_0) * (Global_4542491[iParam0 /*3*/] - Local_18.f_0)) + ((Global_4542491[iParam0 /*3*/].f_1 - Local_18.f_1) * (Global_4542491[iParam0 /*3*/].f_1 - Local_18.f_1))));
	return fLocal_26;
}
...
{
	fLocal_23 = (Global_22951 - Local_18.f_0);
	fLocal_24 = (SYSTEM::COS(((3.14159f / 180f) * Local_18.f_0)) * (Global_22951.f_1 - Local_18.f_1));
	fLocal_25 = MISC::ATAN2(fLocal_23, fLocal_24);
	if (fLocal_25 < 0f)
	{
		fLocal_25 = (fLocal_25 + 360f);
...
{
	fLocal_27 = SYSTEM::SQRT(SYSTEM::VDIST2(Global_22951, Local_18));
	fLocal_28 = (Global_22951.f_2 - Local_18.f_2);
	return fLocal_27;
}

float func_17()//Position - 0x836
{
	fLocal_26 = SYSTEM::SQRT((((Global_22951 - Local_18.f_0) * (Global_22951 - Local_18.f_0)) + ((Global_22951.f_1 - Local_18.f_1) * (Global_22951.f_1 - Local_18.f_1))));
	return fLocal_26;
}
