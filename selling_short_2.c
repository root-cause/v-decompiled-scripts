...
void func_33(bool bParam0)//Position - 0x27B1
{
...
bool func_34(int iParam0)//Position - 0x280B
{
...
void func_35(bool bParam0)//Position - 0x2829
{
	if (bParam0)
	{
		func_41();
...
void func_36(int iParam0)//Position - 0x288C
{
	if (func_39())
	{
		return;
...
void func_37(bool bParam0, bool bParam1)//Position - 0x2916
{
	if (bParam0)
	{
		if (func_40(0))
...
bool func_38()//Position - 0x298A
{
	return BitTest(Global_1963795, 5);
}

bool func_39()//Position - 0x2998
{
	return BitTest(Global_1963795, 19);
}

int func_40(int iParam0)//Position - 0x29A7
{
	if (iParam0 == 1)
	{
...
void func_44(int iParam0)//Position - 0x2B38
{
...
void func_45(char* sParam0)//Position - 0x2B9B
{
	STREAMING::REMOVE_ANIM_DICT(sParam0);
}

void func_46(int iParam0)//Position - 0x2BA9
{
	if (iParam0 != 0)
	{
...
void func_47(var uParam0)//Position - 0x2BBD
{
	int iVar0;
	char* sVar1;
	char* sVar2;
...
char* func_48(int iParam0)//Position - 0x2C32
{
	char* sVar0;
...
char* func_49(int iParam0)//Position - 0x2C48
{
	char* sVar0;
...
void func_50(var uParam0)//Position - 0x2C5D
{
	int iVar0;
...
void func_51(int* iParam0)//Position - 0x2CA9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_52(var uParam0)//Position - 0x2CEA
{
	int iVar0;
...
void func_53(int* iParam0)//Position - 0x2D13
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
