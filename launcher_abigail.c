...
int func_64(int iParam0, int iParam1)//Position - 0x4873
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_99(int iParam0)//Position - 0x87B0
{
...
var func_107(int iParam0)//Position - 0x8CF9
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8D1B
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8D32
{
	return uParam0 & 15;
}
...
bool func_115()//Position - 0x8E62
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_116()//Position - 0x8E78
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x8E8E
{
...
int func_118(bool bParam0)//Position - 0x8ED0
{
...
int func_123(int iParam0)//Position - 0xA963
{
	int iVar0;
...
void func_127(int iParam0)//Position - 0xAB01
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0)//Position - 0xABDD
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xACD6
{
...
int func_135(int iParam0)//Position - 0xAD3D
{
	int iVar0;
...
int func_136(int iParam0)//Position - 0xAD86
{
	if (func_137(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xADA6
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_138(int iParam0)//Position - 0xADC7
{
	switch (iParam0)
	{
		case 5:
...
int func_140(int iParam0)//Position - 0xAE97
{
	switch (iParam0)
	{
		case 5:
...
void func_141(var uParam0, bool bParam1, bool bParam2)//Position - 0xAEEA
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0xAFDF
{
	switch (iParam0)
	{
		case 5:
...
void func_144(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB089
{
	if (bParam0)
	{
...
bool func_146(int iParam0, int iParam1)//Position - 0xB1F0
{
	bool bVar0;
...
int func_148(var uParam0)//Position - 0xB28A
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xB2AC
{
...
int func_151(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB2F9
{
	int iVar0;
...
int func_154(char* sParam0)//Position - 0xB376
{
...
int func_160(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB4A9
{
...
void func_161(int iParam0)//Position - 0xB500
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_168(int iParam0)//Position - 0xB80D
{
	if (iParam0 == 1)
	{
...
int func_170(int iParam0)//Position - 0xB873
{
...
int func_171(int iParam0)//Position - 0xB8B4
{
	int iVar0;
...
int func_173(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB92B
{
	int iVar0;
...
void func_174(var uParam0, int iParam1)//Position - 0xBA62
{
	int iVar0;
...
bool func_175(int iParam0)//Position - 0xBAB1
{
	return func_176(iParam0, Global_44042);
}

int func_176(int iParam0, int iParam1)//Position - 0xBAC2
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_177(int iParam0)//Position - 0xBCA3
{
	if (Global_44042 == 15)
	{
		return 0;
...
int func_179(char* sParam0, int iParam1)//Position - 0xBCD6
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_181(int iParam0, int iParam1)//Position - 0xBD43
{
	switch (iParam0)
	{
		case 0:
...
int func_182(struct<3> Param0, bool bParam3)//Position - 0xC1B4
{
	int iVar0;
...
float func_183(bool bParam0, float fParam1, float fParam2)//Position - 0xC1E0
{
	if (bParam0)
	{
		return fParam1;
...
int func_184(int iParam0)//Position - 0xC1F7
{
	switch (iParam0)
	{
		case 0:
...
int func_185(var uParam0, int iParam1)//Position - 0xC286
{
	switch (uParam0->f_16)
	{
		case 0:
...
int func_187(var uParam0)//Position - 0xCA84
{
	float fVar0;
...
void func_188(int iParam0, int iParam1)//Position - 0xCB12
{
	if (iParam0 == 1)
	{
		if (!func_140(iParam1))
...
int func_189(bool bParam0)//Position - 0xCB76
{
	int iVar0;
...
int func_190(int iParam0)//Position - 0xCC0D
{
	if (func_137(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_191(int iParam0)//Position - 0xCC37
{
	bool bVar0;
...
var func_192()//Position - 0xD354
{
	return Global_101572.f_1;
}

int func_193()//Position - 0xD362
{
	if (Global_98435 != -1)
	{
...
var func_198()//Position - 0xD412
{
	return Global_1575083;
}

int func_199()//Position - 0xD41E
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_200(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD43A
{
	var uVar0;
...
void func_201(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD4C2
{
...
void func_202(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD4FD
{
...
void func_203(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD553
{
...
float func_204(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD5EE
{
	struct<3> Var0;
...
void func_205(int iParam0, var uParam1, char* sParam2)//Position - 0xD628
{
...
bool func_206(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD924
{
...
int func_207(char* sParam0, int iParam1, bool bParam2)//Position - 0xD972
{
	Global_22287 = 0;
...
bool func_210(int iParam0)//Position - 0xDCDA
{
	return func_211(iParam0, 20);
}

var func_211(int iParam0, int iParam1)//Position - 0xDCEA
{
...
float func_217(int iParam0, int iParam1, bool bParam2)//Position - 0xDF5C
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_218(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xDFBA
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_221(int iParam0, int iParam1)//Position - 0xE120
{
	bool bVar0;
	int iVar1;
...
void func_223(int iParam0)//Position - 0xE1CA
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_224(iParam0);
...
void func_224(int iParam0)//Position - 0xE1E1
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_226(int iParam0, bool bParam1)//Position - 0xE2F1
{
	struct<27> Var0;
...
void func_227(int iParam0, var uParam1, int iParam2)//Position - 0xE561
{
	int iVar0;
	int iVar1;
...
int func_228(int iParam0)//Position - 0xE8B9
{
...
int func_229(var uParam0)//Position - 0xE8D9
{
...
int func_230(var uParam0)//Position - 0xE8F1
{
...
void func_232(int* iParam0)//Position - 0xEC14
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_234(var uParam0, bool bParam1, bool bParam2)//Position - 0xECBF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_235(int iParam0, int iParam1)//Position - 0xEE7D
{
	int iVar0;
...
int func_236(var uParam0, bool bParam1, int iParam2)//Position - 0xEEAD
{
	int iVar0;
	int iVar1;
...
int func_237(int iParam0)//Position - 0xF169
{
...
int func_238(int iParam0, float fParam1)//Position - 0xF19D
{
	float fVar0;
...
bool func_239(int iParam0, float fParam1)//Position - 0xF213
{
	return func_240(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_240(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF22B
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_241(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xF2EC
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_242(int iParam0, int iParam1)//Position - 0xF418
{
	int iVar0;
...
int func_244(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xF527
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_245(struct<3> Param0, struct<3> Param3)//Position - 0xF5B8
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_246(struct<3> Param0)//Position - 0xF5D9
{
	float fVar0;
	float fVar1;
...
int func_248(int iParam0, int iParam1)//Position - 0xF633
{
	int iVar0;
...
int func_249(int iParam0)//Position - 0xF672
{
...
int func_250(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF69A
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_251(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF795
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_252(int iParam0, float fParam1)//Position - 0xF8A1
{
	var uVar0;
	struct<3> Var1;
...
int func_253(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF936
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_254(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF9C4
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_255(int iParam0)//Position - 0xFA0C
{
...
void func_256(int iParam0)//Position - 0xFA56
{
	int iVar0;
...
int func_257(int iParam0)//Position - 0xFAF3
{
	if (iParam0 == -1)
	{
		iParam0 = func_178();
...
int func_258(int iParam0)//Position - 0xFB88
{
...
int func_261(int iParam0)//Position - 0xFC07
{
...
int func_263(int iParam0)//Position - 0xFC79
{
	if (func_118(0))
	{
...
int func_264(int iParam0)//Position - 0xFCA1
{
	switch (*iParam0)
	{
		case 0:
...
int func_265(var uParam0)//Position - 0xFCE8
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
...
void func_266(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFE9A
{
	func_267(iParam0);
...
void func_267(int* iParam0)//Position - 0xFEDD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_268(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xFF79
{
...
int func_269(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xFFD5
{
	int iVar0;
...
int func_270(var uParam0, int iParam1)//Position - 0x10065
{
	int iVar0;
...
int func_271(int iParam0)//Position - 0x100AB
{
	int iVar0;
...
int func_273(var uParam0)//Position - 0x10118
{
	int iVar0;
	bool bVar1;
...
int func_274(int iParam0)//Position - 0x10223
{
	struct<27> Var0;
	bool bVar32;
...
int func_275(int iParam0)//Position - 0x10274
{
	char* sVar0;
...
int func_276(int iParam0)//Position - 0x1032D
{
	var uVar0;
...
int func_277(int iParam0)//Position - 0x103EE
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_279(int iParam0)//Position - 0x10555
{
...
int func_280(int iParam0)//Position - 0x10580
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_281(int iParam0)//Position - 0x105AB
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_282(int iParam0)//Position - 0x105D6
{
	if (func_258(iParam0))
	{
		return 0;
...
int func_284(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10625
{
	int iVar0;
...
int func_285(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x1068A
{
	int iVar0;
	struct<7> Var1;
...
int func_286(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10702
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_287(int iParam0, bool bParam1)//Position - 0x1077D
{
	char* sVar0;
...
int func_291(char* sParam0)//Position - 0x10854
{
	struct<6> Var0;
...
void func_296(int* iParam0, bool bParam1)//Position - 0x10908
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_299(int* iParam0)//Position - 0x10992
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_302(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10A1D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_303(int* iParam0)//Position - 0x10A6D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_304(var uParam0)//Position - 0x10AAE
{
	if (*uParam0 == -1)
	{
		return;
...
int func_308(int iParam0)//Position - 0x10B4A
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
