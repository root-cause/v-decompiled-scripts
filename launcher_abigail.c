...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112473[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_294(&(Global_112473[Var0.f_0 /*10*/].f_9));
			}
		}
		func_277(&Var0, 1);
	}
	iVar3[0] = 0;
	iVar3[1] = 1;
	if (!func_274(&iVar3, &Var0, Var1, 1f))
	{
		func_273();
	...
	while (true)
	{
		...
		func_215(Var0.f_0);
		func_208(&iLocal_56, &(Var0.f_9), Var1);
		switch (Var0.f_0)
		{
			case 0:
			...
			case 1:
				func_190(&Var0, Var1, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
		if (func_175(&Var0, 0))
		{
...
int func_61(int iParam0)//Position - 0x466B
{
...
int func_62(int iParam0, int iParam1)//Position - 0x4833
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x53D4
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x540F
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x5683
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x56BF
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5C0E
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5C52
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x63D1
{
	if (bParam2)
	{
...
int func_70(var uParam0)//Position - 0x6418
{
...
bool func_71(int iParam0)//Position - 0x6473
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x6483
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_74()//Position - 0x685F
{
	return Global_31959;
}

int func_75(int iParam0)//Position - 0x686A
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x687A
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x691C
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x7041
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x7099
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7143
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
...
Vector3 func_81(struct<3> Param0, float fParam1)//Position - 0x71D8
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_82(int iParam0)//Position - 0x721C
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x73A0
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x73AE
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7E75
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7EF7
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x7F4F
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x7F58
{
	switch (iParam0)
	{
		case 1:
...
int func_89()//Position - 0x81B9
{
	return func_90(PLAYER::PLAYER_ID());
}

int func_90(int iParam0)//Position - 0x81C9
{
	return MISC::GET_BITS_IN_RANGE(Global_2689235[iParam0 /*453*/].f_318.f_3, 28, 31);
}

int func_91(int iParam0)//Position - 0x81E6
{
	return func_72(iParam0, 0, 0);
}

int func_92(int iParam0)//Position - 0x81F6
{
	switch (iParam0)
	{
		case -1:
...
bool func_93()//Position - 0x8505
{
	return Global_100493.f_375 > 0;
}

var func_94()//Position - 0x8516
{
	var uVar0;
...
void func_95(var uParam0, int iParam1)//Position - 0x855C
{
	if (iParam1 <= 0)
	{
		return;
...
void func_96(var uParam0, int iParam1)//Position - 0x85E2
{
...
void func_97(var uParam0, int iParam1)//Position - 0x8615
{
	int iVar0;
	int iVar1;
...
int func_98(int iParam0, int iParam1)//Position - 0x8666
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_99(int iParam0)//Position - 0x8708
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_100(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_100(bool bParam0, int iParam1, int iParam2)//Position - 0x872A
{
	if (bParam0)
	{
		return iParam1;
...
int func_101(var uParam0)//Position - 0x8741
{
	return uParam0 & 15;
}

void func_102(var uParam0, int iParam1)//Position - 0x874E
{
...
void func_103(var uParam0, int iParam1)//Position - 0x8788
{
...
void func_104(var uParam0, int iParam1)//Position - 0x87C3
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_105()//Position - 0x87FF
{
	func_56();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_106(int iParam0)//Position - 0x8818
{
	var uVar0;
	char cVar1[24];
...
bool func_107()//Position - 0x8871
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_108()//Position - 0x8887
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_109(char* sParam0, int iParam1, int iParam2)//Position - 0x889D
{
...
int func_110(bool bParam0)//Position - 0x88DF
{
...
struct<2> func_111(int iParam0)//Position - 0x8907
{
	struct<2> Var0;
...
void func_112(int iParam0, var uParam1)//Position - 0x8D54
{
	switch (iParam0)
	{
		case 0:
...
int func_114(int iParam0)//Position - 0xA02C
{
	switch (iParam0)
	{
		case 0:
...
int func_115(int iParam0)//Position - 0xA372
{
	int iVar0;
...
void func_116(int iParam0)//Position - 0xA417
{
	struct<2> Var0;
...
void func_117(int iParam0)//Position - 0xA4B2
{
	if (iParam0 < 63)
	{
		func_118();
...
void func_119(int iParam0)//Position - 0xA510
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_120(int iParam0)//Position - 0xA569
{
...
void func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA61D
{
	func_123(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_123(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA632
{
	int iVar0;
...
int func_125(int iParam0, int iParam1, int iParam2)//Position - 0xA6E5
{
...
int func_126(int iParam0, int iParam1, int iParam2)//Position - 0xA700
{
	int iVar0;
...
int func_127(int iParam0)//Position - 0xA74C
{
	int iVar0;
...
int func_128(int iParam0)//Position - 0xA795
{
	if (func_129(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_129(int iParam0)//Position - 0xA7B5
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_130(int iParam0)//Position - 0xA7D6
{
	switch (iParam0)
	{
		case 5:
...
int func_132(int iParam0)//Position - 0xA8A6
{
	switch (iParam0)
	{
		case 5:
...
void func_133(var uParam0, bool bParam1, bool bParam2)//Position - 0xA8F9
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xA9EE
{
	switch (iParam0)
	{
		case 5:
...
void func_135(bool bParam0)//Position - 0xAA59
{
	int iVar0;
...
void func_136(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAA98
{
	if (bParam0)
	{
...
bool func_137()//Position - 0xABDB
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_138(int iParam0, int iParam1)//Position - 0xABF5
{
	bool bVar0;
...
int func_139(int iParam0, bool bParam1)//Position - 0xAC40
{
	int iVar0;
	int iVar1;
...
int func_140(int iParam0)//Position - 0xAC81
{
...
bool func_141()//Position - 0xACC0
{
	return BitTest(Global_2621446, 3);
}

int func_142(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xACCE
{
	int iVar0;
...
void func_144(int iParam0)//Position - 0xAD28
{
	if (iParam0 == 1)
	{
...
int func_145(char* sParam0)//Position - 0xAD4B
{
...
void func_146()//Position - 0xAD88
{
	Global_20471 = 0;
	func_147();
}

void func_147()//Position - 0xAD98
{
...
int func_151(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAE7E
{
...
void func_152(int iParam0)//Position - 0xB016
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_154(int iParam0)//Position - 0xB093
{
	if (func_159())
	{
		return;
...
void func_155(int iParam0)//Position - 0xB0C6
{
	if (func_159())
	{
		return;
...
void func_156(bool bParam0, bool bParam1)//Position - 0xB150
{
	if (bParam0)
	{
		if (func_158(0))
...
bool func_157()//Position - 0xB1C4
{
	return BitTest(Global_1958711, 5);
}

int func_158(int iParam0)//Position - 0xB1D2
{
	if (iParam0 == 1)
	{
...
bool func_159()//Position - 0xB229
{
	return BitTest(Global_1958711, 19);
}

int func_160(int iParam0)//Position - 0xB238
{
...
int func_161(int iParam0)//Position - 0xB279
{
	int iVar0;
...
void func_162(int iParam0)//Position - 0xB2BE
{
...
int func_163(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB2F0
{
	int iVar0;
...
void func_164(var uParam0, int iParam1)//Position - 0xB427
{
	int iVar0;
...
bool func_165(int iParam0)//Position - 0xB476
{
	return func_166(iParam0, Global_43052);
}

int func_166(int iParam0, int iParam1)//Position - 0xB487
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_167(int iParam0)//Position - 0xB668
{
	if (Global_43052 == 15)
	{
		return 0;
...
int func_168()//Position - 0xB68A
{
	return func_169(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_169(char* sParam0, int iParam1)//Position - 0xB69B
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_171(int iParam0, int iParam1)//Position - 0xB708
{
	switch (iParam0)
	{
		case 0:
...
int func_172(struct<3> Param0, bool bParam1)//Position - 0xBB77
{
	int iVar0;
...
float func_173(bool bParam0, float fParam1, float fParam2)//Position - 0xBBA3
{
	if (bParam0)
	{
		return fParam1;
...
int func_174(int iParam0)//Position - 0xBBBA
{
	switch (iParam0)
	{
		case 0:
...
int func_175(var uParam0, int iParam1)//Position - 0xBC49
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_176()//Position - 0xC430
{
	func_27(&(Global_103950.f_2890), &Global_103950, 0, 1, 1, 0);
}

int func_177(var uParam0)//Position - 0xC44B
{
	float fVar0;
...
void func_178(int iParam0, int iParam1)//Position - 0xC4D9
{
	if (iParam0 == 1)
	{
		if (!func_132(iParam1))
...
int func_179(bool bParam0)//Position - 0xC53D
{
	int iVar0;
...
int func_180(int iParam0)//Position - 0xC5D4
{
	if (func_129(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_181(int iParam0)//Position - 0xC5FE
{
	bool bVar0;
...
var func_182()//Position - 0xCD1B
{
	return Global_100480.f_1;
}

int func_183()//Position - 0xCD29
{
	if (Global_97363 != -1)
	{
...
bool func_186()//Position - 0xCD90
{
	return Global_100493.f_376 > 0;
}

bool func_187(int iParam0, int iParam1)//Position - 0xCDA1
{
	switch (iParam0)
	{
		case 5:
...
var func_188()//Position - 0xCDD9
{
	return Global_1575058;
}

int func_189()//Position - 0xCDE5
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_190(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xCE01
{
	var uVar0;
	
	if ((((func_129(PLAYER::PLAYER_PED_ID()) && func_129(uParam0->f_28[0])) && !func_148()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam6) && func_194(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_193(&uVar0, iParam4, uParam0->f_28[0], sParam5, 0, 1);
...
void func_191(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCE89
{
...
void func_192(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCEC4
{
...
void func_193(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCF1A
{
...
float func_194(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xCFB5
{
	struct<3> Var0;
...
{
	if (func_129(*uParam1) && func_129(PLAYER::PLAYER_PED_ID()))
	{
		switch (*iParam0)
		{
			case 0:
				iParam0->f_166 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(1000, 2000));
				func_193(&(iParam0->f_1), 3, *uParam1, "ABIGAIL", 0, 1);
			...
			case 1:
				if (MISC::GET_GAME_TIMER() > iParam0->f_166)
				{
					...
					else if (func_207(PLAYER::PLAYER_PED_ID(), *uParam1, 1) < 15f)
					{
						*iParam0 = 4;
					}
				}
			...
			case 4:
				if (func_196(&(iParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_52, Local_53, 8f, false, true, 0))
					{
...
bool func_196(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD2EB
{
	func_192(uParam0, 145, sParam1, iParam4, iParam5, iParam6);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
...
int func_197(char* sParam0, int iParam1, bool bParam2)//Position - 0xD339
{
	Global_21606 = 0;
...
bool func_200(int iParam0)//Position - 0xD6A1
{
	return func_201(iParam0, 20);
}

var func_201(int iParam0, int iParam1)//Position - 0xD6B1
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

void func_202()//Position - 0xD6C9
{
	int iVar0;
...
float func_207(int iParam0, int iParam1, bool bParam2)//Position - 0xD923
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_208(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD981
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_209(int iParam0, bool bParam1)//Position - 0xDA72
{
	if (iParam0 == -1)
	{
		return;
...
int func_210(int iParam0)//Position - 0xDAAE
{
	if (Global_78315 == iParam0)
	{
		if (Global_78316 == -1)
...
void func_211(int iParam0, int iParam1)//Position - 0xDAE7
{
	bool bVar0;
	int iVar1;
...
bool func_212()//Position - 0xDB85
{
	return Global_97750;
}

void func_213(int iParam0)//Position - 0xDB91
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_214(iParam0);
...
void func_214(int iParam0)//Position - 0xDBA8
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_215(int iParam0)//Position - 0xDC90
{
	if (iParam0 == -1)
	{
		iParam0 = func_168();
...
int func_216(int iParam0, bool bParam1)//Position - 0xDCB8
{
	struct<27> Var0;
...
void func_217(int iParam0, var uParam1, int iParam2)//Position - 0xDF28
{
	int iVar0;
	int iVar1;
...
int func_218(int iParam0)//Position - 0xE280
{
...
int func_219(var uParam0)//Position - 0xE2A0
{
...
int func_220(var uParam0)//Position - 0xE2B8
{
...
void func_221(var uParam0)//Position - 0xE2DD
{
	int iVar0;
	int iVar1;
...
void func_222(int* iParam0)//Position - 0xE5DB
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_223(var uParam0)//Position - 0xE606
{
	int iVar0;
...
int func_224(var uParam0, bool bParam1, bool bParam2)//Position - 0xE686
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_225(int iParam0, int iParam1)//Position - 0xE844
{
	int iVar0;
...
int func_226(var uParam0, bool bParam1, int iParam2)//Position - 0xE874
{
	int iVar0;
	int iVar1;
...
int func_227(int iParam0)//Position - 0xEB30
{
...
int func_228(int iParam0, float fParam1)//Position - 0xEB64
{
	float fVar0;
...
bool func_229(int iParam0, float fParam1)//Position - 0xEBDA
{
	return func_230(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_230(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEBF2
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
...
int func_231(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xECB3
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_232(int iParam0, int iParam1)//Position - 0xEDDF
{
	int iVar0;
...
int func_234(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEEEE
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
float func_235(struct<3> Param0, struct<3> Param1)//Position - 0xEF7F
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_236(struct<3> Param0)//Position - 0xEFA0
{
	float fVar0;
	float fVar1;
...
void func_237(var uParam0)//Position - 0xEFDF
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_238(int iParam0, int iParam1)//Position - 0xEFFA
{
	int iVar0;
...
int func_239(int iParam0)//Position - 0xF039
{
...
int func_240(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF061
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_241(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF15C
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_242(int iParam0, float fParam1)//Position - 0xF268
{
	var uVar0;
	struct<3> Var1;
...
int func_243(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xF2FD
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_244(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF38B
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_245(int iParam0)//Position - 0xF3D3
{
...
void func_246(int iParam0)//Position - 0xF41D
{
	int iVar0;
...
int func_247(int iParam0)//Position - 0xF4BA
{
	if (iParam0 == -1)
	{
		iParam0 = func_168();
...
int func_248(int iParam0)//Position - 0xF54F
{
...
int func_251(int iParam0)//Position - 0xF5CE
{
	if ((func_252() && Global_100441.f_11 == 6) && iParam0 == func_169(&(Global_100441.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_253(int iParam0)//Position - 0xF640
{
	if (func_110(0))
	{
...
int func_255(var uParam0)//Position - 0xF6AF
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_262(&(uParam0->f_48), cLocal_55, "base", 0);
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_261(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(cLocal_55))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				if (!func_258(&(uParam0->f_28[0]), 16, -1596.09f, 5218.102f, 3.045f, 125.5f, "RC ABIGAIL 2", 1))
				{
					bVar2 = false;
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_256(&(uParam0->f_35[0]), iVar0[1], -1584.0127f, 5158.5386f, 18.6057f, 210.5309f);
...
void func_256(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xF861
{
	func_257(iParam0);
...
void func_257(int* iParam0)//Position - 0xF8A3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xF93F
{
	if (func_259(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_259(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xF99B
{
	int iVar0;
...
int func_260(var uParam0, int iParam1)//Position - 0xFA29
{
	int iVar0;
...
int func_261(int iParam0)//Position - 0xFA6F
{
	int iVar0;
...
void func_262(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xFAA0
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_263(var uParam0)//Position - 0xFADC
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_258(&(uParam0->f_28[0]), 16, -1607.918f, 5243.162f, 3.045f, 125.5f, "RC ABIGAIL 1", 1))
				{
					bVar1 = false;
				}
			}
...
int func_264(int iParam0)//Position - 0xFBE7
{
	struct<27> Var0;
	bool bVar1;
...
bool func_268(int iParam0, char* sParam1)//Position - 0xFE37
{
...
int func_269(int iParam0)//Position - 0xFF19
{
...
int func_270(int iParam0)//Position - 0xFF44
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_271(int iParam0)//Position - 0xFF6F
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_272(int iParam0)//Position - 0xFF9A
{
	if (func_248(iParam0))
	{
		return 0;
...
void func_273()//Position - 0xFFCF
{
	func_295("Running end routines.");
	Global_113104 = (Global_113104 - 1);
}

int func_274(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xFFE9
{
	int iVar0;
...
int func_275(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0x10050
{
	int iVar0;
	struct<7> Var1;
...
int func_276(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x100C8
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_277(int iParam0, bool bParam1)//Position - 0x10143
{
	...
	func_273();
	func_295("SCRIPT TERMINATING: ");
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_278(char* sParam0)//Position - 0x101CA
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_281(sParam0))
...
void func_279()//Position - 0x101E9
{
	Global_20471 = 0;
	func_280();
}

void func_280()//Position - 0x101F9
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22616 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_281(char* sParam0)//Position - 0x1021A
{
	struct<6> Var0;
...
struct<6> func_282()//Position - 0x1023A
{
	struct<6> Var0;
...
void func_283(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x1025E
{
...
void func_284(var uParam0, bool bParam1)//Position - 0x1027E
{
	func_285(&(uParam0->f_41), bParam1);
}

void func_285(var uParam0, bool bParam1)//Position - 0x10290
{
	int iVar0;
...
void func_286(int* iParam0, bool bParam1)//Position - 0x102CE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_287(var uParam0, bool bParam1)//Position - 0x10309
{
	func_288(&(uParam0->f_35), bParam1);
}

void func_288(var uParam0, bool bParam1)//Position - 0x1031B
{
	int iVar0;
...
void func_289(int* iParam0)//Position - 0x10358
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_290(var uParam0, int iParam1)//Position - 0x10390
{
	func_291(&(uParam0->f_28), iParam1);
}

void func_291(var uParam0, int iParam1)//Position - 0x103A2
{
	int iVar0;
...
void func_292(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x103E3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_293(int* iParam0)//Position - 0x10433
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_294(var uParam0)//Position - 0x10474
{
	if (*uParam0 == -1)
	{
		return;
...
void func_295(char* sParam0)//Position - 0x104B1
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_296(var uParam0)//Position - 0x104C3
{
	*uParam0 = -1;
...
void func_297()//Position - 0x104F6
{
	func_295("Running start routines.");
	Global_113104++;
}

int func_298(int iParam0)//Position - 0x10510
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
