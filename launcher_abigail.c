...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113222[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_304(&(Global_113222[Var0.f_0 /*10*/].f_9));
			}
		}
		func_287(&Var0, 1);
	}
	iVar231[0] = 0;
	iVar231[1] = 1;
	if (!func_284(&iVar231, &Var0, Var61, 1f))
	{
		func_283();
	...
	while (true)
	{
		...
		func_225(Var0.f_0);
		func_218(&iLocal_98, &(Var0.f_9), Var61);
		switch (Var0.f_0)
		{
			case 0:
				func_205(&Var64, &(Var0.f_28[0]), "SONAR_PRE");
				break;
			
			case 1:
				func_200(&Var0, Var61, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
		if (func_185(&Var0, 0))
		{
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5E34
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x65F7
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x663E
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x66A9
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6ACB
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6ADB
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x7601
{
...
Vector3 func_84(struct<3> Param0)//Position - 0x7643
{
...
int func_86(int iParam0)//Position - 0x766F
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7771
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x7806
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_93(int iParam0, var uParam1)//Position - 0x84A4
{
	switch (iParam0)
	{
		case 0:
...
int func_99(int iParam0)//Position - 0x883B
{
...
var func_107(int iParam0)//Position - 0x8D91
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8DB3
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8DCA
{
	return uParam0 & 15;
}
...
void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x8F30
{
...
int func_118(bool bParam0)//Position - 0x8F72
{
...
int func_123(int iParam0)//Position - 0xAA05
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAD78
{
...
int func_136(int iParam0)//Position - 0xAE28
{
	if (func_137(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xAE48
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_138(int iParam0)//Position - 0xAE69
{
	switch (iParam0)
	{
		case 5:
...
int func_140(int iParam0)//Position - 0xAF39
{
	switch (iParam0)
	{
		case 5:
...
void func_141(var uParam0, bool bParam1, bool bParam2)//Position - 0xAF8C
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0xB082
{
	switch (iParam0)
	{
		case 5:
...
void func_144(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB12C
{
	if (bParam0)
	{
...
int func_148(var uParam0)//Position - 0xB32F
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xB351
{
...
int func_151(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB39E
{
	int iVar0;
...
int func_154(char* sParam0)//Position - 0xB41B
{
...
int func_160(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB54E
{
...
void func_161(int iParam0)//Position - 0xB5A5
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_170(int iParam0)//Position - 0xB918
{
...
int func_171(int iParam0)//Position - 0xB959
{
	int iVar0;
...
int func_173(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB9D0
{
	int iVar0;
...
void func_174(var uParam0, int iParam1)//Position - 0xBB07
{
	int iVar0;
...
bool func_175(int iParam0)//Position - 0xBB56
{
	return func_176(iParam0, Global_44181);
}

int func_176(int iParam0, int iParam1)//Position - 0xBB67
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_177(int iParam0)//Position - 0xBD48
{
	if (Global_44181 == 15)
	{
		return 0;
...
int func_179(char* sParam0, int iParam1)//Position - 0xBD7B
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_181(int iParam0, int iParam1)//Position - 0xBDE8
{
	switch (iParam0)
	{
		case 0:
...
int func_182(struct<3> Param0, bool bParam3)//Position - 0xC25C
{
	int iVar0;
...
float func_183(bool bParam0, float fParam1, float fParam2)//Position - 0xC288
{
	if (bParam0)
	{
		return fParam1;
...
int func_184(int iParam0)//Position - 0xC29F
{
	switch (iParam0)
	{
		case 0:
...
int func_185(var uParam0, int iParam1)//Position - 0xC32E
{
	switch (uParam0->f_16)
	{
		case 0:
...
int func_187(var uParam0)//Position - 0xCB2C
{
	float fVar0;
...
void func_188(int iParam0, int iParam1)//Position - 0xCBBA
{
	if (iParam0 == 1)
	{
		if (!func_140(iParam1))
...
int func_189(bool bParam0)//Position - 0xCC1E
{
	int iVar0;
...
int func_190(int iParam0)//Position - 0xCCB5
{
	if (func_137(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_191(int iParam0)//Position - 0xCCDF
{
	bool bVar0;
...
var func_192()//Position - 0xD3FC
{
	return Global_101727.f_1;
}

int func_193()//Position - 0xD40A
{
	if (Global_98585 != -1)
	{
...
var func_198()//Position - 0xD4BA
{
	return Global_1575084;
}

int func_199()//Position - 0xD4C6
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_200(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD4E2
{
	var uVar0;
	
	if ((((func_137(PLAYER::PLAYER_PED_ID()) && func_137(uParam0->f_28[0])) && !func_157()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_204(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_203(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
		func_201(&uVar0, cParam4, sParam5, 7, 0, 0);
...
void func_201(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD56A
{
...
void func_203(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD5FB
{
...
float func_204(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD696
{
	struct<3> Var0;
...
void func_205(int iParam0, var uParam1, char* sParam2)//Position - 0xD6D0
{
	if (func_137(*uParam1) && func_137(PLAYER::PLAYER_PED_ID()))
	{
		switch (*iParam0)
		{
			case 0:
			...
			case 1:
				if (MISC::GET_GAME_TIMER() > iParam0->f_166)
				{
					...
					else if (func_217(PLAYER::PLAYER_PED_ID(), *uParam1, 1) < 15f)
					{
						*iParam0 = 4;
					}
				}
...
bool func_206(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD9CC
{
...
int func_207(char* sParam0, int iParam1, bool bParam2)//Position - 0xDA1A
{
	Global_22426 = 0;
...
var func_211(int iParam0, int iParam1)//Position - 0xDD92
{
...
float func_217(int iParam0, int iParam1, bool bParam2)//Position - 0xE004
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_218(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xE062
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_221(int iParam0, int iParam1)//Position - 0xE1C8
{
	bool bVar0;
	int iVar1;
...
void func_223(int iParam0)//Position - 0xE272
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_224(iParam0);
...
void func_224(int iParam0)//Position - 0xE289
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_226(int iParam0, bool bParam1)//Position - 0xE399
{
	struct<27> Var0;
...
int func_228(int iParam0)//Position - 0xE961
{
...
int func_229(var uParam0)//Position - 0xE981
{
...
int func_230(var uParam0)//Position - 0xE999
{
...
void func_232(int* iParam0)//Position - 0xECBC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_234(var uParam0, bool bParam1, bool bParam2)//Position - 0xED67
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_235(int iParam0, int iParam1)//Position - 0xEF25
{
	int iVar0;
...
int func_236(var uParam0, bool bParam1, int iParam2)//Position - 0xEF55
{
	int iVar0;
	int iVar1;
...
int func_237(int iParam0)//Position - 0xF211
{
...
int func_238(int iParam0, float fParam1)//Position - 0xF245
{
	float fVar0;
...
bool func_239(int iParam0, float fParam1)//Position - 0xF2BB
{
	return func_240(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_240(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF2D3
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_241(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xF394
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_242(int iParam0, int iParam1)//Position - 0xF4C0
{
	int iVar0;
...
int func_244(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xF5CF
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_245(struct<3> Param0, struct<3> Param3)//Position - 0xF660
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_246(struct<3> Param0)//Position - 0xF681
{
	float fVar0;
	float fVar1;
...
int func_248(int iParam0, int iParam1)//Position - 0xF6DB
{
	int iVar0;
...
int func_249(int iParam0)//Position - 0xF71A
{
...
int func_250(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF742
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_251(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF83D
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_252(int iParam0, float fParam1)//Position - 0xF949
{
	var uVar0;
	struct<3> Var1;
...
int func_253(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF9DE
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_254(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xFA6C
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_255(int iParam0)//Position - 0xFAB4
{
...
void func_256(int iParam0)//Position - 0xFAFE
{
	int iVar0;
...
int func_257(int iParam0)//Position - 0xFB9B
{
	if (iParam0 == -1)
	{
		iParam0 = func_178();
...
int func_258(int iParam0)//Position - 0xFC30
{
...
int func_261(int iParam0)//Position - 0xFCAF
{
...
int func_263(int iParam0)//Position - 0xFD21
{
	if (func_118(0))
	{
...
int func_264(int iParam0)//Position - 0xFD49
{
	switch (*iParam0)
	{
		case 0:
...
int func_265(var uParam0)//Position - 0xFD90
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_272(&(uParam0->f_48), cLocal_97, "base", 0);
			iLocal_89 = 1;
			break;
		
		case 1:
			if (!func_271(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(cLocal_97))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_266(&(uParam0->f_35[0]), iVar0[1], -1584.0127f, 5158.5386f, 18.6057f, 210.5309f);
...
void func_266(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFF42
{
	func_267(iParam0);
...
void func_267(int* iParam0)//Position - 0xFF85
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_268(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x10021
{
...
int func_269(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x1007D
{
	int iVar0;
...
int func_270(var uParam0, int iParam1)//Position - 0x1010B
{
	int iVar0;
...
int func_271(int iParam0)//Position - 0x10151
{
	int iVar0;
...
int func_273(var uParam0)//Position - 0x101BE
{
	int iVar0;
	bool bVar1;
...
int func_274(int iParam0)//Position - 0x102C9
{
	struct<27> Var0;
	bool bVar32;
...
int func_275(int iParam0)//Position - 0x1031A
{
	char* sVar0;
...
int func_276(int iParam0)//Position - 0x103D3
{
	var uVar0;
...
int func_277(int iParam0)//Position - 0x10494
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_279(int iParam0)//Position - 0x105FB
{
...
int func_280(int iParam0)//Position - 0x10626
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_281(int iParam0)//Position - 0x10651
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_282(int iParam0)//Position - 0x1067C
{
	if (func_258(iParam0))
	{
		return 0;
...
int func_284(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x106CB
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_285((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_285((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_285(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10730
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_286(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_286(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x107A8
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_287(int iParam0, bool bParam1)//Position - 0x10823
{
	char* sVar0;
...
int func_291(char* sParam0)//Position - 0x108FA
{
	struct<6> Var0;
...
void func_296(int* iParam0, bool bParam1)//Position - 0x109AE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_299(int* iParam0)//Position - 0x10A38
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_302(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10AC3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_303(int* iParam0)//Position - 0x10B13
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_304(var uParam0)//Position - 0x10B54
{
	if (*uParam0 == -1)
	{
		return;
...
int func_308(int iParam0)//Position - 0x10BF0
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
