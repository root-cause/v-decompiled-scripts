...
void __EntryFunction__()//Position - 0x0
{
	...
	iVar3[0] = 0;
	iVar3[1] = 1;
	if (!func_277(&iVar3, &Var0, Var1, 1f))
	{
		func_276();
	...
	while (true)
	{
		...
		func_218(Var0.f_0);
		func_211(&iLocal_56, &(Var0.f_9), Var1);
		switch (Var0.f_0)
		{
			case 0:
				func_198(&Var2, &(Var0.f_28[0]), "SONAR_PRE");
				break;
			
			case 1:
				func_193(&Var0, Var1, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
		if (func_178(&Var0, 0))
		{
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5CE8
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x64AB
{
	if (bParam2)
	{
...
int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6972
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_84(struct<3> Param0, float fParam1)//Position - 0x762F
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
int func_175(struct<3> Param0, bool bParam1)//Position - 0xC00A
{
	int iVar0;
...
int func_193(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xD290
{
	var uVar0;
	
	if ((((func_132(PLAYER::PLAYER_PED_ID()) && func_132(uParam0->f_28[0])) && !func_151()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam6) && func_197(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_196(&uVar0, iParam4, uParam0->f_28[0], sParam5, 0, 1);
...
float func_197(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xD444
{
	struct<3> Var0;
...
int func_234(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xF142
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
float func_238(struct<3> Param0, struct<3> Param1)//Position - 0xF40E
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_246(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xF78C
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_258(var uParam0)//Position - 0xFB3E
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_265(&(uParam0->f_48), cLocal_55, "base", 0);
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_264(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(cLocal_55))
			{
				return 0;
			}
			iLocal_51 = 2;
...
void func_259(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xFCF0
{
	func_260(iParam0);
...
int func_261(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xFDCE
{
	if (func_262(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_262(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xFE2A
{
	int iVar0;
...
int func_277(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x1047C
{
	int iVar0;
...
int func_278(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0x104E1
{
	int iVar0;
	struct<7> Var1;
...
int func_279(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x10559
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
