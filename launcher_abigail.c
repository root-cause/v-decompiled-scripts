...
void __EntryFunction__()//Position - 0x0
{
	...
	Local_92 = { -1593.813f, 5221.2354f, 1.94482f };
	Local_95 = { -1603.9861f, 5243.6235f, 4.940323f };
	uLocal_98 = func_301(16);
	...
	{
		func_298("Force cleanup [TERMINATING]");
		if (Var0.f_0 != -1)
		{
			if (Global_112735[Var0.f_0 /*10*/].f_9 != -1)
			{
				func_298("Relinquishing candidate id...");
				func_297(&(Global_112735[Var0.f_0 /*10*/].f_9));
			}
		}
		func_280(&Var0, 1);
	}
	iVar231[0] = 0;
	iVar231[1] = 1;
	if (!func_277(&iVar231, &Var0, Var61, 1f))
	{
		func_276();
		func_298("SCRIPT TERMINATED");
	...
	while (!func_257(&Var0))
	{
		...
		{
			func_298("Player out of range [TERMINATING]");
			func_280(&Var0, 1);
		}
	}
	...
	while (true)
	{
		...
		func_218(Var0.f_0);
		func_211(&iLocal_100, &(Var0.f_9), Var61);
		switch (Var0.f_0)
		{
			case 0:
				func_198(&Var64, &(Var0.f_28[0]), "SONAR_PRE");
				break;
			
			case 1:
				func_193(&Var0, Var61, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
		if (func_178(&Var0, 0))
		{
			if (func_177(Var0.f_0))
			{
				func_174(Var0.f_0, &iLocal_101);
			}
			if (!func_2(&Var0))
			{
				func_280(&Var0, 1);
...
int func_2(int iParam0)//Position - 0x2BB
{
	...
	if (!func_173())
	{
		while (!func_164(*iParam0))
		{
			...
			{
				func_298("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			SYSTEM::WAIT(0);
		}
	...
	if (!func_118(iParam0))
	{
		func_298("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x38FE
{
	int iVar0;
	var uVar1;
...
int func_50(var uParam0)//Position - 0x393B
{
	int iVar0;
	int iVar1;
...
int func_51()//Position - 0x396F
{
	return Global_1574918;
}

int func_52(int iParam0, int iParam1)//Position - 0x397B
{
	int iVar0;
	var uVar1;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39A7
{
	int iVar0;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EF0
{
	int iVar0;
...
int func_55()//Position - 0x4133
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_56()//Position - 0x414C
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x4249
{
	return Global_43257 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x4257
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x434A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x45D2
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x4673
{
...
int func_62(int iParam0, int iParam1)//Position - 0x484D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x54AE
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x54E9
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x575D
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x5799
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5CE8
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5D2C
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x64AB
{
	if (bParam6)
	{
...
int func_70(var uParam0)//Position - 0x64F2
{
...
bool func_71(int iParam0)//Position - 0x654D
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x655D
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x65BE
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x6957
{
	return Global_32163;
}

int func_75(int iParam0)//Position - 0x6962
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6972
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x6A14
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_78()//Position - 0x7164
{
...
int func_79()//Position - 0x745F
{
	return Global_2652258.f_2650;
}

int func_80(struct<3> Param0)//Position - 0x746E
{
...
int func_81(int iParam0)//Position - 0x7498
{
	if (iParam0 != func_90())
	{
...
Vector3 func_82(int iParam0, int iParam1)//Position - 0x74F0
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_83(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x759A
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_84(struct<3> Param0, float fParam3)//Position - 0x762F
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_85(int iParam0)//Position - 0x7673
{
	struct<6> Var0;
...
struct<6> func_86(int iParam0)//Position - 0x77F7
{
	return func_87(iParam0);
}

struct<6> func_87(int iParam0)//Position - 0x7805
{
	struct<6> Var0;
...
int func_88(int iParam0, var uParam1)//Position - 0x82CD
{
	switch (iParam0)
	{
		case 0:
...
int func_89(int iParam0)//Position - 0x834F
{
	if (iParam0 != func_90())
	{
...
int func_90()//Position - 0x83A7
{
	return -1;
}

Vector3 func_91(int iParam0)//Position - 0x83B0
{
	switch (iParam0)
	{
		case 1:
...
int func_92()//Position - 0x8627
{
	return func_93(PLAYER::PLAYER_ID());
}

int func_93(int iParam0)//Position - 0x8637
{
	return MISC::GET_BITS_IN_RANGE(Global_2657589[iParam0 /*466*/].f_321.f_3, 28, 31);
}

int func_94(int iParam0)//Position - 0x8654
{
	return func_72(iParam0, 0, 0);
}

int func_95(int iParam0)//Position - 0x8664
{
	switch (iParam0)
	{
		case -1:
...
bool func_96()//Position - 0x898D
{
	return Global_100733.f_387 > 0;
}

var func_97()//Position - 0x899E
{
	var uVar0;
...
void func_98(var uParam0, int iParam1)//Position - 0x89E4
{
	if (iParam1 <= 0)
	{
		return;
...
void func_99(var uParam0, int iParam1)//Position - 0x8A6A
{
...
void func_100(var uParam0, int iParam1)//Position - 0x8A9D
{
	int iVar0;
	int iVar1;
...
int func_101(int iParam0, int iParam1)//Position - 0x8AEE
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_102(int iParam0)//Position - 0x8B90
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_103(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_103(bool bParam0, int iParam1, int iParam2)//Position - 0x8BB2
{
	if (bParam0)
	{
		return iParam1;
...
int func_104(var uParam0)//Position - 0x8BC9
{
	return uParam0 & 15;
}

void func_105(var uParam0, int iParam1)//Position - 0x8BD6
{
...
void func_106(var uParam0, int iParam1)//Position - 0x8C10
{
...
void func_107(var uParam0, int iParam1)//Position - 0x8C4B
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_108()//Position - 0x8C87
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_109(int iParam0)//Position - 0x8CA0
{
	var uVar0;
	char cVar1[24];
...
bool func_110()//Position - 0x8CF9
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_111()//Position - 0x8D0F
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_112(char* sParam0, int iParam1, int iParam2)//Position - 0x8D25
{
...
int func_113(bool bParam0)//Position - 0x8D67
{
...
struct<2> func_114(int iParam0)//Position - 0x8D8F
{
	struct<2> Var0;
...
void func_115(int iParam0, var uParam1)//Position - 0x91DC
{
	switch (iParam0)
	{
		case 0:
...
int func_117(int iParam0)//Position - 0xA4B4
{
	switch (iParam0)
	{
		case 0:
...
int func_118(int iParam0)//Position - 0xA7FA
{
	int iVar0;
	...
	if (func_148(&(iParam0->f_1)))
	{
		...
		{
			func_298("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::SET_SCRIPT_CAN_START_CUTSCENE(iVar0);
		}
		else
		{
			func_298("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_119(int iParam0)//Position - 0xA89F
{
	struct<2> Var0;
...
void func_120(int iParam0)//Position - 0xA93A
{
	if (iParam0 < 63)
	{
		func_121();
...
void func_122(int iParam0)//Position - 0xA998
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_123(int iParam0)//Position - 0xA9F1
{
...
int func_124(int iParam0)//Position - 0xAA74
{
	int iVar0;
...
void func_125(int iParam0, int iParam1, int iParam2)//Position - 0xAAA5
{
	func_126(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_126(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAABA
{
	int iVar0;
...
int func_128(int iParam0, int iParam1, int iParam2)//Position - 0xAB6D
{
...
int func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAB88
{
	int iVar0;
...
int func_130(int iParam0)//Position - 0xABD4
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0xAC1D
{
	if (func_132(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_132(int iParam0)//Position - 0xAC3D
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_133(int iParam0)//Position - 0xAC5E
{
	switch (iParam0)
	{
		case 5:
...
void func_136(var uParam0, bool bParam1, bool bParam2)//Position - 0xAD81
{
	int iVar0;
...
int func_137(int iParam0)//Position - 0xAE76
{
	switch (iParam0)
	{
		case 5:
...
void func_138(bool bParam0)//Position - 0xAEE1
{
	int iVar0;
...
void func_139(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAF20
{
	if (bParam0)
	{
...
bool func_140()//Position - 0xB06D
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_141(int iParam0, int iParam1)//Position - 0xB087
{
	bool bVar0;
...
int func_142(int iParam0, bool bParam1)//Position - 0xB0D2
{
	int iVar0;
	int iVar1;
...
int func_143(int iParam0)//Position - 0xB113
{
...
bool func_144()//Position - 0xB152
{
	return BitTest(Global_2621446, 3);
}

int func_145(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB160
{
	int iVar0;
...
void func_147(int iParam0)//Position - 0xB1BA
{
	if (iParam0 == 1)
	{
...
int func_148(char* sParam0)//Position - 0xB1DD
{
	...
	func_298("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}

void func_149()//Position - 0xB21A
{
	Global_20591 = 0;
	func_150();
}

void func_150()//Position - 0xB22A
{
...
int func_154(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB310
{
...
void func_155(int iParam0)//Position - 0xB4A8
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_157(int iParam0)//Position - 0xB525
{
	if (func_162())
	{
		return;
...
void func_158(int iParam0)//Position - 0xB558
{
	if (func_162())
	{
		return;
...
void func_159(bool bParam0, bool bParam1)//Position - 0xB5E2
{
	if (bParam0)
	{
		if (func_161(0))
...
bool func_160()//Position - 0xB656
{
	return BitTest(Global_1962996, 5);
}

int func_161(int iParam0)//Position - 0xB664
{
	if (iParam0 == 1)
	{
...
bool func_162()//Position - 0xB6BB
{
	return BitTest(Global_1962996, 19);
}

int func_163(int iParam0)//Position - 0xB6CA
{
...
int func_164(int iParam0)//Position - 0xB70B
{
	int iVar0;
...
void func_165(int iParam0)//Position - 0xB750
{
...
int func_166(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB782
{
	int iVar0;
...
void func_167(var uParam0, int iParam1)//Position - 0xB8B9
{
	int iVar0;
...
bool func_168(int iParam0)//Position - 0xB908
{
	return func_169(iParam0, Global_43257);
}

int func_169(int iParam0, int iParam1)//Position - 0xB919
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_170(int iParam0)//Position - 0xBAFA
{
	if (Global_43257 == 15)
	{
		return 0;
...
int func_171()//Position - 0xBB1C
{
	return func_172(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_172(char* sParam0, int iParam1)//Position - 0xBB2D
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_174(int iParam0, int iParam1)//Position - 0xBB9A
{
	switch (iParam0)
	{
		case 0:
			*iParam1 = func_175(-1604.668f, 5239.1f, 3.01f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 66);
			HUD::SET_BLIP_COLOUR(*iParam1, 42);
			break;
		
		case 1:
			*iParam1 = func_175(-1592.84f, 5214.04f, 3.01f, 0);
		...
		case 2:
		case 3:
			*iParam1 = func_175(190.26f, -956.35f, 29.63f, 0);
		...
		case 4:
			*iParam1 = func_175(414f, -761f, 29f, 0);
		...
		case 9:
			*iParam1 = func_175(-1622.89f, 4204.87f, 83.3f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 66);
			HUD::SET_BLIP_COLOUR(*iParam1, 42);
			break;
		...
		case 13:
			if (iParam0 == 11)
			{
				*iParam1 = func_175(1835.53f, 4705.86f, 38.1f, 0);
			}
			else if (iParam0 == 12)
			{
				*iParam1 = func_175(1826.13f, 4698.88f, 38.92f, 0);
			}
			else
			{
				*iParam1 = func_175(637.02f, 119.7093f, 89.5f, 0);
			}
		...
		case 19:
			if (iParam0 == 18)
			{
				*iParam1 = func_175(-954.19f, -2760.05f, 14.64f, 0);
			}
			else
			{
				*iParam1 = func_175(-63.8f, -809.5f, 321.8f, 0);
			}
		...
		case 23:
			if (iParam0 == 21)
			{
				*iParam1 = func_175(-1877.82f, -440.649f, 45.05f, 0);
			}
			else
			{
				*iParam1 = func_175(-915.6f, 6139.2f, 5.5f, 0);
			}
		...
		case 27:
			*iParam1 = func_175(-1104.93f, 291.25f, 64.3f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 66);
			HUD::SET_BLIP_COLOUR(*iParam1, 44);
			break;
		...
		case 34:
			*iParam1 = func_175(-303.82f, 6211.29f, 31.05f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 386);
			HUD::SET_BLIP_COLOUR(*iParam1, 44);
			break;
		
		case 43:
			*iParam1 = func_175(-44.75f, -1288.67f, 28.21f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 149);
			HUD::SET_BLIP_COLOUR(*iParam1, 44);
			break;
		
		case 46:
			*iParam1 = func_175(-149.75f, 285.81f, 93.67f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 66);
			HUD::SET_BLIP_COLOUR(*iParam1, 43);
			break;
		...
		case 48:
			if (iParam0 == 47)
			{
				*iParam1 = func_175(-70.71f, 301.43f, 106.79f, 0);
			}
			else
			{
				*iParam1 = func_175(-257.22f, 292.85f, 90.63f, 0);
			}
...
int func_175(struct<3> Param0, bool bParam3)//Position - 0xC00A
{
	int iVar0;
...
float func_176(bool bParam0, float fParam1, float fParam2)//Position - 0xC036
{
	if (bParam0)
	{
		return fParam1;
...
int func_177(int iParam0)//Position - 0xC04D
{
	switch (iParam0)
	{
		case 0:
...
int func_178(var uParam0, int iParam1)//Position - 0xC0DC
{
	switch (uParam0->f_16)
	{
		case 0:
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_184(2))
							{
								if (func_182(uParam0->f_27))
								{
									...
									func_298("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.88849f, 371.9034f, 103.98843f, 241.58984f, 359.64575f, 107.34612f, 1.25f, false, true, 0))
					{
						if (func_184(2))
						{
							...
							{
								func_181(uParam0->f_27, *uParam0);
								func_298("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.9482f, 4143.44f, 42.292946f, 2722.2134f, 4144.5215f, 45.431824f, 10f, false, true, 0))
				{
					if (func_184(2))
					{
						...
						{
							func_181(1, *uParam0);
							func_298("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.11035f, 68.460175f, -1028.5663f, 395.46133f, 94.57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.75565f, 68.02096f, -1021.4514f, 336.34583f, 93.18714f, 14.5f, false, true, 0))
						{
							if (func_184(2))
							{
								...
								{
									func_181(uParam0->f_27, *uParam0);
									func_298("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_179()//Position - 0xC8BF
{
	func_27(&(Global_104212.f_2890), &Global_104212, 0, 1, 1, 0);
}

int func_180(var uParam0)//Position - 0xC8DA
{
	float fVar0;
...
void func_181(int iParam0, int iParam1)//Position - 0xC968
{
	if (iParam0 == 1)
	{
		if (!func_135(iParam1))
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_298("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_298("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
int func_182(bool bParam0)//Position - 0xC9CC
{
	int iVar0;
...
int func_183(int iParam0)//Position - 0xCA63
{
	if (func_132(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_184(int iParam0)//Position - 0xCA8D
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_192()) || Global_112695) || Global_32166) || func_191()) || func_190(8, -1)) || func_96()) || func_189()) || func_188()) || func_187()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_192()) || Global_32166) || func_191()) || func_190(8, -1)) || func_188()) || func_96()) || func_189()) || func_187()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_192()) || Global_112695) || Global_32166) || func_191()) || func_190(8, -1)) || func_188()) || func_96()) || func_189()) || func_187()) || Global_113648.f_7690.f_919[bVar0] == 5) || Global_43804 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_192()) || Global_112695) || Global_32166) || func_191()) || func_190(8, -1)) || func_96()) || func_189()) || func_187()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_192() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_190(8, -1)) || func_187()) || func_186()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_192()) || Global_32166) || func_191()) || func_190(8, -1)) || func_189()) || func_188()) || func_187()) || Global_113648.f_7690.f_919[bVar0] == 5)
							{
								return 0;
							}
						}
...
var func_185()//Position - 0xD1AA
{
	return Global_100720.f_1;
}

int func_186()//Position - 0xD1B8
{
	if (Global_97603 != -1)
	{
...
bool func_189()//Position - 0xD21F
{
	return Global_100733.f_388 > 0;
}

bool func_190(int iParam0, int iParam1)//Position - 0xD230
{
	switch (iParam0)
	{
		case 5:
...
var func_191()//Position - 0xD268
{
	return Global_1575060;
}

int func_192()//Position - 0xD274
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_193(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD290
{
	var uVar0;
	
	if ((((func_132(PLAYER::PLAYER_PED_ID()) && func_132(uParam0->f_28[0])) && !func_151()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_197(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_196(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
...
void func_194(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD318
{
...
void func_195(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD353
{
...
void func_196(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD3A9
{
...
float func_197(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD444
{
	struct<3> Var0;
...
void func_198(int iParam0, var uParam1, char* sParam2)//Position - 0xD47E
{
	if (func_132(*uParam1) && func_132(PLAYER::PLAYER_PED_ID()))
	{
		switch (*iParam0)
		{
			case 0:
				iParam0->f_166 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(1000, 2000));
				func_196(&(iParam0->f_1), 3, *uParam1, "ABIGAIL", 0, 1);
			...
			case 1:
				if (MISC::GET_GAME_TIMER() > iParam0->f_166)
				{
					...
					else if (func_210(PLAYER::PLAYER_PED_ID(), *uParam1, 1) < 15f)
					{
						*iParam0 = 4;
					}
				}
			...
			case 4:
				if (func_199(&(iParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_92, Local_95, 8f, false, true, 0))
					{
...
bool func_199(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD77A
{
	...
	Global_22722 = 0;
	Global_2883585 = 0;
	return func_200(sParam2, iParam3, 0);
}

int func_200(char* sParam0, int iParam1, bool bParam2)//Position - 0xD7C8
{
	Global_21726 = 0;
...
bool func_203(int iParam0)//Position - 0xDB30
{
	return func_204(iParam0, 20);
}

var func_204(int iParam0, int iParam1)//Position - 0xDB40
{
	return BitTest(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

void func_205()//Position - 0xDB58
{
	int iVar0;
...
float func_210(int iParam0, int iParam1, bool bParam2)//Position - 0xDDB2
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_211(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xDE10
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_212(int iParam0, bool bParam1)//Position - 0xDF01
{
	if (iParam0 == -1)
	{
		return;
...
int func_213(int iParam0)//Position - 0xDF3D
{
	if (Global_78554 == iParam0)
	{
		if (Global_78555 == -1)
...
void func_214(int iParam0, int iParam1)//Position - 0xDF76
{
	bool bVar0;
	int iVar1;
...
bool func_215()//Position - 0xE014
{
	return Global_97990;
}

void func_216(int iParam0)//Position - 0xE020
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_217(iParam0);
...
void func_217(int iParam0)//Position - 0xE037
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_218(int iParam0)//Position - 0xE11F
{
	if (iParam0 == -1)
	{
		iParam0 = func_171();
...
int func_219(int iParam0, bool bParam1)//Position - 0xE147
{
	struct<27> Var0;
	
	if (Global_78558)
	{
		func_298("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_115(*iParam0, &Var0);
	...
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_298("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_250(*iParam0))
	{
		...
		func_298("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (iParam0->f_25 == 1)
	{
	...
	if (*iParam0 == 10)
	{
		...
		{
			func_298("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_298("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
...
void func_220(int iParam0, var uParam1, int iParam2)//Position - 0xE3B7
{
	int iVar0;
	int iVar1;
...
int func_221(int iParam0)//Position - 0xE70F
{
...
int func_222(var uParam0)//Position - 0xE72F
{
...
int func_223(var uParam0)//Position - 0xE747
{
...
void func_224(var uParam0)//Position - 0xE76C
{
	int iVar0;
	int iVar1;
...
void func_225(int* iParam0)//Position - 0xEA6A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_226(var uParam0)//Position - 0xEA95
{
	int iVar0;
...
int func_227(var uParam0, bool bParam1, bool bParam2)//Position - 0xEB15
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_131(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				{
					func_298("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[iVar0], false))
				{
					func_298("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[iVar0], PLAYER::PLAYER_PED_ID(), false))
				{
					func_298("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[iVar0]) < 850)
				{
					func_298("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							func_298("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_183(iVar2))
						{
							if (ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck") || ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck2"))
							{
								if (func_183(uParam0->f_35[iVar0]))
								{
									...
									{
										func_298("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_183(iVar3))
						{
							...
							{
								func_298("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							...
							{
								func_298("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
...
int func_228(int iParam0, int iParam1)//Position - 0xECD3
{
	int iVar0;
...
int func_229(var uParam0, bool bParam1, int iParam2)//Position - 0xED03
{
	int iVar0;
	int iVar1;
	...
	if (func_131(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[iVar0]))
						{
							...
							func_298("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[iVar0]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[iVar0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[iVar0]))
					{
						...
						func_298("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[iVar0], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
						{
							...
							func_298("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_248(*uParam0))
					{
						if (!func_163(*uParam0))
						{
							if (func_243(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								...
								func_298("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[iVar0], true), 15f))
						{
							...
							func_298("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_231(uParam0->f_28[iVar0], 1126825984))
						{
							...
							func_298("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_230(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_298("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_298("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_132(uParam0->f_41[0]))
						{
...
int func_230(int iParam0)//Position - 0xEFBF
{
...
int func_231(int iParam0, float fParam1)//Position - 0xEFF3
{
	float fVar0;
...
bool func_232(int iParam0, float fParam1)//Position - 0xF069
{
	return func_233(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_233(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF081
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_234(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xF142
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_235(int iParam0, int iParam1)//Position - 0xF26E
{
	int iVar0;
...
int func_237(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xF37D
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_238(struct<3> Param0, struct<3> Param3)//Position - 0xF40E
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_239(struct<3> Param0)//Position - 0xF42F
{
	float fVar0;
	float fVar1;
...
void func_240(var uParam0)//Position - 0xF46E
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_241(int iParam0, int iParam1)//Position - 0xF489
{
	int iVar0;
...
int func_242(int iParam0)//Position - 0xF4C8
{
...
int func_243(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF4F0
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_244(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF5EB
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_245(int iParam0, float fParam1)//Position - 0xF6F7
{
	var uVar0;
	struct<3> Var1;
...
int func_246(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF78C
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_247(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF81A
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_248(int iParam0)//Position - 0xF862
{
...
void func_249(int iParam0)//Position - 0xF8AC
{
	int iVar0;
...
int func_250(int iParam0)//Position - 0xF949
{
	if (iParam0 == -1)
	{
		iParam0 = func_171();
...
int func_251(int iParam0)//Position - 0xF9DE
{
...
int func_254(int iParam0)//Position - 0xFA5D
{
	if ((func_255() && Global_100681.f_11 == 6) && iParam0 == func_172(&(Global_100681.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_256(int iParam0)//Position - 0xFACF
{
	if (func_113(0))
	{
...
int func_257(int iParam0)//Position - 0xFAF7
{
	switch (*iParam0)
	{
		case 0:
	...
	func_298("Created initial scene");
	return 1;
}

int func_258(var uParam0)//Position - 0xFB3E
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_265(&(uParam0->f_48), cLocal_99, "base", 0);
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_264(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(cLocal_99))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				if (!func_261(&(uParam0->f_28[0]), 16, -1596.09f, 5218.102f, 3.045f, 125.5f, "RC ABIGAIL 2", 1))
				{
					bVar4 = false;
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_259(&(uParam0->f_35[0]), iVar0[1], -1584.0127f, 5158.5386f, 18.6057f, 210.5309f);
...
void func_259(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFCF0
{
	func_260(iParam0);
...
void func_260(int* iParam0)//Position - 0xFD32
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_261(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xFDCE
{
...
int func_262(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xFE2A
{
	int iVar0;
...
int func_263(var uParam0, int iParam1)//Position - 0xFEB8
{
	int iVar0;
...
int func_264(int iParam0)//Position - 0xFEFE
{
	int iVar0;
...
void func_265(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xFF2F
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_266(var uParam0)//Position - 0xFF6B
{
	int iVar0;
	bool bVar1;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_261(&(uParam0->f_28[0]), 16, -1607.918f, 5243.162f, 3.045f, 125.5f, "RC ABIGAIL 1", 1))
				{
					bVar1 = false;
				}
			}
...
int func_267(int iParam0)//Position - 0x1007A
{
	struct<27> Var0;
	bool bVar32;
...
int func_268(int iParam0)//Position - 0x100CB
{
	char* sVar0;
	
	if (Global_78558)
	{
		func_298("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!Global_113648.f_9087 && !func_113(1))
	{
		func_298("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_269(iParam0))
	{
		Global_112735[iParam0 /*10*/].f_1 = 1;
		func_298("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_100681.f_11 == 6)
	{
		if (Global_100681 < 9)
		{
			...
			{
				func_298("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	...
	{
		Global_112735[iParam0 /*10*/].f_1 = 1;
		func_298("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}

int func_269(int iParam0)//Position - 0x10184
{
	var uVar0;
...
int func_270(int iParam0)//Position - 0x10245
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_271(int iParam0, char* sParam1)//Position - 0x102CA
{
...
int func_272(int iParam0)//Position - 0x103AC
{
...
int func_273(int iParam0)//Position - 0x103D7
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_274(int iParam0)//Position - 0x10402
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_275(int iParam0)//Position - 0x1042D
{
	if (func_251(iParam0))
	{
		return 0;
...
void func_276()//Position - 0x10462
{
	func_298("Running end routines.");
	Global_113366 = (Global_113366 - 1);
}

int func_277(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x1047C
{
	int iVar0;
	...
	func_298("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}

int func_278(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x104E1
{
	int iVar0;
	struct<7> Var1;
...
int func_279(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10559
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_280(int iParam0, bool bParam1)//Position - 0x105D4
{
	char* sVar0;
	
	if (bParam1)
	{
		func_298("SCRIPT TERMINATING: Cleaning up entities in Launcher");
	...
	if (iLocal_100 != -1)
	{
		func_298("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_217(&iLocal_100);
	}
	switch (*iParam0)
	{
	...
	func_276();
	func_298("SCRIPT TERMINATING: ");
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_281(char* sParam0)//Position - 0x1065B
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_284(sParam0))
...
void func_282()//Position - 0x1067A
{
	Global_20591 = 0;
	func_283();
}

void func_283()//Position - 0x1068A
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_284(char* sParam0)//Position - 0x106AB
{
	struct<6> Var0;
...
struct<6> func_285()//Position - 0x106CB
{
	struct<6> Var0;
...
void func_286(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x106EF
{
...
void func_287(var uParam0, bool bParam1)//Position - 0x1070F
{
	func_288(&(uParam0->f_41), bParam1);
}

void func_288(var uParam0, bool bParam1)//Position - 0x10721
{
	int iVar0;
...
void func_289(int* iParam0, bool bParam1)//Position - 0x1075F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_290(var uParam0, bool bParam1)//Position - 0x1079A
{
	func_291(&(uParam0->f_35), bParam1);
}

void func_291(var uParam0, bool bParam1)//Position - 0x107AC
{
	int iVar0;
...
void func_292(int* iParam0)//Position - 0x107E9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_293(var uParam0, int iParam1)//Position - 0x10821
{
	func_294(&(uParam0->f_28), iParam1);
}

void func_294(var uParam0, int iParam1)//Position - 0x10833
{
	int iVar0;
...
void func_295(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10874
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_296(int* iParam0)//Position - 0x108C4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_297(var uParam0)//Position - 0x10905
{
	if (*uParam0 == -1)
	{
		return;
...
void func_298(char* sParam0)//Position - 0x10942
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_299(var uParam0)//Position - 0x10954
{
	*uParam0 = -1;
...
void func_300()//Position - 0x10987
{
	func_298("Running start routines.");
	Global_113366++;
}

int func_301(int iParam0)//Position - 0x109A1
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
