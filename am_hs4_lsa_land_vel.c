...
void func_291(var uParam0)//Position - 0x33C1A
{
	...
	func_294(&uLocal_96, joaat("velum2"), "Plane");
	func_292(&uLocal_96, -1640.5961f, -3127.1133f, 14.5828f, -2.3352f, 0.0001f, 145.7214f, "HS4_LSA_LAND_VEL", 0, 1, uParam0->f_4, 0);
}

void func_292(var uParam0, struct<3> Param1, struct<3> Param4, char* sParam7, int iParam8, int iParam9, var uParam10, int iParam11)//Position - 0x33C67
{
...
void func_293(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x33C97
{
	uParam0->f_1 = uParam1;
	uParam0->f_2 = uParam3;
...
void func_294(var uParam0, int iParam1, char* sParam2)//Position - 0x33CC4
{
