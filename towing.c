...
void func_27()//Position - 0x190E
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_30(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_28(iVar0) && (!func_32(14) || Global_113083))
			{
...
void func_62(int iParam0, int iParam1)//Position - 0x3133
{
	...
	func_64(Global_114135.f_24908[iParam0 /*4*/], func_99(iParam0), iParam1, 0, 0);
	switch (iParam0)
	{
		case 3:
...
void func_68(bool bParam0)//Position - 0x3F65
{
	...
	else if (BitTest(Global_114135.f_20568.f_471, bParam0) || BitTest(Global_2359296[func_70() /*5571*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_114135.f_20568.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_70() /*5571*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
int func_77(int iParam0)//Position - 0x42AD
{
	...
	return BitTest(Global_2359296[func_70() /*5571*/].f_681.f_10, iParam0);
}
...
{
	Global_114135.f_19977.f_3++;
	Global_114135.f_19977.f_2 = iLocal_418;
	switch (iLocal_418)
	{
		case 2:
			Global_114135.f_19977.f_4++;
			break;
		
		case 3:
			Global_114135.f_19977.f_7++;
			break;
		
		case 0:
			Global_114135.f_19977.f_6++;
			break;
		
		case 1:
			Global_114135.f_19977.f_5++;
			break;
		
		case 4:
			Global_114135.f_19977.f_8++;
			break;
	}
}
...
void func_112()//Position - 0x56D0
{
	...
	if (((!ENTITY::IS_ENTITY_DEAD(iLocal_3107, false) && !ENTITY::IS_ENTITY_DEAD(Local_2994[0 /*20*/].f_6, false)) && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_3107, Local_2994[0 /*20*/].f_6)) || (Global_114135.f_19977.f_3 == 0 || Global_114135.f_19977.f_3 > 2))
	{
		return;
	}
	switch (iLocal_3048)
...
void func_140(int iParam0)//Position - 0x71DE
{
	...
	else if ((MISC::IS_PS3_VERSION() || func_141()) || MISC::IS_PC_VERSION())
	{
...
void func_145(int* iParam0, float fParam1, bool bParam2)//Position - 0x731D
{
...
int func_146(int* iParam0, float fParam1)//Position - 0x734B
{
...
void func_147(var uParam0, int iParam1, bool bParam2)//Position - 0x7369
{
	char* sVar0;
...
void func_148(var uParam0, struct<3> Param1, int iParam4, int iParam5, bool bParam6, int iParam7, bool bParam8)//Position - 0x7443
{
	int iVar0;
...
int func_150(int iParam0)//Position - 0x7786
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_151(var uParam0)//Position - 0x77E1
{
	int iVar0;
...
int func_153(char* sParam0)//Position - 0x78B6
{
	if (!func_154(1, 1, 0))
	{
...
int func_154(bool bParam0, bool bParam1, bool bParam2)//Position - 0x794F
{
	int iVar0;
	int iVar1;
...
int func_155(int iParam0)//Position - 0x7BA8
{
	if (iParam0 != func_20())
	{
		...
		else if ((Global_1575084 && iParam0 == PLAYER::PLAYER_ID()) && func_156(iParam0, 1, 0))
		{
			return Global_2657991[iParam0 /*467*/].f_324.f_8 != -1;
		}
	}
...
int func_156(int iParam0, bool bParam1, bool bParam2)//Position - 0x7C0E
{
	int iVar0;
...
int func_157(int iParam0, int iParam1)//Position - 0x7C6E
{
...
int func_158(int iParam0, bool bParam1)//Position - 0x7CD0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_163(int iParam0)//Position - 0x7D93
{
	if (iParam0 == 1)
	{
		if (Global_21066.f_1 > 3)
...
void func_164(var uParam0, struct<3> Param1, int iParam4)//Position - 0x7DEA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_165(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x7E86
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_166(bool bParam0, bool bParam1, bool bParam2)//Position - 0x81F3
{
...
int func_167(bool bParam0, bool bParam1, bool bParam2)//Position - 0x8245
{
	if (!func_154(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_168(bool bParam0, bool bParam1, bool bParam2)//Position - 0x828E
{
	if (!func_154(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_169(bool bParam0, bool bParam1, bool bParam2)//Position - 0x82ED
{
	if (!func_154(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_171(bool bParam0)//Position - 0x8353
{
...
bool func_172(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x837E
{
...
void func_175(char* sParam0, int iParam1, int iParam2)//Position - 0x8557
{
	iParam2 = iParam2;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
int func_176(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)//Position - 0x8570
{
	int iVar0;
	bool bVar1;
...
int func_177(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0x869A
{
	int iVar0;
	int iVar1;
...
int func_178(int iParam0, int iParam1)//Position - 0x886C
{
	int iVar0;
...
int func_179(int iParam0, int iParam1, var uParam2)//Position - 0x88C1
{
...
int func_180(int iParam0, int iParam1, var uParam2, bool bParam3)//Position - 0x890F
{
	struct<3> Var0;
	int iVar3;
...
int func_182(int iParam0, var uParam1)//Position - 0x8B56
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
bool func_183(var uParam0, int iParam1)//Position - 0x8BDB
{
	return (uParam0 && iParam1) != 0;
}

void func_184(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5, char* sParam6, char* sParam7, var uParam8, bool bParam9, var uParam10)//Position - 0x8BEA
{
	int iVar0;
...
void func_185(int iParam0, struct<3> Param1, struct<3> Param4)//Position - 0x8F24
{
...
int func_186(var uParam0, var uParam1, struct<3> Param2, var uParam5, var uParam6, var uParam7, float fParam8, char[4] cParam9, char* sParam10, int iParam11)//Position - 0x8F44
{
	var uVar0;
	int iVar1;
	int iVar2;
...
float func_187(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)//Position - 0x9193
{
...
Vector3 func_189(struct<3> Param0)//Position - 0x92CA
{
	float fVar0;
	float fVar1;
...
void func_192(int iParam0)//Position - 0x97EC
{
	iParam0->f_1 = 0;
...
void func_198(var uParam0, int iParam1)//Position - 0xA194
{
...
int func_199(int iParam0)//Position - 0xA304
{
	float fVar0;
...
void func_200(char* sParam0, int iParam1, bool bParam2, int iParam3, float fParam4, float fParam5, float fParam6, char* sParam7)//Position - 0xA389
{
	func_121(iParam1);
	if (bParam2)
	{
...
int func_203(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, var uParam85, var uParam86, var uParam87, var uParam88, var uParam89, var uParam90, var uParam91, var uParam92, var uParam93, var uParam94, var uParam95, var uParam96, var uParam97, var uParam98, var uParam99, var uParam100, var uParam101, var uParam102, var uParam103, var uParam104, var uParam105, var uParam106, var uParam107, var uParam108, var uParam109, var uParam110, var uParam111, var uParam112, var uParam113, var uParam114, var uParam115, var uParam116, var uParam117, var uParam118, var uParam119, var uParam120, var uParam121, var uParam122, var uParam123, var uParam124, var uParam125, var uParam126, var uParam127, var uParam128, var uParam129, var uParam130, var uParam131, var uParam132, var uParam133, var uParam134, var uParam135, var uParam136, var uParam137, var uParam138, var uParam139, var uParam140, var uParam141, var uParam142, var uParam143, var uParam144, var uParam145, var uParam146, var uParam147, var uParam148, var uParam149, var uParam150, var uParam151, var uParam152, var uParam153, var uParam154, var uParam155, var uParam156, var uParam157, var uParam158, var uParam159, var uParam160, var uParam161, var uParam162, var uParam163, var uParam164, char[4] cParam165, char* sParam166, var uParam167, bool bParam168)//Position - 0xB48D
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void func_204(struct<165> Param0, char* sParam165, char* sParam166, bool bParam167)//Position - 0xB4E9
{
	if (bParam167)
	{
		AUDIO::STOP_SCRIPTED_CONVERSATION(false);
...
int func_206(int iParam0, int iParam1, int iParam2)//Position - 0xB61B
{
	int iVar0;
...
void func_207(int iParam0)//Position - 0xB69E
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_208(int* iParam0, float fParam1)//Position - 0xB6F1
{
	if (!func_7(iParam0))
	{
...
int func_209(int iParam0, int iParam1, bool bParam2)//Position - 0xB70B
{
	int iVar0;
...
int func_212(int iParam0, int iParam1)//Position - 0xB85F
{
...
int func_215(int iParam0, int iParam1, struct<7> Param2, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, int* iParam22, var uParam23, char* sParam24, var uParam25, bool bParam26, var uParam27)//Position - 0xB94D
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_219(struct<7> Param0, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, int iParam20, int iParam21)//Position - 0xC048
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_220(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)//Position - 0xC11A
{
	int iVar0;
...
int func_221(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5)//Position - 0xC2E3
{
	int iVar0;
...
int func_222(int iParam0, int iParam1, int iParam2)//Position - 0xC443
{
	if (func_98(iParam0) == 3)
	{
		return 0;
...
void func_224(int iParam0, int* iParam1, var uParam2, var uParam3, char* sParam4, var uParam5, int iParam6, bool bParam7, var uParam8, bool bParam9, var uParam10, bool bParam11, int iParam12, bool bParam13)//Position - 0xC494
{
	int iVar0;
...
int func_225(var uParam0)//Position - 0xC826
{
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
...
void func_228(int* iParam0)//Position - 0xC915
{
	func_229(iParam0, &(iParam0->f_2), iParam0->f_1);
}

void func_229(int* iParam0, char* sParam1, int iParam2)//Position - 0xC92B
{
...
int func_230(var uParam0)//Position - 0xC9FC
{
	bool bVar0;
...
int func_234(var uParam0)//Position - 0xCEEB
{
	int iVar0;
...
int func_236(char* sParam0, char* sParam1, int iParam2)//Position - 0xCF60
{
...
int func_237(var uParam0)//Position - 0xD04B
{
	int iVar0;
...
void func_240(var uParam0, bool bParam1, int iParam2, char* sParam3, int iParam4)//Position - 0xD0DB
{
	int iVar0;
...
var func_246(var uParam0, int iParam1, int iParam2)//Position - 0xD2E9
{
	int iVar0;
	int iVar1;
...
int func_247(int iParam0, var uParam1)//Position - 0xD333
{
	int iVar0;
...
void func_258(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD618
{
...
int func_260(int iParam0)//Position - 0xD722
{
...
int func_261(int iParam0)//Position - 0xD750
{
	...
	if (iParam0 != 2)
	{
		if (Global_114135.f_19977.f_4 < iVar0)
		{
			iVar0 = Global_114135.f_19977.f_4;
			iVar1 = 2;
		}
	}
	if (iParam0 != 0)
	{
		if (Global_114135.f_19977.f_6 < iVar0)
		{
			iVar0 = Global_114135.f_19977.f_6;
			iVar1 = 0;
		}
	}
	if (iParam0 != 1)
	{
		if (Global_114135.f_19977.f_5 < iVar0)
		{
			iVar0 = Global_114135.f_19977.f_5;
			iVar1 = 1;
		}
	}
	if (iParam0 != 3)
	{
		if (Global_114135.f_19977.f_7 < iVar0)
		{
			iVar0 = Global_114135.f_19977.f_7;
			iVar1 = 3;
		}
	}
	if (iParam0 != 4)
	{
		if (Global_114135.f_19977.f_8 < iVar0)
		{
			iVar0 = Global_114135.f_19977.f_8;
			iVar1 = 4;
		}
	}
	return iVar1;
...
void func_264(int* iParam0)//Position - 0xD8FF
{
	if (!func_7(iParam0))
	{
		func_59(iParam0);
...
int func_280()//Position - 0x114A4
{
	...
	iVar0 = func_281(&(Global_101688.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_282(int iParam0, bool bParam1)//Position - 0x114F2
{
	int iVar0;
...
void func_286(bool bParam0)//Position - 0x115FD
{
...
void func_302(var uParam0, var uParam1)//Position - 0x11917
{
	*uParam0 = (*uParam0 || uParam1);
}

int func_303()//Position - 0x11928
{
