...
void __EntryFunction__()//Position - 0x0
{
	...
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_134(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_53) && !ENTITY::IS_ENTITY_DEAD(iLocal_53, false))
		{
			...
			fLocal_57 = SYSTEM::VDIST2(Local_55, ScriptParam_261.f_1[0 /*3*/]);
			fLocal_57 = fLocal_57;
			Local_75 = { Local_55 };
				...
				case 3:
					...
					else
					{
						...
						if (!func_114(3) && !Global_100715)
						{
							...
							{
								if ((!func_134(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_113())) && !Global_100715)
								{
									func_127(10);
									break;
								}
						...
						if (bVar2)
						{
							...
							if (bVar2)
							{
								...
								if (func_93(uLocal_54))
								{
									if (iLocal_60 == -1)
									{
										func_92(&iLocal_60, 4, sLocal_65, 0, 0, 0, 0);
										func_100(&uLocal_58, 2048);
									}
									else if (!func_134(uLocal_58, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_91(&iLocal_60);
				...
				case 6:
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_63 != -1)
						{
							if (func_134(Global_112299, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_20(iLocal_63), 0, Global_100718, 0);
								func_6(func_20(iLocal_63), 0, Global_100718, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_20(iLocal_63), 0, Global_100718, 0);
								func_6(func_20(iLocal_63), 0, Global_100718, 0, 0);
							}
						}
						func_5();
						func_141(&Global_112299, 0);
...
bool func_1(char* sParam0)//Position - 0x9EB
{
...
void func_6(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xA60
{
...
bool func_9()//Position - 0xB23
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_10()//Position - 0xB39
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_11(int* iParam0)//Position - 0xB4F
{
	iParam0->f_1 = 0f;
	iParam0->f_2 = 0f;
	*iParam0 = 0;
...
float func_12(int* iParam0)//Position - 0xB65
{
	if (func_15(iParam0))
	{
		if (func_14(iParam0))
...
float func_13(bool bParam0)//Position - 0xBA1
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_14(var uParam0)//Position - 0xBF9
{
	return BitTest(*uParam0, 2);
}

bool func_15(var uParam0)//Position - 0xC06
{
	return BitTest(*uParam0, 1);
}

int func_16()//Position - 0xC13
{
	return 1;
}

void func_17()//Position - 0xC1C
{
}

void func_18(char* sParam0, int iParam1, int iParam2)//Position - 0xC24
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_97751))
	{
...
int func_19(bool bParam0)//Position - 0xC65
{
...
char* func_20(int iParam0)//Position - 0xC8D
{
	switch (iParam0)
	{
		case 0:
...
void func_21(int iParam0)//Position - 0xDCB
{
	var uVar0;
	char cVar1[24];
...
void func_22(int* iParam0)//Position - 0xE22
{
	if (!func_15(iParam0))
	{
		func_25(iParam0);
...
void func_23(int* iParam0)//Position - 0xE43
{
	func_24(iParam0, 0f);
}

void func_24(int* iParam0, float fParam1)//Position - 0xE52
{
...
void func_25(int* iParam0)//Position - 0xE7D
{
	if (!func_15(iParam0))
	{
		func_23(iParam0);
...
int func_26()//Position - 0xE95
{
	int iVar0;
	
	Global_113648.f_18969 = iLocal_82;
	switch (iLocal_82)
	{
		case 4:
		case 8:
	...
	iVar0 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&Local_51, &Local_83, 170, iLocal_61);
	SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&Local_51);
	return iVar0;
}

void func_27(bool bParam0)//Position - 0xF0C
{
	int* iVar0;
	int iVar1;
	int iVar2;
	...
	Var6 = { func_71(SYSTEM::COS(Var6.f_2), SYSTEM::SIN(Var6.f_2), MISC::TAN(Var6.f_0)) };
	STREAMING::NEW_LOAD_SCENE_START(func_70(iLocal_82), Var6, 5000f, 0);
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			Var4 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - ENTITY::GET_ENTITY_COORDS(iLocal_255, false) };
			Var4.f_2 = 0f;
			...
			if (fVar7 > 0.8f)
			{
				...
				{
					TASK::TASK_GO_STRAIGHT_TO_COORD(0, Var5, 1f, -1, func_67(Var5, ENTITY::GET_ENTITY_COORDS(iLocal_255, false)), 0.5f);
				}
			}
			else if (fVar7 > 0.15f)
			{
				TASK::TASK_ACHIEVE_HEADING(0, func_67(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_255, false)), 0);
			}
	...
	func_25(&iLocal_251);
	while ((func_12(&iLocal_251) < 6f && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "pickup_object", "pickup_low", 3))
	{
		PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, true);
		SYSTEM::WAIT(0);
	}
	...
	while ((func_12(&iLocal_251) < 6f && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(PLAYER::PLAYER_PED_ID(), "pickup_object", "pickup_low") < 0.22f)
	{
		PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, true);
	...
	if (bParam0)
	{
		...
		CAM::SET_CAM_ACTIVE_WITH_INTERP(iVar3, iVar2, func_28(iLocal_82), 1, 1);
		func_23(&iVar0);
		while (func_12(&iVar0) < ((SYSTEM::TO_FLOAT(func_28(iLocal_82)) / 1000f) + 0.3f))
		{
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
			{
				PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, true);
...
int func_28(int iParam0)//Position - 0x13F8
{
	switch (iParam0)
	{
		case 4:
...
float func_29(int iParam0)//Position - 0x141D
{
	switch (iParam0)
	{
		case 4:
...
Vector3 func_30(int iParam0)//Position - 0x144D
{
	switch (iParam0)
	{
		case 4:
...
Vector3 func_31(int iParam0)//Position - 0x1487
{
	switch (iParam0)
	{
		case 4:
...
float func_32(int iParam0)//Position - 0x14C9
{
	switch (iParam0)
	{
		case 4:
...
Vector3 func_33(int iParam0)//Position - 0x14F9
{
	switch (iParam0)
	{
		case 4:
...
Vector3 func_34(int iParam0)//Position - 0x1533
{
	switch (iParam0)
	{
		case 4:
...
int func_35(struct<3> Param0)//Position - 0x1575
{
...
Vector3 func_36(int iParam0)//Position - 0x159F
{
	switch (iParam0)
	{
		case 4:
...
int func_37()//Position - 0x15E1
{
	func_38();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_38()//Position - 0x15FA
{
	int iVar0;
...
bool func_39(int iParam0)//Position - 0x16F7
{
	return iParam0 < 3;
}

int func_40(int iParam0)//Position - 0x1703
{
	int iVar0;
	int iVar1;
...
int func_41(int iParam0)//Position - 0x1740
{
	if (func_39(iParam0))
	{
...
var func_42(int iParam0)//Position - 0x1765
{
	return Global_2028[iParam0 /*29*/];
}

void func_43()//Position - 0x1774
{
	struct<3> Var0;
	var uVar1;
	struct<3> Var2;
	...
	func_51(0, 0, 1);
	iLocal_255 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("p_parachute_s"), func_50(iLocal_82), true, true, false);
	ENTITY::SET_ENTITY_ROTATION(iLocal_255, func_49(iLocal_82), 2, true);
	func_44(&Var0, &uVar1);
	Var2 = { 0f, 0f, uVar1 };
	iVar3 = PED::CREATE_SYNCHRONIZED_SCENE(Var0, Var2, 2);
	ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_255, iVar3, "puton_parachute_bag", "oddjobs@basejump@ig_15", 1000f, -1000f, 1, 1000f);
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
		TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iVar3, "oddjobs@basejump@ig_15", "puton_parachute", 1000f, -1000f, 0, 0, 1000f, 0);
	}
...
float func_45(float fParam0, float fParam1)//Position - 0x19CA
{
	if (fParam0 > fParam1)
	{
		return fParam1;
...
float func_46(float fParam0, float fParam1)//Position - 0x19E1
{
	if (fParam0 > fParam1)
	{
		return fParam0;
...
float func_47(float fParam0, float fParam1, float fParam2)//Position - 0x19F8
{
	float fVar0;
...
Vector3 func_48(int iParam0)//Position - 0x1A3A
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_49(int iParam0)//Position - 0x1B84
{
	switch (iParam0)
	{
		case 4:
...
Vector3 func_50(int iParam0)//Position - 0x1BFA
{
	switch (iParam0)
	{
		case 4:
...
void func_51(int iParam0, bool bParam1, int iParam2)//Position - 0x1C84
{
...
void func_52(int iParam0, bool bParam1)//Position - 0x1CDD
{
	if (bParam1)
	{
...
void func_53(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x1CFF
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_58(PLAYER::PLAYER_ID())) && !func_55(PLAYER::PLAYER_ID(), 0)) && !func_54()) && !bParam4) && !bParam5) && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
			{
...
bool func_54()//Position - 0x1E4C
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_55(int iParam0, int iParam1)//Position - 0x1E66
{
	bool bVar0;
...
int func_56(int iParam0, bool bParam1)//Position - 0x1EB1
{
	int iVar0;
	int iVar1;
...
int func_57()//Position - 0x1EF2
{
	return Global_1574918;
}

int func_58(int iParam0)//Position - 0x1EFE
{
...
bool func_59()//Position - 0x1F3D
{
	return BitTest(Global_2621446, 3);
}

int func_60(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x1F4B
{
	int iVar0;
...
void func_62(int iParam0)//Position - 0x1FA5
{
	if (iParam0 == 1)
	{
...
void func_63(int iParam0)//Position - 0x1FC8
{
	if (func_66())
	{
		return;
...
void func_64(bool bParam0, bool bParam1)//Position - 0x2052
{
	if (bParam0)
	{
		if (func_95(0))
...
bool func_65()//Position - 0x20C6
{
	return BitTest(Global_1962996, 5);
}

bool func_66()//Position - 0x20D4
{
	return BitTest(Global_1962996, 19);
}

float func_67(struct<2> Param0, Vector3 vParam1, struct<2> Param2, Vector3 vParam3)//Position - 0x20E3
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param2.f_0 - Param0.f_0), (Param2.f_1 - Param0.f_1));
}

void func_68(bool bParam0)//Position - 0x20FD
{
	if (bParam0)
	{
		func_69();
...
Vector3 func_70(int iParam0)//Position - 0x2189
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_71(struct<3> Param0)//Position - 0x22D3
{
	float fVar0;
	float fVar1;
...
Vector3 func_72(int iParam0)//Position - 0x2312
{
	switch (iParam0)
	{
		case 0:
...
void func_73(int iParam0)//Position - 0x243C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_74(int iParam0)//Position - 0x2495
{
...
int func_75(int iParam0)//Position - 0x2518
{
	int iVar0;
...
void func_76(int iParam0, int iParam1, int iParam2)//Position - 0x2549
{
	func_77(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_77(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x255E
{
	int iVar0;
...
int func_79(int iParam0, int iParam1, int iParam2)//Position - 0x2611
{
...
int func_80(int iParam0, int iParam1, int iParam2)//Position - 0x262C
{
	int iVar0;
...
int func_81(int iParam0)//Position - 0x2678
{
	int iVar0;
...
int func_83(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x273E
{
	int iVar0;
...
void func_84(var uParam0, int iParam1)//Position - 0x2875
{
	int iVar0;
...
int func_85(int iParam0)//Position - 0x28C4
{
	if (Global_43257 == 15)
	{
		return 0;
...
void func_87()//Position - 0x291D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_255))
	{
		Var1 = { ENTITY::GET_ENTITY_COORDS(iLocal_255, true) };
		if (SYSTEM::VDIST2(Var1, Local_56) > 25f)
		{
			func_88(0);
		}
	}
...
void func_88(int iParam0)//Position - 0x296A
{
	if (iParam0 == 2)
	{
	}
...
int func_89(int iParam0, bool bParam1)//Position - 0x298B
{
	int iVar0;
...
int func_90(int iParam0)//Position - 0x2A43
{
	int iVar0;
...
void func_91(int iParam0)//Position - 0x2A7E
{
	int iVar0;
...
void func_92(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x2AD5
{
	int iVar0;
...
int func_93(var uParam0)//Position - 0x2C00
{
	return 1;
}

var func_94()//Position - 0x2C09
{
	return Global_75693;
}

int func_95(int iParam0)//Position - 0x2C15
{
	if (iParam0 == 1)
	{
...
var func_96(int iParam0, int iParam1)//Position - 0x2C6C
{
	switch (iParam0)
	{
		case 5:
...
bool func_97()//Position - 0x2CA4
{
	return MISC::GET_GAME_TIMER() <= Global_23270.f_6321 + 100;
}

int func_98()//Position - 0x2CB9
{
...
bool func_99(bool bParam0)//Position - 0x2CD3
{
	if (bParam0)
	{
...
void func_100(var uParam0, int iParam1)//Position - 0x2CFC
{
	func_101(uParam0, iParam1);
}

void func_101(var uParam0, var uParam1)//Position - 0x2D0C
{
	*uParam0 = (*uParam0 || uParam1);
}

int func_102()//Position - 0x2D1D
{
	return 1;
}

bool func_103()//Position - 0x2D26
{
	int iVar0;
	bool bVar1;
...
int func_104(int iParam0)//Position - 0x2E30
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_111()) || Global_112695) || Global_32166) || func_110()) || func_96(8, -1)) || func_109()) || func_108()) || func_107()) || func_98()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_111()) || Global_32166) || func_110()) || func_96(8, -1)) || func_107()) || func_109()) || func_108()) || func_98()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_111()) || Global_112695) || Global_32166) || func_110()) || func_96(8, -1)) || func_107()) || func_109()) || func_108()) || func_98()) || Global_113648.f_7690.f_919[iVar0] == 5) || Global_43804 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_111()) || Global_112695) || Global_32166) || func_110()) || func_96(8, -1)) || func_109()) || func_108()) || func_98()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_111() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_96(8, -1)) || func_98()) || func_106()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_111()) || Global_32166) || func_110()) || func_96(8, -1)) || func_108()) || func_107()) || func_98()) || Global_113648.f_7690.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_111()) || func_108()) || Global_112695) || Global_32166) || func_110()) || Global_44446) || func_96(8, -1)) || func_107()) || func_106()) || func_98()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_111()) || Global_112695) || Global_32166) || func_110()) || func_96(8, -1)) || func_107()) || func_106()) || func_109()) || func_108()) || func_98())
						{
							return 0;
						}
						break;
...
var func_105()//Position - 0x354D
{
	return Global_100720.f_1;
}

int func_106()//Position - 0x355B
{
	if (Global_97603 != -1)
	{
...
bool func_108()//Position - 0x35A8
{
	return Global_100733.f_388 > 0;
}

bool func_109()//Position - 0x35B9
{
	return Global_100733.f_387 > 0;
}

var func_110()//Position - 0x35CA
{
	return Global_1575060;
}

int func_111()//Position - 0x35D6
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_113()//Position - 0x360C
{
	return Global_96513;
}

int func_114(int iParam0)//Position - 0x3618
{
	switch (iParam0)
	{
		case 0:
...
bool func_115(int iParam0)//Position - 0x368A
{
	int iVar0;
...
bool func_116(int iParam0)//Position - 0x36C6
{
	return Global_43257 == iParam0;
}

void func_117(var uParam0, int iParam1)//Position - 0x36D4
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_118()//Position - 0x36E5
{
	struct<3> Var0;
	...
	if (bLocal_254)
	{
		switch (iLocal_82)
		{
			...
			case 12:
				...
				if (!func_35(Var0))
				{
					iLocal_256 = VEHICLE::CREATE_VEHICLE(joaat("bati"), Var0, func_119(iLocal_82), true, true, false);
...
float func_119(int iParam0)//Position - 0x37AE
{
	switch (iParam0)
	{
		case 6:
...
Vector3 func_120(int iParam0)//Position - 0x37CC
{
	switch (iParam0)
	{
		case 6:
...
bool func_121()//Position - 0x37F6
{
	switch (iLocal_82)
	{
		...
		case 8:
		case 6:
			return (((STREAMING::HAS_ANIM_DICT_LOADED("pickup_object") && STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@basejump@ig_15")) && func_122(&uLocal_78)) && func_122(&uLocal_80));
			break;
		
		case 12:
			return ((STREAMING::HAS_ANIM_DICT_LOADED("pickup_object") && STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@basejump@ig_15")) && func_122(&uLocal_78));
			break;
...
int func_122(var uParam0)//Position - 0x388A
{
	int iVar0;
...
void func_124(var uParam0)//Position - 0x3970
{
	int iVar0;
...
int func_125(var uParam0, int iParam1)//Position - 0x39A0
{
	int iVar0;
	int iVar1;
...
int func_126(var uParam0)//Position - 0x39FD
{
	int iVar0;
...
void func_127(int iParam0)//Position - 0x3A29
{
	iLocal_59 = iParam0;
}

void func_128(int iParam0, bool bParam1, bool bParam2)//Position - 0x3A35
{
	int iVar0;
	int iVar1;
...
int func_131(int iParam0, int iParam1)//Position - 0x3B75
{
	int iVar0;
...
bool func_132(int iParam0)//Position - 0x3BBF
{
	return func_133(iParam0, Global_43257);
}

int func_133(int iParam0, int iParam1)//Position - 0x3BD0
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_134(var uParam0, int iParam1)//Position - 0x3DB1
{
	return (uParam0 && iParam1) != 0;
}

void func_135()//Position - 0x3DC0
{
	if (ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
...
int func_136(int iParam0)//Position - 0x3EDF
{
	switch (iParam0)
	{
		case 91:
...
void func_137(int iParam0)//Position - 0x3FF7
{
	if (iLocal_59 < 5)
	{
		if (iParam0 != 263)
...
bool func_138(int iParam0)//Position - 0x403B
{
	return Global_112735[iParam0 /*10*/].f_1;
}

int func_139(struct<3> Param0, int iParam1)//Position - 0x404D
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_140(int iParam0)//Position - 0x409C
{
	switch (iParam0)
	{
		case 0:
...
void func_141(var uParam0, int iParam1)//Position - 0x40E3
{
	func_142(uParam0, iParam1);
}

void func_142(var uParam0, var uParam1)//Position - 0x40F3
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_143(bool bParam0)//Position - 0x4108
{
	if (bParam0)
	{
		if (iLocal_69 != 263)
