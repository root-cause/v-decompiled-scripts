...
void __EntryFunction__()//Position - 0x0
{
	...
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_134(uLocal_94, 4194304))
	{
		if (iLocal_105 != 263)
		{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_85) && !ENTITY::IS_ENTITY_DEAD(iLocal_85, false))
		{
			...
			switch (iLocal_95)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_114(3) && !Global_100715)
						{
							...
							{
								if ((!func_134(uLocal_94, 1) || !ENTITY::DOES_ENTITY_EXIST(func_113())) && !Global_100715)
								{
									func_127(10);
									break;
								}
				...
				case 6:
					...
					{
						STATS::PLAYSTATS_ODDJOB_DONE(SYSTEM::ROUND((func_12(&iLocal_107) * 1000f)), iLocal_99, false);
						func_11(&iLocal_107);
						...
						if (iLocal_99 != -1)
						{
							if (func_134(Global_112299, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_20(iLocal_99), 0, Global_100718, 0);
...
void func_27(bool bParam0)//Position - 0xF0C
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_297))
		{
			...
			if (fVar15 > 0.8f)
			{
				...
				if (iLocal_122 == 12)
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Var9, 1f, 20000, 0.25f, 0, func_67(Var9, ENTITY::GET_ENTITY_COORDS(iLocal_297, false)));
				}
				else
				{
	...
	if (bParam0)
	{
		...
		{
			TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), func_36(iLocal_122), 1f, -1, 0.25f, 0, 40000f);
		}
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_297))
		{
			OBJECT::DELETE_OBJECT(&iLocal_297);
		}
		iVar4 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), func_34(iLocal_122), func_33(iLocal_122), func_32(iLocal_122), true, 2);
		iVar5 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), func_31(iLocal_122), func_30(iLocal_122), func_29(iLocal_122), false, 2);
...
float func_67(struct<2> Param0, Vector3 vParam2, struct<2> Param3, Vector3 vParam5)//Position - 0x20E3
{
...
void func_135()//Position - 0x3DC0
{
	...
	fLocal_117 = 1.1f;
	sLocal_101 = "PLAY_BASEJUMP_G" /* GXT: Press ~INPUT_CONTEXT~ to start parachuting. */;
	if (iLocal_105 != 263)
	{
		if (!func_131(0, iLocal_99))
		{
...
int func_139(struct<3> Param0, int iParam3)//Position - 0x404D
{
	float fVar0;
	float fVar1;
	int iVar2;
