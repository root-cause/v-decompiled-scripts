...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		func_302(Local_39.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_40)
		{
			case 0:
				func_300();
...
void func_5()//Position - 0x2C6
{
	if (func_232())
	{
		switch (iLocal_41)
		{
			...
			case 1:
				if (func_231(Local_39.f_28[0]))
				{
					if (func_231(PLAYER::PLAYER_PED_ID()))
					{
						if (!iLocal_45)
						{
							if (func_229(PLAYER::PLAYER_PED_ID(), Local_39.f_28[0]) > fLocal_48)
							{
								func_227();
								iLocal_45 = 1;
							}
							else if ((MISC::GET_GAME_TIMER() - iLocal_224) > 7500)
							{
								if (!bLocal_43)
								{
									bLocal_43 = func_210(&uLocal_49, "SCRAPAU", "SCRAP_1_AMB2", 7, 0, 0, 0);
								}
								else if (!bLocal_44)
								{
									bLocal_44 = func_210(&uLocal_49, "SCRAPAU", "SCRAP_1_HANG", 7, 0, 0, 0);
								}
							}
						}
						else if (!bLocal_46 && func_229(PLAYER::PLAYER_PED_ID(), Local_39.f_28[0]) > 50f)
						{
							bLocal_46 = func_210(&uLocal_49, "SCRAPAU", "SCRAP_WALK", 7, 0, 0, 0);
						}
						if (func_229(PLAYER::PLAYER_PED_ID(), Local_39.f_28[0]) > fLocal_47)
						{
							iLocal_41 = 2;
						}
					}
...
int func_36(int iParam0, int iParam1, int iParam2)//Position - 0x166D
{
	...
	{
		uVar6 = { func_84(iVar0, 0) };
		Global_78341[1 /*14*/] = { func_88(iVar0, iParam1, uVar6[iParam1], -1) };
...
int func_39(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x18F1
{
	...
	if (iParam1 == 12)
	{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						{
							uVar12 = { func_81(iVar10, uVar11[iVar0]) };
						}
						iVar1 = 0;
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_88(iVar10, 14, uVar12[iVar1], -1) };
		...
		if (iParam7 == 1)
		{
			Var14 = { func_88(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var14 = { func_88(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var14 = { func_88(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var14 = { func_88(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var14 = { func_88(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	{
		uVar15 = { func_81(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_88(iVar10, 14, uVar15[iVar1], -1) };
			func_55(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_71(14);
			if (Global_78339 == 1)
			{
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x46A9
{
	...
	else
	{
		...
		iVar4 = (iParam1 - func_58(iParam0, func_80(iParam2)));
		if (iVar4 < 0)
		{
			return -1;
		}
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_80(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4E05
{
	...
	else
	{
		...
		if (iVar4 != -1)
		{
			return (func_58(iParam0, func_80(iParam2)) + iVar4);
		}
	}
	return -99;
}
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.f_0 != 0 && Var2.f_0 != -1) && Var2.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_86(Var2.f_2)] = func_62(iParam1, Var2.f_0, func_86(Var2.f_2), iVar0);
					}
				}
				else if (Var2.f_1 != -1)
				{
...
void func_90(int iParam0)//Position - 0xC15C
{
	...
	switch (iParam0)
	{
		...
		default:
			func_98(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_91(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_98(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE44F
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_91(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_91(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_80(iParam0));
			if (iVar11 > iVar10)
			{
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_153(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar6 = { func_81(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
...
void func_165(int iParam0, bool bParam1, bool bParam2)//Position - 0x200A0
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&sVar1, {func_162(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&sVar1, 0, Global_100718, 0);
		func_166(&sVar1, Var0.f_3, Global_100718, bParam1, bParam2);
	}
}
...
void func_168(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0x212D8
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_232()//Position - 0x27455
{
	if (func_231(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (func_235(Local_39.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
		{
		...
		else if (func_233(PLAYER::PLAYER_PED_ID(), Local_39.f_28[0], 1))
		{
			TASK::TASK_SMART_FLEE_PED(Local_39.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
			iLocal_42 = 3;
			func_254(5);
...
bool func_238(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x276EE
{
	...
	uVar0 = func_239(&(Local_35[iVar2 /*4*/]), Var1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar2 /*4*/].f_3) < iParam4);
}

int func_239(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x277AF
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_242(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x279EA
{
	...
	{
		Var1 = { func_244(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_243(struct<3> Param0, struct<3> Param1)//Position - 0x27A7B
{
...
int func_252(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0x27E40
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	switch (iLocal_41)
	{
		case 0:
			...
			if (func_281(1, 1093140480, 0))
			{
				...
				func_328(0);
				func_278();
				func_270(Local_225[0 /*3*/], Local_225[1 /*3*/], fLocal_226, 2455.886f, 3432.4453f, 49.2697f, 189.77f, 1, 1, 1, 0, 0);
		...
		case 1:
			...
			if (CUTSCENE::HAS_CUTSCENE_FINISHED())
			{
				...
				if (func_231(Local_39.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(Local_39.f_41[0]))
				{
				...
				if (func_231(Local_39.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_217))
				{
...
void func_259(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x28245
{
	int iVar0;
...
void func_270(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x286F4
{
	func_271(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_271(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x2871D
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_275(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x28C83
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_276(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x28F79
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_278()//Position - 0x29092
{
	...
	while (iVar0 < 16)
	{
		if (func_231(uVar1[iVar0]) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(uVar1[iVar0], Local_225[0 /*3*/], Local_225[1 /*3*/], fLocal_226, false, true, 0))
		{
...
void func_290()//Position - 0x2951E
{
	...
	if (func_232())
	{
		if (MISC::GET_GAME_TIMER() < iLocal_221 && !func_291(PLAYER::PLAYER_PED_ID(), Local_39.f_28[0], 4f, 1))
		{
...
void func_300()//Position - 0x297E8
{
	...
	if (func_232())
	{
		if ((((STREAMING::HAS_ANIM_DICT_LOADED("rcmrc_omega_1leadinoutscrap_1_rcm") && STREAMING::HAS_ANIM_DICT_LOADED("rcmrc_omega_1")) && HUD::HAS_ADDITIONAL_TEXT_LOADED(0)) && STREAMING::HAS_MODEL_LOADED(iLocal_215)) && STREAMING::HAS_MODEL_LOADED(iLocal_216))
		{
			...
			if (func_234(PLAYER::PLAYER_PED_ID()) && func_234(Local_39.f_28[0]))
			{
				...
				func_301(&uLocal_49, 3, Local_39.f_28[0], "OMEGA", 0, 1);
				func_301(&uLocal_49, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			}
...
void func_302(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x299FB
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_304(Global_78814, Global_78816, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_305(iVar1), 8);
					break;
			}
			break;
...
int func_321(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0x2A839
{
	if (func_322(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_322(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0x2A895
{
	int iVar0;
...
void func_331(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x2ABCA
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_441(iParam4, iParam5, iParam6, iParam11))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_412(Param1, fParam2);
	}
	else if (iParam7 == 1)
	{
		...
		if (func_157(iParam10))
		{
			func_403(iParam10, 0);
			while (!func_332(iParam0, iParam10, Param1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_332(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)//Position - 0x2AD5E
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2.f_0, Param2, fParam3, true, true, false);
				...
				func_394(iParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_405(struct<3> Param0, float fParam1, bool bParam2)//Position - 0x34616
{
	int iVar0;
...
bool func_411(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x3600D
{
	if (bParam2)
	{
...
int func_412(struct<3> Param0, float fParam1)//Position - 0x36054
{
	return func_413(&(Global_107196.f_2890), Param0, fParam1, 0);
}

int func_413(var uParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x3606E
{
	int iVar0;
	struct<3> Var1;
	bool bVar2;
...
int func_415(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x363E3
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_417(iParam0, uVar1[iVar3], 1) && func_416(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.5635f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_411(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
int func_416(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x365EB
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_447()//Position - 0x37445
{
	...
	func_463(0);
	func_462(&uLocal_49, 1);
	func_462(&uLocal_49, 3);
	func_461(&(Local_39.f_28[0]), 1, 0, 1);
	if (ENTITY::DOES_ENTITY_EXIST(Local_39.f_41[0]))
	{
