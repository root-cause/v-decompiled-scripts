...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_441())
	{
		Global_78564 = 1;
		iLocal_37 = 0;
		func_331(&iVar0, 2455.886f, 3432.445f, 49.2697f, 189.77f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
		func_328(iVar0);
	...
	switch (iLocal_41)
	{
		case 0:
			...
			if (func_281(1, 1093140480, 0))
			{
				...
				func_328(0);
				func_278();
				func_270(Local_225[0 /*3*/], Local_225[1 /*3*/], fLocal_226, 2455.886f, 3432.445f, 49.2697f, 189.77f, 1, 1, 1, 0, 0);
...
int func_411(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x35DC2
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_413(iParam0, uVar1[iVar3], 1) && func_412(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
{
	Local_225[0 /*3*/] = { 2453.513f, 3424.646f, 48.44232f };
	Local_225[1 /*3*/] = { 2490.06f, 3434.195f, 58.26103f };
	fLocal_226 = 32.75f;
}
