...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_445())
	{
		Global_78804 = 1;
		iLocal_79 = 0;
		func_331(&iVar0, 2455.886f, 3432.4453f, 49.2697f, 189.77f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
		func_328(iVar0);
		while (!func_320(&Local_81))
		{
			SYSTEM::WAIT(0);
		}
		func_319(&Local_81, 0, 1);
		Global_78804 = 0;
	}
	func_318(1, 1, 1, 1);
	while (true)
	{
		...
		func_302(Local_81.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_142)
		{
			case 0:
				func_300();
			...
			case 1:
				if (func_231(Local_81.f_28[0]))
				{
					if (func_231(PLAYER::PLAYER_PED_ID()))
					{
						if (!iLocal_147)
						{
							if (func_229(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0]) > fLocal_150)
							{
								func_227();
								iLocal_147 = 1;
							}
							else if ((MISC::GET_GAME_TIMER() - iLocal_330) > 7500)
							{
								if (!bLocal_145)
								{
									bLocal_145 = func_210(&uLocal_151, "SCRAPAU", "SCRAP_1_AMB2", 7, 0, 0, 0);
								}
								else if (!bLocal_146)
								{
									bLocal_146 = func_210(&uLocal_151, "SCRAPAU", "SCRAP_1_HANG", 7, 0, 0, 0);
								}
							}
						}
						else if (!bLocal_148 && func_229(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0]) > 50f)
						{
							bLocal_148 = func_210(&uLocal_151, "SCRAPAU", "SCRAP_WALK", 7, 0, 0, 0);
						}
						if (func_229(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0]) > fLocal_149)
						{
							iLocal_143 = 2;
						}
					}
...
{
	func_207("SSHIP_HELP1" /* GXT: Spaceship parts are scattered throughout San Andreas. Find and collect them all for Omega. */, 1, 0, -1, 10000, 7, 0, 0, 0);
	func_7(66, 1);
	func_447();
}
...
void func_7(int iParam0, bool bParam1)//Position - 0x3FA
{
	...
	{
		func_178(&(Global_112735[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
	...
	func_164(iVar0, 1, 0, 0);
	func_163(0, 0);
	MemCopy(&sVar1, {func_161(iVar0)}, 4);
	func_158(&sVar1, func_159());
	func_35();
...
int func_36(int iParam0, int iParam1, int iParam2)//Position - 0x166D
{
	...
	Global_78341[1 /*14*/] = { func_88(iVar0, iParam1, iParam2, -1) };
	...
	{
		uVar31 = { func_84(iVar0, 0) };
		Global_78341[1 /*14*/] = { func_88(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_80(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_80(iParam1), Global_78341[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_80(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, 0);
		}
	}
	if (func_79(iParam0, iVar0, &iVar48, 0))
	{
...
int func_37(int iParam0, int iParam1, int iParam2)//Position - 0x182A
{
	...
	{
		if (!func_153(iParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_64, Global_113648.f_2365.f_539[iVar0 /*65*/].f_63))
		{
...
int func_38(int iParam0)//Position - 0x18B6
{
	switch (iParam0)
	{
...
int func_39(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x18F1
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_78341[1 /*14*/] = { func_88(iVar10, iParam1, iParam2, -1) };
		if (!func_78(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78341[1 /*14*/] = { func_88(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						{
							uVar28 = { func_81(iVar10, uVar11[iVar0]) };
						}
						iVar1 = 0;
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_88(iVar10, 14, uVar28[iVar1], -1) };
							func_55(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
							func_71(14);
							if (Global_78339 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_80(iVar0), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_80(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_80(iVar0), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
						}
						func_71(iVar0);
						if (Global_78339 == 1)
						{
			...
			{
				Global_78341[1 /*14*/] = { func_88(iVar10, iVar0, func_45(iParam0, iVar0, -1), -1) };
		...
		if (iParam7 == 1)
		{
			Var55 = { func_88(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var55 = { func_88(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var55 = { func_88(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var55 = { func_88(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var55 = { func_88(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	{
		uVar69 = { func_81(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_88(iVar10, 14, uVar69[iVar1], -1) };
			func_55(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_71(14);
			if (Global_78339 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_80(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_80(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_80(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
		}
		if (Global_78339 == 1)
		{
			iVar2 = 0;
...
void func_40(int iParam0, int iParam1, int iParam2)//Position - 0x2102
{
	int iVar0;
	int iVar1;
...
int func_41(int iParam0, int iParam1, int iParam2)//Position - 0x218C
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_42(int iParam0, int iParam1, int iParam2)//Position - 0x226A
{
	Global_78341[1 /*14*/] = { func_88(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78341[1 /*14*/].f_6, 2);
}

int func_43(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x2292
{
	var uVar0;
	int iVar10;
...
int func_44(int iParam0, int iParam1, int iParam2)//Position - 0x2896
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_45(int iParam0, int iParam1, int iParam2)//Position - 0x292F
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x29D0
{
	int iVar0;
...
int func_47(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2CD7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_48(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x388A
{
	int iVar0;
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3B6E
{
	int iVar0;
...
int func_50(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3E35
{
	int iVar0;
	int iVar1;
...
int func_51(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3E6C
{
	int iVar0;
...
int func_52(int iParam0, int iParam1, int iParam2)//Position - 0x3E95
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4160
{
	int iVar0;
...
int func_54(int iParam0, int iParam1, int iParam2)//Position - 0x43EA
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_55(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4541
{
	int iVar0;
...
int func_56(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x45DB
{
	switch (iParam0)
	{
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x46A9
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar36 = (iParam1 - func_58(iParam0, func_80(iParam2)));
		if (iVar36 < 0)
		{
			return -1;
		}
...
int func_58(int iParam0, int iParam1)//Position - 0x47C3
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_59(int iParam0)//Position - 0x4B6A
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4BCB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_61(int iParam0, int iParam1)//Position - 0x4CC7
{
	int iVar0;
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4E05
{
	struct<2> Var0;
	int iVar15;
	int iVar16;
	...
	else
	{
		...
		if (iVar18 != -1)
		{
			return (func_58(iParam0, func_80(iParam2)) + iVar18);
		}
	}
	return -99;
}

int func_63(int iParam0)//Position - 0x4EC0
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_64(int iParam0)//Position - 0x4F1F
{
	switch (iParam0)
	{
		case 0:
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4FA5
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5222
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_67(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5647
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_68(int iParam0, int iParam1)//Position - 0x593A
{
	int iVar0;
	int iVar1;
...
int func_69(int iParam0, int iParam1)//Position - 0x5981
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x59E1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_71(int iParam0)//Position - 0x5A38
{
	if (BitTest(Global_78341[1 /*14*/].f_6, 1) && !BitTest(Global_78341[1 /*14*/].f_6, 6))
	{
		func_77(iParam0, Global_78341[1 /*14*/].f_5, Global_78341[1 /*14*/].f_2, 2, Global_78341[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_78341[1 /*14*/].f_6, 1) && BitTest(Global_78341[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_72(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x5AE4
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_76(iParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
		iVar3 = func_75(iVar2, iVar0, 0);
		MISC::SET_BIT(&iVar3, iVar1);
		func_73(iVar2, iVar3, iVar0, 1, 0);
	}
}

void func_73(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x5B2E
{
	int iVar0;
...
int func_74(var uParam0)//Position - 0x5B5E
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0, int iParam1, int iParam2)//Position - 0x5B92
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 14192)
	{
		...
		iVar0 = Global_2805027[iParam0 /*3*/][func_74(iParam1)];
...
bool func_76(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x5BCF
{
	int iVar0;
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x83DE
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_78(int iParam0)//Position - 0x9281
{
	if (!BitTest(Global_78341[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x92C9
{
	int iVar0;
	...
	{
		if (!func_153(iParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_61, Global_113648.f_2365.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_80(int iParam0)//Position - 0x9374
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_81(int iParam0, int iParam1)//Position - 0x9424
{
	int iVar0;
	struct<10> Var1;
...
void func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9D53
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_83(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x9E7D
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_84(int iParam0, int iParam1)//Position - 0x9EC5
{
	int iVar0;
	struct<17> Var1;
...
void func_85(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBD0D
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_86(Var16.f_2)] = Var16.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_86(Var16.f_2)] = func_62(iParam1, Var16.f_0, func_86(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
int func_86(int iParam0)//Position - 0xBEF7
{
	switch (iParam0)
	{
		case 0:
...
void func_87(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xBFA7
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC01A
{
	func_152();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_89(int iParam0, int iParam1)//Position - 0xC06C
{
	switch (iParam0)
	{
		case 0:
...
void func_90(int iParam0)//Position - 0xC15C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_98(iVar10, iParam0, 155, -1);
			return;
			break;
	}
	func_91(&(Global_78341[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_91(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD38F
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_95(Global_2883588, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_95(Global_2883588, 2, 1, 1, -1))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_75(func_94(iParam1, uParam0->f_2), Global_78338, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_75(func_93(iParam1, uParam0->f_2), Global_78338, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_75(iVar1, Global_78338, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_92(int iParam0, int iParam1, var uParam2)//Position - 0xD733
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_93(int iParam0, int iParam1)//Position - 0xDB38
{
	switch (iParam1)
	{
		case 0:
...
int func_94(int iParam0, int iParam1)//Position - 0xDF33
{
	switch (iParam1)
	{
		case 0:
...
int func_95(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE32E
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	if (func_76(iParam0, iParam1, &iVar2, &uVar1, bParam2, bParam3))
	{
		uVar3 = func_75(iVar2, iVar0, 0);
		return BitTest(uVar3, uVar1);
	}
	return 0;
}

bool func_96(int iParam0)//Position - 0xE36D
{
	return Global_43257 == iParam0;
}

int func_97(int iParam0)//Position - 0xE37B
{
	switch (iParam0)
	{
		case -1:
...
void func_98(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE44F
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_91(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_91(&(Global_78341[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_91(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_91(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_80(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_99(int iParam0)//Position - 0xE6D5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(int iParam0)//Position - 0xE822
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_101(int iParam0)//Position - 0xED2F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_102(int iParam0)//Position - 0xEDA3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_103(int iParam0)//Position - 0xEE16
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_104(int iParam0)//Position - 0xEEFD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0xF23F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(int iParam0)//Position - 0xF447
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0)//Position - 0xF667
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0xF770
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0)//Position - 0x10103
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0)//Position - 0x10C5B
{
	if (iParam0 < 136)
	{
		func_112(iParam0);
	...
	{
		func_98(3, iParam0, 242, -1);
	}
}

void func_111(int iParam0)//Position - 0x10C90
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0x11894
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0x12794
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x128C1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0, int iParam1)//Position - 0x129B8
{
	switch (iParam0)
	{
		case 0:
...
void func_116(int iParam0)//Position - 0x12AA8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0x13F75
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x140BE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x145C8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0x14C31
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0x14CA4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0x14D74
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0x1526F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0x15400
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0x15BEF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x15CF8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0x16C1B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x178C8
{
	if (iParam0 < 107)
	{
		func_131(iParam0);
	...
	if (Global_78341[0 /*14*/].f_2 == -1)
	{
		func_98(3, iParam0, 318, -1);
	}
}

void func_129(int iParam0)//Position - 0x1790E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x183B4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x191A2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x19DE1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x1A059
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0, int iParam1)//Position - 0x1A195
{
	switch (iParam0)
	{
		case 0:
...
void func_135(int iParam0)//Position - 0x1A285
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x1AFE3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x1B152
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x1B6C3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x1BBEB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x1BC5E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x1BD2E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x1C1DF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x1C43A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x1C6FA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x1C8B5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x1D3FB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x1E02D
{
	if (iParam0 < 60)
	{
		func_149(iParam0);
	...
	if (Global_78341[0 /*14*/].f_2 == -1)
	{
		func_98(3, iParam0, 181, -1);
	}
}

void func_148(int iParam0)//Position - 0x1E062
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x1EDF5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x1F477
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1F55D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152()//Position - 0x1F654
{
...
int func_153(int iParam0, int iParam1, int iParam2)//Position - 0x1F6CC
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_153(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar22 = { func_81(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
							if (!func_153(iParam0, 14, uVar22[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
									Global_78341[2 /*14*/] = { func_88(iVar0, 14, iVar4, -1) };
									if (Global_78341[2 /*14*/].f_12 == iVar3)
									{
										if (func_153(iParam0, 14, iVar4))
										{
											if (!func_43(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_78341[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_78341[2 /*14*/] = { func_88(iVar0, iVar2, iVar1, -1) };
						if (!func_43(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_78341[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	{
		uVar33 = { func_81(iVar0, iParam2) };
		iVar32 = 0;
		while (iVar32 <= 8)
		{
			if (!func_153(iParam0, 14, uVar33[iVar32]))
			{
				return 0;
			}
			iVar32++;
	...
	else if (Global_78341[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_80(iParam1)) && Global_78341[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_80(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_154(int iParam0)//Position - 0x1F925
{
	int iVar0;
	int iVar1;
...
int func_155(int iParam0)//Position - 0x1F962
{
	if (func_157(iParam0))
	{
...
var func_156(int iParam0)//Position - 0x1F987
{
	return Global_2028[iParam0 /*29*/];
}

bool func_157(int iParam0)//Position - 0x1F996
{
	return iParam0 < 3;
}

void func_158(char* sParam0, var uParam1)//Position - 0x1F9A2
{
...
void func_160()//Position - 0x1FA39
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_155(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_154(PLAYER::PLAYER_PED_ID());
			if (func_157(iVar0) && (!func_96(14) || Global_112599))
			{
				if (Global_113648.f_2365.f_539.f_4321 != iVar0 && func_157(Global_113648.f_2365.f_539.f_4321))
				{
...
struct<2> func_161(int iParam0)//Position - 0x1FB36
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_162(int iParam0)//Position - 0x1FB6D
{
	struct<2> Var0;
...
void func_163(int iParam0, int iParam1)//Position - 0x1FFB9
{
...
void func_164(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x20003
{
	...
	if (iParam1 == 1)
	{
		func_165(iParam0, bParam2, bParam3);
	}
	HUD::SET_MISSION_NAME(false, 0);
}

void func_165(int iParam0, bool bParam1, bool bParam2)//Position - 0x200A0
{
	struct<4> Var0;
	char* sVar32;
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&sVar32, {func_162(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&sVar32, 0, Global_100718, 0);
		func_166(&sVar32, Var0.f_3, Global_100718, bParam1, bParam2);
	}
}

void func_166(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x200DF
{
...
void func_167(int iParam0, var uParam1)//Position - 0x20123
{
	switch (iParam0)
	{
		case 0:
			func_168(uParam1, "Abigail1", func_161(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0, "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 1:
			func_168(uParam1, "Abigail2", func_161(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, -1, 4, 1, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 2:
			func_168(uParam1, "Barry1", func_161(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1, 4, 1, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 3:
			func_168(uParam1, "Barry2", func_161(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_169(iParam0), 1, 1);
			break;
		
		case 4:
			func_168(uParam1, "Barry3", func_161(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 5:
			func_168(uParam1, "Barry3A", func_161(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 6:
			func_168(uParam1, "Barry3C", func_161(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 7:
			func_168(uParam1, "Barry4", func_161(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_169(iParam0), 0, 0);
			break;
		
		case 8:
			func_168(uParam1, "Dreyfuss1", func_161(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 9:
			func_168(uParam1, "Epsilon1", func_161(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1, 10, 4, 1, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 10:
			func_168(uParam1, "Epsilon2", func_161(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0, 11, 4, 1, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 11:
			func_168(uParam1, "Epsilon3", func_161(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars", 0, 0, 12, 4, 1, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 12:
			func_168(uParam1, "Epsilon4", func_161(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16, "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 13:
			func_168(uParam1, "Epsilon5", func_161(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16, "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 14:
			func_168(uParam1, "Epsilon6", func_161(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0, 15, 4, 1, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 15:
			func_168(uParam1, "Epsilon7", func_161(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 16:
			func_168(uParam1, "Epsilon8", func_161(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 17:
			func_168(uParam1, "Extreme1", func_161(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 18:
			func_168(uParam1, "Extreme2", func_161(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171, 0, 19, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 19:
			func_168(uParam1, "Extreme3", func_161(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 20:
			func_168(uParam1, "Extreme4", func_161(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, -1, 4, 2, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 21:
			func_168(uParam1, "Fanatic1", func_161(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, -1, 4, 1, 700, 2000, func_169(iParam0), 1, 0);
			break;
		
		case 22:
			func_168(uParam1, "Fanatic2", func_161(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1, -1, 4, 4, 700, 2000, func_169(iParam0), 1, 0);
			break;
		
		case 23:
			func_168(uParam1, "Fanatic3", func_161(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1, 4, 2, 700, 2000, func_169(iParam0), 0, 1);
			break;
		
		case 24:
			func_168(uParam1, "Hao1", func_161(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0, "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_169(iParam0), 0, 1);
			break;
		
		case 25:
			func_168(uParam1, "Hunting1", func_161(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 26:
			func_168(uParam1, "Hunting2", func_161(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, -1, 4, 4, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 27:
			func_168(uParam1, "Josh1", func_161(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 28:
			func_168(uParam1, "Josh2", func_161(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0, 29, 4, 4, 0, 2359, func_169(iParam0), 1, 1);
			break;
		
		case 29:
			func_168(uParam1, "Josh3", func_161(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_169(iParam0), 1, 1);
			break;
		
		case 30:
			func_168(uParam1, "Josh4", func_161(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1, 4, 4, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 31:
			func_168(uParam1, "Maude1", func_161(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0, "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 32:
			func_168(uParam1, "Minute1", func_161(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 33:
			func_168(uParam1, "Minute2", func_161(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 34:
			func_168(uParam1, "Minute3", func_161(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0, -1, 4, 4, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 35:
			func_168(uParam1, "MrsPhilips1", func_161(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0, "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 36:
			func_168(uParam1, "MrsPhilips2", func_161(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 37:
			func_168(uParam1, "Nigel1", func_161(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1, -1, 1, 4, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 38:
			func_168(uParam1, "Nigel1A", func_161(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_169(iParam0), 1, 1);
			break;
		
		case 39:
			func_168(uParam1, "Nigel1B", func_161(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_169(iParam0), 1, 1);
			break;
		
		case 40:
			func_168(uParam1, "Nigel1C", func_161(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_169(iParam0), 1, 1);
			break;
		
		case 41:
			func_168(uParam1, "Nigel1D", func_161(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_169(iParam0), 1, 1);
			break;
		
		case 42:
			func_168(uParam1, "Nigel2", func_161(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_169(iParam0), 1, 1);
			break;
		
		case 43:
			func_168(uParam1, "Nigel3", func_161(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16, "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_169(iParam0), 1, 1);
			break;
		
		case 44:
			func_168(uParam1, "Omega1", func_161(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 45:
			func_168(uParam1, "Omega2", func_161(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 46:
			func_168(uParam1, "Paparazzo1", func_161(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 47:
			func_168(uParam1, "Paparazzo2", func_161(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 48:
			func_168(uParam1, "Paparazzo3", func_161(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183, 1, -1, 2, 2, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 49:
			func_168(uParam1, "Paparazzo3A", func_161(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 50:
			func_168(uParam1, "Paparazzo3B", func_161(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 51:
			func_168(uParam1, "Paparazzo4", func_161(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1, -1, 4, 2, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 52:
			func_168(uParam1, "Rampage1", func_161(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 54:
			func_168(uParam1, "Rampage3", func_161(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 55:
			func_168(uParam1, "Rampage4", func_161(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 56:
			func_168(uParam1, "Rampage5", func_161(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 53:
			func_168(uParam1, "Rampage2", func_161(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0, "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 57:
			func_168(uParam1, "TheLastOne", func_161(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, -1, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 58:
			func_168(uParam1, "Tonya1", func_161(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 59:
			func_168(uParam1, "Tonya2", func_161(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 60:
			func_168(uParam1, "Tonya3", func_161(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 61:
			func_168(uParam1, "Tonya4", func_161(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 62:
			func_168(uParam1, "Tonya5", func_161(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0, -1, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
...
int func_169(int iParam0)//Position - 0x21369
{
	switch (iParam0)
	{
		case 0:
...
void func_170(int iParam0)//Position - 0x216AF
{
	Global_43808 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_171()//Position - 0x216C1
{
	if (Global_97993)
	{
		func_160();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_172(Global_113648.f_2365.f_539.f_4321));
	}
	else
	{
...
char* func_172(var uParam0)//Position - 0x216F3
{
	uParam0 = uParam0;
	return "";
}

void func_173()//Position - 0x21702
{
	char cVar0[24];
	
	if (MISC::IS_XBOX360_VERSION() || func_175())
	{
		NETWORK::NETWORK_SET_RICH_PRESENCE(StackVal, 0, 0, 0);
	}
	else if (MISC::IS_PS3_VERSION() || func_174())
	{
...
bool func_174()//Position - 0x21745
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_175()//Position - 0x2175B
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_176(int iParam0, int iParam1)//Position - 0x21771
{
	Global_97988 = iParam0;
	Global_97989 = iParam1;
}

void func_177()//Position - 0x21785
{
	if (Global_78813 != 6)
	{
	}
...
void func_178(var uParam0)//Position - 0x217BD
{
	if (*uParam0 == -1)
	{
		return;
...
void func_179(int iParam0, bool bParam1)//Position - 0x217FA
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_180(int iParam0)//Position - 0x21977
{
	switch (iParam0)
	{
		case 0:
...
void func_181(int iParam0)//Position - 0x21CFE
{
	func_183(iParam0, 1);
	Global_113648.f_18576[iParam0 /*6*/].f_3 = func_182();
	Global_113648.f_18576.f_380++;
}

int func_182()//Position - 0x21D34
{
	return (Global_113648.f_10018.f_21 + Global_113648.f_18576.f_380);
}

void func_183(var uParam0, bool bParam1)//Position - 0x21D50
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_184(int iParam0)//Position - 0x22074
{
...
void func_185(int iParam0)//Position - 0x220A7
{
	switch (iParam0)
	{
		case 30:
...
void func_186(int iParam0, bool bParam1)//Position - 0x220DC
{
	if (iParam0 == -1)
	{
		return;
...
void func_187(int iParam0, int iParam1, bool bParam2)//Position - 0x22139
{
	if (iParam0 == -1)
	{
		return;
...
int func_188(int iParam0, int iParam1)//Position - 0x22174
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_189(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x22194
{
	if (iParam0 != 198)
	{
		if (Global_78558)
...
void func_190(int iParam0, int iParam1)//Position - 0x221EC
{
	switch (iParam0)
	{
		case 12:
...
void func_191(int iParam0, bool bParam1)//Position - 0x222D5
{
	if (bParam1)
	{
...
bool func_192(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x222FE
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_193()//Position - 0x22C4D
{
	if ((func_12() == -1 || func_12() == 999) && !func_194() == 0)
	{
		return 1;
	}
	return 0;
...
int func_194()//Position - 0x22C7D
{
	return Global_32164;
}

int func_195(var uParam0, int iParam1)//Position - 0x22C88
{
	int iVar0;
...
int func_196(int iParam0)//Position - 0x26424
{
	switch (iParam0)
	{
		case 46:
...
void func_197(int iParam0, bool bParam1)//Position - 0x26513
{
	switch (iParam0)
	{
		case 46:
...
void func_198(int iParam0, bool bParam1)//Position - 0x26564
{
	int iVar0;
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (!func_202(iParam0))
		{
			...
			if (!bParam1)
			{
				...
				if (!func_199(68))
				{
					func_207("DI_HLP_STRY" /* GXT: Story characters become available in Rockstar Editor's 'Director Mode' as the GTAV story progresses. */, 2, 0, 20000, 10000, 7, 0, 208, 0);
				}
			}
		}
	}
...
int func_199(int iParam0)//Position - 0x265CA
{
	int iVar0;
	int iVar1;
...
void func_200(char* sParam0)//Position - 0x2660A
{
...
char* func_201(int iParam0)//Position - 0x2662E
{
	switch (iParam0)
	{
		case 0:
...
int func_202(int iParam0)//Position - 0x26801
{
...
void func_203(int iParam0, int iParam1)//Position - 0x2682B
{
...
int func_204(char* sParam0)//Position - 0x26868
{
	int iVar0;
...
int func_205()//Position - 0x268C8
{
	return func_206(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_206(char* sParam0, int iParam1)//Position - 0x268D9
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_207(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x26922
{
	func_208(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_208(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x26943
{
	int iVar0;
...
void func_209()//Position - 0x26B16
{
	int iVar0;
...
bool func_210(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x26C2D
{
	func_226(uParam0, 145, sParam1, iParam4, iParam5, iParam6);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
...
int func_211(char* sParam0, int iParam1, bool bParam2)//Position - 0x26C7B
{
	Global_21726 = 0;
...
void func_212()//Position - 0x26F49
{
	if (!func_213())
	{
		return;
...
bool func_214(int iParam0)//Position - 0x26FE3
{
	return func_215(iParam0, 20);
}

var func_215(int iParam0, int iParam1)//Position - 0x26FF3
{
	return BitTest(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

int func_216()//Position - 0x2700B
{
	return -1;
}

void func_217()//Position - 0x27014
{
	int iVar0;
...
void func_218()//Position - 0x27045
{
...
void func_221()//Position - 0x2719A
{
	if (func_96(14))
	{
...
int func_222()//Position - 0x2723C
{
	func_160();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_223()//Position - 0x27255
{
	int iVar0;
...
bool func_224(int iParam0, int iParam1)//Position - 0x272AC
{
	switch (iParam0)
	{
		case 5:
...
void func_225()//Position - 0x272E4
{
...
void func_226(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x2733B
{
...
void func_227()//Position - 0x27391
{
	Global_20591 = 0;
	func_228();
}

void func_228()//Position - 0x273A1
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
float func_229(int iParam0, int iParam1)//Position - 0x273C5
{
	return func_230(iParam0, iParam1, 1);
}

float func_230(int iParam0, int iParam1, bool bParam2)//Position - 0x273D6
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_231(int iParam0)//Position - 0x27434
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_232()//Position - 0x27455
{
	if (func_231(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (func_235(Local_81.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
		{
		...
		else if (func_233(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 1))
		{
			TASK::TASK_SMART_FLEE_PED(Local_81.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
			iLocal_144 = 3;
			func_254(5);
...
int func_233(int iParam0, int iParam1, bool bParam2)//Position - 0x2753A
{
	if (func_234(iParam0) && PED::IS_PED_IN_ANY_VEHICLE(iParam0, false))
	{
		if (func_234(iParam1))
		{
...
int func_234(int iParam0)//Position - 0x27585
{
	if (func_231(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_235(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x275A5
{
	struct<3> Var0;
	
	if (func_231(PLAYER::PLAYER_PED_ID()) && func_231(iParam0))
	{
...
int func_236(int iParam0, float fParam1)//Position - 0x27660
{
	float fVar0;
...
bool func_237(int iParam0, float fParam1)//Position - 0x276D6
{
	return func_238(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_238(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x276EE
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!func_231(iParam0) || !func_231(iParam1))
	{
		if (iVar4 != -1)
		{
			func_245(&(Local_37[iVar4 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_239(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_239(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x277AF
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_240(int iParam0, int iParam1)//Position - 0x278DB
{
	int iVar0;
...
int func_242(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x279EA
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_243(struct<3> Param0, struct<3> Param3)//Position - 0x27A7B
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_244(struct<3> Param0)//Position - 0x27A9C
{
	float fVar0;
	float fVar1;
...
void func_245(var uParam0)//Position - 0x27ADB
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_246(int iParam0, int iParam1)//Position - 0x27AF6
{
	int iVar0;
...
int func_247(int iParam0)//Position - 0x27B35
{
...
bool func_248(int iParam0, int iParam1, float fParam2)//Position - 0x27B5D
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_249(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x27BA4
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_250(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x27C9F
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_251(int iParam0, float fParam1)//Position - 0x27DAB
{
	var uVar0;
	struct<3> Var1;
...
int func_252(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x27E40
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_253(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x27ECE
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_254(int iParam0)//Position - 0x27F16
{
	iLocal_142 = iParam0;
	iLocal_143 = 0;
}

void func_255()//Position - 0x27F25
{
	if (func_232())
	{
		switch (iLocal_143)
...
void func_256(int iParam0)//Position - 0x27FB3
{
	iLocal_142 = iParam0;
	iLocal_143 = 0;
}

void func_257(char* sParam0, int iParam1, int iParam2)//Position - 0x27FC2
{
	iParam2 = iParam2;
...
void func_258()//Position - 0x27FDB
{
	switch (iLocal_143)
	{
		case 0:
			func_289("SCRAP_1_RCM", 0);
			if (func_281(1, 1093140480, 0))
			{
				...
				func_328(0);
				func_278();
				func_270(Local_331[0 /*3*/], Local_331[1 /*3*/], fLocal_338, 2455.886f, 3432.4453f, 49.2697f, 189.77f, 1, 1, 1, 0, 0);
		...
		case 1:
			...
			if (CUTSCENE::HAS_CUTSCENE_FINISHED())
			{
				...
				if (func_231(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(Local_81.f_41[0]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_81.f_41[0], Local_81.f_28[0], PED::GET_PED_BONE_INDEX(Local_81.f_28[0], 18905), 0.09f, 0.072f, -0.006f, 298f, 194f, 178f, false, false, false, false, 2, true, 0);
				}
				if (func_231(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_319))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_319, Local_81.f_28[0], PED::GET_PED_BONE_INDEX(Local_81.f_28[0], 64729), Local_320, Local_323, false, false, false, false, 2, true, 0);
				}
...
void func_259(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x28245
{
	int iVar0;
...
void func_260(int iParam0, bool bParam1)//Position - 0x28403
{
...
Vector3 func_261(int iParam0)//Position - 0x2843F
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_262(bool bParam0)//Position - 0x28452
{
	int iVar0;
	...
	func_263(1, 1, 0, 0, 0, 0, 0);
}

void func_263(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x28491
{
	if (bParam0)
	{
	...
	else
	{
		...
		func_279(0, bParam3, iParam2, 0);
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_267(PLAYER::PLAYER_ID())) && !func_265(PLAYER::PLAYER_ID(), 0)) && !func_264()) && !bParam4) && !bParam5) && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
			{
...
bool func_264()//Position - 0x285DE
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_265(int iParam0, int iParam1)//Position - 0x285F8
{
	bool bVar0;
...
int func_266(int iParam0, bool bParam1)//Position - 0x28643
{
	int iVar0;
	int iVar1;
...
int func_267(int iParam0)//Position - 0x28684
{
...
bool func_268()//Position - 0x286C3
{
	return BitTest(Global_2621446, 3);
}

void func_269(int iParam0)//Position - 0x286D1
{
	if (iParam0 == 1)
	{
...
void func_270(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x286F4
{
	func_271(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_271(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2871D
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_272(struct<3> Param0)//Position - 0x28B13
{
...
int func_273(int iParam0, int iParam1, bool bParam2)//Position - 0x28B3D
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_274(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x28BAB
{
...
int func_275(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x28C83
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_276(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x28F79
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_277(int iParam0)//Position - 0x2902D
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_278()//Position - 0x29092
{
	int iVar0;
	var uVar1[16];
	...
	while (iVar0 < 16)
	{
		if (func_231(uVar1[iVar0]) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(uVar1[iVar0], Local_331[0 /*3*/], Local_331[1 /*3*/], fLocal_338, false, true, 0))
		{
...
int func_279(bool bParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x29144
{
	int iVar0;
...
void func_280()//Position - 0x29177
{
	int iVar0;
...
int func_281(int iParam0, float fParam1, int iParam2)//Position - 0x29197
{
	int iVar0;
...
bool func_282()//Position - 0x2926B
{
	bool bVar0;
...
void func_283()//Position - 0x2928E
{
	Global_20591 = 0;
	func_225();
}

int func_284()//Position - 0x2929E
{
...
void func_285()//Position - 0x292C0
{
...
int func_286(int iParam0, int iParam1)//Position - 0x29311
{
	if (func_234(iParam0))
	{
...
int func_287(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x29344
{
...
void func_288(int iParam0)//Position - 0x294DC
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_289(char* sParam0, bool bParam1)//Position - 0x29508
{
	func_262(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_290()//Position - 0x2951E
{
	func_292();
	if (func_232())
	{
		if (MISC::GET_GAME_TIMER() < iLocal_327 && !func_291(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 4f, 1))
		{
...
void func_293()//Position - 0x295EB
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_294(int iParam0)//Position - 0x29643
{
	if (func_299())
	{
		return;
...
void func_295(int iParam0)//Position - 0x29676
{
	if (func_299())
	{
		return;
...
void func_296(bool bParam0, bool bParam1)//Position - 0x29700
{
	if (bParam0)
	{
		if (func_298(0))
...
bool func_297()//Position - 0x29774
{
	return BitTest(Global_1962996, 5);
}

int func_298(int iParam0)//Position - 0x29782
{
	if (iParam0 == 1)
	{
		if (Global_20383.f_1 > 3)
...
bool func_299()//Position - 0x297D9
{
	return BitTest(Global_1962996, 19);
}

void func_300()//Position - 0x297E8
{
	func_292();
	...
	if (func_232())
	{
		if ((((STREAMING::HAS_ANIM_DICT_LOADED("rcmrc_omega_1leadinoutscrap_1_rcm") && STREAMING::HAS_ANIM_DICT_LOADED("rcmrc_omega_1")) && HUD::HAS_ADDITIONAL_TEXT_LOADED(0)) && STREAMING::HAS_MODEL_LOADED(iLocal_317)) && STREAMING::HAS_MODEL_LOADED(iLocal_318))
		{
			...
			if (func_234(PLAYER::PLAYER_PED_ID()) && func_234(Local_81.f_28[0]))
			{
				...
				func_301(&uLocal_151, 3, Local_81.f_28[0], "OMEGA", 0, 1);
				func_301(&uLocal_151, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			}
...
void func_301(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x29960
{
...
void func_302(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x299FB
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_304(Global_78814, Global_78816, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_303(char* sParam0)//Position - 0x29CE0
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_304(int iParam0, int iParam1, int iParam2)//Position - 0x29CF3
{
	struct<2> Var0;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_305(iVar2), 8);
					break;
			}
			break;
...
char* func_305(int iParam0)//Position - 0x29DC9
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_306(int iParam0)//Position - 0x29F1C
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_307(int iParam0)//Position - 0x29F4F
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_308(int iParam0)//Position - 0x29F82
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_309(int iParam0)//Position - 0x29FB5
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_310(int iParam0)//Position - 0x29FE8
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_311(int iParam0)//Position - 0x2A025
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_312(int iParam0)//Position - 0x2A058
{
	struct<2> Var0;
...
int func_313(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2A0C1
{
	if (((!func_315(0) || Global_78828) || Global_78817 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78813)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_298(0)) || func_314(1))
			{
			}
			else
			{
...
bool func_314(bool bParam0)//Position - 0x2A1D9
{
	if (bParam0)
	{
...
int func_315(int iParam0)//Position - 0x2A202
{
	if (Global_43257 == 15)
	{
		return 0;
...
bool func_316(int iParam0)//Position - 0x2A224
{
	return func_317(iParam0, Global_43257);
}

int func_317(int iParam0, int iParam1)//Position - 0x2A235
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_318(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2A416
{
	int iVar0;
...
void func_319(var uParam0, bool bParam1, bool bParam2)//Position - 0x2A4C0
{
	int iVar0;
...
int func_320(var uParam0)//Position - 0x2A5B5
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_79)
	{
		case 0:
			...
			func_327(&(uParam0->f_48), "rcmrc_omega_1", "omega_idle_geiger_counter", 0);
			iLocal_79 = 1;
			break;
		
		case 1:
			if (!func_326(&iVar0) || !func_324(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_79 = 2;
		...
		case 2:
			...
			{
				if (!func_321(&(uParam0->f_28[0]), 69, 2468.51f, 3437.39f, 49.9f, 180f, "OMEGA LAUNCHER RC", 1))
				{
					bVar5 = false;
				}
			}
			...
			if ((func_231(uParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0])) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
...
int func_321(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x2A839
{
	if (func_322(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_322(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2A895
{
	int iVar0;
...
int func_323(var uParam0, int iParam1)//Position - 0x2A923
{
	int iVar0;
...
int func_324(var uParam0)//Position - 0x2A969
{
	if (func_325(uParam0))
	{
...
int func_325(var uParam0)//Position - 0x2A993
{
...
int func_326(int iParam0)//Position - 0x2A9B8
{
	int iVar0;
...
void func_327(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2A9E9
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
void func_328(int iParam0)//Position - 0x2AA25
{
	struct<3> Var0[3];
	struct<3> Var10;
	bool bVar13;
...
Vector3 func_329()//Position - 0x2ABA5
{
	return 2.55f, 5.665f, 2.55f;
}

int func_330()//Position - 0x2ABBC
{
	return Global_104212.f_4;
}

void func_331(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2ABCA
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_441(iParam6, iParam7, iParam8, iParam13))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_412(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_411(Param1, 0f, 0f, 0f, 0))
		{
			Param1 = { Global_107196.f_2890 };
			fParam4 = Global_107196.f_2890.f_6;
		}
		MISC::CLEAR_AREA(Param1, 5f, true, false, false, false);
		func_405(Param1, 5f, 0);
		if (func_157(iParam12))
		{
			func_403(iParam12, 0);
			while (!func_332(iParam0, iParam12, Param1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_332(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2AD5E
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_394(iParam0, &(Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_394(iParam0, &(Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5.f_0, Param2, fParam5, true, true, false);
				...
				func_394(iParam0, &(Var5.f_31), &(Var5.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_333(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2BB7E
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_157(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_338(*iParam1, 0, &uVar0))
		{
			func_337(iParam1, &(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_113648.f_20120[iParam0 /*43*/].f_31 = func_336(*iParam1);
				...
				func_334(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_113648.f_20120[iParam0 /*43*/].f_1));
				...
				func_334(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_113648.f_20120[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_334(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x2C796
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_335(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
bool func_335(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x2C809
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_336(int iParam0)//Position - 0x2DCFB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_337(int iParam0, var uParam1, var uParam2)//Position - 0x2DDAB
{
	int iVar0;
	int iVar1;
...
int func_338(int iParam0, bool bParam1, var uParam2)//Position - 0x2DF9E
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_370(iVar0, bParam1, uParam2) && !func_369(PLAYER::PLAYER_ID())) && !func_350(iParam0))
	{
		return 0;
	}
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_339(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_339(int iParam0)//Position - 0x2E10C
{
	int iVar0;
...
int func_340(int iParam0)//Position - 0x2E147
{
	if (iParam0 != func_216())
	{
		if (func_342(iParam0, 1, 1))
		{
			...
			{
				return func_341(Global_2657589[iParam0 /*466*/].f_321.f_7) == 11;
			}
		}
	}
	return 0;
...
int func_341(int iParam0)//Position - 0x2E18E
{
	switch (iParam0)
	{
		case 0:
...
int func_342(int iParam0, bool bParam1, bool bParam2)//Position - 0x2E642
{
	int iVar0;
...
int func_343(int iParam0)//Position - 0x2E6A2
{
...
int func_344(int iParam0)//Position - 0x2E6E4
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_345(int iParam0)//Position - 0x2E7AC
{
	if (iParam0 != func_216())
	{
		if (func_342(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_341(Global_2657589[iParam0 /*466*/].f_321.f_7) == 26;
			}
		}
	}
	return 0;
...
int func_346(int iParam0)//Position - 0x2E7F3
{
	if (iParam0 != func_216())
	{
		if (func_342(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_341(Global_2657589[iParam0 /*466*/].f_321.f_7) == 13;
			}
		}
	}
	return 0;
...
int func_347(int iParam0)//Position - 0x2E83A
{
	if (iParam0 != func_216())
	{
		if (func_342(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_341(Global_2657589[iParam0 /*466*/].f_321.f_7) == 7;
			}
		}
	}
	return 0;
...
int func_348(int iParam0)//Position - 0x2E880
{
	if (iParam0 == joaat("oppressor2"))
	{
		return 0;
	}
	if ((!func_349(PLAYER::PLAYER_ID()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger"))
	{
		return 0;
	}
	return 1;
...
int func_349(int iParam0)//Position - 0x2E8C1
{
	if (iParam0 != func_216())
	{
...
int func_350(int iParam0)//Position - 0x2E8E7
{
	if (func_368(PLAYER::PLAYER_ID()) || func_367(PLAYER::PLAYER_ID()))
	{
		if (func_351(iParam0))
		{
			return 1;
...
int func_351(int iParam0)//Position - 0x2E916
{
	...
	if (func_354(PLAYER::PLAYER_ID()) && (!func_348(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("thruster"))))
	{
		return 0;
	}
...
int func_352(int iParam0)//Position - 0x2E9C7
{
	int iVar0;
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_344(iParam0)) || func_353(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_353(int iParam0)//Position - 0x2EA3E
{
	switch (iParam0)
	{
		case joaat("mule"):
...
int func_354(int iParam0)//Position - 0x2EA8E
{
	if (iParam0 == func_216())
	{
		return 0;
	}
	if (func_369(iParam0) && Global_2657589[iParam0 /*466*/].f_321.f_10 == iParam0)
	{
		return 1;
	}
	return 0;
...
int func_355(int iParam0, bool bParam1)//Position - 0x2EAC7
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_357(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				...
				else if (func_356(iParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_356(int iParam0)//Position - 0x2EB22
{
	int iVar0;
...
int func_357(int iParam0, int iParam1)//Position - 0x2EB5B
{
	if (iParam1 == 0)
	{
...
int func_367(int iParam0)//Position - 0x2F441
{
	if (iParam0 != func_216())
	{
		if (func_342(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1 && Global_2657589[iParam0 /*466*/].f_321.f_10 != func_216())
			{
				return func_341(Global_2657589[iParam0 /*466*/].f_321.f_7) == 5;
			}
		}
	}
	return 0;
...
int func_368(int iParam0)//Position - 0x2F4A0
{
	if (iParam0 != func_216())
	{
		if (func_342(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1 && Global_2657589[iParam0 /*466*/].f_321.f_10 != func_216())
			{
				return func_341(Global_2657589[iParam0 /*466*/].f_321.f_7) == 8;
			}
		}
	}
	return 0;
...
int func_369(int iParam0)//Position - 0x2F500
{
	if (iParam0 != func_216())
	{
		if (func_342(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_341(Global_2657589[iParam0 /*466*/].f_321.f_7) == 9;
			}
		}
	}
	return 0;
...
int func_370(int iParam0, bool bParam1, var uParam2)//Position - 0x2F547
{
	bool bVar0;
...
int func_371(int iParam0)//Position - 0x2F993
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_372(int iParam0, int iParam1)//Position - 0x2F9BC
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_373(iParam0, &(Global_113648.f_32751.f_5510));
}

void func_373(int iParam0, var uParam1)//Position - 0x2FBBE
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		if (uParam1->f_65 == -1 && !func_375(uParam1->f_66))
		{
			uParam1->f_65 = 0;
		}
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_374(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_374(int iParam0)//Position - 0x2FE69
{
	switch (iParam0)
	{
		case 1:
...
int func_375(int iParam0)//Position - 0x2FF19
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_376(int iParam0)//Position - 0x2FF39
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_273(iParam0, 0, 0)) || func_273(iParam0, 1, 0)) || func_273(iParam0, 2, 0)) || func_390(iParam0) != 145) || func_389(iParam0)) || func_388(iParam0)) || func_339(iParam0)) || func_387(iParam0)) || !func_377(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_388(iParam0))
		{
		}
...
int func_377(int iParam0)//Position - 0x30016
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_378(int iParam0, bool bParam1, int iParam2)//Position - 0x301C8
{
	int iVar0;
	struct<2> Var1;
...
int func_379(int iParam0)//Position - 0x3034A
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_381(int iParam0, int iParam1)//Position - 0x3042D
{
	int iVar0;
	int iVar1;
...
int func_382()//Position - 0x33A5D
{
	return 0;
}

int func_383()//Position - 0x33A66
{
	return 1;
}

int func_384()//Position - 0x33A6F
{
	return 1;
}

int func_385()//Position - 0x33A78
{
...
int func_387(int iParam0)//Position - 0x33B49
{
	int iVar0;
	char* sVar1;
...
int func_388(int iParam0)//Position - 0x33B90
{
	int iVar0;
...
int func_389(int iParam0)//Position - 0x33C0C
{
	int iVar0;
...
int func_390(int iParam0)//Position - 0x33CF4
{
	int iVar0;
...
void func_391(int iParam0, int iParam1)//Position - 0x33D57
{
	int iVar0;
...
void func_392(int iParam0)//Position - 0x33DD9
{
	if (!func_393(*iParam0))
	{
...
bool func_393(int iParam0)//Position - 0x33E04
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_394(int iParam0, var uParam1, var uParam2)//Position - 0x33E13
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*iParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_399(*iParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_366(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_397(*iParam0, ((*uParam1)[38] - 1)))
	{
...
int func_395(int iParam0)//Position - 0x33FED
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_396(var uParam0)//Position - 0x340CA
{
...
int func_397(int iParam0, int iParam1)//Position - 0x34121
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_398(int iParam0, int iParam1)//Position - 0x3420A
{
	int iVar0;
	...
	while (iVar0 >= 0 && func_399(iParam0, iParam1, iVar0))
	{
		iVar0 = (iVar0 - 1);
	}
	return iVar0;
...
int func_399(int iParam0, int iParam1, int iParam2)//Position - 0x3426C
{
	if (!func_400() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_400()//Position - 0x34290
{
	return 0;
}

int func_401(var uParam0, int iParam1)//Position - 0x34299
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_402(int iParam0, var uParam1, int iParam2)//Position - 0x342DA
{
	int iVar0;
...
void func_403(int iParam0, int iParam1)//Position - 0x34536
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98012[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98012[iVar0]) == func_404(iParam0, iParam1))
				{
...
int func_404(int iParam0, int iParam1)//Position - 0x345D4
{
	struct<82> Var0;
...
void func_405(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x34616
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_410(&(Global_77348.f_555[0 /*21*/]), iVar0))
		{
...
void func_406(int iParam0)//Position - 0x34666
{
	bool bVar0;
	...
	if (func_410(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_188(iParam0, 0)) && Global_78257.f_66 == 0) && Global_113648.f_32751.f_1958[Global_77348.f_555[0 /*21*/].f_14] != 0) && Global_113648.f_32751.f_1958[Global_77348.f_555[0 /*21*/].f_14] > 3) && (!func_408(0, Global_77348.f_555[0 /*21*/].f_12) || !func_408(1, Global_77348.f_555[0 /*21*/].f_12)))
			{
				func_407(&(Global_113648.f_32751.f_69[Global_77348.f_555[0 /*21*/].f_14 /*78*/]), &Global_78257);
...
void func_407(var uParam0, var uParam1)//Position - 0x347D5
{
...
int func_408(int iParam0, int iParam1)//Position - 0x348A1
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_409(&(Global_113648.f_32751.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_378(Global_113648.f_32751.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}

int func_409(var uParam0)//Position - 0x34914
{
	return *uParam0;
}

int func_410(var uParam0, int iParam1)//Position - 0x3491F
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_411(Global_113648.f_32751.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_411(Global_113648.f_2365.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_411(Global_113648.f_2365.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
bool func_411(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x3600D
{
	if (bParam6)
	{
...
int func_412(struct<3> Param0, float fParam3)//Position - 0x36054
{
	return func_413(&(Global_107196.f_2890), Param0, fParam3, 0);
}

int func_413(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x3606E
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam5)
					{
						...
						{
							func_403(uParam0->f_11, 1);
						}
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
						{
							func_403(uParam0->f_11, 2);
						}
					}
					...
					func_391(iVar0, uParam0->f_11);
				}
				else if ((!func_415(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_414(iVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_414(int iParam0)//Position - 0x36320
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_415(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x363E3
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_417(iParam0, Global_77348.f_139[38], 0))
			{
				func_406(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_417(iParam0, Global_77348.f_139[43], 1))
			{
				func_406(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_417(iParam0, uVar1[iVar6], 1) && func_416(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.5635f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_411(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
int func_416(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x365EB
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_417(int iParam0, int iParam1, bool bParam2)//Position - 0x36666
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_418(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x366C7
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		{
			iVar0 = 1;
			if (BitTest(uParam1->f_77, func_374(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (BitTest(uParam1->f_77, func_374(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_374(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				if (BitTest(uParam1->f_77, func_374(iVar2)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_374(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				if (BitTest(uParam1->f_77, func_374(iVar3)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_374(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (BitTest(uParam1->f_77, func_374(iVar4)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_77), func_374(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("surfer3"))
		{
			...
			while (iVar5 <= 2)
			{
				if (BitTest(uParam1->f_77, func_374(iVar5)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_374(iVar5));
				}
				iVar5++;
			}
		}
		...
		{
			if (BitTest(uParam1->f_77, func_374(4)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_374(4));
			}
		}
		...
		{
			MISC::SET_BIT(&(uParam1->f_77), func_374(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar6 <= 2)
			{
				if (BitTest(uParam1->f_77, func_374(iVar6)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_374(iVar6));
				}
				iVar6++;
			}
		}
		...
		{
			if (func_427(uParam1->f_5) || func_427(uParam1->f_6))
			{
			}
			else
			{
		...
		if (((BitTest(uParam1->f_77, 15) || func_426(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_425())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar7 <= 11)
			{
				if (BitTest(uParam1->f_77, func_374(iVar7 + 1)))
				{
		...
		if (((func_419() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger")))
		{
...
int func_419()//Position - 0x36DAE
{
	...
	if (func_422(7))
	{
		if (func_421(Global_2672505.f_4.f_16) || func_420(Global_2672505.f_4.f_16))
		{
			return 0;
		}
	}
...
int func_420(var uParam0)//Position - 0x36E3D
{
	int iVar0;
...
int func_421(int iParam0)//Position - 0x36E61
{
	int iVar0;
	...
	if (iVar0 != -1)
	{
		return func_215(iParam0, 9);
	}
	return 0;
}

bool func_422(int iParam0)//Position - 0x36E7F
{
	return func_423(&(Global_2672505.f_183), iParam0);
}

var func_423(var uParam0, var uParam1)//Position - 0x36E93
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_424(int iParam0, int iParam1)//Position - 0x36EB6
{
	int iVar0;
	int iVar1;
...
bool func_425()//Position - 0x36F2E
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

int func_426(int iParam0)//Position - 0x36F3F
{
	int iVar0;
...
int func_427(int iParam0)//Position - 0x36F87
{
	if (!func_400() && func_428(iParam0))
	{
		return 1;
	}
	return 0;
...
int func_428(int iParam0)//Position - 0x36FA7
{
	switch (iParam0)
	{
		case 161:
...
int func_429(int iParam0)//Position - 0x36FFA
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
	...
	if (func_431(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
		{
...
int func_430(int iParam0)//Position - 0x37081
{
...
int func_431(int iParam0)//Position - 0x370B0
{
	if (func_434(iParam0) == 233)
	{
...
int func_432(int iParam0)//Position - 0x370CD
{
...
int func_433(int iParam0, int iParam1)//Position - 0x370F0
{
...
int func_434(int iParam0)//Position - 0x3712B
{
	if (func_433(iParam0, 0))
	{
...
int func_435(int iParam0, int iParam1)//Position - 0x3714E
{
	int iVar0;
...
int func_436(var uParam0)//Position - 0x3719B
{
	if (func_437(uParam0))
	{
...
int func_437(var uParam0)//Position - 0x371D0
{
	if (uParam0->f_12.f_66 == 0)
	{
		return 0;
	}
	if (!func_378(uParam0->f_12.f_66, 0, -1))
	{
		return 0;
	}
	if (uParam0->f_12.f_66 == joaat("stunt") && func_416(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
bool func_438()//Position - 0x37230
{
	return func_436(&(Global_107196.f_2890));
}

void func_439()//Position - 0x37243
{
	func_440(&(Global_107196.f_2890));
}

void func_440(var uParam0)//Position - 0x37256
{
	if (func_437(uParam0))
	{
...
int func_441(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x37274
{
	...
	if (iParam2 == 0 && func_443(Global_107196.f_2890.f_12.f_66))
	{
		return 0;
	}
...
int func_443(int iParam0)//Position - 0x37377
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_444()//Position - 0x373D0
{
	return func_437(&(Global_107196.f_2890));
}

int func_445()//Position - 0x373E3
{
...
void func_446()//Position - 0x37407
{
	Local_331[0 /*3*/] = { 2453.5134f, 3424.6465f, 48.44232f };
	Local_331[1 /*3*/] = { 2490.0596f, 3434.1948f, 58.261032f };
	fLocal_338 = 32.75f;
}

void func_447()//Position - 0x37445
{
	func_280();
	if (func_464())
	{
	...
	func_463(0);
	func_462(&uLocal_151, 1);
	func_462(&uLocal_151, 3);
	func_461(&(Local_81.f_28[0]), 1, 0, 1);
	if (ENTITY::DOES_ENTITY_EXIST(Local_81.f_41[0]))
	{
	...
	func_448(&Local_81, 0, 0, 0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_448(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x374BF
{
	func_458(uParam0, iParam1);
	func_453(uParam0, bParam2);
	func_449(uParam0, bParam3);
}

void func_449(var uParam0, bool bParam1)//Position - 0x374DF
{
	func_450(&(uParam0->f_41), bParam1);
}

void func_450(var uParam0, bool bParam1)//Position - 0x374F1
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_451(uParam0[iVar0], 0);
		}
		iVar0++;
	}
}

void func_451(int* iParam0, bool bParam1)//Position - 0x3752F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_452(int* iParam0)//Position - 0x3756A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_453(var uParam0, bool bParam1)//Position - 0x37595
{
	func_454(&(uParam0->f_35), bParam1);
}

void func_454(var uParam0, bool bParam1)//Position - 0x375A7
{
	int iVar0;
...
void func_455(int* iParam0)//Position - 0x375E4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_456(int* iParam0)//Position - 0x3761C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_457(int iParam0)//Position - 0x376B8
{
	if (func_231(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_458(var uParam0, int iParam1)//Position - 0x376E2
{
	func_459(&(uParam0->f_28), iParam1);
}

void func_459(var uParam0, int iParam1)//Position - 0x376F4
{
	int iVar0;
...
void func_460(int* iParam0)//Position - 0x37735
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_461(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x37776
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_462(var uParam0, int iParam1)//Position - 0x377C6
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_463(int iParam0)//Position - 0x377E3
{
	Global_22736 = iParam0;
}

int func_464()//Position - 0x377F0
{
	int iVar0;
...
void func_465(bool bParam0)//Position - 0x37891
{
	int iVar0;
	...
	if (!func_482())
	{
		...
		else
		{
			...
			func_164(iVar0, 1, 1, 0);
		}
		Global_112735[iVar0 /*10*/].f_6 = 1;
	}
}

void func_466(char* sParam0, int iParam1)//Position - 0x37961
{
	if (Global_100681 != 12)
	{
...
int func_467(char* sParam0, int iParam1, int iParam2)//Position - 0x37989
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_468(char* sParam0)//Position - 0x37B18
{
...
int func_470(char* sParam0, bool bParam1)//Position - 0x37B92
{
	int iVar0;
	int iVar1;
...
int func_471(int iParam0, bool bParam1)//Position - 0x37BBC
{
	int iVar0;
...
void func_474(bool bParam0)//Position - 0x37CAE
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_475(int iParam0)//Position - 0x37CC2
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_476(int iParam0)//Position - 0x37CFC
{
	if (iParam0 == 1)
	{
...
void func_477()//Position - 0x37D36
{
	Global_23131.f_5 = 1;
}

void func_478()//Position - 0x37D44
{
	Global_23131.f_5 = 0;
}

void func_479(bool bParam0)//Position - 0x37D52
{
	if (bParam0)
	{
		func_480();
...
void func_480()//Position - 0x37DB5
{
...
void func_481()//Position - 0x37DDE
{
	Global_94857 = 0;
	Global_94858 = 0;
}

int func_482()//Position - 0x37DF0
{
	if (((Global_100681 == 13 || Global_100681 == 10) || Global_100681 == 11) || Global_100681 == 12)
	{
		return 0;
...
void func_483()//Position - 0x37E2E
{
	Global_100716 = 1;
...
void func_484(char* sParam0)//Position - 0x37F1B
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_485(var uParam0)//Position - 0x37F2D
{
...
void func_486(var uParam0)//Position - 0x37F4D
{
	int iVar0;
...
int func_487(int iParam0)//Position - 0x37F87
{
	if (!func_157(iParam0))
	{
		return func_156(iParam0);
