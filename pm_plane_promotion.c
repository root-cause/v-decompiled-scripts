...
void func_1()//Position - 0xC8
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_239))
	{
		...
		else if (iLocal_45 == 2)
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_239, false))
			{
				...
				{
					func_143("BK_PLANE", 7500, 1);
					iLocal_48 = func_142(iLocal_239, 0, 0);
				}
				if (func_141(PLAYER::PLAYER_PED_ID(), iLocal_239, 1) > 300f)
				{
					func_144();
				}
			}
	...
	switch (iLocal_45)
	{
		case 0:
			...
			{
				iLocal_239 = Global_112842.f_222[0];
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_239))
				{
				...
				HUD::CLEAR_PRINTS();
				func_143("GET_PLANE", 7500, 1);
				iLocal_48 = func_142(iLocal_239, 0, 0);
				STREAMING::REQUEST_PTFX_ASSET();
				func_136(&iLocal_49, 1, 0);
				iLocal_45++;
			}
			break;
...
void func_81(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x3B49
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104696.f_4))
	{
		...
		{
			if (func_135(24) != Global_104696.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_132(ENTITY::GET_ENTITY_COORDS(Global_104696.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_82(Global_104696.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_82(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x3BC4
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_118(iParam5, &Var0, Param1, fParam4, func_124(iParam0));
...
void func_83(int iParam0, int iParam1, int iParam2)//Position - 0x3CED
{
	...
	if (!func_115(&(Global_78329.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
...
void func_84(int iParam0, int iParam1)//Position - 0x3E04
{
	...
	func_126(iParam0, &(Global_114135.f_32754.f_5510));
}

int func_85(int iParam0)//Position - 0x4007
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_102(iParam0, 0, 0)) || func_102(iParam0, 1, 0)) || func_102(iParam0, 2, 0)) || func_124(iParam0) != 145) || func_101(iParam0)) || func_100(iParam0)) || func_99(iParam0)) || func_98(iParam0)) || !func_86(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_100(iParam0))
		{
		}
...
int func_88(int iParam0)//Position - 0x4427
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_90(int iParam0, int iParam1)//Position - 0x450A
{
	int iVar0;
	int iVar1;
...
bool func_91()//Position - 0x4713
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_92()//Position - 0x4729
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_93()//Position - 0x473F
{
	return 0;
}

int func_94()//Position - 0x4748
{
	return 1;
}

int func_95()//Position - 0x4751
{
	return 1;
}

int func_96()//Position - 0x475A
{
...
int func_98(int iParam0)//Position - 0x482B
{
	int iVar0;
	char* sVar1;
...
int func_99(int iParam0)//Position - 0x4872
{
	int iVar0;
...
int func_100(int iParam0)//Position - 0x48AD
{
	int iVar0;
...
int func_101(int iParam0)//Position - 0x4929
{
	int iVar0;
...
int func_102(int iParam0, int iParam1, bool bParam2)//Position - 0x4A11
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_103(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x4A7F
{
...
void func_105(var uParam0, int iParam1)//Position - 0x4B9D
{
	if (iParam1 <= 0)
	{
		return;
...
void func_106(var uParam0, int iParam1)//Position - 0x4C23
{
...
void func_107(var uParam0, int iParam1)//Position - 0x4C56
{
	int iVar0;
	int iVar1;
...
int func_108(int iParam0, int iParam1)//Position - 0x4CA7
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_109(int iParam0)//Position - 0x4D49
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_110(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_110(bool bParam0, int iParam1, int iParam2)//Position - 0x4D6B
{
	if (bParam0)
	{
		return iParam1;
...
int func_111(var uParam0)//Position - 0x4D82
{
	return uParam0 & 15;
}

void func_112(var uParam0, int iParam1)//Position - 0x4D8F
{
...
void func_113(var uParam0, int iParam1)//Position - 0x4DC9
{
...
void func_114(var uParam0, int iParam1)//Position - 0x4E04
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_115(var uParam0, int iParam1)//Position - 0x4E40
{
	int iVar0;
	int iVar1;
...
int func_116(int iParam0, int iParam1)//Position - 0x652E
{
	struct<82> Var0;
...
void func_117(int iParam0, var uParam1, int iParam2)//Position - 0x6570
{
	int iVar0;
...
void func_118(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x67CC
{
	if (func_115(&(Global_78329.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_123(iParam0);
			func_122(uParam1, &(Global_114135.f_32754.f_69[Global_78329.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_119(int iParam0, bool bParam1)//Position - 0x68C5
{
	if (iParam0 == -1)
	{
		return;
	...
	if (bParam1)
	{
		...
		{
			func_120(iParam0, 1, 0);
			func_120(iParam0, 2, 0);
			func_120(iParam0, 3, 0);
			func_120(iParam0, 4, 0);
			func_120(iParam0, 0, 1);
...
void func_120(int iParam0, int iParam1, bool bParam2)//Position - 0x6922
{
	if (iParam0 == -1)
	{
		return;
...
int func_121(int iParam0, int iParam1)//Position - 0x695D
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_122(var uParam0, var uParam1)//Position - 0x697D
{
...
void func_123(int iParam0)//Position - 0x6A49
{
	if (iParam0 == -1)
	{
		return;
...
int func_124(int iParam0)//Position - 0x6AC0
{
	int iVar0;
...
bool func_125(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6B23
{
	if (bParam6)
	{
...
void func_126(int iParam0, var uParam1)//Position - 0x6B6A
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_128(&iParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
			{
				MISC::SET_BIT(&(uParam1->f_77), func_127(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_127(int iParam0)//Position - 0x6E15
{
	switch (iParam0)
	{
		case 1:
...
int func_128(int iParam0, var uParam1, var uParam2)//Position - 0x6EC5
{
	int iVar0;
	int iVar1;
...
int func_129(int iParam0)//Position - 0x70B8
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_130(var uParam0)//Position - 0x70D8
{
	int iVar0;
...
void func_131(int iParam0)//Position - 0x7188
{
...
int func_132(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x71AF
{
	int iVar0;
...
int func_133(struct<3> Param0, int iParam3, int iParam4)//Position - 0x72C5
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_134(int iParam0)//Position - 0x7354
{
	return BitTest(Global_114135.f_7233[iParam0], 0);
}

int func_135(int iParam0)//Position - 0x7369
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_136(int* iParam0, bool bParam1, bool bParam2)//Position - 0x7385
{
	int iVar0;
...
void func_137(int iParam0, var uParam1)//Position - 0x7530
{
	switch (iParam0)
	{
		case 0:
...
void func_138(var uParam0)//Position - 0x7578
{
	if (HUD::DOES_BLIP_EXIST(uParam0->f_5))
	{
		HUD::REMOVE_BLIP(&(uParam0->f_5));
...
float func_139(float fParam0, float fParam1, float fParam2)//Position - 0x7593
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
bool func_140(char* sParam0)//Position - 0x75BA
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

float func_141(int iParam0, int iParam1, bool bParam2)//Position - 0x75CD
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_142(int iParam0, bool bParam1, bool bParam2)//Position - 0x762B
{
	return func_34(iParam0, !bParam1, bParam2);
}

void func_143(char* sParam0, int iParam1, int iParam2)//Position - 0x763E
{
	iParam2 = iParam2;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
void func_144()//Position - 0x7657
{
	func_152(2);
	func_151();
}

int func_145()//Position - 0x7668
{
...
void func_146()//Position - 0x768A
{
	...
	func_150(2, 1);
	func_149(&uLocal_74, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
...
int func_147()//Position - 0x78A2
{
	return Global_112842.f_20;
}

int func_148(struct<3> Param0)//Position - 0x78B0
{
...
void func_149(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x78DA
{
...
void func_150(int iParam0, int iParam1)//Position - 0x7975
{
...
void func_152(int iParam0)//Position - 0x7A25
{
