...
void func_1()//Position - 0xC8
{
	...
	{
		if (!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_237, false))
		{
			func_143();
		}
		else if (iLocal_43 == 2)
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_237, false))
			{
				if (!HUD::DOES_BLIP_EXIST(iLocal_46))
				{
					func_142("BK_PLANE", 7500, 1);
					iLocal_46 = func_141(iLocal_237, 0, 0);
				}
				if (func_140(PLAYER::PLAYER_PED_ID(), iLocal_237, 1) > 300f)
				{
					func_143();
				}
			}
	...
	if ((((ENTITY::DOES_ENTITY_EXIST(iLocal_237) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_237, false)) && ENTITY::IS_ENTITY_IN_AIR(iLocal_237)) && iLocal_241) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("PLANES", false, -1))
	{
		if (!bLocal_242)
		{
			if (PAD::IS_CONTROL_JUST_PRESSED(0 /*PLAYER_CONTROL*/, 114 /*INPUT_VEH_FLY_ATTACK*/))
			{
				if (iLocal_240 == -1 || (MISC::GET_GAME_TIMER() - iLocal_240) > 2000)
				{
					...
					{
						iLocal_248 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_property_leaflet_drop", iLocal_237, 0f, -2f, -0.65f, 0f, 0f, 0f, 1f, false, false, false);
						fLocal_246 = 0f;
					}
					if (func_139("LEAFLET"))
					{
	...
	{
		GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_248, false);
		fLocal_246 = 0f;
	}
	if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_248))
	{
		...
		fLocal_246 = func_138(fLocal_246, 0f, 1f);
		GRAPHICS::SET_PARTICLE_FX_LOOPED_EVOLUTION(iLocal_248, "spawn", fLocal_246, false);
	}
	switch (iLocal_43)
	{
		case 0:
			...
			{
				iLocal_237 = Global_112096.f_222[0];
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_237))
				{
					iLocal_237 = VEHICLE::CREATE_VEHICLE(joaat("stunt"), Var0, 121.2244f, true, true, false);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_237, 5f);
				}
				else
				{
				...
				HUD::CLEAR_PRINTS();
				func_142("GET_PLANE", 7500, 1);
				iLocal_46 = func_141(iLocal_237, 0, 0);
				STREAMING::REQUEST_PTFX_ASSET();
				func_135(&iLocal_47, 1, 0);
				iLocal_43++;
			}
			break;
		
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_237) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_237, false))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_237, false))
				{
					HUD::CLEAR_PRINTS();
					func_142("TAKEOFF", 7500, 1);
					if (HUD::DOES_BLIP_EXIST(iLocal_46))
					{
						HUD::REMOVE_BLIP(&iLocal_46);
					}
					func_80(-1021.5223f, -2986.142f, 12.9519f, 341.6539f, 0, 145);
					iLocal_43++;
				}
			}
			break;
		...
		case 3:
			if (func_30(&iLocal_47, Local_36, -1067.083f, -2922.6008f, 12.824183f, -1091.8535f, -2965.4033f, 23.94564f, 31.5625f, 1, iLocal_237, "LAND", "", "BK_PLANE", 1, 0, 1, -1) && !ENTITY::IS_ENTITY_IN_AIR(iLocal_237))
			{
				func_135(&iLocal_47, 1, 0);
				iLocal_43++;
			}
...
void func_29(int iParam0)//Position - 0x104F
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
{
	return func_31(iParam0, Param1, func_75(), Param2, Param3, bParam5, 5, 0, 0, 0, iParam6, sParam7, func_74(), func_74(), func_74(), func_74(), sParam8, 0, bParam10, sParam9, 1, iParam11, bParam12, iParam13, func_74(), func_74(), func_74(), 1, fParam4);
}
		...
		if (CAM::IS_SCREEN_FADED_IN())
		{
			...
			if (bVar1)
			{
				...
				if (bParam18 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					if ((!func_48(iParam0, 1) && !func_47(iParam0)) && !BitTest(iParam0->f_13, 0))
					{
						if (bParam22)
						{
...
int func_32(int iParam0, bool bParam1, bool bParam2)//Position - 0x19D5
{
	return func_33(iParam0, !bParam1, bParam2);
}

int func_33(int iParam0, bool bParam1, bool bParam2)//Position - 0x19E8
{
	int iVar0;
...
float func_34(bool bParam0, float fParam1, float fParam2)//Position - 0x1A8C
{
	if (bParam0)
	{
		return fParam1;
...
int func_35(int* iParam0)//Position - 0x1AA3
{
	if (BitTest(iParam0->f_13, 12))
	{
		if (func_37(PLAYER::PLAYER_PED_ID()))
		{
			if (func_36(1, 0, 1) || BitTest(iParam0->f_13, 7))
			{
				return 1;
			}
		}
	}
	else if (func_36(1, 0, 1) || BitTest(iParam0->f_13, 7))
	{
		return 1;
	}
	return 0;
...
int func_36(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1AF8
{
	int iVar0;
...
int func_37(int iParam0)//Position - 0x1BDD
{
	float fVar0;
...
int func_38(int iParam0, int iParam1)//Position - 0x1C14
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
int func_39(int iParam0, int iParam1)//Position - 0x1C7F
{
	int iVar0;
...
int func_40()//Position - 0x1CC7
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_41(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x1CD7
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_42(int iParam0, int* iParam1)//Position - 0x1D52
{
	if (HUD::DOES_BLIP_EXIST(iParam0))
	{
...
int func_43(struct<3> Param0, bool bParam1)//Position - 0x1D8D
{
	int iVar0;
...
void func_44(int iParam0, char* sParam1, int iParam2)//Position - 0x1DB9
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iParam0, sParam1, func_45(iParam2), 1);
}

int func_45(int iParam0)//Position - 0x1DD0
{
	int iVar0;
...
void func_46(int* iParam0, char* sParam1, bool bParam2)//Position - 0x1FC4
{
	if (!bParam2)
	{
...
int func_47(int* iParam0)//Position - 0x1FFB
{
...
int func_48(int* iParam0, int iParam1)//Position - 0x201F
{
...
int func_50(var uParam0)//Position - 0x208E
{
	int iVar0;
	int iVar1;
...
int func_51(var uParam0, int iParam1)//Position - 0x20B1
{
	int iVar0;
...
int func_52(int iParam0, var uParam1, int iParam2)//Position - 0x20E2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_53(char* sParam0)//Position - 0x2176
{
...
int func_54(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17)//Position - 0x218E
{
	int iVar0;
	int iVar1;
	int iVar2;
						...
						if (func_52(uParam0->f_21, uParam0, iVar3))
						{
							...
							while (iVar0 < 3)
							{
								if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
								{
									...
									if (TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], joaat("SCRIPT_TASK_ENTER_VEHICLE")) == 7 && !func_70(uParam0->f_17[iVar0], uParam0->f_21))
									{
				...
				if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
					...
					if (PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_40()))
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(iVar21))
						{
							...
							{
								if (func_64(iVar0, uParam0) || !BitTest(uParam0->f_13, 27))
								{
									PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uParam0->f_17[iVar0], iVar0);
...
void func_55(int iParam0, var uParam1)//Position - 0x31D1
{
	switch (iParam0)
	{
		case 0:
...
void func_56(var uParam0, char* sParam1, char* sParam2, bool bParam3)//Position - 0x3219
{
	if (!bParam3)
	{
		if (!MISC::IS_STRING_NULL(sParam1))
...
void func_57(char* sParam0, char* sParam1, int iParam2, int iParam3)//Position - 0x3252
{
	iParam3 = iParam3;
...
int func_58(int iParam0, var uParam1)//Position - 0x3271
{
	switch (iParam0)
	{
		case 0:
...
int func_59(int iParam0, float fParam1)//Position - 0x32B1
{
	int iVar0;
...
int func_60(int iParam0, int iParam1)//Position - 0x32E8
{
	int iVar0;
...
int func_61(int iParam0, int iParam1)//Position - 0x334F
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
void func_62(int iParam0, var uParam1)//Position - 0x3384
{
	switch (iParam0)
	{
		case 0:
...
void func_63(int iParam0, var uParam1)//Position - 0x33CC
{
	switch (iParam0)
	{
		case 0:
...
int func_64(int iParam0, var uParam1)//Position - 0x3414
{
	switch (iParam0)
	{
		case 0:
...
int func_65(int iParam0)//Position - 0x3454
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0, var uParam1)//Position - 0x34E1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_67(var uParam0)//Position - 0x3641
{
	int iVar0;
...
int func_68(var uParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x3670
{
	int iVar0;
...
int func_69(int iParam0)//Position - 0x374E
{
	float fVar0;
...
int func_70(int iParam0, int iParam1)//Position - 0x3786
{
	int iVar0;
...
void func_72(var uParam0)//Position - 0x3823
{
	int iVar0;
...
void func_73(var uParam0)//Position - 0x38C3
{
	int iVar0;
...
Vector3 func_75()//Position - 0x3963
{
	return 0f, 0f, 2f;
}

int func_76(var uParam0)//Position - 0x396E
{
	float fVar0;
...
int func_77(struct<3> Param0, float fParam1, bool bParam2)//Position - 0x3AAC
{
	int iVar0;
	
	iVar0 = HUD::ADD_BLIP_FOR_RADIUS(Param0, fParam1);
...
void func_78(char* sParam0, int iParam1)//Position - 0x3AE6
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

float func_79(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x3AFD
{
	struct<3> Var0;
...
void func_80(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x3B37
{
	struct<3> Var0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103950.f_4))
	{
		...
		{
			if (func_134(24) != Global_103950.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_131(ENTITY::GET_ENTITY_COORDS(Global_103950.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_81(Global_103950.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}

void func_81(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x3BB2
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_117(iParam3, &Var0, Param1, fParam2, func_123(iParam0));
		func_82(iParam3, iParam0, 0);
	}
}

void func_82(int iParam0, int iParam1, int iParam2)//Position - 0x3CDB
{
	int iVar0;
	...
	if (!func_114(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_113386.f_32749.f_4801 = func_103();
			}
...
void func_83(int iParam0, int iParam1)//Position - 0x3DF2
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_125(iParam0, &(Global_113386.f_32749.f_5510));
}

int func_84(int iParam0)//Position - 0x3FF4
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_101(iParam0, 0, 0)) || func_101(iParam0, 1, 0)) || func_101(iParam0, 2, 0)) || func_123(iParam0) != 145) || func_100(iParam0)) || func_99(iParam0)) || func_98(iParam0)) || func_97(iParam0)) || !func_85(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_99(iParam0))
		{
		}
...
int func_85(int iParam0)//Position - 0x40D2
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_86(int iParam0, bool bParam1)//Position - 0x4283
{
	int iVar0;
	struct<2> Var1;
...
int func_87(int iParam0)//Position - 0x4403
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_89(int iParam0)//Position - 0x44E6
{
	int iVar0;
	int iVar1;
...
bool func_90()//Position - 0x77B7
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_91()//Position - 0x77CD
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_92()//Position - 0x77E3
{
	return 0;
}

int func_93()//Position - 0x77EC
{
	return 1;
}

int func_94()//Position - 0x77F5
{
	return 1;
}

int func_95()//Position - 0x77FE
{
...
int func_97(int iParam0)//Position - 0x78CF
{
	int iVar0;
	char* sVar1;
...
int func_98(int iParam0)//Position - 0x7915
{
	int iVar0;
...
int func_99(int iParam0)//Position - 0x7950
{
	int iVar0;
...
int func_100(int iParam0)//Position - 0x79CC
{
	int iVar0;
...
int func_101(int iParam0, int iParam1, bool bParam2)//Position - 0x7AB4
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_102(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x7B22
{
...
void func_104(var uParam0, int iParam1)//Position - 0x7C40
{
	if (iParam1 <= 0)
	{
		return;
...
void func_105(var uParam0, int iParam1)//Position - 0x7CC6
{
...
void func_106(var uParam0, int iParam1)//Position - 0x7CF9
{
	int iVar0;
	int iVar1;
...
int func_107(int iParam0, int iParam1)//Position - 0x7D4A
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_108(int iParam0)//Position - 0x7DEC
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_109(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_109(bool bParam0, int iParam1, int iParam2)//Position - 0x7E0E
{
	if (bParam0)
	{
		return iParam1;
...
int func_110(var uParam0)//Position - 0x7E25
{
	return uParam0 & 15;
}

void func_111(var uParam0, int iParam1)//Position - 0x7E32
{
...
void func_112(var uParam0, int iParam1)//Position - 0x7E6C
{
...
void func_113(var uParam0, int iParam1)//Position - 0x7EA7
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_114(var uParam0, int iParam1)//Position - 0x7EE3
{
	int iVar0;
	int iVar1;
...
int func_115(int iParam0, int iParam1)//Position - 0x969C
{
	struct<82> Var0;
...
void func_116(int iParam0, var uParam1, int iParam2)//Position - 0x96DE
{
	int iVar0;
...
void func_117(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x993A
{
	if (func_114(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_122(iParam0);
			func_121(uParam1, &(Global_113386.f_32749.f_69[Global_77137.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_118(int iParam0, bool bParam1)//Position - 0x9A33
{
	if (iParam0 == -1)
	{
		return;
...
void func_119(int iParam0, int iParam1, bool bParam2)//Position - 0x9A90
{
	if (iParam0 == -1)
	{
		return;
...
int func_120(int iParam0, int iParam1)//Position - 0x9ACB
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_121(var uParam0, var uParam1)//Position - 0x9AEB
{
...
void func_122(int iParam0)//Position - 0x9BB7
{
	if (iParam0 == -1)
	{
		return;
...
int func_123(int iParam0)//Position - 0x9C2E
{
	int iVar0;
...
bool func_124(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x9C91
{
	if (bParam2)
	{
...
void func_125(int iParam0, var uParam1)//Position - 0x9CD8
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_127(&iParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
...
int func_126(int iParam0)//Position - 0x9F83
{
	switch (iParam0)
	{
		case 1:
...
int func_127(int iParam0, var uParam1, var uParam2)//Position - 0xA033
{
	int iVar0;
	int iVar1;
...
int func_128(int iParam0)//Position - 0xA226
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_129(var uParam0)//Position - 0xA246
{
	int iVar0;
...
void func_130(int iParam0)//Position - 0xA2F6
{
...
int func_131(struct<3> Param0, int iParam1, var uParam2, var uParam3)//Position - 0xA31D
{
	int iVar0;
	
	iVar0 = func_132(Param0, iParam1, 1);
	switch (iVar0)
	{
		case 0:
...
int func_132(struct<3> Param0, int iParam1, int iParam2)//Position - 0xA433
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_133(int iParam0)//Position - 0xA4C2
{
	return BitTest(Global_113386.f_7229[iParam0], 0);
}

int func_134(int iParam0)//Position - 0xA4D7
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_135(int* iParam0, bool bParam1, bool bParam2)//Position - 0xA4F3
{
	int iVar0;
...
void func_136(int iParam0, var uParam1)//Position - 0xA69E
{
	switch (iParam0)
	{
		case 0:
...
void func_137(var uParam0)//Position - 0xA6E6
{
	if (HUD::DOES_BLIP_EXIST(uParam0->f_5))
	{
		HUD::REMOVE_BLIP(&(uParam0->f_5));
...
float func_138(float fParam0, float fParam1, float fParam2)//Position - 0xA701
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
bool func_139(char* sParam0)//Position - 0xA728
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

float func_140(int iParam0, int iParam1, bool bParam2)//Position - 0xA73B
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_141(int iParam0, bool bParam1, bool bParam2)//Position - 0xA799
{
	return func_33(iParam0, !bParam1, bParam2);
}

void func_142(char* sParam0, int iParam1, int iParam2)//Position - 0xA7AC
{
	iParam2 = iParam2;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
void func_145()//Position - 0xA7F8
{
	...
	func_149(2, 1);
	func_148(&uLocal_72, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	Local_238[0 /*8*/] = { -1039.556f, -1071.2635f, 150f };
	Local_238[0 /*8*/].f_3 = 200f;
	Local_238[1 /*8*/] = { -1014.9763f, 450.128f, 150f };
	...
	while (iVar0 <= 9)
	{
		if (!func_147(Local_238[iVar0 /*8*/]))
		{
			fVar1 = 0f;
			MISC::GET_GROUND_Z_FOR_3D_COORD(Local_238[iVar0 /*8*/], &fVar1, false, false);
...
int func_146()//Position - 0xAA10
{
	return Global_112096.f_20;
}

int func_147(struct<3> Param0)//Position - 0xAA1E
{
...
void func_148(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xAA48
{
...
void func_149(int iParam0, int iParam1)//Position - 0xAAE3
{
...
void func_151(int iParam0)//Position - 0xAB93
{
