...
void func_1()//Position - 0xC8
{
		...
		else if (iLocal_47 == 2)
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_241, false))
			{
				if (!HUD::DOES_BLIP_EXIST(iLocal_50))
				{
					...
					iLocal_50 = func_141(iLocal_241, 0, 0);
				}
				if (func_140(PLAYER::PLAYER_PED_ID(), iLocal_241, 1) > 300f)
				{
					func_143();
				}
			}
	...
	if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_332))
	{
		...
		fLocal_330 = func_138(fLocal_330, 0f, 1f);
	...
	switch (iLocal_47)
	{
		case 0:
			...
			{
				iLocal_241 = Global_112358.f_222[0];
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_241))
				{
		...
		case 3:
			if (func_30(&iLocal_51, Local_36, -1067.083f, -2922.6008f, 12.824183f, -1091.8535f, -2965.4033f, 23.94564f, 31.5625f, 1, iLocal_241, "LAND", "", "BK_PLANE", 1, 0, 1, -1) && !ENTITY::IS_ENTITY_IN_AIR(iLocal_241))
			{
				func_135(&iLocal_51, 1, 0);
				iLocal_47++;
			}
...
int func_30(int* iParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, float fParam10, bool bParam11, int iParam12, char* sParam13, char* sParam14, char* sParam15, bool bParam16, int iParam17, bool bParam18, int iParam19)//Position - 0x107B
{
...
int func_41(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x1CD7
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_43(struct<3> Param0, bool bParam3)//Position - 0x1D8D
{
	int iVar0;
...
int func_77(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x3AAC
{
	int iVar0;
...
float func_79(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x3AFD
{
	struct<3> Var0;
...
void func_80(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x3B37
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104212.f_4))
	{
		...
		{
			if (func_134(24) != Global_104212.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_131(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_81(Global_104212.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_81(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x3BB2
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_117(iParam5, &Var0, Param1, fParam4, func_123(iParam0));
...
void func_82(int iParam0, int iParam1, int iParam2)//Position - 0x3CDB
{
	...
	if (!func_114(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_113648.f_32751.f_4801 = func_103();
			}
...
void func_83(int iParam0, int iParam1)//Position - 0x3DF2
{
	...
	func_125(iParam0, &(Global_113648.f_32751.f_5510));
}
...
int func_86(int iParam0, bool bParam1, int iParam2)//Position - 0x4284
{
	int iVar0;
	struct<2> Var1;
...
int func_87(int iParam0)//Position - 0x4406
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_89(int iParam0, int iParam1)//Position - 0x44E9
{
	int iVar0;
	int iVar1;
...
bool func_90()//Position - 0x7B19
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_91()//Position - 0x7B2F
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_92()//Position - 0x7B45
{
	return 0;
}

int func_93()//Position - 0x7B4E
{
	return 1;
}

int func_94()//Position - 0x7B57
{
	return 1;
}

int func_95()//Position - 0x7B60
{
...
int func_97(int iParam0)//Position - 0x7C31
{
	int iVar0;
	char* sVar1;
...
int func_98(int iParam0)//Position - 0x7C78
{
	int iVar0;
...
int func_99(int iParam0)//Position - 0x7CB3
{
	int iVar0;
...
int func_100(int iParam0)//Position - 0x7D2F
{
	int iVar0;
...
int func_101(int iParam0, int iParam1, bool bParam2)//Position - 0x7E17
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_102(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x7E85
{
...
void func_104(var uParam0, int iParam1)//Position - 0x7FA3
{
	if (iParam1 <= 0)
	{
		return;
...
void func_105(var uParam0, int iParam1)//Position - 0x802A
{
...
void func_106(var uParam0, int iParam1)//Position - 0x805D
{
	int iVar0;
	int iVar1;
...
int func_107(int iParam0, int iParam1)//Position - 0x80AE
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_108(int iParam0)//Position - 0x8150
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_109(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_109(bool bParam0, int iParam1, int iParam2)//Position - 0x8172
{
	if (bParam0)
	{
		return iParam1;
...
int func_110(var uParam0)//Position - 0x8189
{
	return uParam0 & 15;
}

void func_111(var uParam0, int iParam1)//Position - 0x8196
{
...
void func_112(var uParam0, int iParam1)//Position - 0x81D0
{
...
void func_113(var uParam0, int iParam1)//Position - 0x820B
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_114(var uParam0, int iParam1)//Position - 0x8247
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_124(Global_113648.f_32751.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_124(Global_113648.f_2365.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_124(Global_113648.f_2365.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_115(int iParam0, int iParam1)//Position - 0x9935
{
	struct<82> Var0;
...
void func_116(int iParam0, var uParam1, int iParam2)//Position - 0x9977
{
	int iVar0;
...
void func_117(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x9BD3
{
	if (func_114(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_122(iParam0);
			func_121(uParam1, &(Global_113648.f_32751.f_69[Global_77348.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_118(int iParam0, bool bParam1)//Position - 0x9CCC
{
	if (iParam0 == -1)
	{
		return;
...
void func_119(int iParam0, int iParam1, bool bParam2)//Position - 0x9D29
{
	if (iParam0 == -1)
	{
		return;
...
int func_120(int iParam0, int iParam1)//Position - 0x9D64
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_121(var uParam0, var uParam1)//Position - 0x9D84
{
...
void func_122(int iParam0)//Position - 0x9E50
{
	if (iParam0 == -1)
	{
		return;
...
int func_123(int iParam0)//Position - 0x9EC7
{
	int iVar0;
...
bool func_124(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x9F2A
{
	if (bParam6)
	{
...
void func_125(int iParam0, var uParam1)//Position - 0x9F71
{
	int iVar0;
...
int func_126(int iParam0)//Position - 0xA21C
{
	switch (iParam0)
	{
		case 1:
...
int func_127(int iParam0, var uParam1, var uParam2)//Position - 0xA2CC
{
	int iVar0;
	int iVar1;
...
int func_128(int iParam0)//Position - 0xA4BF
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_129(var uParam0)//Position - 0xA4DF
{
	int iVar0;
...
void func_130(int iParam0)//Position - 0xA58F
{
...
int func_131(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0xA5B6
{
	int iVar0;
	
	iVar0 = func_132(Param0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_132(struct<3> Param0, int iParam3, int iParam4)//Position - 0xA6CC
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_133(int iParam0)//Position - 0xA75B
{
	return BitTest(Global_113648.f_7231[iParam0], 0);
}

int func_134(int iParam0)//Position - 0xA770
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_135(int* iParam0, bool bParam1, bool bParam2)//Position - 0xA78C
{
	int iVar0;
...
void func_136(int iParam0, var uParam1)//Position - 0xA937
{
	switch (iParam0)
	{
		case 0:
...
void func_137(var uParam0)//Position - 0xA97F
{
	if (HUD::DOES_BLIP_EXIST(uParam0->f_5))
	{
		HUD::REMOVE_BLIP(&(uParam0->f_5));
...
float func_138(float fParam0, float fParam1, float fParam2)//Position - 0xA99A
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
bool func_139(char* sParam0)//Position - 0xA9C1
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

float func_140(int iParam0, int iParam1, bool bParam2)//Position - 0xA9D4
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_141(int iParam0, bool bParam1, bool bParam2)//Position - 0xAA32
{
	return func_33(iParam0, !bParam1, bParam2);
}

void func_142(char* sParam0, int iParam1, int iParam2)//Position - 0xAA45
{
	iParam2 = iParam2;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
void func_143()//Position - 0xAA5E
{
	func_151(2);
	func_150();
}

int func_144()//Position - 0xAA6F
{
...
void func_145()//Position - 0xAA91
{
	...
	func_149(2, 1);
	func_148(&uLocal_76, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	Local_242[0 /*8*/] = { -1039.556f, -1071.2635f, 150f };
	Local_242[0 /*8*/].f_3 = 200f;
	Local_242[1 /*8*/] = { -1014.9763f, 450.128f, 150f };
...
int func_146()//Position - 0xACA9
{
	return Global_112358.f_20;
}

int func_147(struct<3> Param0)//Position - 0xACB7
{
...
void func_148(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xACE1
{
...
void func_149(int iParam0, int iParam1)//Position - 0xAD7C
{
...
void func_151(int iParam0)//Position - 0xAE2C
{
