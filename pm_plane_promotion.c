...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_29 = 140f;
	fLocal_30 = 180f;
	Local_34 = { -1078.86f, -2943.56f, 12.95f };
	StringCopy(&cLocal_37, "PMPLANE", 16);
	StringCopy(&cLocal_41, "", 16);
	iLocal_47 = -1;
...
void func_1()//Position - 0xC8
{
	...
	Var0 = { -1085.2794f, -2970.5725f, 12.9457f };
	iLocal_327 = 0;
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_239))
	{
		if (!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_239, false))
		{
			func_145();
		}
		else if (iLocal_45 == 2)
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_239, false))
			{
				if (!HUD::DOES_BLIP_EXIST(iLocal_48))
				{
					func_144("BK_PLANE", 7500, 1);
					iLocal_48 = func_143(iLocal_239, 0, 0);
				}
				if (func_142(PLAYER::PLAYER_PED_ID(), iLocal_239, 1) > 300f)
				{
					func_145();
				}
			}
			else if (HUD::DOES_BLIP_EXIST(iLocal_48))
			{
				HUD::CLEAR_PRINTS();
	...
	if ((((ENTITY::DOES_ENTITY_EXIST(iLocal_239) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_239, false)) && ENTITY::IS_ENTITY_IN_AIR(iLocal_239)) && iLocal_323) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("PLANES", false, -1))
	{
		if (!bLocal_324)
		{
			if (PAD::IS_CONTROL_JUST_PRESSED(0 /*PLAYER_CONTROL*/, 114 /*INPUT_VEH_FLY_ATTACK*/))
			{
				if (iLocal_322 == -1 || (MISC::GET_GAME_TIMER() - iLocal_322) > 2000)
				{
					if (!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_330))
					{
						iLocal_330 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_property_leaflet_drop", iLocal_239, 0f, -2f, -0.65f, 0f, 0f, 0f, 1f, false, false, false);
						fLocal_328 = 0f;
					}
					if (func_141("LEAFLET"))
					{
					...
					AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "PROPERTIES_PLANE_PROMO_MASTER", iLocal_239, 0, false, 0);
	...
	if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_330))
	{
		...
		fLocal_328 = (fLocal_328 + ((fVar7 * SYSTEM::TIMESTEP()) * 100f));
		fLocal_328 = func_140(fLocal_328, 0f, 1f);
	...
	switch (iLocal_45)
	{
		case 0:
			...
			{
				iLocal_239 = Global_113079.f_222[0];
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_239))
				{
					iLocal_239 = VEHICLE::CREATE_VEHICLE(joaat("stunt"), Var0, 121.2244f, true, true, false);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_239, 5f);
				}
				else
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_239, true, true);
				}
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("stunt"));
				HUD::CLEAR_PRINTS();
				func_144("GET_PLANE", 7500, 1);
				iLocal_48 = func_143(iLocal_239, 0, 0);
				STREAMING::REQUEST_PTFX_ASSET();
				func_137(&iLocal_49, 1, 0);
				iLocal_45++;
			}
			break;
		
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_239) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_239, false))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_239, false))
				{
					HUD::CLEAR_PRINTS();
					func_144("TAKEOFF", 7500, 1);
					if (HUD::DOES_BLIP_EXIST(iLocal_48))
					{
						HUD::REMOVE_BLIP(&iLocal_48);
					}
		...
		case 2:
			iVar8 = 0;
			while (iVar8 < Local_240.f_0)
			{
				if (func_77(&(Local_240[iVar8 /*8*/])))
				{
					iLocal_321++;
				}
				iVar8++;
		...
		case 3:
			if (func_31(&iLocal_49, Local_34, -1067.083f, -2922.6008f, 12.824183f, -1091.8535f, -2965.4033f, 23.94564f, 31.5625f, 1, iLocal_239, "LAND", "", "BK_PLANE", 1, 0, 1, -1) && !ENTITY::IS_ENTITY_IN_AIR(iLocal_239))
			{
				func_137(&iLocal_49, 1, 0);
				iLocal_45++;
			}
		...
		case 4:
			if (func_28(iLocal_239, 1093140480, 1, 0f, 0, 1, 0))
			{
				iLocal_45++;
			}
			break;
		...
		case 5:
			...
			VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_239, false);
			func_27();
			break;
	}
	switch (iLocal_46)
	{
		case 0:
			...
			else if ((func_26() && (MISC::GET_GAME_TIMER() - iLocal_47) > 5000) && iLocal_327)
			{
				StringCopy(&cVar3, "RAND_", 16);
				StringConCat(&cVar3, &cLocal_41, 16);
				...
				{
					StringIntConCat(&cVar3, iLocal_329 + 1, 16);
				}
				if (func_2(&uLocal_74, &cLocal_37, &cVar3, 8, 0, 0, 0))
				{
					iLocal_329++;
					if (iLocal_329 >= 6)
					{
		...
		case 1:
			...
			{
				if (func_2(&uLocal_74, &cLocal_37, "DONE", 8, 0, 0, 0))
				{
					StringCopy(&cVar3, "", 16);
					iLocal_46++;
				}
...
bool func_6(int iParam0)//Position - 0x91E
{
	return func_7(iParam0, 20);
}

var func_7(int iParam0, int iParam1)//Position - 0x92E
{
	return BitTest(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_8()//Position - 0x946
{
	return -1;
}
...
bool func_16(int iParam0)//Position - 0xC8D
{
	return iParam0 < 3;
}

int func_17(int iParam0)//Position - 0xC99
{
	int iVar0;
	int iVar1;
...
int func_18(int iParam0)//Position - 0xCD6
{
	if (func_16(iParam0))
	{
...
var func_19(int iParam0)//Position - 0xCFB
{
...
void func_24(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0xDFE
{
...
int func_25(int iParam0)//Position - 0xE54
{
...
int func_28(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xEB7
{
...
void func_29(int iParam0)//Position - 0xF0E
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_31(int* iParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, float fParam10, bool bParam11, int iParam12, char* sParam13, char* sParam14, char* sParam15, bool bParam16, int iParam17, bool bParam18, int iParam19)//Position - 0x108B
{
	return func_32(iParam0, Param1, func_76(), Param4, Param7, bParam11, 5, 0, 0, 0, iParam12, sParam13, func_75(), func_75(), func_75(), func_75(), sParam14, 0, bParam16, sParam15, 1, iParam17, bParam18, iParam19, func_75(), func_75(), func_75(), 1, fParam10);
}

int func_32(int* iParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, struct<3> Param10, bool bParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, bool bParam25, bool bParam26, char* sParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, var uParam32, var uParam33, var uParam34, bool bParam35, float fParam36)//Position - 0x10E0
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	func_73(iParam0);
	func_72();
	if (func_55(iParam0, iParam0->f_17[0], iParam0->f_17[1], iParam0->f_17[2], sParam20, sParam21, sParam22, sParam23, iParam0->f_8, bParam25, iParam18, 0, 0, uParam32, uParam33, uParam34, iParam14, bParam26))
	{
		func_54(sParam20);
		func_54(sParam21);
		func_54(sParam22);
		...
		if (CAM::IS_SCREEN_FADED_IN())
		{
			...
			if (bVar1)
			{
				func_54(sParam24);
				func_54(sParam27);
				func_54("MORE_SEATS" /* GXT: A vehicle with more seats is needed. */);
				if (bParam26 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					if ((!func_49(iParam0, 1) && !func_48(iParam0)) && !BitTest(iParam0->f_13, 0))
					{
						if (bParam30)
						{
							func_47(iParam0, "LOSE_WANTED" /* GXT: Lose the Cops. */, 0);
							if (!PED::IS_PED_INJURED(iParam0->f_17[0]))
							{
								func_45(iParam0->f_17[0], "VEHICLE_POLICE_PURSUIT", 3);
							}
						}
				...
				else
				{
					...
					{
						func_54("LOSE_WANTED" /* GXT: Lose the Cops. */);
					...
					if (BitTest(iParam0->f_13, 1))
					{
						if (!func_49(iParam0, 1))
						{
							if (!PED::IS_PED_INJURED(iParam0->f_17[0]))
							{
								func_45(iParam0->f_17[0], "LOSE_WANTED_LEVEL", 3);
							}
							MISC::CLEAR_BIT(&(iParam0->f_13), 1);
						}
					}
					if (!HUD::DOES_BLIP_EXIST(iParam0->f_5))
					{
						...
						if (bParam35)
						{
							func_43(iParam0->f_5, iParam0);
						}
					}
					else if (!func_42(Var3, HUD::GET_BLIP_COORDS(iParam0->f_5), 0.1f, 0))
					{
					...
					if (bVar1)
					{
						...
						while (iVar2 < 3)
						{
							if (!PED::IS_PED_INJURED(iParam0->f_17[iVar2]))
							{
								...
								else if (!PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar2], func_41()) || !func_39(iParam0->f_17[iVar2], 1))
								{
									bVar1 = false;
								}
							}
						...
						if (!func_49(iParam0, 2))
						{
							...
							else if (BitTest(iParam0->f_13, 9))
							{
								...
								if (!BitTest(iParam0->f_13, 23))
								{
									if (!PED::IS_PED_INJURED(iParam0->f_17[0]))
									{
										func_45(iParam0->f_17[0], "GET_IN_CAR", 3);
									}
						...
						if (!func_49(iParam0, 2))
						{
							if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
							{
								if (!BitTest(iParam0->f_13, 13))
								{
									...
									{
										func_45(iParam0->f_17[iVar9], "NEED_A_BIGGER_VEHICLE", 3);
									}
									func_47(iParam0, "MORE_SEATS" /* GXT: A vehicle with more seats is needed. */, 0);
...
int func_33(int iParam0, bool bParam1, bool bParam2)//Position - 0x19E5
{
	return func_34(iParam0, !bParam1, bParam2);
}

int func_34(int iParam0, bool bParam1, bool bParam2)//Position - 0x19F8
{
	int iVar0;
	...
	{
		HUD::SET_BLIP_SCALE(iVar0, func_35(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		HUD::SET_BLIP_SCALE(iVar0, func_35(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
float func_35(bool bParam0, float fParam1, float fParam2)//Position - 0x1A9C
{
	if (bParam0)
	{
		return fParam1;
...
int func_36(int* iParam0)//Position - 0x1AB3
{
	if (BitTest(iParam0->f_13, 12))
	{
		if (func_38(PLAYER::PLAYER_PED_ID()))
		{
			if (func_37(1, 0, 1) || BitTest(iParam0->f_13, 7))
			{
				return 1;
			}
		}
	}
	else if (func_37(1, 0, 1) || BitTest(iParam0->f_13, 7))
	{
		return 1;
	}
	return 0;
...
int func_37(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1B08
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x1BED
{
	float fVar0;
...
int func_39(int iParam0, int iParam1)//Position - 0x1C24
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		else if (PED::IS_PED_GROUP_MEMBER(iParam0, func_41()))
		{
			PED::SET_GROUP_SEPARATION_RANGE(func_41(), 50f);
			return 1;
		}
...
int func_40(int iParam0, int iParam1)//Position - 0x1C8F
{
	int iVar0;
...
int func_42(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x1CE7
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_43(int iParam0, int* iParam1)//Position - 0x1D62
{
	if (HUD::DOES_BLIP_EXIST(iParam0))
	{
...
int func_44(struct<3> Param0, bool bParam3)//Position - 0x1D9D
{
	int iVar0;
...
void func_45(int iParam0, char* sParam1, int iParam2)//Position - 0x1DC9
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iParam0, sParam1, func_46(iParam2), 1);
}

int func_46(int iParam0)//Position - 0x1DE0
{
	int iVar0;
...
void func_47(int* iParam0, char* sParam1, bool bParam2)//Position - 0x1FD4
{
	if (!bParam2)
	{
...
int func_48(int* iParam0)//Position - 0x200B
{
...
int func_49(int* iParam0, int iParam1)//Position - 0x202F
{
...
int func_51(var uParam0)//Position - 0x209E
{
	int iVar0;
	int iVar1;
...
int func_52(var uParam0, int iParam1)//Position - 0x20C1
{
	int iVar0;
	...
	{
		iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
		if (func_53(iVar0, uParam0, iParam1))
		{
			return 1;
		}
	}
...
int func_53(int iParam0, var uParam1, int iParam2)//Position - 0x20F2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_55(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17)//Position - 0x219E
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_21, false))
		{
			if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_21, true)) < 400f)
			{
				if (!PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
				{
					...
					{
						if (func_53(uParam0->f_21, uParam0, iVar3))
						{
							iVar0 = 0;
							while (iVar0 < 3)
							{
								if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
								{
									...
									if (PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_41()))
									{
										PED::REMOVE_PED_FROM_GROUP(uParam0->f_17[iVar0]);
									}
									if (TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], joaat("SCRIPT_TASK_ENTER_VEHICLE")) == 7 && !func_71(uParam0->f_17[iVar0], uParam0->f_21))
									{
		...
		if (bVar23)
		{
			...
			while (iVar0 < 3)
			{
				if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
					...
					if (!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_41()))
					{
						if (func_69(uParam0, uParam0->f_17[iVar0], fParam8, 1))
						{
							PED::SET_PED_AS_GROUP_MEMBER(uParam0->f_17[iVar0], func_41());
						}
					}
				}
				iVar0++;
	...
	if (!BitTest(uParam0->f_13, 26))
	{
		if ((!func_68(uParam0) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID())) && !ENTITY::DOES_ENTITY_EXIST(iParam10))
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar13, false))
			{
				if (!BitTest(uParam0->f_13, 13))
				{
					...
					if (!func_49(uParam0, 2))
					{
						...
						{
							func_45(uParam0->f_17[iVar27], "NEED_A_BIGGER_VEHICLE", 3);
						}
						func_47(uParam0, "MORE_SEATS" /* GXT: A vehicle with more seats is needed. */, 0);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iParam10))
		{
			if ((!PED::IS_PED_INJURED(uParam0->f_17[0]) || !PED::IS_PED_INJURED(uParam0->f_17[1])) || !PED::IS_PED_INJURED(uParam0->f_17[2]))
			{
				...
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()) && !func_49(uParam0, 2))
					{
						iVar13 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
						if (func_67(iVar13, uParam0))
						{
							func_47(uParam0, "CMN_VEHSUIT" /* GXT: ~s~Vehicle is not suitable. */, 0);
				...
				else if (!PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
				{
					...
					func_54("CMN_VEHSUIT" /* GXT: ~s~Vehicle is not suitable. */);
				}
			}
		}
				...
				if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
					...
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						...
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar13, false))
						{
							if (PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_41()))
							{
								if (!func_68(uParam0) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
								{
									if (!func_66(uParam0->f_17[iVar0]))
									{
										PED::REMOVE_PED_FROM_GROUP(uParam0->f_17[iVar0]);
									}
								}
					...
					if (PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_41()))
					{
						...
						{
							if (func_53(iVar32, uParam0, 0))
							{
								if (func_65(iVar0, uParam0) || !BitTest(uParam0->f_13, 27))
								{
									PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uParam0->f_17[iVar0], iVar0);
					...
					if ((!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_41()) && !func_62(uParam0->f_17[iVar0], iParam10)) && !func_61(uParam0->f_17[iVar0], iParam10))
					{
						if (func_69(uParam0, uParam0->f_17[iVar0], fParam8, bParam11))
						{
							if (!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_41()))
							{
						...
						if (bVar11)
						{
							if (!HUD::DOES_BLIP_EXIST(uParam0->f_1[iVar0]))
							{
								...
								uParam0->f_1[iVar0] = func_33(uParam0->f_17[iVar0], 0, 0);
								HUD::SET_BLIP_DISPLAY(uParam0->f_1[iVar0], 2);
								if (bParam9)
								{
									func_43(uParam0->f_1[iVar0], uParam0);
								}
							}
						}
						iVar6 = 0;
					...
					{
						if (((func_39(uParam0->f_17[iVar0], 1) || func_62(uParam0->f_17[iVar0], iParam10)) || iParam12) || (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam10, false) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam10, false)))
						{
							if (HUD::DOES_BLIP_EXIST(uParam0->f_1[iVar0]))
							{
								HUD::REMOVE_BLIP(&(uParam0->f_1[iVar0]));
								func_54(uVar15[iVar0]);
							}
						}
						else
						{
					...
					else if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam10, false))
					{
						if (!PED::IS_PED_SITTING_IN_VEHICLE(uParam0->f_17[iVar0], iParam10))
						{
							if ((ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], iParam10, 20f, 20f, 5f, false, true, 0) && !BitTest(uParam0->f_13, 11)) && !((bParam17 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam10, false)))
							{
								if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(uParam0->f_17[iVar0]))
								{
									...
									{
										if (!func_39(uParam0->f_17[iVar0], 1))
										{
											if (func_38(uParam0->f_17[iVar0]))
											{
								...
								else
								{
									...
									iVar14 = TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], joaat("SCRIPT_TASK_ENTER_VEHICLE"));
									if (iVar14 == 7 && !func_71(uParam0->f_17[iVar0], iParam10))
									{
										if (((((!PED::IS_PED_JUMPING_OUT_OF_VEHICLE(uParam0->f_17[iVar0]) && !PED::IS_PED_JUMPING_OUT_OF_VEHICLE(PLAYER::PLAYER_PED_ID())) && !func_60(uParam0->f_17[iVar0], 2f)) && !PED::IS_PED_RAGDOLL(uParam0->f_17[iVar0])) && !TASK::IS_PED_GETTING_UP(uParam0->f_17[iVar0])) && !FIRE::IS_ENTITY_ON_FIRE(iParam10))
										{
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_17[iVar0], true);
							...
							else if (!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_41()))
							{
								if (func_69(uParam0, uParam0->f_17[iVar0], fParam8, bParam11))
								{
									if (!PED::IS_PED_RAGDOLL(uParam0->f_17[iVar0]) && !TASK::IS_PED_GETTING_UP(uParam0->f_17[iVar0]))
						...
						else if (PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_41()) && !FIRE::IS_ENTITY_ON_FIRE(iParam10))
						{
							PED::REMOVE_PED_FROM_GROUP(uParam0->f_17[iVar0]);
						}
					}
			...
			if (iVar1 > 0)
			{
				...
				while (iVar0 < 3)
				{
					if (iVar7[iVar0])
					{
						if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
						{
							if (func_66(uParam0->f_17[iVar0]) || ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], PLAYER::PLAYER_PED_ID(), uParam0->f_8, uParam0->f_8, uParam0->f_8, false, true, 0))
							{
								iVar1 = (iVar1 - 1);
								iVar7[iVar0] = 0;
							}
					...
					{
						if (!ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], PLAYER::PLAYER_PED_ID(), (uParam0->f_8 * 0.85f), (uParam0->f_8 * 0.85f), uParam0->f_8, false, true, 0) && !func_66(uParam0->f_17[iVar0]))
						{
						}
					}
					iVar0++;
							...
							while (iVar0 < 3)
							{
								if (iVar7[iVar0])
								{
									if (!func_59(iVar0, uParam0))
									{
										...
										if (!func_59(iVar0, uParam0))
										{
											func_47(uParam0, uVar15[iVar0], 0);
											func_56(iVar0, uParam0);
											uParam0->f_12 = iVar1;
										}
									}
...
void func_56(int iParam0, var uParam1)//Position - 0x31E3
{
	switch (iParam0)
	{
		case 0:
...
void func_57(var uParam0, char* sParam1, char* sParam2, bool bParam3)//Position - 0x322B
{
	if (!bParam3)
	{
		if (!MISC::IS_STRING_NULL(sParam1))
...
void func_58(char* sParam0, char* sParam1, int iParam2, int iParam3)//Position - 0x3264
{
	iParam3 = iParam3;
...
int func_59(int iParam0, var uParam1)//Position - 0x3283
{
	switch (iParam0)
	{
		case 0:
...
int func_60(int iParam0, float fParam1)//Position - 0x32C3
{
	int iVar0;
...
int func_61(int iParam0, int iParam1)//Position - 0x32FA
{
	int iVar0;
	
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (!PED::IS_PED_GROUP_MEMBER(iParam0, func_41()))
		{
...
int func_62(int iParam0, int iParam1)//Position - 0x3361
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
void func_63(int iParam0, var uParam1)//Position - 0x3396
{
	switch (iParam0)
	{
		case 0:
...
void func_64(int iParam0, var uParam1)//Position - 0x33DE
{
	switch (iParam0)
	{
		case 0:
...
int func_65(int iParam0, var uParam1)//Position - 0x3426
{
	switch (iParam0)
	{
		case 0:
...
int func_66(int iParam0)//Position - 0x3466
{
	int iVar0;
	int iVar1;
...
int func_67(int iParam0, var uParam1)//Position - 0x34F3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_68(var uParam0)//Position - 0x3653
{
	int iVar0;
...
int func_69(var uParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x3682
{
	int iVar0;
...
int func_70(int iParam0)//Position - 0x3760
{
	float fVar0;
...
int func_71(int iParam0, int iParam1)//Position - 0x3798
{
	int iVar0;
...
void func_73(var uParam0)//Position - 0x3835
{
	int iVar0;
...
void func_74(var uParam0)//Position - 0x38D5
{
	int iVar0;
...
int func_77(var uParam0)//Position - 0x3980
{
	float fVar0;
	
	if (!uParam0->f_6)
	{
		fVar0 = func_80(PLAYER::PLAYER_PED_ID(), *uParam0, 0);
		if (!iLocal_325)
		{
			if (fVar0 < 400f)
			{
				HUD::CLEAR_PRINTS();
				func_144("FLY_DROP", 7500, 1);
...
int func_78(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x3ABE
{
	int iVar0;
...
void func_79(char* sParam0, int iParam1)//Position - 0x3AF8
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

float func_80(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x3B0F
{
	struct<3> Var0;
...
void func_81(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x3B49
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104933.f_4))
	{
		...
		{
			if (func_136(24) != Global_104933.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_133(ENTITY::GET_ENTITY_COORDS(Global_104933.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_82(Global_104933.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_82(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x3BC4
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_119(iParam5, &Var0, Param1, fParam4, func_125(iParam0));
		func_83(iParam5, iParam0, 0);
	}
}

void func_83(int iParam0, int iParam1, int iParam2)//Position - 0x3CED
{
	int iVar0;
	...
	if (!func_116(&(Global_78038.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_114370.f_32752.f_4801 = func_105();
			}
...
void func_84(int iParam0, int iParam1)//Position - 0x3E04
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_127(iParam0, &(Global_114370.f_32752.f_5510));
}

int func_85(int iParam0)//Position - 0x4007
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_103(iParam0, 0, 0)) || func_103(iParam0, 1, 0)) || func_103(iParam0, 2, 0)) || func_125(iParam0) != 145) || func_102(iParam0)) || func_101(iParam0)) || func_100(iParam0)) || func_99(iParam0)) || !func_86(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_101(iParam0))
		{
		}
...
int func_86(int iParam0)//Position - 0x40E4
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_87(int iParam0, bool bParam1, int iParam2)//Position - 0x42A2
{
	int iVar0;
	struct<2> Var1;
...
int func_88(int iParam0)//Position - 0x4424
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_90(int iParam0, int iParam1)//Position - 0x4507
{
	int iVar0;
	int iVar1;
...
int func_91(bool bParam0)//Position - 0x9A3F
{
	if (bParam0)
	{
...
bool func_92()//Position - 0x9A59
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_93()//Position - 0x9A6F
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_94()//Position - 0x9A85
{
	return 0;
}

int func_95()//Position - 0x9A8E
{
	return 1;
}

int func_96()//Position - 0x9A97
{
	return 1;
}

int func_97()//Position - 0x9AA0
{
...
int func_99(int iParam0)//Position - 0x9B71
{
	int iVar0;
	char* sVar1;
...
int func_100(int iParam0)//Position - 0x9BB8
{
	int iVar0;
...
int func_101(int iParam0)//Position - 0x9BF3
{
	int iVar0;
...
int func_102(int iParam0)//Position - 0x9C6F
{
	int iVar0;
...
int func_103(int iParam0, int iParam1, bool bParam2)//Position - 0x9D57
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_104(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x9DC5
{
...
void func_106(var uParam0, int iParam1)//Position - 0x9EE3
{
	if (iParam1 <= 0)
	{
		return;
...
void func_107(var uParam0, int iParam1)//Position - 0x9F69
{
...
void func_108(var uParam0, int iParam1)//Position - 0x9F9C
{
	int iVar0;
	int iVar1;
...
int func_109(int iParam0, int iParam1)//Position - 0x9FED
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_110(int iParam0)//Position - 0xA08F
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_111(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_111(bool bParam0, int iParam1, int iParam2)//Position - 0xA0B1
{
	if (bParam0)
	{
		return iParam1;
...
int func_112(var uParam0)//Position - 0xA0C8
{
	return uParam0 & 15;
}

void func_113(var uParam0, int iParam1)//Position - 0xA0D5
{
...
void func_114(var uParam0, int iParam1)//Position - 0xA10F
{
...
void func_115(var uParam0, int iParam1)//Position - 0xA14A
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_116(var uParam0, int iParam1)//Position - 0xA186
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_126(Global_114370.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_126(Global_114370.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_126(Global_114370.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_117(int iParam0, int iParam1)//Position - 0xB874
{
	struct<82> Var0;
...
void func_118(int iParam0, var uParam1, int iParam2)//Position - 0xB8B6
{
	int iVar0;
...
void func_119(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xBB12
{
	if (func_116(&(Global_78038.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_124(iParam0);
			func_123(uParam1, &(Global_114370.f_32752.f_69[Global_78038.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_120(int iParam0, bool bParam1)//Position - 0xBC0B
{
	if (iParam0 == -1)
	{
		return;
	...
	if (bParam1)
	{
		if (!func_122(iParam0, 0))
		{
			...
			func_121(iParam0, 2, 0);
			func_121(iParam0, 3, 0);
			func_121(iParam0, 4, 0);
...
void func_121(int iParam0, int iParam1, bool bParam2)//Position - 0xBC68
{
	if (iParam0 == -1)
	{
		return;
...
int func_122(int iParam0, int iParam1)//Position - 0xBCA3
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_123(var uParam0, var uParam1)//Position - 0xBCC3
{
...
void func_124(int iParam0)//Position - 0xBD8F
{
	if (iParam0 == -1)
	{
		return;
...
int func_125(int iParam0)//Position - 0xBE06
{
	int iVar0;
...
bool func_126(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xBE69
{
	if (bParam6)
	{
...
void func_127(int iParam0, var uParam1)//Position - 0xBEB0
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_129(&iParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
...
int func_128(int iParam0)//Position - 0xC163
{
	switch (iParam0)
	{
		case 1:
...
int func_129(int iParam0, var uParam1, var uParam2)//Position - 0xC213
{
	int iVar0;
	int iVar1;
...
int func_130(int iParam0)//Position - 0xC406
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_131(var uParam0)//Position - 0xC426
{
	int iVar0;
...
void func_132(int iParam0)//Position - 0xC4D6
{
...
int func_133(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0xC4FD
{
	int iVar0;
...
int func_134(struct<3> Param0, int iParam3, int iParam4)//Position - 0xC613
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_135(int iParam0)//Position - 0xC6A2
{
	return BitTest(Global_114370.f_7232[iParam0], 0);
}

int func_136(int iParam0)//Position - 0xC6B7
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_137(int* iParam0, bool bParam1, bool bParam2)//Position - 0xC6D3
{
	int iVar0;
	...
	while (iVar0 < 3)
	{
		...
		func_138(iVar0, iParam0);
		func_64(iVar0, iParam0);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 31)
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(iParam0->f_17[iVar0]))
		{
			...
			if (bParam1)
			{
				if (PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar0], func_41()) && iParam0->f_17[iVar0] != PLAYER::PLAYER_PED_ID())
				{
...
void func_138(int iParam0, var uParam1)//Position - 0xC87E
{
	switch (iParam0)
	{
		case 0:
...
void func_139(var uParam0)//Position - 0xC8C6
{
	if (HUD::DOES_BLIP_EXIST(uParam0->f_5))
	{
		HUD::REMOVE_BLIP(&(uParam0->f_5));
...
float func_140(float fParam0, float fParam1, float fParam2)//Position - 0xC8E1
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
bool func_141(char* sParam0)//Position - 0xC908
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

float func_142(int iParam0, int iParam1, bool bParam2)//Position - 0xC91B
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_143(int iParam0, bool bParam1, bool bParam2)//Position - 0xC979
{
	return func_34(iParam0, !bParam1, bParam2);
}

void func_144(char* sParam0, int iParam1, int iParam2)//Position - 0xC98C
{
	iParam2 = iParam2;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
void func_145()//Position - 0xC9A5
{
	func_153(2);
	func_152();
}

int func_146()//Position - 0xC9B6
{
...
void func_147()//Position - 0xC9D8
{
	...
	func_151(2, 1);
	func_150(&uLocal_74, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	Local_240[0 /*8*/] = { -1039.556f, -1071.2635f, 150f };
	Local_240[0 /*8*/].f_3 = 200f;
	Local_240[1 /*8*/] = { -1014.9763f, 450.128f, 150f };
	Local_240[1 /*8*/].f_3 = 200f;
	Local_240[2 /*8*/] = { -598.1714f, -310.67f, 150f };
	Local_240[2 /*8*/].f_3 = 200f;
	Local_240[3 /*8*/] = { -392.5704f, 514.8138f, 150f };
	Local_240[3 /*8*/].f_3 = 200f;
	Local_240[4 /*8*/] = { 127.7632f, -135.7758f, 150f };
	Local_240[4 /*8*/].f_3 = 200f;
	Local_240[5 /*8*/] = { 1033.4686f, -570.8278f, 150f };
	Local_240[5 /*8*/].f_3 = 200f;
	Local_240[6 /*8*/] = { 246.5894f, -890.811f, 150f };
	Local_240[6 /*8*/].f_3 = 200f;
	Local_240[7 /*8*/] = { 1231.3933f, -1694.3479f, 150f };
	Local_240[7 /*8*/].f_3 = 200f;
	Local_240[8 /*8*/] = { 424.9531f, -1904.325f, 150f };
	Local_240[8 /*8*/].f_3 = 200f;
	Local_240[9 /*8*/] = { -22.4342f, -1414.275f, 160f };
	Local_240[9 /*8*/].f_3 = 200f;
	iVar0 = 0;
	while (iVar0 <= 9)
	{
		if (!func_149(Local_240[iVar0 /*8*/]))
		{
			fVar1 = 0f;
			MISC::GET_GROUND_Z_FOR_3D_COORD(Local_240[iVar0 /*8*/], &fVar1, false, false);
			Local_240[iVar0 /*8*/].f_2 = fVar1;
		}
		iVar0++;
	}
	switch (func_148())
	{
		case 6:
			StringCopy(&cLocal_41, "DT", 16);
			break;
		
		case 5:
			StringCopy(&cLocal_41, "VW", 16);
			break;
		
		case 7:
			StringCopy(&cLocal_41, "MW", 16);
			break;
	}
...
int func_148()//Position - 0xCBF0
{
	return Global_113079.f_20;
}

int func_149(struct<3> Param0)//Position - 0xCBFE
{
...
void func_150(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCC28
{
...
void func_151(int iParam0, int iParam1)//Position - 0xCCC3
{
...
void func_152()//Position - 0xCCEA
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_239))
	{
		ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_239);
	}
	if (HUD::DOES_BLIP_EXIST(Local_240[0 /*8*/].f_4))
	{
		HUD::REMOVE_BLIP(&(Local_240[0 /*8*/].f_4));
	}
	if (HUD::DOES_BLIP_EXIST(Local_240[0 /*8*/].f_5))
	{
		HUD::REMOVE_BLIP(&(Local_240[0 /*8*/].f_5));
	}
	if (HUD::DOES_BLIP_EXIST(Local_240[1 /*8*/].f_4))
	{
		HUD::REMOVE_BLIP(&(Local_240[1 /*8*/].f_4));
	}
	if (HUD::DOES_BLIP_EXIST(Local_240[1 /*8*/].f_5))
	{
		HUD::REMOVE_BLIP(&(Local_240[1 /*8*/].f_5));
	}
...
void func_153(int iParam0)//Position - 0xCD73
{
