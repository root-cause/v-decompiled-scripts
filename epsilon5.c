...
void func_87(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD6EF
{
	var uVar0;
	int iVar1;
...
int func_91(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE68B
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_149(int iParam0, int iParam1, int iParam2)//Position - 0x1FA26
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_150(int iParam0)//Position - 0x1FC7F
{
	int iVar0;
	int iVar1;
...
int func_151(int iParam0)//Position - 0x1FCBC
{
	if (func_153(iParam0))
	{
...
var func_152(int iParam0)//Position - 0x1FCE1
{
	return Global_2201[iParam0 /*29*/];
}

bool func_153(int iParam0)//Position - 0x1FCF0
{
	return iParam0 < 3;
}

void func_154(char* sParam0, var uParam1)//Position - 0x1FCFC
{
...
int func_195(int iParam0)//Position - 0x26A5B
{
	int iVar0;
	int iVar1;
...
int func_198(int iParam0)//Position - 0x26C92
{
...
int func_200(char* sParam0)//Position - 0x26CF9
{
	int iVar0;
...
int func_202(char* sParam0, int iParam1)//Position - 0x26D6A
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_204(int iParam0, int iParam1, bool bParam2)//Position - 0x26E04
{
	...
	while (iVar1 < Global_54711[iVar0 /*203*/].f_3)
	{
		...
		if (iVar3 < 3)
		{
			func_205(Global_54711[iVar0 /*203*/].f_4[iVar1], Global_54711[iVar0 /*203*/].f_1, 1, bParam2, 0);
		}
		iVar1++;
	}
	return 1;
...
void func_205(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x27000
{
	...
	if (!bParam2)
	{
		...
		iVar2 = iVar20;
		Var3 = { func_211(Global_45411[iVar20 /*12*/].f_1) };
	...
	else
	{
		...
		{
			Var3 = { func_211(Global_45411[iVar26 /*12*/].f_1) };
		}
	}
	if (!bParam4)
	{
...
void func_206(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)//Position - 0x273D5
{
	int iVar0;
	bool bVar1;
	char cVar2[64];
...
char* func_208(int iParam0)//Position - 0x275EB
{
	switch (iParam0)
	{
		case 0:
...
char* func_209(int iParam0, int iParam1)//Position - 0x27956
{
	*iParam1 = 1;
	switch (iParam0)
	{
...
void func_215(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x28009
{
	int iVar0;
...
int func_220(int iParam0)//Position - 0x284A5
{
	if (func_249(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_221(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x284C5
{
	if (bParam0)
	{
...
int func_225(var uParam0)//Position - 0x286C8
{
	int iVar0;
...
int func_226(int iParam0)//Position - 0x286EA
{
...
int func_228(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x28737
{
	int iVar0;
...
void func_232(int* iParam0)//Position - 0x287DF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_234(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x28854
{
	int iVar0;
...
Vector3 func_236(int iParam0)//Position - 0x28A4E
{
...
void func_238(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x28AA0
{
	func_239(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_239(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x28ACA
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_240(struct<3> Param0)//Position - 0x28EC0
{
...
int func_241(int iParam0, int iParam1, bool bParam2)//Position - 0x28EEA
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_242(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x28F58
{
...
int func_243(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x29030
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_244(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x29326
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_245(struct<3> Param0)//Position - 0x293DA
{
	float fVar0;
	float fVar1;
...
void func_246(int iParam0)//Position - 0x29419
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_249(int iParam0)//Position - 0x294B5
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_250(int iParam0, float fParam1, int iParam2)//Position - 0x294D6
{
	int iVar0;
...
int func_256(int iParam0, int iParam1)//Position - 0x296A7
{
	if (func_220(iParam0))
	{
...
int func_257(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x296DA
{
...
void func_258(int iParam0)//Position - 0x29731
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
bool func_262(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x29B4E
{
...
int func_263(char* sParam0, int iParam1, bool bParam2)//Position - 0x29B9C
{
	Global_22426 = 0;
...
var func_267(int iParam0, int iParam1)//Position - 0x29F14
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_268()//Position - 0x29F2C
{
	return -1;
}
...
void func_272()//Position - 0x2A094
{
	if (func_92(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_275(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x2A1C5
{
...
void func_276(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2A21B
{
...
float func_278(int iParam0, int iParam1, bool bParam2)//Position - 0x2A2CF
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_285(int iParam0)//Position - 0x2A4D9
{
	if (iParam0 == 1)
	{
		if (Global_21066.f_1 > 3)
...
void func_287(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2A53F
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_79794 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_289(Global_79795, Global_79797, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_288(char* sParam0)//Position - 0x2A824
{
...
int func_298(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2AC05
{
	if (((!func_300(0) || Global_79810) || Global_79798 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_79794)
...
int func_300(int iParam0)//Position - 0x2AD46
{
	if (Global_44181 == 15)
	{
		return 0;
...
bool func_301(int iParam0)//Position - 0x2AD68
{
	return func_302(iParam0, Global_44181);
}

int func_302(int iParam0, int iParam1)//Position - 0x2AD79
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_303(int iParam0, int iParam1, bool bParam2)//Position - 0x2AF5A
{
	int iVar0;
		...
		if (bParam2)
		{
			if (!Global_79539)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9595[iParam1 /*4*/] = { func_305(iParam0) };
					...
					{
						Global_9546[1 /*6*/] = { func_305(iParam0) };
...
struct<4> func_305(int iParam0)//Position - 0x2B153
{
	return Global_2201[iParam0 /*29*/].f_3;
}

int func_306(int iParam0, int iParam1)//Position - 0x2B166
{
...
int func_307(int iParam0, int iParam1)//Position - 0x2B190
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_308(int iParam0, int iParam1, int iParam2)//Position - 0x2B1BA
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_309(int iParam0, int iParam1, int iParam2)//Position - 0x2B1FF
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
int func_310(var uParam0)//Position - 0x2B244
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
...
int func_311(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x2B3C7
{
...
int func_312(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2B423
{
	int iVar0;
...
int func_313(var uParam0, int iParam1)//Position - 0x2B4B1
{
	int iVar0;
...
int func_314(var uParam0)//Position - 0x2B4F7
{
	if (func_315(uParam0))
	{
...
int func_315(var uParam0)//Position - 0x2B521
{
...
int func_316(int iParam0)//Position - 0x2B546
{
	int iVar0;
...
void func_323(int* iParam0, bool bParam1)//Position - 0x2B691
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_324(int* iParam0)//Position - 0x2B6CC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_327(int* iParam0)//Position - 0x2B746
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_328(int* iParam0)//Position - 0x2B77E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_329(int iParam0)//Position - 0x2B81A
{
	if (func_249(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_332(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2B897
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
int func_336(char* sParam0, int iParam1, int iParam2)//Position - 0x2BA80
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_338()//Position - 0x2BC65
{
	...
	iVar0 = func_339(&(Global_101688.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_340(int iParam0, bool bParam1)//Position - 0x2BCB3
{
	int iVar0;
...
int func_356(int iParam0)//Position - 0x2C082
{
	if (!func_153(iParam0))
	{
		return func_152(iParam0);
