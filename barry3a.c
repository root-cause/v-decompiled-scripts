...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_456())
	{
		...
		{
			case 0:
				func_454(Local_43, Local_43.f_3, 1, 0);
				func_452(1);
				break;
			
			case 1:
				func_454(Local_53, 298.7f, 1, 0);
				func_451(1);
				break;
	...
	{
		func_429(&(Local_56[0 /*29*/]), &(Local_39.f_35[1]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_39.f_28[0]))
	{
		func_428(&(Local_56[0 /*29*/].f_1), &(Local_39.f_28[0]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_39.f_28[1]))
	{
		func_428(&(Local_56[0 /*29*/].f_2), &(Local_39.f_28[1]));
	}
	func_426();
	while (true)
	{
		RECORDING::REPLAY_CHECK_FOR_EVENT_THIS_FRAME("SF_GRTP", 0);
		func_410(Local_39.f_9, 0, 0, 1, 0, 0);
		func_405();
		if (iLocal_40 == 9)
		{
			func_398();
		...
		case 0:
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_43.f_4, false))
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 1)
				{
					iLocal_241 = 1;
					iLocal_242 = 0;
					iLocal_42 = func_216(Local_53, 5, 1);
				}
				else
				{
					iLocal_241 = 1;
			...
			else
			{
				...
				iLocal_42 = func_211(Local_43.f_4, 1, 5);
			}
			iLocal_41 = 1;
			break;
		
		case 1:
			if (!func_210(Local_43.f_4, Local_53, 125f, 1))
			{
...
bool func_210(int iParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x26F0D
{
...
void func_213(int iParam0)//Position - 0x26F90
{
	if (func_212(iParam0))
	{
		func_214(Local_55[iParam0 /*3*/].f_2, 7500, 1);
...
int func_216(struct<3> Param0, int iParam1, bool bParam2)//Position - 0x26FFE
{
	int iVar0;
	...
	switch (iLocal_41)
	{
		...
		case 1:
			if (ENTITY::IS_ENTITY_AT_COORD(Local_43.f_4, Local_53, 10f, 10f, 2f, false, true, 0))
			{
				...
				{
					func_220();
					if (!func_219(PLAYER::PLAYER_PED_ID(), Local_43.f_4, 55f, 1) && !ENTITY::IS_ENTITY_ON_SCREEN(Local_43.f_4))
					{
						iLocal_41 = 2;
					}
					else if ((iLocal_237 && func_212(5)) && (MISC::GET_PROFILE_SETTING(203) == 0 || !func_215()))
					{
						func_213(5);
					}
				}
...
void func_220()//Position - 0x271E9
{
	...
	else if (!iLocal_237)
	{
		if (MISC::GET_GAME_TIMER() > iLocal_239)
		{
			if (iLocal_233 == 1)
			{
				if (func_221(&uLocal_63, 49, "BAR3AAU", "BAR3A_P1", 9, 1, 0, 0, 0))
				{
					iLocal_41 = 1;
					iLocal_237 = 1;
				}
			}
			else if (func_221(&uLocal_63, 49, "BAR3AAU", "BAR3A_P1b", 9, 1, 0, 0, 0))
			{
				iLocal_41 = 1;
				iLocal_237 = 1;
			}
...
int func_238()//Position - 0x279D9
{
	...
	while (iLocal_62 <= 5)
	{
		if (func_239(Local_55[iLocal_62 /*3*/].f_2, 0, 0))
		{
			iVar0 = 1;
		}
		iLocal_62++;
...
void func_240()//Position - 0x27A2A
{
	switch (iLocal_41)
	{
		case 0:
			...
			if (func_243(Local_43.f_4, 1093140480, 1, 1056964608, 0, 1, 0))
			{
				func_242(0, -1);
				iLocal_246 = 0;
				iLocal_243 = 0;
		...
		case 2:
			func_241(&uLocal_63, 3, 0, "BARRY", 0, 1);
			iLocal_41 = 0;
			iLocal_40 = 7;
			break;
	}
...
void func_245()//Position - 0x27DC7
{
	switch (iLocal_41)
	{
		...
		case 1:
			func_251(&uLocal_254, &uLocal_63, "BAR3AAU", &sLocal_255, &cLocal_261);
...
void func_248()//Position - 0x27F28
{
	...
	{
		if (!func_215() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_43.f_4, false))
		{
			if (!iLocal_229)
			{
				iLocal_229 = 1;
			...
			if ((MISC::GET_GAME_TIMER() - iLocal_231) > Local_228[iLocal_230 /*2*/].f_1 && (func_250() || iLocal_230 == 0))
			{
				if (iLocal_230 != 2 || ENTITY::GET_ENTITY_SPEED(Local_43.f_4) > 10f)
				{
					...
					{
						if (func_249(&uLocal_63, "BAR3AAU", Local_228[iLocal_230 /*2*/], 7, 1, 0, 0))
						{
							iLocal_229 = 0;
							iLocal_230++;
						}
					}
					else if (func_249(&uLocal_63, "BAR3AAU", Local_228[iLocal_230 /*2*/], 7, 0, 0, 0))
					{
						iLocal_229 = 0;
						iLocal_230++;
					}
		...
		case 1:
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_43.f_4, false))
			{
				...
				else
				{
					...
					if (!iLocal_236)
					{
						if (((MISC::GET_GAME_TIMER() - iLocal_231) > 8000 && iLocal_230 >= 4) && !func_215())
						{
							if (func_249(&uLocal_63, "BAR3AAU", "BAR3A_LW", 7, 0, 0, 0))
							{
								iLocal_236 = 1;
							}
						}
...
void func_261(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2861E
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_204(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
			...
			{
				iVar6 = func_334(&(Global_100681.f_3));
				if (iVar6 > -1)
				{
...
void func_287(int iParam0, var uParam1)//Position - 0x2AE42
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_289(Var7.f_1)) && iVar9 < 51)
			{
...
int func_295(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x2C7F5
{
	int iVar0;
	int iVar1;
...
bool func_297(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x2CFB8
{
	if (bParam2)
	{
...
int func_303(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x2D474
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_310(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2E09C
{
	...
	Var3 = { Var2 - Var0 };
	Var3 = { func_311(Var3, -Var0.f_3.f_2) };
	Var3 = { func_311(Var3, Var1.f_3.f_2) };
	*uParam2 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Var1, 0f, Var3) };
	uParam2->f_3 = { Var2.f_3 };
	return 1;
}

Vector3 func_311(struct<3> Param0, float fParam1)//Position - 0x2E131
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
void func_341(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x2FC11
{
	struct<3> Var0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104212.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104212.f_4, false))
		{
			if (func_368(24) != Global_104212.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_365(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_342(Global_104212.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}

void func_342(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x2FC8C
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_361(iParam3, &Var0, Param1, fParam2, func_270(iParam0));
		func_343(iParam3, iParam0, 0);
	}
}
...
void func_361(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x3569C
{
	if (func_360(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
...
int func_365(struct<3> Param0, int iParam1, var uParam2, var uParam3)//Position - 0x358FF
{
	int iVar0;
	
	iVar0 = func_366(Param0, iParam1, 1);
	switch (iVar0)
	{
		case 0:
...
int func_366(struct<3> Param0, int iParam1, int iParam2)//Position - 0x35A15
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_370()//Position - 0x35B36
{
	switch (iLocal_41)
	{
		case 0:
			func_241(&uLocal_63, 3, 0, "BARRY", 0, 1);
			if (func_221(&uLocal_63, 49, "BAR3AAU", "BAR3A_PICK2", 7, 1, 0, 0, 0))
			{
				iLocal_41 = 1;
			}
			break;
...
void func_373(int iParam0)//Position - 0x35C41
{
	switch (Local_56[iParam0 /*29*/].f_24)
	{
		case 0:
			...
			{
				if (func_207(Local_56[iParam0 /*29*/]))
				{
			...
			else if (!ENTITY::IS_ENTITY_DEAD(Local_56[iParam0 /*29*/].f_1, false))
			{
				...
				if (func_207(Local_56[iParam0 /*29*/].f_2))
				{
		...
		case 1:
			if (func_210(PLAYER::PLAYER_PED_ID(), Local_56[iParam0 /*29*/].f_3, 275f, 1))
			{
				if (func_392(iParam0))
				{
				...
				else if ((func_391(Local_56[iParam0 /*29*/]) || func_378(Local_56[iParam0 /*29*/].f_1)) || func_378(Local_56[iParam0 /*29*/].f_2))
				{
					func_376(iParam0, 0);
				}
				else if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
			...
			{
				if ((func_378(Local_56[iParam0 /*29*/].f_1) || func_378(Local_56[iParam0 /*29*/].f_2)) || func_391(Local_56[iParam0 /*29*/]))
				{
					func_376(iParam0, 0);
				}
			}
		...
		case 2:
			...
			else if ((func_378(Local_56[iParam0 /*29*/].f_1) || func_378(Local_56[iParam0 /*29*/].f_2)) || func_391(Local_56[iParam0 /*29*/]))
			{
				func_376(iParam0, 0);
			}
			break;
		...
		case 3:
			if (!func_210(PLAYER::PLAYER_PED_ID(), Local_56[iParam0 /*29*/].f_3, 275f, 1))
			{
				if (!Local_56[iParam0 /*29*/].f_26 && ENTITY::DOES_ENTITY_EXIST(Local_56[iParam0 /*29*/].f_1))
				{
					func_374(&(Local_56[iParam0 /*29*/].f_1), 1, 0, 1);
					Local_56[iParam0 /*29*/].f_26 = 1;
				}
				if (!Local_56[iParam0 /*29*/].f_27 && ENTITY::DOES_ENTITY_EXIST(Local_56[iParam0 /*29*/].f_2))
				{
...
void func_376(int iParam0, int iParam1)//Position - 0x360FE
{
	...
	if (func_207(Local_56[iParam0 /*29*/].f_1))
	{
	...
	if (func_207(Local_56[iParam0 /*29*/].f_2))
	{
		...
		func_374(&(Local_56[iParam0 /*29*/].f_2), 1, 0, 1);
	}
	if (iParam1 && func_207(Local_56[iParam0 /*29*/]))
	{
		VEHICLE::SET_VEHICLE_ENGINE_ON(Local_56[iParam0 /*29*/], true, true, false);
		func_377(&(Local_56[iParam0 /*29*/]));
	}
...
bool func_381(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x3633A
{
	...
	uVar0 = func_382(&(Local_35[iVar2 /*4*/]), Var1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar2 /*4*/].f_3) < iParam4);
}

int func_382(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x363FB
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_385(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x36636
{
	...
	{
		Var1 = { func_387(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_386(struct<3> Param0, struct<3> Param1)//Position - 0x366C7
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_396()//Position - 0x3695B
{
	switch (iLocal_243)
	{
		...
		case 2:
			...
			{
				if ((!iLocal_247 && MISC::GET_GAME_TIMER() >= iLocal_245) && !func_215())
				{
					if (func_249(&uLocal_63, "BAR3AAU", "BAR3A_HURRY", 7, 0, 0, 0))
					{
						iLocal_247 = 1;
					}
				}
...
void func_399(bool bParam0)//Position - 0x36B5D
{
	if (bParam0)
	{
		...
		while (iLocal_62 <= 1)
		{
			func_375(&(Local_56[iLocal_62 /*29*/].f_1));
			func_375(&(Local_56[iLocal_62 /*29*/].f_2));
			iLocal_62++;
		}
		iLocal_62 = 0;
		while (iLocal_62 <= 1)
		{
			func_206(&(Local_56[iLocal_62 /*29*/]));
			iLocal_62++;
		}
	}
	else
	{
		func_400(&iLocal_49, 0);
		func_377(&(Local_43.f_4));
		iLocal_62 = 0;
		while (iLocal_62 <= 1)
		{
			func_374(&(Local_56[iLocal_62 /*29*/].f_1), 1, 0, 1);
			func_374(&(Local_56[iLocal_62 /*29*/].f_2), 1, 0, 1);
			func_377(&(Local_56[iLocal_62 /*29*/]));
			iLocal_62++;
		}
	}
	if (iLocal_57)
...
void func_410(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x36F6D
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_412(Global_78814, Global_78816, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_413(iVar1), 8);
					break;
			}
			break;
...
void func_448(struct<3> Param0, float fParam1, bool bParam2)//Position - 0x3805E
{
	...
	if (bParam2)
	{
		func_449(PLAYER::PLAYER_PED_ID(), Local_43.f_4, -1, 0);
	}
	VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_43.f_4, false);
	VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_43.f_4, false);
	VEHICLE::SET_VEHICLE_STRONG(Local_43.f_4, true);
...
void func_452(bool bParam0)//Position - 0x382CE
{
	...
	if (bParam0)
	{
		...
		{
			func_448(Local_43, Local_43.f_3, 0);
		}
		while (!HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			SYSTEM::WAIT(0);
	...
	{
		func_448(Local_43, Local_43.f_3, 1);
	}
	iLocal_243 = 1;
	iLocal_246 = 1;
}
...
void func_454(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x3839B
{
	if (func_456())
	{
...
void func_457()//Position - 0x3847E
{
	...
	if (func_207(PLAYER::PLAYER_PED_ID()))
	{
		func_241(&uLocal_63, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	iLocal_236 = 0;
	iLocal_247 = 0;
	iLocal_230 = 0;
...
{
	Local_55[0 /*3*/] = { func_467("B3ADELV", 1) };
	Local_55[1 /*3*/] = { func_467("B3AGETIN", 1) };
	Local_55[2 /*3*/] = { func_467("B3AWAN1", -1) };
	Local_55[3 /*3*/] = { func_467("B3ARTV", 1) };
	Local_55[4 /*3*/] = { func_467("B3AEXIT", 1) };
	Local_55[5 /*3*/] = { func_467("B3ALEAVE", 1) };
}
...
int func_480(char* sParam0, int iParam1, int iParam2)//Position - 0x38DBD
{
	...
	if (func_483())
	{
		...
		{
			iVar2 = func_334(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
