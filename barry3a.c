...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x88C7
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_74(int iParam0)//Position - 0x976A
{
	if (!BitTest(Global_79172[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x97B2
{
	int iVar0;
...
int func_76(int iParam0)//Position - 0x985D
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_77(int iParam0, int iParam1)//Position - 0x990D
{
	int iVar0;
	struct<10> Var1;
...
void func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA23C
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_79(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xA366
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_80(int iParam0, int iParam1)//Position - 0xA3AE
{
	int iVar0;
	struct<17> Var1;
...
void func_81(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC1F7
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
void func_83(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xC491
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC502
{
	func_148();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_85(int iParam0, int iParam1)//Position - 0xC554
{
	switch (iParam0)
	{
		case 0:
...
void func_87(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD870
{
	var uVar0;
	int iVar1;
...
int func_91(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE80C
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE92C
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_106(int iParam0)//Position - 0x11139
{
	if (iParam0 < 136)
	{
		func_108(iParam0);
...
void func_111(int iParam0, int iParam1)//Position - 0x12E96
{
	switch (iParam0)
	{
		case 0:
...
void func_124(int iParam0)//Position - 0x17DA5
{
	if (iParam0 < 107)
	{
		func_127(iParam0);
...
bool func_170()//Position - 0x21E12
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_171()//Position - 0x21E28
{
...
void func_174(var uParam0)//Position - 0x21E8A
{
	if (*uParam0 == -1)
	{
		return;
...
void func_179(var uParam0, bool bParam1)//Position - 0x2241D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_184(int iParam0, int iParam1)//Position - 0x22841
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_185(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x22861
{
	if (iParam0 != 198)
	{
		if (Global_79389)
...
void func_196(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x26CB7
{
	int iVar0;
...
int func_198(int iParam0)//Position - 0x26FA1
{
	int iVar0;
	int iVar1;
...
int func_201(int iParam0)//Position - 0x271D8
{
...
int func_203(char* sParam0)//Position - 0x2723F
{
	int iVar0;
...
int func_205(char* sParam0, int iParam1)//Position - 0x272B0
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_207(int* iParam0)//Position - 0x2736A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_208(int iParam0)//Position - 0x27406
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_209(int iParam0)//Position - 0x27427
{
	if (func_208(iParam0))
	{
...
void func_210(int* iParam0)//Position - 0x27451
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
bool func_211(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2747C
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

int func_212(int iParam0, bool bParam1, int iParam2)//Position - 0x2749A
{
	int iVar0;
...
int func_213(int iParam0)//Position - 0x274CF
{
...
void func_215(char* sParam0, int iParam1, int iParam2)//Position - 0x27532
{
	iParam2 = iParam2;
...
int func_217(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x2756D
{
	int iVar0;
...
void func_218(int* iParam0)//Position - 0x2759B
{
...
bool func_220(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x27736
{
...
bool func_222(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x277D3
{
...
int func_223(char* sParam0, int iParam1, bool bParam2)//Position - 0x27832
{
	Global_22287 = 0;
...
bool func_226(int iParam0)//Position - 0x27B9A
{
	return func_227(iParam0, 20);
}

var func_227(int iParam0, int iParam1)//Position - 0x27BAA
{
	return BitTest(Global_1887305[iParam0 /*610*/].f_10.f_4, iParam1);
}

int func_228()//Position - 0x27BC2
{
	return -1;
}
...
void func_233()//Position - 0x27D51
{
	if (func_92(14))
	{
...
void func_238(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27EF2
{
...
bool func_240(char* sParam0, int iParam1, char* sParam2)//Position - 0x27F7B
{
...
void func_242(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x28040
{
...
int func_244(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x28175
{
...
void func_245(int iParam0)//Position - 0x281CC
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
bool func_251(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x28596
{
...
void func_253(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)//Position - 0x2862A
{
	switch (*uParam0)
	{
		case 0:
...
bool func_254(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2873B
{
...
void func_263(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28B9E
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_340(&(Global_101533.f_3));
				if (iVar10 > -1)
				{
...
void func_264(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x28D13
{
	func_265(&Global_107514, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_265(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x28D2F
{
	int iVar0;
	int iVar1;
...
void func_267(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x29BDA
{
	int iVar0;
...
int func_268(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x29C62
{
...
int func_269(int iParam0)//Position - 0x29CA2
{
	int iVar0;
...
void func_270(var uParam0, int iParam1, int iParam2)//Position - 0x29CD0
{
...
int func_271(int iParam0)//Position - 0x29DAC
{
	int iVar0;
...
int func_272(int iParam0)//Position - 0x29DEE
{
	int iVar0;
...
int func_273(int iParam0, int iParam1, int iParam2)//Position - 0x29E51
{
	int iVar0;
...
int func_274(int iParam0, int iParam1)//Position - 0x29EDF
{
	struct<82> Var0;
...
void func_275(int iParam0, var uParam1, int iParam2)//Position - 0x29F21
{
	int iVar0;
...
void func_276(int iParam0, var uParam1)//Position - 0x2A17D
{
	int iVar0;
...
int func_278(int iParam0, var uParam1, var uParam2)//Position - 0x2A4D8
{
	int iVar0;
	int iVar1;
...
int func_279(int iParam0)//Position - 0x2A6CB
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_280(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A6EB
{
	char* sVar0;
...
int func_281(int iParam0, int iParam1, bool bParam2)//Position - 0x2A81A
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_282(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2A888
{
...
void func_283(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A960
{
	int iVar0;
	int iVar1;
...
int func_284(int iParam0, int iParam1)//Position - 0x2AAFA
{
	int iVar0;
	var uVar1;
...
int func_285(int iParam0, var uParam1)//Position - 0x2AB1E
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_70(uParam1));
}

void func_286(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2AB33
{
	int iVar0;
...
void func_287(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x2B07C
{
	int iVar0;
...
int func_288()//Position - 0x2B2BD
{
	func_156();
	return Global_113969.f_2366.f_539.f_4321;
}

void func_289(int iParam0, bool bParam1)//Position - 0x2B2D6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_290(int iParam0, var uParam1)//Position - 0x2B3C9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_291(int iParam0)//Position - 0x2B651
{
	switch (iParam0)
	{
...
int func_292(int iParam0)//Position - 0x2B6F2
{
...
int func_293(int iParam0, int iParam1)//Position - 0x2B8E4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_294(int iParam0, var* uParam1)//Position - 0x2C627
{
	int iVar0;
	int iVar1;
...
int func_295(int iParam0)//Position - 0x2C662
{
	int iVar0;
...
void func_296(int iParam0)//Position - 0x2C8D6
{
	int iVar0;
...
int func_298(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x2CE61
{
	int iVar0;
	int iVar1;
...
bool func_300(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2D624
{
	if (bParam6)
	{
...
int func_301(var uParam0)//Position - 0x2D66B
{
...
int func_303(int iParam0, int iParam1, bool bParam2)//Position - 0x2D6D6
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_305(int iParam0)//Position - 0x2DADE
{
	return func_303(iParam0, 5, 1);
}

int func_306(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x2DAEE
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_310(struct<3> Param0)//Position - 0x2E5F9
{
...
int func_311()//Position - 0x2E623
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

Vector3 func_312(struct<3> Param0)//Position - 0x2E63B
{
...
int func_314(int iParam0)//Position - 0x2E667
{
	if (iParam0 != func_228())
	{
...
int func_316(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2E769
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_317(struct<3> Param0, float fParam3)//Position - 0x2E7FE
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_321(int iParam0, var uParam1)//Position - 0x2F49B
{
	switch (iParam0)
	{
		case 0:
...
int func_322(int iParam0)//Position - 0x2F51D
{
	if (iParam0 != func_228())
	{
...
int func_325(int iParam0)//Position - 0x2F7F1
{
	return MISC::GET_BITS_IN_RANGE(Global_2657971[iParam0 /*465*/].f_322.f_3, 28, 31);
}

int func_326(int iParam0)//Position - 0x2F80E
{
...
var func_334(int iParam0)//Position - 0x2FD57
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_335(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_335(bool bParam0, int iParam1, int iParam2)//Position - 0x2FD79
{
	if (bParam0)
	{
		return iParam1;
...
int func_336(var uParam0)//Position - 0x2FD90
{
	return uParam0 & 15;
}
...
int func_340(char* sParam0)//Position - 0x2FE4E
{
...
int func_343(char* sParam0, bool bParam1)//Position - 0x2FFB4
{
	int iVar0;
	int iVar1;
...
int func_344(int iParam0, bool bParam1)//Position - 0x2FFDE
{
	int iVar0;
...
void func_347(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x302E2
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104530.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104530.f_4, false))
		{
			if (func_374(24) != Global_104530.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_371(ENTITY::GET_ENTITY_COORDS(Global_104530.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_348(Global_104530.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_348(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x3035D
{
	struct<60> Var0;
...
void func_349(int iParam0, int iParam1, int iParam2)//Position - 0x30486
{
	int iVar0;
...
void func_350(int iParam0, int iParam1)//Position - 0x3059D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_351(int iParam0)//Position - 0x3079F
{
...
int func_352(int iParam0)//Position - 0x3087C
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_353(int iParam0, bool bParam1, int iParam2)//Position - 0x30A3A
{
	int iVar0;
	struct<2> Var1;
...
int func_354(int iParam0)//Position - 0x30BBF
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_356(int iParam0, int iParam1)//Position - 0x30CA2
{
	int iVar0;
	int iVar1;
...
int func_357()//Position - 0x30EF3
{
	return 0;
}

int func_358()//Position - 0x30EFC
{
	return 1;
}

int func_359()//Position - 0x30F05
{
	return 1;
}

int func_360()//Position - 0x30F0E
{
...
int func_362(int iParam0)//Position - 0x30FDF
{
	int iVar0;
	char* sVar1;
...
int func_363(int iParam0)//Position - 0x31026
{
	int iVar0;
...
int func_364(int iParam0)//Position - 0x31061
{
	int iVar0;
...
int func_365(int iParam0)//Position - 0x310DD
{
	int iVar0;
...
int func_366(var uParam0, int iParam1)//Position - 0x311C5
{
	int iVar0;
	int iVar1;
...
void func_367(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x328B3
{
	if (func_366(&(Global_78179.f_555[0 /*21*/]), iParam0))
	{
...
int func_371(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x32B16
{
	int iVar0;
...
int func_372(struct<3> Param0, int iParam3, int iParam4)//Position - 0x32C2C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_373(int iParam0)//Position - 0x32CBB
{
	return BitTest(Global_113969.f_7232[iParam0], 0);
}

int func_374(int iParam0)//Position - 0x32CD0
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_380(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x33284
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_381(int* iParam0)//Position - 0x332D4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_382(int iParam0, int iParam1)//Position - 0x33315
{
	if (!iLocal_426)
	{
		iLocal_426 = 1;
...
void func_383(int* iParam0)//Position - 0x33407
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_384(int iParam0)//Position - 0x3343F
{
	struct<3> Var0;
...
int func_385(int iParam0, float fParam1)//Position - 0x334C3
{
	float fVar0;
...
bool func_386(int iParam0, float fParam1)//Position - 0x33539
{
	return func_387(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_387(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x33551
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_388(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x33612
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_389(int iParam0, int iParam1)//Position - 0x3373E
{
	int iVar0;
...
int func_391(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x3384D
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_392(struct<3> Param0, struct<3> Param3)//Position - 0x338DE
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_393(struct<3> Param0)//Position - 0x338FF
{
	float fVar0;
	float fVar1;
...
int func_395(int iParam0, int iParam1)//Position - 0x33959
{
	int iVar0;
...
int func_396(int iParam0)//Position - 0x33998
{
...
int func_397(int iParam0)//Position - 0x339C0
{
	struct<3> Var0;
...
int func_398(int iParam0)//Position - 0x33A1F
{
...
void func_406(int* iParam0, bool bParam1)//Position - 0x33E52
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
int func_414(int iParam0, int iParam1)//Position - 0x34118
{
	return BitTest(Global_1670224.f_7064[iParam0], iParam1);
}

int func_415(int iParam0)//Position - 0x3412E
{
	if (iParam0 == 1)
	{
		if (Global_20930.f_1 > 3)
...
void func_416(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x34185
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_418(Global_79645, Global_79647, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_417(char* sParam0)//Position - 0x3446A
{
...
int func_427(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x3484B
{
...
int func_429(int iParam0)//Position - 0x3498C
{
	if (Global_44042 == 15)
	{
		return 0;
...
bool func_430(int iParam0)//Position - 0x349AE
{
	return func_431(iParam0, Global_44042);
}

int func_431(int iParam0, int iParam1)//Position - 0x349BF
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_433(var uParam0, int iParam1)//Position - 0x34BEE
{
...
int func_436(bool bParam0)//Position - 0x34C26
{
...
int func_440(int iParam0)//Position - 0x34D68
{
	if (func_208(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_441(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x34D88
{
	if (bParam0)
	{
...
bool func_443(int iParam0, int iParam1)//Position - 0x34EEF
{
	bool bVar0;
...
int func_445(var uParam0)//Position - 0x34F89
{
	int iVar0;
...
int func_446(int iParam0)//Position - 0x34FAB
{
...
int func_448(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x34FF8
{
	int iVar0;
...
void func_451(int iParam0, int iParam1, int iParam2)//Position - 0x350F8
{
...
void func_455(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x352A5
{
...
void func_456(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x353EA
{
	if (func_440(iParam0))
	{
		if (func_208(iParam1))
...
void func_461(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x355E2
{
	if (func_463())
	{
...
void func_465(int iParam0, int iParam1, bool bParam2)//Position - 0x357D7
{
	int iVar0;
...
struct<4> func_467(int iParam0)//Position - 0x359D0
{
	return Global_2169[iParam0 /*29*/].f_3;
}

int func_468(int iParam0, int iParam1)//Position - 0x359E3
{
...
int func_469(int iParam0, int iParam1)//Position - 0x35A0D
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_470(int iParam0, int iParam1, int iParam2)//Position - 0x35A37
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_471(int iParam0, int iParam1, int iParam2)//Position - 0x35A7C
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_486(char* sParam0, int iParam1)//Position - 0x35FE4
{
	if (Global_101533 != 12)
	{
...
int func_487(char* sParam0, int iParam1, int iParam2)//Position - 0x3600C
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_509(int iParam0)//Position - 0x3668F
{
	if (!func_153(iParam0))
	{
		return func_152(iParam0);
