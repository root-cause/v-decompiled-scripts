#region Local Var
	...
	int iLocal_162[2] = { 0, 0 };
	struct<3> Local_165[6];
	struct<29> Local_184[2];
	int iLocal_243 = 0;
	int iLocal_244 = 0;
	int iLocal_245 = 0;
	int iLocal_246 = 0;
...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_78 = func_509(49);
	Local_154 = { 0f, -1f, 0.64f };
	iLocal_157 = joaat("prop_weed_tub_01b");
	Local_159 = { -1138.9767f, -1252.5486f, 6.05f };
	...
	{
		Local_143.f_4 = Local_79.f_35[0];
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_79.f_41[0]))
	{
		iLocal_153 = Local_79.f_41[0];
	}
	if (func_463())
	{
		iVar0 = func_462();
		...
		{
			case 0:
				func_461(Local_143, Local_143.f_3, 1, 0);
				func_459(1);
				break;
			
			case 1:
				func_461(Local_159, 298.7f, 1, 0);
				func_458(1);
				break;
	...
	{
		func_435(&(Local_184[0 /*29*/]), &(Local_79.f_35[1]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_79.f_28[0]))
	{
		func_434(&(Local_184[0 /*29*/].f_1), &(Local_79.f_28[0]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_79.f_28[1]))
	{
		func_434(&(Local_184[0 /*29*/].f_2), &(Local_79.f_28[1]));
	}
	func_432();
	while (true)
	{
		RECORDING::REPLAY_CHECK_FOR_EVENT_THIS_FRAME("SF_GRTP", 0);
		func_416(Local_79.f_9, 0, 0, 1, 0, 0);
		func_411();
		if (iLocal_140 == 9)
		{
			func_404();
...
void func_1()//Position - 0x2C4
{
	switch (iLocal_141)
	{
		case 0:
			func_218(&iLocal_142);
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_143.f_4, false))
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 1)
				{
					iLocal_435 = 1;
					iLocal_436 = 0;
					iLocal_142 = func_217(Local_159, 5, 1);
				}
				else
				{
					iLocal_435 = 1;
					iLocal_436 = 1;
					if (MISC::GET_PROFILE_SETTING(203) == 0 || !func_216())
					{
						func_214(2);
						iLocal_434 = 0;
					}
			...
			else
			{
				...
				iLocal_142 = func_212(Local_143.f_4, 1, 5);
			}
			iLocal_141 = 1;
			break;
		
		case 1:
			if (!func_211(Local_143.f_4, Local_159, 125f, 1))
			{
			...
			else if (!iLocal_435)
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_143.f_4, false))
				{
					...
					{
						iLocal_436 = 0;
						if (ENTITY::IS_ENTITY_AT_COORD(Local_143.f_4, Local_159, 6f, 6f, 2f, true, true, 0))
						{
							func_218(&iLocal_142);
							iLocal_141 = 0;
							iLocal_140 = 6;
				...
				else if (iLocal_434 && !func_216())
				{
					func_214(3);
					iLocal_434 = 0;
				}
			}
			else if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_143.f_4, false))
			{
				HUD::CLEAR_PRINTS();
				iLocal_435 = 0;
				iLocal_434 = 1;
			...
			else if (ENTITY::IS_ENTITY_AT_COORD(Local_143.f_4, Local_159, 6f, 6f, 2f, true, true, 0))
			{
				func_218(&iLocal_142);
				iLocal_141 = 0;
				iLocal_140 = 6;
...
void func_9(int iParam0, bool bParam1, int iParam2)//Position - 0xCFE
{
	if (iParam2 == -1)
	{
		iParam2 = func_10();
...
int func_32(int iParam0, int iParam1, int iParam2)//Position - 0x1987
{
	int iVar0;
...
int func_36(int iParam0, int iParam1, int iParam2)//Position - 0x22FE
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
int func_38(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x2404
{
	var uVar0;
	int iVar10;
...
int func_39(int iParam0, int iParam1, int iParam2)//Position - 0x2A08
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_41(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2B42
{
	int iVar0;
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x39FC
{
	int iVar0;
...
int func_46(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3FDE
{
	int iVar0;
...
int func_47(int iParam0, int iParam1, int iParam2)//Position - 0x4008
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_48(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x42D2
{
	int iVar0;
...
int func_51(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x474D
{
	switch (iParam0)
	{
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5117
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5394
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x57B9
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5B53
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_69(int iParam0, var uParam1)//Position - 0x5CCC
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_70(uParam1));
}

int func_70(var uParam0)//Position - 0x5CE1
{
	int iVar0;
	int iVar1;
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8969
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_74(int iParam0)//Position - 0x980C
{
	if (!BitTest(Global_79322[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9854
{
	int iVar0;
...
void func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA2DE
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_79(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xA408
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
void func_87(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD913
{
	var uVar0;
	int iVar1;
...
int func_91(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE8AF
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_149(int iParam0, int iParam1, int iParam2)//Position - 0x1FD97
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_150(int iParam0)//Position - 0x1FFF0
{
	int iVar0;
	int iVar1;
...
int func_151(int iParam0)//Position - 0x2002F
{
	if (func_153(iParam0))
	{
...
var func_152(int iParam0)//Position - 0x20054
{
	return Global_2201[iParam0 /*29*/];
}

bool func_153(int iParam0)//Position - 0x20063
{
	return iParam0 < 3;
}

void func_154(char* sParam0, var uParam1)//Position - 0x2006F
{
...
void func_162(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x207AC
{
...
char* func_168(var uParam0)//Position - 0x21DC0
{
	uParam0 = uParam0;
	return "";
}
...
void func_174(var uParam0)//Position - 0x21E94
{
	if (*uParam0 == -1)
	{
		return;
...
void func_179(var uParam0, bool bParam1)//Position - 0x22427
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_184(int iParam0, int iParam1)//Position - 0x2284B
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_185(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x2286B
{
	if (iParam0 != 198)
	{
		if (Global_79539)
...
void func_196(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x26CC1
{
	int iVar0;
...
int func_198(int iParam0)//Position - 0x26FAB
{
	int iVar0;
	int iVar1;
...
int func_201(int iParam0)//Position - 0x271E2
{
...
int func_203(char* sParam0)//Position - 0x27249
{
	int iVar0;
...
int func_205(char* sParam0, int iParam1)//Position - 0x272BA
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_207(int* iParam0)//Position - 0x27374
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_208(int iParam0)//Position - 0x27410
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_209(int iParam0)//Position - 0x27431
{
	if (func_208(iParam0))
	{
...
void func_210(int* iParam0)//Position - 0x2745B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
bool func_211(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x27486
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

int func_212(int iParam0, bool bParam1, int iParam2)//Position - 0x274A4
{
	int iVar0;
...
int func_213(int iParam0)//Position - 0x274D9
{
	if (Local_165[iParam0 /*3*/].f_1 < Local_165[iParam0 /*3*/] || Local_165[iParam0 /*3*/] == -1)
	{
		return 1;
	}
	return 0;
...
void func_214(int iParam0)//Position - 0x27509
{
	if (func_213(iParam0))
	{
		func_215(Local_165[iParam0 /*3*/].f_2, 7500, 1);
		Local_165[iParam0 /*3*/].f_1++;
	}
}

void func_215(char* sParam0, int iParam1, int iParam2)//Position - 0x2753C
{
	iParam2 = iParam2;
...
int func_217(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x27577
{
	int iVar0;
...
void func_218(int* iParam0)//Position - 0x275A5
{
...
void func_219()//Position - 0x275C5
{
	...
	{
		case 0:
			if (ENTITY::IS_ENTITY_AT_COORD(Local_143.f_4, Local_159, 10f, 10f, 2f, false, true, 0))
			{
				func_218(&iLocal_142);
		...
		case 1:
			if (ENTITY::IS_ENTITY_AT_COORD(Local_143.f_4, Local_159, 10f, 10f, 2f, false, true, 0))
			{
				...
				{
					func_221();
					if (!func_220(PLAYER::PLAYER_PED_ID(), Local_143.f_4, 55f, 1) && !ENTITY::IS_ENTITY_ON_SCREEN(Local_143.f_4))
					{
						iLocal_141 = 2;
					}
					else if ((iLocal_431 && func_213(5)) && (MISC::GET_PROFILE_SETTING(203) == 0 || !func_216()))
					{
						func_214(5);
					}
				}
...
bool func_220(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x27740
{
...
void func_221()//Position - 0x27762
{
	...
	else if (!iLocal_431)
	{
		if (MISC::GET_GAME_TIMER() > iLocal_433)
		{
			if (iLocal_427 == 1)
			{
				if (func_222(&uLocal_249, 49, "BAR3AAU", "BAR3A_P1", 9, 1, 0, 0, 0))
				{
					iLocal_141 = 1;
					iLocal_431 = 1;
				}
			}
			else if (func_222(&uLocal_249, 49, "BAR3AAU", "BAR3A_P1b", 9, 1, 0, 0, 0))
			{
				iLocal_141 = 1;
				iLocal_431 = 1;
			}
...
int func_223(char* sParam0, int iParam1, bool bParam2)//Position - 0x2783C
{
	Global_22426 = 0;
...
var func_227(int iParam0, int iParam1)//Position - 0x27BB4
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_228()//Position - 0x27BCC
{
	return -1;
}
...
void func_233()//Position - 0x27D5B
{
	if (func_92(14))
	{
...
int func_239()//Position - 0x27F52
{
	...
	while (iLocal_248 <= 5)
	{
		if (func_240(Local_165[iLocal_248 /*3*/].f_2, 0, 0))
		{
			iVar0 = 1;
		}
		iLocal_248++;
...
bool func_240(char* sParam0, int iParam1, char* sParam2)//Position - 0x27F85
{
...
void func_241()//Position - 0x27FA3
{
	...
	{
		case 0:
			if (VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(Local_143.f_4) < 1f)
			{
				VEHICLE::SET_VEHICLE_PETROL_TANK_HEALTH(Local_143.f_4, 10f);
			}
			if (VEHICLE::GET_VEHICLE_ENGINE_HEALTH(Local_143.f_4) < 1f)
			{
				VEHICLE::SET_VEHICLE_ENGINE_HEALTH(Local_143.f_4, 10f);
			}
			if (func_244(Local_143.f_4, 1093140480, 1, 1056964608, 0, 1, 0))
			{
				func_243(0, -1);
				iLocal_440 = 0;
				iLocal_437 = 0;
		...
		case 2:
			func_242(&uLocal_249, 3, 0, "BARRY", 0, 1);
			iLocal_141 = 0;
			iLocal_140 = 7;
			break;
	}
...
void func_242(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x28048
{
...
int func_244(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2817D
{
...
void func_245(int iParam0)//Position - 0x281D4
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_247()//Position - 0x28351
{
	switch (iLocal_141)
	{
		case 0:
			func_218(&iLocal_142);
			if (!func_216() || MISC::GET_PROFILE_SETTING(203) == 0)
			{
				func_214(2);
				func_258(&uLocal_448);
				iLocal_429 = 0;
		...
		case 1:
			func_253(&uLocal_448, &uLocal_249, "BAR3AAU", &sLocal_449, &cLocal_455);
			if (!iLocal_246 && MISC::GET_GAME_TIMER() > iLocal_247)
			{
...
{
	if (iLocal_426 && iLocal_424 < 4)
	{
		if (!func_216() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_143.f_4, false))
		{
			if (!iLocal_423)
			{
				iLocal_423 = 1;
			...
			if ((MISC::GET_GAME_TIMER() - iLocal_425) > Local_414[iLocal_424 /*2*/].f_1 && (func_252() || iLocal_424 == 0))
			{
				if (iLocal_424 != 2 || ENTITY::GET_ENTITY_SPEED(Local_143.f_4) > 10f)
				{
					if (func_239() || MISC::GET_PROFILE_SETTING(203) == 0)
					{
						if (func_251(&uLocal_249, "BAR3AAU", Local_414[iLocal_424 /*2*/], 7, 1, 0, 0))
						{
							iLocal_423 = 0;
							iLocal_424++;
						}
					}
					else if (func_251(&uLocal_249, "BAR3AAU", Local_414[iLocal_424 /*2*/], 7, 0, 0, 0))
					{
						iLocal_423 = 0;
						iLocal_424++;
					}
...
bool func_251(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2859E
{
...
void func_259()//Position - 0x288A1
{
	switch (iLocal_141)
	{
		case 0:
			func_218(&iLocal_142);
			iLocal_142 = func_212(Local_143.f_4, 1, 5);
			HUD::SET_BLIP_ROUTE(iLocal_142, true);
			if (func_213(3) && (MISC::GET_PROFILE_SETTING(203) == 0 || !func_216()))
			{
				func_214(3);
				func_258(&uLocal_448);
			}
	...
	switch (iLocal_141)
	{
		case 0:
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_143.f_4, false))
			{
				func_218(&iLocal_142);
				iLocal_142 = func_217(Local_159, 5, 1);
				if (func_213(0) && (MISC::GET_PROFILE_SETTING(203) == 0 || !func_216()))
				{
					func_214(0);
					func_258(&uLocal_448);
				}
		...
		case 1:
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_143.f_4, false))
			{
				...
				else
				{
					...
					if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_143.f_4) && ENTITY::IS_ENTITY_AT_COORD(Local_143.f_4, Local_159, 6f, 6f, 2f, true, true, 0))
					{
						iLocal_437 = 0;
						iLocal_141 = 2;
					}
					if (!iLocal_430)
					{
						if (((MISC::GET_GAME_TIMER() - iLocal_425) > 8000 && iLocal_424 >= 4) && !func_216())
						{
							if (func_251(&uLocal_249, "BAR3AAU", "BAR3A_LW", 7, 0, 0, 0))
							{
								iLocal_430 = 1;
							}
						}
...
void func_263(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28BA6
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_205(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
			...
			{
				iVar10 = func_340(&(Global_101688.f_3));
				if (iVar10 > -1)
				{
...
void func_264(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x28D1B
{
	func_265(&Global_107680, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_265(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x28D37
{
	int iVar0;
	int iVar1;
...
int func_269(int iParam0)//Position - 0x29CAA
{
	int iVar0;
...
int func_272(int iParam0)//Position - 0x29DF6
{
	int iVar0;
...
int func_273(int iParam0, int iParam1, int iParam2)//Position - 0x29E59
{
	int iVar0;
...
int func_274(int iParam0, int iParam1)//Position - 0x29EE7
{
	struct<82> Var0;
...
void func_275(int iParam0, var uParam1, int iParam2)//Position - 0x29F29
{
	int iVar0;
...
int func_278(int iParam0, var uParam1, var uParam2)//Position - 0x2A4E0
{
	int iVar0;
	int iVar1;
...
int func_279(int iParam0)//Position - 0x2A6D3
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_280(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A6F3
{
	char* sVar0;
...
int func_281(int iParam0, int iParam1, bool bParam2)//Position - 0x2A822
{
	int iVar0;
	char* sVar1;
	int iVar9;
	...
	iVar0 = 0;
	while (func_282(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_282(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2A890
{
...
int func_284(int iParam0, int iParam1)//Position - 0x2AB02
{
	int iVar0;
	var uVar1;
...
int func_285(int iParam0, var uParam1)//Position - 0x2AB26
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_70(uParam1));
}

void func_286(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2AB3B
{
	int iVar0;
...
void func_287(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x2B084
{
	int iVar0;
...
int func_288()//Position - 0x2B2C5
{
	func_156();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_289(int iParam0, bool bParam1)//Position - 0x2B2DE
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_153(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_290(iParam0, &(Global_114135.f_2367.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_290(int iParam0, var uParam1)//Position - 0x2B3D1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_291(int iParam0)//Position - 0x2B659
{
	switch (iParam0)
	{
...
int func_292(int iParam0)//Position - 0x2B6FA
{
...
void func_296(int iParam0)//Position - 0x2C924
{
	int iVar0;
...
int func_298(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x2CEAF
{
	int iVar0;
	int iVar1;
...
bool func_300(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2D672
{
	if (bParam6)
	{
...
int func_301(var uParam0)//Position - 0x2D6B9
{
...
int func_303(int iParam0, int iParam1, bool bParam2)//Position - 0x2D724
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_305(int iParam0)//Position - 0x2DB3B
{
	return func_303(iParam0, 5, 1);
}

int func_306(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x2DB4B
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_310(struct<3> Param0)//Position - 0x2E671
{
...
Vector3 func_312(struct<3> Param0)//Position - 0x2E6B3
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_313(), 0f, Param0);
}
...
int func_314(int iParam0)//Position - 0x2E6DF
{
	if (iParam0 != func_228())
	{
...
int func_316(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2E7E1
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_317(struct<3> Param0, float fParam3)//Position - 0x2E876
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_321(int iParam0, var uParam1)//Position - 0x2F513
{
	switch (iParam0)
	{
		case 0:
...
int func_322(int iParam0)//Position - 0x2F595
{
	if (iParam0 != func_228())
	{
...
int func_326(int iParam0)//Position - 0x2F8A1
{
...
var func_329()//Position - 0x2FC05
{
	...
	func_339(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_338(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_337(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_332(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_331(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_330(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}
...
var func_334(int iParam0)//Position - 0x2FDF7
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_335(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_335(bool bParam0, int iParam1, int iParam2)//Position - 0x2FE19
{
	if (bParam0)
	{
		return iParam1;
...
int func_336(var uParam0)//Position - 0x2FE30
{
	return uParam0 & 15;
}
...
int func_344(int iParam0, bool bParam1)//Position - 0x3007E
{
	int iVar0;
...
void func_347(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x30380
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104696.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104696.f_4, false))
		{
			if (func_374(24) != Global_104696.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_371(ENTITY::GET_ENTITY_COORDS(Global_104696.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_348(Global_104696.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_348(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x303FB
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_367(iParam5, &Var0, Param1, fParam4, func_272(iParam0));
...
void func_350(int iParam0, int iParam1)//Position - 0x3063B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_351(int iParam0)//Position - 0x3083D
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_281(iParam0, 0, 0)) || func_281(iParam0, 1, 0)) || func_281(iParam0, 2, 0)) || func_272(iParam0) != 145) || func_365(iParam0)) || func_364(iParam0)) || func_363(iParam0)) || func_362(iParam0)) || !func_352(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_364(iParam0))
		{
		}
...
int func_352(int iParam0)//Position - 0x3091A
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_353(int iParam0, bool bParam1, int iParam2)//Position - 0x30AD8
{
	int iVar0;
	struct<2> Var1;
...
int func_354(int iParam0)//Position - 0x30C5D
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_356(int iParam0, int iParam1)//Position - 0x30D40
{
	int iVar0;
	int iVar1;
...
int func_357()//Position - 0x30F49
{
	return 0;
}

int func_358()//Position - 0x30F52
{
	return 1;
}

int func_359()//Position - 0x30F5B
{
	return 1;
}

int func_360()//Position - 0x30F64
{
...
int func_362(int iParam0)//Position - 0x31035
{
	int iVar0;
	char* sVar1;
...
int func_363(int iParam0)//Position - 0x3107C
{
	int iVar0;
...
int func_364(int iParam0)//Position - 0x310B7
{
	int iVar0;
...
int func_365(int iParam0)//Position - 0x31133
{
	int iVar0;
...
int func_366(var uParam0, int iParam1)//Position - 0x3121B
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_300(Global_114135.f_32754.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_300(Global_114135.f_2367.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_300(Global_114135.f_2367.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_367(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x32909
{
	if (func_366(&(Global_78329.f_555[0 /*21*/]), iParam0))
	{
...
int func_371(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x32B6C
{
	int iVar0;
	
	iVar0 = func_372(Param0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_372(struct<3> Param0, int iParam3, int iParam4)//Position - 0x32C82
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_373(int iParam0)//Position - 0x32D11
{
...
void func_376()//Position - 0x32DA3
{
	switch (iLocal_141)
	{
		case 0:
			func_242(&uLocal_249, 3, 0, "BARRY", 0, 1);
			if (func_222(&uLocal_249, 49, "BAR3AAU", "BAR3A_PICK2", 7, 1, 0, 0, 0))
			{
				iLocal_141 = 1;
			}
			break;
...
void func_378()//Position - 0x32E5E
{
	...
	if ((iLocal_243 && Local_184[0 /*29*/].f_24 == 1) && Local_184[1 /*29*/].f_24 == 1)
	{
...
{
	switch (Local_184[iParam0 /*29*/].f_24)
	{
		case 0:
			if (!ENTITY::DOES_ENTITY_EXIST(Local_184[iParam0 /*29*/].f_1))
			{
				if (func_208(Local_184[iParam0 /*29*/]))
				{
					if (STREAMING::HAS_MODEL_LOADED(iLocal_245))
					{
						Local_184[iParam0 /*29*/].f_1 = PED::CREATE_PED_INSIDE_VEHICLE(Local_184[iParam0 /*29*/], 6, iLocal_245, -1, true, true);
						Local_184[iParam0 /*29*/].f_2 = PED::CREATE_PED_INSIDE_VEHICLE(Local_184[iParam0 /*29*/], 6, iLocal_245, 0, true, true);
					}
				}
				else if (STREAMING::HAS_MODEL_LOADED(iLocal_244))
				{
					Local_184[iParam0 /*29*/] = VEHICLE::CREATE_VEHICLE(iLocal_244, Local_184[iParam0 /*29*/].f_3, Local_184[iParam0 /*29*/].f_6, true, true, false);
				}
			}
			else if (!ENTITY::IS_ENTITY_DEAD(Local_184[iParam0 /*29*/].f_1, false))
			{
				PED::SET_PED_AS_COP(Local_184[iParam0 /*29*/].f_1, true);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_184[iParam0 /*29*/].f_1, true);
				WEAPON::GIVE_DELAYED_WEAPON_TO_PED(Local_184[iParam0 /*29*/].f_1, joaat("WEAPON_PISTOL"), 100, true);
				PED::SET_PED_ACCURACY(Local_184[iParam0 /*29*/].f_1, 10);
				if (func_208(Local_184[iParam0 /*29*/].f_2))
				{
					PED::SET_PED_AS_COP(Local_184[iParam0 /*29*/].f_2, true);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_184[iParam0 /*29*/].f_2, true);
					WEAPON::GIVE_DELAYED_WEAPON_TO_PED(Local_184[iParam0 /*29*/].f_2, joaat("WEAPON_PISTOL"), 100, true);
					PED::SET_PED_ACCURACY(Local_184[iParam0 /*29*/].f_2, 10);
				}
				Local_184[iParam0 /*29*/].f_24 = 1;
			}
			break;
		
		case 1:
			if (func_211(PLAYER::PLAYER_PED_ID(), Local_184[iParam0 /*29*/].f_3, 275f, 1))
			{
				if (func_398(iParam0))
				{
					Local_184[iParam0 /*29*/].f_25 = MISC::GET_GAME_TIMER() + 1750;
					Local_184[iParam0 /*29*/].f_24 = 2;
				}
				else if ((func_397(Local_184[iParam0 /*29*/]) || func_384(Local_184[iParam0 /*29*/].f_1)) || func_384(Local_184[iParam0 /*29*/].f_2))
				{
					func_382(iParam0, 0);
				}
				else if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
			...
			{
				if (!Local_184[iParam0 /*29*/].f_26 && ENTITY::DOES_ENTITY_EXIST(Local_184[iParam0 /*29*/].f_1))
				{
					func_381(&(Local_184[iParam0 /*29*/].f_1));
					Local_184[iParam0 /*29*/].f_26 = 1;
				}
				if (!Local_184[iParam0 /*29*/].f_27 && ENTITY::DOES_ENTITY_EXIST(Local_184[iParam0 /*29*/].f_2))
				{
					func_381(&(Local_184[iParam0 /*29*/].f_2));
					Local_184[iParam0 /*29*/].f_27 = 1;
				}
				if (!Local_184[iParam0 /*29*/].f_28 && ENTITY::DOES_ENTITY_EXIST(Local_184[iParam0 /*29*/]))
				{
					func_207(&(Local_184[iParam0 /*29*/]));
					Local_184[iParam0 /*29*/].f_28 = 1;
				}
				if ((Local_184[iParam0 /*29*/].f_26 && Local_184[iParam0 /*29*/].f_27) && Local_184[iParam0 /*29*/].f_28)
				{
					Local_184[iParam0 /*29*/].f_24 = 4;
				}
			}
			if (PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
			{
				if ((func_384(Local_184[iParam0 /*29*/].f_1) || func_384(Local_184[iParam0 /*29*/].f_2)) || func_397(Local_184[iParam0 /*29*/]))
				{
					func_382(iParam0, 0);
				}
			}
		...
		case 2:
			if (MISC::GET_GAME_TIMER() > Local_184[iParam0 /*29*/].f_25)
			{
				func_382(iParam0, 1);
			}
			else if ((func_384(Local_184[iParam0 /*29*/].f_1) || func_384(Local_184[iParam0 /*29*/].f_2)) || func_397(Local_184[iParam0 /*29*/]))
			{
				func_382(iParam0, 0);
			}
			break;
		...
		case 3:
			if (!func_211(PLAYER::PLAYER_PED_ID(), Local_184[iParam0 /*29*/].f_3, 275f, 1))
			{
				if (!Local_184[iParam0 /*29*/].f_26 && ENTITY::DOES_ENTITY_EXIST(Local_184[iParam0 /*29*/].f_1))
				{
					func_380(&(Local_184[iParam0 /*29*/].f_1), 1, 0, 1);
					Local_184[iParam0 /*29*/].f_26 = 1;
				}
				if (!Local_184[iParam0 /*29*/].f_27 && ENTITY::DOES_ENTITY_EXIST(Local_184[iParam0 /*29*/].f_2))
				{
...
void func_380(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x332DA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_381(int* iParam0)//Position - 0x3332A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_382(int iParam0, int iParam1)//Position - 0x3336B
{
	if (!iLocal_426)
	{
		iLocal_426 = 1;
	...
	if (func_208(Local_184[iParam0 /*29*/].f_1))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_184[iParam0 /*29*/].f_1, false);
		PED::SET_PED_HIGHLY_PERCEPTIVE(Local_184[iParam0 /*29*/].f_1, true);
		func_380(&(Local_184[iParam0 /*29*/].f_1), 1, 0, 1);
	}
	if (func_208(Local_184[iParam0 /*29*/].f_2))
	{
		PED::SET_PED_AS_COP(Local_184[iParam0 /*29*/].f_2, true);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_184[iParam0 /*29*/].f_2, false);
		PED::SET_PED_HIGHLY_PERCEPTIVE(Local_184[iParam0 /*29*/].f_2, true);
		func_380(&(Local_184[iParam0 /*29*/].f_2), 1, 0, 1);
	}
	if (iParam1 && func_208(Local_184[iParam0 /*29*/]))
	{
		VEHICLE::SET_VEHICLE_ENGINE_ON(Local_184[iParam0 /*29*/], true, true, false);
		func_383(&(Local_184[iParam0 /*29*/]));
	}
	...
	Local_184[iParam0 /*29*/].f_24 = 3;
}

void func_383(int* iParam0)//Position - 0x3345D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_384(int iParam0)//Position - 0x33495
{
	struct<3> Var0;
	...
	if (func_208(iParam0))
	{
		...
		if (PED::IS_PED_BEING_JACKED(iParam0) && func_220(iParam0, PLAYER::PLAYER_PED_ID(), 2f, 1))
		{
			return 1;
		}
...
int func_385(int iParam0, float fParam1)//Position - 0x33519
{
	float fVar0;
	
	if (func_208(PLAYER::PLAYER_PED_ID()) && func_208(iParam0))
	{
		if (func_396(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_386(int iParam0, float fParam1)//Position - 0x3358F
{
	return func_387(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_387(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x335A7
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	
	iVar4 = func_395(iParam0, iParam1);
	if (!func_208(iParam0) || !func_208(iParam1))
	{
		if (iVar4 != -1)
		{
			func_394(&(Local_35[iVar4 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_388(&(Local_35[iVar4 /*4*/]), Var1, iParam1, &(Local_35[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar4 /*4*/].f_3) < iParam4);
}

int func_388(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x33668
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_389(int iParam0, int iParam1)//Position - 0x33794
{
	int iVar0;
...
int func_391(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x338A3
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_393(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_393(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_392(Var3, Var0);
...
float func_392(struct<3> Param0, struct<3> Param3)//Position - 0x33934
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_393(struct<3> Param0)//Position - 0x33955
{
	float fVar0;
	float fVar1;
...
int func_395(int iParam0, int iParam1)//Position - 0x339AF
{
	int iVar0;
...
int func_396(int iParam0)//Position - 0x339EE
{
...
int func_397(int iParam0)//Position - 0x33A16
{
	struct<3> Var0;
...
int func_398(int iParam0)//Position - 0x33A75
{
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_143.f_4, Local_184[iParam0 /*29*/].f_7[0 /*8*/][0 /*3*/], Local_184[iParam0 /*29*/].f_7[0 /*8*/][1 /*3*/], Local_184[iParam0 /*29*/].f_7[0 /*8*/].f_7, false, true, 0))
	{
		return 1;
	}
	else if (Local_184[iParam0 /*29*/].f_7[1 /*8*/].f_7 != 0f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_143.f_4, Local_184[iParam0 /*29*/].f_7[1 /*8*/][0 /*3*/], Local_184[iParam0 /*29*/].f_7[1 /*8*/][1 /*3*/], Local_184[iParam0 /*29*/].f_7[1 /*8*/].f_7, false, true, 0))
	{
		return 1;
	}
	return 0;
...
int func_401()//Position - 0x33B87
{
	if (VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(Local_143.f_4))
	{
		if (iLocal_151)
		{
...
int func_402()//Position - 0x33BC8
{
	switch (iLocal_437)
	{
		...
		case 2:
			...
			{
				if ((!iLocal_441 && MISC::GET_GAME_TIMER() >= iLocal_439) && !func_216())
				{
					if (func_251(&uLocal_249, "BAR3AAU", "BAR3A_HURRY", 7, 0, 0, 0))
					{
						iLocal_441 = 1;
					}
				}
	...
	switch (iLocal_141)
	{
		case 0:
			if (!func_410())
			{
				...
				{
					sLocal_447 = "DEFAULT" /* GXT: _ */;
				}
				if (MISC::ARE_STRINGS_EQUAL(sLocal_447, "DEFAULT" /* GXT: _ */))
				{
					func_485(1);
				}
				else
				{
					func_408(sLocal_447, 1);
				}
				iLocal_141 = 1;
			}
			break;
...
void func_405(bool bParam0)//Position - 0x33DCA
{
	if (bParam0)
	{
		...
		while (iLocal_248 <= 1)
		{
			func_381(&(Local_184[iLocal_248 /*29*/].f_1));
			func_381(&(Local_184[iLocal_248 /*29*/].f_2));
			iLocal_248++;
		}
		iLocal_248 = 0;
		while (iLocal_248 <= 1)
		{
			func_207(&(Local_184[iLocal_248 /*29*/]));
			iLocal_248++;
		}
	}
	else
	{
		func_406(&iLocal_153, 0);
		func_383(&(Local_143.f_4));
		iLocal_248 = 0;
		while (iLocal_248 <= 1)
		{
			func_380(&(Local_184[iLocal_248 /*29*/].f_1), 1, 0, 1);
			func_380(&(Local_184[iLocal_248 /*29*/].f_2), 1, 0, 1);
			func_383(&(Local_184[iLocal_248 /*29*/]));
			iLocal_248++;
		}
	}
	if (iLocal_243)
...
void func_406(int* iParam0, bool bParam1)//Position - 0x33EA8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_411()//Position - 0x33F74
{
	...
	if (iLocal_440)
	{
		...
		{
			iVar0 = (iLocal_438 - MISC::GET_GAME_TIMER());
			if (iVar0 < 0)
			{
				iVar0 = 0;
			}
...
int func_414(int iParam0, int iParam1)//Position - 0x3416E
{
	return BitTest(Global_1675211.f_7064[iParam0], iParam1);
}

int func_415(int iParam0)//Position - 0x34184
{
	if (iParam0 == 1)
	{
		if (Global_21066.f_1 > 3)
...
void func_416(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x341DB
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_79794 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_418(Global_79795, Global_79797, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_417(char* sParam0)//Position - 0x344C0
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_419(iVar2), 8);
					break;
			}
			break;
...
int func_427(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x348A1
{
	if (((!func_429(0) || Global_79810) || Global_79798 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_79794)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_415(0)) || func_428(1))
			{
			}
			else
			{
...
int func_429(int iParam0)//Position - 0x349E2
{
	if (Global_44181 == 15)
	{
		return 0;
...
bool func_430(int iParam0)//Position - 0x34A04
{
	return func_431(iParam0, Global_44181);
}

int func_431(int iParam0, int iParam1)//Position - 0x34A15
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_432()//Position - 0x34BF6
{
	if (func_208(Local_143.f_4))
	{
		VEHICLE::SET_VEHICLE_STRONG(Local_143.f_4, true);
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_143.f_4, true);
		VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_143.f_4, false);
		VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_143.f_4, false);
		if (!bLocal_150)
		{
			VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_143.f_4);
		}
		func_433(Local_143.f_4, 0);
	}
}
...
int func_436(bool bParam0)//Position - 0x34C7C
{
...
void func_439(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x34D14
{
	int iVar0;
...
int func_440(int iParam0)//Position - 0x34DBE
{
	if (func_208(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_441(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x34DDE
{
	if (bParam0)
	{
...
int func_445(var uParam0)//Position - 0x34FE1
{
	int iVar0;
...
int func_446(int iParam0)//Position - 0x35003
{
...
int func_448(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x35050
{
	int iVar0;
...
{
	if (Local_165[iParam0 /*3*/] == -1)
	{
	}
	else
	{
		Local_165[iParam0 /*3*/].f_1 = Local_165[iParam0 /*3*/];
	}
}
...
void func_454(bool bParam0)//Position - 0x35248
{
	...
	while (iLocal_248 <= 1)
	{
		...
		if (bParam0)
		{
			Local_184[iLocal_248 /*29*/].f_26 = 0;
			Local_184[iLocal_248 /*29*/].f_27 = 0;
			Local_184[iLocal_248 /*29*/].f_28 = 0;
			Local_184[iLocal_248 /*29*/].f_24 = 0;
			if (!iLocal_243)
			{
				STREAMING::REQUEST_MODEL(iLocal_245);
				STREAMING::REQUEST_MODEL(iLocal_244);
			}
			iLocal_243 = 1;
		}
		else
		{
			Local_184[iLocal_248 /*29*/].f_26 = 1;
			Local_184[iLocal_248 /*29*/].f_27 = 1;
			Local_184[iLocal_248 /*29*/].f_28 = 1;
			Local_184[iLocal_248 /*29*/].f_24 = 4;
			if (iLocal_243)
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_245);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_244);
...
void func_455(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x352FD
{
	STREAMING::REQUEST_MODEL(Local_143.f_5);
	STREAMING::REQUEST_MODEL(iLocal_157);
	while (!STREAMING::HAS_MODEL_LOADED(Local_143.f_5) || !STREAMING::HAS_MODEL_LOADED(iLocal_157))
	{
		SYSTEM::WAIT(0);
	}
	if (func_208(Local_143.f_4))
	{
		if (bLocal_150)
		{
			VEHICLE::REMOVE_VEHICLE_UPSIDEDOWN_CHECK(Local_143.f_4);
			bLocal_150 = false;
		}
	}
	if (bParam4)
	...
	func_210(&iLocal_153);
	func_207(&(Local_143.f_4));
	Local_143.f_4 = VEHICLE::CREATE_VEHICLE(Local_143.f_5, Param0, fParam3, true, true, false);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_143.f_4, 1);
	if (bParam4)
	{
		func_456(PLAYER::PLAYER_PED_ID(), Local_143.f_4, -1, 0);
	}
	VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_143.f_4, false);
	VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_143.f_4, false);
	VEHICLE::SET_VEHICLE_STRONG(Local_143.f_4, true);
	VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_143.f_4, true);
	VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_143.f_4);
	VEHICLE::SET_VEHICLE_EXTRA(Local_143.f_4, 1, true);
	VEHICLE::SET_VEHICLE_EXTRA(Local_143.f_4, 2, true);
	VEHICLE::SET_VEHICLE_EXTRA(Local_143.f_4, 3, true);
	iLocal_153 = OBJECT::CREATE_OBJECT(iLocal_157, Param0, true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_153, Local_143.f_4, 0, Local_154, 0f, 0f, 0f, false, false, true, false, 2, true, 0);
	ENTITY::SET_ENTITY_COLLISION(iLocal_153, true, false);
	bLocal_150 = true;
	func_433(Local_143.f_4, 0);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_143.f_5);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_157);
}

void func_456(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x35442
{
	if (func_440(iParam0))
	{
		if (func_208(iParam1))
...
void func_459(bool bParam0)//Position - 0x3556D
{
	...
	if (bParam0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(Local_143.f_4))
		{
			func_455(Local_143, Local_143.f_3, 0);
		}
		while (!HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			SYSTEM::WAIT(0);
	...
	{
		func_455(Local_143, Local_143.f_3, 1);
	}
	iLocal_437 = 1;
	iLocal_440 = 1;
}
...
{
	Local_165[iParam0 /*3*/].f_1 = iParam1;
}

void func_461(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x3563A
{
	if (func_463())
	{
...
void func_464()//Position - 0x3571D
{
	...
	Local_143.f_5 = joaat("dloader");
	Local_143 = { 1199.8f, -1259.22f, 34.23f };
	Local_143.f_3 = 174.7f;
	if (func_208(PLAYER::PLAYER_PED_ID()))
	{
		func_242(&uLocal_249, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	iLocal_430 = 0;
	iLocal_441 = 0;
	iLocal_424 = 0;
	...
	sLocal_447 = "DEFAULT" /* GXT: _ */;
	func_465(49, 1, 0);
	iLocal_162[0] = PED::ADD_SCENARIO_BLOCKING_AREA(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, false, true, true, true, 1);
	iLocal_162[1] = PED::ADD_SCENARIO_BLOCKING_AREA(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, false, true, true, true, 1);
	PATHFIND::SET_GPS_DISABLED_ZONE(-1132.88f, -1262.01f, 0f, -1102.43f, -1196.58f, 15f);
	PED::SET_CREATE_RANDOM_COPS(false);
}

void func_465(int iParam0, int iParam1, bool bParam2)//Position - 0x3582F
{
	int iVar0;
...
struct<4> func_467(int iParam0)//Position - 0x35A28
{
	return Global_2201[iParam0 /*29*/].f_3;
}

int func_468(int iParam0, int iParam1)//Position - 0x35A3B
{
...
int func_469(int iParam0, int iParam1)//Position - 0x35A65
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_470(int iParam0, int iParam1, int iParam2)//Position - 0x35A8F
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_471(int iParam0, int iParam1, int iParam2)//Position - 0x35AD4
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
{
	Local_184[0 /*29*/].f_3 = { 1195.3f, -1312.74f, 34.75f };
	Local_184[0 /*29*/].f_6 = 282.4f;
	Local_184[0 /*29*/].f_7[0 /*8*/][0 /*3*/] = { 1216.1443f, -1287.0039f, 33.976418f };
	Local_184[0 /*29*/].f_7[0 /*8*/][1 /*3*/] = { 1202.4556f, -1306.0538f, 39.47411f };
	Local_184[0 /*29*/].f_7[0 /*8*/].f_7 = 16.5f;
	Local_184[0 /*29*/].f_7[1 /*8*/][0 /*3*/] = { 1204.858f, -1296.1306f, 33.976418f };
	Local_184[0 /*29*/].f_7[1 /*8*/][1 /*3*/] = { 1198.8319f, -1365.9259f, 39.47705f };
	Local_184[0 /*29*/].f_7[1 /*8*/].f_7 = 37.5f;
	Local_184[0 /*29*/].f_24 = 0;
	Local_184[1 /*29*/].f_3 = { 1162.71f, -1357.86f, 33.73f };
	Local_184[1 /*29*/].f_6 = 266.7f;
	Local_184[1 /*29*/].f_7[0 /*8*/][0 /*3*/] = { 1164.4572f, -1363.8395f, 33.510624f };
	Local_184[1 /*29*/].f_7[0 /*8*/][1 /*3*/] = { 1180.6372f, -1359.837f, 39.113964f };
	Local_184[1 /*29*/].f_7[0 /*8*/].f_7 = 15.5f;
	Local_184[1 /*29*/].f_7[1 /*8*/][0 /*3*/] = { 0f, 0f, 0f };
	Local_184[1 /*29*/].f_7[1 /*8*/][1 /*3*/] = { 0f, 0f, 0f };
	Local_184[1 /*29*/].f_7[1 /*8*/].f_7 = 0f;
	Local_184[1 /*29*/].f_24 = 0;
}

void func_473()//Position - 0x35C91
{
	Local_165[0 /*3*/] = { func_474("B3ADELV", 1) };
	Local_165[1 /*3*/] = { func_474("B3AGETIN", 1) };
	Local_165[2 /*3*/] = { func_474("B3AWAN1", -1) };
	Local_165[3 /*3*/] = { func_474("B3ARTV", 1) };
	Local_165[4 /*3*/] = { func_474("B3AEXIT", 1) };
	Local_165[5 /*3*/] = { func_474("B3ALEAVE", 1) };
}
...
{
	Local_414[0 /*2*/] = "BAR3A_C1";
	Local_414[0 /*2*/].f_1 = 1000;
	Local_414[1 /*2*/] = "BAR3A_W2";
	Local_414[1 /*2*/].f_1 = 19000;
	Local_414[2 /*2*/] = "BAR3A_W1";
	Local_414[2 /*2*/].f_1 = 20000;
	Local_414[3 /*2*/] = "BAR3A_W4";
	Local_414[3 /*2*/].f_1 = 22000;
}
...
void func_476()//Position - 0x35D70
{
	...
	func_477(&Local_79, 1, 0, 0);
	func_405(0);
	PED::SET_CREATE_RANDOM_COPS(true);
	PATHFIND::SET_GPS_DISABLED_ZONE(0f, 0f, 0f, 0f, 0f, 0f);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_162[0], false);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_162[1], false);
	MISC::SET_INSTANCE_PRIORITY_HINT(0);
...
int func_487(char* sParam0, int iParam1, int iParam2)//Position - 0x36064
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_490())
	{
		...
		{
			iVar33 = func_340(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_488()//Position - 0x361F3
{
	...
	iVar0 = func_343(&(Global_101688.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
void func_491(bool bParam0)//Position - 0x362D3
{
...
int func_509(int iParam0)//Position - 0x366E7
{
	if (!func_153(iParam0))
	{
		return func_152(iParam0);
