...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_71(PLAYER::PLAYER_ID()))
		{
			if (func_70())
			{
				func_67(&iLocal_112, -271.6364f, 289.377f, 103.994f, 63, "MSG_BLP_EL" /* GXT: Elevator */, 1065353216, 1, 0);
			}
			else
			{
				func_66(&iLocal_112);
...
void func_1(var uParam0)//Position - 0xFE
{
	int iVar0;
...
void func_2(var uParam0, int iParam1)//Position - 0x179
{
	uParam0->f_13 = iParam1;
}

void func_3(int iParam0)//Position - 0x187
{
	Global_2694553 = iParam0;
	Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_855 = iParam0;
}

void func_4(var uParam0)//Position - 0x1A5
{
	if (uParam0->f_6 != -1)
	{
		func_5(&(uParam0->f_6));
...
void func_5(var uParam0)//Position - 0x1C7
{
	int iVar0;
...
int func_6(int iParam0)//Position - 0x21E
{
	int iVar0;
...
void func_7(var uParam0)//Position - 0x259
{
	char* sVar0;
	char* sVar1;
	struct<3> Var2;
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			if (func_56(PLAYER::PLAYER_PED_ID(), &(uParam0->f_16[uParam0->f_9 /*14*/])) && func_55(PLAYER::PLAYER_PED_ID(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13))
			{
				...
				else if (uParam0->f_6 == -1)
				{
					...
					{
						if (func_44(uParam0->f_9) && !Global_262145.f_27071 /* Tunable: VC_PENTHOUSE_DISABLE_DCTL */)
						{
		...
		case 4:
			...
			Var2 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_38(uParam0), func_37(uParam0), 0f, 2) };
			Var3 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_38(uParam0), func_37(uParam0), 0f, 2) };
			fVar4 = Var3.f_2;
			fVar5 = 0.05f;
		...
		case 5:
			...
			Var7 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_38(uParam0), func_37(uParam0), 0f, 2) };
			fVar8 = Var7.f_2;
			if ((iVar6 != 1 && iVar6 != 0) || func_24(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), fVar8, 5f))
			{
				...
				PAD::DISABLE_CONTROL_ACTION(0 /*PLAYER_CONTROL*/, 0 /*INPUT_NEXT_CAMERA*/, true);
				uParam0->f_8 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_38(uParam0), func_37(uParam0), 2, true, false, 1f, 0f, 1.12f);
...
void func_8(var uParam0, bool bParam1)//Position - 0x7EC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_9(var uParam0)//Position - 0x90B
{
	int iVar0;
...
int func_12(int iParam0)//Position - 0x9C1
{
	switch (iParam0)
	{
		case 0:
...
int func_13(bool bParam0, int iParam1, int iParam2)//Position - 0xA02
{
	if (bParam0)
	{
		return iParam1;
...
void func_14(var uParam0)//Position - 0xA19
{
	...
	if (uParam0->f_13 == 6)
	{
		...
		else
		{
			...
			if (((((!HUD::IS_PAUSE_MENU_ACTIVE() && !func_23(&(uParam0->f_7), 0)) && !func_23(&(uParam0->f_7), 4)) && !func_17()) && !func_15(1)) && uParam0->f_1.f_3 != 3)
			{
				if (uParam0->f_6 == -1)
				{
...
int func_15(bool bParam0)//Position - 0xC2D
{
...
int func_16(int iParam0)//Position - 0xD18
{
	int iVar0;
...
bool func_18(var uParam0)//Position - 0xD8F
{
	return func_23(&(uParam0->f_7), 9);
}

void func_19(var uParam0)//Position - 0xDA1
{
	char* sVar0;
	char* sVar1;
...
void func_20(var uParam0)//Position - 0xE54
{
	char* sVar0;
...
var func_21()//Position - 0xEBE
{
	return BitTest(Global_1950108.f_3, 25);
}

void func_22(int* iParam0, int iParam1)//Position - 0xECF
{
	MISC::SET_BIT(iParam0, iParam1);
}

bool func_23(var uParam0, int iParam1)//Position - 0xEDF
{
	return BitTest(*uParam0, iParam1);
}

int func_24(float fParam0, float fParam1, float fParam2)//Position - 0xEED
{
	float fVar0;
	float fVar1;
...
void func_25(var uParam0)//Position - 0xF73
{
	int iVar0;
...
void func_26()//Position - 0x1007
{
	Global_23131.f_6 = 1;
}

void func_27(bool bParam0)//Position - 0x1015
{
	if (bParam0)
	{
		if (func_28())
...
bool func_28()//Position - 0x103A
{
	return BitTest(Global_2683862.f_2, 11);
}

void func_29()//Position - 0x104B
{
	MISC::SET_BIT(&Global_8254, 4);
}

void func_30(int iParam0)//Position - 0x105B
{
	if (func_36())
	{
		return;
...
void func_31(int iParam0)//Position - 0x108E
{
	if (func_36())
	{
		return;
...
void func_33(bool bParam0, bool bParam1)//Position - 0x113F
{
	if (bParam0)
	{
		if (func_35(0))
...
bool func_34()//Position - 0x11B3
{
	return BitTest(Global_1962996, 5);
}

int func_35(int iParam0)//Position - 0x11C1
{
	if (iParam0 == 1)
	{
...
bool func_36()//Position - 0x1218
{
	return BitTest(Global_1962996, 19);
}

Vector3 func_37(var uParam0)//Position - 0x1227
{
	struct<3> Var0;
...
Vector3 func_38(var uParam0)//Position - 0x1263
{
	return uParam0->f_16[uParam0->f_9 /*14*/];
}

void func_39(var uParam0, char* sParam1)//Position - 0x1277
{
	if (uParam0->f_1.f_1 == 1)
	{
		if (func_10())
...
void func_40(var uParam0, char* sParam1)//Position - 0x15AC
{
...
void func_41(var uParam0)//Position - 0x1836
{
...
int func_42(var uParam0)//Position - 0x186E
{
	int iVar0;
	
	iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(0, func_12(uParam0->f_1.f_1));
	if (uParam0->f_1.f_1 == 1)
	{
		if (func_10())
		{
...
int func_43(int iParam0)//Position - 0x1906
{
	switch (iParam0)
	{
		case 1:
...
int func_44(int iParam0)//Position - 0x1934
{
	switch (iParam0)
	{
		case 2:
...
void func_45(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x1972
{
	int iVar0;
...
bool func_46(int iParam0)//Position - 0x1A9D
{
	return func_47(iParam0) == joaat("WEAPON_MINIGUN");
}

int func_47(int iParam0)//Position - 0x1AB1
{
...
int func_49(var uParam0)//Position - 0x1AEF
{
	var uVar0[10];
	int iVar1;
	...
	while (iVar1 < 10)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar1]) && !PED::IS_PED_INJURED(uVar0[iVar1])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar1])) && func_56(uVar0[iVar1], &(uParam0->f_16[uParam0->f_9 /*14*/])))
		{
			return 1;
		}
		iVar1++;
...
int func_50(var uParam0)//Position - 0x1B66
{
	int iVar0;
	int iVar1;
...
int func_51(int iParam0)//Position - 0x1BE0
{
	if (iParam0 != func_52())
	{
...
int func_52()//Position - 0x1C01
{
	return -1;
}

int func_53(int iParam0, bool bParam1, bool bParam2)//Position - 0x1C0A
{
	int iVar0;
...
bool func_54(var uParam0)//Position - 0x1C6A
{
	return uParam0->f_7 & 31 > 0;
}

int func_55(int iParam0, struct<3> Param1, int iParam2)//Position - 0x1C7B
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (iParam2 == 3)
		{
			if (func_24(ENTITY::GET_ENTITY_HEADING(iParam0), (Param1.f_2 - 180f), 45f))
			{
				return 1;
			}
		}
		else if (func_24(ENTITY::GET_ENTITY_HEADING(iParam0), Param1.f_2, 45f))
		{
			return 1;
		}
	}
...
int func_58(int iParam0)//Position - 0x1D6E
{
	switch (iParam0)
	{
		case 1:
			return Global_1981407 == 3;
		
		case 3:
			return Global_1981407 == 3;
		
		case 4:
			return Global_1981407 == 1;
		
		case 5:
			return Global_1981407 != 2;
...
void func_59(int* iParam0, int iParam1)//Position - 0x1DC9
{
	MISC::CLEAR_BIT(iParam0, iParam1);
}

void func_60(var uParam0)//Position - 0x1DD9
{
	if (uParam0->f_13 == 6)
	{
	}
...
float func_61()//Position - 0x1E2C
{
	return 0.13f;
}

void func_62(var uParam0)//Position - 0x1E39
{
...
void func_63(int* iParam0, int iParam1, bool bParam2)//Position - 0x1E91
{
	int iVar0;
...
bool func_64()//Position - 0x1EB5
{
	return Global_75693;
}

int func_65()//Position - 0x1EC1
{
...
void func_66(int* iParam0)//Position - 0x1ED8
{
...
void func_67(int* iParam0, struct<3> Param1, int iParam2, char* sParam3, float fParam4, bool bParam5, bool bParam6)//Position - 0x1EF8
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
		*iParam0 = func_68(Param1, 0);
		...
		HUD::SET_BLIP_AS_SHORT_RANGE(*iParam0, bParam5);
		if (bParam6)
		{
			HUD::SET_BLIP_COLOUR(*iParam0, 55);
		}
	}
}

int func_68(struct<3> Param0, bool bParam1)//Position - 0x1F51
{
	int iVar0;
...
float func_69(bool bParam0, float fParam1, float fParam2)//Position - 0x1F7D
{
	if (bParam0)
	{
		return fParam1;
...
bool func_70()//Position - 0x1F94
{
	return BitTest(Global_1950108.f_11, 17);
}

int func_71(int iParam0)//Position - 0x1FA5
{
	if (iParam0 != func_52())
	{
		return Global_1853910[iParam0 /*862*/].f_267.f_505 != 0;
	}
	return 0;
}

int func_72()//Position - 0x1FCB
{
	...
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_83(PLAYER::PLAYER_ID()), Global_1950108.f_1029[161 /*3*/], true) >= 150f)
	{
		return 1;
	}
	if (func_75())
...
int func_74()//Position - 0x2050
{
	return Global_1574632.f_18;
}

int func_75()//Position - 0x205E
{
	if (Global_1575035 == 0)
	{
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_78()//Position - 0x2139
{
	return Global_32163;
}

bool func_79()//Position - 0x2144
{
	return Global_2683862.f_698;
}

int func_80(int iParam0)//Position - 0x2153
{
...
bool func_81()//Position - 0x216A
{
	return Global_2694524;
}

bool func_82()//Position - 0x2176
{
	return Global_2683862.f_693;
}

Vector3 func_83(int iParam0)//Position - 0x2185
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_84(int iParam0)//Position - 0x2198
{
	if (iParam0 != func_52())
	{
		...
		else if ((Global_1575060 && iParam0 == PLAYER::PLAYER_ID()) && func_53(iParam0, 1, 0))
		{
			return Global_2657589[iParam0 /*466*/].f_321.f_7 != -1;
		}
	}
...
int func_85(int iParam0)//Position - 0x21FE
{
...
void func_87()//Position - 0x2247
{
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_88(var uParam0)//Position - 0x2253
{
	int iVar0;
...
void func_89(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x22B2
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool func_90(int iParam0)//Position - 0x2740
{
	return iParam0 == 17;
}

void func_91()//Position - 0x274D
{
	struct<3> Var0;
...
int func_93(int iParam0)//Position - 0x27D8
{
	int iVar0;
...
void func_94(bool bParam0, int iParam1, int iParam2)//Position - 0x2809
{
	int iVar0;
	int iVar1;
...
void func_95(int iParam0, bool bParam1)//Position - 0x28D9
{
	int iVar0;
...
bool func_97()//Position - 0x294D
{
	return BitTest(Global_2621446, 3);
}

bool func_98(int iParam0, int iParam1)//Position - 0x295B
{
	bool bVar0;
...
int func_99(int iParam0, bool bParam1)//Position - 0x29A6
{
	int iVar0;
	int iVar1;
...
int func_100()//Position - 0x29E7
{
	return Global_1574918;
}

int func_101()//Position - 0x29F3
{
...
void func_103()//Position - 0x2A52
{
	func_104(0, &uLocal_113, 0, 2);
	func_104(1, &uLocal_113, 1, 1);
	func_104(2, &uLocal_113, 2, 2);
	func_104(3, &uLocal_113, 3, 1);
	func_104(4, &uLocal_113, 4, 2);
	func_104(5, &uLocal_113, 5, 1);
	func_104(6, &uLocal_113, 6, 2);
	func_104(7, &uLocal_113, 7, 1);
}

void func_104(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2AA2
{
	struct<3> Var0;
	float fVar1;
	...
	uParam1->f_16[iParam2 /*14*/].f_6.f_1 = { func_106(func_107(), fVar1) + Var0 };
	uParam1->f_16[iParam2 /*14*/].f_6.f_4 = { func_106(func_105(), fVar1) + Var0 };
	uParam1->f_16[iParam2 /*14*/].f_6 = fLocal_95;
}

Vector3 func_105()//Position - 0x2B24
{
	return 0.4f, -0.5f, 2f;
}

Vector3 func_106(struct<3> Param0, float fParam1)//Position - 0x2B37
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
Vector3 func_107()//Position - 0x2B7B
{
	return -0.4f, -0.5f, 0f;
}

void func_108(int iParam0, var uParam1, var uParam2)//Position - 0x2B8E
{
	switch (iParam0)
	{
		case 0:
...
void func_109()//Position - 0x2CB5
{
}

int func_110(int iParam0, int iParam1, bool bParam2)//Position - 0x2CBD
{
	int iVar0;
...
bool func_111(bool bParam0)//Position - 0x2DD3
{
	if (bParam0)
	{
	}
