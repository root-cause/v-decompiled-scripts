...
void __EntryFunction__()//Position - 0x0
{
	...
	if (!func_291(&iVar64, &Var0, Var61, 1f))
	{
		func_290();
	...
	if (Var0.f_0 == 27)
	{
		func_260(&uLocal_97, 5, Var0.f_28[0], "JOSH", 0, 1);
	}
	else if (Var0.f_0 == 30)
	{
		func_260(&uLocal_97, 4, Var0.f_28[0], "JOSH", 0, 1);
		func_260(&uLocal_97, 3, Var0.f_28[1], "JOSHCOP", 0, 1);
	...
	while (true)
	{
		...
		func_220(Var0.f_0);
		func_213(&iLocal_95, &(Var0.f_9), Var61);
		if (Var0.f_0 == 27)
		{
			func_211(&Var0, Var61, "JOSH1AU", "JOSH1_AMB1", 5, "JOSH", 5000, 14f);
		}
		else if (Var0.f_0 == 28)
		{
			func_211(&Var0, Var61, "JOSH2AU", "JOSH2_AMB", 5, "JOSH", 5000, 1101004800);
		}
		else if (Var0.f_0 == 29)
		{
			func_211(&Var0, Var61, "JOSH3AU", "JOSH3_AMB", 3, "JOSH", 5000, 1101004800);
		}
		else if (Var0.f_0 == 30)
		{
			if (iLocal_265 == 0)
...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5E03
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x65C6
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A8D
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_84(struct<3> Param0, float fParam3)//Position - 0x774A
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_174(struct<3> Param0, bool bParam3)//Position - 0xC103
{
	int iVar0;
...
void func_197()//Position - 0xD5C3
{
	switch (iLocal_96)
	{
		...
		case 1:
			...
			{
				if (func_198(&uLocal_97, "JOSH4AU", "JOSH4_AMB", 8, 0, 0, 0))
				{
					iLocal_96 = 2;
				}
			}
...
int func_211(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xDD3E
{
	var uVar0;
	
	if ((((func_210(PLAYER::PLAYER_PED_ID()) && func_210(iParam0->f_28[0])) && !func_150()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_222(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_260(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
		func_212(&uVar0, cParam4, sParam5, 7, 0, 0);
...
float func_222(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xE1B8
{
	struct<3> Var0;
...
bool func_236(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF0B2
{
	...
	uVar0 = func_237(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_237(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xF173
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_241(struct<3> Param0, struct<3> Param3)//Position - 0xF43F
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_249(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF7BD
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_263(int* iParam0, bool bParam1)//Position - 0x1002E
{
	...
	func_264(iParam0, iLocal_93, Var0, fVar3);
...
void func_264(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x100A2
{
	func_265(iParam0);
...
void func_266(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x10180
{
	func_267(iParam0);
...
int func_268(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x101E2
{
	if (func_269(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_269(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x1023E
{
	int iVar0;
...
{
	func_264(iParam0, iLocal_93, 558.09f, -1765.39f, 28.86f, 335.3252f);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*iParam0, 4);
...
int func_291(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10EEB
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_292((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_292((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_292(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10F50
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_293(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_293(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10FC8
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
