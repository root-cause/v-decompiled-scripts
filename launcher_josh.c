...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		func_317("Force cleanup [TERMINATING]");
		if (Var0.f_0 != -1)
		{
			if (Global_112897[Var0.f_0 /*10*/].f_9 != -1)
			{
				func_317("Relinquishing candidate id...");
				func_316(&(Global_112897[Var0.f_0 /*10*/].f_9));
			}
		}
		func_299(&Var0, 1);
	}
	if (!func_296(&iVar64, &Var0, Var61, 1f))
	{
		func_295();
		func_317("SCRIPT TERMINATED");
	...
	while (!func_266(&Var0))
	{
		...
		{
			func_317("Player out of range [TERMINATING]");
			func_299(&Var0, 1);
		}
	}
	...
	if (Var0.f_0 == 27)
	{
		func_265(&uLocal_95, 5, Var0.f_28[0], "JOSH", 0, 1);
	}
	else if (Var0.f_0 == 30)
	{
		func_265(&uLocal_95, 4, Var0.f_28[0], "JOSH", 0, 1);
		func_265(&uLocal_95, 3, Var0.f_28[1], "JOSHCOP", 0, 1);
	...
	while (true)
	{
		...
		if (!func_228(&Var0, 1))
		{
			if (Var0.f_0 == 30)
			{
				if (func_227(PLAYER::PLAYER_PED_ID(), -1102.7241f, 290.1463f, 63.23002f, 1) < 200f)
				{
					PLAYER::SET_PLAYER_WANTED_LEVEL_NO_DROP(PLAYER::PLAYER_ID(), 1, false);
					func_226(&Var0);
					func_317("Making Josh cops attack");
				}
			}
			func_299(&Var0, 1);
		}
		func_225(Var0.f_0);
		func_218(&iLocal_93, &(Var0.f_9), Var61);
		if (Var0.f_0 == 27)
		{
			func_216(&Var0, Var61, "JOSH1AU", "JOSH1_AMB1", 5, "JOSH", 5000, 14f);
		}
		else if (Var0.f_0 == 28)
		{
			func_216(&Var0, Var61, "JOSH2AU", "JOSH2_AMB", 5, "JOSH", 5000, 1101004800);
		}
		else if (Var0.f_0 == 29)
		{
			func_216(&Var0, Var61, "JOSH3AU", "JOSH3_AMB", 3, "JOSH", 5000, 1101004800);
		}
		else if (Var0.f_0 == 30)
		{
			if (iLocal_263 == 0)
			{
				...
				{
					if (func_215(Var0.f_28[1]))
					{
						func_317("Josh 4: Trying to set Cop 1 component variation");
						CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Cop_standing_idle", Var0.f_28[1], 0);
					}
					if (func_215(Var0.f_28[2]))
					{
						func_317("Josh 4: Trying to set Cop 2 component variation");
		...
		if (((func_187(&Var0, 0) || func_186(&Var0)) || func_184(&Var0)) || func_182(&Var0))
		{
			if (func_181(Var0.f_0))
			{
				func_178(Var0.f_0, &iLocal_262);
			}
			if (!func_2(&Var0))
			{
				func_299(&Var0, 1);
...
int func_2(int iParam0)//Position - 0x3D4
{
	...
	if (!func_177())
	{
		while (!func_168(*iParam0))
		{
			...
			{
				func_317("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			SYSTEM::WAIT(0);
		}
	...
	if (!func_122(iParam0))
	{
		func_317("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
int func_64(int iParam0, int iParam1)//Position - 0x497C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5E67
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x662A
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x6671
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x66DC
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_76()//Position - 0x6AE4
{
	return Global_32283;
}

int func_77(int iParam0)//Position - 0x6AEF
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6AFF
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6BA1
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x730C
{
...
int func_81()//Position - 0x7607
{
	return Global_2652364.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x7616
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x7640
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x7655
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x766C
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x76C4
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x776E
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x7803
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x7847
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x79CB
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x79D9
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x84A2
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x8524
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x857C
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x8585
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x87F1
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x8801
{
...
int func_99(int iParam0)//Position - 0x882E
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x8B64
{
	return Global_100885.f_393 > 0;
}

var func_101()//Position - 0x8B75
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8BBB
{
	if (iParam1 <= 0)
	{
		return;
...
void func_103(var uParam0, int iParam1)//Position - 0x8C41
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8C74
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8CC5
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8D67
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8D89
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8DA0
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8DAD
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8DE7
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8E22
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8E5E
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8E77
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8ED0
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8EE6
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8EFC
{
...
int func_117(bool bParam0)//Position - 0x8F3E
{
...
struct<2> func_118(int iParam0)//Position - 0x8F66
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x93B3
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA68B
{
	switch (iParam0)
	{
		case 0:
...
int func_122(var* uParam0)//Position - 0xA9D1
{
	int iVar0;
	...
	if (func_152(&(uParam0->f_1)))
	{
		...
		{
			func_317("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::SET_SCRIPT_CAN_START_CUTSCENE(iVar0);
		}
		else
		{
			func_317("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_123(int iParam0)//Position - 0xAA76
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xAB11
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xAB6F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xABC8
{
...
int func_128(int iParam0)//Position - 0xAC4B
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAC7C
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAC91
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xAD44
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAD5F
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xADAB
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xADF4
{
	if (func_215(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xAE14
{
	switch (iParam0)
	{
		case 5:
...
int func_138(int iParam0)//Position - 0xAEE4
{
	switch (iParam0)
	{
		case 5:
...
void func_139(var uParam0, bool bParam1, bool bParam2)//Position - 0xAF37
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_215(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_215(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_215(uParam0->f_41[iVar0]))
		{
...
int func_140(int iParam0)//Position - 0xB02C
{
	switch (iParam0)
	{
		case 5:
...
void func_141(bool bParam0)//Position - 0xB097
{
	int iVar0;
...
void func_142(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB0D6
{
	if (bParam0)
	{
...
bool func_143()//Position - 0xB223
{
	return BitTest(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_36.f_18, 14);
}

bool func_144(int iParam0, int iParam1)//Position - 0xB23D
{
	bool bVar0;
...
int func_145(int iParam0, bool bParam1)//Position - 0xB296
{
	int iVar0;
	int iVar1;
...
int func_146(var uParam0)//Position - 0xB2D7
{
	int iVar0;
...
int func_147(int iParam0)//Position - 0xB2F9
{
...
bool func_148()//Position - 0xB338
{
	return BitTest(Global_2621446, 3);
}

int func_149(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB346
{
	int iVar0;
...
void func_151(int iParam0)//Position - 0xB3A0
{
	if (iParam0 == 1)
	{
...
int func_152(char* sParam0)//Position - 0xB3C3
{
	...
	func_317("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}

void func_153()//Position - 0xB400
{
	Global_20711 = 0;
	func_154();
}

void func_154()//Position - 0xB410
{
...
int func_158(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB4F6
{
...
void func_159(int iParam0)//Position - 0xB68E
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_161(int iParam0)//Position - 0xB70B
{
	if (func_166())
	{
		return;
...
void func_162(int iParam0)//Position - 0xB73E
{
	if (func_166())
	{
		return;
...
void func_163(bool bParam0, bool bParam1)//Position - 0xB7C8
{
	if (bParam0)
	{
		if (func_165(0))
...
bool func_164()//Position - 0xB83C
{
	return BitTest(Global_1963795, 5);
}

int func_165(int iParam0)//Position - 0xB84A
{
	if (iParam0 == 1)
	{
...
bool func_166()//Position - 0xB8A1
{
	return BitTest(Global_1963795, 19);
}

int func_167(int iParam0)//Position - 0xB8B0
{
...
int func_168(int iParam0)//Position - 0xB8F1
{
	int iVar0;
...
void func_169(int iParam0)//Position - 0xB936
{
...
int func_170(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB968
{
	int iVar0;
...
void func_171(var uParam0, int iParam1)//Position - 0xBA9F
{
	int iVar0;
...
bool func_172(int iParam0)//Position - 0xBAEE
{
	return func_173(iParam0, Global_43377);
}

int func_173(int iParam0, int iParam1)//Position - 0xBAFF
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_174(int iParam0)//Position - 0xBCE0
{
	if (Global_43377 == 15)
	{
		return 0;
...
int func_175()//Position - 0xBD02
{
	return func_176(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_176(char* sParam0, int iParam1)//Position - 0xBD13
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_178(int iParam0, int iParam1)//Position - 0xBD80
{
	switch (iParam0)
	{
		case 0:
...
int func_179(struct<3> Param0, bool bParam3)//Position - 0xC1F0
{
	int iVar0;
...
float func_180(bool bParam0, float fParam1, float fParam2)//Position - 0xC21C
{
	if (bParam0)
	{
		return fParam1;
...
int func_181(int iParam0)//Position - 0xC233
{
	switch (iParam0)
	{
		case 0:
...
int func_182(var uParam0)//Position - 0xC2C2
{
	if (*uParam0 == 30)
	{
		if (func_215(uParam0->f_28[0]))
		{
			if (bLocal_261)
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_183(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], 1) <= 15f)
					{
						func_317("Special launching Josh 4 (not in vehicle)");
						return 1;
					}
				}
				else if (func_183(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], 1) <= 10f)
				{
					func_317("Special launching Josh 4 (in vehicle)");
					return 1;
				}
			}
		}
...
float func_183(int iParam0, int iParam1, bool bParam2)//Position - 0xC341
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_184(var uParam0)//Position - 0xC39F
{
	if (*uParam0 == 29)
	{
		if (func_227(PLAYER::PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, 1) < 6f)
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				func_317("Special launching Josh 3");
				return 1;
			}
			else if ((!func_185(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && func_215(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_158(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 1f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_185(int iParam0, int iParam1)//Position - 0xC432
{
	if (func_135(iParam0))
	{
...
int func_186(var uParam0)//Position - 0xC465
{
	if (*uParam0 == 28)
	{
		if (func_227(PLAYER::PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, 1) < 9f)
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				func_317("Special launching Josh 2");
				return 1;
			}
			else if ((!func_185(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && func_215(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_158(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 4f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_187(var uParam0, int iParam1)//Position - 0xC4FC
{
	switch (uParam0->f_16)
	{
		case 0:
			if (*uParam0 == 12)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.6306f, 4699.115f, 35.38089f, 1812.8776f, 4710.457f, 42.053535f, 23.75f, false, true, 0))
				{
					if (func_215(uParam0->f_28[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_193(2))
							{
								if (func_191(uParam0->f_27))
								{
									func_190(uParam0->f_27, *uParam0);
									func_317("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				else if (func_215(uParam0->f_28[0]))
				{
					if (func_189(uParam0))
					{
						if (func_193(2))
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_215(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
					{
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.88849f, 371.9034f, 103.98843f, 241.58984f, 359.64575f, 107.34612f, 1.25f, false, true, 0))
					{
						if (func_193(2))
						{
							...
							{
								func_190(uParam0->f_27, *uParam0);
								func_317("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.9482f, 4143.44f, 42.292946f, 2722.2134f, 4144.5215f, 45.431824f, 10f, false, true, 0))
				{
					if (func_193(2))
					{
						...
						{
							func_190(1, *uParam0);
							func_317("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.11035f, 68.460175f, -1028.5663f, 395.46133f, 94.57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.75565f, 68.02096f, -1021.4514f, 336.34583f, 93.18714f, 14.5f, false, true, 0))
						{
							if (func_193(2))
							{
								...
								{
									func_190(uParam0->f_27, *uParam0);
									func_317("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_188()//Position - 0xCCDF
{
	func_27(&(Global_104373.f_2890), &Global_104373, 0, 1, 1, 0);
}

int func_189(var uParam0)//Position - 0xCCFA
{
	float fVar0;
...
void func_190(int iParam0, int iParam1)//Position - 0xCD88
{
	if (iParam0 == 1)
	{
		if (!func_138(iParam1))
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_317("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_317("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
int func_191(bool bParam0)//Position - 0xCDEC
{
	int iVar0;
...
int func_192(int iParam0)//Position - 0xCE83
{
	if (func_215(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_193(int iParam0)//Position - 0xCEAD
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_201()) || Global_112857) || Global_32286) || func_200()) || func_199(8, -1)) || func_100()) || func_198()) || func_197()) || func_196()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_201()) || Global_32286) || func_200()) || func_199(8, -1)) || func_197()) || func_100()) || func_198()) || func_196()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_201()) || Global_112857) || Global_32286) || func_200()) || func_199(8, -1)) || func_197()) || func_100()) || func_198()) || func_196()) || Global_113810.f_7691.f_919[bVar0] == 5) || Global_43924 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_201()) || Global_112857) || Global_32286) || func_200()) || func_199(8, -1)) || func_100()) || func_198()) || func_196()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_201() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_199(8, -1)) || func_196()) || func_195()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_199(8, -1) || func_100()) || func_198()) || func_195()) || func_194())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_201()) || Global_32286) || func_200()) || func_199(8, -1)) || func_198()) || func_197()) || func_196()) || Global_113810.f_7691.f_919[bVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_201()) || func_198()) || Global_112857) || Global_32286) || func_200()) || Global_44569) || func_199(8, -1)) || func_197()) || func_195()) || func_196()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_201()) || Global_112857) || Global_32286) || func_200()) || func_199(8, -1)) || func_197()) || func_195()) || func_100()) || func_198()) || func_196())
						{
							return 0;
						}
						break;
...
var func_194()//Position - 0xD5CA
{
	return Global_100872.f_1;
}

int func_195()//Position - 0xD5D8
{
	if (Global_97735 != -1)
	{
...
bool func_198()//Position - 0xD63F
{
	return Global_100885.f_394 > 0;
}

bool func_199(int iParam0, int iParam1)//Position - 0xD650
{
	switch (iParam0)
	{
		case 5:
...
var func_200()//Position - 0xD688
{
	return Global_1575063;
}

int func_201()//Position - 0xD694
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_202()//Position - 0xD6B0
{
	switch (iLocal_94)
	{
		...
		case 1:
			if (func_227(PLAYER::PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, 1) <= 20f)
			{
				if (func_203(&uLocal_95, "JOSH4AU", "JOSH4_AMB", 8, 0, 0, 0))
				{
					iLocal_94 = 2;
				}
			}
		...
		case 2:
			if (!func_155())
			{
				...
				iLocal_94 = 0;
				bLocal_261 = true;
				func_317("Josh 4 conversation finished and will not loop");
			}
			else if (func_227(PLAYER::PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, 1) >= 25f)
			{
				func_153();
				bLocal_261 = true;
				iLocal_94 = 0;
...
bool func_203(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD77C
{
...
int func_204(char* sParam0, int iParam1, bool bParam2)//Position - 0xD7CA
{
	Global_21846 = 0;
...
bool func_207(int iParam0)//Position - 0xDB32
{
	return func_208(iParam0, 20);
}

var func_208(int iParam0, int iParam1)//Position - 0xDB42
{
	return BitTest(Global_1895156[iParam0 /*609*/].f_10.f_4, iParam1);
}

void func_209()//Position - 0xDB5A
{
	int iVar0;
...
void func_214(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDDB4
{
...
int func_215(int iParam0)//Position - 0xDE0A
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_216(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xDE2B
{
	var uVar0;
	
	if ((((func_215(PLAYER::PLAYER_PED_ID()) && func_215(iParam0->f_28[0])) && !func_155()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_227(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_265(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
		func_217(&uVar0, cParam4, sParam5, 7, 0, 0);
...
void func_217(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDEB3
{
	func_214(uParam0, 145, sParam1, iParam4, iParam5, 0);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
...
void func_218(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xDEEE
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_227(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_221(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_227(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_223(iParam0);
				}
			}
...
void func_219(int iParam0, bool bParam1)//Position - 0xDFDF
{
	if (iParam0 == -1)
	{
		return;
...
int func_220(int iParam0)//Position - 0xE01B
{
	if (Global_78685 == iParam0)
	{
		if (Global_78686 == -1)
...
void func_221(int iParam0, int iParam1)//Position - 0xE054
{
	bool bVar0;
	int iVar1;
...
bool func_222()//Position - 0xE0F2
{
	return Global_98122;
}

void func_223(int iParam0)//Position - 0xE0FE
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_224(iParam0);
...
void func_224(int iParam0)//Position - 0xE115
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_225(int iParam0)//Position - 0xE1FD
{
	if (iParam0 == -1)
	{
		iParam0 = func_175();
...
void func_226(int iParam0)//Position - 0xE225
{
	int iVar0;
...
float func_227(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xE2A5
{
	struct<3> Var0;
...
int func_228(var uParam0, bool bParam1)//Position - 0xE2DF
{
	struct<27> Var0;
	
	if (Global_78689)
	{
		func_317("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_119(*uParam0, &Var0);
	if ((func_264(*uParam0) || func_262(*uParam0)) || Global_78935 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_317("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_258(*uParam0))
	{
		...
		func_317("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1)
	{
	...
	if (*uParam0 == 10)
	{
		...
		{
			func_317("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_317("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
	if (func_232(&(uParam0->f_48)) && bParam1)
	{
		func_229(uParam0->f_28[0], &(uParam0->f_48), *uParam0);
	}
	return 1;
}

void func_229(int iParam0, var uParam1, int iParam2)//Position - 0xE54F
{
	int iVar0;
	int iVar1;
	...
	if (func_215(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_231(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_230(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_231(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_230(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
int func_230(int iParam0)//Position - 0xE8A7
{
...
int func_231(var uParam0)//Position - 0xE8C7
{
...
int func_232(var uParam0)//Position - 0xE8DF
{
...
void func_233(var uParam0)//Position - 0xE904
{
	int iVar0;
	int iVar1;
	...
	if (*uParam0 == 52)
	{
		func_234(&(uParam0->f_41[1]));
		func_234(&(uParam0->f_41[2]));
	}
	if (func_215(PLAYER::PLAYER_PED_ID()))
	{
		iVar0 = 0;
...
void func_234(int* iParam0)//Position - 0xEC08
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_235(var uParam0, bool bParam1, bool bParam2)//Position - 0xEC33
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_135(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				{
					func_317("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[iVar0], false))
				{
					func_317("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[iVar0], PLAYER::PLAYER_PED_ID(), false))
				{
					func_317("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[iVar0]) < 850)
				{
					func_317("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							func_317("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_192(iVar2))
						{
							...
							{
								if (func_192(uParam0->f_35[iVar0]))
								{
									if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iVar2, uParam0->f_35[iVar0]))
									{
										func_317("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_192(iVar3))
						{
							...
							{
								func_317("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							if (func_236(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
								func_317("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
...
int func_236(int iParam0, int iParam1)//Position - 0xEDF1
{
	int iVar0;
...
int func_237(var uParam0, bool bParam1, int iParam2)//Position - 0xEE21
{
	int iVar0;
	int iVar1;
	...
	if (func_135(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[iVar0]))
						{
							...
							func_317("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[iVar0]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[iVar0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[iVar0]))
					{
						...
						func_317("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[iVar0], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
						{
							...
							func_317("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_256(*uParam0))
					{
						if (!func_167(*uParam0))
						{
							if (func_251(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								...
								func_317("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[iVar0], true), 15f))
						{
							...
							func_317("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_239(uParam0->f_28[iVar0], 1126825984))
						{
							...
							func_317("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_238(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_317("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_317("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_215(uParam0->f_41[0]))
						{
...
int func_238(int iParam0)//Position - 0xF0DD
{
...
int func_239(int iParam0, float fParam1)//Position - 0xF111
{
	float fVar0;
	
	if (func_215(PLAYER::PLAYER_PED_ID()) && func_215(iParam0))
	{
		if (func_250(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_240(int iParam0, float fParam1)//Position - 0xF187
{
	return func_241(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_241(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF19F
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	
	iVar4 = func_249(iParam0, iParam1);
	if (!func_215(iParam0) || !func_215(iParam1))
	{
		if (iVar4 != -1)
		{
			func_248(&(Local_35[iVar4 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_242(&(Local_35[iVar4 /*4*/]), Var1, iParam1, &(Local_35[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar4 /*4*/].f_3) < iParam4);
}

int func_242(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xF260
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_243(int iParam0, int iParam1)//Position - 0xF38C
{
	int iVar0;
...
int func_245(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xF49B
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_247(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_247(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_246(Var3, Var0);
...
float func_246(struct<3> Param0, struct<3> Param3)//Position - 0xF52C
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_247(struct<3> Param0)//Position - 0xF54D
{
	float fVar0;
	float fVar1;
...
void func_248(var uParam0)//Position - 0xF58C
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_249(int iParam0, int iParam1)//Position - 0xF5A7
{
	int iVar0;
...
int func_250(int iParam0)//Position - 0xF5E6
{
...
int func_251(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF60E
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_252(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF709
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_253(int iParam0, float fParam1)//Position - 0xF815
{
	var uVar0;
	struct<3> Var1;
...
int func_254(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF8AA
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_247(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
int func_255(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF938
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_256(int iParam0)//Position - 0xF980
{
...
void func_257(int iParam0)//Position - 0xF9CA
{
	int iVar0;
...
int func_258(int iParam0)//Position - 0xFA67
{
	if (iParam0 == -1)
	{
		iParam0 = func_175();
...
int func_259(int iParam0)//Position - 0xFAFC
{
...
int func_262(int iParam0)//Position - 0xFB7B
{
	if ((func_263() && Global_100833.f_11 == 6) && iParam0 == func_176(&(Global_100833.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_264(int iParam0)//Position - 0xFBED
{
	if (func_117(0))
	{
...
void func_265(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xFC15
{
...
int func_266(int iParam0)//Position - 0xFCB0
{
	switch (*iParam0)
	{
		case 27:
	...
	func_317("Created initial scene");
	return 1;
}

int func_267(var uParam0)//Position - 0xFD25
{
	int iVar0[4];
	int iVar5;
	float fVar6;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_280(&(uParam0->f_48), "rcmjosh4", "beckon_a_josh", 0);
			iLocal_89 = 1;
			break;
		
		case 1:
			if (!func_279(&iVar0) || !func_278(&(uParam0->f_48)))
			{
				return 0;
			}
			if (!func_277(0, 1))
		...
		case 2:
			...
			{
				if (func_273(&(uParam0->f_28[0]), 58, -1103.6f, 290.81f, 64.31f, -99.24f, "JOSH LAUNCHER RC", 1))
				{
			...
			{
				func_271(&(uParam0->f_28[1]), iVar0[2], -1102.92f, 290.12f, 64.28f, 40.46f, 6);
				if (func_215(uParam0->f_28[1]))
				{
			...
			{
				func_271(&(uParam0->f_28[2]), iVar0[2], -1102.73f, 290.91f, 64.28f, 92.06f, 6);
				if (func_215(uParam0->f_28[2]))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_269(&(uParam0->f_35[0]), iVar0[3], -1107.5f, 280.33f, 64.01f, 97.97f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_268(&(uParam0->f_35[1]), 0);
				if (func_192(uParam0->f_35[1]))
				{
...
void func_268(int* iParam0, bool bParam1)//Position - 0x1011E
{
	struct<3> Var0;
	float fVar3;
	...
	func_269(iParam0, iLocal_91, Var0, fVar3);
...
void func_269(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10192
{
	func_270(iParam0);
...
void func_270(int* iParam0)//Position - 0x101D4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_271(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x10270
{
	func_272(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_272(int* iParam0)//Position - 0x10291
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_273(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x102D2
{
	if (func_274(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_274(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x1032E
{
	int iVar0;
...
int func_275(var uParam0, int iParam1)//Position - 0x103BC
{
	int iVar0;
...
int func_276(bool bParam0, bool bParam1)//Position - 0x10402
{
	int iVar0;
...
int func_277(bool bParam0, bool bParam1)//Position - 0x10470
{
	int iVar0;
...
int func_278(var uParam0)//Position - 0x10516
{
	if (func_232(uParam0))
	{
...
int func_279(int iParam0)//Position - 0x10540
{
	int iVar0;
...
void func_280(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x10571
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_281(var uParam0)//Position - 0x105AD
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_279(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh3"))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_273(&(uParam0->f_28[0]), 58, 566.1639f, -1773.8171f, 29f, 14.4f, "JOSH LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
...
void func_282(int* iParam0)//Position - 0x10795
{
	func_269(iParam0, iLocal_91, 558.09f, -1765.39f, 28.86f, 335.3252f);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*iParam0, 4);
...
int func_283(var uParam0)//Position - 0x107DB
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_279(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh2"))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_273(&(uParam0->f_28[0]), 58, 565.3901f, -1772.8378f, 29.80087f, 62.501556f, "JOSH LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
...
int func_284(var uParam0)//Position - 0x109FE
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_280(&(uParam0->f_48), "rcmjosh1", "idle", 0);
			iLocal_89 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_273(&(uParam0->f_28[0]), 58, -1104.72f, 291.02f, 64.39f, 138.35f, "JOSH LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
...
int func_285(bool bParam0, bool bParam1)//Position - 0x10B6B
{
	int iVar0;
...
int func_286(int iParam0)//Position - 0x10BD9
{
	struct<27> Var0;
	bool bVar32;
...
int func_287(int iParam0)//Position - 0x10C2A
{
	char* sVar0;
	
	if (Global_78689)
	{
		func_317("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!Global_113810.f_9088 && !func_117(1))
	{
		func_317("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_288(iParam0))
	{
		Global_112897[iParam0 /*10*/].f_1 = 1;
		func_317("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_100833.f_11 == 6)
	{
		if (Global_100833 < 9)
		{
			...
			{
				func_317("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	...
	{
		Global_112897[iParam0 /*10*/].f_1 = 1;
		func_317("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}

int func_288(int iParam0)//Position - 0x10CE3
{
	var uVar0;
...
int func_289(int iParam0)//Position - 0x10DA4
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_290(int iParam0, char* sParam1)//Position - 0x10E29
{
...
int func_291(int iParam0)//Position - 0x10F0B
{
...
int func_292(int iParam0)//Position - 0x10F36
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_293(int iParam0)//Position - 0x10F61
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_294(int iParam0)//Position - 0x10F8C
{
	if (func_259(iParam0))
	{
		return 0;
...
void func_295()//Position - 0x10FC1
{
	func_317("Running end routines.");
	Global_113528 = (Global_113528 - 1);
}

int func_296(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10FDB
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_297((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_297((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
	...
	func_317("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}

int func_297(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x11040
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_298(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_298(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x110B8
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_299(int iParam0, bool bParam1)//Position - 0x11133
{
	char* sVar0;
	
	if (bParam1)
	{
		func_317("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_306(iParam0, 0, 0, 0);
	}
	if (HUD::DOES_BLIP_EXIST(iLocal_262))
	{
		HUD::REMOVE_BLIP(&iLocal_262);
	}
	func_305(&(iParam0->f_48));
	if (iLocal_93 != -1)
	{
		func_317("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_224(&iLocal_93);
	}
	switch (*iParam0)
	{
...
void func_300(char* sParam0)//Position - 0x111E1
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_303(sParam0))
...
void func_301()//Position - 0x11200
{
	Global_20711 = 0;
	func_302();
}

void func_302()//Position - 0x11210
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22856 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_303(char* sParam0)//Position - 0x11231
{
	struct<6> Var0;
...
struct<6> func_304()//Position - 0x11251
{
	struct<6> Var0;
...
int func_305(var uParam0)//Position - 0x11275
{
	if (func_232(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_306(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x112AB
{
	func_313(uParam0, iParam1);
	func_310(uParam0, bParam2);
	func_307(uParam0, bParam3);
}

void func_307(var uParam0, bool bParam1)//Position - 0x112CB
{
	func_308(&(uParam0->f_41), bParam1);
}

void func_308(var uParam0, bool bParam1)//Position - 0x112DD
{
	int iVar0;
...
void func_309(int* iParam0, bool bParam1)//Position - 0x1131B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_310(var uParam0, bool bParam1)//Position - 0x11356
{
	func_311(&(uParam0->f_35), bParam1);
}

void func_311(var uParam0, bool bParam1)//Position - 0x11368
{
	int iVar0;
...
void func_312(int* iParam0)//Position - 0x113A5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_313(var uParam0, int iParam1)//Position - 0x113DD
{
	func_314(&(uParam0->f_28), iParam1);
}

void func_314(var uParam0, int iParam1)//Position - 0x113EF
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_315(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_315(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x11430
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_316(var uParam0)//Position - 0x11480
{
	if (*uParam0 == -1)
	{
		return;
...
void func_317(char* sParam0)//Position - 0x114BD
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_318(var uParam0)//Position - 0x114CF
{
	*uParam0 = -1;
...
void func_319()//Position - 0x11502
{
	func_317("Running start routines.");
	Global_113528++;
}

int func_320(int iParam0)//Position - 0x1151C
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
