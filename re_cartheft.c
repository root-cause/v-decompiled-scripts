...
int func_146(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x623D
{
	...
	else
	{
		...
		iVar20 = 0;
		func_152(&iVar20);
		iVar21 = func_151(Var10, Global_114370.f_7691.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_149(Global_114370.f_7691.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_147(Global_114370.f_7691.f_765[iVar20 /*10*/]))
				{
					Global_114370.f_7691.f_765[iVar20 /*10*/] = { Var10 };
					func_148(&Var10);
					return 1;
...
void func_152(int iParam0)//Position - 0x6511
{
	...
	*iParam0 = 0;
	...
	{
		if (func_151(Global_114370.f_7691.f_765[iVar0 /*10*/], Global_114370.f_7691.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
int func_160(int iParam0)//Position - 0x6B4A
{
	if (func_163())
	{
		...
		if (iParam0 && func_134(Global_114359))
		{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_230()) || Global_32831) || func_229()) || func_62(8, -1)) || func_226()) || func_228()) || func_227()) || func_225()) || Global_114370.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_230()) || Global_113417) || Global_32831) || func_229()) || func_62(8, -1)) || func_226()) || func_228()) || func_227()) || func_225()) || Global_114370.f_7691.f_919[iVar0] == 5) || Global_44469 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_230()) || Global_113417) || Global_32831) || func_229()) || func_62(8, -1)) || func_228()) || func_227()) || func_225()) || Global_114370.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_230() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_62(8, -1)) || func_225()) || func_224()) || Global_114370.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
