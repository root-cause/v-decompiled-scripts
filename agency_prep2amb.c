...
void __EntryFunction__()//Position - 0x0
{
	...
	if (!func_281(32))
	{
		...
		if (iLocal_37 == 2)
		{
			...
			Local_52 = { func_280(25) };
			fLocal_53 = func_279(25);
			if (func_278(&Local_54, 25))
			{
...
void func_21(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x9BA
{
	struct<60> Var0;
...
void func_58(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x69DD
{
	if (func_54(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
...
bool func_78(int iParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x7525
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), Param1) <= (fParam2 * fParam2);
}

bool func_79(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x7543
{
	if (bParam2)
	{
...
{
	if ((BitTest(uLocal_49, 0) && Global_43257 == 15) && !func_210())
	{
		if (iLocal_38 == 0)
		{
			if (!BitTest(uLocal_49, 1) && BitTest(uLocal_49, 0))
			{
				if (!func_78(PLAYER::PLAYER_PED_ID(), Local_50, 5f, 1))
				{
					...
					{
						if ((func_252(PLAYER::PLAYER_PED_ID()) && !BitTest(uLocal_47[0], 17)) && !BitTest(uLocal_47[1], 18))
						{
...
int func_186()//Position - 0xB8E2
{
	...
	while (iVar1 <= 4)
	{
		if (func_252(uVar0[iVar1]) && uVar0[iVar1] != PLAYER::PLAYER_PED_ID())
		{
...
int func_190(struct<3> Param0, bool bParam1)//Position - 0xBA0C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_192(struct<3> Param0, bool bParam1)//Position - 0xBABB
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_194(struct<3> Param0, struct<3> Param1)//Position - 0xBBBE
{
	float fVar0;
...
int func_196(struct<3> Param0, int iParam1)//Position - 0xC256
{
	float fVar0;
...
int func_205(struct<3> Param0, int iParam1, int iParam2)//Position - 0xCC8E
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_226()//Position - 0xD636
{
	...
	if (((((((Global_43257 == 15 && iLocal_37 != 3) && BitTest(uLocal_49, 5)) && !func_210()) && Global_78555 == -1) && !func_236()) && !func_86(9)) || func_105(35))
	{
		func_235();
		func_233();
		switch (iLocal_39)
...
void func_261()//Position - 0xE96B
{
	...
	sLocal_45[7] = func_262(7);
	sLocal_45[8] = func_262(8);
	sLocal_45[9] = "PRC_USEFIRST";
	sLocal_45[10] = func_262(10);
	sLocal_45[11] = func_262(11);
	sLocal_45[13] = func_262(13);
	sLocal_45[12] = func_262(12);
	sLocal_45[14] = "PRC_UNUSE";
	sLocal_45[15] = "PRC_SEATS";
	sLocal_45[16] = "PRC_CBOBVAL";
	sLocal_45[17] = func_262(17);
	sLocal_45[18] = func_262(18);
	sLocal_45[20] = func_262(20);
...
struct<8> func_264(char* sParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x1004D
{
	struct<8> Var0;
