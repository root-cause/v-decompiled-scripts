...
void __EntryFunction__()//Position - 0x0
{
	...
	if (!func_281(32))
	{
		...
		if (iLocal_37 == 2)
		{
			MISC::SET_BIT(&uLocal_105, 10);
			Local_110 = { func_280(25) };
			fLocal_113 = func_279(25);
			if (func_278(&Local_114, 25))
			{
				if (!BitTest(uLocal_105, 14))
				{
					MISC::SET_BIT(&uLocal_105, 14);
				}
			}
		}
	}
...
void func_1(int iParam0, bool bParam1)//Position - 0x1D1
{
	...
	if (bParam1)
	{
		if (iParam0 != 46)
		{
			...
			{
				MISC::SET_BIT(&uLocal_105, 15);
				HUD::CLEAR_HELP(true);
			}
		}
		else if ((HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !Global_112288) && !BitTest(uLocal_105, 15))
		{
			MISC::SET_BIT(&uLocal_105, 15);
			HUD::CLEAR_HELP(true);
		}
...
void func_4(bool bParam0)//Position - 0x28F
{
	...
	MISC::CLEAR_BIT(&(uLocal_101[func_5(bParam0)]), iVar0);
}
...
void func_17()//Position - 0x743
{
	...
	if (!BitTest(uLocal_105, 2))
	{
		...
		{
			if (func_78(PLAYER::PLAYER_PED_ID(), Local_110, 100f, 1) && !func_77())
			{
			...
			{
				if (!func_78(PLAYER::PLAYER_PED_ID(), Local_110, 100f, 1))
				{
				}
			}
		}
...
int func_26(int iParam0, bool bParam1, int iParam2)//Position - 0x108B
{
	int iVar0;
	struct<2> Var1;
...
int func_27(int iParam0)//Position - 0x120D
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_29(int iParam0, int iParam1)//Position - 0x12EA
{
	int iVar0;
	int iVar1;
...
bool func_30()//Position - 0x491A
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_31()//Position - 0x4930
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_32()//Position - 0x4946
{
	return 0;
}

int func_33()//Position - 0x494F
{
	return 1;
}

int func_34()//Position - 0x4958
{
	return 1;
}

int func_35()//Position - 0x4961
{
...
int func_37(int iParam0)//Position - 0x4A32
{
	int iVar0;
	char* sVar1;
...
int func_38(int iParam0)//Position - 0x4A79
{
	int iVar0;
...
int func_39(int iParam0)//Position - 0x4AB4
{
	int iVar0;
...
int func_40(int iParam0)//Position - 0x4B30
{
	int iVar0;
...
int func_41(int iParam0, int iParam1, bool bParam2)//Position - 0x4C18
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_42(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x4C86
{
...
void func_44(var uParam0, int iParam1)//Position - 0x4DA3
{
	if (iParam1 <= 0)
	{
		return;
...
void func_45(var uParam0, int iParam1)//Position - 0x4E29
{
...
void func_46(var uParam0, int iParam1)//Position - 0x4E5C
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1)//Position - 0x4EAD
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_48(int iParam0)//Position - 0x4F4F
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_49(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_49(bool bParam0, int iParam1, int iParam2)//Position - 0x4F71
{
	if (bParam0)
	{
		return iParam1;
...
int func_50(var uParam0)//Position - 0x4F88
{
	return uParam0 & 15;
}

void func_51(var uParam0, int iParam1)//Position - 0x4F95
{
...
void func_52(var uParam0, int iParam1)//Position - 0x4FCF
{
...
void func_53(var uParam0, int iParam1)//Position - 0x500A
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_54(var uParam0, int iParam1)//Position - 0x5046
{
	int iVar0;
	int iVar1;
...
int func_55(int iParam0, int iParam1)//Position - 0x6733
{
	struct<82> Var0;
...
void func_56(int iParam0, var uParam1, int iParam2)//Position - 0x6775
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x69D1
{
	return iParam0 < 3;
}

void func_58(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x69DD
{
	if (func_54(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
...
void func_59(int iParam0, bool bParam1)//Position - 0x6AD6
{
	if (iParam0 == -1)
	{
		return;
...
void func_60(int iParam0, int iParam1, bool bParam2)//Position - 0x6B33
{
	if (iParam0 == -1)
	{
		return;
...
void func_61(var uParam0, var uParam1)//Position - 0x6B6E
{
...
void func_62(int iParam0)//Position - 0x6C3A
{
	if (iParam0 == -1)
	{
		return;
...
int func_63(int iParam0)//Position - 0x6CB1
{
	int iVar0;
...
void func_64(int iParam0, var uParam1)//Position - 0x6D14
{
	int iVar0;
...
int func_65(int iParam0)//Position - 0x6FBF
{
	switch (iParam0)
	{
		case 1:
...
int func_66(int iParam0, var uParam1, var uParam2)//Position - 0x706F
{
	int iVar0;
	int iVar1;
...
int func_67(int iParam0)//Position - 0x7262
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_68(var uParam0)//Position - 0x7282
{
	int iVar0;
...
void func_69(int iParam0)//Position - 0x7331
{
...
void func_70(bool bParam0)//Position - 0x7358
{
	if (BitTest(uLocal_105, 14))
	{
		...
		iLocal_40 = 0;
		iLocal_41 = 0;
		MISC::CLEAR_BIT(&uLocal_105, 6);
		MISC::CLEAR_BIT(&uLocal_105, 7);
		MISC::CLEAR_BIT(&uLocal_105, 0);
		MISC::CLEAR_BIT(&uLocal_105, 1);
		MISC::CLEAR_BIT(&uLocal_105, 8);
		MISC::CLEAR_BIT(&uLocal_105, 12);
		MISC::CLEAR_BIT(&uLocal_105, 2);
		MISC::CLEAR_BIT(&uLocal_105, 14);
		if (iLocal_37 == 4)
		{
			if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_1267))
			{
...
void func_71(int iParam0)//Position - 0x743C
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x745C
{
	int iVar0;
	int iVar1;
...
int func_73(int iParam0)//Position - 0x7499
{
	if (func_57(iParam0))
	{
...
var func_74(int iParam0)//Position - 0x74BE
{
	return Global_2028[iParam0 /*29*/];
}

int func_75(int iParam0, int iParam1)//Position - 0x74CD
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_76(int iParam0)//Position - 0x74ED
{
	if (iParam0 == -1)
	{
		return 0;
...
bool func_78(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x7525
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

bool func_79(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x7543
{
	if (bParam6)
	{
...
void func_80(int iParam0, bool bParam1)//Position - 0x758A
{
...
int func_82(bool bParam0)//Position - 0x75F9
{
...
void func_83(char* sParam0, var uParam1)//Position - 0x7621
{
...
bool func_86(int iParam0)//Position - 0x77B5
{
	return Global_43257 == iParam0;
}

int func_87(int iParam0)//Position - 0x77C3
{
	if (func_88(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_88(int iParam0)//Position - 0x77ED
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_89(int iParam0, int iParam1)//Position - 0x780E
{
...
void func_90(bool bParam0)//Position - 0x784B
{
	char* sVar0;
...
bool func_91()//Position - 0x78BE
{
	func_85();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_92(char* sParam0)//Position - 0x78D7
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_93(int iParam0, int iParam1)//Position - 0x78E9
{
...
void func_94()//Position - 0x792E
{
	...
	if (iLocal_42 == 0)
	{
		...
		if (func_103())
		{
			if (func_259(74) || (func_259(75) && func_102()))
			{
				func_93(46, 1);
			}
		}
...
void func_96(int iParam0, int iParam1, int iParam2)//Position - 0x79C4
{
	bool bVar0;
...
int func_98()//Position - 0x7F68
{
	return Global_32163;
}

int func_99(int iParam0, int iParam1)//Position - 0x7F73
{
	int iVar0;
...
void func_100(int iParam0, bool bParam1, int iParam2)//Position - 0x7FC4
{
	if (iParam2 == -1)
	{
		iParam2 = func_101();
...
int func_101()//Position - 0x7FE2
{
	return Global_1574918;
}

int func_102()//Position - 0x7FEE
{
	if ((func_259(41) && func_259(3)) && func_259(21))
	{
		return 1;
	}
	return 0;
...
int func_104()//Position - 0x8051
{
	if ((func_259(79) && func_259(83)) && func_105(func_106()))
	{
		return 1;
	}
	return 0;
...
int func_105(int iParam0)//Position - 0x807F
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
int func_109(int iParam0, int iParam1)//Position - 0x810A
{
	int iVar0;
	int iVar1;
...
void func_110(int iParam0)//Position - 0x814B
{
	Global_78819 = iParam0;
	Global_78820 = iParam0;
}

void func_111()//Position - 0x815F
{
	struct<6> Var0;
			...
			case 1:
				if (iLocal_42 != 2)
				{
					if (!MISC::IS_STRING_NULL_OR_EMPTY(&Var0))
					{
						...
						else if (BitTest(uLocal_105, 10) && AUDIO::GET_CURRENT_SCRIPTED_CONVERSATION_LINE() == 0)
						{
							func_129("LOCAUD", Local_44.f_7);
							func_128(1);
							iLocal_40 = 2;
...
void func_112(bool bParam0)//Position - 0x82D2
{
	if (bParam0)
	{
...
int func_113(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x8343
{
	struct<15> Var0;
	int iVar15;
...
void func_114(bool bParam0)//Position - 0x8494
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_115(int iParam0)//Position - 0x8552
{
	switch (iParam0)
	{
		case 0:
...
void func_116(int iParam0)//Position - 0x85BC
{
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0x8602
{
...
void func_118(int iParam0, int iParam1, int iParam2)//Position - 0x8647
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_120(struct<6> Param0)//Position - 0x86B1
{
	if (iLocal_42 == 0)
	{
		func_125(Param0);
...
void func_121(struct<6> Param0)//Position - 0x86D8
{
	if (func_103())
	{
		func_122(Param0, 1);
...
void func_122(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)//Position - 0x86FC
{
	struct<4> Var0;
...
struct<4> func_123(bool bParam0)//Position - 0x876C
{
	struct<4> Var0;
...
struct<4> func_124(bool bParam0)//Position - 0x87D6
{
	struct<4> Var0;
...
void func_125(struct<6> Param0)//Position - 0x8840
{
	if (func_103())
	{
		if (func_126())
...
int func_126()//Position - 0x888D
{
	if (iLocal_42 == 0)
	{
		if ((func_259(74) || func_259(74)) && func_102())
		{
			return 1;
		}
	}
...
void func_128(bool bParam0)//Position - 0x88F7
{
...
void func_129(char* sParam0, char* sParam1)//Position - 0x890B
{
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		Global_21782 = 1;
...
struct<6> func_130()//Position - 0x892C
{
	struct<6> Var0;
...
void func_131()//Position - 0x8950
{
	func_132();
}

void func_132()//Position - 0x895C
{
	func_138();
	func_133();
}

void func_133()//Position - 0x896C
{
	if (func_137() == 69)
	{
	...
	else if (func_137() == -1)
	{
		...
		{
			if (!func_78(PLAYER::PLAYER_PED_ID(), Local_106, 5f, 1))
			{
				if (func_135())
				{
...
int func_137()//Position - 0x8A87
{
	return Global_78821;
}

void func_138()//Position - 0x8A93
{
	if (!func_79(Local_110, 0f, 0f, 0f, 0) && func_137() != func_139())
	{
		if (func_78(PLAYER::PLAYER_PED_ID(), Local_110, 60f, 1))
		{
			if (func_87(func_76(25)))
			{
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(func_76(25), true), Local_110) >= 100f)
				{
					func_70(0);
				}
			}
...
void func_140()//Position - 0x8B3F
{
	func_17();
	func_111();
}

void func_141()//Position - 0x8B4F
{
	int iVar0;
...
int func_142(var uParam0)//Position - 0x8BBA
{
	char* sVar0;
...
void func_144(int iParam0, struct<3> Param1)//Position - 0x8C34
{
	int iVar0;
...
bool func_145(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x8C83
{
...
int func_146(char* sParam0, int iParam1, bool bParam2)//Position - 0x8CE2
{
	Global_21726 = 0;
...
bool func_149(int iParam0)//Position - 0x904A
{
	return func_150(iParam0, 20);
}

var func_150(int iParam0, int iParam1)//Position - 0x905A
{
	return BitTest(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

int func_151()//Position - 0x9072
{
	return -1;
}

void func_152()//Position - 0x907B
{
	int iVar0;
...
bool func_158(int iParam0, int iParam1)//Position - 0x92F8
{
	switch (iParam0)
	{
		case 5:
...
void func_160(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x9387
{
...
void func_162(bool bParam0, var uParam1)//Position - 0x93F7
{
	int iVar0;
	...
	func_163(&uLocal_1273, Local_44.f_0, PLAYER::PLAYER_PED_ID(), Local_44.f_1, 0, 1);
	func_163(&uLocal_1273, Local_44.f_2, 0, Local_44.f_3, 0, 1);
	Local_44.f_4 = uParam1;
}

void func_163(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x956D
{
...
void func_164(int iParam0, int iParam1, bool bParam2)//Position - 0x9608
{
	int iVar0;
...
struct<4> func_166(int iParam0)//Position - 0x97F9
{
	return Global_2028[iParam0 /*29*/].f_3;
}

int func_167(int iParam0, int iParam1)//Position - 0x980C
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
int func_168(int iParam0, int iParam1)//Position - 0x9836
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
char* func_171(bool bParam0)//Position - 0xB10E
{
	char* sVar0;
...
int func_174(int iParam0)//Position - 0xB2C6
{
...
int func_175(int iParam0)//Position - 0xB2F6
{
	if (Global_22840 == 0)
	{
		return 0;
...
void func_177()//Position - 0xB375
{
	if ((BitTest(uLocal_105, 0) && Global_43257 == 15) && !func_210())
	{
		if (iLocal_38 == 0)
		{
			if (!BitTest(uLocal_105, 1) && BitTest(uLocal_105, 0))
			{
				if (!func_78(PLAYER::PLAYER_PED_ID(), Local_106, 5f, 1))
				{
					if (BitTest(uLocal_105, 20) || func_135())
					{
						if ((func_252(PLAYER::PLAYER_PED_ID()) && !BitTest(uLocal_101[0], 17)) && !BitTest(uLocal_101[1], 18))
						{
							if (PED::IS_PED_STOPPED(PLAYER::PLAYER_PED_ID()))
							{
								...
								if (BitTest(uLocal_105, 0))
								{
									if (!func_207() && func_187(ENTITY::GET_ENTITY_COORDS(iLocal_109, true)))
									{
					...
					{
						if ((PED::IS_PED_STOPPED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) && !BitTest(uLocal_105, 20))
						{
							if (iLocal_1438 != -1)
							{
								if ((MISC::GET_GAME_TIMER() - iLocal_1438) > 1000)
								{
									MISC::SET_BIT(&uLocal_105, 20);
								}
							}
							else
							{
			...
			{
				if (!func_78(PLAYER::PLAYER_PED_ID(), Local_106, 10f, 1))
				{
					MISC::CLEAR_BIT(&uLocal_105, 1);
				}
...
void func_179(int iParam0)//Position - 0xB601
{
	if (func_182())
	{
		return;
...
void func_180(bool bParam0, bool bParam1)//Position - 0xB68B
{
	if (bParam0)
	{
		if (func_15(0))
...
bool func_181()//Position - 0xB6FF
{
	return BitTest(Global_1962996, 5);
}

bool func_182()//Position - 0xB70D
{
	return BitTest(Global_1962996, 19);
}

int func_183(int iParam0)//Position - 0xB71C
{
	struct<3> Var0;
...
int func_184(int iParam0)//Position - 0xB7D1
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var4;
...
int func_185(struct<3> Param0)//Position - 0xB886
{
	float fVar0;
	float fVar1;
	struct<3> Var2;
...
int func_186()//Position - 0xB8E2
{
	...
	while (iVar6 <= 4)
	{
		if (func_252(uVar0[iVar6]) && uVar0[iVar6] != PLAYER::PLAYER_PED_ID())
		{
...
int func_187(struct<3> Param0)//Position - 0xB94B
{
...
int func_188(struct<3> Param0)//Position - 0xB9A4
{
...
int func_189(struct<3> Param0)//Position - 0xB9D7
{
	float fVar0;
	
	fVar0 = SYSTEM::VDIST2(Param0, Global_95820[func_190(Param0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_190(struct<3> Param0, bool bParam3)//Position - 0xBA0C
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= (7 - 1))
	{
		if (Global_95820[iVar0 /*9*/].f_7 != 263)
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, Global_95820[iVar0 /*9*/].f_3, true);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
int func_191(struct<3> Param0)//Position - 0xBA86
{
	float fVar0;
	
	fVar0 = SYSTEM::VDIST2(Param0, Global_95884[func_192(Param0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_192(struct<3> Param0, bool bParam3)//Position - 0xBABB
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_193(struct<3> Param0)//Position - 0xBB35
{
	struct<3> Var0;
	float fVar3;
...
int func_194(struct<3> Param0, struct<3> Param3)//Position - 0xBBBE
{
	float fVar0;
...
int func_195(struct<3> Param0)//Position - 0xBBE1
{
	if (!func_198(1))
	{
		if (!func_198(0))
...
int func_196(struct<3> Param0, int iParam3)//Position - 0xC256
{
	float fVar0;
...
Vector3 func_197(int iParam0)//Position - 0xC27E
{
	struct<3> Var0;
...
int func_198(int iParam0)//Position - 0xC95B
{
...
int func_200(var uParam0)//Position - 0xCADE
{
...
int func_201(char* sParam0)//Position - 0xCB09
{
	int iVar0;
...
int func_202(struct<3> Param0)//Position - 0xCB55
{
	if (Param0.f_2 < -90f)
	{
		return 1;
...
int func_203()//Position - 0xCBDF
{
	int iVar0;
	float fVar1;
	
	iVar0 = func_205(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 145, 1);
	fVar1 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Global_95719[iVar0 /*10*/].f_3);
	if (fVar1 <= 10000f)
	{
		if (func_13())
		{
...
void func_204(int iParam0)//Position - 0xCC31
{
...
int func_205(struct<3> Param0, int iParam3, int iParam4)//Position - 0xCC8E
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_206(int iParam0)//Position - 0xCD1D
{
	return BitTest(Global_113648.f_7231[iParam0], 0);
}

int func_207()//Position - 0xCD32
{
...
int func_208(float fParam0)//Position - 0xCDCA
{
	if (iLocal_42 == 1)
	{
...
void func_209(bool bParam0, bool bParam1)//Position - 0xCE3C
{
	func_4(bParam0);
...
void func_211()//Position - 0xCEAE
{
	int iVar0;
	int iVar1;
	
	if ((Global_43257 == 15 && iLocal_38 == 0) && !func_210())
	{
		if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			if (!BitTest(uLocal_105, 0))
									...
									if (!DECORATOR::DECOR_EXIST_ON(iVar0, "Getaway_Winched"))
									{
										if (func_215(iVar0) && !func_214())
										{
											if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(iVar0))
											{
												...
												ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_109, true, true);
												MISC::SET_BIT(&uLocal_105, 0);
												MISC::SET_BIT(&uLocal_105, 8);
												MISC::SET_BIT(&uLocal_105, 7);
												return;
											}
											else
											{
...
int func_212(int iParam0)//Position - 0xD188
{
...
int func_213(int iParam0)//Position - 0xD1B9
{
...
int func_215(int iParam0)//Position - 0xD241
{
...
int func_216(int iParam0)//Position - 0xD26B
{
	int iVar0;
...
int func_217(int iParam0)//Position - 0xD28C
{
...
int func_218(int iParam0)//Position - 0xD2B9
{
	int iVar0;
...
int func_219(int iParam0)//Position - 0xD30D
{
	int iVar0;
...
int func_220(int iParam0)//Position - 0xD352
{
	int iVar0;
	...
	while (iVar0 <= 9)
	{
		...
		{
			if (iVar0 == 0 && !func_259(33))
			{
				MISC::SET_BIT(&uLocal_105, 3);
			}
			else if (iVar0 == 1 && !func_259(34))
			{
				MISC::SET_BIT(&uLocal_105, 3);
			}
			else
			{
				MISC::CLEAR_BIT(&uLocal_105, 3);
			}
			return 1;
		}
		iVar0++;
...
int func_222(int iParam0)//Position - 0xD414
{
	if (DECORATOR::DECOR_EXIST_ON(iParam0, "GetawayVehicleValid"))
	{
		return 1;
...
int func_224(var uParam0)//Position - 0xD477
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_226()//Position - 0xD636
{
	int iVar0;
	bool bVar1;
	
	if (((((((Global_43257 == 15 && iLocal_37 != 3) && BitTest(uLocal_105, 5)) && !func_210()) && Global_78555 == -1) && !func_236()) && !func_86(9)) || func_105(35))
	{
		func_235();
		func_233();
		switch (iLocal_39)
		{
			case 0:
				if (BitTest(uLocal_105, 17))
				{
					...
					while (iVar0 < (36 - 1))
					{
						...
						if (iVar0 != 46)
						{
							func_232(uLocal_101[0], &iVar0);
						}
					}
					MISC::CLEAR_BIT(&uLocal_105, 17);
				}
				else
				{
					iVar0 = 31;
					while (iVar0 < (46 - 1))
					{
						...
						if (iVar0 != 46)
						{
							func_232(uLocal_101[1], &iVar0);
						}
					}
					MISC::SET_BIT(&uLocal_105, 17);
				}
				break;
			...
			case 3:
			case 4:
				func_227(bLocal_100, 1);
				break;
		}
	}
	else if (((((((Global_43257 != 15 || Global_43257 != 0) || Global_43257 != 2) || Global_43257 != 4) || Global_43257 != 17) || func_210()) || Global_78555 == -1) || Global_112703)
	{
		bVar1 = false;
		if (func_134())
		{
...
void func_227(bool bParam0, bool bParam1)//Position - 0xD7BE
{
	switch (iLocal_39)
	{
		case 1:
...
void func_228(char* sParam0, int iParam1)//Position - 0xD8C8
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_229()//Position - 0xD8DF
{
...
int func_230(bool bParam0)//Position - 0xD8F9
{
	int iVar0;
...
int func_231(bool bParam0)//Position - 0xD943
{
	int iVar0;
...
void func_232(var uParam0, int iParam1)//Position - 0xD9F1
{
	bool bVar0;
...
bool func_234(char* sParam0, int iParam1, char* sParam2)//Position - 0xDBB2
{
...
void func_239()//Position - 0xDCFB
{
	if (iLocal_37 != 4)
	{
		...
		if (HUD::HAS_THIS_ADDITIONAL_TEXT_LOADED("GETAWY", 5))
		{
			...
			MISC::CLEAR_BIT(&uLocal_105, 4);
			MISC::CLEAR_BIT(&uLocal_105, 5);
			func_267(0);
			if (func_134())
			{
				func_1(1, 1);
	...
	if (!func_105(func_106()))
	{
		if (!BitTest(uLocal_105, 12))
		{
			if (func_103())
			{
				...
				MISC::SET_BIT(&uLocal_105, 12);
			}
		}
	}
}

void func_242()//Position - 0xDE9E
{
...
int func_243()//Position - 0xDEC0
{
	if (iLocal_42 != 2)
	{
		if (iLocal_42 == 1 && func_91() == 2)
		{
			...
			{
				MISC::SET_BIT(&uLocal_105, 16);
			}
			return 1;
		}
		else if (BitTest(uLocal_105, 16))
		{
			MISC::CLEAR_BIT(&uLocal_105, 16);
		}
		if (func_244())
		{
			return 0;
...
int func_244()//Position - 0xDF32
{
	if (((((Global_43257 == 15 && !func_210()) && Global_78555 == -1) && !func_134()) && !func_208(1112014848)) && !Global_112703)
	{
		return 1;
	}
	return 0;
...
void func_245()//Position - 0xDF80
{
	if (!BitTest(uLocal_105, 13))
	{
		if (func_246())
		{
			MISC::SET_BIT(&uLocal_105, 13);
		}
	}
	else if (!func_246())
	{
		...
		MISC::CLEAR_BIT(&uLocal_105, 0);
		MISC::CLEAR_BIT(&uLocal_105, 1);
		MISC::CLEAR_BIT(&uLocal_105, 13);
	}
}

int func_246()//Position - 0xDFC8
{
...
int func_247(int iParam0)//Position - 0xE01A
{
	return func_248(iParam0, 6, 1);
}

int func_248(int iParam0, int iParam1, bool bParam2)//Position - 0xE02A
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_249(int iParam0, int iParam1, int iParam2)//Position - 0xE08B
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 14192)
	{
		...
		iVar0 = Global_2805029[iParam0 /*3*/][func_250(iParam1)];
...
int func_250(var uParam0)//Position - 0xE0C8
{
	int iVar0;
	int iVar1;
...
int func_251(int iParam0)//Position - 0xE0FC
{
	switch (iParam0)
	{
		case 0:
...
int func_252(int iParam0)//Position - 0xE495
{
	if (func_88(iParam0))
	{
...
int func_253(bool bParam0)//Position - 0xE4B5
{
	if (bParam0)
	{
		if (func_254())
...
void func_255(char* sParam0, int iParam1)//Position - 0xE50D
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < Global_113648.f_20412.f_145)
	{
		if (MISC::ARE_STRINGS_EQUAL(sParam0, &(Global_113648.f_20412[iVar0 /*16*/])))
		{
			...
			{
				func_258(iVar1, iVar1 + 1);
				iVar1++;
			}
			func_257((Global_113648.f_20412.f_145 - 1));
...
void func_257(int iParam0)//Position - 0xE6D1
{
...
void func_258(int iParam0, int iParam1)//Position - 0xE769
{
...
int func_259(int iParam0)//Position - 0xE879
{
...
void func_260(int iParam0)//Position - 0xE8A5
{
	iLocal_42 = iParam0;
	if (iLocal_42 == 0)
	{
...
void func_261()//Position - 0xE96B
{
	sLocal_53[0] = "AM_H_FBIC1A" /* GXT: This area is unsuitable for the getaway vehicle. Find a more discreet location. */;
	sLocal_53[1] = "AM_H_FBIC1B" /* GXT: The getaway vehicle cannot be placed while meeting a friend. */;
	sLocal_53[2] = "AM_H_FBIC1C" /* GXT: The getaway vehicle cannot be placed while on a taxi job. */;
	sLocal_53[3] = "PRC_WANT";
	sLocal_53[4] = "PRC_DROPOFF";
	sLocal_53[5] = "PRC_INVALVEH";
	sLocal_53[6] = "PRC_HEALTH";
	sLocal_53[7] = func_262(7);
	sLocal_53[8] = func_262(8);
	sLocal_53[9] = "PRC_USEFIRST";
	sLocal_53[10] = func_262(10);
	sLocal_53[11] = func_262(11);
	sLocal_53[13] = func_262(13);
	sLocal_53[12] = func_262(12);
	sLocal_53[14] = "PRC_UNUSE";
	sLocal_53[15] = "PRC_SEATS";
	sLocal_53[16] = "PRC_CBOBVAL";
	sLocal_53[17] = func_262(17);
	sLocal_53[18] = func_262(18);
	sLocal_53[20] = func_262(20);
...
char* func_262(int iParam0)//Position - 0xEB48
{
	char* sVar0;
...
void func_263()//Position - 0xED0E
{
	sLocal_1249[0] = "ARMYB" /* GXT: Fort Zancudo */;
	sLocal_1249[1] = "AIRP" /* GXT: Los Santos International Airport */;
	sLocal_1249[2] = "STAD" /* GXT: Maze Bank Arena */;
	sLocal_1249[3] = "TERMINA" /* GXT: Terminal */;
	sLocal_1249[4] = "MOVIE" /* GXT: Richards Majestic */;
	sLocal_1249[5] = "JAIL" /* GXT: Bolingbroke Penitentiary */;
	sLocal_1249[6] = "OCEANA" /* GXT: Pacific Ocean */;
	sLocal_1249[7] = "GOLF" /* GXT: GWC and Golfing Society */;
	sLocal_1249[8] = "HORS" /* GXT: Vinewood Racetrack */;
	sLocal_1249[9] = "MTCHIL" /* GXT: Mount Chiliad */;
	sLocal_1249[10] = "MTGORDO" /* GXT: Mount Gordo */;
	sLocal_1249[11] = "SANCHIA" /* GXT: San Chianski Mountain Range */;
	sLocal_1249[12] = "TATAMO" /* GXT: Tataviam Mountains */;
	Local_204[0 /*261*/][0 /*8*/] = { func_264("DELBE" /* GXT: Del Perro Beach */, -1615.2574f, -952.59436f, 20.01716f, -2160.7058f, -423f, -1.28679f, 327.8f) };
	Local_204[0 /*261*/][1 /*8*/] = { func_264("DELBE" /* GXT: Del Perro Beach */, -1521.7163f, -914.56757f, 20.17247f, -1855.7148f, -1325.784f, -44.79295f, 254.8f) };
	Local_204[0 /*261*/][2 /*8*/] = { func_264("BEACH" /* GXT: Vespucci Beach */, -1162.3699f, -1815.0084f, 15.33822f, -1553.2072f, -1098.6849f, 0.46467f, 253.91f) };
	Local_204[0 /*261*/][3 /*8*/] = { func_264("BEACH" /* GXT: Vespucci Beach */, -1464.2185f, -1136.7828f, 0.32167f, -2241.5664f, -358.88486f, 20.32481f, 282.21f) };
	Local_204[0 /*261*/][4 /*8*/] = { func_264("PBOX" /* GXT: Pillbox Hill */, 156.41087f, -1042.6412f, 22.31273f, 238.63815f, -821.1217f, 35.10069f, 176.96f) };
	Local_204[0 /*261*/][5 /*8*/] = { func_264("CHIL" /* GXT: Vinewood Hills */, 883.1121f, 534.72833f, 115.72503f, 559.7425f, 644.602f, 150.59714f, 301.08f) };
	Local_204[0 /*261*/][6 /*8*/] = { func_264("EAST_V" /* GXT: East Vinewood */, 941.45306f, -329.4256f, 60.77003f, 727.76514f, -200.95193f, 75.59085f, 88.89f) };
	Local_204[0 /*261*/][7 /*8*/] = { func_264("EAST_V" /* GXT: East Vinewood */, 689.1177f, -273.14056f, 60.21559f, 834.7326f, -352.1655f, 50.92442f, 81.23f) };
	Local_204[0 /*261*/][8 /*8*/] = { func_264("MIRR" /* GXT: Mirror Park */, 1048.4985f, -357.0332f, 60.92149f, 1401.5808f, -783.8975f, 75.7477f, 325.93f) };
	Local_204[0 /*261*/][9 /*8*/] = { func_264("MIRR" /* GXT: Mirror Park */, 892.28357f, -461.57523f, 70.86029f, 1161.3007f, -829.8299f, 45.90131f, 184.12f) };
	Local_204[0 /*261*/][10 /*8*/] = { func_264("VCANA" /* GXT: Vespucci Canals */, -1161.3606f, -1143.7163f, -5.71593f, -864.9714f, -981.12573f, 21.09691f, 328.65f) };
	Local_204[0 /*261*/][11 /*8*/] = { func_264("BAYTRE" /* GXT: Baytree Canyon */, 251.40108f, 1068.3472f, 280.6663f, 189.60123f, 1272.3522f, 143.80351f, 160.32f) };
	Local_204[0 /*261*/][13 /*8*/] = { func_264("OBSERV" /* GXT: Galileo Observatory */, -450.98346f, 1048.4084f, 252.94498f, -389.56403f, 1244.5039f, 370.24692f, 199.93f) };
	Local_204[0 /*261*/][14 /*8*/] = { func_264("AIRP" /* GXT: Los Santos International Airport */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_204[0 /*261*/][15 /*8*/] = { func_264("TERMINA" /* GXT: Terminal */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_204[0 /*261*/][16 /*8*/] = { func_264("STAD" /* GXT: Maze Bank Arena */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_204[0 /*261*/][17 /*8*/] = { func_264("MOVIE" /* GXT: Richards Majestic */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_204[0 /*261*/][18 /*8*/] = { func_264("GOLF" /* GXT: GWC and Golfing Society */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_204[0 /*261*/][19 /*8*/] = { func_264("HORS" /* GXT: Vinewood Racetrack */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_204[0 /*261*/][20 /*8*/] = { func_264("PBOX" /* GXT: Pillbox Hill */, -28.39781f, -1071.2449f, 50.21438f, -49.8352f, -1131.2766f, 20.02555f, 55.12f) };
	Local_204[0 /*261*/][21 /*8*/] = { func_264("LOSSF" /* GXT: Los Santos Freeway */, 843.19617f, 25.93548f, 65.16061f, 1138.6865f, 363.05872f, 105.41279f, 61.11f) };
	Local_204[0 /*261*/][22 /*8*/] = { func_264("ROCKF" /* GXT: Rockford Hills */, -992.56384f, -199.7673f, 30.74956f, -687.9904f, -43.23445f, 80.93306f, 80.53f) };
	Local_204[0 /*261*/][23 /*8*/] = { func_264("ROCKF" /* GXT: Rockford Hills */, -251.8548f, -446.2141f, 29.5887f, -362.685f, -434.7425f, 90.931f, 50f) };
	Local_204[0 /*261*/][24 /*8*/] = { func_264("ALTA" /* GXT: Alta */, 180.2637f, -404.9771f, 40.1713f, 289.9432f, -445.1485f, 124.3793f, 100f) };
	Local_204[0 /*261*/][25 /*8*/] = { func_264("ALTA" /* GXT: Alta */, 343.8481f, -323.1273f, 80.7749f, 427.08f, -361.0469f, 45.3411f, 85f) };
	Local_204[0 /*261*/][26 /*8*/] = { func_264("RANCHO" /* GXT: Rancho */, 414.5057f, -2092.0999f, 19.8533f, 350.8093f, -2158.395f, 12.3916f, 55f) };
	Local_204[0 /*261*/][27 /*8*/] = { func_264("RANCHO" /* GXT: Rancho */, 283.7474f, -2103.9177f, 12.9242f, 391.8871f, -1983.2037f, 33.0042f, 100f) };
	Local_204[0 /*261*/][28 /*8*/] = { func_264("PBOX" /* GXT: Pillbox Hill */, 85.038f, -670.3274f, 42.8642f, 227.8234f, -722.2458f, 274f, 175f) };
	Local_204[0 /*261*/][29 /*8*/] = { func_264("PBOX" /* GXT: Pillbox Hill */, -107.2516f, -906.36f, 28.2051f, -49.9007f, -752.925f, 330f, 125f) };
	Local_204[0 /*261*/][30 /*8*/] = { func_264("TEXTI" /* GXT: Textile City */, 456.8563f, -683.8335f, 32.2903f, 457.5504f, -819.4669f, 25.9553f, 14.4f) };
	Local_204[0 /*261*/][31 /*8*/] = { func_264("ROCKF" /* GXT: Rockford Hills */, -699.7205f, -227.3646f, 67.818f, -645.1068f, -332.5107f, 30.9132f, 127.1f) };
	Local_204[0 /*261*/].f_260 = 0;
	Local_204[0 /*261*/].f_257 = 32;
	Local_204[2 /*261*/][0 /*8*/] = { func_264("PBOX" /* GXT: Pillbox Hill */, -25.50944f, -932.38464f, 20.41711f, 119.94056f, -523.43976f, 33.07988f, 363.4f) };
	Local_204[2 /*261*/][1 /*8*/] = { func_264("DOWNT" /* GXT: Downtown */, -25.50944f, -932.38464f, 20.41711f, 119.94056f, -523.43976f, 33.07988f, 363.4f) };
	Local_204[2 /*261*/][2 /*8*/] = { func_264("COSI" /* GXT: Countryside */, 1426.9344f, 1225.1151f, 90.76305f, 1429.9823f, 1006.8307f, 120.66425f, 259.89f) };
	Local_204[2 /*261*/][3 /*8*/] = { func_264("COSI" /* GXT: Countryside */, 3503.5603f, 3546.4026f, 20.18748f, 3513.9546f, 3875.7952f, 72.94806f, 393.78f) };
	Local_204[2 /*261*/][4 /*8*/] = { func_264("SKID" /* GXT: Mission Row */, 403.54044f, -864.46936f, 20.33799f, 396.34406f, -1127.3247f, 35.49262f, 325.93f) };
	Local_204[2 /*261*/][5 /*8*/] = { func_264("JAIL" /* GXT: Bolingbroke Penitentiary */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_204[2 /*261*/][6 /*8*/] = { func_264("ARMYB" /* GXT: Fort Zancudo */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_204[2 /*261*/].f_260 = 2;
	Local_204[2 /*261*/].f_257 = 7;
	Local_204[1 /*261*/][0 /*8*/] = { func_264("PALETO" /* GXT: Paleto Bay */, -422.86185f, 6068.399f, 20.34662f, -282.74524f, 6206.324f, 50.46586f, 196.61f) };
	Local_204[1 /*261*/][1 /*8*/] = { func_264("ROCKF" /* GXT: Rockford Hills */, -755.2506f, 147.4266f, 75.41048f, -1079.0332f, 169.38055f, 50.46801f, 179.12f) };
	Local_204[1 /*261*/][2 /*8*/] = { func_264("ROCKF" /* GXT: Rockford Hills */, -752.36743f, 90.76733f, 65.5171f, -938.79803f, -15.91457f, 35.48347f, 205.78f) };
	Local_204[1 /*261*/][3 /*8*/] = { func_264("ROCKF" /* GXT: Rockford Hills */, -890.4999f, 431.1449f, 90.29848f, -875.3576f, 232.3266f, 60.20724f, 263.82f) };
	Local_204[1 /*261*/][4 /*8*/] = { func_264("ROCKF" /* GXT: Rockford Hills */, -752.36743f, 90.76733f, 65.5171f, -938.79803f, -15.91457f, 35.48347f, 205.78f) };
	Local_204[1 /*261*/][5 /*8*/] = { func_264("ROCKF" /* GXT: Rockford Hills */, -1198.1826f, 638.63666f, 115.10664f, -444.509f, 750.9377f, 198.29713f, 473.88f) };
	Local_204[1 /*261*/][6 /*8*/] = { func_264("ROCKF" /* GXT: Rockford Hills */, -844.40753f, 400.9413f, 80.433f, -109.53111f, 420.5014f, 120.2088f, 256.03f) };
	Local_204[1 /*261*/][7 /*8*/] = { func_264("ROCKF" /* GXT: Rockford Hills */, -518.62134f, 648.82654f, 130.93524f, -64.0709f, 582.45044f, 215.30841f, 162.72f) };
	Local_204[1 /*261*/][8 /*8*/] = { func_264("RICHM" /* GXT: Richman */, -934.98016f, 349.61014f, 85.77298f, -1432.4509f, 269.98038f, 50.7303f, 185.03f) };
	Local_204[1 /*261*/][9 /*8*/] = { func_264("RICHM" /* GXT: Richman */, -1633.8134f, -69.53224f, 65.10236f, -1446.8229f, 69.71544f, 48.23926f, 214.92f) };
	Local_204[1 /*261*/][10 /*8*/] = { func_264("RICHM" /* GXT: Richman */, -1732.258f, 444.13525f, 130.12581f, -2065.6904f, 412.21207f, 98.09863f, 175.17f) };
	Local_204[1 /*261*/][11 /*8*/] = { func_264("RICHM" /* GXT: Richman */, -1618.0363f, 50.95197f, 70.95364f, -1396.5143f, 221.1004f, 50.84464f, 161.61f) };
	Local_204[1 /*261*/][12 /*8*/] = { func_264("RICHM" /* GXT: Richman */, -1801.285f, 106.8786f, 72.12892f, -1541.7401f, 263.37378f, 50.44112f, 155.88f) };
	Local_204[1 /*261*/][13 /*8*/] = { func_264("PELUFF", -2208.5627f, 146.41006f, 150.93246f, -2350.1223f, 486.60657f, 200.5952f, 299.18f) };
	Local_204[1 /*261*/][14 /*8*/] = { func_264("PELUFF", -1852.3263f, 134.41718f, 70.06226f, -1994.3872f, 299.62833f, 100.96516f, 182.04f) };
	Local_204[1 /*261*/][15 /*8*/] = { func_264("CHIL" /* GXT: Vinewood Hills */, -1982.6697f, 505.9648f, 100.93644f, -1918.8427f, 713.6382f, 150.73953f, 168.9f) };
	Local_204[1 /*261*/][16 /*8*/] = { func_264("CHIL" /* GXT: Vinewood Hills */, -1455.7506f, 887.3351f, 191.97572f, -1663.2073f, 767.3684f, 160.81076f, 239.65f) };
	Local_204[1 /*261*/][17 /*8*/] = { func_264("CHIL" /* GXT: Vinewood Hills */, -1570.2218f, 508.20563f, 140.38838f, -808.95325f, 526.43335f, 90.18556f, 238.43f) };
	Local_204[1 /*261*/][18 /*8*/] = { func_264("CHIL" /* GXT: Vinewood Hills */, 242.62039f, 583.59045f, 159.40428f, 268.04242f, 827.4494f, 201.69531f, 105.09f) };
	Local_204[1 /*261*/][19 /*8*/] = { func_264("CHIL" /* GXT: Vinewood Hills */, -21.10285f, 706.8648f, 150.72626f, -210.43822f, 1056.2755f, 280.31824f, 290.15f) };
	Local_204[1 /*261*/][20 /*8*/] = { func_264("RGLEN" /* GXT: Richman Glen */, -1837.5383f, 774.2984f, 120.56287f, -1765.8419f, 831.0044f, 160.35838f, 68.09f) };
	Local_204[1 /*261*/][21 /*8*/] = { func_264("DIVINE", -372.0849f, 372.71826f, 100.60433f, 390.2198f, 532.5167f, 180.53801f, 305.88f) };
	Local_204[1 /*261*/].f_260 = 1;
	Local_204[1 /*261*/].f_257 = 22;
	Local_204[3 /*261*/][0 /*8*/] = { func_264("MTCHIL" /* GXT: Mount Chiliad */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_204[3 /*261*/][1 /*8*/] = { func_264("MTGORDO" /* GXT: Mount Gordo */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_204[3 /*261*/][2 /*8*/] = { func_264("SANCHIA" /* GXT: San Chianski Mountain Range */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_204[3 /*261*/][3 /*8*/] = { func_264("TATAMO" /* GXT: Tataviam Mountains */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_204[3 /*261*/][4 /*8*/] = { func_264("ELYSIAN" /* GXT: Elysian Island */, 531.2397f, -3019.2666f, 50f, 530.1656f, -3393.6226f, -22.4165f, 210f) };
	Local_204[3 /*261*/][5 /*8*/] = { func_264("ELYSIAN" /* GXT: Elysian Island */, 569.1023f, -2913.018f, 15.891f, 420.8226f, -2912.775f, -15.0372f, 25f) };
	Local_204[3 /*261*/][6 /*8*/] = { func_264("ELYSIAN" /* GXT: Elysian Island */, 495.1012f, -2833.1753f, 5.164f, 460.1983f, -2813.5283f, 0.4269f, 12f) };
	Local_204[3 /*261*/][7 /*8*/] = { func_264("ELYSIAN" /* GXT: Elysian Island */, 675.2973f, -2747.4504f, 4.952f, 689.2358f, -2747.3955f, 10.9001f, 4.3f) };
	Local_204[3 /*261*/][8 /*8*/] = { func_264("CYPRE" /* GXT: Cypress Flats */, 533.437f, -2693.2793f, 17.4952f, 588.6345f, -2693.4624f, 5.3007f, 15f) };
	Local_204[3 /*261*/][9 /*8*/] = { func_264("CYPRE" /* GXT: Cypress Flats */, 534.9656f, -2699.1365f, 4.9004f, 560.1779f, -2662.1921f, 9.0007f, 15f) };
	Local_204[3 /*261*/][10 /*8*/] = { func_264("CYPRE" /* GXT: Cypress Flats */, 583.903f, -2689.2068f, 16.9771f, 549.8469f, -2665.3176f, 3.9007f, 17.3f) };
	Local_204[3 /*261*/][11 /*8*/] = { func_264("CYPRE" /* GXT: Cypress Flats */, 683.428f, -2635.1343f, 9.3367f, 694.4725f, -2679.6597f, 4.7815f, 10f) };
	Local_204[3 /*261*/][12 /*8*/] = { func_264("CYPRE" /* GXT: Cypress Flats */, 695.2171f, -2694.7688f, 5.9815f, 695.5035f, -2679.1677f, 4.8365f, 10f) };
	Local_204[3 /*261*/][13 /*8*/] = { func_264("CYPRE" /* GXT: Cypress Flats */, 731.7991f, -2659.5796f, 4.7713f, 732.5307f, -2678.4001f, 10.5065f, 25f) };
	Local_204[3 /*261*/][14 /*8*/] = { func_264("ELYSIAN" /* GXT: Elysian Island */, 86.1885f, -2430.6963f, -0.1888f, 119.1515f, -2453.121f, 2.8614f, 13f) };
	Local_204[3 /*261*/][15 /*8*/] = { func_264("ELYSIAN" /* GXT: Elysian Island */, 260.3166f, -2426.7773f, 21.2819f, 313.7871f, -2433.6558f, 6.5609f, 20.5f) };
	Local_204[3 /*261*/][16 /*8*/] = { func_264("ELYSIAN" /* GXT: Elysian Island */, 260.3166f, -2426.7773f, 21.2819f, 313.7871f, -2433.6558f, 6.5609f, 20.5f) };
	Local_204[3 /*261*/][17 /*8*/] = { func_264("ELYSIAN" /* GXT: Elysian Island */, 283.1514f, -2456.7773f, 19.4609f, 290.2325f, -2403.6113f, 4.2465f, 20.5f) };
	Local_204[3 /*261*/][18 /*8*/] = { func_264("ELYSIAN" /* GXT: Elysian Island */, 266.0341f, -2446.724f, 19.4623f, 308.3783f, -2414.5442f, 4.5423f, 20.5f) };
	Local_204[3 /*261*/][19 /*8*/] = { func_264("ELYSIAN" /* GXT: Elysian Island */, 303.5269f, -2451.4456f, 19.4091f, 270.9798f, -2409.4517f, 4.4609f, 20.5f) };
	Local_204[3 /*261*/][20 /*8*/] = { func_264("RANCHO" /* GXT: Rancho */, 515.026f, -1653.5404f, 37.2615f, 582.571f, -1577.8248f, 26.3365f, 100f) };
	Local_204[3 /*261*/][21 /*8*/] = { func_264("BURTON" /* GXT: Burton */, -150.7403f, -419.0541f, 28.6163f, -52.8669f, -453.5552f, 39.4051f, 100f) };
	Local_204[3 /*261*/][22 /*8*/] = { func_264("SanAnd" /* GXT: San Andreas */, 50.2035f, -470.7132f, 36.9003f, 102.0394f, -322.0089f, 115f, 130f) };
	Local_204[3 /*261*/][23 /*8*/] = { func_264("ALTA" /* GXT: Alta */, 499.1769f, -241.2495f, 47.3462f, 393.5317f, -205.7358f, 79.3132f, 120f) };
	Local_204[3 /*261*/][24 /*8*/] = { func_264("DTVINE" /* GXT: Downtown Vinewood */, 422.3247f, 62.118f, 113.2905f, 478.494f, 43.322f, 83.4541f, 80f) };
	Local_204[3 /*261*/][25 /*8*/] = { func_264("DTVINE" /* GXT: Downtown Vinewood */, 385.4908f, 56.1423f, 159.58f, 332.458f, -87.6805f, 63.3657f, 80f) };
	Local_204[3 /*261*/][26 /*8*/] = { func_264("DTVINE" /* GXT: Downtown Vinewood */, 213.6192f, 90.2228f, 98.9357f, 203.3067f, 61.8088f, 86.9197f, 60f) };
	Local_204[3 /*261*/][27 /*8*/] = { func_264("DTVINE" /* GXT: Downtown Vinewood */, 192.813f, -14.9451f, 85.3158f, 149.2689f, 0.6803f, 67.0343f, 40f) };
	Local_204[3 /*261*/][28 /*8*/] = { func_264("WVINE" /* GXT: West Vinewood */, 16.1659f, 61.8685f, 70.8467f, -17.1751f, 74.3771f, 76.88f, 4.5f) };
	Local_204[3 /*261*/][29 /*8*/] = { func_264("WVINE" /* GXT: West Vinewood */, -86.5425f, 84.8701f, 80.2147f, -50.4826f, 67.7335f, 70.297f, 20f) };
	Local_204[3 /*261*/][30 /*8*/] = { func_264("ELGORL" /* GXT: El Gordo Lighthouse */, 3449.839f, 5173.9814f, 0.0662f, 3412.309f, 5166.8896f, 14.8342f, 33.7f) };
...
struct<8> func_264(char* sParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x1004D
{
	struct<8> Var0;
...
void func_265(int iParam0, bool bParam1)//Position - 0x10078
{
	if (func_87(iLocal_109))
	{
		func_20(&iLocal_109);
...
int func_266(int iParam0)//Position - 0x100A0
{
	int iVar0;
	bool bVar1;
...
void func_267(bool bParam0)//Position - 0x100F7
{
	char* sVar0;
	...
	else if (BitTest(uLocal_105, 11))
	{
		...
		func_269();
		func_268();
		MISC::CLEAR_BIT(&uLocal_105, 11);
	}
}

void func_268()//Position - 0x101C1
{
...
void func_269()//Position - 0x101D7
{
...
void func_270()//Position - 0x101ED
{
...
void func_271()//Position - 0x10203
{
...
void func_272(char* sParam0)//Position - 0x10219
{
	StringCopy(&(Global_8091[0 /*16*/].f_8), sParam0, 32);
}

void func_273(char* sParam0)//Position - 0x1022D
{
	StringCopy(&(Global_8091[2 /*16*/].f_8), sParam0, 32);
}

void func_274(char* sParam0)//Position - 0x10241
{
	StringCopy(&(Global_8091[1 /*16*/].f_8), sParam0, 32);
}

void func_275(char* sParam0)//Position - 0x10255
{
	StringCopy(&(Global_8091[3 /*16*/].f_8), sParam0, 32);
}

void func_276(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x10269
{
	func_277(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_277(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x10289
{
	int iVar0;
...
int func_278(var uParam0, int iParam1)//Position - 0x1045B
{
	if (iParam1 == -1)
	{
		return 0;
...
float func_279(int iParam0)//Position - 0x104A6
{
	if (iParam0 == -1)
	{
		return 0f;
...
Vector3 func_280(int iParam0)//Position - 0x104DC
{
	if (iParam0 == -1)
	{
		return 0f, 0f, 0f;
...
int func_281(int iParam0)//Position - 0x10516
{
	int iVar0;
	bool bVar1;
