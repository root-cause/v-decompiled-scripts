...
int func_34()//Position - 0x1540
{
	return 1;
}

int func_35()//Position - 0x1549
{
...
int func_37(int iParam0)//Position - 0x161A
{
	int iVar0;
	char* sVar1;
...
int func_38(int iParam0)//Position - 0x1661
{
	int iVar0;
...
int func_39(int iParam0)//Position - 0x169C
{
	int iVar0;
...
int func_40(int iParam0)//Position - 0x1718
{
	int iVar0;
...
int func_41(int iParam0, int iParam1, bool bParam2)//Position - 0x1800
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_42(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x186E
{
...
var func_48(int iParam0)//Position - 0x1B37
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_49(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_49(bool bParam0, int iParam1, int iParam2)//Position - 0x1B59
{
	if (bParam0)
	{
		return iParam1;
...
int func_50(var uParam0)//Position - 0x1B70
{
	return uParam0 & 15;
}
...
int func_54(var uParam0, int iParam1)//Position - 0x1C2E
{
	int iVar0;
	int iVar1;
...
bool func_57(int iParam0)//Position - 0x35B9
{
	return iParam0 < 3;
}

void func_58(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x35C5
{
	if (func_54(&(Global_78329.f_555[0 /*21*/]), iParam0))
	{
...
int func_66(int iParam0, var uParam1, var uParam2)//Position - 0x3C57
{
	int iVar0;
	int iVar1;
...
int func_67(int iParam0)//Position - 0x3E4A
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_72(int iParam0)//Position - 0x4045
{
	int iVar0;
	int iVar1;
...
int func_73(int iParam0)//Position - 0x4082
{
	if (func_57(iParam0))
	{
...
var func_74(int iParam0)//Position - 0x40A7
{
	return Global_2201[iParam0 /*29*/];
}

int func_75(int iParam0, int iParam1)//Position - 0x40B6
{
	if (iParam0 == -1)
	{
		return 0;
...
bool func_78(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x410E
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

bool func_79(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x412C
{
	if (bParam6)
	{
...
int func_82(bool bParam0)//Position - 0x41E2
{
...
void func_83(char* sParam0, var uParam1)//Position - 0x420A
{
...
int func_87(int iParam0)//Position - 0x43AC
{
	if (func_88(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_88(int iParam0)//Position - 0x43D6
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_93(int iParam0, int iParam1)//Position - 0x44D2
{
...
void func_100(int iParam0, bool bParam1, int iParam2)//Position - 0x4BAD
{
	if (iParam2 == -1)
	{
		iParam2 = func_101();
...
int func_105(int iParam0)//Position - 0x4C66
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
void func_110(int iParam0)//Position - 0x4D32
{
...
int func_113(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x4F2A
{
	struct<15> Var0;
	int iVar15;
...
void func_114(bool bParam0)//Position - 0x507B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0x51E9
{
...
void func_118(int iParam0, int iParam1, int iParam2)//Position - 0x522E
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_120(struct<6> Param0)//Position - 0x5298
{
	if (iLocal_40 == 0)
	{
		func_125(Param0);
...
void func_121(struct<6> Param0)//Position - 0x52BF
{
	if (func_103())
	{
		func_122(Param0, 1);
...
void func_125(struct<6> Param0)//Position - 0x5427
{
	if (func_103())
	{
		if (func_126())
...
int func_142(var uParam0)//Position - 0x57A1
{
	char* sVar0;
...
void func_144(int iParam0, struct<3> Param1)//Position - 0x581B
{
	int iVar0;
...
int func_146(char* sParam0, int iParam1, bool bParam2)//Position - 0x58C9
{
	Global_22426 = 0;
...
var func_150(int iParam0, int iParam1)//Position - 0x5C41
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_151()//Position - 0x5C59
{
	return -1;
}
...
void func_162(bool bParam0, var uParam1)//Position - 0x5FDE
{
	int iVar0;
...
void func_163(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x6154
{
...
void func_164(int iParam0, int iParam1, bool bParam2)//Position - 0x61EF
{
	int iVar0;
...
struct<4> func_166(int iParam0)//Position - 0x63E6
{
	return Global_2201[iParam0 /*29*/].f_3;
}

int func_167(int iParam0, int iParam1)//Position - 0x63F9
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
int func_168(int iParam0, int iParam1)//Position - 0x6423
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
char* func_171(bool bParam0)//Position - 0x7CFB
{
	char* sVar0;
...
int func_175(int iParam0)//Position - 0x7EE3
{
	if (Global_23540 == 0)
	{
		return 0;
...
{
	if ((BitTest(uLocal_103, 0) && Global_44181 == 15) && !func_210())
	{
		if (iLocal_36 == 0)
		{
...
int func_183(int iParam0)//Position - 0x830B
{
	struct<3> Var0;
...
int func_184(int iParam0)//Position - 0x83C0
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var4;
...
int func_185(struct<3> Param0)//Position - 0x8475
{
	float fVar0;
	float fVar1;
	struct<3> Var2;
...
int func_187(struct<3> Param0)//Position - 0x853A
{
...
int func_188(struct<3> Param0)//Position - 0x8593
{
...
int func_189(struct<3> Param0)//Position - 0x85C6
{
	float fVar0;
...
int func_190(struct<3> Param0, bool bParam3)//Position - 0x85FB
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_191(struct<3> Param0)//Position - 0x8675
{
	float fVar0;
...
int func_192(struct<3> Param0, bool bParam3)//Position - 0x86AA
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_193(struct<3> Param0)//Position - 0x8724
{
	struct<3> Var0;
	float fVar3;
...
int func_194(struct<3> Param0, struct<3> Param3)//Position - 0x87AD
{
	float fVar0;
...
int func_195(struct<3> Param0)//Position - 0x87D0
{
	if (!func_198(1))
	{
		if (!func_198(0))
...
int func_196(struct<3> Param0, int iParam3)//Position - 0x8E43
{
	float fVar0;
...
int func_198(int iParam0)//Position - 0x9548
{
...
int func_200(var uParam0)//Position - 0x96CB
{
...
int func_201(char* sParam0)//Position - 0x96F6
{
	int iVar0;
...
int func_202(struct<3> Param0)//Position - 0x9742
{
	if (Param0.f_2 < -90f)
	{
		return 1;
...
int func_205(struct<3> Param0, int iParam3, int iParam4)//Position - 0x987B
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_206(int iParam0)//Position - 0x990A
{
	return BitTest(Global_114135.f_7233[iParam0], 0);
}

int func_207()//Position - 0x991F
{
...
int func_208(float fParam0)//Position - 0x99B7
{
	if (iLocal_40 == 1)
	{
...
void func_209(bool bParam0, bool bParam1)//Position - 0x9A29
{
	func_4(bParam0);
...
int func_212(int iParam0)//Position - 0x9D75
{
...
int func_213(int iParam0)//Position - 0x9DA6
{
...
int func_215(int iParam0)//Position - 0x9E2E
{
...
int func_218(int iParam0)//Position - 0x9EA6
{
	int iVar0;
...
int func_219(int iParam0)//Position - 0x9EFA
{
	int iVar0;
...
int func_220(int iParam0)//Position - 0x9F3F
{
	int iVar0;
...
int func_222(int iParam0)//Position - 0xA001
{
	if (DECORATOR::DECOR_EXIST_ON(iParam0, "GetawayVehicleValid"))
	{
		return 1;
...
int func_224(var uParam0)//Position - 0xA064
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_226()//Position - 0xA231
{
	...
	if (((((((Global_44181 == 15 && iLocal_35 != 3) && BitTest(uLocal_103, 5)) && !func_210()) && Global_79536 == -1) && !func_236()) && !func_86(9)) || func_105(35))
	{
		func_235();
		func_233();
		switch (iLocal_37)
...
void func_227(bool bParam0, bool bParam1)//Position - 0xA3B9
{
	switch (iLocal_37)
	{
		case 1:
...
void func_228(char* sParam0, int iParam1)//Position - 0xA4C3
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_229()//Position - 0xA4DA
{
...
int func_230(bool bParam0)//Position - 0xA4F4
{
	int iVar0;
...
int func_231(bool bParam0)//Position - 0xA53E
{
	int iVar0;
...
void func_232(var uParam0, int iParam1)//Position - 0xA5EC
{
	bool bVar0;
...
bool func_234(char* sParam0, int iParam1, char* sParam2)//Position - 0xA7AD
{
...
int func_247(int iParam0)//Position - 0xAC15
{
	return func_248(iParam0, 6, 1);
}

int func_248(int iParam0, int iParam1, bool bParam2)//Position - 0xAC25
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_250(int iParam0, var uParam1)//Position - 0xACB4
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_251(uParam1));
}

int func_251(var uParam0)//Position - 0xACC9
{
	int iVar0;
	int iVar1;
...
int func_253(int iParam0)//Position - 0xB0B4
{
	if (func_88(iParam0))
	{
...
int func_254(bool bParam0)//Position - 0xB0D4
{
	if (bParam0)
	{
		if (func_255())
...
void func_256(char* sParam0, int iParam1)//Position - 0xB12C
{
	int iVar0;
	int iVar1;
...
int func_260(int iParam0)//Position - 0xB498
{
...
struct<8> func_265(char* sParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0xCC69
{
	struct<8> Var0;
...
void func_278(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0xCEA5
{
	int iVar0;
...
int func_279(var uParam0, int iParam1)//Position - 0xD077
{
	if (iParam1 == -1)
	{
		return 0;
...
int func_282(int iParam0)//Position - 0xD132
{
	int iVar0;
	bool bVar1;
