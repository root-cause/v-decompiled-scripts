...
void func_227()//Position - 0xF569
{
	...
	else if (((((((Global_43922 != 15 || Global_43922 != 0) || Global_43922 != 2) || Global_43922 != 4) || Global_43922 != 17) || func_211()) || Global_79245 == -1) || Global_113427)
	{
		bVar1 = false;
		if (func_135())
		{
...
{
	if (((((Global_43922 == 15 && !func_211()) && Global_79245 == -1) && !func_135()) && !func_209(1112014848)) && !Global_113427)
	{
		return 1;
	}
	return 0;
...
void func_257(char* sParam0, int iParam1)//Position - 0x10457
{
	...
	while (iVar0 < Global_114372.f_20413.f_145)
	{
		if (MISC::ARE_STRINGS_EQUAL(sParam0, &(Global_114372.f_20413[iVar0 /*16*/])))
		{
			...
			func_259((Global_114372.f_20413.f_145 - 1));
