...
int func_30(bool bParam0)//Position - 0x64C1
{
	if (bParam0)
	{
...
bool func_31()//Position - 0x64DB
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_32()//Position - 0x64F1
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_33()//Position - 0x6507
{
	return 0;
}

int func_34()//Position - 0x6510
{
	return 1;
}

int func_35()//Position - 0x6519
{
	return 1;
}

int func_36()//Position - 0x6522
{
...
int func_38(int iParam0)//Position - 0x65F3
{
	int iVar0;
	char* sVar1;
...
int func_39(int iParam0)//Position - 0x663A
{
	int iVar0;
...
int func_40(int iParam0)//Position - 0x6675
{
	int iVar0;
...
int func_41(int iParam0)//Position - 0x66F1
{
	int iVar0;
...
int func_42(int iParam0, int iParam1, bool bParam2)//Position - 0x67D9
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_43(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x6847
{
...
void func_45(var uParam0, int iParam1)//Position - 0x6964
{
	if (iParam1 <= 0)
	{
		return;
...
void func_46(var uParam0, int iParam1)//Position - 0x69EA
{
...
void func_47(var uParam0, int iParam1)//Position - 0x6A1D
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1)//Position - 0x6A6E
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_49(int iParam0)//Position - 0x6B10
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_50(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_50(bool bParam0, int iParam1, int iParam2)//Position - 0x6B32
{
	if (bParam0)
	{
		return iParam1;
...
int func_51(var uParam0)//Position - 0x6B49
{
	return uParam0 & 15;
}

void func_52(var uParam0, int iParam1)//Position - 0x6B56
{
...
void func_53(var uParam0, int iParam1)//Position - 0x6B90
{
...
void func_54(var uParam0, int iParam1)//Position - 0x6BCB
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_55(var uParam0, int iParam1)//Position - 0x6C07
{
	int iVar0;
	int iVar1;
...
int func_56(int iParam0, int iParam1)//Position - 0x82F5
{
	struct<82> Var0;
...
void func_57(int iParam0, var uParam1, int iParam2)//Position - 0x8337
{
	int iVar0;
...
bool func_58(int iParam0)//Position - 0x8593
{
	return iParam0 < 3;
}

void func_59(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x859F
{
	if (func_55(&(Global_77479.f_555[0 /*21*/]), iParam0))
	{
...
void func_60(int iParam0, bool bParam1)//Position - 0x8698
{
	if (iParam0 == -1)
	{
		return;
...
void func_61(int iParam0, int iParam1, bool bParam2)//Position - 0x86F5
{
	if (iParam0 == -1)
	{
		return;
...
void func_62(var uParam0, var uParam1)//Position - 0x8730
{
...
void func_63(int iParam0)//Position - 0x87FC
{
	if (iParam0 == -1)
	{
		return;
...
int func_64(int iParam0)//Position - 0x8873
{
	int iVar0;
...
void func_65(int iParam0, var uParam1)//Position - 0x88D6
{
	int iVar0;
...
int func_66(int iParam0)//Position - 0x8B81
{
	switch (iParam0)
	{
		case 1:
...
int func_67(int iParam0, var uParam1, var uParam2)//Position - 0x8C31
{
	int iVar0;
	int iVar1;
...
int func_68(int iParam0)//Position - 0x8E24
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_69(var uParam0)//Position - 0x8E44
{
	int iVar0;
...
void func_70(int iParam0)//Position - 0x8EF3
{
...
void func_71(bool bParam0)//Position - 0x8F1A
{
	if (BitTest(uLocal_103, 14))
	{
...
void func_72(int iParam0)//Position - 0x8FFE
{
	int iVar0;
...
int func_73(int iParam0)//Position - 0x901E
{
	int iVar0;
	int iVar1;
...
int func_74(int iParam0)//Position - 0x905B
{
	if (func_58(iParam0))
	{
...
var func_75(int iParam0)//Position - 0x9080
{
	return Global_2058[iParam0 /*29*/];
}

int func_76(int iParam0, int iParam1)//Position - 0x908F
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x90AF
{
	if (iParam0 == -1)
	{
		return 0;
...
bool func_79(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x90E7
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

bool func_80(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x9105
{
	if (bParam6)
	{
...
void func_81(int iParam0, bool bParam1)//Position - 0x914C
{
...
int func_83(bool bParam0)//Position - 0x91BB
{
...
void func_84(char* sParam0, var uParam1)//Position - 0x91E3
{
...
bool func_87(int iParam0)//Position - 0x9377
{
	return Global_43377 == iParam0;
}

int func_88(int iParam0)//Position - 0x9385
{
	if (func_89(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_89(int iParam0)//Position - 0x93AF
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_90(int iParam0, int iParam1)//Position - 0x93D0
{
...
void func_91(bool bParam0)//Position - 0x940D
{
	char* sVar0;
...
bool func_92()//Position - 0x9480
{
	func_86();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_93(char* sParam0)//Position - 0x9499
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_94(int iParam0, int iParam1)//Position - 0x94AB
{
...
void func_97(int iParam0, int iParam1, int iParam2)//Position - 0x9586
{
	bool bVar0;
...
int func_99()//Position - 0x9B2A
{
	return Global_32283;
}

int func_100(int iParam0, int iParam1)//Position - 0x9B35
{
	int iVar0;
...
void func_101(int iParam0, bool bParam1, int iParam2)//Position - 0x9B86
{
	if (iParam2 == -1)
	{
		iParam2 = func_102();
...
int func_102()//Position - 0x9BA4
{
	return Global_1574918;
}

int func_103()//Position - 0x9BB0
{
...
int func_106(int iParam0)//Position - 0x9C3F
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
int func_110(int iParam0, int iParam1)//Position - 0x9CCA
{
	int iVar0;
	int iVar1;
...
void func_111(int iParam0)//Position - 0x9D0B
{
	Global_78950 = iParam0;
	Global_78951 = iParam0;
}

void func_112()//Position - 0x9D1F
{
	struct<6> Var0;
...
void func_113(bool bParam0)//Position - 0x9E92
{
	if (bParam0)
	{
...
int func_114(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x9F03
{
	struct<15> Var0;
	int iVar15;
...
void func_115(bool bParam0)//Position - 0xA054
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_116(int iParam0)//Position - 0xA112
{
	switch (iParam0)
	{
		case 0:
...
void func_117(int iParam0)//Position - 0xA17C
{
...
void func_118(int iParam0, int iParam1, int iParam2)//Position - 0xA1C2
{
...
void func_119(int iParam0, int iParam1, int iParam2)//Position - 0xA207
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_121(struct<6> Param0)//Position - 0xA271
{
	if (iLocal_40 == 0)
	{
		func_126(Param0);
...
void func_122(struct<6> Param0)//Position - 0xA298
{
	if (func_104())
	{
		func_123(Param0, 1);
...
void func_123(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)//Position - 0xA2BC
{
	struct<4> Var0;
...
struct<4> func_124(bool bParam0)//Position - 0xA32C
{
	struct<4> Var0;
...
struct<4> func_125(bool bParam0)//Position - 0xA396
{
	struct<4> Var0;
...
void func_126(struct<6> Param0)//Position - 0xA400
{
	if (func_104())
	{
		if (func_127())
...
void func_129(bool bParam0)//Position - 0xA4B7
{
...
void func_130(char* sParam0, char* sParam1)//Position - 0xA4CB
{
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		Global_21902 = 1;
...
struct<6> func_131()//Position - 0xA4EC
{
	struct<6> Var0;
...
void func_132()//Position - 0xA510
{
	func_133();
}

void func_133()//Position - 0xA51C
{
	func_139();
	func_134();
}

void func_134()//Position - 0xA52C
{
	if (func_138() == 69)
	{
...
int func_138()//Position - 0xA647
{
	return Global_78952;
}

void func_139()//Position - 0xA653
{
...
void func_141()//Position - 0xA6FF
{
	func_17();
	func_112();
}

void func_142()//Position - 0xA70F
{
	int iVar0;
...
int func_143(var uParam0)//Position - 0xA77A
{
	char* sVar0;
...
void func_145(int iParam0, struct<3> Param1)//Position - 0xA7F4
{
	int iVar0;
...
bool func_146(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0xA843
{
...
int func_147(char* sParam0, int iParam1, bool bParam2)//Position - 0xA8A2
{
	Global_21846 = 0;
...
bool func_150(int iParam0)//Position - 0xAC0A
{
	return func_151(iParam0, 20);
}

var func_151(int iParam0, int iParam1)//Position - 0xAC1A
{
	return BitTest(Global_1895156[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_152()//Position - 0xAC32
{
	return -1;
}

void func_153()//Position - 0xAC3B
{
	int iVar0;
...
bool func_159(int iParam0, int iParam1)//Position - 0xAEB8
{
	switch (iParam0)
	{
		case 5:
...
void func_161(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAF47
{
...
void func_163(bool bParam0, var uParam1)//Position - 0xAFB7
{
	int iVar0;
...
void func_164(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xB12D
{
...
void func_165(int iParam0, int iParam1, bool bParam2)//Position - 0xB1C8
{
	int iVar0;
...
struct<4> func_167(int iParam0)//Position - 0xB3BF
{
	return Global_2058[iParam0 /*29*/].f_3;
}

int func_168(int iParam0, int iParam1)//Position - 0xB3D2
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
int func_169(int iParam0, int iParam1)//Position - 0xB3FC
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
char* func_172(bool bParam0)//Position - 0xCCD6
{
	char* sVar0;
...
int func_175(int iParam0)//Position - 0xCE8E
{
...
int func_176(int iParam0)//Position - 0xCEBE
{
	if (Global_22960 == 0)
	{
		return 0;
...
void func_178()//Position - 0xCF3D
{
	if ((BitTest(uLocal_103, 0) && Global_43377 == 15) && !func_211())
	{
		if (iLocal_36 == 0)
		{
...
void func_180(int iParam0)//Position - 0xD1C9
{
	if (func_183())
	{
		return;
...
void func_181(bool bParam0, bool bParam1)//Position - 0xD253
{
	if (bParam0)
	{
		if (func_15(0))
...
bool func_182()//Position - 0xD2C7
{
	return BitTest(Global_1963795, 5);
}

bool func_183()//Position - 0xD2D5
{
	return BitTest(Global_1963795, 19);
}

int func_184(int iParam0)//Position - 0xD2E4
{
	struct<3> Var0;
...
int func_185(int iParam0)//Position - 0xD399
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var4;
...
int func_186(struct<3> Param0)//Position - 0xD44E
{
	float fVar0;
	float fVar1;
	struct<3> Var2;
...
int func_188(struct<3> Param0)//Position - 0xD513
{
...
int func_189(struct<3> Param0)//Position - 0xD56C
{
...
int func_190(struct<3> Param0)//Position - 0xD59F
{
	float fVar0;
...
int func_191(struct<3> Param0, bool bParam3)//Position - 0xD5D4
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_192(struct<3> Param0)//Position - 0xD64E
{
	float fVar0;
...
int func_193(struct<3> Param0, bool bParam3)//Position - 0xD683
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_194(struct<3> Param0)//Position - 0xD6FD
{
	struct<3> Var0;
	float fVar3;
...
int func_195(struct<3> Param0, struct<3> Param3)//Position - 0xD786
{
	float fVar0;
...
int func_196(struct<3> Param0)//Position - 0xD7A9
{
	if (!func_199(1))
	{
		if (!func_199(0))
...
int func_197(struct<3> Param0, int iParam3)//Position - 0xDE1C
{
	float fVar0;
...
Vector3 func_198(int iParam0)//Position - 0xDE44
{
	struct<3> Var0;
...
int func_199(int iParam0)//Position - 0xE521
{
...
int func_201(var uParam0)//Position - 0xE6A4
{
...
int func_202(char* sParam0)//Position - 0xE6CF
{
	int iVar0;
...
int func_203(struct<3> Param0)//Position - 0xE71B
{
	if (Param0.f_2 < -90f)
	{
		return 1;
...
void func_205(int iParam0)//Position - 0xE7F7
{
...
int func_206(struct<3> Param0, int iParam3, int iParam4)//Position - 0xE854
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_207(int iParam0)//Position - 0xE8E3
{
	return BitTest(Global_113810.f_7232[iParam0], 0);
}

int func_208()//Position - 0xE8F8
{
...
int func_209(float fParam0)//Position - 0xE990
{
	if (iLocal_40 == 1)
	{
...
void func_210(bool bParam0, bool bParam1)//Position - 0xEA02
{
	func_4(bParam0);
...
void func_212()//Position - 0xEA74
{
	int iVar0;
	int iVar1;
	
	if ((Global_43377 == 15 && iLocal_36 == 0) && !func_211())
	{
		if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			if (!BitTest(uLocal_103, 0))
...
int func_213(int iParam0)//Position - 0xED4E
{
...
int func_214(int iParam0)//Position - 0xED7F
{
...
int func_216(int iParam0)//Position - 0xEE07
{
...
int func_217(int iParam0)//Position - 0xEE31
{
	int iVar0;
...
int func_218(int iParam0)//Position - 0xEE52
{
...
int func_220(int iParam0)//Position - 0xEED3
{
	int iVar0;
...
int func_221(int iParam0)//Position - 0xEF18
{
	int iVar0;
...
int func_223(int iParam0)//Position - 0xEFDA
{
	if (DECORATOR::DECOR_EXIST_ON(iParam0, "GetawayVehicleValid"))
	{
		return 1;
...
int func_225(var uParam0)//Position - 0xF03D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_227()//Position - 0xF1FC
{
	int iVar0;
	bool bVar1;
	
	if (((((((Global_43377 == 15 && iLocal_35 != 3) && BitTest(uLocal_103, 5)) && !func_211()) && Global_78686 == -1) && !func_237()) && !func_87(9)) || func_106(35))
	{
		func_236();
		func_234();
		switch (iLocal_37)
	...
	else if (((((((Global_43377 != 15 || Global_43377 != 0) || Global_43377 != 2) || Global_43377 != 4) || Global_43377 != 17) || func_211()) || Global_78686 == -1) || Global_112865)
	{
		bVar1 = false;
		if (func_135())
		{
...
void func_228(bool bParam0, bool bParam1)//Position - 0xF384
{
	switch (iLocal_37)
	{
		case 1:
...
void func_229(char* sParam0, int iParam1)//Position - 0xF48E
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_230()//Position - 0xF4A5
{
...
int func_231(bool bParam0)//Position - 0xF4BF
{
	int iVar0;
...
int func_232(bool bParam0)//Position - 0xF509
{
	int iVar0;
...
void func_233(var uParam0, int iParam1)//Position - 0xF5B7
{
	bool bVar0;
...
bool func_235(char* sParam0, int iParam1, char* sParam2)//Position - 0xF778
{
...
int func_245()//Position - 0xFAF8
{
	if (((((Global_43377 == 15 && !func_211()) && Global_78686 == -1) && !func_135()) && !func_209(1112014848)) && !Global_112865)
	{
		return 1;
	}
	return 0;
...
int func_248(int iParam0)//Position - 0xFBE0
{
	return func_249(iParam0, 6, 1);
}

int func_249(int iParam0, int iParam1, bool bParam2)//Position - 0xFBF0
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_250(int iParam0, int iParam1)//Position - 0xFC50
{
	int iVar0;
	var uVar1;
...
int func_251(int iParam0, var uParam1)//Position - 0xFC7F
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_252(uParam1));
}

int func_252(var uParam0)//Position - 0xFC94
{
	int iVar0;
	int iVar1;
...
int func_253(int iParam0)//Position - 0xFCC8
{
	switch (iParam0)
	{
		case 0:
...
int func_254(int iParam0)//Position - 0x10072
{
	if (func_89(iParam0))
	{
...
int func_255(bool bParam0)//Position - 0x10092
{
	if (bParam0)
	{
		if (func_256())
...
void func_257(char* sParam0, int iParam1)//Position - 0x100EA
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < Global_113810.f_20413.f_145)
	{
		if (MISC::ARE_STRINGS_EQUAL(sParam0, &(Global_113810.f_20413[iVar0 /*16*/])))
		{
			...
			func_259((Global_113810.f_20413.f_145 - 1));
...
void func_258()//Position - 0x10197
{
	int iVar0;
...
void func_259(int iParam0)//Position - 0x102AE
{
...
void func_260(int iParam0, int iParam1)//Position - 0x10346
{
...
int func_261(int iParam0)//Position - 0x10456
{
...
void func_262(int iParam0)//Position - 0x10482
{
	iLocal_40 = iParam0;
	if (iLocal_40 == 0)
	{
...
void func_263()//Position - 0x10548
{
...
char* func_264(int iParam0)//Position - 0x10725
{
	char* sVar0;
...
void func_265()//Position - 0x108EB
{
...
struct<8> func_266(char* sParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x11C25
{
	struct<8> Var0;
...
void func_267(int iParam0, bool bParam1)//Position - 0x11C50
{
	if (func_88(iLocal_107))
	{
		func_20(&iLocal_107);
...
int func_268(int iParam0)//Position - 0x11C78
{
	int iVar0;
	bool bVar1;
...
void func_269(bool bParam0)//Position - 0x11CCF
{
	char* sVar0;
...
void func_270()//Position - 0x11D99
{
...
void func_271()//Position - 0x11DAF
{
...
void func_272()//Position - 0x11DC5
{
...
void func_273()//Position - 0x11DDB
{
...
void func_274(char* sParam0)//Position - 0x11DF1
{
	StringCopy(&(Global_8208[0 /*16*/].f_8), sParam0, 32);
}

void func_275(char* sParam0)//Position - 0x11E05
{
	StringCopy(&(Global_8208[2 /*16*/].f_8), sParam0, 32);
}

void func_276(char* sParam0)//Position - 0x11E19
{
	StringCopy(&(Global_8208[1 /*16*/].f_8), sParam0, 32);
}

void func_277(char* sParam0)//Position - 0x11E2D
{
	StringCopy(&(Global_8208[3 /*16*/].f_8), sParam0, 32);
}

void func_278(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x11E41
{
	func_279(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_279(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x11E61
{
	int iVar0;
...
int func_280(var uParam0, int iParam1)//Position - 0x12033
{
	if (iParam1 == -1)
	{
		return 0;
...
float func_281(int iParam0)//Position - 0x1207E
{
	if (iParam0 == -1)
	{
		return 0f;
...
Vector3 func_282(int iParam0)//Position - 0x120B4
{
	if (iParam0 == -1)
	{
		return 0f, 0f, 0f;
...
int func_283(int iParam0)//Position - 0x120EE
{
	int iVar0;
	bool bVar1;
