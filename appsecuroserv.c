...
int func_230(int iParam0)//Position - 0xAE7C
{
	...
	if (func_254())
	{
		...
		iVar13 = -1;
		while (func_239(&iVar13, (iVar7 - iVar2), 0, -1616616027, 235173372, iVar10, iVar11, iVar0, iVar12, iVar4, iVar3, iVar2))
		{
			func_651();
			SYSTEM::WAIT(0);
		}
	...
	if (BitTest(iLocal_554, 7))
	{
		switch (iLocal_728)
		{
			case 0:
				...
				if (func_247(78225582, iParam3, iParam5, iParam4, 1, iParam1, iParam2, 4, iParam6, 3))
				{
					...
					if (iParam8 != 0)
					{
						if (func_247(78225582, iParam3, iParam8, iParam4, 1, iParam7, 1, 4, iParam6, 3))
						{
						}
						else
						{
					...
					if (iParam9 != 0)
					{
						if (func_247(78225582, -103880010, iParam9, iParam4, 1, iParam11, 1, 4, iParam10, 3))
						{
						}
						else
						{
...
int func_249(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5)//Position - 0xBF92
{
	...
	*iParam0 = 0;
	...
	{
		*iParam0 = func_250(uVar3, iParam1, -2085313189, iParam3, iParam2, 0, 1, iParam4, uParam5, 0, bVar0);
		return 1;
	}
	return 0;
}
...
int func_291(int iParam0, int iParam1)//Position - 0x158E1
{
	...
	if (func_254())
	{
		...
		iLocal_728 = 0;
		iVar4 = -1;
		while (func_292(&iVar4, iVar1, 1, -103880010, 235173372, iVar3, iVar2))
		{
			func_651();
			SYSTEM::WAIT(0);
		}
...
int func_318(bool bParam0, int iParam1)//Position - 0x1652B
{
	...
	if (func_254())
	{
		...
		while (func_325(&iVar9, iVar4, iVar0, -1799524201, -1018905335, iVar7, iVar8, &bVar10, &iLocal_728))
		{
			func_651();
			SYSTEM::WAIT(0);
		}
...
int func_339(int iParam0)//Position - 0x170B1
{
	...
	if (func_254())
	{
		...
		while (func_325(&iVar4, 0, iVar0, -1799524201, -1018905335, iVar2, iVar3, &bVar5, &iLocal_728))
		{
			func_651();
			SYSTEM::WAIT(0);
		}
...
int func_389(bool bParam0, int iParam1)//Position - 0x18DEB
{
	...
	*iParam1 = -1;
	...
	if (func_254())
	{
		...
		iVar11 = -1;
		while (func_239(&iVar11, iVar3, *iParam1, -1616616027, 235173372, iVar8, iVar9, iVar7, iVar10, 0, 0, 0))
		{
			func_651();
			SYSTEM::WAIT(0);
		}
