...
void func_4()//Position - 0x48C
{
	...
	if (iVar1 != -1 && iVar1 < func_5())
	{
		...
		GRAPHICS::_SCALEFORM_MOVIE_METHOD_ADD_PARAM_TEXTURE_NAME_STRING_2(&(Local_748[iVar1 /*16*/]));
...
int func_230(int iParam0)//Position - 0xAE7C
{
	...
	if (iVar1 == 0 || iVar1 == 11)
	{
		...
		MONEY::_NETWORK_SPENT_PURCHASE_IMPORTEXPORT_WAREHOUSE(iVar7, &Var14, false, true);
	}
	else
	{
		if (iVar0 > 0)
		...
		if (iVar7 > 0)
		{
			...
			MONEY::_0x2FAB6614CE22E196(iVar7, &Var15, 0, 1);
		}
	}
	if (func_254())
	{
...
int func_291(int iParam0, int iParam1)//Position - 0x158E1
{
	...
	if (iVar1 > 0)
	{
		...
		MONEY::_NETWORK_SPENT_UPGRADE_IMPORTEXPORT_WAREHOUSE(iVar1, &Var5, 0, 1);
	}
	if (func_254())
	{
		func_231(func_236());
...
int func_318(bool bParam0, int iParam1)//Position - 0x1652B
{
	...
	if (iVar6 >= 0 && (iVar6 == 0 || (iVar6 > 0 && (func_254() || MONEY::NETWORK_CAN_SPEND_MONEY(iVar6, false, true, false, -1, 0)))))
	{
		...
		MONEY::_NETWORK_BUY_CONTRABAND(iVar4, bParam0, MISC::GET_HASH_KEY(&cVar1), false, true);
		if (func_254())
		{
			func_231(func_236());
		}
	...
	*iParam1 = -1;
	...
	if (iVar5 >= 0 && (iVar5 == 0 || (iVar5 > 0 && (func_254() || MONEY::NETWORK_CAN_SPEND_MONEY(iVar5, false, true, false, -1, 0)))))
	{
		...
		if (bVar6 <= 0 || bVar6 > 22)
		{
			...
			MONEY::_NETWORK_SPENT_PURCHASE_WAREHOUSE(iVar3, &Var12, 0, 1);
		}
		else if (iVar5 > 0)
		{
			if (func_254())
			...
			MONEY::_NETWORK_SPENT_UPGRADE_WAREHOUSE(iVar5, &Var12, 0, 1);
		}
		if (func_254())
		{
			func_231(func_236());
								...
								if (bVar33)
								{
									...
									if (MISC::GET_HASH_KEY(&(Global_23150.f_79[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										else
										{
											...
											if (func_345() && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (iVar8 == 0)
												{
													if (Global_23150.f_2130[iVar24])
	...
	if (!BitTest(uParam0->f_373, 2))
	{
		...
		while (iVar1 >= 0)
		{
			...
			if (bVar3 > 0)
			{
				...
				if (func_460())
				{
					func_459(HUD::_GET_LABEL_TEXT(func_334(bVar3)), 0, 0, 0);
				}
				else
				{
					func_458(HUD::_GET_LABEL_TEXT(func_334(bVar3)), 0, 1, 1);
				}
...
void func_484(var uParam0, int iParam1, int iParam2, struct<3> Param3, var uParam4, struct<3> Param5, bool bParam6, bool bParam7, var uParam8, var uParam9, int iParam10, bool bParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16, bool bParam17, bool bParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)//Position - 0x203B2
{
	...
	else if (bParam17)
	{
		...
		Var0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_527(iVar6), func_526(iVar6), 3.5688f, 7.9792f, 4.1641f) };
...
void func_595()//Position - 0x247AB
{
	if (iLocal_731 == 2 || iLocal_731 == 5)
	{
		...
		{
			if (GRAPHICS::_GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_BOOL(iLocal_552))
			{
				MISC::SET_BIT(&iLocal_554, 16);
			}
			else
	...
	if (Global_75652)
	{
		if (Global_75650)
		{
			if (PAD::IS_CONTROL_JUST_PRESSED(2, 201) || (PAD::IS_CONTROL_JUST_PRESSED(2, 237) && !HUD::IS_WARNING_MESSAGE_ACTIVE()))
			{
				...
				NETWORK::_0xFAE628F1E9ADB239(Global_75653, Global_75654, 0);
...
void func_685(int iParam0, int iParam1)//Position - 0x277B1
{
	...
	GRAPHICS::_SCALEFORM_MOVIE_METHOD_ADD_PARAM_TEXTURE_NAME_STRING_2(func_686(iParam0));
...
int func_689(int iParam0)//Position - 0x27AA3
{
	...
	if (iParam0 != func_9())
	{
		...
		else if (func_559() || MISC::_0x807ABE1AB65C24D2())
		{
			if (NETWORK::NETWORK_HAVE_USER_CONTENT_PRIVILEGES(0))
			{
				if (NETWORK::NETWORK_CAN_VIEW_GAMER_USER_CONTENT(&Var0))
...
void func_701(bool bParam0)//Position - 0x27CB0
{
	...
	if (BitTest(iLocal_554, 13))
	{
		...
		GRAPHICS::_SCALEFORM_MOVIE_METHOD_ADD_PARAM_TEXTURE_NAME_STRING_2(func_686(PLAYER::PLAYER_ID()));
...
bool func_730(int iParam0)//Position - 0x29202
{
	...
	if (bVar0)
	{
		...
		while (!bVar7)
		{
			...
			{
				StringCopy(&(Local_757[iVar5 /*16*/]), HUD::_GET_TEXT_SUBSTRING_SAFE(sVar2, iVar3, iVar4, 63), 64);
