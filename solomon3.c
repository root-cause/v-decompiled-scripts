...
void func_7(bool bParam0, int iParam1)//Position - 0xEB3
{
	...
	if (Global_114370.f_9088 || func_453(0))
	{
		iVar0 = func_8();
...
void func_62(int iParam0, bool bParam1)//Position - 0x4598
{
	...
	if (func_38(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_63(iParam0, &(Global_114370.f_2366.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_155(int iParam0, int iParam1)//Position - 0x120D3
{
	...
	func_39(iParam0, &(Global_114370.f_32752.f_5510));
}
...
int func_167(int iParam0, int iParam1)//Position - 0x12A49
{
	...
	return func_139(Global_114370.f_32752.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}
...
int func_169(var uParam0, int iParam1)//Position - 0x12AC7
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_73(Global_114370.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_73(Global_114370.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_73(Global_114370.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_261(int iParam0)//Position - 0x18BFC
{
	...
	func_262(&(Global_114370.f_2366.f_539), iVar1);
...
void func_262(var uParam0, int iParam1)//Position - 0x18D0C
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_264(Global_114370.f_18536[iVar0], &Var2, &fVar5))
			{
...
void func_405(float fParam0)//Position - 0x259FF
{
	...
	while (iVar0 < 9)
	{
		if (func_411(&(Global_114370.f_18106.f_175[iVar0 /*19*/].f_5)))
		{
			func_406(&(Global_114370.f_18106.f_175[iVar0 /*19*/].f_5), (fParam0 * 60f));
		}
		iVar0++;
	}
	iVar1 = 0;
	while (iVar1 < 6)
	{
		if (func_411(&(Global_114370.f_18106.f_362[iVar1 /*3*/])))
		{
			func_406(&(Global_114370.f_18106.f_362[iVar1 /*3*/]), (fParam0 * 60f));
		}
		iVar1++;
	}
