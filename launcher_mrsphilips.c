...
void __EntryFunction__()//Position - 0x0
{
	...
	iVar2[0] = 35;
	if (!func_248(&iVar2, &Var0, Var1, 1f))
	{
		func_247();
	...
	while (true)
	{
		...
		func_197(Var0.f_0);
		func_189(&iLocal_51, &(Var0.f_9), Var1);
		if (func_174(&Var0, 0))
		{
			if (Var0.f_0 == 35)
			{
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5C9E
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x6461
{
	if (bParam2)
	{
...
int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6928
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_84(struct<3> Param0, float fParam1)//Position - 0x75E5
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
float func_193(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xCE7B
{
	struct<3> Var0;
...
bool func_212(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDF28
{
	...
	iVar2 = func_220(iParam0, iParam1);
	if (!func_132(iParam0) || !func_132(iParam1))
	{
		if (iVar2 != -1)
		{
			func_219(&(Local_37[iVar2 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_213(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_213(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xDFE9
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_216(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE224
{
	...
	{
		Var1 = { func_218(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_217(Var1, Var0);
...
float func_217(struct<3> Param0, struct<3> Param1)//Position - 0xE2B5
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_225(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xE633
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_248(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xEE20
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_249((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_249((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_249(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xEE85
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_250(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_250(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0xEEFD
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
