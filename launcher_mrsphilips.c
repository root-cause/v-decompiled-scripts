...
int func_64(int iParam0, int iParam1)//Position - 0x482A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x556B
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x55A6
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x581A
{
	bool bVar0;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5DA5
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6568
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x65AF
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x661A
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6A2D
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A3D
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x7548
{
...
int func_83()//Position - 0x7572
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

Vector3 func_84(struct<3> Param0)//Position - 0x758A
{
...
int func_86(int iParam0)//Position - 0x75B6
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x76B8
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x774D
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_93(int iParam0, var uParam1)//Position - 0x83EB
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0)//Position - 0x846D
{
	if (iParam0 != func_95())
	{
...
int func_98(int iParam0)//Position - 0x874A
{
	return MISC::GET_BITS_IN_RANGE(Global_2657971[iParam0 /*465*/].f_322.f_3, 28, 31);
}

int func_99(int iParam0)//Position - 0x8767
{
...
var func_107(int iParam0)//Position - 0x8CB0
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8CD2
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8CE9
{
	return uParam0 & 15;
}
...
bool func_115()//Position - 0x8E19
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_116()//Position - 0x8E2F
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x8E45
{
...
int func_118(bool bParam0)//Position - 0x8E86
{
...
int func_123(var* uParam0)//Position - 0xA886
{
	int iVar0;
...
void func_127(int iParam0)//Position - 0xAA24
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0)//Position - 0xAB00
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xABF9
{
...
int func_135(int iParam0)//Position - 0xAC60
{
	int iVar0;
...
int func_136(int iParam0)//Position - 0xACA9
{
	if (func_137(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xACC9
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_138(int iParam0)//Position - 0xACEA
{
	switch (iParam0)
	{
		case 5:
...
int func_140(int iParam0)//Position - 0xADBA
{
	switch (iParam0)
	{
		case 5:
...
void func_141(var uParam0, bool bParam1, bool bParam2)//Position - 0xAE0D
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0xAF02
{
	switch (iParam0)
	{
		case 5:
...
void func_144(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAFAC
{
	if (bParam0)
	{
...
bool func_146(int iParam0, int iParam1)//Position - 0xB113
{
	bool bVar0;
...
int func_148(var uParam0)//Position - 0xB1AD
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xB1CF
{
...
int func_151(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB21C
{
	int iVar0;
...
int func_154(char* sParam0)//Position - 0xB299
{
...
int func_160(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB3CC
{
...
void func_161(int iParam0)//Position - 0xB423
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_168(int iParam0)//Position - 0xB730
{
	if (iParam0 == 1)
	{
...
int func_170(int iParam0)//Position - 0xB796
{
...
int func_171(int iParam0)//Position - 0xB7D7
{
	int iVar0;
...
int func_173(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB84E
{
	int iVar0;
...
void func_174(var uParam0, int iParam1)//Position - 0xB985
{
	int iVar0;
...
bool func_175(int iParam0)//Position - 0xB9D4
{
	return func_176(iParam0, Global_44042);
}

int func_176(int iParam0, int iParam1)//Position - 0xB9E5
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_177(int iParam0)//Position - 0xBBC6
{
	if (Global_44042 == 15)
	{
		return 0;
...
int func_179(char* sParam0, int iParam1)//Position - 0xBBF9
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_181(var uParam0, int iParam1)//Position - 0xBC66
{
	switch (uParam0->f_16)
	{
		case 0:
...
int func_183(var uParam0)//Position - 0xC465
{
	float fVar0;
...
void func_184(int iParam0, int iParam1)//Position - 0xC4F3
{
	if (iParam0 == 1)
	{
		if (!func_140(iParam1))
...
int func_185(bool bParam0)//Position - 0xC557
{
	int iVar0;
...
int func_186(int iParam0)//Position - 0xC5EE
{
	if (func_137(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_187(int iParam0)//Position - 0xC618
{
	bool bVar0;
...
var func_188()//Position - 0xCD35
{
	return Global_101572.f_1;
}

int func_189()//Position - 0xCD43
{
	if (Global_98435 != -1)
	{
...
var func_193(int iParam0, int iParam1)//Position - 0xCDBB
{
	switch (iParam0)
	{
		case 5:
...
var func_194()//Position - 0xCDF3
{
	return Global_1575083;
}

int func_195()//Position - 0xCDFF
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_196(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xCE1B
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_199(int iParam0, int iParam1)//Position - 0xCF81
{
	bool bVar0;
	int iVar1;
...
float func_200(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD01F
{
	struct<3> Var0;
...
void func_202(int iParam0)//Position - 0xD065
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_203(iParam0);
...
void func_203(int iParam0)//Position - 0xD07C
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_205(var uParam0, bool bParam1)//Position - 0xD18C
{
	struct<27> Var0;
...
void func_206(int iParam0, var uParam1, int iParam2)//Position - 0xD3FC
{
	int iVar0;
	int iVar1;
...
int func_207(int iParam0)//Position - 0xD754
{
...
int func_208(var uParam0)//Position - 0xD774
{
...
int func_209(var uParam0)//Position - 0xD78C
{
...
void func_211(int* iParam0)//Position - 0xDAB5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_213(var uParam0, bool bParam1, bool bParam2)//Position - 0xDB60
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_214(int iParam0, int iParam1)//Position - 0xDD1E
{
	int iVar0;
...
int func_215(var uParam0, bool bParam1, int iParam2)//Position - 0xDD4E
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0)//Position - 0xE00A
{
...
int func_217(int iParam0, float fParam1)//Position - 0xE03E
{
	float fVar0;
...
bool func_218(int iParam0, float fParam1)//Position - 0xE0B4
{
	return func_219(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE0CC
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_220(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE18D
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_221(int iParam0, int iParam1)//Position - 0xE2B9
{
	int iVar0;
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE3C8
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_224(struct<3> Param0, struct<3> Param3)//Position - 0xE459
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_225(struct<3> Param0)//Position - 0xE47A
{
	float fVar0;
	float fVar1;
...
int func_227(int iParam0, int iParam1)//Position - 0xE4D4
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0xE513
{
...
int func_229(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE53B
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_230(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE636
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_231(int iParam0, float fParam1)//Position - 0xE742
{
	var uVar0;
	struct<3> Var1;
...
int func_232(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE7D7
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_233(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE865
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_234(int iParam0)//Position - 0xE8AD
{
...
void func_235(int iParam0)//Position - 0xE8F7
{
	int iVar0;
...
int func_236(int iParam0)//Position - 0xE994
{
	if (iParam0 == -1)
	{
		iParam0 = func_178();
...
int func_237(int iParam0)//Position - 0xEA29
{
...
int func_240(int iParam0)//Position - 0xEAA8
{
...
int func_242(int iParam0)//Position - 0xEB1A
{
	if (func_118(0))
	{
...
void func_243(int iParam0)//Position - 0xEB42
{
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
...
void func_244(int iParam0)//Position - 0xEB6F
{
	iParam0->f_16 = 5;
...
int func_245(int iParam0)//Position - 0xEBC4
{
	struct<27> Var0;
	bool bVar32;
...
int func_246(int iParam0)//Position - 0xEC15
{
	char* sVar0;
...
int func_247(int iParam0)//Position - 0xECCE
{
	var uVar0;
...
int func_248(int iParam0)//Position - 0xED8F
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_250(int iParam0)//Position - 0xEEF4
{
...
int func_251(int iParam0)//Position - 0xEF1F
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_252(int iParam0)//Position - 0xEF4A
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_253(int iParam0)//Position - 0xEF75
{
	if (func_237(iParam0))
	{
		return 0;
...
int func_255(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xEFC4
{
	int iVar0;
...
int func_256(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xF029
{
	int iVar0;
	struct<7> Var1;
...
int func_257(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xF0A1
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_258(int iParam0, bool bParam1)//Position - 0xF11C
{
	if (bParam1)
	{
...
void func_262(int* iParam0, bool bParam1)//Position - 0xF1E0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_265(int* iParam0)//Position - 0xF26A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_266(int* iParam0)//Position - 0xF2A2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_269(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF391
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_270(int* iParam0)//Position - 0xF3E1
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_271(var uParam0)//Position - 0xF422
{
	if (*uParam0 == -1)
	{
		return;
