...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		func_265("Force cleanup [TERMINATING]");
		if (Var0.f_0 != -1)
		{
			if (Global_112735[Var0.f_0 /*10*/].f_9 != -1)
			{
				func_265("Relinquishing candidate id...");
				func_264(&(Global_112735[Var0.f_0 /*10*/].f_9));
			}
		}
		func_251(&Var0, 1);
	}
	iVar64[0] = 35;
	if (!func_248(&iVar64, &Var0, Var61, 1f))
	{
		func_247();
		func_265("SCRIPT TERMINATED");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	if (!func_239(Var0.f_0))
	{
		func_247();
		func_265("SCRIPT TERMINATED");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	if (func_238(Var0.f_0))
	{
		func_247();
		func_265("SCRIPT TERMINATED");
		SCRIPT::TERMINATE_THIS_THREAD();
	...
	while (true)
	{
		...
		func_197(Var0.f_0);
		func_189(&iLocal_91, &(Var0.f_9), Var61);
		if (func_174(&Var0, 0))
		{
			if (Var0.f_0 == 35)
			{
...
int func_2(int iParam0)//Position - 0x27E
{
	...
	if (!func_173())
	{
		while (!func_164(*iParam0))
		{
			...
			if (!func_198(iParam0, *iParam0 != 2))
			{
				func_265("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			SYSTEM::WAIT(0);
		}
	...
	if (!func_118(iParam0))
	{
		func_265("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
void func_4(int iParam0)//Position - 0x3F7
{
	int iVar0;
	int iVar1;
...
void func_6(int iParam0)//Position - 0x604
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0)//Position - 0x9EC
{
	Global_63355 = 1;
	Global_63358 = 1;
	if (Global_75457 > 15)
...
void func_8(int iParam0)//Position - 0xA37
{
...
struct<2> func_9(int iParam0)//Position - 0xA6B
{
	struct<2> Var0;
	char[] cVar2[8];
...
void func_13()//Position - 0xB5B
{
	Global_63521 = 0;
}

void func_14()//Position - 0xB67
{
	Global_63381 = 0;
...
var func_15(int iParam0)//Position - 0xBBB
{
	var uVar0;
...
void func_17(int iParam0)//Position - 0xBF9
{
...
void func_21(char* sParam0)//Position - 0xCB0
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xCC3
{
	MISC::CLEAR_BIT(&(Global_100681.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xCE0
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x19B8
{
	int iVar0;
	int iVar1;
...
int func_26(var uParam0)//Position - 0x2841
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2863
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x28EB
{
...
int func_29(int iParam0)//Position - 0x292B
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2959
{
...
int func_31(int iParam0)//Position - 0x2A35
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2A77
{
	int iVar0;
...
int func_33(int iParam0, bool bParam1, int iParam2)//Position - 0x2ADA
{
	int iVar0;
...
int func_34(bool bParam0, int iParam1)//Position - 0x2B68
{
	struct<82> Var0;
...
void func_35(bool bParam0, var uParam1, int iParam2)//Position - 0x2BAA
{
	int iVar0;
...
bool func_36(bool bParam0)//Position - 0x2E05
{
	return bParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E11
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x30BC
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x316C
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x335F
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0)//Position - 0x337F
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x342F
{
	char* sVar0;
...
int func_43(int iParam0, bool bParam1, bool bParam2)//Position - 0x355E
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x35CC
{
...
int func_45(int iParam0)//Position - 0x36A4
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x36E1
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x3706
{
	return Global_2028[iParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3715
{
	bool bVar0;
	int iVar1;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x38B5
{
	int iVar0;
	var uVar1;
...
int func_50(var uParam0)//Position - 0x38F2
{
	int iVar0;
	int iVar1;
...
int func_51()//Position - 0x3926
{
	return Global_1574918;
}

int func_52(int iParam0, int iParam1)//Position - 0x3932
{
	int iVar0;
	var uVar1;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x395E
{
	int iVar0;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EA7
{
	int iVar0;
...
int func_55()//Position - 0x40E9
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_56()//Position - 0x4102
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x41FF
{
	return Global_43257 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x420D
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x4300
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x4588
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x4629
{
...
int func_62(int iParam0, int iParam1)//Position - 0x4803
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x5464
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x549F
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x5713
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x574F
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5C9E
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5CE2
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6461
{
	if (bParam6)
	{
...
int func_70(var uParam0)//Position - 0x64A8
{
...
bool func_71(int iParam0)//Position - 0x6503
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x6513
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x6574
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x690D
{
	return Global_32163;
}

int func_75(int iParam0)//Position - 0x6918
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6928
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x69CA
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_78()//Position - 0x711A
{
...
int func_79()//Position - 0x7415
{
	return Global_2652258.f_2650;
}

int func_80(struct<3> Param0)//Position - 0x7424
{
...
int func_81(int iParam0)//Position - 0x744E
{
	if (iParam0 != func_90())
	{
...
Vector3 func_82(int iParam0, int iParam1)//Position - 0x74A6
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_83(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7550
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_84(struct<3> Param0, float fParam3)//Position - 0x75E5
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_85(int iParam0)//Position - 0x7629
{
	struct<6> Var0;
...
struct<6> func_86(int iParam0)//Position - 0x77AD
{
	return func_87(iParam0);
}

struct<6> func_87(int iParam0)//Position - 0x77BB
{
	struct<6> Var0;
...
int func_88(int iParam0, var uParam1)//Position - 0x8287
{
	switch (iParam0)
	{
		case 0:
...
int func_89(int iParam0)//Position - 0x8309
{
	if (iParam0 != func_90())
	{
...
int func_90()//Position - 0x8361
{
	return -1;
}

Vector3 func_91(int iParam0)//Position - 0x836A
{
	switch (iParam0)
	{
		case 1:
...
int func_92()//Position - 0x85E1
{
	return func_93(PLAYER::PLAYER_ID());
}

int func_93(int iParam0)//Position - 0x85F1
{
	return MISC::GET_BITS_IN_RANGE(Global_2657589[iParam0 /*466*/].f_321.f_3, 28, 31);
}

int func_94(int iParam0)//Position - 0x860E
{
	return func_72(iParam0, 0, 0);
}

int func_95(int iParam0)//Position - 0x861E
{
	switch (iParam0)
	{
		case -1:
...
bool func_96()//Position - 0x8947
{
	return Global_100733.f_387 > 0;
}

var func_97()//Position - 0x8958
{
	var uVar0;
...
void func_98(var uParam0, int iParam1)//Position - 0x899E
{
	if (iParam1 <= 0)
	{
		return;
...
void func_99(var uParam0, int iParam1)//Position - 0x8A24
{
...
void func_100(var uParam0, int iParam1)//Position - 0x8A57
{
	int iVar0;
	int iVar1;
...
int func_101(int iParam0, int iParam1)//Position - 0x8AA8
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_102(int iParam0)//Position - 0x8B4A
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_103(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_103(bool bParam0, int iParam1, int iParam2)//Position - 0x8B6C
{
	if (bParam0)
	{
		return iParam1;
...
int func_104(var uParam0)//Position - 0x8B83
{
	return uParam0 & 15;
}

void func_105(var uParam0, int iParam1)//Position - 0x8B90
{
...
void func_106(var uParam0, int iParam1)//Position - 0x8BCA
{
...
void func_107(var uParam0, int iParam1)//Position - 0x8C05
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_108()//Position - 0x8C41
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_109(int iParam0)//Position - 0x8C5A
{
	var uVar0;
	char cVar1[24];
...
bool func_110()//Position - 0x8CB3
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_111()//Position - 0x8CC9
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_112(char* sParam0, int iParam1, int iParam2)//Position - 0x8CDF
{
...
int func_113(bool bParam0)//Position - 0x8D20
{
...
struct<2> func_114(int iParam0)//Position - 0x8D48
{
	struct<2> Var0;
...
void func_115(int iParam0, var uParam1)//Position - 0x9194
{
	switch (iParam0)
	{
		case 0:
...
int func_117(int iParam0)//Position - 0xA3DA
{
	switch (iParam0)
	{
		case 0:
...
int func_118(var* uParam0)//Position - 0xA720
{
	int iVar0;
	...
	if (func_148(&(uParam0->f_1)))
	{
		...
		{
			func_265("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::SET_SCRIPT_CAN_START_CUTSCENE(iVar0);
		}
		else
		{
			func_265("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_119(int iParam0)//Position - 0xA7C5
{
	struct<2> Var0;
...
void func_120(int iParam0)//Position - 0xA860
{
	if (iParam0 < 63)
	{
		func_121();
...
void func_122(int iParam0)//Position - 0xA8BE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_123(int iParam0)//Position - 0xA917
{
...
int func_124(int iParam0)//Position - 0xA99A
{
	int iVar0;
...
void func_125(int iParam0, int iParam1, int iParam2)//Position - 0xA9CB
{
	func_126(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_126(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA9E0
{
	int iVar0;
...
int func_128(int iParam0, int iParam1, int iParam2)//Position - 0xAA93
{
...
int func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAAAE
{
	int iVar0;
...
int func_130(int iParam0)//Position - 0xAAFA
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0xAB43
{
	if (func_132(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_132(int iParam0)//Position - 0xAB63
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_133(int iParam0)//Position - 0xAB84
{
	switch (iParam0)
	{
		case 5:
...
int func_135(int iParam0)//Position - 0xAC54
{
	switch (iParam0)
	{
		case 5:
...
void func_136(var uParam0, bool bParam1, bool bParam2)//Position - 0xACA7
{
	int iVar0;
...
int func_137(int iParam0)//Position - 0xAD9C
{
	switch (iParam0)
	{
		case 5:
...
void func_138(bool bParam0)//Position - 0xAE07
{
	int iVar0;
...
void func_139(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAE46
{
	if (bParam0)
	{
...
bool func_140()//Position - 0xAF93
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_141(int iParam0, int iParam1)//Position - 0xAFAD
{
	bool bVar0;
...
int func_142(int iParam0, bool bParam1)//Position - 0xAFF8
{
	int iVar0;
	int iVar1;
...
int func_143(int iParam0)//Position - 0xB039
{
...
bool func_144()//Position - 0xB078
{
	return BitTest(Global_2621446, 3);
}

int func_145(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB086
{
	int iVar0;
...
void func_147(int iParam0)//Position - 0xB0E0
{
	if (iParam0 == 1)
	{
...
int func_148(char* sParam0)//Position - 0xB103
{
	...
	func_265("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}

void func_149()//Position - 0xB140
{
	Global_20591 = 0;
	func_150();
}

void func_150()//Position - 0xB150
{
...
int func_154(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB236
{
...
void func_155(int iParam0)//Position - 0xB3CE
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_157(int iParam0)//Position - 0xB44B
{
	if (func_162())
	{
		return;
...
void func_158(int iParam0)//Position - 0xB47E
{
	if (func_162())
	{
		return;
...
void func_159(bool bParam0, bool bParam1)//Position - 0xB508
{
	if (bParam0)
	{
		if (func_161(0))
...
bool func_160()//Position - 0xB57C
{
	return BitTest(Global_1962996, 5);
}

int func_161(int iParam0)//Position - 0xB58A
{
	if (iParam0 == 1)
	{
...
bool func_162()//Position - 0xB5E1
{
	return BitTest(Global_1962996, 19);
}

int func_163(int iParam0)//Position - 0xB5F0
{
...
int func_164(int iParam0)//Position - 0xB631
{
	int iVar0;
...
void func_165(int iParam0)//Position - 0xB676
{
...
int func_166(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB6A8
{
	int iVar0;
...
void func_167(var uParam0, int iParam1)//Position - 0xB7DF
{
	int iVar0;
...
bool func_168(int iParam0)//Position - 0xB82E
{
	return func_169(iParam0, Global_43257);
}

int func_169(int iParam0, int iParam1)//Position - 0xB83F
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_170(int iParam0)//Position - 0xBA20
{
	if (Global_43257 == 15)
	{
		return 0;
...
int func_171()//Position - 0xBA42
{
	return func_172(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_172(char* sParam0, int iParam1)//Position - 0xBA53
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_174(var uParam0, int iParam1)//Position - 0xBAC0
{
	switch (uParam0->f_16)
	{
		case 0:
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_180(2))
							{
								if (func_178(uParam0->f_27))
								{
									...
									func_265("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.88849f, 371.9034f, 103.98843f, 241.58984f, 359.64575f, 107.34612f, 1.25f, false, true, 0))
					{
						if (func_180(2))
						{
							...
							{
								func_177(uParam0->f_27, *uParam0);
								func_265("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.9482f, 4143.44f, 42.292946f, 2722.2134f, 4144.5215f, 45.431824f, 10f, false, true, 0))
				{
					if (func_180(2))
					{
						...
						{
							func_177(1, *uParam0);
							func_265("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.11035f, 68.460175f, -1028.5663f, 395.46133f, 94.57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.75565f, 68.02096f, -1021.4514f, 336.34583f, 93.18714f, 14.5f, false, true, 0))
						{
							if (func_180(2))
							{
								...
								{
									func_177(uParam0->f_27, *uParam0);
									func_265("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_175()//Position - 0xC2A6
{
	func_27(&(Global_104212.f_2890), &Global_104212, 0, 1, 1, 0);
}

int func_176(var uParam0)//Position - 0xC2C1
{
	float fVar0;
...
void func_177(int iParam0, int iParam1)//Position - 0xC34F
{
	if (iParam0 == 1)
	{
		if (!func_135(iParam1))
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_265("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_265("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
int func_178(bool bParam0)//Position - 0xC3B3
{
	int iVar0;
...
int func_179(int iParam0)//Position - 0xC44A
{
	if (func_132(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_180(int iParam0)//Position - 0xC474
{
	bool bVar0;
...
var func_181()//Position - 0xCB91
{
	return Global_100720.f_1;
}

int func_182()//Position - 0xCB9F
{
	if (Global_97603 != -1)
	{
...
bool func_185()//Position - 0xCC06
{
	return Global_100733.f_388 > 0;
}

var func_186(int iParam0, int iParam1)//Position - 0xCC17
{
	switch (iParam0)
	{
		case 5:
...
var func_187()//Position - 0xCC4F
{
	return Global_1575060;
}

int func_188()//Position - 0xCC5B
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_189(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xCC77
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_193(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_192(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_193(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_195(iParam0);
				}
			}
...
void func_190(int iParam0, bool bParam1)//Position - 0xCD68
{
	if (iParam0 == -1)
	{
		return;
...
int func_191(int iParam0)//Position - 0xCDA4
{
	if (Global_78554 == iParam0)
	{
		if (Global_78555 == -1)
...
void func_192(int iParam0, int iParam1)//Position - 0xCDDD
{
	bool bVar0;
	int iVar1;
...
float func_193(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xCE7B
{
	struct<3> Var0;
...
bool func_194()//Position - 0xCEB5
{
	return Global_97990;
}

void func_195(int iParam0)//Position - 0xCEC1
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_196(iParam0);
...
void func_196(int iParam0)//Position - 0xCED8
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_197(int iParam0)//Position - 0xCFC0
{
	if (iParam0 == -1)
	{
		iParam0 = func_171();
...
int func_198(var uParam0, bool bParam1)//Position - 0xCFE8
{
	struct<27> Var0;
	
	if (Global_78558)
	{
		func_265("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_115(*uParam0, &Var0);
	if ((func_235(*uParam0) || func_233(*uParam0)) || Global_78804 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_265("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_229(*uParam0))
	{
		if (*uParam0 == 19)
		{
			func_228(uParam0->f_28[0]);
		}
		func_265("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1)
	{
	...
	if (*uParam0 == 10)
	{
		...
		{
			func_265("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_265("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
	if (func_202(&(uParam0->f_48)) && bParam1)
	{
		func_199(uParam0->f_28[0], &(uParam0->f_48), *uParam0);
	}
	return 1;
}

void func_199(int iParam0, var uParam1, int iParam2)//Position - 0xD258
{
	int iVar0;
	int iVar1;
	...
	if (func_132(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_201(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_200(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_201(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_200(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
int func_200(int iParam0)//Position - 0xD5B0
{
...
int func_201(var uParam0)//Position - 0xD5D0
{
...
int func_202(var uParam0)//Position - 0xD5E8
{
...
void func_203(var uParam0)//Position - 0xD60D
{
	int iVar0;
	int iVar1;
	...
	if (*uParam0 == 52)
	{
		func_204(&(uParam0->f_41[1]));
		func_204(&(uParam0->f_41[2]));
	}
...
void func_204(int* iParam0)//Position - 0xD911
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_205(var uParam0)//Position - 0xD93C
{
	int iVar0;
...
int func_206(var uParam0, bool bParam1, bool bParam2)//Position - 0xD9BC
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_131(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				{
					func_265("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[iVar0], false))
				{
					func_265("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[iVar0], PLAYER::PLAYER_PED_ID(), false))
				{
					func_265("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[iVar0]) < 850)
				{
					func_265("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							func_265("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_179(iVar2))
						{
							if (ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck") || ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck2"))
							{
								if (func_179(uParam0->f_35[iVar0]))
								{
									...
									{
										func_265("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_179(iVar3))
						{
							...
							{
								func_265("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							if (func_207(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
								func_265("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
...
int func_207(int iParam0, int iParam1)//Position - 0xDB7A
{
	int iVar0;
...
int func_208(var uParam0, bool bParam1, int iParam2)//Position - 0xDBAA
{
	int iVar0;
	int iVar1;
	...
	if (func_131(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[iVar0]))
						{
							...
							func_265("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[iVar0]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[iVar0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[iVar0]))
					{
						...
						func_265("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[iVar0], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
						{
							...
							func_265("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_227(*uParam0))
					{
						if (!func_163(*uParam0))
						{
							if (func_222(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_203(uParam0);
								...
								func_265("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[iVar0], true), 15f))
						{
							...
							func_265("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_210(uParam0->f_28[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_203(uParam0);
							...
							func_265("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_209(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_265("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_265("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_132(uParam0->f_41[0]))
						{
...
int func_209(int iParam0)//Position - 0xDE66
{
...
int func_210(int iParam0, float fParam1)//Position - 0xDE9A
{
	float fVar0;
	
	if (func_132(PLAYER::PLAYER_PED_ID()) && func_132(iParam0))
	{
		if (func_221(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_211(int iParam0, float fParam1)//Position - 0xDF10
{
	return func_212(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_212(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDF28
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	
	iVar4 = func_220(iParam0, iParam1);
	if (!func_132(iParam0) || !func_132(iParam1))
	{
		if (iVar4 != -1)
		{
			func_219(&(Local_37[iVar4 /*4*/]));
		}
		return 0;
	}
	if (!func_216(iParam0, iParam1, fParam2, iParam3))
	{
		return 0;
	}
	if (iVar4 == -1)
	...
	uVar0 = func_213(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_213(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xDFE9
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_214(int iParam0, int iParam1)//Position - 0xE115
{
	int iVar0;
...
int func_216(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE224
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_218(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_218(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_217(Var3, Var0);
...
float func_217(struct<3> Param0, struct<3> Param3)//Position - 0xE2B5
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_218(struct<3> Param0)//Position - 0xE2D6
{
	float fVar0;
	float fVar1;
...
void func_219(var uParam0)//Position - 0xE315
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_220(int iParam0, int iParam1)//Position - 0xE330
{
	int iVar0;
...
int func_221(int iParam0)//Position - 0xE36F
{
...
int func_222(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE397
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_132(PLAYER::PLAYER_PED_ID()) && func_132(iParam0))
	{
		...
		if (!bParam2)
		{
			if (func_226(iParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_223(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_223(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE492
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_224(int iParam0, float fParam1)//Position - 0xE59E
{
	var uVar0;
	struct<3> Var1;
	...
	{
		if (func_225(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_225(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE633
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_218(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
int func_226(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE6C1
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_227(int iParam0)//Position - 0xE709
{
...
void func_228(int iParam0)//Position - 0xE753
{
	int iVar0;
...
int func_229(int iParam0)//Position - 0xE7F0
{
	if (iParam0 == -1)
	{
		iParam0 = func_171();
...
int func_230(int iParam0)//Position - 0xE885
{
...
int func_233(int iParam0)//Position - 0xE904
{
	if ((func_234() && Global_100681.f_11 == 6) && iParam0 == func_172(&(Global_100681.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_235(int iParam0)//Position - 0xE976
{
	if (func_113(0))
	{
...
void func_236(int iParam0)//Position - 0xE99E
{
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_265("Player out of range [TERMINATING]");
		func_251(iParam0, 1);
	}
	func_237(iParam0);
	func_265("Created initial scene");
}

void func_237(int iParam0)//Position - 0xE9CB
{
	iParam0->f_16 = 5;
...
int func_238(int iParam0)//Position - 0xEA20
{
	struct<27> Var0;
	bool bVar32;
...
int func_239(int iParam0)//Position - 0xEA71
{
	char* sVar0;
	
	if (Global_78558)
	{
		func_265("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!Global_113648.f_9087 && !func_113(1))
	{
		func_265("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_240(iParam0))
	{
		Global_112735[iParam0 /*10*/].f_1 = 1;
		func_265("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_100681.f_11 == 6)
	{
		if (Global_100681 < 9)
		{
			...
			{
				func_265("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	...
	{
		Global_112735[iParam0 /*10*/].f_1 = 1;
		func_265("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}

int func_240(int iParam0)//Position - 0xEB2A
{
	var uVar0;
...
int func_241(int iParam0)//Position - 0xEBEB
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_242(int iParam0, char* sParam1)//Position - 0xEC70
{
...
int func_243(int iParam0)//Position - 0xED50
{
...
int func_244(int iParam0)//Position - 0xED7B
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_245(int iParam0)//Position - 0xEDA6
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_246(int iParam0)//Position - 0xEDD1
{
	if (func_230(iParam0))
	{
		return 0;
...
void func_247()//Position - 0xEE06
{
	func_265("Running end routines.");
	Global_113366 = (Global_113366 - 1);
}

int func_248(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xEE20
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_249((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_249((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
	...
	func_265("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}

int func_249(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xEE85
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_250(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_250(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xEEFD
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_251(int iParam0, bool bParam1)//Position - 0xEF78
{
	if (bParam1)
	{
		func_265("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_252(iParam0, 0, 0, 0);
	}
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_92, false);
	if (iLocal_91 != -1)
	{
		func_265("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_196(&iLocal_91);
	}
	if (bParam1)
	{
...
void func_252(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xEFCC
{
...
void func_253(var uParam0, bool bParam1)//Position - 0xEFEC
{
	func_254(&(uParam0->f_41), bParam1);
}

void func_254(var uParam0, bool bParam1)//Position - 0xEFFE
{
	int iVar0;
...
void func_255(int* iParam0, bool bParam1)//Position - 0xF03C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_256(var uParam0, bool bParam1)//Position - 0xF077
{
	func_257(&(uParam0->f_35), bParam1);
}

void func_257(var uParam0, bool bParam1)//Position - 0xF089
{
	int iVar0;
...
void func_258(int* iParam0)//Position - 0xF0C6
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_259(int* iParam0)//Position - 0xF0FE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_260(var uParam0, int iParam1)//Position - 0xF19A
{
	func_261(&(uParam0->f_28), iParam1);
}

void func_261(var uParam0, int iParam1)//Position - 0xF1AC
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_262(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_262(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF1ED
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_263(int* iParam0)//Position - 0xF23D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_264(var uParam0)//Position - 0xF27E
{
	if (*uParam0 == -1)
	{
		return;
...
void func_265(char* sParam0)//Position - 0xF2BB
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_266(var uParam0)//Position - 0xF2CD
{
	*uParam0 = -1;
...
void func_267()//Position - 0xF2FF
{
	func_265("Running start routines.");
	Global_113366++;
}
