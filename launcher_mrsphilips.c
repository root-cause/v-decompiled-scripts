...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113222[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_271(&(Global_113222[Var0.f_0 /*10*/].f_9));
			}
		}
		func_258(&Var0, 1);
	}
	iVar64[0] = 35;
	if (!func_255(&iVar64, &Var0, Var61, 1f))
	{
		func_254();
	...
	while (true)
	{
		...
		func_204(Var0.f_0);
		func_196(&iLocal_89, &(Var0.f_9), Var61);
		if (func_181(&Var0, 0))
		{
			if (Var0.f_0 == 35)
			{
...
int func_1(int iParam0)//Position - 0x262
{
...
int func_2(int iParam0)//Position - 0x280
{
	struct<4> Var0;
	char* sVar32;
...
void func_3(int iParam0, char* sParam1)//Position - 0x341
{
	func_21(sParam1);
...
void func_17(int iParam0)//Position - 0xBFB
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xCC5
{
	MISC::CLEAR_BIT(&(Global_101688.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xCE2
{
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x28ED
{
...
int func_29(int iParam0)//Position - 0x292D
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x295B
{
...
int func_31(int iParam0)//Position - 0x2A37
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2A79
{
	int iVar0;
...
int func_33(int iParam0, bool bParam1, int iParam2)//Position - 0x2ADC
{
	int iVar0;
...
int func_34(bool bParam0, int iParam1)//Position - 0x2B6A
{
	struct<82> Var0;
...
void func_35(bool bParam0, var uParam1, int iParam2)//Position - 0x2BAC
{
	int iVar0;
...
bool func_36(bool bParam0)//Position - 0x2E07
{
	return bParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E13
{
	int iVar0;
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x316E
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x3361
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3431
{
	char* sVar0;
...
int func_43(int iParam0, bool bParam1, bool bParam2)//Position - 0x3560
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x35CE
{
...
int func_45(int iParam0)//Position - 0x36A6
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x36E3
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x3708
{
...
int func_50(int iParam0, var uParam1)//Position - 0x38E0
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(uParam1));
}

int func_51(var uParam0)//Position - 0x38F5
{
	int iVar0;
	int iVar1;
...
int func_53(int iParam0, int iParam1)//Position - 0x3935
{
	int iVar0;
	var uVar1;
...
int func_54(int iParam0, var uParam1)//Position - 0x3959
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(uParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x396E
{
	int iVar0;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EB7
{
	int iVar0;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5DEB
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x65AE
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x65F5
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x6660
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6A82
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A92
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x75B8
{
...
Vector3 func_84(struct<3> Param0)//Position - 0x75FA
{
...
int func_86(int iParam0)//Position - 0x7626
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7728
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x77BD
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_118(bool bParam0)//Position - 0x8F29
{
...
int func_123(var* uParam0)//Position - 0xA929
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAC9C
{
...
int func_136(int iParam0)//Position - 0xAD4C
{
	if (func_137(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xAD6C
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_138(int iParam0)//Position - 0xAD8D
{
	switch (iParam0)
	{
		case 5:
...
int func_140(int iParam0)//Position - 0xAE5D
{
	switch (iParam0)
	{
		case 5:
...
void func_141(var uParam0, bool bParam1, bool bParam2)//Position - 0xAEB0
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0xAFA6
{
	switch (iParam0)
	{
		case 5:
...
void func_144(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB050
{
	if (bParam0)
	{
...
int func_148(var uParam0)//Position - 0xB253
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xB275
{
...
int func_151(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB2C2
{
	int iVar0;
...
int func_154(char* sParam0)//Position - 0xB33F
{
...
int func_160(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB472
{
...
void func_161(int iParam0)//Position - 0xB4C9
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_168(int iParam0)//Position - 0xB7D6
{
	if (iParam0 == 1)
	{
...
int func_170(int iParam0)//Position - 0xB83C
{
...
int func_171(int iParam0)//Position - 0xB87D
{
	int iVar0;
...
int func_173(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB8F4
{
	int iVar0;
...
void func_174(var uParam0, int iParam1)//Position - 0xBA2B
{
	int iVar0;
...
bool func_175(int iParam0)//Position - 0xBA7A
{
	return func_176(iParam0, Global_44181);
}

int func_176(int iParam0, int iParam1)//Position - 0xBA8B
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_177(int iParam0)//Position - 0xBC6C
{
	if (Global_44181 == 15)
	{
		return 0;
...
int func_179(char* sParam0, int iParam1)//Position - 0xBC9F
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_181(var uParam0, int iParam1)//Position - 0xBD0C
{
	switch (uParam0->f_16)
	{
		case 0:
...
int func_183(var uParam0)//Position - 0xC50C
{
	float fVar0;
...
void func_184(int iParam0, int iParam1)//Position - 0xC59A
{
	if (iParam0 == 1)
	{
		if (!func_140(iParam1))
...
int func_185(bool bParam0)//Position - 0xC5FE
{
	int iVar0;
...
int func_186(int iParam0)//Position - 0xC695
{
	if (func_137(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_187(int iParam0)//Position - 0xC6BF
{
	bool bVar0;
...
var func_188()//Position - 0xCDDC
{
	return Global_101727.f_1;
}

int func_189()//Position - 0xCDEA
{
	if (Global_98585 != -1)
	{
...
var func_193(int iParam0, int iParam1)//Position - 0xCE62
{
	switch (iParam0)
	{
		case 5:
...
var func_194()//Position - 0xCE9A
{
	return Global_1575084;
}

int func_195()//Position - 0xCEA6
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_196(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xCEC2
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_199(int iParam0, int iParam1)//Position - 0xD028
{
	bool bVar0;
	int iVar1;
...
float func_200(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD0C6
{
	struct<3> Var0;
...
void func_202(int iParam0)//Position - 0xD10C
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_203(iParam0);
...
void func_203(int iParam0)//Position - 0xD123
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_205(var uParam0, bool bParam1)//Position - 0xD233
{
	struct<27> Var0;
	...
	if ((func_242(*uParam0) || func_240(*uParam0)) || Global_79785 == 1)
	{
		return 1;
	}
...
int func_207(int iParam0)//Position - 0xD7FB
{
...
int func_208(var uParam0)//Position - 0xD81B
{
...
int func_209(var uParam0)//Position - 0xD833
{
...
void func_211(int* iParam0)//Position - 0xDB5C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_213(var uParam0, bool bParam1, bool bParam2)//Position - 0xDC07
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_214(int iParam0, int iParam1)//Position - 0xDDC5
{
	int iVar0;
...
int func_215(var uParam0, bool bParam1, int iParam2)//Position - 0xDDF5
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0)//Position - 0xE0B1
{
...
int func_217(int iParam0, float fParam1)//Position - 0xE0E5
{
	float fVar0;
...
bool func_218(int iParam0, float fParam1)//Position - 0xE15B
{
	return func_219(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE173
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	uVar0 = func_220(&(Local_35[iVar4 /*4*/]), Var1, iParam1, &(Local_35[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar4 /*4*/].f_3) < iParam4);
}

int func_220(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE234
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_221(int iParam0, int iParam1)//Position - 0xE360
{
	int iVar0;
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE46F
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_224(struct<3> Param0, struct<3> Param3)//Position - 0xE500
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_225(struct<3> Param0)//Position - 0xE521
{
	float fVar0;
	float fVar1;
...
int func_227(int iParam0, int iParam1)//Position - 0xE57B
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0xE5BA
{
...
int func_229(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE5E2
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_230(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE6DD
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_231(int iParam0, float fParam1)//Position - 0xE7E9
{
	var uVar0;
	struct<3> Var1;
...
int func_232(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE87E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_233(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE90C
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_234(int iParam0)//Position - 0xE954
{
...
void func_235(int iParam0)//Position - 0xE99E
{
	int iVar0;
...
int func_236(int iParam0)//Position - 0xEA3B
{
	if (iParam0 == -1)
	{
		iParam0 = func_178();
...
int func_237(int iParam0)//Position - 0xEAD0
{
...
int func_240(int iParam0)//Position - 0xEB4F
{
...
int func_242(int iParam0)//Position - 0xEBC1
{
	if (func_118(0))
	{
...
void func_243(int iParam0)//Position - 0xEBE9
{
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
...
void func_244(int iParam0)//Position - 0xEC16
{
	iParam0->f_16 = 5;
...
int func_245(int iParam0)//Position - 0xEC6B
{
	struct<27> Var0;
	bool bVar32;
...
int func_246(int iParam0)//Position - 0xECBC
{
	char* sVar0;
...
int func_247(int iParam0)//Position - 0xED75
{
	var uVar0;
...
int func_248(int iParam0)//Position - 0xEE36
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_250(int iParam0)//Position - 0xEF9B
{
...
int func_251(int iParam0)//Position - 0xEFC6
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_252(int iParam0)//Position - 0xEFF1
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_253(int iParam0)//Position - 0xF01C
{
	if (func_237(iParam0))
	{
		return 0;
...
int func_255(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF06B
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_256((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_256((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_256(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xF0D0
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_257(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_257(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xF148
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_258(int iParam0, bool bParam1)//Position - 0xF1C3
{
	if (bParam1)
	{
...
void func_262(int* iParam0, bool bParam1)//Position - 0xF287
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_265(int* iParam0)//Position - 0xF311
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_266(int* iParam0)//Position - 0xF349
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_269(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF438
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_270(int* iParam0)//Position - 0xF488
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_271(var uParam0)//Position - 0xF4C9
{
	if (*uParam0 == -1)
	{
		return;
