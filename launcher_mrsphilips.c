...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		func_262("Force cleanup [TERMINATING]");
		if (Var0.f_0 != -1)
		{
			if (Global_112473[Var0.f_0 /*10*/].f_9 != -1)
			{
				func_262("Relinquishing candidate id...");
				func_261(&(Global_112473[Var0.f_0 /*10*/].f_9));
			}
		}
		func_248(&Var0, 1);
	}
	iVar2[0] = 35;
	if (!func_245(&iVar2, &Var0, Var1, 1f))
	{
		func_244();
		func_262("SCRIPT TERMINATED");
	...
	while (true)
	{
		...
		func_194(Var0.f_0);
		func_186(&iLocal_51, &(Var0.f_9), Var1);
		if (func_171(&Var0, 0))
		{
			if (Var0.f_0 == 35)
			{
...
int func_2(int iParam0)//Position - 0x27E
{
	...
	if (!func_170())
	{
		while (!func_161(*iParam0))
		{
			...
			if (!func_195(iParam0, *iParam0 != 2))
			{
				func_262("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			SYSTEM::WAIT(0);
		}
	...
	if (!func_115(iParam0))
	{
		func_262("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EA6
{
	int iVar0;
...
void func_58(int iParam0, bool bParam1)//Position - 0x420C
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x42FF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x4587
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x4622
{
...
int func_62(int iParam0, int iParam1)//Position - 0x47EA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x538B
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x53C6
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x563A
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x5676
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5BC5
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5C09
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x6388
{
	if (bParam2)
	{
...
int func_70(var uParam0)//Position - 0x63CF
{
...
bool func_71(int iParam0)//Position - 0x642A
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x643A
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x649B
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x6816
{
	return Global_31959;
}

int func_75(int iParam0)//Position - 0x6821
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6831
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x68D3
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x6FF8
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x7050
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x70FA
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
...
Vector3 func_81(struct<3> Param0, float fParam1)//Position - 0x718F
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_82(int iParam0)//Position - 0x71D3
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x7357
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x7365
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7E2C
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7EAE
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x7F06
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x7F0F
{
	switch (iParam0)
	{
		case 1:
...
int func_110(bool bParam0)//Position - 0x8894
{
...
struct<2> func_111(int iParam0)//Position - 0x88BC
{
	struct<2> Var0;
...
void func_112(int iParam0, var uParam1)//Position - 0x8D08
{
	switch (iParam0)
	{
		case 0:
...
int func_114(int iParam0)//Position - 0x9F4E
{
	switch (iParam0)
	{
		case 0:
...
int func_115(var* uParam0)//Position - 0xA294
{
	int iVar0;
	...
	if (func_145(&(uParam0->f_1)))
	{
		...
		{
			func_262("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::SET_SCRIPT_CAN_START_CUTSCENE(iVar0);
		}
		else
		{
			func_262("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_116(int iParam0)//Position - 0xA339
{
	struct<2> Var0;
...
void func_117(int iParam0)//Position - 0xA3D4
{
	if (iParam0 < 63)
	{
		func_118();
...
void func_119(int iParam0)//Position - 0xA432
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_120(int iParam0)//Position - 0xA48B
{
...
int func_121(int iParam0)//Position - 0xA50E
{
	int iVar0;
...
void func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA53F
{
	func_123(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_123(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA554
{
	int iVar0;
...
int func_125(int iParam0, int iParam1, int iParam2)//Position - 0xA607
{
...
int func_126(int iParam0, int iParam1, int iParam2)//Position - 0xA622
{
	int iVar0;
...
int func_127(int iParam0)//Position - 0xA66E
{
	int iVar0;
...
int func_128(int iParam0)//Position - 0xA6B7
{
	if (func_129(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_129(int iParam0)//Position - 0xA6D7
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_130(int iParam0)//Position - 0xA6F8
{
	switch (iParam0)
	{
		case 5:
...
int func_132(int iParam0)//Position - 0xA7C8
{
	switch (iParam0)
	{
		case 5:
...
void func_133(var uParam0, bool bParam1, bool bParam2)//Position - 0xA81B
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xA910
{
	switch (iParam0)
	{
		case 5:
...
void func_135(bool bParam0)//Position - 0xA97B
{
	int iVar0;
...
void func_136(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xA9BA
{
	if (bParam0)
	{
...
bool func_137()//Position - 0xAAFD
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_138(int iParam0, int iParam1)//Position - 0xAB17
{
	bool bVar0;
...
int func_139(int iParam0, bool bParam1)//Position - 0xAB62
{
	int iVar0;
	int iVar1;
...
int func_140(int iParam0)//Position - 0xABA3
{
...
bool func_141()//Position - 0xABE2
{
	return BitTest(Global_2621446, 3);
}

int func_142(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xABF0
{
	int iVar0;
...
void func_144(int iParam0)//Position - 0xAC4A
{
	if (iParam0 == 1)
	{
...
int func_145(char* sParam0)//Position - 0xAC6D
{
	...
	func_262("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}

void func_146()//Position - 0xACAA
{
	Global_20471 = 0;
	func_147();
}

void func_147()//Position - 0xACBA
{
...
int func_151(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xADA0
{
...
void func_152(int iParam0)//Position - 0xAF38
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_154(int iParam0)//Position - 0xAFB5
{
	if (func_159())
	{
		return;
...
void func_155(int iParam0)//Position - 0xAFE8
{
	if (func_159())
	{
		return;
...
void func_156(bool bParam0, bool bParam1)//Position - 0xB072
{
	if (bParam0)
	{
		if (func_158(0))
...
bool func_157()//Position - 0xB0E6
{
	return BitTest(Global_1958711, 5);
}

int func_158(int iParam0)//Position - 0xB0F4
{
	if (iParam0 == 1)
	{
...
bool func_159()//Position - 0xB14B
{
	return BitTest(Global_1958711, 19);
}

int func_160(int iParam0)//Position - 0xB15A
{
...
int func_161(int iParam0)//Position - 0xB19B
{
	int iVar0;
...
void func_162(int iParam0)//Position - 0xB1E0
{
...
int func_163(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB212
{
	int iVar0;
...
void func_164(var uParam0, int iParam1)//Position - 0xB349
{
	int iVar0;
...
bool func_165(int iParam0)//Position - 0xB398
{
	return func_166(iParam0, Global_43052);
}

int func_166(int iParam0, int iParam1)//Position - 0xB3A9
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_167(int iParam0)//Position - 0xB58A
{
	if (Global_43052 == 15)
	{
		return 0;
...
int func_168()//Position - 0xB5AC
{
	return func_169(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_169(char* sParam0, int iParam1)//Position - 0xB5BD
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_171(var uParam0, int iParam1)//Position - 0xB62A
{
	switch (uParam0->f_16)
	{
		case 0:
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_177(2))
							{
								if (func_175(uParam0->f_27))
								{
									...
									func_262("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.8885f, 371.9034f, 103.9884f, 241.5898f, 359.6458f, 107.3461f, 1.25f, false, true, 0))
					{
						if (func_177(2))
						{
							...
							{
								func_174(uParam0->f_27, *uParam0);
								func_262("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.948f, 4143.44f, 42.29295f, 2722.213f, 4144.521f, 45.43182f, 10f, false, true, 0))
				{
					if (func_177(2))
					{
						...
						{
							func_174(1, *uParam0);
							func_262("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.1104f, 68.46017f, -1028.566f, 395.4613f, 94.57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.7556f, 68.02096f, -1021.451f, 336.3458f, 93.18714f, 14.5f, false, true, 0))
						{
							if (func_177(2))
							{
								...
								{
									func_174(uParam0->f_27, *uParam0);
									func_262("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_172()//Position - 0xBE0D
{
	func_27(&(Global_103950.f_2890), &Global_103950, 0, 1, 1, 0);
}

int func_173(var uParam0)//Position - 0xBE28
{
	float fVar0;
...
void func_174(int iParam0, int iParam1)//Position - 0xBEB6
{
	if (iParam0 == 1)
	{
		if (!func_132(iParam1))
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_262("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_262("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
int func_175(bool bParam0)//Position - 0xBF1A
{
	int iVar0;
...
int func_176(int iParam0)//Position - 0xBFB1
{
	if (func_129(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_177(int iParam0)//Position - 0xBFDB
{
	bool bVar0;
...
var func_178()//Position - 0xC6F9
{
	return Global_100480.f_1;
}

int func_179()//Position - 0xC707
{
	if (Global_97363 != -1)
	{
...
bool func_182()//Position - 0xC76E
{
	return Global_100493.f_376 > 0;
}

var func_183(int iParam0, int iParam1)//Position - 0xC77F
{
	switch (iParam0)
	{
		case 5:
...
var func_184()//Position - 0xC7B7
{
	return Global_1575058;
}

int func_185()//Position - 0xC7C3
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_186(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xC7DF
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_187(int iParam0, bool bParam1)//Position - 0xC8D0
{
	if (iParam0 == -1)
	{
		return;
...
int func_188(int iParam0)//Position - 0xC90C
{
	if (Global_78315 == iParam0)
	{
		if (Global_78316 == -1)
...
void func_189(int iParam0, int iParam1)//Position - 0xC945
{
	bool bVar0;
	int iVar1;
...
float func_190(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xC9E3
{
	struct<3> Var0;
...
bool func_191()//Position - 0xCA1D
{
	return Global_97750;
}

void func_192(int iParam0)//Position - 0xCA29
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_193(iParam0);
...
void func_193(int iParam0)//Position - 0xCA40
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_194(int iParam0)//Position - 0xCB28
{
	if (iParam0 == -1)
	{
		iParam0 = func_168();
...
int func_195(var uParam0, bool bParam1)//Position - 0xCB50
{
	struct<27> Var0;
	
	if (Global_78319)
	{
		func_262("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	...
	{
		func_262("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_226(*uParam0))
	{
		...
		func_262("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1)
	{
	...
	if (*uParam0 == 10)
	{
		...
		{
			func_262("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_262("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
...
void func_196(int iParam0, var uParam1, int iParam2)//Position - 0xCDC0
{
	int iVar0;
	int iVar1;
...
int func_197(int iParam0)//Position - 0xD118
{
...
int func_198(var uParam0)//Position - 0xD138
{
...
int func_199(var uParam0)//Position - 0xD150
{
...
void func_200(var uParam0)//Position - 0xD175
{
	int iVar0;
	int iVar1;
...
void func_201(int* iParam0)//Position - 0xD479
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_202(var uParam0)//Position - 0xD4A4
{
	int iVar0;
...
int func_203(var uParam0, bool bParam1, bool bParam2)//Position - 0xD524
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_128(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				{
					func_262("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[iVar0], false))
				{
					func_262("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[iVar0], PLAYER::PLAYER_PED_ID(), false))
				{
					func_262("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[iVar0]) < 850)
				{
					func_262("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							func_262("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_176(iVar2))
						{
							if (ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck") || ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck2"))
							{
								if (func_176(uParam0->f_35[iVar0]))
								{
									...
									{
										func_262("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_176(iVar3))
						{
							...
							{
								func_262("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							...
							{
								func_262("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
...
int func_204(int iParam0, int iParam1)//Position - 0xD6E2
{
	int iVar0;
...
int func_205(var uParam0, bool bParam1, int iParam2)//Position - 0xD712
{
	int iVar0;
	int iVar1;
	...
	if (func_128(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[iVar0]))
						{
							...
							func_262("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[iVar0]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[iVar0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[iVar0]))
					{
						...
						func_262("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[iVar0], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
						{
							...
							func_262("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_224(*uParam0))
					{
						if (!func_160(*uParam0))
						{
							if (func_219(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								...
								func_262("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[iVar0], true), 15f))
						{
							...
							func_262("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_207(uParam0->f_28[iVar0], 1126825984))
						{
							...
							func_262("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_206(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_262("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_262("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_129(uParam0->f_41[0]))
						{
...
int func_206(int iParam0)//Position - 0xD9CE
{
...
int func_207(int iParam0, float fParam1)//Position - 0xDA02
{
	float fVar0;
...
bool func_208(int iParam0, float fParam1)//Position - 0xDA78
{
	return func_209(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_209(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDA90
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
...
int func_210(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xDB51
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_211(int iParam0, int iParam1)//Position - 0xDC7D
{
	int iVar0;
...
int func_213(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xDD8C
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
float func_214(struct<3> Param0, struct<3> Param1)//Position - 0xDE1D
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_215(struct<3> Param0)//Position - 0xDE3E
{
	float fVar0;
	float fVar1;
...
void func_216(var uParam0)//Position - 0xDE7D
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_217(int iParam0, int iParam1)//Position - 0xDE98
{
	int iVar0;
...
int func_218(int iParam0)//Position - 0xDED7
{
...
int func_219(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xDEFF
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_220(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xDFFA
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_221(int iParam0, float fParam1)//Position - 0xE106
{
	var uVar0;
	struct<3> Var1;
...
int func_222(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xE19B
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_223(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE229
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_224(int iParam0)//Position - 0xE271
{
...
void func_225(int iParam0)//Position - 0xE2BB
{
	int iVar0;
...
int func_226(int iParam0)//Position - 0xE358
{
	if (iParam0 == -1)
	{
		iParam0 = func_168();
...
int func_227(int iParam0)//Position - 0xE3ED
{
...
int func_230(int iParam0)//Position - 0xE46C
{
...
int func_232(int iParam0)//Position - 0xE4DE
{
	if (func_110(0))
	{
...
void func_233(int iParam0)//Position - 0xE506
{
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_262("Player out of range [TERMINATING]");
		func_248(iParam0, 1);
	}
	func_234(iParam0);
	func_262("Created initial scene");
}
...
int func_235(int iParam0)//Position - 0xE588
{
	struct<27> Var0;
	bool bVar1;
...
int func_236(int iParam0)//Position - 0xE5D9
{
	...
	if (Global_78319)
	{
		func_262("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!Global_113386.f_9085 && !func_110(1))
	{
		func_262("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_237(iParam0))
	{
		Global_112473[iParam0 /*10*/].f_1 = 1;
		func_262("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_100441.f_11 == 6)
	{
		if (Global_100441 < 9)
		{
			...
			{
				func_262("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	...
	{
		Global_112473[iParam0 /*10*/].f_1 = 1;
		func_262("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}
...
bool func_239(int iParam0, char* sParam1)//Position - 0xE7D8
{
...
int func_240(int iParam0)//Position - 0xE8B8
{
...
int func_241(int iParam0)//Position - 0xE8E3
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_242(int iParam0)//Position - 0xE90E
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_243(int iParam0)//Position - 0xE939
{
	if (func_227(iParam0))
	{
		return 0;
...
void func_244()//Position - 0xE96E
{
	func_262("Running end routines.");
	Global_113104 = (Global_113104 - 1);
}

int func_245(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xE988
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_246((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_246((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
	...
	func_262("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}

int func_246(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xE9ED
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_247(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_247(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0xEA65
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_248(int iParam0, bool bParam1)//Position - 0xEAE0
{
	if (bParam1)
	{
		func_262("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_249(iParam0, 0, 0, 0);
	}
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_52, false);
	if (iLocal_51 != -1)
	{
		func_262("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_193(&iLocal_51);
	}
	if (bParam1)
	{
...
void func_249(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xEB34
{
	func_257(uParam0, iParam1);
	func_253(uParam0, bParam2);
	func_250(uParam0, bParam3);
}

void func_250(var uParam0, bool bParam1)//Position - 0xEB54
{
	func_251(&(uParam0->f_41), bParam1);
}

void func_251(var uParam0, bool bParam1)//Position - 0xEB66
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_252(uParam0[iVar0], 0);
		}
		iVar0++;
	}
}

void func_252(int* iParam0, bool bParam1)//Position - 0xEBA4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_253(var uParam0, bool bParam1)//Position - 0xEBDF
{
	func_254(&(uParam0->f_35), bParam1);
}

void func_254(var uParam0, bool bParam1)//Position - 0xEBF1
{
	int iVar0;
...
void func_255(int* iParam0)//Position - 0xEC2E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_256(int* iParam0)//Position - 0xEC66
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_257(var uParam0, int iParam1)//Position - 0xED02
{
	func_258(&(uParam0->f_28), iParam1);
}

void func_258(var uParam0, int iParam1)//Position - 0xED14
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_259(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_259(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xED55
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_260(int* iParam0)//Position - 0xEDA5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_261(var uParam0)//Position - 0xEDE6
{
	if (*uParam0 == -1)
	{
		return;
...
void func_262(char* sParam0)//Position - 0xEE23
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_263(var uParam0)//Position - 0xEE35
{
	*uParam0 = -1;
...
void func_264()//Position - 0xEE67
{
	func_262("Running start routines.");
	Global_113104++;
}
