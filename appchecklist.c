...
void func_4()//Position - 0x1E2
{
	...
	if (Global_20926 == 0)
	{
		while (iVar0 < 5)
		{
			func_7(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iLocal_113), SYSTEM::TO_FLOAT(0), -1f, -1f, &(Local_129[iVar0 /*6*/]), 0, 0, 0, 0);
	...
	if (Global_20926 == 1)
	{
		...
		while (iVar0 < 5)
		{
			if (Local_129[iVar1 /*6*/].f_5 > 0)
			{
				...
				{
					func_7(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iLocal_113), SYSTEM::TO_FLOAT(0), -1f, -1f, &(Local_129[iVar1 /*6*/]), 0, 0, 0, 0);
	...
	if (iLocal_113 == 0)
	{
		func_7(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_3092" /* GXT: No progress made. */, 0, 0, 0, 0);
	}
	else
	{
		bLocal_128 = true;
	...
	func_5(Global_20911, "SET_HEADER", "CELL_23" /* GXT: Check List */, 0, 0, 0, 0);
	if (Global_20918)
	{
		func_7(Global_20911, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205" /* GXT: SELECT */, 0, 0, 0, 0);
		func_7(Global_20911, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /* GXT: BACK */, 0, 0, 0, 0);
		func_7(Global_20911, "SET_SOFT_KEYS", 1f, 0f, 15f, -1f, -1f, "CELL_227" /* GXT: SORT */, 0, 0, 0, 0);
...
void func_10()//Position - 0x5B3
{
	...
	if (Global_20908 == 0)
	{
		if (func_9(2, Global_20899, 0))
		{
			...
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			func_33(Global_20911, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_5(Global_20911, "SET_HEADER", &(Local_129[iLocal_115 /*6*/]), 0, 0, 0, 0);
...
void func_11()//Position - 0x743
{
	...
	{
		case 0:
			iLocal_124 = Global_113688;
			iLocal_125 = Global_113705;
			break;
		
		case 1:
			iLocal_124 = (Global_113689 + Global_113690);
			iLocal_125 = (Global_113706 + Global_113707);
			break;
		
		case 2:
			iLocal_124 = Global_113691;
			iLocal_125 = Global_113708;
			break;
		
		case 3:
			iLocal_124 = Global_113692;
			iLocal_125 = Global_113709;
			break;
		
		case 4:
			iLocal_124 = (Global_113693 + Global_113694);
			iLocal_125 = (Global_113710 + Global_113711);
			break;
...
void func_16()//Position - 0x8CD
{
	...
	if (func_17(0))
	{
		func_7(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_229" /* GXT: On Active Mission */, 0, 0, 0, 0);
	}
	else
	{
	...
	func_33(Global_20911, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_5(Global_20911, "SET_HEADER", "CELL_3301" /* GXT: Open Missions */, 0, 0, 0, 0);
	...
	{
		func_7(Global_20911, "SET_SOFT_KEYS", 2f, 0f, 2f, -1f, -1f, "CELL_205" /* GXT: SELECT */, 0, 0, 0, 0);
		func_7(Global_20911, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /* GXT: BACK */, 0, 0, 0, 0);
		func_7(Global_20911, "SET_SOFT_KEYS", 1f, 0f, 15f, -1f, -1f, "CELL_227" /* GXT: SORT */, 0, 0, 0, 0);
	}
	else
...
{
	func_33(Global_20911, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_7(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_3301" /* GXT: Open Missions */, 0, 0, 0, 0);
	func_7(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_3302" /* GXT: Progress */, 0, 0, 0, 0);
	iLocal_113 = 2;
	func_33(Global_20911, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_5(Global_20911, "SET_HEADER", "CELL_23" /* GXT: Check List */, 0, 0, 0, 0);
	if (Global_20918)
...
{
	func_32(0, "CELL_3001" /* GXT: Missions */, 1, Global_113705);
	func_32(1, "CELL_3008" /* GXT: Hobbies and Pastimes */, 3, Global_113705);
	func_32(2, "CELL_3004" /* GXT: Strangers and Freaks */, 7, Global_113708);
	func_32(3, "CELL_3005" /* GXT: Random Events */, 9, Global_113709);
	func_32(4, "CELL_3007" /* GXT: Miscellaneous */, 11, Global_113710);
}
