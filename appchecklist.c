...
void func_4()//Position - 0x1E2
{
	...
	if (Global_21062 == 0)
	{
		while (iVar0 < 5)
		{
			func_7(Global_21047, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iLocal_113), SYSTEM::TO_FLOAT(0), -1f, -1f, &(Local_129[iVar0 /*6*/]), 0, 0, 0, 0);
	...
	if (Global_21062 == 1)
	{
		...
		while (iVar0 < 5)
		{
			if (Local_129[iVar1 /*6*/].f_5 > 0)
			{
				...
				{
					func_7(Global_21047, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iLocal_113), SYSTEM::TO_FLOAT(0), -1f, -1f, &(Local_129[iVar1 /*6*/]), 0, 0, 0, 0);
	...
	if (iLocal_113 == 0)
	{
		func_7(Global_21047, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_3092" /* GXT: No progress made. */, 0, 0, 0, 0);
	}
	else
	{
		bLocal_128 = true;
	...
	func_5(Global_21047, "SET_HEADER", "CELL_23" /* GXT: Check List */, 0, 0, 0, 0);
	if (Global_21054)
	{
		func_7(Global_21047, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205" /* GXT: SELECT */, 0, 0, 0, 0);
		func_7(Global_21047, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /* GXT: BACK */, 0, 0, 0, 0);
		func_7(Global_21047, "SET_SOFT_KEYS", 1f, 0f, 15f, -1f, -1f, "CELL_227" /* GXT: SORT */, 0, 0, 0, 0);
...
void func_10()//Position - 0x5B3
{
	...
	if (Global_21044 == 0)
	{
		if (func_9(2, Global_21035, 0))
		{
			...
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			func_33(Global_21047, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_5(Global_21047, "SET_HEADER", &(Local_129[iLocal_115 /*6*/]), 0, 0, 0, 0);
...
void func_16()//Position - 0x8CD
{
	...
	if (func_17(0))
	{
		func_7(Global_21047, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_229" /* GXT: On Active Mission */, 0, 0, 0, 0);
	}
	else
	{
		while (iVar0 < Global_96664)
		{
			func_7(Global_21047, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(0), -1f, -1f, &(Global_96455[iVar0 /*4*/]), 0, 0, 0, 0);
			iLocal_113++;
	...
	func_33(Global_21047, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_5(Global_21047, "SET_HEADER", "CELL_3301" /* GXT: Open Missions */, 0, 0, 0, 0);
	...
	{
		func_7(Global_21047, "SET_SOFT_KEYS", 2f, 0f, 2f, -1f, -1f, "CELL_205" /* GXT: SELECT */, 0, 0, 0, 0);
		func_7(Global_21047, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /* GXT: BACK */, 0, 0, 0, 0);
		func_7(Global_21047, "SET_SOFT_KEYS", 1f, 0f, 15f, -1f, -1f, "CELL_227" /* GXT: SORT */, 0, 0, 0, 0);
	}
	else
...
void func_20()//Position - 0xCE1
{
	...
	while (bVar0 < 7)
	{
		if (Global_92415[bVar0 /*5*/] != -1)
		{
			if (Global_96664 < 52)
			{
				iVar1 = Global_79810.f_109[Global_92415[bVar0 /*5*/] /*4*/];
				MemCopy(&(Global_96455[Global_96664 /*4*/]), {func_24(iVar1)}, 4);
				Global_96664++;
			}
			else
			{
	...
	while (bVar0 < 63)
	{
		if ((BitTest(Global_114135.f_18578[bVar0 /*6*/], 0) && BitTest(Global_114135.f_18578[bVar0 /*6*/], 1)) && !BitTest(Global_114135.f_18578[bVar0 /*6*/], 3))
		{
			if (Global_96664 < 52)
			{
				MemCopy(&(Global_96455[Global_96664 /*4*/]), {func_22(bVar0)}, 4);
				Global_96664++;
			}
			else
			{
	...
	while (bVar0 < 20)
	{
		if (BitTest(Global_114135.f_9089.f_99.f_219[0], bVar0))
		{
			if (Global_96664 < 52)
			{
				StringCopy(&(Global_96455[Global_96664 /*4*/]), func_21(bVar0), 16);
				Global_96664++;
			}
			else
			{
...
{
	func_33(Global_21047, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_7(Global_21047, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_3301" /* GXT: Open Missions */, 0, 0, 0, 0);
	func_7(Global_21047, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_3302" /* GXT: Progress */, 0, 0, 0, 0);
	iLocal_113 = 2;
	func_33(Global_21047, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_5(Global_21047, "SET_HEADER", "CELL_23" /* GXT: Check List */, 0, 0, 0, 0);
	if (Global_21054)
...
{
	func_32(0, "CELL_3001" /* GXT: Missions */, 1, Global_113871);
	func_32(1, "CELL_3008" /* GXT: Hobbies and Pastimes */, 3, Global_113871);
	func_32(2, "CELL_3004" /* GXT: Strangers and Freaks */, 7, Global_113874);
	func_32(3, "CELL_3005" /* GXT: Random Events */, 9, Global_113875);
	func_32(4, "CELL_3007" /* GXT: Miscellaneous */, 11, Global_113876);
}
