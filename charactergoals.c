		...
		switch (iLocal_18)
		{
			case 0:
				if (iLocal_19[0])
				{
					...
					StringCopy(&(Global_22844[3 /*42*/]), "PA_TREV1" /* GXT: Earn one million dollars. */, 16);
					StringCopy(&(Global_22844[3 /*42*/].f_4), "PA_TREV1" /* GXT: Earn one million dollars. */, 16);
					Global_22844[3 /*42*/].f_8 = 0;
					Global_22844[3 /*42*/].f_9 = 1;
					StringCopy(&(Global_22844[3 /*42*/].f_10[1 /*4*/]), "PA_TREV1A" /* GXT: Current wealth $~1~. */, 16);
