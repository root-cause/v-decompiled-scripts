...
void __EntryFunction__()//Position - 0x0
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_81.f_35[0]))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_81.f_35[0], false))
		{
			...
			func_474(&(Local_159.f_4), &(Local_81.f_35[0]));
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_159.f_4, true, 1);
			func_473(Local_159.f_4, 0);
		}
	}
	func_472(&iLocal_172, &(Local_81.f_41[0]));
	func_458();
	if (ENTITY::DOES_ENTITY_EXIST(Local_81.f_35[1]))
	{
		func_474(&(Local_191[6 /*7*/].f_4), &(Local_81.f_35[1]));
	}
	if (func_457())
	{
		iVar0 = func_456();
	...
	while (true)
	{
		...
		func_404(Local_81.f_9, 0, 0, 0, 0, 0);
		if (iLocal_156 == 13)
		{
			func_385();
		}
		...
		{
			func_383();
			func_378(&uLocal_143, &uLocal_251, "BAR3CAU", &sLocal_144, &cLocal_150);
			switch (iLocal_156)
			{
				case 0:
					func_377();
...
{
	if (func_421(iLocal_188) && func_421(Local_159.f_4))
	{
		if (func_3())
		{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (func_421(iVar0))
		{
			...
			if ((((iVar1 == joaat("towtruck") || iVar1 == joaat("towtruck2")) || iVar1 == joaat("cargobob")) || iVar1 == joaat("cargobob2")) || iVar1 == joaat("cargobob3"))
			{
				...
				while (iLocal_250 <= 7)
				{
					if (func_421(Local_191[iLocal_250 /*7*/].f_4) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_191[iLocal_250 /*7*/].f_4, false))
					{
						bVar2 = true;
						Local_191[iLocal_250 /*7*/].f_6 = 1;
						func_474(&iLocal_188, &(Local_191[iLocal_250 /*7*/].f_4));
					}
					iLocal_250++;
				}
				if (!bVar2)
...
void func_5(bool bParam0)//Position - 0x598
{
	...
	else
	{
		...
		while (iLocal_250 <= 7)
		{
			...
			{
				if (!func_9(PLAYER::PLAYER_PED_ID(), Local_191[iLocal_250 /*7*/], 175f, 1) && func_8(PLAYER::PLAYER_PED_ID(), Local_191[iLocal_250 /*7*/].f_4, 1) > 175f)
				{
					func_6(&(Local_191[iLocal_250 /*7*/].f_4));
				}
			}
			else if (!Local_191[iLocal_250 /*7*/].f_6 && func_9(PLAYER::PLAYER_PED_ID(), Local_191[iLocal_250 /*7*/], 100f, 1))
			{
...
void func_17()//Position - 0x945
{
	...
	else
	{
		...
		{
			if (!bLocal_427 && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0 /*PLAYER_CONTROL*/, 75 /*INPUT_VEH_EXIT*/))
			{
				bLocal_427 = true;
			}
			switch (iLocal_424)
	...
	switch (iLocal_157)
	{
		case 0:
			...
			if (func_421(iLocal_188))
			{
				...
				if ((!func_15() && iLocal_438) && !PAD::IS_CONTROL_PRESSED(0 /*PLAYER_CONTROL*/, 74 /*INPUT_VEH_HEADLIGHT*/))
				{
					iLocal_431 = 0;
				}
				iLocal_157 = 1;
		...
		case 1:
			func_20();
			if (iLocal_457 && !func_421(iLocal_188))
			{
				func_47(&iLocal_158);
				HUD::CLEAR_PRINTS();
				iLocal_156 = 10;
...
void func_48()//Position - 0x1732
{
	...
	switch (iLocal_157)
	{
		...
		case 1:
			...
			else if (iLocal_457 && !func_421(iLocal_188))
			{
				func_47(&iLocal_158);
				HUD::CLEAR_PRINTS();
				iLocal_156 = 10;
...
void func_51()//Position - 0x1948
{
	...
	switch (iLocal_157)
	{
		...
		case 1:
			...
			{
				if (!func_251(PLAYER::PLAYER_PED_ID(), Local_159.f_4, 150f, 1) && !func_15())
				{
					iLocal_157 = 2;
				}
...
int func_81(int iParam0, int iParam1, int iParam2)//Position - 0x2CBF
{
	...
	else
	{
		...
		Global_78341[1 /*14*/] = { func_133(iVar0, iParam1, uVar31[iParam1], -1) };
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2F43
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_133(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_133(iVar10, 14, uVar69[iVar1], -1) };
			func_100(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_116(14);
			if (Global_78339 == 1)
			{
...
void func_118(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x7182
{
	...
	iVar0 = Global_2805029[iParam0 /*3*/][func_119(iParam2)];
	if (iVar0 != 0)
	{
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0x71E6
{
	...
	if (iParam0 != 14192)
	{
		...
		iVar0 = Global_2805029[iParam0 /*3*/][func_119(iParam1)];
...
void func_135(int iParam0)//Position - 0xDA65
{
	...
	func_136(&(Global_78341[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_142(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xFD4F
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_136(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_136(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_204(int iParam0, bool bParam1, bool bParam2)//Position - 0x2182A
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&sVar32, {func_201(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&sVar32, 0, Global_100718, 0);
		func_205(&sVar32, Var0.f_3, Global_100718, bParam1, bParam2);
	}
}
...
void func_252()//Position - 0x2843C
{
	...
	{
		if (func_332(&uLocal_251, 49, "BAR3CAU", "BAR3C_P1", 9, 1, 0, 0, 0))
		{
...
void func_253(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2847C
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_248(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
			...
			{
				iVar10 = func_326(&(Global_100681.f_3));
				if (iVar10 > -1)
				{
...
int func_274(int iParam0, int iParam1)//Position - 0x2A3DE
{
	...
	iVar0 = Global_2848282[iParam0 /*3*/][func_119(iParam1)];
...
void func_279(int iParam0, var uParam1)//Position - 0x2ACA0
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_281(Var11.f_1)) && iVar72 < 51)
			{
...
int func_287(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x2C63F
{
	int iVar0;
	int iVar1;
...
bool func_289(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2CE02
{
	if (bParam6)
	{
...
int func_295(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x2D2BE
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 59)
	{
		if (iParam3 == 6 || iParam3 == func_313(iVar0))
		{
...
int func_302(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2DEE6
{
	...
	if (!func_307(iParam1, &Var6))
	{
		return 0;
	}
	if (!bParam4)
	{
		Var12 = { func_305(iParam0) };
	}
	else
	{
	...
	Var18 = { Var12 - Var0 };
	Var18 = { func_303(Var18, -Var0.f_3.f_2) };
	Var18 = { func_303(Var18, Var6.f_3.f_2) };
	*uParam2 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Var6, 0f, Var18) };
	uParam2->f_3 = { Var12.f_3 };
	return 1;
}

Vector3 func_303(struct<3> Param0, float fParam3)//Position - 0x2DF7B
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
void func_337()//Position - 0x2FD3D
{
	...
	switch (iLocal_157)
	{
		case 0:
			func_47(&iLocal_158);
			iLocal_158 = func_338(Local_182, 5, 1);
...
int func_338(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x2FF79
{
	int iVar0;
		...
		case 0:
			...
			else
			{
				...
				else if (!iLocal_417 && (MISC::GET_GAME_TIMER() - iLocal_422) > 120000)
				{
					if (!func_344())
					{
						if (func_343(&uLocal_251, 49, "BAR3CAU", "BAR3C_HC", 7, 0, 0, 1))
						{
							iLocal_417 = 1;
						}
					}
...
int func_344()//Position - 0x30420
{
	...
	while (iLocal_250 <= 7)
	{
		if (!Local_191[iLocal_250 /*7*/].f_6 && func_9(PLAYER::PLAYER_PED_ID(), Local_191[iLocal_250 /*7*/], 8f, 1))
		{
			return 1;
		}
		iLocal_250++;
...
void func_346(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x304BE
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104212.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104212.f_4, false))
		{
			if (func_373(24) != Global_104212.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_370(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_347(Global_104212.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_347(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x30539
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_366(iParam5, &Var0, Param1, fParam4, func_262(iParam0));
		func_348(iParam5, iParam0, 0);
	}
}
...
void func_366(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x35E60
{
	if (func_365(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
...
int func_370(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x360C3
{
	int iVar0;
	
	iVar0 = func_371(Param0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_371(struct<3> Param0, int iParam3, int iParam4)//Position - 0x361D9
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_374()//Position - 0x36299
{
	switch (iLocal_157)
	{
		case 0:
			iLocal_428 = 0;
			bLocal_427 = false;
			if (func_332(&uLocal_251, 49, "BAR3CAU", "BAR3C_NG", 9, 1, 0, 0, 0))
			{
				iLocal_157 = 1;
			}
			break;
...
void func_375()//Position - 0x36384
{
	switch (iLocal_157)
	{
		...
		case 1:
			if (((!bLocal_427 && iLocal_424 != 0) && (iLocal_425 > 0 && iLocal_425 < 4)) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0 /*PLAYER_CONTROL*/, 75 /*INPUT_VEH_EXIT*/))
			{
				bLocal_427 = true;
			}
			switch (iLocal_424)
...
void func_385()//Position - 0x36D58
{
	switch (iLocal_157)
	{
		case 0:
			...
			{
				sLocal_487 = "DEFAULT" /* GXT: _ */;
			}
			if (MISC::ARE_STRINGS_EQUAL(sLocal_487, "DEFAULT" /* GXT: _ */))
			{
				func_477(1);
			}
			else
			{
				func_402(sLocal_487, 1);
			}
			iLocal_157 = 1;
			break;
		...
		case 1:
			if (func_401())
			{
				if ((func_421(Local_159.f_4) && func_421(iLocal_188)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_159.f_4, iLocal_188))
				{
...
void func_404(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x371E2
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_406(Global_78814, Global_78816, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
void func_426(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x37F43
{
	if (func_421(PLAYER::PLAYER_PED_ID()))
	{
		if (bParam4)
	...
	if (bParam4)
	{
		func_427(PLAYER::PLAYER_PED_ID(), iLocal_188, -1, 0);
	}
...
void func_429(struct<3> Param0, float fParam3)//Position - 0x38088
{
	...
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_172, Local_159.f_4, 0, Local_173, Local_176, false, false, false, false, 2, true, 0);
}
...
void func_438(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x3831C
{
	if (func_457())
	{
...
int func_442(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x38437
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_444(bool bParam0)//Position - 0x386F9
{
	if (bParam0)
	{
		...
		func_438(Local_159, Local_159.f_3, 1, 0);
	}
	if (iLocal_189 == joaat("towtruck"))
	{
		Local_488 = { -462.0807f, -1711.6804f, 17.6454f };
		fLocal_491 = 277.92f;
	}
	else if (iLocal_189 == joaat("towtruck2"))
	{
		Local_488 = { -463.5672f, -1712.2842f, 17.6392f };
		fLocal_491 = 272.29f;
	}
	else if ((iLocal_189 == joaat("cargobob") || iLocal_189 == joaat("cargobob2")) || iLocal_189 == joaat("cargobob3"))
	{
		Local_488 = { -455.4628f, -1712.2817f, 17.642f };
		fLocal_491 = 0.7f;
	}
	if (bParam0)
	{
		func_438(Local_488, fLocal_491, 1, 0);
	}
	...
	func_11(7, 0);
	func_11(7, 0);
	func_429(Local_159, Local_159.f_3);
	if (bParam0)
	{
		func_426(Local_488, fLocal_491, 0);
		if (func_421(iLocal_188) && iLocal_189 == joaat("towtruck"))
		{
	...
	{
		func_426(Local_488, fLocal_491, 1);
		if (func_421(iLocal_188) && iLocal_189 == joaat("towtruck"))
		{
			VEHICLE::SET_VEHICLE_TOW_TRUCK_ARM_POSITION(iLocal_188, 0f);
		}
...
void func_458()//Position - 0x38E73
{
	...
	Local_182 = { -1152.43f, -1238.8237f, 5.9752f };
	iLocal_142 = func_471();
	...
	Local_159.f_3 = -76.2f;
	Local_191[0 /*7*/] = { func_470(-552.67f, -1698.84f, 18.16f, 205.7f) };
	Local_191[1 /*7*/] = { func_470(-317.14f, -1540.72f, 26.67f, 336.5f) };
	Local_191[2 /*7*/] = { func_470(-104.41f, -1984.91f, 17.02f, 171.6f) };
	Local_191[3 /*7*/] = { func_470(-586.69f, -1774.59f, 21.67f, 145.8f) };
	Local_191[4 /*7*/] = { func_470(-1207.9f, -1334.87f, 3.77f, 204.1f) };
	Local_191[5 /*7*/] = { func_470(-1253.67f, -1210.3f, 6.03f, 10.7f) };
	Local_191[6 /*7*/] = { func_470(-426.56f, -1717.89f, 18.2f, 43.5f) };
	Local_191[7 /*7*/] = { func_470(401.64f, -1633.3f, 28.29f, 231.5f) };
	if (func_421(Local_159.f_4))
	{
		VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_159.f_4, false);
		VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_159.f_4, false);
	...
	if (func_421(PLAYER::PLAYER_PED_ID()))
	{
		func_469(&uLocal_251, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	func_469(&uLocal_251, 3, 0, "BARRY", 0, 1);
	iLocal_419 = 0;
	func_467();
	sLocal_487 = "DEFAULT" /* GXT: _ */;
	iLocal_437 = 0;
...
{
	Local_458[0 /*3*/] = { func_468("B3CENTV", 1) };
	Local_458[1 /*3*/] = { func_468("B3CDELV", 1) };
	Local_458[2 /*3*/] = { func_468("B3CWAN1", -1) };
	Local_458[3 /*3*/] = { func_468("B3CNOGO", 1) };
	Local_458[4 /*3*/] = { func_468("B3CREVRS", 1) };
	Local_458[5 /*3*/] = { func_468("B3CLEAVE", 1) };
	Local_458[6 /*3*/] = { func_468("B3CRTTT", 1) };
	Local_458[7 /*3*/] = { func_468("B3CGBTB", 1) };
	Local_458[8 /*3*/] = { func_468("B3CRTCB", 1) };
}
...
struct<7> func_470(struct<3> Param0, float fParam3)//Position - 0x395CC
{
	struct<7> Var0;
