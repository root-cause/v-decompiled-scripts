...
void __EntryFunction__()//Position - 0x0
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_79.f_35[0]))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_79.f_35[0], false))
		{
			...
			func_471(&(Local_97.f_4), &(Local_79.f_35[0]));
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_97.f_4, true, 1);
			func_470(Local_97.f_4, 0);
		}
	}
	func_469(&iLocal_106, &(Local_79.f_41[0]));
	func_455();
	if (ENTITY::DOES_ENTITY_EXIST(Local_79.f_35[1]))
	{
		func_471(&(Local_117[6 /*7*/].f_4), &(Local_79.f_35[1]));
	}
	if (func_454())
	{
		iVar0 = func_453();
	...
	while (true)
	{
		...
		func_401(Local_79.f_9, 0, 0, 0, 0, 0);
		if (iLocal_94 == 13)
		{
			func_382();
		}
		...
		{
			func_380();
			func_375(&uLocal_81, &uLocal_121, "BAR3CAU", &sLocal_82, &cLocal_88);
			switch (iLocal_94)
			{
				case 0:
					func_374();
...
{
	if (func_418(iLocal_114) && func_418(Local_97.f_4))
	{
		if (func_3())
		{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (func_418(iVar0))
		{
			...
			if ((((iVar1 == joaat("towtruck") || iVar1 == joaat("towtruck2")) || iVar1 == joaat("cargobob")) || iVar1 == joaat("cargobob2")) || iVar1 == joaat("cargobob3"))
			{
				...
				while (iLocal_120 <= 7)
				{
					if (func_418(Local_117[iLocal_120 /*7*/].f_4) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/].f_4, false))
					{
						bVar2 = true;
						Local_117[iLocal_120 /*7*/].f_6 = 1;
						func_471(&iLocal_114, &(Local_117[iLocal_120 /*7*/].f_4));
					}
					iLocal_120++;
				}
				if (!bVar2)
...
void func_19()//Position - 0xBB1
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			func_20();
			if (iLocal_307 && !func_418(iLocal_114))
			{
				func_47(&iLocal_96);
				HUD::CLEAR_PRINTS();
				iLocal_94 = 10;
...
void func_48()//Position - 0x1732
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			...
			else if (iLocal_307 && !func_418(iLocal_114))
			{
				func_47(&iLocal_96);
				HUD::CLEAR_PRINTS();
				iLocal_94 = 10;
...
int func_81(int iParam0, int iParam1, int iParam2)//Position - 0x2CBF
{
	...
	else
	{
		...
		Global_78130[1 /*14*/] = { func_133(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_125(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_125(iParam1), Global_78130[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_125(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, 0);
		}
	}
...
int func_83(int iParam0)//Position - 0x2F07
{
	switch (iParam0)
	{
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2F42
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_133(iVar10, 14, uVar12[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_125(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_125(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_125(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
						}
						func_116(iVar0);
						if (Global_78128 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_133(iVar10, 14, uVar15[iVar1], -1) };
			func_100(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_116(14);
			if (Global_78128 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_125(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_125(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_125(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
		}
		if (Global_78128 == 1)
		{
			iVar2 = 0;
...
void func_85(int iParam0, int iParam1, int iParam2)//Position - 0x3752
{
	int iVar0;
	int iVar1;
...
int func_86(int iParam0, int iParam1, int iParam2)//Position - 0x37DC
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_87(int iParam0, int iParam1, int iParam2)//Position - 0x38BA
{
	Global_78130[1 /*14*/] = { func_133(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78130[1 /*14*/].f_6, 2);
}

int func_88(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x38E2
{
	var uVar0;
	int iVar1;
...
int func_89(int iParam0, int iParam1, int iParam2)//Position - 0x3EE6
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4022
{
	int iVar0;
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x4329
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x4EDC
{
	int iVar0;
...
int func_94(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x51C0
{
	int iVar0;
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5487
{
	int iVar0;
	int iVar1;
...
int func_96(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x54BE
{
	int iVar0;
...
int func_97(int iParam0, int iParam1, int iParam2)//Position - 0x54E7
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_98(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x57B1
{
	int iVar0;
...
int func_99(int iParam0, int iParam1, int iParam2)//Position - 0x5A3B
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5B92
{
	int iVar0;
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5C2A
{
	switch (iParam0)
	{
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5CF8
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_103(int iParam0, int iParam1)//Position - 0x5E12
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_104(int iParam0)//Position - 0x61B9
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x621A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_106(int iParam0, int iParam1)//Position - 0x6316
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6454
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_108(int iParam0)//Position - 0x650F
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_109(int iParam0)//Position - 0x656E
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x65F4
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6871
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_112(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6C96
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_113(int iParam0, int iParam1)//Position - 0x6F89
{
	int iVar0;
	int iVar1;
...
int func_114(int iParam0, int iParam1)//Position - 0x6FCF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_115(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x702F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_116(int iParam0)//Position - 0x7086
{
...
void func_117(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x7132
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_118(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x717C
{
	int iVar0;
...
int func_119(var uParam0)//Position - 0x71AC
{
	int iVar0;
	int iVar1;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0x71E0
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 13122)
	{
		...
		iVar0 = Global_2826809[iParam0 /*3*/][func_119(iParam1)];
...
bool func_121(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x721D
{
	int iVar0;
...
int func_122(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x997F
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_123(int iParam0)//Position - 0xA822
{
	if (!BitTest(Global_78130[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_125(int iParam0)//Position - 0xA900
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_126(int iParam0, int iParam1)//Position - 0xA9B0
{
	int iVar0;
	struct<10> Var1;
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB2DF
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var2;
...
void func_128(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xB409
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_129(int iParam0, int iParam1)//Position - 0xB451
{
	int iVar0;
	struct<17> Var1;
...
void func_130(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD29B
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var2;
...
int func_131(int iParam0)//Position - 0xD485
{
	switch (iParam0)
	{
		case 0:
...
void func_132(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xD535
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_133(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD5A6
{
	func_196();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_134(int iParam0, int iParam1)//Position - 0xD5F8
{
	switch (iParam0)
	{
		case 0:
...
void func_135(int iParam0)//Position - 0xD6E8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_136(&(Global_78130[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_136(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xE920
{
	var uVar0;
	int iVar1;
...
bool func_137(int iParam0, int iParam1, var uParam2)//Position - 0xECC4
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_138(int iParam0, int iParam1)//Position - 0xF0C9
{
	switch (iParam1)
	{
		case 0:
...
int func_139(int iParam0, int iParam1)//Position - 0xF4C4
{
	switch (iParam1)
	{
		case 0:
...
int func_140(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xF8BF
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_141(int iParam0)//Position - 0xF8FE
{
	switch (iParam0)
	{
		case -1:
...
void func_142(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF9D2
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_136(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_136(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
...
void func_143(int iParam0)//Position - 0xFC58
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0xFDA5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x102B4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x10328
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x1039B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x10482
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x107C4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x109CC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x10BEC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x10CF5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x11687
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x121DF
{
	if (iParam0 < 136)
	{
		func_156(iParam0);
...
void func_155(int iParam0)//Position - 0x12214
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x12E18
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x13D18
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x13E45
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0, int iParam1)//Position - 0x13F3C
{
	switch (iParam0)
	{
		case 0:
...
void func_160(int iParam0)//Position - 0x1402E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x154FB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x15642
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x15B4C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x161B5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x16228
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x162F8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x167F3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x16984
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x17173
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x1727C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x181A2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x18E4F
{
	if (iParam0 < 107)
	{
		func_175(iParam0);
...
void func_173(int iParam0)//Position - 0x18E95
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x19939
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x1A727
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x1B366
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x1B5DE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0, int iParam1)//Position - 0x1B71A
{
	switch (iParam0)
	{
		case 0:
...
void func_179(int iParam0)//Position - 0x1B80A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x1C569
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x1C6D8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x1CC49
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x1D171
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x1D1E4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185(int iParam0)//Position - 0x1D2B4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186(int iParam0)//Position - 0x1D764
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_187(int iParam0)//Position - 0x1D9BF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_188(int iParam0)//Position - 0x1DC7F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_189(int iParam0)//Position - 0x1DE3A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_190(int iParam0)//Position - 0x1E980
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_191(int iParam0)//Position - 0x1F5B2
{
	if (iParam0 < 60)
	{
		func_193(iParam0);
...
void func_192(int iParam0)//Position - 0x1F5E7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_193(int iParam0)//Position - 0x2037C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_194(int iParam0)//Position - 0x209FE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_195(int iParam0)//Position - 0x20AE4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_196()//Position - 0x20BDB
{
...
int func_197(int iParam0, int iParam1, int iParam2)//Position - 0x20C53
{
	...
	else if (Global_78130[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_125(iParam1)) && Global_78130[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_125(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_198(char* sParam0, var uParam1)//Position - 0x20EAB
{
...
struct<2> func_200(int iParam0)//Position - 0x20F42
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_201(int iParam0)//Position - 0x20F79
{
	struct<2> Var0;
...
void func_202(int iParam0, int iParam1)//Position - 0x213C5
{
...
void func_203(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2140F
{
...
void func_204(int iParam0, bool bParam1, bool bParam2)//Position - 0x214AC
{
	struct<4> Var0;
	char* sVar1;
	...
	if (iParam0 != -1)
	{
		...
		func_205(&sVar1, Var0.f_3, Global_100478, bParam1, bParam2);
	}
}

void func_205(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x214EB
{
...
void func_206(int iParam0, var uParam1)//Position - 0x2152F
{
	switch (iParam0)
	{
		case 0:
...
int func_208(int iParam0)//Position - 0x22775
{
	switch (iParam0)
	{
		case 0:
...
void func_209(int iParam0)//Position - 0x22ABB
{
	Global_43603 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_210()//Position - 0x22ACD
{
	if (Global_97753)
	{
		func_34();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_211(Global_113386.f_2363.f_539.f_4321));
	}
	else
	{
...
char* func_211(var uParam0)//Position - 0x22AFF
{
	uParam0 = uParam0;
	return "";
}

void func_212()//Position - 0x22B0E
{
	char cVar0[24];
...
bool func_213()//Position - 0x22B51
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_214()//Position - 0x22B67
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_215(int iParam0, int iParam1)//Position - 0x22B7D
{
	Global_97748 = iParam0;
	Global_97749 = iParam1;
}

void func_216()//Position - 0x22B91
{
	if (Global_78573 != 6)
	{
	}
...
void func_217(var uParam0)//Position - 0x22BC9
{
	if (*uParam0 == -1)
	{
		return;
...
void func_218(int iParam0, bool bParam1)//Position - 0x22C06
{
	struct<26> Var0;
	int iVar1;
	bool bVar2;
...
int func_219(int iParam0)//Position - 0x22D83
{
	switch (iParam0)
	{
		case 0:
...
void func_220(int iParam0)//Position - 0x2310A
{
	func_222(iParam0, 1);
...
int func_221()//Position - 0x23140
{
	return (Global_113386.f_10016.f_21 + Global_113386.f_18574.f_380);
}

void func_222(var uParam0, bool bParam1)//Position - 0x2315C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_223(int iParam0)//Position - 0x23480
{
...
void func_224(int iParam0)//Position - 0x234B3
{
	switch (iParam0)
	{
		case 30:
...
void func_225(int iParam0, bool bParam1)//Position - 0x234E8
{
	if (iParam0 == -1)
	{
		return;
...
void func_226(int iParam0, int iParam1, bool bParam2)//Position - 0x23545
{
	if (iParam0 == -1)
	{
		return;
...
int func_227(int iParam0, int iParam1)//Position - 0x23580
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_228(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x235A0
{
	if (iParam0 != 198)
	{
		if (Global_78319)
...
void func_229(int iParam0, int iParam1)//Position - 0x235F8
{
	switch (iParam0)
	{
		case 12:
...
void func_230(int iParam0, bool bParam1)//Position - 0x236E1
{
	if (bParam1)
	{
...
bool func_231(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x2370A
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_233()//Position - 0x2408B
{
	return Global_31960;
}

int func_234(var uParam0, int iParam1)//Position - 0x24096
{
	int iVar0;
...
int func_235(int iParam0)//Position - 0x27830
{
	switch (iParam0)
	{
		case 46:
...
void func_236(int iParam0, bool bParam1)//Position - 0x2791F
{
	switch (iParam0)
	{
		case 46:
...
void func_237(int iParam0, bool bParam1)//Position - 0x27970
{
	int iVar0;
...
void func_238(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x279D6
{
	func_239(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_239(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x279F7
{
	int iVar0;
...
void func_240()//Position - 0x27BCA
{
	int iVar0;
...
int func_241(int iParam0)//Position - 0x27CE1
{
	int iVar0;
	int iVar1;
...
void func_242(char* sParam0)//Position - 0x27D21
{
...
char* func_243(int iParam0)//Position - 0x27D45
{
	switch (iParam0)
	{
		case 0:
...
int func_244(int iParam0)//Position - 0x27F18
{
...
void func_245(int iParam0, int iParam1)//Position - 0x27F42
{
...
int func_246(char* sParam0)//Position - 0x27F7F
{
	int iVar0;
...
int func_247()//Position - 0x27FDF
{
	return func_248(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_248(char* sParam0, int iParam1)//Position - 0x27FF0
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_249(int* iParam0)//Position - 0x2803B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
bool func_251(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x2809E
{
...
void func_252()//Position - 0x280C0
{
	...
	{
		if (func_329(&uLocal_121, 49, "BAR3CAU", "BAR3C_P1", 9, 1, 0, 0, 0))
		{
...
void func_253(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28100
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_323(&(Global_100441.f_3));
				if (iVar6 > -1)
				{
...
void func_254(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x28275
{
	func_255(&Global_106934, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_255(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x28291
{
	int iVar0;
	int iVar1;
...
int func_256(var uParam0)//Position - 0x2911A
{
...
void func_257(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2913C
{
	int iVar0;
...
int func_258(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x291C4
{
...
int func_259(int iParam0)//Position - 0x29204
{
	int iVar0;
...
void func_260(var uParam0, int iParam1, int iParam2)//Position - 0x29232
{
...
int func_261(int iParam0)//Position - 0x2930E
{
	int iVar0;
...
int func_262(int iParam0)//Position - 0x29350
{
	int iVar0;
...
int func_263(int iParam0, int iParam1, int iParam2)//Position - 0x293B3
{
	int iVar0;
...
int func_264(int iParam0, int iParam1)//Position - 0x29441
{
	struct<82> Var0;
...
void func_265(int iParam0, var uParam1, int iParam2)//Position - 0x29483
{
	int iVar0;
...
void func_266(int iParam0, var uParam1)//Position - 0x296DF
{
	int iVar0;
...
int func_267(int iParam0)//Position - 0x2998A
{
	switch (iParam0)
	{
		case 1:
...
int func_268(int iParam0, var uParam1, var uParam2)//Position - 0x29A3A
{
	int iVar0;
	int iVar1;
...
int func_269(int iParam0)//Position - 0x29C2D
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_270(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x29C4D
{
	char* sVar0;
...
int func_271(int iParam0, int iParam1, bool bParam2)//Position - 0x29D7C
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_272(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x29DEA
{
...
void func_273(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x29EC2
{
	int iVar0;
	int iVar1;
...
int func_274(int iParam0, int iParam1)//Position - 0x2A062
{
	int iVar0;
	var uVar1;
	
	iVar0 = Global_2866852[iParam0 /*3*/][func_119(iParam1)];
...
void func_275(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2A08E
{
	int iVar0;
...
void func_276(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x2A5D6
{
	int iVar0;
...
int func_277()//Position - 0x2A817
{
	func_34();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_278(int iParam0, bool bParam1)//Position - 0x2A830
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_279(int iParam0, var uParam1)//Position - 0x2A923
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_280(int iParam0)//Position - 0x2ABAB
{
	switch (iParam0)
	{
...
int func_281(int iParam0)//Position - 0x2AC46
{
...
int func_282(int iParam0, int iParam1)//Position - 0x2AE0E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_283(int iParam0, var* uParam1)//Position - 0x2B9AF
{
	int iVar0;
	int iVar1;
...
int func_284(int iParam0)//Position - 0x2B9EA
{
	int iVar0;
...
void func_285(int iParam0)//Position - 0x2BC5E
{
	int iVar0;
...
void func_286(var uParam0, int iParam1)//Position - 0x2BC9A
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_287(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x2C1EB
{
	int iVar0;
	int iVar1;
...
bool func_288(int iParam0, var uParam1, var uParam2)//Position - 0x2C22F
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_289(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x2C9AE
{
	if (bParam2)
	{
...
int func_290(var uParam0)//Position - 0x2C9F5
{
...
bool func_291(int iParam0)//Position - 0x2CA50
{
	return func_292(iParam0, 0, 1);
}

int func_292(int iParam0, int iParam1, bool bParam2)//Position - 0x2CA60
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_293(int iParam0)//Position - 0x2CAC1
{
	switch (iParam0)
	{
		case 0:
...
int func_294(int iParam0)//Position - 0x2CE3C
{
	return func_292(iParam0, 5, 1);
}

int func_295(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x2CE4C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_296(int iParam0, bool bParam1)//Position - 0x2CEEE
{
	switch (iParam0)
	{
		case -1:
...
int func_297(int iParam0)//Position - 0x2D613
{
	if (iParam0 != func_27())
	{
...
Vector3 func_298(int iParam0, int iParam1)//Position - 0x2D66B
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_299(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2D715
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
...
Vector3 func_300(struct<3> Param0, float fParam1)//Position - 0x2D7AA
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_301(int iParam0)//Position - 0x2D7EE
{
	struct<6> Var0;
...
struct<6> func_302(int iParam0)//Position - 0x2D972
{
	return func_303(iParam0);
}

struct<6> func_303(int iParam0)//Position - 0x2D980
{
	struct<6> Var0;
...
int func_304(int iParam0, var uParam1)//Position - 0x2E447
{
	switch (iParam0)
	{
		case 0:
...
int func_305(int iParam0)//Position - 0x2E4C9
{
	if (iParam0 != func_27())
	{
...
Vector3 func_306(int iParam0)//Position - 0x2E521
{
	switch (iParam0)
	{
		case 1:
...
int func_307()//Position - 0x2E77D
{
	return func_308(PLAYER::PLAYER_ID());
}

int func_308(int iParam0)//Position - 0x2E78D
{
	return MISC::GET_BITS_IN_RANGE(Global_2689235[iParam0 /*453*/].f_318.f_3, 28, 31);
}

int func_309(int iParam0)//Position - 0x2E7AA
{
	return func_292(iParam0, 0, 0);
}

int func_310(int iParam0)//Position - 0x2E7BA
{
	switch (iParam0)
	{
		case -1:
...
bool func_311()//Position - 0x2EAC9
{
	return Global_100493.f_375 > 0;
}

var func_312()//Position - 0x2EADA
{
	var uVar0;
...
void func_313(var uParam0, int iParam1)//Position - 0x2EB20
{
	if (iParam1 <= 0)
	{
		return;
...
void func_314(var uParam0, int iParam1)//Position - 0x2EBA6
{
...
void func_315(var uParam0, int iParam1)//Position - 0x2EBD9
{
	int iVar0;
	int iVar1;
...
int func_316(int iParam0, int iParam1)//Position - 0x2EC2A
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_317(int iParam0)//Position - 0x2ECCC
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_318(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_318(bool bParam0, int iParam1, int iParam2)//Position - 0x2ECEE
{
	if (bParam0)
	{
		return iParam1;
...
int func_319(var uParam0)//Position - 0x2ED05
{
	return uParam0 & 15;
}

void func_320(var uParam0, int iParam1)//Position - 0x2ED12
{
...
void func_321(var uParam0, int iParam1)//Position - 0x2ED4C
{
...
void func_322(var uParam0, int iParam1)//Position - 0x2ED87
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_323(char* sParam0)//Position - 0x2EDC3
{
...
int func_324(int iParam0)//Position - 0x2EE19
{
	switch (iParam0)
	{
		case 69:
...
int func_325(int iParam0)//Position - 0x2EED5
{
	switch (iParam0)
	{
		case 1:
...
int func_326(char* sParam0, bool bParam1)//Position - 0x2EF29
{
	int iVar0;
	int iVar1;
...
int func_327(int iParam0, bool bParam1)//Position - 0x2EF53
{
	int iVar0;
...
void func_328(bool bParam0)//Position - 0x2EF89
{
	int iVar0;
	int iVar1;
...
bool func_329(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x2F20B
{
...
void func_331(int iParam0)//Position - 0x2F415
{
	bool bVar0;
	int iVar1;
...
void func_332(bool bParam0, int iParam1)//Position - 0x2F486
{
	int iVar0;
...
void func_333(char* sParam0, int iParam1)//Position - 0x2F520
{
...
void func_334()//Position - 0x2F537
{
	...
	switch (iLocal_95)
	{
		case 0:
			func_47(&iLocal_96);
			iLocal_96 = func_335(Local_112, 5, 1);
...
int func_335(struct<3> Param0, int iParam1, bool bParam2)//Position - 0x2F773
{
	int iVar0;
...
void func_337(int iParam0, bool bParam1)//Position - 0x2F95C
{
	int iVar0;
		...
		case 0:
			...
			else
			{
				...
				else if (!iLocal_287 && (MISC::GET_GAME_TIMER() - iLocal_292) > 120000)
				{
					if (!func_341())
					{
						if (func_340(&uLocal_121, 49, "BAR3CAU", "BAR3C_HC", 7, 0, 0, 1))
						{
							iLocal_287 = 1;
						}
					}
...
bool func_340(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)//Position - 0x2FBCB
{
...
void func_343(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x2FCB7
{
	struct<3> Var0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103950.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_103950.f_4, false))
		{
			if (func_370(24) != Global_103950.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_367(ENTITY::GET_ENTITY_COORDS(Global_103950.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_344(Global_103950.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}

void func_344(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x2FD32
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_363(iParam3, &Var0, Param1, fParam2, func_262(iParam0));
		func_345(iParam3, iParam0, 0);
	}
}

void func_345(int iParam0, int iParam1, int iParam2)//Position - 0x2FE5B
{
	int iVar0;
...
void func_346(int iParam0, int iParam1)//Position - 0x2FF72
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_347(int iParam0)//Position - 0x30177
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_271(iParam0, 0, 0)) || func_271(iParam0, 1, 0)) || func_271(iParam0, 2, 0)) || func_262(iParam0) != 145) || func_361(iParam0)) || func_360(iParam0)) || func_359(iParam0)) || func_358(iParam0)) || !func_348(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_360(iParam0))
		{
		}
...
int func_348(int iParam0)//Position - 0x30254
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_349(int iParam0, bool bParam1)//Position - 0x30405
{
	int iVar0;
	struct<2> Var1;
...
int func_350(int iParam0)//Position - 0x30585
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_352(int iParam0)//Position - 0x30668
{
	int iVar0;
	int iVar1;
...
int func_353()//Position - 0x33939
{
	return 0;
}

int func_354()//Position - 0x33942
{
	return 1;
}

int func_355()//Position - 0x3394B
{
	return 1;
}

int func_356()//Position - 0x33954
{
...
int func_358(int iParam0)//Position - 0x33A25
{
	int iVar0;
	char* sVar1;
...
int func_359(int iParam0)//Position - 0x33A6B
{
	int iVar0;
...
int func_360(int iParam0)//Position - 0x33AA6
{
	int iVar0;
...
int func_361(int iParam0)//Position - 0x33B22
{
	int iVar0;
...
int func_362(var uParam0, int iParam1)//Position - 0x33C0A
{
	int iVar0;
	int iVar1;
...
void func_363(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x352FA
{
	if (func_362(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_364(var uParam0, var uParam1)//Position - 0x353F3
{
...
void func_365(int iParam0)//Position - 0x354BF
{
	if (iParam0 == -1)
	{
		return;
...
void func_366(int iParam0)//Position - 0x35536
{
...
int func_367(struct<3> Param0, int iParam1, var uParam2, var uParam3)//Position - 0x3555D
{
	int iVar0;
...
int func_368(struct<3> Param0, int iParam1, int iParam2)//Position - 0x35673
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_369(int iParam0)//Position - 0x35702
{
	return BitTest(Global_113386.f_7229[iParam0], 0);
}

int func_370(int iParam0)//Position - 0x35717
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_371()//Position - 0x35733
{
	switch (iLocal_95)
	{
		case 0:
			iLocal_298 = 0;
			bLocal_297 = false;
			if (func_329(&uLocal_121, 49, "BAR3CAU", "BAR3C_NG", 9, 1, 0, 0, 0))
			{
				iLocal_95 = 1;
			}
			break;
...
void func_373(int iParam0, bool bParam1)//Position - 0x35D2B
{
...
void func_375(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)//Position - 0x35E78
{
	switch (*uParam0)
	{
		case 0:
		...
		case 4:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && func_376(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
bool func_376(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x35F89
{
...
void func_377()//Position - 0x35FDD
{
	Global_20471 = 0;
	func_42();
}

struct<6> func_378()//Position - 0x35FED
{
	struct<6> Var0;
	int iVar1;
	int iVar2;
...
struct<6> func_379()//Position - 0x36099
{
	struct<6> Var0;
...
void func_380()//Position - 0x360BD
{
}
...
void func_382()//Position - 0x361F2
{
	switch (iLocal_95)
	{
		...
		case 1:
			if (func_398())
			{
				if ((func_418(Local_97.f_4) && func_418(iLocal_114)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_97.f_4, iLocal_114))
				{
...
void func_383()//Position - 0x36288
{
	...
	func_394(0);
	func_384(&Local_79, 1, 0, 0);
}

void func_384(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x362CB
{
...
void func_385(var uParam0, bool bParam1)//Position - 0x362EB
{
	func_386(&(uParam0->f_41), bParam1);
}

void func_386(var uParam0, bool bParam1)//Position - 0x362FD
{
	int iVar0;
...
void func_387(int* iParam0, bool bParam1)//Position - 0x3633B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_388(var uParam0, bool bParam1)//Position - 0x36376
{
	func_389(&(uParam0->f_35), bParam1);
}

void func_389(var uParam0, bool bParam1)//Position - 0x36388
{
	int iVar0;
...
void func_390(var uParam0, int iParam1)//Position - 0x363C5
{
	func_391(&(uParam0->f_28), iParam1);
}

void func_391(var uParam0, int iParam1)//Position - 0x363D7
{
	int iVar0;
...
void func_392(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x36418
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_393(int* iParam0)//Position - 0x36468
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_394(bool bParam0)//Position - 0x364A9
{
	func_395(39, bParam0);
	func_395(40, bParam0);
	func_395(41, bParam0);
...
void func_395(int iParam0, bool bParam1)//Position - 0x364E1
{
	if (bParam1)
	{
...
void func_396(int iParam0, int iParam1, bool bParam2)//Position - 0x36518
{
	int iVar0;
...
void func_397(int iParam0, int iParam1, bool bParam2)//Position - 0x3658A
{
	int iVar0;
...
void func_399(char* sParam0, bool bParam1)//Position - 0x36629
{
	func_400(sParam0);
	func_474(bParam1);
}

void func_400(char* sParam0)//Position - 0x3663D
{
...
void func_401(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x3667C
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78573 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_403(Global_78574, Global_78576, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
float func_402(char* sParam0)//Position - 0x36961
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_403(int iParam0, int iParam1, int iParam2)//Position - 0x36974
{
	struct<2> Var0;
	int iVar1;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_404(iVar1), 8);
					break;
			}
			break;
...
char* func_404(int iParam0)//Position - 0x36A4A
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_405(int iParam0)//Position - 0x36B9D
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_406(int iParam0)//Position - 0x36BD0
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_407(int iParam0)//Position - 0x36C03
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_408(int iParam0)//Position - 0x36C36
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_409(int iParam0)//Position - 0x36C69
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_410(int iParam0)//Position - 0x36CA6
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_411(int iParam0)//Position - 0x36CD9
{
	struct<2> Var0;
...
int func_412(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x36D42
{
	if (((!func_415(0) || Global_78588) || Global_78577 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78573)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_414(0)) || func_413(1))
			{
			}
			else
			{
...
bool func_413(bool bParam0)//Position - 0x36E5A
{
	if (bParam0)
	{
...
int func_414(int iParam0)//Position - 0x36E83
{
	if (iParam0 == 1)
	{
		if (Global_20266.f_1 > 3)
...
int func_415(int iParam0)//Position - 0x36EDA
{
	if (Global_43052 == 15)
	{
		return 0;
...
bool func_416(int iParam0)//Position - 0x36EFC
{
	return func_417(iParam0, Global_43052);
}

int func_417(int iParam0, int iParam1)//Position - 0x36F0D
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_418(int iParam0)//Position - 0x370EE
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_419(bool bParam0)//Position - 0x3710F
{
...
void func_420(bool bParam0)//Position - 0x37137
{
	if (bParam0)
	{
		...
		{
			func_435(-1237.9617f, -1035.1941f, 7.2466f, 110f, 1, 0);
		}
		else
		{
			func_435(-1074.1339f, -1250.2921f, 4.5293f, 199.5f, 1, 0);
		}
	}
	func_428();
	func_427();
...
void func_421(int iParam0, int iParam1, int iParam2)//Position - 0x37308
{
...
void func_423(struct<3> Param0, float fParam1, bool bParam2)//Position - 0x373DD
{
	...
	if (bParam2)
	{
		func_424(PLAYER::PLAYER_PED_ID(), iLocal_114, -1, 0);
	}
...
void func_424(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x3749F
{
	if (func_425(iParam0))
	{
		if (func_418(iParam1))
...
int func_425(int iParam0)//Position - 0x37501
{
	if (func_418(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_427()//Position - 0x37616
{
	if (func_418(PLAYER::PLAYER_PED_ID()))
	{
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
...
void func_429(int iParam0)//Position - 0x37669
{
	if (func_432())
	{
		return;
...
void func_430(bool bParam0, bool bParam1)//Position - 0x376F3
{
	if (bParam0)
	{
		if (func_414(0))
...
bool func_431()//Position - 0x37767
{
	return BitTest(Global_1958711, 5);
}

bool func_432()//Position - 0x37775
{
	return BitTest(Global_1958711, 19);
}

void func_433()//Position - 0x37784
{
	Global_20471 = 0;
	func_434();
}

void func_434()//Position - 0x37794
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22616 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_435(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x377B5
{
	if (func_454())
	{
...
int func_436()//Position - 0x3784A
{
	return Global_106934.f_2890.f_12.f_66;
}

bool func_437()//Position - 0x3785D
{
	return func_438(&(Global_106934.f_2890));
}

int func_438(var uParam0)//Position - 0x37870
{
...
int func_439(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x378CF
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_440(bool bParam0)//Position - 0x3794A
{
	if (bParam0)
	{
		...
		if (iLocal_115 == joaat("towtruck") || iLocal_115 == joaat("towtruck2"))
		{
			func_435(-1154.2244f, -1234.3102f, 5.7174f, 12.45f, 1, 0);
		}
		else
		{
			func_435(-1148.1831f, -1227.005f, 8.4468f, 19.2f, 1, 0);
		}
	}
	func_428();
	func_427();
...
void func_441(bool bParam0)//Position - 0x37B91
{
	if (bParam0)
	{
		...
		func_435(Local_97, Local_97.f_3, 1, 0);
	}
	...
	if (bParam0)
	{
		func_435(Local_311, fLocal_312, 1, 0);
	}
	...
	if (bParam0)
	{
		...
		if (func_418(iLocal_114) && iLocal_115 == joaat("towtruck"))
		{
...
void func_442(int iParam0, int iParam1, int iParam2)//Position - 0x37E0C
{
...
void func_443(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x37E40
{
	int iVar0;
...
void func_444(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x37EEA
{
	if (bParam0)
	{
	...
	else
	{
		...
		func_450(0, bParam3, iParam2, 0);
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_448(PLAYER::PLAYER_ID())) && !func_446(PLAYER::PLAYER_ID(), 0)) && !func_445()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_448(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_78317 = 0;
...
bool func_445()//Position - 0x3802E
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_446(int iParam0, int iParam1)//Position - 0x38048
{
	bool bVar0;
...
int func_447(int iParam0, bool bParam1)//Position - 0x38093
{
	int iVar0;
	int iVar1;
...
int func_448(int iParam0)//Position - 0x380D4
{
...
bool func_449()//Position - 0x38113
{
	return BitTest(Global_2621446, 3);
}

int func_450(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x38121
{
	int iVar0;
...
void func_451(int iParam0)//Position - 0x38154
{
	if (iParam0 == 1)
	{
...
void func_455()//Position - 0x38302
{
	...
	if (func_418(PLAYER::PLAYER_PED_ID()))
	{
		func_466(&uLocal_121, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	func_466(&uLocal_121, 3, 0, "BARRY", 0, 1);
	iLocal_289 = 0;
	func_464();
	sLocal_310 = "DEFAULT" /* GXT: _ */;
	iLocal_303 = 0;
...
void func_456(int iParam0, int iParam1, bool bParam2)//Position - 0x385EF
{
	int iVar0;
...
void func_457()//Position - 0x38767
{
	char cVar0[64];
	char cVar1[64];
	char* sVar2;
...
struct<4> func_458(int iParam0)//Position - 0x387E2
{
	return Global_1998[iParam0 /*29*/].f_3;
}

int func_459(int iParam0, int iParam1)//Position - 0x387F5
{
...
int func_460(int iParam0, int iParam1)//Position - 0x3881F
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_461(int iParam0, int iParam1, int iParam2)//Position - 0x38849
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_462(int iParam0, int iParam1, int iParam2)//Position - 0x3888E
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
{
	Local_308[0 /*3*/] = { func_465("B3CENTV", 1) };
	Local_308[1 /*3*/] = { func_465("B3CDELV", 1) };
	Local_308[2 /*3*/] = { func_465("B3CWAN1", -1) };
	Local_308[3 /*3*/] = { func_465("B3CNOGO", 1) };
	Local_308[4 /*3*/] = { func_465("B3CREVRS", 1) };
	Local_308[5 /*3*/] = { func_465("B3CLEAVE", 1) };
	Local_308[6 /*3*/] = { func_465("B3CRTTT", 1) };
	Local_308[7 /*3*/] = { func_465("B3CGBTB", 1) };
	Local_308[8 /*3*/] = { func_465("B3CRTCB", 1) };
}

Vector3 func_465(char* sParam0, int iParam1)//Position - 0x389A5
{
	struct<3> Var0;
...
void func_466(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x389C0
{
...
int func_468()//Position - 0x38A83
{
	return PED::ADD_SCENARIO_BLOCKING_AREA(-564f, -1758.1f, 16.5f, -419.31f, -1649f, 23f, false, true, true, true);
}

void func_469(var uParam0, var uParam1)//Position - 0x38AB1
{
	*uParam0 = *uParam1;
	*uParam1 = 0;
}

void func_470(var uParam0, int iParam1)//Position - 0x38AC3
{
	Global_100441.f_22[iParam1] = uParam0;
}

void func_471(int iParam0, var uParam1)//Position - 0x38AD7
{
	*iParam0 = *uParam1;
	*uParam1 = 0;
}
...
void func_474(bool bParam0)//Position - 0x38BD9
{
	int iVar0;
	...
	if (!func_488())
	{
		...
		{
			func_204(iVar0, 1, 0);
			func_475(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_112473[iVar0 /*10*/].f_9 == -1)
...
void func_475(char* sParam0, int iParam1)//Position - 0x38CA9
{
	if (Global_100441 != 12)
	{
...
int func_476(char* sParam0, int iParam1, int iParam2)//Position - 0x38CD1
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
...
void func_480(bool bParam0)//Position - 0x38F40
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_481(int iParam0)//Position - 0x38F54
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_482(int iParam0)//Position - 0x38F8E
{
	if (iParam0 == 1)
	{
...
void func_483()//Position - 0x38FC8
{
	Global_23011.f_5 = 1;
}

void func_484()//Position - 0x38FD6
{
	Global_23011.f_5 = 0;
}

void func_485(bool bParam0)//Position - 0x38FE4
{
	if (bParam0)
	{
		func_486();
...
void func_486()//Position - 0x39047
{
...
void func_487()//Position - 0x39070
{
	Global_94617 = 0;
	Global_94618 = 0;
}

int func_488()//Position - 0x39082
{
...
void func_489()//Position - 0x390C0
{
	Global_100476 = 1;
...
void func_490(char* sParam0)//Position - 0x391AD
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_491()//Position - 0x391BF
{
	int iVar0;
...
void func_492(var uParam0)//Position - 0x391DF
{
...
void func_493(var uParam0)//Position - 0x391FF
{
	int iVar0;
...
int func_494(int iParam0)//Position - 0x39239
{
	if (!func_35(iParam0))
	{
		return func_38(iParam0);
