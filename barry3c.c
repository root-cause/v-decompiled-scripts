...
void __EntryFunction__()//Position - 0x0
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_79.f_35[0]))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_79.f_35[0], false))
		{
			...
			func_474(&(Local_97.f_4), &(Local_79.f_35[0]));
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_97.f_4, true, 1);
			func_473(Local_97.f_4, 0);
		}
	}
	func_472(&iLocal_106, &(Local_79.f_41[0]));
	func_458();
	if (ENTITY::DOES_ENTITY_EXIST(Local_79.f_35[1]))
	{
		func_474(&(Local_117[6 /*7*/].f_4), &(Local_79.f_35[1]));
	}
	if (func_457())
	{
		iVar0 = func_456();
	...
	{
		if (func_421(PLAYER::PLAYER_PED_ID()))
		{
	...
	while (true)
	{
		...
		func_404(Local_79.f_9, 0, 0, 0, 0, 0);
		if (iLocal_94 == 13)
		{
			func_385();
		}
		...
		{
			func_383();
			func_378(&uLocal_81, &uLocal_121, "BAR3CAU", &sLocal_82, &cLocal_88);
			switch (iLocal_94)
			{
				case 0:
					func_377();
...
{
	if (func_421(iLocal_114) && func_421(Local_97.f_4))
	{
		if (func_3())
		{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (func_421(iVar0))
		{
			...
			if ((((iVar1 == joaat("towtruck") || iVar1 == joaat("towtruck2")) || iVar1 == joaat("cargobob")) || iVar1 == joaat("cargobob2")) || iVar1 == joaat("cargobob3"))
			{
				...
				while (iLocal_120 <= 7)
				{
					if (func_421(Local_117[iLocal_120 /*7*/].f_4) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/].f_4, false))
					{
						bVar2 = true;
						Local_117[iLocal_120 /*7*/].f_6 = 1;
						func_474(&iLocal_114, &(Local_117[iLocal_120 /*7*/].f_4));
					}
					iLocal_120++;
				}
				if (!bVar2)
...
void func_5(bool bParam0)//Position - 0x598
{
	...
	else
	{
		...
		while (iLocal_120 <= 7)
		{
			...
			{
				if (!func_9(PLAYER::PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/], 175f, 1) && func_8(PLAYER::PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/].f_4, 1) > 175f)
				{
					func_6(&(Local_117[iLocal_120 /*7*/].f_4));
				}
			}
			else if (!Local_117[iLocal_120 /*7*/].f_6 && func_9(PLAYER::PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/], 100f, 1))
			{
...
bool func_9(int iParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x7EE
{
...
void func_12(int iParam0)//Position - 0x857
{
	...
	{
		func_14(Local_308[iParam0 /*3*/].f_2, 7500, 1);
		func_13(&uLocal_81);
...
void func_19()//Position - 0xBB1
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			func_20();
			if (iLocal_307 && !func_421(iLocal_114))
			{
				func_47(&iLocal_96);
				HUD::CLEAR_PRINTS();
				iLocal_94 = 10;
...
void func_34()//Position - 0x13C9
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_37(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_35(iVar0) && (!func_39(14) || Global_112599))
			{
				if (Global_113648.f_2365.f_539.f_4321 != iVar0 && func_35(Global_113648.f_2365.f_539.f_4321))
				{
...
int func_44()//Position - 0x168D
{
	...
	while (iLocal_120 <= 8)
	{
		if (func_45(Local_308[iLocal_120 /*3*/].f_2, 0, 0))
		{
			return 1;
		}
		iLocal_120++;
...
void func_48()//Position - 0x1732
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			...
			else if (iLocal_307 && !func_421(iLocal_114))
			{
				func_47(&iLocal_96);
				HUD::CLEAR_PRINTS();
				iLocal_94 = 10;
...
void func_51()//Position - 0x1948
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			...
			{
				if (!func_251(PLAYER::PLAYER_PED_ID(), Local_97.f_4, 150f, 1) && !func_15())
				{
					iLocal_95 = 2;
				}
...
void func_53(int iParam0, bool bParam1)//Position - 0x1A74
{
	...
	{
		func_217(&(Global_112735[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	...
	func_202(0, 0);
	MemCopy(&sVar1, {func_200(iVar0)}, 4);
	func_198(&sVar1, func_199());
	func_80();
...
void func_56()//Position - 0x1CD9
{
	...
	{
		func_58(13, SYSTEM::FLOOR(Global_113648.f_10196.f_3853));
	}
...
int func_81(int iParam0, int iParam1, int iParam2)//Position - 0x2CBF
{
	...
	Global_78341[1 /*14*/] = { func_133(iVar0, iParam1, iParam2, -1) };
	...
	{
		uVar6 = { func_129(iVar0, 0) };
		Global_78341[1 /*14*/] = { func_133(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_125(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_125(iParam1), Global_78341[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_125(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, 0);
		}
	}
...
int func_82(int iParam0, int iParam1, int iParam2)//Position - 0x2E7C
{
	...
	{
		if (!func_197(iParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_64, Global_113648.f_2365.f_539[iVar0 /*65*/].f_63))
		{
...
int func_83(int iParam0)//Position - 0x2F08
{
	switch (iParam0)
	{
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2F43
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_78341[1 /*14*/] = { func_133(iVar10, iParam1, iParam2, -1) };
		if (!func_123(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78341[1 /*14*/] = { func_133(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						{
							uVar12 = { func_126(iVar10, uVar11[iVar0]) };
						}
						iVar1 = 0;
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_133(iVar10, 14, uVar12[iVar1], -1) };
							func_100(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
							func_116(14);
							if (Global_78339 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_125(iVar0), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_125(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_125(iVar0), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
						}
						func_116(iVar0);
						if (Global_78339 == 1)
						{
			...
			{
				Global_78341[1 /*14*/] = { func_133(iVar10, iVar0, func_90(iParam0, iVar0, -1), -1) };
		...
		if (iParam7 == 1)
		{
			Var14 = { func_133(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var14 = { func_133(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var14 = { func_133(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var14 = { func_133(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var14 = { func_133(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	{
		uVar15 = { func_126(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_133(iVar10, 14, uVar15[iVar1], -1) };
			func_100(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_116(14);
			if (Global_78339 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_125(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_125(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_125(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
		}
		if (Global_78339 == 1)
		{
			iVar2 = 0;
...
void func_85(int iParam0, int iParam1, int iParam2)//Position - 0x3754
{
	int iVar0;
	int iVar1;
...
int func_86(int iParam0, int iParam1, int iParam2)//Position - 0x37DE
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_87(int iParam0, int iParam1, int iParam2)//Position - 0x38BC
{
	Global_78341[1 /*14*/] = { func_133(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78341[1 /*14*/].f_6, 2);
}

int func_88(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x38E4
{
	var uVar0;
	int iVar1;
...
int func_89(int iParam0, int iParam1, int iParam2)//Position - 0x3EE8
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_90(int iParam0, int iParam1, int iParam2)//Position - 0x3F81
{
	int iVar0;
	int iVar1;
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4025
{
	int iVar0;
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x432C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x4EDF
{
	int iVar0;
...
int func_94(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x51C3
{
	int iVar0;
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x548A
{
	int iVar0;
	int iVar1;
...
int func_96(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x54C1
{
	int iVar0;
...
int func_97(int iParam0, int iParam1, int iParam2)//Position - 0x54EA
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_98(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x57B4
{
	int iVar0;
...
int func_99(int iParam0, int iParam1, int iParam2)//Position - 0x5A3E
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5B95
{
	int iVar0;
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5C2F
{
	switch (iParam0)
	{
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5CFD
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		iVar4 = (iParam1 - func_103(iParam0, func_125(iParam2)));
		if (iVar4 < 0)
		{
			return -1;
		}
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_125(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_103(int iParam0, int iParam1)//Position - 0x5E17
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_104(int iParam0)//Position - 0x61BE
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x621F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_106(int iParam0, int iParam1)//Position - 0x631B
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6459
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		if (iVar4 != -1)
		{
			return (func_103(iParam0, func_125(iParam2)) + iVar4);
		}
	}
	return -99;
}

int func_108(int iParam0)//Position - 0x6514
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_109(int iParam0)//Position - 0x6573
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x65F9
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6876
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_112(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6C9B
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_113(int iParam0, int iParam1)//Position - 0x6F8E
{
	int iVar0;
	int iVar1;
...
int func_114(int iParam0, int iParam1)//Position - 0x6FD5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_115(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7035
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_116(int iParam0)//Position - 0x708C
{
	if (BitTest(Global_78341[1 /*14*/].f_6, 1) && !BitTest(Global_78341[1 /*14*/].f_6, 6))
	{
		func_122(iParam0, Global_78341[1 /*14*/].f_5, Global_78341[1 /*14*/].f_2, 2, Global_78341[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_78341[1 /*14*/].f_6, 1) && BitTest(Global_78341[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_117(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x7138
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_118(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x7182
{
	int iVar0;
	...
	iVar0 = Global_2805027[iParam0 /*3*/][func_119(iParam2)];
	if (iVar0 != 0)
	{
...
int func_119(var uParam0)//Position - 0x71B2
{
	int iVar0;
	int iVar1;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0x71E6
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 14192)
	{
		...
		iVar0 = Global_2805027[iParam0 /*3*/][func_119(iParam1)];
...
bool func_121(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x7223
{
	int iVar0;
...
int func_122(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x9C3D
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_123(int iParam0)//Position - 0xAAE0
{
	if (!BitTest(Global_78341[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_124(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAB28
{
	int iVar0;
	...
	{
		if (!func_197(iParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_61, Global_113648.f_2365.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_125(int iParam0)//Position - 0xABD3
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_126(int iParam0, int iParam1)//Position - 0xAC83
{
	int iVar0;
	struct<10> Var1;
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB5B2
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var2;
...
void func_128(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xB6DC
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_129(int iParam0, int iParam1)//Position - 0xB724
{
	int iVar0;
	struct<17> Var1;
...
void func_130(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD618
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var2;
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.f_0 != 0 && Var2.f_0 != -1) && Var2.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_131(Var2.f_2)] = func_107(iParam1, Var2.f_0, func_131(Var2.f_2), iVar0);
					}
				}
				else if (Var2.f_1 != -1)
				{
...
int func_131(int iParam0)//Position - 0xD802
{
	switch (iParam0)
	{
		case 0:
...
void func_132(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xD8B2
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_133(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD923
{
	func_196();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_134(int iParam0, int iParam1)//Position - 0xD975
{
	switch (iParam0)
	{
		case 0:
...
void func_135(int iParam0)//Position - 0xDA65
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_142(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_136(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_136(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xEC9D
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_120(func_139(iParam1, uParam0->f_2), Global_78338, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_120(func_138(iParam1, uParam0->f_2), Global_78338, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_120(iVar1, Global_78338, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_137(int iParam0, int iParam1, var uParam2)//Position - 0xF041
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_138(int iParam0, int iParam1)//Position - 0xF446
{
	switch (iParam1)
	{
		case 0:
...
int func_139(int iParam0, int iParam1)//Position - 0xF841
{
	switch (iParam1)
	{
		case 0:
...
int func_140(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xFC3C
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_141(int iParam0)//Position - 0xFC7B
{
	switch (iParam0)
	{
		case -1:
...
void func_142(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xFD4F
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar3 >= 0)
		{
			...
			if (iVar4 > iVar3)
			{
				...
				func_136(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_136(&(Global_78341[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_136(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_136(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_125(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_143(int iParam0)//Position - 0xFFD5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x10125
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x10632
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x106A6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x10719
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x10800
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x10B42
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x10D4A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x10F6A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x11073
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x11A05
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1255D
{
	if (iParam0 < 136)
	{
		func_156(iParam0);
...
void func_155(int iParam0)//Position - 0x12592
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x13196
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x14097
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x141C4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0, int iParam1)//Position - 0x142BB
{
	switch (iParam0)
	{
		case 0:
...
void func_160(int iParam0)//Position - 0x143AB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x15878
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x159BF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x15EC9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x16532
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x165A5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x16675
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x16B70
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x16D01
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x174F0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x175F9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x1851D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x191CA
{
	if (iParam0 < 107)
	{
		func_175(iParam0);
...
void func_173(int iParam0)//Position - 0x19210
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x19CB4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x1AAA2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x1B6E1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x1B959
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0, int iParam1)//Position - 0x1BA95
{
	switch (iParam0)
	{
		case 0:
...
void func_179(int iParam0)//Position - 0x1BB85
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x1C8E5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x1CA54
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x1CFC5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x1D4ED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x1D560
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185(int iParam0)//Position - 0x1D630
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186(int iParam0)//Position - 0x1DAE0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_187(int iParam0)//Position - 0x1DD3B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_188(int iParam0)//Position - 0x1DFFB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_189(int iParam0)//Position - 0x1E1B6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_190(int iParam0)//Position - 0x1ECFC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_191(int iParam0)//Position - 0x1F92E
{
	if (iParam0 < 60)
	{
		func_193(iParam0);
...
void func_192(int iParam0)//Position - 0x1F963
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_193(int iParam0)//Position - 0x206F9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_194(int iParam0)//Position - 0x20D7B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_195(int iParam0)//Position - 0x20E61
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_196()//Position - 0x20F58
{
...
int func_197(int iParam0, int iParam1, int iParam2)//Position - 0x20FD0
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_197(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar6 = { func_126(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
							if (!func_197(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_78341[2 /*14*/] = { func_133(iVar0, 14, iVar4, -1) };
									if (Global_78341[2 /*14*/].f_12 == iVar3)
									{
										if (func_197(iParam0, 14, iVar4))
										{
											if (!func_88(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_78341[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_78341[2 /*14*/] = { func_133(iVar0, iVar2, iVar1, -1) };
						if (!func_88(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_78341[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_78341[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_125(iParam1)) && Global_78341[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_125(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_198(char* sParam0, var uParam1)//Position - 0x21229
{
...
struct<2> func_200(int iParam0)//Position - 0x212C0
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_201(int iParam0)//Position - 0x212F7
{
	struct<2> Var0;
...
void func_202(int iParam0, int iParam1)//Position - 0x21743
{
...
void func_203(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2178D
{
	...
	if (iParam1 == 1)
	{
		func_204(iParam0, bParam2, bParam3);
	}
	HUD::SET_MISSION_NAME(false, 0);
}

void func_204(int iParam0, bool bParam1, bool bParam2)//Position - 0x2182A
{
	struct<4> Var0;
	char* sVar1;
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&sVar1, {func_201(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&sVar1, 0, Global_100718, 0);
		func_205(&sVar1, Var0.f_3, Global_100718, bParam1, bParam2);
	}
}

void func_205(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x21869
{
...
void func_206(int iParam0, var uParam1)//Position - 0x218AD
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_207(uParam1, "Barry3A", func_200(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_208(iParam0), 0, 1);
			break;
		...
		case 8:
			func_207(uParam1, "Dreyfuss1", func_200(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_208(iParam0), 0, 0);
			break;
		...
		case 38:
			func_207(uParam1, "Nigel1A", func_200(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_208(iParam0), 1, 1);
			break;
		...
		case 49:
			func_207(uParam1, "Paparazzo3A", func_200(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_208(iParam0), 0, 1);
			break;
		...
		case 58:
			func_207(uParam1, "Tonya1", func_200(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_208(iParam0), 0, 1);
			break;
...
void func_207(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0x22A62
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_208(int iParam0)//Position - 0x22AF3
{
	switch (iParam0)
	{
		case 0:
...
void func_209(int iParam0)//Position - 0x22E39
{
	Global_43808 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_210()//Position - 0x22E4B
{
	if (Global_97993)
	{
		func_34();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_211(Global_113648.f_2365.f_539.f_4321));
	}
	else
	{
...
char* func_211(var uParam0)//Position - 0x22E7D
{
	uParam0 = uParam0;
	return "";
}

void func_212()//Position - 0x22E8C
{
	char cVar0[24];
	
	if (MISC::IS_XBOX360_VERSION() || func_214())
	{
		NETWORK::NETWORK_SET_RICH_PRESENCE(StackVal, 0, 0, 0);
	}
	else if (MISC::IS_PS3_VERSION() || func_213())
	{
...
bool func_213()//Position - 0x22ECF
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_214()//Position - 0x22EE5
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_215(int iParam0, int iParam1)//Position - 0x22EFB
{
	Global_97988 = iParam0;
	Global_97989 = iParam1;
}

void func_216()//Position - 0x22F0F
{
	if (Global_78813 != 6)
	{
	}
...
void func_217(var uParam0)//Position - 0x22F47
{
	if (*uParam0 == -1)
	{
		return;
...
void func_218(int iParam0, bool bParam1)//Position - 0x22F84
{
	struct<26> Var0;
	int iVar1;
	bool bVar2;
...
int func_219(int iParam0)//Position - 0x23101
{
	switch (iParam0)
	{
		case 0:
...
void func_220(int iParam0)//Position - 0x23488
{
	func_222(iParam0, 1);
	Global_113648.f_18576[iParam0 /*6*/].f_3 = func_221();
	Global_113648.f_18576.f_380++;
}

int func_221()//Position - 0x234BE
{
	return (Global_113648.f_10018.f_21 + Global_113648.f_18576.f_380);
}

void func_222(var uParam0, bool bParam1)//Position - 0x234DA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_223(int iParam0)//Position - 0x237FE
{
...
void func_224(int iParam0)//Position - 0x23831
{
	switch (iParam0)
	{
		case 30:
...
void func_225(int iParam0, bool bParam1)//Position - 0x23866
{
	if (iParam0 == -1)
	{
		return;
...
void func_226(int iParam0, int iParam1, bool bParam2)//Position - 0x238C3
{
	if (iParam0 == -1)
	{
		return;
...
int func_227(int iParam0, int iParam1)//Position - 0x238FE
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_228(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x2391E
{
	if (iParam0 != 198)
	{
		if (Global_78558)
...
void func_229(int iParam0, int iParam1)//Position - 0x23976
{
	switch (iParam0)
	{
		case 12:
...
void func_230(int iParam0, bool bParam1)//Position - 0x23A5F
{
	if (bParam1)
	{
...
bool func_231(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x23A88
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_233()//Position - 0x24408
{
	return Global_32164;
}

int func_234(var uParam0, int iParam1)//Position - 0x24413
{
	int iVar0;
...
int func_235(int iParam0)//Position - 0x27BAD
{
	switch (iParam0)
	{
		case 46:
...
void func_236(int iParam0, bool bParam1)//Position - 0x27C9C
{
	switch (iParam0)
	{
		case 46:
...
void func_237(int iParam0, bool bParam1)//Position - 0x27CED
{
	int iVar0;
...
void func_238(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x27D53
{
	func_239(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_239(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x27D74
{
	int iVar0;
...
void func_240()//Position - 0x27F47
{
	int iVar0;
...
int func_241(int iParam0)//Position - 0x2805F
{
	int iVar0;
	int iVar1;
...
void func_242(char* sParam0)//Position - 0x2809F
{
...
char* func_243(int iParam0)//Position - 0x280C3
{
	switch (iParam0)
	{
		case 0:
...
int func_244(int iParam0)//Position - 0x28296
{
...
void func_245(int iParam0, int iParam1)//Position - 0x282C0
{
...
int func_246(char* sParam0)//Position - 0x282FD
{
	int iVar0;
...
int func_247()//Position - 0x2835D
{
	return func_248(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_248(char* sParam0, int iParam1)//Position - 0x2836E
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_249(int* iParam0)//Position - 0x283B7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_250(bool bParam0)//Position - 0x283E2
{
	if (bParam0)
	{
...
bool func_251(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x2841A
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), ENTITY::GET_ENTITY_COORDS(iParam1, bParam3)) <= (fParam2 * fParam2);
}

void func_252()//Position - 0x2843C
{
	if (MISC::GET_GAME_TIMER() > iLocal_292)
	{
		if (func_332(&uLocal_121, 49, "BAR3CAU", "BAR3C_P1", 9, 1, 0, 0, 0))
		{
...
void func_253(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2847C
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_248(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
				Global_113648.f_18576[iVar4 /*6*/].f_4 = 0;
				MemCopy(&uVar5, {func_201(iVar4)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar5, 0, Global_100718, iParam0);
			}
			else
			{
				iVar6 = func_326(&(Global_100681.f_3));
				if (iVar6 > -1)
				{
...
void func_254(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x285F1
{
	func_255(&Global_107196, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_255(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2860D
{
	int iVar0;
	int iVar1;
...
int func_256(var uParam0)//Position - 0x29496
{
...
void func_257(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x294B8
{
	int iVar0;
...
int func_258(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x29540
{
...
int func_259(int iParam0)//Position - 0x29580
{
	int iVar0;
...
void func_260(var uParam0, int iParam1, int iParam2)//Position - 0x295AE
{
...
int func_261(int iParam0)//Position - 0x2968A
{
	int iVar0;
...
int func_262(int iParam0)//Position - 0x296CC
{
	int iVar0;
...
int func_263(int iParam0, int iParam1, int iParam2)//Position - 0x2972F
{
	int iVar0;
...
int func_264(int iParam0, int iParam1)//Position - 0x297BD
{
	struct<82> Var0;
...
void func_265(int iParam0, var uParam1, int iParam2)//Position - 0x297FF
{
	int iVar0;
...
void func_266(int iParam0, var uParam1)//Position - 0x29A5B
{
	int iVar0;
...
int func_267(int iParam0)//Position - 0x29D06
{
	switch (iParam0)
	{
		case 1:
...
int func_268(int iParam0, var uParam1, var uParam2)//Position - 0x29DB6
{
	int iVar0;
	int iVar1;
...
int func_269(int iParam0)//Position - 0x29FA9
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_270(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x29FC9
{
	char* sVar0;
...
int func_271(int iParam0, int iParam1, bool bParam2)//Position - 0x2A0F8
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_272(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2A166
{
...
void func_273(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A23E
{
	int iVar0;
	int iVar1;
...
int func_274(int iParam0, int iParam1)//Position - 0x2A3DE
{
	int iVar0;
	var uVar1;
	
	iVar0 = Global_2848280[iParam0 /*3*/][func_119(iParam1)];
...
void func_275(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2A40A
{
	int iVar0;
...
void func_276(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x2A953
{
	int iVar0;
...
int func_277()//Position - 0x2AB94
{
	func_34();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_278(int iParam0, bool bParam1)//Position - 0x2ABAD
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_35(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_279(iParam0, &(Global_113648.f_2365.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_279(int iParam0, var uParam1)//Position - 0x2ACA0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_280(int iParam0)//Position - 0x2AF28
{
	switch (iParam0)
	{
...
int func_281(int iParam0)//Position - 0x2AFC9
{
...
int func_282(int iParam0, int iParam1)//Position - 0x2B1A3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_283(int iParam0, var* uParam1)//Position - 0x2BE04
{
	int iVar0;
	int iVar1;
...
int func_284(int iParam0)//Position - 0x2BE3F
{
	int iVar0;
...
void func_285(int iParam0)//Position - 0x2C0B4
{
	int iVar0;
...
void func_286(var uParam0, int iParam1)//Position - 0x2C0F0
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_287(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x2C63F
{
	int iVar0;
	int iVar1;
...
bool func_288(int iParam0, var uParam1, var uParam2)//Position - 0x2C683
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_289(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x2CE02
{
	if (bParam2)
	{
...
int func_290(var uParam0)//Position - 0x2CE49
{
...
bool func_291(int iParam0)//Position - 0x2CEA4
{
	return func_292(iParam0, 0, 1);
}

int func_292(int iParam0, int iParam1, bool bParam2)//Position - 0x2CEB4
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_293(int iParam0)//Position - 0x2CF15
{
	switch (iParam0)
	{
		case 0:
...
int func_294(int iParam0)//Position - 0x2D2AE
{
	return func_292(iParam0, 5, 1);
}

int func_295(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x2D2BE
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_296(int iParam0, bool bParam1)//Position - 0x2D360
{
	switch (iParam0)
	{
		case -1:
		...
		case 45:
			return func_309(Global_102825);
			break;
		
		case 46:
			if (Global_1853747 != func_27())
			{
				if (func_308(Global_1853747))
				{
					return func_301(2, 2);
				}
				else if (func_300(Global_1853747))
				{
...
Vector3 func_297()//Position - 0x2DAB0
{
	if (!func_299(Global_1956117))
	{
...
int func_298()//Position - 0x2DDAB
{
	return Global_2652258.f_2650;
}

int func_299(struct<3> Param0)//Position - 0x2DDBA
{
...
int func_300(int iParam0)//Position - 0x2DDE4
{
	if (iParam0 != func_27())
	{
...
Vector3 func_301(int iParam0, int iParam1)//Position - 0x2DE3C
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_302(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2DEE6
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
...
Vector3 func_303(struct<3> Param0, float fParam1)//Position - 0x2DF7B
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_304(int iParam0)//Position - 0x2DFBF
{
	struct<6> Var0;
...
struct<6> func_305(int iParam0)//Position - 0x2E143
{
	return func_306(iParam0);
}

struct<6> func_306(int iParam0)//Position - 0x2E151
{
	struct<6> Var0;
...
int func_307(int iParam0, var uParam1)//Position - 0x2EC18
{
	switch (iParam0)
	{
		case 0:
...
int func_308(int iParam0)//Position - 0x2EC9A
{
	if (iParam0 != func_27())
	{
...
Vector3 func_309(int iParam0)//Position - 0x2ECF2
{
	switch (iParam0)
	{
		case 1:
...
int func_310()//Position - 0x2EF69
{
	return func_311(PLAYER::PLAYER_ID());
}

int func_311(int iParam0)//Position - 0x2EF79
{
	return MISC::GET_BITS_IN_RANGE(Global_2657589[iParam0 /*466*/].f_321.f_3, 28, 31);
}

int func_312(int iParam0)//Position - 0x2EF96
{
	return func_292(iParam0, 0, 0);
}

int func_313(int iParam0)//Position - 0x2EFA6
{
	switch (iParam0)
	{
		case -1:
...
bool func_314()//Position - 0x2F2CF
{
	return Global_100733.f_387 > 0;
}

var func_315()//Position - 0x2F2E0
{
	var uVar0;
...
void func_316(var uParam0, int iParam1)//Position - 0x2F326
{
	if (iParam1 <= 0)
	{
		return;
...
void func_317(var uParam0, int iParam1)//Position - 0x2F3AC
{
...
void func_318(var uParam0, int iParam1)//Position - 0x2F3DF
{
	int iVar0;
	int iVar1;
...
int func_319(int iParam0, int iParam1)//Position - 0x2F430
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_320(int iParam0)//Position - 0x2F4D2
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_321(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_321(bool bParam0, int iParam1, int iParam2)//Position - 0x2F4F4
{
	if (bParam0)
	{
		return iParam1;
...
int func_322(var uParam0)//Position - 0x2F50B
{
	return uParam0 & 15;
}

void func_323(var uParam0, int iParam1)//Position - 0x2F518
{
...
void func_324(var uParam0, int iParam1)//Position - 0x2F552
{
...
void func_325(var uParam0, int iParam1)//Position - 0x2F58D
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_326(char* sParam0)//Position - 0x2F5C9
{
...
int func_327(int iParam0)//Position - 0x2F61F
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_328(Global_113648.f_9087.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_328(Global_113648.f_9087.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_328(Global_113648.f_9087.f_99.f_205[11]);
			break;
		
		case 90:
			return func_328(Global_113648.f_9087.f_99.f_205[7]);
			break;
		
		case 93:
			return func_328(Global_113648.f_9087.f_99.f_205[9]);
			break;
	}
	return 0;
}

int func_328(int iParam0)//Position - 0x2F6DB
{
	switch (iParam0)
	{
		case 1:
...
int func_329(char* sParam0, bool bParam1)//Position - 0x2F72F
{
	int iVar0;
	int iVar1;
...
int func_330(int iParam0, bool bParam1)//Position - 0x2F759
{
	int iVar0;
...
void func_331(bool bParam0)//Position - 0x2F78F
{
	int iVar0;
	int iVar1;
...
bool func_332(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x2FA11
{
...
void func_333()//Position - 0x2FA70
{
	func_17();
	switch (iLocal_95)
	{
...
void func_334(int iParam0)//Position - 0x2FC1B
{
	bool bVar0;
	int iVar1;
...
void func_335(bool bParam0, int iParam1)//Position - 0x2FC8C
{
	int iVar0;
...
void func_336(char* sParam0, int iParam1)//Position - 0x2FD26
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

void func_337()//Position - 0x2FD3D
{
	struct<3> Var0;
	...
	switch (iLocal_95)
	{
		case 0:
			func_47(&iLocal_96);
			iLocal_96 = func_338(Local_112, 5, 1);
...
int func_338(struct<3> Param0, int iParam1, bool bParam2)//Position - 0x2FF79
{
	int iVar0;
...
void func_339()//Position - 0x2FFA7
{
	func_17();
	switch (iLocal_95)
	{
...
void func_340(int iParam0, bool bParam1)//Position - 0x30163
{
	int iVar0;
...
void func_341(int iParam0)//Position - 0x301AD
{
...
void func_342()//Position - 0x301D3
{
	switch (iLocal_95)
	{
		case 0:
			...
			else
			{
				...
				else if (!iLocal_287 && (MISC::GET_GAME_TIMER() - iLocal_292) > 120000)
				{
					if (!func_344())
					{
						if (func_343(&uLocal_121, 49, "BAR3CAU", "BAR3C_HC", 7, 0, 0, 1))
						{
							iLocal_287 = 1;
						}
					}
...
bool func_343(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)//Position - 0x303D2
{
...
int func_344()//Position - 0x30420
{
	...
	while (iLocal_120 <= 7)
	{
		if (!Local_117[iLocal_120 /*7*/].f_6 && func_9(PLAYER::PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/], 8f, 1))
		{
			return 1;
		}
		iLocal_120++;
...
void func_345()//Position - 0x304A2
{
	if (!iLocal_119)
	{
		func_346(0f, 0f, 0f, 0f, 0, 145);
		iLocal_119 = 1;
	}
}

void func_346(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x304BE
{
	struct<3> Var0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104212.f_4))
	{
		...
		{
			if (func_373(24) != Global_104212.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_370(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_347(Global_104212.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}

void func_347(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x30539
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_366(iParam3, &Var0, Param1, fParam2, func_262(iParam0));
		func_348(iParam3, iParam0, 0);
	}
}

void func_348(int iParam0, int iParam1, int iParam2)//Position - 0x30662
{
	int iVar0;
	...
	if (!func_365(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_113648.f_32751.f_4801 = func_315();
			}
...
void func_349(int iParam0, int iParam1)//Position - 0x30779
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_266(iParam0, &(Global_113648.f_32751.f_5510));
}

int func_350(int iParam0)//Position - 0x3097B
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_271(iParam0, 0, 0)) || func_271(iParam0, 1, 0)) || func_271(iParam0, 2, 0)) || func_262(iParam0) != 145) || func_364(iParam0)) || func_363(iParam0)) || func_362(iParam0)) || func_361(iParam0)) || !func_351(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_363(iParam0))
		{
		}
...
int func_351(int iParam0)//Position - 0x30A58
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_352(int iParam0, bool bParam1, int iParam2)//Position - 0x30C0A
{
	int iVar0;
	struct<2> Var1;
	...
	{
		if ((func_214() || MISC::IS_PC_VERSION()) || func_213())
		{
		}
		else if (!func_357())
		{
...
int func_353(int iParam0)//Position - 0x30D8C
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_355(int iParam0, int iParam1)//Position - 0x30E6F
{
	int iVar0;
	int iVar1;
...
int func_356()//Position - 0x344A0
{
	return 0;
}

int func_357()//Position - 0x344A9
{
	return 1;
}

int func_358()//Position - 0x344B2
{
	return 1;
}

int func_359()//Position - 0x344BB
{
...
int func_361(int iParam0)//Position - 0x3458C
{
	int iVar0;
	char* sVar1;
...
int func_362(int iParam0)//Position - 0x345D3
{
	int iVar0;
...
int func_363(int iParam0)//Position - 0x3460E
{
	int iVar0;
...
int func_364(int iParam0)//Position - 0x3468A
{
	int iVar0;
...
int func_365(var uParam0, int iParam1)//Position - 0x34772
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_289(Global_113648.f_32751.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_289(Global_113648.f_2365.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_289(Global_113648.f_2365.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_366(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x35E60
{
	if (func_365(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_368(iParam0);
			func_367(uParam1, &(Global_113648.f_32751.f_69[Global_77348.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_367(var uParam0, var uParam1)//Position - 0x35F59
{
...
void func_368(int iParam0)//Position - 0x36025
{
	if (iParam0 == -1)
	{
		return;
...
void func_369(int iParam0)//Position - 0x3609C
{
...
int func_370(struct<3> Param0, int iParam1, var uParam2, var uParam3)//Position - 0x360C3
{
	int iVar0;
	
	iVar0 = func_371(Param0, iParam1, 1);
	switch (iVar0)
	{
		case 0:
...
int func_371(struct<3> Param0, int iParam1, int iParam2)//Position - 0x361D9
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_372(int iParam0)//Position - 0x36268
{
	return BitTest(Global_113648.f_7231[iParam0], 0);
}

int func_373(int iParam0)//Position - 0x3627D
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_374()//Position - 0x36299
{
	switch (iLocal_95)
	{
		case 0:
			iLocal_298 = 0;
			bLocal_297 = false;
			if (func_332(&uLocal_121, 49, "BAR3CAU", "BAR3C_NG", 9, 1, 0, 0, 0))
			{
				iLocal_95 = 1;
			}
			break;
...
void func_375()//Position - 0x36384
{
	switch (iLocal_95)
	{
		case 0:
...
void func_376(int iParam0, bool bParam1)//Position - 0x36891
{
...
void func_377()//Position - 0x368CD
{
	switch (iLocal_95)
	{
		case 0:
...
void func_378(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)//Position - 0x369DE
{
	switch (*uParam0)
	{
		case 0:
		...
		case 2:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
			{
				...
				{
					if (func_379(uParam1, sParam2, sParam3, sParam4, 8, 1, 0))
					{
						*uParam0 = 3;
					}
				}
		...
		case 4:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && func_379(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
bool func_379(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x36AEF
{
...
void func_380()//Position - 0x36B43
{
	Global_20591 = 0;
	func_42();
}

struct<6> func_381()//Position - 0x36B53
{
	struct<6> Var0;
	int iVar1;
	int iVar2;
...
struct<6> func_382()//Position - 0x36BFF
{
	struct<6> Var0;
...
void func_383()//Position - 0x36C23
{
}

int func_384()//Position - 0x36C2B
{
	if (!func_421(PLAYER::PLAYER_PED_ID()))
	{
		return 1;
...
void func_385()//Position - 0x36D58
{
	switch (iLocal_95)
	{
		case 0:
		...
		case 1:
			if (func_401())
			{
				if ((func_421(Local_97.f_4) && func_421(iLocal_114)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_97.f_4, iLocal_114))
				{
...
void func_386()//Position - 0x36DEE
{
	if (func_421(Local_97.f_4))
	{
	...
	func_397(0);
	func_387(&Local_79, 1, 0, 0);
}

void func_387(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x36E31
{
	func_393(uParam0, iParam1);
	func_391(uParam0, bParam2);
	func_388(uParam0, bParam3);
}

void func_388(var uParam0, bool bParam1)//Position - 0x36E51
{
	func_389(&(uParam0->f_41), bParam1);
}

void func_389(var uParam0, bool bParam1)//Position - 0x36E63
{
	int iVar0;
...
void func_390(int* iParam0, bool bParam1)//Position - 0x36EA1
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_391(var uParam0, bool bParam1)//Position - 0x36EDC
{
	func_392(&(uParam0->f_35), bParam1);
}

void func_392(var uParam0, bool bParam1)//Position - 0x36EEE
{
	int iVar0;
...
void func_393(var uParam0, int iParam1)//Position - 0x36F2B
{
	func_394(&(uParam0->f_28), iParam1);
}

void func_394(var uParam0, int iParam1)//Position - 0x36F3D
{
	int iVar0;
...
void func_395(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x36F7E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_396(int* iParam0)//Position - 0x36FCE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_397(bool bParam0)//Position - 0x3700F
{
	func_398(39, bParam0);
	func_398(40, bParam0);
	func_398(41, bParam0);
...
void func_398(int iParam0, bool bParam1)//Position - 0x37047
{
	if (bParam1)
	{
	...
	{
		func_399(iParam0, 2, 1);
	}
}

void func_399(int iParam0, int iParam1, bool bParam2)//Position - 0x3707E
{
	int iVar0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_57() == 0)
		{
			iVar0 = func_120(func_293(iParam0), -1, 0);
			MISC::CLEAR_BIT(&iVar0, iParam1);
			func_118(func_293(iParam0), iVar0, -1, 1, 0);
		}
	}
	else
	{
...
void func_400(int iParam0, int iParam1, bool bParam2)//Position - 0x370F0
{
	int iVar0;
...
void func_402(char* sParam0, bool bParam1)//Position - 0x3718F
{
	func_403(sParam0);
	func_477(bParam1);
}

void func_403(char* sParam0)//Position - 0x371A3
{
...
void func_404(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x371E2
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_406(Global_78814, Global_78816, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
float func_405(char* sParam0)//Position - 0x374C7
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_406(int iParam0, int iParam1, int iParam2)//Position - 0x374DA
{
	struct<2> Var0;
	int iVar1;
...
char* func_407(int iParam0)//Position - 0x375B0
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_408(int iParam0)//Position - 0x37703
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_409(int iParam0)//Position - 0x37736
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_410(int iParam0)//Position - 0x37769
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_411(int iParam0)//Position - 0x3779C
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_412(int iParam0)//Position - 0x377CF
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_413(int iParam0)//Position - 0x3780C
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_414(int iParam0)//Position - 0x3783F
{
	struct<2> Var0;
...
int func_415(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x378A8
{
	if (((!func_418(0) || Global_78828) || Global_78817 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78813)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_417(0)) || func_416(1))
			{
			}
			else
			{
...
bool func_416(bool bParam0)//Position - 0x379C0
{
	if (bParam0)
	{
...
int func_417(int iParam0)//Position - 0x379E9
{
	if (iParam0 == 1)
	{
		if (Global_20383.f_1 > 3)
...
int func_418(int iParam0)//Position - 0x37A40
{
	if (Global_43257 == 15)
	{
		return 0;
...
bool func_419(int iParam0)//Position - 0x37A62
{
	return func_420(iParam0, Global_43257);
}

int func_420(int iParam0, int iParam1)//Position - 0x37A73
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_421(int iParam0)//Position - 0x37C54
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_422(bool bParam0)//Position - 0x37C75
{
...
void func_423(bool bParam0)//Position - 0x37C9D
{
	if (bParam0)
	{
		if (func_440())
		...
		{
			func_438(-1237.9617f, -1035.1941f, 7.2466f, 110f, 1, 0);
		}
		else
		{
			func_438(-1074.1339f, -1250.2921f, 4.5293f, 199.5f, 1, 0);
		}
	}
	func_431();
	func_430();
	...
	func_341(7);
	func_341(7);
	func_429(-1151.36f, -1243.57f, 6.52f, 25.18f);
	if (bParam0)
	{
		if (iLocal_115 == joaat("towtruck") || iLocal_115 == joaat("towtruck2"))
		{
			func_426(-1237.9617f, -1035.1941f, 7.2466f, 110f, 0);
		}
		else
		{
			func_426(-1074.1339f, -1250.2921f, 4.5293f, 199.5f, 0);
		}
		while (!HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			SYSTEM::WAIT(0);
		}
		func_424(iLocal_114, -1, 0);
	}
	else if (iLocal_115 == joaat("towtruck") || iLocal_115 == joaat("towtruck2"))
	{
		func_426(-1237.9617f, -1035.1941f, 7.2466f, 110f, 1);
	}
	else
	{
		func_426(-1074.1339f, -1250.2921f, 4.5293f, 199.5f, 1);
	}
	func_376(500, 1);
}

void func_424(int iParam0, int iParam1, int iParam2)//Position - 0x37E6E
{
	if (func_457() && func_425())
	{
...
var func_425()//Position - 0x37F32
{
	return BitTest(Global_100681.f_20, 13);
}

void func_426(struct<3> Param0, float fParam1, bool bParam2)//Position - 0x37F43
{
	if (func_421(PLAYER::PLAYER_PED_ID()))
	{
		if (bParam2)
	...
	if (bParam2)
	{
		func_427(PLAYER::PLAYER_PED_ID(), iLocal_114, -1, 0);
	}
...
void func_427(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x38006
{
	if (func_428(iParam0))
	{
		if (func_421(iParam1))
...
int func_428(int iParam0)//Position - 0x38068
{
	if (func_421(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_429(struct<3> Param0, float fParam1)//Position - 0x38088
{
...
void func_430()//Position - 0x3817D
{
	if (func_421(PLAYER::PLAYER_PED_ID()))
	{
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
...
void func_431()//Position - 0x381AF
{
	HUD::CLEAR_PRINTS();
	HUD::CLEAR_HELP(true);
	if (func_15())
...
void func_432(int iParam0)//Position - 0x381D0
{
	if (func_435())
	{
		return;
...
void func_433(bool bParam0, bool bParam1)//Position - 0x3825A
{
	if (bParam0)
	{
		if (func_417(0))
...
bool func_434()//Position - 0x382CE
{
	return BitTest(Global_1962996, 5);
}

bool func_435()//Position - 0x382DC
{
	return BitTest(Global_1962996, 19);
}

void func_436()//Position - 0x382EB
{
	Global_20591 = 0;
	func_437();
}

void func_437()//Position - 0x382FB
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_438(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x3831C
{
	if (func_457())
	{
...
int func_439()//Position - 0x383B1
{
	return Global_107196.f_2890.f_12.f_66;
}

bool func_440()//Position - 0x383C4
{
	return func_441(&(Global_107196.f_2890));
}

int func_441(var uParam0)//Position - 0x383D7
{
	if (uParam0->f_12.f_66 == 0)
	{
		return 0;
	}
	if (!func_352(uParam0->f_12.f_66, 0, -1))
	{
		return 0;
	}
...
int func_442(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x38437
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_443(bool bParam0)//Position - 0x384B2
{
	if (bParam0)
	{
		if (func_440())
		...
		if (iLocal_115 == joaat("towtruck") || iLocal_115 == joaat("towtruck2"))
		{
			func_438(-1154.2244f, -1234.3102f, 5.7174f, 12.45f, 1, 0);
		}
		else
		{
			func_438(-1148.1831f, -1227.005f, 8.4468f, 19.2f, 1, 0);
		}
	}
	func_431();
	func_430();
	func_47(&iLocal_96);
	if (bParam0 && !Global_94858)
	{
		iLocal_307 = 1;
		iLocal_94 = 7;
	}
	...
	if (bParam0)
	{
		if (iLocal_115 == joaat("towtruck") || iLocal_115 == joaat("towtruck2"))
		{
			func_426(-1154.2244f, -1234.3102f, 5.7174f, 12.45f, 0);
		}
		else
		{
			func_426(-1148.1831f, -1227.005f, 8.4468f, 19.2f, 0);
		}
		while (!HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			SYSTEM::WAIT(0);
	...
	{
		func_426(-1154.2244f, -1234.3102f, 5.7174f, 12.45f, 1);
	}
	else
	{
		func_426(-1148.1831f, -1227.005f, 8.4468f, 19.2f, 1);
	}
	func_253(2, "Delivered vehicle", 1, 0, 0, 1);
}

void func_444(bool bParam0)//Position - 0x386F9
{
	if (bParam0)
	{
		if (func_440())
		...
		func_438(Local_97, Local_97.f_3, 1, 0);
	}
	...
	if (bParam0)
	{
		func_438(Local_311, fLocal_312, 1, 0);
	}
	...
	func_11(7, 0);
	func_11(7, 0);
	func_429(Local_97, Local_97.f_3);
	if (bParam0)
	{
		func_426(Local_311, fLocal_312, 0);
		if (func_421(iLocal_114) && iLocal_115 == joaat("towtruck"))
		{
	...
	{
		func_426(Local_311, fLocal_312, 1);
		if (func_421(iLocal_114) && iLocal_115 == joaat("towtruck"))
		{
			VEHICLE::SET_VEHICLE_TOW_TRUCK_ARM_POSITION(iLocal_114, 0f);
		}
...
void func_445(int iParam0, int iParam1, int iParam2)//Position - 0x38974
{
	func_446(0, 0, iParam2, 1);
	if (iParam0 == 1)
	{
		CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
...
void func_446(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x389A8
{
	int iVar0;
...
void func_447(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x38A52
{
	if (bParam0)
	{
	...
	else
	{
		...
		func_453(0, bParam3, iParam2, 0);
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_451(PLAYER::PLAYER_ID())) && !func_449(PLAYER::PLAYER_ID(), 0)) && !func_448()) && !bParam4) && !bParam5) && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_451(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_78556 = 0;
...
bool func_448()//Position - 0x38B9F
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_449(int iParam0, int iParam1)//Position - 0x38BB9
{
	bool bVar0;
	
	if (iParam0 == PLAYER::PLAYER_ID())
	{
		bVar0 = func_450(-1, 0) == 8;
	}
	else
	{
...
int func_450(int iParam0, bool bParam1)//Position - 0x38C04
{
	int iVar0;
	int iVar1;
...
int func_451(int iParam0)//Position - 0x38C45
{
...
bool func_452()//Position - 0x38C84
{
	return BitTest(Global_2621446, 3);
}

int func_453(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x38C92
{
	int iVar0;
...
void func_454(int iParam0)//Position - 0x38CC5
{
	if (iParam0 == 1)
	{
...
void func_455(bool bParam0)//Position - 0x38CE8
{
	if (bParam0)
	{
		func_438(Local_97, Local_97.f_3, 1, 0);
...
void func_458()//Position - 0x38E73
{
	...
	Local_97.f_3 = -76.2f;
	Local_117[0 /*7*/] = { func_470(-552.67f, -1698.84f, 18.16f, 205.7f) };
	Local_117[1 /*7*/] = { func_470(-317.14f, -1540.72f, 26.67f, 336.5f) };
	Local_117[2 /*7*/] = { func_470(-104.41f, -1984.91f, 17.02f, 171.6f) };
	Local_117[3 /*7*/] = { func_470(-586.69f, -1774.59f, 21.67f, 145.8f) };
	Local_117[4 /*7*/] = { func_470(-1207.9f, -1334.87f, 3.77f, 204.1f) };
	Local_117[5 /*7*/] = { func_470(-1253.67f, -1210.3f, 6.03f, 10.7f) };
	Local_117[6 /*7*/] = { func_470(-426.56f, -1717.89f, 18.2f, 43.5f) };
	Local_117[7 /*7*/] = { func_470(401.64f, -1633.3f, 28.29f, 231.5f) };
	if (func_421(Local_97.f_4))
	{
		VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_97.f_4, false);
		VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_97.f_4, false);
	...
	if (func_421(PLAYER::PLAYER_PED_ID()))
	{
		func_469(&uLocal_121, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	func_469(&uLocal_121, 3, 0, "BARRY", 0, 1);
	iLocal_289 = 0;
	func_467();
	sLocal_310 = "DEFAULT" /* GXT: _ */;
	iLocal_303 = 0;
...
void func_459(int iParam0, int iParam1, bool bParam2)//Position - 0x39160
{
	int iVar0;
	...
	if (Global_117[iParam0 /*10*/].f_8 != 169)
	{
		...
		if (iParam1 == 4)
		{
			...
			func_465(iParam0, 1, 1);
			func_465(iParam0, 2, 1);
		...
		{
			if (func_463(iParam0, iParam1) == 1 && func_462(iParam0, iParam1) == 1)
			{
				bParam2 = false;
			}
			iVar0 = iParam1;
			func_465(iParam0, iVar0, 1);
		...
		if (bParam2)
		{
			if (!Global_78558)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8912[iParam1 /*4*/] = { func_461(iParam0) };
					...
					{
						Global_8863[1 /*6*/] = { func_461(iParam0) };
...
void func_460()//Position - 0x392D8
{
	char cVar0[64];
	char cVar1[64];
	char* sVar2;
...
struct<4> func_461(int iParam0)//Position - 0x39353
{
	return Global_2028[iParam0 /*29*/].f_3;
}

int func_462(int iParam0, int iParam1)//Position - 0x39366
{
...
int func_463(int iParam0, int iParam1)//Position - 0x39390
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_464(int iParam0, int iParam1, int iParam2)//Position - 0x393BA
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_465(int iParam0, int iParam1, int iParam2)//Position - 0x393FF
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_466()//Position - 0x39444
{
...
void func_467()//Position - 0x39474
{
	Local_308[0 /*3*/] = { func_468("B3CENTV", 1) };
	Local_308[1 /*3*/] = { func_468("B3CDELV", 1) };
	Local_308[2 /*3*/] = { func_468("B3CWAN1", -1) };
	Local_308[3 /*3*/] = { func_468("B3CNOGO", 1) };
	Local_308[4 /*3*/] = { func_468("B3CREVRS", 1) };
	Local_308[5 /*3*/] = { func_468("B3CLEAVE", 1) };
	Local_308[6 /*3*/] = { func_468("B3CRTTT", 1) };
	Local_308[7 /*3*/] = { func_468("B3CGBTB", 1) };
	Local_308[8 /*3*/] = { func_468("B3CRTCB", 1) };
}

Vector3 func_468(char* sParam0, int iParam1)//Position - 0x39516
{
	struct<3> Var0;
...
void func_469(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x39531
{
...
struct<7> func_470(struct<3> Param0, float fParam1)//Position - 0x395CC
{
	struct<7> Var0;
...
int func_471()//Position - 0x395F4
{
	return PED::ADD_SCENARIO_BLOCKING_AREA(-564f, -1758.1f, 16.5f, -419.31f, -1649f, 23f, false, true, true, true);
}

void func_472(var uParam0, var uParam1)//Position - 0x39622
{
	*uParam0 = *uParam1;
	*uParam1 = 0;
}

void func_473(var uParam0, int iParam1)//Position - 0x39634
{
	Global_100681.f_22[iParam1] = uParam0;
}

void func_474(int iParam0, var uParam1)//Position - 0x39648
{
	*iParam0 = *uParam1;
	*uParam1 = 0;
}

void func_475()//Position - 0x3965A
{
	if (func_476())
	{
	}
...
void func_477(bool bParam0)//Position - 0x3974A
{
	int iVar0;
...
void func_478(char* sParam0, int iParam1)//Position - 0x3981A
{
	if (Global_100681 != 12)
	{
...
int func_479(char* sParam0, int iParam1, int iParam2)//Position - 0x39842
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
...
int func_480()//Position - 0x399D1
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_329(&(Global_100681.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_482()//Position - 0x39A45
{
	...
	{
		if (func_326(&(Global_100681.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_483(bool bParam0)//Position - 0x39AB1
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_484(int iParam0)//Position - 0x39AC5
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_485(int iParam0)//Position - 0x39AFF
{
	if (iParam0 == 1)
	{
...
void func_486()//Position - 0x39B39
{
	Global_23131.f_5 = 1;
}

void func_487()//Position - 0x39B47
{
	Global_23131.f_5 = 0;
}

void func_488(bool bParam0)//Position - 0x39B55
{
	if (bParam0)
	{
		func_489();
...
void func_489()//Position - 0x39BB8
{
...
void func_490()//Position - 0x39BE1
{
	Global_94857 = 0;
	Global_94858 = 0;
}

int func_491()//Position - 0x39BF3
{
...
void func_492()//Position - 0x39C31
{
	Global_100716 = 1;
...
void func_493(char* sParam0)//Position - 0x39D1E
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_494()//Position - 0x39D30
{
	int iVar0;
...
void func_495(var uParam0)//Position - 0x39D50
{
...
void func_496(var uParam0)//Position - 0x39D70
{
	int iVar0;
...
int func_497(int iParam0)//Position - 0x39DAA
{
	if (!func_35(iParam0))
	{
		return func_38(iParam0);
