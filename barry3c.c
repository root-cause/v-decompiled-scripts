#region Local Var
	...
	int iLocal_183[2] = { 0, 0 };
	int iLocal_186 = 0;
	int iLocal_187 = 0;
	int iLocal_188 = 0;
	struct<7> Local_189[8];
	int iLocal_246 = 0;
	int iLocal_247 = 0;
	int iLocal_248 = 0;
	var uLocal_249 = 16;
	...
	int iLocal_428 = 0;
	int iLocal_429 = 0;
	char* sLocal_430[4] = { NULL, NULL, NULL, NULL };
	int iLocal_435 = 0;
	int iLocal_436 = 0;
	struct<7> Local_437[2];
	float fLocal_452[2] = { 0f, 0f };
	int iLocal_455 = 0;
	struct<3> Local_456[9];
	int iLocal_484 = 0;
...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_78 = func_503(49);
	Local_171 = { -0.1f, -0.85f, 0.23f };
	Local_174 = { 8f, 0.5f, 0f };
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_79.f_35[0]))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_79.f_35[0], false))
		{
			...
			func_480(&(Local_157.f_4), &(Local_79.f_35[0]));
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_157.f_4, true, 1);
			func_479(Local_157.f_4, 0);
		}
	}
	func_478(&iLocal_170, &(Local_79.f_41[0]));
	func_464();
	if (ENTITY::DOES_ENTITY_EXIST(Local_79.f_35[1]))
	{
		func_480(&(Local_189[6 /*7*/].f_4), &(Local_79.f_35[1]));
	}
	if (func_463())
	{
		iVar0 = func_462();
	...
	while (true)
	{
		...
		func_409(Local_79.f_9, 0, 0, 0, 0, 0);
		if (iLocal_154 == 13)
		{
			func_390();
		}
		...
		{
			func_388();
			func_383(&uLocal_141, &uLocal_249, "BAR3CAU", &sLocal_142, &cLocal_148);
			switch (iLocal_154)
			{
				case 0:
					func_382();
...
void func_1()//Position - 0x2FE
{
	...
	switch (iLocal_155)
	{
		...
		case 1:
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_157.f_4, Local_437[0 /*7*/][0 /*3*/], Local_437[0 /*7*/][1 /*3*/], fLocal_452[0], false, true, 0))
			{
				iLocal_155 = 2;
			}
			else
...
{
	if (func_426(iLocal_186) && func_426(Local_157.f_4))
	{
		if (func_3())
		{
			if (VEHICLE::DOES_CARGOBOB_HAVE_PICK_UP_ROPE(iLocal_186) && VEHICLE::IS_VEHICLE_ATTACHED_TO_CARGOBOB(iLocal_186, Local_157.f_4))
			{
				bLocal_178 = true;
				return 1;
			}
		}
		else if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_186, Local_157.f_4))
		{
			bLocal_178 = true;
			return 1;
		}
...
int func_3()//Position - 0x42B
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iLocal_186);
...
int func_4()//Position - 0x467
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_186) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_186, false))
	{
		return 1;
	}
		...
		if (func_426(iVar0))
		{
			...
			if ((((iVar1 == joaat("towtruck") || iVar1 == joaat("towtruck2")) || iVar1 == joaat("cargobob")) || iVar1 == joaat("cargobob2")) || iVar1 == joaat("cargobob3"))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_186))
				{
					if (iLocal_166)
					{
						VEHICLE::REMOVE_VEHICLE_UPSIDEDOWN_CHECK(iLocal_186);
						iLocal_166 = 0;
					}
					ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_186);
				}
				iLocal_248 = 0;
				while (iLocal_248 <= 7)
				{
					if (func_426(Local_189[iLocal_248 /*7*/].f_4) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_189[iLocal_248 /*7*/].f_4, false))
					{
						bVar2 = true;
						Local_189[iLocal_248 /*7*/].f_6 = 1;
						func_480(&iLocal_186, &(Local_189[iLocal_248 /*7*/].f_4));
					}
					iLocal_248++;
				}
				if (!bVar2)
				...
				VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(iLocal_186);
				iLocal_166 = 1;
				VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(iLocal_186, false, 0);
				iLocal_436 = 0;
				return 1;
			}
		}
...
void func_5(bool bParam0)//Position - 0x598
{
	if (bParam0)
	{
		...
		while (iLocal_248 <= 7)
		{
			func_10(&(Local_189[iLocal_248 /*7*/].f_4));
			iLocal_248++;
		}
	}
	else
	{
		...
		while (iLocal_248 <= 7)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_189[iLocal_248 /*7*/].f_4))
			{
				if (!func_9(PLAYER::PLAYER_PED_ID(), Local_189[iLocal_248 /*7*/], 175f, 1) && func_8(PLAYER::PLAYER_PED_ID(), Local_189[iLocal_248 /*7*/].f_4, 1) > 175f)
				{
					func_6(&(Local_189[iLocal_248 /*7*/].f_4));
				}
			}
			else if (!Local_189[iLocal_248 /*7*/].f_6 && func_9(PLAYER::PLAYER_PED_ID(), Local_189[iLocal_248 /*7*/], 100f, 1))
			{
				Local_189[iLocal_248 /*7*/].f_4 = VEHICLE::CREATE_VEHICLE(joaat("towtruck"), Local_189[iLocal_248 /*7*/], Local_189[iLocal_248 /*7*/].f_3, true, true, false);
				if (iLocal_248 == 6)
				{
					VEHICLE::SET_VEHICLE_COLOURS(Local_189[iLocal_248 /*7*/].f_4, 39, 43);
				}
				else
				{
					VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_189[iLocal_248 /*7*/].f_4, 0);
				}
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_189[iLocal_248 /*7*/].f_4, 5f);
				VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(Local_189[iLocal_248 /*7*/].f_4, false, 0);
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_189[iLocal_248 /*7*/].f_4, true);
			}
			iLocal_248++;
		}
	}
...
void func_6(int* iParam0)//Position - 0x6CA
{
...
int func_7(int iParam0)//Position - 0x766
{
	if (func_426(iParam0))
	{
...
float func_8(int iParam0, int iParam1, bool bParam2)//Position - 0x790
{
	struct<3> Var0;
	struct<3> Var3;
...
bool func_9(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x7EE
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

void func_10(int* iParam0)//Position - 0x80C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
{
	Local_456[iParam0 /*3*/].f_1 = iParam1;
}

void func_12(int iParam0)//Position - 0x857
{
	if (Local_456[iParam0 /*3*/].f_1 < Local_456[iParam0 /*3*/] || Local_456[iParam0 /*3*/] == -1)
	{
		func_14(Local_456[iParam0 /*3*/].f_2, 7500, 1);
		func_13(&uLocal_141);
		Local_456[iParam0 /*3*/].f_1++;
	}
}
...
void func_14(char* sParam0, int iParam1, int iParam2)//Position - 0x8D7
{
	iParam2 = iParam2;
...
void func_17()//Position - 0x945
{
	if (!iLocal_426)
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_157.f_4, false))
		{
			iLocal_426 = 1;
			bLocal_425 = false;
			iLocal_422 = 0;
		...
		else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_157.f_4, true))
		{
			func_18();
		}
	}
	else
	{
		...
		{
			if (!bLocal_425 && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0 /*PLAYER_CONTROL*/, 75 /*INPUT_VEH_EXIT*/))
			{
				bLocal_425 = true;
			}
			switch (iLocal_422)
			{
				case 0:
					...
					else
					{
						...
						{
							if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_157.f_4, -1, false) == PLAYER::PLAYER_PED_ID())
							{
								iLocal_422 = 1;
							}
						}
				...
				case 2:
					...
					TASK::TASK_PLAY_ANIM(0, sLocal_427, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(0, sLocal_427, "franklinfailingtostartcar_loop", 8f, -8f, 1500, 9, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(0, sLocal_427, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0f, false, false, false);
				...
				case 3:
					...
					{
						AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_424, "IGNITION_FAIL", Local_157.f_4, "BARRY_03_SOUNDSET", false, 0);
				...
				case 7:
					...
					{
						TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
						TASK::TASK_LEAVE_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_157.f_4, 0);
						PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
					}
					break;
				}
...
void func_19()//Position - 0xBB1
{
	...
	switch (iLocal_155)
	{
		case 0:
			...
			func_47(&iLocal_156);
			if (func_426(iLocal_186))
			{
				iLocal_156 = func_46(Local_157.f_4, 1, 5);
				HUD::SET_BLIP_ROUTE(iLocal_156, true);
				if (bLocal_178)
				{
					func_12(7);
				}
				if ((!func_15() && iLocal_436) && !PAD::IS_CONTROL_PRESSED(0 /*PLAYER_CONTROL*/, 74 /*INPUT_VEH_HEADLIGHT*/))
				{
					iLocal_429 = 0;
				}
				iLocal_155 = 1;
		...
		case 1:
			func_20();
			if (iLocal_455 && !func_426(iLocal_186))
			{
				func_47(&iLocal_156);
				HUD::CLEAR_PRINTS();
				iLocal_154 = 10;
			...
			else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_157.f_4, Local_437[0 /*7*/][0 /*3*/], Local_437[0 /*7*/][1 /*3*/], fLocal_452[0], false, false, 0) && !ENTITY::IS_ENTITY_IN_AIR(Local_157.f_4))
			{
				Var0 = { ENTITY::GET_ENTITY_COORDS(Local_157.f_4, true) };
				if (Var0.f_2 < 6.7f)
				{
					iLocal_154 = 12;
					iLocal_155 = 0;
...
void func_20()//Position - 0xD00
{
	switch (iLocal_429)
	{
		case 0:
			...
			if (func_44())
			{
				if (func_21(&uLocal_249, "BAR3CAU", sLocal_430[iLocal_435], 7, 1, 0, 0))
				{
					iLocal_429 = 1;
				}
			}
			else if (func_21(&uLocal_249, "BAR3CAU", sLocal_430[iLocal_435], 7, 0, 0, 0))
			{
				iLocal_429 = 1;
			}
			break;
...
bool func_21(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xDA1
{
...
int func_22(char* sParam0, int iParam1, bool bParam2)//Position - 0xDEF
{
	Global_22426 = 0;
...
var func_26(int iParam0, int iParam1)//Position - 0x1167
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_27()//Position - 0x117F
{
	return -1;
}
...
void func_34()//Position - 0x13C9
{
	...
	{
		if (func_37(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_36(PLAYER::PLAYER_PED_ID());
			if (func_35(iVar0) && (!func_39(14) || Global_113083))
			{
				if (Global_114135.f_2367.f_539.f_4321 != iVar0 && func_35(Global_114135.f_2367.f_539.f_4321))
				{
...
bool func_35(int iParam0)//Position - 0x14C6
{
	return iParam0 < 3;
}

int func_36(int iParam0)//Position - 0x14D2
{
	int iVar0;
	int iVar1;
...
int func_37(int iParam0)//Position - 0x150F
{
	if (func_35(iParam0))
	{
...
var func_38(int iParam0)//Position - 0x1534
{
...
int func_44()//Position - 0x168D
{
	...
	while (iLocal_248 <= 8)
	{
		if (func_45(Local_456[iLocal_248 /*3*/].f_2, 0, 0))
		{
			return 1;
		}
		iLocal_248++;
...
bool func_45(char* sParam0, int iParam1, char* sParam2)//Position - 0x16BF
{
...
int func_46(int iParam0, bool bParam1, int iParam2)//Position - 0x16DD
{
	int iVar0;
...
void func_47(int* iParam0)//Position - 0x1712
{
...
void func_48()//Position - 0x1732
{
	...
	switch (iLocal_155)
	{
		...
		case 1:
			...
			else if (iLocal_455 && !func_426(iLocal_186))
			{
				func_47(&iLocal_156);
				HUD::CLEAR_PRINTS();
				iLocal_154 = 10;
		...
		case 2:
			...
			if (func_4())
			{
				if (func_2())
				{
					...
					else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_157.f_4, Local_437[0 /*7*/][0 /*3*/], Local_437[0 /*7*/][1 /*3*/], fLocal_452[0], false, true, 0))
					{
						iLocal_154 = 6;
					}
					else
...
void func_49()//Position - 0x188E
{
	...
	switch (iLocal_155)
	{
		...
		case 2:
			HUD::CLEAR_PRINTS();
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_186, false))
			{
				iLocal_154 = 8;
			}
			else if (!VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_186, Local_157.f_4))
...
{
	HUD::CLEAR_THIS_PRINT(Local_456[iParam0 /*3*/].f_2);
}
...
void func_51()//Position - 0x1948
{
	...
	switch (iLocal_155)
	{
		...
		case 1:
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_157.f_4, Local_437[1 /*7*/][0 /*3*/], Local_437[1 /*7*/][1 /*3*/], fLocal_452[1], false, true, 0))
			{
				if (!func_252(PLAYER::PLAYER_PED_ID(), Local_157.f_4, 150f, 1) && !func_15())
				{
					iLocal_155 = 2;
				}
...
void func_53(int iParam0, bool bParam1)//Position - 0x1A74
{
	...
	{
		func_218(&(Global_113222[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	...
	func_203(0, 0);
	MemCopy(&sVar1, {func_201(iVar0)}, 4);
	func_199(&sVar1, func_200());
	func_80();
...
void func_59(int iParam0, bool bParam1, int iParam2)//Position - 0x21F3
{
	if (iParam2 == -1)
	{
		iParam2 = func_60();
...
int func_81(int iParam0, int iParam1, int iParam2)//Position - 0x2CBF
{
	...
	Global_79322[1 /*14*/] = { func_134(iVar0, iParam1, iParam2, -1) };
	...
	{
		uVar31 = { func_130(iVar0, 0) };
		Global_79322[1 /*14*/] = { func_134(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_126(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_126(iParam1), Global_79322[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_126(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, 0);
		}
	}
	if (func_125(iParam0, iVar0, &iVar48, 0))
	{
...
int func_82(int iParam0, int iParam1, int iParam2)//Position - 0x2E7C
{
	int iVar0;
	...
	{
		if (!func_198(iParam0, Global_114135.f_2367.f_539[iVar0 /*65*/].f_64, Global_114135.f_2367.f_539[iVar0 /*65*/].f_63))
		{
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2F58
{
	...
	if (iParam5 == 0)
	{
		Global_79322[1 /*14*/] = { func_134(iVar10, iParam1, iParam2, -1) };
		if (!func_124(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_79322[1 /*14*/] = { func_134(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_79322[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						{
							uVar28 = { func_127(iVar10, uVar11[iVar0]) };
						}
						iVar1 = 0;
						while (iVar1 <= 8)
						{
							Global_79322[1 /*14*/] = { func_134(iVar10, 14, uVar28[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_126(iVar0), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_126(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_126(iVar0), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
						}
						func_116(iVar0);
						if (Global_79320 == 1)
						{
			...
			{
				Global_79322[1 /*14*/] = { func_134(iVar10, iVar0, func_90(iParam0, iVar0, -1), -1) };
		...
		if (iParam7 == 1)
		{
			Var55 = { func_134(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var55 = { func_134(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var55 = { func_134(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var55 = { func_134(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var55 = { func_134(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	{
		uVar69 = { func_127(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
			Global_79322[1 /*14*/] = { func_134(iVar10, 14, uVar69[iVar1], -1) };
			func_100(iParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
			func_116(14);
			if (Global_79320 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_126(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_126(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_126(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
		}
		if (Global_79320 == 1)
		{
			iVar2 = 0;
...
int func_86(int iParam0, int iParam1, int iParam2)//Position - 0x37F3
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x38F9
{
	var uVar0;
	int iVar10;
...
int func_89(int iParam0, int iParam1, int iParam2)//Position - 0x3EFD
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4037
{
	int iVar0;
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x4EF1
{
	int iVar0;
...
int func_96(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x54D3
{
	int iVar0;
...
int func_97(int iParam0, int iParam1, int iParam2)//Position - 0x54FC
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_98(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x57C6
{
	int iVar0;
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5C41
{
	switch (iParam0)
	{
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5D0F
{
	...
	else
	{
		...
		iVar36 = (iParam1 - func_103(iParam0, func_126(iParam2)));
		if (iVar36 < 0)
		{
			return -1;
		}
		...
		iVar37 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_126(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x646B
{
	...
	else
	{
		...
		if (iVar18 != -1)
		{
			return (func_103(iParam0, func_126(iParam2)) + iVar18);
		}
	}
	return -99;
}
...
int func_110(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x660B
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_102(iParam0, iParam2, 14, 3), joaat("HAT_MENU"), 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_102(iParam0, iParam2, 1, 3), joaat("HAT_MENU"), 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_102(iParam0, iParam2, 14, 4), joaat("HAT_MENU"), 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_102(iParam0, iParam2, 1, 4), joaat("HAT_MENU"), 0));
					}
					break;
			}
			break;
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6888
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_112(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6CAD
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_115(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7047
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_117(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x714A
{
	...
	{
		iVar3 = func_121(iVar2, iVar0);
		MISC::SET_BIT(&iVar3, iVar1);
		func_118(iVar2, iVar3, iVar0, 1);
	}
}
...
int func_119(int iParam0, var uParam1)//Position - 0x71C0
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_120(uParam1));
}

int func_120(var uParam0)//Position - 0x71D5
{
	int iVar0;
	int iVar1;
...
int func_123(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xA051
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_124(int iParam0)//Position - 0xAEF4
{
	if (!BitTest(Global_79322[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_125(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAF3C
{
	int iVar0;
	...
	{
		if (!func_198(iParam0, Global_114135.f_2367.f_539[iVar0 /*65*/].f_61, Global_114135.f_2367.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_128(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB9C6
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_129(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xBAF0
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_133(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[0], Global_114135.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_133(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[1], Global_114135.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_133(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[2], Global_114135.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_132(Var16.f_2)] = Var16.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_132(Var16.f_2)] = func_107(iParam1, Var16.f_0, func_132(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
					(*uParam0)[func_132(Var16.f_2)] = Var16.f_1;
				}
			}
			iVar36++;
		}
...
void func_136(int iParam0)//Position - 0xDDCF
{
	...
	switch (iParam0)
	{
		...
		default:
			func_143(iVar10, iParam0, 155, -1);
			return;
			break;
	}
	func_137(&(Global_79322[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_137(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xF007
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_121(func_140(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_121(func_139(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_121(iVar1, Global_79319);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_141(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xFFA3
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_143(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x100CD
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_137(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_137(&(Global_79322[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_137(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79520)
		{
			...
			func_137(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_126(iParam0));
			if (iVar57 > iVar56)
			{
...
int func_198(int iParam0, int iParam1, int iParam2)//Position - 0x21643
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_198(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar22 = { func_127(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
							if (!func_198(iParam0, 14, uVar22[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
									Global_79322[2 /*14*/] = { func_134(iVar0, 14, iVar4, -1) };
									if (Global_79322[2 /*14*/].f_12 == iVar3)
									{
										if (func_198(iParam0, 14, iVar4))
										{
											if (!func_88(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_79322[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_79322[2 /*14*/] = { func_134(iVar0, iVar2, iVar1, -1) };
						if (!func_88(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_79322[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	{
		uVar33 = { func_127(iVar0, iParam2) };
		iVar32 = 0;
		while (iVar32 <= 8)
		{
			if (!func_198(iParam0, 14, uVar33[iVar32]))
			{
				return 0;
			}
			iVar32++;
	...
	else if (Global_79322[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_126(iParam1)) && Global_79322[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_126(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_199(char* sParam0, var uParam1)//Position - 0x2189C
{
...
void func_205(int iParam0, bool bParam1, bool bParam2)//Position - 0x21E9D
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&sVar32, {func_202(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&sVar32, 0, Global_101725, 0);
		func_206(&sVar32, Var0.f_3, Global_101725, bParam1, bParam2);
	}
}

void func_206(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x21EDC
{
...
void func_207(int iParam0, var uParam1)//Position - 0x21F20
{
	switch (iParam0)
	{
		...
		case 5:
			func_208(uParam1, "Barry3A", func_201(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_209(iParam0), 0, 1);
			break;
		...
		case 8:
			func_208(uParam1, "Dreyfuss1", func_201(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_209(iParam0), 0, 0);
			break;
		...
		case 38:
			func_208(uParam1, "Nigel1A", func_201(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_209(iParam0), 1, 1);
			break;
		...
		case 49:
			func_208(uParam1, "Paparazzo3A", func_201(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_209(iParam0), 0, 1);
			break;
		...
		case 58:
			func_208(uParam1, "Tonya1", func_201(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_209(iParam0), 0, 1);
			break;
...
void func_208(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, struct<3> Param7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)//Position - 0x230D5
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
void func_211()//Position - 0x234BE
{
	...
	{
		func_34();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_212(Global_114135.f_2367.f_539.f_4321));
	}
	else
	{
...
char* func_212(var uParam0)//Position - 0x234F0
{
	uParam0 = uParam0;
	return "";
}
...
void func_213()//Position - 0x234FF
{
	...
	else if ((MISC::IS_PS3_VERSION() || func_214()) || MISC::IS_PC_VERSION())
	{
...
void func_218(var uParam0)//Position - 0x235C4
{
	if (*uParam0 == -1)
	{
		return;
...
void func_223(var uParam0, bool bParam1)//Position - 0x23B57
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_228(int iParam0, int iParam1)//Position - 0x23F7B
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_229(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x23F9B
{
	if (iParam0 != 198)
	{
		if (Global_79539)
...
void func_240(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2842B
{
	int iVar0;
...
int func_242(int iParam0)//Position - 0x28715
{
	int iVar0;
	int iVar1;
...
int func_245(int iParam0)//Position - 0x2894C
{
...
int func_247(char* sParam0)//Position - 0x289B3
{
	int iVar0;
...
int func_249(char* sParam0, int iParam1)//Position - 0x28A24
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_250(int* iParam0)//Position - 0x28A6D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_251(bool bParam0)//Position - 0x28A98
{
	if (bParam0)
	{
		VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(Local_157.f_4, false, 0);
		VEHICLE::SET_VEHICLE_DISABLE_TOWING(Local_157.f_4, true);
	}
	else
	{
		VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(Local_157.f_4, true, 0);
		VEHICLE::SET_VEHICLE_DISABLE_TOWING(Local_157.f_4, false);
	}
}

bool func_252(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x28AD0
{
...
void func_253()//Position - 0x28AF2
{
	...
	{
		if (func_337(&uLocal_249, 49, "BAR3CAU", "BAR3C_P1", 9, 1, 0, 0, 0))
		{
...
void func_254(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28B32
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_249(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
				Global_114135.f_18578[iVar5 /*6*/].f_4 = 0;
				MemCopy(&uVar6, {func_202(iVar5)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar6, 0, Global_101725, iParam0);
			}
			else
			{
				iVar10 = func_331(&(Global_101688.f_3));
				if (iVar10 > -1)
				{
...
void func_255(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x28CA7
{
	func_256(&Global_107680, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_256(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x28CC3
{
	int iVar0;
	int iVar1;
...
int func_260(int iParam0)//Position - 0x29C36
{
	int iVar0;
...
int func_263(int iParam0)//Position - 0x29D82
{
	int iVar0;
...
int func_264(int iParam0, int iParam1, int iParam2)//Position - 0x29DE5
{
	int iVar0;
...
int func_265(int iParam0, int iParam1)//Position - 0x29E73
{
	struct<82> Var0;
...
void func_266(int iParam0, var uParam1, int iParam2)//Position - 0x29EB5
{
	int iVar0;
...
int func_269(int iParam0, var uParam1, var uParam2)//Position - 0x2A46C
{
	int iVar0;
	int iVar1;
...
int func_270(int iParam0)//Position - 0x2A65F
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_271(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A67F
{
	char* sVar0;
...
int func_272(int iParam0, int iParam1, bool bParam2)//Position - 0x2A7AE
{
	int iVar0;
	char* sVar1;
	int iVar9;
	...
	iVar0 = 0;
	while (func_273(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_273(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2A81C
{
...
int func_275(int iParam0, int iParam1)//Position - 0x2AA8E
{
	int iVar0;
	var uVar1;
...
int func_276(int iParam0, var uParam1)//Position - 0x2AAB2
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_120(uParam1));
}

void func_277(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2AAC7
{
	int iVar0;
...
void func_278(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x2B010
{
	int iVar0;
...
int func_279()//Position - 0x2B251
{
	func_34();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_280(int iParam0, bool bParam1)//Position - 0x2B26A
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_35(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_281(iParam0, &(Global_114135.f_2367.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_281(int iParam0, var uParam1)//Position - 0x2B35D
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_283(Var11.f_1)) && iVar72 < 51)
			{
...
int func_282(int iParam0)//Position - 0x2B5E5
{
	switch (iParam0)
	{
...
int func_283(int iParam0)//Position - 0x2B686
{
...
void func_287(int iParam0)//Position - 0x2C8B2
{
	int iVar0;
...
int func_289(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x2CE3D
{
	int iVar0;
	int iVar1;
...
bool func_291(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2D600
{
	if (bParam6)
	{
...
int func_292(var uParam0)//Position - 0x2D647
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_319())
		{
			*uParam0 = func_297(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 6, -1, 0, 1, -1);
...
int func_294(int iParam0, int iParam1, bool bParam2)//Position - 0x2D6B2
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_296(int iParam0)//Position - 0x2DAC9
{
	return func_294(iParam0, 5, 1);
}

int func_297(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x2DAD9
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 61)
	{
		if (iParam3 == 6 || iParam3 == func_318(iVar0))
		{
			if (!bParam5 || func_317(iVar0))
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_298(iVar0, 0), true);
...
int func_301(struct<3> Param0)//Position - 0x2E5FF
{
...
Vector3 func_303(struct<3> Param0)//Position - 0x2E641
{
...
int func_305(int iParam0)//Position - 0x2E66D
{
	if (iParam0 != func_27())
	{
...
int func_307(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2E76F
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_308(struct<3> Param0, float fParam3)//Position - 0x2E804
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_312(int iParam0, var uParam1)//Position - 0x2F4A1
{
	switch (iParam0)
	{
		case 0:
...
int func_313(int iParam0)//Position - 0x2F523
{
	if (iParam0 != func_27())
	{
...
int func_317(int iParam0)//Position - 0x2F82F
{
...
var func_325(int iParam0)//Position - 0x2FD85
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_326(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_326(bool bParam0, int iParam1, int iParam2)//Position - 0x2FDA7
{
	if (bParam0)
	{
		return iParam1;
...
int func_327(var uParam0)//Position - 0x2FDBE
{
	return uParam0 & 15;
}
...
int func_335(int iParam0, bool bParam1)//Position - 0x3000C
{
	int iVar0;
...
void func_338()//Position - 0x30323
{
	...
	switch (iLocal_155)
	{
		...
		case 1:
			...
			else if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_186, false))
			{
				iLocal_155 = 2;
			}
			else if (func_2())
			{
				...
				else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_157.f_4, Local_437[1 /*7*/][0 /*3*/], Local_437[1 /*7*/][1 /*3*/], fLocal_452[1], false, true, 0))
				{
					iLocal_154 = 10;
					iLocal_155 = 0;
				}
...
void func_341(char* sParam0, int iParam1)//Position - 0x305D9
{
...
void func_342()//Position - 0x305F0
{
	...
	switch (iLocal_155)
	{
		case 0:
			func_47(&iLocal_156);
			iLocal_156 = func_343(Local_180, 5, 1);
		...
		case 1:
			...
			else if (!func_2())
			{
				if (func_3())
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_157.f_4, Local_437[1 /*7*/][0 /*3*/], Local_437[1 /*7*/][1 /*3*/], fLocal_452[1], false, false, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_AIR(Local_157.f_4))
						{
							Var0 = { ENTITY::GET_ENTITY_COORDS(Local_157.f_4, true) };
							if (Var0.f_2 < 6.7f)
							{
			...
			else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_157.f_4, Local_437[0 /*7*/][0 /*3*/], Local_437[0 /*7*/][1 /*3*/], fLocal_452[0], true, true, 0))
			{
				iLocal_155 = 2;
			}
			else if (iLocal_484)
		...
		case 2:
			...
			{
				if (func_3() && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_157.f_4, Local_437[0 /*7*/][0 /*3*/], Local_437[0 /*7*/][1 /*3*/], fLocal_452[0], false, false, 0))
				{
					if (!ENTITY::IS_ENTITY_IN_AIR(Local_157.f_4))
					{
						Var0 = { ENTITY::GET_ENTITY_COORDS(Local_157.f_4, true) };
...
int func_343(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x3082C
{
	int iVar0;
...
void func_344()//Position - 0x3085A
{
	...
	switch (iLocal_155)
	{
		...
		case 1:
			if (((!iLocal_417 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -458.11f, -1725.3f, 17.67f, -456.71f, -1701.81f, 22f, 17.5f, false, true, 0)) && !func_2()) && !func_3())
			{
				func_341("B3CTTHB", -1);
				iLocal_417 = 1;
			}
...
{
	if (Local_456[iParam0 /*3*/] == -1)
	{
	}
	else
	{
		Local_456[iParam0 /*3*/].f_1 = Local_456[iParam0 /*3*/];
	}
}
...
void func_347()//Position - 0x30A85
{
	switch (iLocal_155)
	{
		case 0:
			...
			{
				func_17();
				if (!iLocal_414 && (MISC::GET_GAME_TIMER() - iLocal_420) > 8000)
				{
					if (func_21(&uLocal_249, "BAR3CAU", "BAR3C_MUTT", 7, 0, 0, 0))
					{
						iLocal_414 = 1;
					}
				}
				else if (!iLocal_415 && (MISC::GET_GAME_TIMER() - iLocal_420) > 120000)
				{
					if (!func_349())
					{
						if (func_348(&uLocal_249, 49, "BAR3CAU", "BAR3C_HC", 7, 0, 0, 1))
						{
							iLocal_415 = 1;
						}
					}
				}
				else if (!iLocal_416 && (MISC::GET_GAME_TIMER() - iLocal_420) > 160000)
				{
					if (func_21(&uLocal_249, "BAR3CAU", "BAR3C_TOW", 7, 0, 0, 0))
					{
						iLocal_416 = 1;
					}
				}
...
int func_349()//Position - 0x30CD2
{
	...
	while (iLocal_248 <= 7)
	{
		if (!Local_189[iLocal_248 /*7*/].f_6 && func_9(PLAYER::PLAYER_PED_ID(), Local_189[iLocal_248 /*7*/], 8f, 1))
		{
			return 1;
		}
		iLocal_248++;
...
void func_351(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x30D70
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104696.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104696.f_4, false))
		{
			if (func_378(24) != Global_104696.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_375(ENTITY::GET_ENTITY_COORDS(Global_104696.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_352(Global_104696.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_352(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x30DEB
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_371(iParam5, &Var0, Param1, fParam4, func_263(iParam0));
...
void func_354(int iParam0, int iParam1)//Position - 0x3102B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_355(int iParam0)//Position - 0x3122D
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_272(iParam0, 0, 0)) || func_272(iParam0, 1, 0)) || func_272(iParam0, 2, 0)) || func_263(iParam0) != 145) || func_369(iParam0)) || func_368(iParam0)) || func_367(iParam0)) || func_366(iParam0)) || !func_356(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_368(iParam0))
		{
		}
...
int func_356(int iParam0)//Position - 0x3130A
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_357(int iParam0, bool bParam1, int iParam2)//Position - 0x314C8
{
	int iVar0;
	struct<2> Var1;
...
int func_358(int iParam0)//Position - 0x3164D
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_360(int iParam0, int iParam1)//Position - 0x31730
{
	int iVar0;
	int iVar1;
...
int func_361()//Position - 0x31939
{
	return 0;
}

int func_362()//Position - 0x31942
{
	return 1;
}

int func_363()//Position - 0x3194B
{
	return 1;
}

int func_364()//Position - 0x31954
{
...
int func_366(int iParam0)//Position - 0x31A25
{
	int iVar0;
	char* sVar1;
...
int func_367(int iParam0)//Position - 0x31A6C
{
	int iVar0;
...
int func_368(int iParam0)//Position - 0x31AA7
{
	int iVar0;
...
int func_369(int iParam0)//Position - 0x31B23
{
	int iVar0;
...
int func_370(var uParam0, int iParam1)//Position - 0x31C0B
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_291(Global_114135.f_32754.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_291(Global_114135.f_2367.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_291(Global_114135.f_2367.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_371(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x332F9
{
	if (func_370(&(Global_78329.f_555[0 /*21*/]), iParam0))
	{
...
int func_375(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x3355C
{
	int iVar0;
	
	iVar0 = func_376(Param0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_376(struct<3> Param0, int iParam3, int iParam4)//Position - 0x33672
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_377(int iParam0)//Position - 0x33701
{
...
void func_379()//Position - 0x33732
{
	switch (iLocal_155)
	{
		case 0:
			iLocal_426 = 0;
			bLocal_425 = false;
			if (func_337(&uLocal_249, 49, "BAR3CAU", "BAR3C_NG", 9, 1, 0, 0, 0))
			{
				iLocal_155 = 1;
			}
			break;
	...
	switch (iLocal_155)
	{
		case 0:
			...
			if (func_4())
			{
				...
				func_346(3);
				func_346(4);
				VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_157.f_4, false);
				VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_157.f_4, false);
				if (func_2())
				{
					iLocal_155 = 0;
					iLocal_154 = 5;
		...
		case 1:
			if (((!bLocal_425 && iLocal_422 != 0) && (iLocal_423 > 0 && iLocal_423 < 4)) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0 /*PLAYER_CONTROL*/, 75 /*INPUT_VEH_EXIT*/))
			{
				bLocal_425 = true;
			}
			switch (iLocal_422)
			{
				case 0:
					if (AUDIO::REQUEST_SCRIPT_AUDIO_BANK("BARRY3C_IGNITION_FAIL", false, -1) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_427))
					{
						if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_157.f_4, -1, false) == PLAYER::PLAYER_PED_ID())
						{
							if (!iLocal_167)
							{
								VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_157.f_4);
								iLocal_167 = 1;
							}
							iLocal_423 = 0;
				...
				case 2:
					if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_157.f_4, -1, false) == PLAYER::PLAYER_PED_ID() && PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_157.f_4))
					{
						if (iLocal_423 == 3)
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_428);
							TASK::TASK_PLAY_ANIM(0, sLocal_427, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0f, false, false, false);
							TASK::TASK_PLAY_ANIM(0, sLocal_427, "franklinfailingtostartcar_loop", 8f, -8f, 8000, 9, 0f, false, false, false);
							TASK::TASK_PLAY_ANIM(0, sLocal_427, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0f, false, false, false);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_428);
							TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iLocal_428);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_428);
						...
						{
							if (func_21(&uLocal_249, "BAR3CAU", "BAR3C_C1", 7, 0, 0, 0))
							{
								TASK::OPEN_SEQUENCE_TASK(&iLocal_428);
								TASK::TASK_PLAY_ANIM(0, sLocal_427, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0f, false, false, false);
								TASK::TASK_PLAY_ANIM(0, sLocal_427, "franklinfailingtostartcar_loop", 8f, -8f, (1200 + iLocal_423 * 250), 9, 0f, false, false, false);
								TASK::TASK_PLAY_ANIM(0, sLocal_427, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0f, false, false, false);
								TASK::CLOSE_SEQUENCE_TASK(iLocal_428);
								TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iLocal_428);
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_428);
				...
				case 3:
					if (MISC::GET_GAME_TIMER() > iLocal_419)
					{
						...
						else
						{
							...
							iLocal_419 = (MISC::GET_GAME_TIMER() + iLocal_423 * 250) + 1200 + 766;
						}
						iLocal_422 = 4;
					}
					break;
				...
				case 4:
					if (MISC::GET_GAME_TIMER() > iLocal_419)
					{
						...
						else
						{
							...
							if (iLocal_423 == 4)
							{
								TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_427, "franklinfailingtostartcar_slamwheel", 1000f, -8f, 3300, 0, 0f, false, false, false);
				...
				case 5:
					if (MISC::GET_GAME_TIMER() > iLocal_419)
					{
						VEHICLE::START_VEHICLE_HORN(Local_157.f_4, 500, MISC::GET_HASH_KEY("NORMAL"), false);
						iLocal_419 = MISC::GET_GAME_TIMER() + 2000;
						iLocal_422 = 8;
					}
					break;
				...
				case 6:
					if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_157.f_4))
					{
						if (!func_15())
						{
							if (func_21(&uLocal_249, "BAR3CAU", "BAR3C_C2", 7, 0, 0, 0))
							{
		...
		case 2:
			if (!func_15() && (MISC::GET_GAME_TIMER() - iLocal_419) > 2500)
			{
				iLocal_155 = 0;
				iLocal_154 = 2;
			}
...
int func_389()//Position - 0x340C6
{
	if (!func_426(PLAYER::PLAYER_PED_ID()))
	{
		return 1;
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_157.f_4))
	{
		if (ENTITY::IS_ENTITY_DEAD(Local_157.f_4, false))
		{
		...
		{
			if (VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(Local_157.f_4))
			{
				if (iLocal_164)
				{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_186))
	{
		if (ENTITY::IS_ENTITY_DEAD(iLocal_186, false) && iLocal_455 == 0)
		{
			if (func_3())
			{
		...
		else if (iLocal_166 && iLocal_455 == 0)
		{
			if (VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(iLocal_186))
			{
				if (iLocal_165)
				{
...
void func_390()//Position - 0x341F3
{
	switch (iLocal_155)
	{
		case 0:
			...
			{
				sLocal_485 = "DEFAULT" /* GXT: _ */;
			}
			if (MISC::ARE_STRINGS_EQUAL(sLocal_485, "DEFAULT" /* GXT: _ */))
			{
				func_483(1);
			}
			else
			{
				func_407(sLocal_485, 1);
			}
			iLocal_155 = 1;
			break;
		...
		case 1:
			if (func_406())
			{
				if ((func_426(Local_157.f_4) && func_426(iLocal_186)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_157.f_4, iLocal_186))
				{
					VEHICLE::DETACH_VEHICLE_FROM_ANY_TOW_TRUCK(Local_157.f_4);
				}
				func_391();
				func_481();
			}
...
{
	if (func_426(Local_157.f_4))
	{
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_157.f_4, false, 1);
	}
	func_10(&iLocal_186);
	func_10(&(Local_157.f_4));
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("towtruck"), false);
	func_402(0);
	func_392(&Local_79, 1, 0, 0);
}
...
void func_395(int* iParam0, bool bParam1)//Position - 0x3433C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_400(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x34419
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_401(int* iParam0)//Position - 0x34469
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_404(int iParam0, int iParam1, bool bParam2)//Position - 0x34519
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_57() == 0)
		{
			iVar0 = func_121(func_295(iParam0), -1);
			MISC::CLEAR_BIT(&iVar0, iParam1);
			func_118(func_295(iParam0), iVar0, -1, 1);
		}
	}
	else
	{
...
void func_409(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x34679
{
	float fVar0;
	int iVar1;
	int iVar2;
...
float func_410(char* sParam0)//Position - 0x3495E
{
...
int func_420(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x34D3F
{
	if (((!func_423(0) || Global_79810) || Global_79798 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_79794)
...
int func_422(int iParam0)//Position - 0x34E80
{
	if (iParam0 == 1)
	{
		if (Global_21066.f_1 > 3)
...
int func_423(int iParam0)//Position - 0x34ED7
{
	if (Global_44181 == 15)
	{
		return 0;
...
bool func_424(int iParam0)//Position - 0x34EF9
{
	return func_425(iParam0, Global_44181);
}

int func_425(int iParam0, int iParam1)//Position - 0x34F0A
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_426(int iParam0)//Position - 0x350EB
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_427(bool bParam0)//Position - 0x3510C
{
...
void func_428(bool bParam0)//Position - 0x35134
{
	...
	if (bParam0)
	{
		if (iLocal_187 == joaat("towtruck") || iLocal_187 == joaat("towtruck2"))
		{
			func_431(-1237.9617f, -1035.1941f, 7.2466f, 110f, 0);
		}
		else
		{
			func_431(-1074.1339f, -1250.2921f, 4.5293f, 199.5f, 0);
		}
	...
	{
		func_431(-1237.9617f, -1035.1941f, 7.2466f, 110f, 1);
	}
	else
	{
		func_431(-1074.1339f, -1250.2921f, 4.5293f, 199.5f, 1);
	}
	func_381(500, 1);
}
...
var func_430()//Position - 0x353C9
{
	return BitTest(Global_101688.f_20, 13);
}

void func_431(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x353DA
{
	if (func_426(PLAYER::PLAYER_PED_ID()))
	{
		if (bParam4)
	...
	STREAMING::REQUEST_MODEL(iLocal_187);
	while (!STREAMING::HAS_MODEL_LOADED(iLocal_187))
	{
		SYSTEM::WAIT(0);
	}
	iLocal_186 = VEHICLE::CREATE_VEHICLE(iLocal_187, Param0, fParam3, true, true, false);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_187);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iLocal_186, iLocal_188);
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_186, 5f);
	if (bParam4)
	{
		func_432(PLAYER::PLAYER_PED_ID(), iLocal_186, -1, 0);
	}
	VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(iLocal_186, false);
	VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(iLocal_186, false);
	VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(iLocal_186, true);
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_186, false))
	{
		VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(iLocal_186);
		iLocal_166 = 1;
	}
...
void func_432(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x3549C
{
	if (func_433(iParam0))
	{
		if (func_426(iParam1))
...
int func_433(int iParam0)//Position - 0x354FE
{
	if (func_426(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_434(struct<3> Param0, float fParam3)//Position - 0x3551E
{
	STREAMING::REQUEST_MODEL(Local_157.f_5);
	if (ENTITY::DOES_ENTITY_EXIST(Local_157.f_4))
	{
		if (iLocal_167)
		{
			VEHICLE::REMOVE_VEHICLE_UPSIDEDOWN_CHECK(Local_157.f_4);
			iLocal_167 = 0;
		}
	}
	while (!STREAMING::HAS_MODEL_LOADED(Local_157.f_5))
	{
		SYSTEM::WAIT(0);
	}
	func_250(&iLocal_170);
	func_6(&(Local_157.f_4));
	Local_157.f_4 = VEHICLE::CREATE_VEHICLE(Local_157.f_5, Param0, fParam3, true, true, false);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_157.f_5);
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_157.f_4, 5f);
	VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_157.f_4, false);
	VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_157.f_4, false);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_157.f_4, 1);
	VEHICLE::SET_VEHICLE_UNDRIVEABLE(Local_157.f_4, true);
	VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_157.f_4, true);
	ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_157.f_4, true, 1);
	if (!ENTITY::IS_ENTITY_DEAD(Local_157.f_4, false))
	{
		VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_157.f_4);
	...
	iLocal_170 = OBJECT::CREATE_OBJECT(iLocal_177, Param0 + Local_171, true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_170, Local_157.f_4, 0, Local_171, Local_174, false, false, false, false, 2, true, 0);
}
...
void func_443(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x357B2
{
	if (func_463())
	{
...
int func_446(var uParam0)//Position - 0x3586D
{
...
int func_447(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x358CD
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_448(bool bParam0)//Position - 0x35948
{
	...
	if (bParam0)
	{
		if (iLocal_187 == joaat("towtruck") || iLocal_187 == joaat("towtruck2"))
		{
			func_431(-1154.2244f, -1234.3102f, 5.7174f, 12.45f, 0);
		}
		else
		{
			func_431(-1148.1831f, -1227.005f, 8.4468f, 19.2f, 0);
		}
		while (!HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			SYSTEM::WAIT(0);
	...
	{
		func_431(-1154.2244f, -1234.3102f, 5.7174f, 12.45f, 1);
	}
	else
	{
		func_431(-1148.1831f, -1227.005f, 8.4468f, 19.2f, 1);
	}
	func_254(2, "Delivered vehicle", 1, 0, 0, 1);
}
...
void func_449(bool bParam0)//Position - 0x35B8F
{
	if (bParam0)
	{
		...
		func_443(Local_157, Local_157.f_3, 1, 0);
	}
	if (iLocal_187 == joaat("towtruck"))
	{
		Local_486 = { -462.0807f, -1711.6804f, 17.6454f };
		fLocal_489 = 277.92f;
	}
	else if (iLocal_187 == joaat("towtruck2"))
	{
		Local_486 = { -463.5672f, -1712.2842f, 17.6392f };
		fLocal_489 = 272.29f;
	}
	else if ((iLocal_187 == joaat("cargobob") || iLocal_187 == joaat("cargobob2")) || iLocal_187 == joaat("cargobob3"))
	{
		Local_486 = { -455.4628f, -1712.2817f, 17.642f };
		fLocal_489 = 0.7f;
	}
	if (bParam0)
	{
		func_443(Local_486, fLocal_489, 1, 0);
	}
	else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_157.f_4, false))
	{
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_157, true, false, false, true);
	}
	func_436();
	func_435();
	func_47(&iLocal_156);
	...
	func_11(7, 0);
	func_11(7, 0);
	func_434(Local_157, Local_157.f_3);
	if (bParam0)
	{
		func_431(Local_486, fLocal_489, 0);
		if (func_426(iLocal_186) && iLocal_187 == joaat("towtruck"))
		{
			VEHICLE::SET_VEHICLE_TOW_TRUCK_ARM_POSITION(iLocal_186, 0f);
		}
		while (!HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			SYSTEM::WAIT(0);
	...
	{
		func_431(Local_486, fLocal_489, 1);
		if (func_426(iLocal_186) && iLocal_187 == joaat("towtruck"))
		{
			VEHICLE::SET_VEHICLE_TOW_TRUCK_ARM_POSITION(iLocal_186, 0f);
		}
...
void func_451(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x35E3E
{
	int iVar0;
...
void func_452(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x35EE8
{
	if (bParam0)
	{
...
int func_456(var uParam0)//Position - 0x360EB
{
	int iVar0;
...
int func_457(int iParam0)//Position - 0x3610D
{
...
int func_459(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x3615A
{
	int iVar0;
...
void func_461(bool bParam0)//Position - 0x361B0
{
	...
	else
	{
		...
		func_434(Local_157, Local_157.f_3);
		PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_157.f_4, -1);
	}
}
...
void func_464()//Position - 0x3633B
{
	...
	Local_180 = { -1152.43f, -1238.8237f, 5.9752f };
	iLocal_140 = func_477();
	iLocal_183[0] = PED::ADD_SCENARIO_BLOCKING_AREA(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, false, true, true, true, 1);
	iLocal_183[1] = PED::ADD_SCENARIO_BLOCKING_AREA(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, false, true, true, true, 1);
	Local_157.f_5 = joaat("emperor2");
	Local_157 = { -468.9f, -1713.06f, 18.21f };
	Local_157.f_3 = -76.2f;
	Local_189[0 /*7*/] = { func_476(-552.67f, -1698.84f, 18.16f, 205.7f) };
	Local_189[1 /*7*/] = { func_476(-317.14f, -1540.72f, 26.67f, 336.5f) };
	Local_189[2 /*7*/] = { func_476(-104.41f, -1984.91f, 17.02f, 171.6f) };
	Local_189[3 /*7*/] = { func_476(-586.69f, -1774.59f, 21.67f, 145.8f) };
	Local_189[4 /*7*/] = { func_476(-1207.9f, -1334.87f, 3.77f, 204.1f) };
	Local_189[5 /*7*/] = { func_476(-1253.67f, -1210.3f, 6.03f, 10.7f) };
	Local_189[6 /*7*/] = { func_476(-426.56f, -1717.89f, 18.2f, 43.5f) };
	Local_189[7 /*7*/] = { func_476(401.64f, -1633.3f, 28.29f, 231.5f) };
	if (func_426(Local_157.f_4))
	{
		VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_157.f_4, false);
		VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_157.f_4, false);
	...
	if (func_426(PLAYER::PLAYER_PED_ID()))
	{
		func_475(&uLocal_249, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	func_475(&uLocal_249, 3, 0, "BARRY", 0, 1);
	iLocal_417 = 0;
	func_473();
	sLocal_485 = "DEFAULT" /* GXT: _ */;
	iLocal_435 = 0;
	func_472();
	iLocal_429 = 2;
	Local_437[0 /*7*/][0 /*3*/] = { -1161.11f, -1217.32f, 5.65f };
	Local_437[0 /*7*/][1 /*3*/] = { -1147.86f, -1251.6f, 10.01f };
	fLocal_452[0] = 10.5f;
	Local_437[1 /*7*/][0 /*3*/] = { -1147.14f, -1253.07f, 5.65f };
	Local_437[1 /*7*/][1 /*3*/] = { -1161.97f, -1216.69f, 10.98f };
	fLocal_452[1] = 12f;
	func_465(49, 1, 0);
	iLocal_455 = 0;
...
void func_465(int iParam0, int iParam1, bool bParam2)//Position - 0x3662A
{
	int iVar0;
...
struct<4> func_467(int iParam0)//Position - 0x36823
{
	return Global_2201[iParam0 /*29*/].f_3;
}

int func_468(int iParam0, int iParam1)//Position - 0x36836
{
...
int func_469(int iParam0, int iParam1)//Position - 0x36860
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_470(int iParam0, int iParam1, int iParam2)//Position - 0x3688A
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_471(int iParam0, int iParam1, int iParam2)//Position - 0x368CF
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
{
	sLocal_430[0] = "BAR3C_Z1";
	sLocal_430[1] = "BAR3C_Z2";
	sLocal_430[2] = "BAR3C_Z3";
	sLocal_430[3] = "BAR3C_Z4";
}

void func_473()//Position - 0x36944
{
	Local_456[0 /*3*/] = { func_474("B3CENTV", 1) };
	Local_456[1 /*3*/] = { func_474("B3CDELV", 1) };
	Local_456[2 /*3*/] = { func_474("B3CWAN1", -1) };
	Local_456[3 /*3*/] = { func_474("B3CNOGO", 1) };
	Local_456[4 /*3*/] = { func_474("B3CREVRS", 1) };
	Local_456[5 /*3*/] = { func_474("B3CLEAVE", 1) };
	Local_456[6 /*3*/] = { func_474("B3CRTTT", 1) };
	Local_456[7 /*3*/] = { func_474("B3CGBTB", 1) };
	Local_456[8 /*3*/] = { func_474("B3CRTCB", 1) };
}
...
void func_475(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x36A01
{
...
struct<7> func_476(struct<3> Param0, float fParam3)//Position - 0x36A9C
{
	struct<7> Var0;
...
void func_479(var uParam0, int iParam1)//Position - 0x36B05
{
	Global_101688.f_22[iParam1] = uParam0;
}

void func_480(int iParam0, var uParam1)//Position - 0x36B19
{
	*iParam0 = *uParam1;
	*uParam1 = 0;
}
...
void func_481()//Position - 0x36B2B
{
	...
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_183[0], false);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_183[1], false);
...
int func_485(char* sParam0, int iParam1, int iParam2)//Position - 0x36D13
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_486()//Position - 0x36EA2
{
	...
	iVar0 = func_334(&(Global_101688.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
void func_489(bool bParam0)//Position - 0x36F82
{
...
int func_503(int iParam0)//Position - 0x3727B
{
	if (!func_35(iParam0))
	{
		return func_38(iParam0);
