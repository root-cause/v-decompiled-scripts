...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_50 = func_573(64);
	uLocal_51 = func_573(63);
	...
	{
		func_569("Force cleanup [TERMINATING]");
		func_553(1);
		func_542(1);
	}
	if (func_541())
	{
		...
		func_534(&Local_66, 0, 1);
		Global_78564 = 0;
		func_533("Set up script for replay");
	}
	...
	{
		if (func_514(Local_303[iVar0 /*13*/]))
		{
	...
	if (func_541() || func_513(0))
	{
		if (func_513(0) && !func_541())
		{
			iVar1 = 0;
			func_512(PLAYER::PLAYER_PED_ID(), -1291.596f, -12.9214f, 48.5137f, 294.7073f, 0, 1);
		}
		else
		{
			iVar1 = func_511();
		}
		func_510("Replay stage grabbed: ", iVar1);
		if (Global_94618 == 1)
		{
			iVar1++;
		}
		...
		{
			case 0:
				func_510("Replay skipping to stage ", 1);
				func_509(-1291.596f, -12.9214f, 48.5137f, 294.7073f, 1, 0);
				func_501(1, 0);
				break;
			
			case 1:
				func_510("Replay skipping to stage ", 3);
				func_509(-1190.22f, 36.83f, 52.03f, 299f, 1, 0);
				func_501(3, 0);
				break;
			
			case 2:
				func_510("Replay skipping to stage ", 7);
				func_509(-1324.854f, 60.2491f, 52.54f, 94.6913f, 1, 0);
				func_501(7, 0);
				break;
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		func_485(Local_66.f_9, 0, 0, 0, 0, 0);
		if (func_514(Local_293.f_0))
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_270) > 2000)
			{
				if (!iLocal_269)
				{
					func_484(Local_293.f_0, 0);
					func_533("Added Mark to headshot watch");
					iLocal_269 = 1;
				}
			}
		}
...
void func_2()//Position - 0x4C4
{
	...
	{
		case 0:
			func_533("In INTRO_PHONECALL stage skip");
			if (iLocal_69 == 1)
			{
				if (func_14())
				{
		...
		case 1:
			func_533("In GO_TO_THE_GOLF_CLUB stage skip");
		...
		case 2:
			func_533("Skipping MS_GO_TO_CELBRITY...");
			iLocal_248 = 0;
			if (func_14())
			{
				func_15();
		...
		case 3:
			func_533("In GO_TO_CELBRITY stage skip");
			if (func_14())
			{
				func_15();
			}
		...
		case 4:
			func_533("Skipping MS_CHASE_THE_GOLFER...");
			if (func_5(Local_317.f_0))
			{
				...
				ENTITY::SET_ENTITY_COORDS(Local_317.f_0, -1246.956f, -89.9753f, 42.904f, true, false, false, true);
			...
			if (!func_32())
			{
				if (func_5(Local_316[4 /*6*/]))
				{
					...
					ENTITY::SET_ENTITY_COORDS(Local_316[4 /*6*/], -1273.736f, -75.3014f, 44.6289f, true, false, false, true);
					ENTITY::SET_ENTITY_HEADING(Local_316[4 /*6*/], 242f);
				}
				else
				{
					func_533("Skip buggy isn't okay, probably going to fail");
				}
			}
			iLocal_260 = 0;
			iLocal_69 = 2;
		...
		case 5:
			func_533("Skipping MS_CHASE_IN_CITY...");
			if (func_5(Local_317.f_0))
			{
				ENTITY::SET_ENTITY_HEALTH(Local_317.f_0, 450, 0);
				func_533("SKIPPED CITY CHASE SETTING HEALTH TO 450 ");
			}
			if (func_514(iLocal_323))
			{
		...
		case 6:
			func_533("Skipping MS_COLLECT_GOLF_CLUB...");
			if (!func_32())
			{
				if (func_514(PLAYER::PLAYER_PED_ID()))
				{
...
void func_20(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xE62
{
	if (bParam0)
	{
...
bool func_21()//Position - 0xFA5
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_22(int iParam0, int iParam1)//Position - 0xFBF
{
	bool bVar0;
...
int func_23(int iParam0, bool bParam1)//Position - 0x100A
{
	int iVar0;
	int iVar1;
...
int func_24()//Position - 0x104B
{
	return Global_1574918;
}

int func_25(int iParam0)//Position - 0x1057
{
...
bool func_26()//Position - 0x1096
{
	return BitTest(Global_2621446, 3);
}

int func_27(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x10A4
{
	int iVar0;
...
void func_29(int iParam0)//Position - 0x10FE
{
	if (iParam0 == 1)
	{
...
void func_30(int iParam0, int iParam1, int iParam2)//Position - 0x1121
{
	if (func_541() && func_32())
	{
...
void func_31(int iParam0)//Position - 0x11E5
{
	if (iParam0 == 1)
	{
...
bool func_32()//Position - 0x120E
{
	return BitTest(Global_100441.f_20, 13);
}

void func_33(char* sParam0, int iParam1, int iParam2)//Position - 0x121F
{
	iParam2 = iParam2;
...
void func_36()//Position - 0x125A
{
	...
	{
		case 0:
			func_533("ENTERING END PHONECALL");
			...
			if (func_514(PLAYER::PLAYER_PED_ID()))
			{
				...
				func_296(&uLocal_72, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
				func_296(&uLocal_72, 3, 0, "NIGEL", 0, 1);
				func_296(&uLocal_72, 4, 0, "MRSTHORNHILL", 0, 1);
				iLocal_69 = 1;
				func_533("ENTERING END PHONECALL LOOP");
			}
			break;
		...
		case 2:
			func_533("CLEANUP END PHONECALL");
			HUD::CLEAR_PRINTS();
			func_37();
			break;
	}
...
void func_38(int iParam0, bool bParam1)//Position - 0x13BA
{
	...
	{
		func_204(&(Global_112473[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	...
	func_189(0, 0);
	MemCopy(&sVar1, {func_187(iVar0)}, 4);
...
void func_40(int iParam0, int iParam1, int iParam2)//Position - 0x1539
{
	bool bVar0;
...
void func_41()//Position - 0x161F
{
	...
	{
		func_43(13, SYSTEM::FLOOR(Global_113386.f_10194.f_3853));
	}
...
int func_42()//Position - 0x1ADD
{
	return Global_31959;
}

int func_43(int iParam0, int iParam1)//Position - 0x1AE8
{
	int iVar0;
...
void func_44(int iParam0, bool bParam1, int iParam2)//Position - 0x1B39
{
	if (iParam2 == -1)
	{
		iParam2 = func_24();
...
void func_47()//Position - 0x1BCE
{
	StringCopy(&Global_78551, "", 16);
	StringCopy(&Global_78555, "", 16);
}

void func_48()//Position - 0x1BEA
{
	int iVar0;
...
void func_52(int iParam0)//Position - 0x1CBC
{
	if (iParam0 == 1)
	{
		Global_43601 = 1;
...
void func_53()//Position - 0x1CD5
{
	func_54(&Global_106934);
}

void func_54(var uParam0)//Position - 0x1CE5
{
	int iVar0;
	int iVar1;
...
void func_55(var uParam0)//Position - 0x2275
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_56(var uParam0)//Position - 0x2290
{
...
void func_57(var uParam0)//Position - 0x22BF
{
	int iVar0;
...
void func_58(var uParam0)//Position - 0x2370
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_59(var uParam0)//Position - 0x238E
{
	int iVar0;
...
void func_60(var uParam0)//Position - 0x246F
{
	*uParam0 = -15;
}

void func_61()//Position - 0x247D
{
	StringCopy(&Global_103942, "", 32);
	func_54(&Global_103950);
}

void func_62()//Position - 0x2497
{
...
int func_64(int iParam0, int iParam1, int iParam2)//Position - 0x25D5
{
	...
	Global_78130[1 /*14*/] = { func_116(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_78130[1 /*14*/] = { func_116(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_108(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_108(iParam1), Global_78130[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_108(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, 0);
		}
	}
...
int func_67(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2858
{
	...
	if (iParam5 == 0)
	{
		Global_78130[1 /*14*/] = { func_116(iVar10, iParam1, iParam2, -1) };
		if (!func_106(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78130[1 /*14*/] = { func_116(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_116(iVar10, 14, uVar12[iVar1], -1) };
							func_83(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
							func_99(14);
							if (Global_78128 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_108(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_108(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_108(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
						}
						func_99(iVar0);
						if (Global_78128 == 1)
						{
			...
			{
				Global_78130[1 /*14*/] = { func_116(iVar10, iVar0, func_73(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_116(iVar10, 14, uVar15[iVar1], -1) };
			func_83(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_99(14);
			if (Global_78128 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_108(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_108(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_108(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
		}
		if (Global_78128 == 1)
		{
			iVar2 = 0;
...
void func_68(int iParam0, int iParam1, int iParam2)//Position - 0x3068
{
	int iVar0;
	int iVar1;
...
int func_69(int iParam0, int iParam1, int iParam2)//Position - 0x30F2
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_70(int iParam0, int iParam1, int iParam2)//Position - 0x31D0
{
	Global_78130[1 /*14*/] = { func_116(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78130[1 /*14*/].f_6, 2);
}

int func_71(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x31F8
{
	var uVar0;
	int iVar1;
...
int func_72(int iParam0, int iParam1, int iParam2)//Position - 0x37FC
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3936
{
	int iVar0;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x3C3D
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam4 == 0)
	{
		...
		{
			case 2:
				iVar1 = func_97(iParam0, 1);
				iVar0 = func_82(iParam1, iParam3, iVar1);
				break;
			
			case 1:
				iVar2 = func_97(iParam0, 2);
				...
				switch (iParam4)
				{
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							{
								iVar5 = iParam3;
								iVar4 = func_97(iParam0, 3);
							}
							else if (iParam2 == 3)
							{
								iVar4 = iParam3;
								iVar5 = func_97(iParam0, 11);
								iVar5 = func_77(iParam1, iVar4, iVar5, 0);
							}
							iVar3 = func_97(iParam0, 8);
					...
					case 11:
						if (iParam2 == 3)
						{
							...
							{
								iVar7 = func_97(iParam0, 8);
								iVar8 = func_97(iParam0, 11);
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x47F1
{
	int iVar0;
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4AD5
{
	int iVar0;
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4D9C
{
	int iVar0;
	int iVar1;
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4DD3
{
	int iVar0;
...
int func_80(int iParam0, int iParam1, int iParam2)//Position - 0x4DFC
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x50C6
{
	int iVar0;
...
int func_82(int iParam0, int iParam1, int iParam2)//Position - 0x5350
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x54A7
{
	int iVar0;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x553F
{
	switch (iParam0)
	{
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x560D
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_108(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_86(int iParam0, int iParam1)//Position - 0x5727
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_87(int iParam0)//Position - 0x5ACE
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5B2F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_89(int iParam0, int iParam1)//Position - 0x5C2B
{
	int iVar0;
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5D69
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_91(int iParam0)//Position - 0x5E24
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_92(int iParam0)//Position - 0x5E83
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5F09
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_94(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6186
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x65AB
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_96(int iParam0, int iParam1)//Position - 0x689E
{
	int iVar0;
	int iVar1;
...
int func_97(int iParam0, int iParam1)//Position - 0x68E4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_98(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6944
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_99(int iParam0)//Position - 0x699B
{
	if (BitTest(Global_78130[1 /*14*/].f_6, 1) && !BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
		func_105(iParam0, Global_78130[1 /*14*/].f_5, Global_78130[1 /*14*/].f_2, 2, Global_78130[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_78130[1 /*14*/].f_6, 1) && BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_100(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x6A47
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		iVar3 = func_103(iVar2, iVar0, 0);
		MISC::SET_BIT(&iVar3, iVar1);
		func_101(iVar2, iVar3, iVar0, 1, 0);
	}
}

void func_101(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x6A91
{
	int iVar0;
	...
	iVar0 = Global_2826809[iParam0 /*3*/][func_102(iParam2)];
	if (iVar0 != 0)
	{
...
int func_102(var uParam0)//Position - 0x6AC1
{
	int iVar0;
	int iVar1;
...
int func_103(int iParam0, int iParam1, int iParam2)//Position - 0x6AF5
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 13122)
	{
		...
		iVar0 = Global_2826809[iParam0 /*3*/][func_102(iParam1)];
...
bool func_104(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x6B32
{
	int iVar0;
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x9084
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_106(int iParam0)//Position - 0x9F27
{
	if (!BitTest(Global_78130[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_108(int iParam0)//Position - 0xA005
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_109(int iParam0, int iParam1)//Position - 0xA0B5
{
	int iVar0;
	struct<10> Var1;
...
void func_110(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA9E4
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var2;
...
void func_111(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xAB0E
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_112(int iParam0, int iParam1)//Position - 0xAB56
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_115(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[0], Global_113386.f_2363.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_115(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[1], Global_113386.f_2363.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_115(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[2], Global_113386.f_2363.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_113(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC9A1
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var2;
...
int func_114(int iParam0)//Position - 0xCB8B
{
	switch (iParam0)
	{
		case 0:
...
void func_115(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xCC3B
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_116(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCCAC
{
	func_180();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_117(int iParam0, int iParam1)//Position - 0xCCFE
{
	switch (iParam0)
	{
		case 0:
...
void func_118(int iParam0)//Position - 0xCDEE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_119(&(Global_78130[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_119(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xE065
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_103(func_122(iParam1, uParam0->f_2), Global_78127, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_103(func_121(iParam1, uParam0->f_2), Global_78127, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_103(iVar1, Global_78127, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_120(int iParam0, int iParam1, var uParam2)//Position - 0xE40A
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_121(int iParam0, int iParam1)//Position - 0xE80F
{
	switch (iParam1)
	{
		case 0:
...
int func_122(int iParam0, int iParam1)//Position - 0xEC0A
{
	switch (iParam1)
	{
		case 0:
...
int func_123(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xF005
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_124(int iParam0)//Position - 0xF044
{
	return Global_43052 == iParam0;
}

int func_125(int iParam0)//Position - 0xF052
{
	switch (iParam0)
	{
		case -1:
...
void func_126(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF126
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar3 >= 0)
		{
			...
			if (iVar4 > iVar3)
			{
				...
				func_119(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_119(&(Global_78130[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_119(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_119(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_108(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_127(int iParam0)//Position - 0xF3AD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0xF504
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0xFA12
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0xFA87
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0xFAFB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0xFBE2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0xFF45
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x10158
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x10388
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x10498
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x10E37
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x119AA
{
	if (iParam0 < 136)
	{
		func_140(iParam0);
...
void func_139(int iParam0)//Position - 0x119DF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x125E3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x134F1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x1361E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0, int iParam1)//Position - 0x1371C
{
	switch (iParam0)
	{
		case 0:
...
void func_144(int iParam0)//Position - 0x1380C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x14CFE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x14E4F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x1535A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x159C8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x15A3C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x15B0C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1603C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x161D3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x169D1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x16AE1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x17A0C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x186CC
{
	if (iParam0 < 107)
	{
		func_159(iParam0);
...
void func_157(int iParam0)//Position - 0x18712
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x191B7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x19FA6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1ABEF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1AE68
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0, int iParam1)//Position - 0x1AFAE
{
	switch (iParam0)
	{
		case 0:
...
void func_163(int iParam0)//Position - 0x1B09E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1BE28
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1BFA2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1C54F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x1CA79
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x1CAED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x1CBBD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x1D095
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x1D2FE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x1D5D4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x1D79D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x1E2F1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x1EF3B
{
	if (iParam0 < 60)
	{
		func_177(iParam0);
...
void func_176(int iParam0)//Position - 0x1EF70
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x1FD10
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x2039D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x20484
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180()//Position - 0x20582
{
...
int func_181(int iParam0, int iParam1, int iParam2)//Position - 0x205FB
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_181(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_181(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_78130[2 /*14*/] = { func_116(iVar0, 14, iVar4, -1) };
									if (Global_78130[2 /*14*/].f_12 == iVar3)
									{
										if (func_181(iParam0, 14, iVar4))
										{
											if (!func_71(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_78130[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_78130[2 /*14*/] = { func_116(iVar0, iVar2, iVar1, -1) };
						if (!func_71(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_78130[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_78130[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_108(iParam1)) && Global_78130[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_108(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_182(int iParam0)//Position - 0x20853
{
	int iVar0;
	int iVar1;
...
void func_183(char* sParam0, var uParam1)//Position - 0x20890
{
...
void func_185()//Position - 0x20927
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_238(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_182(PLAYER::PLAYER_PED_ID());
			if (func_186(iVar0) && (!func_124(14) || Global_112337))
			{
				if (Global_113386.f_2363.f_539.f_4321 != iVar0 && func_186(Global_113386.f_2363.f_539.f_4321))
				{
...
bool func_186(int iParam0)//Position - 0x20A24
{
	return iParam0 < 3;
}

struct<2> func_187(int iParam0)//Position - 0x20A30
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_188(int iParam0)//Position - 0x20A68
{
	struct<2> Var0;
...
void func_189(int iParam0, int iParam1)//Position - 0x20EB5
{
...
void func_190(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x20EFF
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
	...
	if (iParam1 == 1)
	{
		func_191(iParam0, bParam2, bParam3);
	}
	HUD::SET_MISSION_NAME(false, 0);
}

void func_191(int iParam0, bool bParam1, bool bParam2)//Position - 0x20F9C
{
	struct<4> Var0;
	char* sVar1;
	...
	if (iParam0 != -1)
	{
		...
		func_192(&sVar1, Var0.f_3, Global_100478, bParam1, bParam2);
	}
}

void func_192(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x20FDB
{
...
void func_193(int iParam0, var uParam1)//Position - 0x21020
{
	switch (iParam0)
	{
		case 0:
...
void func_194(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0x22267
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_195(int iParam0)//Position - 0x222F8
{
	switch (iParam0)
	{
		case 0:
...
void func_196(int iParam0)//Position - 0x2263E
{
	Global_43603 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_197()//Position - 0x22650
{
	if (Global_97753)
	{
		func_185();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_198(Global_113386.f_2363.f_539.f_4321));
	}
	else
	{
...
char* func_198(var uParam0)//Position - 0x22683
{
	uParam0 = uParam0;
	return "";
}

void func_199()//Position - 0x22693
{
	char cVar0[24];
	
	if (MISC::IS_XBOX360_VERSION() || func_201())
	{
		NETWORK::NETWORK_SET_RICH_PRESENCE(StackVal, 0, 0, 0);
	}
	else if (MISC::IS_PS3_VERSION() || func_200())
	{
...
bool func_200()//Position - 0x226D6
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_201()//Position - 0x226EC
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_202(int iParam0, int iParam1)//Position - 0x22702
{
	Global_97748 = iParam0;
	Global_97749 = iParam1;
}

void func_203()//Position - 0x22716
{
	if (Global_78573 != 6)
	{
	}
...
void func_204(var uParam0)//Position - 0x2274E
{
	if (*uParam0 == -1)
	{
		return;
...
void func_205(int iParam0, bool bParam1)//Position - 0x2278B
{
	struct<26> Var0;
	int iVar1;
	bool bVar2;
...
int func_206(int iParam0)//Position - 0x22909
{
	switch (iParam0)
	{
		case 0:
...
void func_207(int iParam0)//Position - 0x22C90
{
	func_209(iParam0, 1);
	Global_113386.f_18574[iParam0 /*6*/].f_3 = func_208();
	Global_113386.f_18574.f_380++;
}

int func_208()//Position - 0x22CC6
{
	return (Global_113386.f_10016.f_21 + Global_113386.f_18574.f_380);
}

void func_209(var uParam0, bool bParam1)//Position - 0x22CE2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_210(int iParam0)//Position - 0x23006
{
...
void func_211(int iParam0)//Position - 0x23039
{
	switch (iParam0)
	{
		case 30:
...
void func_212(int iParam0, bool bParam1)//Position - 0x2306E
{
	if (iParam0 == -1)
	{
		return;
...
void func_213(int iParam0, int iParam1, bool bParam2)//Position - 0x230CB
{
	if (iParam0 == -1)
	{
		return;
...
int func_214(int iParam0, int iParam1)//Position - 0x23106
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_215(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x23126
{
	if (iParam0 != 198)
	{
		if (Global_78319)
...
void func_216(int iParam0, int iParam1)//Position - 0x2317E
{
	switch (iParam0)
	{
		case 12:
...
void func_217(int iParam0, bool bParam1)//Position - 0x23267
{
	if (bParam1)
	{
...
bool func_218(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x23290
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_220()//Position - 0x23C25
{
	return Global_31960;
}

int func_221(var uParam0, int iParam1)//Position - 0x23C30
{
	int iVar0;
...
int func_222(int iParam0)//Position - 0x27777
{
	switch (iParam0)
	{
		case 46:
...
void func_223(int iParam0, bool bParam1)//Position - 0x27866
{
	switch (iParam0)
	{
		case 46:
...
void func_224(int iParam0, bool bParam1)//Position - 0x278B7
{
	int iVar0;
...
void func_225(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2791D
{
	func_226(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_226(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2793F
{
	int iVar0;
...
void func_227()//Position - 0x27B13
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0x27C2A
{
	int iVar0;
	int iVar1;
...
void func_229(char* sParam0)//Position - 0x27C6A
{
...
char* func_230(int iParam0)//Position - 0x27C8F
{
	switch (iParam0)
	{
		case 0:
...
int func_231(int iParam0)//Position - 0x27E62
{
...
void func_232(int iParam0, int iParam1)//Position - 0x27E8C
{
...
int func_233(char* sParam0)//Position - 0x27EC9
{
	int iVar0;
...
int func_234()//Position - 0x27F29
{
	return func_235(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_235(char* sParam0, int iParam1)//Position - 0x27F3A
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_236(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x27F83
{
	...
	if (BitTest(Global_78130[1 /*14*/].f_6, 0) && !BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_105(iParam1, Global_78130[1 /*14*/].f_5, Global_78130[1 /*14*/].f_2, 1, Global_78130[1 /*14*/].f_1, 1, 0);
			if (iParam1 == 12)
			{
				iVar0 = 1;
				if (iParam0 == joaat("Player_Zero"))
		...
		{
			func_105(iParam1, Global_78130[1 /*14*/].f_5, Global_78130[1 /*14*/].f_2, 1, Global_78130[1 /*14*/].f_1, 0, 1);
		}
...
int func_237(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x28367
{
	Global_78130[1 /*14*/] = { func_116(iParam0, iParam1, iParam2, -1) };
	if (BitTest(Global_78130[1 /*14*/].f_6, 0) && !BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_105(iParam1, Global_78130[1 /*14*/].f_5, Global_78130[1 /*14*/].f_2, 0, Global_78130[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_105(iParam1, Global_78130[1 /*14*/].f_5, Global_78130[1 /*14*/].f_2, 0, Global_78130[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
int func_238(int iParam0)//Position - 0x283FD
{
	if (func_186(iParam0))
	{
...
var func_239(int iParam0)//Position - 0x28422
{
...
bool func_242(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x2845F
{
...
int func_243(char* sParam0, int iParam1, bool bParam2)//Position - 0x284BE
{
	Global_21606 = 0;
...
void func_244()//Position - 0x2878C
{
	if (!func_245())
	{
		return;
...
bool func_246(int iParam0)//Position - 0x28826
{
	return func_247(iParam0, 20);
}

var func_247(int iParam0, int iParam1)//Position - 0x28836
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

int func_248()//Position - 0x2884E
{
	return -1;
}

void func_249()//Position - 0x28857
{
	int iVar0;
...
void func_250()//Position - 0x28889
{
...
void func_252()//Position - 0x289B7
{
	if (func_124(14))
	{
...
int func_253()//Position - 0x28A59
{
	func_185();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_254()//Position - 0x28A72
{
	int iVar0;
...
bool func_255(int iParam0, int iParam1)//Position - 0x28ACA
{
	switch (iParam0)
	{
		case 5:
...
void func_256(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28B02
{
...
void func_257()//Position - 0x28B58
{
	...
	if (func_514(Local_293.f_0))
	{
		switch (iLocal_68)
		{
			case 0:
				...
				if (func_275(Local_293.f_0, 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					if (!func_14())
					{
						...
						func_533("GS_WAIT_FOR_PLAYER, player threatened Glen; attacking...");
				...
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 11f, 11f, 11f, false, true, 0))
				{
					if (!func_181(PLAYER::PLAYER_PED_ID(), 12, 4))
					{
						...
						func_533("GS_WAIT_FOR_PLAYER, player got too close to Glen (alert_dis); attacking...");
						func_267();
						ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_328.f_1, Local_293.f_0, PED::GET_PED_BONE_INDEX(Local_293.f_0, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, false, false, false, false, 2, true, 0);
						iLocal_68 = 3;
					}
			...
			case 1:
				...
				{
					func_533("GS_PLAYER_IN_OUTFIT, player threatened Glen or returned a second time; attacking...");
					func_267();
				}
				else
				{
					...
					if ((func_5(Local_317.f_0) && func_5(Local_316[5 /*6*/])) && func_514(PLAYER::PLAYER_PED_ID()))
					{
			...
			case 2:
				if (func_275(Local_293.f_0, 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					func_533("GS_ANGRY_AT_PLAYER, player threatened Glen; attacking...");
					func_267();
				}
				if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 11f, 11f, 11f, false, true, 0))
				{
			...
			case 3:
				if (((func_5(Local_317.f_0) && func_265(Local_293.f_0, Local_317.f_0, 1) < 10f) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_317.f_0, false)) && !ENTITY::IS_ENTITY_UPSIDEDOWN(Local_317.f_0))
				{
			...
			case 7:
				func_533("Celeb crashed or forced out - quitting chase");
				if (iLocal_67 < 6)
				{
	...
	else
	{
		if (!iLocal_272)
		{
			func_533("bReplayCelebDeadCheck tripped, recording last 2 seconds");
...
int func_258()//Position - 0x294D8
{
	if (ENTITY::GET_ENTITY_SPEED(Local_317.f_0) < 0.15f && PED::IS_PED_IN_VEHICLE(Local_293.f_0, Local_317.f_0, false))
	{
		...
		{
			TASK::VEHICLE_WAYPOINT_PLAYBACK_PAUSE(Local_317.f_0);
			if (func_5(Local_317.f_0) && func_514(Local_293.f_0))
			{
			...
			if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
			{
				if (!func_14())
				{
					if ((MISC::GET_GAME_TIMER() - iLocal_284) > 15000)
					{
						if (func_6(Local_293.f_0))
						{
							if (func_261(Local_293.f_0, PLAYER::PLAYER_PED_ID()) < 40f)
							{
								func_296(&uLocal_72, 6, Local_293.f_0, "FOSTENBURG", 0, 1);
								func_296(&uLocal_72, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
								switch (iLocal_278)
...
float func_261(int iParam0, int iParam1)//Position - 0x29845
{
...
void func_262()//Position - 0x29856
{
	...
	func_533("RESET COURSE SECURITY");
	iLocal_251 = 1;
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		if (func_514(Local_304[iVar0 /*13*/]))
		{
			iLocal_310[iVar0] = 1;
		}
		iVar0++;
...
int func_263()//Position - 0x29892
{
	if (func_514(PLAYER::PLAYER_PED_ID()))
	{
		if (func_264(&uLocal_437, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
		{
			return 1;
		}
	}
...
bool func_264(var uParam0, struct<2> Param1, Vector3 vParam2)//Position - 0x298BD
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
float func_265(int iParam0, int iParam1, bool bParam2)//Position - 0x29979
{
	struct<3> Var0;
	struct<3> Var1;
...
bool func_266(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x299D7
{
	...
	if (iLocal_255 == 0)
	{
		...
		while (iVar0 <= 2)
		{
			if (func_514(Local_303[iVar0 /*13*/]))
			{
				...
				func_510("Attack player, security guard: ", iVar0);
			}
			iVar0++;
		}
		if (func_5(Local_317.f_0))
			...
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_317.f_0, false))
			{
				if (func_6(Local_293.f_0))
				{
					if (!PED::IS_PED_IN_VEHICLE(Local_293.f_0, Local_317.f_0, false))
					{
						...
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_321);
						func_533("Making Glen get into vehicle through MAKE_SECURITY_ATTACK()");
						iLocal_68 = 3;
					}
				}
			}
		...
		func_269();
		if (iLocal_67 <= 3 && func_514(Local_293.f_0))
		{
			ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_328.f_1, Local_293.f_0, PED::GET_PED_BONE_INDEX(Local_293.f_0, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, false, false, false, false, 2, true, 0);
			if (func_514(Local_298.f_0))
			{
...
void func_268(int iParam0, bool bParam1)//Position - 0x29C7E
{
	int iVar0;
...
void func_269()//Position - 0x29CC8
{
	...
	while (iVar0 <= 5)
	{
		if (func_514(Local_305[iVar0 /*13*/]))
		{
			func_270(iVar0);
			iLocal_308[iVar0] = 3;
		}
...
int func_271(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x29D3B
{
	int iVar0;
	bool bVar1;
...
bool func_272(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x29D8D
{
...
{
	if ((func_274(PLAYER::PLAYER_PED_ID()) == joaat("WEAPON_SNIPERRIFLE") || func_274(PLAYER::PLAYER_PED_ID()) == joaat("WEAPON_HEAVYSNIPER")) || func_274(PLAYER::PLAYER_PED_ID()) == joaat("WEAPON_REMOTESNIPER"))
	{
		return 1;
	}
	return 0;
...
int func_274(int iParam0)//Position - 0x29E27
{
	var uVar0;
...
int func_275(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x29E3B
{
	struct<3> Var0;
	
	if (func_514(PLAYER::PLAYER_PED_ID()) && func_514(iParam0))
	{
...
int func_276(int iParam0, float fParam1)//Position - 0x29EF6
{
	float fVar0;
...
bool func_277(int iParam0, float fParam1)//Position - 0x29F6C
{
	return func_278(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_278(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x29F84
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (!func_514(iParam0) || !func_514(iParam1))
	{
		if (iVar2 != -1)
		{
...
int func_279(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2A045
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_280(int iParam0, int iParam1)//Position - 0x2A171
{
	int iVar0;
...
int func_282(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2A280
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	{
		Var1 = { func_284(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_283(struct<3> Param0, struct<3> Param1)//Position - 0x2A311
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_284(struct<3> Param0)//Position - 0x2A332
{
	float fVar0;
	float fVar1;
...
void func_285(var uParam0)//Position - 0x2A371
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_286(int iParam0, int iParam1)//Position - 0x2A38C
{
	int iVar0;
...
int func_287(int iParam0)//Position - 0x2A3CB
{
...
bool func_288(int iParam0, int iParam1, float fParam2)//Position - 0x2A3F3
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_289(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2A43A
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_290(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2A535
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_291(int iParam0, float fParam1)//Position - 0x2A641
{
	var uVar0;
	struct<3> Var1;
...
int func_292(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0x2A6D6
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_293(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2A764
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_294()//Position - 0x2A7AC
{
	...
	{
		case 0:
			if (func_6(Local_293.f_0) && func_514(PLAYER::PLAYER_PED_ID()))
			{
				if (((func_295(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 35f, 1) && iLocal_307[0] != 5) && iLocal_307[1] != 5) && iLocal_307[2] != 5)
				{
					if (!func_14())
					{
						func_296(&uLocal_72, 6, Local_293.f_0, "FOSTENBURG", 0, 1);
...
bool func_295(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x2A880
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), ENTITY::GET_ENTITY_COORDS(iParam1, bParam3)) <= (fParam2 * fParam2);
}

void func_296(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2A8A2
{
...
void func_297(var uParam0, int iParam1)//Position - 0x2A93D
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_298(int* iParam0)//Position - 0x2A95A
{
...
void func_300()//Position - 0x2AABA
{
	...
	switch (iLocal_69)
	{
		case 0:
			...
			func_533("ENTERING LOSE THE COPS");
			iLocal_69 = 1;
			break;
...
void func_301()//Position - 0x2AB5E
{
	if (iLocal_266)
	{
		if (!func_514(Local_293.f_0) && func_303())
		{
			func_533("Player achieved FOUR!");
			iLocal_266 = 0;
			func_302(792);
		}
	}
...
void func_302(int iParam0)//Position - 0x2AB93
{
	bool bVar0;
	int iVar1;
...
void func_304()//Position - 0x2AC30
{
	...
	else
	{
		...
		while (iVar0 <= 1)
		{
			if (func_514(Local_306[iVar0 /*13*/]))
			{
				func_305(iVar0);
			}
			iVar0++;
				...
				if (func_514(Local_293.f_0))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_293.f_0, Local_317.f_0, false))
					{
						...
						else if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_306[iParam0 /*13*/], true), 15f, true))
						{
							...
							if (func_265(PLAYER::PLAYER_PED_ID(), Local_306[iParam0 /*13*/], 1) < 45f)
							{
					...
					else if (func_275(Local_306[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || ENTITY::IS_ENTITY_AT_ENTITY(Local_293.f_0, Local_306[iParam0 /*13*/], 30f, 30f, 30f, false, true, 0))
					{
						func_299(Local_306[iParam0 /*13*/], 0);
						iLocal_309[iParam0] = 3;
					}
...
void func_306(int iParam0, char* sParam1, int iParam2)//Position - 0x2AF25
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iParam0, sParam1, func_307(iParam2), 1);
}

int func_307(int iParam0)//Position - 0x2AF3C
{
	int iVar0;
...
void func_308(var uParam0, int iParam1)//Position - 0x2B14A
{
...
void func_311()//Position - 0x2B2CD
{
	...
	if (iLocal_243 == 0)
	{
		if (func_8(0))
		{
			func_533("Celeb security loaded, creating now...");
			iVar0 = 0;
			while (iVar0 <= 2)
			{
	...
	while (iVar0 <= 2)
	{
		if (func_514(Local_303[iVar0 /*13*/]))
		{
			if (iLocal_255 == 0 && iLocal_249 == 0)
			{
				if (func_321())
				{
					func_533("Monitor_Security, player has 'mucked about' with the celeb scene; attacking...");
					if (func_320(PLAYER::PLAYER_PED_ID(), -1098.865f, 69.9792f, 53.6198f, 1) < 45f)
					{
...
void func_313(int iParam0)//Position - 0x2B463
{
	...
	if (func_514(PLAYER::PLAYER_PED_ID()) && func_514(Local_303[iParam0 /*13*/]))
	{
		if (func_265(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 1) < 20f)
		{
	...
	{
		case 0:
			if (func_275(Local_303[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || PED::HAS_PED_RECEIVED_EVENT(Local_303[iParam0 /*13*/], 61))
			{
				if (func_277(Local_303[iParam0 /*13*/], 110f))
				{
					...
					func_533("SS_GUARD_AREA, player threatened Celeb security; attacking...");
					func_267();
				}
			}
			else if (CAM::IS_FIRST_PERSON_AIM_CAM_ACTIVE())
			{
				if ((ENTITY::IS_ENTITY_ON_SCREEN(Local_303[iParam0 /*13*/]) && func_277(Local_303[iParam0 /*13*/], 1126825984)) && func_265(Local_303[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1) < 50f)
				{
					if (func_14())
					{
						func_12();
					...
					func_296(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
					func_272(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_6", 7, 1, 0);
					func_533("SS_GUARD_AREA, player tried sniping Celeb security but was spotted; attacking...");
					func_267();
				}
			}
			else if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_303[iParam0 /*13*/]))
			{
				if (func_273())
				{
					if (func_277(Local_303[iParam0 /*13*/], 1126825984))
					{
						...
						{
							func_533("SS_GUARD_AREA, player aimed Sniper Rifle when security could see them; attacking...");
							func_267();
						}
					}
				}
			...
			else if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 25f, 25f, 25f, false, true, 0))
				{
					if (!func_181(PLAYER::PLAYER_PED_ID(), 12, 4))
					{
						if (!func_317())
						{
							if (func_277(Local_303[iParam0 /*13*/], 1126825984) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 18f, 18f, 18f, false, true, 0))
							{
								if (func_14())
								{
									func_12();
								...
								{
									func_533("SS_GUARD_AREA, player armed, not wearing outfit, guard has LOS or player within 18m; attacking...");
									func_267();
								}
							}
						}
						else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 18f, 18f, 18f, false, true, 0))
						{
							...
							else if (iLocal_249 == 1)
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 12f, 12f, 12f, false, true, 0))
								{
									...
									{
										func_533("SS_GUARD_AREA, non-outfit, player came back to area after being warned; attacking");
										func_267();
									}
								}
							}
					...
					else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 18f, 18f, 18f, false, true, 0))
					{
						...
						else if (iLocal_249 == 1)
						{
							if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 12f, 12f, 12f, false, true, 0))
							{
								...
								{
									func_533("SS_GUARD_AREA, outfit, player came back to area after being warned; attacking");
									func_267();
								}
							}
						}
			...
			else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 50f, 50f, 50f, false, true, 0))
			{
				if (!VEHICLE::IS_VEHICLE_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), Local_317.f_5))
				{
					if (func_277(Local_303[iParam0 /*13*/], 1126825984))
					{
						...
						if (func_272(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0))
						{
							func_533("SS_GUARD_AREA, player 50m away from group in non-buggy vehicle; attacking");
							func_267();
						}
					}
				}
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 25f, 25f, 25f, false, true, 0))
				{
					...
					{
						func_316("Going too fast, going to trigger aggro: ", ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)));
						if (PED::HAS_PED_RECEIVED_EVENT(Local_303[iParam0 /*13*/], 61) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 6f, 6f, 6f, false, true, 0))
						{
							if (func_277(Local_303[iParam0 /*13*/], 1126825984))
							{
								...
								if (func_272(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0))
								{
									func_533("SS_GUARD_AREA, player went too fast too close to security; attacking");
									func_267();
								}
							}
						}
					...
					else if (func_277(Local_303[iParam0 /*13*/], 1126825984))
					{
						...
						if (iLocal_254 == 0)
						{
							...
							{
								func_510("'You can't drive through here buddy said by ped id: ", iParam0);
								if (func_6(Local_303[iParam0 /*13*/]))
								{
									TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_303[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), -1);
								}
		...
		case 1:
			if (!func_317())
			{
				if (func_277(Local_303[iParam0 /*13*/], 1126825984))
				{
					if (func_265(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 1) < 80f)
					{
						func_533("SS_GO_TO_PLAYER, player armed, guard has LOS; attacking...");
						func_267();
					}
				}
			}
			...
			else if ((MISC::GET_GAME_TIMER() - iLocal_285) >= 8000)
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 20f, 20f, 20f, false, true, 0))
				{
					...
					if (func_272(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_2", 7, 0, 0))
					{
						...
						iLocal_285 = MISC::GET_GAME_TIMER();
						iLocal_307[iParam0] = 2;
						func_533("Guard: going into SS_WARN_PLAYER ");
					}
				}
			}
			break;
		...
		case 2:
			if (!func_317())
			{
				if (func_277(Local_303[iParam0 /*13*/], 1126825984))
				{
					if (func_265(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 1) < 80f)
					{
						func_533("SS_WARN_PLAYER, player armed, guard has LOS; attacking...");
						func_267();
					}
				}
			}
			else if (!func_181(PLAYER::PLAYER_PED_ID(), 12, 4))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 4f, 4f, 4f, false, true, 0) || (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 8f, 8f, 8f, false, true, 0) && iLocal_249 == 1))
				{
					...
					func_533("SS_WARN_PLAYER, player got too close, going to aim...");
				}
				else
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 9f, 9f, 9f, false, true, 0))
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) >= 15f)
							{
								...
								func_316("SS_WARN_PLAYER, going too fast: ", ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)));
								func_296(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
								func_272(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
								func_533("SS_WARN_PLAYER, player in vehicle going too fast within 9m of guard; attacking...");
								func_267();
							}
						}
					}
					if ((MISC::GET_GAME_TIMER() - iLocal_285) >= 7000)
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 20f, 20f, 20f, false, true, 0))
						{
							...
							if (func_272(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_3", 7, 0, 0))
							{
								...
								iLocal_285 = MISC::GET_GAME_TIMER();
								iLocal_307[iParam0] = 3;
								func_533("SS_WARN_PLAYER, player took too long, going to aim...");
							}
						}
						else if (func_265(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 1) > 20f)
						{
							TASK::TASK_ACHIEVE_HEADING(Local_303[iParam0 /*13*/], Local_303[iParam0 /*13*/].f_7, 0);
							TASK::TASK_CLEAR_LOOK_AT(Local_303[iParam0 /*13*/]);
							func_533("SS_WARN_PLAYER, player >20m away, returning to SS_GUARD_AREA...");
			...
			else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 18f, 18f, 18f, false, true, 0))
			{
				...
				else if (iLocal_249 == 1)
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 12f, 12f, 12f, false, true, 0))
					{
						...
						if (func_272(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0))
						{
							func_533("SS_WARN_PLAYER, outfit worn, player came back to area after being warned; attacking");
							func_267();
						}
					}
				}
		...
		case 3:
			if (!func_317())
			{
				if (func_277(Local_303[iParam0 /*13*/], 1126825984))
				{
					if (func_265(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 1) < 80f)
					{
						...
						func_533("SS_AIM_AT_PLAYER, player armed, guard has LOS; attacking...");
						if (iLocal_255 == 0)
						{
							func_267();
						}
						else
						{
							...
							func_510("Attack player, FORCE security guard: ", iParam0);
						}
					}
				}
			}
			else
			{
				if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_303[iParam0 /*13*/], true), 20f, false) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 20f, 20f, 20f, false, true, 0))
				{
					...
					func_296(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
					func_272(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
					func_533("SS_AIM_AT_PLAYER, bullet detected within 20m of a ped, attacking...");
					func_267();
				}
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 7f, 7f, 5f, false, true, 0) || (func_315(PLAYER::PLAYER_PED_ID(), -1097.28f, 68.05f, 52.99f, 10f, 1) && iLocal_249 == 1))
				{
					if (func_14())
					{
						func_12();
					...
					func_296(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
					func_272(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
					func_533("SS_AIM_AT_PLAYER, player got too close, attacking...");
					func_267();
				}
				else
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 20f, 20f, 20f, false, true, 0))
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) >= 15f)
							{
								...
								func_316("SS_AIM_AT_PLAYER, going too fast: ", ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)));
								func_296(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
								func_272(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
								func_533("SS_AIM_AT_PLAYER, player in vehicle above acceptable speed, within 20m; attacking...");
								func_267();
							}
						}
					}
						...
						if (func_514(Local_293.f_0))
						{
							...
							else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 20f, 20f, 20f, false, true, 0))
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 9f, 9f, 9f, false, true, 0) || (MISC::GET_GAME_TIMER() - iLocal_285) >= 12000)
								{
									...
									func_296(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
									func_272(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
									func_533("SS_AIM_AT_PLAYER, player took too long and didn't move away, attacking...");
									func_267();
								}
							}
						}
		...
		case 4:
			if (func_265(Local_303[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1) > 120f && (PED::IS_PED_IN_ANY_VEHICLE(Local_293.f_0, false) || func_514(Local_293.f_0)))
			{
				if (HUD::DOES_BLIP_EXIST(Local_303[iParam0 /*13*/].f_11))
				{
		...
		case 5:
			...
			if (func_275(Local_303[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || PED::HAS_PED_RECEIVED_EVENT(Local_303[iParam0 /*13*/], 61))
			{
				func_533("SS_STANDDOWN, player threatened Glen OR guard thought he'd get run over; attacking...");
				func_267();
			}
			else if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_303[iParam0 /*13*/]))
			{
				if (func_273())
				{
					if (func_277(Local_303[iParam0 /*13*/], 1126825984))
					{
						...
						func_296(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
						func_272(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_6", 7, 0, 0);
						func_533("SS_STANDDOWN, player aiming Sniper Rifle, guard has LOS; attacking...");
						func_267();
					}
				}
			}
...
int func_314(int iParam0, int iParam1)//Position - 0x2C80A
{
	if (func_6(iParam0))
	{
...
bool func_315(int iParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x2C83D
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), Param1) <= (fParam2 * fParam2);
}

void func_316(char* sParam0, float fParam1)//Position - 0x2C85B
{
	sParam0 = sParam0;
	fParam1 = fParam1;
}
...
{
	if (func_274(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED") && func_274(PLAYER::PLAYER_PED_ID()) != joaat("OBJECT"))
	{
		if (func_274(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_GOLFCLUB"))
		{
			return 0;
		}
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_318()//Position - 0x2C8CF
{
	...
	{
		if (iLocal_67 < 3 || func_265(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 1) > 100f)
		{
			iVar0 = 0;
			while (iVar0 <= 2)
			{
				if (func_6(Local_303[iVar0 /*13*/]))
				{
					...
					func_510("Alerted, security guard: ", iVar0);
				}
				iLocal_307[iVar0] = 3;
				iVar0++;
			}
		...
		{
			func_533("Alert called, but guards need to attack instead");
			func_267();
		}
	}
}

void func_319(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2CA3E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
float func_320(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x2CA8E
{
	struct<3> Var0;
...
int func_321()//Position - 0x2CAC8
{
	...
	while (iVar0 <= 2)
	{
		if ((!func_514(Local_303[iVar0 /*13*/]) || func_322(PLAYER::PLAYER_PED_ID(), Local_303[iVar0 /*13*/], 1)) || PED::IS_PED_RAGDOLL(Local_303[iVar0 /*13*/]))
		{
			func_533("HAS_PLAYER_MUCKED_ABOUT(): Player bumped celeb security with vehicle OR celeb security dead");
			return 1;
		}
		iVar0++;
	}
	if ((!func_514(Local_293.f_0) || func_322(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 1)) || PED::IS_PED_RAGDOLL(Local_293.f_0))
	{
		func_533("HAS_PLAYER_MUCKED_ABOUT(): Celeb ragdoll OR player bumped celeb with vehicle OR celeb isn't alive");
		return 1;
	}
	if ((!func_514(Local_298.f_0) || func_322(PLAYER::PLAYER_PED_ID(), Local_298.f_0, 1)) || PED::IS_PED_RAGDOLL(Local_298.f_0))
	{
		func_533("HAS_PLAYER_MUCKED_ABOUT(): Celeb friend ragdoll OR player bumped friend with vehicle OR friend isn't alive");
		return 1;
	}
	if (func_5(Local_317.f_0) && func_514(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_317.f_0, false))
		{
			func_533("HAS_PLAYER_MUCKED_ABOUT(): Player in celeb's golf cart");
			return 1;
		}
	}
	else
	{
		func_533("HAS_PLAYER_MUCKED_ABOUT(): Celeb golf cart not OK, player destroyed it?");
		return 1;
	}
	if (func_5(Local_316[4 /*6*/]) && func_514(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_316[4 /*6*/], false))
		{
			func_533("HAS_PLAYER_MUCKED_ABOUT(): Player in golf cart behind celeb");
			return 1;
		}
	}
	else
	{
		func_533("HAS_PLAYER_MUCKED_ABOUT(): Golf cart behind celeb not OK, player destroyed it?");
		return 1;
	}
	if (func_5(Local_316[5 /*6*/]) && func_514(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_316[5 /*6*/], false))
		{
			func_533("HAS_PLAYER_MUCKED_ABOUT(): Player in golf cart next to celeb");
			return 1;
		}
	}
	else
	{
		func_533("HAS_PLAYER_MUCKED_ABOUT(): Golf cart next to celeb not OK, player destroyed it?");
		return 1;
	}
	return 0;
}

int func_322(int iParam0, int iParam1, bool bParam2)//Position - 0x2CC69
{
...
void func_323()//Position - 0x2CCB4
{
	...
	switch (iLocal_69)
	{
		case 0:
			...
			func_533("ENTERING LOSE THE SECURITY ");
			iLocal_69 = 1;
			break;
...
void func_325()//Position - 0x2CE04
{
	switch (iLocal_69)
	{
		case 0:
			...
			func_533("ENTERING COLLECT GOLF CLUB ");
			iLocal_69 = 1;
			break;
...
void func_326(bool bParam0, int iParam1)//Position - 0x2D058
{
	int iVar0;
...
void func_327()//Position - 0x2D0F2
{
	if (iLocal_265 == 0)
	{
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
		{
			...
			func_533("*** Played special Nigel 1D police report ***");
			iLocal_265 = 1;
		}
	}
}
...
{
	if (func_264(&uLocal_333, ENTITY::GET_ENTITY_COORDS(iParam0, true)))
	{
		return 1;
	}
	return 0;
...
void func_329()//Position - 0x2D143
{
	if (iLocal_262 == 0)
	{
		if (func_514(Local_328.f_1) && iLocal_67 == 6)
		{
	...
	if (func_514(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (iLocal_67 < 6)
		{
			if (func_514(Local_293.f_0))
			{
				if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 140f, 140f, 140f, false, true, 0) && !func_278(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 1126825984, 1, 250, 7))
				{
					func_34(1);
				}
			}
...
void func_330(var uParam0, int iParam1, bool bParam2)//Position - 0x2D28F
{
	char* sVar0;
...
bool func_331(char* sParam0)//Position - 0x2D370
{
...
void func_332()//Position - 0x2D383
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_293.f_0) && func_514(Local_328.f_1))
	{
	...
	switch (iLocal_69)
	{
		case 0:
			...
			if (func_514(Local_328.f_1) && func_514(Local_293.f_0))
			{
				...
				{
					func_533("Glen still holding club, reattach to bag");
					ENTITY::DETACH_ENTITY(Local_328.f_1, true, true);
					ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_328.f_1, iLocal_323, 0, 0.1f, 0f, -0.25f, -5f, 155f, 0f, false, false, false, false, 2, true, 0);
				}
			}
			MISC::SET_INSTANCE_PRIORITY_HINT(2);
			func_533("ENTERING CHASE IN CITY ");
			func_298(&iLocal_237);
		...
		case 1:
			...
			if (bLocal_267)
			{
				if (func_514(Local_328.f_1) && func_514(iLocal_323))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
...
int func_334()//Position - 0x2D6C8
{
	if (func_5(Local_317.f_0))
	{
		if (func_514(Local_293.f_0))
		{
			...
			{
				func_533("Buggy stuck or front tyres burst in city - returning true");
				if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_317.f_0))
				{
					TASK::REMOVE_WAYPOINT_RECORDING("NIGEL1DGOLF");
					TASK::REMOVE_WAYPOINT_RECORDING("NIGEL1DGOLF2");
			...
			{
				func_533("Buggy health below threshold - returning true");
				iLocal_242 = 1;
				return 1;
			}
			if (!PED::IS_PED_IN_VEHICLE(Local_293.f_0, Local_317.f_0, false))
			{
				func_533("Celeb not in buggy while monitoring chase - returning true");
				return 1;
			}
		}
		else
		{
			func_533("Celeb dead - returning true");
			return 1;
		}
	}
	else
	{
		func_533("Buggy somehow not ok - returning true");
		return 1;
	}
	return 0;
}
...
void func_336(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x2D804
{
	func_337(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_337(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x2D821
{
	func_338(uParam0, iParam1, Param2, sParam3, iParam4, bParam5, uParam6, bParam7);
}

void func_338(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x2D83F
{
...
void func_339(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x2D877
{
	int iVar0;
	int iVar1;
...
void func_340(var uParam0)//Position - 0x2DBE8
{
...
int func_341(var uParam0)//Position - 0x2DC56
{
	int iVar0;
...
int func_342(bool bParam0)//Position - 0x2DC81
{
	switch (Global_43052)
	{
		case 0:
...
void func_343(char* sParam0, int iParam1)//Position - 0x2DD2B
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_344(char* sParam0)//Position - 0x2DD42
{
	if (!func_345(1, 1, 0))
	{
		if ((!MISC::IS_STRING_NULL_OR_EMPTY(sParam0) && func_331(sParam0)) || func_331("CMN_HINT"))
		{
			HUD::CLEAR_HELP(true);
		}
		return 0;
...
int func_345(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2DDDC
{
	int iVar0;
	int iVar1;
	...
	if ((func_352() || func_351(Global_4718592.f_168757)) || func_350())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
...
int func_346(int iParam0)//Position - 0x2E035
{
	if (iParam0 != func_248())
	{
		...
		else if ((Global_1575058 && iParam0 == PLAYER::PLAYER_ID()) && func_347(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
int func_347(int iParam0, bool bParam1, bool bParam2)//Position - 0x2E09B
{
	int iVar0;
...
int func_348(int iParam0, int iParam1)//Position - 0x2E0FB
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
...
int func_349(int iParam0, bool bParam1)//Position - 0x2E15D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_350()//Position - 0x2E1E2
{
	return Global_2714762.f_19;
}

bool func_351(int iParam0)//Position - 0x2E1F0
{
	return iParam0 == 51;
}

var func_352()//Position - 0x2E1FD
{
	return Global_2714762.f_18;
}

bool func_353()//Position - 0x2E20B
{
	return MISC::GET_GAME_TIMER() <= Global_23150.f_6269 + 100;
}

int func_354(int iParam0)//Position - 0x2E220
{
	if (iParam0 == 1)
	{
		if (Global_20266.f_1 > 3)
...
void func_355(var uParam0, int iParam1, struct<3> Param2, int iParam3)//Position - 0x2E277
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_356()//Position - 0x2E38B
{
	return func_357(PLAYER::PLAYER_ID());
}

int func_357(int iParam0)//Position - 0x2E39B
{
...
bool func_358(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x2E3BA
{
	if (bParam2)
	{
...
int func_359(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x2E401
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_360(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2E76D
{
...
int func_361(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2E7BF
{
	if (!func_345(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_362(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2E808
{
	if (!func_345(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_363(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2E867
{
	if (!func_345(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_364(int iParam0)//Position - 0x2E8BD
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_365()//Position - 0x2E918
{
	MISC::SET_BIT(&Global_8137, 4);
}

void func_366(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)//Position - 0x2E928
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_367(int iParam0, bool bParam1, int iParam2)//Position - 0x2EA81
{
	int iVar0;
...
void func_368()//Position - 0x2EAB6
{
	...
	{
		case 0:
			func_533("CHASE THE GOLFER ");
			iLocal_282 = MISC::GET_GAME_TIMER();
			iLocal_283 = MISC::GET_GAME_TIMER();
			iLocal_284 = MISC::GET_GAME_TIMER();
			HUD::SET_BLIP_SCALE(iLocal_237, 1f);
			func_382(&(Local_316[3 /*6*/]));
			if (func_514(iLocal_323) && func_5(Local_317.f_0))
			{
				if (!ENTITY::IS_ENTITY_ATTACHED(iLocal_323))
				{
					func_533("Reattaching bag to buggy!?");
			...
			if ((func_514(Local_328.f_1) && func_514(Local_293.f_0)) && func_5(Local_317.f_0))
			{
				if (!ENTITY::IS_ENTITY_ATTACHED(Local_328.f_1))
				{
					func_533("Reattaching club to bag!?");
		...
		case 1:
			...
			if (func_369() || !func_514(Local_293.f_0))
			{
				func_33("N1D_COLLECT", 7500, 5);
				func_35(6);
			}
...
int func_369()//Position - 0x2EDB3
{
	if (func_5(Local_317.f_0))
	{
		if (func_514(Local_293.f_0))
		{
			...
			if ((func_258() || VEHICLE::IS_VEHICLE_TYRE_BURST(Local_317.f_0, 0, false)) || VEHICLE::IS_VEHICLE_TYRE_BURST(Local_317.f_0, 1, false))
			{
				...
				TASK::CLEAR_PED_TASKS(Local_293.f_0);
				func_299(Local_293.f_0, 1);
				func_533("*** Celeb cart stuck or a front wheel is burst - chase monitor returning True");
				return 1;
			}
			else
			{
			...
			{
				iLocal_242 = 1;
				func_533("*** Celeb cart below drop club threshold - chase monitor returning True");
				return 1;
			}
			if (!PED::IS_PED_IN_VEHICLE(Local_293.f_0, Local_317.f_0, false))
			{
				func_533("*** Celeb no longer in vehicle - chase monitor returning True");
				return 1;
			}
			...
			{
				func_370();
				func_510("VEHICLE HEALTH IS ", ENTITY::GET_ENTITY_HEALTH(Local_317.f_0));
	...
	{
		func_533("*** Celeb cart wrecked/not OK - chase monitor returning True");
		func_299(Local_293.f_0, 1);
		return 1;
	}
	return 0;
	...
	else
	{
		...
		while (iVar0 <= 5)
		{
			if (func_377(iVar0))
			{
				...
				{
					iLocal_308[iVar0] = 4;
					func_510("This Ambient Golfer is now dead: ", iVar0);
					func_375(iVar0);
				}
			}
			if (func_514(Local_305[iVar0 /*13*/]))
	...
	switch (iLocal_308[iParam0])
	{
		case 0:
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_305[iParam0 /*13*/], true), 50f, false))
				{
					...
					func_533("AS_PLAYGOLF, bullet in area of ambient golfer (no vehicle); alerted...");
					func_318();
				...
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_305[iParam0 /*13*/], 20f, 20f, 20f, false, true, 0))
				{
					if (func_275(Local_305[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0))
					{
						if (!func_317())
						{
							...
							func_270(iParam0);
							func_533("AS_PLAYGOLF, player threatened ambient golfer; attacking...");
							func_318();
							iLocal_308[iParam0] = 1;
						}
						else
						{
							...
							if (!func_14() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
							{
								...
								func_533("Played aggro line from ambient golfer...");
							}
					...
					else if (func_277(Local_305[iParam0 /*13*/], 1126825984))
					{
						if (!func_317())
						{
							...
							func_270(iParam0);
							func_533("AS_PLAYGOLF, player armed and ambient golfer has LOS; attacking...");
							func_318();
							iLocal_308[iParam0] = 1;
						}
					}
			...
			else if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) >= 10f)
			{
				if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_305[iParam0 /*13*/], 11f, 11f, 11f, false, true, 0) && PED::HAS_PED_RECEIVED_EVENT(Local_305[iParam0 /*13*/], 61)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(Local_305[iParam0 /*13*/]))
				{
					...
					func_510("This ambient golfer nearly got run over and is now attacking player: ", iParam0);
					PED::SET_PED_CAN_BE_TARGETTED(Local_305[iParam0 /*13*/], true);
					TASK::TASK_COMBAT_PED(Local_305[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 0, 16);
					func_374();
					iLocal_308[iParam0] = 1;
			...
			else if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_305[iParam0 /*13*/], true), 50f, true))
			{
				...
				func_533("AS_PLAYGOLF, bullet in area of ambient golfer (in vehicle); attacking...");
				func_318();
				iLocal_308[iParam0] = 1;
			}
			...
			{
				func_533("Player damaged an ambient golfer with their vehicle (or another vehicle damaged them?)");
				if (!func_14() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
					func_306(Local_305[iParam0 /*13*/], "GENERIC_FUCK_YOU", 34);
				}
		...
		case 1:
			if (func_275(Local_305[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) && !func_317())
			{
				...
				func_533("AS_ALERTED, player threatened ambient golfer and was armed; attacking...");
				func_318();
				func_270(iParam0);
				iLocal_308[iParam0] = 3;
			}
		...
		while (iVar0 <= 5)
		{
			if (func_514(Local_305[iVar0 /*13*/]))
			{
				if (func_376(Local_305[iParam0 /*13*/], Local_305[iVar0 /*13*/], 20f))
				{
					...
					{
						func_510("Making this Ambient Golfer flee from dead ped: ", iVar0);
						func_270(iVar0);
					}
				}
			}
...
void func_382(int* iParam0)//Position - 0x2F9BC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_383()//Position - 0x2F9F4
{
	...
	{
		case 0:
			func_533("ENTERING GET THE CLUB 1 ");
			if (iLocal_259 == 0)
			{
				func_33("N1D_TAKE", 7500, 5);
				iLocal_259 = 1;
		...
		case 2:
			HUD::CLEAR_PRINTS();
			if (func_514(Local_293.f_0) && !bLocal_264)
			{
				func_35(4);
			}
			else
...
void func_384()//Position - 0x2FB9B
{
	switch (iLocal_312)
	{
		...
		case 1:
			...
			{
				iLocal_239 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SPLINE_CAMERA"), -1409.452f, 53.5135f, 78.0868f, -26.7543f, 0f, -85.6976f, 50f, false, 2);
		...
		case 4:
			...
			{
				iLocal_240 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SPLINE_CAMERA"), -1373.681f, 57.0584f, 54.9717f, -10.6657f, 0f, 91.5916f, 50f, false, 2);
...
void func_385(int iParam0)//Position - 0x2FF61
{
	if (!func_186(iParam0))
	{
		return;
...
void func_387()//Position - 0x2FFA8
{
	...
	if (iLocal_258 == 0)
	{
		if (func_9(0))
		{
			func_533("Concierge scene loaded, creating now...");
			iVar0 = 0;
			while (iVar0 <= 3)
			{
...
void func_388()//Position - 0x30065
{
	...
	while (iVar0 <= 3)
	{
		if (func_514(Local_292[iVar0 /*13*/]))
		{
			func_389(iVar0);
		}
		iVar0++;
...
void func_391()//Position - 0x3023B
{
	if (func_514(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			func_533("Recreated mission blip");
			iLocal_237 = func_271(Local_293.f_0, 1, 0, 5);
		}
		else
		{
...
{
	if (func_264(&uLocal_385, ENTITY::GET_ENTITY_COORDS(iParam0, false)))
	{
		return 1;
	}
	return 0;
...
void func_393()//Position - 0x302C3
{
	switch (iLocal_69)
	{
		case 0:
			...
			func_533("ENTERING GO TO CELEBRITY ");
			if (iLocal_259 == 0)
			{
				func_33("N1D_TAKE", 7500, 5);
				iLocal_259 = 1;
		...
		case 1:
			...
			func_257();
			func_384();
			if (func_514(Local_293.f_0) && func_514(PLAYER::PLAYER_PED_ID()))
			{
				if (func_295(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 50f, 1) || iLocal_68 == 3)
				{
					iLocal_69 = 2;
				}
				else if (func_32())
				...
				{
					if (func_295(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 150f, 1))
					{
						iLocal_69 = 2;
					}
				}
...
void func_394(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x30424
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_466(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_235(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
			...
			{
				iVar6 = func_463(&(Global_100441.f_3));
				if (iVar6 > -1)
				{
...
void func_395(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3059D
{
	func_396(&Global_106934, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_396(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x305B9
{
	int iVar0;
	int iVar1;
	
	*uParam0 = func_253();
	uParam0->f_1 = func_452();
	MISC::GET_CURR_WEATHER_STATE(&(uParam0->f_6), &(uParam0->f_7), &(uParam0->f_8));
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		func_427(&(uParam0->f_2884), 0);
		func_426(PLAYER::PLAYER_PED_ID());
		func_419(PLAYER::PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_418())
		{
			func_414(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
int func_397(var uParam0)//Position - 0x31442
{
...
void func_398(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x31464
{
	int iVar0;
...
int func_399(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x314EC
{
...
int func_400(int iParam0)//Position - 0x3152C
{
	int iVar0;
...
void func_401(var uParam0, int iParam1, int iParam2)//Position - 0x3155A
{
...
int func_402(int iParam0)//Position - 0x31636
{
	int iVar0;
...
int func_403(int iParam0)//Position - 0x31678
{
	int iVar0;
...
int func_404(int iParam0, int iParam1, int iParam2)//Position - 0x316DB
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97772[iVar0]))
		{
			if (Global_97772[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || ENTITY::GET_ENTITY_MODEL(iParam0) == func_405(iParam1, iParam2))
					{
						return 1;
					}
				}
...
int func_405(int iParam0, int iParam1)//Position - 0x31769
{
	struct<82> Var0;
...
void func_406(int iParam0, var uParam1, int iParam2)//Position - 0x317AB
{
	int iVar0;
...
void func_407(int iParam0, var uParam1)//Position - 0x31A0C
{
	int iVar0;
...
int func_408(int iParam0)//Position - 0x31CB9
{
	switch (iParam0)
	{
		case 1:
...
int func_409(int iParam0, var uParam1, var uParam2)//Position - 0x31D69
{
	int iVar0;
	int iVar1;
...
int func_410(int iParam0)//Position - 0x31F5C
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_411(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x31F7C
{
	char* sVar0;
...
int func_412(int iParam0, int iParam1, bool bParam2)//Position - 0x320AE
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_413(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3211C
{
...
void func_414(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x321FC
{
	int iVar0;
	int iVar1;
...
int func_415(int iParam0, int iParam1)//Position - 0x3239C
{
	int iVar0;
	var uVar1;
	
	iVar0 = Global_2866852[iParam0 /*3*/][func_102(iParam1)];
...
void func_416(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x323C8
{
	int iVar0;
...
void func_417(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x32910
{
	int iVar0;
...
int func_418()//Position - 0x32B51
{
	func_185();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_419(int iParam0, bool bParam1)//Position - 0x32B6A
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = func_182(iParam0);
	if (func_186(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_420(iParam0, &(Global_113386.f_2363.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_420(int iParam0, var uParam1)//Position - 0x32C5D
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_425(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_422(Var7.f_1)) && iVar9 < 51)
			{
...
int func_421(int iParam0)//Position - 0x32EE5
{
	switch (iParam0)
	{
...
int func_422(int iParam0)//Position - 0x32F80
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_423(int iParam0, int iParam1)//Position - 0x33148
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_424(int iParam0, var* uParam1)//Position - 0x33CE9
{
	int iVar0;
	int iVar1;
...
int func_425(int iParam0)//Position - 0x33D24
{
	int iVar0;
...
void func_426(int iParam0)//Position - 0x33F98
{
	int iVar0;
...
void func_427(var uParam0, int iParam1)//Position - 0x33FD4
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_428(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x34526
{
	int iVar0;
	int iVar1;
...
bool func_429(int iParam0, var uParam1, var uParam2)//Position - 0x3456A
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
int func_430(var uParam0)//Position - 0x34CE9
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_451())
		{
			*uParam0 = func_435(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 6, -1, 0, 1, -1);
...
bool func_431(int iParam0)//Position - 0x34D44
{
	return func_432(iParam0, 0, 1);
}

int func_432(int iParam0, int iParam1, bool bParam2)//Position - 0x34D54
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_433(int iParam0)//Position - 0x34DB5
{
	switch (iParam0)
	{
		case 0:
...
int func_434(int iParam0)//Position - 0x35130
{
	return func_432(iParam0, 5, 1);
}

int func_435(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x35140
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 57)
	{
		if (iParam1 == 6 || iParam1 == func_450(iVar0))
		{
			if (!bParam3 || func_449(iVar0))
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_436(iVar0, 0), true);
...
Vector3 func_436(int iParam0, bool bParam1)//Position - 0x351E2
{
	switch (iParam0)
	{
		case -1:
		...
		case 45:
			return func_446(Global_102568);
			break;
		
		case 46:
			if (Global_1853185 != func_248())
			{
				if (func_445(Global_1853185))
				{
					return func_438(2, 2);
				}
				else if (func_437(Global_1853185))
				{
					return func_438(45, 3);
				}
				else
				{
...
int func_437(int iParam0)//Position - 0x35907
{
	if (iParam0 != func_248())
	{
...
Vector3 func_438(int iParam0, int iParam1)//Position - 0x3595F
{
	struct<3> Var0;
	struct<3> Var1;
	...
	if (Global_1853185 != func_248())
	{
		if (iParam1 == 3)
		{
			if (func_439(iParam0, 1, &Var0, 0, 0))
			{
				Var1 = { Var0 };
			}
		}
		else if (iParam1 == 2)
		{
			...
			{
				if (func_439(iParam0, 2, &Var0, 0, 0))
				{
					Var1 = { Var0 };
				}
			}
...
int func_439(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x35A09
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
	...
	if (!func_444(iParam3, &Var0))
	{
		return 0;
	}
	if (!func_444(iParam1, &Var1))
	{
		return 0;
	}
	if (!bParam4)
	{
		Var2 = { func_442(iParam0) };
	}
	else
	{
	...
	Var3 = { Var2 - Var0 };
	Var3 = { func_440(Var3, -Var0.f_3.f_2) };
	Var3 = { func_440(Var3, Var1.f_3.f_2) };
	*uParam2 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Var1, 0f, Var3) };
	uParam2->f_3 = { Var2.f_3 };
	return 1;
}

Vector3 func_440(struct<3> Param0, float fParam1)//Position - 0x35A9E
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_441(int iParam0)//Position - 0x35AE2
{
	struct<6> Var0;
...
struct<6> func_442(int iParam0)//Position - 0x35C66
{
	return func_443(iParam0);
}

struct<6> func_443(int iParam0)//Position - 0x35C74
{
	struct<6> Var0;
...
int func_444(int iParam0, var uParam1)//Position - 0x3673B
{
	switch (iParam0)
	{
		case 0:
...
int func_445(int iParam0)//Position - 0x367BD
{
	if (iParam0 != func_248())
	{
...
Vector3 func_446(int iParam0)//Position - 0x36815
{
	switch (iParam0)
	{
		case 1:
...
int func_447()//Position - 0x36A71
{
	return func_448(PLAYER::PLAYER_ID());
}

int func_448(int iParam0)//Position - 0x36A81
{
	return MISC::GET_BITS_IN_RANGE(Global_2689235[iParam0 /*453*/].f_318.f_3, 28, 31);
}

int func_449(int iParam0)//Position - 0x36A9E
{
	return func_432(iParam0, 0, 0);
}

int func_450(int iParam0)//Position - 0x36AAE
{
	switch (iParam0)
	{
		case -1:
...
bool func_451()//Position - 0x36DBD
{
	return Global_100493.f_375 > 0;
}

var func_452()//Position - 0x36DCE
{
	var uVar0;
	
	func_462(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_461(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_460(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_455(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_454(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_453(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}

void func_453(var uParam0, int iParam1)//Position - 0x36E14
{
	if (iParam1 <= 0)
	{
		return;
...
void func_454(var uParam0, int iParam1)//Position - 0x36E9A
{
...
void func_455(var uParam0, int iParam1)//Position - 0x36ECD
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_459(*uParam0);
	iVar1 = func_457(*uParam0);
	if (iParam1 < 1 || iParam1 > func_456(iVar0, iVar1))
	{
		return;
	}
...
int func_456(int iParam0, int iParam1)//Position - 0x36F1E
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_457(int iParam0)//Position - 0x36FC0
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_458(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_458(bool bParam0, int iParam1, int iParam2)//Position - 0x36FE2
{
	if (bParam0)
	{
		return iParam1;
...
int func_459(var uParam0)//Position - 0x36FF9
{
	return uParam0 & 15;
}

void func_460(var uParam0, int iParam1)//Position - 0x37006
{
...
void func_461(var uParam0, int iParam1)//Position - 0x37040
{
...
void func_462(var uParam0, int iParam1)//Position - 0x3707B
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_463(char* sParam0)//Position - 0x370B7
{
...
int func_464(int iParam0)//Position - 0x37111
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_465(Global_113386.f_9085.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_465(Global_113386.f_9085.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_465(Global_113386.f_9085.f_99.f_205[11]);
			break;
		
		case 90:
			return func_465(Global_113386.f_9085.f_99.f_205[7]);
			break;
		
		case 93:
			return func_465(Global_113386.f_9085.f_99.f_205[9]);
			break;
	}
	return 0;
}

int func_465(int iParam0)//Position - 0x371CD
{
	switch (iParam0)
	{
		case 1:
...
int func_466(char* sParam0, bool bParam1)//Position - 0x37221
{
	int iVar0;
	int iVar1;
	
	iVar0 = MISC::GET_HASH_KEY(sParam0);
	iVar1 = func_467(iVar0, 1);
	if (iVar1 == -1 && !bParam1)
	{
	}
	return iVar1;
...
int func_467(int iParam0, bool bParam1)//Position - 0x3724B
{
	int iVar0;
...
void func_468(bool bParam0)//Position - 0x37281
{
	int iVar0;
	int iVar1;
...
void func_469()//Position - 0x37503
{
	...
	{
		case 0:
			func_533("ENTERING GO TO GOLF CLUB ");
			if (iLocal_259 == 0)
			{
				func_33("N1D_TAKE", 7500, 5);
				iLocal_259 = 1;
			...
			{
				func_533("Glen was not alive when trying to create the blip in GO_TO_THE_GOLF_CLUB() init");
				func_473();
				iLocal_237 = func_271(Local_293.f_0, 1, 0, 5);
			}
			func_470(0);
			func_533("ENTERING GO TO GOLF CLUB LOOP ");
			if (func_513(0) && iLocal_71)
			{
				func_17(1, 1, 1);
			}
			MISC::SET_INSTANCE_PRIORITY_HINT(0);
		...
		case 1:
			if (iLocal_252 == 0)
			{
				func_533("Glen created in GO_TO_THE_GOLF_CLUB() SS_UPDATE");
				func_473();
			}
			else
			{
...
void func_470(int iParam0)//Position - 0x3761F
{
	if (iLocal_312 != 5 || iParam0 == 1)
	{
		...
		{
			iLocal_238 = func_471(-1377.18f, 55.39f, 53.7f, 0);
...
int func_471(struct<3> Param0, bool bParam1)//Position - 0x37668
{
	int iVar0;
	
	iVar0 = HUD::ADD_BLIP_FOR_COORD(Param0);
	HUD::SET_BLIP_SCALE(iVar0, func_472(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
	HUD::SET_BLIP_ROUTE(iVar0, bParam1);
	return iVar0;
}

float func_472(bool bParam0, float fParam1, float fParam2)//Position - 0x37694
{
	if (bParam0)
	{
		return fParam1;
...
void func_473()//Position - 0x376AB
{
	while (iLocal_252 == 0)
	{
		if (func_474(0))
		{
			...
			func_533("Celeb created!");
			iLocal_252 = 1;
		}
		else
		{
			func_533("Waiting for celeb assets...");
		}
		SYSTEM::WAIT(0);
	}
}
...
void func_475()//Position - 0x379B9
{
	...
	{
		case 0:
			func_533("ENTERING PHONE CALL 3 ");
			func_296(&uLocal_72, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			func_296(&uLocal_72, 3, 0, "NIGEL", 0, 1);
			func_296(&uLocal_72, 4, 0, "MRSTHORNHILL", 0, 1);
			if (iLocal_71 == 1)
...
void func_478()//Position - 0x37BD8
{
	...
	func_3(&Local_317);
	func_480(&(Local_328.f_1));
	func_480(&iLocal_323);
	func_480(&Local_332);
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		func_480(&(Local_331[iVar0 /*6*/]));
		iVar0++;
	}
	...
	func_479(2, uLocal_263);
}

void func_479(int iParam0, var uParam1)//Position - 0x37D3B
{
	if (!func_186(iParam0))
	{
		return;
...
void func_480(int* iParam0)//Position - 0x37D63
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_482(char* sParam0, bool bParam1)//Position - 0x37DBB
{
	func_483(sParam0);
	func_553(bParam1);
}

void func_483(char* sParam0)//Position - 0x37DCF
{
...
void func_484(int iParam0, bool bParam1)//Position - 0x37E0F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_485(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x37EAA
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78573 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_487(Global_78574, Global_78576, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
float func_486(char* sParam0)//Position - 0x3818F
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_487(int iParam0, int iParam1, int iParam2)//Position - 0x381A2
{
	struct<2> Var0;
	int iVar1;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_488(iVar1), 8);
					break;
			}
			break;
...
char* func_488(int iParam0)//Position - 0x38279
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_489(int iParam0)//Position - 0x383E1
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_490(int iParam0)//Position - 0x38416
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_491(int iParam0)//Position - 0x3844B
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_492(int iParam0)//Position - 0x38480
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_493(int iParam0)//Position - 0x384B5
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_494(int iParam0)//Position - 0x384F4
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_495(int iParam0)//Position - 0x38529
{
	struct<2> Var0;
...
int func_496(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x38596
{
	if (((!func_498(0) || Global_78588) || Global_78577 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78573)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_354(0)) || func_497(1))
			{
			}
			else
			{
...
bool func_497(bool bParam0)//Position - 0x386AF
{
	if (bParam0)
	{
...
int func_498(int iParam0)//Position - 0x386D8
{
	if (Global_43052 == 15)
	{
		return 0;
...
bool func_499(int iParam0)//Position - 0x386FA
{
	return func_500(iParam0, Global_43052);
}

int func_500(int iParam0, int iParam1)//Position - 0x3870B
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_501(int iParam0, int iParam1)//Position - 0x388EC
{
	...
	if (iLocal_70 == 3)
	{
		func_533("We are trying to skip to Get The Club...");
	}
	else if (iLocal_70 == 1)
	{
		func_533("We are trying to skip to Go to Golf Club...");
	}
	iLocal_71 = 0;
	func_1(iLocal_70);
}
...
void func_505(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x38B1F
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_506(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
Vector3 func_506(int iParam0)//Position - 0x38CDD
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_507(bool bParam0)//Position - 0x38CF0
{
	int iVar0;
...
void func_508(bool bParam0, int iParam1, int iParam2)//Position - 0x38D2F
{
	bool bVar0;
...
void func_509(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x38D8E
{
	if (func_541())
	{
...
void func_510(char* sParam0, int iParam1)//Position - 0x38E23
{
	sParam0 = sParam0;
	iParam1 = iParam1;
}

int func_511()//Position - 0x38E33
{
...
int func_512(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)//Position - 0x38E5D
{
	bool bVar0;
	float fVar1;
...
int func_513(bool bParam0)//Position - 0x38EB9
{
...
int func_514(int iParam0)//Position - 0x38EE1
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_515()//Position - 0x38F02
{
	...
	iLocal_324 = PED::ADD_SCENARIO_BLOCKING_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, false, true, true, true);
	...
	func_519(&uLocal_333);
	func_518(&uLocal_333, -1313.714f, -27.2202f, 48.0314f);
	func_518(&uLocal_333, -1294.066f, -27.0136f, 47.5724f);
	func_518(&uLocal_333, -1069.844f, -143.769f, 39.7493f);
	func_518(&uLocal_333, -925.2529f, -89.9079f, 38.3457f);
	func_518(&uLocal_333, -1010.948f, 40.0643f, 49.9277f);
	func_518(&uLocal_333, -1122.838f, 233.7037f, 64.7587f);
	func_518(&uLocal_333, -1282.578f, 188.8798f, 59.2769f);
	func_518(&uLocal_333, -1328.153f, 192.0178f, 57.8136f);
	func_518(&uLocal_333, -1386.75f, 167.32f, 57.11f);
	func_518(&uLocal_333, -1411.5f, 109.64f, 51.49f);
	func_518(&uLocal_333, -1399.63f, -10.83f, 51.93f);
	func_518(&uLocal_333, -1359.54f, 18.93f, 52.52f);
	func_518(&uLocal_333, -1342.27f, 16.92f, 52.16f);
	func_517(&uLocal_333);
	func_516(&uLocal_385, &uLocal_333, 100f);
	func_519(&uLocal_437);
	func_518(&uLocal_437, -1100.2f, 77.1233f, 53.2703f);
	func_518(&uLocal_437, -1040.69f, 97.3963f, 51.9067f);
	func_518(&uLocal_437, -977.9333f, -5.5166f, 45.6548f);
	func_518(&uLocal_437, -1039.687f, -35.872f, 45.4867f);
	func_518(&uLocal_437, -1062.19f, -2.8635f, 49.6013f);
	func_517(&uLocal_437);
	iLocal_71 = 1;
}

void func_516(var uParam0, var uParam1, float fParam2)//Position - 0x3933A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_517(var uParam0)//Position - 0x39447
{
	int iVar0;
	float fVar1;
...
void func_518(var uParam0, struct<3> Param1)//Position - 0x394E7
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_519(var uParam0)//Position - 0x39518
{
	if (uParam0->f_51)
	{
	}
...
void func_520(int iParam0)//Position - 0x3953F
{
	if (func_523())
	{
		return;
...
void func_521(bool bParam0, bool bParam1)//Position - 0x395C9
{
	if (bParam0)
	{
		if (func_354(0))
...
bool func_522()//Position - 0x3963D
{
	return BitTest(Global_1958711, 5);
}

bool func_523()//Position - 0x3964B
{
	return BitTest(Global_1958711, 19);
}

void func_524(int iParam0, int iParam1, bool bParam2)//Position - 0x3965A
{
	int iVar0;
	...
	if (Global_117[iParam0 /*10*/].f_8 != 166)
	{
		...
		if (iParam1 == 4)
		{
			func_530(iParam0, 0, 1);
			func_530(iParam0, 1, 1);
			func_530(iParam0, 2, 1);
			func_529(iParam0, 0, 1);
			func_529(iParam0, 1, 1);
			func_529(iParam0, 2, 1);
		}
		else
		{
			if (func_528(iParam0, iParam1) == 1 && func_527(iParam0, iParam1) == 1)
			{
				bParam2 = false;
			}
			iVar0 = iParam1;
			func_530(iParam0, iVar0, 1);
			func_529(iParam0, iVar0, 1);
		...
		if (bParam2)
		{
			if (!Global_78319)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8795[iParam1 /*4*/] = { func_526(iParam0) };
					...
					{
						Global_8746[1 /*6*/] = { func_526(iParam0) };
...
void func_525()//Position - 0x397D2
{
	char cVar0[64];
	char cVar1[64];
	char* sVar2;
...
struct<4> func_526(int iParam0)//Position - 0x39851
{
	return Global_1998[iParam0 /*29*/].f_3;
}

int func_527(int iParam0, int iParam1)//Position - 0x39864
{
...
int func_528(int iParam0, int iParam1)//Position - 0x3988E
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_529(int iParam0, int iParam1, int iParam2)//Position - 0x398B8
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_530(int iParam0, int iParam1, int iParam2)//Position - 0x398FD
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
int func_531(int iParam0)//Position - 0x39942
{
	if (!func_186(iParam0))
	{
		return 0;
...
void func_533(char* sParam0)//Position - 0x3A18A
{
	sParam0 = sParam0;
}

void func_534(var uParam0, bool bParam1, bool bParam2)//Position - 0x3A196
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_514(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_514(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_514(uParam0->f_41[iVar0]))
		{
...
int func_535(var uParam0, var uParam1)//Position - 0x3A28B
{
	...
	switch (iLocal_49)
	{
		case 0:
			...
			func_519(uParam1);
			func_518(uParam1, -1313.714f, -27.2202f, 48.0314f);
			func_518(uParam1, -1294.066f, -27.0136f, 47.5724f);
			func_518(uParam1, -1069.844f, -143.769f, 39.7493f);
			func_518(uParam1, -925.2529f, -89.9079f, 38.3457f);
			func_518(uParam1, -1010.948f, 40.0643f, 49.9277f);
			func_518(uParam1, -1122.838f, 233.7037f, 64.7587f);
			func_518(uParam1, -1282.578f, 188.8798f, 59.2769f);
			func_518(uParam1, -1328.153f, 192.0178f, 57.8136f);
			func_518(uParam1, -1386.75f, 167.32f, 57.11f);
			func_518(uParam1, -1411.5f, 109.64f, 51.49f);
			func_518(uParam1, -1379.52f, 111.05f, 54.28f);
			func_518(uParam1, -1371.77f, 24.07f, 52.88f);
			func_518(uParam1, -1342.27f, 16.92f, 52.16f);
			func_517(uParam1);
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
		...
		case 1:
			if ((!func_540(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar1))
			{
				return 0;
			}
			iLocal_49 = 2;
...
void func_536(int iParam0, bool bParam1)//Position - 0x3A87E
{
	switch (iParam0)
	{
		...
		case 38:
			if (bParam1)
			{
				iLocal_65 = PED::ADD_SCENARIO_BLOCKING_AREA(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, false, true, true, true);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_GUARD_STAND", false);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_CLIPBOARD", false);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", false);
		...
		case 39:
			if (bParam1)
			{
				iLocal_65 = PED::ADD_SCENARIO_BLOCKING_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, false, true, true, true);
				PED::SET_PED_NON_CREATION_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f);
		...
		case 41:
			if (bParam1)
			{
				iLocal_65 = PED::ADD_SCENARIO_BLOCKING_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, false, true, true, true);
		...
		case 42:
			if (bParam1)
			{
				iLocal_65 = PED::ADD_SCENARIO_BLOCKING_AREA(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, false, true, true, true);
...
void func_537(bool bParam0)//Position - 0x3AC9D
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
void func_542(int iParam0)//Position - 0x3ADDB
{
	...
	MISC::SET_INSTANCE_PRIORITY_HINT(0);
	func_543(&Local_66, 0, 0, 0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_543(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x3AF78
{
	func_548(uParam0, iParam1);
	func_546(uParam0, bParam2);
	func_544(uParam0, bParam3);
}

void func_544(var uParam0, bool bParam1)//Position - 0x3AF98
{
	func_545(&(uParam0->f_41), bParam1);
}

void func_545(var uParam0, bool bParam1)//Position - 0x3AFAA
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		if (bParam1)
		{
			func_480(uParam0[iVar0]);
		}
		else
		{
			func_550(uParam0[iVar0], 0);
		}
		iVar0++;
	}
}

void func_546(var uParam0, bool bParam1)//Position - 0x3AFE8
{
	func_547(&(uParam0->f_35), bParam1);
}

void func_547(var uParam0, bool bParam1)//Position - 0x3AFFA
{
	int iVar0;
...
void func_548(var uParam0, int iParam1)//Position - 0x3B037
{
	func_549(&(uParam0->f_28), iParam1);
}

void func_549(var uParam0, int iParam1)//Position - 0x3B049
{
	int iVar0;
...
void func_550(int* iParam0, bool bParam1)//Position - 0x3B08A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_551()//Position - 0x3B0C5
{
	int iVar0;
...
void func_553(bool bParam0)//Position - 0x3B190
{
	int iVar0;
	...
	if (!func_567())
	{
		...
		{
			func_191(iVar0, 1, 0);
			func_554(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_112473[iVar0 /*10*/].f_9 == -1)
...
void func_554(char* sParam0, int iParam1)//Position - 0x3B260
{
	if (Global_100441 != 12)
	{
...
int func_555(char* sParam0, int iParam1, int iParam2)//Position - 0x3B288
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
	...
	if (func_558())
	{
		...
		{
			iVar2 = func_463(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_556()//Position - 0x3B417
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_466(&(Global_100441.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_558()//Position - 0x3B48B
{
	...
	{
		if (func_463(&(Global_100441.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_559(bool bParam0)//Position - 0x3B4F7
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_560(int iParam0)//Position - 0x3B50B
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_561(int iParam0)//Position - 0x3B545
{
	if (iParam0 == 1)
	{
...
void func_562()//Position - 0x3B57F
{
	Global_23011.f_5 = 1;
}

void func_563()//Position - 0x3B58D
{
	Global_23011.f_5 = 0;
}

void func_564(bool bParam0)//Position - 0x3B59B
{
	if (bParam0)
	{
		func_565();
...
void func_565()//Position - 0x3B5FE
{
...
void func_566()//Position - 0x3B627
{
	Global_94617 = 0;
	Global_94618 = 0;
}

int func_567()//Position - 0x3B639
{
...
void func_568()//Position - 0x3B677
{
	Global_100476 = 1;
...
void func_569(char* sParam0)//Position - 0x3B76C
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_570()//Position - 0x3B77E
{
	int iVar0;
...
void func_571(var uParam0)//Position - 0x3B79E
{
	func_572(&(uParam0->f_28));
	func_572(&(uParam0->f_35));
	func_572(&(uParam0->f_41));
}

void func_572(var uParam0)//Position - 0x3B7BE
{
	int iVar0;
...
int func_573(int iParam0)//Position - 0x3B7F8
{
	if (!func_186(iParam0))
	{
		return func_239(iParam0);
