...
void __EntryFunction__()//Position - 0x0
{
	...
	Local_57 = { -683.8261f, 5840.81f, 16.566f };
	iLocal_59 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112473[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_274(&(Global_112473[Var0.f_0 /*10*/].f_9));
			}
		}
		func_262(&Var0, 1);
	}
	if (!func_259(&iVar2, &Var0, Var1, 1f))
	{
		func_258();
	...
	while (true)
	{
		...
		func_198(Var0.f_0);
		func_191(&iLocal_59, &(Var0.f_9), Var1);
		if (Var0.f_0 == 25)
		{
			func_186(&Var0, Var1, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
		}
		...
		if (func_171(&Var0, 0) && MISC::ABSF((Var1.f_2 - Var3.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_262(&Var0, 1);
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x3931
{
	int iVar0;
	var uVar1;
...
int func_50(var uParam0)//Position - 0x396E
{
	int iVar0;
	int iVar1;
...
int func_51()//Position - 0x39A2
{
	return Global_1574918;
}

int func_52(int iParam0, int iParam1)//Position - 0x39AE
{
	int iVar0;
	var uVar1;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39DA
{
	int iVar0;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F22
{
	int iVar0;
...
int func_55()//Position - 0x4164
{
	func_56();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_56()//Position - 0x417D
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x427A
{
	return Global_43052 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x4288
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x437B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x4603
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x469E
{
...
int func_62(int iParam0, int iParam1)//Position - 0x4866
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x5407
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x5442
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x56B6
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x56F2
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5C41
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5C85
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x6404
{
	if (bParam2)
	{
...
int func_70(var uParam0)//Position - 0x644B
{
...
bool func_71(int iParam0)//Position - 0x64A6
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x64B6
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x6517
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x6892
{
	return Global_31959;
}

int func_75(int iParam0)//Position - 0x689D
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x68AD
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x694F
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x7074
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x70CC
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7176
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
...
Vector3 func_81(struct<3> Param0, float fParam1)//Position - 0x720B
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_82(int iParam0)//Position - 0x724F
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x73D3
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x73E1
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7EA8
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7F2A
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x7F82
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x7F8B
{
	switch (iParam0)
	{
		case 1:
...
int func_130(int iParam0)//Position - 0xA872
{
	switch (iParam0)
	{
		case 5:
...
int func_132(int iParam0)//Position - 0xA942
{
	switch (iParam0)
	{
		case 5:
...
void func_133(var uParam0, bool bParam1, bool bParam2)//Position - 0xA995
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xAA8A
{
	switch (iParam0)
	{
		case 5:
...
void func_135(bool bParam0)//Position - 0xAAF5
{
	int iVar0;
...
void func_136(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAB34
{
	if (bParam0)
	{
...
bool func_137()//Position - 0xAC77
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_138(int iParam0, int iParam1)//Position - 0xAC91
{
	bool bVar0;
...
int func_139(int iParam0, bool bParam1)//Position - 0xACDC
{
	int iVar0;
	int iVar1;
...
int func_140(int iParam0)//Position - 0xAD1D
{
...
bool func_141()//Position - 0xAD5C
{
	return BitTest(Global_2621446, 3);
}

int func_142(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xAD6A
{
	int iVar0;
...
void func_144(int iParam0)//Position - 0xADC4
{
	if (iParam0 == 1)
	{
...
int func_145(char* sParam0)//Position - 0xADE7
{
...
void func_146()//Position - 0xAE24
{
	Global_20471 = 0;
	func_147();
}

void func_147()//Position - 0xAE34
{
...
int func_151(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAF1A
{
...
void func_152(int iParam0)//Position - 0xB0B2
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_155(int iParam0)//Position - 0xB162
{
	if (func_159())
	{
		return;
...
void func_156(bool bParam0, bool bParam1)//Position - 0xB1EC
{
	if (bParam0)
	{
		if (func_158(0))
...
bool func_157()//Position - 0xB260
{
	return BitTest(Global_1958711, 5);
}

int func_158(int iParam0)//Position - 0xB26E
{
	if (iParam0 == 1)
	{
...
bool func_159()//Position - 0xB2C5
{
	return BitTest(Global_1958711, 19);
}

int func_160(int iParam0)//Position - 0xB2D4
{
...
int func_161(int iParam0)//Position - 0xB315
{
	int iVar0;
...
void func_162(int iParam0)//Position - 0xB35A
{
...
int func_163(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB38C
{
	int iVar0;
...
void func_164(var uParam0, int iParam1)//Position - 0xB4C3
{
	int iVar0;
...
bool func_165(int iParam0)//Position - 0xB512
{
	return func_166(iParam0, Global_43052);
}

int func_166(int iParam0, int iParam1)//Position - 0xB523
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_167(int iParam0)//Position - 0xB704
{
	if (Global_43052 == 15)
	{
		return 0;
...
int func_168()//Position - 0xB726
{
	return func_169(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_169(char* sParam0, int iParam1)//Position - 0xB737
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_171(int iParam0, int iParam1)//Position - 0xB7A4
{
	switch (iParam0->f_16)
	{
		case 0:
...
void func_172()//Position - 0xBF87
{
	func_27(&(Global_103950.f_2890), &Global_103950, 0, 1, 1, 0);
}

int func_173(var uParam0)//Position - 0xBFA2
{
	float fVar0;
...
void func_174(int iParam0, int iParam1)//Position - 0xC031
{
	if (iParam0 == 1)
	{
		if (!func_132(iParam1))
...
int func_175(bool bParam0)//Position - 0xC095
{
	int iVar0;
...
int func_176(int iParam0)//Position - 0xC12C
{
	if (func_129(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_177(int iParam0)//Position - 0xC156
{
	bool bVar0;
...
var func_178()//Position - 0xC873
{
	return Global_100480.f_1;
}

int func_179()//Position - 0xC881
{
	if (Global_97363 != -1)
	{
...
bool func_182()//Position - 0xC8E8
{
	return Global_100493.f_376 > 0;
}

var func_183(int iParam0, int iParam1)//Position - 0xC8F9
{
	switch (iParam0)
	{
		case 5:
...
var func_184()//Position - 0xC931
{
	return Global_1575058;
}

int func_185()//Position - 0xC93D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_186(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xC959
{
	var uVar0;
	
	if ((((func_129(PLAYER::PLAYER_PED_ID()) && func_129(iParam0->f_28[0])) && !func_148()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_190(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_189(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
...
void func_187(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC9E1
{
...
void func_188(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCA1C
{
...
void func_189(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCA72
{
...
float func_190(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xCB0D
{
	struct<3> Var0;
...
void func_191(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xCB47
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_192(int iParam0, bool bParam1)//Position - 0xCC38
{
	if (iParam0 == -1)
	{
		return;
...
int func_193(int iParam0)//Position - 0xCC74
{
	if (Global_78315 == iParam0)
	{
		if (Global_78316 == -1)
...
void func_194(int iParam0, int iParam1)//Position - 0xCCAD
{
	bool bVar0;
	int iVar1;
...
bool func_195()//Position - 0xCD4B
{
	return Global_97750;
}

void func_196(int iParam0)//Position - 0xCD57
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_197(iParam0);
...
void func_197(int iParam0)//Position - 0xCD6E
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_198(int iParam0)//Position - 0xCE56
{
	if (iParam0 == -1)
	{
		iParam0 = func_168();
...
int func_199(int iParam0, bool bParam1)//Position - 0xCE7E
{
	struct<27> Var0;
	...
	func_112(*iParam0, &Var0);
	if ((func_236(*iParam0) || func_234(*iParam0)) || Global_78564 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_203(&(iParam0->f_48)) && bParam1)
	{
		func_200(iParam0->f_28[0], &(iParam0->f_48), *iParam0);
	}
	return 1;
}

void func_200(int iParam0, var uParam1, int iParam2)//Position - 0xD0EE
{
	int iVar0;
	int iVar1;
...
int func_201(int iParam0)//Position - 0xD446
{
...
int func_202(var uParam0)//Position - 0xD466
{
...
int func_203(var uParam0)//Position - 0xD47E
{
...
void func_204(var uParam0)//Position - 0xD4A3
{
	int iVar0;
	int iVar1;
...
void func_205(int* iParam0)//Position - 0xD7A7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_206(var uParam0)//Position - 0xD7D2
{
	int iVar0;
...
int func_207(var uParam0, bool bParam1, bool bParam2)//Position - 0xD852
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_208(int iParam0, int iParam1)//Position - 0xDA10
{
	int iVar0;
...
int func_209(var uParam0, bool bParam1, int iParam2)//Position - 0xDA40
{
	int iVar0;
	int iVar1;
...
int func_210(int iParam0)//Position - 0xDCFC
{
...
int func_211(int iParam0, float fParam1)//Position - 0xDD30
{
	float fVar0;
...
bool func_212(int iParam0, float fParam1)//Position - 0xDDA6
{
	return func_213(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_213(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDDBE
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_214(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_214(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xDE7F
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_215(int iParam0, int iParam1)//Position - 0xDFAB
{
	int iVar0;
...
int func_217(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE0BA
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
float func_218(struct<3> Param0, struct<3> Param1)//Position - 0xE14B
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_219(struct<3> Param0)//Position - 0xE16C
{
	float fVar0;
	float fVar1;
...
void func_220(var uParam0)//Position - 0xE1AB
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_221(int iParam0, int iParam1)//Position - 0xE1C6
{
	int iVar0;
...
int func_222(int iParam0)//Position - 0xE205
{
...
int func_223(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE22D
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_224(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE328
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_225(int iParam0, float fParam1)//Position - 0xE434
{
	var uVar0;
	struct<3> Var1;
...
int func_226(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xE4C9
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_227(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE557
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_228(int iParam0)//Position - 0xE59F
{
...
void func_229(int iParam0)//Position - 0xE5E9
{
	int iVar0;
...
int func_230(int iParam0)//Position - 0xE686
{
	if (iParam0 == -1)
	{
		iParam0 = func_168();
...
int func_231(int iParam0)//Position - 0xE71B
{
...
int func_234(int iParam0)//Position - 0xE79A
{
	if ((func_235() && Global_100441.f_11 == 6) && iParam0 == func_169(&(Global_100441.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_236(int iParam0)//Position - 0xE80C
{
	if (func_110(0))
	{
...
int func_238(var uParam0)//Position - 0xE87B
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_245(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmhunting2"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				if (func_242(&(uParam0->f_28[0]), 54, -683.3276f, 5841.042f, 17.217f, 8.33f, "RC HUNTER 2", 1))
				{
			...
			{
				func_239(&(uParam0->f_35[0]), -685.2281f, 5833.982f, 16.331f, 313.2204f, 0);
			}
...
{
	func_240(iParam0, iLocal_53, Param1, fParam2);
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_240(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xEB16
{
	func_241(iParam0);
...
void func_241(int* iParam0)//Position - 0xEB58
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_242(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xEBF4
{
	if (func_243(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_243(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xEC50
{
	int iVar0;
...
int func_244(var uParam0, int iParam1)//Position - 0xECDE
{
	int iVar0;
...
int func_245(int iParam0)//Position - 0xED24
{
	int iVar0;
...
int func_246(var uParam0)//Position - 0xED55
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_248(&(uParam0->f_48), "special_ped@cletus@base", "cletus_base", 0);
			STREAMING::REQUEST_ANIM_DICT("special_ped@cletus@base");
			iLocal_51 = 1;
			break;
		
		case 1:
			if ((!func_245(&iVar0) || !func_247(&(uParam0->f_48))) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_242(&(uParam0->f_28[0]), 54, 1804.33f, 3931.33f, 33.83f, 91.63f, "RC HUNTER 1", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_239(&(uParam0->f_35[0]), 1806.732f, 3934.353f, 33.3275f, 76.1155f, 0);
...
int func_247(var uParam0)//Position - 0xF00B
{
	if (func_203(uParam0))
	{
...
void func_248(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xF035
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_249(int iParam0)//Position - 0xF071
{
	struct<27> Var0;
	bool bVar1;
...
bool func_253(int iParam0, char* sParam1)//Position - 0xF2C1
{
...
int func_254(int iParam0)//Position - 0xF3A3
{
...
int func_255(int iParam0)//Position - 0xF3CE
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_256(int iParam0)//Position - 0xF3F9
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_257(int iParam0)//Position - 0xF424
{
	if (func_231(iParam0))
	{
		return 0;
...
void func_258()//Position - 0xF459
{
	func_275("Running end routines.");
	Global_113104 = (Global_113104 - 1);
}

int func_259(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xF473
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_260((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_260((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_260(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xF4D8
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_261(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_261(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0xF550
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_263(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xF618
{
	func_270(uParam0, iParam1);
	func_267(uParam0, bParam2);
	func_264(uParam0, bParam3);
}

void func_264(var uParam0, bool bParam1)//Position - 0xF638
{
	func_265(&(uParam0->f_41), bParam1);
}

void func_265(var uParam0, bool bParam1)//Position - 0xF64A
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_266(uParam0[iVar0], 0);
		}
		iVar0++;
	}
}

void func_266(int* iParam0, bool bParam1)//Position - 0xF688
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_267(var uParam0, bool bParam1)//Position - 0xF6C3
{
	func_268(&(uParam0->f_35), bParam1);
}

void func_268(var uParam0, bool bParam1)//Position - 0xF6D5
{
	int iVar0;
...
void func_269(int* iParam0)//Position - 0xF712
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_270(var uParam0, int iParam1)//Position - 0xF74A
{
	func_271(&(uParam0->f_28), iParam1);
}

void func_271(var uParam0, int iParam1)//Position - 0xF75C
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_272(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_272(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF79D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_273(int* iParam0)//Position - 0xF7ED
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_274(var uParam0)//Position - 0xF82E
{
	if (*uParam0 == -1)
	{
		return;
...
void func_275(char* sParam0)//Position - 0xF86B
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_276(var uParam0)//Position - 0xF87D
{
	*uParam0 = -1;
...
void func_277()//Position - 0xF8B0
{
	func_275("Running start routines.");
	Global_113104++;
}

int func_278(int iParam0)//Position - 0xF8CA
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
