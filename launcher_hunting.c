...
void __EntryFunction__()//Position - 0x0
{
	...
	uLocal_90 = func_287(54);
	iLocal_91 = joaat("dune");
	iLocal_92 = WEAPON::GET_WEAPONTYPE_MODEL(joaat("WEAPON_SNIPERRIFLE"));
	iLocal_93 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(joaat("COMPONENT_AT_SCOPE_LARGE"));
	iLocal_94 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(joaat("COMPONENT_AT_AR_SUPP_02"));
	Local_95 = { -683.8261f, 5840.8096f, 16.566f };
	iLocal_99 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113457[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_283(&(Global_113457[Var0.f_0 /*10*/].f_9));
			}
		}
		func_271(&Var0, 1);
	}
	if (!func_268(&iVar64, &Var0, Var61, 1f))
	{
		func_267();
	...
	while (true)
	{
		...
		func_207(Var0.f_0);
		func_200(&iLocal_99, &(Var0.f_9), Var61);
		if (Var0.f_0 == 25)
		{
			func_195(&Var0, Var61, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
		}
		...
		if (func_180(&Var0, 0) && MISC::ABSF((Var61.f_2 - Var67.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_271(&Var0, 1);
...
void func_17(int iParam0)//Position - 0xC6F
{
...
void func_21(char* sParam0)//Position - 0xD28
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xD3B
{
	MISC::CLEAR_BIT(&(Global_101392.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xD58
{
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2964
{
...
int func_29(int iParam0)//Position - 0x29A4
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x29D2
{
...
int func_31(int iParam0)//Position - 0x2AAE
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2AF0
{
	int iVar0;
...
int func_33(int iParam0, bool bParam1, int iParam2)//Position - 0x2B53
{
	int iVar0;
...
int func_34(bool bParam0, int iParam1)//Position - 0x2BE1
{
	struct<82> Var0;
...
void func_35(bool bParam0, var uParam1, int iParam2)//Position - 0x2C23
{
	int iVar0;
...
bool func_36(bool bParam0)//Position - 0x2E7F
{
	return bParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E8B
{
	int iVar0;
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x31E6
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x33D9
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x34AA
{
	char* sVar0;
...
int func_43(int iParam0, bool bParam1, bool bParam2)//Position - 0x35D9
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3647
{
...
int func_45(int iParam0)//Position - 0x3720
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x375D
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x3782
{
...
int func_50(int iParam0, var uParam1)//Position - 0x395A
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(uParam1));
}

int func_51(var uParam0)//Position - 0x396F
{
	int iVar0;
	int iVar1;
...
int func_53(int iParam0, int iParam1)//Position - 0x39AF
{
	int iVar0;
	var uVar1;
...
int func_54(int iParam0, var uParam1)//Position - 0x39D3
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(uParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39E8
{
	int iVar0;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F31
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x4613
{
	switch (iParam0)
	{
...
int func_63(int iParam0)//Position - 0x46B4
{
...
int func_64(int iParam0, int iParam1)//Position - 0x48A0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x55C1
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x55FC
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x5870
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x58AC
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5DFB
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5E3F
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x65BE
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x6605
{
...
bool func_73(int iParam0)//Position - 0x6660
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x6670
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x66D0
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x6A78
{
	return Global_32828;
}

int func_77(int iParam0)//Position - 0x6A83
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A93
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6B35
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x72A0
{
...
int func_81()//Position - 0x759B
{
	return Global_2652572.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x75AA
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x75D4
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x75E9
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x7600
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x7658
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7702
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x7797
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x77DB
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x795F
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x796D
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x8439
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x84BB
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x8513
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x851C
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x8788
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x8798
{
	return MISC::GET_BITS_IN_RANGE(Global_2657921[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x87B5
{
	return func_74(iParam0, 0, 0);
}

int func_99(int iParam0)//Position - 0x87C5
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x8AFB
{
	return Global_101444.f_393 > 0;
}

var func_101()//Position - 0x8B0C
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8B52
{
	if (iParam1 <= 0)
	{
		return;
...
void func_103(var uParam0, int iParam1)//Position - 0x8BD8
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8C0B
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8C5C
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8CFE
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8D20
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8D37
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8D44
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8D7E
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8DB9
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8DF5
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8E0E
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8E67
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8E7D
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8E93
{
...
int func_117(bool bParam0)//Position - 0x8ED5
{
...
struct<2> func_118(int iParam0)//Position - 0x8EFD
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x934A
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA622
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0)//Position - 0xA968
{
	int iVar0;
...
void func_123(int iParam0)//Position - 0xAA0D
{
	struct<2> Var0;
...
void func_126(int iParam0)//Position - 0xAB06
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xAB5F
{
...
int func_128(int iParam0)//Position - 0xABE2
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAC13
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAC28
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xACDB
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xACF6
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xAD42
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xAD8B
{
	if (func_136(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xADAB
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_137(int iParam0)//Position - 0xADCC
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xAE9C
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xAEEF
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xAFE4
{
	switch (iParam0)
	{
		case 5:
...
void func_142(bool bParam0)//Position - 0xB04F
{
	int iVar0;
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB08E
{
	if (bParam0)
	{
...
bool func_144()//Position - 0xB1DB
{
	return BitTest(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

bool func_145(int iParam0, int iParam1)//Position - 0xB1F5
{
	bool bVar0;
...
int func_146(int iParam0, bool bParam1)//Position - 0xB24E
{
	int iVar0;
	int iVar1;
...
int func_147(var uParam0)//Position - 0xB28F
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB2B1
{
...
bool func_149()//Position - 0xB2F0
{
	return BitTest(Global_2621446, 3);
}

int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB2FE
{
	int iVar0;
...
void func_152(int iParam0)//Position - 0xB358
{
	if (iParam0 == 1)
	{
...
int func_153(char* sParam0)//Position - 0xB37B
{
...
void func_154()//Position - 0xB3B8
{
	Global_21032 = 0;
	func_155();
}

void func_155()//Position - 0xB3C8
{
...
int func_159(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB4AE
{
...
void func_160(int iParam0)//Position - 0xB505
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_161(bool bParam0, bool bParam1)//Position - 0xB531
{
...
void func_163(int iParam0)//Position - 0xB6D3
{
	if (func_168())
	{
		return;
...
void func_164(int iParam0)//Position - 0xB706
{
	if (func_168())
	{
		return;
...
void func_165(bool bParam0, bool bParam1)//Position - 0xB790
{
	if (bParam0)
	{
		if (func_167(0))
...
bool func_166()//Position - 0xB804
{
	return BitTest(Global_1956030, 5);
}

int func_167(int iParam0)//Position - 0xB812
{
	if (iParam0 == 1)
	{
...
int func_169(int iParam0)//Position - 0xB878
{
...
int func_170(int iParam0)//Position - 0xB8B9
{
	int iVar0;
...
void func_171(int iParam0)//Position - 0xB8FE
{
...
int func_172(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB930
{
	int iVar0;
...
void func_173(var uParam0, int iParam1)//Position - 0xBA67
{
	int iVar0;
...
bool func_174(int iParam0)//Position - 0xBAB6
{
	return func_175(iParam0, Global_43922);
}

int func_175(int iParam0, int iParam1)//Position - 0xBAC7
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_176(int iParam0)//Position - 0xBCA8
{
	if (Global_43922 == 15)
	{
		return 0;
...
int func_177()//Position - 0xBCCA
{
	return func_178(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_178(char* sParam0, int iParam1)//Position - 0xBCDB
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_180(int iParam0, int iParam1)//Position - 0xBD48
{
	switch (iParam0->f_16)
	{
		case 0:
...
void func_181()//Position - 0xC52C
{
	func_27(&(Global_104933.f_2890), &Global_104933, 0, 1, 1, 0);
}

int func_182(var uParam0)//Position - 0xC547
{
	float fVar0;
...
void func_183(int iParam0, int iParam1)//Position - 0xC5D5
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_184(bool bParam0)//Position - 0xC639
{
	int iVar0;
...
int func_185(int iParam0)//Position - 0xC6D0
{
	if (func_136(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_186(int iParam0)//Position - 0xC6FA
{
	bool bVar0;
...
var func_187()//Position - 0xCE17
{
	return Global_101431.f_1;
}

int func_188()//Position - 0xCE25
{
	if (Global_98294 != -1)
	{
...
bool func_191()//Position - 0xCE8C
{
	return Global_101444.f_394 > 0;
}

var func_192(int iParam0, int iParam1)//Position - 0xCE9D
{
	switch (iParam0)
	{
		case 5:
...
var func_193()//Position - 0xCED5
{
	return Global_1575079;
}

int func_194()//Position - 0xCEE1
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_195(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xCEFD
{
	var uVar0;
	
	if ((((func_136(PLAYER::PLAYER_PED_ID()) && func_136(iParam0->f_28[0])) && !func_156()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_199(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_198(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
		func_196(&uVar0, cParam4, sParam5, 7, 0, 0);
...
void func_196(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCF85
{
...
void func_197(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCFC0
{
...
void func_198(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD016
{
...
float func_199(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD0B1
{
	struct<3> Var0;
...
void func_200(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD0EB
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_199(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_203(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_199(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_205(iParam0);
				}
			}
...
void func_201(int iParam0, bool bParam1)//Position - 0xD1DC
{
	if (iParam0 == -1)
	{
		return;
...
int func_202(int iParam0)//Position - 0xD218
{
	if (Global_79244 == iParam0)
	{
		if (Global_79245 == -1)
...
void func_203(int iParam0, int iParam1)//Position - 0xD251
{
	bool bVar0;
	int iVar1;
...
bool func_204()//Position - 0xD2EF
{
	return Global_98681;
}

void func_205(int iParam0)//Position - 0xD2FB
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_206(iParam0);
...
void func_206(int iParam0)//Position - 0xD312
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_207(int iParam0)//Position - 0xD3FA
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_208(int iParam0, bool bParam1)//Position - 0xD422
{
	struct<27> Var0;
	...
	func_119(*iParam0, &Var0);
	if ((func_245(*iParam0) || func_243(*iParam0)) || Global_79494 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_209(int iParam0, var uParam1, int iParam2)//Position - 0xD692
{
	int iVar0;
	int iVar1;
...
int func_210(int iParam0)//Position - 0xD9EA
{
...
int func_211(var uParam0)//Position - 0xDA0A
{
...
int func_212(var uParam0)//Position - 0xDA22
{
...
void func_213(var uParam0)//Position - 0xDA47
{
	int iVar0;
	int iVar1;
...
void func_214(int* iParam0)//Position - 0xDD4B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_215(var uParam0)//Position - 0xDD76
{
	int iVar0;
...
int func_216(var uParam0, bool bParam1, bool bParam2)//Position - 0xDDF6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_217(int iParam0, int iParam1)//Position - 0xDFB4
{
	int iVar0;
...
int func_218(var uParam0, bool bParam1, int iParam2)//Position - 0xDFE4
{
	int iVar0;
	int iVar1;
...
int func_219(int iParam0)//Position - 0xE2A0
{
...
int func_220(int iParam0, float fParam1)//Position - 0xE2D4
{
	float fVar0;
...
bool func_221(int iParam0, float fParam1)//Position - 0xE34A
{
	return func_222(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_222(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE362
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	uVar0 = func_223(&(Local_35[iVar4 /*4*/]), Var1, iParam1, &(Local_35[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar4 /*4*/].f_3) < iParam4);
}

int func_223(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE423
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_224(int iParam0, int iParam1)//Position - 0xE54F
{
	int iVar0;
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE65E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_227(struct<3> Param0, struct<3> Param3)//Position - 0xE6EF
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_228(struct<3> Param0)//Position - 0xE710
{
	float fVar0;
	float fVar1;
...
void func_229(var uParam0)//Position - 0xE74F
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_230(int iParam0, int iParam1)//Position - 0xE76A
{
	int iVar0;
...
int func_231(int iParam0)//Position - 0xE7A9
{
...
int func_232(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE7D1
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_233(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE8CC
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_234(int iParam0, float fParam1)//Position - 0xE9D8
{
	var uVar0;
	struct<3> Var1;
...
int func_235(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xEA6D
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_236(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEAFB
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_237(int iParam0)//Position - 0xEB43
{
...
void func_238(int iParam0)//Position - 0xEB8D
{
	int iVar0;
...
int func_239(int iParam0)//Position - 0xEC2A
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_240(int iParam0)//Position - 0xECBF
{
...
int func_243(int iParam0)//Position - 0xED3E
{
...
int func_245(int iParam0)//Position - 0xEDB0
{
	if (func_117(0))
	{
...
int func_246(int iParam0)//Position - 0xEDD8
{
	switch (*iParam0)
	{
		case 25:
...
int func_247(var uParam0)//Position - 0xEE1F
{
	int iVar0[5];
	int iVar6;
	bool bVar7;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_254(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmhunting2"))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			{
				if (func_251(&(uParam0->f_28[0]), 54, -683.3276f, 5841.042f, 17.217f, 8.33f, "RC HUNTER 2", 1))
				{
			...
			{
				iLocal_98 = WEAPON::CREATE_WEAPON_OBJECT(joaat("WEAPON_SNIPERRIFLE"), 0, Local_95, false, 1f, 0, 0, 1);
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iLocal_98, joaat("COMPONENT_AT_SCOPE_LARGE"));
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iLocal_98, joaat("COMPONENT_AT_AR_SUPP_02"));
			}
			if (bVar7)
			{
				iLocal_89 = 3;
		...
		case 3:
			...
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_95, 1f, iLocal_92, false))
			{
				ENTITY::SET_ENTITY_ROTATION(iLocal_98, 0f, -90f, -162.64f, 2, true);
			}
			iVar6 = 0;
			while (iVar6 <= (iVar0 - 1))
			{
...
void func_248(int* iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF054
{
	func_249(iParam0, iLocal_91, Param1, fParam4);
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_249(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF0BA
{
	func_250(iParam0);
...
void func_250(int* iParam0)//Position - 0xF0FD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_251(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF199
{
	if (func_252(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_252(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF1F5
{
	int iVar0;
...
int func_253(var uParam0, int iParam1)//Position - 0xF283
{
	int iVar0;
...
int func_254(int iParam0)//Position - 0xF2C9
{
	int iVar0;
...
int func_255(var uParam0)//Position - 0xF2FA
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if ((!func_254(&iVar0) || !func_256(&(uParam0->f_48))) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_251(&(uParam0->f_28[0]), 54, 1804.33f, 3931.33f, 33.83f, 91.63f, "RC HUNTER 1", 1))
				{
...
int func_256(var uParam0)//Position - 0xF5B0
{
	if (func_212(uParam0))
	{
...
void func_257(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xF5DA
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_258(int iParam0)//Position - 0xF616
{
	struct<27> Var0;
	bool bVar32;
...
int func_259(int iParam0)//Position - 0xF667
{
	char* sVar0;
...
int func_260(int iParam0)//Position - 0xF720
{
	var uVar0;
...
int func_261(int iParam0)//Position - 0xF7E1
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_262(int iParam0, char* sParam1)//Position - 0xF866
{
...
int func_263(int iParam0)//Position - 0xF948
{
...
int func_264(int iParam0)//Position - 0xF973
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_265(int iParam0)//Position - 0xF99E
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_266(int iParam0)//Position - 0xF9C9
{
	if (func_240(iParam0))
	{
		return 0;
...
void func_267()//Position - 0xF9FE
{
	func_284("Running end routines.");
	Global_114088 = (Global_114088 - 1);
}

int func_268(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFA18
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_269((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_269((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_269(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xFA7D
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_270(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_270(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xFAF5
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_271(int iParam0, bool bParam1)//Position - 0xFB70
{
	if (bParam1)
	{
...
void func_272(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFBBD
{
...
void func_273(var uParam0, bool bParam1)//Position - 0xFBDD
{
	func_274(&(uParam0->f_41), bParam1);
}

void func_274(var uParam0, bool bParam1)//Position - 0xFBEF
{
	int iVar0;
...
void func_275(int* iParam0, bool bParam1)//Position - 0xFC2D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_276(var uParam0, bool bParam1)//Position - 0xFC68
{
	func_277(&(uParam0->f_35), bParam1);
}

void func_277(var uParam0, bool bParam1)//Position - 0xFC7A
{
	int iVar0;
...
void func_278(int* iParam0)//Position - 0xFCB7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_279(var uParam0, int iParam1)//Position - 0xFCEF
{
	func_280(&(uParam0->f_28), iParam1);
}

void func_280(var uParam0, int iParam1)//Position - 0xFD01
{
	int iVar0;
...
void func_281(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFD42
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_282(int* iParam0)//Position - 0xFD92
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_283(var uParam0)//Position - 0xFDD3
{
	if (*uParam0 == -1)
	{
		return;
...
void func_284(char* sParam0)//Position - 0xFE10
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_285(var uParam0)//Position - 0xFE22
{
	*uParam0 = -1;
...
void func_286()//Position - 0xFE55
{
	func_284("Running start routines.");
	Global_114088++;
}

int func_287(int iParam0)//Position - 0xFE6F
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
