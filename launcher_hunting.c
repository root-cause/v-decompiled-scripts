...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		func_201(Var0.f_0);
		func_194(&iLocal_59, &(Var0.f_9), Var1);
		if (Var0.f_0 == 25)
		{
			func_189(&Var0, Var1, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
		}
		...
		if (func_174(&Var0, 0) && MISC::ABSF((Var1.f_2 - Var3.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_265(&Var0, 1);
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5D19
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x64DC
{
	if (bParam2)
	{
...
int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x69A3
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_84(struct<3> Param0, float fParam1)//Position - 0x7660
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
int func_189(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xCD81
{
	var uVar0;
	
	if ((((func_132(PLAYER::PLAYER_PED_ID()) && func_132(iParam0->f_28[0])) && !func_151()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_193(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_193(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xCF35
{
	struct<3> Var0;
...
bool func_216(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE1E6
{
	...
	iVar2 = func_224(iParam0, iParam1);
	if (!func_132(iParam0) || !func_132(iParam1))
	{
		if (iVar2 != -1)
		{
			func_223(&(Local_37[iVar2 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_217(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_217(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE2A7
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_220(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE4E2
{
	...
	{
		Var1 = { func_222(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_221(Var1, Var0);
...
float func_221(struct<3> Param0, struct<3> Param1)//Position - 0xE573
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_229(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xE8F1
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
void func_242(int* iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xEED8
{
	func_243(iParam0, iLocal_53, Param1, fParam2);
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_243(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xEF3E
{
	func_244(iParam0);
...
int func_245(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xF01C
{
	if (func_246(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_246(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xF078
{
	int iVar0;
...
int func_262(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xF89B
{
	int iVar0;
...
int func_263(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xF900
{
	int iVar0;
	struct<7> Var1;
...
int func_264(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0xF978
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
