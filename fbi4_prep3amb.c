...
void func_1(int iParam0, bool bParam1)//Position - 0x1B1
{
	...
	if (bParam1)
	{
		if (iParam0 != 46)
		{
			if ((!func_2(func_3(iParam0)) && !Global_112026) && !BitTest(uLocal_49, 15))
			{
...
void func_21(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x999
{
	struct<60> Var0;
...
void func_22(int iParam0, int iParam1, int iParam2)//Position - 0xAC2
{
	...
	if (!func_54(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_113386.f_32749.f_4801 = func_43();
			}
...
int func_26(int iParam0, bool bParam1)//Position - 0x1069
{
	int iVar0;
	struct<2> Var1;
...
int func_27(int iParam0)//Position - 0x11E9
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_29(int iParam0)//Position - 0x12C5
{
	int iVar0;
	int iVar1;
...
bool func_30()//Position - 0x4596
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_31()//Position - 0x45AC
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_32()//Position - 0x45C2
{
	return 0;
}

int func_33()//Position - 0x45CB
{
	return 1;
}

int func_34()//Position - 0x45D4
{
	return 1;
}

int func_35()//Position - 0x45DD
{
...
int func_37(int iParam0)//Position - 0x46AE
{
	int iVar0;
	char* sVar1;
...
int func_38(int iParam0)//Position - 0x46F4
{
	int iVar0;
...
int func_39(int iParam0)//Position - 0x472F
{
	int iVar0;
...
int func_40(int iParam0)//Position - 0x47AB
{
	int iVar0;
...
int func_41(int iParam0, int iParam1, bool bParam2)//Position - 0x4893
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_42(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x4901
{
...
void func_44(var uParam0, int iParam1)//Position - 0x4A1E
{
	if (iParam1 <= 0)
	{
		return;
...
void func_45(var uParam0, int iParam1)//Position - 0x4AA4
{
...
void func_46(var uParam0, int iParam1)//Position - 0x4AD7
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1)//Position - 0x4B28
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_48(int iParam0)//Position - 0x4BCA
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_49(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_49(bool bParam0, int iParam1, int iParam2)//Position - 0x4BEC
{
	if (bParam0)
	{
		return iParam1;
...
int func_50(var uParam0)//Position - 0x4C03
{
	return uParam0 & 15;
}

void func_51(var uParam0, int iParam1)//Position - 0x4C10
{
...
void func_52(var uParam0, int iParam1)//Position - 0x4C4A
{
...
void func_53(var uParam0, int iParam1)//Position - 0x4C85
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_54(var uParam0, int iParam1)//Position - 0x4CC1
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_79(Global_113386.f_32749.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_79(Global_113386.f_2363.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_79(Global_113386.f_2363.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_55(int iParam0, int iParam1)//Position - 0x63AE
{
	struct<82> Var0;
...
void func_56(int iParam0, var uParam1, int iParam2)//Position - 0x63F0
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x664C
{
	return iParam0 < 3;
}

void func_58(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x6658
{
	if (func_54(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_62(iParam0);
			func_61(uParam1, &(Global_113386.f_32749.f_69[Global_77137.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_59(int iParam0, bool bParam1)//Position - 0x6751
{
	if (iParam0 == -1)
	{
		return;
...
void func_60(int iParam0, int iParam1, bool bParam2)//Position - 0x67AE
{
	if (iParam0 == -1)
	{
		return;
...
void func_61(var uParam0, var uParam1)//Position - 0x67E9
{
...
void func_62(int iParam0)//Position - 0x68B5
{
	if (iParam0 == -1)
	{
		return;
...
int func_63(int iParam0)//Position - 0x692C
{
	int iVar0;
...
void func_64(int iParam0, var uParam1)//Position - 0x698F
{
	int iVar0;
...
int func_65(int iParam0)//Position - 0x6C3A
{
	switch (iParam0)
	{
		case 1:
...
int func_66(int iParam0, var uParam1, var uParam2)//Position - 0x6CEA
{
	int iVar0;
	int iVar1;
...
int func_67(int iParam0)//Position - 0x6EDD
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_68(var uParam0)//Position - 0x6EFD
{
	int iVar0;
...
void func_69(int iParam0)//Position - 0x6FAC
{
...
void func_70(bool bParam0)//Position - 0x6FD3
{
	if (BitTest(uLocal_49, 14))
	{
...
void func_71(int iParam0)//Position - 0x70B7
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x70D7
{
	int iVar0;
	int iVar1;
...
int func_73(int iParam0)//Position - 0x7114
{
	if (func_57(iParam0))
	{
...
var func_74(int iParam0)//Position - 0x7139
{
	return Global_1998[iParam0 /*29*/];
}

int func_75(int iParam0, int iParam1)//Position - 0x7148
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_76(int iParam0)//Position - 0x7168
{
	if (iParam0 == -1)
	{
		return 0;
...
bool func_78(int iParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x71A0
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), Param1) <= (fParam2 * fParam2);
}

bool func_79(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x71BE
{
	if (bParam2)
	{
...
void func_80(int iParam0, bool bParam1)//Position - 0x7205
{
...
int func_82(bool bParam0)//Position - 0x7274
{
...
void func_83(char* sParam0, var uParam1)//Position - 0x729C
{
...
void func_85()//Position - 0x7333
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_73(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_57(iVar0) && (!func_86(14) || Global_112337))
			{
...
bool func_86(int iParam0)//Position - 0x7430
{
	return Global_43052 == iParam0;
}

int func_87(int iParam0)//Position - 0x743E
{
	if (func_88(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_88(int iParam0)//Position - 0x7468
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_89(int iParam0, int iParam1)//Position - 0x7489
{
...
void func_90(bool bParam0)//Position - 0x74C6
{
	char* sVar0;
...
bool func_91()//Position - 0x7539
{
	func_85();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_92(char* sParam0)//Position - 0x7552
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_93(int iParam0, int iParam1)//Position - 0x7564
{
...
void func_94()//Position - 0x75A9
{
	Global_113386.f_10016.f_21++;
	if (iLocal_42 == 0)
	{
		STATS::STAT_SET_INT(joaat("FL_CO_FB4P3"), Global_113386.f_10016.f_21, true);
		if (func_103())
		{
...
void func_96(int iParam0, int iParam1, int iParam2)//Position - 0x763F
{
	bool bVar0;
...
int func_98()//Position - 0x7BE3
{
	return Global_31959;
}

int func_99(int iParam0, int iParam1)//Position - 0x7BEE
{
	int iVar0;
...
void func_100(int iParam0, bool bParam1, int iParam2)//Position - 0x7C3F
{
	if (iParam2 == -1)
	{
		iParam2 = func_101();
...
int func_101()//Position - 0x7C5D
{
	return Global_1574918;
}

int func_102()//Position - 0x7C69
{
...
int func_105(int iParam0)//Position - 0x7CF8
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
int func_109(int iParam0, int iParam1)//Position - 0x7D83
{
	int iVar0;
	int iVar1;
...
void func_110(int iParam0)//Position - 0x7DC4
{
	Global_78579 = iParam0;
	Global_78580 = iParam0;
}

void func_111()//Position - 0x7DD8
{
	struct<6> Var0;
...
void func_112(bool bParam0)//Position - 0x7F4B
{
	if (bParam0)
	{
...
int func_113(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x7FBC
{
	struct<15> Var0;
	int iVar1;
...
void func_114(bool bParam0)//Position - 0x810E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_115(int iParam0)//Position - 0x81CC
{
	switch (iParam0)
	{
		case 0:
...
void func_116(int iParam0)//Position - 0x8236
{
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0x827C
{
...
void func_118(int iParam0, int iParam1, int iParam2)//Position - 0x82C1
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_120(struct<6> Param0)//Position - 0x832B
{
	if (iLocal_42 == 0)
	{
		func_125(Param0);
...
void func_121(struct<6> Param0)//Position - 0x8352
{
	if (func_103())
	{
		func_122(Param0, 1);
...
void func_122(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)//Position - 0x8376
{
	struct<4> Var0;
...
struct<4> func_123(bool bParam0)//Position - 0x83E6
{
	struct<4> Var0;
...
struct<4> func_124(bool bParam0)//Position - 0x8450
{
	struct<4> Var0;
...
void func_125(struct<6> Param0)//Position - 0x84BA
{
	if (func_103())
	{
		if (func_126())
...
void func_128(bool bParam0)//Position - 0x8571
{
...
void func_129(char* sParam0, char* sParam1)//Position - 0x8585
{
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		Global_21662 = 1;
...
struct<6> func_130()//Position - 0x85A6
{
	struct<6> Var0;
...
int func_137()//Position - 0x86F4
{
	return Global_78581;
}

void func_138()//Position - 0x8700
{
...
int func_142(var uParam0)//Position - 0x8827
{
	char* sVar0;
...
void func_144(int iParam0, struct<3> Param1)//Position - 0x88A1
{
	int iVar0;
...
bool func_145(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x88F0
{
...
int func_146(char* sParam0, int iParam1, bool bParam2)//Position - 0x894F
{
	Global_21606 = 0;
...
bool func_149(int iParam0)//Position - 0x8CB7
{
	return func_150(iParam0, 20);
}

var func_150(int iParam0, int iParam1)//Position - 0x8CC7
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

int func_151()//Position - 0x8CDF
{
	return -1;
}

void func_152()//Position - 0x8CE8
{
	int iVar0;
...
bool func_158(int iParam0, int iParam1)//Position - 0x8F65
{
	switch (iParam0)
	{
		case 5:
...
void func_160(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x8FF4
{
...
void func_162(bool bParam0, var uParam1)//Position - 0x9064
{
	int iVar0;
...
void func_163(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x91DA
{
...
void func_164(int iParam0, int iParam1, bool bParam2)//Position - 0x9275
{
	int iVar0;
		...
		if (bParam2)
		{
			if (!Global_78319)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8795[iParam1 /*4*/] = { func_166(iParam0) };
					...
					{
						Global_8746[1 /*6*/] = { func_166(iParam0) };
...
struct<4> func_166(int iParam0)//Position - 0x9466
{
	return Global_1998[iParam0 /*29*/].f_3;
}

int func_167(int iParam0, int iParam1)//Position - 0x9479
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
int func_168(int iParam0, int iParam1)//Position - 0x94A3
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
char* func_171(bool bParam0)//Position - 0xAD7B
{
	char* sVar0;
...
int func_174(int iParam0)//Position - 0xAF32
{
...
int func_175(int iParam0)//Position - 0xAF62
{
	if (Global_22720 == 0)
	{
		return 0;
...
{
	if ((BitTest(uLocal_49, 0) && Global_43052 == 15) && !func_209())
	{
		if (iLocal_38 == 0)
		{
			if (!BitTest(uLocal_49, 1))
			{
				if (!func_78(PLAYER::PLAYER_PED_ID(), Local_50, 5f, 1))
				{
					...
					{
						if ((func_251(PLAYER::PLAYER_PED_ID()) && !BitTest(uLocal_47[0], 17)) && !BitTest(uLocal_47[1], 18))
						{
...
void func_179(int iParam0)//Position - 0xB2C6
{
	if (func_182())
	{
		return;
...
void func_180(bool bParam0, bool bParam1)//Position - 0xB350
{
	if (bParam0)
	{
		if (func_15(0))
...
bool func_181()//Position - 0xB3C4
{
	return BitTest(Global_1958711, 5);
}

bool func_182()//Position - 0xB3D2
{
	return BitTest(Global_1958711, 19);
}

int func_183(int iParam0)//Position - 0xB3E1
{
	struct<3> Var0;
...
int func_189(struct<3> Param0)//Position - 0xB69C
{
	float fVar0;
	
	fVar0 = SYSTEM::VDIST2(Param0, Global_95580[func_190(Param0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_190(struct<3> Param0, bool bParam1)//Position - 0xB6D1
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_191(struct<3> Param0)//Position - 0xB74B
{
	float fVar0;
	
	fVar0 = SYSTEM::VDIST2(Param0, Global_95644[func_192(Param0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_192(struct<3> Param0, bool bParam1)//Position - 0xB780
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_194(struct<3> Param0, struct<3> Param1)//Position - 0xB883
{
	float fVar0;
...
int func_195(struct<3> Param0)//Position - 0xB8A6
{
	if (!func_198(1))
	{
		if (!func_198(0))
...
int func_196(struct<3> Param0, int iParam1)//Position - 0xBF19
{
	float fVar0;
...
Vector3 func_197(int iParam0)//Position - 0xBF41
{
	struct<3> Var0;
...
int func_198(int iParam0)//Position - 0xC620
{
...
int func_200(var uParam0)//Position - 0xC7A3
{
...
int func_201(char* sParam0)//Position - 0xC7CE
{
	int iVar0;
...
int func_205(struct<3> Param0, int iParam1, int iParam2)//Position - 0xC953
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_206(int iParam0)//Position - 0xC9E2
{
...
void func_208(bool bParam0, bool bParam1)//Position - 0xCA6F
{
	func_4(bParam0);
...
void func_210()//Position - 0xCAE1
{
	...
	if ((Global_43052 == 15 && iLocal_38 == 0) && !func_209())
	{
		if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			if (!BitTest(uLocal_49, 0))
...
int func_211(int iParam0)//Position - 0xCDBB
{
...
int func_212(int iParam0)//Position - 0xCDEC
{
...
int func_216(int iParam0)//Position - 0xCEC0
{
	int iVar0;
...
int func_217(int iParam0)//Position - 0xCF14
{
	int iVar0;
...
int func_218(int iParam0)//Position - 0xCF59
{
	int iVar0;
...
int func_220(int iParam0)//Position - 0xD01B
{
	if (DECORATOR::DECOR_EXIST_ON(iParam0, "GetawayVehicleValid"))
	{
		return 1;
...
int func_222(var uParam0)//Position - 0xD07E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_224()//Position - 0xD23D
{
	int iVar0;
	bool bVar1;
	
	if (((((((Global_43052 == 15 && iLocal_37 != 3) && BitTest(uLocal_49, 5)) && !func_209()) && Global_78316 == -1) && !func_234()) && !func_86(9)) || func_105(35))
	{
		func_233();
		func_231();
		switch (iLocal_39)
	...
	else if (((((((Global_43052 != 15 || Global_43052 != 0) || Global_43052 != 2) || Global_43052 != 4) || Global_43052 != 17) || func_209()) || Global_78316 == -1) || Global_112441)
	{
		bVar1 = false;
		if (func_134())
		{
...
void func_225(bool bParam0, bool bParam1)//Position - 0xD3C5
{
	switch (iLocal_39)
	{
		case 1:
...
void func_226(char* sParam0, int iParam1)//Position - 0xD4CF
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_227()//Position - 0xD4E6
{
...
int func_228(bool bParam0)//Position - 0xD500
{
	int iVar0;
...
int func_229(bool bParam0)//Position - 0xD54A
{
	int iVar0;
...
void func_230(var uParam0, int iParam1)//Position - 0xD5F8
{
	bool bVar0;
	...
	if (iLocal_37 == 0 || iLocal_37 == 1)
	{
		switch (iLocal_38)
		{
			case 0:
				...
				{
					if (((((((!func_2(func_3(7)) && !func_2(func_3(8))) && !func_2(func_3(10))) && !func_2(func_3(11))) && !func_2(func_3(12))) && !func_2(func_3(13))) && !func_134()) && !Global_112026)
					{
						MISC::SET_BIT(&uLocal_49, 15);
						HUD::CLEAR_HELP(true);
					}
...
bool func_232(char* sParam0, int iParam1, char* sParam2)//Position - 0xD7B9
{
...
int func_242()//Position - 0xDB39
{
	if (((((Global_43052 == 15 && !func_209()) && Global_78316 == -1) && !func_134()) && !func_243(1112014848)) && !Global_112441)
	{
		return 1;
	}
	return 0;
...
int func_243(float fParam0)//Position - 0xDB87
{
	if (iLocal_42 == 1)
	{
		if (func_78(PLAYER::PLAYER_PED_ID(), Global_96387[1 /*15*/], fParam0, 1))
		{
			return 1;
		}
	}
	...
	{
		if (func_78(PLAYER::PLAYER_PED_ID(), Global_96387[0 /*15*/], fParam0, 1))
		{
			return 1;
		}
	}
	...
	{
		if (func_78(PLAYER::PLAYER_PED_ID(), Global_96387[3 /*15*/], fParam0, 1))
		{
			return 1;
		}
	}
...
int func_247(int iParam0, int iParam1, bool bParam2)//Position - 0xDCA3
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_248(int iParam0, int iParam1, int iParam2)//Position - 0xDD04
{
	int iVar0;
	var uVar1;
...
int func_249(var uParam0)//Position - 0xDD41
{
	int iVar0;
	int iVar1;
...
int func_250(int iParam0)//Position - 0xDD75
{
	switch (iParam0)
	{
		case 0:
...
int func_251(int iParam0)//Position - 0xE0F0
{
	if (func_88(iParam0))
	{
...
int func_252(int iParam0)//Position - 0xE110
{
...
void func_253(int iParam0)//Position - 0xE13C
{
	iLocal_42 = iParam0;
	if (iLocal_42 == 0)
	{
...
char* func_255(int iParam0)//Position - 0xE3DF
{
	char* sVar0;
...
void func_256()//Position - 0xE5A5
{
	...
	Local_68[0 /*261*/][0 /*8*/] = { func_257("DELBE" /* GXT: Del Perro Beach */, -1615.2574f, -952.59436f, 20.01716f, -2160.7058f, -423f, -1.28679f, 327.8f) };
	Local_68[0 /*261*/][1 /*8*/] = { func_257("DELBE" /* GXT: Del Perro Beach */, -1521.7163f, -914.56757f, 20.17247f, -1855.7148f, -1325.784f, -44.79295f, 254.8f) };
	Local_68[0 /*261*/][2 /*8*/] = { func_257("BEACH" /* GXT: Vespucci Beach */, -1162.3699f, -1815.0084f, 15.33822f, -1553.2072f, -1098.6849f, 0.46467f, 253.91f) };
	Local_68[0 /*261*/][3 /*8*/] = { func_257("BEACH" /* GXT: Vespucci Beach */, -1464.2185f, -1136.7828f, 0.32167f, -2241.5664f, -358.88486f, 20.32481f, 282.21f) };
	Local_68[0 /*261*/][4 /*8*/] = { func_257("PBOX" /* GXT: Pillbox Hill */, 156.41087f, -1042.6412f, 22.31273f, 238.63815f, -821.1217f, 35.10069f, 176.96f) };
	Local_68[0 /*261*/][5 /*8*/] = { func_257("CHIL" /* GXT: Vinewood Hills */, 883.1121f, 534.72833f, 115.72503f, 559.7425f, 644.602f, 150.59714f, 301.08f) };
	Local_68[0 /*261*/][6 /*8*/] = { func_257("EAST_V" /* GXT: East Vinewood */, 941.45306f, -329.4256f, 60.77003f, 727.76514f, -200.95193f, 75.59085f, 88.89f) };
	Local_68[0 /*261*/][7 /*8*/] = { func_257("EAST_V" /* GXT: East Vinewood */, 689.1177f, -273.14056f, 60.21559f, 834.7326f, -352.1655f, 50.92442f, 81.23f) };
	Local_68[0 /*261*/][8 /*8*/] = { func_257("MIRR" /* GXT: Mirror Park */, 1048.4985f, -357.0332f, 60.92149f, 1401.5808f, -783.8975f, 75.7477f, 325.93f) };
	Local_68[0 /*261*/][9 /*8*/] = { func_257("MIRR" /* GXT: Mirror Park */, 892.28357f, -461.57523f, 70.86029f, 1161.3007f, -829.8299f, 45.90131f, 184.12f) };
	Local_68[0 /*261*/][10 /*8*/] = { func_257("VCANA" /* GXT: Vespucci Canals */, -1161.3606f, -1143.7163f, -5.71593f, -864.9714f, -981.12573f, 21.09691f, 328.65f) };
	Local_68[0 /*261*/][11 /*8*/] = { func_257("BAYTRE" /* GXT: Baytree Canyon */, 251.40108f, 1068.3472f, 280.6663f, 189.60123f, 1272.3522f, 143.80351f, 160.32f) };
	Local_68[0 /*261*/][13 /*8*/] = { func_257("OBSERV" /* GXT: Galileo Observatory */, -450.98346f, 1048.4084f, 252.94498f, -389.56403f, 1244.5039f, 370.24692f, 199.93f) };
	Local_68[0 /*261*/][14 /*8*/] = { func_257("AIRP" /* GXT: Los Santos International Airport */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_68[0 /*261*/][15 /*8*/] = { func_257("TERMINA" /* GXT: Terminal */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_68[0 /*261*/][16 /*8*/] = { func_257("STAD" /* GXT: Maze Bank Arena */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_68[0 /*261*/][17 /*8*/] = { func_257("MOVIE" /* GXT: Richards Majestic */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_68[0 /*261*/][18 /*8*/] = { func_257("GOLF" /* GXT: GWC and Golfing Society */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_68[0 /*261*/][19 /*8*/] = { func_257("HORS" /* GXT: Vinewood Racetrack */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_68[0 /*261*/][20 /*8*/] = { func_257("PBOX" /* GXT: Pillbox Hill */, -28.39781f, -1071.2449f, 50.21438f, -49.8352f, -1131.2766f, 20.02555f, 55.12f) };
	Local_68[0 /*261*/][21 /*8*/] = { func_257("LOSSF" /* GXT: Los Santos Freeway */, 843.19617f, 25.93548f, 65.16061f, 1138.6865f, 363.05872f, 105.41279f, 61.11f) };
	Local_68[0 /*261*/][22 /*8*/] = { func_257("ROCKF" /* GXT: Rockford Hills */, -992.56384f, -199.7673f, 30.74956f, -687.9904f, -43.23445f, 80.93306f, 80.53f) };
	Local_68[0 /*261*/][23 /*8*/] = { func_257("ROCKF" /* GXT: Rockford Hills */, -251.8548f, -446.2141f, 29.5887f, -362.685f, -434.7425f, 90.931f, 50f) };
	Local_68[0 /*261*/][24 /*8*/] = { func_257("ALTA" /* GXT: Alta */, 180.2637f, -404.9771f, 40.1713f, 289.9432f, -445.1485f, 124.3793f, 100f) };
	Local_68[0 /*261*/][25 /*8*/] = { func_257("ALTA" /* GXT: Alta */, 343.8481f, -323.1273f, 80.7749f, 427.08f, -361.0469f, 45.3411f, 85f) };
	Local_68[0 /*261*/][26 /*8*/] = { func_257("RANCHO" /* GXT: Rancho */, 414.5057f, -2092.0999f, 19.8533f, 350.8093f, -2158.395f, 12.3916f, 55f) };
	Local_68[0 /*261*/][27 /*8*/] = { func_257("RANCHO" /* GXT: Rancho */, 283.7474f, -2103.9177f, 12.9242f, 391.8871f, -1983.2037f, 33.0042f, 100f) };
	Local_68[0 /*261*/][28 /*8*/] = { func_257("PBOX" /* GXT: Pillbox Hill */, 85.038f, -670.3274f, 42.8642f, 227.8234f, -722.2458f, 274f, 175f) };
	Local_68[0 /*261*/][29 /*8*/] = { func_257("PBOX" /* GXT: Pillbox Hill */, -107.2516f, -906.36f, 28.2051f, -49.9007f, -752.925f, 330f, 125f) };
	Local_68[0 /*261*/][30 /*8*/] = { func_257("TEXTI" /* GXT: Textile City */, 456.8563f, -683.8335f, 32.2903f, 457.5504f, -819.4669f, 25.9553f, 14.4f) };
	Local_68[0 /*261*/][31 /*8*/] = { func_257("ROCKF" /* GXT: Rockford Hills */, -699.7205f, -227.3646f, 67.818f, -645.1068f, -332.5107f, 30.9132f, 127.1f) };
	Local_68[0 /*261*/].f_260 = 0;
	Local_68[0 /*261*/].f_257 = 32;
	Local_68[2 /*261*/][0 /*8*/] = { func_257("PBOX" /* GXT: Pillbox Hill */, -25.50944f, -932.38464f, 20.41711f, 119.94056f, -523.43976f, 33.07988f, 363.4f) };
	Local_68[2 /*261*/][1 /*8*/] = { func_257("DOWNT" /* GXT: Downtown */, -25.50944f, -932.38464f, 20.41711f, 119.94056f, -523.43976f, 33.07988f, 363.4f) };
	Local_68[2 /*261*/][2 /*8*/] = { func_257("COSI" /* GXT: Countryside */, 1426.9344f, 1225.1151f, 90.76305f, 1429.9823f, 1006.8307f, 120.66425f, 259.89f) };
	Local_68[2 /*261*/][3 /*8*/] = { func_257("COSI" /* GXT: Countryside */, 3503.5603f, 3546.4026f, 20.18748f, 3513.9546f, 3875.7952f, 72.94806f, 393.78f) };
	Local_68[2 /*261*/][4 /*8*/] = { func_257("SKID" /* GXT: Mission Row */, 403.54044f, -864.46936f, 20.33799f, 396.34406f, -1127.3247f, 35.49262f, 325.93f) };
	Local_68[2 /*261*/][5 /*8*/] = { func_257("JAIL" /* GXT: Bolingbroke Penitentiary */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_68[2 /*261*/][6 /*8*/] = { func_257("ARMYB" /* GXT: Fort Zancudo */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_68[2 /*261*/].f_260 = 2;
	Local_68[2 /*261*/].f_257 = 7;
	Local_68[1 /*261*/][0 /*8*/] = { func_257("PALETO" /* GXT: Paleto Bay */, -422.86185f, 6068.399f, 20.34662f, -282.74524f, 6206.324f, 50.46586f, 196.61f) };
	Local_68[1 /*261*/][1 /*8*/] = { func_257("ROCKF" /* GXT: Rockford Hills */, -755.2506f, 147.4266f, 75.41048f, -1079.0332f, 169.38055f, 50.46801f, 179.12f) };
	Local_68[1 /*261*/][2 /*8*/] = { func_257("ROCKF" /* GXT: Rockford Hills */, -752.36743f, 90.76733f, 65.5171f, -938.79803f, -15.91457f, 35.48347f, 205.78f) };
	Local_68[1 /*261*/][3 /*8*/] = { func_257("ROCKF" /* GXT: Rockford Hills */, -890.4999f, 431.1449f, 90.29848f, -875.3576f, 232.3266f, 60.20724f, 263.82f) };
	Local_68[1 /*261*/][4 /*8*/] = { func_257("ROCKF" /* GXT: Rockford Hills */, -752.36743f, 90.76733f, 65.5171f, -938.79803f, -15.91457f, 35.48347f, 205.78f) };
	Local_68[1 /*261*/][5 /*8*/] = { func_257("ROCKF" /* GXT: Rockford Hills */, -1198.1826f, 638.63666f, 115.10664f, -444.509f, 750.9377f, 198.29713f, 473.88f) };
	Local_68[1 /*261*/][6 /*8*/] = { func_257("ROCKF" /* GXT: Rockford Hills */, -844.40753f, 400.9413f, 80.433f, -109.53111f, 420.5014f, 120.2088f, 256.03f) };
	Local_68[1 /*261*/][7 /*8*/] = { func_257("ROCKF" /* GXT: Rockford Hills */, -518.62134f, 648.82654f, 130.93524f, -64.0709f, 582.45044f, 215.30841f, 162.72f) };
	Local_68[1 /*261*/][8 /*8*/] = { func_257("RICHM" /* GXT: Richman */, -934.98016f, 349.61014f, 85.77298f, -1432.4509f, 269.98038f, 50.7303f, 185.03f) };
	Local_68[1 /*261*/][9 /*8*/] = { func_257("RICHM" /* GXT: Richman */, -1633.8134f, -69.53224f, 65.10236f, -1446.8229f, 69.71544f, 48.23926f, 214.92f) };
	Local_68[1 /*261*/][10 /*8*/] = { func_257("RICHM" /* GXT: Richman */, -1732.258f, 444.13525f, 130.12581f, -2065.6904f, 412.21207f, 98.09863f, 175.17f) };
	Local_68[1 /*261*/][11 /*8*/] = { func_257("RICHM" /* GXT: Richman */, -1618.0363f, 50.95197f, 70.95364f, -1396.5143f, 221.1004f, 50.84464f, 161.61f) };
	Local_68[1 /*261*/][12 /*8*/] = { func_257("RICHM" /* GXT: Richman */, -1801.285f, 106.8786f, 72.12892f, -1541.7401f, 263.37378f, 50.44112f, 155.88f) };
	Local_68[1 /*261*/][13 /*8*/] = { func_257("PELUFF", -2208.5627f, 146.41006f, 150.93246f, -2350.1223f, 486.60657f, 200.5952f, 299.18f) };
	Local_68[1 /*261*/][14 /*8*/] = { func_257("PELUFF", -1852.3263f, 134.41718f, 70.06226f, -1994.3872f, 299.62833f, 100.96516f, 182.04f) };
	Local_68[1 /*261*/][15 /*8*/] = { func_257("CHIL" /* GXT: Vinewood Hills */, -1982.6697f, 505.9648f, 100.93644f, -1918.8427f, 713.6382f, 150.73953f, 168.9f) };
	Local_68[1 /*261*/][16 /*8*/] = { func_257("CHIL" /* GXT: Vinewood Hills */, -1455.7506f, 887.3351f, 191.97572f, -1663.2073f, 767.3684f, 160.81076f, 239.65f) };
	Local_68[1 /*261*/][17 /*8*/] = { func_257("CHIL" /* GXT: Vinewood Hills */, -1570.2218f, 508.20563f, 140.38838f, -808.95325f, 526.43335f, 90.18556f, 238.43f) };
	Local_68[1 /*261*/][18 /*8*/] = { func_257("CHIL" /* GXT: Vinewood Hills */, 242.62039f, 583.59045f, 159.40428f, 268.04242f, 827.4494f, 201.69531f, 105.09f) };
	Local_68[1 /*261*/][19 /*8*/] = { func_257("CHIL" /* GXT: Vinewood Hills */, -21.10285f, 706.8648f, 150.72626f, -210.43822f, 1056.2755f, 280.31824f, 290.15f) };
	Local_68[1 /*261*/][20 /*8*/] = { func_257("RGLEN" /* GXT: Richman Glen */, -1837.5383f, 774.2984f, 120.56287f, -1765.8419f, 831.0044f, 160.35838f, 68.09f) };
	Local_68[1 /*261*/][21 /*8*/] = { func_257("DIVINE", -372.0849f, 372.71826f, 100.60433f, 390.2198f, 532.5167f, 180.53801f, 305.88f) };
	Local_68[1 /*261*/].f_260 = 1;
	Local_68[1 /*261*/].f_257 = 22;
	Local_68[3 /*261*/][0 /*8*/] = { func_257("MTCHIL" /* GXT: Mount Chiliad */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_68[3 /*261*/][1 /*8*/] = { func_257("MTGORDO" /* GXT: Mount Gordo */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_68[3 /*261*/][2 /*8*/] = { func_257("SANCHIA" /* GXT: San Chianski Mountain Range */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_68[3 /*261*/][3 /*8*/] = { func_257("TATAMO" /* GXT: Tataviam Mountains */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_68[3 /*261*/][4 /*8*/] = { func_257("ELYSIAN" /* GXT: Elysian Island */, 531.2397f, -3019.2666f, 50f, 530.1656f, -3393.6226f, -22.4165f, 210f) };
	Local_68[3 /*261*/][5 /*8*/] = { func_257("ELYSIAN" /* GXT: Elysian Island */, 569.1023f, -2913.018f, 15.891f, 420.8226f, -2912.775f, -15.0372f, 25f) };
	Local_68[3 /*261*/][6 /*8*/] = { func_257("ELYSIAN" /* GXT: Elysian Island */, 495.1012f, -2833.1753f, 5.164f, 460.1983f, -2813.5283f, 0.4269f, 12f) };
	Local_68[3 /*261*/][7 /*8*/] = { func_257("ELYSIAN" /* GXT: Elysian Island */, 675.2973f, -2747.4504f, 4.952f, 689.2358f, -2747.3955f, 10.9001f, 4.3f) };
	Local_68[3 /*261*/][8 /*8*/] = { func_257("CYPRE" /* GXT: Cypress Flats */, 533.437f, -2693.2793f, 17.4952f, 588.6345f, -2693.4624f, 5.3007f, 15f) };
	Local_68[3 /*261*/][9 /*8*/] = { func_257("CYPRE" /* GXT: Cypress Flats */, 534.9656f, -2699.1365f, 4.9004f, 560.1779f, -2662.1921f, 9.0007f, 15f) };
	Local_68[3 /*261*/][10 /*8*/] = { func_257("CYPRE" /* GXT: Cypress Flats */, 583.903f, -2689.2068f, 16.9771f, 549.8469f, -2665.3176f, 3.9007f, 17.3f) };
	Local_68[3 /*261*/][11 /*8*/] = { func_257("CYPRE" /* GXT: Cypress Flats */, 683.428f, -2635.1343f, 9.3367f, 694.4725f, -2679.6597f, 4.7815f, 10f) };
	Local_68[3 /*261*/][12 /*8*/] = { func_257("CYPRE" /* GXT: Cypress Flats */, 695.2171f, -2694.7688f, 5.9815f, 695.5035f, -2679.1677f, 4.8365f, 10f) };
	Local_68[3 /*261*/][13 /*8*/] = { func_257("CYPRE" /* GXT: Cypress Flats */, 731.7991f, -2659.5796f, 4.7713f, 732.5307f, -2678.4001f, 10.5065f, 25f) };
	Local_68[3 /*261*/][14 /*8*/] = { func_257("ELYSIAN" /* GXT: Elysian Island */, 86.1885f, -2430.6963f, -0.1888f, 119.1515f, -2453.121f, 2.8614f, 13f) };
	Local_68[3 /*261*/][15 /*8*/] = { func_257("ELYSIAN" /* GXT: Elysian Island */, 260.3166f, -2426.7773f, 21.2819f, 313.7871f, -2433.6558f, 6.5609f, 20.5f) };
	Local_68[3 /*261*/][16 /*8*/] = { func_257("ELYSIAN" /* GXT: Elysian Island */, 260.3166f, -2426.7773f, 21.2819f, 313.7871f, -2433.6558f, 6.5609f, 20.5f) };
	Local_68[3 /*261*/][17 /*8*/] = { func_257("ELYSIAN" /* GXT: Elysian Island */, 283.1514f, -2456.7773f, 19.4609f, 290.2325f, -2403.6113f, 4.2465f, 20.5f) };
	Local_68[3 /*261*/][18 /*8*/] = { func_257("ELYSIAN" /* GXT: Elysian Island */, 266.0341f, -2446.724f, 19.4623f, 308.3783f, -2414.5442f, 4.5423f, 20.5f) };
	Local_68[3 /*261*/][19 /*8*/] = { func_257("ELYSIAN" /* GXT: Elysian Island */, 303.5269f, -2451.4456f, 19.4091f, 270.9798f, -2409.4517f, 4.4609f, 20.5f) };
	Local_68[3 /*261*/][20 /*8*/] = { func_257("RANCHO" /* GXT: Rancho */, 515.026f, -1653.5404f, 37.2615f, 582.571f, -1577.8248f, 26.3365f, 100f) };
	Local_68[3 /*261*/][21 /*8*/] = { func_257("BURTON" /* GXT: Burton */, -150.7403f, -419.0541f, 28.6163f, -52.8669f, -453.5552f, 39.4051f, 100f) };
	Local_68[3 /*261*/][22 /*8*/] = { func_257("SanAnd" /* GXT: San Andreas */, 50.2035f, -470.7132f, 36.9003f, 102.0394f, -322.0089f, 115f, 130f) };
	Local_68[3 /*261*/][23 /*8*/] = { func_257("ALTA" /* GXT: Alta */, 499.1769f, -241.2495f, 47.3462f, 393.5317f, -205.7358f, 79.3132f, 120f) };
	Local_68[3 /*261*/][24 /*8*/] = { func_257("DTVINE" /* GXT: Downtown Vinewood */, 422.3247f, 62.118f, 113.2905f, 478.494f, 43.322f, 83.4541f, 80f) };
	Local_68[3 /*261*/][25 /*8*/] = { func_257("DTVINE" /* GXT: Downtown Vinewood */, 385.4908f, 56.1423f, 159.58f, 332.458f, -87.6805f, 63.3657f, 80f) };
	Local_68[3 /*261*/][26 /*8*/] = { func_257("DTVINE" /* GXT: Downtown Vinewood */, 213.6192f, 90.2228f, 98.9357f, 203.3067f, 61.8088f, 86.9197f, 60f) };
	Local_68[3 /*261*/][27 /*8*/] = { func_257("DTVINE" /* GXT: Downtown Vinewood */, 192.813f, -14.9451f, 85.3158f, 149.2689f, 0.6803f, 67.0343f, 40f) };
	Local_68[3 /*261*/][28 /*8*/] = { func_257("WVINE" /* GXT: West Vinewood */, 16.1659f, 61.8685f, 70.8467f, -17.1751f, 74.3771f, 76.88f, 4.5f) };
	Local_68[3 /*261*/][29 /*8*/] = { func_257("WVINE" /* GXT: West Vinewood */, -86.5425f, 84.8701f, 80.2147f, -50.4826f, 67.7335f, 70.297f, 20f) };
	Local_68[3 /*261*/][30 /*8*/] = { func_257("ELGORL" /* GXT: El Gordo Lighthouse */, 3449.839f, 5173.9814f, 0.0662f, 3412.309f, 5166.8896f, 14.8342f, 33.7f) };
...
struct<8> func_257(char* sParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0xF8DF
{
	struct<8> Var0;
...
void func_258(int iParam0, bool bParam1)//Position - 0xF90A
{
	if (func_87(iLocal_51))
	{
		func_20(&iLocal_51);
...
int func_259(int iParam0)//Position - 0xF932
{
	int iVar0;
	bool bVar1;
...
void func_260(bool bParam0)//Position - 0xF989
{
	char* sVar0;
...
void func_265(char* sParam0)//Position - 0xFAAB
{
	StringCopy(&(Global_7974[0 /*16*/].f_8), sParam0, 32);
}

void func_266(char* sParam0)//Position - 0xFABF
{
	StringCopy(&(Global_7974[2 /*16*/].f_8), sParam0, 32);
}

void func_267(char* sParam0)//Position - 0xFAD3
{
	StringCopy(&(Global_7974[1 /*16*/].f_8), sParam0, 32);
}

void func_268(char* sParam0)//Position - 0xFAE7
{
	StringCopy(&(Global_7974[3 /*16*/].f_8), sParam0, 32);
}

int func_269(var uParam0, int iParam1)//Position - 0xFAFB
{
	if (iParam1 == -1)
	{
		return 0;
	}
	if (!func_54(&(Global_77137.f_555[0 /*21*/]), iParam1))
	{
		return 0;
	}
	else
	{
		func_61(&(Global_113386.f_32749.f_69[Global_77137.f_555[0 /*21*/].f_14 /*78*/]), uParam0);
	}
	return 1;
}

float func_270(int iParam0)//Position - 0xFB46
{
	if (iParam0 == -1)
	{
		return 0f;
...
Vector3 func_271(int iParam0)//Position - 0xFB7C
{
	if (iParam0 == -1)
	{
		return 0f, 0f, 0f;
...
int func_272(int iParam0)//Position - 0xFBB6
{
	int iVar0;
	bool bVar1;
