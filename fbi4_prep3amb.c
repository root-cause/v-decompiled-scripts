...
void func_58(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x69BF
{
	if (func_54(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
...
bool func_78(int iParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x7507
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), Param1) <= (fParam2 * fParam2);
}

bool func_79(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x7525
{
	if (bParam2)
	{
...
int func_190(struct<3> Param0, bool bParam1)//Position - 0xBA3C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_192(struct<3> Param0, bool bParam1)//Position - 0xBAEB
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_194(struct<3> Param0, struct<3> Param1)//Position - 0xBBEE
{
	float fVar0;
...
int func_196(struct<3> Param0, int iParam1)//Position - 0xC285
{
	float fVar0;
...
int func_205(struct<3> Param0, int iParam1, int iParam2)//Position - 0xCCBD
{
	int iVar0;
	float fVar1;
	float fVar2;
...
struct<8> func_257(char* sParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0xFC67
{
	struct<8> Var0;
