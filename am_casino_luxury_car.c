...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		if (func_329(PLAYER::PLAYER_ID(), 0, 1))
		{
...
int func_23()//Position - 0x547
{
	...
	if (!func_309(0))
	{
		if (func_114(func_255(PLAYER::PLAYER_ID()), &Local_91, &(Local_91.f_3)))
		{
			func_113(0);
		}
	}
	...
	{
		MISC::CLEAR_AREA(Local_91, 5f, true, false, false, false);
...
int func_43(int iParam0, var* uParam1)//Position - 0x160D
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0)//Position - 0x168A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_45(int iParam0)//Position - 0x1717
{
	int iVar0;
...
int func_46(int iParam0, int iParam1)//Position - 0x176F
{
	func_50();
	...
	func_48(*iParam0, &Global_1949998, &(Global_1949998.f_1), &(Global_1949998.f_4), &(Global_1949998.f_7), &(Global_1949998.f_10));
	...
	{
		if (func_47(iParam0, iParam1, Global_1949998, Global_1949998.f_1, Global_1949998.f_4, Global_1949998.f_7, Global_1949998.f_10, 0, Global_1949998.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
...
bool func_47(var uParam0, int iParam1, int iParam2, struct<3> Param3, struct<3> Param4, struct<3> Param5, float fParam6, int iParam7, int iParam8)//Position - 0x1A1A
{
...
int func_48(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x1A43
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		return 0;
...
bool func_49(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x6FAA
{
	if (bParam2)
	{
...
int func_51(int iParam0)//Position - 0x706A
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
...
int func_52(int iParam0)//Position - 0x70A2
{
	int iVar0;
...
int func_53(int iParam0, var* uParam1)//Position - 0x70E7
{
	int iVar0;
	bool bVar1;
...
int func_54(int iParam0)//Position - 0x71CE
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return 1;
...
int func_55(int iParam0)//Position - 0x74C4
{
...
int func_56(int iParam0)//Position - 0x74F0
{
...
int func_57(int iParam0)//Position - 0x750D
{
...
int func_58(int iParam0, int iParam1)//Position - 0x7530
{
...
int func_59(int iParam0)//Position - 0x756B
{
	if (func_58(iParam0, 0))
	{
...
int func_61(int iParam0, bool bParam1)//Position - 0x75A0
{
	return func_62(iParam0, bParam1, 1);
}

int func_62(int iParam0, bool bParam1, int iParam2)//Position - 0x75B1
{
	int iVar0;
...
int func_63(int iParam0, int iParam1)//Position - 0x760D
{
	if (iParam0 != func_105())
	{
...
int func_64(int iParam0, bool bParam1)//Position - 0x765C
{
	var uVar0;
	int iVar1;
...
var func_66(int iParam0)//Position - 0x76C7
{
	var uVar0;
...
int func_67(var uParam0)//Position - 0x76DF
{
	int iVar0;
	int iVar1;
...
int func_69(int iParam0)//Position - 0x7719
{
	if (iParam0 != func_105())
	{
...
int func_70(int iParam0)//Position - 0x774E
{
	if (iParam0 != func_105())
	{
...
void func_72(int iParam0, int iParam1)//Position - 0x7C49
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0, int iParam1, int iParam2)//Position - 0x7FCA
{
	...
	if ((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_76()) && Global_1576216)
	{
...
struct<13> func_77()//Position - 0x81F6
{
	struct<13> Var0;
...
int func_78(int iParam0)//Position - 0x820B
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("deathbike2"):
...
int func_80(int iParam0)//Position - 0x852D
{
	switch (iParam0)
	{
		case joaat("deity"):
...
void func_81(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x8580
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("casco"))
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_102(iVar0 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_102(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_102(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_102(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					...
					{
						MISC::SET_BIT(&(uParam1->f_77), func_102(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("surfer3"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_102(iVar5));
				}
				iVar5++;
			}
		}
		...
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar6 <= 2)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_102(iVar6));
				}
				iVar6++;
			}
		}
...
int func_83(var uParam0)//Position - 0x8CF4
{
	int iVar0;
...
int func_84(int iParam0)//Position - 0x8D18
{
	int iVar0;
...
var func_85(int iParam0, int iParam1)//Position - 0x8D36
{
...
var func_87(var uParam0, var uParam1)//Position - 0x8D62
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_88(int iParam0, var uParam1, var uParam2)//Position - 0x8D85
{
	int iVar0;
	int iVar1;
	...
	if (func_93(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_91(*iParam0, ((*uParam1)[38] - 1)))
	{
...
int func_89(int iParam0)//Position - 0x8F5F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_91(int iParam0, int iParam1)//Position - 0x9090
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_92(int iParam0, int iParam1)//Position - 0x9179
{
	int iVar0;
...
int func_93(int iParam0, int iParam1)//Position - 0x91DB
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_94(int iParam0, int iParam1, int iParam2)//Position - 0x95BA
{
...
int func_95()//Position - 0x95DE
{
	return 0;
}

void func_96(int iParam0, int iParam1)//Position - 0x95E7
{
	int iVar0;
	int iVar1;
...
int func_97(int iParam0)//Position - 0x965F
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_99(int iParam0)//Position - 0x9690
{
	int iVar0;
...
int func_100(int iParam0)//Position - 0x96D2
{
...
int func_101(int iParam0)//Position - 0x96F2
{
	switch (iParam0)
	{
		case 161:
...
int func_103(int iParam0)//Position - 0x97F5
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (!func_104(PLAYER::PLAYER_ID(), -1))
		{
...
int func_104(int iParam0, int iParam1)//Position - 0x987C
{
	int iVar0;
...
void func_107(int iParam0)//Position - 0x9BE8
{
...
int func_108(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)//Position - 0x9C02
{
	float fVar0;
	int iVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		*uParam0 = NETWORK::VEH_TO_NET(iVar1);
		...
		if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(*uParam0))
		{
			...
			func_109(Param2, fParam3, iParam1, iVar1);
			return 1;
		}
	}
	return 0;
...
void func_109(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x9D0B
{
	int iVar0;
	
	if (func_110(PLAYER::PLAYER_ID(), Param0, iParam2) > -1)
	{
...
int func_110(int iParam0, struct<3> Param1, int iParam2)//Position - 0x9DDE
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
bool func_111(int iParam0)//Position - 0x9E7C
{
	if (iParam0 == 0)
	{
		return 1;
...
void func_113(int iParam0)//Position - 0x9EB2
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	MISC::SET_BIT(&(uLocal_89[iVar0]), iVar1);
}

int func_114(struct<3> Param0, var uParam1, var uParam2)//Position - 0x9ED4
{
	struct<31> Var0;
...
int func_115(struct<3> Param0, struct<3> Param1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)//Position - 0x9F6F
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (!SCRIPT::GET_ID_OF_THIS_THREAD() == Global_2635559.f_675)
	{
		if (!Global_2635559.f_676 == 0)
		{
			if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635559.f_679) < func_247(0))
			{
				return 0;
			}
			else
	...
	else
	{
		...
		if (!Global_2635559.f_676 == 0)
		{
			if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635559.f_679) > func_247(1))
			{
				Global_2635559.f_676 = 0;
			}
		}
	...
	if (Global_2635559.f_676 == 0)
	{
		...
		func_239();
		func_249();
		if (!uParam6->f_27 || (((((((((func_238(Param0, 1, 1133903872) && !uParam6->f_28) && !Global_2793044.f_936) && !Global_2793044.f_925) && !Global_2793044.f_933) && !Global_2793044.f_937) && !Global_2793044.f_954) && !Global_2793044.f_966) && !Global_2793044.f_938) && !Global_2793044.f_988))
		{
	...
	switch (Global_2635559.f_676)
	{
		case 2:
			if (PATHFIND::ARE_NODES_LOADED_FOR_AREA((Param0.f_0 - 100f), (Param0.f_1 - 100f), (Param0.f_0 + 100f), (Param0.f_1 + 100f)))
			{
				...
				if (((uParam6->f_3 && func_199(Param0, fVar2, fVar3, fVar4, 1f, 0, 0, 0, 1123024896, 0, -1, 1, 0, 0, 0, 0, 0)) && !uParam6->f_7) && !func_197(Param0, *uParam5, iParam2, PLAYER::PLAYER_ID(), 0))
				{
					Global_2635559.f_683 = { Param0 };
				...
				if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635559.f_700) < 10000)
				{
					if (NETWORK::NETWORK_ENTITY_AREA_DOES_EXIST(Global_2635559.f_699))
					{
						if (NETWORK::NETWORK_ENTITY_AREA_HAVE_ALL_REPLIED(Global_2635559.f_699))
						{
							...
							{
								if (func_134(Global_2635559.f_683, Global_2635559.f_686, iParam2, PLAYER::PLAYER_ID(), 0) || func_117(Global_2635559.f_683, Global_2635559.f_686, iParam2, 1, 0, 0, 0, 1, 0))
								{
									func_136(Global_2635559.f_683, 0);
									func_135(-1);
								}
...
int func_117(struct<3> Param0, float fParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, int iParam8)//Position - 0xA888
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam7 == 1 && PLAYER::PLAYER_ID() != iVar1) || iParam7 == 0)
		{
			if (func_329(iVar1, bParam3, bParam4))
			{
				...
				{
					if (!bParam6 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_133(iVar1)))
					{
						...
						{
							if (((PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1 && iParam8) && bParam5) && func_128(iVar1))
							{
							}
...
int func_118(struct<3> Param0, struct<3> Param1, float fParam2, int iParam3, float fParam4)//Position - 0xA9FB
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	if (SYSTEM::VDIST(Param0, Param1) < func_126(iParam3, 1008981770))
	{
...
void func_119(struct<3> Param0, float fParam1, int iParam2, var uParam3, var uParam4, var uParam5, float fParam6)//Position - 0xAA4E
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
void func_120(int iParam0, var* uParam1, var* uParam2, float fParam3, float fParam4, float fParam5)//Position - 0xAB1A
{
	int iVar0;
...
void func_121(int iParam0, var* uParam1, var* uParam2, float fParam3, float fParam4, float fParam5)//Position - 0xAC19
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xAEA6
{
	int iVar0;
	int iVar1;
...
int func_124(int iParam0)//Position - 0xAED5
{
	int iVar0;
...
void func_125(var uParam0, struct<3> Param1)//Position - 0xAEE7
{
	float fVar0;
	float fVar1;
	struct<3> Var2;
...
float func_126(int iParam0, float fParam1)//Position - 0xAFBE
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_127(struct<3> Param0, float fParam1, int iParam2, struct<3> Param3, float fParam4, int iParam5, int iParam6)//Position - 0xB03E
{
...
int func_128(int iParam0)//Position - 0xB0DC
{
	...
	if (func_129(PLAYER::PLAYER_ID(), iParam0))
	{
		return 1;
	}
	return 0;
...
int func_129(int iParam0, int iParam1)//Position - 0xB123
{
	int iVar0;
...
int func_130(int iParam0)//Position - 0xB14E
{
	if (iParam0 != func_105())
	{
...
struct<13> func_131(int iParam0)//Position - 0xB171
{
	struct<13> Var0;
...
int func_132(int iParam0, int iParam1)//Position - 0xB188
{
	if (NETWORK::NETWORK_CLAN_SERVICE_IS_VALID())
	{
		Global_2764201 = { func_131(iParam0) };
		Global_2764214 = { func_131(iParam1) };
...
int func_133(int iParam0)//Position - 0xB1F5
{
...
int func_134(struct<3> Param0, float fParam1, int iParam2, int iParam3, int iParam4)//Position - 0xB220
{
	int iVar0;
	int iVar1;
...
void func_136(struct<3> Param0, int iParam1)//Position - 0xB39A
{
	struct<3> Var0;
...
int func_137(struct<3> Param0, float fParam1)//Position - 0xB403
{
	int iVar0;
...
int func_138(struct<3> Param0, float fParam1, int iParam2, bool bParam3, float fParam4)//Position - 0xB43E
{
	struct<3> Var0;
	struct<3> Var1;
	var uVar2;
...
void func_139(struct<3> Param0, var uParam1, int iParam2, var uParam3)//Position - 0xB50F
{
	struct<8> Var0;
...
int func_140(var uParam0, var uParam1, var uParam2)//Position - 0xB55F
{
	char cVar0[64];
	int iVar1;
...
void func_141(var uParam0, var uParam1, var uParam2)//Position - 0xB5AD
{
	int iVar0;
...
int func_142(var uParam0, var uParam1, var uParam2)//Position - 0xB61C
{
	int iVar0;
	struct<3> Var1;
	float* fVar2;
		...
		if (PATHFIND::IS_VEHICLE_NODE_ID_VALID(iVar6))
		{
						...
						if ((uParam2->f_13 || uVar5 & 64 == 0) || uParam2->f_33 == 1)
						{
							if (uParam2->f_14 || uVar5 & 16 == 0)
							{
								if ((uVar5 & 128 == 0 && uVar5 & 256 == 0) && uVar5 & 512 == 0)
								{
									if (!func_173(Var1))
									{
										Var1 = { func_168(Var1, &fVar2, iVar7, uParam2->f_9, *uParam2, bVar8, uParam2->f_11, uParam2->f_34, &bVar9, bVar10, 1, uParam2->f_51, uParam2->f_60) };
														...
														if (func_163(Var1, uParam2))
														{
															if ((uParam2->f_48 && !func_183(&Var1, 0)) || uParam2->f_48 == 0)
															{
																...
																if (SYSTEM::VMAG(Var1) > 0f)
																{
																	...
																	{
																		if ((uParam2->f_12 && !func_162(Var1, fVar2, uParam2->f_34, PLAYER::PLAYER_ID(), 0, uParam2->f_56)) || !uParam2->f_12)
																		{
			...
			if (iVar0 >= (40 + iVar13) || iVar0 >= 100)
			{
				...
				else
				{
					...
					{
						func_147(iVar13, *uParam0, &iVar0, &Var1, &fVar2, uParam2, bVar8, iVar7, iVar3, fVar11, fVar12, bVar9);
						Var27 = { Var1 };
						fVar28 = fVar2;
						if (!uParam2->f_50)
						{
...
void func_143(var uParam0, var uParam1, var uParam2, struct<3> Param3)//Position - 0xC04B
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_144(struct<3> Param0, float fParam1, int iParam2, int iParam3, int iParam4)//Position - 0xC0CF
{
...
int func_145(struct<3> Param0, int iParam1, int iParam2)//Position - 0xC100
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_146(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xC1C2
{
	int iVar0;
	int iVar1;
	bool bVar2;
		...
		if (!iParam2 == iVar0 || iParam3 == 1)
		{
			...
			if (!bVar2)
			{
				if (func_329(iVar1, 0, 1) && func_329(iParam2, 0, 1))
				{
					...
					else if (SYSTEM::VDIST(func_255(iVar1), Param0) < 1f)
					{
						return 1;
					}
				}
				...
				{
					if (SYSTEM::VDIST(func_255(iVar1), Param0) < 1f)
					{
						return 1;
					}
				}
...
void func_147(int iParam0, struct<3> Param1, int iParam2, var* uParam3, float* fParam4, var uParam5, bool bParam6, int iParam7, int iParam8, float fParam9, float fParam10, bool bParam11)//Position - 0xC2DF
{
	int iVar0;
	...
	while (iVar0 < 30)
	{
		*iParam2 = MISC::GET_RANDOM_INT_IN_RANGE((1 + iParam0), (40 + iParam0));
		if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(Param1, *iParam2, uParam3, fParam4, &iParam7, iParam8, fParam9, fParam10))
		{
			...
			{
				*uParam3 = { func_168(*uParam3, fParam4, iParam7, uParam5->f_9, *uParam5, bParam6, uParam5->f_11, uParam5->f_34, &bParam11, 0, 0, uParam5->f_51, uParam5->f_60) };
				if (!func_173(*uParam3))
				{
					iVar0 = 999;
					return;
...
void func_150(struct<3> Param0, float fParam1, int iParam2)//Position - 0xC422
{
	struct<3> Var0;
	var uVar1;
...
int func_151(struct<3> Param0, float fParam1, float fParam2)//Position - 0xC48F
{
	int iVar0;
	struct<3> Var1;
	int iVar2;
...
int func_152(int iParam0)//Position - 0xC4F7
{
	if (func_329(iParam0, 0, 1))
	{
		if (!func_159(iParam0))
		{
			if (NETWORK::NETWORK_ARE_PLAYERS_IN_SAME_TUTORIAL_SESSION(PLAYER::PLAYER_ID(), iParam0))
			{
				...
				{
					if (func_156(PLAYER::PLAYER_ID(), 1, 0))
					{
...
int func_153(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC5A5
{
	bool bVar0;
	bool bVar1;
...
int func_154(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0xC8F0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_155(int iParam0)//Position - 0xCA1C
{
	return BitTest(Global_1853910[iParam0 /*862*/].f_36.f_18, 14);
}

int func_156(int iParam0, bool bParam1, bool bParam2)//Position - 0xCA34
{
	if (bParam1)
	{
		if (func_157(iParam0))
...
bool func_157(int iParam0)//Position - 0xCA66
{
	return func_158(iParam0);
}

var func_158(int iParam0)//Position - 0xCA74
{
	return BitTest(Global_1853910[iParam0 /*862*/].f_11.f_1, 0);
}

int func_159(int iParam0)//Position - 0xCA8B
{
...
int func_161(struct<3> Param0, float fParam1, int iParam2)//Position - 0xCAD8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_162(struct<3> Param0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCBE4
{
...
int func_163(struct<3> Param0, var uParam1)//Position - 0xCC1A
{
	if (uParam1->f_18)
	{
		switch (uParam1->f_26)
...
int func_164(struct<3> Param0, struct<3> Param1, struct<3> Param2, bool bParam3, bool bParam4)//Position - 0xCCAB
{
...
bool func_166(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)//Position - 0xCDB8
{
	if (bParam3 && bParam4)
	{
		Param0.f_2 = 0f;
...
int func_167(struct<3> Param0, float fParam1)//Position - 0xCE6B
{
	int iVar0;
	...
	if (func_156(PLAYER::PLAYER_ID(), 1, 0))
	{
		...
		if (Global_1058070.f_268 > 0)
		{
			...
			while (iVar0 < Global_1058070.f_268)
			{
				...
				{
					if (func_118(Param0, ENTITY::GET_ENTITY_COORDS(Global_1058070.f_233[iVar0], true), ENTITY::GET_ENTITY_HEADING(Global_1058070.f_233[iVar0]), ENTITY::GET_ENTITY_MODEL(Global_1058070.f_233[iVar0]), 0.5f))
					{
						return 1;
					}
				}
		...
		if (Global_1058070.f_266 > 0)
		{
			...
			while (iVar0 < Global_1058070.f_266)
			{
				...
				{
					if (func_118(Param0, ENTITY::GET_ENTITY_COORDS(Global_1058070.f_119[iVar0], true), ENTITY::GET_ENTITY_HEADING(Global_1058070.f_119[iVar0]), ENTITY::GET_ENTITY_MODEL(Global_1058070.f_119[iVar0]), 0.5f))
					{
						return 1;
					}
				}
...
Vector3 func_168(struct<3> Param0, float* fParam1, int iParam2, bool bParam3, struct<3> Param4, bool bParam5, bool bParam6, int iParam7, var uParam8, int iParam9, bool bParam10, bool bParam11, var uParam12)//Position - 0xD0FF
{
	struct<3> Var0;
	var uVar1;
	var uVar2;
	...
	if (bParam11)
	{
		...
		{
			if (!func_171(Param0, *fParam1, Param4))
			{
	...
	if (uVar2 & 1024 == 0 && !bParam6)
	{
		...
		if (bParam10)
		{
			...
			if (VEHICLE::IS_THIS_MODEL_A_HELI(iParam7) && func_170(Param0))
			{
				return 0f, 0f, 0f;
			}
		}
...
float func_169(int iParam0, float fParam1)//Position - 0xD54E
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_170(struct<3> Param0)//Position - 0xD585
{
	float fVar0;
...
int func_171(struct<3> Param0, float fParam1, struct<3> Param2)//Position - 0xD5BD
{
	struct<3> Var0;
	struct<3> Var1;
...
float func_172(struct<3> Param0, struct<3> Param1)//Position - 0xD5F9
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

int func_173(struct<3> Param0)//Position - 0xD61A
{
	int iVar0;
	int iVar1;
...
bool func_174(struct<3> Param0, var uParam1)//Position - 0xD695
{
	return OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, *uParam1, uParam1->f_3, uParam1->f_6, false, true);
}

int func_175(struct<2> Param0, var uParam1)//Position - 0xD6B5
{
...
int func_176(var uParam0, bool bParam1)//Position - 0xD750
{
	var uVar0;
	struct<3> Var1;
	float fVar2;
...
int func_177(struct<3> Param0, var uParam1)//Position - 0xD7E8
{
	int iVar0;
	int iVar1;
...
int func_178(struct<3> Param0, var uParam1, float fParam2, bool bParam3, bool bParam4)//Position - 0xD84C
{
	switch (uParam1->f_10)
	{
		case 0:
...
void func_181(var uParam0, struct<3> Param1, float fParam2, float fParam3, bool bParam4, float fParam5)//Position - 0xD9EF
{
	struct<3> Var0;
	struct<3> Var1;
	...
	else
	{
		...
		if (fParam5 == 0f)
		{
			func_125(&Var0, 0f, 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 360f));
		}
		else
		{
...
int func_182(struct<3> Param0)//Position - 0xDA97
{
	float fVar0;
...
Vector3 func_184(struct<3> Param0, struct<3> Param1, struct<3> Param2, float fParam3, int iParam4, float fParam5, bool bParam6)//Position - 0xDBC2
{
	int iVar0;
	struct<3> Var1;
...
void func_185(var uParam0, struct<3> Param1, struct<3> Param2, float fParam3, float fParam4, bool bParam5)//Position - 0xDCC5
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
Vector3 func_186(struct<3> Param0, struct<3> Param1)//Position - 0xDF94
{
...
void func_187(var uParam0, struct<2> Param1, var uParam2, struct<2> Param3, var uParam4, float fParam5, bool bParam6)//Position - 0xDFCD
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
int func_188(struct<3> Param0, var uParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xE0CC
{
	int iVar0;
	bool bVar1;
...
int func_189(var uParam0, bool bParam1, bool bParam2)//Position - 0xE188
{
	int iVar0;
	var uVar1;
	struct<3> Var2;
...
void func_190(var uParam0, var uParam1, float fParam2, bool bParam3, bool bParam4)//Position - 0xE20C
{
	if (bParam4)
	{
		switch (uParam1->f_10)
...
int func_191(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE316
{
	int iVar0;
	struct<3> Var1;
...
int func_192(var uParam0, var uParam1, var uParam2)//Position - 0xE3F1
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (iVar2 > -1 && iVar2 < 101)
			{
				...
				if (SYSTEM::VMAG(Var3) > 0f)
				{
					if ((uParam2->f_57 && SYSTEM::VDIST(Var3, uParam2->f_35) > uParam2->f_4) || uParam2->f_57 == 0)
					{
						...
						{
							if ((uParam2->f_12 && !func_162(Var3, fVar4, uParam2->f_34, PLAYER::PLAYER_ID(), 0, uParam2->f_56)) || !uParam2->f_12)
							{
...
void func_195(struct<3> Param0)//Position - 0xEB4E
{
	float fVar0;
	var uVar1;
	int iVar2;
...
int func_196(struct<3> Param0, float fParam1, float fParam2)//Position - 0xEB89
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_197(struct<3> Param0, float fParam1, int iParam2, int iParam3, int iParam4)//Position - 0xEBEB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_198(struct<3> Param0, int iParam1, struct<3> Param2, int iParam3)//Position - 0xECC5
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_199(struct<3> Param0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, bool bParam6, int iParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, float fParam12, bool bParam13, float fParam14, bool bParam15, bool bParam16)//Position - 0xED05
{
...
int func_200(struct<3> Param0, float fParam1, int iParam2, int iParam3, float fParam4, bool bParam5, int iParam6, float fParam7, bool bParam8)//Position - 0xEE17
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (iParam2 && !bParam5)
	{
		if (func_329(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_201(PLAYER::PLAYER_ID()), Param0, true) <= (fVar2 + fParam1))
				{
				...
				if (iParam2 == 1 || (iParam2 == 0 && iVar1 != PLAYER::PLAYER_ID()))
				{
					if ((func_133(iVar1) || !bParam8) && !Global_2657589[iVar1 /*466*/].f_270)
					{
						...
						if (!bParam5)
						{
							...
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_201(iVar1), Param0, true) <= (fVar2 + fParam1))
								{
...
Vector3 func_201(int iParam0)//Position - 0xEFCF
{
	int iVar0;
...
int func_202(struct<3> Param0)//Position - 0xF022
{
...
var func_203()//Position - 0xF04C
{
	return Global_2683862.f_19;
}

int func_204(struct<3> Param0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, var uParam7, int iParam8)//Position - 0xF05A
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam6 == 1 && PLAYER::PLAYER_ID() != iVar1) || iParam6 == 0)
		{
			if (func_329(iVar1, bParam2, bParam3))
			{
				...
				{
					if (!bParam5 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_133(iVar1)))
					{
						if ((!bParam4 || (bParam4 == 1 && PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) != PLAYER::GET_PLAYER_TEAM(iVar1))) || PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1)
						{
							if (((PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1 && uParam7) && bParam4) && func_128(iVar1))
							{
							}
							else if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(iVar1)))
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_255(iVar1), Param0, true) < fParam1)
								{
									return 1;
								}
							}
...
int func_205(struct<3> Param0)//Position - 0xF15E
{
	var uVar0;
...
int func_206(struct<3> Param0, var uParam1)//Position - 0xF184
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_207(int iParam0)//Position - 0xF1E8
{
	int iVar0;
	int iVar1;
	...
	if (func_216(PLAYER::PLAYER_ID(), 0) || (func_213(PLAYER::PLAYER_ID()) && func_71(func_212(PLAYER::PLAYER_ID())) == 12))
	{
		return 1;
	}
	if (func_211(PLAYER::PLAYER_ID()) || (func_213(PLAYER::PLAYER_ID()) && func_71(func_212(PLAYER::PLAYER_ID())) == 8))
	{
		return 1;
	}
	if (func_210(PLAYER::PLAYER_ID()) || (func_213(PLAYER::PLAYER_ID()) && func_71(func_212(PLAYER::PLAYER_ID())) == 5))
	{
		return 1;
	}
	if (func_209(PLAYER::PLAYER_ID()) || (func_213(PLAYER::PLAYER_ID()) && func_71(func_212(PLAYER::PLAYER_ID())) == 10))
	{
		return 1;
	}
	if (func_208(PLAYER::PLAYER_ID()) || (func_213(PLAYER::PLAYER_ID()) && func_71(func_212(PLAYER::PLAYER_ID())) == 6))
	{
		return 1;
	}
	return 0;
...
int func_208(int iParam0)//Position - 0xF350
{
	if (iParam0 != func_105())
	{
		if (func_329(iParam0, 1, 1))
...
int func_209(int iParam0)//Position - 0xF396
{
	if (iParam0 != func_105())
	{
		if (func_329(iParam0, 1, 1))
...
int func_210(int iParam0)//Position - 0xF3DD
{
	if (iParam0 != func_105())
	{
		if (func_329(iParam0, 1, 1))
...
int func_211(int iParam0)//Position - 0xF43C
{
	if (iParam0 != func_105())
	{
		if (func_329(iParam0, 1, 1))
...
int func_212(int iParam0)//Position - 0xF49C
{
...
int func_213(int iParam0)//Position - 0xF4CD
{
	if (iParam0 != func_105() && func_329(iParam0, 1, 1))
	{
...
int func_214(int iParam0)//Position - 0xF506
{
	if (iParam0 != func_105() && func_329(iParam0, 1, 1))
	{
...
int func_215(int iParam0)//Position - 0xF537
{
	if (iParam0 != func_105() && func_329(iParam0, 1, 1))
	{
...
int func_216(int iParam0, bool bParam1)//Position - 0xF568
{
	int iVar0;
...
int func_218(struct<3> Param0, int iParam1)//Position - 0xF647
{
	int iVar0;
...
void func_219(struct<3> Param0, int iParam1)//Position - 0xF69B
{
	int iVar0;
	int iVar1;
	int iVar2[3];
	...
	if (!func_237())
	{
		...
		if (iVar1 > -1)
		{
			...
			switch (iVar1)
			{
				...
				case 30:
					if (func_232(iParam1))
					{
						func_233(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_267.f_33);
					}
					break;
		...
		else if (func_229(Param0, &iVar2, &iVar3) || (func_206(Param0, &(iVar2[0])) && (VEHICLE::IS_THIS_MODEL_A_PLANE(iParam1) || VEHICLE::IS_THIS_MODEL_A_HELI(iParam1))))
		{
			func_248();
			iVar0 = 0;
			while (iVar0 < iVar2)
			{
				...
				{
					if (((func_227(PLAYER::PLAYER_PED_ID()) || func_226(PLAYER::PLAYER_PED_ID())) && VEHICLE::IS_THIS_MODEL_A_PLANE(iParam1)) || VEHICLE::IS_THIS_MODEL_A_HELI(iParam1))
					{
						if (func_225(iParam1))
						{
...
void func_220(int iParam0, int iParam1)//Position - 0x10496
{
	switch (iParam0)
	{
		case 23:
...
void func_221(struct<3> Param0, float fParam1, int iParam2, bool bParam3)//Position - 0x14370
{
	struct<2> Var0;
	struct<2> Var1;
	float fVar2;
...
int func_223(int iParam0)//Position - 0x159B9
{
	switch (iParam0)
	{
		case joaat("microlight"):
...
int func_225(int iParam0)//Position - 0x16039
{
	switch (iParam0)
	{
		case joaat("hydra"):
...
int func_226(int iParam0)//Position - 0x160D7
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
int func_227(int iParam0)//Position - 0x16115
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
int func_228(int iParam0, int iParam1)//Position - 0x16153
{
	if (iParam1 == -1)
	{
		switch (iParam0)
...
int func_229(struct<2> Param0, var uParam1, var uParam2, var uParam3)//Position - 0x16230
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_230(int iParam0)//Position - 0x16396
{
	int iVar0;
	int iVar1;
...
int func_232(int iParam0)//Position - 0x16491
{
...
void func_235(struct<3> Param0, float fParam1)//Position - 0x176C8
{
...
int func_236(struct<3> Param0)//Position - 0x1772D
{
	int iVar0;
...
int func_238(struct<2> Param0, var uParam1, bool bParam2, float fParam3)//Position - 0x177F7
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_240(var uParam0, bool bParam1)//Position - 0x178A4
{
	int iVar0;
	struct<3> Var1;
...
int func_241(struct<3> Param0)//Position - 0x17941
{
	int iVar0;
	struct<3> Var1;
...
Vector3 func_242(var uParam0)//Position - 0x17A01
{
	switch (uParam0->f_10)
	{
		case 0:
...
int func_243(struct<3> Param0, float fParam1)//Position - 0x17A4A
{
	int iVar0;
...
int func_244(struct<3> Param0, float fParam1)//Position - 0x17A92
{
	int iVar0;
...
bool func_245(int iParam0, bool bParam1)//Position - 0x17AD9
{
	if (func_40() != 0)
	{
...
int func_246(int iParam0)//Position - 0x17B00
{
	if (func_329(iParam0, 0, 1))
	{
...
int func_250()//Position - 0x17C25
{
	if (!Global_2635559.f_606 == 0 && NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635559.f_611) < func_247(0))
	{
		return 1;
	}
	return 0;
...
int func_251()//Position - 0x17C59
{
	...
	if (!func_253(PLAYER::PLAYER_ID()) && !func_252(0))
	{
		return 0;
	}
	return 1;
...
int func_253(int iParam0)//Position - 0x17CC1
{
	if (iParam0 == -1)
	{
		return 0;
...
Vector3 func_255(int iParam0)//Position - 0x17CF0
{
...
void func_256(int iParam0)//Position - 0x17D03
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	MISC::SET_BIT(&(Local_85.f_2[iVar0]), iVar1);
}

void func_257(int iParam0)//Position - 0x17D32
{
	if (!NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		return;
...
void func_258()//Position - 0x17D4B
{
	...
	if (func_260(NETWORK::PARTICIPANT_ID()) != 3 && func_20() == 3)
	{
		func_259(3);
	}
...
{
	Local_87[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1 = iParam0;
}

int func_260(int iParam0)//Position - 0x17DD1
{
...
bool func_266(int iParam0)//Position - 0x17E73
{
	return func_6(iParam0, 11);
}

int func_267()//Position - 0x17E83
{
	if (func_5(PLAYER::PLAYER_ID()))
	{
		return 0;
...
bool func_268(int iParam0, int iParam1)//Position - 0x17EDD
{
	int iVar0;
	int iVar1;
...
var func_273(int iParam0)//Position - 0x17F59
{
...
void func_274()//Position - 0x17F69
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && func_280(PLAYER::PLAYER_PED_ID(), func_16(), 120f, 1))
	{
		if (!func_268(NETWORK::PARTICIPANT_ID(), 1))
		{
			func_279(1);
	...
	else if (func_268(NETWORK::PARTICIPANT_ID(), 1))
	{
		func_278(1);
	}
	if (!func_268(NETWORK::PARTICIPANT_ID(), 0) && func_275())
	{
		func_279(0);
	}
}

int func_275()//Position - 0x17FE0
{
	if (func_272())
	{
		if (!func_280(PLAYER::PLAYER_PED_ID(), func_16(), 1000f, 1))
		{
			return 1;
		}
		if (func_277(PLAYER::PLAYER_ID(), 1, 1))
		{
			return 1;
		}
...
int func_276(int iParam0)//Position - 0x1804D
{
...
int func_277(int iParam0, bool bParam1, bool bParam2)//Position - 0x18086
{
	if (iParam0 == func_105())
	{
		return 0;
...
void func_278(int iParam0)//Position - 0x180EA
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	MISC::CLEAR_BIT(&(Local_87[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2[iVar0]), iVar1);
}
...
void func_279(int iParam0)//Position - 0x18114
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	MISC::SET_BIT(&(Local_87[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2[iVar0]), iVar1);
}

bool func_280(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x1813E
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), ENTITY::GET_ENTITY_COORDS(iParam1, bParam3)) <= (fParam2 * fParam2);
}

int func_281()//Position - 0x18160
{
	if (func_7())
	{
		return 1;
...
void func_282()//Position - 0x18174
{
	...
	if (iVar0 != func_284())
	{
		switch (func_284())
		{
			...
			case 0:
				if ((func_272() && !func_268(NETWORK::PARTICIPANT_ID(), 0)) && iVar0 == 2)
				{
					func_279(0);
				}
				break;
...
int func_286(int iParam0)//Position - 0x18225
{
	if (iParam0 != func_105())
	{
		if (Global_1894573[iParam0 /*608*/].f_10 != func_105())
...
bool func_288(int iParam0, bool bParam1)//Position - 0x1826C
{
	if (!bParam1)
	{
		if (func_286(iParam0))
...
void func_289()//Position - 0x18297
{
	...
	switch (func_19())
	{
		...
		case 3:
			if (((!func_12(4) && !func_268(NETWORK::PARTICIPANT_ID(), 3)) && func_7()) && !ENTITY::IS_ENTITY_VISIBLE(func_16()))
			{
				func_279(3);
			}
			break;
...
void func_290(int iParam0)//Position - 0x183C0
{
	int iVar0;
...
int func_291(int iParam0)//Position - 0x183F9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_292(int iParam0)//Position - 0x18440
{
...
int func_293(int iParam0)//Position - 0x18475
{
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iParam0))
	{
...
void func_294()//Position - 0x18497
{
	if (func_300())
	{
		...
		{
			iLocal_92 = HUD::ADD_BLIP_FOR_ENTITY(func_16());
			HUD::SET_BLIP_SPRITE(iLocal_92, func_299());
			func_296(&iLocal_92, func_298());
			HUD::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_92, func_295());
		}
	}
...
void func_296(int iParam0, int iParam1)//Position - 0x184F5
{
	int iVar0;
...
int func_297(int iParam0)//Position - 0x1851B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_299()//Position - 0x1878D
{
	return 225;
}

int func_300()//Position - 0x18797
{
	if (!NETWORK::NETWORK_DOES_ENTITY_EXIST_WITH_NETWORK_ID(func_10()))
	{
		return 0;
...
{
	Local_87[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/] = iParam0;
}

int func_302()//Position - 0x187EE
{
	func_303();
	return 1;
}
...
int func_305(int iParam0)//Position - 0x18813
{
...
void func_306()//Position - 0x18821
{
	...
	while (iVar0 < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar0))
		{
			...
			iVar1 = NETWORK::NETWORK_GET_PLAYER_INDEX(iLocal_88[iVar0]);
			if (func_329(iVar1, 0, 1))
			{
				if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
				{
					if (!bVar2)
...
void func_307(int iParam0)//Position - 0x1893D
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	MISC::CLEAR_BIT(&(Local_85.f_2[iVar0]), iVar1);
}

int func_308()//Position - 0x1896C
{
	return -1;
}
...
int func_310()//Position - 0x18994
{
	...
	if (func_311() != 0)
	{
		if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(func_311()) == 0)
		{
			return 1;
		}
	}
...
int func_314(int iParam0)//Position - 0x18A7E
{
...
void func_320(int iParam0)//Position - 0x18B42
{
	int iVar0;
...
bool func_323(int iParam0)//Position - 0x18B82
{
...
int func_325(struct<21> Param0)//Position - 0x18BB1
{
	func_328(8, Param0);
	NETWORK::RESERVE_NETWORK_MISSION_VEHICLES(1);
	func_326(0, -1, 0);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_85, 8, 0);
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&Local_87, 33, 0);
	MISC::SET_THIS_SCRIPT_CAN_BE_PAUSED(false);
	return 1;
}

int func_326(int iParam0, int iParam1, bool bParam2)//Position - 0x18BE8
{
	int iVar0;
...
void func_328(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x18D0A
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_327();
...
int func_329(int iParam0, bool bParam1, bool bParam2)//Position - 0x18D29
{
	int iVar0;
