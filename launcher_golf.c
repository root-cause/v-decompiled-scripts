				...
				case 3:
					...
					else
					{
						...
						if (!func_76(3) && !Global_101722)
						{
							...
							{
								if ((!func_90(uLocal_92, 1) || !ENTITY::DOES_ENTITY_EXIST(func_75())) && !Global_101722)
								{
									func_83(10);
									break;
								}
...
void func_10(int* iParam0)//Position - 0xD10
{
	iParam0->f_1 = 0f;
	iParam0->f_2 = 0f;
	*iParam0 = 0;
...
float func_11(int* iParam0)//Position - 0xD26
{
	if (func_14(iParam0))
	{
		if (func_13(iParam0))
...
int func_18(bool bParam0)//Position - 0xE26
{
...
void func_21(int* iParam0)//Position - 0xFED
{
	if (!func_14(iParam0))
	{
		func_24(iParam0);
...
void func_22(int* iParam0)//Position - 0x100E
{
	func_23(iParam0, 0f);
}

void func_23(int* iParam0, float fParam1)//Position - 0x101D
{
...
void func_24(int* iParam0)//Position - 0x1048
{
	if (!func_14(iParam0))
	{
		func_22(iParam0);
...
int func_32(int iParam0, int iParam1, int iParam2)//Position - 0x12BA
{
...
int func_36(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x13E7
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x156D
{
	if (Global_44181 == 15)
	{
		return 0;
...
int func_40(int iParam0)//Position - 0x15D0
{
	return Global_114135.f_24908[iParam0 /*4*/];
}

int func_41(int iParam0, bool bParam1)//Position - 0x15E3
{
	int iVar0;
...
void func_43(int iParam0)//Position - 0x16D6
{
	int iVar0;
...
void func_45(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x1749
{
	int iVar0;
...
int func_46(int iParam0)//Position - 0x1874
{
...
void func_50()//Position - 0x193E
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_53(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_51(iVar0) && (!func_78(14) || Global_113083))
			{
...
bool func_51(int iParam0)//Position - 0x1A3B
{
	return iParam0 < 3;
}
...
var func_54(int iParam0)//Position - 0x1AA9
{
...
var func_56()//Position - 0x1ADA
{
	return Global_76640;
}

int func_57(int iParam0)//Position - 0x1AE6
{
	if (iParam0 == 1)
	{
...
var func_58(int iParam0, int iParam1)//Position - 0x1B3D
{
	switch (iParam0)
	{
		case 5:
...
void func_63(var uParam0, var uParam1)//Position - 0x1BDD
{
	*uParam0 = (*uParam0 || uParam1);
}

int func_64()//Position - 0x1BEE
{
	if (func_78(6) || func_78(7))
	{
		return func_77(68);
...
int func_66(int iParam0)//Position - 0x1D1D
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_73()) || Global_33090) || func_72()) || func_58(8, -1)) || func_69()) || func_71()) || func_70()) || func_60()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_73()) || Global_113182) || Global_33090) || func_72()) || func_58(8, -1)) || func_69()) || func_71()) || func_70()) || func_60()) || Global_114135.f_7692.f_919[iVar0] == 5) || Global_44728 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_73()) || Global_113182) || Global_33090) || func_72()) || func_58(8, -1)) || func_71()) || func_70()) || func_60()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_73() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_58(8, -1)) || func_60()) || func_68()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_73()) || Global_33090) || func_72()) || func_58(8, -1)) || func_70()) || func_69()) || func_60()) || Global_114135.f_7692.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_73()) || func_70()) || Global_113182) || Global_33090) || func_72()) || Global_45392) || func_58(8, -1)) || func_69()) || func_68()) || func_60()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_73()) || Global_113182) || Global_33090) || func_72()) || func_58(8, -1)) || func_69()) || func_68()) || func_71()) || func_70()) || func_60())
						{
							return 0;
						}
						break;
...
var func_67()//Position - 0x243A
{
	return Global_101727.f_1;
}

int func_68()//Position - 0x2448
{
	if (Global_98585 != -1)
	{
...
var func_72()//Position - 0x24B7
{
	return Global_1575084;
}

int func_73()//Position - 0x24C3
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_76(int iParam0)//Position - 0x2505
{
	switch (iParam0)
	{
		case 0:
...
int func_87(int iParam0, int iParam1)//Position - 0x2737
{
	int iVar0;
...
bool func_88(int iParam0)//Position - 0x2781
{
	return func_89(iParam0, Global_44181);
}

int func_89(int iParam0, int iParam1)//Position - 0x2792
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_90(var uParam0, int iParam1)//Position - 0x2973
{
...
void func_94(var uParam0, int iParam1)//Position - 0x2B26
{
	func_95(uParam0, iParam1);
}

void func_95(var uParam0, var uParam1)//Position - 0x2B36
{
