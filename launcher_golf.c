...
void __EntryFunction__()//Position - 0x0
{
	...
	if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_90(uLocal_66, 4194304))
	{
		if (iLocal_77 != 263)
		{
				...
				case 3:
					...
					else
					{
						...
						if (!func_76(3) && !Global_100475)
						{
							...
							{
								if ((!func_90(uLocal_66, 1) || !ENTITY::DOES_ENTITY_EXIST(func_75())) && !Global_100475)
								{
									func_83(10);
									break;
								}
