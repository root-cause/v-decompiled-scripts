...
void __EntryFunction__()//Position - 0x0
{
	...
	func_494();
	iLocal_1016 = 4;
	Local_804 = { func_492(iLocal_1016) };
	func_507(&Local_120, 16);
	func_507(&Local_120, 2);
	Local_120.f_3 = 750;
	...
	if (func_497())
	{
		...
		if (iLocal_1778 == 0)
		{
			if (bLocal_1749)
			{
				...
				iVar0 = func_423(Local_1964, fLocal_1967);
		...
		else if (iLocal_1778 == 1)
		{
			if (bLocal_1749)
			{
				...
				iVar1 = func_423(Local_1968, fLocal_1971);
		...
		else if (iLocal_1778 == 3)
		{
			...
			CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(90f);
			CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
			func_422(Local_1960, fLocal_1963, 1, 0);
		}
...
void func_1()//Position - 0x605
{
	...
	switch (iLocal_1033)
	{
		...
		case 4:
			...
			func_402();
			func_401();
			func_400(&uLocal_2008, 1, iLocal_1804, "FRANKLIN", 0, 1);
			iLocal_1033 = 5;
			break;
...
void func_3(int iParam0)//Position - 0x8EE
{
	int iVar0;
	
	if (Global_114370.f_9088 || func_18(0))
	{
		iVar0 = func_17();
		if (!func_4(iVar0))
		{
...
int func_4(int iParam0)//Position - 0x933
{
	int iVar0;
	int iVar1;
	...
	func_5(&(Global_114370.f_2366.f_539), iVar1);
...
void func_5(var uParam0, int iParam1)//Position - 0xA43
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_7(Global_114370.f_18536[iVar0], &Var2, &fVar5))
			{
...
int func_7(int iParam0, var uParam1, float fParam2)//Position - 0xC17
{
	switch (iParam0)
	{
		case 11:
...
bool func_13(int iParam0)//Position - 0x17CF
{
	return iParam0 < 3;
}

int func_14(int iParam0)//Position - 0x17DB
{
	int iVar0;
	int iVar1;
...
int func_15(int iParam0)//Position - 0x1818
{
	if (func_13(iParam0))
	{
...
var func_16(int iParam0)//Position - 0x183D
{
...
int func_18(bool bParam0)//Position - 0x187E
{
...
void func_21(struct<3> Param0, float fParam3)//Position - 0x190D
{
	func_22(&(Global_107917.f_2890), Param0, fParam3);
}

void func_22(var uParam0, struct<3> Param1, var uParam4)//Position - 0x1926
{
	*uParam0 = { Param1 };
	uParam0->f_6 = uParam4;
}

void func_23(struct<3> Param0, float fParam3)//Position - 0x193C
{
	if (func_24(Global_79489, 0f, 0f, 0f, 0))
	{
		Global_79489 = { Param0 };
...
bool func_24(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x1968
{
	if (bParam6)
	{
...
int func_25(var uParam0)//Position - 0x19AF
{
	struct<3> Var0;
...
int func_26(var uParam0, struct<3> Param1, char* sParam4, float fParam5)//Position - 0x1AA3
{
	float fVar0;
...
float func_27(int* iParam0)//Position - 0x1B2A
{
	if (func_30(iParam0))
	{
		if (func_29(iParam0))
...
bool func_30(int* iParam0)//Position - 0x1BCB
{
	return BitTest(*iParam0, 1);
}

void func_31(int* iParam0)//Position - 0x1BD8
{
	func_32(iParam0, 0f);
}

void func_32(int* iParam0, float fParam1)//Position - 0x1BE7
{
...
void func_33(char* sParam0, int iParam1, int iParam2)//Position - 0x1C12
{
	iParam2 = iParam2;
...
float func_34(struct<3> Param0, bool bParam3)//Position - 0x1C2B
{
	return func_35(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), Param0, bParam3);
}

float func_35(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x1C45
{
...
int func_37(int iParam0, float fParam1, float fParam2)//Position - 0x1C97
{
	int iVar0;
	float fVar1;
...
float func_38(int iParam0, bool bParam1)//Position - 0x1D3E
{
	return func_39(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), iParam0, bParam1);
}

float func_39(int iParam0, int iParam1, bool bParam2)//Position - 0x1D56
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_42(int iParam0, int iParam1)//Position - 0x1E62
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
			...
			switch (iLocal_1766)
			{
				...
				case 1:
					if (iLocal_1765 >= 2)
					{
						...
						if (iLocal_1807 != 0)
						{
							func_400(&uLocal_2008, 5, iLocal_1807, "OJAcsGUARD2", 0, 1);
				...
				case 2:
					if (iLocal_1765 > 3 || bLocal_1722)
					{
						...
						if (iLocal_1807 != 0)
						{
							func_400(&uLocal_2008, 7, iLocal_1807, "OJAcsGUARD4", 0, 1);
							if ((MISC::GET_RANDOM_INT_IN_RANGE(0, 65535) % 2) == 0)
							{
						...
						if (func_27(&iLocal_1982) > 8f)
						{
							if (func_63(&Local_1359, 6) >= 2)
							{
								...
								if (iLocal_1807 != 0)
								{
									if (PED::CAN_PED_SEE_HATED_PED(iLocal_1807, PLAYER::PLAYER_PED_ID()))
									{
										func_400(&uLocal_2008, 6, iLocal_1807, "OJAcsGUARD3", 0, 1);
										if ((MISC::GET_RANDOM_INT_IN_RANGE(0, 65535) % 2) == 0)
										{
				...
				case 6:
					if (func_63(&Local_1359, 6) >= 4)
					{
						...
						if (iLocal_1807 != 0)
						{
							if (PED::CAN_PED_SEE_HATED_PED(iLocal_1807, PLAYER::PLAYER_PED_ID()))
							{
								func_400(&uLocal_2008, 4, iLocal_1807, "OJAcsGUARD", 0, 1);
								if ((MISC::GET_RANDOM_INT_IN_RANGE(0, 65535) % 2) == 0)
								{
				...
				case 8:
					if (func_45(&Local_1359, 6) <= 2)
					{
						...
						if (iLocal_1807 != 0)
						{
							func_400(&uLocal_2008, 8, iLocal_1807, "OJAcsGUARD5", 0, 1);
							if ((MISC::GET_RANDOM_INT_IN_RANGE(0, 65535) % 2) == 0)
							{
				...
				case 10:
					if (ENTITY::DOES_ENTITY_EXIST(Local_1513[0 /*19*/]) && ENTITY::DOES_ENTITY_EXIST(iLocal_1805))
					{
						...
						{
							func_400(&uLocal_2008, 4, Local_1513[0 /*19*/], "OJAcsGUARD", 0, 1);
...
int func_45(int iParam0, int iParam1)//Position - 0x27FA
{
	int iVar0;
	int iVar1;
...
int func_46(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x283A
{
...
int func_47(char* sParam0, int iParam1, bool bParam2)//Position - 0x288E
{
	Global_22167 = 0;
...
bool func_50(int iParam0)//Position - 0x2BF6
{
	return func_51(iParam0, 20);
}

var func_51(int iParam0, int iParam1)//Position - 0x2C06
{
	return BitTest(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_52()//Position - 0x2C1E
{
	return -1;
}
...
void func_61(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2F35
{
...
void func_62(int* iParam0, float fParam1)//Position - 0x2F8B
{
	if (!func_30(iParam0))
	{
...
int func_63(int iParam0, int iParam1)//Position - 0x2FA5
{
	int iVar0;
	int iVar1;
...
bool func_64(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2FE4
{
...
void func_65(int iParam0)//Position - 0x3032
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		func_400(&uLocal_2008, 4, iParam0, "OJAcsGUARD", 0, 1);
...
int func_66(float fParam0)//Position - 0x309E
{
	int iVar0;
	struct<3> Var1;
	int iVar4;
...
void func_67(int* iParam0)//Position - 0x31B8
{
	if (!func_30(iParam0))
	{
		func_31(iParam0);
...
int func_70(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)//Position - 0x3403
{
	bool bVar0;
...
void func_71(int* iParam0)//Position - 0x35F7
{
	bool bVar0;
	struct<8> Var1;
...
int func_72(int iParam0)//Position - 0x3669
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iParam0, false))
...
void func_73(int iParam0, int iParam1)//Position - 0x368A
{
	int iVar0;
...
int func_75(int iParam0)//Position - 0x3872
{
	float fVar0;
...
int func_77(int iParam0, int iParam1)//Position - 0x3942
{
	int iVar0;
...
int func_78(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)//Position - 0x39D6
{
	int iVar0;
	bool bVar1;
...
int func_79(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0x3B00
{
	int iVar0;
	int iVar1;
...
int func_80(int iParam0, int iParam1)//Position - 0x3CC8
{
	int iVar0;
...
int func_81(int iParam0, int iParam1, var uParam2)//Position - 0x3D1D
{
...
int func_82(int iParam0, int iParam1, var uParam2, bool bParam3)//Position - 0x3D6B
{
	struct<3> Var0;
	int iVar3;
...
int func_83(int iParam0)//Position - 0x3EE4
{
	int iVar0;
	int iVar1;
...
int func_84(int iParam0, var uParam1)//Position - 0x3FB2
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
bool func_85(var uParam0, int iParam1)//Position - 0x4038
{
	...
	switch (iLocal_1078)
	{
		case 0:
			if (!iLocal_137)
			{
				...
				Global_114370.f_19966.f_9 = func_27(&iLocal_1979);
...
void func_89(bool bParam0, int iParam1)//Position - 0x421B
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (bParam0)
	{
		if ((func_18(0) && Global_79495.f_1 == 1) && func_90(Global_79495))
		{
		}
		else
		{
...
int func_90(int iParam0)//Position - 0x42EB
{
	switch (iParam0)
	{
		case 71:
...
void func_91(struct<25> Param0, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38)//Position - 0x4329
{
	float fVar0;
...
void func_92(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x4374
{
	int iVar0;
	int iVar1;
...
void func_96(bool bParam0)//Position - 0x4D21
{
	bool bVar0;
	char cVar1[64];
	...
	else if (BitTest(Global_114370.f_20567.f_471, bParam0) || BitTest(Global_2359296[func_98() /*5569*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_114370.f_20567.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_98() /*5569*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
char* func_97(bool bParam0)//Position - 0x4E9A
{
	switch (bParam0)
	{
		case 0:
...
int func_100(int iParam0, var uParam1)//Position - 0x4FD7
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_101(uParam1));
}

int func_101(var uParam0)//Position - 0x4FEC
{
	int iVar0;
	int iVar1;
...
void func_103(int iParam0, bool bParam1, int iParam2)//Position - 0x502C
{
	if (iParam2 == -1)
	{
		iParam2 = func_102();
...
int func_105(int iParam0)//Position - 0x506A
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	return BitTest(Global_2359296[func_98() /*5569*/].f_681.f_10, iParam0);
}
...
bool func_107(int iParam0, int iParam1)//Position - 0x5239
{
	if (iParam1 == -1)
	{
		iParam1 = func_102();
...
int func_111(var uParam0, int iParam1)//Position - 0x53C4
{
	int iVar0;
	var uVar1[78];
...
void func_116(var uParam0, float fParam1)//Position - 0x5545
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
int func_121(int iParam0)//Position - 0x55BB
{
	switch (iParam0)
	{
		case 60:
...
int func_122(int iParam0, int iParam1)//Position - 0x560B
{
	int iVar0;
...
void func_123(int iParam0, int iParam1)//Position - 0x565C
{
	int iVar0;
...
int func_126(int iParam0)//Position - 0x5751
{
...
float func_127()//Position - 0x5762
{
	...
	if (func_85(Global_114370.f_19966.f_1, 32768/*func_157*/))
	{
		fVar0 = (fVar0 + 0.2f);
	}
...
void func_130(int iParam0)//Position - 0x5942
{
...
void func_132(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)//Position - 0x5989
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
float func_135(bool bParam0, float fParam1, float fParam2)//Position - 0x5C69
{
	if (bParam0)
	{
		return fParam1;
...
void func_137(char* sParam0)//Position - 0x5C92
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
}

bool func_138(var uParam0, int iParam1)//Position - 0x5CA0
{
	return (uParam0 && iParam1) != 0;
}

int func_139(var uParam0)//Position - 0x5CAF
{
	if (*uParam0 != 0)
	{
...
int func_140(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4, bool bParam5)//Position - 0x5CD6
{
	bool bVar0;
...
void func_143(var uParam0, float fParam1, bool bParam2)//Position - 0x641C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_145(char* sParam0, char* sParam1, float fParam2, float fParam3, bool bParam4, int iParam5)//Position - 0x711C
{
...
void func_146(char* sParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, int iParam5)//Position - 0x7149
{
...
int func_147(int iParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)//Position - 0x7186
{
	char cVar0[64];
	char cVar16[64];
	int iVar32;
...
void func_149(bool bParam0, int* iParam1, int* iParam2, float fParam3)//Position - 0x7386
{
	float fVar0;
	float fVar1;
	float fVar2;
...
var func_151(int iParam0, bool bParam1)//Position - 0x7429
{
	char* sVar0[2];
	var uVar3;
	struct<13> Var19;
...
var func_152(var uParam0)//Position - 0x7951
{
	return uParam0;
}

struct<13> func_153(int iParam0)//Position - 0x795B
{
	struct<13> Var0;
...
void func_156(int iParam0, int iParam1, float fParam2, float fParam3, char* sParam4, int iParam5)//Position - 0x7C75
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_161(int iParam0, int iParam1)//Position - 0x8196
{
	return BitTest(Global_1669875.f_7064[iParam0], iParam1);
}

float func_162(char* sParam0, char* sParam1)//Position - 0x81AC
{
...
float func_163(char* sParam0)//Position - 0x81C7
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return (HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true) / 2f);
}
...
void func_165(char* sParam0)//Position - 0x8204
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
}
...
int func_172(int iParam0)//Position - 0x8375
{
	if (iParam0 == 1)
	{
		if (Global_20813.f_1 > 3)
...
int func_176(var uParam0, bool bParam1, int iParam2)//Position - 0x851E
{
...
void func_180()//Position - 0x8909
{
	...
	if (!iLocal_137)
	{
		func_186(&uLocal_148, &Local_729, &Global_64053, 0);
		...
		if (Global_95549)
		{
			...
			{
				if (Global_76134[iVar1 /*9*/] >= 0 && !Global_64263[Global_76134[iVar1 /*9*/] /*13*/].f_7)
				{
...
void func_191(int iParam0, int iParam1)//Position - 0x9350
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST((*iParam0)[iVar0 /*19*/]))
		{
			if (!PED::IS_PED_INJURED((*iParam0)[iVar0 /*19*/]))
			{
				if (ENTITY::IS_ENTITY_OCCLUDED((*iParam0)[iVar0 /*19*/]) || !ENTITY::IS_ENTITY_ON_SCREEN((*iParam0)[iVar0 /*19*/]))
				{
					if (!PED::IS_PED_INJURED((*iParam0)[iVar0 /*19*/]))
					{
						ENTITY::SET_ENTITY_HEALTH((*iParam0)[iVar0 /*19*/], 0, 0, 0);
					}
				}
				else
				{
...
int func_193()//Position - 0x9414
{
	if (!iLocal_1755)
	{
		func_400(&uLocal_2008, 3, 0, "LESTER", 0, 1);
...
bool func_195(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x947C
{
...
int func_199(int iParam0)//Position - 0x96FB
{
...
void func_201(bool bParam0, bool bParam1, int iParam2)//Position - 0x9770
{
	if (bParam0)
	{
...
void func_203(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x97D0
{
	if (bParam0)
	{
...
bool func_205(int iParam0, int iParam1)//Position - 0x9937
{
	bool bVar0;
...
int func_207(var uParam0)//Position - 0x99D1
{
	int iVar0;
...
int func_208(int iParam0)//Position - 0x99F3
{
...
int func_210(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x9A40
{
	int iVar0;
...
void func_212(int iParam0, int iParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, int iParam6)//Position - 0x9A96
{
	struct<3> Var0;
	float fVar3;
	int iVar4;
...
void func_213(int iParam0, int iParam1)//Position - 0x9C02
{
	if (*iParam0 == -1)
	{
...
void func_214(char* sParam0, int iParam1, bool bParam2, int iParam3, float fParam4, float fParam5, float fParam6, char* sParam7)//Position - 0x9C29
{
	func_221(iParam1);
	if (bParam2)
	{
...
int func_216(int iParam0, var uParam1, float fParam2)//Position - 0x9DD7
{
	struct<3> Var0;
...
void func_218(int iParam0, int iParam1)//Position - 0x9F87
{
	int iVar0;
...
void func_220(int iParam0, bool bParam1, int iParam2)//Position - 0xA023
{
...
void func_221(int iParam0)//Position - 0xA07C
{
	if (*iParam0 != -1)
	{
...
bool func_222(char* sParam0)//Position - 0xA09D
{
...
int func_224(struct<3> Param0)//Position - 0xA0CD
{
...
void func_226(char* sParam0, int iParam1)//Position - 0xA154
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

bool func_227(char* sParam0, int iParam1, char* sParam2)//Position - 0xA16B
{
...
int func_228(int iParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0xA189
{
	if (!*iParam0)
	{
...
void func_231()//Position - 0xA2BF
{
	...
	switch (iLocal_1763)
	{
		case 0:
			...
			{
				TASK::TASK_ENTER_VEHICLE(iLocal_1805, iLocal_1975, 20000, 0, 2f, 1, 0, 0);
			}
			if (bLocal_1739)
			{
	...
	if (!iLocal_1736)
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_1513[3 /*19*/], false))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_1513[3 /*19*/], PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_INJURED(Local_1513[3 /*19*/]))
			{
				...
				ENTITY::SET_ENTITY_HEALTH(Local_1513[3 /*19*/], 0, 0, 0);
				iLocal_1736 = 1;
			}
		}
	}
	...
	if (bLocal_1739)
	{
		if (!bLocal_1732)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_1975))
			{
				...
				func_400(&uLocal_2008, 3, iLocal_1805, "MAFIABOSS", 0, 1);
				PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1805, 3, false);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(Local_1474[iVar0 /*19*/]))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_1790[1]))
				{
					if (iVar0 == 0)
					{
						...
						func_400(&uLocal_2008, 4, Local_1474[iVar0 /*19*/], "OJAcsGUARD", 0, 1);
					}
					else if (iVar0 == 1)
					{
						...
						func_400(&uLocal_2008, 5, Local_1474[iVar0 /*19*/], "OJAcsGUARD2", 0, 1);
					}
				}
			}
...
void func_244(int iParam0, int iParam1, bool bParam2)//Position - 0xB744
{
...
int func_245(struct<3> Param0)//Position - 0xB7DE
{
...
void func_246(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB808
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		if (iVar1 != -1 && iVar1 != 94)
		{
			Global_114370.f_9088.f_330[iVar1 /*6*/].f_1 = 0;
		...
		else
		{
			...
			if (iVar5 != -1)
			{
				Global_114370.f_18577[iVar5 /*6*/].f_4 = 0;
				MemCopy(&uVar6, {func_323(iVar5)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar6, 0, Global_101429, iParam0);
			}
			else
			{
				iVar10 = func_322(&(Global_101392.f_3));
				if (iVar10 > -1)
				{
					Global_114370.f_24989.f_4[iVar10] = 0;
				}
			}
		}
...
void func_247(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0xB97D
{
	func_248(&Global_107917, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_248(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0xB999
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_10();
	...
	while (iVar1 < 3)
	{
		uParam0->f_17[iVar1] = Global_114370.f_2366.f_539.f_294[iVar1];
		if (iVar1 == func_272())
		{
		...
		while (iVar0 < 44)
		{
			uParam0->f_812[iVar1 /*477*/][iVar0 /*5*/] = { Global_114370.f_2366.f_539.f_298[iVar1 /*477*/][iVar0 /*5*/] };
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < 51)
		{
			uParam0->f_812[iVar1 /*477*/].f_221[iVar0 /*5*/] = { Global_114370.f_2366.f_539.f_298[iVar1 /*477*/].f_221[iVar0 /*5*/] };
			iVar0++;
		}
		switch (iVar1)
		{
		...
		uParam0->f_9[iVar1] = Global_114370.f_20567.f_233[iVar1 /*69*/].f_1;
		uParam0->f_13[iVar1] = Global_61212[iVar1];
		uParam0->f_25[0 /*295*/][iVar1 /*98*/] = { Global_114370.f_2366.f_539.f_2407[0 /*295*/][iVar1 /*98*/] };
		uParam0->f_25[1 /*295*/][iVar1 /*98*/] = { Global_114370.f_2366.f_539.f_2407[1 /*295*/][iVar1 /*98*/] };
		iVar0 = 0;
		while (iVar0 <= 3)
		{
			uParam0->f_2838[iVar1 /*15*/][iVar0] = Global_114370.f_2366.f_493[iVar1 /*15*/][iVar0];
			uParam0->f_2838[iVar1 /*15*/].f_5[iVar0] = Global_114370.f_2366.f_493[iVar1 /*15*/].f_5[iVar0];
			uParam0->f_2838[iVar1 /*15*/].f_10[iVar0] = Global_114370.f_2366.f_493[iVar1 /*15*/].f_10[iVar0];
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 <= 2)
		{
			uParam0->f_2345[iVar1 /*164*/][iVar0] = Global_114370.f_2366[iVar1 /*164*/][iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_4[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_4[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_8[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_8[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_12[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_12[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_16[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_16[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_20[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_20[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_24[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_24[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_28[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_28[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_32[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_32[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_36[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_36[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_40[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_40[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_44[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_44[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_48[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_48[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_52[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_52[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_56[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_56[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_60[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_60[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_64[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_64[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_68[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_68[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_72[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_72[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_76[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_76[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_80[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_80[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_84[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_84[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_88[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_88[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_92[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_92[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_96[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_96[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_100[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_100[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_104[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_104[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_108[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_108[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_112[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_112[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_116[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_116[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_120[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_120[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_124[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_124[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_128[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_128[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_132[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_132[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_136[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_136[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_140[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_140[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_144[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_144[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_148[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_148[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_152[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_152[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_156[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_156[iVar0];
			uParam0->f_2345[iVar1 /*164*/].f_160[iVar0] = Global_114370.f_2366[iVar1 /*164*/].f_160[iVar0];
			iVar0++;
		}
		iVar1++;
	}
...
void func_250(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC845
{
	int iVar0;
...
int func_251(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0xC8CD
{
...
int func_252(int iParam0)//Position - 0xC90D
{
	int iVar0;
...
void func_253(var uParam0, int iParam1, int iParam2)//Position - 0xC93B
{
...
int func_254(int iParam0)//Position - 0xCA17
{
	int iVar0;
...
int func_255(int iParam0)//Position - 0xCA59
{
	int iVar0;
...
int func_256(int iParam0, int iParam1, int iParam2)//Position - 0xCABC
{
	int iVar0;
...
int func_257(int iParam0, int iParam1)//Position - 0xCB4A
{
	struct<82> Var0;
...
void func_258(int iParam0, var uParam1, int iParam2)//Position - 0xCB8C
{
	int iVar0;
...
void func_259(int iParam0, var uParam1)//Position - 0xCDE8
{
	int iVar0;
...
int func_261(int iParam0, var uParam1, var uParam2)//Position - 0xD143
{
	int iVar0;
	int iVar1;
...
int func_262(int iParam0)//Position - 0xD336
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_264(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0xD406
{
	char* sVar0;
...
int func_265(int iParam0, int iParam1, bool bParam2)//Position - 0xD535
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_266(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0xD5A3
{
...
void func_267(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0xD67B
{
	int iVar0;
	int iVar1;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		if (func_13(iVar0))
		{
			uParam1->f_59 = Global_114370.f_2366.f_539[iVar0 /*65*/].f_59;
			uParam1->f_60 = Global_114370.f_2366.f_539[iVar0 /*65*/].f_60;
			uParam1->f_61 = Global_114370.f_2366.f_539[iVar0 /*65*/].f_61;
			uParam1->f_62 = Global_114370.f_2366.f_539[iVar0 /*65*/].f_62;
			uParam1->f_63 = Global_114370.f_2366.f_539[iVar0 /*65*/].f_63;
			uParam1->f_64 = Global_114370.f_2366.f_539[iVar0 /*65*/].f_64;
		}
...
int func_268(int iParam0, int iParam1)//Position - 0xD815
{
	int iVar0;
	var uVar1;
...
int func_269(int iParam0, var uParam1)//Position - 0xD839
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_101(uParam1));
}

void func_270(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0xD84E
{
	int iVar0;
...
void func_271(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0xDD97
{
	int iVar0;
...
int func_272()//Position - 0xDFD8
{
	func_11();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_273(int iParam0, bool bParam1)//Position - 0xDFF1
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_13(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_274(iParam0, &(Global_114370.f_2366.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
				Global_114370.f_2366.f_539.f_1730[iVar2 /*4*/][iVar0] = HUD::HUD_GET_WEAPON_WHEEL_TOP_SLOT(iVar2);
				if (bParam1)
				{
					iVar1 = HUD::HUD_GET_WEAPON_WHEEL_CURRENTLY_HIGHLIGHTED();
					if (Global_114370.f_2366.f_539.f_1730[iVar2 /*4*/][iVar0] == iVar1)
					{
						Global_114370.f_2366.f_539.f_1763 = iVar2;
					}
				}
				iVar2++;
			}
...
void func_274(int iParam0, var uParam1)//Position - 0xE0E4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_275(int iParam0)//Position - 0xE36C
{
	switch (iParam0)
	{
...
int func_276(int iParam0)//Position - 0xE40D
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_277(int iParam0, int iParam1)//Position - 0xE5F9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_278(int iParam0, var* uParam1)//Position - 0xF31A
{
	int iVar0;
	int iVar1;
...
int func_279(int iParam0)//Position - 0xF355
{
	int iVar0;
...
void func_280(int iParam0)//Position - 0xF5C9
{
	int iVar0;
	...
	if (func_13(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		Global_114370.f_2366.f_539.f_294[iVar0] = PED::GET_PED_ARMOUR(iParam0);
	}
}

void func_281(var uParam0, int iParam1)//Position - 0xF605
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_282(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0xFB54
{
	int iVar0;
	int iVar1;
...
bool func_283(int iParam0, var uParam1, var uParam2)//Position - 0xFB98
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
int func_284(var uParam0)//Position - 0x10319
{
...
bool func_285(int iParam0)//Position - 0x10374
{
	return func_286(iParam0, 0, 1);
}

int func_286(int iParam0, int iParam1, bool bParam2)//Position - 0x10384
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_287(int iParam0)//Position - 0x103E4
{
	switch (iParam0)
	{
		case 0:
...
int func_288()//Position - 0x1078C
{
	return Global_32828;
}

int func_289(int iParam0)//Position - 0x10797
{
	return func_286(iParam0, 5, 1);
}

int func_290(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x107A7
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_291(int iParam0, bool bParam1)//Position - 0x10849
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_292()//Position - 0x10FB4
{
	if (!func_245(Global_1948900))
	{
...
int func_293()//Position - 0x112AF
{
	return Global_2652572.f_2650;
}

Vector3 func_294(struct<3> Param0)//Position - 0x112BE
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_295(), 0f, Param0);
}

Vector3 func_295()//Position - 0x112D3
{
	return -880f, -2770f, -50f;
}

int func_296(int iParam0)//Position - 0x112EA
{
	if (iParam0 != func_52())
	{
...
Vector3 func_297(int iParam0, int iParam1)//Position - 0x11342
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_298(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x113EC
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_299(struct<3> Param0, float fParam3)//Position - 0x11481
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_300(int iParam0)//Position - 0x114C5
{
	struct<6> Var0;
...
struct<6> func_301(int iParam0)//Position - 0x11649
{
	return func_302(iParam0);
}

struct<6> func_302(int iParam0)//Position - 0x11657
{
	struct<6> Var0;
...
int func_303(int iParam0, var uParam1)//Position - 0x1211E
{
	switch (iParam0)
	{
		case 0:
...
int func_304(int iParam0)//Position - 0x121A0
{
	if (iParam0 != func_52())
	{
...
Vector3 func_305(int iParam0)//Position - 0x121F8
{
	switch (iParam0)
	{
		case 1:
...
int func_306()//Position - 0x12464
{
	return func_307(PLAYER::PLAYER_ID());
}

int func_307(int iParam0)//Position - 0x12474
{
	return MISC::GET_BITS_IN_RANGE(Global_2657921[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_308(int iParam0)//Position - 0x12491
{
	return func_286(iParam0, 0, 0);
}

int func_309(int iParam0)//Position - 0x124A1
{
	switch (iParam0)
	{
		case -1:
...
bool func_310()//Position - 0x127D7
{
	return Global_101444.f_393 > 0;
}

var func_311()//Position - 0x127E8
{
	var uVar0;
...
void func_312(var uParam0, int iParam1)//Position - 0x1282E
{
	if (iParam1 <= 0)
	{
		return;
...
void func_313(var uParam0, int iParam1)//Position - 0x128B4
{
...
void func_314(var uParam0, int iParam1)//Position - 0x128E7
{
	int iVar0;
	int iVar1;
...
int func_315(int iParam0, int iParam1)//Position - 0x12938
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_316(int iParam0)//Position - 0x129DA
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_317(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_317(bool bParam0, int iParam1, int iParam2)//Position - 0x129FC
{
	if (bParam0)
	{
		return iParam1;
...
int func_318(var uParam0)//Position - 0x12A13
{
	return uParam0 & 15;
}

void func_319(var uParam0, int iParam1)//Position - 0x12A20
{
...
void func_320(var uParam0, int iParam1)//Position - 0x12A5A
{
...
void func_321(var uParam0, int iParam1)//Position - 0x12A95
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_322(char* sParam0)//Position - 0x12AD1
{
...
struct<2> func_323(int iParam0)//Position - 0x12B27
{
	struct<2> Var0;
...
int func_324(char* sParam0, int iParam1)//Position - 0x12F73
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_325(int iParam0, var uParam1)//Position - 0x12FBC
{
	switch (iParam0)
	{
		case 0:
...
int func_327(int iParam0)//Position - 0x14203
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_328(int iParam0)//Position - 0x14549
{
	struct<2> Var0;
	char[] cVar2[8];
...
int func_329(int iParam0)//Position - 0x14580
{
	switch (iParam0)
	{
		case 69:
...
int func_330(int iParam0)//Position - 0x1463C
{
	switch (iParam0)
	{
		case 1:
...
int func_331(char* sParam0, bool bParam1)//Position - 0x14690
{
	int iVar0;
	int iVar1;
...
int func_332(int iParam0, bool bParam1)//Position - 0x146BA
{
	int iVar0;
...
void func_333()//Position - 0x146F0
{
	struct<3> Var0;
	float fVar3;
...
void func_334(bool bParam0, bool bParam1)//Position - 0x1496E
{
	ENTITY::DETACH_ENTITY(iLocal_1804, true, true);
	func_221(&iLocal_1768);
	if (bParam0)
...
void func_335()//Position - 0x14A8C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_336(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5)//Position - 0x14B34
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_337()//Position - 0x14B87
{
	int iVar0;
	struct<3> Var1;
...
void func_338()//Position - 0x14BE1
{
	int iVar0;
	int iVar1;
...
void func_339(int iParam0, int iParam1)//Position - 0x14E7C
{
	int iVar0;
...
void func_340()//Position - 0x14ED7
{
	struct<3> Var0;
...
void func_341()//Position - 0x14F35
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
void func_342(bool bParam0)//Position - 0x15046
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_1790[1]))
	{
		if (bParam0)
...
void func_343()//Position - 0x15131
{
	var uVar0;
	struct<3> Var1;
	float fVar4;
...
void func_344(bool bParam0)//Position - 0x1538E
{
	ENTITY::DETACH_ENTITY(iLocal_1804, true, true);
	func_221(&iLocal_1768);
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1790[0]))
...
void func_345()//Position - 0x154CE
{
	int iVar0;
	int iVar1;
...
void func_346()//Position - 0x1568E
{
	switch (iLocal_1763)
	{
		case 0:
...
void func_347()//Position - 0x157FB
{
	int iVar0;
...
void func_348()//Position - 0x15923
{
	struct<3> Var0;
...
void func_349()//Position - 0x15A02
{
	if (!bLocal_1722)
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1973, false))
...
void func_350()//Position - 0x15AAE
{
	int iVar0;
...
void func_351()//Position - 0x15B7D
{
	int iVar0;
	int iVar1;
...
void func_353()//Position - 0x15C69
{
...
void func_354()//Position - 0x15CD5
{
	struct<3> Var0;
	float fVar3;
...
float func_356(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4)//Position - 0x16396
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_357(bool bParam0)//Position - 0x163E8
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_1805))
	{
		if (bParam0)
		...
		if (!PED::IS_PED_INJURED(iLocal_1806))
		{
			func_400(&uLocal_2008, 5, iLocal_1806, "OJAcsGUARD2", 0, 1);
		}
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_1805, iLocal_1978);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_1805, true);
	}
...
int func_358(float fParam0, int iParam1)//Position - 0x164A6
{
	int iVar0;
...
int func_359(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x1654E
{
...
void func_360(int iParam0)//Position - 0x165A5
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_361(bool bParam0, bool bParam1)//Position - 0x165D1
{
...
void func_362()//Position - 0x16722
{
	func_371();
	func_369();
	...
	switch (iLocal_1763)
	{
		case 0:
			...
			if (func_364(Local_1946, 5f) && PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()))
			{
				if (HUD::DOES_BLIP_EXIST(iLocal_1712))
				{
					HUD::REMOVE_BLIP(&iLocal_1712);
...
void func_363()//Position - 0x16888
{
	if (!iLocal_1746)
	{
...
int func_364(struct<3> Param0, float fParam3)//Position - 0x168DB
{
	if (func_34(Param0, 1) <= fParam3 && !func_365())
	{
		return 1;
	}
	return 0;
...
void func_366()//Position - 0x16945
{
...
void func_367(int iParam0)//Position - 0x16A67
{
...
void func_369()//Position - 0x16B1A
{
...
void func_370(int iParam0)//Position - 0x16B71
{
	func_251(&(Global_107917.f_2890), &Global_107917, iParam0, 1);
}

void func_371()//Position - 0x16B8C
{
	struct<3> Var0;
...
void func_372()//Position - 0x16C08
{
	switch (iLocal_1036)
	{
		case 0:
		...
		case 1:
			if (!func_30(&iLocal_1988))
			{
				...
				{
					func_400(&uLocal_2008, 4, iLocal_1813, "OJAcsGUARD", 0, 1);
...
int func_373()//Position - 0x16D19
{
	...
	switch (iLocal_1773)
	{
		...
		case 1:
			func_400(&uLocal_2008, 8, Local_1648[iLocal_1774 /*19*/], "OJAScsWARN1", 0, 1);
...
void func_376()//Position - 0x1717B
{
	func_398();
	func_397();
	func_396();
	...
	if (bLocal_1730)
	{
		...
		{
			func_32(&iLocal_1979, Global_114370.f_19966.f_9);
		}
		if (iLocal_1778 == 0)
		{
			func_392();
...
void func_377(bool bParam0)//Position - 0x17243
{
	if (!HUD::DOES_BLIP_EXIST(iLocal_1712))
	{
		iLocal_1712 = func_379(Local_1946, 1);
		HUD::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_1712, "ASS_CS_STATION");
		func_378(&iLocal_1712, -79.8767f, -917.7642f, 28.1898f, 269.6892f);
		if (bParam0)
		{
...
void func_378(int iParam0, struct<3> Param1, float fParam4)//Position - 0x172A3
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		Global_113406 = *iParam0;
		Global_113411 = { Param1 };
		Global_113415 = fParam4;
	}
}

int func_379(struct<3> Param0, bool bParam3)//Position - 0x172CC
{
	int iVar0;
...
void func_380()//Position - 0x172F8
{
	func_334(1, 0);
...
void func_381(int iParam0)//Position - 0x17330
{
	if (!CAM::IS_SCREEN_FADED_IN())
	{
...
void func_382(int iParam0, int iParam1, int iParam2)//Position - 0x17356
{
	if (func_497() && func_384())
	{
...
void func_383(int iParam0)//Position - 0x1741A
{
	if (iParam0 == 1)
	{
...
var func_384()//Position - 0x17443
{
	return BitTest(Global_101392.f_20, 13);
}

void func_385()//Position - 0x17454
{
	while (!func_368())
	{
		SYSTEM::WAIT(0);
...
void func_387()//Position - 0x1750B
{
	while (!func_368())
	{
		SYSTEM::WAIT(0);
...
void func_388()//Position - 0x175EA
{
	iLocal_2176 = func_389(1);
	if (iLocal_2176 != 0)
	{
...
var func_389(int iParam0)//Position - 0x1762C
{
	if (Global_101429 > 0)
	{
...
void func_390(int iParam0, int iParam1)//Position - 0x17656
{
	int iVar0;
...
void func_391()//Position - 0x176C8
{
	bLocal_1717 = false;
	while (!func_368())
	{
...
void func_392()//Position - 0x1772D
{
	bLocal_1067 = false;
	func_377(1);
	func_382(0, -1, 1);
...
void func_393()//Position - 0x17767
{
...
void func_394()//Position - 0x177E9
{
...
void func_395(bool bParam0)//Position - 0x17823
{
	int iVar0;
	struct<3> Var1[5];
	float fVar17[5];
...
void func_396()//Position - 0x1794F
{
	StringCopy(&Local_729, "ASS_CS_PASSED", 24);
	MemCopy(&(Local_729.f_6), {Global_64053}, 6);
...
void func_397()//Position - 0x179C5
{
...
void func_398()//Position - 0x17A25
{
...
void func_400(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x17B3B
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_401()//Position - 0x17BD6
{
...
void func_402()//Position - 0x1816A
{
...
void func_403()//Position - 0x18867
{
...
void func_404()//Position - 0x188BB
{
	fLocal_133 = 8000f;
	fLocal_134 = 2000f;
}

void func_405()//Position - 0x188D1
{
...
void func_406()//Position - 0x1893E
{
...
void func_407()//Position - 0x1898C
{
	switch (iLocal_1037)
	{
		case 0:
			...
			if (bLocal_1065)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_1038))
				{
					func_411(805.0217f, -1076.8108f, 26.622034f, 813.8823f, -1076.8142f, 32.50576f, 5f, 814.4346f, -1081.6877f, 27.3991f, 90.2655f, 1, 1, 1, 0, 0);
					...
					func_400(&uLocal_2008, 3, 0, "LESTER", 0, 1);
					func_400(&uLocal_2008, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					HUD::DISPLAY_RADAR(false);
					HUD::DISPLAY_HUD(false);
...
int func_408(int iParam0)//Position - 0x18E86
{
...
void func_409()//Position - 0x18EA5
{
	switch (iLocal_1079)
	{
		case 0:
			if (func_410(&iLocal_1040, 4f, 799.7321f, -1083.4171f, 30.3753f, -1.3455f, 0f, -42.1124f, 42.5517f, 1, 0.3f))
			{
				iLocal_1079 = 1;
			}
			break;
		...
		case 1:
			if (func_410(&iLocal_1040, 11f, 814.8909f, -1078.2717f, 29.0784f, 0f, -0.0387f, 70.1654f, 30.1956f, 1, 0.3f))
			{
				iLocal_1079 = 2;
			}
			break;
		...
		case 2:
			if (func_410(&iLocal_1040, 20f, 808.044f, -1074.6467f, 29.2119f, -4.8627f, 0f, -129.3806f, 36.3462f, 1, 0.3f))
			{
				iLocal_1079 = 3;
			}
			break;
		...
		case 3:
			if (func_410(&iLocal_1040, 25f, 814.8909f, -1078.2717f, 29.0784f, 0f, -0.0387f, 70.1654f, 30.1956f, 1, 0.2f))
			{
				iLocal_1079 = 4;
			}
			break;
		...
		case 4:
			if (func_410(&iLocal_1040, 30f, 808.044f, -1074.6467f, 29.2119f, -4.8627f, 0f, -129.3806f, 36.3462f, 1, 0.2f))
			{
				iLocal_1079 = 5;
			}
			break;
		...
		case 5:
			if (func_410(&iLocal_1040, 37f, 812.5805f, -1076.6483f, 28.9375f, 2.1171f, 0.0247f, 79.0055f, 29.2734f, 1, 0.2f))
			{
				iLocal_1079 = 6;
			}
			break;
...
int func_410(int iParam0, float fParam1, struct<3> Param2, struct<3> Param5, float fParam8, bool bParam9, float fParam10)//Position - 0x19044
{
...
void func_411(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x190A4
{
	func_412(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_412(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x190CD
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_413(iVar0, Param0, Param3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_413(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x194C3
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_414(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var9) || func_414(Var18[0 /*3*/], Var18[1 /*3*/], Var9, Var15)) || func_414(Var18[0 /*3*/], Var18[1 /*3*/], Var12, Var15)) || func_414(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var12)) || func_414(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var9)) || func_414(Var18[1 /*3*/], Var18[3 /*3*/], Var9, Var15)) || func_414(Var18[1 /*3*/], Var18[3 /*3*/], Var12, Var15)) || func_414(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var12)) || func_414(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var9)) || func_414(Var18[3 /*3*/], Var18[2 /*3*/], Var9, Var15)) || func_414(Var18[3 /*3*/], Var18[2 /*3*/], Var12, Var15)) || func_414(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var12)) || func_414(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var9)) || func_414(Var18[2 /*3*/], Var18[0 /*3*/], Var9, Var15)) || func_414(Var18[2 /*3*/], Var18[0 /*3*/], Var12, Var15)) || func_414(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_414(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x197B9
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_415(struct<3> Param0)//Position - 0x1986D
{
	float fVar0;
	float fVar1;
...
void func_416(int iParam0)//Position - 0x198AC
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_417()//Position - 0x19911
{
...
void func_418()//Position - 0x1994B
{
	if (iLocal_2181 > 0)
	{
...
void func_419()//Position - 0x19BE3
{
	struct<3> Var0;
	float fVar3;
	int iVar4;
...
void func_420()//Position - 0x19D4D
{
	func_498();
}

int func_421()//Position - 0x19D59
{
	if (Global_4)
	{
		return 1;
...
void func_422(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x19D86
{
	if (func_497())
	{
...
int func_423(struct<3> Param0, float fParam3)//Position - 0x19E1B
{
	return func_424(&(Global_107917.f_2890), Param0, fParam3, 0);
}

int func_424(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x19E35
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (func_487(uParam0))
	{
		...
		if (func_486(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_453(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_452(iVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
void func_425(int iParam0, int iParam1)//Position - 0x1A0E7
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_259(iParam0, &(Global_114370.f_32752.f_5510));
}

int func_426(int iParam0)//Position - 0x1A2E9
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_265(iParam0, 0, 0)) || func_265(iParam0, 1, 0)) || func_265(iParam0, 2, 0)) || func_255(iParam0) != 145) || func_443(iParam0)) || func_442(iParam0)) || func_441(iParam0)) || func_440(iParam0)) || !func_427(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_442(iParam0))
		{
		}
...
int func_427(int iParam0)//Position - 0x1A3C6
{
	if (iParam0 == 0)
	{
		return 0;
	}
	if (!func_428(iParam0, 0, -1))
	{
		return 0;
	}
...
int func_428(int iParam0, bool bParam1, int iParam2)//Position - 0x1A584
{
	int iVar0;
	struct<2> Var1;
	...
	{
		if ((func_434() || MISC::IS_PC_VERSION()) || func_433())
		{
		}
		else if (!func_436())
		{
...
int func_429(int iParam0)//Position - 0x1A706
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_431(int iParam0, int iParam1)//Position - 0x1A7E9
{
	int iVar0;
	int iVar1;
...
int func_432(bool bParam0)//Position - 0x1FD23
{
	if (bParam0)
	{
...
bool func_433()//Position - 0x1FD3D
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_434()//Position - 0x1FD53
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_435()//Position - 0x1FD69
{
	return 0;
}

int func_436()//Position - 0x1FD72
{
	return 1;
}

int func_437()//Position - 0x1FD7B
{
	return 1;
}

int func_438()//Position - 0x1FD84
{
...
int func_440(int iParam0)//Position - 0x1FE55
{
	int iVar0;
	char* sVar1;
...
int func_441(int iParam0)//Position - 0x1FE9C
{
	int iVar0;
...
int func_442(int iParam0)//Position - 0x1FED7
{
	int iVar0;
...
int func_443(int iParam0)//Position - 0x1FF53
{
	int iVar0;
...
void func_444(int iParam0, bool bParam1)//Position - 0x2003C
{
	if (iParam0 == -1)
	{
		return;
...
void func_445(int iParam0, int iParam1, bool bParam2)//Position - 0x20099
{
	if (iParam0 == -1)
	{
		return;
...
int func_446(int iParam0, int iParam1)//Position - 0x200D4
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_447(int iParam0)//Position - 0x200F4
{
	bool bVar0;
...
void func_448(var uParam0, var uParam1)//Position - 0x20263
{
...
int func_449(int iParam0, int iParam1)//Position - 0x2032F
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_450(&(Global_114370.f_32752.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_428(Global_114370.f_32752.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}

int func_450(var uParam0)//Position - 0x203A2
{
	return *uParam0;
}

int func_451(var uParam0, int iParam1)//Position - 0x203AD
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_24(Global_114370.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_24(Global_114370.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_24(Global_114370.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_452(int iParam0)//Position - 0x21A9B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_453(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x21B5E
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_455(iParam0, Global_78038.f_139[38], 0))
			{
				func_447(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_455(iParam0, Global_78038.f_139[43], 1))
			{
				func_447(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_455(iParam0, uVar1[iVar6], 1) && func_454(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.5635f, 39.9702f, 5f, 0))
				{
...
int func_454(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x21D66
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_455(int iParam0, int iParam1, bool bParam2)//Position - 0x21DE1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_456(int iParam0, int iParam1)//Position - 0x21E42
{
	int iVar0;
...
void func_457(int iParam0, int iParam1)//Position - 0x21EC4
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98703[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98703[iVar0]) == func_257(iParam0, iParam1))
				{
...
void func_458(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x21F62
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((BitTest(uParam1->f_77, 15) || func_474(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_473())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
		{
			func_464(&iParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
		...
		if ((((func_459() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_432(1)))
		{
...
int func_460(var uParam0)//Position - 0x226E9
{
	int iVar0;
...
int func_461(int iParam0)//Position - 0x2270D
{
	int iVar0;
...
bool func_462(int iParam0)//Position - 0x2272B
{
	return func_463(&(Global_2672741.f_188), iParam0);
}

var func_463(var uParam0, var uParam1)//Position - 0x2273F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_464(int iParam0, var uParam1, var uParam2)//Position - 0x22762
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*iParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_470(*iParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_469(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_467(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_467(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_466(iParam0);
	if (func_465(*iParam0))
	{
...
int func_465(int iParam0)//Position - 0x2293C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_466(var uParam0)//Position - 0x22A18
{
...
int func_467(int iParam0, int iParam1)//Position - 0x22A6F
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		iVar0 = func_468(iParam0, 38) + 1;
		iVar1 = func_468(iParam0, 24) + 1;
...
int func_468(int iParam0, int iParam1)//Position - 0x22B58
{
	int iVar0;
	...
	while (iVar0 >= 0 && func_470(iParam0, iParam1, iVar0))
	{
		iVar0 = (iVar0 - 1);
	}
	return iVar0;
...
int func_469(int iParam0, int iParam1)//Position - 0x22BBA
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_470(int iParam0, int iParam1, int iParam2)//Position - 0x22F99
{
	if (!func_471() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_471()//Position - 0x22FBD
{
	return 0;
}

void func_472(int iParam0, int iParam1)//Position - 0x22FC6
{
	int iVar0;
	int iVar1;
...
bool func_473()//Position - 0x2303E
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

int func_474(int iParam0)//Position - 0x2304F
{
	int iVar0;
...
int func_475(int iParam0)//Position - 0x23097
{
	if (!func_471() && func_476(iParam0))
	{
		return 1;
	}
	return 0;
...
int func_476(int iParam0)//Position - 0x230B7
{
	switch (iParam0)
	{
		case 161:
...
int func_477(int iParam0)//Position - 0x2310A
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (!func_483(PLAYER::PLAYER_ID(), -1))
		{
...
int func_478(int iParam0)//Position - 0x23191
{
...
int func_479(int iParam0)//Position - 0x231C0
{
	if (func_482(iParam0) == 233)
	{
...
int func_480(int iParam0)//Position - 0x231DD
{
...
int func_481(int iParam0, int iParam1)//Position - 0x23200
{
	if (func_207(iParam0))
	{
...
int func_482(int iParam0)//Position - 0x23244
{
	if (func_207(iParam0))
	{
		if (func_481(iParam0, 0))
...
int func_483(int iParam0, int iParam1)//Position - 0x23270
{
	int iVar0;
	
	if (func_484(iParam0, 1, 1))
	{
...
int func_484(int iParam0, bool bParam1, bool bParam2)//Position - 0x232BD
{
	int iVar0;
...
void func_485(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x2331D
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_451(&(Global_78038.f_555[0 /*21*/]), iVar0))
		{
...
int func_486(var uParam0)//Position - 0x2336D
{
	if (func_487(uParam0))
	{
...
int func_487(var uParam0)//Position - 0x233A2
{
	if (uParam0->f_12.f_66 == 0)
	{
		return 0;
	}
	if (!func_428(uParam0->f_12.f_66, 0, -1))
	{
		return 0;
	}
...
bool func_488()//Position - 0x23402
{
	return func_486(&(Global_107917.f_2890));
}

void func_489()//Position - 0x23415
{
	func_490(&(Global_107917.f_2890));
}

void func_490(var uParam0)//Position - 0x23428
{
	if (func_487(uParam0))
	{
...
struct<39> func_492(int iParam0)//Position - 0x23470
{
	struct<39> Var0;
...
Vector3 func_493(int iParam0)//Position - 0x23928
{
	switch (iParam0)
	{
		case 0:
...
void func_494()//Position - 0x239B2
{
	bool bVar0;
	
	bVar0 = func_85(Global_114370.f_19966.f_1, 4096);
...
void func_495()//Position - 0x239EB
{
}

bool func_496()//Position - 0x239F3
{
	return func_487(&(Global_107917.f_2890));
}

int func_497()//Position - 0x23A06
{
	if (Global_101392 == 10 || Global_101392 == 9)
	{
		return 1;
...
void func_498()//Position - 0x23A2A
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1039))
	{
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("p_phonebox_01b_s"));
...
void func_499()//Position - 0x23C07
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1973))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_1973, 0f);
...
void func_500()//Position - 0x23CA5
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1972))
	{
...
void func_501()//Position - 0x23CCF
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1975))
	{
...
void func_502()//Position - 0x23D56
{
...
void func_503()//Position - 0x23D8C
{
	if (OBJECT::DOES_PICKUP_EXIST(iLocal_2174))
	{
...
void func_504()//Position - 0x23DB6
{
	if (OBJECT::DOES_PICKUP_EXIST(iLocal_2173))
	{
...
void func_505()//Position - 0x23DCF
{
	int iVar0;
...
void func_507(var uParam0, int iParam1)//Position - 0x23E7E
{
	func_508(uParam0, iParam1);
}

void func_508(var uParam0, var uParam1)//Position - 0x23E8E
{
