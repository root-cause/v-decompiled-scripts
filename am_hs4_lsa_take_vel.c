...
void func_287(var uParam0)//Position - 0x33815
{
	...
	func_54(&uLocal_95, 1);
	func_288(&uLocal_95, -1581.6901f, -3023.0054f, 15.8275f, 0.739f, 0.0046f, -100.8783f, "HS4_LSA_TAKE_VEL", 0, 1, uParam0->f_4, 0);
}

void func_288(var uParam0, struct<3> Param1, struct<3> Param4, char* sParam7, int iParam8, int iParam9, var uParam10, int iParam11)//Position - 0x33869
{
...
void func_289(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x33899
{
	uParam0->f_1 = uParam1;
	uParam0->f_2 = uParam3;
...
void func_290(var uParam0, int iParam1, char* sParam2)//Position - 0x338C6
{
