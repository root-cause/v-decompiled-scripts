		...
		if (func_217())
		{
			if (NETWORK::CAN_REGISTER_MISSION_OBJECTS(1))
			{
				...
				if (func_227(PLAYER::PLAYER_ID()) == 7)
				{
					...
					if (Global_4718592.f_3592[iVar12 /*25891*/].f_3146[0 /*36*/].f_23 > 0f)
					{
						Var6 = { Global_4718592.f_3592[iVar12 /*25891*/].f_3146[0 /*36*/].f_16 };
						Var9 = { Global_4718592.f_3592[iVar12 /*25891*/].f_3146[0 /*36*/].f_19 };
						fVar5 = Global_4718592.f_3592[iVar12 /*25891*/].f_3146[0 /*36*/].f_23;
						iVar4 = 1;
					}
					else if (Global_4718592.f_3592[iVar12 /*25891*/].f_3146[0 /*36*/].f_22 > 0f)
					{
						Var6 = { Global_4718592.f_3592[iVar12 /*25891*/].f_3146[0 /*36*/].f_13 };
						fVar5 = Global_4718592.f_3592[iVar12 /*25891*/].f_3146[0 /*36*/].f_22;
					}
				}
	...
	if (bVar25)
	{
		if (Global_2635563.f_2764 == 1)
		{
			if (SCRIPT::IS_THREAD_ACTIVE(Global_2635563.f_2773))
			{
				...
				{
					if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635563.f_2770) < func_186(0))
					{
						return 0;
					}
				}
				else if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635563.f_2770) < func_186(0))
				{
					return 0;
				}
			}
					...
					while (iVar17 < 3)
					{
						if (SYSTEM::VMAG(*(uParam2[0 /*3*/])) == 0f)
						{
							if (!SYSTEM::VMAG(Global_2635563.f_2925[iVar17 /*3*/]) == 0f)
							{
								...
								{
									case 0:
										if (func_148(Global_2635563.f_2925[iVar17 /*3*/], *uParam0, uParam0->f_4, 0, 0))
										{
									...
									case 1:
										if (func_60(Global_2635563.f_2925[iVar17 /*3*/], uParam0->f_8, uParam0->f_11, 0, 0))
										{
											*(uParam2[0 /*3*/]) = { Global_2635563.f_2925[iVar17 /*3*/] };
										}
										break;
...
int func_22(struct<3> Param0, var uParam3, float fParam4, bool bParam5, bool bParam6)//Position - 0x24B0
{
	...
	{
		case 0:
			return func_148(Param0, *uParam3, ((uParam3->f_6 + fParam4) + (IntToFloat(Global_2635563.f_3035) * uParam3->f_8)), bParam5, bParam6);
			break;
...
int func_26(int iParam0, bool bParam1, bool bParam2)//Position - 0x2C0C
{
	int iVar0;
...
int func_27()//Position - 0x2C6C
{
	return -1;
}

int func_28(struct<3> Param0, var* uParam3, int iParam4, int iParam5, bool bParam6)//Position - 0x2C75
{
...
int func_29(struct<3> Param0, var* uParam3, int iParam4, bool bParam5)//Position - 0x2CD1
{
	float fVar0;
	var uVar1;
	var uVar8;
	...
	if (fVar0 < 40f)
	{
		uVar1 = 2;
		uVar8 = 2;
		if ((iParam4 == 1 && !func_45(Global_2635563.f_512, uParam3, &uVar1, &uVar8, bParam5, 1)) || iParam4 == 0)
		{
...
int func_30(var uParam0, bool bParam1)//Position - 0x2D56
{
	int iVar0;
	struct<3> Var1;
	int iVar4;
	...
	{
		if (func_31(Var1, &(Global_2641042[iVar4 /*155*/][iVar0 /*7*/])))
		{
			if (bParam1)
			{
				func_15(&Var1, Global_2641042[iVar4 /*155*/][iVar0 /*7*/], Global_2641042[iVar4 /*155*/][iVar0 /*7*/].f_3, Global_2641042[iVar4 /*155*/][iVar0 /*7*/].f_6, 1036831949, 0);
				*uParam0 = { Var1 };
			}
			return 1;
		}
...
bool func_31(struct<3> Param0, var uParam3)//Position - 0x2E63
{
	return OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, *uParam3, uParam3->f_3, uParam3->f_6, false, true);
}

int func_32(struct<2> Param0, var uParam2)//Position - 0x2E83
{
...
int func_33(struct<3> Param0, float fParam3)//Position - 0x2F1E
{
	int iVar0;
	...
	if (func_42(PLAYER::PLAYER_ID(), 1, 0))
	{
		if (Global_4980736.f_47367 > 0)
		{
			...
			while (iVar0 < Global_4980736.f_47367)
			{
				...
				{
					if (func_34(Param0, Global_4980736.f_47368[iVar0 /*163*/], Global_4980736.f_47368[iVar0 /*163*/].f_6, Global_4980736.f_47368[iVar0 /*163*/].f_7, fParam3))
					{
						return 1;
					}
				}
...
int func_34(struct<3> Param0, struct<3> Param3, float fParam6, int iParam7, float fParam8)//Position - 0x31B2
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_35(struct<3> Param0, float fParam3, int iParam4, var uParam5, var uParam6, var uParam7, float fParam8)//Position - 0x3205
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
void func_36(int iParam0, var* uParam1, var* uParam2, float fParam3, float fParam4, float fParam5)//Position - 0x32D1
{
	int iVar0;
...
void func_37(int iParam0, var* uParam1, var* uParam2, float fParam3, float fParam4, float fParam5)//Position - 0x33D0
{
	int iVar0;
...
int func_39(int iParam0)//Position - 0x365D
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x368C
{
	int iVar0;
...
float func_41(int iParam0, float fParam1)//Position - 0x369E
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_42(int iParam0, bool bParam1, bool bParam2)//Position - 0x371E
{
	if (bParam1)
	{
		if (func_43(iParam0))
...
bool func_43(int iParam0)//Position - 0x3750
{
	return func_44(iParam0);
}

var func_44(int iParam0)//Position - 0x375E
{
	return BitTest(Global_1845281[iParam0 /*883*/].f_11.f_1, 0);
}

int func_45(struct<3> Param0, var uParam3, var uParam4, var uParam5, bool bParam6, bool bParam7)//Position - 0x3775
{
	int iVar0;
	bool bVar1;
...
int func_46(struct<3> Param0, float fParam3)//Position - 0x3831
{
	int iVar0;
...
int func_47(var uParam0, bool bParam1, bool bParam2)//Position - 0x386C
{
	int iVar0;
	var uVar1;
	struct<3> Var2;
...
int func_48(struct<3> Param0)//Position - 0x38F0
{
	float fVar0;
...
int func_49(struct<3> Param0, var uParam3)//Position - 0x3929
{
	int iVar0;
	int iVar1;
...
int func_52(struct<3> Param0)//Position - 0x39CF
{
	int iVar0;
	struct<3> Var1;
...
int func_54(struct<3> Param0, float fParam3)//Position - 0x3AD8
{
	int iVar0;
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_22(Param0, &(Global_2635563.f_45[iVar0 /*12*/]), fParam3, 0, 0))
			{
				return iVar0;
			}
		}
...
int func_55(struct<3> Param0, float fParam3)//Position - 0x3B20
{
	int iVar0;
...
bool func_56(int iParam0, bool bParam1)//Position - 0x3B67
{
	if (func_58() != 0)
	{
...
int func_57(int iParam0)//Position - 0x3B8E
{
...
int func_59(struct<3> Param0, var uParam3)//Position - 0x3BBB
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_60(struct<3> Param0, struct<3> Param3, struct<3> Param6, bool bParam9, bool bParam10)//Position - 0x3C35
{
...
int func_62(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x3D42
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_63(float fParam0)//Position - 0x3DED
{
	if (fParam0 > 50f)
	{
		return 1;
...
int func_64(var uParam0, var uParam1, var uParam2, bool bParam3)//Position - 0x3E05
{
	struct<3> Var0;
	float fVar3;
	int iVar4;
...
void func_65(struct<3> Param0)//Position - 0x43CD
{
	int iVar0;
...
void func_66(var uParam0, var uParam1, var uParam2)//Position - 0x441D
{
...
void func_67(var uParam0, struct<3> Param1, struct<3> Param4)//Position - 0x4482
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_68(var uParam0, struct<3> Param1)//Position - 0x4521
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_69(var uParam0)//Position - 0x45A3
{
	int iVar0;
	float fVar1;
	struct<10> Var2;
...
void func_70(var uParam0, float fParam1)//Position - 0x4610
{
	int iVar0;
	float fVar1;
	struct<10> Var2;
...
void func_72(struct<3> Param0, float fParam3, var uParam4, var uParam5, bool bParam6, int iParam7)//Position - 0x46CA
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	else
	{
		...
		if (iVar16 > -1)
		{
			...
			if (!func_104(&(Global_2635563.f_45[iVar16 /*12*/]), Var17, Var20, fVar23))
			{
				iVar8 = -1;
			}
		}
	...
	if (Global_2635563.f_3198 && uParam4->f_5)
	{
		if (iVar8 > 0)
		{
			...
			{
				fVar0 = func_94(Param0, Global_2635563.f_2766, uParam5->f_6, uParam5->f_4, bVar4, iVar10, &(Var25.f_8));
			}
			if (bVar9)
			{
				fVar0 = (fVar0 * 3f);
		...
		while (iVar24 < 5)
		{
			if (iVar8 >= Global_2635563.f_2791.f_6[iVar24 /*10*/])
			{
				if (uParam4->f_5)
				{
					...
					if ((func_11(Global_2635563.f_489) && iVar8 == Global_2635563.f_2791.f_6[iVar24 /*10*/]) && iVar8 < 4096)
					{
						if (!bVar36)
						{
...
float func_74(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, int iParam7, bool bParam8)//Position - 0x5126
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
int func_75(int iParam0)//Position - 0x52BD
{
...
void func_76(struct<10> Param0, int iParam10)//Position - 0x52E9
{
	struct<10> Var0;
...
void func_77(struct<10> Param0)//Position - 0x533B
{
	int iVar0;
	struct<10> Var1;
	int iVar11;
...
float func_78(struct<3> Param0, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7)//Position - 0x542F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0)//Position - 0x5592
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_80(int iParam0)//Position - 0x55A5
{
	if (func_26(iParam0, 0, 1))
	{
		if (!func_90(iParam0))
...
int func_81(int iParam0)//Position - 0x5653
{
...
int func_82(int iParam0, int iParam1)//Position - 0x569A
{
	int iVar0;
...
int func_83(var uParam0)//Position - 0x56C3
{
	int iVar0;
...
int func_84(int iParam0)//Position - 0x56E5
{
	if (func_83(iParam0))
	{
...
struct<13> func_85(int iParam0)//Position - 0x5708
{
	struct<13> Var0;
...
int func_86(int iParam0, int iParam1)//Position - 0x571F
{
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x578C
{
	bool bVar0;
	bool bVar1;
...
int func_88(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x5AD7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_89(int iParam0)//Position - 0x5C03
{
	return BitTest(Global_1845281[iParam0 /*883*/].f_36.f_18, 14);
}

int func_90(int iParam0)//Position - 0x5C1B
{
...
float func_92(struct<3> Param0)//Position - 0x5C68
{
	var uVar0;
...
float func_93(struct<3> Param0, var uParam3, var uParam4)//Position - 0x5C80
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float func_94(struct<3> Param0, struct<3> Param3, bool bParam6, bool bParam7, bool bParam8, int iParam9, var uParam10)//Position - 0x5DFC
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_95(struct<3> Param0, var uParam3, var uParam4)//Position - 0x5FE3
{
	struct<3> Var0;
	int iVar3;
	var uVar4;
...
float func_96(struct<3> Param0, int iParam3, int iParam4)//Position - 0x603C
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_97(int iParam0, int iParam1)//Position - 0x60F7
{
	int iVar0;
...
float func_98(struct<3> Param0)//Position - 0x6131
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_99(int iParam0)//Position - 0x6251
{
	int iVar0;
	int iVar1;
...
int func_103(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, float fParam7, float fParam8, float fParam9)//Position - 0x640A
{
	float fVar0;
...
int func_104(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x6499
{
	switch (uParam0->f_10)
	{
		case 0:
...
int func_105(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, struct<3> Param10, float fParam13)//Position - 0x6525
{
	struct<3> Var0[8];
	int iVar25;
...
void func_106(struct<3> Param0, struct<3> Param3, float fParam6, var uParam7)//Position - 0x6577
{
	struct<3> Var0;
	struct<3> Var3;
	var uVar6;
...
int func_107(struct<3> Param0, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12)//Position - 0x66A4
{
	struct<3> Var0[8];
	int iVar25;
...
int func_108(struct<3> Param0, float fParam3, struct<3> Param4, struct<3> Param7, float fParam10)//Position - 0x676E
{
	struct<3> Var0[4];
	int iVar13;
...
void func_109(struct<3> Param0, var uParam3, var uParam4, var uParam5)//Position - 0x67F2
{
	int iVar0;
	struct<3> Var1;
	int iVar4;
...
int func_110(struct<3> Param0)//Position - 0x68E0
{
	int iVar0;
	int iVar1;
...
int func_111(struct<3> Param0)//Position - 0x694B
{
...
int func_112(struct<3> Param0, var uParam3, var uParam4, float fParam5)//Position - 0x69DD
{
	float fVar0;
	int iVar1;
	struct<3> Var2;
...
int func_113(var uParam0, var uParam1, bool bParam2, float fParam3)//Position - 0x6A8B
{
	int iVar0;
	struct<3> Var1;
...
int func_114(int iParam0)//Position - 0x6AFE
{
	switch (func_58())
	{
		case 0:
...
bool func_115(int iParam0)//Position - 0x6B34
{
	return Global_1845281[iParam0 /*883*/].f_193 != 0;
}

int func_116(int iParam0)//Position - 0x6B49
{
...
int func_117(struct<3> Param0, float fParam3, int iParam4)//Position - 0x6B6E
{
	int iVar0;
...
int func_118(var uParam0, bool bParam1)//Position - 0x6BAC
{
	var uVar0;
	struct<3> Var1;
	float fVar4;
	...
	if (func_48(*uParam0))
	{
		if (bParam1)
		{
			...
			func_19(&Var1, Global_2635563.f_593, Global_2635563.f_596, 1036831949, 0, fVar4);
			if (func_49(Var1, &uVar0) || func_48(Var1))
			{
				Var1 = { *uParam0 };
				func_19(&Var1, Global_2635563.f_593, Global_2635563.f_596, 1036831949, 1, fVar4);
			}
			*uParam0 = { Var1 };
		}
	}
...
int func_119(struct<3> Param0, float fParam3, int iParam4, int iParam5, float fParam6, bool bParam7, int iParam8, float fParam9, bool bParam10)//Position - 0x6C44
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar0 < 32)
	{
		...
		if (func_26(iVar1, 1, 1))
		{
			if (!func_145(iVar1, 0) && NETWORK::NETWORK_ARE_PLAYERS_IN_SAME_TUTORIAL_SESSION(PLAYER::PLAYER_ID(), iVar1))
			{
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != PLAYER::PLAYER_ID()))
				{
					if ((func_75(iVar1) || !bParam10) && !Global_2657971[iVar1 /*465*/].f_271)
					{
						fVar2 = fParam6;
						if (fParam9 > 0f)
						{
...
Vector3 func_120(int iParam0)//Position - 0x6DFC
{
	int iVar0;
...
int func_122(struct<3> Param0, float fParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6E5D
{
...
int func_123(struct<3> Param0, int iParam3, int iParam4)//Position - 0x6E8E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_124(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6)//Position - 0x6F50
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
int func_125(struct<3> Param0, float fParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, float fParam8, float fParam9, float fParam10, float fParam11, float fParam12, float fParam13, bool bParam14, bool bParam15)//Position - 0x706D
{
...
int func_126(struct<3> Param0, float fParam3, float fParam4, float fParam5, float fParam6)//Position - 0x72AD
{
	int iVar0;
	int iVar1;
...
bool func_127(struct<3> Param0, struct<3> Param3, float fParam6, float fParam7, float fParam8, float fParam9)//Position - 0x732C
{
	struct<3> Var0;
	struct<3> Var3;
...
bool func_128(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x73B8
{
	if (iParam2 == -2)
	{
		if (iParam3 == 0)
...
int func_129(struct<3> Param0, float fParam3)//Position - 0x7430
{
	int iVar0;
	int iVar1;
...
int func_130(int iParam0)//Position - 0x74EC
{
...
int func_131(struct<3> Param0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8, int iParam9, int iParam10)//Position - 0x752F
{
	int iVar0;
	int iVar1;
...
int func_132(struct<3> Param0, float fParam3, int iParam4, float fParam5)//Position - 0x7633
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_133(int iParam0)//Position - 0x76F8
{
...
int func_134(int iParam0)//Position - 0x7734
{
	if (!func_26(iParam0, 0, 1))
	{
		return 0;
...
int func_135(int iParam0, int iParam1)//Position - 0x775C
{
	if (func_83(iParam0))
	{
...
int func_136(int iParam0)//Position - 0x77A0
{
	int iVar0;
...
void func_137(struct<3> Param0, var uParam3, var uParam4)//Position - 0x77C1
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_2635563.f_2562 > 0)
	{
		...
		while (iVar0 < Global_2635563.f_2562)
		{
			if (func_141(Global_2635563.f_2563[iVar0 /*4*/], uParam0))
			{
				...
				func_72(Global_2635563.f_2563[iVar0 /*4*/], fVar4, uParam0, uParam1, 0, uParam0->f_28);
...
int func_141(struct<3> Param0, var uParam3)//Position - 0x7C49
{
	switch (uParam3->f_7)
	{
		case 0:
...
void func_142(struct<3> Param0, struct<3> Param3, var uParam6, var uParam7, float fParam8)//Position - 0x7CA6
{
	float fVar0;
...
bool func_145(int iParam0, int iParam1)//Position - 0x7D1E
{
	bool bVar0;
...
bool func_148(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7, bool bParam8)//Position - 0x7DC4
{
	if (bParam7 && bParam8)
	{
		Param0.f_2 = 0f;
...
void func_151(var uParam0, var uParam1, var uParam2, struct<3> Param3)//Position - 0x8919
{
	float fVar0;
	float fVar1;
	int iVar2;
...
void func_152(int iParam0, struct<3> Param1, int iParam4, var* uParam5, float* fParam6, var uParam7, bool bParam8, int iParam9, int iParam10, float fParam11, float fParam12, bool bParam13)//Position - 0x899D
{
	int iVar0;
...
void func_155(struct<3> Param0, float fParam3, int iParam4)//Position - 0x8AE0
{
	struct<3> Var0;
	var uVar3;
...
int func_156(struct<3> Param0, float fParam3, float fParam4)//Position - 0x8B4D
{
	int iVar0;
	struct<3> Var1;
	int iVar4;
...
int func_157(struct<3> Param0, float fParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10)//Position - 0x8BB5
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_158(struct<3> Param0, float fParam3, int iParam4, struct<3> Param5, float fParam8, int iParam9, int iParam10)//Position - 0x8D28
{
	if (func_34(Param0, Param5, fParam8, iParam9, 1036831949))
	{
		return 1;
	}
	func_35(Param0, fParam3, iParam4, &Global_1975334, &(Global_1975334.f_3), &(Global_1975334.f_6), 1036831949);
	func_35(Param5, fParam8, iParam9, &(Global_1975334.f_7), &(Global_1975334.f_10), &(Global_1975334.f_13), 1036831949);
...
int func_159(struct<3> Param0, float fParam3, int iParam4)//Position - 0x8DC6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_160(struct<3> Param0, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x8ED2
{
...
int func_161(struct<3> Param0, float fParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8F08
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar0 < 32)
	{
		if (!iParam5 == iVar0 || iParam6 == 1)
		{
			...
			while (iVar1 < 2)
			{
				if (func_162(Param0, iParam4, Global_2648938.f_461[iVar0 /*11*/][iVar1 /*5*/], Global_2648938.f_461[iVar0 /*11*/][iVar1 /*5*/].f_4))
				{
					if (func_158(Param0, fParam3, iParam4, Global_2648938.f_461[iVar0 /*11*/][iVar1 /*5*/], Global_2648938.f_461[iVar0 /*11*/][iVar1 /*5*/].f_3, Global_2648938.f_461[iVar0 /*11*/][iVar1 /*5*/].f_4, 0))
					{
...
int func_162(struct<3> Param0, int iParam3, struct<3> Param4, int iParam7)//Position - 0x8FE2
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_163(struct<3> Param0, float fParam3, int iParam4, int iParam5, int iParam6)//Position - 0x9022
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		if (!iParam5 == iVar0 || iParam6 == 1)
		{
			...
			if (func_26(iVar1, 0, 1) && func_26(iParam5, 0, 1))
			{
				if (Global_2648938.f_261[iVar0])
				{
					if (func_34(Global_2648938.f_131[iVar0 /*3*/], Param0, fParam3, iParam4, 1036831949))
					{
						return 1;
					}
				}
...
int func_164(struct<3> Param0, var uParam3)//Position - 0x9131
{
	if (uParam3->f_18)
	{
		switch (uParam3->f_26)
...
Vector3 func_165(struct<3> Param0, float* fParam3, int iParam4, bool bParam5, struct<3> Param6, bool bParam9, bool bParam10, int iParam11, var uParam12, int iParam13, bool bParam14, bool bParam15, var uParam16)//Position - 0x91C2
{
	struct<3> Var0;
	var uVar3;
	var uVar4;
...
float func_166(int iParam0, float fParam1)//Position - 0x9611
{
	float fVar0;
	float fVar3;
	float fVar6;
...
int func_167(struct<3> Param0)//Position - 0x9648
{
	float fVar0;
...
int func_168(struct<3> Param0, float fParam3, struct<3> Param4)//Position - 0x9680
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_169(struct<3> Param0)//Position - 0x96BC
{
	int iVar0;
	int iVar1;
...
void func_174(struct<3> Param0)//Position - 0x9F86
{
	float fVar0;
	var uVar1;
	int iVar2;
...
int func_175(struct<3> Param0, float fParam3, float fParam4)//Position - 0x9FC1
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_178(struct<3> Param0, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, bool bParam8, int iParam9, float fParam10, bool bParam11, int iParam12, bool bParam13, float fParam14, bool bParam15, float fParam16, bool bParam17, bool bParam18)//Position - 0xA063
{
...
int func_187(struct<3> Param0, float fParam3, var uParam4, var uParam5, var uParam6)//Position - 0xA2D6
{
	struct<17> Var0;
	struct<18> Var34;
	struct<3> Var65;
...
int func_188(var uParam0)//Position - 0xA3DC
{
	if (uParam0->f_1)
	{
...
void func_190(var uParam0, bool bParam1, bool bParam2)//Position - 0xA424
{
	if (uParam0->f_1 == 0)
	{
...
int func_199(int iParam0, var uParam1)//Position - 0xA610
{
...
int func_201(var uParam0)//Position - 0xA654
{
	int iVar0;
	int iVar1;
...
void func_203(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, int iParam15)//Position - 0xA727
{
...
int func_204(int iParam0)//Position - 0xA756
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_205(char* sParam0, bool bParam1)//Position - 0xA7B3
{
	int iVar0;
	int iVar1;
...
bool func_209()//Position - 0xA98E
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

int func_210(int iParam0)//Position - 0xA99F
{
	switch (iParam0)
	{
		case 1:
...
int func_212(int iParam0)//Position - 0xAA3B
{
...
int func_223(int iParam0)//Position - 0xAC62
{
...
int func_227(int iParam0)//Position - 0xACA1
{
...
int func_234(struct<21> Param0)//Position - 0xAE6D
{
...
int func_236(int iParam0, int iParam1, bool bParam2)//Position - 0xAF60
{
	int iVar0;
...
void func_238(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)//Position - 0xB087
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_229();
