...
int func_257(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0x27FEA
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
float func_258(struct<3> Param0, struct<3> Param1)//Position - 0x28079
{
...
void func_268(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x282FA
{
...
void func_269(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x28332
{
	int iVar0;
	int iVar1;
...
void func_285(var uParam0, int iParam1, struct<3> Param2, int iParam3)//Position - 0x28D1E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_288(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x28E59
{
	if (bParam2)
	{
...
bool func_304(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x29831
{
...
void func_329(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x2A8B4
{
	int iVar0;
...
void func_332(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x2AAC4
{
	struct<3> Var0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104212.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104212.f_4, false))
		{
			if (func_379(24) != Global_104212.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_376(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_333(Global_104212.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}

void func_333(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x2AB3F
{
	struct<60> Var0;
...
void func_367(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x30B39
{
	if (func_364(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
...
int func_376(struct<3> Param0, int iParam1, var uParam2, var uParam3)//Position - 0x3136D
{
	int iVar0;
...
int func_377(struct<3> Param0, int iParam1, int iParam2)//Position - 0x31483
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_380(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x31543
{
	func_381(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_381(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x3156C
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_383(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x3198C
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_384(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x31C82
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_386(struct<3> Param0, int iParam1)//Position - 0x31D9B
{
	return func_387(Global_104212.f_2890.f_12.f_66, Param0, iParam1);
}

int func_387(int iParam0, struct<3> Param1, int iParam2)//Position - 0x31DB8
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_406(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x323FA
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_408(Global_78814, Global_78816, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
void func_425(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x33037
{
	int iVar0;
	int iVar1;
...
int func_430(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0x33264
{
	int iVar0;
...
int func_432(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)//Position - 0x33338
{
	bool bVar0;
	float fVar1;
...
void func_437(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x3389F
{
	if (func_450())
	{
...
void func_444(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x33C67
{
	func_2(iParam0);
...
int func_445(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0x33CA9
{
