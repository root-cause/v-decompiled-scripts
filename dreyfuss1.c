...
void func_11(int iParam0, bool bParam1)//Position - 0x590
{
	...
	{
		func_183(&(Global_112897[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_15()//Position - 0x81D
{
	...
	{
		func_17(13, SYSTEM::FLOOR(Global_113810.f_10197.f_3853));
	}
...
int func_40(int iParam0, int iParam1, int iParam2)//Position - 0x1803
{
	...
	Global_78472[1 /*14*/] = { func_93(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_78472[1 /*14*/] = { func_93(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_85(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_85(iParam1), Global_78472[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_85(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, 0);
		}
	}
...
int func_41(int iParam0, int iParam1, int iParam2)//Position - 0x19C0
{
	...
	{
		if (!func_158(iParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_64, Global_113810.f_2366.f_539[iVar0 /*65*/].f_63))
		{
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1A87
{
	...
	if (iParam5 == 0)
	{
		Global_78472[1 /*14*/] = { func_93(iVar10, iParam1, iParam2, -1) };
		if (!func_83(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78472[1 /*14*/] = { func_93(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78472[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78472[1 /*14*/] = { func_93(iVar10, 14, uVar28[iVar1], -1) };
							func_59(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
							func_75(14);
							if (Global_78470 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_85(iVar0), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_85(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_85(iVar0), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
						}
						func_75(iVar0);
						if (Global_78470 == 1)
						{
			...
			{
				Global_78472[1 /*14*/] = { func_93(iVar10, iVar0, func_49(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78472[1 /*14*/] = { func_93(iVar10, 14, uVar69[iVar1], -1) };
			func_59(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
			func_75(14);
			if (Global_78470 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_85(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_85(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_85(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
		}
		if (Global_78470 == 1)
		{
			iVar2 = 0;
...
{
	Global_78472[1 /*14*/] = { func_93(iParam0, iParam1, iParam2, -1) };
...
void func_75(int iParam0)//Position - 0x5BCE
{
	...
	{
		func_82(iParam0, Global_78472[1 /*14*/].f_5, Global_78472[1 /*14*/].f_2, 2, Global_78472[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_78472[1 /*14*/].f_6, 1) && BitTest(Global_78472[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_77(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x5CC2
{
	int iVar0;
...
int func_78(int iParam0, var uParam1)//Position - 0x5CE5
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_79(uParam1));
}

int func_79(var uParam0)//Position - 0x5CFA
{
	int iVar0;
	int iVar1;
...
int func_80(int iParam0, int iParam1)//Position - 0x5D2E
{
	int iVar0;
	var uVar1;
...
bool func_81(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x5D5D
{
	int iVar0;
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x875C
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_83(int iParam0)//Position - 0x95FF
{
	if (!BitTest(Global_78472[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9647
{
	int iVar0;
	...
	{
		if (!func_158(iParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_61, Global_113810.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_85(int iParam0)//Position - 0x96F2
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_86(int iParam0, int iParam1)//Position - 0x97A2
{
	int iVar0;
	struct<10> Var1;
...
void func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA0D1
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_88(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xA1FB
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_89(int iParam0, int iParam1)//Position - 0xA243
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_92(&Var1, -99, -99, Global_113810.f_2366.f_539.f_196[0], Global_113810.f_2366.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_92(&Var1, -99, -99, Global_113810.f_2366.f_539.f_196[1], Global_113810.f_2366.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_92(&Var1, -99, -99, Global_113810.f_2366.f_539.f_196[2], Global_113810.f_2366.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_90(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC08D
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
int func_91(int iParam0)//Position - 0xC277
{
	switch (iParam0)
	{
		case 0:
...
void func_92(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xC327
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_93(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC398
{
	func_157();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_94(int iParam0, int iParam1)//Position - 0xC3EA
{
	switch (iParam0)
	{
		case 0:
...
void func_95(int iParam0)//Position - 0xC4DA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_96(&(Global_78472[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_96(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD70F
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_80(func_99(iParam1, uParam0->f_2), Global_78469);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_80(func_98(iParam1, uParam0->f_2), Global_78469);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
...
bool func_97(int iParam0, int iParam1, var uParam2)//Position - 0xDAB0
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_98(int iParam0, int iParam1)//Position - 0xDEB5
{
	switch (iParam1)
	{
		case 0:
...
int func_99(int iParam0, int iParam1)//Position - 0xE2B0
{
	switch (iParam1)
	{
		case 0:
...
int func_100(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE6AB
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_101(int iParam0)//Position - 0xE6E9
{
	return Global_43377 == iParam0;
}

int func_102(int iParam0)//Position - 0xE6F7
{
	switch (iParam0)
	{
		case -1:
...
void func_103(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE7CB
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_96(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_96(&(Global_78472[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_96(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78670)
		{
			...
			func_96(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_104(int iParam0)//Position - 0xEA51
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0xEB9E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(int iParam0)//Position - 0xF0AB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0)//Position - 0xF11F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0xF192
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0)//Position - 0xF279
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0)//Position - 0xF5BB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0xF7C3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0xF9E3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0xFAEC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x10480
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0x10FD8
{
	if (iParam0 < 136)
	{
		func_117(iParam0);
...
void func_116(int iParam0)//Position - 0x1100D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0x11C11
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x12B11
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x12C3E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0, int iParam1)//Position - 0x12D35
{
	switch (iParam0)
	{
		case 0:
...
void func_121(int iParam0)//Position - 0x12E25
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0x142F4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0x1443B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0x14945
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0x14FAE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x15021
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0x150F1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x155EC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0x1577D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x15F6C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x16075
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x16F98
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x17C45
{
	if (iParam0 < 107)
	{
		func_136(iParam0);
...
void func_134(int iParam0)//Position - 0x17C8B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x18730
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x1951E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x1A15D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x1A3D5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0, int iParam1)//Position - 0x1A511
{
	switch (iParam0)
	{
		case 0:
...
void func_140(int iParam0)//Position - 0x1A601
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x1B35F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x1B4CE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x1BA3F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x1BF67
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x1BFDA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x1C0AC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x1C55C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x1C7B7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x1CA77
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x1CC32
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1D778
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x1E3AA
{
	if (iParam0 < 60)
	{
		func_154(iParam0);
...
void func_153(int iParam0)//Position - 0x1E3DF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1F172
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1F7F4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1F8DA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157()//Position - 0x1F9D1
{
...
int func_158(int iParam0, int iParam1, int iParam2)//Position - 0x1FA49
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_158(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_158(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_78472[2 /*14*/] = { func_93(iVar0, 14, iVar4, -1) };
									if (Global_78472[2 /*14*/].f_12 == iVar3)
									{
										if (func_158(iParam0, 14, iVar4))
										{
											if (!func_47(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_78472[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_78472[2 /*14*/] = { func_93(iVar0, iVar2, iVar1, -1) };
						if (!func_47(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_78472[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_78472[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_85(iParam1)) && Global_78472[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_85(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_159(int iParam0)//Position - 0x1FCA2
{
	int iVar0;
	int iVar1;
...
int func_160(int iParam0)//Position - 0x1FCDF
{
	if (func_162(iParam0))
	{
...
var func_161(int iParam0)//Position - 0x1FD04
{
	return Global_2058[iParam0 /*29*/];
}

bool func_162(int iParam0)//Position - 0x1FD13
{
	return iParam0 < 3;
}

void func_163(char* sParam0, var uParam1)//Position - 0x1FD1F
{
...
void func_165()//Position - 0x1FDB6
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_160(Global_113810.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_159(PLAYER::PLAYER_PED_ID());
			if (func_162(iVar0) && (!func_101(14) || Global_112760))
			{
				if (Global_113810.f_2366.f_539.f_4321 != iVar0 && func_162(Global_113810.f_2366.f_539.f_4321))
				{
...
struct<2> func_166(int iParam0)//Position - 0x1FEB3
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_167(int iParam0)//Position - 0x1FEEA
{
	struct<2> Var0;
...
void func_168(int iParam0, int iParam1)//Position - 0x2043E
{
...
void func_169(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x20488
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_170(int iParam0, bool bParam1, bool bParam2)//Position - 0x20525
{
	struct<4> Var0;
	char* sVar32;
	...
	if (iParam0 != -1)
	{
		...
		func_171(&sVar32, Var0.f_3, Global_100870, bParam1, bParam2);
	}
}

void func_171(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x20564
{
...
void func_172(int iParam0, var uParam1)//Position - 0x205A8
{
	switch (iParam0)
	{
		case 0:
...
int func_174(int iParam0)//Position - 0x217EE
{
	switch (iParam0)
	{
		case 0:
...
void func_175(int iParam0)//Position - 0x21B34
{
	Global_43928 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_176()//Position - 0x21B46
{
	if (Global_98125)
	{
		func_165();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_177(Global_113810.f_2366.f_539.f_4321));
	}
	else
	{
...
char* func_177(var uParam0)//Position - 0x21B78
{
	uParam0 = uParam0;
	return "";
}

void func_178()//Position - 0x21B87
{
	char cVar0[24];
...
bool func_179()//Position - 0x21BCA
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_180()//Position - 0x21BE0
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_181(int iParam0, int iParam1)//Position - 0x21BF6
{
	Global_98120 = iParam0;
	Global_98121 = iParam1;
}

void func_182()//Position - 0x21C0A
{
	if (Global_78944 != 6)
	{
	}
...
void func_183(var uParam0)//Position - 0x21C42
{
	if (*uParam0 == -1)
	{
		return;
...
void func_184(int iParam0, bool bParam1)//Position - 0x21C7F
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_185(int iParam0)//Position - 0x21DFC
{
	switch (iParam0)
	{
		case 0:
...
void func_186(int iParam0)//Position - 0x22183
{
	func_188(iParam0, 1);
	Global_113810.f_18577[iParam0 /*6*/].f_3 = func_187();
	Global_113810.f_18577.f_380++;
}

int func_187()//Position - 0x221B9
{
	return (Global_113810.f_10019.f_21 + Global_113810.f_18577.f_380);
}

void func_188(var uParam0, bool bParam1)//Position - 0x221D5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_189(int iParam0)//Position - 0x224F9
{
...
void func_190(int iParam0)//Position - 0x2252C
{
	switch (iParam0)
	{
		case 30:
...
void func_191(int iParam0, bool bParam1)//Position - 0x22561
{
	if (iParam0 == -1)
	{
		return;
...
void func_192(int iParam0, int iParam1, bool bParam2)//Position - 0x225BE
{
	if (iParam0 == -1)
	{
		return;
...
int func_193(int iParam0, int iParam1)//Position - 0x225F9
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_194(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x22619
{
	if (iParam0 != 198)
	{
		if (Global_78689)
...
void func_195(int iParam0, int iParam1)//Position - 0x22671
{
	switch (iParam0)
	{
		case 12:
...
void func_196(int iParam0, bool bParam1)//Position - 0x2275A
{
	if (bParam1)
	{
...
bool func_197(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x22783
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_199()//Position - 0x23102
{
	return Global_32284;
}

int func_200(var uParam0, int iParam1)//Position - 0x2310D
{
	int iVar0;
...
int func_201(int iParam0)//Position - 0x268A8
{
	switch (iParam0)
	{
		case 46:
...
void func_202(int iParam0, bool bParam1)//Position - 0x26997
{
	switch (iParam0)
	{
		case 46:
...
void func_203(int iParam0, bool bParam1)//Position - 0x269E8
{
	int iVar0;
...
void func_204(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x26A4E
{
	func_205(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_205(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x26A6F
{
	int iVar0;
...
void func_206()//Position - 0x26C42
{
	int iVar0;
...
int func_207(int iParam0)//Position - 0x26D59
{
	int iVar0;
	int iVar1;
...
void func_208(char* sParam0)//Position - 0x26D99
{
...
char* func_209(int iParam0)//Position - 0x26DBD
{
	switch (iParam0)
	{
		case 0:
...
int func_210(int iParam0)//Position - 0x26F90
{
...
void func_211(int iParam0, int iParam1)//Position - 0x26FBA
{
...
int func_212(char* sParam0)//Position - 0x26FF7
{
	int iVar0;
...
int func_213()//Position - 0x27057
{
	return func_214(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_214(char* sParam0, int iParam1)//Position - 0x27068
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_215(int iParam0, int iParam1)//Position - 0x270B1
{
	if (BitTest(Global_100833.f_20, 17))
	{
		return 0;
	}
...
int func_216(int iParam0, int iParam1)//Position - 0x270D1
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_217(int iParam0, int iParam1)//Position - 0x270EC
{
	...
	if (func_227(&Global_4542602))
	{
		if (func_225(&Global_4542602, iParam0))
		{
			return 0;
		}
		if (func_218(&Global_4542602, iParam0))
		{
			return 1;
		}
	}
...
int func_218(var uParam0, int iParam1)//Position - 0x27189
{
	int iVar0;
	var uVar1[78];
...
int func_219(var uParam0, int iParam1)//Position - 0x2723A
{
	int iVar0;
...
bool func_220(var uParam0, int iParam1)//Position - 0x272B5
{
	return (*uParam0)[iParam1] == 78;
}

void func_221(var uParam0)//Position - 0x272C6
{
	int iVar0;
	...
	func_223(uParam0, (Global_4542601 - 0.5f));
}

void func_222(var uParam0, int iParam1)//Position - 0x272FA
{
	(*uParam0)[iParam1] = 78;
}

void func_223(var uParam0, float fParam1)//Position - 0x2730A
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_224(var uParam0)//Position - 0x27327
{
	return uParam0->f_80;
}

bool func_225(var uParam0, int iParam1)//Position - 0x27333
{
	return func_226(uParam0, iParam1) != -1;
}

int func_226(var uParam0, int iParam1)//Position - 0x27345
{
	int iVar0;
...
bool func_227(var uParam0)//Position - 0x27372
{
	return uParam0->f_79 == 1;
}

int func_228(int iParam0)//Position - 0x27380
{
	switch (iParam0)
	{
		case 60:
...
bool func_229(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x273D0
{
...
int func_230(char* sParam0, int iParam1, bool bParam2)//Position - 0x27424
{
	Global_21846 = 0;
...
void func_231()//Position - 0x276F2
{
	if (!func_232())
	{
		return;
...
bool func_233(int iParam0)//Position - 0x2778C
{
	return func_234(iParam0, 20);
}

var func_234(int iParam0, int iParam1)//Position - 0x2779C
{
	return BitTest(Global_1895156[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_235()//Position - 0x277B4
{
	return -1;
}

void func_236()//Position - 0x277BD
{
	int iVar0;
...
void func_237()//Position - 0x277EE
{
...
void func_240()//Position - 0x27943
{
	if (func_101(14))
	{
...
int func_241()//Position - 0x279E5
{
	func_165();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_242()//Position - 0x279FE
{
	int iVar0;
...
bool func_243(int iParam0, int iParam1)//Position - 0x27A55
{
	switch (iParam0)
	{
		case 5:
...
void func_244()//Position - 0x27A8D
{
...
void func_245(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27AE4
{
...
void func_247()//Position - 0x27B5C
{
	Global_20711 = 0;
	func_248();
}

void func_248()//Position - 0x27B6C
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22856 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_249()//Position - 0x27B8D
{
	Global_20711 = 0;
	func_244();
}

void func_250()//Position - 0x27B9D
{
	switch (iLocal_153)
	{
		case 0:
		...
		case 1:
			...
			if (!func_443(iLocal_154))
			{
				...
				if (!BitTest(Global_113810.f_18577.f_382, 0))
				{
					MISC::SET_BIT(&(Global_113810.f_18577.f_382), 0);
				}
				func_299(4);
			}
...
void func_251()//Position - 0x27CC1
{
	if (!bLocal_505)
	{
...
void func_252(int iParam0, int iParam1, int iParam2, var uParam3, char* sParam4, char* sParam5, bool bParam6)//Position - 0x27D49
{
	if (!func_263(PLAYER::PLAYER_PED_ID(), iLocal_154, fLocal_332, 1))
	{
		iLocal_535 = 1;
...
int func_253(int iParam0)//Position - 0x27E62
{
	if (func_443(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_254(bool bParam0)//Position - 0x27E82
{
	if (iLocal_546 == 0)
	{
...
int func_255(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x27F28
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_256(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x28024
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_257(int iParam0, float fParam1)//Position - 0x28130
{
	var uVar0;
	struct<3> Var1;
...
int func_258(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x281C5
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_259(struct<3> Param0, struct<3> Param3)//Position - 0x28253
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_260(struct<3> Param0)//Position - 0x28274
{
	float fVar0;
	float fVar1;
...
int func_261(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x282B3
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
bool func_262(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x282FB
{
...
bool func_263(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x28349
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), ENTITY::GET_ENTITY_COORDS(iParam1, bParam3)) <= (fParam2 * fParam2);
}

void func_264(int* iParam0, char* sParam1, char* sParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2836B
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_265(char* sParam0, int iParam1, int iParam2)//Position - 0x28466
{
	iParam2 = iParam2;
...
bool func_266(char* sParam0, int iParam1, char* sParam2)//Position - 0x2847F
{
...
void func_267(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x2849D
{
	func_268(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_268(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x284B7
{
	func_269(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_269(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x284D4
{
...
void func_270(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2850C
{
	int iVar0;
	int iVar1;
...
void func_271(var uParam0)//Position - 0x28875
{
...
int func_272(var uParam0)//Position - 0x288D9
{
	int iVar0;
...
int func_273(bool bParam0)//Position - 0x28904
{
	switch (Global_43377)
	{
		case 0:
...
void func_274(char* sParam0, int iParam1)//Position - 0x289AE
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_275(char* sParam0)//Position - 0x289C5
{
	if (!func_276(1, 1, 0))
	{
...
int func_276(bool bParam0, bool bParam1, bool bParam2)//Position - 0x28A5D
{
	int iVar0;
	int iVar1;
...
int func_277(int iParam0)//Position - 0x28CB6
{
	if (iParam0 != func_235())
	{
...
int func_278(int iParam0, bool bParam1, bool bParam2)//Position - 0x28D1C
{
	int iVar0;
...
int func_279(int iParam0, int iParam1)//Position - 0x28D7C
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
...
int func_280(int iParam0, bool bParam1)//Position - 0x28DDE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_281()//Position - 0x28E63
{
	return Global_2683883.f_19;
}

bool func_282(int iParam0)//Position - 0x28E71
{
	return iParam0 == 51;
}

var func_283()//Position - 0x28E7E
{
	return Global_2683883.f_18;
}

bool func_284()//Position - 0x28E8C
{
	return MISC::GET_GAME_TIMER() <= Global_23390.f_6321 + 100;
}

int func_285(int iParam0)//Position - 0x28EA1
{
	if (iParam0 == 1)
	{
		if (Global_20500.f_1 > 3)
...
void func_286(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x28EF8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_287()//Position - 0x29004
{
	return func_288(PLAYER::PLAYER_ID());
}

int func_288(int iParam0)//Position - 0x29014
{
...
bool func_289(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x29033
{
	if (bParam6)
	{
...
int func_290(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x2907A
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_291(bool bParam0, bool bParam1, bool bParam2)//Position - 0x293E6
{
...
int func_292(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29438
{
	if (!func_276(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_293(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29481
{
	if (!func_276(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_294(bool bParam0, bool bParam1, bool bParam2)//Position - 0x294E0
{
	if (!func_276(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_295(int iParam0)//Position - 0x29536
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_296()//Position - 0x29591
{
	MISC::SET_BIT(&Global_8371, 4);
}

float func_297(int iParam0, int iParam1)//Position - 0x295A1
{
	return func_298(iParam0, iParam1, 1);
}

float func_298(int iParam0, int iParam1, bool bParam2)//Position - 0x295B2
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_299(int iParam0)//Position - 0x29610
{
	iLocal_152 = iParam0;
	iLocal_153 = 0;
}

void func_300(int iParam0)//Position - 0x2961F
{
	bool bVar0;
	int iVar1;
...
void func_301()//Position - 0x29690
{
	if (func_443(iLocal_154))
	{
		if (WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(iLocal_154, joaat("WEAPON_STUNGUN"), 0))
		{
			if (func_443(iLocal_154))
			{
				ENTITY::SET_ENTITY_HEALTH(iLocal_154, 99, 0);
			}
		}
	}
}

void func_302()//Position - 0x296C2
{
	int iVar0;
...
void func_303()//Position - 0x29929
{
	if (func_443(Local_84.f_35[0]))
	{
		if (func_307())
...
bool func_305(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x29A0B
{
	return SYSTEM::VDIST2(Param0, Param3) <= (fParam6 * fParam6);
}

void func_306()//Position - 0x29A25
{
	iLocal_534 = MISC::GET_GAME_TIMER();
...
int func_309(int iParam0)//Position - 0x29B53
{
	int iVar0;
...
void func_310()//Position - 0x29B9F
{
	switch (iLocal_153)
	{
		case 0:
			...
			if (func_443(iLocal_154))
			{
				...
				if (func_3(Local_84.f_35[0]))
				{
					...
					TASK::TASK_ENTER_VEHICLE(0, Local_84.f_35[0], 20000, -1, 3f, 1, 0);
...
int func_311(int iParam0)//Position - 0x29E93
{
...
int func_313(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x29F6E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_314()//Position - 0x29FFF
{
...
void func_315(int iParam0, bool bParam1)//Position - 0x2A043
{
...
void func_316(int* iParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, bool bParam5, int iParam6)//Position - 0x2A07F
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if (bParam5)
...
int func_317(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x2A12B
{
	int iVar0;
	bool bVar1;
...
void func_319(var uParam0, bool bParam1, bool bParam2)//Position - 0x2A23A
{
	int iVar0;
...
void func_320()//Position - 0x2A32F
{
	switch (iLocal_153)
	{
		case 0:
...
void func_321(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2A74F
{
	int iVar0;
...
void func_322(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2A7F9
{
	if (bParam0)
	{
...
bool func_323()//Position - 0x2A946
{
	return BitTest(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_36.f_18, 14);
}

bool func_324(int iParam0, int iParam1)//Position - 0x2A960
{
	bool bVar0;
...
int func_325(int iParam0, bool bParam1)//Position - 0x2A9B9
{
	int iVar0;
	int iVar1;
...
int func_326(var uParam0)//Position - 0x2A9FA
{
	int iVar0;
...
int func_327(int iParam0)//Position - 0x2AA1C
{
...
bool func_328()//Position - 0x2AA5B
{
	return BitTest(Global_2621446, 3);
}

int func_329(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x2AA69
{
	int iVar0;
...
void func_330(int iParam0)//Position - 0x2AA9C
{
	if (iParam0 == 1)
	{
...
void func_331(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x2AABF
{
	int iVar0;
...
Vector3 func_332(int iParam0)//Position - 0x2AC7D
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_333(bool bParam0)//Position - 0x2AC90
{
	int iVar0;
...
void func_334(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2ACCF
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104373.f_4))
	{
		...
		{
			if (func_382(24) != Global_104373.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_379(ENTITY::GET_ENTITY_COORDS(Global_104373.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_335(Global_104373.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_335(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x2AD4A
{
	struct<60> Var0;
...
void func_336(int iParam0, int iParam1, int iParam2)//Position - 0x2AE73
{
	int iVar0;
	...
	if (!func_367(&(Global_77479.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_113810.f_32752.f_4801 = func_356();
			}
...
void func_337(int iParam0, int iParam1)//Position - 0x2AF8A
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_374(iParam0, &(Global_113810.f_32752.f_5510));
}

int func_338(int iParam0)//Position - 0x2B18C
{
...
int func_339(int iParam0)//Position - 0x2B269
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_340(int iParam0, bool bParam1, int iParam2)//Position - 0x2B41B
{
	int iVar0;
	struct<2> Var1;
...
int func_341(int iParam0)//Position - 0x2B59D
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_343(int iParam0, int iParam1)//Position - 0x2B680
{
	int iVar0;
	int iVar1;
...
int func_344(bool bParam0)//Position - 0x30859
{
	if (bParam0)
	{
...
int func_345()//Position - 0x30873
{
	return 0;
}

int func_346()//Position - 0x3087C
{
	return 1;
}

int func_347()//Position - 0x30885
{
	return 1;
}

int func_348()//Position - 0x3088E
{
...
int func_350(int iParam0)//Position - 0x3095F
{
	int iVar0;
	char* sVar1;
...
int func_351(int iParam0)//Position - 0x309A6
{
	int iVar0;
...
int func_352(int iParam0)//Position - 0x309E1
{
	int iVar0;
...
int func_353(int iParam0)//Position - 0x30A5D
{
	int iVar0;
...
int func_354(int iParam0, int iParam1, bool bParam2)//Position - 0x30B45
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_355(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x30BB3
{
...
void func_357(var uParam0, int iParam1)//Position - 0x30CD1
{
	if (iParam1 <= 0)
	{
		return;
...
void func_358(var uParam0, int iParam1)//Position - 0x30D57
{
...
void func_359(var uParam0, int iParam1)//Position - 0x30D8A
{
	int iVar0;
	int iVar1;
...
int func_360(int iParam0, int iParam1)//Position - 0x30DDB
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_361(int iParam0)//Position - 0x30E7D
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_362(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_362(bool bParam0, int iParam1, int iParam2)//Position - 0x30E9F
{
	if (bParam0)
	{
		return iParam1;
...
int func_363(var uParam0)//Position - 0x30EB6
{
	return uParam0 & 15;
}

void func_364(var uParam0, int iParam1)//Position - 0x30EC3
{
...
void func_365(var uParam0, int iParam1)//Position - 0x30EFD
{
...
void func_366(var uParam0, int iParam1)//Position - 0x30F38
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_367(var uParam0, int iParam1)//Position - 0x30F74
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_289(Global_113810.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_289(Global_113810.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_289(Global_113810.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_368(int iParam0, int iParam1)//Position - 0x32662
{
	struct<82> Var0;
...
void func_369(int iParam0, var uParam1, int iParam2)//Position - 0x326A4
{
	int iVar0;
...
void func_370(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x32900
{
	if (func_367(&(Global_77479.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_372(iParam0);
			func_371(uParam1, &(Global_113810.f_32752.f_69[Global_77479.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_371(var uParam0, var uParam1)//Position - 0x329F9
{
...
void func_372(int iParam0)//Position - 0x32AC5
{
	if (iParam0 == -1)
	{
		return;
...
int func_373(int iParam0)//Position - 0x32B3C
{
	int iVar0;
...
void func_374(int iParam0, var uParam1)//Position - 0x32B9F
{
	int iVar0;
...
int func_375(int iParam0)//Position - 0x32E4A
{
	switch (iParam0)
	{
		case 1:
...
int func_376(int iParam0, var uParam1, var uParam2)//Position - 0x32EFA
{
	int iVar0;
	int iVar1;
...
int func_377(int iParam0)//Position - 0x330ED
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_378(int iParam0)//Position - 0x3310D
{
...
int func_379(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x33134
{
	int iVar0;
...
int func_380(struct<3> Param0, int iParam3, int iParam4)//Position - 0x3324A
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_381(int iParam0)//Position - 0x332D9
{
	return BitTest(Global_113810.f_7232[iParam0], 0);
}

int func_382(int iParam0)//Position - 0x332EE
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_383(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x3330A
{
	func_384(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_384(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x33333
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_385(struct<3> Param0)//Position - 0x33729
{
...
int func_386(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x33753
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_387(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x33A49
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_388(int iParam0)//Position - 0x33AFD
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
bool func_389(struct<3> Param0, int iParam3)//Position - 0x33B62
{
	return func_390(Global_104373.f_2890.f_12.f_66, Param0, iParam3);
}

int func_390(int iParam0, struct<3> Param1, int iParam4)//Position - 0x33B7F
{
	struct<3> Var0;
	struct<3> Var3;
...
Vector3 func_391()//Position - 0x33BE9
{
	return 2.55f, 5.665f, 2.55f;
}

void func_392()//Position - 0x33C00
{
	int iVar0;
...
int func_393(int iParam0, float fParam1, int iParam2)//Position - 0x33C20
{
	int iVar0;
...
bool func_394()//Position - 0x33CF4
{
	bool bVar0;
...
void func_395()//Position - 0x33D17
{
...
int func_396(int iParam0, int iParam1)//Position - 0x33D68
{
	if (func_253(iParam0))
	{
...
int func_397(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x33D9B
{
...
void func_398(int iParam0)//Position - 0x33F33
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_399()//Position - 0x33F5F
{
	func_400();
...
void func_400()//Position - 0x33FB5
{
	func_402(0);
	func_395();
	func_401();
...
void func_401()//Position - 0x33FCA
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_402(int iParam0)//Position - 0x34025
{
	if (func_406())
	{
		return;
...
void func_403(int iParam0)//Position - 0x34058
{
	if (func_406())
	{
		return;
...
void func_404(bool bParam0, bool bParam1)//Position - 0x340E2
{
	if (bParam0)
	{
		if (func_285(0))
...
bool func_405()//Position - 0x34156
{
	return BitTest(Global_1963795, 5);
}

bool func_406()//Position - 0x34164
{
	return BitTest(Global_1963795, 19);
}

void func_407(int* iParam0, bool bParam1)//Position - 0x34173
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_408(char* sParam0, bool bParam1)//Position - 0x341AE
{
	func_333(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_409(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x341C4
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_411(Global_78945, Global_78947, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_410(char* sParam0)//Position - 0x344A9
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_411(int iParam0, int iParam1, int iParam2)//Position - 0x344BC
{
	struct<2> Var0;
	int iVar2;
...
char* func_412(int iParam0)//Position - 0x34592
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_413(int iParam0)//Position - 0x346E5
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_414(int iParam0)//Position - 0x34718
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_415(int iParam0)//Position - 0x3474B
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_416(int iParam0)//Position - 0x3477E
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_417(int iParam0)//Position - 0x347B1
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_418(int iParam0)//Position - 0x347EE
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_419(int iParam0)//Position - 0x34821
{
	struct<2> Var0;
...
int func_420(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x3488A
{
	if (((!func_422(0) || Global_78960) || Global_78948 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78944)
...
bool func_421(bool bParam0)//Position - 0x349A2
{
	if (bParam0)
	{
...
int func_422(int iParam0)//Position - 0x349CB
{
	if (Global_43377 == 15)
	{
		return 0;
...
bool func_423(int iParam0)//Position - 0x349ED
{
	return func_424(iParam0, Global_43377);
}

int func_424(int iParam0, int iParam1)//Position - 0x349FE
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_425(int iParam0)//Position - 0x34BDF
{
	func_439(1, 1);
	MISC::SET_INSTANCE_PRIORITY_HINT(0);
	func_438();
...
void func_426(int iParam0, int iParam1, int iParam2)//Position - 0x34D0A
{
...
void func_427(int iParam0, int iParam1, int iParam2)//Position - 0x34D3E
{
...
void func_428(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x34E02
{
	int iVar0;
	int iVar1;
...
void func_429()//Position - 0x34E72
{
	Global_23251.f_6 = 1;
}

void func_430()//Position - 0x34E80
{
	if (!func_443(Local_84.f_35[0]))
	{
...
void func_431()//Position - 0x34F00
{
	if (!func_443(iLocal_154))
	{
...
void func_432(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x34F94
{
...
int func_433(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x3502F
{
	int iVar0;
...
int func_434(var uParam0, int iParam1)//Position - 0x350BD
{
	int iVar0;
...
int func_435(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x35103
{
	bool bVar0;
	float fVar1;
...
bool func_436()//Position - 0x3515F
{
	return BitTest(Global_100833.f_20, 13);
}

void func_437(bool bParam0, int iParam1, int iParam2)//Position - 0x35170
{
	bool bVar0;
...
void func_438()//Position - 0x351CF
{
	int iVar0;
...
void func_439(bool bParam0, bool bParam1)//Position - 0x35637
{
	if (bParam0)
	{
		func_437(0, 1, 1);
...
void func_440(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x3566A
{
	if (func_453())
	{
...
void func_442()//Position - 0x35729
{
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.1f);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_79, true);
	func_438();
	MISC::CLEAR_BIT(&(Global_113810.f_18577.f_382), 0);
...
int func_443(int iParam0)//Position - 0x35776
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_444(bool bParam0)//Position - 0x35797
{
...
int func_446(var uParam0)//Position - 0x35817
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
...
void func_447(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x35A32
{
	func_2(iParam0);
...
int func_448(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x35A74
{
...
int func_449(var uParam0)//Position - 0x35AD0
{
	if (func_450(uParam0))
	{
...
int func_450(var uParam0)//Position - 0x35AFA
{
...
int func_451(int iParam0)//Position - 0x35B1F
{
	int iVar0;
...
void func_452(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x35B50
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
void func_454()//Position - 0x35BB0
{
	func_392();
	if (func_469())
	{
...
void func_455(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x35C06
{
...
void func_456(var uParam0, bool bParam1)//Position - 0x35C26
{
	func_457(&(uParam0->f_41), bParam1);
}

void func_457(var uParam0, bool bParam1)//Position - 0x35C38
{
	int iVar0;
...
void func_458(int* iParam0)//Position - 0x35C76
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_459(var uParam0, bool bParam1)//Position - 0x35CA1
{
	func_460(&(uParam0->f_35), bParam1);
}

void func_460(var uParam0, bool bParam1)//Position - 0x35CB3
{
	int iVar0;
...
void func_461(int* iParam0)//Position - 0x35CF0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_462(var uParam0, int iParam1)//Position - 0x35D28
{
	func_463(&(uParam0->f_28), iParam1);
}

void func_463(var uParam0, int iParam1)//Position - 0x35D3A
{
	int iVar0;
...
void func_464(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x35D7B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_465()//Position - 0x35DCB
{
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
	func_7(&uLocal_547, 0, 0);
	func_444(1);
...
void func_466()//Position - 0x35E3D
{
	Global_20711 = 0;
	func_467();
}

void func_467()//Position - 0x35E4D
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_468(var uParam0, int iParam1)//Position - 0x35E71
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_470(bool bParam0)//Position - 0x35F2F
{
	int iVar0;
...
void func_471(char* sParam0, int iParam1)//Position - 0x35FFF
{
	if (Global_100833 != 12)
	{
...
int func_472(char* sParam0, int iParam1, int iParam2)//Position - 0x36027
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_473(char* sParam0)//Position - 0x361B6
{
...
int func_474()//Position - 0x36210
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_475(&(Global_100833.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_475(char* sParam0, bool bParam1)//Position - 0x36234
{
	int iVar0;
	int iVar1;
...
int func_476(int iParam0, bool bParam1)//Position - 0x3625E
{
	int iVar0;
...
int func_478()//Position - 0x362E4
{
	...
	{
		if (func_473(&(Global_100833.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_479(bool bParam0)//Position - 0x36350
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_480(int iParam0)//Position - 0x36364
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_481(int iParam0)//Position - 0x3639E
{
	if (iParam0 == 1)
	{
...
void func_482()//Position - 0x363D8
{
	Global_23251.f_5 = 1;
}

void func_483()//Position - 0x363E6
{
	Global_23251.f_5 = 0;
}

void func_484(bool bParam0)//Position - 0x363F4
{
	if (bParam0)
	{
		func_485();
...
void func_485()//Position - 0x36457
{
...
void func_486()//Position - 0x36480
{
	Global_94989 = 0;
	Global_94990 = 0;
}

int func_487()//Position - 0x36492
{
...
void func_488()//Position - 0x364D0
{
	Global_100868 = 1;
...
void func_489(char* sParam0)//Position - 0x365C3
{
...
void func_490(var uParam0)//Position - 0x365D5
{
...
void func_491(var uParam0)//Position - 0x365F5
{
	int iVar0;
...
int func_492(int iParam0)//Position - 0x3662F
{
	if (!func_162(iParam0))
	{
		return func_161(iParam0);
