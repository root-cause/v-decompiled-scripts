		...
		switch (iLocal_821)
		{
			case 0:
				if (!PED::IS_PED_INJURED(Global_112680) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, false))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(Global_112680, Global_112679))
					{
						if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_824, "leanover_enter", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_824, "leanover_idle", 3))
						{
	...
	switch (iLocal_823)
	{
		...
		case 6:
			...
			if (iLocal_815 != -1)
			{
				...
				if (bVar1)
				{
					CLOCK::ADVANCE_CLOCK_TIME_TO(Global_91469[iLocal_815 /*34*/].f_13, 0, 0);
				}
			}
...
void func_81()//Position - 0x3E2E
{
	...
	switch (iLocal_816)
	{
		case 92:
			Var0 = { func_83(229, 0) };
			fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Global_112686, Var0, true);
			if (fVar1 < 100f)
			{
				Var0 = { func_82(Global_112686 - Var0) };
				Var0 = { (Global_112686 + (Var0.f_0 * IntToFloat((100 - SYSTEM::ROUND(fVar1))))), (Global_112686.f_1 + (Var0.f_1 * IntToFloat((100 - SYSTEM::ROUND(fVar1))))), Global_112686.f_2 };
...
void func_120()//Position - 0x62BC
{
	...
	fVar0 = (((func_119(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_112686) / 50f) * fLocal_73) * 2.4f);
...
void func_121()//Position - 0x6324
{
	...
	if (iLocal_101 != iLocal_102)
	{
		...
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		fLocal_83 = SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_112686);
	...
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		switch (iLocal_820)
		{
			...
			case 2:
				...
				{
					if (func_125(&Global_112679, ENTITY::GET_ENTITY_COORDS(Global_112679, false), Local_829, uParam1, fParam2, &iLocal_88, iParam0, 1000))
					{
						iLocal_820 = 3;
						return 0;
					}
...
int func_156(var uParam0, int iParam1, float fParam2)//Position - 0xC189
{
	...
	while (iVar4 < 8)
	{
		if (Global_97614[iVar4 /*17*/])
		{
			...
			{
				if (HUD::DOES_BLIP_EXIST(Global_32543[Global_97614[iVar4 /*17*/].f_9 /*23*/].f_19))
				{
					Var3 = { HUD::GET_BLIP_COORDS(Global_32543[Global_97614[iVar4 /*17*/].f_9 /*23*/].f_19) };
					if (uParam0->f_2 == 1f)
					{
						Var3.f_2 = 1f;
					}
	...
	if (!PED::IS_PED_INJURED(Global_112680) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, false))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(Global_112680, Global_112679))
		{
			...
			else if (!func_2(Global_112680, joaat("SCRIPT_TASK_VEHICLE_PARK")))
			{
				...
				fVar1 = ENTITY::GET_ENTITY_HEADING(Global_112679);
				TASK::TASK_VEHICLE_PARK(Global_112680, Global_112679, Var0, fVar1, 3, 60f, false);
			}
		}
	}
}
		...
		if (bLocal_61)
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, false))
			{
				if (!PED::IS_PED_INJURED(Global_112680))
				{
					...
					else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_824, "leanover_enter", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_824, "leanover_idle", 3))
					{
						if (PED::IS_PED_HEADTRACKING_PED(Global_112680, PLAYER::PLAYER_PED_ID()))
						{
							TASK::TASK_CLEAR_LOOK_AT(Global_112680);
						}
						TASK::TASK_PLAY_ANIM(Global_112680, &cLocal_824, "leanover_exit", 4f, -4f, -1, 0, 0f, false, false, false);
					}
					else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_824, "leanover_exit", 3))
					{
						ENTITY::SET_ENTITY_ANIM_SPEED(Global_112680, &cLocal_824, "leanover_exit", 1.2f);
					...
					else if (!func_2(Global_112680, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
					{
						...
						else
						{
							...
							TASK::TASK_VEHICLE_PARK(0, Global_112679, Global_112686, Global_112692, iLocal_110, 60f, true);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_813);
							TASK::TASK_PERFORM_SEQUENCE(Global_112680, iLocal_813);
...
{
	if ((ENTITY::IS_ENTITY_AT_COORD(Global_112679, Global_112686, 45f, 45f, 20f, false, true, 0) || iLocal_56) || iLocal_821 == 4)
	{
		iLocal_56 = 1;
...
int func_176()//Position - 0xCD19
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_112679))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, false))
		{
			iLocal_109 = OBJECT::CREATE_OBJECT(iLocal_108, ENTITY::GET_ENTITY_COORDS(Global_112679, true), true, true, false);
			ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_109, Global_112679, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(Global_112679, "Chassis"), Local_837, Local_838, false, false, false, false, 2, true, 0);
...
void func_178()//Position - 0xCE0D
{
	...
	if (!CAM::DOES_CAM_EXIST(iLocal_68))
	{
		if (!func_186() && !func_185(8, -1))
		{
			...
			CAM::ATTACH_CAM_TO_ENTITY(iLocal_68, Global_112679, Local_835, true);
			func_182();
...
void func_182()//Position - 0xD006
{
	if (CAM::DOES_CAM_EXIST(iLocal_68))
	{
		func_183(Global_112679, &iLocal_68, Local_836);
...
void func_183(int iParam0, int iParam1, struct<3> Param2)//Position - 0xD045
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
		if (CAM::DOES_CAM_EXIST(*iParam1))
		{
			...
			fVar3 = Var0.f_1;
			Var4 = { func_82(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_112679, Param2) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_112679, Local_835)) };
...
void func_197(struct<3> Param0, bool bParam1)//Position - 0xEB82
{
	int iVar0;
	int iVar1;
...
void func_198(struct<3> Param0, int iParam1)//Position - 0xECA1
{
	func_199(iParam1);
...
void func_200(struct<3> Param0, int iParam1)//Position - 0xED27
{
	Local_819[iParam1 /*3*/] = { Param0 };
	if (func_127(Local_819[iParam1 /*3*/]) == HUD::GET_WAYPOINT_BLIP_ENUM_ID())
	{
...
bool func_207(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0xEF48
{
	if (bParam2)
	{
			...
			if (iLocal_821 == 2)
			{
				...
				if (!bLocal_64)
				{
					if (PAD::IS_CONTROL_JUST_PRESSED(2 /*FRONTEND_CONTROL*/, 179 /*INPUT_CELLPHONE_EXTRA_OPTION*/))
					{
						...
						if (!PED::IS_PED_INJURED(Global_112680))
						{
							if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_824, "leanover_enter", 3))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_824, "leanover_idle", 3))
								{
									if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_824, "leanover_exit", 3))
									{
										TASK::CLEAR_PED_TASKS(Global_112680);
									}
								}
...
int func_230()//Position - 0xFB43
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_234(&iVar0, func_236(), func_235()))
		{
			...
			{
				Local_832 = { ENTITY::GET_ENTITY_COORDS(Global_112679, true) - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
				Local_832.f_2 = 0f;
...
void func_237(bool bParam0)//Position - 0x100FA
{
	...
	if (func_238(Global_112680))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_824, "leanover_enter", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(Global_112680, "leanover_enter", &cLocal_824, -2f);
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_824, "leanover_idle", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(Global_112680, "leanover_idle", &cLocal_824, -2f);
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_824, "leanover_exit", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(Global_112680, "leanover_exit", &cLocal_824, -2f);
		}
		if (PED::IS_PED_HEADTRACKING_PED(Global_112680, PLAYER::PLAYER_PED_ID()))
		{
			TASK::TASK_CLEAR_LOOK_AT(Global_112680);
