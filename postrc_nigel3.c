	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			else if (!func_24())
			{
				...
				if (!BitTest(Global_114372.f_18577.f_382, 5))
				{
					MISC::SET_BIT(&(Global_114372.f_18577.f_382), 5);
				}
				func_32();
			}
			else if (!func_22())
...
void func_1()//Position - 0xF6
{
	...
	{
		case 0:
			if ((MISC::GET_GAME_TIMER() - iLocal_185) > 5000 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_186, PLAYER::PLAYER_PED_ID(), true))
			{
				if (func_3(&uLocal_20, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_186);
					iLocal_19 = 1;
				}
			}
			else if ((MISC::GET_GAME_TIMER() - iLocal_185) > 12000 && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_186, true)) <= 900f)
			{
				if (func_3(&uLocal_20, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					iLocal_19 = 1;
...
bool func_3(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1C8
{
...
int func_4(char* sParam0, int iParam1, bool bParam2)//Position - 0x216
{
	Global_22167 = 0;
...
var func_8(int iParam0, int iParam1)//Position - 0x58E
{
	return BitTest(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_9()//Position - 0x5A6
{
	return -1;
}
...
void func_19(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x8CB
{
...
{
	iLocal_185 = MISC::GET_GAME_TIMER();
	func_21(&uLocal_20, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	func_21(&uLocal_20, 5, iLocal_186, "DINAPOLI", 0, 1);
	iLocal_18 = 1;
}

void func_21(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x950
{
...
int func_22()//Position - 0x9EB
{
	float fVar0;
	
	fVar0 = 200f;
	if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_186, true)) >= (fVar0 * fVar0) && !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_186))
	{
		return 0;
	}
	return 1;
...
int func_24()//Position - 0xA6D
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_186))
	{
		if (!PED::IS_PED_INJURED(iLocal_186))
		{
			return 1;
		}
	}
...
void func_26()//Position - 0xAA6
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_29(Global_114372.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_27(iVar0) && (!func_15(14) || Global_113320))
			{
...
bool func_27(int iParam0)//Position - 0xBA3
{
	return iParam0 < 3;
}

int func_28(int iParam0)//Position - 0xBAF
{
	int iVar0;
	int iVar1;
...
int func_29(int iParam0)//Position - 0xBEC
{
	if (func_27(iParam0))
	{
...
var func_30(int iParam0)//Position - 0xC11
{
