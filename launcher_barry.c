...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		func_313("Force cleanup [TERMINATING]");
		if (Var0.f_0 != -1)
		{
			if (Global_112473[Var0.f_0 /*10*/].f_9 != -1)
			{
				func_313("Relinquishing candidate id...");
				func_312(&(Global_112473[Var0.f_0 /*10*/].f_9));
			}
		}
		func_295(&Var0, 1);
	}
	...
	while (!func_260(&Var0))
	{
		...
		{
			func_313("Player out of range [TERMINATING]");
			func_295(&Var0, 1);
		}
	}
	if (Var0.f_0 == 6)
	...
	if (Var0.f_0 == 4)
	{
		func_258(&uLocal_59, 3, Var0.f_28[0], "BARRY", 0, 1);
	...
	while (true)
	{
		...
		if (!func_216(&Var0, Var0.f_0 != 2))
		{
			func_295(&Var0, 1);
		}
		func_215(Var0.f_0);
		func_208(&iLocal_53, &(Var0.f_9), Var1);
		if (func_207(Var0.f_28[0]))
		{
			if (Var0.f_0 == 2)
			{
				if (func_205(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
				{
			...
			{
				if (func_205(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f))
				{
				}
			}
			else if (Var0.f_0 == 4)
		...
		if (func_174(&Var0, iVar2))
		{
			if (func_173(Var0.f_0))
			{
				func_170(Var0.f_0, &iLocal_56);
			}
			if (!func_2(&Var0))
			{
				func_295(&Var0, 1);
...
int func_2(int iParam0)//Position - 0x34C
{
	...
	if (!func_169())
	{
		while (!func_160(*iParam0))
		{
			...
			{
				func_313("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			SYSTEM::WAIT(0);
		}
	...
	if (!func_115(iParam0))
	{
		func_313("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x398F
{
	int iVar0;
	var uVar1;
...
int func_50(var uParam0)//Position - 0x39CC
{
	int iVar0;
	int iVar1;
...
int func_51()//Position - 0x3A00
{
	return Global_1574918;
}

int func_52(int iParam0, int iParam1)//Position - 0x3A0C
{
	int iVar0;
	var uVar1;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3A38
{
	int iVar0;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F80
{
	int iVar0;
...
int func_55()//Position - 0x41C2
{
	func_56();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_56()//Position - 0x41DB
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x42D8
{
	return Global_43052 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x42E6
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x43D9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x4661
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x46FC
{
...
int func_62(int iParam0, int iParam1)//Position - 0x48C4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x5465
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x54A0
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x5714
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x5750
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5C9F
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5CE3
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x6462
{
	if (bParam2)
	{
...
int func_70(var uParam0)//Position - 0x64A9
{
...
bool func_71(int iParam0)//Position - 0x6504
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x6514
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x6575
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x68F0
{
	return Global_31959;
}

int func_75(int iParam0)//Position - 0x68FB
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x690B
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x69AD
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x70D2
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x712A
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x71D4
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
...
Vector3 func_81(struct<3> Param0, float fParam1)//Position - 0x7269
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_82(int iParam0)//Position - 0x72AD
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x7431
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x743F
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7F06
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7F88
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x7FE0
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x7FE9
{
	switch (iParam0)
	{
		case 1:
...
int func_89()//Position - 0x8255
{
	return func_90(PLAYER::PLAYER_ID());
}

int func_90(int iParam0)//Position - 0x8265
{
	return MISC::GET_BITS_IN_RANGE(Global_2689235[iParam0 /*453*/].f_318.f_3, 28, 31);
}

int func_91(int iParam0)//Position - 0x8282
{
	return func_72(iParam0, 0, 0);
}

int func_92(int iParam0)//Position - 0x8292
{
	switch (iParam0)
	{
		case -1:
...
bool func_93()//Position - 0x85A1
{
	return Global_100493.f_375 > 0;
}

var func_94()//Position - 0x85B2
{
	var uVar0;
...
void func_95(var uParam0, int iParam1)//Position - 0x85F8
{
	if (iParam1 <= 0)
	{
		return;
...
void func_96(var uParam0, int iParam1)//Position - 0x867E
{
...
void func_97(var uParam0, int iParam1)//Position - 0x86B1
{
	int iVar0;
	int iVar1;
...
int func_98(int iParam0, int iParam1)//Position - 0x8702
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_99(int iParam0)//Position - 0x87A4
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_100(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_100(bool bParam0, int iParam1, int iParam2)//Position - 0x87C6
{
	if (bParam0)
	{
		return iParam1;
...
int func_101(var uParam0)//Position - 0x87DD
{
	return uParam0 & 15;
}

void func_102(var uParam0, int iParam1)//Position - 0x87EA
{
...
void func_103(var uParam0, int iParam1)//Position - 0x8824
{
...
void func_104(var uParam0, int iParam1)//Position - 0x885F
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_105()//Position - 0x889B
{
	func_56();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_106(int iParam0)//Position - 0x88B4
{
	var uVar0;
	char cVar1[24];
...
bool func_107()//Position - 0x890D
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_108()//Position - 0x8923
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_109(char* sParam0, int iParam1, int iParam2)//Position - 0x8939
{
...
int func_110(bool bParam0)//Position - 0x897B
{
...
struct<2> func_111(int iParam0)//Position - 0x89A3
{
	struct<2> Var0;
...
void func_112(int iParam0, var uParam1)//Position - 0x8DF0
{
	switch (iParam0)
	{
		case 0:
...
int func_114(int iParam0)//Position - 0xA0C8
{
	switch (iParam0)
	{
		case 0:
...
int func_115(int iParam0)//Position - 0xA40E
{
	int iVar0;
	...
	if (func_144(&(iParam0->f_1)))
	{
		...
		func_116(*iParam0);
		iVar0 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&(iParam0->f_1), iParam0, 61, 51000);
		SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&(iParam0->f_1));
		if (CUTSCENE::HAS_CUTSCENE_LOADED())
		{
			func_313("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::SET_SCRIPT_CAN_START_CUTSCENE(iVar0);
		}
		else
		{
			func_313("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_116(int iParam0)//Position - 0xA4B3
{
	struct<2> Var0;
...
void func_117(int iParam0)//Position - 0xA54E
{
	if (iParam0 < 63)
	{
		func_118();
...
void func_119(int iParam0)//Position - 0xA5AC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_120(int iParam0)//Position - 0xA605
{
...
int func_121(int iParam0)//Position - 0xA688
{
	int iVar0;
...
void func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA6B9
{
	func_123(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_123(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA6CE
{
	int iVar0;
...
int func_125(int iParam0, int iParam1, int iParam2)//Position - 0xA781
{
...
int func_126(int iParam0, int iParam1, int iParam2)//Position - 0xA79C
{
	int iVar0;
...
int func_127(int iParam0)//Position - 0xA7E8
{
	int iVar0;
...
int func_128(int iParam0)//Position - 0xA831
{
	if (func_207(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_129(int iParam0)//Position - 0xA851
{
	switch (iParam0)
	{
		case 5:
...
int func_131(int iParam0)//Position - 0xA921
{
	switch (iParam0)
	{
		case 5:
...
void func_132(var uParam0, bool bParam1, bool bParam2)//Position - 0xA974
{
	int iVar0;
...
int func_133(int iParam0)//Position - 0xAA69
{
	switch (iParam0)
	{
		case 5:
...
void func_134(bool bParam0)//Position - 0xAAD4
{
	int iVar0;
...
void func_135(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAB13
{
	if (bParam0)
	{
...
bool func_136()//Position - 0xAC56
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_137(int iParam0, int iParam1)//Position - 0xAC70
{
	bool bVar0;
...
int func_138(int iParam0, bool bParam1)//Position - 0xACBB
{
	int iVar0;
	int iVar1;
...
int func_139(int iParam0)//Position - 0xACFC
{
...
bool func_140()//Position - 0xAD3B
{
	return BitTest(Global_2621446, 3);
}

int func_141(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xAD49
{
	int iVar0;
...
void func_143(int iParam0)//Position - 0xADA3
{
	if (iParam0 == 1)
	{
...
int func_144(char* sParam0)//Position - 0xADC6
{
	...
	func_313("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}

void func_145()//Position - 0xAE03
{
	Global_20471 = 0;
	func_146();
}

void func_146()//Position - 0xAE13
{
...
int func_150(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAEF9
{
...
void func_151(int iParam0)//Position - 0xB091
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_153(int iParam0)//Position - 0xB10E
{
	if (func_158())
	{
		return;
...
void func_154(int iParam0)//Position - 0xB141
{
	if (func_158())
	{
		return;
...
void func_155(bool bParam0, bool bParam1)//Position - 0xB1CB
{
	if (bParam0)
	{
		if (func_157(0))
...
bool func_156()//Position - 0xB23F
{
	return BitTest(Global_1958711, 5);
}

int func_157(int iParam0)//Position - 0xB24D
{
	if (iParam0 == 1)
	{
...
bool func_158()//Position - 0xB2A4
{
	return BitTest(Global_1958711, 19);
}

int func_159(int iParam0)//Position - 0xB2B3
{
...
int func_160(int iParam0)//Position - 0xB2F4
{
	int iVar0;
...
void func_161(int iParam0)//Position - 0xB339
{
...
int func_162(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB36B
{
	int iVar0;
...
void func_163(var uParam0, int iParam1)//Position - 0xB4A2
{
	int iVar0;
...
bool func_164(int iParam0)//Position - 0xB4F1
{
	return func_165(iParam0, Global_43052);
}

int func_165(int iParam0, int iParam1)//Position - 0xB502
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_166(int iParam0)//Position - 0xB6E3
{
	if (Global_43052 == 15)
	{
		return 0;
...
int func_167()//Position - 0xB705
{
	return func_168(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_168(char* sParam0, int iParam1)//Position - 0xB716
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_170(int iParam0, int iParam1)//Position - 0xB783
{
	switch (iParam0)
	{
		case 0:
...
int func_171(struct<3> Param0, bool bParam1)//Position - 0xBBF2
{
	int iVar0;
...
float func_172(bool bParam0, float fParam1, float fParam2)//Position - 0xBC1E
{
	if (bParam0)
	{
		return fParam1;
...
int func_173(int iParam0)//Position - 0xBC35
{
	switch (iParam0)
	{
		case 0:
...
int func_174(int iParam0, int iParam1)//Position - 0xBCC4
{
	switch (iParam0->f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], true), true) < 3f)
						{
							if (func_180(2))
							{
								if (func_178(iParam0->f_27))
								{
									...
									func_313("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				else if (func_207(iParam0->f_28[0]))
				{
					if (func_176(iParam0))
					{
						if (func_180(2))
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.88849f, 371.9034f, 103.98843f, 241.58984f, 359.64575f, 107.34612f, 1.25f, false, true, 0))
					{
						if (func_180(2))
						{
							...
							{
								func_177(iParam0->f_27, *iParam0);
								func_313("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*iParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.9482f, 4143.44f, 42.292946f, 2722.2134f, 4144.5215f, 45.431824f, 10f, false, true, 0))
				{
					if (func_180(2))
					{
						...
						{
							func_177(1, *iParam0);
							func_313("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.11035f, 68.460175f, -1028.5663f, 395.46133f, 94.57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.75565f, 68.02096f, -1021.4514f, 336.34583f, 93.18714f, 14.5f, false, true, 0))
						{
							if (func_180(2))
							{
								...
								{
									func_177(iParam0->f_27, *iParam0);
									func_313("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_175()//Position - 0xC4A8
{
	func_27(&(Global_103950.f_2890), &Global_103950, 0, 1, 1, 0);
}

int func_176(var uParam0)//Position - 0xC4C3
{
	float fVar0;
...
void func_177(int iParam0, int iParam1)//Position - 0xC551
{
	if (iParam0 == 1)
	{
		if (!func_131(iParam1))
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_313("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_313("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
int func_178(bool bParam0)//Position - 0xC5B5
{
	int iVar0;
...
int func_179(int iParam0)//Position - 0xC64C
{
	if (func_207(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_180(int iParam0)//Position - 0xC676
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_188()) || Global_112433) || Global_31962) || func_187()) || func_186(8, -1)) || func_93()) || func_185()) || func_184()) || func_183()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_188()) || Global_31962) || func_187()) || func_186(8, -1)) || func_184()) || func_93()) || func_185()) || func_183()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_188()) || Global_112433) || Global_31962) || func_187()) || func_186(8, -1)) || func_93()) || func_185()) || func_183()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_188() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_186(8, -1)) || func_183()) || func_182()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_188()) || func_185()) || Global_112433) || Global_31962) || func_187()) || Global_44238) || func_186(8, -1)) || func_184()) || func_182()) || func_183()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_181()//Position - 0xCD93
{
	return Global_100480.f_1;
}

int func_182()//Position - 0xCDA1
{
	if (Global_97363 != -1)
	{
...
bool func_185()//Position - 0xCE08
{
	return Global_100493.f_376 > 0;
}

bool func_186(int iParam0, int iParam1)//Position - 0xCE19
{
	switch (iParam0)
	{
		case 5:
...
var func_187()//Position - 0xCE51
{
	return Global_1575058;
}

int func_188()//Position - 0xCE5D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_190(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3)//Position - 0xCE9C
{
	switch (*uParam0)
	{
		...
		case 1:
			if (func_203(PLAYER::PLAYER_PED_ID(), Param1, 1) <= 20f)
			{
				if (func_191(&uLocal_59, cParam2, sParam3, 8, 0, 0, 0))
				{
					*uParam0 = 2;
				}
			}
		...
		case 2:
			...
			else if (func_203(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 25f)
			{
				func_145();
				*uParam0 = 0;
			}
...
bool func_191(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xCF39
{
...
int func_192(char* sParam0, int iParam1, bool bParam2)//Position - 0xCF87
{
	Global_21606 = 0;
...
bool func_195(int iParam0)//Position - 0xD2EF
{
	return func_196(iParam0, 20);
}

var func_196(int iParam0, int iParam1)//Position - 0xD2FF
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

void func_197()//Position - 0xD317
{
	int iVar0;
...
void func_202(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD571
{
...
float func_203(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xD5C7
{
	struct<3> Var0;
...
void func_204(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, int iParam10)//Position - 0xD601
{
	...
	iVar1 = 32768;
	if (!func_207(iParam0->f_28[iParam10]))
	{
		return;
	}
	if (bParam9)
...
int func_205(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xD69E
{
	var uVar0;
	
	if ((((func_207(PLAYER::PLAYER_PED_ID()) && func_207(iParam0->f_28[0])) && !func_147()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_203(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_258(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
...
void func_206(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD726
{
...
int func_207(int iParam0)//Position - 0xD761
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_208(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD782
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_209(int iParam0, bool bParam1)//Position - 0xD873
{
	if (iParam0 == -1)
	{
		return;
...
int func_210(int iParam0)//Position - 0xD8AF
{
	if (Global_78315 == iParam0)
	{
		if (Global_78316 == -1)
...
void func_211(int iParam0, int iParam1)//Position - 0xD8E8
{
	bool bVar0;
	int iVar1;
...
bool func_212()//Position - 0xD986
{
	return Global_97750;
}

void func_213(int iParam0)//Position - 0xD992
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_214(iParam0);
...
void func_214(int iParam0)//Position - 0xD9A9
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_215(int iParam0)//Position - 0xDA91
{
	if (iParam0 == -1)
	{
		iParam0 = func_167();
...
int func_216(int iParam0, bool bParam1)//Position - 0xDAB9
{
	struct<27> Var0;
	
	if (Global_78319)
	{
		func_313("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_112(*iParam0, &Var0);
	if ((func_253(*iParam0) || func_251(*iParam0)) || Global_78564 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_313("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_247(*iParam0))
	{
		if (*iParam0 == 19)
		{
			func_246(iParam0->f_28[0]);
		}
		func_313("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (iParam0->f_25 == 1)
	{
		if (!func_226(iParam0, 1, 0))
		{
			return 0;
		}
	}
	...
	if (*iParam0 == 10)
	{
		...
		{
			func_313("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_313("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
	if (func_220(&(iParam0->f_48)) && bParam1)
	{
		func_217(iParam0->f_28[0], &(iParam0->f_48), *iParam0);
	}
	return 1;
}

void func_217(int iParam0, var uParam1, int iParam2)//Position - 0xDD29
{
	int iVar0;
	int iVar1;
...
int func_218(int iParam0)//Position - 0xE081
{
...
int func_219(var uParam0)//Position - 0xE0A1
{
...
int func_220(var uParam0)//Position - 0xE0B9
{
...
void func_221(var uParam0)//Position - 0xE0DE
{
	int iVar0;
	int iVar1;
...
void func_222(int* iParam0)//Position - 0xE3E2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_223(var uParam0)//Position - 0xE40D
{
	int iVar0;
...
int func_224(var uParam0, bool bParam1, bool bParam2)//Position - 0xE48D
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_128(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				{
					func_313("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[iVar0], false))
				{
					func_313("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[iVar0], PLAYER::PLAYER_PED_ID(), false))
				{
					func_313("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[iVar0]) < 850)
				{
					func_313("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							func_313("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_179(iVar2))
						{
							if (ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck") || ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck2"))
							{
								if (func_179(uParam0->f_35[iVar0]))
								{
									...
									{
										func_313("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_179(iVar3))
						{
							...
							{
								func_313("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							...
							{
								func_313("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
...
int func_225(int iParam0, int iParam1)//Position - 0xE64B
{
	int iVar0;
...
int func_226(var uParam0, bool bParam1, int iParam2)//Position - 0xE67B
{
	int iVar0;
	int iVar1;
	...
	if (func_128(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[iVar0]))
						{
							...
							func_313("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[iVar0]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[iVar0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[iVar0]))
					{
						...
						func_313("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[iVar0], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
						{
							...
							func_313("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_245(*uParam0))
					{
						if (!func_159(*uParam0))
						{
							if (func_240(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								...
								func_313("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[iVar0], true), 15f))
						{
							...
							func_313("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_228(uParam0->f_28[iVar0], 1126825984))
						{
							...
							func_313("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_227(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_313("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_313("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_207(uParam0->f_41[0]))
						{
...
int func_227(int iParam0)//Position - 0xE937
{
...
int func_228(int iParam0, float fParam1)//Position - 0xE96B
{
	float fVar0;
...
bool func_229(int iParam0, float fParam1)//Position - 0xE9E1
{
	return func_230(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_230(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE9F9
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	
	iVar2 = func_238(iParam0, iParam1);
	if (!func_207(iParam0) || !func_207(iParam1))
	{
		if (iVar2 != -1)
		{
			func_237(&(Local_37[iVar2 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_231(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_231(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xEABA
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_232(int iParam0, int iParam1)//Position - 0xEBE6
{
	int iVar0;
...
int func_234(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xECF5
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	{
		Var1 = { func_236(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_235(Var1, Var0);
...
float func_235(struct<3> Param0, struct<3> Param1)//Position - 0xED86
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_236(struct<3> Param0)//Position - 0xEDA7
{
	float fVar0;
	float fVar1;
...
void func_237(var uParam0)//Position - 0xEDE6
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_238(int iParam0, int iParam1)//Position - 0xEE01
{
	int iVar0;
...
int func_239(int iParam0)//Position - 0xEE40
{
...
int func_240(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEE68
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_241(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEF63
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_242(int iParam0, float fParam1)//Position - 0xF06F
{
	var uVar0;
	struct<3> Var1;
...
int func_243(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xF104
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_244(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF192
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_245(int iParam0)//Position - 0xF1DA
{
...
void func_246(int iParam0)//Position - 0xF224
{
	int iVar0;
...
int func_247(int iParam0)//Position - 0xF2C1
{
	if (iParam0 == -1)
	{
		iParam0 = func_167();
...
int func_248(int iParam0)//Position - 0xF356
{
...
int func_251(int iParam0)//Position - 0xF3D5
{
	if ((func_252() && Global_100441.f_11 == 6) && iParam0 == func_168(&(Global_100441.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_253(int iParam0)//Position - 0xF447
{
	if (func_110(0))
	{
...
void func_254()//Position - 0xF46F
{
	...
	if (func_207(PLAYER::PLAYER_PED_ID()))
	{
		if (func_255(PLAYER::PLAYER_PED_ID(), Var0, fVar1, 1))
		{
			func_152();
		}
	}
...
bool func_255(int iParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0xF4B2
{
...
void func_258(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xF5D9
{
...
int func_260(int iParam0)//Position - 0xF6A2
{
	...
	func_313("Created initial scene");
	return 1;
}
...
int func_263(var uParam0)//Position - 0xF7DA
{
	uParam0->f_16 = 3;
...
int func_264(var uParam0)//Position - 0xF805
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			{
				func_266(&(uParam0->f_35[0]), iVar0[0], Var1, fVar5);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
			...
			{
				func_265(&(uParam0->f_41[0]), iVar0[1], Var1 + Var3, 0f);
			...
			{
				func_266(&(uParam0->f_35[1]), iVar0[2], Var2, fVar6);
...
void func_265(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xFA8B
{
	func_222(iParam0);
...
void func_266(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xFAB2
{
	func_267(iParam0);
...
void func_267(int* iParam0)//Position - 0xFAF4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_268(int iParam0)//Position - 0xFB90
{
	int iVar0;
...
int func_269(var uParam0)//Position - 0xFBC1
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			bVar7 = true;
			func_266(&(uParam0->f_35[0]), iVar0[0], Var1, fVar4);
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_35[0], 1);
				VEHICLE::SET_VEHICLE_ALARM(uParam0->f_35[0], false);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_265(&(uParam0->f_41[0]), iVar0[1], Var1 + Var2, 0f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_266(&(uParam0->f_35[1]), iVar0[2], Var3, fVar5);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				func_270(&(uParam0->f_28[0]), iVar0[3], Var3, fVar5, 6);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				func_270(&(uParam0->f_28[1]), iVar0[3], Var3, fVar5, 6);
			}
			if (bVar7)
			{
				iLocal_51 = 3;
...
void func_270(int* iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0xFF11
{
	func_271(iParam0);
	*iParam0 = PED::CREATE_PED(iParam4, iParam1, Param2, fParam3, false, false);
}

void func_271(int* iParam0)//Position - 0xFF32
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_272(var uParam0)//Position - 0xFF73
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_277(&(uParam0->f_48), "rcm_barry3", "bar_3_rcm_barry_standing_on_street_base", "bar_3_rcm_barry_standing_on_street_fidget");
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_268(&iVar0) || !func_276(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_273(&(uParam0->f_28[0]), 49, Var1, fVar2, "RC LAUNCHER: BARRY 3", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_265(&(uParam0->f_41[0]), iVar0[1], Var1 + Vector(0f, 0f, 5f), -115.18f);
				if (func_207(uParam0->f_41[0]) && func_207(uParam0->f_28[0]))
				{
...
int func_273(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0x1016C
{
	if (func_274(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_274(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0x101C8
{
	int iVar0;
...
int func_275(var uParam0, int iParam1)//Position - 0x10256
{
	int iVar0;
...
int func_276(var uParam0)//Position - 0x1029C
{
	if (func_220(uParam0))
	{
...
void func_277(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x102C6
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_278(var uParam0)//Position - 0x10302
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_277(&(uParam0->f_48), "rcm_barry2", "lead_in_loop", "lead_in_loop");
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_273(&(uParam0->f_28[0]), 49, Var1, fVar2, "RC LAUNCHER: BARRY 2", 1))
				{
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false);
				}
				else
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				func_265(&(uParam0->f_41[0]), iVar0[1], 189.5964f, -956.0344f, 29.09179f, func_280(-2.01f));
				if (func_207(uParam0->f_41[0]))
				{
					ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_41[0], true);
					func_265(&(uParam0->f_41[2]), iVar0[3], 189.79015f, -956.1675f, 29.8229f, func_280(-2.01f));
					if (func_207(uParam0->f_41[2]))
					{
			...
			{
				func_265(&(uParam0->f_41[1]), iVar0[2], 190.417f, -956.511f, 29.09179f, -99.157f);
				if (func_207(uParam0->f_41[1]))
				{
		...
		case 3:
			...
			func_279(&(uParam0->f_41[3]), iVar0[4]);
			iVar3 = 0;
			while (iVar3 <= (iVar0 - 1))
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iVar0[iVar3]);
...
void func_279(int* iParam0, int iParam1)//Position - 0x106A0
{
	struct<3> Var0;
	float fVar1;
	...
	fVar1 = 23.45f;
	func_265(iParam0, iParam1, Var0, fVar1);
}

float func_280(float fParam0)//Position - 0x106D0
{
...
int func_281(var uParam0)//Position - 0x106E0
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_277(&(uParam0->f_48), "RCMBarryLeadInOut", "idle", "fidget");
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_273(&(uParam0->f_28[0]), 49, Var1, fVar2, "RC LAUNCHER: BARRY 1", 1))
				{
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false);
				}
				else
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				func_265(&(uParam0->f_41[1]), iVar0[2], 190.2574f, -956.3513f, 29.09179f, func_280(-1.68f));
				if (func_207(uParam0->f_41[1]))
				{
					ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_41[1], true);
					ENTITY::SET_ENTITY_COLLISION(uParam0->f_41[1], false, false);
...
int func_282(int iParam0)//Position - 0x10B3E
{
	struct<27> Var0;
	bool bVar1;
...
int func_283(int iParam0)//Position - 0x10B8F
{
	...
	if (Global_78319)
	{
		func_313("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!Global_113386.f_9085 && !func_110(1))
	{
		func_313("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_284(iParam0))
	{
		Global_112473[iParam0 /*10*/].f_1 = 1;
		func_313("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_100441.f_11 == 6)
	{
		if (Global_100441 < 9)
		{
			...
			{
				func_313("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	...
	{
		Global_112473[iParam0 /*10*/].f_1 = 1;
		func_313("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}
...
bool func_286(int iParam0, char* sParam1)//Position - 0x10D8E
{
...
int func_287(int iParam0)//Position - 0x10E70
{
...
int func_288(int iParam0)//Position - 0x10E9B
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_289(int iParam0)//Position - 0x10EC6
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_290(int iParam0)//Position - 0x10EF1
{
	if (func_248(iParam0))
	{
		return 0;
...
void func_291()//Position - 0x10F26
{
	func_313("Running end routines.");
...
int func_292(int iParam0, struct<3> Param1, float fParam2)//Position - 0x10F40
{
	...
	if (func_105() == 0)
	{
		if (func_293(2, Param1, fParam2, iParam0))
		{
			return 1;
		}
	}
	...
	{
		if (func_293(3, Param1, fParam2, iParam0))
		{
			return 1;
		}
	}
	...
	while (iVar1 < iVar0)
	{
		if (func_293(iVar0[iVar1], Param1, fParam2, iParam0))
		{
			iVar1 = iVar0;
			return 1;
		}
...
int func_293(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0x10FD1
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_294(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_294(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x11049
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_295(int iParam0, bool bParam1)//Position - 0x110C4
{
	...
	if (bParam1)
	{
		func_313("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_257(iParam0);
	...
	if (iLocal_53 != -1)
	{
		func_313("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_214(&iLocal_53);
	}
	if (*iParam0 == 6)
	{
...
void func_296(char* sParam0)//Position - 0x11159
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_299(sParam0))
...
void func_297()//Position - 0x11178
{
	Global_20471 = 0;
	func_298();
}

void func_298()//Position - 0x11188
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22616 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_299(char* sParam0)//Position - 0x111A9
{
	struct<6> Var0;
...
struct<6> func_300()//Position - 0x111C9
{
	struct<6> Var0;
...
int func_301(var uParam0)//Position - 0x111ED
{
	if (func_220(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_302(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x11223
{
...
void func_303(var uParam0, bool bParam1)//Position - 0x11243
{
	func_304(&(uParam0->f_41), bParam1);
}

void func_304(var uParam0, bool bParam1)//Position - 0x11255
{
	int iVar0;
...
void func_305(int* iParam0, bool bParam1)//Position - 0x11293
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_306(var uParam0, bool bParam1)//Position - 0x112CE
{
	func_307(&(uParam0->f_35), bParam1);
}

void func_307(var uParam0, bool bParam1)//Position - 0x112E0
{
	int iVar0;
...
void func_308(int* iParam0)//Position - 0x1131D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_309(var uParam0, int iParam1)//Position - 0x11355
{
	func_310(&(uParam0->f_28), iParam1);
}

void func_310(var uParam0, int iParam1)//Position - 0x11367
{
	int iVar0;
...
void func_311(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x113A8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_312(var uParam0)//Position - 0x113F8
{
	if (*uParam0 == -1)
	{
		return;
...
void func_313(char* sParam0)//Position - 0x11435
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_314(var uParam0)//Position - 0x11447
{
	*uParam0 = -1;
...
void func_315()//Position - 0x1147A
{
	func_313("Running start routines.");
	Global_113104++;
}

int func_316(int iParam0)//Position - 0x11494
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
