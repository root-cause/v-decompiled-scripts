...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112897[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_320(&(Global_112897[Var0.f_0 /*10*/].f_9));
			}
		}
		func_303(&Var0, 1);
	}
	if (!func_300(&Var0, Var61, 1f))
	{
		func_299();
	...
	if (Var0.f_0 == 4)
	{
		func_266(&uLocal_104, 3, Var0.f_28[0], "BARRY", 0, 1);
	...
	while (true)
	{
		...
		if (!func_224(&Var0, Var0.f_0 != 2))
		{
			func_303(&Var0, 1);
		}
		func_223(Var0.f_0);
		func_216(&iLocal_91, &(Var0.f_9), Var61);
		if (func_215(Var0.f_28[0]))
		{
			if (Var0.f_0 == 2)
			{
				if (func_213(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
				{
					func_212(&Var0, Local_95, 1, 0);
				}
			}
			else if (Var0.f_0 == 3)
			{
				if (func_213(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f))
				{
				}
			}
			else if (Var0.f_0 == 4)
			{
				func_198(&uLocal_103, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar64 = 0;
		if (func_197(Var0.f_0))
		{
		...
		if (func_182(&Var0, iVar64))
		{
			if (func_181(Var0.f_0))
			{
				func_178(Var0.f_0, &iLocal_94);
			}
			if (!func_2(&Var0))
			{
				func_303(&Var0, 1);
...
int func_64(int iParam0, int iParam1)//Position - 0x48F2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x55A3
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x55DE
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x5852
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x588E
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5DDD
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5E21
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x65A0
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x65E7
{
...
bool func_73(int iParam0)//Position - 0x6642
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x6652
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x66B2
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x6A5A
{
	return Global_32283;
}

int func_77(int iParam0)//Position - 0x6A65
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A75
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6B17
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x7282
{
...
int func_81()//Position - 0x757D
{
	return Global_2652364.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x758C
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x75B6
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x75CB
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x75E2
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x763A
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x76E4
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x7779
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x77BD
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x7941
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x794F
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x8417
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x8499
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x84F1
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x84FA
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x8766
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x8776
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x8793
{
	return func_74(iParam0, 0, 0);
}

int func_99(int iParam0)//Position - 0x87A3
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x8AD9
{
	return Global_100885.f_393 > 0;
}

var func_101()//Position - 0x8AEA
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8B30
{
	if (iParam1 <= 0)
	{
		return;
...
void func_103(var uParam0, int iParam1)//Position - 0x8BB6
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8BE9
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8C3A
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8CDC
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8CFE
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8D15
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8D22
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8D5C
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8D97
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8DD3
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8DEC
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8E45
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8E5B
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8E71
{
...
int func_117(bool bParam0)//Position - 0x8EB3
{
...
struct<2> func_118(int iParam0)//Position - 0x8EDB
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x9328
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA600
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0)//Position - 0xA946
{
	int iVar0;
...
void func_123(int iParam0)//Position - 0xA9EB
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xAA86
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xAAE4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xAB3D
{
...
int func_128(int iParam0)//Position - 0xABC0
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xABF1
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAC06
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xACB9
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xACD4
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xAD20
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xAD69
{
	if (func_215(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xAD89
{
	switch (iParam0)
	{
		case 5:
...
int func_138(int iParam0)//Position - 0xAE59
{
	switch (iParam0)
	{
		case 5:
...
void func_139(var uParam0, bool bParam1, bool bParam2)//Position - 0xAEAC
{
	int iVar0;
...
int func_140(int iParam0)//Position - 0xAFA1
{
	switch (iParam0)
	{
		case 5:
...
void func_141(bool bParam0)//Position - 0xB00C
{
	int iVar0;
...
void func_142(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB04B
{
	if (bParam0)
	{
...
bool func_143()//Position - 0xB198
{
	return BitTest(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_36.f_18, 14);
}

bool func_144(int iParam0, int iParam1)//Position - 0xB1B2
{
	bool bVar0;
...
int func_145(int iParam0, bool bParam1)//Position - 0xB20B
{
	int iVar0;
	int iVar1;
...
int func_146(var uParam0)//Position - 0xB24C
{
	int iVar0;
...
int func_147(int iParam0)//Position - 0xB26E
{
...
bool func_148()//Position - 0xB2AD
{
	return BitTest(Global_2621446, 3);
}

int func_149(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB2BB
{
	int iVar0;
...
void func_151(int iParam0)//Position - 0xB315
{
	if (iParam0 == 1)
	{
...
int func_152(char* sParam0)//Position - 0xB338
{
...
void func_153()//Position - 0xB375
{
	Global_20711 = 0;
	func_154();
}

void func_154()//Position - 0xB385
{
...
int func_158(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB46B
{
...
void func_159(int iParam0)//Position - 0xB603
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_161(int iParam0)//Position - 0xB680
{
	if (func_166())
	{
		return;
...
void func_162(int iParam0)//Position - 0xB6B3
{
	if (func_166())
	{
		return;
...
void func_163(bool bParam0, bool bParam1)//Position - 0xB73D
{
	if (bParam0)
	{
		if (func_165(0))
...
bool func_164()//Position - 0xB7B1
{
	return BitTest(Global_1963795, 5);
}

int func_165(int iParam0)//Position - 0xB7BF
{
	if (iParam0 == 1)
	{
...
bool func_166()//Position - 0xB816
{
	return BitTest(Global_1963795, 19);
}

int func_167(int iParam0)//Position - 0xB825
{
...
int func_168(int iParam0)//Position - 0xB866
{
	int iVar0;
...
void func_169(int iParam0)//Position - 0xB8AB
{
...
int func_170(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB8DD
{
	int iVar0;
...
void func_171(var uParam0, int iParam1)//Position - 0xBA14
{
	int iVar0;
...
bool func_172(int iParam0)//Position - 0xBA63
{
	return func_173(iParam0, Global_43377);
}

int func_173(int iParam0, int iParam1)//Position - 0xBA74
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_174(int iParam0)//Position - 0xBC55
{
	if (Global_43377 == 15)
	{
		return 0;
...
int func_175()//Position - 0xBC77
{
	return func_176(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_176(char* sParam0, int iParam1)//Position - 0xBC88
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_178(int iParam0, int iParam1)//Position - 0xBCF5
{
	switch (iParam0)
	{
		case 0:
...
int func_179(struct<3> Param0, bool bParam3)//Position - 0xC164
{
	int iVar0;
...
float func_180(bool bParam0, float fParam1, float fParam2)//Position - 0xC190
{
	if (bParam0)
	{
		return fParam1;
...
int func_181(int iParam0)//Position - 0xC1A7
{
	switch (iParam0)
	{
		case 0:
...
int func_182(int iParam0, int iParam1)//Position - 0xC236
{
	switch (iParam0->f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.6306f, 4699.115f, 35.38089f, 1812.8776f, 4710.457f, 42.053535f, 23.75f, false, true, 0))
				{
					if (func_215(iParam0->f_28[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], true), true) < 3f)
						{
							if (func_188(2))
							{
								if (func_186(iParam0->f_27))
								{
									func_185(iParam0->f_27, *iParam0);
				...
				else if (func_215(iParam0->f_28[0]))
				{
					if (func_184(iParam0))
					{
						if (func_188(2))
...
void func_183()//Position - 0xCA19
{
	func_27(&(Global_104373.f_2890), &Global_104373, 0, 1, 1, 0);
}

int func_184(var uParam0)//Position - 0xCA34
{
	float fVar0;
...
void func_185(int iParam0, int iParam1)//Position - 0xCAC2
{
	if (iParam0 == 1)
	{
		if (!func_138(iParam1))
...
int func_186(bool bParam0)//Position - 0xCB26
{
	int iVar0;
...
int func_187(int iParam0)//Position - 0xCBBD
{
	if (func_215(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_188(int iParam0)//Position - 0xCBE7
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_196()) || Global_112857) || Global_32286) || func_195()) || func_194(8, -1)) || func_100()) || func_193()) || func_192()) || func_191()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_196()) || Global_32286) || func_195()) || func_194(8, -1)) || func_192()) || func_100()) || func_193()) || func_191()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_196()) || Global_112857) || Global_32286) || func_195()) || func_194(8, -1)) || func_192()) || func_100()) || func_193()) || func_191()) || Global_113810.f_7691.f_919[bVar0] == 5) || Global_43924 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_196()) || Global_112857) || Global_32286) || func_195()) || func_194(8, -1)) || func_100()) || func_193()) || func_191()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_196() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_194(8, -1)) || func_191()) || func_190()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_194(8, -1) || func_100()) || func_193()) || func_190()) || func_189())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_196()) || Global_32286) || func_195()) || func_194(8, -1)) || func_193()) || func_192()) || func_191()) || Global_113810.f_7691.f_919[bVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_196()) || func_193()) || Global_112857) || Global_32286) || func_195()) || Global_44569) || func_194(8, -1)) || func_192()) || func_190()) || func_191()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_196()) || Global_112857) || Global_32286) || func_195()) || func_194(8, -1)) || func_192()) || func_190()) || func_100()) || func_193()) || func_191())
						{
							return 0;
						}
						break;
...
var func_189()//Position - 0xD304
{
	return Global_100872.f_1;
}

int func_190()//Position - 0xD312
{
	if (Global_97735 != -1)
	{
...
bool func_193()//Position - 0xD379
{
	return Global_100885.f_394 > 0;
}

bool func_194(int iParam0, int iParam1)//Position - 0xD38A
{
	switch (iParam0)
	{
		case 5:
...
var func_195()//Position - 0xD3C2
{
	return Global_1575063;
}

int func_196()//Position - 0xD3CE
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_197(int iParam0)//Position - 0xD3EA
{
	switch (iParam0)
	{
		case 5:
...
void func_198(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5)//Position - 0xD40D
{
	switch (*uParam0)
	{
		case 0:
		...
		case 1:
			if (func_211(PLAYER::PLAYER_PED_ID(), Param1, 1) <= 20f)
			{
				if (func_199(&uLocal_104, cParam4, sParam5, 8, 0, 0, 0))
				{
					*uParam0 = 2;
				}
			}
		...
		case 2:
			...
			else if (func_211(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 25f)
			{
				func_153();
				*uParam0 = 0;
			}
...
bool func_199(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD4AA
{
...
int func_200(char* sParam0, int iParam1, bool bParam2)//Position - 0xD4F8
{
	Global_21846 = 0;
...
bool func_203(int iParam0)//Position - 0xD860
{
	return func_204(iParam0, 20);
}

var func_204(int iParam0, int iParam1)//Position - 0xD870
{
	return BitTest(Global_1895156[iParam0 /*609*/].f_10.f_4, iParam1);
}

void func_205()//Position - 0xD888
{
	int iVar0;
...
void func_210(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDAE2
{
...
float func_211(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xDB38
{
	struct<3> Var0;
...
void func_212(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, int iParam10)//Position - 0xDB72
{
	int iVar0;
	int iVar1;
	
	iVar1 = 32768;
	if (!func_215(iParam0->f_28[iParam10]))
	{
		return;
	}
	if (bParam9)
...
int func_213(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xDC0F
{
	var uVar0;
	
	if ((((func_215(PLAYER::PLAYER_PED_ID()) && func_215(iParam0->f_28[0])) && !func_155()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_211(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_266(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
		func_214(&uVar0, cParam4, sParam5, 7, 0, 0);
...
void func_214(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDC97
{
...
int func_215(int iParam0)//Position - 0xDCD2
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_216(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xDCF3
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_211(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_219(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_211(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_221(iParam0);
				}
			}
...
void func_217(int iParam0, bool bParam1)//Position - 0xDDE4
{
	if (iParam0 == -1)
	{
		return;
...
int func_218(int iParam0)//Position - 0xDE20
{
	if (Global_78685 == iParam0)
	{
		if (Global_78686 == -1)
...
void func_219(int iParam0, int iParam1)//Position - 0xDE59
{
	bool bVar0;
	int iVar1;
...
bool func_220()//Position - 0xDEF7
{
	return Global_98122;
}

void func_221(int iParam0)//Position - 0xDF03
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_222(iParam0);
...
void func_222(int iParam0)//Position - 0xDF1A
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_223(int iParam0)//Position - 0xE002
{
	if (iParam0 == -1)
	{
		iParam0 = func_175();
...
int func_224(int iParam0, bool bParam1)//Position - 0xE02A
{
	struct<27> Var0;
...
void func_225(int iParam0, var uParam1, int iParam2)//Position - 0xE29A
{
	int iVar0;
	int iVar1;
...
int func_226(int iParam0)//Position - 0xE5F2
{
...
int func_227(var uParam0)//Position - 0xE612
{
...
int func_228(var uParam0)//Position - 0xE62A
{
...
void func_229(var uParam0)//Position - 0xE64F
{
	int iVar0;
	int iVar1;
...
void func_230(int* iParam0)//Position - 0xE953
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_231(var uParam0)//Position - 0xE97E
{
	int iVar0;
...
int func_232(var uParam0, bool bParam1, bool bParam2)//Position - 0xE9FE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_233(int iParam0, int iParam1)//Position - 0xEBBC
{
	int iVar0;
...
int func_234(var uParam0, bool bParam1, int iParam2)//Position - 0xEBEC
{
	int iVar0;
	int iVar1;
...
int func_235(int iParam0)//Position - 0xEEA8
{
...
int func_236(int iParam0, float fParam1)//Position - 0xEEDC
{
	float fVar0;
...
bool func_237(int iParam0, float fParam1)//Position - 0xEF52
{
	return func_238(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_238(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEF6A
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_239(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xF02B
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_240(int iParam0, int iParam1)//Position - 0xF157
{
	int iVar0;
...
int func_242(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xF266
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_243(struct<3> Param0, struct<3> Param3)//Position - 0xF2F7
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_244(struct<3> Param0)//Position - 0xF318
{
	float fVar0;
	float fVar1;
...
void func_245(var uParam0)//Position - 0xF357
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_246(int iParam0, int iParam1)//Position - 0xF372
{
	int iVar0;
...
int func_247(int iParam0)//Position - 0xF3B1
{
...
int func_248(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF3D9
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_249(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF4D4
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_250(int iParam0, float fParam1)//Position - 0xF5E0
{
	var uVar0;
	struct<3> Var1;
...
int func_251(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF675
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_252(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF703
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_253(int iParam0)//Position - 0xF74B
{
...
void func_254(int iParam0)//Position - 0xF795
{
	int iVar0;
...
int func_255(int iParam0)//Position - 0xF832
{
	if (iParam0 == -1)
	{
		iParam0 = func_175();
...
int func_256(int iParam0)//Position - 0xF8C7
{
...
int func_259(int iParam0)//Position - 0xF946
{
	if ((func_260() && Global_100833.f_11 == 6) && iParam0 == func_176(&(Global_100833.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_261(int iParam0)//Position - 0xF9B8
{
	if (func_117(0))
	{
...
void func_262()//Position - 0xF9E0
{
	...
	if (func_215(PLAYER::PLAYER_PED_ID()))
	{
		if (func_263(PLAYER::PLAYER_PED_ID(), Var0, fVar3, 1))
		{
			func_160();
		}
	}
...
bool func_263(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0xFA23
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

void func_264(int iParam0)//Position - 0xFA41
{
	if (func_215(iParam0->f_28[0]))
	{
...
void func_265(var uParam0)//Position - 0xFAB0
{
	int iVar0;
...
void func_266(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xFB4A
{
...
int func_268(int iParam0)//Position - 0xFC13
{
	...
	{
		func_270(&Local_95);
		func_269(&Local_95, "democ_only_works");
		func_269(&Local_95, "gift_from_god");
		func_269(&Local_95, "rigged_vote");
		func_269(&Local_95, "suck_my");
		func_269(&Local_95, "tyranny");
	}
	func_321("Created initial scene");
	return 1;
}

void func_269(var uParam0, char* sParam1)//Position - 0xFCF5
{
...
void func_270(var uParam0)//Position - 0xFD1E
{
	int iVar0;
...
int func_271(var uParam0)//Position - 0xFD4B
{
	uParam0->f_16 = 3;
...
int func_272(var uParam0)//Position - 0xFD76
{
	int iVar0[3];
	struct<3> Var4;
	struct<3> Var7;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_274(&(uParam0->f_35[0]), iVar0[0], Var4, fVar16);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
			...
			{
				func_273(&(uParam0->f_41[0]), iVar0[1], Var4 + Var10, 0f);
			...
			{
				func_274(&(uParam0->f_35[1]), iVar0[2], Var7, fVar17);
...
void func_273(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFFFC
{
	func_230(iParam0);
...
void func_274(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10027
{
	func_275(iParam0);
...
void func_275(int* iParam0)//Position - 0x10069
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_276(int iParam0)//Position - 0x10105
{
	int iVar0;
...
int func_277(var uParam0)//Position - 0x10136
{
	int iVar0[4];
	struct<3> Var5;
	struct<3> Var8;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			bVar17 = true;
			func_274(&(uParam0->f_35[0]), iVar0[0], Var5, fVar14);
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_35[0], 1);
				VEHICLE::SET_VEHICLE_ALARM(uParam0->f_35[0], false);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_273(&(uParam0->f_41[0]), iVar0[1], Var5 + Var8, 0f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_274(&(uParam0->f_35[1]), iVar0[2], Var11, fVar15);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				func_278(&(uParam0->f_28[0]), iVar0[3], Var11, fVar15, 6);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				func_278(&(uParam0->f_28[1]), iVar0[3], Var11, fVar15, 6);
			}
			if (bVar17)
			{
				iLocal_89 = 3;
...
void func_278(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x10486
{
	func_279(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_279(int* iParam0)//Position - 0x104A7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_280(var uParam0)//Position - 0x104E8
{
	int iVar0[2];
	struct<3> Var3;
	float fVar6;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_285(&(uParam0->f_48), "rcm_barry3", "bar_3_rcm_barry_standing_on_street_base", "bar_3_rcm_barry_standing_on_street_fidget");
			iLocal_89 = 1;
			break;
		
		case 1:
			if (!func_276(&iVar0) || !func_284(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_281(&(uParam0->f_28[0]), 49, Var3, fVar6, "RC LAUNCHER: BARRY 3", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_273(&(uParam0->f_41[0]), iVar0[1], Var3 + Vector(0f, 0f, 5f), -115.18f);
				if (func_215(uParam0->f_41[0]) && func_215(uParam0->f_28[0]))
				{
...
int func_281(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x106E0
{
	if (func_282(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_282(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x1073C
{
	int iVar0;
...
int func_283(var uParam0, int iParam1)//Position - 0x107CA
{
	int iVar0;
...
int func_284(var uParam0)//Position - 0x10810
{
	if (func_228(uParam0))
	{
...
void func_285(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x1083A
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_286(var uParam0)//Position - 0x10876
{
	int iVar0[5];
	struct<3> Var6;
	float fVar9;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_285(&(uParam0->f_48), "rcm_barry2", "lead_in_loop", "lead_in_loop");
			iLocal_89 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_281(&(uParam0->f_28[0]), 49, Var6, fVar9, "RC LAUNCHER: BARRY 2", 1))
				{
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				}
				else
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				func_273(&(uParam0->f_41[0]), iVar0[1], 189.5964f, -956.0344f, 29.09179f, func_288(-2.01f));
				if (func_215(uParam0->f_41[0]))
				{
					ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_41[0], true);
					func_273(&(uParam0->f_41[2]), iVar0[3], 189.79015f, -956.1675f, 29.8229f, func_288(-2.01f));
					if (func_215(uParam0->f_41[2]))
					{
			...
			{
				func_273(&(uParam0->f_41[1]), iVar0[2], 190.417f, -956.511f, 29.09179f, -99.157f);
				if (func_215(uParam0->f_41[1]))
				{
		...
		case 3:
			...
			func_287(&(uParam0->f_41[3]), iVar0[4]);
			iVar10 = 0;
			while (iVar10 <= (iVar0 - 1))
			{
...
void func_287(int* iParam0, int iParam1)//Position - 0x10C15
{
	struct<3> Var0;
	float fVar3;
	...
	fVar3 = 23.45f;
	func_273(iParam0, iParam1, Var0, fVar3);
}

float func_288(float fParam0)//Position - 0x10C45
{
	return (fParam0 * 57.29578f);
}

int func_289(var uParam0)//Position - 0x10C55
{
	int iVar0[7];
	struct<3> Var8;
	float fVar11;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_285(&(uParam0->f_48), "RCMBarryLeadInOut", "idle", "fidget");
			iLocal_89 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_281(&(uParam0->f_28[0]), 49, Var8, fVar11, "RC LAUNCHER: BARRY 1", 1))
				{
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				}
				else
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				func_273(&(uParam0->f_41[1]), iVar0[2], 190.2574f, -956.3513f, 29.09179f, func_288(-1.68f));
				if (func_215(uParam0->f_41[1]))
				{
					ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_41[1], true);
					ENTITY::SET_ENTITY_COLLISION(uParam0->f_41[1], false, false);
...
int func_290(int iParam0)//Position - 0x110B4
{
	struct<27> Var0;
	bool bVar32;
...
int func_291(int iParam0)//Position - 0x11105
{
	char* sVar0;
...
int func_292(int iParam0)//Position - 0x111BE
{
	var uVar0;
...
int func_293(int iParam0)//Position - 0x1127F
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_294(int iParam0, char* sParam1)//Position - 0x11304
{
...
int func_295(int iParam0)//Position - 0x113E6
{
...
int func_296(int iParam0)//Position - 0x11411
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_297(int iParam0)//Position - 0x1143C
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_298(int iParam0)//Position - 0x11467
{
	if (func_256(iParam0))
	{
		return 0;
...
void func_299()//Position - 0x1149C
{
	func_321("Running end routines.");
	Global_113528 = (Global_113528 - 1);
}

int func_300(int iParam0, struct<3> Param1, float fParam4)//Position - 0x114B6
{
	int iVar0[4];
	int iVar5;
	...
	if (func_112() == 0)
	{
		if (func_301(2, Param1, fParam4, iParam0))
		{
			return 1;
		}
	}
	...
	{
		if (func_301(3, Param1, fParam4, iParam0))
		{
			return 1;
		}
	}
	...
	while (iVar5 < iVar0)
	{
		if (func_301(iVar0[iVar5], Param1, fParam4, iParam0))
		{
			iVar5 = iVar0;
			return 1;
		}
...
int func_301(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x11547
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_302(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_302(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x115BF
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_303(int iParam0, bool bParam1)//Position - 0x1163A
{
	char* sVar0;
...
void func_304(char* sParam0)//Position - 0x116CF
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_307(sParam0))
...
void func_305()//Position - 0x116EE
{
	Global_20711 = 0;
	func_306();
}

void func_306()//Position - 0x116FE
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22856 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_307(char* sParam0)//Position - 0x1171F
{
	struct<6> Var0;
...
struct<6> func_308()//Position - 0x1173F
{
	struct<6> Var0;
...
int func_309(var uParam0)//Position - 0x11763
{
	if (func_228(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_310(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x11799
{
	func_317(uParam0, iParam1);
	func_314(uParam0, bParam2);
	func_311(uParam0, bParam3);
}

void func_311(var uParam0, bool bParam1)//Position - 0x117B9
{
	func_312(&(uParam0->f_41), bParam1);
}

void func_312(var uParam0, bool bParam1)//Position - 0x117CB
{
	int iVar0;
...
void func_313(int* iParam0, bool bParam1)//Position - 0x11809
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_314(var uParam0, bool bParam1)//Position - 0x11844
{
	func_315(&(uParam0->f_35), bParam1);
}

void func_315(var uParam0, bool bParam1)//Position - 0x11856
{
	int iVar0;
...
void func_316(int* iParam0)//Position - 0x11893
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_317(var uParam0, int iParam1)//Position - 0x118CB
{
	func_318(&(uParam0->f_28), iParam1);
}

void func_318(var uParam0, int iParam1)//Position - 0x118DD
{
	int iVar0;
...
void func_319(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1191E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_320(var uParam0)//Position - 0x1196E
{
	if (*uParam0 == -1)
	{
		return;
...
void func_321(char* sParam0)//Position - 0x119AB
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_322(var uParam0)//Position - 0x119BD
{
	*uParam0 = -1;
...
void func_323()//Position - 0x119F0
{
	func_321("Running start routines.");
	Global_113528++;
}

int func_324(int iParam0)//Position - 0x11A0A
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
