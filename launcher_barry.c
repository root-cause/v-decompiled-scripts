...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113222[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_322(&(Global_113222[Var0.f_0 /*10*/].f_9));
			}
		}
		func_305(&Var0, 1);
	}
	if (!func_302(&Var0, Var61, 1f))
	{
		func_301();
	...
	if (Var0.f_0 == 4)
	{
		func_268(&uLocal_104, 3, Var0.f_28[0], "BARRY", 0, 1);
	...
	while (true)
	{
		...
		func_225(Var0.f_0);
		func_218(&iLocal_91, &(Var0.f_9), Var61);
		if (func_217(Var0.f_28[0]))
		{
			if (Var0.f_0 == 2)
			{
				if (func_215(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
				{
					func_214(&Var0, Local_95, 1, 0);
				}
			}
			else if (Var0.f_0 == 3)
			{
				if (func_215(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f))
				{
				}
			}
			else if (Var0.f_0 == 4)
			{
				func_200(&uLocal_103, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar64 = 0;
		...
		if (func_184(&Var0, iVar64))
		{
			if (func_183(Var0.f_0))
			{
				func_180(Var0.f_0, &iLocal_94);
			}
			if (!func_2(&Var0))
			{
				func_305(&Var0, 1);
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5EC5
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6688
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x66CF
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x673A
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6B5C
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6B6C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_84(struct<3> Param0)//Position - 0x76D4
{
...
int func_86(int iParam0)//Position - 0x7700
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7802
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x7897
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_93(int iParam0, var uParam1)//Position - 0x8539
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0)//Position - 0x85BB
{
	if (iParam0 != func_95())
	{
...
int func_99(int iParam0)//Position - 0x88D0
{
...
var func_107(int iParam0)//Position - 0x8E26
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8E48
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8E5F
{
	return uParam0 & 15;
}
...
void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x8FC5
{
...
int func_118(bool bParam0)//Position - 0x9007
{
...
int func_123(int iParam0)//Position - 0xAA9A
{
	int iVar0;
	...
	if (func_153(&(iParam0->f_1)))
	{
		...
		func_124(*iParam0);
		iVar0 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&(iParam0->f_1), iParam0, 61, 63500);
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAE0D
{
...
int func_136(int iParam0)//Position - 0xAEBD
{
	if (func_217(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xAEDD
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xAFAD
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xB000
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xB0F6
{
	switch (iParam0)
	{
		case 5:
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB1A0
{
	if (bParam0)
	{
...
int func_147(var uParam0)//Position - 0xB3A3
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB3C5
{
...
int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB412
{
	int iVar0;
...
int func_153(char* sParam0)//Position - 0xB48F
{
...
int func_159(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB5C2
{
...
void func_160(int iParam0)//Position - 0xB619
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_167(int iParam0)//Position - 0xB926
{
	if (iParam0 == 1)
	{
...
int func_169(int iParam0)//Position - 0xB98C
{
...
int func_170(int iParam0)//Position - 0xB9CD
{
	int iVar0;
	...
	iVar0 = func_172(&(Global_113222[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
int func_172(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xBA44
{
	int iVar0;
...
void func_173(var uParam0, int iParam1)//Position - 0xBB7B
{
	int iVar0;
...
bool func_174(int iParam0)//Position - 0xBBCA
{
	return func_175(iParam0, Global_44181);
}

int func_175(int iParam0, int iParam1)//Position - 0xBBDB
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_176(int iParam0)//Position - 0xBDBC
{
	if (Global_44181 == 15)
	{
		return 0;
...
int func_178(char* sParam0, int iParam1)//Position - 0xBDEF
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_180(int iParam0, int iParam1)//Position - 0xBE5C
{
	switch (iParam0)
	{
		case 0:
...
int func_181(struct<3> Param0, bool bParam3)//Position - 0xC2CC
{
	int iVar0;
...
float func_182(bool bParam0, float fParam1, float fParam2)//Position - 0xC2F8
{
	if (bParam0)
	{
		return fParam1;
...
int func_183(int iParam0)//Position - 0xC30F
{
	switch (iParam0)
	{
		case 0:
...
int func_184(int iParam0, int iParam1)//Position - 0xC39E
{
	switch (iParam0->f_16)
	{
		case 0:
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_217(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
					{
...
int func_186(var uParam0)//Position - 0xCB9C
{
	float fVar0;
...
void func_187(int iParam0, int iParam1)//Position - 0xCC2A
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_188(bool bParam0)//Position - 0xCC8E
{
	int iVar0;
...
int func_189(int iParam0)//Position - 0xCD25
{
	if (func_217(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_190(int iParam0)//Position - 0xCD4F
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_198()) || Global_113182) || Global_33090) || func_197()) || func_196(8, -1)) || func_101()) || func_195()) || func_194()) || func_193()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_198()) || Global_33090) || func_197()) || func_196(8, -1)) || func_194()) || func_101()) || func_195()) || func_193()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_198()) || Global_113182) || Global_33090) || func_197()) || func_196(8, -1)) || func_194()) || func_101()) || func_195()) || func_193()) || Global_114135.f_7692.f_919[bVar0] == 5) || Global_44728 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_198()) || Global_113182) || Global_33090) || func_197()) || func_196(8, -1)) || func_101()) || func_195()) || func_193()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_198() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_196(8, -1)) || func_193()) || func_192()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_198()) || Global_33090) || func_197()) || func_196(8, -1)) || func_195()) || func_194()) || func_193()) || Global_114135.f_7692.f_919[bVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_198()) || func_195()) || Global_113182) || Global_33090) || func_197()) || Global_45392) || func_196(8, -1)) || func_194()) || func_192()) || func_193()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_191()//Position - 0xD46C
{
	return Global_101727.f_1;
}

int func_192()//Position - 0xD47A
{
	if (Global_98585 != -1)
	{
...
var func_197()//Position - 0xD52A
{
	return Global_1575084;
}

int func_198()//Position - 0xD536
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_199(int iParam0)//Position - 0xD552
{
	switch (iParam0)
	{
		case 5:
...
void func_200(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5)//Position - 0xD575
{
	switch (*uParam0)
	{
		case 0:
		...
		case 1:
			if (func_213(PLAYER::PLAYER_PED_ID(), Param1, 1) <= 20f)
			{
				if (func_201(&uLocal_104, cParam4, sParam5, 8, 0, 0, 0))
				{
					*uParam0 = 2;
				}
			}
		...
		case 2:
			...
			else if (func_213(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 25f)
			{
				func_154();
				*uParam0 = 0;
			}
...
bool func_201(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD612
{
...
int func_202(char* sParam0, int iParam1, bool bParam2)//Position - 0xD660
{
	Global_22426 = 0;
...
var func_206(int iParam0, int iParam1)//Position - 0xD9D8
{
...
float func_213(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xDCA0
{
	struct<3> Var0;
...
void func_214(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, int iParam10)//Position - 0xDCDA
{
	int iVar0;
	int iVar1;
...
int func_215(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xDD77
{
	var uVar0;
	
	if ((((func_217(PLAYER::PLAYER_PED_ID()) && func_217(iParam0->f_28[0])) && !func_156()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_213(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_268(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
		func_216(&uVar0, cParam4, sParam5, 7, 0, 0);
...
void func_216(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDDFF
{
...
int func_217(int iParam0)//Position - 0xDE3A
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_218(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xDE5B
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_213(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_221(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_213(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_223(iParam0);
				}
			}
...
void func_221(int iParam0, int iParam1)//Position - 0xDFC1
{
	bool bVar0;
	int iVar1;
...
void func_223(int iParam0)//Position - 0xE06B
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_224(iParam0);
...
void func_224(int iParam0)//Position - 0xE082
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_226(int iParam0, bool bParam1)//Position - 0xE192
{
	struct<27> Var0;
	...
	func_120(*iParam0, &Var0);
	if ((func_263(*iParam0) || func_261(*iParam0)) || Global_79785 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (*iParam0 == 10)
	{
		if (FIRE::IS_EXPLOSION_IN_SPHERE(-1 /*EXP_TAG_DONTCARE*/, iParam0->f_17[0 /*3*/], 8f))
		{
...
int func_228(int iParam0)//Position - 0xE75A
{
...
int func_229(var uParam0)//Position - 0xE77A
{
...
int func_230(var uParam0)//Position - 0xE792
{
...
void func_232(int* iParam0)//Position - 0xEABB
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_234(var uParam0, bool bParam1, bool bParam2)//Position - 0xEB66
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_235(int iParam0, int iParam1)//Position - 0xED24
{
	int iVar0;
...
int func_236(var uParam0, bool bParam1, int iParam2)//Position - 0xED54
{
	int iVar0;
	int iVar1;
...
int func_237(int iParam0)//Position - 0xF010
{
...
int func_238(int iParam0, float fParam1)//Position - 0xF044
{
	float fVar0;
	
	if (func_217(PLAYER::PLAYER_PED_ID()) && func_217(iParam0))
	{
...
bool func_239(int iParam0, float fParam1)//Position - 0xF0BA
{
	return func_240(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_240(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF0D2
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_241(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xF193
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_242(int iParam0, int iParam1)//Position - 0xF2BF
{
	int iVar0;
...
int func_244(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xF3CE
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_245(struct<3> Param0, struct<3> Param3)//Position - 0xF45F
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_246(struct<3> Param0)//Position - 0xF480
{
	float fVar0;
	float fVar1;
...
int func_248(int iParam0, int iParam1)//Position - 0xF4DA
{
	int iVar0;
...
int func_249(int iParam0)//Position - 0xF519
{
...
int func_250(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF541
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_251(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF63C
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_252(int iParam0, float fParam1)//Position - 0xF748
{
	var uVar0;
	struct<3> Var1;
...
int func_253(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF7DD
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_254(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF86B
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_255(int iParam0)//Position - 0xF8B3
{
...
void func_256(int iParam0)//Position - 0xF8FD
{
	int iVar0;
...
int func_257(int iParam0)//Position - 0xF99A
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_258(int iParam0)//Position - 0xFA2F
{
...
int func_261(int iParam0)//Position - 0xFAAE
{
...
int func_263(int iParam0)//Position - 0xFB20
{
	if (func_118(0))
	{
...
void func_264()//Position - 0xFB48
{
	...
	if (func_217(PLAYER::PLAYER_PED_ID()))
	{
		if (func_265(PLAYER::PLAYER_PED_ID(), Var0, fVar3, 1))
		{
			func_162();
		}
	}
...
bool func_265(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0xFB8B
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

void func_266(int iParam0)//Position - 0xFBA9
{
	if (func_217(iParam0->f_28[0]))
	{
		PED::SET_PED_RESET_FLAG(iParam0->f_28[0], 64, true);
		PED::SET_PED_RESET_FLAG(iParam0->f_28[0], 249, true);
		if (FIRE::IS_EXPLOSION_IN_SPHERE(-1 /*EXP_TAG_DONTCARE*/, ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], true), 5.1f))
		{
			func_267(iParam0);
			if (func_217(iParam0->f_28[0]))
			{
...
void func_268(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xFCB3
{
...
int func_270(int iParam0)//Position - 0xFD7D
{
	...
	{
		func_272(&Local_95);
		func_271(&Local_95, "democ_only_works");
		func_271(&Local_95, "gift_from_god");
		func_271(&Local_95, "rigged_vote");
		func_271(&Local_95, "suck_my");
		func_271(&Local_95, "tyranny");
	}
...
int func_273(var uParam0)//Position - 0xFEB5
{
	uParam0->f_16 = 3;
...
int func_274(var uParam0)//Position - 0xFEE0
{
	int iVar0[3];
	struct<3> Var4;
	struct<3> Var7;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_276(&(uParam0->f_35[0]), iVar0[0], Var4, fVar16);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
			...
			{
				func_275(&(uParam0->f_41[0]), iVar0[1], Var4 + Var10, 0f);
			...
			{
				func_276(&(uParam0->f_35[1]), iVar0[2], Var7, fVar17);
...
void func_275(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10167
{
	func_232(iParam0);
...
void func_276(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x1018E
{
	func_277(iParam0);
...
void func_277(int* iParam0)//Position - 0x101D1
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_278(int iParam0)//Position - 0x1026D
{
	int iVar0;
...
int func_279(var uParam0)//Position - 0x1029E
{
	int iVar0[4];
	struct<3> Var5;
	struct<3> Var8;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			bVar17 = true;
			func_276(&(uParam0->f_35[0]), iVar0[0], Var5, fVar14);
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_35[0], 1);
				VEHICLE::SET_VEHICLE_ALARM(uParam0->f_35[0], false);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_275(&(uParam0->f_41[0]), iVar0[1], Var5 + Var8, 0f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_276(&(uParam0->f_35[1]), iVar0[2], Var11, fVar15);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				func_280(&(uParam0->f_28[0]), iVar0[3], Var11, fVar15, 6);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				func_280(&(uParam0->f_28[1]), iVar0[3], Var11, fVar15, 6);
			}
			if (bVar17)
			{
				iLocal_89 = 3;
...
void func_280(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x105EE
{
	func_281(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_281(int* iParam0)//Position - 0x1060F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_282(var uParam0)//Position - 0x10650
{
	int iVar0[2];
	struct<3> Var3;
	float fVar6;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_283(&(uParam0->f_28[0]), 49, Var3, fVar6, "RC LAUNCHER: BARRY 3", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_275(&(uParam0->f_41[0]), iVar0[1], Var3 + Vector(0f, 0f, 5f), -115.18f);
...
int func_283(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x10848
{
	if (func_284(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_284(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x108A4
{
	int iVar0;
...
int func_285(var uParam0, int iParam1)//Position - 0x10932
{
	int iVar0;
...
int func_286(var uParam0)//Position - 0x10978
{
	if (func_230(uParam0))
	{
...
int func_288(var uParam0)//Position - 0x109DE
{
	int iVar0[5];
	struct<3> Var6;
	float fVar9;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_283(&(uParam0->f_28[0]), 49, Var6, fVar9, "RC LAUNCHER: BARRY 2", 1))
				{
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				}
				else
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				if (func_217(uParam0->f_41[0]))
				{
					...
					func_275(&(uParam0->f_41[2]), iVar0[3], 189.79015f, -956.1675f, 29.8229f, func_290(-2.01f));
...
void func_289(int* iParam0, int iParam1)//Position - 0x10D7D
{
	struct<3> Var0;
	float fVar3;
	...
	fVar3 = 23.45f;
	func_275(iParam0, iParam1, Var0, fVar3);
}
...
int func_291(var uParam0)//Position - 0x10DBD
{
	int iVar0[7];
	struct<3> Var8;
	float fVar11;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_283(&(uParam0->f_28[0]), 49, Var8, fVar11, "RC LAUNCHER: BARRY 1", 1))
				{
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				}
				else
...
int func_292(int iParam0)//Position - 0x1121C
{
	struct<27> Var0;
	bool bVar32;
...
int func_293(int iParam0)//Position - 0x1126D
{
	char* sVar0;
...
int func_294(int iParam0)//Position - 0x11326
{
	var uVar0;
...
int func_295(int iParam0)//Position - 0x113E7
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_297(int iParam0)//Position - 0x1154E
{
...
int func_298(int iParam0)//Position - 0x11579
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_299(int iParam0)//Position - 0x115A4
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_300(int iParam0)//Position - 0x115CF
{
	if (func_258(iParam0))
	{
		return 0;
...
int func_302(int iParam0, struct<3> Param1, float fParam4)//Position - 0x1161E
{
	int iVar0[4];
	int iVar5;
	...
	if (func_113() == 0)
	{
		if (func_303(2, Param1, fParam4, iParam0))
		{
			return 1;
		}
	}
	...
	{
		if (func_303(3, Param1, fParam4, iParam0))
		{
			return 1;
		}
	}
	...
	while (iVar5 < iVar0)
	{
		if (func_303(iVar0[iVar5], Param1, fParam4, iParam0))
		{
			iVar5 = iVar0;
			return 1;
		}
...
int func_303(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x116AF
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_304(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_304(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x11727
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_305(int iParam0, bool bParam1)//Position - 0x117A2
{
	char* sVar0;
...
int func_309(char* sParam0)//Position - 0x11887
{
	struct<6> Var0;
...
void func_315(int* iParam0, bool bParam1)//Position - 0x11971
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_318(int* iParam0)//Position - 0x119FB
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_321(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x11A86
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_322(var uParam0)//Position - 0x11AD6
{
	if (*uParam0 == -1)
	{
		return;
...
int func_326(int iParam0)//Position - 0x11B72
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
