...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112735[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_315(&(Global_112735[Var0.f_0 /*10*/].f_9));
			}
		}
		func_298(&Var0, 1);
	}
	if (!func_295(&Var0, Var61, 1f))
	{
		func_294();
	...
	if (Var0.f_0 == 4)
	{
		func_261(&uLocal_106, 3, Var0.f_28[0], "BARRY", 0, 1);
	...
	while (true)
	{
		...
		if (!func_219(&Var0, Var0.f_0 != 2))
		{
			func_298(&Var0, 1);
		}
		func_218(Var0.f_0);
		func_211(&iLocal_93, &(Var0.f_9), Var61);
		if (func_210(Var0.f_28[0]))
		{
			if (Var0.f_0 == 2)
			{
				if (func_208(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
				{
					func_207(&Var0, Local_97, 1, 0);
				}
			}
			else if (Var0.f_0 == 3)
			{
				if (func_208(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f))
				{
				}
			}
			else if (Var0.f_0 == 4)
			{
				func_193(&uLocal_105, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar64 = 0;
		if (func_192(Var0.f_0))
		{
		...
		if (func_177(&Var0, iVar64))
		{
			if (func_176(Var0.f_0))
			{
				func_173(Var0.f_0, &iLocal_96);
			}
			if (!func_2(&Var0))
			{
				func_298(&Var0, 1);
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F81
{
	int iVar0;
...
int func_55()//Position - 0x41C4
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_56()//Position - 0x41DD
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x42DA
{
	return Global_43257 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x42E8
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x43DB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x4663
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x4704
{
...
int func_62(int iParam0, int iParam1)//Position - 0x48DE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x553F
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x557A
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x57EE
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x582A
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5D79
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5DBD
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x653C
{
	if (bParam6)
	{
...
int func_70(var uParam0)//Position - 0x6583
{
...
bool func_71(int iParam0)//Position - 0x65DE
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x65EE
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x664F
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x69E8
{
	return Global_32163;
}

int func_75(int iParam0)//Position - 0x69F3
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A03
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x6AA5
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_78()//Position - 0x71F5
{
...
int func_79()//Position - 0x74F0
{
	return Global_2652258.f_2650;
}

int func_80(struct<3> Param0)//Position - 0x74FF
{
...
int func_81(int iParam0)//Position - 0x7529
{
	if (iParam0 != func_90())
	{
...
Vector3 func_82(int iParam0, int iParam1)//Position - 0x7581
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_83(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x762B
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_84(struct<3> Param0, float fParam3)//Position - 0x76C0
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_85(int iParam0)//Position - 0x7704
{
	struct<6> Var0;
...
struct<6> func_86(int iParam0)//Position - 0x7888
{
	return func_87(iParam0);
}

struct<6> func_87(int iParam0)//Position - 0x7896
{
	struct<6> Var0;
...
int func_88(int iParam0, var uParam1)//Position - 0x835E
{
	switch (iParam0)
	{
		case 0:
...
int func_89(int iParam0)//Position - 0x83E0
{
	if (iParam0 != func_90())
	{
...
int func_90()//Position - 0x8438
{
	return -1;
}

Vector3 func_91(int iParam0)//Position - 0x8441
{
	switch (iParam0)
	{
		case 1:
...
int func_92()//Position - 0x86B8
{
	return func_93(PLAYER::PLAYER_ID());
}

int func_93(int iParam0)//Position - 0x86C8
{
	return MISC::GET_BITS_IN_RANGE(Global_2657589[iParam0 /*466*/].f_321.f_3, 28, 31);
}

int func_94(int iParam0)//Position - 0x86E5
{
	return func_72(iParam0, 0, 0);
}

int func_95(int iParam0)//Position - 0x86F5
{
	switch (iParam0)
	{
		case -1:
...
bool func_96()//Position - 0x8A1E
{
	return Global_100733.f_387 > 0;
}

var func_97()//Position - 0x8A2F
{
	var uVar0;
...
void func_98(var uParam0, int iParam1)//Position - 0x8A75
{
	if (iParam1 <= 0)
	{
		return;
...
void func_99(var uParam0, int iParam1)//Position - 0x8AFB
{
...
void func_100(var uParam0, int iParam1)//Position - 0x8B2E
{
	int iVar0;
	int iVar1;
...
int func_101(int iParam0, int iParam1)//Position - 0x8B7F
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_102(int iParam0)//Position - 0x8C21
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_103(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_103(bool bParam0, int iParam1, int iParam2)//Position - 0x8C43
{
	if (bParam0)
	{
		return iParam1;
...
int func_104(var uParam0)//Position - 0x8C5A
{
	return uParam0 & 15;
}

void func_105(var uParam0, int iParam1)//Position - 0x8C67
{
...
void func_106(var uParam0, int iParam1)//Position - 0x8CA1
{
...
void func_107(var uParam0, int iParam1)//Position - 0x8CDC
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_108()//Position - 0x8D18
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_109(int iParam0)//Position - 0x8D31
{
	var uVar0;
	char cVar1[24];
...
bool func_110()//Position - 0x8D8A
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_111()//Position - 0x8DA0
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_112(char* sParam0, int iParam1, int iParam2)//Position - 0x8DB6
{
...
int func_113(bool bParam0)//Position - 0x8DF8
{
...
struct<2> func_114(int iParam0)//Position - 0x8E20
{
	struct<2> Var0;
...
void func_115(int iParam0, var uParam1)//Position - 0x926D
{
	switch (iParam0)
	{
		case 0:
...
int func_117(int iParam0)//Position - 0xA545
{
	switch (iParam0)
	{
		case 0:
...
int func_118(int iParam0)//Position - 0xA88B
{
	int iVar0;
	
	if (func_147(&(iParam0->f_1)))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&(iParam0->f_9)))
		{
			func_137(1);
			func_135(iParam0, 1, func_136(*iParam0));
		}
		if (iParam0->f_27)
		{
			if (func_134(*iParam0))
		...
		func_119(*iParam0);
		iVar0 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&(iParam0->f_1), iParam0, 61, 54000);
...
void func_119(int iParam0)//Position - 0xA930
{
	struct<2> Var0;
...
void func_120(int iParam0)//Position - 0xA9CB
{
	if (iParam0 < 63)
	{
		func_121();
...
void func_122(int iParam0)//Position - 0xAA29
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_123(int iParam0)//Position - 0xAA82
{
...
int func_124(int iParam0)//Position - 0xAB05
{
	int iVar0;
...
void func_125(int iParam0, int iParam1, int iParam2)//Position - 0xAB36
{
	func_126(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_126(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAB4B
{
	int iVar0;
...
int func_128(int iParam0, int iParam1, int iParam2)//Position - 0xABFE
{
...
int func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAC19
{
	int iVar0;
...
int func_130(int iParam0)//Position - 0xAC65
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0xACAE
{
	if (func_210(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_132(int iParam0)//Position - 0xACCE
{
	switch (iParam0)
	{
		case 5:
...
int func_134(int iParam0)//Position - 0xAD9E
{
	switch (iParam0)
	{
		case 5:
...
void func_135(var uParam0, bool bParam1, bool bParam2)//Position - 0xADF1
{
	int iVar0;
...
int func_136(int iParam0)//Position - 0xAEE6
{
	switch (iParam0)
	{
		case 5:
...
void func_137(bool bParam0)//Position - 0xAF51
{
	int iVar0;
...
void func_138(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAF90
{
	if (bParam0)
	{
...
bool func_139()//Position - 0xB0DD
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_140(int iParam0, int iParam1)//Position - 0xB0F7
{
	bool bVar0;
...
int func_141(int iParam0, bool bParam1)//Position - 0xB142
{
	int iVar0;
	int iVar1;
...
int func_142(int iParam0)//Position - 0xB183
{
...
bool func_143()//Position - 0xB1C2
{
	return BitTest(Global_2621446, 3);
}

int func_144(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB1D0
{
	int iVar0;
...
void func_146(int iParam0)//Position - 0xB22A
{
	if (iParam0 == 1)
	{
...
int func_147(char* sParam0)//Position - 0xB24D
{
...
void func_148()//Position - 0xB28A
{
	Global_20591 = 0;
	func_149();
}

void func_149()//Position - 0xB29A
{
...
int func_153(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB380
{
...
void func_154(int iParam0)//Position - 0xB518
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_156(int iParam0)//Position - 0xB595
{
	if (func_161())
	{
		return;
...
void func_157(int iParam0)//Position - 0xB5C8
{
	if (func_161())
	{
		return;
...
void func_158(bool bParam0, bool bParam1)//Position - 0xB652
{
	if (bParam0)
	{
		if (func_160(0))
...
bool func_159()//Position - 0xB6C6
{
	return BitTest(Global_1962996, 5);
}

int func_160(int iParam0)//Position - 0xB6D4
{
	if (iParam0 == 1)
	{
...
bool func_161()//Position - 0xB72B
{
	return BitTest(Global_1962996, 19);
}

int func_162(int iParam0)//Position - 0xB73A
{
...
int func_163(int iParam0)//Position - 0xB77B
{
	int iVar0;
...
void func_164(int iParam0)//Position - 0xB7C0
{
...
int func_165(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB7F2
{
	int iVar0;
...
void func_166(var uParam0, int iParam1)//Position - 0xB929
{
	int iVar0;
...
bool func_167(int iParam0)//Position - 0xB978
{
	return func_168(iParam0, Global_43257);
}

int func_168(int iParam0, int iParam1)//Position - 0xB989
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_169(int iParam0)//Position - 0xBB6A
{
	if (Global_43257 == 15)
	{
		return 0;
...
int func_170()//Position - 0xBB8C
{
	return func_171(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_171(char* sParam0, int iParam1)//Position - 0xBB9D
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_173(int iParam0, int iParam1)//Position - 0xBC0A
{
	switch (iParam0)
	{
		case 0:
...
int func_174(struct<3> Param0, bool bParam3)//Position - 0xC07D
{
	int iVar0;
...
float func_175(bool bParam0, float fParam1, float fParam2)//Position - 0xC0A9
{
	if (bParam0)
	{
		return fParam1;
...
int func_176(int iParam0)//Position - 0xC0C0
{
	switch (iParam0)
	{
		case 0:
...
int func_177(int iParam0, int iParam1)//Position - 0xC14F
{
	switch (iParam0->f_16)
	{
		case 0:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.6306f, 4699.115f, 35.38089f, 1812.8776f, 4710.457f, 42.053535f, 23.75f, false, true, 0))
				{
					if (func_210(iParam0->f_28[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], true), true) < 3f)
						{
							if (func_183(2))
							{
								if (func_181(iParam0->f_27))
								{
									func_180(iParam0->f_27, *iParam0);
...
void func_178()//Position - 0xC932
{
	func_27(&(Global_104212.f_2890), &Global_104212, 0, 1, 1, 0);
}

int func_179(var uParam0)//Position - 0xC94D
{
	float fVar0;
...
void func_180(int iParam0, int iParam1)//Position - 0xC9DB
{
	if (iParam0 == 1)
	{
		if (!func_134(iParam1))
...
int func_181(bool bParam0)//Position - 0xCA3F
{
	int iVar0;
...
int func_182(int iParam0)//Position - 0xCAD6
{
	if (func_210(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_183(int iParam0)//Position - 0xCB00
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_191()) || Global_112695) || Global_32166) || func_190()) || func_189(8, -1)) || func_96()) || func_188()) || func_187()) || func_186()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_191()) || Global_32166) || func_190()) || func_189(8, -1)) || func_187()) || func_96()) || func_188()) || func_186()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_191()) || Global_112695) || Global_32166) || func_190()) || func_189(8, -1)) || func_187()) || func_96()) || func_188()) || func_186()) || Global_113648.f_7690.f_919[bVar0] == 5) || Global_43804 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_191()) || Global_112695) || Global_32166) || func_190()) || func_189(8, -1)) || func_96()) || func_188()) || func_186()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_191() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_189(8, -1)) || func_186()) || func_185()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_189(8, -1) || func_96()) || func_188()) || func_185()) || func_184())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_191()) || Global_32166) || func_190()) || func_189(8, -1)) || func_188()) || func_187()) || func_186()) || Global_113648.f_7690.f_919[bVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_191()) || func_188()) || Global_112695) || Global_32166) || func_190()) || Global_44446) || func_189(8, -1)) || func_187()) || func_185()) || func_186()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_191()) || Global_112695) || Global_32166) || func_190()) || func_189(8, -1)) || func_187()) || func_185()) || func_96()) || func_188()) || func_186())
						{
							return 0;
						}
						break;
...
var func_184()//Position - 0xD21D
{
	return Global_100720.f_1;
}

int func_185()//Position - 0xD22B
{
	if (Global_97603 != -1)
	{
...
bool func_188()//Position - 0xD292
{
	return Global_100733.f_388 > 0;
}

bool func_189(int iParam0, int iParam1)//Position - 0xD2A3
{
	switch (iParam0)
	{
		case 5:
...
var func_190()//Position - 0xD2DB
{
	return Global_1575060;
}

int func_191()//Position - 0xD2E7
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_192(int iParam0)//Position - 0xD303
{
	switch (iParam0)
	{
		case 5:
...
void func_193(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5)//Position - 0xD326
{
	switch (*uParam0)
	{
		case 0:
		...
		case 1:
			...
			{
				if (func_194(&uLocal_106, cParam4, sParam5, 8, 0, 0, 0))
				{
					*uParam0 = 2;
				}
			}
		...
		case 2:
			...
			else if (func_206(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 25f)
			{
				func_148();
				*uParam0 = 0;
			}
...
bool func_194(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD3C3
{
...
int func_195(char* sParam0, int iParam1, bool bParam2)//Position - 0xD411
{
	Global_21726 = 0;
...
bool func_198(int iParam0)//Position - 0xD779
{
	return func_199(iParam0, 20);
}

var func_199(int iParam0, int iParam1)//Position - 0xD789
{
	return BitTest(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

void func_200()//Position - 0xD7A1
{
	int iVar0;
...
void func_205(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD9FB
{
...
float func_206(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xDA51
{
	struct<3> Var0;
...
void func_207(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, int iParam10)//Position - 0xDA8B
{
	int iVar0;
	int iVar1;
	
	iVar1 = 32768;
	if (!func_210(iParam0->f_28[iParam10]))
	{
		return;
	}
	if (bParam9)
...
int func_208(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xDB28
{
	var uVar0;
	
	if ((((func_210(PLAYER::PLAYER_PED_ID()) && func_210(iParam0->f_28[0])) && !func_150()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_206(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_261(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
...
void func_209(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDBB0
{
...
int func_210(int iParam0)//Position - 0xDBEB
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_211(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xDC0C
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_212(int iParam0, bool bParam1)//Position - 0xDCFD
{
	if (iParam0 == -1)
	{
		return;
...
int func_213(int iParam0)//Position - 0xDD39
{
	if (Global_78554 == iParam0)
	{
		if (Global_78555 == -1)
...
void func_214(int iParam0, int iParam1)//Position - 0xDD72
{
	bool bVar0;
	int iVar1;
...
bool func_215()//Position - 0xDE10
{
	return Global_97990;
}

void func_216(int iParam0)//Position - 0xDE1C
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_217(iParam0);
...
void func_217(int iParam0)//Position - 0xDE33
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_218(int iParam0)//Position - 0xDF1B
{
	if (iParam0 == -1)
	{
		iParam0 = func_170();
...
int func_219(int iParam0, bool bParam1)//Position - 0xDF43
{
	struct<27> Var0;
	...
	func_115(*iParam0, &Var0);
	if ((func_256(*iParam0) || func_254(*iParam0)) || Global_78804 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_223(&(iParam0->f_48)) && bParam1)
	{
		func_220(iParam0->f_28[0], &(iParam0->f_48), *iParam0);
	}
	return 1;
}

void func_220(int iParam0, var uParam1, int iParam2)//Position - 0xE1B3
{
	int iVar0;
	int iVar1;
...
int func_221(int iParam0)//Position - 0xE50B
{
...
int func_222(var uParam0)//Position - 0xE52B
{
...
int func_223(var uParam0)//Position - 0xE543
{
...
void func_224(var uParam0)//Position - 0xE568
{
	int iVar0;
	int iVar1;
...
void func_225(int* iParam0)//Position - 0xE86C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_226(var uParam0)//Position - 0xE897
{
	int iVar0;
...
int func_227(var uParam0, bool bParam1, bool bParam2)//Position - 0xE917
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_228(int iParam0, int iParam1)//Position - 0xEAD5
{
	int iVar0;
...
int func_229(var uParam0, bool bParam1, int iParam2)//Position - 0xEB05
{
	int iVar0;
	int iVar1;
...
int func_230(int iParam0)//Position - 0xEDC1
{
...
int func_231(int iParam0, float fParam1)//Position - 0xEDF5
{
	float fVar0;
...
bool func_232(int iParam0, float fParam1)//Position - 0xEE6B
{
	return func_233(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_233(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEE83
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	uVar0 = func_234(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_234(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xEF44
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_235(int iParam0, int iParam1)//Position - 0xF070
{
	int iVar0;
...
int func_237(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xF17F
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_238(struct<3> Param0, struct<3> Param3)//Position - 0xF210
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_239(struct<3> Param0)//Position - 0xF231
{
	float fVar0;
	float fVar1;
...
void func_240(var uParam0)//Position - 0xF270
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_241(int iParam0, int iParam1)//Position - 0xF28B
{
	int iVar0;
...
int func_242(int iParam0)//Position - 0xF2CA
{
...
int func_243(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF2F2
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_244(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF3ED
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_245(int iParam0, float fParam1)//Position - 0xF4F9
{
	var uVar0;
	struct<3> Var1;
...
int func_246(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF58E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_247(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF61C
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_248(int iParam0)//Position - 0xF664
{
...
void func_249(int iParam0)//Position - 0xF6AE
{
	int iVar0;
...
int func_250(int iParam0)//Position - 0xF74B
{
	if (iParam0 == -1)
	{
		iParam0 = func_170();
...
int func_251(int iParam0)//Position - 0xF7E0
{
...
int func_254(int iParam0)//Position - 0xF85F
{
	if ((func_255() && Global_100681.f_11 == 6) && iParam0 == func_171(&(Global_100681.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_256(int iParam0)//Position - 0xF8D1
{
	if (func_113(0))
	{
...
void func_257()//Position - 0xF8F9
{
	...
	if (func_210(PLAYER::PLAYER_PED_ID()))
	{
		if (func_258(PLAYER::PLAYER_PED_ID(), Var0, fVar3, 1))
		{
			func_155();
		}
	}
...
bool func_258(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0xF93C
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

void func_259(int iParam0)//Position - 0xF95A
{
	if (func_210(iParam0->f_28[0]))
	{
...
void func_260(var uParam0)//Position - 0xF9C9
{
	int iVar0;
...
void func_261(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xFA63
{
...
int func_263(int iParam0)//Position - 0xFB2C
{
	...
	{
		func_265(&Local_97);
		func_264(&Local_97, "democ_only_works");
		func_264(&Local_97, "gift_from_god");
		func_264(&Local_97, "rigged_vote");
		func_264(&Local_97, "suck_my");
		func_264(&Local_97, "tyranny");
	}
	func_316("Created initial scene");
	return 1;
}

void func_264(var uParam0, char* sParam1)//Position - 0xFC0E
{
...
void func_265(var uParam0)//Position - 0xFC37
{
	int iVar0;
...
int func_266(var uParam0)//Position - 0xFC64
{
	uParam0->f_16 = 3;
...
int func_267(var uParam0)//Position - 0xFC8F
{
	int iVar0[3];
	struct<3> Var4;
	struct<3> Var7;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				func_269(&(uParam0->f_35[0]), iVar0[0], Var4, fVar16);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
			...
			{
				func_268(&(uParam0->f_41[0]), iVar0[1], Var4 + Var10, 0f);
			...
			{
				func_269(&(uParam0->f_35[1]), iVar0[2], Var7, fVar17);
...
void func_268(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFF15
{
	func_225(iParam0);
...
void func_269(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFF3C
{
	func_270(iParam0);
...
void func_270(int* iParam0)//Position - 0xFF7E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_271(int iParam0)//Position - 0x1001B
{
	int iVar0;
...
int func_272(var uParam0)//Position - 0x1004C
{
	int iVar0[4];
	struct<3> Var5;
	struct<3> Var8;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			bVar17 = true;
			func_269(&(uParam0->f_35[0]), iVar0[0], Var5, fVar14);
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_35[0], 1);
				VEHICLE::SET_VEHICLE_ALARM(uParam0->f_35[0], false);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_268(&(uParam0->f_41[0]), iVar0[1], Var5 + Var8, 0f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_269(&(uParam0->f_35[1]), iVar0[2], Var11, fVar15);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				func_273(&(uParam0->f_28[0]), iVar0[3], Var11, fVar15, 6);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				func_273(&(uParam0->f_28[1]), iVar0[3], Var11, fVar15, 6);
			}
			if (bVar17)
			{
				iLocal_91 = 3;
...
void func_273(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x1039C
{
	func_274(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_274(int* iParam0)//Position - 0x103BD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_275(var uParam0)//Position - 0x103FE
{
	int iVar0[2];
	struct<3> Var3;
	float fVar6;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_280(&(uParam0->f_48), "rcm_barry3", "bar_3_rcm_barry_standing_on_street_base", "bar_3_rcm_barry_standing_on_street_fidget");
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_271(&iVar0) || !func_279(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_276(&(uParam0->f_28[0]), 49, Var3, fVar6, "RC LAUNCHER: BARRY 3", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_268(&(uParam0->f_41[0]), iVar0[1], Var3 + Vector(0f, 0f, 5f), -115.18f);
				if (func_210(uParam0->f_41[0]) && func_210(uParam0->f_28[0]))
				{
...
int func_276(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x105F6
{
...
int func_277(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x10652
{
	int iVar0;
...
int func_278(var uParam0, int iParam1)//Position - 0x106E0
{
	int iVar0;
...
int func_279(var uParam0)//Position - 0x10726
{
	if (func_223(uParam0))
	{
...
void func_280(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x10750
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_281(var uParam0)//Position - 0x1078C
{
	int iVar0[5];
	struct<3> Var6;
	float fVar9;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_280(&(uParam0->f_48), "rcm_barry2", "lead_in_loop", "lead_in_loop");
			iLocal_91 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_276(&(uParam0->f_28[0]), 49, Var6, fVar9, "RC LAUNCHER: BARRY 2", 1))
				{
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				}
				else
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				func_268(&(uParam0->f_41[0]), iVar0[1], 189.5964f, -956.0344f, 29.09179f, func_283(-2.01f));
				if (func_210(uParam0->f_41[0]))
				{
					ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_41[0], true);
					func_268(&(uParam0->f_41[2]), iVar0[3], 189.79015f, -956.1675f, 29.8229f, func_283(-2.01f));
					if (func_210(uParam0->f_41[2]))
					{
			...
			{
				func_268(&(uParam0->f_41[1]), iVar0[2], 190.417f, -956.511f, 29.09179f, -99.157f);
				if (func_210(uParam0->f_41[1]))
				{
		...
		case 3:
			...
			func_282(&(uParam0->f_41[3]), iVar0[4]);
			iVar10 = 0;
			while (iVar10 <= (iVar0 - 1))
			{
...
void func_282(int* iParam0, int iParam1)//Position - 0x10B2B
{
	struct<3> Var0;
	float fVar3;
	...
	fVar3 = 23.45f;
	func_268(iParam0, iParam1, Var0, fVar3);
}

float func_283(float fParam0)//Position - 0x10B5B
{
	return (fParam0 * 57.29578f);
}

int func_284(var uParam0)//Position - 0x10B6B
{
	int iVar0[7];
	struct<3> Var8;
	float fVar11;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_280(&(uParam0->f_48), "RCMBarryLeadInOut", "idle", "fidget");
			iLocal_91 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_276(&(uParam0->f_28[0]), 49, Var8, fVar11, "RC LAUNCHER: BARRY 1", 1))
				{
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				}
				else
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				func_268(&(uParam0->f_41[1]), iVar0[2], 190.2574f, -956.3513f, 29.09179f, func_283(-1.68f));
				if (func_210(uParam0->f_41[1]))
				{
					ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_41[1], true);
					ENTITY::SET_ENTITY_COLLISION(uParam0->f_41[1], false, false);
...
int func_285(int iParam0)//Position - 0x10FCA
{
	struct<27> Var0;
	bool bVar32;
...
int func_286(int iParam0)//Position - 0x1101B
{
	char* sVar0;
...
int func_287(int iParam0)//Position - 0x110D4
{
	var uVar0;
...
int func_288(int iParam0)//Position - 0x11195
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_289(int iParam0, char* sParam1)//Position - 0x1121A
{
...
int func_290(int iParam0)//Position - 0x112FC
{
...
int func_291(int iParam0)//Position - 0x11327
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_292(int iParam0)//Position - 0x11352
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_293(int iParam0)//Position - 0x1137D
{
	if (func_251(iParam0))
	{
		return 0;
...
void func_294()//Position - 0x113B2
{
	func_316("Running end routines.");
	Global_113366 = (Global_113366 - 1);
}

int func_295(int iParam0, struct<3> Param1, float fParam4)//Position - 0x113CC
{
	int iVar0[4];
	int iVar5;
	...
	if (func_108() == 0)
	{
		if (func_296(2, Param1, fParam4, iParam0))
		{
			return 1;
		}
	}
	...
	{
		if (func_296(3, Param1, fParam4, iParam0))
		{
			return 1;
		}
	}
	...
	while (iVar5 < iVar0)
	{
		if (func_296(iVar0[iVar5], Param1, fParam4, iParam0))
		{
			iVar5 = iVar0;
			return 1;
		}
...
int func_296(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x1145D
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_297(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_297(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x114D5
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_298(int iParam0, bool bParam1)//Position - 0x11550
{
	char* sVar0;
...
void func_299(char* sParam0)//Position - 0x115E5
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_302(sParam0))
...
void func_300()//Position - 0x11604
{
	Global_20591 = 0;
	func_301();
}

void func_301()//Position - 0x11614
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_302(char* sParam0)//Position - 0x11635
{
	struct<6> Var0;
...
struct<6> func_303()//Position - 0x11655
{
	struct<6> Var0;
...
int func_304(var uParam0)//Position - 0x11679
{
	if (func_223(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_305(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x116AF
{
	func_312(uParam0, iParam1);
	func_309(uParam0, bParam2);
	func_306(uParam0, bParam3);
}

void func_306(var uParam0, bool bParam1)//Position - 0x116CF
{
	func_307(&(uParam0->f_41), bParam1);
}

void func_307(var uParam0, bool bParam1)//Position - 0x116E1
{
	int iVar0;
...
void func_308(int* iParam0, bool bParam1)//Position - 0x1171F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_309(var uParam0, bool bParam1)//Position - 0x1175A
{
	func_310(&(uParam0->f_35), bParam1);
}

void func_310(var uParam0, bool bParam1)//Position - 0x1176C
{
	int iVar0;
...
void func_311(int* iParam0)//Position - 0x117A9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_312(var uParam0, int iParam1)//Position - 0x117E1
{
	func_313(&(uParam0->f_28), iParam1);
}

void func_313(var uParam0, int iParam1)//Position - 0x117F3
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_314(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_314(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x11834
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_315(var uParam0)//Position - 0x11884
{
	if (*uParam0 == -1)
	{
		return;
...
void func_316(char* sParam0)//Position - 0x118C1
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_317(var uParam0)//Position - 0x118D3
{
	*uParam0 = -1;
...
void func_318()//Position - 0x11906
{
	func_316("Running start routines.");
	Global_113366++;
}

int func_319(int iParam0)//Position - 0x11920
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
