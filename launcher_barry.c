#region Local Var
	...
	int iLocal_93 = 0;
	int iLocal_94 = 0;
	struct<8> Local_95 = { 5, 0, 0, 0, 0, 0, 0, -1 } ;
	var uLocal_103 = 0;
	var uLocal_104 = 16;
	var uLocal_105 = 0;
	var uLocal_106 = 0;
...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113457[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_321(&(Global_113457[Var0.f_0 /*10*/].f_9));
			}
		}
		func_304(&Var0, 1);
	}
	if (!func_301(&Var0, Var61, 1f))
	{
		func_300();
	...
	if (Var0.f_0 == 4)
	{
		func_267(&uLocal_104, 3, Var0.f_28[0], "BARRY", 0, 1);
	...
	while (true)
	{
		...
		if (!func_225(&Var0, Var0.f_0 != 2))
		{
			func_304(&Var0, 1);
		}
		func_224(Var0.f_0);
		func_217(&iLocal_91, &(Var0.f_9), Var61);
		if (func_216(Var0.f_28[0]))
		{
			if (Var0.f_0 == 2)
			{
				if (func_214(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
				{
					func_213(&Var0, Local_95, 1, 0);
				}
			}
			else if (Var0.f_0 == 3)
			{
				if (func_214(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f))
				{
				}
			}
			else if (Var0.f_0 == 4)
			{
				func_199(&uLocal_103, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar64 = 0;
		if (func_198(Var0.f_0))
		{
		...
		if (func_183(&Var0, iVar64))
		{
			if (func_182(Var0.f_0))
			{
				func_179(Var0.f_0, &iLocal_94);
			}
			if (!func_2(&Var0))
			{
				func_304(&Var0, 1);
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x29C2
{
...
int func_29(int iParam0)//Position - 0x2A02
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2A30
{
...
int func_31(int iParam0)//Position - 0x2B0C
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2B4E
{
	int iVar0;
...
int func_33(int iParam0, bool bParam1, int iParam2)//Position - 0x2BB1
{
	int iVar0;
...
int func_34(bool bParam0, int iParam1)//Position - 0x2C3F
{
	struct<82> Var0;
...
void func_35(bool bParam0, var uParam1, int iParam2)//Position - 0x2C81
{
	int iVar0;
...
bool func_36(bool bParam0)//Position - 0x2EDD
{
	return bParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2EE9
{
	int iVar0;
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x3244
{
	int iVar0;
	int iVar1;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3508
{
	char* sVar0;
...
int func_43(int iParam0, bool bParam1, bool bParam2)//Position - 0x3637
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x36A5
{
...
int func_45(int iParam0)//Position - 0x377E
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x37BB
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x37E0
{
...
int func_50(int iParam0, var uParam1)//Position - 0x39B8
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(uParam1));
}

int func_51(var uParam0)//Position - 0x39CD
{
	int iVar0;
	int iVar1;
...
int func_53(int iParam0, int iParam1)//Position - 0x3A0D
{
	int iVar0;
	var uVar1;
...
int func_54(int iParam0, var uParam1)//Position - 0x3A31
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(uParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3A46
{
	int iVar0;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F8F
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x4671
{
	switch (iParam0)
	{
...
int func_63(int iParam0)//Position - 0x4712
{
...
int func_64(int iParam0, int iParam1)//Position - 0x48FE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x561F
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x565A
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x58CE
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x590A
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5E59
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5E9D
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x661C
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x6663
{
...
bool func_73(int iParam0)//Position - 0x66BE
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x66CE
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x672E
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x6AD6
{
	return Global_32828;
}

int func_77(int iParam0)//Position - 0x6AE1
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6AF1
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6B93
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x72FE
{
...
int func_81()//Position - 0x75F9
{
	return Global_2652572.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x7608
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x7632
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x7647
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x765E
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x76B6
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7760
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x77F5
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x7839
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x79BD
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x79CB
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x8494
{
	switch (iParam0)
	{
		case 0:
...
int func_94()//Position - 0x856E
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x8577
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x87E3
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x87F3
{
	return MISC::GET_BITS_IN_RANGE(Global_2657921[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x8810
{
	return func_74(iParam0, 0, 0);
}

int func_99(int iParam0)//Position - 0x8820
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x8B56
{
	return Global_101444.f_393 > 0;
}

var func_101()//Position - 0x8B67
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8BAD
{
	if (iParam1 <= 0)
	{
		return;
...
void func_103(var uParam0, int iParam1)//Position - 0x8C33
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8C66
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8CB7
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8D59
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8D7B
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8D92
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8D9F
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8DD9
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8E14
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8E50
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8E69
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8EC2
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8ED8
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8EEE
{
...
int func_117(bool bParam0)//Position - 0x8F30
{
...
struct<2> func_118(int iParam0)//Position - 0x8F58
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x93A5
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA67D
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0)//Position - 0xA9C3
{
	int iVar0;
	
	if (func_152(&(iParam0->f_1)))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&(iParam0->f_9)))
		{
			func_141(1);
			func_139(iParam0, 1, func_140(*iParam0));
		}
		if (iParam0->f_27)
		{
			if (func_138(*iParam0))
		...
		func_123(*iParam0);
		iVar0 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&(iParam0->f_1), iParam0, 61, 60500);
...
void func_123(int iParam0)//Position - 0xAA68
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xAB03
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xAB61
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xABBA
{
...
int func_128(int iParam0)//Position - 0xAC3D
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAC6E
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAC83
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xAD36
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAD51
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xAD9D
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xADE6
{
	if (func_216(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xAE06
{
	switch (iParam0)
	{
		case 5:
...
int func_138(int iParam0)//Position - 0xAED6
{
	switch (iParam0)
	{
		case 5:
...
void func_139(var uParam0, bool bParam1, bool bParam2)//Position - 0xAF29
{
	int iVar0;
...
int func_140(int iParam0)//Position - 0xB01E
{
	switch (iParam0)
	{
		case 5:
...
void func_141(bool bParam0)//Position - 0xB089
{
	int iVar0;
...
void func_142(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB0C8
{
	if (bParam0)
	{
...
bool func_143()//Position - 0xB215
{
	return BitTest(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

bool func_144(int iParam0, int iParam1)//Position - 0xB22F
{
	bool bVar0;
...
int func_145(int iParam0, bool bParam1)//Position - 0xB288
{
	int iVar0;
	int iVar1;
...
int func_146(var uParam0)//Position - 0xB2C9
{
	int iVar0;
...
int func_147(int iParam0)//Position - 0xB2EB
{
...
bool func_148()//Position - 0xB32A
{
	return BitTest(Global_2621446, 3);
}

int func_149(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB338
{
	int iVar0;
...
void func_151(int iParam0)//Position - 0xB392
{
	if (iParam0 == 1)
	{
...
int func_152(char* sParam0)//Position - 0xB3B5
{
...
void func_153()//Position - 0xB3F2
{
	Global_21032 = 0;
	func_154();
}

void func_154()//Position - 0xB402
{
...
int func_158(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB4E8
{
...
void func_159(int iParam0)//Position - 0xB53F
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_160(bool bParam0, bool bParam1)//Position - 0xB56B
{
...
void func_162(int iParam0)//Position - 0xB70D
{
	if (func_167())
	{
		return;
...
void func_163(int iParam0)//Position - 0xB740
{
	if (func_167())
	{
		return;
...
void func_164(bool bParam0, bool bParam1)//Position - 0xB7CA
{
	if (bParam0)
	{
		if (func_166(0))
...
bool func_165()//Position - 0xB83E
{
	return BitTest(Global_1956030, 5);
}

int func_166(int iParam0)//Position - 0xB84C
{
	if (iParam0 == 1)
	{
...
bool func_167()//Position - 0xB8A3
{
	return BitTest(Global_1956030, 19);
}

int func_168(int iParam0)//Position - 0xB8B2
{
...
int func_169(int iParam0)//Position - 0xB8F3
{
	int iVar0;
...
void func_170(int iParam0)//Position - 0xB938
{
...
int func_171(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB96A
{
	int iVar0;
...
void func_172(var uParam0, int iParam1)//Position - 0xBAA1
{
	int iVar0;
...
bool func_173(int iParam0)//Position - 0xBAF0
{
	return func_174(iParam0, Global_43922);
}

int func_174(int iParam0, int iParam1)//Position - 0xBB01
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_175(int iParam0)//Position - 0xBCE2
{
	if (Global_43922 == 15)
	{
		return 0;
...
int func_176()//Position - 0xBD04
{
	return func_177(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_177(char* sParam0, int iParam1)//Position - 0xBD15
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_179(int iParam0, int iParam1)//Position - 0xBD82
{
	switch (iParam0)
	{
		case 0:
...
int func_180(struct<3> Param0, bool bParam3)//Position - 0xC1F5
{
	int iVar0;
...
float func_181(bool bParam0, float fParam1, float fParam2)//Position - 0xC221
{
	if (bParam0)
	{
		return fParam1;
...
int func_182(int iParam0)//Position - 0xC238
{
	switch (iParam0)
	{
		case 0:
...
int func_183(int iParam0, int iParam1)//Position - 0xC2C7
{
	switch (iParam0->f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
				...
				else if (func_216(iParam0->f_28[0]))
				{
					if (func_185(iParam0))
					{
						if (func_189(2))
...
void func_184()//Position - 0xCAAA
{
	func_27(&(Global_104933.f_2890), &Global_104933, 0, 1, 1, 0);
}

int func_185(var uParam0)//Position - 0xCAC5
{
	float fVar0;
...
void func_186(int iParam0, int iParam1)//Position - 0xCB53
{
	if (iParam0 == 1)
	{
		if (!func_138(iParam1))
...
int func_187(bool bParam0)//Position - 0xCBB7
{
	int iVar0;
...
int func_188(int iParam0)//Position - 0xCC4E
{
	if (func_216(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_189(int iParam0)//Position - 0xCC78
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_197()) || Global_32831) || func_196()) || func_195(8, -1)) || func_193()) || func_100()) || func_194()) || func_192()) || Global_114370.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_197()) || Global_113417) || Global_32831) || func_196()) || func_195(8, -1)) || func_193()) || func_100()) || func_194()) || func_192()) || Global_114370.f_7691.f_919[bVar0] == 5) || Global_44469 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_197()) || Global_113417) || Global_32831) || func_196()) || func_195(8, -1)) || func_100()) || func_194()) || func_192()) || Global_114370.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_197() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_195(8, -1)) || func_192()) || func_191()) || Global_114370.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_190()//Position - 0xD395
{
	return Global_101431.f_1;
}

int func_191()//Position - 0xD3A3
{
	if (Global_98294 != -1)
	{
...
bool func_194()//Position - 0xD40A
{
	return Global_101444.f_394 > 0;
}

bool func_195(int iParam0, int iParam1)//Position - 0xD41B
{
	switch (iParam0)
	{
		case 5:
...
var func_196()//Position - 0xD453
{
	return Global_1575079;
}

int func_197()//Position - 0xD45F
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_198(int iParam0)//Position - 0xD47B
{
	switch (iParam0)
	{
		case 5:
...
void func_199(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5)//Position - 0xD49E
{
	switch (*uParam0)
	{
		case 0:
		...
		case 1:
			if (func_212(PLAYER::PLAYER_PED_ID(), Param1, 1) <= 20f)
			{
				if (func_200(&uLocal_104, cParam4, sParam5, 8, 0, 0, 0))
				{
					*uParam0 = 2;
				}
			}
		...
		case 2:
			...
			else if (func_212(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 25f)
			{
				func_153();
				*uParam0 = 0;
			}
...
bool func_200(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD53B
{
	...
	Global_23163 = 0;
	Global_2883585 = 0;
	return func_201(sParam2, iParam3, 0);
}

int func_201(char* sParam0, int iParam1, bool bParam2)//Position - 0xD589
{
	Global_22167 = 0;
...
bool func_204(int iParam0)//Position - 0xD8F1
{
	return func_205(iParam0, 20);
}

var func_205(int iParam0, int iParam1)//Position - 0xD901
{
	return BitTest(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

void func_206()//Position - 0xD919
{
	int iVar0;
...
void func_211(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDB73
{
...
float func_212(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xDBC9
{
	struct<3> Var0;
...
void func_213(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, int iParam10)//Position - 0xDC03
{
	int iVar0;
	int iVar1;
	
	iVar1 = 32768;
	if (!func_216(iParam0->f_28[iParam10]))
	{
		return;
	}
	if (bParam9)
...
int func_214(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xDCA0
{
	var uVar0;
	
	if ((((func_216(PLAYER::PLAYER_PED_ID()) && func_216(iParam0->f_28[0])) && !func_155()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_212(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_267(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
		func_215(&uVar0, cParam4, sParam5, 7, 0, 0);
...
void func_215(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDD28
{
...
int func_216(int iParam0)//Position - 0xDD63
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_217(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xDD84
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_212(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_220(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_212(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_222(iParam0);
				}
			}
...
void func_218(int iParam0, bool bParam1)//Position - 0xDE75
{
	if (iParam0 == -1)
	{
		return;
...
int func_219(int iParam0)//Position - 0xDEB1
{
	if (Global_79244 == iParam0)
	{
		if (Global_79245 == -1)
...
void func_220(int iParam0, int iParam1)//Position - 0xDEEA
{
	bool bVar0;
	int iVar1;
...
bool func_221()//Position - 0xDF88
{
	return Global_98681;
}

void func_222(int iParam0)//Position - 0xDF94
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_223(iParam0);
...
void func_223(int iParam0)//Position - 0xDFAB
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_224(int iParam0)//Position - 0xE093
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
int func_225(int iParam0, bool bParam1)//Position - 0xE0BB
{
	struct<27> Var0;
	...
	func_119(*iParam0, &Var0);
	if ((func_262(*iParam0) || func_260(*iParam0)) || Global_79494 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_229(&(iParam0->f_48)) && bParam1)
	{
		func_226(iParam0->f_28[0], &(iParam0->f_48), *iParam0);
	}
	return 1;
}

void func_226(int iParam0, var uParam1, int iParam2)//Position - 0xE32B
{
	int iVar0;
	int iVar1;
	...
	if (func_216(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_228(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_227(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_228(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_227(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
int func_227(int iParam0)//Position - 0xE683
{
...
int func_228(var uParam0)//Position - 0xE6A3
{
...
int func_229(var uParam0)//Position - 0xE6BB
{
...
void func_230(var uParam0)//Position - 0xE6E0
{
	int iVar0;
	int iVar1;
...
void func_231(int* iParam0)//Position - 0xE9E4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_232(var uParam0)//Position - 0xEA0F
{
	int iVar0;
...
int func_233(var uParam0, bool bParam1, bool bParam2)//Position - 0xEA8F
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_234(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_234(int iParam0, int iParam1)//Position - 0xEC4D
{
	int iVar0;
...
int func_235(var uParam0, bool bParam1, int iParam2)//Position - 0xEC7D
{
	int iVar0;
	int iVar1;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					...
					if (func_254(*uParam0))
					{
						if (!func_168(*uParam0))
						{
							if (func_249(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_230(uParam0);
						...
						if (func_237(uParam0->f_28[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_230(uParam0);
...
int func_236(int iParam0)//Position - 0xEF39
{
...
int func_237(int iParam0, float fParam1)//Position - 0xEF6D
{
	float fVar0;
...
bool func_238(int iParam0, float fParam1)//Position - 0xEFE3
{
	return func_239(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_239(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEFFB
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_240(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xF0BC
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_241(int iParam0, int iParam1)//Position - 0xF1E8
{
	int iVar0;
...
int func_243(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xF2F7
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_244(struct<3> Param0, struct<3> Param3)//Position - 0xF388
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_245(struct<3> Param0)//Position - 0xF3A9
{
	float fVar0;
	float fVar1;
...
void func_246(var uParam0)//Position - 0xF3E8
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_247(int iParam0, int iParam1)//Position - 0xF403
{
	int iVar0;
...
int func_248(int iParam0)//Position - 0xF442
{
...
int func_249(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF46A
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_250(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF565
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_251(int iParam0, float fParam1)//Position - 0xF671
{
	var uVar0;
	struct<3> Var1;
...
int func_252(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF706
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_253(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF794
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_254(int iParam0)//Position - 0xF7DC
{
...
void func_255(int iParam0)//Position - 0xF826
{
	int iVar0;
...
int func_256(int iParam0)//Position - 0xF8C3
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
int func_257(int iParam0)//Position - 0xF958
{
...
int func_260(int iParam0)//Position - 0xF9D7
{
...
int func_262(int iParam0)//Position - 0xFA49
{
	if (func_117(0))
	{
...
void func_263()//Position - 0xFA71
{
	...
	if (func_216(PLAYER::PLAYER_PED_ID()))
	{
		if (func_264(PLAYER::PLAYER_PED_ID(), Var0, fVar3, 1))
		{
			func_161();
		}
	}
...
bool func_264(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0xFAB4
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

void func_265(int iParam0)//Position - 0xFAD2
{
	if (func_216(iParam0->f_28[0]))
	{
		...
		if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], true), 5.1f))
		{
			...
			if (func_216(iParam0->f_28[0]))
			{
				PED::APPLY_DAMAGE_TO_PED(iParam0->f_28[0], 1000, true, 0, 0);
			}
		}
	}
}

void func_266(var uParam0)//Position - 0xFB42
{
	int iVar0;
...
void func_267(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xFBDC
{
...
int func_269(int iParam0)//Position - 0xFCA6
{
	...
	{
		func_271(&Local_95);
		func_270(&Local_95, "democ_only_works");
		func_270(&Local_95, "gift_from_god");
		func_270(&Local_95, "rigged_vote");
		func_270(&Local_95, "suck_my");
		func_270(&Local_95, "tyranny");
	}
	func_322("Created initial scene");
	return 1;
}

void func_270(var uParam0, char* sParam1)//Position - 0xFD88
{
...
void func_271(var uParam0)//Position - 0xFDB1
{
	int iVar0;
...
int func_272(var uParam0)//Position - 0xFDDE
{
	uParam0->f_16 = 3;
...
int func_273(var uParam0)//Position - 0xFE09
{
	int iVar0[3];
	struct<3> Var4;
	struct<3> Var7;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_275(&(uParam0->f_35[0]), iVar0[0], Var4, fVar16);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
			...
			{
				func_274(&(uParam0->f_41[0]), iVar0[1], Var4 + Var10, 0f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[0], uParam0->f_35[0], 0, Var10, Var13, false, false, false, false, 2, true, 0);
				}
				else
				{
					bVar19 = false;
			...
			{
				func_275(&(uParam0->f_35[1]), iVar0[2], Var7, fVar17);
...
void func_274(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10090
{
	func_231(iParam0);
...
void func_275(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x100B7
{
	func_276(iParam0);
...
void func_276(int* iParam0)//Position - 0x100FA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_277(int iParam0)//Position - 0x10196
{
	int iVar0;
...
int func_278(var uParam0)//Position - 0x101C7
{
	int iVar0[4];
	struct<3> Var5;
	struct<3> Var8;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			bVar17 = true;
			func_275(&(uParam0->f_35[0]), iVar0[0], Var5, fVar14);
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_35[0], 1);
				VEHICLE::SET_VEHICLE_ALARM(uParam0->f_35[0], false);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_274(&(uParam0->f_41[0]), iVar0[1], Var5 + Var8, 0f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[0], uParam0->f_35[0], 0, Var8, 0f, 0f, 0f, false, false, true, false, 2, true, 0);
				}
				else
				{
					bVar17 = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_275(&(uParam0->f_35[1]), iVar0[2], Var11, fVar15);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				func_279(&(uParam0->f_28[0]), iVar0[3], Var11, fVar15, 6);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				func_279(&(uParam0->f_28[1]), iVar0[3], Var11, fVar15, 6);
			}
			if (bVar17)
			{
				iLocal_89 = 3;
...
void func_279(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x10517
{
	func_280(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_280(int* iParam0)//Position - 0x10538
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_281(var uParam0)//Position - 0x10579
{
	int iVar0[2];
	struct<3> Var3;
	float fVar6;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_277(&iVar0) || !func_285(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_282(&(uParam0->f_28[0]), 49, Var3, fVar6, "RC LAUNCHER: BARRY 3", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_274(&(uParam0->f_41[0]), iVar0[1], Var3 + Vector(0f, 0f, 5f), -115.18f);
				if (func_216(uParam0->f_41[0]) && func_216(uParam0->f_28[0]))
				{
...
int func_282(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x10771
{
	if (func_283(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_283(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x107CD
{
	int iVar0;
...
int func_284(var uParam0, int iParam1)//Position - 0x1085B
{
	int iVar0;
...
int func_285(var uParam0)//Position - 0x108A1
{
	if (func_229(uParam0))
	{
...
void func_286(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x108CB
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_287(var uParam0)//Position - 0x10907
{
	int iVar0[5];
	struct<3> Var6;
	float fVar9;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_282(&(uParam0->f_28[0]), 49, Var6, fVar9, "RC LAUNCHER: BARRY 2", 1))
				{
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				}
				else
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				func_274(&(uParam0->f_41[0]), iVar0[1], 189.5964f, -956.0344f, 29.09179f, func_289(-2.01f));
				if (func_216(uParam0->f_41[0]))
				{
					ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_41[0], true);
					func_274(&(uParam0->f_41[2]), iVar0[3], 189.79015f, -956.1675f, 29.8229f, func_289(-2.01f));
					if (func_216(uParam0->f_41[2]))
					{
			...
			{
				func_274(&(uParam0->f_41[1]), iVar0[2], 190.417f, -956.511f, 29.09179f, -99.157f);
				if (func_216(uParam0->f_41[1]))
				{
		...
		case 3:
			...
			func_288(&(uParam0->f_41[3]), iVar0[4]);
			iVar10 = 0;
			while (iVar10 <= (iVar0 - 1))
			{
...
void func_288(int* iParam0, int iParam1)//Position - 0x10CA6
{
	struct<3> Var0;
	float fVar3;
	...
	fVar3 = 23.45f;
	func_274(iParam0, iParam1, Var0, fVar3);
}

float func_289(float fParam0)//Position - 0x10CD6
{
	return (fParam0 * 57.29578f);
}

int func_290(var uParam0)//Position - 0x10CE6
{
	int iVar0[7];
	struct<3> Var8;
	float fVar11;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_282(&(uParam0->f_28[0]), 49, Var8, fVar11, "RC LAUNCHER: BARRY 1", 1))
				{
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				}
				else
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				func_274(&(uParam0->f_41[1]), iVar0[2], 190.2574f, -956.3513f, 29.09179f, func_289(-1.68f));
				if (func_216(uParam0->f_41[1]))
				{
					ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_41[1], true);
					ENTITY::SET_ENTITY_COLLISION(uParam0->f_41[1], false, false);
...
int func_291(int iParam0)//Position - 0x11145
{
	struct<27> Var0;
	bool bVar32;
...
int func_292(int iParam0)//Position - 0x11196
{
	char* sVar0;
...
int func_293(int iParam0)//Position - 0x1124F
{
	var uVar0;
...
int func_294(int iParam0)//Position - 0x11310
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_295(int iParam0, char* sParam1)//Position - 0x11395
{
...
int func_296(int iParam0)//Position - 0x11477
{
...
int func_297(int iParam0)//Position - 0x114A2
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_298(int iParam0)//Position - 0x114CD
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_299(int iParam0)//Position - 0x114F8
{
	if (func_257(iParam0))
	{
		return 0;
...
void func_300()//Position - 0x1152D
{
	func_322("Running end routines.");
	Global_114088 = (Global_114088 - 1);
}

int func_301(int iParam0, struct<3> Param1, float fParam4)//Position - 0x11547
{
	int iVar0[4];
	int iVar5;
	...
	if (func_112() == 0)
	{
		if (func_302(2, Param1, fParam4, iParam0))
		{
			return 1;
		}
	}
	...
	{
		if (func_302(3, Param1, fParam4, iParam0))
		{
			return 1;
		}
	}
	...
	while (iVar5 < iVar0)
	{
		if (func_302(iVar0[iVar5], Param1, fParam4, iParam0))
		{
			iVar5 = iVar0;
			return 1;
		}
...
int func_302(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x115D8
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_303(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_303(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x11650
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_304(int iParam0, bool bParam1)//Position - 0x116CB
{
	char* sVar0;
...
void func_305(char* sParam0)//Position - 0x11760
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_308(sParam0))
...
void func_306()//Position - 0x1177F
{
	Global_21032 = 0;
	func_307();
}

void func_307()//Position - 0x1178F
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_308(char* sParam0)//Position - 0x117B0
{
	struct<6> Var0;
...
struct<6> func_309()//Position - 0x117D0
{
	struct<6> Var0;
...
int func_310(var uParam0)//Position - 0x117F4
{
	if (func_229(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_311(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x1182A
{
...
void func_312(var uParam0, bool bParam1)//Position - 0x1184A
{
	func_313(&(uParam0->f_41), bParam1);
}

void func_313(var uParam0, bool bParam1)//Position - 0x1185C
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_314(uParam0[iVar0], 0);
		}
		iVar0++;
	}
}

void func_314(int* iParam0, bool bParam1)//Position - 0x1189A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_315(var uParam0, bool bParam1)//Position - 0x118D5
{
	func_316(&(uParam0->f_35), bParam1);
}

void func_316(var uParam0, bool bParam1)//Position - 0x118E7
{
	int iVar0;
...
void func_317(int* iParam0)//Position - 0x11924
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_318(var uParam0, int iParam1)//Position - 0x1195C
{
	func_319(&(uParam0->f_28), iParam1);
}

void func_319(var uParam0, int iParam1)//Position - 0x1196E
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_320(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_320(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x119AF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_321(var uParam0)//Position - 0x119FF
{
	if (*uParam0 == -1)
	{
		return;
...
void func_322(char* sParam0)//Position - 0x11A3C
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_323(var uParam0)//Position - 0x11A4E
{
	*uParam0 = -1;
...
void func_324()//Position - 0x11A81
{
	func_322("Running start routines.");
	Global_114088++;
}

int func_325(int iParam0)//Position - 0x11A9B
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
