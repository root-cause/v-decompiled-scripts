...
int func_64(int iParam0, int iParam1)//Position - 0x4904
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x5645
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x5680
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x58F4
{
	bool bVar0;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5E7F
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6642
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x6689
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x66F4
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6B07
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6B17
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x7622
{
...
int func_83()//Position - 0x764C
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

Vector3 func_84(struct<3> Param0)//Position - 0x7664
{
...
int func_86(int iParam0)//Position - 0x7690
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7792
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x7827
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_93(int iParam0, var uParam1)//Position - 0x84C5
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0)//Position - 0x8547
{
	if (iParam0 != func_95())
	{
...
int func_98(int iParam0)//Position - 0x8824
{
	return MISC::GET_BITS_IN_RANGE(Global_2657971[iParam0 /*465*/].f_322.f_3, 28, 31);
}

int func_99(int iParam0)//Position - 0x8841
{
...
var func_107(int iParam0)//Position - 0x8D8A
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8DAC
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8DC3
{
	return uParam0 & 15;
}
...
bool func_115()//Position - 0x8EF3
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_116()//Position - 0x8F09
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x8F1F
{
...
int func_118(bool bParam0)//Position - 0x8F61
{
...
int func_123(int iParam0)//Position - 0xA9F4
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xAC6E
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAD67
{
...
int func_135(int iParam0)//Position - 0xADCE
{
	int iVar0;
...
int func_136(int iParam0)//Position - 0xAE17
{
	if (func_217(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xAE37
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xAF07
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xAF5A
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xB04F
{
	switch (iParam0)
	{
		case 5:
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB0F9
{
	if (bParam0)
	{
...
bool func_145(int iParam0, int iParam1)//Position - 0xB260
{
	bool bVar0;
...
int func_147(var uParam0)//Position - 0xB2FA
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB31C
{
...
int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB369
{
	int iVar0;
...
int func_153(char* sParam0)//Position - 0xB3E6
{
...
int func_159(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB519
{
...
void func_160(int iParam0)//Position - 0xB570
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_167(int iParam0)//Position - 0xB87D
{
	if (iParam0 == 1)
	{
...
int func_169(int iParam0)//Position - 0xB8E3
{
...
int func_170(int iParam0)//Position - 0xB924
{
	int iVar0;
...
int func_172(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB99B
{
	int iVar0;
...
void func_173(var uParam0, int iParam1)//Position - 0xBAD2
{
	int iVar0;
...
bool func_174(int iParam0)//Position - 0xBB21
{
	return func_175(iParam0, Global_44042);
}

int func_175(int iParam0, int iParam1)//Position - 0xBB32
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_176(int iParam0)//Position - 0xBD13
{
	if (Global_44042 == 15)
	{
		return 0;
...
int func_178(char* sParam0, int iParam1)//Position - 0xBD46
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_180(int iParam0, int iParam1)//Position - 0xBDB3
{
	switch (iParam0)
	{
		case 0:
...
int func_181(struct<3> Param0, bool bParam3)//Position - 0xC223
{
	int iVar0;
...
float func_182(bool bParam0, float fParam1, float fParam2)//Position - 0xC24F
{
	if (bParam0)
	{
		return fParam1;
...
int func_183(int iParam0)//Position - 0xC266
{
	switch (iParam0)
	{
		case 0:
...
int func_184(int iParam0, int iParam1)//Position - 0xC2F5
{
	switch (iParam0->f_16)
	{
		case 0:
...
int func_186(var uParam0)//Position - 0xCAF3
{
	float fVar0;
...
void func_187(int iParam0, int iParam1)//Position - 0xCB81
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_188(bool bParam0)//Position - 0xCBE5
{
	int iVar0;
...
int func_189(int iParam0)//Position - 0xCC7C
{
	if (func_217(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_190(int iParam0)//Position - 0xCCA6
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_198()) || Global_32951) || func_197()) || func_196(8, -1)) || func_194()) || func_101()) || func_195()) || func_193()) || Global_113969.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_198()) || Global_113016) || Global_32951) || func_197()) || func_196(8, -1)) || func_101()) || func_195()) || func_193()) || Global_113969.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_198() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_196(8, -1)) || func_193()) || func_192()) || Global_113969.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_198()) || func_195()) || Global_113016) || Global_32951) || func_197()) || Global_45250) || func_196(8, -1)) || func_194()) || func_192()) || func_193()) || Global_113969.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_191()//Position - 0xD3C3
{
	return Global_101572.f_1;
}

int func_192()//Position - 0xD3D1
{
	if (Global_98435 != -1)
	{
...
var func_197()//Position - 0xD481
{
	return Global_1575083;
}

int func_198()//Position - 0xD48D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_199(int iParam0)//Position - 0xD4A9
{
	switch (iParam0)
	{
		case 5:
...
void func_200(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5)//Position - 0xD4CC
{
	switch (*uParam0)
	{
		case 0:
...
bool func_201(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD569
{
...
int func_202(char* sParam0, int iParam1, bool bParam2)//Position - 0xD5B7
{
	Global_22287 = 0;
...
bool func_205(int iParam0)//Position - 0xD91F
{
	return func_206(iParam0, 20);
}

var func_206(int iParam0, int iParam1)//Position - 0xD92F
{
...
void func_212(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDBA1
{
...
float func_213(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xDBF7
{
	struct<3> Var0;
...
void func_214(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, int iParam10)//Position - 0xDC31
{
	int iVar0;
	int iVar1;
...
int func_215(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xDCCE
{
	var uVar0;
...
void func_216(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDD56
{
...
int func_217(int iParam0)//Position - 0xDD91
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_218(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xDDB2
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_221(int iParam0, int iParam1)//Position - 0xDF18
{
	bool bVar0;
	int iVar1;
...
void func_223(int iParam0)//Position - 0xDFC2
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_224(iParam0);
...
void func_224(int iParam0)//Position - 0xDFD9
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_226(int iParam0, bool bParam1)//Position - 0xE0E9
{
	struct<27> Var0;
...
void func_227(int iParam0, var uParam1, int iParam2)//Position - 0xE359
{
	int iVar0;
	int iVar1;
...
int func_228(int iParam0)//Position - 0xE6B1
{
...
int func_229(var uParam0)//Position - 0xE6D1
{
...
int func_230(var uParam0)//Position - 0xE6E9
{
...
void func_232(int* iParam0)//Position - 0xEA12
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_234(var uParam0, bool bParam1, bool bParam2)//Position - 0xEABD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_235(int iParam0, int iParam1)//Position - 0xEC7B
{
	int iVar0;
...
int func_236(var uParam0, bool bParam1, int iParam2)//Position - 0xECAB
{
	int iVar0;
	int iVar1;
...
int func_237(int iParam0)//Position - 0xEF67
{
...
int func_238(int iParam0, float fParam1)//Position - 0xEF9B
{
	float fVar0;
...
bool func_239(int iParam0, float fParam1)//Position - 0xF011
{
	return func_240(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_240(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF029
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_241(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xF0EA
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_242(int iParam0, int iParam1)//Position - 0xF216
{
	int iVar0;
...
int func_244(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xF325
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_245(struct<3> Param0, struct<3> Param3)//Position - 0xF3B6
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_246(struct<3> Param0)//Position - 0xF3D7
{
	float fVar0;
	float fVar1;
...
int func_248(int iParam0, int iParam1)//Position - 0xF431
{
	int iVar0;
...
int func_249(int iParam0)//Position - 0xF470
{
...
int func_250(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF498
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_251(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF593
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_252(int iParam0, float fParam1)//Position - 0xF69F
{
	var uVar0;
	struct<3> Var1;
...
int func_253(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF734
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_254(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF7C2
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_255(int iParam0)//Position - 0xF80A
{
...
void func_256(int iParam0)//Position - 0xF854
{
	int iVar0;
...
int func_257(int iParam0)//Position - 0xF8F1
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_258(int iParam0)//Position - 0xF986
{
...
int func_261(int iParam0)//Position - 0xFA05
{
...
int func_263(int iParam0)//Position - 0xFA77
{
	if (func_118(0))
	{
...
bool func_265(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0xFAE2
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

void func_266(int iParam0)//Position - 0xFB00
{
	if (func_217(iParam0->f_28[0]))
	{
...
void func_268(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xFC0A
{
...
int func_270(int iParam0)//Position - 0xFCD4
{
	switch (*iParam0)
	{
		case 2:
...
int func_273(var uParam0)//Position - 0xFE0C
{
	uParam0->f_16 = 3;
...
int func_274(var uParam0)//Position - 0xFE37
{
	int iVar0[3];
	struct<3> Var4;
	struct<3> Var7;
...
void func_275(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x100BE
{
	func_232(iParam0);
...
void func_276(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x100E5
{
	func_277(iParam0);
...
void func_277(int* iParam0)//Position - 0x10128
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_278(int iParam0)//Position - 0x101C4
{
	int iVar0;
...
int func_279(var uParam0)//Position - 0x101F5
{
	int iVar0[4];
	struct<3> Var5;
	struct<3> Var8;
...
void func_280(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x10545
{
	func_281(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_281(int* iParam0)//Position - 0x10566
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_282(var uParam0)//Position - 0x105A7
{
	int iVar0[2];
	struct<3> Var3;
	float fVar6;
...
int func_283(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x1079F
{
...
int func_284(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x107FB
{
	int iVar0;
...
int func_285(var uParam0, int iParam1)//Position - 0x10889
{
	int iVar0;
...
int func_286(var uParam0)//Position - 0x108CF
{
	if (func_230(uParam0))
	{
...
int func_288(var uParam0)//Position - 0x10935
{
	int iVar0[5];
	struct<3> Var6;
	float fVar9;
...
void func_289(int* iParam0, int iParam1)//Position - 0x10CD4
{
	struct<3> Var0;
	float fVar3;
...
int func_291(var uParam0)//Position - 0x10D14
{
	int iVar0[7];
	struct<3> Var8;
	float fVar11;
...
int func_292(int iParam0)//Position - 0x11173
{
	struct<27> Var0;
	bool bVar32;
...
int func_293(int iParam0)//Position - 0x111C4
{
	char* sVar0;
...
int func_294(int iParam0)//Position - 0x1127D
{
	var uVar0;
...
int func_295(int iParam0)//Position - 0x1133E
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_297(int iParam0)//Position - 0x114A5
{
...
int func_298(int iParam0)//Position - 0x114D0
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_299(int iParam0)//Position - 0x114FB
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_300(int iParam0)//Position - 0x11526
{
	if (func_258(iParam0))
	{
		return 0;
...
int func_302(int iParam0, struct<3> Param1, float fParam4)//Position - 0x11575
{
	int iVar0[4];
	int iVar5;
...
int func_303(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x11606
{
	int iVar0;
	struct<7> Var1;
...
int func_304(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x1167E
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_305(int iParam0, bool bParam1)//Position - 0x116F9
{
	char* sVar0;
...
int func_309(char* sParam0)//Position - 0x117DE
{
	struct<6> Var0;
...
void func_315(int* iParam0, bool bParam1)//Position - 0x118C8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_318(int* iParam0)//Position - 0x11952
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_321(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x119DD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_322(var uParam0)//Position - 0x11A2D
{
	if (*uParam0 == -1)
	{
		return;
...
int func_326(int iParam0)//Position - 0x11AC9
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
