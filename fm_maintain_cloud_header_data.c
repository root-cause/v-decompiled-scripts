...
int func_14(int iParam0, int iParam1)//Position - 0x5B2
{
	...
	iVar0 = Global_2848280[iParam0 /*3*/][func_15(iParam1)];
...
{
	return BitTest(Global_2683862, 19);
}
...
void func_132(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x3C96
{
	...
	iVar0 = Global_2805027[iParam0 /*3*/][func_15(iParam2)];
	if (iVar0 != 0)
	{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0x3CC6
{
	...
	if (iParam0 != 14192)
	{
		...
		iVar0 = Global_2805027[iParam0 /*3*/][func_15(iParam1)];
...
void func_199(int iParam0, bool bParam1)//Position - 0x20717
{
	...
	if (iVar0 > -1)
	{
		if (bParam1)
		{
			MISC::SET_BIT(&(Global_2803653.f_1032[func_186(iVar0)]), func_188(iVar0));
		}
		else
		{
			MISC::CLEAR_BIT(&(Global_2803653.f_1032[func_186(iVar0)]), func_188(iVar0));
		}
	}
}
...
var func_207(int iParam0)//Position - 0x21747
{
	...
	uVar0 = Global_2803653.f_1032[func_186(iParam0)];
	return uVar0;
}
