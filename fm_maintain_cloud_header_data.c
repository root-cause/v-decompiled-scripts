	...
	while (true)
	{
		...
		else
		{
			...
			switch (iLocal_148)
			{
				...
				case 1:
					Local_45.f_3.f_25 = 1;
					if (iLocal_149 == 0 && !BitTest(Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_36.f_18, 30))
					{
						if (func_42())
						{
							bVar0 = false;
					...
					{
						if (BitTest(Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_36.f_18, 29))
						{
							if (func_2())
							{
								func_1();
...
void func_3()//Position - 0x359
{
	...
	if (Global_1845221[iVar0 /*889*/].f_137.f_1 != 0)
	{
		Global_1845221[iVar0 /*889*/].f_137.f_1 = 0;
		Global_1845221[iVar0 /*889*/].f_137 = 0;
	}
}
...
int func_6()//Position - 0x3C0
{
	if (BitTest(Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_36.f_18, 30))
	{
		return 0;
	}
	if (BitTest(Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_36.f_18, 29))
	...
	if (((((((((((((((func_30() == 0 && !func_29()) && !func_2()) && !func_28()) && !func_27()) && !func_26()) && !func_25()) && !func_24()) && !func_23()) && func_20()) && func_12()) && Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_96 != 8) && Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_96 != 9) && !func_10(PLAYER::PLAYER_ID())) && !func_9()) && !func_7(PLAYER::PLAYER_ID(), 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_7(int iParam0, bool bParam1, bool bParam2)//Position - 0x4BC
{
	if (iParam0 == func_8())
	{
		return 0;
...
var func_11(int iParam0)//Position - 0x567
{
	return BitTest(Global_1845221[iParam0 /*889*/].f_11.f_1, 0);
}

int func_12()//Position - 0x57E
{
	if (!func_13())
	{
		return 0;
...
int func_14(int iParam0, int iParam1)//Position - 0x5C3
{
	int iVar0;
	var uVar1;
...
int func_15(int iParam0, var uParam1)//Position - 0x5E7
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_16(uParam1));
}

int func_16(var uParam0)//Position - 0x5FC
{
	int iVar0;
	int iVar1;
...
int func_44(var uParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x8AE
{
	if (func_337())
	{
		return 0;
	...
	switch (*uParam0)
	{
		...
		case 7:
			if (func_310())
			{
				if (func_309(&(uParam0->f_3), 0, 31, 0))
				{
					uParam0->f_1 = 0;
					uParam0->f_2 = 150;
					func_4(uParam0, 8);
...
int func_47(var uParam0, var* uParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, int iParam9, bool bParam10, int iParam11, int iParam12)//Position - 0xBD8
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (uParam0->f_3)
	{
							...
							case 0:
								switch (iParam2)
								{
									...
									case 1:
										if (bParam10)
										{
											func_293(&Global_987974, 1, 0, 1, 0, 1);
										}
										else
										{
											func_293(&Global_982384, 1, 0, 1, 0, 0);
										}
										break;
									
									case 7:
										func_292(&Global_999154, 0, 1, 0);
										break;
									
									case 8:
										if (bParam10)
										{
											func_293(&Global_993564, 1, 0, 1, 0, 1);
										}
										else
										{
											func_293(&Global_982384, 0, 0, 1, 0, 0);
										}
										break;
		...
		case 1:
			...
			else if (func_286(iParam2, uParam0->f_11, iParam4, iParam5, iParam7, uParam1, iParam6, iParam11, iParam12, 0))
			{
				if (iParam2 == 0)
				{
						...
						switch (iParam5)
						{
							case 0:
								switch (iParam4)
								{
									...
									case 3:
									case 4:
										func_232(&Global_949659, uParam0, 0, iParam4, 0);
										break;
									
									case 5:
									case 6:
										func_232(&Global_949659, uParam0, 0, iParam4, Global_949659.f_32723);
										break;
									...
									case 0:
										switch (iParam2)
										{
											case 0:
											case 1:
												func_136(uParam0, iParam2, 0, bParam8, bParam10, 0);
												break;
											
											case 8:
												func_136(uParam0, iParam2, 31, bParam8, bParam10, 1);
												break;
							...
							case 1:
								...
								{
									case 8:
										func_67(uParam0, &Global_1052675, 1, 0);
										break;
									...
									default:
										switch (iParam4)
										{
											...
											case 5:
											case 6:
												func_66(uParam0, &Global_1054553, 1, iParam4);
												break;
											
											default:
												func_67(uParam0, &Global_1051736, 1, iParam4);
												break;
										}
										break;
								}
...
void func_48(bool bParam0)//Position - 0x14A5
{
	...
	if (bParam0)
	{
		...
		while (iVar0 < iVar4)
		{
			...
			if (BitTest(Global_1835455[iVar1], bVar2))
			{
				iVar3 = iVar0;
				while (iVar3 <= (iVar4 - 2))
				{
				...
				MISC::CLEAR_BIT(&(Global_1835455[iVar1]), bVar2);
				return;
			}
			MISC::CLEAR_BIT(&(Global_1835455[iVar1]), bVar2);
			iVar0++;
...
int func_49(var uParam0, int iParam1, bool bParam2)//Position - 0x15E7
{
	if (iParam1 == -1)
	{
		return 1;
...
void func_50(var uParam0, bool bParam1, bool bParam2)//Position - 0x1645
{
	if (uParam0->f_1 == 0)
	{
...
bool func_51(var uParam0)//Position - 0x168A
{
	return uParam0->f_1;
}
	...
	switch (iParam0)
	{
		case 0:
			switch (iParam2)
			{
				...
				case 5:
				case 6:
					func_294(&Global_949659, 1, 0, iParam3);
					break;
				...
				case 0:
					switch (iParam1)
					{
						...
						case 1:
							if (bParam4)
							{
								func_293(&Global_987974, 1, 1, 0, iParam3, bParam4);
							}
							else
							{
								func_293(&Global_982384, 1, 1, 0, iParam3, 0);
							}
							break;
						...
						case 8:
							if (bParam4)
							{
								func_293(&Global_993564, 1, 1, 0, iParam3, bParam4);
								iVar0 = 0;
								while (iVar0 < 62)
								{
									Global_993564.f_5523[iVar0] = 0;
							...
							{
								func_293(&Global_982384, 0, 1, 0, iParam3 + 31, 0);
							}
							break;
						
						case 7:
						case 2:
							func_292(&Global_999154, 1, 0, iParam3);
							break;
					}
					break;
			}
...
void func_54(int iParam0)//Position - 0x17A9
{
	Global_2696929 = iParam0;
}

void func_55(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x17B7
{
	var* uVar0;
	var* uVar1;
	var* uVar2;
...
struct<13> func_56(int iParam0)//Position - 0x19BD
{
	struct<13> Var0;
...
int func_57(char* sParam0)//Position - 0x19D4
{
	struct<13> Var0;
	struct<13> Var13;
...
struct<13> func_58(char* sParam0)//Position - 0x1A04
{
	struct<13> Var0;
...
int func_59(int iParam0, bool bParam1, char* sParam2, int iParam3)//Position - 0x1A1B
{
	struct<13> Var0;
	struct<13> Var13;
	...
	if (!Global_1980811)
	{
		return func_60(&Var0, &Var13, iParam0, bParam1);
	}
	if (!NETWORK::_NETWORK_HAS_PLAYER_PASSED_CHECK_TYPE(2, &Var0))
	{
		return 0;
	}
	return 1;
...
int func_60(var* uParam0, var* uParam1, int iParam2, bool bParam3)//Position - 0x1A6F
{
	if (iParam2 == 0)
	{
		if (bParam3)
		{
			if (NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uParam1, uParam0))
			{
				return 1;
			}
			else if (!NETWORK::NETWORK_IS_FRIEND(uParam0))
			{
				return 0;
			}
		}
		else if (func_61())
		{
			...
			else if ((NETWORK::NETWORK_PERMISSIONS_HAS_GAMER_RECORD(uParam0) && NETWORK::NETWORK_HAS_VIEW_GAMER_USER_CONTENT_RESULT(uParam0)) && !NETWORK::NETWORK_CAN_VIEW_GAMER_USER_CONTENT(uParam0))
			{
				return 0;
			}
		}
		else if (!NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uParam1, uParam0))
		{
			return 0;
		}
	}
...
int func_62(int iParam0)//Position - 0x1B0C
{
	switch (iParam0)
	{
		case 1:
...
int func_63(int iParam0)//Position - 0x1B44
{
...
int func_64()//Position - 0x1B89
{
	return 0;
	return func_65();
}

bool func_65()//Position - 0x1B99
{
...
void func_68(var uParam0, bool bParam1)//Position - 0x1E63
{
	...
	if (bParam1 == 0)
	{
		...
		if (((((((((((func_135(iVar5) || func_134(iVar5)) || func_133(iVar5)) || func_132(iVar5)) || func_131(iVar5)) || func_130(iVar5)) || func_129(iVar5)) || func_127(iVar5)) || func_126(iVar5)) || func_125(iVar5)) || (func_124(iVar5) && func_123())) || func_121(iVar5))
		{
			func_297();
			return;
		}
		if (func_119(iVar5) && !func_118(PLAYER::PLAYER_ID()))
		{
			func_297();
			return;
		}
	...
	{
		if (Global_262145.f_7166 /* Tunable: TOGGLE_CTF_CONTENT */ == 0)
		{
		...
		if (Global_262145.f_7167 /* Tunable: TOGGLE_LTS_CONTENT */ == 0)
		{
		...
		if (Global_262145.f_7884 /* Tunable: TOGGLE_RACE_CREATOR */ == 0)
		{
		...
		if (Global_262145.f_7885 /* Tunable: TOGGLE_DEATHMATCH_CREATOR */ == 0)
		{
	...
	Global_999154.f_33[iVar3 /*89*/].f_56 = { func_112(iVar2) };
	if (DATAFILE::DATADICT_GET_TYPE(iVar2, "cam") == 5)
	{
		Global_999154.f_33[iVar3 /*89*/].f_59 = { func_111(iVar2, "cam") };
	}
	...
	Global_999154.f_33[iVar3 /*89*/].f_62 = { func_110(iVar2) };
	...
	{
		Global_999154.f_33[iVar3 /*89*/].f_71 = func_109();
	}
	...
	Global_999154.f_33[iVar3 /*89*/].f_73 = func_108(NETWORK::UGC_GET_CONTENT_RATING(uParam0->f_6, 0), NETWORK::UGC_GET_CONTENT_RATING_COUNT(uParam0->f_6, 0));
	...
	if (func_107() != 2)
	{
		if (Global_999154.f_33[uParam0->f_8 /*89*/].f_71 > Global_262145.f_4270 /* Tunable: MAX_NG_TRANSITION_SESSION_SIZE */)
		{
			Global_999154.f_33[uParam0->f_8 /*89*/].f_71 = Global_262145.f_4270 /* Tunable: MAX_NG_TRANSITION_SESSION_SIZE */;
		}
		if (Global_999154.f_33[uParam0->f_8 /*89*/].f_69 > Global_262145.f_4270 /* Tunable: MAX_NG_TRANSITION_SESSION_SIZE */)
		{
			Global_999154.f_33[uParam0->f_8 /*89*/].f_69 = Global_262145.f_4270 /* Tunable: MAX_NG_TRANSITION_SESSION_SIZE */;
		}
	}
	...
	if (!func_328())
	{
		...
		Global_999154.f_33[iVar3 /*89*/].f_67 = func_106(uParam0->f_6);
	...
	func_105(Global_999154.f_33[iVar3 /*89*/].f_65, &(Global_999154.f_33[iVar3 /*89*/].f_71), &(Global_999154.f_33[iVar3 /*89*/].f_69));
	...
	func_70(MISC::GET_HASH_KEY(NETWORK::UGC_GET_ROOT_CONTENT_ID(uParam0->f_6)), &(Global_999154.f_33[iVar3 /*89*/].f_76), &(Global_999154.f_33[iVar3 /*89*/].f_77), Global_999154.f_33[iVar3 /*89*/].f_80);
	MISC::SET_BIT(&(Global_999154.f_33[iVar3 /*89*/].f_76), 13);
	if (MISC::IS_STRING_NULL_OR_EMPTY(&(Global_999154.f_33[iVar3 /*89*/])))
	{
		MISC::CLEAR_BIT(&(Global_999154.f_33[iVar3 /*89*/].f_76), 13);
	}
	if (func_69(Global_999154.f_33[iVar3 /*89*/].f_56))
	{
		MISC::CLEAR_BIT(&(Global_999154.f_33[iVar3 /*89*/].f_76), 13);
	}
	Global_999154++;
...
int func_69(struct<3> Param0)//Position - 0x268D
{
...
void func_70(int iParam0, int* iParam1, int* iParam2, int iParam3)//Position - 0x26B7
{
	if (func_104(iParam0))
	{
...
int func_84(int iParam0)//Position - 0x2A19
{
	int iVar0;
...
int func_86(int iParam0)//Position - 0x2A72
{
	int iVar0;
...
int func_87(int iParam0)//Position - 0x2ABF
{
	int iVar0;
...
int func_88(int iParam0)//Position - 0x2B0C
{
	int iVar0;
...
int func_89(int iParam0)//Position - 0x2B59
{
	int iVar0;
...
int func_90(int iParam0)//Position - 0x2BA6
{
	int iVar0;
...
int func_91(int iParam0)//Position - 0x2BF3
{
	int iVar0;
...
int func_92(int iParam0)//Position - 0x2C40
{
	int iVar0;
...
int func_93(int iParam0)//Position - 0x2C8D
{
	int iVar0;
...
int func_94(int iParam0)//Position - 0x2CDA
{
	int iVar0;
...
int func_95(int iParam0)//Position - 0x2D27
{
	int iVar0;
...
int func_96(int iParam0)//Position - 0x2D74
{
	int iVar0;
...
int func_97(int iParam0)//Position - 0x2DC1
{
	int iVar0;
...
int func_98(int iParam0)//Position - 0x2E0E
{
	int iVar0;
...
int func_99(int iParam0, bool bParam1, bool bParam2)//Position - 0x2E5B
{
	int iVar0;
	...
	if (bParam2)
	{
		if (func_100(Global_4718592.f_187633, 0))
		{
			return 1;
		}
	}
...
int func_100(int iParam0, bool bParam1)//Position - 0x2EC7
{
	if (iParam0 == 93)
	{
		if (bParam1)
...
int func_101(int iParam0)//Position - 0x2EF3
{
	int iVar0;
...
int func_102(int iParam0)//Position - 0x2F3F
{
...
int func_103(int iParam0)//Position - 0x2FAC
{
...
int func_104(int iParam0)//Position - 0x3019
{
...
void func_105(int iParam0, var uParam1, var uParam2)//Position - 0x30A6
{
	if (iParam0 == 1)
	{
		if (*uParam2 < 2)
...
int func_106(int iParam0)//Position - 0x30DC
{
...
Vector3 func_112(int iParam0)//Position - 0x3294
{
	...
	return func_113(Var0);
}

Vector3 func_113(struct<3> Param0)//Position - 0x3392
{
	if (func_114(Param0, -1713.73f, 2723.09f, -0.13f, 0.25f, 0))
	{
...
int func_114(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x33CC
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_115(int iParam0)//Position - 0x3447
{
	int iVar0;
	int iVar1;
...
int func_116(int iParam0)//Position - 0x34AC
{
	int iVar0;
	...
	while (iVar0 < 8)
	{
		if (iParam0 == Global_262145.f_9530[iVar0] || iParam0 == Global_262145.f_9539[iVar0])
		{
			return 1;
		}
		iVar0++;
...
int func_117(int iParam0)//Position - 0x34FB
{
	int iVar0;
...
int func_119(int iParam0)//Position - 0x353F
{
	int iVar0;
...
int func_121(int iParam0)//Position - 0x357C
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0x3634
{
	int iVar0;
...
int func_126(int iParam0)//Position - 0x3677
{
	int iVar0;
...
int func_127(int iParam0)//Position - 0x36BA
{
...
int func_129(int iParam0)//Position - 0x372C
{
...
int func_130(int iParam0)//Position - 0x378A
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0x37C3
{
	if ((Global_262145.f_6007[0] /* Tunable: CICASINO_HEIST_MISSION_STEALTH_STAGE_1A */ == iParam0 || Global_262145.f_6007[6] /* Tunable: CICASINO_HEIST_MISSION_SUBTERFUGE_STAGE_1A */ == iParam0) || Global_262145.f_6007[13] /* Tunable: CICASINO_HEIST_MISSION_DIRECT_STAGE_1A */ == iParam0)
	{
		return 1;
	}
	return 0;
...
int func_132(int iParam0)//Position - 0x3807
{
	int iVar0;
...
int func_133(int iParam0)//Position - 0x3841
{
	int iVar0;
...
void func_136(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0x38EF
{
	...
	if (iParam1 != 0 && iParam1 != 1)
	{
		...
		if (!func_59(uParam0->f_23, uParam0->f_24, NETWORK::UGC_GET_CONTENT_USER_ID(uParam0->f_6), NETWORK::UGC_GET_CONTENT_CATEGORY(uParam0->f_6)))
		{
			if (bParam5 && func_61())
			{
				...
				MISC::SET_BIT(&(Global_1835455[iVar2]), iVar1);
	...
	if (bParam4)
	{
		if (bParam5)
		{
			if (func_228(uParam0, &(Global_993564.f_4[iVar0 /*89*/]), iParam1, 1, iParam2, bParam5))
			{
				Global_993564++;
				uParam0->f_8++;
			}
		}
		else if (func_228(uParam0, &(Global_987974.f_4[iVar0 /*89*/]), iParam1, 1, iParam2, 0))
		{
			Global_987974++;
			func_142(uParam0, iParam1);
			func_137(uParam0, iParam1, iVar0);
	...
	else if (bParam3)
	{
		if (iParam1 == 1)
		{
			if (Global_982384 < 62)
			{
				func_228(uParam0, &(Global_982384.f_4[Global_982384 /*89*/]), iParam1, 0, iParam2, 0);
				Global_982384++;
			}
		}
		else if (Global_999154 < 31)
		{
			if (func_228(uParam0, &(Global_999154.f_33[Global_999154 /*89*/]), iParam1, 0, iParam2, 0))
			{
				Global_999154++;
			}
		}
	...
	else if (func_228(uParam0, &(Global_982384.f_4[iVar0 /*89*/]), iParam1, 1, iParam2, 0))
	{
		func_142(uParam0, iParam1);
		if (iParam2 == 0)
		{
...
void func_138(struct<16> Param0)//Position - 0x3BCC
{
	int iVar0;
	
	iVar0 = func_139(4);
	Global_2645376[iVar0 /*83*/] = 4;
	Global_2645376[iVar0 /*83*/].f_1 = { Param0 };
	StringCopy(&(Global_2645376[iVar0 /*83*/].f_18[0 /*16*/]), "-FromLiveArea", 64);
	StringCopy(&(Global_2645376[iVar0 /*83*/].f_18[1 /*16*/]), "-LiveAreaContentType=UGC_TYPE_GTA5_MISSION", 64);
	StringCopy(&(Global_2645376[iVar0 /*83*/].f_18[2 /*16*/]), "-LiveAreaLoadContent=", 64);
	MemCopy(&(Global_2645376[iVar0 /*83*/].f_18[3 /*16*/]), {Global_4718592.f_128763}, 16);
}
...
void func_140(struct<16> Param0)//Position - 0x3C95
{
	int iVar0;
	
	iVar0 = func_139(3);
	Global_2645376[iVar0 /*83*/] = 3;
	Global_2645376[iVar0 /*83*/].f_1 = { Param0 };
	StringCopy(&(Global_2645376[iVar0 /*83*/].f_18[0 /*16*/]), "-FromLiveArea", 64);
	StringCopy(&(Global_2645376[iVar0 /*83*/].f_18[1 /*16*/]), "-LiveAreaContentType=UGC_TYPE_GTA5_MISSION", 64);
	StringCopy(&(Global_2645376[iVar0 /*83*/].f_18[2 /*16*/]), "-LiveAreaLoadContent=", 64);
...
void func_141(struct<16> Param0)//Position - 0x3D11
{
	int iVar0;
	
	iVar0 = func_139(2);
	Global_2645376[iVar0 /*83*/] = 2;
	Global_2645376[iVar0 /*83*/].f_1 = { Param0 };
	StringCopy(&(Global_2645376[iVar0 /*83*/].f_18[0 /*16*/]), "-FromLiveArea", 64);
	StringCopy(&(Global_2645376[iVar0 /*83*/].f_18[1 /*16*/]), "-LiveAreaContentType=UGC_TYPE_GTA5_MISSION", 64);
	StringCopy(&(Global_2645376[iVar0 /*83*/].f_18[2 /*16*/]), "-LiveAreaLoadContent=", 64);
...
void func_142(var uParam0, int iParam1)//Position - 0x3D8D
{
	if (iParam1 == 0 || iParam1 == 1)
	{
		if (NETWORK::UGC_GET_CONTENT_IS_VERIFIED(uParam0->f_6))
		{
			if (!func_227(89, -1) || func_226(4244, -1) == 0)
			{
				func_225(4244, 1, -1);
				func_195(89, 1, 1, 0, 0, -1);
				if (!func_193())
				{
...
void func_143(int iParam0, int iParam1)//Position - 0x3E01
{
	if (iParam0 == joaat("MP_M_Freemode_01"))
	{
		if (iParam1 == 89)
		{
			func_144(joaat("MP_M_Freemode_01"), 11, 23, 1);
			func_144(joaat("MP_M_Freemode_01"), 8, 23, 1);
			func_144(joaat("MP_M_Freemode_01"), 8, 231, 1);
		}
		else if (iParam1 == 88)
		{
			func_144(joaat("MP_M_Freemode_01"), 11, 17, 1);
			func_144(joaat("MP_M_Freemode_01"), 8, 17, 1);
			func_144(joaat("MP_M_Freemode_01"), 8, 225, 1);
		}
		else if (iParam1 == 87)
		{
			func_144(joaat("MP_M_Freemode_01"), 11, 28, 1);
			func_144(joaat("MP_M_Freemode_01"), 8, 28, 1);
			func_144(joaat("MP_M_Freemode_01"), 8, 236, 1);
		}
	}
	else if (iParam0 == joaat("MP_F_Freemode_01"))
	{
		if (iParam1 == 89)
		{
			func_144(joaat("MP_F_Freemode_01"), 11, 4, 1);
			func_144(joaat("MP_F_Freemode_01"), 8, 4, 1);
			func_144(joaat("MP_F_Freemode_01"), 8, 20, 1);
		}
		else if (iParam1 == 88)
		{
			func_144(joaat("MP_F_Freemode_01"), 11, 7, 1);
			func_144(joaat("MP_F_Freemode_01"), 8, 7, 1);
			func_144(joaat("MP_F_Freemode_01"), 8, 23, 1);
		}
		else if (iParam1 == 87)
		{
			func_144(joaat("MP_F_Freemode_01"), 11, 9, 1);
			func_144(joaat("MP_F_Freemode_01"), 8, 9, 1);
			func_144(joaat("MP_F_Freemode_01"), 8, 25, 1);
		}
	}
}
...
int func_144(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x3F52
{
	...
	{
		if (func_148(iParam1, Global_79322[1 /*14*/].f_2, &iVar0))
		{
			iVar1 = func_147(iVar0, Global_79319);
			if (bParam3)
			{
				MISC::CLEAR_BIT(&iVar1, Global_79322[1 /*14*/].f_1);
			}
			else
			{
				MISC::SET_BIT(&iVar1, Global_79322[1 /*14*/].f_1);
			}
			func_145(iVar0, iVar1, Global_79319, 1);
			return 1;
		}
	}
	return 0;
...
void func_145(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x3FD8
{
	int iVar0;
...
int func_146(int iParam0, var uParam1)//Position - 0x4007
{
...
void func_151(int iParam0)//Position - 0x459D
{
	...
	func_152(&(Global_79322[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_152(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x4758
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_147(func_154(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_147(func_153(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_147(iVar1, Global_79319);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_155(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x52EF
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_156(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x6192
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	if (func_157(iParam0, iParam1, &iVar2, &uVar1, bParam2, bParam3))
	{
		uVar3 = func_147(iVar2, iVar0);
...
void func_160(int iParam0, int iParam1)//Position - 0x8ED7
{
	...
	func_161(iVar0, iParam0, 0, iParam1);
}
...
void func_161(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8EF7
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_152(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_152(&(Global_79322[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_152(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79520)
		{
			...
			func_152(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_163(int iParam0, int iParam1)//Position - 0x922D
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 4;
			func_161(iVar10, iParam0, 9, iParam1);
			return;
			break;
	}
	...
	func_152(&(Global_79322[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_164(int iParam0, int iParam1)//Position - 0x9330
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 4;
			func_161(iVar10, iParam0, 28, iParam1);
			return;
			break;
	}
	func_152(&(Global_79322[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
...
void func_165(int iParam0, int iParam1)//Position - 0x960F
{
	...
	{
		Global_79322[0 /*14*/].f_5 = 4;
		func_161(iVar10, iParam0, 327, iParam1);
...
void func_166(int iParam0, int iParam1)//Position - 0xC3E7
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 4;
			func_161(iVar10, iParam0, 6, iParam1);
			return;
			break;
	}
	func_152(&(Global_79322[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
...
void func_167(int iParam0, int iParam1)//Position - 0xC4EC
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 4;
			func_161(iVar10, iParam0, 55, iParam1);
			if (Global_79322[0 /*14*/].f_7 > 0)
			{
...
void func_168(int iParam0, int iParam1)//Position - 0xCCC8
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 4;
			func_161(iVar10, iParam0, 26, iParam1);
			if (Global_79322[0 /*14*/].f_7 > 0)
			{
...
void func_169(int iParam0, int iParam1)//Position - 0xCFAD
{
	...
	{
		Global_79322[0 /*14*/].f_5 = 4;
		func_161(iVar10, iParam0, 256, iParam1);
		if (Global_79322[0 /*14*/].f_7 > 0)
		{
...
void func_171(int iParam0, int iParam1)//Position - 0xFC33
{
	...
	{
		Global_79322[0 /*14*/].f_5 = 4;
		func_161(iVar10, iParam0, 16, iParam1);
		return;
	}
	func_152(&(Global_79322[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_172(int iParam0, int iParam1)//Position - 0xFD8E
{
	...
	{
		Global_79322[0 /*14*/].f_5 = 4;
		func_161(iVar10, iParam0, 36, iParam1);
		return;
	}
	func_152(&(Global_79322[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_173(int iParam0, int iParam1)//Position - 0x10010
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 4;
			func_161(iVar10, iParam0, 136, iParam1);
			if (Global_79322[0 /*14*/].f_7 > 0)
			{
...
void func_175(int iParam0, int iParam1)//Position - 0x12B17
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 4;
			func_161(iVar10, iParam0, 92, iParam1);
			return;
			break;
	}
...
void func_182(int iParam0, int iParam1)//Position - 0x16E51
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 3;
			func_161(iVar10, iParam0, 7, iParam1);
			return;
			break;
	}
	func_152(&(Global_79322[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
...
void func_188(int iParam0, int iParam1)//Position - 0x1A8EA
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 3;
			func_161(iVar10, iParam0, 46, iParam1);
			return;
			break;
	}
	func_152(&(Global_79322[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
...
void func_189(int iParam0, int iParam1)//Position - 0x1AC06
{
	...
	{
		Global_79322[0 /*14*/].f_5 = 3;
		func_161(iVar10, iParam0, 241, iParam1);
		if (Global_79322[0 /*14*/].f_7 > 0)
		{
...
void func_190(int iParam0, int iParam1)//Position - 0x1D0F8
{
	...
	{
		Global_79322[0 /*14*/].f_5 = 3;
		func_161(iVar10, iParam0, 237, iParam1);
		if (Global_79322[0 /*14*/].f_7 > 0)
		{
			Global_79322[0 /*14*/].f_7 = SYSTEM::ROUND((SYSTEM::TO_FLOAT(Global_79322[0 /*14*/].f_7) * Global_298510.f_10));
		}
...
void func_191(int iParam0, int iParam1)//Position - 0x1E683
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 3;
			func_161(iVar10, iParam0, 91, iParam1);
			return;
			break;
	}
...
int func_194(int iParam0)//Position - 0x1F5C5
{
...
void func_195(int iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x1F5E4
{
	if (iParam4 || bParam1)
	{
...
void func_197(int iParam0, bool bParam1)//Position - 0x1F7A4
{
	...
	while (iVar1 >= 0)
	{
		if (bParam1)
		{
			if (Global_1981834[iVar1] == iParam0)
			{
				return;
			}
			else if (Global_1981834[iVar1] == -1)
			{
				iVar0 = iVar1;
			}
		}
		else if (Global_1981834[iVar1] == iParam0)
		{
			Global_1981834[iVar1] = -1;
			return;
		}
		iVar1 = (iVar1 + -1);
	}
...
void func_198(int iParam0, bool bParam1, int iParam2)//Position - 0x1F81E
{
	...
	iVar0 = func_204(iParam0, iParam2);
	iVar1 = iParam0;
	if (iVar1 > -1)
	{
		if (bParam1)
		{
			MISC::SET_BIT(&iVar0, func_203(iVar1));
		}
		else
		{
			MISC::CLEAR_BIT(&iVar0, func_203(iVar1));
		}
		if (!func_202(0))
		{
			...
			if (iVar2 != 15468)
			{
				func_145(iVar2, iVar0, iParam2, 1);
			}
		}
	}
}
...
int func_204(int iParam0, int iParam1)//Position - 0x1FC5B
{
	...
	uVar1 = func_147(iVar0, iParam1);
	return uVar1;
}

int func_205(int iParam0, int iParam1)//Position - 0x1FCA1
{
	var uVar0;
	int iVar1;
	...
	uVar0 = func_204(iParam0, iParam1);
...
void func_206(int iParam0, int iParam1, int iParam2)//Position - 0x1FCE0
{
	...
	iVar0 = func_147(iParam0, func_16(iParam2));
	iVar0 = (iVar0 + iParam1);
...
void func_208(var uParam0, bool bParam1, var uParam2)//Position - 0x1FD3D
{
	int iVar0;
	int iVar1;
	...
	if (iVar1 > -1)
	{
		...
		func_145(func_209(uParam0), iVar0, uParam2, 1);
	}
}

int func_209(var uParam0)//Position - 0x1FD89
{
	int iVar0;
	int iVar1;
...
var func_210(var uParam0)//Position - 0x20105
{
	var uVar0;
	
	uVar0 = func_147(func_209(uParam0), -1);
	return uVar0;
}

bool func_211(var uParam0)//Position - 0x2011C
{
	var uVar0;
	int iVar1;
	
	uVar0 = func_210(uParam0);
	iVar1 = uParam0;
...
void func_212(int iParam0, bool bParam1)//Position - 0x20139
{
	...
	if (iVar0 > -1)
	{
		if (bParam1)
		{
			MISC::SET_BIT(&(Global_2750848.f_1032[func_201(iVar0)]), func_203(iVar0));
		}
		else
		{
			MISC::CLEAR_BIT(&(Global_2750848.f_1032[func_201(iVar0)]), func_203(iVar0));
		}
	}
}
...
int func_219(int iParam0)//Position - 0x2114C
{
	var uVar0;
	int iVar1;
...
var func_220(int iParam0)//Position - 0x21169
{
	var uVar0;
	
	uVar0 = Global_2750848.f_1032[func_201(iParam0)];
	return uVar0;
}
...
void func_221(int iParam0, bool bParam1, int iParam2)//Position - 0x21184
{
	...
	if (iVar1 > -1)
	{
		...
		func_145(func_223(iParam0), iVar0, iParam2, 1);
	}
}

var func_222(var uParam0, int iParam1)//Position - 0x211E0
{
	var uVar0;
	
	uVar0 = func_147(func_223(uParam0), iParam1);
	return uVar0;
}

int func_223(var uParam0)//Position - 0x211F8
{
	int iVar0;
	int iVar1;
...
void func_224(int iParam0, var uParam1)//Position - 0x21573
{
	int iVar0;
	
	iVar0 = func_147(iParam0, func_16(uParam1));
	iVar0++;
	func_145(iParam0, iVar0, uParam1, 1);
}

void func_225(int iParam0, bool bParam1, int iParam2)//Position - 0x2159A
{
	if (iParam2 == -1)
	{
		iParam2 = func_17();
...
int func_227(int iParam0, int iParam1)//Position - 0x215D4
{
	var uVar0;
	int iVar1;
...
int func_228(var uParam0, char* sParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)//Position - 0x21603
{
	struct<89> Var0;
	var* uVar89;
	var* uVar90;
	...
	*sParam1 = { Var0 };
	...
	sParam1->f_56 = { func_112(iVar91) };
	sParam1->f_59 = { func_111(iVar91, "cam") };
	sParam1->f_62 = { func_110(iVar91) };
	...
	sParam1->f_73 = func_108(NETWORK::UGC_GET_CONTENT_RATING(uParam0->f_6, 0), NETWORK::UGC_GET_CONTENT_RATING_COUNT(uParam0->f_6, 0));
	...
	if (func_107() != 2)
	{
		if (sParam1->f_71 > Global_262145.f_4270 /* Tunable: MAX_NG_TRANSITION_SESSION_SIZE */)
		{
			sParam1->f_71 = Global_262145.f_4270 /* Tunable: MAX_NG_TRANSITION_SESSION_SIZE */;
		}
		if (sParam1->f_69 > Global_262145.f_4270 /* Tunable: MAX_NG_TRANSITION_SESSION_SIZE */)
		{
			sParam1->f_69 = Global_262145.f_4270 /* Tunable: MAX_NG_TRANSITION_SESSION_SIZE */;
		}
	}
	if (DATAFILE::DATADICT_GET_TYPE(iVar91, "optbs") == 2)
	{
...
int func_229(struct<3> Param0)//Position - 0x21AF2
{
	if (((Param0.f_2 < 0f || func_231(Param0, 999, 2f)) || func_230(Param0)) || (Global_4718592.f_111859[0 /*65*/].f_2 < -2f && !BitTest(Global_4718592.f_111859[0 /*65*/].f_31, 5)))
	{
		return 1;
	}
	return 0;
...
int func_230(struct<3> Param0)//Position - 0x21B58
{
	int iVar0;
	...
	if (Global_2709834)
	{
		...
		while (iVar0 < 10)
		{
			if (OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, Global_2709834.f_1[iVar0 /*3*/], Global_2709834.f_32[iVar0 /*3*/], Global_2709834.f_63[iVar0], false, true))
			{
				return 1;
			}
			iVar0++;
...
int func_231(struct<3> Param0, int iParam3, float fParam4)//Position - 0x21CE6
{
	int iVar0;
	struct<3> Var1[3];
	struct<3> Var11[3];
	...
	else
	{
		...
		while (iVar0 <= 7)
		{
			if (func_231(Param0, iVar0, fParam4))
			{
				return 1;
			}
			iVar0++;
		...
		if (func_231(Param0, 8, fParam4))
		{
			return 1;
		}
		if (func_231(Param0, 17, fParam4))
		{
			return 1;
		}
	}
...
void func_232(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4)//Position - 0x2203A
{
	...
	if (!func_328())
	{
		uParam0->f_1804[iVar3 /*89*/].f_67 = func_106(uParam1->f_6);
	...
	uParam0->f_1804[iVar3 /*89*/].f_56 = { func_112(iVar2) };
	uParam0->f_1804[iVar3 /*89*/].f_59 = { func_111(iVar2, "cam") };
	uParam0->f_1804[iVar3 /*89*/].f_62 = { func_110(iVar2) };
	...
	{
		uParam0->f_1804[iVar3 /*89*/].f_71 = func_109();
	}
	...
	if (MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_3[iVar3 /*6*/])) || MISC::ARE_STRINGS_EQUAL(&(uParam0->f_3[iVar3 /*6*/]), "Verified"))
	{
		if (uParam0->f_1804[iVar3 /*89*/].f_81 == 3 || uParam0->f_1804[iVar3 /*89*/].f_81 == 4)
		{
			StringCopy(&(uParam0->f_3[iVar3 /*6*/]), func_247(), 24);
		}
		else if (uParam0->f_1804[iVar3 /*89*/].f_81 == 5 || uParam0->f_1804[iVar3 /*89*/].f_81 == 6)
		{
			StringCopy(&(uParam0->f_3[iVar3 /*6*/]), func_246(), 24);
		}
	}
	...
	if (!func_328())
	{
		uParam0->f_1804[iVar3 /*89*/].f_73 = func_108(NETWORK::UGC_GET_CONTENT_RATING(uParam1->f_6, 0), NETWORK::UGC_GET_CONTENT_RATING_COUNT(uParam1->f_6, 0));
	...
	func_105(uParam0->f_1804[iVar3 /*89*/].f_65, &(uParam0->f_1804[iVar3 /*89*/].f_71), &(uParam0->f_1804[iVar3 /*89*/].f_69));
	...
	if (func_107() != 2)
	{
		if (uParam0->f_1804[iVar3 /*89*/].f_71 > Global_262145.f_4270 /* Tunable: MAX_NG_TRANSITION_SESSION_SIZE */)
		{
			uParam0->f_1804[iVar3 /*89*/].f_71 = Global_262145.f_4270 /* Tunable: MAX_NG_TRANSITION_SESSION_SIZE */;
		}
		if (uParam0->f_1804[iVar3 /*89*/].f_69 > Global_262145.f_4270 /* Tunable: MAX_NG_TRANSITION_SESSION_SIZE */)
		{
			uParam0->f_1804[iVar3 /*89*/].f_69 = Global_262145.f_4270 /* Tunable: MAX_NG_TRANSITION_SESSION_SIZE */;
		}
	}
	if (!bParam2)
	{
		func_244(uParam0->f_1804[iVar3 /*89*/].f_65, uParam0->f_1804[iVar3 /*89*/].f_68, BitTest(uParam0->f_1804[iVar3 /*89*/].f_76, 14), uParam0->f_1804[iVar3 /*89*/].f_70, 1);
		func_233(uParam0->f_1804[iVar3 /*89*/].f_65, uParam0->f_1804[iVar3 /*89*/].f_68, uParam0->f_1804[iVar3 /*89*/].f_70, 1);
	}
	uParam1->f_8++;
	if (DATAFILE::DATAFILE_GET_FILE_DICT(0) != 0)
	{
...
void func_233(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x22536
{
	...
	if (func_20())
	{
		if (iParam0 == 0)
		{
			...
			{
				if (func_238(PLAYER::PLAYER_ID()) < iParam2)
				{
					return;
				}
			}
		}
		iVar0 = func_237(iParam0, iParam1, bParam3);
		if (iVar0 == -1)
		{
			return;
		}
...
int func_236(var uParam0)//Position - 0x225D5
{
	int iVar0;
	var uVar1;
...
int func_242(int iParam0)//Position - 0x22DC2
{
	if (!func_243(iParam0))
	{
		return 0;
...
int func_243(var uParam0)//Position - 0x22DE1
{
	int iVar0;
...
void func_244(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)//Position - 0x22E03
{
	...
	if (iParam0 == 0)
	{
		if (((iParam1 != 6 && iParam1 != 5) && iParam1 != 4) && iParam1 != 9)
		{
			if (func_238(PLAYER::PLAYER_ID()) < iParam3)
			{
				return;
			}
		}
	...
	iVar0 = func_245(iParam0, iParam1, bParam4);
	if (iVar0 == -1)
	{
		return;
	}
...
void func_248(var uParam0, bool bParam1)//Position - 0x23009
{
	...
	if (func_328())
	{
		if (func_285(NETWORK::UGC_GET_CONTENT_ID(uParam0->f_6)))
		{
			if (DATAFILE::DATAFILE_GET_FILE_DICT(0) != 0)
			{
				DATAFILE::DATAFILE_DELETE(0);
	...
	if (Global_262145.f_8364 /* Tunable: TOGGLE_HEISTS_OFF */)
	{
	...
	Global_794744.f_4[uParam0->f_8 /*89*/].f_56 = { func_112(iVar2) };
	if (DATAFILE::DATADICT_GET_TYPE(iVar2, "optbs") == 2)
	{
	...
	Global_794744.f_4[uParam0->f_8 /*89*/].f_59 = { func_111(iVar2, "cam") };
	Global_794744.f_4[uParam0->f_8 /*89*/].f_62 = { func_110(iVar2) };
	if (!func_328())
	{
		if (NETWORK::UGC_IS_LANGUAGE_SUPPORTED(NETWORK::UGC_GET_CONTENT_LANGUAGE(uParam0->f_6)))
		{
	...
	if (func_328())
	{
		StringCopy(&(Global_794744.f_4[uParam0->f_8 /*89*/].f_6), func_279(), 64);
	}
	else
	{
	...
	if (!func_328())
	{
		Global_794744.f_4[uParam0->f_8 /*89*/].f_73 = func_108(NETWORK::UGC_GET_CONTENT_RATING(uParam0->f_6, 0), NETWORK::UGC_GET_CONTENT_RATING_COUNT(uParam0->f_6, 0));
	...
	if (Global_794744.f_4[uParam0->f_8 /*89*/].f_65 == 6 && !bParam1)
	{
		if (Global_1001983.f_684 < 85)
		{
			...
			Global_1001983[Global_1001983.f_684 /*3*/] = { func_111(iVar2, "area") };
	...
	Global_794744.f_135107[uParam0->f_8 /*13*/].f_2 = func_274(Global_794744.f_135107[uParam0->f_8 /*13*/].f_1, 1);
	...
	bVar95 = func_115(Global_794744.f_135107[uParam0->f_8 /*13*/].f_1);
	iVar96 = func_270(Global_794744.f_135107[uParam0->f_8 /*13*/].f_1);
	if (iVar96 != -1)
	{
		Global_1962962[iVar96] = uParam0->f_8;
	}
	...
	if (!bParam1 && !bVar95)
	{
		if (func_20())
		{
			func_244(Global_794744.f_4[uParam0->f_8 /*89*/].f_65, Global_794744.f_4[uParam0->f_8 /*89*/].f_68, BitTest(Global_794744.f_4[uParam0->f_8 /*89*/].f_76, 14), Global_794744.f_4[uParam0->f_8 /*89*/].f_70, 0);
			func_233(Global_794744.f_4[uParam0->f_8 /*89*/].f_65, Global_794744.f_4[uParam0->f_8 /*89*/].f_68, Global_794744.f_4[uParam0->f_8 /*89*/].f_70, 0);
			func_257(Global_794744.f_4[uParam0->f_8 /*89*/].f_65, Global_794744.f_4[uParam0->f_8 /*89*/].f_68, Global_794744.f_4[uParam0->f_8 /*89*/].f_75, Global_794744.f_4[uParam0->f_8 /*89*/].f_70, BitTest(Global_794744.f_4[uParam0->f_8 /*89*/].f_76, 14));
...
void func_249(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x23D10
{
	...
	if (!func_251(iParam0, iParam1, iParam2, &iVar0, iParam3))
	{
		return;
	}
...
int func_251(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4)//Position - 0x23DB7
{
	int iVar0;
	...
	if (func_238(PLAYER::PLAYER_ID()) < iParam4)
	{
		return 0;
	}
	iVar0 = func_252(iParam2);
	*uParam3 = 145;
	if (iVar0 != 0)
	{
		*uParam3 = iVar0;
...
int func_259(int iParam0, int iParam1)//Position - 0x24446
{
	if (iParam1 > 0)
	{
		return 1;
	}
	if ((((((((((((((((((((func_104(iParam0) || func_103(iParam0)) || func_102(iParam0)) || func_99(iParam0, 1, 1)) || func_101(iParam0)) || func_98(iParam0)) || func_97(iParam0)) || func_96(iParam0)) || func_95(iParam0)) || func_94(iParam0)) || func_93(iParam0)) || func_92(iParam0)) || func_91(iParam0)) || func_90(iParam0)) || func_89(iParam0)) || func_87(iParam0)) || func_86(iParam0)) || func_84(iParam0)) || func_88(iParam0)) || func_261(iParam1)) || func_260(iParam1))
	{
		return 1;
	}
	return 0;
...
void func_262(int iParam0, int iParam1)//Position - 0x24572
{
	...
	while (iVar0 < 8)
	{
		if (iParam0 == Global_262145.f_9530[iVar0])
		{
			...
			Global_794744.f_4[iParam1 /*89*/].f_56 = { func_265(0, iVar0) };
			Global_794744.f_4[iParam1 /*89*/].f_59 = { func_264(0, iVar0) };
			Global_794744.f_4[iParam1 /*89*/].f_62 = { func_263(0, iVar0) };
		...
		else if (iParam0 == Global_262145.f_9539[iVar0])
		{
			Global_794744.f_135107[iParam1 /*13*/].f_12 = 0;
			Global_794744.f_4[iParam1 /*89*/].f_68 = 8;
			Global_794744.f_4[iParam1 /*89*/].f_75 = 0;
...
int func_274(int iParam0, int iParam1)//Position - 0x24AE9
{
	int iVar0;
	int iVar1;
...
{
	if (Global_262145.f_4724[0] /* Tunable: VCM_FLOW_ROOTCONTENT_ID_0 */ == 0)
	{
...
int func_276(int iParam0)//Position - 0x24DA7
{
	int iVar0;
...
int func_278(int iParam0)//Position - 0x24E39
{
	int iVar0;
...
void func_280(bool bParam0)//Position - 0x24E78
{
	func_281(joaat("MPPLY_BIG_FEED_INIT"), bParam0);
}

void func_281(int iParam0, bool bParam1)//Position - 0x24E8B
{
	int iVar0;
...
int func_285(char* sParam0)//Position - 0x25179
{
...
int func_286(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var* uParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x25293
{
	switch (iParam0)
	{
		case 0:
			...
			{
				if (NETWORK::UGC_QUERY_MY_CONTENT(iParam1, iParam6, func_288(iParam3), 0, iParam8, iParam7))
				{
					return 1;
				}
			}
			else if (NETWORK::UGC_GET_MY_CONTENT(iParam1, iParam6, func_288(iParam3), uParam5))
			{
				return 1;
			}
			break;
		...
		case 1:
			if (NETWORK::UGC_QUERY_MY_CONTENT(iParam1, iParam6, func_288(iParam3), 1, iParam8, iParam7))
			{
				return 1;
			}
			break;
		...
		case 2:
			if (NETWORK::UGC_QUERY_MY_CONTENT(iParam1, iParam6, func_288(iParam3), 2, iParam8, iParam7))
			{
				return 1;
			}
			break;
		...
		case 3:
			if (NETWORK::UGC_GET_FRIEND_CONTENT(iParam1, iParam6, func_288(iParam3), uParam5))
			{
				return 1;
			}
			break;
		...
		case 4:
			if (iParam4 == -1)
			{
				iParam4 = func_287(PLAYER::PLAYER_ID());
			}
			if (NETWORK::UGC_GET_CREW_CONTENT(iParam4, iParam1, iParam6, func_288(iParam3), uParam5))
			{
				return 1;
			}
			break;
		...
		case 5:
			...
			{
				if (NETWORK::UGC_QUERY_BY_CATEGORY(iParam2, iParam1, iParam6, func_288(iParam3), 0, false))
				{
					return 1;
				}
			}
			else if (NETWORK::UGC_GET_GET_BY_CATEGORY(iParam2, iParam1, iParam6, func_288(iParam3), uParam5))
			{
				return 1;
			}
			break;
		...
		case 6:
			if (NETWORK::UGC_GET_TOP_RATED_CONTENT(iParam1, iParam6, func_288(iParam3), uParam5))
			{
				return 1;
			}
			break;
		...
		case 7:
			if (NETWORK::UGC_GET_MOST_RECENTLY_PLAYED_CONTENT(iParam1, iParam6, func_288(iParam3), uParam5))
			{
				return 1;
			}
			break;
		...
		case 8:
			if (NETWORK::UGC_GET_BOOKMARKED_CONTENT(iParam1, iParam6, func_288(iParam3), uParam5))
			{
				return 1;
			}
			break;
		...
		case 9:
			if (iParam3 == 4)
			{
				if (NETWORK::UGC_QUERY_MOST_RECENTLY_CREATED_CONTENT(iParam1, iParam6, func_288(iParam3), iParam7))
				{
					return 1;
				}
			}
			else if (NETWORK::UGC_GET_MOST_RECENTLY_CREATED_CONTENT(iParam1, iParam6, func_288(iParam3), uParam5))
			{
				return 1;
			}
			break;
...
int func_287(int iParam0)//Position - 0x254BA
{
	struct<13> Var0;
	var uVar13;
...
void func_292(var uParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x256B8
{
	int iVar0;
	struct<89> Var1;
...
void func_293(var uParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)//Position - 0x25707
{
	int iVar0;
	struct<89> Var1;
...
void func_298(var uParam0)//Position - 0x258C8
{
	uParam0->f_1 = 0;
}
...
int func_303(var uParam0)//Position - 0x25949
{
	struct<13> Var0;
	var* uVar13;
	int iVar14;
	...
	switch (*uParam0)
	{
		...
		case 1:
			if (NETWORK::UGC_GET_CREATORS_BY_USER_ID(&(uParam0->f_1), func_288(0)))
			{
				*uParam0++;
			}
			break;
...
void func_305(int iParam0, int iParam1)//Position - 0x25A2C
{
	var uVar0;
	int iVar1;
...
struct<13> func_306()//Position - 0x25A4C
{
	struct<13> Var0;
...
void func_307(int iParam0, int iParam1)//Position - 0x25A61
{
	int iVar0;
	int iVar1;
	struct<89> Var2;
	...
	while (iVar1 <= 30)
	{
		if (BitTest(Global_982384.f_4[iVar1 /*89*/].f_76, 13))
		{
			...
			{
				if (iVar0 < 1500 && func_308(Global_982384.f_4[iVar1 /*89*/].f_56, Global_794744.f_4[iVar0 /*89*/].f_56, 1082130432))
				{
			...
			if (iParam0 == 0)
			{
				...
				while (iVar0 <= 299)
				{
					if (func_308(Global_982384.f_4[iVar1 /*89*/].f_56, Global_949659.f_1804[iVar0 /*89*/].f_56, 1082130432))
					{
						Global_982384.f_4[iVar1 /*89*/] = { Var2 };
					}
					iVar0++;
...
int func_308(struct<2> Param0, var uParam2, struct<3> Param3, float fParam6)//Position - 0x25B56
{
	if (!func_69(Param3))
	{
...
int func_310()//Position - 0x25BC7
{
	...
	if ((((((func_226(32, -1) || iVar3 > 0) || iVar1 > 0) || iVar2 > 0) || iVar4 > 0) || iVar5 > 0) || iVar6 > 0)
	{
		iVar0 = 1;
	}
	return iVar0;
...
void func_311(var uParam0, int iParam1)//Position - 0x25C53
{
	int iVar0;
	int iVar1;
	struct<89> Var2;
	...
	while (iVar1 <= 299)
	{
		if (BitTest(Global_949659.f_1804[iVar1 /*89*/].f_76, 13))
		{
			...
			while (iVar0 <= (iParam1 - 1))
			{
				...
				{
					if (func_308(Global_794744.f_4[iVar0 /*89*/].f_56, Global_949659.f_1804[iVar1 /*89*/].f_56, 1082130432))
					{
...
bool func_312(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x25D13
{
	...
	return func_47(uParam0, &(Global_1835437.f_1), 5, iParam1, iVar0, iParam2, iParam3, -1, 0, 1, 0, 0, -1);
}
...
int func_319(var uParam0)//Position - 0x25DBB
{
	int iVar0;
	...
	if (Global_262145.f_3675 /* Tunable: DISABLE_UGC_PLANNING_CACHE */ == 1)
	{
		return 1;
	}
	switch (uParam0->f_3)
	{
		...
		case 25:
			...
			while (iVar0 <= 63)
			{
				if (iVar0 < 35)
				{
					Global_1050156.f_1195[iVar0 /*6*/] = { func_326((iVar0 + uParam0->f_11)) };
		...
		case 1:
			if (NETWORK::UGC_QUERY_BY_CONTENT_IDS(&(Global_1050156.f_1195), uParam0->f_12, true, func_288(0)))
			{
				func_35(uParam0, 3);
			}
			break;
		...
		case 26:
			if (func_320(uParam0) || func_49(&(uParam0->f_32), 45000, 0))
			{
...
bool func_320(var uParam0)//Position - 0x26125
{
	...
	while (iVar0 <= uParam0->f_11 + 63)
	{
		if (iVar0 < 35)
		{
			...
			{
				if (!func_323(Global_786550.f_1[iVar0 /*89*/].f_54, &(Global_786550.f_3573[iVar0 /*132*/].f_129)))
				{
					bVar1 = false;
				}
	...
	if (bVar1)
	{
		...
		while (iVar0 <= uParam0->f_11 + 63)
		{
			if (iVar0 < 35)
			{
				...
				iVar5 = 0;
				bVar6 = false;
				sVar2 = func_321(Global_786550.f_1[iVar0 /*89*/].f_54, 500);
...
char* func_321(int iParam0, int iParam1)//Position - 0x26271
{
	if (iParam0 == -1)
	{
		return func_322();
...
char* func_322()//Position - 0x26291
{
	return HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION("CREATOR_NO_T" /* GXT: No translation. */);
}

int func_323(int iParam0, var uParam1)//Position - 0x262A1
{
	if (*uParam1 != iParam0)
	{
		if (*uParam1 != 0)
...
void func_324(var uParam0)//Position - 0x2634C
{
	...
	Global_786550.f_1[(uParam0->f_8 + uParam0->f_11) /*89*/].f_56 = { func_112(iVar2) };
	if (DATAFILE::DATADICT_GET_TYPE(iVar2, "optbs") == 2)
	{
	...
	Global_786550.f_1[(uParam0->f_8 + uParam0->f_11) /*89*/].f_59 = { func_111(iVar2, "cam") };
	Global_786550.f_1[(uParam0->f_8 + uParam0->f_11) /*89*/].f_62 = { func_110(iVar2) };
	if (!func_328())
	{
		if (NETWORK::UGC_IS_LANGUAGE_SUPPORTED(NETWORK::UGC_GET_CONTENT_LANGUAGE(uParam0->f_6)))
		{
	...
	if (func_328())
	{
		StringCopy(&(Global_786550.f_1[(uParam0->f_8 + uParam0->f_11) /*89*/].f_6), func_279(), 64);
	}
	else
	{
	...
	if (!func_328())
	{
		Global_786550.f_1[(uParam0->f_8 + uParam0->f_11) /*89*/].f_73 = func_108(NETWORK::UGC_GET_CONTENT_RATING(uParam0->f_6, 0), NETWORK::UGC_GET_CONTENT_RATING_COUNT(uParam0->f_6, 0));
...
void func_325(var uParam0, bool bParam1, bool bParam2)//Position - 0x26939
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
	{
		if (!bParam2)
...
bool func_329(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x26BB8
{
	...
	return func_47(uParam0, &Global_1835437, 5, iParam1, iVar0, iParam2, iParam3, -1, 0, 1, 0, 0, -1);
}

int func_330(int iParam0)//Position - 0x26BE6
{
	if (MISC::IS_PS3_VERSION() || (func_332() && iParam0 == 0))
	{
...
int func_331()//Position - 0x26C3F
{
	...
	if ((func_332() && NETWORK::NETWORK_HAS_AGE_RESTRICTIONS() == 0) && NETWORK::NETWORK_HAVE_ONLINE_PRIVILEGES())
	{
		return 1;
	}
	if (func_61() && NETWORK::NETWORK_HAVE_ONLINE_PRIVILEGES())
	{
		return 1;
	}
