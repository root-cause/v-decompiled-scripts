...
int func_58(int iParam0, bool bParam1, char* sParam2, int iParam3)//Position - 0x1977
{
	...
	if (iParam0 == 0)
	{
		...
		else if (func_59())
		{
			...
			else if ((NETWORK::_0x559EBF901A8C68E0(&Var0) && NETWORK::NETWORK_HAS_VIEW_GAMER_USER_CONTENT_RESULT(&Var0)) && !NETWORK::NETWORK_CAN_VIEW_GAMER_USER_CONTENT(&Var0))
			{
				return 0;
			}
		}
...
void func_64(var uParam0, bool bParam1)//Position - 0x1D85
{
	...
	if (func_102() != 2)
	{
		if (Global_1036842.f_33[uParam0->f_9 /*88*/].f_71 > Global_262145.f_4605)
		{
			Global_1036842.f_33[uParam0->f_9 /*88*/].f_71 = Global_262145.f_4605;
		}
		if (Global_1036842.f_33[uParam0->f_9 /*88*/].f_69 > Global_262145.f_4605)
		{
			Global_1036842.f_33[uParam0->f_9 /*88*/].f_69 = Global_262145.f_4605;
		}
	}
...
int func_212(var uParam0, char* sParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)//Position - 0x217DB
{
	...
	*sParam1 = { Var0 };
	...
	if (func_102() != 2)
	{
		if (sParam1->f_71 > Global_262145.f_4605)
		{
			sParam1->f_71 = Global_262145.f_4605;
		}
		if (sParam1->f_69 > Global_262145.f_4605)
		{
			sParam1->f_69 = Global_262145.f_4605;
		}
	}
	if (DATAFILE::DATADICT_GET_TYPE(iVar3, "optbs") == 2)
	{
...
int func_214(struct<3> Param0)//Position - 0x21D27
{
	...
	if (OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, 986.8618f, 74.74512f, 115.0391f, 975.716f, 57.44831f, 118.0387f, 14.5625f, false, true))
	{
		return 1;
	}
	if (OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, 1093.315f, 219.7407f, -50.98997f, 1084.527f, 219.227f, -45.92859f, 8.75f, false, true))
	{
		return 1;
	}
...
void func_216(var uParam0, var uParam1, bool bParam2, int iParam3)//Position - 0x22208
{
	...
	if (!func_307())
	{
		...
		MISC::_SET_CONTENT_MAP_INDEX(uParam0->f_9405[uParam1->f_9 /*13*/].f_1, uParam1->f_9 + 2018);
	}
	if (func_102() != 2)
	{
		if (uParam0->f_604[uParam1->f_9 /*88*/].f_71 > Global_262145.f_4605)
		{
			uParam0->f_604[uParam1->f_9 /*88*/].f_71 = Global_262145.f_4605;
		}
		if (uParam0->f_604[uParam1->f_9 /*88*/].f_69 > Global_262145.f_4605)
		{
			uParam0->f_604[uParam1->f_9 /*88*/].f_69 = Global_262145.f_4605;
		}
	}
	if (!bParam2)
	{
...
void func_232(var uParam0, bool bParam1)//Position - 0x22E63
{
	...
	if (!func_307())
	{
		...
		MISC::_SET_CONTENT_MAP_INDEX(Global_794709.f_177589[uParam0->f_9 /*13*/].f_1, uParam0->f_9);
	}
...
int func_265(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var* uParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x24EC4
{
	switch (iParam0)
	{
		...
		case 5:
			...
			{
				if (NETWORK::_0x692D58DF40657E8C(iParam2, iParam1, iParam6, func_267(iParam3), 0, false))
				{
					return 1;
				}
			}
...
int func_282(var uParam0)//Position - 0x25584
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			if (NETWORK::_0xB746D20B17F2A229(&(uParam0->f_1), func_267(0)))
			{
				*uParam0++;
			}
			break;
...
int func_310()//Position - 0x2687A
{
	...
	if ((func_311() && NETWORK::_NETWORK_HAS_AGE_RESTRICTED_PROFILE() == 0) && NETWORK::NETWORK_HAVE_ONLINE_PRIVILEGES())
	{
		return 1;
	}
