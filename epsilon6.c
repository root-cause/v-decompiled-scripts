...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_119 = 350f;
	iLocal_120 = 5;
	Local_121 = { 1720.961f, 3254.951f, 42.5f };
	Local_122 = { 1620.34f, 3228.95f, 37.65051f };
	iLocal_127 = -1;
	...
	if (func_490())
	{
		...
		{
			case 0:
				func_472(-2907.29f, 3215.91f, 9.866f, 215.2019f, 1, 0);
				break;
			...
			else
			{
				...
				if (func_242())
				{
					if (func_241(PLAYER::PLAYER_PED_ID(), Local_54.f_0, 1) > 300f && !ENTITY::IS_ENTITY_ON_SCREEN(Local_54.f_0))
					{
						...
						TASK::TASK_PLANE_MISSION(0, Local_54.f_0, 0, 0, 3891.478f, 2298.554f, 301.6707f, 4, 40f, 10f, -1f, 4.203895E-43f, 4.203895E-44f, true);
						TASK::TASK_PLANE_MISSION(0, Local_54.f_0, 0, 0, 1562.099f, 2167.677f, 329.9366f, 4, 40f, 10f, -1f, 4.203895E-43f, 1.401298E-43f, true);
...
void func_272()//Position - 0x28CF8
{
	...
	switch (iLocal_69)
	{
		...
		case 4:
			...
			if (iLocal_127 == -1)
			{
				iLocal_127 = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(1687.954f, 3277.727f, 40.25f, 6f, 6f, 6f, 0f, false, 7);
	...
	switch (iLocal_69)
	{
		case 0:
			if (func_481(Local_62.f_0))
			{
				...
				ENTITY::SET_ENTITY_COORDS(Local_62.f_0, -2881.755f, 3188.125f, 10.1136f, true, false, false, true);
			...
			{
				func_4(&Local_62);
				Local_62.f_0 = PED::CREATE_PED(26, iLocal_626, -2881.755f, 3188.125f, 10.1136f, 254.1723f, true, true);
...
void func_286()//Position - 0x298FD
{
	switch (iLocal_69)
	{
		...
		case 2:
			...
			{
				Local_54.f_0 = VEHICLE::CREATE_VEHICLE(iLocal_625, 595.7562f, 2926.42f, 173.2301f, 283.3833f, false, false, false);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_54.f_0, 5f);
				VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_54.f_0);
				VEHICLE::SET_VEHICLE_COLOURS(Local_54.f_0, 157, 157);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(Local_54.f_0, 157, 5);
...
void func_295()//Position - 0x2A270
{
	switch (iLocal_69)
	{
		case 0:
			...
			if (!func_271())
			{
				func_287(PLAYER::PLAYER_PED_ID(), -2914.707f, 3234.639f, 9.7863f, 215.2149f, 0, 1);
			}
			break;
	...
	switch (iLocal_70)
	{
		case 0:
			...
			if (func_397(1, 1093140480, 0))
			{
				...
				func_289(&iLocal_126);
				func_389(1679.917f, 3270.735f, 39.34466f, 1697.999f, 3281.172f, 44.14951f, 7.75f, 1530.862f, 3767.051f, 33.0489f, 304.28f, func_395(), 1, 1, 1, 0, 0);
				func_386(1525.085f, 3772.686f, 33.5119f, 1, 0, 1, 1, 1, 1, 1, 1, 1, 1);
	...
	switch (iLocal_73)
	{
		...
		case 4:
			if (iLocal_74 == 0)
			{
				if (func_482(Local_62.f_0))
				{
					if (func_424(Local_62.f_0, -2884.934f, 3200.156f, 10.7036f, 1) > 2f)
					{
						TASK::CLEAR_PED_TASKS(Local_62.f_0);
						...
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -2884.934f, 3200.156f, 10.7036f, 1f, 20000, 0.25f, 0, 40000f);
...
int func_485(var uParam0)//Position - 0x36DB4
{
	...
	switch (iLocal_49)
	{
		...
		case 2:
			...
			func_486(&(uParam0->f_28[0]), iVar0[1], -2881.755f, 3188.125f, 10.1136f, 254.1723f, 26);
