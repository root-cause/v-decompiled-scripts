...
void func_6()//Position - 0x25A
{
	...
	{
		while (!BitTest(Global_1836588, 1))
		{
...
int func_14(var uParam0)//Position - 0xCC1
{
	...
	ENTITY::SET_ENTITY_INVINCIBLE(iLocal_23[iLocal_20], true, false);
	if (uParam0->f_6 == -1)
	{
...
void func_16(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x34E7
{
	int iVar0;
	float fVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		if ((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iParam0)) || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			func_82(iParam0, uParam1, bParam2, bParam3);
			if (uParam1->f_102 != 0)
			{
				if (uParam1->f_102 == 2)
				{
			...
			{
				if (BitTest(uParam1->f_103, 0) || func_79(ENTITY::GET_ENTITY_MODEL(iParam0)))
				{
					VEHICLE::SET_VEHICLE_ALLOW_HOMING_MISSLE_LOCKON_SYNCED(iParam0, false, true);
					func_78(iParam0);
				}
...
bool func_17(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)//Position - 0x3A12
{
...
int func_19(int iParam0)//Position - 0x3A3C
{
	switch (iParam0)
	{
		case joaat("coureur"):
...
int func_20(int iParam0)//Position - 0x3A71
{
	switch (iParam0)
	{
		case joaat("pounder2"):
...
void func_21(int iParam0)//Position - 0x3B78
{
	struct<3> Var0;
...
void func_22(struct<3> Param0)//Position - 0x3C07
{
	struct<4> Var0;
...
var func_23(int iParam0, bool bParam1)//Position - 0x3C48
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool func_24(int iParam0, int iParam1)//Position - 0x3CAD
{
	bool bVar0;
...
int func_27(var uParam0)//Position - 0x3D53
{
	int iVar0;
...
int func_28(int iParam0, bool bParam1, bool bParam2)//Position - 0x3D75
{
	int iVar0;
...
int func_29(int iParam0)//Position - 0x3DD5
{
	int iVar0;
...
int func_31(int iParam0, int iParam1, bool bParam2)//Position - 0x3E20
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_33(int iParam0, var uParam1)//Position - 0x3EAF
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_34(uParam1));
}

int func_34(var uParam0)//Position - 0x3EC4
{
	int iVar0;
	int iVar1;
...
int func_39(int iParam0, var* uParam1)//Position - 0x470F
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x478C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_41(int iParam0)//Position - 0x4819
{
	int iVar0;
...
int func_42(int iParam0, int iParam1)//Position - 0x4879
{
	func_46();
	...
	func_44(*iParam0, &Global_1943806, &(Global_1943806.f_1), &(Global_1943806.f_4), &(Global_1943806.f_7), &(Global_1943806.f_10));
	...
	{
		if (func_43(iParam0, iParam1, Global_1943806, Global_1943806.f_1, Global_1943806.f_4, Global_1943806.f_7, Global_1943806.f_10, 0, Global_1943806.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
	...
	else
	{
		...
		if (((Global_1943806.f_23 == 0 && func_43(iParam0, iParam1, Global_1943806, Global_1943806.f_1, Global_1943806.f_4, Global_1943806.f_7, Global_1943806.f_10, 0, Global_1943806.f_13)) || Global_1943806.f_23 != 0) && ((Global_1943806.f_24 == 0 && func_43(iParam0, iParam1, Global_1943806, Global_1943806.f_14, Global_1943806.f_17, Global_1943806.f_20, Global_1943806.f_10, 1, Global_1943806.f_13)) || Global_1943806.f_24 != 0))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				Global_1577965 = NETWORK::GET_NETWORK_TIME();
...
bool func_43(var uParam0, int iParam1, int iParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, int iParam13, int iParam14)//Position - 0x4B24
{
...
int func_44(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x4B4D
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		return 0;
	...
	*uParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iParam0, "chassis_dummy");
	if (((!func_45(Global_1943832, 0f, 0f, 0f, 0) && !func_45(Global_1943835, 0f, 0f, 0f, 0)) && !func_45(Global_1943838, 0f, 0f, 0f, 0)) && !Global_1943841 == 0f)
	{
...
bool func_45(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xA865
{
	if (bParam6)
	{
...
int func_47(int iParam0)//Position - 0xA925
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
...
int func_48(int iParam0)//Position - 0xA95D
{
	int iVar0;
...
int func_49(int iParam0, var* uParam1)//Position - 0xA9A8
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	{
		iVar2 = Global_2359296[func_56() /*5571*/].f_681.f_2;
...
int func_50(int iParam0)//Position - 0xAB05
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return 1;
...
int func_51(int iParam0)//Position - 0xAE44
{
...
int func_54(int iParam0, int iParam1)//Position - 0xAEB3
{
	if (func_27(iParam0))
	{
...
int func_58(int iParam0, bool bParam1)//Position - 0xAF42
{
...
int func_60(int iParam0, int iParam1)//Position - 0xAFAF
{
	if (func_27(iParam0))
	{
...
int func_61(int iParam0, bool bParam1)//Position - 0xAFFE
{
	var uVar0;
	int iVar1;
...
var func_63(int iParam0)//Position - 0xB069
{
	var uVar0;
...
int func_64(var uParam0)//Position - 0xB080
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0xB0BA
{
	if (iParam0 != func_109())
	{
		if (func_67(iParam0) && Global_2657991[iParam0 /*467*/].f_324.f_11 == iParam0)
		{
			return 1;
		}
	}
...
int func_67(int iParam0)//Position - 0xB0EF
{
	if (iParam0 != func_109())
	{
		if (func_28(iParam0, 1, 1))
		{
			...
			{
				return func_68(Global_2657991[iParam0 /*467*/].f_324.f_8) == 22;
			}
		}
	}
	return 0;
...
void func_69(int iParam0, int iParam1)//Position - 0xB652
{
	int iVar0;
	int iVar1;
...
struct<13> func_74()//Position - 0xBBFD
{
	struct<13> Var0;
...
int func_75(int iParam0)//Position - 0xBC12
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("deathbike2"):
...
void func_77(int iParam0)//Position - 0xBF34
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_78(int iParam0)//Position - 0xBF69
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", 2))
...
int func_79(int iParam0)//Position - 0xBFA0
{
	switch (iParam0)
	{
		case joaat("jester5"):
...
int func_80(int iParam0)//Position - 0xBFBD
{
...
int func_81(int iParam0)//Position - 0xC533
{
	switch (iParam0)
	{
		case joaat("deity"):
...
void func_82(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0xC5C2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_83(int iParam0, float fParam1)//Position - 0xCCC7
{
	struct<3> Var0;
	float fVar3;
...
int func_86(var uParam0)//Position - 0xCDE1
{
	int iVar0;
...
int func_87(int iParam0)//Position - 0xCE05
{
	int iVar0;
...
var func_88(int iParam0, int iParam1)//Position - 0xCE23
{
...
var func_90(var uParam0, var uParam1)//Position - 0xCE4F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_91(int iParam0, var uParam1, var uParam2)//Position - 0xCE72
{
	int iVar0;
	int iVar1;
...
int func_92(int iParam0)//Position - 0xD04B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_94(int iParam0, int iParam1)//Position - 0xD17E
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_95(int iParam0, int iParam1)//Position - 0xD267
{
	int iVar0;
...
int func_96(int iParam0)//Position - 0xD2C9
{
...
int func_97(int iParam0, int iParam1)//Position - 0xD2F4
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_98(int iParam0, int iParam1, int iParam2)//Position - 0xD6D3
{
...
int func_99()//Position - 0xD6F7
{
	return 0;
}

void func_100(int iParam0, int iParam1)//Position - 0xD700
{
	int iVar0;
	int iVar1;
...
int func_101(int iParam0)//Position - 0xD778
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_103(int iParam0)//Position - 0xD7A9
{
	int iVar0;
...
int func_104(int iParam0)//Position - 0xD7F1
{
...
int func_105(int iParam0)//Position - 0xD811
{
	switch (iParam0)
	{
		case 161:
...
int func_107(int iParam0)//Position - 0xD914
{
...
int func_108(int iParam0, int iParam1)//Position - 0xD99B
{
	int iVar0;
...
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_creator")) == 0 || Global_1836593 == 0)
	{
		iLocal_18 = 3;
	}
	if (iLocal_19 != 0)
