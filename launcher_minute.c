...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_52 = func_298(56);
	iLocal_53 = func_298(57);
	iLocal_54 = func_298(59);
	...
	if (!func_275(&iVar2, &Var0, Var1, 1f))
	{
		func_274();
	...
	while (true)
	{
		...
		func_208(Var0.f_0);
		func_201(&iLocal_56, &(Var0.f_9), Var1);
		if (Var0.f_0 == 32)
		{
			func_197(&Var0, Var1, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_59);
		}
		else if (Var0.f_0 == 34)
		{
			func_192(&Var0, Var1, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
		}
		if (func_178(&Var0, 0))
		{
			if (func_177(Var0.f_0))
			{
				func_174(Var0.f_0, &iLocal_58);
			}
			if (!func_2(&Var0))
			{
				func_278(&Var0, 1);
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5DC5
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x6588
{
	if (bParam2)
	{
...
int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6A4F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_84(struct<3> Param0, float fParam1)//Position - 0x770C
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
int func_175(struct<3> Param0, bool bParam1)//Position - 0xC0EA
{
	int iVar0;
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xD346
{
	var uVar0;
	
	if ((((func_132(PLAYER::PLAYER_PED_ID()) && func_132(iParam0->f_28[0])) && !func_151()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_196(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xD4FA
{
	struct<3> Var0;
...
int func_197(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)//Position - 0xD534
{
	var uVar0;
		...
		if (func_183(2))
		{
			if (!func_151())
			{
				if (((func_132(PLAYER::PLAYER_PED_ID()) && func_132(iParam0->f_28[0])) && func_132(iParam0->f_28[1])) && func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
					...
					{
						func_195(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
						func_195(&uVar0, iParam6, iParam0->f_28[1], sParam7, 0, 1);
						func_193(&uVar0, cParam2, sParam3, 7, 0, 0);
						*uParam8 = 2;
					}
					else if (*uParam8 == 2)
			...
			else if (((func_199(sParam3) && !*uParam8 == 1) && func_132(PLAYER::PLAYER_PED_ID())) && func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
			{
				func_295("pause conversation");
				func_198(1);
				*uParam8 = 1;
			}
			if (func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
int func_212(struct<2> Param0, float fParam1, struct<2> Param2, Vector3 vParam3, float fParam4)//Position - 0xDDD3
{
	if (fParam4 < 0f)
	{
		fParam4 = 0f;
...
bool func_227(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEA7A
{
	...
	uVar0 = func_228(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_228(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xEB3B
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_231(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xED76
{
	...
	{
		Var1 = { func_233(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_232(struct<3> Param0, struct<3> Param1)//Position - 0xEE07
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_240(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xF185
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
void func_253(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xF802
{
	func_254(iParam0);
...
int func_255(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xF8E0
{
	if (func_256(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_256(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xF93C
{
	int iVar0;
...
void func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xFA10
{
	func_211(iParam0);
...
int func_275(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x1033F
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_276((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_276((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_276(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0x103A4
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_277(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_277(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x1041C
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
