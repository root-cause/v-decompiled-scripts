...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_92 = func_298(56);
	iLocal_93 = func_298(57);
	iLocal_94 = func_298(59);
	...
	while (true)
	{
		...
		{
			func_214();
			if (func_213(Var0.f_35[1]))
			{
				if (!func_212(329.513f, 3402.691f, 36.258f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[1], true), 1056964608))
				{
					func_295("Player has moved SURFER2 vehicle [TERMINATING]");
					func_209(&Var0);
					func_278(&Var0, 1);
				}
			}
		...
		if (Var0.f_0 == 32)
		{
			func_197(&Var0, Var61, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_99);
		}
		else if (Var0.f_0 == 34)
		{
			func_192(&Var0, Var61, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
		}
		if (func_178(&Var0, 0))
		{
			if (func_177(Var0.f_0))
			{
				func_174(Var0.f_0, &iLocal_98);
			}
			if (!func_2(&Var0))
			{
				func_278(&Var0, 1);
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x39DC
{
	int iVar0;
	var uVar1;
...
int func_50(var uParam0)//Position - 0x3A19
{
	int iVar0;
	int iVar1;
...
int func_51()//Position - 0x3A4D
{
	return Global_1574918;
}

int func_52(int iParam0, int iParam1)//Position - 0x3A59
{
	int iVar0;
	var uVar1;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3A85
{
	int iVar0;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3FCE
{
	int iVar0;
...
int func_55()//Position - 0x4210
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_56()//Position - 0x4229
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x4326
{
	return Global_43257 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x4334
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x4427
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x46AF
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x4750
{
...
int func_62(int iParam0, int iParam1)//Position - 0x492A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x558B
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x55C6
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x583A
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x5876
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5DC5
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5E09
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6588
{
	if (bParam6)
	{
...
int func_70(var uParam0)//Position - 0x65CF
{
...
bool func_71(int iParam0)//Position - 0x662A
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x663A
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x669B
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x6A34
{
	return Global_32163;
}

int func_75(int iParam0)//Position - 0x6A3F
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A4F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x6AF1
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_78()//Position - 0x7241
{
...
int func_79()//Position - 0x753C
{
	return Global_2652258.f_2650;
}

int func_80(struct<3> Param0)//Position - 0x754B
{
...
int func_81(int iParam0)//Position - 0x7575
{
	if (iParam0 != func_90())
	{
...
Vector3 func_82(int iParam0, int iParam1)//Position - 0x75CD
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_83(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7677
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_84(struct<3> Param0, float fParam3)//Position - 0x770C
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_85(int iParam0)//Position - 0x7750
{
	struct<6> Var0;
...
struct<6> func_86(int iParam0)//Position - 0x78D4
{
	return func_87(iParam0);
}

struct<6> func_87(int iParam0)//Position - 0x78E2
{
	struct<6> Var0;
...
int func_88(int iParam0, var uParam1)//Position - 0x83AD
{
	switch (iParam0)
	{
		case 0:
...
int func_89(int iParam0)//Position - 0x842F
{
	if (iParam0 != func_90())
	{
...
int func_90()//Position - 0x8487
{
	return -1;
}

Vector3 func_91(int iParam0)//Position - 0x8490
{
	switch (iParam0)
	{
		case 1:
...
int func_92()//Position - 0x8707
{
	return func_93(PLAYER::PLAYER_ID());
}

int func_93(int iParam0)//Position - 0x8717
{
	return MISC::GET_BITS_IN_RANGE(Global_2657589[iParam0 /*466*/].f_321.f_3, 28, 31);
}

int func_94(int iParam0)//Position - 0x8734
{
	return func_72(iParam0, 0, 0);
}

int func_95(int iParam0)//Position - 0x8744
{
	switch (iParam0)
	{
		case -1:
...
bool func_96()//Position - 0x8A6D
{
	return Global_100733.f_387 > 0;
}

var func_97()//Position - 0x8A7E
{
	var uVar0;
...
void func_98(var uParam0, int iParam1)//Position - 0x8AC4
{
	if (iParam1 <= 0)
	{
		return;
...
void func_99(var uParam0, int iParam1)//Position - 0x8B4A
{
...
void func_100(var uParam0, int iParam1)//Position - 0x8B7D
{
	int iVar0;
	int iVar1;
...
int func_101(int iParam0, int iParam1)//Position - 0x8BCE
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_102(int iParam0)//Position - 0x8C70
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_103(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_103(bool bParam0, int iParam1, int iParam2)//Position - 0x8C92
{
	if (bParam0)
	{
		return iParam1;
...
int func_104(var uParam0)//Position - 0x8CA9
{
	return uParam0 & 15;
}

void func_105(var uParam0, int iParam1)//Position - 0x8CB6
{
...
void func_106(var uParam0, int iParam1)//Position - 0x8CF0
{
...
void func_107(var uParam0, int iParam1)//Position - 0x8D2B
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_108()//Position - 0x8D67
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_109(int iParam0)//Position - 0x8D80
{
	var uVar0;
	char cVar1[24];
...
bool func_110()//Position - 0x8DD9
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_111()//Position - 0x8DEF
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_112(char* sParam0, int iParam1, int iParam2)//Position - 0x8E05
{
...
int func_113(bool bParam0)//Position - 0x8E47
{
...
struct<2> func_114(int iParam0)//Position - 0x8E6F
{
	struct<2> Var0;
...
void func_115(int iParam0, var uParam1)//Position - 0x92BC
{
	switch (iParam0)
	{
		case 0:
...
int func_117(int iParam0)//Position - 0xA594
{
	switch (iParam0)
	{
		case 0:
...
int func_118(var* uParam0)//Position - 0xA8DA
{
	int iVar0;
...
void func_119(int iParam0)//Position - 0xA97F
{
	struct<2> Var0;
...
void func_120(int iParam0)//Position - 0xAA1A
{
	if (iParam0 < 63)
	{
		func_121();
...
void func_122(int iParam0)//Position - 0xAA78
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_123(int iParam0)//Position - 0xAAD1
{
...
int func_124(int iParam0)//Position - 0xAB54
{
	int iVar0;
...
void func_125(int iParam0, int iParam1, int iParam2)//Position - 0xAB85
{
	func_126(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_126(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAB9A
{
	int iVar0;
...
int func_128(int iParam0, int iParam1, int iParam2)//Position - 0xAC4D
{
...
int func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAC68
{
	int iVar0;
...
int func_130(int iParam0)//Position - 0xACB4
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0xACFD
{
	if (func_132(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_132(int iParam0)//Position - 0xAD1D
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_133(int iParam0)//Position - 0xAD3E
{
	switch (iParam0)
	{
		case 5:
...
int func_135(int iParam0)//Position - 0xAE0E
{
	switch (iParam0)
	{
		case 5:
...
void func_136(var uParam0, bool bParam1, bool bParam2)//Position - 0xAE61
{
	int iVar0;
...
int func_137(int iParam0)//Position - 0xAF56
{
	switch (iParam0)
	{
		case 5:
...
void func_138(bool bParam0)//Position - 0xAFC1
{
	int iVar0;
...
void func_139(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB000
{
	if (bParam0)
	{
...
bool func_140()//Position - 0xB14D
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_141(int iParam0, int iParam1)//Position - 0xB167
{
	bool bVar0;
...
int func_142(int iParam0, bool bParam1)//Position - 0xB1B2
{
	int iVar0;
	int iVar1;
...
int func_143(int iParam0)//Position - 0xB1F3
{
...
bool func_144()//Position - 0xB232
{
	return BitTest(Global_2621446, 3);
}

int func_145(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB240
{
	int iVar0;
...
void func_147(int iParam0)//Position - 0xB29A
{
	if (iParam0 == 1)
	{
...
int func_148(char* sParam0)//Position - 0xB2BD
{
...
void func_149()//Position - 0xB2FA
{
	Global_20591 = 0;
	func_150();
}

void func_150()//Position - 0xB30A
{
...
int func_154(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB3F0
{
...
void func_155(int iParam0)//Position - 0xB588
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_157(int iParam0)//Position - 0xB605
{
	if (func_162())
	{
		return;
...
void func_158(int iParam0)//Position - 0xB638
{
	if (func_162())
	{
		return;
...
void func_159(bool bParam0, bool bParam1)//Position - 0xB6C2
{
	if (bParam0)
	{
		if (func_161(0))
...
bool func_160()//Position - 0xB736
{
	return BitTest(Global_1962996, 5);
}

int func_161(int iParam0)//Position - 0xB744
{
	if (iParam0 == 1)
	{
...
bool func_162()//Position - 0xB79B
{
	return BitTest(Global_1962996, 19);
}

int func_163(int iParam0)//Position - 0xB7AA
{
...
int func_164(int iParam0)//Position - 0xB7EB
{
	int iVar0;
...
void func_165(int iParam0)//Position - 0xB830
{
...
int func_166(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB862
{
	int iVar0;
...
void func_167(var uParam0, int iParam1)//Position - 0xB999
{
	int iVar0;
...
bool func_168(int iParam0)//Position - 0xB9E8
{
	return func_169(iParam0, Global_43257);
}

int func_169(int iParam0, int iParam1)//Position - 0xB9F9
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_170(int iParam0)//Position - 0xBBDA
{
	if (Global_43257 == 15)
	{
		return 0;
...
int func_171()//Position - 0xBBFC
{
	return func_172(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_172(char* sParam0, int iParam1)//Position - 0xBC0D
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_174(int iParam0, int iParam1)//Position - 0xBC7A
{
	switch (iParam0)
	{
		case 0:
...
int func_175(struct<3> Param0, bool bParam3)//Position - 0xC0EA
{
	int iVar0;
...
float func_176(bool bParam0, float fParam1, float fParam2)//Position - 0xC116
{
	if (bParam0)
	{
		return fParam1;
...
int func_177(int iParam0)//Position - 0xC12D
{
	switch (iParam0)
	{
		case 0:
...
int func_178(int iParam0, int iParam1)//Position - 0xC1BC
{
	switch (iParam0->f_16)
	{
		case 0:
...
void func_179()//Position - 0xC99F
{
	func_27(&(Global_104212.f_2890), &Global_104212, 0, 1, 1, 0);
}

int func_180(var uParam0)//Position - 0xC9BA
{
	float fVar0;
...
void func_181(int iParam0, int iParam1)//Position - 0xCA48
{
	if (iParam0 == 1)
	{
		if (!func_135(iParam1))
...
int func_182(bool bParam0)//Position - 0xCAAC
{
	int iVar0;
...
int func_183(int iParam0)//Position - 0xCB43
{
	bool bVar0;
...
var func_184()//Position - 0xD260
{
	return Global_100720.f_1;
}

int func_185()//Position - 0xD26E
{
	if (Global_97603 != -1)
	{
...
bool func_188()//Position - 0xD2D5
{
	return Global_100733.f_388 > 0;
}

var func_189(int iParam0, int iParam1)//Position - 0xD2E6
{
	switch (iParam0)
	{
		case 5:
...
var func_190()//Position - 0xD31E
{
	return Global_1575060;
}

int func_191()//Position - 0xD32A
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD346
{
	var uVar0;
	
	if ((((func_132(PLAYER::PLAYER_PED_ID()) && func_132(iParam0->f_28[0])) && !func_151()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_195(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
		func_193(&uVar0, cParam4, sParam5, 7, 0, 0);
...
void func_193(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD3CE
{
...
void func_194(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD409
{
...
void func_195(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD45F
{
...
float func_196(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD4FA
{
	struct<3> Var0;
...
int func_197(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)//Position - 0xD534
{
	var uVar0;
	...
	if (!*uParam10 == 3)
	{
		if (func_183(2))
		{
			if (!func_151())
			{
				if (((func_132(PLAYER::PLAYER_PED_ID()) && func_132(iParam0->f_28[0])) && func_132(iParam0->f_28[1])) && func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
					...
					{
						func_195(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
						func_195(&uVar0, iParam8, iParam0->f_28[1], sParam9, 0, 1);
						func_193(&uVar0, cParam4, sParam5, 7, 0, 0);
						*uParam10 = 2;
					}
					else if (*uParam10 == 2)
			...
			else if (((func_199(sParam5) && !*uParam10 == 1) && func_132(PLAYER::PLAYER_PED_ID())) && func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
			{
				func_295("pause conversation");
				func_198(1);
				*uParam10 = 1;
			}
			if (func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
void func_198(int iParam0)//Position - 0xD67F
{
	Global_22736 = iParam0;
}

int func_199(char* sParam0)//Position - 0xD68C
{
	struct<6> Var0;
...
struct<6> func_200()//Position - 0xD6AC
{
	struct<6> Var0;
...
void func_201(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD6D0
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_196(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_204(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_196(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_206(iParam0);
				}
			}
...
void func_202(int iParam0, bool bParam1)//Position - 0xD7C1
{
	if (iParam0 == -1)
	{
		return;
...
int func_203(int iParam0)//Position - 0xD7FD
{
	if (Global_78554 == iParam0)
	{
		if (Global_78555 == -1)
...
void func_204(int iParam0, int iParam1)//Position - 0xD836
{
	bool bVar0;
	int iVar1;
...
bool func_205()//Position - 0xD8D4
{
	return Global_97990;
}

void func_206(int iParam0)//Position - 0xD8E0
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_207(iParam0);
...
void func_207(int iParam0)//Position - 0xD8F7
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_208(int iParam0)//Position - 0xD9DF
{
	if (iParam0 == -1)
	{
		iParam0 = func_171();
...
void func_209(var uParam0)//Position - 0xDA07
{
	int iVar0;
	int iVar1;
...
void func_210(int iParam0)//Position - 0xDD0B
{
	int iVar0;
...
void func_211(int* iParam0)//Position - 0xDDA8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_212(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)//Position - 0xDDD3
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_213(int iParam0)//Position - 0xDE0C
{
	if (func_132(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_215(var uParam0, bool bParam1)//Position - 0xDE69
{
	struct<27> Var0;
	...
	if (func_219(&(uParam0->f_48)) && bParam1)
	{
		func_216(uParam0->f_28[0], &(uParam0->f_48), *uParam0);
	}
	return 1;
}

void func_216(int iParam0, var uParam1, int iParam2)//Position - 0xE0D9
{
	int iVar0;
	int iVar1;
...
int func_217(int iParam0)//Position - 0xE431
{
...
int func_218(var uParam0)//Position - 0xE451
{
...
int func_219(var uParam0)//Position - 0xE469
{
...
void func_220(var uParam0)//Position - 0xE48E
{
	int iVar0;
...
int func_221(var uParam0, bool bParam1, bool bParam2)//Position - 0xE50E
{
	int iVar0;
	int iVar1;
	int iVar2;
				...
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						if (func_213(iVar2))
						{
							...
							{
								if (func_213(uParam0->f_35[iVar0]))
								{
...
int func_222(int iParam0, int iParam1)//Position - 0xE6CC
{
	int iVar0;
...
int func_223(var uParam0, bool bParam1, int iParam2)//Position - 0xE6FC
{
	int iVar0;
	int iVar1;
...
int func_224(int iParam0)//Position - 0xE9B8
{
...
int func_225(int iParam0, float fParam1)//Position - 0xE9EC
{
	float fVar0;
...
bool func_226(int iParam0, float fParam1)//Position - 0xEA62
{
	return func_227(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_227(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEA7A
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	uVar0 = func_228(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_228(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xEB3B
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_229(int iParam0, int iParam1)//Position - 0xEC67
{
	int iVar0;
...
int func_231(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xED76
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_232(struct<3> Param0, struct<3> Param3)//Position - 0xEE07
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_233(struct<3> Param0)//Position - 0xEE28
{
	float fVar0;
	float fVar1;
...
void func_234(var uParam0)//Position - 0xEE67
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_235(int iParam0, int iParam1)//Position - 0xEE82
{
	int iVar0;
...
int func_236(int iParam0)//Position - 0xEEC1
{
...
int func_237(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEEE9
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_238(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEFE4
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_239(int iParam0, float fParam1)//Position - 0xF0F0
{
	var uVar0;
	struct<3> Var1;
...
int func_240(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF185
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_241(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF213
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_242(int iParam0)//Position - 0xF25B
{
...
int func_243(int iParam0)//Position - 0xF2A5
{
	if (iParam0 == -1)
	{
		iParam0 = func_171();
...
int func_244(int iParam0)//Position - 0xF33A
{
...
int func_247(int iParam0)//Position - 0xF3B9
{
	if ((func_248() && Global_100681.f_11 == 6) && iParam0 == func_172(&(Global_100681.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_249(int iParam0)//Position - 0xF42B
{
	if (func_113(0))
	{
...
int func_252(var uParam0)//Position - 0xF4DF
{
	int iVar0[5];
	int iVar6;
	bool bVar7;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_261(&(uParam0->f_48), "rcmminute3base", "base", "beckon");
		...
		case 2:
			...
			{
				func_258(&(uParam0->f_41[0]), iVar0[3], -303.74f, 6211.56f, 30.49f, -176.77f);
			...
			{
				if (func_255(&(uParam0->f_28[0]), 59, uParam0->f_48.f_5, -2.8f, "RCM MINUTE - MANUEL", 1))
				{
			...
			{
				func_253(&(uParam0->f_35[0]), iVar0[0], -281.93f, 6198.32f, 30.77f, -135.32f);
			...
			{
				func_253(&(uParam0->f_35[1]), iVar0[1], -291.72f, 6208.33f, 30.87f, -134.50163f);
			...
			{
				func_258(&(uParam0->f_41[1]), iVar0[4], -303.74f, 6211.56f, 30.49f, -176.77f);
...
void func_253(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF802
{
	func_254(iParam0);
...
void func_254(int* iParam0)//Position - 0xF844
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_255(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF8E0
{
...
int func_256(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF93C
{
	int iVar0;
...
int func_257(var uParam0, int iParam1)//Position - 0xF9CA
{
	int iVar0;
...
void func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFA10
{
	func_211(iParam0);
...
int func_259(var uParam0)//Position - 0xFA37
{
	if (func_219(uParam0))
	{
...
int func_260(int iParam0)//Position - 0xFA61
{
	int iVar0;
...
void func_261(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xFA92
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_262(var uParam0)//Position - 0xFACE
{
	int iVar0[1];
	int iVar2;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			func_253(&(uParam0->f_35[0]), iVar0[0], 20.8f, 4532.65f, 104.66f, 284.7f);
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
...
int func_263(var uParam0)//Position - 0xFBE1
{
	int iVar0[4];
	int iVar5;
	bool bVar6;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			MISC::CLEAR_AREA(321.69f, 3408.64f, 35.34f, 10f, true, false, false, false);
			if (!func_260(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_255(&(uParam0->f_28[0]), 56, 329.3f, 3404.2f, 35.8f, -174.9f, "RCM MINUTE - JOE", 1))
				{
			...
			{
				if (func_255(&(uParam0->f_28[1]), 57, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_253(&(uParam0->f_35[0]), iVar0[0], 321.69f, 3408.64f, 35.34f, -105.8f);
				func_264(uParam0->f_35[0], iVar0[0]);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_253(&(uParam0->f_35[1]), iVar0[1], 329.49f, 3402.71f, 36.29f, 284.36f);
				func_264(uParam0->f_35[1], iVar0[1]);
...
void func_264(int iParam0, int iParam1)//Position - 0xFF05
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_265(int iParam0)//Position - 0xFF3B
{
	struct<27> Var0;
	bool bVar32;
...
int func_266(int iParam0)//Position - 0xFF8C
{
	char* sVar0;
...
int func_267(int iParam0)//Position - 0x10047
{
	var uVar0;
...
int func_268(int iParam0)//Position - 0x10108
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_269(int iParam0, char* sParam1)//Position - 0x1018D
{
...
int func_270(int iParam0)//Position - 0x1026F
{
...
int func_271(int iParam0)//Position - 0x1029A
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_272(int iParam0)//Position - 0x102C5
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_273(int iParam0)//Position - 0x102F0
{
	if (func_244(iParam0))
	{
		return 0;
...
void func_274()//Position - 0x10325
{
	func_295("Running end routines.");
	Global_113366 = (Global_113366 - 1);
}

int func_275(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x1033F
{
	int iVar0;
...
int func_276(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x103A4
{
	int iVar0;
	struct<7> Var1;
...
int func_277(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x1041C
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_278(int iParam0, bool bParam1)//Position - 0x10497
{
	char* sVar0;
...
void func_279(char* sParam0)//Position - 0x10584
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_199(sParam0))
...
void func_280()//Position - 0x105A3
{
	Global_20591 = 0;
	func_281();
}

void func_281()//Position - 0x105B3
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_282(var uParam0)//Position - 0x105D4
{
	if (func_219(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_283(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x1060A
{
...
void func_284(var uParam0, bool bParam1)//Position - 0x1062A
{
	func_285(&(uParam0->f_41), bParam1);
}

void func_285(var uParam0, bool bParam1)//Position - 0x1063C
{
	int iVar0;
...
void func_286(int* iParam0, bool bParam1)//Position - 0x1067A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_287(var uParam0, bool bParam1)//Position - 0x106B5
{
	func_288(&(uParam0->f_35), bParam1);
}

void func_288(var uParam0, bool bParam1)//Position - 0x106C7
{
	int iVar0;
...
void func_289(int* iParam0)//Position - 0x10704
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_290(var uParam0, int iParam1)//Position - 0x1073C
{
	func_291(&(uParam0->f_28), iParam1);
}

void func_291(var uParam0, int iParam1)//Position - 0x1074E
{
	int iVar0;
...
void func_292(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1078F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_293(int* iParam0)//Position - 0x107DF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_294(var uParam0)//Position - 0x10820
{
	if (*uParam0 == -1)
	{
		return;
...
void func_295(char* sParam0)//Position - 0x1085D
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_296(var uParam0)//Position - 0x1086F
{
	*uParam0 = -1;
...
void func_297()//Position - 0x108A2
{
	func_295("Running start routines.");
	Global_113366++;
}

int func_298(int iParam0)//Position - 0x108BC
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
