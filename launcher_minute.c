...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113457[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_300(&(Global_113457[Var0.f_0 /*10*/].f_9));
			}
		}
		func_284(&Var0, 1);
	}
	if (!func_281(&iVar64, &Var0, Var61, 1f))
	{
		func_280();
	...
	while (true)
	{
		...
		{
			func_220();
			if (func_219(Var0.f_35[1]))
			{
				if (!func_218(329.513f, 3402.691f, 36.258f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[1], true), 1056964608))
				{
		...
		func_214(Var0.f_0);
		func_207(&iLocal_94, &(Var0.f_9), Var61);
		if (Var0.f_0 == 32)
		{
			func_203(&Var0, Var61, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_97);
		}
		else if (Var0.f_0 == 34)
		{
			func_198(&Var0, Var61, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
		}
		if (func_184(&Var0, 0))
		{
			if (func_183(Var0.f_0))
			{
				func_180(Var0.f_0, &iLocal_96);
			}
			if (!func_2(&Var0))
			{
				func_284(&Var0, 1);
...
int func_1(int iParam0)//Position - 0x37A
{
...
int func_2(int iParam0)//Position - 0x398
{
	struct<4> Var0;
	char* sVar32;
...
void func_3(int iParam0, char* sParam1)//Position - 0x45A
{
	func_21(sParam1);
...
void func_17(int iParam0)//Position - 0xD1A
{
...
void func_21(char* sParam0)//Position - 0xDD3
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xDE6
{
	MISC::CLEAR_BIT(&(Global_101392.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xE03
{
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A0F
{
...
int func_29(int iParam0)//Position - 0x2A4F
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2A7D
{
...
int func_31(int iParam0)//Position - 0x2B59
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2B9B
{
	int iVar0;
...
int func_33(int iParam0, bool bParam1, int iParam2)//Position - 0x2BFE
{
	int iVar0;
...
int func_34(bool bParam0, int iParam1)//Position - 0x2C8C
{
	struct<82> Var0;
...
void func_35(bool bParam0, var uParam1, int iParam2)//Position - 0x2CCE
{
	int iVar0;
...
bool func_36(bool bParam0)//Position - 0x2F2A
{
	return bParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2F36
{
	int iVar0;
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x3291
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x3484
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3555
{
	char* sVar0;
...
int func_43(int iParam0, bool bParam1, bool bParam2)//Position - 0x3684
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x36F2
{
...
int func_45(int iParam0)//Position - 0x37CB
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x3808
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x382D
{
...
int func_50(int iParam0, var uParam1)//Position - 0x3A05
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(uParam1));
}

int func_51(var uParam0)//Position - 0x3A1A
{
	int iVar0;
	int iVar1;
...
int func_53(int iParam0, int iParam1)//Position - 0x3A5A
{
	int iVar0;
	var uVar1;
...
int func_54(int iParam0, var uParam1)//Position - 0x3A7E
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(uParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3A93
{
	int iVar0;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3FDC
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x46BE
{
	switch (iParam0)
	{
...
int func_63(int iParam0)//Position - 0x475F
{
...
int func_64(int iParam0, int iParam1)//Position - 0x494B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x566C
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x56A7
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x591B
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x5957
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5EA6
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5EEA
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6669
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x66B0
{
...
bool func_73(int iParam0)//Position - 0x670B
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x671B
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x677B
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x6B23
{
	return Global_32828;
}

int func_77(int iParam0)//Position - 0x6B2E
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6B3E
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6BE0
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x734B
{
...
int func_81()//Position - 0x7646
{
	return Global_2652572.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x7655
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x767F
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x7694
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x76AB
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x7703
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x77AD
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x7842
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x7886
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x7A0A
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x7A18
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x84E0
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x8562
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x85BA
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x85C3
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x882F
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x883F
{
...
int func_99(int iParam0)//Position - 0x886C
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x8BA2
{
	return Global_101444.f_393 > 0;
}

var func_101()//Position - 0x8BB3
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8BF9
{
	if (iParam1 <= 0)
	{
		return;
...
void func_103(var uParam0, int iParam1)//Position - 0x8C7F
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8CB2
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8D03
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8DA5
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8DC7
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8DDE
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8DEB
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8E25
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8E60
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8E9C
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8EB5
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8F0E
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8F24
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8F3A
{
...
int func_117(bool bParam0)//Position - 0x8F7C
{
...
struct<2> func_118(int iParam0)//Position - 0x8FA4
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x93F1
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA6C9
{
	switch (iParam0)
	{
		case 0:
...
int func_122(var* uParam0)//Position - 0xAA0F
{
	int iVar0;
...
void func_123(int iParam0)//Position - 0xAAB4
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xAB4F
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xABAD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xAC06
{
...
int func_128(int iParam0)//Position - 0xAC89
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xACBA
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xACCF
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xAD82
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAD9D
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xADE9
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xAE32
{
	if (func_136(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xAE52
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_137(int iParam0)//Position - 0xAE73
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xAF43
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xAF96
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xB08B
{
	switch (iParam0)
	{
		case 5:
...
void func_142(bool bParam0)//Position - 0xB0F6
{
	int iVar0;
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB135
{
	if (bParam0)
	{
...
bool func_144()//Position - 0xB282
{
	return BitTest(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

bool func_145(int iParam0, int iParam1)//Position - 0xB29C
{
	bool bVar0;
...
int func_146(int iParam0, bool bParam1)//Position - 0xB2F5
{
	int iVar0;
	int iVar1;
...
int func_147(var uParam0)//Position - 0xB336
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB358
{
...
bool func_149()//Position - 0xB397
{
	return BitTest(Global_2621446, 3);
}

int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB3A5
{
	int iVar0;
...
void func_152(int iParam0)//Position - 0xB3FF
{
	if (iParam0 == 1)
	{
...
int func_153(char* sParam0)//Position - 0xB422
{
...
void func_154()//Position - 0xB45F
{
	Global_21032 = 0;
	func_155();
}

void func_155()//Position - 0xB46F
{
...
int func_159(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB555
{
...
void func_160(int iParam0)//Position - 0xB5AC
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_161(bool bParam0, bool bParam1)//Position - 0xB5D8
{
...
void func_163(int iParam0)//Position - 0xB77A
{
	if (func_168())
	{
		return;
...
void func_164(int iParam0)//Position - 0xB7AD
{
	if (func_168())
	{
		return;
...
void func_165(bool bParam0, bool bParam1)//Position - 0xB837
{
	if (bParam0)
	{
		if (func_167(0))
...
bool func_166()//Position - 0xB8AB
{
	return BitTest(Global_1956030, 5);
}

int func_167(int iParam0)//Position - 0xB8B9
{
	if (iParam0 == 1)
	{
...
bool func_168()//Position - 0xB910
{
	return BitTest(Global_1956030, 19);
}

int func_169(int iParam0)//Position - 0xB91F
{
...
int func_170(int iParam0)//Position - 0xB960
{
	int iVar0;
...
void func_171(int iParam0)//Position - 0xB9A5
{
...
int func_172(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB9D7
{
	int iVar0;
...
void func_173(var uParam0, int iParam1)//Position - 0xBB0E
{
	int iVar0;
...
bool func_174(int iParam0)//Position - 0xBB5D
{
	return func_175(iParam0, Global_43922);
}

int func_175(int iParam0, int iParam1)//Position - 0xBB6E
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_176(int iParam0)//Position - 0xBD4F
{
	if (Global_43922 == 15)
	{
		return 0;
...
int func_177()//Position - 0xBD71
{
	return func_178(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_178(char* sParam0, int iParam1)//Position - 0xBD82
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_180(int iParam0, int iParam1)//Position - 0xBDEF
{
	switch (iParam0)
	{
		case 0:
...
int func_181(struct<3> Param0, bool bParam3)//Position - 0xC261
{
	int iVar0;
...
float func_182(bool bParam0, float fParam1, float fParam2)//Position - 0xC28D
{
	if (bParam0)
	{
		return fParam1;
...
int func_183(int iParam0)//Position - 0xC2A4
{
	switch (iParam0)
	{
		case 0:
...
int func_184(int iParam0, int iParam1)//Position - 0xC333
{
	switch (iParam0->f_16)
	{
		case 0:
...
void func_185()//Position - 0xCB16
{
	func_27(&(Global_104933.f_2890), &Global_104933, 0, 1, 1, 0);
}

int func_186(var uParam0)//Position - 0xCB31
{
	float fVar0;
...
void func_187(int iParam0, int iParam1)//Position - 0xCBBF
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_188(bool bParam0)//Position - 0xCC23
{
	int iVar0;
...
int func_189(int iParam0)//Position - 0xCCBA
{
	bool bVar0;
...
var func_190()//Position - 0xD3D7
{
	return Global_101431.f_1;
}

int func_191()//Position - 0xD3E5
{
	if (Global_98294 != -1)
	{
...
bool func_194()//Position - 0xD44C
{
	return Global_101444.f_394 > 0;
}

var func_195(int iParam0, int iParam1)//Position - 0xD45D
{
	switch (iParam0)
	{
		case 5:
...
var func_196()//Position - 0xD495
{
	return Global_1575079;
}

int func_197()//Position - 0xD4A1
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_198(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD4BD
{
	var uVar0;
	
	if ((((func_136(PLAYER::PLAYER_PED_ID()) && func_136(iParam0->f_28[0])) && !func_156()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_202(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_201(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
...
void func_199(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD545
{
...
void func_200(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD580
{
...
void func_201(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD5D6
{
...
float func_202(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD671
{
	struct<3> Var0;
...
int func_203(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)//Position - 0xD6AB
{
	var uVar0;
	...
	if (!*uParam10 == 3)
	{
		if (func_189(2))
		{
			if (!func_156())
			{
				if (((func_136(PLAYER::PLAYER_PED_ID()) && func_136(iParam0->f_28[0])) && func_136(iParam0->f_28[1])) && func_202(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
					...
					{
						func_201(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
						func_201(&uVar0, iParam8, iParam0->f_28[1], sParam9, 0, 1);
						func_199(&uVar0, cParam4, sParam5, 7, 0, 0);
						*uParam10 = 2;
					}
					else if (*uParam10 == 2)
			...
			else if (((func_205(sParam5) && !*uParam10 == 1) && func_136(PLAYER::PLAYER_PED_ID())) && func_202(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
			{
				func_301("pause conversation");
				func_204(1);
				*uParam10 = 1;
			}
			if (func_202(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
void func_204(int iParam0)//Position - 0xD7F6
{
	Global_23177 = iParam0;
}

int func_205(char* sParam0)//Position - 0xD803
{
	struct<6> Var0;
...
struct<6> func_206()//Position - 0xD823
{
	struct<6> Var0;
...
void func_207(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD847
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_208(int iParam0, bool bParam1)//Position - 0xD938
{
	if (iParam0 == -1)
	{
		return;
...
int func_209(int iParam0)//Position - 0xD974
{
	if (Global_79244 == iParam0)
	{
		if (Global_79245 == -1)
...
void func_210(int iParam0, int iParam1)//Position - 0xD9AD
{
	bool bVar0;
	int iVar1;
...
bool func_211()//Position - 0xDA4B
{
	return Global_98681;
}

void func_212(int iParam0)//Position - 0xDA57
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_213(iParam0);
...
void func_213(int iParam0)//Position - 0xDA6E
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_214(int iParam0)//Position - 0xDB56
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
void func_215(var uParam0)//Position - 0xDB7E
{
	int iVar0;
	int iVar1;
...
void func_216(int iParam0)//Position - 0xDE82
{
	int iVar0;
...
void func_217(int* iParam0)//Position - 0xDF1F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_218(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)//Position - 0xDF4A
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_219(int iParam0)//Position - 0xDF83
{
	if (func_136(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_221(var uParam0, bool bParam1)//Position - 0xDFE0
{
	struct<27> Var0;
	...
	if ((func_255(*uParam0) || func_253(*uParam0)) || Global_79494 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_225(&(uParam0->f_48)) && bParam1)
	{
		func_222(uParam0->f_28[0], &(uParam0->f_48), *uParam0);
	}
	return 1;
}

void func_222(int iParam0, var uParam1, int iParam2)//Position - 0xE250
{
	int iVar0;
	int iVar1;
	...
	if (func_136(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_224(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_223(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_224(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_223(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
int func_223(int iParam0)//Position - 0xE5A8
{
...
int func_224(var uParam0)//Position - 0xE5C8
{
...
int func_225(var uParam0)//Position - 0xE5E0
{
...
void func_226(var uParam0)//Position - 0xE605
{
	int iVar0;
...
int func_227(var uParam0, bool bParam1, bool bParam2)//Position - 0xE685
{
	int iVar0;
	int iVar1;
	int iVar2;
				...
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						if (func_219(iVar2))
						{
							...
							{
								if (func_219(uParam0->f_35[iVar0]))
								{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_228(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_228(int iParam0, int iParam1)//Position - 0xE843
{
	int iVar0;
...
int func_229(var uParam0, bool bParam1, int iParam2)//Position - 0xE873
{
	int iVar0;
	int iVar1;
...
int func_230(int iParam0)//Position - 0xEB2F
{
...
int func_231(int iParam0, float fParam1)//Position - 0xEB63
{
	float fVar0;
	
	if (func_136(PLAYER::PLAYER_PED_ID()) && func_136(iParam0))
	{
		if (func_242(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_232(int iParam0, float fParam1)//Position - 0xEBD9
{
	return func_233(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_233(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEBF1
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	
	iVar4 = func_241(iParam0, iParam1);
	if (!func_136(iParam0) || !func_136(iParam1))
	{
		if (iVar4 != -1)
		{
			func_240(&(Local_35[iVar4 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_234(&(Local_35[iVar4 /*4*/]), Var1, iParam1, &(Local_35[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar4 /*4*/].f_3) < iParam4);
}

int func_234(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xECB2
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_235(int iParam0, int iParam1)//Position - 0xEDDE
{
	int iVar0;
...
int func_237(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEEED
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_239(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_239(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_238(Var3, Var0);
...
float func_238(struct<3> Param0, struct<3> Param3)//Position - 0xEF7E
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_239(struct<3> Param0)//Position - 0xEF9F
{
	float fVar0;
	float fVar1;
...
void func_240(var uParam0)//Position - 0xEFDE
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_241(int iParam0, int iParam1)//Position - 0xEFF9
{
	int iVar0;
...
int func_242(int iParam0)//Position - 0xF038
{
...
int func_243(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF060
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_244(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF15B
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_245(int iParam0, float fParam1)//Position - 0xF267
{
	var uVar0;
	struct<3> Var1;
	...
	{
		if (func_246(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_246(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF2FC
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_239(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
int func_247(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF38A
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_248(int iParam0)//Position - 0xF3D2
{
...
int func_249(int iParam0)//Position - 0xF41C
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_250(int iParam0)//Position - 0xF4B1
{
...
int func_253(int iParam0)//Position - 0xF530
{
...
int func_255(int iParam0)//Position - 0xF5A2
{
	if (func_117(0))
	{
...
int func_258(var uParam0)//Position - 0xF657
{
	int iVar0[5];
	int iVar6;
	bool bVar7;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_264(&(uParam0->f_41[0]), iVar0[3], -303.74f, 6211.56f, 30.49f, -176.77f);
			...
			{
				if (func_261(&(uParam0->f_28[0]), 59, uParam0->f_48.f_5, -2.8f, "RCM MINUTE - MANUEL", 1))
				{
			...
			{
				func_259(&(uParam0->f_35[0]), iVar0[0], -281.93f, 6198.32f, 30.77f, -135.32f);
			...
			{
				func_259(&(uParam0->f_35[1]), iVar0[1], -291.72f, 6208.33f, 30.87f, -134.50163f);
			...
			{
				func_264(&(uParam0->f_41[1]), iVar0[4], -303.74f, 6211.56f, 30.49f, -176.77f);
...
void func_259(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF97A
{
	func_260(iParam0);
...
void func_260(int* iParam0)//Position - 0xF9BD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_261(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xFA59
{
	if (func_262(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_262(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xFAB5
{
	int iVar0;
...
int func_263(var uParam0, int iParam1)//Position - 0xFB43
{
	int iVar0;
...
void func_264(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFB89
{
	func_217(iParam0);
...
int func_265(var uParam0)//Position - 0xFBB0
{
	if (func_225(uParam0))
	{
...
int func_266(int iParam0)//Position - 0xFBDA
{
	int iVar0;
...
void func_267(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xFC0B
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_268(var uParam0)//Position - 0xFC47
{
	int iVar0[1];
	int iVar2;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			func_259(&(uParam0->f_35[0]), iVar0[0], 20.8f, 4532.65f, 104.66f, 284.7f);
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
...
int func_269(var uParam0)//Position - 0xFD5A
{
	int iVar0[4];
	int iVar5;
	bool bVar6;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			MISC::CLEAR_AREA(321.69f, 3408.64f, 35.34f, 10f, true, false, false, false);
			if (!func_266(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_261(&(uParam0->f_28[0]), 56, 329.3f, 3404.2f, 35.8f, -174.9f, "RCM MINUTE - JOE", 1))
				{
			...
			{
				if (func_261(&(uParam0->f_28[1]), 57, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_259(&(uParam0->f_35[0]), iVar0[0], 321.69f, 3408.64f, 35.34f, -105.8f);
				func_270(uParam0->f_35[0], iVar0[0]);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_259(&(uParam0->f_35[1]), iVar0[1], 329.49f, 3402.71f, 36.29f, 284.36f);
				func_270(uParam0->f_35[1], iVar0[1]);
...
void func_270(int iParam0, int iParam1)//Position - 0x1007F
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_271(int iParam0)//Position - 0x100B5
{
	struct<27> Var0;
	bool bVar32;
...
int func_272(int iParam0)//Position - 0x10106
{
	char* sVar0;
...
int func_273(int iParam0)//Position - 0x101BF
{
	var uVar0;
...
int func_274(int iParam0)//Position - 0x10280
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_275(int iParam0, char* sParam1)//Position - 0x10305
{
...
int func_276(int iParam0)//Position - 0x103E7
{
...
int func_277(int iParam0)//Position - 0x10412
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_278(int iParam0)//Position - 0x1043D
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_279(int iParam0)//Position - 0x10468
{
	if (func_250(iParam0))
	{
		return 0;
...
void func_280()//Position - 0x1049D
{
	func_301("Running end routines.");
	Global_114088 = (Global_114088 - 1);
}

int func_281(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x104B7
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_282((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_282((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_282(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x1051C
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_283(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_283(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10594
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_284(int iParam0, bool bParam1)//Position - 0x1060F
{
	char* sVar0;
...
void func_285(char* sParam0)//Position - 0x106FC
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_205(sParam0))
...
void func_286()//Position - 0x1071B
{
	Global_21032 = 0;
	func_287();
}

void func_287()//Position - 0x1072B
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_288(var uParam0)//Position - 0x1074C
{
	if (func_225(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_289(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10782
{
...
void func_290(var uParam0, bool bParam1)//Position - 0x107A2
{
	func_291(&(uParam0->f_41), bParam1);
}

void func_291(var uParam0, bool bParam1)//Position - 0x107B4
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_292(uParam0[iVar0], 0);
		}
		iVar0++;
	}
}

void func_292(int* iParam0, bool bParam1)//Position - 0x107F2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_293(var uParam0, bool bParam1)//Position - 0x1082D
{
	func_294(&(uParam0->f_35), bParam1);
}

void func_294(var uParam0, bool bParam1)//Position - 0x1083F
{
	int iVar0;
...
void func_295(int* iParam0)//Position - 0x1087C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_296(var uParam0, int iParam1)//Position - 0x108B4
{
	func_297(&(uParam0->f_28), iParam1);
}

void func_297(var uParam0, int iParam1)//Position - 0x108C6
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_298(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_298(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10907
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_299(int* iParam0)//Position - 0x10957
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_300(var uParam0)//Position - 0x10998
{
	if (*uParam0 == -1)
	{
		return;
...
void func_301(char* sParam0)//Position - 0x109D5
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_302(var uParam0)//Position - 0x109E7
{
	*uParam0 = -1;
...
void func_303()//Position - 0x10A1A
{
	func_301("Running start routines.");
	Global_114088++;
}

int func_304(int iParam0)//Position - 0x10A34
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
