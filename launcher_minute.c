...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (Var0.f_0 == 32)
		{
			...
			{
				if (!func_219(329.513f, 3402.691f, 36.258f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[1], true), 1056964608))
				{
		...
		func_215(Var0.f_0);
		func_208(&iLocal_94, &(Var0.f_9), Var61);
		if (Var0.f_0 == 32)
		{
			func_204(&Var0, Var61, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_97);
		}
		else if (Var0.f_0 == 34)
		{
			func_199(&Var0, Var61, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
		}
		if (func_185(&Var0, 0))
		{
			if (func_184(Var0.f_0))
			{
				func_181(Var0.f_0, &iLocal_96);
			}
			if (!func_2(&Var0))
			{
				func_285(&Var0, 1);
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5F12
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x66D5
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x671C
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x6787
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6BA9
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6BB9
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x76DF
{
...
Vector3 func_84(struct<3> Param0)//Position - 0x7721
{
...
int func_86(int iParam0)//Position - 0x774D
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x784F
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x78E4
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_93(int iParam0, var uParam1)//Position - 0x8581
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0)//Position - 0x8603
{
	if (iParam0 != func_95())
	{
...
int func_99(int iParam0)//Position - 0x8918
{
...
var func_107(int iParam0)//Position - 0x8E6E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8E90
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8EA7
{
	return uParam0 & 15;
}
...
void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x900D
{
...
int func_118(bool bParam0)//Position - 0x904F
{
...
int func_123(var* uParam0)//Position - 0xAAE2
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAE55
{
...
int func_136(int iParam0)//Position - 0xAF05
{
	if (func_137(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xAF25
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_138(int iParam0)//Position - 0xAF46
{
	switch (iParam0)
	{
		case 5:
...
int func_140(int iParam0)//Position - 0xB016
{
	switch (iParam0)
	{
		case 5:
...
void func_141(var uParam0, bool bParam1, bool bParam2)//Position - 0xB069
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0xB15F
{
	switch (iParam0)
	{
		case 5:
...
void func_144(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB209
{
	if (bParam0)
	{
...
int func_148(var uParam0)//Position - 0xB40C
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xB42E
{
...
int func_151(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB47B
{
	int iVar0;
...
int func_154(char* sParam0)//Position - 0xB4F8
{
...
int func_160(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB62B
{
...
void func_161(int iParam0)//Position - 0xB682
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_170(int iParam0)//Position - 0xB9F5
{
...
int func_171(int iParam0)//Position - 0xBA36
{
	int iVar0;
...
int func_173(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xBAAD
{
	int iVar0;
...
void func_174(var uParam0, int iParam1)//Position - 0xBBE4
{
	int iVar0;
...
bool func_175(int iParam0)//Position - 0xBC33
{
	return func_176(iParam0, Global_44181);
}

int func_176(int iParam0, int iParam1)//Position - 0xBC44
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_177(int iParam0)//Position - 0xBE25
{
	if (Global_44181 == 15)
	{
		return 0;
...
int func_179(char* sParam0, int iParam1)//Position - 0xBE58
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_181(int iParam0, int iParam1)//Position - 0xBEC5
{
	switch (iParam0)
	{
		case 0:
...
int func_182(struct<3> Param0, bool bParam3)//Position - 0xC336
{
	int iVar0;
...
float func_183(bool bParam0, float fParam1, float fParam2)//Position - 0xC362
{
	if (bParam0)
	{
		return fParam1;
...
int func_184(int iParam0)//Position - 0xC379
{
	switch (iParam0)
	{
		case 0:
...
int func_185(int iParam0, int iParam1)//Position - 0xC408
{
	switch (iParam0->f_16)
	{
		case 0:
...
int func_187(var uParam0)//Position - 0xCC06
{
	float fVar0;
...
void func_188(int iParam0, int iParam1)//Position - 0xCC94
{
	if (iParam0 == 1)
	{
		if (!func_140(iParam1))
...
int func_189(bool bParam0)//Position - 0xCCF8
{
	int iVar0;
...
int func_190(int iParam0)//Position - 0xCD8F
{
	bool bVar0;
...
var func_191()//Position - 0xD4AC
{
	return Global_101727.f_1;
}

int func_192()//Position - 0xD4BA
{
	if (Global_98585 != -1)
	{
...
var func_196(int iParam0, int iParam1)//Position - 0xD532
{
	switch (iParam0)
	{
		case 5:
...
var func_197()//Position - 0xD56A
{
	return Global_1575084;
}

int func_198()//Position - 0xD576
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_199(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD592
{
	var uVar0;
	
	if ((((func_137(PLAYER::PLAYER_PED_ID()) && func_137(iParam0->f_28[0])) && !func_157()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_203(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_202(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
...
void func_200(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD61A
{
...
void func_202(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD6AB
{
...
float func_203(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD746
{
	struct<3> Var0;
...
int func_204(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)//Position - 0xD780
{
	var uVar0;
	...
	if (!*uParam10 == 3)
	{
		if (func_190(2))
		{
			if (!func_157())
			{
				if (((func_137(PLAYER::PLAYER_PED_ID()) && func_137(iParam0->f_28[0])) && func_137(iParam0->f_28[1])) && func_203(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
					...
					{
						func_202(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
						func_202(&uVar0, iParam8, iParam0->f_28[1], sParam9, 0, 1);
						func_200(&uVar0, cParam4, sParam5, 7, 0, 0);
						*uParam10 = 2;
					}
					else if (*uParam10 == 2)
			...
			else if (((func_206(sParam5) && !*uParam10 == 1) && func_137(PLAYER::PLAYER_PED_ID())) && func_203(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
			{
				func_302("pause conversation");
				func_205(1);
				*uParam10 = 1;
			}
			if (func_203(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
int func_206(char* sParam0)//Position - 0xD8D8
{
	struct<6> Var0;
...
void func_208(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD91C
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_211(int iParam0, int iParam1)//Position - 0xDA82
{
	bool bVar0;
	int iVar1;
...
void func_213(int iParam0)//Position - 0xDB2C
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_214(iParam0);
...
void func_214(int iParam0)//Position - 0xDB43
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_217(int iParam0)//Position - 0xDF57
{
	int iVar0;
...
void func_218(int* iParam0)//Position - 0xDFF4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_219(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)//Position - 0xE01F
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_220(int iParam0)//Position - 0xE058
{
	if (func_137(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_222(var uParam0, bool bParam1)//Position - 0xE0B5
{
	struct<27> Var0;
...
void func_223(int iParam0, var uParam1, int iParam2)//Position - 0xE325
{
	...
	if (func_137(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_225(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_224(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_225(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_224(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
int func_224(int iParam0)//Position - 0xE67D
{
...
int func_225(var uParam0)//Position - 0xE69D
{
...
int func_226(var uParam0)//Position - 0xE6B5
{
...
int func_228(var uParam0, bool bParam1, bool bParam2)//Position - 0xE75A
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_229(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_229(int iParam0, int iParam1)//Position - 0xE918
{
	int iVar0;
...
int func_230(var uParam0, bool bParam1, int iParam2)//Position - 0xE948
{
	int iVar0;
	int iVar1;
...
int func_231(int iParam0)//Position - 0xEC04
{
...
int func_232(int iParam0, float fParam1)//Position - 0xEC38
{
	float fVar0;
...
bool func_233(int iParam0, float fParam1)//Position - 0xECAE
{
	return func_234(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_234(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xECC6
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	uVar0 = func_235(&(Local_35[iVar4 /*4*/]), Var1, iParam1, &(Local_35[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar4 /*4*/].f_3) < iParam4);
}

int func_235(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xED87
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_236(int iParam0, int iParam1)//Position - 0xEEB3
{
	int iVar0;
...
int func_238(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEFC2
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_239(struct<3> Param0, struct<3> Param3)//Position - 0xF053
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_240(struct<3> Param0)//Position - 0xF074
{
	float fVar0;
	float fVar1;
...
int func_242(int iParam0, int iParam1)//Position - 0xF0CE
{
	int iVar0;
...
int func_243(int iParam0)//Position - 0xF10D
{
...
int func_244(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF135
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_245(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF230
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_246(int iParam0, float fParam1)//Position - 0xF33C
{
	var uVar0;
	struct<3> Var1;
...
int func_247(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF3D1
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_248(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF45F
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_249(int iParam0)//Position - 0xF4A7
{
...
int func_250(int iParam0)//Position - 0xF4F1
{
	if (iParam0 == -1)
	{
		iParam0 = func_178();
...
int func_251(int iParam0)//Position - 0xF586
{
...
int func_254(int iParam0)//Position - 0xF605
{
...
int func_256(int iParam0)//Position - 0xF677
{
	if (func_118(0))
	{
...
int func_259(var uParam0)//Position - 0xF72C
{
	int iVar0[5];
	int iVar6;
	bool bVar7;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_260(&(uParam0->f_35[1]), iVar0[1], -291.72f, 6208.33f, 30.87f, -134.50163f);
...
void func_260(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFA4F
{
	func_261(iParam0);
...
void func_261(int* iParam0)//Position - 0xFA92
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_262(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xFB2E
{
	if (func_263(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_263(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xFB8A
{
	int iVar0;
...
int func_264(var uParam0, int iParam1)//Position - 0xFC18
{
	int iVar0;
...
void func_265(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFC5E
{
	func_218(iParam0);
...
int func_266(var uParam0)//Position - 0xFC85
{
	if (func_226(uParam0))
	{
...
int func_267(int iParam0)//Position - 0xFCAF
{
	int iVar0;
...
int func_269(var uParam0)//Position - 0xFD1C
{
	int iVar0[1];
	int iVar2;
...
int func_270(var uParam0)//Position - 0xFE2F
{
	int iVar0[4];
	int iVar5;
	bool bVar6;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			MISC::CLEAR_AREA(321.69f, 3408.64f, 35.34f, 10f, true, false, false, false);
			if (!func_267(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				return 0;
			}
			iLocal_89 = 2;
...
void func_271(int iParam0, int iParam1)//Position - 0x10154
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_272(int iParam0)//Position - 0x1018A
{
	struct<27> Var0;
	bool bVar32;
...
int func_273(int iParam0)//Position - 0x101DB
{
	char* sVar0;
...
int func_274(int iParam0)//Position - 0x10294
{
	var uVar0;
...
int func_275(int iParam0)//Position - 0x10355
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_277(int iParam0)//Position - 0x104BC
{
...
int func_278(int iParam0)//Position - 0x104E7
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_279(int iParam0)//Position - 0x10512
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_280(int iParam0)//Position - 0x1053D
{
	if (func_251(iParam0))
	{
		return 0;
...
int func_282(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x1058C
{
	int iVar0;
...
int func_283(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x105F1
{
	int iVar0;
	struct<7> Var1;
...
int func_284(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10669
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_285(int iParam0, bool bParam1)//Position - 0x106E4
{
	char* sVar0;
...
void func_293(int* iParam0, bool bParam1)//Position - 0x108C7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_296(int* iParam0)//Position - 0x10951
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_299(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x109DC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_300(int* iParam0)//Position - 0x10A2C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_301(var uParam0)//Position - 0x10A6D
{
	if (*uParam0 == -1)
	{
		return;
...
int func_305(int iParam0)//Position - 0x10B09
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
