...
int func_64(int iParam0, int iParam1)//Position - 0x4951
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x5692
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x56CD
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x5941
{
	bool bVar0;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5ECC
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x668F
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x66D6
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x6741
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6B54
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6B64
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x766F
{
...
int func_83()//Position - 0x7699
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

Vector3 func_84(struct<3> Param0)//Position - 0x76B1
{
...
int func_86(int iParam0)//Position - 0x76DD
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x77DF
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x7874
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_93(int iParam0, var uParam1)//Position - 0x8516
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0)//Position - 0x8598
{
	if (iParam0 != func_95())
	{
...
int func_98(int iParam0)//Position - 0x8875
{
	return MISC::GET_BITS_IN_RANGE(Global_2657971[iParam0 /*465*/].f_322.f_3, 28, 31);
}

int func_99(int iParam0)//Position - 0x8892
{
...
var func_107(int iParam0)//Position - 0x8DDB
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8DFD
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8E14
{
	return uParam0 & 15;
}
...
bool func_115()//Position - 0x8F44
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_116()//Position - 0x8F5A
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x8F70
{
...
int func_118(bool bParam0)//Position - 0x8FB2
{
...
int func_123(var* uParam0)//Position - 0xAA45
{
	int iVar0;
...
void func_127(int iParam0)//Position - 0xABE3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0)//Position - 0xACBF
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xADB8
{
...
int func_135(int iParam0)//Position - 0xAE1F
{
	int iVar0;
...
int func_136(int iParam0)//Position - 0xAE68
{
	if (func_137(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xAE88
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_138(int iParam0)//Position - 0xAEA9
{
	switch (iParam0)
	{
		case 5:
...
int func_140(int iParam0)//Position - 0xAF79
{
	switch (iParam0)
	{
		case 5:
...
void func_141(var uParam0, bool bParam1, bool bParam2)//Position - 0xAFCC
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0xB0C1
{
	switch (iParam0)
	{
		case 5:
...
void func_144(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB16B
{
	if (bParam0)
	{
...
bool func_146(int iParam0, int iParam1)//Position - 0xB2D2
{
	bool bVar0;
...
int func_148(var uParam0)//Position - 0xB36C
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xB38E
{
...
int func_151(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB3DB
{
	int iVar0;
...
int func_154(char* sParam0)//Position - 0xB458
{
...
int func_160(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB58B
{
...
void func_161(int iParam0)//Position - 0xB5E2
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_168(int iParam0)//Position - 0xB8EF
{
	if (iParam0 == 1)
	{
...
int func_170(int iParam0)//Position - 0xB955
{
...
int func_171(int iParam0)//Position - 0xB996
{
	int iVar0;
...
int func_173(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xBA0D
{
	int iVar0;
...
void func_174(var uParam0, int iParam1)//Position - 0xBB44
{
	int iVar0;
...
bool func_175(int iParam0)//Position - 0xBB93
{
	return func_176(iParam0, Global_44042);
}

int func_176(int iParam0, int iParam1)//Position - 0xBBA4
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_177(int iParam0)//Position - 0xBD85
{
	if (Global_44042 == 15)
	{
		return 0;
...
int func_179(char* sParam0, int iParam1)//Position - 0xBDB8
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_181(int iParam0, int iParam1)//Position - 0xBE25
{
	switch (iParam0)
	{
		case 0:
...
int func_182(struct<3> Param0, bool bParam3)//Position - 0xC295
{
	int iVar0;
...
float func_183(bool bParam0, float fParam1, float fParam2)//Position - 0xC2C1
{
	if (bParam0)
	{
		return fParam1;
...
int func_184(int iParam0)//Position - 0xC2D8
{
	switch (iParam0)
	{
		case 0:
...
int func_185(int iParam0, int iParam1)//Position - 0xC367
{
	switch (iParam0->f_16)
	{
		case 0:
...
int func_187(var uParam0)//Position - 0xCB65
{
	float fVar0;
...
void func_188(int iParam0, int iParam1)//Position - 0xCBF3
{
	if (iParam0 == 1)
	{
		if (!func_140(iParam1))
...
int func_189(bool bParam0)//Position - 0xCC57
{
	int iVar0;
...
int func_190(int iParam0)//Position - 0xCCEE
{
	bool bVar0;
...
var func_191()//Position - 0xD40B
{
	return Global_101572.f_1;
}

int func_192()//Position - 0xD419
{
	if (Global_98435 != -1)
	{
...
var func_196(int iParam0, int iParam1)//Position - 0xD491
{
	switch (iParam0)
	{
		case 5:
...
var func_197()//Position - 0xD4C9
{
	return Global_1575083;
}

int func_198()//Position - 0xD4D5
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_199(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD4F1
{
	var uVar0;
...
void func_200(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD579
{
...
void func_201(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD5B4
{
...
void func_202(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD60A
{
...
float func_203(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD6A5
{
	struct<3> Var0;
...
int func_204(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)//Position - 0xD6DF
{
	var uVar0;
...
int func_206(char* sParam0)//Position - 0xD837
{
	struct<6> Var0;
...
void func_208(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD87B
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_211(int iParam0, int iParam1)//Position - 0xD9E1
{
	bool bVar0;
	int iVar1;
...
void func_213(int iParam0)//Position - 0xDA8B
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_214(iParam0);
...
void func_214(int iParam0)//Position - 0xDAA2
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_217(int iParam0)//Position - 0xDEB6
{
	int iVar0;
...
void func_218(int* iParam0)//Position - 0xDF53
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_219(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)//Position - 0xDF7E
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_220(int iParam0)//Position - 0xDFB7
{
	if (func_137(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_222(var uParam0, bool bParam1)//Position - 0xE014
{
	struct<27> Var0;
...
void func_223(int iParam0, var uParam1, int iParam2)//Position - 0xE284
{
	int iVar0;
	int iVar1;
...
int func_224(int iParam0)//Position - 0xE5DC
{
...
int func_225(var uParam0)//Position - 0xE5FC
{
...
int func_226(var uParam0)//Position - 0xE614
{
...
int func_228(var uParam0, bool bParam1, bool bParam2)//Position - 0xE6B9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_229(int iParam0, int iParam1)//Position - 0xE877
{
	int iVar0;
...
int func_230(var uParam0, bool bParam1, int iParam2)//Position - 0xE8A7
{
	int iVar0;
	int iVar1;
...
int func_231(int iParam0)//Position - 0xEB63
{
...
int func_232(int iParam0, float fParam1)//Position - 0xEB97
{
	float fVar0;
...
bool func_233(int iParam0, float fParam1)//Position - 0xEC0D
{
	return func_234(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_234(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEC25
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_235(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xECE6
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_236(int iParam0, int iParam1)//Position - 0xEE12
{
	int iVar0;
...
int func_238(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEF21
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_239(struct<3> Param0, struct<3> Param3)//Position - 0xEFB2
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_240(struct<3> Param0)//Position - 0xEFD3
{
	float fVar0;
	float fVar1;
...
int func_242(int iParam0, int iParam1)//Position - 0xF02D
{
	int iVar0;
...
int func_243(int iParam0)//Position - 0xF06C
{
...
int func_244(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF094
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_245(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF18F
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_246(int iParam0, float fParam1)//Position - 0xF29B
{
	var uVar0;
	struct<3> Var1;
...
int func_247(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF330
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_248(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF3BE
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_249(int iParam0)//Position - 0xF406
{
...
int func_250(int iParam0)//Position - 0xF450
{
	if (iParam0 == -1)
	{
		iParam0 = func_178();
...
int func_251(int iParam0)//Position - 0xF4E5
{
...
int func_254(int iParam0)//Position - 0xF564
{
...
int func_256(int iParam0)//Position - 0xF5D6
{
	if (func_118(0))
	{
...
int func_258(int iParam0)//Position - 0xF62D
{
	switch (*iParam0)
	{
		case 32:
...
int func_259(var uParam0)//Position - 0xF68B
{
	int iVar0[5];
	int iVar6;
	bool bVar7;
...
void func_260(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF9AE
{
	func_261(iParam0);
...
void func_261(int* iParam0)//Position - 0xF9F1
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_262(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xFA8D
{
...
int func_263(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xFAE9
{
	int iVar0;
...
int func_264(var uParam0, int iParam1)//Position - 0xFB77
{
	int iVar0;
...
void func_265(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFBBD
{
	func_218(iParam0);
...
int func_266(var uParam0)//Position - 0xFBE4
{
	if (func_226(uParam0))
	{
...
int func_267(int iParam0)//Position - 0xFC0E
{
	int iVar0;
...
int func_269(var uParam0)//Position - 0xFC7B
{
	int iVar0[1];
	int iVar2;
...
int func_270(var uParam0)//Position - 0xFD8E
{
	int iVar0[4];
	int iVar5;
	bool bVar6;
...
void func_271(int iParam0, int iParam1)//Position - 0x100B3
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_272(int iParam0)//Position - 0x100E9
{
	struct<27> Var0;
	bool bVar32;
...
int func_273(int iParam0)//Position - 0x1013A
{
	char* sVar0;
...
int func_274(int iParam0)//Position - 0x101F3
{
	var uVar0;
...
int func_275(int iParam0)//Position - 0x102B4
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_277(int iParam0)//Position - 0x1041B
{
...
int func_278(int iParam0)//Position - 0x10446
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_279(int iParam0)//Position - 0x10471
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_280(int iParam0)//Position - 0x1049C
{
	if (func_251(iParam0))
	{
		return 0;
...
int func_282(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x104EB
{
	int iVar0;
...
int func_283(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10550
{
	int iVar0;
	struct<7> Var1;
...
int func_284(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x105C8
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_285(int iParam0, bool bParam1)//Position - 0x10643
{
	char* sVar0;
...
void func_293(int* iParam0, bool bParam1)//Position - 0x10826
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_296(int* iParam0)//Position - 0x108B0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_299(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1093B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_300(int* iParam0)//Position - 0x1098B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_301(var uParam0)//Position - 0x109CC
{
	if (*uParam0 == -1)
	{
		return;
...
int func_305(int iParam0)//Position - 0x10A68
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
