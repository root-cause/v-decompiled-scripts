...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_90 = func_303(56);
	iLocal_91 = func_303(57);
	iLocal_92 = func_303(59);
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112897[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_299(&(Global_112897[Var0.f_0 /*10*/].f_9));
			}
		}
		func_283(&Var0, 1);
	}
	...
	while (true)
	{
		...
		{
			func_219();
			if (func_218(Var0.f_35[1]))
			{
				if (!func_217(329.513f, 3402.691f, 36.258f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[1], true), 1056964608))
				{
					func_300("Player has moved SURFER2 vehicle [TERMINATING]");
					func_214(&Var0);
					func_283(&Var0, 1);
				}
			}
		...
		func_213(Var0.f_0);
		func_206(&iLocal_94, &(Var0.f_9), Var61);
		if (Var0.f_0 == 32)
		{
			func_202(&Var0, Var61, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_97);
		}
		else if (Var0.f_0 == 34)
		{
			func_197(&Var0, Var61, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
		}
		if (func_183(&Var0, 0))
		{
...
int func_64(int iParam0, int iParam1)//Position - 0x493F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x55F0
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x562B
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x589F
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x58DB
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5E2A
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5E6E
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x65ED
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x6634
{
...
bool func_73(int iParam0)//Position - 0x668F
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x669F
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x66FF
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x6AA7
{
	return Global_32283;
}

int func_77(int iParam0)//Position - 0x6AB2
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6AC2
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6B64
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x72CF
{
...
int func_81()//Position - 0x75CA
{
	return Global_2652364.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x75D9
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x7603
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x7618
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x762F
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x7687
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7731
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x77C6
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x780A
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x798E
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x799C
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x8467
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x84E9
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x8541
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x854A
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x87B6
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x87C6
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x87E3
{
...
bool func_100()//Position - 0x8B29
{
	return Global_100885.f_393 > 0;
}

var func_101()//Position - 0x8B3A
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8B80
{
	if (iParam1 <= 0)
	{
		return;
...
void func_103(var uParam0, int iParam1)//Position - 0x8C06
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8C39
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8C8A
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8D2C
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8D4E
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8D65
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8D72
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8DAC
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8DE7
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8E23
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8E3C
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8E95
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8EAB
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8EC1
{
...
int func_117(bool bParam0)//Position - 0x8F03
{
...
struct<2> func_118(int iParam0)//Position - 0x8F2B
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x9378
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA650
{
	switch (iParam0)
	{
		case 0:
...
int func_122(var* uParam0)//Position - 0xA996
{
	int iVar0;
...
void func_123(int iParam0)//Position - 0xAA3B
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xAAD6
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xAB34
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xAB8D
{
...
int func_128(int iParam0)//Position - 0xAC10
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAC41
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAC56
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xAD09
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAD24
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xAD70
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xADB9
{
	if (func_136(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xADD9
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_137(int iParam0)//Position - 0xADFA
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xAECA
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xAF1D
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xB012
{
	switch (iParam0)
	{
		case 5:
...
void func_142(bool bParam0)//Position - 0xB07D
{
	int iVar0;
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB0BC
{
	if (bParam0)
	{
...
bool func_144()//Position - 0xB209
{
	return BitTest(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_36.f_18, 14);
}

bool func_145(int iParam0, int iParam1)//Position - 0xB223
{
	bool bVar0;
...
int func_146(int iParam0, bool bParam1)//Position - 0xB27C
{
	int iVar0;
	int iVar1;
...
int func_147(var uParam0)//Position - 0xB2BD
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB2DF
{
...
bool func_149()//Position - 0xB31E
{
	return BitTest(Global_2621446, 3);
}

int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB32C
{
	int iVar0;
...
void func_152(int iParam0)//Position - 0xB386
{
	if (iParam0 == 1)
	{
...
int func_153(char* sParam0)//Position - 0xB3A9
{
...
void func_154()//Position - 0xB3E6
{
	Global_20711 = 0;
	func_155();
}

void func_155()//Position - 0xB3F6
{
...
int func_159(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB4DC
{
...
void func_160(int iParam0)//Position - 0xB674
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_162(int iParam0)//Position - 0xB6F1
{
	if (func_167())
	{
		return;
...
void func_163(int iParam0)//Position - 0xB724
{
	if (func_167())
	{
		return;
...
void func_164(bool bParam0, bool bParam1)//Position - 0xB7AE
{
	if (bParam0)
	{
		if (func_166(0))
...
bool func_165()//Position - 0xB822
{
	return BitTest(Global_1963795, 5);
}

int func_166(int iParam0)//Position - 0xB830
{
	if (iParam0 == 1)
	{
...
bool func_167()//Position - 0xB887
{
	return BitTest(Global_1963795, 19);
}

int func_168(int iParam0)//Position - 0xB896
{
...
int func_169(int iParam0)//Position - 0xB8D7
{
	int iVar0;
...
void func_170(int iParam0)//Position - 0xB91C
{
...
int func_171(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB94E
{
	int iVar0;
...
void func_172(var uParam0, int iParam1)//Position - 0xBA85
{
	int iVar0;
...
bool func_173(int iParam0)//Position - 0xBAD4
{
	return func_174(iParam0, Global_43377);
}

int func_174(int iParam0, int iParam1)//Position - 0xBAE5
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_175(int iParam0)//Position - 0xBCC6
{
	if (Global_43377 == 15)
	{
		return 0;
...
int func_176()//Position - 0xBCE8
{
	return func_177(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_177(char* sParam0, int iParam1)//Position - 0xBCF9
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_179(int iParam0, int iParam1)//Position - 0xBD66
{
	switch (iParam0)
	{
		case 0:
...
int func_180(struct<3> Param0, bool bParam3)//Position - 0xC1D9
{
	int iVar0;
...
float func_181(bool bParam0, float fParam1, float fParam2)//Position - 0xC205
{
	if (bParam0)
	{
		return fParam1;
...
int func_182(int iParam0)//Position - 0xC21C
{
	switch (iParam0)
	{
		case 0:
...
int func_183(int iParam0, int iParam1)//Position - 0xC2AB
{
	switch (iParam0->f_16)
	{
		case 0:
...
void func_184()//Position - 0xCA8E
{
	func_27(&(Global_104373.f_2890), &Global_104373, 0, 1, 1, 0);
}

int func_185(var uParam0)//Position - 0xCAA9
{
	float fVar0;
...
void func_186(int iParam0, int iParam1)//Position - 0xCB37
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_187(bool bParam0)//Position - 0xCB9B
{
	int iVar0;
...
int func_188(int iParam0)//Position - 0xCC32
{
	bool bVar0;
...
var func_189()//Position - 0xD34F
{
	return Global_100872.f_1;
}

int func_190()//Position - 0xD35D
{
	if (Global_97735 != -1)
	{
...
bool func_193()//Position - 0xD3C4
{
	return Global_100885.f_394 > 0;
}

var func_194(int iParam0, int iParam1)//Position - 0xD3D5
{
	switch (iParam0)
	{
		case 5:
...
var func_195()//Position - 0xD40D
{
	return Global_1575063;
}

int func_196()//Position - 0xD419
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_197(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD435
{
	var uVar0;
	
	if ((((func_136(PLAYER::PLAYER_PED_ID()) && func_136(iParam0->f_28[0])) && !func_156()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_201(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_198(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD4BD
{
...
void func_199(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD4F8
{
...
void func_200(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD54E
{
...
float func_201(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD5E9
{
	struct<3> Var0;
...
int func_202(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)//Position - 0xD623
{
	var uVar0;
	...
	if (!*uParam10 == 3)
	{
		if (func_188(2))
		{
			if (!func_156())
			{
				if (((func_136(PLAYER::PLAYER_PED_ID()) && func_136(iParam0->f_28[0])) && func_136(iParam0->f_28[1])) && func_201(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
					func_300("start conversation");
					uVar0 = 16;
					if (*uParam10 == 0)
					{
						func_200(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
						func_200(&uVar0, iParam8, iParam0->f_28[1], sParam9, 0, 1);
						func_198(&uVar0, cParam4, sParam5, 7, 0, 0);
						*uParam10 = 2;
					}
					else if (*uParam10 == 2)
					{
						func_300("conversation ended");
						*uParam10 = 3;
						return 1;
					}
				}
			}
			else if (((func_204(sParam5) && !*uParam10 == 1) && func_136(PLAYER::PLAYER_PED_ID())) && func_201(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
			{
				func_300("pause conversation");
				func_203(1);
				*uParam10 = 1;
			}
			if (func_201(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam10 == 1)
			{
				func_300("unpause conversation");
				func_203(0);
				*uParam10 = 2;
			}
		}
...
void func_203(int iParam0)//Position - 0xD76E
{
	Global_22856 = iParam0;
}

int func_204(char* sParam0)//Position - 0xD77B
{
	struct<6> Var0;
...
struct<6> func_205()//Position - 0xD79B
{
	struct<6> Var0;
...
void func_206(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD7BF
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_207(int iParam0, bool bParam1)//Position - 0xD8B0
{
	if (iParam0 == -1)
	{
		return;
...
int func_208(int iParam0)//Position - 0xD8EC
{
	if (Global_78685 == iParam0)
	{
		if (Global_78686 == -1)
...
void func_209(int iParam0, int iParam1)//Position - 0xD925
{
	bool bVar0;
	int iVar1;
...
bool func_210()//Position - 0xD9C3
{
	return Global_98122;
}

void func_211(int iParam0)//Position - 0xD9CF
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_212(iParam0);
...
void func_212(int iParam0)//Position - 0xD9E6
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_213(int iParam0)//Position - 0xDACE
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
void func_214(var uParam0)//Position - 0xDAF6
{
	int iVar0;
	int iVar1;
...
void func_215(int iParam0)//Position - 0xDDFA
{
	int iVar0;
...
void func_216(int* iParam0)//Position - 0xDE97
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_217(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)//Position - 0xDEC2
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_218(int iParam0)//Position - 0xDEFB
{
	if (func_136(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_220(var uParam0, bool bParam1)//Position - 0xDF58
{
	struct<27> Var0;
	...
	if ((func_254(*uParam0) || func_252(*uParam0)) || Global_78935 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_221(int iParam0, var uParam1, int iParam2)//Position - 0xE1C8
{
	int iVar0;
	int iVar1;
...
int func_222(int iParam0)//Position - 0xE520
{
...
int func_223(var uParam0)//Position - 0xE540
{
...
int func_224(var uParam0)//Position - 0xE558
{
...
void func_225(var uParam0)//Position - 0xE57D
{
	int iVar0;
...
int func_226(var uParam0, bool bParam1, bool bParam2)//Position - 0xE5FD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_227(int iParam0, int iParam1)//Position - 0xE7BB
{
	int iVar0;
...
int func_228(var uParam0, bool bParam1, int iParam2)//Position - 0xE7EB
{
	int iVar0;
	int iVar1;
...
int func_229(int iParam0)//Position - 0xEAA7
{
...
int func_230(int iParam0, float fParam1)//Position - 0xEADB
{
	float fVar0;
...
bool func_231(int iParam0, float fParam1)//Position - 0xEB51
{
	return func_232(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_232(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEB69
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_233(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xEC2A
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_234(int iParam0, int iParam1)//Position - 0xED56
{
	int iVar0;
...
int func_236(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEE65
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_237(struct<3> Param0, struct<3> Param3)//Position - 0xEEF6
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_238(struct<3> Param0)//Position - 0xEF17
{
	float fVar0;
	float fVar1;
...
void func_239(var uParam0)//Position - 0xEF56
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_240(int iParam0, int iParam1)//Position - 0xEF71
{
	int iVar0;
...
int func_241(int iParam0)//Position - 0xEFB0
{
...
int func_242(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEFD8
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_243(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF0D3
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_244(int iParam0, float fParam1)//Position - 0xF1DF
{
	var uVar0;
	struct<3> Var1;
...
int func_245(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF274
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_246(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF302
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_247(int iParam0)//Position - 0xF34A
{
...
int func_248(int iParam0)//Position - 0xF394
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
int func_249(int iParam0)//Position - 0xF429
{
...
int func_252(int iParam0)//Position - 0xF4A8
{
	if ((func_253() && Global_100833.f_11 == 6) && iParam0 == func_177(&(Global_100833.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_254(int iParam0)//Position - 0xF51A
{
	if (func_117(0))
	{
...
int func_257(var uParam0)//Position - 0xF5CE
{
	int iVar0[5];
	int iVar6;
	bool bVar7;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_266(&(uParam0->f_48), "rcmminute3base", "base", "beckon");
		...
		case 2:
			...
			{
				func_263(&(uParam0->f_41[0]), iVar0[3], -303.74f, 6211.56f, 30.49f, -176.77f);
			...
			{
				if (func_260(&(uParam0->f_28[0]), 59, uParam0->f_48.f_5, -2.8f, "RCM MINUTE - MANUEL", 1))
				{
			...
			{
				func_258(&(uParam0->f_35[0]), iVar0[0], -281.93f, 6198.32f, 30.77f, -135.32f);
			...
			{
				func_258(&(uParam0->f_35[1]), iVar0[1], -291.72f, 6208.33f, 30.87f, -134.50163f);
			...
			{
				func_263(&(uParam0->f_41[1]), iVar0[4], -303.74f, 6211.56f, 30.49f, -176.77f);
...
void func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF8F1
{
	func_259(iParam0);
...
void func_259(int* iParam0)//Position - 0xF933
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_260(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF9CF
{
...
int func_261(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xFA2B
{
	int iVar0;
...
int func_262(var uParam0, int iParam1)//Position - 0xFAB9
{
	int iVar0;
...
void func_263(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFAFF
{
	func_216(iParam0);
...
int func_264(var uParam0)//Position - 0xFB26
{
	if (func_224(uParam0))
	{
...
int func_265(int iParam0)//Position - 0xFB50
{
	int iVar0;
...
void func_266(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xFB81
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_267(var uParam0)//Position - 0xFBBD
{
	int iVar0[1];
	int iVar2;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			func_258(&(uParam0->f_35[0]), iVar0[0], 20.8f, 4532.65f, 104.66f, 284.7f);
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
...
int func_268(var uParam0)//Position - 0xFCD0
{
	int iVar0[4];
	int iVar5;
	bool bVar6;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			MISC::CLEAR_AREA(321.69f, 3408.64f, 35.34f, 10f, true, false, false, false);
			if (!func_265(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_260(&(uParam0->f_28[0]), 56, 329.3f, 3404.2f, 35.8f, -174.9f, "RCM MINUTE - JOE", 1))
				{
			...
			{
				if (func_260(&(uParam0->f_28[1]), 57, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_258(&(uParam0->f_35[0]), iVar0[0], 321.69f, 3408.64f, 35.34f, -105.8f);
				func_269(uParam0->f_35[0], iVar0[0]);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_258(&(uParam0->f_35[1]), iVar0[1], 329.49f, 3402.71f, 36.29f, 284.36f);
				func_269(uParam0->f_35[1], iVar0[1]);
...
void func_269(int iParam0, int iParam1)//Position - 0xFFF4
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_270(int iParam0)//Position - 0x1002B
{
	struct<27> Var0;
	bool bVar32;
...
int func_271(int iParam0)//Position - 0x1007C
{
	char* sVar0;
...
int func_272(int iParam0)//Position - 0x10135
{
	var uVar0;
...
int func_273(int iParam0)//Position - 0x101F6
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_274(int iParam0, char* sParam1)//Position - 0x1027B
{
...
int func_275(int iParam0)//Position - 0x1035D
{
...
int func_276(int iParam0)//Position - 0x10388
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_277(int iParam0)//Position - 0x103B3
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_278(int iParam0)//Position - 0x103DE
{
	if (func_249(iParam0))
	{
		return 0;
...
void func_279()//Position - 0x10413
{
	func_300("Running end routines.");
	Global_113528 = (Global_113528 - 1);
}

int func_280(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x1042D
{
	int iVar0;
...
int func_281(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10492
{
	int iVar0;
	struct<7> Var1;
...
int func_282(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x1050A
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_283(int iParam0, bool bParam1)//Position - 0x10585
{
	char* sVar0;
...
void func_284(char* sParam0)//Position - 0x10672
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_204(sParam0))
...
void func_285()//Position - 0x10691
{
	Global_20711 = 0;
	func_286();
}

void func_286()//Position - 0x106A1
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22856 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_287(var uParam0)//Position - 0x106C2
{
	if (func_224(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_288(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x106F8
{
...
void func_289(var uParam0, bool bParam1)//Position - 0x10718
{
	func_290(&(uParam0->f_41), bParam1);
}

void func_290(var uParam0, bool bParam1)//Position - 0x1072A
{
	int iVar0;
...
void func_291(int* iParam0, bool bParam1)//Position - 0x10768
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_292(var uParam0, bool bParam1)//Position - 0x107A3
{
	func_293(&(uParam0->f_35), bParam1);
}

void func_293(var uParam0, bool bParam1)//Position - 0x107B5
{
	int iVar0;
...
void func_294(int* iParam0)//Position - 0x107F2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_295(var uParam0, int iParam1)//Position - 0x1082A
{
	func_296(&(uParam0->f_28), iParam1);
}

void func_296(var uParam0, int iParam1)//Position - 0x1083C
{
	int iVar0;
...
void func_297(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1087D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_298(int* iParam0)//Position - 0x108CD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_299(var uParam0)//Position - 0x1090E
{
	if (*uParam0 == -1)
	{
		return;
...
void func_300(char* sParam0)//Position - 0x1094B
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_301(var uParam0)//Position - 0x1095D
{
	*uParam0 = -1;
...
void func_302()//Position - 0x10990
{
	func_300("Running start routines.");
	Global_113528++;
}

int func_303(int iParam0)//Position - 0x109AA
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
