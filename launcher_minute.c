...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_52 = func_295(56);
	iLocal_53 = func_295(57);
	iLocal_54 = func_295(59);
	...
	if (!func_272(&iVar2, &Var0, Var1, 1f))
	{
		func_271();
	...
	while (true)
	{
		...
		{
			func_211();
			if (func_210(Var0.f_35[1]))
			{
				if (!func_209(329.513f, 3402.691f, 36.258f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[1], true), 1056964608))
				{
					func_292("Player has moved SURFER2 vehicle [TERMINATING]");
					func_206(&Var0);
					func_275(&Var0, 1);
				}
			}
		...
		func_205(Var0.f_0);
		func_198(&iLocal_56, &(Var0.f_9), Var1);
		if (Var0.f_0 == 32)
		{
			func_194(&Var0, Var1, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_59);
		}
		else if (Var0.f_0 == 34)
		{
			func_189(&Var0, Var1, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
		}
		if (func_175(&Var0, 0))
		{
			if (func_174(Var0.f_0))
			{
				func_171(Var0.f_0, &iLocal_58);
			}
			if (!func_2(&Var0))
			{
				func_275(&Var0, 1);
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3FCD
{
	int iVar0;
...
int func_61(int iParam0)//Position - 0x474A
{
...
int func_62(int iParam0, int iParam1)//Position - 0x4912
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x54B3
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x54EE
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x5762
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x579E
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5CED
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5D31
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x64B0
{
	if (bParam2)
	{
...
int func_70(var uParam0)//Position - 0x64F7
{
...
bool func_71(int iParam0)//Position - 0x6552
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x6562
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x65C3
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x693E
{
	return Global_31959;
}

int func_75(int iParam0)//Position - 0x6949
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6959
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x69FB
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x7120
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x7178
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7222
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
...
Vector3 func_81(struct<3> Param0, float fParam1)//Position - 0x72B7
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_82(int iParam0)//Position - 0x72FB
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x747F
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x748D
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7F54
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7FD6
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x8032
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x803B
{
	switch (iParam0)
	{
		case 1:
...
int func_89()//Position - 0x8297
{
	return func_90(PLAYER::PLAYER_ID());
}

int func_90(int iParam0)//Position - 0x82A7
{
	return MISC::GET_BITS_IN_RANGE(Global_2689235[iParam0 /*453*/].f_318.f_3, 28, 31);
}

int func_91(int iParam0)//Position - 0x82C4
{
	return func_72(iParam0, 0, 0);
}

int func_92(int iParam0)//Position - 0x82D4
{
	switch (iParam0)
	{
		case -1:
...
bool func_93()//Position - 0x85E3
{
	return Global_100493.f_375 > 0;
}

var func_94()//Position - 0x85F4
{
	var uVar0;
...
void func_95(var uParam0, int iParam1)//Position - 0x863A
{
	if (iParam1 <= 0)
	{
		return;
...
void func_96(var uParam0, int iParam1)//Position - 0x86C0
{
...
void func_97(var uParam0, int iParam1)//Position - 0x86F3
{
	int iVar0;
	int iVar1;
...
int func_98(int iParam0, int iParam1)//Position - 0x8744
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_99(int iParam0)//Position - 0x87E6
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_100(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_100(bool bParam0, int iParam1, int iParam2)//Position - 0x8808
{
	if (bParam0)
	{
		return iParam1;
...
int func_101(var uParam0)//Position - 0x881F
{
	return uParam0 & 15;
}

void func_102(var uParam0, int iParam1)//Position - 0x882C
{
...
void func_103(var uParam0, int iParam1)//Position - 0x8866
{
...
void func_104(var uParam0, int iParam1)//Position - 0x88A1
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_105()//Position - 0x88DD
{
	func_56();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_106(int iParam0)//Position - 0x88F6
{
	var uVar0;
	char cVar1[24];
...
bool func_107()//Position - 0x894F
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_108()//Position - 0x8965
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_109(char* sParam0, int iParam1, int iParam2)//Position - 0x897B
{
...
int func_110(bool bParam0)//Position - 0x89BD
{
...
struct<2> func_111(int iParam0)//Position - 0x89E5
{
	struct<2> Var0;
...
void func_112(int iParam0, var uParam1)//Position - 0x8E32
{
	switch (iParam0)
	{
		case 0:
...
int func_114(int iParam0)//Position - 0xA10A
{
	switch (iParam0)
	{
		case 0:
...
int func_115(var* uParam0)//Position - 0xA450
{
	int iVar0;
...
void func_116(int iParam0)//Position - 0xA4F5
{
	struct<2> Var0;
...
void func_117(int iParam0)//Position - 0xA590
{
	if (iParam0 < 63)
	{
		func_118();
...
void func_119(int iParam0)//Position - 0xA5EE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_120(int iParam0)//Position - 0xA647
{
...
int func_121(int iParam0)//Position - 0xA6CA
{
	int iVar0;
...
void func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA6FB
{
	func_123(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_123(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA710
{
	int iVar0;
...
int func_125(int iParam0, int iParam1, int iParam2)//Position - 0xA7C3
{
...
int func_126(int iParam0, int iParam1, int iParam2)//Position - 0xA7DE
{
	int iVar0;
...
int func_127(int iParam0)//Position - 0xA82A
{
	int iVar0;
...
int func_128(int iParam0)//Position - 0xA873
{
	if (func_129(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_129(int iParam0)//Position - 0xA893
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_130(int iParam0)//Position - 0xA8B4
{
	switch (iParam0)
	{
		case 5:
...
int func_132(int iParam0)//Position - 0xA984
{
	switch (iParam0)
	{
		case 5:
...
void func_133(var uParam0, bool bParam1, bool bParam2)//Position - 0xA9D7
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xAACC
{
	switch (iParam0)
	{
		case 5:
...
void func_135(bool bParam0)//Position - 0xAB37
{
	int iVar0;
...
void func_136(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAB76
{
	if (bParam0)
	{
...
bool func_138(int iParam0, int iParam1)//Position - 0xACD3
{
	bool bVar0;
...
int func_139(int iParam0, bool bParam1)//Position - 0xAD1E
{
	int iVar0;
	int iVar1;
...
int func_140(int iParam0)//Position - 0xAD5F
{
...
bool func_141()//Position - 0xAD9E
{
	return BitTest(Global_2621446, 3);
}

int func_142(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xADAC
{
	int iVar0;
...
void func_144(int iParam0)//Position - 0xAE06
{
	if (iParam0 == 1)
	{
...
int func_145(char* sParam0)//Position - 0xAE29
{
...
void func_146()//Position - 0xAE66
{
	Global_20471 = 0;
	func_147();
}

void func_147()//Position - 0xAE76
{
...
int func_151(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAF5C
{
...
void func_152(int iParam0)//Position - 0xB0F4
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_154(int iParam0)//Position - 0xB171
{
	if (func_159())
	{
		return;
...
void func_155(int iParam0)//Position - 0xB1A4
{
	if (func_159())
	{
		return;
...
void func_156(bool bParam0, bool bParam1)//Position - 0xB22E
{
	if (bParam0)
	{
		if (func_158(0))
...
bool func_157()//Position - 0xB2A2
{
	return BitTest(Global_1958711, 5);
}

int func_158(int iParam0)//Position - 0xB2B0
{
	if (iParam0 == 1)
	{
...
bool func_159()//Position - 0xB307
{
	return BitTest(Global_1958711, 19);
}

int func_160(int iParam0)//Position - 0xB316
{
...
int func_161(int iParam0)//Position - 0xB357
{
	int iVar0;
...
void func_162(int iParam0)//Position - 0xB39C
{
...
int func_163(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB3CE
{
	int iVar0;
...
void func_164(var uParam0, int iParam1)//Position - 0xB505
{
	int iVar0;
...
bool func_165(int iParam0)//Position - 0xB554
{
	return func_166(iParam0, Global_43052);
}

int func_166(int iParam0, int iParam1)//Position - 0xB565
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_167(int iParam0)//Position - 0xB746
{
	if (Global_43052 == 15)
	{
		return 0;
...
int func_168()//Position - 0xB768
{
	return func_169(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_169(char* sParam0, int iParam1)//Position - 0xB779
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_171(int iParam0, int iParam1)//Position - 0xB7E6
{
	switch (iParam0)
	{
		case 0:
			*iParam1 = func_172(-1604.668f, 5239.1f, 3.01f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 66);
			HUD::SET_BLIP_COLOUR(*iParam1, 42);
			break;
		
		case 1:
			*iParam1 = func_172(-1592.84f, 5214.04f, 3.01f, 0);
		...
		case 2:
		case 3:
			*iParam1 = func_172(190.26f, -956.35f, 29.63f, 0);
		...
		case 4:
			*iParam1 = func_172(414f, -761f, 29f, 0);
		...
		case 9:
			*iParam1 = func_172(-1622.89f, 4204.87f, 83.3f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 66);
			HUD::SET_BLIP_COLOUR(*iParam1, 42);
			break;
		...
		case 13:
			if (iParam0 == 11)
			{
				*iParam1 = func_172(1835.53f, 4705.86f, 38.1f, 0);
			}
			else if (iParam0 == 12)
			{
				*iParam1 = func_172(1826.13f, 4698.88f, 38.92f, 0);
			}
			else
			{
				*iParam1 = func_172(637.02f, 119.7093f, 89.5f, 0);
			}
		...
		case 19:
			if (iParam0 == 18)
			{
				*iParam1 = func_172(-954.19f, -2760.05f, 14.64f, 0);
			}
			else
			{
				*iParam1 = func_172(-63.8f, -809.5f, 321.8f, 0);
			}
		...
		case 23:
			if (iParam0 == 21)
			{
				*iParam1 = func_172(-1877.82f, -440.649f, 45.05f, 0);
			}
			else
			{
				*iParam1 = func_172(-915.6f, 6139.2f, 5.5f, 0);
			}
		...
		case 27:
			*iParam1 = func_172(-1104.93f, 291.25f, 64.3f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 66);
			HUD::SET_BLIP_COLOUR(*iParam1, 44);
			break;
		...
		case 34:
			*iParam1 = func_172(-303.82f, 6211.29f, 31.05f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 386);
			HUD::SET_BLIP_COLOUR(*iParam1, 44);
			break;
		
		case 43:
			*iParam1 = func_172(-44.75f, -1288.67f, 28.21f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 149);
			HUD::SET_BLIP_COLOUR(*iParam1, 44);
			break;
		
		case 46:
			*iParam1 = func_172(-149.75f, 285.81f, 93.67f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 66);
			HUD::SET_BLIP_COLOUR(*iParam1, 43);
			break;
		...
		case 48:
			if (iParam0 == 47)
			{
				*iParam1 = func_172(-70.71f, 301.43f, 106.79f, 0);
			}
			else
			{
				*iParam1 = func_172(-257.22f, 292.85f, 90.63f, 0);
			}
...
int func_172(struct<3> Param0, bool bParam1)//Position - 0xBC55
{
	int iVar0;
	
	iVar0 = HUD::ADD_BLIP_FOR_COORD(Param0);
	HUD::SET_BLIP_SCALE(iVar0, func_173(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
	HUD::SET_BLIP_ROUTE(iVar0, bParam1);
	return iVar0;
}

float func_173(bool bParam0, float fParam1, float fParam2)//Position - 0xBC81
{
	if (bParam0)
	{
		return fParam1;
...
int func_175(int iParam0, int iParam1)//Position - 0xBD27
{
	switch (iParam0->f_16)
	{
		case 0:
...
void func_176()//Position - 0xC50B
{
	func_27(&(Global_103950.f_2890), &Global_103950, 0, 1, 1, 0);
}

int func_177(var uParam0)//Position - 0xC526
{
	float fVar0;
...
void func_178(int iParam0, int iParam1)//Position - 0xC5B4
{
	if (iParam0 == 1)
	{
		if (!func_132(iParam1))
...
int func_179(bool bParam0)//Position - 0xC618
{
	int iVar0;
...
int func_180(int iParam0)//Position - 0xC6AF
{
	bool bVar0;
...
var func_181()//Position - 0xCDCC
{
	return Global_100480.f_1;
}

int func_182()//Position - 0xCDDA
{
	if (Global_97363 != -1)
	{
...
bool func_185()//Position - 0xCE41
{
	return Global_100493.f_376 > 0;
}

var func_186(int iParam0, int iParam1)//Position - 0xCE52
{
	switch (iParam0)
	{
		case 5:
...
var func_187()//Position - 0xCE8A
{
	return Global_1575058;
}

int func_188()//Position - 0xCE96
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_189(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xCEB2
{
	var uVar0;
	
	if ((((func_129(PLAYER::PLAYER_PED_ID()) && func_129(iParam0->f_28[0])) && !func_148()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_193(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_192(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
		func_190(&uVar0, cParam2, sParam3, 7, 0, 0);
...
void func_190(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCF3A
{
...
void func_191(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCF75
{
...
void func_192(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCFCB
{
...
float func_193(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xD066
{
	struct<3> Var0;
...
int func_194(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)//Position - 0xD0A0
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_180(2))
		{
			if (!func_148())
			{
				if (((func_129(PLAYER::PLAYER_PED_ID()) && func_129(iParam0->f_28[0])) && func_129(iParam0->f_28[1])) && func_193(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
					func_292("start conversation");
					uVar0 = 16;
					if (*uParam8 == 0)
					{
						func_192(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
						func_192(&uVar0, iParam6, iParam0->f_28[1], sParam7, 0, 1);
						func_190(&uVar0, cParam2, sParam3, 7, 0, 0);
						*uParam8 = 2;
					}
					else if (*uParam8 == 2)
					{
						func_292("conversation ended");
						*uParam8 = 3;
						return 1;
					}
				}
			}
			else if (((func_196(sParam3) && !*uParam8 == 1) && func_129(PLAYER::PLAYER_PED_ID())) && func_193(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
			{
				func_292("pause conversation");
				func_195(1);
				*uParam8 = 1;
			}
			if (func_193(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam8 == 1)
			{
				func_292("unpause conversation");
				func_195(0);
				*uParam8 = 2;
			}
		}
...
void func_195(int iParam0)//Position - 0xD1EB
{
	Global_22616 = iParam0;
}

int func_196(char* sParam0)//Position - 0xD1F8
{
	struct<6> Var0;
...
struct<6> func_197()//Position - 0xD218
{
	struct<6> Var0;
...
void func_198(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD23C
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_199(int iParam0, bool bParam1)//Position - 0xD32D
{
	if (iParam0 == -1)
	{
		return;
...
int func_200(int iParam0)//Position - 0xD369
{
	if (Global_78315 == iParam0)
	{
		if (Global_78316 == -1)
...
void func_201(int iParam0, int iParam1)//Position - 0xD3A2
{
	bool bVar0;
	int iVar1;
...
bool func_202()//Position - 0xD440
{
	return Global_97750;
}

void func_203(int iParam0)//Position - 0xD44C
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_204(iParam0);
...
void func_204(int iParam0)//Position - 0xD463
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_205(int iParam0)//Position - 0xD54B
{
	if (iParam0 == -1)
	{
		iParam0 = func_168();
...
void func_206(var uParam0)//Position - 0xD573
{
	int iVar0;
	int iVar1;
	...
	if (*uParam0 == 52)
	{
		func_208(&(uParam0->f_41[1]));
		func_208(&(uParam0->f_41[2]));
	}
...
void func_207(int iParam0)//Position - 0xD877
{
	int iVar0;
...
void func_208(int* iParam0)//Position - 0xD914
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_209(struct<2> Param0, float fParam1, struct<2> Param2, Vector3 vParam3, float fParam4)//Position - 0xD93F
{
	if (fParam4 < 0f)
	{
		fParam4 = 0f;
...
int func_210(int iParam0)//Position - 0xD978
{
	if (func_129(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_212(var uParam0, bool bParam1)//Position - 0xD9D5
{
	struct<27> Var0;
...
void func_213(int iParam0, var uParam1, int iParam2)//Position - 0xDC45
{
	int iVar0;
	int iVar1;
...
int func_214(int iParam0)//Position - 0xDF9D
{
...
int func_215(var uParam0)//Position - 0xDFBD
{
...
int func_216(var uParam0)//Position - 0xDFD5
{
...
void func_217(var uParam0)//Position - 0xDFFA
{
	int iVar0;
...
int func_218(var uParam0, bool bParam1, bool bParam2)//Position - 0xE07A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_219(int iParam0, int iParam1)//Position - 0xE238
{
	int iVar0;
...
int func_220(var uParam0, bool bParam1, int iParam2)//Position - 0xE268
{
	int iVar0;
	int iVar1;
...
int func_221(int iParam0)//Position - 0xE524
{
...
int func_222(int iParam0, float fParam1)//Position - 0xE558
{
	float fVar0;
...
bool func_223(int iParam0, float fParam1)//Position - 0xE5CE
{
	return func_224(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_224(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE5E6
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
...
int func_225(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE6A7
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_226(int iParam0, int iParam1)//Position - 0xE7D3
{
	int iVar0;
...
int func_228(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE8E2
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
float func_229(struct<3> Param0, struct<3> Param1)//Position - 0xE973
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_230(struct<3> Param0)//Position - 0xE994
{
	float fVar0;
	float fVar1;
...
void func_231(var uParam0)//Position - 0xE9D3
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_232(int iParam0, int iParam1)//Position - 0xE9EE
{
	int iVar0;
...
int func_233(int iParam0)//Position - 0xEA2D
{
...
int func_234(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEA55
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_235(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEB50
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_236(int iParam0, float fParam1)//Position - 0xEC5C
{
	var uVar0;
	struct<3> Var1;
...
int func_237(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xECF1
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_238(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xED7F
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_239(int iParam0)//Position - 0xEDC7
{
...
int func_240(int iParam0)//Position - 0xEE11
{
	if (iParam0 == -1)
	{
		iParam0 = func_168();
...
int func_241(int iParam0)//Position - 0xEEA6
{
...
int func_244(int iParam0)//Position - 0xEF25
{
	if ((func_245() && Global_100441.f_11 == 6) && iParam0 == func_169(&(Global_100441.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_246(int iParam0)//Position - 0xEF97
{
	if (func_110(0))
	{
...
int func_249(var uParam0)//Position - 0xF04B
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_258(&(uParam0->f_48), "rcmminute3base", "base", "beckon");
		...
		case 2:
			...
			{
				func_255(&(uParam0->f_41[0]), iVar0[3], -303.74f, 6211.56f, 30.49f, -176.77f);
			...
			{
				if (func_252(&(uParam0->f_28[0]), 59, uParam0->f_48.f_5, -2.8f, "RCM MINUTE - MANUEL", 1))
				{
			...
			{
				func_250(&(uParam0->f_35[0]), iVar0[0], -281.93f, 6198.32f, 30.77f, -135.32f);
			...
			{
				func_250(&(uParam0->f_35[1]), iVar0[1], -291.72f, 6208.33f, 30.87f, -134.50163f);
			...
			{
				func_255(&(uParam0->f_41[1]), iVar0[4], -303.74f, 6211.56f, 30.49f, -176.77f);
...
void func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xF36D
{
	func_251(iParam0);
...
void func_251(int* iParam0)//Position - 0xF3AF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_252(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xF44B
{
...
int func_253(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xF4A7
{
	int iVar0;
...
int func_254(var uParam0, int iParam1)//Position - 0xF535
{
	int iVar0;
...
void func_255(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xF57B
{
	func_208(iParam0);
...
int func_256(var uParam0)//Position - 0xF5A2
{
	if (func_216(uParam0))
	{
...
int func_257(int iParam0)//Position - 0xF5CC
{
	int iVar0;
...
void func_258(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xF5FD
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_259(var uParam0)//Position - 0xF639
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			func_250(&(uParam0->f_35[0]), iVar0[0], 20.8f, 4532.65f, 104.66f, 284.7f);
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
...
int func_260(var uParam0)//Position - 0xF74C
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			MISC::CLEAR_AREA(321.69f, 3408.64f, 35.34f, 10f, true, false, false, false);
			if (!func_257(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_252(&(uParam0->f_28[0]), 56, 329.3f, 3404.2f, 35.8f, -174.9f, "RCM MINUTE - JOE", 1))
				{
			...
			{
				if (func_252(&(uParam0->f_28[1]), 57, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_250(&(uParam0->f_35[0]), iVar0[0], 321.69f, 3408.64f, 35.34f, -105.8f);
				func_261(uParam0->f_35[0], iVar0[0]);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_250(&(uParam0->f_35[1]), iVar0[1], 329.49f, 3402.71f, 36.29f, 284.36f);
...
int func_262(int iParam0)//Position - 0xFAA3
{
	struct<27> Var0;
	bool bVar1;
...
bool func_266(int iParam0, char* sParam1)//Position - 0xFCF3
{
...
int func_267(int iParam0)//Position - 0xFDD5
{
...
int func_268(int iParam0)//Position - 0xFE00
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_269(int iParam0)//Position - 0xFE2B
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_270(int iParam0)//Position - 0xFE56
{
	if (func_241(iParam0))
	{
		return 0;
...
void func_271()//Position - 0xFE8B
{
	func_292("Running end routines.");
	Global_113104 = (Global_113104 - 1);
}

int func_272(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xFEA5
{
	int iVar0;
...
int func_273(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xFF0A
{
	int iVar0;
	struct<7> Var1;
...
int func_274(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0xFF82
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_275(int iParam0, bool bParam1)//Position - 0xFFFD
{
	...
	if (bParam1)
	{
		func_292("SCRIPT TERMINATING: Cleaning up entities in Launcher");
...
void func_276(char* sParam0)//Position - 0x100ED
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_196(sParam0))
...
void func_277()//Position - 0x1010C
{
	Global_20471 = 0;
	func_278();
}

void func_278()//Position - 0x1011C
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22616 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_279(var uParam0)//Position - 0x1013D
{
	if (func_216(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_280(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10173
{
...
void func_281(var uParam0, bool bParam1)//Position - 0x10193
{
	func_282(&(uParam0->f_41), bParam1);
}

void func_282(var uParam0, bool bParam1)//Position - 0x101A5
{
	int iVar0;
...
void func_283(int* iParam0, bool bParam1)//Position - 0x101E3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_284(var uParam0, bool bParam1)//Position - 0x1021E
{
	func_285(&(uParam0->f_35), bParam1);
}

void func_285(var uParam0, bool bParam1)//Position - 0x10230
{
	int iVar0;
...
void func_286(int* iParam0)//Position - 0x1026D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_287(var uParam0, int iParam1)//Position - 0x102A5
{
	func_288(&(uParam0->f_28), iParam1);
}

void func_288(var uParam0, int iParam1)//Position - 0x102B7
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_289(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_289(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x102F8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_290(int* iParam0)//Position - 0x10348
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_291(var uParam0)//Position - 0x10389
{
	if (*uParam0 == -1)
	{
		return;
...
void func_292(char* sParam0)//Position - 0x103C6
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_293(var uParam0)//Position - 0x103D8
{
	*uParam0 = -1;
...
void func_294()//Position - 0x1040B
{
	func_292("Running start routines.");
	Global_113104++;
}

int func_295(int iParam0)//Position - 0x10425
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
