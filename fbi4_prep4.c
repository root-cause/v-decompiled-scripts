...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_286(0))
	{
		Global_114372.f_2366.f_539.f_2395[0] = -99;
		Global_114372.f_2366.f_539.f_2395[1] = -99;
		Global_114372.f_2366.f_539.f_2395[2] = -99;
		func_254();
	}
	while (true)
	{
...
void func_4(int iParam0)//Position - 0x28C
{
	...
	if (Global_114372.f_9088 || func_286(0))
	{
		iVar0 = func_18();
		if (!func_5(iVar0))
		{
...
int func_5(int iParam0)//Position - 0x2D1
{
	...
	func_6(&(Global_114372.f_2366.f_539), iVar1);
...
void func_6(var uParam0, int iParam1)//Position - 0x3E1
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_8(Global_114372.f_18536[iVar0], &Var2, &fVar5))
			{
...
void func_12()//Position - 0x1062
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_16(Global_114372.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_14(iVar0) && (!func_13(14) || Global_113320))
			{
				if (Global_114372.f_2366.f_539.f_4321 != iVar0 && func_14(Global_114372.f_2366.f_539.f_4321))
				{
	...
	switch (iLocal_79)
	{
		...
		case 2:
			if ((MISC::GET_GAME_TIMER() - iLocal_202) > 2000)
			{
				...
				{
					func_43(0, -1);
					if ((Global_114372.f_2366.f_539.f_2395[0] == 38 && Global_114372.f_2366.f_539.f_2395[1] == 33) && Global_114372.f_2366.f_539.f_2395[2] == 54)
					{
						func_42(821);
					}
					func_39();
		...
		case 3:
			Global_114372.f_2366.f_539.f_2395[0] = 38;
			Global_114372.f_2366.f_539.f_2395[1] = 33;
			Global_114372.f_2366.f_539.f_2395[2] = 54;
			func_24(1, 1, 1);
			iLocal_79 = 2;
			break;
	}
...
bool func_30(int iParam0, int iParam1)//Position - 0x173E
{
	bool bVar0;
...
int func_33(var uParam0)//Position - 0x17E4
{
	int iVar0;
...
int func_34(int iParam0)//Position - 0x1806
{
...
int func_36(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x1853
{
	int iVar0;
...
void func_40(bool bParam0, int iParam1)//Position - 0x18E6
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (bParam0)
	{
		if ((func_286(0) && Global_79495.f_1 == 1) && func_41(Global_79495))
		{
		}
		else
		{
...
int func_41(int iParam0)//Position - 0x19B6
{
	switch (iParam0)
	{
		case 71:
...
int func_44(var uParam0, char* sParam1, var uParam2)//Position - 0x1AFF
{
	switch (*uParam0)
	{
		case 0:
...
int func_46(int iParam0)//Position - 0x1CB1
{
	if (iParam0 == 1)
	{
...
int func_52(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x1DDC
{
	struct<15> Var0;
	int iVar15;
...
void func_53(bool bParam0)//Position - 0x1F2D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_57(int iParam0, int iParam1)//Position - 0x2187
{
	bool bVar0;
...
int func_58(int iParam0)//Position - 0x21E0
{
	if (iParam0 > 3)
	{
		return 0;
	...
	return Global_98850[func_59(iParam0)];
}

int func_59(int iParam0)//Position - 0x2211
{
	if (iParam0 == 0)
	{
		return 0;
...
bool func_61(var uParam0, var uParam1, bool bParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)//Position - 0x22B2
{
...
int func_62(char* sParam0, int iParam1, bool bParam2)//Position - 0x231A
{
	Global_22167 = 0;
...
bool func_65(int iParam0)//Position - 0x2682
{
	return func_66(iParam0, 20);
}

var func_66(int iParam0, int iParam1)//Position - 0x2692
{
	return BitTest(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_67()//Position - 0x26AA
{
	return -1;
}
...
void func_75(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x299A
{
...
void func_78(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2B31
{
...
void func_79(int iParam0, int iParam1)//Position - 0x2BCC
{
...
int func_82(int iParam0)//Position - 0x2CAD
{
...
void func_85(int* iParam0, struct<3> Param1, bool bParam4, bool bParam5, char* sParam6)//Position - 0x2D4E
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_86(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x2D7D
{
	int iVar0;
...
bool func_87(char* sParam0, int iParam1, char* sParam2)//Position - 0x2DAB
{
...
int func_88(int iParam0)//Position - 0x2DC9
{
	return func_89(iParam0, 6, 1);
}

int func_89(int iParam0, int iParam1, bool bParam2)//Position - 0x2DD9
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_91(int iParam0, var uParam1)//Position - 0x2E68
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_92(uParam1));
}

int func_92(var uParam0)//Position - 0x2E7D
{
	int iVar0;
	int iVar1;
...
bool func_95(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x3264
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

int func_96(int iParam0, bool bParam1)//Position - 0x3282
{
	func_101();
	switch (iParam0)
	{
...
void func_97(int iParam0, struct<3> Param1, float fParam4)//Position - 0x332D
{
	if (func_253(iParam0))
	{
...
int func_98(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x3353
{
	bool bVar0;
	float fVar1;
...
int func_99(int iParam0, struct<3> Param1, float fParam4)//Position - 0x33AF
{
	switch (iParam0)
	{
		case 0:
...
int func_100(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x3417
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_108(char* sParam0, int iParam1)//Position - 0x36E6
{
	if (!*iParam1)
	{
...
void func_109(char* sParam0, int iParam1, int iParam2)//Position - 0x3703
{
	iParam2 = iParam2;
...
void func_111(int* iParam0)//Position - 0x3841
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_113(int iParam0, int iParam1, int iParam2)//Position - 0x3889
{
	if (func_288() && func_115())
	{
...
var func_115()//Position - 0x3976
{
	return BitTest(Global_101392.f_20, 13);
}

void func_116(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x3987
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_288() || !func_237())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
...
int func_117(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x3B1B
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_114372.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114372.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114372.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_185(iParam0, &(Global_114372.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_114372.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_114372.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114372.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114372.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_185(iParam0, &(Global_114372.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_114372.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5.f_0, Param2, fParam5, true, true, false);
				...
				func_185(iParam0, &(Var5.f_31), &(Var5.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_118(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x4941
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_14(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		{
			func_122(iParam1, &(Global_114372.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_114372.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_114372.f_20121[iParam0 /*43*/].f_31 = func_121(*iParam1);
				...
				func_119(Global_114372.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_114372.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_114372.f_20121[iParam0 /*43*/].f_1));
				...
				func_119(Global_114372.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_114372.f_20121[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
float func_121(int iParam0)//Position - 0x6ABA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_122(int iParam0, var uParam1, var uParam2)//Position - 0x6B6A
{
	int iVar0;
	int iVar1;
...
int func_123(int iParam0, bool bParam1, var uParam2)//Position - 0x6D5D
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	if ((!func_156(iVar0, bParam1, uParam2) && !func_155(PLAYER::PLAYER_ID())) && !func_136(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_132(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
...
int func_124(int iParam0)//Position - 0x6ECB
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0x6F06
{
	if (iParam0 != func_67())
	{
		if (func_127(iParam0, 1, 1))
		{
			...
			{
				return func_126(Global_2657921[iParam0 /*463*/].f_321.f_7) == 11;
			}
		}
	}
	return 0;
...
int func_126(int iParam0)//Position - 0x6F4D
{
	switch (iParam0)
	{
		case 0:
...
int func_127(int iParam0, bool bParam1, bool bParam2)//Position - 0x7427
{
	int iVar0;
...
int func_128(int iParam0)//Position - 0x7487
{
...
int func_129(int iParam0)//Position - 0x74C9
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_130(int iParam0)//Position - 0x7591
{
	if (iParam0 != func_67())
	{
		if (func_127(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_126(Global_2657921[iParam0 /*463*/].f_321.f_7) == 26;
			}
		}
	}
	return 0;
...
int func_131(int iParam0)//Position - 0x75D8
{
	if (iParam0 != func_67())
	{
		if (func_127(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_126(Global_2657921[iParam0 /*463*/].f_321.f_7) == 13;
			}
		}
	}
	return 0;
...
int func_132(int iParam0)//Position - 0x761F
{
	if (iParam0 != func_67())
	{
		if (func_127(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_126(Global_2657921[iParam0 /*463*/].f_321.f_7) == 7;
			}
		}
	}
	return 0;
...
int func_133(int iParam0)//Position - 0x7665
{
	bool bVar0;
	...
	if ((((!func_135(PLAYER::PLAYER_ID()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger")) && iParam0 != func_134(1)) && !bVar0)
	{
		return 0;
	}
	return 1;
...
int func_134(bool bParam0)//Position - 0x76F6
{
	if (bParam0)
	{
...
int func_135(int iParam0)//Position - 0x7710
{
	if (iParam0 != func_67())
	{
...
int func_136(int iParam0)//Position - 0x7736
{
...
int func_137(int iParam0)//Position - 0x7765
{
	...
	if (func_140(PLAYER::PLAYER_ID()) && ((((!func_133(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("openwheel1"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("openwheel2"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("formula"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("formula2"))))
	{
		return 0;
	}
...
int func_138(int iParam0)//Position - 0x789D
{
	int iVar0;
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_129(iParam0)) || func_139(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_139(int iParam0)//Position - 0x791A
{
	switch (iParam0)
	{
		case joaat("mule"):
...
int func_140(int iParam0)//Position - 0x7976
{
	if (iParam0 == func_67())
	{
		return 0;
	}
	if (func_155(iParam0) && Global_2657921[iParam0 /*463*/].f_321.f_10 == iParam0)
	{
		return 1;
	}
	return 0;
...
int func_141(int iParam0, bool bParam1)//Position - 0x79AF
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_143(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_142(int iParam0)//Position - 0x7A0A
{
	int iVar0;
...
int func_143(int iParam0, int iParam1)//Position - 0x7A43
{
	if (iParam1 == 0)
	{
...
int func_153(int iParam0)//Position - 0x83D8
{
	if (iParam0 != func_67())
	{
		if (func_127(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1 && Global_2657921[iParam0 /*463*/].f_321.f_10 != func_67())
			{
				return func_126(Global_2657921[iParam0 /*463*/].f_321.f_7) == 5;
			}
		}
	}
	return 0;
...
int func_154(int iParam0)//Position - 0x8437
{
	if (iParam0 != func_67())
	{
		if (func_127(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1 && Global_2657921[iParam0 /*463*/].f_321.f_10 != func_67())
			{
				return func_126(Global_2657921[iParam0 /*463*/].f_321.f_7) == 8;
			}
		}
	}
	return 0;
...
int func_155(int iParam0)//Position - 0x8497
{
	if (iParam0 != func_67())
	{
		if (func_127(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_126(Global_2657921[iParam0 /*463*/].f_321.f_7) == 9;
			}
		}
	}
	return 0;
...
int func_156(int iParam0, bool bParam1, var uParam2)//Position - 0x84DE
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_132(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_157(int iParam0)//Position - 0x88D5
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_158(int iParam0, int iParam1)//Position - 0x890A
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_159(iParam0, &(Global_114372.f_32753.f_5510));
}

void func_159(int iParam0, var uParam1)//Position - 0x8B0C
{
	int iVar0;
...
int func_160(int iParam0)//Position - 0x8DB7
{
	switch (iParam0)
	{
		case 1:
...
int func_161(int iParam0)//Position - 0x8E67
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_162(var uParam0)//Position - 0x8E87
{
	int iVar0;
...
int func_163(int iParam0)//Position - 0x8F37
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_180(iParam0, 0, 0)) || func_180(iParam0, 1, 0)) || func_180(iParam0, 2, 0)) || func_179(iParam0) != 145) || func_178(iParam0)) || func_177(iParam0)) || func_124(iParam0)) || func_176(iParam0)) || !func_164(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_177(iParam0))
		{
		}
		...
		if (func_180(iParam0, 0, 0))
		{
		}
		if (func_180(iParam0, 1, 0))
		{
		}
		if (func_180(iParam0, 2, 0))
		{
		}
		if (func_179(iParam0) != 145)
		{
		}
		return 0;
	}
...
int func_164(int iParam0)//Position - 0x9014
{
	if (iParam0 == 0)
	{
		return 0;
	}
	if (!func_165(iParam0, 0, -1))
	{
		return 0;
	}
...
int func_165(int iParam0, bool bParam1, int iParam2)//Position - 0x91D2
{
	int iVar0;
	struct<2> Var1;
	...
	{
		if ((func_170() || MISC::IS_PC_VERSION()) || func_169())
		{
		}
		else if (!func_172())
		{
...
int func_166(int iParam0)//Position - 0x9354
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_168(int iParam0, int iParam1)//Position - 0x9437
{
	int iVar0;
	int iVar1;
...
bool func_169()//Position - 0xE970
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_170()//Position - 0xE986
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_171()//Position - 0xE99C
{
	return 0;
}

int func_172()//Position - 0xE9A5
{
	return 1;
}

int func_173()//Position - 0xE9AE
{
	return 1;
}

int func_174()//Position - 0xE9B7
{
...
int func_176(int iParam0)//Position - 0xEA88
{
	int iVar0;
	char* sVar1;
...
int func_177(int iParam0)//Position - 0xEACF
{
	int iVar0;
...
int func_178(int iParam0)//Position - 0xEB4B
{
	int iVar0;
...
int func_179(int iParam0)//Position - 0xEC33
{
	int iVar0;
...
int func_180(int iParam0, int iParam1, bool bParam2)//Position - 0xEC96
{
	int iVar0;
	char* sVar1;
	int iVar9;
	...
	iVar0 = 0;
	while (func_181(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_181(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0xED04
{
...
void func_182(int iParam0, int iParam1)//Position - 0xEDDC
{
	int iVar0;
...
void func_183(int iParam0)//Position - 0xEE5E
{
	if (!func_184(*iParam0))
	{
...
bool func_184(int iParam0)//Position - 0xEE89
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_185(int iParam0, var uParam1, var uParam2)//Position - 0xEE98
{
	int iVar0;
	int iVar1;
	...
	if (func_152(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_188(*iParam0, ((*uParam1)[38] - 1)))
	{
...
int func_186(int iParam0)//Position - 0xF072
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_187(var uParam0)//Position - 0xF14E
{
...
int func_188(int iParam0, int iParam1)//Position - 0xF1A5
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_189(int iParam0, int iParam1)//Position - 0xF28E
{
	int iVar0;
...
int func_190(int iParam0, int iParam1, int iParam2)//Position - 0xF2F0
{
	if (!func_191() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_191()//Position - 0xF314
{
	return 0;
}

int func_192(var uParam0, int iParam1)//Position - 0xF31D
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_193(int iParam0, var uParam1, int iParam2)//Position - 0xF35E
{
	int iVar0;
...
void func_194(int iParam0, int iParam1)//Position - 0xF5BA
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98703[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98703[iVar0]) == func_195(iParam0, iParam1))
				{
...
int func_195(int iParam0, int iParam1)//Position - 0xF658
{
	struct<82> Var0;
...
void func_196(struct<3> Param0, float fParam3, bool bParam4)//Position - 0xF69A
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_204(&(Global_78038.f_555[0 /*21*/]), iVar0))
		{
...
void func_197(int iParam0)//Position - 0xF6EA
{
	bool bVar0;
	...
	if (func_204(&(Global_78038.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_203(iParam0, 0)) && Global_78947.f_66 == 0) && Global_114372.f_32753.f_1958[Global_78038.f_555[0 /*21*/].f_14] != 0) && Global_114372.f_32753.f_1958[Global_78038.f_555[0 /*21*/].f_14] > 3) && (!func_201(0, Global_78038.f_555[0 /*21*/].f_12) || !func_201(1, Global_78038.f_555[0 /*21*/].f_12)))
			{
				func_200(&(Global_114372.f_32753.f_69[Global_78038.f_555[0 /*21*/].f_14 /*78*/]), &Global_78947);
...
void func_198(int iParam0, bool bParam1)//Position - 0xF859
{
	if (iParam0 == -1)
	{
		return;
...
void func_199(int iParam0, int iParam1, bool bParam2)//Position - 0xF8B6
{
	if (iParam0 == -1)
	{
		return;
...
void func_200(var uParam0, var uParam1)//Position - 0xF8F1
{
...
int func_201(int iParam0, int iParam1)//Position - 0xF9BD
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_202(&(Global_114372.f_32753.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_165(Global_114372.f_32753.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}

int func_202(var uParam0)//Position - 0xFA30
{
	return *uParam0;
}

int func_203(int iParam0, int iParam1)//Position - 0xFA3B
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_204(var uParam0, int iParam1)//Position - 0xFA5B
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_205(Global_114372.f_32753.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_205(Global_114372.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_205(Global_114372.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
bool func_205(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x1114C
{
	if (bParam6)
	{
...
int func_206(struct<3> Param0, float fParam3)//Position - 0x11193
{
	return func_207(&(Global_107917.f_2890), Param0, fParam3, 0);
}

int func_207(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x111AD
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (func_230(uParam0))
	{
		...
		if (func_229(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_211(iVar0, &(uParam0->f_12), 0, 1);
				bVar4 = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_182(iVar0, uParam0->f_11);
				}
				else if ((!func_209(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_208(iVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_208(int iParam0)//Position - 0x1145F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_209(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x11522
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_210(iParam0, Global_78038.f_139[38], 0))
			{
				func_197(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_210(iParam0, Global_78038.f_139[43], 1))
			{
				func_197(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_210(iParam0, uVar1[iVar6], 1) && func_100(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.5635f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_205(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
int func_210(int iParam0, int iParam1, bool bParam2)//Position - 0x1172A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_211(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x1178B
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((BitTest(uParam1->f_77, 15) || func_219(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_218())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if ((((func_212() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_134(1)))
		{
...
int func_213(var uParam0)//Position - 0x11F12
{
	int iVar0;
...
int func_214(int iParam0)//Position - 0x11F36
{
	int iVar0;
...
bool func_215(int iParam0)//Position - 0x11F54
{
	return func_216(&(Global_2672741.f_188), iParam0);
}

var func_216(var uParam0, var uParam1)//Position - 0x11F68
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_217(int iParam0, int iParam1)//Position - 0x11F8B
{
	int iVar0;
	int iVar1;
...
bool func_218()//Position - 0x12003
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

int func_219(int iParam0)//Position - 0x12014
{
	int iVar0;
...
int func_220(int iParam0)//Position - 0x1205C
{
	if (!func_191() && func_221(iParam0))
	{
		return 1;
	}
	return 0;
...
int func_221(int iParam0)//Position - 0x1207C
{
	switch (iParam0)
	{
		case 161:
...
int func_222(int iParam0)//Position - 0x120CF
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (!func_228(PLAYER::PLAYER_ID(), -1))
		{
...
int func_223(int iParam0)//Position - 0x12156
{
...
int func_224(int iParam0)//Position - 0x12185
{
	if (func_227(iParam0) == 233)
	{
...
int func_225(int iParam0)//Position - 0x121A2
{
...
int func_226(int iParam0, int iParam1)//Position - 0x121C5
{
	if (func_33(iParam0))
	{
...
int func_227(int iParam0)//Position - 0x12209
{
	if (func_33(iParam0))
	{
		if (func_226(iParam0, 0))
...
int func_228(int iParam0, int iParam1)//Position - 0x12235
{
	int iVar0;
...
int func_229(var uParam0)//Position - 0x12282
{
	if (func_230(uParam0))
	{
...
int func_230(var uParam0)//Position - 0x122B7
{
	if (uParam0->f_12.f_66 == 0)
	{
		return 0;
	}
	if (!func_165(uParam0->f_12.f_66, 0, -1))
	{
		return 0;
	}
...
bool func_231()//Position - 0x12317
{
	return func_229(&(Global_107917.f_2890));
}

void func_232()//Position - 0x1232A
{
	func_233(&(Global_107917.f_2890));
}

void func_233(var uParam0)//Position - 0x1233D
{
	if (func_230(uParam0))
	{
...
int func_234(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1235B
{
...
int func_236(int iParam0)//Position - 0x1245E
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_237()//Position - 0x124D0
{
	return func_230(&(Global_107917.f_2890));
}

void func_238(int iParam0)//Position - 0x124E3
{
	Global_97227 = 0;
	switch (iParam0)
	{
...
void func_239(int iParam0)//Position - 0x12571
{
	MISC::SET_BIT(&Global_97227, iParam0);
}

void func_240()//Position - 0x12583
{
...
int func_241()//Position - 0x12640
{
	...
	if (!func_242(bLocal_188, iVar0) && !bLocal_188)
	{
		return 0;
	}
	return 1;
...
int func_242(bool bParam0, int iParam1)//Position - 0x1267C
{
	int iVar0;
...
int func_243(int iParam0, int iParam1)//Position - 0x126C8
{
	int iVar0;
...
int func_244(int iParam0)//Position - 0x126DD
{
	return Global_61212[iParam0];
}

bool func_245(int iParam0)//Position - 0x126EC
{
	return func_89(iParam0, 1, 1);
}

void func_246(int iParam0)//Position - 0x126FC
{
	HUD::CLEAR_PRINTS();
	func_247();
	switch (iParam0)
...
void func_247()//Position - 0x1275E
{
	Global_21032 = 0;
	func_74();
}

int func_248()//Position - 0x1276E
{
	func_249();
	if (iLocal_189 >= 3)
	{
...
void func_249()//Position - 0x127B3
{
	if (func_251())
	{
		switch (func_11())
		{
			case 0:
				if (Global_114372.f_2366.f_539.f_2395[0] == -99)
				{
					func_250(sLocal_206[0], sLocal_206[1], sLocal_206[2]);
				}
				else if (Global_114372.f_2366.f_539.f_2395[1] == -99)
				{
					func_250(sLocal_206[1], sLocal_206[0], sLocal_206[2]);
				}
				else if (Global_114372.f_2366.f_539.f_2395[2] == -99)
				{
					func_250(sLocal_206[2], sLocal_206[1], sLocal_206[0]);
				}
				break;
			
			case 1:
				if (Global_114372.f_2366.f_539.f_2395[1] == -99)
				{
					func_250(sLocal_206[1], sLocal_206[0], sLocal_206[2]);
				}
				else if (Global_114372.f_2366.f_539.f_2395[0] == -99)
				{
					func_250(sLocal_206[0], sLocal_206[1], sLocal_206[2]);
				}
				else if (Global_114372.f_2366.f_539.f_2395[2] == -99)
			...
			case 2:
				if (Global_114372.f_2366.f_539.f_2395[2] == -99)
				{
					func_250(sLocal_206[2], sLocal_206[1], sLocal_206[0]);
				}
				else if (Global_114372.f_2366.f_539.f_2395[0] == -99)
...
void func_250(char* sParam0, char* sParam1, char* sParam2)//Position - 0x12969
{
...
bool func_251()//Position - 0x129A5
{
	return MISC::GET_GAME_TIMER() <= Global_23711.f_6481 + 100;
}

int func_252()//Position - 0x129BA
{
	int iVar0;
	int iVar1;
	...
	while (iVar1 <= 2)
	{
		if (Global_114372.f_2366.f_539.f_2395[iVar1] != -99)
		{
			iVar0++;
		}
		iVar1++;
...
int func_253(int iParam0)//Position - 0x129F6
{
	if (func_27(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_254()//Position - 0x12A16
{
	int iVar0;
	...
	if (func_244(iVar0) < 1500)
	{
		func_255(func_11(), 96, 1500, 0, 0);
	}
}

void func_255(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x12A66
{
	int iVar0;
	int iVar1;
	
	if (func_285(iParam0) == 3)
	{
		return;
	}
	...
	func_256(func_285(iParam0), 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
int func_256(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x12B38
{
	float fVar0;
	bool bVar1;
	int iVar2;
...
void func_257(bool bParam0)//Position - 0x13137
{
	int iVar0;
	int iVar1;
...
void func_258(int iParam0)//Position - 0x133B9
{
	int iVar0;
...
void func_259(bool bParam0)//Position - 0x13413
{
	bool bVar0;
	char cVar1[64];
	...
	else if (BitTest(Global_114372.f_20567.f_471, bParam0) || BitTest(Global_2359296[func_261() /*5569*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_114372.f_20567.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_261() /*5569*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED" /* GXT: You have redeemed your promotion for ~a~ */);
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_260(bParam0));
		HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar1, &cVar1, true, 0, "", 0);
	}
}

char* func_260(bool bParam0)//Position - 0x1358C
{
	switch (bParam0)
	{
		case 0:
...
void func_262(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x1369B
{
	int iVar0;
...
void func_263(int iParam0, bool bParam1, int iParam2)//Position - 0x136C9
{
	if (iParam2 == -1)
	{
		iParam2 = func_32();
...
void func_264(int iParam0)//Position - 0x136E7
{
	func_283(93, iParam0);
	func_283(29, iParam0);
	func_283(30, iParam0);
...
int func_265(int iParam0)//Position - 0x13707
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam0 == 8)
	{
		return func_266(129, -1);
	}
	if (iParam0 == 9)
	{
		return func_266(135, -1);
	}
	if (iParam0 == 10)
	{
		return func_266(136, -1);
	}
	if (iParam0 == 11)
	{
		return func_266(137, -1);
	}
	if (iParam0 == 12)
	{
	...
	return BitTest(Global_2359296[func_261() /*5569*/].f_681.f_10, iParam0);
}

bool func_266(int iParam0, int iParam1)//Position - 0x138A7
{
	if (iParam1 == -1)
	{
		iParam1 = func_32();
...
int func_267(bool bParam0)//Position - 0x138C3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_268(int iParam0, int iParam1)//Position - 0x1397A
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_269(int iParam0, int iParam1)//Position - 0x13995
{
...
int func_270(var uParam0, int iParam1)//Position - 0x13A32
{
	int iVar0;
	var uVar1[78];
...
int func_271(var uParam0, int iParam1)//Position - 0x13AE3
{
	int iVar0;
...
bool func_272(var uParam0, int iParam1)//Position - 0x13B5E
{
	return (*uParam0)[iParam1] == 78;
}

void func_273(var uParam0)//Position - 0x13B6F
{
	int iVar0;
...
void func_274(var uParam0, int iParam1)//Position - 0x13BA3
{
	(*uParam0)[iParam1] = 78;
}

void func_275(var uParam0, float fParam1)//Position - 0x13BB3
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_276(var uParam0)//Position - 0x13BD0
{
	return uParam0->f_80;
}

bool func_277(var uParam0, int iParam1)//Position - 0x13BDC
{
	return func_278(uParam0, iParam1) != -1;
}

int func_278(var uParam0, int iParam1)//Position - 0x13BEE
{
	int iVar0;
...
bool func_279(var uParam0)//Position - 0x13C1B
{
	return uParam0->f_79 == 1;
}

int func_280(int iParam0)//Position - 0x13C29
{
	switch (iParam0)
	{
		case 60:
...
int func_281(int iParam0, int iParam1)//Position - 0x13C79
{
	int iVar0;
...
void func_282(int iParam0, int iParam1)//Position - 0x13CCA
{
	int iVar0;
...
void func_283(int iParam0, int iParam1)//Position - 0x13CED
{
	int iVar0;
...
void func_284()//Position - 0x13D4A
{
	int iVar0;
...
int func_285(int iParam0)//Position - 0x13DBF
{
	return Global_2139[iParam0 /*29*/].f_17;
}

int func_286(bool bParam0)//Position - 0x13DD0
{
...
void func_287(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x13DF8
{
	if (func_288())
	{
...
void func_289()//Position - 0x13EB1
{
	func_290(joaat("Player_Zero"), 14, 31, 1);
	func_290(joaat("Player_Zero"), 14, 32, 1);
	func_290(joaat("Player_Zero"), 14, 33, 1);
	func_290(joaat("Player_Zero"), 14, 34, 1);
	func_290(joaat("Player_Zero"), 14, 35, 1);
	func_290(joaat("Player_Zero"), 14, 36, 1);
	func_290(joaat("Player_Zero"), 14, 37, 1);
	func_290(joaat("Player_Zero"), 14, 38, 1);
	func_290(joaat("Player_Zero"), 14, 39, 1);
	func_290(joaat("Player_Zero"), 14, 40, 1);
	func_290(joaat("Player_Zero"), 14, 41, 1);
	func_290(joaat("Player_Zero"), 14, 42, 1);
	func_290(joaat("Player_Zero"), 14, 43, 1);
	func_290(joaat("Player_Zero"), 14, 44, 1);
	func_290(joaat("Player_Zero"), 9, 9, 1);
	func_290(joaat("Player_Zero"), 9, 10, 1);
	func_290(joaat("Player_Zero"), 9, 11, 1);
	func_290(joaat("Player_Zero"), 9, 12, 1);
	func_290(joaat("Player_Zero"), 9, 13, 1);
	func_290(joaat("Player_Zero"), 9, 14, 1);
	func_290(joaat("Player_One"), 14, 26, 1);
	func_290(joaat("Player_One"), 14, 27, 1);
	func_290(joaat("Player_One"), 14, 28, 1);
	func_290(joaat("Player_One"), 14, 29, 1);
	func_290(joaat("Player_One"), 14, 30, 1);
	func_290(joaat("Player_One"), 14, 31, 1);
	func_290(joaat("Player_One"), 14, 32, 1);
	func_290(joaat("Player_One"), 14, 33, 1);
	func_290(joaat("Player_One"), 14, 34, 1);
	func_290(joaat("Player_One"), 14, 35, 1);
	func_290(joaat("Player_One"), 14, 36, 1);
	func_290(joaat("Player_One"), 14, 37, 1);
	func_290(joaat("Player_One"), 14, 38, 1);
	func_290(joaat("Player_One"), 14, 39, 1);
	func_290(joaat("Player_One"), 9, 5, 1);
	func_290(joaat("Player_One"), 9, 6, 1);
	func_290(joaat("Player_One"), 9, 7, 1);
	func_290(joaat("Player_One"), 9, 8, 1);
	func_290(joaat("Player_One"), 9, 9, 1);
	func_290(joaat("Player_One"), 9, 10, 1);
	func_290(joaat("Player_Two"), 14, 49, 1);
	func_290(joaat("Player_Two"), 14, 50, 1);
	func_290(joaat("Player_Two"), 14, 51, 1);
	func_290(joaat("Player_Two"), 14, 52, 1);
	func_290(joaat("Player_Two"), 14, 53, 1);
	func_290(joaat("Player_Two"), 14, 54, 1);
	func_290(joaat("Player_Two"), 14, 55, 1);
	func_290(joaat("Player_Two"), 14, 56, 1);
	func_290(joaat("Player_Two"), 14, 57, 1);
	func_290(joaat("Player_Two"), 14, 58, 1);
	func_290(joaat("Player_Two"), 14, 59, 1);
	func_290(joaat("Player_Two"), 14, 60, 1);
	func_290(joaat("Player_Two"), 9, 9, 1);
	func_290(joaat("Player_Two"), 9, 10, 1);
	func_290(joaat("Player_Two"), 9, 11, 1);
	func_290(joaat("Player_Two"), 9, 12, 1);
	func_290(joaat("Player_Two"), 9, 13, 1);
	func_290(joaat("Player_Two"), 9, 14, 1);
	func_290(joaat("Player_Two"), 9, 15, 1);
	func_290(joaat("Player_Two"), 9, 16, 1);
}

int func_290(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x14203
{
...
int func_291(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x14299
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_292(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1513C
{
	func_357();
...
void func_293(int iParam0, int iParam1)//Position - 0x1518E
{
	switch (iParam0)
	{
		case 0:
...
void func_294(int iParam0)//Position - 0x1527E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_302(iVar10, iParam0, 155, -1);
			return;
			break;
	}
	func_295(&(Global_79031[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_295(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x164F5
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_299(Global_2883588, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_299(Global_2883588, 2, 1, 1, -1))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_90(func_298(iParam1, uParam0->f_2), Global_79028);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_90(func_297(iParam1, uParam0->f_2), Global_79028);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
...
bool func_296(int iParam0, int iParam1, var uParam2)//Position - 0x16897
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_297(int iParam0, int iParam1)//Position - 0x16C9C
{
	switch (iParam1)
	{
		case 0:
...
int func_298(int iParam0, int iParam1)//Position - 0x17097
{
	switch (iParam1)
	{
		case 0:
...
int func_299(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x17492
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	if (func_300(iParam0, iParam1, &iVar2, &uVar1, bParam2, bParam3))
	{
...
bool func_300(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x174D0
{
	int iVar0;
...
int func_301(int iParam0)//Position - 0x19FBF
{
	switch (iParam0)
	{
		case -1:
...
void func_302(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1A093
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_295(&(Global_79031[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_295(&(Global_79031[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_295(&(Global_79031[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79229)
		{
			...
			func_295(&(Global_79031[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_303(iParam0));
			if (iVar57 > iVar56)
			{
...
int func_303(int iParam0)//Position - 0x1A31A
{
	switch (iParam0)
	{
		case 0:
...
void func_304(int iParam0)//Position - 0x1A3CA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_305(int iParam0)//Position - 0x1A521
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_306(int iParam0)//Position - 0x1AA2F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_307(int iParam0)//Position - 0x1AAA4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_308(int iParam0)//Position - 0x1AB18
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_309(int iParam0)//Position - 0x1ABFF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_310(int iParam0)//Position - 0x1AF62
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_311(int iParam0)//Position - 0x1B173
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_312(int iParam0)//Position - 0x1B3A3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_313(int iParam0)//Position - 0x1B4B3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_314(int iParam0)//Position - 0x1BE52
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_315(int iParam0)//Position - 0x1CB4C
{
	if (iParam0 < 136)
	{
		func_317(iParam0);
...
void func_316(int iParam0)//Position - 0x1CB81
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_317(int iParam0)//Position - 0x1D785
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_318(int iParam0)//Position - 0x1E693
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_319(int iParam0)//Position - 0x1E7C0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_320(int iParam0, int iParam1)//Position - 0x1E8BE
{
	switch (iParam0)
	{
		case 0:
...
void func_321(int iParam0)//Position - 0x1E9AE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_322(int iParam0)//Position - 0x1FE9F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_323(int iParam0)//Position - 0x1FFF0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_324(int iParam0)//Position - 0x204FC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_325(int iParam0)//Position - 0x20B6A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_326(int iParam0)//Position - 0x20BDE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_327(int iParam0)//Position - 0x20CAE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_328(int iParam0)//Position - 0x211DE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_329(int iParam0)//Position - 0x21375
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_330(int iParam0)//Position - 0x21B73
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_331(int iParam0)//Position - 0x21C83
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_332(int iParam0)//Position - 0x22BAE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_333(int iParam0)//Position - 0x2386B
{
	if (iParam0 < 107)
	{
		func_336(iParam0);
...
void func_334(int iParam0)//Position - 0x238B1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_335(int iParam0)//Position - 0x24358
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_336(int iParam0)//Position - 0x25147
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_337(int iParam0)//Position - 0x25D90
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_338(int iParam0)//Position - 0x26009
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_339(int iParam0, int iParam1)//Position - 0x2614F
{
	switch (iParam0)
	{
		case 0:
...
void func_340(int iParam0)//Position - 0x2623F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_341(int iParam0)//Position - 0x26FC9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_342(int iParam0)//Position - 0x27143
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_343(int iParam0)//Position - 0x276BA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_344(int iParam0)//Position - 0x27BE4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_345(int iParam0)//Position - 0x27C58
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_346(int iParam0)//Position - 0x27D28
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_347(int iParam0)//Position - 0x28201
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_348(int iParam0)//Position - 0x2846A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_349(int iParam0)//Position - 0x28740
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_350(int iParam0)//Position - 0x28909
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_351(int iParam0)//Position - 0x2945D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_352(int iParam0)//Position - 0x2A0A7
{
	if (iParam0 < 60)
	{
		func_354(iParam0);
...
void func_353(int iParam0)//Position - 0x2A0DC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_354(int iParam0)//Position - 0x2AE7C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_355(int iParam0)//Position - 0x2B508
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_356(int iParam0)//Position - 0x2B5EF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_357()//Position - 0x2B6ED
{
...
void func_358()//Position - 0x2B766
{
	func_367();
	func_366();
	func_359();
...
void func_359()//Position - 0x2B77A
{
	struct<3> Var0[8];
...
void func_360(var uParam0, int iParam1)//Position - 0x2B7E7
{
	int iVar0;
	...
	{
		func_364(&uLocal_80, *(uParam0[iVar0 /*3*/]));
		iVar0++;
	}
	func_363(&uLocal_80);
...
void func_361(var uParam0, var uParam1, float fParam2)//Position - 0x2B82B
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_362(uParam1, *(uParam1[iVar1 /*3*/]) + Var9))
		{
			Var9 = { -Var9 };
		}
...
bool func_362(var uParam0, struct<2> Param1, Vector3 vParam3)//Position - 0x2B938
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_363(var uParam0)//Position - 0x2B9F4
{
	int iVar0;
	float fVar1;
...
void func_364(var uParam0, struct<3> Param1)//Position - 0x2BA94
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_365(var uParam0)//Position - 0x2BAC5
{
	if (uParam0->f_51)
	{
	}
...
void func_366()//Position - 0x2BAEC
{
...
void func_367()//Position - 0x2BB0C
{
}

void func_368()//Position - 0x2BB14
{
	func_379(1);
	func_378();
	func_369(0);
...
void func_369(bool bParam0)//Position - 0x2BB2E
{
	if (bParam0)
	{
	}
...
void func_370()//Position - 0x2BB99
{
}

void func_371()//Position - 0x2BBA1
{
	Global_21032 = 0;
	func_372();
}

void func_372()//Position - 0x2BBB1
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_373()//Position - 0x2BBD2
{
}

void func_374()//Position - 0x2BBDA
{
}

void func_375()//Position - 0x2BBE2
{
}

void func_376()//Position - 0x2BBEA
{
}

void func_377(bool bParam0, int iParam1, int iParam2)//Position - 0x2BBF2
{
	bool bVar0;
...
void func_378()//Position - 0x2BC51
{
	Global_97227 = 0;
}

void func_379(bool bParam0)//Position - 0x2BC5E
{
...
void func_380()//Position - 0x2BCA5
{
	int iVar0;
...
void func_382()//Position - 0x2BD54
{
	Global_114372.f_2366.f_539.f_2395[0] = -99;
	Global_114372.f_2366.f_539.f_2395[1] = -99;
	Global_114372.f_2366.f_539.f_2395[2] = -99;
