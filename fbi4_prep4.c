...
void __EntryFunction__()//Position - 0x0
{
	...
	sLocal_188 = "FBIPRD";
	Local_194 = { 0f, 0f, 0f };
	Local_195 = { -1335.314f, -1277.943f, 3.8649f };
	Local_196 = { -1336.378f, -1279.056f, 3.855f };
	iLocal_199 = -1;
	sLocal_203 = "FBIPRAU";
	...
	if (func_281())
	{
		func_280(-1339.786f, -1277.51f, 3.8874f, 261.2839f, 1, 0);
	}
	if (func_279(0))
	{
...
int func_202(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xEEDF
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_203(iParam0, uVar1[iVar3], 1) && func_98(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
