...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_484())
	{
		...
		func_483(Local_104, fLocal_107, 1, 0);
		func_518("*** Replay setup started");
		Global_79635 = 1;
		iLocal_77 = 0;
		while (!func_472(&Local_441))
		{
			SYSTEM::WAIT(0);
		}
		func_518("*** Josh 4 scene set up");
		func_471(&Local_441, 0, 1);
		Global_79635 = 0;
	}
	if (func_470(Local_441.f_28[1]))
	{
		AUDIO::STOP_PED_SPEAKING(Local_441.f_28[1], true);
	}
	if (func_470(Local_441.f_28[2]))
	{
	...
	switch (iLocal_86)
	{
		...
		case 1:
			...
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) <= 0 && !func_210())
			{
				...
				{
					if (func_470(Local_441.f_28[iVar0]))
					{
...
int func_32(int iParam0, int iParam1, int iParam2)//Position - 0x16B4
{
	...
	else
	{
		...
		Global_79172[1 /*14*/] = { func_85(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_77(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_77(iParam1), Global_79172[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_77(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, 0);
		}
	}
...
int func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x194D
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_79172[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_79172[1 /*14*/] = { func_85(iVar10, 14, uVar28[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_77(iVar0), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_77(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_77(iVar0), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
						}
						func_67(iVar0);
						if (Global_79170 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_79172[1 /*14*/] = { func_85(iVar10, 14, uVar69[iVar1], -1) };
			func_51(iParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
			func_67(14);
			if (Global_79170 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_77(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_77(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_77(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
		}
		if (Global_79170 == 1)
		{
			iVar2 = 0;
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x87B0
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_75(int iParam0)//Position - 0x9653
{
	if (!BitTest(Global_79172[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x969B
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x9746
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_78(int iParam0, int iParam1)//Position - 0x97F6
{
	int iVar0;
	struct<10> Var1;
...
void func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA125
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xA24F
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_81(int iParam0, int iParam1)//Position - 0xA297
{
	int iVar0;
	struct<17> Var1;
...
void func_82(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC0E0
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
void func_84(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xC37A
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC3EB
{
	func_149();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_87(int iParam0)//Position - 0xC52D
{
	...
	func_88(&(Global_79172[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_88(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD7A4
{
	var uVar0;
	int iVar1;
...
int func_92(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE741
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE861
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_88(&(Global_79172[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_88(&(Global_79172[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_150(int iParam0, int iParam1, int iParam2)//Position - 0x1FE8C
{
	...
	else if (Global_79172[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_77(iParam1)) && Global_79172[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_77(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_157()//Position - 0x201FA
{
	...
	{
		if (func_152(Global_113969.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_162(int iParam0, bool bParam1, bool bParam2)//Position - 0x20863
{
	...
	if (iParam0 != -1)
	{
		...
		func_163(&sVar32, Var0.f_3, Global_101570, bParam1, bParam2);
	}
}
...
bool func_171()//Position - 0x21F9D
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_172()//Position - 0x21FB3
{
...
void func_175(var uParam0)//Position - 0x22015
{
	if (*uParam0 == -1)
	{
		return;
...
void func_180(var uParam0, bool bParam1)//Position - 0x225A9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_185(int iParam0, int iParam1)//Position - 0x229CD
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_186(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x229ED
{
	if (iParam0 != 198)
	{
		if (Global_79389)
...
void func_197(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x26EFF
{
	int iVar0;
...
int func_199(int iParam0)//Position - 0x271EA
{
	int iVar0;
	int iVar1;
...
int func_202(int iParam0)//Position - 0x27422
{
...
int func_204(char* sParam0)//Position - 0x27489
{
	int iVar0;
...
int func_206(char* sParam0, int iParam1)//Position - 0x274FA
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_208(int iParam0)//Position - 0x275B4
{
	if (func_470(iParam0))
	{
...
void func_209(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x275DE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
float func_212(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x27696
{
	struct<3> Var0;
...
float func_214(int iParam0, int iParam1, bool bParam2)//Position - 0x27819
{
	struct<3> Var0;
	struct<3> Var3;
...
bool func_215(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x27877
{
...
int func_216(char* sParam0, int iParam1, bool bParam2)//Position - 0x278C5
{
	Global_22287 = 0;
...
bool func_219(int iParam0)//Position - 0x27C2D
{
	return func_220(iParam0, 20);
}

var func_220(int iParam0, int iParam1)//Position - 0x27C3D
{
	return BitTest(Global_1887305[iParam0 /*610*/].f_10.f_4, iParam1);
}

int func_221()//Position - 0x27C55
{
	return -1;
}
...
void func_226()//Position - 0x27DE5
{
	if (func_93(14))
	{
...
void func_231(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27F87
{
...
void func_232(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x27FDD
{
	...
	switch (iLocal_100)
	{
		...
		case 1:
			if (func_470(Local_441.f_28[0]))
			{
				...
				if (func_470(PLAYER::PLAYER_PED_ID()) && func_470(Local_441.f_28[0]))
				{
					if (iLocal_527 < 3)
					{
...
void func_236(int* iParam0)//Position - 0x285D2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_237(int* iParam0)//Position - 0x2866E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_238(int* iParam0)//Position - 0x286AF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_239(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x286E7
{
	...
	switch (iLocal_99)
	{
		...
		case 3:
			...
			else
			{
				...
				{
					if (func_470(Local_441.f_28[iVar1]))
					{
...
int func_244(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x2901E
{
	struct<3> Var0;
...
int func_245(int iParam0, float fParam1)//Position - 0x290D9
{
	float fVar0;
...
bool func_246(int iParam0, float fParam1)//Position - 0x2914F
{
	return func_247(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_247(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x29167
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_248(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x29228
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_249(int iParam0, int iParam1)//Position - 0x29354
{
	int iVar0;
...
int func_251(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x29463
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_252(struct<3> Param0, struct<3> Param3)//Position - 0x294F4
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_253(struct<3> Param0)//Position - 0x29515
{
	float fVar0;
	float fVar1;
...
int func_255(int iParam0, int iParam1)//Position - 0x2956F
{
	int iVar0;
...
int func_256(int iParam0)//Position - 0x295AE
{
...
bool func_257(int iParam0, int iParam1, float fParam2)//Position - 0x295D6
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_258(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2961D
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_259(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x29718
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_260(int iParam0, float fParam1)//Position - 0x29824
{
	var uVar0;
	struct<3> Var1;
...
int func_261(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x298B9
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_262(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x29947
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_264(char* sParam0, int iParam1, int iParam2)//Position - 0x29ACB
{
	iParam2 = iParam2;
...
int func_268(int iParam0)//Position - 0x2A051
{
	if (func_470(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_269(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2A071
{
	if (bParam0)
	{
...
bool func_271(int iParam0, int iParam1)//Position - 0x2A1D8
{
	bool bVar0;
...
int func_273(var uParam0)//Position - 0x2A272
{
	int iVar0;
...
int func_274(int iParam0)//Position - 0x2A294
{
...
int func_276(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x2A2E1
{
	int iVar0;
...
void func_278()//Position - 0x2A337
{
	...
	{
		if (func_470(iLocal_502) && func_470(Local_441.f_28[1]))
		{
	...
	{
		if (func_470(iLocal_503) && func_470(Local_441.f_28[2]))
		{
...
void func_280(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x2A5CF
{
	int iVar0;
...
Vector3 func_282(int iParam0)//Position - 0x2A7C9
{
...
void func_285(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2A832
{
	func_286(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_286(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2A85C
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_287(struct<3> Param0)//Position - 0x2AC52
{
...
int func_288(int iParam0, int iParam1, bool bParam2)//Position - 0x2AC7C
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_289(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2ACEA
{
...
int func_290(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2ADCA
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_291(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2B0C0
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_292(int iParam0)//Position - 0x2B174
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_295(int iParam0, float fParam1, int iParam2)//Position - 0x2B33A
{
	int iVar0;
...
int func_298(int iParam0, int iParam1)//Position - 0x2B482
{
	if (func_268(iParam0))
	{
...
int func_299(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2B4B5
{
...
void func_300(int iParam0)//Position - 0x2B50C
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_305()//Position - 0x2B99D
{
	...
	switch (iLocal_86)
	{
		...
		case 1:
			if (!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.3529f, 281.62604f, 61.46451f, -1099.5205f, 282.50732f, 65.992226f, 16f, false, true, 0))
			{
				if (func_470(PLAYER::PLAYER_PED_ID()) && func_268(Local_441.f_28[0]))
				{
				...
				{
					if ((func_470(PLAYER::PLAYER_PED_ID()) && func_268(Local_441.f_28[0])) && !func_306())
					{
						if (!func_298(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")))
						{
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_441.f_28[0], 0);
...
int func_313(int iParam0)//Position - 0x2BF54
{
	if (iParam0 == 1)
	{
		if (Global_20930.f_1 > 3)
...
void func_315(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2BFBA
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_317(Global_79645, Global_79647, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_316(char* sParam0)//Position - 0x2C2A3
{
...
int func_326(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2C6AA
{
...
int func_328(int iParam0)//Position - 0x2C7EC
{
	if (Global_44042 == 15)
	{
		return 0;
...
bool func_329(int iParam0)//Position - 0x2C80E
{
	return func_330(iParam0, Global_44042);
}

int func_330(int iParam0, int iParam1)//Position - 0x2C81F
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_333(int iParam0, int iParam1, int iParam2)//Position - 0x2CBD4
{
...
int func_334(bool bParam0, bool bParam1)//Position - 0x2CC98
{
	int iVar0;
...
int func_335(bool bParam0, bool bParam1)//Position - 0x2CD06
{
	int iVar0;
...
int func_336(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2CDAC
{
	bool bVar0;
	float fVar1;
...
void func_338(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2CE19
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_428(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
...
int func_339(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2CFAD
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_340(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2DDD0
{
	var uVar0;
	int iVar1;
	int iVar2;
...
float func_343(int iParam0)//Position - 0x2FFF9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_344(int iParam0, var uParam1, var uParam2)//Position - 0x300AB
{
	int iVar0;
	int iVar1;
...
int func_345(int iParam0, bool bParam1, var uParam2)//Position - 0x3029E
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_386(iVar0, bParam1, uParam2) && !func_385(PLAYER::PLAYER_ID())) && !func_358(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_354(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_351(iParam0)) && !bVar1) && !(func_350(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_347(PLAYER::PLAYER_ID())))
	{
...
int func_346(int iParam0)//Position - 0x3040C
{
	int iVar0;
...
int func_347(int iParam0)//Position - 0x30447
{
	if (iParam0 != func_221())
	{
...
int func_348(int iParam0)//Position - 0x3048E
{
	switch (iParam0)
	{
		case 0:
...
int func_349(int iParam0, bool bParam1, bool bParam2)//Position - 0x3098E
{
	int iVar0;
...
int func_350(int iParam0)//Position - 0x309EE
{
...
int func_351(int iParam0)//Position - 0x30A30
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_352(int iParam0)//Position - 0x30AF8
{
	if (iParam0 != func_221())
	{
		if (func_349(iParam0, 1, 1))
...
int func_353(int iParam0)//Position - 0x30B3F
{
	if (iParam0 != func_221())
	{
		if (func_349(iParam0, 1, 1))
...
int func_354(int iParam0)//Position - 0x30B86
{
	if (iParam0 != func_221())
	{
		if (func_349(iParam0, 1, 1))
...
int func_355(int iParam0)//Position - 0x30BCC
{
	bool bVar0;
	...
	if ((((!func_357(PLAYER::PLAYER_ID()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger")) && iParam0 != func_356(1)) && !bVar0)
	{
		return 0;
	}
	return 1;
...
int func_356(bool bParam0)//Position - 0x30C5D
{
	if (bParam0)
	{
...
int func_357(int iParam0)//Position - 0x30C77
{
	if (iParam0 != func_221())
	{
...
int func_358(int iParam0)//Position - 0x30C9D
{
...
int func_359(int iParam0)//Position - 0x30CCC
{
	...
	if (func_362(PLAYER::PLAYER_ID()) && ((((!func_355(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("openwheel1"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("openwheel2"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("formula"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("formula2"))))
	{
		return 0;
	}
...
int func_360(int iParam0)//Position - 0x30E15
{
	int iVar0;
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_351(iParam0)) || func_361(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_361(int iParam0)//Position - 0x30E92
{
	switch (iParam0)
	{
		case joaat("mule"):
...
int func_362(int iParam0)//Position - 0x30EEE
{
	if (iParam0 == func_221())
	{
		return 0;
...
int func_363(int iParam0, bool bParam1)//Position - 0x30F27
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_365(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_364(int iParam0)//Position - 0x30F82
{
	int iVar0;
...
int func_365(int iParam0, int iParam1)//Position - 0x30FBB
{
	if (iParam1 == 0)
	{
...
int func_374(int iParam0, int iParam1)//Position - 0x314B6
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_375(int iParam0)//Position - 0x31895
{
	if (PLAYER::PLAYER_ID() != func_221())
	{
		...
		if (((func_379(PLAYER::PLAYER_ID(), 1, 0) && Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_268.f_35 > 0) || BitTest(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_268.f_33, 14)) || BitTest(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_268.f_33, 11))
		{
			return 0;
		}
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("Player_Vehicle", 3))
		{
			if (DECORATOR::DECOR_EXIST_ON(iParam0, "Player_Vehicle"))
			{
				if (DECORATOR::DECOR_GET_INT(iParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
				{
					...
					{
						if (!func_376(iParam0) || ENTITY::GET_ENTITY_MODEL(iParam0) != Global_1586521[func_377() /*142*/].f_66)
						{
							return 1;
						}
					}
...
int func_376(int iParam0)//Position - 0x31991
{
...
int func_379(int iParam0, bool bParam1, bool bParam2)//Position - 0x319CF
{
	if (iParam0 == func_221())
	{
		return 0;
...
int func_380(int iParam0)//Position - 0x31A33
{
...
int func_382()//Position - 0x31A72
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

int func_383(int iParam0)//Position - 0x31A8A
{
	if (iParam0 != func_221())
	{
		if (func_349(iParam0, 1, 1))
...
int func_384(int iParam0)//Position - 0x31AE9
{
	if (iParam0 != func_221())
	{
		if (func_349(iParam0, 1, 1))
...
int func_385(int iParam0)//Position - 0x31B49
{
	if (iParam0 != func_221())
	{
		if (func_349(iParam0, 1, 1))
...
int func_386(int iParam0, bool bParam1, var uParam2)//Position - 0x31B90
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_354(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_387(int iParam0)//Position - 0x31F87
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_388(int iParam0, int iParam1)//Position - 0x31FBC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_389(int iParam0, var uParam1)//Position - 0x321BE
{
	int iVar0;
...
int func_391(int iParam0)//Position - 0x3251B
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_392(int iParam0)//Position - 0x3253B
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_288(iParam0, 0, 0)) || func_288(iParam0, 1, 0)) || func_288(iParam0, 2, 0)) || func_406(iParam0) != 145) || func_405(iParam0)) || func_404(iParam0)) || func_346(iParam0)) || func_403(iParam0)) || !func_393(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_404(iParam0))
		{
		}
...
int func_393(int iParam0)//Position - 0x32618
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_394(int iParam0, bool bParam1, int iParam2)//Position - 0x327D6
{
	int iVar0;
	struct<2> Var1;
...
int func_395(int iParam0)//Position - 0x3295B
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_397(int iParam0, int iParam1)//Position - 0x32A46
{
	int iVar0;
	int iVar1;
...
int func_398()//Position - 0x32C97
{
	return 0;
}

int func_399()//Position - 0x32CA0
{
	return 1;
}

int func_400()//Position - 0x32CA9
{
	return 1;
}

int func_401()//Position - 0x32CB2
{
...
int func_403(int iParam0)//Position - 0x32D83
{
	int iVar0;
	char* sVar1;
...
int func_404(int iParam0)//Position - 0x32DCB
{
	int iVar0;
...
int func_405(int iParam0)//Position - 0x32E47
{
	int iVar0;
...
int func_406(int iParam0)//Position - 0x32F2F
{
	int iVar0;
...
void func_407(int iParam0, int iParam1)//Position - 0x32F92
{
	int iVar0;
...
void func_408(int iParam0)//Position - 0x33014
{
	if (!func_409(*iParam0))
	{
...
bool func_409(int iParam0)//Position - 0x3303F
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_410(int iParam0, var uParam1, var uParam2)//Position - 0x3304E
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*iParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_415(*iParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_374(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_413(*iParam0, ((*uParam1)[38] - 1)))
	{
...
int func_411(int iParam0)//Position - 0x33228
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_413(int iParam0, int iParam1)//Position - 0x3335D
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_414(int iParam0, int iParam1)//Position - 0x33446
{
	int iVar0;
...
int func_415(int iParam0, int iParam1, int iParam2)//Position - 0x334A8
{
	if (!func_416() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_416()//Position - 0x334CC
{
	return 0;
}

int func_417(var uParam0, int iParam1)//Position - 0x334D5
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_418(int iParam0, var uParam1, int iParam2)//Position - 0x33516
{
	int iVar0;
...
void func_419(int iParam0, int iParam1)//Position - 0x33777
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98844[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98844[iVar0]) == func_420(iParam0, iParam1))
				{
...
int func_420(int iParam0, int iParam1)//Position - 0x33815
{
	struct<82> Var0;
...
void func_421(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x33857
{
	int iVar0;
...
int func_424(int iParam0, int iParam1)//Position - 0x33AE2
{
	int iVar0;
...
int func_426(var uParam0, int iParam1)//Position - 0x33B60
{
	int iVar0;
	int iVar1;
...
bool func_427(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x35254
{
	if (bParam6)
	{
...
int func_428(struct<3> Param0, float fParam3)//Position - 0x3529B
{
	return func_429(&(Global_107514.f_2890), Param0, fParam3, 0);
}

int func_429(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x352B5
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (func_454(uParam0))
	{
		...
		if (func_453(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_431(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_430(iVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_430(int iParam0)//Position - 0x35568
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_431(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x3562B
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_433(iParam0, uVar1[iVar6], 1) && func_432(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.5635f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_427(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_432(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x35833
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_433(int iParam0, int iParam1, bool bParam2)//Position - 0x358AE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_434(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x3590F
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("surfer3"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_390(iVar5));
				}
				iVar5++;
			}
		}
		...
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar6 <= 2)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_390(iVar6));
				}
				iVar6++;
			}
		}
		...
		if ((((func_436() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_356(1)))
		{
...
int func_435(int iParam0, float fParam1)//Position - 0x36016
{
	struct<3> Var0;
	float fVar3;
...
int func_437(var uParam0)//Position - 0x36116
{
	int iVar0;
...
int func_438(int iParam0)//Position - 0x3613A
{
	int iVar0;
...
var func_440(var uParam0, var uParam1)//Position - 0x3616C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_441(int iParam0, int iParam1)//Position - 0x3618F
{
	int iVar0;
	int iVar1;
...
int func_443(int iParam0)//Position - 0x36218
{
	int iVar0;
...
int func_444(int iParam0)//Position - 0x36263
{
...
int func_445(int iParam0)//Position - 0x36283
{
	switch (iParam0)
	{
		case 161:
...
int func_446(int iParam0)//Position - 0x362D6
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (!func_452(PLAYER::PLAYER_ID(), -1))
		{
...
int func_447(int iParam0)//Position - 0x3635D
{
...
int func_448(int iParam0)//Position - 0x3638F
{
...
int func_449(int iParam0)//Position - 0x363AC
{
...
int func_450(int iParam0, int iParam1)//Position - 0x363CF
{
	if (func_273(iParam0))
	{
...
int func_451(int iParam0)//Position - 0x36413
{
	if (func_273(iParam0))
	{
		if (func_450(iParam0, 0))
...
int func_452(int iParam0, int iParam1)//Position - 0x3643F
{
	int iVar0;
...
int func_453(var uParam0)//Position - 0x3648C
{
	if (func_454(uParam0))
	{
...
int func_454(var uParam0)//Position - 0x364C1
{
...
int func_458(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x36565
{
...
int func_460(int iParam0)//Position - 0x36668
{
	switch (iParam0)
	{
		case joaat("police"):
...
void func_462(int iParam0, int iParam1, bool bParam2)//Position - 0x3670B
{
	int iVar0;
...
struct<4> func_464(int iParam0)//Position - 0x36908
{
	return Global_2169[iParam0 /*29*/].f_3;
}

int func_465(int iParam0, int iParam1)//Position - 0x3691B
{
...
int func_466(int iParam0, int iParam1)//Position - 0x36945
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_467(int iParam0, int iParam1, int iParam2)//Position - 0x3696F
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_468(int iParam0, int iParam1, int iParam2)//Position - 0x369B4
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
int func_470(int iParam0)//Position - 0x36D13
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_472(var uParam0)//Position - 0x36E29
{
	int iVar0[4];
	int iVar5;
	float fVar6;
...
void func_473(int* iParam0, bool bParam1)//Position - 0x37223
{
	struct<3> Var0;
	float fVar3;
	...
	func_474(iParam0, iLocal_79, Var0, fVar3);
...
void func_474(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x37297
{
	func_236(iParam0);
...
void func_475(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x372DA
{
	func_237(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

int func_476(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x372FB
{
	if (func_477(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_477(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x37357
{
	int iVar0;
...
int func_478(var uParam0, int iParam1)//Position - 0x373E5
{
	int iVar0;
...
int func_479(var uParam0)//Position - 0x3742B
{
	if (func_480(uParam0))
	{
...
int func_480(var uParam0)//Position - 0x37455
{
...
int func_481(int iParam0)//Position - 0x3747A
{
	int iVar0;
...
void func_483(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x374E7
{
	if (func_484())
	{
...
void func_489(int* iParam0, bool bParam1)//Position - 0x376E2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_490(int* iParam0)//Position - 0x3771D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_496(bool bParam0)//Position - 0x3788B
{
	...
	if (!func_513())
	{
		...
		{
			func_162(iVar0, 1, 0);
			func_497(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_113056[iVar0 /*10*/].f_9 == -1)
...
void func_497(char* sParam0, int iParam1)//Position - 0x3795B
{
	if (Global_101533 != 12)
	{
...
int func_498(char* sParam0, int iParam1, int iParam2)//Position - 0x37983
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_504())
	{
		...
		{
			iVar33 = func_499(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_499(char* sParam0)//Position - 0x37B12
{
...
int func_501(char* sParam0, bool bParam1)//Position - 0x37B90
{
	int iVar0;
	int iVar1;
...
int func_502(int iParam0, bool bParam1)//Position - 0x37BBA
{
	int iVar0;
...
void func_518(char* sParam0)//Position - 0x37F8D
{
	sParam0 = sParam0;
}

int func_519(int iParam0)//Position - 0x37F99
{
	if (!func_154(iParam0))
	{
		return func_153(iParam0);
