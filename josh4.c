				...
				case 0:
					if (func_293(1, 1093140480, 0))
					{
						...
						if (func_207(iVar0))
						{
							if (VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iVar0)))
							{
								func_283(-1115.9844f, 285.59244f, 61.942406f, -1097.5992f, 285.1346f, 66.346695f, 33f, Var1, fVar2, 50f, 50f, 50f, 1, 1, 1, 0, 0);
							}
							else
							{
								func_283(-1115.9844f, 285.59244f, 61.942406f, -1097.5992f, 285.1346f, 66.346695f, 33f, Var1, fVar2, func_282(), 1, 1, 1, 0, 0);
							}
						}
						else
						{
