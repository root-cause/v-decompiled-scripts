		...
		switch (iLocal_250)
		{
			...
			case 8:
				...
				else if (iLocal_440 == 1)
				{
					...
					{
						func_53(Global_113593[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_240, &Local_372, &Local_356));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_62();
				bVar37 = func_63();
				func_52(Global_113593[iLocal_251]);
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_505)
					{
						Global_113593[iLocal_251] = uLocal_504;
					}
					else
					{
...
{
	if (Global_113593[iLocal_251] == 3 && (iLocal_297 >= 4 && iLocal_297 <= 12))
	{
		return 1;
	}
	return 0;
...
void func_55()//Position - 0x242D
{
	...
	func_58(Global_113593[iLocal_251] + 1, &sVar0, &Var8);
	...
	PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_240, false, false);
	func_56(Global_113593[iLocal_251]);
}
...
void func_106()//Position - 0x3241
{
	...
	bLocal_436 = !Global_3;
	iLocal_252 = 8;
	sLocal_303 = "PBZB_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to the Zombie. */;
