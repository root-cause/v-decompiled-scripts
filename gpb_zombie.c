		...
		switch (iLocal_216)
		{
			...
			case 8:
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_53(Global_113593[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_208, &Local_253, &Local_252));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_62();
				bVar37 = func_63();
				func_52(Global_113593[iLocal_217]);
...
{
	if (Global_113593[iLocal_217] == 3 && (iLocal_223 >= 4 && iLocal_223 <= 12))
	{
		return 1;
	}
	return 0;
...
void func_18()//Position - 0x168B
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_22(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_20(iVar0) && (!func_19(14) || Global_112599))
			{
...
void func_55()//Position - 0x242D
{
	...
	func_58(Global_113593[iLocal_217] + 1, &sVar0, &Var1);
	...
	PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_208, false, false);
	func_56(Global_113593[iLocal_217]);
}
...
void func_98(int iParam0)//Position - 0x305A
{
	...
	func_101(&(Global_113648.f_20119), iParam0);
