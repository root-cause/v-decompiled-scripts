...
void __EntryFunction__()//Position - 0x0
{
	...
	while (iVar0 == 1)
	{
		...
		switch (iLocal_216)
		{
			...
			case 8:
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_53(Global_113331[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_208, &Local_253, &Local_252));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_62();
				bVar37 = func_63();
				func_52(Global_113331[iLocal_217]);
		...
		if (((((((((((((iLocal_216 == 0 || iLocal_216 == 1) || iLocal_216 == 3) || iLocal_216 == 8) || iLocal_216 == 9) || iLocal_216 == 7) && func_85(iLocal_208, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_265 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) && iVar6 == 0) && bLocal_268 == 1) && !Global_3) && func_7()) && bVar18)
		{
			if (iLocal_224 == -1)
			{
...
{
	if (Global_113331[iLocal_217] == 3 && (iLocal_223 >= 4 && iLocal_223 <= 12))
	{
		return 1;
	}
	return 0;
...
void func_18()//Position - 0x168B
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_22(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_20(iVar0) && (!func_19(14) || Global_112337))
			{
...
void func_55()//Position - 0x242D
{
	...
	func_58(Global_113331[iLocal_217] + 1, &sVar0, &Var1);
	...
	PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_208, false, false);
	func_56(Global_113331[iLocal_217]);
}
...
int func_86(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2EA6
{
	...
	{
		Var1 = { func_88(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_87(struct<3> Param0, struct<3> Param1)//Position - 0x2F37
{
...
void func_98(int iParam0)//Position - 0x305A
{
	...
	func_101(&(Global_113386.f_20117), iParam0);
...
{
	PED::SET_PED_CAN_EVASIVE_DIVE(iLocal_208, false);
...
void func_106()//Position - 0x3241
{
	...
	bLocal_265 = !Global_3;
	iLocal_218 = 8;
	sLocal_226 = "PBZB_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to the Zombie. */;
