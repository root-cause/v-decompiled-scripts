...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_239 = 1;
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_238) && func_103(iLocal_238))
	{
	...
	while (iVar0 == 1)
	{
		...
		fVar43 = func_97(PLAYER::PLAYER_PED_ID(), iLocal_238);
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if ((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_238) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_238)) && fVar43 < 25f) && func_89(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED")) && func_86(iLocal_238, PLAYER::PLAYER_PED_ID(), 1126825984, 0))
			{
				if (!func_90())
				{
					func_92();
		...
		if (func_85(iLocal_238, PLAYER::PLAYER_PED_ID(), 1) < 25f)
		{
			if (!HUD::DOES_BLIP_EXIST(iLocal_246))
			{
				func_81(&iLocal_246, &iLocal_238, 0);
			}
		}
		...
		switch (iLocal_248)
		{
			...
			case 3:
				...
				if (func_85(iLocal_238, PLAYER::PLAYER_PED_ID(), 1) < fVar40)
				{
					if (func_59() == 1)
					{
						iLocal_248 = 8;
			...
			case 8:
				...
				else if (iLocal_438 == 1)
				{
					...
					{
						func_53(Global_114317[iLocal_249], iLocal_295, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_238, &Local_370, &Local_354));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_62();
				bVar37 = func_63();
				func_52(Global_114317[iLocal_249]);
				if (!bVar37 && (!bVar36 || bLocal_435))
				{
					if (bLocal_503)
					{
						Global_114317[iLocal_249] = uLocal_502;
					}
					else
					{
			...
			case 13:
				...
				func_50(&uLocal_35, 3, iLocal_238, &Local_234, 0, 1);
				func_49(&cVar5);
				if (func_34(&uLocal_35, &cLocal_302, &cVar5, 3, 0, 0, 0))
				{
					iLocal_248 = 14;
				}
				func_33();
			...
			case 10:
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(&Local_402))
				{
					...
					else if (func_34(&uLocal_35, &cLocal_302, &cVar9, 3, 0, 0, 0))
					{
						iVar35 = 1;
					}
					if (iVar35 == 1)
			...
			case 12:
				...
				iLocal_244++;
				Local_418 = { Local_402 };
				if (!iLocal_244 < func_16() || fVar43 > 10f)
				{
		...
		if (((((((((((((iLocal_248 == 0 || iLocal_248 == 1) || iLocal_248 == 3) || iLocal_248 == 8) || iLocal_248 == 9) || iLocal_248 == 7) && func_85(iLocal_238, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_434 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) && iVar30 == 0) && bLocal_437 == 1) && !Global_4) && func_7()) && bVar81)
		{
			if (iLocal_296 == -1)
			{
	...
	while (true)
	{
		...
		if ((ENTITY::IS_ENTITY_OCCLUDED(iLocal_238) && func_85(iLocal_238, PLAYER::PLAYER_PED_ID(), 1) > 50f) && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			func_114(1);
		}
		SYSTEM::WAIT(0);
...
int func_8()//Position - 0x14DD
{
	if (Global_114317[iLocal_249] == 3 && (iLocal_295 >= 4 && iLocal_295 <= 12))
	{
		return 1;
	}
	return 0;
...
{
	func_10();
	if (func_103(iLocal_238) && func_103(PLAYER::PLAYER_PED_ID()))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_238, false);
...
void func_18()//Position - 0x168B
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_22(Global_114372.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_20(iVar0) && (!func_19(14) || Global_113320))
			{
...
bool func_20(int iParam0)//Position - 0x1796
{
	return iParam0 < 3;
}

int func_21(int iParam0)//Position - 0x17A2
{
	int iVar0;
	int iVar1;
...
int func_22(int iParam0)//Position - 0x17DF
{
	if (func_20(iParam0))
	{
...
var func_23(int iParam0)//Position - 0x1804
{
...
void func_29(char* sParam0)//Position - 0x1AB8
{
	...
	*sParam0 = { Var0 };
	...
	StringIntConCat(sParam0, iLocal_297[func_17()], 16);
}
...
bool func_34(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B81
{
...
var func_39(int iParam0, int iParam1)//Position - 0x1F47
{
	return BitTest(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_40()//Position - 0x1F5F
{
	return -1;
}
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x221D
{
...
void func_49(char[4] cParam0)//Position - 0x2273
{
	int iVar0;
...
void func_50(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x22AE
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_52(var uParam0)//Position - 0x2381
{
}
...
void func_53(int iParam0, int iParam1, float fParam2)//Position - 0x2389
{
	if (iParam0 == 3)
	{
		if ((iParam1 == 3 && !iLocal_447) && fParam2 >= 0.773f)
		{
			iLocal_446 = OBJECT::CREATE_OBJECT(joaat("prop_npc_phone"), ENTITY::GET_ENTITY_COORDS(iLocal_238, true), true, true, false);
		...
		if ((iParam1 == 12 && iLocal_447) && fParam2 >= 0.116f)
		{
			ENTITY::DETACH_ENTITY(iLocal_446, true, true);
			OBJECT::DELETE_OBJECT(&iLocal_446);
			iLocal_447 = 0;
...
void func_55()//Position - 0x242D
{
	...
	func_58(Global_114317[iLocal_249] + 1, &sVar0, &Var8);
	...
	PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_238, false, false);
	func_56(Global_114317[iLocal_249]);
}

void func_56(var uParam0)//Position - 0x24A3
{
}

void func_57(char* sParam0)//Position - 0x24AB
{
...
int func_59()//Position - 0x255D
{
	...
	{
		iVar4 = func_34(&uLocal_35, &cLocal_302, &Var0, 3, 0, 0, 0);
	}
	Local_498 = { Var0 };
	return iVar4;
}
...
void func_71(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2766
{
	int iVar0;
...
int func_73(int iParam0)//Position - 0x2A4F
{
	int iVar0;
	int iVar1;
...
int func_76(int iParam0)//Position - 0x2B95
{
	if (func_78(iParam0))
	{
...
int func_77(int iParam0)//Position - 0x2BB9
{
	int iVar0;
...
int func_78(int iParam0)//Position - 0x2BE9
{
...
void func_80(int* iParam0)//Position - 0x2CD1
{
	if (iLocal_445 == 1)
	{
...
void func_81(int* iParam0, int iParam1, bool bParam2)//Position - 0x2CF0
{
	if (iLocal_445 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_82(int iParam0, bool bParam1, int iParam2)//Position - 0x2D43
{
	int iVar0;
...
int func_83(int iParam0, bool bParam1, bool bParam2)//Position - 0x2D8D
{
	int iVar0;
...
float func_84(bool bParam0, float fParam1, float fParam2)//Position - 0x2E31
{
	if (bParam0)
	{
		return fParam1;
...
float func_85(int iParam0, int iParam1, bool bParam2)//Position - 0x2E48
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_86(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2EA6
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_87(struct<3> Param0, struct<3> Param3)//Position - 0x2F37
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_88(struct<3> Param0)//Position - 0x2F58
{
	float fVar0;
	float fVar1;
...
int func_89(int iParam0)//Position - 0x2F97
{
	var uVar0;
...
int func_96()//Position - 0x3030
{
	if (Global_114317[iLocal_249] == 3)
	{
		return 0;
	}
	return 1;
...
float func_97(int iParam0, int iParam1)//Position - 0x3049
{
...
void func_98(int iParam0)//Position - 0x305A
{
	...
	func_101(&(Global_114372.f_20120), iParam0);
...
void func_101(var uParam0, var uParam1)//Position - 0x316F
{
...
int func_103(int iParam0)//Position - 0x31F2
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
{
	PED::SET_PED_CAN_EVASIVE_DIVE(iLocal_238, false);
	PED::SET_PED_CONFIG_FLAG(iLocal_238, 185, true);
	PED::SET_PED_CONFIG_FLAG(iLocal_238, 318, true);
}

void func_106()//Position - 0x3241
{
	iLocal_34 = joaat("U_M_Y_Zombie_01");
	StringCopy(&Local_232, "PBZB", 8);
	StringCopy(&Local_234, "ZOMBIE", 16);
	StringCopy(&Local_200, "Special_Ped@zombie", 64);
	StringCopy(&Local_216, "Base", 64);
	bLocal_434 = !Global_4;
	iLocal_250 = 8;
	sLocal_301 = "PBZB_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to the Zombie. */;
	StringCopy(&Local_310, "PBZB_CONV_GM", 16);
	StringCopy(&Local_314, "PBZB_CONV_GT", 16);
	StringCopy(&Local_318, "PBZB_CONV_GF", 16);
	StringCopy(&cLocal_322, "special_ped@zombie@base", 64);
	StringCopy(&cLocal_338, "special_ped@zombie@intro", 64);
	iLocal_249 = 12;
	iLocal_253[0] = 9;
	iLocal_253[1] = 8;
	iLocal_253[2] = 7;
...
int func_110()//Position - 0x333D
{
	return 1;
}

bool func_111(var uParam0)//Position - 0x3346
{
	return func_112(Global_114372.f_20120, uParam0);
}

bool func_112(var uParam0, var uParam1)//Position - 0x335B
{
	return (uParam0 && uParam1) != 0;
}

int func_113(char* sParam0)//Position - 0x336A
{
...
void func_115(int* iParam0)//Position - 0x3560
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
