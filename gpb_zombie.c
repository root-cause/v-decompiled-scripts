...
void __EntryFunction__()//Position - 0x0
{
	...
	while (iVar0 == 1)
	{
		...
		switch (iLocal_248)
		{
			...
			case 8:
				...
				else if (iLocal_438 == 1)
				{
					...
					{
						func_53(Global_113755[iLocal_249], iLocal_295, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_238, &Local_370, &Local_354));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_62();
				bVar37 = func_63();
				func_52(Global_113755[iLocal_249]);
				if (!bVar37 && (!bVar36 || bLocal_435))
				{
					if (bLocal_503)
					{
						Global_113755[iLocal_249] = uLocal_502;
					}
					else
					{
		...
		if (((((((((((((iLocal_248 == 0 || iLocal_248 == 1) || iLocal_248 == 3) || iLocal_248 == 8) || iLocal_248 == 9) || iLocal_248 == 7) && func_85(iLocal_238, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_434 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) && iVar30 == 0) && bLocal_437 == 1) && !Global_3) && func_7()) && bVar81)
		{
			if (iLocal_296 == -1)
			{
...
{
	if (Global_113755[iLocal_249] == 3 && (iLocal_295 >= 4 && iLocal_295 <= 12))
	{
		return 1;
	}
	return 0;
...
void func_55()//Position - 0x242D
{
	...
	func_58(Global_113755[iLocal_249] + 1, &sVar0, &Var8);
	...
	PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_238, false, false);
	func_56(Global_113755[iLocal_249]);
}
