...
void func_290()//Position - 0x2A202
{
	...
	else if (iLocal_42 == 1)
	{
		...
		{
			if (!bLocal_57 && (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 415.4781f, -771.7041f, 27.85562f, 415.5606f, -759.9372f, 31.36162f, 7.25f, false, true, 0) || func_291()))
			{
				bLocal_57 = true;
...
int func_434(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x374A5
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_436(iParam0, uVar1[iVar3], 1) && func_435(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
