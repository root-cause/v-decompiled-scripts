...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	uLocal_80 = func_516(49);
	sLocal_142 = "DEFAULT" /* GXT: _ */;
	...
	{
		func_352(&iLocal_147, &(Local_81.f_28[0]));
	}
	func_351(1);
	while (true)
	{
		...
		func_335(Local_81.f_9, 0, 0, 0, 0, 0);
		if (iLocal_143 == 5)
		{
			func_329();
		}
...
int func_31(int iParam0, int iParam1, int iParam2)//Position - 0x152E
{
	...
	else
	{
		...
		Global_78341[1 /*14*/] = { func_83(iVar0, iParam1, uVar31[iParam1], -1) };
...
int func_34(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x17B2
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_83(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_83(iVar10, 14, uVar69[iVar1], -1) };
			func_50(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_66(14);
			if (Global_78339 == 1)
			{
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x456A
{
	...
	else
	{
		...
		iVar36 = (iParam1 - func_53(iParam0, func_75(iParam2)));
		if (iVar36 < 0)
		{
			return -1;
		}
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4CC6
{
	...
	else
	{
		...
		if (iVar18 != -1)
		{
			return (func_53(iParam0, func_75(iParam2)) + iVar18);
		}
	}
	return -99;
}
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_81(Var16.f_2)] = func_57(iParam1, Var16.f_0, func_81(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
void func_85(int iParam0)//Position - 0xC01E
{
	...
	func_86(&(Global_78341[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_93(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE30C
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_86(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_86(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_160(int iParam0, bool bParam1, bool bParam2)//Position - 0x1FFB8
{
	...
	if (iParam0 != -1)
	{
		...
		func_161(&sVar32, Var0.f_3, Global_100718, bParam1, bParam2);
	}
}
	...
	switch (iLocal_144)
	{
		case 0:
			if (func_240())
			{
				...
				if (!bLocal_163[3] && func_237(PLAYER::PLAYER_PED_ID(), iLocal_147, 15f, 1))
				{
					bLocal_163[3] = func_222(&uLocal_179, "BARR3AU", sLocal_173[3], 7, 1, 0, 0);
				}
				if (!bLocal_159)
				{
					func_221(1);
		...
		case 1:
			...
			if (func_353(iLocal_149[0]) && func_353(iLocal_149[1]))
			{
				if ((func_220(iLocal_149[0], Local_360, 30f, 1) || func_217(iLocal_149[0], PLAYER::PLAYER_PED_ID(), 1126825984, 0)) || func_217(iLocal_149[1], PLAYER::PLAYER_PED_ID(), 1126825984, 0))
				{
					func_216(&(iLocal_149[0]), 1, 0, 1);
					func_216(&(iLocal_149[1]), 1, 0, 1);
					func_215(&iLocal_148);
				}
			}
			break;
...
float func_218(struct<3> Param0, struct<3> Param3)//Position - 0x2716D
{
...
bool func_220(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x271CD
{
...
void func_239(bool bParam0)//Position - 0x279A7
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_81.f_41[0]))
	{
		if (bParam0)
		{
			...
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_81.f_41[0], iLocal_147, PED::GET_PED_BONE_INDEX(iLocal_147, 60309), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
			}
		}
...
int func_240()//Position - 0x27A1F
{
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iLocal_148) && STREAMING::HAS_MODEL_LOADED(iLocal_153)) && STREAMING::HAS_MODEL_LOADED(iLocal_154))
	{
		Var0 = { Local_354 };
		fVar3 = fLocal_365;
		if (func_241(PLAYER::PLAYER_PED_ID(), Local_354, 1) < func_241(PLAYER::PLAYER_PED_ID(), Local_357, 1))
		{
			Var0 = { Local_357 };
			fVar3 = fLocal_366;
		}
...
float func_241(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x27B29
{
	struct<3> Var0;
	...
	switch (iLocal_144)
	{
		...
		case 1:
			if (!func_247())
			{
				...
				if (iLocal_162 < 3)
				{
					if (func_237(PLAYER::PLAYER_PED_ID(), iLocal_147, 15f, 1))
					{
						if (!bLocal_163[iLocal_162])
						{
							if ((MISC::GET_GAME_TIMER() - iLocal_178) > iLocal_344[iLocal_162])
							{
								bLocal_163[iLocal_162] = func_222(&uLocal_179, "BARR3AU", sLocal_173[iLocal_162], 7, 0, 0, 0);
							}
						}
						else
						{
			...
			else if (func_237(PLAYER::PLAYER_PED_ID(), iLocal_147, 15f, 1))
			{
				if (!bLocal_169)
				{
					bLocal_169 = func_222(&uLocal_179, "BARR3AU", "BARRY3_TRICK", 7, 0, 0, 0);
				}
			}
			if (!iLocal_157)
			{
				...
				else if (!func_237(PLAYER::PLAYER_PED_ID(), iLocal_147, 100f, 1))
				{
					iLocal_144 = 2;
				}
			}
...
{
	if (func_237(iLocal_147, PLAYER::PLAYER_PED_ID(), 7f, 1))
	{
		if (!PED::IS_PED_HEADTRACKING_PED(iLocal_147, PLAYER::PLAYER_PED_ID()))
		{
	...
	if (func_237(iLocal_147, PLAYER::PLAYER_PED_ID(), 6f, 1))
	{
		if (!PED::IS_PED_HEADTRACKING_PED(PLAYER::PLAYER_PED_ID(), iLocal_147))
		{
...
bool func_247()//Position - 0x27E1D
{
	if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (func_237(iLocal_147, PLAYER::PLAYER_PED_ID(), 40f, 1))
			{
				bLocal_158 = true;
			}
			else
		...
		{
			if (func_237(iLocal_147, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 15f, 1))
			{
				bLocal_159 = true;
				AUDIO::STOP_SCRIPTED_CONVERSATION(false);
				func_221(0);
	...
	switch (iLocal_144)
	{
		...
		case 1:
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_367))
			{
				if (iLocal_172 == 0)
				{
					if (func_222(&uLocal_179, "BARR3AU", "BAR_3_INT_LO", 8, 0, 0, 0))
					{
						iLocal_172 = 1;
					}
				}
	...
	switch (iLocal_144)
	{
		case 0:
			...
			if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
			{
				if (func_353(PLAYER::PLAYER_PED_ID()))
				{
					func_284(sLocal_369, PLAYER::PLAYER_PED_ID(), 0, 2);
				}
...
void func_265(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x2866A
{
	int iVar0;
...
void func_268(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x2887A
{
	func_269(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_269(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x288A3
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_273(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x28E09
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_274(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x290FF
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_285(int iParam0, var uParam1, int iParam2)//Position - 0x29642
{
	...
	while (iVar0 < 12)
	{
		...
		{
			if (func_41(iVar81, func_81(iVar0), func_65(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_81(iVar0)), &uVar1))
			{
			...
			if (func_48(iVar81, func_81(iVar0), func_65(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_81(iVar0)), &uVar1))
			{
...
void func_290()//Position - 0x2A20D
{
	...
	{
		if (func_255(iLocal_147))
		{
			if (!bLocal_161 && (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 415.47806f, -771.7041f, 27.855623f, 415.5606f, -759.9372f, 31.361616f, 7.25f, false, true, 0) || func_291()))
			{
				bLocal_161 = true;
				if (func_237(PLAYER::PLAYER_PED_ID(), iLocal_147, 5f, 1))
				{
					bLocal_171 = true;
				}
			}
			if (bLocal_161)
			{
				...
				if (func_237(PLAYER::PLAYER_PED_ID(), iLocal_147, 2.5f, 1))
				{
			...
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_147, sLocal_145, "lead_in", 3))
			{
				if (iLocal_170 == 0)
				{
					if (func_222(&uLocal_179, "BARR3AU", "BAR_3_INT_LI", 8, 0, 0, 0))
					{
						iLocal_170 = 1;
					}
				}
...
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && func_353(iLocal_147))
	{
...
void func_301()//Position - 0x2A65C
{
	...
	if (iLocal_144 == 0)
	{
		...
		func_309(&uLocal_179, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		func_309(&uLocal_179, 3, iLocal_147, "BARRY", 0, 1);
			...
			if (func_478())
			{
				switch (func_308())
				{
					case 0:
						...
						STREAMING::REQUEST_MODEL(iLocal_154);
						func_307(0, 0);
						func_306(iLocal_147, Local_351, fLocal_364, 1, 1);
						...
						func_264();
						func_305(Local_348, fLocal_363, 1, 0);
						func_303(0, -1, 1);
						func_252(2);
						break;
...
void func_305(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2A931
{
	if (func_478())
	{
...
int func_306(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2A9C6
{
	bool bVar0;
	float fVar1;
...
int func_310()//Position - 0x2AB19
{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(iLocal_147))
	{
		...
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_147, PLAYER::PLAYER_PED_ID(), true) || func_327(PLAYER::PLAYER_PED_ID(), iLocal_147, 1))
		{
		...
		else if (func_311(iLocal_147, 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_327(PLAYER::PLAYER_PED_ID(), iLocal_147, 1))
		{
			if (!iLocal_157)
			{
...
bool func_314(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2AD61
{
	...
	iVar4 = func_319(iParam0, iParam1);
	if (!func_353(iParam0) || !func_353(iParam1))
	{
		if (iVar4 != -1)
		{
			func_318(&(Local_37[iVar4 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_315(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_315(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2AE22
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_325(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x2B3C2
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_329()//Position - 0x2B504
{
	...
	{
		case 0:
			if (MISC::ARE_STRINGS_EQUAL(sLocal_142, "DEFAULT" /* GXT: _ */))
			{
				func_494(1);
			}
			else
			{
				func_333(sLocal_142, 1);
			}
			iLocal_144 = 1;
			break;
		...
		case 1:
			...
			else if (!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_142))
			{
				if (func_255(iLocal_147))
				{
					if (func_255(PLAYER::PLAYER_PED_ID()) && func_237(PLAYER::PLAYER_PED_ID(), iLocal_147, 15f, 1))
					{
						func_330();
					}
				}
...
int func_330()//Position - 0x2B588
{
	...
	if (!bLocal_168)
	{
		...
		else
		{
			...
			if (iVar0 == 0)
			{
				bLocal_168 = func_331(&uLocal_179, "BARR3AU", "BARRY3_EEP", "BARRY3_EEP_1", 9, 1, 0);
			}
			else if (iVar0 == 1)
			{
				bLocal_168 = func_331(&uLocal_179, "BARR3AU", "BARRY3_EEP", "BARRY3_EEP_2", 9, 1, 0);
			}
			else
			{
				bLocal_168 = func_331(&uLocal_179, "BARR3AU", "BARRY3_EEP", "BARRY3_EEP_3", 9, 1, 0);
			}
		}
	}
	if (bLocal_168)
...
void func_335(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2B6E7
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_337(Global_78814, Global_78816, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_338(iVar2), 8);
					break;
			}
			break;
...
void func_354(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2C166
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_435(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
		...
		{
			func_426(iParam12, 0);
			while (!func_355(iParam0, iParam12, Param1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_355(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2C2FA
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5.f_0, Param2, fParam5, true, true, false);
				...
				func_417(iParam0, &(Var5.f_31), &(Var5.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
int func_357(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x2DD2E
{
	...
	iVar0 = 0;
	while (func_358(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
void func_428(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x35BD0
{
	int iVar0;
...
bool func_434(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x375C7
{
	if (bParam6)
	{
...
int func_435(struct<3> Param0, float fParam3)//Position - 0x3760E
{
	return func_436(&(Global_107196.f_2890), Param0, fParam3, 0);
}

int func_436(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x37628
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_438(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x3799D
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_440(iParam0, uVar1[iVar6], 1) && func_439(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.5635f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_434(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
int func_439(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x37BA5
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_468(var uParam0)//Position - 0x3899E
{
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			{
				if (func_471(&(uParam0->f_28[0]), 49, Var3, fVar6, "RC LAUNCHER: BARRY 3", 1))
				{
			...
			{
				func_469(&(uParam0->f_41[0]), iVar0[1], Var3 + Vector(0f, 0f, 5f), -115.18f);
...
void func_469(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x38B95
{
	func_470(iParam0);
...
int func_471(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x38BE7
{
	if (func_472(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_472(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x38C43
{
	int iVar0;
...
void func_479()//Position - 0x38DF7
{
	...
	func_492(&uLocal_179, 1);
	func_492(&uLocal_179, 3);
	HUD::CLEAR_PRINTS();
	...
	func_216(&iLocal_147, 1, 0, 1);
	func_491(&iLocal_152, 0);
	func_490(1);
	func_351(0);
	PED::SET_CREATE_RANDOM_COPS(true);
	func_480(&Local_81, 0, 0, 0);
...
void func_490(bool bParam0)//Position - 0x39097
{
	...
	{
		func_489(&(iLocal_149[0]));
		func_489(&(iLocal_149[1]));
		func_485(&iLocal_148);
	}
}
...
int func_496(char* sParam0, int iParam1, int iParam2)//Position - 0x392CE
{
	...
	if (func_502())
	{
		...
		{
			iVar33 = func_497(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
