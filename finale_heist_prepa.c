#region Local Var
	...
	var uLocal_296 = 0;
	var uLocal_297 = 0;
	struct<4> Local_298[2];
	struct<7> Local_307[6];
	int iLocal_350 = 0;
	...
	bool bLocal_385 = 0;
	bool bLocal_386 = 0;
	struct<22> Local_387[3];
	struct<6> Local_454 = { 0, 0, 0, 0, 0, 0 } ;
	struct<6> Local_460[3];
	int iLocal_479 = 0;
	char[] cLocal_480[8] = 0;
	var uLocal_481 = 16;
	var uLocal_482 = 0;
	...
	char* sLocal_650[3] = { NULL, NULL, NULL };
	int iLocal_654 = 0;
	int iLocal_655 = 0;
	int iLocal_656 = 0;
	int iLocal_657 = 0;
...
void __EntryFunction__()//Position - 0x0
{
	...
	sLocal_352 = "FINPRA";
	Local_359 = { 0f, 0f, 0f };
	Local_362 = { 134.6909f, -1255.3782f, 28.4875f };
	fLocal_368 = 0f;
	bLocal_371 = true;
	cLocal_480 = "BSPRAAU";
	iLocal_658 = -1;
	iLocal_660 = 1;
	iLocal_663 = -1;
	StringCopy(&cLocal_664, "NONE" /* GXT: None */, 24);
	StringCopy(&cLocal_670, "NONE" /* GXT: None */, 24);
...
void func_2()//Position - 0x288
{
	...
	VEHICLE::REMOVE_VEHICLE_UPSIDEDOWN_CHECK(Local_454.f_0);
	func_5(&Local_454);
	func_4(&iLocal_356);
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		func_3(&(Local_387[iVar0 /*22*/]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		func_5(&(Local_460[iVar0 /*6*/]));
		iVar0++;
	}
}

void func_3(int* iParam0)//Position - 0x2DF
{
...
void func_4(int* iParam0)//Position - 0x320
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_5(int* iParam0)//Position - 0x34B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_6(int iParam0)//Position - 0x3E7
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_7(int iParam0)//Position - 0x408
{
	if (func_6(iParam0))
	{
...
void func_8(struct<3> Param0, float fParam3)//Position - 0x432
{
	func_9(&(Global_107917.f_2890), Param0, fParam3);
}

void func_9(var uParam0, struct<3> Param1, var uParam4)//Position - 0x44B
{
	*uParam0 = { Param1 };
	uParam0->f_6 = uParam4;
}

void func_10(struct<3> Param0, float fParam3)//Position - 0x461
{
...
bool func_11(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x48D
{
	if (bParam6)
	{
...
bool func_12(var uParam0, struct<2> Param1, Vector3 vParam3)//Position - 0x4D4
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_15(int iParam0)//Position - 0x5D2
{
	int iVar0;
	
	if (Global_114372.f_9088 || func_30(0))
	{
		iVar0 = func_29();
		if (!func_16(iVar0))
		{
...
int func_16(int iParam0)//Position - 0x617
{
	int iVar0;
	int iVar1;
	...
	func_17(&(Global_114372.f_2366.f_539), iVar1);
...
void func_17(var uParam0, int iParam1)//Position - 0x727
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_19(Global_114372.f_18536[iVar0], &Var2, &fVar5))
			{
...
int func_19(int iParam0, var uParam1, float fParam2)//Position - 0x8FB
{
	switch (iParam0)
	{
		case 11:
...
void func_23()//Position - 0x13A8
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_27(Global_114372.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_25(iVar0) && (!func_24(14) || Global_113320))
			{
...
bool func_25(int iParam0)//Position - 0x14B3
{
	return iParam0 < 3;
}

int func_26(int iParam0)//Position - 0x14BF
{
	int iVar0;
	int iVar1;
...
int func_27(int iParam0)//Position - 0x14FC
{
	if (func_25(iParam0))
	{
...
var func_28(int iParam0)//Position - 0x1521
{
...
int func_30(bool bParam0)//Position - 0x1562
{
...
void func_34(int* iParam0)//Position - 0x15F2
{
...
void func_35()//Position - 0x1612
{
	...
	func_92(&Local_454, &uVar0, &iLocal_80, &iLocal_355, &iLocal_354, Local_362, 0, 0, 1090519040);
	switch (iLocal_79)
	{
		case 0:
		...
		case 1:
			func_71(&iLocal_354, Local_362, &iLocal_89, iLocal_80, &iLocal_353, &iLocal_382);
			if (iLocal_89 == 2)
			{
			...
			if (func_59(Local_454.f_0, Local_362, &iLocal_354, iLocal_80, iLocal_89, &iLocal_661, &iLocal_383, &iLocal_377, &iLocal_378, &iLocal_353, 1090519040))
			{
		...
		case 3:
			if (func_7(Local_454.f_0))
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_454.f_0, false))
				{
					PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_454.f_0, -1);
				}
				else
				{
					func_50(Local_454.f_0, Local_362, 126.0705f, 0, 1);
					func_36(1, 1, 1);
					iLocal_79 = 1;
				}
			}
...
void func_39(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x1851
{
	if (bParam0)
	{
...
bool func_40()//Position - 0x199E
{
	return BitTest(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

bool func_41(int iParam0, int iParam1)//Position - 0x19B8
{
	bool bVar0;
...
int func_42(int iParam0, bool bParam1)//Position - 0x1A11
{
	int iVar0;
	int iVar1;
...
int func_43()//Position - 0x1A52
{
	return Global_1574925;
}

int func_44(var uParam0)//Position - 0x1A5E
{
	int iVar0;
...
int func_45(int iParam0)//Position - 0x1A80
{
...
bool func_46()//Position - 0x1ABF
{
	return BitTest(Global_2621446, 3);
}

int func_47(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x1ACD
{
	int iVar0;
...
void func_49(int iParam0)//Position - 0x1B27
{
	if (iParam0 == 1)
	{
...
int func_50(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x1B4A
{
	bool bVar0;
	float fVar1;
...
void func_52(bool bParam0, int iParam1)//Position - 0x1BC0
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (bParam0)
	{
		if ((func_30(0) && Global_79495.f_1 == 1) && func_53(Global_79495))
		{
		}
		else
		{
...
int func_53(int iParam0)//Position - 0x1C90
{
	switch (iParam0)
	{
		case 71:
...
void func_54()//Position - 0x1CCE
{
	Global_21032 = 0;
	func_55();
}

void func_55()//Position - 0x1CDE
{
...
void func_56()//Position - 0x1D35
{
	func_58(1, 649);
	func_57(0, -1);
}

void func_57(int iParam0, int iParam1)//Position - 0x1D4B
{
	int iVar0;
...
void func_58(bool bParam0, int iParam1)//Position - 0x1DB6
{
	int iVar0;
...
int func_59(int iParam0, struct<3> Param1, int* iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)//Position - 0x1E50
{
	float fVar0;
	...
	if ((iParam5 == 1 || iParam5 == 2) || iParam5 == 3)
	{
		if (iParam6 == 0)
		{
			if (func_7(iParam0))
			{
				...
				{
					func_68(func_69(func_70()), iParam11);
				}
			}
			...
			else
			{
				...
				{
					fVar0 = (fParam12 / 2f);
					if (func_64(PLAYER::PLAYER_PED_ID(), Param1, fVar0, 1))
					{
						*iParam7 = 0;
	...
	else
	{
		...
		if (!*iParam8)
		{
			...
			{
				HUD::CLEAR_THIS_PRINT(func_62(func_70(), 0));
			}
...
void func_60(char* sParam0, int iParam1, int iParam2)//Position - 0x1FFB
{
	iParam2 = iParam2;
...
char* func_61(int iParam0)//Position - 0x2014
{
	char* sVar0;
...
char* func_62(int iParam0, bool bParam1)//Position - 0x2069
{
	char* sVar0;
...
int func_63(float fParam0, int iParam1)//Position - 0x20CC
{
	int iVar0;
...
bool func_64(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2150
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

void func_65(int* iParam0, struct<3> Param1, bool bParam4)//Position - 0x216E
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
		*iParam0 = func_66(Param1, 5, bParam4);
	}
}

int func_66(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x218F
{
	int iVar0;
...
bool func_67(char* sParam0, int iParam1, char* sParam2)//Position - 0x21BD
{
...
void func_68(char* sParam0, int iParam1)//Position - 0x21DB
{
	if (!*iParam1)
	{
...
char* func_69(int iParam0)//Position - 0x21F8
{
	char* sVar0;
...
int func_70()//Position - 0x224D
{
	return Global_79511;
}

void func_71(int* iParam0, struct<3> Param1, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x2259
{
	switch (*iParam4)
	{
		case 0:
		...
		case 1:
			...
			{
				HUD::CLEAR_PRINTS();
				func_60("LOSE_WANTED" /* GXT: Lose the Cops. */, 7500, 0);
				*iParam4 = 2;
			}
			break;
		...
		case 2:
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
			{
				...
				if ((iParam5 == 1 || iParam5 == 2) || iParam5 == 3)
				{
					func_68(func_62(func_70(), 0), iParam6);
...
int func_72(int iParam0, bool bParam1)//Position - 0x2339
{
	int* iVar0;
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_83(1, Local_359, 0))
			{
				if (((func_83(2, Local_454.f_1, Local_454.f_4) && func_83(4, Local_359, 0)) && func_83(3, Local_359, 0)) && func_83(5, Local_359, 0))
				{
					iLocal_369 = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(400.86282f, -1609.7386f, 28.29278f, 7.5f, 2f, 9.5f, func_82(229.3746f), false, 7);
					if (HUD::GET_BLIP_FROM_ENTITY(Local_454.f_0) != 0)
					{
						iVar0 = HUD::GET_BLIP_FROM_ENTITY(Local_454.f_0);
						MISC::SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(true);
						func_34(&iVar0);
						MISC::SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(false);
					}
					func_80(&iLocal_354, Local_454.f_0, 1);
					func_78();
					func_76();
					return 1;
				}
		...
		case 1:
			if (bParam1)
			{
				if (((func_83(2, Local_454.f_1, Local_454.f_4) && func_83(4, Local_359, 0)) && func_83(3, Local_359, 0)) && func_83(5, Local_359, 0))
				{
					...
					MISC::CLEAR_AREA_OF_PEDS(Local_387[0 /*22*/].f_1, 5f, 0);
					func_78();
					func_76();
					bLocal_26 = false;
					func_36(1, 1, 1);
		...
		case 2:
			if (bParam1)
			{
				if ((func_83(2, Local_454.f_1, Local_454.f_4) && func_83(4, Local_359, 0)) && func_83(3, Local_359, 0))
				{
					func_73();
					MISC::CLEAR_AREA_OF_PEDS(369.0115f, -1609.1163f, 28.2928f, 5f, 0);
					MISC::CLEAR_AREA_OF_PEDS(Local_387[0 /*22*/].f_1, 5f, 0);
		...
		case 3:
			if (bParam1)
			{
				if (func_83(2, Local_362, Local_454.f_4))
				{
					func_73();
					PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_454.f_0, -1);
					func_76();
...
void func_73()//Position - 0x25A2
{
	...
	while (iVar0 <= 2)
	{
		Local_387[iVar0 /*22*/].f_18 = 0;
		Local_387[iVar0 /*22*/].f_19 = 0;
		Local_387[iVar0 /*22*/].f_20 = 0;
		iLocal_646[iVar0] = 0;
		iVar0++;
	}
	iLocal_654 = 0;
...
void func_74()//Position - 0x2656
{
	...
	while (iVar1 <= 2)
	{
		...
		while (iVar0 <= (15 - 1))
		{
			MISC::CLEAR_BIT(&(Local_387[iVar1 /*22*/].f_15), iVar0);
			iVar0++;
		}
		Local_387[iVar1 /*22*/].f_17 = 0;
		Local_387[iVar1 /*22*/].f_16 = 0;
		iVar1++;
	}
	iLocal_375 = 0;
	iLocal_376 = 0;
...
void func_75(int iParam0, struct<3> Param1, float fParam4)//Position - 0x26C4
{
	if (func_383(iParam0))
	{
		TASK::CLEAR_PED_TASKS(iParam0);
	}
	func_50(iParam0, Param1, fParam4, 0, 1);
}

void func_76()//Position - 0x26EA
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	func_77(&uLocal_481, iVar0, PLAYER::PLAYER_PED_ID(), sVar1, 0, 1);
	func_77(&uLocal_481, 6, Local_387[0 /*22*/], "BSPRACopBreak1", 0, 1);
	func_77(&uLocal_481, 7, Local_387[1 /*22*/], "BSPRACopBreak2", 0, 1);
	func_77(&uLocal_481, 5, Local_387[2 /*22*/], "BSPRACopBreak3", 0, 1);
}

void func_77(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2778
{
...
void func_78()//Position - 0x2813
{
	...
	while (iVar0 <= 2)
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_387[iVar0 /*22*/], false);
		if (!func_79(Local_387[iVar0 /*22*/], joaat("SCRIPT_TASK_START_SCENARIO_AT_POSITION")))
		{
			switch (iVar0)
			{
				case 0:
				case 1:
					TASK::TASK_START_SCENARIO_AT_POSITION(Local_387[iVar0 /*22*/], "WORLD_HUMAN_HANG_OUT_STREET", Local_387[iVar0 /*22*/].f_1, Local_387[iVar0 /*22*/].f_4, 0, false, true);
					break;
				
				case 2:
					TASK::TASK_USE_MOBILE_PHONE(Local_387[iVar0 /*22*/], true, 1);
					break;
				}
		}
		WEAPON::GIVE_WEAPON_TO_PED(Local_387[iVar0 /*22*/], joaat("WEAPON_PISTOL"), -1, false, false);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_387[iVar0 /*22*/], iLocal_479);
		Local_387[iVar0 /*22*/].f_18 = 1;
		Local_387[iVar0 /*22*/].f_21 = 0;
		iVar0++;
	}
}

int func_79(int iParam0, int iParam1)//Position - 0x28D4
{
	if (func_383(iParam0))
	{
...
void func_80(int* iParam0, int iParam1, bool bParam2)//Position - 0x2907
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
		*iParam0 = func_81(iParam1, bParam2, 5);
	}
}

int func_81(int iParam0, bool bParam1, int iParam2)//Position - 0x2926
{
	int iVar0;
...
float func_82(float fParam0)//Position - 0x295B
{
	return (fParam0 * 0.017453292f);
}

int func_83(int iParam0, struct<3> Param1, float fParam4)//Position - 0x296B
{
	int iVar0;
	int iVar1;
	char cVar2[16];
	...
	{
		case 0:
			if (func_91(Param1, Local_359, 1056964608, 0) && fParam4 == 0f)
			{
				return 1;
			}
			break;
		...
		case 1:
			...
			HUD::REQUEST_ADDITIONAL_TEXT(cLocal_480, 6);
		...
		case 2:
			if (func_7(Global_97869[0]))
			{
				...
				Local_454.f_0 = Global_97869[0];
				if (func_7(Local_454.f_0))
				{
					if (!VEHICLE::DOES_VEHICLE_HAVE_STUCK_VEHICLE_CHECK(Local_454.f_0))
					{
						VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_454.f_0);
					}
					VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(Local_454.f_0, 2, false);
					VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(Local_454.f_0, 3, false);
					func_90(Local_454.f_0, 0);
					VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_454.f_0, true);
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_454.f_0, 1);
					return 1;
				}
			}
			else if (func_89(&Local_454, Local_454.f_5, Local_454.f_1, Local_454.f_4, 1))
			{
				if (!VEHICLE::DOES_VEHICLE_HAVE_STUCK_VEHICLE_CHECK(Local_454.f_0))
				{
					VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_454.f_0);
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_97869.f_9[iVar0]))
				{
					if (!PED::IS_PED_DEAD_OR_DYING(Global_97869.f_9[iVar0], true))
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97869.f_9[iVar0], true, true);
						Local_387[iVar0 /*22*/] = Global_97869.f_9[iVar0];
						if (func_383(Local_387[iVar0 /*22*/]))
						{
							PED::SET_PED_TARGET_LOSS_RESPONSE(Local_387[iVar0 /*22*/], 2);
							AUDIO::STOP_PED_SPEAKING(Local_387[iVar0 /*22*/], true);
							func_88(iVar0);
							iVar1++;
						}
					}
				...
				else if (func_87(&(Local_387[iVar0 /*22*/]), Local_387[iVar0 /*22*/].f_5, Local_387[iVar0 /*22*/].f_1, Local_387[iVar0 /*22*/].f_4, 0, 0, 0, 1))
				{
					func_88(iVar0);
					AUDIO::STOP_PED_SPEAKING(Local_387[iVar0 /*22*/], true);
					PED::SET_PED_TARGET_LOSS_RESPONSE(Local_387[iVar0 /*22*/], 2);
					...
					PED::SET_PED_NAME_DEBUG(Local_387[iVar0 /*22*/], &cVar2);
					iVar1++;
				}
				iVar0++;
			}
		...
		case 4:
			...
			while (iVar6 <= 3)
			{
				if (func_7(Global_97869[iVar6]))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97869[iVar6], true, true);
					Local_460[iVar7 /*6*/] = Global_97869[iVar6];
					if (func_7(Local_460[iVar7 /*6*/]))
					{
						iVar8++;
					}
				}
				else if (func_89(&(Local_460[iVar7 /*6*/]), Local_460[iVar7 /*6*/].f_5, Local_460[iVar7 /*6*/].f_1, Local_460[iVar7 /*6*/].f_4, 1))
				{
					iVar8++;
				}
				iVar7++;
		...
		case 5:
			if (func_84(&iLocal_356, joaat("prop_box_guncase_03a"), 354.6938f, -1634.7828f, 22.7849f, 299.1508f, 1))
			{
				if (func_7(Local_454.f_0))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_356, Local_454.f_0, 0, 0f, -1.85f, 0.05f, ENTITY::GET_ENTITY_ROTATION(Local_454.f_0, 2), false, false, false, false, 2, true, 0);
					if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_454.f_0, iLocal_356))
					{
						return 1;
					}
				}
...
int func_84(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2CD9
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_85(int iParam0, bool bParam1)//Position - 0x2D3C
{
	if (bParam1)
	{
...
int func_86(int iParam0, char* sParam1, int iParam2)//Position - 0x2D61
{
...
int func_87(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x2D90
{
...
void func_88(int iParam0)//Position - 0x2E10
{
	if (func_383(Local_387[iParam0 /*22*/]))
	{
		if (iParam0 == 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(Local_387[iParam0 /*22*/], 0, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_387[iParam0 /*22*/], 3, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_387[iParam0 /*22*/], 4, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_387[iParam0 /*22*/], 8, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_387[iParam0 /*22*/], 9, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_387[iParam0 /*22*/], 10, 0, 0, 0);
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(Local_387[iParam0 /*22*/], 0, 1, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_387[iParam0 /*22*/], 3, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_387[iParam0 /*22*/], 4, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_387[iParam0 /*22*/], 8, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_387[iParam0 /*22*/], 9, 2, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_387[iParam0 /*22*/], 10, 0, 1, 0);
		}
	}
}

int func_89(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2EE9
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_86(iParam1, "Loading", 0))
...
void func_90(int iParam0, int iParam1)//Position - 0x2F9C
{
	Global_101392.f_22[iParam1] = iParam0;
}

int func_91(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x2FB0
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_92(int* iParam0, var uParam1, int iParam2, int* iParam3, int* iParam4, struct<3> Param5, int iParam8, bool bParam9, float fParam10)//Position - 0x302B
{
	if (func_7(*iParam0))
	{
		switch (*iParam2)
		{
			...
			case 2:
			case 1:
				if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam0, false) && !func_98(*iParam0)) && !func_97(*iParam0))
				{
					func_34(iParam4);
...
void func_93(int* iParam0, var uParam1)//Position - 0x31DF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_94(int* iParam0)//Position - 0x32CC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_95(int* iParam0)//Position - 0x3304
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (iVar0 != *iParam0)
		{
			if (func_7(iVar0))
			{
				if (ENTITY::GET_ENTITY_MODEL(iVar0) == func_96(func_70()))
				{
					func_94(iParam0);
					*iParam0 = iVar0;
					func_90(*iParam0, 1);
...
int func_96(int iParam0)//Position - 0x3361
{
	int iVar0;
...
int func_97(int iParam0)//Position - 0x33BA
{
	int iVar0;
	int iVar1;
	
	if ((func_383(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) && func_7(iParam0))
	{
...
int func_98(int iParam0)//Position - 0x343D
{
	int iVar0;
	int iVar1;
...
void func_99()//Position - 0x34A9
{
	...
	switch (iLocal_79)
	{
				...
				if (AUDIO::PREPARE_MUSIC_EVENT("FHPRA_VAN"))
				{
					if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
					{
						if (iLocal_80 == 1 || iLocal_80 == 2)
						{
							...
							if (!func_104())
							{
								func_68("PR_TAKBACK" /* GXT: Titanium Infinity Exhaust */, &iLocal_353);
							}
							RECORDING::REPLAY_RECORD_BACK_FOR_TIME(5f, 6f, 4);
							AUDIO::TRIGGER_MUSIC_EVENT("FHPRA_VAN");
							func_65(&iLocal_354, Local_362, 1);
						}
					}
					iLocal_662 = 0;
					iLocal_79 = 1;
		...
		case 1:
			...
			if (func_102(Local_454.f_0, Local_362, &iLocal_354, iLocal_89, iLocal_80, &iLocal_353, &iLocal_383, 0, 0, 1086324736))
			{
				RECORDING::REPLAY_RECORD_BACK_FOR_TIME(5f, 6f, 4);
				iLocal_79 = 2;
			}
...
void func_100(bool bParam0)//Position - 0x3644
{
	func_101(iLocal_78);
...
void func_101(int iParam0)//Position - 0x367C
{
	switch (iParam0)
	{
		case 0:
...
int func_102(int iParam0, struct<3> Param1, int* iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, float fParam11)//Position - 0x3694
{
	if ((iParam6 == 1 || iParam6 == 2) || iParam6 == 3)
	{
		if (iParam5 == 0)
		{
			...
			if (!func_103())
			{
				func_68(func_62(func_70(), bParam9), iParam7);
			}
		}
	}
	else if (iParam5 == 0)
...
bool func_103()//Position - 0x3787
{
	return Global_101444.f_393 > 0;
}

int func_104()//Position - 0x3798
{
...
void func_105()//Position - 0x37BA
{
	Global_21032 = 0;
	func_106();
}

void func_106()//Position - 0x37CA
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
	...
	while (iVar0 < 3)
	{
		...
		if (!PED::IS_PED_INJURED(iVar1))
		{
			switch (iLocal_85[iVar0])
			{
				...
				case 1:
					if (func_110(iVar0, iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, true))
					{
						iLocal_85[iVar0] = 0;
						func_109(iVar1);
					}
				...
				case 2:
					if (func_108(iVar0, iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, true))
					{
						iLocal_85[iVar0] = 0;
						func_109(iVar1);
					}
...
int func_108(int iParam0, int iParam1)//Position - 0x38D6
{
	switch (iLocal_81[iParam0])
	{
		case 0:
			TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, PED::GET_VEHICLE_PED_IS_IN(iParam1, false), Local_362, 4, 20f, 786469, 3.5f, 5f, true);
			iLocal_81[iParam0] = 3;
			break;
		
		case 3:
			if (!func_112(iParam0, iParam1) || func_64(PLAYER::PLAYER_PED_ID(), Local_362, 2f, 1))
			{
				iLocal_81[iParam0] = 4;
			}
			break;
...
int func_109(int iParam0)//Position - 0x3962
{
	bool bVar0;
...
int func_110(int iParam0, int iParam1)//Position - 0x39B7
{
	float fVar0;
	...
	{
		case 0:
			if (!MISC::IS_POSITION_OCCUPIED(Local_298[iLocal_663 /*4*/], 1.5f, false, false, true, false, false, iParam1, false))
			{
				if (func_64(iParam1, Local_298[iLocal_663 /*4*/], 5f, 1))
				{
					fVar0 = 1f;
				}
				else
				...
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam1, Local_298[iLocal_663 /*4*/], fVar0, 20000, 0.25f, 0, Local_298[iLocal_663 /*4*/].f_3);
				iLocal_81[iParam0] = 1;
			}
			break;
...
int func_111(int iParam0, int iParam1)//Position - 0x3A96
{
	bool bVar0;
...
int func_112(int iParam0, int iParam1)//Position - 0x3B17
{
	if (!func_113())
	{
		if ((ENTITY::DOES_ENTITY_EXIST(Local_454.f_0) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_454.f_0, false)) && !ENTITY::IS_ENTITY_AT_COORD(Local_454.f_0, Local_362, 2f, 2f, 2f, false, true, 0))
		{
			if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_454.f_0, false)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
			{
				if (PED::IS_PED_IN_VEHICLE(iParam1, Local_454.f_0, false) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_454.f_0, -1, false) == iParam1)
				{
					iLocal_85[iParam0] = 2;
					return 1;
				}
...
int func_114(int iParam0, int iParam1)//Position - 0x3BC8
{
	if (!func_113())
	{
...
int func_115(int iParam0, int iParam1)//Position - 0x3CBE
{
	bool bVar0;
...
int func_116(int iParam0)//Position - 0x3D17
{
	bool bVar0;
...
int func_117(int iParam0)//Position - 0x3D5D
{
	...
	return Global_98850[func_118(iParam0)];
}

int func_118(int iParam0)//Position - 0x3D8E
{
	if (iParam0 == 0)
	{
		return 0;
...
void func_119()//Position - 0x3DC9
{
	...
	if (!bLocal_26)
	{
		...
		if (iLocal_78 == 2)
		{
			if (!iLocal_384)
			{
				if (!func_64(PLAYER::PLAYER_PED_ID(), Local_454.f_1, 180f, 1))
				{
					iVar0 = 0;
					while (iVar0 <= 2)
					{
						func_209(&(Local_387[iVar0 /*22*/]), 1, 0, 1);
						iVar0++;
					}
					iLocal_384 = 1;
				}
...
void func_120()//Position - 0x3E54
{
	int iVar0;
	
	iVar0 = 2;
	if (Local_387[iVar0 /*22*/].f_18 != 3 && Local_387[iVar0 /*22*/].f_20 != 7)
	{
		func_197(Local_387[iVar0 /*22*/], &(Local_387[iVar0 /*22*/].f_6), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
	}
	else
	{
		func_196(&(Local_387[iVar0 /*22*/].f_6));
	}
	if (func_383(Local_387[iVar0 /*22*/]))
	{
		func_153(iVar0);
		switch (Local_387[iVar0 /*22*/].f_18)
		{
			case 0:
				break;
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_387[iVar0 /*22*/]) && !PED::IS_PED_INJURED(Local_387[iVar0 /*22*/]))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_387[iVar0 /*22*/], PLAYER::PLAYER_PED_ID(), true))
			{
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_387[iVar0 /*22*/]);
				if (((WEAPON::IS_PED_CURRENT_WEAPON_SILENCED(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_BEING_STEALTH_KILLED(Local_387[iVar0 /*22*/])) || PED::WAS_PED_KILLED_BY_STEALTH(Local_387[iVar0 /*22*/])) || PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_387[iVar0 /*22*/]))
				{
					if (!bLocal_372)
					{
		...
		func_34(&(Local_387[iVar0 /*22*/].f_6));
		func_209(&(Local_387[iVar0 /*22*/]), 1, 0, 1);
	}
}

void func_121(int iParam0)//Position - 0x3FD5
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (Local_387[iParam0 /*22*/].f_20)
	{
		case 1:
			if (func_150(iParam0) && func_64(Local_387[iParam0 /*22*/], Local_387[iParam0 /*22*/].f_1, 3f, 1))
			{
				if (MISC::GET_GAME_TIMER() - Local_387[iParam0 /*22*/].f_14) > MISC::GET_RANDOM_INT_IN_RANGE(1000, 1500)
				{
					if (!func_79(Local_387[iParam0 /*22*/], joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")))
					{
						PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(Local_387[iParam0 /*22*/]);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_387[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 0);
					}
					Local_387[iParam0 /*22*/].f_14 = MISC::GET_GAME_TIMER();
				}
			}
			else
			{
		...
		case 2:
			if (MISC::GET_GAME_TIMER() - Local_387[iParam0 /*22*/].f_14) > MISC::GET_RANDOM_INT_IN_RANGE(5000, 6000)
			{
				if (BitTest(Local_387[iParam0 /*22*/].f_15, 2))
				{
					func_128(iParam0);
					func_126();
					return;
				...
				{
					Local_387[iParam0 /*22*/].f_17 = 1;
				}
			}
			break;
		
		case 3:
			if (MISC::GET_GAME_TIMER() - Local_387[iParam0 /*22*/].f_14) > MISC::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				if (BitTest(Local_387[iParam0 /*22*/].f_15, 8))
				{
					Local_387[iParam0 /*22*/].f_17 = 1;
				}
				else
		...
		case 4:
			if (MISC::GET_GAME_TIMER() - Local_387[iParam0 /*22*/].f_14) > MISC::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				if (BitTest(Local_387[iParam0 /*22*/].f_15, 8))
				{
					...
					else if (BitTest(Local_387[iParam0 /*22*/].f_15, 9) && !bLocal_370)
					{
						func_128(iParam0);
						func_126();
						return;
		...
		case 6:
			...
			if ((MISC::GET_GAME_TIMER() - Local_387[iParam0 /*22*/].f_14) > iVar0)
			{
				if (!PED::IS_PED_BEING_STUNNED(Local_387[iParam0 /*22*/], 0) && !TASK::IS_PED_IN_WRITHE(Local_387[iParam0 /*22*/]))
				{
					Local_387[iParam0 /*22*/].f_14 = MISC::GET_GAME_TIMER();
					func_128(iParam0);
				}
		...
		case 5:
			if (MISC::GET_GAME_TIMER() - Local_387[iParam0 /*22*/].f_14) > MISC::GET_RANDOM_INT_IN_RANGE(1000, 3000)
			{
				func_126();
				return;
			}
		...
		case 7:
			if ((MISC::GET_GAME_TIMER() - Local_387[iParam0 /*22*/].f_14) > 350)
			{
				if (!bLocal_372 && func_125(iParam0, 15))
				{
					func_74();
					func_135(iParam0);
					HUD::REMOVE_COP_BLIP_FROM_PED(Local_387[iParam0 /*22*/]);
					return;
				}
				else
				{
					if (iLocal_658 != -1)
					{
						...
						else if (PLAYER::GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(PLAYER::PLAYER_ID(), &iVar1))
						{
							if (ENTITY::IS_ENTITY_A_PED(iVar1))
							{
								...
								if ((iVar2 == Local_387[0 /*22*/] || iVar2 == Local_387[1 /*22*/]) || iVar2 == Local_387[2 /*22*/])
								{
									func_124(2);
								}
							}
					...
					if (Local_387[iParam0 /*22*/].f_16)
					{
						PLAYER::UPDATE_WANTED_POSITION_THIS_FRAME(PLAYER::PLAYER_ID());
					}
					if ((func_79(Local_387[iParam0 /*22*/], joaat("SCRIPT_TASK_INVALID")) || func_79(Local_387[iParam0 /*22*/], joaat("SCRIPT_TASK_STAND_STILL"))) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 2)
					{
						if (!func_79(Local_387[iParam0 /*22*/], joaat("SCRIPT_TASK_ARREST_PED")))
						{
							TASK::TASK_ARREST_PED(Local_387[iParam0 /*22*/], PLAYER::PLAYER_PED_ID());
						}
					}
				}
			}
			if (!iLocal_656)
			{
				if (BitTest(Local_387[iParam0 /*22*/].f_15, 1) && BitTest(Local_387[iParam0 /*22*/].f_15, 14))
				{
					if (iParam0 == 0)
					{
						sVar3 = "PRA_COPSHT1";
					...
					func_54();
					func_122(&uLocal_481, cLocal_480, sVar3, 7, 0, 0);
					iLocal_656 = 1;
				}
			}
			break;
...
void func_122(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x4401
{
...
void func_124(int iParam0)//Position - 0x4492
{
	...
	iLocal_658 = -1;
	if (func_383(Local_387[0 /*22*/]))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_387[0 /*22*/], false);
	}
	if (func_383(Local_387[1 /*22*/]))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_387[1 /*22*/], false);
	}
	if (func_383(Local_387[2 /*22*/]))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_387[2 /*22*/], false);
	}
	if (iParam0 != -1)
	{
...
int func_125(int iParam0, int iParam1)//Position - 0x450A
{
	bool bVar0;
	...
	while (bVar0 <= 14)
	{
		if (bVar0 != iParam1)
		{
			if (BitTest(Local_387[iParam0 /*22*/].f_15, bVar0))
			{
				return 0;
			}
		}
...
void func_126()//Position - 0x454A
{
	...
	while (iVar0 <= 2)
	{
		if (Local_387[iVar0 /*22*/].f_20 != 6 && Local_387[iVar0 /*22*/].f_20 != 7)
		{
			func_196(&(Local_387[iVar0 /*22*/].f_6));
			Local_387[iVar0 /*22*/].f_14 = MISC::GET_GAME_TIMER();
			Local_387[iVar0 /*22*/].f_18 = 3;
			Local_387[iVar0 /*22*/].f_20 = 6;
		}
		iVar0++;
	}
}

void func_127()//Position - 0x45B4
{
	if (!iLocal_373)
	{
...
void func_128(int iParam0)//Position - 0x45EC
{
	if (Local_387[iParam0 /*22*/].f_20 != 7)
	{
		if (func_383(Local_387[iParam0 /*22*/]))
		{
			if (func_79(Local_387[iParam0 /*22*/], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) || PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(Local_387[iParam0 /*22*/]))
			{
				TASK::CLEAR_PED_TASKS(Local_387[iParam0 /*22*/]);
			}
			else if (func_79(Local_387[iParam0 /*22*/], joaat("SCRIPT_TASK_START_SCENARIO_AT_POSITION")) || func_79(Local_387[iParam0 /*22*/], joaat("SCRIPT_TASK_START_SCENARIO_IN_PLACE")))
			{
				PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(Local_387[iParam0 /*22*/]);
			}
			PED::SET_PED_AS_COP(Local_387[iParam0 /*22*/], true);
			TASK::TASK_ARREST_PED(Local_387[iParam0 /*22*/], PLAYER::PLAYER_PED_ID());
			WEAPON::GIVE_WEAPON_TO_PED(Local_387[iParam0 /*22*/], joaat("WEAPON_PISTOL"), -1, false, true);
			ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_387[iParam0 /*22*/]);
			PLAYER::UPDATE_WANTED_POSITION_THIS_FRAME(PLAYER::PLAYER_ID());
			func_129(iParam0);
			Local_387[iParam0 /*22*/].f_18 = 3;
			Local_387[iParam0 /*22*/].f_20 = 7;
		}
	}
}

void func_129(int iParam0)//Position - 0x46D0
{
	char* sVar0;
	
	if ((iLocal_78 != 2 && !iLocal_657) && !ENTITY::IS_ENTITY_DEAD(Local_387[iParam0 /*22*/], false))
	{
		if (func_134(iParam0) && func_132(Local_387[iParam0 /*22*/], 30f))
		{
			if (iParam0 == 0)
			{
			...
			if (BitTest(Local_387[iParam0 /*22*/].f_15, 3))
			{
				iLocal_657 = 1;
			}
			else if (!func_125(iParam0, 15) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 362.63586f, -1581.2556f, 31.547737f, 358.10736f, -1586.615f, 34.297737f, 2f, false, true, 0))
			{
				...
				if (iParam0 == 2)
				{
					func_122(&uLocal_481, cLocal_480, sVar0, 7, 0, 0);
				}
				else
				{
					AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_387[iParam0 /*22*/], "ARREST_PLAYER", sVar0, "SPEECH_PARAMS_FORCE", false);
				}
				iLocal_657 = 1;
			}
		}
...
void func_130()//Position - 0x47CD
{
	Global_21032 = 0;
	func_131();
}

void func_131()//Position - 0x47DD
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_132(int iParam0, float fParam1)//Position - 0x47FE
{
	if (iParam0 == 0)
	{
		return 1;
	}
	if (func_383(PLAYER::PLAYER_PED_ID()) && func_383(iParam0))
	{
		if (func_133(PLAYER::PLAYER_PED_ID(), iParam0, 0) <= fParam1)
		{
			return 1;
		}
	}
...
float func_133(int iParam0, int iParam1, bool bParam2)//Position - 0x483C
{
	struct<3> Var0;
	struct<3> Var3;
...
bool func_134(int iParam0)//Position - 0x489A
{
	return Local_387[iParam0 /*22*/].f_18 > 1;
}

void func_135(int iParam0)//Position - 0x48AD
{
	int iVar0;
	
	if (Local_387[iParam0 /*22*/].f_18 != 1 && !func_79(Local_387[iParam0 /*22*/], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
	{
		TASK::CLEAR_PED_TASKS(Local_387[iParam0 /*22*/]);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_387[iParam0 /*22*/], iLocal_479);
		if (iParam0 == 2)
		{
			TASK::OPEN_SEQUENCE_TASK(&iVar0);
			if (!func_64(Local_387[iParam0 /*22*/], Local_387[iParam0 /*22*/].f_1, 3f, 1))
			{
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_387[iParam0 /*22*/].f_1, 1f, 120000, 0.25f, 0, Local_387[iParam0 /*22*/].f_4);
			}
			else
			{
				TASK::TASK_ACHIEVE_HEADING(0, Local_387[iParam0 /*22*/].f_4, 0);
			}
			if (iLocal_646[2] && MISC::IS_STRING_NULL_OR_EMPTY("sResumeRoot"))
			{
			...
			TASK::TASK_PERFORM_SEQUENCE(Local_387[iParam0 /*22*/], iVar0);
		...
		func_136();
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_387[iParam0 /*22*/], false);
		Local_387[iParam0 /*22*/].f_18 = 1;
		Local_387[iParam0 /*22*/].f_21 = 0;
		Local_387[iParam0 /*22*/].f_19 = 0;
		Local_387[iParam0 /*22*/].f_20 = 0;
	}
}

void func_136()//Position - 0x4AE4
{
	if (func_12(&uLocal_90, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
	{
		if (!func_104())
		{
			if ((!MISC::ARE_STRINGS_EQUAL(&cLocal_664, "NONE" /* GXT: None */) && !MISC::ARE_STRINGS_EQUAL(&cLocal_670, "NONE" /* GXT: None */)) && !func_67("PR_TAKBACK" /* GXT: Titanium Infinity Exhaust */, 0, 0))
			{
				if (func_137(&uLocal_481, cLocal_480, &cLocal_664, &cLocal_670, 7, 0, 0))
				{
					StringCopy(&cLocal_664, "NONE" /* GXT: None */, 24);
					StringCopy(&cLocal_670, "NONE" /* GXT: None */, 24);
					iLocal_654 = 1;
...
bool func_137(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x4B5D
{
...
int func_138(char* sParam0, int iParam1, bool bParam2)//Position - 0x4BB1
{
	Global_22167 = 0;
...
bool func_141(int iParam0)//Position - 0x4F19
{
	return func_142(iParam0, 20);
}

var func_142(int iParam0, int iParam1)//Position - 0x4F29
{
	return BitTest(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_143()//Position - 0x4F41
{
	return -1;
}

void func_144()//Position - 0x4F4A
{
	int iVar0;
...
bool func_149(int iParam0, int iParam1)//Position - 0x51A2
{
	switch (iParam0)
	{
		case 5:
...
int func_150(int iParam0)//Position - 0x51DA
{
	if (Local_387[func_151(iParam0) /*22*/].f_18 > 1 && Local_387[func_151(iParam0) /*22*/].f_20 != 1)
	{
		return 1;
	}
	return 0;
...
int func_151(int iParam0)//Position - 0x520D
{
	int iVar0;
...
void func_152(int iParam0)//Position - 0x5229
{
	switch (Local_387[iParam0 /*22*/].f_21)
	{
		case 0:
			if (func_104())
			{
				if (PED::IS_PED_BEING_STEALTH_KILLED(Local_387[iParam0 /*22*/]))
				{
					func_130();
				}
			}
			...
			{
				if (iLocal_646[2] && !AUDIO::IS_PED_IN_CURRENT_CONVERSATION(Local_387[iParam0 /*22*/]))
				{
					TASK::CLEAR_PED_TASKS(Local_387[iParam0 /*22*/]);
					TASK::TASK_START_SCENARIO_IN_PLACE(Local_387[iParam0 /*22*/], "WORLD_HUMAN_STAND_MOBILE", 0, true);
				}
			}
			break;
...
void func_153(int iParam0)//Position - 0x52A9
{
	func_175(iParam0);
	if (!func_174(iParam0))
	{
	...
	else if (func_154(Local_387[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 5f, 1))
	{
		if (!bLocal_372)
		{
			PLAYER::SUPPRESS_CRIME_THIS_FRAME(PLAYER::PLAYER_ID(), 41);
...
bool func_154(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x539C
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), ENTITY::GET_ENTITY_COORDS(iParam1, bParam3)) <= (fParam2 * fParam2);
}

int func_155(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x53BE
{
	struct<3> Var0;
	...
	if (func_6(PLAYER::PLAYER_PED_ID()) && func_6(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_168(PLAYER::PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_156(int iParam0, float fParam1)//Position - 0x5479
{
	float fVar0;
	
	if (func_6(PLAYER::PLAYER_PED_ID()) && func_6(iParam0))
	{
		if (func_167(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				fVar0 = 40f;
...
bool func_157(int iParam0, float fParam1)//Position - 0x54EF
{
	return func_158(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_158(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x5507
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	
	iVar4 = func_166(iParam0, iParam1);
	if (!func_6(iParam0) || !func_6(iParam1))
	{
		if (iVar4 != -1)
		{
			func_165(&(Local_36[iVar4 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_159(&(Local_36[iVar4 /*4*/]), Var1, iParam1, &(Local_36[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar4 /*4*/].f_3) < iParam4);
}

int func_159(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x55C8
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_160(int iParam0, int iParam1)//Position - 0x56F4
{
	int iVar0;
...
int func_162(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x5803
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_164(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_164(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_163(Var3, Var0);
...
float func_163(struct<3> Param0, struct<3> Param3)//Position - 0x5894
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_164(struct<3> Param0)//Position - 0x58B5
{
	float fVar0;
	float fVar1;
...
void func_165(var uParam0)//Position - 0x58F4
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_166(int iParam0, int iParam1)//Position - 0x590F
{
	int iVar0;
...
int func_167(int iParam0)//Position - 0x594E
{
...
bool func_168(int iParam0, int iParam1, float fParam2)//Position - 0x5976
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_169(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x59BD
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_170(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x5AB8
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_171(int iParam0, float fParam1)//Position - 0x5BC4
{
	var uVar0;
	struct<3> Var1;
...
int func_172(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x5C59
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_164(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
int func_173(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x5CE7
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_174(int iParam0)//Position - 0x5D2F
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_387[iParam0 /*22*/], 0f, -2f, 0f), 2f, 3f, 2f, false, true, 0) && !WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
	{
		return 1;
	}
	return 0;
...
void func_175(int iParam0)//Position - 0x5D6E
{
	func_195(iParam0);
	func_191(iParam0);
	func_188(iParam0);
	func_185(iParam0);
	if (Local_387[iParam0 /*22*/].f_20 != 7 || Local_387[iParam0 /*22*/].f_20 != 6)
	{
		if (((!bLocal_370 && !PED::IS_PED_BEING_STEALTH_KILLED(Local_387[iParam0 /*22*/])) && !PED::WAS_PED_KILLED_BY_STEALTH(Local_387[iParam0 /*22*/])) && !PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_387[iParam0 /*22*/]))
		{
			func_176(iParam0);
		}
	}
...
void func_176(int iParam0)//Position - 0x5DED
{
	bool bVar0;
	
	if ((((!func_150(iParam0) && Local_387[iParam0 /*22*/].f_20 != 7) && Local_387[iParam0 /*22*/].f_20 != 6) && !bLocal_372) && Local_387[iParam0 /*22*/].f_17)
	{
		bVar0 = false;
		while (bVar0 <= 11)
		{
...
void func_177(int iParam0, bool bParam1)//Position - 0x5E6D
{
	switch (bParam1)
	{
		case 0:
...
void func_178(int iParam0, int iParam1, int iParam2)//Position - 0x5F64
{
	char* sVar0;
	char* sVar1;
	...
	if (!func_150(iParam0) || iParam2)
	{
		if (iParam1 == 2)
		{
			if (Local_387[func_151(iParam0) /*22*/].f_20 != 2)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPGUNW1";
		...
		{
			if (Local_387[func_151(iParam0) /*22*/].f_20 != 3 || (MISC::GET_GAME_TIMER() - iLocal_374) > 7500)
			{
				if (!BitTest(Local_387[iParam0 /*22*/].f_15, 9))
				{
					if (iParam0 == 0)
					{
						sVar0 = "PRA_CWCAR1";
		...
		{
			if (Local_387[func_151(iParam0) /*22*/].f_20 != 4 || (MISC::GET_GAME_TIMER() - iLocal_374) > 7500)
			{
				if (!bLocal_371)
				{
					if (iParam0 == 0)
		...
		{
			if (Local_387[func_151(iParam0) /*22*/].f_20 != 5)
			{
				if (iParam0 == 0)
				{
					sVar1 = "S_M_Y_COP_01_WHITE_MINI_03";
					AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_387[iParam0 /*22*/], "CHALLENGE_THREATEN", sVar1, "SPEECH_PARAMS_FORCE", false);
				}
				else if (iParam0 == 1)
				{
		...
		Local_387[iParam0 /*22*/].f_14 = MISC::GET_GAME_TIMER();
		Local_387[func_151(iParam0) /*22*/].f_14 = MISC::GET_GAME_TIMER();
		Local_387[func_151(iParam0) /*22*/].f_18 = 3;
		Local_387[func_151(iParam0) /*22*/].f_20 = 1;
		Local_387[iParam0 /*22*/].f_18 = 3;
		Local_387[iParam0 /*22*/].f_20 = iParam1;
	}
}

void func_179(int iParam0, char* sParam1, bool bParam2, bool bParam3)//Position - 0x61F4
{
	struct<6> Var0;
	
	if (bParam3)
	{
		if (BitTest(Local_387[iParam0 /*22*/].f_15, 12))
		{
			return;
		}
	}
	...
	{
		func_122(&uLocal_481, cLocal_480, sParam1, 7, 0, 0);
		if (bParam2)
		{
	...
	if ((!MISC::ARE_STRINGS_EQUAL(&Var0, sParam1) && !func_67("PR_TAKBACK" /* GXT: Titanium Infinity Exhaust */, 0, 0)) && !func_67("PR_GOVEH", 0, 0))
	{
		func_180();
		func_122(&uLocal_481, cLocal_480, sParam1, 7, 0, 0);
		if (bParam2)
...
struct<6> func_181()//Position - 0x62F3
{
	struct<6> Var0;
	int iVar6;
...
struct<6> func_182()//Position - 0x6339
{
	struct<6> Var0;
...
void func_183(int iParam0, int iParam1, int iParam2)//Position - 0x635D
{
	char* sVar0;
	char* sVar1;
	...
	if (!func_150(iParam0) || iParam2)
	{
		if (iParam1 == 1)
		{
			if (Local_387[iParam0 /*22*/].f_19 != 1 || (MISC::GET_GAME_TIMER() - iLocal_374) > 7500)
			{
				if (!bLocal_370)
				{
					if (iParam0 == 0)
		...
		{
			if (Local_387[iParam0 /*22*/].f_19 != 2 || (MISC::GET_GAME_TIMER() - iLocal_374) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPPLY1";
		...
		{
			if (Local_387[iParam0 /*22*/].f_19 != 4 || (MISC::GET_GAME_TIMER() - iLocal_374) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPST1";
		...
		{
			if (Local_387[iParam0 /*22*/].f_19 != 6)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPGUNR1";
		...
		{
			if (Local_387[iParam0 /*22*/].f_19 != 5)
			{
				if (iParam0 == 0)
				{
					sVar1 = "S_M_Y_COP_01_WHITE_MINI_03";
				...
				AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_387[iParam0 /*22*/], "BUMP", sVar1, "SPEECH_PARAMS_FORCE", false);
				func_184(iParam0, iParam1, 0);
			}
		}
		else if (iParam1 == 7)
		{
			if (Local_387[iParam0 /*22*/].f_19 != 7)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_CHP1";
		...
		if (bLocal_370)
		{
			if (!BitTest(Local_387[iParam0 /*22*/].f_15, 12))
			{
				MISC::SET_BIT(&(Local_387[iParam0 /*22*/].f_15), 12);
			}
		}
	}
}

void func_184(int iParam0, int iParam1, bool bParam2)//Position - 0x65B9
{
	if (bParam2)
	{
		if (BitTest(Local_387[iParam0 /*22*/].f_15, 12))
	...
	Local_387[func_151(iParam0) /*22*/].f_18 = 3;
	Local_387[func_151(iParam0) /*22*/].f_20 = 1;
	Local_387[iParam0 /*22*/].f_19 = iParam1;
	Local_387[iParam0 /*22*/].f_18 = 2;
}

void func_185(int iParam0)//Position - 0x6656
{
	float fVar0;
	
	if ((!func_150(iParam0) && Local_387[iParam0 /*22*/].f_20 != 6) && Local_387[iParam0 /*22*/].f_20 != 7)
	{
		...
		if (iParam0 == 0 || iParam0 == 1)
		{
			if (!iLocal_380)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 340.0758f, -1598.2554f, 28.29322f, 346.4939f, -1603.6843f, 38.29278f, 6.22f, false, true, 0))
				{
					...
					else if (!BitTest(Local_387[iParam0 /*22*/].f_15, 11))
					{
						if ((((fVar0 > 16f && !Local_387[iParam0 /*22*/].f_16) && !BitTest(Local_387[iParam0 /*22*/].f_15, 10)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 344.44824f, -1603.4729f, 28.29278f, 345.62222f, -1604.4784f, 32.29278f, 3.46f, false, true, 0)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_387[iParam0 /*22*/], Local_307[1 /*7*/], Local_307[1 /*7*/].f_3, Local_307[1 /*7*/].f_6, false, true, 0))
						{
							func_187(iParam0, 11);
							return;
						}
				...
				if (((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_307[1 /*7*/], Local_307[1 /*7*/].f_3, Local_307[1 /*7*/].f_6, false, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_387[iParam0 /*22*/], Local_307[1 /*7*/], Local_307[1 /*7*/].f_3, Local_307[1 /*7*/].f_6, false, true, 0)) && !BitTest(Local_387[iParam0 /*22*/].f_15, 10)) && !BitTest(Local_387[iParam0 /*22*/].f_15, 11))
				{
					if ((fVar0 > 12f && !Local_387[iParam0 /*22*/].f_16) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 344.44824f, -1603.4729f, 28.29278f, 345.62222f, -1604.4784f, 32.29278f, 3.46f, false, true, 0))
					{
						func_187(iParam0, 11);
					}
				}
		...
		else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_307[5 /*7*/], Local_307[5 /*7*/].f_3, Local_307[5 /*7*/].f_6, false, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_387[iParam0 /*22*/], Local_307[5 /*7*/], Local_307[5 /*7*/].f_3, Local_307[5 /*7*/].f_6, false, true, 0))
		{
			if (fVar0 > 10f && !Local_387[iParam0 /*22*/].f_16)
			{
				func_187(iParam0, 11);
			}
			else
...
void func_186(int iParam0, bool bParam1)//Position - 0x6916
{
	if (BitTest(Local_387[iParam0 /*22*/].f_15, bParam1))
	{
		MISC::CLEAR_BIT(&(Local_387[iParam0 /*22*/].f_15), bParam1);
		Local_387[iParam0 /*22*/].f_17 = 1;
	}
}

void func_187(int iParam0, bool bParam1)//Position - 0x6946
{
	if (!BitTest(Local_387[iParam0 /*22*/].f_15, bParam1))
	{
		MISC::SET_BIT(&(Local_387[iParam0 /*22*/].f_15), bParam1);
		Local_387[iParam0 /*22*/].f_17 = 1;
	}
}

void func_188(int iParam0)//Position - 0x6977
{
	bool bVar0;
	
	if ((Local_387[iParam0 /*22*/].f_19 != 5 && Local_387[iParam0 /*22*/].f_20 != 6) && Local_387[iParam0 /*22*/].f_20 != 7)
	{
		bVar0 = false;
		if (((func_154(Local_387[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 5f, 1) && !PED::IS_PED_BEING_STEALTH_KILLED(Local_387[iParam0 /*22*/])) && !PED::WAS_PED_KILLED_BY_STEALTH(Local_387[iParam0 /*22*/])) && !PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_387[iParam0 /*22*/]))
		{
	...
	else if (!func_154(Local_387[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 5.5f, 1))
	{
		func_186(iParam0, 5);
		func_186(iParam0, 3);
	}
...
int func_189(int iParam0)//Position - 0x6A75
{
	if (iParam0 == 2)
	{
		return 0;
	...
	if (Local_387[iParam0 /*22*/].f_20 != 7)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_387[iParam0 /*22*/], 1f, -1f, 0f), 1f, 1f, 2f, false, true, 0))
		{
			return 1;
		}
	}
...
int func_190(int iParam0, int iParam1)//Position - 0x6AB8
{
	if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(Local_387[iParam0 /*22*/], PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_RAGDOLL(Local_387[iParam0 /*22*/]))
		{
			*iParam1 = 1;
		}
		else
...
void func_191(int iParam0)//Position - 0x6AF0
{
	int iVar0;
	
	if (Local_387[iParam0 /*22*/].f_20 != 6 && Local_387[iParam0 /*22*/].f_20 != 7)
	{
		iVar0 = 0;
		while (iVar0 <= 5)
		{
			if (Local_387[iParam0 /*22*/].f_16)
			{
				if (!BitTest(Local_387[iParam0 /*22*/].f_15, 12))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_307[iVar0 /*7*/], Local_307[iVar0 /*7*/].f_3, Local_307[iVar0 /*7*/].f_6, false, true, 0))
					{
						iLocal_380 = 1;
						iLocal_379 = MISC::GET_GAME_TIMER();
						if (iVar0 == 4)
			...
			else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_307[iVar0 /*7*/], Local_307[iVar0 /*7*/].f_3, Local_307[iVar0 /*7*/].f_6, false, true, 0) || BitTest(Local_387[iParam0 /*22*/].f_15, 12))
			{
				func_192(iParam0, iVar0);
			}
			iVar0++;
	...
	else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_307[3 /*7*/], Local_307[3 /*7*/].f_3, Local_307[3 /*7*/].f_6, false, true, 0))
	{
		func_194(iParam0, 3);
	}
	else
...
void func_192(int iParam0, int iParam1)//Position - 0x6C38
{
	int iVar0;
	...
	switch (iParam1)
	{
		...
		case 4:
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (func_7(iVar0))
				{
					if (func_193(ENTITY::GET_ENTITY_MODEL(iVar0)))
					{
						bLocal_371 = true;
					}
					else
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar0, Local_307[4 /*7*/], Local_307[4 /*7*/].f_3, Local_307[4 /*7*/].f_6, false, true, 0))
					{
						func_186(iParam0, 8);
						func_186(iParam0, 7);
					}
					else if (!BitTest(Local_387[iParam0 /*22*/].f_15, 7))
					{
						func_187(iParam0, 7);
					}
				}
...
int func_193(int iParam0)//Position - 0x6D3E
{
	switch (iParam0)
	{
		case joaat("police"):
...
void func_194(int iParam0, int iParam1)//Position - 0x6DB0
{
	switch (iParam1)
	{
		case 1:
			if ((!BitTest(Local_387[iParam0 /*22*/].f_15, 6) && !BitTest(Local_387[iParam0 /*22*/].f_15, 1)) && !BitTest(Local_387[iParam0 /*22*/].f_15, 9))
			{
				if (!BitTest(Local_387[iParam0 /*22*/].f_15, 10))
				{
					func_187(iParam0, 10);
				}
			}
		...
		case 2:
			if (!BitTest(Local_387[iParam0 /*22*/].f_15, 1))
			{
				if (!BitTest(Local_387[iParam0 /*22*/].f_15, 6))
				{
					func_187(iParam0, 6);
				}
			}
		...
		case 3:
			if (!BitTest(Local_387[iParam0 /*22*/].f_15, 14))
			{
				func_187(iParam0, 14);
			}
			break;
		...
		case 4:
			if (!BitTest(Local_387[iParam0 /*22*/].f_15, 8))
			{
				...
				{
					MISC::SET_BIT(&(Local_387[iParam0 /*22*/].f_15), 9);
					func_187(iParam0, 8);
				}
				else
				{
					MISC::CLEAR_BIT(&(Local_387[iParam0 /*22*/].f_15), 9);
					func_187(iParam0, 8);
				}
			}
			break;
		...
		case 5:
			if (!BitTest(Local_387[iParam0 /*22*/].f_15, 4))
			{
				if ((!PED::IS_PED_BEING_STEALTH_KILLED(Local_387[iParam0 /*22*/]) && !PED::WAS_PED_KILLED_BY_STEALTH(Local_387[iParam0 /*22*/])) && !PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_387[iParam0 /*22*/]))
				{
					func_187(iParam0, 4);
...
void func_195(int iParam0)//Position - 0x6F25
{
	if (func_154(PLAYER::PLAYER_PED_ID(), Local_387[iParam0 /*22*/], 30f, 1))
	{
		if (func_158(Local_387[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 140f, 1, 250, 7))
		{
			Local_387[iParam0 /*22*/].f_16 = 1;
		}
		else
		{
			Local_387[iParam0 /*22*/].f_16 = 0;
		}
	}
}

void func_196(int* iParam0)//Position - 0x6F77
{
	bool bVar0;
	struct<8> Var1;
...
int func_197(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)//Position - 0x6FE9
{
	bool bVar0;
...
void func_198()//Position - 0x71DD
{
	...
	while (iVar0 <= 1)
	{
		...
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_387[iVar0 /*22*/]))
			{
				if (func_7(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_387[iVar0 /*22*/], PLAYER::GET_PLAYERS_LAST_VEHICLE(), true))
					{
						ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_387[iVar0 /*22*/]);
						func_126();
					}
...
void func_199(int iParam0)//Position - 0x7334
{
	char* sVar0;
	float fVar1;
	
	switch (Local_387[iParam0 /*22*/].f_19)
	{
		case 1:
			if (MISC::GET_GAME_TIMER() - Local_387[iParam0 /*22*/].f_14) > MISC::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				...
				{
					if ((BitTest(Local_387[iParam0 /*22*/].f_15, 13) && (MISC::GET_GAME_TIMER() - iLocal_374) > 2500) && !iLocal_659)
					{
						if (iParam0 == 0)
						{
							sVar0 = "PRA_COPST1";
						...
						func_122(&uLocal_481, cLocal_480, sVar0, 7, 0, 0);
						MISC::CLEAR_BIT(&(Local_387[iParam0 /*22*/].f_15), 13);
						MISC::CLEAR_BIT(&(Local_387[func_151(iParam0) /*22*/].f_15), 13);
						iLocal_659 = 1;
					}
					Local_387[iParam0 /*22*/].f_17 = 1;
				}
		...
		case 2:
			if (MISC::GET_GAME_TIMER() - Local_387[iParam0 /*22*/].f_14) > MISC::GET_RANDOM_INT_IN_RANGE(1500, 2000)
			{
				if (func_125(iParam0, 12))
				{
					func_135(iParam0);
		...
		case 5:
			if (MISC::GET_GAME_TIMER() - Local_387[iParam0 /*22*/].f_14) > MISC::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				if (!func_154(Local_387[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 1.5f, 1))
				{
					MISC::CLEAR_BIT(&(Local_387[iParam0 /*22*/].f_15), 5);
				}
				if (func_125(iParam0, 12))
				{
					func_135(iParam0);
		...
		case 7:
			if (MISC::GET_GAME_TIMER() - Local_387[iParam0 /*22*/].f_14) > MISC::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				...
				if (((fVar1 < 12f && !Local_387[iParam0 /*22*/].f_16) && !BitTest(Local_387[iParam0 /*22*/].f_15, 10)) && !func_79(Local_387[iParam0 /*22*/], joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")))
				{
					MISC::CLEAR_BIT(&(Local_387[iParam0 /*22*/].f_15), 11);
				}
				if (func_125(iParam0, 12))
				{
					func_135(iParam0);
...
void func_200(int iParam0)//Position - 0x7624
{
	func_201(iParam0);
	func_185(iParam0);
	func_176(iParam0);
...
void func_201(int iParam0)//Position - 0x763E
{
	func_195(iParam0);
	func_204(iParam0);
	func_191(iParam0);
	if (!BitTest(Local_387[iParam0 /*22*/].f_15, 1))
	{
		if ((Local_387[iParam0 /*22*/].f_20 != 6 && Local_387[iParam0 /*22*/].f_20 != 7) && !bLocal_372)
		{
			if (!bLocal_370 && func_64(Local_387[iParam0 /*22*/], Local_387[iParam0 /*22*/].f_1, 6f, 1))
			{
				func_203(iParam0);
			}
			func_188(iParam0);
...
void func_202(int iParam0)//Position - 0x76C4
{
	bool bVar0;
	...
	if (!iLocal_659)
	{
		...
		if (!BitTest(Local_387[iParam0 /*22*/].f_15, 13))
		{
			if (BitTest(Local_387[iParam0 /*22*/].f_15, 10))
			{
				if (Local_387[iParam0 /*22*/].f_16)
		...
		else if (func_134(iParam0))
		{
			if (bVar0)
			{
				if (!func_154(PLAYER::PLAYER_PED_ID(), Local_387[iParam0 /*22*/], 10f, 1))
				{
					if (!BitTest(Local_387[iParam0 /*22*/].f_15, 10) && !BitTest(Local_387[iParam0 /*22*/].f_15, 6))
					{
						MISC::CLEAR_BIT(&(Local_387[iParam0 /*22*/].f_15), 13);
					}
				}
...
void func_203(int iParam0)//Position - 0x7785
{
	bool bVar0;
	...
	if (Local_387[iParam0 /*22*/].f_20 != 6 && Local_387[iParam0 /*22*/].f_20 != 7)
	{
		if (func_154(PLAYER::PLAYER_PED_ID(), Local_387[iParam0 /*22*/], 12f, 1))
		{
			if (bVar0)
			{
				if (Local_387[iParam0 /*22*/].f_16)
...
void func_204(int iParam0)//Position - 0x7840
{
	if (!func_174(iParam0))
	{
		if (bLocal_372)
...
int func_205(int iParam0)//Position - 0x78B0
{
	float fVar0;
	...
	if (func_383(Local_387[iParam0 /*22*/]))
	{
		...
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_387[iParam0 /*22*/], fVar0, fVar0, fVar0, false, true, 0))
		{
			if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_387[iParam0 /*22*/]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_387[iParam0 /*22*/]))
			{
				if (Local_387[iParam0 /*22*/].f_16)
				{
					return 1;
...
void func_206()//Position - 0x7932
{
	if ((Local_387[0 /*22*/].f_18 == 1 && Local_387[1 /*22*/].f_18 == 1) && Local_387[2 /*22*/].f_18 == 1)
	{
		if ((((func_383(Local_387[0 /*22*/]) && func_383(Local_387[1 /*22*/])) && func_12(&uLocal_90, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true))) && func_64(Local_387[0 /*22*/], Local_387[0 /*22*/].f_1, 3f, 1)) && func_64(Local_387[1 /*22*/], Local_387[1 /*22*/].f_1, 3f, 1))
		{
			if ((func_125(0, 15) && func_125(1, 15)) && !iLocal_646[iLocal_655])
			{
				if (func_207(0, &(iLocal_646[iLocal_655]), sLocal_650[iLocal_655], 10f, 4))
				{
					iLocal_655++;
					if (iLocal_655 == 2)
					{
		...
		else if ((func_383(Local_387[2 /*22*/]) && func_12(&uLocal_142, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true))) && func_64(Local_387[2 /*22*/], Local_387[2 /*22*/].f_1, 3f, 1))
		{
			if (!BitTest(Local_387[2 /*22*/].f_15, 2) && !BitTest(Local_387[2 /*22*/].f_15, 4))
			{
				if (func_207(0, &(iLocal_646[2]), "PRA_COPTLK3", 10f, 4))
				{
					iLocal_654 = 1;
				}
			}
		}
		else if (iLocal_654 && func_104())
		{
			func_54();
			iLocal_654 = 0;
		}
...
bool func_207(int iParam0, var uParam1, char* sParam2, float fParam3, int iParam4)//Position - 0x7AB7
{
	if (!*uParam1)
	{
		if (!func_104() && CAM::IS_SCREEN_FADED_IN())
		{
			if (func_132(iParam0, fParam3) && !func_67("PR_TAKBACK" /* GXT: Titanium Infinity Exhaust */, 0, 0))
			{
				*uParam1 = func_208(&uLocal_481, cLocal_480, sParam2, iParam4, 0, 0, 0);
			}
		}
	}
...
int func_208(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x7B1B
{
...
void func_209(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x7B69
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_210()//Position - 0x7BB9
{
	...
	switch (iLocal_79)
	{
		...
		case 1:
			...
			if ((PED::IS_PED_CLIMBING(PLAYER::PLAYER_PED_ID()) && iLocal_676 == 0) && func_133(Local_454.f_0, PLAYER::PLAYER_PED_ID(), 1) < 100f)
			{
...
void func_211()//Position - 0x7D93
{
	switch (iLocal_79)
	{
		case 0:
			if (func_72(iLocal_78, 0))
			{
				func_367(78);
				...
				else
				{
					...
					{
						func_75(PLAYER::PLAYER_PED_ID(), 408.3364f, -1567.4294f, 28.2723f, 128.2512f);
						func_212(408.3364f, -1567.4294f, 28.2723f, 50f, 12, 5000, 0, 0);
						func_37(500, 1);
					}
					iLocal_79 = 2;
				}
...
void func_212(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x7E93
{
	int iVar0;
	int iVar1;
...
void func_213()//Position - 0x7F03
{
	Global_23572.f_6 = 1;
}

void func_214(int iParam0)//Position - 0x7F11
{
	if (func_219())
	{
		return;
...
void func_215(int iParam0)//Position - 0x7F44
{
	if (func_219())
	{
		return;
...
void func_216(bool bParam0, bool bParam1)//Position - 0x7FCE
{
	if (bParam0)
	{
		if (func_218(0))
...
bool func_217()//Position - 0x8043
{
	return BitTest(Global_1956030, 5);
}

int func_218(int iParam0)//Position - 0x8051
{
	if (iParam0 == 1)
	{
		if (Global_20813.f_1 > 3)
...
bool func_219()//Position - 0x80A8
{
	return BitTest(Global_1956030, 19);
}

void func_220(int iParam0, int iParam1, int iParam2)//Position - 0x80B7
{
	if (func_385() && func_222())
	{
...
void func_221(int iParam0)//Position - 0x817B
{
	if (iParam0 == 1)
	{
...
var func_222()//Position - 0x81A4
{
	return BitTest(Global_101392.f_20, 13);
}

void func_223(int iParam0)//Position - 0x81B5
{
	Global_97227 = 0;
	switch (iParam0)
	{
...
void func_224(int iParam0)//Position - 0x8243
{
	MISC::SET_BIT(&Global_97227, iParam0);
}

void func_225()//Position - 0x8255
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			func_226(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, true), ENTITY::GET_ENTITY_HEADING(iVar0), 24, 0);
		}
	}
}

void func_226(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x8292
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_264(iParam5, &Var0, Param1, fParam4, func_270(iParam0));
		func_227(iParam5, iParam0, 0);
	}
}

void func_227(int iParam0, int iParam1, int iParam2)//Position - 0x83BB
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_114372.f_32753.f_4801 = func_250();
			}
...
void func_228(int iParam0, int iParam1)//Position - 0x84D2
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_271(iParam0, &(Global_114372.f_32753.f_5510));
}

int func_229(int iParam0)//Position - 0x86D4
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_247(iParam0, 0, 0)) || func_247(iParam0, 1, 0)) || func_247(iParam0, 2, 0)) || func_270(iParam0) != 145) || func_246(iParam0)) || func_245(iParam0)) || func_244(iParam0)) || func_243(iParam0)) || !func_230(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_245(iParam0))
		{
		}
...
int func_230(int iParam0)//Position - 0x87B1
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_231(int iParam0, bool bParam1, int iParam2)//Position - 0x896F
{
	int iVar0;
	struct<2> Var1;
	...
	{
		if ((func_237() || MISC::IS_PC_VERSION()) || func_236())
		{
		}
		else if (!func_239())
		{
...
int func_232(int iParam0)//Position - 0x8AF1
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_234(int iParam0, int iParam1)//Position - 0x8BD4
{
	int iVar0;
	int iVar1;
...
int func_235(bool bParam0)//Position - 0xE10F
{
	if (bParam0)
	{
...
bool func_236()//Position - 0xE129
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_237()//Position - 0xE13F
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_238()//Position - 0xE155
{
	return 0;
}

int func_239()//Position - 0xE15E
{
	return 1;
}

int func_240()//Position - 0xE167
{
	return 1;
}

int func_241()//Position - 0xE170
{
...
int func_243(int iParam0)//Position - 0xE241
{
	int iVar0;
	char* sVar1;
...
int func_244(int iParam0)//Position - 0xE288
{
	int iVar0;
...
int func_245(int iParam0)//Position - 0xE2C3
{
	int iVar0;
...
int func_246(int iParam0)//Position - 0xE33F
{
	int iVar0;
...
int func_247(int iParam0, int iParam1, bool bParam2)//Position - 0xE427
{
	int iVar0;
	char* sVar1;
	int iVar9;
	...
	iVar0 = 0;
	while (func_248(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_248(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0xE495
{
...
int func_249(int iParam0)//Position - 0xE56D
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_251(var uParam0, int iParam1)//Position - 0xE5CF
{
	if (iParam1 <= 0)
	{
		return;
...
void func_252(var uParam0, int iParam1)//Position - 0xE655
{
...
void func_253(var uParam0, int iParam1)//Position - 0xE688
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_257(*uParam0);
	iVar1 = func_255(*uParam0);
	if (iParam1 < 1 || iParam1 > func_254(iVar0, iVar1))
	{
		return;
	}
...
int func_254(int iParam0, int iParam1)//Position - 0xE6D9
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_255(int iParam0)//Position - 0xE77B
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_256(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_256(bool bParam0, int iParam1, int iParam2)//Position - 0xE79D
{
	if (bParam0)
	{
		return iParam1;
...
int func_257(var uParam0)//Position - 0xE7B4
{
	return uParam0 & 15;
}

void func_258(var uParam0, int iParam1)//Position - 0xE7C1
{
...
void func_259(var uParam0, int iParam1)//Position - 0xE7FB
{
...
void func_260(var uParam0, int iParam1)//Position - 0xE836
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_261(var uParam0, int iParam1)//Position - 0xE872
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_11(Global_114372.f_32753.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_11(Global_114372.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_11(Global_114372.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_262(int iParam0, int iParam1)//Position - 0xFF60
{
	struct<82> Var0;
...
void func_263(int iParam0, var uParam1, int iParam2)//Position - 0xFFA2
{
	int iVar0;
...
void func_264(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x101FF
{
	if (func_261(&(Global_78038.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_269(iParam0);
			func_268(uParam1, &(Global_114372.f_32753.f_69[Global_78038.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_265(int iParam0, bool bParam1)//Position - 0x102F8
{
	if (iParam0 == -1)
	{
		return;
...
void func_266(int iParam0, int iParam1, bool bParam2)//Position - 0x10355
{
	if (iParam0 == -1)
	{
		return;
...
int func_267(int iParam0, int iParam1)//Position - 0x10390
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_268(var uParam0, var uParam1)//Position - 0x103B0
{
...
void func_269(int iParam0)//Position - 0x1047C
{
	if (iParam0 == -1)
	{
		return;
...
int func_270(int iParam0)//Position - 0x104F3
{
	int iVar0;
...
void func_271(int iParam0, var uParam1)//Position - 0x10556
{
	int iVar0;
...
int func_272(int iParam0)//Position - 0x10801
{
	switch (iParam0)
	{
		case 1:
...
int func_273(int iParam0, var uParam1, var uParam2)//Position - 0x108B1
{
	int iVar0;
	int iVar1;
...
int func_274(int iParam0)//Position - 0x10AA4
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_275(var uParam0)//Position - 0x10AC4
{
	int iVar0;
...
void func_276(int iParam0)//Position - 0x10B74
{
...
int func_277(int iParam0, int iParam1, int iParam2)//Position - 0x10B9B
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_79031[1 /*14*/] = { func_298(iVar0, iParam1, iParam2, -1) };
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_277(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar22 = { func_289(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
							if (!func_277(iParam0, 14, uVar22[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
									Global_79031[2 /*14*/] = { func_298(iVar0, 14, iVar4, -1) };
									if (Global_79031[2 /*14*/].f_12 == iVar3)
									{
										if (func_277(iParam0, 14, iVar4))
										{
											if (!func_281(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_79031[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_79031[2 /*14*/] = { func_298(iVar0, iVar2, iVar1, -1) };
						if (!func_281(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_79031[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	{
		uVar33 = { func_289(iVar0, iParam2) };
		iVar32 = 0;
		while (iVar32 <= 8)
		{
			if (!func_277(iParam0, 14, uVar33[iVar32]))
			{
				return 0;
			}
			iVar32++;
	...
	else if (Global_79031[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_278(iParam1)) && Global_79031[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_278(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_278(int iParam0)//Position - 0x10DF4
{
	switch (iParam0)
	{
		case 0:
...
int func_279(int iParam0, int iParam1)//Position - 0x10EA4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_280(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10F04
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_281(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x10F5B
{
	var uVar0;
	int iVar10;
	...
	if (iParam2 == 14)
	{
		uVar0 = { func_289(iParam0, (*uParam4)[13]) };
		iVar10 = 0;
		while (iVar10 <= 8)
		{
	...
	if (func_288(iParam0, iParam2, iParam3))
	{
		return 1;
	}
	if (iParam0 == joaat("Player_Zero"))
	{
		if (func_287(iParam0, iParam2, iParam3, -1))
		{
...
int func_282(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1155F
{
	switch (iParam0)
	{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_283(iParam0, iParam2, 14, 3), joaat("HAT_MENU"), 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_283(iParam0, iParam2, 1, 3), joaat("HAT_MENU"), 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_283(iParam0, iParam2, 14, 4), joaat("HAT_MENU"), 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_283(iParam0, iParam2, 1, 4), joaat("HAT_MENU"), 0));
					}
					break;
			}
			break;
...
int func_283(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x117DC
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else if (iParam2 == 14)
	{
		...
		iVar17 = (iParam1 - func_285(iParam0));
		if (iVar17 < 0)
		{
			return -1;
		}
	...
	else
	{
		...
		iVar36 = (iParam1 - func_284(iParam0, func_278(iParam2)));
		if (iVar36 < 0)
		{
			return -1;
		}
		...
		iVar37 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_278(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_284(int iParam0, int iParam1)//Position - 0x118F6
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_285(int iParam0)//Position - 0x11C9D
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_286(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11CFE
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_287(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x12123
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_288(int iParam0, int iParam1, int iParam2)//Position - 0x12416
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_289(int iParam0, int iParam1)//Position - 0x124AF
{
	int iVar0;
	struct<10> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				default:
					func_290(&Var1, iParam0, iParam1, 10);
					break;
			}
			break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				default:
					func_290(&Var1, iParam0, iParam1, 9);
					break;
			}
			break;
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				...
				default:
					func_290(&Var1, iParam0, iParam1, 25);
					break;
			}
			break;
...
void func_290(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x12DDE
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1.f_0))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_291(iParam1, Var16.f_0, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
...
int func_291(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x12F08
{
	struct<2> Var0;
	int iVar15;
	int iVar16;
	...
	if (iParam2 == 12)
	{
		...
		while (iVar15 < iVar16)
		{
			...
			if (Var0.f_1 == iParam1)
			{
				return (func_292(iParam0) + iVar15);
			}
			iVar15++;
		}
	}
	...
	else if (iParam2 == 14)
	{
		...
		if (iVar17 != -1)
		{
			return (func_285(iParam0) + iVar17);
		}
	}
	else
	{
		...
		if (iVar18 != -1)
		{
			return (func_284(iParam0, func_278(iParam2)) + iVar18);
		}
	}
	return -99;
}

int func_292(int iParam0)//Position - 0x12FC3
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_293(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x13022
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_294(int iParam0, int iParam1)//Position - 0x1306A
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_297(&Var1, -99, -99, Global_114372.f_2366.f_539.f_196[0], Global_114372.f_2366.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_297(&Var1, -99, -99, Global_114372.f_2366.f_539.f_196[1], Global_114372.f_2366.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_297(&Var1, -99, -99, Global_114372.f_2366.f_539.f_196[2], Global_114372.f_2366.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_295(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x14F18
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_296(Var16.f_2)] = func_291(iParam1, Var16.f_0, func_296(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
int func_296(int iParam0)//Position - 0x15102
{
	switch (iParam0)
	{
		case 0:
...
void func_297(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x151B2
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_298(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x15223
{
	func_366();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_299(int iParam0, int iParam1)//Position - 0x15275
{
	switch (iParam0)
	{
		case 0:
...
void func_300(int iParam0)//Position - 0x15365
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_312(iVar10, iParam0, 155, -1);
			return;
			break;
	}
	func_301(&(Global_79031[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_301(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x165DC
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_309(Global_2883588, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_309(Global_2883588, 2, 1, 1, -1))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_304(func_307(iParam1, uParam0->f_2), Global_79028);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_304(func_303(iParam1, uParam0->f_2), Global_79028);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			if (func_302(iParam1, uParam0->f_2, &iVar1))
			{
				uVar0 = func_304(iVar1, Global_79028);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_302(int iParam0, int iParam1, var uParam2)//Position - 0x1697E
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_303(int iParam0, int iParam1)//Position - 0x16D83
{
	switch (iParam1)
	{
		case 0:
...
int func_304(int iParam0, int iParam1)//Position - 0x1717E
{
	int iVar0;
	var uVar1;
...
int func_305(int iParam0, var uParam1)//Position - 0x171AD
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_306(uParam1));
}

int func_306(var uParam0)//Position - 0x171C2
{
	int iVar0;
	int iVar1;
...
int func_307(int iParam0, int iParam1)//Position - 0x171F6
{
	switch (iParam1)
	{
		case 0:
...
int func_308(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x175F1
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_309(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x18495
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	if (func_310(iParam0, iParam1, &iVar2, &uVar1, bParam2, bParam3))
	{
		uVar3 = func_304(iVar2, iVar0);
		return BitTest(uVar3, uVar1);
	}
	return 0;
}

bool func_310(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x184D3
{
	int iVar0;
...
int func_311(int iParam0)//Position - 0x1AFC1
{
	switch (iParam0)
	{
		case -1:
...
void func_312(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1B095
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_301(&(Global_79031[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_301(&(Global_79031[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_301(&(Global_79031[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79229)
		{
			...
			func_301(&(Global_79031[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_278(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_313(int iParam0)//Position - 0x1B31C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_314(int iParam0)//Position - 0x1B473
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_315(int iParam0)//Position - 0x1B981
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_316(int iParam0)//Position - 0x1B9F6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_317(int iParam0)//Position - 0x1BA6A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_318(int iParam0)//Position - 0x1BB51
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_319(int iParam0)//Position - 0x1BEB4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_320(int iParam0)//Position - 0x1C0C7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_321(int iParam0)//Position - 0x1C2F7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_322(int iParam0)//Position - 0x1C407
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_323(int iParam0)//Position - 0x1CDA6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_324(int iParam0)//Position - 0x1D919
{
	if (iParam0 < 136)
	{
		func_326(iParam0);
...
void func_325(int iParam0)//Position - 0x1D94E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_326(int iParam0)//Position - 0x1E552
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_327(int iParam0)//Position - 0x1F460
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_328(int iParam0)//Position - 0x1F58D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_329(int iParam0, int iParam1)//Position - 0x1F68B
{
	switch (iParam0)
	{
		case 0:
...
void func_330(int iParam0)//Position - 0x1F77B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_331(int iParam0)//Position - 0x20C6E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_332(int iParam0)//Position - 0x20DBF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_333(int iParam0)//Position - 0x212CA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_334(int iParam0)//Position - 0x21938
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_335(int iParam0)//Position - 0x219AC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_336(int iParam0)//Position - 0x21A7C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_337(int iParam0)//Position - 0x21FAC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_338(int iParam0)//Position - 0x22143
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_339(int iParam0)//Position - 0x22941
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_340(int iParam0)//Position - 0x22A51
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_341(int iParam0)//Position - 0x2397C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_342(int iParam0)//Position - 0x2463B
{
	if (iParam0 < 107)
	{
		func_345(iParam0);
...
void func_343(int iParam0)//Position - 0x24681
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_344(int iParam0)//Position - 0x25126
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_345(int iParam0)//Position - 0x25F15
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_346(int iParam0)//Position - 0x26B5E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_347(int iParam0)//Position - 0x26DD7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_348(int iParam0, int iParam1)//Position - 0x26F1D
{
	switch (iParam0)
	{
		case 0:
...
void func_349(int iParam0)//Position - 0x2700D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_350(int iParam0)//Position - 0x27D97
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_351(int iParam0)//Position - 0x27F11
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_352(int iParam0)//Position - 0x2854F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_353(int iParam0)//Position - 0x28A79
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_354(int iParam0)//Position - 0x28AED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_355(int iParam0)//Position - 0x28BBD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_356(int iParam0)//Position - 0x29095
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_357(int iParam0)//Position - 0x292FE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_358(int iParam0)//Position - 0x295D4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_359(int iParam0)//Position - 0x2979D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_360(int iParam0)//Position - 0x2A2F1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_361(int iParam0)//Position - 0x2AF3B
{
	if (iParam0 < 60)
	{
		func_363(iParam0);
...
void func_362(int iParam0)//Position - 0x2AF70
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_363(int iParam0)//Position - 0x2BD10
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_364(int iParam0)//Position - 0x2C39D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_365(int iParam0)//Position - 0x2C484
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_366()//Position - 0x2C582
{
...
void func_367(int iParam0)//Position - 0x2C5FB
{
	if (Global_98294 != -1)
	{
...
void func_368()//Position - 0x2C61F
{
	func_370();
	func_369();
}

void func_369()//Position - 0x2C62F
{
	if (PED::IS_COP_PED_IN_AREA_3D(385.8528f, -1629.9448f, 35.29278f, 398.8063f, -1640.8654f, 28f))
	{
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iLocal_367, 0, true, true);
	}
	else
	{
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iLocal_367, 1, true, true);
	}
}

void func_370()//Position - 0x2C673
{
	if (bLocal_372)
	{
...
void func_371(int iParam0, float fParam1)//Position - 0x2C7E6
{
...
void func_372(int iParam0, float fParam1)//Position - 0x2C871
{
	if (*fParam1 != 1f)
	{
		OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(iParam0, *fParam1, true, true);
...
void func_373()//Position - 0x2C8BA
{
	func_374();
	if (iLocal_660)
	{
...
void func_374()//Position - 0x2C8E3
{
	if (!iLocal_381)
	{
		if (iLocal_80 == 1 || iLocal_80 == 2)
		{
			func_57(Local_454.f_0, 650);
			func_375(649, 0);
			iLocal_381 = 1;
		}
	}
...
void func_375(int iParam0, bool bParam1)//Position - 0x2C919
{
	int iVar0;
...
void func_376()//Position - 0x2C963
{
...
void func_377()//Position - 0x2C988
{
	if (iLocal_78 != 2 && iLocal_78 != 3)
	{
		if (!func_64(PLAYER::PLAYER_PED_ID(), 372.0053f, -1604.0758f, 36.7536f, 100f, 1) && !bLocal_385)
		{
			func_379("PR_AREAWARN", &bLocal_385);
		}
		else if (!func_64(PLAYER::PLAYER_PED_ID(), 372.0053f, -1604.0758f, 36.7536f, 170f, 1) && bLocal_385)
		{
			func_378(3);
		}
	}
...
void func_378(int iParam0)//Position - 0x2CA06
{
	HUD::CLEAR_PRINTS();
	func_54();
	AUDIO::TRIGGER_MUSIC_EVENT("FHPRA_FAIL");
...
void func_379(char* sParam0, bool bParam1)//Position - 0x2CA74
{
	if (!*bParam1)
	{
		func_60(sParam0, 7500, 0);
...
void func_380()//Position - 0x2CA91
{
	if (!func_7(Local_454.f_0))
	{
		func_378(1);
	...
	else
	{
		...
		if (iLocal_78 == 2 || iLocal_78 == 3)
		{
			if (!func_154(PLAYER::PLAYER_PED_ID(), Local_454.f_0, 50f, 1) && !bLocal_386)
			{
				func_379("PR_VANWARN", &bLocal_386);
			}
			else if (!func_154(PLAYER::PLAYER_PED_ID(), Local_454.f_0, 100f, 1) && bLocal_386)
			{
				func_378(4);
			}
		}
...
void func_381()//Position - 0x2CB0F
{
	if (VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(Local_454.f_0))
	{
		if (iLocal_366)
		{
	...
	if (func_382(Local_454.f_0))
	{
		func_378(2);
	}
}

int func_382(int iParam0)//Position - 0x2CB61
{
	if (func_7(iParam0))
	{
...
int func_383(int iParam0)//Position - 0x2CBBC
{
	if (func_6(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_384(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2CBDC
{
	if (func_385())
	{
...
void func_386(int iParam0, int iParam1)//Position - 0x2CC95
{
...
void func_387()//Position - 0x2CCDA
{
	func_399();
	func_397();
	func_392();
...
void func_388()//Position - 0x2CCFA
{
	Local_307[1 /*7*/] = { func_389(359.52383f, -1581.4447f, 28.29278f, 341.13434f, -1603.0525f, 40.37049f, 7.3f) };
	Local_307[2 /*7*/] = { func_389(352.2312f, -1590.4707f, 28.29277f, 341.13434f, -1603.0525f, 40.37049f, 6.78f) };
	Local_307[0 /*7*/] = { func_389(344.58505f, -1601.5624f, 28.29278f, 342.42746f, -1604.0714f, 40.29278f, 3.79f) };
	Local_307[3 /*7*/] = { func_389(345.01022f, -1604.0956f, 40.6735f, 361.0914f, -1617.4596f, 28.29278f, 3.33f) };
	Local_307[4 /*7*/] = { func_389(362.79855f, -1577.0809f, 28.29278f, 341.13434f, -1603.0525f, 40.37049f, 6.78f) };
	Local_307[5 /*7*/] = { func_389(365.9773f, -1611.556f, 28.29277f, 373.12787f, -1617.8064f, 40.37049f, 19.19f) };
}

struct<7> func_389(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2CE1C
{
	struct<7> Var0;
...
void func_390()//Position - 0x2CE40
{
	int iVar0;
	...
	Local_298[0 /*4*/] = { 344.4447f, -1603.4282f, 28.2928f };
	Local_298[0 /*4*/].f_3 = 228.9052f;
	Local_298[1 /*4*/] = { 345.9821f, -1604.8014f, 28.2928f };
	Local_298[1 /*4*/].f_3 = 40.2137f;
}

void func_391()//Position - 0x2CEB0
{
	iLocal_367 = -1469527606;
	if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(iLocal_367))
	{
		OBJECT::ADD_DOOR_TO_SYSTEM(iLocal_367, joaat("prop_fnclink_03gate5"), 391.8602f, -1636.0702f, 29.9744f, true, true, false);
	}
	OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_42618[13 /*31*/], 1, true, false);
	OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iLocal_367, 1, true, false);
}

void func_392()//Position - 0x2CF01
{
	struct<3> Var0[8];
...
void func_393(var uParam0)//Position - 0x2D0D4
{
	int iVar0;
	float fVar1;
...
void func_394(var uParam0, struct<3> Param1)//Position - 0x2D174
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_395(var uParam0)//Position - 0x2D1A5
{
	if (uParam0->f_51)
	{
	}
...
void func_396(var uParam0, var uParam1, int iParam2)//Position - 0x2D1CC
{
	int iVar0;
	...
	{
		func_394(uParam0, *(uParam1[iVar0 /*3*/]));
		iVar0++;
	}
	func_393(uParam0);
}

void func_397()//Position - 0x2D203
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Local_387[0 /*22*/] = { func_398(353.1191f, -1589.6061f, 28.2928f, 270.0968f, iVar0) };
	Local_387[1 /*22*/] = { func_398(354.557f, -1590.5488f, 28.2928f, 16.3702f, iVar0) };
	Local_387[2 /*22*/] = { func_398(369.8186f, -1611.0293f, 28.3928f, 9.0837f, iVar0) };
	iVar1 = 0;
	while (iVar1 <= 2)
	{
		Local_387[iVar1 /*22*/].f_18 = 0;
		Local_387[iVar1 /*22*/].f_19 = 0;
		Local_387[iVar1 /*22*/].f_20 = 0;
		Local_387[iVar1 /*22*/].f_17 = 0;
		Local_387[iVar1 /*22*/].f_16 = 0;
		iVar2 = 0;
		while (iVar2 <= (15 - 1))
		{
			MISC::CLEAR_BIT(&(Local_387[iVar1 /*22*/].f_15), iVar2);
			iVar2++;
		}
		iVar1++;
	}
	iLocal_654 = 0;
	iLocal_655 = 0;
	sLocal_650[0] = "PRA_COPTLK1";
	sLocal_650[1] = "PRA_COPTLK2";
}

struct<22> func_398(struct<3> Param0, float fParam3, int iParam4)//Position - 0x2D2FF
{
	struct<22> Var0;
...
void func_399()//Position - 0x2D32B
{
	Local_454 = { func_400(372.9868f, -1623.5312f, 28.2928f, 321.7075f, joaat("policet")) };
	Local_460[0 /*6*/] = { func_400(400.5771f, -1618.9274f, 28.2928f, 48.8115f, joaat("police3")) };
	Local_460[1 /*6*/] = { func_400(396.6843f, -1623.222f, 28.2928f, 231.3392f, joaat("police3")) };
	Local_460[2 /*6*/] = { func_400(394.3527f, -1625.3374f, 28.2928f, 49.3732f, joaat("police3")) };
}

struct<6> func_400(struct<3> Param0, float fParam3, int iParam4)//Position - 0x2D3C4
{
	struct<6> Var0;
...
void func_401()//Position - 0x2D3E6
{
	PED::ADD_RELATIONSHIP_GROUP("COPS", &iLocal_479);
}

void func_402()//Position - 0x2D3FA
{
	PED::REMOVE_RELATIONSHIP_GROUP(iLocal_479);
	func_413(1);
	if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(Global_42618[13 /*31*/]))
	{
	...
	OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iLocal_367, 0, true, false);
	OBJECT::REMOVE_DOOR_FROM_SYSTEM(iLocal_367, 0);
...
void func_403(bool bParam0)//Position - 0x2D47D
{
	struct<3> Var0;
	...
	if (bParam0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_454.f_0))
		{
			if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	...
	if (CAM::DOES_CAM_EXIST(iLocal_357))
	{
		...
		CAM::DESTROY_CAM(iLocal_357, false);
	}
}

void func_404()//Position - 0x2D557
{
	int iVar0;
	
	VEHICLE::REMOVE_VEHICLE_UPSIDEDOWN_CHECK(Local_454.f_0);
	func_94(&Local_454);
	func_405(&iLocal_356, 0);
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		func_209(&(Local_387[iVar0 /*22*/]), 1, 0, 1);
	...
	while (iVar0 <= 2)
	{
		func_94(&(Local_460[iVar0 /*6*/]));
		iVar0++;
	}
}

void func_405(int* iParam0, bool bParam1)//Position - 0x2D5B2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_406()//Position - 0x2D5ED
{
}

void func_407()//Position - 0x2D5F5
{
}

void func_408()//Position - 0x2D5FD
{
}

void func_409()//Position - 0x2D605
{
	int iVar0;
	
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_454.f_5);
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_460[iVar0 /*6*/].f_5);
		iVar0++;
	}
}

void func_410()//Position - 0x2D635
{
	int iVar0;
	int iVar1;
...
void func_411(bool bParam0, int iParam1, int iParam2)//Position - 0x2D671
{
	bool bVar0;
...
void func_412()//Position - 0x2D6D0
{
	Global_97227 = 0;
}

void func_413(int iParam0)//Position - 0x2D6DD
{
	Global_98678 = iParam0;
}

void func_414()//Position - 0x2D6EB
{
	int iVar0;
...
void func_416()//Position - 0x2D79A
{
