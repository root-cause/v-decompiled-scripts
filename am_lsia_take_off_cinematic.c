...
bool func_98(var uParam0, int iParam1, int iParam2, struct<3> Param3, struct<3> Param4, struct<3> Param5, float fParam6, int iParam7, int iParam8)//Position - 0x2F6C
{
...
bool func_100(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x84FC
{
	if (bParam2)
	{
...
void func_160(int iParam0, var uParam1, bool bParam2, int iParam3)//Position - 0xB02B
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		bVar2 = func_262(iParam0, 0);
		bVar3 = func_254(iParam0);
		bVar4 = func_177(iParam0, iParam3);
		if (bParam2)
		{
			bVar3 = true;
		}
		...
		while (iVar5 < 127)
		{
			...
			{
				if (func_169(&Var0, iVar5, iVar1, iParam0, -1))
				{
					if (func_162(iParam0, &Var0, iVar5, Var0.f_4, Var0.f_8, bVar2, bVar3, bParam2, bVar4))
					{
		...
		while (iVar6 < iVar7)
		{
			if (FILES::GET_TATTOO_SHOP_DLC_ITEM_DATA(iVar1, iVar6, &Var8))
			{
				if (!FILES::IS_CONTENT_ITEM_LOCKED(Var8.f_0))
				{
					...
					{
						if (func_162(iParam0, &(Var8.f_7), iVar9, Var8.f_2, Var8.f_6, bVar2, bVar3, bParam2, bVar4))
						{
							PED::ADD_PED_DECORATION_FROM_HASHES_IN_CORONA(iParam0, Var8.f_2, Var8.f_3);
							func_161(iParam0, Var8.f_2, Var8.f_3);
						}
					}
				}
			}
...
int func_178(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11F3F
{
	...
	else if (iParam2 == 14)
	{
		...
		iVar1 = (iParam1 - func_181(iParam0));
		if (iVar1 < 0)
		{
			return -1;
		}
	...
	else
	{
		...
		iVar4 = (iParam1 - func_179(iParam0, func_180(iParam2)));
		if (iVar4 < 0)
		{
			return -1;
		}
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_180(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_188(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x128EA
{
	...
	else
	{
		...
		if (iVar4 != -1)
		{
			return (func_179(iParam0, func_180(iParam2)) + iVar4);
		}
	}
	return -99;
}
...
int func_191(int iParam0, int iParam1, int iParam2)//Position - 0x12A8A
{
		...
		while (iVar7 < 7)
		{
			...
			if (uVar8[iVar4] != -99)
			{
				if (!func_191(iParam0, iVar4, uVar8[iVar4]))
				{
					...
					if (iVar4 == 13)
					{
						uVar9 = { func_200(iVar0, uVar8[iVar4]) };
						iVar5 = 0;
						while (iVar5 <= 8)
						{
							if (!func_191(iParam0, 14, uVar9[iVar5]))
							{
								iVar6 = 0;
								while (iVar6 <= 19)
								{
	...
	{
		uVar11 = { func_200(iVar0, iParam2) };
		iVar10 = 0;
		while (iVar10 <= 8)
		{
			if (!func_191(iParam0, 14, uVar11[iVar10]))
			{
				return 0;
			}
			iVar10++;
	...
	else
	{
		...
		if (iParam1 == 4)
		{
			...
			if (Global_78340 == 1)
			{
				...
				{
					if (func_193(iVar0, 4, iParam2, &uVar18))
					{
						return func_191(iParam0, 4, uVar18);
					}
				}
				else if (func_192(iVar0, 4, iParam2, &uVar18))
				{
					return func_191(iParam0, 4, uVar18);
				}
			}
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1.f_0))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &Var2) && Var2.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var2.f_2] = func_188(iParam1, Var2.f_0, 14, iVar0);
					}
					else if (Var2.f_1 != -1)
					{
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.f_0 != 0 && Var2.f_0 != -1) && Var2.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_205(Var2.f_2)] = Var2.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_205(Var2.f_2)] = func_188(iParam1, Var2.f_0, func_205(Var2.f_2), iVar0);
					}
				}
				else if (Var2.f_1 != -1)
				{
					(*uParam0)[func_205(Var2.f_2)] = Var2.f_1;
				}
			}
			iVar4++;
		}
...
void func_209(int iParam0)//Position - 0x16E00
{
	...
	func_210(&(Global_78341[0 /*14*/]), iVar7, iParam0, &sVar2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_220(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1B74F
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_210(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_210(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_180(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_221(int iParam0, int iParam1)//Position - 0x1B9D6
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78341[0 /*14*/].f_5 = 4;
			func_220(iVar7, iParam0, 9, iParam1);
			return;
			break;
	}
	...
	func_210(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_222(int iParam0, int iParam1)//Position - 0x1BAD9
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78341[0 /*14*/].f_5 = 4;
			func_220(iVar7, iParam0, 28, iParam1);
			return;
			break;
	}
	func_210(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_223(int iParam0, int iParam1)//Position - 0x1BDB8
{
	...
	{
		Global_78341[0 /*14*/].f_5 = 4;
		func_220(iVar7, iParam0, 327, iParam1);
...
void func_224(int iParam0, int iParam1)//Position - 0x1EBE7
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78341[0 /*14*/].f_5 = 4;
			func_220(iVar7, iParam0, 6, iParam1);
			return;
			break;
	}
	func_210(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_225(int iParam0, int iParam1)//Position - 0x1ECEC
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78341[0 /*14*/].f_5 = 4;
			func_220(iVar7, iParam0, 55, iParam1);
			if (Global_78341[0 /*14*/].f_7 > 0)
			{
...
void func_226(int iParam0, int iParam1)//Position - 0x1F4C8
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78341[0 /*14*/].f_5 = 4;
			func_220(iVar7, iParam0, 26, iParam1);
			if (Global_78341[0 /*14*/].f_7 > 0)
			{
...
void func_227(int iParam0, int iParam1)//Position - 0x1F7AD
{
	...
	{
		Global_78341[0 /*14*/].f_5 = 4;
		func_220(iVar7, iParam0, 256, iParam1);
		if (Global_78341[0 /*14*/].f_7 > 0)
		{
...
void func_229(int iParam0, int iParam1)//Position - 0x224AB
{
	...
	{
		Global_78341[0 /*14*/].f_5 = 4;
		func_220(iVar7, iParam0, 16, iParam1);
		return;
	}
	func_210(&(Global_78341[0 /*14*/]), iVar7, iParam0, &sVar2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_230(int iParam0, int iParam1)//Position - 0x22606
{
	...
	{
		Global_78341[0 /*14*/].f_5 = 4;
		func_220(iVar7, iParam0, 36, iParam1);
		return;
	}
	func_210(&(Global_78341[0 /*14*/]), iVar7, iParam0, &sVar2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_231(int iParam0, int iParam1)//Position - 0x22886
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78341[0 /*14*/].f_5 = 4;
			func_220(iVar7, iParam0, 136, iParam1);
			if (Global_78341[0 /*14*/].f_7 > 0)
			{
...
void func_236(int iParam0, int iParam1)//Position - 0x25747
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78341[0 /*14*/].f_5 = 4;
			func_220(iVar7, iParam0, 92, iParam1);
			return;
			break;
	}
...
void func_243(int iParam0, int iParam1)//Position - 0x29A83
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78341[0 /*14*/].f_5 = 3;
			func_220(iVar7, iParam0, 7, iParam1);
			return;
			break;
	}
	func_210(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_249(int iParam0, int iParam1)//Position - 0x2D51A
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78341[0 /*14*/].f_5 = 3;
			func_220(iVar7, iParam0, 46, iParam1);
			return;
			break;
	}
	func_210(&(Global_78341[0 /*14*/]), iVar7, iParam0, &sVar2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_250(int iParam0, int iParam1)//Position - 0x2D836
{
	...
	{
		Global_78341[0 /*14*/].f_5 = 3;
		func_220(iVar7, iParam0, 241, iParam1);
		if (Global_78341[0 /*14*/].f_7 > 0)
		{
...
void func_251(int iParam0, int iParam1)//Position - 0x2FD27
{
	...
	{
		Global_78341[0 /*14*/].f_5 = 3;
		func_220(iVar7, iParam0, 237, iParam1);
		if (Global_78341[0 /*14*/].f_7 > 0)
		{
			Global_78341[0 /*14*/].f_7 = SYSTEM::ROUND((SYSTEM::TO_FLOAT(Global_78341[0 /*14*/].f_7) * Global_296940.f_16));
		}
...
void func_252(int iParam0, int iParam1)//Position - 0x312DC
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78341[0 /*14*/].f_5 = 3;
			func_220(iVar7, iParam0, 91, iParam1);
			return;
			break;
	}
...
void func_289(var uParam0, struct<3> Param1, struct<3> Param2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x33866
{
	func_290(uParam0, sParam3, iParam4, iParam5, iParam6);
	uParam0->f_9 = { Param1 };
	uParam0->f_12 = { Param2 };
	uParam0->f_7 = iParam7;
}
