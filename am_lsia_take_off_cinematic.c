...
int func_56(int iParam0, struct<3> Param1)//Position - 0x1338
{
	struct<3> Var0;
	var uVar1;
...
int func_57(var uParam0)//Position - 0x1392
{
	func_273();
...
int func_58(var uParam0)//Position - 0x13F5
{
	func_59();
	if (CAM::IS_SCREEN_FADED_OUT())
	{
...
void func_61(int iParam0)//Position - 0x14C4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8)//Position - 0x1560
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63()//Position - 0x1644
{
	return -1;
}

int func_64(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x164D
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x16E8
{
	*uParam0 = iParam1;
}

int func_66()//Position - 0x16F5
{
...
void func_67(var uParam0)//Position - 0x1727
{
	int iVar0;
...
int func_68(var uParam0)//Position - 0x18B6
{
	if (uParam0->f_20 == 0)
	{
		return 1;
...
int func_69()//Position - 0x1936
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

char* func_70(bool bParam0, char* sParam1, char* sParam2)//Position - 0x1946
{
	if (bParam0)
	{
		return sParam1;
...
void func_71(var uParam0)//Position - 0x195D
{
	func_59();
...
void func_72(var uParam0)//Position - 0x1977
{
	func_155(uParam0);
	if (uParam0->f_5)
	{
...
void func_73(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1A1D
{
	func_75();
	func_48(1);
	HUD::CLEAR_HELP(true);
...
void func_77(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x1C05
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		if ((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iParam0)) || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			if (func_130(ENTITY::GET_ENTITY_MODEL(iParam0)))
			{
				if (uParam1->f_9[44] == 2)
				{
...
bool func_78(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)//Position - 0x20DC
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

bool func_79(int iParam0)//Position - 0x20EC
{
	return func_130(iParam0);
}

int func_80(int iParam0)//Position - 0x20FA
{
	switch (iParam0)
	{
		case joaat("pounder2"):
...
void func_81(int iParam0)//Position - 0x21FB
{
	struct<3> Var0;
...
void func_82(struct<3> Param0)//Position - 0x2286
{
	struct<3> Var0;
...
var func_83(int iParam0, bool bParam1)//Position - 0x22C5
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_84(int iParam0)//Position - 0x232A
{
	int iVar0;
...
bool func_85(int iParam0)//Position - 0x2365
{
	return func_86(iParam0, 6, 1);
}

int func_86(int iParam0, int iParam1, bool bParam2)//Position - 0x2375
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_87(int iParam0, int iParam1, int iParam2)//Position - 0x23D6
{
	int iVar0;
	var uVar1;
...
int func_88(var uParam0)//Position - 0x2413
{
	int iVar0;
	int iVar1;
...
int func_89(int iParam0)//Position - 0x2447
{
	switch (iParam0)
	{
		case 0:
...
int func_90()//Position - 0x27C2
{
	return Global_31959;
}

int func_91(int iParam0)//Position - 0x27CD
{
	switch (iParam0)
	{
		case -1:
...
bool func_92()//Position - 0x2ADC
{
	return Global_100493.f_376 > 0;
}

int func_93(int iParam0, var* uParam1)//Position - 0x2AED
{
	int iVar0;
	int iVar1;
...
int func_94(int iParam0)//Position - 0x2B6A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_95(int iParam0)//Position - 0x2BF7
{
	int iVar0;
...
int func_96(int iParam0, int iParam1)//Position - 0x2C53
{
	func_100();
...
bool func_97(var uParam0, int iParam1, int iParam2, struct<3> Param3, struct<3> Param4, struct<3> Param5, float fParam6, int iParam7, int iParam8)//Position - 0x2EFE
{
...
int func_98(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x2F27
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		return 0;
...
bool func_99(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x821E
{
	if (bParam2)
	{
...
int func_101(int iParam0)//Position - 0x82DE
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
...
int func_102(int iParam0)//Position - 0x8316
{
	int iVar0;
...
int func_103(int iParam0, var* uParam1)//Position - 0x835E
{
	int iVar0;
	bool bVar1;
...
int func_104(int iParam0)//Position - 0x8445
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return 1;
...
int func_105(int iParam0)//Position - 0x872F
{
...
int func_106(int iParam0)//Position - 0x875B
{
...
int func_107(int iParam0)//Position - 0x8778
{
...
int func_108(int iParam0, int iParam1)//Position - 0x879B
{
...
int func_109(int iParam0)//Position - 0x87D6
{
	if (func_108(iParam0, 0))
	{
...
bool func_110(bool bParam0)//Position - 0x87F9
{
	return func_111(PLAYER::PLAYER_ID(), bParam0);
}

int func_111(int iParam0, bool bParam1)//Position - 0x880B
{
	return func_112(iParam0, bParam1, 1);
}

int func_112(int iParam0, bool bParam1, int iParam2)//Position - 0x881C
{
	int iVar0;
...
int func_113(int iParam0, int iParam1)//Position - 0x8878
{
	if (iParam0 != func_63())
	{
...
int func_114(int iParam0, bool bParam1)//Position - 0x88C7
{
	var uVar0;
	int iVar1;
...
int func_115(int iParam0)//Position - 0x8925
{
	return (iParam0 % 32);
}

int func_116(int iParam0)//Position - 0x8932
{
	int iVar0;
...
int func_117(var uParam0)//Position - 0x894A
{
	int iVar0;
	int iVar1;
...
int func_118(int iParam0)//Position - 0x8977
{
	return (iParam0 / 32);
}

int func_119(int iParam0)//Position - 0x8984
{
	if (iParam0 != func_63())
	{
...
int func_120(int iParam0)//Position - 0x89B9
{
	if (iParam0 != func_63())
	{
...
int func_121(int iParam0)//Position - 0x8A00
{
	switch (iParam0)
	{
		case 0:
...
void func_122(int iParam0, int iParam1)//Position - 0x8E87
{
	int iVar0;
	int iVar1;
...
bool func_123(int iParam0, var uParam1)//Position - 0x8EA8
{
	*uParam1 = -1;
	switch (iParam0)
	{
...
int func_124(int iParam0)//Position - 0x916A
{
	switch (iParam0)
	{
		case 0:
...
int func_125(int iParam0, int iParam1, int iParam2)//Position - 0x9208
{
	...
	if ((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_126()) && Global_1576214)
	{
...
struct<13> func_127()//Position - 0x9432
{
	struct<13> Var0;
...
int func_128(int iParam0)//Position - 0x9447
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("deathbike2"):
...
bool func_129(int iParam0, var uParam1)//Position - 0x9468
{
	*uParam1 = -1f;
	switch (iParam0)
	{
...
int func_130(int iParam0)//Position - 0x9769
{
	switch (iParam0)
	{
		case joaat("deity"):
...
void func_131(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x97B0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_133(var uParam0)//Position - 0x9EE4
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0x9F08
{
	int iVar0;
...
var func_135(int iParam0, int iParam1)//Position - 0x9F26
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

bool func_136(int iParam0)//Position - 0x9F3E
{
	return func_137(&(Global_2703735.f_169), iParam0);
}

var func_137(var uParam0, var uParam1)//Position - 0x9F52
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_138(int iParam0, var uParam1, var uParam2)//Position - 0x9F75
{
	int iVar0;
	int iVar1;
	...
	if (func_142(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_141(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_141(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_140(iParam0);
	if (func_139(*iParam0))
	{
...
int func_139(int iParam0)//Position - 0xA14F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_140(var uParam0)//Position - 0xA229
{
...
int func_141(int iParam0, int iParam1)//Position - 0xA280
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_142(int iParam0, int iParam1)//Position - 0xA365
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_143(int iParam0, int iParam1, int iParam2)//Position - 0xA744
{
...
int func_144()//Position - 0xA768
{
	return 0;
}

void func_145(int iParam0, int iParam1)//Position - 0xA771
{
	int iVar0;
	int iVar1;
...
int func_146(int iParam0)//Position - 0xA7E9
{
	switch (iParam0)
	{
		case joaat("granger"):
...
bool func_147()//Position - 0xA809
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

int func_148(int iParam0)//Position - 0xA81A
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xA85F
{
...
int func_150(int iParam0)//Position - 0xA87F
{
	switch (iParam0)
	{
		case 161:
...
int func_151(int iParam0)//Position - 0xA8D2
{
	switch (iParam0)
	{
		case 1:
...
int func_152(int iParam0)//Position - 0xA982
{
...
int func_153(int iParam0, int iParam1)//Position - 0xAA09
{
	int iVar0;
...
int func_154(int iParam0)//Position - 0xAA56
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_155(var uParam0)//Position - 0xAA77
{
	char* sVar0;
...
void func_156(var uParam0)//Position - 0xAAC5
{
...
void func_159(int iParam0, var uParam1, bool bParam2, int iParam3)//Position - 0xAC83
{
	struct<9> Var0;
	int iVar1;
	bool bVar2;
...
void func_160(int iParam0, int iParam1, int iParam2)//Position - 0xADEC
{
	switch (iParam1)
	{
...
int func_161(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)//Position - 0xC040
{
	int iVar0;
	int iVar1;
...
int func_162(int iParam0, int iParam1)//Position - 0xC866
{
	var uVar0;
	int iVar1;
...
int func_163(int iParam0, int iParam1)//Position - 0xC8A5
{
	int iVar0;
	int iVar1;
...
int func_164()//Position - 0xC8EC
{
	return Global_31960;
}

int func_165(var uParam0)//Position - 0xC8F7
{
	int iVar0;
	int iVar1;
...
char* func_166(int iParam0)//Position - 0xCC5C
{
	switch (iParam0)
	{
		case 0:
...
int func_167(int iParam0, char* sParam1, int iParam2)//Position - 0xD299
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
bool func_168(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xE2CB
{
	int iVar0;
	int iVar1;
	...
	switch (iParam2)
	{
		...
		case 4:
			...
			{
				case 0:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_008", "multiplayer_overlays", "000", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(20000) * Global_262145.f_2916 /* Tunable: TATTOO_MP_FM_HEAD_BANGER_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 1:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_009", "multiplayer_overlays", "001", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1400) * Global_262145.f_2917 /* Tunable: TATTOO_MP_FM_SLAYER_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 2:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_010", "multiplayer_overlays", "002", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(9750) * Global_262145.f_2918 /* Tunable: TATTOO_MP_FM_GANGHIDEOUT_CLEAR_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 3:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_011", "multiplayer_overlays", "003", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2150) * Global_262145.f_2919 /* Tunable: TATTOO_MP_FM_ARMOURED_VAN_TAKEDOWN_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 4:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_012", "multiplayer_overlays", "004", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2920 /* Tunable: TATTOO_MP_FM_HUSTLER_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 54:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_013", "multiplayer_overlays", "005", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12400) * Global_262145.f_2921 /* Tunable: TATTOO_MP_FM_WIN_EVER_MODE_ONCE_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 5:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_014", "multiplayer_overlays", "006", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3500) * Global_262145.f_2922 /* Tunable: TATTOO_MP_FM_BOUNTY_KILLER_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 6:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_015", "multiplayer_overlays", "007", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4950) * Global_262145.f_2923 /* Tunable: TATTOO_MP_FM_HOLD_WORLD_RECORD_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 55:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_016", "multiplayer_overlays", "008", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1350) * Global_262145.f_2924 /* Tunable: TATTOO_MP_FM_FULL_MODDED_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 7:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_017", "multiplayer_overlays", "009", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1450) * Global_262145.f_2925 /* Tunable: TATTOO_MP_FM_REVENGE_KILL_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 8:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_018", "multiplayer_overlays", "010", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2700) * Global_262145.f_2926 /* Tunable: TATTOO_MP_FM_KILL_3_RACERS_EXPENDITURE_TUNABLE */)), 7);
					break;
				
				case 9:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_019", "multiplayer_overlays", "011", "rank", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1200) * Global_262145.f_2927 /* Tunable: TATTOO_MP_FM_REACH_RANK_1_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 10:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_020", "multiplayer_overlays", "012", "rank", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1500) * Global_262145.f_2928 /* Tunable: TATTOO_MP_FM_REACH_RANK_2_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 11:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_021", "multiplayer_overlays", "013", "rank", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2650) * Global_262145.f_2929 /* Tunable: TATTOO_MP_FM_REACH_RANK_3_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 56:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_022", "multiplayer_overlays", "014", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1900) * Global_262145.f_2930 /* Tunable: TATTOO_MP_FM_FMKILLCHEATER_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 12:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_023", "multiplayer_overlays", "015", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4950) * Global_262145.f_2931 /* Tunable: TATTOO_MP_FM_RACES_WON_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 57:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_024", "multiplayer_overlays", "016", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2400) * Global_262145.f_2932 /* Tunable: TATTOO_MP_FM_HOLD_UP_SHOPS_1_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 58:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_025", "multiplayer_overlays", "017", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5100) * Global_262145.f_2933 /* Tunable: TATTOO_MP_FM_HOLD_UP_SHOPS_2_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 59:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_026", "multiplayer_overlays", "018", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7400) * Global_262145.f_2934 /* Tunable: TATTOO_MP_FM_HOLD_UP_SHOPS_3_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 60:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_027", "multiplayer_overlays", "019", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2935 /* Tunable: TATTOO_MP_FM_HOLD_UP_SHOPS_4_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 17:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_201", "multiplayer_overlays", "005", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2400) * Global_262145.f_2940 /* Tunable: TATTOO_MP_FM_01_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 18:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_202", "multiplayer_overlays", "006", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5100) * Global_262145.f_2941 /* Tunable: TATTOO_MP_FM_02_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 19:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_203", "multiplayer_overlays", "015", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3600) * Global_262145.f_2942 /* Tunable: TATTOO_MP_FM_03_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 20:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_204", "multiplayer_overlays", "000", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2943 /* Tunable: TATTOO_MP_FM_04_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 21:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_205", "multiplayer_overlays", "001", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12500) * Global_262145.f_2944 /* Tunable: TATTOO_MP_FM_05_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 22:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_206", "multiplayer_overlays", "003", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2945 /* Tunable: TATTOO_MP_FM_06_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 23:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_207", "multiplayer_overlays", "014", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2946 /* Tunable: TATTOO_MP_FM_07_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 24:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_208", "multiplayer_overlays", "018", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2947 /* Tunable: TATTOO_MP_FM_08_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 25:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_209", "multiplayer_overlays", "002", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3750) * Global_262145.f_2948 /* Tunable: TATTOO_MP_FM_09_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 26:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_210", "multiplayer_overlays", "007", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3750) * Global_262145.f_2949 /* Tunable: TATTOO_MP_FM_10_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 27:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_211", "multiplayer_overlays", "008", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4800) * Global_262145.f_2950 /* Tunable: TATTOO_MP_FM_11_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 28:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_212", "multiplayer_overlays", "017", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3500) * Global_262145.f_2951 /* Tunable: TATTOO_MP_FM_12_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 61:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_213", "multiplayer_overlays", "009", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12350) * Global_262145.f_2952 /* Tunable: TATTOO_MP_FM_13_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 62:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_214", "multiplayer_overlays", "011", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1900) * Global_262145.f_2953 /* Tunable: TATTOO_MP_FM_14_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 63:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_215", "multiplayer_overlays", "013", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4500) * Global_262145.f_2954 /* Tunable: TATTOO_MP_FM_15_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 64:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_216", "multiplayer_overlays", "016", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12250) * Global_262145.f_2955 /* Tunable: TATTOO_MP_FM_16_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 65:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_217", "multiplayer_overlays", "019", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12300) * Global_262145.f_2956 /* Tunable: TATTOO_MP_FM_17_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 29:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_218", "multiplayer_overlays", "010", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2500) * Global_262145.f_2957 /* Tunable: TATTOO_MP_FM_18_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 30:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_219", "multiplayer_overlays", "004", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2958 /* Tunable: TATTOO_MP_FM_19_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 31:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_220", "multiplayer_overlays", "012", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2959 /* Tunable: TATTOO_MP_FM_20_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 66:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_221", "multiplayer_overlays", "020", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2960 /* Tunable: TATTOO_MP_FM_21_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 32:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_222", "multiplayer_overlays", "021", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2961 /* Tunable: TATTOO_MP_FM_22_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 33:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_223", "multiplayer_overlays", "022", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7300) * Global_262145.f_2962 /* Tunable: TATTOO_MP_FM_23_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 34:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_224", "multiplayer_overlays", "023", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7250) * Global_262145.f_2963 /* Tunable: TATTOO_MP_FM_24_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 35:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_225", "multiplayer_overlays", "024", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(11900) * Global_262145.f_2964 /* Tunable: TATTOO_MP_FM_25_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 36:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_226", "multiplayer_overlays", "025", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2750) * Global_262145.f_2965 /* Tunable: TATTOO_MP_FM_26_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 37:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_227", "multiplayer_overlays", "026", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1750) * Global_262145.f_2966 /* Tunable: TATTOO_MP_FM_27_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 38:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_228", "multiplayer_overlays", "027", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7300) * Global_262145.f_2967 /* Tunable: TATTOO_MP_FM_28_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 39:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_229", "multiplayer_overlays", "028", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3250) * Global_262145.f_2968 /* Tunable: TATTOO_MP_FM_29_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 40:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_230", "multiplayer_overlays", "029", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1000) * Global_262145.f_2969 /* Tunable: TATTOO_MP_FM_30_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 67:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_231", "multiplayer_overlays", "030", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2970 /* Tunable: TATTOO_MP_FM_31_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 41:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_232", "multiplayer_overlays", "031", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2971 /* Tunable: TATTOO_MP_FM_32_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 68:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_233", "multiplayer_overlays", "032", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5100) * Global_262145.f_2972 /* Tunable: TATTOO_MP_FM_33_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 42:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_234", "multiplayer_overlays", "033", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5050) * Global_262145.f_2973 /* Tunable: TATTOO_MP_FM_34_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 43:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_235", "multiplayer_overlays", "034", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2450) * Global_262145.f_2974 /* Tunable: TATTOO_MP_FM_35_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 44:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_236", "multiplayer_overlays", "035", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4950) * Global_262145.f_2975 /* Tunable: TATTOO_MP_FM_36_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 45:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_237", "multiplayer_overlays", "036", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5100) * Global_262145.f_2976 /* Tunable: TATTOO_MP_FM_37_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 46:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_238", "multiplayer_overlays", "037", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12250) * Global_262145.f_2977 /* Tunable: TATTOO_MP_FM_38_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 47:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_239", "multiplayer_overlays", "038", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1150) * Global_262145.f_2978 /* Tunable: TATTOO_MP_FM_39_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 48:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_240", "multiplayer_overlays", "039", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2979 /* Tunable: TATTOO_MP_FM_40_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 49:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_241", "multiplayer_overlays", "040", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7600) * Global_262145.f_2980 /* Tunable: TATTOO_MP_FM_41_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 50:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_242", "multiplayer_overlays", "041", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2600) * Global_262145.f_2981 /* Tunable: TATTOO_MP_FM_42_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 51:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_243", "multiplayer_overlays", "042", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2500) * Global_262145.f_2982 /* Tunable: TATTOO_MP_FM_43_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 52:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_244", "multiplayer_overlays", "043", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7450) * Global_262145.f_2983 /* Tunable: TATTOO_MP_FM_44_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 53:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_245", "multiplayer_overlays", "044", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2984 /* Tunable: TATTOO_MP_FM_45_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 69:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_246", "multiplayer_overlays", "045", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2985 /* Tunable: TATTOO_MP_FM_46_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 70:
					func_175(sParam0, iParam1, iParam3, "TAT_FM_247", "multiplayer_overlays", "047", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2500) * Global_262145.f_2986 /* Tunable: TATTOO_MP_FM_47_EXPENDITURE_TUNABLE */)), 2);
					break;
			}
			if (iVar0 == joaat("MP_M_Freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_175(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_000", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2987 /* Tunable: TSHIRT_TRANS_MP_FM_REDSKULL_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 88:
						func_175(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_001", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2988 /* Tunable: TSHIRT_TRANS_MP_FM_LSBELLE_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 89:
						func_175(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_002", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2989 /* Tunable: TSHIRT_TRANS_MP_FM_ROCKSTAR_EXPENDITURE_TUNABLE */)), 0);
						break;
					...
					case 13:
						func_175(sParam0, iParam1, iParam3, "TAT_FM_100" /* GXT: Crew Emblem Small */, "multiplayer_overlays", "000_A", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2936 /* Tunable: TATTOO_MP_FM_CREW_A_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 14:
						func_175(sParam0, iParam1, iParam3, "TAT_FM_101" /* GXT: Crew Emblem Large */, "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2937 /* Tunable: TATTOO_MP_FM_CREW_B_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 15:
						func_175(sParam0, iParam1, iParam3, "TAT_FMM_CLB" /* GXT: Crew Emblem Back */, "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2938 /* Tunable: TATTOO_MP_FM_CREW_C_EXPENDITURE_TUNABLE */)), 2);
						break;
					
					case 16:
						func_175(sParam0, iParam1, iParam3, "TAT_FM_100" /* GXT: Crew Emblem Small */, "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2939 /* Tunable: TATTOO_MP_FM_CREW_D_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 71:
						func_175(sParam0, iParam1, iParam3, "TAT_FM_101" /* GXT: Crew Emblem Large */, "multiplayer_overlays", "000_E", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2939 /* Tunable: TATTOO_MP_FM_CREW_D_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 72:
						func_175(sParam0, iParam1, iParam3, "TAT_FMM_CLB" /* GXT: Crew Emblem Back */, "multiplayer_overlays", "000_F", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2939 /* Tunable: TATTOO_MP_FM_CREW_D_EXPENDITURE_TUNABLE */)), 0);
						break;
				}
			}
			else if (iVar0 == joaat("MP_F_Freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_175(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_000", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2987 /* Tunable: TSHIRT_TRANS_MP_FM_REDSKULL_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 88:
						func_175(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_001", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2988 /* Tunable: TSHIRT_TRANS_MP_FM_LSBELLE_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 89:
						func_175(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_002", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2989 /* Tunable: TSHIRT_TRANS_MP_FM_ROCKSTAR_EXPENDITURE_TUNABLE */)), 0);
						break;
					...
					case 14:
						func_175(sParam0, iParam1, iParam3, "TAT_FM_100" /* GXT: Crew Emblem Small */, "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2937 /* Tunable: TATTOO_MP_FM_CREW_B_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 15:
						func_175(sParam0, iParam1, iParam3, "TAT_FM_101" /* GXT: Crew Emblem Large */, "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2938 /* Tunable: TATTOO_MP_FM_CREW_C_EXPENDITURE_TUNABLE */)), 2);
						break;
					
					case 16:
						func_175(sParam0, iParam1, iParam3, "TAT_FM_101" /* GXT: Crew Emblem Large */, "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2939 /* Tunable: TATTOO_MP_FM_CREW_D_EXPENDITURE_TUNABLE */)), 0);
						break;
					}
			}
			break;
...
void func_169(char* sParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11273
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
int func_173()//Position - 0x115AC
{
	return 1;
}

int func_174()//Position - 0x115B5
{
	return 1;
}

void func_175(char* sParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9)//Position - 0x115BE
{
	char cVar0[32];
...
int func_176(int iParam0, int iParam1)//Position - 0x11873
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_177(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11B29
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_178(int iParam0, int iParam1)//Position - 0x11C43
{
	switch (iParam0)
	{
...
int func_179(int iParam0)//Position - 0x11FEA
{
	switch (iParam0)
	{
		case 0:
...
int func_180(int iParam0)//Position - 0x1209A
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_181(int iParam0, int iParam1, int iParam2)//Position - 0x120FB
{
	int iVar0;
	int iVar1;
...
int func_182(int iParam0, int iParam1)//Position - 0x1219C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_183(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x121FC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_184(int iParam0, int iParam1)//Position - 0x12253
{
	int iVar0;
	int iVar1;
...
int func_185(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x12299
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_186(int iParam0, int iParam1)//Position - 0x12395
{
	int iVar0;
...
int func_187(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x124D3
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_188(int iParam0)//Position - 0x1258E
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_189(int iParam0)//Position - 0x125ED
{
	switch (iParam0)
	{
		case 0:
...
int func_190(int iParam0, int iParam1, int iParam2)//Position - 0x12673
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	{
		if (Global_78130[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_179(iParam1)) && Global_78130[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_179(iParam1)))
		{
			return 1;
		}
		if (iParam1 == 4)
...
int func_191(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x12ACD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_192(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x12B76
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_193(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x12C1E
{
	switch (iParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
int func_194(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x12C71
{
	var uVar0;
	int iVar1;
...
int func_195(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x13275
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_177(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_177(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_177(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_177(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_196(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x134F2
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_197(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x13917
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_198(int iParam0, int iParam1, int iParam2)//Position - 0x13C0A
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_199(int iParam0, int iParam1)//Position - 0x13CA3
{
	int iVar0;
	struct<10> Var1;
...
void func_200(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x145D3
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var2;
...
void func_201(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x146FD
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_202(int iParam0, int iParam1)//Position - 0x14745
{
	int iVar0;
	struct<17> Var1;
...
void func_203(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1658D
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var2;
...
int func_204(int iParam0)//Position - 0x16777
{
	switch (iParam0)
	{
		case 0:
...
void func_205(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x16827
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_206(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x16898
{
	func_252();
	if (iParam0 == joaat("MP_M_Freemode_01"))
	{
...
void func_207(int iParam0, int iParam1, int iParam2)//Position - 0x168D9
{
	switch (iParam0)
	{
		case 2:
...
void func_208(int iParam0)//Position - 0x169E5
{
	bool bVar0;
	int iVar1;
	char* sVar2;
...
void func_209(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x16BA0
{
	var uVar0;
	int iVar1;
...
bool func_210(int iParam0, int iParam1, var uParam2)//Position - 0x16F45
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_211(int iParam0, int iParam1)//Position - 0x1734A
{
	switch (iParam1)
	{
		case 0:
...
int func_212(int iParam0, int iParam1)//Position - 0x17745
{
	switch (iParam1)
	{
		case 0:
...
int func_213(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x17B40
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_214(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x189E5
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_215(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x18A24
{
	int iVar0;
...
bool func_216(int iParam0)//Position - 0x1AF75
{
	return Global_43052 == iParam0;
}

int func_217(int iParam0)//Position - 0x1AF83
{
	switch (iParam0)
	{
		case -1:
...
void func_218(int iParam0, int iParam1)//Position - 0x1B057
{
	int iVar0;
...
void func_219(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1B077
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_209(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_209(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
...
void func_220(int iParam0, int iParam1)//Position - 0x1B2FE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_221(int iParam0, int iParam1)//Position - 0x1B401
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_222(int iParam0, int iParam1)//Position - 0x1B6E0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_223(int iParam0, int iParam1)//Position - 0x1E570
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_224(int iParam0, int iParam1)//Position - 0x1E675
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_225(int iParam0, int iParam1)//Position - 0x1EE51
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_226(int iParam0, int iParam1)//Position - 0x1F136
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_227(int iParam0, int iParam1)//Position - 0x2075E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_228(int iParam0, int iParam1)//Position - 0x21DBD
{
	bool bVar0;
	int iVar1;
	char* sVar2;
...
void func_229(int iParam0, int iParam1)//Position - 0x21F18
{
	bool bVar0;
	int iVar1;
	char* sVar2;
...
void func_230(int iParam0, int iParam1)//Position - 0x22198
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
int func_231(int iParam0, int iParam1)//Position - 0x2353A
{
	var uVar0;
	int iVar1;
...
var func_232(var uParam0, int iParam1)//Position - 0x23569
{
	var uVar0;
...
int func_233(var uParam0)//Position - 0x23582
{
	int iVar0;
	int iVar1;
...
void func_234(int iParam0, int iParam1)//Position - 0x238C1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_235(int iParam0, int iParam1)//Position - 0x25027
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_236(int iParam0, int iParam1, int iParam2)//Position - 0x25EF8
{
	switch (iParam0)
	{
		case 2:
...
void func_237(int iParam0)//Position - 0x26004
{
	bool bVar0;
	int iVar1;
	char* sVar2;
...
void func_238(int iParam0, int iParam1)//Position - 0x261CE
{
	int iVar0;
...
void func_239(int iParam0, int iParam1)//Position - 0x261EE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_240(int iParam0, int iParam1)//Position - 0x262F1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_241(int iParam0, int iParam1)//Position - 0x265A2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_242(int iParam0, int iParam1)//Position - 0x29363
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_243(int iParam0, int iParam1)//Position - 0x29484
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_244(int iParam0, int iParam1)//Position - 0x29D7C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_245(int iParam0, int iParam1)//Position - 0x2A033
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_246(int iParam0, int iParam1)//Position - 0x2B670
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_247(int iParam0, int iParam1)//Position - 0x2CD09
{
	bool bVar0;
	int iVar1;
	char* sVar2;
...
void func_248(int iParam0, int iParam1)//Position - 0x2CE60
{
	bool bVar0;
	int iVar1;
	char* sVar2;
...
void func_249(int iParam0, int iParam1)//Position - 0x2D17C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_250(int iParam0, int iParam1)//Position - 0x2F66D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_251(int iParam0, int iParam1)//Position - 0x30BF9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_252()//Position - 0x31AB3
{
...
int func_253(int iParam0)//Position - 0x31B2C
{
	int iVar0;
...
int func_254(int iParam0)//Position - 0x31BA8
{
	if (func_255(1))
	{
...
int func_255(bool bParam0)//Position - 0x31BDF
{
...
bool func_256(int iParam0)//Position - 0x31C13
{
	return iParam0 == 87;
}

int func_257()//Position - 0x31C20
{
	return func_258(Global_4718592.f_116524);
}

int func_258(int iParam0)//Position - 0x31C36
{
	int iVar0;
...
var func_259(bool bParam0)//Position - 0x31C70
{
	if (bParam0)
	{
...
int func_261(int iParam0, bool bParam1)//Position - 0x31CD4
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			switch (iVar0)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_111(PLAYER::PLAYER_ID(), 1) && Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_76.f_21 != 0)
						{
							return 1;
						}
					}
...
int func_262(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3250E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_263(int iParam0, int iParam1)//Position - 0x32D32
{
	int iVar0;
...
int func_264(int iParam0)//Position - 0x32D54
{
...
int func_266()//Position - 0x32DD5
{
	return Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10;
}

bool func_267(bool bParam0)//Position - 0x32DEA
{
	return func_268(PLAYER::PLAYER_ID(), bParam0);
}

bool func_268(int iParam0, bool bParam1)//Position - 0x32DFC
{
	if (!bParam1)
	{
		if (func_269(iParam0))
...
int func_269(int iParam0)//Position - 0x32E27
{
	if (iParam0 != func_63())
	{
		if (Global_1892703[iParam0 /*599*/].f_10 != func_63())
...
int func_271(int iParam0, bool bParam1, int iParam2)//Position - 0x32E7E
{
...
int func_272(var uParam0)//Position - 0x32ED5
{
	return *uParam0;
}

void func_273()//Position - 0x32EE0
{
...
void func_274(int iParam0)//Position - 0x32F2B
{
	if (func_45())
	{
		return;
...
void func_275(bool bParam0)//Position - 0x32F5E
{
	if (bParam0)
	{
		func_277();
...
void func_276(int iParam0, int iParam1)//Position - 0x32FAF
{
...
void func_277()//Position - 0x32FE5
{
	Global_2815059.f_4599 = 0;
}

int func_278()//Position - 0x32FF5
{
	if (func_279())
	{
		return 1;
...
bool func_282()//Position - 0x330E4
{
	return Global_2714762.f_698;
}

int func_283(int iParam0)//Position - 0x330F3
{
...
bool func_284()//Position - 0x3310A
{
	return Global_2725403;
}

bool func_285()//Position - 0x33116
{
	return Global_2714762.f_693;
}

void func_286()//Position - 0x33125
{
	SYSTEM::WAIT(0);
}

void func_287()//Position - 0x33132
{
	NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, -1);
	func_290(&uLocal_93, joaat("nimbus"), "Plane_1");
	func_54(&uLocal_93, 1);
	func_288(&uLocal_93, -1249.1444f, -3200.4622f, 13.5621f, 1.8349f, -0.2505f, 59.0838f, "hs4_lsa_take_nimb2", 0, 0, 1, 0);
}

void func_288(var uParam0, struct<3> Param1, struct<3> Param2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x33183
{
...
void func_289(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x331B3
{
	uParam0->f_1 = uParam1;
	uParam0->f_2 = uParam3;
...
void func_290(var uParam0, int iParam1, char* sParam2)//Position - 0x331E0
{
