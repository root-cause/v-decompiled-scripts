	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		switch (iParam0->f_6)
		{
			case 0:
				...
				else if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(func_216()) > 0)
				{
					iParam0->f_295 = 1;
				}
				...
				if (!func_213(&(iParam0->f_15)))
				{
					func_212(&(iParam0->f_15), 0, 0);
				}
				...
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					*iParam0 = 0;
					...
					func_190(1, 0);
					func_161(1, 1);
					if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_intro")) < 1 || !func_160())
					{
						if (iParam0->f_292)
						{
							if (func_159() == 0)
			...
			case 2:
				if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
				{
					if (!BitTest(*iParam0, 4))
					{
						...
						{
							STREAMING::CLEAR_FOCUS();
							STREAMING::NEW_LOAD_SCENE_START(754.2219f, 1226.8309f, 356.5081f, func_136(-14.367f, 0f, 157.3524f), 100f, 0);
							func_135(&(iParam0->f_17));
							func_212(&(iParam0->f_17), 0, 0);
			...
			case 19:
				...
				func_95(iParam0);
				func_132(iParam0, 19);
				if (func_130(iParam0, 19, 0) && BitTest(iParam0->f_3, 0))
				{
			...
			case 28:
				...
				func_132(iParam0, 28);
				if ((AUDIO::PREPARE_MUSIC_EVENT("FM_INTRO_DRIVE_START") && BitTest(iParam0->f_3, 3)) && func_130(iParam0, 28, 0))
				{
					iParam0->f_6 = 29;
				}
				break;
			...
			case 50:
				...
				if (func_130(iParam0, 50, 0) && BitTest(*iParam0, 20))
				{
...
void func_2(int* iParam0)//Position - 0x37E6
{
	int iVar0;
...
void func_3(bool bParam0)//Position - 0x383C
{
	if (bParam0)
	{
...
void func_5(int* iParam0)//Position - 0x38D8
{
	struct<3> Var0;
...
void func_6(var uParam0, bool bParam1)//Position - 0x3945
{
	struct<3> Var0;
	float fVar1;
...
void func_7(int iParam0, var uParam1, var uParam2)//Position - 0x39FA
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
float func_8(int* iParam0)//Position - 0x3C30
{
	float fVar0;
	float fVar1;
...
void func_9(int* iParam0)//Position - 0x3CAD
{
	if (BitTest(*iParam0, 29))
	{
...
void func_10(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x3D2C
{
	int iVar0;
	
	if (func_13())
	{
		iVar0 = Global_2848280[iParam0 /*3*/][func_11(iParam2)];
		if (iVar0 != 0)
		{
...
int func_11(var uParam0)//Position - 0x3D5E
{
	int iVar0;
	int iVar1;
...
int func_12()//Position - 0x3D92
{
	return Global_1574918;
}

int func_13()//Position - 0x3D9E
{
	return 1;
	return 0;
}

void func_14(int* iParam0, bool bParam1, bool bParam2)//Position - 0x3DAB
{
...
void func_15(int iParam0)//Position - 0x4007
{
	Global_2803653.f_1072 = iParam0;
}

void func_16()//Position - 0x4018
{
	func_17(0);
}

void func_17(bool bParam0)//Position - 0x4025
{
	if (bParam0)
	{
		func_24();
...
void func_18(int iParam0)//Position - 0x4088
{
	if (func_22())
	{
		return;
...
void func_20(bool bParam0, bool bParam1)//Position - 0x4139
{
	if (bParam0)
	{
		if (func_23(0))
...
bool func_21()//Position - 0x41AD
{
	return BitTest(Global_1962996, 5);
}

bool func_22()//Position - 0x41BB
{
	return BitTest(Global_1962996, 19);
}

int func_23(int iParam0)//Position - 0x41CA
{
	if (iParam0 == 1)
	{
...
void func_27(int* iParam0)//Position - 0x4281
{
	int iVar0;
...
int func_29(int* iParam0, int iParam1, bool bParam2)//Position - 0x42FC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_30(int iParam0)//Position - 0x437F
{
	switch (iParam0)
	{
		case 6:
...
int func_31(int iParam0)//Position - 0x455E
{
	switch (iParam0)
	{
		case 6:
...
int func_32(int* iParam0)//Position - 0x473D
{
	int iVar0;
	int iVar1;
...
void func_33(int* iParam0, int iParam1)//Position - 0x4863
{
...
void func_34(bool bParam0)//Position - 0x48A1
{
	if (bParam0)
	{
...
bool func_35(int iParam0)//Position - 0x48D7
{
	return BitTest(Global_1853910[iParam0 /*862*/].f_143, 22);
}

void func_36(bool bParam0)//Position - 0x48ED
{
	if (bParam0)
	{
...
int func_37(int* iParam0)//Position - 0x4921
{
	if (iParam0->f_6 < 31)
	{
...
void func_38(int* iParam0, float fParam1)//Position - 0x495D
{
	func_39(iParam0->f_34, 7, "FMINTRO", fParam1, 1);
}

void func_39(int iParam0, int iParam1, char* sParam2, float fParam3, bool bParam4)//Position - 0x4975
{
	int iVar0;
...
void func_40(int* iParam0, float fParam1)//Position - 0x49F5
{
	func_39(iParam0->f_34, 6, "FMINTRO", fParam1, 1);
}

void func_41(int* iParam0)//Position - 0x4A0D
{
	int iVar0;
	int iVar1;
...
bool func_42(int iParam0)//Position - 0x4A42
{
	if (iParam0 == 0)
	{
		return 1;
...
void func_43(int* iParam0)//Position - 0x4A60
{
	int iVar0;
...
int func_44(int* iParam0)//Position - 0x4AAF
{
	int iVar0;
...
bool func_45(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x4E84
{
...
int func_46(char* sParam0, int iParam1, bool bParam2)//Position - 0x4ED8
{
	Global_21726 = 0;
...
bool func_49(int iParam0)//Position - 0x5240
{
	return func_50(iParam0, 20);
}

var func_50(int iParam0, int iParam1)//Position - 0x5250
{
	return BitTest(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

int func_51()//Position - 0x5268
{
	return -1;
}

void func_52()//Position - 0x5271
{
	int iVar0;
...
var func_56()//Position - 0x5473
{
	func_57();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_57()//Position - 0x548C
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_60(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_59(PLAYER::PLAYER_PED_ID());
			if (func_58(iVar0) && (!func_62(14) || Global_112599))
			{
				if (Global_113648.f_2365.f_539.f_4321 != iVar0 && func_58(Global_113648.f_2365.f_539.f_4321))
				{
...
bool func_58(int iParam0)//Position - 0x5589
{
	return iParam0 < 3;
}

int func_59(int iParam0)//Position - 0x5595
{
	int iVar0;
	int iVar1;
...
int func_60(int iParam0)//Position - 0x55D2
{
	if (func_58(iParam0))
	{
...
var func_61(int iParam0)//Position - 0x55F7
{
	return Global_2028[iParam0 /*29*/];
}

bool func_62(int iParam0)//Position - 0x5606
{
	return Global_43257 == iParam0;
}

void func_63()//Position - 0x5614
{
	int iVar0;
...
bool func_64(int iParam0, int iParam1)//Position - 0x566C
{
	switch (iParam0)
	{
		case 5:
...
void func_66(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x56FB
{
...
int func_68(int* iParam0)//Position - 0x582C
{
	int iVar0;
	struct<3> Var1;
	float fVar2;
...
int func_69()//Position - 0x59D8
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

void func_70(int* iParam0)//Position - 0x59E8
{
	int iVar0;
...
void func_71(int* iParam0)//Position - 0x5A49
{
	int iVar0;
...
int func_72(int* iParam0)//Position - 0x5AE7
{
	if (func_87(iParam0))
	{
...
int func_73(int* iParam0)//Position - 0x5B54
{
	int iVar0;
...
void func_74(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x5C1B
{
...
void func_75(int* iParam0, float fParam1)//Position - 0x5CB6
{
	func_39(iParam0->f_34, 5, "FMINTRO", fParam1, 0);
}

void func_76(int* iParam0)//Position - 0x5CCE
{
	int iVar0;
...
void func_77(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x5D0C
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_81(PLAYER::PLAYER_ID())) && !func_79(PLAYER::PLAYER_ID(), 0)) && !func_78()) && !bParam4) && !bParam5) && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
...
bool func_78()//Position - 0x5E59
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_79(int iParam0, int iParam1)//Position - 0x5E73
{
	bool bVar0;
...
int func_80(int iParam0, bool bParam1)//Position - 0x5EBE
{
	int iVar0;
	int iVar1;
...
int func_81(int iParam0)//Position - 0x5EFF
{
...
bool func_82()//Position - 0x5F3E
{
	return BitTest(Global_2621446, 3);
}

int func_83(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x5F4C
{
	int iVar0;
...
void func_84(int iParam0)//Position - 0x5F7F
{
	if (iParam0 == 1)
	{
...
void func_85(int* iParam0)//Position - 0x5FA2
{
	int iVar0;
...
char* func_86(int iParam0)//Position - 0x5FEF
{
	switch (iParam0)
	{
		case 0:
...
int func_87(int* iParam0)//Position - 0x6072
{
	if (iParam0->f_295)
	{
		return func_88();
...
int func_88()//Position - 0x6091
{
	return func_89(PLAYER::PLAYER_ID());
}

int func_89(int iParam0)//Position - 0x60A1
{
...
int func_90()//Position - 0x60C0
{
	return joaat("S_M_Y_XMech_02");
}

void func_91(int* iParam0, int iParam1)//Position - 0x60CD
{
...
int func_92(int iParam0)//Position - 0x6116
{
	switch (iParam0)
	{
		case 0:
...
void func_94(int* iParam0)//Position - 0x61ED
{
	var uVar0;
	int iVar1;
...
void func_95(int* iParam0)//Position - 0x6298
{
...
void func_96(int* iParam0)//Position - 0x62F0
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_49[2]))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0->f_49[2], false))
...
void func_98(int* iParam0, char* sParam1, char* sParam2, int iParam3, struct<3> Param4, struct<3> Param5)//Position - 0x6353
{
...
void func_99(int* iParam0)//Position - 0x63CE
{
...
int func_101(int* iParam0)//Position - 0x6473
{
	int iVar0;
	struct<3> Var1;
...
void func_102(var uParam0, int iParam1)//Position - 0x6673
{
	switch (iParam1)
	{
		case 0:
...
int func_103(var uParam0, int iParam1)//Position - 0x6FAD
{
...
int func_104(int iParam0, bool bParam1, bool bParam2)//Position - 0x6FE8
{
	int iVar0;
...
int func_105(var uParam0, int iParam1)//Position - 0x7048
{
...
void func_106(var uParam0)//Position - 0x709B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_107(int iParam0)//Position - 0x710A
{
	switch (iParam0)
	{
		case 0:
...
int func_108(int* iParam0)//Position - 0x7175
{
	int iVar0;
	int iVar1;
...
void func_109(int* iParam0)//Position - 0x733F
{
	int iVar0;
...
int func_110(var uParam0)//Position - 0x73E0
{
	int iVar0;
...
int func_111(var uParam0)//Position - 0x75CE
{
	int iVar0;
	struct<3> Var1;
	float fVar2;
				...
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_49[bVar3]))
				{
					...
					if (STREAMING::IS_MODEL_IN_CDIMAGE(iVar0))
					{
						if (STREAMING::HAS_MODEL_LOADED(iVar0))
						{
							...
							ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(uParam0->f_49[bVar3], true);
							VEHICLE::SET_VEHICLE_DIRT_LEVEL(uParam0->f_49[bVar3], 0f);
							VEHICLE::SET_VEHICLE_NOT_STEALABLE_AMBIENTLY(uParam0->f_49[bVar3], false);
							if (bVar3 == 2)
							{
...
int func_112(var uParam0, bool bParam1)//Position - 0x7731
{
	switch (bParam1)
	{
		case 0:
...
void func_113(var uParam0, int iParam1)//Position - 0x7BE6
{
	switch (iParam1)
	{
		case 0:
...
void func_114(var uParam0, int iParam1)//Position - 0x7E2D
{
	switch (iParam1)
	{
		case 0:
...
bool func_115(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x7F4A
{
	if (bParam2)
	{
...
void func_116(int iParam0, var uParam1, var uParam2)//Position - 0x7F91
{
	switch (iParam0)
	{
		case 0:
...
void func_117()//Position - 0x80C2
{
	STREAMING::REQUEST_MODEL(func_90());
	STREAMING::REQUEST_ANIM_DICT(func_118());
}

char* func_118()//Position - 0x80DA
{
	return "MP_INTRO_SEQ@";
}

void func_119()//Position - 0x80E6
{
	int iVar0;
...
void func_120(int* iParam0, float fParam1, float fParam2)//Position - 0x810B
{
...
void func_121(int* iParam0, int iParam1)//Position - 0x8170
{
	bool bVar0;
	int* iVar1;
	...
	{
		case 14:
			func_122(iParam0, 0, -2997.1738f, 330.9234f, 14.2341f, -15.97f, &iVar1, 1);
			func_122(iParam0, 2, -2983.9001f, 423.7414f, 14.4122f, -5.25f, &iVar1, 1);
			break;
		
		case 15:
			func_122(iParam0, 1, -2622.2075f, -109.3386f, 19.2643f, 39.34f, &iVar1, 1);
			func_122(iParam0, 3, -2583.9497f, -143.6469f, 20.6224f, 48.89f, &iVar1, 1);
			func_122(iParam0, 7, -2552.1448f, -169.0495f, 19.8664f, 60.04f, &iVar1, 1);
			func_122(iParam0, 8, -2531.4744f, -174.4581f, 19.2269f, 58.09f, &iVar1, 1);
			break;
		...
		case 17:
			func_122(iParam0, 0, -2420.6177f, -232.2668f, 15.3525f, 57.71f, &iVar1, 1);
			func_122(iParam0, 2, -2399.7092f, -249.2471f, 14.9551f, 58.19f, &iVar1, 1);
			...
			func_122(iParam0, 9, -2408.7327f, -238.8328f, 15.2055f, 59.84f, &iVar1, 1);
			break;
		...
		case 18:
			...
			func_122(iParam0, 8, -2191.4287f, -335.8769f, 12.7225f, 84.71f, &iVar1, 1);
			break;
		
		case 19:
			func_122(iParam0, 0, -1833.8702f, -561.7711f, 11.0989f, 48.11f, &iVar1, 1);
			func_122(iParam0, 1, -1630.5872f, -685.6821f, 16.5351f, 58.23f, &iVar1, 1);
			...
			func_122(iParam0, 4, -1706.5074f, -720.8959f, 9.6281f, -132.94f, &iVar1, 1);
			func_122(iParam0, 5, -1626.756f, -769.9745f, 10.2367f, -128.8f, &iVar1, 1);
			func_122(iParam0, 6, -1782.7637f, -610.5726f, 10.3008f, 52.34f, &iVar1, 1);
			func_122(iParam0, 7, -1595.258f, -733.587f, 10.8576f, 68.39f, &iVar1, 1);
			func_122(iParam0, 8, -1751.8918f, -682.1017f, 9.6795f, -134.89f, &iVar1, 1);
			func_122(iParam0, 9, -1742.0983f, -642.5658f, 9.8169f, 48.19f, &iVar1, 1);
			break;
		
		case 33:
			func_122(iParam0, 0, -934.4687f, -2716.0378f, 12.7365f, 309.2312f, &iVar1, 0);
			func_122(iParam0, 5, -975.6617f, -2733.5168f, 12.8172f, 267.4944f, &iVar1, 0);
			break;
		...
		case 38:
			func_122(iParam0, 0, -712.0925f, -1983.5159f, 25.688f, -167.99f, &iVar1, 0);
			func_122(iParam0, 1, -533.9934f, -2004.7274f, 26.9085f, 58.71f, &iVar1, 0);
			func_122(iParam0, 2, -653.3551f, -2047.7823f, 27.3566f, -112.14f, &iVar1, 0);
			func_122(iParam0, 3, -663.821f, -1934.8499f, 27.1417f, -121.65f, &iVar1, 0);
			func_122(iParam0, 4, -656.6017f, -2009.0784f, 30.0188f, -106.53f, &iVar1, 0);
			func_122(iParam0, 5, -502.696f, -2023.0684f, 26.2376f, 60.2827f, &iVar1, 0);
			func_122(iParam0, 6, -460.1447f, -2044.032f, 26.2371f, 63.9022f, &iVar1, 0);
			func_122(iParam0, 7, -624.7944f, -1960.9753f, 26.29f, 237.3848f, &iVar1, 0);
			func_122(iParam0, 8, -463.0545f, -1998.2552f, 36.6533f, 27.85f, &iVar1, 0);
			func_122(iParam0, 9, -473.4099f, -1950.2133f, 24.7576f, 37.16f, &iVar1, 0);
			func_122(iParam0, 10, -574.5834f, -1994.9f, 26.2871f, 236.0571f, &iVar1, 0);
			func_122(iParam0, 11, -546.7894f, -2012.7808f, 26.3137f, 235.9205f, &iVar1, 0);
			func_122(iParam0, 12, -584.929f, -1970.3323f, 26.2437f, 55.8826f, &iVar1, 0);
			func_122(iParam0, 13, -633.4936f, -1937.6824f, 26.2413f, 54.9911f, &iVar1, 0);
			func_122(iParam0, 14, -601.2188f, -1941.4187f, 17.4986f, 148.6622f, &iVar1, 0);
			break;
		
		case 39:
			func_122(iParam0, 4, -499.2335f, -1906.5316f, 16.3534f, 133.5751f, &iVar1, 0);
			func_122(iParam0, 9, -518.8654f, -1918.1439f, 16.3355f, 134.6305f, &iVar1, 0);
			break;
		
		case 40:
			func_122(iParam0, 3, -270.2197f, -1499.7521f, 29.4309f, -13.07f, &iVar1, 0);
			func_122(iParam0, 7, -313.1461f, -1559.5889f, 24.2966f, 145.66f, &iVar1, 0);
			func_122(iParam0, 8, -301.9485f, -1550.0525f, 25.5595f, 146.95f, &iVar1, 0);
			break;
...
void func_122(var uParam0, int iParam1, struct<3> Param2, float fParam3, int* iParam4, bool bParam5)//Position - 0x8B3C
{
...
void func_123(int* iParam0, char* sParam1, char* sParam2, struct<3> Param3, struct<3> Param4, float fParam5, float fParam6)//Position - 0x8C60
{
	if (!CAM::DOES_CAM_EXIST(iParam0->f_8))
	{
		iParam0->f_8 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
...
void func_124(int* iParam0)//Position - 0x8CD1
{
...
int func_125(int* iParam0)//Position - 0x8CFF
{
	bool bVar0;
	int iVar1;
...
int func_128(int* iParam0)//Position - 0x91C0
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
void func_129(char* sParam0, int iParam1)//Position - 0x9358
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, false, iParam1);
}

int func_130(int* iParam0, int iParam1, int iParam2)//Position - 0x936F
{
	int iVar0;
...
int func_131(int* iParam0)//Position - 0x93B5
{
	int iVar0;
...
void func_132(int* iParam0, int iParam1)//Position - 0x9471
{
...
void func_133(int* iParam0)//Position - 0x94A8
{
	iParam0->f_13 = MISC::GET_GAME_TIMER();
}

int func_134(var uParam0, int iParam1, bool bParam2)//Position - 0x94B8
{
	if (iParam1 == -1)
	{
		return 1;
...
void func_135(var uParam0)//Position - 0x9516
{
	uParam0->f_1 = 0;
}

Vector3 func_136(struct<3> Param0)//Position - 0x9523
{
	return (-SYSTEM::SIN(Param0.f_2) * SYSTEM::COS(Param0.f_0)), (SYSTEM::COS(Param0.f_2) * SYSTEM::COS(Param0.f_0)), SYSTEM::SIN(Param0.f_0);
}

int func_137()//Position - 0x9550
{
	return Global_1574993;
}

void func_138()//Position - 0x955C
{
...
void func_139(int iParam0)//Position - 0x95B8
{
	Global_2793044.f_4628 = iParam0;
}

void func_140()//Position - 0x95C9
{
	func_18(0);
	func_17(1);
}

bool func_141()//Position - 0x95DB
{
	return func_142();
}

int func_142()//Position - 0x95E7
{
	return func_19();
}

void func_143(bool bParam0, bool bParam1, bool bParam2)//Position - 0x95F3
{
	func_148();
	func_146(1);
	HUD::CLEAR_HELP(true);
...
void func_144(int iParam0, bool bParam1, int iParam2)//Position - 0x9660
{
	switch (iParam0)
	{
		case 5:
...
void func_146(bool bParam0)//Position - 0x9706
{
	int iVar0;
...
void func_147(int iParam0)//Position - 0x9734
{
...
void func_151(int iParam0)//Position - 0x9846
{
...
void func_152(int iParam0, bool bParam1)//Position - 0x9861
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
int func_153(int iParam0)//Position - 0x990D
{
	struct<2> Var0;
...
struct<2> func_154(int iParam0)//Position - 0x993E
{
	struct<2> Var0;
...
void func_155(int iParam0, bool bParam1)//Position - 0x996B
{
	struct<2> Var0;
...
var func_156(int iParam0, int iParam1)//Position - 0x99AE
{
	struct<5> Var0;
...
struct<5> func_157(int iParam0)//Position - 0x99D3
{
	struct<5> Var0;
	struct<3> Var1;
...
struct<6> func_158(int iParam0, bool bParam1)//Position - 0xC2FF
{
	struct<6> Var0;
...
int func_159()//Position - 0xCEB5
{
	return Global_2695821;
}

bool func_160()//Position - 0xCEC1
{
	return Global_2694522;
}

void func_161(bool bParam0, bool bParam1)//Position - 0xCECD
{
	if (bParam1)
	{
...
void func_162(int iParam0)//Position - 0xCEF8
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	if (Global_1575060)
	{
		sVar1 = func_183(iParam0);
		iVar2 = MISC::GET_HASH_KEY(sVar1);
		uVar3 = func_182(&Global_2696935, 1, 0);
		func_181(&Global_2696933, 1, 0);
...
int func_165()//Position - 0xCF9B
{
	...
	if (Global_2684799.f_6618 && Global_2694444)
	{
		if (func_170(0))
		{
			if (func_168() && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				{
					iVar0 = func_167(Global_2684799.f_6640);
					if (iVar0 == 24)
					{
						return 1;
					}
...
bool func_166()//Position - 0xD0BF
{
	return Global_2683862.f_24;
}

int func_167(int iParam0)//Position - 0xD0CD
{
	switch (iParam0)
	{
		case 0:
...
int func_169()//Position - 0xD596
{
	return Global_1574632.f_18;
}

int func_170(int iParam0)//Position - 0xD5A4
{
	if (func_180(PLAYER::PLAYER_ID()) && BitTest(Global_1950108.f_4, 22))
	{
		return 0;
	}
	if (Global_1577872)
	...
	if ((Global_2694445 && func_178()) || Global_2694445 == 0)
	{
		return 1;
	}
	...
	if (Global_2694449)
	{
		if (iParam0 == 0)
		{
			if ((Global_2684799.f_6640 == 123 || (Global_2684799.f_6640 == 124 && func_176() == 1)) || Global_2684799.f_6640 == 125)
			{
				return 1;
			}
		}
	}
	if ((Global_2684799.f_6618 || func_174(-1046478848)) && Global_2694450)
	{
		if (iParam0 == 0)
		{
			return 1;
...
var func_171()//Position - 0xD701
{
	return func_172(PLAYER::PLAYER_ID());
}

var func_172(int iParam0)//Position - 0xD711
{
	return func_173(&(Global_2657589[iParam0 /*466*/].f_445), 0);
}

var func_173(var uParam0, int iParam1)//Position - 0xD72A
{
	return BitTest(*uParam0, iParam1);
}

int func_174(float fParam0)//Position - 0xD738
{
	struct<3> Var0;
...
Vector3 func_175(int iParam0)//Position - 0xD787
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_176()//Position - 0xD79A
{
	return func_177(PLAYER::PLAYER_ID());
}

int func_177(int iParam0)//Position - 0xD7AA
{
	return MISC::GET_BITS_IN_RANGE(Global_2657589[iParam0 /*466*/].f_321.f_3, 28, 31);
}

var func_178()//Position - 0xD7C7
{
...
int func_180(int iParam0)//Position - 0xD7ED
{
	if (iParam0 != func_51())
	{
		if (func_104(iParam0, 1, 1))
		{
			...
			{
				return func_167(Global_2657589[iParam0 /*466*/].f_321.f_7) == 13;
			}
		}
	}
	return 0;
...
void func_181(var uParam0, bool bParam1, bool bParam2)//Position - 0xD834
{
...
int func_182(var uParam0, bool bParam1, bool bParam2)//Position - 0xD871
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
	{
		if (!bParam2)
...
char* func_183(int iParam0)//Position - 0xD8B8
{
	switch (iParam0)
	{
		case 0:
...
void func_184(int iParam0)//Position - 0xDC59
{
	var uVar0;
...
var func_185()//Position - 0xDC6D
{
	return Global_1574992;
}

void func_186(bool bParam0, bool bParam1)//Position - 0xDC79
{
	int iVar0;
	
	func_188(&Global_23051, bParam1);
	GRAPHICS::DONT_RENDER_IN_GAME_UI(false);
	iVar0 = 1;
	if (bParam0)
	{
...
void func_187(int iParam0)//Position - 0xDCDE
{
	if (iParam0 == 0)
	{
		Global_2696911 = 0;
...
void func_188(var uParam0, bool bParam1)//Position - 0xDCF9
{
	uParam0->f_15 = 0;
	uParam0->f_16 = 0;
	uParam0->f_17 = 0;
...
void func_189(int iParam0)//Position - 0xDD71
{
	Global_23129 = iParam0;
}

void func_190(bool bParam0, int iParam1)//Position - 0xDD7E
{
	if (bParam0)
	{
		func_195(1, 0, 1);
...
void func_191(int iParam0)//Position - 0xDD9B
{
	func_194();
	if (iParam0 == 0)
	{
	...
	if (func_193() == 0 || HUD::IS_PAUSE_MENU_ACTIVE())
	{
		func_192(1);
...
void func_192(int iParam0)//Position - 0xDDDC
{
...
int func_193()//Position - 0xDDF7
{
	return Global_1574632.f_20;
}

void func_194()//Position - 0xDE05
{
	Global_2696215 = 1;
}

void func_195(int iParam0, bool bParam1, bool bParam2)//Position - 0xDE12
{
	if (func_196())
	{
		return;
	}
	if ((func_193() == 1 || HUD::IS_PAUSE_MENU_ACTIVE()) || iParam0)
	{
		func_192(0);
...
void func_198(bool bParam0)//Position - 0xDE8B
{
	if (bParam0)
	{
...
void func_199(bool bParam0)//Position - 0xDEFF
{
	int iVar0;
...
void func_200(int iParam0)//Position - 0xDF36
{
	Global_100733.f_202[iParam0] = 1;
	Global_100733.f_201 = 1;
}

void func_201(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xDF50
{
	int iVar0;
	...
	func_202(PLAYER::PLAYER_ID(), 0, iVar0, 0);
	if (bParam5)
	{
...
void func_202(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xDFDF
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (bParam1)
			{
				...
				if (!func_206(iVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar27))
				{
					if (!bVar22)
					{
...
bool func_203(int iParam0)//Position - 0xE46D
{
	return iParam0 == 17;
}

void func_204()//Position - 0xE47A
{
	struct<3> Var0;
...
int func_206(int iParam0)//Position - 0xE505
{
	int iVar0;
...
void func_207(bool bParam0, int iParam1, int iParam2)//Position - 0xE536
{
	int iVar0;
	int iVar1;
...
void func_208(int iParam0, bool bParam1)//Position - 0xE606
{
	int iVar0;
...
void func_211()//Position - 0xE6AB
{
	Global_23131.f_5 = 1;
}

void func_212(var uParam0, bool bParam1, bool bParam2)//Position - 0xE6B9
{
	if (uParam0->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
...
bool func_213(var uParam0)//Position - 0xE6FE
{
	return uParam0->f_1;
}

void func_214(bool bParam0)//Position - 0xE70A
{
	if (bParam0)
	{
...
void func_217(int iParam0)//Position - 0xE7A3
{
	PED::SET_PED_RESET_FLAG(PLAYER::GET_PLAYER_PED(iParam0), 346, true);
}

void func_218(int* iParam0)//Position - 0xE7B9
{
					...
					switch (iParam0->f_5)
					{
						case 0:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 33)
								{
									...
									{
										func_223("artdir", 0f, 420f, "left", 0.3f, 0.3f);
									}
									else
									{
										func_223("artdir", 0f, 450f, "left", 0.3f, 0.3f);
									}
									func_222("artdir", "Art Director", 175f, "HUD_COLOUR_FRIENDLY", 1);
									func_221("artdir", "AARON GARBUT", 210f, "|", 1);
									func_220("artdir", 0.16f);
						...
						case 1:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								...
								{
									func_223("techdir", 0f, 30f, "left", 0.3f, 0.3f);
									func_222("techdir", "Technical Director", 100f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_221("techdir", "ADAM FOWLER", 185f, "|", 1);
									func_220("techdir", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 2:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 35)
								{
									func_223("assartdir", 0f, 100f, "left", 0.3f, 0f);
									func_222("assartdir", "Associate Art Directors", 20f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_221("assartdir", "ADAM COCHRANE|MICHAEL KANE", 100f, "|", 1);
									func_220("assartdir", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (iParam0->f_6 > 35)
							{
								func_219("assartdir", 0f);
								iParam0->f_5++;
							}
							break;
						...
						case 3:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 36)
								{
									if (((LOCALIZATION::GET_CURRENT_LANGUAGE() == 9 || LOCALIZATION::GET_CURRENT_LANGUAGE() == 10) || LOCALIZATION::GET_CURRENT_LANGUAGE() == 8) || LOCALIZATION::GET_CURRENT_LANGUAGE() == 12)
									{
										func_223("asstecdir", 0f, 370f, "right", 0.3f, 0.3f);
									}
									else
									{
										func_223("asstecdir", 0f, 400f, "right", 0.3f, 0.3f);
									}
									func_222("asstecdir", "Associate Technical Directors", 0f, "HUD_COLOUR_NET_PLAYER3", 1);
									func_221("asstecdir", "KLAAS SCHILSTRA|PHIL HOOKER", 150f, "|", 1);
									func_220("asstecdir", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 4:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								...
								{
									func_223("leadprog", 30f, 20f, "right", 0.3f, 0.3f);
									func_222("leadprog", "Lead Programmers", 0f, "HUD_COLOUR_FRIENDLY", 1);
									func_221("leadprog", "DANIEL YELLAND|ROBERT TRICKEY", 145f, "|", 1);
									func_220("leadprog", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 5:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 37)
								{
									if (((LOCALIZATION::GET_CURRENT_LANGUAGE() == 9 || LOCALIZATION::GET_CURRENT_LANGUAGE() == 10) || LOCALIZATION::GET_CURRENT_LANGUAGE() == 8) || LOCALIZATION::GET_CURRENT_LANGUAGE() == 12)
									{
										func_223("senprog", 0f, 200f, "left", 0.3f, 0.3f);
									}
									else
									{
										func_223("senprog", 0f, 225f, "left", 0.3f, 0.3f);
									}
									func_222("senprog", "Senior Programmers", 20f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_221("senprog", "JOHN HYND|JOHN GURNEY|DAN CONTI|ROSS CHILDS|STEPHEN LaVALLEY", 75f, "|", 1);
									func_220("senprog", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 6:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 38)
								{
									func_223("prog", 0f, 100f, "left", 0.3f, 0.3f);
									func_222("prog", "Programmers", 35f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_221("prog", "MIGUEL FREITAS|STUART ROSKELL|ALLAN WALTON|PAU AGUILAR FRUTO", 100f, "|", 1);
									func_220("prog", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 7:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (func_130(iParam0, 38, -3240))
								{
									if (((LOCALIZATION::GET_CURRENT_LANGUAGE() == 9 || LOCALIZATION::GET_CURRENT_LANGUAGE() == 10) || LOCALIZATION::GET_CURRENT_LANGUAGE() == 8) || LOCALIZATION::GET_CURRENT_LANGUAGE() == 12)
									{
										func_223("socclub", 40f, 305f, "right", 0.3f, 0.3f);
									}
									else
									{
										func_223("socclub", 40f, 325f, "right", 0.3f, 0.3f);
									}
									func_222("socclub", "Social Club", 0f, "HUD_COLOUR_NET_PLAYER3", 1);
									func_221("socclub", "IAN McFARLAND|KEVIN BACA", 40f, "|", 1);
									func_220("socclub", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 8:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 39)
								{
									func_223("audio", 0f, 10f, "right", 0.3f, 0.3f);
									func_222("audio", "Audio", 0f, "HUD_COLOUR_FRIENDLY", 1);
									func_221("audio", "MATTHEW SMITH|CRAIG CONNER|ALASTAIR MacGREGOR|JEFFREY WHITCHER", 35f, "|", 1);
									func_220("audio", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 9:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 40)
								{
									func_223("scrlead", 50f, 85f, "right", 0.3f, 0.3f);
									func_222("scrlead", "Script Leads", 0f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_221("scrlead", "BOBBY WRIGHT|KEITH McLEMAN|BRENDA CAREY|ROWAN COCKCROFT|NEIL FERGUSON|RYAN BAKER", 60f, "|", 1);
									func_220("scrlead", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 10:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 41)
								{
									func_223("script1", 0f, 10f, "left", 0.3f, 0.3f);
									func_222("script1", "Scripters", 20f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_221("script1", "CONOR McGUIRE|JAMES ADWICK|DAVID WATSON|NEIL BEGGS|WILLIAM KENNEDY", 80f, "|", 1);
									func_220("script1", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 11:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 42)
								{
									func_223("script2", 0f, 10f, "left", 0.3f, 0.3f);
									func_222("script2", "Scripters", 20f, "HUD_COLOUR_NET_PLAYER3", 1);
									func_221("script2", "DAVID GENTLES|BEN HINCHLIFFE|KEVIN WONG|CHRISTOPHER SPEIRS|CHRIS McMAHON", 80f, "|", 1);
									func_220("script2", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 12:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 43)
								{
									func_223("visdes", 0f, 45f, "left", 0.2f, 0.2f);
									func_222("visdes", "Visual Design", 30f, "HUD_COLOUR_FRIENDLY", 1);
									func_221("visdes", "THOMAS DIAKOMICHALIS|KARMEN COKER|LUKE HOWARD| | |", 67f, "|", 1);
									func_222("visdes", "Character Creator", 100f, "HUD_COLOUR_FRIENDLY", 1);
									func_221("visdes", "STUART HANSELL|STEWART WRIGHT|FLAVIUS ALECU", 147f, "|", 1);
									func_220("visdes", 0.05f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 13:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 44)
								{
									func_223("uides", 40f, 20f, "right", 0f, 0.3f);
									func_222("uides", "UI Design & Development", 0f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_221("uides", "STUART PETRI|STEVE WALSH|GARETH EVANS|JEFFREY KHAN|CHRIS EDWARDS", 110f, "|", 1);
									func_220("uides", 0f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 14:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 46)
								{
									func_223("concre", 0f, 20f, "left", 0f, 0.3f);
									func_222("concre", "Content Creation", 40f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_221("concre", "CALLUM MUNGALL|CHRIS McCALLUM|JESSE HOLCROFT|JOE STAFFORD", 80f, "|", 1);
									func_221("concre", "JOSHUA MATTYASOVSZKY|MARTIN LOGAN|STEFAN WEBSTER", 80f, "|", 1);
									func_220("concre", 0f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 15:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 47)
								{
									func_223("devass", 0f, 400f, "right", 0f, 0f);
									func_222("devass", "Development Assistants", 0f, "HUD_COLOUR_NET_PLAYER3", 1);
									func_221("devass", "FIONN WRIGHT|KATIE PICA", 100f, "|", 1);
									func_220("devass", 0f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 16:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 48)
								{
									func_223("qasup", 20f, 0f, "right", 0.3f, 0.3f);
									func_222("qasup", "QA Supervisor", 0f, "HUD_COLOUR_FRIENDLY", 1);
									func_221("qasup", "ADAM WHITING| ", 50f, "|", 1);
									func_222("qasup", "Lead Test Analyst", 50f, "HUD_COLOUR_FRIENDLY", 1);
									func_221("qasup", "CHRIS THOMSON", 160f, "|", 1);
									func_220("qasup", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 17:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 49)
								{
									func_223("senta", 0f, 25f, "left", 0.3f, 0.3f);
									func_222("senta", "Senior Test Analysts", 30f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_221("senta", "MICHAEL BURTON|ROSS PARKER|SEAN CASEY", 120f, "|", 1);
									func_220("senta", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 18:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								...
								{
									func_223("asspro", 20f, 350f, "right", 0.3f, 0.3f);
									func_222("asspro", "Assistant Producer", 0f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_221("asspro", "JOSH NEEDLEMAN", 75f, "|", 1);
									func_220("asspro", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 19:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (func_87(iParam0))
								{
									...
									{
										func_223("animdir", 0f, 95f, "left", 0.3f, 0.3f);
										func_222("animdir", "Animation Director", 110f, "HUD_COLOUR_NET_PLAYER3", 1);
										func_221("animdir", "ROB NELSON", 200f, "|", 1);
										func_220("animdir", 0.16f);
										MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
									}
								}
								else if (iParam0->f_6 >= 50)
								{
									func_223("animdir", 50f, 90f, "right", 0.3f, 0.3f);
									func_222("animdir", "Animation Director", 0f, "HUD_COLOUR_NET_PLAYER3", 1);
									func_221("animdir", "ROB NELSON", 90f, "|", 1);
									func_220("animdir", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 20:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (func_87(iParam0))
								{
									...
									{
										func_223("producer", 65f, 55f, "right", 0f, 0f);
										func_222("producer", "Producer", 0f, "HUD_COLOUR_FRIENDLY", 1);
										func_221("producer", "ANDY DUTHIE", 20f, "|", 1);
										func_220("producer", 0f);
										MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
									}
								}
								else if (CUTSCENE::IS_CUTSCENE_PLAYING() && CUTSCENE::GET_CUTSCENE_TIME() > 2452)
								{
									func_223("producer", 0f, 100f, "left", 0.3f, 0f);
									func_222("producer", "Producer", 80f, "HUD_COLOUR_FRIENDLY", 1);
									func_221("producer", "ANDY DUTHIE", 110f, "|", 1);
									func_220("producer", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_87(iParam0))
						...
						case 21:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (func_87(iParam0))
								{
									...
									{
										func_223("vpcre", 65f, 55f, "right", 0.3f, 0.3f);
										func_222("vpcre", "VP of Creative", 0f, "HUD_COLOUR_NET_PLAYER1", 1);
										func_221("vpcre", "DAN HOUSER", 80f, "|", 1);
										func_220("vpcre", 0.16f);
										MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
									}
								}
								else if (CUTSCENE::IS_CUTSCENE_PLAYING() && CUTSCENE::GET_CUTSCENE_TIME() > 6921)
								{
									func_223("vpcre", 65f, 80f, "right", 0.3f, 0.3f);
									func_222("vpcre", "VP of Creative", 0f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_221("vpcre", "DAN HOUSER", 80f, "|", 1);
									func_220("vpcre", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
						...
						case 22:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (func_87(iParam0))
								{
									...
									{
										Global_1935679 = 0;
										func_223("execpro", 0f, 375f, "left", 0.3f, 0.3f);
										func_222("execpro", "Executive Producer", 70f, "HUD_COLOUR_NET_PLAYER2", 1);
										func_221("execpro", "SAM HOUSER", 165f, "|", 1);
										func_220("execpro", 0.16f);
										MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
									}
								}
								...
								{
									Global_1935679 = 0;
									func_223("execpro", 0f, 340f, "left", 0.3f, 0.3f);
									func_222("execpro", "Executive Producer", 100f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_221("execpro", "SAM HOUSER", 190f, "|", 1);
									func_220("execpro", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
...
void func_219(char* sParam0, float fParam1)//Position - 0xFBCB
{
...
void func_220(char* sParam0, float fParam1)//Position - 0xFBFC
{
...
void func_221(char* sParam0, char* sParam1, float fParam2, char* sParam3, bool bParam4)//Position - 0xFC2D
{
...
void func_222(char* sParam0, char* sParam1, float fParam2, char* sParam3, bool bParam4)//Position - 0xFC88
{
...
void func_223(char* sParam0, float fParam1, float fParam2, char* sParam3, float fParam4, float fParam5)//Position - 0xFCE3
{
...
void func_224(int* iParam0)//Position - 0xFD38
{
