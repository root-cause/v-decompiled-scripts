...
void func_10(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x3D2C
{
	...
	if (func_13())
	{
		iVar0 = Global_2848282[iParam0 /*3*/][func_11(iParam2)];
		if (iVar0 != 0)
		{
...
void func_98(int* iParam0, char* sParam1, char* sParam2, int iParam3, struct<3> Param4, struct<3> Param7)//Position - 0x6353
{
...
bool func_115(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x7F4A
{
	if (bParam6)
	{
...
void func_122(var uParam0, int iParam1, struct<3> Param2, float fParam5, int* iParam6, bool bParam7)//Position - 0x8B3C
{
...
void func_123(int* iParam0, char* sParam1, char* sParam2, struct<3> Param3, struct<3> Param6, float fParam9, float fParam10)//Position - 0x8C60
{
	if (!CAM::DOES_CAM_EXIST(iParam0->f_8))
	{
		iParam0->f_8 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
...
void func_162(int iParam0)//Position - 0xCEF8
{
	...
	if (Global_1575060)
	{
		...
		uVar3 = func_182(&Global_2696937, 1, 0);
		func_181(&Global_2696935, 1, 0);
	...
	if (Global_2684801.f_6618 && Global_2694446)
	{
		if (func_170(0))
		{
			if (func_168() && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				{
					iVar0 = func_167(Global_2684801.f_6640);
					if (iVar0 == 24)
					{
						return 1;
					}
...
int func_170(int iParam0)//Position - 0xD5A4
{
	...
	if ((Global_2694447 && func_178()) || Global_2694447 == 0)
	{
		return 1;
	}
	...
	if (Global_2694451)
	{
		if (iParam0 == 0)
		{
			if ((Global_2684801.f_6640 == 123 || (Global_2684801.f_6640 == 124 && func_176() == 1)) || Global_2684801.f_6640 == 125)
			{
				return 1;
			}
		}
	}
	if ((Global_2684801.f_6618 || func_174(-1046478848)) && Global_2694452)
	{
		if (iParam0 == 0)
		{
			return 1;
