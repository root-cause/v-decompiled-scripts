...
void __EntryFunction__()//Position - 0x0
{
	...
	while (iVar0 < 9)
	{
		...
		else if (MISC::ARE_STRINGS_EQUAL(&(Global_113969.f_14054[Global_20930 /*20*/].f_11), &(Global_9605[Global_20930 /*2811*/][1 /*281*/].f_144[iVar0 /*6*/])))
		{
	...
	if (Global_79389)
	{
		...
		StringCopy(&(Global_9605[3 /*2811*/][0 /*281*/].f_2), "CELL_701" /* GXT: Snapmatic */, 16);
		Global_9605[3 /*2811*/][0 /*281*/].f_6 = 19;
		Global_9605[3 /*2811*/][0 /*281*/].f_280 = 1;
		StringCopy(&(Global_9605[3 /*2811*/][0 /*281*/].f_7[0 /*4*/]), "CELL_704" /* GXT: Quick launch Off */, 16);
		Global_9605[3 /*2811*/][0 /*281*/].f_124[0] = 1;
		Global_9605[3 /*2811*/][0 /*281*/].f_84[0] = 170;
		Global_9605[3 /*2811*/][0 /*281*/].f_104[0] = 19;
		StringCopy(&(Global_9605[3 /*2811*/][0 /*281*/].f_7[1 /*4*/]), "CELL_703" /* GXT: Quick launch On */, 16);
		Global_9605[3 /*2811*/][0 /*281*/].f_124[1] = 1;
		Global_9605[3 /*2811*/][0 /*281*/].f_84[1] = 175;
		Global_9605[3 /*2811*/][0 /*281*/].f_104[1] = 19;
		StringCopy(&(Global_9605[3 /*2811*/][0 /*281*/].f_7[2 /*4*/]), "CELL_801" /* GXT: Sleep Mode */, 16);
...
void func_12()//Position - 0x890
{
	...
	if (iLocal_41 == 1)
	{
		...
		if ((((func_10(2, Global_20906, 0) || func_10(2, Global_20907, 0)) || iLocal_49) || iLocal_63 == 1) || iLocal_64 == 1)
		{
			iLocal_63 = 0;
			iLocal_64 = 0;
			iLocal_49 = 0;
	...
	if (Global_20908 == 0)
	{
		if (func_10(2, Global_20899, 0))
		{
			...
			Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_259 = iLocal_16[iLocal_44];
			if (iLocal_41 == 2)
			{
				iVar0 = Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_259;
				...
				func_19();
				func_18(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iLocal_43), SYSTEM::TO_FLOAT(23), -1f, -1f, &(Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_7[iLocal_16[iLocal_43] /*4*/]), 0, 0, 0, 0);
				func_18(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iLocal_44), SYSTEM::TO_FLOAT(48), -1f, -1f, &(Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_7[iLocal_16[iLocal_44] /*4*/]), 0, 0, 0, 0);
				iLocal_43 = iLocal_44;
			...
			if (iLocal_41 == 4)
			{
				...
				if (Global_79389)
				{
					...
					if (Global_4543361 == 0)
					{
						...
						if ((NETWORK::NETWORK_CLAN_PLAYER_IS_ACTIVE(&Var17) && NETWORK::NETWORK_HAVE_USER_CONTENT_PRIVILEGES(0)) && Global_4543364 == 0)
						{
							SYSTEM::SETTIMERA(0);
			...
			if (iLocal_41 == 1)
			{
				...
				func_18(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iLocal_43), SYSTEM::TO_FLOAT(18), -1f, -1f, &(Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_7[iLocal_16[iLocal_43] /*4*/]), 0, 0, 0, 0);
				func_18(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iLocal_44), SYSTEM::TO_FLOAT(48), -1f, -1f, &(Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_7[iLocal_16[iLocal_44] /*4*/]), 0, 0, 0, 0);
				iLocal_43 = iLocal_44;
				func_47(Global_20911, "DISPLAY_VIEW", 22f, SYSTEM::TO_FLOAT(iLocal_44), -1082130432, -1082130432, -1082130432);
			}
			...
			if (iLocal_41 == 0)
			{
				if (Global_79389 == 1)
				{
					Global_9605[3 /*2811*/][iLocal_41 /*281*/].f_259 = iLocal_16[iLocal_44];
					func_18(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iLocal_43), SYSTEM::TO_FLOAT(19), -1f, -1f, &(Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_7[iLocal_16[iLocal_43] /*4*/]), 0, 0, 0, 0);
					func_18(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iLocal_44), SYSTEM::TO_FLOAT(48), -1f, -1f, &(Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_7[iLocal_16[iLocal_44] /*4*/]), 0, 0, 0, 0);
					iLocal_43 = iLocal_44;
					func_47(Global_20911, "DISPLAY_VIEW", 22f, SYSTEM::TO_FLOAT(iLocal_44), -1082130432, -1082130432, -1082130432);
					func_20(2092, Global_9605[3 /*2811*/][iLocal_41 /*281*/].f_259, -1, 1);
				}
				else
				{
					Global_9605[0 /*2811*/][iLocal_41 /*281*/].f_259 = iLocal_16[iLocal_44];
					Global_9605[1 /*2811*/][iLocal_41 /*281*/].f_259 = iLocal_16[iLocal_44];
					Global_9605[2 /*2811*/][iLocal_41 /*281*/].f_259 = iLocal_16[iLocal_44];
...
void func_28()//Position - 0x16F8
{
	...
	if (Global_79389)
	{
		StringCopy(&(Global_9605[3 /*2811*/][4 /*281*/].f_7[0 /*4*/]), "CELL_CREWEMB" /* GXT: Crew Emblem */, 16);
		Var21 = { func_17(PLAYER::PLAYER_ID()) };
		if (!NETWORK::NETWORK_CLAN_PLAYER_IS_ACTIVE(&Var21))
		{
			StringCopy(&(Global_9605[3 /*2811*/][4 /*281*/].f_7[0 /*4*/]), "CELL_840" /* GXT: Default */, 16);
		}
	}
	while (iVar20 < 19)
	{
		iVar34 = 0;
		iVar35 = 18;
		Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_84[iVar35] = 5000;
		while (iVar34 < 19)
		{
			if (Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_124[iVar34] == 1)
			{
				if (iVar0[iVar34] == 0)
				{
					if (Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_84[iVar34] < Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_84[iVar35])
					{
						iVar35 = iVar34;
						func_18(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iVar20), SYSTEM::TO_FLOAT(Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_104[iVar35]), -1f, -1f, &(Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_7[iVar35 /*4*/]), 0, 0, 0, 0);
					}
				}
			}
			iVar34++;
		...
		iVar0[iVar35] = 1;
		if (MISC::ARE_STRINGS_EQUAL(&(Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_7[Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_259 /*4*/]), &(Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_7[iVar35 /*4*/])))
		{
			iLocal_46 = iVar20;
			if (iLocal_46 < 0)
			{
			...
			{
				func_18(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iVar20), SYSTEM::TO_FLOAT(48), -1f, -1f, &(Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_7[iVar35 /*4*/]), 0, 0, 0, 0);
				iLocal_43 = iVar20;
			}
			if (iLocal_41 == 0 && Global_79389 == 1)
			{
				func_18(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iVar20), SYSTEM::TO_FLOAT(48), -1f, -1f, &(Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_7[iVar35 /*4*/]), 0, 0, 0, 0);
				iLocal_43 = iVar20;
			}
		}
		if (Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_124[iVar20] == 1)
		{
			iLocal_37++;
		}
		iVar20++;
	...
	if (Global_20918)
	{
		func_18(Global_20911, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205" /* GXT: SELECT */, 0, 0, 0, 0);
		func_18(Global_20911, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /* GXT: BACK */, 0, 0, 0, 0);
	}
	else
	{
...
void func_34()//Position - 0x1BAA
{
	...
	while (iVar21 < 9)
	{
		iVar22 = 0;
		iVar23 = 9;
		Global_9605[Global_20930 /*2811*/][iVar23 /*281*/] = 5000;
		...
		while (iVar22 < 9)
		{
			if (Global_9605[Global_20930 /*2811*/][iVar22 /*281*/].f_280 == 1)
			{
				if (iVar0[iVar22] == 0)
				{
					if (Global_9605[Global_20930 /*2811*/][iVar22 /*281*/] < Global_9605[Global_20930 /*2811*/][iVar23 /*281*/])
					{
						if (Global_79389)
						{
							if (iVar22 == 0)
							{
								...
								func_18(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(13), SYSTEM::TO_FLOAT(iVar21), SYSTEM::TO_FLOAT(iLocal_47), -1f, -1f, &(Global_9605[Global_20930 /*2811*/][iVar23 /*281*/].f_2), 0, 0, 0, 0);
							}
							else
							{
								iVar23 = iVar22;
		...
		iVar0[iVar23] = 1;
		if (Global_9605[Global_20930 /*2811*/][iVar21 /*281*/].f_280 == 1)
		{
			iLocal_37++;
		}
		iVar21++;
