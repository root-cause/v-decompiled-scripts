...
void __EntryFunction__()//Position - 0x0
{
	...
	if (!func_274(&iVar2, &Var0, Var1, 1f))
	{
		func_273();
	...
	while (true)
	{
		...
		func_209(Var0.f_0);
		func_202(&iLocal_54, &(Var0.f_9), Var1);
		if (Var0.f_0 == 18)
		{
			func_201(&Var0);
			func_196(&Var0, Var1, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (Var0.f_0 == 19)
		{
			func_201(&Var0);
			...
			{
				func_196(&Var0, Var1, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_195() && func_194(Var0.f_28[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && AUDIO::HAS_SOUND_FINISHED(iLocal_56)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, -1))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_56, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", false, 0);
			}
			if ((iLocal_55 == 0 && func_194(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var1, Var0.f_15, Var0.f_15, Var0.f_15, false, false, 0))
			{
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5E36
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x65F9
{
	if (bParam2)
	{
...
int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6AC0
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_84(struct<3> Param0, float fParam1)//Position - 0x777D
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
int func_173(struct<3> Param0, bool bParam1)//Position - 0xC115
{
	int iVar0;
...
int func_196(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xD4CF
{
	var uVar0;
	
	if ((((func_194(PLAYER::PLAYER_PED_ID()) && func_194(iParam0->f_28[0])) && !func_195()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_200(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_200(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xD683
{
	struct<3> Var0;
...
bool func_224(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE961
{
	...
	uVar0 = func_225(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_225(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xEA22
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_228(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEC5D
{
	...
	{
		Var1 = { func_230(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_229(Var1, Var0);
...
float func_229(struct<3> Param0, struct<3> Param1)//Position - 0xECEE
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_237(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xF06C
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
void func_250(int* iParam0, struct<3> Param1, float fParam2)//Position - 0xF550
{
	func_251(iParam0, iLocal_53, Param1, fParam2, 26);
	PED::SET_PED_DEFAULT_COMPONENT_VARIATION(*iParam0);
	PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(*iParam0, false);
	PED::SET_PED_NAME_DEBUG(*iParam0, "EXTREME LAUNCHER RC");
}

void func_251(int* iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0xF582
{
	func_252(iParam0);
...
int func_257(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xF80E
{
...
int func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xF86A
{
	int iVar0;
...
void func_261(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xFC42
{
	func_262(iParam0);
...
int func_274(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x10210
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_275((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_275((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_275(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0x10275
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_276(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_276(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x102ED
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
