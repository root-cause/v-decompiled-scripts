...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112897[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_294(&(Global_112897[Var0.f_0 /*10*/].f_9));
			}
		}
		func_282(&Var0, 1);
	}
	if (!func_279(&iVar64, &Var0, Var61, 1f))
	{
		func_278();
	...
	if (Var0.f_0 == 17)
	{
		iLocal_95 = PED::ADD_SCENARIO_BLOCKING_AREA(Var61 - Vector(40f, 40f, 40f), Var61 + Vector(40f, 40f, 40f), false, true, true, true);
		TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_SALTON_DIRT_BIKE", false);
	}
	else if (Var0.f_0 == 18)
	{
		iLocal_95 = PED::ADD_SCENARIO_BLOCKING_AREA(-1040f, -2870f, 0f, -910f, -2740f, 50f, false, false, true, true);
	}
	...
	while (true)
	{
		...
		func_214(Var0.f_0);
		func_207(&iLocal_92, &(Var0.f_9), Var61);
		if (Var0.f_0 == 18)
		{
			func_206(&Var0);
			func_201(&Var0, Var61, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (Var0.f_0 == 19)
		{
			func_206(&Var0);
			...
			{
				func_201(&Var0, Var61, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_200() && func_199(Var0.f_28[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && AUDIO::HAS_SOUND_FINISHED(iLocal_94)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, -1))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_94, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", false, 0);
			}
			if ((iLocal_93 == 0 && func_199(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var61, Var0.f_15, Var0.f_15, Var0.f_15, false, false, 0))
			{
				Var69 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
				if (Var69.f_2 < 100f)
				{
					iLocal_93 = 1;
					func_198("TOPMAZE_HELP" /* GXT: Get to the top of the Maze Tower to start this mission. */, -1);
					func_295("Player below mission start location so displaying help text TOPMAZE_HELP");
				}
			}
		}
		if (func_183(&Var0, 0) || func_181(&Var0))
		{
			if (func_180(Var0.f_0))
			{
				func_177(Var0.f_0, &iLocal_96);
			}
			if (!func_2(&Var0))
			{
				func_282(&Var0, 1);
...
int func_49(int iParam0, int iParam1)//Position - 0x3A47
{
	int iVar0;
	var uVar1;
...
int func_50(int iParam0, var uParam1)//Position - 0x3A76
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(uParam1));
}

int func_51(var uParam0)//Position - 0x3A8B
{
	int iVar0;
	int iVar1;
...
int func_52()//Position - 0x3ABF
{
	return Global_1574918;
}

int func_53(int iParam0, int iParam1)//Position - 0x3ACB
{
	int iVar0;
	var uVar1;
...
int func_54(int iParam0, var uParam1)//Position - 0x3AEF
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(uParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3B04
{
	int iVar0;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x404D
{
	int iVar0;
...
int func_57()//Position - 0x428E
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_58()//Position - 0x42A7
{
	int iVar0;
...
bool func_59(int iParam0)//Position - 0x43A4
{
	return Global_43377 == iParam0;
}

void func_60(int iParam0, bool bParam1)//Position - 0x43B2
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_61(int iParam0, var uParam1)//Position - 0x44A5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0)//Position - 0x472D
{
	switch (iParam0)
	{
...
int func_63(int iParam0)//Position - 0x47CE
{
...
int func_64(int iParam0, int iParam1)//Position - 0x49AE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x565F
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x569A
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x590E
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x594A
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5E99
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5EDD
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x665C
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x66A3
{
...
bool func_73(int iParam0)//Position - 0x66FE
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x670E
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x676E
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x6B16
{
	return Global_32283;
}

int func_77(int iParam0)//Position - 0x6B21
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6B31
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6BD3
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x733E
{
...
int func_81()//Position - 0x7639
{
	return Global_2652364.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x7648
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x7672
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x7687
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x769E
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x76F6
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x77A0
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x7835
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x7879
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x79FD
{
...
int func_92(int iParam0, var uParam1)//Position - 0x84D5
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x8557
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x85AF
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x85B8
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x8824
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x8834
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x8851
{
...
bool func_100()//Position - 0x8B97
{
	return Global_100885.f_393 > 0;
}

var func_101()//Position - 0x8BA8
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8BEE
{
	if (iParam1 <= 0)
	{
		return;
...
void func_103(var uParam0, int iParam1)//Position - 0x8C74
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8CA7
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8CF8
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8D9A
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8DBC
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8DD3
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8DE0
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8E1A
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8E55
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8E91
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8EAA
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8F03
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8F19
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8F2F
{
...
int func_117(bool bParam0)//Position - 0x8F71
{
...
struct<2> func_118(int iParam0)//Position - 0x8F99
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x93E6
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA6BE
{
	switch (iParam0)
	{
		case 0:
...
int func_122(var* uParam0)//Position - 0xAA04
{
	int iVar0;
...
void func_123(int iParam0)//Position - 0xAAA9
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xAB44
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xABA2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xABFB
{
...
int func_128(int iParam0)//Position - 0xAC7E
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xACAF
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xACC4
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xAD77
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAD92
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xADDE
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xAE27
{
	if (func_199(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xAE47
{
	switch (iParam0)
	{
		case 5:
...
int func_138(int iParam0)//Position - 0xAF17
{
	switch (iParam0)
	{
		case 5:
...
void func_139(var uParam0, bool bParam1, bool bParam2)//Position - 0xAF6A
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_199(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_199(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_199(uParam0->f_41[iVar0]))
		{
...
int func_140(int iParam0)//Position - 0xB05F
{
	switch (iParam0)
	{
		case 5:
...
void func_141(bool bParam0)//Position - 0xB0CA
{
	int iVar0;
...
void func_142(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB109
{
	if (bParam0)
	{
...
bool func_143()//Position - 0xB256
{
	return BitTest(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_36.f_18, 14);
}

bool func_144(int iParam0, int iParam1)//Position - 0xB270
{
	bool bVar0;
...
int func_145(int iParam0, bool bParam1)//Position - 0xB2C9
{
	int iVar0;
	int iVar1;
...
int func_146(var uParam0)//Position - 0xB30A
{
	int iVar0;
...
int func_147(int iParam0)//Position - 0xB32C
{
...
bool func_148()//Position - 0xB36B
{
	return BitTest(Global_2621446, 3);
}

int func_149(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB379
{
	int iVar0;
...
void func_151(int iParam0)//Position - 0xB3D3
{
	if (iParam0 == 1)
	{
...
int func_152(char* sParam0)//Position - 0xB3F6
{
...
void func_153()//Position - 0xB433
{
	Global_20711 = 0;
	func_154();
}

void func_154()//Position - 0xB443
{
...
int func_157(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB507
{
...
void func_158(int iParam0)//Position - 0xB69F
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_160(int iParam0)//Position - 0xB71C
{
	if (func_165())
	{
		return;
...
void func_161(int iParam0)//Position - 0xB74F
{
	if (func_165())
	{
		return;
...
void func_162(bool bParam0, bool bParam1)//Position - 0xB7D9
{
	if (bParam0)
	{
		if (func_164(0))
...
bool func_163()//Position - 0xB84D
{
	return BitTest(Global_1963795, 5);
}

int func_164(int iParam0)//Position - 0xB85B
{
	if (iParam0 == 1)
	{
...
bool func_165()//Position - 0xB8B2
{
	return BitTest(Global_1963795, 19);
}

int func_166(int iParam0)//Position - 0xB8C1
{
...
int func_167(int iParam0)//Position - 0xB902
{
	int iVar0;
	...
	iVar0 = func_169(&(Global_112897[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
void func_168(int iParam0)//Position - 0xB947
{
...
int func_169(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB979
{
	int iVar0;
...
void func_170(var uParam0, int iParam1)//Position - 0xBAB0
{
	int iVar0;
...
bool func_171(int iParam0)//Position - 0xBAFF
{
	return func_172(iParam0, Global_43377);
}

int func_172(int iParam0, int iParam1)//Position - 0xBB10
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_173(int iParam0)//Position - 0xBCF1
{
	if (Global_43377 == 15)
	{
		return 0;
...
int func_174()//Position - 0xBD13
{
	return func_175(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_175(char* sParam0, int iParam1)//Position - 0xBD24
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_177(int iParam0, int iParam1)//Position - 0xBD91
{
	switch (iParam0)
	{
		case 0:
...
int func_178(struct<3> Param0, bool bParam3)//Position - 0xC202
{
	int iVar0;
...
float func_179(bool bParam0, float fParam1, float fParam2)//Position - 0xC22E
{
	if (bParam0)
	{
		return fParam1;
...
int func_180(int iParam0)//Position - 0xC245
{
	switch (iParam0)
	{
		case 0:
...
int func_181(var uParam0)//Position - 0xC2D4
{
	if (*uParam0 == 18)
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -954.5357f, -2760.5532f, 11.916363f, -947.6847f, -2749.719f, 15.631608f, 26f, false, true, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				func_295("Special launching Extreme 2");
				return 1;
			}
			else if ((!func_182(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && func_199(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_157(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 3f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_182(int iParam0, int iParam1)//Position - 0xC37B
{
	if (func_135(iParam0))
	{
...
int func_183(var uParam0, int iParam1)//Position - 0xC3AE
{
	switch (uParam0->f_16)
	{
		case 0:
			if (*uParam0 == 12)
			{
				...
				else if (func_199(uParam0->f_28[0]))
				{
					if (func_185(uParam0))
					{
						if (func_189(2))
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_199(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
					{
...
void func_184()//Position - 0xCB91
{
	func_27(&(Global_104373.f_2890), &Global_104373, 0, 1, 1, 0);
}

int func_185(var uParam0)//Position - 0xCBAC
{
	float fVar0;
...
void func_186(int iParam0, int iParam1)//Position - 0xCC3A
{
	if (iParam0 == 1)
	{
		if (!func_138(iParam1))
...
int func_187(bool bParam0)//Position - 0xCC9E
{
	int iVar0;
...
int func_188(int iParam0)//Position - 0xCD35
{
	if (func_199(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_189(int iParam0)//Position - 0xCD5F
{
	bool bVar0;
...
var func_190()//Position - 0xD47C
{
	return Global_100872.f_1;
}

int func_191()//Position - 0xD48A
{
	if (Global_97735 != -1)
	{
...
bool func_194()//Position - 0xD4F1
{
	return Global_100885.f_394 > 0;
}

var func_195(int iParam0, int iParam1)//Position - 0xD502
{
	switch (iParam0)
	{
		case 5:
...
var func_196()//Position - 0xD53A
{
	return Global_1575063;
}

int func_197()//Position - 0xD546
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_198(char* sParam0, int iParam1)//Position - 0xD562
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_199(int iParam0)//Position - 0xD579
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_201(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD5BC
{
	var uVar0;
	
	if ((((func_199(PLAYER::PLAYER_PED_ID()) && func_199(iParam0->f_28[0])) && !func_200()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_205(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_202(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD644
{
...
void func_203(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD67F
{
...
void func_204(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD6D5
{
...
float func_205(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD770
{
	struct<3> Var0;
...
void func_206(int iParam0)//Position - 0xD7AA
{
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		if (func_199(iParam0->f_28[0]))
		{
...
void func_207(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD7D7
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_208(int iParam0, bool bParam1)//Position - 0xD8C8
{
	if (iParam0 == -1)
	{
		return;
...
int func_209(int iParam0)//Position - 0xD904
{
	if (Global_78685 == iParam0)
	{
		if (Global_78686 == -1)
...
void func_210(int iParam0, int iParam1)//Position - 0xD93D
{
	bool bVar0;
	int iVar1;
...
bool func_211()//Position - 0xD9DB
{
	return Global_98122;
}

void func_212(int iParam0)//Position - 0xD9E7
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_213(iParam0);
...
void func_213(int iParam0)//Position - 0xD9FE
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_214(int iParam0)//Position - 0xDAE6
{
	if (iParam0 == -1)
	{
		iParam0 = func_174();
...
int func_215(var uParam0, bool bParam1)//Position - 0xDB0E
{
	struct<27> Var0;
	...
	if ((func_252(*uParam0) || func_250(*uParam0)) || Global_78935 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_216(int iParam0, var uParam1, int iParam2)//Position - 0xDD7E
{
	int iVar0;
	int iVar1;
...
int func_217(int iParam0)//Position - 0xE0D6
{
...
int func_218(var uParam0)//Position - 0xE0F6
{
...
int func_219(var uParam0)//Position - 0xE10E
{
...
void func_220(var uParam0)//Position - 0xE133
{
	int iVar0;
	int iVar1;
...
void func_221(int* iParam0)//Position - 0xE437
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_222(var uParam0)//Position - 0xE462
{
	int iVar0;
...
int func_223(var uParam0, bool bParam1, bool bParam2)//Position - 0xE4E2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_224(int iParam0, int iParam1)//Position - 0xE6A0
{
	int iVar0;
...
int func_225(var uParam0, bool bParam1, int iParam2)//Position - 0xE6D0
{
	int iVar0;
	int iVar1;
...
int func_226(int iParam0)//Position - 0xE98C
{
...
int func_227(int iParam0, float fParam1)//Position - 0xE9C0
{
	float fVar0;
	
	if (func_199(PLAYER::PLAYER_PED_ID()) && func_199(iParam0))
	{
...
bool func_228(int iParam0, float fParam1)//Position - 0xEA36
{
	return func_229(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_229(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEA4E
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!func_199(iParam0) || !func_199(iParam1))
	{
		if (iVar4 != -1)
		{
...
int func_230(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xEB0F
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_231(int iParam0, int iParam1)//Position - 0xEC3B
{
	int iVar0;
...
int func_233(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xED4A
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_234(struct<3> Param0, struct<3> Param3)//Position - 0xEDDB
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_235(struct<3> Param0)//Position - 0xEDFC
{
	float fVar0;
	float fVar1;
...
void func_236(var uParam0)//Position - 0xEE3B
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_237(int iParam0, int iParam1)//Position - 0xEE56
{
	int iVar0;
...
int func_238(int iParam0)//Position - 0xEE95
{
...
int func_239(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEEBD
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_240(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEFB8
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_241(int iParam0, float fParam1)//Position - 0xF0C4
{
	var uVar0;
	struct<3> Var1;
...
int func_242(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF159
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_243(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF1E7
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_244(int iParam0)//Position - 0xF22F
{
...
void func_245(int iParam0)//Position - 0xF279
{
	int iVar0;
...
int func_246(int iParam0)//Position - 0xF316
{
	if (iParam0 == -1)
	{
		iParam0 = func_174();
...
int func_247(int iParam0)//Position - 0xF3AB
{
...
int func_250(int iParam0)//Position - 0xF42A
{
	if ((func_251() && Global_100833.f_11 == 6) && iParam0 == func_175(&(Global_100833.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_252(int iParam0)//Position - 0xF49C
{
	if (func_117(0))
	{
...
int func_253(int iParam0)//Position - 0xF4C4
{
	switch (*iParam0)
	{
		case 17:
...
int func_254(var uParam0)//Position - 0xF539
{
	int iVar0[1];
	int iVar2;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_260(&(uParam0->f_48), "rcmextreme4", "idle_a", "idle_c");
			iLocal_89 = 1;
			break;
		...
		case 2:
			func_255(&(uParam0->f_28[0]), 1732.27f, 96.36f, 170.29f, -98.56f);
...
void func_255(int* iParam0, struct<3> Param1, float fParam4)//Position - 0xF63D
{
	func_256(iParam0, iLocal_91, Param1, fParam4, 26);
	PED::SET_PED_DEFAULT_COMPONENT_VARIATION(*iParam0);
	PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(*iParam0, false);
	PED::SET_PED_NAME_DEBUG(*iParam0, "EXTREME LAUNCHER RC");
}

void func_256(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xF66F
{
	func_257(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_257(int* iParam0)//Position - 0xF690
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_258(var uParam0)//Position - 0xF6D1
{
	if (func_219(uParam0))
	{
...
int func_259(int iParam0)//Position - 0xF6FB
{
	int iVar0;
...
void func_260(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xF72C
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_261(var uParam0)//Position - 0xF768
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_260(&(uParam0->f_48), "rcmextreme3", "idle_calm", "fidget_02");
			iLocal_89 = 1;
			break;
		...
		case 2:
			...
			{
				if (func_262(&(uParam0->f_28[0]), 52, -63.8f, -809.5f, 321.8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
...
int func_262(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF8FB
{
...
int func_263(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF957
{
	int iVar0;
...
int func_264(var uParam0, int iParam1)//Position - 0xF9E5
{
	int iVar0;
...
int func_265(var uParam0)//Position - 0xFA2B
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_260(&(uParam0->f_48), "rcmextreme2", "sitting_idle", "loop_punching");
			iLocal_89 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_262(&(uParam0->f_28[0]), 52, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_266(&(uParam0->f_35[0]), iVar0[0], -950.8f, -2751.98f, 13.21f, 199.05f);
			...
			{
				func_266(&(uParam0->f_35[1]), iVar0[0], -950.192f, -2755.96f, 13.3639f, -178.182f);
			...
			{
				func_266(&(uParam0->f_35[2]), iVar0[1], -957.23f, -2764.89f, 14.04f, 147.61f);
...
void func_266(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFD2F
{
	func_267(iParam0);
...
void func_267(int* iParam0)//Position - 0xFD71
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_268(var uParam0)//Position - 0xFE0D
{
	int iVar0[1];
	int iVar2;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_260(&(uParam0->f_48), "rcm_extreme1", "idle_a", "idle_c");
			iLocal_89 = 1;
			break;
		...
		case 2:
			func_255(&(uParam0->f_28[0]), -188.22f, 1296.1f, 302.86f, 43.7f);
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iVar0[iVar2]);
...
int func_269(int iParam0)//Position - 0xFEF9
{
	struct<27> Var0;
	bool bVar32;
...
int func_270(int iParam0)//Position - 0xFF4A
{
	char* sVar0;
...
int func_271(int iParam0)//Position - 0x10004
{
	var uVar0;
...
int func_272(int iParam0)//Position - 0x100C5
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_273(int iParam0, char* sParam1)//Position - 0x1014A
{
...
int func_274(int iParam0)//Position - 0x1022C
{
...
int func_275(int iParam0)//Position - 0x10257
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_276(int iParam0)//Position - 0x10282
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_277(int iParam0)//Position - 0x102AD
{
	if (func_247(iParam0))
	{
		return 0;
...
void func_278()//Position - 0x102E2
{
	func_295("Running end routines.");
	Global_113528 = (Global_113528 - 1);
}

int func_279(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x102FC
{
	int iVar0;
...
int func_280(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10361
{
	int iVar0;
	struct<7> Var1;
...
int func_281(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x103D9
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_282(int iParam0, bool bParam1)//Position - 0x10454
{
	if (*iParam0 == 18)
	{
		if (func_199(iParam0->f_35[0]))
		{
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(iParam0->f_35[0], 1);
		}
		if (func_199(iParam0->f_35[1]))
		{
...
int func_283(var uParam0)//Position - 0x10535
{
	if (func_219(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_284(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x1056B
{
...
void func_285(var uParam0, bool bParam1)//Position - 0x1058B
{
	func_286(&(uParam0->f_41), bParam1);
}

void func_286(var uParam0, bool bParam1)//Position - 0x1059D
{
	int iVar0;
...
void func_287(int* iParam0, bool bParam1)//Position - 0x105DB
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_288(var uParam0, bool bParam1)//Position - 0x10616
{
	func_289(&(uParam0->f_35), bParam1);
}

void func_289(var uParam0, bool bParam1)//Position - 0x10628
{
	int iVar0;
...
void func_290(int* iParam0)//Position - 0x10665
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_291(var uParam0, int iParam1)//Position - 0x1069D
{
	func_292(&(uParam0->f_28), iParam1);
}

void func_292(var uParam0, int iParam1)//Position - 0x106AF
{
	int iVar0;
...
void func_293(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x106F0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_294(var uParam0)//Position - 0x10740
{
	if (*uParam0 == -1)
	{
		return;
...
void func_295(char* sParam0)//Position - 0x1077D
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_296(var uParam0)//Position - 0x1078F
{
	*uParam0 = -1;
...
void func_297()//Position - 0x107C2
{
	func_295("Running start routines.");
	Global_113528++;
}

int func_298(int iParam0)//Position - 0x107DC
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
