...
int func_64(int iParam0, int iParam1)//Position - 0x49C3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x5704
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x573F
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x59B3
{
	bool bVar0;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5F3E
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6701
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x6748
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x67B3
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6BD6
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x76E1
{
...
int func_83()//Position - 0x770B
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

Vector3 func_84(struct<3> Param0)//Position - 0x7723
{
...
int func_86(int iParam0)//Position - 0x774F
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7851
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x78E6
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_93(int iParam0, var uParam1)//Position - 0x8584
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0)//Position - 0x8606
{
	if (iParam0 != func_95())
	{
...
int func_98(int iParam0)//Position - 0x88E3
{
	return MISC::GET_BITS_IN_RANGE(Global_2657971[iParam0 /*465*/].f_322.f_3, 28, 31);
}

int func_99(int iParam0)//Position - 0x8900
{
...
var func_107(int iParam0)//Position - 0x8E49
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8E6B
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8E82
{
	return uParam0 & 15;
}
...
bool func_115()//Position - 0x8FB2
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_116()//Position - 0x8FC8
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x8FDE
{
...
int func_118(bool bParam0)//Position - 0x9020
{
...
int func_123(var* uParam0)//Position - 0xAAB3
{
	int iVar0;
...
void func_127(int iParam0)//Position - 0xAC51
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0)//Position - 0xAD2D
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAE26
{
...
int func_135(int iParam0)//Position - 0xAE8D
{
	int iVar0;
...
int func_136(int iParam0)//Position - 0xAED6
{
	if (func_201(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xAEF6
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xAFC6
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xB019
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xB10E
{
	switch (iParam0)
	{
		case 5:
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB1B8
{
	if (bParam0)
	{
...
bool func_145(int iParam0, int iParam1)//Position - 0xB31F
{
	bool bVar0;
...
int func_147(var uParam0)//Position - 0xB3B9
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB3DB
{
...
int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB428
{
	int iVar0;
...
int func_153(char* sParam0)//Position - 0xB4A5
{
...
int func_158(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB5B6
{
...
void func_159(int iParam0)//Position - 0xB60D
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_166(int iParam0)//Position - 0xB91A
{
	if (iParam0 == 1)
	{
...
int func_168(int iParam0)//Position - 0xB980
{
...
int func_169(int iParam0)//Position - 0xB9C1
{
	int iVar0;
...
int func_171(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xBA38
{
	int iVar0;
...
void func_172(var uParam0, int iParam1)//Position - 0xBB6F
{
	int iVar0;
...
bool func_173(int iParam0)//Position - 0xBBBE
{
	return func_174(iParam0, Global_44042);
}

int func_174(int iParam0, int iParam1)//Position - 0xBBCF
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_175(int iParam0)//Position - 0xBDB0
{
	if (Global_44042 == 15)
	{
		return 0;
...
int func_177(char* sParam0, int iParam1)//Position - 0xBDE3
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_179(int iParam0, int iParam1)//Position - 0xBE50
{
	switch (iParam0)
	{
		case 0:
...
int func_180(struct<3> Param0, bool bParam3)//Position - 0xC2C1
{
	int iVar0;
...
float func_181(bool bParam0, float fParam1, float fParam2)//Position - 0xC2ED
{
	if (bParam0)
	{
		return fParam1;
...
int func_182(int iParam0)//Position - 0xC304
{
	switch (iParam0)
	{
		case 0:
...
int func_184(int iParam0, int iParam1)//Position - 0xC43A
{
	if (func_136(iParam0))
	{
...
int func_187(var uParam0)//Position - 0xCC6B
{
	float fVar0;
...
void func_188(int iParam0, int iParam1)//Position - 0xCCF9
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_189(bool bParam0)//Position - 0xCD5D
{
	int iVar0;
...
int func_190(int iParam0)//Position - 0xCDF4
{
	if (func_201(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_191(int iParam0)//Position - 0xCE1E
{
	bool bVar0;
...
var func_192()//Position - 0xD53B
{
	return Global_101572.f_1;
}

int func_193()//Position - 0xD549
{
	if (Global_98435 != -1)
	{
...
var func_197(int iParam0, int iParam1)//Position - 0xD5C1
{
	switch (iParam0)
	{
		case 5:
...
var func_198()//Position - 0xD5F9
{
	return Global_1575083;
}

int func_199()//Position - 0xD605
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_200(char* sParam0, int iParam1)//Position - 0xD621
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_201(int iParam0)//Position - 0xD638
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_203(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD67B
{
	var uVar0;
...
void func_204(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD703
{
...
void func_205(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD73E
{
...
void func_206(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD794
{
...
float func_207(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD82F
{
	struct<3> Var0;
...
void func_208(int iParam0)//Position - 0xD869
{
...
void func_209(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD896
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_212(int iParam0, int iParam1)//Position - 0xD9FC
{
	bool bVar0;
	int iVar1;
...
void func_214(int iParam0)//Position - 0xDAA6
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_215(iParam0);
...
void func_215(int iParam0)//Position - 0xDABD
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_217(var uParam0, bool bParam1)//Position - 0xDBCD
{
	struct<27> Var0;
...
void func_218(int iParam0, var uParam1, int iParam2)//Position - 0xDE3D
{
	int iVar0;
	int iVar1;
...
int func_219(int iParam0)//Position - 0xE195
{
...
int func_220(var uParam0)//Position - 0xE1B5
{
...
int func_221(var uParam0)//Position - 0xE1CD
{
...
void func_223(int* iParam0)//Position - 0xE4F6
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_225(var uParam0, bool bParam1, bool bParam2)//Position - 0xE5A1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_226(int iParam0, int iParam1)//Position - 0xE75F
{
	int iVar0;
...
int func_227(var uParam0, bool bParam1, int iParam2)//Position - 0xE78F
{
	int iVar0;
	int iVar1;
...
int func_228(int iParam0)//Position - 0xEA4B
{
...
int func_229(int iParam0, float fParam1)//Position - 0xEA7F
{
	float fVar0;
...
bool func_230(int iParam0, float fParam1)//Position - 0xEAF5
{
	return func_231(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_231(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEB0D
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_232(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xEBCE
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_233(int iParam0, int iParam1)//Position - 0xECFA
{
	int iVar0;
...
int func_235(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEE09
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_236(struct<3> Param0, struct<3> Param3)//Position - 0xEE9A
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_237(struct<3> Param0)//Position - 0xEEBB
{
	float fVar0;
	float fVar1;
...
int func_239(int iParam0, int iParam1)//Position - 0xEF15
{
	int iVar0;
...
int func_240(int iParam0)//Position - 0xEF54
{
...
int func_241(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEF7C
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_242(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF077
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_243(int iParam0, float fParam1)//Position - 0xF183
{
	var uVar0;
	struct<3> Var1;
...
int func_244(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF218
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_245(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF2A6
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_246(int iParam0)//Position - 0xF2EE
{
...
void func_247(int iParam0)//Position - 0xF338
{
	int iVar0;
...
int func_248(int iParam0)//Position - 0xF3D5
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
int func_249(int iParam0)//Position - 0xF46A
{
...
int func_252(int iParam0)//Position - 0xF4E9
{
...
int func_254(int iParam0)//Position - 0xF55B
{
	if (func_118(0))
	{
...
int func_255(int iParam0)//Position - 0xF583
{
	switch (*iParam0)
	{
		case 17:
...
int func_256(var uParam0)//Position - 0xF5F8
{
	int iVar0[1];
	int iVar2;
...
void func_257(int* iParam0, struct<3> Param1, float fParam4)//Position - 0xF6FC
{
...
void func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xF72E
{
	func_259(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_259(int* iParam0)//Position - 0xF74F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_260(var uParam0)//Position - 0xF790
{
	if (func_221(uParam0))
	{
...
int func_261(int iParam0)//Position - 0xF7BA
{
	int iVar0;
...
int func_263(var uParam0)//Position - 0xF827
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
...
int func_264(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF9BA
{
...
int func_265(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xFA16
{
	int iVar0;
...
int func_266(var uParam0, int iParam1)//Position - 0xFAA4
{
	int iVar0;
...
int func_267(var uParam0)//Position - 0xFAEA
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
...
void func_268(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFDEE
{
	func_269(iParam0);
...
void func_269(int* iParam0)//Position - 0xFE31
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_270(var uParam0)//Position - 0xFECD
{
	int iVar0[1];
	int iVar2;
...
int func_271(int iParam0)//Position - 0xFFB9
{
	struct<27> Var0;
	bool bVar32;
...
int func_272(int iParam0)//Position - 0x1000B
{
	char* sVar0;
...
int func_273(int iParam0)//Position - 0x100C4
{
	var uVar0;
...
int func_274(int iParam0)//Position - 0x10185
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_276(int iParam0)//Position - 0x102EC
{
...
int func_277(int iParam0)//Position - 0x10317
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_278(int iParam0)//Position - 0x10342
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_279(int iParam0)//Position - 0x1036D
{
	if (func_249(iParam0))
	{
		return 0;
...
int func_281(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x103BC
{
	int iVar0;
...
int func_282(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10421
{
	int iVar0;
	struct<7> Var1;
...
int func_283(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10499
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_284(int iParam0, bool bParam1)//Position - 0x10514
{
	if (*iParam0 == 18)
	{
...
void func_289(int* iParam0, bool bParam1)//Position - 0x1069B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_292(int* iParam0)//Position - 0x10725
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_295(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x107B0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_296(var uParam0)//Position - 0x10800
{
	if (*uParam0 == -1)
	{
		return;
...
int func_300(int iParam0)//Position - 0x1089C
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
