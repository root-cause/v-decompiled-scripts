...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112473[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_286(&(Global_112473[Var0.f_0 /*10*/].f_9));
			}
		}
		func_274(&Var0, 1);
	}
	if (!func_271(&iVar2, &Var0, Var1, 1f))
	{
		func_270();
	...
	while (true)
	{
		...
		func_206(Var0.f_0);
		func_199(&iLocal_54, &(Var0.f_9), Var1);
		if (Var0.f_0 == 18)
		{
			func_198(&Var0);
			func_193(&Var0, Var1, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (Var0.f_0 == 19)
		{
			func_198(&Var0);
			...
			{
				func_193(&Var0, Var1, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_192() && func_191(Var0.f_28[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && AUDIO::HAS_SOUND_FINISHED(iLocal_56)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, -1))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_56, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", false, 0);
			}
			if ((iLocal_55 == 0 && func_191(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var1, Var0.f_15, Var0.f_15, Var0.f_15, false, false, 0))
			{
				Var3 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
				if (Var3.f_2 < 100f)
				{
					iLocal_55 = 1;
					func_190("TOPMAZE_HELP" /* GXT: Get to the top of the Maze Tower to start this mission. */, -1);
					func_287("Player below mission start location so displaying help text TOPMAZE_HELP");
				}
			}
		}
		if (func_175(&Var0, 0) || func_173(&Var0))
		{
			if (func_172(Var0.f_0))
			{
				func_169(Var0.f_0, &iLocal_58);
			}
			if (!func_2(&Var0))
			{
				func_274(&Var0, 1);
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x403F
{
	int iVar0;
...
int func_55()//Position - 0x4280
{
	func_56();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_56()//Position - 0x4299
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x4396
{
	return Global_43052 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x43A4
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x4497
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x471F
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x47BA
{
...
int func_62(int iParam0, int iParam1)//Position - 0x4982
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x5523
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x555E
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x57D2
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x580E
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5D5D
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5DA1
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x6520
{
	if (bParam2)
	{
...
int func_70(var uParam0)//Position - 0x6567
{
...
bool func_71(int iParam0)//Position - 0x65C2
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x65D2
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x6633
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x69AE
{
	return Global_31959;
}

int func_75(int iParam0)//Position - 0x69B9
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x69C9
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x6A6B
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x7190
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x71E8
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7292
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
...
Vector3 func_81(struct<3> Param0, float fParam1)//Position - 0x7327
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_82(int iParam0)//Position - 0x736B
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x74EF
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x74FD
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7FC4
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x8047
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x809F
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x80A8
{
	switch (iParam0)
	{
		case 1:
...
int func_89()//Position - 0x8304
{
	return func_90(PLAYER::PLAYER_ID());
}

int func_90(int iParam0)//Position - 0x8314
{
	return MISC::GET_BITS_IN_RANGE(Global_2689235[iParam0 /*453*/].f_318.f_3, 28, 31);
}

int func_91(int iParam0)//Position - 0x8331
{
	return func_72(iParam0, 0, 0);
}

int func_92(int iParam0)//Position - 0x8341
{
	switch (iParam0)
	{
		case -1:
...
bool func_93()//Position - 0x8650
{
	return Global_100493.f_375 > 0;
}

var func_94()//Position - 0x8661
{
	var uVar0;
...
void func_95(var uParam0, int iParam1)//Position - 0x86A7
{
	if (iParam1 <= 0)
	{
		return;
...
void func_96(var uParam0, int iParam1)//Position - 0x872D
{
...
void func_97(var uParam0, int iParam1)//Position - 0x8760
{
	int iVar0;
	int iVar1;
...
int func_98(int iParam0, int iParam1)//Position - 0x87B1
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_99(int iParam0)//Position - 0x8853
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_100(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_100(bool bParam0, int iParam1, int iParam2)//Position - 0x8875
{
	if (bParam0)
	{
		return iParam1;
...
int func_101(var uParam0)//Position - 0x888C
{
	return uParam0 & 15;
}

void func_102(var uParam0, int iParam1)//Position - 0x8899
{
...
void func_103(var uParam0, int iParam1)//Position - 0x88D3
{
...
void func_104(var uParam0, int iParam1)//Position - 0x890E
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_105()//Position - 0x894A
{
	func_56();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_106(int iParam0)//Position - 0x8963
{
	var uVar0;
	char cVar1[24];
...
bool func_107()//Position - 0x89BC
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_108()//Position - 0x89D2
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_109(char* sParam0, int iParam1, int iParam2)//Position - 0x89E8
{
...
int func_110(bool bParam0)//Position - 0x8A2A
{
...
struct<2> func_111(int iParam0)//Position - 0x8A52
{
	struct<2> Var0;
...
void func_112(int iParam0, var uParam1)//Position - 0x8E9F
{
	switch (iParam0)
	{
		case 0:
...
int func_114(int iParam0)//Position - 0xA177
{
	switch (iParam0)
	{
		case 0:
...
int func_115(var* uParam0)//Position - 0xA4BD
{
	int iVar0;
...
void func_116(int iParam0)//Position - 0xA562
{
	struct<2> Var0;
...
void func_117(int iParam0)//Position - 0xA5FD
{
	if (iParam0 < 63)
	{
		func_118();
...
void func_119(int iParam0)//Position - 0xA65B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_120(int iParam0)//Position - 0xA6B4
{
...
int func_121(int iParam0)//Position - 0xA737
{
	int iVar0;
...
void func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA768
{
	func_123(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_123(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA77D
{
	int iVar0;
...
int func_125(int iParam0, int iParam1, int iParam2)//Position - 0xA830
{
...
int func_126(int iParam0, int iParam1, int iParam2)//Position - 0xA84B
{
	int iVar0;
...
int func_127(int iParam0)//Position - 0xA897
{
	int iVar0;
...
int func_128(int iParam0)//Position - 0xA8E0
{
	if (func_191(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_129(int iParam0)//Position - 0xA900
{
	switch (iParam0)
	{
		case 5:
...
int func_131(int iParam0)//Position - 0xA9D0
{
	switch (iParam0)
	{
		case 5:
...
void func_132(var uParam0, bool bParam1, bool bParam2)//Position - 0xAA23
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_191(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_191(uParam0->f_41[iVar0]))
		{
...
int func_133(int iParam0)//Position - 0xAB18
{
	switch (iParam0)
	{
		case 5:
...
void func_134(bool bParam0)//Position - 0xAB83
{
	int iVar0;
...
void func_135(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xABC2
{
	if (bParam0)
	{
...
bool func_136()//Position - 0xAD05
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_137(int iParam0, int iParam1)//Position - 0xAD1F
{
	bool bVar0;
...
int func_138(int iParam0, bool bParam1)//Position - 0xAD6A
{
	int iVar0;
	int iVar1;
...
int func_139(int iParam0)//Position - 0xADAB
{
...
bool func_140()//Position - 0xADEA
{
	return BitTest(Global_2621446, 3);
}

int func_141(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xADF8
{
	int iVar0;
...
void func_143(int iParam0)//Position - 0xAE52
{
	if (iParam0 == 1)
	{
...
int func_144(char* sParam0)//Position - 0xAE75
{
...
void func_145()//Position - 0xAEB2
{
	Global_20471 = 0;
	func_146();
}

void func_146()//Position - 0xAEC2
{
...
int func_149(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAF86
{
...
void func_150(int iParam0)//Position - 0xB11E
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_152(int iParam0)//Position - 0xB19B
{
	if (func_157())
	{
		return;
...
void func_153(int iParam0)//Position - 0xB1CE
{
	if (func_157())
	{
		return;
...
void func_154(bool bParam0, bool bParam1)//Position - 0xB258
{
	if (bParam0)
	{
		if (func_156(0))
...
bool func_155()//Position - 0xB2CC
{
	return BitTest(Global_1958711, 5);
}

int func_156(int iParam0)//Position - 0xB2DA
{
	if (iParam0 == 1)
	{
...
bool func_157()//Position - 0xB331
{
	return BitTest(Global_1958711, 19);
}

int func_158(int iParam0)//Position - 0xB340
{
...
int func_159(int iParam0)//Position - 0xB381
{
	int iVar0;
	...
	iVar0 = func_161(&(Global_112473[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
void func_160(int iParam0)//Position - 0xB3C6
{
...
int func_161(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB3F8
{
	int iVar0;
...
void func_162(var uParam0, int iParam1)//Position - 0xB52F
{
	int iVar0;
...
bool func_163(int iParam0)//Position - 0xB57E
{
	return func_164(iParam0, Global_43052);
}

int func_164(int iParam0, int iParam1)//Position - 0xB58F
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_165(int iParam0)//Position - 0xB770
{
	if (Global_43052 == 15)
	{
		return 0;
...
int func_166()//Position - 0xB792
{
	return func_167(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_167(char* sParam0, int iParam1)//Position - 0xB7A3
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_169(int iParam0, int iParam1)//Position - 0xB810
{
	switch (iParam0)
	{
		case 0:
...
int func_170(struct<3> Param0, bool bParam1)//Position - 0xBC7F
{
	int iVar0;
...
float func_171(bool bParam0, float fParam1, float fParam2)//Position - 0xBCAB
{
	if (bParam0)
	{
		return fParam1;
...
int func_172(int iParam0)//Position - 0xBCC2
{
	switch (iParam0)
	{
		case 0:
...
int func_173(var uParam0)//Position - 0xBD51
{
	if (*uParam0 == 18)
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -954.5357f, -2760.553f, 11.91636f, -947.6847f, -2749.719f, 15.63161f, 26f, false, true, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				func_287("Special launching Extreme 2");
				return 1;
			}
			else if ((!func_174(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && func_191(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_149(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 3f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_174(int iParam0, int iParam1)//Position - 0xBDF8
{
	if (func_128(iParam0))
	{
...
int func_175(var uParam0, int iParam1)//Position - 0xBE2B
{
	switch (uParam0->f_16)
	{
		case 0:
			if (*uParam0 == 12)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, false, true, 0))
				{
					if (func_191(uParam0->f_28[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_181(2))
							{
								if (func_179(uParam0->f_27))
								{
									func_178(uParam0->f_27, *uParam0);
				...
				else if (func_191(uParam0->f_28[0]))
				{
					if (func_177(uParam0))
					{
						if (func_181(2))
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_191(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
					{
...
void func_176()//Position - 0xC613
{
	func_27(&(Global_103950.f_2890), &Global_103950, 0, 1, 1, 0);
}

int func_177(var uParam0)//Position - 0xC62E
{
	float fVar0;
...
void func_178(int iParam0, int iParam1)//Position - 0xC6BC
{
	if (iParam0 == 1)
	{
		if (!func_131(iParam1))
...
int func_179(bool bParam0)//Position - 0xC720
{
	int iVar0;
...
int func_180(int iParam0)//Position - 0xC7B7
{
	if (func_191(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_181(int iParam0)//Position - 0xC7E1
{
	bool bVar0;
...
var func_182()//Position - 0xCEFE
{
	return Global_100480.f_1;
}

int func_183()//Position - 0xCF0C
{
	if (Global_97363 != -1)
	{
...
bool func_186()//Position - 0xCF73
{
	return Global_100493.f_376 > 0;
}

var func_187(int iParam0, int iParam1)//Position - 0xCF84
{
	switch (iParam0)
	{
		case 5:
...
var func_188()//Position - 0xCFBC
{
	return Global_1575058;
}

int func_189()//Position - 0xCFC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_190(char* sParam0, int iParam1)//Position - 0xCFE4
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_191(int iParam0)//Position - 0xCFFB
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_193(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xD03E
{
	var uVar0;
	
	if ((((func_191(PLAYER::PLAYER_PED_ID()) && func_191(iParam0->f_28[0])) && !func_192()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_197(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_194(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD0C6
{
...
void func_195(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD101
{
...
void func_196(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD157
{
...
float func_197(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xD1F2
{
	struct<3> Var0;
...
void func_199(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD259
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_200(int iParam0, bool bParam1)//Position - 0xD34A
{
	if (iParam0 == -1)
	{
		return;
...
int func_201(int iParam0)//Position - 0xD386
{
	if (Global_78315 == iParam0)
	{
		if (Global_78316 == -1)
...
void func_202(int iParam0, int iParam1)//Position - 0xD3BF
{
	bool bVar0;
	int iVar1;
...
bool func_203()//Position - 0xD45D
{
	return Global_97750;
}

void func_204(int iParam0)//Position - 0xD469
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_205(iParam0);
...
void func_205(int iParam0)//Position - 0xD480
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_206(int iParam0)//Position - 0xD568
{
	if (iParam0 == -1)
	{
		iParam0 = func_166();
...
int func_207(var uParam0, bool bParam1)//Position - 0xD590
{
	struct<27> Var0;
	...
	if ((func_244(*uParam0) || func_242(*uParam0)) || Global_78564 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_208(int iParam0, var uParam1, int iParam2)//Position - 0xD800
{
	int iVar0;
	int iVar1;
...
int func_209(int iParam0)//Position - 0xDB58
{
...
int func_210(var uParam0)//Position - 0xDB78
{
...
int func_211(var uParam0)//Position - 0xDB90
{
...
void func_212(var uParam0)//Position - 0xDBB5
{
	int iVar0;
	int iVar1;
...
void func_213(int* iParam0)//Position - 0xDEB9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_214(var uParam0)//Position - 0xDEE4
{
	int iVar0;
...
int func_215(var uParam0, bool bParam1, bool bParam2)//Position - 0xDF64
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_216(int iParam0, int iParam1)//Position - 0xE122
{
	int iVar0;
...
int func_217(var uParam0, bool bParam1, int iParam2)//Position - 0xE152
{
	int iVar0;
	int iVar1;
...
int func_218(int iParam0)//Position - 0xE40E
{
...
int func_219(int iParam0, float fParam1)//Position - 0xE442
{
	float fVar0;
	
	if (func_191(PLAYER::PLAYER_PED_ID()) && func_191(iParam0))
	{
...
bool func_220(int iParam0, float fParam1)//Position - 0xE4B8
{
	return func_221(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_221(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE4D0
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (!func_191(iParam0) || !func_191(iParam1))
	{
		if (iVar2 != -1)
		{
	...
	uVar0 = func_222(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_222(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE591
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_223(int iParam0, int iParam1)//Position - 0xE6BD
{
	int iVar0;
...
int func_225(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE7CC
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	{
		Var1 = { func_227(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_226(Var1, Var0);
...
float func_226(struct<3> Param0, struct<3> Param1)//Position - 0xE85D
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_227(struct<3> Param0)//Position - 0xE87E
{
	float fVar0;
	float fVar1;
...
void func_228(var uParam0)//Position - 0xE8BD
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_229(int iParam0, int iParam1)//Position - 0xE8D8
{
	int iVar0;
...
int func_230(int iParam0)//Position - 0xE917
{
...
int func_231(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE93F
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_232(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEA3A
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_233(int iParam0, float fParam1)//Position - 0xEB46
{
	var uVar0;
	struct<3> Var1;
...
int func_234(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xEBDB
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_235(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEC69
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_236(int iParam0)//Position - 0xECB1
{
...
void func_237(int iParam0)//Position - 0xECFB
{
	int iVar0;
...
int func_238(int iParam0)//Position - 0xED98
{
	if (iParam0 == -1)
	{
		iParam0 = func_166();
...
int func_239(int iParam0)//Position - 0xEE2D
{
...
int func_242(int iParam0)//Position - 0xEEAC
{
	if ((func_243() && Global_100441.f_11 == 6) && iParam0 == func_167(&(Global_100441.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_244(int iParam0)//Position - 0xEF1E
{
	if (func_110(0))
	{
...
int func_246(var uParam0)//Position - 0xEFBB
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_252(&(uParam0->f_48), "rcmextreme4", "idle_a", "idle_c");
			iLocal_51 = 1;
			break;
...
{
	func_248(iParam0, iLocal_53, Param1, fParam2, 26);
	PED::SET_PED_DEFAULT_COMPONENT_VARIATION(*iParam0);
	PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(*iParam0, false);
	PED::SET_PED_NAME_DEBUG(*iParam0, "EXTREME LAUNCHER RC");
}

void func_248(int* iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0xF0F1
{
	func_249(iParam0);
	*iParam0 = PED::CREATE_PED(iParam4, iParam1, Param2, fParam3, false, false);
}

void func_249(int* iParam0)//Position - 0xF112
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_250(var uParam0)//Position - 0xF153
{
	if (func_211(uParam0))
	{
...
int func_251(int iParam0)//Position - 0xF17D
{
	int iVar0;
...
void func_252(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xF1AE
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_253(var uParam0)//Position - 0xF1EA
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_252(&(uParam0->f_48), "rcmextreme3", "idle_calm", "fidget_02");
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			{
				if (func_254(&(uParam0->f_28[0]), 52, -63.8f, -809.5f, 321.8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
...
int func_254(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xF37D
{
	if (func_255(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_255(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xF3D9
{
	int iVar0;
...
int func_256(var uParam0, int iParam1)//Position - 0xF467
{
	int iVar0;
...
int func_257(var uParam0)//Position - 0xF4AD
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_252(&(uParam0->f_48), "rcmextreme2", "sitting_idle", "loop_punching");
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_254(&(uParam0->f_28[0]), 52, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_258(&(uParam0->f_35[0]), iVar0[0], -950.8f, -2751.98f, 13.21f, 199.05f);
			...
			{
				func_258(&(uParam0->f_35[1]), iVar0[0], -950.192f, -2755.96f, 13.3639f, -178.182f);
			...
			{
				func_258(&(uParam0->f_35[2]), iVar0[1], -957.23f, -2764.89f, 14.04f, 147.61f);
...
void func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xF7B1
{
	func_259(iParam0);
...
void func_259(int* iParam0)//Position - 0xF7F3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_260(var uParam0)//Position - 0xF88F
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_252(&(uParam0->f_48), "rcm_extreme1", "idle_a", "idle_c");
			iLocal_51 = 1;
			break;
...
int func_261(int iParam0)//Position - 0xF97B
{
	struct<27> Var0;
	bool bVar1;
...
bool func_265(int iParam0, char* sParam1)//Position - 0xFBCB
{
...
int func_266(int iParam0)//Position - 0xFCAD
{
...
int func_267(int iParam0)//Position - 0xFCD8
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_268(int iParam0)//Position - 0xFD03
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_269(int iParam0)//Position - 0xFD2E
{
	if (func_239(iParam0))
	{
		return 0;
...
void func_270()//Position - 0xFD63
{
	func_287("Running end routines.");
	Global_113104 = (Global_113104 - 1);
}

int func_271(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xFD7D
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_272((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_272((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_272(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xFDE2
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_273(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_273(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0xFE5A
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_274(int iParam0, bool bParam1)//Position - 0xFED5
{
	if (*iParam0 == 18)
	{
		if (func_191(iParam0->f_35[0]))
		{
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(iParam0->f_35[0], 1);
		}
		if (func_191(iParam0->f_35[1]))
		{
...
int func_275(var uParam0)//Position - 0xFFB6
{
	if (func_211(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_276(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFFEC
{
...
void func_277(var uParam0, bool bParam1)//Position - 0x1000F
{
	func_278(&(uParam0->f_41), bParam1);
}

void func_278(var uParam0, bool bParam1)//Position - 0x10021
{
	int iVar0;
...
void func_279(int* iParam0, bool bParam1)//Position - 0x1005F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_280(var uParam0, bool bParam1)//Position - 0x1009A
{
	func_281(&(uParam0->f_35), bParam1);
}

void func_281(var uParam0, bool bParam1)//Position - 0x100AC
{
	int iVar0;
...
void func_282(int* iParam0)//Position - 0x100E9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_283(var uParam0, int iParam1)//Position - 0x10121
{
	func_284(&(uParam0->f_28), iParam1);
}

void func_284(var uParam0, int iParam1)//Position - 0x10133
{
	int iVar0;
...
void func_285(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10174
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_286(var uParam0)//Position - 0x101C4
{
	if (*uParam0 == -1)
	{
		return;
...
void func_287(char* sParam0)//Position - 0x10201
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_288(var uParam0)//Position - 0x10213
{
	*uParam0 = -1;
...
void func_289()//Position - 0x10246
{
	func_287("Running start routines.");
	Global_113104++;
}

int func_290(int iParam0)//Position - 0x10260
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
