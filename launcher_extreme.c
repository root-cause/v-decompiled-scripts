...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112735[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_289(&(Global_112735[Var0.f_0 /*10*/].f_9));
			}
		}
		func_277(&Var0, 1);
	}
	if (!func_274(&iVar64, &Var0, Var61, 1f))
	{
		func_273();
	...
	while (true)
	{
		...
		func_209(Var0.f_0);
		func_202(&iLocal_94, &(Var0.f_9), Var61);
		if (Var0.f_0 == 18)
		{
			func_201(&Var0);
			func_196(&Var0, Var61, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (Var0.f_0 == 19)
		{
			func_201(&Var0);
			...
			{
				func_196(&Var0, Var61, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_195() && func_194(Var0.f_28[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && AUDIO::HAS_SOUND_FINISHED(iLocal_96)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, -1))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_96, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", false, 0);
			}
			if ((iLocal_95 == 0 && func_194(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var61, Var0.f_15, Var0.f_15, Var0.f_15, false, false, 0))
			{
				Var69 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
				if (Var69.f_2 < 100f)
				{
					iLocal_95 = 1;
					func_193("TOPMAZE_HELP" /* GXT: Get to the top of the Maze Tower to start this mission. */, -1);
					func_290("Player below mission start location so displaying help text TOPMAZE_HELP");
				}
			}
		}
		if (func_178(&Var0, 0) || func_176(&Var0))
		{
			if (func_175(Var0.f_0))
			{
				func_172(Var0.f_0, &iLocal_98);
			}
			if (!func_2(&Var0))
			{
				func_277(&Var0, 1);
...
int func_1(int iParam0)//Position - 0x3EA
{
...
int func_2(int iParam0)//Position - 0x408
{
	struct<4> Var0;
	char* sVar32;
...
void func_3(int iParam0, char* sParam1)//Position - 0x4CB
{
	func_21(sParam1);
...
void func_4(int iParam0)//Position - 0x587
{
	int iVar0;
	int iVar1;
...
void func_6(int iParam0)//Position - 0x794
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0)//Position - 0xB7C
{
	Global_63355 = 1;
	Global_63358 = 1;
	if (Global_75457 > 15)
...
void func_8(int iParam0)//Position - 0xBC7
{
...
struct<2> func_9(int iParam0)//Position - 0xBFB
{
	struct<2> Var0;
	char[] cVar2[8];
...
void func_13()//Position - 0xCED
{
	Global_63521 = 0;
}

void func_14()//Position - 0xCF9
{
	Global_63381 = 0;
...
var func_15(int iParam0)//Position - 0xD4D
{
	var uVar0;
...
void func_17(int iParam0)//Position - 0xD8B
{
	Global_78819 = iParam0;
	Global_78820 = iParam0;
}

void func_18()//Position - 0xD9F
{
	int iVar0;
...
void func_21(char* sParam0)//Position - 0xE44
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xE57
{
	MISC::CLEAR_BIT(&(Global_100681.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xE74
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1B4D
{
	int iVar0;
	int iVar1;
...
int func_26(var uParam0)//Position - 0x29D6
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x29F8
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A80
{
...
int func_29(int iParam0)//Position - 0x2AC0
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2AEE
{
...
int func_31(int iParam0)//Position - 0x2BCA
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2C0C
{
	int iVar0;
...
int func_33(int iParam0, bool bParam1, int iParam2)//Position - 0x2C6F
{
	int iVar0;
...
int func_34(bool bParam0, int iParam1)//Position - 0x2CFD
{
	struct<82> Var0;
...
void func_35(bool bParam0, var uParam1, int iParam2)//Position - 0x2D3F
{
	int iVar0;
...
bool func_36(bool bParam0)//Position - 0x2F9B
{
	return bParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2FA7
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x3252
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x3302
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x34F5
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0)//Position - 0x3515
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x35C6
{
	char* sVar0;
...
int func_43(int iParam0, bool bParam1, bool bParam2)//Position - 0x36F5
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3763
{
...
int func_45(int iParam0)//Position - 0x383C
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x3879
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x389E
{
	return Global_2028[iParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x38AD
{
	bool bVar0;
	int iVar1;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x3A4D
{
	int iVar0;
	var uVar1;
...
int func_50(var uParam0)//Position - 0x3A8A
{
	int iVar0;
	int iVar1;
...
int func_51()//Position - 0x3ABE
{
	return Global_1574918;
}

int func_52(int iParam0, int iParam1)//Position - 0x3ACA
{
	int iVar0;
	var uVar1;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3AF6
{
	int iVar0;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x4040
{
	int iVar0;
...
int func_55()//Position - 0x4281
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_56()//Position - 0x429A
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x4397
{
	return Global_43257 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x43A5
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x4498
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x4720
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x47C1
{
...
int func_62(int iParam0, int iParam1)//Position - 0x499B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x55FC
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x5637
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x58AB
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x58E7
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5E36
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5E7A
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x65F9
{
	if (bParam6)
	{
...
int func_70(var uParam0)//Position - 0x6640
{
...
bool func_71(int iParam0)//Position - 0x669B
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x66AB
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x670C
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x6AA5
{
	return Global_32163;
}

int func_75(int iParam0)//Position - 0x6AB0
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6AC0
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x6B62
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_78()//Position - 0x72B2
{
...
int func_79()//Position - 0x75AD
{
	return Global_2652258.f_2650;
}

int func_80(struct<3> Param0)//Position - 0x75BC
{
...
int func_81(int iParam0)//Position - 0x75E6
{
	if (iParam0 != func_90())
	{
...
Vector3 func_82(int iParam0, int iParam1)//Position - 0x763E
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_83(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x76E8
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_84(struct<3> Param0, float fParam3)//Position - 0x777D
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_85(int iParam0)//Position - 0x77C1
{
	struct<6> Var0;
...
struct<6> func_86(int iParam0)//Position - 0x7945
{
	return func_87(iParam0);
}

struct<6> func_87(int iParam0)//Position - 0x7953
{
	struct<6> Var0;
...
int func_88(int iParam0, var uParam1)//Position - 0x841B
{
	switch (iParam0)
	{
		case 0:
...
int func_89(int iParam0)//Position - 0x849D
{
	if (iParam0 != func_90())
	{
...
int func_90()//Position - 0x84F5
{
	return -1;
}

Vector3 func_91(int iParam0)//Position - 0x84FE
{
	switch (iParam0)
	{
		case 1:
...
int func_92()//Position - 0x8775
{
	return func_93(PLAYER::PLAYER_ID());
}

int func_93(int iParam0)//Position - 0x8785
{
	return MISC::GET_BITS_IN_RANGE(Global_2657589[iParam0 /*466*/].f_321.f_3, 28, 31);
}

int func_94(int iParam0)//Position - 0x87A2
{
	return func_72(iParam0, 0, 0);
}

int func_95(int iParam0)//Position - 0x87B2
{
	switch (iParam0)
	{
		case -1:
...
bool func_96()//Position - 0x8ADB
{
	return Global_100733.f_387 > 0;
}

var func_97()//Position - 0x8AEC
{
	var uVar0;
...
void func_98(var uParam0, int iParam1)//Position - 0x8B32
{
	if (iParam1 <= 0)
	{
		return;
...
void func_99(var uParam0, int iParam1)//Position - 0x8BB8
{
...
void func_100(var uParam0, int iParam1)//Position - 0x8BEB
{
	int iVar0;
	int iVar1;
...
int func_101(int iParam0, int iParam1)//Position - 0x8C3C
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_102(int iParam0)//Position - 0x8CDE
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_103(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_103(bool bParam0, int iParam1, int iParam2)//Position - 0x8D00
{
	if (bParam0)
	{
		return iParam1;
...
int func_104(var uParam0)//Position - 0x8D17
{
	return uParam0 & 15;
}

void func_105(var uParam0, int iParam1)//Position - 0x8D24
{
...
void func_106(var uParam0, int iParam1)//Position - 0x8D5E
{
...
void func_107(var uParam0, int iParam1)//Position - 0x8D99
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_108()//Position - 0x8DD5
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_109(int iParam0)//Position - 0x8DEE
{
	var uVar0;
	char cVar1[24];
...
bool func_110()//Position - 0x8E47
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_111()//Position - 0x8E5D
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_112(char* sParam0, int iParam1, int iParam2)//Position - 0x8E73
{
...
int func_113(bool bParam0)//Position - 0x8EB5
{
...
struct<2> func_114(int iParam0)//Position - 0x8EDD
{
	struct<2> Var0;
...
void func_115(int iParam0, var uParam1)//Position - 0x932A
{
	switch (iParam0)
	{
		case 0:
...
int func_117(int iParam0)//Position - 0xA602
{
	switch (iParam0)
	{
		case 0:
...
int func_118(var* uParam0)//Position - 0xA948
{
	int iVar0;
...
void func_119(int iParam0)//Position - 0xA9ED
{
	struct<2> Var0;
...
void func_120(int iParam0)//Position - 0xAA88
{
	if (iParam0 < 63)
	{
		func_121();
...
void func_122(int iParam0)//Position - 0xAAE6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_123(int iParam0)//Position - 0xAB3F
{
...
int func_124(int iParam0)//Position - 0xABC2
{
	int iVar0;
...
void func_125(int iParam0, int iParam1, int iParam2)//Position - 0xABF3
{
	func_126(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_126(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAC08
{
	int iVar0;
...
int func_128(int iParam0, int iParam1, int iParam2)//Position - 0xACBB
{
...
int func_129(int iParam0, int iParam1, int iParam2)//Position - 0xACD6
{
	int iVar0;
...
int func_130(int iParam0)//Position - 0xAD22
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0xAD6B
{
	if (func_194(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_132(int iParam0)//Position - 0xAD8B
{
	switch (iParam0)
	{
		case 5:
...
void func_135(var uParam0, bool bParam1, bool bParam2)//Position - 0xAEAE
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_194(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_194(uParam0->f_41[iVar0]))
		{
...
int func_136(int iParam0)//Position - 0xAFA3
{
	switch (iParam0)
	{
		case 5:
...
void func_137(bool bParam0)//Position - 0xB00E
{
	int iVar0;
...
void func_138(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB04D
{
	if (bParam0)
	{
...
bool func_139()//Position - 0xB19A
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_140(int iParam0, int iParam1)//Position - 0xB1B4
{
	bool bVar0;
...
int func_141(int iParam0, bool bParam1)//Position - 0xB1FF
{
	int iVar0;
	int iVar1;
...
int func_142(int iParam0)//Position - 0xB240
{
...
bool func_143()//Position - 0xB27F
{
	return BitTest(Global_2621446, 3);
}

int func_144(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB28D
{
	int iVar0;
...
void func_146(int iParam0)//Position - 0xB2E7
{
	if (iParam0 == 1)
	{
...
int func_147(char* sParam0)//Position - 0xB30A
{
...
void func_148()//Position - 0xB347
{
	Global_20591 = 0;
	func_149();
}

void func_149()//Position - 0xB357
{
...
void func_151()//Position - 0xB3C3
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_152(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_152(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB41B
{
...
void func_153(int iParam0)//Position - 0xB5B3
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_155(int iParam0)//Position - 0xB630
{
	if (func_160())
	{
		return;
...
void func_156(int iParam0)//Position - 0xB663
{
	if (func_160())
	{
		return;
...
void func_157(bool bParam0, bool bParam1)//Position - 0xB6ED
{
	if (bParam0)
	{
		if (func_159(0))
...
bool func_158()//Position - 0xB761
{
	return BitTest(Global_1962996, 5);
}

int func_159(int iParam0)//Position - 0xB76F
{
	if (iParam0 == 1)
	{
...
bool func_160()//Position - 0xB7C6
{
	return BitTest(Global_1962996, 19);
}

int func_161(int iParam0)//Position - 0xB7D5
{
...
int func_162(int iParam0)//Position - 0xB816
{
	int iVar0;
	...
	iVar0 = func_164(&(Global_112735[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
void func_163(int iParam0)//Position - 0xB85B
{
...
int func_164(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB88D
{
	int iVar0;
...
void func_165(var uParam0, int iParam1)//Position - 0xB9C4
{
	int iVar0;
...
bool func_166(int iParam0)//Position - 0xBA13
{
	return func_167(iParam0, Global_43257);
}

int func_167(int iParam0, int iParam1)//Position - 0xBA24
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_168(int iParam0)//Position - 0xBC05
{
	if (Global_43257 == 15)
	{
		return 0;
...
int func_169()//Position - 0xBC27
{
	return func_170(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_170(char* sParam0, int iParam1)//Position - 0xBC38
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_172(int iParam0, int iParam1)//Position - 0xBCA5
{
	switch (iParam0)
	{
		case 0:
			*iParam1 = func_173(-1604.668f, 5239.1f, 3.01f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 66);
			HUD::SET_BLIP_COLOUR(*iParam1, 42);
			break;
		
		case 1:
			*iParam1 = func_173(-1592.84f, 5214.04f, 3.01f, 0);
		...
		case 2:
		case 3:
			*iParam1 = func_173(190.26f, -956.35f, 29.63f, 0);
		...
		case 4:
			*iParam1 = func_173(414f, -761f, 29f, 0);
		...
		case 9:
			*iParam1 = func_173(-1622.89f, 4204.87f, 83.3f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 66);
			HUD::SET_BLIP_COLOUR(*iParam1, 42);
			break;
		...
		case 13:
			if (iParam0 == 11)
			{
				*iParam1 = func_173(1835.53f, 4705.86f, 38.1f, 0);
			}
			else if (iParam0 == 12)
			{
				*iParam1 = func_173(1826.13f, 4698.88f, 38.92f, 0);
			}
			else
			{
				*iParam1 = func_173(637.02f, 119.7093f, 89.5f, 0);
			}
		...
		case 19:
			if (iParam0 == 18)
			{
				*iParam1 = func_173(-954.19f, -2760.05f, 14.64f, 0);
			}
			else
			{
				*iParam1 = func_173(-63.8f, -809.5f, 321.8f, 0);
			}
		...
		case 23:
			if (iParam0 == 21)
			{
				*iParam1 = func_173(-1877.82f, -440.649f, 45.05f, 0);
			}
			else
			{
				*iParam1 = func_173(-915.6f, 6139.2f, 5.5f, 0);
			}
		...
		case 27:
			*iParam1 = func_173(-1104.93f, 291.25f, 64.3f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 66);
			HUD::SET_BLIP_COLOUR(*iParam1, 44);
			break;
		...
		case 34:
			*iParam1 = func_173(-303.82f, 6211.29f, 31.05f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 386);
			HUD::SET_BLIP_COLOUR(*iParam1, 44);
			break;
		
		case 43:
			*iParam1 = func_173(-44.75f, -1288.67f, 28.21f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 149);
			HUD::SET_BLIP_COLOUR(*iParam1, 44);
			break;
		
		case 46:
			*iParam1 = func_173(-149.75f, 285.81f, 93.67f, 0);
			HUD::SET_BLIP_SPRITE(*iParam1, 66);
			HUD::SET_BLIP_COLOUR(*iParam1, 43);
			break;
		...
		case 48:
			if (iParam0 == 47)
			{
				*iParam1 = func_173(-70.71f, 301.43f, 106.79f, 0);
			}
			else
			{
				*iParam1 = func_173(-257.22f, 292.85f, 90.63f, 0);
			}
...
int func_173(struct<3> Param0, bool bParam3)//Position - 0xC115
{
	int iVar0;
...
float func_174(bool bParam0, float fParam1, float fParam2)//Position - 0xC141
{
	if (bParam0)
	{
		return fParam1;
...
int func_175(int iParam0)//Position - 0xC158
{
	switch (iParam0)
	{
		case 0:
...
int func_176(var uParam0)//Position - 0xC1E7
{
	if (*uParam0 == 18)
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -954.5357f, -2760.5532f, 11.916363f, -947.6847f, -2749.719f, 15.631608f, 26f, false, true, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				func_290("Special launching Extreme 2");
				return 1;
			}
			else if ((!func_177(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && func_194(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_152(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 3f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_177(int iParam0, int iParam1)//Position - 0xC28E
{
	if (func_131(iParam0))
	{
...
int func_178(var uParam0, int iParam1)//Position - 0xC2C1
{
	switch (uParam0->f_16)
	{
		case 0:
			if (*uParam0 == 12)
			{
				...
				else if (func_194(uParam0->f_28[0]))
				{
					if (func_180(uParam0))
					{
						if (func_184(2))
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_194(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
					{
...
void func_179()//Position - 0xCAA4
{
	func_27(&(Global_104212.f_2890), &Global_104212, 0, 1, 1, 0);
}

int func_180(var uParam0)//Position - 0xCABF
{
	float fVar0;
...
void func_181(int iParam0, int iParam1)//Position - 0xCB4D
{
	if (iParam0 == 1)
	{
		if (!func_134(iParam1))
...
int func_182(bool bParam0)//Position - 0xCBB1
{
	int iVar0;
...
int func_183(int iParam0)//Position - 0xCC48
{
	if (func_194(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_184(int iParam0)//Position - 0xCC72
{
	bool bVar0;
...
var func_185()//Position - 0xD38F
{
	return Global_100720.f_1;
}

int func_186()//Position - 0xD39D
{
	if (Global_97603 != -1)
	{
...
bool func_189()//Position - 0xD404
{
	return Global_100733.f_388 > 0;
}

var func_190(int iParam0, int iParam1)//Position - 0xD415
{
	switch (iParam0)
	{
		case 5:
...
var func_191()//Position - 0xD44D
{
	return Global_1575060;
}

int func_192()//Position - 0xD459
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_193(char* sParam0, int iParam1)//Position - 0xD475
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_194(int iParam0)//Position - 0xD48C
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_196(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD4CF
{
	var uVar0;
	
	if ((((func_194(PLAYER::PLAYER_PED_ID()) && func_194(iParam0->f_28[0])) && !func_195()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_200(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_197(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD557
{
...
void func_198(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD592
{
...
void func_199(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD5E8
{
...
float func_200(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD683
{
	struct<3> Var0;
...
void func_201(int iParam0)//Position - 0xD6BD
{
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		if (func_194(iParam0->f_28[0]))
		{
...
void func_202(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD6EA
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_203(int iParam0, bool bParam1)//Position - 0xD7DB
{
	if (iParam0 == -1)
	{
		return;
...
int func_204(int iParam0)//Position - 0xD817
{
	if (Global_78554 == iParam0)
	{
		if (Global_78555 == -1)
...
void func_205(int iParam0, int iParam1)//Position - 0xD850
{
	bool bVar0;
	int iVar1;
...
bool func_206()//Position - 0xD8EE
{
	return Global_97990;
}

void func_207(int iParam0)//Position - 0xD8FA
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_208(iParam0);
...
void func_209(int iParam0)//Position - 0xD9F9
{
	if (iParam0 == -1)
	{
		iParam0 = func_169();
...
int func_210(var uParam0, bool bParam1)//Position - 0xDA21
{
	struct<27> Var0;
	...
	if ((func_247(*uParam0) || func_245(*uParam0)) || Global_78804 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_211(int iParam0, var uParam1, int iParam2)//Position - 0xDC91
{
	int iVar0;
	int iVar1;
...
int func_212(int iParam0)//Position - 0xDFE9
{
...
int func_213(var uParam0)//Position - 0xE009
{
...
int func_214(var uParam0)//Position - 0xE021
{
...
void func_215(var uParam0)//Position - 0xE046
{
	int iVar0;
	int iVar1;
	...
	if (func_194(PLAYER::PLAYER_PED_ID()))
	{
		iVar0 = 0;
...
void func_216(int* iParam0)//Position - 0xE34A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_217(var uParam0)//Position - 0xE375
{
	int iVar0;
...
int func_218(var uParam0, bool bParam1, bool bParam2)//Position - 0xE3F5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_219(int iParam0, int iParam1)//Position - 0xE5B3
{
	int iVar0;
...
int func_220(var uParam0, bool bParam1, int iParam2)//Position - 0xE5E3
{
	int iVar0;
	int iVar1;
...
int func_221(int iParam0)//Position - 0xE89F
{
...
int func_222(int iParam0, float fParam1)//Position - 0xE8D3
{
	float fVar0;
	
	if (func_194(PLAYER::PLAYER_PED_ID()) && func_194(iParam0))
	{
...
bool func_223(int iParam0, float fParam1)//Position - 0xE949
{
	return func_224(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_224(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE961
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!func_194(iParam0) || !func_194(iParam1))
	{
		if (iVar4 != -1)
		{
	...
	uVar0 = func_225(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_225(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xEA22
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_226(int iParam0, int iParam1)//Position - 0xEB4E
{
	int iVar0;
...
int func_228(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEC5D
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_229(struct<3> Param0, struct<3> Param3)//Position - 0xECEE
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_230(struct<3> Param0)//Position - 0xED0F
{
	float fVar0;
	float fVar1;
...
void func_231(var uParam0)//Position - 0xED4E
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_232(int iParam0, int iParam1)//Position - 0xED69
{
	int iVar0;
...
int func_233(int iParam0)//Position - 0xEDA8
{
...
int func_234(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEDD0
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_235(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEECB
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_236(int iParam0, float fParam1)//Position - 0xEFD7
{
	var uVar0;
	struct<3> Var1;
...
int func_237(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF06C
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_238(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF0FA
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_239(int iParam0)//Position - 0xF142
{
...
void func_240(int iParam0)//Position - 0xF18C
{
	int iVar0;
...
int func_241(int iParam0)//Position - 0xF229
{
	if (iParam0 == -1)
	{
		iParam0 = func_169();
...
int func_242(int iParam0)//Position - 0xF2BE
{
...
int func_245(int iParam0)//Position - 0xF33D
{
	if ((func_246() && Global_100681.f_11 == 6) && iParam0 == func_170(&(Global_100681.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_247(int iParam0)//Position - 0xF3AF
{
	if (func_113(0))
	{
...
int func_248(int iParam0)//Position - 0xF3D7
{
	switch (*iParam0)
	{
		case 17:
...
int func_249(var uParam0)//Position - 0xF44C
{
	int iVar0[1];
	int iVar2;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_255(&(uParam0->f_48), "rcmextreme4", "idle_a", "idle_c");
			iLocal_91 = 1;
			break;
		...
		case 2:
			func_250(&(uParam0->f_28[0]), 1732.27f, 96.36f, 170.29f, -98.56f);
...
void func_250(int* iParam0, struct<3> Param1, float fParam4)//Position - 0xF550
{
	func_251(iParam0, iLocal_93, Param1, fParam4, 26);
	PED::SET_PED_DEFAULT_COMPONENT_VARIATION(*iParam0);
	PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(*iParam0, false);
	PED::SET_PED_NAME_DEBUG(*iParam0, "EXTREME LAUNCHER RC");
}

void func_251(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xF582
{
	func_252(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_252(int* iParam0)//Position - 0xF5A3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_253(var uParam0)//Position - 0xF5E4
{
	if (func_214(uParam0))
	{
...
int func_254(int iParam0)//Position - 0xF60E
{
	int iVar0;
...
void func_255(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xF63F
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_256(var uParam0)//Position - 0xF67B
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_255(&(uParam0->f_48), "rcmextreme3", "idle_calm", "fidget_02");
			iLocal_91 = 1;
			break;
		...
		case 2:
			...
			{
				if (func_257(&(uParam0->f_28[0]), 52, -63.8f, -809.5f, 321.8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
...
int func_257(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF80E
{
	if (func_258(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF86A
{
	int iVar0;
...
int func_259(var uParam0, int iParam1)//Position - 0xF8F8
{
	int iVar0;
...
int func_260(var uParam0)//Position - 0xF93E
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_255(&(uParam0->f_48), "rcmextreme2", "sitting_idle", "loop_punching");
			iLocal_91 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_257(&(uParam0->f_28[0]), 52, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_261(&(uParam0->f_35[0]), iVar0[0], -950.8f, -2751.98f, 13.21f, 199.05f);
			...
			{
				func_261(&(uParam0->f_35[1]), iVar0[0], -950.192f, -2755.96f, 13.3639f, -178.182f);
			...
			{
				func_261(&(uParam0->f_35[2]), iVar0[1], -957.23f, -2764.89f, 14.04f, 147.61f);
...
void func_261(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFC42
{
	func_262(iParam0);
...
void func_262(int* iParam0)//Position - 0xFC84
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_263(var uParam0)//Position - 0xFD20
{
	int iVar0[1];
	int iVar2;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_255(&(uParam0->f_48), "rcm_extreme1", "idle_a", "idle_c");
			iLocal_91 = 1;
			break;
		...
		case 2:
			func_250(&(uParam0->f_28[0]), -188.22f, 1296.1f, 302.86f, 43.7f);
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iVar0[iVar2]);
...
int func_264(int iParam0)//Position - 0xFE0C
{
	struct<27> Var0;
	bool bVar32;
...
int func_265(int iParam0)//Position - 0xFE5D
{
	char* sVar0;
...
int func_266(int iParam0)//Position - 0xFF16
{
	var uVar0;
...
int func_267(int iParam0)//Position - 0xFFD7
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_268(int iParam0, char* sParam1)//Position - 0x1005E
{
...
int func_269(int iParam0)//Position - 0x10140
{
...
int func_270(int iParam0)//Position - 0x1016B
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_271(int iParam0)//Position - 0x10196
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_272(int iParam0)//Position - 0x101C1
{
	if (func_242(iParam0))
	{
		return 0;
...
void func_273()//Position - 0x101F6
{
	func_290("Running end routines.");
	Global_113366 = (Global_113366 - 1);
}

int func_274(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10210
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_275((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_275((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_275(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10275
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_276(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_276(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x102ED
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_277(int iParam0, bool bParam1)//Position - 0x10368
{
	if (*iParam0 == 18)
	{
		if (func_194(iParam0->f_35[0]))
		{
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(iParam0->f_35[0], 1);
		}
		if (func_194(iParam0->f_35[1]))
		{
...
int func_278(var uParam0)//Position - 0x10449
{
	if (func_214(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_279(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x1047F
{
...
void func_280(var uParam0, bool bParam1)//Position - 0x1049F
{
	func_281(&(uParam0->f_41), bParam1);
}

void func_281(var uParam0, bool bParam1)//Position - 0x104B1
{
	int iVar0;
...
void func_282(int* iParam0, bool bParam1)//Position - 0x104EF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_283(var uParam0, bool bParam1)//Position - 0x1052A
{
	func_284(&(uParam0->f_35), bParam1);
}

void func_284(var uParam0, bool bParam1)//Position - 0x1053C
{
	int iVar0;
...
void func_285(int* iParam0)//Position - 0x10579
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_286(var uParam0, int iParam1)//Position - 0x105B1
{
	func_287(&(uParam0->f_28), iParam1);
}

void func_287(var uParam0, int iParam1)//Position - 0x105C3
{
	int iVar0;
...
void func_288(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10604
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_289(var uParam0)//Position - 0x10654
{
	if (*uParam0 == -1)
	{
		return;
...
void func_290(char* sParam0)//Position - 0x10691
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_291(var uParam0)//Position - 0x106A3
{
	*uParam0 = -1;
...
void func_292()//Position - 0x106D6
{
	func_290("Running start routines.");
	Global_113366++;
}

int func_293(int iParam0)//Position - 0x106F0
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
