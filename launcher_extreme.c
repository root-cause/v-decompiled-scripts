...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113457[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_295(&(Global_113457[Var0.f_0 /*10*/].f_9));
			}
		}
		func_283(&Var0, 1);
	}
	if (!func_280(&iVar64, &Var0, Var61, 1f))
	{
		func_279();
	...
	if (Var0.f_0 == 17)
	{
		iLocal_95 = PED::ADD_SCENARIO_BLOCKING_AREA(Var61 - Vector(40f, 40f, 40f), Var61 + Vector(40f, 40f, 40f), false, true, true, true, 1);
	...
	while (true)
	{
		...
		func_215(Var0.f_0);
		func_208(&iLocal_92, &(Var0.f_9), Var61);
		if (Var0.f_0 == 18)
		{
			func_207(&Var0);
			func_202(&Var0, Var61, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (Var0.f_0 == 19)
		{
			func_207(&Var0);
			...
			{
				func_202(&Var0, Var61, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_201() && func_200(Var0.f_28[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && AUDIO::HAS_SOUND_FINISHED(iLocal_94)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, -1))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_94, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", false, 0);
			}
			if ((iLocal_93 == 0 && func_200(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var61, Var0.f_15, Var0.f_15, Var0.f_15, false, false, 0))
			{
				Var69 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
				if (Var69.f_2 < 100f)
				{
					iLocal_93 = 1;
					func_199("TOPMAZE_HELP" /* GXT: Get to the top of the Maze Tower to start this mission. */, -1);
					func_296("Player below mission start location so displaying help text TOPMAZE_HELP");
				}
			}
		}
		if (func_184(&Var0, 0) || func_182(&Var0))
		{
			if (func_181(Var0.f_0))
			{
				func_178(Var0.f_0, &iLocal_96);
			}
			if (!func_2(&Var0))
			{
				func_283(&Var0, 1);
...
int func_1(int iParam0)//Position - 0x3EC
{
...
int func_2(int iParam0)//Position - 0x40A
{
	struct<4> Var0;
	char* sVar32;
...
void func_3(int iParam0, char* sParam1)//Position - 0x4CD
{
	func_21(sParam1);
...
void func_17(int iParam0)//Position - 0xD8D
{
...
void func_21(char* sParam0)//Position - 0xE46
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xE59
{
	MISC::CLEAR_BIT(&(Global_101392.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xE76
{
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A82
{
...
int func_29(int iParam0)//Position - 0x2AC2
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2AF0
{
...
int func_31(int iParam0)//Position - 0x2BCC
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2C0E
{
	int iVar0;
...
int func_33(int iParam0, bool bParam1, int iParam2)//Position - 0x2C71
{
	int iVar0;
...
int func_34(bool bParam0, int iParam1)//Position - 0x2CFF
{
	struct<82> Var0;
...
void func_35(bool bParam0, var uParam1, int iParam2)//Position - 0x2D41
{
	int iVar0;
...
bool func_36(bool bParam0)//Position - 0x2F9D
{
	return bParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2FA9
{
	int iVar0;
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x3304
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x34F7
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x35C8
{
	char* sVar0;
...
int func_43(int iParam0, bool bParam1, bool bParam2)//Position - 0x36F7
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3765
{
...
int func_45(int iParam0)//Position - 0x383E
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x387B
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x38A0
{
...
int func_50(int iParam0, var uParam1)//Position - 0x3A78
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(uParam1));
}

int func_51(var uParam0)//Position - 0x3A8D
{
	int iVar0;
	int iVar1;
...
int func_53(int iParam0, int iParam1)//Position - 0x3ACD
{
	int iVar0;
	var uVar1;
...
int func_54(int iParam0, var uParam1)//Position - 0x3AF1
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(uParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3B06
{
	int iVar0;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x4050
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x4730
{
	switch (iParam0)
	{
...
int func_63(int iParam0)//Position - 0x47D1
{
...
int func_64(int iParam0, int iParam1)//Position - 0x49BD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x56DE
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x5719
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x598D
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x59C9
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5F18
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5F5C
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x66DB
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x6722
{
...
bool func_73(int iParam0)//Position - 0x677D
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x678D
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x67ED
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x6B95
{
	return Global_32828;
}

int func_77(int iParam0)//Position - 0x6BA0
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6BB0
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6C52
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x73BD
{
...
int func_81()//Position - 0x76B8
{
	return Global_2652572.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x76C7
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x76F1
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x7706
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x771D
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x7775
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x781F
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x78B4
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x78F8
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x7A7C
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x7A8A
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x8552
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x85D4
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x862C
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x8635
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x88A1
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x88B1
{
	return MISC::GET_BITS_IN_RANGE(Global_2657921[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x88CE
{
	return func_74(iParam0, 0, 0);
}

int func_99(int iParam0)//Position - 0x88DE
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x8C14
{
	return Global_101444.f_393 > 0;
}

var func_101()//Position - 0x8C25
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8C6B
{
	if (iParam1 <= 0)
	{
		return;
...
void func_103(var uParam0, int iParam1)//Position - 0x8CF1
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8D24
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8D75
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8E17
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8E39
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8E50
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8E5D
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8E97
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8ED2
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8F0E
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8F27
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8F80
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8F96
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8FAC
{
...
int func_117(bool bParam0)//Position - 0x8FEE
{
...
struct<2> func_118(int iParam0)//Position - 0x9016
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x9463
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA73B
{
	switch (iParam0)
	{
		case 0:
...
int func_122(var* uParam0)//Position - 0xAA81
{
	int iVar0;
...
void func_123(int iParam0)//Position - 0xAB26
{
	struct<2> Var0;
...
void func_126(int iParam0)//Position - 0xAC1F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xAC78
{
...
int func_128(int iParam0)//Position - 0xACFB
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAD2C
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAD41
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xADF4
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAE0F
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xAE5B
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xAEA4
{
	if (func_200(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xAEC4
{
	switch (iParam0)
	{
		case 5:
...
int func_138(int iParam0)//Position - 0xAF94
{
	switch (iParam0)
	{
		case 5:
...
void func_139(var uParam0, bool bParam1, bool bParam2)//Position - 0xAFE7
{
	int iVar0;
...
int func_140(int iParam0)//Position - 0xB0DC
{
	switch (iParam0)
	{
		case 5:
...
void func_141(bool bParam0)//Position - 0xB147
{
	int iVar0;
...
void func_142(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB186
{
	if (bParam0)
	{
...
bool func_143()//Position - 0xB2D3
{
	return BitTest(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

bool func_144(int iParam0, int iParam1)//Position - 0xB2ED
{
	bool bVar0;
...
int func_145(int iParam0, bool bParam1)//Position - 0xB346
{
	int iVar0;
	int iVar1;
...
int func_146(var uParam0)//Position - 0xB387
{
	int iVar0;
...
int func_147(int iParam0)//Position - 0xB3A9
{
...
bool func_148()//Position - 0xB3E8
{
	return BitTest(Global_2621446, 3);
}

int func_149(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB3F6
{
	int iVar0;
...
void func_151(int iParam0)//Position - 0xB450
{
	if (iParam0 == 1)
	{
...
int func_152(char* sParam0)//Position - 0xB473
{
...
void func_153()//Position - 0xB4B0
{
	Global_21032 = 0;
	func_154();
}

void func_154()//Position - 0xB4C0
{
...
void func_156()//Position - 0xB52C
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_157(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_157(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB584
{
...
void func_158(int iParam0)//Position - 0xB5DB
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_159(bool bParam0, bool bParam1)//Position - 0xB607
{
...
void func_161(int iParam0)//Position - 0xB7A9
{
	if (func_166())
	{
		return;
...
void func_162(int iParam0)//Position - 0xB7DC
{
	if (func_166())
	{
		return;
...
void func_163(bool bParam0, bool bParam1)//Position - 0xB866
{
	if (bParam0)
	{
		if (func_165(0))
...
bool func_164()//Position - 0xB8DA
{
	return BitTest(Global_1956030, 5);
}

int func_165(int iParam0)//Position - 0xB8E8
{
	if (iParam0 == 1)
	{
...
bool func_166()//Position - 0xB93F
{
	return BitTest(Global_1956030, 19);
}

int func_167(int iParam0)//Position - 0xB94E
{
...
int func_168(int iParam0)//Position - 0xB98F
{
	int iVar0;
	...
	iVar0 = func_170(&(Global_113457[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
void func_169(int iParam0)//Position - 0xB9D4
{
...
int func_170(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xBA06
{
	int iVar0;
...
void func_171(var uParam0, int iParam1)//Position - 0xBB3D
{
	int iVar0;
...
bool func_172(int iParam0)//Position - 0xBB8C
{
	return func_173(iParam0, Global_43922);
}

int func_173(int iParam0, int iParam1)//Position - 0xBB9D
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_174(int iParam0)//Position - 0xBD7E
{
	if (Global_43922 == 15)
	{
		return 0;
...
int func_175()//Position - 0xBDA0
{
	return func_176(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_176(char* sParam0, int iParam1)//Position - 0xBDB1
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_178(int iParam0, int iParam1)//Position - 0xBE1E
{
	switch (iParam0)
	{
		case 0:
...
int func_179(struct<3> Param0, bool bParam3)//Position - 0xC28E
{
	int iVar0;
...
float func_180(bool bParam0, float fParam1, float fParam2)//Position - 0xC2BA
{
	if (bParam0)
	{
		return fParam1;
...
int func_181(int iParam0)//Position - 0xC2D1
{
	switch (iParam0)
	{
		case 0:
...
int func_182(var uParam0)//Position - 0xC360
{
	if (*uParam0 == 18)
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -954.5357f, -2760.5532f, 11.916363f, -947.6847f, -2749.719f, 15.631608f, 26f, false, true, 0))
		{
			...
			else if ((!func_183(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && func_200(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_157(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 3f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_183(int iParam0, int iParam1)//Position - 0xC407
{
	if (func_135(iParam0))
	{
...
int func_184(var uParam0, int iParam1)//Position - 0xC43A
{
	switch (uParam0->f_16)
	{
		case 0:
			if (*uParam0 == 12)
			{
				...
				else if (func_200(uParam0->f_28[0]))
				{
					if (func_186(uParam0))
					{
						if (func_190(2))
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_200(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
					{
...
void func_185()//Position - 0xCC1D
{
	func_27(&(Global_104933.f_2890), &Global_104933, 0, 1, 1, 0);
}

int func_186(var uParam0)//Position - 0xCC38
{
	float fVar0;
...
void func_187(int iParam0, int iParam1)//Position - 0xCCC6
{
	if (iParam0 == 1)
	{
		if (!func_138(iParam1))
...
int func_188(bool bParam0)//Position - 0xCD2A
{
	int iVar0;
...
int func_189(int iParam0)//Position - 0xCDC1
{
	if (func_200(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_190(int iParam0)//Position - 0xCDEB
{
	bool bVar0;
...
var func_191()//Position - 0xD508
{
	return Global_101431.f_1;
}

int func_192()//Position - 0xD516
{
	if (Global_98294 != -1)
	{
...
bool func_195()//Position - 0xD57D
{
	return Global_101444.f_394 > 0;
}

var func_196(int iParam0, int iParam1)//Position - 0xD58E
{
	switch (iParam0)
	{
		case 5:
...
var func_197()//Position - 0xD5C6
{
	return Global_1575079;
}

int func_198()//Position - 0xD5D2
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_199(char* sParam0, int iParam1)//Position - 0xD5EE
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_200(int iParam0)//Position - 0xD605
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_202(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD648
{
	var uVar0;
	
	if ((((func_200(PLAYER::PLAYER_PED_ID()) && func_200(iParam0->f_28[0])) && !func_201()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_206(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_205(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
		func_203(&uVar0, cParam4, sParam5, 7, 0, 0);
...
void func_203(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD6D0
{
...
void func_204(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD70B
{
...
void func_205(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD761
{
...
float func_206(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD7FC
{
	struct<3> Var0;
...
void func_207(int iParam0)//Position - 0xD836
{
...
void func_208(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD863
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_206(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_211(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_206(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_213(iParam0);
				}
			}
...
void func_209(int iParam0, bool bParam1)//Position - 0xD954
{
	if (iParam0 == -1)
	{
		return;
...
int func_210(int iParam0)//Position - 0xD990
{
	if (Global_79244 == iParam0)
	{
		if (Global_79245 == -1)
...
void func_211(int iParam0, int iParam1)//Position - 0xD9C9
{
	bool bVar0;
	int iVar1;
...
bool func_212()//Position - 0xDA67
{
	return Global_98681;
}

void func_213(int iParam0)//Position - 0xDA73
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_214(iParam0);
...
void func_214(int iParam0)//Position - 0xDA8A
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_215(int iParam0)//Position - 0xDB72
{
	if (iParam0 == -1)
	{
		iParam0 = func_175();
...
int func_216(var uParam0, bool bParam1)//Position - 0xDB9A
{
	struct<27> Var0;
	...
	if ((func_253(*uParam0) || func_251(*uParam0)) || Global_79494 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_220(&(uParam0->f_48)) && bParam1)
	{
		func_217(uParam0->f_28[0], &(uParam0->f_48), *uParam0);
	}
	return 1;
}

void func_217(int iParam0, var uParam1, int iParam2)//Position - 0xDE0A
{
	int iVar0;
	int iVar1;
	...
	if (func_200(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_219(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_218(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_219(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_218(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
int func_218(int iParam0)//Position - 0xE162
{
...
int func_219(var uParam0)//Position - 0xE182
{
...
int func_220(var uParam0)//Position - 0xE19A
{
...
void func_221(var uParam0)//Position - 0xE1BF
{
	int iVar0;
	int iVar1;
...
void func_222(int* iParam0)//Position - 0xE4C3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_223(var uParam0)//Position - 0xE4EE
{
	int iVar0;
...
int func_224(var uParam0, bool bParam1, bool bParam2)//Position - 0xE56E
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_225(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_225(int iParam0, int iParam1)//Position - 0xE72C
{
	int iVar0;
...
int func_226(var uParam0, bool bParam1, int iParam2)//Position - 0xE75C
{
	int iVar0;
	int iVar1;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					...
					if (func_245(*uParam0))
					{
						if (!func_167(*uParam0))
						{
							if (func_240(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_221(uParam0);
						...
						if (func_228(uParam0->f_28[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_221(uParam0);
...
int func_227(int iParam0)//Position - 0xEA18
{
...
int func_228(int iParam0, float fParam1)//Position - 0xEA4C
{
	float fVar0;
	
	if (func_200(PLAYER::PLAYER_PED_ID()) && func_200(iParam0))
	{
		if (func_239(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_229(int iParam0, float fParam1)//Position - 0xEAC2
{
	return func_230(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_230(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEADA
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	
	iVar4 = func_238(iParam0, iParam1);
	if (!func_200(iParam0) || !func_200(iParam1))
	{
		if (iVar4 != -1)
		{
			func_237(&(Local_35[iVar4 /*4*/]));
		}
		return 0;
	}
	if (!func_234(iParam0, iParam1, fParam2, iParam3))
	{
		return 0;
	}
	if (iVar4 == -1)
	...
	uVar0 = func_231(&(Local_35[iVar4 /*4*/]), Var1, iParam1, &(Local_35[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar4 /*4*/].f_3) < iParam4);
}

int func_231(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xEB9B
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_232(int iParam0, int iParam1)//Position - 0xECC7
{
	int iVar0;
...
int func_234(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEDD6
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_236(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_236(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_235(Var3, Var0);
...
float func_235(struct<3> Param0, struct<3> Param3)//Position - 0xEE67
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_236(struct<3> Param0)//Position - 0xEE88
{
	float fVar0;
	float fVar1;
...
void func_237(var uParam0)//Position - 0xEEC7
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_238(int iParam0, int iParam1)//Position - 0xEEE2
{
	int iVar0;
...
int func_239(int iParam0)//Position - 0xEF21
{
...
int func_240(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEF49
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_200(PLAYER::PLAYER_PED_ID()) && func_200(iParam0))
	{
		...
		if (!bParam2)
		{
			if (func_244(iParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_241(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_241(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF044
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_242(int iParam0, float fParam1)//Position - 0xF150
{
	var uVar0;
	struct<3> Var1;
	...
	{
		if (func_243(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_243(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF1E5
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_236(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
int func_244(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF273
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_245(int iParam0)//Position - 0xF2BB
{
...
void func_246(int iParam0)//Position - 0xF305
{
	int iVar0;
...
int func_247(int iParam0)//Position - 0xF3A2
{
	if (iParam0 == -1)
	{
		iParam0 = func_175();
...
int func_248(int iParam0)//Position - 0xF437
{
...
int func_251(int iParam0)//Position - 0xF4B6
{
...
int func_253(int iParam0)//Position - 0xF528
{
	if (func_117(0))
	{
...
int func_254(int iParam0)//Position - 0xF550
{
	switch (*iParam0)
	{
		case 17:
...
int func_255(var uParam0)//Position - 0xF5C5
{
	int iVar0[1];
	int iVar2;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_260(&iVar0) || !func_259(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_89 = 2;
...
void func_256(int* iParam0, struct<3> Param1, float fParam4)//Position - 0xF6C9
{
	func_257(iParam0, iLocal_91, Param1, fParam4, 26);
	PED::SET_PED_DEFAULT_COMPONENT_VARIATION(*iParam0);
	PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(*iParam0, false);
	PED::SET_PED_NAME_DEBUG(*iParam0, "EXTREME LAUNCHER RC");
}

void func_257(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xF6FB
{
	func_258(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_258(int* iParam0)//Position - 0xF71C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_259(var uParam0)//Position - 0xF75D
{
	if (func_220(uParam0))
	{
...
int func_260(int iParam0)//Position - 0xF787
{
	int iVar0;
...
void func_261(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xF7B8
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_262(var uParam0)//Position - 0xF7F4
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				if (func_263(&(uParam0->f_28[0]), 52, -63.8f, -809.5f, 321.8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
...
int func_263(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF987
{
...
int func_264(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF9E3
{
	int iVar0;
...
int func_265(var uParam0, int iParam1)//Position - 0xFA71
{
	int iVar0;
...
int func_266(var uParam0)//Position - 0xFAB7
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_263(&(uParam0->f_28[0]), 52, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_267(&(uParam0->f_35[0]), iVar0[0], -950.8f, -2751.98f, 13.21f, 199.05f);
			...
			{
				func_267(&(uParam0->f_35[1]), iVar0[0], -950.192f, -2755.96f, 13.3639f, -178.182f);
			...
			{
				func_267(&(uParam0->f_35[2]), iVar0[1], -957.23f, -2764.89f, 14.04f, 147.61f);
...
void func_267(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFDBB
{
	func_268(iParam0);
...
void func_268(int* iParam0)//Position - 0xFDFE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_269(var uParam0)//Position - 0xFE9A
{
	int iVar0[1];
	int iVar2;
...
int func_270(int iParam0)//Position - 0xFF86
{
	struct<27> Var0;
	bool bVar32;
...
int func_271(int iParam0)//Position - 0xFFD7
{
	char* sVar0;
...
int func_272(int iParam0)//Position - 0x10090
{
	var uVar0;
...
int func_273(int iParam0)//Position - 0x10151
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_274(int iParam0, char* sParam1)//Position - 0x101D6
{
...
int func_275(int iParam0)//Position - 0x102B8
{
...
int func_276(int iParam0)//Position - 0x102E3
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_277(int iParam0)//Position - 0x1030E
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_278(int iParam0)//Position - 0x10339
{
	if (func_248(iParam0))
	{
		return 0;
...
void func_279()//Position - 0x1036E
{
	func_296("Running end routines.");
	Global_114088 = (Global_114088 - 1);
}

int func_280(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10388
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_281((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_281((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_281(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x103ED
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_282(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_282(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10465
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_283(int iParam0, bool bParam1)//Position - 0x104E0
{
	if (*iParam0 == 18)
	{
...
int func_284(var uParam0)//Position - 0x105C1
{
	if (func_220(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_285(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x105F7
{
...
void func_286(var uParam0, bool bParam1)//Position - 0x10617
{
	func_287(&(uParam0->f_41), bParam1);
}

void func_287(var uParam0, bool bParam1)//Position - 0x10629
{
	int iVar0;
...
void func_288(int* iParam0, bool bParam1)//Position - 0x10667
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_289(var uParam0, bool bParam1)//Position - 0x106A2
{
	func_290(&(uParam0->f_35), bParam1);
}

void func_290(var uParam0, bool bParam1)//Position - 0x106B4
{
	int iVar0;
...
void func_291(int* iParam0)//Position - 0x106F1
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_292(var uParam0, int iParam1)//Position - 0x10729
{
	func_293(&(uParam0->f_28), iParam1);
}

void func_293(var uParam0, int iParam1)//Position - 0x1073B
{
	int iVar0;
...
void func_294(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1077C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_295(var uParam0)//Position - 0x107CC
{
	if (*uParam0 == -1)
	{
		return;
...
void func_296(char* sParam0)//Position - 0x10809
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_297(var uParam0)//Position - 0x1081B
{
	*uParam0 = -1;
...
void func_298()//Position - 0x1084E
{
	func_296("Running start routines.");
	Global_114088++;
}

int func_299(int iParam0)//Position - 0x10868
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
