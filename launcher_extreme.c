...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113222[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_296(&(Global_113222[Var0.f_0 /*10*/].f_9));
			}
		}
		func_284(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_216(Var0.f_0);
		func_209(&iLocal_92, &(Var0.f_9), Var61);
		if (Var0.f_0 == 18)
		{
			func_208(&Var0);
			func_203(&Var0, Var61, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (Var0.f_0 == 19)
		{
			func_208(&Var0);
			...
			{
				func_203(&Var0, Var61, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_202() && func_201(Var0.f_28[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && AUDIO::HAS_SOUND_FINISHED(iLocal_94)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, -1))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_94, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", false, 0);
			}
			if ((iLocal_93 == 0 && func_201(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var61, Var0.f_15, Var0.f_15, Var0.f_15, false, false, 0))
			{
				Var69 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
				if (Var69.f_2 < 100f)
				{
					iLocal_93 = 1;
					func_200("TOPMAZE_HELP" /* GXT: Get to the top of the Maze Tower to start this mission. */, -1);
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5F84
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6747
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x678E
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x67F9
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6C1B
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6C2B
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x7751
{
...
Vector3 func_84(struct<3> Param0)//Position - 0x7793
{
...
int func_86(int iParam0)//Position - 0x77BF
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x78C1
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x7956
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_93(int iParam0, var uParam1)//Position - 0x85F8
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0)//Position - 0x867A
{
	if (iParam0 != func_95())
	{
...
int func_99(int iParam0)//Position - 0x898F
{
...
var func_107(int iParam0)//Position - 0x8EE5
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8F07
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8F1E
{
	return uParam0 & 15;
}
...
void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x9084
{
...
int func_118(bool bParam0)//Position - 0x90C6
{
...
int func_123(var* uParam0)//Position - 0xAB59
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAECC
{
...
int func_136(int iParam0)//Position - 0xAF7C
{
	if (func_201(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xAF9C
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xB06C
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xB0BF
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xB1B5
{
	switch (iParam0)
	{
		case 5:
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB25F
{
	if (bParam0)
	{
...
int func_147(var uParam0)//Position - 0xB462
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB484
{
...
int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB4D1
{
	int iVar0;
...
int func_153(char* sParam0)//Position - 0xB54E
{
...
int func_158(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB65F
{
...
void func_159(int iParam0)//Position - 0xB6B6
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_166(int iParam0)//Position - 0xB9C3
{
	if (iParam0 == 1)
	{
...
int func_168(int iParam0)//Position - 0xBA29
{
...
int func_169(int iParam0)//Position - 0xBA6A
{
	int iVar0;
	...
	iVar0 = func_171(&(Global_113222[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
int func_171(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xBAE1
{
	int iVar0;
...
void func_172(var uParam0, int iParam1)//Position - 0xBC18
{
	int iVar0;
...
bool func_173(int iParam0)//Position - 0xBC67
{
	return func_174(iParam0, Global_44181);
}

int func_174(int iParam0, int iParam1)//Position - 0xBC78
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_175(int iParam0)//Position - 0xBE59
{
	if (Global_44181 == 15)
	{
		return 0;
...
int func_177(char* sParam0, int iParam1)//Position - 0xBE8C
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_179(int iParam0, int iParam1)//Position - 0xBEF9
{
	switch (iParam0)
	{
		case 0:
...
int func_180(struct<3> Param0, bool bParam3)//Position - 0xC369
{
	int iVar0;
...
float func_181(bool bParam0, float fParam1, float fParam2)//Position - 0xC395
{
	if (bParam0)
	{
		return fParam1;
...
int func_182(int iParam0)//Position - 0xC3AC
{
	switch (iParam0)
	{
		case 0:
...
int func_183(var uParam0)//Position - 0xC43B
{
	if (*uParam0 == 18)
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -954.5357f, -2760.5532f, 11.916363f, -947.6847f, -2749.719f, 15.631608f, 26f, false, true, 0))
		{
			...
			else if ((!func_184(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && func_201(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_158(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 3f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_184(int iParam0, int iParam1)//Position - 0xC4E2
{
	if (func_136(iParam0))
	{
	...
	switch (uParam0->f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_201(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
					{
...
int func_187(var uParam0)//Position - 0xCD13
{
	float fVar0;
...
void func_188(int iParam0, int iParam1)//Position - 0xCDA1
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_189(bool bParam0)//Position - 0xCE05
{
	int iVar0;
...
int func_190(int iParam0)//Position - 0xCE9C
{
	if (func_201(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_191(int iParam0)//Position - 0xCEC6
{
	bool bVar0;
...
var func_192()//Position - 0xD5E3
{
	return Global_101727.f_1;
}

int func_193()//Position - 0xD5F1
{
	if (Global_98585 != -1)
	{
...
var func_197(int iParam0, int iParam1)//Position - 0xD669
{
	switch (iParam0)
	{
		case 5:
...
var func_198()//Position - 0xD6A1
{
	return Global_1575084;
}

int func_199()//Position - 0xD6AD
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_200(char* sParam0, int iParam1)//Position - 0xD6C9
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_201(int iParam0)//Position - 0xD6E0
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_203(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD723
{
	var uVar0;
	
	if ((((func_201(PLAYER::PLAYER_PED_ID()) && func_201(iParam0->f_28[0])) && !func_202()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_207(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_204(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD7AB
{
...
void func_206(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD83C
{
...
float func_207(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD8D7
{
	struct<3> Var0;
...
void func_208(int iParam0)//Position - 0xD911
{
...
void func_209(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD93E
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_212(int iParam0, int iParam1)//Position - 0xDAA4
{
	bool bVar0;
	int iVar1;
...
void func_214(int iParam0)//Position - 0xDB4E
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_215(iParam0);
...
void func_215(int iParam0)//Position - 0xDB65
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_217(var uParam0, bool bParam1)//Position - 0xDC75
{
	struct<27> Var0;
	...
	if ((func_254(*uParam0) || func_252(*uParam0)) || Global_79785 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_218(int iParam0, var uParam1, int iParam2)//Position - 0xDEE5
{
	...
	if (func_201(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_220(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_219(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_220(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_219(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
int func_219(int iParam0)//Position - 0xE23D
{
...
int func_220(var uParam0)//Position - 0xE25D
{
...
int func_221(var uParam0)//Position - 0xE275
{
...
void func_222(var uParam0)//Position - 0xE29A
{
	...
	if (func_201(PLAYER::PLAYER_PED_ID()))
	{
		iVar0 = 0;
...
void func_223(int* iParam0)//Position - 0xE59E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_225(var uParam0, bool bParam1, bool bParam2)//Position - 0xE649
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_226(int iParam0, int iParam1)//Position - 0xE807
{
	int iVar0;
...
int func_227(var uParam0, bool bParam1, int iParam2)//Position - 0xE837
{
	int iVar0;
	int iVar1;
...
int func_228(int iParam0)//Position - 0xEAF3
{
...
int func_229(int iParam0, float fParam1)//Position - 0xEB27
{
	float fVar0;
	
	if (func_201(PLAYER::PLAYER_PED_ID()) && func_201(iParam0))
	{
...
bool func_230(int iParam0, float fParam1)//Position - 0xEB9D
{
	return func_231(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_231(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEBB5
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	uVar0 = func_232(&(Local_35[iVar4 /*4*/]), Var1, iParam1, &(Local_35[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar4 /*4*/].f_3) < iParam4);
}

int func_232(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xEC76
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_233(int iParam0, int iParam1)//Position - 0xEDA2
{
	int iVar0;
...
int func_235(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEEB1
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_236(struct<3> Param0, struct<3> Param3)//Position - 0xEF42
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_237(struct<3> Param0)//Position - 0xEF63
{
	float fVar0;
	float fVar1;
...
int func_239(int iParam0, int iParam1)//Position - 0xEFBD
{
	int iVar0;
...
int func_240(int iParam0)//Position - 0xEFFC
{
...
int func_241(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF024
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_242(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF11F
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_243(int iParam0, float fParam1)//Position - 0xF22B
{
	var uVar0;
	struct<3> Var1;
...
int func_244(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF2C0
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_245(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF34E
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_246(int iParam0)//Position - 0xF396
{
...
void func_247(int iParam0)//Position - 0xF3E0
{
	int iVar0;
...
int func_248(int iParam0)//Position - 0xF47D
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
int func_249(int iParam0)//Position - 0xF512
{
...
int func_252(int iParam0)//Position - 0xF591
{
...
int func_254(int iParam0)//Position - 0xF603
{
	if (func_118(0))
	{
...
int func_255(int iParam0)//Position - 0xF62B
{
	switch (*iParam0)
	{
		case 17:
...
int func_256(var uParam0)//Position - 0xF6A0
{
	int iVar0[1];
	int iVar2;
...
void func_257(int* iParam0, struct<3> Param1, float fParam4)//Position - 0xF7A4
{
	func_258(iParam0, iLocal_91, Param1, fParam4, 26);
	PED::SET_PED_DEFAULT_COMPONENT_VARIATION(*iParam0);
	PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(*iParam0, false);
	PED::SET_PED_NAME_DEBUG(*iParam0, "EXTREME LAUNCHER RC");
}

void func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xF7D6
{
	func_259(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_259(int* iParam0)//Position - 0xF7F7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_260(var uParam0)//Position - 0xF838
{
	if (func_221(uParam0))
	{
...
int func_261(int iParam0)//Position - 0xF862
{
	int iVar0;
...
int func_263(var uParam0)//Position - 0xF8CF
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
...
int func_264(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xFA62
{
	if (func_265(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_265(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xFABE
{
	int iVar0;
...
int func_266(var uParam0, int iParam1)//Position - 0xFB4C
{
	int iVar0;
...
int func_267(var uParam0)//Position - 0xFB92
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
...
void func_268(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFE96
{
	func_269(iParam0);
...
void func_269(int* iParam0)//Position - 0xFED9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_270(var uParam0)//Position - 0xFF75
{
	int iVar0[1];
	int iVar2;
...
int func_271(int iParam0)//Position - 0x10063
{
	struct<27> Var0;
	bool bVar32;
...
int func_272(int iParam0)//Position - 0x100B4
{
	char* sVar0;
...
int func_273(int iParam0)//Position - 0x1016D
{
	var uVar0;
...
int func_274(int iParam0)//Position - 0x1022E
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_276(int iParam0)//Position - 0x10395
{
...
int func_277(int iParam0)//Position - 0x103C0
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_278(int iParam0)//Position - 0x103EB
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_279(int iParam0)//Position - 0x10416
{
	if (func_249(iParam0))
	{
		return 0;
...
int func_281(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10465
{
	int iVar0;
...
int func_282(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x104CA
{
	int iVar0;
	struct<7> Var1;
...
int func_283(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10542
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_284(int iParam0, bool bParam1)//Position - 0x105BD
{
	if (*iParam0 == 18)
	{
...
void func_289(int* iParam0, bool bParam1)//Position - 0x10744
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_292(int* iParam0)//Position - 0x107CE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_295(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10859
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_296(var uParam0)//Position - 0x108A9
{
	if (*uParam0 == -1)
	{
		return;
...
int func_300(int iParam0)//Position - 0x10945
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
