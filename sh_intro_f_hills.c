							...
							if (func_163())
							{
								if (func_168(&uLocal_54, Var0))
								{
									if (func_157())
									{
										...
										fVar3 = 227.6652f;
										STREAMING::NEW_LOAD_SCENE_START(Var2, SYSTEM::COS((fVar3 + 90f)), SYSTEM::SIN((fVar3 + 90f)), 0f, 25f, 2);
										iLocal_44 = 2;
									}
								}
								else
...
void func_9(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x7A2
{
	int iVar0;
...
int func_12(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x9AF
{
	...
	if (iParam1 == 12)
	{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_64(iVar10, 14, uVar12[iVar1], -1) };
		...
		if (iParam7 == 1)
		{
			Var14 = { func_64(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var14 = { func_64(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var14 = { func_64(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var14 = { func_64(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var14 = { func_64(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_64(iVar10, 14, uVar15[iVar1], -1) };
			func_32(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_55(14);
			if (Global_78339 == 1)
			{
...
int func_34(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3988
{
	...
	else
	{
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_22(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
void func_66(int iParam0)//Position - 0xB2EC
{
	...
	switch (iParam0)
	{
		...
		default:
			func_74(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_67(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_74(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD5DE
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_67(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_67(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_22(iParam0));
			if (iVar11 > iVar10)
			{
...
int func_129(int iParam0, int iParam1, int iParam2)//Position - 0x1EA14
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_129(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_129(iParam0, 14, uVar6[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar7 <= 8)
		{
			if (!func_129(iParam0, 14, uVar8[iVar7]))
			{
				return 0;
			}
			iVar7++;
...
bool func_167(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x1F9A5
{
	struct<3> Var0;
...
bool func_168(var uParam0, struct<2> Param1, var uParam2)//Position - 0x1F9CF
{
	bool bVar0;
	int iVar1;
	int iVar2;
