...
void __EntryFunction__()//Position - 0x0
{
	...
	StringCopy(&Local_331, "MAUDE_MCS_3", 24);
	...
	if (func_534())
	{
		...
		{
			case 0:
				if (VEHICLE::IS_THIS_MODEL_A_PLANE(Global_106934.f_2890.f_12.f_66))
				{
					func_450(&iLocal_344, 225.012f, 2310.695f, 77.257f, 218.1301f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				}
				else
				{
					func_450(&iLocal_344, 232.0044f, 2314.844f, 76.9871f, 173.0429f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				}
				func_449(Local_339, fLocal_119, 1, 0);
				iLocal_61 = 2;
				func_438(1, 0);
				break;
			
			case 1:
				func_450(&iLocal_344, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				func_449(Local_336, 254.9762f, 0, 0);
				func_438(4, 0);
				break;
	...
	else if (func_437(0))
	{
		...
		{
			func_435(PLAYER::PLAYER_PED_ID(), Local_339, fLocal_119, 0, 0);
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			Local_337 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
			func_424();
			func_423();
			switch (iLocal_58)
			{
		...
		switch (iLocal_58)
		{
			case 0:
				if (iLocal_60 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER::PLAYER_PED_ID(), Local_340, fLocal_120, 0, 1);
			...
			case 1:
				...
				if (iLocal_60 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER::PLAYER_PED_ID(), Local_341, fLocal_121, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_104 == 0)
						{
			...
			case 3:
				...
				if (iLocal_60 == 1)
				{
					func_435(Local_68.f_9, Local_336, 0f, 0, 0);
					if (!func_71())
					{
						func_435(PLAYER::PLAYER_PED_ID(), Local_336, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_104 == 0)
						{
...
void func_3()//Position - 0x6A5
{
	Global_20471 = 0;
	func_4();
}

void func_4()//Position - 0x6B5
{
...
int func_5(int iParam0, float fParam1)//Position - 0x6D6
{
	struct<3> Var0;
...
bool func_6(struct<3> Param0, var* uParam1, float fParam2, bool bParam3)//Position - 0x71E
{
	var uVar0;
	struct<3> Var1;
...
void func_9(var uParam0)//Position - 0x7DB
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_10(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x7F6
{
	int iVar0;
	int iVar1;
...
void func_11()//Position - 0x866
{
	Global_23011.f_6 = 1;
}

void func_12(int iParam0)//Position - 0x874
{
	if (func_18())
	{
		return;
...
void func_13(int iParam0)//Position - 0x8A7
{
	if (func_18())
	{
		return;
...
void func_15(bool bParam0, bool bParam1)//Position - 0x958
{
	if (bParam0)
	{
		if (func_17(0))
...
bool func_16()//Position - 0x9CC
{
	return BitTest(Global_1958711, 5);
}

int func_17(int iParam0)//Position - 0x9DA
{
	if (iParam0 == 1)
	{
...
bool func_18()//Position - 0xA31
{
	return BitTest(Global_1958711, 19);
}

void func_19(int iParam0, struct<2> Param1, Vector3 vParam2)//Position - 0xA40
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
int func_20(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)//Position - 0xA9F
{
	bool bVar0;
	float fVar1;
...
void func_21()//Position - 0xAFB
{
	Global_20471 = 0;
	func_22();
}

void func_22()//Position - 0xB0B
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22616 = 0;
...
int func_23(int iParam0)//Position - 0xB62
{
	if (func_436(iParam0))
	{
...
void func_24(int iParam0, bool bParam1)//Position - 0xB82
{
...
void func_25(int iParam0, int iParam1, int iParam2)//Position - 0xBBE
{
...
void func_26(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0xBF2
{
	int iVar0;
...
void func_27(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xC9C
{
	if (bParam0)
	{
...
bool func_28()//Position - 0xDDF
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_29(int iParam0, int iParam1)//Position - 0xDF9
{
	bool bVar0;
...
int func_30(int iParam0, bool bParam1)//Position - 0xE44
{
	int iVar0;
	int iVar1;
...
int func_31()//Position - 0xE85
{
	return Global_1574918;
}

int func_32(int iParam0)//Position - 0xE91
{
...
bool func_33()//Position - 0xED0
{
	return BitTest(Global_2621446, 3);
}

int func_34(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xEDE
{
	int iVar0;
...
void func_35(int iParam0)//Position - 0xF11
{
	if (iParam0 == 1)
	{
...
void func_36(int iParam0)//Position - 0xF34
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		switch (iParam0)
...
int func_37()//Position - 0xF90
{
	if (func_59(Local_337, Local_75.f_1, 210f))
	{
		if (!iLocal_113)
		{
		...
		{
			if (func_59(Local_337, Local_79.f_1, 150f))
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_79.f_1, 10f, func_48(), false))
				{
					Local_79.f_0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_79.f_1, 10f, func_48(), true, false, true);
					if (func_436(Local_79.f_0))
					{
						ENTITY::SET_ENTITY_COORDS(Local_79.f_0, func_47(), true, false, false, true);
						ENTITY::SET_ENTITY_HEADING(Local_79.f_0, func_46());
		...
		{
			if (func_59(Local_337, Local_80.f_1, 150f))
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_80.f_1, 10f, func_45(), false))
				{
					Local_80.f_0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_80.f_1, 10f, func_45(), true, false, true);
				}
			}
		}
	}
...
void func_38(int* iParam0, bool bParam1)//Position - 0x1145
{
	if (bParam1)
	{
		func_40(iParam0);
...
void func_39(int* iParam0, bool bParam1)//Position - 0x1162
{
...
void func_40(int* iParam0)//Position - 0x119D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
char* func_41()//Position - 0x11C8
{
	return "special_ped@maude@base";
}

void func_42(int* iParam0, bool bParam1)//Position - 0x11D3
{
	if (bParam1)
	{
		func_44(iParam0);
...
void func_43(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x11F2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_44(int* iParam0)//Position - 0x1242
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_45()//Position - 0x1283
{
	return joaat("prop_radio_01");
}

float func_46()//Position - 0x1290
{
	return -92.17f;
}

Vector3 func_47()//Position - 0x129D
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_48()//Position - 0x12B4
{
	return joaat("prop_table_03b");
}

void func_49()//Position - 0x12C1
{
	int iVar0;
	int iVar1;
	
	if (func_23(Local_75.f_0))
	{
		if (func_436(Local_77.f_0))
		{
			if (func_58(2))
			{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(Local_75.f_0, iVar0, func_41(), func_51(), 1000f, -8f, 4688, 0, 1000f, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_77.f_0, iVar0, func_50(), func_41(), 1000f, -8f, iVar1, 1000f);
...
char* func_50()//Position - 0x13AD
{
	return "base_chair";
}

char* func_51()//Position - 0x13B8
{
	return "base";
}

Vector3 func_52()//Position - 0x13C3
{
	return 0f, 0f, -92.17f;
}

Vector3 func_53()//Position - 0x13D2
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_54(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x13E9
{
...
void func_55(int iParam0, bool bParam1)//Position - 0x146B
{
	if (iParam0 != 0)
	{
		if (bParam1)
...
int func_56(int iParam0)//Position - 0x1496
{
	if (iParam0 == 0)
	{
		return 1;
...
int func_57(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0x14BC
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
int func_58(int iParam0)//Position - 0x1527
{
	switch (iParam0)
	{
		case 0:
...
bool func_59(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x1592
{
	return SYSTEM::VDIST2(Param0, Param1) <= (fParam2 * fParam2);
}

int func_60(int iParam0, float fParam1, int iParam2)//Position - 0x15AC
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if ((!PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_BOAT(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = 0;
				if (!func_64(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")))
				{
...
int func_64(int iParam0, int iParam1)//Position - 0x1716
{
	if (func_23(iParam0))
	{
...
int func_65(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x1749
{
...
void func_66(int iParam0)//Position - 0x18E1
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_67()//Position - 0x190D
{
	if (func_436(Local_68.f_9))
	{
...
void func_68(char* sParam0)//Position - 0x194F
{
	func_27(1, 1, 0, 0, 0, 0, 0);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_69(int iParam0, int iParam1, int iParam2)//Position - 0x196A
{
	if (func_534() && func_71())
	{
...
void func_70(int iParam0)//Position - 0x1A2E
{
	if (iParam0 == 1)
	{
...
bool func_71()//Position - 0x1A57
{
	return BitTest(Global_100441.f_20, 13);
}

void func_72()//Position - 0x1A68
{
	char* sVar0;
	int iVar1;
			...
			else
			{
				if (!iLocal_95)
				{
					...
					if (iLocal_62 == 4)
					{
						if (func_23(Local_75.f_0))
						{
							if (func_112(Local_75.f_0, Local_337, 35f, 1))
							{
								func_97(&uLocal_157, 4, Local_75.f_0, "MAUDE", 0, 1);
								if (func_75(&uLocal_157, cLocal_151, &Local_323, 4, 0, 0, 0))
								{
									iLocal_95 = 1;
								}
							}
					...
					else if (func_75(&uLocal_157, cLocal_151, &Local_323, 4, 0, 0, 0))
					{
						iLocal_95 = 1;
					}
				}
				if (iLocal_62 == 4)
				{
					...
					else if (func_23(Local_75.f_0))
					{
						if (!func_64(Local_75.f_0, joaat("SCRIPT_TASK_SMART_FLEE_PED")))
						{
							if (!PED::IS_PED_FLEEING(Local_75.f_0))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_75.f_0, func_109(), func_74(), 3))
								{
									func_73(&Local_75);
...
void func_73(int iParam0)//Position - 0x1D20
{
	if (func_23(*iParam0))
	{
...
char* func_74()//Position - 0x1D89
{
	return "female_Flee_Table_Left_Maude";
}

int func_75(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1D94
{
	if (iParam4 == 0)
	{
...
bool func_76(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1DD1
{
...
int func_77(char* sParam0, int iParam1, bool bParam2)//Position - 0x1E1F
{
	Global_21606 = 0;
...
bool func_80(int iParam0)//Position - 0x2187
{
	return func_81(iParam0, 20);
}

var func_81(int iParam0, int iParam1)//Position - 0x2197
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

int func_82()//Position - 0x21AF
{
	return -1;
}

void func_83()//Position - 0x21B8
{
	int iVar0;
...
int func_87()//Position - 0x23B9
{
	func_88();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_88()//Position - 0x23D2
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_91(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_90(PLAYER::PLAYER_PED_ID());
			if (func_89(iVar0) && (!func_93(14) || Global_112337))
			{
				if (Global_113386.f_2363.f_539.f_4321 != iVar0 && func_89(Global_113386.f_2363.f_539.f_4321))
				{
...
bool func_89(int iParam0)//Position - 0x24CF
{
	return iParam0 < 3;
}

int func_90(int iParam0)//Position - 0x24DB
{
	int iVar0;
	int iVar1;
...
int func_91(int iParam0)//Position - 0x2518
{
	if (func_89(iParam0))
	{
...
var func_92(int iParam0)//Position - 0x253D
{
	return Global_1998[iParam0 /*29*/];
}

bool func_93(int iParam0)//Position - 0x254C
{
	return Global_43052 == iParam0;
}

void func_94()//Position - 0x255A
{
	int iVar0;
...
bool func_95(int iParam0, int iParam1)//Position - 0x25B1
{
	switch (iParam0)
	{
		case 5:
...
void func_96(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x25E9
{
...
void func_97(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x263F
{
...
void func_98(bool bParam0)//Position - 0x26DA
{
	int iVar0;
...
void func_99(int* iParam0, bool bParam1)//Position - 0x28AE
{
	if (bParam1)
	{
		func_101(iParam0);
...
void func_100(int* iParam0)//Position - 0x28CA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_101(int* iParam0)//Position - 0x2902
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_102(int iParam0)//Position - 0x299E
{
	if (func_436(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_103(var uParam0)//Position - 0x29C8
{
...
void func_105(char* sParam0)//Position - 0x2A0E
{
...
void func_106(int iParam0, bool bParam1)//Position - 0x2A4D
{
	if (func_23(iParam0))
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(iParam0, 5, false);
		...
		if (!func_64(iParam0, joaat("SCRIPT_TASK_SMART_FLEE_PED")))
		{
...
int func_107(int iParam0, int iParam1, int iParam2)//Position - 0x2AC8
{
	int iVar0;
			...
			if (!PED::IS_PED_RAGDOLL(*iParam0) || TASK::IS_PED_GETTING_UP(*iParam0))
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(func_109()))
				{
					*iParam2 = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
					...
					if (func_64(*iParam0, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE")))
					{
...
char* func_108()//Position - 0x2C14
{
	return "Female_Flee_Table_Left_Maude_Chair";
}

char* func_109()//Position - 0x2C20
{
	return "special_ped@maude@exit_flee";
}

void func_110(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2C2C
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_111(iParam3), false);
}

int func_111(int iParam0)//Position - 0x2C45
{
	int iVar0;
...
bool func_112(int iParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x2E3A
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), Param1) <= (fParam2 * fParam2);
}

void func_113(int iParam0, bool bParam1)//Position - 0x2E58
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_114(var uParam0, int iParam1)//Position - 0x2EC9
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_116(int* iParam0)//Position - 0x2F0A
{
	bool bVar0;
	struct<8> Var1;
...
void func_117(int* iParam0)//Position - 0x2F7C
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_118(int iParam0)//Position - 0x2F9C
{
	int iVar0;
...
bool func_120(int iParam0, int iParam1)//Position - 0x316A
{
	return (MISC::GET_GAME_TIMER() - iParam0) > iParam1;
}

void func_121(int iParam0)//Position - 0x317C
{
	if (func_23(Local_69[iParam0 /*20*/]))
	{
		...
		PED::SET_PED_FIRING_PATTERN(Local_69[iParam0 /*20*/], joaat("FIRING_PATTERN_SHORT_BURSTS"));
		if (MISC::GET_RANDOM_INT_IN_RANGE(0, 2) == 0)
		{
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_69[iParam0 /*20*/], ENTITY::GET_ENTITY_COORDS(Local_69[iParam0 /*20*/], true), 45f, false, false);
		}
		else
		{
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_69[iParam0 /*20*/], ENTITY::GET_ENTITY_COORDS(Local_69[iParam0 /*20*/], true), 35f, false, false);
		}
...
void func_122(int iParam0)//Position - 0x32D3
{
	func_24(500, 1);
...
void func_123(int iParam0, int iParam1, int iParam2)//Position - 0x3308
{
	bool bVar0;
...
void func_124()//Position - 0x33EE
{
	...
	{
		func_127(13, SYSTEM::FLOOR(Global_113386.f_10194.f_3853));
	}
...
int func_126()//Position - 0x38F7
{
	return Global_31959;
}

int func_127(int iParam0, int iParam1)//Position - 0x3902
{
	int iVar0;
...
void func_128(int iParam0, bool bParam1, int iParam2)//Position - 0x3953
{
	if (iParam2 == -1)
	{
		iParam2 = func_31();
...
int func_129(int iParam0)//Position - 0x3971
{
	int iVar0;
		...
		case 0:
			...
			if (func_37())
			{
				if (func_60(1, 10.5f, 1))
				{
					...
					func_198(&Var0, &Var1, &fVar3);
					Var2 = { func_197() };
					if (func_194(Var2, 0))
					{
						func_187(Var0, Var1, fVar3, 2719.87f, 4143.46f, 43.46f, 261.91f, 1, 1, 1, 0, 0);
						func_132(2719.87f, 4143.46f, 43.46f, 261.91f, 0, 145);
					}
					else
					{
						func_187(Var0, Var1, fVar3, 2710.665f, 4149.075f, 42.7026f, 180.9488f, 1, 1, 1, 0, 0);
...
void func_131(int iParam0)//Position - 0x3CBB
{
	iLocal_58 = iParam0;
	iLocal_60 = 0;
}

void func_132(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x3CCA
{
	struct<3> Var0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103950.f_4))
	{
		...
		{
			if (func_186(24) != Global_103950.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_183(ENTITY::GET_ENTITY_COORDS(Global_103950.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
...
void func_133(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x3D45
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_169(iParam3, &Var0, Param1, fParam2, func_175(iParam0));
		func_134(iParam3, iParam0, 0);
	}
}

void func_134(int iParam0, int iParam1, int iParam2)//Position - 0x3E6E
{
	int iVar0;
	...
	if (!func_166(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_113386.f_32749.f_4801 = func_155();
			}
...
void func_135(int iParam0, int iParam1)//Position - 0x3F85
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_177(iParam0, &(Global_113386.f_32749.f_5510));
}

int func_136(int iParam0)//Position - 0x418B
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_153(iParam0, 0, 0)) || func_153(iParam0, 1, 0)) || func_153(iParam0, 2, 0)) || func_175(iParam0) != 145) || func_152(iParam0)) || func_151(iParam0)) || func_150(iParam0)) || func_149(iParam0)) || !func_137(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_151(iParam0))
		{
		}
		...
		if (func_153(iParam0, 1, 0))
		{
		}
		if (func_153(iParam0, 2, 0))
		{
		}
...
int func_137(int iParam0)//Position - 0x4268
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_138(int iParam0, bool bParam1)//Position - 0x4419
{
	int iVar0;
	struct<2> Var1;
	...
	{
		if ((((!func_147() && !func_146()) && !func_145()) && !func_144()) && !func_148())
		{
			return 0;
		}
	}
	...
	{
		if ((func_143() || MISC::IS_PC_VERSION()) || func_142())
		{
		}
		else if (!func_145())
		{
...
int func_139(int iParam0)//Position - 0x4599
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_141(int iParam0)//Position - 0x467C
{
	int iVar0;
	int iVar1;
...
bool func_142()//Position - 0x794D
{
	return (MISC::IS_ORBIS_VERSION() || MISC::_0x807ABE1AB65C24D2());
}

bool func_143()//Position - 0x7963
{
	return (MISC::IS_DURANGO_VERSION() || MISC::_0xC545AB1CF97ABB34());
}

int func_144()//Position - 0x7979
{
	return 0;
}

int func_145()//Position - 0x7982
{
	return 1;
}

int func_146()//Position - 0x798B
{
	return 1;
}

int func_147()//Position - 0x7994
{
...
int func_149(int iParam0)//Position - 0x7A65
{
	int iVar0;
	char* sVar1;
...
int func_150(int iParam0)//Position - 0x7AAB
{
	int iVar0;
...
int func_151(int iParam0)//Position - 0x7AE6
{
	int iVar0;
...
int func_152(int iParam0)//Position - 0x7B62
{
	int iVar0;
...
int func_153(int iParam0, int iParam1, bool bParam2)//Position - 0x7C4A
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	iVar0 = 0;
	while (func_154(iParam1, iVar0, &sVar1, &iVar2))
	{
...
int func_154(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x7CB8
{
...
var func_155()//Position - 0x7D90
{
	var uVar0;
	
	func_165(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_164(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_163(&uVar0, CLOCK::GET_CLOCK_HOURS());
...
void func_156(var uParam0, int iParam1)//Position - 0x7DD6
{
	if (iParam1 <= 0)
	{
		return;
...
void func_157(var uParam0, int iParam1)//Position - 0x7E5C
{
...
void func_158(var uParam0, int iParam1)//Position - 0x7E8F
{
	int iVar0;
	int iVar1;
...
int func_159(int iParam0, int iParam1)//Position - 0x7EE0
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_160(int iParam0)//Position - 0x7F82
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_161(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_161(bool bParam0, int iParam1, int iParam2)//Position - 0x7FA4
{
	if (bParam0)
	{
		return iParam1;
...
int func_162(var uParam0)//Position - 0x7FBB
{
	return uParam0 & 15;
}

void func_163(var uParam0, int iParam1)//Position - 0x7FC8
{
...
void func_164(var uParam0, int iParam1)//Position - 0x8003
{
...
void func_165(var uParam0, int iParam1)//Position - 0x803E
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_166(var uParam0, int iParam1)//Position - 0x807A
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_176(Global_113386.f_32749.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_176(Global_113386.f_2363.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_176(Global_113386.f_2363.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_167(int iParam0, int iParam1)//Position - 0x9768
{
	struct<82> Var0;
...
void func_168(int iParam0, var uParam1, int iParam2)//Position - 0x97AA
{
	int iVar0;
...
void func_169(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x9A06
{
	if (func_166(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_174(iParam0);
			func_173(uParam1, &(Global_113386.f_32749.f_69[Global_77137.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_170(int iParam0, bool bParam1)//Position - 0x9AFF
{
	if (iParam0 == -1)
	{
		return;
...
void func_171(int iParam0, int iParam1, bool bParam2)//Position - 0x9B5C
{
	if (iParam0 == -1)
	{
		return;
...
int func_172(int iParam0, int iParam1)//Position - 0x9B97
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_173(var uParam0, var uParam1)//Position - 0x9BB7
{
...
void func_174(int iParam0)//Position - 0x9C83
{
	if (iParam0 == -1)
	{
		return;
...
int func_175(int iParam0)//Position - 0x9CFA
{
	int iVar0;
...
bool func_176(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x9D5D
{
	if (bParam2)
	{
...
void func_177(int iParam0, var uParam1)//Position - 0x9DA4
{
	int iVar0;
...
int func_178(int iParam0)//Position - 0xA04F
{
	switch (iParam0)
	{
		case 1:
...
int func_179(int iParam0, var uParam1, var uParam2)//Position - 0xA0FF
{
	int iVar0;
	int iVar1;
...
int func_180(int iParam0)//Position - 0xA2F2
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_181(var uParam0)//Position - 0xA312
{
	int iVar0;
...
void func_182(int iParam0)//Position - 0xA3C2
{
...
int func_183(struct<3> Param0, int iParam1, var uParam2, var uParam3)//Position - 0xA3E9
{
	int iVar0;
	
	iVar0 = func_184(Param0, iParam1, 1);
	switch (iVar0)
	{
		case 0:
...
int func_184(struct<3> Param0, int iParam1, int iParam2)//Position - 0xA4FF
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_185(int iParam0)//Position - 0xA58E
{
	return BitTest(Global_113386.f_7229[iParam0], 0);
}

int func_186(int iParam0)//Position - 0xA5A3
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_187(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0xA5BF
{
	func_188(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_188(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0xA5E8
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_190(iVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_189(struct<3> Param0)//Position - 0xA9DE
{
...
int func_190(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0xAA08
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_191(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_191(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_191(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_191(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_191(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_191(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_191(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_191(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_191(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_191(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_191(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_191(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_191(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_191(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_191(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_191(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4))
		{
			return 1;
		}
	}
...
int func_191(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0xACFE
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_192(struct<3> Param0)//Position - 0xADB2
{
	float fVar0;
	float fVar1;
...
void func_193(int iParam0)//Position - 0xADF1
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
bool func_194(struct<3> Param0, int iParam1)//Position - 0xAE56
{
	return func_195(Global_103950.f_2890.f_12.f_66, Param0, iParam1);
}

int func_195(int iParam0, struct<3> Param1, int iParam2)//Position - 0xAE73
{
	struct<3> Var0;
	struct<3> Var1;
...
Vector3 func_196()//Position - 0xAEDD
{
	return 2.55f, 5.665f, 2.55f;
}

Vector3 func_197()//Position - 0xAEF4
{
	return 3.01f, 11.01f, 6.01f;
}

int func_198(var uParam0, var uParam1, var uParam2)//Position - 0xAF0B
{
...
void func_199(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0xAF42
{
	int iVar0;
...
Vector3 func_200(int iParam0)//Position - 0xB100
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_201(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xB113
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_78130[1 /*14*/] = { func_252(iVar10, iParam1, iParam2, -1) };
		if (!func_251(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		if (iParam7 == 1)
		{
			...
			{
				iVar5 = func_242(iParam0, 8);
				if (iVar5 != 9)
				{
					iVar5 = -99;
				}
			}
			iVar6 = func_242(iParam0, 9);
			...
			iVar7 = func_241(iParam0, 1);
			if (!func_240(iVar10, 14, iVar7, -1))
			{
				iVar7 = -99;
			}
			iVar8 = func_241(iParam0, 0);
			if (!func_239(iVar10, 14, iVar8, -1) && !func_238(iVar10, 14, iVar8, -1))
			{
				iVar8 = -99;
			}
			if (iVar10 == joaat("player_one"))
			{
				iVar9 = func_241(iParam0, 2);
			}
		}
		...
		{
			uVar11 = { func_234(iVar10, iParam2) };
		}
		iVar0 = 0;
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78130[1 /*14*/] = { func_252(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						{
							uVar12 = { func_231(iVar10, uVar11[iVar0]) };
						}
						iVar1 = 0;
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_252(iVar10, 14, uVar12[iVar1], -1) };
							func_221(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
							func_244(14);
							if (Global_78128 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_211(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_211(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_211(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
						}
						func_244(iVar0);
						if (Global_78128 == 1)
						{
			...
			{
				Global_78130[1 /*14*/] = { func_252(iVar10, iVar0, func_210(iParam0, iVar0, -1), -1) };
		...
		if (iParam7 == 1)
		{
			Var14 = { func_252(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var14 = { func_252(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var14 = { func_252(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var14 = { func_252(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var14 = { func_252(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	{
		uVar15 = { func_231(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_252(iVar10, 14, uVar15[iVar1], -1) };
			func_221(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_244(14);
			if (Global_78128 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_211(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_211(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_211(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
		}
		if (Global_78128 == 1)
		{
			iVar2 = 0;
...
int func_202(int iParam0, int iParam1, int iParam2)//Position - 0xB923
{
	int iVar0;
...
int func_203(int iParam0)//Position - 0xB9AF
{
	switch (iParam0)
	{
...
void func_204(int iParam0, int iParam1, int iParam2)//Position - 0xB9EA
{
	int iVar0;
	int iVar1;
...
int func_205(int iParam0, int iParam1, int iParam2)//Position - 0xBA74
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_206(int iParam0, int iParam1, int iParam2)//Position - 0xBB52
{
	Global_78130[1 /*14*/] = { func_252(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78130[1 /*14*/].f_6, 2);
}

int func_207(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0xBB7A
{
	var uVar0;
	int iVar1;
	...
	if (iParam2 == 14)
	{
		uVar0 = { func_231(iParam0, (*uParam4)[13]) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
	...
	if (iParam0 == joaat("player_zero"))
	{
		if (func_240(iParam0, iParam2, iParam3, -1))
		{
...
int func_208(int iParam0, int iParam1, int iParam2)//Position - 0xC180
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_209(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC219
{
	int iVar0;
...
int func_210(int iParam0, int iParam1, int iParam2)//Position - 0xC2AF
{
	int iVar0;
	int iVar1;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		else if (iParam1 == 14)
		{
			...
			{
				return func_241(iParam0, iParam2);
			}
		}
		else
		{
...
int func_211(int iParam0)//Position - 0xC350
{
	switch (iParam0)
	{
		case 0:
...
int func_212(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC400
{
	int iVar0;
...
int func_213(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC707
{
	int iVar0;
	int iVar1;
	int iVar2;
				...
				switch (iParam4)
				{
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							{
								iVar5 = iParam3;
								iVar4 = func_242(iParam0, 3);
							}
							else if (iParam2 == 3)
							{
								iVar4 = iParam3;
								iVar5 = func_242(iParam0, 11);
								iVar5 = func_215(iParam1, iVar4, iVar5, 0);
							}
							iVar3 = func_242(iParam0, 8);
					...
					case 11:
						if (iParam2 == 3)
						{
							...
							{
								iVar7 = func_242(iParam0, 8);
								iVar8 = func_242(iParam0, 11);
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0xD2BA
{
	int iVar0;
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD59E
{
	int iVar0;
...
int func_216(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD865
{
	int iVar0;
	int iVar1;
...
int func_217(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD89C
{
	int iVar0;
...
int func_218(int iParam0, int iParam1, int iParam2)//Position - 0xD8C5
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDB8F
{
	int iVar0;
...
int func_220(int iParam0, int iParam1, int iParam2)//Position - 0xDE19
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_221(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDF70
{
	int iVar0;
...
int func_222(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE008
{
	switch (iParam0)
	{
...
int func_223(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE0D6
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else if (iParam2 == 14)
	{
		...
		iVar1 = (iParam1 - func_225(iParam0));
		if (iVar1 < 0)
		{
			return -1;
		}
	...
	else
	{
		...
		iVar4 = (iParam1 - func_224(iParam0, func_211(iParam2)));
		if (iVar4 < 0)
		{
			return -1;
		}
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_211(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_224(int iParam0, int iParam1)//Position - 0xE1F0
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_225(int iParam0)//Position - 0xE597
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_226(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE5F8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_227(int iParam0, int iParam1)//Position - 0xE6F4
{
	int iVar0;
...
int func_228(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE832
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		if (iVar4 != -1)
		{
			return (func_224(iParam0, func_211(iParam2)) + iVar4);
		}
	}
	return -99;
}

int func_229(int iParam0)//Position - 0xE8ED
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_230(int iParam0)//Position - 0xE94C
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_231(int iParam0, int iParam1)//Position - 0xE9D2
{
	int iVar0;
	struct<10> Var1;
...
void func_232(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF301
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var2;
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1.f_0))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &Var2) && Var2.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var2.f_2] = func_228(iParam1, Var2.f_0, 14, iVar0);
					}
					else if (Var2.f_1 != -1)
					{
...
void func_233(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xF42B
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_234(int iParam0, int iParam1)//Position - 0xF473
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_237(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[0], Global_113386.f_2363.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
				...
				default:
					func_235(&Var1, iParam0, iParam1, 53);
					break;
			}
			break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_237(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[1], Global_113386.f_2363.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
				...
				default:
					func_235(&Var1, iParam0, iParam1, 47);
					break;
			}
			break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_237(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[2], Global_113386.f_2363.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				...
				default:
					func_235(&Var1, iParam0, iParam1, 48);
					break;
			}
			break;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				...
				default:
					func_235(&Var1, iParam0, iParam1, 26);
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				...
				default:
					func_235(&Var1, iParam0, iParam1, 28);
					break;
			}
			break;
	}
...
void func_235(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x112BE
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var2;
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.f_0 != 0 && Var2.f_0 != -1) && Var2.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_236(Var2.f_2)] = Var2.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_236(Var2.f_2)] = func_228(iParam1, Var2.f_0, func_236(Var2.f_2), iVar0);
					}
				}
				else if (Var2.f_1 != -1)
				{
					(*uParam0)[func_236(Var2.f_2)] = Var2.f_1;
				}
			}
			iVar4++;
		}
...
int func_236(int iParam0)//Position - 0x114A8
{
	switch (iParam0)
	{
		case 0:
...
void func_237(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x11558
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_238(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x115C9
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_239(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11846
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_240(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11C6B
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_241(int iParam0, int iParam1)//Position - 0x11F5E
{
	int iVar0;
	int iVar1;
	...
	if (iVar0 == -1)
	{
		return func_230(iParam1);
	}
	iVar1 = PED::GET_PED_PROP_TEXTURE_INDEX(iParam0, iParam1);
	return func_226(iParam0, iVar0, iVar1, iParam1);
}

int func_242(int iParam0, int iParam1)//Position - 0x11FA4
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	return func_243(iParam0, iVar1, iVar2, iParam1);
}

int func_243(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x12004
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_244(int iParam0)//Position - 0x1205B
{
	if (BitTest(Global_78130[1 /*14*/].f_6, 1) && !BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
		func_250(iParam0, Global_78130[1 /*14*/].f_5, Global_78130[1 /*14*/].f_2, 2, Global_78130[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_78130[1 /*14*/].f_6, 1) && BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
		{
			func_245(Global_2883588, 2, 1, 1, -1);
		}
		else if (iParam0 == 13)
		{
		}
...
void func_245(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x12107
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_249(iParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
		iVar3 = func_248(iVar2, iVar0, 0);
		MISC::SET_BIT(&iVar3, iVar1);
		func_246(iVar2, iVar3, iVar0, 1, 0);
	}
}

void func_246(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x12151
{
	int iVar0;
	...
	iVar0 = Global_2826809[iParam0 /*3*/][func_247(iParam2)];
	if (iVar0 != 0)
	{
...
int func_247(var uParam0)//Position - 0x12181
{
	int iVar0;
	int iVar1;
...
int func_248(int iParam0, int iParam1, int iParam2)//Position - 0x121B5
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 13122)
	{
		...
		iVar0 = Global_2826809[iParam0 /*3*/][func_247(iParam1)];
...
bool func_249(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x121F2
{
	int iVar0;
...
int func_250(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x14744
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_251(int iParam0)//Position - 0x155E7
{
	if (!BitTest(Global_78130[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_252(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1562F
{
	func_315();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_253(int iParam0, int iParam1)//Position - 0x15681
{
	switch (iParam0)
	{
		case 0:
...
void func_254(int iParam0)//Position - 0x15771
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_261(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_255(&(Global_78130[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_255(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x169E8
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_259(Global_2883588, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_259(Global_2883588, 2, 1, 1, -1))
			{
	...
	else if (uParam0->f_5 >= 0 && uParam0->f_5 < 3)
	{
		MISC::SET_BIT(&(uParam0->f_6), 0);
		MISC::SET_BIT(&(uParam0->f_6), 5);
		if (func_250(iParam1, uParam0->f_5, uParam0->f_2, 0, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 1);
		}
		if (func_250(iParam1, uParam0->f_5, uParam0->f_2, 1, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 2);
		}
		if (!func_250(iParam1, uParam0->f_5, uParam0->f_2, 2, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 4);
		}
	}
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_248(func_258(iParam1, uParam0->f_2), Global_78127, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_248(func_257(iParam1, uParam0->f_2), Global_78127, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			if (func_256(iParam1, uParam0->f_2, &iVar1))
			{
				uVar0 = func_248(iVar1, Global_78127, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_256(int iParam0, int iParam1, var uParam2)//Position - 0x16D8D
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_257(int iParam0, int iParam1)//Position - 0x17192
{
	switch (iParam1)
	{
		case 0:
...
int func_258(int iParam0, int iParam1)//Position - 0x1758D
{
	switch (iParam1)
	{
		case 0:
...
int func_259(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x17988
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	if (func_249(iParam0, iParam1, &iVar2, &uVar1, bParam2, bParam3))
	{
		uVar3 = func_248(iVar2, iVar0, 0);
		return BitTest(uVar3, uVar1);
	}
	return 0;
}

int func_260(int iParam0)//Position - 0x179C7
{
	switch (iParam0)
	{
		case -1:
...
void func_261(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x17A9B
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar3 >= 0)
		{
			...
			if (iVar4 > iVar3)
			{
				...
				func_255(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_255(&(Global_78130[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_255(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_255(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_211(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_262(int iParam0)//Position - 0x17D22
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_263(int iParam0)//Position - 0x17E79
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_264(int iParam0)//Position - 0x18388
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_265(int iParam0)//Position - 0x183FD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_266(int iParam0)//Position - 0x18471
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_267(int iParam0)//Position - 0x18558
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_268(int iParam0)//Position - 0x188BB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_269(int iParam0)//Position - 0x18ACC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_270(int iParam0)//Position - 0x18CFC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_271(int iParam0)//Position - 0x18E0C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_272(int iParam0)//Position - 0x197AB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_273(int iParam0)//Position - 0x1A31E
{
	if (iParam0 < 136)
	{
		func_275(iParam0);
	...
	{
		func_261(3, iParam0, 242, -1);
	}
}

void func_274(int iParam0)//Position - 0x1A353
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_275(int iParam0)//Position - 0x1AF57
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_276(int iParam0)//Position - 0x1BE65
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_277(int iParam0)//Position - 0x1BF92
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_278(int iParam0, int iParam1)//Position - 0x1C091
{
	switch (iParam0)
	{
		case 0:
...
void func_279(int iParam0)//Position - 0x1C181
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_280(int iParam0)//Position - 0x1D672
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_281(int iParam0)//Position - 0x1D7C3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_282(int iParam0)//Position - 0x1DCCE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_283(int iParam0)//Position - 0x1E33C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_284(int iParam0)//Position - 0x1E3B0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_285(int iParam0)//Position - 0x1E480
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_286(int iParam0)//Position - 0x1E9B0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_287(int iParam0)//Position - 0x1EB47
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_288(int iParam0)//Position - 0x1F345
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_289(int iParam0)//Position - 0x1F455
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_290(int iParam0)//Position - 0x20382
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_291(int iParam0)//Position - 0x2103F
{
	if (iParam0 < 107)
	{
		func_294(iParam0);
	...
	if (Global_78130[0 /*14*/].f_2 == -1)
	{
		func_261(3, iParam0, 318, -1);
	}
}

void func_292(int iParam0)//Position - 0x21085
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_293(int iParam0)//Position - 0x21B2A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_294(int iParam0)//Position - 0x22919
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_295(int iParam0)//Position - 0x23562
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_296(int iParam0)//Position - 0x237DB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_297(int iParam0, int iParam1)//Position - 0x23921
{
	switch (iParam0)
	{
		case 0:
...
void func_298(int iParam0)//Position - 0x23A11
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_299(int iParam0)//Position - 0x2479B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_300(int iParam0)//Position - 0x24915
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_301(int iParam0)//Position - 0x24E8C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_302(int iParam0)//Position - 0x253B6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_303(int iParam0)//Position - 0x2542A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_304(int iParam0)//Position - 0x254FA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_305(int iParam0)//Position - 0x259D2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_306(int iParam0)//Position - 0x25C3B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_307(int iParam0)//Position - 0x25F11
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_308(int iParam0)//Position - 0x260DA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_309(int iParam0)//Position - 0x26C2E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_310(int iParam0)//Position - 0x27878
{
	if (iParam0 < 60)
	{
		func_312(iParam0);
	...
	if (Global_78130[0 /*14*/].f_2 == -1)
	{
		func_261(3, iParam0, 181, -1);
	}
}

void func_311(int iParam0)//Position - 0x278AD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_312(int iParam0)//Position - 0x2864E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_313(int iParam0)//Position - 0x28CDA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_314(int iParam0)//Position - 0x28DC1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_315()//Position - 0x28EBF
{
...
int func_316(int iParam0, int iParam1, int iParam2)//Position - 0x28F38
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_316(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar6 = { func_231(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
							if (!func_316(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_78130[2 /*14*/] = { func_252(iVar0, 14, iVar4, -1) };
									if (Global_78130[2 /*14*/].f_12 == iVar3)
									{
										if (func_316(iParam0, 14, iVar4))
										{
											if (!func_207(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_78130[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					{
						iVar1 = func_242(iParam0, iVar2);
						Global_78130[2 /*14*/] = { func_252(iVar0, iVar2, iVar1, -1) };
						if (!func_207(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_78130[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_78130[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_211(iParam1)) && Global_78130[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_211(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_317(bool bParam0)//Position - 0x29190
{
	int iVar0;
...
void func_318()//Position - 0x291CF
{
	bool bVar0;
	struct<3> Var1;
	...
	if (func_23(Local_68.f_9))
	{
		...
		func_385(Local_68.f_9, &iLocal_135, 1126825984, 7);
		func_377(Local_68.f_9, &(Local_68.f_19), 1126825984, 7);
		func_365();
		switch (iLocal_60)
		{
			case 0:
				...
				Local_342 = { ENTITY::GET_ENTITY_COORDS(Local_68.f_9, false) };
				func_364(&Local_343, Local_342);
				...
				if (func_23(Local_68.f_9))
				{
					...
					{
						Local_68.f_8 = func_362(Local_68.f_9, 1, 0, 5);
					}
				...
				func_361(&(Local_68.f_8), "", "", &iLocal_127, iLocal_128, 0);
				iLocal_60 = 1;
				break;
			...
			case 1:
				...
				{
					func_361(&(Local_68.f_8), "", "", &iLocal_127, iLocal_128, 0);
					func_333(&uLocal_44, Local_68.f_9, 0, 0, 1, 1, 1);
					if (Local_68.f_10 == 13 || Local_68.f_10 == 14)
					{
						if (iLocal_137 == -1)
						{
						...
						if (func_330(Local_68.f_9, Local_337, bVar0, 0, 1, iLocal_139))
						{
							if ((func_120(iLocal_137, 5000) || func_176(Local_343, 0f, 0f, 0f, 0)) || (!func_59(Var1, Local_343, 8.5f) && !func_59(Var1, Local_342, 8.5f)))
							{
								func_329();
								Local_68.f_17 = MISC::GET_GAME_TIMER();
								func_327(&uLocal_44, 0, 0);
								iLocal_109 = 1;
							}
						}
						else
						{
							if (!iLocal_81)
							{
								if (!func_120(iLocal_124, 2500))
								{
									if (!func_62())
									{
										if (func_112(Local_68.f_9, Local_337, 30f, 1))
										{
							...
							func_326(Local_68.f_9, Local_337, iLocal_137, 925353388);
						}
					}
					else
					{
				...
				{
					func_329();
					if (!func_112(Local_68.f_9, Local_337, 10f, 1))
					{
						if (!iLocal_98)
						{
							if (!func_324(sLocal_148, 1))
							{
								func_322(&(Local_68.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_127, &iLocal_128, 1, 1);
								iLocal_98 = 1;
							}
						}
						else
						{
							func_361(&(Local_68.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_127, iLocal_128, 1);
						}
					}
					else
					{
						if (!iLocal_82)
						{
							...
							{
								if (func_321("BBS_APPSUS", 0, 0) || func_321("BBS_APPSUS2", 0, 0))
								{
									HUD::CLEAR_PRINTS();
								}
								if (!func_62())
...
int func_319(var uParam0)//Position - 0x296AD
{
	struct<3> Var0;
...
int func_320(var uParam0)//Position - 0x296F2
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
...
bool func_321(char* sParam0, int iParam1, char* sParam2)//Position - 0x2972A
{
...
void func_322(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x29748
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
		if (bParam5)
		{
			...
			if (iParam6 && !func_62())
			{
				if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_321(sParam2, 0, 0))
				{
					func_323(sParam1, 7500, 0);
				}
			}
		}
		else
		{
			...
			if (iParam6 && !func_62())
			{
				if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_321(sParam1, 0, 0))
				{
					func_323(sParam2, 7500, 0);
				}
			}
		}
...
void func_323(char* sParam0, int iParam1, int iParam2)//Position - 0x297F4
{
	iParam2 = iParam2;
...
int func_324(char* sParam0, bool bParam1)//Position - 0x2980D
{
	struct<6> Var0;
...
struct<6> func_325()//Position - 0x29848
{
	struct<6> Var0;
...
void func_326(int iParam0, struct<3> Param1, int iParam2, float fParam3)//Position - 0x2986C
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_327(var uParam0, int iParam1, bool bParam2)//Position - 0x29951
{
	char* sVar0;
...
bool func_328(char* sParam0)//Position - 0x29A2B
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_329()//Position - 0x29A3E
{
	if (func_23(Local_68.f_9))
	{
...
int func_330(int iParam0, struct<3> Param1, bool bParam2, bool bParam3, bool bParam4, int iParam5)//Position - 0x29B39
{
	int iVar0;
	...
	if (func_23(iParam0))
	{
		...
		if (bParam3)
		{
			if (func_331(iParam0, Param1, 1112014848, 1084227584))
			{
				return 1;
			}
		}
...
int func_331(int iParam0, struct<3> Param1, float fParam2, float fParam3)//Position - 0x29CB1
{
...
int func_332(int iParam0, struct<3> Param1)//Position - 0x29CEA
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
...
void func_333(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x29D49
{
	func_334(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_334(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x29D63
{
	func_335(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_335(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x29D80
{
	...
	uParam0->f_6 = 2;
	func_336(uParam0, iParam1, Param2, sParam3, iParam4, bParam5, uParam6, bParam7);
}

void func_336(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x29DB8
{
	int iVar0;
	int iVar1;
	...
	if (func_359(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		iVar1 = 0;
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			if (func_354(uParam0, bParam5, bParam7, 0))
			{
				func_351(uParam0, iParam1, Param2, iParam4);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
void func_337(var uParam0)//Position - 0x2A125
{
	if (func_359(PLAYER::PLAYER_PED_ID()))
	{
...
int func_338(var uParam0)//Position - 0x2A18E
{
	int iVar0;
...
int func_339(bool bParam0)//Position - 0x2A1B9
{
	switch (Global_43052)
	{
		case 0:
...
void func_340(char* sParam0, int iParam1)//Position - 0x2A263
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_341(char* sParam0)//Position - 0x2A27A
{
	if (!func_342(1, 1, 0))
	{
...
int func_342(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2A313
{
	int iVar0;
	int iVar1;
	...
	if ((func_349() || func_348(Global_4718592.f_168757)) || func_347())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
...
int func_343(int iParam0)//Position - 0x2A56C
{
	if (iParam0 != func_82())
	{
		...
		else if ((Global_1575058 && iParam0 == PLAYER::PLAYER_ID()) && func_344(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
int func_344(int iParam0, bool bParam1, bool bParam2)//Position - 0x2A5D2
{
	int iVar0;
...
int func_345(int iParam0, int iParam1)//Position - 0x2A632
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_346(int iParam0, bool bParam1)//Position - 0x2A694
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_347()//Position - 0x2A719
{
	return Global_2714762.f_19;
}

bool func_348(int iParam0)//Position - 0x2A727
{
	return iParam0 == 51;
}

var func_349()//Position - 0x2A734
{
	return Global_2714762.f_18;
}

bool func_350()//Position - 0x2A742
{
	return MISC::GET_GAME_TIMER() <= Global_23150.f_6269 + 100;
}

void func_351(var uParam0, int iParam1, struct<3> Param2, int iParam3)//Position - 0x2A757
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_352()//Position - 0x2A867
{
	return func_353(PLAYER::PLAYER_ID());
}

int func_353(int iParam0)//Position - 0x2A877
{
...
int func_354(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x2A896
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_357(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || func_355(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
int func_355(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2AC02
{
...
int func_356(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2AC54
{
	if (!func_342(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_357(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2AC9D
{
	if (!func_342(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_358(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2ACFC
{
	if (!func_342(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_359(int iParam0)//Position - 0x2AD52
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_360()//Position - 0x2ADAD
{
	MISC::SET_BIT(&Global_8137, 4);
}

void func_361(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2ADBD
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
	...
	{
		if (func_321(sParam1, 0, 0))
		{
			HUD::CLEAR_THIS_PRINT(sParam1);
		}
		if (func_321(sParam2, 0, 0))
		{
...
int func_362(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x2AEB8
{
	int iVar0;
	bool bVar1;
...
void func_363(int iParam0)//Position - 0x2AF0A
{
...
void func_364(var* uParam0, struct<3> Param1)//Position - 0x2AF59
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_365()//Position - 0x2B036
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_23(Local_68.f_9))
	{
		if (iLocal_70 == 0)
		{
			func_376(&(Local_68.f_9), &bLocal_116);
			if (func_375())
			{
				if (iLocal_109 || iLocal_58 == 7)
				{
					...
					{
						PED::SET_PED_MOVEMENT_CLIPSET(Local_68.f_9, func_373(), 0.25f);
						iLocal_70 = 1;
					}
				}
			}
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				case 0:
					if (func_112(Local_68.f_9, Local_337, 20f, 1))
					{
				...
				case 4:
					if (!func_64(Local_68.f_9, joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")))
					{
				...
				case 6:
					if (!func_112(Local_68.f_9, Local_337, 3.5f, 1))
					{
						if (!func_64(Local_68.f_9, joaat("SCRIPT_TASK_GO_TO_ENTITY")))
						{
							Local_68.f_10 = 5;
						}
						else
					...
					else if (!func_64(Local_68.f_9, joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), -1);
					}
					break;
				...
				case 8:
					if (!func_64(Local_68.f_9, joaat("SCRIPT_TASK_COMBAT")))
					{
						Local_68.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						Local_68.f_10 = 7;
					}
				...
				case 10:
					if (!PED::IS_PED_RAGDOLL(Local_68.f_9))
					{
						if (!func_64(Local_68.f_9, joaat("SCRIPT_TASK_COWER")) && !func_64(Local_68.f_9, joaat("SCRIPT_TASK_HANDS_UP")))
						{
				...
				case 29:
					if (func_120(Local_68.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						TASK::TASK_COMBAT_PED(Local_68.f_9, PLAYER::PLAYER_PED_ID(), 0, 16);
						TASK::TASK_SET_SPHERE_DEFENSIVE_AREA(Local_68.f_9, Local_338, 30f);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, true);
						Local_68.f_10 = 30;
					}
					break;
				...
				case 13:
					if (func_120(Local_68.f_18, MISC::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_68.f_9))
						{
							PED::SET_PED_PANIC_EXIT_SCENARIO(Local_68.f_9, Local_337);
						}
						WEAPON::GET_CURRENT_PED_WEAPON(Local_68.f_9, &iVar0, true);
						if (iVar0 != joaat("weapon_unarmed"))
						{
				...
				case 14:
					if (!func_64(Local_68.f_9, joaat("SCRIPT_TASK_SMART_FLEE_PED")) && !PED::IS_PED_FLEEING(Local_68.f_9))
					{
						Local_68.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						Local_68.f_10 = 13;
					}
				...
				case 15:
					...
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_71[0 /*6*/], false) && func_112(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f, 1)) && func_372(ENTITY::GET_ENTITY_HEADING(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f))
						{
				...
				case 16:
					...
					else if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_71[0 /*6*/], false) || PED::IS_PED_BEING_JACKED(Local_68.f_9)) || !func_112(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f, 1)) || !func_372(ENTITY::GET_ENTITY_HEADING(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f))
					{
						Local_68.f_10 = 13;
					}
					...
					else if (!func_64(Local_68.f_9, joaat("SCRIPT_TASK_ENTER_VEHICLE")))
					{
						Local_68.f_10 = 15;
					}
				...
				case 18:
					if (!func_64(Local_68.f_9, joaat("SCRIPT_TASK_VEHICLE_MISSION")))
					{
						Local_68.f_10 = 17;
					}
					break;
				...
				case 20:
					if (!PED::IS_PED_RAGDOLL(Local_68.f_9))
					{
						if (!func_64(Local_68.f_9, joaat("SCRIPT_TASK_COWER")))
						{
							Local_68.f_10 = 19;
						}
					}
				...
				case 21:
					...
					else if (PED::DOES_GROUP_EXIST(func_368()))
					{
						...
						if (!PED::IS_PED_GROUP_MEMBER(Local_68.f_9, func_368()))
						{
							PED::SET_PED_AS_GROUP_MEMBER(Local_68.f_9, func_368());
						}
						PED::SET_GROUP_FORMATION(func_368(), 0);
						PED::SET_GROUP_FORMATION_SPACING(func_368(), 1.5f, 3.5f, -1f);
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (func_367())
							{
								...
								if (!PED::IS_PED_IN_VEHICLE(Local_68.f_9, iVar1, false))
								{
									...
									if (fVar3 < 1.75f && func_112(Local_68.f_9, Local_337, 8f, 1))
									{
										if (!func_64(Local_68.f_9, joaat("SCRIPT_TASK_ENTER_VEHICLE")))
										{
											iVar2 = -1;
				...
				case 23:
					if (func_370(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_369())
					{
						...
						if (((!PED::IS_PED_RAGDOLL(Local_68.f_9) && !PED::IS_PED_BEING_STUNNED(Local_68.f_9, 0)) && !PED::IS_PED_BEING_JACKED(Local_68.f_9)) && !func_64(Local_68.f_9, joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")))
						{
							TASK::TASK_LOOK_AT_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							if ((!func_366(Local_68.f_19, 10) && func_112(Local_68.f_9, Local_337, 50f, 1)) || !func_120(iLocal_142, 2000))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, true))
								{
									TASK::TASK_LEAVE_ANY_VEHICLE(Local_68.f_9, 0, 0);
				...
				case 24:
					if (func_370(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_369())
					{
						if (!func_64(Local_68.f_9, joaat("SCRIPT_TASK_HANDS_UP")))
						{
							if (!func_64(Local_68.f_9, joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, false))
								{
									if (!func_366(Local_68.f_19, 10) && func_112(Local_68.f_9, Local_337, 50f, 1))
									{
										TASK::TASK_LEAVE_ANY_VEHICLE(Local_68.f_9, 0, 0);
										Local_68.f_10 = 23;
									}
							...
							else if (!func_366(Local_68.f_19, 10) && func_112(Local_68.f_9, Local_337, 50f, 1))
							{
...
bool func_366(int iParam0, int iParam1)//Position - 0x2C1AA
{
	return (MISC::GET_FRAME_COUNT() - iParam0) > iParam1;
}

int func_367()//Position - 0x2C1BC
{
	int iVar0;
	int iVar1;
...
int func_368()//Position - 0x2C242
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_369()//Position - 0x2C252
{
	if (!iLocal_82)
	{
		return 1;
	}
	if (func_324(sLocal_148, 0))
	{
		return 1;
	}
...
int func_370(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)//Position - 0x2C2BF
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (func_23(iParam0))
	{
		...
		if (func_112(iParam0, Local_337, fParam2, 1))
		{
			if (!func_366(iParam1, 10))
			{
				if (bParam6)
				{
					if (func_371(1, 0, 1))
...
int func_371(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2C476
{
	int iVar0;
...
int func_372(float fParam0, float fParam1, float fParam2)//Position - 0x2C56D
{
...
char* func_373()//Position - 0x2C589
{
	return "move_m@bail_bond_not_tazered";
}

char* func_374()//Position - 0x2C595
{
	return "move_m@bail_bond_tazered";
}

int func_375()//Position - 0x2C5A1
{
	STREAMING::REQUEST_ANIM_SET(func_373());
	STREAMING::REQUEST_ANIM_SET(func_374());
	if (STREAMING::HAS_CLIP_SET_LOADED(func_373()) && STREAMING::HAS_CLIP_SET_LOADED(func_374()))
	{
		return 1;
	}
	return 0;
...
void func_376(var uParam0, bool bParam1)//Position - 0x2C5D6
{
...
void func_377(int iParam0, var uParam1, float fParam2, int iParam3)//Position - 0x2C5ED
{
	if (func_436(iParam0))
	{
		if (func_378(iParam0, PLAYER::PLAYER_PED_ID(), fParam2, 1, 250, iParam3))
		{
...
bool func_378(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2C619
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	
	iVar2 = func_384(iParam0, iParam1);
	if (!func_436(iParam0) || !func_436(iParam1))
	{
		if (iVar2 != -1)
		{
	...
	if (!func_382(iParam0, iParam1, fParam2, iParam3))
	{
		return 0;
	}
	if (iVar2 == -1)
	...
	uVar0 = func_379(&(Local_56[iVar2 /*4*/]), Var1, iParam1, &(Local_56[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_56[iVar2 /*4*/].f_3) < iParam4);
}

int func_379(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2C6DA
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_380(int iParam0, int iParam1)//Position - 0x2C806
{
	int iVar0;
...
int func_382(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2C915
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
float func_383(struct<3> Param0, struct<3> Param1)//Position - 0x2C9A6
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

int func_384(int iParam0, int iParam1)//Position - 0x2C9C7
{
	int iVar0;
...
void func_385(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2CA06
{
	if (func_436(iParam0))
	{
		if (func_378(PLAYER::PLAYER_PED_ID(), iParam0, fParam2, 1, 250, iParam3))
		{
...
void func_386()//Position - 0x2CA32
{
	if (func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_336, 100f))
	{
		if (!func_387())
		{
			CUTSCENE::REQUEST_CUTSCENE(&Local_331, 8);
			func_67();
			iLocal_114 = 1;
		}
	}
	...
	{
		if (!func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_336, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
...
bool func_387()//Position - 0x2CABC
{
	return Global_97750;
}

void func_388()//Position - 0x2CAC8
{
	func_37();
	func_386();
	if (func_23(Local_68.f_9))
	{
		...
		switch (iLocal_60)
		{
			...
			case 1:
				if (!iLocal_110)
				{
					if (func_321("BBS_05", 0, 0))
					{
						HUD::CLEAR_THIS_PRINT("BBS_05");
					}
					func_117(&(Local_68.f_8));
					if (!func_112(Local_68.f_9, Local_337, 25f, 1))
					{
				...
				else if (func_112(Local_68.f_9, Local_337, 8f, 1))
				{
				...
				else
				{
					...
					if (!HUD::DOES_BLIP_EXIST(Local_68.f_8))
					{
						Local_68.f_8 = func_362(Local_68.f_9, 1, 1, 5);
					}
					if (!iLocal_101)
					{
						func_323("BBS_05", 7500, 1);
						iLocal_101 = 1;
					}
				}
				if (func_319(&(Local_68.f_9)))
...
void func_389()//Position - 0x2CDC6
{
	int iVar0;
	int iVar1;
		...
		else
		{
			...
			if (PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!iLocal_89)
				{
					...
					else if (!func_324("BBC_T8", 1) && !func_324("BB2_WTF", 1))
					{
				...
				else if (!iLocal_93)
				{
					if (func_390(&iVar0))
					{
						if ((!func_324("BB2_JACK", 1) && !func_324("BBC_T6", 1)) && !func_324("BBC_T8", 1))
						{
			...
			else
			{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, false))
				{
					if (!iLocal_90)
					{
						if (!func_324("BBC_T7", 1) && !func_324("BB2_OUT", 1))
						{
							if (MISC::GET_RANDOM_INT_IN_RANGE(0, 11) < 5)
							{
				...
				else if (Local_68.f_10 == 24 && func_64(Local_68.f_9, joaat("SCRIPT_TASK_HANDS_UP")))
				{
					if (func_112(Local_68.f_9, Local_337, 25f, 1))
					{
						if (!func_324("BB2_J10", 1))
						{
...
int func_390(int iParam0)//Position - 0x2D244
{
	int iVar0;
...
void func_391(char* sParam0, bool bParam1)//Position - 0x2D27D
{
	if (func_328(sParam0))
	{
...
void func_392(int iParam0)//Position - 0x2D294
{
...
void func_393()//Position - 0x2D2CF
{
	func_37();
	func_386();
	if (func_23(Local_68.f_9))
	{
		...
		switch (iLocal_60)
		{
			...
			case 1:
				if (!iLocal_110)
				{
					...
					else
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_117))
						{
							if (iLocal_97)
							{
								iLocal_117 = func_398(Local_336, 5, 1);
							}
						}
						if (!iLocal_83)
						{
						...
						{
							func_389();
							func_396(&Local_75, Local_337, &iLocal_126, 5000, 1101004800);
						}
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_336, 4f, 4f, 2f, true, true, 0))
						{
						}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (func_112(PLAYER::PLAYER_PED_ID(), Local_336, 6.5f, 1))
							{
								iLocal_60 = 2;
							}
						}
						else if (func_112(PLAYER::PLAYER_PED_ID(), Local_336, 2.5f, 1))
						{
							iLocal_60 = 2;
						}
					}
				...
				{
					func_117(&iLocal_117);
					if (func_321("BBS_DROP", 0, 0))
					{
						HUD::CLEAR_THIS_PRINT("BBS_DROP");
					}
					if (func_112(Local_68.f_9, Local_337, 8f, 1))
					{
						if (Local_68.f_10 == 25 || Local_68.f_10 == 26)
						{
							Local_68.f_18 = MISC::GET_GAME_TIMER();
				...
				if (!bLocal_107)
				{
					bLocal_107 = func_394(Local_337, Local_63, 180f);
				}
				if (func_319(&(Local_68.f_9)))
				{
					iLocal_115 = 1;
			...
			case 2:
				...
				else
				{
					...
					if (!bLocal_107)
					{
						bLocal_107 = func_394(Local_337, Local_63, 0f);
					}
					func_131(4);
				}
				break;
...
int func_394(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x2D6C0
{
	int iVar0;
	
	if (!func_395(Param0, Param1, fParam2))
	{
...
bool func_395(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x2D7B2
{
	struct<3> Var0;
...
int func_396(int iParam0, struct<3> Param1, int iParam2, int iParam3, float fParam4)//Position - 0x2D7DC
{
	struct<3> Var0;
	var uVar1;
	char[] cVar2[8];
		...
		if (!func_62())
		{
			...
			if (SYSTEM::VDIST2(Param1, Var0) < (fParam4 * fParam4))
			{
				if (MISC::GET_GAME_TIMER() - *iParam2) > (iParam3 + MISC::GET_RANDOM_INT_IN_RANGE(0, 2000))
				{
					...
					cVar2 = "BBCAUD";
					sVar3 = "BBC_loiter";
					func_397(&uVar1, cVar2, sVar3, 4, 0, 0);
...
void func_397(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2D868
{
...
int func_398(struct<3> Param0, int iParam1, bool bParam2)//Position - 0x2D8A3
{
	int iVar0;
...
void func_399()//Position - 0x2D8D1
{
	bool bVar0;
			...
			case 1:
				...
				if (!iLocal_109)
				{
					...
					if (Local_68.f_10 == 13 || Local_68.f_10 == 14)
					{
						...
						if (func_330(Local_68.f_9, Local_337, bVar0, 0, 1, 170))
						{
							func_329();
							func_401(iLocal_134);
							Local_68.f_17 = MISC::GET_GAME_TIMER();
					...
					else if ((iLocal_129 > 0 && func_112(Local_68.f_9, Local_337, 85f, 1)) || ENTITY::GET_ENTITY_HEALTH(Local_68.f_9) < 200)
					{
						Local_68.f_10 = 13;
						Local_68.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						iLocal_136 = MISC::GET_GAME_TIMER();
...
void func_400(bool bParam0, var uParam1)//Position - 0x2DDB7
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_401(int iParam0)//Position - 0x2DEA4
{
	int iVar0;
...
void func_402(int iParam0)//Position - 0x2DEED
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_23(Local_69[iVar0 /*20*/]))
		{
			func_377(Local_69[iVar0 /*20*/], &(Local_69[iVar0 /*20*/].f_17), 1126825984, 7);
			switch (Local_69[iVar0 /*20*/].f_14)
			{
				...
				case 2:
					func_403(Local_69[iVar0 /*20*/], &(Local_69[iVar0 /*20*/].f_6), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0);
					break;
				
				case 3:
					if (!func_64(Local_69[iVar0 /*20*/], joaat("SCRIPT_TASK_PLAY_ANIM")))
					{
						func_121(iVar0);
					}
					break;
				...
				case 4:
					if (!func_64(Local_69[iVar0 /*20*/], joaat("SCRIPT_TASK_SMART_FLEE_PED")))
					{
						func_106(Local_69[iVar0 /*20*/], 1);
					}
					func_116(&(Local_69[iVar0 /*20*/].f_6));
...
int func_403(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11)//Position - 0x2E078
{
	bool bVar0;
...
void func_404(int iParam0)//Position - 0x2E264
{
	int iVar0;
...
void func_405()//Position - 0x2E2A3
{
	if (func_23(Local_68.f_9))
	{
		func_385(Local_68.f_9, &iLocal_135, 1126825984, 1);
		func_377(Local_68.f_9, &(Local_68.f_19), 1126825984, 7);
		func_365();
		switch (iLocal_60)
		{
			case 0:
				...
				func_322(&(Local_68.f_8), "", "", &iLocal_127, &iLocal_128, 1, 0);
				iLocal_60 = 1;
				break;
			...
			case 1:
				switch (iLocal_61)
				{
					case 2:
						...
						{
							if (!func_324("BBC_T14", 1))
							{
								func_322(&(Local_68.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_127, &iLocal_128, 1, 1);
								iLocal_99 = 1;
							}
						}
						else
						{
							func_361(&(Local_68.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_127, iLocal_128, 1);
							if (func_112(Local_68.f_9, Local_337, 22f, 1) && func_415(Local_68.f_9, Local_337, 10f))
							{
								if (PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false))
								{
									if (func_414(&(Local_68.f_19)))
									{
										iLocal_61 = 1;
										iLocal_91 = 0;
								...
								else if (func_413(Local_68.f_9, iLocal_135, 0, 1102053376, 1086324736))
								{
									iLocal_61 = 0;
								}
								else if (func_112(Local_68.f_9, Local_337, 5f, 1))
								{
									iLocal_61 = 0;
								}
								else if (func_414(&(Local_68.f_19)))
								{
									if (func_112(Local_68.f_9, Local_337, (22f - 1.5f), 1))
									{
										iLocal_61 = 1;
										iLocal_91 = 0;
										if (Local_68.f_10 != 3 && Local_68.f_10 != 4)
						...
						if (func_370(Local_68.f_9, Local_68.f_19, 22f, 0, 1090519040, 1097859072, 0))
						{
							iLocal_60 = 2;
						}
						break;
					...
					case 1:
						if (!iLocal_91)
						{
							if (func_321("BBS_APHEND", 0, 0) || func_321("BBS_APHEND2", 0, 0))
							{
								HUD::CLEAR_PRINTS();
							}
							if (func_62())
						...
						{
							if (!func_324("BBC_T14", 1) && !func_324("BB2_J2", 1))
							{
								if (func_321("BBS_APHEND", 0, 0) || func_321("BBS_APHEND2", 0, 0))
								{
									HUD::CLEAR_PRINTS();
...
void func_406(bool bParam0)//Position - 0x2E785
{
	if (func_324("BB2_AMB", 0))
	{
		if (bParam0)
		{
			func_407();
...
void func_407()//Position - 0x2E7A9
{
	Global_20471 = 0;
	func_408();
}

void func_408()//Position - 0x2E7B9
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_409()//Position - 0x2E7DD
{
	if (!iLocal_92)
	{
		if (!func_62())
		{
			if (func_112(Local_68.f_9, Local_337, (22f + 5f), 1))
			{
				iLocal_118 = 0;
				if (HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
				...
				else if (func_411(&uLocal_157, cLocal_150, "BB2_AMB", &Local_335, 1, iLocal_118, 0))
				{
					iLocal_92 = 1;
					StringCopy(&Local_335, "", 24);
				}
	...
	else if (func_324("BB2_AMB", 0))
	{
		if (!func_112(Local_68.f_9, Local_337, (22f + 10f), 1))
		{
			Local_335 = { func_410() };
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_335))
			{
...
struct<6> func_410()//Position - 0x2E904
{
	struct<6> Var0;
	int iVar1;
	int iVar2;
...
int func_411(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2E9B0
{
	if (iParam5 == 0)
	{
		if (HUD::IS_MESSAGE_BEING_DISPLAYED())
	...
	if (func_412(uParam0, sParam1, sParam2, sParam3, iParam4, iParam5, iParam6))
	{
		return 1;
	}
	return 0;
...
bool func_412(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2E9ED
{
...
int func_413(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)//Position - 0x2EA41
{
	if (func_436(iParam0))
	{
		if (!func_366(iParam1, 10))
		{
			if (bParam2)
			{
				if (!func_112(Local_68.f_9, Local_337, fParam3, 1))
				{
					return 0;
				}
				if (!func_415(iParam0, Local_337, fParam4))
				{
					return 0;
				}
			}
...
int func_414(var uParam0)//Position - 0x2EAA8
{
	if (!func_366(*uParam0, 10))
	{
		return 1;
	}
	return 0;
...
int func_415(int iParam0, struct<3> Param1, float fParam2)//Position - 0x2EAC2
{
	struct<3> Var0;
	float fVar1;
...
void func_416()//Position - 0x2EAF1
{
	switch (iLocal_60)
	{
		case 0:
...
void func_417(var uParam0, var uParam1)//Position - 0x2ED21
{
	if (!uParam0->f_7)
	{
		if (func_420(26, func_422(uParam0->f_4), 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if ((!func_62() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID())) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
					...
					if (func_76(uParam1, func_419(uParam0->f_4), func_418(uParam0->f_4), 4, 0, 0, 0))
					{
						uParam0->f_7 = 1;
					}
				}
...
char* func_418(int iParam0)//Position - 0x2EDB2
{
	switch (iParam0)
	{
		case 0:
...
char* func_419(int iParam0)//Position - 0x2EDF7
{
	switch (iParam0)
	{
		case 0:
...
int func_420(int iParam0, int iParam1, int iParam2)//Position - 0x2EE3A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_421(int iParam0)//Position - 0x2EF24
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_422(int iParam0)//Position - 0x2EF88
{
	switch (iParam0)
	{
		case 0:
...
void func_423()//Position - 0x2EFC5
{
	if (bLocal_103)
	{
...
void func_424()//Position - 0x2F022
{
	if (bLocal_103)
	{
...
void func_425()//Position - 0x2F06C
{
	...
	if (iLocal_58 == 0)
	{
		if (!SYSTEM::VDIST2(Local_337, Local_63) <= ((Local_63.f_3 + 25f) * (Local_63.f_3 + 25f)))
		{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(Local_68.f_9))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_68.f_9, false) && !PED::IS_PED_INJURED(Local_68.f_9))
		{
			...
			{
				if (!func_112(Local_68.f_9, Local_337, 150f, 1))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_68.f_9))
					{
						iLocal_62 = 2;
			...
			{
				if (!func_112(Local_68.f_9, Local_337, 80f, 1))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_68.f_9))
					{
						iLocal_62 = 2;
...
int func_426(bool bParam0)//Position - 0x2F1AD
{
	if (func_23(Local_75.f_0))
	{
		...
		if (func_432(Local_75.f_0, 1126825984))
		{
			return 1;
		}
		if (func_427(Local_75.f_0, 1, 0, 0, 0))
		{
			return 1;
		}
...
int func_427(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2F305
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_436(PLAYER::PLAYER_PED_ID()) && func_436(iParam0))
	{
		...
		if (!bParam2)
		{
			if (func_431(iParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_428(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_428(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2F400
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_429(int iParam0, float fParam1)//Position - 0x2F50C
{
	var uVar0;
	struct<3> Var1;
	...
	{
		if (func_430(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_430(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0x2F5A1
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_431(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2F62F
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_432(int iParam0, float fParam1)//Position - 0x2F677
{
	float fVar0;
	
	if (func_436(PLAYER::PLAYER_PED_ID()) && func_436(iParam0))
	{
		if (func_434(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_433(int iParam0, float fParam1)//Position - 0x2F6ED
{
	return func_378(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_434(int iParam0)//Position - 0x2F705
{
...
void func_435(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)//Position - 0x2F72D
{
...
int func_436(int iParam0)//Position - 0x2F75B
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_437(bool bParam0)//Position - 0x2F77C
{
...
void func_438(int iParam0, bool bParam1)//Position - 0x2F7A4
{
	func_448(bParam1, 1);
	if (bParam1)
	{
...
void func_439()//Position - 0x2F833
{
	func_440(1, 0);
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_440(bool bParam0, bool bParam1)//Position - 0x2F8A5
{
	HUD::CLEAR_PRINTS();
	if (HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
	{
...
void func_441(bool bParam0)//Position - 0x2F9C3
{
	if (bParam0)
	{
...
void func_442()//Position - 0x2F9E9
{
	STREAMING::REMOVE_ANIM_SET(func_373());
	STREAMING::REMOVE_ANIM_SET(func_374());
}

void func_443(bool bParam0, int iParam1, int iParam2)//Position - 0x2FA01
{
	bool bVar0;
...
void func_444(int iParam0)//Position - 0x2FA60
{
	Global_97747 = iParam0;
}

void func_445(bool bParam0)//Position - 0x2FA6E
{
	if (bParam0)
	{
...
void func_446(bool bParam0)//Position - 0x2FB4A
{
	if (bParam0)
	{
		func_447();
...
void func_447()//Position - 0x2FBAD
{
...
void func_448(bool bParam0, bool bParam1)//Position - 0x2FBD6
{
	if (bParam0)
	{
		func_443(0, 1, 1);
...
void func_449(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x2FC09
{
	if (func_534())
	{
...
void func_450(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x2FC9E
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_534() || !func_532())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	{
		if (!func_529(iParam4, iParam5, iParam6, iParam11))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_500(Param1, fParam2);
	}
	else if (iParam7 == 1)
	{
		if (func_176(Param1, 0f, 0f, 0f, 0))
		...
		func_496(Param1, 5f, 0);
		if (func_89(iParam10))
		{
			func_495(iParam10, 0);
			while (!func_451(iParam0, iParam10, Param1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_451(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)//Position - 0x2FE32
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_113386.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113386.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113386.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_488(iParam0, &(Global_113386.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_113386.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_113386.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113386.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113386.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_488(iParam0, &(Global_113386.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_113386.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2.f_0, Param2, fParam3, true, true, false);
				...
				func_488(iParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_452(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x30C55
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_89(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_456(*iParam1, 0, &uVar0))
		{
			func_179(iParam1, &(Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_113386.f_20118[iParam0 /*43*/].f_31 = func_455(*iParam1);
				...
				func_453(Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_113386.f_20118[iParam0 /*43*/].f_1));
				...
				func_453(Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_113386.f_20118[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_453(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x31869
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_454(iVar0, &sVar2, &iVar1, &iVar3, &iVar4))
	{
...
bool func_454(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x318DC
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_455(int iParam0)//Position - 0x32DCE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_456(int iParam0, bool bParam1, var uParam2)//Position - 0x32E7E
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_483(iVar0, bParam1, uParam2) && !func_482(PLAYER::PLAYER_ID())) && !func_464(iParam0))
	{
		return 0;
	}
	...
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_460(iParam0)) && !bVar1) && !(func_459(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_457(PLAYER::PLAYER_ID())))
	{
...
int func_457(int iParam0)//Position - 0x32FEC
{
	if (iParam0 != func_82())
	{
		if (func_344(iParam0, 1, 1))
		{
			...
			{
				return func_458(Global_2689235[iParam0 /*453*/].f_318.f_6) == 11;
			}
		}
	}
	return 0;
...
int func_458(int iParam0)//Position - 0x33033
{
	switch (iParam0)
	{
		case 0:
...
int func_459(int iParam0)//Position - 0x334BA
{
...
int func_460(int iParam0)//Position - 0x334FC
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_461(int iParam0)//Position - 0x3359F
{
	if (iParam0 != func_82())
	{
		if (func_344(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1)
			{
				return func_458(Global_2689235[iParam0 /*453*/].f_318.f_6) == 13;
			}
		}
	}
	return 0;
...
int func_462(int iParam0)//Position - 0x335E6
{
	if (iParam0 != func_82())
	{
		if (func_344(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1)
			{
				return func_458(Global_2689235[iParam0 /*453*/].f_318.f_6) == 7;
			}
		}
	}
	return 0;
...
int func_463(int iParam0)//Position - 0x3362C
{
	return 1;
}

int func_464(int iParam0)//Position - 0x33635
{
	if (func_481(PLAYER::PLAYER_ID()) || func_480(PLAYER::PLAYER_ID()))
	{
		if (func_465(iParam0))
		{
			return 1;
...
int func_465(int iParam0)//Position - 0x33664
{
...
int func_466(int iParam0)//Position - 0x336D4
{
	int iVar0;
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_460(iParam0)) || func_467(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_467(int iParam0)//Position - 0x33757
{
	switch (iParam0)
	{
		case joaat("mule"):
...
int func_468(int iParam0, bool bParam1)//Position - 0x337A7
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_470(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				if (Global_2815059.f_303 == iParam0)
				{
					return 1;
				}
				else if (func_469(iParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_469(int iParam0)//Position - 0x33802
{
	int iVar0;
...
int func_470(int iParam0, int iParam1)//Position - 0x3383B
{
	if (iParam1 == 0)
	{
...
int func_480(int iParam0)//Position - 0x34123
{
	if (iParam0 != func_82())
	{
		if (func_344(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1 && Global_2689235[iParam0 /*453*/].f_318.f_9 != func_82())
			{
				return func_458(Global_2689235[iParam0 /*453*/].f_318.f_6) == 5;
			}
		}
	}
	return 0;
...
int func_481(int iParam0)//Position - 0x34182
{
	if (iParam0 != func_82())
	{
		if (func_344(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1 && Global_2689235[iParam0 /*453*/].f_318.f_9 != func_82())
			{
				return func_458(Global_2689235[iParam0 /*453*/].f_318.f_6) == 8;
			}
		}
	}
	return 0;
...
int func_482(int iParam0)//Position - 0x341E2
{
	if (iParam0 != func_82())
	{
		if (func_344(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1)
			{
				return func_458(Global_2689235[iParam0 /*453*/].f_318.f_6) == 9;
			}
		}
	}
	return 0;
...
int func_483(int iParam0, bool bParam1, var uParam2)//Position - 0x34229
{
	bool bVar0;
...
int func_484(int iParam0)//Position - 0x34675
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_485(int iParam0, int iParam1)//Position - 0x3469E
{
	int iVar0;
...
void func_486(int iParam0)//Position - 0x34720
{
	if (!func_487(*iParam0))
	{
...
bool func_487(int iParam0)//Position - 0x3474B
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_488(int iParam0, var uParam1, var uParam2)//Position - 0x3475A
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*iParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_492(*iParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_479(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_491(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_491(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_490(iParam0);
	if (func_489(*iParam0))
	{
...
int func_489(int iParam0)//Position - 0x34934
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_490(var uParam0)//Position - 0x34A10
{
...
int func_491(int iParam0, int iParam1)//Position - 0x34A67
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_492(int iParam0, int iParam1, int iParam2)//Position - 0x34B4C
{
	if (!func_493() && VEHICLE::_IS_VEHICLE_MOD_HSW_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_493()//Position - 0x34B70
{
	return 0;
}

int func_494(var uParam0, int iParam1)//Position - 0x34B79
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_495(int iParam0, int iParam1)//Position - 0x34BBA
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97772[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_97772[iVar0]) == func_167(iParam0, iParam1))
				{
...
void func_496(struct<3> Param0, float fParam1, bool bParam2)//Position - 0x34C58
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_166(&(Global_77137.f_555[0 /*21*/]), iVar0))
		{
...
void func_497(int iParam0)//Position - 0x34CA8
{
	bool bVar0;
	...
	if (func_166(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		...
		if (BitTest(Global_77137.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_172(iParam0, 0)) && Global_78046.f_66 == 0) && Global_113386.f_32749.f_1958[Global_77137.f_555[0 /*21*/].f_14] != 0) && Global_113386.f_32749.f_1958[Global_77137.f_555[0 /*21*/].f_14] > 3) && (!func_498(0, Global_77137.f_555[0 /*21*/].f_12) || !func_498(1, Global_77137.f_555[0 /*21*/].f_12)))
			{
				func_173(&(Global_113386.f_32749.f_69[Global_77137.f_555[0 /*21*/].f_14 /*78*/]), &Global_78046);
...
int func_498(int iParam0, int iParam1)//Position - 0x34E17
{
	int iVar0;
	...
	return func_138(Global_113386.f_32749.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}

int func_499(var uParam0)//Position - 0x34E89
{
	return *uParam0;
}

int func_500(struct<3> Param0, float fParam1)//Position - 0x34E94
{
	return func_501(&(Global_106934.f_2890), Param0, fParam1, 0);
}

int func_501(var uParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x34EAE
{
	int iVar0;
	struct<3> Var1;
	bool bVar2;
...
int func_502(int iParam0)//Position - 0x35160
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_503(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x35223
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_505(iParam0, Global_77137.f_139[38], 0))
			{
				func_497(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_505(iParam0, Global_77137.f_139[43], 1))
			{
				func_497(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_505(iParam0, uVar1[iVar3], 1) && func_504(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_176(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_504(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x3542B
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_505(int iParam0, int iParam1, bool bParam2)//Position - 0x354A6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_506(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x35507
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		{
			iVar0 = 1;
			if (BitTest(uParam1->f_77, func_178(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (BitTest(uParam1->f_77, func_178(iVar1 + 1)))
			{
			}
			else
			{
		...
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				if (BitTest(uParam1->f_77, func_178(iVar2)))
				{
				}
				else
				{
		...
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				if (BitTest(uParam1->f_77, func_178(iVar3)))
				{
				}
				else
				{
		...
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (BitTest(uParam1->f_77, func_178(iVar4)))
					{
					}
					else
					{
		...
		{
			if (BitTest(uParam1->f_77, func_178(4)))
			{
			}
			else
			{
		...
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar5 <= 2)
			{
				if (BitTest(uParam1->f_77, func_178(iVar5)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_178(iVar5));
				}
				iVar5++;
			}
		}
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar6 <= 11)
			{
				if (BitTest(uParam1->f_77, func_178(iVar6 + 1)))
				{
...
int func_508(var uParam0)//Position - 0x35C3D
{
	int iVar0;
...
int func_509(int iParam0)//Position - 0x35C61
{
	int iVar0;
	...
	if (iVar0 != -1)
	{
		return func_81(iParam0, 9);
	}
	return 0;
}

bool func_510(int iParam0)//Position - 0x35C7F
{
	return func_511(&(Global_2703735.f_169), iParam0);
}

var func_511(var uParam0, var uParam1)//Position - 0x35C93
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_512(int iParam0, int iParam1)//Position - 0x35CB6
{
	int iVar0;
	bool bVar1;
...
bool func_513()//Position - 0x35D2E
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

int func_514(int iParam0)//Position - 0x35D3F
{
	int iVar0;
...
int func_515(int iParam0)//Position - 0x35D87
{
	if (!func_493() && func_516(iParam0))
	{
		return 1;
	}
	return 0;
...
int func_516(int iParam0)//Position - 0x35DA7
{
	switch (iParam0)
	{
		case 161:
...
int func_517(int iParam0)//Position - 0x35DFA
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (!func_523(PLAYER::PLAYER_ID(), -1))
		{
...
int func_518(int iParam0)//Position - 0x35E81
{
...
int func_519(int iParam0)//Position - 0x35EB0
{
...
int func_520(int iParam0)//Position - 0x35ECD
{
...
int func_521(int iParam0, int iParam1)//Position - 0x35EF0
{
...
int func_522(int iParam0)//Position - 0x35F2B
{
	if (func_521(iParam0, 0))
	{
...
int func_523(int iParam0, int iParam1)//Position - 0x35F4E
{
	int iVar0;
...
int func_524(var uParam0)//Position - 0x35F9B
{
	if (func_525(uParam0))
	{
...
int func_525(var uParam0)//Position - 0x35FD0
{
...
bool func_526()//Position - 0x3602F
{
	return func_524(&(Global_106934.f_2890));
}

void func_527()//Position - 0x36042
{
	func_528(&(Global_106934.f_2890));
}

void func_528(var uParam0)//Position - 0x36055
{
	if (func_525(uParam0))
	{
...
int func_529(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x36073
{
	...
	if (iParam2 == 0 && func_531(Global_106934.f_2890.f_12.f_66))
	{
		return 0;
	}
...
int func_531(int iParam0)//Position - 0x36176
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_532()//Position - 0x361CF
{
	return func_525(&(Global_106934.f_2890));
}

int func_533()//Position - 0x361E2
{
...
void func_535()//Position - 0x36230
{
	struct<3> Var0;
	struct<3> Var1;
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("player"), iLocal_322);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_322, joaat("player"));
	Var0 = { func_542(Local_63) };
	Var1 = { func_541(Local_63) };
	PED::SET_PED_NON_CREATION_AREA(Var0, Var1);
	iLocal_143 = PED::ADD_SCENARIO_BLOCKING_AREA(Var0, Var1, false, true, true, true);
	MISC::CLEAR_AREA(Local_63, 15f, false, false, false, false);
...
void func_536()//Position - 0x36375
{
	int iVar0;
	...
	if (func_23(Local_68.f_9))
	{
		...
		func_363(Local_68.f_9);
		func_537(Local_68.f_9, "TARGET_", 0);
		Local_68.f_10 = 0;
	...
	while (iVar0 <= 5)
	{
		if (func_23(Local_69[iVar0 /*20*/]))
		{
			...
			func_537(Local_69[iVar0 /*20*/], "BACKUP_", iVar0);
			if (func_102(Local_71[0 /*6*/]))
			{
				if (iVar0 == 1)
				{
			...
			if (iVar0 == 0)
			{
				...
				if (func_23(Local_69[iVar0 /*20*/]))
				{
					...
					PED::SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(Local_69[iVar0 /*20*/], true);
				}
			}
		}
		iVar0++;
...
void func_537(int iParam0, char* sParam1, int iParam2)//Position - 0x36827
{
	char cVar0[16];
...
int func_538()//Position - 0x36843
{
	...
	if (iLocal_131 > 0)
	{
		...
		{
			if (func_540(&(Local_71[iVar2 /*6*/]), Local_71[iVar2 /*6*/].f_5, Local_71[iVar2 /*6*/].f_1, Local_71[iVar2 /*6*/].f_4, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	if (iLocal_133 > 0)
	{
		...
		{
			if (func_539(&(Local_74[iVar2 /*7*/]), Local_74[iVar2 /*7*/].f_5, Local_74[iVar2 /*7*/].f_2, Local_74[iVar2 /*7*/].f_6, Local_74[iVar2 /*7*/].f_1, 1))
			{
				iVar0++;
			}
			iVar2++;
...
int func_539(var uParam0, int iParam1, struct<3> Param2, int iParam3, int iParam4, bool bParam5)//Position - 0x36A8A
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam4))
...
int func_540(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0x36AFB
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
Vector3 func_541(struct<5> Param0, var uParam1, var uParam2, var uParam3)//Position - 0x36B9A
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_542(struct<5> Param0, var uParam1, var uParam2, var uParam3)//Position - 0x36C0E
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_543()//Position - 0x36C82
{
	int iVar0;
	...
	iLocal_130 = 0;
	iLocal_133 = 0;
	Local_339 = { 232.541f, 2321.896f, 76.1228f };
	fLocal_119 = 129.6421f;
	Local_340 = { 190.8215f, 2284.055f, 88.3843f };
	fLocal_120 = 76.0608f;
	Local_341 = { 181.1229f, 2289.56f, 91.2944f };
	...
	iLocal_139 = 0;
	iLocal_141 = -1;
	Local_338 = { 166.4233f, 2285.507f, 92.5205f };
	Local_336 = { 2722.661f, 4143.105f, 43.0617f };
	StringCopy(&Local_323, "", 24);
	StringCopy(&Local_335, "", 24);
	Local_75.f_6 = func_554(62);
	Local_75.f_1 = { func_553() };
	Local_75.f_4 = func_552();
	Local_77.f_5 = func_551();
	Local_77.f_1 = { func_550() };
	Local_77.f_4 = func_549();
	Local_78.f_5 = func_548();
	Local_78.f_1 = { func_547() };
	Local_78.f_4 = func_546();
	Local_79.f_5 = func_48();
	Local_79.f_1 = { func_47() };
	Local_79.f_4 = func_46();
	Local_80.f_5 = func_45();
	Local_80.f_1 = { func_545() };
	Local_80.f_4 = func_544();
...
float func_544()//Position - 0x370CD
{
	return 75.15f;
}

Vector3 func_545()//Position - 0x370DA
{
	return 2727.29f, 4145.9f, 44.16f;
}

float func_546()//Position - 0x370F1
{
	return 71f;
}

Vector3 func_547()//Position - 0x370FE
{
	return 2727.686f, 4145.715f, 44.08f;
}

int func_548()//Position - 0x37115
{
	return joaat("prop_laptop_01a");
}

float func_549()//Position - 0x37122
{
	return -91.28f;
}

Vector3 func_550()//Position - 0x3712F
{
	return 2728.35f, 4145.59f, 43.3f;
}

int func_551()//Position - 0x37146
{
	return joaat("prop_table_03_chr");
}

float func_552()//Position - 0x37153
{
	return 89.19f;
}

Vector3 func_553()//Position - 0x37160
{
	return 2728.33f, 4145.6f, 43.89f;
}

int func_554(int iParam0)//Position - 0x37177
{
	if (!func_89(iParam0))
	{
		return func_92(iParam0);
...
int func_555(bool bParam0)//Position - 0x3719D
{
...
int func_559(int iParam0)//Position - 0x372D5
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_558()) || Global_112433) || Global_31962) || func_564()) || func_95(8, -1)) || func_563()) || func_562()) || func_556()) || func_557()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_558()) || Global_31962) || func_564()) || func_95(8, -1)) || func_556()) || func_563()) || func_562()) || func_557()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_558()) || Global_112433) || Global_31962) || func_564()) || func_95(8, -1)) || func_556()) || func_563()) || func_562()) || func_557()) || Global_113386.f_7688.f_919[iVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_558()) || Global_112433) || Global_31962) || func_564()) || func_95(8, -1)) || func_563()) || func_562()) || func_557()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_558() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_95(8, -1)) || func_557()) || func_561()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_95(8, -1) || func_563()) || func_562()) || func_561()) || func_560())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_558()) || Global_31962) || func_564()) || func_95(8, -1)) || func_562()) || func_556()) || func_557()) || Global_113386.f_7688.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_558()) || func_562()) || Global_112433) || Global_31962) || func_564()) || Global_44238) || func_95(8, -1)) || func_556()) || func_561()) || func_557()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_558()) || Global_112433) || Global_31962) || func_564()) || func_95(8, -1)) || func_556()) || func_561()) || func_563()) || func_562()) || func_557())
						{
							return 0;
						}
						break;
...
var func_560()//Position - 0x379F2
{
	return Global_100480.f_1;
}

int func_561()//Position - 0x37A00
{
	if (Global_97363 != -1)
	{
...
bool func_562()//Position - 0x37A23
{
	return Global_100493.f_376 > 0;
}

bool func_563()//Position - 0x37A34
{
	return Global_100493.f_375 > 0;
}

var func_564()//Position - 0x37A45
{
	return Global_1575058;
}

bool func_565(int iParam0)//Position - 0x37A51
{
	return func_566(iParam0, Global_43052);
}

int func_566(int iParam0, int iParam1)//Position - 0x37A62
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_567(int iParam0)//Position - 0x37C43
{
	func_592();
	if (!func_591())
	{
		...
		func_568(SCRIPT::GET_THIS_SCRIPT_NAME());
	}
}

void func_568(char* sParam0)//Position - 0x37C8E
{
	if (Global_100441 != 12)
	{
		func_569(sParam0, 5, -1);
	}
}

int func_569(char* sParam0, int iParam1, int iParam2)//Position - 0x37CAB
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
	...
	if (func_580())
	{
		...
		{
			iVar2 = func_570(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_570(char* sParam0)//Position - 0x37E3A
{
...
void func_571(int iParam0, var uParam1)//Position - 0x37E90
{
	switch (iParam0)
	{
		case 0:
			func_572(uParam1, "Abigail1", func_574(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0, "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_573(iParam0), 1, 0);
			break;
		
		case 1:
			func_572(uParam1, "Abigail2", func_574(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, -1, 4, 1, 0, 2359, func_573(iParam0), 1, 0);
			break;
		
		case 2:
			func_572(uParam1, "Barry1", func_574(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1, 4, 1, 0, 2359, func_573(iParam0), 1, 0);
			break;
		
		case 3:
			func_572(uParam1, "Barry2", func_574(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_573(iParam0), 1, 1);
			break;
		
		case 4:
			func_572(uParam1, "Barry3", func_574(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2, 0, 2359, func_573(iParam0), 0, 0);
			break;
		
		case 5:
			func_572(uParam1, "Barry3A", func_574(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 6:
			func_572(uParam1, "Barry3C", func_574(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 7:
			func_572(uParam1, "Barry4", func_574(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_573(iParam0), 0, 0);
			break;
		
		case 8:
			func_572(uParam1, "Dreyfuss1", func_574(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_573(iParam0), 0, 0);
			break;
		
		case 9:
			func_572(uParam1, "Epsilon1", func_574(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1, 10, 4, 1, 0, 2359, func_573(iParam0), 0, 0);
			break;
		
		case 10:
			func_572(uParam1, "Epsilon2", func_574(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0, 11, 4, 1, 0, 2359, func_573(iParam0), 1, 0);
			break;
		
		case 11:
			func_572(uParam1, "Epsilon3", func_574(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars", 0, 0, 12, 4, 1, 0, 2359, func_573(iParam0), 0, 0);
			break;
		
		case 12:
			func_572(uParam1, "Epsilon4", func_574(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16, "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_573(iParam0), 0, 0);
			break;
		
		case 13:
			func_572(uParam1, "Epsilon5", func_574(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16, "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_573(iParam0), 1, 0);
			break;
		
		case 14:
			func_572(uParam1, "Epsilon6", func_574(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0, 15, 4, 1, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 15:
			func_572(uParam1, "Epsilon7", func_574(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_573(iParam0), 0, 0);
			break;
		
		case 16:
			func_572(uParam1, "Epsilon8", func_574(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_573(iParam0), 1, 0);
			break;
		
		case 17:
			func_572(uParam1, "Extreme1", func_574(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 18:
			func_572(uParam1, "Extreme2", func_574(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171, 0, 19, 4, 2, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 19:
			func_572(uParam1, "Extreme3", func_574(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20, 4, 2, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 20:
			func_572(uParam1, "Extreme4", func_574(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, -1, 4, 2, 0, 2359, func_573(iParam0), 0, 0);
			break;
		
		case 21:
			func_572(uParam1, "Fanatic1", func_574(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, -1, 4, 1, 700, 2000, func_573(iParam0), 1, 0);
			break;
		
		case 22:
			func_572(uParam1, "Fanatic2", func_574(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1, -1, 4, 4, 700, 2000, func_573(iParam0), 1, 0);
			break;
		
		case 23:
			func_572(uParam1, "Fanatic3", func_574(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1, 4, 2, 700, 2000, func_573(iParam0), 0, 1);
			break;
		
		case 24:
			func_572(uParam1, "Hao1", func_574(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0, "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_573(iParam0), 0, 1);
			break;
		
		case 25:
			func_572(uParam1, "Hunting1", func_574(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 26:
			func_572(uParam1, "Hunting2", func_574(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, -1, 4, 4, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 27:
			func_572(uParam1, "Josh1", func_574(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_573(iParam0), 1, 0);
			break;
		
		case 28:
			func_572(uParam1, "Josh2", func_574(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0, 29, 4, 4, 0, 2359, func_573(iParam0), 1, 1);
			break;
		
		case 29:
			func_572(uParam1, "Josh3", func_574(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_573(iParam0), 1, 1);
			break;
		
		case 30:
			func_572(uParam1, "Josh4", func_574(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1, 4, 4, 0, 2359, func_573(iParam0), 1, 0);
			break;
		
		case 31:
			func_572(uParam1, "Maude1", func_574(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0, "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 32:
			func_572(uParam1, "Minute1", func_574(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 33:
			func_572(uParam1, "Minute2", func_574(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 34:
			func_572(uParam1, "Minute3", func_574(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0, -1, 4, 4, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 35:
			func_572(uParam1, "MrsPhilips1", func_574(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0, "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_573(iParam0), 0, 0);
			break;
		
		case 36:
			func_572(uParam1, "MrsPhilips2", func_574(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_573(iParam0), 0, 0);
			break;
		
		case 37:
			func_572(uParam1, "Nigel1", func_574(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1, -1, 1, 4, 0, 2359, func_573(iParam0), 1, 0);
			break;
		
		case 38:
			func_572(uParam1, "Nigel1A", func_574(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_573(iParam0), 1, 1);
			break;
		
		case 39:
			func_572(uParam1, "Nigel1B", func_574(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_573(iParam0), 1, 1);
			break;
		
		case 40:
			func_572(uParam1, "Nigel1C", func_574(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_573(iParam0), 1, 1);
			break;
		
		case 41:
			func_572(uParam1, "Nigel1D", func_574(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_573(iParam0), 1, 1);
			break;
		
		case 42:
			func_572(uParam1, "Nigel2", func_574(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_573(iParam0), 1, 1);
			break;
		
		case 43:
			func_572(uParam1, "Nigel3", func_574(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16, "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_573(iParam0), 1, 1);
			break;
		
		case 44:
			func_572(uParam1, "Omega1", func_574(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_573(iParam0), 0, 0);
			break;
		
		case 45:
			func_572(uParam1, "Omega2", func_574(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_573(iParam0), 0, 0);
			break;
		
		case 46:
			func_572(uParam1, "Paparazzo1", func_574(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 47:
			func_572(uParam1, "Paparazzo2", func_574(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 48:
			func_572(uParam1, "Paparazzo3", func_574(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183, 1, -1, 2, 2, 0, 2359, func_573(iParam0), 0, 0);
			break;
		
		case 49:
			func_572(uParam1, "Paparazzo3A", func_574(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 50:
			func_572(uParam1, "Paparazzo3B", func_574(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 51:
			func_572(uParam1, "Paparazzo4", func_574(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1, -1, 4, 2, 0, 2359, func_573(iParam0), 0, 0);
			break;
		
		case 52:
			func_572(uParam1, "Rampage1", func_574(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_573(iParam0), 0, 0);
			break;
		
		case 54:
			func_572(uParam1, "Rampage3", func_574(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_573(iParam0), 1, 0);
			break;
		
		case 55:
			func_572(uParam1, "Rampage4", func_574(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_573(iParam0), 1, 0);
			break;
		
		case 56:
			func_572(uParam1, "Rampage5", func_574(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_573(iParam0), 0, 0);
			break;
		
		case 53:
			func_572(uParam1, "Rampage2", func_574(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0, "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_573(iParam0), 1, 0);
			break;
		
		case 57:
			func_572(uParam1, "TheLastOne", func_574(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, -1, 4, 2, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 58:
			func_572(uParam1, "Tonya1", func_574(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 59:
			func_572(uParam1, "Tonya2", func_574(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 60:
			func_572(uParam1, "Tonya3", func_574(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 61:
			func_572(uParam1, "Tonya4", func_574(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_573(iParam0), 0, 1);
			break;
		
		case 62:
			func_572(uParam1, "Tonya5", func_574(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0, -1, 4, 2, 0, 2359, func_573(iParam0), 0, 1);
			break;
...
void func_572(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0x391AE
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_573(int iParam0)//Position - 0x3923F
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_574(int iParam0)//Position - 0x39585
{
	struct<2> Var0;
	char[] cVar1[8];
	
	StringCopy(&Var0, "", 8);
	cVar1 = { func_575(iParam0) };
...
struct<2> func_575(int iParam0)//Position - 0x395BC
{
	struct<2> Var0;
...
int func_576()//Position - 0x39A08
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_577(&(Global_100441.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_577(char* sParam0, bool bParam1)//Position - 0x39A2C
{
	int iVar0;
	int iVar1;
...
int func_578(int iParam0, bool bParam1)//Position - 0x39A56
{
	int iVar0;
...
int func_580()//Position - 0x39ADC
{
	...
	{
		if (func_570(&(Global_100441.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_581(int iParam0)//Position - 0x39B48
{
	if (iParam0 == 1)
	{
		Global_43601 = 1;
...
void func_582(bool bParam0)//Position - 0x39B61
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_583(int iParam0)//Position - 0x39B75
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_584(int iParam0)//Position - 0x39BAF
{
	if (iParam0 == 1)
	{
...
void func_585()//Position - 0x39BE9
{
	Global_23011.f_5 = 1;
}

void func_586()//Position - 0x39BF7
{
	Global_23011.f_5 = 0;
}

void func_587()//Position - 0x39C05
{
	Global_94617 = 0;
	Global_94618 = 0;
}

void func_588()//Position - 0x39C17
{
	Global_100441 = 13;
	Global_100441.f_1 = -1;
	Global_100441.f_2 = 0;
...
void func_592()//Position - 0x39D02
{
	Global_100476 = 1;
...
void func_593()//Position - 0x39DEF
{
	if (iLocal_112)
	{
		func_440(0, 1);
