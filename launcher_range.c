...
void __EntryFunction__()//Position - 0x0
{
	...
	bLocal_78 = true;
	bLocal_93 = true;
	Local_56 = { ScriptParam_105.f_1[0 /*3*/] };
	Local_56 = { Local_56 };
	uLocal_54 = uLocal_54;
	Local_52 = { Local_52 };
	bVar0 = false;
	...
	if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_100(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_53) && !ENTITY::IS_ENTITY_DEAD(iLocal_53, false))
		{
			...
			fLocal_57 = SYSTEM::VDIST2(Local_55, ScriptParam_105.f_1[0 /*3*/]);
			fLocal_57 = fLocal_57;
			Local_75 = { Local_55 };
			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_83(3) && !Global_100475)
						{
							if (func_100(uLocal_58, 2097152))
							{
								if ((!func_100(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_82())) && !Global_100475)
								{
									func_93(10);
									break;
								}
						...
						if ((!func_73(6) || Global_112433) || func_72())
						{
							bVar2 = false;
						}
						if (!bLocal_78)
						...
						if (bVar2)
						{
							...
							if (bVar2)
							{
								...
								if (func_54(uLocal_54))
								{
									...
									else if (!func_100(uLocal_58, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_51(&iLocal_60);
				...
				case 6:
					...
					if (func_100(Global_112037, 262144))
					{
						func_104(&Global_112037, 262144);
						func_15();
					}
					if (func_100(uLocal_58, 2097152))
					{
						if (!func_83(3) && !SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
						{
							func_93(10);
						}
					}
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						else if (func_100(uLocal_58, 2))
						{
							if (func_100(Global_112037, 0))
							{
								func_6(&iLocal_62);
								iLocal_62 = -1;
								func_104(&uLocal_58, 2);
						...
						if (iLocal_63 != -1)
						{
							if (func_100(Global_112037, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_63), 0, Global_100478, 0);
								func_5(func_19(iLocal_63), 0, Global_100478, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_63), 0, Global_100478, 0);
								func_5(func_19(iLocal_63), 0, Global_100478, 0, 0);
							}
						}
						func_4();
						func_104(&Global_112037, 0);
...
void func_40()//Position - 0x15F8
{
	...
	if (bLocal_93)
	{
		...
		if (fVar1 < 400f)
		{
			if (!iLocal_94)
			{
				if ((ENTITY::DOES_ENTITY_EXIST(Local_100[0 /*6*/].f_1) && ENTITY::DOES_ENTITY_EXIST(iLocal_83)) && !PED::IS_PED_DEAD_OR_DYING(iLocal_83, true))
				{
					PED::SET_PED_ACCURACY(iLocal_83, 20);
					PED::SET_PED_STRAFE_CLIPSET(iLocal_83, "move_ped_strafing");
					if (iLocal_98 == 0)
					{
						Var3 = { ENTITY::GET_ENTITY_COORDS(Local_100[0 /*6*/].f_1, true) - Vector(0.75f, 0f, 0f) };
					}
					else
					{
						Var3 = { ENTITY::GET_ENTITY_COORDS(Local_100[0 /*6*/].f_1, true) - Vector(0.77f, 0f, 0f) };
					}
					TASK::OPEN_SEQUENCE_TASK(&iVar2);
					TASK::TASK_AIM_GUN_AT_COORD(0, Var3, 3000, false, false);
			...
			if (!iLocal_95)
			{
				if ((ENTITY::DOES_ENTITY_EXIST(Local_100[1 /*6*/].f_1) && ENTITY::DOES_ENTITY_EXIST(iLocal_84)) && !PED::IS_PED_DEAD_OR_DYING(iLocal_84, true))
				{
					PED::SET_PED_ACCURACY(iLocal_84, 20);
					PED::SET_PED_STRAFE_CLIPSET(iLocal_84, "move_ped_strafing");
					if (iLocal_98 == 0)
					{
						Var3 = { ENTITY::GET_ENTITY_COORDS(Local_100[1 /*6*/].f_1, true) - Vector(0.7f, 0f, 0f) };
					}
					else
					{
						Var3 = { ENTITY::GET_ENTITY_COORDS(Local_100[1 /*6*/].f_1, true) - Vector(0.7f, 0f, 0f) };
					...
					TASK::OPEN_SEQUENCE_TASK(&iVar2);
					TASK::TASK_AIM_GUN_AT_COORD(0, Var3, 4000, false, false);
			...
			if (!iLocal_96)
			{
				if ((ENTITY::DOES_ENTITY_EXIST(Local_100[2 /*6*/].f_1) && ENTITY::DOES_ENTITY_EXIST(iLocal_85)) && !PED::IS_PED_DEAD_OR_DYING(iLocal_85, true))
				{
					PED::SET_PED_ACCURACY(iLocal_85, 20);
					PED::SET_PED_STRAFE_CLIPSET(iLocal_85, "move_ped_strafing");
					if (iLocal_98 == 0)
					{
						Var3 = { ENTITY::GET_ENTITY_COORDS(Local_100[2 /*6*/].f_1, true) - Vector(0.8f, 0f, 0f) };
					}
					else
					{
						Var3 = { ENTITY::GET_ENTITY_COORDS(Local_100[2 /*6*/].f_1, true) - Vector(0.68f, 0f, 0f) };
					}
					TASK::OPEN_SEQUENCE_TASK(&iVar2);
					TASK::TASK_AIM_GUN_AT_COORD(0, Var3, 2000, false, false);
...
void func_41()//Position - 0x1A86
{
	...
	iLocal_97 = 1;
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_83) && !PED::IS_PED_DEAD_OR_DYING(iLocal_83, true))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_83, false);
		TASK::TASK_COMBAT_PED(iLocal_83, PLAYER::PLAYER_PED_ID(), 0, 16);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_84) && !PED::IS_PED_DEAD_OR_DYING(iLocal_84, true))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_84, false);
		TASK::TASK_COMBAT_PED(iLocal_84, PLAYER::PLAYER_PED_ID(), 0, 16);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_85) && !PED::IS_PED_DEAD_OR_DYING(iLocal_85, true))
	{
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x1B27
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_48() == 0)
		{
			return BitTest(func_44(func_47(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_44(int iParam0, int iParam1, int iParam2)//Position - 0x1B88
{
	int iVar0;
	var uVar1;
...
int func_45(var uParam0)//Position - 0x1BC5
{
	int iVar0;
	int iVar1;
...
var func_46()//Position - 0x1BF9
{
	return Global_1574918;
}

int func_47(int iParam0)//Position - 0x1C05
{
	switch (iParam0)
	{
		case 0:
...
int func_48()//Position - 0x1F80
{
	return Global_31959;
}

int func_49(int iParam0, bool bParam1)//Position - 0x1F8B
{
	int iVar0;
...
int func_50(int iParam0)//Position - 0x2043
{
	int iVar0;
...
void func_51(int iParam0)//Position - 0x207E
{
	int iVar0;
...
void func_52(char* sParam0, int iParam1)//Position - 0x20D5
{
...
void func_53(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x20F1
{
	int iVar0;
...
int func_54(var uParam0)//Position - 0x221C
{
	return 1;
}

void func_55(char* sParam0, int iParam1, int iParam2)//Position - 0x2225
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam1);
...
int func_56(int iParam0)//Position - 0x2242
{
	var uVar0;
...
int func_57()//Position - 0x229A
{
	func_58();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_58()//Position - 0x22B3
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_61(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_59(iVar0) && (!func_85(14) || Global_112337))
			{
...
bool func_59(int iParam0)//Position - 0x23B0
{
	return iParam0 < 3;
}

int func_60(int iParam0)//Position - 0x23BC
{
	int iVar0;
	int iVar1;
...
int func_61(int iParam0)//Position - 0x23F9
{
	if (func_59(iParam0))
	{
...
var func_62(int iParam0)//Position - 0x241E
{
	return Global_1998[iParam0 /*29*/];
}

var func_63()//Position - 0x242D
{
	return Global_75485;
}

int func_64(int iParam0)//Position - 0x2439
{
	if (iParam0 == 1)
	{
...
var func_65(int iParam0, int iParam1)//Position - 0x2490
{
	switch (iParam0)
	{
		case 5:
...
bool func_66()//Position - 0x24C8
{
	return MISC::GET_GAME_TIMER() <= Global_23150.f_6269 + 100;
}

int func_67()//Position - 0x24DD
{
...
bool func_68(bool bParam0)//Position - 0x24F7
{
	if (bParam0)
	{
...
int func_69()//Position - 0x2520
{
	return 1;
}

void func_70(var uParam0, int iParam1)//Position - 0x2529
{
	func_71(uParam0, iParam1);
}

void func_71(var uParam0, var uParam1)//Position - 0x2539
{
...
int func_73(int iParam0)//Position - 0x2654
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_80()) || Global_112433) || Global_31962) || func_79()) || func_65(8, -1)) || func_78()) || func_77()) || func_76()) || func_67()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_80()) || Global_31962) || func_79()) || func_65(8, -1)) || func_76()) || func_78()) || func_77()) || func_67()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_80()) || Global_112433) || Global_31962) || func_79()) || func_65(8, -1)) || func_76()) || func_78()) || func_77()) || func_67()) || Global_113386.f_7688.f_919[iVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_80()) || Global_112433) || Global_31962) || func_79()) || func_65(8, -1)) || func_78()) || func_77()) || func_67()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_80() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_65(8, -1)) || func_67()) || func_75()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_80()) || Global_31962) || func_79()) || func_65(8, -1)) || func_77()) || func_76()) || func_67()) || Global_113386.f_7688.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_80()) || func_77()) || Global_112433) || Global_31962) || func_79()) || Global_44238) || func_65(8, -1)) || func_76()) || func_75()) || func_67()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_74()//Position - 0x2D71
{
	return Global_100480.f_1;
}

int func_75()//Position - 0x2D7F
{
	if (Global_97363 != -1)
	{
...
bool func_77()//Position - 0x2DCC
{
	return Global_100493.f_376 > 0;
}

bool func_78()//Position - 0x2DDD
{
	return Global_100493.f_375 > 0;
}

var func_79()//Position - 0x2DEE
{
	return Global_1575058;
}

int func_80()//Position - 0x2DFA
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_82()//Position - 0x2E30
{
	return Global_96273;
}

int func_83(int iParam0)//Position - 0x2E3C
{
	switch (iParam0)
	{
		case 0:
...
bool func_84(int iParam0)//Position - 0x2EAE
{
	int iVar0;
...
bool func_85(int iParam0)//Position - 0x2EEA
{
	return Global_43052 == iParam0;
}

void func_86(var uParam0, int iParam1)//Position - 0x2EF8
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_87()//Position - 0x2F09
{
	struct<3> Var0;
	float fVar1;
	int iVar2;
...
void func_88(int iParam0)//Position - 0x31DD
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (iLocal_98 == 0)
	{
		...
		Var12 = { Vector(31.58f, -1092.35f, 12.617f) + Var9 * Vector(fVar5, fVar5, fVar5) };
	}
	else
	{
		fVar3 = 1.35f;
	...
	if (iParam0 == 0)
	{
		Var6 = { Var8 * Vector(fVar0, fVar0, fVar0) };
		Var7 = { Var10 + Var6 };
	}
	else if (iParam0 == 1)
	{
		Var6 = { Var8 * Vector(fVar1, fVar1, fVar1) };
		Var7 = { Var11 + Var6 };
	}
	else
	{
		Var6 = { Var8 * Vector(fVar2, fVar2, fVar2) };
		Var7 = { Var12 + Var6 };
	}
	Local_100[iParam0 /*6*/] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_target_backboard_b"), Var7, true, true, false);
	Local_100[iParam0 /*6*/].f_1 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_target_bull_b"), Var7, true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_100[iParam0 /*6*/].f_1, Local_100[iParam0 /*6*/], 0, 0f, -0.04f, -0.41f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
	Local_100[iParam0 /*6*/].f_2 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_target_inner1"), Var7, true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_100[iParam0 /*6*/].f_2, Local_100[iParam0 /*6*/], 0, 0f, -0.04f, -0.41f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
	Local_100[iParam0 /*6*/].f_3 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_target_inner2_b"), Var7, true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_100[iParam0 /*6*/].f_3, Local_100[iParam0 /*6*/], 0, 0f, -0.04f, -0.41f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
	Local_100[iParam0 /*6*/].f_4 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_target_inner3_b"), Var7, true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_100[iParam0 /*6*/].f_4, Local_100[iParam0 /*6*/], 0, 0f, -0.04f, -0.41f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
	Local_100[iParam0 /*6*/].f_5 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_target_arm_b"), Var7, true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_100[iParam0 /*6*/], Local_100[iParam0 /*6*/].f_5, 0, 0f, 0.007f, -0.76f, 0f, 0f, 180f, false, false, false, false, 2, true, 0);
	if (iLocal_98 == 0)
	{
		ENTITY::SET_ENTITY_ROTATION(Local_100[iParam0 /*6*/].f_5, 0f, 0f, 160f, 2, true);
	}
	else
	{
		ENTITY::SET_ENTITY_ROTATION(Local_100[iParam0 /*6*/].f_5, 0f, 0f, 359f, 2, true);
	}
...
void func_89(int iParam0, var uParam1, var uParam2)//Position - 0x35A4
{
...
void func_93(int iParam0)//Position - 0x377F
{
	iLocal_59 = iParam0;
}

void func_94(int iParam0, bool bParam1, bool bParam2)//Position - 0x378B
{
	int iVar0;
	int iVar1;
...
int func_97(int iParam0, int iParam1)//Position - 0x38CB
{
	int iVar0;
...
bool func_98(int iParam0)//Position - 0x3915
{
	return func_99(iParam0, Global_43052);
}

int func_99(int iParam0, int iParam1)//Position - 0x3926
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_100(var uParam0, int iParam1)//Position - 0x3B07
{
...
bool func_102(int iParam0)//Position - 0x3BB7
{
	return func_43(iParam0, 0, 1);
}

int func_103(int iParam0)//Position - 0x3BC7
{
	switch (iParam0)
	{
		case 91:
...
void func_104(var uParam0, int iParam1)//Position - 0x3CDF
{
	func_105(uParam0, iParam1);
}

void func_105(var uParam0, var uParam1)//Position - 0x3CEF
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_106(bool bParam0)//Position - 0x3D04
{
	if (bParam0)
	{
		if (iLocal_69 != 263)
...
void func_108()//Position - 0x3DAF
{
}

bool func_109(char* sParam0, int iParam1)//Position - 0x3DB7
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam1);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
