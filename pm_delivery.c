...
bool func_21(int* iParam0, struct<3> Param1, struct<3> Param2, bool bParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, bool bParam8, int iParam9, bool bParam10, int iParam11)//Position - 0x10A5
{
...
int func_29(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x1C30
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_31(struct<3> Param0, bool bParam1)//Position - 0x1CE6
{
	int iVar0;
...
void func_69(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x3BB4
{
	func_70(uParam0, iParam1, Param2, sParam3, iParam4, bParam5, uParam6, bParam7);
}

void func_70(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x3BD2
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
	{
...
void func_71(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x3C0A
{
	int iVar0;
	int iVar1;
...
int func_78(int iParam0)//Position - 0x43C2
{
	if (iParam0 != func_80())
	{
		...
		else if ((Global_1575058 && iParam0 == PLAYER::PLAYER_ID()) && func_79(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
void func_88(var uParam0, int iParam1, struct<3> Param2, int iParam3)//Position - 0x460D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_91(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x474C
{
	if (bParam2)
	{
...
int func_124(int iParam0, bool bParam1)//Position - 0x647B
{
	int iVar0;
	struct<2> Var1;
...
int func_125(int iParam0)//Position - 0x65FB
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_127(int iParam0)//Position - 0x66DE
{
	int iVar0;
	int iVar1;
...
bool func_128()//Position - 0x99B0
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_129()//Position - 0x99C6
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_130()//Position - 0x99DC
{
	return 0;
}

int func_131()//Position - 0x99E5
{
	return 1;
}

int func_132()//Position - 0x99EE
{
	return 1;
}

int func_133()//Position - 0x99F7
{
...
int func_135(int iParam0)//Position - 0x9AC8
{
	int iVar0;
	char* sVar1;
...
int func_136(int iParam0)//Position - 0x9B0E
{
	int iVar0;
...
int func_137(int iParam0)//Position - 0x9B49
{
	int iVar0;
...
int func_138(int iParam0)//Position - 0x9BC5
{
	int iVar0;
...
int func_139(int iParam0)//Position - 0x9CAD
{
	int iVar0;
...
int func_140(int iParam0, int iParam1, bool bParam2)//Position - 0x9D10
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_141(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x9D7E
{
...
void func_142(int iParam0)//Position - 0x9E56
{
