...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_25 = -0.0375f;
	fLocal_26 = 0.17f;
	Local_118 = { -2145.4856f, 3018.2944f, 31.81f };
	Local_119 = { 1744.3083f, 3270.673f, 40.2076f };
...
void func_1()//Position - 0x149
{
	...
	if (iLocal_28 == 2)
	{
		...
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, false))
			{
...
void func_5(struct<3> Param0, float fParam1)//Position - 0x362
{
	func_6(&(Global_106934.f_2890), Param0, fParam1);
}

void func_6(var uParam0, struct<3> Param1, var uParam2)//Position - 0x37B
{
	*uParam0 = { Param1 };
	uParam0->f_6 = uParam2;
}

void func_7(struct<3> Param0, float fParam1)//Position - 0x391
{
...
bool func_8(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x3BD
{
	if (bParam2)
	{
...
void func_15(var uParam0, int iParam1)//Position - 0x5ED
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_17(Global_113386.f_18533[iVar0], &Var2, &fVar3))
			{
...
void func_29()//Position - 0x1450
{
	...
	if (iLocal_54 == 0)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, false))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, false))
				{
	...
	if (iLocal_54 == 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, false))
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, true))
				{
					VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_34, 0, false);
					VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_34, 1, false);
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_34, 2);
					VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_34, false);
...
void func_35()//Position - 0x16E9
{
	switch (iLocal_28)
	{
		case 2:
			...
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_39, false))
				{
...
void func_37()//Position - 0x1841
{
	switch (iLocal_28)
	{
		case 2:
			...
			func_121(-1720.5f, 2568.4f, 67.1f, -1523.2f, 3002f, -70f, 100f, -1155.0603f, 2665.9795f, 17.0939f, 219.2079f, 1, 0, 1, 0, 0);
			...
			if (func_283())
			{
				if (func_120())
				{
					if (!VEHICLE::IS_THIS_MODEL_A_HELI(func_119()) && !VEHICLE::IS_THIS_MODEL_A_PLANE(func_119()))
					{
						func_117();
						while (!func_116())
						{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_34))
			{
				MISC::CLEAR_AREA(Local_118, 10f, true, false, false, false);
				iLocal_34 = VEHICLE::CREATE_VEHICLE(joaat("cargobob"), Local_118, fLocal_122, true, true, false);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
			{
				if (STREAMING::HAS_MODEL_LOADED(joaat("buzzard")))
				{
					...
					VEHICLE::SET_VEHICLE_CAN_BE_TARGETTED(iLocal_35[0], true);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_35[0], 5f);
					AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_35[0], "DH_P_2B_ENEMY_CHOPPERS", 0f);
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("buzzard"));
					VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_35[0], false);
				}
			}
			if (func_283())
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_39))
				{
					if (func_120())
					{
						if (!VEHICLE::IS_THIS_MODEL_A_HELI(func_119()) && !VEHICLE::IS_THIS_MODEL_A_PLANE(func_119()))
						{
							iLocal_39 = func_38(-1535.2094f, 2744.5505f, 16.6437f, 47.9754f);
		...
		case 3:
			...
			{
				iLocal_31[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_35[0], 26, joaat("S_M_M_Pilot_02"), -1, true, true);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("S_M_M_Pilot_02"));
			}
			else if (!PED::IS_PED_IN_VEHICLE(iLocal_31[0], iLocal_35[0], false))
			{
		...
		case 4:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_34))
			{
				...
				VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(iLocal_34, false);
				VEHICLE::SET_VEHICLE_STRONG(iLocal_34, true);
				VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_34, true, true, false);
				VEHICLE::SET_HELI_BLADES_FULL_SPEED(iLocal_34);
		...
		case 5:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_34))
			{
				...
				iLocal_34 = VEHICLE::CREATE_VEHICLE(joaat("cargobob"), 1749.6102f, 3272.9497f, 40.1533f, 51.128f, true, true, false);
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_34, true, 1);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("cargobob"));
				VEHICLE::SET_VEHICLE_STRONG(iLocal_34, true);
				VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(iLocal_34, false);
			...
			{
				iLocal_36[0] = VEHICLE::CREATE_VEHICLE(joaat("sandking"), 1754.9508f, 3290.994f, 40.1176f, 182.397f, true, true, false);
...
int func_38(struct<3> Param0, float fParam1)//Position - 0x1F1F
{
	return func_39(&(Global_106934.f_2890), Param0, fParam1, 0);
}

int func_39(var uParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x1F39
{
	int iVar0;
	struct<3> Var1;
	bool bVar2;
...
int func_48(int iParam0, bool bParam1)//Position - 0x2C96
{
	int iVar0;
	struct<2> Var1;
...
int func_49(int iParam0)//Position - 0x2E16
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_51(int iParam0)//Position - 0x2EF8
{
	int iVar0;
	int iVar1;
...
bool func_52()//Position - 0x61CE
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_53()//Position - 0x61E4
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_54()//Position - 0x61FA
{
	return 0;
}

int func_55()//Position - 0x6203
{
	return 1;
}

int func_56()//Position - 0x620C
{
	return 1;
}

int func_57()//Position - 0x6215
{
...
int func_59(int iParam0)//Position - 0x62E6
{
	int iVar0;
	char* sVar1;
...
int func_60(int iParam0)//Position - 0x632C
{
	int iVar0;
...
int func_61(int iParam0)//Position - 0x6367
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x63E3
{
	int iVar0;
...
int func_63(int iParam0)//Position - 0x64CB
{
	int iVar0;
...
int func_64(int iParam0, int iParam1, bool bParam2)//Position - 0x652E
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_65(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x659C
{
...
void func_66(int iParam0, bool bParam1)//Position - 0x6674
{
	if (iParam0 == -1)
	{
		return;
...
void func_67(int iParam0, int iParam1, bool bParam2)//Position - 0x66D1
{
	if (iParam0 == -1)
	{
		return;
...
int func_68(int iParam0, int iParam1)//Position - 0x670C
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_69(int iParam0)//Position - 0x672C
{
	bool bVar0;
...
void func_70(var uParam0, var uParam1)//Position - 0x689B
{
...
int func_71(int iParam0, int iParam1)//Position - 0x6967
{
	int iVar0;
...
int func_72(var uParam0)//Position - 0x69D9
{
	return *uParam0;
}

int func_73(var uParam0, int iParam1)//Position - 0x69E4
{
	int iVar0;
	int iVar1;
...
int func_74(int iParam0, int iParam1)//Position - 0x80D4
{
	struct<82> Var0;
...
void func_75(int iParam0, var uParam1, int iParam2)//Position - 0x8116
{
	int iVar0;
...
int func_76(int iParam0)//Position - 0x8372
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_77(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x8435
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_79(iParam0, uVar1[iVar3], 1) && func_78(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.5635f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_8(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
int func_78(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x863D
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_79(int iParam0, int iParam1, bool bParam2)//Position - 0x86B8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_80(int iParam0, int iParam1)//Position - 0x8719
{
	int iVar0;
...
void func_81(int iParam0, int iParam1)//Position - 0x879B
{
	int iVar0;
...
void func_82(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x8839
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_84(var uParam0)//Position - 0x8F6D
{
	int iVar0;
...
int func_85(int iParam0)//Position - 0x8F91
{
	int iVar0;
...
var func_86(int iParam0, int iParam1)//Position - 0x8FAF
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

bool func_87(int iParam0)//Position - 0x8FC7
{
	return func_88(&(Global_2703735.f_169), iParam0);
}

var func_88(var uParam0, var uParam1)//Position - 0x8FDB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_89(int iParam0, var uParam1, var uParam2)//Position - 0x8FFE
{
	int iVar0;
	int iVar1;
...
int func_90(int iParam0)//Position - 0x91D8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_91(var uParam0)//Position - 0x92B4
{
...
int func_92(int iParam0, int iParam1)//Position - 0x930B
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_93(int iParam0, int iParam1)//Position - 0x93F0
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
{
	if (!func_95() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_95()//Position - 0x97F3
{
	return 0;
}

void func_96(int iParam0, int iParam1)//Position - 0x97FC
{
	int iVar0;
	int iVar1;
...
bool func_97()//Position - 0x9874
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

int func_98(int iParam0)//Position - 0x9885
{
	int iVar0;
...
int func_99(int iParam0)//Position - 0x98CD
{
...
int func_100(int iParam0)//Position - 0x98ED
{
	switch (iParam0)
	{
		case 161:
...
int func_101(int iParam0)//Position - 0x9940
{
...
int func_102(int iParam0)//Position - 0x99C7
{
...
int func_103(int iParam0)//Position - 0x99F6
{
...
int func_104(int iParam0)//Position - 0x9A13
{
...
int func_105(int iParam0, int iParam1)//Position - 0x9A36
{
...
int func_106(int iParam0)//Position - 0x9A71
{
	if (func_105(iParam0, 0))
	{
...
int func_107(int iParam0, int iParam1)//Position - 0x9A94
{
	int iVar0;
...
int func_108(int iParam0, bool bParam1, bool bParam2)//Position - 0x9AE1
{
	int iVar0;
...
void func_109(struct<3> Param0, float fParam1, bool bParam2)//Position - 0x9B41
{
	int iVar0;
...
int func_110(var uParam0)//Position - 0x9B91
{
	if (func_111(uParam0))
	{
...
int func_111(var uParam0)//Position - 0x9BC6
{
...
void func_112()//Position - 0x9C25
{
	if (iLocal_80 == 0)
	{
		if (STREAMING::HAS_MODEL_LOADED(joaat("S_M_Y_Marine_01")) && STREAMING::HAS_MODEL_LOADED(joaat("S_M_M_Pilot_02")))
		{
			...
			{
				iLocal_32[0] = PED::CREATE_PED(26, joaat("S_M_Y_Marine_01"), -1590.5227f, 2796.3022f, 15.9184f, 247.0896f, true, true);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_32[1]))
			{
				iLocal_32[1] = PED::CREATE_PED(26, joaat("S_M_Y_Marine_01"), -2303.7996f, 3387.99f, 30.034f, 58.5763f, true, true);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_32[2]))
			{
				iLocal_32[2] = PED::CREATE_PED(26, joaat("S_M_Y_Marine_01"), -1697.329f, 2909.9414f, 31.9506f, 245.656f, true, true);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_32[3]))
			{
				iLocal_32[3] = PED::CREATE_PED(26, joaat("S_M_Y_Marine_01"), -1696.3693f, 2905.7722f, 31.9454f, 6.3714f, true, true);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_32[4]))
			{
				iLocal_32[4] = PED::CREATE_PED(26, joaat("S_M_Y_Marine_01"), -1843.7073f, 2821.6106f, 31.8528f, 271.6265f, true, true);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_32[5]))
			{
				iLocal_32[5] = PED::CREATE_PED(26, joaat("S_M_Y_Marine_01"), -2006.8772f, 2955.1013f, 31.8103f, 332.0101f, true, true);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_32[6]))
			{
				iLocal_32[6] = PED::CREATE_PED(26, joaat("S_M_Y_Marine_01"), -2010.022f, 2956.8052f, 31.8103f, 288.1283f, true, true);
			}
			if (iLocal_28 != 3)
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_32[7]))
				{
					iLocal_32[7] = PED::CREATE_PED(26, joaat("S_M_Y_Marine_01"), -2140.2131f, 3034.6091f, 31.81f, 302.4493f, true, true);
				}
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_32[8]))
				{
					iLocal_32[8] = PED::CREATE_PED(26, joaat("S_M_Y_Marine_01"), -2136.053f, 3031.4944f, 31.81f, 38.6856f, true, true);
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_32[9]))
			{
				iLocal_32[9] = PED::CREATE_PED(26, joaat("S_M_Y_Marine_01"), -2035.4293f, 3058.8765f, 31.8103f, 169.8222f, true, true);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_32[10]))
			{
				iLocal_32[10] = PED::CREATE_PED(26, joaat("S_M_Y_Marine_01"), -2146.4666f, 3160.749f, 31.8106f, 356.4766f, true, true);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_32[11]))
			{
				iLocal_32[11] = PED::CREATE_PED(26, joaat("S_M_Y_Marine_01"), -2280.087f, 3172.4233f, 31.8103f, 353.663f, true, true);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_32[12]))
			{
				iLocal_32[12] = PED::CREATE_PED(26, joaat("S_M_Y_Marine_01"), -2277.3762f, 3177.8f, 31.8103f, 175.0685f, true, true);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
			{
				iLocal_31[0] = PED::CREATE_PED(26, joaat("S_M_M_Pilot_02"), -1859.8307f, 3071.7576f, 31.8104f, 139.3607f, true, true);
				...
				func_114(iLocal_31[0], 595);
				func_113(iLocal_31[0], 0);
			}
			iLocal_55 = 0;
			while (iLocal_55 <= 12)
			{
				if (iLocal_97[iLocal_55] == 0)
				{
					if (!PED::IS_PED_INJURED(iLocal_32[iLocal_55]))
					{
						...
						func_114(iLocal_32[iLocal_55], 595);
						func_113(iLocal_32[iLocal_55], 0);
...
void func_113(int iParam0, bool bParam1)//Position - 0xA03C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_114(var uParam0, int iParam1)//Position - 0xA0D7
{
	int iVar0;
...
void func_115(int iParam0, int iParam1)//Position - 0xA12D
{
	Global_100441.f_22[iParam1] = iParam0;
}

bool func_116()//Position - 0xA141
{
	return func_110(&(Global_106934.f_2890));
}

void func_117()//Position - 0xA154
{
	func_118(&(Global_106934.f_2890));
}

void func_118(var uParam0)//Position - 0xA167
{
	if (func_111(uParam0))
	{
...
var func_119()//Position - 0xA185
{
	return Global_106934.f_2890.f_12.f_66;
}

bool func_120()//Position - 0xA198
{
	return func_111(&(Global_106934.f_2890));
}

void func_121(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0xA1AB
{
	func_122(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_122(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0xA1D4
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_124(iVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_123(struct<3> Param0)//Position - 0xA5CA
{
...
int func_124(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0xA5F4
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_125(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_125(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_125(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_125(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_125(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_125(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_125(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_125(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_125(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_125(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_125(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_125(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_125(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_125(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_125(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_125(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4))
		{
			return 1;
		}
	}
...
int func_125(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0xA8EA
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_126(struct<3> Param0)//Position - 0xA99E
{
	float fVar0;
	float fVar1;
...
void func_127(int iParam0)//Position - 0xA9DD
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_128()//Position - 0xAA42
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_35[0], 0f);
	}
	...
	{
		if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_96938[0], true))
		{
	...
	{
		if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_96938[1], true))
		{
	...
	{
		if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_96938[2], true))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_96938[2], true, true);
		}
		VEHICLE::DELETE_VEHICLE(&(Global_96938[2]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
	{
	...
	if (CAM::DOES_CAM_EXIST(iLocal_40))
	{
		...
		CAM::DESTROY_CAM(iLocal_40, false);
	}
}

void func_129()//Position - 0xAC8C
{
	...
	while (iLocal_55 <= 12)
	{
		func_130(&(Local_53[iLocal_55 /*8*/]));
		iLocal_55++;
	}
	HUD::CLEAR_GPS_MULTI_ROUTE();
}

void func_130(int* iParam0)//Position - 0xACE2
{
	bool bVar0;
	struct<8> Var1;
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, false))
		{
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, false))
			{
				...
				if (iLocal_28 == 4)
				{
					if (!HUD::DOES_BLIP_EXIST(iLocal_46))
					{
						iLocal_46 = func_138(Local_119, 0);
					}
					if (iLocal_78 == 0)
					{
						if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (!func_137() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
							{
				...
				if (iLocal_28 == 3)
				{
					...
					{
						uLocal_47[0] = func_135(iLocal_31[0], 1, 0);
					}
				}
			}
			else if (iLocal_28 != 5)
			{
				if (!HUD::DOES_BLIP_EXIST(iLocal_45))
				{
					iLocal_45 = func_132(iLocal_34, 0, 0);
				}
				if (iLocal_28 == 3 || iLocal_28 == 4)
				{
					if (iLocal_107 == 0)
...
int func_132(int iParam0, bool bParam1, bool bParam2)//Position - 0xAF07
{
	return func_133(iParam0, !bParam1, bParam2);
}

int func_133(int iParam0, bool bParam1, bool bParam2)//Position - 0xAF1A
{
	int iVar0;
...
float func_134(bool bParam0, float fParam1, float fParam2)//Position - 0xAFBE
{
	if (bParam0)
	{
		return fParam1;
...
int func_135(int iParam0, bool bParam1, bool bParam2)//Position - 0xAFD5
{
	return func_133(iParam0, !bParam1, bParam2);
}

void func_136(char* sParam0, int iParam1, int iParam2)//Position - 0xAFE8
{
	iParam2 = iParam2;
...
int func_138(struct<3> Param0, bool bParam1)//Position - 0xB023
{
	int iVar0;
	...
	if (iLocal_54 == 1)
	{
		if (iLocal_115 == 0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, false))
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, false))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_118, true) > 800f)
						{
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_118, true) > 800f)
						{
							if (iLocal_111 == 0 && iLocal_78 == 1)
							{
								if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
								{
									if (!func_137() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
									{
										func_160(&uLocal_198, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
										if (func_159(&uLocal_198, "DP2BAUD", "DP2B_CHAT59", 7, 0, 0, 0))
										{
											iLocal_111 = 1;
										}
									}
							...
							if (iLocal_111 == 1 && iLocal_116 == 0)
							{
								if (func_158(72) == 0)
								{
									if (!func_137())
									{
										...
										{
											func_160(&uLocal_198, 3, 0, "Wade", 0, 1);
											if (func_143(&uLocal_198, 24, "DP2BAUD", "DP2B_WADEP3", 7, 1, 0, 0, 0))
											{
												iLocal_116 = 1;
											}
										}
								...
								else if (!func_137())
								{
									...
									{
										func_160(&uLocal_198, 3, 0, "Wade", 0, 1);
										if (func_143(&uLocal_198, 24, "DP2BAUD", "DP2B_WADEP4", 7, 1, 0, 0, 0))
										{
											iLocal_116 = 1;
										}
									}
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, false))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, false))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_119, 2f, 2f, 2f, true, true, 0))
					{
					}
...
void func_140(bool bParam0, int iParam1)//Position - 0xB3F5
{
	int iVar0;
...
void func_141(char* sParam0, int iParam1)//Position - 0xB48F
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_142(int iParam0)//Position - 0xB4A6
{
...
bool func_143(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0xB4D3
{
...
int func_144(char* sParam0, int iParam1, bool bParam2)//Position - 0xB532
{
	Global_21606 = 0;
...
bool func_147(int iParam0)//Position - 0xB89A
{
	return func_86(iParam0, 20);
}

int func_148()//Position - 0xB8AA
{
	return -1;
}

void func_149()//Position - 0xB8B3
{
	int iVar0;
...
bool func_155(int iParam0, int iParam1)//Position - 0xBB32
{
	switch (iParam0)
	{
		case 5:
...
void func_157(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xBBC1
{
...
int func_158(int iParam0)//Position - 0xBC17
{
...
bool func_159(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xBC43
{
...
void func_160(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xBC91
{
...
void func_161(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xBD2C
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_234(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_227(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
				Global_113386.f_18574[iVar4 /*6*/].f_4 = 0;
				MemCopy(&uVar5, {func_226(iVar4)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar5, 0, Global_100478, iParam0);
			}
			else
			{
				iVar6 = func_225(&(Global_100441.f_3));
				if (iVar6 > -1)
				{
...
void func_162(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0xBEA1
{
	func_163(&Global_106934, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_163(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0xBEBD
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_20();
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_187(PLAYER::PLAYER_PED_ID());
		func_180(PLAYER::PLAYER_PED_ID(), 0);
...
int func_164(var uParam0)//Position - 0xCD47
{
...
void func_165(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCD69
{
	int iVar0;
...
int func_166(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0xCDF1
{
...
int func_167(int iParam0)//Position - 0xCE31
{
	int iVar0;
...
void func_168(var uParam0, int iParam1, int iParam2)//Position - 0xCE5F
{
...
int func_169(int iParam0)//Position - 0xCF3B
{
	int iVar0;
...
int func_170(int iParam0, int iParam1, int iParam2)//Position - 0xCF7D
{
	int iVar0;
...
int func_171(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0xD00B
{
	char* sVar0;
...
void func_172(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0xD138
{
	int iVar0;
	int iVar1;
...
int func_173(int iParam0, int iParam1, int iParam2)//Position - 0xD2D8
{
	int iVar0;
	var uVar1;
...
int func_174(var uParam0)//Position - 0xD315
{
	int iVar0;
	int iVar1;
...
var func_175()//Position - 0xD349
{
	return Global_1574918;
}

int func_176(int iParam0, int iParam1)//Position - 0xD355
{
	int iVar0;
	var uVar1;
...
void func_177(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0xD381
{
	int iVar0;
...
void func_178(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0xD8C9
{
	int iVar0;
...
int func_179()//Position - 0xDB0A
{
	func_21();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_180(int iParam0, bool bParam1)//Position - 0xDB23
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_181(int iParam0, var uParam1)//Position - 0xDC16
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_186(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_183(Var7.f_1)) && iVar9 < 51)
			{
...
int func_182(int iParam0)//Position - 0xDE9E
{
	switch (iParam0)
	{
...
int func_183(int iParam0)//Position - 0xDF39
{
...
int func_184(int iParam0, int iParam1)//Position - 0xE101
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_185(int iParam0, var* uParam1)//Position - 0xECA2
{
	int iVar0;
	int iVar1;
...
int func_186(int iParam0)//Position - 0xECDD
{
	int iVar0;
...
void func_187(int iParam0)//Position - 0xEF51
{
	int iVar0;
...
void func_188(var uParam0, int iParam1)//Position - 0xEF8D
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_189(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0xF4DC
{
	int iVar0;
	int iVar1;
...
bool func_190(int iParam0, var uParam1, var uParam2)//Position - 0xF520
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
int func_191(var uParam0)//Position - 0xFC9F
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_213())
		{
			*uParam0 = func_197(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 6, -1, 0, 1, -1);
...
bool func_192(int iParam0)//Position - 0xFCFA
{
	return func_193(iParam0, 0, 1);
}

int func_193(int iParam0, int iParam1, bool bParam2)//Position - 0xFD0A
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_194(int iParam0)//Position - 0xFD6B
{
	switch (iParam0)
	{
		case 0:
...
int func_195()//Position - 0x100E7
{
	return Global_31959;
}

int func_196(int iParam0)//Position - 0x100F2
{
	return func_193(iParam0, 5, 1);
}

int func_197(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x10102
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 57)
	{
		if (iParam1 == 6 || iParam1 == func_212(iVar0))
		{
			if (!bParam3 || func_211(iVar0))
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_198(iVar0, 0), true);
...
Vector3 func_198(int iParam0, bool bParam1)//Position - 0x101A4
{
	switch (iParam0)
	{
		case -1:
...
int func_199(int iParam0)//Position - 0x108C9
{
	if (iParam0 != func_148())
	{
...
Vector3 func_200(int iParam0, int iParam1)//Position - 0x10921
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_201(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x109CB
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
	...
	{
		Var2 = { func_203(iParam0) };
	}
	Var3 = { Var2 - Var0 };
	Var3 = { func_202(Var3, -Var0.f_3.f_2) };
	Var3 = { func_202(Var3, Var1.f_3.f_2) };
	*uParam2 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Var1, 0f, Var3) };
	uParam2->f_3 = { Var2.f_3 };
	return 1;
}

Vector3 func_202(struct<3> Param0, float fParam1)//Position - 0x10A60
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_203(int iParam0)//Position - 0x10AA4
{
	struct<6> Var0;
...
struct<6> func_204(int iParam0)//Position - 0x10C28
{
	return func_205(iParam0);
}

struct<6> func_205(int iParam0)//Position - 0x10C36
{
	struct<6> Var0;
...
int func_206(int iParam0, var uParam1)//Position - 0x116FD
{
	switch (iParam0)
	{
		case 0:
...
int func_207(int iParam0)//Position - 0x1177F
{
	if (iParam0 != func_148())
	{
...
Vector3 func_208(int iParam0)//Position - 0x117D7
{
	switch (iParam0)
	{
		case 1:
...
int func_209()//Position - 0x11A33
{
	return func_210(PLAYER::PLAYER_ID());
}

int func_210(int iParam0)//Position - 0x11A43
{
	return MISC::GET_BITS_IN_RANGE(Global_2689235[iParam0 /*453*/].f_318.f_3, 28, 31);
}

int func_211(int iParam0)//Position - 0x11A60
{
	return func_193(iParam0, 0, 0);
}

int func_212(int iParam0)//Position - 0x11A70
{
	switch (iParam0)
	{
		case -1:
...
bool func_213()//Position - 0x11D7F
{
	return Global_100493.f_375 > 0;
}

var func_214()//Position - 0x11D90
{
	var uVar0;
	
	func_224(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_223(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_222(&uVar0, CLOCK::GET_CLOCK_HOURS());
...
void func_215(var uParam0, int iParam1)//Position - 0x11DD6
{
	if (iParam1 <= 0)
	{
		return;
...
void func_216(var uParam0, int iParam1)//Position - 0x11E5C
{
...
void func_217(var uParam0, int iParam1)//Position - 0x11E8F
{
	int iVar0;
	int iVar1;
...
int func_218(int iParam0, int iParam1)//Position - 0x11EE0
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_219(int iParam0)//Position - 0x11F82
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_220(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_220(bool bParam0, int iParam1, int iParam2)//Position - 0x11FA4
{
	if (bParam0)
	{
		return iParam1;
...
int func_221(var uParam0)//Position - 0x11FBB
{
	return uParam0 & 15;
}

void func_222(var uParam0, int iParam1)//Position - 0x11FC8
{
...
void func_223(var uParam0, int iParam1)//Position - 0x12002
{
...
void func_224(var uParam0, int iParam1)//Position - 0x1203D
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_225(char* sParam0)//Position - 0x12079
{
...
struct<2> func_226(int iParam0)//Position - 0x120CF
{
	struct<2> Var0;
...
int func_227(char* sParam0, int iParam1)//Position - 0x1251B
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_228(int iParam0, var uParam1)//Position - 0x12564
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_229(uParam1, "Barry3A", func_231(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_230(iParam0), 0, 1);
			break;
		...
		case 8:
			func_229(uParam1, "Dreyfuss1", func_231(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_230(iParam0), 0, 0);
			break;
		...
		case 38:
			func_229(uParam1, "Nigel1A", func_231(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_230(iParam0), 1, 1);
			break;
		...
		case 49:
			func_229(uParam1, "Paparazzo3A", func_231(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_230(iParam0), 0, 1);
			break;
		...
		case 58:
			func_229(uParam1, "Tonya1", func_231(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_230(iParam0), 0, 1);
			break;
...
void func_229(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0x13719
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_230(int iParam0)//Position - 0x137AA
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_231(int iParam0)//Position - 0x13AF0
{
	struct<2> Var0;
	char[] cVar1[8];
	
	StringCopy(&Var0, "", 8);
	cVar1 = { func_226(iParam0) };
...
int func_232(int iParam0)//Position - 0x13B27
{
	switch (iParam0)
	{
		case 69:
...
int func_233(int iParam0)//Position - 0x13BE3
{
	switch (iParam0)
	{
		case 1:
...
int func_234(char* sParam0, bool bParam1)//Position - 0x13C37
{
	int iVar0;
	int iVar1;
...
int func_235(int iParam0, bool bParam1)//Position - 0x13C61
{
	int iVar0;
...
void func_236(bool bParam0)//Position - 0x13C97
{
	int iVar0;
	int iVar1;
...
void func_237(int iParam0, int iParam1, int iParam2)//Position - 0x13F19
{
	if (func_283() && func_36())
	{
...
void func_238(int iParam0)//Position - 0x13FDD
{
	if (iParam0 == 1)
	{
...
void func_239()//Position - 0x14007
{
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_119, true) < 500f)
	{
		if (iLocal_89 == 0)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
	...
	{
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_119, true) > 550f)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
			{
				VEHICLE::DELETE_VEHICLE(&(iLocal_36[0]));
...
void func_240()//Position - 0x140D7
{
	if (iLocal_54 > 0)
	{
		func_131();
		...
		while (iLocal_55 <= 12)
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, false))
			{
				func_243(iLocal_32[iLocal_55], &(Local_53[iLocal_55 /*8*/]), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0);
			}
			else
			{
				func_130(&(Local_53[iLocal_55 /*8*/]));
	...
	if (iLocal_54 == 1)
	{
		if (iLocal_83[0] == 1)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, false))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_34, 1721.0015f, 3264.2483f, 38.400642f, 1765.5089f, 3276.518f, 46.053852f, 48.25f, false, true, 0))
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, false))
						{
							PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 0, false);
...
void func_241(int iParam0, int iParam1)//Position - 0x143BA
{
	Global_63165 = iParam0;
	Global_63166 = iParam1;
}

void func_242(int iParam0, bool bParam1)//Position - 0x143CC
{
	int iVar0;
...
int func_243(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11)//Position - 0x14416
{
	bool bVar0;
...
void func_244()//Position - 0x14602
{
...
void func_245()//Position - 0x1469A
{
	if (iLocal_28 == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, false))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, false))
				{
					Local_121 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], false))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									...
									{
										if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_121, -75.8f, -819.9f, 326f, true) > 1600f && MISC::GET_DISTANCE_BETWEEN_COORDS(Local_121, -2159f, 3067f, 33f, true) < 1000f)
										{
											if (Local_121.f_2 > 70f)
											{
												if (iLocal_30 != 2)
												{
													iLocal_90[0] = 1;
											...
											if (iLocal_95 == 1)
											{
												if (iLocal_96 == 0)
												{
													if (!func_137())
													{
														if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
														{
															func_160(&uLocal_198, 4, 0, "PilotDispatch", 0, 1);
															func_160(&uLocal_198, 5, 0, "PilotDispatch2", 0, 1);
															if (func_159(&uLocal_198, "DP2BAUD", "DP2B_CHAT54", 7, 0, 0, 0))
															{
																iLocal_96 = 1;
															}
														}
										...
										{
											if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_121, -75.8f, -819.9f, 326f, true) < 1600f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_90[0] = 1;
												...
												if (iLocal_95 == 0)
												{
													if (!func_137())
													{
														if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
														{
															func_160(&uLocal_198, 4, 0, "PilotDispatch", 0, 1);
															func_160(&uLocal_198, 5, 0, "PilotDispatch2", 0, 1);
															if (func_159(&uLocal_198, "DP2BAUD", "DP2B_CHAT53", 7, 0, 0, 0))
															{
																iLocal_95 = 1;
															}
														}
											...
											if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_121, -2159f, 3067f, 33f, true) > 1000f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_90[0] = 1;
				...
				else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_121, -75.8f, -819.9f, 326f, true) > 1600f)
				{
					if (iLocal_30 != 0)
					{
						iLocal_90[0] = 1;
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], false))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_31[0]))
						{
							...
							{
								Local_120 = { ENTITY::GET_ENTITY_COORDS(iLocal_35[0], true) };
								TASK::CLEAR_PED_TASKS(iLocal_31[0]);
								PED::SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_31[0], Local_120, 10f, false, false);
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], false))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_31[0]))
						{
							...
							if (!PED::IS_PED_IN_VEHICLE(iLocal_31[0], iLocal_35[0], false))
							{
								TASK::TASK_ENTER_VEHICLE(0, iLocal_35[0], 20000, -1, 2f, 1, 0);
							}
							TASK::TASK_HELI_MISSION(0, iLocal_35[0], 0, 0, Local_120.f_0, Local_120.f_1, (Local_120.f_2 + 20f), 4, 30f, 10f, -1f, 170, 40, -1f, 0);
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
				{
					if (!PED::IS_PED_INJURED(iLocal_31[0]))
					{
						if (PED::IS_PED_IN_VEHICLE(iLocal_31[0], iLocal_35[0], false))
						{
							...
							else if (MISC::GET_GAME_TIMER() > iLocal_67 + 10000 && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, false))
							{
								if (iLocal_104 == 0)
								{
									PED::SET_PED_ACCURACY(iLocal_31[0], 100);
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], false))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, 0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_35[0], 20f, 0f, 0f), 4, 10f, 10f, ENTITY::GET_ENTITY_HEADING(iLocal_35[0]), SYSTEM::ROUND(ENTITY::GET_ENTITY_HEIGHT(iLocal_35[0], ENTITY::GET_ENTITY_COORDS(iLocal_35[0], true), true, true)), 100, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_32[iLocal_55]))
				{
					if (!PED::IS_PED_INJURED(iLocal_32[iLocal_55]))
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
						{
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, false))
							{
								if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, false) || iLocal_87 == 1)
								{
									if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_32[iLocal_55], 1) < 39f)
									{
										if (iLocal_91[iLocal_55] == 0)
										{
											...
											PED::SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_32[iLocal_55], ENTITY::GET_ENTITY_COORDS(iLocal_32[iLocal_55], true), 50f, false, false);
					...
					if (!PED::IS_PED_INJURED(iLocal_32[iLocal_72]))
					{
						if (func_2(iLocal_32[iLocal_72], PLAYER::PLAYER_PED_ID(), 1) < 25f)
						{
							if (iLocal_101[iLocal_72] == 0)
							{
								...
								TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_32[iLocal_72], PLAYER::PLAYER_PED_ID(), -1, false);
...
int func_247(struct<3> Param0, int iParam1, int iParam2, bool bParam3)//Position - 0x15830
{
	struct<3> Var0[15];
	struct<3> Var1[15];
	float fVar2[15];
...
void func_248()//Position - 0x16584
{
	if (iLocal_54 > 0)
	{
		func_131();
	...
	if (iLocal_54 == 0)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Global_96938[2]))
		{
			...
			{
				if (VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(Global_96938[2])))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_96938[2], true, true);
					func_256(1734.799f, 3234.8335f, 40.7041f, 321.0399f, 0, 145);
				}
				if (((VEHICLE::IS_THIS_MODEL_A_CAR(ENTITY::GET_ENTITY_MODEL(Global_96938[2])) || VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(Global_96938[2]))) || VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(Global_96938[2]))) || VEHICLE::IS_THIS_MODEL_A_QUADBIKE(ENTITY::GET_ENTITY_MODEL(Global_96938[2])))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_96938[2], true, true);
					func_256(1748.0499f, 3294.7f, 40.106f, 204.2419f, 0, 145);
				}
			}
		}
		...
		if (CAM::IS_SCREEN_FADED_OUT())
		{
			...
			func_237(iLocal_39, -1, 1);
		}
		if (!CAM::IS_SCREEN_FADED_IN())
		{
			CAM::DO_SCREEN_FADE_IN(800);
		}
		func_255(PLAYER::PLAYER_PED_ID(), -1);
		func_254(73);
		iLocal_76 = 1;
		iLocal_54 = 1;
	}
						...
						if (!PED::IS_PED_INJURED(iLocal_32[iLocal_63]))
						{
							if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_32[iLocal_63], 1) < 40f)
							{
								if (PED::CAN_PED_SEE_HATED_PED(iLocal_32[iLocal_63], PLAYER::PLAYER_PED_ID()))
								{
									...
									if (iLocal_114 == 0)
									{
										if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !func_253(0))
										{
											if (func_252(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED"))
											{
									...
									else if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !func_253(0))
									{
										if (func_252(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED"))
										{
...
void func_249(int iParam0)//Position - 0x16AEA
{
	MISC::CLEAR_BIT(&Global_96296, iParam0);
}

void func_250(int iParam0)//Position - 0x16AFC
{
	MISC::SET_BIT(&Global_96296, iParam0);
}

bool func_251(int iParam0)//Position - 0x16B0E
{
	return BitTest(Global_96296, iParam0);
}

int func_252(int iParam0)//Position - 0x16B1D
{
	var uVar0;
...
int func_253(int iParam0)//Position - 0x16B31
{
	if (iParam0 == 1)
	{
		if (Global_20266.f_1 > 3)
...
void func_254(int iParam0)//Position - 0x16B88
{
	if (Global_97363 != -1)
	{
...
void func_255(int iParam0, int iParam1)//Position - 0x16BAC
{
	int iVar0;
...
void func_256(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x16C17
{
	struct<3> Var0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103950.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_103950.f_4, false))
		{
			if (func_265(24) != Global_103950.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_262(ENTITY::GET_ENTITY_COORDS(Global_103950.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_257(Global_103950.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}

void func_257(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x16C92
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_259(iParam3, &Var0, Param1, fParam2, func_63(iParam0));
		func_258(iParam3, iParam0, 0);
	}
}

void func_258(int iParam0, int iParam1, int iParam2)//Position - 0x16DBB
{
	int iVar0;
...
void func_259(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x16ED2
{
	if (func_73(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_260(int iParam0)//Position - 0x16FCB
{
	if (iParam0 == -1)
	{
		return;
...
void func_261(int iParam0)//Position - 0x17042
{
...
int func_262(struct<3> Param0, int iParam1, var uParam2, var uParam3)//Position - 0x17069
{
	int iVar0;
	
	iVar0 = func_263(Param0, iParam1, 1);
	switch (iVar0)
	{
		case 0:
...
int func_263(struct<3> Param0, int iParam1, int iParam2)//Position - 0x1717F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_264(int iParam0)//Position - 0x1720E
{
	return BitTest(Global_113386.f_7229[iParam0], 0);
}

int func_265(int iParam0)//Position - 0x17223
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_266()//Position - 0x1723F
{
	if (iLocal_54 == 0)
	{
		func_270(1, 0);
		...
		if (func_283())
		{
			if (Global_94618 == 1)
			{
				if (func_269() == 0)
				{
					func_268(Local_118, fLocal_122, 1, 0);
					iLocal_75 = 1;
					iLocal_54 = 0;
					iLocal_28 = 3;
				}
			...
			else
			{
				if (func_269() == 0)
				{
					func_268(-1565.0836f, 2780.813f, 16.4022f, 53.6086f, 1, 0);
					iLocal_75 = 1;
					iLocal_54 = 0;
					iLocal_28 = 2;
				}
...
void func_267()//Position - 0x17409
{
	iLocal_76 = 0;
	if (!CAM::IS_SCREEN_FADED_OUT())
	{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_34))
	{
		...
		iLocal_34 = VEHICLE::CREATE_VEHICLE(joaat("cargobob"), 1740.8517f, 3263.1614f, 40.2743f, 280.3712f, true, true, false);
		VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_34, 0, true);
		VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_34, 1, true);
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_34, 2);
		VEHICLE::SET_VEHICLE_STRONG(iLocal_34, true);
		ENTITY::FREEZE_ENTITY_POSITION(iLocal_34, true);
		VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(iLocal_34, false);
...
void func_268(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x17518
{
	if (func_283())
	{
...
void func_272()//Position - 0x17612
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, false))
...
int func_273(int iParam0, int iParam1)//Position - 0x1766A
{
...
void func_274()//Position - 0x176DC
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (iLocal_28 == 2 || iLocal_28 == 3)
		{
			if (func_247(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 3, 200, 0) || iLocal_86 == 1)
			{
		...
		if (iLocal_28 == 4)
		{
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) != 0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_118, true) > 1000f)
			{
				PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 0, false);
				PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), false);
			}
...
void func_275()//Position - 0x17773
{
}

void func_276()//Position - 0x1777B
{
	if (iLocal_98 == 0)
	{
		iLocal_64 = 0;
				...
				if (!PED::IS_PED_INJURED(iLocal_32[iLocal_64]))
				{
					if (PED::CAN_PED_SEE_HATED_PED(iLocal_32[iLocal_64], PLAYER::PLAYER_PED_ID()))
					{
						...
						if (func_2(iLocal_32[iLocal_64], PLAYER::PLAYER_PED_ID(), 1) < 25f)
						{
							if (func_252(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED"))
							{
								if (func_281(iLocal_32[iLocal_64], 6))
								{
									iLocal_98 = 1;
								}
							}
											...
											if (func_252(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED"))
											{
												if (ENTITY::DOES_ENTITY_EXIST(iLocal_32[0]))
												{
													if (!PED::IS_PED_INJURED(iLocal_32[0]))
													{
														...
														{
															func_160(&uLocal_198, 4, iLocal_32[0], "ARMY_Guard01", 0, 1);
														}
													}
												}
												if (ENTITY::DOES_ENTITY_EXIST(iLocal_32[1]))
												{
													if (!PED::IS_PED_INJURED(iLocal_32[1]))
													{
														...
														{
															func_160(&uLocal_198, 4, iLocal_32[1], "ARMY_Guard01", 0, 1);
														}
													}
												}
												if (func_159(&uLocal_198, "ARMYAUD", "ARMY_WRN1", 7, 0, 0, 0))
												{
							...
							if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
							{
								if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_32[iLocal_71], 1) < 25f)
								{
									if (PED::CAN_PED_SEE_HATED_PED(iLocal_32[iLocal_71], PLAYER::PLAYER_PED_ID()))
									{
										if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
										{
											if (func_252(PLAYER::PLAYER_PED_ID()) == joaat("WEAPON_UNARMED") || func_253(0))
											{
												if (ENTITY::DOES_ENTITY_EXIST(iLocal_32[0]))
												{
													if (!PED::IS_PED_INJURED(iLocal_32[0]))
												...
												if (PED::CAN_PED_SEE_HATED_PED(iLocal_32[iLocal_71], PLAYER::PLAYER_PED_ID()))
												{
													if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !func_253(0))
													{
														if (func_252(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED"))
														{
															...
															if (func_159(&uLocal_198, "ARMYAUD", "ARMY_WRN1a", 7, 0, 0, 0))
															{
																iLocal_65 = MISC::GET_GAME_TIMER();
																iLocal_117 = 1;
															}
...
void func_277(int iParam0, char* sParam1, int iParam2)//Position - 0x17E48
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iParam0, sParam1, func_278(iParam2), 1);
}

int func_278(int iParam0)//Position - 0x17E5F
{
	int iVar0;
...
int func_281(int iParam0, int iParam1)//Position - 0x18119
{
...
void func_282()//Position - 0x18165
{
...
void func_284()//Position - 0x181B0
{
	...
	iLocal_50 = PED::ADD_SCENARIO_BLOCKING_AREA(-1884.6f, 2827.7f, 41.8f, -1843.1f, 2772.1f, 29.9f, false, true, true, true);
	iLocal_52 = PED::ADD_SCENARIO_BLOCKING_AREA(-2168.3f, 3223.6f, 52.8f, -2156.2f, 3205f, 29f, false, true, true, true);
...
void func_285(int iParam0)//Position - 0x18396
{
	Global_96296 = 0;
	switch (iParam0)
	{
...
void func_287()//Position - 0x1856C
{
	Global_96296 = 0;
}

void func_288()//Position - 0x18579
{
	int iVar0;
