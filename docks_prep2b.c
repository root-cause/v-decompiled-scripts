...
{
	func_6(&(Global_107917.f_2890), Param0, fParam3);
}
...
{
	if (func_8(Global_79489, 0f, 0f, 0f, 0))
	{
		Global_79489 = { Param0 };
...
void func_13(int iParam0)//Position - 0x498
{
	...
	if (Global_114370.f_9088 || func_28(0))
	{
		iVar0 = func_27();
		if (!func_14(iVar0))
		{
...
int func_14(int iParam0)//Position - 0x4DD
{
	...
	func_15(&(Global_114370.f_2366.f_539), iVar1);
...
void func_15(var uParam0, int iParam1)//Position - 0x5ED
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_17(Global_114370.f_18536[iVar0], &Var2, &fVar5))
			{
...
void func_32(bool bParam0, int iParam1)//Position - 0x15AB
{
	...
	if (bParam0)
	{
		if ((func_28(0) && Global_79495.f_1 == 1) && func_33(Global_79495))
		{
		}
		else
		{
...
void func_37()//Position - 0x1841
{
	switch (iLocal_26)
	{
		case 2:
			...
			func_124(-1720.5f, 2568.4f, 67.1f, -1523.2f, 3002f, -70f, 100f, -1155.0603f, 2665.9795f, 17.0939f, 219.2079f, 1, 0, 1, 0, 0);
...
{
	return func_39(&(Global_107917.f_2890), Param0, fParam3, 0);
}
...
int func_49(int iParam0)//Position - 0x2E25
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_51(int iParam0, int iParam1)//Position - 0x2F07
{
	int iVar0;
	int iVar1;
...
int func_52(bool bParam0)//Position - 0x8440
{
	if (bParam0)
	{
...
bool func_53()//Position - 0x845A
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_54()//Position - 0x8470
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_55()//Position - 0x8486
{
	return 0;
}

int func_56()//Position - 0x848F
{
	return 1;
}

int func_57()//Position - 0x8498
{
	return 1;
}

int func_58()//Position - 0x84A1
{
...
int func_60(int iParam0)//Position - 0x8572
{
	int iVar0;
	char* sVar1;
...
int func_61(int iParam0)//Position - 0x85B9
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x85F4
{
	int iVar0;
...
int func_63(int iParam0)//Position - 0x8670
{
	int iVar0;
...
int func_64(int iParam0)//Position - 0x8758
{
	int iVar0;
...
int func_65(int iParam0, int iParam1, bool bParam2)//Position - 0x87BB
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_66(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x8829
{
...
void func_67(int iParam0, bool bParam1)//Position - 0x8901
{
	if (iParam0 == -1)
	{
		return;
...
void func_68(int iParam0, int iParam1, bool bParam2)//Position - 0x895E
{
	if (iParam0 == -1)
	{
		return;
...
int func_69(int iParam0, int iParam1)//Position - 0x8999
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_70(int iParam0)//Position - 0x89B9
{
	bool bVar0;
...
void func_71(var uParam0, var uParam1)//Position - 0x8B28
{
...
int func_72(int iParam0, int iParam1)//Position - 0x8BF4
{
	int iVar0;
...
int func_73(var uParam0)//Position - 0x8C67
{
	return *uParam0;
}

int func_74(var uParam0, int iParam1)//Position - 0x8C72
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_8(Global_114370.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_8(Global_114370.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_8(Global_114370.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_75(int iParam0, int iParam1)//Position - 0xA360
{
	struct<82> Var0;
...
void func_76(int iParam0, var uParam1, int iParam2)//Position - 0xA3A2
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0xA5FE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_78(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xA6C1
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_79(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xA8C9
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_80(int iParam0, int iParam1, bool bParam2)//Position - 0xA944
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_81(int iParam0, int iParam1)//Position - 0xA9A5
{
	int iVar0;
...
void func_82(int iParam0, int iParam1)//Position - 0xAA27
{
	int iVar0;
...
void func_83(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0xAAC5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_85(var uParam0)//Position - 0xB24A
{
	int iVar0;
...
int func_86(int iParam0)//Position - 0xB26E
{
	int iVar0;
...
var func_87(int iParam0, int iParam1)//Position - 0xB28C
{
	return BitTest(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

bool func_88(int iParam0)//Position - 0xB2A4
{
	return func_89(&(Global_2672741.f_188), iParam0);
}

var func_89(var uParam0, var uParam1)//Position - 0xB2B8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_90(int iParam0, var uParam1, var uParam2)//Position - 0xB2DB
{
	int iVar0;
	int iVar1;
...
int func_91(int iParam0)//Position - 0xB4B5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_92(var uParam0)//Position - 0xB591
{
...
int func_93(int iParam0, int iParam1)//Position - 0xB5E8
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_94(int iParam0, int iParam1)//Position - 0xB6D1
{
	int iVar0;
...
int func_95(int iParam0, int iParam1)//Position - 0xB733
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_96(int iParam0, int iParam1, int iParam2)//Position - 0xBB12
{
...
int func_97()//Position - 0xBB36
{
	return 0;
}

void func_98(int iParam0, int iParam1)//Position - 0xBB3F
{
	int iVar0;
	int iVar1;
...
bool func_99()//Position - 0xBBB7
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

int func_100(int iParam0)//Position - 0xBBC8
{
	int iVar0;
...
int func_101(int iParam0)//Position - 0xBC10
{
...
int func_102(int iParam0)//Position - 0xBC30
{
	switch (iParam0)
	{
		case 161:
...
int func_103(int iParam0)//Position - 0xBC83
{
...
int func_104(int iParam0)//Position - 0xBD0A
{
...
int func_105(int iParam0)//Position - 0xBD39
{
...
int func_106(int iParam0)//Position - 0xBD56
{
...
int func_107(int iParam0, int iParam1)//Position - 0xBD79
{
	if (func_108(iParam0))
	{
...
int func_108(var uParam0)//Position - 0xBDBD
{
	int iVar0;
...
int func_109(int iParam0)//Position - 0xBDDF
{
	if (func_108(iParam0))
	{
		if (func_107(iParam0, 0))
...
int func_110(int iParam0, int iParam1)//Position - 0xBE0B
{
	int iVar0;
...
int func_111(int iParam0, bool bParam1, bool bParam2)//Position - 0xBE58
{
	int iVar0;
...
void func_112(struct<3> Param0, float fParam3, bool bParam4)//Position - 0xBEB8
{
	int iVar0;
...
int func_113(var uParam0)//Position - 0xBF08
{
	if (func_114(uParam0))
	{
...
int func_114(var uParam0)//Position - 0xBF3D
{
	...
	if (iLocal_199 == 0)
	{
		if (STREAMING::HAS_MODEL_LOADED(joaat("S_M_Y_Marine_01")) && STREAMING::HAS_MODEL_LOADED(joaat("S_M_M_Pilot_02")))
		{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_29[0]))
			{
				...
				func_117(iLocal_29[0], 595);
				func_116(iLocal_29[0], 0);
			}
			iLocal_174 = 0;
			while (iLocal_174 <= 12)
			{
				if (iLocal_273[iLocal_174] == 0)
				{
					if (!PED::IS_PED_INJURED(iLocal_31[iLocal_174]))
					{
						...
						func_117(iLocal_31[iLocal_174], 595);
						func_116(iLocal_31[iLocal_174], 0);
...
void func_116(int iParam0, bool bParam1)//Position - 0xC3B6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_117(var uParam0, int iParam1)//Position - 0xC451
{
	int iVar0;
	...
	while (iVar0 < 16)
	{
		if (Global_76286[iVar0 /*2*/] == 0)
		{
			Global_76286[iVar0 /*2*/] = uParam0;
			Global_76286[iVar0 /*2*/].f_1 = iParam1;
			if (iVar0 == Global_76319)
			{
				Global_76319++;
			}
			return;
...
void func_118(int iParam0, int iParam1)//Position - 0xC4A7
{
	Global_101392.f_22[iParam1] = iParam0;
}

bool func_119()//Position - 0xC4BB
{
	return func_113(&(Global_107917.f_2890));
}

void func_120()//Position - 0xC4CE
{
	func_121(&(Global_107917.f_2890));
}

void func_121(var uParam0)//Position - 0xC4E1
{
	if (func_114(uParam0))
	{
...
var func_122()//Position - 0xC4FF
{
	return Global_107917.f_2890.f_12.f_66;
}

bool func_123()//Position - 0xC512
{
	return func_114(&(Global_107917.f_2890));
}

void func_124(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0xC525
{
	func_125(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_125(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0xC54E
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_127(iVar0, Param0, Param3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_126(struct<3> Param0)//Position - 0xC944
{
...
int func_127(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0xC96E
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_128(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var9) || func_128(Var18[0 /*3*/], Var18[1 /*3*/], Var9, Var15)) || func_128(Var18[0 /*3*/], Var18[1 /*3*/], Var12, Var15)) || func_128(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var12)) || func_128(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var9)) || func_128(Var18[1 /*3*/], Var18[3 /*3*/], Var9, Var15)) || func_128(Var18[1 /*3*/], Var18[3 /*3*/], Var12, Var15)) || func_128(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var12)) || func_128(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var9)) || func_128(Var18[3 /*3*/], Var18[2 /*3*/], Var9, Var15)) || func_128(Var18[3 /*3*/], Var18[2 /*3*/], Var12, Var15)) || func_128(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var12)) || func_128(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var9)) || func_128(Var18[2 /*3*/], Var18[0 /*3*/], Var9, Var15)) || func_128(Var18[2 /*3*/], Var18[0 /*3*/], Var12, Var15)) || func_128(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_128(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0xCC64
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_129(struct<3> Param0)//Position - 0xCD18
{
	float fVar0;
	float fVar1;
...
void func_130(int iParam0)//Position - 0xCD57
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_132()//Position - 0xD006
{
	...
	while (iLocal_174 <= 12)
	{
		func_133(&(Local_68[iLocal_174 /*8*/]));
		iLocal_174++;
	}
	HUD::CLEAR_GPS_MULTI_ROUTE();
}

void func_133(int* iParam0)//Position - 0xD05C
{
	bool bVar0;
	struct<8> Var1;
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_46, false))
		{
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_46, false))
			{
				...
				if (iLocal_26 == 4)
				{
					if (!HUD::DOES_BLIP_EXIST(iLocal_60))
					{
						iLocal_60 = func_141(Local_312, 0);
					}
					if (iLocal_197 == 0)
					{
				...
				if (iLocal_26 == 3)
				{
					...
					{
						uLocal_61[0] = func_138(iLocal_29[0], 1, 0);
					}
				}
			}
			else if (iLocal_26 != 5)
			{
				if (!HUD::DOES_BLIP_EXIST(iLocal_59))
				{
					iLocal_59 = func_135(iLocal_46, 0, 0);
				}
				if (iLocal_26 == 3 || iLocal_26 == 4)
				{
					if (iLocal_298 == 0)
...
int func_135(int iParam0, bool bParam1, bool bParam2)//Position - 0xD281
{
	return func_136(iParam0, !bParam1, bParam2);
}

int func_136(int iParam0, bool bParam1, bool bParam2)//Position - 0xD294
{
	int iVar0;
...
float func_137(bool bParam0, float fParam1, float fParam2)//Position - 0xD338
{
	if (bParam0)
	{
		return fParam1;
...
int func_138(int iParam0, bool bParam1, bool bParam2)//Position - 0xD34F
{
	return func_136(iParam0, !bParam1, bParam2);
}

void func_139(char* sParam0, int iParam1, int iParam2)//Position - 0xD362
{
	iParam2 = iParam2;
...
int func_141(struct<3> Param0, bool bParam3)//Position - 0xD39D
{
	int iVar0;
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_309, true) > 800f)
						{
							if (iLocal_302 == 0 && iLocal_197 == 1)
							{
								if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
								{
									if (!func_140() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
									{
										func_163(&uLocal_401, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
										if (func_162(&uLocal_401, "DP2BAUD", "DP2B_CHAT59", 7, 0, 0, 0))
										{
											iLocal_302 = 1;
										}
									}
							...
							if (iLocal_302 == 1 && iLocal_307 == 0)
							{
								if (func_161(72) == 0)
								{
									if (!func_140())
									{
										...
										{
											func_163(&uLocal_401, 3, 0, "Wade", 0, 1);
											if (func_146(&uLocal_401, 24, "DP2BAUD", "DP2B_WADEP3", 7, 1, 0, 0, 0))
											{
												iLocal_307 = 1;
											}
										}
								...
								else if (!func_140())
								{
									...
									{
										func_163(&uLocal_401, 3, 0, "Wade", 0, 1);
										if (func_146(&uLocal_401, 24, "DP2BAUD", "DP2B_WADEP4", 7, 1, 0, 0, 0))
										{
											iLocal_307 = 1;
										}
									}
...
void func_143(bool bParam0, int iParam1)//Position - 0xD76F
{
	int iVar0;
...
void func_144(char* sParam0, int iParam1)//Position - 0xD809
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_145(int iParam0)//Position - 0xD820
{
...
bool func_146(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0xD84D
{
...
int func_147(char* sParam0, int iParam1, bool bParam2)//Position - 0xD8AC
{
	Global_22167 = 0;
...
bool func_150(int iParam0)//Position - 0xDC14
{
	return func_87(iParam0, 20);
}

int func_151()//Position - 0xDC24
{
	return -1;
}

void func_152()//Position - 0xDC2D
{
	int iVar0;
...
bool func_158(int iParam0, int iParam1)//Position - 0xDEAC
{
	switch (iParam0)
	{
		case 5:
...
void func_160(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDF3B
{
...
int func_161(int iParam0)//Position - 0xDF91
{
...
bool func_162(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xDFBD
{
...
void func_163(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xE00B
{
...
void func_164(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE0A6
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_236(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
				Global_114370.f_18577[iVar5 /*6*/].f_4 = 0;
				MemCopy(&uVar6, {func_235(iVar5)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar6, 0, Global_101429, iParam0);
			}
			else
			{
				iVar10 = func_234(&(Global_101392.f_3));
				if (iVar10 > -1)
				{
...
void func_165(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0xE21B
{
	func_166(&Global_107917, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_166(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE237
{
	int iVar0;
	int iVar1;
...
int func_167(var uParam0)//Position - 0xF0C0
{
...
void func_168(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF0E2
{
	int iVar0;
...
int func_169(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0xF16A
{
...
int func_170(int iParam0)//Position - 0xF1AA
{
	int iVar0;
...
void func_171(var uParam0, int iParam1, int iParam2)//Position - 0xF1D8
{
...
int func_172(int iParam0)//Position - 0xF2B4
{
	int iVar0;
...
int func_173(int iParam0, int iParam1, int iParam2)//Position - 0xF2F6
{
	int iVar0;
...
int func_174(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0xF384
{
	char* sVar0;
...
void func_175(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0xF4B1
{
	int iVar0;
	int iVar1;
...
int func_176(int iParam0, int iParam1)//Position - 0xF64B
{
	int iVar0;
	var uVar1;
...
int func_177(int iParam0, var uParam1)//Position - 0xF67A
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_178(uParam1));
}

int func_178(var uParam0)//Position - 0xF68F
{
	int iVar0;
	int iVar1;
...
var func_179()//Position - 0xF6C3
{
	return Global_1574925;
}

int func_180(int iParam0, int iParam1)//Position - 0xF6CF
{
	int iVar0;
	var uVar1;
...
int func_181(int iParam0, var uParam1)//Position - 0xF6F3
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_178(uParam1));
}

void func_182(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0xF708
{
	int iVar0;
...
void func_183(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0xFC51
{
	int iVar0;
...
int func_184()//Position - 0xFE92
{
	func_21();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_185(int iParam0, bool bParam1)//Position - 0xFEAB
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_23(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_186(iParam0, &(Global_114370.f_2366.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_186(int iParam0, var uParam1)//Position - 0xFF9E
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_188(Var11.f_1)) && iVar72 < 51)
			{
...
int func_187(int iParam0)//Position - 0x10228
{
	switch (iParam0)
	{
...
int func_188(int iParam0)//Position - 0x102C9
{
...
int func_189(int iParam0, int iParam1)//Position - 0x104B5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_190(int iParam0, var* uParam1)//Position - 0x111D6
{
	int iVar0;
	int iVar1;
...
int func_191(int iParam0)//Position - 0x11211
{
	int iVar0;
...
void func_192(int iParam0)//Position - 0x11485
{
	int iVar0;
...
void func_193(var uParam0, int iParam1)//Position - 0x114C1
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_194(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x11A10
{
	int iVar0;
	int iVar1;
...
bool func_195(int iParam0, var uParam1, var uParam2)//Position - 0x11A54
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
int func_196(var uParam0)//Position - 0x121D3
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_222())
		{
			*uParam0 = func_202(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 6, -1, 0, 1, -1);
...
bool func_197(int iParam0)//Position - 0x1222E
{
	return func_198(iParam0, 0, 1);
}

int func_198(int iParam0, int iParam1, bool bParam2)//Position - 0x1223E
{
	if (iParam0 == -1)
	{
		return 0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_200() == 0)
		{
			return BitTest(func_176(func_199(iParam0), -1), iParam1);
		}
	}
	else
	{
...
int func_199(int iParam0)//Position - 0x1229E
{
	switch (iParam0)
	{
		case 0:
...
int func_200()//Position - 0x12646
{
	return Global_32828;
}

int func_201(int iParam0)//Position - 0x12651
{
	return func_198(iParam0, 5, 1);
}

int func_202(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x12661
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 60)
	{
		if (iParam3 == 6 || iParam3 == func_221(iVar0))
		{
			if (!bParam5 || func_220(iVar0))
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_203(iVar0, 0), true);
...
Vector3 func_203(int iParam0, bool bParam1)//Position - 0x12703
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_204()//Position - 0x12E6E
{
	if (!func_126(Global_1948900))
	{
...
int func_205()//Position - 0x13169
{
	return Global_2652572.f_2650;
}

Vector3 func_206(struct<3> Param0)//Position - 0x13178
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_207(), 0f, Param0);
}

Vector3 func_207()//Position - 0x1318D
{
	return -880f, -2770f, -50f;
}

int func_208(int iParam0)//Position - 0x131A4
{
	if (iParam0 != func_151())
	{
...
Vector3 func_209(int iParam0, int iParam1)//Position - 0x131FC
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_210(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x132A6
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
	...
	if (!func_215(iParam1, &Var6))
	{
		return 0;
	}
	if (!bParam4)
	{
		Var12 = { func_213(iParam0) };
	}
	else
	{
		Var12 = { func_212(iParam0) };
	}
	Var18 = { Var12 - Var0 };
	Var18 = { func_211(Var18, -Var0.f_3.f_2) };
	Var18 = { func_211(Var18, Var6.f_3.f_2) };
	*uParam2 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Var6, 0f, Var18) };
	uParam2->f_3 = { Var12.f_3 };
	return 1;
}

Vector3 func_211(struct<3> Param0, float fParam3)//Position - 0x1333B
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_212(int iParam0)//Position - 0x1337F
{
	struct<6> Var0;
...
struct<6> func_213(int iParam0)//Position - 0x13503
{
	return func_214(iParam0);
}

struct<6> func_214(int iParam0)//Position - 0x13511
{
	struct<6> Var0;
...
int func_215(int iParam0, var uParam1)//Position - 0x13FD8
{
	switch (iParam0)
	{
		case 0:
...
int func_216(int iParam0)//Position - 0x1405F
{
	if (iParam0 != func_151())
	{
...
Vector3 func_217(int iParam0)//Position - 0x140B7
{
	switch (iParam0)
	{
		case 1:
...
int func_218()//Position - 0x14323
{
	return func_219(PLAYER::PLAYER_ID());
}

int func_219(int iParam0)//Position - 0x14333
{
	return MISC::GET_BITS_IN_RANGE(Global_2657921[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_220(int iParam0)//Position - 0x14350
{
	return func_198(iParam0, 0, 0);
}

int func_221(int iParam0)//Position - 0x14360
{
	switch (iParam0)
	{
		case -1:
...
bool func_222()//Position - 0x14696
{
	return Global_101444.f_393 > 0;
}

var func_223()//Position - 0x146A7
{
	var uVar0;
...
void func_224(var uParam0, int iParam1)//Position - 0x146ED
{
	if (iParam1 <= 0)
	{
		return;
...
void func_225(var uParam0, int iParam1)//Position - 0x14773
{
...
void func_226(var uParam0, int iParam1)//Position - 0x147A6
{
	int iVar0;
	int iVar1;
...
int func_227(int iParam0, int iParam1)//Position - 0x147F7
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_228(int iParam0)//Position - 0x14899
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_229(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_229(bool bParam0, int iParam1, int iParam2)//Position - 0x148BB
{
	if (bParam0)
	{
		return iParam1;
...
int func_230(var uParam0)//Position - 0x148D2
{
	return uParam0 & 15;
}

void func_231(var uParam0, int iParam1)//Position - 0x148DF
{
...
void func_232(var uParam0, int iParam1)//Position - 0x14919
{
...
void func_233(var uParam0, int iParam1)//Position - 0x14954
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_234(char* sParam0)//Position - 0x14990
{
...
struct<2> func_235(int iParam0)//Position - 0x149E6
{
	struct<2> Var0;
...
int func_236(char* sParam0, int iParam1)//Position - 0x14E32
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_237(int iParam0, var uParam1)//Position - 0x14E7B
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_238(uParam1, "Barry3A", func_240(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_239(iParam0), 0, 1);
			break;
		...
		case 8:
			func_238(uParam1, "Dreyfuss1", func_240(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_239(iParam0), 0, 0);
			break;
		...
		case 38:
			func_238(uParam1, "Nigel1A", func_240(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_239(iParam0), 1, 1);
			break;
		...
		case 49:
			func_238(uParam1, "Paparazzo3A", func_240(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_239(iParam0), 0, 1);
			break;
		...
		case 58:
			func_238(uParam1, "Tonya1", func_240(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_239(iParam0), 0, 1);
			break;
...
int func_239(int iParam0)//Position - 0x160C1
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_240(int iParam0)//Position - 0x16407
{
	struct<2> Var0;
	char[] cVar2[8];
	
	StringCopy(&Var0, "", 8);
	cVar2 = { func_235(iParam0) };
...
int func_241(int iParam0)//Position - 0x1643E
{
	switch (iParam0)
	{
		case 69:
...
int func_242(int iParam0)//Position - 0x164FA
{
	switch (iParam0)
	{
		case 1:
...
int func_243(char* sParam0, bool bParam1)//Position - 0x1654E
{
	int iVar0;
	int iVar1;
...
int func_244(int iParam0, bool bParam1)//Position - 0x16578
{
	int iVar0;
...
void func_245(bool bParam0)//Position - 0x165AE
{
	int iVar0;
	int iVar1;
...
void func_246(int iParam0, int iParam1, int iParam2)//Position - 0x16830
{
	if (func_292() && func_36())
	{
...
void func_247(int iParam0)//Position - 0x168F4
{
	if (iParam0 == 1)
	{
...
void func_248()//Position - 0x1691D
{
...
void func_249()//Position - 0x169ED
{
	if (iLocal_173 > 0)
	{
		func_134();
		...
		while (iLocal_174 <= 12)
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_46, false))
			{
				func_252(iLocal_31[iLocal_174], &(Local_68[iLocal_174 /*8*/]), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
			}
			else
			{
				func_133(&(Local_68[iLocal_174 /*8*/]));
...
void func_250(int iParam0, int iParam1)//Position - 0x16CD1
{
	Global_64049 = iParam0;
	Global_64050 = iParam1;
}

void func_251(int iParam0, bool bParam1)//Position - 0x16CE3
{
	int iVar0;
...
int func_252(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)//Position - 0x16D2D
{
	bool bVar0;
...
void func_253()//Position - 0x16F21
{
...
void func_254()//Position - 0x16FB9
{
	if (iLocal_26 == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
											...
											if (iLocal_271 == 1)
											{
												if (iLocal_272 == 0)
												{
													if (!func_140())
													{
														if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
														{
															func_163(&uLocal_401, 4, 0, "PilotDispatch", 0, 1);
															func_163(&uLocal_401, 5, 0, "PilotDispatch2", 0, 1);
															if (func_162(&uLocal_401, "DP2BAUD", "DP2B_CHAT54", 7, 0, 0, 0))
															{
																iLocal_272 = 1;
															}
														}
												...
												if (iLocal_271 == 0)
												{
													if (!func_140())
													{
														if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
														{
															func_163(&uLocal_401, 4, 0, "PilotDispatch", 0, 1);
															func_163(&uLocal_401, 5, 0, "PilotDispatch2", 0, 1);
															if (func_162(&uLocal_401, "DP2BAUD", "DP2B_CHAT53", 7, 0, 0, 0))
															{
																iLocal_271 = 1;
															}
														}
...
int func_256(struct<3> Param0, int iParam3, int iParam4, bool bParam5)//Position - 0x18153
{
	struct<3> Var0[15];
	struct<3> Var46[15];
	float fVar92[15];
...
void func_257()//Position - 0x18EA7
{
	if (iLocal_173 > 0)
	{
		func_134();
...
void func_258(int iParam0)//Position - 0x1940D
{
	MISC::CLEAR_BIT(&Global_97227, iParam0);
}

void func_259(int iParam0)//Position - 0x1941F
{
	MISC::SET_BIT(&Global_97227, iParam0);
}

bool func_260(int iParam0)//Position - 0x19431
{
	return BitTest(Global_97227, iParam0);
}

int func_261(int iParam0)//Position - 0x19440
{
	var uVar0;
...
int func_262(int iParam0)//Position - 0x19454
{
	if (iParam0 == 1)
	{
		if (Global_20813.f_1 > 3)
...
void func_263(int iParam0)//Position - 0x194AB
{
	if (Global_98294 != -1)
	{
...
void func_264(int iParam0, int iParam1)//Position - 0x194CF
{
	int iVar0;
...
void func_265(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x1953A
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104933.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104933.f_4, false))
		{
			if (func_274(24) != Global_104933.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_271(ENTITY::GET_ENTITY_COORDS(Global_104933.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_266(Global_104933.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_266(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x195B5
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_268(iParam5, &Var0, Param1, fParam4, func_64(iParam0));
		func_267(iParam5, iParam0, 0);
	}
}

void func_267(int iParam0, int iParam1, int iParam2)//Position - 0x196DE
{
	int iVar0;
...
void func_268(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x197F5
{
	if (func_74(&(Global_78038.f_555[0 /*21*/]), iParam0))
	{
...
void func_269(int iParam0)//Position - 0x198EE
{
	if (iParam0 == -1)
	{
		return;
...
void func_270(int iParam0)//Position - 0x19965
{
...
int func_271(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x1998C
{
	int iVar0;
	
	iVar0 = func_272(Param0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_272(struct<3> Param0, int iParam3, int iParam4)//Position - 0x19AA2
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_273(int iParam0)//Position - 0x19B31
{
	return BitTest(Global_114370.f_7232[iParam0], 0);
}

int func_274(int iParam0)//Position - 0x19B46
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_275()//Position - 0x19B62
{
	if (iLocal_173 == 0)
	{
		func_279(1, 0);
		...
		if (func_292())
		{
			if (Global_95549 == 1)
			{
				if (func_278() == 0)
				{
					func_277(Local_309, fLocal_321, 1, 0);
					iLocal_194 = 1;
					iLocal_173 = 0;
					iLocal_26 = 3;
				}
...
void func_276()//Position - 0x19D2C
{
	iLocal_195 = 0;
	if (!CAM::IS_SCREEN_FADED_OUT())
	{
...
void func_277(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x19E3B
{
	if (func_292())
	{
...
void func_281()//Position - 0x19F35
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_46, false))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_46, false))
				{
					...
					{
						if (func_282(PLAYER::PLAYER_PED_ID(), iLocal_46) == -1)
						{
...
int func_282(int iParam0, int iParam1)//Position - 0x19F8D
{
...
void func_283()//Position - 0x19FFF
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (iLocal_26 == 2 || iLocal_26 == 3)
		{
			if (func_256(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 3, 200, 0) || iLocal_209 == 1)
			{
...
void func_284()//Position - 0x1A096
{
}

void func_285()//Position - 0x1A09E
{
	if (iLocal_287 == 0)
	{
		iLocal_183 = 0;
				...
				if (!PED::IS_PED_INJURED(iLocal_31[iLocal_183]))
				{
					if (PED::CAN_PED_SEE_HATED_PED(iLocal_31[iLocal_183], PLAYER::PLAYER_PED_ID()))
					{
						...
						if (func_2(iLocal_31[iLocal_183], PLAYER::PLAYER_PED_ID(), 1) < 25f)
						{
							if (func_261(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED"))
							{
								if (func_290(iLocal_31[iLocal_183], 6))
								{
									iLocal_287 = 1;
								}
							}
											...
											if (func_261(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED"))
											{
												if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
												{
													if (!PED::IS_PED_INJURED(iLocal_31[0]))
													{
														...
														{
															func_163(&uLocal_401, 4, iLocal_31[0], "ARMY_Guard01", 0, 1);
														}
													}
												}
												if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[1]))
												{
													if (!PED::IS_PED_INJURED(iLocal_31[1]))
													{
														...
														{
															func_163(&uLocal_401, 4, iLocal_31[1], "ARMY_Guard01", 0, 1);
														}
													}
												}
												if (func_162(&uLocal_401, "ARMYAUD", "ARMY_WRN1", 7, 0, 0, 0))
												{
												...
												if (PED::CAN_PED_SEE_HATED_PED(iLocal_31[iLocal_190], PLAYER::PLAYER_PED_ID()))
												{
													if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !func_262(0))
													{
														if (func_261(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED"))
														{
															...
															if (func_162(&uLocal_401, "ARMYAUD", "ARMY_WRN1a", 7, 0, 0, 0))
															{
																iLocal_184 = MISC::GET_GAME_TIMER();
																iLocal_308 = 1;
															}
...
void func_286(int iParam0, char* sParam1, int iParam2)//Position - 0x1A76B
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iParam0, sParam1, func_287(iParam2), 1);
}

int func_287(int iParam0)//Position - 0x1A782
{
	int iVar0;
...
int func_290(int iParam0, int iParam1)//Position - 0x1AA3B
{
...
void func_291()//Position - 0x1AA87
{
...
void func_293()//Position - 0x1AAD2
{
	func_294(73);
...
void func_294(int iParam0)//Position - 0x1ACBA
{
	Global_97227 = 0;
	switch (iParam0)
	{
...
void func_295()//Position - 0x1AD48
{
	func_296();
...
void func_296()//Position - 0x1AE90
{
	Global_97227 = 0;
}

void func_297()//Position - 0x1AE9D
{
	int iVar0;
