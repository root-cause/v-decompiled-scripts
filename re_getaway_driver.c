...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11))
	{
		...
		func_247(Var1, &iLocal_288, bVar12);
	}
	func_246(&uLocal_312, 3);
	if (func_215(Local_232, -1, 0, 0, 0))
	{
		func_212(-1);
	}
	else
	...
	while (iVar0 != 7)
	{
		iVar18 = 0;
		func_209(&uLocal_312);
		if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() && !func_208())
		{
			iVar18 = 0;
			iVar0 = 7;
			func_247(Var1, &iLocal_288, bVar12);
		...
		{
			if (PED::IS_COP_PED_IN_AREA_3D(func_187(PLAYER::PLAYER_ID()) - Vector(10f, 20f, 20f), func_187(PLAYER::PLAYER_ID()) + Vector(10f, 20f, 20f)) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(func_187(PLAYER::PLAYER_ID()) - Vector(10f, 20f, 20f), func_187(PLAYER::PLAYER_ID()) + Vector(10f, 20f, 20f)))
			{
				if ((((!PED::IS_PED_INJURED(iLocal_288[0]) && !PED::IS_PED_INJURED(iLocal_288[1])) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), PLAYER::GET_PLAYERS_LAST_VEHICLE(), false)) && PED::IS_PED_IN_VEHICLE(iLocal_288[0], PLAYER::GET_PLAYERS_LAST_VEHICLE(), false)) && PED::IS_PED_IN_VEHICLE(iLocal_288[1], PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
				{
					...
					if (iLocal_228 != -1 && MISC::GET_GAME_TIMER() > iLocal_228 + 1000)
					{
						if (!func_186())
						{
							func_172(&uLocal_53, "REGETAU", "REAWA_LOSE", 4, 0, 0, 0);
						}
						if (iLocal_228 != -1 && MISC::GET_GAME_TIMER() > iLocal_228 + 10000)
						{
							func_170();
							SYSTEM::WAIT(0);
							func_172(&uLocal_53, "REGETAU", "REAWA_COPS", 4, 0, 0, 0);
							if (!PED::IS_PED_INJURED(iLocal_288[0]))
							{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_288[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_288[1]))
			{
				if (PED::IS_PED_INJURED(iLocal_288[1]) || !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_288[0], PLAYER::PLAYER_PED_ID(), 80f, 80f, 80f, false, true, 0))
				{
					if (!PED::IS_PED_INJURED(iLocal_288[0]))
					{
						...
						func_170();
						SYSTEM::WAIT(0);
						func_172(&uLocal_53, "REGETAU", "REAWA_FKDB", 4, 0, 0, 0);
					}
					iVar18 = 0;
					iVar0 = 7;
					func_247(Var1, &iLocal_288, bVar12);
				...
				if (PED::IS_PED_INJURED(iLocal_288[0]) || !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_288[1], PLAYER::PLAYER_PED_ID(), 80f, 80f, 80f, false, true, 0))
				{
					if (!PED::IS_PED_INJURED(iLocal_288[1]))
					{
						...
						func_170();
						SYSTEM::WAIT(0);
						func_172(&uLocal_53, "REGETAU", "REAWA_DEAD1", 4, 0, 0, 0);
					}
					iVar18 = 0;
					iVar0 = 7;
					func_247(Var1, &iLocal_288, bVar12);
		...
		if (func_169(&iLocal_288, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 180f))
		{
					...
					if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_297[0], PLAYER::PLAYER_PED_ID(), 4f, 4f, 4f, false, true, 0))
						{
							if (!func_186())
							{
								...
								func_172(&uLocal_53, "REGETAU", "REAWA_THX", 4, 0, 0, 0);
								SYSTEM::SETTIMERB(0);
							}
							else
							{
				...
				if (!PED::IS_PED_INJURED(iLocal_287))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_287, PLAYER::PLAYER_PED_ID(), 4f, 4f, 4f, false, true, 0))
					{
						if (!func_186())
						{
							...
							func_172(&uLocal_53, "REGETAU", "REAWA_THANKS", 4, 0, 0, 0);
						}
						else
						{
							if (!PED::IS_PED_INJURED(iLocal_287))
	...
	switch (*iParam0)
	{
		...
		case 1:
			*iParam11 = 0;
			...
			if (func_120() == 0)
			{
				func_119(&uLocal_53, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
			}
			else if (func_120() == 1)
			{
				func_119(&uLocal_53, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			}
			else if (func_120() == 2)
			{
				func_119(&uLocal_53, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			}
			...
			func_119(&uLocal_53, 2, (*uParam10)[0], "REGETRobber2", 0, 1);
			...
			func_119(&uLocal_53, 1, (*uParam10)[1], "PACKIE", 0, 1);
			...
			func_119(&uLocal_53, 3, iLocal_287, "StoreOwner", 0, 1);
		...
		case 3:
			...
			if (PED::IS_COP_PED_IN_AREA_3D(Local_232 - Vector(40f, 40f, 40f), Local_232 + Vector(40f, 40f, 40f)) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(Local_232 - Vector(40f, 40f, 40f), Local_232 + Vector(40f, 40f, 40f)))
			{
				if (!PED::IS_PED_INJURED((*uParam10)[0]) && !PED::IS_PED_INJURED((*uParam10)[1]))
				{
					...
					func_170();
					SYSTEM::WAIT(0);
					func_172(&uLocal_53, "REGETAU", "REAWA_POLICE", 4, 0, 0, 0);
					*iParam0 = 20;
				}
			}
			break;
		...
		case 4:
			if (!func_186())
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_287))
				{
					if (!PED::IS_PED_INJURED(iLocal_287))
					{
						func_172(&uLocal_53, "REGETAU", "REAWA_DOWN", 4, 0, 0, 0);
			...
			if (!PED::IS_PED_INJURED(iLocal_288[0]) && !PED::IS_PED_INJURED(iLocal_288[1]))
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_ON_ANY_BIKE(PLAYER::PLAYER_PED_ID()))
				{
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
					{
						...
						{
							if (func_129() && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
							{
							...
							else if (!iLocal_278)
							{
								if (!func_186())
								{
									func_172(&uLocal_53, "REGETAU", "REAWA_CAR", 4, 0, 0, 0);
				...
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), (*uParam10)[1], 10f, 10f, 10f, false, true, 0))
				{
					if (!iLocal_278)
					{
						if (!func_186())
						{
							func_172(&uLocal_53, "REGETAU", "REAWA_NDCAR", 4, 0, 0, 0);
							TASK::TASK_LOOK_AT_ENTITY(iLocal_288[1], PLAYER::PLAYER_PED_ID(), -1, 2096, 4);
							iLocal_278 = 1;
						}
					}
			...
			*iParam11 = 0;
			...
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
			{
				if (func_72(uParam10, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 120f) || bLocal_274)
				{
					...
					if (!bLocal_274)
					{
						func_172(&uLocal_53, "REGETAU", "REAWA_COPS2", 4, 0, 0, 0);
					}
		...
		case 10:
			...
			else
			{
				...
				if (!iLocal_220)
				{
					func_170();
					SYSTEM::WAIT(0);
					func_172(&uLocal_53, "REGETAU", "REAWA_HOM", 4, 0, 0, 0);
					iLocal_220 = 1;
				}
				*iParam0 = 11;
			}
		...
		case 11:
			*iParam11 = 0;
			...
			else
			{
				...
				{
					func_172(&uLocal_53, "REGETAU", "REAWA_CULT", 4, 0, 0, 0);
				}
				if (func_54())
				{
					func_170();
					...
					if (func_53())
					{
						func_172(&uLocal_53, "REGETAU", "REAWA_CULT2", 4, 0, 0, 0);
					}
					else
					{
						func_172(&uLocal_53, "REGETAU", "REAWA_CULT3", 4, 0, 0, 0);
					}
				}
				if (!PED::IS_PED_INJURED(iLocal_288[0]) && !PED::IS_PED_INJURED(iLocal_288[1]))
				{
					if ((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var15[iLocal_221 /*3*/], Global_22, true, true, 0) && ENTITY::IS_ENTITY_AT_COORD(iLocal_288[0], Var15[iLocal_221 /*3*/], 20f, 20f, 20f, false, true, 0)) && ENTITY::IS_ENTITY_AT_COORD(iLocal_288[1], Var15[iLocal_221 /*3*/], 20f, 20f, 20f, false, true, 0))
					{
						func_69(iLocal_51);
						iVar48 = 0;
		...
		case 12:
			...
			if (bLocal_276)
			{
				...
				func_170();
				SYSTEM::WAIT(0);
				func_172(&uLocal_53, "REGETAU", "REAWA_COPS3", 4, 0, 0, 0);
				if (!PED::IS_PED_INJURED((*uParam10)[0]))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_307);
		...
		case 14:
			...
			while (iVar48 < *uParam10)
			{
				if (!PED::IS_PED_INJURED((*uParam10)[0]))
				{
					...
					if (iLocal_226 > 0)
					{
						func_172(&uLocal_53, "REGETAU", "REAWA_STOP2", 4, 0, 0, 0);
					}
					else
					{
						func_172(&uLocal_53, "REGETAU", "REAWA_STOP", 4, 0, 0, 0);
					}
					*iParam0 = 15;
				}
				iVar48++;
		...
		case 18:
			...
			if (!PED::IS_PED_INJURED(iLocal_288[1]))
			{
				func_172(&uLocal_53, "REGETAU", "REAWA_ATTP", 4, 0, 0, 0);
			}
			else if (!PED::IS_PED_INJURED(iLocal_288[0]))
			{
				func_172(&uLocal_53, "REGETAU", "REAWA_ATTB", 4, 0, 0, 0);
			}
			if (!bLocal_277)
			{
				if (!PED::IS_PED_INJURED(iLocal_287))
...
void func_8()//Position - 0x3AFD
{
	...
	{
		if (func_12(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_11(PLAYER::PLAYER_PED_ID());
			if (func_10(iVar0) && (!func_9(14) || Global_113083))
			{
				if (Global_114135.f_2367.f_539.f_4321 != iVar0 && func_10(Global_114135.f_2367.f_539.f_4321))
				{
...
void func_22(bool bParam0)//Position - 0x4776
{
	...
	else if (BitTest(Global_114135.f_20568.f_471, bParam0) || BitTest(Global_2359296[func_24() /*5571*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_114135.f_20568.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_24() /*5571*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
int func_31(int iParam0)//Position - 0x4AC1
{
	...
	return BitTest(Global_2359296[func_24() /*5571*/].f_681.f_10, iParam0);
}
	...
	if (!PED::IS_PED_INJURED((*uParam0)[0]) && !PED::IS_PED_INJURED((*uParam0)[1]))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY((*uParam0)[0], (*uParam0)[1], 15f, 15f, 15f, false, true, 0) && ENTITY::IS_ENTITY_AT_ENTITY((*uParam0)[0], PLAYER::PLAYER_PED_ID(), 15f, 15f, 15f, false, true, 0))
		{
			switch (iLocal_225)
			{
				...
				case 1:
					if (func_128(iLocal_224, 2000))
					{
						if (!func_186())
						{
							func_172(&uLocal_53, "REGETAU", "REAWA_PITCH", 4, 0, 0, 0);
							iLocal_225++;
						}
					}
					break;
				...
				case 2:
					if (!func_186())
					{
						if (func_120() == 0)
						{
							func_172(&uLocal_53, "REGETAU", "REAWA_SUREM", 4, 0, 0, 0);
						}
						if (func_120() == 1)
						{
							func_172(&uLocal_53, "REGETAU", "REAWA_SUREF", 4, 0, 0, 0);
						}
						if (func_120() == 2)
						{
							func_172(&uLocal_53, "REGETAU", "REAWA_SURET", 4, 0, 0, 0);
						}
						iLocal_225++;
					}
					break;
			...
			switch (iLocal_223)
			{
				...
				case 1:
					if (func_128(iLocal_224, 2000))
					{
						if (!func_186())
						{
							func_172(&uLocal_53, "REGETAU", "REAWA_HOM2", 4, 0, 0, 0);
							iLocal_223++;
						}
					}
					break;
				...
				case 2:
					if (!func_186())
					{
						if (func_120() == 0)
						{
							func_172(&uLocal_53, "REGETAU", "REAWA_HOM4M", 4, 0, 0, 0);
						}
						if (func_120() == 1)
						{
							func_172(&uLocal_53, "REGETAU", "REAWA_HOM4F", 4, 0, 0, 0);
						}
						if (func_120() == 2)
						{
							func_172(&uLocal_53, "REGETAU", "REAWA_HOM4T", 4, 0, 0, 0);
						}
						iLocal_223++;
					}
					break;
				...
				if (!PED::IS_PED_IN_GROUP(iLocal_288[iVar0]))
				{
					...
					if (!iLocal_282)
					{
						if (iLocal_227 != -1 && MISC::GET_GAME_TIMER() > iLocal_227 + 1000)
						{
							func_170();
							SYSTEM::WAIT(0);
							func_172(&uLocal_53, "REGETAU", "REAWA_AIM", 4, 0, 0, 0);
							iLocal_282 = 1;
						}
					}
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
			...
			if (!PED::IS_PED_INJURED((*uParam0)[iVar0]))
			{
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 121.8366f, -1503.0063f, 28.0999f, 0.1367f, -1649.7048f, 48.1608f, 125.8125f, false, true, 0) && !ENTITY::IS_ENTITY_OCCLUDED((*uParam0)[iVar0])) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 75.3661f, -1542.8114f, 28.4601f, 43.7035f, -1580.2795f, 33.4259f, 26f, false, true, 0))
				{
					...
					if (!func_186())
					{
						...
						{
							func_172(&uLocal_53, "REGETAU", "REAWA_SHOUT", 4, 0, 0, 0);
					...
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 75.3661f, -1542.8114f, 28.4601f, 43.7035f, -1580.2795f, 33.4259f, 26f, false, true, 0))
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(iParam1, false))
						{
							if (!func_186())
							{
								if (func_129() && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
								{
									func_172(&uLocal_53, "REGETAU", "REAWA_START", 4, 0, 0, 0);
									iLocal_219 = 1;
								}
								else
								{
									func_172(&uLocal_53, "REGETAU", "REAWA_START2", 4, 0, 0, 0);
									iLocal_219 = 1;
								}
...
void func_80(int iParam0, int iParam1)//Position - 0x6237
{
	...
	func_81(iParam0, &(Global_114135.f_32754.f_5510));
}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_104(iParam0, 0, 0)) || func_104(iParam0, 1, 0)) || func_104(iParam0, 2, 0)) || func_103(iParam0) != 145) || func_102(iParam0)) || func_101(iParam0)) || func_100(iParam0)) || func_99(iParam0)) || !func_87(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_101(iParam0))
		{
		}
...
int func_89(int iParam0)//Position - 0x6E78
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_91(int iParam0, int iParam1)//Position - 0x6F5B
{
	int iVar0;
	int iVar1;
...
int func_94()//Position - 0x7190
{
	return 0;
}

int func_95()//Position - 0x7199
{
	return 1;
}

int func_96()//Position - 0x71A2
{
	return 1;
}

int func_97()//Position - 0x71AB
{
...
int func_99(int iParam0)//Position - 0x727C
{
	int iVar0;
	char* sVar1;
...
int func_100(int iParam0)//Position - 0x72C3
{
	int iVar0;
...
int func_101(int iParam0)//Position - 0x72FE
{
	int iVar0;
...
int func_102(int iParam0)//Position - 0x737A
{
	int iVar0;
...
int func_103(int iParam0)//Position - 0x7462
{
	int iVar0;
...
int func_104(int iParam0, int iParam1, bool bParam2)//Position - 0x74C5
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_105(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x7533
{
...
int func_107(int iParam0)//Position - 0x7638
{
	if (func_111())
	{
		Global_114125 = 1;
		...
		if (iParam0 && func_110(Global_114124))
		{
...
int func_110(int iParam0)//Position - 0x77AA
{
	switch (iParam0)
	{
		case 29:
...
int func_111()//Position - 0x77D9
{
	switch (func_112(&Global_33147, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
bool func_114(int iParam0)//Position - 0x7995
{
	return func_115(iParam0, Global_44181);
}

int func_115(int iParam0, int iParam1)//Position - 0x79A6
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_116(int iParam0)//Position - 0x7B87
{
	if (Global_44181 == 15)
	{
		return 0;
...
void func_117(int iParam0, char* sParam1, int iParam2)//Position - 0x7BA9
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iParam0, sParam1, func_118(iParam2), 1);
}

int func_118(int iParam0)//Position - 0x7BC0
{
	int iVar0;
...
void func_119(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x7DB5
{
...
void func_121(int iParam0, bool bParam1)//Position - 0x7E69
{
	if (bParam1)
	{
		if (!func_126(iParam0, 2, 1))
		{
			func_125(iParam0, 2, 1);
		}
	}
	else if (func_126(iParam0, 2, 1))
	{
...
void func_122(int iParam0, int iParam1, bool bParam2)//Position - 0x7EA0
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_124() == 0)
		{
			iVar0 = func_32(func_123(iParam0), -1);
			MISC::CLEAR_BIT(&iVar0, iParam1);
			func_25(func_123(iParam0), iVar0, -1, 1);
		}
	}
	else
	{
...
int func_126(int iParam0, int iParam1, bool bParam2)//Position - 0x842B
{
	if (iParam0 == -1)
	{
		return 0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_124() == 0)
		{
			return BitTest(func_32(func_123(iParam0), -1), iParam1);
		}
	}
	else
	{
...
int func_127(struct<3> Param0, float fParam3, int iParam4)//Position - 0x848B
{
...
int func_128(int iParam0, int iParam1)//Position - 0x84C9
{
	int iVar0;
	int iVar1;
...
int func_131(int iParam0)//Position - 0x862F
{
...
int func_132(int iParam0)//Position - 0x864C
{
	switch (iParam0)
	{
		case 0:
...
int func_133(int iParam0)//Position - 0x86BE
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_142()) || Global_113182) || Global_33090) || func_141()) || func_140(8, -1)) || func_139()) || func_138()) || func_137()) || func_136()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_142()) || Global_33090) || func_141()) || func_140(8, -1)) || func_137()) || func_139()) || func_138()) || func_136()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_142()) || Global_113182) || Global_33090) || func_141()) || func_140(8, -1)) || func_137()) || func_139()) || func_138()) || func_136()) || Global_114135.f_7692.f_919[iVar0] == 5) || Global_44728 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_142()) || Global_113182) || Global_33090) || func_141()) || func_140(8, -1)) || func_139()) || func_138()) || func_136()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_142() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_140(8, -1)) || func_136()) || func_135()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_142()) || Global_33090) || func_141()) || func_140(8, -1)) || func_138()) || func_137()) || func_136()) || Global_114135.f_7692.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_142()) || func_138()) || Global_113182) || Global_33090) || func_141()) || Global_45392) || func_140(8, -1)) || func_137()) || func_135()) || func_136()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_142()) || Global_113182) || Global_33090) || func_141()) || func_140(8, -1)) || func_137()) || func_135()) || func_139()) || func_138()) || func_136())
						{
							return 0;
						}
						break;
...
var func_134()//Position - 0x8DDB
{
	return Global_101727.f_1;
}

int func_135()//Position - 0x8DE9
{
	if (Global_98585 != -1)
	{
...
var func_141()//Position - 0x8EAA
{
	return Global_1575084;
}

int func_142()//Position - 0x8EB6
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_143(int iParam0, struct<7> Param1, var uParam8, var uParam9)//Position - 0x8ED2
{
	if (iParam0 == 1)
	{
		func_153(&uLocal_312, Param1.f_0);
		func_153(&uLocal_312, Param1.f_1);
		func_153(&uLocal_312, Param1.f_2);
		func_153(&uLocal_312, Param1.f_3);
		func_153(&uLocal_312, Param1.f_4);
		func_153(&uLocal_312, Param1.f_5);
		func_153(&uLocal_312, Param1.f_6);
...
void func_148(int iParam0, char* sParam1, int iParam2)//Position - 0x8FE6
{
...
int func_149(var uParam0)//Position - 0x90A0
{
	bool bVar0;
...
int func_150(var uParam0)//Position - 0x90C9
{
	int iVar0;
...
int func_152(char* sParam0, char* sParam1, int iParam2)//Position - 0x913C
{
	if (BitTest(sParam0, 30))
	{
		if (BitTest(sParam0, 29))
		{
			switch (func_149(sParam0))
			{
				case 0:
...
void func_154(var uParam0, bool bParam1, int iParam2, char* sParam3, int iParam4)//Position - 0x923B
{
	int iVar0;
...
void func_168()//Position - 0xAF97
{
	if (!bLocal_276)
	{
		PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(func_187(PLAYER::PLAYER_ID()) - Vector(0f, 10f, 0f), MISC::GET_RANDOM_INT_IN_RANGE(5, 15), &Local_241, 1, 3f, 0f);
			...
			if (bLocal_275)
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_297[0]))
				{
					...
					else
					{
						...
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_307);
						PED::SET_PED_KEEP_TASK(iLocal_297[0], true);
						func_119(&uLocal_53, 4, iLocal_297[0], "REGETCop", 0, 1);
					}
				}
				...
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_304))
				{
					...
					Local_238 = { func_187(PLAYER::PLAYER_ID()) - ENTITY::GET_ENTITY_COORDS(iLocal_304, true) };
...
int func_169(var uParam0, int iParam1, float fParam2)//Position - 0xB33B
{
	int iVar0;
...
int func_172(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xB407
{
...
var func_177(int iParam0, int iParam1)//Position - 0xB7CD
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_178()//Position - 0xB7E5
{
	return -1;
}
...
void func_185(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0xBA6F
{
...
Vector3 func_187(int iParam0)//Position - 0xBAE7
{
...
int func_190(bool bParam0)//Position - 0xBB52
{
...
void func_191(int iParam0, int iParam1)//Position - 0xBB7A
{
	...
	if (iParam1 <= func_197(iParam0))
	{
		...
		{
			func_192(func_194(iParam0, iParam1), Local_47.f_0, Local_47.f_1);
		}
...
void func_193()//Position - 0xBD64
{
	...
	if (!DATAFILE::DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_79539)
		{
			if (func_124() == 2 == 0 && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
...
int func_199(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0xC6C4
{
...
int func_203(int iParam0)//Position - 0xC9EF
{
...
int func_204()//Position - 0xCA1B
{
	return 1;
}

int func_205()//Position - 0xCA24
{
	if (Global_33327)
	{
		func_167(4);
...
int func_206(int iParam0)//Position - 0xCA3C
{
	return func_126(iParam0, 5, 1);
}

int func_207()//Position - 0xCA4C
{
	if (!func_114(5))
	{
		return 1;
...
int func_208()//Position - 0xCAAE
{
	if ((Global_114124 == func_198() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_114125)
	{
		return 1;
	}
	return 0;
...
void func_210(int* iParam0)//Position - 0xCB57
{
	func_211(iParam0, &(iParam0->f_2), iParam0->f_1);
}

void func_211(int* iParam0, char* sParam1, int iParam2)//Position - 0xCB6D
{
	if (BitTest(*iParam0, 30))
	{
		switch (func_149(*iParam0))
...
int func_215(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xCCBF
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (func_10(func_120()))
		{
			if (func_243(func_120()) == 4 || func_243(func_120()) == 5)
			{
				return 0;
			}
		}
		if (func_10(func_120()))
		{
			if (!func_242(iParam3, bParam4, 145))
			{
				return 0;
			}
		}
...
bool func_216(int iParam0)//Position - 0xD059
{
	int iVar0;
...
int func_217(int iParam0)//Position - 0xD07A
{
...
void func_220(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xD0FA
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = SYSTEM::ROUND(func_221(SYSTEM::TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
int func_228(bool bParam0, int iParam1, int iParam2)//Position - 0xD44C
{
	if (bParam0)
	{
		return iParam1;
...
int func_230(int iParam0, int iParam1)//Position - 0xD470
{
	int iVar0;
	int iVar1;
...
int func_231()//Position - 0xD57C
{
	...
	func_237(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_236(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_235(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_234(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_233(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_232(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}
...
int func_238(int iParam0)//Position - 0xD77D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_239(int iParam0, bool bParam1)//Position - 0xD859
{
...
int func_242(int iParam0, int iParam1, int iParam2)//Position - 0xD8B3
{
	int iVar0;
	int iVar1;
...
int func_243(int iParam0)//Position - 0xD997
{
	if (!func_10(iParam0))
	{
		return 7;
...
int func_244(int iParam0)//Position - 0xD9BB
{
	int iVar0;
	int iVar1;
...
void func_247(struct<9> Param0, int iParam9, bool bParam10)//Position - 0xDA6E
{
	int iVar0;
	...
	if (iLocal_311)
	{
		...
		if (!bParam10)
		{
			if (!PED::IS_PED_INJURED((*iParam9)[0]))
			{
				TASK::TASK_SMART_FLEE_COORD((*iParam9)[0], func_187(PLAYER::PLAYER_ID()), 200f, -1, false, false);
			}
			if (!PED::IS_PED_INJURED((*iParam9)[1]))
			{
				TASK::TASK_SMART_FLEE_COORD((*iParam9)[1], func_187(PLAYER::PLAYER_ID()), 200f, -1, false, false);
			}
		}
		if (!iLocal_218)
		{
...
void func_248(int iParam0)//Position - 0xDDE2
{
	...
	if (func_208())
	{
		...
		func_251(30000);
		StringCopy(&cVar0, func_250(Global_114124, 1), 64);
...
void func_253(int iParam0, int iParam1, int iParam2)//Position - 0xE141
{
	...
	uVar0 = func_231();
	func_256(&uVar0, 0, 0, iParam2, iParam1, 0, 0);
	func_255(iParam0, &uVar0);
	Var1 = { func_254(&uVar0) };
}
...
void func_256(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE259
{
	...
	iVar0 = (iVar0 + iParam6);
	func_257(uParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
