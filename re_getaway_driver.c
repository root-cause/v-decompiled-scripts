...
void func_22(bool bParam0)//Position - 0x4772
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_24() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_24() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
int func_87(int iParam0, bool bParam1)//Position - 0x6CE9
{
	int iVar0;
	struct<2> Var1;
...
int func_88(int iParam0)//Position - 0x6E69
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_90(int iParam0)//Position - 0x6F4C
{
	int iVar0;
	int iVar1;
...
bool func_91()//Position - 0xA222
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_92()//Position - 0xA238
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_93()//Position - 0xA24E
{
	return 0;
}

int func_94()//Position - 0xA257
{
	return 1;
}

int func_95()//Position - 0xA260
{
	return 1;
}

int func_96()//Position - 0xA269
{
...
int func_98(int iParam0)//Position - 0xA33A
{
	int iVar0;
	char* sVar1;
...
int func_99(int iParam0)//Position - 0xA380
{
	int iVar0;
...
int func_100(int iParam0)//Position - 0xA3BB
{
	int iVar0;
...
int func_101(int iParam0)//Position - 0xA437
{
	int iVar0;
...
int func_102(int iParam0)//Position - 0xA51F
{
	int iVar0;
...
int func_103(int iParam0, int iParam1, bool bParam2)//Position - 0xA582
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_104(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0xA5F0
{
...
void func_105(bool bParam0)//Position - 0xA6C9
{
	if (bParam0)
	{
...
int func_106(int iParam0)//Position - 0xA6F5
{
	if (func_110())
	{
		Global_113376 = 1;
...
void func_107(int iParam0)//Position - 0xA748
{
	switch (iParam0)
	{
		case 0:
...
char* func_108(int iParam0)//Position - 0xA823
{
	char* sVar0;
...
int func_109(int iParam0)//Position - 0xA867
{
	switch (iParam0)
	{
		case 29:
...
int func_110()//Position - 0xA896
{
	switch (func_111(&Global_32019, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_111(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xA8CC
{
	int iVar0;
...
void func_112(var uParam0, int iParam1)//Position - 0xAA03
{
	int iVar0;
...
bool func_113(int iParam0)//Position - 0xAA52
{
	return func_114(iParam0, Global_43052);
}

int func_114(int iParam0, int iParam1)//Position - 0xAA63
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_115(int iParam0)//Position - 0xAC44
{
	if (Global_43052 == 15)
	{
		return 0;
...
void func_116(int iParam0, char* sParam1, int iParam2)//Position - 0xAC66
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iParam0, sParam1, func_117(iParam2), 1);
}

int func_117(int iParam0)//Position - 0xAC7D
{
	int iVar0;
...
void func_118(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xAE72
{
...
int func_119()//Position - 0xAF0D
{
	func_8();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_120(int iParam0, bool bParam1)//Position - 0xAF26
{
	if (bParam1)
	{
...
void func_121(int iParam0, int iParam1, bool bParam2)//Position - 0xAF5D
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xAFCF
{
	switch (iParam0)
	{
		case 0:
...
int func_123()//Position - 0xB34A
{
	return Global_31959;
}

void func_124(int iParam0, int iParam1, bool bParam2)//Position - 0xB355
{
	int iVar0;
...
int func_125(int iParam0, int iParam1, bool bParam2)//Position - 0xB3C7
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_126(struct<3> Param0, float fParam1, int iParam2)//Position - 0xB428
{
...
int func_127(int iParam0, int iParam1)//Position - 0xB466
{
	int iVar0;
	int iVar1;
...
void func_129(bool bParam0)//Position - 0xB5BF
{
	if (bParam0)
	{
	}
...
int func_130(int iParam0)//Position - 0xB5CC
{
...
int func_131(int iParam0)//Position - 0xB5E9
{
	switch (iParam0)
	{
		case 0:
...
int func_132(int iParam0)//Position - 0xB65B
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_141()) || Global_31962) || func_140()) || func_139(8, -1)) || func_136()) || func_138()) || func_137()) || func_135()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_141()) || Global_112433) || Global_31962) || func_140()) || func_139(8, -1)) || func_138()) || func_137()) || func_135()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_141() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_139(8, -1)) || func_135()) || func_134()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_141()) || func_137()) || Global_112433) || Global_31962) || func_140()) || Global_44238) || func_139(8, -1)) || func_136()) || func_134()) || func_135()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_133()//Position - 0xBD78
{
	return Global_100480.f_1;
}

int func_134()//Position - 0xBD86
{
	if (Global_97363 != -1)
	{
...
bool func_137()//Position - 0xBDED
{
	return Global_100493.f_376 > 0;
}

bool func_138()//Position - 0xBDFE
{
	return Global_100493.f_375 > 0;
}

bool func_139(int iParam0, int iParam1)//Position - 0xBE0F
{
	switch (iParam0)
	{
		case 5:
...
var func_140()//Position - 0xBE47
{
	return Global_1575058;
}

int func_141()//Position - 0xBE53
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_142(int iParam0, struct<7> Param1, var uParam2, var uParam3)//Position - 0xBE6F
{
	if (iParam0 == 1)
	{
...
void func_143(var uParam0, bool bParam1)//Position - 0xBEE2
{
	int iVar0;
...
void func_144(var uParam0)//Position - 0xBF1D
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
...
void func_145(var uParam0)//Position - 0xBF36
{
	int iVar0;
...
void func_146(var uParam0)//Position - 0xBF6C
{
	func_147(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

void func_147(int iParam0, char* sParam1, int iParam2)//Position - 0xBF83
{
...
int func_148(var uParam0)//Position - 0xC03E
{
	bool bVar0;
...
int func_149(var uParam0)//Position - 0xC067
{
	int iVar0;
...
bool func_150(var uParam0)//Position - 0xC0C3
{
	return func_151(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

int func_151(char* sParam0, char* sParam1, int iParam2)//Position - 0xC0DA
{
...
void func_152(var uParam0, int iParam1)//Position - 0xC1C5
{
	func_153(uParam0, 0, iParam1, "NULL", 0);
}

void func_153(var uParam0, bool bParam1, int iParam2, char* sParam3, int iParam4)//Position - 0xC1D9
{
	int iVar0;
...
int func_155(float fParam0, bool bParam1)//Position - 0xC33E
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_156(int iParam0, var uParam1)//Position - 0xC3EF
{
	switch (iParam0)
	{
		case 0:
...
int func_158(int iParam0)//Position - 0xD6C7
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_159(int iParam0)//Position - 0xDA0D
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_160(int iParam0)//Position - 0xDA45
{
	struct<2> Var0;
...
bool func_162()//Position - 0xDEC4
{
	return Global_113104 > 0;
}

int func_163()//Position - 0xDED2
{
	if (Global_97363 != -1)
	{
		return 1;
...
void func_166(int iParam0)//Position - 0xDF27
{
	Global_113372 = iParam0;
}

void func_167()//Position - 0xDF35
{
	if (!bLocal_248)
	{
...
int func_168(var uParam0, int iParam1, float fParam2)//Position - 0xE2D9
{
	int iVar0;
...
void func_169()//Position - 0xE374
{
	Global_20471 = 0;
	func_170();
}

void func_170()//Position - 0xE384
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22616 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_171(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE3A5
{
...
int func_172(char* sParam0, int iParam1, bool bParam2)//Position - 0xE3F3
{
	Global_21606 = 0;
...
bool func_175(int iParam0)//Position - 0xE75B
{
	return func_176(iParam0, 20);
}

var func_176(int iParam0, int iParam1)//Position - 0xE76B
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

int func_177()//Position - 0xE783
{
	return -1;
}

void func_178()//Position - 0xE78C
{
	int iVar0;
...
void func_184(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0xEA0D
{
...
Vector3 func_186(int iParam0)//Position - 0xEA85
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_187()//Position - 0xEA98
{
	func_188();
}

int func_188()//Position - 0xEAA5
{
	if (func_189(0))
	{
		return 0;
...
int func_189(bool bParam0)//Position - 0xEAF0
{
...
void func_190(int iParam0, int iParam1)//Position - 0xEB18
{
	if (iParam0 == -1)
	{
		iParam0 = func_197();
...
void func_191(int iParam0, var uParam1, var uParam2)//Position - 0xEC1C
{
	bool bVar0;
...
void func_192()//Position - 0xED02
{
	...
	{
		func_47(13, SYSTEM::FLOOR(Global_113386.f_10194.f_3853));
	}
...
int func_193(int iParam0, int iParam1)//Position - 0xF1C0
{
	switch (iParam0)
	{
		case 0:
...
void func_194(int iParam0)//Position - 0xF534
{
	int iVar0;
	int iVar1;
...
void func_195(int iParam0, int iParam1)//Position - 0xF576
{
	MISC::SET_BIT(&(Global_113386.f_24995.f_8[iParam0]), iParam1);
}

int func_196(int iParam0)//Position - 0xF591
{
	int iVar0;
...
int func_198(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0xF65F
{
...
void func_199(int iParam0, bool bParam1)//Position - 0xF839
{
	int iVar0;
...
int func_202(int iParam0)//Position - 0xF98A
{
...
int func_203()//Position - 0xF9B6
{
	return 1;
}

int func_204()//Position - 0xF9BF
{
	if (Global_32198)
	{
		func_166(4);
...
int func_205(int iParam0)//Position - 0xF9D7
{
	return func_125(iParam0, 5, 1);
}

int func_206()//Position - 0xF9E7
{
	if (!func_113(5))
	{
		return 1;
...
int func_207()//Position - 0xFA49
{
	if ((Global_113375 == func_197() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_113376)
	{
		return 1;
	}
	return 0;
...
void func_208(var uParam0)//Position - 0xFA74
{
	int iVar0;
...
void func_209(int* iParam0)//Position - 0xFAF2
{
	func_210(iParam0, &(iParam0->f_2), iParam0->f_1);
}

void func_210(int* iParam0, char* sParam1, int iParam2)//Position - 0xFB08
{
	if (BitTest(*iParam0, 30))
	{
		switch (func_148(*iParam0))
...
void func_211(int iParam0)//Position - 0xFBD9
{
	if (iParam0 == -1)
	{
		iParam0 = func_197();
...
void func_213(int iParam0)//Position - 0xFC4C
{
	Global_113375 = iParam0;
}

int func_214(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xFC5A
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
...
bool func_215(int iParam0)//Position - 0xFFF4
{
	int iVar0;
...
int func_216(int iParam0)//Position - 0x10016
{
	return func_217(iParam0, 1);
}

int func_217(int iParam0, int iParam1)//Position - 0x10025
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_218(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x10078
{
	func_219(func_230(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_219(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x10096
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_220(float fParam0, float fParam1, float fParam2)//Position - 0x10297
{
	float fVar0;
...
int func_221(int iParam0, int iParam1)//Position - 0x102D9
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_222(int iParam0)//Position - 0x1037B
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_223(int iParam0)//Position - 0x1038E
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_224(int iParam0)//Position - 0x103A1
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_225(int iParam0)//Position - 0x103B4
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_226(int iParam0)//Position - 0x103C6
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_227(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_227(bool bParam0, int iParam1, int iParam2)//Position - 0x103E8
{
	if (bParam0)
	{
		return iParam1;
...
int func_228(int iParam0)//Position - 0x103FF
{
	return iParam0 & 15;
}

int func_229(int iParam0, int iParam1)//Position - 0x1040C
{
	int iVar0;
	int iVar1;
...
void func_231(var uParam0, int iParam1)//Position - 0x1055E
{
	if (iParam1 <= 0)
	{
		return;
...
void func_232(var uParam0, int iParam1)//Position - 0x105E4
{
...
void func_233(var uParam0, int iParam1)//Position - 0x10617
{
	int iVar0;
	int iVar1;
...
void func_234(var uParam0, int iParam1)//Position - 0x10668
{
...
void func_235(var uParam0, int iParam1)//Position - 0x106A2
{
...
void func_236(var uParam0, int iParam1)//Position - 0x106DD
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_237(int iParam0)//Position - 0x10719
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_238(int iParam0, bool bParam1)//Position - 0x107F5
{
...
bool func_240(int iParam0)//Position - 0x1083D
{
	return func_229(func_230(), iParam0);
}

int func_241(int iParam0, int iParam1, int iParam2)//Position - 0x1084F
{
	int iVar0;
	int iVar1;
...
int func_242(int iParam0)//Position - 0x10933
{
	if (!func_10(iParam0))
	{
		return 7;
...
int func_243(int iParam0)//Position - 0x10957
{
	int iVar0;
	int iVar1;
...
void func_245(var uParam0, int iParam1)//Position - 0x109F3
{
	if (iParam1 > 0)
	{
...
void func_246(struct<9> Param0, int iParam1, bool bParam2)//Position - 0x10A0A
{
	int iVar0;
...
void func_247(int iParam0)//Position - 0x10D7E
{
	char cVar0[64];
...
void func_248(var uParam0)//Position - 0x10E30
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_249(int iParam0, bool bParam1)//Position - 0x10E6D
{
	switch (iParam0)
	{
		case 0:
...
void func_250(int iParam0)//Position - 0x110B6
{
	Global_43603 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_251(int iParam0)//Position - 0x110C8
{
	func_252(iParam0, 0, func_257(iParam0));
}

void func_252(int iParam0, int iParam1, int iParam2)//Position - 0x110DD
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_253(var uParam0)//Position - 0x1110C
{
	struct<16> Var0;
	int iVar1;
...
void func_254(int iParam0, var uParam1)//Position - 0x111DD
{
	Global_113386.f_24995.f_43[iParam0] = *uParam1;
}

void func_255(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x111F5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_256(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x11377
{
...
int func_257(int iParam0)//Position - 0x113AF
{
	int iVar0;
...
void func_258()//Position - 0x11552
{
	Global_32197 = 0;
	Global_32198 = 0;
	Global_32200 = 0;
...
void func_259(bool bParam0)//Position - 0x1156E
{
	int iVar0;
