...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_227 = -1;
	iLocal_228 = -1;
	Local_244 = { 370.25763f, -1597.4883f, 35.949543f };
	Local_247 = { 824.992f, -1289.2668f, 27.245644f };
	Local_250 = { 450.18887f, -981.6754f, 42.69174f };
	Local_253 = { -1088.3698f, -842.2911f, 30.275543f };
	Local_256 = { 608.9076f, 0.806411f, 100.24968f };
	Local_259 = { -562.01587f, -130.81131f, 37.4369f };
	Local_262 = { 1855.237f, 3683.236f, 33.29165f };
	Local_265 = { -443.50635f, 6016.231f, 30.717875f };
	Local_268 = { -1034.6f, 4918.6f, 205.9f };
	iVar0 = 0;
	iVar10 = 0;
	Local_232 = { ScriptParam_0.f_1[0 /*3*/] };
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11))
	{
		...
		func_248(Var1, &iLocal_288, bVar12);
	}
	func_247(&uLocal_312, 3);
	if (func_216(Local_232, -1, 0, 0, 0))
	{
		func_213(-1);
	}
	else
	...
	while (iVar0 != 7)
	{
		...
		{
			if (PED::IS_COP_PED_IN_AREA_3D(func_188(PLAYER::PLAYER_ID()) - Vector(10f, 20f, 20f), func_188(PLAYER::PLAYER_ID()) + Vector(10f, 20f, 20f)) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(func_188(PLAYER::PLAYER_ID()) - Vector(10f, 20f, 20f), func_188(PLAYER::PLAYER_ID()) + Vector(10f, 20f, 20f)))
			{
				if ((((!PED::IS_PED_INJURED(iLocal_288[0]) && !PED::IS_PED_INJURED(iLocal_288[1])) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), PLAYER::GET_PLAYERS_LAST_VEHICLE(), false)) && PED::IS_PED_IN_VEHICLE(iLocal_288[0], PLAYER::GET_PLAYERS_LAST_VEHICLE(), false)) && PED::IS_PED_IN_VEHICLE(iLocal_288[1], PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
				{
					...
					if (iLocal_228 != -1 && MISC::GET_GAME_TIMER() > iLocal_228 + 1000)
					{
						if (!func_187())
						{
							func_173(&uLocal_53, "REGETAU", "REAWA_LOSE", 4, 0, 0, 0);
						}
						if (iLocal_228 != -1 && MISC::GET_GAME_TIMER() > iLocal_228 + 10000)
						{
							func_171();
							SYSTEM::WAIT(0);
							func_173(&uLocal_53, "REGETAU", "REAWA_COPS", 4, 0, 0, 0);
							if (!PED::IS_PED_INJURED(iLocal_288[0]))
							{
		...
		if (iVar10 > 1)
		{
			...
			{
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, iLocal_308, joaat("AMBIENT_GANG_BALLAS"));
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, iLocal_308, joaat("AMBIENT_GANG_FAMILY"));
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, joaat("AMBIENT_GANG_BALLAS"), iLocal_308);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, joaat("AMBIENT_GANG_FAMILY"), iLocal_308);
			}
			else
			{
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_308, joaat("AMBIENT_GANG_BALLAS"));
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_308, joaat("AMBIENT_GANG_FAMILY"));
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("AMBIENT_GANG_BALLAS"), iLocal_308);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("AMBIENT_GANG_FAMILY"), iLocal_308);
			}
		}
		if ((iVar10 > 1 && iVar10 < 7) && !iLocal_281)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_287))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_287, PLAYER::PLAYER_PED_ID(), true))
				{
					func_171();
					SYSTEM::WAIT(0);
					if (!PED::IS_PED_INJURED(iLocal_288[0]))
		...
		if ((iVar10 > 7 && iVar10 < 18) && !iLocal_281)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_288[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_288[1]))
			{
				if (PED::IS_PED_INJURED(iLocal_288[1]) || !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_288[0], PLAYER::PLAYER_PED_ID(), 80f, 80f, 80f, false, true, 0))
				{
					if (!PED::IS_PED_INJURED(iLocal_288[0]))
					{
						...
						func_171();
						SYSTEM::WAIT(0);
						func_173(&uLocal_53, "REGETAU", "REAWA_FKDB", 4, 0, 0, 0);
					}
					iVar18 = 0;
					iVar0 = 7;
					func_248(Var1, &iLocal_288, bVar12);
				...
				if (PED::IS_PED_INJURED(iLocal_288[0]) || !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_288[1], PLAYER::PLAYER_PED_ID(), 80f, 80f, 80f, false, true, 0))
				{
					if (!PED::IS_PED_INJURED(iLocal_288[1]))
					{
						...
						func_171();
						SYSTEM::WAIT(0);
						func_173(&uLocal_53, "REGETAU", "REAWA_DEAD1", 4, 0, 0, 0);
					}
					iVar18 = 0;
					iVar0 = 7;
					func_248(Var1, &iLocal_288, bVar12);
		...
		if (func_170(&iLocal_288, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 180f))
		{
			...
			if (iLocal_281)
			{
				...
				if (!bLocal_277)
				{
					...
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_307);
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_287, "random@getawaydriver", "idle_a", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_287, "random@getawaydriver", "idle_2_hands_up", 3))
						{
						...
						TASK::CLOSE_SEQUENCE_TASK(iLocal_307);
						TASK::TASK_PERFORM_SEQUENCE(iLocal_287, iLocal_307);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_307);
						PED::SET_PED_KEEP_TASK(iLocal_287, true);
						bLocal_277 = true;
					}
				}
			}
			...
			if (bLocal_276)
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_297[0]))
				{
					if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_297[0], PLAYER::PLAYER_PED_ID(), 4f, 4f, 4f, false, true, 0))
						{
							if (!func_187())
							{
								TASK::TASK_LOOK_AT_ENTITY(iLocal_297[0], PLAYER::PLAYER_PED_ID(), 1000, 2052, 4);
								func_173(&uLocal_53, "REGETAU", "REAWA_THX", 4, 0, 0, 0);
								SYSTEM::SETTIMERB(0);
							}
							else
							{
								if (!PED::IS_PED_INJURED(iLocal_297[0]))
								{
									PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_297[0], false);
								}
								if (!PED::IS_PED_INJURED(iLocal_297[1]))
								{
									PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_297[1], false);
								}
						...
						else if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_297[0], PLAYER::PLAYER_PED_ID(), 120f, 120f, 120f, false, true, 0))
						{
							iVar18 = 0;
							iVar0 = 7;
							func_248(Var1, &iLocal_288, bVar12);
					...
					{
						TASK::CLEAR_PED_TASKS(iLocal_297[0]);
						func_171();
						SYSTEM::WAIT(0);
						iVar18 = 0;
						iVar0 = 7;
				...
				else if (PED::IS_PED_INJURED(iLocal_287))
				{
					iVar18 = 0;
					iVar0 = 7;
					func_248(Var1, &iLocal_288, bVar12);
			...
			if (bLocal_277)
			{
				if (!PED::IS_PED_INJURED(iLocal_287))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_287, PLAYER::PLAYER_PED_ID(), 4f, 4f, 4f, false, true, 0))
					{
						if (!func_187())
						{
							TASK::TASK_LOOK_AT_ENTITY(iLocal_287, PLAYER::PLAYER_PED_ID(), 3000, 2048, 2);
							func_173(&uLocal_53, "REGETAU", "REAWA_THANKS", 4, 0, 0, 0);
						}
						else
						{
							if (!PED::IS_PED_INJURED(iLocal_287))
							{
								PED::SET_PED_CAN_BE_TARGETTED(iLocal_287, true);
							}
							while (func_187())
							{
								SYSTEM::WAIT(0);
					...
					else if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_287, PLAYER::PLAYER_PED_ID(), 120f, 120f, 120f, false, true, 0))
					{
						iVar18 = 0;
						iVar0 = 7;
						func_248(Var1, &iLocal_288, bVar12);
				...
				else if (PED::IS_PED_INJURED(iLocal_297[0]))
				{
					iVar18 = 0;
					iVar0 = 7;
					func_248(Var1, &iLocal_288, bVar12);
		...
		switch (iVar0)
		{
			...
			case 4:
				...
				iVar0 = 5;
				PATHFIND::GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), &uVar13, &uVar16, 1, 3f, 0f);
				if (func_129(iVar17, 20000))
				{
					iVar0 = 6;
				}
				if (iVar0 != 5)
			...
			case 5:
				if (iVar10 > 1)
				{
					if (!func_209())
					{
						...
						if (!iLocal_280)
						{
							if (PED::IS_PED_SHOOTING_IN_AREA(PLAYER::PLAYER_PED_ID(), Vector(28.4601f, -1565.2933f, 61.5891f) - Vector(30f, 30f, 30f), Vector(28.4601f, -1565.2933f, 61.5891f) + Vector(30f, 30f, 30f), false, true))
							{
								iVar19 = 0;
								while (iVar19 < iLocal_291)
								{
									if (!PED::IS_PED_INJURED(iLocal_291[iVar19]))
									{
										TASK::TASK_SMART_FLEE_PED(iLocal_291[iVar19], PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
										PED::SET_PED_KEEP_TASK(iLocal_291[iVar19], true);
									}
									iVar19++;
								}
								if (!PED::IS_PED_INJURED(iLocal_287))
								{
									TASK::TASK_SMART_FLEE_PED(iLocal_287, PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
									PED::SET_PED_KEEP_TASK(iLocal_287, true);
								}
								iLocal_280 = 1;
							}
				...
				if (iVar0 != 6)
				{
					if (func_1(&iVar10, Var1, &iLocal_288, &iVar18, &bVar12))
					{
						iVar0 = 6;
						break;
					}
...
int func_1(int iParam0, struct<5> Param1, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, bool bParam12)//Position - 0xE0E
{
	...
	Var15[3 /*3*/] = { -1339.3282f, -762.4225f, 19.314f };
	Var15[4 /*3*/] = { -461.6898f, 283.665f, 82.2492f };
	Var32[0 /*3*/] = { -45.2654f, -1290.1265f, 28.1977f };
	Var32[1 /*3*/] = { 470.193f, -731.1867f, 26.412f };
	Var32[2 /*3*/] = { 889.9938f, -2177.6382f, 29.5195f };
	Var32[3 /*3*/] = { -1334.8262f, -792.1527f, 18.8175f };
	Var32[4 /*3*/] = { -424.5901f, 288.3558f, 82.2293f };
	switch (*iParam0)
	{
		case 0:
			if (func_128(Local_232, 300f, 1))
			{
				*iParam0 = 1;
			}
			break;
		...
		case 1:
			*iParam11 = 0;
			...
			if (func_121() == 0)
			{
				func_120(&uLocal_53, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
			}
			else if (func_121() == 1)
			{
				func_120(&uLocal_53, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			}
			else if (func_121() == 2)
			{
				func_120(&uLocal_53, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			}
			if (SYSTEM::VDIST(Local_232, 933.83f, 3640.22f, 32.36f) < 20f)
			{
				Var1[0 /*3*/] = { 943.1853f, 3647.218f, 31.3603f };
				fVar8[0] = 58.2967f;
				Var1[1 /*3*/] = { 941.3207f, 3650.3005f, 31.3111f };
				fVar8[1] = 92.7793f;
				Var11 = { 939.2422f, 3649.7551f, 31.3536f };
				fVar14 = 260.4475f;
			}
			else if (SYSTEM::VDIST(Local_232, 57.86f, -1562.4f, 29.47f) < 20f)
			{
				Var1[0 /*3*/] = { 66.0644f, -1564.2178f, 28.4602f };
				fVar8[0] = 198.4093f;
				Var1[1 /*3*/] = { 63.5055f, -1568.1783f, 28.4602f };
				fVar8[1] = 254.133f;
				Var11 = { 68.4259f, -1569.0674f, 28.6027f };
				fVar14 = 64.1114f;
			}
			iLocal_231 = PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID());
			VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_232 - Vector(20f, 20f, 20f), Local_232 + Vector(20f, 20f, 20f), false, true);
			PED::ADD_SCENARIO_BLOCKING_AREA(Local_232 - Vector(50f, 50f, 50f), Local_232 + Vector(50f, 50f, 50f), false, true, true, true);
			PATHFIND::SET_PED_PATHS_IN_AREA(Local_232 - Vector(20f, 20f, 20f), Local_232 + Vector(20f, 20f, 20f), false, 0);
			PATHFIND::SET_ROADS_IN_AREA(Local_232 - Vector(20f, 20f, 20f), Local_232 + Vector(20f, 20f, 20f), false, true);
			...
			iVar52[0] = VEHICLE::CREATE_VEHICLE(joaat("picador"), 59.5209f, -1547.2279f, 28.4602f, 49.1762f, true, true, false);
			iVar52[1] = VEHICLE::CREATE_VEHICLE(joaat("stanier"), 33.3296f, -1577.5375f, 28.2826f, 51.8183f, true, true, false);
			iVar52[2] = VEHICLE::CREATE_VEHICLE(joaat("patriot"), 48.8282f, -1582.7057f, 28.4603f, 226.8345f, true, true, false);
			...
			PED::ADD_RELATIONSHIP_GROUP("reCriminals", &iLocal_308);
			PED::ADD_RELATIONSHIP_GROUP("reShopKeep", &iLocal_309);
			PED::ADD_RELATIONSHIP_GROUP("reCops", &iLocal_310);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_308, joaat("COP"));
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_310, iLocal_308);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("COP"), iLocal_308);
			...
			PED::SET_PED_RELATIONSHIP_GROUP_HASH((*uParam10)[0], iLocal_308);
			...
			func_120(&uLocal_53, 2, (*uParam10)[0], "REGETRobber2", 0, 1);
			...
			PED::SET_PED_RELATIONSHIP_GROUP_HASH((*uParam10)[1], iLocal_308);
			...
			func_120(&uLocal_53, 1, (*uParam10)[1], "PACKIE", 0, 1);
			iLocal_287 = PED::CREATE_PED(4, Param1.f_2, Var11, fVar14, true, true);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Param1.f_2);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_287, true);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_287, iLocal_309);
			AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_287, "A_M_Y_Business_01_CHINESE_MINI_01");
			func_120(&uLocal_53, 3, iLocal_287, "StoreOwner", 0, 1);
			iLocal_291[0] = PED::CREATE_PED(5, Param1.f_3, 62.8929f, -1575.5201f, 28.6027f, 326.1814f, true, true);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Param1.f_3);
			PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_291[0], 17, true);
			TASK::TASK_COWER(iLocal_291[0], -1);
			iLocal_291[2] = PED::CREATE_PED(5, Param1.f_3, 61.6538f, -1555.2559f, 28.4601f, 206.7004f, true, true);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Param1.f_3);
			PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_291[2], 17, true);
			TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_291[2], "WORLD_HUMAN_MOBILE_FILM_SHOCKING", 0, false);
			iLocal_291[3] = PED::CREATE_PED(4, Param1.f_4, 75.9343f, -1556.3062f, 28.6028f, 147.2908f, true, true);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Param1.f_4);
			PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_291[3], 17, true);
			*iParam0 = 2;
			break;
		
		case 2:
			if (((((!ENTITY::IS_ENTITY_DEAD(iLocal_287, false) && !ENTITY::IS_ENTITY_DEAD(iLocal_291[0], false)) && !ENTITY::IS_ENTITY_DEAD(iLocal_291[2], false)) && !ENTITY::IS_ENTITY_DEAD(iLocal_291[3], false)) && !ENTITY::IS_ENTITY_DEAD((*uParam10)[0], false)) && !ENTITY::IS_ENTITY_DEAD((*uParam10)[1], false))
			{
				if (((((PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(iLocal_287) && PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(iLocal_291[0])) && PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(iLocal_291[2])) && PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(iLocal_291[3])) && PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED((*uParam10)[0])) && PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED((*uParam10)[1]))
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_287))
					{
						TASK::TASK_HANDS_UP(iLocal_287, -1, 0, -1, 0);
		...
		case 3:
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 81.719765f, -1530.8341f, 28.176506f, 26.785257f, -1595.6927f, 58.294434f, 32.875f, false, true, 0))
			{
				if (!iLocal_280)
				{
					if (!PED::IS_PED_INJURED(iLocal_291[0]))
					{
						TASK::TASK_SMART_FLEE_COORD(iLocal_291[0], Local_232, 200f, -1, false, false);
					}
					if (!PED::IS_PED_INJURED(iLocal_291[2]))
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_307);
						TASK::TASK_PAUSE(0, 250);
						TASK::TASK_SMART_FLEE_COORD(0, Local_232, 200f, -1, false, false);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_307);
			...
			if (PED::IS_COP_PED_IN_AREA_3D(Local_232 - Vector(40f, 40f, 40f), Local_232 + Vector(40f, 40f, 40f)) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(Local_232 - Vector(40f, 40f, 40f), Local_232 + Vector(40f, 40f, 40f)))
			{
				if (!PED::IS_PED_INJURED((*uParam10)[0]) && !PED::IS_PED_INJURED((*uParam10)[1]))
				{
					...
					func_171();
					SYSTEM::WAIT(0);
					func_173(&uLocal_53, "REGETAU", "REAWA_POLICE", 4, 0, 0, 0);
					*iParam0 = 20;
				}
			}
			break;
		...
		case 4:
			if (!func_187())
			{
				if ((!PED::IS_PED_INJURED((*uParam10)[0]) && !PED::IS_PED_INJURED((*uParam10)[1])) && !PED::IS_PED_INJURED(iLocal_287))
				{
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_287))
				{
					if (!PED::IS_PED_INJURED(iLocal_287))
					{
						func_173(&uLocal_53, "REGETAU", "REAWA_DOWN", 4, 0, 0, 0);
			...
			if (((PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_COP_PED_IN_AREA_3D(Local_232 - Vector(40f, 40f, 40f), Local_232 + Vector(40f, 40f, 40f))) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(Local_232 - Vector(40f, 40f, 40f), Local_232 + Vector(40f, 40f, 40f)))
			{
				if (!PED::IS_PED_INJURED((*uParam10)[0]) && !PED::IS_PED_INJURED((*uParam10)[1]))
				{
					TASK::TASK_SMART_FLEE_PED((*uParam10)[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
		...
		case 5:
			...
			else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_287, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_287, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) != 0)
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_307);
				TASK::TASK_PLAY_ANIM(0, "random@getawaydriver", "idle_2_hands_up", 4f, -4f, -1, 0, 0.25f, false, false, false);
				TASK::TASK_PLAY_ANIM(0, "random@getawaydriver", "idle_a", 4f, -4f, -1, 1, 0f, false, false, false);
			...
			if (!PED::IS_PED_INJURED(iLocal_288[0]) && !PED::IS_PED_INJURED(iLocal_288[1]))
			{
					...
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
					{
						if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) < 0.1f)
						{
							if (func_130() && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
							{
								...
								if (!PED::IS_PED_INJURED(iLocal_287))
								{
									Local_271 = { ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false) };
									...
									TASK::TASK_AIM_GUN_AT_ENTITY(0, iLocal_287, 1500, false);
									TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Var56, iLocal_287, 3f, false, 0.5f, 4f, true, 0, false, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
									TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000, 2096, 4);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_307);
									TASK::TASK_PERFORM_SEQUENCE(iLocal_288[0], iLocal_307);
									TASK::CLEAR_SEQUENCE_TASK(&iLocal_307);
									TASK::OPEN_SEQUENCE_TASK(&iLocal_307);
									TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000, 2096, 4);
									TASK::TASK_AIM_GUN_AT_ENTITY(0, iLocal_287, 2500, false);
									TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Var59, iLocal_287, 3f, false, 0.5f, 4f, true, 0, false, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
									TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000, 2096, 4);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_307);
									TASK::TASK_PERFORM_SEQUENCE(iLocal_288[1], iLocal_307);
									TASK::CLEAR_SEQUENCE_TASK(&iLocal_307);
							...
							else if (!iLocal_278)
							{
								if (!func_187())
								{
									func_173(&uLocal_53, "REGETAU", "REAWA_CAR", 4, 0, 0, 0);
									TASK::TASK_LOOK_AT_ENTITY(iLocal_288[1], PLAYER::PLAYER_PED_ID(), -1, 2096, 4);
									iLocal_278 = 1;
								}
							}
						}
				...
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), (*uParam10)[1], 10f, 10f, 10f, false, true, 0))
				{
					if (!iLocal_278)
					{
						if (!func_187())
						{
							func_173(&uLocal_53, "REGETAU", "REAWA_NDCAR", 4, 0, 0, 0);
							TASK::TASK_LOOK_AT_ENTITY(iLocal_288[1], PLAYER::PLAYER_PED_ID(), -1, 2096, 4);
							iLocal_278 = 1;
						}
					}
		...
		case 7:
			*iParam11 = 0;
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
			{
				...
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_271, 2f, 2f, 2f, false, true, 0))
					{
						if (!PED::IS_PED_INJURED(iLocal_288[0]) && !PED::IS_PED_INJURED(iLocal_288[1]))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_ON_ANY_BIKE(PLAYER::PLAYER_PED_ID()))
								...
								if (func_130() && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
								{
									...
									if (!PED::IS_PED_INJURED(iLocal_288[0]) && !PED::IS_PED_INJURED(iLocal_288[1]))
									{
										if (!PED::IS_PED_IN_GROUP(iLocal_288[0]) && !PED::IS_PED_IN_GROUP(iLocal_288[1]))
										{
											...
											TASK::TASK_LOOK_AT_ENTITY(iLocal_288[1], PLAYER::PLAYER_PED_ID(), 10000, 2052, 4);
											PED::SET_PED_AS_GROUP_MEMBER(iLocal_288[0], func_74());
											PED::SET_PED_AS_GROUP_MEMBER(iLocal_288[1], func_74());
											PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_288[0], 1);
											PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_288[1], 0);
			...
			if (!PED::IS_PED_INJURED(iLocal_288[0]))
			{
				if (!PED::IS_PED_IN_GROUP(iLocal_288[0]))
				{
					if (!PED::IS_PED_INJURED(iLocal_287))
					{
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
						{
							if ((TASK::GET_SCRIPT_TASK_STATUS(iLocal_288[0], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_288[0], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) != 0) || TASK::GET_SCRIPT_TASK_STATUS(iLocal_288[0], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) == 7)
							{
								PED::SET_PED_AS_GROUP_MEMBER(iLocal_288[0], func_74());
								PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_288[0], true);
							}
				...
				else
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						if ((!PED::IS_PED_GETTING_INTO_A_VEHICLE(iLocal_288[0]) && !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_271, 2f, 2f, 2f, false, true, 0)) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_288[0], ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYERS_LAST_VEHICLE(), true), 2.5f, 2.5f, 2.5f, false, true, 0))
						{
							PED::SET_PED_MIN_MOVE_BLEND_RATIO(iLocal_288[0], 2f);
						}
					}
					if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_288[0], joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")) == 1 || TASK::GET_SCRIPT_TASK_STATUS(iLocal_288[0], joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")) == 0)
					{
					}
				}
			}
			if (!PED::IS_PED_INJURED(iLocal_288[1]))
			{
				if (!PED::IS_PED_IN_GROUP(iLocal_288[1]))
				{
					if (!PED::IS_PED_INJURED(iLocal_287))
					{
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
						{
							if ((TASK::GET_SCRIPT_TASK_STATUS(iLocal_288[1], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_288[1], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) != 0) || TASK::GET_SCRIPT_TASK_STATUS(iLocal_288[1], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) == 7)
							{
								PED::SET_PED_AS_GROUP_MEMBER(iLocal_288[1], func_74());
								PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_288[1], true);
							}
				...
				else
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						if ((!PED::IS_PED_GETTING_INTO_A_VEHICLE(iLocal_288[1]) && !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_271, 2f, 2f, 2f, false, true, 0)) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_288[1], ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYERS_LAST_VEHICLE(), true), 2.5f, 2.5f, 2.5f, false, true, 0))
						{
							PED::SET_PED_MIN_MOVE_BLEND_RATIO(iLocal_288[1], 2f);
						}
					}
					if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_288[1], joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")) == 1 || TASK::GET_SCRIPT_TASK_STATUS(iLocal_288[1], joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")) == 0)
					{
					}
				}
			}
			...
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
			{
				if (func_72(uParam10, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 120f) || bLocal_274)
				{
					if (!PED::IS_PED_INJURED(iLocal_287))
					{
						...
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_307);
						PED::SET_PED_KEEP_TASK(iLocal_287, true);
						ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_287);
					}
					func_71();
					if (!CAM::IS_SPHERE_VISIBLE(7.3162f, -1544.8378f, 28.2558f, 3f))
					{
						iLocal_305 = VEHICLE::CREATE_VEHICLE(joaat("police3"), 7.3162f, -1544.8378f, 28.2558f, 251.9956f, true, true, false);
						iLocal_301[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_305, 6, joaat("S_M_Y_Cop_01"), -1, true, true);
						iLocal_301[1] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_305, 6, joaat("S_M_Y_Cop_01"), 0, true, true);
						WEAPON::GIVE_WEAPON_TO_PED(iLocal_301[0], joaat("WEAPON_PISTOL"), -1, false, true);
						WEAPON::GIVE_WEAPON_TO_PED(iLocal_301[1], joaat("WEAPON_PISTOL"), -1, false, true);
						PED::SET_PED_TARGET_LOSS_RESPONSE(iLocal_301[0], 0);
					}
					if (!CAM::IS_SPHERE_VISIBLE(91.6602f, -1541.8986f, 28.3422f, 3f))
					{
						iLocal_305 = VEHICLE::CREATE_VEHICLE(joaat("police3"), 91.6602f, -1541.8986f, 28.3422f, 127.3064f, true, true, false);
						iLocal_301[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_305, 6, joaat("S_M_Y_Cop_01"), -1, true, true);
						iLocal_301[1] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_305, 6, joaat("S_M_Y_Cop_01"), 0, true, true);
						WEAPON::GIVE_WEAPON_TO_PED(iLocal_301[0], joaat("WEAPON_PISTOL"), -1, false, true);
						WEAPON::GIVE_WEAPON_TO_PED(iLocal_301[1], joaat("WEAPON_PISTOL"), -1, false, true);
					...
					{
						iLocal_305 = VEHICLE::CREATE_VEHICLE(joaat("police3"), 32.8029f, -1594.4001f, 28.4262f, 337.7429f, true, true, false);
						iLocal_301[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_305, 6, joaat("S_M_Y_Cop_01"), -1, true, true);
						iLocal_301[1] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_305, 6, joaat("S_M_Y_Cop_01"), 0, true, true);
						WEAPON::GIVE_WEAPON_TO_PED(iLocal_301[0], joaat("WEAPON_PISTOL"), -1, false, true);
						WEAPON::GIVE_WEAPON_TO_PED(iLocal_301[1], joaat("WEAPON_PISTOL"), -1, false, true);
					...
					if (!bLocal_274)
					{
						func_173(&uLocal_53, "REGETAU", "REAWA_COPS2", 4, 0, 0, 0);
					}
		...
		case 9:
			...
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
			{
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("COP"), iLocal_308);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_308, joaat("COP"));
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
				{
					VEHICLE::SET_VEHICLE_IS_WANTED(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false);
				}
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_305, false))
				{
					ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_305);
				}
				if (!PED::IS_PED_INJURED(iLocal_301[0]))
				{
					ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_301[0]));
				}
				if (!PED::IS_PED_INJURED(iLocal_301[1]))
				{
					ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_301[1]));
				}
				func_69(iLocal_51);
				*iParam0 = 10;
			}
			...
			while (iVar48 < *uParam10)
			{
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false) && !PED::IS_PED_INJURED((*uParam10)[iVar48]))
				{
					...
					{
						if (!HUD::DOES_BLIP_EXIST(uLocal_283[iVar48]))
						{
							uLocal_283[iVar48] = func_66((*uParam10)[iVar48], 0, 145);
							func_69(iLocal_51);
						}
					}
				}
		...
		case 10:
			...
			else
			{
				...
				if (func_63(Var15[iLocal_221 /*3*/], 0f, 0f, 0f, 0))
				{
					iLocal_221 = 0;
				}
				iLocal_51 = func_61(Var15[iLocal_221 /*3*/], 1);
				if (func_121() == 2 && !func_60())
				{
				...
				if (!iLocal_220)
				{
					func_171();
					SYSTEM::WAIT(0);
					func_173(&uLocal_53, "REGETAU", "REAWA_HOM", 4, 0, 0, 0);
					iLocal_220 = 1;
				}
				*iParam0 = 11;
			}
		...
		case 11:
			*iParam11 = 0;
			...
			{
				if (func_56(Var15[iLocal_221 /*3*/]))
				{
					func_173(&uLocal_53, "REGETAU", "REAWA_CULT", 4, 0, 0, 0);
				}
				if (func_54())
				{
					func_171();
					...
					if (func_53())
					{
						func_173(&uLocal_53, "REGETAU", "REAWA_CULT2", 4, 0, 0, 0);
					}
					else
					{
						func_173(&uLocal_53, "REGETAU", "REAWA_CULT3", 4, 0, 0, 0);
					}
				}
				if (!PED::IS_PED_INJURED(iLocal_288[0]) && !PED::IS_PED_INJURED(iLocal_288[1]))
				{
					if ((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var15[iLocal_221 /*3*/], Global_19, true, true, 0) && ENTITY::IS_ENTITY_AT_COORD(iLocal_288[0], Var15[iLocal_221 /*3*/], 20f, 20f, 20f, false, true, 0)) && ENTITY::IS_ENTITY_AT_COORD(iLocal_288[1], Var15[iLocal_221 /*3*/], 20f, 20f, 20f, false, true, 0))
					{
						func_69(iLocal_51);
						iVar48 = 0;
		...
		case 12:
			...
			if (bLocal_276)
			{
				...
				func_171();
				SYSTEM::WAIT(0);
				func_173(&uLocal_53, "REGETAU", "REAWA_COPS3", 4, 0, 0, 0);
				if (!PED::IS_PED_INJURED((*uParam10)[0]))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_307);
		...
		case 13:
			if (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 5f)
			{
				...
				while (iVar48 <= (*uParam10 - 1))
				{
					if (!PED::IS_PED_INJURED((*uParam10)[iVar48]))
					{
						if (TASK::GET_SCRIPT_TASK_STATUS((*uParam10)[iVar48], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) != 1 || TASK::GET_SCRIPT_TASK_STATUS((*uParam10)[iVar48], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) != 0)
						{
							if (!PED::IS_PED_INJURED((*uParam10)[iVar48]))
							{
								iVar0 = 0;
		...
		case 14:
			...
			while (iVar48 < *uParam10)
			{
				if (!PED::IS_PED_INJURED((*uParam10)[0]))
				{
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Var32[iLocal_221 /*3*/], 2f, -1, 0.25f, 0, 40000f);
					TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
					...
					if (iLocal_226 > 0)
					{
						func_173(&uLocal_53, "REGETAU", "REAWA_STOP2", 4, 0, 0, 0);
					}
					else
					{
						func_173(&uLocal_53, "REGETAU", "REAWA_STOP", 4, 0, 0, 0);
					}
					*iParam0 = 15;
				}
				iVar48++;
		...
		case 18:
			iLocal_281 = 1;
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_308, joaat("PLAYER"));
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_308, iLocal_308);
			PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
			PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0f);
			PLAYER::SET_POLICE_IGNORE_PLAYER(PLAYER::PLAYER_ID(), true);
			iVar65 = 0;
			while (iVar65 < iLocal_288)
			{
				if (!PED::IS_PED_INJURED(iLocal_288[iVar65]))
				{
					if (HUD::DOES_BLIP_EXIST(uLocal_283[iVar65]))
					{
						HUD::REMOVE_BLIP(&(uLocal_283[iVar65]));
						if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_288[iVar65], false))
						{
							TASK::TASK_LEAVE_ANY_VEHICLE(iLocal_288[iVar65], 0, 0);
						}
						if (HUD::DOES_BLIP_EXIST(iLocal_51))
						{
							HUD::REMOVE_BLIP(&iLocal_51);
						}
						PED::REMOVE_PED_FROM_GROUP(iLocal_288[iVar65]);
						TASK::TASK_COMBAT_PED(iLocal_288[iVar65], PLAYER::PLAYER_PED_ID(), 0, 16);
						PED::SET_PED_KEEP_TASK(iLocal_288[iVar65], true);
					}
				}
				iVar65++;
			}
			...
			if (!PED::IS_PED_INJURED(iLocal_288[1]))
			{
				func_173(&uLocal_53, "REGETAU", "REAWA_ATTP", 4, 0, 0, 0);
			}
			else if (!PED::IS_PED_INJURED(iLocal_288[0]))
			{
				func_173(&uLocal_53, "REGETAU", "REAWA_ATTB", 4, 0, 0, 0);
			}
			if (!bLocal_277)
			{
				if (!PED::IS_PED_INJURED(iLocal_287))
				{
					PED::SET_PED_CAN_BE_TARGETTED(iLocal_287, false);
					TASK::TASK_PLAY_ANIM(iLocal_287, "random@getawaydriver", "base", 4f, -4f, -1, 1, 0f, false, false, false);
				}
			}
			iVar65 = 0;
			while (iVar65 < iLocal_291)
			{
				if (!PED::IS_PED_INJURED(iLocal_291[iVar65]))
				{
					TASK::TASK_SMART_FLEE_PED(iLocal_291[iVar65], PLAYER::PLAYER_PED_ID(), 150f, -1, false, false);
					PED::SET_PED_KEEP_TASK(iLocal_291[iVar65], true);
				}
				iVar65++;
			}
			*iParam0 = 19;
		...
		case 19:
			...
			while (iVar65 < iLocal_288)
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_288[iVar65]))
				{
					if (!HUD::DOES_BLIP_EXIST(uLocal_283[iVar65]))
					{
						uLocal_283[iVar65] = func_66(iLocal_288[iVar65], 1, 145);
					}
					if (PED::IS_PED_IN_GROUP(iLocal_288[iVar65]))
					{
						PED::REMOVE_PED_FROM_GROUP(iLocal_288[iVar65]);
					}
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_288[iVar65], false))
...
void func_8()//Position - 0x3AFC
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_12(Global_113810.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_10(iVar0) && (!func_9(14) || Global_112760))
			{
...
bool func_9(int iParam0)//Position - 0x3BF9
{
	return Global_43377 == iParam0;
}

bool func_10(int iParam0)//Position - 0x3C07
{
	return iParam0 < 3;
}

int func_11(int iParam0)//Position - 0x3C13
{
	int iVar0;
	int iVar1;
...
int func_12(int iParam0)//Position - 0x3C50
{
	if (func_10(iParam0))
	{
...
var func_13(int iParam0)//Position - 0x3C75
{
	return Global_2058[iParam0 /*29*/];
}

int func_14(int iParam0)//Position - 0x3C84
{
	int iVar0;
	int iVar1;
...
var func_15(int iParam0)//Position - 0x3CC4
{
	return func_16(iParam0);
}

char* func_16(int iParam0)//Position - 0x3CD2
{
	switch (iParam0)
	{
		case 1:
...
int func_17(int iParam0)//Position - 0x3DB5
{
	return Global_96688[iParam0 /*5*/];
}

void func_18(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x3DC5
{
	int iVar0;
	int iVar1;
	...
	func_19(func_52(iParam0), 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
int func_19(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x3E97
{
	float fVar0;
	bool bVar1;
	int iVar2;
...
void func_20(bool bParam0)//Position - 0x4496
{
	int iVar0;
	int iVar1;
...
void func_21(int iParam0)//Position - 0x4718
{
	int iVar0;
...
void func_22(bool bParam0)//Position - 0x4772
{
	bool bVar0;
	char cVar1[64];
...
char* func_23(bool bParam0)//Position - 0x48EC
{
	switch (bParam0)
	{
		case 0:
...
void func_25(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x49FC
{
	int iVar0;
...
int func_26(int iParam0, var uParam1)//Position - 0x4A1F
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_27(uParam1));
}

int func_27(var uParam0)//Position - 0x4A34
{
	int iVar0;
	int iVar1;
...
int func_28()//Position - 0x4A68
{
	return Global_1574918;
}

void func_29(int iParam0, bool bParam1, int iParam2)//Position - 0x4A74
{
	if (iParam2 == -1)
	{
		iParam2 = func_28();
...
void func_30(int iParam0)//Position - 0x4A92
{
	func_50(93, iParam0);
	func_50(29, iParam0);
	func_50(30, iParam0);
...
int func_31(int iParam0)//Position - 0x4AB2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_32(int iParam0, int iParam1)//Position - 0x4C52
{
	int iVar0;
	var uVar1;
...
bool func_33(int iParam0, int iParam1)//Position - 0x4C81
{
	if (iParam1 == -1)
	{
		iParam1 = func_28();
...
int func_34(bool bParam0)//Position - 0x4C9D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_35(int iParam0, int iParam1)//Position - 0x4D54
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_36(int iParam0, int iParam1)//Position - 0x4D6F
{
...
int func_37(var uParam0, int iParam1)//Position - 0x4E0C
{
	int iVar0;
	var uVar1[78];
...
int func_38(var uParam0, int iParam1)//Position - 0x4EBD
{
	int iVar0;
...
bool func_39(var uParam0, int iParam1)//Position - 0x4F38
{
	return (*uParam0)[iParam1] == 78;
}

void func_40(var uParam0)//Position - 0x4F49
{
	int iVar0;
...
void func_41(var uParam0, int iParam1)//Position - 0x4F7D
{
	(*uParam0)[iParam1] = 78;
}

void func_42(var uParam0, float fParam1)//Position - 0x4F8D
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_43(var uParam0)//Position - 0x4FAA
{
	return uParam0->f_80;
}

bool func_44(var uParam0, int iParam1)//Position - 0x4FB6
{
	return func_45(uParam0, iParam1) != -1;
}

int func_45(var uParam0, int iParam1)//Position - 0x4FC8
{
	int iVar0;
...
bool func_46(var uParam0)//Position - 0x4FF5
{
	return uParam0->f_79 == 1;
}

int func_47(int iParam0)//Position - 0x5003
{
	switch (iParam0)
	{
		case 60:
...
int func_48(int iParam0, int iParam1)//Position - 0x5053
{
	int iVar0;
...
void func_49(int iParam0, int iParam1)//Position - 0x50A4
{
	int iVar0;
...
void func_50(int iParam0, int iParam1)//Position - 0x50C7
{
	int iVar0;
...
int func_52(int iParam0)//Position - 0x5199
{
	return Global_2058[iParam0 /*29*/].f_17;
}

int func_53()//Position - 0x51AA
{
...
bool func_55()//Position - 0x5243
{
	return Global_32522;
}

int func_56(struct<3> Param0)//Position - 0x524E
{
	if (func_121() == 2)
	{
		if (func_55() && !Global_32525)
		{
			if (fLocal_50 == -1f)
			{
				fLocal_50 = SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Param0);
			}
			if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Param0) > (fLocal_50 + 200f) || MISC::GET_DISTANCE_BETWEEN_COORDS(-1014.1535f, 4881.411f, 245.00009f, ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), false), true) < 400f)
			{
				Global_32525 = 1;
				return 1;
			}
...
void func_57(var uParam0)//Position - 0x52DB
{
			...
			switch (iLocal_225)
			{
				...
				case 1:
					if (func_129(iLocal_224, 2000))
					{
						if (!func_187())
						{
							func_173(&uLocal_53, "REGETAU", "REAWA_PITCH", 4, 0, 0, 0);
							iLocal_225++;
						}
					}
					break;
				...
				case 2:
					if (!func_187())
					{
						if (func_121() == 0)
						{
							func_173(&uLocal_53, "REGETAU", "REAWA_SUREM", 4, 0, 0, 0);
						}
						if (func_121() == 1)
						{
							func_173(&uLocal_53, "REGETAU", "REAWA_SUREF", 4, 0, 0, 0);
						}
						if (func_121() == 2)
						{
							func_173(&uLocal_53, "REGETAU", "REAWA_SURET", 4, 0, 0, 0);
						}
						iLocal_225++;
					}
					break;
...
void func_58()//Position - 0x53FC
{
	if (func_121() == 2)
	{
		if (!Global_32524)
		{
			func_59("CULT_BLIP_HELP" /* GXT: Trevor can sometimes deliver Random Event passengers to the Altruist Cult, located at ~BLIP_ALTRUIST~ */, -1);
			Global_32524 = 1;
		}
	}
}

void func_59(char* sParam0, int iParam1)//Position - 0x5420
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_60()//Position - 0x5437
{
...
int func_61(struct<3> Param0, bool bParam3)//Position - 0x5453
{
	int iVar0;
...
float func_62(bool bParam0, float fParam1, float fParam2)//Position - 0x547F
{
	if (bParam0)
	{
		return fParam1;
...
bool func_63(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x5496
{
	if (bParam6)
	{
...
int func_64()//Position - 0x54DD
{
	if (func_65())
	{
		if (((((((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_244, 50f, 50f, 50f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_247, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_250, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_253, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_256, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_259, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_262, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_265, 50f, 50f, 50f, false, true, 0))
		{
			if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) < 0.2f)
			{
				return 1;
...
int func_65()//Position - 0x5628
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			if (!PED::IS_PED_INJURED(iLocal_288[0]) && !PED::IS_PED_INJURED(iLocal_288[1]))
			{
				if (PED::IS_PED_IN_VEHICLE(iLocal_288[0], iVar0, false) && PED::IS_PED_IN_VEHICLE(iLocal_288[1], iVar0, false))
				{
					return 1;
				}
			}
...
int func_66(int iParam0, bool bParam1, int iParam2)//Position - 0x5696
{
	int iVar0;
...
int func_67(int iParam0, bool bParam1, bool bParam2)//Position - 0x56E0
{
	int iVar0;
...
void func_68(var uParam0)//Position - 0x5784
{
	if (!PED::IS_PED_INJURED((*uParam0)[0]) && !PED::IS_PED_INJURED((*uParam0)[1]))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY((*uParam0)[0], (*uParam0)[1], 15f, 15f, 15f, false, true, 0) && ENTITY::IS_ENTITY_AT_ENTITY((*uParam0)[0], PLAYER::PLAYER_PED_ID(), 15f, 15f, 15f, false, true, 0))
			...
			switch (iLocal_223)
			{
				...
				case 1:
					if (func_129(iLocal_224, 2000))
					{
						if (!func_187())
						{
							func_173(&uLocal_53, "REGETAU", "REAWA_HOM2", 4, 0, 0, 0);
							iLocal_223++;
						}
					}
					break;
				...
				case 2:
					if (!func_187())
					{
						if (func_121() == 0)
						{
							func_173(&uLocal_53, "REGETAU", "REAWA_HOM4M", 4, 0, 0, 0);
						}
						if (func_121() == 1)
						{
							func_173(&uLocal_53, "REGETAU", "REAWA_HOM4F", 4, 0, 0, 0);
						}
						if (func_121() == 2)
						{
							func_173(&uLocal_53, "REGETAU", "REAWA_HOM4T", 4, 0, 0, 0);
						}
						iLocal_223++;
					}
					break;
...
void func_69(int iParam0)//Position - 0x58A5
{
	...
	while (iVar0 < iLocal_288)
	{
		if (!PED::IS_PED_INJURED(iLocal_288[iVar0]))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
			{
				if (!func_130())
				{
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_288[iVar0], true);
					if (PED::IS_PED_IN_GROUP(iLocal_288[iVar0]))
					{
						PED::REMOVE_PED_FROM_GROUP(iLocal_288[iVar0]);
					}
					if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_288[iVar0], joaat("SCRIPT_TASK_GO_TO_ENTITY")) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_288[iVar0], joaat("SCRIPT_TASK_GO_TO_ENTITY")) != 0)
					{
						TASK::TASK_GO_TO_ENTITY(iLocal_288[iVar0], PLAYER::PLAYER_PED_ID(), -1, 6f, 2f, 2f, 0);
					}
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_288[iVar0], false))
					{
						TASK::TASK_LEAVE_ANY_VEHICLE(iLocal_288[iVar0], 0, 0);
					}
					if (!iLocal_279)
					{
						if (!func_187())
				...
				{
					iLocal_279 = 0;
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_288[iVar0], false);
					if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_288[iVar0], joaat("SCRIPT_TASK_GO_TO_ENTITY")) == 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_288[iVar0], joaat("SCRIPT_TASK_GO_TO_ENTITY")) == 0)
					{
						TASK::CLEAR_PED_TASKS(iLocal_288[iVar0]);
					}
					if (!PED::IS_PED_INJURED(iLocal_288[0]) && !PED::IS_PED_INJURED(iLocal_288[1]))
					{
						PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_288[0], 1);
			...
			else if (!PED::IS_PED_IN_GROUP(iLocal_288[iVar0]))
			{
				TASK::CLEAR_PED_TASKS(iLocal_288[iVar0]);
				PED::SET_PED_AS_GROUP_MEMBER(iLocal_288[iVar0], func_74());
				PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_288[iVar0], true);
				if (!PED::IS_PED_INJURED(iLocal_288[0]) && !PED::IS_PED_INJURED(iLocal_288[1]))
				{
					PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_288[0], 1);
					PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_288[1], 0);
...
int func_72(var uParam0, int iParam1, float fParam2)//Position - 0x5B37
{
	int iVar0;
...
void func_73(var uParam0, float fParam1)//Position - 0x5BA1
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		if (PED::IS_PED_INJURED((*uParam0)[iVar0]))
		{
			if (HUD::DOES_BLIP_EXIST(uLocal_283[iVar0]))
			{
				HUD::REMOVE_BLIP(&(uLocal_283[iVar0]));
			}
		}
		else
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false))
				{
					...
					else if (!HUD::DOES_BLIP_EXIST(uLocal_283[iVar0]))
					{
						uLocal_283[iVar0] = func_66((*uParam0)[iVar0], 0, 145);
					}
				}
			}
			else if (!HUD::DOES_BLIP_EXIST(uLocal_283[iVar0]))
...
int func_74()//Position - 0x5CCC
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_75()//Position - 0x5CDC
{
	int iVar0;
	...
	while (iVar0 < iLocal_288)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_288[iVar0]))
		{
			if (!PED::IS_PED_INJURED(iLocal_288[iVar0]))
			{
				if (!PED::IS_PED_IN_GROUP(iLocal_288[iVar0]))
				{
					...
					{
						if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_288[iVar0], PLAYER::PLAYER_PED_ID()))
						{
							if (!PED::IS_PED_INJURED(iLocal_288[0]) && !PED::IS_PED_INJURED(iLocal_288[1]))
							{
					...
					if (!iLocal_282)
					{
						if (iLocal_227 != -1 && MISC::GET_GAME_TIMER() > iLocal_227 + 1000)
						{
							func_171();
							SYSTEM::WAIT(0);
							func_173(&uLocal_53, "REGETAU", "REAWA_AIM", 4, 0, 0, 0);
							iLocal_282 = 1;
						}
					}
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
					{
						if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_288[iVar0], PLAYER::GET_PLAYERS_LAST_VEHICLE(), true))
						{
							return 1;
						}
					}
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_288[iVar0], PLAYER::PLAYER_PED_ID(), true) && ENTITY::GET_ENTITY_HEALTH(iLocal_288[iVar0]) < 190) || (iLocal_227 != -1 && MISC::GET_GAME_TIMER() > iLocal_227 + 5000))
					{
						return 1;
					}
				}
			...
			else
			{
				...
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_288[iVar0], PLAYER::PLAYER_PED_ID(), true))
				{
					return 1;
				}
			}
...
int func_76(var uParam0, int iParam1)//Position - 0x5EA1
{
	int iVar0;
	...
	if (!iLocal_219)
	{
		...
		while (iVar0 <= (*uParam0 - 1))
		{
			if (!PED::IS_PED_INJURED((*uParam0)[iVar0]))
			{
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 121.8366f, -1503.0063f, 28.0999f, 0.1367f, -1649.7048f, 48.1608f, 125.8125f, false, true, 0) && !ENTITY::IS_ENTITY_OCCLUDED((*uParam0)[iVar0])) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 75.3661f, -1542.8114f, 28.4601f, 43.7035f, -1580.2795f, 33.4259f, 26f, false, true, 0))
				{
					if (!HUD::DOES_BLIP_EXIST(uLocal_283[iVar0]))
					{
						if (!PED::IS_PED_INJURED((*uParam0)[iVar0]))
						{
							if (!func_209())
							{
								func_108(1);
								func_107(1);
								if (!ENTITY::IS_ENTITY_DEAD(iLocal_306, false))
								{
									if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_306, false) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_306, 50f, 50f, 50f, false, true, 0))
									{
										func_79(iLocal_306, 0, 145);
									}
								}
							}
							uLocal_283[iVar0] = func_66((*uParam0)[iVar0], 0, 145);
							HUD::SHOW_HEIGHT_ON_BLIP(uLocal_283[iVar0], false);
							func_69(iLocal_52);
						}
					}
					if (!func_187())
					{
						...
						{
							func_173(&uLocal_53, "REGETAU", "REAWA_SHOUT", 4, 0, 0, 0);
					...
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 75.3661f, -1542.8114f, 28.4601f, 43.7035f, -1580.2795f, 33.4259f, 26f, false, true, 0))
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(iParam1, false))
						{
							if (!func_187())
							{
								if (func_130() && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
								{
									func_173(&uLocal_53, "REGETAU", "REAWA_START", 4, 0, 0, 0);
									iLocal_219 = 1;
								}
								else
								{
									func_173(&uLocal_53, "REGETAU", "REAWA_START2", 4, 0, 0, 0);
									iLocal_219 = 1;
								}
								...
								if (!PED::IS_PED_INJURED((*uParam0)[1]) && !PED::IS_PED_INJURED(iLocal_287))
								{
									...
									TASK::TASK_AIM_GUN_AT_ENTITY(0, iLocal_287, -1, false);
...
void func_77()//Position - 0x6181
{
	Global_20711 = 0;
	func_78();
}

void func_78()//Position - 0x6191
{
...
int func_79(int iParam0, int iParam1, int iParam2)//Position - 0x61E8
{
	var uVar0;
	char* sVar1;
...
void func_80(int iParam0, int iParam1)//Position - 0x6228
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_81(iParam0, &(Global_113810.f_32752.f_5510));
}

void func_81(int iParam0, var uParam1)//Position - 0x642A
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_82(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_82(int iParam0)//Position - 0x66D5
{
	switch (iParam0)
	{
		case 1:
...
int func_83(int iParam0, var uParam1, var uParam2)//Position - 0x6785
{
	int iVar0;
	int iVar1;
...
int func_84(int iParam0)//Position - 0x6978
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_85(var uParam0)//Position - 0x6998
{
	int iVar0;
...
int func_86(int iParam0)//Position - 0x6A49
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_105(iParam0, 0, 0)) || func_105(iParam0, 1, 0)) || func_105(iParam0, 2, 0)) || func_104(iParam0) != 145) || func_103(iParam0)) || func_102(iParam0)) || func_101(iParam0)) || func_100(iParam0)) || !func_87(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_102(iParam0))
		{
		}
...
int func_87(int iParam0)//Position - 0x6B26
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_88(int iParam0, bool bParam1, int iParam2)//Position - 0x6CD8
{
	int iVar0;
	struct<2> Var1;
...
int func_89(int iParam0)//Position - 0x6E5A
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_91(int iParam0, int iParam1)//Position - 0x6F3D
{
	int iVar0;
	int iVar1;
...
int func_92(bool bParam0)//Position - 0xC118
{
	if (bParam0)
	{
...
bool func_93()//Position - 0xC132
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_94()//Position - 0xC148
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_95()//Position - 0xC15E
{
	return 0;
}

int func_96()//Position - 0xC167
{
	return 1;
}

int func_97()//Position - 0xC170
{
	return 1;
}

int func_98()//Position - 0xC179
{
...
int func_100(int iParam0)//Position - 0xC24A
{
	int iVar0;
	char* sVar1;
...
int func_101(int iParam0)//Position - 0xC291
{
	int iVar0;
...
int func_102(int iParam0)//Position - 0xC2CC
{
	int iVar0;
...
int func_103(int iParam0)//Position - 0xC348
{
	int iVar0;
...
int func_104(int iParam0)//Position - 0xC430
{
	int iVar0;
...
int func_105(int iParam0, int iParam1, bool bParam2)//Position - 0xC493
{
	int iVar0;
	char* sVar1;
	int iVar9;
	...
	iVar0 = 0;
	while (func_106(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_106(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0xC501
{
...
void func_107(bool bParam0)//Position - 0xC5DA
{
	if (bParam0)
	{
...
int func_108(int iParam0)//Position - 0xC606
{
	if (func_112())
	{
		Global_113800 = 1;
		Global_113797 = MISC::GET_GAME_TIMER();
		if (func_111(Global_113799))
		{
			func_109(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /* GXT: Random Event */);
		if (iParam0 && func_111(Global_113799))
		{
...
void func_109(int iParam0)//Position - 0xC659
{
	switch (iParam0)
	{
		case 0:
...
char* func_110(int iParam0)//Position - 0xC734
{
	char* sVar0;
...
int func_111(int iParam0)//Position - 0xC778
{
	switch (iParam0)
	{
		case 29:
...
int func_112()//Position - 0xC7A7
{
	switch (func_113(&Global_32343, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_113(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xC7DD
{
	int iVar0;
...
void func_114(var uParam0, int iParam1)//Position - 0xC914
{
	int iVar0;
...
bool func_115(int iParam0)//Position - 0xC963
{
	return func_116(iParam0, Global_43377);
}

int func_116(int iParam0, int iParam1)//Position - 0xC974
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_117(int iParam0)//Position - 0xCB55
{
	if (Global_43377 == 15)
	{
		return 0;
...
void func_118(int iParam0, char* sParam1, int iParam2)//Position - 0xCB77
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iParam0, sParam1, func_119(iParam2), 1);
}

int func_119(int iParam0)//Position - 0xCB8E
{
	int iVar0;
...
void func_120(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCD83
{
...
int func_121()//Position - 0xCE1E
{
	func_8();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_122(int iParam0, bool bParam1)//Position - 0xCE37
{
	if (bParam1)
	{
	...
	else if (func_127(iParam0, 2, 1))
	{
		func_123(iParam0, 2, 1);
	}
}

void func_123(int iParam0, int iParam1, bool bParam2)//Position - 0xCE6E
{
	int iVar0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_125() == 0)
		{
			iVar0 = func_32(func_124(iParam0), -1);
			MISC::CLEAR_BIT(&iVar0, iParam1);
			func_25(func_124(iParam0), iVar0, -1, 1);
		}
	}
	else
	{
...
int func_124(int iParam0)//Position - 0xCEDE
{
	switch (iParam0)
	{
		case 0:
...
int func_125()//Position - 0xD286
{
	return Global_32283;
}

void func_126(int iParam0, int iParam1, bool bParam2)//Position - 0xD291
{
	int iVar0;
...
int func_127(int iParam0, int iParam1, bool bParam2)//Position - 0xD301
{
	if (iParam0 == -1)
	{
		return 0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_125() == 0)
		{
			return BitTest(func_32(func_124(iParam0), -1), iParam1);
		}
	}
	else
	{
...
int func_128(struct<3> Param0, float fParam3, int iParam4)//Position - 0xD361
{
...
int func_129(int iParam0, int iParam1)//Position - 0xD39F
{
	int iVar0;
	int iVar1;
...
void func_131(bool bParam0)//Position - 0xD4F8
{
	if (bParam0)
	{
	}
...
int func_132(int iParam0)//Position - 0xD505
{
...
int func_133(int iParam0)//Position - 0xD522
{
	switch (iParam0)
	{
		case 0:
...
int func_134(int iParam0)//Position - 0xD594
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_143()) || Global_112857) || Global_32286) || func_142()) || func_141(8, -1)) || func_140()) || func_139()) || func_138()) || func_137()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_143()) || Global_32286) || func_142()) || func_141(8, -1)) || func_138()) || func_140()) || func_139()) || func_137()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_143()) || Global_112857) || Global_32286) || func_142()) || func_141(8, -1)) || func_138()) || func_140()) || func_139()) || func_137()) || Global_113810.f_7691.f_919[iVar0] == 5) || Global_43924 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_143()) || Global_112857) || Global_32286) || func_142()) || func_141(8, -1)) || func_140()) || func_139()) || func_137()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_143() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_141(8, -1)) || func_137()) || func_136()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_143()) || Global_32286) || func_142()) || func_141(8, -1)) || func_139()) || func_138()) || func_137()) || Global_113810.f_7691.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_135()//Position - 0xDCB1
{
	return Global_100872.f_1;
}

int func_136()//Position - 0xDCBF
{
	if (Global_97735 != -1)
	{
...
bool func_139()//Position - 0xDD26
{
	return Global_100885.f_394 > 0;
}

bool func_140()//Position - 0xDD37
{
	return Global_100885.f_393 > 0;
}

bool func_141(int iParam0, int iParam1)//Position - 0xDD48
{
	switch (iParam0)
	{
		case 5:
...
var func_142()//Position - 0xDD80
{
	return Global_1575063;
}

int func_143()//Position - 0xDD8C
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_144(int iParam0, struct<7> Param1, var uParam8, var uParam9)//Position - 0xDDA8
{
	if (iParam0 == 1)
	{
		func_154(&uLocal_312, Param1.f_0);
		func_154(&uLocal_312, Param1.f_1);
		func_154(&uLocal_312, Param1.f_2);
		func_154(&uLocal_312, Param1.f_3);
		func_154(&uLocal_312, Param1.f_4);
		func_154(&uLocal_312, Param1.f_5);
		func_154(&uLocal_312, Param1.f_6);
	...
	{
		func_145(&uLocal_312, 0);
	}
	return 0;
}

void func_145(var uParam0, bool bParam1)//Position - 0xDE1B
{
	int iVar0;
...
void func_146(var uParam0)//Position - 0xDE56
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
...
void func_147(var uParam0)//Position - 0xDE6F
{
	int iVar0;
...
void func_148(var uParam0)//Position - 0xDEA5
{
	func_149(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

void func_149(int iParam0, char* sParam1, int iParam2)//Position - 0xDEBC
{
...
int func_150(var uParam0)//Position - 0xDF76
{
	bool bVar0;
...
int func_151(var uParam0)//Position - 0xDF9F
{
	int iVar0;
...
bool func_152(var uParam0)//Position - 0xDFFB
{
	return func_153(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

int func_153(char* sParam0, char* sParam1, int iParam2)//Position - 0xE012
{
	if (BitTest(sParam0, 30))
	{
		if (BitTest(sParam0, 29))
		{
			switch (func_150(sParam0))
			{
				case 0:
...
void func_154(var uParam0, int iParam1)//Position - 0xE0FD
{
	func_155(uParam0, 0, iParam1, "NULL", 0);
}

void func_155(var uParam0, bool bParam1, int iParam2, char* sParam3, int iParam4)//Position - 0xE111
{
	int iVar0;
...
int func_156()//Position - 0xE1F0
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_47) < (75f * 75f))
		{
			return 1;
		}
...
int func_157(float fParam0, bool bParam1)//Position - 0xE276
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_158(int iParam0, var uParam1)//Position - 0xE327
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_159(uParam1, "Barry3A", func_161(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_160(iParam0), 0, 1);
			break;
		...
		case 8:
			func_159(uParam1, "Dreyfuss1", func_161(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_160(iParam0), 0, 0);
			break;
		...
		case 38:
			func_159(uParam1, "Nigel1A", func_161(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_160(iParam0), 1, 1);
			break;
		...
		case 49:
			func_159(uParam1, "Paparazzo3A", func_161(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_160(iParam0), 0, 1);
			break;
		...
		case 58:
			func_159(uParam1, "Tonya1", func_161(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_160(iParam0), 0, 1);
			break;
...
int func_160(int iParam0)//Position - 0xF5FF
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_161(int iParam0)//Position - 0xF945
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_162(int iParam0)//Position - 0xF97D
{
	struct<2> Var0;
...
bool func_164()//Position - 0xFDFC
{
	return Global_113528 > 0;
}

int func_165()//Position - 0xFE0A
{
	if (Global_97735 != -1)
	{
		return 1;
...
void func_168(int iParam0)//Position - 0xFE5F
{
	Global_113796 = iParam0;
}

void func_169()//Position - 0xFE6D
{
	if (!bLocal_276)
	{
		PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(func_188(PLAYER::PLAYER_ID()) - Vector(0f, 10f, 0f), MISC::GET_RANDOM_INT_IN_RANGE(5, 15), &Local_241, 1, 3f, 0f);
		if (!CAM::IS_SPHERE_VISIBLE(Local_241, 10f))
		{
			Local_235 = { Local_241 };
			bLocal_275 = true;
		}
		else
		{
			...
			if (bLocal_275)
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_297[0]))
				{
					iLocal_297[0] = PED::CREATE_PED(6, joaat("S_M_Y_Cop_01"), Local_235 + Vector(0f, 5f, 0f), 0f, true, true);
					if (func_64())
					{
						WEAPON::GIVE_WEAPON_TO_PED(iLocal_297[0], joaat("WEAPON_PISTOL"), -1, true, true);
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_297[0], iLocal_310);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_297[0], true);
						TASK::TASK_COMBAT_HATED_TARGETS_AROUND_PED(iLocal_297[0], 50f, 0);
						PED::SET_PED_KEEP_TASK(iLocal_297[0], true);
					}
					else
					{
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_297[0], true);
						...
						TASK::CLOSE_SEQUENCE_TASK(iLocal_307);
						TASK::TASK_PERFORM_SEQUENCE(iLocal_297[0], iLocal_307);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_307);
						PED::SET_PED_KEEP_TASK(iLocal_297[0], true);
						func_120(&uLocal_53, 4, iLocal_297[0], "REGETCop", 0, 1);
					}
				}
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_297[1]))
				{
					iLocal_297[1] = PED::CREATE_PED(6, joaat("S_M_Y_Cop_01"), Local_235 - Vector(0f, 5f, 0f), 0f, true, true);
					if (func_64())
					{
						WEAPON::GIVE_WEAPON_TO_PED(iLocal_297[0], joaat("WEAPON_PISTOL"), -1, false, true);
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_297[1], iLocal_310);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_297[1], true);
						TASK::TASK_COMBAT_HATED_TARGETS_AROUND_PED(iLocal_297[1], 50f, 0);
						PED::SET_PED_KEEP_TASK(iLocal_297[1], true);
					}
					else
					{
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_297[1], true);
						TASK::TASK_GO_TO_COORD_ANY_MEANS(iLocal_297[1], 68.7217f, -1569.8304f, 28.6027f, 3f, 0, false, 786603, -1f);
						PED::SET_PED_KEEP_TASK(iLocal_297[1], true);
					}
				}
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_304))
				{
					iLocal_304 = VEHICLE::CREATE_VEHICLE(joaat("police3"), Local_235, 0f, true, true, false);
					Local_238 = { func_188(PLAYER::PLAYER_ID()) - ENTITY::GET_ENTITY_COORDS(iLocal_304, true) };
					ENTITY::SET_ENTITY_HEADING(iLocal_304, MISC::GET_HEADING_FROM_VECTOR_2D(Local_238.f_0, Local_238.f_1));
					VEHICLE::SET_VEHICLE_SIREN(iLocal_304, true);
				}
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_297[2]))
				{
					iLocal_297[2] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_304, 6, joaat("S_M_Y_Cop_01"), -1, true, true);
					if (func_64())
					{
						WEAPON::GIVE_WEAPON_TO_PED(iLocal_297[2], joaat("WEAPON_PISTOL"), -1, true, true);
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_297[2], iLocal_310);
						PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_297[2], 1, true);
						PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_297[2], 3, false);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_297[2], true);
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_297[2], iLocal_304, iLocal_288[1], 6, 15f, 2, -1f, -1f, true);
						PED::SET_PED_KEEP_TASK(iLocal_297[2], true);
					}
					else
					{
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_297[2], true);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_307);
						TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_304, 40.2328f, -1555.7529f, 28.2128f, 10f, 0, joaat("police"), 786469, 1f, -1f);
						TASK::TASK_STAND_STILL(0, 5000);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_307);
						TASK::TASK_PERFORM_SEQUENCE(iLocal_297[2], iLocal_307);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_307);
						PED::SET_PED_KEEP_TASK(iLocal_297[2], true);
					}
				}
...
int func_170(var uParam0, int iParam1, float fParam2)//Position - 0x10213
{
	int iVar0;
...
void func_171()//Position - 0x102AE
{
	Global_20711 = 0;
	func_172();
}

void func_172()//Position - 0x102BE
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22856 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_173(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x102DF
{
...
int func_174(char* sParam0, int iParam1, bool bParam2)//Position - 0x1032D
{
	Global_21846 = 0;
...
void func_175()//Position - 0x105FB
{
	if (!func_176())
	{
		return;
...
bool func_177(int iParam0)//Position - 0x10695
{
	return func_178(iParam0, 20);
}

var func_178(int iParam0, int iParam1)//Position - 0x106A5
{
	return BitTest(Global_1895156[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_179()//Position - 0x106BD
{
	return -1;
}

void func_180()//Position - 0x106C6
{
	int iVar0;
...
void func_181()//Position - 0x106F8
{
...
void func_184()//Position - 0x1084D
{
	if (func_9(14))
	{
...
void func_185()//Position - 0x108EF
{
	int iVar0;
...
void func_186(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x10947
{
...
Vector3 func_188(int iParam0)//Position - 0x109BF
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_189()//Position - 0x109D2
{
	func_190();
}

int func_190()//Position - 0x109DF
{
	if (func_191(0))
	{
		return 0;
...
int func_191(bool bParam0)//Position - 0x10A2A
{
...
void func_192(int iParam0, int iParam1)//Position - 0x10A52
{
	if (iParam0 == -1)
	{
		iParam0 = func_199();
	...
	if (iParam1 <= func_198(iParam0))
	{
		...
		{
			func_193(func_195(iParam0, iParam1), Local_47.f_0, Local_47.f_1);
		}
...
void func_193(int iParam0, var uParam1, var uParam2)//Position - 0x10B56
{
	bool bVar0;
...
void func_194()//Position - 0x10C3C
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	{
		func_48(13, SYSTEM::FLOOR(Global_113810.f_10197.f_3853));
	}
	if (!DATAFILE::DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_78689)
		{
			if (func_125() == 2 == 0 && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
...
int func_195(int iParam0, int iParam1)//Position - 0x110FA
{
	switch (iParam0)
	{
		case 0:
...
void func_196(int iParam0)//Position - 0x1146E
{
	int iVar0;
	int iVar1;
...
void func_197(int iParam0, int iParam1)//Position - 0x114B0
{
	MISC::SET_BIT(&(Global_113810.f_24998.f_8[iParam0]), iParam1);
}

int func_198(int iParam0)//Position - 0x114CB
{
	int iVar0;
...
int func_200(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x11599
{
...
void func_201(int iParam0, bool bParam1)//Position - 0x11773
{
	int iVar0;
...
void func_202(char* sParam0)//Position - 0x117BC
{
...
char* func_203(int iParam0)//Position - 0x117E1
{
	switch (iParam0)
	{
		case 0:
...
int func_204(int iParam0)//Position - 0x118C4
{
...
int func_205()//Position - 0x118F0
{
	return 1;
}

int func_206()//Position - 0x118F9
{
	if (Global_32523)
	{
		func_168(4);
...
int func_207(int iParam0)//Position - 0x11911
{
	return func_127(iParam0, 5, 1);
}

int func_208()//Position - 0x11921
{
	if (!func_115(5))
	{
		return 1;
...
int func_209()//Position - 0x11983
{
	if ((Global_113799 == func_199() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_113800)
	{
		return 1;
	}
	return 0;
...
void func_210(var uParam0)//Position - 0x119AE
{
	int iVar0;
...
void func_211(int* iParam0)//Position - 0x11A2C
{
	func_212(iParam0, &(iParam0->f_2), iParam0->f_1);
}

void func_212(int* iParam0, char* sParam1, int iParam2)//Position - 0x11A42
{
	if (BitTest(*iParam0, 30))
	{
		switch (func_150(*iParam0))
...
void func_213(int iParam0)//Position - 0x11B13
{
	if (iParam0 == -1)
	{
		iParam0 = func_199();
...
void func_214()//Position - 0x11B49
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_215(int iParam0)//Position - 0x11B86
{
	Global_113799 = iParam0;
}

int func_216(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x11B94
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (func_10(func_121()))
		{
			if (func_244(func_121()) == 4 || func_244(func_121()) == 5)
			{
				return 0;
			}
		}
		if (func_10(func_121()))
		{
			if (!func_243(iParam3, bParam4, 145))
			{
				return 0;
			}
		}
		if (!func_242(Global_113810.f_24998.f_43[iParam3]))
		{
			return 0;
		}
...
bool func_217(int iParam0)//Position - 0x11F2E
{
	int iVar0;
...
int func_218(int iParam0)//Position - 0x11F4F
{
	return func_219(iParam0, 1);
}

int func_219(int iParam0, int iParam1)//Position - 0x11F5E
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_220(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x11FB1
{
	func_221(func_232(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_221(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x11FCF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_222(float fParam0, float fParam1, float fParam2)//Position - 0x121D0
{
	float fVar0;
...
int func_223(int iParam0, int iParam1)//Position - 0x12212
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_224(int iParam0)//Position - 0x122B4
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_225(int iParam0)//Position - 0x122C7
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_226(int iParam0)//Position - 0x122DA
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_227(int iParam0)//Position - 0x122ED
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_228(int iParam0)//Position - 0x122FF
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_229(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_229(bool bParam0, int iParam1, int iParam2)//Position - 0x12321
{
	if (bParam0)
	{
		return iParam1;
...
int func_230(int iParam0)//Position - 0x12338
{
	return iParam0 & 15;
}

int func_231(int iParam0, int iParam1)//Position - 0x12345
{
	int iVar0;
	int iVar1;
...
void func_233(var uParam0, int iParam1)//Position - 0x12497
{
	if (iParam1 <= 0)
	{
		return;
...
void func_234(var uParam0, int iParam1)//Position - 0x1251D
{
...
void func_235(var uParam0, int iParam1)//Position - 0x12550
{
	int iVar0;
	int iVar1;
...
void func_236(var uParam0, int iParam1)//Position - 0x125A1
{
...
void func_237(var uParam0, int iParam1)//Position - 0x125DB
{
...
void func_238(var uParam0, int iParam1)//Position - 0x12616
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_239(int iParam0)//Position - 0x12652
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_240(int iParam0, bool bParam1)//Position - 0x1272E
{
...
bool func_242(int iParam0)//Position - 0x12776
{
	return func_231(func_232(), iParam0);
}

int func_243(int iParam0, int iParam1, int iParam2)//Position - 0x12788
{
	int iVar0;
	int iVar1;
...
int func_244(int iParam0)//Position - 0x1286C
{
	if (!func_10(iParam0))
	{
		return 7;
...
int func_245(int iParam0)//Position - 0x12890
{
	int iVar0;
	int iVar1;
...
void func_247(var uParam0, int iParam1)//Position - 0x1292C
{
	if (iParam1 > 0)
	{
...
void func_248(struct<9> Param0, int iParam9, bool bParam10)//Position - 0x12943
{
	int iVar0;
	...
	if (iLocal_311)
	{
		...
		func_260();
		func_107(0);
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_232 - Vector(20f, 20f, 20f), Local_232 + Vector(20f, 20f, 20f), true, true);
		PED::REMOVE_SCENARIO_BLOCKING_AREAS();
		PATHFIND::SET_PED_PATHS_BACK_TO_ORIGINAL(Local_232 - Vector(20f, 20f, 20f), Local_232 + Vector(20f, 20f, 20f), 0);
		PATHFIND::SET_ROADS_BACK_TO_ORIGINAL(Local_232 - Vector(20f, 20f, 20f), Local_232 + Vector(20f, 20f, 20f), 1);
		...
		if (!PED::IS_PED_INJURED(iLocal_287))
		{
			...
			TASK::CLEAR_PED_SECONDARY_TASK(iLocal_287);
			PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_287, 17, true);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_287, false);
		}
		if (!PED::IS_PED_INJURED((*iParam9)[0]))
		{
		...
		{
			if (!PED::IS_PED_INJURED(iLocal_291[iVar0]))
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_291[iVar0], false);
			}
			iVar0++;
		}
		if (!PED::IS_PED_INJURED(iLocal_297[0]))
		...
		if (!PED::IS_PED_INJURED(iLocal_297[1]))
		{
			WEAPON::GIVE_WEAPON_TO_PED(iLocal_297[1], joaat("WEAPON_PISTOL"), -1, false, true);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_297[1], false);
		}
		if (!PED::IS_PED_INJURED(iLocal_297[2]))
		{
			WEAPON::GIVE_WEAPON_TO_PED(iLocal_297[2], joaat("WEAPON_PISTOL"), -1, false, true);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_297[2], false);
		}
		if (!bParam10)
		{
			if (!PED::IS_PED_INJURED((*iParam9)[0]))
			{
				TASK::TASK_SMART_FLEE_COORD((*iParam9)[0], func_188(PLAYER::PLAYER_ID()), 200f, -1, false, false);
			}
			if (!PED::IS_PED_INJURED((*iParam9)[1]))
			{
				TASK::TASK_SMART_FLEE_COORD((*iParam9)[1], func_188(PLAYER::PLAYER_ID()), 200f, -1, false, false);
			}
		}
		if (!iLocal_218)
		{
...
void func_249(int iParam0)//Position - 0x12CB7
{
	char cVar0[64];
	...
	if (func_209())
	{
		...
		func_252(30000);
		StringCopy(&cVar0, func_251(Global_113799, 1), 64);
		if (func_198(Global_113799) > 0)
		{
	...
	func_250(&Global_32343);
	Global_113800 = 0;
	func_215(-1);
}

void func_250(var uParam0)//Position - 0x12D69
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_251(int iParam0, bool bParam1)//Position - 0x12DA6
{
	switch (iParam0)
	{
		case 0:
...
void func_252(int iParam0)//Position - 0x12FEF
{
	Global_43928 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_253(int iParam0)//Position - 0x13001
{
	func_254(iParam0, 0, func_259(iParam0));
}

void func_254(int iParam0, int iParam1, int iParam2)//Position - 0x13016
{
	var uVar0;
	struct<16> Var1;
	
	uVar0 = func_232();
	func_257(&uVar0, 0, 0, iParam2, iParam1, 0, 0);
	func_256(iParam0, &uVar0);
	Var1 = { func_255(&uVar0) };
}

struct<16> func_255(var uParam0)//Position - 0x13045
{
	struct<16> Var0;
	int iVar16;
...
void func_256(int iParam0, var uParam1)//Position - 0x13116
{
	Global_113810.f_24998.f_43[iParam0] = *uParam1;
}

void func_257(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1312E
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = (iVar0 + iParam6);
	func_258(uParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}

void func_258(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x132B0
{
...
int func_259(int iParam0)//Position - 0x132E8
{
	int iVar0;
...
void func_260()//Position - 0x1348B
{
	Global_32522 = 0;
	Global_32523 = 0;
	Global_32525 = 0;
...
void func_261(bool bParam0)//Position - 0x134A7
{
	int iVar0;
