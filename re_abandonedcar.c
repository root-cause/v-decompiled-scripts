...
void __EntryFunction__()//Position - 0x0
{
	...
	Local_277 = { 1435.77f, 2983.11f, 40.77f };
	Local_280 = { 2162.5518f, 2122.646f, 124.7956f };
	Local_54 = { ScriptParam_0.f_1[0 /*3*/] };
	func_323();
	if (CLOCK::GET_CLOCK_HOURS() > 7 && CLOCK::GET_CLOCK_HOURS() < 19)
	{
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	if (func_297(Local_54, 23, bLocal_283, 0, 0))
	{
		func_295(-1);
	}
	else
	...
	{
		SYSTEM::WAIT(0);
		if ((BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() && !PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || iLocal_259)
		{
			if (!func_238())
			{
				if (func_237())
			...
			switch (iLocal_49)
			{
				...
				case 1:
					...
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_250, false))
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_250, false))
						{
							func_221();
						}
					}
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_251, false))
					{
					...
					if (!iLocal_259)
					{
						...
						{
							if (func_206(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_252, true), 1) < IntToFloat(iLocal_272) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_252))
							{
								if (!iLocal_266)
								{
									func_204();
									...
									if (iLocal_50 == 1)
									{
										if (func_203() == 0)
										{
											func_188(&uLocal_82, "re_acau", "re_ac_approM", 4, 0, 0, 0);
										}
										else if (func_203() == 1)
										{
											func_188(&uLocal_82, "re_acau", "re_ac_approF", 4, 0, 0, 0);
										}
										else if (func_203() == 2)
										{
											func_188(&uLocal_82, "re_acau", "re_ac_approT", 4, 0, 0, 0);
										}
									}
									else if (iLocal_50 == 2)
									{
										if (func_203() == 0)
										{
											func_188(&uLocal_82, "reac2au", "reac2_approM", 4, 0, 0, 0);
										}
										else if (func_203() == 1)
										{
											func_188(&uLocal_82, "reac2au", "reac2_approF", 4, 0, 0, 0);
										}
										else if (func_203() == 2)
										{
											func_188(&uLocal_82, "reac2au", "reac2_approT", 4, 0, 0, 0);
										}
									}
									if (HUD::DOES_BLIP_EXIST(iLocal_249))
									{
										HUD::SHOW_HEIGHT_ON_BLIP(iLocal_249, true);
									}
									iLocal_266 = 1;
								}
							}
					...
					else
					{
						...
						if (!iLocal_261)
						{
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_252, false))
							{
								if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_252, false))
								{
									if (!PED::IS_PED_INJURED(iLocal_250))
									{
										TASK::OPEN_SEQUENCE_TASK(&iLocal_269);
										TASK::TASK_ENTER_VEHICLE(0, iLocal_252, -1, -1, 2f, 524296, 0, 0);
										TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
										TASK::CLOSE_SEQUENCE_TASK(iLocal_269);
										TASK::TASK_PERFORM_SEQUENCE(iLocal_250, iLocal_269);
										TASK::CLEAR_SEQUENCE_TASK(&iLocal_269);
										PED::SET_PED_KEEP_TASK(iLocal_250, true);
									}
									iLocal_261 = 1;
								}
							}
...
void func_2()//Position - 0x392
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_250, false))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_250, 10f, 10f, 10f, false, true, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if ((SYSTEM::TIMERB() > 3000 && iLocal_270 == 0) && !func_3())
			{
				func_188(&uLocal_82, "re_acau", "re_ac_attac2", 4, 0, 0, 0);
				TASK::TASK_LOOK_AT_ENTITY(iLocal_250, PLAYER::PLAYER_PED_ID(), 4000, 0, 2);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_79, joaat("PLAYER"));
				SYSTEM::SETTIMERB(0);
				iLocal_270++;
			}
			if ((SYSTEM::TIMERB() > 4000 && iLocal_270 == 1) && !func_3())
			{
				func_188(&uLocal_82, "re_acau", "re_ac_attac1", 4, 0, 0, 0);
				TASK::TASK_LOOK_AT_ENTITY(iLocal_250, PLAYER::PLAYER_PED_ID(), 4000, 0, 2);
				SYSTEM::SETTIMERB(0);
				iLocal_270++;
			}
			if ((SYSTEM::TIMERB() > 3000 && iLocal_270 == 2) && !func_3())
			{
				func_188(&uLocal_82, "re_acau", "re_ac_attac2", 4, 0, 0, 0);
				TASK::TASK_LOOK_AT_ENTITY(iLocal_250, PLAYER::PLAYER_PED_ID(), 4000, 0, 2);
				SYSTEM::SETTIMERB(0);
		...
		if (!PED::IS_PED_INJURED(iLocal_250))
		{
			if (!iLocal_262)
			{
				if (PED::IS_PED_BEING_STUNNED(PLAYER::PLAYER_PED_ID(), 0))
				{
					iLocal_262 = 1;
					iLocal_273++;
					func_188(&uLocal_82, "re_acau", "re_ac_rambl", 4, 0, 0, 0);
					SYSTEM::SETTIMERA(0);
				}
			}
			else if (SYSTEM::TIMERA() > 4000)
			{
				if (!PED::IS_PED_INJURED(iLocal_250))
				{
					TASK::TASK_COMBAT_PED(iLocal_250, PLAYER::PLAYER_PED_ID(), 0, 16);
					PED::SET_PED_KEEP_TASK(iLocal_250, true);
				}
			...
			if (!PED::IS_PED_INJURED(iLocal_250))
			{
				if ((iLocal_273 >= 1 && PED::IS_PED_BEING_STUNNED(PLAYER::PLAYER_PED_ID(), 0)) && iLocal_262)
				{
					TASK::TASK_PLAY_ANIM(iLocal_250, "amb@world_human_guard_patrol@male@idle_b", "idle_e", 2f, -2f, -1, 0, 0f, false, false, false);
		...
		switch (iLocal_276)
		{
			...
			case 1:
				if (!PED::IS_PED_INJURED(iLocal_250))
				{
					...
					{
						ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_250);
					}
					iLocal_276++;
				}
				else
			...
			case 2:
				...
				iLocal_253 = VEHICLE::CREATE_MISSION_TRAIN(0, 1063.5955f, 3227.5706f, 39.3899f, true, 0, 0);
				iVar0 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_253, 26, iLocal_256, -1, true, true);
				iVar0 = iVar0;
				if (!iLocal_264)
				{
					if (AUDIO::REQUEST_SCRIPT_AUDIO_BANK("Train_Horn", false, -1))
					{
						AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "Warning_Once", iLocal_253, "TRAIN_HORN", false, 0);
					}
				}
			...
			case 4:
				...
				if (SYSTEM::TIMERA() > 2000 && SYSTEM::TIMERA() < 3000)
				{
					if (func_203() == 0)
					{
						func_188(&uLocal_82, "re_acau", "re_ac_awakeM", 4, 0, 0, 0);
					}
					else if (func_203() == 1)
					{
						func_188(&uLocal_82, "re_acau", "re_ac_awakeF", 4, 0, 0, 0);
					}
					else if (func_203() == 2)
					{
						func_188(&uLocal_82, "re_acau", "re_ac_awakeT", 4, 0, 0, 0);
					}
				}
...
int func_7(bool bParam0)//Position - 0xA71
{
...
void func_12(int iParam0, bool bParam1, int iParam2)//Position - 0x1099
{
	if (iParam2 == -1)
	{
		iParam2 = func_13();
...
void func_15()//Position - 0x10CF
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		func_16(23, bLocal_283);
		func_5();
		func_239();
	}
}

void func_16(int iParam0, bool bParam1)//Position - 0x10F4
{
	if (iParam0 == -1)
	{
		iParam0 = func_34();
	...
	if (bParam1 <= func_33(iParam0))
	{
		...
		{
			func_8(func_18(iParam0, bParam1), Local_46.f_0, Local_46.f_1);
		}
...
int func_19(int iParam0)//Position - 0x157A
{
	switch (iParam0)
	{
		case 29:
...
void func_22(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x160D
{
	int iVar0;
...
void func_25()//Position - 0x193E
{
	...
	{
		if (func_29(Global_114372.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_28(PLAYER::PLAYER_PED_ID());
			if (func_27(iVar0) && (!func_26(14) || Global_113320))
			{
				if (Global_114372.f_2366.f_539.f_4321 != iVar0 && func_27(Global_114372.f_2366.f_539.f_4321))
				{
...
bool func_27(int iParam0)//Position - 0x1A49
{
	return iParam0 < 3;
}

int func_28(int iParam0)//Position - 0x1A55
{
	int iVar0;
	int iVar1;
...
int func_29(int iParam0)//Position - 0x1A92
{
	if (func_27(iParam0))
	{
...
var func_30(int iParam0)//Position - 0x1AB7
{
	return Global_2139[iParam0 /*29*/];
}

int func_31(int iParam0)//Position - 0x1AC6
{
	int iVar0;
	int iVar1;
...
int func_35(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x1BEF
{
...
void func_37(float fParam0)//Position - 0x1E19
{
	...
	while (iVar0 < 9)
	{
		if (func_43(&(Global_114372.f_18106.f_175[iVar0 /*19*/].f_5)))
		{
			func_38(&(Global_114372.f_18106.f_175[iVar0 /*19*/].f_5), (fParam0 * 60f));
		}
		iVar0++;
	}
	iVar1 = 0;
	while (iVar1 < 6)
	{
		if (func_43(&(Global_114372.f_18106.f_362[iVar1 /*3*/])))
		{
			func_38(&(Global_114372.f_18106.f_362[iVar1 /*3*/]), (fParam0 * 60f));
		}
		iVar1++;
	}
...
void func_38(int* iParam0, float fParam1)//Position - 0x1EAA
{
	if (func_43(iParam0))
	{
...
void func_39(int* iParam0, float fParam1)//Position - 0x1ECD
{
...
int func_44(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1FA6
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_79031[1 /*14*/] = { func_97(iVar10, iParam1, iParam2, -1) };
		if (!func_96(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_79031[1 /*14*/] = { func_97(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_79031[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_79031[1 /*14*/] = { func_97(iVar10, 14, uVar28[iVar1], -1) };
							func_65(iParam0, Global_79031[1 /*14*/].f_12, Global_79031[1 /*14*/].f_3, Global_79031[1 /*14*/].f_4);
							func_88(14);
							if (Global_79029 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_55(iVar0), Global_79031[1 /*14*/].f_3, Global_79031[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_55(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_55(iVar0), Global_79031[1 /*14*/].f_3, Global_79031[1 /*14*/].f_4, iParam4);
						}
						func_88(iVar0);
						if (Global_79029 == 1)
						{
			...
			{
				Global_79031[1 /*14*/] = { func_97(iVar10, iVar0, func_54(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_79031[1 /*14*/] = { func_97(iVar10, 14, uVar69[iVar1], -1) };
			func_65(iParam0, Global_79031[1 /*14*/].f_12, Global_79031[1 /*14*/].f_3, Global_79031[1 /*14*/].f_4);
			func_88(14);
			if (Global_79029 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_55(iParam1), Global_79031[1 /*14*/].f_3, Global_79031[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_55(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_55(iParam1), Global_79031[1 /*14*/].f_3, Global_79031[1 /*14*/].f_4, iParam4);
		}
		if (Global_79029 == 1)
		{
			iVar2 = 0;
...
int func_45(int iParam0, int iParam1, int iParam2)//Position - 0x27B7
{
	int iVar0;
	...
	{
		if (!func_46(iParam0, Global_114372.f_2366.f_539[iVar0 /*65*/].f_64, Global_114372.f_2366.f_539[iVar0 /*65*/].f_63))
		{
...
int func_46(int iParam0, int iParam1, int iParam2)//Position - 0x2858
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Global_79031[1 /*14*/] = { func_97(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_79031[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_46(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_46(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_79031[2 /*14*/] = { func_97(iVar0, 14, iVar4, -1) };
									if (Global_79031[2 /*14*/].f_12 == iVar3)
									{
										if (func_46(iParam0, 14, iVar4))
										{
											if (!func_51(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_79031[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_79031[2 /*14*/] = { func_97(iVar0, iVar2, iVar1, -1) };
						if (!func_51(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_79031[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_79031[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_55(iParam1)) && Global_79031[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_55(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x2B76
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
{
	Global_79031[1 /*14*/] = { func_97(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_79031[1 /*14*/].f_6, 2);
}

int func_51(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x2C7C
{
	var uVar0;
	int iVar10;
...
int func_52(int iParam0, int iParam1, int iParam2)//Position - 0x3280
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3319
{
	int iVar0;
	...
	{
		if (!func_46(iParam0, Global_114372.f_2366.f_539[iVar0 /*65*/].f_61, Global_114372.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_54(int iParam0, int iParam1, int iParam2)//Position - 0x33C4
{
	int iVar0;
	int iVar1;
...
int func_56(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3515
{
	int iVar0;
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x381C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_58(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x43D1
{
	int iVar0;
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x49B3
{
	int iVar0;
...
int func_62(int iParam0, int iParam1, int iParam2)//Position - 0x49DC
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_63(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4CA6
{
	int iVar0;
...
void func_65(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5087
{
	int iVar0;
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5121
{
	switch (iParam0)
	{
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5711
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_71(int iParam0, int iParam1)//Position - 0x580D
{
	int iVar0;
...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x594B
{
	...
	else
	{
		...
		if (iVar18 != -1)
		{
			return (func_68(iParam0, func_55(iParam2)) + iVar18);
		}
	}
	return -99;
}
...
void func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x641A
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_77(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x6544
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_81(&Var1, -99, -99, Global_114372.f_2366.f_539.f_196[0], Global_114372.f_2366.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_81(&Var1, -99, -99, Global_114372.f_2366.f_539.f_196[1], Global_114372.f_2366.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_81(&Var1, -99, -99, Global_114372.f_2366.f_539.f_196[2], Global_114372.f_2366.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_80(Var16.f_2)] = func_72(iParam1, Var16.f_0, func_80(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8737
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_67(iParam0, iParam2, 14, 3), joaat("HAT_MENU"), 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_67(iParam0, iParam2, 1, 3), joaat("HAT_MENU"), 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_67(iParam0, iParam2, 14, 4), joaat("HAT_MENU"), 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_67(iParam0, iParam2, 1, 4), joaat("HAT_MENU"), 0));
					}
					break;
			}
			break;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x89B4
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8DD9
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_85(int iParam0, int iParam1)//Position - 0x90CC
{
	int iVar0;
	int iVar1;
...
int func_86(int iParam0, int iParam1)//Position - 0x9113
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9173
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_89(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x9276
{
	...
	{
		iVar3 = func_93(iVar2, iVar0);
		MISC::SET_BIT(&iVar3, iVar1);
		func_90(iVar2, iVar3, iVar0, 1);
	}
}
...
int func_91(int iParam0, var uParam1)//Position - 0x92EC
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_92(uParam1));
}

int func_92(var uParam0)//Position - 0x9301
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xBE52
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_96(int iParam0)//Position - 0xCCF6
{
	if (!BitTest(Global_79031[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_97(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCD3E
{
	func_160();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_98(int iParam0, int iParam1)//Position - 0xCD90
{
	switch (iParam0)
	{
		case 0:
...
void func_99(int iParam0)//Position - 0xCE80
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_106(iVar10, iParam0, 155, -1);
			return;
			break;
	}
	func_100(&(Global_79031[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_100(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xE0F7
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_93(func_103(iParam1, uParam0->f_2), Global_79028);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_93(func_102(iParam1, uParam0->f_2), Global_79028);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_93(iVar1, Global_79028);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_101(int iParam0, int iParam1, var uParam2)//Position - 0xE499
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_102(int iParam0, int iParam1)//Position - 0xE89E
{
	switch (iParam1)
	{
		case 0:
...
int func_103(int iParam0, int iParam1)//Position - 0xEC99
{
	switch (iParam1)
	{
		case 0:
...
int func_104(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xF094
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	{
		uVar3 = func_93(iVar2, iVar0);
		return BitTest(uVar3, uVar1);
	}
	return 0;
}

int func_105(int iParam0)//Position - 0xF0D2
{
	switch (iParam0)
	{
		case -1:
...
void func_106(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF1A6
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_100(&(Global_79031[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_100(&(Global_79031[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_100(&(Global_79031[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79229)
		{
			...
			func_100(&(Global_79031[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_107(int iParam0)//Position - 0xF42D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0xF584
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0)//Position - 0xFA92
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0)//Position - 0xFB07
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0xFB7B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0xFC62
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0xFFC5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x101E9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0x10419
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x10529
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0x10EC8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x11A3B
{
	if (iParam0 < 136)
	{
		func_120(iParam0);
...
void func_119(int iParam0)//Position - 0x11A70
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0x12674
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0x13582
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0x136AF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0, int iParam1)//Position - 0x137AD
{
	switch (iParam0)
	{
		case 0:
...
void func_124(int iParam0)//Position - 0x1389D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0x14D90
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x14EE1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0x153EC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x15A5A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0x15ACE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x15B9E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x160CE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x16265
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x16A63
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x16B73
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x17A9E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x1875C
{
	if (iParam0 < 107)
	{
		func_139(iParam0);
...
void func_137(int iParam0)//Position - 0x187A2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x19247
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x1A036
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x1AC7F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x1AEF8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0, int iParam1)//Position - 0x1B03E
{
	switch (iParam0)
	{
		case 0:
...
void func_143(int iParam0)//Position - 0x1B12E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x1BEB8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x1C032
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x1C5A9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x1CAD3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x1CB47
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x1CC17
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x1D0EF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1D358
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x1D62E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1D7F7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1E34B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1EF95
{
	if (iParam0 < 60)
	{
		func_157(iParam0);
...
void func_156(int iParam0)//Position - 0x1EFCA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x1FD6A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x203F7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x204DE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160()//Position - 0x205DC
{
...
void func_161(bool bParam0)//Position - 0x20655
{
	if (bParam0)
	{
		func_168();
...
void func_162(int iParam0)//Position - 0x206B8
{
	if (func_166())
	{
		return;
...
void func_164(bool bParam0, bool bParam1)//Position - 0x20769
{
	if (bParam0)
	{
		if (func_167(0))
...
bool func_165()//Position - 0x207DD
{
	return BitTest(Global_1956030, 5);
}

bool func_166()//Position - 0x207EB
{
	return BitTest(Global_1956030, 19);
}

int func_167(int iParam0)//Position - 0x207FA
{
	if (iParam0 == 1)
	{
...
void func_168()//Position - 0x20851
{
...
void func_169()//Position - 0x2087A
{
	Global_21032 = 0;
	func_170();
}

void func_170()//Position - 0x2088A
{
...
void func_171()//Position - 0x208AE
{
	if ((PED::IS_PED_INJURED(iLocal_250) && PED::IS_PED_INJURED(iLocal_251)) && !iLocal_265)
	{
		func_15();
	}
	if (iLocal_50 == 1)
	{
		if (!iLocal_265)
		{
			if (!PED::IS_PED_INJURED(iLocal_250))
			{
				if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_250, 50f, 50f, 50f, false, true, 0))
				{
					func_15();
				}
			}
	...
	{
		if (!PED::IS_PED_INJURED(iLocal_250) && !PED::IS_PED_INJURED(iLocal_251))
		{
			if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_250, 200f, 200f, 200f, false, true, 0) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_250, 200f, 200f, 200f, false, true, 0))
			{
				func_15();
			}
		}
...
void func_172()//Position - 0x20977
{
	if (!PED::IS_PED_INJURED(iLocal_250))
	{
		if (iLocal_50 == 1)
		{
			if (!PED::IS_PED_BEING_STUNNED(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_250, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, false, true, 0) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_250, Local_69, 215f, 215f, 215f, false, true, 0))
				{
					if ((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_250) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_250)) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_250, Local_69, 215f, 215f, 215f, false, true, 0))
					{
						if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_250, Local_69, 215f, 215f, 215f, false, true, 0))
						{
							TASK::TASK_SMART_FLEE_PED(iLocal_250, PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
							PED::SET_PED_KEEP_TASK(iLocal_250, true);
							func_204();
							SYSTEM::WAIT(0);
							func_188(&uLocal_82, "re_acau", "re_ac_aim", 4, 0, 0, 0);
							func_15();
						}
					}
				}
...
void func_173()//Position - 0x20AF0
{
	if (iLocal_50 == 1)
	{
		if (!PED::IS_PED_INJURED(iLocal_250))
		{
			if (!TASK::IS_PED_IN_WRITHE(iLocal_250))
			{
				if (iLocal_276 < 3)
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_250, 20f, 20f, 10f, false, true, 0))
					{
						if (func_178())
						{
							func_177(0);
	...
	else if (iLocal_50 == 2)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_250, false))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_250, 31f, 31f, 11f, false, true, 0))
			{
				if (func_178())
				{
					func_177(0);
		...
		else if (!ENTITY::IS_ENTITY_DEAD(iLocal_251, false))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_251, 31f, 31f, 11f, false, true, 0))
			{
				if (func_178())
				{
					func_177(0);
		...
		if (!func_3())
		{
			if (!iLocal_268)
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_250, 30f, 30f, 10f, false, true, 0))
				{
					if (func_203() == 0)
					{
						func_188(&uLocal_82, "reac2au", "reac2_attacM", 4, 0, 0, 0);
					}
					else if (func_203() == 1)
					{
						func_188(&uLocal_82, "reac2au", "reac2_attacF", 4, 0, 0, 0);
					}
					else if (func_203() == 2)
					{
						func_188(&uLocal_82, "reac2au", "reac2_attacT", 4, 0, 0, 0);
					}
				}
				iLocal_268 = 1;
			}
			if (iLocal_274 < MISC::GET_GAME_TIMER())
			{
				if (func_176())
				{
					if (!PED::IS_PED_INJURED(iLocal_250))
					{
						if (!TASK::IS_PED_IN_WRITHE(iLocal_250))
						{
							func_188(&uLocal_82, "reac2au", "reac2_attac2", 4, 0, 0, 0);
							iLocal_274 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(4500, 5000));
						}
					}
				}
				else if (!PED::IS_PED_INJURED(iLocal_251))
				{
					if (!TASK::IS_PED_IN_WRITHE(iLocal_251))
					{
						func_188(&uLocal_82, "reac2au", "reac2_attac3", 4, 0, 0, 0);
						iLocal_274 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(4500, 5000));
					}
				}
			}
	...
	if (!PED::IS_PED_INJURED(iLocal_250))
	{
		if (!TASK::IS_PED_IN_WRITHE(iLocal_250))
		{
			if ((PED::IS_PED_RAGDOLL(iLocal_250) || PED::IS_PED_BEING_STUNNED(iLocal_250, joaat("WEAPON_STUNGUN"))) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_250, PLAYER::PLAYER_PED_ID(), true))
			{
				func_204();
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_250);
			}
			if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_250, Local_76, false, true, 0) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_250, Local_69, 290f, 290f, 290f, false, true, 0))
			{
				if ((!iLocal_263 && !func_174("reac2_attac1")) && iLocal_276 < 3)
				{
					func_204();
					SYSTEM::WAIT(0);
					if (iLocal_50 == 1)
					{
						func_188(&uLocal_82, "re_acau", "re_ac_flee", 4, 0, 0, 0);
					}
					else if (iLocal_50 == 2)
					{
						func_188(&uLocal_82, "reac2au", "reac2_flee", 4, 0, 0, 0);
					}
					iLocal_263 = 1;
				}
			}
...
int func_174(char* sParam0)//Position - 0x20DF1
{
	var uVar0;
	
	if (func_3())
	{
		MemCopy(&uVar0, {func_175()}, 4);
...
struct<6> func_175()//Position - 0x20E19
{
	struct<6> Var0;
...
void func_177(int iParam0)//Position - 0x20E5B
{
	Global_23177 = iParam0;
}

int func_178()//Position - 0x20E68
{
	if (Global_23177 == 1)
	{
		return 1;
...
void func_179()//Position - 0x20E7F
{
	if (HUD::DOES_BLIP_EXIST(iLocal_247))
	{
		if (PED::IS_PED_INJURED(iLocal_250))
...
void func_180()//Position - 0x20EB7
{
	if (!PED::IS_PED_INJURED(iLocal_250))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_250, false))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(iLocal_250, false), false))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy", 3))
				{
					if ((((((((ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.1f && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.075f) || (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.25f && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.225f)) || (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.38f && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.355f)) || (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.53f && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.505f)) || (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.638f && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.613f)) || (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.7f && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.675f)) || (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.833f && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.808f)) || (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 1f && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.983f))
					{
						ENTITY::APPLY_FORCE_TO_ENTITY(PED::GET_VEHICLE_PED_IS_IN(iLocal_250, false), 0, 0f, 0f, 15f, -0.4f, 0f, 0f, 0, true, true, true, false, true);
						AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "SUSPENSION_SCRIPT_FORCE", PED::GET_VEHICLE_PED_IS_IN(iLocal_250, false), 0, false, 0);
					}
				}
				if (func_238() && !iLocal_267)
				{
					if (!func_3())
					{
						func_188(&uLocal_82, "reac2au", "reac2_sex", 4, 0, 0, 0);
						iLocal_267 = 1;
					}
				}
			}
		...
		if (!PED::IS_PED_INJURED(iLocal_251))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_251, PLAYER::PLAYER_PED_ID(), true))
			{
				TASK::TASK_PLAY_ANIM(iLocal_251, "random@train_tracks", "frontseat_carsex_death_exit_top_guy", 2f, -2f, -1, 2097152, 0f, false, false, false);
			}
		}
	}
}

void func_181()//Position - 0x2111B
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_252, false))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_252, false)) || iLocal_50 == 2)
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_252, Local_73, false, true, 0) || iLocal_258)
			{
				if (iLocal_50 == 1)
				{
					Local_57 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - Vector(-1f, 8.8f, 0f) };
					PATHFIND::GET_SAFE_COORD_FOR_PED(Local_57, false, &Local_57, 0);
					Local_60 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) + Vector(-1f, 0f, 8.8f) };
					PATHFIND::GET_SAFE_COORD_FOR_PED(Local_60, false, &Local_60, 0);
					Local_63 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) + Vector(-1f, 8.8f, 0f) };
					PATHFIND::GET_SAFE_COORD_FOR_PED(Local_63, false, &Local_63, 0);
					Local_66 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - Vector(-1f, 0f, 8.8f) };
					PATHFIND::GET_SAFE_COORD_FOR_PED(Local_66, false, &Local_66, 0);
					if (!CAM::IS_SPHERE_VISIBLE(Local_57, 2f))
					{
						iLocal_250 = PED::CREATE_PED(19, iLocal_256, Local_57 - Vector(1f, 0f, 0f), func_186(Local_57, func_187(PLAYER::PLAYER_ID())), true, true);
					}
					else if (!CAM::IS_SPHERE_VISIBLE(Local_60, 2f))
					{
						iLocal_250 = PED::CREATE_PED(19, iLocal_256, Local_60 - Vector(1f, 0f, 0f), func_186(Local_60, func_187(PLAYER::PLAYER_ID())), true, true);
					}
					else if (!CAM::IS_SPHERE_VISIBLE(Local_63, 2f))
					{
						iLocal_250 = PED::CREATE_PED(19, iLocal_256, Local_63 - Vector(1f, 0f, 0f), func_186(Local_63, func_187(PLAYER::PLAYER_ID())), true, true);
					}
					else if (!CAM::IS_SPHERE_VISIBLE(Local_66, 2f))
					{
						iLocal_250 = PED::CREATE_PED(19, iLocal_256, Local_66 - Vector(1f, 0f, 0f), func_186(Local_66, func_187(PLAYER::PLAYER_ID())), true, true);
					}
					if (!PED::IS_PED_INJURED(iLocal_250))
					{
						AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_250, "A_M_M_HillBilly_01_WHITE_MINI_02");
						WEAPON::GIVE_WEAPON_TO_PED(iLocal_250, joaat("WEAPON_STUNGUN"), -1, true, true);
						PED::SET_PED_SHOOT_RATE(iLocal_250, 100);
						PED::SET_PED_CONFIG_FLAG(iLocal_250, 137, true);
						PED::SET_PED_CONFIG_FLAG(iLocal_250, 188, true);
						PED::SET_PED_CONFIG_FLAG(iLocal_250, 286, true);
						PED::SET_PED_MIN_GROUND_TIME_FOR_STUNGUN(PLAYER::PLAYER_PED_ID(), 10000);
						PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_250, 0, false);
						PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_250, 27, true);
						PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_250, 13, true);
						PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_250, 50, true);
						PED::SET_PED_COMBAT_MOVEMENT(iLocal_250, 2);
						PED::SET_PED_COMBAT_ABILITY(iLocal_250, 2);
						PED::SET_PED_COMBAT_RANGE(iLocal_250, 0);
						PED::SET_COMBAT_FLOAT(iLocal_250, 2, 11f);
						PED::SET_COMBAT_FLOAT(iLocal_250, 13, 1f);
						AUDIO::STOP_PED_SPEAKING(iLocal_250, true);
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_250, iLocal_79);
						func_185(&uLocal_82, 4, iLocal_250, "RAPIST", 0, 1);
						PED::CLEAR_PED_ALTERNATE_WALK_ANIM(PLAYER::PLAYER_PED_ID(), -8f);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_250, true);
						if (!HUD::DOES_BLIP_EXIST(iLocal_247))
						{
							iLocal_247 = func_182(iLocal_250, 1, 145);
						}
						...
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_269);
						PED::SET_PED_KEEP_TASK(iLocal_250, true);
						PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_250, false, false);
						iLocal_259 = 1;
					}
				}
				else if (iLocal_50 == 2)
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_251))
					{
						iLocal_248 = func_182(iLocal_251, 1, 145);
						ENTITY::SET_ENTITY_HEALTH(iLocal_251, 200, 0, 0);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_269);
						...
						TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_269);
						TASK::TASK_PERFORM_SEQUENCE(iLocal_251, iLocal_269);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_269);
					...
					if (!PED::IS_PED_INJURED(iLocal_250) && !PED::IS_PED_INJURED(iLocal_251))
					{
						func_188(&uLocal_82, "reac2au", "reac2_attac1", 4, 0, 0, 0);
					}
					iLocal_259 = 1;
				}
			}
...
int func_182(int iParam0, bool bParam1, int iParam2)//Position - 0x2157F
{
	int iVar0;
	
	iVar0 = func_183(iParam0, !bParam1, 0);
...
int func_183(int iParam0, bool bParam1, bool bParam2)//Position - 0x215C9
{
	int iVar0;
	...
	{
		HUD::SET_BLIP_SCALE(iVar0, func_184(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		HUD::SET_BLIP_SCALE(iVar0, func_184(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
float func_184(bool bParam0, float fParam1, float fParam2)//Position - 0x2166D
{
	if (bParam0)
	{
		return fParam1;
...
void func_185(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x21684
{
...
float func_186(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)//Position - 0x2171F
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param3.f_0 - Param0.f_0), (Param3.f_1 - Param0.f_1));
}

Vector3 func_187(int iParam0)//Position - 0x21739
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_188(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2174C
{
...
int func_189(char* sParam0, int iParam1, bool bParam2)//Position - 0x2179A
{
	Global_22167 = 0;
...
void func_190()//Position - 0x21A68
{
	if (!func_191())
	{
		return;
...
bool func_192(int iParam0)//Position - 0x21B02
{
	return func_193(iParam0, 20);
}

var func_193(int iParam0, int iParam1)//Position - 0x21B12
{
	return BitTest(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_194()//Position - 0x21B2A
{
	return -1;
}

void func_195()//Position - 0x21B33
{
	int iVar0;
...
void func_196()//Position - 0x21B65
{
...
void func_198()//Position - 0x21C93
{
	if (func_26(14))
	{
...
void func_199()//Position - 0x21D35
{
	int iVar0;
...
bool func_200(int iParam0, int iParam1)//Position - 0x21D8D
{
	switch (iParam0)
	{
		case 5:
...
void func_201()//Position - 0x21DC5
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
...
void func_202(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21E1C
{
...
int func_203()//Position - 0x21E72
{
	func_25();
	return Global_114372.f_2366.f_539.f_4321;
}

void func_204()//Position - 0x21E8B
{
	Global_21032 = 0;
	func_205();
}

void func_205()//Position - 0x21E9B
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
float func_206(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x21EBC
{
	struct<3> Var0;
...
void func_207()//Position - 0x21EF6
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_252, false))
	{
		if (!func_238())
		{
			if (func_206(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_252, true), 1) < IntToFloat(iLocal_271))
			{
				if (HUD::DOES_BLIP_EXIST(iLocal_249))
				{
					HUD::REMOVE_BLIP(&iLocal_249);
				}
				iLocal_249 = func_219(iLocal_252, 0, 0);
				HUD::SHOW_HEIGHT_ON_BLIP(iLocal_249, false);
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
				{
					iLocal_254 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
				}
				func_209(1);
				func_208(1);
			}
	...
	if (iLocal_50 == 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_250, false))
		{
			if ((((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_250, 13f, 13f, 13f, false, true, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_250, true)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_250, PLAYER::PLAYER_PED_ID(), true)) || CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(iLocal_250, true), 2f))
			{
				iLocal_258 = 1;
				SYSTEM::SETTIMERB(0);
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_250, false))
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_250))
					{
						TASK::TASK_LOOK_AT_ENTITY(iLocal_250, PLAYER::PLAYER_PED_ID(), 30000, 0, 2);
					}
				}
			}
		}
...
void func_208(bool bParam0)//Position - 0x2205B
{
	if (bParam0)
	{
...
int func_209(int iParam0)//Position - 0x22087
{
	if (func_213())
	{
		Global_114362 = 1;
		Global_114359 = MISC::GET_GAME_TIMER();
		if (func_19(Global_114361))
		{
			func_210(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /* GXT: Random Event */);
		if (iParam0 && func_19(Global_114361))
		{
...
void func_210(int iParam0)//Position - 0x220DA
{
	switch (iParam0)
	{
		case 0:
...
void func_211(char* sParam0, int iParam1)//Position - 0x221B5
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

char* func_212(int iParam0)//Position - 0x221CC
{
	char* sVar0;
...
int func_213()//Position - 0x22210
{
	switch (func_214(&Global_32888, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_214(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x22246
{
	int iVar0;
...
void func_215(var uParam0, int iParam1)//Position - 0x2237D
{
	int iVar0;
...
bool func_216(int iParam0)//Position - 0x223CC
{
	return func_217(iParam0, Global_43922);
}

int func_217(int iParam0, int iParam1)//Position - 0x223DD
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_218(int iParam0)//Position - 0x225BE
{
	if (Global_43922 == 15)
	{
		return 0;
...
int func_219(int iParam0, bool bParam1, bool bParam2)//Position - 0x225E0
{
	return func_183(iParam0, !bParam1, bParam2);
}

void func_220()//Position - 0x225F3
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_252, false))
	{
		if (iLocal_50 == 1)
		{
			if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_252, Local_69, 15f, 15f, 15f, false, true, 0))
			{
				func_14();
			}
		}
		...
		{
			if ((((((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_252, PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_SHOOTING_IN_AREA(PLAYER::PLAYER_PED_ID(), Local_69 - Vector(50f, 50f, 50f), Local_69 + Vector(50f, 50f, 50f), false, true)) || FIRE::IS_EXPLOSION_IN_AREA(2, Local_69 - Vector(50f, 50f, 50f), Local_69 + Vector(50f, 50f, 50f))) || FIRE::IS_EXPLOSION_IN_AREA(4, Local_69 - Vector(50f, 50f, 50f), Local_69 + Vector(50f, 50f, 50f))) || FIRE::IS_EXPLOSION_IN_AREA(0, Local_69 - Vector(50f, 50f, 50f), Local_69 + Vector(50f, 50f, 50f))) || FIRE::IS_EXPLOSION_IN_AREA(1, Local_69 - Vector(50f, 50f, 50f), Local_69 + Vector(50f, 50f, 50f))) || PED::IS_COP_PED_IN_AREA_3D(Local_69 - Vector(50f, 50f, 50f), Local_69 + Vector(50f, 50f, 50f))) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(Local_69 - Vector(50f, 50f, 50f), Local_69 + Vector(50f, 50f, 50f))) || (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_252, 50f, 50f, 50f, false, true, 2) && PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID())))
			{
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
				{
					iLocal_254 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
...
void func_221()//Position - 0x22800
{
	RECORDING::REPLAY_PREVENT_RECORDING_THIS_FRAME();
	func_222();
}

void func_222()//Position - 0x22810
{
	Global_23572.f_134 = 1;
}

void func_223()//Position - 0x2281E
{
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("surfer"), true);
	if (iLocal_50 == 1)
	{
		PED::ADD_SCENARIO_BLOCKING_AREA(Local_69 - Vector(20f, 50f, 50f), Local_69 + Vector(20f, 50f, 50f), false, true, true, true, 1);
	}
	else if (iLocal_50 == 2)
	{
		PED::ADD_SCENARIO_BLOCKING_AREA(Local_69 - Vector(50f, 100f, 100f), Local_69 + Vector(50f, 100f, 100f), false, true, true, true, 1);
	}
	MISC::CLEAR_AREA_OF_VEHICLES(Local_54, 50f, false, false, false, false, false, false, 0);
	...
	while (((((!STREAMING::HAS_MODEL_LOADED(iLocal_256) || !STREAMING::HAS_MODEL_LOADED(iLocal_257)) || !STREAMING::HAS_ANIM_DICT_LOADED("random@train_tracks")) || !STREAMING::HAS_ANIM_DICT_LOADED("amb@world_human_guard_patrol@male@idle_b")) || !AUDIO::PREPARE_MUSIC_EVENT(sLocal_275)) || !AUDIO::IS_AUDIO_SCENE_ACTIVE("RE_ABANDONED_VEHICLE_SCENE"))
	{
		SYSTEM::WAIT(0);
	}
	if (func_203() == 0)
	{
		func_185(&uLocal_82, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	}
	else if (func_203() == 1)
	{
		func_185(&uLocal_82, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	else if (func_203() == 2)
	{
		func_185(&uLocal_82, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	}
	MISC::ENABLE_DISPATCH_SERVICE(3, false);
	MISC::ENABLE_DISPATCH_SERVICE(5, false);
	iLocal_252 = VEHICLE::CREATE_VEHICLE(iLocal_257, Local_69, fLocal_72, true, true, false);
	ENTITY::SET_ENTITY_LOD_DIST(iLocal_252, 10000);
	VEHICLE::SET_LAST_DRIVEN_VEHICLE(iLocal_252);
	VEHICLE::SET_VEHICLE_LOD_MULTIPLIER(iLocal_252, 5f);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_257);
	AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_252, "RE_ABANDONED_VEHICLE_MOTORHOME", 0f);
	AUDIO::SET_AUDIO_VEHICLE_PRIORITY(iLocal_252, 3);
	PED::ADD_RELATIONSHIP_GROUP("Redneck", &iLocal_79);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_79, joaat("PLAYER"));
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("COP"), iLocal_79);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_79, joaat("COP"));
	if (iLocal_50 == 1)
	{
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_252, 0, true, false);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_252, 1, true, false);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_252, Local_69, 0f, 1700f, true);
		VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_252, false, true, false);
		VEHICLE::SET_VEHICLE_LIGHTS(iLocal_252, 2);
	}
	else if (iLocal_50 == 2)
	{
		VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_252, false, true, false);
		VEHICLE::SET_VEHICLE_LIGHTS(iLocal_252, 1);
		iLocal_250 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_252, 26, iLocal_256, -1, true, true);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_250, 0, 0, 2, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_250, 2, 1, 2, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_250, 3, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_250, 4, 0, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_250, 8, 0, 0, 0);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_250, true);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_250, iLocal_79);
		WEAPON::GIVE_WEAPON_TO_PED(iLocal_250, joaat("WEAPON_SAWNOFFSHOTGUN"), -1, false, true);
		PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_250, 1, false);
		PED::SET_PED_ACCURACY(iLocal_250, 25);
		AUDIO::STOP_PED_SPEAKING(iLocal_250, true);
		AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_250, "A_M_M_HillBilly_02_WHITE_MINI_01");
		func_185(&uLocal_82, 4, iLocal_250, "INCESTBRO1", 0, 1);
		iLocal_251 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_252, 26, iLocal_256, 0, true, true);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_251, 0, 0, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_251, 2, 0, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_251, 3, 0, 2, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_251, 4, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_251, 8, 0, 0, 0);
		ENTITY::SET_ENTITY_HEALTH(iLocal_251, 100000000, 0, 0);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_251, true);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_251, iLocal_79);
		WEAPON::GIVE_WEAPON_TO_PED(iLocal_251, joaat("WEAPON_PISTOL"), -1, false, true);
		PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_251, 1, false);
		PED::SET_PED_ACCURACY(iLocal_251, 25);
		AUDIO::STOP_PED_SPEAKING(iLocal_251, true);
		AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_251, "A_M_M_HillBilly_02_WHITE_MINI_02");
		func_185(&uLocal_82, 5, iLocal_251, "INCESTBRO2", 0, 1);
		TASK::TASK_PLAY_ANIM(iLocal_250, "random@train_tracks", "frontseat_carsex_loop_low_guy", 1000f, -8f, -1, 1, 0f, false, false, false);
		TASK::TASK_PLAY_ANIM(iLocal_251, "random@train_tracks", "frontseat_carsex_loop_top_guy", 1000f, -8f, -1, 1, 0f, false, false, false);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_256);
	}
	iLocal_51 = 1;
}

void func_224()//Position - 0x22BE0
{
	if (iLocal_50 == 1)
	{
		iLocal_256 = joaat("A_M_M_Hillbilly_01");
		iLocal_257 = joaat("surfer");
		Local_69 = { 1430.0726f, 2976.3992f, 39.7694f };
		fLocal_72 = 131.558f;
		Local_76 = { 18f, 18f, 10f };
		iLocal_271 = 170;
		iLocal_272 = 40;
		Local_73 = { 20f, 20f, 10f };
	...
	else if (iLocal_50 == 2)
	{
		...
		Local_57 = { 2162.5518f, 2122.646f, 124.7956f };
		Local_69 = { 2162.5518f, 2122.646f, 124.7956f };
		fLocal_72 = 218.6214f;
		Local_76 = { 20f, 20f, 20f };
		iLocal_271 = 70;
		iLocal_272 = 25;
		Local_73 = { 10f, 10f, 10f };
		sLocal_275 = "RE8B_CAUGHT";
	}
	iLocal_53 = 1;
}

int func_225()//Position - 0x22CCF
{
...
int func_226(float fParam0, bool bParam1)//Position - 0x22D55
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_227(int iParam0, var uParam1)//Position - 0x22E06
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_228(uParam1, "Barry3A", func_230(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_229(iParam0), 0, 1);
			break;
		...
		case 8:
			func_228(uParam1, "Dreyfuss1", func_230(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_229(iParam0), 0, 0);
			break;
		...
		case 38:
			func_228(uParam1, "Nigel1A", func_230(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_229(iParam0), 1, 1);
			break;
		...
		case 49:
			func_228(uParam1, "Paparazzo3A", func_230(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_229(iParam0), 0, 1);
			break;
		...
		case 58:
			func_228(uParam1, "Tonya1", func_230(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_229(iParam0), 0, 1);
			break;
...
void func_228(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, struct<3> Param7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)//Position - 0x2404E
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_229(int iParam0)//Position - 0x240DF
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_230(int iParam0)//Position - 0x24425
{
	struct<2> Var0;
	char[] cVar2[8];
	
	StringCopy(&Var0, "", 8);
	cVar2 = { func_231(iParam0) };
...
struct<2> func_231(int iParam0)//Position - 0x2445D
{
	struct<2> Var0;
...
bool func_233()//Position - 0x248DC
{
	return Global_114090 > 0;
}

int func_234()//Position - 0x248EA
{
	if (Global_98294 != -1)
	{
		return 1;
...
int func_238()//Position - 0x249A1
{
	if ((Global_114361 == func_34() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_114362)
	{
		return 1;
	}
	return 0;
...
void func_239()//Position - 0x249CC
{
	if (iLocal_52)
	{
		if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		...
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_254, false) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_254, 50f, 50f, 50f, false, true, 0))
			{
				func_267(iLocal_254, 0, 145);
			}
		}
		if (!PED::IS_PED_INJURED(iLocal_250) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			WEAPON::SET_PED_DROPS_WEAPON(iLocal_250);
			TASK::TASK_SMART_FLEE_PED(iLocal_250, PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
			PED::SET_PED_KEEP_TASK(iLocal_250, true);
		}
		if (!PED::IS_PED_INJURED(iLocal_251) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			TASK::TASK_SMART_FLEE_PED(iLocal_251, PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
			PED::SET_PED_KEEP_TASK(iLocal_251, true);
		}
	}
	func_240(-1);
...
void func_240(int iParam0)//Position - 0x24AFF
{
	char cVar0[64];
	...
	if (func_238())
	{
		...
		func_244(30000);
		StringCopy(&cVar0, func_243(Global_114361, 1), 64);
		if (func_33(Global_114361) > 0)
		{
...
void func_241(int iParam0)//Position - 0x24BB1
{
	Global_114361 = iParam0;
}

void func_242(var uParam0)//Position - 0x24BBF
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_243(int iParam0, bool bParam1)//Position - 0x24BFC
{
	switch (iParam0)
	{
		case 0:
...
void func_244(int iParam0)//Position - 0x24E45
{
	Global_44473 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_245(int iParam0)//Position - 0x24E57
{
	func_246(iParam0, 0, func_266(iParam0));
}

void func_246(int iParam0, int iParam1, int iParam2)//Position - 0x24E6C
{
	int iVar0;
	struct<16> Var1;
	
	iVar0 = func_265();
	func_256(&iVar0, 0, 0, iParam2, iParam1, 0, 0);
	func_255(iParam0, &iVar0);
	Var1 = { func_247(&iVar0) };
}

struct<16> func_247(int iParam0)//Position - 0x24E9B
{
	struct<16> Var0;
	int iVar16;
...
int func_248(int iParam0)//Position - 0x24F6C
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_249(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_249(bool bParam0, int iParam1, int iParam2)//Position - 0x24F8E
{
	if (bParam0)
	{
		return iParam1;
...
int func_250(int iParam0)//Position - 0x24FA5
{
	return iParam0 & 15;
}

int func_251(int iParam0)//Position - 0x24FB2
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_252(int iParam0)//Position - 0x24FC4
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_253(int iParam0)//Position - 0x24FD7
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_254(int iParam0)//Position - 0x24FEA
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

void func_255(int iParam0, int iParam1)//Position - 0x24FFD
{
	Global_114372.f_24998.f_43[iParam0] = *iParam1;
}

void func_256(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x25015
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = (iVar0 + iParam6);
	func_257(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}

void func_257(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x25197
{
...
void func_258(var uParam0, int iParam1)//Position - 0x251CF
{
	if (iParam1 <= 0)
	{
		return;
...
void func_259(var uParam0, int iParam1)//Position - 0x25255
{
	int iVar0;
	int iVar1;
	...
	if (iParam1 < 1 || iParam1 > func_264(iVar0, iVar1))
	{
		return;
	}
...
void func_260(var uParam0, int iParam1)//Position - 0x252A6
{
...
void func_261(var uParam0, int iParam1)//Position - 0x252D9
{
...
void func_262(var uParam0, int iParam1)//Position - 0x25313
{
...
void func_263(var uParam0, int iParam1)//Position - 0x2534E
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_264(int iParam0, int iParam1)//Position - 0x2538A
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_265()//Position - 0x2542C
{
	var uVar0;
	
	func_263(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_262(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_261(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_259(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_260(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_258(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}

int func_266(int iParam0)//Position - 0x25472
{
	int iVar0;
...
int func_267(int iParam0, int iParam1, int iParam2)//Position - 0x25615
{
	var uVar0;
	char* sVar1;
...
void func_268(int iParam0, int iParam1)//Position - 0x25655
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_269(iParam0, &(Global_114372.f_32753.f_5510));
}

void func_269(int iParam0, var uParam1)//Position - 0x25857
{
	int iVar0;
...
int func_270(int iParam0)//Position - 0x25B02
{
	switch (iParam0)
	{
		case 1:
...
int func_271(int iParam0, var uParam1, var uParam2)//Position - 0x25BB2
{
	int iVar0;
	int iVar1;
...
int func_272(int iParam0)//Position - 0x25DA5
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_273(var uParam0)//Position - 0x25DC5
{
	int iVar0;
...
int func_274(int iParam0)//Position - 0x25E76
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_293(iParam0, 0, 0)) || func_293(iParam0, 1, 0)) || func_293(iParam0, 2, 0)) || func_292(iParam0) != 145) || func_291(iParam0)) || func_290(iParam0)) || func_289(iParam0)) || func_288(iParam0)) || !func_275(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_290(iParam0))
		{
		}
...
int func_275(int iParam0)//Position - 0x25F53
{
	if (iParam0 == 0)
	{
		return 0;
	}
	if (!func_276(iParam0, 0, -1))
	{
		return 0;
	}
...
int func_276(int iParam0, bool bParam1, int iParam2)//Position - 0x26111
{
	int iVar0;
	struct<2> Var1;
	...
	{
		if ((func_282() || MISC::IS_PC_VERSION()) || func_281())
		{
		}
		else if (!func_284())
		{
...
int func_277(int iParam0)//Position - 0x26293
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_279(int iParam0, int iParam1)//Position - 0x26376
{
	int iVar0;
	int iVar1;
...
int func_280(bool bParam0)//Position - 0x2B8B0
{
	if (bParam0)
	{
...
bool func_281()//Position - 0x2B8CA
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_282()//Position - 0x2B8E0
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_283()//Position - 0x2B8F6
{
	return 0;
}

int func_284()//Position - 0x2B8FF
{
	return 1;
}

int func_285()//Position - 0x2B908
{
	return 1;
}

int func_286()//Position - 0x2B911
{
...
int func_288(int iParam0)//Position - 0x2B9E2
{
	int iVar0;
	char* sVar1;
...
int func_289(int iParam0)//Position - 0x2BA29
{
	int iVar0;
...
int func_290(int iParam0)//Position - 0x2BA64
{
	int iVar0;
...
int func_291(int iParam0)//Position - 0x2BAE0
{
	int iVar0;
...
int func_292(int iParam0)//Position - 0x2BBC8
{
	int iVar0;
...
int func_293(int iParam0, int iParam1, bool bParam2)//Position - 0x2BC2B
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_294(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2BC99
{
...
void func_295(int iParam0)//Position - 0x2BD72
{
	if (iParam0 == -1)
	{
		iParam0 = func_34();
...
void func_296()//Position - 0x2BDA8
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
int func_297(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2BDE5
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (func_27(func_203()))
		{
			if (func_320(func_203()) == 4 || func_320(func_203()) == 5)
			{
				return 0;
			}
		}
...
bool func_298(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2C182
{
	if (bParam6)
	{
...
bool func_299(int iParam0)//Position - 0x2C1C9
{
	int iVar0;
...
int func_300(int iParam0)//Position - 0x2C1EA
{
	return func_301(iParam0, 1);
}

int func_301(int iParam0, int iParam1)//Position - 0x2C1F9
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	func_302(iParam0, &uVar0, &uVar1, &iVar2, &iVar3, &iVar4, &iVar5);
...
void func_302(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2C24C
{
	func_303(func_265(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_303(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x2C26A
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_305(iParam0, iParam1))
	{
		...
		iVar5 = (func_254(iParam0) - func_254(iParam1));
		iVar6 = (func_253(iParam0) - func_253(iParam1));
		iVar7 = (func_252(iParam0) - func_252(iParam1));
	}
	else
	{
		...
		iVar5 = (func_254(iParam1) - func_254(iParam0));
		iVar6 = (func_253(iParam1) - func_253(iParam0));
		iVar7 = (func_252(iParam1) - func_252(iParam0));
	}
	while (iVar7 < 0)
	{
		iVar7 += 60;
	...
	while (iVar4 < 0)
	{
		...
		iVar4 = (iVar4 + func_264(iVar0, iVar1));
		iVar3 = (iVar3 - 1);
		iVar0 = SYSTEM::ROUND(func_304(SYSTEM::TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
float func_304(float fParam0, float fParam1, float fParam2)//Position - 0x2C46B
{
	float fVar0;
...
int func_305(int iParam0, int iParam1)//Position - 0x2C4AD
{
	int iVar0;
	int iVar1;
...
int func_306(int iParam0)//Position - 0x2C5B9
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar5 < 1 || iVar5 > func_264(iVar4, iVar3))
	{
		return 0;
	}
	return 1;
...
int func_307(int iParam0, bool bParam1)//Position - 0x2C695
{
...
int func_308(int iParam0)//Position - 0x2C6B5
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_316()) || Global_113419) || Global_32831) || func_315()) || func_200(8, -1)) || func_314()) || func_313()) || func_312()) || func_311()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_316()) || Global_32831) || func_315()) || func_200(8, -1)) || func_312()) || func_314()) || func_313()) || func_311()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_316()) || Global_113419) || Global_32831) || func_315()) || func_200(8, -1)) || func_312()) || func_314()) || func_313()) || func_311()) || Global_114372.f_7691.f_919[iVar0] == 5) || Global_44469 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_316()) || Global_113419) || Global_32831) || func_315()) || func_200(8, -1)) || func_314()) || func_313()) || func_311()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_316() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_200(8, -1)) || func_311()) || func_310()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_316()) || Global_32831) || func_315()) || func_200(8, -1)) || func_313()) || func_312()) || func_311()) || Global_114372.f_7691.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_316()) || Global_113419) || Global_32831) || func_315()) || func_200(8, -1)) || func_312()) || func_310()) || func_314()) || func_313()) || func_311())
						{
							return 0;
						}
						break;
...
var func_309()//Position - 0x2CDD2
{
	return Global_101431.f_1;
}

int func_310()//Position - 0x2CDE0
{
	if (Global_98294 != -1)
	{
...
bool func_313()//Position - 0x2CE47
{
	return Global_101444.f_394 > 0;
}

bool func_314()//Position - 0x2CE58
{
	return Global_101444.f_393 > 0;
}

var func_315()//Position - 0x2CE69
{
	return Global_1575079;
}

int func_316()//Position - 0x2CE75
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_318(int iParam0)//Position - 0x2CEB9
{
	return func_305(func_265(), iParam0);
}

int func_319(int iParam0, int iParam1, int iParam2)//Position - 0x2CECB
{
	int iVar0;
	int iVar1;
...
int func_320(int iParam0)//Position - 0x2CFAF
{
	if (!func_27(iParam0))
	{
		return 7;
...
int func_321(int iParam0)//Position - 0x2CFD3
{
	int iVar0;
	int iVar1;
...
Vector3 func_323()//Position - 0x2D06F
{
	float fVar0;
	
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_277, true);
		bLocal_283 = true;
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_280, true) < fVar0)
		{
			fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_280, true);
			bLocal_283 = 2;
		}
		if (bLocal_283 == 1)
		{
