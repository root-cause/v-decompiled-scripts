...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_295(Local_54, 23, bLocal_263, 0, 0))
	{
		func_293(-1);
	}
	else
		...
		if ((BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() && !PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || iLocal_243)
		{
			...
			switch (iLocal_49)
			{
				...
				case 1:
					...
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_234, false))
						{
							func_220();
						}
					}
					...
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_235, false))
						{
							func_220();
						}
					}
					...
					if (!iLocal_243)
					{
						...
						{
							if (func_205(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_236, true), 1) < IntToFloat(iLocal_256) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_236))
							{
								if (!iLocal_250)
								{
									func_203();
									...
									if (iLocal_50 == 1)
									{
										if (func_202() == 0)
										{
											func_187(&uLocal_66, "re_acau", "re_ac_approM", 4, 0, 0, 0);
										}
										else if (func_202() == 1)
										{
											func_187(&uLocal_66, "re_acau", "re_ac_approF", 4, 0, 0, 0);
										}
										else if (func_202() == 2)
										{
											func_187(&uLocal_66, "re_acau", "re_ac_approT", 4, 0, 0, 0);
										}
									}
									else if (iLocal_50 == 2)
									{
										if (func_202() == 0)
										{
											func_187(&uLocal_66, "reac2au", "reac2_approM", 4, 0, 0, 0);
										}
										else if (func_202() == 1)
										{
											func_187(&uLocal_66, "reac2au", "reac2_approF", 4, 0, 0, 0);
										}
										else if (func_202() == 2)
										{
											func_187(&uLocal_66, "reac2au", "reac2_approT", 4, 0, 0, 0);
										}
									}
...
void func_1()//Position - 0x389
{
}

void func_2()//Position - 0x391
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_234, false))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_234, 10f, 10f, 10f, false, true, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			{
				func_187(&uLocal_66, "re_acau", "re_ac_attac1", 4, 0, 0, 0);
				TASK::TASK_LOOK_AT_ENTITY(iLocal_234, PLAYER::PLAYER_PED_ID(), 4000, 0, 2);
				SYSTEM::SETTIMERB(0);
				iLocal_254++;
			}
		...
		if (!PED::IS_PED_INJURED(iLocal_234))
		{
			if (!iLocal_246)
			{
				if (PED::IS_PED_BEING_STUNNED(PLAYER::PLAYER_PED_ID(), 0))
				{
					iLocal_246 = 1;
					iLocal_257++;
					func_187(&uLocal_66, "re_acau", "re_ac_rambl", 4, 0, 0, 0);
					SYSTEM::SETTIMERA(0);
				}
			}
			...
			if (!PED::IS_PED_INJURED(iLocal_234))
			{
				...
				{
					TASK::TASK_PLAY_ANIM(iLocal_234, "amb@world_human_guard_patrol@male@idle_b", "idle_e", 2f, -2f, -1, 0, 0f, false, false, false);
	...
	else
	{
		...
		switch (iLocal_260)
		{
			...
			case 1:
				...
				{
					func_168();
					iLocal_64 = STREAMING::STREAMVOL_CREATE_SPHERE(923.5159f, 3203.386f, 40.173f, 30f, 13, 127);
					func_160(1);
			...
			case 3:
				STREAMING::STREAMVOL_DELETE(iLocal_64);
			...
			case 4:
				...
				if (SYSTEM::TIMERA() > 2000 && SYSTEM::TIMERA() < 3000)
				{
					if (func_202() == 0)
					{
						func_187(&uLocal_66, "re_acau", "re_ac_awakeM", 4, 0, 0, 0);
					}
					else if (func_202() == 1)
					{
						func_187(&uLocal_66, "re_acau", "re_ac_awakeF", 4, 0, 0, 0);
					}
					else if (func_202() == 2)
					{
						func_187(&uLocal_66, "re_acau", "re_ac_awakeT", 4, 0, 0, 0);
					}
				}
...
void func_5()//Position - 0xA18
{
	func_6();
}

int func_6()//Position - 0xA25
{
	if (func_7(0))
	{
		return 0;
...
int func_7(bool bParam0)//Position - 0xA70
{
...
void func_8(int iParam0, int iParam1, int iParam2)//Position - 0xA98
{
	bool bVar0;
...
int func_10()//Position - 0x103C
{
	return Global_32163;
}

int func_11(int iParam0, int iParam1)//Position - 0x1047
{
	int iVar0;
...
void func_12(int iParam0, bool bParam1, int iParam2)//Position - 0x1098
{
	if (iParam2 == -1)
	{
		iParam2 = func_13();
...
int func_13()//Position - 0x10B6
{
	return Global_1574918;
}

void func_14()//Position - 0x10C2
{
	func_238();
}

void func_15()//Position - 0x10CE
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		func_16(23, bLocal_263);
		func_5();
		func_238();
	}
}

void func_16(int iParam0, bool bParam1)//Position - 0x10F3
{
	if (iParam0 == -1)
	{
		iParam0 = func_34();
	...
	if (bParam1 <= func_33(iParam0))
	{
		...
		{
			func_8(func_18(iParam0, bParam1), Local_48.f_0, Local_48.f_1);
		}
...
void func_17(int iParam0)//Position - 0x11F7
{
	Global_113634 = iParam0;
}

int func_18(int iParam0, int iParam1)//Position - 0x1205
{
	switch (iParam0)
	{
		case 0:
...
int func_19(int iParam0)//Position - 0x1579
{
	switch (iParam0)
	{
		case 29:
...
void func_20(int iParam0)//Position - 0x15A8
{
	int iVar0;
	int iVar1;
...
void func_21(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x15EA
{
	func_22(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_22(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x160C
{
	int iVar0;
...
bool func_26(int iParam0)//Position - 0x1A3A
{
	return Global_43257 == iParam0;
}

bool func_27(int iParam0)//Position - 0x1A48
{
	return iParam0 < 3;
}

int func_28(int iParam0)//Position - 0x1A54
{
	int iVar0;
	int iVar1;
...
int func_29(int iParam0)//Position - 0x1A91
{
	if (func_27(iParam0))
	{
...
var func_30(int iParam0)//Position - 0x1AB6
{
	return Global_2028[iParam0 /*29*/];
}

int func_31(int iParam0)//Position - 0x1AC5
{
	int iVar0;
	int iVar1;
...
void func_32(int iParam0, int iParam1)//Position - 0x1B05
{
	MISC::SET_BIT(&(Global_113648.f_24997.f_8[iParam0]), iParam1);
}

int func_33(int iParam0)//Position - 0x1B20
{
	int iVar0;
...
int func_35(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x1BEE
{
...
int func_36(int iParam0)//Position - 0x1DC8
{
	int iVar0;
	int iVar1;
...
void func_37(float fParam0)//Position - 0x1E18
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 9)
	{
		if (func_43(&(Global_113648.f_18105.f_175[iVar0 /*19*/].f_5)))
		{
			func_38(&(Global_113648.f_18105.f_175[iVar0 /*19*/].f_5), (fParam0 * 60f));
		}
		iVar0++;
	}
	iVar1 = 0;
	while (iVar1 < 6)
	{
		if (func_43(&(Global_113648.f_18105.f_362[iVar1 /*3*/])))
		{
			func_38(&(Global_113648.f_18105.f_362[iVar1 /*3*/]), (fParam0 * 60f));
		}
		iVar1++;
	}
...
void func_38(int* iParam0, float fParam1)//Position - 0x1EA9
{
	if (func_43(iParam0))
	{
...
void func_39(int* iParam0, float fParam1)//Position - 0x1ECC
{
...
float func_40(bool bParam0)//Position - 0x1EF7
{
	float fVar0;
	float fVar1;
	int iVar2;
...
float func_41(var uParam0)//Position - 0x1F4F
{
	if (func_43(uParam0))
	{
		if (func_42(uParam0))
...
bool func_42(var uParam0)//Position - 0x1F8B
{
	return BitTest(*uParam0, 2);
}

bool func_43(var uParam0)//Position - 0x1F98
{
	return BitTest(*uParam0, 1);
}

int func_44(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1FA5
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_78341[1 /*14*/] = { func_96(iVar10, iParam1, iParam2, -1) };
		if (!func_95(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78341[1 /*14*/] = { func_96(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_96(iVar10, 14, uVar12[iVar1], -1) };
							func_65(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
							func_88(14);
							if (Global_78339 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_55(iVar0), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_55(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_55(iVar0), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
						}
						func_88(iVar0);
						if (Global_78339 == 1)
						{
			...
			{
				Global_78341[1 /*14*/] = { func_96(iVar10, iVar0, func_54(iParam0, iVar0, -1), -1) };
		...
		if (iParam7 == 1)
		{
			Var14 = { func_96(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var14 = { func_96(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var14 = { func_96(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var14 = { func_96(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var14 = { func_96(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_96(iVar10, 14, uVar15[iVar1], -1) };
			func_65(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_88(14);
			if (Global_78339 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_55(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_55(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_55(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
		}
		if (Global_78339 == 1)
		{
			iVar2 = 0;
...
int func_45(int iParam0, int iParam1, int iParam2)//Position - 0x27B6
{
	int iVar0;
	...
	{
		if (!func_46(iParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_64, Global_113648.f_2365.f_539[iVar0 /*65*/].f_63))
		{
...
int func_46(int iParam0, int iParam1, int iParam2)//Position - 0x2842
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Global_78341[1 /*14*/] = { func_96(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_78341[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_46(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_46(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_78341[2 /*14*/] = { func_96(iVar0, 14, iVar4, -1) };
									if (Global_78341[2 /*14*/].f_12 == iVar3)
									{
										if (func_46(iParam0, 14, iVar4))
										{
											if (!func_51(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_78341[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_78341[2 /*14*/] = { func_96(iVar0, iVar2, iVar1, -1) };
						if (!func_51(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_78341[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_78341[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_55(iParam1)) && Global_78341[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_55(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_47(int iParam0)//Position - 0x2A9B
{
	switch (iParam0)
	{
...
void func_48(int iParam0, int iParam1, int iParam2)//Position - 0x2AD6
{
	int iVar0;
	int iVar1;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x2B60
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_50(int iParam0, int iParam1, int iParam2)//Position - 0x2C3E
{
	Global_78341[1 /*14*/] = { func_96(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78341[1 /*14*/].f_6, 2);
}

int func_51(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x2C66
{
	var uVar0;
	int iVar1;
...
int func_52(int iParam0, int iParam1, int iParam2)//Position - 0x326A
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3303
{
	int iVar0;
	...
	{
		if (!func_46(iParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_61, Global_113648.f_2365.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_54(int iParam0, int iParam1, int iParam2)//Position - 0x33AE
{
	int iVar0;
	int iVar1;
...
int func_55(int iParam0)//Position - 0x344F
{
	switch (iParam0)
	{
		case 0:
...
int func_56(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x34FF
{
	int iVar0;
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x3806
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_58(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x43BB
{
	int iVar0;
...
int func_59(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x469F
{
	int iVar0;
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4966
{
	int iVar0;
	int iVar1;
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x499D
{
	int iVar0;
...
int func_62(int iParam0, int iParam1, int iParam2)//Position - 0x49C6
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_63(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4C90
{
	int iVar0;
...
int func_64(int iParam0, int iParam1, int iParam2)//Position - 0x4F1A
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_65(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5071
{
	int iVar0;
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x510B
{
	switch (iParam0)
	{
...
int func_67(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x51D9
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		iVar4 = (iParam1 - func_68(iParam0, func_55(iParam2)));
		if (iVar4 < 0)
		{
			return -1;
		}
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_55(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_68(int iParam0, int iParam1)//Position - 0x52F3
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_69(int iParam0)//Position - 0x569A
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x56FB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_71(int iParam0, int iParam1)//Position - 0x57F7
{
	int iVar0;
...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5935
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		if (iVar4 != -1)
		{
			return (func_68(iParam0, func_55(iParam2)) + iVar4);
		}
	}
	return -99;
}

int func_73(int iParam0)//Position - 0x59F0
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_74(int iParam0)//Position - 0x5A4F
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_75(int iParam0, int iParam1)//Position - 0x5AD5
{
	int iVar0;
	struct<10> Var1;
...
void func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6404
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var2;
...
void func_77(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x652E
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_78(int iParam0, int iParam1)//Position - 0x6576
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_81(&Var1, -99, -99, Global_113648.f_2365.f_539.f_196[0], Global_113648.f_2365.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_81(&Var1, -99, -99, Global_113648.f_2365.f_539.f_196[1], Global_113648.f_2365.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_81(&Var1, -99, -99, Global_113648.f_2365.f_539.f_196[2], Global_113648.f_2365.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.f_0 != 0 && Var2.f_0 != -1) && Var2.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_80(Var2.f_2)] = Var2.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_80(Var2.f_2)] = func_72(iParam1, Var2.f_0, func_80(Var2.f_2), iVar0);
					}
				}
				else if (Var2.f_1 != -1)
				{
					(*uParam0)[func_80(Var2.f_2)] = Var2.f_1;
				}
			}
			iVar4++;
		}
...
void func_88(int iParam0)//Position - 0x91CA
{
	...
	{
		func_94(iParam0, Global_78341[1 /*14*/].f_5, Global_78341[1 /*14*/].f_2, 2, Global_78341[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_78341[1 /*14*/].f_6, 1) && BitTest(Global_78341[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_90(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x92C0
{
	int iVar0;
...
int func_91(var uParam0)//Position - 0x92F0
{
	int iVar0;
	int iVar1;
...
int func_92(int iParam0, int iParam1, int iParam2)//Position - 0x9324
{
	int iVar0;
	var uVar1;
...
bool func_93(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x9361
{
	int iVar0;
...
int func_94(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xBB70
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_95(int iParam0)//Position - 0xCA15
{
	if (!BitTest(Global_78341[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_96(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCA5D
{
	func_159();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_97(int iParam0, int iParam1)//Position - 0xCAAF
{
	switch (iParam0)
	{
		case 0:
...
void func_98(int iParam0)//Position - 0xCB9F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_99(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_99(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xDE16
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_92(func_102(iParam1, uParam0->f_2), Global_78338, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_92(func_101(iParam1, uParam0->f_2), Global_78338, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_92(iVar1, Global_78338, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_100(int iParam0, int iParam1, var uParam2)//Position - 0xE1BB
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_101(int iParam0, int iParam1)//Position - 0xE5C0
{
	switch (iParam1)
	{
		case 0:
...
int func_102(int iParam0, int iParam1)//Position - 0xE9BB
{
	switch (iParam1)
	{
		case 0:
...
int func_103(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xEDB6
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	if (func_93(iParam0, iParam1, &iVar2, &uVar1, bParam2, bParam3))
	{
		uVar3 = func_92(iVar2, iVar0, 0);
		return BitTest(uVar3, uVar1);
	}
	return 0;
}

int func_104(int iParam0)//Position - 0xEDF5
{
	switch (iParam0)
	{
		case -1:
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEEC9
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar3 >= 0)
		{
			...
			if (iVar4 > iVar3)
			{
				...
				func_99(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_99(&(Global_78341[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_99(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_99(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_55(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_106(int iParam0)//Position - 0xF150
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0)//Position - 0xF2A7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0xF7B5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0)//Position - 0xF82A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0)//Position - 0xF89E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0xF985
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0xFCE8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0xFEF9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x1012A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0x1023A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x10BD9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0x1174C
{
	if (iParam0 < 136)
	{
		func_119(iParam0);
...
void func_118(int iParam0)//Position - 0x11781
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x12385
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0x13293
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0x133C0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0, int iParam1)//Position - 0x134BE
{
	switch (iParam0)
	{
		case 0:
...
void func_123(int iParam0)//Position - 0x135AE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0x14AA0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0x14BF1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x150FC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0x1576A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x157DE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0x158AE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x15DDE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x15F75
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x16773
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x16883
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x177AE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x1846C
{
	if (iParam0 < 107)
	{
		func_138(iParam0);
...
void func_136(int iParam0)//Position - 0x184B2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x18F57
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x19D46
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x1A98F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x1AC08
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0, int iParam1)//Position - 0x1AD4E
{
	switch (iParam0)
	{
		case 0:
...
void func_142(int iParam0)//Position - 0x1AE3E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x1BBC8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x1BD42
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x1C2BB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x1C7E5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x1C859
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x1C929
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x1CE01
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x1D06A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1D340
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x1D509
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1E05D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1ECA7
{
	if (iParam0 < 60)
	{
		func_156(iParam0);
...
void func_155(int iParam0)//Position - 0x1ECDC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1FA7C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x2010B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x201F2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159()//Position - 0x202F0
{
...
void func_160(bool bParam0)//Position - 0x20369
{
	if (bParam0)
	{
		func_167();
...
void func_161(int iParam0)//Position - 0x203CC
{
	if (func_165())
	{
		return;
...
void func_163(bool bParam0, bool bParam1)//Position - 0x2047D
{
	if (bParam0)
	{
		if (func_166(0))
...
bool func_164()//Position - 0x204F1
{
	return BitTest(Global_1962996, 5);
}

bool func_165()//Position - 0x204FF
{
	return BitTest(Global_1962996, 19);
}

int func_166(int iParam0)//Position - 0x2050E
{
	if (iParam0 == 1)
	{
...
void func_167()//Position - 0x20565
{
...
void func_168()//Position - 0x2058E
{
	Global_20591 = 0;
	func_169();
}

void func_169()//Position - 0x2059E
{
...
void func_170()//Position - 0x205C2
{
	...
	if (iLocal_50 == 1)
	{
		if (!iLocal_249)
		{
			if (!PED::IS_PED_INJURED(iLocal_234))
			{
				if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_234, 50f, 50f, 50f, false, true, 0))
				{
					func_15();
				}
			}
	...
	else if (iLocal_50 == 2)
	{
		...
		{
			if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_234, 200f, 200f, 200f, false, true, 0) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_234, 200f, 200f, 200f, false, true, 0))
			{
				func_15();
			}
		}
...
void func_171()//Position - 0x2068B
{
	if (!PED::IS_PED_INJURED(iLocal_234))
	{
		if (iLocal_50 == 1)
		{
			if (!PED::IS_PED_BEING_STUNNED(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_234, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, false, true, 0) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_234, Local_59, 215f, 215f, 215f, false, true, 0))
				{
					if ((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_234) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_234)) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_234, Local_59, 215f, 215f, 215f, false, true, 0))
					{
						if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_234, Local_59, 215f, 215f, 215f, false, true, 0))
						{
							TASK::TASK_SMART_FLEE_PED(iLocal_234, PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
							PED::SET_PED_KEEP_TASK(iLocal_234, true);
							func_203();
							SYSTEM::WAIT(0);
							func_187(&uLocal_66, "re_acau", "re_ac_aim", 4, 0, 0, 0);
							func_15();
						}
					}
				}
...
void func_172()//Position - 0x20804
{
	if (iLocal_50 == 1)
	{
		if (!PED::IS_PED_INJURED(iLocal_234))
		{
			if (!TASK::IS_PED_IN_WRITHE(iLocal_234))
			{
				if (iLocal_260 < 3)
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_234, 20f, 20f, 10f, false, true, 0))
					{
						if (func_177())
						{
							func_176(0);
	...
	else if (iLocal_50 == 2)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_234, false))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_234, 31f, 31f, 11f, false, true, 0))
			{
				if (func_177())
				{
					func_176(0);
		...
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_235, 31f, 31f, 11f, false, true, 0))
			{
				if (func_177())
				{
					func_176(0);
		...
		if (!func_3())
		{
			if (!iLocal_252)
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_234, 30f, 30f, 10f, false, true, 0))
				{
					if (func_202() == 0)
					{
						func_187(&uLocal_66, "reac2au", "reac2_attacM", 4, 0, 0, 0);
					}
					else if (func_202() == 1)
					{
						func_187(&uLocal_66, "reac2au", "reac2_attacF", 4, 0, 0, 0);
					}
					else if (func_202() == 2)
					{
						func_187(&uLocal_66, "reac2au", "reac2_attacT", 4, 0, 0, 0);
					}
				}
				iLocal_252 = 1;
			}
			if (iLocal_258 < MISC::GET_GAME_TIMER())
			{
				if (func_175())
				{
					if (!PED::IS_PED_INJURED(iLocal_234))
					{
						if (!TASK::IS_PED_IN_WRITHE(iLocal_234))
						{
							func_187(&uLocal_66, "reac2au", "reac2_attac2", 4, 0, 0, 0);
				...
				else if (!PED::IS_PED_INJURED(iLocal_235))
				{
					...
					{
						func_187(&uLocal_66, "reac2au", "reac2_attac3", 4, 0, 0, 0);
						iLocal_258 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(4500, 5000));
					}
				}
			}
	...
	if (!PED::IS_PED_INJURED(iLocal_234))
	{
		if (!TASK::IS_PED_IN_WRITHE(iLocal_234))
		{
			if ((PED::IS_PED_RAGDOLL(iLocal_234) || PED::IS_PED_BEING_STUNNED(iLocal_234, joaat("WEAPON_STUNGUN"))) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_234, PLAYER::PLAYER_PED_ID(), true))
			{
				func_203();
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_234);
			}
			if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_234, Local_62, false, true, 0) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_234, Local_59, 290f, 290f, 290f, false, true, 0))
			{
				if ((!iLocal_247 && !func_173("reac2_attac1")) && iLocal_260 < 3)
				{
					func_203();
					SYSTEM::WAIT(0);
					if (iLocal_50 == 1)
					{
						func_187(&uLocal_66, "re_acau", "re_ac_flee", 4, 0, 0, 0);
					}
					else if (iLocal_50 == 2)
					{
						func_187(&uLocal_66, "reac2au", "reac2_flee", 4, 0, 0, 0);
					}
					iLocal_247 = 1;
				}
			}
...
int func_173(char* sParam0)//Position - 0x20B05
{
	var uVar0;
...
struct<6> func_174()//Position - 0x20B2D
{
	struct<6> Var0;
...
void func_176(int iParam0)//Position - 0x20B6F
{
	Global_22736 = iParam0;
}

int func_177()//Position - 0x20B7C
{
	if (Global_22736 == 1)
	{
		return 1;
...
void func_178()//Position - 0x20B93
{
	if (HUD::DOES_BLIP_EXIST(iLocal_231))
	{
		if (PED::IS_PED_INJURED(iLocal_234))
...
void func_179()//Position - 0x20BCB
{
	if (!PED::IS_PED_INJURED(iLocal_234))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_234, false))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(iLocal_234, false), false))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy", 3))
				{
					...
					{
						ENTITY::APPLY_FORCE_TO_ENTITY(PED::GET_VEHICLE_PED_IS_IN(iLocal_234, false), 0, 0f, 0f, 15f, -0.4f, 0f, 0f, 0, true, true, true, false, true);
						AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "SUSPENSION_SCRIPT_FORCE", PED::GET_VEHICLE_PED_IS_IN(iLocal_234, false), 0, false, 0);
					}
				}
				if (func_237() && !iLocal_251)
				{
					if (!func_3())
					{
						func_187(&uLocal_66, "reac2au", "reac2_sex", 4, 0, 0, 0);
						iLocal_251 = 1;
					}
				}
			}
		...
		if (!PED::IS_PED_INJURED(iLocal_235))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_235, PLAYER::PLAYER_PED_ID(), true))
			{
				TASK::TASK_PLAY_ANIM(iLocal_235, "random@train_tracks", "frontseat_carsex_death_exit_top_guy", 2f, -2f, -1, 2097152, 0f, false, false, false);
			}
		}
	}
}

void func_180()//Position - 0x20E2F
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_236, false))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_236, false)) || iLocal_50 == 2)
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_236, Local_61, false, true, 0) || iLocal_242)
			{
				if (iLocal_50 == 1)
				{
					Local_55 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - Vector(-1f, 8.8f, 0f) };
					PATHFIND::GET_SAFE_COORD_FOR_PED(Local_55, false, &Local_55, 0);
					Local_56 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) + Vector(-1f, 0f, 8.8f) };
					PATHFIND::GET_SAFE_COORD_FOR_PED(Local_56, false, &Local_56, 0);
					...
					Local_58 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - Vector(-1f, 0f, 8.8f) };
					PATHFIND::GET_SAFE_COORD_FOR_PED(Local_58, false, &Local_58, 0);
					if (!CAM::IS_SPHERE_VISIBLE(Local_55, 2f))
					{
						iLocal_234 = PED::CREATE_PED(19, iLocal_240, Local_55 - Vector(1f, 0f, 0f), func_185(Local_55, func_186(PLAYER::PLAYER_ID())), true, true);
					}
					else if (!CAM::IS_SPHERE_VISIBLE(Local_56, 2f))
					{
						iLocal_234 = PED::CREATE_PED(19, iLocal_240, Local_56 - Vector(1f, 0f, 0f), func_185(Local_56, func_186(PLAYER::PLAYER_ID())), true, true);
					}
					else if (!CAM::IS_SPHERE_VISIBLE(Local_57, 2f))
					{
						iLocal_234 = PED::CREATE_PED(19, iLocal_240, Local_57 - Vector(1f, 0f, 0f), func_185(Local_57, func_186(PLAYER::PLAYER_ID())), true, true);
					}
					else if (!CAM::IS_SPHERE_VISIBLE(Local_58, 2f))
					{
						iLocal_234 = PED::CREATE_PED(19, iLocal_240, Local_58 - Vector(1f, 0f, 0f), func_185(Local_58, func_186(PLAYER::PLAYER_ID())), true, true);
					}
					if (!PED::IS_PED_INJURED(iLocal_234))
					{
						...
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_253);
						PED::SET_PED_KEEP_TASK(iLocal_234, true);
						PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_234, false, false);
						iLocal_243 = 1;
					}
				}
				else if (iLocal_50 == 2)
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_235))
					{
						iLocal_232 = func_181(iLocal_235, 1, 145);
					...
					if (!PED::IS_PED_INJURED(iLocal_234) && !PED::IS_PED_INJURED(iLocal_235))
					{
						func_187(&uLocal_66, "reac2au", "reac2_attac1", 4, 0, 0, 0);
					}
					iLocal_243 = 1;
				}
			}
...
int func_181(int iParam0, bool bParam1, int iParam2)//Position - 0x21292
{
	int iVar0;
	
	iVar0 = func_182(iParam0, !bParam1, 0);
...
int func_182(int iParam0, bool bParam1, bool bParam2)//Position - 0x212DC
{
	int iVar0;
	...
	{
		HUD::SET_BLIP_SCALE(iVar0, func_183(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
float func_183(bool bParam0, float fParam1, float fParam2)//Position - 0x21380
{
	if (bParam0)
	{
		return fParam1;
...
void func_184(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x21397
{
...
float func_185(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3)//Position - 0x21432
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param2.f_0 - Param0.f_0), (Param2.f_1 - Param0.f_1));
}

Vector3 func_186(int iParam0)//Position - 0x2144C
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_187(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2145F
{
...
int func_188(char* sParam0, int iParam1, bool bParam2)//Position - 0x214AD
{
	Global_21726 = 0;
...
void func_189()//Position - 0x2177B
{
	if (!func_190())
	{
		return;
...
bool func_191(int iParam0)//Position - 0x21815
{
	return func_192(iParam0, 20);
}

var func_192(int iParam0, int iParam1)//Position - 0x21825
{
	return BitTest(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

int func_193()//Position - 0x2183D
{
	return -1;
}

void func_194()//Position - 0x21846
{
	int iVar0;
...
void func_195()//Position - 0x21878
{
...
void func_197()//Position - 0x219A6
{
	if (func_26(14))
	{
...
void func_198()//Position - 0x21A48
{
	int iVar0;
...
bool func_199(int iParam0, int iParam1)//Position - 0x21AA0
{
	switch (iParam0)
	{
		case 5:
...
void func_200()//Position - 0x21AD8
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
...
void func_201(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21B2F
{
...
int func_202()//Position - 0x21B85
{
	func_25();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_203()//Position - 0x21B9E
{
	Global_20591 = 0;
	func_204();
}

void func_204()//Position - 0x21BAE
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
float func_205(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x21BCF
{
	struct<3> Var0;
...
void func_206()//Position - 0x21C09
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_236, false))
	{
		if (!func_237())
		{
			if (func_205(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_236, true), 1) < IntToFloat(iLocal_255))
			{
				if (HUD::DOES_BLIP_EXIST(iLocal_233))
				{
					HUD::REMOVE_BLIP(&iLocal_233);
				}
				iLocal_233 = func_218(iLocal_236, 0, 0);
	...
	if (iLocal_50 == 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_234, false))
		{
			if ((((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_234, 13f, 13f, 13f, false, true, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_234, true)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_234, PLAYER::PLAYER_PED_ID(), true)) || CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(iLocal_234, true), 2f))
			{
				iLocal_242 = 1;
				SYSTEM::SETTIMERB(0);
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_234, false))
...
void func_207(bool bParam0)//Position - 0x21D6F
{
	if (bParam0)
	{
...
int func_208(int iParam0)//Position - 0x21D9B
{
	if (func_212())
	{
		Global_113638 = 1;
...
void func_209(int iParam0)//Position - 0x21DEE
{
	switch (iParam0)
	{
		case 0:
...
void func_210(char* sParam0, int iParam1)//Position - 0x21EC9
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

char* func_211(int iParam0)//Position - 0x21EE0
{
	char* sVar0;
...
int func_212()//Position - 0x21F24
{
	switch (func_213(&Global_32223, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_213(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x21F5A
{
	int iVar0;
...
void func_214(var uParam0, int iParam1)//Position - 0x22091
{
	int iVar0;
...
bool func_215(int iParam0)//Position - 0x220E0
{
	return func_216(iParam0, Global_43257);
}

int func_216(int iParam0, int iParam1)//Position - 0x220F1
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_217(int iParam0)//Position - 0x222D2
{
	if (Global_43257 == 15)
	{
		return 0;
...
int func_218(int iParam0, bool bParam1, bool bParam2)//Position - 0x222F4
{
	return func_182(iParam0, !bParam1, bParam2);
}

void func_219()//Position - 0x22307
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_236, false))
	{
		if (iLocal_50 == 1)
		{
			if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_236, Local_59, 15f, 15f, 15f, false, true, 0))
			{
				func_14();
			}
		}
		...
		{
			if ((((((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_236, PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_SHOOTING_IN_AREA(PLAYER::PLAYER_PED_ID(), Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f), false, true)) || FIRE::IS_EXPLOSION_IN_AREA(2, Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || FIRE::IS_EXPLOSION_IN_AREA(4, Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || FIRE::IS_EXPLOSION_IN_AREA(0, Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || FIRE::IS_EXPLOSION_IN_AREA(1, Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || PED::IS_COP_PED_IN_AREA_3D(Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_236, 50f, 50f, 50f, false, true, 2) && PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID())))
			{
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
				{
					iLocal_238 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
...
void func_220()//Position - 0x22515
{
	RECORDING::REPLAY_PREVENT_RECORDING_THIS_FRAME();
	func_221();
}

void func_221()//Position - 0x22525
{
	Global_23131.f_134 = 1;
}

void func_222()//Position - 0x22533
{
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("surfer"), true);
	if (iLocal_50 == 1)
	{
		PED::ADD_SCENARIO_BLOCKING_AREA(Local_59 - Vector(20f, 50f, 50f), Local_59 + Vector(20f, 50f, 50f), false, true, true, true);
	}
	else if (iLocal_50 == 2)
	{
		PED::ADD_SCENARIO_BLOCKING_AREA(Local_59 - Vector(50f, 100f, 100f), Local_59 + Vector(50f, 100f, 100f), false, true, true, true);
	}
	...
	if (func_202() == 0)
	{
		func_184(&uLocal_66, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	}
	else if (func_202() == 1)
	{
		func_184(&uLocal_66, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	else if (func_202() == 2)
	{
		func_184(&uLocal_66, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	}
	MISC::ENABLE_DISPATCH_SERVICE(3, false);
	MISC::ENABLE_DISPATCH_SERVICE(5, false);
	iLocal_236 = VEHICLE::CREATE_VEHICLE(iLocal_241, Local_59, fLocal_60, true, true, false);
	...
	if (iLocal_50 == 1)
	{
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_236, 0, true, false);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_236, 1, true, false);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_236, Local_59, 0f, 1700f, true);
	...
	else if (iLocal_50 == 2)
	{
		...
		iLocal_234 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_236, 26, iLocal_240, -1, true, true);
		...
		func_184(&uLocal_66, 4, iLocal_234, "INCESTBRO1", 0, 1);
		iLocal_235 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_236, 26, iLocal_240, 0, true, true);
		...
		func_184(&uLocal_66, 5, iLocal_235, "INCESTBRO2", 0, 1);
		TASK::TASK_PLAY_ANIM(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy", 1000f, -8f, -1, 1, 0f, false, false, false);
		TASK::TASK_PLAY_ANIM(iLocal_235, "random@train_tracks", "frontseat_carsex_loop_top_guy", 1000f, -8f, -1, 1, 0f, false, false, false);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_240);
	}
	iLocal_51 = 1;
}

void func_223()//Position - 0x228F2
{
	if (iLocal_50 == 1)
	{
	...
	else if (iLocal_50 == 2)
	{
		...
		iLocal_255 = 70;
		iLocal_256 = 25;
		Local_61 = { 10f, 10f, 10f };
		sLocal_259 = "RE8B_CAUGHT";
	}
	iLocal_53 = 1;
}

int func_224()//Position - 0x229E1
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_235())
		{
			return 0;
		}
	}
...
int func_225(float fParam0, bool bParam1)//Position - 0x22A67
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_226(int iParam0, var uParam1)//Position - 0x22B18
{
	switch (iParam0)
	{
		case 0:
			func_227(uParam1, "Abigail1", func_229(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0, "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_228(iParam0), 1, 0);
			break;
		
		case 1:
			func_227(uParam1, "Abigail2", func_229(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, -1, 4, 1, 0, 2359, func_228(iParam0), 1, 0);
			break;
		
		case 2:
			func_227(uParam1, "Barry1", func_229(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1, 4, 1, 0, 2359, func_228(iParam0), 1, 0);
			break;
		
		case 3:
			func_227(uParam1, "Barry2", func_229(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_228(iParam0), 1, 1);
			break;
		
		case 4:
			func_227(uParam1, "Barry3", func_229(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2, 0, 2359, func_228(iParam0), 0, 0);
			break;
		
		case 5:
			func_227(uParam1, "Barry3A", func_229(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 6:
			func_227(uParam1, "Barry3C", func_229(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 7:
			func_227(uParam1, "Barry4", func_229(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_228(iParam0), 0, 0);
			break;
		
		case 8:
			func_227(uParam1, "Dreyfuss1", func_229(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_228(iParam0), 0, 0);
			break;
		
		case 9:
			func_227(uParam1, "Epsilon1", func_229(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1, 10, 4, 1, 0, 2359, func_228(iParam0), 0, 0);
			break;
		
		case 10:
			func_227(uParam1, "Epsilon2", func_229(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0, 11, 4, 1, 0, 2359, func_228(iParam0), 1, 0);
			break;
		
		case 11:
			func_227(uParam1, "Epsilon3", func_229(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars", 0, 0, 12, 4, 1, 0, 2359, func_228(iParam0), 0, 0);
			break;
		
		case 12:
			func_227(uParam1, "Epsilon4", func_229(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16, "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_228(iParam0), 0, 0);
			break;
		
		case 13:
			func_227(uParam1, "Epsilon5", func_229(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16, "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_228(iParam0), 1, 0);
			break;
		
		case 14:
			func_227(uParam1, "Epsilon6", func_229(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0, 15, 4, 1, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 15:
			func_227(uParam1, "Epsilon7", func_229(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_228(iParam0), 0, 0);
			break;
		
		case 16:
			func_227(uParam1, "Epsilon8", func_229(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_228(iParam0), 1, 0);
			break;
		
		case 17:
			func_227(uParam1, "Extreme1", func_229(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 18:
			func_227(uParam1, "Extreme2", func_229(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171, 0, 19, 4, 2, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 19:
			func_227(uParam1, "Extreme3", func_229(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20, 4, 2, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 20:
			func_227(uParam1, "Extreme4", func_229(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, -1, 4, 2, 0, 2359, func_228(iParam0), 0, 0);
			break;
		
		case 21:
			func_227(uParam1, "Fanatic1", func_229(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, -1, 4, 1, 700, 2000, func_228(iParam0), 1, 0);
			break;
		
		case 22:
			func_227(uParam1, "Fanatic2", func_229(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1, -1, 4, 4, 700, 2000, func_228(iParam0), 1, 0);
			break;
		
		case 23:
			func_227(uParam1, "Fanatic3", func_229(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1, 4, 2, 700, 2000, func_228(iParam0), 0, 1);
			break;
		
		case 24:
			func_227(uParam1, "Hao1", func_229(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0, "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_228(iParam0), 0, 1);
			break;
		
		case 25:
			func_227(uParam1, "Hunting1", func_229(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 26:
			func_227(uParam1, "Hunting2", func_229(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, -1, 4, 4, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 27:
			func_227(uParam1, "Josh1", func_229(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_228(iParam0), 1, 0);
			break;
		
		case 28:
			func_227(uParam1, "Josh2", func_229(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0, 29, 4, 4, 0, 2359, func_228(iParam0), 1, 1);
			break;
		
		case 29:
			func_227(uParam1, "Josh3", func_229(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_228(iParam0), 1, 1);
			break;
		
		case 30:
			func_227(uParam1, "Josh4", func_229(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1, 4, 4, 0, 2359, func_228(iParam0), 1, 0);
			break;
		
		case 31:
			func_227(uParam1, "Maude1", func_229(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0, "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 32:
			func_227(uParam1, "Minute1", func_229(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 33:
			func_227(uParam1, "Minute2", func_229(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 34:
			func_227(uParam1, "Minute3", func_229(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0, -1, 4, 4, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 35:
			func_227(uParam1, "MrsPhilips1", func_229(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0, "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_228(iParam0), 0, 0);
			break;
		
		case 36:
			func_227(uParam1, "MrsPhilips2", func_229(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_228(iParam0), 0, 0);
			break;
		
		case 37:
			func_227(uParam1, "Nigel1", func_229(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1, -1, 1, 4, 0, 2359, func_228(iParam0), 1, 0);
			break;
		
		case 38:
			func_227(uParam1, "Nigel1A", func_229(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_228(iParam0), 1, 1);
			break;
		
		case 39:
			func_227(uParam1, "Nigel1B", func_229(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_228(iParam0), 1, 1);
			break;
		
		case 40:
			func_227(uParam1, "Nigel1C", func_229(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_228(iParam0), 1, 1);
			break;
		
		case 41:
			func_227(uParam1, "Nigel1D", func_229(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_228(iParam0), 1, 1);
			break;
		
		case 42:
			func_227(uParam1, "Nigel2", func_229(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_228(iParam0), 1, 1);
			break;
		
		case 43:
			func_227(uParam1, "Nigel3", func_229(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16, "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_228(iParam0), 1, 1);
			break;
		
		case 44:
			func_227(uParam1, "Omega1", func_229(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_228(iParam0), 0, 0);
			break;
		
		case 45:
			func_227(uParam1, "Omega2", func_229(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_228(iParam0), 0, 0);
			break;
		
		case 46:
			func_227(uParam1, "Paparazzo1", func_229(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 47:
			func_227(uParam1, "Paparazzo2", func_229(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 48:
			func_227(uParam1, "Paparazzo3", func_229(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183, 1, -1, 2, 2, 0, 2359, func_228(iParam0), 0, 0);
			break;
		
		case 49:
			func_227(uParam1, "Paparazzo3A", func_229(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 50:
			func_227(uParam1, "Paparazzo3B", func_229(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 51:
			func_227(uParam1, "Paparazzo4", func_229(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1, -1, 4, 2, 0, 2359, func_228(iParam0), 0, 0);
			break;
		
		case 52:
			func_227(uParam1, "Rampage1", func_229(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_228(iParam0), 0, 0);
			break;
		
		case 54:
			func_227(uParam1, "Rampage3", func_229(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_228(iParam0), 1, 0);
			break;
		
		case 55:
			func_227(uParam1, "Rampage4", func_229(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_228(iParam0), 1, 0);
			break;
		
		case 56:
			func_227(uParam1, "Rampage5", func_229(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_228(iParam0), 0, 0);
			break;
		
		case 53:
			func_227(uParam1, "Rampage2", func_229(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0, "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_228(iParam0), 1, 0);
			break;
		
		case 57:
			func_227(uParam1, "TheLastOne", func_229(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, -1, 4, 2, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 58:
			func_227(uParam1, "Tonya1", func_229(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 59:
			func_227(uParam1, "Tonya2", func_229(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 60:
			func_227(uParam1, "Tonya3", func_229(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 61:
			func_227(uParam1, "Tonya4", func_229(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_228(iParam0), 0, 1);
			break;
		
		case 62:
			func_227(uParam1, "Tonya5", func_229(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0, -1, 4, 2, 0, 2359, func_228(iParam0), 0, 1);
			break;
...
void func_227(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0x23D5F
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_228(int iParam0)//Position - 0x23DF0
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_229(int iParam0)//Position - 0x24137
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_230(int iParam0)//Position - 0x2416F
{
	struct<2> Var0;
...
bool func_232()//Position - 0x245EE
{
	return Global_113366 > 0;
}

int func_233()//Position - 0x245FC
{
	if (Global_97603 != -1)
	{
		return 1;
...
void func_238()//Position - 0x246DE
{
	if (iLocal_52)
	{
		if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		...
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_238, false) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_238, 50f, 50f, 50f, false, true, 0))
			{
				func_266(iLocal_238, 0, 145);
			}
		}
		...
		if (!PED::IS_PED_INJURED(iLocal_235) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			TASK::TASK_SMART_FLEE_PED(iLocal_235, PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
			PED::SET_PED_KEEP_TASK(iLocal_235, true);
		}
	}
	func_239(-1);
...
void func_239(int iParam0)//Position - 0x24815
{
	char cVar0[64];
	...
	if (func_237())
	{
		...
		func_243(30000);
		StringCopy(&cVar0, func_242(Global_113637, 1), 64);
	...
	func_241(&Global_32223);
	Global_113638 = 0;
	func_240(-1);
}

void func_240(int iParam0)//Position - 0x248C7
{
	Global_113637 = iParam0;
}

void func_241(var uParam0)//Position - 0x248D5
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_242(int iParam0, bool bParam1)//Position - 0x24912
{
	switch (iParam0)
	{
		case 0:
...
void func_243(int iParam0)//Position - 0x24B5B
{
	Global_43808 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_244(int iParam0)//Position - 0x24B6D
{
	func_245(iParam0, 0, func_265(iParam0));
}

void func_245(int iParam0, int iParam1, int iParam2)//Position - 0x24B82
{
	int iVar0;
	struct<16> Var1;
...
struct<16> func_246(int iParam0)//Position - 0x24BB1
{
	struct<16> Var0;
	int iVar1;
...
int func_247(int iParam0)//Position - 0x24C82
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_248(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_248(bool bParam0, int iParam1, int iParam2)//Position - 0x24CA4
{
	if (bParam0)
	{
		return iParam1;
...
int func_249(int iParam0)//Position - 0x24CBB
{
	return iParam0 & 15;
}

int func_250(int iParam0)//Position - 0x24CC8
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_251(int iParam0)//Position - 0x24CDA
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_252(int iParam0)//Position - 0x24CED
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_253(int iParam0)//Position - 0x24D00
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

void func_254(int iParam0, int iParam1)//Position - 0x24D13
{
	Global_113648.f_24997.f_43[iParam0] = *iParam1;
}

void func_255(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x24D2B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_256(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x24EAD
{
...
void func_257(var uParam0, int iParam1)//Position - 0x24EE5
{
	if (iParam1 <= 0)
	{
		return;
...
void func_258(var uParam0, int iParam1)//Position - 0x24F6B
{
	int iVar0;
	int iVar1;
...
void func_259(var uParam0, int iParam1)//Position - 0x24FBC
{
...
void func_260(var uParam0, int iParam1)//Position - 0x24FEF
{
...
void func_261(var uParam0, int iParam1)//Position - 0x25029
{
...
void func_262(var uParam0, int iParam1)//Position - 0x25064
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_263(int iParam0, int iParam1)//Position - 0x250A0
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_265(int iParam0)//Position - 0x25188
{
	int iVar0;
...
int func_266(int iParam0, int iParam1, int iParam2)//Position - 0x2532B
{
	var uVar0;
	char* sVar1;
...
void func_267(int iParam0, int iParam1)//Position - 0x2536B
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_268(iParam0, &(Global_113648.f_32751.f_5510));
}

void func_268(int iParam0, var uParam1)//Position - 0x2556D
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_270(&iParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
			{
				MISC::SET_BIT(&(uParam1->f_77), func_269(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_269(int iParam0)//Position - 0x25818
{
	switch (iParam0)
	{
		case 1:
...
int func_270(int iParam0, var uParam1, var uParam2)//Position - 0x258C8
{
	int iVar0;
	int iVar1;
...
int func_271(int iParam0)//Position - 0x25ABB
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_272(var uParam0)//Position - 0x25ADB
{
	int iVar0;
...
int func_273(int iParam0)//Position - 0x25B8C
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_291(iParam0, 0, 0)) || func_291(iParam0, 1, 0)) || func_291(iParam0, 2, 0)) || func_290(iParam0) != 145) || func_289(iParam0)) || func_288(iParam0)) || func_287(iParam0)) || func_286(iParam0)) || !func_274(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_288(iParam0))
		{
		}
...
int func_274(int iParam0)//Position - 0x25C69
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_275(int iParam0, bool bParam1, int iParam2)//Position - 0x25E1B
{
	int iVar0;
	struct<2> Var1;
	...
	{
		if ((func_280() || MISC::IS_PC_VERSION()) || func_279())
		{
		}
		else if (!func_282())
		{
...
int func_276(int iParam0)//Position - 0x25F9D
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_278(int iParam0, int iParam1)//Position - 0x26080
{
	int iVar0;
	int iVar1;
...
bool func_279()//Position - 0x296B2
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_280()//Position - 0x296C8
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_281()//Position - 0x296DE
{
	return 0;
}

int func_282()//Position - 0x296E7
{
	return 1;
}

int func_283()//Position - 0x296F0
{
	return 1;
}

int func_284()//Position - 0x296F9
{
...
int func_286(int iParam0)//Position - 0x297CA
{
	int iVar0;
	char* sVar1;
...
int func_287(int iParam0)//Position - 0x29811
{
	int iVar0;
...
int func_288(int iParam0)//Position - 0x2984C
{
	int iVar0;
...
int func_289(int iParam0)//Position - 0x298C8
{
	int iVar0;
...
int func_290(int iParam0)//Position - 0x299B0
{
	int iVar0;
...
int func_291(int iParam0, int iParam1, bool bParam2)//Position - 0x29A13
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	iVar0 = 0;
	while (func_292(iParam1, iVar0, &sVar1, &iVar2))
	{
...
int func_292(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x29A81
{
...
void func_293(int iParam0)//Position - 0x29B5A
{
	if (iParam0 == -1)
	{
		iParam0 = func_34();
...
void func_294()//Position - 0x29B90
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
int func_295(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x29BCD
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (func_27(func_202()))
		{
			if (func_318(func_202()) == 4 || func_318(func_202()) == 5)
			{
				return 0;
			}
		}
		if (func_27(func_202()))
		{
			if (!func_317(iParam1, bParam2, 145))
			{
				return 0;
			}
		}
		if (!func_316(Global_113648.f_24997.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (func_305(iParam1, bParam2) && !bParam3)
		{
			return 0;
		}
		...
		if ((iParam1 == 9 && (bParam2 == 2 || bParam2 == 5)) && !func_305(0, 0))
		{
			return 0;
		}
		if (Global_32310)
...
bool func_296(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x29F67
{
	if (bParam2)
	{
...
bool func_297(int iParam0)//Position - 0x29FAE
{
	int iVar0;
...
int func_298(int iParam0)//Position - 0x29FCF
{
	return func_299(iParam0, 1);
}

int func_299(int iParam0, int iParam1)//Position - 0x29FDE
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	func_300(iParam0, &uVar0, &uVar1, &iVar2, &iVar3, &iVar4, &iVar5);
...
void func_300(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2A031
{
	func_301(func_264(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_301(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x2A04F
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_303(iParam0, iParam1))
	{
		...
		iVar5 = (func_253(iParam0) - func_253(iParam1));
		iVar6 = (func_252(iParam0) - func_252(iParam1));
		iVar7 = (func_251(iParam0) - func_251(iParam1));
	}
	else
	{
		...
		iVar5 = (func_253(iParam1) - func_253(iParam0));
		iVar6 = (func_252(iParam1) - func_252(iParam0));
		iVar7 = (func_251(iParam1) - func_251(iParam0));
	}
	while (iVar7 < 0)
	{
		iVar7 += 60;
	...
	while (iVar4 < 0)
	{
		...
		iVar4 = (iVar4 + func_263(iVar0, iVar1));
		iVar3 = (iVar3 - 1);
		iVar0 = SYSTEM::ROUND(func_302(SYSTEM::TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
float func_302(float fParam0, float fParam1, float fParam2)//Position - 0x2A250
{
	float fVar0;
...
int func_303(int iParam0, int iParam1)//Position - 0x2A292
{
	int iVar0;
	int iVar1;
...
int func_304(int iParam0)//Position - 0x2A39E
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar5 < 1 || iVar5 > func_263(iVar4, iVar3))
	{
		return 0;
	}
	return 1;
...
int func_305(int iParam0, bool bParam1)//Position - 0x2A47A
{
...
int func_306(int iParam0)//Position - 0x2A49A
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_314()) || Global_112695) || Global_32166) || func_313()) || func_199(8, -1)) || func_312()) || func_311()) || func_310()) || func_309()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_314()) || Global_32166) || func_313()) || func_199(8, -1)) || func_310()) || func_312()) || func_311()) || func_309()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_314()) || Global_112695) || Global_32166) || func_313()) || func_199(8, -1)) || func_310()) || func_312()) || func_311()) || func_309()) || Global_113648.f_7690.f_919[iVar0] == 5) || Global_43804 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_314()) || Global_112695) || Global_32166) || func_313()) || func_199(8, -1)) || func_312()) || func_311()) || func_309()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_314() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_199(8, -1)) || func_309()) || func_308()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_199(8, -1) || func_312()) || func_311()) || func_308()) || func_307())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_314()) || Global_32166) || func_313()) || func_199(8, -1)) || func_311()) || func_310()) || func_309()) || Global_113648.f_7690.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_314()) || func_311()) || Global_112695) || Global_32166) || func_313()) || Global_44446) || func_199(8, -1)) || func_310()) || func_308()) || func_309()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_314()) || Global_112695) || Global_32166) || func_313()) || func_199(8, -1)) || func_310()) || func_308()) || func_312()) || func_311()) || func_309())
						{
							return 0;
						}
						break;
...
var func_307()//Position - 0x2ABB7
{
	return Global_100720.f_1;
}

int func_308()//Position - 0x2ABC5
{
	if (Global_97603 != -1)
	{
...
bool func_311()//Position - 0x2AC2C
{
	return Global_100733.f_388 > 0;
}

bool func_312()//Position - 0x2AC3D
{
	return Global_100733.f_387 > 0;
}

var func_313()//Position - 0x2AC4E
{
	return Global_1575060;
}

int func_314()//Position - 0x2AC5A
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_316(int iParam0)//Position - 0x2AC9E
{
	return func_303(func_264(), iParam0);
}

int func_317(int iParam0, int iParam1, int iParam2)//Position - 0x2ACB0
{
	int iVar0;
	int iVar1;
...
int func_318(int iParam0)//Position - 0x2AD94
{
	if (!func_27(iParam0))
	{
		return 7;
...
int func_319(int iParam0)//Position - 0x2ADB8
{
	int iVar0;
	int iVar1;
...
Vector3 func_321()//Position - 0x2AE54
{
	float fVar0;
	
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_261, true);
		bLocal_263 = true;
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_262, true) < fVar0)
		{
			fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_262, true);
			bLocal_263 = 2;
		}
		if (bLocal_263 == 1)
		{
