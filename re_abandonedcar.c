...
void __EntryFunction__()//Position - 0x0
{
	...
	Local_282 = { 2162.5518f, 2122.646f, 124.7956f };
	...
	if (func_295(Local_56, 23, bLocal_285, 0, 0))
	{
		func_293(-1);
	}
	else
			...
			switch (iLocal_51)
			{
				...
				case 1:
					...
					if (!iLocal_261)
					{
						...
						{
							if (func_205(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_254, true), 1) < IntToFloat(iLocal_274) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_254))
							{
								if (!iLocal_268)
								{
									func_203();
									...
									if (iLocal_52 == 1)
									{
										if (func_202() == 0)
										{
											func_187(&uLocal_84, "re_acau", "re_ac_approM", 4, 0, 0, 0);
										}
										else if (func_202() == 1)
										{
											func_187(&uLocal_84, "re_acau", "re_ac_approF", 4, 0, 0, 0);
										}
										else if (func_202() == 2)
										{
											func_187(&uLocal_84, "re_acau", "re_ac_approT", 4, 0, 0, 0);
										}
									}
									else if (iLocal_52 == 2)
									{
										if (func_202() == 0)
										{
											func_187(&uLocal_84, "reac2au", "reac2_approM", 4, 0, 0, 0);
										}
										else if (func_202() == 1)
										{
											func_187(&uLocal_84, "reac2au", "reac2_approF", 4, 0, 0, 0);
										}
										else if (func_202() == 2)
										{
											func_187(&uLocal_84, "reac2au", "reac2_approT", 4, 0, 0, 0);
										}
									}
...
void func_2()//Position - 0x391
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_252, false))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_252, 10f, 10f, 10f, false, true, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			{
				func_187(&uLocal_84, "re_acau", "re_ac_attac2", 4, 0, 0, 0);
			...
			{
				func_187(&uLocal_84, "re_acau", "re_ac_attac1", 4, 0, 0, 0);
				TASK::TASK_LOOK_AT_ENTITY(iLocal_252, PLAYER::PLAYER_PED_ID(), 4000, 0, 2);
				SYSTEM::SETTIMERB(0);
				iLocal_272++;
			}
		...
		if (!PED::IS_PED_INJURED(iLocal_252))
		{
			if (!iLocal_264)
			{
				if (PED::IS_PED_BEING_STUNNED(PLAYER::PLAYER_PED_ID(), 0))
				{
					iLocal_264 = 1;
					iLocal_275++;
					func_187(&uLocal_84, "re_acau", "re_ac_rambl", 4, 0, 0, 0);
					SYSTEM::SETTIMERA(0);
				}
			}
	...
	else
	{
		...
		switch (iLocal_278)
		{
			...
			case 2:
				...
				iLocal_255 = VEHICLE::CREATE_MISSION_TRAIN(0, 1063.5955f, 3227.5706f, 39.3899f, true, 0, 0);
			...
			case 4:
				...
				if (SYSTEM::TIMERA() > 2000 && SYSTEM::TIMERA() < 3000)
				{
					if (func_202() == 0)
					{
						func_187(&uLocal_84, "re_acau", "re_ac_awakeM", 4, 0, 0, 0);
					}
					else if (func_202() == 1)
					{
						func_187(&uLocal_84, "re_acau", "re_ac_awakeF", 4, 0, 0, 0);
					}
					else if (func_202() == 2)
					{
						func_187(&uLocal_84, "re_acau", "re_ac_awakeT", 4, 0, 0, 0);
					}
				}
...
int func_44(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1FA5
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_96(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_96(iVar10, 14, uVar69[iVar1], -1) };
			func_65(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_88(14);
			if (Global_78339 == 1)
			{
...
void func_90(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x92C0
{
	...
	iVar0 = Global_2805029[iParam0 /*3*/][func_91(iParam2)];
	if (iVar0 != 0)
	{
...
void func_98(int iParam0)//Position - 0xCB9F
{
	...
	func_99(&(Global_78341[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEEC9
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_99(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_99(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
				...
				if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_252, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, false, true, 0) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_252, Local_71, 215f, 215f, 215f, false, true, 0))
				{
					if ((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_252) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_252)) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_252, Local_71, 215f, 215f, 215f, false, true, 0))
					{
						if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_252, Local_71, 215f, 215f, 215f, false, true, 0))
						{
							...
							func_203();
							SYSTEM::WAIT(0);
							func_187(&uLocal_84, "re_acau", "re_ac_aim", 4, 0, 0, 0);
							func_15();
						}
					}
				}
...
void func_172()//Position - 0x20804
{
		...
		if (!func_3())
		{
			if (!iLocal_270)
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_252, 30f, 30f, 10f, false, true, 0))
				{
					if (func_202() == 0)
					{
						func_187(&uLocal_84, "reac2au", "reac2_attacM", 4, 0, 0, 0);
					}
					else if (func_202() == 1)
					{
						func_187(&uLocal_84, "reac2au", "reac2_attacF", 4, 0, 0, 0);
					}
					else if (func_202() == 2)
					{
						func_187(&uLocal_84, "reac2au", "reac2_attacT", 4, 0, 0, 0);
					}
				}
				iLocal_270 = 1;
			}
			if (iLocal_276 < MISC::GET_GAME_TIMER())
			{
				if (func_175())
				{
					if (!PED::IS_PED_INJURED(iLocal_252))
					{
						if (!TASK::IS_PED_IN_WRITHE(iLocal_252))
						{
							func_187(&uLocal_84, "reac2au", "reac2_attac2", 4, 0, 0, 0);
				...
				else if (!PED::IS_PED_INJURED(iLocal_253))
				{
					...
					{
						func_187(&uLocal_84, "reac2au", "reac2_attac3", 4, 0, 0, 0);
						iLocal_276 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(4500, 5000));
					}
				}
			}
	...
	if (!PED::IS_PED_INJURED(iLocal_252))
	{
		if (!TASK::IS_PED_IN_WRITHE(iLocal_252))
		{
			...
			{
				if ((!iLocal_265 && !func_173("reac2_attac1")) && iLocal_278 < 3)
				{
					func_203();
					SYSTEM::WAIT(0);
					if (iLocal_52 == 1)
					{
						func_187(&uLocal_84, "re_acau", "re_ac_flee", 4, 0, 0, 0);
					}
					else if (iLocal_52 == 2)
					{
						func_187(&uLocal_84, "reac2au", "reac2_flee", 4, 0, 0, 0);
					}
					iLocal_265 = 1;
				}
			}
	...
	if (!PED::IS_PED_INJURED(iLocal_252))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_252, false))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(iLocal_252, false), false))
			{
				...
				if (func_237() && !iLocal_269)
				{
					if (!func_3())
					{
						func_187(&uLocal_84, "reac2au", "reac2_sex", 4, 0, 0, 0);
						iLocal_269 = 1;
					}
				}
			}
		...
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_254, false)) || iLocal_52 == 2)
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_254, Local_75, false, true, 0) || iLocal_260)
			{
				if (iLocal_52 == 1)
				{
					...
					{
						iLocal_252 = PED::CREATE_PED(19, iLocal_258, Local_59 - Vector(1f, 0f, 0f), func_185(Local_59, func_186(PLAYER::PLAYER_ID())), true, true);
					}
					else if (!CAM::IS_SPHERE_VISIBLE(Local_62, 2f))
					{
						iLocal_252 = PED::CREATE_PED(19, iLocal_258, Local_62 - Vector(1f, 0f, 0f), func_185(Local_62, func_186(PLAYER::PLAYER_ID())), true, true);
					}
					else if (!CAM::IS_SPHERE_VISIBLE(Local_65, 2f))
					{
						iLocal_252 = PED::CREATE_PED(19, iLocal_258, Local_65 - Vector(1f, 0f, 0f), func_185(Local_65, func_186(PLAYER::PLAYER_ID())), true, true);
					}
					else if (!CAM::IS_SPHERE_VISIBLE(Local_68, 2f))
					{
						iLocal_252 = PED::CREATE_PED(19, iLocal_258, Local_68 - Vector(1f, 0f, 0f), func_185(Local_68, func_186(PLAYER::PLAYER_ID())), true, true);
					}
					if (!PED::IS_PED_INJURED(iLocal_252))
					{
				...
				else if (iLocal_52 == 2)
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_253))
					{
						iLocal_250 = func_181(iLocal_253, 1, 145);
					...
					if (!PED::IS_PED_INJURED(iLocal_252) && !PED::IS_PED_INJURED(iLocal_253))
					{
						func_187(&uLocal_84, "reac2au", "reac2_attac1", 4, 0, 0, 0);
					}
					iLocal_261 = 1;
				}
			}
...
float func_185(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)//Position - 0x21432
{
...
float func_205(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x21BCF
{
	struct<3> Var0;
...
void func_206()//Position - 0x21C09
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_254, false))
	{
		if (!func_237())
		{
			if (func_205(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_254, true), 1) < IntToFloat(iLocal_273))
			{
				if (HUD::DOES_BLIP_EXIST(iLocal_251))
				{
					HUD::REMOVE_BLIP(&iLocal_251);
				}
				iLocal_251 = func_218(iLocal_254, 0, 0);
...
void func_222()//Position - 0x22533
{
	...
	if (func_202() == 0)
	{
		func_184(&uLocal_84, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	}
	else if (func_202() == 1)
	{
		func_184(&uLocal_84, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	else if (func_202() == 2)
	{
		func_184(&uLocal_84, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	}
	...
	else if (iLocal_52 == 2)
	{
		...
		func_184(&uLocal_84, 4, iLocal_252, "INCESTBRO1", 0, 1);
		...
		func_184(&uLocal_84, 5, iLocal_253, "INCESTBRO2", 0, 1);
...
void func_223()//Position - 0x228F2
{
	if (iLocal_52 == 1)
	{
		...
		Local_71 = { 1430.0726f, 2976.3992f, 39.7694f };
		fLocal_74 = 131.558f;
	...
	else if (iLocal_52 == 2)
	{
		...
		Local_71 = { 2162.5518f, 2122.646f, 124.7956f };
		fLocal_74 = 218.6214f;
...
void func_227(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, struct<3> Param7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)//Position - 0x23D5F
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_295(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x29BCD
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (func_27(func_202()))
		{
			if (!func_317(iParam3, bParam4, 145))
			{
				return 0;
			}
		}
		if (!func_316(Global_113648.f_24997.f_43[iParam3]))
		{
			return 0;
		}
		...
		if (func_305(iParam3, bParam4) && !bParam5)
		{
			return 0;
		}
		...
		if ((iParam3 == 9 && (bParam4 == 2 || bParam4 == 5)) && !func_305(0, 0))
		{
			return 0;
		}
		if (Global_32310)
...
bool func_296(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x29F67
{
	if (bParam6)
	{
