...
void func_31()//Position - 0x1119
{
	...
	{
		func_33(13, SYSTEM::FLOOR(Global_113810.f_10197.f_3853));
	}
...
int func_50(int iParam0, var uParam1)//Position - 0x21A5
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(uParam1));
}

int func_51(int iParam0)//Position - 0x21BA
{
	int iVar0;
	int iVar1;
...
int func_52(int iParam0, int iParam1)//Position - 0x21EE
{
	int iVar0;
	var uVar1;
...
int func_53()//Position - 0x221D
{
	return 1;
}

int func_54()//Position - 0x2226
{
	if (Global_32523)
	{
		func_29(4);
...
void func_55()//Position - 0x223E
{
	Global_20711 = 0;
	func_56();
}

void func_56()//Position - 0x224E
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22856 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_57(int iParam0)//Position - 0x226F
{
	Global_22856 = iParam0;
}

int func_58()//Position - 0x227C
{
...
bool func_59()//Position - 0x2298
{
	return Global_32522;
}

void func_60()//Position - 0x22A3
{
	func_62();
	while (func_61())
	{
...
void func_62()//Position - 0x22E4
{
	Global_20711 = 0;
	func_63();
}

void func_63()//Position - 0x22F4
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_66(var uParam0, int iParam1)//Position - 0x289E
{
...
struct<6> func_67()//Position - 0x28BB
{
	struct<6> Var0;
	int iVar6;
...
int func_70(int iParam0, bool bParam1, int iParam2)//Position - 0x2FB2
{
	int iVar0;
...
int func_71(int iParam0, bool bParam1, bool bParam2)//Position - 0x2FFC
{
	int iVar0;
...
float func_72(bool bParam0, float fParam1, float fParam2)//Position - 0x30A0
{
	if (bParam0)
	{
		return fParam1;
...
void func_73(int iParam0, bool bParam1, int iParam2)//Position - 0x30B7
{
	bool bVar0;
	int iVar1;
...
void func_74(int iParam0, int iParam1)//Position - 0x31E0
{
	int iVar0;
...
void func_75(int iParam0, int iParam1, int iParam2)//Position - 0x3215
{
...
void func_76(int iParam0, int iParam1, int iParam2)//Position - 0x325A
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_77(int iParam0, int iParam1)//Position - 0x329F
{
	if (iParam1 > -1)
	{
...
void func_78(int iParam0)//Position - 0x32DC
{
	if (iParam0 != -1)
	{
...
void func_79(int iParam0, int iParam1, int iParam2)//Position - 0x3313
{
	int iVar0;
...
int func_81(int iParam0, var uParam1)//Position - 0x3375
{
	if (Global_1575051)
	{
		return 0;
...
void func_83(int iParam0, int iParam1, bool bParam2)//Position - 0x3408
{
	int iVar0;
		...
		if (bParam2)
		{
			if (!Global_78689)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9029[iParam1 /*4*/] = { func_85(iParam0) };
					...
					{
						Global_8980[1 /*6*/] = { func_85(iParam0) };
...
struct<4> func_85(int iParam0)//Position - 0x35FF
{
	return Global_2058[iParam0 /*29*/].f_3;
}

int func_86(int iParam0, int iParam1)//Position - 0x3612
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
int func_87(int iParam0, int iParam1)//Position - 0x363C
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_88(int iParam0, int iParam1)//Position - 0x3666
{
	Global_113810.f_243[func_92() /*53*/].f_2[iParam0 /*5*/].f_1 = iParam1;
}

int func_89(int iParam0, int iParam1)//Position - 0x3684
{
...
int func_90(int iParam0)//Position - 0x36A0
{
	switch (iParam0)
	{
		case 0:
...
int func_91(int iParam0)//Position - 0x373D
{
	switch (iParam0)
	{
		case 0:
...
void func_93(int iParam0, int iParam1)//Position - 0x3827
{
...
void func_94(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x3864
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x3936
{
	float fVar0;
	bool bVar1;
	int iVar2;
...
void func_96(bool bParam0)//Position - 0x3F35
{
	int iVar0;
	int iVar1;
...
void func_97(int iParam0)//Position - 0x41B9
{
	int iVar0;
...
void func_98(bool bParam0)//Position - 0x4213
{
	bool bVar0;
	char cVar1[64];
	...
	else if (BitTest(Global_113810.f_20567.f_471, bParam0) || BitTest(Global_2359296[func_82() /*5568*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), bParam0);
...
char* func_99(bool bParam0)//Position - 0x438B
{
	switch (bParam0)
	{
		case 0:
...
void func_100(int iParam0)//Position - 0x448C
{
	func_118(93, iParam0);
	func_118(29, iParam0);
	func_118(30, iParam0);
...
int func_101(int iParam0)//Position - 0x44AC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_102(int iParam0, int iParam1)//Position - 0x464C
{
	if (iParam1 == -1)
	{
		iParam1 = func_35();
...
int func_103(bool bParam0)//Position - 0x4668
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_104(int iParam0, int iParam1)//Position - 0x471F
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_105(int iParam0, int iParam1)//Position - 0x473A
{
	...
	if (func_115(&Global_4542602))
	{
		if (func_113(&Global_4542602, iParam0))
		{
			return 0;
		}
		if (func_106(&Global_4542602, iParam0))
		{
			return 1;
		}
	}
...
int func_106(var uParam0, int iParam1)//Position - 0x47D7
{
	int iVar0;
	var uVar1[78];
...
int func_107(var uParam0, int iParam1)//Position - 0x4888
{
	int iVar0;
...
bool func_108(var uParam0, int iParam1)//Position - 0x4903
{
	return (*uParam0)[iParam1] == 78;
}

void func_109(var uParam0)//Position - 0x4914
{
	int iVar0;
	...
	func_111(uParam0, (Global_4542601 - 0.5f));
}

void func_110(var uParam0, int iParam1)//Position - 0x4948
{
	(*uParam0)[iParam1] = 78;
}

void func_111(var uParam0, float fParam1)//Position - 0x4958
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_112(var uParam0)//Position - 0x4975
{
	return uParam0->f_80;
}

bool func_113(var uParam0, int iParam1)//Position - 0x4981
{
	return func_114(uParam0, iParam1) != -1;
}

int func_114(var uParam0, int iParam1)//Position - 0x4993
{
	int iVar0;
...
bool func_115(var uParam0)//Position - 0x49C0
{
	return uParam0->f_79 == 1;
}

int func_116(int iParam0)//Position - 0x49CE
{
	switch (iParam0)
	{
		case 60:
...
void func_117(int iParam0, int iParam1)//Position - 0x4A1E
{
	int iVar0;
...
void func_118(int iParam0, int iParam1)//Position - 0x4A41
{
	int iVar0;
...
int func_120(int iParam0)//Position - 0x4B13
{
	return Global_2058[iParam0 /*29*/].f_17;
}

void func_121()//Position - 0x4B24
{
	if (!PED::IS_PED_INJURED(iLocal_83))
	{
...
int func_122()//Position - 0x4CEB
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

void func_123(bool bParam0)//Position - 0x4CFB
{
	if (bParam0)
	{
		if (iLocal_125)
...
struct<6> func_124()//Position - 0x4D56
{
	struct<6> Var0;
...
int func_126(char* sParam0)//Position - 0x5008
{
	var uVar0;
...
bool func_127(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x5030
{
...
int func_132(struct<3> Param0, bool bParam3)//Position - 0x55D7
{
	int iVar0;
...
int func_134(char* sParam0)//Position - 0x56EE
{
	var uVar0;
...
int func_139(struct<3> Param0)//Position - 0x5B8F
{
	if (func_13() == 2)
	{
		if (func_59() && !Global_32525)
		{
			if (fLocal_45 == -1f)
			{
...
void func_141()//Position - 0x6AD7
{
	if (iLocal_58 != 3)
	{
		if (func_144())
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_83))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_91, 3f, 3f, 2f, true, true, 0) && ENTITY::IS_ENTITY_AT_COORD(iLocal_83, Local_91, Global_19, false, true, 0))
				{
					if (func_143(1, 0, 1))
					{
						func_142();
	...
	else if (bLocal_110)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_83))
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 805.501f, 1269.9261f, 361.4025f, 25f, 30f, 2f, false, true, 0) || (ENTITY::IS_ENTITY_AT_COORD(iLocal_83, 824.8886f, 1275.6705f, 359.4312f, Global_19, true, true, 0) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_83, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, false, true, 0)))
			{
				func_55();
				SYSTEM::WAIT(0);
...
void func_142()//Position - 0x6CBE
{
	Global_20711 = 0;
	func_22();
}

int func_143(bool bParam0, bool bParam1, bool bParam2)//Position - 0x6CCE
{
	int iVar0;
...
void func_146(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, struct<3> Param7, int iParam10, float fParam11)//Position - 0x7115
{
	struct<3> Var0;
...
int func_147(struct<3> Param0)//Position - 0x734A
{
...
float func_148(int iParam0, int iParam1, bool bParam2)//Position - 0x7374
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_149(int iParam0, var uParam1, var uParam2)//Position - 0x73D2
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
float func_150(struct<2> Param0, Vector3 vParam2, struct<2> Param3, Vector3 vParam5)//Position - 0x7402
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param3.f_0 - Param0.f_0), (Param3.f_1 - Param0.f_1));
}

int func_151(int iParam0)//Position - 0x741C
{
	int iVar0;
...
void func_152(int* iParam0, int* iParam1, int* iParam2, int* iParam3)//Position - 0x7467
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var4;
...
void func_153(int* iParam0, int* iParam1, int* iParam2, int* iParam3)//Position - 0x75B2
{
	int iVar0;
	int iVar1;
...
float func_156(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, int iParam6)//Position - 0x7ABB
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_157(int iParam0)//Position - 0x7B20
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_158(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x7B33
{
	func_23(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_159(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x7B87
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_162(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17)//Position - 0x87E8
{
	int iVar0;
	int iVar1;
...
void func_163(int iParam0, int iParam1)//Position - 0x8945
{
	MISC::SET_BIT(&(Global_1655612.f_7009[iParam0]), iParam1);
}

int func_164(int iParam0, int iParam1)//Position - 0x895E
{
	return BitTest(Global_1655612.f_7009[iParam0], iParam1);
}

int func_165(int iParam0)//Position - 0x8974
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_166(int iParam0)//Position - 0x8987
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_167()//Position - 0x899A
{
	var uVar0;
...
void func_168(var uParam0, int iParam1)//Position - 0x89E0
{
	if (iParam1 <= 0)
	{
		return;
...
void func_169(var uParam0, int iParam1)//Position - 0x8A66
{
...
void func_170(var uParam0, int iParam1)//Position - 0x8A99
{
	int iVar0;
	int iVar1;
...
int func_171(int iParam0, int iParam1)//Position - 0x8AEA
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_172(int iParam0)//Position - 0x8B8C
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_173(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_173(bool bParam0, int iParam1, int iParam2)//Position - 0x8BAE
{
	if (bParam0)
	{
		return iParam1;
...
int func_174(int iParam0)//Position - 0x8BC5
{
	return iParam0 & 15;
}

void func_175(var uParam0, int iParam1)//Position - 0x8BD2
{
...
void func_176(var uParam0, int iParam1)//Position - 0x8C0C
{
...
void func_177(var uParam0, int iParam1)//Position - 0x8C47
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
void func_180(char* sParam0, int iParam1)//Position - 0x8E40
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

void func_181()//Position - 0x8E57
{
	int iVar0;
...
float func_183(int iParam0, int iParam1)//Position - 0x94B3
{
	return func_148(iParam0, iParam1, 1);
}

void func_184()//Position - 0x94C4
{
	int iVar0;
...
void func_191()//Position - 0xAD1E
{
	...
	else if (iLocal_58 == 2)
	{
		...
		TASK::TASK_PLAY_ANIM(iLocal_83, "random@hitch_lift", "idle_f", 2f, -2f, -1, 49, 0f, false, false, false);
		PED::ADD_SCENARIO_BLOCKING_AREA(Local_91 - Vector(20f, 50f, 50f), Local_91 + Vector(20f, 50f, 50f), false, true, true, true);
		func_192(1);
	}
	else if (iLocal_58 == 3)
	{
...
void func_192(bool bParam0)//Position - 0xAF81
{
	if (bParam0)
	{
...
void func_193(int iParam0, bool bParam1)//Position - 0xAFAD
{
	if (bParam1)
	{
...
void func_194(int iParam0, int iParam1, bool bParam2)//Position - 0xAFE4
{
	int iVar0;
...
int func_195(int iParam0)//Position - 0xB054
{
	switch (iParam0)
	{
		case 0:
...
void func_196(int iParam0, int iParam1, bool bParam2)//Position - 0xB3FC
{
	int iVar0;
...
int func_197(int iParam0, int iParam1, bool bParam2)//Position - 0xB46C
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_198(int iParam0)//Position - 0xB4CC
{
	if (func_201())
	{
		Global_113800 = 1;
		Global_113797 = MISC::GET_GAME_TIMER();
		if (func_37(Global_113799))
		{
			func_199(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /* GXT: Random Event */);
		if (iParam0 && func_37(Global_113799))
		{
...
void func_199(int iParam0)//Position - 0xB51F
{
	switch (iParam0)
	{
		case 0:
...
char* func_200(int iParam0)//Position - 0xB5FA
{
	char* sVar0;
...
int func_201()//Position - 0xB63C
{
	switch (func_202(&Global_32343, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_202(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB672
{
	int iVar0;
...
void func_203(var uParam0, int iParam1)//Position - 0xB7A9
{
	int iVar0;
...
bool func_204(int iParam0)//Position - 0xB7F8
{
	return func_205(iParam0, Global_43377);
}

int func_205(int iParam0, int iParam1)//Position - 0xB809
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_206(int iParam0)//Position - 0xB9EA
{
	if (Global_43377 == 15)
	{
		return 0;
...
int func_211(float fParam0, bool bParam1)//Position - 0xBE48
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_212(int iParam0, var uParam1)//Position - 0xBEF9
{
	switch (iParam0)
	{
		case 0:
...
{
	if ((Global_113799 == func_46() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_113800)
	{
		return 1;
	}
	return 0;
...
int func_227(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xDB69
{
	...
	if (!bVar0)
	{
		...
		if (!func_250(Global_113810.f_24998.f_43[iParam3]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_248()) || Global_32286) || func_247()) || func_21(8, -1)) || func_244()) || func_246()) || func_245()) || func_243()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_248()) || Global_112857) || Global_32286) || func_247()) || func_21(8, -1)) || func_244()) || func_246()) || func_245()) || func_243()) || Global_113810.f_7691.f_919[iVar0] == 5) || Global_43924 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_248()) || Global_112857) || Global_32286) || func_247()) || func_21(8, -1)) || func_246()) || func_245()) || func_243()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_248() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_21(8, -1)) || func_243()) || func_242()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_248()) || Global_32286) || func_247()) || func_21(8, -1)) || func_245()) || func_244()) || func_243()) || Global_113810.f_7691.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_248()) || Global_112857) || Global_32286) || func_247()) || func_21(8, -1)) || func_244()) || func_242()) || func_246()) || func_245()) || func_243())
						{
							return 0;
						}
						break;
