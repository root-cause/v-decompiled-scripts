...
void func_14()//Position - 0xBAD
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_17(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_15(iVar0) && (!func_19(14) || Global_113083))
			{
		...
		if (bParam2)
		{
			if (!Global_79539)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9595[iParam1 /*4*/] = { func_85(iParam0) };
					...
					{
						Global_9546[1 /*6*/] = { func_85(iParam0) };
...
void func_98(bool bParam0)//Position - 0x421D
{
	...
	else if (BitTest(Global_114135.f_20568.f_471, bParam0) || BitTest(Global_2359296[func_82() /*5571*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_114135.f_20568.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_82() /*5571*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
int func_101(int iParam0)//Position - 0x44B6
{
	...
	return BitTest(Global_2359296[func_82() /*5571*/].f_681.f_10, iParam0);
}
...
void func_141()//Position - 0x6AE1
{
	if (iLocal_58 != 3)
	{
		if (func_144())
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_83))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_91, 3f, 3f, 2f, true, true, 0) && ENTITY::IS_ENTITY_AT_COORD(iLocal_83, Local_91, Global_22, false, true, 0))
				{
					if (func_143(1, 0, 1))
					{
						func_142();
	...
	else if (bLocal_110)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_83))
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 805.501f, 1269.9261f, 361.4025f, 25f, 30f, 2f, false, true, 0) || (ENTITY::IS_ENTITY_AT_COORD(iLocal_83, 824.8886f, 1275.6705f, 359.4312f, Global_22, true, true, 0) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_83, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, false, true, 0)))
			{
				func_55();
				SYSTEM::WAIT(0);
...
int func_197(int iParam0, int iParam1, bool bParam2)//Position - 0xB48A
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_198(int iParam0)//Position - 0xB4EA
{
	if (func_201())
	{
		Global_114125 = 1;
		...
		if (iParam0 && func_37(Global_114124))
		{
...
int func_201()//Position - 0xB65A
{
	switch (func_202(&Global_33147, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
bool func_204(int iParam0)//Position - 0xB816
{
	return func_205(iParam0, Global_44181);
}

int func_205(int iParam0, int iParam1)//Position - 0xB827
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_206(int iParam0)//Position - 0xBA08
{
	if (Global_44181 == 15)
	{
		return 0;
...
{
	if ((Global_114124 == func_46() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_114125)
	{
		return 1;
	}
	return 0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_248()) || Global_33090) || func_247()) || func_21(8, -1)) || func_244()) || func_246()) || func_245()) || func_243()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_248()) || Global_113182) || Global_33090) || func_247()) || func_21(8, -1)) || func_244()) || func_246()) || func_245()) || func_243()) || Global_114135.f_7692.f_919[iVar0] == 5) || Global_44728 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_248()) || Global_113182) || Global_33090) || func_247()) || func_21(8, -1)) || func_246()) || func_245()) || func_243()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_248() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_21(8, -1)) || func_243()) || func_242()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_248()) || Global_33090) || func_247()) || func_21(8, -1)) || func_245()) || func_244()) || func_243()) || Global_114135.f_7692.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_248()) || Global_113182) || Global_33090) || func_247()) || func_21(8, -1)) || func_244()) || func_242()) || func_246()) || func_245()) || func_243())
						{
							return 0;
						}
						break;
...
void func_257(int iParam0)//Position - 0xF06D
{
	...
	if (func_223())
	{
		...
		func_260(30000);
		StringCopy(&cVar0, func_259(Global_114124, 1), 64);
...
int func_272(var uParam0)//Position - 0xFA42
{
	int iVar0;
...
int func_273(int iParam0)//Position - 0xFA64
{
...
int func_275(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xFAB1
{
	int iVar0;
