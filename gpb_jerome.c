...
float func_86(struct<3> Param0, struct<3> Param1)//Position - 0x2E00
{
...
void func_105()//Position - 0x30E7
{
	...
	bLocal_265 = !Global_3;
	iLocal_218 = 8;
	sLocal_226 = "PBJS_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to Jesse. */;
...
int func_109()//Position - 0x31E1
{
	return 1;
}

bool func_110(var uParam0)//Position - 0x31EA
{
	return func_111(Global_113386.f_20117, uParam0);
}

bool func_111(var uParam0, var uParam1)//Position - 0x31FF
{
	return (uParam0 && uParam1) != 0;
}

int func_112(char* sParam0)//Position - 0x320E
{
...
void func_113(int iParam0)//Position - 0x3335
{
	var uVar0;
...
void func_114(int* iParam0)//Position - 0x3404
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_115()//Position - 0x3424
{
	struct<6> Var0;
...
void func_116()//Position - 0x3448
{
	func_117();
}

void func_117()//Position - 0x3454
{
}

void func_118()//Position - 0x345C
{
	if (iLocal_211 == -1)
	{
