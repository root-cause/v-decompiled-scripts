...
void func_104(int iParam0)//Position - 0x6D18
{
	...
	if (MONEY::NETWORK_CAN_SPEND_MONEY(1, false, false, true, -1, 0))
	{
		if (func_117())
		{
			func_105(1976384368, 1, &iVar1, 0, 0, 1);
...
void func_105(int iParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0x6D85
{
	...
	switch (iParam0)
	{
		...
		case 1815541181:
			...
			{
				func_106(uParam2, -1135378931, 537254313, 1474183246, iParam0, iParam1, iVar0, 7);
			}
			break;
		...
		case 1138089938:
		case -561012053:
			func_106(uParam2, -1135378931, 1445302971, 1474183246, iParam0, iParam1, iVar0, 7);
			break;
	}
	switch (iParam0)
	{
...
void func_122(var uParam0, var uParam1, bool bParam2, bool bParam3, var uParam4, var uParam5)//Position - 0x7CC3
{
	if (MISC::IS_PC_VERSION() && !NETWORK::NETWORK_TEXT_CHAT_IS_TYPING())
	{
		...
		if (func_124(0, 0, 0) || PAD::IS_CONTROL_PRESSED(2, 188))
		{
			*uParam0 = 1;
		}
		if (func_123(0, 0, 0) || PAD::IS_CONTROL_PRESSED(2, 187))
		{
			*uParam1 = 1;
		}
