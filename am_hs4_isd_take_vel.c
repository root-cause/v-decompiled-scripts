...
void func_286(var uParam0)//Position - 0x33132
{
	...
	func_287(&uLocal_93, 4494.8423f, -4522.1455f, 4.9819f, -10.7044f, 0.1567f, 155.8207f, "HS4_ISD_TAKE_VEL", 0, 1, uParam0->f_4, 0);
}
...
void func_288(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x331AF
{
	uParam0->f_1 = uParam1;
	uParam0->f_2 = uParam3;
...
void func_289(var uParam0, int iParam1, char* sParam2)//Position - 0x331DC
{
