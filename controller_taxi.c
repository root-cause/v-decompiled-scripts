					...
					if (iVar1 != 2)
					{
						if ((!MISC::IS_MINIGAME_IN_PROGRESS() && !bVar0) && !func_76(5))
						{
							...
							if (func_72())
							{
								...
								if (((PAD::IS_CONTROL_PRESSED(0 /*PLAYER_CONTROL*/, 86 /*INPUT_VEH_HORN*/) && !ENTITY::IS_ENTITY_UPSIDEDOWN(PLAYER::PLAYER_PED_ID())) && !Global_33101) && (MISC::GET_GAME_TIMER() - iLocal_107) > 3000)
								{
									iVar4 = func_70();
									if (iVar4 == 0)
									{
			...
			case 8:
				if (func_72())
				{
					if (!func_23())
					{
						...
						iLocal_96 = SYSTEM::START_NEW_SCRIPT(&Local_97, 62500);
...
void func_12()//Position - 0xB8C
{
	...
	while (iVar0 < 10)
	{
		Global_113969.f_19100.f_1[iVar0 /*2*/].f_1 = 0;
		iVar0++;
	}
}
...
void func_49()//Position - 0x21D5
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_51(Global_113969.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_86(PLAYER::PLAYER_PED_ID());
			if (func_50(iVar0) && (!func_76(14) || Global_112917))
			{
