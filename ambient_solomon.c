...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_76(PLAYER::PLAYER_PED_ID()))
	{
		while (bVar0 == 0)
		{
			bVar0 = ((MISC::GET_MISSION_FLAG() == 0 && func_71() == 0) && func_70(PLAYER::PLAYER_PED_ID(), Local_63, fLocal_66, 1));
			func_68();
		}
	}
	func_67(65, 0);
	...
	while (true)
	{
		...
		Local_249 = { ENTITY::GET_ENTITY_FORWARD_VECTOR(PLAYER::PLAYER_PED_ID()) };
...
int func_2(struct<3> Param0, int iParam3, int iParam4, bool bParam5)//Position - 0x1E7
{
	struct<3> Var0[15];
	struct<3> Var46[15];
	float fVar92[15];
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				fVar1 = MISC::ACOS(func_57(Local_249, 0.73f, 0.683f, -0.013f));
				if (MISC::ABSF(fVar1) < 25f)
				{
					if (func_58(iVar2, -1211.7739f, -580.92993f, 26.33095f, -1208.1272f, -585.3617f, 29.660564f, 4.5f))
					{
						fLocal_240 = 3f;
						*uParam0++;
					}
		...
		case 2:
			...
			{
				iVar2 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
				func_54(iVar2, fLocal_240, iLocal_241, 1056964608, 0, 1, 0);
			}
			else
			{
			...
			{
				func_51(&uLocal_73, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
				if (func_50())
				{
					bVar0 = func_34(&uLocal_73, "AMSOLAU", "AMSOL_HERE", 8, 0, 0, 0);
				}
				else
				{
					bVar0 = func_34(&uLocal_73, "AMSOLAU", "AMSOL_WORK", 8, 0, 0, 0);
				}
				if (bVar0)
				{
					*uParam0++;
		...
		case 3:
			...
			{
				iVar2 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
				if (func_54(iVar2, fLocal_240, iLocal_241, 1056964608, 0, 1, 0))
				{
					*uParam0++;
					return;
				}
		...
		case 6:
			func_4(&iLocal_244, -1206.8398f, -583.2034f, 26.1738f, 311.4116f);
			*uParam0++;
			break;
...
void func_4(int* iParam0, struct<3> Param1, float fParam4)//Position - 0x11E7
{
	iParam0->f_1 = VEHICLE::CREATE_VEHICLE(joaat("akuma"), Param1, fParam4, true, true, false);
	if (func_76(iParam0->f_1))
	{
...
bool func_13(bool bParam0)//Position - 0x1BDE
{
	return bParam0 < 3;
}

int func_14(int iParam0)//Position - 0x1BEA
{
	int iVar0;
...
int func_15(int iParam0)//Position - 0x1C56
{
	return iParam0;
}
...
void func_16(int iParam0, var uParam1)//Position - 0x1C60
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_17(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_92451[26 /*34*/].f_6) == 0)
			{
				Global_114135.f_7265[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_114135.f_7265[iParam0], true, true);
			}
...
var func_24(int iParam0)//Position - 0x2831
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_25(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_25(bool bParam0, int iParam1, int iParam2)//Position - 0x2853
{
	if (bParam0)
	{
		return iParam1;
...
int func_26(var uParam0)//Position - 0x286A
{
	return uParam0 & 15;
}
...
int func_52(struct<3> Param0)//Position - 0x5D7D
{
	...
	while (iVar1 < iVar0)
	{
		...
		{
			if (PED::IS_PED_MODEL(uVar2[iVar1], iLocal_252))
			{
...
float func_53(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x5DEA
{
	struct<3> Var0;
...
void func_55(int iParam0)//Position - 0x5E7B
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
float func_57(struct<2> Param0, var uParam2, struct<2> Param3, float fParam5)//Position - 0x5FF8
{
	return ((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1));
}

int func_58(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x600F
{
	struct<3> Var0;
	struct<2> Var3;
	struct<2> Var6;
...
void func_59(int* iParam0)//Position - 0x6153
{
...
void func_60(int* iParam0)//Position - 0x6194
{
	func_59(iParam0);
	func_61(&(iParam0->f_1));
}

void func_61(int* iParam0)//Position - 0x61AA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_62(int iParam0)//Position - 0x6246
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_63(int iParam0)//Position - 0x6267
{
	if (func_62(iParam0))
	{
...
void func_64(var uParam0)//Position - 0x6291
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			{
				iVar2 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
				fVar1 = MISC::ACOS(func_57(Local_249, -0.37f, -0.927f, -0.053f));
				if (MISC::ABSF(fVar1) < 45f)
				{
					if (func_58(iVar2, -1049.3175f, -473.7472f, 34.941956f, -1059.4834f, -468.76077f, 39.94483f, 4.5f))
					{
						fLocal_240 = 1f;
						*uParam0++;
					}
		...
		case 6:
			func_4(&iLocal_242, -1051.9556f, -472.055f, 35.5672f, 161.4418f);
			*uParam0++;
			break;
...
void func_68()//Position - 0x6672
{
	...
	if (!func_70(PLAYER::PLAYER_PED_ID(), Local_63, (fLocal_66 + 30f), 1))
	{
		func_78();
	}
	SYSTEM::WAIT(0);
...
bool func_70(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x672C
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

int func_71()//Position - 0x674A
{
	func_72();
...
void func_72()//Position - 0x6763
{
	...
	{
		if (func_74(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_73(PLAYER::PLAYER_PED_ID());
			if (func_13(iVar0) && (!func_11(14) || Global_113083))
			{
...
int func_73(int iParam0)//Position - 0x6860
{
	int iVar0;
	int iVar1;
...
int func_74(int iParam0)//Position - 0x689D
{
	if (func_13(iParam0))
	{
...
var func_75(int iParam0)//Position - 0x68C2
{
	return Global_2201[iParam0 /*29*/];
}

bool func_76(int iParam0)//Position - 0x68D1
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
void func_78()//Position - 0x6946
{
	func_60(&iLocal_242);
	func_60(&iLocal_244);
	func_79(&iLocal_247, 0, 0, 1);
	func_79(&iLocal_248, 0, 0, 1);
	func_67(65, 1);
...
void func_79(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x6989
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
