...
void func_13()//Position - 0x1194
{
	...
	{
		func_15(13, SYSTEM::FLOOR(Global_114372.f_10197.f_3853));
	}
...
void func_64()//Position - 0x3324
{
	if (!bLocal_282)
	{
		...
		if (iLocal_263 == 3)
		{
			...
			{
				func_59(&uLocal_52, 5);
				TASK::TASK_ENTER_VEHICLE(iLocal_221, iLocal_234, -1, -1, 2f, 8, 0, 0);
				iLocal_263 = 2;
			}
			if (PED::IS_PED_INJURED(iLocal_221) && !PED::IS_PED_INJURED(iLocal_220))
			{
				func_59(&uLocal_52, 6);
				TASK::TASK_ENTER_VEHICLE(iLocal_220, iLocal_234, -1, -1, 2f, 8, 0, 0);
				iLocal_263 = 1;
			}
		}
		if (iLocal_263 == 4)
	...
	if ((ENTITY::IS_ENTITY_DEAD(iLocal_224[0], false) && ENTITY::IS_ENTITY_DEAD(iLocal_224[1], false)) && ENTITY::IS_ENTITY_DEAD(iLocal_224[2], false))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_234, false))
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_220) && !PED::IS_PED_HURT(iLocal_220))
			{
				...
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_234);
				TASK::OPEN_SEQUENCE_TASK(&iLocal_267);
				TASK::TASK_ENTER_VEHICLE(0, iLocal_234, -1, -1, 2f, 9, 0, 0);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_267);
				TASK::TASK_PERFORM_SEQUENCE(iLocal_220, iLocal_267);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_267);
				if (!PED::IS_PED_INJURED(iLocal_221) && !PED::IS_PED_HURT(iLocal_221))
				{
					...
					TASK::TASK_ENTER_VEHICLE(iLocal_221, iLocal_234, -1, 0, 2f, 1, 0, 0);
					iLocal_263 = 3;
				}
			}
			else if (!PED::IS_PED_INJURED(iLocal_221))
			{
				...
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_234);
				TASK::OPEN_SEQUENCE_TASK(&iLocal_267);
				TASK::TASK_ENTER_VEHICLE(0, iLocal_234, -1, -1, 2f, 1, 0, 0);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_267);
				TASK::TASK_PERFORM_SEQUENCE(iLocal_221, iLocal_267);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_267);
				iLocal_263 = 2;
...
void func_67(int iParam0, var uParam1, int iParam2, float fParam3)//Position - 0x387D
{
	struct<3> Var0;
	struct<3> Var3;
	int iVar6;
...
void func_68(int iParam0)//Position - 0x39FB
{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_234, false))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_234, false))
				{
					if (!PED::IS_PED_INJURED(iLocal_220))
					{
						...
						TASK::TASK_ENTER_VEHICLE(iLocal_220, iLocal_234, -1, -1, 2f, 524296, 0, 0);
					}
					else if (!PED::IS_PED_INJURED(iLocal_221))
					{
						func_59(&uLocal_52, 5);
						func_56(&uLocal_52, 5, iLocal_221, "RECSBRobber1", 0, 1);
						func_66(&uLocal_52, "recsbau", "recsb_deadcr", "recsb_deadcr_1", 4, 0, 0);
						TASK::TASK_ENTER_VEHICLE(iLocal_221, iLocal_234, -1, -1, 2f, 524296, 0, 0);
					}
				}
				else if (!bLocal_47)
				{
...
int func_70(char* sParam0)//Position - 0x449A
{
	var uVar0;
...
int func_74(int iParam0)//Position - 0x522D
{
	if (func_78())
	{
		Global_114362 = 1;
...
void func_76(char* sParam0, int iParam1)//Position - 0x535B
{
...
int func_78()//Position - 0x53B5
{
	switch (func_79(&Global_32888, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
bool func_81(int iParam0)//Position - 0x5571
{
	return func_82(iParam0, Global_43922);
}

int func_82(int iParam0, int iParam1)//Position - 0x5582
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_83(int iParam0)//Position - 0x5763
{
	if (Global_43922 == 15)
	{
		return 0;
...
int func_85(int iParam0, bool bParam1, int iParam2)//Position - 0x5921
{
	int iVar0;
...
int func_86(int iParam0, bool bParam1, bool bParam2)//Position - 0x596B
{
	int iVar0;
...
void func_91()//Position - 0x61FA
{
	...
	if ((((STREAMING::HAS_MODEL_LOADED(joaat("S_M_Y_Ranger_01")) && STREAMING::HAS_MODEL_LOADED(joaat("A_M_Y_GenStreet_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("S_M_M_Paramedic_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("sheriff"))) && STREAMING::HAS_MODEL_LOADED(joaat("phoenix")))
	{
		...
		ENTITY::SET_ENTITY_HEALTH(iLocal_228, 0, 0, 0);
		...
		ENTITY::SET_ENTITY_HEALTH(iLocal_221, 300, 0, 0);
		...
		ENTITY::SET_ENTITY_HEALTH(iLocal_220, 300, 0, 0);
...
int func_95(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x6A75
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (!func_131(Global_114372.f_24998.f_43[iParam3]))
		{
			return 0;
		}
...
bool func_96(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6E0F
{
	if (bParam6)
	{
...
bool func_97(int iParam0)//Position - 0x6E56
{
	int iVar0;
...
int func_98(int iParam0)//Position - 0x6E77
{
...
int func_109(bool bParam0, int iParam1, int iParam2)//Position - 0x7249
{
	if (bParam0)
	{
		return iParam1;
...
int func_111(int iParam0, int iParam1)//Position - 0x726D
{
	int iVar0;
	int iVar1;
...
int func_119(int iParam0)//Position - 0x757A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_120(int iParam0, bool bParam1)//Position - 0x7656
{
...
int func_121(int iParam0)//Position - 0x7676
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_129()) || Global_113419) || Global_32831) || func_128()) || func_53(8, -1)) || func_127()) || func_126()) || func_125()) || func_124()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_129()) || Global_32831) || func_128()) || func_53(8, -1)) || func_125()) || func_127()) || func_126()) || func_124()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_129()) || Global_113419) || Global_32831) || func_128()) || func_53(8, -1)) || func_125()) || func_127()) || func_126()) || func_124()) || Global_114372.f_7691.f_919[iVar0] == 5) || Global_44469 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_129()) || Global_113419) || Global_32831) || func_128()) || func_53(8, -1)) || func_127()) || func_126()) || func_124()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_129() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_53(8, -1)) || func_124()) || func_123()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_129()) || Global_32831) || func_128()) || func_53(8, -1)) || func_126()) || func_125()) || func_124()) || Global_114372.f_7691.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_129()) || func_126()) || Global_113419) || Global_32831) || func_128()) || Global_45122) || func_53(8, -1)) || func_125()) || func_123()) || func_124()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_129()) || Global_113419) || Global_32831) || func_128()) || func_53(8, -1)) || func_125()) || func_123()) || func_127()) || func_126()) || func_124())
						{
							return 0;
						}
						break;
...
var func_122()//Position - 0x7D93
{
	return Global_101431.f_1;
}

int func_123()//Position - 0x7DA1
{
	if (Global_98294 != -1)
	{
...
var func_128()//Position - 0x7E2A
{
	return Global_1575079;
}

int func_129()//Position - 0x7E36
{
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0x7E8C
{
	int iVar0;
	int iVar1;
...
int func_133(int iParam0)//Position - 0x7F70
{
	if (!func_27(iParam0))
	{
		return 7;
...
int func_134(int iParam0)//Position - 0x7F94
{
	int iVar0;
	int iVar1;
...
void func_149(int iParam0)//Position - 0x9DAD
{
	...
	if (func_87())
	{
		...
		func_152(30000);
		StringCopy(&cVar0, func_151(Global_114361, 1), 64);
