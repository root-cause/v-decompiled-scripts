...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_105 = -1;
	Local_107 = { 0f, 0f, 0f };
	Local_108 = { -1154.086f, -2006.297f, 12.1803f };
	Local_110 = { -442.5602f, -2184.605f, 14.55648f };
	Local_111 = { -442.668f, -2172.496f, 9.39933f };
	fLocal_112 = 13.47f;
	...
	switch (iLocal_93)
	{
		case 0:
			if (func_65(iLocal_92, bLocal_28))
			{
				...
				if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(Local_97.f_0))
				{
					OBJECT::ADD_DOOR_TO_SYSTEM(Local_97.f_0, joaat("prop_com_gar_door_01"), -445.3054f, -2171.827f, 11.3672f, true, true, false);
					OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Local_97.f_0, 1, true, true);
				}
...
int func_169(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xDE05
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_171(iParam0, uVar1[iVar3], 1) && func_170(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
{
	Local_96 = { func_472(1616809629, -440.0352f, -2172.502f, 9.39933f, -440.1235f, -2166.841f, 12.3181f, -440.1479f, -2166.364f, 9.3181f, -439.9046f, -2174.041f, 12.39933f, -442.2598f, -2169.643f, 9.31843f, -438.0615f, -2173.349f, 13.31699f) };
	Local_97 = { func_472(-1380475172, -445.3699f, -2172.47f, 9.39933f, -445.3286f, -2166.688f, 12.31802f, -445.492f, -2166.232f, 9.31686f, -445.2189f, -2174.173f, 12.39933f, -447.3654f, -2169.836f, 9.30682f, -443.38f, -2173.165f, 12.31856f) };
}
...
void func_473()//Position - 0x319CE
{
	switch (func_41())
	{
		case 80:
			...
			Local_109 = { -442.189f, -2183.603f, 9.31981f };
			break;
		...
		case 82:
			Local_124 = { func_474(307.123f, -1084.801f, 28.3597f, 299.7018f, joaat("gauntlet"), 0) };
			Local_109 = { -442.189f, -2183.603f, 9.31981f };
			break;
	}
	iLocal_126[0] = 0;
	...
	Local_127[1 /*3*/] = { -442.1008f, -2181.29f, 9.3195f };
	Local_127[2 /*3*/] = { -445.3427f, -2181.132f, 9.3183f };
