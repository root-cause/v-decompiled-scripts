...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	uLocal_80 = func_391(64);
	uLocal_81 = func_391(63);
	...
	if (func_351())
	{
		Global_78804 = 1;
		iLocal_79 = 0;
		while (!func_341(&Local_96))
		{
			SYSTEM::WAIT(0);
		}
		func_340(&Local_96, 0, 1);
		Global_78804 = 0;
	}
	iLocal_325 = func_339();
	func_338();
	while (true)
	{
		...
		func_321(Local_96.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_322)
		{
			case 0:
				func_232();
...
void func_1()//Position - 0x12C
{
	switch (iLocal_323)
	{
		case 0:
			bLocal_324 = false;
			func_231(&uLocal_157, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			iLocal_323 = 1;
			break;
		...
		case 1:
			if (!bLocal_324)
			{
				bLocal_324 = func_216(&uLocal_157, "NIG1AAU", "NIG1A_COMM", 7, 0, 0, 0);
			}
			else if (!func_215())
			{
				iLocal_323 = 2;
			...
			switch (iLocal_326)
			{
				...
				case 2:
					if (!CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						func_240(1, 1, 1, 1);
						func_340(&Local_96, 0, 1);
						if (!func_312(Local_96.f_35[0]))
						{
							func_236(&(Local_96.f_35[0]), -1084.4558f, 787.2556f, 163.986f, 100.8542f, 0, 1);
						}
						if (func_312(Local_96.f_35[0]))
						{
							func_235(Local_96.f_35[0], -1094.4845f, 785.5936f, 163.2927f, 102.2748f, 0, 1);
						...
						func_234(&(Local_96.f_28[0]), 1, 0, 1);
						func_234(&(Local_96.f_28[1]), 1, 0, 1);
						func_233(&(Local_96.f_35[0]));
						iLocal_322 = 1;
						iLocal_323 = 0;
					}
					break;
...
int func_235(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x279E2
{
	bool bVar0;
	float fVar1;
...
int func_236(int* iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6)//Position - 0x27A3E
{
	...
	func_237(iParam0, iLocal_83, Param1, fParam4);
	if (func_312(*iParam0))
	{
...
void func_237(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x27AC9
{
	func_238(iParam0);
...
void func_251(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x27F6D
{
	int iVar0;
...
void func_254(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2817F
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104212.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104212.f_4, false))
		{
			if (func_302(24) != Global_104212.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_299(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_255(Global_104212.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_255(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x281FA
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_289(iParam5, &Var0, Param1, fParam4, func_292(iParam0));
		func_256(iParam5, iParam0, 0);
	}
}
...
void func_289(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x2E1F0
{
	if (func_286(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
...
bool func_293(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2E48F
{
	if (bParam6)
	{
...
int func_299(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x2EA6B
{
	int iVar0;
	
	iVar0 = func_300(Param0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_300(struct<3> Param0, int iParam3, int iParam4)//Position - 0x2EB81
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_303(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2EC41
{
	func_304(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_304(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2EC6B
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_306(iVar0, Param0, Param3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_306(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2F08B
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_307(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var9) || func_307(Var18[0 /*3*/], Var18[1 /*3*/], Var9, Var15)) || func_307(Var18[0 /*3*/], Var18[1 /*3*/], Var12, Var15)) || func_307(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var12)) || func_307(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var9)) || func_307(Var18[1 /*3*/], Var18[3 /*3*/], Var9, Var15)) || func_307(Var18[1 /*3*/], Var18[3 /*3*/], Var12, Var15)) || func_307(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var12)) || func_307(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var9)) || func_307(Var18[3 /*3*/], Var18[2 /*3*/], Var9, Var15)) || func_307(Var18[3 /*3*/], Var18[2 /*3*/], Var12, Var15)) || func_307(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var12)) || func_307(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var9)) || func_307(Var18[2 /*3*/], Var18[0 /*3*/], Var9, Var15)) || func_307(Var18[2 /*3*/], Var18[0 /*3*/], Var12, Var15)) || func_307(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_307(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2F381
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_321(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2F896
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_323(Global_78814, Global_78816, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
int func_341(var uParam0)//Position - 0x30459
{
	...
	switch (iLocal_79)
	{
		case 0:
			...
			func_350(&uLocal_84, "rcmnigel1", "base_mrs_thornhill", "base_mrs_thornhill");
			iLocal_79 = 1;
			break;
		...
		case 2:
			...
			{
				func_237(&(uParam0->f_35[0]), iLocal_83, -1077.959f, 793.9361f, 164.6374f, 172.8563f);
...
void func_342(int iParam0, bool bParam1)//Position - 0x306FA
{
	switch (iParam0)
	{
		...
		case 38:
			if (bParam1)
			{
				iLocal_95 = PED::ADD_SCENARIO_BLOCKING_AREA(-577.27405f, 270.65054f, 77f, -543.17926f, 315.29727f, 94f, false, true, true, true);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_GUARD_STAND", false);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_CLIPBOARD", false);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", false);
		...
		case 39:
			if (bParam1)
			{
				iLocal_95 = PED::ADD_SCENARIO_BLOCKING_AREA(-1073.19f, 342.05f, 63.328316f, -966.24f, 411.05f, 84.820435f, false, true, true, true);
		...
		case 41:
			if (bParam1)
			{
				iLocal_95 = PED::ADD_SCENARIO_BLOCKING_AREA(-1122.2018f, 48.5724f, 51.4652f, -1076.2333f, 92.1041f, 60.0617f, false, true, true, true);
		...
		case 42:
			if (bParam1)
			{
				iLocal_95 = PED::ADD_SCENARIO_BLOCKING_AREA(-1319.5663f, -650.07697f, 23.53715f, -1301.7892f, -634.0721f, 38.18122f, false, true, true, true);
...
int func_344(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x30BA1
{
	if (func_345(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_345(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x30BFD
{
	int iVar0;
