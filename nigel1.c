...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_78 = func_394(64);
	uLocal_79 = func_394(63);
	...
	if (func_354())
	{
		Global_79785 = 1;
		iLocal_77 = 0;
		while (!func_344(&Local_94))
		{
			SYSTEM::WAIT(0);
		}
		func_343(&Local_94, 0, 1);
		Global_79785 = 0;
	}
	iLocal_323 = func_342();
	func_341();
	while (true)
	{
		...
		func_324(Local_94.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_320)
		{
			case 0:
				func_233();
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x85C8
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_75(int iParam0)//Position - 0x946B
{
	if (!BitTest(Global_79322[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x94B3
{
	int iVar0;
...
void func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9F3D
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xA067
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
void func_88(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD572
{
	var uVar0;
	int iVar1;
...
int func_92(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE50E
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_207(int iParam0, int iParam1, bool bParam2)//Position - 0x26EE2
{
	int iVar0;
		...
		if (bParam2)
		{
			if (!Global_79539)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9595[iParam1 /*4*/] = { func_209(iParam0) };
					...
					{
						Global_9546[1 /*6*/] = { func_209(iParam0) };
...
struct<4> func_209(int iParam0)//Position - 0x270DB
{
	return Global_2201[iParam0 /*29*/].f_3;
}

int func_210(int iParam0, int iParam1)//Position - 0x270EE
{
...
int func_211(int iParam0, int iParam1)//Position - 0x27118
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_212(int iParam0, int iParam1, int iParam2)//Position - 0x27142
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_213(int iParam0, int iParam1, int iParam2)//Position - 0x27187
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_214()//Position - 0x271CC
{
	if (func_93(14))
	{
...
int func_215()//Position - 0x2726E
{
	func_157();
	return Global_114135.f_2367.f_539.f_4321;
}

int func_216()//Position - 0x27287
{
...
bool func_217(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x272A9
{
...
var func_222(int iParam0, int iParam1)//Position - 0x2766F
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_223()//Position - 0x27687
{
	return -1;
}
...
void func_231(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x278FC
{
...
void func_232(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x27952
{
		...
		case 1:
			switch (iLocal_324)
			{
				...
				case 1:
					...
					{
						func_305(-1103.3269f, 786.844f, 157.71326f, -1090.2865f, 788.60144f, 168.52283f, 10f, -1107.0227f, 788.9111f, 163.0734f, 187.0703f, func_312(), 1, 1, 1, 0, 0);
...
void func_234(int* iParam0)//Position - 0x27CFA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_235(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x27D32
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
int func_236(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x27D82
{
	bool bVar0;
	float fVar1;
...
int func_237(int* iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6)//Position - 0x27DDE
{
...
void func_238(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x27E69
{
	func_239(iParam0);
...
void func_239(int* iParam0)//Position - 0x27EAC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_240(int iParam0)//Position - 0x27F48
{
	if (func_314(iParam0))
	{
...
int func_242(int iParam0)//Position - 0x2801D
{
	if (func_314(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_243(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2803D
{
	if (bParam0)
	{
...
int func_247(var uParam0)//Position - 0x28240
{
	int iVar0;
...
int func_248(int iParam0)//Position - 0x28262
{
...
int func_250(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x282AF
{
	int iVar0;
...
void func_253(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x28341
{
	int iVar0;
...
Vector3 func_254(int iParam0)//Position - 0x284FF
{
...
void func_256(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x28551
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104696.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104696.f_4, false))
		{
			if (func_304(24) != Global_104696.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_301(ENTITY::GET_ENTITY_COORDS(Global_104696.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_257(Global_104696.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_257(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x285CC
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_291(iParam5, &Var0, Param1, fParam4, func_294(iParam0));
...
void func_259(int iParam0, int iParam1)//Position - 0x2880C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_260(int iParam0)//Position - 0x28A0E
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_275(iParam0, 0, 0)) || func_275(iParam0, 1, 0)) || func_275(iParam0, 2, 0)) || func_294(iParam0) != 145) || func_274(iParam0)) || func_273(iParam0)) || func_272(iParam0)) || func_271(iParam0)) || !func_261(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_273(iParam0))
		{
		}
...
int func_261(int iParam0)//Position - 0x28AEB
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_262(int iParam0, bool bParam1, int iParam2)//Position - 0x28CA9
{
	int iVar0;
	struct<2> Var1;
...
int func_263(int iParam0)//Position - 0x28E2E
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_265(int iParam0, int iParam1)//Position - 0x28F11
{
	int iVar0;
	int iVar1;
...
int func_266()//Position - 0x2911A
{
	return 0;
}

int func_267()//Position - 0x29123
{
	return 1;
}

int func_268()//Position - 0x2912C
{
	return 1;
}

int func_269()//Position - 0x29135
{
...
int func_271(int iParam0)//Position - 0x29206
{
	int iVar0;
	char* sVar1;
...
int func_272(int iParam0)//Position - 0x2924D
{
	int iVar0;
...
int func_273(int iParam0)//Position - 0x29288
{
	int iVar0;
...
int func_274(int iParam0)//Position - 0x29304
{
	int iVar0;
...
int func_275(int iParam0, int iParam1, bool bParam2)//Position - 0x293EC
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_276(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2945A
{
...
var func_277()//Position - 0x29532
{
	...
	func_287(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_286(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_285(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_280(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_279(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_278(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}
...
var func_282(int iParam0)//Position - 0x29724
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_283(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_283(bool bParam0, int iParam1, int iParam2)//Position - 0x29746
{
	if (bParam0)
	{
		return iParam1;
...
int func_284(var uParam0)//Position - 0x2975D
{
	return uParam0 & 15;
}
...
int func_288(var uParam0, int iParam1)//Position - 0x2981B
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_295(Global_114135.f_32754.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_295(Global_114135.f_2367.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_295(Global_114135.f_2367.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_289(int iParam0, int iParam1)//Position - 0x2AF09
{
	struct<82> Var0;
...
void func_290(int iParam0, var uParam1, int iParam2)//Position - 0x2AF4B
{
	int iVar0;
...
void func_291(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x2B1A7
{
	if (func_288(&(Global_78329.f_555[0 /*21*/]), iParam0))
	{
...
bool func_295(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2B446
{
	if (bParam6)
	{
...
int func_298(int iParam0, var uParam1, var uParam2)//Position - 0x2B7E8
{
	int iVar0;
	int iVar1;
...
int func_299(int iParam0)//Position - 0x2B9DB
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_301(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x2BA22
{
	int iVar0;
	
	iVar0 = func_302(Param0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_302(struct<3> Param0, int iParam3, int iParam4)//Position - 0x2BB38
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_303(int iParam0)//Position - 0x2BBC7
{
...
void func_305(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2BBF8
{
	func_306(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_306(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2BC22
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_308(iVar0, Param0, Param3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_307(struct<3> Param0)//Position - 0x2C01A
{
...
int func_308(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2C044
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_309(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var9) || func_309(Var18[0 /*3*/], Var18[1 /*3*/], Var9, Var15)) || func_309(Var18[0 /*3*/], Var18[1 /*3*/], Var12, Var15)) || func_309(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var12)) || func_309(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var9)) || func_309(Var18[1 /*3*/], Var18[3 /*3*/], Var9, Var15)) || func_309(Var18[1 /*3*/], Var18[3 /*3*/], Var12, Var15)) || func_309(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var12)) || func_309(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var9)) || func_309(Var18[3 /*3*/], Var18[2 /*3*/], Var9, Var15)) || func_309(Var18[3 /*3*/], Var18[2 /*3*/], Var12, Var15)) || func_309(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var12)) || func_309(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var9)) || func_309(Var18[2 /*3*/], Var18[0 /*3*/], Var9, Var15)) || func_309(Var18[2 /*3*/], Var18[0 /*3*/], Var12, Var15)) || func_309(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_309(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2C33A
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_310(struct<3> Param0)//Position - 0x2C3EE
{
	float fVar0;
	float fVar1;
...
void func_311(int iParam0)//Position - 0x2C42D
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_314(int iParam0)//Position - 0x2C4C9
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_315(int iParam0, float fParam1, int iParam2)//Position - 0x2C4EA
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_320(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_319(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")))
				{
...
int func_319(int iParam0, int iParam1)//Position - 0x2C642
{
	if (func_242(iParam0))
	{
...
int func_320(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2C675
{
...
void func_321(int iParam0)//Position - 0x2C6CC
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_324(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2C85F
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_79794 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_326(Global_79795, Global_79797, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_325(char* sParam0)//Position - 0x2CB44
{
...
int func_335(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2CF25
{
	if (((!func_338(0) || Global_79810) || Global_79798 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_79794)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_337(0)) || func_336(1))
			{
			}
			else
			{
...
int func_337(int iParam0)//Position - 0x2D066
{
	if (iParam0 == 1)
	{
		if (Global_21066.f_1 > 3)
...
int func_338(int iParam0)//Position - 0x2D0BD
{
	if (Global_44181 == 15)
	{
		return 0;
...
bool func_339(int iParam0)//Position - 0x2D0DF
{
	return func_340(iParam0, Global_44181);
}

int func_340(int iParam0, int iParam1)//Position - 0x2D0F0
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_344(var uParam0)//Position - 0x2D420
{
	int iVar0[3];
	int iVar4;
	int iVar5;
...
int func_347(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x2DB6C
{
	if (func_348(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_348(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2DBC8
{
	int iVar0;
...
int func_349(var uParam0, int iParam1)//Position - 0x2DC56
{
	int iVar0;
...
int func_350(var uParam0)//Position - 0x2DC9C
{
	if (func_351(uParam0))
	{
...
int func_351(var uParam0)//Position - 0x2DCC6
{
...
int func_352(int iParam0)//Position - 0x2DCEB
{
	int iVar0;
...
void func_359(int* iParam0, bool bParam1)//Position - 0x2DE24
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_360(int* iParam0)//Position - 0x2DE5F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_365(int* iParam0)//Position - 0x2DF2C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_370(char* sParam0, int iParam1, int iParam2)//Position - 0x2E123
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_372()//Position - 0x2E308
{
	...
	iVar0 = func_373(&(Global_101688.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_374(int iParam0, bool bParam1)//Position - 0x2E356
{
	int iVar0;
...
void func_377(bool bParam0)//Position - 0x2E448
{
...
int func_394(int iParam0)//Position - 0x2E83C
{
	if (!func_154(iParam0))
	{
		return func_153(iParam0);
