...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_77 = 4f;
	bLocal_78 = true;
	Local_56 = { ScriptParam_260.f_1[0 /*3*/] };
	Local_56 = { Local_56 };
	iLocal_54 = iLocal_54;
	Local_52 = { Local_52 };
	bVar0 = false;
	...
	iLocal_59 = 0;
	func_168(&Global_112037, 0);
	func_162();
	MISC::SET_THIS_IS_A_TRIGGER_SCRIPT(true);
	if (func_161(uLocal_58, 1))
	{
		iLocal_64 = 10;
	}
	else
	...
	if (!func_161(uLocal_58, 8))
	{
		if (!func_159(iLocal_64))
		{
			if (func_158(0, iLocal_63))
			{
				func_170(0);
			}
			else
	...
	if (func_161(uLocal_58, 8388608))
	{
		func_170(1);
	}
	if (func_161(uLocal_58, 524288) && (func_157() && !func_156()))
	{
		func_170(1);
	}
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_161(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
			func_155(iLocal_69, 1, 0);
			iLocal_69 = 263;
		}
		func_154(10);
	}
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_53) && !ENTITY::IS_ENTITY_DEAD(iLocal_53, false))
		{
			...
			fLocal_57 = SYSTEM::VDIST2(Local_55, ScriptParam_260.f_1[0 /*3*/]);
			fLocal_57 = fLocal_57;
			Local_75 = { Local_55 };
			...
			{
				case 0:
					if (func_159(iLocal_64) || (func_161(uLocal_58, 16) && !func_161(uLocal_58, 524288)))
					{
						iLocal_62 = -1;
						func_147();
						func_154(1);
				...
				case 3:
					...
					if (!func_161(uLocal_58, 4))
					{
						func_143();
						func_142(&uLocal_58, 4);
					}
					if (fLocal_74 > (fLocal_66 * fLocal_66) && !Global_100475)
					{
						if (iLocal_69 != 263)
						{
							if (func_141(6) && !func_140(iLocal_69))
							{
							}
							else
							{
					...
					{
						Local_52 = { Local_51 };
						bVar2 = !func_161(uLocal_58, 64);
						func_168(&uLocal_58, 128);
						if (!func_139(3) && !Global_100475)
						{
							if (func_161(uLocal_58, 2097152))
							{
								if ((!func_161(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_138())) && !Global_100475)
								{
									func_154(10);
									break;
								}
						...
						if ((!func_129(6) || Global_112433) || func_128())
						{
							bVar2 = false;
						}
						if (!bLocal_78)
						{
							func_126(&uLocal_58, 128);
							bVar2 = false;
						}
						if (func_161(uLocal_58, 1))
						{
						...
						if (bVar2)
						{
							...
							if (bVar2)
							{
								...
								if (func_118(iLocal_54))
								{
									if (iLocal_60 == -1)
									{
										func_117(&iLocal_60, 4, sLocal_65, 0, 0, 0, 0);
										func_126(&uLocal_58, 2048);
									}
									else if (!func_161(uLocal_58, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_116(&iLocal_60);
										func_168(&uLocal_58, 2048);
									}
									if (func_114(iLocal_60, 1))
									{
										sLocal_65 = sLocal_65;
										func_116(&iLocal_60);
										func_168(&uLocal_58, 2048);
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&Local_52))
					{
						...
						if (iVar4 != 1)
						{
							iVar4 = func_49(&iLocal_62, 6, iLocal_64, 0, 0);
						}
						if (iVar4 == 1)
						{
							...
							iLocal_50 = func_29();
							func_168(&uLocal_58, 4);
							func_28();
							func_126(&uLocal_58, 2);
							func_154(6);
							func_24(&iLocal_71);
							if (iLocal_63 != -1)
							{
								func_23(iLocal_63);
								func_20(func_22(iLocal_63), 0, 0);
							}
						}
						else if (iVar4 == 2)
						{
				...
				case 6:
					if (func_161(Global_112037, 262144))
					{
						func_168(&Global_112037, 262144);
						func_16();
					}
					if (func_161(uLocal_58, 2097152))
					{
						if (!func_139(3) && !SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
						{
							func_154(10);
						}
					}
					...
					{
						STATS::PLAYSTATS_ODDJOB_DONE(SYSTEM::ROUND((func_12(&iLocal_71) * 1000f)), iLocal_63, 0);
						func_11(&iLocal_71);
						func_168(&uLocal_58, 256);
						func_8();
						if (bVar0)
						{
							func_168(&uLocal_58, 2);
						}
						else if (func_161(uLocal_58, 2))
						{
							if (func_161(Global_112037, 0))
							{
								func_7(&iLocal_62);
								iLocal_62 = -1;
								func_168(&uLocal_58, 2);
						...
						if (iLocal_63 != -1)
						{
							if (func_161(Global_112037, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_22(iLocal_63), 0, Global_100478, 0);
								func_6(func_22(iLocal_63), 0, Global_100478, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_22(iLocal_63), 0, Global_100478, 0);
								func_6(func_22(iLocal_63), 0, Global_100478, 0, 0);
							}
						}
						func_5();
						func_168(&Global_112037, 0);
						if (func_161(uLocal_58, 16777216))
						{
							func_170(1);
						}
						if (iLocal_63 != -1)
					...
					if ((iLocal_68 % 150) == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (iLocal_70 == 2)
							{
								if (iLocal_70 == 2)
								{
									if (func_159(iLocal_64) && func_158(0, iLocal_63))
									{
										func_162();
										if (iLocal_69 != 263)
										{
...
bool func_1(char* sParam0)//Position - 0xA35
{
...
float func_12(int* iParam0)//Position - 0xBBD
{
	if (func_15(iParam0))
	{
		if (func_14(iParam0))
...
bool func_14(var uParam0)//Position - 0xC51
{
	return BitTest(*uParam0, 2);
}

bool func_15(var uParam0)//Position - 0xC5E
{
...
{
	func_18(&iLocal_252, Local_247.f_0);
}

void func_18(int iParam0, int iParam1)//Position - 0xC86
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (CAM::DOES_CAM_EXIST(*iParam0) && CAM::IS_CAM_ACTIVE(*iParam0))
	{
		...
		fVar3 = MISC::ATAN2((Var1.f_2 - Var2.f_2), MISC::GET_DISTANCE_BETWEEN_COORDS(Var1, Var2, false));
		if (fVar3 > Var0.f_0)
		{
			Var0.f_0 = func_19(Var0.f_0, fVar3, 0.07f);
		}
...
int func_21(bool bParam0)//Position - 0xD65
{
...
void func_24(int* iParam0)//Position - 0xF22
{
	if (!func_15(iParam0))
	{
		func_27(iParam0);
...
void func_25(int* iParam0)//Position - 0xF43
{
	func_26(iParam0, 0f);
}

void func_26(int* iParam0, float fParam1)//Position - 0xF52
{
...
void func_27(int* iParam0)//Position - 0xF7D
{
	if (!func_15(iParam0))
	{
		func_25(iParam0);
...
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_247.f_0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
	}
	if (CAM::IS_CAM_ACTIVE(iLocal_252))
	{
		...
		CAM::DESTROY_CAM(iLocal_252, false);
	}
	func_2();
}
...
int func_29()//Position - 0xFDF
{
	...
	Global_113386.f_18967 = iLocal_81;
	switch (iLocal_81)
	{
		case 0:
		case 1:
...
void func_30(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x1063
{
	if (iParam0 != 198)
	{
		if (Global_78319)
...
void func_38()//Position - 0x52F8
{
	...
	{
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_247.f_0, 1);
	}
}

void func_39(int iParam0)//Position - 0x533D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_41(int iParam0)//Position - 0x5419
{
	int iVar0;
...
int func_45(int iParam0, int iParam1, int iParam2)//Position - 0x5512
{
...
int func_47(int iParam0)//Position - 0x5579
{
	int iVar0;
...
int func_49(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x563F
{
	int iVar0;
...
int func_51(int iParam0)//Position - 0x57C5
{
	if (Global_43052 == 15)
	{
		return 0;
...
void func_53()//Position - 0x57F3
{
	...
	fVar7 = func_112(func_113(iLocal_81) == joaat("maverick"), 0.45f, 0.3f);
	...
	if (func_109(Local_247.f_3, Local_247.f_0, 1, 1, 1, 1, 0) || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		func_152(0);
		iLocal_249 = 0;
		if (ENTITY::DOES_ENTITY_EXIST(Local_247.f_3) && !PED::IS_PED_INJURED(Local_247.f_3))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_247.f_0, false) && PED::IS_PED_IN_VEHICLE(Local_247.f_3, Local_247.f_0, false))
			{
				TASK::TASK_VEHICLE_MISSION_COORS_TARGET(Local_247.f_3, Local_247.f_0, ENTITY::GET_ENTITY_COORDS(Local_247.f_0, true) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_247.f_0) + Vector(500f, 0f, 0f), 4, VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(Local_247.f_0), 262144, 50f, 50f, true);
			}
			else
			{
				TASK::TASK_SMART_FLEE_PED(Local_247.f_3, PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
			}
		...
		if (ENTITY::DOES_ENTITY_EXIST(Local_247.f_0))
		{
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&Local_247);
			Local_247.f_0 = 0;
		}
	...
	fVar6 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_108(iLocal_81));
	if (fVar6 < 11664f)
	{
		if (!iLocal_251)
		{
			STREAMING::REQUEST_MODEL(func_107(iLocal_81));
			iLocal_251 = 1;
		}
	}
	else if (fVar6 > 13924f)
	{
		if (iLocal_251)
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_107(iLocal_81));
			iLocal_251 = 0;
		}
	}
	if (fVar6 < 10000f)
	{
		...
		{
			if ((STREAMING::HAS_MODEL_LOADED(func_107(iLocal_81)) && ENTITY::DOES_ENTITY_EXIST(Local_247.f_0)) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_247.f_0, false))
			{
				Local_247.f_3 = PED::CREATE_PED_INSIDE_VEHICLE(Local_247.f_0, 4, func_107(iLocal_81), -1, true, true);
				if (!PED::IS_PED_INJURED(Local_247.f_3))
				{
					PED::SET_PED_HELMET(Local_247.f_3, false);
					func_106(Local_247.f_3, iLocal_81);
					func_105();
					AUDIO::SET_AMBIENT_VOICE_NAME(Local_247.f_3, func_104(iLocal_81));
					func_102(&uLocal_82, 0, Local_247.f_3, func_103(iLocal_81), 1, 1);
				...
				VEHICLE::SET_VEHICLE_ENGINE_ON(Local_247.f_0, true, true, false);
				VEHICLE::SET_HELI_BLADES_SPEED(Local_247.f_0, fVar7);
			}
		}
		else
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Local_247.f_3, true, false);
			if (!CAM::DOES_CAM_EXIST(iLocal_252) || !CAM::IS_CAM_RENDERING(iLocal_252))
			{
				VEHICLE::SET_HELI_BLADES_SPEED(Local_247.f_0, fVar7);
			}
			if (!BitTest(Local_247.f_169, 0))
			{
				if (CAM::IS_SCREEN_FADED_IN())
				{
					if (!PED::IS_PED_INJURED(Local_247.f_3) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						...
						{
							func_80(&uLocal_82, "OJBJAUD", func_100(iLocal_81), 8, 0, 0, 0);
	...
	func_18(&iLocal_252, Local_247.f_0);
	if ((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_247.f_0, true) && !PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID())) && func_78(Local_247.f_3, Local_247.f_0))
	{
		Var5 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_247.f_0, PED::GET_PED_BONE_COORDS(PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f)) };
		if (Var5.f_0 < 0f || Var5.f_1 < 1f)
		{
			AUDIO::SET_AUDIO_FLAG("DisableFlightMusic", true);
			AUDIO::SET_VEH_RADIO_STATION(Local_247.f_0, "OFF");
			func_168(&uLocal_58, 64);
			bVar8 = true;
			if (iLocal_250)
			{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_247.f_0, false))
			{
				...
				if (iVar0 != 0 && iVar0 != 1)
				{
					...
					func_24(&iLocal_253);
					while (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_247.f_0, false) && func_55(&iLocal_253) < 2f)
					{
						SYSTEM::WAIT(0);
					}
					func_11(&iLocal_253);
					if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_247.f_0, false))
					{
						bVar8 = false;
						CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, false, 0);
						if (CAM::DOES_CAM_EXIST(iLocal_252))
					...
					if (!ENTITY::IS_ENTITY_DEAD(Local_247.f_3, false) && !ENTITY::IS_ENTITY_DEAD(Local_247.f_0, false))
					{
						TASK::OPEN_SEQUENCE_TASK(&iVar4);
						TASK::TASK_STAND_STILL(0, 500);
						TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_247.f_0, ENTITY::GET_ENTITY_COORDS(Local_247.f_0, true) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_247.f_0) + Vector(500f, 0f, 0f), 4, VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(Local_247.f_0), 262144, 50f, 50f, true);
...
float func_55(int* iParam0)//Position - 0x6049
{
	if (func_15(iParam0))
	{
		if (func_14(iParam0))
...
void func_67(int iParam0, bool bParam1, int iParam2)//Position - 0x64A4
{
...
void func_69(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x651F
{
	if (bParam0)
	{
	...
	else
	{
		...
		func_76(0, bParam3, uParam2, 0);
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_74(PLAYER::PLAYER_ID())) && !func_71(PLAYER::PLAYER_ID(), 0)) && !func_70()) && !bParam4) && !bParam5)
			{
...
bool func_70()//Position - 0x6662
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_71(int iParam0, int iParam1)//Position - 0x667C
{
	bool bVar0;
...
int func_72(int iParam0, bool bParam1)//Position - 0x66C7
{
	int iVar0;
	int iVar1;
...
int func_73()//Position - 0x6708
{
	return Global_1574918;
}

int func_74(int iParam0)//Position - 0x6714
{
...
bool func_75()//Position - 0x6753
{
	return BitTest(Global_2621446, 3);
}

int func_76(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x6761
{
	int iVar0;
...
void func_77(int iParam0)//Position - 0x6794
{
	if (iParam0 == 1)
	{
...
int func_78(int iParam0, int iParam1)//Position - 0x67B7
{
	...
	if (PED::IS_PED_IN_VEHICLE(iParam0, iParam1, false) && func_79(iParam0, iParam1) == -1)
	{
		return 1;
	}
	return 0;
...
int func_79(int iParam0, int iParam1)//Position - 0x6814
{
...
int func_80(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6886
{
...
int func_81(char* sParam0, int iParam1, bool bParam2)//Position - 0x68D4
{
	Global_21606 = 0;
...
bool func_84(int iParam0)//Position - 0x6C3C
{
	return func_85(iParam0, 20);
}

var func_85(int iParam0, int iParam1)//Position - 0x6C4C
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

int func_86()//Position - 0x6C64
{
	return -1;
}

void func_87()//Position - 0x6C6D
{
	int iVar0;
...
var func_91()//Position - 0x6E6E
{
	func_92();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_92()//Position - 0x6E87
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_95(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_93(iVar0) && (!func_141(14) || Global_112337))
			{
...
bool func_93(int iParam0)//Position - 0x6F84
{
	return iParam0 < 3;
}

int func_94(int iParam0)//Position - 0x6F90
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0)//Position - 0x6FCD
{
	if (func_93(iParam0))
	{
...
var func_96(int iParam0)//Position - 0x6FF2
{
	return Global_1998[iParam0 /*29*/];
}

void func_97()//Position - 0x7001
{
	int iVar0;
...
void func_99(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x70AF
{
...
char* func_100(int iParam0)//Position - 0x7105
{
	bool bVar0;
	
	bVar0 = func_94(PLAYER::PLAYER_PED_ID()) == true;
	switch (iParam0)
	{
		case 0:
			return func_101(bVar0, "BJ_01F", "BJ_01L");
		
		case 1:
			return func_101(bVar0, "BJ_02F", "BJ_02L");
		
		case 2:
			return func_101(bVar0, "BJ_03F", "BJ_03L");
		
		case 3:
			return func_101(bVar0, "BJ_04FG", "BJ_04L");
		
		case 7:
			return "BJ_08L";
		
		case 9:
			return func_101(bVar0, "BJ_10LF", "BJ_10L");
		
		case 10:
			return func_101(bVar0, "BJ_11LF", "BJ_11L");
...
char* func_101(bool bParam0, char* sParam1, char* sParam2)//Position - 0x71C7
{
	if (bParam0)
	{
		return sParam1;
...
void func_102(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x71DE
{
...
char* func_103(int iParam0)//Position - 0x7279
{
	return "EXT1HELIPILOT";
}

char* func_104(int iParam0)//Position - 0x7285
{
	switch (iParam0)
	{
		case 0:
...
void func_105()//Position - 0x7300
{
	iLocal_46++;
}

void func_106(int iParam0, int iParam1)//Position - 0x730E
{
...
int func_107(int iParam0)//Position - 0x73B5
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_108(int iParam0)//Position - 0x7435
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x757F
{
	int iVar0;
	struct<3> Var1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (PED::IS_PED_BEING_JACKED(iParam0) || !func_78(iParam0, iParam1))
			{
				return 1;
			}
...
float func_110(int iParam0, bool bParam1)//Position - 0x776E
{
	return func_111(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), iParam0, bParam1);
}

float func_111(int iParam0, int iParam1, bool bParam2)//Position - 0x7786
{
	struct<3> Var0;
	struct<3> Var1;
...
float func_112(bool bParam0, float fParam1, float fParam2)//Position - 0x77E4
{
	if (bParam0)
	{
		return fParam1;
...
int func_113(int iParam0)//Position - 0x77FB
{
	switch (iParam0)
	{
		case 0:
...
int func_114(int iParam0, bool bParam1)//Position - 0x7851
{
	int iVar0;
...
int func_115(int iParam0)//Position - 0x7909
{
	int iVar0;
...
void func_116(int iParam0)//Position - 0x7944
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x799B
{
	int iVar0;
...
int func_118(int iParam0)//Position - 0x7AC6
{
	return 0;
	return 1;
}

var func_119()//Position - 0x7AD3
{
	return Global_75485;
}

int func_120(int iParam0)//Position - 0x7ADF
{
	if (iParam0 == 1)
	{
		if (Global_20266.f_1 > 3)
...
bool func_121(int iParam0, int iParam1)//Position - 0x7B36
{
	switch (iParam0)
	{
		case 5:
...
bool func_122()//Position - 0x7B6E
{
	return MISC::GET_GAME_TIMER() <= Global_23150.f_6269 + 100;
}

int func_123()//Position - 0x7B83
{
...
bool func_124(bool bParam0)//Position - 0x7B9D
{
	if (bParam0)
	{
...
int func_125()//Position - 0x7BC6
{
	return 1;
}

void func_126(var uParam0, int iParam1)//Position - 0x7BCF
{
	func_127(uParam0, iParam1);
}

void func_127(var uParam0, var uParam1)//Position - 0x7BDF
{
	*uParam0 = (*uParam0 || uParam1);
}

bool func_128()//Position - 0x7BF0
{
	int iVar0;
	bool bVar1;
...
int func_129(int iParam0)//Position - 0x7CFA
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_136()) || Global_112433) || Global_31962) || func_135()) || func_121(8, -1)) || func_134()) || func_133()) || func_132()) || func_123()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_136()) || Global_31962) || func_135()) || func_121(8, -1)) || func_132()) || func_134()) || func_133()) || func_123()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_136()) || Global_112433) || Global_31962) || func_135()) || func_121(8, -1)) || func_132()) || func_134()) || func_133()) || func_123()) || Global_113386.f_7688.f_919[iVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_136()) || Global_112433) || Global_31962) || func_135()) || func_121(8, -1)) || func_134()) || func_133()) || func_123()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_136() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_121(8, -1)) || func_123()) || func_131()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_121(8, -1) || func_134()) || func_133()) || func_131()) || func_130())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_136()) || Global_31962) || func_135()) || func_121(8, -1)) || func_133()) || func_132()) || func_123()) || Global_113386.f_7688.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_136()) || func_133()) || Global_112433) || Global_31962) || func_135()) || Global_44238) || func_121(8, -1)) || func_132()) || func_131()) || func_123()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_136()) || Global_112433) || Global_31962) || func_135()) || func_121(8, -1)) || func_132()) || func_131()) || func_134()) || func_133()) || func_123())
						{
							return 0;
						}
						break;
...
var func_130()//Position - 0x8418
{
	return Global_100480.f_1;
}

int func_131()//Position - 0x8426
{
	if (Global_97363 != -1)
	{
...
bool func_133()//Position - 0x8473
{
	return Global_100493.f_376 > 0;
}

bool func_134()//Position - 0x8484
{
	return Global_100493.f_375 > 0;
}

var func_135()//Position - 0x8495
{
	return Global_1575058;
}

int func_136()//Position - 0x84A1
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_138()//Position - 0x84D7
{
	return Global_96273;
}

int func_139(int iParam0)//Position - 0x84E3
{
	switch (iParam0)
	{
		case 0:
...
bool func_140(int iParam0)//Position - 0x8555
{
	int iVar0;
...
bool func_141(int iParam0)//Position - 0x8591
{
	return Global_43052 == iParam0;
}

void func_142(var uParam0, int iParam1)//Position - 0x859F
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_143()//Position - 0x85B0
{
	if (bLocal_248)
	{
		switch (iLocal_81)
		{
			...
			case 1:
				func_144(1208.197f, 174.5777f, 81.0003f, 138.8786f);
				break;
			
			case 2:
				func_144(2463.904f, 1509.964f, 35.0372f, 88.9199f);
				break;
			...
			case 7:
				func_144(-742.5047f, 4493.466f, 75.2206f, 180.991f);
				break;
			
			case 9:
				func_144(-1367.687f, 4381.998f, 41.4017f, 277.8339f);
				break;
			...
			case 11:
				func_144(1054.534f, -179.6562f, 70.3162f, 30.046f);
				break;
...
void func_144(struct<3> Param0, float fParam1)//Position - 0x86D0
{
	var uVar0;
	bool bVar1;
	
	fLocal_57 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Param0);
	...
	if (bVar1)
	{
		...
		if (iLocal_81 == 3)
		{
			Local_247.f_0 = VEHICLE::CREATE_VEHICLE(joaat("frogger"), Param0, fParam1, true, true, false);
			VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_247.f_0, 5);
		}
		else
		{
			Local_247.f_0 = VEHICLE::CREATE_VEHICLE(joaat("maverick"), Param0, fParam1, true, true, false);
			VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_247.f_0, 6);
		}
		iLocal_54 = Local_247.f_0;
		ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(iLocal_54, true);
		if (MISC::GET_GROUND_Z_FOR_3D_COORD(Param0, &uVar0, false, false))
		{
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_247.f_0, 5f);
		}
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_247.f_0, true);
		iLocal_249 = 1;
	}
	else
	{
...
bool func_145()//Position - 0x8800
{
	return func_146(&uLocal_79);
}

int func_146(var uParam0)//Position - 0x880E
{
	int iVar0;
...
void func_148(var uParam0)//Position - 0x88AA
{
	int iVar0;
...
void func_149()//Position - 0x88DA
{
	if (iLocal_81 == 3)
	{
		func_150(&uLocal_79, joaat("frogger"));
	}
	else
	{
		func_150(&uLocal_79, joaat("maverick"));
	}
}

int func_150(var uParam0, int iParam1)//Position - 0x8903
{
	int iVar0;
	int iVar1;
...
int func_151(var uParam0)//Position - 0x8960
{
	int iVar0;
...
void func_152(int iParam0)//Position - 0x898C
{
	if (iParam0 == 2)
	{
	}
...
void func_154(int iParam0)//Position - 0x8A20
{
	iLocal_59 = iParam0;
}

void func_155(int iParam0, bool bParam1, bool bParam2)//Position - 0x8A2C
{
	int iVar0;
	int iVar1;
...
int func_158(int iParam0, int iParam1)//Position - 0x8B6C
{
	int iVar0;
...
bool func_159(int iParam0)//Position - 0x8BB6
{
	return func_160(iParam0, Global_43052);
}

int func_160(int iParam0, int iParam1)//Position - 0x8BC7
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_161(var uParam0, int iParam1)//Position - 0x8DA8
{
	return (uParam0 && iParam1) != 0;
}

void func_162()//Position - 0x8DB7
{
	iLocal_63 = 0;
	if (ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		func_126(&uLocal_58, 8388608);
		return;
	}
	StringCopy(&Local_51, "bj", 64);
	iLocal_81 = func_166(Local_56, 1);
	func_126(&uLocal_58, 64);
	switch (iLocal_81)
	{
		case 0:
			iLocal_69 = 125;
	...
	func_126(&uLocal_58, 4194304);
	func_126(&uLocal_58, 16);
	fLocal_66 = (SYSTEM::TO_FLOAT(func_163(iLocal_69)) + 5f);
	if (iLocal_69 != 263)
	{
		if (!func_158(0, iLocal_63))
		{
	...
	{
		func_168(&uLocal_58, 8);
	}
	if (func_141(12))
	{
		func_126(&uLocal_58, 8);
	}
	iLocal_61 = 51000;
}

int func_163(int iParam0)//Position - 0x8F4A
{
	switch (iParam0)
	{
		case 91:
...
int func_164(int iParam0)//Position - 0x9062
{
...
bool func_165(int iParam0)//Position - 0x908E
{
	return Global_112473[iParam0 /*10*/].f_1;
}

int func_166(struct<3> Param0, int iParam1)//Position - 0x90A0
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	while (iVar3 < 13)
	{
		if (iParam1 == func_167(iVar3))
		{
			fVar1 = SYSTEM::VDIST2(Param0, func_108(iVar3));
			if (fVar0 > fVar1)
			{
				fVar0 = fVar1;
				iVar2 = iVar3;
...
int func_167(int iParam0)//Position - 0x90EF
{
	switch (iParam0)
	{
		case 0:
...
void func_168(var uParam0, int iParam1)//Position - 0x9136
{
	func_169(uParam0, iParam1);
}

void func_169(var uParam0, var uParam1)//Position - 0x9146
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_170(bool bParam0)//Position - 0x915B
{
	if (bParam0)
	{
		if (iLocal_69 != 263)
