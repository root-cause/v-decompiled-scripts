...
void __EntryFunction__()//Position - 0x0
{
	...
	if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_161(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
...
void func_144(struct<3> Param0, float fParam1)//Position - 0x86D0
{
	...
	if (bVar1)
	{
		...
		ENTITY::_SET_ENTITY_CLEANUP_BY_ENGINE(iLocal_54, true);
