...
int func_77(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x86F2
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_112(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
int func_78(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x88FA
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_110(struct<3> Param0, float fParam1, bool bParam2)//Position - 0x9EA4
{
	int iVar0;
...
bool func_112(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x9F29
{
	if (bParam2)
	{
...
int func_117(struct<3> Param0, int iParam1)//Position - 0xA014
{
	return func_118(Global_104212.f_2890.f_12.f_66, Param0, iParam1);
}

int func_118(int iParam0, struct<3> Param1, int iParam2)//Position - 0xA031
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_133(struct<3> Param0, bool bParam1)//Position - 0xB38B
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_33, false))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_33, false))
		{
			...
			else
			{
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_32, false))
				{
					if (!HUD::DOES_BLIP_EXIST(iLocal_52))
					{
						iLocal_52 = func_153(iLocal_32, 0, 0);
		...
		else
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_33, false))
			{
				if (!HUD::DOES_BLIP_EXIST(iLocal_49))
				{
					iLocal_49 = func_153(iLocal_33, 0, 0);
...
void func_161(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0xC4B4
{
	struct<3> Var0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104212.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104212.f_4, false))
		{
			if (func_181(24) != Global_104212.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_178(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
...
void func_162(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0xC52F
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_175(iParam3, &Var0, Param1, fParam2, func_63(iParam0));
...
void func_175(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0xCA58
{
	if (func_73(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
...
int func_178(struct<3> Param0, int iParam1, var uParam2, var uParam3)//Position - 0xCBEF
{
	int iVar0;
...
int func_179(struct<3> Param0, int iParam1, int iParam2)//Position - 0xCD05
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_185(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0xCFC3
{
	if (func_30())
	{
		...
		if (iLocal_31 == 1)
		{
			if (iLocal_303[0] == 1)
			{
				if (iLocal_303[1] == 1)
				{
					...
					else if (func_189(PLAYER::PLAYER_PED_ID(), iLocal_36[1], 1) < 15f)
					{
				...
				else if (func_189(PLAYER::PLAYER_PED_ID(), iLocal_36[0], 1) < func_189(PLAYER::PLAYER_PED_ID(), iLocal_36[1], 1))
				{
					if (func_189(PLAYER::PLAYER_PED_ID(), iLocal_36[0], 1) < 15f)
					{
	...
	if (func_34(iLocal_37, 0))
	{
		if (!PED::IS_PED_INJURED(iLocal_37))
		{
			...
			else
			{
				...
				if (iLocal_347 == 1)
				{
					if ((func_211(iLocal_37) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_37, true)) && iLocal_350 == 0)
					{
	...
	if (func_34(iLocal_39, 0))
	{
		if (!PED::IS_PED_INJURED(iLocal_39))
		{
			...
			else
			{
				...
				if (iLocal_348 == 1)
				{
					if ((func_211(iLocal_39) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_39, true)) && iLocal_352 == 0)
					{
	...
	if (func_34(iLocal_38, 0))
	{
		if (!PED::IS_PED_INJURED(iLocal_38))
		{
			...
			else
			{
				...
				if (iLocal_349 == 1)
				{
					if ((func_211(iLocal_38) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_38, true)) && iLocal_351 == 0)
					{
