...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_78 = func_374(60);
	uLocal_79 = func_374(14);
	...
	func_321("EP_1_RCM_Concat", 1);
	while (true)
	{
		SYSTEM::WAIT(0);
		func_305(Local_81.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_142)
		{
			case 0:
				func_297();
...
int func_7(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x3C4
{
	...
	else
	{
		...
		iVar20 = 0;
		func_13(&iVar20);
		iVar21 = func_12(Var10, Global_113810.f_7691.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_10(Global_113810.f_7691.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_8(Global_113810.f_7691.f_765[iVar20 /*10*/]))
				{
					Global_113810.f_7691.f_765[iVar20 /*10*/] = { Var10 };
					func_9(&Var10);
					return 1;
...
void func_13(int iParam0)//Position - 0x698
{
	...
	*iParam0 = 0;
	...
	{
		if (func_12(Global_113810.f_7691.f_765[iVar0 /*10*/], Global_113810.f_7691.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
void func_17(int iParam0, bool bParam1)//Position - 0x7DA
{
	...
	{
		func_187(&(Global_112897[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_20()//Position - 0xA3F
{
	...
	{
		func_6(13, SYSTEM::FLOOR(Global_113810.f_10197.f_3853));
	}
...
int func_44(int iParam0, int iParam1, int iParam2)//Position - 0x19D4
{
	...
	else
	{
		...
		Global_78472[1 /*14*/] = { func_97(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_89(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_89(iParam1), Global_78472[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_89(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, 0);
		}
	}
...
int func_45(int iParam0, int iParam1, int iParam2)//Position - 0x1B91
{
	...
	{
		if (!func_162(iParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_64, Global_113810.f_2366.f_539[iVar0 /*65*/].f_63))
		{
...
int func_46(int iParam0)//Position - 0x1C1D
{
	switch (iParam0)
	{
...
int func_47(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1C58
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
				...
				if (BitTest(Global_78472[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							...
							func_63(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
							func_79(14);
							if (Global_78470 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_89(iVar0), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_89(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_89(iVar0), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
						}
						func_79(iVar0);
						if (Global_78470 == 1)
						{
			...
			{
				Global_78472[1 /*14*/] = { func_97(iVar10, iVar0, func_53(iParam0, iVar0, -1), -1) };
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_89(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_89(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_89(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
		}
		if (Global_78470 == 1)
		{
			iVar2 = 0;
...
void func_48(int iParam0, int iParam1, int iParam2)//Position - 0x2469
{
	int iVar0;
	int iVar1;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x24F3
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_50(int iParam0, int iParam1, int iParam2)//Position - 0x25D1
{
	Global_78472[1 /*14*/] = { func_97(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78472[1 /*14*/].f_6, 2);
}

int func_51(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x25F9
{
	var uVar0;
	int iVar10;
...
int func_52(int iParam0, int iParam1, int iParam2)//Position - 0x2BFD
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_53(int iParam0, int iParam1, int iParam2)//Position - 0x2C96
{
	int iVar0;
	int iVar1;
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2D37
{
	int iVar0;
...
int func_55(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x303E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_56(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x3BF1
{
	int iVar0;
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3ED5
{
	int iVar0;
...
int func_58(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x419D
{
	int iVar0;
	int iVar1;
...
int func_59(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x41D4
{
	int iVar0;
...
int func_60(int iParam0, int iParam1, int iParam2)//Position - 0x41FD
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x44C7
{
	int iVar0;
...
int func_62(int iParam0, int iParam1, int iParam2)//Position - 0x4751
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_63(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x48A8
{
	int iVar0;
...
int func_64(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4942
{
	switch (iParam0)
	{
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4A10
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_66(int iParam0, int iParam1)//Position - 0x4B2A
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_67(int iParam0)//Position - 0x4ED1
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_68(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4F32
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_69(int iParam0, int iParam1)//Position - 0x502E
{
	int iVar0;
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x516C
{
	struct<2> Var0;
	int iVar15;
	int iVar16;
...
int func_71(int iParam0)//Position - 0x5227
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_72(int iParam0)//Position - 0x5286
{
	switch (iParam0)
	{
		case 0:
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x530C
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5589
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x59AE
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_76(int iParam0, int iParam1)//Position - 0x5CA1
{
	int iVar0;
	int iVar1;
...
int func_77(int iParam0, int iParam1)//Position - 0x5CE8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5D48
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_79(int iParam0)//Position - 0x5D9F
{
	if (BitTest(Global_78472[1 /*14*/].f_6, 1) && !BitTest(Global_78472[1 /*14*/].f_6, 6))
	{
		func_86(iParam0, Global_78472[1 /*14*/].f_5, Global_78472[1 /*14*/].f_2, 2, Global_78472[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_78472[1 /*14*/].f_6, 1) && BitTest(Global_78472[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_80(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x5E4B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_81(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x5E93
{
	int iVar0;
...
int func_82(int iParam0, var uParam1)//Position - 0x5EB6
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_83(uParam1));
}

int func_83(var uParam0)//Position - 0x5ECB
{
	int iVar0;
	int iVar1;
...
int func_84(int iParam0, int iParam1)//Position - 0x5EFF
{
	int iVar0;
	var uVar1;
...
bool func_85(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x5F2E
{
	int iVar0;
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x892D
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_87(int iParam0)//Position - 0x97D0
{
	if (!BitTest(Global_78472[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9818
{
	int iVar0;
	...
	{
		if (!func_162(iParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_61, Global_113810.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_89(int iParam0)//Position - 0x98C3
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_90(int iParam0, int iParam1)//Position - 0x9973
{
	int iVar0;
	struct<10> Var1;
...
void func_91(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA2A2
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_92(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xA3CC
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_93(int iParam0, int iParam1)//Position - 0xA414
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_96(&Var1, -99, -99, Global_113810.f_2366.f_539.f_196[0], Global_113810.f_2366.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_96(&Var1, -99, -99, Global_113810.f_2366.f_539.f_196[1], Global_113810.f_2366.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_96(&Var1, -99, -99, Global_113810.f_2366.f_539.f_196[2], Global_113810.f_2366.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_94(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC25D
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
int func_95(int iParam0)//Position - 0xC447
{
	switch (iParam0)
	{
		case 0:
...
void func_96(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xC4F7
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_97(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC568
{
	func_161();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_98(int iParam0, int iParam1)//Position - 0xC5BA
{
	switch (iParam0)
	{
		case 0:
...
void func_99(int iParam0)//Position - 0xC6AA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD8DE
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_84(func_103(iParam1, uParam0->f_2), Global_78469);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_84(func_102(iParam1, uParam0->f_2), Global_78469);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_84(iVar1, Global_78469);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_101(int iParam0, int iParam1, var uParam2)//Position - 0xDC7F
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_102(int iParam0, int iParam1)//Position - 0xE084
{
	switch (iParam1)
	{
		case 0:
...
int func_103(int iParam0, int iParam1)//Position - 0xE47F
{
	switch (iParam1)
	{
		case 0:
...
int func_104(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE87A
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_105(int iParam0)//Position - 0xE8B8
{
	return Global_43377 == iParam0;
}

int func_106(int iParam0)//Position - 0xE8C6
{
	switch (iParam0)
	{
		case -1:
...
void func_107(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE99A
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_108(int iParam0)//Position - 0xEC20
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0)//Position - 0xED6D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0)//Position - 0xF27A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0xF2EE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0xF361
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0xF448
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0xF78A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0xF992
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0xFBB2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0xFCBB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x1064F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x111A7
{
	if (iParam0 < 136)
	{
		func_121(iParam0);
...
void func_120(int iParam0)//Position - 0x111DC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0x11DE0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0x12CE0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0x12E0D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0, int iParam1)//Position - 0x12F04
{
	switch (iParam0)
	{
		case 0:
...
void func_125(int iParam0)//Position - 0x12FF4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x144C3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0x1460A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x14B14
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0x1517D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x151F0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x152C0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x157BB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x1594C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x1613B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x16244
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x17167
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x17E14
{
	if (iParam0 < 107)
	{
		func_140(iParam0);
...
void func_138(int iParam0)//Position - 0x17E5A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
int func_162(int iParam0, int iParam1, int iParam2)//Position - 0x1FD97
{
	...
	else if (Global_78472[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_89(iParam1)) && Global_78472[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_89(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_169()//Position - 0x20106
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_164(Global_113810.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_166(iVar0) && (!func_105(14) || Global_112760))
			{
...
void func_174(int iParam0, bool bParam1, bool bParam2)//Position - 0x2076D
{
	...
	if (iParam0 != -1)
	{
		...
		func_175(&sVar32, Var0.f_3, Global_100870, bParam1, bParam2);
	}
}
...
void func_180()//Position - 0x21D8E
{
	...
	{
		func_169();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_181(Global_113810.f_2366.f_539.f_4321));
	}
	else
	{
...
{
	func_192(iParam0, 1);
	Global_113810.f_18577[iParam0 /*6*/].f_3 = func_191();
...
void func_292(int iParam0)//Position - 0x2997D
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_293()//Position - 0x299A9
{
	func_295(0);
	func_289();
	func_294();
...
void func_294()//Position - 0x299BE
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_295(int iParam0)//Position - 0x29A16
{
	if (func_252())
	{
		return;
...
void func_296()//Position - 0x29A49
{
	func_293();
	switch (iLocal_143)
	{
...
void func_297()//Position - 0x29AC0
{
	...
	if (func_218(PLAYER::PLAYER_PED_ID()))
	{
		func_298(PLAYER::PLAYER_PED_ID(), 0);
		WEAPON::REMOVE_ALL_PED_WEAPONS(PLAYER::PLAYER_PED_ID(), true);
	}
	func_220(1);
}

void func_298(int iParam0, bool bParam1)//Position - 0x29B5E
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_166(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_299(iParam0, &(Global_113810.f_2366.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_299(int iParam0, var uParam1)//Position - 0x29C51
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_304(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_301(Var11.f_1)) && iVar72 < 51)
			{
...
int func_300(int iParam0)//Position - 0x29ED9
{
	switch (iParam0)
	{
...
int func_301(int iParam0)//Position - 0x29F7A
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_302(int iParam0, bool bParam1)//Position - 0x2A15A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_303(int iParam0, var* uParam1)//Position - 0x2AE0B
{
	int iVar0;
	int iVar1;
...
int func_304(int iParam0)//Position - 0x2AE46
{
	int iVar0;
...
void func_305(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2B0BA
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_307(Global_78945, Global_78947, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_306(char* sParam0)//Position - 0x2B39F
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_307(int iParam0, int iParam1, int iParam2)//Position - 0x2B3B2
{
	struct<2> Var0;
	int iVar2;
...
char* func_308(int iParam0)//Position - 0x2B488
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_309(int iParam0)//Position - 0x2B5DB
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_310(int iParam0)//Position - 0x2B60E
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_311(int iParam0)//Position - 0x2B641
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_312(int iParam0)//Position - 0x2B674
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_313(int iParam0)//Position - 0x2B6A7
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_314(int iParam0)//Position - 0x2B6E4
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_315(int iParam0)//Position - 0x2B717
{
	struct<2> Var0;
...
int func_316(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2B780
{
	if (((!func_318(0) || Global_78960) || Global_78948 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78944)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_253(0)) || func_317(1))
			{
			}
			else
			{
...
bool func_317(bool bParam0)//Position - 0x2B898
{
	if (bParam0)
	{
...
int func_318(int iParam0)//Position - 0x2B8C1
{
	if (Global_43377 == 15)
	{
		return 0;
...
bool func_319(int iParam0)//Position - 0x2B8E3
{
	return func_320(iParam0, Global_43377);
}

int func_320(int iParam0, int iParam1)//Position - 0x2B8F4
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_321(char* sParam0, bool bParam1)//Position - 0x2BAD5
{
	func_275(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

int func_322(var uParam0)//Position - 0x2BAEB
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			{
				func_323(&(uParam0->f_35[0]), iVar0[0], -1619.53f, 4204.1f, 83.3f, 77.92f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
...
void func_323(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x2BC4E
{
	func_324(iParam0);
...
void func_324(int* iParam0)//Position - 0x2BC90
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_325(int iParam0)//Position - 0x2BD2C
{
	if (func_218(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_326(int iParam0)//Position - 0x2BD56
{
	int iVar0;
...
void func_328()//Position - 0x2BDAB
{
	func_285();
	if (func_353())
	{
		func_352(&iLocal_145, 1, 0, 1);
		func_351(&iLocal_148);
		...
		if (func_218(PLAYER::PLAYER_PED_ID()))
		{
			...
			func_339(PLAYER::PLAYER_PED_ID(), 1, 0);
		}
	...
	func_329(&Local_81, 1, 0, 0);
	func_248(0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_329(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2BE3E
{
	func_336(uParam0, iParam1);
	func_334(uParam0, bParam2);
	func_330(uParam0, bParam3);
}

void func_330(var uParam0, bool bParam1)//Position - 0x2BE5E
{
	func_331(&(uParam0->f_41), bParam1);
}

void func_331(var uParam0, bool bParam1)//Position - 0x2BE70
{
	int iVar0;
...
void func_332(int* iParam0, bool bParam1)//Position - 0x2BEAE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_333(int* iParam0)//Position - 0x2BEE9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_334(var uParam0, bool bParam1)//Position - 0x2BF14
{
	func_335(&(uParam0->f_35), bParam1);
}

void func_335(var uParam0, bool bParam1)//Position - 0x2BF26
{
	int iVar0;
...
void func_336(var uParam0, int iParam1)//Position - 0x2BF63
{
	func_337(&(uParam0->f_28), iParam1);
}

void func_337(var uParam0, int iParam1)//Position - 0x2BF75
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_352(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_338(int* iParam0)//Position - 0x2BFB6
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_339(int iParam0, bool bParam1, bool bParam2)//Position - 0x2BFF7
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_166(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		func_340(iParam0, &(Global_113810.f_2366.f_539.f_298[iVar0 /*477*/]), bParam1);
		iVar1 = 0;
		while (iVar1 <= (8 - 1))
		{
			HUD::HUD_SET_WEAPON_WHEEL_TOP_SLOT(Global_113810.f_2366.f_539.f_1730[iVar1 /*4*/][iVar0]);
			if (bParam2)
			{
				if (iVar1 == Global_113810.f_2366.f_539.f_1763 || (Global_113810.f_2366.f_539.f_1763 == -1 && iVar1 == 4))
				{
					if (Global_113810.f_2366.f_539.f_1730[iVar1 /*4*/][iVar0] != 0 && Global_113810.f_2366.f_539.f_1730[iVar1 /*4*/][iVar0] != joaat("WEAPON_MOLOTOV"))
					{
						if (WEAPON::HAS_PED_GOT_WEAPON(iParam0, Global_113810.f_2366.f_539.f_1730[iVar1 /*4*/][iVar0], false))
						{
							WEAPON::SET_CURRENT_PED_WEAPON(iParam0, Global_113810.f_2366.f_539.f_1730[iVar1 /*4*/][iVar0], true);
						}
					}
				}
			}
...
void func_340(int iParam0, var uParam1, bool bParam2)//Position - 0x2C15A
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < iVar72)
			{
				if (iVar8 < 51)
				{
					...
					{
						if (!FILES::IS_CONTENT_ITEM_LOCKED(Var9.f_0) && !func_301(Var9.f_1))
						{
							if (iVar7 == 0)
							{
		...
		while (iVar70 < uParam1->f_221)
		{
			...
			iVar8 = func_341(iVar3, &Var9);
			if ((iVar8 != -1 && iVar8 < 51) && !func_301(Var9.f_1))
			{
				if (FILES::IS_CONTENT_ITEM_LOCKED(Var9.f_0) || func_301(Var9.f_1))
				{
								...
								if (!func_300(Var48.f_3))
								{
									if (BitTest(uParam1->f_221[iVar70 /*5*/].f_2, bVar71))
									{
										if (!WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar3, Var48.f_3))
										{
											...
											func_346(iParam0, iVar3, Var48.f_3);
											if (func_345(Var48.f_3))
											{
												WEAPON::SET_PED_WEAPON_COMPONENT_TINT_INDEX(iParam0, iVar3, Var48.f_3, uParam1->f_221[iVar70 /*5*/].f_4);
												func_344(iParam0, iVar3, Var48.f_3, uParam1->f_221[iVar70 /*5*/].f_4);
											}
										}
									}
									else if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar3, Var48.f_3))
									{
										...
										func_342(iParam0, iVar3, Var48.f_3);
									}
									bVar71++;
								}
							}
						...
						while (bVar6 < FILES::GET_NUM_DLC_WEAPON_COMPONENTS_SP(iVar8))
						{
							if (FILES::GET_DLC_WEAPON_COMPONENT_DATA_SP(iVar8, bVar6, &Var48))
							{
								if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, Var48.f_3))
								{
									...
									func_342(iParam0, iVar2, Var48.f_3);
								}
							}
							bVar6++;
						}
...
int func_341(int iParam0, var* uParam1)//Position - 0x2C7BF
{
	int iVar0;
	int iVar1;
...
void func_342(int iParam0, int iParam1, int iParam2)//Position - 0x2C7FA
{
	int iVar0;
...
int func_343(int iParam0)//Position - 0x2C827
{
	switch (iParam0)
	{
...
void func_344(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2C9BE
{
	int iVar0;
...
int func_345(int iParam0)//Position - 0x2C9E0
{
	switch (iParam0)
	{
...
void func_346(int iParam0, int iParam1, int iParam2)//Position - 0x2CD1B
{
	int iVar0;
...
bool func_347(int iParam0)//Position - 0x2CD3B
{
	int iVar0;
	struct<2> Var1;
	...
	if (iParam0 == -61829581)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_350())
		{
			return 1;
		}
		else
	...
	switch (iParam0)
	{
		...
		case joaat("WEAPON_RAILGUN"):
			if (!func_348() || NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				return 0;
			}
			break;
		...
		case joaat("WEAPON_HATCHET"):
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				if (!func_348() && !Global_262145.f_20404 /* Tunable: ENABLE_RETURNING_CONTENT_WEAPON */)
				{
					return 0;
				}
			}
	...
	while (iVar0 < FILES::GET_NUM_DLC_WEAPONS())
	{
		if (FILES::GET_DLC_WEAPON_DATA(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (FILES::IS_CONTENT_ITEM_LOCKED(Var1.f_0) || func_301(Var1.f_1))
				{
					return 0;
				}
			}
...
int func_349(bool bParam0, bool bParam1)//Position - 0x2CF1F
{
	if (bParam0)
	{
...
bool func_350()//Position - 0x2CF88
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

void func_351(int* iParam0)//Position - 0x2CF99
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_352(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2CFD1
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_354(bool bParam0)//Position - 0x2D0C2
{
	int iVar0;
	...
	if (!func_369())
	{
		...
		{
			func_174(iVar0, 1, 0);
			func_355(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_112897[iVar0 /*10*/].f_9 == -1)
...
void func_355(char* sParam0, int iParam1)//Position - 0x2D192
{
	if (Global_100833 != 12)
	{
		if (func_356(sParam0, 6, iParam1))
		{
...
int func_356(char* sParam0, int iParam1, int iParam2)//Position - 0x2D1BA
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_362())
	{
		...
		{
			iVar33 = func_357(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_357(char* sParam0)//Position - 0x2D349
{
...
int func_359(char* sParam0, bool bParam1)//Position - 0x2D3C3
{
	int iVar0;
	int iVar1;
...
int func_360(int iParam0, bool bParam1)//Position - 0x2D3ED
{
	int iVar0;
...
int func_362()//Position - 0x2D473
{
	...
	{
		if (func_357(&(Global_100833.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_363(bool bParam0)//Position - 0x2D4DF
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_364(int iParam0)//Position - 0x2D4F3
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_365(int iParam0)//Position - 0x2D52D
{
	if (iParam0 == 1)
	{
...
void func_366()//Position - 0x2D567
{
	Global_23251.f_5 = 1;
}

void func_367()//Position - 0x2D575
{
	Global_23251.f_5 = 0;
}

void func_368()//Position - 0x2D583
{
	Global_94989 = 0;
	Global_94990 = 0;
}

int func_369()//Position - 0x2D595
{
...
void func_370()//Position - 0x2D5D3
{
	Global_100868 = 1;
...
void func_371(char* sParam0)//Position - 0x2D6C0
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_372(var uParam0)//Position - 0x2D6D2
{
	func_373(&(uParam0->f_28));
	func_373(&(uParam0->f_35));
	func_373(&(uParam0->f_41));
}

void func_373(var uParam0)//Position - 0x2D6F2
{
	int iVar0;
...
int func_374(int iParam0)//Position - 0x2D72C
{
	if (!func_166(iParam0))
	{
		return func_165(iParam0);
