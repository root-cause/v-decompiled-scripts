...
int func_7(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x3C4
{
	...
	else
	{
		...
		iVar20 = 0;
		func_13(&iVar20);
		iVar21 = func_12(Var10, Global_114370.f_7691.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_10(Global_114370.f_7691.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_8(Global_114370.f_7691.f_765[iVar20 /*10*/]))
				{
					Global_114370.f_7691.f_765[iVar20 /*10*/] = { Var10 };
					func_9(&Var10);
					return 1;
...
void func_13(int iParam0)//Position - 0x698
{
	...
	*iParam0 = 0;
	...
	{
		if (func_12(Global_114370.f_7691.f_765[iVar0 /*10*/], Global_114370.f_7691.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
void func_17(int iParam0, bool bParam1)//Position - 0x7DA
{
	...
	{
		func_187(&(Global_113457[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
int func_45(int iParam0, int iParam1, int iParam2)//Position - 0x1B91
{
	...
	{
		if (!func_162(iParam0, Global_114370.f_2366.f_539[iVar0 /*65*/].f_64, Global_114370.f_2366.f_539[iVar0 /*65*/].f_63))
		{
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9929
{
	...
	{
		if (!func_162(iParam0, Global_114370.f_2366.f_539[iVar0 /*65*/].f_61, Global_114370.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_96(&Var1, -99, -99, Global_114370.f_2366.f_539.f_196[0], Global_114370.f_2366.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_96(&Var1, -99, -99, Global_114370.f_2366.f_539.f_196[1], Global_114370.f_2366.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_96(&Var1, -99, -99, Global_114370.f_2366.f_539.f_196[2], Global_114370.f_2366.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_299(int iParam0, bool bParam1)//Position - 0x29B6E
{
	...
	if (func_166(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_300(iParam0, &(Global_114370.f_2366.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_340(int iParam0, bool bParam1, bool bParam2)//Position - 0x2C085
{
	...
	if (func_166(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		func_341(iParam0, &(Global_114370.f_2366.f_539.f_298[iVar0 /*477*/]), bParam1);
		iVar1 = 0;
		while (iVar1 <= (8 - 1))
		{
			HUD::HUD_SET_WEAPON_WHEEL_TOP_SLOT(Global_114370.f_2366.f_539.f_1730[iVar1 /*4*/][iVar0]);
			if (bParam2)
			{
				if (iVar1 == Global_114370.f_2366.f_539.f_1763 || (Global_114370.f_2366.f_539.f_1763 == -1 && iVar1 == 4))
				{
					if (Global_114370.f_2366.f_539.f_1730[iVar1 /*4*/][iVar0] != 0 && Global_114370.f_2366.f_539.f_1730[iVar1 /*4*/][iVar0] != joaat("WEAPON_MOLOTOV"))
					{
						if (WEAPON::HAS_PED_GOT_WEAPON(iParam0, Global_114370.f_2366.f_539.f_1730[iVar1 /*4*/][iVar0], false))
						{
							WEAPON::SET_CURRENT_PED_WEAPON(iParam0, Global_114370.f_2366.f_539.f_1730[iVar1 /*4*/][iVar0], true);
						}
					}
				}
			}
