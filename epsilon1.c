...
int func_7(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x3C4
{
	...
	else
	{
		...
		iVar20 = 0;
		func_13(&iVar20);
		iVar21 = func_12(Var10, Global_114135.f_7692.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_10(Global_114135.f_7692.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_8(Global_114135.f_7692.f_765[iVar20 /*10*/]))
				{
					Global_114135.f_7692.f_765[iVar20 /*10*/] = { Var10 };
					func_9(&Var10);
					return 1;
...
void func_13(int iParam0)//Position - 0x698
{
	...
	*iParam0 = 0;
	...
	{
		if (func_12(Global_114135.f_7692.f_765[iVar0 /*10*/], Global_114135.f_7692.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
void func_17(int iParam0, bool bParam1)//Position - 0x7DA
{
	...
	{
		func_187(&(Global_113222[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
int func_44(int iParam0, int iParam1, int iParam2)//Position - 0x19D4
{
	...
	else
	{
		...
		Global_79322[1 /*14*/] = { func_97(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_89(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_89(iParam1), Global_79322[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_89(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, 0);
		}
	}
...
int func_45(int iParam0, int iParam1, int iParam2)//Position - 0x1B91
{
	...
	{
		if (!func_162(iParam0, Global_114135.f_2367.f_539[iVar0 /*65*/].f_64, Global_114135.f_2367.f_539[iVar0 /*65*/].f_63))
		{
...
int func_47(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1C6D
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
				...
				if (BitTest(Global_79322[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							...
							func_63(iParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
							func_79(14);
							if (Global_79320 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_89(iVar0), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_89(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_89(iVar0), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
						}
						func_79(iVar0);
						if (Global_79320 == 1)
						{
			...
			{
				Global_79322[1 /*14*/] = { func_97(iVar10, iVar0, func_53(iParam0, iVar0, -1), -1) };
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_89(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_89(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_89(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
		}
		if (Global_79320 == 1)
		{
			iVar2 = 0;
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8D31
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_87(int iParam0)//Position - 0x9BD4
{
	if (!BitTest(Global_79322[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9C1C
{
	int iVar0;
	...
	{
		if (!func_162(iParam0, Global_114135.f_2367.f_539[iVar0 /*65*/].f_61, Global_114135.f_2367.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_91(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA6A6
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_92(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xA7D0
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_96(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[0], Global_114135.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_96(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[1], Global_114135.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_96(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[2], Global_114135.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_100(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xDCE3
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_84(func_103(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_84(func_102(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_84(iVar1, Global_79319);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_104(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xEC7F
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_162(int iParam0, int iParam1, int iParam2)//Position - 0x2003F
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else if (Global_79322[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_89(iParam1)) && Global_79322[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_89(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_163(int iParam0)//Position - 0x20298
{
	int iVar0;
	int iVar1;
...
int func_164(int iParam0)//Position - 0x202D5
{
	if (func_166(iParam0))
	{
...
var func_165(int iParam0)//Position - 0x202FA
{
	return Global_2201[iParam0 /*29*/];
}

bool func_166(int iParam0)//Position - 0x20309
{
	return iParam0 < 3;
}

void func_167(char* sParam0, var uParam1)//Position - 0x20315
{
...
void func_169()//Position - 0x203AC
{
	...
	{
		if (func_164(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_163(PLAYER::PLAYER_PED_ID());
			if (func_166(iVar0) && (!func_105(14) || Global_113083))
			{
...
void func_174(int iParam0, bool bParam1, bool bParam2)//Position - 0x20A13
{
	...
	if (iParam0 != -1)
	{
		...
		func_175(&sVar32, Var0.f_3, Global_101725, bParam1, bParam2);
	}
}

void func_175(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x20A52
{
...
void func_180()//Position - 0x22034
{
	...
	{
		func_169();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_181(Global_114135.f_2367.f_539.f_4321));
	}
	else
	{
...
char* func_181(var uParam0)//Position - 0x22066
{
	uParam0 = uParam0;
	return "";
}
...
void func_182()//Position - 0x22075
{
	...
	else if ((MISC::IS_PS3_VERSION() || func_183()) || MISC::IS_PC_VERSION())
	{
...
void func_187(var uParam0)//Position - 0x2213A
{
	if (*uParam0 == -1)
	{
		return;
...
void func_192(var uParam0, bool bParam1)//Position - 0x226CD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_197(int iParam0, int iParam1)//Position - 0x22AF1
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_198(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x22B11
{
	if (iParam0 != 198)
	{
		if (Global_79539)
...
void func_209(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x26F68
{
	int iVar0;
...
int func_211(int iParam0)//Position - 0x27252
{
	int iVar0;
	int iVar1;
...
int func_214(int iParam0)//Position - 0x27489
{
...
int func_215(char* sParam0)//Position - 0x274B3
{
	int iVar0;
...
int func_217(char* sParam0, int iParam1)//Position - 0x27524
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_218(int iParam0)//Position - 0x2756D
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
					...
					if (func_244(iLocal_145, iLocal_148, -1))
					{
						if (iLocal_327)
						{
							...
							else if (!func_226())
							{
								...
								func_222(PLAYER::PLAYER_PED_ID(), 30000, 0, -1082130432);
...
int func_222(int iParam0, int iParam1, bool bParam2, int iParam3)//Position - 0x2795B
{
	...
	Global_45147[iVar2 /*6*/] = 0;
	Global_45147[iVar2 /*6*/].f_1 = iParam0;
	Global_45147[iVar2 /*6*/].f_2 = iParam1;
	Global_45147[iVar2 /*6*/].f_3 = iParam1;
	Global_45147[iVar2 /*6*/].f_4 = 0;
	Global_45147[iVar2 /*6*/].f_5 = iParam3;
...
bool func_227(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x27AE5
{
...
var func_232(int iParam0, int iParam1)//Position - 0x27EAB
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_233()//Position - 0x27EC3
{
	return -1;
}
...
void func_238()//Position - 0x28056
{
	if (func_105(14))
	{
...
void func_243(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x281F7
{
...
int func_244(int iParam0, int iParam1, int iParam2)//Position - 0x2824D
{
...
void func_245(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2828B
{
...
int func_246(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x28326
{
	bool bVar0;
	float fVar1;
...
int func_253(int iParam0)//Position - 0x28542
{
	if (iParam0 == 1)
	{
		if (Global_21066.f_1 > 3)
...
int func_260(int iParam0)//Position - 0x2897D
{
	if (func_218(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_261(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2899D
{
	if (bParam0)
	{
...
int func_265(var uParam0)//Position - 0x28BA0
{
	int iVar0;
...
int func_266(int iParam0)//Position - 0x28BC2
{
...
int func_268(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x28C0F
{
	int iVar0;
...
int func_270(int iParam0)//Position - 0x28C65
{
...
void func_273(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x28D13
{
	int iVar0;
...
Vector3 func_274(int iParam0)//Position - 0x28ED1
{
...
void func_276(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x28F23
{
	func_277(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_277(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x28F4C
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_278(struct<3> Param0)//Position - 0x29342
{
...
int func_279(int iParam0, int iParam1, bool bParam2)//Position - 0x2936C
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_280(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x293DA
{
...
int func_281(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x294B2
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_282(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x297A8
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_283(struct<3> Param0)//Position - 0x2985C
{
	float fVar0;
	float fVar1;
...
void func_284(int iParam0)//Position - 0x2989B
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_286(int iParam0, float fParam1, int iParam2)//Position - 0x29920
{
	int iVar0;
...
int func_290(int iParam0, int iParam1)//Position - 0x29A78
{
	if (func_260(iParam0))
	{
...
int func_291(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x29AAB
{
...
void func_292(int iParam0)//Position - 0x29B02
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_299(int iParam0, bool bParam1)//Position - 0x29E34
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_166(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_300(iParam0, &(Global_114135.f_2367.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_300(int iParam0, var uParam1)//Position - 0x29F27
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_301(int iParam0)//Position - 0x2A1AF
{
	switch (iParam0)
	{
...
int func_302(int iParam0)//Position - 0x2A250
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_303(int iParam0, bool bParam1)//Position - 0x2A448
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_306(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2B478
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_79794 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_308(Global_79795, Global_79797, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_307(char* sParam0)//Position - 0x2B75D
{
...
int func_317(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2BB3E
{
...
int func_319(int iParam0)//Position - 0x2BC7F
{
	if (Global_44181 == 15)
	{
		return 0;
...
bool func_320(int iParam0)//Position - 0x2BCA1
{
	return func_321(iParam0, Global_44181);
}

int func_321(int iParam0, int iParam1)//Position - 0x2BCB2
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_323(var uParam0)//Position - 0x2BEA9
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
...
void func_324(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x2C00E
{
	func_325(iParam0);
...
void func_325(int* iParam0)//Position - 0x2C051
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_326(int iParam0)//Position - 0x2C0ED
{
	if (func_218(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_327(int iParam0)//Position - 0x2C117
{
	int iVar0;
...
void func_333(int* iParam0, bool bParam1)//Position - 0x2C26F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_334(int* iParam0)//Position - 0x2C2AA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_339(int* iParam0)//Position - 0x2C377
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_340(int iParam0, bool bParam1, bool bParam2)//Position - 0x2C3B8
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_166(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		func_341(iParam0, &(Global_114135.f_2367.f_539.f_298[iVar0 /*477*/]), bParam1);
		iVar1 = 0;
		while (iVar1 <= (8 - 1))
		{
			...
			if (bParam2)
			{
				if (iVar1 == Global_114135.f_2367.f_539.f_1763 || (Global_114135.f_2367.f_539.f_1763 == -1 && iVar1 == 4))
				{
					if (Global_114135.f_2367.f_539.f_1730[iVar1 /*4*/][iVar0] != 0 && Global_114135.f_2367.f_539.f_1730[iVar1 /*4*/][iVar0] != joaat("WEAPON_MOLOTOV"))
					{
						if (WEAPON::HAS_PED_GOT_WEAPON(iParam0, Global_114135.f_2367.f_539.f_1730[iVar1 /*4*/][iVar0], false))
						{
							WEAPON::SET_CURRENT_PED_WEAPON(iParam0, Global_114135.f_2367.f_539.f_1730[iVar1 /*4*/][iVar0], true);
						}
					}
				}
			}
...
void func_341(int iParam0, var uParam1, bool bParam2)//Position - 0x2C519
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_343(int iParam0, int iParam1, int iParam2)//Position - 0x2CBB9
{
	int iVar0;
...
void func_345(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2CD7D
{
	int iVar0;
...
int func_346(int iParam0)//Position - 0x2CD9F
{
	switch (iParam0)
	{
...
void func_347(int iParam0, int iParam1, int iParam2)//Position - 0x2D0DA
{
	int iVar0;
...
bool func_348(int iParam0)//Position - 0x2D0FA
{
	...
	switch (iParam0)
	{
		...
		case joaat("WEAPON_HATCHET"):
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				if (!func_349() && !Global_262145.f_19963 /* Tunable: ENABLE_RETURNING_CONTENT_WEAPON */)
				{
					return 0;
				}
			}
...
int func_350(bool bParam0, bool bParam1)//Position - 0x2D2DE
{
	if (bParam0)
	{
...
void func_352(int* iParam0)//Position - 0x2D358
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_353(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2D390
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
int func_357(char* sParam0, int iParam1, int iParam2)//Position - 0x2D579
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_359()//Position - 0x2D75E
{
	...
	iVar0 = func_360(&(Global_101688.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_361(int iParam0, bool bParam1)//Position - 0x2D7AC
{
	int iVar0;
