...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_78 = func_372(60);
	uLocal_79 = func_372(14);
	...
	{
		SYSTEM::WAIT(0);
		func_303(Local_81.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_82)
		{
			case 0:
				func_295();
...
int func_7(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x3C4
{
	...
	else
	{
		...
		iVar2 = 0;
		func_13(&iVar2);
		iVar3 = func_12(Var1, Global_113648.f_7690.f_765[iVar2 /*10*/]);
		if (iVar3 == 2)
		{
			func_10(Global_113648.f_7690.f_765[iVar2 /*10*/]);
		...
		else if (iVar3 == 1)
		{
			...
			{
				if (!func_8(Global_113648.f_7690.f_765[iVar2 /*10*/]))
				{
					Global_113648.f_7690.f_765[iVar2 /*10*/] = { Var1 };
					func_9(&Var1);
					return 1;
...
int func_8(struct<9> Param0, var uParam1)//Position - 0x5E3
{
	if (Param0.f_8 == 0)
	{
		return 0;
...
int func_12(struct<4> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, struct<4> Param7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13)//Position - 0x667
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0, int iParam1, int iParam2)//Position - 0x19D4
{
	...
	else
	{
		...
		Global_78341[1 /*14*/] = { func_96(iVar0, iParam1, uVar6[iParam1], -1) };
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4A10
{
	...
	else
	{
		...
		iVar4 = (iParam1 - func_66(iParam0, func_88(iParam2)));
		if (iVar4 < 0)
		{
			return -1;
		}
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_88(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x516C
{
	...
	else
	{
		...
		if (iVar4 != -1)
		{
			return (func_66(iParam0, func_88(iParam2)) + iVar4);
		}
	}
	return -99;
}
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.f_0 != 0 && Var2.f_0 != -1) && Var2.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_94(Var2.f_2)] = func_70(iParam1, Var2.f_0, func_94(Var2.f_2), iVar0);
					}
				}
				else if (Var2.f_1 != -1)
				{
...
void func_106(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE7B8
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_88(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_173(int iParam0, bool bParam1, bool bParam2)//Position - 0x20525
{
	...
	if (iParam0 != -1)
	{
		...
		func_174(&sVar1, Var0.f_3, Global_100718, bParam1, bParam2);
	}
}
...
void func_176(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0x2175D
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
void func_218()//Position - 0x27095
{
	...
	switch (iLocal_83)
	{
		case 0:
			...
			func_245(PLAYER::PLAYER_PED_ID(), Local_256, 201.2074f, 0, 1);
			...
			{
				func_244(&uLocal_91, 4, iLocal_85, "CRIS", 0, 1);
			}
			bLocal_260 = false;
			iLocal_83 = 1;
			break;
		...
		case 1:
			...
			else if (func_217(iLocal_85))
			{
				if (func_217(iLocal_88))
				{
					if (func_243(iLocal_85, iLocal_88, -1))
					{
						if (iLocal_263)
						{
							if (!bLocal_260)
							{
								bLocal_260 = func_226(&uLocal_91, "EPS1AU", "EPS1_CAR", 8, 0, 0, 0);
							}
							else if (!func_225())
							{
...
int func_245(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)//Position - 0x27E19
{
	bool bVar0;
	float fVar1;
...
void func_271(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x287D3
{
	int iVar0;
...
void func_274(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x289E3
{
	func_275(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_275(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x28A0C
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_279(iVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_277(int iParam0, int iParam1, bool bParam2)//Position - 0x28E2C
{
	...
	iVar0 = 0;
	while (func_278(iParam1, iVar0, &sVar1, &iVar2))
	{
...
int func_279(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x28F72
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_280(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_280(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_280(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_280(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_280(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_280(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_280(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_280(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_280(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_280(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_280(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_280(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_280(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_280(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_280(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_280(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4))
		{
			return 1;
		}
	}
...
int func_280(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x29268
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_294()//Position - 0x297CF
{
	...
	switch (iLocal_83)
	{
		...
		case 1:
			if (!bLocal_262)
			{
				bLocal_262 = func_226(&uLocal_91, "EPS1AU", "EPS1_TRUCK", 8, 0, 0, 0);
			}
			else if (!func_225())
			{
...
void func_295()//Position - 0x29846
{
	...
	func_244(&uLocal_91, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	if (func_217(PLAYER::PLAYER_PED_ID()))
	{
...
void func_297(int iParam0, var uParam1)//Position - 0x299D7
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_299(Var7.f_1)) && iVar9 < 51)
			{
...
void func_303(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2ADEA
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_305(Global_78814, Global_78816, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_306(iVar1), 8);
					break;
			}
			break;
...
void func_321(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x2B97E
{
	func_322(iParam0);
								...
								if (!func_298(Var10.f_3))
								{
									if (BitTest(uParam1->f_221[iVar11 /*5*/].f_2, bVar12))
									{
										if (!WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar3, Var10.f_3))
										{
											...
											func_344(iParam0, iVar3, Var10.f_3);
											if (func_343(Var10.f_3))
											{
												WEAPON::SET_PED_WEAPON_COMPONENT_TINT_INDEX(iParam0, iVar3, Var10.f_3, uParam1->f_221[iVar11 /*5*/].f_4);
												func_342(iParam0, iVar3, Var10.f_3, uParam1->f_221[iVar11 /*5*/].f_4);
											}
										}
									}
						...
						while (bVar6 < FILES::GET_NUM_DLC_WEAPON_COMPONENTS_SP(iVar8))
						{
							if (FILES::GET_DLC_WEAPON_COMPONENT_DATA_SP(iVar8, bVar6, &Var10))
							{
								if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, Var10.f_3))
								{
									...
									func_340(iParam0, iVar2, Var10.f_3);
								}
							}
							bVar6++;
						}
...
int func_354(char* sParam0, int iParam1, int iParam2)//Position - 0x2CEEA
{
	...
	if (func_360())
	{
		...
		{
			iVar2 = func_355(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
