...
void func_11(var uParam0)//Position - 0x219
{
	...
	switch (uParam0->f_85.f_4)
	{
		...
		case 2:
			if (func_50(PLAYER::PLAYER_PED_ID(), uParam0[uParam0->f_85.f_2 /*14*/]))
			{
				...
				else if (uParam0->f_85.f_5 == -1)
				{
					...
					{
						func_45(&(uParam0->f_85.f_5), 4, "MPJAC_SIT" /* GXT: Press ~INPUT_CONTEXT~ to sit down. */, 0, 0, 0, 0);
					}
				}
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar7 = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_85.f_1);
		...
		case 8:
			iVar8 = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_85.f_1);
	...
	if (uParam0->f_85.f_4 == 6)
	{
		...
		else
		{
			...
			if (((((!HUD::IS_PAUSE_MENU_ACTIVE() && !func_8(&(uParam0->f_85), 0)) && !func_8(&(uParam0->f_85), 4)) && !func_21()) && !func_19(1)) && uParam0->f_85.f_8.f_2 != 3)
			{
				...
				{
					func_45(&(uParam0->f_85.f_5), 4, "MPJAC_EXIT" /* GXT: Press ~INPUT_CONTEXT~ to stand up. */, 0, 0, 0, 0);
				}
				if (uParam0->f_85.f_4 == 6)
				{
...
int func_70()//Position - 0x17F9
{
	if (Global_1853191 != func_60())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_reception_seats", Global_1853191, true, 0))
		{
			return 0;
		}
...
void func_71()//Position - 0x1845
{
	...
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_74(2, &uLocal_93, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_74(3, &uLocal_93, &iVar0);
	iVar0[0] = 4;
	iVar0[1] = 5;
	func_74(4, &uLocal_93, &iVar0);
	func_72(&uLocal_93, 6324/*func_73*/);
}

void func_72(var uParam0, int iParam1)//Position - 0x189B
{
	uParam0->f_85.f_13 = iParam1;
	func_25(&(uParam0->f_85), 5);
}

int func_73(var uParam0, int iParam1)//Position - 0x18B4
{
...
void func_74(int iParam0, var uParam1, int iParam2)//Position - 0x18ED
{
	struct<3> Var0;
	float fVar1;
	int iVar2;
...
Vector3 func_75(int iParam0)//Position - 0x19A8
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_76(int iParam0)//Position - 0x19F6
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_77(struct<3> Param0, float fParam1)//Position - 0x1A38
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
Vector3 func_78(int iParam0)//Position - 0x1A7C
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_79()//Position - 0x1AC8
{
	return func_80() + Vector(0f, -8.946f, 47.215f);
}

Vector3 func_80()//Position - 0x1AE0
{
	return 345.0041f, 4842.001f, -59.9997f;
}

void func_81(int iParam0, var uParam1, var uParam2)//Position - 0x1AF7
{
	switch (iParam0)
	{
		case 0:
...
int func_82(int iParam0, int iParam1, bool bParam2)//Position - 0x1C95
{
	int iVar0;
...
bool func_83(bool bParam0)//Position - 0x1DAB
{
	if (bParam0)
	{
	}
