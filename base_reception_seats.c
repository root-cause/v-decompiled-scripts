...
int func_70()//Position - 0x17F9
{
	if (Global_1853830 != func_60())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_reception_seats", Global_1853830, true, 0))
		{
			return 0;
		}
...
void func_71()//Position - 0x1845
{
	...
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_74(2, &uLocal_96, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_74(3, &uLocal_96, &iVar0);
	iVar0[0] = 4;
	iVar0[1] = 5;
	func_74(4, &uLocal_96, &iVar0);
	func_72(&uLocal_96, 6324/*func_73*/);
}
...
void func_74(int iParam0, var uParam1, int iParam2)//Position - 0x18ED
{
	...
	func_81(iParam0, &Var0, &fVar3);
	iVar4 = 0;
	while (iVar4 < 2)
	{
		(*uParam1)[(*iParam2)[iVar4] /*14*/] = 2;
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_8 = { func_77(func_78(iVar4), fVar3) + Var0 };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_8.f_3 = { 0f, 0f, (fVar3 + 174f) };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_1 = { func_77(func_76(iVar4), fVar3) + Var0 };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_1.f_3 = { func_77(func_75(iVar4), fVar3) + Var0 };
...
Vector3 func_77(struct<3> Param0, float fParam3)//Position - 0x1A38
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
