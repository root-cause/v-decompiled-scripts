...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112897[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_279(&(Global_112897[Var0.f_0 /*10*/].f_9));
			}
		}
		func_263(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_202(Var0.f_0);
		func_194(&iLocal_91, &(Var0.f_9), Var61);
		if (func_179(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_64(int iParam0, int iParam1)//Position - 0x47AD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x545E
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x5499
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x570D
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x5749
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5C98
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5CDC
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x645B
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x64A2
{
...
bool func_73(int iParam0)//Position - 0x64FD
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x650D
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x656D
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x6915
{
	return Global_32283;
}

int func_77(int iParam0)//Position - 0x6920
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6930
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x69D2
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x713D
{
...
int func_81()//Position - 0x7438
{
	return Global_2652364.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x7447
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x7471
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x7486
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x749D
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x74F5
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x759F
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x7634
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x7678
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x77FC
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x780A
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x82D2
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x8354
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x83AC
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x83B5
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x8621
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x8631
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x864E
{
	return func_74(iParam0, 0, 0);
}

int func_99(int iParam0)//Position - 0x865E
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x8994
{
	return Global_100885.f_393 > 0;
}

var func_101()//Position - 0x89A5
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x89EB
{
	if (iParam1 <= 0)
	{
		return;
...
void func_103(var uParam0, int iParam1)//Position - 0x8A71
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8AA4
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8AF5
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8B97
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8BB9
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8BD0
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8BDD
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8C17
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8C52
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8C8E
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8CA7
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8D00
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8D16
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8D2C
{
...
int func_117(bool bParam0)//Position - 0x8D6E
{
...
struct<2> func_118(int iParam0)//Position - 0x8D96
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x91E3
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA4BB
{
	switch (iParam0)
	{
		case 0:
...
int func_122(var* uParam0)//Position - 0xA801
{
	int iVar0;
...
void func_123(int iParam0)//Position - 0xA8A6
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xA941
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xA99F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xA9F8
{
...
int func_128(int iParam0)//Position - 0xAA7B
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAAAC
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAAC1
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xAB74
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAB8F
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xABDB
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xAC24
{
	if (func_136(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xAC44
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_137(int iParam0)//Position - 0xAC65
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xAD35
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xAD88
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xAE7D
{
	switch (iParam0)
	{
		case 5:
...
void func_142(bool bParam0)//Position - 0xAEE8
{
	int iVar0;
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAF27
{
	if (bParam0)
	{
...
bool func_144()//Position - 0xB074
{
	return BitTest(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_36.f_18, 14);
}

bool func_145(int iParam0, int iParam1)//Position - 0xB08E
{
	bool bVar0;
...
int func_146(int iParam0, bool bParam1)//Position - 0xB0E7
{
	int iVar0;
	int iVar1;
...
int func_147(var uParam0)//Position - 0xB128
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB14A
{
...
bool func_149()//Position - 0xB189
{
	return BitTest(Global_2621446, 3);
}

int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB197
{
	int iVar0;
...
void func_152(int iParam0)//Position - 0xB1F1
{
	if (iParam0 == 1)
	{
...
int func_153(char* sParam0)//Position - 0xB214
{
...
void func_154()//Position - 0xB251
{
	Global_20711 = 0;
	func_155();
}

void func_155()//Position - 0xB261
{
...
int func_159(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB347
{
...
void func_160(int iParam0)//Position - 0xB4DF
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_162(int iParam0)//Position - 0xB55C
{
	if (func_167())
	{
		return;
...
void func_163(int iParam0)//Position - 0xB58F
{
	if (func_167())
	{
		return;
...
void func_164(bool bParam0, bool bParam1)//Position - 0xB619
{
	if (bParam0)
	{
		if (func_166(0))
...
bool func_165()//Position - 0xB68D
{
	return BitTest(Global_1963795, 5);
}

int func_166(int iParam0)//Position - 0xB69B
{
	if (iParam0 == 1)
	{
...
bool func_167()//Position - 0xB6F2
{
	return BitTest(Global_1963795, 19);
}

int func_168(int iParam0)//Position - 0xB701
{
...
int func_169(int iParam0)//Position - 0xB742
{
	int iVar0;
...
void func_170(int iParam0)//Position - 0xB787
{
...
int func_171(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB7B9
{
	int iVar0;
...
void func_172(var uParam0, int iParam1)//Position - 0xB8F0
{
	int iVar0;
...
bool func_173(int iParam0)//Position - 0xB93F
{
	return func_174(iParam0, Global_43377);
}

int func_174(int iParam0, int iParam1)//Position - 0xB950
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_175(int iParam0)//Position - 0xBB31
{
	if (Global_43377 == 15)
	{
		return 0;
...
int func_176()//Position - 0xBB53
{
	return func_177(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_177(char* sParam0, int iParam1)//Position - 0xBB64
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_179(var uParam0, int iParam1)//Position - 0xBBD1
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_180()//Position - 0xC3B4
{
	func_27(&(Global_104373.f_2890), &Global_104373, 0, 1, 1, 0);
}

int func_181(var uParam0)//Position - 0xC3CF
{
	float fVar0;
...
void func_182(int iParam0, int iParam1)//Position - 0xC45D
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_183(bool bParam0)//Position - 0xC4C1
{
	int iVar0;
...
int func_184(int iParam0)//Position - 0xC558
{
	if (func_136(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_185(int iParam0)//Position - 0xC582
{
	bool bVar0;
...
var func_186()//Position - 0xCC9F
{
	return Global_100872.f_1;
}

int func_187()//Position - 0xCCAD
{
	if (Global_97735 != -1)
	{
...
bool func_190()//Position - 0xCD14
{
	return Global_100885.f_394 > 0;
}

var func_191(int iParam0, int iParam1)//Position - 0xCD25
{
	switch (iParam0)
	{
		case 5:
...
var func_192()//Position - 0xCD5D
{
	return Global_1575063;
}

int func_193()//Position - 0xCD69
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_194(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xCD85
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_195(int iParam0, bool bParam1)//Position - 0xCE76
{
	if (iParam0 == -1)
	{
		return;
...
int func_196(int iParam0)//Position - 0xCEB2
{
	if (Global_78685 == iParam0)
	{
		if (Global_78686 == -1)
...
void func_197(int iParam0, int iParam1)//Position - 0xCEEB
{
	bool bVar0;
	int iVar1;
...
float func_198(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xCF89
{
	struct<3> Var0;
...
bool func_199()//Position - 0xCFC3
{
	return Global_98122;
}

void func_200(int iParam0)//Position - 0xCFCF
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_201(iParam0);
...
void func_201(int iParam0)//Position - 0xCFE6
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_202(int iParam0)//Position - 0xD0CE
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
int func_203(var uParam0, bool bParam1)//Position - 0xD0F6
{
	struct<27> Var0;
...
void func_204(int iParam0, var uParam1, int iParam2)//Position - 0xD366
{
	int iVar0;
	int iVar1;
...
int func_205(int iParam0)//Position - 0xD6BE
{
...
int func_206(var uParam0)//Position - 0xD6DE
{
...
int func_207(var uParam0)//Position - 0xD6F6
{
...
void func_208(var uParam0)//Position - 0xD71B
{
	int iVar0;
	int iVar1;
...
void func_209(int* iParam0)//Position - 0xDA1F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_210(var uParam0)//Position - 0xDA4A
{
	int iVar0;
...
int func_211(var uParam0, bool bParam1, bool bParam2)//Position - 0xDACA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_212(int iParam0, int iParam1)//Position - 0xDC88
{
	int iVar0;
...
int func_213(var uParam0, bool bParam1, int iParam2)//Position - 0xDCB8
{
	int iVar0;
	int iVar1;
...
int func_214(int iParam0)//Position - 0xDF74
{
...
int func_215(int iParam0, float fParam1)//Position - 0xDFA8
{
	float fVar0;
...
bool func_216(int iParam0, float fParam1)//Position - 0xE01E
{
	return func_217(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_217(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE036
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_218(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE0F7
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_219(int iParam0, int iParam1)//Position - 0xE223
{
	int iVar0;
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE332
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_222(struct<3> Param0, struct<3> Param3)//Position - 0xE3C3
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_223(struct<3> Param0)//Position - 0xE3E4
{
	float fVar0;
	float fVar1;
...
void func_224(var uParam0)//Position - 0xE423
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_225(int iParam0, int iParam1)//Position - 0xE43E
{
	int iVar0;
...
int func_226(int iParam0)//Position - 0xE47D
{
...
int func_227(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE4A5
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_228(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE5A0
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_229(int iParam0, float fParam1)//Position - 0xE6AC
{
	var uVar0;
	struct<3> Var1;
...
int func_230(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE741
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_231(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE7CF
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_232(int iParam0)//Position - 0xE817
{
...
void func_233(int iParam0)//Position - 0xE861
{
	int iVar0;
...
int func_234(int iParam0)//Position - 0xE8FE
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
int func_235(int iParam0)//Position - 0xE993
{
...
int func_238(int iParam0)//Position - 0xEA12
{
...
int func_240(int iParam0)//Position - 0xEA84
{
	if (func_117(0))
	{
...
int func_241(int iParam0)//Position - 0xEAAC
{
	if (!func_242(iParam0))
	{
		return 0;
...
int func_242(var uParam0)//Position - 0xEACB
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_247(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			{
				func_246(&(uParam0->f_41[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				func_246(&(uParam0->f_41[1]), iVar0[2], 2727.686f, 4145.715f, 44.08f, 71f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_243(&(uParam0->f_28[0]), 62, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1))
				{
					bVar5 = false;
				}
			}
...
int func_243(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xED63
{
	if (func_244(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_244(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xEDBF
{
	int iVar0;
...
int func_245(var uParam0, int iParam1)//Position - 0xEE4D
{
	int iVar0;
...
void func_246(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xEE93
{
	func_209(iParam0);
...
void func_248(int iParam0, bool bParam1, bool bParam2)//Position - 0xEEEB
{
	struct<3> Var0;
	struct<3> Var3;
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				iLocal_90 = PED::ADD_SCENARIO_BLOCKING_AREA(Var0, Var3, false, true, true, true);
...
int func_249(int iParam0)//Position - 0xEFEB
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
...
int func_250(int iParam0)//Position - 0xF011
{
	struct<27> Var0;
	bool bVar32;
...
int func_251(int iParam0)//Position - 0xF062
{
	char* sVar0;
...
int func_252(int iParam0)//Position - 0xF11B
{
	var uVar0;
...
int func_253(int iParam0)//Position - 0xF1DC
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_254(int iParam0, char* sParam1)//Position - 0xF261
{
...
int func_255(int iParam0)//Position - 0xF343
{
...
int func_256(int iParam0)//Position - 0xF36E
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_257(int iParam0)//Position - 0xF399
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_258(int iParam0)//Position - 0xF3C4
{
	if (func_235(iParam0))
	{
		return 0;
...
void func_259()//Position - 0xF3F9
{
	func_280("Running end routines.");
	Global_113528 = (Global_113528 - 1);
}

int func_260(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF413
{
	int iVar0;
...
int func_261(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xF478
{
	int iVar0;
	struct<7> Var1;
...
int func_262(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xF4F0
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_263(int iParam0, bool bParam1)//Position - 0xF56B
{
	if (bParam1)
	{
		func_280("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_248(*iParam0, 0, 1);
		func_277(iParam0);
...
int func_264(var uParam0)//Position - 0xF5D0
{
	if (func_207(uParam0))
	{
...
void func_265(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xF606
{
...
void func_266(var uParam0, bool bParam1)//Position - 0xF626
{
	func_267(&(uParam0->f_41), bParam1);
}

void func_267(var uParam0, bool bParam1)//Position - 0xF638
{
	int iVar0;
...
void func_268(int* iParam0, bool bParam1)//Position - 0xF676
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_269(var uParam0, bool bParam1)//Position - 0xF6B1
{
	func_270(&(uParam0->f_35), bParam1);
}

void func_270(var uParam0, bool bParam1)//Position - 0xF6C3
{
	int iVar0;
...
void func_271(int* iParam0)//Position - 0xF700
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_272(int* iParam0)//Position - 0xF738
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_273(var uParam0, int iParam1)//Position - 0xF7D4
{
	func_274(&(uParam0->f_28), iParam1);
}

void func_274(var uParam0, int iParam1)//Position - 0xF7E6
{
	int iVar0;
...
void func_275(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF827
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_276(int* iParam0)//Position - 0xF877
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_277(var uParam0)//Position - 0xF8B8
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		if (func_135(uParam0->f_28[0]))
		{
			if (func_278(uParam0->f_28[0], joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE")))
			{
...
int func_278(int iParam0, int iParam1)//Position - 0xF929
{
	if (func_135(iParam0))
	{
...
void func_279(var uParam0)//Position - 0xF95C
{
	if (*uParam0 == -1)
	{
		return;
...
void func_280(char* sParam0)//Position - 0xF999
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_281(var uParam0)//Position - 0xF9AB
{
	*uParam0 = -1;
