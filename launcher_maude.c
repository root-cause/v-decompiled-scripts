...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		func_275("Force cleanup [TERMINATING]");
		if (Var0.f_0 != -1)
		{
			if (Global_112735[Var0.f_0 /*10*/].f_9 != -1)
			{
				func_275("Relinquishing candidate id...");
				func_274(&(Global_112735[Var0.f_0 /*10*/].f_9));
			}
		}
		func_258(&Var0, 1);
	}
	...
	while (!func_236(&Var0))
	{
		...
		{
			func_275("Player out of range [TERMINATING]");
			func_258(&Var0, 1);
		}
	}
	...
	while (true)
	{
		...
		func_197(Var0.f_0);
		func_189(&iLocal_93, &(Var0.f_9), Var61);
		if (func_174(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_2(var* uParam0)//Position - 0x20D
{
	...
	if (!func_173())
	{
		while (!func_164(*uParam0))
		{
			...
			if (!func_198(uParam0, *uParam0 != 2))
			{
				func_275("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			SYSTEM::WAIT(0);
		}
	...
	if (!func_118(uParam0))
	{
		func_275("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
	func_115(*uParam0, &Var0);
	MemCopy(&sVar32, {func_114(*uParam0)}, 4);
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3E3C
{
	int iVar0;
...
int func_61(int iParam0)//Position - 0x45BE
{
...
int func_62(int iParam0, int iParam1)//Position - 0x4798
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x53F9
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x5434
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x56A8
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x56E4
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5C33
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5C77
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x63F6
{
	if (bParam6)
	{
...
int func_70(var uParam0)//Position - 0x643D
{
...
bool func_71(int iParam0)//Position - 0x6498
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x64A8
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x6509
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x68A2
{
	return Global_32163;
}

int func_75(int iParam0)//Position - 0x68AD
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x68BD
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x695F
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_78()//Position - 0x70AF
{
...
int func_79()//Position - 0x73AA
{
	return Global_2652258.f_2650;
}

int func_80(struct<3> Param0)//Position - 0x73B9
{
...
int func_81(int iParam0)//Position - 0x73E3
{
	if (iParam0 != func_90())
	{
...
Vector3 func_82(int iParam0, int iParam1)//Position - 0x743B
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_83(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x74E5
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_84(struct<3> Param0, float fParam3)//Position - 0x757A
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_85(int iParam0)//Position - 0x75BE
{
	struct<6> Var0;
...
struct<6> func_86(int iParam0)//Position - 0x7742
{
	return func_87(iParam0);
}

struct<6> func_87(int iParam0)//Position - 0x7750
{
	struct<6> Var0;
...
int func_88(int iParam0, var uParam1)//Position - 0x821C
{
	switch (iParam0)
	{
		case 0:
...
int func_89(int iParam0)//Position - 0x829E
{
	if (iParam0 != func_90())
	{
...
int func_90()//Position - 0x82F6
{
	return -1;
}

Vector3 func_91(int iParam0)//Position - 0x82FF
{
	switch (iParam0)
	{
		case 1:
...
int func_92()//Position - 0x8576
{
	return func_93(PLAYER::PLAYER_ID());
}

int func_93(int iParam0)//Position - 0x8586
{
	return MISC::GET_BITS_IN_RANGE(Global_2657589[iParam0 /*466*/].f_321.f_3, 28, 31);
}

int func_94(int iParam0)//Position - 0x85A3
{
	return func_72(iParam0, 0, 0);
}

int func_95(int iParam0)//Position - 0x85B3
{
	switch (iParam0)
	{
		case -1:
...
bool func_96()//Position - 0x88DC
{
	return Global_100733.f_387 > 0;
}

var func_97()//Position - 0x88ED
{
	var uVar0;
...
void func_98(var uParam0, int iParam1)//Position - 0x8933
{
	if (iParam1 <= 0)
	{
		return;
...
void func_99(var uParam0, int iParam1)//Position - 0x89B9
{
...
void func_100(var uParam0, int iParam1)//Position - 0x89EC
{
	int iVar0;
	int iVar1;
...
int func_101(int iParam0, int iParam1)//Position - 0x8A3D
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_102(int iParam0)//Position - 0x8ADF
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_103(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_103(bool bParam0, int iParam1, int iParam2)//Position - 0x8B01
{
	if (bParam0)
	{
		return iParam1;
...
int func_104(var uParam0)//Position - 0x8B18
{
	return uParam0 & 15;
}

void func_105(var uParam0, int iParam1)//Position - 0x8B25
{
...
void func_106(var uParam0, int iParam1)//Position - 0x8B5F
{
...
void func_107(var uParam0, int iParam1)//Position - 0x8B9A
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_108()//Position - 0x8BD6
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_109(int iParam0)//Position - 0x8BEF
{
	var uVar0;
	char cVar1[24];
...
bool func_110()//Position - 0x8C48
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_111()//Position - 0x8C5E
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_112(char* sParam0, int iParam1, int iParam2)//Position - 0x8C74
{
...
int func_113(bool bParam0)//Position - 0x8CB6
{
...
struct<2> func_114(int iParam0)//Position - 0x8CDE
{
	struct<2> Var0;
...
void func_115(int iParam0, var uParam1)//Position - 0x912B
{
	switch (iParam0)
	{
		case 0:
...
int func_117(int iParam0)//Position - 0xA403
{
	switch (iParam0)
	{
		case 0:
...
int func_118(var* uParam0)//Position - 0xA749
{
	int iVar0;
	...
	if (func_148(&(uParam0->f_1)))
	{
		...
		{
			func_275("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::SET_SCRIPT_CAN_START_CUTSCENE(iVar0);
		}
		else
		{
			func_275("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_119(int iParam0)//Position - 0xA7EE
{
	struct<2> Var0;
...
void func_120(int iParam0)//Position - 0xA889
{
	if (iParam0 < 63)
	{
		func_121();
...
void func_122(int iParam0)//Position - 0xA8E7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_123(int iParam0)//Position - 0xA940
{
...
int func_124(int iParam0)//Position - 0xA9C3
{
	int iVar0;
...
void func_125(int iParam0, int iParam1, int iParam2)//Position - 0xA9F4
{
	func_126(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_126(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAA09
{
	int iVar0;
...
int func_128(int iParam0, int iParam1, int iParam2)//Position - 0xAABC
{
...
int func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAAD7
{
	int iVar0;
...
int func_130(int iParam0)//Position - 0xAB23
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0xAB6C
{
	if (func_132(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_132(int iParam0)//Position - 0xAB8C
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_133(int iParam0)//Position - 0xABAD
{
	switch (iParam0)
	{
		case 5:
...
int func_135(int iParam0)//Position - 0xAC7D
{
	switch (iParam0)
	{
		case 5:
...
void func_136(var uParam0, bool bParam1, bool bParam2)//Position - 0xACD0
{
	int iVar0;
...
int func_137(int iParam0)//Position - 0xADC5
{
	switch (iParam0)
	{
		case 5:
...
void func_138(bool bParam0)//Position - 0xAE30
{
	int iVar0;
...
void func_139(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAE6F
{
	if (bParam0)
	{
...
bool func_140()//Position - 0xAFBC
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_141(int iParam0, int iParam1)//Position - 0xAFD6
{
	bool bVar0;
...
int func_142(int iParam0, bool bParam1)//Position - 0xB021
{
	int iVar0;
	int iVar1;
...
int func_143(int iParam0)//Position - 0xB062
{
...
bool func_144()//Position - 0xB0A1
{
	return BitTest(Global_2621446, 3);
}

int func_145(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB0AF
{
	int iVar0;
...
void func_147(int iParam0)//Position - 0xB109
{
	if (iParam0 == 1)
	{
...
int func_148(char* sParam0)//Position - 0xB12C
{
	...
	func_275("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}

void func_149()//Position - 0xB169
{
	Global_20591 = 0;
	func_150();
}

void func_150()//Position - 0xB179
{
...
int func_154(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB25F
{
...
void func_155(int iParam0)//Position - 0xB3F7
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_157(int iParam0)//Position - 0xB474
{
	if (func_162())
	{
		return;
...
void func_158(int iParam0)//Position - 0xB4A7
{
	if (func_162())
	{
		return;
...
void func_159(bool bParam0, bool bParam1)//Position - 0xB531
{
	if (bParam0)
	{
		if (func_161(0))
...
bool func_160()//Position - 0xB5A5
{
	return BitTest(Global_1962996, 5);
}

int func_161(int iParam0)//Position - 0xB5B3
{
	if (iParam0 == 1)
	{
...
bool func_162()//Position - 0xB60A
{
	return BitTest(Global_1962996, 19);
}

int func_163(int iParam0)//Position - 0xB619
{
...
int func_164(int iParam0)//Position - 0xB65A
{
	int iVar0;
...
void func_165(int iParam0)//Position - 0xB69F
{
...
int func_166(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB6D1
{
	int iVar0;
...
void func_167(var uParam0, int iParam1)//Position - 0xB808
{
	int iVar0;
...
bool func_168(int iParam0)//Position - 0xB857
{
	return func_169(iParam0, Global_43257);
}

int func_169(int iParam0, int iParam1)//Position - 0xB868
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_170(int iParam0)//Position - 0xBA49
{
	if (Global_43257 == 15)
	{
		return 0;
...
int func_171()//Position - 0xBA6B
{
	return func_172(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_172(char* sParam0, int iParam1)//Position - 0xBA7C
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_174(var uParam0, int iParam1)//Position - 0xBAE9
{
	switch (uParam0->f_16)
	{
		case 0:
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_180(2))
							{
								if (func_178(uParam0->f_27))
								{
									...
									func_275("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.88849f, 371.9034f, 103.98843f, 241.58984f, 359.64575f, 107.34612f, 1.25f, false, true, 0))
					{
						if (func_180(2))
						{
							...
							{
								func_177(uParam0->f_27, *uParam0);
								func_275("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.9482f, 4143.44f, 42.292946f, 2722.2134f, 4144.5215f, 45.431824f, 10f, false, true, 0))
				{
					if (func_180(2))
					{
						...
						{
							func_177(1, *uParam0);
							func_275("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.11035f, 68.460175f, -1028.5663f, 395.46133f, 94.57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.75565f, 68.02096f, -1021.4514f, 336.34583f, 93.18714f, 14.5f, false, true, 0))
						{
							if (func_180(2))
							{
								...
								{
									func_177(uParam0->f_27, *uParam0);
									func_275("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_175()//Position - 0xC2CF
{
	func_27(&(Global_104212.f_2890), &Global_104212, 0, 1, 1, 0);
}

int func_176(var uParam0)//Position - 0xC2EA
{
	float fVar0;
...
void func_177(int iParam0, int iParam1)//Position - 0xC378
{
	if (iParam0 == 1)
	{
		if (!func_135(iParam1))
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_275("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_275("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
int func_178(bool bParam0)//Position - 0xC3DC
{
	int iVar0;
...
int func_179(int iParam0)//Position - 0xC473
{
	if (func_132(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_180(int iParam0)//Position - 0xC49D
{
	bool bVar0;
...
var func_181()//Position - 0xCBBA
{
	return Global_100720.f_1;
}

int func_182()//Position - 0xCBC8
{
	if (Global_97603 != -1)
	{
...
bool func_185()//Position - 0xCC2F
{
	return Global_100733.f_388 > 0;
}

var func_186(int iParam0, int iParam1)//Position - 0xCC40
{
	switch (iParam0)
	{
		case 5:
...
var func_187()//Position - 0xCC78
{
	return Global_1575060;
}

int func_188()//Position - 0xCC84
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_189(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xCCA0
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_190(int iParam0, bool bParam1)//Position - 0xCD91
{
	if (iParam0 == -1)
	{
		return;
...
int func_191(int iParam0)//Position - 0xCDCD
{
	if (Global_78554 == iParam0)
	{
		if (Global_78555 == -1)
...
void func_192(int iParam0, int iParam1)//Position - 0xCE06
{
	bool bVar0;
	int iVar1;
...
float func_193(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xCEA4
{
	struct<3> Var0;
...
bool func_194()//Position - 0xCEDE
{
	return Global_97990;
}

void func_195(int iParam0)//Position - 0xCEEA
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_196(iParam0);
...
void func_196(int iParam0)//Position - 0xCF01
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_197(int iParam0)//Position - 0xCFE9
{
	if (iParam0 == -1)
	{
		iParam0 = func_171();
...
int func_198(var uParam0, bool bParam1)//Position - 0xD011
{
	struct<27> Var0;
	
	if (Global_78558)
	{
		func_275("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_115(*uParam0, &Var0);
	...
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_275("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_229(*uParam0))
	{
		...
		func_275("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1)
	{
	...
	if (*uParam0 == 10)
	{
		...
		{
			func_275("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_275("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
...
void func_199(int iParam0, var uParam1, int iParam2)//Position - 0xD281
{
	int iVar0;
	int iVar1;
...
int func_200(int iParam0)//Position - 0xD5D9
{
...
int func_201(var uParam0)//Position - 0xD5F9
{
...
int func_202(var uParam0)//Position - 0xD611
{
...
void func_203(var uParam0)//Position - 0xD636
{
	int iVar0;
	int iVar1;
...
void func_204(int* iParam0)//Position - 0xD93A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_205(var uParam0)//Position - 0xD965
{
	int iVar0;
...
int func_206(var uParam0, bool bParam1, bool bParam2)//Position - 0xD9E5
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_131(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				{
					func_275("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[iVar0], false))
				{
					func_275("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[iVar0], PLAYER::PLAYER_PED_ID(), false))
				{
					func_275("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[iVar0]) < 850)
				{
					func_275("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							func_275("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_179(iVar2))
						{
							if (ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck") || ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck2"))
							{
								if (func_179(uParam0->f_35[iVar0]))
								{
									...
									{
										func_275("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_179(iVar3))
						{
							...
							{
								func_275("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							...
							{
								func_275("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
...
int func_207(int iParam0, int iParam1)//Position - 0xDBA3
{
	int iVar0;
...
int func_208(var uParam0, bool bParam1, int iParam2)//Position - 0xDBD3
{
	int iVar0;
	int iVar1;
	...
	if (func_131(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[iVar0]))
						{
							...
							func_275("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[iVar0]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[iVar0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[iVar0]))
					{
						...
						func_275("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[iVar0], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
						{
							...
							func_275("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_227(*uParam0))
					{
						if (!func_163(*uParam0))
						{
							if (func_222(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								...
								func_275("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[iVar0], true), 15f))
						{
							...
							func_275("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_210(uParam0->f_28[iVar0], 1126825984))
						{
							...
							func_275("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_209(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_275("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_275("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_132(uParam0->f_41[0]))
						{
...
int func_209(int iParam0)//Position - 0xDE8F
{
...
int func_210(int iParam0, float fParam1)//Position - 0xDEC3
{
	float fVar0;
...
bool func_211(int iParam0, float fParam1)//Position - 0xDF39
{
	return func_212(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_212(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDF51
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_213(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE012
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_214(int iParam0, int iParam1)//Position - 0xE13E
{
	int iVar0;
...
int func_216(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE24D
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_217(struct<3> Param0, struct<3> Param3)//Position - 0xE2DE
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_218(struct<3> Param0)//Position - 0xE2FF
{
	float fVar0;
	float fVar1;
...
void func_219(var uParam0)//Position - 0xE33E
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_220(int iParam0, int iParam1)//Position - 0xE359
{
	int iVar0;
...
int func_221(int iParam0)//Position - 0xE398
{
...
int func_222(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE3C0
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_223(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE4BB
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_224(int iParam0, float fParam1)//Position - 0xE5C7
{
	var uVar0;
	struct<3> Var1;
...
int func_225(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE65C
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_226(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE6EA
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_227(int iParam0)//Position - 0xE732
{
...
void func_228(int iParam0)//Position - 0xE77C
{
	int iVar0;
...
int func_229(int iParam0)//Position - 0xE819
{
	if (iParam0 == -1)
	{
		iParam0 = func_171();
...
int func_230(int iParam0)//Position - 0xE8AE
{
...
int func_233(int iParam0)//Position - 0xE92D
{
...
int func_235(int iParam0)//Position - 0xE99F
{
	if (func_113(0))
	{
...
int func_236(int iParam0)//Position - 0xE9C7
{
	if (!func_237(iParam0))
	{
		return 0;
	}
	func_275("Created initial scene");
	return 1;
}

int func_237(var uParam0)//Position - 0xE9E6
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_242(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				func_241(&(uParam0->f_41[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				func_241(&(uParam0->f_41[1]), iVar0[2], 2727.686f, 4145.715f, 44.08f, 71f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_238(&(uParam0->f_28[0]), 62, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1))
				{
					bVar5 = false;
				}
			}
		...
		case 3:
			if (func_131(uParam0->f_28[0]) && func_132(uParam0->f_41[0]))
			{
...
int func_238(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xEC7E
{
	if (func_239(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_239(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xECDA
{
	int iVar0;
...
int func_240(var uParam0, int iParam1)//Position - 0xED68
{
	int iVar0;
...
void func_241(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xEDAE
{
	func_204(iParam0);
...
int func_242(int iParam0)//Position - 0xEDD5
{
	int iVar0;
...
void func_243(int iParam0, bool bParam1, bool bParam2)//Position - 0xEE06
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_244(int iParam0)//Position - 0xEF06
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
...
int func_245(int iParam0)//Position - 0xEF2C
{
	struct<27> Var0;
	bool bVar32;
...
int func_246(int iParam0)//Position - 0xEF7D
{
	char* sVar0;
	
	if (Global_78558)
	{
		func_275("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!Global_113648.f_9087 && !func_113(1))
	{
		func_275("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_247(iParam0))
	{
		Global_112735[iParam0 /*10*/].f_1 = 1;
		func_275("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_100681.f_11 == 6)
	{
		if (Global_100681 < 9)
		{
			...
			{
				func_275("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	...
	{
		Global_112735[iParam0 /*10*/].f_1 = 1;
		func_275("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}

int func_247(int iParam0)//Position - 0xF036
{
	var uVar0;
...
int func_248(int iParam0)//Position - 0xF0F7
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_249(int iParam0, char* sParam1)//Position - 0xF17C
{
...
int func_250(int iParam0)//Position - 0xF25E
{
...
int func_251(int iParam0)//Position - 0xF289
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_252(int iParam0)//Position - 0xF2B4
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_253(int iParam0)//Position - 0xF2DF
{
	if (func_230(iParam0))
	{
		return 0;
...
void func_254()//Position - 0xF314
{
	func_275("Running end routines.");
	Global_113366 = (Global_113366 - 1);
}

int func_255(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF32E
{
	int iVar0;
	...
	func_275("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}

int func_256(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xF393
{
	int iVar0;
	struct<7> Var1;
...
int func_257(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xF40B
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_258(int iParam0, bool bParam1)//Position - 0xF486
{
	if (bParam1)
	{
		func_275("SCRIPT TERMINATING: Cleaning up entities in Launcher");
	...
	if (iLocal_93 != -1)
	{
		func_275("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_196(&iLocal_93);
	}
...
int func_259(var uParam0)//Position - 0xF4EB
{
	if (func_202(uParam0))
	{
...
void func_260(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xF521
{
...
void func_261(var uParam0, bool bParam1)//Position - 0xF541
{
	func_262(&(uParam0->f_41), bParam1);
}

void func_262(var uParam0, bool bParam1)//Position - 0xF553
{
	int iVar0;
...
void func_263(int* iParam0, bool bParam1)//Position - 0xF591
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_264(var uParam0, bool bParam1)//Position - 0xF5CC
{
	func_265(&(uParam0->f_35), bParam1);
}

void func_265(var uParam0, bool bParam1)//Position - 0xF5DE
{
	int iVar0;
...
void func_266(int* iParam0)//Position - 0xF61B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_267(int* iParam0)//Position - 0xF653
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_268(var uParam0, int iParam1)//Position - 0xF6EF
{
	func_269(&(uParam0->f_28), iParam1);
}

void func_269(var uParam0, int iParam1)//Position - 0xF701
{
	int iVar0;
...
void func_270(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF742
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_271(int* iParam0)//Position - 0xF792
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_272(var uParam0)//Position - 0xF7D3
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		if (func_131(uParam0->f_28[0]))
		{
			if (func_273(uParam0->f_28[0], joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE")))
			{
...
int func_273(int iParam0, int iParam1)//Position - 0xF844
{
	if (func_131(iParam0))
	{
...
void func_274(var uParam0)//Position - 0xF877
{
	if (*uParam0 == -1)
	{
		return;
...
void func_275(char* sParam0)//Position - 0xF8B4
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_276(var uParam0)//Position - 0xF8C6
{
	*uParam0 = -1;
...
void func_277()//Position - 0xF8F9
{
	func_275("Running start routines.");
	Global_113366++;
}
