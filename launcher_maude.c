...
int func_64(int iParam0, int iParam1)//Position - 0x47BF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x5500
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x553B
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x57AF
{
	bool bVar0;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5D3A
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x64FD
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x6544
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x65AF
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x69C2
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x69D2
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x74DD
{
...
int func_83()//Position - 0x7507
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

Vector3 func_84(struct<3> Param0)//Position - 0x751F
{
...
int func_86(int iParam0)//Position - 0x754B
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x764D
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x76E2
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_93(int iParam0, var uParam1)//Position - 0x8380
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0)//Position - 0x8402
{
	if (iParam0 != func_95())
	{
...
int func_98(int iParam0)//Position - 0x86DF
{
	return MISC::GET_BITS_IN_RANGE(Global_2657971[iParam0 /*465*/].f_322.f_3, 28, 31);
}

int func_99(int iParam0)//Position - 0x86FC
{
...
var func_107(int iParam0)//Position - 0x8C45
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8C67
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8C7E
{
	return uParam0 & 15;
}
...
void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x8DDA
{
...
int func_118(bool bParam0)//Position - 0x8E1C
{
...
int func_123(var* uParam0)//Position - 0xA8AF
{
	int iVar0;
...
void func_127(int iParam0)//Position - 0xAA4D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0)//Position - 0xAB29
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAC22
{
...
int func_135(int iParam0)//Position - 0xAC89
{
	int iVar0;
...
int func_136(int iParam0)//Position - 0xACD2
{
	if (func_137(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xACF2
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_138(int iParam0)//Position - 0xAD13
{
	switch (iParam0)
	{
		case 5:
...
int func_140(int iParam0)//Position - 0xADE3
{
	switch (iParam0)
	{
		case 5:
...
void func_141(var uParam0, bool bParam1, bool bParam2)//Position - 0xAE36
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0xAF2B
{
	switch (iParam0)
	{
		case 5:
...
void func_144(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAFD5
{
	if (bParam0)
	{
...
bool func_146(int iParam0, int iParam1)//Position - 0xB13C
{
	bool bVar0;
...
int func_148(var uParam0)//Position - 0xB1D6
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xB1F8
{
...
int func_151(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB245
{
	int iVar0;
...
int func_154(char* sParam0)//Position - 0xB2C2
{
...
int func_160(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB3F5
{
...
void func_161(int iParam0)//Position - 0xB44C
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_168(int iParam0)//Position - 0xB759
{
	if (iParam0 == 1)
	{
...
int func_170(int iParam0)//Position - 0xB7BF
{
...
int func_171(int iParam0)//Position - 0xB800
{
	int iVar0;
...
int func_173(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB877
{
	int iVar0;
...
void func_174(var uParam0, int iParam1)//Position - 0xB9AE
{
	int iVar0;
...
bool func_175(int iParam0)//Position - 0xB9FD
{
	return func_176(iParam0, Global_44042);
}

int func_176(int iParam0, int iParam1)//Position - 0xBA0E
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_177(int iParam0)//Position - 0xBBEF
{
	if (Global_44042 == 15)
	{
		return 0;
...
int func_179(char* sParam0, int iParam1)//Position - 0xBC22
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_181(var uParam0, int iParam1)//Position - 0xBC8F
{
	switch (uParam0->f_16)
	{
		case 0:
...
int func_183(var uParam0)//Position - 0xC490
{
	float fVar0;
...
void func_184(int iParam0, int iParam1)//Position - 0xC51E
{
	if (iParam0 == 1)
	{
		if (!func_140(iParam1))
...
int func_185(bool bParam0)//Position - 0xC582
{
	int iVar0;
...
int func_186(int iParam0)//Position - 0xC619
{
	if (func_137(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_187(int iParam0)//Position - 0xC643
{
	bool bVar0;
...
var func_188()//Position - 0xCD60
{
	return Global_101572.f_1;
}

int func_189()//Position - 0xCD6E
{
	if (Global_98435 != -1)
	{
...
var func_193(int iParam0, int iParam1)//Position - 0xCDE6
{
	switch (iParam0)
	{
		case 5:
...
var func_194()//Position - 0xCE1E
{
	return Global_1575083;
}

int func_195()//Position - 0xCE2A
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_196(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xCE46
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_199(int iParam0, int iParam1)//Position - 0xCFAC
{
	bool bVar0;
	int iVar1;
...
float func_200(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD04A
{
	struct<3> Var0;
...
void func_202(int iParam0)//Position - 0xD090
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_203(iParam0);
...
void func_203(int iParam0)//Position - 0xD0A7
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_205(var uParam0, bool bParam1)//Position - 0xD1B7
{
	struct<27> Var0;
...
void func_206(int iParam0, var uParam1, int iParam2)//Position - 0xD427
{
	int iVar0;
	int iVar1;
...
int func_207(int iParam0)//Position - 0xD77F
{
...
int func_208(var uParam0)//Position - 0xD79F
{
...
int func_209(var uParam0)//Position - 0xD7B7
{
...
void func_211(int* iParam0)//Position - 0xDAE0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_213(var uParam0, bool bParam1, bool bParam2)//Position - 0xDB8B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_214(int iParam0, int iParam1)//Position - 0xDD49
{
	int iVar0;
...
int func_215(var uParam0, bool bParam1, int iParam2)//Position - 0xDD79
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0)//Position - 0xE035
{
...
int func_217(int iParam0, float fParam1)//Position - 0xE069
{
	float fVar0;
...
bool func_218(int iParam0, float fParam1)//Position - 0xE0DF
{
	return func_219(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE0F7
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_220(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE1B8
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_221(int iParam0, int iParam1)//Position - 0xE2E4
{
	int iVar0;
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE3F3
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_224(struct<3> Param0, struct<3> Param3)//Position - 0xE484
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_225(struct<3> Param0)//Position - 0xE4A5
{
	float fVar0;
	float fVar1;
...
int func_227(int iParam0, int iParam1)//Position - 0xE4FF
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0xE53E
{
...
int func_229(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE566
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_230(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE661
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_231(int iParam0, float fParam1)//Position - 0xE76D
{
	var uVar0;
	struct<3> Var1;
...
int func_232(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE802
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_233(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE890
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_235(int iParam0)//Position - 0xE922
{
	int iVar0;
...
int func_236(int iParam0)//Position - 0xE9BF
{
	if (iParam0 == -1)
	{
		iParam0 = func_178();
...
int func_237(int iParam0)//Position - 0xEA54
{
...
int func_240(int iParam0)//Position - 0xEAD3
{
...
int func_242(int iParam0)//Position - 0xEB45
{
	if (func_118(0))
	{
...
int func_243(int iParam0)//Position - 0xEB6D
{
	if (!func_244(iParam0))
	{
		return 0;
...
int func_244(var uParam0)//Position - 0xEB8C
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
...
int func_245(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xEE24
{
...
int func_246(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xEE80
{
	int iVar0;
...
int func_247(var uParam0, int iParam1)//Position - 0xEF0E
{
	int iVar0;
...
void func_248(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xEF54
{
	func_211(iParam0);
...
int func_249(int iParam0)//Position - 0xEF7B
{
	int iVar0;
...
int func_251(int iParam0)//Position - 0xF0AD
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
...
int func_252(int iParam0)//Position - 0xF0D3
{
	struct<27> Var0;
	bool bVar32;
...
int func_253(int iParam0)//Position - 0xF124
{
	char* sVar0;
...
int func_254(int iParam0)//Position - 0xF1DD
{
	var uVar0;
...
int func_255(int iParam0)//Position - 0xF29E
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_257(int iParam0)//Position - 0xF405
{
...
int func_258(int iParam0)//Position - 0xF430
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_259(int iParam0)//Position - 0xF45B
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_260(int iParam0)//Position - 0xF486
{
	if (func_237(iParam0))
	{
		return 0;
...
int func_262(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF4D5
{
	int iVar0;
...
int func_263(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xF53A
{
	int iVar0;
	struct<7> Var1;
...
int func_264(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xF5B2
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_265(int iParam0, bool bParam1)//Position - 0xF62D
{
	if (bParam1)
	{
...
void func_270(int* iParam0, bool bParam1)//Position - 0xF738
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_273(int* iParam0)//Position - 0xF7C2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_274(int* iParam0)//Position - 0xF7FA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_277(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF8E9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_278(int* iParam0)//Position - 0xF939
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_280(int iParam0, int iParam1)//Position - 0xF9EB
{
	if (func_136(iParam0))
	{
...
void func_281(var uParam0)//Position - 0xFA1E
{
	if (*uParam0 == -1)
	{
		return;
