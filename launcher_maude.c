...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113222[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_281(&(Global_113222[Var0.f_0 /*10*/].f_9));
			}
		}
		func_265(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_204(Var0.f_0);
		func_196(&iLocal_91, &(Var0.f_9), Var61);
		if (func_181(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5D80
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6543
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x658A
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x65F5
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6A17
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A27
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x754D
{
...
Vector3 func_84(struct<3> Param0)//Position - 0x758F
{
...
int func_86(int iParam0)//Position - 0x75BB
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x76BD
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x7752
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_93(int iParam0, var uParam1)//Position - 0x83F3
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0)//Position - 0x8475
{
	if (iParam0 != func_95())
	{
...
int func_99(int iParam0)//Position - 0x878A
{
...
var func_107(int iParam0)//Position - 0x8CE0
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8D02
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8D19
{
	return uParam0 & 15;
}
...
void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x8E7F
{
...
int func_118(bool bParam0)//Position - 0x8EC1
{
...
int func_123(var* uParam0)//Position - 0xA954
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xACC7
{
...
int func_136(int iParam0)//Position - 0xAD77
{
	if (func_137(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xAD97
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_138(int iParam0)//Position - 0xADB8
{
	switch (iParam0)
	{
		case 5:
...
int func_140(int iParam0)//Position - 0xAE88
{
	switch (iParam0)
	{
		case 5:
...
void func_141(var uParam0, bool bParam1, bool bParam2)//Position - 0xAEDB
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0xAFD1
{
	switch (iParam0)
	{
		case 5:
...
void func_144(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB07B
{
	if (bParam0)
	{
...
int func_148(var uParam0)//Position - 0xB27E
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xB2A0
{
...
int func_151(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB2ED
{
	int iVar0;
...
int func_154(char* sParam0)//Position - 0xB36A
{
...
int func_160(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB49D
{
...
void func_161(int iParam0)//Position - 0xB4F4
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_168(int iParam0)//Position - 0xB801
{
	if (iParam0 == 1)
	{
...
int func_170(int iParam0)//Position - 0xB867
{
...
int func_171(int iParam0)//Position - 0xB8A8
{
	int iVar0;
...
int func_173(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB91F
{
	int iVar0;
...
void func_174(var uParam0, int iParam1)//Position - 0xBA56
{
	int iVar0;
...
bool func_175(int iParam0)//Position - 0xBAA5
{
	return func_176(iParam0, Global_44181);
}

int func_176(int iParam0, int iParam1)//Position - 0xBAB6
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_177(int iParam0)//Position - 0xBC97
{
	if (Global_44181 == 15)
	{
		return 0;
...
int func_179(char* sParam0, int iParam1)//Position - 0xBCCA
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_181(var uParam0, int iParam1)//Position - 0xBD37
{
	switch (uParam0->f_16)
	{
		case 0:
...
int func_183(var uParam0)//Position - 0xC538
{
	float fVar0;
...
void func_184(int iParam0, int iParam1)//Position - 0xC5C6
{
	if (iParam0 == 1)
	{
		if (!func_140(iParam1))
...
int func_185(bool bParam0)//Position - 0xC62A
{
	int iVar0;
...
int func_186(int iParam0)//Position - 0xC6C1
{
	if (func_137(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_187(int iParam0)//Position - 0xC6EB
{
	bool bVar0;
...
var func_188()//Position - 0xCE08
{
	return Global_101727.f_1;
}

int func_189()//Position - 0xCE16
{
	if (Global_98585 != -1)
	{
...
var func_193(int iParam0, int iParam1)//Position - 0xCE8E
{
	switch (iParam0)
	{
		case 5:
...
var func_194()//Position - 0xCEC6
{
	return Global_1575084;
}

int func_195()//Position - 0xCED2
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_196(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xCEEE
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_199(int iParam0, int iParam1)//Position - 0xD054
{
	bool bVar0;
	int iVar1;
...
float func_200(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD0F2
{
	struct<3> Var0;
...
void func_202(int iParam0)//Position - 0xD138
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_203(iParam0);
...
void func_203(int iParam0)//Position - 0xD14F
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_205(var uParam0, bool bParam1)//Position - 0xD25F
{
	struct<27> Var0;
...
int func_207(int iParam0)//Position - 0xD827
{
...
int func_208(var uParam0)//Position - 0xD847
{
...
int func_209(var uParam0)//Position - 0xD85F
{
...
void func_211(int* iParam0)//Position - 0xDB88
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_213(var uParam0, bool bParam1, bool bParam2)//Position - 0xDC33
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_214(int iParam0, int iParam1)//Position - 0xDDF1
{
	int iVar0;
...
int func_215(var uParam0, bool bParam1, int iParam2)//Position - 0xDE21
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0)//Position - 0xE0DD
{
...
int func_217(int iParam0, float fParam1)//Position - 0xE111
{
	float fVar0;
...
bool func_218(int iParam0, float fParam1)//Position - 0xE187
{
	return func_219(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE19F
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_220(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE260
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_221(int iParam0, int iParam1)//Position - 0xE38C
{
	int iVar0;
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE49B
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_224(struct<3> Param0, struct<3> Param3)//Position - 0xE52C
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_225(struct<3> Param0)//Position - 0xE54D
{
	float fVar0;
	float fVar1;
...
int func_227(int iParam0, int iParam1)//Position - 0xE5A7
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0xE5E6
{
...
int func_229(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE60E
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_230(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE709
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_231(int iParam0, float fParam1)//Position - 0xE815
{
	var uVar0;
	struct<3> Var1;
...
int func_232(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE8AA
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_233(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE938
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_234(int iParam0)//Position - 0xE980
{
...
void func_235(int iParam0)//Position - 0xE9CA
{
	int iVar0;
...
int func_236(int iParam0)//Position - 0xEA67
{
	if (iParam0 == -1)
	{
		iParam0 = func_178();
...
int func_237(int iParam0)//Position - 0xEAFC
{
...
int func_240(int iParam0)//Position - 0xEB7B
{
...
int func_242(int iParam0)//Position - 0xEBED
{
	if (func_118(0))
	{
...
int func_243(int iParam0)//Position - 0xEC15
{
	if (!func_244(iParam0))
	{
		return 0;
...
int func_244(var uParam0)//Position - 0xEC34
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_249(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_89 = 2;
...
int func_245(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xEECC
{
	if (func_246(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_246(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xEF28
{
	int iVar0;
...
int func_247(var uParam0, int iParam1)//Position - 0xEFB6
{
	int iVar0;
...
void func_248(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xEFFC
{
	func_211(iParam0);
...
int func_249(int iParam0)//Position - 0xF023
{
	int iVar0;
...
int func_251(int iParam0)//Position - 0xF155
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
...
int func_252(int iParam0)//Position - 0xF17B
{
	struct<27> Var0;
	bool bVar32;
...
int func_253(int iParam0)//Position - 0xF1CC
{
	char* sVar0;
...
int func_254(int iParam0)//Position - 0xF285
{
	var uVar0;
...
int func_255(int iParam0)//Position - 0xF346
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_257(int iParam0)//Position - 0xF4AD
{
...
int func_258(int iParam0)//Position - 0xF4D8
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_262(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF57D
{
	int iVar0;
...
int func_263(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xF5E2
{
	int iVar0;
	struct<7> Var1;
...
int func_264(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xF65A
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_265(int iParam0, bool bParam1)//Position - 0xF6D5
{
	if (bParam1)
	{
...
void func_270(int* iParam0, bool bParam1)//Position - 0xF7E0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_273(int* iParam0)//Position - 0xF86A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_274(int* iParam0)//Position - 0xF8A2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_277(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF991
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_278(int* iParam0)//Position - 0xF9E1
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_280(int iParam0, int iParam1)//Position - 0xFA93
{
	if (func_136(iParam0))
	{
...
void func_281(var uParam0)//Position - 0xFAC6
{
	if (*uParam0 == -1)
	{
		return;
