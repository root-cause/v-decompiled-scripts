...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113457[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_280(&(Global_113457[Var0.f_0 /*10*/].f_9));
			}
		}
		func_264(&Var0, 1);
	}
	iVar64[0] = 31;
	if (!func_261(&iVar64, &Var0, Var61, 1f))
	{
		func_260();
	...
	while (true)
	{
		...
		func_203(Var0.f_0);
		func_195(&iLocal_91, &(Var0.f_9), Var61);
		if (func_180(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_50(int iParam0, var uParam1)//Position - 0x3873
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(uParam1));
}

int func_51(var uParam0)//Position - 0x3888
{
	int iVar0;
	int iVar1;
...
int func_53(int iParam0, int iParam1)//Position - 0x38C8
{
	int iVar0;
	var uVar1;
...
int func_54(int iParam0, var uParam1)//Position - 0x38EC
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(uParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3901
{
	int iVar0;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3E4A
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x452C
{
	switch (iParam0)
	{
...
int func_63(int iParam0)//Position - 0x45CD
{
...
int func_64(int iParam0, int iParam1)//Position - 0x47B9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x54DA
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x5515
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x5789
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x57C5
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5D14
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5D58
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x64D7
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x651E
{
...
bool func_73(int iParam0)//Position - 0x6579
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x6589
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x65E9
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x6991
{
	return Global_32828;
}

int func_77(int iParam0)//Position - 0x699C
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x69AC
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6A4E
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x71B9
{
...
int func_81()//Position - 0x74B4
{
	return Global_2652572.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x74C3
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x74ED
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x7502
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x7519
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x7571
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x761B
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x76B0
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x76F4
{
	struct<6> Var0;
...
struct<6> func_91(int iParam0)//Position - 0x7886
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x834F
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x83D1
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x8429
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x8432
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x869E
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x86AE
{
	return MISC::GET_BITS_IN_RANGE(Global_2657921[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x86CB
{
	return func_74(iParam0, 0, 0);
}

int func_99(int iParam0)//Position - 0x86DB
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x8A11
{
	return Global_101444.f_393 > 0;
}

var func_101()//Position - 0x8A22
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8A68
{
	if (iParam1 <= 0)
	{
		return;
...
void func_103(var uParam0, int iParam1)//Position - 0x8AEE
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8B21
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8B72
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8C14
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8C36
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8C4D
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8C5A
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8C94
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8CCF
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8D0B
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8D24
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8D7D
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8D93
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8DA9
{
...
int func_117(bool bParam0)//Position - 0x8DEB
{
...
struct<2> func_118(int iParam0)//Position - 0x8E13
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x9260
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA538
{
	switch (iParam0)
	{
		case 0:
...
int func_122(var* uParam0)//Position - 0xA87E
{
	int iVar0;
...
void func_123(int iParam0)//Position - 0xA923
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xA9BE
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xAA1C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xAA75
{
...
int func_128(int iParam0)//Position - 0xAAF8
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAB29
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAB3E
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xABF1
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAC0C
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xAC58
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xACA1
{
	if (func_136(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xACC1
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_137(int iParam0)//Position - 0xACE2
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xADB2
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xAE05
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xAEFA
{
	switch (iParam0)
	{
		case 5:
...
void func_142(bool bParam0)//Position - 0xAF65
{
	int iVar0;
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAFA4
{
	if (bParam0)
	{
...
bool func_144()//Position - 0xB0F1
{
	return BitTest(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

bool func_145(int iParam0, int iParam1)//Position - 0xB10B
{
	bool bVar0;
...
int func_146(int iParam0, bool bParam1)//Position - 0xB164
{
	int iVar0;
	int iVar1;
...
int func_147(var uParam0)//Position - 0xB1A5
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB1C7
{
...
bool func_149()//Position - 0xB206
{
	return BitTest(Global_2621446, 3);
}

int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB214
{
	int iVar0;
...
void func_152(int iParam0)//Position - 0xB26E
{
	if (iParam0 == 1)
	{
...
int func_153(char* sParam0)//Position - 0xB291
{
...
void func_154()//Position - 0xB2CE
{
	Global_21032 = 0;
	func_155();
}

void func_155()//Position - 0xB2DE
{
...
int func_159(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB3C4
{
...
void func_160(int iParam0)//Position - 0xB41B
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_161(bool bParam0, bool bParam1)//Position - 0xB447
{
...
void func_163(int iParam0)//Position - 0xB5E9
{
	if (func_168())
	{
		return;
...
void func_164(int iParam0)//Position - 0xB61C
{
	if (func_168())
	{
		return;
...
void func_165(bool bParam0, bool bParam1)//Position - 0xB6A6
{
	if (bParam0)
	{
		if (func_167(0))
...
bool func_166()//Position - 0xB71A
{
	return BitTest(Global_1956030, 5);
}

int func_167(int iParam0)//Position - 0xB728
{
	if (iParam0 == 1)
	{
...
bool func_168()//Position - 0xB77F
{
	return BitTest(Global_1956030, 19);
}

int func_169(int iParam0)//Position - 0xB78E
{
...
int func_170(int iParam0)//Position - 0xB7CF
{
	int iVar0;
...
void func_171(int iParam0)//Position - 0xB814
{
...
int func_172(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB846
{
	int iVar0;
...
void func_173(var uParam0, int iParam1)//Position - 0xB97D
{
	int iVar0;
...
bool func_174(int iParam0)//Position - 0xB9CC
{
	return func_175(iParam0, Global_43922);
}

int func_175(int iParam0, int iParam1)//Position - 0xB9DD
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_176(int iParam0)//Position - 0xBBBE
{
	if (Global_43922 == 15)
	{
		return 0;
...
int func_177()//Position - 0xBBE0
{
	return func_178(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_178(char* sParam0, int iParam1)//Position - 0xBBF1
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_180(var uParam0, int iParam1)//Position - 0xBC5E
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_181()//Position - 0xC442
{
	func_27(&(Global_104933.f_2890), &Global_104933, 0, 1, 1, 0);
}

int func_182(var uParam0)//Position - 0xC45D
{
	float fVar0;
...
void func_183(int iParam0, int iParam1)//Position - 0xC4EB
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_184(bool bParam0)//Position - 0xC54F
{
	int iVar0;
...
int func_185(int iParam0)//Position - 0xC5E6
{
	if (func_136(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_186(int iParam0)//Position - 0xC610
{
	bool bVar0;
...
var func_187()//Position - 0xCD2D
{
	return Global_101431.f_1;
}

int func_188()//Position - 0xCD3B
{
	if (Global_98294 != -1)
	{
...
bool func_191()//Position - 0xCDA2
{
	return Global_101444.f_394 > 0;
}

var func_192(int iParam0, int iParam1)//Position - 0xCDB3
{
	switch (iParam0)
	{
		case 5:
...
var func_193()//Position - 0xCDEB
{
	return Global_1575079;
}

int func_194()//Position - 0xCDF7
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_195(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xCE13
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_196(int iParam0, bool bParam1)//Position - 0xCF04
{
	if (iParam0 == -1)
	{
		return;
...
int func_197(int iParam0)//Position - 0xCF40
{
	if (Global_79244 == iParam0)
	{
		if (Global_79245 == -1)
...
void func_198(int iParam0, int iParam1)//Position - 0xCF79
{
	bool bVar0;
	int iVar1;
...
float func_199(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD017
{
	struct<3> Var0;
...
bool func_200()//Position - 0xD051
{
	return Global_98681;
}

void func_201(int iParam0)//Position - 0xD05D
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_202(iParam0);
...
void func_202(int iParam0)//Position - 0xD074
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_203(int iParam0)//Position - 0xD15C
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_204(var uParam0, bool bParam1)//Position - 0xD184
{
	struct<27> Var0;
...
void func_205(int iParam0, var uParam1, int iParam2)//Position - 0xD3F4
{
	int iVar0;
	int iVar1;
...
int func_206(int iParam0)//Position - 0xD74C
{
...
int func_207(var uParam0)//Position - 0xD76C
{
...
int func_208(var uParam0)//Position - 0xD784
{
...
void func_209(var uParam0)//Position - 0xD7A9
{
	int iVar0;
	int iVar1;
...
void func_210(int* iParam0)//Position - 0xDAAD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_211(var uParam0)//Position - 0xDAD8
{
	int iVar0;
...
int func_212(var uParam0, bool bParam1, bool bParam2)//Position - 0xDB58
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_213(int iParam0, int iParam1)//Position - 0xDD16
{
	int iVar0;
...
int func_214(var uParam0, bool bParam1, int iParam2)//Position - 0xDD46
{
	int iVar0;
	int iVar1;
...
int func_215(int iParam0)//Position - 0xE002
{
...
int func_216(int iParam0, float fParam1)//Position - 0xE036
{
	float fVar0;
...
bool func_217(int iParam0, float fParam1)//Position - 0xE0AC
{
	return func_218(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_218(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE0C4
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_219(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE185
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_220(int iParam0, int iParam1)//Position - 0xE2B1
{
	int iVar0;
...
int func_222(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE3C0
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_223(struct<3> Param0, struct<3> Param3)//Position - 0xE451
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_224(struct<3> Param0)//Position - 0xE472
{
	float fVar0;
	float fVar1;
...
void func_225(var uParam0)//Position - 0xE4B1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_226(int iParam0, int iParam1)//Position - 0xE4CC
{
	int iVar0;
...
int func_227(int iParam0)//Position - 0xE50B
{
...
int func_228(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE533
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_229(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE62E
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_230(int iParam0, float fParam1)//Position - 0xE73A
{
	var uVar0;
	struct<3> Var1;
...
int func_231(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE7CF
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_232(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE85D
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_233(int iParam0)//Position - 0xE8A5
{
...
void func_234(int iParam0)//Position - 0xE8EF
{
	int iVar0;
...
int func_235(int iParam0)//Position - 0xE98C
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_236(int iParam0)//Position - 0xEA21
{
...
int func_239(int iParam0)//Position - 0xEAA0
{
...
int func_241(int iParam0)//Position - 0xEB12
{
	if (func_117(0))
	{
...
int func_242(int iParam0)//Position - 0xEB3A
{
	if (!func_243(iParam0))
	{
		return 0;
...
int func_243(var uParam0)//Position - 0xEB59
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_248(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			{
				func_247(&(uParam0->f_41[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				func_247(&(uParam0->f_41[1]), iVar0[2], 2727.686f, 4145.715f, 44.08f, 71f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_244(&(uParam0->f_28[0]), 62, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1))
				{
					bVar5 = false;
				}
			}
		...
		case 3:
			if (func_135(uParam0->f_28[0]) && func_136(uParam0->f_41[0]))
			{
...
int func_244(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xEDF1
{
	if (func_245(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_245(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xEE4D
{
	int iVar0;
...
int func_246(var uParam0, int iParam1)//Position - 0xEEDB
{
	int iVar0;
...
void func_247(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xEF21
{
	func_210(iParam0);
...
int func_248(int iParam0)//Position - 0xEF48
{
	int iVar0;
...
void func_249(int iParam0, bool bParam1, bool bParam2)//Position - 0xEF79
{
	struct<3> Var0;
	struct<3> Var3;
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				iLocal_90 = PED::ADD_SCENARIO_BLOCKING_AREA(Var0, Var3, false, true, true, true, 1);
...
int func_250(int iParam0)//Position - 0xF07A
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
...
int func_251(int iParam0)//Position - 0xF0A0
{
	struct<27> Var0;
	bool bVar32;
...
int func_252(int iParam0)//Position - 0xF0F1
{
	char* sVar0;
...
int func_253(int iParam0)//Position - 0xF1AA
{
	var uVar0;
...
int func_254(int iParam0)//Position - 0xF26B
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_255(int iParam0, char* sParam1)//Position - 0xF2F0
{
...
int func_256(int iParam0)//Position - 0xF3D2
{
...
int func_257(int iParam0)//Position - 0xF3FD
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_258(int iParam0)//Position - 0xF428
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_259(int iParam0)//Position - 0xF453
{
	if (func_236(iParam0))
	{
		return 0;
...
void func_260()//Position - 0xF488
{
	func_281("Running end routines.");
	Global_114088 = (Global_114088 - 1);
}

int func_261(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF4A2
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_262((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_262((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_262(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xF507
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_263(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_263(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xF57F
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_264(int iParam0, bool bParam1)//Position - 0xF5FA
{
	if (bParam1)
	{
...
int func_265(var uParam0)//Position - 0xF65F
{
	if (func_208(uParam0))
	{
...
void func_266(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xF695
{
...
void func_267(var uParam0, bool bParam1)//Position - 0xF6B5
{
	func_268(&(uParam0->f_41), bParam1);
}

void func_268(var uParam0, bool bParam1)//Position - 0xF6C7
{
	int iVar0;
...
void func_269(int* iParam0, bool bParam1)//Position - 0xF705
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_270(var uParam0, bool bParam1)//Position - 0xF740
{
	func_271(&(uParam0->f_35), bParam1);
}

void func_271(var uParam0, bool bParam1)//Position - 0xF752
{
	int iVar0;
...
void func_272(int* iParam0)//Position - 0xF78F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_273(int* iParam0)//Position - 0xF7C7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_274(var uParam0, int iParam1)//Position - 0xF863
{
	func_275(&(uParam0->f_28), iParam1);
}

void func_275(var uParam0, int iParam1)//Position - 0xF875
{
	int iVar0;
...
void func_276(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF8B6
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_277(int* iParam0)//Position - 0xF906
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_278(var uParam0)//Position - 0xF947
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		if (func_135(uParam0->f_28[0]))
		{
			if (func_279(uParam0->f_28[0], joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE")))
			{
...
int func_279(int iParam0, int iParam1)//Position - 0xF9B8
{
	if (func_135(iParam0))
	{
...
void func_280(var uParam0)//Position - 0xF9EB
{
	if (*uParam0 == -1)
	{
		return;
...
void func_281(char* sParam0)//Position - 0xFA28
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_282(var uParam0)//Position - 0xFA3A
{
	*uParam0 = -1;
