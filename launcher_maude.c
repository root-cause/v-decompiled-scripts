...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		func_197(Var0.f_0);
		func_189(&iLocal_53, &(Var0.f_9), Var1);
		if (func_174(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5C33
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x63F6
{
	if (bParam2)
	{
...
int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x68BD
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_84(struct<3> Param0, float fParam1)//Position - 0x757A
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
float func_193(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xCEA4
{
	struct<3> Var0;
...
int func_213(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE012
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
float func_217(struct<3> Param0, struct<3> Param1)//Position - 0xE2DE
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_225(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xE65C
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_238(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xEC7E
{
	if (func_239(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_239(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xECDA
{
	int iVar0;
...
void func_241(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xEDAE
{
	func_204(iParam0);
...
int func_255(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xF32E
{
	int iVar0;
...
int func_256(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xF393
{
	int iVar0;
	struct<7> Var1;
...
int func_257(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0xF40B
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
