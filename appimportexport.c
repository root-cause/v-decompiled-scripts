#region Local Var
	...
	var uLocal_552 = 0;
	var uLocal_553 = 0;
	int iLocal_554[4] = { 0, 0, 0, 0 };
	int iLocal_555[4] = { 0, 0, 0, 0 };
...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_559 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("IMPORT_EXPORT_WAREHOUSE");
	func_408(1);
	func_406(1);
	func_405();
	HUD::THEFEED_PAUSE();
	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_559))
	{
		SYSTEM::WAIT(0);
	}
	Global_77117 = 1;
	...
	{
		uLocal_553 = func_402(PLAYER::PLAYER_ID());
	}
	Global_1946220 = 0;
	...
	if (func_379())
	{
		MISC::SET_BIT(&uLocal_552, 1);
	}
	if (func_378())
	{
		MISC::SET_BIT(&uLocal_552, 3);
	}
	func_375();
	...
	while (Global_77117)
	{
		...
		switch (iLocal_576)
		{
			case 0:
				func_361();
				if (!BitTest(uLocal_552, 3))
				{
					func_358();
					func_335();
				}
				if (!BitTest(uLocal_552, 1))
				{
					func_327();
				}
				if (!iLocal_548)
			...
			case 1:
				func_260();
				if (!func_259(&uLocal_742))
				{
					func_258(&uLocal_742, 0, 0);
				}
				else if (func_257(&uLocal_742, 301000, 0))
				{
					Global_1946220 = 0;
					func_411(0, 1);
				}
...
int func_1(int iParam0)//Position - 0x344
{
	if (iParam0 != func_3())
	{
		...
		else if ((Global_1575058 && iParam0 == PLAYER::PLAYER_ID()) && func_2(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
void func_4()//Position - 0x413
{
	...
	while (iVar0 < 4)
	{
		if (bVar2)
		{
			uVar1[iVar0] = iLocal_555[iVar0];
		}
		else
		{
			uVar1[iVar0] = iLocal_554[iVar0];
		}
		iVar0++;
	}
	if (iLocal_557 == 0 || func_254())
	{
		func_77(PLAYER::PLAYER_ID(), 1);
	}
	if (func_68(iLocal_557, func_76(bVar2), bVar2))
	{
...
void func_12(var uParam0)//Position - 0x659
{
	...
	while (iVar0 < *uParam0)
	{
		...
		if (iVar1 != 0)
		{
			...
			func_25(iVar1);
			func_17(iVar1);
			iVar2 = (Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_267.f_142.f_1 - 1);
			if (iVar2 >= 0)
			{
				func_16(iVar2);
			}
...
void func_16(int iParam0)//Position - 0x7B3
{
	...
	{
		Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_267.f_142.f_1 = iParam0;
	}
}
...
void func_31(int iParam0)//Position - 0x1025
{
	...
	if (iParam0 != -1)
	{
		...
		func_32(&(Global_4534105[iParam0 /*85*/]));
	}
}
...
int func_37()//Position - 0x125A
{
	...
	if (!bVar0)
	{
		...
		{
			if (func_41(Global_4534105[iVar2 /*85*/].f_66.f_6, Global_4534105[iVar2 /*85*/].f_66.f_4, Global_4534105[iVar2 /*85*/].f_66.f_1) == 1)
			{
				Global_4535607 = 1;
			}
			return 0;
	...
	if (iVar3 != 2147483647)
	{
		if ((bVar0 || iVar1) || NETSHOPPING::NET_GAMESERVER_CHECKOUT_START(iVar3))
		{
			...
			if (bVar0 || iVar1)
			{
				func_38(Global_4534105[iVar2 /*85*/], iVar2);
			}
			Global_4535592 = 1;
			return 1;
		}
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x1A5B
{
	bool bVar0;
	int iVar1;
	struct<4> Var2;
...
int func_43(int iParam0)//Position - 0x1B7D
{
	switch (iParam0)
	{
...
int func_44(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5)//Position - 0x1C0C
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
int func_45(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, bool bParam10)//Position - 0x1D09
{
	int iVar0;
	...
	while (iVar0 < 15)
	{
		if (Global_4534105[iVar0 /*85*/].f_66.f_2 == 0)
		{
			...
			{
				func_38(Global_4534105[iVar0 /*85*/], iVar0);
			}
			return iVar0;
		}
		iVar0++;
...
int func_46(int iParam0)//Position - 0x1E46
{
	char cVar0[64];
...
int func_48(int iParam0)//Position - 0x1E8C
{
	int iVar0;
...
void func_49(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5)//Position - 0x1EEC
{
...
void func_50(int iParam0, int iParam1)//Position - 0x1F28
{
...
void func_51(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x1F90
{
	struct<7> Var0;
...
var func_52()//Position - 0x1FDA
{
	return Global_2815059.f_5195.f_346;
}

var func_53()//Position - 0x1FEC
{
	return Global_2815059.f_5195.f_345;
}

var func_54()//Position - 0x1FFE
{
	return Global_2815059.f_5195.f_344;
}

int func_55(int iParam0, bool bParam1)//Position - 0x2010
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool func_56(int iParam0, int iParam1)//Position - 0x2075
{
	bool bVar0;
...
int func_57(int iParam0, bool bParam1)//Position - 0x20C0
{
	int iVar0;
	int iVar1;
...
void func_58(int iParam0)//Position - 0x2101
{
	Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_32 = iParam0;
}

int func_59(int iParam0, int iParam1)//Position - 0x211A
{
	if (func_60(iParam0, 0))
	{
		return func_61(Global_1892703[iParam0 /*599*/].f_10.f_33) == iParam1;
	}
	return 0;
}

int func_60(int iParam0, int iParam1)//Position - 0x2144
{
...
int func_61(int iParam0)//Position - 0x217F
{
	switch (iParam0)
	{
		case 153:
...
bool func_62(bool bParam0)//Position - 0x23C1
{
	return func_63(PLAYER::PLAYER_ID(), bParam0);
}

bool func_63(int iParam0, bool bParam1)//Position - 0x23D3
{
	if (!bParam1)
	{
		if (func_64(iParam0))
...
int func_64(int iParam0)//Position - 0x23FE
{
	if (iParam0 != func_3())
	{
...
bool func_65()//Position - 0x2433
{
	return func_64(PLAYER::PLAYER_ID());
}

void func_66(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x2443
{
...
void func_67(int iParam0)//Position - 0x24AE
{
...
int func_68(int iParam0, int iParam1, bool bParam2)//Position - 0x24D1
{
	int iVar0;
	int iVar1[13];
	bool bVar2;
	...
	else if (iParam0 == 4)
	{
		...
		if (iVar5 != 0)
		{
			...
			while (iVar0 < 4)
			{
				Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_332[iVar0] = func_74(iVar5);
				iVar0++;
			}
			bVar3 = true;
		}
	...
	if (iParam0 != 4)
	{
		...
		else if (iVar4 >= iParam1)
		{
			...
			while (iVar0 < iParam1)
			{
				Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_332[iVar0] = func_69(&iVar1, iVar4, &uVar8);
				iVar0++;
			}
			bVar3 = true;
		}
...
int func_69(int iParam0, int iParam1, var uParam2)//Position - 0x2744
{
	float fVar0;
	float fVar1;
	var uVar2[13];
	...
	if (func_20(iVar4))
	{
		Var6 = { Global_1946250.f_533[func_72(func_21(iVar4)) /*3*/] };
		Var6.f_2 = 0f;
	}
	else
	{
...
void func_70(int iParam0, int iParam1, bool bParam2)//Position - 0x2950
{
	*iParam1 = SYSTEM::FLOOR((SYSTEM::TO_FLOAT(iParam0) / 32f));
	*bParam2 = (iParam0 - *iParam1 * 32);
}

Vector3 func_71(int iParam0)//Position - 0x2976
{
	switch (iParam0)
	{
		case 19:
...
int func_72(int iParam0)//Position - 0x2E20
{
	switch (iParam0)
	{
		case 1:
...
int func_74(int iParam0)//Position - 0x2EDF
{
	switch (iParam0)
	{
		case 1:
...
int func_75()//Position - 0x2F5D
{
	return Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10;
}

int func_76(bool bParam0)//Position - 0x2F72
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 4)
	{
		if (!bParam0)
		{
			if (iLocal_554[iVar0] != 0)
			{
				iVar1++;
			}
		}
		else if (iLocal_555[iVar0] != 0)
		{
			iVar1++;
		}
		iVar0++;
...
void func_77(int iParam0, bool bParam1)//Position - 0x2FB9
{
	if (bParam1)
	{
		if (iParam0 != func_3())
		{
			if (!BitTest(Global_2689235[iParam0 /*453*/].f_197, 19))
			{
				MISC::SET_BIT(&(Global_2689235[iParam0 /*453*/].f_197), 19);
			}
		}
	}
	else if (iParam0 != func_3())
	{
		if (BitTest(Global_2689235[iParam0 /*453*/].f_197, 19))
		{
			MISC::CLEAR_BIT(&(Global_2689235[iParam0 /*453*/].f_197), 19);
		}
	}
}

int func_78(bool bParam0, bool bParam1)//Position - 0x3020
{
	int iVar0;
	int iVar1;
	...
	{
		iLocal_550 = func_87(PLAYER::PLAYER_ID(), 188, 0);
		if (iLocal_550 == 16)
		{
			iLocal_550 = 19;
		}
		else if (iLocal_550 == 15)
		{
			iLocal_550 = 20;
		}
		return 0;
...
int func_79(int iParam0)//Position - 0x317A
{
...
int func_80()//Position - 0x31AB
{
	if (Global_1946221 && func_81())
	{
		return 1;
	}
	return 0;
...
var func_81()//Position - 0x31C8
{
	return Global_2726699;
}

int func_82()//Position - 0x31D4
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 7)
	{
		if (Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_11[iVar0] != func_3())
		{
			if ((func_404(Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_11[iVar0]) && func_2(Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_11[iVar0], 1, 1)) && !func_79(Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_11[iVar0]))
			{
				iVar1++;
			}
		}
...
int func_83(int iParam0)//Position - 0x3276
{
	int iVar0;
...
bool func_84(int iParam0, int iParam1)//Position - 0x3294
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

bool func_85(int iParam0)//Position - 0x32AC
{
	return func_86(iParam0, 1);
}

int func_86(int iParam0, int iParam1)//Position - 0x32BB
{
	if (iParam0 != func_3())
	{
		if (Global_1892703[iParam0 /*599*/].f_10 != func_3())
...
int func_87(int iParam0, int iParam1, bool bParam2)//Position - 0x330A
{
	int iVar0;
	int iVar1;
	...
	else if (func_61(iParam1) == 2)
	{
		...
		if (!bParam2)
		{
			if (Global_1892703[iParam0 /*599*/].f_10.f_34 != func_3())
			{
				return 9;
			}
		}
...
var func_88(int iParam0, int iParam1)//Position - 0x34F9
{
	return BitTest(Global_2689235[iParam0 /*453*/].f_216, iParam1);
}

int func_89(int iParam0, int iParam1)//Position - 0x350F
{
	int iVar0;
	int iVar1;
...
int func_90(int iParam0, int iParam1, bool bParam2)//Position - 0x3561
{
	if (iParam1 != func_3())
	{
		if (!bParam2)
...
int func_91(int iParam0, int iParam1)//Position - 0x35AB
{
	if (iParam1 != func_3())
	{
		if (iParam0 != func_3())
...
int func_92(int iParam0)//Position - 0x35F0
{
	switch (iParam0)
	{
		case 180:
...
bool func_95()//Position - 0x3745
{
	return Global_1575016 == 10;
}

bool func_96()//Position - 0x3754
{
	return Global_262145.f_15734 /* Tunable: EXEC_CONTRABAND_DISABLE */;
}

int func_97(int iParam0)//Position - 0x3763
{
	switch (iParam0)
	{
		case 167:
...
int func_98(int iParam0)//Position - 0x3789
{
...
int func_99(int iParam0)//Position - 0x37AF
{
	switch (iParam0)
	{
		case 155:
...
int func_100(int iParam0, int iParam1)//Position - 0x3809
{
	switch (iParam0)
	{
		case 199:
...
int func_101(int iParam0)//Position - 0x385E
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar1))
		{
			if ((Global_1892703[iParam0 /*599*/].f_10.f_34 != func_3() && Global_1892703[iParam0 /*599*/].f_10.f_34 == iVar1) && Global_1892703[iVar1 /*599*/].f_10.f_34 == iParam0)
			{
				return 1;
			}
		}
...
int func_102(int iParam0)//Position - 0x38CE
{
	switch (iParam0)
	{
		case 179:
...
int func_105()//Position - 0x3991
{
	return Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_103;
}

bool func_106()//Position - 0x39A8
{
	return Global_1920255.f_11.f_144 != -1;
}

bool func_107()//Position - 0x39BA
{
	return Global_1920255.f_11.f_143 != -1;
}

int func_108(int iParam0)//Position - 0x39CC
{
	int iVar0;
	int iVar1;
...
int func_109(int iParam0)//Position - 0x3A38
{
	if (iParam0 == func_3())
	{
		return 0;
...
int func_110()//Position - 0x3AD6
{
	return (func_111() - 1);
}

int func_111()//Position - 0x3AE4
{
	return func_112(PLAYER::PLAYER_ID());
}

int func_112(int iParam0)//Position - 0x3AF4
{
	int iVar0;
	
	iVar0 = Global_1892703[iParam0 /*599*/].f_10;
	if (iVar0 != func_3() && Global_1892703[iVar0 /*599*/].f_10.f_428 == 1)
	{
		return 8;
	}
	return 4;
...
int func_113(int iParam0)//Position - 0x3B2E
{
	if (iParam0 != func_3())
	{
		if (func_2(iParam0, 1, 1))
		{
			...
			{
				return func_114(Global_2689235[iParam0 /*453*/].f_318.f_6) == 23;
			}
		}
	}
	return 0;
...
int func_114(int iParam0)//Position - 0x3B75
{
	switch (iParam0)
	{
		case 0:
...
int func_115(int iParam0)//Position - 0x3FFC
{
	if (iParam0 != func_3())
	{
...
int func_116(int iParam0)//Position - 0x4025
{
	int iVar0;
	int iVar1;
...
int func_117(int iParam0)//Position - 0x4091
{
	int iVar0;
...
int func_118(int iParam0)//Position - 0x40B4
{
	switch (iParam0)
	{
		case 162:
...
int func_119(int iParam0)//Position - 0x4206
{
	return Global_1920255.f_11.f_147[func_120(iParam0)];
}

int func_120(int iParam0)//Position - 0x421E
{
	switch (iParam0)
	{
		case 148:
...
int func_121(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x461A
{
...
int func_122(int iParam0, bool bParam1, bool bParam2)//Position - 0x4654
{
	return func_123(2, iParam0, 0, bParam1, bParam2);
}

int func_123(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x4668
{
	int iVar0;
	int iVar1;
...
int func_124(int iParam0)//Position - 0x472E
{
	switch (iParam0)
	{
		case 0:
...
int func_125(int iParam0)//Position - 0x4768
{
	switch (iParam0)
	{
		case 0:
...
int func_126(int iParam0, bool bParam1)//Position - 0x47AE
{
	int iVar0;
...
int func_127(int iParam0)//Position - 0x484B
{
	switch (iParam0)
	{
		case 0:
...
int func_128(int iParam0, bool bParam1, bool bParam2)//Position - 0x488B
{
	return func_123(1, iParam0, 0, bParam1, bParam2);
}

int func_129(int iParam0, bool bParam1, bool bParam2)//Position - 0x489F
{
	return func_123(0, iParam0, 0, bParam1, bParam2);
}

int func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x48B3
{
	switch (iParam0)
	{
		case 148:
...
int func_131(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4B86
{
	int iVar0;
...
int func_132(int iParam0, var uParam1)//Position - 0x4BA9
{
	switch (iParam0)
	{
		case 2:
...
int func_133(int iParam0, var uParam1, var uParam2)//Position - 0x4BC3
{
	switch (iParam0)
	{
		case 0:
...
int func_134(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4BDD
{
	int iVar0;
...
int func_135(int iParam0, int iParam1)//Position - 0x4C00
{
	struct<3> Var0;
...
Vector3 func_136(int iParam0)//Position - 0x4D67
{
	return Global_1892703[iParam0 /*599*/].f_10.f_305;
}

int func_137(int iParam0, int iParam1, var uParam2)//Position - 0x4D7F
{
	switch (iParam0)
	{
		case 0:
...
int func_138(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4FE2
{
	int iVar0;
...
int func_139(int iParam0, int iParam1)//Position - 0x500F
{
	switch (iParam0)
	{
		case 14:
...
int func_140(int iParam0)//Position - 0x5061
{
	return 0;
}

int func_141(int iParam0, int iParam1, int iParam2)//Position - 0x506A
{
	switch (iParam0)
	{
		case 13:
...
int func_142(int iParam0)//Position - 0x5219
{
	switch (iParam0)
	{
		case 0:
...
int func_143(int iParam0, int iParam1, int iParam2)//Position - 0x5265
{
	int iVar0;
...
int func_144(int iParam0)//Position - 0x5289
{
	return 1;
}

int func_145(int iParam0, int iParam1)//Position - 0x5292
{
	switch (iParam0)
	{
		case 12:
...
int func_146(int iParam0, int iParam1)//Position - 0x53E1
{
	int iVar0;
...
int func_147(int iParam0, int iParam1)//Position - 0x5475
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_148(int iParam0)//Position - 0x550E
{
	switch (iParam0)
	{
		case 5:
...
int func_149(int iParam0, int iParam1)//Position - 0x553E
{
	if (func_152(iParam0))
	{
...
int func_150(int iParam0)//Position - 0x558C
{
	switch (iParam0)
	{
		case 15:
...
int func_152(int iParam0)//Position - 0x55DD
{
	switch (iParam0)
	{
		case 14:
...
int func_153(int iParam0, int iParam1)//Position - 0x5633
{
	switch (iParam0)
	{
		case 32:
...
int func_154(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x58C5
{
	int iVar0;
...
int func_155(int iParam0)//Position - 0x5918
{
	switch (iParam0)
	{
		case 2:
...
int func_156(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4)//Position - 0x593E
{
	int iVar0;
...
int func_157(int iParam0)//Position - 0x59DA
{
	return 1;
}

int func_158(int iParam0)//Position - 0x59E3
{
	return 4;
}

int func_159(int iParam0)//Position - 0x59EC
{
	switch (iParam0)
	{
		case 3:
...
int func_160(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x5A2A
{
	int iVar0;
...
int func_161(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x5AE5
{
	int iVar0;
...
int func_162(int iParam0)//Position - 0x5B38
{
	switch (iParam0)
	{
		case 23:
...
int func_163(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x5B52
{
	int iVar0;
	int iVar1;
...
int func_164(int iParam0)//Position - 0x5CD0
{
	switch (iParam0)
	{
		case 15:
...
int func_165(int iParam0)//Position - 0x5CEA
{
	if (!func_170(iParam0))
	{
		if (func_171(iParam0))
...
int func_166(int iParam0)//Position - 0x5D44
{
	switch (iParam0)
	{
		case 12:
...
int func_167(int iParam0)//Position - 0x5D5E
{
	if (iParam0 == func_3() || Global_1853348[iParam0 /*834*/].f_267.f_278 == 0)
	{
		return 50;
	}
...
int func_168(int iParam0)//Position - 0x5DA0
{
	switch (iParam0)
	{
		case 26:
...
int func_169(int iParam0)//Position - 0x5DBA
{
	if (iParam0 > 25)
	{
		return 3;
...
int func_170(int iParam0)//Position - 0x5DDC
{
	switch (iParam0)
	{
		case 15:
...
int func_171(int iParam0)//Position - 0x5E32
{
...
int func_172(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x5E54
{
	switch (iParam0)
	{
		case 1:
...
int func_173(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5F86
{
	int iVar0;
...
int func_174(int iParam0)//Position - 0x5FCC
{
	switch (iParam0)
	{
		case 0:
...
int func_175(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6010
{
	int iVar0;
...
int func_176(int iParam0)//Position - 0x60ED
{
	switch (iParam0)
	{
		case 14:
...
int func_177(int iParam0)//Position - 0x6125
{
	switch (iParam0)
	{
		case 0:
...
int func_178(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6187
{
	switch (iParam0)
	{
		case 0:
...
int func_179(int iParam0, int iParam1, var uParam2)//Position - 0x64D3
{
	int iVar0;
...
int func_180(int iParam0, int iParam1)//Position - 0x64F4
{
	switch (iParam0)
	{
		case 6:
...
int func_181(int iParam0)//Position - 0x66B4
{
	switch (iParam0)
	{
		case 0:
...
int func_182(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x678C
{
	switch (iParam0)
	{
		case 148:
...
int func_183(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x6A7B
{
	int iVar0;
...
int func_184(int iParam0, int iParam1)//Position - 0x6AF1
{
	switch (iParam0)
	{
		case 2:
...
bool func_185(int iParam0, int iParam1)//Position - 0x6B0B
{
	return func_184(iParam0, iParam1) > 0;
}

int func_186(var uParam0, int iParam1, int iParam2)//Position - 0x6B1D
{
	switch (iParam1)
	{
		case 2:
...
int func_187(int iParam0, int iParam1)//Position - 0x6B37
{
	switch (iParam1)
	{
		case 0:
...
int func_188(int iParam0, int iParam1)//Position - 0x6B6B
{
	switch (iParam0)
	{
		case 2:
...
int func_189(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x6B85
{
	int iVar0;
...
int func_190(int iParam0, int iParam1)//Position - 0x6F10
{
	switch (iParam0)
	{
		case 0:
...
bool func_191(int iParam0, int iParam1)//Position - 0x6F96
{
	return func_190(iParam0, iParam1) > 0;
}

int func_192(int iParam0, int iParam1, int iParam2)//Position - 0x6FA8
{
	struct<3> Var0;
...
int func_193(int iParam0, int iParam1)//Position - 0x7040
{
	switch (iParam1)
	{
		case 96:
...
int func_194(int iParam0, int iParam1)//Position - 0x731F
{
	switch (iParam0)
	{
		case 53:
...
int func_195(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x7339
{
	int iVar0;
...
int func_196(int iParam0, int iParam1)//Position - 0x7614
{
	switch (iParam0)
	{
		case 4:
...
bool func_197(int iParam0, int iParam1)//Position - 0x764B
{
	return func_196(iParam0, iParam1) > 0;
}

int func_198(int iParam0, int iParam1)//Position - 0x765D
{
	switch (iParam1)
	{
		case 6:
...
int func_199(int iParam0, int iParam1)//Position - 0x7687
{
	switch (iParam1)
	{
		case 46:
...
int func_200(int iParam0, int iParam1)//Position - 0x77B9
{
	switch (iParam0)
	{
		case 16:
...
int func_201(int iParam0)//Position - 0x77D3
{
	switch (iParam0)
	{
		case 0:
...
int func_202(int iParam0, int iParam1, int iParam2)//Position - 0x781F
{
	int iVar0;
...
int func_203(int iParam0, int iParam1)//Position - 0x79C0
{
	int iVar0;
...
int func_204(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x7FA7
{
	int iVar0;
...
int func_205(int iParam0)//Position - 0x816F
{
	switch (iParam0)
	{
		case 0:
...
bool func_206(int iParam0)//Position - 0x81B3
{
	return func_205(iParam0) > 0;
}

int func_207(var uParam0, int iParam1)//Position - 0x81C3
{
	return 2;
}

int func_208(int iParam0, int iParam1)//Position - 0x81CC
{
	switch (iParam1)
	{
		case 136:
...
int func_209(int iParam0, int iParam1)//Position - 0x8214
{
	var uVar0;
...
int func_210(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x8274
{
	int iVar0;
...
int func_211(int iParam0)//Position - 0x853A
{
	switch (iParam0)
	{
		case 12:
...
bool func_212(int iParam0)//Position - 0x85AC
{
	return func_211(iParam0) > 0;
}

int func_213(int iParam0, int iParam1)//Position - 0x85BC
{
	switch (iParam0)
	{
		case 1:
...
int func_214(int iParam0, int iParam1)//Position - 0x86B4
{
	switch (iParam1)
	{
		case 0:
...
int func_215(int iParam0, int iParam1)//Position - 0x8A54
{
	switch (iParam0)
	{
		case 1:
...
int func_216(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x8B4D
{
	int iVar0;
...
int func_217(int iParam0)//Position - 0x8ED0
{
	switch (iParam0)
	{
		case 1:
...
bool func_218(int iParam0)//Position - 0x8F44
{
	return func_217(iParam0) > 0;
}

int func_219(int iParam0, int iParam1)//Position - 0x8F54
{
	switch (iParam0)
	{
		case 2:
...
int func_220(int iParam0, int iParam1, int iParam2)//Position - 0x8FA0
{
	int iVar0;
...
int func_221(int iParam0)//Position - 0x92A9
{
	if (func_222(iParam0))
	{
		return 2;
...
int func_222(int iParam0)//Position - 0x92BF
{
	switch (iParam0)
	{
		case 7:
...
int func_223(int iParam0, var uParam1, int iParam2)//Position - 0x9309
{
	int iVar0;
...
int func_224(int iParam0)//Position - 0x9333
{
	switch (iParam0)
	{
		case 0:
...
int func_225(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x940C
{
	switch (iParam0)
	{
		case 148:
...
int func_226(int iParam0, int iParam1, bool bParam2, int iParam3)//Position - 0x96D4
{
	int iVar0;
...
int func_227(int iParam0, var uParam1)//Position - 0x9712
{
...
int func_228(int iParam0, var uParam1)//Position - 0x973A
{
	switch (iParam0)
	{
		case 2:
...
int func_229(int iParam0, int iParam1, bool bParam2, int iParam3)//Position - 0x9754
{
	int iVar0;
...
int func_230(int iParam0, int iParam1)//Position - 0x9AE2
{
	if (func_191(iParam0, iParam1))
	{
...
int func_231(int iParam0, int iParam1)//Position - 0x9B0A
{
	switch (iParam0)
	{
		case 0:
...
int func_232(int iParam0, int iParam1, bool bParam2, int iParam3)//Position - 0x9B98
{
	int iVar0;
...
int func_233(int iParam0, int iParam1)//Position - 0x9DBB
{
	if (func_197(iParam0, iParam1))
	{
...
int func_234(int iParam0, int iParam1)//Position - 0x9DE3
{
	switch (iParam0)
	{
		case 4:
...
int func_235(int iParam0, int iParam1)//Position - 0x9E1A
{
	switch (iParam0)
	{
		case 0:
...
int func_236(int iParam0, int iParam1, int iParam2)//Position - 0x9E8B
{
	int iVar0;
...
int func_239(int iParam0, int iParam1)//Position - 0xA060
{
	int iVar0;
...
int func_240(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0xA63D
{
	int iVar0;
...
int func_241(int iParam0, var uParam1)//Position - 0xA73C
{
	if (func_206(iParam0))
	{
...
int func_242(int iParam0, var uParam1)//Position - 0xA760
{
	switch (iParam0)
	{
		case 0:
...
int func_243(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0xA7A6
{
	int iVar0;
...
int func_244(int iParam0, int iParam1)//Position - 0xA920
{
	if (func_212(iParam0))
	{
...
int func_245(int iParam0, int iParam1)//Position - 0xA944
{
	switch (iParam0)
	{
		case 11:
...
int func_246(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0xA9BE
{
	int iVar0;
...
int func_247(int iParam0)//Position - 0xACF3
{
	if (func_218(iParam0))
	{
...
int func_248(int iParam0)//Position - 0xAD15
{
	switch (iParam0)
	{
		case 1:
...
int func_249(int iParam0, int iParam1, var uParam2)//Position - 0xAD91
{
	int iVar0;
...
int func_250(int iParam0)//Position - 0xB059
{
	if (func_222(iParam0))
	{
		if (func_251(iParam0))
...
int func_251(int iParam0)//Position - 0xB07C
{
	switch (iParam0)
	{
		case 7:
...
int func_252(int iParam0)//Position - 0xB0C6
{
	switch (iParam0)
	{
		case 0:
...
bool func_253(int iParam0, int iParam1, bool bParam2)//Position - 0xB1A8
{
	return func_87(iParam0, iParam1, bParam2) == -1;
}

bool func_254()//Position - 0xB1BC
{
	return Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_331 != 2000;
}

void func_255(var uParam0)//Position - 0xB1D8
{
	uParam0->f_1 = 0;
}

int func_256(int iParam0)//Position - 0xB1E5
{
	if (iParam0 == func_3())
	{
		return 0;
...
int func_257(var uParam0, int iParam1, bool bParam2)//Position - 0xB208
{
	if (iParam1 == -1)
	{
		return 1;
...
void func_258(var uParam0, bool bParam1, bool bParam2)//Position - 0xB266
{
	if (uParam0->f_1 == 0)
	{
...
bool func_259(var uParam0)//Position - 0xB2AB
{
	return uParam0->f_1;
}

void func_260()//Position - 0xB2B7
{
	if (!Global_1574747)
	{
		return;
...
int func_262(int iParam0)//Position - 0xB2ED
{
	if (iParam0 == func_3())
	{
		return 0;
	}
	return BitTest(Global_2689235[iParam0 /*453*/].f_197, 18);
}

void func_263()//Position - 0xB310
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (iLocal_562 == 2000000)
	{
		...
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_559, "GET_CURRENT_SELECTION");
			iLocal_560 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_559, "GET_CURRENT_TAB_ID");
			iLocal_561 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
			iLocal_562 = 1000000;
		}
	}
	if (iLocal_562 == 1000000 && (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_560) && GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_561)))
	{
		iLocal_551 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_561);
		iVar0 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_560);
		bVar1 = true;
		bVar2 = true;
		iLocal_562 = iVar0;
		if (func_321(iVar0))
		...
		else if (func_312(iVar0))
		{
			...
			{
				func_308(1, 0);
				GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(iLocal_558), -1f, -1f, -1f, -1f);
				iLocal_558 = iVar3;
				func_304(iVar3);
			}
			else
		...
		if (bVar1)
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(iVar0), -1f, -1f, -1f, -1f);
		}
		if (bVar2)
		{
			func_303(iLocal_551);
...
void func_264(int iParam0)//Position - 0xB629
{
	bool bVar0;
	struct<4> Var1;
	int iVar2;
		...
		if (*iParam0 == 101)
		{
			if (iLocal_549)
			{
				...
				else
				{
					Var1 = { func_286(bVar0) };
					func_288();
					GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(202), -1f, -1f, -1f, -1f);
					if (iLocal_550 == 17 && !bVar0)
					{
...
int func_265(int iParam0, bool bParam1)//Position - 0xBA12
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_266(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xBA57
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_267(int iParam0, bool bParam1)//Position - 0xBB07
{
	int iVar0;
	int iVar1;
	
	iVar0 = SYSTEM::CEIL((IntToFloat(func_272(iParam0)) * Global_262145.f_19464 /* Tunable: IMPEXP_SELL_BUYER3_OFFER_MODIFIER */));
	iVar1 = 0;
	if (!bParam1)
	{
...
int func_268(int iParam0)//Position - 0xBB3E
{
	return SYSTEM::CEIL((IntToFloat(iParam0) * Global_262145.f_19462));
}

int func_269(int iParam0)//Position - 0xBB55
{
	switch (iParam0)
	{
		case 19:
...
int func_270(int iParam0, bool bParam1)//Position - 0xBB99
{
	int iVar0;
	int iVar1;
	
	iVar0 = SYSTEM::CEIL((IntToFloat(func_272(iParam0)) * Global_262145.f_19463 /* Tunable: IMPEXP_SELL_BUYER2_OFFER_MODIFIER */));
	iVar1 = 0;
	if (!bParam1)
	{
...
int func_271(int iParam0)//Position - 0xBBD0
{
	return SYSTEM::CEIL((IntToFloat(iParam0) * Global_262145.f_19461));
}

int func_272(int iParam0)//Position - 0xBBE7
{
	switch (iParam0)
	{
		case 3:
...
int func_273(int iParam0)//Position - 0xBC27
{
	switch (iParam0)
	{
		case 11:
...
int func_274(int iParam0)//Position - 0xBC6B
{
	switch (iParam0)
	{
...
int func_275(var uParam0, int iParam1, bool bParam2, int iParam3)//Position - 0xBD47
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	if (bVar0 || iParam3 == 1)
	{
		...
		switch (iParam1)
		{
			...
			case joaat("italigtb2"):
				iVar1 = (Global_262145.f_19679 /* Tunable: IMPEXP_ITALIGTB_BASE_PRICE */ + func_278(iParam1));
				break;
			...
			case joaat("nero2"):
				iVar1 = (Global_262145.f_19683 /* Tunable: IMPEXP_NERO_BASE_PRICE */ + func_278(iParam1));
				break;
			...
			case joaat("diablous2"):
				iVar1 = (Global_262145.f_19689 /* Tunable: IMPEXP_DIABLOUS_BASE_PRICE */ + func_278(iParam1));
				break;
			...
			case joaat("fcr2"):
				iVar1 = (Global_262145.f_19687 /* Tunable: IMPEXP_FCR_BASE_PRICE */ + func_278(iParam1));
				break;
			...
			case joaat("specter2"):
				iVar1 = (Global_262145.f_19681 /* Tunable: IMPEXP_SPECTER_BASE_PRICE */ + func_278(iParam1));
				break;
			...
			case joaat("elegy"):
				iVar1 = (Global_262145.f_19693 /* Tunable: IMPEXP_ELEGY_BASE_PRICE */ + func_278(iParam1));
				break;
		...
		switch (iParam1)
		{
			...
			case joaat("peyote3"):
				...
				if (bVar0)
				{
					iVar1 = (Global_262145.f_29366 /* Tunable: SUM_SALE_PRICE_PEYOTE */ + func_278(iParam1));
				}
				break;
			...
			case joaat("yosemite3"):
				...
				if (bVar0)
				{
					iVar1 = (Global_262145.f_23943 /* Tunable: H2_VEHICLES_PRICE_YOSEMITE */ + func_278(iParam1));
				}
				break;
			...
			case joaat("gauntlet5"):
				...
				if (bVar0)
				{
					iVar1 = (Global_262145.f_26879 /* Tunable: VC_SALE_PRICE_GAUNTLET_CLASSIC */ + func_278(iParam1));
				}
				break;
			...
			case joaat("glendale2"):
				...
				if (bVar0)
				{
					iVar1 = (Global_262145.f_8105 /* Tunable: DLC_HIPSTER_CAR_MOD_BENEFACTOR_GLENDA */ + func_278(iParam1));
				}
				break;
			...
			case joaat("youga3"):
				...
				if (bVar0)
				{
					iVar1 = (Global_262145.f_19045 + func_278(iParam1));
				}
				break;
			...
			case joaat("manana2"):
				...
				if (bVar0)
				{
					iVar1 = (Global_262145.f_29365 /* Tunable: SUM_SALE_PRICE_MANANA */ + func_278(iParam1));
				}
				break;
			...
			case joaat("weevil2"):
				iVar1 = (Global_262145.f_30804 /* Tunable: IH_TRADE_PRICE_WEEVIL */ + func_278(iParam1));
				break;
			
			case joaat("tenf2"):
				iVar1 = (Global_262145.f_33528 /* Tunable: SU22_BIN_PRICE_TENF */ + func_278(iParam1));
				break;
			
			case joaat("brioso3"):
				iVar1 = (Global_262145.f_30805 /* Tunable: IH_TRADE_PRICE_BRIOSO2 */ + func_278(iParam1));
				break;
			
			case joaat("sentinel4"):
				iVar1 = (Global_262145.f_28505 + func_278(iParam1));
				break;
		}
	...
	switch (iParam1)
	{
		...
		case joaat("chino2"):
			iVar1 = 225000;
			iVar1 = (Global_262145.f_12339 /* Tunable: WEBSITE_VAPID_CHINO__BENNYS_WEBSITE_ */ + func_278(iParam1));
			break;
		...
		case joaat("primo2"):
			...
			{
				iVar1 = (Global_262145.f_12338 /* Tunable: WEBSITE_ALBANY_PRIMO */ + func_278(iParam1));
			}
			break;
		...
		case joaat("moonbeam2"):
			iVar1 = (Global_262145.f_12335 /* Tunable: WEBSITE_DECLASSE_MOONBEAM */ + func_278(iParam1));
			break;
		...
		case joaat("faction2"):
			iVar1 = 95000;
			iVar1 = (Global_262145.f_12334 /* Tunable: WEBSITE_WILLARD_FACTION */ + func_278(iParam1));
			break;
		...
		case joaat("buccaneer2"):
			iVar1 = 85000;
			iVar1 = (Global_262145.f_12336 /* Tunable: WEBSITE_ALBANY_BUCCANEER */ + func_278(iParam1));
			break;
		...
		case joaat("voodoo"):
			iVar1 = 105000;
			iVar1 = (Global_262145.f_12337 /* Tunable: WEBSITE_DECLASSE_VOODOO */ + func_278(iParam1));
			break;
		
		case joaat("dominator4"):
		case joaat("dominator5"):
		case joaat("dominator6"):
			iVar1 = (Global_262145.f_25928 /* Tunable: AW_TRADE_PRICE_DOMINATOR */ + func_278(iParam1));
			break;
		
		case joaat("slamvan4"):
		case joaat("slamvan5"):
		case joaat("slamvan6"):
			iVar1 = (Global_262145.f_9405 /* Tunable: VEHICLE_XMAS14_SLAMVAN */ + func_278(iParam1));
			break;
		
		case joaat("issi4"):
		case joaat("issi5"):
		case joaat("issi6"):
			iVar1 = (Global_262145.f_24151 /* Tunable: ASSAULT_VEHICLES_WEENY_ISSI_CLASSIC */ + func_278(iParam1));
			break;
		
		case joaat("impaler2"):
		case joaat("impaler3"):
		case joaat("impaler4"):
			iVar1 = (Global_262145.f_25929 /* Tunable: AW_TRADE_PRICE_IMPALER */ + func_278(iParam1));
			break;
		
		case joaat("deathbike"):
		case joaat("deathbike2"):
		case joaat("deathbike3"):
			iVar1 = (Global_262145.f_25931 /* Tunable: AW_TRADE_PRICE_GARGOYLE */ + func_278(iParam1));
			break;
		
		case joaat("monster3"):
		case joaat("monster4"):
		case joaat("monster5"):
			iVar1 = (Global_262145.f_25925 /* Tunable: AW_TRADE_PRICE_RATLOADER */ + func_278(iParam1));
			break;
		
		case joaat("bruiser"):
		case joaat("bruiser2"):
		case joaat("bruiser3"):
			iVar1 = (Global_262145.f_25926 /* Tunable: AW_TRADE_PRICE_GLENDALE */ + func_278(iParam1));
			break;
		...
		case joaat("sultanrs"):
			iVar1 = (Global_262145.f_13449 /* Tunable: BENNYSWEBSITE_KARIN_SULTAN_BENNYS */ + func_278(iParam1));
			break;
		...
		case joaat("banshee2"):
			iVar1 = (Global_262145.f_13451 /* Tunable: UPGRADE_BRAVADO_BANSHEE_BENNYS */ + func_278(iParam1));
			break;
		...
		case joaat("minivan2"):
			iVar1 = (Global_262145.f_7036 /* Tunable: BUSINESS_VEHICLES_MINIVAN */ + func_278(iParam1));
			break;
		
		case joaat("sabregt2"):
			iVar1 = (Global_262145.f_15026 /* Tunable: WEBSITE_BENNYS_DECLASSE_SABRE_TURBO */ + func_278(iParam1));
			break;
		...
		case joaat("tornado5"):
			iVar1 = (Global_262145.f_15027 /* Tunable: WEBSITE_BENNYS_DECLASSE_TORNADO */ + func_278(iParam1));
			break;
		...
		case joaat("virgo2"):
			iVar1 = (Global_262145.f_15025 /* Tunable: WEBSITE_BENNYS_DUNDREARY_VIRGO_CLASSIC */ + func_278(iParam1));
			break;
		...
		case joaat("technical3"):
			...
			if (bVar0)
			{
				if (Global_262145.f_9098 /* Tunable: VEHICLES_HEIST_KARIN_TECHNICAL */ >= 0)
				{
					iVar1 = (Global_262145.f_9098 /* Tunable: VEHICLES_HEIST_KARIN_TECHNICAL */ + func_278(iParam1));
				}
			}
			break;
		...
		case joaat("insurgent3"):
			...
			if (bVar0)
			{
				if (Global_262145.f_9091 /* Tunable: VEHICLES_HEIST_HVY_INSURGENT_PICKUP */ >= 0)
				{
					iVar1 = (Global_262145.f_9091 /* Tunable: VEHICLES_HEIST_HVY_INSURGENT_PICKUP */ + func_278(iParam1));
				}
			}
			break;
	}
...
int func_276(int iParam0)//Position - 0x13FBD
{
	switch (iParam0)
	{
		case joaat("apc"):
...
int func_277(int iParam0)//Position - 0x1410D
{
	switch (iParam0)
	{
		case joaat("scarab"):
...
int func_278(int iParam0)//Position - 0x141F9
{
	switch (iParam0)
	{
		case joaat("chino2"):
...
int func_279(int iParam0)//Position - 0x145FF
{
	int iVar0;
...
int func_280(int iParam0)//Position - 0x146D4
{
	switch (iParam0)
	{
		case 1:
...
int func_281(int iParam0)//Position - 0x14A24
{
	int iVar0;
...
char* func_282(bool bParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x14A7B
{
	if (bParam3)
	{
...
int func_283(int iParam0)//Position - 0x14B0A
{
	...
	if (iParam0 == 0)
	{
		return Global_262145.f_19441 /* Tunable: IMPEXP_SELL_DISABLE_BUYER1 */;
	}
	else if (iParam0 == 1)
	{
		return Global_262145.f_19442 /* Tunable: IMPEXP_SELL_DISABLE_BUYER2 */;
	}
	else if (iParam0 == 2)
	{
		return Global_262145.f_19443 /* Tunable: IMPEXP_SELL_DISABLE_BUYER3 */;
	}
	return 0;
}

void func_284()//Position - 0x14B54
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_559, "SHOW_BUYERS");
...
void func_285()//Position - 0x14C56
{
	int iVar0;
	...
	while (iVar0 >= 0)
	{
		if (iLocal_554[iVar0] != 0)
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(iLocal_554[iVar0]), -1f, -1f, -1f, -1f);
			iLocal_554[iVar0] = 0;
		}
		else
		{
...
struct<4> func_286(bool bParam0)//Position - 0x14CB0
{
	struct<4> Var0;
...
int func_287(int iParam0)//Position - 0x14DEF
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_288()//Position - 0x14E12
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_559, "HIDE_OVERLAY");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	iLocal_575 = 0;
	if (iLocal_549)
	{
...
void func_289(bool bParam0)//Position - 0x14E38
{
	int iVar0;
	var uVar1[4];
	var uVar2;
	...
	while (iVar0 < 4)
	{
		if ((!bParam0 && iLocal_554[iVar0] != 0) || (bParam0 && iLocal_555[iVar0] != 0))
		{
			uVar2 = iLocal_554[iVar0];
			if (bParam0)
			{
				uVar2 = iLocal_555[iVar0];
			}
			Global_1835008[iVar0 /*103*/].f_101 = uVar2;
			Global_1835008[iVar0 /*103*/].f_100 = iLocal_556[iVar0];
		}
		else
		{
			func_300(&uVar1);
			...
			iLocal_556[iVar0] = uVar1[0];
		}
		iVar0++;
	}
	if (iLocal_557 != 0 && !bParam0)
	{
		if (func_299())
		{
			func_297();
	...
	func_293(0);
	func_290(iLocal_556[0], iLocal_556[1], iLocal_556[2], iLocal_556[3], Global_1835008[0 /*103*/].f_101, Global_1835008[1 /*103*/].f_101, Global_1835008[2 /*103*/].f_101, Global_1835008[3 /*103*/].f_101, iLocal_557, bParam0);
	Global_1946220 = 1;
}

void func_290(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, bool bParam9)//Position - 0x14F7A
{
	struct<14> Var0;
	int iVar1;
...
var func_291(bool bParam0, bool bParam1)//Position - 0x15012
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_292(int iParam0, int iParam1)//Position - 0x150A9
{
	int iVar0;
...
void func_293(bool bParam0)//Position - 0x150D4
{
	if (bParam0)
	{
		if (!BitTest(Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_198, 6))
		{
			MISC::SET_BIT(&(Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_198), 6);
		}
	}
	else if (BitTest(Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_198, 6))
	{
		MISC::CLEAR_BIT(&(Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_198), 6);
	}
}

void func_294()//Position - 0x1512D
{
	int iVar0;
	...
	while (iVar0 < 4)
	{
		Global_2787554.f_20[iVar0] = 0;
		iVar0++;
	}
	Global_2787554.f_25 = 0;
	Global_2787554.f_19 = 2000;
	Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_331 = 2000;
}

void func_295(int iParam0)//Position - 0x15175
{
	if (func_311(iParam0))
	{
		Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_331 = iParam0;
	}
}

void func_296(bool bParam0)//Position - 0x1519B
{
	if (bParam0)
	{
		if (!BitTest(Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_197, 18))
		{
			MISC::SET_BIT(&(Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_197), 18);
		}
	}
	else if (BitTest(Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_197, 18))
	{
		MISC::CLEAR_BIT(&(Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_197), 18);
	}
}

void func_297()//Position - 0x151F8
{
	Global_20471 = 0;
	func_298();
}

void func_298()//Position - 0x15208
{
...
void func_300(var uParam0)//Position - 0x15281
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar0 < iVar2)
	{
		if ((((Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_11[iVar0] != func_3() && func_2(Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_11[iVar0], 1, 1)) && !func_301(Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_11[iVar0])) && func_404(Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_11[iVar0])) && !func_79(Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_11[iVar0]))
		{
			(*uParam0)[iVar1] = Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_11[iVar0];
			iVar1++;
		}
		else
		{
...
int func_301(int iParam0)//Position - 0x1537C
{
	int iVar0;
...
void func_302(bool bParam0)//Position - 0x153A7
{
	int iVar0;
	var uVar1[4];
	...
	while (iVar0 < 4)
	{
		if ((!bParam0 && iLocal_554[iVar0] != 0) || (bParam0 && iLocal_555[iVar0] != 0))
		{
			if (iVar0 == 0)
			{
				iLocal_556[iVar0] = PLAYER::PLAYER_ID();
			}
			else
			{
				func_300(&uVar1);
...
void func_303(int iParam0)//Position - 0x15416
{
...
void func_304(int iParam0)//Position - 0x1542B
{
	struct<2> Var0;
	int iVar1;
...
void func_305(var uParam0, int iParam1)//Position - 0x15463
{
...
int func_306(int iParam0)//Position - 0x1563C
{
	switch (iParam0)
	{
		case 2001:
...
bool func_307()//Position - 0x156CE
{
	return iLocal_558 != 2000;
}

void func_308(bool bParam0, bool bParam1)//Position - 0x156DD
{
	int iVar0;
...
int func_309(int iParam0)//Position - 0x1573B
{
	switch (iParam0)
	{
		case 2001:
...
char* func_310(int iParam0)//Position - 0x157AF
{
	int iVar0;
...
int func_312(int iParam0)//Position - 0x15836
{
	int iVar0;
	int iVar1;
...
void func_313(int iParam0)//Position - 0x1587A
{
	int iVar0;
	...
	while (iVar0 < 4)
	{
		...
		else if (iLocal_554[iVar0] == iParam0)
		{
			if (iLocal_554[iVar0 + 1] != 0)
			{
				iLocal_554[iVar0] = iLocal_554[iVar0 + 1];
				iLocal_554[iVar0 + 1] = iParam0;
			}
			else
			{
				iLocal_554[iVar0] = 0;
...
void func_314(int iParam0, bool bParam1)//Position - 0x158F7
{
	int iVar0;
	...
	while (iVar0 < 4)
	{
		if (bParam1)
		{
			if (iLocal_555[iVar0] == 0)
			{
				iLocal_555[iVar0] = iParam0;
				return;
			}
		}
		else if (iLocal_554[iVar0] == 0)
		{
...
int func_315(int iParam0, bool bParam1)//Position - 0x15947
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 4)
	{
		if (bParam1)
		{
			if (iLocal_555[iVar0] == iVar1)
			{
				return 1;
			}
		}
		else if (iLocal_554[iVar0] == iVar1)
		{
			return 1;
		}
		iVar0++;
...
int func_316(int iParam0)//Position - 0x1599E
{
	if (iParam0 != func_3())
	{
		if (func_2(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1)
			{
				return func_114(Global_2689235[iParam0 /*453*/].f_318.f_6) == 17;
			}
		}
	}
	return 0;
...
void func_318(char* sParam0)//Position - 0x15A35
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

char* func_319()//Position - 0x15A47
{
...
int func_320(int iParam0)//Position - 0x15A70
{
	if (iParam0 == 8)
	{
		if (func_259(&(Global_2789228.f_144)) && !func_257(&(Global_2789228.f_144), Global_2789828, 0))
		{
			return 0;
		}
	}
	else if (func_259(&(Global_2789228.f_146)) && !func_257(&(Global_2789228.f_146), Global_262145.f_19359 /* Tunable: IMPEXP_STEAL_COOLDOWN */, 1))
	{
		return 0;
	}
	return 1;
...
int func_321(int iParam0)//Position - 0x15AD2
{
	int iVar0;
	int iVar1;
...
void func_322()//Position - 0x15B13
{
	...
	if (PAD::IS_CONTROL_JUST_PRESSED(2 /*FRONTEND_CONTROL*/, 205 /*INPUT_FRONTEND_LB*/))
	{
		...
		{
			func_303(0);
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(205), -1f, -1f, -1f, -1f);
		}
	}
	...
	if (PAD::IS_CONTROL_JUST_PRESSED(2 /*FRONTEND_CONTROL*/, 206 /*INPUT_FRONTEND_RB*/))
	{
		...
		{
			func_303(1);
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(206), -1f, -1f, -1f, -1f);
		}
	}
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(207), -1f, -1f, -1f, -1f);
	}
	if (PAD::IS_CONTROL_JUST_RELEASED(2 /*FRONTEND_CONTROL*/, 207 /*INPUT_FRONTEND_LT*/))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(207), -1f, -1f, -1f, -1f);
	}
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(208), -1f, -1f, -1f, -1f);
	}
	if (PAD::IS_CONTROL_JUST_RELEASED(2 /*FRONTEND_CONTROL*/, 208 /*INPUT_FRONTEND_RT*/))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(208), -1f, -1f, -1f, -1f);
	}
	func_326();
	PAD::ENABLE_CONTROL_ACTION(2 /*FRONTEND_CONTROL*/, 201 /*INPUT_FRONTEND_ACCEPT*/, true);
	if (PAD::IS_CONTROL_JUST_PRESSED(2 /*FRONTEND_CONTROL*/, 201 /*INPUT_FRONTEND_ACCEPT*/))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(201), -1f, -1f, -1f, -1f);
	}
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(203), -1f, -1f, -1f, -1f);
	}
	if (PAD::IS_USING_CURSOR(2 /*FRONTEND_CONTROL*/))
	{
		...
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(237), -1f, -1f, -1f, -1f);
		}
		if (PAD::IS_CONTROL_JUST_RELEASED(2 /*FRONTEND_CONTROL*/, 238 /*INPUT_CURSOR_CANCEL*/))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(238), -1f, -1f, -1f, -1f);
		}
		func_323(0, 1);
	}
	else
...
void func_323(bool bParam0, bool bParam1)//Position - 0x15DC5
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam0)
	{
		...
		if (((iVar0 != 127 || iLocal_567 != 127) || iVar1 != 127) || iLocal_568 != 127)
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_559, "SET_ANALOG_STICK_INPUT");
			iLocal_567 = iVar0;
			iLocal_568 = iVar1;
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(true);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_567);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_568);
	...
	if (bParam1)
	{
		...
		if (((iVar2 != 127 || iLocal_569 != 127) || iVar3 != 127) || iLocal_570 != 127)
		{
...
void func_324()//Position - 0x15F08
{
	fLocal_563 = PAD::GET_DISABLED_CONTROL_NORMAL(2 /*FRONTEND_CONTROL*/, 239 /*INPUT_CURSOR_X*/);
	fLocal_564 = PAD::GET_DISABLED_CONTROL_NORMAL(2 /*FRONTEND_CONTROL*/, 240 /*INPUT_CURSOR_Y*/);
	if (fLocal_563 != fLocal_565 || fLocal_564 != fLocal_566)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_559, "SET_MOUSE_INPUT");
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(fLocal_563);
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(fLocal_564);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		fLocal_565 = fLocal_563;
		fLocal_566 = fLocal_564;
	}
	PAD::ENABLE_CONTROL_ACTION(2 /*FRONTEND_CONTROL*/, 237 /*INPUT_CURSOR_ACCEPT*/, true);
	if (PAD::IS_CONTROL_JUST_PRESSED(2 /*FRONTEND_CONTROL*/, 237 /*INPUT_CURSOR_ACCEPT*/))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(237), -1f, -1f, -1f, -1f);
	}
...
void func_325()//Position - 0x15FD7
{
	if (iLocal_575)
	{
		func_288();
	}
	else if (iLocal_551 == 2)
	{
		func_303(0);
	}
	else if (func_307() && iLocal_551 == 1)
	...
	else if (func_76(0) > 0 && iLocal_551 == 0)
	{
		func_285();
	}
	else
...
void func_326()//Position - 0x1603C
{
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(188), -1f, -1f, -1f, -1f);
	}
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(187), -1f, -1f, -1f, -1f);
	}
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(189), -1f, -1f, -1f, -1f);
	}
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_559, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(190), -1f, -1f, -1f, -1f);
	}
}

void func_327()//Position - 0x16120
{
	char* sVar0;
	
	if (!BitTest(uLocal_552, 0) && !BitTest(uLocal_552, 2))
	{
		if (func_332(16))
		{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && !BitTest(uLocal_552, 0))
	{
		func_328(sVar0, iLocal_573);
		MISC::SET_BIT(&uLocal_552, 0);
	}
	else if (BitTest(uLocal_552, 0))
	{
		if (!func_259(&uLocal_744))
		{
			func_258(&uLocal_744, 0, 0);
		}
		else if (func_257(&uLocal_744, iLocal_573, 0))
		{
			MISC::CLEAR_BIT(&uLocal_552, 0);
			iLocal_573 = 0;
			func_255(&uLocal_744);
			if (func_379())
			{
...
void func_328(char* sParam0, int iParam1)//Position - 0x162F3
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

void func_329(int* iParam0, var uParam1, int iParam2)//Position - 0x1630A
{
	int iVar0;
...
void func_330(int* iParam0, var uParam1, var uParam2, int iParam3)//Position - 0x16337
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
int func_331(var uParam0, var uParam1, var uParam2)//Position - 0x163BB
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_332(int iParam0)//Position - 0x1641B
{
	bool bVar0;
	...
	{
		case 16:
			if ((!func_334(iLocal_571, uLocal_572, 18) && !BitTest(Global_1946101, bVar0)) && !BitTest(uLocal_552, 4))
			{
				return 1;
			}
			break;
		...
		case 17:
			if (((!func_334(iLocal_571, uLocal_572, 21) && !BitTest(Global_1946101, bVar0)) && !BitTest(uLocal_552, 5)) && iLocal_551 == 2)
			{
				return 1;
			}
			break;
		...
		case 18:
			if (((!func_334(iLocal_571, uLocal_572, 24) && !BitTest(Global_1946101, bVar0)) && !BitTest(uLocal_552, 5)) && iLocal_551 == 2)
			{
				return 1;
			}
			break;
		...
		case 19:
			if (((!func_334(iLocal_571, uLocal_572, 27) && !BitTest(Global_1946101, bVar0)) && !BitTest(uLocal_552, 6)) && iLocal_551 == 1)
			{
				return 1;
			}
			break;
		...
		case 20:
			if ((((!func_334(iLocal_571, uLocal_572, 30) && !BitTest(Global_1946101, bVar0)) && !BitTest(uLocal_552, 6)) && iLocal_551 == 1) && func_333())
			{
				return 1;
			}
			break;
		...
		case 21:
			if ((!func_334(iLocal_571, uLocal_572, 33) && !BitTest(Global_1946101, bVar0)) && !func_320(8))
			{
				return 1;
			}
			break;
		...
		case 22:
			if (((!func_334(iLocal_571, uLocal_572, 36) && !BitTest(Global_1946101, bVar0)) && !BitTest(uLocal_552, 5)) && iLocal_551 == 2)
			{
				return 1;
			}
			break;
...
bool func_334(var uParam0, var uParam1, int iParam2)//Position - 0x1660C
{
	return func_331(uParam0, uParam1, iParam2) == 3;
}

void func_335()//Position - 0x16620
{
	if (iLocal_574 != -1)
	{
		func_336(iLocal_574);
...
void func_336(int iParam0)//Position - 0x16636
{
	if (func_337(&uLocal_577, "IMMECAU", func_357(iParam0), 8, 0, 0, 0))
	{
		iLocal_574 = -1;
	}
}

bool func_337(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1665B
{
...
int func_338(char* sParam0, int iParam1, bool bParam2)//Position - 0x166A9
{
	Global_21606 = 0;
...
void func_339()//Position - 0x16977
{
	if (!func_340())
	{
		return;
...
bool func_341(int iParam0)//Position - 0x16A11
{
	return func_84(iParam0, 20);
}

void func_342()//Position - 0x16A21
{
	int iVar0;
...
void func_343()//Position - 0x16A52
{
...
void func_346()//Position - 0x16BA7
{
	if (func_353(14))
	{
...
var func_347()//Position - 0x16C49
{
	func_348();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_348()//Position - 0x16C62
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_351(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_350(PLAYER::PLAYER_PED_ID());
			if (func_349(iVar0) && (!func_353(14) || Global_112337))
			{
				if (Global_113386.f_2363.f_539.f_4321 != iVar0 && func_349(Global_113386.f_2363.f_539.f_4321))
				{
...
bool func_349(int iParam0)//Position - 0x16D5F
{
	return iParam0 < 3;
}

int func_350(int iParam0)//Position - 0x16D6B
{
	int iVar0;
	int iVar1;
...
int func_351(int iParam0)//Position - 0x16DA8
{
	if (func_349(iParam0))
	{
...
var func_352(int iParam0)//Position - 0x16DCD
{
	return Global_1998[iParam0 /*29*/];
}

bool func_353(int iParam0)//Position - 0x16DDC
{
	return Global_43052 == iParam0;
}

void func_354()//Position - 0x16DEA
{
	int iVar0;
...
bool func_355(int iParam0, int iParam1)//Position - 0x16E41
{
	switch (iParam0)
	{
		case 5:
...
void func_356(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x16E79
{
...
char* func_357(int iParam0)//Position - 0x16ECF
{
	switch (iParam0)
	{
		case 0:
...
void func_358()//Position - 0x16F09
{
	bool bVar0;
	
	if (!BitTest(uLocal_552, 2) && !func_299())
	{
		if (!func_360(3814, -1))
		{
			bVar0 = true;
			...
			iLocal_574 = 0;
			func_359(3814, 1, -1);
			MISC::SET_BIT(&uLocal_552, 4);
		}
		else if (iLocal_551 == 2 && !func_360(3815, -1))
		{
			bVar0 = true;
			iLocal_573 = 8000;
			iLocal_574 = 1;
			func_359(3815, 1, -1);
			MISC::SET_BIT(&uLocal_552, 5);
		}
		else if (iLocal_551 == 1 && !func_360(3816, -1))
		{
			bVar0 = true;
			iLocal_573 = 6000;
			iLocal_574 = 2;
			func_359(3816, 1, -1);
			MISC::SET_BIT(&uLocal_552, 6);
		}
	}
	if (bVar0)
	{
		MISC::SET_BIT(&uLocal_552, 2);
	}
	else if (BitTest(uLocal_552, 2))
	{
		if (!func_259(&uLocal_744))
		{
			func_258(&uLocal_744, 0, 0);
...
void func_359(int iParam0, bool bParam1, int iParam2)//Position - 0x1701B
{
	if (iParam2 == -1)
	{
		iParam2 = func_8();
...
bool func_360(int iParam0, int iParam1)//Position - 0x17039
{
	if (iParam1 == -1)
	{
		iParam1 = func_8();
...
void func_361()//Position - 0x17055
{
	...
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_559, 255, 255, 255, 255, 0);
	func_368();
	func_365(0);
	func_362(1);
}

void func_362(bool bParam0)//Position - 0x170C3
{
	if (bParam0)
	{
		func_364();
...
void func_363(int iParam0, int iParam1)//Position - 0x17114
{
...
void func_364()//Position - 0x1714A
{
	Global_2815059.f_4599 = 0;
}

void func_365(int iParam0)//Position - 0x1715A
{
	if (func_367())
	{
		return;
...
int func_366(int iParam0)//Position - 0x1718D
{
	if (iParam0 == 1)
	{
		if (Global_20266.f_1 > 3)
...
bool func_367()//Position - 0x171E4
{
	return BitTest(Global_1958711, 19);
}

void func_368()//Position - 0x171F3
{
	RECORDING::REPLAY_PREVENT_RECORDING_THIS_FRAME();
	func_369();
}

void func_369()//Position - 0x17203
{
	Global_23011.f_134 = 1;
}

void func_370()//Position - 0x17211
{
	func_371(1);
...
void func_371(bool bParam0)//Position - 0x1723D
{
	if (bParam0)
	{
		if (func_372())
...
bool func_372()//Position - 0x17262
{
	return BitTest(Global_2714762.f_2, 11);
}

bool func_373(char* sParam0)//Position - 0x17273
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

bool func_374()//Position - 0x17286
{
	return Global_1964706 != -1;
}

void func_375()//Position - 0x17294
{
	func_377(1);
	func_376(&uLocal_577, 2, 0, "SECUROMECH", 0, 1);
}

void func_376(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x172B0
{
...
void func_377(bool bParam0)//Position - 0x1734B
{
	if (bParam0)
	{
		Global_1835497 = 1;
...
int func_379()//Position - 0x17397
{
	if (((((func_334(iLocal_571, uLocal_572, 18) && func_334(iLocal_571, uLocal_572, 21)) && func_334(iLocal_571, uLocal_572, 24)) && func_334(iLocal_571, uLocal_572, 27)) && func_334(iLocal_571, uLocal_572, 30)) && func_334(iLocal_571, uLocal_572, 33))
	{
		return 1;
	}
	return 0;
...
void func_380()//Position - 0x17408
{
	iLocal_571 = func_10(5370, -1, 0);
	uLocal_572 = func_10(5371, -1, 0);
}

int func_381(bool bParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x17428
{
	int iVar0;
...
void func_382()//Position - 0x1745B
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar0 < 40)
	{
		iVar1 = Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_267.f_142.f_2[iVar0];
		if (iVar1 > 1000)
		{
			iVar1 = (iVar1 - 1000);
		}
	...
	{
		iVar2 = func_384(8);
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_559, "SET_COOLDOWN");
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar2);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	}
	func_383();
...
void func_383()//Position - 0x17500
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_559, "SHOW_EXPORT_SCREEN");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}

int func_384(int iParam0)//Position - 0x17518
{
	int iVar0;
...
void func_385(int iParam0)//Position - 0x17571
{
	int iVar0;
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_559, "UPDATE_COLLECTION");
...
int func_386(int iParam0, int iParam1)//Position - 0x175AF
{
	int iVar0;
	int iVar1;
	...
	{
		case 2001:
			iVar1 = Global_262145.f_19573 /* Tunable: IMPEXP_COLLECTION_BONUS_METAL */;
			break;
		
		case 2002:
			iVar1 = Global_262145.f_19574 /* Tunable: IMPEXP_COLLECTION_BONUS_TROPICAL */;
			break;
		
		case 2003:
			iVar1 = Global_262145.f_19575 /* Tunable: IMPEXP_COLLECTION_BONUS_ELEGANT */;
			break;
		
		case 2004:
			iVar1 = Global_262145.f_19576 /* Tunable: IMPEXP_COLLECTION_BONUS_RALLY */;
			break;
		
		case 2005:
			iVar1 = Global_262145.f_19577 /* Tunable: IMPEXP_COLLECTION_BONUS_PRETTY */;
			break;
		
		case 2006:
			iVar1 = Global_262145.f_19578 /* Tunable: IMPEXP_COLLECTION_BONUS_DECLASSE */;
			break;
		
		case 2007:
			iVar1 = Global_262145.f_19579 /* Tunable: IMPEXP_COLLECTION_BONUS_DANGEROUS */;
			break;
		
		case 2008:
			iVar1 = Global_262145.f_19580 /* Tunable: IMPEXP_COLLECTION_BONUS_MATTE */;
			break;
		
		case 2009:
			iVar1 = Global_262145.f_19581 /* Tunable: IMPEXP_COLLECTION_BONUS_MUSCULAR */;
			break;
		
		case 2010:
			iVar1 = Global_262145.f_19582 /* Tunable: IMPEXP_COLLECTION_BONUS_WEALTHY */;
			break;
	}
	if (iParam1 != -1)
	{
...
int func_387(int iParam0)//Position - 0x17694
{
	switch (iParam0)
	{
		case 2001:
			return Global_262145.f_19583 /* Tunable: IMPEXP_COLLECTION_DISABLE_METAL */;
		
		case 2002:
			return Global_262145.f_19584 /* Tunable: IMPEXP_COLLECTION_DISABLE_TROPICAL */;
		
		case 2003:
			return Global_262145.f_19585 /* Tunable: IMPEXP_COLLECTION_DISABLE_ELEGANT */;
		
		case 2004:
			return Global_262145.f_19586 /* Tunable: IMPEXP_COLLECTION_DISABLE_RALLY */;
		
		case 2005:
			return Global_262145.f_19587 /* Tunable: IMPEXP_COLLECTION_DISABLE_PRETTY */;
		
		case 2006:
			return Global_262145.f_19588 /* Tunable: IMPEXP_COLLECTION_DISABLE_DECLASSE */;
		
		case 2007:
			return Global_262145.f_19589 /* Tunable: IMPEXP_COLLECTION_DISABLE_DANGEROUS */;
		
		case 2008:
			return Global_262145.f_19590 /* Tunable: IMPEXP_COLLECTION_DISABLE_MATTE */;
		
		case 2009:
			return Global_262145.f_19591 /* Tunable: IMPEXP_COLLECTION_DISABLE_MUSCULAR */;
		
		case 2010:
			return Global_262145.f_19592 /* Tunable: IMPEXP_COLLECTION_DISABLE_WEALTHY */;
...
void func_388(int iParam0, bool bParam1)//Position - 0x17744
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar3 = 0;
	if (iVar0 >= Global_262145.f_19457 /* Tunable: IMPEXP_SELL_BUYER1_OFFER_HARD */)
	{
		iVar3 = 2;
	}
	else if (iVar0 >= Global_262145.f_19458 /* Tunable: IMPEXP_SELL_BUYER1_OFFER_MED */)
	{
		iVar3 = 1;
	}
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_559, "UPDATE_VEHICLE");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar0);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar1);
...
void func_389()//Position - 0x177DA
{
	int iVar0;
	...
	while (iVar0 < 4)
	{
		iLocal_556[iVar0] = func_3();
		iVar0++;
	}
}

void func_390(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x177FF
{
	int iVar0;
	bool bVar1;
	bool bVar2;
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			else
			{
				if (!func_394(iVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar27))
				{
					...
					if (func_391(Global_4718592.f_168757))
					{
...
bool func_391(int iParam0)//Position - 0x17C8D
{
	return iParam0 == 17;
}

void func_392()//Position - 0x17C9A
{
	struct<3> Var0;
...
void func_393()//Position - 0x17CE7
{
...
int func_394(int iParam0)//Position - 0x17D25
{
	int iVar0;
...
void func_395(bool bParam0, int iParam1, int iParam2)//Position - 0x17D56
{
	int iVar0;
	int iVar1;
...
void func_396(int iParam0, bool bParam1)//Position - 0x17E26
{
	int iVar0;
...
void func_397()//Position - 0x17E42
{
	int iVar0;
...
bool func_398()//Position - 0x17E9A
{
	return BitTest(Global_2621446, 3);
}

int func_399()//Position - 0x17EA8
{
	if (func_400() == 0)
	{
		return 1;
...
int func_400()//Position - 0x17EBD
{
	return Global_1574632.f_18;
}

int func_401()//Position - 0x17ECB
{
...
int func_402(int iParam0)//Position - 0x17EFC
{
	if (func_404(iParam0))
	{
		return func_403(Global_2689235[iParam0 /*453*/].f_318.f_6);
	}
	return 0;
}

int func_403(int iParam0)//Position - 0x17F23
{
	switch (iParam0)
	{
		case 60:
...
int func_404(int iParam0)//Position - 0x17FB8
{
	if (iParam0 != func_3())
	{
		if (func_2(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1)
			{
				return func_114(Global_2689235[iParam0 /*453*/].f_318.f_6) == 1;
			}
		}
	}
	return 0;
...
void func_405()//Position - 0x17FFE
{
	Global_1574747 = 1;
...
void func_406(bool bParam0)//Position - 0x18029
{
	if (bParam0)
	{
		func_407();
...
void func_407()//Position - 0x1808C
{
...
void func_408(int iParam0)//Position - 0x180B5
{
	if (func_367())
	{
		return;
...
void func_409(bool bParam0, bool bParam1)//Position - 0x1813F
{
	if (bParam0)
	{
		if (func_366(0))
...
bool func_410()//Position - 0x181B3
{
	return BitTest(Global_1958711, 5);
}

void func_411(int iParam0, bool bParam1)//Position - 0x181C1
{
	Global_77117 = iParam0;
	func_406(0);
	func_260();
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_559);
	if (bParam1)
	{
