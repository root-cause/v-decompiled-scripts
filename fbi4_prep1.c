...
{
	func_13(&(Global_107917.f_2890), Param0, fParam3);
}
...
{
	if (func_15(Global_79489, 0f, 0f, 0f, 0))
	{
		Global_79489 = { Param0 };
...
void func_18(int iParam0)//Position - 0x5CF
{
	...
	if (Global_114372.f_9088 || func_33(0))
	{
		iVar0 = func_32();
		if (!func_19(iVar0))
		{
...
int func_19(int iParam0)//Position - 0x614
{
	...
	func_20(&(Global_114372.f_2366.f_539), iVar1);
...
void func_20(var uParam0, int iParam1)//Position - 0x724
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_22(Global_114372.f_18536[iVar0], &Var2, &fVar5))
			{
...
void func_26()//Position - 0x13A5
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_30(Global_114372.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_28(iVar0) && (!func_27(14) || Global_113320))
			{
...
void func_60(bool bParam0, int iParam1)//Position - 0x1DEA
{
	...
	if (bParam0)
	{
		if ((func_33(0) && Global_79495.f_1 == 1) && func_61(Global_79495))
		{
		}
		else
		{
...
int func_80(int iParam0)//Position - 0x264D
{
	...
	return Global_98850[func_81(iParam0)];
}
		...
		case 3:
			if (ENTITY::DOES_ENTITY_EXIST(Global_97869.f_9[0]))
			{
				if (!PED::IS_PED_DEAD_OR_DYING(Global_97869.f_9[0], true))
				{
					...
					Local_838.f_0 = Global_97869.f_9[0];
					if (func_345(Local_838.f_0))
					{
		...
		case 4:
			if (ENTITY::DOES_ENTITY_EXIST(Global_97869.f_9[1]))
			{
				if (!PED::IS_PED_DEAD_OR_DYING(Global_97869.f_9[1], true))
				{
					...
					Local_852.f_0 = Global_97869.f_9[1];
					if (func_345(Local_852.f_0))
					{
...
void func_287(int iParam0, int iParam1, int iParam2)//Position - 0xA2C6
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_114372.f_32753.f_4801 = func_310();
			}
...
void func_288(int iParam0, int iParam1)//Position - 0xA3DD
{
	...
	func_331(iParam0, &(Global_114372.f_32753.f_5510));
}
...
int func_292(int iParam0)//Position - 0xA9FC
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_294(int iParam0, int iParam1)//Position - 0xAADF
{
	int iVar0;
	int iVar1;
...
int func_295(bool bParam0)//Position - 0x10019
{
	if (bParam0)
	{
...
bool func_296()//Position - 0x10033
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_297()//Position - 0x10049
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_298()//Position - 0x1005F
{
	return 0;
}

int func_299()//Position - 0x10068
{
	return 1;
}

int func_300()//Position - 0x10071
{
	return 1;
}

int func_301()//Position - 0x1007A
{
...
int func_303(int iParam0)//Position - 0x1014B
{
	int iVar0;
	char* sVar1;
...
int func_304(int iParam0)//Position - 0x10192
{
	int iVar0;
...
int func_305(int iParam0)//Position - 0x101CD
{
	int iVar0;
...
int func_306(int iParam0)//Position - 0x10249
{
	int iVar0;
...
int func_307(int iParam0, int iParam1, bool bParam2)//Position - 0x10331
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_308(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x1039F
{
...
int func_309(int iParam0)//Position - 0x10477
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_311(var uParam0, int iParam1)//Position - 0x104D9
{
	if (iParam1 <= 0)
	{
		return;
...
void func_312(var uParam0, int iParam1)//Position - 0x1055F
{
...
void func_313(var uParam0, int iParam1)//Position - 0x10592
{
	int iVar0;
	int iVar1;
...
int func_314(int iParam0, int iParam1)//Position - 0x105E3
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_315(int iParam0)//Position - 0x10685
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_316(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_316(bool bParam0, int iParam1, int iParam2)//Position - 0x106A7
{
	if (bParam0)
	{
		return iParam1;
...
int func_317(var uParam0)//Position - 0x106BE
{
	return uParam0 & 15;
}

void func_318(var uParam0, int iParam1)//Position - 0x106CB
{
...
void func_319(var uParam0, int iParam1)//Position - 0x10705
{
...
void func_320(var uParam0, int iParam1)//Position - 0x10740
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_321(var uParam0, int iParam1)//Position - 0x1077C
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_15(Global_114372.f_32753.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_15(Global_114372.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_15(Global_114372.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_322(int iParam0, int iParam1)//Position - 0x11E6A
{
	struct<82> Var0;
...
void func_323(int iParam0, var uParam1, int iParam2)//Position - 0x11EAC
{
	int iVar0;
...
void func_324(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x12108
{
	if (func_321(&(Global_78038.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_329(iParam0);
			func_328(uParam1, &(Global_114372.f_32753.f_69[Global_78038.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_325(int iParam0, bool bParam1)//Position - 0x12201
{
	if (iParam0 == -1)
	{
		return;
...
void func_326(int iParam0, int iParam1, bool bParam2)//Position - 0x1225E
{
	if (iParam0 == -1)
	{
		return;
...
int func_327(int iParam0, int iParam1)//Position - 0x12299
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_328(var uParam0, var uParam1)//Position - 0x122B9
{
...
void func_329(int iParam0)//Position - 0x12385
{
	if (iParam0 == -1)
	{
		return;
...
int func_330(int iParam0)//Position - 0x123FC
{
	int iVar0;
...
void func_331(int iParam0, var uParam1)//Position - 0x1245F
{
	int iVar0;
...
int func_332(int iParam0)//Position - 0x1270A
{
	switch (iParam0)
	{
		case 1:
...
int func_333(int iParam0, var uParam1, var uParam2)//Position - 0x127BA
{
	int iVar0;
	int iVar1;
...
int func_334(int iParam0)//Position - 0x129AD
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_335(var uParam0)//Position - 0x129CD
{
	int iVar0;
...
void func_336(int iParam0)//Position - 0x12A7D
{
...
void func_337()//Position - 0x12AA4
{
	func_340();
	func_338();
}

void func_338()//Position - 0x12AB4
{
	if (!iLocal_829)
	{
		if (func_37(iLocal_872))
...
void func_339(int iParam0, bool bParam1)//Position - 0x12B2C
{
	int iVar0;
...
void func_340()//Position - 0x12B76
{
}

void func_341()//Position - 0x12B7E
{
...
void func_342()//Position - 0x12BA1
{
	float fVar0;
	int iVar1;
...
int func_343(int iParam0)//Position - 0x12CE7
{
	if (func_37(iParam0))
	{
...
void func_344(int iParam0)//Position - 0x12D42
{
	HUD::CLEAR_PRINTS();
	func_62();
	switch (iParam0)
...
int func_345(int iParam0)//Position - 0x12D9A
{
	if (func_10(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_346()//Position - 0x12DBA
{
	if (!func_103(36))
	{
		func_347(21, 0, 0);
...
void func_347(int iParam0, bool bParam1, int iParam2)//Position - 0x12DD4
{
	if (bParam1)
	{
...
void func_348(int iParam0)//Position - 0x12E93
{
	Global_101444.f_205[iParam0] = 1;
	Global_101444.f_204 = 1;
}

void func_349(int iParam0, int iParam1, bool bParam2)//Position - 0x12EAD
{
	int iVar0;
...
void func_350(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x12F1D
{
	int iVar0;
...
int func_351(int iParam0, var uParam1)//Position - 0x12F4B
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_352(uParam1));
}

int func_352(var uParam0)//Position - 0x12F60
{
	int iVar0;
	int iVar1;
...
int func_353(int iParam0, int iParam1)//Position - 0x12F94
{
	int iVar0;
	var uVar1;
...
int func_354(int iParam0)//Position - 0x12FC3
{
	switch (iParam0)
	{
		case 0:
...
int func_355()//Position - 0x1336B
{
	return Global_32828;
}

void func_356(int iParam0, int iParam1, bool bParam2)//Position - 0x13376
{
	int iVar0;
...
void func_357(int iParam0)//Position - 0x133E6
{
...
bool func_358(int iParam0)//Position - 0x1340D
{
	return func_360(iParam0, 5, 1);
}

int func_359(int iParam0)//Position - 0x1341D
{
	switch (iParam0)
	{
		case -1:
...
int func_360(int iParam0, int iParam1, bool bParam2)//Position - 0x13753
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_361(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x137B3
{
	if (func_362())
	{
...
void func_363()//Position - 0x1386C
{
	func_378();
	func_376();
	func_369();
...
void func_364()//Position - 0x13888
{
	iLocal_1046[0] = 0;
	iLocal_1046[1] = 0;
	iLocal_1046[2] = 0;
...
struct<8> func_365(char* sParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)//Position - 0x13911
{
	struct<8> Var0;
...
void func_366()//Position - 0x1394F
{
...
void func_367(var uParam0, struct<3> Param1, int iParam4, float fParam5, float fParam6, float fParam7, int iParam8, struct<3> Param9, struct<3> Param12)//Position - 0x14135
{
	uParam0->f_3 = { Param1 };
	uParam0->f_6 = fParam5;
	uParam0->f_7 = fParam6;
...
struct<25> func_368(struct<3> Param0, struct<3> Param3, float fParam6, int iParam7)//Position - 0x14179
{
	struct<25> Var0;
...
void func_369()//Position - 0x141B3
{
	struct<3> Var0[6];
...
void func_370(var uParam0, int iParam1)//Position - 0x1424B
{
	int iVar0;
...
void func_371(var uParam0, var uParam1, float fParam2)//Position - 0x14294
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_372(var uParam0, struct<2> Param1, Vector3 vParam3)//Position - 0x143A1
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_373(var uParam0)//Position - 0x1445D
{
	int iVar0;
	float fVar1;
...
void func_374(var uParam0, struct<3> Param1)//Position - 0x144FD
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_375(var uParam0)//Position - 0x1452E
{
	if (uParam0->f_51)
	{
	}
...
void func_376()//Position - 0x14555
{
...
struct<14> func_377(struct<3> Param0, float fParam3, int iParam4)//Position - 0x145A3
{
	struct<14> Var0;
...
void func_378()//Position - 0x145C6
{
	Local_866 = { func_379(1203.1462f, -337.3543f, 67.9314f, 189.7047f, joaat("trash")) };
}

struct<6> func_379(struct<3> Param0, float fParam3, int iParam4)//Position - 0x145F0
{
	struct<6> Var0;
...
void func_380()//Position - 0x14612
{
	func_241(1);
	func_391(1);
...
void func_381(bool bParam0)//Position - 0x14657
{
	struct<3> Var0;
...
void func_382()//Position - 0x1473B
{
	func_3();
	func_6(&Local_866);
	func_6(&iLocal_873);
...
void func_383()//Position - 0x14777
{
	Global_21032 = 0;
	func_384();
}

void func_384()//Position - 0x14787
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_385()//Position - 0x147A8
{
}

void func_386()//Position - 0x147B0
{
	if (iLocal_835)
	{
		VEHICLE::REMOVE_VEHICLE_ASSET(joaat("trash"));
...
void func_387()//Position - 0x147C7
{
}

void func_388()//Position - 0x147CF
{
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_866.f_5);
}

void func_389()//Position - 0x147E0
{
	func_347(21, 1, 0);
}

void func_390()//Position - 0x147F0
{
	Global_97227 = 0;
}

void func_391(int iParam0)//Position - 0x147FD
{
	Global_98678 = iParam0;
}

void func_392()//Position - 0x1480B
{
	int iVar0;
