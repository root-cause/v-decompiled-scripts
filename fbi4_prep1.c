...
void func_12(struct<3> Param0, float fParam1)//Position - 0x4EB
{
	func_13(&(Global_106934.f_2890), Param0, fParam1);
}

void func_13(var uParam0, struct<3> Param1, var uParam2)//Position - 0x504
{
	*uParam0 = { Param1 };
	uParam0->f_6 = uParam2;
}

void func_14(struct<3> Param0, float fParam1)//Position - 0x51A
{
...
bool func_15(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x546
{
	if (bParam2)
	{
...
void func_26()//Position - 0x13A5
{
	...
	{
		if (func_30(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_39()//Position - 0x1626
{
	...
	switch (iLocal_69)
	{
		...
		case 1:
			if (!func_107(PLAYER::PLAYER_PED_ID(), Local_186, 270f, 1))
			{
				iLocal_69 = 2;
			}
...
bool func_45(int iParam0, int iParam1)//Position - 0x197F
{
	bool bVar0;
...
int func_46(int iParam0, bool bParam1)//Position - 0x19CA
{
	int iVar0;
	int iVar1;
...
bool func_49()//Position - 0x1A56
{
	return BitTest(Global_2621446, 3);
}

int func_50(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x1A64
{
	int iVar0;
...
void func_52(int iParam0)//Position - 0x1ABE
{
	if (iParam0 == 1)
	{
...
int func_53(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x1AE1
{
	struct<15> Var0;
	int iVar1;
...
void func_54(bool bParam0)//Position - 0x1C3E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_55(int iParam0)//Position - 0x1CFC
{
	switch (iParam0)
	{
		case 0:
...
int func_56(bool bParam0)//Position - 0x1D66
{
	if (bParam0 == 1)
	{
		return 9;
...
void func_59(bool bParam0, int iParam1)//Position - 0x1DB0
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_60(int iParam0)//Position - 0x1E80
{
	switch (iParam0)
	{
		case 71:
...
void func_61()//Position - 0x1EBE
{
	Global_20471 = 0;
	func_62();
}

void func_62()//Position - 0x1ECE
{
...
void func_64(bool bParam0, int iParam1)//Position - 0x1F43
{
	int iVar0;
...
void func_65(int iParam0, int iParam1)//Position - 0x1FDD
{
	int iVar0;
...
void func_66(int iParam0, int iParam1)//Position - 0x2048
{
...
void func_68(int iParam0, int iParam1)//Position - 0x21CF
{
...
int func_69(int iParam0)//Position - 0x220C
{
	if (iParam0 == 1)
	{
...
void func_71(bool bParam0)//Position - 0x2286
{
...
void func_72(char* sParam0, char* sParam1)//Position - 0x229A
{
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		Global_21662 = 1;
...
int func_75(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2337
{
	struct<15> Var0;
	int iVar1;
...
int func_77()//Position - 0x25AE
{
	return Global_78581;
}

int func_78(int iParam0, int iParam1)//Position - 0x25BA
{
	bool bVar0;
...
int func_79(int iParam0)//Position - 0x2613
{
	if (iParam0 > 3)
	{
		return 0;
...
int func_80(int iParam0)//Position - 0x2644
{
	if (iParam0 == 0)
	{
		return 0;
...
struct<4> func_81(bool bParam0)//Position - 0x267F
{
	struct<4> Var0;
...
bool func_86(int iParam0)//Position - 0x2AB5
{
	return func_87(iParam0, 20);
}

var func_87(int iParam0, int iParam1)//Position - 0x2AC5
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

int func_88()//Position - 0x2ADD
{
	return -1;
}

void func_89()//Position - 0x2AE6
{
	int iVar0;
...
bool func_94(int iParam0, int iParam1)//Position - 0x2D3E
{
	switch (iParam0)
	{
		case 5:
...
void func_95(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2D76
{
...
void func_98(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2F0D
{
...
void func_99(int iParam0, int iParam1)//Position - 0x2FA8
{
...
void func_100(bool bParam0)//Position - 0x2FED
{
	if (bParam0)
	{
...
int func_102(int iParam0)//Position - 0x3089
{
...
int func_104(int iParam0)//Position - 0x30FD
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
void func_105(char* sParam0, int iParam1, int iParam2)//Position - 0x312A
{
	iParam2 = iParam2;
...
bool func_106(char* sParam0, int iParam1, char* sParam2)//Position - 0x3143
{
...
bool func_107(int iParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x3161
{
...
int func_109(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)//Position - 0x32D2
{
	bool bVar0;
	float fVar1;
...
void func_111(int iParam0)//Position - 0x336B
{
	switch (iParam0)
	{
		case 0:
...
int func_113(int iParam0, struct<3> Param1, int* iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, float fParam10)//Position - 0x33B5
{
	float fVar0;
...
char* func_114(int iParam0)//Position - 0x3560
{
	char* sVar0;
...
char* func_115(int iParam0, bool bParam1)//Position - 0x35B9
{
	char* sVar0;
...
int func_116(float fParam0, int iParam1)//Position - 0x3621
{
	int iVar0;
...
void func_117(int* iParam0, struct<3> Param1, bool bParam2)//Position - 0x36A5
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_118(struct<3> Param0, int iParam1, bool bParam2)//Position - 0x36C6
{
	int iVar0;
...
char* func_119(int iParam0)//Position - 0x36F4
{
	char* sVar0;
...
void func_120(int* iParam0, struct<3> Param1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x374D
{
	switch (*iParam2)
	{
		case 0:
...
void func_121(char* sParam0, int iParam1)//Position - 0x382D
{
	if (!*iParam1)
	{
...
void func_124(int iParam0, struct<3> Param1, float fParam2)//Position - 0x3BA6
{
	if (func_343(iParam0))
	{
...
void func_125(int* iParam0, int iParam1, bool bParam2)//Position - 0x3BCC
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_126(int iParam0, bool bParam1, int iParam2)//Position - 0x3BEB
{
	int iVar0;
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3C20
{
	int iVar0;
	...
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(Local_45[0 /*11*/], true, 0f);
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(Local_45[1 /*11*/], true, 0f);
...
void func_129()//Position - 0x3D2E
{
	...
	{
		TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_45[0 /*11*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_137(1)), 1f, -1, 0.25f, false, 40000f);
		Local_45[0 /*11*/].f_7 = 1;
	}
	else
	{
...
int func_132()//Position - 0x3F3B
{
	...
	if (func_37(iLocal_43))
	{
		...
		fVar7 = func_133(Local_46[iVar0 /*25*/] - Var1, ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_43));
		iVar3 = iVar0;
		iVar8 = 0;
		while (fVar7 < 0f && iVar8 < 40)
		{
			...
			Var1 = { ENTITY::GET_ENTITY_COORDS(iLocal_43, true) };
			fVar7 = func_133(Local_46[iVar3 /*25*/] - Var1, ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_43));
			iVar8++;
		}
		if (iVar8 >= 40)
		{
...
float func_133(struct<3> Param0, struct<3> Param1)//Position - 0x4075
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_136(struct<3> Param0)//Position - 0x41CD
{
...
void func_143(var uParam0)//Position - 0x4321
{
	int iVar0;
	char* sVar1;
...
void func_144(int iParam0, struct<3> Param1)//Position - 0x4377
{
	int iVar0;
...
void func_145(var uParam0, int iParam1, bool bParam2)//Position - 0x440B
{
	char* sVar0;
...
bool func_146(char* sParam0)//Position - 0x44E5
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_147(int iParam0)//Position - 0x44F8
{
	if (Global_97363 != -1)
	{
		...
		case 2:
			if (func_37(Global_96938[0]))
			{
				...
				if (func_37(Local_199.f_0))
				{
					...
					ENTITY::_SET_ENTITY_CLEANUP_BY_ENGINE(Local_199.f_0, true);
					return 1;
				}
			}
...
int func_150(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x4835
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_151(int iParam0, bool bParam1)//Position - 0x48BF
{
	if (bParam1)
	{
...
int func_152(int iParam0, char* sParam1, int iParam2)//Position - 0x48E4
{
...
int func_153(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0x4913
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_152(iParam1, "Loading", 0))
...
int func_154(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x49C6
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
bool func_157(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x4BE7
{
		...
		case 11:
			...
			if ((MISC::GET_GAME_TIMER() - iParam0->f_1) > 5000)
			{
				if (!func_184(*iParam0, joaat("SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD")))
				{
					...
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, Local_54, 1f, -1, 2f, false, 40000f);
					}
				}
				iParam0->f_1 = MISC::GET_GAME_TIMER();
				iParam0->f_6 = 23;
...
int func_159(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0x5556
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	{
		Var1 = { func_160(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
Vector3 func_160(struct<3> Param0)//Position - 0x55E4
{
	float fVar0;
	float fVar1;
		...
		case 3:
			if (!func_184(*iParam0, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
			{
				...
				if (!PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_43, false))
				{
					if (iParam0->f_10 == 0)
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_137(1)), 1f, -1, 0.25f, false, 40000f);
						iParam0->f_7 = 1;
					}
					else
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_137(0)), 1f, -1, 0.25f, false, 40000f);
						iParam0->f_7 = 1;
					}
				}
			}
...
void func_164(var uParam0)//Position - 0x58D6
{
	if (!func_184(*uParam0, joaat("SCRIPT_TASK_PUT_PED_DIRECTLY_INTO_MELEE")))
	{
		...
		{
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_46[iLocal_48 /*25*/].f_19, 1f, 20000, -1f, false, func_165(Local_46[iLocal_48 /*25*/].f_19, ENTITY::GET_ENTITY_COORDS(*uParam0, true), 1));
		}
		if (func_37(iLocal_43))
		{
...
float func_165(struct<2> Param0, var uParam1, struct<2> Param2, Vector3 vParam3, int iParam4)//Position - 0x597C
{
	float fVar0;
	float fVar1;
	float fVar2;
...
{
	if (func_37(iLocal_43) && func_343(PLAYER::PLAYER_PED_ID()))
	{
...
float func_170(struct<2> Param0, Vector3 vParam1, struct<2> Param2, Vector3 vParam3)//Position - 0x5AF3
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param2.f_0 - Param0.f_0), (Param2.f_1 - Param0.f_1));
}

int func_171(int iParam0)//Position - 0x5B0D
{
	if (iParam0 == 0)
	{
		return 1;
...
{
	if (func_37(iLocal_43) && (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_43, false) && !PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_43, false)))
	{
...
int func_173(int iParam0, bool bParam1, int iParam2)//Position - 0x5B7A
{
	int iVar0;
...
int func_174(int iParam0, bool bParam1, bool bParam2)//Position - 0x5BC4
{
	int iVar0;
...
float func_175(bool bParam0, float fParam1, float fParam2)//Position - 0x5C68
{
	if (bParam0)
	{
		return fParam1;
...
bool func_177(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x5D3B
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
...
int func_178(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x5DFC
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_179(int iParam0, int iParam1)//Position - 0x5F28
{
	int iVar0;
...
int func_181(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x6037
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
void func_182(var uParam0)//Position - 0x60C8
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_183(int iParam0, int iParam1)//Position - 0x60E3
{
	int iVar0;
...
int func_184(int iParam0, int iParam1)//Position - 0x6122
{
	if (func_343(iParam0))
	{
...
void func_185(var uParam0)//Position - 0x6155
{
	...
	switch (uParam0->f_7)
	{
		...
		case 6:
			if (!func_184(*uParam0, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) && VEHICLE::IS_VEHICLE_STOPPED(iLocal_43))
			{
				if (bLocal_51)
				{
					uParam0->f_8 = uParam0->f_7;
	...
	switch (uParam0->f_9)
	{
		...
		case 2:
			...
			else if (!func_184(*uParam0, joaat("SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD")))
			{
				if (func_37(iLocal_43))
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 0f, -4.8f, 0f), 1f, -1, 0.25f, false, ENTITY::GET_ENTITY_HEADING(iLocal_43));
				}
				uParam0->f_9 = 3;
			}
			PED::SET_PED_CAPSULE(*uParam0, 0.2f);
...
void func_187(int* iParam0)//Position - 0x6805
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_196(var uParam0, bool bParam1)//Position - 0x6C74
{
	...
	if (func_191(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_137(bParam1)), iLocal_43, 1.9f, 1.9f, 8f))
	{
		...
		else if (!func_184(*uParam0, joaat("SCRIPT_TASK_GO_TO_ENTITY")) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_43, true) + Vector(2f, 0f, 0f), 9f, false, true, 0))
		{
			TASK::CLEAR_PED_TASKS(*uParam0);
			TASK::TASK_GO_TO_ENTITY(*uParam0, PLAYER::PLAYER_PED_ID(), -1, 4f, 1f, 2f, 0);
		}
	}
	else if (func_107(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_137(bParam1)), 5f, 1))
	{
		iVar0 = -1;
		if (!bParam1)
		{
...
void func_198(var uParam0)//Position - 0x6E77
{
	if (uParam0->f_5 != 1)
	{
		if (func_37(iLocal_43) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (!func_184(*uParam0, joaat("SCRIPT_TASK_DRIVE_BY")) && PED::IS_PED_IN_VEHICLE(*uParam0, iLocal_43, false))
			{
...
void func_199()//Position - 0x6F07
{
	...
	while (iVar0 <= (iLocal_41 - 1))
	{
		if (Local_46[iVar0 /*25*/].f_23 != 0)
		{
			...
			{
				if (func_107(PLAYER::PLAYER_PED_ID(), Local_46[iVar0 /*25*/], 100f, 1) || func_107(Local_45[0 /*11*/], Local_46[iVar0 /*25*/], 120f, 1))
				{
...
float func_201(int iParam0, int iParam1, bool bParam2)//Position - 0x7067
{
	struct<3> Var0;
	struct<3> Var1;
		...
		if (!func_343(Local_45[func_171(iParam1) /*11*/]))
		{
			if (!bLocal_52)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_45[func_171(iParam1) /*11*/]))
				{
					...
					{
						Local_54 = { ENTITY::GET_ENTITY_COORDS(Local_45[func_171(iParam1) /*11*/], true) };
						iParam0->f_1 = MISC::GET_GAME_TIMER();
						iParam0->f_8 = iParam0->f_7;
						iParam0->f_5 = 1;
						iParam0->f_6 = 11;
					...
					if (PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_43, false))
					{
						if (ENTITY::GET_ENTITY_SPEED(iLocal_43) > 5f)
						{
							...
							else
							{
								TASK::TASK_COWER(*iParam0, -1);
								iParam0->f_6 = 12;
								TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_45[func_171(iParam1) /*11*/], iLocal_43, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, true);
...
int func_204(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x7635
{
	struct<3> Var0;
...
int func_205(int iParam0, float fParam1)//Position - 0x76F0
{
	float fVar0;
...
bool func_206(int iParam0, float fParam1)//Position - 0x7766
{
	return func_177(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_207(int iParam0)//Position - 0x777E
{
...
bool func_208(int iParam0, int iParam1, float fParam2)//Position - 0x77A6
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_209(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x77ED
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_210(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x78E8
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_211(int iParam0, float fParam1)//Position - 0x79F4
{
	var uVar0;
	struct<3> Var1;
...
int func_212(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x7A89
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_214()//Position - 0x7B05
{
	if (func_37(Local_199.f_0))
	{
		if (func_157(PLAYER::PLAYER_PED_ID(), Local_199.f_0, 100f, 1) && !iLocal_194)
		{
		...
		else if (!func_157(PLAYER::PLAYER_PED_ID(), Local_199.f_0, 120f, 1) && iLocal_194)
		{
...
void func_215(int* iParam0, int iParam1, int iParam2, int* iParam3, int* iParam4, struct<3> Param5, int iParam6, bool bParam7, float fParam8)//Position - 0x7B7C
{
	if (func_37(*iParam0))
	{
		switch (*iParam2)
...
void func_216(int* iParam0, var uParam1)//Position - 0x7D30
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_217(int* iParam0)//Position - 0x7E1D
{
	int iVar0;
...
int func_218(int iParam0)//Position - 0x7E7A
{
	int iVar0;
...
int func_219(int iParam0)//Position - 0x7ED3
{
	int iVar0;
	int iVar1;
...
int func_220(int iParam0)//Position - 0x7F56
{
	int iVar0;
	int iVar1;
...
int func_223(int iParam0)//Position - 0x8163
{
	bool bVar0;
...
int func_224(int iParam0)//Position - 0x81B8
{
	bool bVar0;
...
int func_225(int iParam0, struct<3> Param1, int* iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)//Position - 0x81FE
{
			...
			else if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar2, true))
			{
				if (func_231(iVar2))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(iVar2, joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iVar2, joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 0)
					{
						...
						{
							PATHFIND::REQUEST_PATHS_PREFER_ACCURATE_BOUNDINGSTRUCT(623.3781f, -172.26f, 1700.732f, -2115.843f);
						}
					}
				}
...
int func_228(int iParam0, int iParam1)//Position - 0x850F
{
	bool bVar0;
...
float func_235(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x893F
{
	struct<3> Var0;
...
{
	if (func_107(PLAYER::PLAYER_PED_ID(), Local_186, 220f, 1))
	{
		if (!iLocal_203 && !func_107(PLAYER::PLAYER_PED_ID(), Local_186, 100f, 1))
		{
			iLocal_203 = func_153(&iLocal_202, joaat("cavalcade2"), 1370.912f, -2060.055f, 50.9983f, 312.8686f, 1);
		}
	}
	else if (func_107(PLAYER::PLAYER_PED_ID(), Local_186, 240f, 1))
	{
		if (iLocal_203)
		{
			func_6(&iLocal_202);
...
void func_239()//Position - 0x8A75
{
	...
	switch (iLocal_69)
	{
		...
		case 1:
			...
			if (!bLocal_190)
			{
				if (func_343(Local_197.f_0) && PED::IS_PED_BEING_JACKED(Local_197.f_0))
				{
					func_241();
				}
				if (func_343(Local_198.f_0) && PED::IS_PED_BEING_JACKED(Local_198.f_0))
				{
					func_241();
				}
			}
...
void func_240(bool bParam0)//Position - 0x8BCC
{
...
void func_242(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x8C79
{
	func_243(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_243(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x8C96
{
	func_244(uParam0, iParam1, Param2, sParam3, iParam4, bParam5, uParam6, bParam7);
}

void func_244(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x8CB4
{
...
void func_245(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x8CEC
{
	int iVar0;
	int iVar1;
...
void func_246(var uParam0)//Position - 0x9059
{
...
int func_247(var uParam0)//Position - 0x90C2
{
	int iVar0;
...
int func_248(bool bParam0)//Position - 0x90ED
{
	switch (Global_43052)
	{
		case 0:
...
void func_249(char* sParam0, int iParam1)//Position - 0x9197
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_250(char* sParam0)//Position - 0x91AE
{
	if (!func_251(1, 1, 0))
	{
...
int func_251(bool bParam0, bool bParam1, bool bParam2)//Position - 0x9247
{
	int iVar0;
	int iVar1;
...
int func_252(int iParam0)//Position - 0x94A0
{
	if (iParam0 != func_88())
	{
		...
		else if ((Global_1575058 && iParam0 == PLAYER::PLAYER_ID()) && func_253(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
int func_253(int iParam0, bool bParam1, bool bParam2)//Position - 0x9506
{
	int iVar0;
...
int func_254(int iParam0, int iParam1)//Position - 0x9566
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
...
int func_255(int iParam0, bool bParam1)//Position - 0x95C8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_256()//Position - 0x964D
{
	return Global_2714762.f_19;
}

bool func_257(int iParam0)//Position - 0x965B
{
	return iParam0 == 51;
}

var func_258()//Position - 0x9668
{
	return Global_2714762.f_18;
}

bool func_259()//Position - 0x9676
{
	return MISC::GET_GAME_TIMER() <= Global_23150.f_6269 + 100;
}

void func_260(var uParam0, int iParam1, struct<3> Param2, int iParam3)//Position - 0x968B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_261()//Position - 0x979B
{
	return func_262(PLAYER::PLAYER_ID());
}

int func_262(int iParam0)//Position - 0x97AB
{
...
int func_263(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x97CA
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_264(bool bParam0, bool bParam1, bool bParam2)//Position - 0x9B36
{
...
int func_265(bool bParam0, bool bParam1, bool bParam2)//Position - 0x9B88
{
	if (!func_251(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_266(bool bParam0, bool bParam1, bool bParam2)//Position - 0x9BD1
{
	if (!func_251(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_267(bool bParam0, bool bParam1, bool bParam2)//Position - 0x9C30
{
	if (!func_251(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_268(int iParam0)//Position - 0x9C86
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(iParam0))
...
void func_271()//Position - 0x9DB9
{
}

void func_272(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x9DC1
{
	int iVar0;
	int iVar1;
...
void func_273()//Position - 0x9E31
{
	Global_23011.f_6 = 1;
}

void func_274(int iParam0)//Position - 0x9E3F
{
	if (func_278())
	{
		return;
...
void func_275(int iParam0)//Position - 0x9E72
{
	if (func_278())
	{
		return;
...
void func_276(bool bParam0, bool bParam1)//Position - 0x9EFC
{
	if (bParam0)
	{
		if (func_69(0))
...
bool func_277()//Position - 0x9F70
{
	return BitTest(Global_1958711, 5);
}

bool func_278()//Position - 0x9F7E
{
	return BitTest(Global_1958711, 19);
}

void func_279(int iParam0, int iParam1, int iParam2)//Position - 0x9F8D
{
...
void func_280(int iParam0)//Position - 0xA051
{
	if (iParam0 == 1)
	{
...
var func_281()//Position - 0xA07A
{
	return BitTest(Global_100441.f_20, 13);
}

void func_282(int iParam0)//Position - 0xA08B
{
	Global_96296 = 0;
	switch (iParam0)
	{
...
void func_283(int iParam0)//Position - 0xA119
{
	MISC::SET_BIT(&Global_96296, iParam0);
}

void func_284()//Position - 0xA12B
{
	int iVar0;
...
void func_285(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0xA168
{
	struct<60> Var0;
...
void func_286(int iParam0, int iParam1, int iParam2)//Position - 0xA291
{
	int iVar0;
...
void func_287(int iParam0, int iParam1)//Position - 0xA3A8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_288(int iParam0)//Position - 0xA5AA
{
...
int func_289(int iParam0)//Position - 0xA687
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_290(int iParam0, bool bParam1)//Position - 0xA838
{
	int iVar0;
	struct<2> Var1;
...
int func_291(int iParam0)//Position - 0xA9B8
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_293(int iParam0)//Position - 0xAA9B
{
	int iVar0;
	int iVar1;
...
bool func_294()//Position - 0xDD6C
{
	return (MISC::IS_ORBIS_VERSION() || MISC::_0x807ABE1AB65C24D2());
}

bool func_295()//Position - 0xDD82
{
	return (MISC::IS_DURANGO_VERSION() || MISC::_0xC545AB1CF97ABB34());
}

int func_296()//Position - 0xDD98
{
	return 0;
}

int func_297()//Position - 0xDDA1
{
	return 1;
}

int func_298()//Position - 0xDDAA
{
	return 1;
}

int func_299()//Position - 0xDDB3
{
...
int func_301(int iParam0)//Position - 0xDE84
{
	int iVar0;
	char* sVar1;
...
int func_302(int iParam0)//Position - 0xDECA
{
	int iVar0;
...
int func_303(int iParam0)//Position - 0xDF05
{
	int iVar0;
...
int func_304(int iParam0)//Position - 0xDF81
{
	int iVar0;
...
int func_305(int iParam0, int iParam1, bool bParam2)//Position - 0xE069
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_306(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0xE0D7
{
...
int func_307(int iParam0)//Position - 0xE1AF
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_309(var uParam0, int iParam1)//Position - 0xE211
{
	if (iParam1 <= 0)
	{
		return;
...
void func_310(var uParam0, int iParam1)//Position - 0xE297
{
...
void func_311(var uParam0, int iParam1)//Position - 0xE2CA
{
	int iVar0;
	int iVar1;
...
int func_312(int iParam0, int iParam1)//Position - 0xE31B
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_313(int iParam0)//Position - 0xE3BD
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_314(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_314(bool bParam0, int iParam1, int iParam2)//Position - 0xE3DF
{
	if (bParam0)
	{
		return iParam1;
...
int func_315(var uParam0)//Position - 0xE3F6
{
	return uParam0 & 15;
}

void func_316(var uParam0, int iParam1)//Position - 0xE403
{
...
void func_317(var uParam0, int iParam1)//Position - 0xE43D
{
...
void func_318(var uParam0, int iParam1)//Position - 0xE478
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_319(var uParam0, int iParam1)//Position - 0xE4B4
{
	int iVar0;
	int iVar1;
...
int func_320(int iParam0, int iParam1)//Position - 0xFBA2
{
	struct<82> Var0;
...
void func_321(int iParam0, var uParam1, int iParam2)//Position - 0xFBE4
{
	int iVar0;
...
void func_322(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0xFE40
{
	if (func_319(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_323(int iParam0, bool bParam1)//Position - 0xFF39
{
	if (iParam0 == -1)
	{
		return;
...
void func_324(int iParam0, int iParam1, bool bParam2)//Position - 0xFF96
{
	if (iParam0 == -1)
	{
		return;
...
int func_325(int iParam0, int iParam1)//Position - 0xFFD1
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_326(var uParam0, var uParam1)//Position - 0xFFF1
{
...
void func_327(int iParam0)//Position - 0x100BF
{
	if (iParam0 == -1)
	{
		return;
...
int func_328(int iParam0)//Position - 0x10136
{
	int iVar0;
...
void func_329(int iParam0, var uParam1)//Position - 0x10199
{
	int iVar0;
...
int func_330(int iParam0)//Position - 0x10444
{
	switch (iParam0)
	{
		case 1:
...
int func_331(int iParam0, var uParam1, var uParam2)//Position - 0x104F4
{
	int iVar0;
	int iVar1;
...
int func_332(int iParam0)//Position - 0x106E7
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_333(var uParam0)//Position - 0x10707
{
	int iVar0;
...
void func_334(int iParam0)//Position - 0x107B7
{
...
void func_337(int iParam0, bool bParam1)//Position - 0x10866
{
	int iVar0;
...
void func_338()//Position - 0x108B0
{
}
...
void func_340()//Position - 0x108DB
{
	...
	if (!func_37(iLocal_200))
	{
		...
		if (func_37(Local_199.f_0) && !func_157(PLAYER::PLAYER_PED_ID(), Local_199.f_0, fVar0, 1))
		{
			func_342(2);
		}
	}
	else
	{
		...
		if (func_37(Local_199.f_0))
		{
			if (!func_157(PLAYER::PLAYER_PED_ID(), Local_199.f_0, fVar0, 1))
			{
				iVar1++;
			}
		}
...
int func_341(int iParam0)//Position - 0x10A21
{
	if (func_37(iParam0))
	{
...
int func_343(int iParam0)//Position - 0x10AD4
{
	if (func_10(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_344()//Position - 0x10AF4
{
	if (!func_102(36))
	{
		func_345(21, 0, 0);
...
void func_345(int iParam0, bool bParam1, int iParam2)//Position - 0x10B0E
{
	if (bParam1)
	{
...
void func_346(int iParam0)//Position - 0x10BCD
{
	Global_100493.f_196[iParam0] = 1;
	Global_100493.f_195 = 1;
}

void func_347(int iParam0, int iParam1, bool bParam2)//Position - 0x10BE7
{
	int iVar0;
...
void func_348(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x10C59
{
	int iVar0;
...
int func_349(var uParam0)//Position - 0x10C89
{
	int iVar0;
	int iVar1;
...
int func_350(int iParam0, int iParam1, int iParam2)//Position - 0x10CBD
{
	int iVar0;
	var uVar1;
...
int func_351(int iParam0)//Position - 0x10CFA
{
	switch (iParam0)
	{
		case 0:
...
int func_352()//Position - 0x11075
{
	return Global_31959;
}

void func_353(int iParam0, int iParam1, bool bParam2)//Position - 0x11080
{
	int iVar0;
...
void func_354(int iParam0)//Position - 0x110F2
{
...
bool func_355(int iParam0)//Position - 0x11119
{
	return func_357(iParam0, 5, 1);
}

int func_356(int iParam0)//Position - 0x11129
{
	switch (iParam0)
	{
		case -1:
...
int func_357(int iParam0, int iParam1, bool bParam2)//Position - 0x11438
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_358(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x11499
{
	if (func_359())
	{
...
void func_368(var uParam0, var uParam1, float fParam2)//Position - 0x11F79
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_369(var uParam0, struct<2> Param1, Vector3 vParam2)//Position - 0x12086
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_370(var uParam0)//Position - 0x12142
{
	int iVar0;
	float fVar1;
...
void func_371(var uParam0, struct<3> Param1)//Position - 0x121E2
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_372(var uParam0)//Position - 0x12213
{
	if (uParam0->f_51)
	{
	}
...
struct<6> func_376(struct<3> Param0, float fParam1, int iParam2)//Position - 0x122D5
{
	struct<6> Var0;
...
void func_380()//Position - 0x1245C
{
	Global_20471 = 0;
	func_381();
}

void func_381()//Position - 0x1246C
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22616 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_382()//Position - 0x1248D
{
}
...
void func_384()//Position - 0x124AC
{
}
...
void func_386()//Position - 0x124C5
{
	func_345(21, 1, 0);
}

void func_387()//Position - 0x124D5
{
	Global_96296 = 0;
}

void func_388(int iParam0)//Position - 0x124E2
{
