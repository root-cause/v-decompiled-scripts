...
int func_41(int iParam0)//Position - 0x2991
{
	if (iParam0 == 1)
	{
...
void func_45(int iParam0)//Position - 0x2B22
{
...
void func_47(int iParam0)//Position - 0x2B93
{
	if (iParam0 != 0)
	{
...
void func_52(int* iParam0)//Position - 0x2C93
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_54(int* iParam0)//Position - 0x2CFD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
