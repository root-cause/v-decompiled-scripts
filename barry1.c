...
bool func_45()//Position - 0x18AC
{
	return BitTest(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

bool func_46(int iParam0, int iParam1)//Position - 0x18C6
{
	bool bVar0;
...
int func_47(int iParam0, bool bParam1)//Position - 0x191F
{
	int iVar0;
	int iVar1;
...
int func_48()//Position - 0x1960
{
	return Global_1574926;
}

int func_49(var uParam0)//Position - 0x196C
{
	int iVar0;
...
int func_50(int iParam0)//Position - 0x198E
{
...
bool func_51()//Position - 0x19CD
{
	return BitTest(Global_2621446, 3);
}

int func_52(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x19DB
{
	int iVar0;
...
void func_53(int iParam0)//Position - 0x1A0E
{
	if (iParam0 == 1)
	{
...
void func_54(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x1A31
{
	int iVar0;
...
int func_55(int iParam0)//Position - 0x1ADB
{
	if (func_581(iParam0))
	{
...
void func_56(struct<3> Param0, float fParam3)//Position - 0x1AFB
{
	func_57(&(Global_107514.f_2890), Param0, fParam3);
}

void func_57(var uParam0, struct<3> Param1, var uParam4)//Position - 0x1B14
{
	*uParam0 = { Param1 };
	uParam0->f_6 = uParam4;
}

void func_58(struct<3> Param0, float fParam3)//Position - 0x1B2A
{
...
bool func_59(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x1B56
{
	if (bParam6)
	{
...
void func_61(bool bParam0)//Position - 0x1BCA
{
	int iVar0;
...
void func_62(var uParam0, bool bParam1)//Position - 0x1BF6
{
	if (*uParam0 == 0)
	{
		return;
...
void func_63(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1C1E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_64(var uParam0)//Position - 0x1C6E
{
	if (func_68(uParam0))
	{
		iLocal_556 = 0;
...
void func_65(var uParam0)//Position - 0x1CBF
{
...
void func_66(var uParam0)//Position - 0x1CEF
{
	if (*uParam0 != 0)
	{
...
void func_67(var uParam0)//Position - 0x1D1F
{
	if (*uParam0 != -1)
	{
...
bool func_68(var uParam0)//Position - 0x1D40
{
	return (uParam0->f_1 == 10 || uParam0->f_1 == 11);
}

void func_69()//Position - 0x1D5C
{
	int iVar0;
...
void func_71(int iParam0)//Position - 0x1DF1
{
	int iVar0;
...
void func_74(var uParam0)//Position - 0x215A
{
	if (*uParam0 == 0)
	{
		return;
...
void func_75(int* iParam0)//Position - 0x217E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_76(var uParam0, float fParam1)//Position - 0x21BF
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (uParam0->f_15 && !uParam0->f_16)
	{
		if (CAM::DOES_CAM_EXIST(uParam0->f_9))
		{
			...
			if (!Global_23692.f_111)
			{
				...
				{
					Global_23692.f_109 = AUDIO::GET_SOUND_ID();
					Global_23692.f_110 = MISC::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME());
				}
				AUDIO::PLAY_SOUND(Global_23692.f_109, "CHARACTER_CHANGE_SKY_MASTER", 0, false, 0, true);
	...
	if (uParam0->f_17)
	{
		...
		uParam0->f_24 = 0;
		uParam0->f_27 = 0;
		if (Global_23692.f_109 != -1 && Global_23692.f_110 == MISC::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()))
		{
			AUDIO::STOP_SOUND(Global_23692.f_109);
			AUDIO::RELEASE_SOUND_ID(Global_23692.f_109);
...
void func_77(int iParam0)//Position - 0x27F7
{
	Global_23690 = iParam0;
}

float func_78(int iParam0)//Position - 0x2804
{
	struct<3> Var0;
...
float func_79(float fParam0, float fParam1, float fParam2)//Position - 0x2827
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
int func_80()//Position - 0x284E
{
	return Global_2621446.f_2;
}

void func_81(int iParam0, int iParam1, int iParam2)//Position - 0x285C
{
	if (*iParam2 >= 8)
	{
		return;
...
void func_82(int iParam0)//Position - 0x2880
{
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		if (func_581(PLAYER::PLAYER_PED_ID()))
...
void func_84(int iParam0, bool bParam1)//Position - 0x2CB5
{
	int iVar0;
	char* sVar1;
...
void func_86(int iParam0, int iParam1, int iParam2)//Position - 0x2E34
{
	bool bVar0;
...
int func_88()//Position - 0x33D8
{
	return Global_32948;
}

int func_89(int iParam0, int iParam1)//Position - 0x33E3
{
	int iVar0;
...
void func_90(int iParam0, bool bParam1, int iParam2)//Position - 0x3434
{
	if (iParam2 == -1)
	{
		iParam2 = func_48();
...
void func_92(int iParam0)//Position - 0x34AB
{
	if (iParam0 == 1)
	{
...
void func_94()//Position - 0x34F2
{
	StringCopy(&Global_79622, "", 16);
	StringCopy(&Global_79626, "", 16);
}

void func_95()//Position - 0x350A
{
	int iVar0;
...
void func_99(int iParam0)//Position - 0x35DC
{
	if (iParam0 == 1)
	{
		Global_44591 = 1;
...
void func_100()//Position - 0x35F5
{
	func_101(&Global_107514);
}

void func_101(var uParam0)//Position - 0x3605
{
	int iVar0;
	int iVar1;
...
void func_102(var uParam0)//Position - 0x3B95
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_103(var uParam0)//Position - 0x3BB0
{
...
void func_104(var uParam0)//Position - 0x3BDF
{
	int iVar0;
...
void func_105(var uParam0)//Position - 0x3C8E
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_106(var uParam0)//Position - 0x3CAC
{
	int iVar0;
...
void func_107(var uParam0)//Position - 0x3D8B
{
	*uParam0 = -15;
}

void func_108()//Position - 0x3D99
{
	StringCopy(&Global_104522, "", 32);
	func_101(&Global_104530);
}

void func_109()//Position - 0x3DB1
{
...
int func_111(int iParam0, int iParam1, int iParam2)//Position - 0x3EEF
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	else
	{
		...
		Global_79172[1 /*14*/] = { func_164(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_156(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_156(iParam1), Global_79172[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_156(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, 0);
		}
	}
...
int func_112(int iParam0, int iParam1, int iParam2)//Position - 0x40AE
{
	int iVar0;
...
int func_113(int iParam0)//Position - 0x414F
{
	switch (iParam0)
	{
...
int func_114(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x418A
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_79172[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_79172[1 /*14*/] = { func_164(iVar10, 14, uVar28[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_156(iVar0), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_156(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_156(iVar0), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
						}
						func_146(iVar0);
						if (Global_79170 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_79172[1 /*14*/] = { func_164(iVar10, 14, uVar69[iVar1], -1) };
			func_130(iParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
			func_146(14);
			if (Global_79170 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_156(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_156(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_156(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
		}
		if (Global_79170 == 1)
		{
			iVar2 = 0;
...
void func_115(int iParam0, int iParam1, int iParam2)//Position - 0x499B
{
	int iVar0;
	int iVar1;
...
int func_116(int iParam0, int iParam1, int iParam2)//Position - 0x4A25
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_117(int iParam0, int iParam1, int iParam2)//Position - 0x4B03
{
	Global_79172[1 /*14*/] = { func_164(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_79172[1 /*14*/].f_6, 2);
}

int func_118(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x4B2B
{
	var uVar0;
	int iVar10;
...
int func_119(int iParam0, int iParam1, int iParam2)//Position - 0x512F
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0x51C8
{
	int iVar0;
	int iVar1;
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5269
{
	int iVar0;
...
int func_122(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x5570
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_123(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x6123
{
	int iVar0;
...
int func_124(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6407
{
	int iVar0;
...
int func_125(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x66CE
{
	int iVar0;
	int iVar1;
...
int func_126(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6705
{
	int iVar0;
...
int func_127(int iParam0, int iParam1, int iParam2)//Position - 0x672E
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_128(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x69F8
{
	int iVar0;
...
int func_129(int iParam0, int iParam1, int iParam2)//Position - 0x6C82
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_130(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6DD9
{
	int iVar0;
...
int func_131(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6E73
{
	switch (iParam0)
	{
...
int func_132(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6F41
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_133(int iParam0, int iParam1)//Position - 0x705B
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_134(int iParam0)//Position - 0x7402
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_135(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7463
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_136(int iParam0, int iParam1)//Position - 0x755F
{
	int iVar0;
...
int func_137(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x769D
{
	struct<2> Var0;
	int iVar15;
	int iVar16;
...
int func_138(int iParam0)//Position - 0x7758
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_139(int iParam0)//Position - 0x77B7
{
	switch (iParam0)
	{
		case 0:
...
int func_140(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x783D
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_141(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7ABA
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_142(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7EDF
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_143(int iParam0, int iParam1)//Position - 0x81D3
{
	int iVar0;
	int iVar1;
...
int func_144(int iParam0, int iParam1)//Position - 0x821A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_145(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x827A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_146(int iParam0)//Position - 0x82D1
{
...
void func_147(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x837D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_148(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x83C5
{
	int iVar0;
...
int func_149(int iParam0, var uParam1)//Position - 0x83F3
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_150(uParam1));
}

int func_150(var uParam0)//Position - 0x8408
{
	int iVar0;
	int iVar1;
...
int func_151(int iParam0, int iParam1)//Position - 0x843C
{
	int iVar0;
	var uVar1;
...
bool func_152(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x846B
{
	int iVar0;
...
int func_153(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xAFEC
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_154(int iParam0)//Position - 0xBE8F
{
	if (!BitTest(Global_79172[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_155(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBED7
{
	int iVar0;
...
int func_156(int iParam0)//Position - 0xBF82
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_157(int iParam0, int iParam1)//Position - 0xC032
{
	int iVar0;
	struct<10> Var1;
...
void func_158(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC961
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_159(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xCA8B
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_160(int iParam0, int iParam1)//Position - 0xCAD3
{
	int iVar0;
	struct<17> Var1;
...
void func_161(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE91B
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
int func_162(int iParam0)//Position - 0xEB05
{
	switch (iParam0)
	{
		case 0:
...
void func_163(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xEBB5
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_164(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEC26
{
	func_227();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_165(int iParam0, int iParam1)//Position - 0xEC78
{
	switch (iParam0)
	{
		case 0:
...
void func_166(int iParam0)//Position - 0xED68
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_167(&(Global_79172[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_167(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xFFDF
{
	var uVar0;
	int iVar1;
...
bool func_168(int iParam0, int iParam1, var uParam2)//Position - 0x10383
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_169(int iParam0, int iParam1)//Position - 0x10788
{
	switch (iParam1)
	{
		case 0:
...
int func_170(int iParam0, int iParam1)//Position - 0x10B83
{
	switch (iParam1)
	{
		case 0:
...
int func_171(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x10F7E
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_172(int iParam0)//Position - 0x10FBC
{
	switch (iParam0)
	{
		case -1:
...
void func_173(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11090
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_167(&(Global_79172[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_167(&(Global_79172[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_174(int iParam0)//Position - 0x11317
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x1146E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x1197C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x119F1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x11A65
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x11B4C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x11EAF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x120C0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x122F0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x12400
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x12D9F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185(int iParam0)//Position - 0x13912
{
	if (iParam0 < 136)
	{
		func_187(iParam0);
...
void func_186(int iParam0)//Position - 0x13947
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_187(int iParam0)//Position - 0x1454C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_188(int iParam0)//Position - 0x1545A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_189(int iParam0)//Position - 0x15587
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_190(int iParam0, int iParam1)//Position - 0x15685
{
	switch (iParam0)
	{
		case 0:
...
void func_191(int iParam0)//Position - 0x15775
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_192(int iParam0)//Position - 0x16C66
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_193(int iParam0)//Position - 0x16DB7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_194(int iParam0)//Position - 0x172C2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_195(int iParam0)//Position - 0x17930
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_196(int iParam0)//Position - 0x179A4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_197(int iParam0)//Position - 0x17A74
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_198(int iParam0)//Position - 0x17FA4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_199(int iParam0)//Position - 0x1816F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_200(int iParam0)//Position - 0x1896D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_201(int iParam0)//Position - 0x18A7D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_202(int iParam0)//Position - 0x199A8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_203(int iParam0)//Position - 0x1A665
{
	if (iParam0 < 107)
	{
		func_206(iParam0);
...
void func_204(int iParam0)//Position - 0x1A6AB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_205(int iParam0)//Position - 0x1B150
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_206(int iParam0)//Position - 0x1BF3F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
int func_228(int iParam0, int iParam1, int iParam2)//Position - 0x225F9
{
	...
	else if (Global_79172[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_156(iParam1)) && Global_79172[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_156(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_235(int iParam0, bool bParam1, bool bParam2)//Position - 0x22E51
{
	...
	if (iParam0 != -1)
	{
		...
		func_236(&sVar32, Var0.f_3, Global_101570, bParam1, bParam2);
	}
}
...
void func_241()//Position - 0x24433
{
	...
	{
		func_30();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_242(Global_113969.f_2366.f_539.f_4321));
	}
	else
	{
...
void func_243()//Position - 0x24472
{
	...
	else if (MISC::IS_PS3_VERSION() || func_244())
	{
...
bool func_244()//Position - 0x244B5
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_245()//Position - 0x244CB
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_246(int iParam0, int iParam1)//Position - 0x244E1
{
	Global_98820 = iParam0;
	Global_98821 = iParam1;
}

void func_247()//Position - 0x244F5
{
	if (Global_79644 != 6)
	{
	}
...
void func_248(var uParam0)//Position - 0x2452D
{
	if (*uParam0 == -1)
	{
		return;
...
void func_249(int iParam0, bool bParam1)//Position - 0x2456A
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_250(int iParam0)//Position - 0x246E6
{
	switch (iParam0)
	{
		case 0:
...
void func_251(int iParam0)//Position - 0x24A6D
{
	func_253(iParam0, 1);
...
int func_252()//Position - 0x24AA3
{
	return (Global_113969.f_10019.f_21 + Global_113969.f_18577.f_380);
}

void func_253(var uParam0, bool bParam1)//Position - 0x24ABF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_254(int iParam0)//Position - 0x24DE3
{
...
void func_255(int iParam0)//Position - 0x24E16
{
	switch (iParam0)
	{
		case 30:
...
void func_256(int iParam0, bool bParam1)//Position - 0x24E4B
{
	if (iParam0 == -1)
	{
		return;
...
void func_257(int iParam0, int iParam1, bool bParam2)//Position - 0x24EA8
{
	if (iParam0 == -1)
	{
		return;
...
int func_258(int iParam0, int iParam1)//Position - 0x24EE3
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_259(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x24F03
{
	if (iParam0 != 198)
	{
		if (Global_79389)
...
void func_260(int iParam0, int iParam1)//Position - 0x24F5B
{
	switch (iParam0)
	{
		case 12:
...
void func_261(int iParam0, bool bParam1)//Position - 0x25044
{
	if (bParam1)
	{
...
bool func_262(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x2506D
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_264()//Position - 0x259D6
{
	return Global_32949;
}

int func_265(var uParam0, int iParam1)//Position - 0x259E1
{
	int iVar0;
...
int func_266(int iParam0)//Position - 0x290D9
{
	switch (iParam0)
	{
		case 46:
...
void func_267(int iParam0, bool bParam1)//Position - 0x291C8
{
	switch (iParam0)
	{
		case 46:
...
void func_268(int iParam0, bool bParam1)//Position - 0x29219
{
	int iVar0;
...
void func_269(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2927F
{
	func_270(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_270(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2929F
{
	int iVar0;
...
void func_271()//Position - 0x29471
{
	int iVar0;
...
int func_272(int iParam0)//Position - 0x29588
{
	int iVar0;
	int iVar1;
...
void func_273(char* sParam0)//Position - 0x295C8
{
...
char* func_274(int iParam0)//Position - 0x295EB
{
	switch (iParam0)
	{
		case 0:
...
int func_275(int iParam0)//Position - 0x297BE
{
...
void func_276(int iParam0, int iParam1)//Position - 0x297E8
{
...
int func_277(char* sParam0)//Position - 0x29825
{
	int iVar0;
...
int func_278()//Position - 0x29885
{
	return func_279(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_279(char* sParam0, int iParam1)//Position - 0x29896
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
Vector3 func_280(int iParam0, struct<3> Param1)//Position - 0x298DF
{
	var uVar0;
...
void func_281(bool bParam0, int iParam1, int iParam2)//Position - 0x29925
{
	bool bVar0;
...
void func_282(int iParam0, bool bParam1)//Position - 0x29984
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
void func_283(int* iParam0, int iParam1)//Position - 0x299B6
{
	struct<3> Var0;
	float fVar3;
...
void func_284(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x299E6
{
	func_14(iParam0);
...
void func_285(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x29A0D
{
	int iVar0;
...
Vector3 func_286(int iParam0)//Position - 0x29BCB
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_287(int iParam0, bool bParam1)//Position - 0x29BDE
{
	if (CAM::IS_SCREEN_FADED_OUT() || CAM::IS_SCREEN_FADING_OUT())
	{
		if (!CAM::IS_SCREEN_FADING_IN())
...
void func_288()//Position - 0x29C1A
{
	if (iLocal_927)
	{
		return;
...
void func_289(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x29CB0
{
	struct<60> Var0;
...
void func_290(int iParam0, int iParam1, int iParam2)//Position - 0x29DD9
{
	int iVar0;
...
void func_291(int iParam0, int iParam1)//Position - 0x29EF0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_292(int iParam0)//Position - 0x2A0F2
{
...
int func_293(int iParam0)//Position - 0x2A1CF
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_294(int iParam0, bool bParam1, int iParam2)//Position - 0x2A38D
{
	int iVar0;
	struct<2> Var1;
...
int func_295(int iParam0)//Position - 0x2A512
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_297(int iParam0, int iParam1)//Position - 0x2A5F5
{
	int iVar0;
	int iVar1;
...
int func_298()//Position - 0x2A846
{
	return 0;
}

int func_299()//Position - 0x2A84F
{
	return 1;
}

int func_300()//Position - 0x2A858
{
	return 1;
}

int func_301()//Position - 0x2A861
{
...
int func_303(int iParam0)//Position - 0x2A932
{
	int iVar0;
	char* sVar1;
...
int func_304(int iParam0)//Position - 0x2A979
{
	int iVar0;
...
int func_305(int iParam0)//Position - 0x2A9B4
{
	int iVar0;
...
int func_306(int iParam0)//Position - 0x2AA30
{
	int iVar0;
...
int func_307(int iParam0, int iParam1, bool bParam2)//Position - 0x2AB18
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_308(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2AB86
{
...
int func_309(int iParam0)//Position - 0x2AC5D
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_311(var uParam0, int iParam1)//Position - 0x2ACBF
{
	if (iParam1 <= 0)
	{
		return;
...
void func_312(var uParam0, int iParam1)//Position - 0x2AD45
{
...
void func_313(var uParam0, int iParam1)//Position - 0x2AD78
{
	int iVar0;
	int iVar1;
...
int func_314(int iParam0, int iParam1)//Position - 0x2ADC9
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_315(int iParam0)//Position - 0x2AE6B
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_316(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_316(bool bParam0, int iParam1, int iParam2)//Position - 0x2AE8D
{
	if (bParam0)
	{
		return iParam1;
...
int func_317(var uParam0)//Position - 0x2AEA4
{
	return uParam0 & 15;
}

void func_318(var uParam0, int iParam1)//Position - 0x2AEB1
{
...
void func_319(var uParam0, int iParam1)//Position - 0x2AEEB
{
...
void func_320(var uParam0, int iParam1)//Position - 0x2AF26
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_321(var uParam0, int iParam1)//Position - 0x2AF62
{
	int iVar0;
	int iVar1;
...
int func_322(int iParam0, int iParam1)//Position - 0x2C651
{
	struct<82> Var0;
...
void func_323(int iParam0, var uParam1, int iParam2)//Position - 0x2C693
{
	int iVar0;
...
void func_324(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x2C8EF
{
	if (func_321(&(Global_78179.f_555[0 /*21*/]), iParam0))
	{
...
void func_325(var uParam0, var uParam1)//Position - 0x2C9E8
{
...
void func_326(int iParam0)//Position - 0x2CAB4
{
	if (iParam0 == -1)
	{
		return;
...
int func_327(int iParam0)//Position - 0x2CB2B
{
	int iVar0;
...
void func_328(int iParam0, var uParam1)//Position - 0x2CB8E
{
	int iVar0;
...
int func_329(int iParam0)//Position - 0x2CE39
{
	switch (iParam0)
	{
		case 1:
...
int func_330(int iParam0, var uParam1, var uParam2)//Position - 0x2CEE9
{
	int iVar0;
	int iVar1;
...
int func_331(int iParam0)//Position - 0x2D0DC
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_332(int iParam0)//Position - 0x2D0FC
{
...
bool func_333(struct<3> Param0, int iParam3)//Position - 0x2D123
{
	return func_334(Global_104530.f_2890.f_12.f_66, Param0, iParam3);
}

int func_334(int iParam0, struct<3> Param1, int iParam4)//Position - 0x2D140
{
	struct<3> Var0;
	struct<3> Var3;
...
Vector3 func_335()//Position - 0x2D1AA
{
	return 2.55f, 5.665f, 2.55f;
}

int func_336()//Position - 0x2D1C1
{
	return Global_104530.f_4;
}

void func_337()//Position - 0x2D1CF
{
...
int func_338(int iParam0, float fParam1, int iParam2)//Position - 0x2D242
{
	int iVar0;
...
bool func_339()//Position - 0x2D316
{
	bool bVar0;
...
void func_340()//Position - 0x2D339
{
	Global_21152 = 0;
	func_38();
}

int func_341()//Position - 0x2D349
{
...
void func_342()//Position - 0x2D36B
{
...
int func_343(int iParam0, int iParam1)//Position - 0x2D3BC
{
	if (func_55(iParam0))
	{
...
int func_344(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2D3EF
{
...
void func_345(int iParam0)//Position - 0x2D446
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_346(bool bParam0, bool bParam1)//Position - 0x2D472
{
...
void func_347(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x2D5C3
{
	int iVar0;
	int iVar1;
...
void func_348()//Position - 0x2D633
{
	Global_23692.f_6 = 1;
}

void func_349(int iParam0)//Position - 0x2D641
{
	switch (*iParam0)
	{
		case 0:
...
void func_350(int iParam0)//Position - 0x2D69A
{
	switch (*iParam0)
	{
		case 0:
...
void func_351()//Position - 0x2D78A
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		return;
...
int func_353(var uParam0, int iParam1)//Position - 0x2D852
{
...
int func_355(var uParam0)//Position - 0x2D8C1
{
	int iVar0;
	int iVar1;
...
bool func_356(char* sParam0, int iParam1, char* sParam2)//Position - 0x2D8E4
{
...
void func_357()//Position - 0x2D902
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
int func_358(var uParam0)//Position - 0x2DA28
{
	if (iLocal_179 == 0)
	{
		return 0;
...
int func_359(var uParam0, bool bParam1)//Position - 0x2DA82
{
	struct<3> Var0;
	float fVar3;
...
bool func_360(struct<3> Param0, float fParam3, int iParam4, bool bParam5)//Position - 0x2DB48
{
	return MISC::IS_POSITION_OCCUPIED(Param0, fParam3, false, false, true, false, false, iParam4, bParam5);
}

bool func_361(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2DB63
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

Vector3 func_362(struct<3> Param0, float fParam3, float fParam4)//Position - 0x2DB81
{
	struct<3> Var0;
	float fVar3;
...
Vector3 func_363(struct<3> Param0, float fParam3)//Position - 0x2DBC9
{
	float fVar0;
...
void func_364(var uParam0)//Position - 0x2DC00
{
...
int func_365(var uParam0, struct<3> Param1, int iParam4, bool bParam5)//Position - 0x2DC35
{
	if (bParam5)
	{
...
float func_366(int iParam0, int iParam1, bool bParam2)//Position - 0x2DEA7
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_367(int iParam0)//Position - 0x2DF05
{
	float fVar0;
...
float func_368(struct<2> Param0, Vector3 vParam2, struct<2> Param3, Vector3 vParam5, int iParam6)//Position - 0x2DF2C
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_369(var uParam0, float fParam1)//Position - 0x2DF91
{
	float fVar0;
	struct<3> Var1;
...
int func_370(var uParam0)//Position - 0x2DFD1
{
	int iVar0;
	int iVar1;
	struct<3> Var2[9];
...
void func_371(int iParam0, int iParam1, struct<3> Param2)//Position - 0x2E06F
{
	*(iParam0[iParam1 /*3*/]) = { Param2 };
}

void func_372(var uParam0)//Position - 0x2E083
{
	int iVar0;
...
int func_373(int iParam0)//Position - 0x2E0AA
{
	int iVar0;
...
void func_374(int iParam0)//Position - 0x2E0E2
{
	int iVar0;
...
int func_375(int iParam0)//Position - 0x2E173
{
	int iVar0;
...
int func_376(int iParam0)//Position - 0x2E1B7
{
	int iVar0;
...
int func_377(int iParam0)//Position - 0x2E1EF
{
	if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		return 0;
...
void func_378(int iParam0)//Position - 0x2E22C
{
	switch (*iParam0)
	{
		case 0:
...
int func_379(int* iParam0, float fParam1)//Position - 0x2E317
{
...
void func_380(var uParam0)//Position - 0x2E335
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
int func_381(var uParam0, float fParam1)//Position - 0x2E34B
{
	if (func_385(uParam0))
	{
...
float func_382(var uParam0)//Position - 0x2E36D
{
	if (func_385(uParam0))
	{
		if (func_384(uParam0))
...
float func_383(bool bParam0)//Position - 0x2E3A9
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_384(var uParam0)//Position - 0x2E401
{
	return BitTest(*uParam0, 2);
}

bool func_385(var uParam0)//Position - 0x2E40E
{
	return BitTest(*uParam0, 1);
}

void func_386(int* iParam0)//Position - 0x2E41B
{
	if (!func_385(iParam0))
	{
		func_387(iParam0);
...
void func_387(int* iParam0)//Position - 0x2E433
{
	func_388(iParam0, 0f);
}

void func_388(int* iParam0, float fParam1)//Position - 0x2E442
{
...
void func_389(int iParam0)//Position - 0x2E46D
{
	int iVar0;
...
void func_390(struct<3> Param0, float fParam3, int iParam4, bool bParam5)//Position - 0x2E6B2
{
	int iVar0;
	struct<3> Var1;
...
int func_391(struct<3> Param0, float fParam3, var uParam4)//Position - 0x2E734
{
	if (iLocal_179 == 0)
	{
		return 0;
...
void func_392()//Position - 0x2E75C
{
	struct<2> Var0;
...
void func_393(int iParam0, int iParam1)//Position - 0x2E7C5
{
	int iVar0;
...
void func_394(int iParam0)//Position - 0x2E830
{
	int iVar0;
...
void func_395()//Position - 0x2E8CC
{
	iLocal_34 = MISC::GET_GAME_TIMER();
}

void func_396(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2E8DA
{
...
void func_397(var uParam0, bool bParam1)//Position - 0x2E8FA
{
	func_398(&(uParam0->f_41), bParam1);
}

void func_398(var uParam0, bool bParam1)//Position - 0x2E90C
{
	int iVar0;
...
void func_399(int* iParam0, bool bParam1)//Position - 0x2E94A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_400(var uParam0, bool bParam1)//Position - 0x2E985
{
	func_401(&(uParam0->f_35), bParam1);
}

void func_401(var uParam0, bool bParam1)//Position - 0x2E997
{
	int iVar0;
...
void func_402(int* iParam0)//Position - 0x2E9D4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_403(int* iParam0)//Position - 0x2EA0C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_404(int iParam0)//Position - 0x2EAA8
{
	if (func_581(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_405(var uParam0, int iParam1)//Position - 0x2EAD2
{
	func_406(&(uParam0->f_28), iParam1);
}

void func_406(var uParam0, int iParam1)//Position - 0x2EAE4
{
	int iVar0;
...
void func_407(var uParam0, bool bParam1, bool bParam2)//Position - 0x2EB25
{
	int iVar0;
...
void func_408()//Position - 0x2EC1A
{
	func_41(&uLocal_388, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
...
void func_409()//Position - 0x2EC6C
{
...
int func_410(var uParam0, int iParam1)//Position - 0x2ECED
{
...
void func_411(var uParam0)//Position - 0x2ED2E
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_412(var uParam0, int iParam1, char* sParam2, int iParam3)//Position - 0x2ED53
{
	if (BitTest(uParam0->f_113, iParam1) || BitTest(uParam0->f_114, iParam1))
	{
		return 1;
...
int func_413(var uParam0, int iParam1, int iParam2)//Position - 0x2ED9D
{
	if (BitTest(uParam0->f_113, iParam1) || BitTest(uParam0->f_114, iParam1))
	{
		return 1;
...
int func_414(var uParam0, int iParam1, int iParam2, char* sParam3, char* sParam4)//Position - 0x2EDE6
{
	if (BitTest(uParam0->f_113, iParam1) || BitTest(uParam0->f_114, iParam1))
	{
		return 1;
...
int func_415(var uParam0, int iParam1, int iParam2)//Position - 0x2EEB8
{
	if (BitTest(uParam0->f_113, iParam1) || BitTest(uParam0->f_114, iParam1))
	{
		return 1;
...
bool func_416(var uParam0)//Position - 0x2EEF8
{
	bool bVar0;
	int iVar1;
...
int func_417(var uParam0, bool bParam1)//Position - 0x2EF6C
{
...
int func_418(var uParam0, int iParam1)//Position - 0x2F16C
{
	if (BitTest(uParam0->f_113, iParam1) || BitTest(uParam0->f_114, iParam1))
	{
		return 1;
...
void func_419(int iParam0)//Position - 0x2F303
{
	int iVar0;
	char* sVar1;
...
int func_420(int iParam0)//Position - 0x2F7F1
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
void func_422(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0x2F86D
{
...
void func_423(int iParam0, int iParam1)//Position - 0x2F88B
{
...
void func_424()//Position - 0x2F95B
{
	if (func_333(func_335(), 1))
	{
		if (func_581(func_336()))
...
void func_425(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2FA0B
{
	func_426(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_426(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2FA35
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_427(struct<3> Param0)//Position - 0x2FE2B
{
...
int func_428(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2FE55
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_429(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x3014C
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_430(struct<3> Param0)//Position - 0x30200
{
	float fVar0;
	float fVar1;
...
void func_431(int iParam0)//Position - 0x3023F
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_432(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x302A4
{
	if (iParam0 == 1)
	{
...
void func_433()//Position - 0x3033F
{
	int iVar0;
...
int func_434(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x3035F
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_435(int iParam0, int iParam1)//Position - 0x304D3
{
	int iVar0;
...
int func_436(int iParam0)//Position - 0x304F1
{
	switch (iParam0)
	{
...
int func_437(int iParam0)//Position - 0x30688
{
...
int func_438(int iParam0, bool bParam1)//Position - 0x30898
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_439(int iParam0)//Position - 0x315D9
{
	switch (iParam0)
	{
...
int func_440(int iParam0, var* uParam1)//Position - 0x3167A
{
	int iVar0;
	int iVar1;
...
void func_441(int iParam0)//Position - 0x316B5
{
	int iVar0;
	int iVar1;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar1 <= (8 - 1))
		{
			Global_113969.f_2366.f_539.f_1730[iVar1 /*4*/][iVar0] = HUD::HUD_GET_WEAPON_WHEEL_TOP_SLOT(iVar1);
			iVar1++;
		}
	}
}

void func_442(int iParam0, var uParam1)//Position - 0x31712
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_443(int iParam0)//Position - 0x3199A
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_444(int iParam0)//Position - 0x31B8C
{
	int iVar0;
...
void func_445(int iParam0)//Position - 0x31E00
{
	var uVar0;
...
int func_446(char* sParam0, int iParam1)//Position - 0x31FBB
{
	int iVar0;
...
void func_447()//Position - 0x32016
{
	if (func_581(PLAYER::PLAYER_PED_ID()))
	{
...
void func_448()//Position - 0x3208F
{
	func_488(0);
	func_342();
	func_449();
...
void func_449()//Position - 0x320A4
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_450()//Position - 0x320FC
{
	int iVar0;
...
void func_451()//Position - 0x32158
{
	int iVar0;
	float fVar1;
...
void func_452(var uParam0)//Position - 0x321E0
{
	struct<3> Var0;
	var uVar3;
	int iVar4;
...
int func_453(var uParam0)//Position - 0x32C45
{
	if (uParam0->f_1 != 7)
	{
		return 0;
...
int func_454(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x32CAB
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_455(var uParam0)//Position - 0x32D26
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
void func_456(struct<3> Param0, struct<3> Param3, int iParam6)//Position - 0x33181
{
...
void func_457()//Position - 0x331DE
{
...
void func_458(char* sParam0, int iParam1)//Position - 0x33238
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

void func_459(var uParam0)//Position - 0x3324F
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_460(struct<3> Param0, struct<3> Param3, struct<3> Param6)//Position - 0x333AC
{
	float fVar0;
...
float func_461(struct<3> Param0, struct<3> Param3)//Position - 0x333E1
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

int func_462(var uParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, struct<3> Param10)//Position - 0x33402
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_465(struct<3> Param0, struct<3> Param3, var uParam6, var uParam7, int iParam8)//Position - 0x334D8
{
	struct<3> Var0;
...
void func_466(struct<3> Param0, var uParam3, var uParam4, int iParam5)//Position - 0x334FB
{
	float fVar0;
...
void func_467(var uParam0)//Position - 0x335A0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_468(int iParam0, char* sParam1, char* sParam2, int iParam3, bool bParam4)//Position - 0x337B4
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_469(iParam3), bParam4);
}

int func_469(int iParam0)//Position - 0x337CE
{
	int iVar0;
...
void func_470(var uParam0)//Position - 0x339DB
{
	int iVar0;
	float fVar1;
...
void func_471()//Position - 0x33C3F
{
...
bool func_472(char* sParam0)//Position - 0x33C5D
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

int func_473(float fParam0)//Position - 0x33C70
{
	if (fParam0 < 0f)
	{
		return -1;
...
void func_474(var uParam0)//Position - 0x33C87
{
	int iVar0;
...
void func_475()//Position - 0x33F29
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		return;
...
void func_476(int iParam0, int iParam1)//Position - 0x33F78
{
	float fVar0;
...
int func_477(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x33F9D
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
bool func_478(var uParam0)//Position - 0x34031
{
	if (uParam0->f_32)
	{
		return 0;
...
int func_479(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x34071
{
	int iVar0;
	bool bVar1;
...
bool func_480(var uParam0)//Position - 0x340C3
{
	int iVar0;
...
bool func_481(var uParam0)//Position - 0x340D6
{
	return ((((uParam0->f_1 == 20 || uParam0->f_1 == 19) || uParam0->f_1 == 18) || uParam0->f_1 == 17) || uParam0->f_1 == 15);
}

void func_482(var uParam0)//Position - 0x34119
{
...
int func_483(var uParam0)//Position - 0x3418D
{
	if (!func_487(uParam0))
	{
...
void func_484(int iParam0)//Position - 0x3431D
{
	bool bVar0;
	int iVar1;
...
void func_485()//Position - 0x3438E
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		return;
...
void func_486(char* sParam0, char* sParam1, struct<3> Param2, int iParam5)//Position - 0x3441C
{
	AUDIO::PLAY_AMBIENT_SPEECH_FROM_POSITION_NATIVE(sParam0, sParam1, Param2, func_469(iParam5));
}

bool func_487(var uParam0)//Position - 0x34436
{
	return (uParam0->f_1 == 7 || uParam0->f_1 == 8);
}

void func_488(int iParam0)//Position - 0x34451
{
	if (func_493())
	{
		return;
...
void func_489(int iParam0)//Position - 0x34484
{
	if (func_493())
	{
		return;
...
void func_490(bool bParam0, bool bParam1)//Position - 0x3450E
{
	if (bParam0)
	{
		if (func_492(0))
...
bool func_491()//Position - 0x34582
{
	return BitTest(Global_1956920, 5);
}

int func_492(int iParam0)//Position - 0x34590
{
	if (iParam0 == 1)
	{
		if (Global_20930.f_1 > 3)
...
bool func_493()//Position - 0x345E7
{
	return BitTest(Global_1956920, 19);
}

void func_494()//Position - 0x345F6
{
	PED::SET_PED_DENSITY_MULTIPLIER_THIS_FRAME(0f);
...
void func_495(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x34618
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_497(Global_79645, Global_79647, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_496(char* sParam0)//Position - 0x348FD
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_497(int iParam0, int iParam1, int iParam2)//Position - 0x34910
{
	struct<2> Var0;
	int iVar2;
...
char* func_498(int iParam0)//Position - 0x349E5
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_499(int iParam0)//Position - 0x34B4D
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_500(int iParam0)//Position - 0x34B80
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_501(int iParam0)//Position - 0x34BB3
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_502(int iParam0)//Position - 0x34BE6
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_503(int iParam0)//Position - 0x34C19
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_504(int iParam0)//Position - 0x34C56
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_505(int iParam0)//Position - 0x34C89
{
	struct<2> Var0;
...
int func_506(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x34CF6
{
	if (((!func_508(0) || Global_79660) || Global_79648 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_79644)
...
bool func_507(bool bParam0)//Position - 0x34E0F
{
	if (bParam0)
	{
...
int func_508(int iParam0)//Position - 0x34E38
{
	if (Global_44042 == 15)
	{
		return 0;
...
bool func_509(int iParam0)//Position - 0x34E5A
{
	return func_510(iParam0, Global_44042);
}

int func_510(int iParam0, int iParam1)//Position - 0x34E6B
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_511(bool bParam0)//Position - 0x3504C
{
...
void func_512(int iParam0)//Position - 0x35074
{
	if (iParam0 > 0)
	{
	}
...
void func_513(struct<3> Param0, float fParam3, var uParam4, var uParam5)//Position - 0x35082
{
	struct<3> Var0;
...
int func_514(int iParam0, int iParam1)//Position - 0x350AE
{
	int iVar0;
...
void func_515()//Position - 0x3510C
{
...
void func_516(int iParam0, int iParam1, int iParam2)//Position - 0x35309
{
...
var func_517()//Position - 0x353CD
{
	return BitTest(Global_101533.f_20, 13);
}

void func_518(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x353DE
{
	if (func_528())
	{
...
int func_519(var uParam0)//Position - 0x35473
{
	int iVar0[7];
	struct<3> Var8;
	float fVar11;
...
int func_520(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x358D7
{
...
int func_521(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x35933
{
	int iVar0;
...
int func_522(var uParam0, int iParam1)//Position - 0x359C1
{
	int iVar0;
...
int func_523(var uParam0)//Position - 0x35A07
{
	if (func_524(uParam0))
	{
...
int func_524(var uParam0)//Position - 0x35A31
{
...
int func_525(int iParam0)//Position - 0x35A56
{
	int iVar0;
...
void func_526(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x35A87
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
float func_527(float fParam0)//Position - 0x35AC3
{
	return (fParam0 * 57.29578f);
}

int func_528()//Position - 0x35AD3
{
...
void func_529(bool bParam0)//Position - 0x35AF7
{
	if (bParam0)
	{
...
void func_530(int iParam0, bool bParam1)//Position - 0x35B23
{
	if (bParam1)
	{
...
void func_531()//Position - 0x35B45
{
...
void func_532()//Position - 0x35C1D
{
	iLocal_207 = joaat("WEAPON_MINIGUN");
	fLocal_568 = 7.5f;
	iLocal_563 = 10;
...
void func_533()//Position - 0x35CD2
{
	int iVar0;
...
void func_534(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x35CFC
{
	*(uParam0[0 /*3*/]) = { Param1 };
	*(uParam0[1 /*3*/]) = { Param4 };
	uParam0->f_7 = fParam7;
...
void func_535(bool bParam0)//Position - 0x35D20
{
	if (bParam0)
	{
		func_536();
...
void func_536()//Position - 0x35D83
{
...
void func_537(bool bParam0)//Position - 0x35DAC
{
...
void func_538(bool bParam0)//Position - 0x35E06
{
	int iVar0;
...
void func_539(int iParam0, bool bParam1)//Position - 0x35E29
{
	if (bParam1)
	{
...
void func_540(int iParam0, int iParam1, bool bParam2)//Position - 0x35E60
{
	int iVar0;
...
int func_541(int iParam0)//Position - 0x35ED0
{
	switch (iParam0)
	{
		case 0:
...
void func_542(int iParam0, int iParam1, bool bParam2)//Position - 0x36278
{
	int iVar0;
...
int func_543(int iParam0, int iParam1, bool bParam2)//Position - 0x362E8
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_544()//Position - 0x36348
{
	func_433();
	if (func_548())
	{
...
void func_545(int iParam0)//Position - 0x364A2
{
...
void func_546(var uParam0)//Position - 0x36505
{
	bool bVar0;
...
int func_547(var uParam0, bool bParam1)//Position - 0x3652A
{
...
void func_549(bool bParam0)//Position - 0x367BB
{
	int iVar0;
...
void func_550(char* sParam0, int iParam1)//Position - 0x3688B
{
	if (Global_101533 != 12)
	{
...
int func_551(char* sParam0, int iParam1, int iParam2)//Position - 0x368B3
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_552(char* sParam0)//Position - 0x36A42
{
...
int func_554(char* sParam0, bool bParam1)//Position - 0x36AC0
{
	int iVar0;
	int iVar1;
...
int func_555(int iParam0, bool bParam1)//Position - 0x36AEA
{
	int iVar0;
...
void func_558(bool bParam0)//Position - 0x36BDC
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_559(int iParam0)//Position - 0x36BF0
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_560(int iParam0)//Position - 0x36C2A
{
	if (iParam0 == 1)
	{
...
void func_561()//Position - 0x36C64
{
	Global_23692.f_5 = 1;
}

void func_562()//Position - 0x36C72
{
	Global_23692.f_5 = 0;
}

void func_563()//Position - 0x36C80
{
	Global_95689 = 0;
	Global_95690 = 0;
}

int func_564()//Position - 0x36C92
{
...
void func_565()//Position - 0x36CD0
{
	Global_101568 = 1;
...
void func_566(char* sParam0, bool bParam1)//Position - 0x36DC1
{
	func_567(sParam0);
	func_549(bParam1);
}

void func_567(char* sParam0)//Position - 0x36DD5
{
...
void func_568(char* sParam0)//Position - 0x36E13
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_569(int iParam0)//Position - 0x36E25
{
	if (func_31(iParam0))
	{
...
void func_570(int iParam0, bool bParam1)//Position - 0x36E5D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_571(int iParam0, bool bParam1)//Position - 0x36F50
{
	int iVar0;
	int iVar1;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar1 <= (8 - 1))
		{
			HUD::HUD_SET_WEAPON_WHEEL_TOP_SLOT(Global_113969.f_2366.f_539.f_1730[iVar1 /*4*/][iVar0]);
			iVar1++;
		}
	}
}

void func_572(int iParam0, var uParam1, bool bParam2)//Position - 0x36FAD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_573(int iParam0, var* uParam1)//Position - 0x37612
{
	int iVar0;
	int iVar1;
...
void func_574(int iParam0, int iParam1, int iParam2)//Position - 0x3764D
{
	int iVar0;
...
void func_575(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3767A
{
	int iVar0;
...
int func_576(int iParam0)//Position - 0x3769C
{
	switch (iParam0)
	{
...
void func_577(int iParam0, int iParam1, int iParam2)//Position - 0x379D7
{
	int iVar0;
...
bool func_578(int iParam0)//Position - 0x379F7
{
	int iVar0;
	struct<2> Var1;
...
int func_579(bool bParam0, bool bParam1)//Position - 0x37B23
{
	if (bParam0)
	{
...
bool func_580()//Position - 0x37B8C
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

int func_581(int iParam0)//Position - 0x37B9D
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_582(var uParam0)//Position - 0x37BBE
{
...
void func_583(var uParam0)//Position - 0x37BDE
{
	int iVar0;
...
int func_584(int iParam0)//Position - 0x37C18
{
	if (!func_31(iParam0))
	{
		return func_34(iParam0);
