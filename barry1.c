...
void __EntryFunction__()//Position - 0x0
{
	...
	sLocal_97 = "";
	iLocal_98 = -1;
	Local_104 = { 174.6435f, -1012.361f, 28.3152f };
	fLocal_105 = 30.2623f;
	Local_106 = { 180.5319f, -970.6324f, 29.0923f };
	fLocal_107 = 100f;
	Local_108 = { 188.86f, -955.83f, 30.09f };
	fLocal_109 = 62.08f;
	fLocal_110 = 1f;
	fLocal_111 = 1f;
	fLocal_112 = 0.8f;
	...
	fLocal_492 = 1f;
	bLocal_493 = true;
	Local_494 = { 183.58f, -967.1f, 29.09f };
	fLocal_495 = 38.25f;
	fLocal_496 = 30f;
	fLocal_497 = 60f;
	iLocal_499 = 600;
	...
	fLocal_514 = 0.3f;
	fLocal_515 = 1.75f;
	Local_516 = { 0.3f, 0.3f, 0f };
	Local_517 = { 270f, 0f, 0f };
	fLocal_518 = 0.1f;
	iLocal_519 = 3;
	iLocal_526 = 31;
	Local_528 = { 188.86f, -955.83f, 29.09f };
	iLocal_531 = 5;
	Local_532 = { 216.7659f, -908.9621f, 29.69239f };
	fLocal_533 = 7f;
	Local_571 = { 184.8f, -961.5f, 200f };
	Local_572 = { -90f, 0f, -109.6f };
	...
	func_512();
	func_511(iLocal_123, 1);
	func_510(181.3f, -969.1f, 30.3f, 200f, &Var0, &Var1);
	func_509(iLocal_524);
	if (func_508(0))
	{
	...
	while (true)
	{
		...
		func_492(Local_94.f_9, 0, 0, 0, 0, 0);
		fLocal_111 = 1f;
		iLocal_118 = 0;
		func_491();
...
void func_1()//Position - 0x529
{
	...
	bVar0 = func_8(PLAYER::PLAYER_PED_ID(), Local_106, 1) < (fLocal_107 + 10f);
	if (iLocal_113)
	{
		if (bVar0 == 0 && bLocal_477 == 0)
		{
			...
			func_6(&iLocal_115);
			iLocal_115 = func_5(Local_106, 5, 1);
			iLocal_114 = MISC::GET_GAME_TIMER() + 10000;
			func_3(0);
			iLocal_113 = 0;
		}
	}
	else if (func_8(PLAYER::PLAYER_PED_ID(), Local_106, 1) > fLocal_107)
	{
...
int func_5(struct<3> Param0, int iParam1, bool bParam2)//Position - 0x698
{
	int iVar0;
...
float func_8(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x6FF
{
	struct<3> Var0;
	...
	switch (iLocal_99)
	{
		...
		case 1:
			if (iParam0 == 0)
			{
				...
				{
					ENTITY::DETACH_ENTITY(iLocal_101, true, false);
				}
				TASK::OPEN_SEQUENCE_TASK(&iVar2);
				TASK::TASK_PLAY_ANIM(0, sLocal_256, sLocal_270, 8f, -8f, -1, 0, 0f, false, false, false);
				TASK::TASK_PLAY_ANIM(0, sLocal_256, sLocal_271, 8f, -8f, -1, 1, 0f, false, false, false);
				TASK::CLOSE_SEQUENCE_TASK(iVar2);
				TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iVar2);
				TASK::CLEAR_SEQUENCE_TASK(&iVar2);
			}
			iVar3 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", CAM::GET_GAMEPLAY_CAM_COORD(), CAM::GET_GAMEPLAY_CAM_ROT(2), CAM::GET_GAMEPLAY_CAM_FOV(), true, 2);
			Var0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - CAM::GET_GAMEPLAY_CAM_COORD() };
			CAM::ATTACH_CAM_TO_ENTITY(iVar3, PLAYER::PLAYER_PED_ID(), -Var0, true);
		...
		case 4:
			...
			if (iParam0 == 1)
			{
				...
				{
					func_16();
					GRAPHICS::ANIMPOSTFX_PLAY(sLocal_255, 0, false);
		...
		case 5:
			if (MISC::GET_GAME_TIMER() > iLocal_96)
			{
				if (iParam0 == 1)
				{
					...
					MISC::CLEAR_AREA_OF_VEHICLES(Local_108, 200f, false, false, false, false, false, false, 0);
					GRAPHICS::REMOVE_DECALS_IN_RANGE(Local_108, 500f);
					AUDIO::CLEAR_AMBIENT_ZONE_STATE(sLocal_473, true);
					if (func_12(PLAYER::PLAYER_PED_ID()))
					{
...
bool func_17(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD30
{
...
int func_18(char* sParam0, int iParam1, bool bParam2)//Position - 0xD84
{
	Global_21606 = 0;
...
bool func_21(int iParam0)//Position - 0x10EC
{
	return func_22(iParam0, 20);
}

var func_22(int iParam0, int iParam1)//Position - 0x10FC
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

int func_23()//Position - 0x1114
{
	return -1;
}

void func_24()//Position - 0x111D
{
	int iVar0;
...
int func_29()//Position - 0x1344
{
	func_30();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_30()//Position - 0x135D
{
	int iVar0;
...
bool func_31(int iParam0)//Position - 0x145A
{
	return iParam0 < 3;
}

int func_32(int iParam0)//Position - 0x1466
{
	int iVar0;
	int iVar1;
...
int func_33(int iParam0)//Position - 0x14A3
{
	if (func_31(iParam0))
	{
...
var func_34(int iParam0)//Position - 0x14C8
{
	return Global_1998[iParam0 /*29*/];
}

bool func_35(int iParam0)//Position - 0x14D7
{
	return Global_43052 == iParam0;
}

void func_36()//Position - 0x14E5
{
	int iVar0;
...
bool func_37(int iParam0, int iParam1)//Position - 0x153B
{
	switch (iParam0)
	{
		case 5:
...
void func_39(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x15CA
{
...
bool func_40(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1620
{
...
void func_41(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x166E
{
...
void func_42(char* sParam0, bool bParam1)//Position - 0x1709
{
	func_43(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_43(bool bParam0)//Position - 0x171F
{
	int iVar0;
...
void func_44(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x175E
{
	if (bParam0)
	{
...
bool func_45()//Position - 0x18A1
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_46(int iParam0, int iParam1)//Position - 0x18BB
{
	bool bVar0;
...
int func_47(int iParam0, bool bParam1)//Position - 0x1906
{
	int iVar0;
	int iVar1;
...
int func_48()//Position - 0x1947
{
	return Global_1574918;
}

int func_49(int iParam0)//Position - 0x1953
{
...
bool func_50()//Position - 0x1992
{
	return BitTest(Global_2621446, 3);
}

int func_51(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x19A0
{
	int iVar0;
...
void func_52(int iParam0)//Position - 0x19D3
{
	if (iParam0 == 1)
	{
...
void func_53(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x19F6
{
	int iVar0;
...
int func_54(int iParam0)//Position - 0x1AA0
{
	if (func_578(iParam0))
	{
...
void func_55(struct<3> Param0, float fParam1)//Position - 0x1AC0
{
	func_56(&(Global_106934.f_2890), Param0, fParam1);
}

void func_56(var uParam0, struct<3> Param1, var uParam2)//Position - 0x1AD9
{
	*uParam0 = { Param1 };
	uParam0->f_6 = uParam2;
}

void func_57(struct<3> Param0, float fParam1)//Position - 0x1AEF
{
	if (func_58(Global_78559, 0f, 0f, 0f, 0))
	{
		Global_78559 = { Param0 };
...
bool func_58(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x1B1B
{
	if (bParam2)
	{
...
void func_60(bool bParam0)//Position - 0x1B8F
{
	int iVar0;
...
void func_61(var uParam0, bool bParam1)//Position - 0x1BBB
{
	if (*uParam0 == 0)
	{
		return;
...
void func_62(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1BE3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_63(var uParam0)//Position - 0x1C33
{
	if (func_67(uParam0))
	{
		iLocal_476 = 0;
...
void func_64(var uParam0)//Position - 0x1C84
{
...
void func_65(var uParam0)//Position - 0x1CB4
{
	if (*uParam0 != 0)
	{
...
void func_66(var uParam0)//Position - 0x1CE4
{
	if (*uParam0 != -1)
	{
...
bool func_67(var uParam0)//Position - 0x1D05
{
	return (uParam0->f_1 == 10 || uParam0->f_1 == 11);
}

void func_68()//Position - 0x1D21
{
	int iVar0;
	...
	while (iVar0 < Local_502.f_0)
	{
		if (func_4(&(Local_502[iVar0 /*33*/])))
		{
			...
			TASK::TASK_SMART_FLEE_COORD(Local_502[iVar0 /*33*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 400f, -1, false, false);
		}
		iVar0++;
	}
}

void func_69()//Position - 0x1D8C
{
	int iVar0;
...
void func_70(int iParam0)//Position - 0x1DB6
{
	int iVar0;
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_12(iLocal_101) && ENTITY::IS_ENTITY_ATTACHED(iLocal_101))
			{
				ENTITY::DETACH_ENTITY(iLocal_101, true, true);
			}
			TASK::OPEN_SEQUENCE_TASK(&iVar0);
			TASK::TASK_PLAY_ANIM(0, sLocal_256, sLocal_266, 8f, -8f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(0, sLocal_256, sLocal_269, 8f, -2f, -1, 0, 0f, false, false, false);
		...
		case 2:
			if (TASK::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) == 7)
			{
				...
				GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_alien_teleport", ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_ROTATION(PLAYER::PLAYER_PED_ID(), 2), fLocal_491, false, false, false);
...
int func_71()//Position - 0x1F2A
{
	...
	{
		case 0:
			iLocal_545 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", Local_571, Local_572, 50f, false, 2);
		...
		case 3:
			if (MISC::GET_GAME_TIMER() > iLocal_570)
			{
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_571, true, false, false, true);
				...
				if (CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(0) != 4)
				{
					...
					{
						CAM::SET_CAM_ROT(iLocal_545, Local_572, 2);
						CAM::SET_CAM_ACTIVE(iLocal_545, true);
						CAM::ATTACH_CAM_TO_ENTITY(iLocal_545, PLAYER::PLAYER_PED_ID(), 0f, 0f, 4f, false);
					}
				}
				else
				{
...
void func_73(var uParam0)//Position - 0x211F
{
	if (*uParam0 == 0)
	{
		return;
...
void func_74(int* iParam0)//Position - 0x2143
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_75(var uParam0, float fParam1)//Position - 0x2184
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (!uParam0->f_15)
	{
		if (CAM::DOES_CAM_EXIST(uParam0->f_11))
		{
			...
			if (bVar5)
			{
				Var4 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar6, CAM::GET_FINAL_RENDERED_CAM_COORD()) };
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar6, Var4, true);
			}
			else
			{
				Var4 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar7, CAM::GET_FINAL_RENDERED_CAM_COORD()) };
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar7, Var4, true);
			}
			...
			{
				Var4 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar6, CAM::GET_FINAL_RENDERED_CAM_COORD()) };
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar6, Var4 + Vector(15f, 0f, 0f), true);
			}
			else
			{
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar7, 0f, 0f, 5f, false);
			}
			...
			if (bVar5)
			{
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar6, 0f, 0f, 75f, false);
			}
			else
			{
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar7, 0f, 0f, 75f, false);
			}
			CAM::SET_CAM_ROT((*uParam0)[uParam0->f_24], -87.5f, 0f, Var3.f_2, 2);
			CAM::SET_CAM_FOV((*uParam0)[uParam0->f_24], CAM::GET_FINAL_RENDERED_CAM_FOV());
			CAM::ADD_CAM_SPLINE_NODE_USING_CAMERA(uParam0->f_9, (*uParam0)[uParam0->f_24], 400, 1);
			uParam0->f_24++;
			uParam0->f_27 += 400;
			Var8 = { CAM::GET_CAM_ROT(uParam0->f_11, 2) };
			Var8.f_0 = 21f;
			CAM::ADD_CAM_SPLINE_NODE(uParam0->f_9, CAM::GET_CAM_COORD(uParam0->f_11), Var8, iVar1, 3, 2);
	...
	if (uParam0->f_17)
	{
		if (CAM::DOES_CAM_EXIST(uParam0->f_9))
		{
			if (CAM::DOES_CAM_EXIST(uParam0->f_11))
			{
				Global_1574632.f_1 = { CAM::GET_CAM_COORD(uParam0->f_9) };
				Global_1574632.f_4 = { CAM::GET_CAM_ROT(uParam0->f_9, 2) };
...
void func_76(int iParam0)//Position - 0x27BC
{
	Global_23009 = iParam0;
}

float func_77(int iParam0)//Position - 0x27C9
{
	struct<3> Var0;
...
float func_78(float fParam0, float fParam1, float fParam2)//Position - 0x27EC
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
int func_79()//Position - 0x2813
{
	return Global_2621446.f_2;
}

void func_80(int iParam0, int iParam1, int iParam2)//Position - 0x2821
{
	if (*iParam2 >= 8)
	{
		return;
...
void func_81(int iParam0)//Position - 0x2845
{
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		if (func_578(PLAYER::PLAYER_PED_ID()))
	...
	switch (*iParam0)
	{
		case 0:
			func_42("bar_2_rcm", 0);
			func_344(Local_108, 1112014848, 12, 5000, 0, 0);
		...
		case 1:
			if (func_336(1, 1093140480, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2"))
			{
				...
				func_335();
				MISC::CLEAR_AREA_OF_VEHICLES(Local_108, 250f, false, false, false, false, false, false, 0);
				MISC::CLEAR_AREA_OF_PEDS(Local_108, 50f, 0);
				MISC::CLEAR_AREA_OF_OBJECTS(Local_108, 30f, 0);
				GRAPHICS::REMOVE_DECALS_IN_RANGE(Local_108, 500f);
				PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
				func_286();
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_246, 2, func_581(49), 0);
		...
		case 2:
			...
			else
			{
				...
				if (!func_578(Local_94.f_41[5]))
				{
					func_281(&(Local_94.f_41[5]), iLocal_277);
				}
				...
				{
					if (func_578(Local_94.f_41[0]) && func_578(Local_94.f_41[2]))
					{
		...
		case 3:
			...
			func_53(1, 1, 1, 1);
			func_278(PLAYER::PLAYER_PED_ID(), Local_108);
...
void func_82()//Position - 0x2C11
{
	if (iLocal_127 == iLocal_123 && WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), iLocal_127, false))
	{
		WEAPON::SET_PED_INFINITE_AMMO(PLAYER::PLAYER_PED_ID(), false, iLocal_127);
	}
	if (func_578(PLAYER::PLAYER_PED_ID()))
	{
		func_568(PLAYER::PLAYER_PED_ID(), 1);
...
void func_83(int iParam0, bool bParam1)//Position - 0x2C78
{
	int iVar0;
	char* sVar1;
	...
	{
		func_246(&(Global_112473[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	...
	func_231(0, 0);
	MemCopy(&sVar1, {func_229(iVar0)}, 4);
	func_227(&sVar1, func_228());
	func_109();
...
void func_85(int iParam0, int iParam1, int iParam2)//Position - 0x2DF7
{
	bool bVar0;
...
void func_86()//Position - 0x2EDD
{
	...
	{
		func_88(13, SYSTEM::FLOOR(Global_113386.f_10194.f_3853));
	}
...
int func_87()//Position - 0x339B
{
	return Global_31959;
}

int func_88(int iParam0, int iParam1)//Position - 0x33A6
{
	int iVar0;
...
void func_89(int iParam0, bool bParam1, int iParam2)//Position - 0x33F7
{
	if (iParam2 == -1)
	{
		iParam2 = func_48();
...
void func_91(int iParam0)//Position - 0x346E
{
	if (iParam0 == 1)
	{
...
void func_93()//Position - 0x34B5
{
	StringCopy(&Global_78551, "", 16);
	StringCopy(&Global_78555, "", 16);
}

void func_94()//Position - 0x34CD
{
	int iVar0;
...
void func_98(int iParam0)//Position - 0x359F
{
	if (iParam0 == 1)
	{
		Global_43601 = 1;
...
void func_99()//Position - 0x35B8
{
	func_100(&Global_106934);
}

void func_100(var uParam0)//Position - 0x35C8
{
	int iVar0;
	int iVar1;
...
void func_101(var uParam0)//Position - 0x3B58
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_102(var uParam0)//Position - 0x3B73
{
...
void func_103(var uParam0)//Position - 0x3BA2
{
	int iVar0;
...
void func_104(var uParam0)//Position - 0x3C51
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_105(var uParam0)//Position - 0x3C6F
{
	int iVar0;
...
void func_106(var uParam0)//Position - 0x3D4E
{
	*uParam0 = -15;
}

void func_107()//Position - 0x3D5C
{
	StringCopy(&Global_103942, "", 32);
	func_100(&Global_103950);
}

void func_108()//Position - 0x3D74
{
...
int func_110(int iParam0, int iParam1, int iParam2)//Position - 0x3EB2
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	Global_78130[1 /*14*/] = { func_162(iVar0, iParam1, iParam2, -1) };
	...
	{
		uVar6 = { func_158(iVar0, 0) };
		Global_78130[1 /*14*/] = { func_162(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_154(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_154(iParam1), Global_78130[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_154(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, 0);
		}
	}
	if (func_153(iParam0, iVar0, &iVar7, 0))
	{
...
int func_111(int iParam0, int iParam1, int iParam2)//Position - 0x4072
{
	int iVar0;
	...
	{
		if (!func_226(iParam0, Global_113386.f_2363.f_539[iVar0 /*65*/].f_64, Global_113386.f_2363.f_539[iVar0 /*65*/].f_63))
		{
...
int func_112(int iParam0)//Position - 0x40FE
{
	switch (iParam0)
	{
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x4139
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_78130[1 /*14*/] = { func_162(iVar10, iParam1, iParam2, -1) };
		if (!func_152(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		{
			uVar11 = { func_158(iVar10, iParam2) };
		}
		iVar0 = 0;
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78130[1 /*14*/] = { func_162(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						{
							uVar12 = { func_155(iVar10, uVar11[iVar0]) };
						}
						iVar1 = 0;
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_162(iVar10, 14, uVar12[iVar1], -1) };
							func_129(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
							func_145(14);
							if (Global_78128 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_154(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_154(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_154(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
						}
						func_145(iVar0);
						if (Global_78128 == 1)
						{
			...
			{
				Global_78130[1 /*14*/] = { func_162(iVar10, iVar0, func_119(iParam0, iVar0, -1), -1) };
		...
		if (iParam7 == 1)
		{
			Var14 = { func_162(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var14 = { func_162(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var14 = { func_162(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var14 = { func_162(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var14 = { func_162(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	{
		uVar15 = { func_155(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_162(iVar10, 14, uVar15[iVar1], -1) };
			func_129(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_145(14);
			if (Global_78128 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_154(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_154(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_154(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
		}
		if (Global_78128 == 1)
		{
			iVar2 = 0;
...
void func_114(int iParam0, int iParam1, int iParam2)//Position - 0x4949
{
	int iVar0;
	int iVar1;
...
int func_115(int iParam0, int iParam1, int iParam2)//Position - 0x49D3
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_116(int iParam0, int iParam1, int iParam2)//Position - 0x4AB1
{
	Global_78130[1 /*14*/] = { func_162(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78130[1 /*14*/].f_6, 2);
}

int func_117(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x4AD9
{
	var uVar0;
	int iVar1;
	...
	if (iParam2 == 14)
	{
		uVar0 = { func_155(iParam0, (*uParam4)[13]) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
...
int func_118(int iParam0, int iParam1, int iParam2)//Position - 0x50DD
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_119(int iParam0, int iParam1, int iParam2)//Position - 0x5176
{
	int iVar0;
	int iVar1;
...
int func_120(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5217
{
	int iVar0;
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x551E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_122(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x60D1
{
	int iVar0;
...
int func_123(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x63B5
{
	int iVar0;
...
int func_124(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x667C
{
	int iVar0;
	int iVar1;
...
int func_125(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x66B3
{
	int iVar0;
...
int func_126(int iParam0, int iParam1, int iParam2)//Position - 0x66DC
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_127(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x69A6
{
	int iVar0;
...
int func_128(int iParam0, int iParam1, int iParam2)//Position - 0x6C30
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_129(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6D87
{
	int iVar0;
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6E1F
{
	switch (iParam0)
	{
...
int func_131(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6EED
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		iVar4 = (iParam1 - func_132(iParam0, func_154(iParam2)));
		if (iVar4 < 0)
		{
			return -1;
		}
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_154(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_132(int iParam0, int iParam1)//Position - 0x7007
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_133(int iParam0)//Position - 0x73AE
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_134(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x740F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_135(int iParam0, int iParam1)//Position - 0x750B
{
	int iVar0;
...
int func_136(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7649
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_154(iParam2));
		iVar4 = FILES::GET_SHOP_PED_QUERY_COMPONENT_INDEX(iParam1);
		if (iVar4 != -1)
		{
			return (func_132(iParam0, func_154(iParam2)) + iVar4);
		}
	}
	return -99;
}

int func_137(int iParam0)//Position - 0x7704
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_138(int iParam0)//Position - 0x7763
{
	switch (iParam0)
	{
		case 0:
...
int func_139(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x77E9
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_140(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7A66
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_141(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7E8B
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_142(int iParam0, int iParam1)//Position - 0x817F
{
	int iVar0;
	int iVar1;
...
int func_143(int iParam0, int iParam1)//Position - 0x81C5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_144(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8225
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_145(int iParam0)//Position - 0x827C
{
	if (BitTest(Global_78130[1 /*14*/].f_6, 1) && !BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
		func_151(iParam0, Global_78130[1 /*14*/].f_5, Global_78130[1 /*14*/].f_2, 2, Global_78130[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_78130[1 /*14*/].f_6, 1) && BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_146(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x8328
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_150(iParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
		...
		func_147(iVar2, iVar3, iVar0, 1, 0);
	}
}

void func_147(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x8372
{
	int iVar0;
	...
	iVar0 = Global_2826809[iParam0 /*3*/][func_148(iParam2)];
	if (iVar0 != 0)
	{
...
int func_148(var uParam0)//Position - 0x83A2
{
	int iVar0;
	int iVar1;
...
int func_149(int iParam0, int iParam1, int iParam2)//Position - 0x83D6
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 13122)
	{
		...
		iVar0 = Global_2826809[iParam0 /*3*/][func_148(iParam1)];
...
bool func_150(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x8413
{
	int iVar0;
...
int func_151(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xA964
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_152(int iParam0)//Position - 0xB807
{
	if (!BitTest(Global_78130[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_153(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB84F
{
	int iVar0;
	...
	{
		if (!func_226(iParam0, Global_113386.f_2363.f_539[iVar0 /*65*/].f_61, Global_113386.f_2363.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_154(int iParam0)//Position - 0xB8E5
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_155(int iParam0, int iParam1)//Position - 0xB995
{
	int iVar0;
	struct<10> Var1;
...
void func_156(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC2C4
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var2;
...
void func_157(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xC3EE
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_158(int iParam0, int iParam1)//Position - 0xC436
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_161(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[0], Global_113386.f_2363.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_161(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[1], Global_113386.f_2363.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_161(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[2], Global_113386.f_2363.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_159(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE27E
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var2;
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.f_0 != 0 && Var2.f_0 != -1) && Var2.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_160(Var2.f_2)] = Var2.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_160(Var2.f_2)] = func_136(iParam1, Var2.f_0, func_160(Var2.f_2), iVar0);
					}
				}
				else if (Var2.f_1 != -1)
				{
					(*uParam0)[func_160(Var2.f_2)] = Var2.f_1;
				}
			}
			iVar4++;
		}
...
int func_160(int iParam0)//Position - 0xE468
{
	switch (iParam0)
	{
		case 0:
...
void func_161(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xE518
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_162(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE589
{
	func_225();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_163(int iParam0, int iParam1)//Position - 0xE5DB
{
	switch (iParam0)
	{
		case 0:
...
void func_164(int iParam0)//Position - 0xE6CB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_171(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_165(&(Global_78130[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_165(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xF942
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_149(func_168(iParam1, uParam0->f_2), Global_78127, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_149(func_167(iParam1, uParam0->f_2), Global_78127, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_149(iVar1, Global_78127, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_166(int iParam0, int iParam1, var uParam2)//Position - 0xFCE7
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_167(int iParam0, int iParam1)//Position - 0x100FD
{
	switch (iParam1)
	{
		case 0:
...
int func_168(int iParam0, int iParam1)//Position - 0x104F8
{
	switch (iParam1)
	{
		case 0:
...
int func_169(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x108F3
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_170(int iParam0)//Position - 0x10932
{
	switch (iParam0)
	{
		case -1:
...
void func_171(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10A06
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar3 >= 0)
		{
			...
			if (iVar4 > iVar3)
			{
				...
				func_165(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_165(&(Global_78130[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_165(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_165(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_154(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_172(int iParam0)//Position - 0x10C8D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x10DE4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x112F2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x11367
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x113DB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x114C2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x11825
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x11A36
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x11C66
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x11D76
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x12715
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x13288
{
	if (iParam0 < 136)
	{
		func_185(iParam0);
...
void func_184(int iParam0)//Position - 0x132BD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185(int iParam0)//Position - 0x13EC1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186(int iParam0)//Position - 0x14EE7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_187(int iParam0)//Position - 0x15014
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_188(int iParam0, int iParam1)//Position - 0x15112
{
	switch (iParam0)
	{
		case 0:
...
void func_189(int iParam0)//Position - 0x15202
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_190(int iParam0)//Position - 0x166F3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_191(int iParam0)//Position - 0x16844
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_192(int iParam0)//Position - 0x16D4F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_193(int iParam0)//Position - 0x173BD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_194(int iParam0)//Position - 0x17431
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_195(int iParam0)//Position - 0x17501
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_196(int iParam0)//Position - 0x17A31
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_197(int iParam0)//Position - 0x17BC8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_198(int iParam0)//Position - 0x183C8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_199(int iParam0)//Position - 0x184D8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_200(int iParam0)//Position - 0x19403
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_201(int iParam0)//Position - 0x1A0C0
{
	if (iParam0 < 107)
	{
		func_204(iParam0);
...
void func_202(int iParam0)//Position - 0x1A106
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_203(int iParam0)//Position - 0x1ABAB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_204(int iParam0)//Position - 0x1B99A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_205(int iParam0)//Position - 0x1C5E5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_206(int iParam0)//Position - 0x1C85E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_207(int iParam0, int iParam1)//Position - 0x1C9A4
{
	switch (iParam0)
	{
		case 0:
...
void func_208(int iParam0)//Position - 0x1CA94
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_209(int iParam0)//Position - 0x1D81E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_210(int iParam0)//Position - 0x1D998
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_211(int iParam0)//Position - 0x1DF0F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_212(int iParam0)//Position - 0x1E439
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_213(int iParam0)//Position - 0x1E4AD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_214(int iParam0)//Position - 0x1E57D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_215(int iParam0)//Position - 0x1EA55
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_216(int iParam0)//Position - 0x1ECBE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_217(int iParam0)//Position - 0x1EF94
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_218(int iParam0)//Position - 0x1F15D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_219(int iParam0)//Position - 0x1FCB1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_220(int iParam0)//Position - 0x208FD
{
	if (iParam0 < 60)
	{
		func_222(iParam0);
...
void func_221(int iParam0)//Position - 0x20932
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_222(int iParam0)//Position - 0x216D2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_223(int iParam0)//Position - 0x21D5E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_224(int iParam0)//Position - 0x21E45
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_225()//Position - 0x21F43
{
...
int func_226(int iParam0, int iParam1, int iParam2)//Position - 0x21FBC
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_226(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar6 = { func_155(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
							if (!func_226(iParam0, 14, uVar6[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
									Global_78130[2 /*14*/] = { func_162(iVar0, 14, iVar4, -1) };
									if (Global_78130[2 /*14*/].f_12 == iVar3)
									{
										if (func_226(iParam0, 14, iVar4))
										{
											if (!func_117(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_78130[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_78130[2 /*14*/] = { func_162(iVar0, iVar2, iVar1, -1) };
						if (!func_117(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_78130[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar7 <= 8)
		{
			if (!func_226(iParam0, 14, uVar8[iVar7]))
			{
				return 0;
			}
			iVar7++;
	...
	else if (Global_78130[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_154(iParam1)) && Global_78130[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_154(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_227(char* sParam0, var uParam1)//Position - 0x22214
{
...
struct<2> func_229(int iParam0)//Position - 0x222AB
{
	struct<2> Var0;
	char[] cVar1[8];
	
	StringCopy(&Var0, "", 8);
	cVar1 = { func_230(iParam0) };
...
struct<2> func_230(int iParam0)//Position - 0x222E1
{
	struct<2> Var0;
...
void func_231(int iParam0, int iParam1)//Position - 0x2272C
{
...
void func_232(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x22776
{
	...
	if (iParam1 == 1)
	{
		func_233(iParam0, bParam2, bParam3);
	}
	HUD::SET_MISSION_NAME(false, 0);
}

void func_233(int iParam0, bool bParam1, bool bParam2)//Position - 0x22813
{
	struct<4> Var0;
	char* sVar1;
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&sVar1, {func_230(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&sVar1, 0, Global_100478, 0);
		func_234(&sVar1, Var0.f_3, Global_100478, bParam1, bParam2);
	}
}

void func_234(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x22852
{
...
void func_235(int iParam0, var uParam1)//Position - 0x22895
{
	switch (iParam0)
	{
		case 0:
...
int func_237(int iParam0)//Position - 0x23A9B
{
	switch (iParam0)
	{
		case 0:
...
void func_238(int iParam0)//Position - 0x23DE1
{
	Global_43603 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_239()//Position - 0x23DF3
{
	if (Global_97753)
	{
		func_30();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_240(Global_113386.f_2363.f_539.f_4321));
	}
	else
	{
...
char* func_240(var uParam0)//Position - 0x23E24
{
	uParam0 = uParam0;
	return "";
}

void func_241()//Position - 0x23E32
{
	char cVar0[24];
	...
	else if (MISC::IS_PS3_VERSION() || func_242())
	{
...
bool func_242()//Position - 0x23E75
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_243()//Position - 0x23E8B
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_244(int iParam0, int iParam1)//Position - 0x23EA1
{
	Global_97748 = iParam0;
	Global_97749 = iParam1;
}

void func_245()//Position - 0x23EB5
{
	if (Global_78573 != 6)
	{
	}
...
void func_246(var uParam0)//Position - 0x23EED
{
	if (*uParam0 == -1)
	{
		return;
...
void func_247(int iParam0, bool bParam1)//Position - 0x23F2A
{
	struct<26> Var0;
	int iVar1;
	bool bVar2;
...
int func_248(int iParam0)//Position - 0x240A8
{
	switch (iParam0)
	{
		case 0:
...
void func_249(int iParam0)//Position - 0x2442F
{
	func_251(iParam0, 1);
	Global_113386.f_18574[iParam0 /*6*/].f_3 = func_250();
	Global_113386.f_18574.f_380++;
}

int func_250()//Position - 0x24465
{
	return (Global_113386.f_10016.f_21 + Global_113386.f_18574.f_380);
}

void func_251(var uParam0, bool bParam1)//Position - 0x24481
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_252(int iParam0)//Position - 0x247A5
{
...
void func_253(int iParam0)//Position - 0x247D8
{
	switch (iParam0)
	{
		case 30:
...
void func_254(int iParam0, bool bParam1)//Position - 0x2480D
{
	if (iParam0 == -1)
	{
		return;
...
void func_255(int iParam0, int iParam1, bool bParam2)//Position - 0x2486A
{
	if (iParam0 == -1)
	{
		return;
...
int func_256(int iParam0, int iParam1)//Position - 0x248A5
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_257(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x248C5
{
	if (iParam0 != 198)
	{
		if (Global_78319)
...
void func_258(int iParam0, int iParam1)//Position - 0x2491D
{
	switch (iParam0)
	{
		case 12:
...
void func_259(int iParam0, bool bParam1)//Position - 0x24A06
{
	if (bParam1)
	{
...
bool func_260(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x24A2F
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_262()//Position - 0x25398
{
	return Global_31960;
}

int func_263(var uParam0, int iParam1)//Position - 0x253A3
{
	int iVar0;
...
int func_264(int iParam0)//Position - 0x28A9A
{
	switch (iParam0)
	{
		case 46:
...
void func_265(int iParam0, bool bParam1)//Position - 0x28B89
{
	switch (iParam0)
	{
		case 46:
...
void func_266(int iParam0, bool bParam1)//Position - 0x28BDA
{
	int iVar0;
...
void func_267(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x28C40
{
	func_268(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_268(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x28C60
{
	int iVar0;
...
void func_269()//Position - 0x28E32
{
	int iVar0;
...
int func_270(int iParam0)//Position - 0x28F49
{
	int iVar0;
	int iVar1;
...
void func_271(char* sParam0)//Position - 0x28F89
{
...
char* func_272(int iParam0)//Position - 0x28FAC
{
	switch (iParam0)
	{
		case 0:
...
int func_273(int iParam0)//Position - 0x2917F
{
...
void func_274(int iParam0, int iParam1)//Position - 0x291A9
{
...
int func_275(char* sParam0)//Position - 0x291E6
{
	int iVar0;
...
int func_276()//Position - 0x29246
{
	return func_277(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_277(char* sParam0, int iParam1)//Position - 0x29257
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
Vector3 func_278(int iParam0, struct<3> Param1)//Position - 0x292A0
{
	var uVar0;
...
void func_279(bool bParam0, int iParam1, int iParam2)//Position - 0x292E6
{
	bool bVar0;
...
void func_280(int iParam0, bool bParam1)//Position - 0x29345
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
void func_281(int* iParam0, int iParam1)//Position - 0x29377
{
	struct<3> Var0;
	float fVar1;
	...
	fVar1 = 23.45f;
	func_282(iParam0, iParam1, Var0, fVar1);
}

void func_282(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x293A7
{
	func_14(iParam0);
...
void func_283(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x293CE
{
	int iVar0;
...
Vector3 func_284(int iParam0)//Position - 0x2958C
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_285(int iParam0, bool bParam1)//Position - 0x2959F
{
	if (CAM::IS_SCREEN_FADED_OUT() || CAM::IS_SCREEN_FADING_OUT())
	{
		if (!CAM::IS_SCREEN_FADING_IN())
...
void func_286()//Position - 0x295DB
{
	if (iLocal_544)
	{
		return;
	}
	if (ENTITY::DOES_ENTITY_EXIST(func_334()) && !func_58(Local_542, Local_104, 0))
	{
		MISC::CLEAR_AREA(Local_542, 3f, true, false, false, false);
		if (func_578(func_334()))
		{
			ENTITY::SET_ENTITY_COORDS(func_334(), Local_542, true, false, false, true);
			ENTITY::SET_ENTITY_HEADING(func_334(), fLocal_543);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(func_334(), 5f);
		}
		if (func_331(func_333(), 1))
		{
			func_287(func_334(), Local_542, fLocal_543, 24, 0);
		}
	}
	iLocal_544 = 1;
}

void func_287(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x29671
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_322(iParam3, &Var0, Param1, fParam2, func_325(iParam0));
		func_288(iParam3, iParam0, 0);
	}
}

void func_288(int iParam0, int iParam1, int iParam2)//Position - 0x2979A
{
	int iVar0;
...
void func_289(int iParam0, int iParam1)//Position - 0x298B1
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_326(iParam0, &(Global_113386.f_32749.f_5510));
}

int func_290(int iParam0)//Position - 0x29AB3
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_305(iParam0, 0, 0)) || func_305(iParam0, 1, 0)) || func_305(iParam0, 2, 0)) || func_325(iParam0) != 145) || func_304(iParam0)) || func_303(iParam0)) || func_302(iParam0)) || func_301(iParam0)) || !func_291(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_303(iParam0))
		{
		}
...
int func_291(int iParam0)//Position - 0x29B90
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_292(int iParam0, bool bParam1)//Position - 0x29D41
{
	int iVar0;
	struct<2> Var1;
...
int func_293(int iParam0)//Position - 0x29EC1
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_295(int iParam0)//Position - 0x29FA4
{
	int iVar0;
	int iVar1;
...
int func_296()//Position - 0x2D278
{
	return 0;
}

int func_297()//Position - 0x2D281
{
	return 1;
}

int func_298()//Position - 0x2D28A
{
	return 1;
}

int func_299()//Position - 0x2D293
{
...
int func_301(int iParam0)//Position - 0x2D364
{
	int iVar0;
	char* sVar1;
...
int func_302(int iParam0)//Position - 0x2D3AA
{
	int iVar0;
...
int func_303(int iParam0)//Position - 0x2D3E5
{
	int iVar0;
...
int func_304(int iParam0)//Position - 0x2D461
{
	int iVar0;
...
int func_305(int iParam0, int iParam1, bool bParam2)//Position - 0x2D549
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_306(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2D5B7
{
...
int func_307(int iParam0)//Position - 0x2D68E
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_309(var uParam0, int iParam1)//Position - 0x2D6F0
{
	if (iParam1 <= 0)
	{
		return;
...
void func_310(var uParam0, int iParam1)//Position - 0x2D776
{
...
void func_311(var uParam0, int iParam1)//Position - 0x2D7A9
{
	int iVar0;
	int iVar1;
...
int func_312(int iParam0, int iParam1)//Position - 0x2D7FA
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_313(int iParam0)//Position - 0x2D89C
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_314(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_314(bool bParam0, int iParam1, int iParam2)//Position - 0x2D8BE
{
	if (bParam0)
	{
		return iParam1;
...
int func_315(var uParam0)//Position - 0x2D8D5
{
	return uParam0 & 15;
}

void func_316(var uParam0, int iParam1)//Position - 0x2D8E2
{
...
void func_317(var uParam0, int iParam1)//Position - 0x2D91C
{
...
void func_318(var uParam0, int iParam1)//Position - 0x2D957
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_319(var uParam0, int iParam1)//Position - 0x2D993
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_58(Global_113386.f_32749.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_58(Global_113386.f_2363.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_58(Global_113386.f_2363.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_320(int iParam0, int iParam1)//Position - 0x2F080
{
	struct<82> Var0;
...
void func_321(int iParam0, var uParam1, int iParam2)//Position - 0x2F0C2
{
	int iVar0;
...
void func_322(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x2F31E
{
	if (func_319(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_324(iParam0);
			func_323(uParam1, &(Global_113386.f_32749.f_69[Global_77137.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_323(var uParam0, var uParam1)//Position - 0x2F417
{
...
void func_324(int iParam0)//Position - 0x2F4E3
{
	if (iParam0 == -1)
	{
		return;
...
int func_325(int iParam0)//Position - 0x2F55A
{
	int iVar0;
...
void func_326(int iParam0, var uParam1)//Position - 0x2F5BD
{
	int iVar0;
...
int func_327(int iParam0)//Position - 0x2F868
{
	switch (iParam0)
	{
		case 1:
...
int func_328(int iParam0, var uParam1, var uParam2)//Position - 0x2F918
{
	int iVar0;
	int iVar1;
...
int func_329(int iParam0)//Position - 0x2FB0B
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_330(int iParam0)//Position - 0x2FB2B
{
...
bool func_331(struct<3> Param0, int iParam1)//Position - 0x2FB52
{
	return func_332(Global_103950.f_2890.f_12.f_66, Param0, iParam1);
}

int func_332(int iParam0, struct<3> Param1, int iParam2)//Position - 0x2FB6F
{
	struct<3> Var0;
	struct<3> Var1;
...
Vector3 func_333()//Position - 0x2FBD9
{
	return 2.55f, 5.665f, 2.55f;
}

int func_334()//Position - 0x2FBF0
{
	return Global_103950.f_4;
}

void func_335()//Position - 0x2FBFE
{
...
int func_336(int iParam0, float fParam1, int iParam2)//Position - 0x2FC71
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_342(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
bool func_337()//Position - 0x2FD45
{
	bool bVar0;
...
void func_338()//Position - 0x2FD68
{
	Global_20471 = 0;
	func_38();
}

int func_339()//Position - 0x2FD78
{
...
void func_340()//Position - 0x2FD9A
{
...
int func_341(int iParam0, int iParam1)//Position - 0x2FDEB
{
	if (func_54(iParam0))
	{
...
int func_342(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2FE1E
{
...
void func_343(int iParam0)//Position - 0x2FFB6
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_344(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x2FFE2
{
	int iVar0;
	int iVar1;
...
void func_345()//Position - 0x30052
{
	Global_23011.f_6 = 1;
}

void func_346(int iParam0)//Position - 0x30060
{
	switch (*iParam0)
	{
		case 0:
...
void func_347(int iParam0)//Position - 0x300B9
{
	switch (*iParam0)
	{
		case 0:
...
void func_348()//Position - 0x301A9
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		return;
...
int func_350(var uParam0, int iParam1)//Position - 0x30271
{
...
int func_352(var uParam0)//Position - 0x302E0
{
	int iVar0;
	int iVar1;
...
bool func_353(char* sParam0, int iParam1, char* sParam2)//Position - 0x30303
{
...
void func_354()//Position - 0x30321
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
	...
	if (MISC::GET_GAME_TIMER() > iLocal_498)
	{
		if (func_370(&iVar1))
		{
			...
			{
				func_362(&(Local_502[iVar1 /*33*/]), Var2, 0, 0);
				Local_502[iVar1 /*33*/].f_32 = 1;
				Local_502[iVar1 /*33*/].f_14 = 150f;
				iLocal_498 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_499, iLocal_500));
				func_361(&(Local_502[iVar1 /*33*/]));
			}
			else if (func_355(&Var2))
			{
				func_362(&(Local_502[iVar1 /*33*/]), Var2, 0, 0);
				iLocal_498 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_499, iLocal_500));
			}
...
int func_355(var uParam0)//Position - 0x30447
{
	if (iLocal_113 == 0)
	{
		return 0;
	...
	if (bLocal_493)
	{
		*uParam0 = { func_359(Local_494, fLocal_495, 6f) };
	}
	else
	{
		*uParam0 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 360f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(fLocal_496, fLocal_497), 6f) };
	}
	return func_356(uParam0, 0);
}

int func_356(var uParam0, bool bParam1)//Position - 0x304A1
{
	struct<3> Var0;
	float fVar1;
	...
	if (func_358(PLAYER::PLAYER_PED_ID(), Var0, fVar1, 1))
	{
		return 0;
	}
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(Var0, Local_106, true) > fLocal_107)
	{
		return 0;
	}
	if (!OBJECT::IS_POINT_IN_ANGLED_AREA(Var0, Local_125[0 /*3*/], Local_125[1 /*3*/], Local_125.f_7, false, true))
	{
		return 0;
	}
	if (bLocal_117)
...
bool func_357(struct<3> Param0, float fParam1, int iParam2, bool bParam3)//Position - 0x30567
{
	return MISC::IS_POSITION_OCCUPIED(Param0, fParam1, false, false, true, false, false, iParam2, bParam3);
}

bool func_358(int iParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x30582
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), Param1) <= (fParam2 * fParam2);
}

Vector3 func_359(struct<3> Param0, float fParam1, float fParam2)//Position - 0x305A0
{
	struct<3> Var0;
	float fVar1;
	...
	fVar1 = (fParam2 / 2f);
	Var0 = { func_360(Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1)) };
	Var0.f_2 = MISC::GET_RANDOM_FLOAT_IN_RANGE(-fVar1, fVar1);
	return Param0 + Var0;
}

Vector3 func_360(struct<3> Param0, float fParam1)//Position - 0x305E8
{
	float fVar0;
...
void func_361(var uParam0)//Position - 0x3061F
{
...
int func_362(var uParam0, struct<3> Param1, int iParam2, bool bParam3)//Position - 0x30653
{
	if (bParam3)
	{
	...
	uParam0->f_2 = PED::CREATE_PED(26, iLocal_275, Param1, 0f, true, true);
	...
	*uParam0 = 1;
	...
	TASK::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_268, 1000f, -8f, -1, 1, 0f, false, false, false);
	iLocal_524++;
	return 1;
}

float func_363(int iParam0, int iParam1, bool bParam2)//Position - 0x308C1
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_364(int iParam0)//Position - 0x3091F
{
	float fVar0;
	
	fVar0 = func_365(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1);
	ENTITY::SET_ENTITY_HEADING(iParam0, fVar0);
}

float func_365(struct<2> Param0, Vector3 vParam1, struct<2> Param2, Vector3 vParam3, int iParam4)//Position - 0x30946
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_366(var uParam0, float fParam1)//Position - 0x309AB
{
	float fVar0;
	struct<3> Var1;
...
int func_367(var uParam0)//Position - 0x309EB
{
	int iVar0;
	int iVar1;
	struct<3> Var2[9];
	...
	while (iVar0 < 9)
	{
		if (iVar1 < Var2.f_0)
		{
			if (!PED::IS_ANY_PED_NEAR_POINT(Local_541[iVar0 /*3*/], 1.5f))
			{
				func_368(&Var2, iVar1, Local_541[iVar0 /*3*/]);
				iVar1++;
			}
		}
		else
	...
	else
	{
		...
		*uParam0 = { Var2[iVar3 /*3*/] };
		if (func_58(Var2[iVar3 /*3*/], 0f, 0f, 0f, 0))
		{
		}
		else
		{
...
void func_368(int iParam0, int iParam1, struct<3> Param2)//Position - 0x30A89
{
	*(iParam0[iParam1 /*3*/]) = { Param2 };
}

void func_369(var uParam0)//Position - 0x30A9D
{
	int iVar0;
...
int func_370(int iParam0)//Position - 0x30AC4
{
	int iVar0;
...
void func_371(int iParam0)//Position - 0x30AFC
{
	int iVar0;
...
int func_372(int iParam0)//Position - 0x30B8D
{
	int iVar0;
...
int func_373(int iParam0)//Position - 0x30BD1
{
	int iVar0;
...
int func_374(int iParam0)//Position - 0x30C09
{
	if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		return 0;
...
void func_375(int iParam0)//Position - 0x30C46
{
	switch (*iParam0)
	{
		case 0:
...
int func_376(int* iParam0, float fParam1)//Position - 0x30D31
{
...
void func_377(var uParam0)//Position - 0x30D4F
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
int func_378(var uParam0, float fParam1)//Position - 0x30D65
{
	if (func_382(uParam0))
	{
...
float func_379(var uParam0)//Position - 0x30D87
{
	if (func_382(uParam0))
	{
		if (func_381(uParam0))
		...
		{
			return (func_380(BitTest(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}

float func_380(bool bParam0)//Position - 0x30DC3
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_381(var uParam0)//Position - 0x30E1B
{
	return BitTest(*uParam0, 2);
}

bool func_382(var uParam0)//Position - 0x30E28
{
	return BitTest(*uParam0, 1);
}

void func_383(int* iParam0)//Position - 0x30E35
{
	if (!func_382(iParam0))
	{
		func_384(iParam0);
...
void func_384(int* iParam0)//Position - 0x30E4D
{
	func_385(iParam0, 0f);
}

void func_385(int* iParam0, float fParam1)//Position - 0x30E5C
{
	iParam0->f_1 = (func_380(BitTest(*iParam0, 4)) - fParam1);
	MISC::SET_BIT(iParam0, 1);
	MISC::CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}

void func_386(int iParam0)//Position - 0x30E87
{
	int iVar0;
	...
	switch (*iParam0)
	{
		case 0:
			...
			if (!func_413(&uLocal_128))
			{
				func_406();
			}
			*iParam0 = 1;
			func_405();
			func_404(&Local_94, 0, 0);
			func_393(&Local_94, 1, 1, 0);
			func_392();
			func_391(iLocal_127);
			AUDIO::SET_AMBIENT_ZONE_STATE(sLocal_473, true, false);
			break;
		...
		case 1:
			...
			if (func_370(&iVar0))
			{
				func_362(&(Local_502[iVar0 /*33*/]), 212.9178f, -920.5014f, 30.6922f, 0, 0);
				Local_502[iVar0 /*33*/].f_14 = 15f;
				func_361(&(Local_502[iVar0 /*33*/]));
			}
			if (func_370(&iVar0))
			{
				func_362(&(Local_502[iVar0 /*33*/]), 213.2008f, -917.9012f, 30.6923f, 2, 0);
				Local_502[iVar0 /*33*/].f_14 = 15f;
				func_361(&(Local_502[iVar0 /*33*/]));
			}
			if (func_370(&iVar0))
			{
				func_362(&(Local_502[iVar0 /*33*/]), 217.8108f, -916.817f, 30.6923f, 4, 0);
				Local_502[iVar0 /*33*/].f_14 = 15f;
				func_361(&(Local_502[iVar0 /*33*/]));
			}
			if (func_370(&iVar0))
			{
				func_362(&(Local_502[iVar0 /*33*/]), 211.0789f, -912.207f, 30.6923f, 8, 0);
				Local_502[iVar0 /*33*/].f_14 = 15f;
				func_361(&(Local_502[iVar0 /*33*/]));
			}
			func_285(500, 0);
		...
		case 2:
			func_389();
			func_387(Local_532, fLocal_533, 5, 1);
			if (iLocal_522 != 0 && MISC::GET_GAME_TIMER() > iLocal_522)
			{
				iLocal_522 = 0;
				iLocal_521 = 0;
...
void func_387(struct<3> Param0, float fParam1, int iParam2, bool bParam3)//Position - 0x310CC
{
	int iVar0;
	struct<3> Var1;
	...
	{
		if (func_376(&iLocal_534, fLocal_537))
		{
			if (func_370(&iVar0))
			{
				if (func_388(Param0, fParam1, &Var1))
				{
					if (func_362(&(Local_502[iVar0 /*33*/]), Var1, 0, 0))
					{
						if (bParam3)
						{
							func_361(&(Local_502[iVar0 /*33*/]));
...
int func_388(struct<3> Param0, float fParam1, var uParam2)//Position - 0x3114E
{
	if (iLocal_113 == 0)
	{
		return 0;
	}
	*uParam2 = { func_359(Param0, fParam1, 6f) };
	return func_356(uParam2, 1);
}

void func_389()//Position - 0x31176
{
	struct<2> Var0;
...
void func_390(int iParam0, int iParam1)//Position - 0x311DF
{
	int iVar0;
...
void func_391(int iParam0)//Position - 0x3124A
{
	int iVar0;
...
void func_392()//Position - 0x312E6
{
	iLocal_34 = MISC::GET_GAME_TIMER();
}

void func_393(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x312F4
{
...
void func_394(var uParam0, bool bParam1)//Position - 0x31314
{
	func_395(&(uParam0->f_41), bParam1);
}

void func_395(var uParam0, bool bParam1)//Position - 0x31326
{
	int iVar0;
...
void func_396(int* iParam0, bool bParam1)//Position - 0x31364
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_397(var uParam0, bool bParam1)//Position - 0x3139F
{
	func_398(&(uParam0->f_35), bParam1);
}

void func_398(var uParam0, bool bParam1)//Position - 0x313B1
{
	int iVar0;
...
void func_399(int* iParam0)//Position - 0x313EE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_400(int* iParam0)//Position - 0x31426
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_401(int iParam0)//Position - 0x314C2
{
	if (func_578(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_402(var uParam0, int iParam1)//Position - 0x314EC
{
	func_403(&(uParam0->f_28), iParam1);
}

void func_403(var uParam0, int iParam1)//Position - 0x314FE
{
	int iVar0;
...
void func_404(var uParam0, bool bParam1, bool bParam2)//Position - 0x3153F
{
	int iVar0;
...
void func_405()//Position - 0x31634
{
	func_41(&uLocal_308, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
...
void func_406()//Position - 0x31686
{
	func_412(&uLocal_128, 0, iLocal_123);
	func_411(&uLocal_128, 1, 4, "SCRIPT\BARRY_01_ALIEN_A", 0);
	func_411(&uLocal_128, 2, 4, "SCRIPT\BARRY_01_ALIEN_B", 0);
	func_411(&uLocal_128, 3, 4, "SCRIPT\BARRY_01_ALIEN_C", 0);
	func_410(&uLocal_128, 4, iLocal_275);
	func_410(&uLocal_128, 5, iLocal_276);
	func_409(&uLocal_128, 6, "BARY1", 0);
	func_407(&uLocal_128, 7);
	func_411(&uLocal_128, 8, 2, sLocal_256, 0);
	func_410(&uLocal_128, 9, iLocal_277);
}

int func_407(var uParam0, int iParam1)//Position - 0x31707
{
...
void func_408(var uParam0)//Position - 0x31748
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_409(var uParam0, int iParam1, char* sParam2, int iParam3)//Position - 0x3176D
{
	if (BitTest(uParam0->f_113, iParam1) || BitTest(uParam0->f_114, iParam1))
	{
		return 1;
...
int func_410(var uParam0, int iParam1, int iParam2)//Position - 0x317B7
{
	if (BitTest(uParam0->f_113, iParam1) || BitTest(uParam0->f_114, iParam1))
	{
		return 1;
...
int func_411(var uParam0, int iParam1, int iParam2, char* sParam3, char* sParam4)//Position - 0x31800
{
	if (BitTest(uParam0->f_113, iParam1) || BitTest(uParam0->f_114, iParam1))
	{
		return 1;
...
int func_412(var uParam0, int iParam1, int iParam2)//Position - 0x318D2
{
	if (BitTest(uParam0->f_113, iParam1) || BitTest(uParam0->f_114, iParam1))
	{
		return 1;
...
bool func_413(var uParam0)//Position - 0x31912
{
	bool bVar0;
	int iVar1;
...
int func_414(var uParam0, bool bParam1)//Position - 0x31986
{
...
int func_415(var uParam0, int iParam1)//Position - 0x31B86
{
	if (BitTest(uParam0->f_113, iParam1) || BitTest(uParam0->f_114, iParam1))
	{
		return 1;
...
void func_416(int iParam0)//Position - 0x31D1D
{
	int iVar0;
	char* sVar1;
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_336(1, 1093140480, 0))
			{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_94.f_28[0], sLocal_246, 2, func_581(49), 0);
				}
				if (func_578(Local_94.f_41[0]))
				{
				...
				iLocal_530 = func_431(PLAYER::PLAYER_PED_ID(), iLocal_127, 1, 0, 0, 0, 0, 0, 0);
				...
				func_429(0, 0, 1, 0);
				func_421();
				func_283(Local_108, 1, 0, 1, 1, 0, 1, 1, 1, 1, 1);
				func_420(&iLocal_103, 0);
				func_16();
				iLocal_529 = 0;
				func_281(&(Local_94.f_41[5]), iLocal_277);
				func_285(500, 0);
		...
		case 3:
			...
			if (iLocal_272 == 0)
			{
				...
				if (!GRAPHICS::ANIMPOSTFX_IS_RUNNING(sLocal_254))
				{
					GRAPHICS::ANIMPOSTFX_PLAY(sLocal_254, 0, true);
				}
			}
			else
			{
...
int func_417(int iParam0)//Position - 0x3220B
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
void func_419(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0x32287
{
...
void func_420(int iParam0, int iParam1)//Position - 0x322A5
{
...
void func_421()//Position - 0x32374
{
	if (func_331(func_333(), 1))
	{
		if (func_578(func_334()))
		{
			Local_542 = { ENTITY::GET_ENTITY_COORDS(func_334(), true) };
			fLocal_543 = ENTITY::GET_ENTITY_HEADING(func_334());
		}
	}
	if (!func_331(func_333(), 1) || func_8(func_334(), Local_108, 1) < 10f)
	{
		Local_542 = { Local_104 };
		fLocal_543 = fLocal_105;
	}
	func_422(Local_124[0 /*3*/], Local_124[1 /*3*/], Local_124.f_7, Local_104, fLocal_105, func_333(), 1, 1, 1, 0, 0);
	if (func_331(func_333(), 1))
	{
		func_287(func_334(), Local_542, fLocal_543, 24, 0);
	}
...
void func_422(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x32424
{
	func_423(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_423(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x3244E
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_425(iVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_424(struct<3> Param0)//Position - 0x32844
{
...
int func_425(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x3286E
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_426(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_426(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_426(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_426(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_426(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_426(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_426(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_426(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_426(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_426(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_426(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_426(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_426(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_426(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_426(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_426(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4))
		{
			return 1;
		}
	}
...
int func_426(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x32B64
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_427(struct<3> Param0)//Position - 0x32C18
{
	float fVar0;
	float fVar1;
...
void func_428(int iParam0)//Position - 0x32C57
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_429(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x32CBC
{
	if (iParam0 == 1)
	{
...
void func_430()//Position - 0x32D57
{
	int iVar0;
...
int func_431(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x32D77
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	while (func_435(iVar2, bVar6) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_435(iVar2, bVar6)))
			{
				if (func_434(func_435(iVar2, bVar6)))
				{
					iVar7 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_435(iVar2, bVar6));
				}
			}
		}
		bVar6++;
	...
	while (func_435(iVar2, bVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
		{
			...
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iVar1, func_435(iVar2, bVar8));
				func_432(iVar1, func_435(iVar2, bVar8));
			}
		}
		bVar8++;
	}
...
void func_432(int iParam0, int iParam1)//Position - 0x32EEB
{
	int iVar0;
...
int func_433(int iParam0)//Position - 0x32F09
{
	switch (iParam0)
	{
...
int func_434(int iParam0)//Position - 0x3308F
{
...
int func_435(int iParam0, bool bParam1)//Position - 0x33291
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_436(int iParam0)//Position - 0x33E32
{
	switch (iParam0)
	{
...
int func_437(int iParam0, var* uParam1)//Position - 0x33ECD
{
	int iVar0;
	int iVar1;
...
void func_438(int iParam0)//Position - 0x33F08
{
	int iVar0;
	int iVar1;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		func_439(iParam0, &(Global_113386.f_2363.f_539.f_1764));
		iVar1 = 0;
		while (iVar1 <= (8 - 1))
		{
...
void func_439(int iParam0, var uParam1)//Position - 0x33F65
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_440(Var7.f_1)) && iVar9 < 51)
			{
...
int func_440(int iParam0)//Position - 0x341EE
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_441(int iParam0)//Position - 0x343B6
{
	int iVar0;
...
void func_442(int iParam0)//Position - 0x3462A
{
	var uVar0;
	...
	switch (*iParam0)
	{
		...
		case 1:
			if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_257) && !func_339())
			{
				uVar0 = 16;
				...
				{
					TASK::TASK_PLAY_ANIM(Local_94.f_28[0], sLocal_257, "leadin", 8f, -4f, -1, 2, 0f, false, false, false);
		...
		case 2:
			if (func_578(Local_94.f_28[0]))
			{
				if (!func_339() || MISC::GET_GAME_TIMER() > iLocal_95)
				{
					*iParam0 = 4;
				}
			}
...
int func_443(char* sParam0, int iParam1)//Position - 0x347E5
{
	int iVar0;
...
void func_444()//Position - 0x34840
{
	if (func_578(PLAYER::PLAYER_PED_ID()))
	{
...
void func_445()//Position - 0x348B9
{
	func_485(0);
	func_340();
	func_446();
...
void func_446()//Position - 0x348CE
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_342(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_447()//Position - 0x34926
{
	int iVar0;
...
void func_448()//Position - 0x34982
{
	int iVar0;
	float fVar1;
...
void func_449(var uParam0)//Position - 0x34A0A
{
	struct<3> Var0;
	var uVar1;
	int iVar2;
	...
	{
		Var0 = { PED::GET_PED_BONE_COORDS(uParam0->f_2, 31086, Local_516) };
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uParam0->f_4, Var0, false, false, true);
		ENTITY::SET_ENTITY_COLLISION(uParam0->f_4, false, false);
	}
	if (func_478(uParam0) && bLocal_477 == 1)
	{
		if (iLocal_116 == 1)
		{
		}
		TASK::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_267, 8f, -8f, -1, 1, 0f, false, false, false);
		func_64(uParam0);
		func_66(&(uParam0->f_17));
		uParam0->f_1 = 13;
		uParam0->f_26 = 0;
	...
	else if (func_477(uParam0) && uParam0->f_3 == 0)
	{
	...
	switch (uParam0->f_1)
	{
		...
		case 2:
			...
			PED::SET_PED_CAN_BE_TARGETTED(uParam0->f_2, false);
			func_364(uParam0->f_2);
			TASK::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_268, 8f, -8f, -1, 1, 0f, false, false, false);
			GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_alien_teleport", uParam0->f_2, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_491, false, false, false);
		...
		case 4:
			...
			func_6(&(uParam0->f_3));
			func_66(&(uParam0->f_17));
			GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_alien_teleport", ENTITY::GET_ENTITY_COORDS(uParam0->f_2, true), ENTITY::GET_ENTITY_ROTATION(uParam0->f_2, 2), fLocal_491, false, false, false);
			AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "SPAWN", uParam0->f_2, "BARRY_01_SOUNDSET", false, 0);
			uParam0->f_7 = MISC::GET_GAME_TIMER() + 450;
			uParam0->f_1 = 5;
		...
		case 12:
			...
			else if (MISC::GET_GAME_TIMER() > uParam0->f_7)
			{
				...
				if (WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), iLocal_127, false))
				{
		...
		case 13:
			...
			if (bLocal_477 == 1)
			{
				...
				{
					TASK::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_267, 4f, -4f, -1, 1, 0f, false, false, false);
				}
				return;
			}
			uParam0->f_1 = 14;
		...
		case 18:
			if (!PED::IS_PED_RUNNING_RAGDOLL_TASK(uParam0->f_2))
			{
				...
				func_65(&(uParam0->f_24));
				uParam0->f_12 = 0f;
				uParam0->f_22 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_impact", uParam0->f_4, 0f, 0f, 0f, 0f, 0f, 0f, (fLocal_489 / 3f), false, false, false);
				uParam0->f_23 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_beam", uParam0->f_4, 0f, 0f, 0f, Local_517, fLocal_510, false, false, false);
				GRAPHICS::SET_PARTICLE_FX_LOOPED_FAR_CLIP_DIST(uParam0->f_23, uParam0->f_12);
				TASK::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, "MIND_CONTROL_B_Loop", 4f, -8f, -1, 1, 0f, false, false, false);
				uParam0->f_1 = 19;
			}
			break;
		...
		case 20:
			...
			if (TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_2, joaat("SCRIPT_TASK_PLAY_ANIM")) != 1)
			{
				TASK::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, "MIND_CONTROL_B_LOOP", 2f, -8f, -1, 1, 0f, false, false, false);
			}
			if (TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_2, joaat("SCRIPT_TASK_PLAY_ANIM")) == 1)
			{
				...
				{
					uParam0->f_22 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_charging", uParam0->f_4, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_490, false, false, false);
				}
				if (iLocal_116 == 1)
				{
				}
		...
		case 7:
			if (func_450(uParam0) || MISC::GET_GAME_TIMER() > uParam0->f_7)
			{
				...
				GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_alien_disintegrate", uParam0->f_2, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_492, false, false, false);
...
int func_450(var uParam0)//Position - 0x3546E
{
	if (uParam0->f_1 != 7)
	{
		return 0;
...
int func_451(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x354D4
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_452(var uParam0)//Position - 0x3554F
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
	...
	Var4 = { Var3 + ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_4) * FtoV((uParam0->f_12 + 3f)) };
	if (uParam0->f_26 == 0)
	{
		uParam0->f_26 = SHAPETEST::START_SHAPE_TEST_LOS_PROBE(Var3, Var4, 511, uParam0->f_2, 7);
	}
	else
	{
		iVar1 = SHAPETEST::GET_SHAPE_TEST_RESULT(uParam0->f_26, &iVar0, &Var5, &uVar6, &uVar7);
		if (iVar1 == 0)
		{
			uParam0->f_26 = 0;
		}
		else if (iVar1 == 2)
		{
			if (iVar0 > 0)
			{
				...
				uParam0->f_27 = { MISC::GET_CLOSEST_POINT_ON_LINE(Var5, Var3, Var4, false) };
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(uParam0->f_27, Var2, true) <= 0.7f)
				{
					...
					if (MISC::ABSF((uParam0->f_27.f_2 - Var2.f_2)) < 1f)
					{
						...
						{
							MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(Var3, Var4, 0, true, joaat("WEAPON_PISTOL"), 0, false, true, -1f);
						}
						if (iLocal_503 == 1)
						{
							ENTITY::APPLY_FORCE_TO_ENTITY(PLAYER::PLAYER_PED_ID(), 1, Vector(fLocal_515, fLocal_515, fLocal_515) * ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_4), 0f, 0f, 0f, 0, false, true, true, false, true);
						}
						if (iLocal_504 == 0)
						{
						...
						if (MISC::GET_GAME_TIMER() > uParam0->f_8)
						{
							...
							if ((ENTITY::GET_ENTITY_HEALTH(PLAYER::PLAYER_PED_ID()) - iLocal_505) <= 100)
							{
								func_68();
								func_60(1);
								func_453(Var3, Var4, 1);
								return;
							}
							else
							{
								PED::APPLY_DAMAGE_TO_PED(PLAYER::PLAYER_PED_ID(), iLocal_505, false, 0);
							}
							uParam0->f_8 = (MISC::GET_GAME_TIMER() + SYSTEM::ROUND((IntToFloat(iLocal_506) * 1.25f)));
							PAD::SET_CONTROL_SHAKE(0, (iLocal_506 / 2), 255);
							PAD::SET_CONTROL_SHAKE(0, (iLocal_506 / 2), 255);
						}
					}
				}
	...
	{
		uParam0->f_24 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_impact", uParam0->f_5, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_489, false, false, false);
	}
}

void func_453(struct<3> Param0, struct<3> Param1, int iParam2)//Position - 0x359A9
{
	PLAYER::SET_PLAYER_HEALTH_RECHARGE_MULTIPLIER(PLAYER::PLAYER_ID(), 0f);
	if (!func_424(Param0) && !func_424(Param1))
	{
	}
	iLocal_101 = func_15(iLocal_127, 0);
	func_396(&iLocal_101, 0);
	if (iParam2 == 1)
	{
...
void func_454()//Position - 0x35A05
{
...
void func_455(char* sParam0, int iParam1)//Position - 0x35A5F
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

void func_456(var uParam0)//Position - 0x35A76
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	Var1 = { func_460(CAM::GET_FINAL_RENDERED_CAM_ROT(2)) };
	Var2 = { Var0 + Var1 * FtoV(CAM::GET_FINAL_RENDERED_CAM_NEAR_CLIP()) };
	fVar5 = (fLocal_489 * 1.25f);
	if (func_459(&Var3, ENTITY::GET_ENTITY_COORDS(uParam0->f_4, true), ENTITY::GET_ENTITY_COORDS(uParam0->f_5, true), Var1, Var2))
	{
		if (CAM::IS_SPHERE_VISIBLE(Var3, 0.5f))
		{
			iVar6 = func_457(Var1, Var0, ENTITY::GET_ENTITY_COORDS(uParam0->f_4, true));
			iVar7 = func_457(Var1, Var0, ENTITY::GET_ENTITY_COORDS(uParam0->f_5, true));
			if (iVar6 > 0 && iVar7 < 0)
			{
				Var3 = { Var3 - ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_4) * Vector(fLocal_518, fLocal_518, fLocal_518) };
			}
			else if (iVar6 < 0 && iVar7 > 0)
			{
				Var3 = { Var3 + ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_4) * FtoV((fLocal_518 * 4.5f)) };
			}
			if (!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uParam0->f_25))
			{
				uParam0->f_25 = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD("scr_alien_impact", Var3, 0f, 0f, 0f, fVar5, false, false, false, false);
			}
...
int func_457(struct<3> Param0, struct<3> Param1, struct<3> Param2)//Position - 0x35BD3
{
	float fVar0;
	
	fVar0 = func_458(Param2 - Param1, Param0);
	if (fVar0 < 0f)
	{
		return -1;
	}
...
float func_458(struct<3> Param0, struct<3> Param1)//Position - 0x35C08
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

int func_459(var uParam0, struct<3> Param1, struct<3> Param2, struct<3> Param3, struct<3> Param4)//Position - 0x35C29
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	Var0 = { Param2 - Param1 };
	Var1 = { Param1 - Param4 };
	fVar2 = func_458(Param3, Var0);
	fVar3 = -func_458(Param3, Var1);
...
Vector3 func_460(struct<3> Param0)//Position - 0x35CA9
{
	return (-SYSTEM::SIN(Param0.f_2) * SYSTEM::COS(Param0.f_0)), (SYSTEM::COS(Param0.f_2) * SYSTEM::COS(Param0.f_0)), SYSTEM::SIN(Param0.f_0);
}

void func_461(int iParam0, struct<3> Param1)//Position - 0x35CD6
{
	float fVar0;
	float fVar1;
	
	func_462(ENTITY::GET_ENTITY_COORDS(iParam0, true), Param1, &fVar0, &fVar1, 1);
	ENTITY::SET_ENTITY_ROTATION(iParam0, fVar0, 0f, fVar1, 2, true);
}

void func_462(struct<3> Param0, struct<3> Param1, var uParam2, var uParam3, int iParam4)//Position - 0x35CFF
{
	struct<3> Var0;
	
	Var0 = { Param1 - Param0 };
	func_463(Var0, uParam2, uParam3, iParam4);
}

void func_463(struct<3> Param0, var uParam1, var uParam2, int iParam3)//Position - 0x35D22
{
	float fVar0;
...
void func_464(var uParam0)//Position - 0x35DC7
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (uParam0->f_26 == 0)
	{
		Var4 = { PED::GET_PED_BONE_COORDS(PLAYER::PLAYER_PED_ID(), 31086, 0f, 0f, 0f) };
		uParam0->f_26 = SHAPETEST::START_SHAPE_TEST_LOS_PROBE(Var3, Var4, 511, PLAYER::PLAYER_PED_ID(), 7);
	...
	{
		iVar1 = SHAPETEST::GET_SHAPE_TEST_RESULT(uParam0->f_26, &iVar0, &Var4, &uVar5, &uVar6);
		if (iVar1 == 2)
		{
			if (iVar0 == 0 && func_9())
			{
				...
				TASK::TASK_PLAY_ANIM(0, sLocal_256, "MIND_CONTROL_B_Enter", 8f, -8f, -1, 2, 0f, false, false, false);
				TASK::CLOSE_SEQUENCE_TASK(iVar2);
...
void func_465(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x35FDB
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_466(iParam3), false);
}

int func_466(int iParam0)//Position - 0x35FF4
{
	int iVar0;
...
void func_467(var uParam0)//Position - 0x36201
{
	int iVar0;
	float fVar1;
	...
	{
		GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_alien_teleport", PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 0f, 0f, 0f, fLocal_491, false, false, false);
		uParam0->f_19 = MISC::GET_GAME_TIMER() + 2000;
	}
	if (uParam0->f_18 > iLocal_483 || TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_2, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) > 1)
	{
		...
		{
			TASK::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_263, 8f, -8f, -1, 0, 0f, false, false, false);
		}
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_262, 3))
		{
			TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
			TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_264, 8f, -4f, -1, 0, 0f, false, false, false);
	...
	if (MISC::GET_GAME_TIMER() > uParam0->f_7)
	{
		TASK::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_265, 8f, -8f, -1, 0, 0f, false, false, false);
		func_66(&(uParam0->f_17));
		func_468();
	}
}

void func_468()//Position - 0x36465
{
...
bool func_469(char* sParam0)//Position - 0x36483
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

int func_470(float fParam0)//Position - 0x36496
{
	if (fParam0 < 0f)
	{
		return -1;
...
void func_471(var uParam0)//Position - 0x364AD
{
	int iVar0;
	...
	func_364(uParam0->f_2);
	TASK::OPEN_SEQUENCE_TASK(&iVar0);
	TASK::TASK_PLAY_ANIM(0, sLocal_256, sLocal_259, 8f, -8f, -1, 0, 0f, false, false, false);
	TASK::TASK_PLAY_ANIM(0, sLocal_256, sLocal_261, 8f, -8f, -1, 1, 0f, false, false, false);
	TASK::CLOSE_SEQUENCE_TASK(iVar0);
	...
	TASK::OPEN_SEQUENCE_TASK(&iVar0);
	TASK::TASK_PLAY_ANIM(0, sLocal_256, sLocal_260, 8f, -8f, -1, 0, 0f, false, false, false);
	TASK::TASK_PLAY_ANIM(0, sLocal_256, sLocal_262, 8f, -8f, -1, 1, 0f, false, false, false);
	TASK::CLOSE_SEQUENCE_TASK(iVar0);
	TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iVar0);
	TASK::CLEAR_SEQUENCE_TASK(&iVar0);
	PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), false, false);
	...
	if (iLocal_523 == 0)
	{
		...
		CAM::SET_GAMEPLAY_PED_HINT(uParam0->f_2, 0f, 0f, 0f, true, iLocal_484 + 2000, 2000, 2000);
	}
	else
	{
		uParam0->f_7 = (MISC::GET_GAME_TIMER() + iLocal_484);
		CAM::SET_GAMEPLAY_PED_HINT(uParam0->f_2, 0f, 0f, 0f, true, iLocal_484, 2000, 2000);
	}
	iLocal_523++;
	uParam0->f_18 = 0;
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
...
void func_472()//Position - 0x3674F
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		return;
...
void func_473(int iParam0, int iParam1)//Position - 0x3679E
{
	float fVar0;
	
	fVar0 = func_365(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(iParam1, true), 1);
	ENTITY::SET_ENTITY_HEADING(iParam0, fVar0);
}

int func_474(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x367C3
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_427(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var1 = { func_427(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_458(Var1, Var0);
...
bool func_475(var uParam0)//Position - 0x36854
{
	if (uParam0->f_32)
	{
		return 0;
...
int func_476(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x36894
{
	int iVar0;
	bool bVar1;
...
bool func_477(var uParam0)//Position - 0x368E6
{
	int iVar0;
...
bool func_478(var uParam0)//Position - 0x368F9
{
	return ((((uParam0->f_1 == 20 || uParam0->f_1 == 19) || uParam0->f_1 == 18) || uParam0->f_1 == 17) || uParam0->f_1 == 15);
}

void func_479(var uParam0)//Position - 0x3693C
{
...
int func_480(var uParam0)//Position - 0x369AF
{
	if (!func_484(uParam0))
	{
		...
		if (ENTITY::IS_ENTITY_DEAD(uParam0->f_2, false) || PED::IS_PED_INJURED(uParam0->f_2))
		{
			...
			func_483("ALIEN_DEATH", "ALIENS", ENTITY::GET_ENTITY_COORDS(uParam0->f_2, true), 10);
			func_64(uParam0);
			func_66(&(uParam0->f_17));
			func_14(&(uParam0->f_4));
			func_14(&(uParam0->f_5));
			...
			if ((iLocal_525 % 5) == 0)
			{
				...
				if (iLocal_519 >= Local_502.f_0)
				{
					iLocal_519 = Local_502.f_0;
				}
			}
			uParam0->f_1 = 7;
			return 1;
...
void func_481(int iParam0)//Position - 0x36B3F
{
	bool bVar0;
	int iVar1;
...
void func_482()//Position - 0x36BB0
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		return;
...
void func_483(char* sParam0, char* sParam1, struct<3> Param2, int iParam3)//Position - 0x36C3E
{
	AUDIO::PLAY_AMBIENT_SPEECH_FROM_POSITION_NATIVE(sParam0, sParam1, Param2, func_466(iParam3));
}

bool func_484(var uParam0)//Position - 0x36C58
{
	return (uParam0->f_1 == 7 || uParam0->f_1 == 8);
}

void func_485(int iParam0)//Position - 0x36C73
{
	if (func_490())
	{
		return;
...
void func_486(int iParam0)//Position - 0x36CA6
{
	if (func_490())
	{
		return;
...
void func_487(bool bParam0, bool bParam1)//Position - 0x36D30
{
	if (bParam0)
	{
		if (func_489(0))
...
bool func_488()//Position - 0x36DA4
{
	return BitTest(Global_1958711, 5);
}

int func_489(int iParam0)//Position - 0x36DB2
{
	if (iParam0 == 1)
	{
		if (Global_20266.f_1 > 3)
...
bool func_490()//Position - 0x36E09
{
	return BitTest(Global_1958711, 19);
}

void func_491()//Position - 0x36E18
{
	PED::SET_PED_DENSITY_MULTIPLIER_THIS_FRAME(0f);
...
void func_492(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x36E3A
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78573 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_494(Global_78574, Global_78576, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
float func_493(char* sParam0)//Position - 0x3711F
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_494(int iParam0, int iParam1, int iParam2)//Position - 0x37132
{
	struct<2> Var0;
	int iVar1;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_495(iVar1), 8);
					break;
			}
			break;
...
char* func_495(int iParam0)//Position - 0x37207
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_496(int iParam0)//Position - 0x3736F
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_497(int iParam0)//Position - 0x373A2
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_498(int iParam0)//Position - 0x373D5
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_499(int iParam0)//Position - 0x37408
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_500(int iParam0)//Position - 0x3743B
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_501(int iParam0)//Position - 0x37478
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_502(int iParam0)//Position - 0x374AB
{
	struct<2> Var0;
...
int func_503(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x37518
{
	if (((!func_505(0) || Global_78588) || Global_78577 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78573)
...
bool func_504(bool bParam0)//Position - 0x37631
{
	if (bParam0)
	{
...
int func_505(int iParam0)//Position - 0x3765A
{
	if (Global_43052 == 15)
	{
		return 0;
...
bool func_506(int iParam0)//Position - 0x3767C
{
	return func_507(iParam0, Global_43052);
}

int func_507(int iParam0, int iParam1)//Position - 0x3768D
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_508(bool bParam0)//Position - 0x3786E
{
...
void func_509(int iParam0)//Position - 0x37896
{
	if (iParam0 > 0)
	{
	}
...
void func_510(struct<3> Param0, float fParam1, var uParam2, var uParam3)//Position - 0x378A4
{
	struct<3> Var0;
...
int func_511(int iParam0, int iParam1)//Position - 0x378D0
{
	int iVar0;
...
void func_512()//Position - 0x3792E
{
	...
	func_531(&Local_125, 126.5859f, -903.2452f, 87.53514f, 266.4236f, -956.5806f, 27.45261f, 230f);
	func_531(&Local_124, 168.85f, -1001.024f, 23.09129f, 225.9042f, -862.5969f, 34.09233f, 55f);
	func_530();
	func_529();
	func_528();
	...
	if (func_525() == 1)
	{
		...
		AUDIO::SET_AMBIENT_ZONE_STATE(sLocal_473, true, false);
		func_406();
		while (!func_413(&uLocal_128))
		{
			SYSTEM::WAIT(0);
		}
		func_515(Local_528, 327.2303f, 0, 0);
...
void func_513(int iParam0, int iParam1, int iParam2)//Position - 0x37B2B
{
...
var func_514()//Position - 0x37BEF
{
	return BitTest(Global_100441.f_20, 13);
}

void func_515(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x37C00
{
	if (func_525())
	{
...
int func_516(var uParam0)//Position - 0x37C95
{
	int iVar0[7];
	struct<3> Var1;
	float fVar2;
	...
	switch (iLocal_80)
	{
		...
		case 2:
			...
			{
				if (func_517(&(uParam0->f_28[0]), 49, Var1, fVar2, "RC LAUNCHER: BARRY 1", 1))
				{
...
int func_517(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0x380FA
{
	if (func_518(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_518(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0x38156
{
	int iVar0;
...
int func_519(var uParam0, int iParam1)//Position - 0x381E4
{
	int iVar0;
...
int func_520(var uParam0)//Position - 0x3822A
{
	if (func_521(uParam0))
	{
...
int func_521(var uParam0)//Position - 0x38254
{
...
int func_522(int iParam0)//Position - 0x38279
{
	int iVar0;
...
void func_523(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x382AA
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
float func_524(float fParam0)//Position - 0x382E6
{
	return (fParam0 * 57.29578f);
}

int func_525()//Position - 0x382F6
{
...
void func_526(bool bParam0)//Position - 0x3831A
{
	if (bParam0)
	{
...
void func_527(int iParam0, bool bParam1)//Position - 0x38346
{
	if (bParam1)
	{
...
void func_528()//Position - 0x38368
{
	func_368(&Local_541, 0, 175.5842f, -964.2895f, 35.0957f);
	func_368(&Local_541, 1, 183.1626f, -970.6071f, 35.0957f);
	func_368(&Local_541, 2, 179.9724f, -943.0597f, 34.0921f);
	func_368(&Local_541, 3, 185.2821f, -935.3659f, 34.0922f);
	func_368(&Local_541, 4, 199.9392f, -951.7982f, 35.0511f);
	func_368(&Local_541, 5, 190.3101f, -976.7255f, 35.0916f);
	func_368(&Local_541, 6, 205.6451f, -974.7205f, 35.0476f);
	func_368(&Local_541, 7, 212.8866f, -936.2545f, 33.7047f);
	func_368(&Local_541, 8, 194.1555f, -957.8777f, 33.3463f);
}

void func_529()//Position - 0x38440
{
	iLocal_127 = joaat("WEAPON_MINIGUN");
	fLocal_488 = 7.5f;
	iLocal_483 = 10;
...
void func_530()//Position - 0x384F5
{
	int iVar0;
...
void func_531(var uParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x3851F
{
	*(uParam0[0 /*3*/]) = { Param1 };
	*(uParam0[1 /*3*/]) = { Param2 };
	uParam0->f_7 = fParam3;
...
void func_532(bool bParam0)//Position - 0x38543
{
	if (bParam0)
	{
		func_533();
...
void func_533()//Position - 0x385A6
{
...
void func_534(bool bParam0)//Position - 0x385CF
{
...
void func_535(bool bParam0)//Position - 0x38629
{
	int iVar0;
...
void func_536(int iParam0, bool bParam1)//Position - 0x3864C
{
	if (bParam1)
	{
	...
	else if (func_540(iParam0, 2, 1))
	{
		func_537(iParam0, 2, 1);
	}
}

void func_537(int iParam0, int iParam1, bool bParam2)//Position - 0x38683
{
	int iVar0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_87() == 0)
		{
			iVar0 = func_149(func_538(iParam0), -1, 0);
			MISC::CLEAR_BIT(&iVar0, iParam1);
			func_147(func_538(iParam0), iVar0, -1, 1, 0);
		}
	}
	else
	{
...
int func_538(int iParam0)//Position - 0x386F5
{
	switch (iParam0)
	{
		case 0:
...
void func_539(int iParam0, int iParam1, bool bParam2)//Position - 0x38A70
{
	int iVar0;
...
int func_540(int iParam0, int iParam1, bool bParam2)//Position - 0x38AE2
{
	if (iParam0 == -1)
	{
		return 0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_87() == 0)
		{
			return BitTest(func_149(func_538(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_541()//Position - 0x38B43
{
	func_430();
	if (func_545())
	{
	...
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
	AUDIO::CLEAR_AMBIENT_ZONE_STATE(sLocal_473, true);
	func_393(&Local_94, 0, 0, 0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_542(int iParam0)//Position - 0x38C9D
{
...
void func_543(var uParam0)//Position - 0x38D00
{
	bool bVar0;
...
int func_544(var uParam0, bool bParam1)//Position - 0x38D25
{
...
void func_546(bool bParam0)//Position - 0x38FB6
{
	int iVar0;
...
void func_547(char* sParam0, int iParam1)//Position - 0x39086
{
	if (Global_100441 != 12)
	{
...
int func_548(char* sParam0, int iParam1, int iParam2)//Position - 0x390AE
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
	...
	if (func_554())
	{
		...
		{
			iVar2 = func_549(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_549(char* sParam0)//Position - 0x3923D
{
...
int func_550()//Position - 0x39297
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_551(&(Global_100441.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_551(char* sParam0, bool bParam1)//Position - 0x392BB
{
	int iVar0;
	int iVar1;
...
int func_552(int iParam0, bool bParam1)//Position - 0x392E5
{
	int iVar0;
...
int func_554()//Position - 0x3936B
{
	...
	{
		if (func_549(&(Global_100441.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_555(bool bParam0)//Position - 0x393D7
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_556(int iParam0)//Position - 0x393EB
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_557(int iParam0)//Position - 0x39425
{
	if (iParam0 == 1)
	{
...
void func_558()//Position - 0x3945F
{
	Global_23011.f_5 = 1;
}

void func_559()//Position - 0x3946D
{
	Global_23011.f_5 = 0;
}

void func_560()//Position - 0x3947B
{
	Global_94617 = 0;
	Global_94618 = 0;
}

int func_561()//Position - 0x3948D
{
...
void func_562()//Position - 0x394CB
{
	Global_100476 = 1;
...
void func_563(char* sParam0, bool bParam1)//Position - 0x395BC
{
	func_564(sParam0);
	func_546(bParam1);
}

void func_564(char* sParam0)//Position - 0x395D0
{
...
void func_565(char* sParam0)//Position - 0x3960E
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_566(int iParam0)//Position - 0x39620
{
	if (func_31(iParam0))
	{
...
void func_567(int iParam0, bool bParam1)//Position - 0x39658
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_31(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		...
		{
			func_439(iParam0, &(Global_113386.f_2363.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_568(int iParam0, bool bParam1)//Position - 0x3974B
{
	int iVar0;
	int iVar1;
	...
	{
		iVar0 = func_32(iParam0);
		func_569(iParam0, &(Global_113386.f_2363.f_539.f_1764), bParam1);
		iVar1 = 0;
		while (iVar1 <= (8 - 1))
		{
...
void func_569(int iParam0, var uParam1, bool bParam2)//Position - 0x397A8
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		iVar13 = FILES::GET_NUM_DLC_WEAPONS_SP();
		iVar7 = 0;
		while (iVar7 < 2)
		{
			iVar5 = 0;
				...
				if (iVar1 != 0 && iVar1 != joaat("SLOT_UNARMED"))
				{
					...
					if (iVar2 != 0 && iVar2 != joaat("WEAPON_UNARMED"))
					{
						if (func_575(iVar2))
						{
							if (iVar7 == 0)
							{
								iVar14[iVar5] = WEAPON::GET_AMMO_IN_PED_WEAPON(iParam0, iVar2);
							}
							else
							{
				...
				if (iVar8 < 51)
				{
					if (FILES::GET_DLC_WEAPON_DATA_SP(iVar8, &Var9))
					{
						if (!FILES::IS_CONTENT_ITEM_LOCKED(Var9.f_0) && !func_440(Var9.f_1))
						{
							if (iVar7 == 0)
							{
								iVar15[iVar8] = WEAPON::GET_AMMO_IN_PED_WEAPON(iParam0, Var9.f_1);
							}
							else
							{
		...
		while (iVar5 <= (44 - 1))
		{
			...
			if (iVar1 != 0 && iVar1 != joaat("SLOT_UNARMED"))
			{
				...
				if (!bParam2)
				{
					if (iVar2 != 0 && iVar2 != joaat("WEAPON_UNARMED"))
					{
						if (WEAPON::GET_AMMO_IN_PED_WEAPON(iParam0, iVar2) < iVar14[iVar5])
						{
							WEAPON::SET_PED_AMMO(iParam0, iVar2, iVar14[iVar5], false);
						}
					}
				}
			}
			...
			if ((iVar8 != -1 && iVar8 < 51) && !func_440(Var9.f_1))
			{
				...
				if (iVar3 != 0)
				{
					if (iVar3 != joaat("WEAPON_UNARMED"))
					{
						...
						{
							if (FILES::GET_DLC_WEAPON_COMPONENT_DATA_SP(iVar8, bVar6, &Var10))
							{
								if (!func_436(Var10.f_3))
								{
									...
									else if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar3, Var10.f_3))
									{
										...
										func_571(iParam0, iVar3, Var10.f_3);
									}
									bVar12++;
								}
							}
						...
						while (bVar6 < FILES::GET_NUM_DLC_WEAPON_COMPONENTS_SP(iVar8))
						{
							if (FILES::GET_DLC_WEAPON_COMPONENT_DATA_SP(iVar8, bVar6, &Var10))
							{
								if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, Var10.f_3))
								{
									...
									func_571(iParam0, iVar2, Var10.f_3);
								}
							}
							bVar6++;
						}
				...
				if (!bParam2)
				{
					...
					{
						if (WEAPON::GET_AMMO_IN_PED_WEAPON(iParam0, iVar3) < iVar15[iVar8])
						{
							WEAPON::SET_PED_AMMO(iParam0, iVar3, iVar15[iVar8], false);
						}
					}
				}
			}
...
int func_570(int iParam0, var* uParam1)//Position - 0x39E0D
{
	int iVar0;
	int iVar1;
...
void func_571(int iParam0, int iParam1, int iParam2)//Position - 0x39E48
{
	int iVar0;
...
void func_572(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x39E75
{
	int iVar0;
...
int func_573(int iParam0)//Position - 0x39E97
{
	switch (iParam0)
	{
...
void func_574(int iParam0, int iParam1, int iParam2)//Position - 0x3A1CC
{
	int iVar0;
...
bool func_575(int iParam0)//Position - 0x3A1EC
{
	int iVar0;
	struct<2> Var1;
	...
	switch (iParam0)
	{
		...
		case joaat("WEAPON_HATCHET"):
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				if (!func_300() && !Global_262145.f_20269)
				{
					return 0;
				}
			}
...
int func_576(bool bParam0, bool bParam1)//Position - 0x3A318
{
	if (bParam0)
	{
...
bool func_577()//Position - 0x3A381
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

int func_578(int iParam0)//Position - 0x3A392
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_579(var uParam0)//Position - 0x3A3B3
{
...
void func_580(var uParam0)//Position - 0x3A3D3
{
	int iVar0;
...
int func_581(int iParam0)//Position - 0x3A40D
{
	if (!func_31(iParam0))
	{
		return func_34(iParam0);
