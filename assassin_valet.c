...
void __EntryFunction__()//Position - 0x0
{
	...
	Local_1064 = { -1236.661f, -197.316f, 39.6313f };
	Local_1065 = { -1266.027f, -218.9829f, 41.44594f };
	Local_1067 = { -1237.731f, -189.5452f, 40.63728f };
	fLocal_1068 = 40f;
	...
	Local_1417 = { -1263.677f, -222.2767f, 41.446f };
	fLocal_1418 = 304.201f;
	Local_1419 = { -1507.252f, -934.3307f, 8.6562f };
	fLocal_1420 = 137.9228f;
	Local_1423 = { -1510.733f, -935.96f, 10.90214f };
	Local_1424 = { 15.07491f, -0.024198f, -71.86189f };
	Local_1425 = { -1510.878f, -936.1155f, 9.798549f };
...
void func_212(var uParam0, float fParam1, bool bParam2)//Position - 0x9FE5
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_230();
		GRAPHICS::DRAW_RECT(0.5f, (fVar1 - (func_233((2f - 0.5f)) - 0.001388889f)), fVar6, func_227(1f), iVar13, iVar14, iVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), false);
	}
	else
	{
		return;
...
void func_381()//Position - 0x168E3
{
	switch (iLocal_1022)
	{
		case 0:
			...
			{
				func_411(-1248.398f, -183.366f, 37.72881f, -1216.437f, -196.8727f, 44.07541f, 59.25f, Local_1417, fLocal_1418, 1, 1, 1, 0, 0);
	...
	switch (iLocal_1023)
	{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_1069, false))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1069, false))
				{
					if (SYSTEM::TIMERA() > 6000)
					{
						...
						CAM::SET_CAM_PARAMS(iLocal_1082, -1218.861f, -191.0496f, 38.83616f, 3.519839f, -0.000706f, 42.27108f, 38f, 0, 1, 1, 2);
						CAM::SET_CAM_NEAR_DOF(iLocal_1082, 0.5f);
						CAM::SET_CAM_FAR_DOF(iLocal_1082, 7f);
						CAM::SHAKE_CAM(iLocal_1082, "HAND_SHAKE", 0.2f);
						CAM::SET_CAM_PARAMS(iLocal_1083, -1218.91f, -190.8791f, 38.84585f, 3.519839f, -0.000706f, 43.33815f, 38f, 0, 1, 1, 2);
		...
		case 3:
			if (SYSTEM::TIMERA() >= 2000)
			{
				...
				{
					CAM::SET_CAM_PARAMS(iLocal_1082, -1265.549f, -213.4919f, 43.0913f, -0.055f, 0.0543f, -50.0795f, 38f, 0, 1, 1, 2);
					CAM::SHAKE_CAM(iLocal_1082, "HAND_SHAKE", 0.2f);
					CAM::SET_CAM_PARAMS(iLocal_1083, -1266.063f, -213.922f, 43.0918f, -0.055f, 0.0543f, -50.0795f, 38f, 0, 1, 1, 2);
					CAM::SHAKE_CAM(iLocal_1083, "HAND_SHAKE", 0.2f);
				...
				{
					CAM::SET_CAM_PARAMS(iLocal_1082, -1266.193f, -215.217f, 43.2442f, -3.1088f, 0.0498f, -48.5594f, 38f, 0, 1, 1, 2);
					CAM::SHAKE_CAM(iLocal_1082, "HAND_SHAKE", 0.2f);
					CAM::SET_CAM_PARAMS(iLocal_1083, -1267.53f, -215.7824f, 43.1067f, -9.2365f, 0.0498f, -48.3561f, 38f, 0, 1, 1, 2);
					CAM::SHAKE_CAM(iLocal_1083, "HAND_SHAKE", 0.2f);
					CAM::SET_CAM_ACTIVE_WITH_INTERP(iLocal_1083, iLocal_1082, 4000, 3, 3);
					iLocal_1041 = 4000;
				}
...
void func_406()//Position - 0x17C78
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1072))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1072, false))
		{
			...
			ENTITY::SET_ENTITY_COORDS(iLocal_1072, -1251.873f, -256.7999f, 38.2695f, true, false, false, true);
			...
			if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			{
				if (!func_425())
				{
					if (!HUD::DOES_BLIP_EXIST(iLocal_953))
					{
						...
						func_423(&iLocal_953, -1234.307f, -250.6783f, 38.2238f, 28.914f);
						if (!iLocal_962)
						{
...
void func_416()//Position - 0x1838E
{
	if (!iLocal_961)
	{
		...
		{
			func_418();
			iLocal_959 = STREAMING::STREAMVOL_CREATE_FRUSTUM(-1244.344f, -251.566f, 50.3194f, -9.2001f, 0.0498f, 6.3064f, 80f, 12, 127);
			iLocal_961 = 1;
		}
	}
...
void func_427()//Position - 0x186C8
{
	...
	switch (iLocal_1029)
	{
		...
		case 1:
			Local_1431[0] = PED::CREATE_PED(4, joaat("A_F_M_BevHills_01"), -1220.679f, -203.2689f, 38.3251f, 321.2841f, true, true);
			...
			TASK::CLEAR_SEQUENCE_TASK(&iVar0);
			Local_1431.f_4 = VEHICLE::CREATE_VEHICLE(joaat("taxi"), -1221.73f, -199.0665f, 38.1751f, 152.5038f, true, true, false);
			...
			Local_1431.f_8[0] = PED::CREATE_PED(4, joaat("A_M_M_BevHills_01"), -1211.597f, -184.5331f, 38.3255f, 4.5193f, true, true);
			Local_1431.f_8[1] = PED::CREATE_PED(4, joaat("A_M_Y_Hipster_01"), -1211.654f, -182.7625f, 38.3255f, 166.2532f, true, true);
			...
			Local_1431.f_5[0] = PED::CREATE_PED(4, joaat("A_M_M_BevHills_01"), -1229.099f, -176.3197f, 38.3255f, 231.8036f, true, true);
			Local_1431.f_5[1] = PED::CREATE_PED(4, joaat("A_F_M_BevHills_02"), -1249.779f, -162.4767f, 39.4131f, 220.1651f, true, true);
...
void func_428()//Position - 0x18AB7
{
	...
	{
		fLocal_1053 = SYSTEM::VDIST(-1510.291f, -946.9932f, 8.278f, Local_1065);
	}
...
{
	iLocal_1073[0] = VEHICLE::CREATE_VEHICLE(iLocal_1081, -1270.045f, -251.4953f, 41.4459f, 214.63f, true, true, false);
	iLocal_1073[1] = VEHICLE::CREATE_VEHICLE(iLocal_1081, -1265.199f, -218.4823f, 45.9981f, 127.85f, true, true, false);
}

void func_443()//Position - 0x190D5
{
	iLocal_1082 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), -1244.344f, -251.566f, 50.3194f, -9.2001f, 0.0498f, 6.3064f, 38f, false, 2);
	iLocal_1083 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), -1243.588f, -251.4826f, 50.3187f, -9.2001f, 0.0498f, 6.3064f, 38f, false, 2);
}
...
{
	Local_1059 = { -1343.493f, -153.199f, 47.1825f };
	fLocal_1047 = 260.3612f;
	Local_1060 = { -1242.213f, -241.5975f, 38.71f };
	fLocal_1043 = 96.8755f;
	Local_1061 = { -1221.631f, -186.8819f, 38.7996f };
	fLocal_1044 = 201.0763f;
	fLocal_1048 = 40f;
	Local_320.f_2 = 40f;
	Local_1056[0 /*3*/] = { -1221.154f, -170.9907f, 38.3253f };
	Local_1056[1 /*3*/] = { -1210.556f, -192.882f, 38.3253f };
	Local_1056[2 /*3*/] = { -1216.369f, -203.6806f, 38.3253f };
	fLocal_1049[0] = 157.3177f;
	fLocal_1049[1] = 58.3594f;
	fLocal_1049[2] = 65.6443f;
	Local_1058[0 /*3*/] = { -1220.377f, -169.407f, 38.3253f };
	Local_1058[1 /*3*/] = { -1208.963f, -193.8791f, 38.3253f };
	Local_1058[2 /*3*/] = { -1214.955f, -205.0824f, 38.3253f };
	Local_1058[3 /*3*/] = { -1217.518f, -197.13f, 38.3254f };
	Local_1058[4 /*3*/] = { -1231.892f, -194.382f, 38.1753f };
	...
	switch (iLocal_1022)
	{
		...
		case 1:
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				{
					iLocal_1421 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), Local_1423, Local_1424, 42.2032f, true, 2);
					CAM::SHAKE_CAM(iLocal_1421, "HAND_SHAKE", 0.3f);
				}
				if (!CAM::DOES_CAM_EXIST(iLocal_1422))
				{
					iLocal_1422 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), Local_1425, Local_1426, 42.2032f, false, 2);
...
void func_452()//Position - 0x19B92
{
	...
	{
		iLocal_1430 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1510.103f, -947.7194f, 8.2332f, 5f, joaat("prop_bench_08"), true, false, true);
	}
}
...
int func_494(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x20135
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_496(iParam0, uVar1[iVar3], 1) && func_495(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
