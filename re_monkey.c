...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_52 = 256.1257f;
	fLocal_56 = 0f;
	Local_67 = { -334.8087f, -85.713f, 47.4504f };
...
void func_40(int iParam0)//Position - 0x1B1B
{
	...
	while (iVar15 < Global_114135.f_7692.f_198)
	{
		...
		{
			func_41(Global_114135.f_7692.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
void func_49(int iParam0, struct<3> Param1, float fParam4)//Position - 0x1E49
{
...
void func_51()//Position - 0x1E88
{
	...
	while (iVar0 < 4)
	{
		...
		switch (iVar1)
		{
			...
			case 1:
				iLocal_62[iVar1] = OBJECT::CREATE_OBJECT(joaat("prop_paints_can02"), -335.66f, -95.24f, 46.16f, true, true, false);
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_62[iVar1], -335.66f, -95.24f, 46.16f, false, false, true);
				ENTITY::SET_ENTITY_ROTATION(iLocal_62[iVar1], -2.32f, 0.66f, -0.8f, 2, true);
				break;
			
			case 2:
				iLocal_62[iVar1] = OBJECT::CREATE_OBJECT(joaat("prop_paint_brush05"), -336.04f, -94.9f, 46.02f, true, true, false);
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_62[iVar1], -336.04f, -94.9f, 46.02f, false, false, true);
				ENTITY::SET_ENTITY_ROTATION(iLocal_62[iVar1], 0.01f, 3.85f, 2.72f, 2, true);
				break;
			
			case 3:
				iLocal_62[iVar1] = OBJECT::CREATE_OBJECT(joaat("prop_paint_spray01b"), -336.34f, -95.66f, 46.02f, true, true, false);
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_62[iVar1], -336.34f, -95.66f, 46.02f, false, false, true);
				ENTITY::SET_ENTITY_ROTATION(iLocal_62[iVar1], -2.86f, 0.76f, 28.89f, 2, true);
				break;
		}
		iVar0++;
	}
...
int func_57()//Position - 0x2186
{
	...
	else
	{
		...
		{
			iLocal_48 = PED::CREATE_PED(26, joaat("U_M_M_StreetArt_01"), Local_49, fLocal_52, true, true);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("U_M_M_StreetArt_01"));
			iLocal_62[0] = OBJECT::CREATE_OBJECT(joaat("prop_cs_spray_can"), Local_67, true, true, false);
			ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_62[0], iLocal_48, PED::GET_PED_BONE_INDEX(iLocal_48, 28422), 0f, -0.01f, -0.02f, Local_76, true, true, false, false, 2, true, 0);
			PED::SET_PED_KEEP_TASK(iLocal_48, true);
			PED::SET_PED_CONFIG_FLAG(iLocal_48, 42, true);
			iLocal_55 = func_68(iLocal_48, 0, 145);
			func_58(1);
...
{
	switch (func_63(&Global_33147, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
		...
		switch (iLocal_53)
		{
			case 0:
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_72))
				{
					...
					TASK::TASK_PLAY_ANIM(iLocal_48, sLocal_72, sLocal_73, 1000f, -8f, -1, 8193, 0f, false, false, false);
					iLocal_53++;
				}
				break;
			...
			case 1:
				...
				if (func_82(PLAYER::PLAYER_PED_ID(), iLocal_48, 35f))
				{
					...
					TASK::TASK_PLAY_ANIM(0, sLocal_72, sLocal_74, 8f, -8f, -1, 8192, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(0, sLocal_72, sLocal_75, 8f, -2f, -1, 8193, 0f, false, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_80);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_48, iLocal_80);
			...
			case 2:
				...
				if ((bVar0 && bVar1) && func_82(PLAYER::PLAYER_PED_ID(), iLocal_48, fVar14))
				{
					iLocal_53 = 3;
				}
				if (iLocal_54)
			...
			case 5:
				...
				{
					iLocal_79 = SHAPETEST::START_SHAPE_TEST_LOS_PROBE(Var5, Var2, 1, 0, 7);
					iLocal_53++;
				}
				break;
			...
			case 6:
				...
				iVar23 = SHAPETEST::GET_SHAPE_TEST_RESULT(iLocal_79, &iVar15, &uVar16, &uVar19, &uVar22);
				if (iVar23 == 2)
				{
					if (iVar15 == 1)
					{
...
int func_73()//Position - 0x2BE9
{
	...
	{
		case 0:
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48, sLocal_72, sLocal_75, 3))
			{
				fLocal_56 = 0.349f;
				iLocal_57 = 900;
				Local_59 = { Var0 };
			...
			else if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48, sLocal_72, sLocal_74, 3))
			{
				fLocal_56 = ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_48, sLocal_72, sLocal_74);
				fLocal_56 = func_77(fLocal_56, 0.2f, 0.349f);
				if (fLocal_56 != 0.2f)
				{
					fVar6 = ((1f / (0.349f - 0.161f)) * SYSTEM::TO_FLOAT(900));
					iLocal_57 = SYSTEM::ROUND(((fLocal_56 - 0.161f) * fVar6));
					Local_59 = { ENTITY::GET_ENTITY_COORDS(iLocal_48, false) - Vector(1f, 0f, 0f) };
					iLocal_58 = 1;
				}
				else
				{
		...
		case 1:
			...
			TASK::TASK_PLAY_ANIM(iLocal_48, sLocal_72, sLocal_74, 4f, -8f, -1, 0, fLocal_56, true, false, false);
			iLocal_81 = MISC::GET_GAME_TIMER();
			func_76(&iLocal_55);
			func_75();
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_62[0]))
			{
				ENTITY::DETACH_ENTITY(iLocal_62[0], true, true);
			}
			iLocal_58++;
			break;
		
		case 2:
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48, sLocal_72, sLocal_74, 3))
			{
				iVar7 = (MISC::GET_GAME_TIMER() - iLocal_81);
				fVar8 = (SYSTEM::TO_FLOAT(iVar7) / SYSTEM::TO_FLOAT(iLocal_57));
				fVar9 = (fLocal_56 - ((fLocal_56 - 0.161f) * fVar8));
				fVar9 = func_77(fVar9, 0.161f, fLocal_56);
				ENTITY::SET_ENTITY_ANIM_CURRENT_TIME(iLocal_48, sLocal_72, sLocal_74, fVar9);
				fVar10 = (fVar8 - 0.12f);
				fVar10 = func_77(fVar10, 0f, 0.8f);
				Var11 = { func_74(Local_59, Var3, fVar10) };
				ENTITY::SET_ENTITY_COORDS(iLocal_48, Var11, false, true, false, true);
				if (fVar9 == 0.161f)
				{
					ENTITY::FREEZE_ENTITY_POSITION(iLocal_48, false);
					return 1;
...
Vector3 func_74(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2DF7
{
...
void func_78()//Position - 0x2E71
{
	...
	if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48, sLocal_72, sLocal_74, 3))
	{
		fVar0 = ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_48, sLocal_72, sLocal_74);
		if (fVar0 < 0.383793f)
		{
			func_75();
		}
	...
	else if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48, sLocal_72, sLocal_75, 3))
	{
		fVar0 = ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_48, sLocal_72, sLocal_75);
		if (fVar0 < 0.1124f)
		{
			func_75();
		}
...
void func_79()//Position - 0x2F32
{
	if (iLocal_70 == 0)
	{
		iLocal_70 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY(sLocal_71, iLocal_62[0], Local_76, Local_76, 1f, false, false, false);
		GRAPHICS::SET_PARTICLE_FX_LOOPED_COLOUR(iLocal_70, 1f, 1f, 1f, false);
		GRAPHICS::SET_PARTICLE_FX_LOOPED_ALPHA(iLocal_70, 0.2f);
	}
}

bool func_80(struct<3> Param0, struct<3> Param3)//Position - 0x2F72
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_95(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x32F3
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (func_22(func_143()))
		{
			if (!func_134(iParam3, bParam4, 145))
			{
				return 0;
			}
		}
...
bool func_96(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x368D
{
	if (bParam6)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_130()) || Global_113182) || Global_33090) || func_129()) || func_128(8, -1)) || func_127()) || func_126()) || func_125()) || func_124()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_130()) || Global_33090) || func_129()) || func_128(8, -1)) || func_125()) || func_127()) || func_126()) || func_124()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_130()) || Global_113182) || Global_33090) || func_129()) || func_128(8, -1)) || func_125()) || func_127()) || func_126()) || func_124()) || Global_114135.f_7692.f_919[iVar0] == 5) || Global_44728 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_130()) || Global_113182) || Global_33090) || func_129()) || func_128(8, -1)) || func_127()) || func_126()) || func_124()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_130() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_128(8, -1)) || func_124()) || func_123()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_130()) || Global_33090) || func_129()) || func_128(8, -1)) || func_126()) || func_125()) || func_124()) || Global_114135.f_7692.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_130()) || func_126()) || Global_113182) || Global_33090) || func_129()) || Global_45392) || func_128(8, -1)) || func_125()) || func_123()) || func_124()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_130()) || Global_113182) || Global_33090) || func_129()) || func_128(8, -1)) || func_125()) || func_123()) || func_127()) || func_126()) || func_124())
						{
							return 0;
						}
						break;
...
void func_151(int iParam0)//Position - 0x650E
{
	...
	if (func_162())
	{
		...
		func_154(30000);
		StringCopy(&cVar0, func_153(Global_114124, 1), 64);
