...
int func_70()//Position - 0x17F9
{
	if (Global_1853753 != func_60())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_quaters_seats", Global_1853753, true, 0))
		{
			return 0;
		}
...
{
	func_74(2, &uLocal_95, 0);
	func_74(3, &uLocal_95, 1);
	func_72(&uLocal_95, 6294/*func_73*/);
}
...
{
	func_82(2, &uLocal_95, 0);
	func_82(3, &uLocal_95, 1);
}
...
{
	return BitTest(Global_1853910[iParam0 /*862*/].f_267.f_300.f_1, 0);
}
