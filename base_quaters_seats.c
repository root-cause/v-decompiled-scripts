...
void func_11(var uParam0)//Position - 0x219
{
	...
	switch (uParam0->f_29.f_4)
	{
		...
		case 4:
			...
			if (Var2.f_0 != 3)
			{
				Var3 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_39(uParam0), func_38(uParam0), 0f, 2) };
				Var4 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_39(uParam0), func_38(uParam0), 0f, 2) };
				fVar5 = Var4.f_2;
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar7 = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_29.f_1);
		...
		case 8:
			iVar8 = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_29.f_1);
...
Vector3 func_77(struct<3> Param0, float fParam1)//Position - 0x1954
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
