...
void __EntryFunction__()//Position - 0x0
{
	...
	while (iVar0 < 5)
	{
		...
		MISC::SET_BIT(&(Global_114135.f_18578[(iLocal_28 + iVar0) /*6*/]), 3);
		iVar0++;
	}
	func_19(1);
	while (true)
...
{
	return (((func_9(9) || Global_33090) || func_2() != 2) || Global_113222[56 /*10*/].f_3);
}
...
void func_19(bool bParam0)//Position - 0x913
{
	...
	while (iVar0 < 5)
	{
		...
		func_23(iVar1, 1);
		func_22(iVar1, 44);
		if (((Global_114135.f_2356[iVar0 /*2*/] >= 1 || func_36(108) == 1) || func_21((iLocal_27 + iVar0), 0)) || BitTest(Global_114135.f_18578[(iLocal_28 + iVar0) /*6*/], 3))
		{
			func_20(iVar1, 1);
		}
		iVar0++;
