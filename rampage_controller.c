...
void __EntryFunction__()//Position - 0x0
{
	...
	while (iVar0 < 5)
	{
		...
		MISC::SET_BIT(&(Global_113810.f_18577[(iLocal_28 + iVar0) /*6*/]), 3);
		iVar0++;
	}
	func_19(1);
	while (true)
...
void func_19(bool bParam0)//Position - 0x913
{
	...
	while (iVar0 < 5)
	{
		...
		func_23(iVar1, 1);
		func_22(iVar1, 44);
		if (((Global_113810.f_2355[iVar0 /*2*/] >= 1 || func_36(108) == 1) || func_21((iLocal_27 + iVar0), 0)) || BitTest(Global_113810.f_18577[(iLocal_28 + iVar0) /*6*/], 3))
		{
			func_20(iVar1, 1);
		}
		iVar0++;
