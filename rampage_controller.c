...
void __EntryFunction__()//Position - 0x0
{
	...
	while (iVar0 < 5)
	{
		...
		MISC::SET_BIT(&(Global_113648.f_18576[(iLocal_30 + iVar0) /*6*/]), 3);
		iVar0++;
	}
	func_19(1);
	while (true)
...
void func_19(bool bParam0)//Position - 0x913
{
	...
	while (iVar0 < 5)
	{
		...
		func_23(iVar1, 1);
		func_22(iVar1, 44);
		if (((Global_113648.f_2354[iVar0 /*2*/] >= 1 || func_36(108) == 1) || func_21((iLocal_29 + iVar0), 0)) || BitTest(Global_113648.f_18576[(iLocal_30 + iVar0) /*6*/], 3))
		{
			func_20(iVar1, 1);
		}
		iVar0++;
