#region Local Var
	...
	var uLocal_91 = 0;
	var uLocal_92 = 0;
	struct<9> Local_93 = { 0, 0, 0, 0, 0, 1, 0, 0, 1 } ;
	var uLocal_94 = 0;
	var uLocal_95 = 0;
	var uLocal_96 = 0;
	var uLocal_97 = 0;
...
bool func_37()//Position - 0xF76
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

int func_38(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xF90
{
	int iVar0;
...
void func_40()//Position - 0xFEA
{
	func_41(0);
}

void func_41(bool bParam0)//Position - 0xFF7
{
	if (bParam0)
	{
		func_47();
...
void func_42(int iParam0)//Position - 0x105A
{
	if (func_45())
	{
		return;
...
void func_43(bool bParam0, bool bParam1)//Position - 0x10E4
{
	if (bParam0)
	{
		if (func_46(0))
...
bool func_45()//Position - 0x1166
{
	return BitTest(Global_1958711, 19);
}

int func_46(int iParam0)//Position - 0x1175
{
	if (iParam0 == 1)
	{
...
void func_48(bool bParam0)//Position - 0x11F5
{
	int iVar0;
...
void func_49(int iParam0)//Position - 0x1223
{
...
void func_52(var uParam0)//Position - 0x12C0
{
	uParam0->f_1 = 0;
}

void func_53(int iParam0)//Position - 0x12CD
{
	Global_1057410 = iParam0;
}

void func_54(var uParam0, bool bParam1)//Position - 0x12DB
{
	uParam0->f_6 = bParam1;
	if (bParam1)
	{
...
int func_56(var uParam0)//Position - 0x1326
{
	func_272();
...
void func_60(int iParam0)//Position - 0x1458
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_61(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8)//Position - 0x14F4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62()//Position - 0x15D8
{
	return -1;
}

int func_63(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x15E1
{
	int iVar0;
...
void func_64(var uParam0, int iParam1)//Position - 0x167C
{
	*uParam0 = iParam1;
}

int func_65()//Position - 0x1689
{
...
void func_66(var uParam0)//Position - 0x16BB
{
	int iVar0;
...
int func_67(var uParam0)//Position - 0x184A
{
	if (uParam0->f_20 == 0)
	{
		return 1;
...
int func_68()//Position - 0x18CA
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

char* func_69(bool bParam0, char* sParam1, char* sParam2)//Position - 0x18DA
{
	if (bParam0)
	{
		return sParam1;
...
void func_70(var uParam0)//Position - 0x18F1
{
	func_58();
...
void func_71(var uParam0)//Position - 0x190B
{
	func_154(uParam0);
	if (uParam0->f_5)
	{
...
void func_72(bool bParam0, bool bParam1, bool bParam2)//Position - 0x19B1
{
	func_74();
	func_48(1);
	HUD::CLEAR_HELP(true);
...
void func_75(var uParam0)//Position - 0x1A9E
{
	struct<101> Var0;
...
void func_76(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x1B99
{
	int iVar0;
	float fVar1;
...
bool func_77(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)//Position - 0x2070
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

bool func_78(int iParam0)//Position - 0x2080
{
	return func_129(iParam0);
}

int func_79(int iParam0)//Position - 0x208E
{
	switch (iParam0)
	{
		case joaat("pounder2"):
...
void func_80(int iParam0)//Position - 0x218F
{
	struct<3> Var0;
...
void func_81(struct<3> Param0)//Position - 0x221A
{
	struct<3> Var0;
...
var func_82(int iParam0, bool bParam1)//Position - 0x2259
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_83(int iParam0)//Position - 0x22BE
{
	int iVar0;
...
bool func_84(int iParam0)//Position - 0x22F9
{
	return func_85(iParam0, 6, 1);
}

int func_85(int iParam0, int iParam1, bool bParam2)//Position - 0x2309
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_86(int iParam0, int iParam1, int iParam2)//Position - 0x236A
{
	int iVar0;
	var uVar1;
...
int func_87(var uParam0)//Position - 0x23A7
{
	int iVar0;
	int iVar1;
...
int func_88(int iParam0)//Position - 0x23DB
{
	switch (iParam0)
	{
		case 0:
...
int func_89()//Position - 0x2756
{
	return Global_31959;
}

int func_90(int iParam0)//Position - 0x2761
{
	switch (iParam0)
	{
		case -1:
...
bool func_91()//Position - 0x2A70
{
	return Global_100493.f_376 > 0;
}

int func_92(int iParam0, var* uParam1)//Position - 0x2A81
{
	int iVar0;
	int iVar1;
...
int func_93(int iParam0)//Position - 0x2AFE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_94(int iParam0)//Position - 0x2B8B
{
	int iVar0;
...
int func_95(int iParam0, int iParam1)//Position - 0x2BE7
{
	func_99();
...
bool func_96(var uParam0, int iParam1, int iParam2, struct<3> Param3, struct<3> Param4, struct<3> Param5, float fParam6, int iParam7, int iParam8)//Position - 0x2E92
{
...
int func_97(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x2EBB
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		return 0;
...
bool func_98(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x81B3
{
	if (bParam2)
	{
...
int func_100(int iParam0)//Position - 0x8273
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
...
int func_101(int iParam0)//Position - 0x82AB
{
	int iVar0;
...
int func_102(int iParam0, var* uParam1)//Position - 0x82F3
{
	int iVar0;
	bool bVar1;
...
int func_103(int iParam0)//Position - 0x83DA
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return 1;
...
int func_104(int iParam0)//Position - 0x86C4
{
...
int func_105(int iParam0)//Position - 0x86F0
{
...
int func_106(int iParam0)//Position - 0x870D
{
...
int func_107(int iParam0, int iParam1)//Position - 0x8730
{
...
int func_108(int iParam0)//Position - 0x876B
{
	if (func_107(iParam0, 0))
	{
...
bool func_109(bool bParam0)//Position - 0x878E
{
	return func_110(PLAYER::PLAYER_ID(), bParam0);
}

int func_110(int iParam0, bool bParam1)//Position - 0x87A0
{
	return func_111(iParam0, bParam1, 1);
}

int func_111(int iParam0, bool bParam1, int iParam2)//Position - 0x87B1
{
	int iVar0;
...
int func_112(int iParam0, int iParam1)//Position - 0x880D
{
	if (iParam0 != func_62())
	{
...
int func_113(int iParam0, bool bParam1)//Position - 0x885C
{
	var uVar0;
	int iVar1;
...
int func_114(int iParam0)//Position - 0x88BA
{
	return (iParam0 % 32);
}

int func_115(int iParam0)//Position - 0x88C7
{
	int iVar0;
...
int func_116(var uParam0)//Position - 0x88DF
{
	int iVar0;
	int iVar1;
...
int func_117(int iParam0)//Position - 0x890C
{
	return (iParam0 / 32);
}

int func_118(int iParam0)//Position - 0x8919
{
	if (iParam0 != func_62())
	{
...
int func_119(int iParam0)//Position - 0x894E
{
	if (iParam0 != func_62())
	{
...
int func_120(int iParam0)//Position - 0x8995
{
	switch (iParam0)
	{
		case 0:
...
void func_121(int iParam0, int iParam1)//Position - 0x8E1C
{
	int iVar0;
	int iVar1;
...
bool func_122(int iParam0, var uParam1)//Position - 0x8E3D
{
	*uParam1 = -1;
	switch (iParam0)
	{
...
int func_123(int iParam0)//Position - 0x90FF
{
	switch (iParam0)
	{
		case 0:
...
int func_124(int iParam0, int iParam1, int iParam2)//Position - 0x919D
{
...
struct<13> func_126()//Position - 0x93C7
{
	struct<13> Var0;
...
int func_127(int iParam0)//Position - 0x93DC
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("deathbike2"):
...
bool func_128(int iParam0, var uParam1)//Position - 0x93FD
{
	*uParam1 = -1f;
	switch (iParam0)
	{
...
int func_129(int iParam0)//Position - 0x96FE
{
	switch (iParam0)
	{
		case joaat("deity"):
...
void func_130(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x9745
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_132(var uParam0)//Position - 0x9E79
{
	int iVar0;
...
int func_133(int iParam0)//Position - 0x9E9D
{
	int iVar0;
...
var func_134(int iParam0, int iParam1)//Position - 0x9EBB
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

bool func_135(int iParam0)//Position - 0x9ED3
{
	return func_136(&(Global_2703735.f_169), iParam0);
}

var func_136(var uParam0, var uParam1)//Position - 0x9EE7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_137(int iParam0, var uParam1, var uParam2)//Position - 0x9F0A
{
	int iVar0;
	int iVar1;
...
int func_138(int iParam0)//Position - 0xA0E4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_139(var uParam0)//Position - 0xA1BE
{
...
int func_140(int iParam0, int iParam1)//Position - 0xA215
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_141(int iParam0, int iParam1)//Position - 0xA2FA
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_142(int iParam0, int iParam1, int iParam2)//Position - 0xA6D9
{
...
int func_143()//Position - 0xA6FD
{
	return 0;
}

void func_144(int iParam0, int iParam1)//Position - 0xA706
{
	int iVar0;
	int iVar1;
...
int func_145(int iParam0)//Position - 0xA77E
{
	switch (iParam0)
	{
		case joaat("granger"):
...
bool func_146()//Position - 0xA79E
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

int func_147(int iParam0)//Position - 0xA7AF
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xA7F4
{
...
int func_149(int iParam0)//Position - 0xA814
{
	switch (iParam0)
	{
		case 161:
...
int func_150(int iParam0)//Position - 0xA867
{
	switch (iParam0)
	{
		case 1:
...
int func_151(int iParam0)//Position - 0xA917
{
...
int func_152(int iParam0, int iParam1)//Position - 0xA99E
{
	int iVar0;
...
int func_153(int iParam0)//Position - 0xA9EB
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_154(var uParam0)//Position - 0xAA0C
{
	char* sVar0;
...
void func_155(var uParam0)//Position - 0xAA5A
{
...
void func_158(int iParam0, var uParam1, bool bParam2, int iParam3)//Position - 0xAC18
{
	struct<9> Var0;
	int iVar1;
	bool bVar2;
...
void func_159(int iParam0, int iParam1, int iParam2)//Position - 0xAD81
{
	switch (iParam1)
	{
...
int func_160(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)//Position - 0xBFD4
{
	int iVar0;
	int iVar1;
...
int func_161(int iParam0, int iParam1)//Position - 0xC7FB
{
	var uVar0;
	int iVar1;
...
int func_162(int iParam0, int iParam1)//Position - 0xC83A
{
	int iVar0;
	int iVar1;
...
int func_163()//Position - 0xC881
{
	return Global_31960;
}

int func_164(var uParam0)//Position - 0xC88C
{
	int iVar0;
	int iVar1;
...
char* func_165(int iParam0)//Position - 0xCBF1
{
	switch (iParam0)
	{
		case 0:
...
int func_166(int iParam0, char* sParam1, int iParam2)//Position - 0xD22E
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
bool func_167(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xE260
{
	int iVar0;
	int iVar1;
...
void func_168(char* sParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11206
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
int func_172()//Position - 0x1153F
{
	return 1;
}

int func_173()//Position - 0x11548
{
	return 1;
}

void func_174(char* sParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9)//Position - 0x11551
{
	char cVar0[32];
...
int func_175(int iParam0, int iParam1)//Position - 0x11806
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_176(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11ABC
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_177(int iParam0, int iParam1)//Position - 0x11BD6
{
	switch (iParam0)
	{
...
int func_178(int iParam0)//Position - 0x11F7D
{
	switch (iParam0)
	{
		case 0:
...
int func_179(int iParam0)//Position - 0x1202D
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_180(int iParam0, int iParam1, int iParam2)//Position - 0x1208E
{
	int iVar0;
	int iVar1;
...
int func_181(int iParam0, int iParam1)//Position - 0x1212F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_182(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1218F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_183(int iParam0, int iParam1)//Position - 0x121E6
{
	int iVar0;
	int iVar1;
...
int func_184(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1222C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_185(int iParam0, int iParam1)//Position - 0x12328
{
	int iVar0;
...
int func_186(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x12466
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_187(int iParam0)//Position - 0x12521
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_188(int iParam0)//Position - 0x12580
{
	switch (iParam0)
	{
		case 0:
...
int func_189(int iParam0, int iParam1, int iParam2)//Position - 0x12606
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_190(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x12A60
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_191(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x12B09
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_192(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x12BB1
{
	switch (iParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
int func_193(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x12C04
{
	var uVar0;
	int iVar1;
...
int func_194(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x13208
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_195(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x13485
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_196(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x138AA
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_197(int iParam0, int iParam1, int iParam2)//Position - 0x13B9D
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_198(int iParam0, int iParam1)//Position - 0x13C36
{
	int iVar0;
	struct<10> Var1;
...
void func_286()//Position - 0x33132
{
	int iVar0;
	
	NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, -1);
	func_289(&Local_93, joaat("nimbus"), "Plane_1");
	ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), false, false);
	Local_93.f_8 = 0;
	iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(0, 100);
	if (iVar0 < 50)
	{
		func_287(&Local_93, 4105.583f, -4644.602f, 4.1196f, 11.1032f, -0.012f, 107.968f, "HS4_ISD_TAKE_NIMB2", 0, 1, 1, 0);
	}
	else
	{
		func_287(&Local_93, 4105.583f, -4644.602f, 4.1196f, 11.1032f, -0.012f, 107.968f, "HS4_ISD_TAKE_NIMB2", 0, 1, 2, 0);
	}
}

void func_287(var uParam0, struct<3> Param1, struct<3> Param2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x331CA
{
...
void func_288(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x331FA
{
	uParam0->f_1 = uParam1;
	uParam0->f_2 = uParam3;
...
void func_289(var uParam0, int iParam1, char* sParam2)//Position - 0x33227
{
