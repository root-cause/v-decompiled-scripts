#region Local Var
	...
	var uLocal_93 = 0;
	var uLocal_94 = 0;
	struct<9> Local_95 = { 0, 0, 0, 0, 0, 1, 0, 0, 1 } ;
	var uLocal_104 = 0;
	var uLocal_105 = 0;
	var uLocal_106 = 0;
	var uLocal_107 = 0;
...
int func_56(var uParam0)//Position - 0x1330
{
	func_273();
...
int func_57(var uParam0)//Position - 0x1393
{
	func_58();
	if (CAM::IS_SCREEN_FADED_OUT())
	{
...
void func_60(int iParam0)//Position - 0x1462
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_61(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8)//Position - 0x14FE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62()//Position - 0x15E2
{
	return -1;
}

int func_63(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x15EB
{
	int iVar0;
...
int func_67(var uParam0)//Position - 0x1854
{
	if (uParam0->f_20 == 0)
	{
		return 1;
...
int func_68()//Position - 0x18D4
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

char* func_69(bool bParam0, char* sParam1, char* sParam2)//Position - 0x18E4
{
	if (bParam0)
	{
		return sParam1;
...
void func_76(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x1BA3
{
	int iVar0;
	float fVar1;
...
bool func_77(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)//Position - 0x207A
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

bool func_78(int iParam0)//Position - 0x208A
{
	return func_129(iParam0);
}

int func_79(int iParam0)//Position - 0x2098
{
	switch (iParam0)
	{
		case joaat("pounder2"):
...
void func_80(int iParam0)//Position - 0x2199
{
	struct<3> Var0;
...
void func_81(struct<3> Param0)//Position - 0x2224
{
	struct<3> Var0;
...
var func_82(int iParam0, bool bParam1)//Position - 0x2263
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_83(int iParam0)//Position - 0x22C8
{
	int iVar0;
...
int func_85(int iParam0, int iParam1, bool bParam2)//Position - 0x2313
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_86(int iParam0, int iParam1, int iParam2)//Position - 0x2374
{
	int iVar0;
	var uVar1;
...
int func_87(var uParam0)//Position - 0x23B1
{
	int iVar0;
	int iVar1;
...
int func_88(int iParam0)//Position - 0x23E5
{
	switch (iParam0)
	{
		case 0:
...
int func_92(int iParam0, var* uParam1)//Position - 0x2AC3
{
	int iVar0;
	int iVar1;
...
int func_93(int iParam0)//Position - 0x2B40
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_94(int iParam0)//Position - 0x2BCD
{
	int iVar0;
...
int func_95(int iParam0, int iParam1)//Position - 0x2C29
{
	func_99();
...
bool func_96(var uParam0, int iParam1, int iParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, int iParam13, int iParam14)//Position - 0x2ED4
{
...
int func_97(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x2EFD
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		return 0;
...
void func_287()//Position - 0x33815
{
	...
	func_290(&Local_95, joaat("nimbus"), "Plane_1");
	ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), false, false);
	Local_95.f_8 = 0;
	iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(0, 100);
	if (iVar0 < 50)
	{
		func_288(&Local_95, 4105.583f, -4644.602f, 4.1196f, 11.1032f, -0.012f, 107.968f, "HS4_ISD_TAKE_NIMB2", 0, 1, 1, 0);
	}
	else
	{
		func_288(&Local_95, 4105.583f, -4644.602f, 4.1196f, 11.1032f, -0.012f, 107.968f, "HS4_ISD_TAKE_NIMB2", 0, 1, 2, 0);
	}
}

void func_288(var uParam0, struct<3> Param1, struct<3> Param4, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x338AD
{
...
void func_289(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x338DD
{
	uParam0->f_1 = uParam1;
	uParam0->f_2 = uParam3;
