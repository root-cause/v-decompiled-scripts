#region Local Var
	...
	struct<19> Local_130[3];
	int iLocal_188 = 0;
	struct<6> Local_189[6];
	struct<6> Local_226[8];
	struct<9> Local_275[4];
	struct<7> Local_312[1];
	struct<7> Local_320 = { 0, 0, 0, 0, 0, 0, 0 } ;
	var uLocal_327 = 0;
	struct<6> Local_328 = { 0, 0, 0, 0, 0, 0 } ;
	struct<6> Local_334 = { 0, 0, 0, 0, 0, 0 } ;
	struct<6> Local_340 = { 0, 0, 0, 0, 0, 0 } ;
	struct<6> Local_346 = { 0, 0, 0, 0, 0, 0 } ;
	int iLocal_352 = 0;
	int iLocal_353 = 0;
	int iLocal_354 = 0;
	int iLocal_355 = 0;
	int iLocal_356 = 0;
	int iLocal_357[2] = { 0, 0 };
	int iLocal_360 = 0;
	int iLocal_361 = 0;
	int iLocal_362 = 0;
	int iLocal_363 = 0;
...
void __EntryFunction__()//Position - 0x0
{
	...
	StringCopy(&Local_602, "MAUDE_MCS_5", 24);
	StringCopy(&Local_608, "", 24);
	...
	if (func_555())
	{
		...
		{
			case 0:
				func_454(&iLocal_638, 1476.8867f, 6363.799f, 22.5945f, 171.3869f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				func_453(Local_623, fLocal_390, 1, 0);
				iLocal_99 = 2;
				func_442(1, 0);
				break;
			
			case 1:
				func_454(&iLocal_638, 2704.0776f, 4152.2397f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				func_453(Local_614, 254.9762f, 0, 0);
				func_442(4, 0);
				break;
	...
	else if (func_441(0))
	{
		...
		{
			func_439(PLAYER::PLAYER_PED_ID(), Local_623, fLocal_390, 0, 0);
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			Local_617 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
			func_428();
			func_427();
			switch (iLocal_96)
			{
		...
		switch (iLocal_96)
		{
			case 0:
				if (iLocal_98 == 1)
				{
					if (!func_73())
					{
						func_20(PLAYER::PLAYER_PED_ID(), Local_626, fLocal_391, 0, 1);
			...
			case 1:
				...
				if (iLocal_98 == 1)
				{
					if (!func_73())
					{
						func_20(PLAYER::PLAYER_PED_ID(), Local_629, fLocal_392, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_377 == 0)
						{
			...
			case 2:
				...
				if (iLocal_98 == 1)
				{
					...
					if (iLocal_405 > 0)
					{
						...
						{
							if (func_23(Local_130[iVar0 /*19*/]))
							{
								PED::EXPLODE_PED_HEAD(Local_130[iVar0 /*19*/], joaat("WEAPON_SNIPERRIFLE"));
								ENTITY::SET_ENTITY_HEALTH(Local_130[iVar0 /*19*/], 0, 0, 0);
							}
							iVar0++;
						}
					}
			...
			case 3:
				...
				if (iLocal_98 == 1)
				{
					func_439(Local_110.f_9, Local_614, 0f, 0, 0);
					if (!func_73())
					{
						func_439(PLAYER::PLAYER_PED_ID(), Local_614, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_377 == 0)
						{
...
int func_3(int iParam0, float fParam1)//Position - 0x660
{
	struct<3> Var0;
...
bool func_4(struct<3> Param0, var* uParam3, float fParam4, bool bParam5)//Position - 0x6A8
{
	var uVar0;
	struct<3> Var1;
...
void func_7()//Position - 0x725
{
	...
	while (iVar0 <= (iLocal_405 - 1))
	{
		Local_130[iVar0 /*19*/].f_15 = 0;
		Local_130[iVar0 /*19*/].f_16 = 0;
		iVar0++;
	}
}
...
void func_10(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x7A8
{
	int iVar0;
	int iVar1;
...
int func_17(int iParam0)//Position - 0x98C
{
	if (iParam0 == 1)
	{
...
void func_19(int iParam0, struct<2> Param1, Vector3 vParam3)//Position - 0x9F2
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_20(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0xA51
{
	bool bVar0;
	float fVar1;
...
int func_23(int iParam0)//Position - 0xB14
{
	if (func_440(iParam0))
	{
...
void func_27(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xC4E
{
	if (bParam0)
	{
...
int func_32(var uParam0)//Position - 0xE5D
{
	int iVar0;
...
int func_33(int iParam0)//Position - 0xE7F
{
...
int func_35(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xECC
{
	int iVar0;
...
int func_38()//Position - 0xF7E
{
	if (func_60(Local_617, Local_320.f_1, 210f))
	{
		if (!iLocal_383)
		{
			if ((func_59(2) && func_58(&Local_328, Local_328.f_5, Local_328.f_1, Local_328.f_4, 1)) && func_58(&Local_334, Local_334.f_5, Local_334.f_1, Local_334.f_4, 1))
			{
				if (func_55(&Local_320, Local_320.f_6, Local_320.f_1, Local_320.f_4, 1, 0, 1))
				{
					func_50();
					iLocal_383 = 1;
				}
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_340.f_0))
		{
			if (func_60(Local_617, Local_340.f_1, 150f))
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_340.f_1, 10f, func_49(), false))
				{
					Local_340.f_0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_340.f_1, 10f, func_49(), true, false, true);
					if (func_440(Local_340.f_0))
					{
						ENTITY::SET_ENTITY_COORDS(Local_340.f_0, func_48(), true, false, false, true);
						ENTITY::SET_ENTITY_HEADING(Local_340.f_0, func_47());
						ENTITY::FREEZE_ENTITY_POSITION(Local_340.f_0, true);
					}
				}
			}
		}
		if (!ENTITY::DOES_ENTITY_EXIST(Local_346.f_0))
		{
			if (func_60(Local_617, Local_346.f_1, 150f))
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_346.f_1, 10f, func_46(), false))
				{
					Local_346.f_0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_346.f_1, 10f, func_46(), true, false, true);
				}
			}
		}
	}
	else if (!CAM::IS_SPHERE_VISIBLE(Local_320.f_1, 2.5f))
	{
		func_43(&Local_320, 1);
...
void func_39(int* iParam0, bool bParam1)//Position - 0x1133
{
	if (bParam1)
	{
		func_41(iParam0);
...
void func_40(int* iParam0, bool bParam1)//Position - 0x1150
{
...
void func_41(int* iParam0)//Position - 0x118B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_43(int* iParam0, bool bParam1)//Position - 0x11C1
{
	if (bParam1)
	{
		func_45(iParam0);
...
void func_44(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x11E0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_45(int* iParam0)//Position - 0x1230
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_50()//Position - 0x12AF
{
	...
	if (func_23(Local_320.f_0))
	{
		if (func_440(Local_328.f_0))
		{
			if (func_59(2))
			{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(Local_320.f_0, iVar0, func_42(), func_52(), 1000f, -8f, 4688, 0, 1000f, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_328.f_0, iVar0, func_51(), func_42(), 1000f, -8f, iVar1, 1000f);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_320.f_0, true);
				PED::SET_PED_MONEY(Local_320.f_0, 0);
				PED::SET_PED_CAN_BE_TARGETTED(Local_320.f_0, false);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_320.f_0, joaat("PLAYER"));
				TASK::SET_PED_PATH_CAN_USE_CLIMBOVERS(Local_320.f_0, false);
				TASK::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(Local_320.f_0, false);
				PED::SET_PED_KEEP_TASK(Local_320.f_0, true);
				PED::SET_PED_CONFIG_FLAG(Local_320.f_0, 118, false);
			}
		}
	}
}
...
int func_55(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, bool bParam7, bool bParam8)//Position - 0x13D7
{
...
int func_57(int iParam0)//Position - 0x1484
{
	if (iParam0 == 0)
	{
		return 1;
...
int func_58(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x14AA
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_57(iParam1))
...
int func_59(int iParam0)//Position - 0x1515
{
	switch (iParam0)
	{
		case 0:
...
bool func_60(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x15B9
{
	return SYSTEM::VDIST2(Param0, Param3) <= (fParam6 * fParam6);
}

int func_61(int iParam0, float fParam1, int iParam2)//Position - 0x15D3
{
	int iVar0;
...
int func_65(int iParam0, int iParam1)//Position - 0x173D
{
	if (func_23(iParam0))
	{
...
int func_66(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x1770
{
...
void func_67(int iParam0)//Position - 0x17C7
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
{
	if (func_440(Local_110.f_9))
	{
		if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
		{
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED(sLocal_427, Local_110.f_9, 0);
		}
	}
	if (func_440(Local_320.f_0))
	{
		if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
		{
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED(sLocal_426, Local_320.f_0, 0);
		}
	}
}

void func_70(char* sParam0)//Position - 0x1986
{
		...
		case 0:
			...
			if (iLocal_100 == 4)
			{
				if (func_23(Local_320.f_0))
				{
					...
					func_115(Local_320.f_0, 0);
					if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_320.f_0))
					{
						if (func_114(Local_320.f_0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 35f, 1))
						{
							AUDIO::STOP_PED_SPEAKING(Local_320.f_0, false);
							func_112(Local_320.f_0, "GENERIC_FRIGHTENED_HIGH", "MAUDE", 3, 0);
						}
					}
				}
				if (ENTITY::DOES_ENTITY_EXIST(Local_334.f_0))
				{
					ENTITY::FREEZE_ENTITY_POSITION(Local_334.f_0, false);
				}
				if (ENTITY::DOES_ENTITY_EXIST(Local_340.f_0))
				{
					ENTITY::FREEZE_ENTITY_POSITION(Local_340.f_0, false);
				}
				STREAMING::REQUEST_ANIM_DICT(func_111());
				if (func_109(&Local_320, &Local_328, &iLocal_412))
				{
					iLocal_386 = 1;
				}
			}
			...
			{
				iLocal_373 = 0;
				StringCopy(&Local_596, "BBC_T12", 24);
			}
			if (func_23(Local_110.f_9))
			{
			...
			iVar1 = 0;
			while (iVar1 <= (iLocal_405 - 1))
			{
				func_108(Local_130[iVar1 /*19*/], 1);
				iVar1++;
			}
			switch (iLocal_100)
			{
		...
		case 1:
			...
			else if (!iLocal_373)
			{
				...
				if (iLocal_100 == 4)
				{
					if (func_23(Local_320.f_0))
					{
						if (func_114(Local_320.f_0, Local_617, 35f, 1))
						{
							func_99(&uLocal_430, 4, Local_320.f_0, "MAUDE", 0, 1);
							if (func_77(&uLocal_430, cLocal_424, &Local_596, 4, 0, 0, 0))
							{
								iLocal_373 = 1;
							}
						}
				...
				else if (func_77(&uLocal_430, cLocal_424, &Local_596, 4, 0, 0, 0))
				{
					iLocal_373 = 1;
				}
				if (iLocal_100 == 4)
				{
					...
					else if (func_23(Local_320.f_0))
					{
						if (!func_65(Local_320.f_0, joaat("SCRIPT_TASK_SMART_FLEE_PED")))
						{
							if (!PED::IS_PED_FLEEING(Local_320.f_0))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_320.f_0, func_111(), func_76(), 3))
								{
									func_75(&Local_320);
									TASK::TASK_SMART_FLEE_PED(Local_320.f_0, PLAYER::PLAYER_PED_ID(), 50f, -1, false, false);
									PED::SET_PED_KEEP_TASK(Local_320.f_0, true);
								}
							}
						}
...
void func_75(int iParam0)//Position - 0x1D4D
{
	if (func_23(*iParam0))
	{
...
int func_77(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1DC2
{
	if (iParam4 == 0)
	{
...
bool func_78(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1DFF
{
...
int func_79(char* sParam0, int iParam1, bool bParam2)//Position - 0x1E4D
{
	Global_22426 = 0;
...
var func_83(int iParam0, int iParam1)//Position - 0x21C5
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_84()//Position - 0x21DD
{
	return -1;
}
...
bool func_91(int iParam0)//Position - 0x24FD
{
	return iParam0 < 3;
}

int func_92(int iParam0)//Position - 0x2509
{
	int iVar0;
	int iVar1;
...
int func_93(int iParam0)//Position - 0x2546
{
	if (func_91(iParam0))
	{
...
var func_94(int iParam0)//Position - 0x256B
{
...
void func_99(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x266D
{
...
void func_100(bool bParam0)//Position - 0x2708
{
	...
	if (iLocal_403 > 0)
	{
		...
		{
			func_39(&(Local_226[iVar0 /*6*/]), bParam0);
			iVar0++;
		}
	}
	if (iLocal_401 > 0)
	{
		iVar0 = 0;
		while (iVar0 <= (iLocal_401 - 1))
		{
			func_39(&(Local_275[iVar0 /*9*/]), bParam0);
			iVar0++;
		}
	}
	if (iLocal_404 > 0)
	{
		...
		{
			func_105(&(Local_312[iVar0 /*7*/]));
			iVar0++;
		}
	}
	func_39(&Local_328, bParam0);
	func_39(&Local_334, bParam0);
	func_39(&Local_340, 0);
	func_39(&Local_346, 0);
	if (func_23(Local_110.f_9))
	{
	...
	if (func_23(Local_320.f_0))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_320.f_0, false);
		PED::SET_PED_KEEP_TASK(Local_320.f_0, true);
	}
	func_43(&Local_320, bParam0);
	if (iLocal_405 > 0)
	{
		iVar0 = 0;
		while (iVar0 <= (iLocal_405 - 1))
		{
			if (iLocal_109 == 4)
			{
				if (func_23(Local_130[iVar0 /*19*/]))
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_130[iVar0 /*19*/], joaat("HATES_PLAYER"));
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_130[iVar0 /*19*/], false);
					if (Global_112841 == 0)
					{
						PED::SET_PED_KEEP_TASK(Local_130[iVar0 /*19*/], false);
					}
					else
					{
						PED::SET_PED_KEEP_TASK(Local_130[iVar0 /*19*/], true);
					}
				}
			}
			func_43(&(Local_130[iVar0 /*19*/]), bParam0);
			iVar0++;
		}
	}
	if (iLocal_402 > 0)
	{
		...
		{
			func_101(&(Local_189[iVar0 /*6*/]), bParam0);
			iVar0++;
		}
	}
}

void func_101(int* iParam0, bool bParam1)//Position - 0x28DB
{
	if (bParam1)
	{
		func_103(iParam0);
...
void func_102(int* iParam0)//Position - 0x28F7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_103(int* iParam0)//Position - 0x292F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_104(int iParam0)//Position - 0x29CB
{
	if (func_440(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_109(int iParam0, int iParam1, int iParam2)//Position - 0x2AF5
{
	int iVar0;
...
void func_112(int iParam0, char* sParam1, char* sParam2, int iParam3, bool bParam4)//Position - 0x2C59
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_113(iParam3), bParam4);
}

int func_113(int iParam0)//Position - 0x2C73
{
	int iVar0;
...
bool func_114(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2E68
{
...
void func_118(int* iParam0, bool bParam1)//Position - 0x2F3B
{
	bool bVar0;
	struct<8> Var1;
...
void func_119(int* iParam0)//Position - 0x2FB5
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_120(int iParam0)//Position - 0x2FD5
{
	...
	{
		func_118(&(Local_130[iVar0 /*19*/].f_6), 0);
		iVar0++;
	}
}
		...
		case 1:
			if (func_122(iLocal_409, 500))
			{
				if (!bLocal_374)
				{
					...
					if (func_77(&uLocal_430, cLocal_424, "BBC_PK1", 4, 0, 0, 0))
					{
						bLocal_374 = true;
					}
				}
...
{
	if (func_23(Local_130[iParam0 /*19*/]))
	{
		if (PED::GET_PED_RELATIONSHIP_GROUP_HASH(Local_130[iParam0 /*19*/]) == iLocal_595)
		{
			PED::SET_PED_HEARING_RANGE(Local_130[iParam0 /*19*/], 30f);
			PED::SET_PED_SEEING_RANGE(Local_130[iParam0 /*19*/], 30f);
			PED::SET_PED_ID_RANGE(Local_130[iParam0 /*19*/], 30f);
			PED::SET_PED_COMBAT_RANGE(Local_130[iParam0 /*19*/], 0);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_130[iParam0 /*19*/], 1, false);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_130[iParam0 /*19*/], 3, true);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_130[iParam0 /*19*/], 0, true);
			TASK::TASK_LOOK_AT_ENTITY(Local_130[iParam0 /*19*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			if (!PED::IS_PED_FLEEING(Local_130[iParam0 /*19*/]))
			{
				if (PED::IS_PED_USING_ANY_SCENARIO(Local_130[iParam0 /*19*/]))
				{
					PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(Local_130[iParam0 /*19*/]);
				}
				TASK::TASK_CLEAR_LOOK_AT(Local_130[iParam0 /*19*/]);
				TASK::CLEAR_PED_SECONDARY_TASK(Local_130[iParam0 /*19*/]);
				TASK::CLEAR_PED_TASKS(Local_130[iParam0 /*19*/]);
				TASK::TASK_HANDS_UP(Local_130[iParam0 /*19*/], -1, PLAYER::PLAYER_PED_ID(), -1, 0);
			}
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_130[iParam0 /*19*/], true);
			Local_130[iParam0 /*19*/].f_14 = 2;
		}
		else
		{
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_130[iParam0 /*19*/], 13, false);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_130[iParam0 /*19*/], 5, false);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_130[iParam0 /*19*/], 17, true);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_130[iParam0 /*19*/], 0, true);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_130[iParam0 /*19*/], false);
			Local_130[iParam0 /*19*/].f_14 = 5;
		}
	}
}
...
void func_130(int iParam0, bool bParam1, int iParam2)//Position - 0x3897
{
	if (iParam2 == -1)
	{
		iParam2 = func_31();
	...
	switch (iLocal_98)
	{
		case 0:
			...
			if (func_38())
			{
				if (func_61(1, 10.5f, 1))
				{
					...
					if (func_440(Local_320.f_0))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_320.f_0, sLocal_426, 0, 0, 0);
					}
					if (func_440(Local_110.f_9))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_110.f_9, sLocal_427, 0, 0, 0);
					}
					if (func_440(Local_328.f_0))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_328.f_0, sLocal_428, 0, 0, 0);
					}
					if (func_440(Local_334.f_0))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_334.f_0, sLocal_429, 0, 0, 0);
					}
		...
		case 2:
			...
			else
			{
				...
				if (func_23(Local_320.f_0))
				{
					TASK::TASK_LOOK_AT_ENTITY(Local_320.f_0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					PED::SET_PED_KEEP_TASK(Local_320.f_0, true);
				}
				func_44(&Local_320, 1, 0, 1);
				func_133(5);
			}
			break;
	}
...
void func_134(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x3BFF
{
	struct<3> Var0;
	var uVar3;
...
void func_135(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x3C7A
{
	struct<60> Var0;
...
void func_137(int iParam0, int iParam1)//Position - 0x3EBA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_138(int iParam0)//Position - 0x40BF
{
...
int func_139(int iParam0)//Position - 0x419C
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_140(int iParam0, bool bParam1, int iParam2)//Position - 0x435A
{
	int iVar0;
	struct<2> Var1;
...
int func_141(int iParam0)//Position - 0x44DF
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_143(int iParam0, int iParam1)//Position - 0x45C2
{
	int iVar0;
	int iVar1;
...
int func_146()//Position - 0x47F7
{
	return 0;
}

int func_147()//Position - 0x4800
{
	return 1;
}

int func_148()//Position - 0x4809
{
	return 1;
}

int func_149()//Position - 0x4812
{
...
int func_151(int iParam0)//Position - 0x48E3
{
	int iVar0;
	char* sVar1;
...
int func_152(int iParam0)//Position - 0x492A
{
	int iVar0;
...
int func_153(int iParam0)//Position - 0x4965
{
	int iVar0;
...
int func_154(int iParam0)//Position - 0x49E1
{
	int iVar0;
...
int func_155(int iParam0, int iParam1, bool bParam2)//Position - 0x4AC9
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_156(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x4B37
{
...
var func_162(int iParam0)//Position - 0x4E01
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_163(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_163(bool bParam0, int iParam1, int iParam2)//Position - 0x4E23
{
	if (bParam0)
	{
		return iParam1;
...
int func_164(var uParam0)//Position - 0x4E3A
{
	return uParam0 & 15;
}
...
int func_168(var uParam0, int iParam1)//Position - 0x4EF8
{
	int iVar0;
	int iVar1;
...
int func_169(int iParam0, int iParam1)//Position - 0x65E6
{
	struct<82> Var0;
...
void func_170(int iParam0, var uParam1, int iParam2)//Position - 0x6628
{
	int iVar0;
...
void func_171(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x6884
{
	if (func_168(&(Global_78329.f_555[0 /*21*/]), iParam0))
	{
...
int func_174(int iParam0, int iParam1)//Position - 0x6A15
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_177(int iParam0)//Position - 0x6B78
{
	int iVar0;
...
bool func_178(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6BDB
{
	if (bParam6)
	{
...
int func_181(int iParam0, var uParam1, var uParam2)//Position - 0x6F7D
{
	int iVar0;
	int iVar1;
...
int func_182(int iParam0)//Position - 0x7170
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_185(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x7267
{
	int iVar0;
...
int func_186(struct<3> Param0, int iParam3, int iParam4)//Position - 0x737D
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_187(int iParam0)//Position - 0x740C
{
...
void func_189(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x743D
{
	func_190(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_190(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x7466
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_191(struct<3> Param0)//Position - 0x785C
{
...
int func_192(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x7886
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_193(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x7B7C
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_194(struct<3> Param0)//Position - 0x7C30
{
	float fVar0;
	float fVar1;
...
void func_195(int iParam0)//Position - 0x7C6F
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
bool func_196(struct<3> Param0, int iParam3)//Position - 0x7CD4
{
	return func_197(Global_104696.f_2890.f_12.f_66, Param0, iParam3);
}

int func_197(int iParam0, struct<3> Param1, int iParam4)//Position - 0x7CF1
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_201(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x7DC0
{
	int iVar0;
...
Vector3 func_202(int iParam0)//Position - 0x7F7E
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_203(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x7F91
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_204(int iParam0, int iParam1, int iParam2)//Position - 0x87A3
{
	int iVar0;
...
int func_207(int iParam0, int iParam1, int iParam2)//Position - 0x8909
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
int func_209(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x8A0F
{
	var uVar0;
	int iVar10;
...
int func_210(int iParam0, int iParam1, int iParam2)//Position - 0x9013
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_211(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x90AC
{
	int iVar0;
...
int func_212(int iParam0, int iParam1, int iParam2)//Position - 0x9157
{
	int iVar0;
	int iVar1;
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x92A8
{
	int iVar0;
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x95AF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_216(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0xA162
{
	int iVar0;
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA744
{
	int iVar0;
...
int func_220(int iParam0, int iParam1, int iParam2)//Position - 0xA76D
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_221(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAA37
{
	int iVar0;
...
void func_223(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAE18
{
	int iVar0;
...
int func_224(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAEB2
{
	switch (iParam0)
	{
...
int func_228(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB4A2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_229(int iParam0, int iParam1)//Position - 0xB59E
{
	int iVar0;
...
void func_234(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC1AD
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_235(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xC2D7
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
int func_240(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE472
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_241(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE6EF
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_242(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEB14
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_243(int iParam0, int iParam1)//Position - 0xEE07
{
	int iVar0;
	int iVar1;
...
int func_244(int iParam0, int iParam1)//Position - 0xEE4E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_245(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEEAE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_248(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0xEFF9
{
	int iVar0;
...
int func_249(int iParam0, var uParam1)//Position - 0xF027
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_250(uParam1));
}

int func_250(var uParam0)//Position - 0xF03C
{
	int iVar0;
	int iVar1;
...
int func_253(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x11CC2
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_254(int iParam0)//Position - 0x12B65
{
	if (!BitTest(Global_79322[1 /*14*/].f_6, 0))
	{
		return 0;
...
void func_258(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x13F66
{
	var uVar0;
	int iVar1;
...
int func_262(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x14F03
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_321()//Position - 0x26891
{
	...
	if (func_23(Local_110.f_9))
	{
		...
		func_388(Local_110.f_9, &iLocal_406, 1126825984, 7);
		func_380(Local_110.f_9, &(Local_110.f_19), 1126825984, 7);
		func_368();
		switch (iLocal_98)
		{
			case 0:
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("PLAYER"), iLocal_595);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_595, joaat("PLAYER"));
				iLocal_410 = ENTITY::GET_ENTITY_HEALTH(Local_110.f_9);
				Local_632 = { ENTITY::GET_ENTITY_COORDS(Local_110.f_9, false) };
				func_367(&Local_635, Local_632);
				...
				func_364(&(Local_110.f_8), "", "", &iLocal_398, iLocal_399, 0);
				iLocal_98 = 1;
				break;
			...
			case 1:
				if (!iLocal_380)
				{
					...
					if (Local_110.f_10 == 13 || Local_110.f_10 == 14)
					{
						...
						if (func_333(Local_110.f_9, Local_617, bVar0, 0, 1, iLocal_410))
						{
							if ((func_122(iLocal_408, 5000) || func_178(Local_635, 0f, 0f, 0f, 0)) || (!func_60(Var1, Local_635, 8.5f) && !func_60(Var1, Local_632, 8.5f)))
							{
								func_332();
						...
						else
						{
							if (!iLocal_352)
							{
								if (!func_122(iLocal_395, 2500))
								{
									if (!func_63())
									{
										if (func_114(Local_110.f_9, Local_617, 30f, 1))
										{
											if (func_77(&uLocal_430, cLocal_423, "BB4_J7", 4, 0, 0, 0))
											{
												iLocal_395 = MISC::GET_GAME_TIMER();
												iLocal_352 = 1;
											}
								...
								if (func_122(iLocal_395, MISC::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_114(Local_110.f_9, Local_617, 30f, 1))
									{
										if (PED::IS_PED_FLEEING(Local_110.f_9))
										{
											...
											{
												if (func_77(&uLocal_430, cLocal_424, "BBC_T13", 4, 0, 0, 0))
												{
													iLocal_395 = MISC::GET_GAME_TIMER();
												}
											}
											else if (func_77(&uLocal_430, cLocal_423, "BB4_FLEE", 4, 0, 0, 0))
											{
												iLocal_395 = MISC::GET_GAME_TIMER();
											}
										}
							...
							func_329(Local_110.f_9, Local_617, iLocal_408, 925353388);
						}
					}
					else
					{
				...
				{
					func_332();
					if (!func_114(Local_110.f_9, Local_617, 10f, 1))
					{
						if (!iLocal_368)
						{
							if (!func_327(sLocal_419, 1))
							{
								func_325(&(Local_110.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_398, &iLocal_399, 1, 1);
								iLocal_368 = 1;
							}
						}
						else
						{
							func_364(&(Local_110.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_398, iLocal_399, 1);
						}
					}
					else
					{
						if (!iLocal_353)
						{
							if (!PED::IS_PED_RAGDOLL(Local_110.f_9) && !PED::IS_PED_IN_ANY_VEHICLE(Local_110.f_9, false))
							{
								...
								if (func_77(&uLocal_430, cLocal_423, sLocal_419, 4, 0, 0, 0))
								{
									iLocal_353 = 1;
								}
							}
			...
			case 2:
				...
				iLocal_353 = 1;
				func_332();
				PED::CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("PLAYER"), iLocal_595);
				PED::CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_595, joaat("PLAYER"));
				func_119(&(Local_110.f_8));
				iLocal_353 = 1;
				Local_110.f_17 = MISC::GET_GAME_TIMER();
				func_330(&uLocal_42, 0, 0);
...
void func_367(var* uParam0, struct<3> Param1)//Position - 0x28613
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_368()//Position - 0x286F0
{
	...
	if (func_23(Local_110.f_9))
	{
		if (iLocal_188 == 0)
		{
			func_379(&(Local_110.f_9), &bLocal_387);
			if (func_378())
			{
				if (iLocal_380 || iLocal_96 == 7)
				{
					if (bLocal_387)
					{
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				case 0:
					if (func_114(Local_110.f_9, Local_617, 20f, 1))
					{
				...
				case 6:
					if (!func_114(Local_110.f_9, Local_617, 3.5f, 1))
					{
				...
				case 29:
					...
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_110.f_9, 0, false);
					PED::SET_PED_COMBAT_RANGE(Local_110.f_9, 0);
					PED::SET_PED_ACCURACY(Local_110.f_9, 15);
					TASK::CLEAR_PED_TASKS(Local_110.f_9);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_110.f_9, true);
					Local_110.f_10 = 30;
					break;
				...
				case 30:
					if (!func_65(Local_110.f_9, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
					{
						...
						TASK::TASK_PERFORM_SEQUENCE(Local_110.f_9, iLocal_416);
				...
				case 31:
					if (func_122(Local_110.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						PED::SET_PED_ACCURACY(Local_110.f_9, 50);
						WEAPON::GET_CURRENT_PED_WEAPON(Local_110.f_9, &iVar0, true);
						if (iVar0 == joaat("WEAPON_UNARMED"))
						{
							WEAPON::GIVE_WEAPON_TO_PED(Local_110.f_9, joaat("WEAPON_PISTOL"), -1, false, true);
						...
						TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Local_620, PLAYER::PLAYER_PED_ID(), 1f, true, 0.5f, 4f, true, 0, false, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
						TASK::TASK_SEEK_COVER_FROM_PED(0, PLAYER::PLAYER_PED_ID(), MISC::GET_RANDOM_INT_IN_RANGE(1500, 2500), true);
						TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
						TASK::TASK_SET_SPHERE_DEFENSIVE_AREA(0, Local_620, 50f);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_416);
						TASK::TASK_PERFORM_SEQUENCE(Local_110.f_9, iLocal_416);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_416);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_110.f_9, true);
				...
				case 33:
					if (func_122(Local_110.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						PED::SET_PED_ACCURACY(Local_110.f_9, 10);
						WEAPON::GET_CURRENT_PED_WEAPON(Local_110.f_9, &iVar0, true);
						if (iVar0 == joaat("WEAPON_UNARMED"))
						{
							WEAPON::GIVE_WEAPON_TO_PED(Local_110.f_9, joaat("WEAPON_PISTOL"), -1, false, true);
						...
						TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Local_620, PLAYER::PLAYER_PED_ID(), 2f, true, 0.5f, 4f, true, 0, false, joaat("FIRING_PATTERN_BURST_FIRE"), 20000);
				...
				case 35:
					if (func_122(Local_110.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						TASK::OPEN_SEQUENCE_TASK(&iLocal_416);
						TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 750, false);
						TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Local_620, PLAYER::PLAYER_PED_ID(), 2f, true, 0.75f, 4f, true, 0, false, joaat("FIRING_PATTERN_BURST_FIRE"), 20000);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_416);
						TASK::TASK_PERFORM_SEQUENCE(Local_110.f_9, iLocal_416);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_416);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_110.f_9, true);
				...
				case 37:
					if (func_122(Local_110.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 750)))
					{
						...
						PED::SET_PED_COMBAT_RANGE(Local_110.f_9, 1);
				...
				case 13:
					if (func_122(Local_110.f_18, MISC::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_110.f_9))
						{
							PED::SET_PED_PANIC_EXIT_SCENARIO(Local_110.f_9, Local_617);
						}
						WEAPON::GET_CURRENT_PED_WEAPON(Local_110.f_9, &iVar0, true);
						if (iVar0 != joaat("WEAPON_UNARMED"))
						{
						...
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_110.f_9, 5, false);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_110.f_9, 17, true);
						TASK::TASK_SMART_FLEE_PED(Local_110.f_9, PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_110.f_9, true);
						PED::SET_PED_KEEP_TASK(Local_110.f_9, true);
						Local_110.f_10 = 14;
					}
				...
				case 14:
					if (!func_65(Local_110.f_9, joaat("SCRIPT_TASK_SMART_FLEE_PED")))
					{
						if (!PED::IS_PED_FLEEING(Local_110.f_9))
						{
							Local_110.f_18 = (MISC::GET_GAME_TIMER() - 5000);
				...
				case 15:
					...
					if (func_104(Local_189[0 /*6*/]))
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_189[0 /*6*/], false) && func_114(Local_189[0 /*6*/], Local_189[0 /*6*/].f_1, 3f, 1)) && func_375(ENTITY::GET_ENTITY_HEADING(Local_189[0 /*6*/]), Local_189[0 /*6*/].f_4, 20f))
						{
							if (PED::IS_PED_IN_VEHICLE(Local_110.f_9, Local_189[0 /*6*/], false) && !PED::IS_PED_BEING_JACKED(Local_110.f_9))
							{
								Local_110.f_10 = 16;
							}
							else if (func_122(Local_110.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 350)))
							{
								...
								TASK::TASK_ENTER_VEHICLE(Local_110.f_9, Local_189[0 /*6*/], 25000, -1, 2f, 8388608, 0, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_110.f_9, true);
								Local_110.f_10 = 16;
							}
						}
				...
				case 16:
					...
					else if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_189[0 /*6*/], false) || PED::IS_PED_BEING_JACKED(Local_110.f_9)) || !func_114(Local_189[0 /*6*/], Local_189[0 /*6*/].f_1, 3f, 1)) || !func_375(ENTITY::GET_ENTITY_HEADING(Local_189[0 /*6*/]), Local_189[0 /*6*/].f_4, 20f))
					{
						Local_110.f_10 = 13;
					}
					else if (PED::IS_PED_SITTING_IN_VEHICLE(Local_110.f_9, Local_189[0 /*6*/]))
					{
						Local_110.f_10 = 39;
					}
				...
				case 17:
					if (func_104(Local_189[0 /*6*/]) && PED::IS_PED_SITTING_IN_VEHICLE(Local_110.f_9, Local_189[0 /*6*/]))
					{
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_110.f_9, Local_189[0 /*6*/], PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 350f, 30f, true);
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (func_370())
							{
								...
								if (!PED::IS_PED_IN_VEHICLE(Local_110.f_9, iVar1, false))
								{
									...
									if (fVar4 < 1.75f && func_114(Local_110.f_9, Local_617, 8f, 1))
									{
				...
				case 23:
					if (func_373(Local_110.f_9, Local_110.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_372())
					{
						...
						{
							TASK::TASK_LOOK_AT_ENTITY(Local_110.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							if ((!func_369(Local_110.f_19, 10) && func_114(Local_110.f_9, Local_617, 50f, 1)) || !func_122(iLocal_413, 2000))
							{
					...
					if (func_373(Local_110.f_9, Local_110.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_372())
					{
						if (!func_65(Local_110.f_9, joaat("SCRIPT_TASK_HANDS_UP")))
						{
							if (!func_65(Local_110.f_9, joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_110.f_9, false))
								{
									if (!func_369(Local_110.f_19, 10) && func_114(Local_110.f_9, Local_617, 50f, 1))
									{
										TASK::TASK_LEAVE_ANY_VEHICLE(Local_110.f_9, 0, 0);
										Local_110.f_10 = 23;
									}
							...
							else if (!func_369(Local_110.f_19, 10) && func_114(Local_110.f_9, Local_617, 50f, 1))
							{
...
int func_372()//Position - 0x29C4C
{
	if (!iLocal_353)
	{
		return 1;
	}
	if (func_327(sLocal_419, 0))
	{
		return 1;
	}
...
int func_373(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)//Position - 0x29CB9
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (func_23(iParam0))
	{
		...
		if (func_114(iParam0, Local_617, fParam2, 1))
		{
...
int func_374(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29E70
{
	int iVar0;
...
int func_375(float fParam0, float fParam1, float fParam2)//Position - 0x29F67
{
...
void func_379(var uParam0, bool bParam1)//Position - 0x29FD0
{
...
void func_380(int iParam0, var uParam1, float fParam2, int iParam3)//Position - 0x29FE7
{
	if (func_440(iParam0))
	{
...
int func_382(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2A0D4
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_383(int iParam0, int iParam1)//Position - 0x2A200
{
	int iVar0;
...
int func_385(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2A30F
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_386(struct<3> Param0, struct<3> Param3)//Position - 0x2A3A0
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

int func_387(int iParam0, int iParam1)//Position - 0x2A3C1
{
	int iVar0;
...
void func_388(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2A400
{
	if (func_440(iParam0))
	{
...
{
	if (func_60(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_614, 100f))
	{
		if (!func_390())
		{
			CUTSCENE::REQUEST_CUTSCENE(&Local_602, 8);
			func_69();
			iLocal_384 = 1;
		}
	}
	...
	{
		if (!func_60(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_614, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
		...
		switch (iLocal_98)
		{
			...
			case 1:
				if (!iLocal_381)
				{
					...
					func_119(&(Local_110.f_8));
					if (!func_114(Local_110.f_9, Local_617, 25f, 1))
					{
						...
						if (func_369(iLocal_406, 10))
						{
							if (!func_63())
							{
								if (func_77(&uLocal_430, cLocal_424, "BBC_T9", 4, 0, 0, 0))
								{
									iLocal_395 = MISC::GET_GAME_TIMER();
								}
							}
					...
					else if (!iLocal_354)
					{
						if (!func_327(sLocal_419, 1))
						{
							if (func_77(&uLocal_430, cLocal_424, "BBC_T5", 4, 0, 0, 0))
							{
								iLocal_354 = 1;
							}
						}
					...
					{
						func_394();
						func_392(&Local_320, Local_617, &iLocal_397, 5000, 1101004800);
					}
				}
				else if (func_114(Local_110.f_9, Local_617, 8f, 1))
				{
					...
					if (!func_63())
					{
						if (Local_110.f_10 == 21 || Local_110.f_10 == 22)
						{
							...
							{
								if (func_77(&uLocal_430, cLocal_424, "BBC_T10", 4, 0, 0, 0))
								{
									iLocal_395 = MISC::GET_GAME_TIMER();
								}
							}
							else if (func_77(&uLocal_430, cLocal_423, "BB4_J5", 4, 0, 0, 0))
							{
								iLocal_395 = MISC::GET_GAME_TIMER();
							}
						}
...
int func_392(int iParam0, struct<3> Param1, int iParam4, int iParam5, float fParam6)//Position - 0x2A7D8
{
	struct<3> Var0;
	var uVar3;
	char[] cVar168[8];
		...
		if (!func_63())
		{
			...
			if (SYSTEM::VDIST2(Param1, Var0) < (fParam6 * fParam6))
			{
				if (MISC::GET_GAME_TIMER() - *iParam4) > (iParam5 + MISC::GET_RANDOM_INT_IN_RANGE(0, 2000))
				{
					...
					cVar168 = "BBCAUD";
					sVar169 = "BBC_loiter";
					func_393(&uVar3, cVar168, sVar169, 4, 0, 0);
					*iParam4 = MISC::GET_GAME_TIMER();
					return 1;
				}
			}
...
void func_393(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2A865
{
...
void func_394()//Position - 0x2A8A0
{
	...
	if (func_23(Local_110.f_9))
	{
		...
		if (!iLocal_356)
		{
			if (func_77(&uLocal_430, cLocal_423, "BB4_J6", 4, 0, 0, 0))
			{
				iLocal_356 = 1;
			}
		}
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_110.f_9, false) && PED::GET_VEHICLE_PED_IS_IN(Local_110.f_9, false) == iVar0)
			{
						...
						if (ENTITY::GET_ENTITY_SPEED(iVar0) < 0.5f)
						{
							if (!iLocal_375)
							{
								if (!func_63())
								{
									...
									{
										if (func_77(&uLocal_430, cLocal_423, "BB4_STOP", 4, 0, 0, 0))
										{
											iLocal_375 = 1;
										}
									}
				...
				{
					if (func_77(&uLocal_430, cLocal_423, "BB4_J9", 4, 0, 0, 0))
					{
						iLocal_355 = 1;
					}
				}
			...
			if (PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!iLocal_362)
				{
					if (func_370())
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(Local_110.f_9, false))
						{
							...
							{
								if (func_77(&uLocal_430, cLocal_424, "BBC_T6", 4, iVar1, 0, 0))
								{
									iLocal_362 = 1;
								}
							}
					...
					else if (!func_327("BBC_T8", 1) && !func_327("BB4_VEH", 1))
					{
						...
						{
							if (func_77(&uLocal_430, cLocal_424, "BBC_T8", 4, iVar1, 0, 0))
							{
								iLocal_362 = 1;
							}
						}
						else if (func_77(&uLocal_430, cLocal_423, "BB4_VEH", 4, iVar1, 0, 0))
						{
							iLocal_362 = 1;
						}
					}
				...
				else if (!iLocal_366)
				{
					if (func_395(&iVar0))
					{
						...
						{
							if (func_77(&uLocal_430, cLocal_423, "BB4_JACK", 4, iVar1, 0, 0))
							{
								iLocal_366 = 1;
							}
						}
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(Local_110.f_9, false))
				{
					if (!iLocal_363)
					{
						if (!func_327("BBC_T7", 1) && !func_327("BB4_GETOUT", 1))
						{
							if (MISC::GET_RANDOM_INT_IN_RANGE(0, 11) < 5)
							{
								if (func_77(&uLocal_430, cLocal_424, "BBC_T7", 4, iVar1, 0, 0))
								{
									iLocal_363 = 1;
								}
							}
							else if (func_77(&uLocal_430, cLocal_423, "BB4_GETOUT", 4, iVar1, 0, 0))
							{
								iLocal_363 = 1;
							}
						}
					...
					if (func_114(Local_110.f_9, Local_617, 25f, 1))
					{
						if (!func_327("BB4_J11", 1))
						{
							if (func_122(iLocal_396, MISC::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								...
								if (func_77(&uLocal_430, cLocal_423, "BB4_J11", 4, 0, 0, 0))
								{
				...
				else
				{
					...
					if (!func_63())
					{
						if (func_122(iLocal_395, MISC::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_114(Local_110.f_9, Local_617, 20f, 1))
							{
								if (func_77(&uLocal_430, cLocal_423, "BB4_J4", 4, 0, 0, 0))
								{
									iLocal_395 = MISC::GET_GAME_TIMER();
								}
							}
...
int func_395(int iParam0)//Position - 0x2ACFE
{
	int iVar0;
...
{
	if (!iLocal_357[iParam0])
	{
		if (func_77(&uLocal_430, cLocal_423, sLocal_420[iParam0], 4, 0, 0, 0))
		{
			iLocal_357[iParam0] = 1;
			iLocal_379 = 0;
			iLocal_394 = 0;
		}
	}
		...
		switch (iLocal_98)
		{
			...
			case 1:
				if (!iLocal_381)
				{
					...
					else
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_388))
						{
							if (iLocal_367)
							{
								iLocal_388 = func_401(Local_614, 5, 1);
							}
						}
						if (!iLocal_354)
						{
						...
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_614, 4f, 4f, 2f, true, true, 0))
						{
						}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (func_114(PLAYER::PLAYER_PED_ID(), Local_614, 6.5f, 1))
							{
								iLocal_98 = 2;
							}
						}
						else if (func_114(PLAYER::PLAYER_PED_ID(), Local_614, 2.5f, 1))
						{
							iLocal_98 = 2;
						}
					}
				...
				else
				{
					...
					if (func_114(Local_110.f_9, Local_617, 8f, 1))
					{
						if (Local_110.f_10 == 25 || Local_110.f_10 == 26)
						{
							Local_110.f_18 = MISC::GET_GAME_TIMER();
				...
				if (!bLocal_378)
				{
					bLocal_378 = func_399(Local_617, Local_101, 180f);
				}
				if (func_322(&(Local_110.f_9)))
				{
					iLocal_385 = 1;
			...
			case 2:
				...
				else
				{
					...
					if (!bLocal_378)
					{
						bLocal_378 = func_399(Local_617, Local_101, 0f);
					}
					func_133(4);
				}
				break;
...
int func_399(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2B162
{
	int iVar0;
	
	if (!func_400(Param0, Param3, fParam6))
	{
		...
		if (iLocal_405 > 0)
		{
			...
			while (iVar0 <= (iLocal_405 - 1))
			{
				func_44(&(Local_130[iVar0 /*19*/]), 1, 0, 1);
				iVar0++;
			}
		}
		if (iLocal_402 > 0)
...
bool func_400(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2B253
{
	struct<3> Var0;
...
int func_401(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x2B27D
{
	int iVar0;
...
void func_402()//Position - 0x2B2AB
{
	...
	if (func_23(Local_110.f_9))
	{
		...
		{
			case 0:
				if (Local_110.f_10 != 35 && Local_110.f_10 != 36)
				{
					Local_110.f_18 = MISC::GET_GAME_TIMER();
					Local_110.f_10 = 35;
				}
			...
			case 1:
				...
				if (!iLocal_380)
				{
					...
					if (!iLocal_352)
					{
						if (func_114(Local_110.f_9, Local_617, 30f, 1))
						{
							if (!func_63())
							{
								...
								sLocal_418 = "BB4_J1";
								if (func_77(&uLocal_430, cLocal_423, sLocal_418, 4, 0, 0, 0))
								{
									Local_110.f_17 = MISC::GET_GAME_TIMER();
									iLocal_395 = MISC::GET_GAME_TIMER();
									iLocal_352 = 1;
					...
					if (Local_110.f_10 == 13 || Local_110.f_10 == 14)
					{
						...
						if (func_333(Local_110.f_9, Local_617, bVar0, 0, 1, 170))
						{
							func_332();
							func_404(iLocal_405);
							Local_110.f_17 = MISC::GET_GAME_TIMER();
						...
						else
						{
							...
							func_329(Local_110.f_9, Local_617, iLocal_407, 925353388);
						}
					}
				}
				else
...
void func_404(int iParam0)//Position - 0x2B7BB
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (Local_130[iVar0 /*19*/].f_14 != 6)
		{
			func_108(Local_130[iVar0 /*19*/], 1);
			Local_130[iVar0 /*19*/].f_14 = 4;
			func_118(&(Local_130[iVar0 /*19*/].f_6), 0);
		}
		iVar0++;
	}
...
void func_405(int iParam0)//Position - 0x2B805
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_23(Local_130[iVar0 /*19*/]))
		{
			func_380(Local_130[iVar0 /*19*/], &(Local_130[iVar0 /*19*/].f_16), 1126825984, 7);
			switch (Local_130[iVar0 /*19*/].f_14)
			{
				case 0:
					break;
				...
				case 1:
					...
					if (func_122(Local_130[iVar0 /*19*/].f_15, iVar2))
					{
						func_123(iVar0);
					}
					break;
				...
				case 2:
					if (func_407(Local_130[iVar0 /*19*/], Local_130[iVar0 /*19*/].f_16, 50f, 1, 1, 12f, 15f))
					{
						if (!func_23(Local_110.f_9) || (PED::IS_PED_FLEEING(Local_110.f_9) && TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(Local_110.f_9) > 1f))
						{
							if (TASK::GET_SCRIPT_TASK_STATUS(Local_130[iVar0 /*19*/], joaat("SCRIPT_TASK_HANDS_UP")) == 1)
							{
								if (iVar0 == 0)
								{
									iVar2 = 750;
								...
								TASK::UPDATE_TASK_HANDS_UP_DURATION(Local_130[iVar0 /*19*/], iVar2);
							}
							else
							{
								TASK::CLEAR_PED_TASKS(Local_130[iVar0 /*19*/]);
								TASK::CLEAR_PED_SECONDARY_TASK(Local_130[iVar0 /*19*/]);
							}
							Local_130[iVar0 /*19*/].f_14 = 4;
							func_118(&(Local_130[iVar0 /*19*/].f_6), 0);
						}
					}
					else if (!func_65(Local_130[iVar0 /*19*/], joaat("SCRIPT_TASK_COMBAT")))
					{
						func_118(&(Local_130[iVar0 /*19*/].f_6), 0);
						if (func_114(Local_130[iVar0 /*19*/], Local_617, 5f, 1))
						{
							if (!func_369(Local_130[iVar0 /*19*/].f_16, 10))
							{
								PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_130[iVar0 /*19*/], ENTITY::GET_ENTITY_COORDS(Local_130[iVar0 /*19*/], true), 5f, false, false);
								TASK::TASK_COMBAT_PED(Local_130[iVar0 /*19*/], PLAYER::PLAYER_PED_ID(), 0, 16);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_130[iVar0 /*19*/], true);
							}
						}
					}
					else
					{
						if (!func_114(Local_130[iVar0 /*19*/], Local_617, 7f, 1))
						{
							TASK::CLEAR_PED_TASKS(Local_130[iVar0 /*19*/]);
							TASK::TASK_LOOK_AT_ENTITY(Local_130[iVar0 /*19*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_130[iVar0 /*19*/], PLAYER::PLAYER_PED_ID(), -1);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_130[iVar0 /*19*/], false);
						}
						func_406(Local_130[iVar0 /*19*/], &(Local_130[iVar0 /*19*/].f_6), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
					}
					break;
				
				case 3:
					if (!func_65(Local_130[iVar0 /*19*/], joaat("SCRIPT_TASK_PLAY_ANIM")))
					{
						if (func_407(Local_130[iVar0 /*19*/], Local_130[iVar0 /*19*/].f_16, 50f, 1, 1, 12f, 15f))
						{
							func_108(Local_130[iVar0 /*19*/], 1);
				...
				case 4:
					if (!func_65(Local_130[iVar0 /*19*/], joaat("SCRIPT_TASK_HANDS_UP")))
					{
						if (!PED::IS_PED_FLEEING(Local_130[iVar0 /*19*/]))
						{
							if (!func_65(Local_130[iVar0 /*19*/], joaat("SCRIPT_TASK_SMART_FLEE_PED")))
							{
								func_108(Local_130[iVar0 /*19*/], 1);
							}
						}
...
int func_406(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)//Position - 0x2BB63
{
	bool bVar0;
...
int func_407(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, float fParam6)//Position - 0x2BD57
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (func_23(iParam0))
	{
		if (func_374(1, 0, 1))
		{
			...
			if (FIRE::IS_EXPLOSION_IN_SPHERE(-1 /*EXP_TAG_DONTCARE*/, Var0, fParam6))
			{
				return 1;
			}
			Var3 = { Var0 };
...
void func_408(int iParam0)//Position - 0x2BEF1
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_23(Local_130[iVar0 /*19*/]))
		{
			Local_130[iVar0 /*19*/].f_15 = MISC::GET_GAME_TIMER();
			Local_130[iVar0 /*19*/].f_14 = 1;
		}
		iVar0++;
	}
}
...
void func_409()//Position - 0x2BF30
{
	if (func_23(Local_110.f_9))
	{
		func_388(Local_110.f_9, &iLocal_406, 1126825984, 1);
		func_380(Local_110.f_9, &(Local_110.f_19), 120f, 7);
		func_368();
		switch (iLocal_98)
		{
			case 0:
				...
				func_325(&(Local_110.f_8), "", "", &iLocal_398, &iLocal_399, 1, 0);
				iLocal_98 = 1;
				break;
				...
				switch (iLocal_99)
				{
					case 2:
						if (!iLocal_361)
						{
							...
							if (func_77(&uLocal_430, cLocal_424, "BBC_T14", 4, 0, 0, 0))
							{
								Local_110.f_17 = MISC::GET_GAME_TIMER();
								iLocal_361 = 1;
							}
						...
						else if (!iLocal_369)
						{
							...
							{
								func_325(&(Local_110.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_398, &iLocal_399, 1, 1);
								iLocal_369 = 1;
							}
						}
						else
						{
							func_364(&(Local_110.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_398, iLocal_399, 1);
							if (func_114(Local_110.f_9, Local_617, 25f, 1) && func_419(Local_110.f_9, Local_617, 10f))
							{
								if (PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false))
								{
									if (func_418(&(Local_110.f_19)))
									{
										iLocal_99 = 1;
										iLocal_364 = 0;
								...
								else if (func_417(Local_110.f_9, iLocal_406, 0, 1103626240, 1086324736))
								{
									iLocal_99 = 0;
								}
								else if (func_114(Local_110.f_9, Local_617, 5f, 1))
								{
									iLocal_99 = 0;
								}
								else if (func_418(&(Local_110.f_19)))
								{
									iLocal_99 = 1;
									iLocal_364 = 0;
									if (Local_110.f_10 != 3 && Local_110.f_10 != 4)
						...
						if (func_373(Local_110.f_9, Local_110.f_19, 25f, 0, 1090519040, 1097859072, 0))
						{
							iLocal_98 = 2;
						}
						break;
					...
					case 1:
						if (!iLocal_364)
						{
							...
							if (func_77(&uLocal_430, cLocal_423, "BB4_J2", 4, 0, 0, 0))
							{
								Local_110.f_17 = MISC::GET_GAME_TIMER();
								iLocal_395 = MISC::GET_GAME_TIMER();
								iLocal_364 = 1;
						...
						else if (!iLocal_360)
						{
							if (!func_327("BBC_T14", 1) && !func_327("BB4_J2", 1))
							{
								...
								if (func_77(&uLocal_430, cLocal_424, "BBC_T1", 4, 0, 0, 0))
								{
									Local_110.f_17 = MISC::GET_GAME_TIMER();
									iLocal_360 = 1;
								}
...
void func_413()//Position - 0x2C451
{
	if (!iLocal_365)
	{
		if (!func_63())
		{
			if (func_114(Local_110.f_9, Local_617, (25f + 5f), 1))
			{
				iLocal_389 = 0;
				if (HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(&Local_608))
				{
					if (func_77(&uLocal_430, cLocal_423, "BB4_AMB", 1, iLocal_389, 0, 0))
					{
						iLocal_365 = 1;
					}
				}
				else if (func_415(&uLocal_430, cLocal_423, "BB4_AMB", &Local_608, 1, iLocal_389, 0))
				{
					iLocal_365 = 1;
					StringCopy(&Local_608, "", 24);
				}
	...
	{
		if (!func_114(Local_110.f_9, Local_617, (25f + 10f), 1))
		{
			Local_608 = { func_414() };
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_608))
			{
...
int func_415(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2C624
{
	if (iParam5 == 0)
	{
		if (HUD::IS_MESSAGE_BEING_DISPLAYED())
...
int func_417(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)//Position - 0x2C6B5
{
	if (func_440(iParam0))
	{
		if (!func_369(iParam1, 10))
		{
			if (bParam2)
			{
				if (!func_114(Local_110.f_9, Local_617, fParam3, 1))
				{
					return 0;
				}
				if (!func_419(iParam0, Local_617, fParam4))
				{
					return 0;
				}
			}
...
int func_418(var uParam0)//Position - 0x2C71C
{
...
int func_419(int iParam0, struct<3> Param1, float fParam4)//Position - 0x2C736
{
	struct<3> Var0;
	float fVar3;
		...
		case 1:
			...
			if (func_23(Local_110.f_9))
			{
				...
				if (func_114(Local_110.f_9, Local_617, 25f, 1) && func_419(Local_110.f_9, Local_617, 10f))
				{
					...
					{
						if (func_114(Local_110.f_9, Local_617, (25f - 1.5f), 1))
						{
							iLocal_99 = 1;
							iLocal_98 = 2;
						}
...
int func_424(int iParam0, int iParam1, int iParam2)//Position - 0x2CAAE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_320.f_0))
	{
		if (ENTITY::IS_ENTITY_DEAD(Local_320.f_0, false) || PED::IS_PED_INJURED(Local_320.f_0))
		{
			iLocal_100 = 3;
			return;
		}
	...
	if (iLocal_96 == 0)
	{
		if (!SYSTEM::VDIST2(Local_617, Local_101) <= ((Local_101.f_3 + 25f) * (Local_101.f_3 + 25f)))
		{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(Local_110.f_9))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_110.f_9, false) && !PED::IS_PED_INJURED(Local_110.f_9))
		{
			...
			{
				if (!func_114(Local_110.f_9, Local_617, 150f, 1))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_110.f_9))
					{
						iLocal_100 = 2;
			...
			{
				if (!func_114(Local_110.f_9, Local_617, 80f, 1))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_110.f_9))
					{
						iLocal_100 = 2;
...
int func_430(bool bParam0)//Position - 0x2CE21
{
	if (func_23(Local_320.f_0))
	{
		if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(Local_320.f_0) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(Local_320.f_0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(Local_320.f_0))
		{
			return 1;
		}
		if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
		{
			if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_320.f_0))
			{
				return 1;
			}
			if (ENTITY::DOES_ENTITY_EXIST(Local_328.f_0))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_328.f_0))
				{
					return 1;
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(Local_340.f_0))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_340.f_0))
				{
					return 1;
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(Local_334.f_0))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_334.f_0))
				{
					return 1;
				}
			}
		}
		if (PED::HAS_PED_RECEIVED_EVENT(Local_320.f_0, 61))
		{
			return 1;
		}
		if (PED::IS_PED_RAGDOLL(Local_320.f_0))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(Local_320.f_0, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
			{
				return 1;
			}
		}
		if (PED::HAS_PED_RECEIVED_EVENT(Local_320.f_0, 51))
		{
			return 1;
		}
		if (func_436(Local_320.f_0, 1126825984))
		{
			return 1;
		}
		if (func_431(Local_320.f_0, 1, 0, 0, 0))
		{
			return 1;
		}
		if (FIRE::IS_EXPLOSION_IN_SPHERE(-1 /*EXP_TAG_DONTCARE*/, ENTITY::GET_ENTITY_COORDS(Local_320.f_0, true), 15f))
		{
			return 1;
		}
		if (PED::HAS_PED_RECEIVED_EVENT(Local_320.f_0, 73))
		{
			return 1;
		}
		if (bParam0)
...
int func_431(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2CF79
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_432(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2D074
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_433(int iParam0, float fParam1)//Position - 0x2D180
{
	var uVar0;
	struct<3> Var1;
...
int func_434(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x2D215
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_435(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2D2A3
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_436(int iParam0, float fParam1)//Position - 0x2D2EB
{
	float fVar0;
	
	if (func_440(PLAYER::PLAYER_PED_ID()) && func_440(iParam0))
	{
		if (func_438(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_437(int iParam0, float fParam1)//Position - 0x2D361
{
...
void func_439(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2D3A1
{
...
int func_440(int iParam0)//Position - 0x2D3CF
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_441(bool bParam0)//Position - 0x2D3F0
{
...
void func_443()//Position - 0x2D4A7
{
	...
	func_21();
	PED::REMOVE_RELATIONSHIP_GROUP(iLocal_595);
	func_556();
	func_133(0);
}
...
void func_453(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2D88B
{
	if (func_555())
	{
...
void func_454(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2D920
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_555() || !func_553())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_520(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_178(Param1, 0f, 0f, 0f, 0))
		...
		{
			func_515(iParam12, 0);
			while (!func_455(iParam0, iParam12, Param1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_455(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2DAB4
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_114135.f_2367.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114135.f_2367.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114135.f_2367.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_506(iParam0, &(Global_114135.f_2367.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_114135.f_2367.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_114135.f_2367.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114135.f_2367.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114135.f_2367.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_506(iParam0, &(Global_114135.f_2367.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_114135.f_2367.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5.f_0, Param2, fParam5, true, true, false);
				...
				func_506(iParam0, &(Var5.f_31), &(Var5.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_456(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2E8D7
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_91(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_460(*iParam1, 0, &uVar0))
		{
			...
			if (bParam3)
			{
				...
				Global_114135.f_20122[iParam0 /*43*/].f_31 = func_459(*iParam1);
				...
				func_457(Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_114135.f_20122[iParam0 /*43*/].f_1));
				...
				func_457(Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_114135.f_20122[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_457(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x2F4EB
{
	...
	iVar0 = 0;
	while (func_458(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
float func_459(int iParam0)//Position - 0x30A52
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_460(int iParam0, bool bParam1, var uParam2)//Position - 0x30B02
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_501(iVar0, bParam1, uParam2) && !func_500(PLAYER::PLAYER_ID())) && !func_473(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_469(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if ((((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_466(iParam0)) && !bVar1) && !(func_465(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_464(PLAYER::PLAYER_ID()))) && !(func_463(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_461(PLAYER::PLAYER_ID())))
	{
...
int func_461(int iParam0)//Position - 0x30C8D
{
	if (iParam0 != func_84())
	{
		if (func_347(iParam0, 1, 1))
		{
			...
			{
				return func_462(Global_2657991[iParam0 /*467*/].f_324.f_8) == 30;
			}
		}
	}
	return 0;
...
int func_463(int iParam0)//Position - 0x311F0
{
...
int func_464(int iParam0)//Position - 0x31207
{
	if (iParam0 != func_84())
	{
		if (func_347(iParam0, 1, 1))
		{
			if (Global_2657991[iParam0 /*467*/].f_324.f_8 != -1)
			{
				return func_462(Global_2657991[iParam0 /*467*/].f_324.f_8) == 11;
			}
		}
	}
	return 0;
...
int func_465(int iParam0)//Position - 0x3124E
{
...
int func_466(int iParam0)//Position - 0x31290
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_467(int iParam0)//Position - 0x31358
{
	if (iParam0 != func_84())
	{
		if (func_347(iParam0, 1, 1))
		{
			if (Global_2657991[iParam0 /*467*/].f_324.f_8 != -1)
			{
				return func_462(Global_2657991[iParam0 /*467*/].f_324.f_8) == 26;
			}
		}
	}
	return 0;
...
int func_468(int iParam0)//Position - 0x3139F
{
	if (iParam0 != func_84())
	{
		if (func_347(iParam0, 1, 1))
		{
			if (Global_2657991[iParam0 /*467*/].f_324.f_8 != -1)
			{
				return func_462(Global_2657991[iParam0 /*467*/].f_324.f_8) == 13;
			}
		}
	}
	return 0;
...
int func_469(int iParam0)//Position - 0x313E6
{
	if (iParam0 != func_84())
	{
		if (func_347(iParam0, 1, 1))
		{
			if (Global_2657991[iParam0 /*467*/].f_324.f_8 != -1)
			{
				return func_462(Global_2657991[iParam0 /*467*/].f_324.f_8) == 7;
			}
		}
	}
	return 0;
...
int func_470(int iParam0)//Position - 0x3142C
{
	bool bVar0;
	...
	if ((((!func_472(PLAYER::PLAYER_ID()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger")) && iParam0 != func_471(1)) && !bVar0)
	{
		return 0;
	}
	return 1;
...
int func_472(int iParam0)//Position - 0x314D7
{
	if (iParam0 != func_84())
	{
...
int func_473(int iParam0)//Position - 0x314FD
{
...
int func_474(int iParam0)//Position - 0x3152C
{
	...
	if (func_477(PLAYER::PLAYER_ID()) && ((((!func_470(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("openwheel1"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("openwheel2"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("formula"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("formula2"))))
	{
		return 0;
	}
...
int func_475(int iParam0)//Position - 0x31694
{
	int iVar0;
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_466(iParam0)) || func_476(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_476(int iParam0)//Position - 0x31711
{
	switch (iParam0)
	{
		case joaat("mule"):
...
int func_477(int iParam0)//Position - 0x3176D
{
	if (iParam0 == func_84())
	{
		return 0;
	}
	if (func_500(iParam0) && Global_2657991[iParam0 /*467*/].f_324.f_11 == iParam0)
	{
		return 1;
	}
	return 0;
...
int func_478(int iParam0, bool bParam1)//Position - 0x317A6
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_480(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				...
				else if (func_479(iParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_479(int iParam0)//Position - 0x31801
{
	int iVar0;
...
int func_480(int iParam0, int iParam1)//Position - 0x3183A
{
	if (iParam1 == 0)
	{
...
int func_489(int iParam0, int iParam1)//Position - 0x31D35
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_490(int iParam0)//Position - 0x32114
{
	if (PLAYER::PLAYER_ID() != func_84())
	{
		if (func_496() || func_495(PLAYER::PLAYER_ID()))
		{
			return 0;
		}
		if (((func_494(PLAYER::PLAYER_ID(), 1, 0) && Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_268.f_36 > 0) || BitTest(Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_268.f_34, 14)) || BitTest(Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_268.f_34, 11))
		{
			return 0;
		}
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("Player_Vehicle", 3))
		{
			if (DECORATOR::DECOR_EXIST_ON(iParam0, "Player_Vehicle"))
			{
				if (DECORATOR::DECOR_GET_INT(iParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
				{
					...
					{
						if (!func_491(iParam0) || ENTITY::GET_ENTITY_MODEL(iParam0) != Global_1586535[func_492() /*143*/].f_66)
						{
							return 1;
						}
					}
...
int func_491(int iParam0)//Position - 0x3220D
{
...
int func_494(int iParam0, bool bParam1, bool bParam2)//Position - 0x3224B
{
	if (iParam0 == func_84())
	{
		return 0;
...
int func_495(int iParam0)//Position - 0x322AF
{
...
int func_498(int iParam0)//Position - 0x32306
{
	if (iParam0 != func_84())
	{
		if (func_347(iParam0, 1, 1))
		{
			...
			{
				return func_462(Global_2657991[iParam0 /*467*/].f_324.f_8) == 5;
			}
		}
	}
	return 0;
...
int func_499(int iParam0)//Position - 0x32365
{
	if (iParam0 != func_84())
	{
		if (func_347(iParam0, 1, 1))
		{
			if (Global_2657991[iParam0 /*467*/].f_324.f_8 != -1 && Global_2657991[iParam0 /*467*/].f_324.f_11 != func_84())
			{
				return func_462(Global_2657991[iParam0 /*467*/].f_324.f_8) == 8;
			}
		}
	}
	return 0;
...
int func_500(int iParam0)//Position - 0x323C5
{
	if (iParam0 != func_84())
	{
		if (func_347(iParam0, 1, 1))
		{
			if (Global_2657991[iParam0 /*467*/].f_324.f_8 != -1)
			{
				return func_462(Global_2657991[iParam0 /*467*/].f_324.f_8) == 9;
			}
		}
	}
	return 0;
...
int func_501(int iParam0, bool bParam1, var uParam2)//Position - 0x3240C
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_469(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_502(int iParam0)//Position - 0x32803
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_503(int iParam0, int iParam1)//Position - 0x32838
{
	int iVar0;
...
void func_504(int iParam0)//Position - 0x328BA
{
	if (!func_505(*iParam0))
	{
...
bool func_505(int iParam0)//Position - 0x328E5
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_506(int iParam0, var uParam1, var uParam2)//Position - 0x328F4
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*iParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_512(*iParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_511(ENTITY::GET_ENTITY_MODEL(*iParam0)) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_509(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_509(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_508(iParam0);
	if (func_507(*iParam0))
	{
...
int func_507(int iParam0)//Position - 0x32ACD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_509(int iParam0, int iParam1)//Position - 0x32C00
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		iVar0 = func_510(iParam0, 38) + 1;
		iVar1 = func_510(iParam0, 24) + 1;
...
int func_510(int iParam0, int iParam1)//Position - 0x32CE9
{
	int iVar0;
	...
	while (iVar0 >= 0 && func_512(iParam0, iParam1, iVar0))
	{
		iVar0 = (iVar0 - 1);
	}
	return iVar0;
...
int func_511(int iParam0)//Position - 0x32D4B
{
...
int func_512(int iParam0, int iParam1, int iParam2)//Position - 0x32D76
{
	if (!func_513() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_513()//Position - 0x32D9A
{
	return 0;
}

int func_514(var uParam0, int iParam1)//Position - 0x32DA3
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_515(int iParam0, int iParam1)//Position - 0x32DE4
{
	int iVar0;
...
void func_516(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x32E82
{
	int iVar0;
...
int func_518(int iParam0, int iParam1)//Position - 0x33041
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_519(&(Global_114135.f_32754.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
...
int func_520(struct<3> Param0, float fParam3)//Position - 0x330BF
{
	return func_521(&(Global_107680.f_2890), Param0, fParam3, 0);
}

int func_521(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x330D9
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (func_546(uParam0))
	{
		...
		if (func_545(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_526(iVar0, &(uParam0->f_12), 0, 1);
				bVar4 = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_503(iVar0, uParam0->f_11);
				}
				else if ((!func_523(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_522(iVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_523(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x3344E
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_525(iParam0, Global_78329.f_139[38], 0))
			{
				func_517(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_525(iParam0, Global_78329.f_139[43], 1))
			{
				func_517(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_525(iParam0, uVar1[iVar6], 1) && func_524(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.5635f, 39.9702f, 5f, 0))
				{
...
int func_524(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x33656
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_525(int iParam0, int iParam1, bool bParam2)//Position - 0x336D1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_526(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x33732
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((BitTest(uParam1->f_77, 15) || func_535(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_534())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if ((((func_528() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_471(1)))
		{
			if (!BitTest(uParam1->f_77, 23))
			{
				if (!BitTest(uParam1->f_77, 22) && func_527(iParam0, 5f))
				{
...
int func_527(int iParam0, float fParam1)//Position - 0x33E37
{
	struct<3> Var0;
	float fVar3;
...
int func_529(var uParam0)//Position - 0x33F37
{
	int iVar0;
...
int func_530(int iParam0)//Position - 0x33F5B
{
	int iVar0;
...
var func_532(var uParam0, var uParam1)//Position - 0x33F8D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_533(int iParam0, int iParam1)//Position - 0x33FB0
{
	int iVar0;
	int iVar1;
...
int func_535(int iParam0)//Position - 0x3403A
{
	int iVar0;
...
int func_536(int iParam0)//Position - 0x34082
{
	if (!func_513() && func_537(iParam0))
	{
		return 1;
	}
	return 0;
...
int func_537(int iParam0)//Position - 0x340A2
{
	switch (iParam0)
	{
		case 161:
...
int func_538(int iParam0)//Position - 0x340F5
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (!func_544(PLAYER::PLAYER_ID(), -1))
		{
...
int func_542(int iParam0, int iParam1)//Position - 0x341EB
{
	if (func_32(iParam0))
	{
...
int func_544(int iParam0, int iParam1)//Position - 0x3425B
{
	int iVar0;
...
int func_545(var uParam0)//Position - 0x342A8
{
	if (func_546(uParam0))
	{
...
int func_546(var uParam0)//Position - 0x342DD
{
	...
	if (uParam0->f_12.f_66 == joaat("stunt") && func_524(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
int func_550(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x34381
{
...
int func_552(int iParam0)//Position - 0x34484
{
	switch (iParam0)
	{
		case joaat("police"):
...
void func_556()//Position - 0x3458D
{
	...
	PED::ADD_RELATIONSHIP_GROUP("ENEMIES", &iLocal_595);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("PLAYER"), iLocal_595);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_595, joaat("PLAYER"));
	Var0 = { func_563(Local_101) };
	Var3 = { func_562(Local_101) };
	PED::SET_PED_NON_CREATION_AREA(Var0, Var3);
	iLocal_414 = PED::ADD_SCENARIO_BLOCKING_AREA(Var0, Var3, false, true, true, true, 1);
	MISC::CLEAR_AREA(Local_101, 30f, false, false, false, false);
	...
	if (func_23(PLAYER::PLAYER_PED_ID()))
	{
		func_99(&uLocal_430, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		PED::SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(PLAYER::PLAYER_PED_ID(), true);
	}
	if (func_23(Local_110.f_9))
	{
		func_99(&uLocal_430, 3, Local_110.f_9, sLocal_417, 0, 1);
...
void func_557()//Position - 0x346D3
{
	...
	if (func_23(Local_110.f_9))
	{
		...
		PED::SET_PED_AS_ENEMY(Local_110.f_9, true);
		if (Local_110.f_12 != 0)
		{
			WEAPON::GIVE_WEAPON_TO_PED(Local_110.f_9, Local_110.f_12, -1, false, true);
		}
		func_366(Local_110.f_9);
		func_558(Local_110.f_9, "TARGET_", 0);
		Local_110.f_10 = 0;
		PED::SET_PED_COMPONENT_VARIATION(Local_110.f_9, 0, 1, 1, 0);
		PED::SET_PED_COMPONENT_VARIATION(Local_110.f_9, 2, 1, 1, 0);
		PED::SET_PED_COMPONENT_VARIATION(Local_110.f_9, 3, 0, 1, 0);
		PED::SET_PED_COMPONENT_VARIATION(Local_110.f_9, 4, 0, 0, 0);
		TASK::OPEN_SEQUENCE_TASK(&iLocal_416);
	...
	while (iVar0 <= 2)
	{
		if (func_23(Local_130[iVar0 /*19*/]))
		{
			func_366(Local_130[iVar0 /*19*/]);
			if (iVar0 == 0 || iVar0 == 2)
			{
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_130[iVar0 /*19*/], iLocal_595);
			}
			func_558(Local_130[iVar0 /*19*/], "BACKUP_", iVar0);
			switch (iVar0)
			{
				case 0:
					TASK::OPEN_SEQUENCE_TASK(&iLocal_416);
					...
					TASK::SET_SEQUENCE_TO_REPEAT(iLocal_416, true);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_416);
					TASK::TASK_PERFORM_SEQUENCE(Local_130[iVar0 /*19*/], iLocal_416);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_416);
					break;
...
void func_558(int iParam0, char* sParam1, int iParam2)//Position - 0x34BCB
{
	char cVar0[16];
...
int func_559()//Position - 0x34BE7
{
	...
	if (iLocal_405 > 0)
	{
		...
		{
			if (func_55(&(Local_130[iVar2 /*19*/]), Local_130[iVar2 /*19*/].f_18, Local_130[iVar2 /*19*/].f_1, Local_130[iVar2 /*19*/].f_4, 0, 0, 0))
			{
				if (func_23(Local_130[iVar2 /*19*/]))
				{
					iVar0++;
					iVar1++;
				}
	...
	if (iVar1 == iLocal_405)
	{
		...
		while (iVar2 <= (iLocal_405 - 1))
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_130[iVar2 /*19*/].f_18);
			iVar2++;
		}
	}
	if (iLocal_402 > 0)
	{
		...
		{
			if (func_561(&(Local_189[iVar2 /*6*/]), Local_189[iVar2 /*6*/].f_5, Local_189[iVar2 /*6*/].f_1, Local_189[iVar2 /*6*/].f_4, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	if (iLocal_403 > 0)
	{
		...
		{
			if (func_58(&(Local_226[iVar2 /*6*/]), Local_226[iVar2 /*6*/].f_5, Local_226[iVar2 /*6*/].f_1, Local_226[iVar2 /*6*/].f_4, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	{
		iVar2 = 0;
		while (iVar2 <= (iLocal_401 - 1))
		{
			if (func_58(&(Local_275[iVar2 /*9*/]), Local_275[iVar2 /*9*/].f_8, Local_275[iVar2 /*9*/].f_1, Local_275[iVar2 /*9*/].f_7, 1))
			{
				ENTITY::FREEZE_ENTITY_POSITION(Local_275[iVar2 /*9*/], true);
				iVar0++;
			}
			iVar2++;
		}
	...
	if (iLocal_404 > 0)
	{
		...
		{
			if (func_560(&(Local_312[iVar2 /*7*/]), Local_312[iVar2 /*7*/].f_5, Local_312[iVar2 /*7*/].f_2, Local_312[iVar2 /*7*/].f_6, Local_312[iVar2 /*7*/].f_1, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	if (iVar0 == ((((iLocal_405 + iLocal_402) + iLocal_403) + iLocal_401) + iLocal_404) + 1)
	{
		return 1;
	}
	return 0;
...
int func_560(var uParam0, int iParam1, struct<3> Param2, int iParam5, int iParam6, bool bParam7)//Position - 0x34E1D
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_57(iParam6))
...
int func_561(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x34E8E
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_57(iParam1))
...
Vector3 func_562(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x34F2D
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_563(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x34FA1
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_564()//Position - 0x35015
{
	...
	iVar0 = 0;
	iLocal_109 = 4;
	Local_110.f_11 = joaat("A_M_O_ACult_02");
	Local_110.f_13 = { 1429.18f, 6350.05f, 23.99f };
	Local_110.f_16 = 39.2f;
	...
	Local_110.f_19 = 0;
	func_8();
	Local_130[0 /*19*/].f_18 = joaat("A_M_M_Tramp_01");
	Local_130[0 /*19*/].f_1 = { 1426.88f, 6352.04f, 23.99f };
	Local_130[0 /*19*/].f_4 = -166.25f;
	Local_130[1 /*19*/].f_18 = joaat("A_M_M_Tramp_01");
	Local_130[1 /*19*/].f_1 = { 1430.64f, 6347.71f, 23.99f };
	Local_130[1 /*19*/].f_4 = 39.58f;
	Local_130[2 /*19*/].f_18 = joaat("A_M_M_Tramp_01");
	Local_130[2 /*19*/].f_1 = { 1429.44f, 6345.15f, 23.99f };
	Local_130[2 /*19*/].f_4 = 10.05f;
	Local_130[2 /*19*/].f_16 = 0;
	iVar0 = 0;
	while (iVar0 <= (iLocal_405 - 1))
	{
		Local_130[iVar0 /*19*/].f_15 = 0;
		Local_130[iVar0 /*19*/].f_16 = 0;
		Local_130[iVar0 /*19*/].f_14 = 0;
		iVar0++;
	}
	iLocal_405 = 3;
	iLocal_402 = 0;
	Local_226[0 /*6*/].f_5 = joaat("prop_box_wood04a");
	Local_226[0 /*6*/].f_1 = { 1427.1107f, 6346.972f, 22.9878f };
	Local_226[0 /*6*/].f_4 = 257.2001f;
	Local_226[1 /*6*/].f_5 = joaat("prop_box_wood04a");
	Local_226[1 /*6*/].f_1 = { 1445.8561f, 6348.2437f, 22.6787f };
	Local_226[1 /*6*/].f_4 = 190.8004f;
	Local_226[2 /*6*/].f_5 = joaat("prop_box_wood04a");
	Local_226[2 /*6*/].f_1 = { 1433.8666f, 6344.37f, 22.9878f };
	Local_226[2 /*6*/].f_4 = 68.0003f;
	Local_226[3 /*6*/].f_5 = joaat("prop_box_wood04a");
	Local_226[3 /*6*/].f_1 = { 1439.4877f, 6353.5938f, 22.9811f };
	Local_226[3 /*6*/].f_4 = 117.2f;
	Local_226[4 /*6*/].f_5 = joaat("prop_box_wood04a");
	Local_226[4 /*6*/].f_1 = { 1441.3259f, 6340.9526f, 22.9246f };
	Local_226[4 /*6*/].f_4 = 47.9998f;
	Local_226[5 /*6*/].f_5 = joaat("prop_box_wood04a");
	Local_226[5 /*6*/].f_1 = { 1432.9397f, 6351.1963f, 22.9878f };
	Local_226[5 /*6*/].f_4 = 5.5997f;
	Local_226[6 /*6*/].f_5 = joaat("prop_box_wood04a");
	Local_226[6 /*6*/].f_1 = { 1431.6637f, 6337.6978f, 22.9945f };
	Local_226[6 /*6*/].f_4 = 129.1996f;
	iLocal_403 = 7;
	iLocal_401 = 0;
	iLocal_404 = 0;
	Local_623 = { 1477.9075f, 6372.509f, 22.5721f };
	fLocal_390 = 145.357f;
	Local_626 = { 1456.282f, 6352.942f, 22.8309f };
	fLocal_391 = 97.282f;
	Local_629 = { 1445.6962f, 6351.5645f, 22.7946f };
	fLocal_392 = 90.3412f;
	Local_632 = { 0f, 0f, 0f };
	Local_635 = { 0f, 0f, 0f };
	iLocal_99 = 4;
	...
	iLocal_410 = 0;
	iLocal_412 = -1;
	Local_620 = { 1425.318f, 6346.781f, 22.9851f };
	Local_614 = { 2722.6611f, 4143.1055f, 43.0617f };
	StringCopy(&Local_596, "", 24);
	StringCopy(&Local_608, "", 24);
	Local_320.f_6 = func_575(62);
	Local_320.f_1 = { func_574() };
	Local_320.f_4 = func_573();
	Local_328.f_5 = func_572();
	Local_328.f_1 = { func_571() };
	Local_328.f_4 = func_570();
	Local_334.f_5 = func_569();
	Local_334.f_1 = { func_568() };
	Local_334.f_4 = func_567();
	Local_340.f_5 = func_49();
	Local_340.f_1 = { func_48() };
	Local_340.f_4 = func_47();
	Local_346.f_5 = func_46();
	Local_346.f_1 = { func_566() };
	Local_346.f_4 = func_565();
	sLocal_417 = "BailBond4Jumper";
	sLocal_419 = "BB4_J3";
	sLocal_420[0] = "BB4_VC1";
	sLocal_420[1] = "BB4_VC2";
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		iLocal_357[iVar0] = 0;
...
int func_575(int iParam0)//Position - 0x35580
{
	if (!func_91(iParam0))
	{
		return func_94(iParam0);
...
int func_576(bool bParam0)//Position - 0x355A6
{
...
int func_580(int iParam0)//Position - 0x356DE
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_579()) || Global_113182) || Global_33090) || func_585()) || func_97(8, -1)) || func_584()) || func_583()) || func_577()) || func_578()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_579()) || Global_33090) || func_585()) || func_97(8, -1)) || func_577()) || func_584()) || func_583()) || func_578()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_579()) || Global_113182) || Global_33090) || func_585()) || func_97(8, -1)) || func_577()) || func_584()) || func_583()) || func_578()) || Global_114135.f_7692.f_919[iVar0] == 5) || Global_44728 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_579()) || Global_113182) || Global_33090) || func_585()) || func_97(8, -1)) || func_584()) || func_583()) || func_578()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_579() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_97(8, -1)) || func_578()) || func_582()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_579()) || Global_33090) || func_585()) || func_97(8, -1)) || func_583()) || func_577()) || func_578()) || Global_114135.f_7692.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_579()) || func_583()) || Global_113182) || Global_33090) || func_585()) || Global_45392) || func_97(8, -1)) || func_577()) || func_582()) || func_578()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_579()) || Global_113182) || Global_33090) || func_585()) || func_97(8, -1)) || func_577()) || func_582()) || func_584()) || func_583()) || func_578())
						{
							return 0;
						}
						break;
...
var func_581()//Position - 0x35DFB
{
	return Global_101727.f_1;
}

int func_582()//Position - 0x35E09
{
	if (Global_98585 != -1)
	{
...
var func_585()//Position - 0x35E4E
{
	return Global_1575084;
}

bool func_586(int iParam0)//Position - 0x35E5A
{
	return func_587(iParam0, Global_44181);
}

int func_587(int iParam0, int iParam1)//Position - 0x35E6B
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_588(int iParam0)//Position - 0x3604C
{
	...
	if (!func_612())
	{
		...
		func_589(SCRIPT::GET_THIS_SCRIPT_NAME());
	}
}
...
int func_590(char* sParam0, int iParam1, int iParam2)//Position - 0x360B4
{
	...
	if (func_601())
	{
		...
		{
			iVar33 = func_591(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
void func_592(int iParam0, var uParam1)//Position - 0x36299
{
	switch (iParam0)
	{
		...
		case 5:
			func_593(uParam1, "Barry3A", func_595(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_594(iParam0), 0, 1);
			break;
		...
		case 8:
			func_593(uParam1, "Dreyfuss1", func_595(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_594(iParam0), 0, 0);
			break;
		...
		case 38:
			func_593(uParam1, "Nigel1A", func_595(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_594(iParam0), 1, 1);
			break;
		...
		case 49:
			func_593(uParam1, "Paparazzo3A", func_595(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_594(iParam0), 0, 1);
			break;
		...
		case 58:
			func_593(uParam1, "Tonya1", func_595(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_594(iParam0), 0, 1);
			break;
...
void func_593(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, struct<3> Param7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)//Position - 0x3744E
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_597()//Position - 0x37CA8
{
	...
	iVar0 = func_598(&(Global_101688.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_599(int iParam0, bool bParam1)//Position - 0x37CF6
{
	int iVar0;
...
void func_603(bool bParam0)//Position - 0x37E01
{
