...
int func_20(int iParam0)//Position - 0xBF4
{
	...
	if (!bVar0)
	{
		...
		if (Global_2726699)
		{
			if (Global_4534105[*iParam0 /*85*/].f_66.f_6 == joaat("CATEGORY_WEAPON_AMMO") || Global_4534105[*iParam0 /*85*/].f_66.f_6 == joaat("CATEGORY_MART"))
			{
				Global_4535608 = 1;
				return 0;
			}
...
void func_36(int iParam0)//Position - 0x4017
{
	...
	{
		if (Global_4539666[iParam0 /*12*/].f_1 != joaat("NET_SHOP_ACTION_EARN") && Global_4539666[iParam0 /*12*/].f_1 != joaat("NET_SHOP_ACTION_SELL_VEHICLE"))
		{
			return;
		}
	}
...
int func_39()//Position - 0x4167
{
	...
	if (func_40() != 0)
	{
		if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(func_40()) == 0)
		{
			return 1;
		}
	}
