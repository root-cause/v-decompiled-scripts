...
void func_22()//Position - 0x6A5
{
	...
	iVar0 = 0;
	while ((!ENTITY::DOES_ENTITY_EXIST(Global_100162) || !ENTITY::DOES_ENTITY_EXIST(iLocal_70)) || (!STREAMING::HAS_MODEL_LOADED(iLocal_69) && iVar0 < 400))
	{
	...
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_100162, Global_95445);
		AUDIO::SET_AMBIENT_VOICE_NAME(Global_100162, "A_F_Y_BevHills_01_White_FULL_01");
	}
...
int func_48(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0xDE60
{
	switch (iParam1)
	{
		case 0:
...
int func_50(int iParam0, var uParam1, var uParam2)//Position - 0xFDCB
{
	switch (iParam0)
	{
		case 11:
