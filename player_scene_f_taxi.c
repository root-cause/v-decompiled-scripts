...
int func_2()//Position - 0x11B
{
	...
	if (!func_3(&uVar0))
	{
		...
		fVar2 = SYSTEM::VDIST2(Local_170 + Local_173, Var1);
		if (fVar2 < (4.5f * 4.5f))
		{
...
int func_4()//Position - 0x1B6
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98011))
		{
			...
			if (!func_5(Global_100402, iLocal_70, 2))
			{
				if (fVar1 >= 0.9f)
				{
					PED::SET_PED_INTO_VEHICLE(Global_100402, iLocal_70, 2);
				}
			}
			if (!iLocal_172)
			{
		...
		else
		{
			...
			ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_70, -8f, true);
			SYSTEM::WAIT(100);
			if (!func_3(&uVar0))
			{
				...
				TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_70, Local_170 + Local_173, fLocal_171, 0, iLocal_71, 786599, ((4.5f / 2f) - 1f), 10f);
...
int func_8(int iParam0, int iParam1)//Position - 0x36D
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_9(Global_100402) && iParam1 != 0)
		{
			Global_100402 = 0;
		}
	}
...
void func_12()//Position - 0x4B0
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_15(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_13(iVar0) && (!func_17(14) || Global_112599))
			{
...
void func_22()//Position - 0x6A5
{
	...
	iVar0 = 0;
	while ((!ENTITY::DOES_ENTITY_EXIST(Global_100402) || !ENTITY::DOES_ENTITY_EXIST(iLocal_70)) || (!STREAMING::HAS_MODEL_LOADED(iLocal_69) && iVar0 < 400))
	{
	...
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_100402, Global_95685);
		AUDIO::SET_AMBIENT_VOICE_NAME(Global_100402, "A_F_Y_BevHills_01_White_FULL_01");
	}
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_70, false))
	{
		VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_70, true, true, false);
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_70, 2);
		VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_70, 5f);
		iLocal_68 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_70, 4, iLocal_69, -1, true, true);
...
void func_23()//Position - 0x7A1
{
	...
	func_29(1, iLocal_66, &iLocal_71, &Local_169, &uVar1, &Local_170, &fLocal_171);
	Var2.f_1 = -1;
	Var2.f_17 = 4;
	Var2.f_17.f_8 = 4;
	Var2.f_17.f_13 = 4;
...
int func_31(int iParam0, var uParam1, int iParam2)//Position - 0x7A5F
{
	...
	if (!func_32(Global_100085[iParam0 /*98*/], 0, -1))
	{
		func_30(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
...
bool func_36()//Position - 0xB52D
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_37()//Position - 0xB543
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_38()//Position - 0xB559
{
	return 0;
}

int func_39()//Position - 0xB562
{
	return 1;
}

int func_40()//Position - 0xB56B
{
	return 1;
}

int func_41()//Position - 0xB574
{
...
int func_43(int iParam0)//Position - 0xB645
{
...
int func_44(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0xB8C5
{
	int iVar0;
...
bool func_45(var uParam0)//Position - 0xBAC0
{
	int iVar0;
	struct<3> Var1;
	float fVar2;
...
bool func_46(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0xBB78
{
	if (bParam2)
	{
...
int func_47(int iParam0, var uParam1, char* sParam2)//Position - 0xBBBF
{
	struct<3> Var0;
	int iVar1;
	var uVar2;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[0];
			StringCopy(sParam2, func_51(Global_113648.f_2365.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[1];
			StringCopy(sParam2, func_51(Global_113648.f_2365.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[2];
			StringCopy(sParam2, func_51(Global_113648.f_2365.f_539.f_2314[2]), 32);
			return 1;
			break;
...
int func_48(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0xE1C3
{
	switch (iParam1)
	{
		case 0:
...
int func_50(int iParam0, var uParam1, var uParam2)//Position - 0x10130
{
	switch (iParam0)
	{
		case 11:
...
char* func_51(int iParam0)//Position - 0x10A9F
{
	switch (iParam0)
	{
...
void func_52()//Position - 0x10B32
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_68, false) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_68, true))
	{
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_68);
	}
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_70, false) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_70, true))
	{
