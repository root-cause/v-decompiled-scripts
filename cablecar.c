...
void func_254(var uParam0)//Position - 0x2350B
{
	...
	{
		case 0:
			func_260(&uLocal_202, 461.3928f, 5634.593f, 803.8433f, -21.1986f, 0.0407f, 152.8518f, 0, 0);
		...
		case 5:
			...
			if (uParam0->f_20 > 288f)
			{
				...
				func_259(&uLocal_202, 248.8245f, 5575.748f, 619.0521f, -54.605f, 0f, 89.7301f, 11000);
				func_258(&uLocal_202, 45f, 0);
				func_255(&Var1, 16);
				iLocal_226++;
				iVar0 = 1;
		...
		case 6:
			func_257(-69.826f, 5595.765f, 390.4564f, 25.1669f, 0f, -110.119f, 1128792064);
			if (uParam0->f_20 > 400f)
			{
				func_260(&uLocal_202, -69.826f, 5595.765f, 390.4564f, 25.1669f, 0f, -110.119f, 0, 0);
		...
		case 9:
		case 10:
			func_257(-6.2591f, 5609.318f, 402.8656f, -0.9222f, 0f, 153.9538f, 1128792064);
			if (uParam0->f_20 > 575f)
			{
				func_260(&uLocal_202, -6.2591f, 5609.318f, 402.8656f, -0.9222f, 0f, 153.9538f, 0, 0);
				func_259(&uLocal_202, -5.9107f, 5609.613f, 401.1573f, -11.4635f, 0f, 130.2651f, 10000);
		...
		case 12:
			func_257(-61.8849f, 5558.974f, 338.9037f, -15.2417f, 0f, 104.1686f, 1128792064);
			if (uParam0->f_20 > 740f)
			{
				func_260(&uLocal_202, -61.8849f, 5558.974f, 338.9037f, -15.2417f, 0f, 104.1686f, 0, 0);
				func_259(&uLocal_202, -58.0053f, 5559.955f, 323.449f, -10.6159f, 0f, 104.1686f, 10000);
		...
		case 13:
			func_257(-291.6088f, 5570.382f, 227.2185f, 26.4681f, 0f, -73.2798f, 1128792064);
			if (uParam0->f_20 > 840f)
			{
				func_260(&uLocal_202, -291.6088f, 5570.382f, 227.2185f, 26.4681f, 0f, -73.2798f, 0, 0);
		...
		case 14:
			func_257(-509.6508f, 5683.843f, 89.9184f, 21.3193f, 0f, -128.1549f, 1128792064);
			if (uParam0->f_20 > 920f)
			{
				func_260(&uLocal_202, -509.6508f, 5683.843f, 89.9184f, 21.3193f, 0f, -128.1549f, 0, 0);
		...
		case 16:
			func_257(-475.9374f, 5375.989f, 94.2374f, 6.8777f, 0f, 6.4845f, 1128792064);
			if (uParam0->f_20 > 1090f)
			{
				func_260(&uLocal_202, -475.9374f, 5375.989f, 94.2374f, 6.8777f, 0f, 6.4845f, 0, 0);
				func_259(&uLocal_202, -475.9374f, 5375.989f, 94.2374f, -2.0745f, 0f, 21.1399f, 16000);
		...
		case 22:
			func_257(-743.0775f, 5570.776f, 47.8665f, -3.7547f, 0.251f, -46.5015f, 1128792064);
			if (uParam0->f_20 > 1355f)
			{
				func_260(&uLocal_202, -743.0775f, 5570.776f, 47.8665f, -3.7547f, 0.251f, -46.5015f, 0, 0);
...
void func_262(var uParam0)//Position - 0x23F08
{
	...
	{
		case 0:
			func_260(&uLocal_202, -733.0331f, 5557.05f, 54.315f, -13.2766f, 0f, 26.2995f, 0, 0);
			func_259(&uLocal_202, -733.0331f, 5557.05f, 54.305f, 3.6561f, 0f, -49.3377f, 20000);
		...
		case 2:
			func_257(-539.4792f, 5522.976f, 65.4f, 4.1853f, 0f, 23.2142f, 1128792064);
			if (uParam0->f_20 > 136f)
			{
				func_260(&uLocal_202, -539.4792f, 5522.976f, 65.4f, 4.1853f, 0f, 23.2142f, 0, 0);
				func_259(&uLocal_202, -536.2819f, 5524.217f, 65.4f, 9.7636f, 0f, 14.8368f, 10000);
				func_258(&uLocal_202, 55f, 0);
				iLocal_226++;
				iVar0 = 1;
			}
		...
		case 6:
			func_257(-237.0857f, 5571.89f, 262.2075f, -38.2954f, 0.0082f, 79.4291f, 1128792064);
			if (uParam0->f_20 > 440.5f)
			{
				func_260(&uLocal_202, -237.0857f, 5571.89f, 262.2075f, -38.2954f, 0.0082f, 79.4291f, 0, 0);
				func_259(&uLocal_202, -234.3823f, 5571.384f, 258.7245f, -23.0862f, 0.0082f, 79.4291f, 13500);
		...
		case 7:
			func_257(-318.7657f, 5556.838f, 239.9462f, 18.044f, 0.0339f, -85.4425f, 1128792064);
			if (uParam0->f_20 > 545.5f)
			{
				func_260(&uLocal_202, -318.7657f, 5556.838f, 239.9462f, 18.044f, 0.0339f, -85.4425f, 0, 0);
				func_259(&uLocal_202, -311.451f, 5557.42f, 242.3366f, 20.0948f, 0.0339f, -85.4425f, 20000);
				func_258(&uLocal_202, 50f, 0);
				iLocal_226++;
				iVar0 = 1;
			}
		...
		case 12:
			...
			if (uParam0->f_20 > 1185.504f)
			{
				...
				func_259(&uLocal_202, 268.5094f, 5563.507f, 628.7556f, 33.0263f, 0f, -82.3579f, 12000);
				func_258(&uLocal_202, 50f, 0);
				iLocal_226++;
				iVar0 = 1;
			}
		...
		case 13:
			func_257(358.3939f, 5507.892f, 702.6762f, 12.1268f, -0.0966f, -6.9744f, 1128792064);
			if (uParam0->f_20 > 1285f)
			{
				func_260(&uLocal_202, 358.3939f, 5507.892f, 702.6762f, 12.1268f, -0.0966f, -6.9744f, 0, 0);
				func_259(&uLocal_202, 351.1451f, 5510.497f, 702.6633f, 28.5814f, -0.0966f, -30.1375f, 12000);
				func_258(&uLocal_202, 45f, 0);
				iLocal_226++;
				iVar0 = 1;
			}
