...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (!func_303(PLAYER::PLAYER_PED_ID()) || Global_33091 == 1)
		{
			func_308(1, 1, 1, 1);
			Global_33093 = 0;
...
void func_42(var uParam0, bool bParam1)//Position - 0x220B
{
	...
	if (uParam0->f_11 == 1 || uParam0->f_34 == 1)
	{
		...
		MISC::CLEAR_BIT(&Global_79788, 4);
		MISC::CLEAR_BIT(&Global_79788, 5);
		if (uParam0->f_24 == 0)
		{
...
void func_98()//Position - 0x408C
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_94(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_91(iVar0) && (!func_45(14) || Global_113083))
			{
...
int func_117(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x49C5
{
	...
	if (iParam5 == 0)
	{
		Global_79322[1 /*14*/] = { func_165(iVar10, iParam1, iParam2, -1) };
		if (!func_164(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_79322[1 /*14*/] = { func_165(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_79322[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_79322[1 /*14*/] = { func_165(iVar10, 14, uVar28[iVar1], -1) };
							func_137(iParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
							func_160(14);
							if (Global_79320 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_127(iVar0), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_127(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_127(iVar0), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
						}
						func_160(iVar0);
						if (Global_79320 == 1)
						{
			...
			{
				Global_79322[1 /*14*/] = { func_165(iVar10, iVar0, func_126(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_79322[1 /*14*/] = { func_165(iVar10, 14, uVar69[iVar1], -1) };
			func_137(iParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
			func_160(14);
			if (Global_79320 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_127(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_127(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_127(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
		}
		if (Global_79320 == 1)
		{
			iVar2 = 0;
...
int func_118(int iParam0, int iParam1, int iParam2)//Position - 0x51D6
{
	...
	{
		if (!func_229(iParam0, Global_114135.f_2367.f_539[iVar0 /*65*/].f_64, Global_114135.f_2367.f_539[iVar0 /*65*/].f_63))
		{
...
int func_125(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5ADF
{
	...
	{
		if (!func_229(iParam0, Global_114135.f_2367.f_539[iVar0 /*65*/].f_61, Global_114135.f_2367.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_153(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[0], Global_114135.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_153(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[1], Global_114135.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_153(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[2], Global_114135.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
int func_163(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE650
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_164(int iParam0)//Position - 0xF4F3
{
	if (!BitTest(Global_79322[1 /*14*/].f_6, 0))
	{
		return 0;
...
void func_167(int iParam0)//Position - 0xF67D
{
	...
	func_168(&(Global_79322[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_168(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x108F5
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_68(func_171(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_68(func_170(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_68(iVar1, Global_79319);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_172(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x11892
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_174(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x119A4
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_168(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_168(&(Global_79322[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_168(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79520)
		{
			...
			func_168(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_229(int iParam0, int iParam1, int iParam2)//Position - 0x22E42
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_79322[1 /*14*/] = { func_165(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_79322[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_229(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_229(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_79322[2 /*14*/] = { func_165(iVar0, 14, iVar4, -1) };
									if (Global_79322[2 /*14*/].f_12 == iVar3)
									{
										if (func_229(iParam0, 14, iVar4))
										{
											if (!func_123(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_79322[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_79322[2 /*14*/] = { func_165(iVar0, iVar2, iVar1, -1) };
						if (!func_123(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_79322[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_79322[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_127(iParam1)) && Global_79322[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_127(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_231(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x230DA
{
	if (bParam0)
	{
...
int func_235(int iParam0)//Position - 0x232DD
{
...
int func_237(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x2332A
{
	int iVar0;
...
bool func_239(int iParam0, var uParam1, float fParam2, bool bParam3)//Position - 0x23380
{
	struct<8> Var0;
	struct<8> Var8;
...
struct<8> func_240(struct<8> Param0, float fParam8)//Position - 0x23432
{
	struct<8> Var0;
	struct<3> Var8;
...
Vector3 func_241(struct<3> Param0)//Position - 0x23494
{
	float fVar0;
	float fVar1;
...
void func_243(struct<3> Param0, struct<3> Param3, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x234F9
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
Vector3 func_244(struct<3> Param0, struct<3> Param3)//Position - 0x23709
{
	return ((Param0.f_1 * Param3.f_2) - (Param0.f_2 * Param3.f_1)), ((Param0.f_2 * Param3.f_0) - (Param0.f_0 * Param3.f_2)), ((Param0.f_0 * Param3.f_1) - (Param0.f_1 * Param3.f_0));
}

void func_245(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x23742
{
	*(uParam0[0 /*3*/]) = { Param1 };
	*(uParam0[1 /*3*/]) = { Param4 };
	uParam0->f_7 = fParam7;
...
Vector3 func_258(struct<3> Param0)//Position - 0x2446E
{
	return (-SYSTEM::SIN(Param0.f_2) * SYSTEM::COS(Param0.f_0)), (SYSTEM::COS(Param0.f_2) * SYSTEM::COS(Param0.f_0)), SYSTEM::SIN(Param0.f_0);
}

void func_259(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2449B
{
...
void func_260(var uParam0, float fParam1, float fParam2)//Position - 0x24511
{
...
void func_261(var uParam0, struct<3> Param1, struct<3> Param4, int iParam7)//Position - 0x2453E
{
...
void func_262(var uParam0, struct<3> Param1, struct<3> Param4, int iParam7, int iParam8)//Position - 0x2456A
{
	func_263(uParam0);
...
void func_269(int iParam0, var uParam1, int iParam2)//Position - 0x252B6
{
	struct<3> Var0;
...
bool func_270(int iParam0)//Position - 0x2535B
{
	int iVar0;
...
int func_273(var uParam0)//Position - 0x25400
{
	...
	switch (uParam0->f_1)
	{
		...
		case 4:
			...
			if (func_252(uParam0) == 0)
			{
				MISC::SET_BIT(&Global_79788, 4);
			}
			else
			{
				MISC::SET_BIT(&Global_79788, 5);
			}
			HUD::CLEAR_HELP(true);
			return 1;
	}
...
var func_276(int iParam0)//Position - 0x256BF
{
...
int func_279(var uParam0)//Position - 0x256F8
{
	int iVar0;
	int iVar1;
	var uVar2[10];
...
bool func_281(int iParam0, var uParam1, float fParam2, bool bParam3)//Position - 0x257BA
{
	struct<8> Var0;
	struct<8> Var8;
...
void func_282(var uParam0, bool bParam1, bool bParam2)//Position - 0x25878
{
...
void func_283(var uParam0, bool bParam1)//Position - 0x25912
{
	if (CAM::DOES_CAM_EXIST(*uParam0))
	{
...
int func_285(struct<3> Param0)//Position - 0x25964
{
...
void func_289(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x259CA
{
	float fVar0;
...
float func_290(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, int iParam6)//Position - 0x25BCF
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_298(var uParam0, bool bParam1)//Position - 0x26020
{
...
bool func_303(int iParam0)//Position - 0x26507
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
float func_307(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x266F3
{
	struct<3> Var0;
...
void func_308(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2672D
{
	int iVar0;
...
int func_309(int iParam0)//Position - 0x267D7
{
	if (func_16(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
