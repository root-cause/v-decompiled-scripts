...
int func_70()//Position - 0x1802
{
	if (Global_1845058 != func_60())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_corridor_seats", Global_1845058, true, 0))
		{
			return 0;
		}
...
void func_71()//Position - 0x184E
{
	...
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_72(5, &uLocal_118, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_72(6, &uLocal_118, &iVar0);
}

void func_72(int iParam0, var uParam1, int iParam2)//Position - 0x1885
{
	struct<3> Var0;
	float fVar3;
	int iVar4;
...
Vector3 func_75(struct<3> Param0, float fParam3)//Position - 0x19D0
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_80(int iParam0, int iParam1, bool bParam2)//Position - 0x1C2D
{
	int iVar0;
