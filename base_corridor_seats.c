...
void func_11(var uParam0)//Position - 0x219
{
	...
	switch (uParam0->f_57.f_4)
	{
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar7 = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_57.f_1);
		...
		case 8:
			iVar8 = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_57.f_1);
...
int func_70()//Position - 0x17F9
{
	if (Global_1853191 != func_60())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_corridor_seats", Global_1853191, true, 0))
		{
			return 0;
		}
...
void func_71()//Position - 0x1845
{
	...
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_72(5, &uLocal_93, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_72(6, &uLocal_93, &iVar0);
}

void func_72(int iParam0, var uParam1, int iParam2)//Position - 0x187C
{
	struct<3> Var0;
	float fVar1;
	int iVar2;
...
Vector3 func_73(int iParam0)//Position - 0x1937
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_74(int iParam0)//Position - 0x1985
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_75(struct<3> Param0, float fParam1)//Position - 0x19C7
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0)//Position - 0x1A0B
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_77()//Position - 0x1A57
{
	return func_78() + Vector(0f, -8.946f, 47.215f);
}

Vector3 func_78()//Position - 0x1A6F
{
...
int func_80(int iParam0, int iParam1, bool bParam2)//Position - 0x1C24
{
	int iVar0;
