				...
				while (bVar1 <= 19)
				{
					if (!bVar0)
					{
						...
						if (func_12(bVar1))
						{
							...
							if (iVar12 != -1)
							{
								if (Global_2657418.f_87[iVar12] == 0)
								{
									if (!BitTest(*iParam1, bVar1))
									{
...
void func_21()//Position - 0xED0
{
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		if (BitTest(Global_1853910[iLocal_139 /*862*/].f_143, 0))
		{
			if (func_307(iVar1, 0, 1))
			{
				if (iVar2 > -1)
		...
		{
			if (BitTest(Global_1853910[iLocal_139 /*862*/].f_143, 12))
			{
				if (Local_65.f_5.f_5[iLocal_139] != -1)
				{
					Local_65.f_5.f_5[iLocal_139] = -1;
...
bool func_94(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x42B5
{
	if (bParam2)
	{
		...
		case 1:
			...
			else if (func_167())
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
				{
					...
					if ((!func_20(&uLocal_332) || func_19(&uLocal_332, 20000, 0)) || BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_143, 16))
					{
						if (BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_143, 16))
						{
							MISC::CLEAR_BIT(&(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_143), 16);
...
int func_202(struct<6> Param0, struct<6> Param1)//Position - 0x755F
{
	struct<4> Var0;
	struct<4> Var1;
	int iVar2;
...
void func_219(int iParam0)//Position - 0x7C8C
{
	...
	func_220(&(Global_1666668[iVar2 /*5*/]));
...
int func_232(struct<6> Param0, struct<6> Param1)//Position - 0x865E
{
	struct<4> Var0;
	struct<4> Var1;
	int iVar2;
...
void func_320(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x9F9D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_306();
