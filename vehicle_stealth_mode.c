...
{
	return (!BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_837, 4) && !func_30());
}
...
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_837, 3);
}
...
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_837, 2);
}
...
int func_60(int iParam0)//Position - 0x1050
{
...
int func_61(int iParam0, bool bParam1, bool bParam2)//Position - 0x1081
{
	int iVar0;
...
int func_62()//Position - 0x10E1
{
	return -1;
}

int func_63(int iParam0)//Position - 0x10EA
{
...
int func_64(int iParam0, bool bParam1, bool bParam2)//Position - 0x1123
{
	if (iParam0 == func_62())
	{
		return 0;
...
int func_65(int iParam0)//Position - 0x1187
{
	switch (iParam0)
	{
		case joaat("akula"):
...
void func_68(int* iParam0)//Position - 0x131C
{
...
bool func_70(int* iParam0)//Position - 0x1370
{
	bool bVar0;
...
var func_75()//Position - 0x142E
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_837, 1);
}
...
int func_77(int iParam0, bool bParam1)//Position - 0x1453
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_85(int iParam0)//Position - 0x1601
{
...
int func_88(int* iParam0)//Position - 0x1633
{
	func_67(iParam0);
	if (func_66(iParam0))
	{
