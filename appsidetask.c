...
void __EntryFunction__()//Position - 0x0
{
	...
	func_16(Global_20911, "SET_HEADER", "CELL_4" /* GXT: Sidetasks */, 0, 0, 0, 0);
	while (true)
	{
		SYSTEM::WAIT(0);
...
void func_6()//Position - 0x277
{
	...
	{
		func_7(fLocal_27, fLocal_28, "CELL_506" /* GXT: ~1~:0~1~ */, Global_23574[iLocal_23 /*9*/].f_2.f_2, Global_23574[iLocal_23 /*9*/].f_2.f_1);
	}
	else
	{
		func_7(fLocal_27, fLocal_28, "CELL_503" /* GXT: ~1~:~1~ */, Global_23574[iLocal_23 /*9*/].f_2.f_2, Global_23574[iLocal_23 /*9*/].f_2.f_1);
	}
	fLocal_27 = (fLocal_27 + 0.07f);
	func_10(255, 255, 255, 205);
	func_7(fLocal_27, fLocal_28, "CELL_505" /* GXT: ~1~/~1~ */, Global_23574[iLocal_23 /*9*/].f_2.f_3, Global_23574[iLocal_23 /*9*/].f_2.f_4);
	fLocal_27 = fLocal_25;
	func_10(255, 255, 255, 205);
	...
	iVar0 = 1;
	while (iVar0 <= Global_23405[Global_23574[iLocal_23 /*9*/].f_1 /*42*/].f_9)
	{
		func_10(255, 255, 255, 255);
		fLocal_28 = (fLocal_28 + 0.04f);
		if (Global_23405[Global_23574[iLocal_23 /*9*/].f_1 /*42*/].f_32[iVar0] == -1)
		{
			func_8(fLocal_27, fLocal_28, &(Global_23405[Global_23574[iLocal_23 /*9*/].f_1 /*42*/].f_10[iVar0 /*4*/]), 0);
		}
		else
		{
			func_7(fLocal_27, fLocal_28, &(Global_23405[Global_23574[iLocal_23 /*9*/].f_1 /*42*/].f_10[iVar0 /*4*/]), Global_23405[Global_23574[iLocal_23 /*9*/].f_1 /*42*/].f_27[iVar0], Global_23405[Global_23574[iLocal_23 /*9*/].f_1 /*42*/].f_32[iVar0]);
		}
		iVar0++;
	}
}
...
void func_11()//Position - 0x4FC
{
	if (func_2(2, Global_20899, 0))
	{
		...
		Global_23352 = 1;
		func_12(Global_20911, "SET_DATA_SLOT", 15f, 0f, -1f, -1f, -1f, "CELL_287" /* GXT: Send Photo(s) */, "CELL_280" /* GXT: Take Photo */, "CELL_285" /* GXT: Move */, "CELL_284" /* GXT: Zoom */, 0);
...
void func_15()//Position - 0x6DC
{
	...
	while (iVar0 < iLocal_24)
	{
		...
		func_8(fLocal_27, fLocal_28, &(Global_2169[Global_23574[iLocal_16[iVar0] /*9*/] /*29*/].f_3), 0);
		fLocal_27 = (fLocal_27 + 0.07f);
		func_10(255, 255, 255, 205);
		if (Global_23574[iLocal_16[iVar0] /*9*/].f_2.f_1 < 10)
		{
			func_7(fLocal_27, fLocal_28, "CELL_506" /* GXT: ~1~:0~1~ */, Global_23574[iLocal_16[iVar0] /*9*/].f_2.f_2, Global_23574[iLocal_16[iVar0] /*9*/].f_2.f_1);
		}
		else
		{
			func_7(fLocal_27, fLocal_28, "CELL_503" /* GXT: ~1~:~1~ */, Global_23574[iLocal_16[iVar0] /*9*/].f_2.f_2, Global_23574[iLocal_16[iVar0] /*9*/].f_2.f_1);
		}
		fLocal_27 = (fLocal_27 + 0.07f);
		func_10(255, 255, 255, 205);
		func_7(fLocal_27, fLocal_28, "CELL_505" /* GXT: ~1~/~1~ */, Global_23574[iLocal_16[iVar0] /*9*/].f_2.f_3, Global_23574[iLocal_16[iVar0] /*9*/].f_2.f_4);
		fLocal_27 = fLocal_25;
		func_10(255, 255, 255, 205);
		if (iVar0 == iLocal_22)
		{
		...
		fLocal_28 = (fLocal_28 + 0.02f);
		HUD::SET_TEXT_WRAP(0f, 0.93f);
		func_8(fLocal_27, fLocal_28, &(Global_23405[Global_23574[iLocal_16[iVar0] /*9*/].f_1 /*42*/]), 0);
...
void func_18()//Position - 0x8FD
{
	...
	while (iVar5 < 4)
	{
		iVar6 = 0;
		iVar7 = 3;
		Global_23574[iVar7 /*9*/].f_2 = -1;
		Global_23574[iVar7 /*9*/].f_2.f_1 = 0;
		Global_23574[iVar7 /*9*/].f_2.f_2 = 0;
		Global_23574[iVar7 /*9*/].f_2.f_3 = 0;
		Global_23574[iVar7 /*9*/].f_2.f_5 = 0;
		while (iVar6 < 4)
		{
			if (iVar0[iVar6] == 0)
			{
				if (Global_23574[iVar6 /*9*/].f_8 != 0)
				{
					if (func_19(Global_23574[iVar6 /*9*/].f_2, Global_23574[iVar7 /*9*/].f_2))
					{
						iVar7 = iVar6;
					}
				}
		...
		iVar0[iVar7] = 1;
		if (Global_23574[iVar5 /*9*/].f_8 != 0)
		{
			iLocal_21++;
		}
		iVar5++;
	}
	func_12(Global_20911, "SET_DATA_SLOT", 14f, 0f, 25f, -1f, -1f, "CELL_287" /* GXT: Send Photo(s) */, "CELL_280" /* GXT: Take Photo */, 0, 0, 0);
}
