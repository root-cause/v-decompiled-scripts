...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	Local_80 = { -1593.813f, 5221.2354f, 1.94482f };
	Local_83 = { -1603.9861f, 5243.6235f, 4.940323f };
	uLocal_86 = func_507(16);
	sLocal_87 = "rcmabigail";
	iLocal_161 = joaat("asea");
	Local_163 = { -1573.7334f, 5164.508f, 18.5576f };
	fLocal_166 = 175.9451f;
	Local_347 = { -1014.0543f, -2474.0132f, 19.1091f };
	...
	if (func_470())
	{
		...
		{
			case 0:
				func_468(-1595.201f, 5217.4946f, 3.0009f, 208.2675f, 1, 0);
				func_385(1);
				break;
			}
	}
	while (true)
	{
		...
		func_369(Local_100.f_9, 0, 0, 0, 0, 0);
...
void func_9()//Position - 0x47B
{
	switch (iLocal_168)
	{
		...
		case 1:
			...
			else if (func_235(PLAYER::PLAYER_PED_ID(), iLocal_169) > 250f)
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) == 0)
				{
					iLocal_168 = 2;
			...
			{
				if (!func_233(iLocal_169, joaat("SCRIPT_TASK_SMART_FLEE_PED")))
				{
					TASK::TASK_SMART_FLEE_PED(iLocal_169, PLAYER::PLAYER_PED_ID(), 250f, -1, false, false);
				}
				if (iLocal_338 == 0)
				{
					if (((!func_232() && func_231(iLocal_169, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_169)) && func_214(&uLocal_173, "SONARAU", "SONAR_SHOOTS", 7, 0, 0, 0))
					{
						iLocal_338 = 1;
					}
				}
				else if (((((iLocal_346 < 15 && !func_232()) && (MISC::GET_GAME_TIMER() - iLocal_343) > 10000) && func_231(iLocal_169, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_169)) && func_214(&uLocal_173, "SONARAU", "SONAR_CHASE", 7, 0, 0, 0))
				{
...
int func_42(int iParam0)//Position - 0x1AC7
{
	switch (iParam0)
	{
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1B02
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_44(int iParam0, int iParam1, int iParam2)//Position - 0x2313
{
	int iVar0;
	int iVar1;
...
int func_45(int iParam0, int iParam1, int iParam2)//Position - 0x239D
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_46(int iParam0, int iParam1, int iParam2)//Position - 0x247B
{
	Global_78341[1 /*14*/] = { func_92(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78341[1 /*14*/].f_6, 2);
}

int func_47(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x24A3
{
	var uVar0;
	int iVar10;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x2AA7
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x2B40
{
	int iVar0;
	int iVar1;
...
int func_50(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2BE1
{
	int iVar0;
...
int func_51(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2EE8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x3A9B
{
	int iVar0;
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3D7F
{
	int iVar0;
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4048
{
	int iVar0;
	int iVar1;
...
int func_55(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x407F
{
	int iVar0;
...
int func_56(int iParam0, int iParam1, int iParam2)//Position - 0x40A8
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4372
{
	int iVar0;
...
int func_58(int iParam0, int iParam1, int iParam2)//Position - 0x45FC
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_59(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4753
{
	int iVar0;
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x47ED
{
	switch (iParam0)
	{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x48BB
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_62(int iParam0, int iParam1)//Position - 0x49D5
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_63(int iParam0)//Position - 0x4D7C
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_64(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4DDD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, int iParam1)//Position - 0x4ED9
{
	int iVar0;
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5017
{
	struct<2> Var0;
	int iVar15;
	int iVar16;
...
int func_67(int iParam0)//Position - 0x50D2
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_68(int iParam0)//Position - 0x5131
{
	switch (iParam0)
	{
		case 0:
...
int func_69(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x51B7
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5434
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5859
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_72(int iParam0, int iParam1)//Position - 0x5B4C
{
	int iVar0;
	int iVar1;
...
int func_73(int iParam0, int iParam1)//Position - 0x5B93
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5BF3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_75(int iParam0)//Position - 0x5C4A
{
...
void func_76(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x5CF6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_77(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x5D40
{
	int iVar0;
...
int func_78(var uParam0)//Position - 0x5D70
{
	int iVar0;
	int iVar1;
...
int func_79(int iParam0, int iParam1, int iParam2)//Position - 0x5DA4
{
	int iVar0;
	var uVar1;
...
bool func_80(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x5DE1
{
	int iVar0;
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x85F1
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_82(int iParam0)//Position - 0x9494
{
	if (!BitTest(Global_78341[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x94DC
{
	int iVar0;
...
int func_84(int iParam0)//Position - 0x9587
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_85(int iParam0, int iParam1)//Position - 0x9637
{
	int iVar0;
	struct<10> Var1;
...
void func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9F66
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_87(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xA090
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_88(int iParam0, int iParam1)//Position - 0xA0D8
{
	int iVar0;
	struct<17> Var1;
...
void func_89(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBF20
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
int func_90(int iParam0)//Position - 0xC10C
{
	switch (iParam0)
	{
		case 0:
...
void func_91(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xC1BC
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_92(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC22D
{
	func_156();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_93(int iParam0, int iParam1)//Position - 0xC27F
{
	switch (iParam0)
	{
		case 0:
...
void func_94(int iParam0)//Position - 0xC36F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_95(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD5A3
{
	var uVar0;
	int iVar1;
...
bool func_96(int iParam0, int iParam1, var uParam2)//Position - 0xD947
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_97(int iParam0, int iParam1)//Position - 0xDD4C
{
	switch (iParam1)
	{
		case 0:
...
int func_98(int iParam0, int iParam1)//Position - 0xE147
{
	switch (iParam1)
	{
		case 0:
...
int func_99(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE542
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_100(int iParam0)//Position - 0xE581
{
	return Global_43257 == iParam0;
}

int func_101(int iParam0)//Position - 0xE58F
{
	switch (iParam0)
	{
		case -1:
...
void func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE663
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_103(int iParam0)//Position - 0xE8E9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_104(int iParam0)//Position - 0xEA36
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0xEF43
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(int iParam0)//Position - 0xEFB7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0)//Position - 0xF02A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0xF111
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0)//Position - 0xF453
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0)//Position - 0xF65B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0xF87B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0xF984
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0x10317
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x10E6F
{
	if (iParam0 < 136)
	{
		func_116(iParam0);
...
void func_115(int iParam0)//Position - 0x10EA4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x11AA8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0x129A8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x12AD5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0, int iParam1)//Position - 0x12BCC
{
	switch (iParam0)
	{
		case 0:
...
void func_120(int iParam0)//Position - 0x12CBC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0x1418A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0x142D1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0x147DB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0x14E44
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0x14EB7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x14F87
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0x15482
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x15613
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0x15E02
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x15F0B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x16E2E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x17ADB
{
	if (iParam0 < 107)
	{
		func_135(iParam0);
...
void func_133(int iParam0)//Position - 0x17B21
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x185C7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x193B5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x19FF4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x1A26C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0, int iParam1)//Position - 0x1A3A8
{
	switch (iParam0)
	{
		case 0:
...
void func_139(int iParam0)//Position - 0x1A498
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x1B1F6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x1B365
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x1B8D6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x1BDFE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x1BE71
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x1BF41
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
int func_214(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x26ED7
{
...
int func_215(char* sParam0, int iParam1, bool bParam2)//Position - 0x26F25
{
	Global_21726 = 0;
...
void func_216()//Position - 0x271F3
{
	if (!func_217())
	{
		return;
...
bool func_218(int iParam0)//Position - 0x2728D
{
	return func_219(iParam0, 20);
}

var func_219(int iParam0, int iParam1)//Position - 0x2729D
{
	return BitTest(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

int func_220()//Position - 0x272B5
{
	return -1;
}

void func_221()//Position - 0x272BE
{
	int iVar0;
...
void func_222()//Position - 0x272EF
{
...
void func_225()//Position - 0x27444
{
	if (func_100(14))
	{
...
int func_226()//Position - 0x274E6
{
	func_164();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_227()//Position - 0x274FF
{
	int iVar0;
...
bool func_228(int iParam0, int iParam1)//Position - 0x27556
{
	switch (iParam0)
	{
		case 5:
...
void func_229()//Position - 0x2758E
{
...
void func_230(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x275E5
{
...
int func_233(int iParam0, int iParam1)//Position - 0x2767F
{
	if (func_234(iParam0))
	{
...
int func_234(int iParam0)//Position - 0x276B2
{
	if (func_472(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
float func_235(int iParam0, int iParam1)//Position - 0x276D2
{
	return func_236(iParam0, iParam1, 1);
}

float func_236(int iParam0, int iParam1, bool bParam2)//Position - 0x276E3
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_237(int iParam0)//Position - 0x27741
{
	iLocal_167 = iParam0;
	iLocal_168 = 0;
}

void func_238()//Position - 0x27750
{
	if (func_472(iLocal_169))
	{
		if ((MISC::GET_GAME_TIMER() - iLocal_352) > 1000)
		{
			...
			func_239(&uLocal_88, iLocal_169, "ABGAIL2_HINT", 0, 1, 1, 1);
		}
	}
	else
	{
...
void func_239(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x27792
{
	func_240(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_240(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x277AF
{
	...
	uParam0->f_6 = 2;
	func_241(uParam0, iParam1, Param2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_241(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x277E7
{
	int iVar0;
	int iVar1;
	...
	if (func_266(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_257(uParam0, iParam1, Param2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
		...
		else
		{
			...
			if (!func_261(uParam0, bParam7, bParam9, 0))
			{
				if ((!*uParam0 && !uParam0->f_1) && !func_243(uParam0))
				{
					func_242(uParam0);
				}
			}
...
void func_242(var uParam0)//Position - 0x27B50
{
...
int func_243(var uParam0)//Position - 0x27BB4
{
	int iVar0;
...
int func_244(bool bParam0)//Position - 0x27BDF
{
	switch (Global_43257)
	{
		case 0:
...
void func_245(char* sParam0, int iParam1)//Position - 0x27C89
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_246(char* sParam0)//Position - 0x27CA0
{
	if (!func_247(1, 1, 0))
	{
...
int func_247(bool bParam0, bool bParam1, bool bParam2)//Position - 0x27D38
{
	int iVar0;
	int iVar1;
	...
	if ((func_254() || func_253(Global_4718592.f_166301)) || func_252())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
			iVar1 = func_251(PLAYER::PLAYER_PED_ID(), 0);
			if (((VEHICLE::IS_TURRET_SEAT(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("riot2") && iVar1 == 0) && func_250(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_248(int iParam0)//Position - 0x27F91
{
	if (iParam0 != func_220())
	{
		if (func_249(iParam0, 1, 1))
		{
			return Global_2657589[iParam0 /*466*/].f_321.f_7 != -1;
		}
		else if ((Global_1575060 && iParam0 == PLAYER::PLAYER_ID()) && func_249(iParam0, 1, 0))
		{
			return Global_2657589[iParam0 /*466*/].f_321.f_7 != -1;
		}
	}
...
int func_249(int iParam0, bool bParam1, bool bParam2)//Position - 0x27FF7
{
	int iVar0;
...
int func_250(int iParam0, int iParam1)//Position - 0x28059
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
...
int func_251(int iParam0, bool bParam1)//Position - 0x280BB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_252()//Position - 0x28140
{
	return Global_2683864.f_19;
}

bool func_253(int iParam0)//Position - 0x2814E
{
	return iParam0 == 51;
}

var func_254()//Position - 0x2815B
{
	return Global_2683864.f_18;
}

bool func_255()//Position - 0x28169
{
	return MISC::GET_GAME_TIMER() <= Global_23270.f_6321 + 100;
}

int func_256(int iParam0)//Position - 0x2817E
{
	if (iParam0 == 1)
	{
		if (Global_20383.f_1 > 3)
...
void func_257(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x281D5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_258()//Position - 0x282E1
{
	return func_259(PLAYER::PLAYER_ID());
}

int func_259(int iParam0)//Position - 0x282F1
{
...
bool func_260(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x28310
{
	if (bParam6)
	{
...
int func_261(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x28357
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_262(bool bParam0, bool bParam1, bool bParam2)//Position - 0x286C3
{
	if (!func_247(bParam0, bParam1, bParam2))
	{
		return 0;
	}
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
int func_263(bool bParam0, bool bParam1, bool bParam2)//Position - 0x28715
{
	if (!func_247(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_264(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2875E
{
	if (!func_247(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_265(bool bParam0, bool bParam1, bool bParam2)//Position - 0x287BD
{
	if (!func_247(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_266(int iParam0)//Position - 0x28813
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_267()//Position - 0x2886E
{
	MISC::SET_BIT(&Global_8254, 4);
}

void func_268()//Position - 0x2887E
{
	if (!HUD::DOES_BLIP_EXIST(iLocal_170) && func_472(iLocal_169))
	{
		iLocal_170 = func_269(iLocal_169, 1, 0, 5);
	}
...
int func_269(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x288CA
{
	int iVar0;
	bool bVar1;
...
void func_270()//Position - 0x2891C
{
	switch (iLocal_168)
	{
		case 0:
		...
		case 1:
			...
			{
				if (((iLocal_340 == 0 && !func_232()) && func_231(iLocal_169, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_214(&uLocal_173, "SONARAU", "SONAR_ARRIVE", 7, 0, 0, 0))
				{
					iLocal_340 = 1;
					func_268();
				}
				if (func_235(PLAYER::PLAYER_PED_ID(), iLocal_169) > 250f)
				{
					iLocal_168 = 2;
				}
			}
			if ((iLocal_341 == 0 && iLocal_340 == 1) && !func_232())
			{
				if (func_472(iLocal_169))
				{
				...
				func_271("ABGAIL2_WANTED", 7500, 1);
				iLocal_341 = 1;
			}
			break;
...
void func_271(char* sParam0, int iParam1, int iParam2)//Position - 0x28A2E
{
	iParam2 = iParam2;
...
void func_272()//Position - 0x28A47
{
	switch (iLocal_168)
	{
		case 0:
			...
			if (func_472(iLocal_169))
			{
				...
				if (func_3(iLocal_162))
				{
					...
					func_297(&iLocal_170, "", "", &iLocal_171, &iLocal_172, 1, 0);
		...
		case 1:
			...
			{
				func_273(&iLocal_170, "", "", &iLocal_171, iLocal_172, 0);
				if (iLocal_339 == 0)
				{
					if (((func_472(iLocal_162) && PED::IS_PED_IN_VEHICLE(iLocal_169, iLocal_162, true)) && func_231(iLocal_169, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_214(&uLocal_173, "SONARAU", "SONAR_INCAR", 7, 0, 0, 0))
					{
						iLocal_339 = 1;
					}
					if (((((iLocal_345 < 7 && !func_232()) && (MISC::GET_GAME_TIMER() - iLocal_342) > 10000) && func_231(iLocal_169, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_169)) && func_214(&uLocal_173, "SONARAU", "SONAR_FOLLOW", 7, 0, 0, 0))
					{
						iLocal_342 = MISC::GET_GAME_TIMER();
						iLocal_345++;
					}
...
void func_273(int* iParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28D79
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if ((MISC::GET_GAME_TIMER() - *iParam3) > 500)
		{
			if (HUD::GET_BLIP_COLOUR(*iParam0) == 1)
			{
				...
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_274(sParam1, 0, 0))
					{
						func_271(sParam2, 7500, 0);
					}
				}
			...
			else
			{
				...
				if ((MISC::GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_274(sParam2, 0, 0))
					{
						func_271(sParam1, 7500, 0);
					}
				}
				*iParam3 = MISC::GET_GAME_TIMER();
			}
	...
	{
		if (func_274(sParam1, 0, 0))
		{
			HUD::CLEAR_THIS_PRINT(sParam1);
		}
		if (func_274(sParam2, 0, 0))
		{
...
bool func_274(char* sParam0, int iParam1, char* sParam2)//Position - 0x28E74
{
...
void func_275()//Position - 0x28E92
{
	Global_20591 = 0;
	func_276();
}

void func_276()//Position - 0x28EA2
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_277()//Position - 0x28EC3
{
	...
	if (func_472(iLocal_162))
	{
		if (func_278(iLocal_169, 1, 1116471296, 1126825984, 0, 0, 0, 0))
		{
			return 1;
		}
...
int func_278(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x28F7E
{
	struct<3> Var0;
	
	if (func_472(PLAYER::PLAYER_PED_ID()) && func_472(iParam0))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), true))
		{
			return 1;
		}
		if (func_292(iParam0, bParam1, bParam5, bParam6, bParam7))
		{
			return 1;
		}
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_291(PLAYER::PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
		...
		else if (func_279(iParam0, fParam3))
		{
			return 1;
		}
	}
...
int func_279(int iParam0, float fParam1)//Position - 0x29039
{
	float fVar0;
	
	if (func_472(PLAYER::PLAYER_PED_ID()) && func_472(iParam0))
	{
		if (func_290(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				fVar0 = 40f;
...
bool func_280(int iParam0, float fParam1)//Position - 0x290AF
{
	return func_281(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_281(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x290C7
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	
	iVar4 = func_289(iParam0, iParam1);
	if (!func_472(iParam0) || !func_472(iParam1))
	{
		if (iVar4 != -1)
		{
			func_288(&(Local_37[iVar4 /*4*/]));
		}
		return 0;
	}
	if (!func_285(iParam0, iParam1, fParam2, iParam3))
	{
		return 0;
	}
	if (iVar4 == -1)
	...
	uVar0 = func_282(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_282(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x29188
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_283(int iParam0, int iParam1)//Position - 0x292B4
{
	int iVar0;
...
int func_285(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x293C3
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_287(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_287(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_286(Var3, Var0);
...
float func_286(struct<3> Param0, struct<3> Param3)//Position - 0x29454
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_287(struct<3> Param0)//Position - 0x29475
{
	float fVar0;
	float fVar1;
...
void func_288(var uParam0)//Position - 0x294B4
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_289(int iParam0, int iParam1)//Position - 0x294CF
{
	int iVar0;
...
int func_290(int iParam0)//Position - 0x2950E
{
...
bool func_291(int iParam0, int iParam1, float fParam2)//Position - 0x29536
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_292(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2957D
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_472(PLAYER::PLAYER_PED_ID()) && func_472(iParam0))
	{
		...
		if (!bParam2)
		{
			...
			if (func_293(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_293(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x29678
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_294(int iParam0, float fParam1)//Position - 0x29784
{
	var uVar0;
	struct<3> Var1;
	...
	{
		if (func_295(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_295(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x29819
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_287(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
int func_296(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x298A7
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_297(int* iParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x298EF
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if (bParam5)
...
void func_298()//Position - 0x2999B
{
	if (func_472(iLocal_169))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_169, true);
		func_299(&uLocal_173, 3, iLocal_169, "ABIGAIL", 0, 1);
...
void func_299(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x29A17
{
...
void func_300()//Position - 0x29AB2
{
	if (!func_472(iLocal_162))
	{
...
void func_301()//Position - 0x29B00
{
	switch (iLocal_168)
	{
		case 0:
			func_360("ABIGAIL_MCS_2", 0);
			func_275();
			iLocal_350 = 0;
			iLocal_351 = 0;
			iLocal_168 = 1;
		...
		case 1:
			switch (iLocal_351)
			{
				...
				case 1:
					...
					{
						func_345(-950.64136f, -1507.6007f, 4.17325f, -953.2579f, -1500.4388f, 4.17084f, 8f, -970.3301f, -1526.626f, 4.0877f, 306.1f, 1, 1, 1, 0, 0);
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("ABIGAIL", func_507(16)) && func_472(iLocal_169))
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_169, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 40000f);
						}
					...
					else
					{
						...
						if (iLocal_350 == 1)
						{
							if (func_472(iLocal_169))
							{
								...
								func_340(iLocal_169, -1587.11f, 5204.18f, 3.02f, 210.9196f, 0, 1);
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_169, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 40000f);
...
void func_302(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x29D2D
{
	int iVar0;
	int iVar1;
	...
	if (func_329(iParam0) == 4)
	{
		return;
	}
	func_303(func_329(iParam0), 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
int func_303(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x29DFF
{
	float fVar0;
	bool bVar1;
	int iVar2;
	...
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				case 0:
					func_327(99, 1);
					func_326(joaat("SP0_MONEY_TOTAL_SPENT"), iParam3);
					break;
				
				case 1:
					func_326(joaat("SP1_MONEY_TOTAL_SPENT"), iParam3);
					break;
				
				case 2:
					func_326(joaat("SP2_MONEY_TOTAL_SPENT"), iParam3);
					break;
			}
			func_312(0);
			switch (iParam2)
			{
				...
				case 68:
					...
					{
						case 0:
							func_326(joaat("SP0_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
						
						case 1:
							func_326(joaat("SP1_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
						
						case 2:
							func_326(joaat("SP2_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					}
					if (func_310(1))
					{
				...
				case 21:
					...
					{
						case 0:
							func_326(joaat("SP0_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
						
						case 1:
							func_326(joaat("SP1_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
						
						case 2:
							func_326(joaat("SP2_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					}
					break;
				...
				case 25:
					...
					{
						case 0:
							func_326(joaat("SP0_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
						
						case 1:
							func_326(joaat("SP1_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
						
						case 2:
							func_326(joaat("SP2_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					}
					break;
				...
				case 113:
					...
					{
						case 0:
							func_326(joaat("SP0_MONEY_SPENT_PROPERTY"), iParam3);
							break;
						
						case 1:
							func_326(joaat("SP1_MONEY_SPENT_PROPERTY"), iParam3);
							break;
						
						case 2:
							func_326(joaat("SP2_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					}
					break;
				...
				default:
					switch (SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME())
					{
						case joaat("clothes_shop_sp"):
							...
							{
								case 0:
									func_326(joaat("SP0_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
								
								case 1:
									func_326(joaat("SP1_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
								
								case 2:
									func_326(joaat("SP2_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							}
							break;
						...
						case joaat("hairdo_shop_sp"):
							...
							{
								case 0:
									func_326(joaat("SP0_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
								
								case 1:
									func_326(joaat("SP1_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
								
								case 2:
									func_326(joaat("SP2_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							}
							if (func_310(0))
							{
						...
						case joaat("gunclub_shop"):
							...
							{
								case 0:
									func_326(joaat("SP0_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
								
								case 1:
									func_326(joaat("SP1_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
								
								case 2:
									func_326(joaat("SP2_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							}
							break;
						...
						case joaat("carmod_shop"):
							...
							{
								case 0:
									func_326(joaat("SP0_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
								
								case 1:
									func_326(joaat("SP1_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
								
								case 2:
									func_326(joaat("SP2_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							}
							func_309(iParam3);
							break;
	...
	switch (iParam1)
	{
		case 1:
			...
			{
				case 0:
					func_326(joaat("SP0_TOTAL_CASH_EARNED"), iParam3);
					break;
				
				case 1:
					func_326(joaat("SP1_TOTAL_CASH_EARNED"), iParam3);
					break;
				
				case 2:
					func_326(joaat("SP2_TOTAL_CASH_EARNED"), iParam3);
					break;
			}
			break;
...
void func_304(bool bParam0)//Position - 0x2A3FE
{
	int iVar0;
	int iVar1;
...
void func_305(int iParam0)//Position - 0x2A680
{
	int iVar0;
...
void func_306(bool bParam0)//Position - 0x2A6DA
{
	bool bVar0;
	char cVar1[64];
	...
	else if (BitTest(Global_113648.f_20566.f_471, bParam0) || BitTest(Global_2359296[func_308() /*5568*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_308() /*5568*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED" /* GXT: You have redeemed your promotion for ~a~ */);
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_307(bParam0));
		HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar1, &cVar1, true, 0, "", 0);
	}
}

char* func_307(bool bParam0)//Position - 0x2A859
{
	switch (bParam0)
	{
		case 0:
...
void func_309(int iParam0)//Position - 0x2A968
{
	func_327(93, iParam0);
	func_327(29, iParam0);
	func_327(30, iParam0);
...
int func_310(int iParam0)//Position - 0x2A988
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam0 == 8)
	{
		return func_311(129, -1);
	}
	if (iParam0 == 9)
	{
		return func_311(135, -1);
	}
	if (iParam0 == 10)
	{
		return func_311(136, -1);
	}
	if (iParam0 == 11)
	{
		return func_311(137, -1);
	}
	if (iParam0 == 12)
	{
		iVar0 = NETWORK::GET_CLOUD_TIME_AS_INT();
		iVar1 = func_79(8272, -1, 0);
	...
	return BitTest(Global_2359296[func_308() /*5568*/].f_681.f_10, iParam0);
}

bool func_311(int iParam0, int iParam1)//Position - 0x2AB2E
{
	if (iParam1 == -1)
	{
		iParam1 = func_19();
...
int func_312(bool bParam0)//Position - 0x2AB4A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_313(int iParam0, int iParam1)//Position - 0x2AC01
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_314(int iParam0, int iParam1)//Position - 0x2AC1C
{
	if (func_100(14) && !func_325(iParam0))
	{
		return 0;
	}
	...
	if (func_324(&Global_4542597))
	{
		if (func_322(&Global_4542597, iParam0))
		{
			return 0;
		}
		if (func_315(&Global_4542597, iParam0))
		{
			return 1;
		}
	}
...
int func_315(var uParam0, int iParam1)//Position - 0x2ACB9
{
	int iVar0;
	var uVar1[78];
	...
	if (func_100(14) && !func_325(iParam1))
	{
		return 0;
	}
...
int func_316(var uParam0, int iParam1)//Position - 0x2AD6A
{
	int iVar0;
...
bool func_317(var uParam0, int iParam1)//Position - 0x2ADE5
{
	return (*uParam0)[iParam1] == 78;
}

void func_318(var uParam0)//Position - 0x2ADF6
{
	int iVar0;
	...
	func_320(uParam0, (Global_4542596 - 0.5f));
}

void func_319(var uParam0, int iParam1)//Position - 0x2AE2A
{
	(*uParam0)[iParam1] = 78;
}

void func_320(var uParam0, float fParam1)//Position - 0x2AE3A
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_321(var uParam0)//Position - 0x2AE57
{
	return uParam0->f_80;
}

bool func_322(var uParam0, int iParam1)//Position - 0x2AE63
{
	return func_323(uParam0, iParam1) != -1;
}

int func_323(var uParam0, int iParam1)//Position - 0x2AE75
{
	int iVar0;
...
bool func_324(var uParam0)//Position - 0x2AEA2
{
	return uParam0->f_79 == 1;
}

int func_325(int iParam0)//Position - 0x2AEB0
{
	switch (iParam0)
	{
		case 60:
...
void func_326(int iParam0, int iParam1)//Position - 0x2AF00
{
	int iVar0;
...
void func_327(int iParam0, int iParam1)//Position - 0x2AF23
{
	int iVar0;
...
void func_328()//Position - 0x2AF80
{
	int iVar0;
...
int func_329(int iParam0)//Position - 0x2AFF5
{
	return Global_2028[iParam0 /*29*/].f_17;
}

void func_330(var uParam0, bool bParam1, bool bParam2)//Position - 0x2B006
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_472(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_472(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_472(uParam0->f_41[iVar0]))
		{
...
void func_331(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2B0FB
{
	int iVar0;
...
void func_332(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2B1A5
{
	if (bParam0)
	{
	...
	else
	{
		...
		func_338(0, bParam3, iParam2, 0);
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_336(PLAYER::PLAYER_ID())) && !func_334(PLAYER::PLAYER_ID(), 0)) && !func_333()) && !bParam4) && !bParam5) && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_336(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_78556 = 0;
...
bool func_333()//Position - 0x2B2F2
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_334(int iParam0, int iParam1)//Position - 0x2B30C
{
	bool bVar0;
...
int func_335(int iParam0, bool bParam1)//Position - 0x2B357
{
	int iVar0;
	int iVar1;
...
int func_336(int iParam0)//Position - 0x2B398
{
...
bool func_337()//Position - 0x2B3D7
{
	return BitTest(Global_2621446, 3);
}

int func_338(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x2B3E5
{
	int iVar0;
...
void func_339(int iParam0)//Position - 0x2B418
{
	if (iParam0 == 1)
	{
...
int func_340(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2B43B
{
	bool bVar0;
	float fVar1;
...
void func_341(int iParam0, bool bParam1)//Position - 0x2B497
{
...
void func_342(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x2B4D3
{
	int iVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_343(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
Vector3 func_343(int iParam0)//Position - 0x2B691
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_344(bool bParam0)//Position - 0x2B6A4
{
	int iVar0;
	...
	func_332(1, 1, 0, 0, 0, 0, 0);
}

void func_345(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x2B6E3
{
	func_346(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_346(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2B70C
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_347(struct<3> Param0)//Position - 0x2BB02
{
...
int func_348(int iParam0, int iParam1, bool bParam2)//Position - 0x2BB2C
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_349(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2BB9A
{
...
int func_350(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2BC72
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_351(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2BF68
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_352(int iParam0)//Position - 0x2C01D
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_353()//Position - 0x2C082
{
	int iVar0;
...
int func_354(int iParam0, float fParam1, int iParam2)//Position - 0x2C0A2
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if ((!PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_BOAT(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = 0;
				if (!func_233(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")))
				{
...
bool func_355()//Position - 0x2C176
{
	bool bVar0;
...
void func_356()//Position - 0x2C199
{
	Global_20591 = 0;
	func_229();
}

void func_357()//Position - 0x2C1A9
{
...
int func_358(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2C1FA
{
...
void func_359(int iParam0)//Position - 0x2C392
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_360(char* sParam0, bool bParam1)//Position - 0x2C3BE
{
	func_344(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_361()//Position - 0x2C3D4
{
	HUD::REQUEST_ADDITIONAL_TEXT("ABGAIL2", 0);
	STREAMING::REQUEST_MODEL(iLocal_161);
	if ((!func_232() && HUD::HAS_ADDITIONAL_TEXT_LOADED(0)) && STREAMING::HAS_MODEL_LOADED(iLocal_161))
	{
		PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.1f);
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_161, true);
		if (func_472(Local_100.f_35[0]))
		{
...
void func_362()//Position - 0x2C447
{
	func_364(0);
	func_357();
	func_363();
...
void func_363()//Position - 0x2C45C
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_358(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_364(int iParam0)//Position - 0x2C4B4
{
	if (func_368())
	{
		return;
...
void func_365(int iParam0)//Position - 0x2C4E7
{
	if (func_368())
	{
		return;
...
void func_366(bool bParam0, bool bParam1)//Position - 0x2C571
{
	if (bParam0)
	{
		if (func_256(0))
...
bool func_367()//Position - 0x2C5E5
{
	return BitTest(Global_1962996, 5);
}

bool func_368()//Position - 0x2C5F3
{
	return BitTest(Global_1962996, 19);
}

void func_369(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2C602
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_371(Global_78814, Global_78816, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_370(char* sParam0)//Position - 0x2C8E7
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_371(int iParam0, int iParam1, int iParam2)//Position - 0x2C8FA
{
	struct<2> Var0;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_372(iVar2), 8);
					break;
			}
			break;
...
char* func_372(int iParam0)//Position - 0x2C9D0
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_373(int iParam0)//Position - 0x2CB23
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_374(int iParam0)//Position - 0x2CB56
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_375(int iParam0)//Position - 0x2CB89
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_376(int iParam0)//Position - 0x2CBBC
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_377(int iParam0)//Position - 0x2CBEF
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_378(int iParam0)//Position - 0x2CC2C
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_379(int iParam0)//Position - 0x2CC5F
{
	struct<2> Var0;
...
int func_380(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2CCC8
{
	if (((!func_382(0) || Global_78828) || Global_78817 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78813)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_256(0)) || func_381(1))
			{
			}
			else
			{
...
bool func_381(bool bParam0)//Position - 0x2CDE0
{
	if (bParam0)
	{
...
int func_382(int iParam0)//Position - 0x2CE09
{
	if (Global_43257 == 15)
	{
		return 0;
...
bool func_383(int iParam0)//Position - 0x2CE2B
{
	return func_384(iParam0, Global_43257);
}

int func_384(int iParam0, int iParam1)//Position - 0x2CE3C
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_385(int iParam0)//Position - 0x2D01D
{
	func_467(0, 0, 0);
	func_466(1, 1);
	func_4(&iLocal_169);
	...
	switch (iParam0)
	{
		...
		case 1:
			func_391(-1595.201f, 5217.4946f, 3.0009f, 208.2675f, -1580.2358f, 5169.5854f, 18.5846f, 189.4926f, -1587.11f, 5204.18f, 3.02f, -143.87f, Local_163, fLocal_166);
			func_237(2);
			break;
		
		case 2:
			func_391(0f, 0f, 0f, 0f, -1580.2358f, 5169.5854f, 18.5846f, 189.4926f, 0f, 0f, 0f, 0f, Local_163, fLocal_166);
			func_237(2);
			break;
	...
	if (!func_390())
	{
		func_388(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1112014848, 12, 5000, 0, 0);
	}
	func_387(0, -1, 1);
	func_386(1, 1, 1);
}

void func_386(int iParam0, int iParam1, int iParam2)//Position - 0x2D1B7
{
	func_331(0, 0, iParam2, 1);
	if (iParam0 == 1)
	{
		CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
...
void func_387(int iParam0, int iParam1, int iParam2)//Position - 0x2D1EB
{
	if (func_470() && func_390())
	{
...
void func_388(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x2D2AF
{
	int iVar0;
	int iVar1;
...
void func_389()//Position - 0x2D31F
{
	Global_23131.f_6 = 1;
}

bool func_390()//Position - 0x2D32D
{
	return BitTest(Global_100681.f_20, 13);
}

void func_391(struct<3> Param0, float fParam3, struct<3> Param4, float fParam7, struct<3> Param8, float fParam11, struct<3> Param12, float fParam15)//Position - 0x2D33E
{
	int* iVar0;
	
	if (func_347(Param0))
	{
		while (!func_396(&iVar0, 0, Param4, fParam7, 1, 0))
		{
			SYSTEM::WAIT(0);
		}
	...
	{
		func_340(PLAYER::PLAYER_PED_ID(), Param0, fParam3, 0, 1);
	}
	STREAMING::REQUEST_MODEL(iLocal_161);
	...
	while (!func_392(&iLocal_169, 16, Param8, fParam11, "RC ABIGAIL 2", 1))
	{
		SYSTEM::WAIT(0);
	}
...
int func_392(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x2D406
{
...
int func_393(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2D462
{
	int iVar0;
...
int func_394(var uParam0, int iParam1)//Position - 0x2D4F0
{
	int iVar0;
...
void func_395(int* iParam0)//Position - 0x2D536
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_396(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2D56E
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_457(iParam0, &(Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_457(iParam0, &(Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5.f_0, Param2, fParam5, true, true, false);
				...
				func_457(iParam0, &(Var5.f_31), &(Var5.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_397(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2E38E
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_161(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_402(*iParam1, 0, &uVar0))
		{
			func_401(iParam1, &(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_113648.f_20120[iParam0 /*43*/].f_31 = func_400(*iParam1);
				...
				func_398(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_113648.f_20120[iParam0 /*43*/].f_1));
				...
				func_398(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_113648.f_20120[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_398(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x2EFA2
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_399(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
bool func_399(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x2F015
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_400(int iParam0)//Position - 0x30509
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_401(int iParam0, var uParam1, var uParam2)//Position - 0x305B9
{
	int iVar0;
	int iVar1;
...
int func_402(int iParam0, bool bParam1, var uParam2)//Position - 0x307AC
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_433(iVar0, bParam1, uParam2) && !func_432(PLAYER::PLAYER_ID())) && !func_413(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_410(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_407(iParam0)) && !bVar1) && !(func_406(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_404(PLAYER::PLAYER_ID())))
	{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_403(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_403(int iParam0)//Position - 0x3091A
{
	int iVar0;
...
int func_404(int iParam0)//Position - 0x30955
{
	if (iParam0 != func_220())
	{
		if (func_249(iParam0, 1, 1))
		{
			...
			{
				return func_405(Global_2657589[iParam0 /*466*/].f_321.f_7) == 11;
			}
		}
	}
	return 0;
...
int func_405(int iParam0)//Position - 0x3099C
{
	switch (iParam0)
	{
		case 0:
...
int func_406(int iParam0)//Position - 0x30E50
{
...
int func_407(int iParam0)//Position - 0x30E92
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_408(int iParam0)//Position - 0x30F5A
{
	if (iParam0 != func_220())
	{
		if (func_249(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_405(Global_2657589[iParam0 /*466*/].f_321.f_7) == 26;
			}
		}
	}
	return 0;
...
int func_409(int iParam0)//Position - 0x30FA1
{
	if (iParam0 != func_220())
	{
		if (func_249(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_405(Global_2657589[iParam0 /*466*/].f_321.f_7) == 13;
			}
		}
	}
	return 0;
...
int func_410(int iParam0)//Position - 0x30FE8
{
	if (iParam0 != func_220())
	{
		if (func_249(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_405(Global_2657589[iParam0 /*466*/].f_321.f_7) == 7;
			}
		}
	}
	return 0;
...
int func_411(int iParam0)//Position - 0x3102E
{
	bool bVar0;
	...
	if (((!func_412(PLAYER::PLAYER_ID()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger")) && !bVar0)
	{
		return 0;
	}
	return 1;
...
int func_412(int iParam0)//Position - 0x310B2
{
	if (iParam0 != func_220())
	{
...
int func_413(int iParam0)//Position - 0x310D8
{
	if (func_431(PLAYER::PLAYER_ID()) || func_430(PLAYER::PLAYER_ID()))
	{
		if (func_414(iParam0))
		{
			return 1;
...
int func_414(int iParam0)//Position - 0x31107
{
	...
	if (func_417(PLAYER::PLAYER_ID()) && (!func_411(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("thruster"))))
	{
		return 0;
	}
...
int func_415(int iParam0)//Position - 0x311B8
{
	int iVar0;
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_407(iParam0)) || func_416(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_416(int iParam0)//Position - 0x3122F
{
	switch (iParam0)
	{
		case joaat("mule"):
...
int func_417(int iParam0)//Position - 0x3127F
{
	if (iParam0 == func_220())
	{
		return 0;
	}
	if (func_432(iParam0) && Global_2657589[iParam0 /*466*/].f_321.f_10 == iParam0)
	{
		return 1;
	}
	return 0;
...
int func_418(int iParam0, bool bParam1)//Position - 0x312B8
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_420(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				if (Global_2793046.f_304 == iParam0)
				{
					return 1;
				}
				else if (func_419(iParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_419(int iParam0)//Position - 0x31313
{
	int iVar0;
...
int func_420(int iParam0, int iParam1)//Position - 0x3134C
{
	if (iParam1 == 0)
	{
...
int func_430(int iParam0)//Position - 0x31C32
{
	if (iParam0 != func_220())
	{
		if (func_249(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1 && Global_2657589[iParam0 /*466*/].f_321.f_10 != func_220())
			{
				return func_405(Global_2657589[iParam0 /*466*/].f_321.f_7) == 5;
			}
		}
	}
	return 0;
...
int func_431(int iParam0)//Position - 0x31C91
{
	if (iParam0 != func_220())
	{
		if (func_249(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1 && Global_2657589[iParam0 /*466*/].f_321.f_10 != func_220())
			{
				return func_405(Global_2657589[iParam0 /*466*/].f_321.f_7) == 8;
			}
		}
	}
	return 0;
...
int func_432(int iParam0)//Position - 0x31CF1
{
	if (iParam0 != func_220())
	{
		if (func_249(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_405(Global_2657589[iParam0 /*466*/].f_321.f_7) == 9;
			}
		}
	}
	return 0;
...
int func_433(int iParam0, bool bParam1, var uParam2)//Position - 0x31D38
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_410(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_434(int iParam0)//Position - 0x32184
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_435(int iParam0, int iParam1)//Position - 0x321AD
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_436(iParam0, &(Global_113648.f_32751.f_5510));
}

void func_436(int iParam0, var uParam1)//Position - 0x323AF
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		if (uParam1->f_65 == -1 && !func_438(uParam1->f_66))
		{
			uParam1->f_65 = 0;
		}
...
int func_437(int iParam0)//Position - 0x3265A
{
	switch (iParam0)
	{
		case 1:
...
int func_438(int iParam0)//Position - 0x3270A
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_439(int iParam0)//Position - 0x3272A
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_348(iParam0, 0, 0)) || func_348(iParam0, 1, 0)) || func_348(iParam0, 2, 0)) || func_453(iParam0) != 145) || func_452(iParam0)) || func_451(iParam0)) || func_403(iParam0)) || func_450(iParam0)) || !func_440(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_451(iParam0))
		{
		}
...
int func_440(int iParam0)//Position - 0x32807
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_441(int iParam0, bool bParam1, int iParam2)//Position - 0x329B9
{
	int iVar0;
	struct<2> Var1;
	...
	{
		if ((((!func_448() && !func_447()) && !func_446()) && !func_445()) && !func_449())
		{
			return 0;
		}
	}
...
int func_442(int iParam0)//Position - 0x32B3B
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_444(int iParam0, int iParam1)//Position - 0x32C1E
{
	int iVar0;
	int iVar1;
...
int func_445()//Position - 0x36250
{
	return 0;
}

int func_446()//Position - 0x36259
{
	return 1;
}

int func_447()//Position - 0x36262
{
	return 1;
}

int func_448()//Position - 0x3626B
{
...
int func_450(int iParam0)//Position - 0x3633C
{
	int iVar0;
	char* sVar1;
...
int func_451(int iParam0)//Position - 0x36383
{
	int iVar0;
...
int func_452(int iParam0)//Position - 0x363FF
{
	int iVar0;
...
int func_453(int iParam0)//Position - 0x364E7
{
	int iVar0;
...
void func_454(int iParam0, int iParam1)//Position - 0x3654A
{
	int iVar0;
...
void func_455(var uParam0)//Position - 0x365CC
{
	if (!func_456(*uParam0))
	{
...
bool func_456(int iParam0)//Position - 0x365F7
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_457(var uParam0, var uParam1, var uParam2)//Position - 0x36606
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*uParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_462(*uParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_429(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_460(*uParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_460(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_459(uParam0);
	if (func_458(*uParam0))
	{
...
int func_458(int iParam0)//Position - 0x367E0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_459(var uParam0)//Position - 0x368BC
{
...
int func_460(int iParam0, int iParam1)//Position - 0x36913
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_461(int iParam0, int iParam1)//Position - 0x369FC
{
	int iVar0;
...
int func_462(int iParam0, int iParam1, int iParam2)//Position - 0x36A5E
{
...
int func_463()//Position - 0x36A82
{
	return 0;
}

int func_464(var uParam0, int iParam1)//Position - 0x36A8B
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_465(int iParam0, var uParam1, int iParam2)//Position - 0x36ACC
{
	int iVar0;
...
void func_466(bool bParam0, bool bParam1)//Position - 0x36D28
{
	if (bParam0)
	{
		func_467(0, 1, 1);
...
void func_467(bool bParam0, int iParam1, int iParam2)//Position - 0x36D5B
{
	bool bVar0;
	...
	if (CUTSCENE::IS_CUTSCENE_ACTIVE())
	{
		...
		if (bParam0)
		{
			func_331(iParam1, iParam2, 1, 1);
		}
	}
}

void func_468(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x36DBA
{
	if (func_470())
	{
...
void func_471()//Position - 0x36E9D
{
	iLocal_171 = 0;
	iLocal_172 = 0;
	iLocal_338 = 0;
...
int func_472(int iParam0)//Position - 0x36ECB
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_473(int iParam0)//Position - 0x36EEC
{
	func_7(&uLocal_88, 0, 0);
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
	...
	func_395(&iLocal_162);
	func_353();
	func_483(&uLocal_173, 3);
	func_474(&Local_100, 0, 0, 0);
...
void func_474(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x36F59
{
	func_481(uParam0, iParam1);
	func_479(uParam0, bParam2);
	func_475(uParam0, bParam3);
}

void func_475(var uParam0, bool bParam1)//Position - 0x36F79
{
	func_476(&(uParam0->f_41), bParam1);
}

void func_476(var uParam0, bool bParam1)//Position - 0x36F8B
{
	int iVar0;
...
void func_477(int* iParam0, bool bParam1)//Position - 0x36FC9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_478(int* iParam0)//Position - 0x37004
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_479(var uParam0, bool bParam1)//Position - 0x3702F
{
	func_480(&(uParam0->f_35), bParam1);
}

void func_480(var uParam0, bool bParam1)//Position - 0x37041
{
	int iVar0;
...
void func_481(var uParam0, int iParam1)//Position - 0x3707E
{
	func_482(&(uParam0->f_28), iParam1);
}

void func_482(var uParam0, int iParam1)//Position - 0x37090
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_484(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_483(var uParam0, int iParam1)//Position - 0x370D1
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_484(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x370EE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_485(bool bParam0)//Position - 0x3713E
{
	int iVar0;
...
void func_486(char* sParam0, int iParam1)//Position - 0x3720E
{
	if (Global_100681 != 12)
	{
...
int func_487(char* sParam0, int iParam1, int iParam2)//Position - 0x37236
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_488(char* sParam0)//Position - 0x373C5
{
...
int func_490(char* sParam0, bool bParam1)//Position - 0x3743F
{
	int iVar0;
	int iVar1;
...
int func_491(int iParam0, bool bParam1)//Position - 0x37469
{
	int iVar0;
...
void func_494(bool bParam0)//Position - 0x3755B
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_495(int iParam0)//Position - 0x3756F
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_496(int iParam0)//Position - 0x375A9
{
	if (iParam0 == 1)
	{
...
void func_497()//Position - 0x375E3
{
	Global_23131.f_5 = 1;
}

void func_498()//Position - 0x375F1
{
	Global_23131.f_5 = 0;
}

void func_499(bool bParam0)//Position - 0x375FF
{
	if (bParam0)
	{
		func_500();
...
void func_500()//Position - 0x37662
{
...
void func_501()//Position - 0x3768B
{
	Global_94857 = 0;
	Global_94858 = 0;
}

int func_502()//Position - 0x3769D
{
...
void func_503()//Position - 0x376DB
{
	Global_100716 = 1;
...
void func_504(char* sParam0)//Position - 0x377C8
{
...
void func_505(var uParam0)//Position - 0x377DA
{
...
void func_506(var uParam0)//Position - 0x377FA
{
	int iVar0;
...
int func_507(int iParam0)//Position - 0x37834
{
	if (!func_161(iParam0))
	{
		return func_160(iParam0);
