...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	Local_38 = { -1593.813f, 5221.235f, 1.94482f };
	Local_39 = { -1603.986f, 5243.624f, 4.940323f };
	uLocal_40 = func_503(16);
	sLocal_41 = "rcmabigail";
	iLocal_55 = joaat("asea");
	Local_57 = { -1573.733f, 5164.508f, 18.5576f };
	fLocal_58 = 175.9451f;
	Local_239 = { -1014.054f, -2474.013f, 19.1091f };
	...
	if (func_466())
	{
		...
		{
			case 0:
				func_464(-1595.201f, 5217.495f, 3.0009f, 208.2675f, 1, 0);
				func_385(1);
				break;
			}
	}
...
void func_11(int iParam0, bool bParam1)//Position - 0x60B
{
	...
	{
		func_182(&(Global_112473[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_15()//Position - 0x898
{
	...
	{
		func_17(13, SYSTEM::FLOOR(Global_113386.f_10194.f_3853));
	}
...
int func_40(int iParam0, int iParam1, int iParam2)//Position - 0x187E
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_84(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_84(iParam1), Global_78130[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_84(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, 0);
		}
	}
...
int func_42(int iParam0)//Position - 0x1AC6
{
	switch (iParam0)
	{
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1B01
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							...
							func_59(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
							func_75(14);
							if (Global_78128 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_84(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_84(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_84(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
						}
						func_75(iVar0);
						if (Global_78128 == 1)
						{
			...
			{
				Global_78130[1 /*14*/] = { func_92(iVar10, iVar0, func_49(iParam0, iVar0, -1), -1) };
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_84(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_84(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_84(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
		}
		if (Global_78128 == 1)
		{
			iVar2 = 0;
...
int func_45(int iParam0, int iParam1, int iParam2)//Position - 0x239B
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_46(int iParam0, int iParam1, int iParam2)//Position - 0x2479
{
	Global_78130[1 /*14*/] = { func_92(iParam0, iParam1, iParam2, -1) };
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x2AA5
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_50(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2BDF
{
	int iVar0;
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x3A99
{
	int iVar0;
...
int func_55(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x407C
{
	int iVar0;
...
int func_56(int iParam0, int iParam1, int iParam2)//Position - 0x40A5
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x436F
{
	int iVar0;
...
int func_58(int iParam0, int iParam1, int iParam2)//Position - 0x45F9
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_59(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4750
{
	int iVar0;
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x47E8
{
	switch (iParam0)
	{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x48B6
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, int iParam1)//Position - 0x49D0
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_63(int iParam0)//Position - 0x4D77
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_64(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4DD8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, int iParam1)//Position - 0x4ED4
{
	int iVar0;
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5012
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_67(int iParam0)//Position - 0x50CD
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_68(int iParam0)//Position - 0x512C
{
	switch (iParam0)
	{
		case 0:
...
int func_69(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x51B2
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x542F
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5854
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_73(int iParam0, int iParam1)//Position - 0x5B8D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5BED
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_75(int iParam0)//Position - 0x5C44
{
	...
	{
		func_81(iParam0, Global_78130[1 /*14*/].f_5, Global_78130[1 /*14*/].f_2, 2, Global_78130[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_78130[1 /*14*/].f_6, 1) && BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
int func_78(var uParam0)//Position - 0x5D6A
{
	int iVar0;
	int iVar1;
...
int func_79(int iParam0, int iParam1, int iParam2)//Position - 0x5D9E
{
	int iVar0;
	var uVar1;
...
bool func_80(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x5DDB
{
	int iVar0;
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x83D7
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_82(int iParam0)//Position - 0x927A
{
	if (!BitTest(Global_78130[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_84(int iParam0)//Position - 0x9358
{
	switch (iParam0)
	{
		case 0:
...
void func_87(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x9E61
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_88(int iParam0, int iParam1)//Position - 0x9EA9
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_91(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[0], Global_113386.f_2363.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_91(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[1], Global_113386.f_2363.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_91(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[2], Global_113386.f_2363.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
int func_90(int iParam0)//Position - 0xBEDB
{
	switch (iParam0)
	{
		case 0:
...
void func_91(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xBF8B
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_79(func_98(iParam1, uParam0->f_2), Global_78127, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_79(func_97(iParam1, uParam0->f_2), Global_78127, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
...
bool func_96(int iParam0, int iParam1, var uParam2)//Position - 0xD71A
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_97(int iParam0, int iParam1)//Position - 0xDB1F
{
	switch (iParam1)
	{
		case 0:
...
int func_98(int iParam0, int iParam1)//Position - 0xDF1A
{
	switch (iParam1)
	{
		case 0:
...
bool func_100(int iParam0)//Position - 0xE354
{
	return Global_43052 == iParam0;
}

int func_101(int iParam0)//Position - 0xE362
{
	switch (iParam0)
	{
		case -1:
...
void func_107(int iParam0)//Position - 0xEDFD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0xF757
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0x100EA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x10C42
{
	if (iParam0 < 136)
	{
		func_116(iParam0);
...
void func_115(int iParam0)//Position - 0x10C77
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x128A8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x178AE
{
	if (iParam0 < 107)
	{
		func_135(iParam0);
...
void func_134(int iParam0)//Position - 0x1839A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x1B138
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x1BC44
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x1C1C6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156()//Position - 0x1F63B
{
...
int func_157(int iParam0, int iParam1, int iParam2)//Position - 0x1F6B3
{
	...
	else if (Global_78130[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_84(iParam1)) && Global_78130[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_84(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_158(int iParam0)//Position - 0x1F90B
{
	int iVar0;
	int iVar1;
...
int func_159(int iParam0)//Position - 0x1F948
{
	if (func_161(iParam0))
	{
...
var func_160(int iParam0)//Position - 0x1F96D
{
	return Global_1998[iParam0 /*29*/];
}

bool func_161(int iParam0)//Position - 0x1F97C
{
	return iParam0 < 3;
}

void func_162(char* sParam0, var uParam1)//Position - 0x1F988
{
...
void func_164()//Position - 0x1FA1F
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_159(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_158(PLAYER::PLAYER_PED_ID());
			if (func_161(iVar0) && (!func_100(14) || Global_112337))
			{
				if (Global_113386.f_2363.f_539.f_4321 != iVar0 && func_161(Global_113386.f_2363.f_539.f_4321))
				{
...
struct<2> func_165(int iParam0)//Position - 0x1FB1C
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_166(int iParam0)//Position - 0x1FB53
{
	struct<2> Var0;
...
void func_167(int iParam0, int iParam1)//Position - 0x1FF9F
{
...
void func_169(int iParam0, bool bParam1, bool bParam2)//Position - 0x20088
{
	struct<4> Var0;
	char* sVar1;
	...
	if (iParam0 != -1)
	{
		...
		func_170(&sVar1, Var0.f_3, Global_100478, bParam1, bParam2);
	}
}

void func_170(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x200C7
{
...
void func_171(int iParam0, var uParam1)//Position - 0x2010B
{
	switch (iParam0)
	{
		case 0:
...
int func_173(int iParam0)//Position - 0x21351
{
	switch (iParam0)
	{
		case 0:
...
void func_174(int iParam0)//Position - 0x21697
{
	Global_43603 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_175()//Position - 0x216A9
{
	if (Global_97753)
	{
		func_164();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_176(Global_113386.f_2363.f_539.f_4321));
	}
	else
	{
...
char* func_176(var uParam0)//Position - 0x216DB
{
	uParam0 = uParam0;
	return "";
}

void func_177()//Position - 0x216EA
{
	char cVar0[24];
...
bool func_178()//Position - 0x2172D
{
	return (MISC::IS_ORBIS_VERSION() || MISC::_0x807ABE1AB65C24D2());
}

bool func_179()//Position - 0x21743
{
	return (MISC::IS_DURANGO_VERSION() || MISC::_0xC545AB1CF97ABB34());
}

void func_180(int iParam0, int iParam1)//Position - 0x21759
{
	Global_97748 = iParam0;
	Global_97749 = iParam1;
}

void func_181()//Position - 0x2176D
{
	if (Global_78573 != 6)
	{
	}
...
void func_182(var uParam0)//Position - 0x217A5
{
	if (*uParam0 == -1)
	{
		return;
...
int func_184(int iParam0)//Position - 0x2195F
{
	switch (iParam0)
	{
		case 0:
...
void func_185(int iParam0)//Position - 0x21CE6
{
	func_187(iParam0, 1);
	Global_113386.f_18574[iParam0 /*6*/].f_3 = func_186();
	Global_113386.f_18574.f_380++;
}

int func_186()//Position - 0x21D1C
{
	return (Global_113386.f_10016.f_21 + Global_113386.f_18574.f_380);
}

void func_187(var uParam0, bool bParam1)//Position - 0x21D38
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_190(int iParam0, bool bParam1)//Position - 0x220C4
{
	if (iParam0 == -1)
	{
		return;
...
void func_191(int iParam0, int iParam1, bool bParam2)//Position - 0x22121
{
	if (iParam0 == -1)
	{
		return;
...
int func_192(int iParam0, int iParam1)//Position - 0x2215C
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_194(int iParam0, int iParam1)//Position - 0x221D4
{
	switch (iParam0)
	{
		case 12:
...
void func_195(int iParam0, bool bParam1)//Position - 0x222BD
{
	if (bParam1)
	{
...
bool func_196(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x222E6
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_198()//Position - 0x22C65
{
	return Global_31960;
}

int func_199(var uParam0, int iParam1)//Position - 0x22C70
{
	int iVar0;
...
int func_200(int iParam0)//Position - 0x2640B
{
	switch (iParam0)
	{
		case 46:
...
void func_203(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x265B1
{
	func_204(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_204(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x265D2
{
	int iVar0;
...
void func_205()//Position - 0x267A5
{
	int iVar0;
...
int func_206(int iParam0)//Position - 0x268BC
{
	int iVar0;
	int iVar1;
...
void func_207(char* sParam0)//Position - 0x268FC
{
...
char* func_208(int iParam0)//Position - 0x26920
{
	switch (iParam0)
	{
		case 0:
...
int func_209(int iParam0)//Position - 0x26AF3
{
...
void func_210(int iParam0, int iParam1)//Position - 0x26B1D
{
...
int func_211(char* sParam0)//Position - 0x26B5A
{
	int iVar0;
...
int func_212()//Position - 0x26BBA
{
	return func_213(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_213(char* sParam0, int iParam1)//Position - 0x26BCB
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_214(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x26C14
{
...
int func_215(char* sParam0, int iParam1, bool bParam2)//Position - 0x26C62
{
	Global_21606 = 0;
...
void func_216()//Position - 0x26F30
{
	if (!func_217())
	{
		return;
...
bool func_218(int iParam0)//Position - 0x26FCA
{
	return func_219(iParam0, 20);
}

var func_219(int iParam0, int iParam1)//Position - 0x26FDA
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

int func_220()//Position - 0x26FF2
{
	return -1;
}

void func_221()//Position - 0x26FFB
{
	int iVar0;
...
void func_222()//Position - 0x2702C
{
...
void func_225()//Position - 0x27181
{
	if (func_100(14))
	{
...
int func_226()//Position - 0x27223
{
	func_164();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_227()//Position - 0x2723C
{
	int iVar0;
...
bool func_228(int iParam0, int iParam1)//Position - 0x27293
{
	switch (iParam0)
	{
		case 5:
...
void func_229()//Position - 0x272CB
{
...
void func_230(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x27322
{
...
int func_233(int iParam0, int iParam1)//Position - 0x273BC
{
	if (func_234(iParam0))
	{
...
int func_234(int iParam0)//Position - 0x273EF
{
	if (func_468(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
float func_235(int iParam0, int iParam1)//Position - 0x2740F
{
	return func_236(iParam0, iParam1, 1);
}

float func_236(int iParam0, int iParam1, bool bParam2)//Position - 0x27420
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_242(var uParam0)//Position - 0x2788D
{
...
int func_243(var uParam0)//Position - 0x278F1
{
	int iVar0;
...
int func_244(bool bParam0)//Position - 0x2791C
{
	switch (Global_43052)
	{
		case 0:
...
void func_245(char* sParam0, int iParam1)//Position - 0x279C6
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_246(char* sParam0)//Position - 0x279DD
{
	if (!func_247(1, 1, 0))
	{
...
int func_247(bool bParam0, bool bParam1, bool bParam2)//Position - 0x27A75
{
	int iVar0;
	int iVar1;
	...
	if ((func_254() || func_253(Global_4718592.f_168757)) || func_252())
	{
...
int func_248(int iParam0)//Position - 0x27CCE
{
	if (iParam0 != func_220())
	{
		...
		else if ((Global_1575058 && iParam0 == PLAYER::PLAYER_ID()) && func_249(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
int func_249(int iParam0, bool bParam1, bool bParam2)//Position - 0x27D34
{
	int iVar0;
...
int func_250(int iParam0, int iParam1)//Position - 0x27D94
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
...
int func_251(int iParam0, bool bParam1)//Position - 0x27DF6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_252()//Position - 0x27E7B
{
	return Global_2714762.f_19;
}

bool func_253(int iParam0)//Position - 0x27E89
{
	return iParam0 == 51;
}

var func_254()//Position - 0x27E96
{
	return Global_2714762.f_18;
}

bool func_255()//Position - 0x27EA4
{
	return MISC::GET_GAME_TIMER() <= Global_23150.f_6269 + 100;
}

int func_256(int iParam0)//Position - 0x27EB9
{
	if (iParam0 == 1)
	{
		if (Global_20266.f_1 > 3)
...
bool func_258()//Position - 0x2801D
{
	return func_259(PLAYER::PLAYER_ID());
}

int func_259(int iParam0)//Position - 0x2802D
{
...
bool func_260(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x2804C
{
	if (bParam2)
	{
...
int func_261(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x28093
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_262(bool bParam0, bool bParam1, bool bParam2)//Position - 0x283FF
{
...
int func_263(bool bParam0, bool bParam1, bool bParam2)//Position - 0x28451
{
	if (!func_247(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_264(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2849A
{
	if (!func_247(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_265(bool bParam0, bool bParam1, bool bParam2)//Position - 0x284F9
{
	if (!func_247(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_266(int iParam0)//Position - 0x2854F
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_267()//Position - 0x285AA
{
...
{
	if (!HUD::DOES_BLIP_EXIST(iLocal_62) && func_468(iLocal_61))
	{
...
int func_269(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x28606
{
	int iVar0;
	bool bVar1;
...
void func_271(char* sParam0, int iParam1, int iParam2)//Position - 0x2876A
{
	iParam2 = iParam2;
	...
	switch (iLocal_60)
	{
		...
		case 1:
			...
			else
			{
				...
				if (iLocal_231 == 0)
				{
					if (((func_468(iLocal_56) && PED::IS_PED_IN_VEHICLE(iLocal_61, iLocal_56, true)) && func_231(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_214(&uLocal_65, "SONARAU", "SONAR_INCAR", 7, 0, 0, 0))
					{
						iLocal_231 = 1;
					}
...
bool func_274(char* sParam0, int iParam1, char* sParam2)//Position - 0x28BB0
{
...
void func_276()//Position - 0x28BDE
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22616 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_278(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x28CBA
{
	struct<3> Var0;
	
	if (func_468(PLAYER::PLAYER_PED_ID()) && func_468(iParam0))
	{
...
int func_279(int iParam0, float fParam1)//Position - 0x28D75
{
	float fVar0;
...
bool func_280(int iParam0, float fParam1)//Position - 0x28DEB
{
	return func_281(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_281(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28E03
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (!func_468(iParam0) || !func_468(iParam1))
	{
		if (iVar2 != -1)
		{
...
int func_282(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x28EC4
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_283(int iParam0, int iParam1)//Position - 0x28FF0
{
	int iVar0;
...
int func_285(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x290FF
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
float func_286(struct<3> Param0, struct<3> Param1)//Position - 0x29190
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_287(struct<3> Param0)//Position - 0x291B1
{
	float fVar0;
	float fVar1;
...
void func_288(var uParam0)//Position - 0x291F0
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_289(int iParam0, int iParam1)//Position - 0x2920B
{
	int iVar0;
...
int func_290(int iParam0)//Position - 0x2924A
{
...
bool func_291(int iParam0, int iParam1, float fParam2)//Position - 0x29272
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_292(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x292B9
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_293(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x293B4
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_294(int iParam0, float fParam1)//Position - 0x294C0
{
	var uVar0;
	struct<3> Var1;
...
int func_295(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0x29555
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_296(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x295E3
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_299(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x29753
{
		...
		case 1:
			switch (iLocal_241)
			{
				...
				case 1:
					...
					{
						func_345(-950.6414f, -1507.601f, 4.17325f, -953.2579f, -1500.439f, 4.17084f, 8f, -970.3301f, -1526.626f, 4.0877f, 306.1f, 1, 1, 1, 0, 0);
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("ABIGAIL", func_503(16)) && func_468(iLocal_61))
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_61, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, true, 40000f);
						}
...
void func_304(bool bParam0)//Position - 0x2A13A
{
	int iVar0;
	int iVar1;
...
void func_305(int iParam0)//Position - 0x2A3BC
{
	int iVar0;
...
void func_306(bool bParam0)//Position - 0x2A416
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_308() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_308() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
char* func_307(bool bParam0)//Position - 0x2A595
{
	switch (bParam0)
	{
		case 0:
...
void func_309(int iParam0)//Position - 0x2A6A4
{
	func_327(93, iParam0);
	func_327(29, iParam0);
	func_327(30, iParam0);
...
int func_310(int iParam0)//Position - 0x2A6C4
{
	...
	return BitTest(Global_2359296[func_308() /*5567*/].f_681.f_10, iParam0);
}

bool func_311(int iParam0, int iParam1)//Position - 0x2A86A
{
	if (iParam1 == -1)
	{
		iParam1 = func_19();
...
int func_314(int iParam0, int iParam1)//Position - 0x2A958
{
	...
	if (func_324(&Global_4541529))
	{
		if (func_322(&Global_4541529, iParam0))
		{
			return 0;
		}
		if (func_315(&Global_4541529, iParam0))
		{
			return 1;
		}
	}
...
int func_315(var uParam0, int iParam1)//Position - 0x2A9F5
{
	int iVar0;
	var uVar1[78];
...
int func_316(var uParam0, int iParam1)//Position - 0x2AAA6
{
	int iVar0;
...
bool func_317(var uParam0, int iParam1)//Position - 0x2AB21
{
	return (*uParam0)[iParam1] == 78;
}

void func_318(var uParam0)//Position - 0x2AB32
{
	int iVar0;
	...
	func_320(uParam0, (Global_4541528 - 0.5f));
}

void func_319(var uParam0, int iParam1)//Position - 0x2AB66
{
	(*uParam0)[iParam1] = 78;
}

void func_320(var uParam0, float fParam1)//Position - 0x2AB76
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_321(var uParam0)//Position - 0x2AB93
{
	return uParam0->f_80;
}

bool func_322(var uParam0, int iParam1)//Position - 0x2AB9F
{
	return func_323(uParam0, iParam1) != -1;
}

int func_323(var uParam0, int iParam1)//Position - 0x2ABB1
{
	int iVar0;
...
bool func_324(var uParam0)//Position - 0x2ABDE
{
	return uParam0->f_79 == 1;
}

int func_325(int iParam0)//Position - 0x2ABEC
{
	switch (iParam0)
	{
		case 60:
...
void func_326(int iParam0, int iParam1)//Position - 0x2AC3C
{
	int iVar0;
...
void func_327(int iParam0, int iParam1)//Position - 0x2AC5F
{
	int iVar0;
...
void func_328()//Position - 0x2ACBC
{
	int iVar0;
...
int func_329(int iParam0)//Position - 0x2AD31
{
	return Global_1998[iParam0 /*29*/].f_17;
}

void func_330(var uParam0, bool bParam1, bool bParam2)//Position - 0x2AD42
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_468(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_468(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_468(uParam0->f_41[iVar0]))
		{
...
void func_331(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2AE37
{
	int iVar0;
...
void func_332(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2AEE1
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_336(PLAYER::PLAYER_ID())) && !func_334(PLAYER::PLAYER_ID(), 0)) && !func_333()) && !bParam4) && !bParam5)
			{
...
bool func_333()//Position - 0x2B024
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_334(int iParam0, int iParam1)//Position - 0x2B03E
{
	bool bVar0;
...
int func_335(int iParam0, bool bParam1)//Position - 0x2B089
{
	int iVar0;
	int iVar1;
...
int func_336(int iParam0)//Position - 0x2B0CA
{
...
bool func_337()//Position - 0x2B109
{
	return BitTest(Global_2621446, 3);
}

int func_338(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x2B117
{
	int iVar0;
...
void func_339(int iParam0)//Position - 0x2B14A
{
	if (iParam0 == 1)
	{
...
int func_340(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)//Position - 0x2B16D
{
	bool bVar0;
	float fVar1;
...
void func_341(int iParam0, bool bParam1)//Position - 0x2B1C9
{
...
Vector3 func_343(int iParam0)//Position - 0x2B3C3
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_344(bool bParam0)//Position - 0x2B3D6
{
	int iVar0;
...
void func_345(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x2B415
{
	func_346(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_346(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x2B43E
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_347(struct<3> Param0)//Position - 0x2B834
{
...
int func_348(int iParam0, int iParam1, bool bParam2)//Position - 0x2B85E
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_349(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2B8CC
{
...
int func_350(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x2B9A4
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_351(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x2BC9A
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_352(int iParam0)//Position - 0x2BD4E
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_353()//Position - 0x2BDB3
{
	int iVar0;
...
int func_354(int iParam0, float fParam1, int iParam2)//Position - 0x2BDD3
{
	int iVar0;
...
bool func_355()//Position - 0x2BEA7
{
	bool bVar0;
...
void func_356()//Position - 0x2BECA
{
	Global_20471 = 0;
	func_229();
}

void func_357()//Position - 0x2BEDA
{
...
int func_358(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2BF2B
{
...
void func_359(int iParam0)//Position - 0x2C0C4
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_360(char* sParam0, bool bParam1)//Position - 0x2C0F0
{
	func_344(bParam1);
...
void func_362()//Position - 0x2C179
{
	func_364(0);
	func_357();
	func_363();
...
void func_363()//Position - 0x2C18E
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_364(int iParam0)//Position - 0x2C1E6
{
	if (func_368())
	{
		return;
...
void func_365(int iParam0)//Position - 0x2C219
{
	if (func_368())
	{
		return;
...
void func_366(bool bParam0, bool bParam1)//Position - 0x2C2A3
{
	if (bParam0)
	{
		if (func_256(0))
...
bool func_367()//Position - 0x2C317
{
	return BitTest(Global_1958711, 5);
}

bool func_368()//Position - 0x2C325
{
	return BitTest(Global_1958711, 19);
}

void func_369(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2C334
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78573 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_371(Global_78574, Global_78576, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
float func_370(char* sParam0)//Position - 0x2C619
{
	HUD::_BEGIN_TEXT_COMMAND_GET_WIDTH(sParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(true);
}

struct<2> func_371(int iParam0, int iParam1, int iParam2)//Position - 0x2C62C
{
	struct<2> Var0;
	int iVar1;
...
char* func_372(int iParam0)//Position - 0x2C702
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_373(int iParam0)//Position - 0x2C855
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_374(int iParam0)//Position - 0x2C888
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_375(int iParam0)//Position - 0x2C8BB
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_376(int iParam0)//Position - 0x2C8EE
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_377(int iParam0)//Position - 0x2C921
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_378(int iParam0)//Position - 0x2C95E
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_379(int iParam0)//Position - 0x2C991
{
	struct<2> Var0;
...
int func_380(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2C9FA
{
	if (((!func_382(0) || Global_78588) || Global_78577 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78573)
...
bool func_381(bool bParam0)//Position - 0x2CB12
{
	if (bParam0)
	{
...
int func_382(int iParam0)//Position - 0x2CB3B
{
	if (Global_43052 == 15)
	{
		return 0;
...
bool func_383(int iParam0)//Position - 0x2CB5D
{
	return func_384(iParam0, Global_43052);
}

int func_384(int iParam0, int iParam1)//Position - 0x2CB6E
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_385(int iParam0)//Position - 0x2CD4F
{
	...
	{
		case 0:
			func_391(-1590.964f, 5211.717f, 3.0098f, 37.4745f, 0f, 0f, 0f, 0f, -1596.09f, 5218.102f, 3.045f, 125.5f, -1584.013f, 5158.539f, 18.6057f, 210.5309f);
			func_237(1);
			break;
		
		case 1:
			func_391(-1595.201f, 5217.495f, 3.0009f, 208.2675f, -1580.236f, 5169.585f, 18.5846f, 189.4926f, -1587.11f, 5204.18f, 3.02f, -143.87f, Local_57, fLocal_58);
			func_237(2);
			break;
		
		case 2:
			func_391(0f, 0f, 0f, 0f, -1580.236f, 5169.585f, 18.5846f, 189.4926f, 0f, 0f, 0f, 0f, Local_57, fLocal_58);
			func_237(2);
			break;
		
		case 3:
			func_391(0f, 0f, 0f, 0f, -973.0429f, -2405.925f, 19.1698f, 151.3282f, 0f, 0f, 0f, 0f, -982.942f, -2422.911f, 19.1683f, 148.0451f);
			iLocal_231 = 1;
			iLocal_237 = 7;
			func_237(2);
			break;
...
void func_386(int iParam0, int iParam1, int iParam2)//Position - 0x2CEE9
{
...
void func_388(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x2CFE1
{
	int iVar0;
	int iVar1;
...
void func_389()//Position - 0x2D051
{
	Global_23011.f_6 = 1;
}

bool func_390()//Position - 0x2D05F
{
...
int func_394(var uParam0, int iParam1)//Position - 0x2D222
{
	int iVar0;
...
void func_395(int* iParam0)//Position - 0x2D268
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_397(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2E0C0
{
	...
	if ((func_161(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		{
			func_401(iParam1, &(Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_113386.f_20118[iParam0 /*43*/].f_31 = func_400(*iParam1);
				...
				func_398(Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_113386.f_20118[iParam0 /*43*/].f_1));
				...
				func_398(Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_113386.f_20118[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_398(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x2ECD4
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_399(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x2ED47
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_400(int iParam0)//Position - 0x3023A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_401(int iParam0, var uParam1, var uParam2)//Position - 0x302EA
{
	int iVar0;
	int iVar1;
...
int func_402(int iParam0, bool bParam1, var uParam2)//Position - 0x304DD
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_430(iVar0, bParam1, uParam2) && !func_429(PLAYER::PLAYER_ID())) && !func_411(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_409(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
...
int func_403(int iParam0)//Position - 0x3064B
{
	int iVar0;
...
int func_404(int iParam0)//Position - 0x30686
{
	if (iParam0 != func_220())
	{
		if (func_249(iParam0, 1, 1))
		{
			...
			{
				return func_405(Global_2689235[iParam0 /*453*/].f_318.f_6) == 11;
			}
		}
	}
	return 0;
...
int func_405(int iParam0)//Position - 0x306CD
{
	switch (iParam0)
	{
		case 0:
...
int func_406(int iParam0)//Position - 0x30B54
{
...
int func_407(int iParam0)//Position - 0x30B96
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_408(int iParam0)//Position - 0x30C39
{
	if (iParam0 != func_220())
	{
		if (func_249(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1)
			{
				return func_405(Global_2689235[iParam0 /*453*/].f_318.f_6) == 13;
			}
		}
	}
	return 0;
...
int func_409(int iParam0)//Position - 0x30C80
{
	if (iParam0 != func_220())
	{
		if (func_249(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1)
			{
				return func_405(Global_2689235[iParam0 /*453*/].f_318.f_6) == 7;
			}
		}
	}
	return 0;
...
int func_410(int iParam0)//Position - 0x30CC6
{
	return 1;
}

int func_411(int iParam0)//Position - 0x30CCF
{
...
int func_412(int iParam0)//Position - 0x30CFE
{
...
int func_413(int iParam0)//Position - 0x30D6E
{
	int iVar0;
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_407(iParam0)) || func_414(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_414(int iParam0)//Position - 0x30DF1
{
	switch (iParam0)
	{
		case joaat("mule"):
...
int func_415(int iParam0, bool bParam1)//Position - 0x30E41
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_417(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				if (Global_2815059.f_303 == iParam0)
				{
					return 1;
				}
				else if (func_416(iParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_416(int iParam0)//Position - 0x30E9C
{
	int iVar0;
...
int func_417(int iParam0, int iParam1)//Position - 0x30ED5
{
	if (iParam1 == 0)
	{
...
int func_427(int iParam0)//Position - 0x317BB
{
	if (iParam0 != func_220())
	{
		if (func_249(iParam0, 1, 1))
		{
			...
			{
				return func_405(Global_2689235[iParam0 /*453*/].f_318.f_6) == 5;
			}
		}
	}
	return 0;
...
int func_428(int iParam0)//Position - 0x3181A
{
	if (iParam0 != func_220())
	{
		if (func_249(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1 && Global_2689235[iParam0 /*453*/].f_318.f_9 != func_220())
			{
				return func_405(Global_2689235[iParam0 /*453*/].f_318.f_6) == 8;
			}
		}
	}
	return 0;
...
int func_429(int iParam0)//Position - 0x3187A
{
	if (iParam0 != func_220())
	{
		if (func_249(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1)
			{
				return func_405(Global_2689235[iParam0 /*453*/].f_318.f_6) == 9;
			}
		}
	}
	return 0;
...
int func_430(int iParam0, bool bParam1, var uParam2)//Position - 0x318C1
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_409(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_431(int iParam0)//Position - 0x31D0D
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_432(int iParam0, int iParam1)//Position - 0x31D36
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_433(iParam0, &(Global_113386.f_32749.f_5510));
}

void func_433(int iParam0, var uParam1)//Position - 0x31F38
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		if (uParam1->f_65 == -1 && !func_435(uParam1->f_66))
		{
			uParam1->f_65 = 0;
		}
...
int func_434(int iParam0)//Position - 0x321E3
{
	switch (iParam0)
	{
		case 1:
...
int func_435(int iParam0)//Position - 0x32293
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_436(int iParam0)//Position - 0x322B3
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_348(iParam0, 0, 0)) || func_348(iParam0, 1, 0)) || func_348(iParam0, 2, 0)) || func_450(iParam0) != 145) || func_449(iParam0)) || func_448(iParam0)) || func_403(iParam0)) || func_447(iParam0)) || !func_437(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_448(iParam0))
		{
		}
...
int func_437(int iParam0)//Position - 0x32390
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_438(int iParam0, bool bParam1)//Position - 0x32541
{
	int iVar0;
	struct<2> Var1;
...
int func_439(int iParam0)//Position - 0x326C1
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_441(int iParam0)//Position - 0x327A4
{
	int iVar0;
	int iVar1;
...
int func_442()//Position - 0x35A75
{
	return 0;
}

int func_443()//Position - 0x35A7E
{
	return 1;
}

int func_444()//Position - 0x35A87
{
	return 1;
}

int func_445()//Position - 0x35A90
{
...
int func_447(int iParam0)//Position - 0x35B61
{
	int iVar0;
	char* sVar1;
...
int func_448(int iParam0)//Position - 0x35BA7
{
	int iVar0;
...
int func_449(int iParam0)//Position - 0x35C23
{
	int iVar0;
...
int func_450(int iParam0)//Position - 0x35D0B
{
	int iVar0;
...
void func_451(int iParam0, int iParam1)//Position - 0x35D6E
{
	int iVar0;
...
void func_452(var uParam0)//Position - 0x35DF0
{
	if (!func_453(*uParam0))
	{
...
bool func_453(int iParam0)//Position - 0x35E1B
{
...
int func_454(var uParam0, var uParam1, var uParam2)//Position - 0x35E2A
{
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*uParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_458(*uParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_426(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_457(*uParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_457(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_456(uParam0);
	if (func_455(*uParam0))
	{
...
int func_455(int iParam0)//Position - 0x36004
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_456(var uParam0)//Position - 0x360E0
{
...
int func_457(int iParam0, int iParam1)//Position - 0x36137
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_458(int iParam0, int iParam1, int iParam2)//Position - 0x3621C
{
	if (!func_459() && VEHICLE::_IS_VEHICLE_MOD_HSW_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_459()//Position - 0x36240
{
	return 0;
}

int func_460(var uParam0, int iParam1)//Position - 0x36249
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_461(int iParam0, var uParam1, int iParam2)//Position - 0x3628A
{
	int iVar0;
...
void func_463(bool bParam0, int iParam1, int iParam2)//Position - 0x36519
{
	bool bVar0;
...
int func_468(int iParam0)//Position - 0x36689
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_469(int iParam0)//Position - 0x366AA
{
	...
	func_395(&iLocal_56);
	func_353();
	func_479(&uLocal_65, 3);
	func_470(&Local_54, 0, 0, 0);
...
void func_470(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x36717
{
...
void func_471(var uParam0, bool bParam1)//Position - 0x36737
{
	func_472(&(uParam0->f_41), bParam1);
}

void func_472(var uParam0, bool bParam1)//Position - 0x36749
{
	int iVar0;
...
void func_473(int* iParam0, bool bParam1)//Position - 0x36787
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_474(int* iParam0)//Position - 0x367C2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_475(var uParam0, bool bParam1)//Position - 0x367ED
{
	func_476(&(uParam0->f_35), bParam1);
}

void func_476(var uParam0, bool bParam1)//Position - 0x367FF
{
	int iVar0;
...
void func_477(var uParam0, int iParam1)//Position - 0x3683C
{
	func_478(&(uParam0->f_28), iParam1);
}

void func_478(var uParam0, int iParam1)//Position - 0x3684E
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_480(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_479(var uParam0, int iParam1)//Position - 0x3688F
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_480(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x368AC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
int func_483(char* sParam0, int iParam1, int iParam2)//Position - 0x369F4
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
...
int func_484(char* sParam0)//Position - 0x36B83
{
...
int func_486(char* sParam0, bool bParam1)//Position - 0x36BFD
{
	int iVar0;
	int iVar1;
...
int func_487(int iParam0, bool bParam1)//Position - 0x36C27
{
	int iVar0;
...
void func_490(bool bParam0)//Position - 0x36D19
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_491(int iParam0)//Position - 0x36D2D
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_492(int iParam0)//Position - 0x36D67
{
	if (iParam0 == 1)
	{
...
void func_493()//Position - 0x36DA1
{
	Global_23011.f_5 = 1;
}

void func_494()//Position - 0x36DAF
{
	Global_23011.f_5 = 0;
}

void func_495(bool bParam0)//Position - 0x36DBD
{
	if (bParam0)
	{
		func_496();
...
void func_496()//Position - 0x36E20
{
...
void func_497()//Position - 0x36E49
{
	Global_94617 = 0;
	Global_94618 = 0;
}

int func_498()//Position - 0x36E5B
{
...
void func_499()//Position - 0x36E99
{
	Global_100476 = 1;
...
void func_500(char* sParam0)//Position - 0x36F86
{
...
void func_501(var uParam0)//Position - 0x36F98
{
...
void func_502(var uParam0)//Position - 0x36FB8
{
	int iVar0;
...
int func_503(int iParam0)//Position - 0x36FF2
{
	if (!func_161(iParam0))
	{
		return func_160(iParam0);
