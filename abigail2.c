...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		func_369(Local_54.f_9, 0, 0, 0, 0, 0);
...
void func_9()//Position - 0x47B
{
	switch (iLocal_60)
	{
		...
		case 1:
			...
			else if (func_235(PLAYER::PLAYER_PED_ID(), iLocal_61) > 250f)
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) == 0)
				{
					iLocal_60 = 2;
			...
			{
				if (!func_233(iLocal_61, joaat("SCRIPT_TASK_SMART_FLEE_PED")))
				{
					TASK::TASK_SMART_FLEE_PED(iLocal_61, PLAYER::PLAYER_PED_ID(), 250f, -1, false, false);
				}
				if (iLocal_230 == 0)
				{
					if (((!func_232() && func_231(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_61)) && func_214(&uLocal_65, "SONARAU", "SONAR_SHOOTS", 7, 0, 0, 0))
					{
						iLocal_230 = 1;
					}
				}
				else if (((((iLocal_238 < 15 && !func_232()) && (MISC::GET_GAME_TIMER() - iLocal_235) > 10000) && func_231(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_61)) && func_214(&uLocal_65, "SONARAU", "SONAR_CHASE", 7, 0, 0, 0))
				{
...
int func_40(int iParam0, int iParam1, int iParam2)//Position - 0x187E
{
	...
	else
	{
		...
		Global_78341[1 /*14*/] = { func_92(iVar0, iParam1, uVar6[iParam1], -1) };
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1B02
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_92(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_92(iVar10, 14, uVar15[iVar1], -1) };
			func_59(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_75(14);
			if (Global_78339 == 1)
			{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x48BB
{
	...
	else
	{
		...
		iVar4 = (iParam1 - func_62(iParam0, func_84(iParam2)));
		if (iVar4 < 0)
		{
			return -1;
		}
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_84(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5017
{
	...
	else
	{
		...
		if (iVar4 != -1)
		{
			return (func_62(iParam0, func_84(iParam2)) + iVar4);
		}
	}
	return -99;
}
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.f_0 != 0 && Var2.f_0 != -1) && Var2.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_90(Var2.f_2)] = func_66(iParam1, Var2.f_0, func_90(Var2.f_2), iVar0);
					}
				}
				else if (Var2.f_1 != -1)
				{
...
void func_94(int iParam0)//Position - 0xC36F
{
	...
	func_95(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE663
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_95(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_95(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_84(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_169(int iParam0, bool bParam1, bool bParam2)//Position - 0x2034A
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&sVar1, {func_166(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&sVar1, 0, Global_100718, 0);
		func_170(&sVar1, Var0.f_3, Global_100718, bParam1, bParam2);
	}
}
...
void func_172(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0x21582
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
void func_240(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x277AF
{
...
void func_241(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x277E7
{
	int iVar0;
	int iVar1;
...
void func_257(var uParam0, int iParam1, struct<3> Param2, int iParam3)//Position - 0x281D5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_260(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x28310
{
	if (bParam2)
	{
...
{
	if (!HUD::DOES_BLIP_EXIST(iLocal_62) && func_472(iLocal_61))
	{
		iLocal_62 = func_269(iLocal_61, 1, 0, 5);
	}
...
void func_270()//Position - 0x2891C
{
	switch (iLocal_60)
	{
		...
		case 1:
			...
			{
				if (((iLocal_232 == 0 && !func_232()) && func_231(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_214(&uLocal_65, "SONARAU", "SONAR_ARRIVE", 7, 0, 0, 0))
				{
					iLocal_232 = 1;
					func_268();
				}
				if (func_235(PLAYER::PLAYER_PED_ID(), iLocal_61) > 250f)
				{
					iLocal_60 = 2;
				}
			}
			if ((iLocal_233 == 0 && iLocal_232 == 1) && !func_232())
			{
				if (func_472(iLocal_61))
				{
	...
	switch (iLocal_60)
	{
		...
		case 1:
			...
			else
			{
				...
				if (iLocal_231 == 0)
				{
					if (((func_472(iLocal_56) && PED::IS_PED_IN_VEHICLE(iLocal_61, iLocal_56, true)) && func_231(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_214(&uLocal_65, "SONARAU", "SONAR_INCAR", 7, 0, 0, 0))
					{
						iLocal_231 = 1;
					}
					if (((((iLocal_237 < 7 && !func_232()) && (MISC::GET_GAME_TIMER() - iLocal_234) > 10000) && func_231(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_61)) && func_214(&uLocal_65, "SONARAU", "SONAR_FOLLOW", 7, 0, 0, 0))
					{
						iLocal_234 = MISC::GET_GAME_TIMER();
						iLocal_237++;
					}
...
int func_277()//Position - 0x28EC3
{
	...
	if (func_472(iLocal_56))
	{
		if (func_278(iLocal_61, 1, 1116471296, 1126825984, 0, 0, 0, 0))
		{
			return 1;
		}
...
bool func_281(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x290C7
{
	...
	iVar2 = func_289(iParam0, iParam1);
	if (!func_472(iParam0) || !func_472(iParam1))
	{
		if (iVar2 != -1)
		{
			func_288(&(Local_35[iVar2 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_282(&(Local_35[iVar2 /*4*/]), Var1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar2 /*4*/].f_3) < iParam4);
}

int func_282(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x29188
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_285(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x293C3
{
	...
	{
		Var1 = { func_287(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_286(Var1, Var0);
...
float func_286(struct<3> Param0, struct<3> Param1)//Position - 0x29454
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_295(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0x29819
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
void func_298()//Position - 0x2999B
{
	if (func_472(iLocal_61))
	{
		...
		func_299(&uLocal_65, 3, iLocal_61, "ABIGAIL", 0, 1);
		...
		case 1:
			switch (iLocal_241)
			{
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("ABIGAIL", func_507(16)) && func_472(iLocal_61))
						{
					...
					else
					{
						...
						if (iLocal_240 == 1)
						{
							if (func_472(iLocal_61))
							{
								...
								func_340(iLocal_61, -1587.11f, 5204.18f, 3.02f, 210.9196f, 0, 1);
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_61, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 40000f);
...
int func_340(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)//Position - 0x2B43B
{
	bool bVar0;
	float fVar1;
...
void func_342(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x2B4D3
{
	int iVar0;
...
void func_345(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x2B6E3
{
	func_346(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_346(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x2B70C
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_350(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x2BC72
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_351(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x2BF68
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_361()//Position - 0x2C3D4
{
	...
	if ((!func_232() && HUD::HAS_ADDITIONAL_TEXT_LOADED(0)) && STREAMING::HAS_MODEL_LOADED(iLocal_55))
	{
		PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.1f);
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_55, true);
		if (func_472(Local_54.f_35[0]))
		{
...
void func_369(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2C602
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_371(Global_78814, Global_78816, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_372(iVar1), 8);
					break;
			}
			break;
...
void func_388(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x2D2AF
{
	int iVar0;
	int iVar1;
...
void func_391(struct<3> Param0, float fParam1, struct<3> Param2, float fParam3, struct<3> Param4, float fParam5, struct<3> Param6, float fParam7)//Position - 0x2D33E
{
	int* iVar0;
	...
	{
		func_340(PLAYER::PLAYER_PED_ID(), Param0, fParam1, 0, 1);
	}
	STREAMING::REQUEST_MODEL(iLocal_55);
...
int func_392(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0x2D406
{
...
int func_393(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0x2D462
{
	int iVar0;
...
int func_396(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)//Position - 0x2D56E
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2.f_0, Param2, fParam3, true, true, false);
				...
				func_457(iParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
int func_398(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x2EFA2
{
	...
	iVar0 = 0;
	while (func_399(iVar0, &sVar2, &iVar1, &iVar3, &iVar4))
	{
...
void func_468(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x36D77
{
	if (func_470())
	{
...
void func_473(int iParam0)//Position - 0x36EA9
{
	...
	func_395(&iLocal_56);
	func_353();
	func_483(&uLocal_65, 3);
	func_474(&Local_54, 0, 0, 0);
