...
int func_2()//Position - 0x10E
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_89))
	{
		if (!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_86))
		{
			Var0 = { Vector(32.856f, 3819.65f, 1971.62f) - Local_82 };
			iLocal_86 = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD(&cLocal_89, Local_82 + Var0, 0f, 0f, 0f, 1f, false, false, false, false);
		}
	}
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &sLocal_142, &cLocal_158, 2))
		{
			fVar3 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_98993);
			switch (iLocal_223)
			{
				case 0:
					if (fLocal_140 < 0f)
					...
					if (fVar3 > fLocal_140)
					{
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_71) || iLocal_88 != -1)
						{
							if (GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE(&cLocal_105, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 0f, 0f, 0f, iLocal_88, 1f, false, false, false))
							{
								if (MISC::ARE_STRINGS_EQUAL(&cLocal_105, "scr_meth_pipe_smoke"))
								{
									func_17(PLAYER::PLAYER_PED_ID(), 0, 1, 0, -1);
								}
								iLocal_222 = AUDIO::GET_SOUND_ID();
								AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_222, &cLocal_206, PLAYER::PLAYER_PED_ID(), &cLocal_190, false, 0);
								iLocal_223++;
							}
						}
						else if (GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY(&cLocal_105, iLocal_71, 0f, 0f, -1f, 0f, 0f, 0f, 1f, false, false, false))
						{
							if (MISC::ARE_STRINGS_EQUAL(&cLocal_105, "scr_meth_pipe_smoke"))
							{
								func_17(PLAYER::PLAYER_PED_ID(), 0, 1, 0, -1);
				...
				case 2:
					if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_121))
					{
						if (GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD(&cLocal_121, Local_82 + Local_137, 0f, 0f, 0f, 1f, false, false, false))
						{
							iLocal_223++;
						}
					}
			...
			{
				if (ENTITY::IS_ENTITY_ATTACHED(iLocal_71))
				{
					if (iLocal_81 != -1)
					{
						if (fVar3 > fLocal_80)
						{
							func_3(&iLocal_71, iLocal_81);
						}
					}
				}
			}
			...
			*iParam0 = OBJECT::CREATE_OBJECT(iVar34, Var27, true, true, false);
			...
			if (func_6(iVar0, &sVar35, &cVar51, &iVar67))
			{
				if (func_4(iVar0, &sVar68, &cVar84, &cVar100, &uVar116, &uVar117))
				{
					...
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(*iParam0, Global_98993, &sVar35, &sVar68, 1000f, -8f, iVar67, 1000f);
					}
				}
			}
...
void func_17(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x2671
{
	...
	Global_45365 = 0.25f;
	StringCopy(&Global_45366, func_23(iParam3), 16);
...
int func_21(int iParam0, int iParam1, int iParam2)//Position - 0x28B2
{
...
int func_34(int iParam0)//Position - 0x2CF0
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_37()//Position - 0x2D9D
{
	if (!iLocal_72 == 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_71))
		{
			...
			{
				iLocal_71 = OBJECT::CREATE_OBJECT(iLocal_72, Local_82, true, true, false);
				ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), iLocal_79), Local_73, Local_76, false, false, false, false, 2, true, 0);
			}
			else
			{
				iLocal_71 = OBJECT::CREATE_OBJECT(iLocal_72, Local_82 + Local_73, true, true, false);
				ENTITY::SET_ENTITY_COORDS(iLocal_71, Local_82 + Local_73, true, false, false, true);
				ENTITY::SET_ENTITY_ROTATION(iLocal_71, Vector(uLocal_85, 0f, 0f) + Local_76, 2, true);
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_71, true);
			}
		}
	}
	if (!func_38())
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_71))
		{
			if (iLocal_79 != -1)
			{
				if (!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID()))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), iLocal_79), Local_73, Local_76, false, false, false, false, 2, true, 0);
				}
			}
...
bool func_41(var uParam0, var uParam1)//Position - 0x2FDA
{
...
void func_43()//Position - 0x302F
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_46(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_44(iVar0) && (!func_48(14) || Global_113083))
			{
...
bool func_44(int iParam0)//Position - 0x312C
{
	return iParam0 < 3;
}

int func_45(int iParam0)//Position - 0x3138
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x3175
{
	if (func_44(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x319A
{
...
void func_53()//Position - 0x3224
{
	...
	while (!bVar1 && iVar0 < 400)
	{
		...
		{
			if (!AUDIO::REQUEST_AMBIENT_AUDIO_BANK(&cLocal_174, false, -1))
			{
				bVar1 = false;
			}
		}
...
void func_54()//Position - 0x3375
{
	...
	func_58(iLocal_69, &Local_82, &uLocal_85, &cVar0);
	switch (iLocal_69)
	{
		case 273:
		case 274:
			StringCopy(&cLocal_174, "TREVOR_PUKEINTOFOUNT", 64);
			StringCopy(&cLocal_190, "TREVOR_PUKEINTOFOUNT_SOUNDS", 64);
			StringCopy(&cLocal_206, "Puke", 64);
			fLocal_140 = 0.19f;
			fLocal_141 = 0.33f;
			iLocal_88 = 31086;
			StringCopy(&cLocal_89, "", 64);
			StringCopy(&cLocal_105, "scr_trev_amb_puke", 64);
			StringCopy(&cLocal_121, "scr_pts_vomit_water", 64);
			if (iLocal_69 == 273)
			{
				Local_137 = { Vector((34.97325f + 0.25f), -441.7662f, -118.32176f) - Local_82 };
			}
			else if (iLocal_69 == 274)
			{
				Local_137 = { 0.125f, -1.1486f, (0.0588f + 0.1f) };
			}
			else
			{
				Local_137 = { -0.125f, 1.1486f, -0.0588f };
			}
			break;
		
		case 245:
		case 40:
			StringCopy(&cLocal_174, "", 64);
			StringCopy(&cLocal_190, "", 64);
			StringCopy(&cLocal_206, "", 64);
			fLocal_140 = 0.19f;
			fLocal_141 = 0.47f;
			iLocal_88 = 31086;
			StringCopy(&cLocal_89, "", 64);
			StringCopy(&cLocal_105, "scr_meth_pipe_smoke", 64);
			StringCopy(&cLocal_121, "", 64);
			break;
		...
		case 310:
			...
			iLocal_88 = -1;
			StringCopy(&cLocal_89, "", 64);
			StringCopy(&cLocal_105, "scr_pts_digging", 64);
			StringCopy(&cLocal_121, "", 64);
			iLocal_72 = joaat("prop_tool_shovel");
			Local_73 = { 0f, 0f, -0.045f };
			Local_76 = { 0f, 180f, 0f };
			iLocal_79 = 28422;
			fLocal_80 = 0.7f;
			iLocal_81 = 0;
		...
		case 311:
			...
			fLocal_141 = 0.55f;
			iLocal_88 = 52301;
			StringCopy(&cLocal_89, "scr_pts_flush", 64);
			StringCopy(&cLocal_105, "scr_pts_footsplash", 64);
			StringCopy(&cLocal_121, "", 64);
			break;
		...
		case 315:
			...
			iLocal_88 = 31086;
			StringCopy(&cLocal_89, "", 64);
			StringCopy(&cLocal_105, "scr_pts_headsplash_trev", 64);
			StringCopy(&cLocal_121, "", 64);
			iLocal_72 = joaat("prop_cs_sink_filler_02");
			Local_73 = { -0.54f, 0.08f, -0.13f };
			Local_76 = { 0f, 0f, -12f };
			iLocal_79 = -1;
			fLocal_80 = 0.7f;
			iLocal_81 = -1;
		...
		case 124:
			...
			iLocal_88 = 60309;
			StringCopy(&cLocal_89, "", 64);
			StringCopy(&cLocal_105, "scr_pts_headsplash", 64);
			StringCopy(&cLocal_121, "", 64);
			iLocal_72 = joaat("prop_cs_sink_filler_03");
			Local_73 = { -0.72f, 0.9f, 0.21f };
			Local_76 = { 0f, 0f, 9f };
			iLocal_79 = -1;
			fLocal_80 = 0.7f;
			iLocal_81 = -1;
	...
	func_55(Var8, &Var117);
	func_4(iLocal_69, &sLocal_142, &cVar237, &cLocal_158, &uVar253, &uVar254);
}

int func_55(struct<109> Param0, var uParam109)//Position - 0x370C
{
	uParam109->f_119 = 0;
	switch (Param0.f_2)
	{
		...
		case 80:
			*uParam109 = { Param0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 17, joaat("SCRIPT_TASK_PLAY_ANIM"), joaat("SCRIPT_TASK_PLAY_ANIM"), Vector(2.6407f, 8.164f, -14.1564f) + Vector(-1f, 0.03f, -2.16f), (-66f + -56f));
			if (Param0.f_2 == 80)
			{
				func_57(uParam109);
			}
...
void func_56(var uParam0, int iParam1, int iParam2, int iParam3, struct<3> Param4, float fParam7)//Position - 0x6A87
{
...
bool func_60(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6D7A
{
	if (bParam6)
	{
...
int func_61(int iParam0, var uParam1, char* sParam2)//Position - 0x6DC1
{
	struct<3> Var0;
	int iVar3;
	var uVar4;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114135.f_2367.f_539.f_2310[0];
			StringCopy(sParam2, func_65(Global_114135.f_2367.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_114135.f_2367.f_539.f_2310[1];
			StringCopy(sParam2, func_65(Global_114135.f_2367.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_114135.f_2367.f_539.f_2310[2];
			StringCopy(sParam2, func_65(Global_114135.f_2367.f_539.f_2314[2]), 32);
			return 1;
			break;
...
int func_62(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x92CB
{
	switch (iParam1)
	{
		case 0:
...
int func_64(int iParam0, var uParam1, var uParam2)//Position - 0xB236
{
	switch (iParam0)
	{
		case 11:
