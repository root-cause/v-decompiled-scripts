...
int func_145(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xA976
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
...
bool func_146(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0xAD10
{
	if (bParam2)
	{
