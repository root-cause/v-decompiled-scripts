...
int func_82(int iParam0)//Position - 0x2157
{
	if (iParam0 != func_53())
	{
		if (func_54(iParam0, 1, 1))
		{
			...
			{
				return func_83(Global_2689235[iParam0 /*453*/].f_318.f_6) == 15;
			}
		}
	}
	return 0;
...
void func_84()//Position - 0x2625
{
	func_86(&uLocal_109);
	func_85();
}

void func_85()//Position - 0x2637
{
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_86(var uParam0)//Position - 0x2643
{
	int iVar0;
...
void func_87(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x26A2
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_96(PLAYER::PLAYER_ID(), 0) && !func_95()))
				{
...
bool func_88(int iParam0)//Position - 0x2B30
{
	return iParam0 == 17;
}

void func_89()//Position - 0x2B3D
{
	struct<3> Var0;
...
int func_91(int iParam0)//Position - 0x2BC8
{
	int iVar0;
...
void func_92(bool bParam0, int iParam1, int iParam2)//Position - 0x2BF9
{
	int iVar0;
	int iVar1;
...
void func_93(int iParam0, bool bParam1)//Position - 0x2CC9
{
	int iVar0;
...
bool func_95()//Position - 0x2D3D
{
	return BitTest(Global_2621446, 3);
}

bool func_96(int iParam0, int iParam1)//Position - 0x2D4B
{
	bool bVar0;
...
int func_97(int iParam0, bool bParam1)//Position - 0x2D96
{
	int iVar0;
	int iVar1;
...
int func_98()//Position - 0x2DD7
{
	return Global_1574918;
}

int func_99()//Position - 0x2DE3
{
...
{
	NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, func_111());
	func_109(0, -1, 0);
	func_108();
	func_101();
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_101()//Position - 0x2E45
{
	func_102(0, &uLocal_109, 0, 3);
	func_102(1, &uLocal_109, 1, 3);
	func_102(2, &uLocal_109, 2, 3);
	func_102(3, &uLocal_109, 3, 1);
	func_102(4, &uLocal_109, 4, 1);
	func_102(5, &uLocal_109, 5, 1);
	func_102(6, &uLocal_109, 6, 1);
	func_102(7, &uLocal_109, 7, 1);
	func_102(8, &uLocal_109, 8, 1);
	func_102(9, &uLocal_109, 9, 1);
	func_102(10, &uLocal_109, 10, 1);
	func_102(11, &uLocal_109, 11, 1);
	func_102(12, &uLocal_109, 12, 1);
	func_102(13, &uLocal_109, 13, 1);
	func_102(14, &uLocal_109, 14, 1);
	func_102(15, &uLocal_109, 15, 1);
	func_102(16, &uLocal_109, 16, 1);
	func_102(17, &uLocal_109, 17, 1);
	func_102(18, &uLocal_109, 18, 1);
	func_102(19, &uLocal_109, 19, 1);
}

void func_102(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2F19
{
	struct<3> Var0;
	float fVar1;
...
Vector3 func_103()//Position - 0x2FAA
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_104(struct<3> Param0, float fParam1)//Position - 0x2FBD
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
float func_105(int iParam0, float fParam1)//Position - 0x3001
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_106()//Position - 0x303A
{
	return -0.5f, -0.5f, 0f;
}
...
void func_108()//Position - 0x360D
{
}

int func_109(int iParam0, int iParam1, bool bParam2)//Position - 0x3615
{
	int iVar0;
...
bool func_110(bool bParam0)//Position - 0x372B
{
	if (bParam0)
	{
	}
