...
void func_1(var uParam0)//Position - 0xB3
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			...
			{
				if ((((((((((((func_55(uParam0) || func_51(uParam0)) || func_50(uParam0)) || !func_49(uParam0)) || func_47(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) || BitTest(Global_1950108.f_4, 2)) || func_46(uParam0->f_16[uParam0->f_9 /*14*/].f_13))
				{
				...
				else
				{
					...
					if (uParam0->f_6 == -1)
					{
						...
						{
							if (func_41(uParam0->f_9) && !Global_262145.f_27071 /* Tunable: VC_PENTHOUSE_DISABLE_DCTL */)
							{
...
int func_82(int iParam0)//Position - 0x2157
{
	if (iParam0 != func_53())
	{
		if (func_54(iParam0, 1, 1))
		{
			...
			{
				return func_83(Global_2657589[iParam0 /*466*/].f_321.f_7) == 15;
			}
		}
	}
	return 0;
...
bool func_88(int iParam0)//Position - 0x2B5D
{
	return iParam0 == 17;
}

void func_89()//Position - 0x2B6A
{
	struct<3> Var0;
...
void func_92(bool bParam0, int iParam1, int iParam2)//Position - 0x2C26
{
	int iVar0;
	int iVar1;
...
void func_93(int iParam0, bool bParam1)//Position - 0x2CF6
{
	int iVar0;
...
bool func_95()//Position - 0x2D6A
{
	return BitTest(Global_2621446, 3);
}

bool func_96(int iParam0, int iParam1)//Position - 0x2D78
{
	bool bVar0;
...
int func_97(int iParam0, bool bParam1)//Position - 0x2DC3
{
	int iVar0;
	int iVar1;
...
int func_98()//Position - 0x2E04
{
	return Global_1574918;
}

int func_99()//Position - 0x2E10
{
...
void func_101()//Position - 0x2E72
{
	func_102(0, &uLocal_111, 0, 3);
	func_102(1, &uLocal_111, 1, 3);
	func_102(2, &uLocal_111, 2, 3);
	func_102(3, &uLocal_111, 3, 1);
	func_102(4, &uLocal_111, 4, 1);
	func_102(5, &uLocal_111, 5, 1);
	func_102(6, &uLocal_111, 6, 1);
	func_102(7, &uLocal_111, 7, 1);
	func_102(8, &uLocal_111, 8, 1);
	func_102(9, &uLocal_111, 9, 1);
	func_102(10, &uLocal_111, 10, 1);
	func_102(11, &uLocal_111, 11, 1);
	func_102(12, &uLocal_111, 12, 1);
	func_102(13, &uLocal_111, 13, 1);
	func_102(14, &uLocal_111, 14, 1);
	func_102(15, &uLocal_111, 15, 1);
	func_102(16, &uLocal_111, 16, 1);
	func_102(17, &uLocal_111, 17, 1);
	func_102(18, &uLocal_111, 18, 1);
	func_102(19, &uLocal_111, 19, 1);
}

void func_102(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2F46
{
	struct<3> Var0;
	float fVar3;
...
Vector3 func_103()//Position - 0x2FD7
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_104(struct<3> Param0, float fParam3)//Position - 0x2FEA
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
float func_105(int iParam0, float fParam1)//Position - 0x302E
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_106()//Position - 0x3067
{
	return -0.5f, -0.5f, 0f;
}

void func_107(int iParam0, var uParam1, var uParam2)//Position - 0x307A
{
	if (func_4())
	{
		switch (iParam0)
...
void func_108()//Position - 0x363A
{
}

int func_109(int iParam0, int iParam1, bool bParam2)//Position - 0x3642
{
	int iVar0;
...
bool func_110(bool bParam0)//Position - 0x3758
{
	if (bParam0)
	{
	}
