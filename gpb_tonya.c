...
void __EntryFunction__()//Position - 0x0
{
	...
	if (MISC::GET_GAME_TIMER() < Global_32428 + 10000 && !func_107())
	{
		func_115(0);
	}
		...
		switch (iLocal_216)
		{
			...
			case 8:
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_52(Global_113593[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_208, &Local_253, &Local_252));
					}
				}
				break;
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_266))
				{
					if (bLocal_329)
					{
						Global_113593[iLocal_217] = uLocal_328;
					}
					else
					{
...
int func_75(int iParam0)//Position - 0x2A7C
{
	if (func_77(iParam0))
	{
		return BitTest(Global_113648.f_26436.f_2, iParam0);
	}
	return 0;
}
...
int func_76(int iParam0)//Position - 0x2AA0
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		return BitTest(Global_113648.f_26436.f_2, iVar0);
	}
	return 0;
}
...
{
	if (BitTest(Global_113648.f_18576[58 /*6*/], 0) && !BitTest(Global_113648.f_18576[58 /*6*/], 3))
	{
		return 1;
	}
	return 0;
...
{
	if (BitTest(Global_113648.f_18576[60 /*6*/], 0) && !BitTest(Global_113648.f_18576[60 /*6*/], 3))
	{
		return 0;
	}
	if (BitTest(Global_113648.f_18576[61 /*6*/], 0) && !BitTest(Global_113648.f_18576[61 /*6*/], 3))
	{
		return 0;
	}
	if (BitTest(Global_113648.f_18576[62 /*6*/], 3))
	{
		return 0;
	}
	if ((BitTest(Global_113648.f_18576[58 /*6*/], 2) || BitTest(Global_113648.f_18576[59 /*6*/], 2)) || BitTest(Global_113648.f_18576[62 /*6*/], 2))
	{
		return 1;
	}
	return 0;
...
{
	return func_113(Global_113648.f_20119, uParam0);
}
