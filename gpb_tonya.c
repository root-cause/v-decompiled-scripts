...
void __EntryFunction__()//Position - 0x0
{
	...
	if (MISC::GET_GAME_TIMER() < Global_33352 + 10000 && !func_107())
	{
		func_115(0);
	}
		...
		switch (iLocal_248)
		{
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_435))
				{
					if (bLocal_501)
					{
						Global_114080[iLocal_249] = uLocal_500;
					}
					else
					{
...
bool func_19(int iParam0)//Position - 0x173A
{
	return iParam0 < 3;
}

int func_20(int iParam0)//Position - 0x1746
{
	int iVar0;
	int iVar1;
...
int func_21(int iParam0)//Position - 0x1783
{
	if (func_19(iParam0))
	{
...
var func_22(int iParam0)//Position - 0x17A8
{
...
bool func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B17
{
...
var func_38(int iParam0, int iParam1)//Position - 0x1EDD
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_39()//Position - 0x1EF5
{
	return -1;
}
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21B3
{
...
void func_48(char[4] cParam0)//Position - 0x2209
{
	int iVar0;
...
void func_49(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2244
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_51(var uParam0)//Position - 0x2317
{
}

void func_52(var uParam0, int iParam1, float fParam2)//Position - 0x231F
{
}
...
void func_55(var uParam0)//Position - 0x23AC
{
}

void func_56(char* sParam0)//Position - 0x23B4
{
...
void func_70(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x264D
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x2936
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0)//Position - 0x2A7C
{
	if (func_77(iParam0))
	{
...
int func_76(int iParam0)//Position - 0x2AA0
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x2AD0
{
...
void func_79(int* iParam0)//Position - 0x2BB8
{
	if (iLocal_445 == 1)
	{
...
void func_80(int* iParam0, int iParam1, bool bParam2)//Position - 0x2BD7
{
	if (iLocal_445 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_81(int iParam0, bool bParam1, int iParam2)//Position - 0x2C2A
{
	int iVar0;
...
int func_82(int iParam0, bool bParam1, bool bParam2)//Position - 0x2C74
{
	int iVar0;
...
float func_83(bool bParam0, float fParam1, float fParam2)//Position - 0x2D18
{
	if (bParam0)
	{
		return fParam1;
...
float func_84(int iParam0, int iParam1, bool bParam2)//Position - 0x2D2F
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_85(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2D8D
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_86(struct<3> Param0, struct<3> Param3)//Position - 0x2E1E
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_87(struct<3> Param0)//Position - 0x2E3F
{
	float fVar0;
	float fVar1;
...
int func_88(int iParam0)//Position - 0x2E7E
{
	var uVar0;
...
int func_95()//Position - 0x2F14
{
	return 1;
}

float func_96(int iParam0, int iParam1)//Position - 0x2F1D
{
...
void func_100(var uParam0, var uParam1)//Position - 0x3043
{
...
int func_102(int iParam0)//Position - 0x30C6
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_105()//Position - 0x30FB
{
	...
	StringCopy(&Local_232, "TOW", 8);
	StringCopy(&Local_234, "TONYA", 16);
	...
	{
		sLocal_301 = "PBTS_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to Tonya. */;
	}
	StringCopy(&Local_310, "TONYA_MIC", 16);
	StringCopy(&Local_314, "TONYA_TRE", 16);
	StringCopy(&Local_318, "", 16);
	StringCopy(&cLocal_322, "special_ped@tonya@base", 64);
	StringCopy(&cLocal_338, "special_ped@tonya@intro", 64);
	bLocal_439 = true;
	iLocal_249 = 13;
	iLocal_445 = 0;
	iLocal_253[0] = 4;
...
{
	if (BitTest(Global_114135.f_18578[58 /*6*/], 0) && !BitTest(Global_114135.f_18578[58 /*6*/], 3))
	{
		return 1;
	}
	return 0;
...
int func_111()//Position - 0x3248
{
	if (BitTest(Global_114135.f_18578[60 /*6*/], 0) && !BitTest(Global_114135.f_18578[60 /*6*/], 3))
	{
		return 0;
	}
	if (BitTest(Global_114135.f_18578[61 /*6*/], 0) && !BitTest(Global_114135.f_18578[61 /*6*/], 3))
	{
		return 0;
	}
	if (BitTest(Global_114135.f_18578[62 /*6*/], 3))
	{
		return 0;
	}
	if ((BitTest(Global_114135.f_18578[58 /*6*/], 2) || BitTest(Global_114135.f_18578[59 /*6*/], 2)) || BitTest(Global_114135.f_18578[62 /*6*/], 2))
	{
		return 1;
	}
	return 0;
...
bool func_112(var uParam0)//Position - 0x32ED
{
	return func_113(Global_114135.f_20121, uParam0);
}

bool func_113(var uParam0, var uParam1)//Position - 0x3302
{
	return (uParam0 && uParam1) != 0;
}

int func_114(char* sParam0)//Position - 0x3311
{
...
void func_115(int iParam0)//Position - 0x3438
{
	...
	if (iLocal_239)
	{
		...
		if (MISC::ARE_STRINGS_EQUAL(&uVar0, &Local_496))
		{
			func_13();
		}
		if (iParam0 == 1)
...
void func_116(int* iParam0)//Position - 0x3507
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
