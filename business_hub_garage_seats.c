...
int func_82()//Position - 0x23C8
{
	if (Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_318.f_9 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("business_hub_garage_seats", Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_318.f_9, true, 0))
		{
			return 0;
		}
...
{
	func_84(0, &uLocal_93, 0, 2);
	func_84(1, &uLocal_93, 1, 1);
	func_84(2, &uLocal_93, 2, 2);
	func_84(3, &uLocal_93, 3, 1);
	func_84(4, &uLocal_93, 4, 2);
	func_84(5, &uLocal_93, 5, 1);
	func_84(6, &uLocal_93, 6, 2);
	func_84(7, &uLocal_93, 7, 1);
	func_84(8, &uLocal_93, 8, 1);
}
