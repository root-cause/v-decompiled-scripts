...
bool func_41()//Position - 0x1841
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_42(int iParam0, int iParam1)//Position - 0x185B
{
	bool bVar0;
...
int func_43(int iParam0, bool bParam1)//Position - 0x18A6
{
	int iVar0;
	int iVar1;
...
int func_44()//Position - 0x18E7
{
	return Global_1574918;
}

int func_45(int iParam0)//Position - 0x18F3
{
...
bool func_46()//Position - 0x1932
{
	return BitTest(Global_2621446, 3);
}

int func_47(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x1940
{
	int iVar0;
...
void func_48(int iParam0)//Position - 0x1973
{
	if (iParam0 == 1)
	{
...
int func_49(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1996
{
	int iVar0;
...
void func_50(char* sParam0)//Position - 0x1A7B
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, true, true, -1);
}

char* func_51()//Position - 0x1A91
{
	char* sVar0;
...
int func_52(struct<3> Param0, float fParam1, var uParam2, var uParam3)//Position - 0x1B6C
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, Param0, 2f))
			{
				...
				{
					if ((Global_97369 && Global_97370) || func_54())
					{
						return 0;
					}
...
int func_53(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x1C1F
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
Vector3 func_57()//Position - 0x1DCA
{
	struct<3> Var0;
...
int func_62(int iParam0)//Position - 0x206D
{
	if (Global_78319)
	{
		return 1;
	...
	switch (iLocal_40)
	{
		...
		case joaat("prop_mr_raspberry_01"):
			if (Global_113386.f_7261.f_227[145] == 1)
			{
				if (func_15() == 2)
				{
					if (((((Global_95447[13] != 127 && Global_95447[13] != 135) && Global_95463 != 127) && Global_95463 != 135) && !func_65()) && !func_67())
					{
						return 1;
					}
				}
...
int func_64(int iParam0)//Position - 0x2445
{
...
int func_66(int iParam0)//Position - 0x248C
{
...
void func_68(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x24D4
{
...
int func_71(int iParam0)//Position - 0x25AF
{
	if (Global_43052 == 15)
	{
		return 0;
...
bool func_72(int iParam0)//Position - 0x25D1
{
	return func_73(iParam0, Global_43052);
}

int func_73(int iParam0, int iParam1)//Position - 0x25E2
{
	if (iParam1 == 15)
	{
		return 1;
