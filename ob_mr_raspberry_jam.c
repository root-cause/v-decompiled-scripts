...
int func_46(int iParam0)//Position - 0x1930
{
...
int func_48(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x197D
{
	int iVar0;
...
int func_50(bool bParam0, bool bParam1, bool bParam2)//Position - 0x19D3
{
	int iVar0;
...
int func_53(struct<3> Param0, float fParam3, var uParam4, var uParam5)//Position - 0x1BA9
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
int func_54(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x1C5C
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_57(int iParam0)//Position - 0x1DB0
{
	if (iParam0 == 1)
	{
		if (Global_21066.f_1 > 3)
...
int func_63(int iParam0)//Position - 0x20AA
{
	if (Global_79539)
	{
		return 1;
...
int func_65(int iParam0)//Position - 0x2482
{
...
int func_67(int iParam0)//Position - 0x24C9
{
...
void func_69(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2511
{
...
int func_72(int iParam0)//Position - 0x25EC
{
	if (Global_44181 == 15)
	{
		return 0;
...
bool func_73(int iParam0)//Position - 0x260E
{
	return func_74(iParam0, Global_44181);
}

int func_74(int iParam0, int iParam1)//Position - 0x261F
{
	if (iParam1 == 15)
	{
		return 1;
