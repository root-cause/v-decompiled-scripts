...
void func_1()//Position - 0x171
{
	...
	{
		case 0:
			if (func_52(Var0, Var1) && PED::IS_PED_HEADING_TOWARDS_POSITION(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_41, true), 90f))
			{
				func_76();
		...
		case 2:
			...
			TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_278, func_35(), func_34(iLocal_280), 8f, -2f, 0, 0, 1000f, 0);
			ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_41, iLocal_278, func_33(iLocal_280), func_35(), 8f, -2f, 0, 1000f);
			if (PED::IS_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_278))
			{
				PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_278, false);
			}
		...
		case 5:
			...
			{
				STATS::STAT_SET_INT(joaat("NUM_SH_MR_JAM_USED"), iLocal_285 + 1, true);
			}
...
int func_2(int iParam0)//Position - 0x4DE
{
...
bool func_3(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x4FF
{
...
int func_4(char* sParam0, int iParam1, bool bParam2)//Position - 0x54D
{
	Global_21726 = 0;
...
bool func_7(int iParam0)//Position - 0x8B5
{
	return func_8(iParam0, 20);
}

var func_8(int iParam0, int iParam1)//Position - 0x8C5
{
	return BitTest(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

int func_9()//Position - 0x8DD
{
	return -1;
}
...
bool func_17(int iParam0)//Position - 0xC24
{
	return iParam0 < 3;
}

int func_18(int iParam0)//Position - 0xC30
{
	int iVar0;
	int iVar1;
...
int func_19(int iParam0)//Position - 0xC6D
{
	if (func_17(iParam0))
	{
...
var func_20(int iParam0)//Position - 0xC92
{
...
void func_25(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0xD95
{
...
Vector3 func_36()//Position - 0x1453
{
	struct<3> Var0;
...
Vector3 func_37()//Position - 0x1568
{
	struct<3> Var0;
...
bool func_39(char* sParam0)//Position - 0x16EB
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_40(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x16FE
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_45(PLAYER::PLAYER_ID())) && !func_42(PLAYER::PLAYER_ID(), 0)) && !func_41()) && !bParam4) && !bParam5) && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
			{
...
bool func_42(int iParam0, int iParam1)//Position - 0x1865
{
	bool bVar0;
...
int func_45(int iParam0)//Position - 0x18FD
{
...
int func_47(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x194A
{
	int iVar0;
...
int func_49(bool bParam0, bool bParam1, bool bParam2)//Position - 0x19A0
{
	int iVar0;
...
int func_52(struct<3> Param0, float fParam1, var uParam2, var uParam3)//Position - 0x1B76
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, Param0, 2f))
			{
				...
				{
					if ((Global_97609 && Global_97610) || func_54())
					{
						return 0;
					}
					if (func_53(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Param0, fParam1, 0))
					{
						return 1;
					}
				}
...
int func_53(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x1C29
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_56(int iParam0)//Position - 0x1D7D
{
	if (iParam0 == 1)
	{
		if (Global_20383.f_1 > 3)
...
Vector3 func_57()//Position - 0x1DD4
{
	struct<3> Var0;
...
int func_62(int iParam0)//Position - 0x2077
{
	if (Global_78558)
	{
		return 1;
	...
	switch (iLocal_40)
	{
		...
		case joaat("prop_mr_raspberry_01"):
			if (Global_113648.f_7263.f_227[145] == 1)
			{
				if (func_15() == 2)
				{
					if (((((Global_95687[13] != 127 && Global_95687[13] != 135) && Global_95703 != 127) && Global_95703 != 135) && !func_65()) && !func_67())
					{
						return 1;
					}
				}
...
int func_64(int iParam0)//Position - 0x244F
{
...
int func_66(int iParam0)//Position - 0x2496
{
...
void func_68(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x24DE
{
...
int func_71(int iParam0)//Position - 0x25B9
{
	if (Global_43257 == 15)
	{
		return 0;
...
bool func_72(int iParam0)//Position - 0x25DB
{
	return func_73(iParam0, Global_43257);
}

int func_73(int iParam0, int iParam1)//Position - 0x25EC
{
	if (iParam1 == 15)
	{
		return 1;
