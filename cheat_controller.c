...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		func_2();
		if (((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_1(PLAYER::PLAYER_ID(), 1, 1)) && !Global_1836471) && Global_33087 == 0)
		{
			func_113();
		}
		SYSTEM::WAIT(0);
...
void func_5(int iParam0)//Position - 0x339
{
	...
	{
		MISC::SET_BIT(&Global_33338, iParam0);
		Global_33341 = 1;
		func_6();
	}
}
...
void func_9()//Position - 0x3F6
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_12(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_10(iVar0) && (!func_15(14) || Global_113083))
			{
...
{
	if (BitTest(Global_33336, bParam0))
	{
		return 1;
	}
	return 0;
...
void func_31(int iParam0, bool bParam1)//Position - 0xBD2
{
	if (bParam1)
	{
		MISC::SET_BIT(&Global_33337, iParam0);
		func_5(iParam0);
	}
	else
	{
		MISC::CLEAR_BIT(&Global_33337, iParam0);
	}
}
...
int func_66(bool bParam0)//Position - 0x1C75
{
	if (BitTest(Global_33337, bParam0))
	{
		return 1;
	}
	return 0;
...
int func_71(int iParam0)//Position - 0x1D95
{
	if (iParam0 == 1)
	{
...
int func_82(int iParam0)//Position - 0x25EA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_83(int iParam0, int iParam1, bool bParam2)//Position - 0x27EB
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_84(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2859
{
...
int func_104(int iParam0)//Position - 0x3B60
{
	switch (iParam0)
	{
		case joaat("dodo"):
...
int func_105(int iParam0, int iParam1)//Position - 0x3BB8
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_106(bool bParam0, int iParam1)//Position - 0x3BD8
{
	if (BitTest(Global_33339, bParam0))
	{
		if (iParam1 != 0)
		{
			if (iParam1 == Global_33340)
			{
				MISC::CLEAR_BIT(&Global_33339, bParam0);
				iLocal_91 = 1;
				return 1;
			}
			else
