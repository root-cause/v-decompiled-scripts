...
void __EntryFunction__()//Position - 0x0
{
	...
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_86(uLocal_94, 4194304))
	{
		if (iLocal_105 != 263)
		{
			...
			switch (iLocal_95)
			{
				...
				case 3:
					...
					if (!func_84(iLocal_100))
					{
						...
						{
							bVar2 = true;
							if (MISC::ARE_STRINGS_EQUAL(&(Global_100681.f_3), &cLocal_69))
							{
								cLocal_69 = { Local_53 };
								bVar2 = false;
							}
					...
					else
					{
						...
						if (!func_72(3) && !Global_100715)
						{
							...
							{
								if ((!func_86(uLocal_94, 1) || !ENTITY::DOES_ENTITY_EXIST(func_71())) && !Global_100715)
								{
									func_79(10);
									break;
								}
...
void func_87()//Position - 0x270A
{
	...
	sLocal_101 = "PLAY_YOGA" /* GXT: Press ~INPUT_CONTEXT~ to do Yoga. */;
	iLocal_99 = 18;
	fLocal_117 = 2.5f;
	fLocal_102 = 20f;
	iLocal_97 = 54000;
