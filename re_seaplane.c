...
int func_125(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x74F2
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_162(Global_113648.f_24997.f_43[iParam1]))
		{
			return 0;
		}
