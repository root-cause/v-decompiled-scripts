				...
				case 1:
					if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
					{
						...
						switch (iLocal_47)
						{
							...
							case 1:
								if ((!func_133(iLocal_52[0], &iLocal_102, &uLocal_101, uLocal_100, iLocal_103, 7f, 0) && !func_133(iLocal_52[1], &iLocal_102, &uLocal_101, uLocal_100, iLocal_103, 7f, 0)) && !func_132())
								{
									switch (iLocal_48)
									{
										case 0:
											func_131();
											if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_72, 50f, 35f, 50f, false, true, 0))
											{
												func_130();
											}
											if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_72, 80f, 65f, 50f, false, true, 0))
											{
												func_129();
											}
							...
							case 2:
								if ((func_133(iLocal_52[0], &iLocal_102, &uLocal_101, uLocal_100, iLocal_103, 7f, 0) || func_133(iLocal_52[1], &iLocal_102, &uLocal_101, uLocal_100, iLocal_103, 7f, 0)) || iLocal_103)
								{
									iLocal_103 = 1;
									if (!func_166())
									{
							...
							case 4:
								func_91();
								if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_85, 100f, 100f, 100f, true, true, 0))
								{
								...
								{
									if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_113, 200f, 200f, 200f, true, true, 0))
									{
								...
								if (!PED::IS_PED_INJURED(iLocal_51))
								{
									...
									if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_113, Global_22, true, true, 0) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_51, PLAYER::PLAYER_PED_ID(), 10f, 10f, 10f, false, true, 0))
									{
										if (PED::IS_PED_IN_GROUP(iLocal_51))
										{
								...
								if (bLocal_117)
								{
									if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, false))
									{
										if (!PED::IS_PED_INJURED(iLocal_52[0]))
										{
											...
											if (VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_52[0], iLocal_54, -1, false, false) || VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_52[0], iLocal_54, 0, false, false))
											{
												if (!iLocal_124)
												{
													...
													TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, -0.5f, 0.5f, 0f), PLAYER::PLAYER_PED_ID(), 3f, true, 0.5f, 4f, true, 0, false, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
													TASK::TASK_ENTER_VEHICLE(0, iLocal_54, -1, -1, 3f, 9, 0);
													TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_54, PLAYER::PLAYER_PED_ID(), 8, 30f, 262144, -1f, 10f, true);
												...
												else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_52[0], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) == 1)
												{
													...
													{
														if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_52[0], PLAYER::PLAYER_PED_ID(), 10f, 10f, 10f, false, true, 0) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_52[0], Local_74, 10f, 10f, 10f, false, true, 0))
														{
															ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_52[0]));
														}
													}
										...
										if (!PED::IS_PED_INJURED(iLocal_52[1]))
										{
											...
											if (VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_52[1], iLocal_54, -1, false, false) || VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_52[1], iLocal_54, 0, false, false))
											{
												if (!iLocal_124)
												{
												...
												else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_52[1], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) == 1)
												{
													...
													{
														if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_52[1], PLAYER::PLAYER_PED_ID(), 10f, 10f, 10f, false, true, 0) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_52[1], Local_74, 10f, 10f, 10f, false, true, 0))
														{
															ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_52[1]));
														}
													}
						...
						if ((func_10() && !func_9()) && iLocal_47 != 9)
						{
							if (!PED::IS_PED_INJURED(iLocal_51))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(iLocal_51, Local_114, 5f, 5f, 5f, false, true, 0))
								{
									func_8(0);
									SYSTEM::WAIT(0);
									func_110();
							...
							if (!PED::IS_PED_INJURED(iLocal_51))
							{
								if (!bLocal_104)
								{
									if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_51, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE")) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_51, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE")) != 0)
									{
										...
										TASK::TASK_SYNCHRONIZED_SCENE(iLocal_51, iLocal_303, "random@burial", "b_burial", 1000f, -4f, 1, 24592, 1000f, 0);
										ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_57[0], iLocal_303, "b_burial_legstie", "random@burial", 4f, -4f, 0, 1000f);
										ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_57[1], iLocal_303, "b_burial_wristtie", "random@burial", 4f, -4f, 0, 1000f);
...
void func_47()//Position - 0x28E3
{
	...
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_51) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_55, false))
			{
				if (PED::IS_PED_IN_GROUP(iLocal_51))
				{
					PED::REMOVE_PED_FROM_GROUP(iLocal_51);
...
void func_48()//Position - 0x2A2A
{
	...
	{
		case 0:
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, iLocal_137, joaat("PLAYER"));
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, joaat("PLAYER"), iLocal_137);
	...
	if (!PED::IS_PED_INJURED(iLocal_51))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_51, 8f, 8f, 8f, false, true, 0) || PED::IS_PED_IN_ANY_TAXI(PLAYER::PLAYER_PED_ID()))
		{
			...
			else
			{
				...
				if (!HUD::DOES_BLIP_EXIST(iLocal_111))
				{
					iLocal_111 = func_66(Local_113, 1);
				}
			}
		}
...
int func_66(struct<3> Param0, bool bParam1)//Position - 0x3C14
{
	int iVar0;
...
int func_70()//Position - 0x3D45
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		iLocal_129 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_129, false))
		{
			if (!PED::IS_PED_INJURED(iLocal_51))
			{
			...
			if (func_49(1, 0, 1))
			{
				...
				if (!iLocal_89)
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
					{
						...
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::GET_PLAYERS_LAST_VEHICLE(), iLocal_51, 5f, 5f, 5f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), Local_74, 5f, 5f, 5f, false, true, 0))
						{
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_54))
					{
						...
						if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_54, iLocal_51, 8f, 8f, 8f, false, true, 0))
						{
							ENTITY::SET_ENTITY_COORDS(iLocal_54, Local_74, false, false, false, true);
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_54, false))
							{
					...
					if (!PED::IS_PED_INJURED(iLocal_51))
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_129, false))
						{
							...
							ENTITY::SET_ENTITY_COORDS(iLocal_129, ENTITY::GET_ENTITY_COORDS(iLocal_51, true) + Vector(0f, 5f, 5f), true, false, false, true);
						}
					}
					FIRE::STOP_FIRE_IN_RANGE(Local_72, 10f);
					MISC::CLEAR_AREA_OF_PROJECTILES(Local_72, 10f, 0);
					MISC::CLEAR_AREA_OF_VEHICLES(Local_72, 4.5f, false, false, false, false, false, false, 0);
					ENTITY::SET_ENTITY_COORDS(iLocal_51, Local_72, true, false, false, true);
					ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_72, true, false, false, true);
					if (!PED::IS_PED_INJURED(iLocal_51))
					{
					}
					iVar0 = 0;
					...
					if (!PED::IS_PED_INJURED(iLocal_51))
					{
						...
						TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_51);
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_51, iLocal_303, "random@burial", "untie_ped", 1000f, -1000f, 4, 0, 1000f, 0);
						PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_51, false, false);
						TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_303, "random@burial", "untie_player", 1000f, -1000f, 0, 0, 1000f, 0);
						PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), false, false);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_57[0], iLocal_303, "untie_legstie", "random@burial", 1000f, -1000f, 0, 1000f);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_57[1], iLocal_303, "untie_wristtie", "random@burial", 1000f, -1000f, 0, 1000f);
		...
		if (bLocal_96)
		{
			if (!iLocal_95)
			{
				if (!func_12())
				{
					...
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_137, joaat("PLAYER"));
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("PLAYER"), iLocal_137);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_59);
					...
					if (func_45() == 2 && !func_9())
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_112))
						{
							iLocal_112 = func_66(Local_114, 0);
...
int func_102(int iParam0, bool bParam1)//Position - 0x5231
{
	int iVar0;
	int iVar1;
...
int func_103(int iParam0)//Position - 0x5272
{
...
bool func_104()//Position - 0x52B1
{
	return BitTest(Global_2621446, 3);
}

int func_105(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x52BF
{
	int iVar0;
...
void func_106(int iParam0)//Position - 0x52F2
{
	if (iParam0 == 1)
	{
...
void func_108(int iParam0, char* sParam1, int iParam2)//Position - 0x541C
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iParam0, sParam1, func_109(iParam2), 1);
}

int func_109(int iParam0)//Position - 0x5433
{
	int iVar0;
...
void func_110()//Position - 0x5628
{
	Global_20591 = 0;
	func_111();
}

void func_111()//Position - 0x5638
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_112()//Position - 0x5659
{
	if (!iLocal_61 && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_85, 30f, 30f, 30f, false, true, 0))
	{
		if (!PED::IS_PED_INJURED(iLocal_52[1]))
		{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, false))
	{
		if (!PED::IS_PED_INJURED(iLocal_52[0]))
		{
			TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_52[0], iLocal_54, PLAYER::PLAYER_PED_ID(), 8, 30f, 262144, -1f, 10f, true);
			PED::SET_PED_KEEP_TASK(iLocal_52[0], true);
		}
		if (!PED::IS_PED_INJURED(iLocal_52[1]))
		{
	...
	else
	{
		...
		while (iLocal_58 <= 1)
		{
			...
			{
				TASK::TASK_SMART_FLEE_PED(iLocal_52[iLocal_58], PLAYER::PLAYER_PED_ID(), 250f, -1, false, false);
		...
		if (!iLocal_63)
		{
			...
			if (PED::IS_PED_FACING_PED(iLocal_52[1], PLAYER::PLAYER_PED_ID(), 90f))
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_52[0]) && !PED::IS_PED_INJURED(iLocal_52[1]))
				{
					...
					ENTITY::DETACH_ENTITY(iLocal_56, false, true);
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_56, iLocal_52[0], PED::GET_PED_BONE_INDEX(iLocal_52[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
					TASK::CLEAR_PED_TASKS(iLocal_52[0]);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_59);
					TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
...
float func_116(int iParam0, int iParam1, bool bParam2)//Position - 0x5DF3
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_119(int iParam0)//Position - 0x6112
{
	if (func_122())
	{
		Global_113638 = 1;
...
void func_120(int iParam0)//Position - 0x6165
{
	switch (iParam0)
	{
		case 0:
...
char* func_121(int iParam0)//Position - 0x6240
{
	char* sVar0;
...
int func_123(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x62B8
{
	int iVar0;
...
void func_124(var uParam0, int iParam1)//Position - 0x63EF
{
	int iVar0;
...
bool func_125(int iParam0)//Position - 0x643E
{
	return func_126(iParam0, Global_43257);
}

int func_126(int iParam0, int iParam1)//Position - 0x644F
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_127(int iParam0)//Position - 0x6630
{
	if (Global_43257 == 15)
	{
		return 0;
...
void func_128()//Position - 0x6652
{
	...
	while (iLocal_58 <= 1)
	{
		if (!HUD::DOES_BLIP_EXIST(iLocal_87[iLocal_58]))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_52[iLocal_58], false))
			{
		...
		if (ENTITY::IS_ENTITY_ATTACHED(iLocal_56))
		{
			if (!PED::IS_PED_INJURED(iLocal_52[0]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_52[0], "random@burial", "a_burial_stop", 3))
				{
					...
					{
						GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_burial_dirt", iLocal_56, 0f, 0f, -0.95f, 0f, 180f, 0f, 1f, false, false, false);
					}
				}
...
int func_132()//Position - 0x6A7C
{
	if (!iLocal_103)
	{
		if (MISC::IS_BULLET_IN_AREA(Local_74, 100f, true) || MISC::IS_BULLET_IN_AREA(Local_74, 100f, true))
		{
			if (PED::IS_PED_INJURED(iLocal_52[0]) || PED::IS_PED_INJURED(iLocal_52[1]))
			{
				iLocal_49 = 1;
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_54))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_54, false))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_54, PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_54, false))
				{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					...
					{
						if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), iLocal_54))
						{
							func_118();
							iLocal_49 = 3;
							return 1;
		...
		if (!iLocal_69)
		{
			if (!PED::IS_PED_INJURED(iLocal_52[0]) && !PED::IS_PED_INJURED(iLocal_52[1]))
			{
				if ((((PED::CAN_PED_SEE_HATED_PED(iLocal_52[0], PLAYER::PLAYER_PED_ID()) || PED::CAN_PED_SEE_HATED_PED(iLocal_52[1], PLAYER::PLAYER_PED_ID())) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_52[0])) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_52[1])) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_74 - Vector(0f, 0f, 7f), 20f, 15f, 35f, false, true, 0))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_74 - Vector(0f, 0f, 7f), 28f, 18f, 35f, false, true, 0))
					{
						iLocal_49 = 1;
						return 1;
					}
...
int func_133(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, float fParam5, int iParam6)//Position - 0x6F1B
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
void func_134(char* sParam0, int iParam1)//Position - 0x716D
{
	func_136(sParam0);
	func_135(iParam1);
}

void func_135(int iParam0)//Position - 0x7181
{
	if (iParam0 > 0)
	{
	}
...
void func_136(char* sParam0)//Position - 0x718F
{
...
void func_137(int iParam0)//Position - 0x71A2
{
	AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(iParam0);
}

void func_138(char* sParam0)//Position - 0x71B0
{
	func_136(sParam0);
}

int func_139(int iParam0, int iParam1)//Position - 0x71BE
{
	if (PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
	{
...
void func_140()//Position - 0x720B
{
	...
	func_142(43, 1);
	func_142(44, 1);
	PED::ADD_SCENARIO_BLOCKING_AREA(Local_113 - Vector(20f, 40f, 40f), Local_113 + Vector(20f, 40f, 40f), false, true, true, true);
	PED::ADD_SCENARIO_BLOCKING_AREA(Local_72 - Vector(20f, 50f, 60f), Local_72 + Vector(20f, 50f, 50f), false, true, true, true);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_83, true);
	MISC::ENABLE_DISPATCH_SERVICE(5, false);
	MISC::ENABLE_DISPATCH_SERVICE(3, false);
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0f);
	iLocal_51 = PED::CREATE_PED(26, iLocal_80, Local_72, fLocal_77, true, true);
	...
	while (iLocal_58 <= 1)
	{
		iLocal_52[iLocal_58] = PED::CREATE_PED(26, iLocal_81, Local_73[iLocal_58 /*3*/], fLocal_78[iLocal_58], true, true);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_52[iLocal_58], true);
		PED::SET_PED_AS_ENEMY(iLocal_52[iLocal_58], true);
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_136, joaat("PLAYER"));
	...
	iLocal_54 = VEHICLE::CREATE_VEHICLE(iLocal_83, Local_74, fLocal_79, true, true, false);
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_54, 5f);
	VEHICLE::SET_VEHICLE_LIGHTS(iLocal_54, 3);
	VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_54, 5, false, false);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_83);
	iLocal_56 = OBJECT::CREATE_OBJECT(joaat("prop_ld_shovel"), Local_85, true, true, false);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_ld_shovel"));
	iLocal_57[0] = OBJECT::CREATE_OBJECT(joaat("p_arm_bind_cut_s"), Local_85, true, true, false);
	iLocal_57[1] = OBJECT::CREATE_OBJECT(joaat("p_arm_bind_cut_s"), Local_85 + Vector(1f, 1f, 1f), true, true, false);
	...
	Var0 = { Local_72 };
	Var1 = { -2f, -4f, 18f };
	iLocal_303 = PED::CREATE_SYNCHRONIZED_SCENE(Var0, Var1, 2);
	TASK::TASK_SYNCHRONIZED_SCENE(iLocal_51, iLocal_303, "random@burial", "b_burial", 4f, -4f, 1, 0, 1000f, 0);
	ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_57[0], iLocal_303, "b_burial_legstie", "random@burial", 4f, -4f, 0, 1000f);
	ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_57[1], iLocal_303, "b_burial_wristtie", "random@burial", 4f, -4f, 0, 1000f);
	PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_303, true);
	PED::SET_PED_KEEP_TASK(iLocal_51, true);
	...
	PED::SET_PED_ANGLED_DEFENSIVE_AREA(iLocal_52[0], Local_75, Local_76, 2.75f, false, false);
	PED::SET_PED_ANGLED_DEFENSIVE_AREA(iLocal_52[1], Local_75, Local_76, 2.75f, false, false);
	if (func_45() == 0)
	{
...
void func_141(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x771C
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_142(int iParam0, bool bParam1)//Position - 0x77B7
{
	if (bParam1)
	{
...
void func_143(int iParam0, int iParam1, bool bParam2)//Position - 0x77EE
{
	int iVar0;
...
void func_144(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x7860
{
	int iVar0;
...
int func_145(var uParam0)//Position - 0x7890
{
	int iVar0;
	int iVar1;
...
int func_146(int iParam0, int iParam1, int iParam2)//Position - 0x78C4
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 14192)
	{
		...
		iVar0 = Global_2805027[iParam0 /*3*/][func_145(iParam1)];
...
int func_147(int iParam0)//Position - 0x7901
{
	switch (iParam0)
	{
		case 0:
...
void func_148(int iParam0, int iParam1, bool bParam2)//Position - 0x7C9A
{
	int iVar0;
...
int func_149(int iParam0, int iParam1, bool bParam2)//Position - 0x7D0C
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_154(float fParam0, bool bParam1)//Position - 0x8038
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_155(int iParam0, var uParam1)//Position - 0x80E9
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_156(uParam1, "Barry3A", func_158(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_157(iParam0), 0, 1);
			break;
		...
		case 8:
			func_156(uParam1, "Dreyfuss1", func_158(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_157(iParam0), 0, 0);
			break;
		...
		case 38:
			func_156(uParam1, "Nigel1A", func_158(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_157(iParam0), 1, 1);
			break;
		...
		case 49:
			func_156(uParam1, "Paparazzo3A", func_158(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_157(iParam0), 0, 1);
			break;
		...
		case 58:
			func_156(uParam1, "Tonya1", func_158(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_157(iParam0), 0, 1);
			break;
...
int func_157(int iParam0)//Position - 0x92EF
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_158(int iParam0)//Position - 0x9635
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_159(int iParam0)//Position - 0x966B
{
	struct<2> Var0;
...
bool func_161()//Position - 0x9AE8
{
	return Global_113366 > 0;
}

int func_162()//Position - 0x9AF6
{
	if (Global_97603 != -1)
	{
		return 1;
...
void func_167(int iParam0)//Position - 0x9BD8
{
	if (iParam0 == -1)
	{
		iParam0 = func_40();
...
void func_169(int iParam0)//Position - 0x9C4B
{
	Global_113637 = iParam0;
}

int func_170(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x9C59
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
...
bool func_171(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x9FF3
{
	if (bParam2)
	{
...
bool func_172(int iParam0)//Position - 0xA03A
{
	int iVar0;
...
int func_173(int iParam0)//Position - 0xA05B
{
	return func_174(iParam0, 1);
}

int func_174(int iParam0, int iParam1)//Position - 0xA06A
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_175(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xA0BD
{
	func_176(func_187(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_176(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xA0DB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_177(float fParam0, float fParam1, float fParam2)//Position - 0xA2DC
{
	float fVar0;
...
int func_178(int iParam0, int iParam1)//Position - 0xA31E
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_179(int iParam0)//Position - 0xA3C0
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_180(int iParam0)//Position - 0xA3D3
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_181(int iParam0)//Position - 0xA3E6
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_182(int iParam0)//Position - 0xA3F9
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_183(int iParam0)//Position - 0xA40B
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_184(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_184(bool bParam0, int iParam1, int iParam2)//Position - 0xA42D
{
	if (bParam0)
	{
		return iParam1;
...
int func_185(int iParam0)//Position - 0xA444
{
	return iParam0 & 15;
}

int func_186(int iParam0, int iParam1)//Position - 0xA451
{
	int iVar0;
	int iVar1;
...
void func_188(var uParam0, int iParam1)//Position - 0xA5A3
{
	if (iParam1 <= 0)
	{
		return;
...
void func_189(var uParam0, int iParam1)//Position - 0xA629
{
...
void func_190(var uParam0, int iParam1)//Position - 0xA65C
{
	int iVar0;
	int iVar1;
...
void func_191(var uParam0, int iParam1)//Position - 0xA6AD
{
...
void func_192(var uParam0, int iParam1)//Position - 0xA6E7
{
...
void func_193(var uParam0, int iParam1)//Position - 0xA722
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_194(int iParam0)//Position - 0xA75E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_195(int iParam0, bool bParam1)//Position - 0xA83A
{
...
int func_196(int iParam0)//Position - 0xA85A
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_204()) || Global_32166) || func_203()) || func_84(8, -1)) || func_200()) || func_202()) || func_201()) || func_199()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_204()) || Global_112695) || Global_32166) || func_203()) || func_84(8, -1)) || func_202()) || func_201()) || func_199()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_204() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_84(8, -1)) || func_199()) || func_198()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_204()) || func_201()) || Global_112695) || Global_32166) || func_203()) || Global_44446) || func_84(8, -1)) || func_200()) || func_198()) || func_199()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_197()//Position - 0xAF77
{
	return Global_100720.f_1;
}

int func_198()//Position - 0xAF85
{
	if (Global_97603 != -1)
	{
...
bool func_201()//Position - 0xAFEC
{
	return Global_100733.f_388 > 0;
}

bool func_202()//Position - 0xAFFD
{
	return Global_100733.f_387 > 0;
}

var func_203()//Position - 0xB00E
{
	return Global_1575060;
}

int func_204()//Position - 0xB01A
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_206(int iParam0)//Position - 0xB05E
{
	return func_186(func_187(), iParam0);
}

int func_207(int iParam0, int iParam1, int iParam2)//Position - 0xB070
{
	int iVar0;
	int iVar1;
...
int func_208(int iParam0)//Position - 0xB154
{
	if (!func_33(iParam0))
	{
		return 7;
...
int func_209(int iParam0)//Position - 0xB178
{
	int iVar0;
	int iVar1;
...
void func_213(int iParam0)//Position - 0xB4EF
{
	char cVar0[64];
...
void func_214(var uParam0)//Position - 0xB5A1
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_215(int iParam0, bool bParam1)//Position - 0xB5DE
{
	switch (iParam0)
	{
		case 0:
...
void func_216(int iParam0)//Position - 0xB827
{
	Global_43808 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_217(int iParam0)//Position - 0xB839
{
	func_218(iParam0, 0, func_223(iParam0));
}

void func_218(int iParam0, int iParam1, int iParam2)//Position - 0xB84E
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_219(var uParam0)//Position - 0xB87D
{
	struct<16> Var0;
	int iVar1;
...
void func_220(int iParam0, var uParam1)//Position - 0xB94C
{
	Global_113648.f_24997.f_43[iParam0] = *uParam1;
}

void func_221(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xB964
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_222(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xBAE6
{
...
int func_223(int iParam0)//Position - 0xBB1E
{
	int iVar0;
...
void func_225(bool bParam0)//Position - 0xBCDD
{
	int iVar0;
