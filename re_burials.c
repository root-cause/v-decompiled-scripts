...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_125 = 200;
	Local_139 = { -1161.1992f, 934.5912f, 196.7591f };
					...
					if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
					{
								...
								if ((!func_133(iLocal_54[0], &iLocal_128, &uLocal_127, uLocal_126, iLocal_129, 7f, 0) && !func_133(iLocal_54[1], &iLocal_128, &uLocal_127, uLocal_126, iLocal_129, 7f, 0)) && !func_132())
								{
									switch (iLocal_50)
									{
										case 0:
											...
											{
												if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 281.9148f, 6816.3447f, 4.3197f, 48.3924f, 6885.9214f, 43.0037f, 226.5f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_88 - Vector(0f, 0f, 7f), 20f, 15f, 50f, false, true, 0))
												{
													func_128();
							...
							case 4:
								...
								if (!ENTITY::DOES_ENTITY_EXIST(iLocal_57))
								{
									if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_139, 200f, 200f, 200f, true, true, 0))
									{
										...
										{
											iLocal_59 = VEHICLE::CREATE_VEHICLE(joaat("granger"), -1155.0431f, 942.9685f, 197.4921f, 161.1247f, true, true, false);
									...
									if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_58, false))
									{
										if (!PED::IS_PED_INJURED(iLocal_54[0]))
										{
											...
											if (VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_54[0], iLocal_58, -1, false, false) || VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_54[0], iLocal_58, 0, false, false))
											{
												...
												else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_54[0], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) == 1)
												{
										...
										if (!PED::IS_PED_INJURED(iLocal_54[1]))
										{
											...
											if (VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_54[1], iLocal_58, -1, false, false) || VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_54[1], iLocal_58, 0, false, false))
											{
												...
												else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_54[1], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) == 1)
												{
						...
						if (((iLocal_49 == 1 || iLocal_49 == 2) || iLocal_49 == 3) || iLocal_49 == 7)
						{
							if (!PED::IS_PED_INJURED(iLocal_53))
							{
								if (!bLocal_130)
								{
									if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_53, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE")) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_53, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE")) != 0)
									{
...
void func_52()//Position - 0x2E04
{
	if (!PED::IS_PED_INJURED(iLocal_53))
	{
		...
		{
			TASK::TASK_USE_MOBILE_PHONE(iLocal_53, false, 1);
		}
	}
	if (func_70() && !func_12())
	{
	...
	if ((iLocal_172 - iLocal_171) > 180000)
	{
		if (!PED::IS_PED_INJURED(iLocal_53))
		{
			if (PED::IS_PED_IN_GROUP(iLocal_53))
			{
				...
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_53, 1740.7965f, 4648.7563f, 42.6529f, 1f, -1, 0.25f, 0, 40000f);
					PED::SET_PED_KEEP_TASK(iLocal_53, true);
				}
				func_110();
				SYSTEM::WAIT(0);
	...
	if ((iLocal_175 - iLocal_174) > 120000)
	{
		if (!PED::IS_PED_INJURED(iLocal_53))
		{
			if (PED::IS_PED_IN_GROUP(iLocal_53))
			{
				...
				if (ENTITY::IS_ENTITY_AT_COORD(iLocal_53, Local_139, 100f, 100f, 100f, false, true, 0))
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_53, Local_139, 1f, -1, 0.25f, 0, 40000f);
					PED::SET_PED_KEEP_TASK(iLocal_53, true);
				}
				else
				{
...
void func_92()//Position - 0x4740
{
	...
	if (iLocal_117 && !bLocal_122)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_53))
		{
			...
			ENTITY::SET_ENTITY_COORDS(iLocal_53, 164.4963f, 6839.3335f, 18.9657f, true, false, false, true);
		...
		if (!iLocal_69)
		{
			...
			if (PED::IS_PED_FACING_PED(iLocal_54[1], PLAYER::PLAYER_PED_ID(), 90f))
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_54[0]) && !PED::IS_PED_INJURED(iLocal_54[1]))
				{
					...
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_60, iLocal_54[0], PED::GET_PED_BONE_INDEX(iLocal_54[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
					TASK::CLEAR_PED_TASKS(iLocal_54[0]);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_65);
					TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
...
void func_144(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x7860
{
	...
	iVar0 = Global_2805029[iParam0 /*3*/][func_145(iParam2)];
	if (iVar0 != 0)
	{
...
int func_146(int iParam0, int iParam1, int iParam2)//Position - 0x78C4
{
	...
	if (iParam0 != 14192)
	{
		...
		iVar0 = Global_2805029[iParam0 /*3*/][func_145(iParam1)];
...
void func_152()//Position - 0x7EF1
{
	...
	Local_81[1 /*3*/] = { 162.5046f, 6841.6797f, 18.8426f };
	fLocal_98[1] = 193.3866f;
	Local_88 = { 169.3462f, 6837.8047f, 19.1421f };
	fLocal_101 = 265.6862f;
	Local_91 = { 164.08965f, 6836.923f, 19.03899f };
	Local_94 = { 168.9638f, 6834.3022f, 24.99057f };
	iLocal_66 = 1;
}
...
int func_170(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x9C59
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
bool func_171(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x9FF3
{
	if (bParam6)
	{
