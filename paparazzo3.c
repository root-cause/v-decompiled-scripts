...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x86EF
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_75(int iParam0)//Position - 0x9592
{
	if (!BitTest(Global_79172[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x95DA
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x9685
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_78(int iParam0, int iParam1)//Position - 0x9735
{
	int iVar0;
	struct<10> Var1;
...
void func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA064
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xA18E
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_81(int iParam0, int iParam1)//Position - 0xA1D6
{
	int iVar0;
	struct<17> Var1;
...
void func_82(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC021
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
int func_83(int iParam0)//Position - 0xC20B
{
	switch (iParam0)
	{
		case 0:
...
void func_84(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xC2BB
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC32C
{
	func_149();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_88(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD6A8
{
	var uVar0;
	int iVar1;
...
int func_92(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE644
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE764
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
int func_150(int iParam0, int iParam1, int iParam2)//Position - 0x1F9DF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_151(int iParam0)//Position - 0x1FC38
{
	int iVar0;
	int iVar1;
...
int func_152(int iParam0)//Position - 0x1FC75
{
	if (func_154(iParam0))
	{
...
var func_153(int iParam0)//Position - 0x1FC9A
{
	return Global_2169[iParam0 /*29*/];
}

bool func_154(int iParam0)//Position - 0x1FCA9
{
	return iParam0 < 3;
}

void func_155(char* sParam0, var uParam1)//Position - 0x1FCB5
{
...
struct<2> func_158(int iParam0)//Position - 0x1FE49
{
	struct<2> Var0;
	char[] cVar2[8];
...
bool func_171()//Position - 0x21BCA
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_172()//Position - 0x21BE0
{
...
void func_175(var uParam0)//Position - 0x21C42
{
	if (*uParam0 == -1)
	{
		return;
...
void func_180(var uParam0, bool bParam1)//Position - 0x221D5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_185(int iParam0, int iParam1)//Position - 0x225F9
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_186(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x22619
{
	if (iParam0 != 198)
	{
		if (Global_79389)
...
void func_197(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x26A6F
{
	int iVar0;
...
int func_199(int iParam0)//Position - 0x26D59
{
	int iVar0;
	int iVar1;
...
int func_202(int iParam0)//Position - 0x26F90
{
...
int func_204(char* sParam0)//Position - 0x26FF7
{
	int iVar0;
...
int func_205()//Position - 0x27057
{
	return func_206(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_206(char* sParam0, int iParam1)//Position - 0x27068
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_207(int* iParam0)//Position - 0x270B1
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_208(int iParam0, int iParam1, bool bParam2)//Position - 0x270F2
{
	int iVar0;
...
struct<4> func_210(int iParam0)//Position - 0x272EB
{
	return Global_2169[iParam0 /*29*/].f_3;
}

int func_211(int iParam0, int iParam1)//Position - 0x272FE
{
...
int func_212(int iParam0, int iParam1)//Position - 0x27328
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_213(int iParam0, int iParam1, int iParam2)//Position - 0x27352
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_214(int iParam0, int iParam1, int iParam2)//Position - 0x27397
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_215()//Position - 0x273DC
{
	if (func_93(14))
	{
...
int func_216()//Position - 0x2747E
{
	func_157();
	return Global_113969.f_2366.f_539.f_4321;
}

int func_217()//Position - 0x27497
{
...
bool func_218(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x274B9
{
...
bool func_222(int iParam0)//Position - 0x2786F
{
	return func_223(iParam0, 20);
}

var func_223(int iParam0, int iParam1)//Position - 0x2787F
{
	return BitTest(Global_1887305[iParam0 /*610*/].f_10.f_4, iParam1);
}

int func_224()//Position - 0x27897
{
	return -1;
}
...
void func_232(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x27B0C
{
...
int func_233(int iParam0)//Position - 0x27B62
{
	if (func_234(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_234(int iParam0)//Position - 0x27B82
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_235(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x27BA3
{
	struct<3> Var0;
...
int func_236(int iParam0, float fParam1)//Position - 0x27C5E
{
	float fVar0;
...
bool func_237(int iParam0, float fParam1)//Position - 0x27CD4
{
	return func_238(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_238(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27CEC
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_239(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x27DAD
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_240(int iParam0, int iParam1)//Position - 0x27ED9
{
	int iVar0;
...
int func_242(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x27FE8
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_243(struct<3> Param0, struct<3> Param3)//Position - 0x28079
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_244(struct<3> Param0)//Position - 0x2809A
{
	float fVar0;
	float fVar1;
...
int func_246(int iParam0, int iParam1)//Position - 0x280F4
{
	int iVar0;
...
int func_247(int iParam0)//Position - 0x28133
{
...
bool func_248(int iParam0, int iParam1, float fParam2)//Position - 0x2815B
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_249(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x281A2
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_250(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2829D
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_251(int iParam0, float fParam1)//Position - 0x283A9
{
	var uVar0;
	struct<3> Var1;
...
int func_252(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x2843E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_253(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x284CC
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_258(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x28ADA
{
	if (bParam0)
	{
...
bool func_260(int iParam0, int iParam1)//Position - 0x28C41
{
	bool bVar0;
...
int func_261(int iParam0, bool bParam1)//Position - 0x28C9A
{
	int iVar0;
	int iVar1;
...
int func_262(var uParam0)//Position - 0x28CDB
{
	int iVar0;
...
int func_263(int iParam0)//Position - 0x28CFD
{
...
int func_265(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x28D4A
{
	int iVar0;
...
void func_268(int* iParam0)//Position - 0x28DB9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_269(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x28DE4
{
	int iVar0;
...
Vector3 func_271(int iParam0)//Position - 0x28FDE
{
...
void func_273(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x29030
{
	func_274(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_274(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x29059
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_275(struct<3> Param0)//Position - 0x2944F
{
...
int func_276(int iParam0, int iParam1, bool bParam2)//Position - 0x29479
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_277(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x294E7
{
...
int func_278(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x295BF
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_279(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x298B5
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_280(int iParam0)//Position - 0x29969
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_284(int iParam0, float fParam1, int iParam2)//Position - 0x29A89
{
	int iVar0;
...
int func_288(int iParam0, int iParam1)//Position - 0x29BE1
{
	if (func_233(iParam0))
	{
...
int func_289(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x29C14
{
...
void func_290(int iParam0)//Position - 0x29C6B
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_292(char* sParam0, int iParam1, int iParam2, int iParam3)//Position - 0x29DE8
{
	struct<50> Var0;
	int iVar65;
...
void func_293(int iParam0, var uParam1, int iParam2)//Position - 0x29EA3
{
	int iVar0;
	int iVar1;
	struct<50> Var2;
...
void func_294(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A118
{
	int iVar0;
	int iVar1;
...
int func_295(int iParam0, int iParam1)//Position - 0x2A2B2
{
	int iVar0;
	var uVar1;
...
int func_296(int iParam0, var uParam1)//Position - 0x2A2D6
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_71(uParam1));
}

void func_297(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2A2EB
{
	int iVar0;
...
void func_298(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x2A834
{
	int iVar0;
...
int func_309(int iParam0)//Position - 0x2AFCB
{
	if (iParam0 == 1)
	{
		if (Global_20930.f_1 > 3)
...
int func_314(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2B22B
{
	bool bVar0;
	float fVar1;
...
void func_319(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2B434
{
...
void func_320(int* iParam0, var uParam1)//Position - 0x2B4CF
{
	*iParam0 = *uParam1;
	*uParam1 = 0;
}

int func_321()//Position - 0x2B4E1
{
	if (!func_234(PLAYER::PLAYER_PED_ID()))
	{
		return 1;
...
void func_327(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2B63C
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_329(Global_79645, Global_79647, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_328(char* sParam0)//Position - 0x2B921
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_329(int iParam0, int iParam1, int iParam2)//Position - 0x2B934
{
	struct<2> Var0;
	int iVar2;
...
char* func_330(int iParam0)//Position - 0x2BA0A
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_337(int iParam0)//Position - 0x2BC99
{
	struct<2> Var0;
...
int func_338(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2BD02
{
...
int func_340(int iParam0)//Position - 0x2BE43
{
	if (Global_44042 == 15)
	{
		return 0;
...
bool func_341(int iParam0)//Position - 0x2BE65
{
	return func_342(iParam0, Global_44042);
}

int func_342(int iParam0, int iParam1)//Position - 0x2BE76
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_344(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2C14D
{
	int iVar0;
...
int func_345(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2C2E1
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5.f_0, Param2, fParam5, true, true, false);
				...
				func_416(iParam0, &(Var5.f_31), &(Var5.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_346(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2D104
{
	var uVar0;
	int iVar1;
	int iVar2;
...
float func_349(int iParam0)//Position - 0x2F27D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_350(int iParam0, var uParam1, var uParam2)//Position - 0x2F32D
{
	int iVar0;
	int iVar1;
...
int func_351(int iParam0, bool bParam1, var uParam2)//Position - 0x2F520
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_392(iVar0, bParam1, uParam2) && !func_391(PLAYER::PLAYER_ID())) && !func_364(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_360(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_357(iParam0)) && !bVar1) && !(func_356(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_353(PLAYER::PLAYER_ID())))
	{
...
int func_352(int iParam0)//Position - 0x2F68E
{
	int iVar0;
...
int func_353(int iParam0)//Position - 0x2F6C9
{
	if (iParam0 != func_224())
	{
...
int func_354(int iParam0)//Position - 0x2F710
{
	switch (iParam0)
	{
		case 0:
...
int func_355(int iParam0, bool bParam1, bool bParam2)//Position - 0x2FC10
{
	int iVar0;
...
int func_356(int iParam0)//Position - 0x2FC70
{
...
int func_357(int iParam0)//Position - 0x2FCB2
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_358(int iParam0)//Position - 0x2FD7A
{
	if (iParam0 != func_224())
	{
		if (func_355(iParam0, 1, 1))
...
int func_359(int iParam0)//Position - 0x2FDC1
{
	if (iParam0 != func_224())
	{
		if (func_355(iParam0, 1, 1))
...
int func_360(int iParam0)//Position - 0x2FE08
{
	if (iParam0 != func_224())
	{
		if (func_355(iParam0, 1, 1))
...
int func_361(int iParam0)//Position - 0x2FE4E
{
	bool bVar0;
	...
	if ((((!func_363(PLAYER::PLAYER_ID()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger")) && iParam0 != func_362(1)) && !bVar0)
	{
		return 0;
	}
	return 1;
...
int func_362(bool bParam0)//Position - 0x2FEDF
{
	if (bParam0)
	{
...
int func_363(int iParam0)//Position - 0x2FEF9
{
	if (iParam0 != func_224())
	{
...
int func_364(int iParam0)//Position - 0x2FF1F
{
...
int func_365(int iParam0)//Position - 0x2FF4E
{
	...
	if (func_368(PLAYER::PLAYER_ID()) && ((((!func_361(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("openwheel1"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("openwheel2"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("formula"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("formula2"))))
	{
		return 0;
	}
...
int func_366(int iParam0)//Position - 0x30095
{
	int iVar0;
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_357(iParam0)) || func_367(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_367(int iParam0)//Position - 0x30112
{
	switch (iParam0)
	{
		case joaat("mule"):
...
int func_368(int iParam0)//Position - 0x3016E
{
	if (iParam0 == func_224())
	{
		return 0;
...
int func_369(int iParam0, bool bParam1)//Position - 0x301A7
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_370(int iParam0)//Position - 0x30202
{
	int iVar0;
...
int func_371(int iParam0, int iParam1)//Position - 0x3023B
{
	if (iParam1 == 0)
	{
...
int func_380(int iParam0, int iParam1)//Position - 0x30736
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_381(int iParam0)//Position - 0x30B15
{
	if (PLAYER::PLAYER_ID() != func_224())
	{
		...
		if (((func_385(PLAYER::PLAYER_ID(), 1, 0) && Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_268.f_35 > 0) || BitTest(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_268.f_33, 14)) || BitTest(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_268.f_33, 11))
		{
			return 0;
		}
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("Player_Vehicle", 3))
		{
			if (DECORATOR::DECOR_EXIST_ON(iParam0, "Player_Vehicle"))
			{
				if (DECORATOR::DECOR_GET_INT(iParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
				{
					...
					{
						if (!func_382(iParam0) || ENTITY::GET_ENTITY_MODEL(iParam0) != Global_1586521[func_383() /*142*/].f_66)
						{
							return 1;
						}
					}
...
int func_382(int iParam0)//Position - 0x30C0E
{
...
int func_385(int iParam0, bool bParam1, bool bParam2)//Position - 0x30C4C
{
	if (iParam0 == func_224())
	{
		return 0;
...
int func_386(int iParam0)//Position - 0x30CB0
{
...
int func_388()//Position - 0x30CEF
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

int func_389(int iParam0)//Position - 0x30D07
{
	if (iParam0 != func_224())
	{
		if (func_355(iParam0, 1, 1))
...
int func_390(int iParam0)//Position - 0x30D66
{
	if (iParam0 != func_224())
	{
		if (func_355(iParam0, 1, 1))
...
int func_391(int iParam0)//Position - 0x30DC6
{
	if (iParam0 != func_224())
	{
		if (func_355(iParam0, 1, 1))
...
int func_392(int iParam0, bool bParam1, var uParam2)//Position - 0x30E0D
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_360(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_393(int iParam0)//Position - 0x31204
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_394(int iParam0, int iParam1)//Position - 0x31239
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_395(int iParam0, var uParam1)//Position - 0x3143B
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_396(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_397(int iParam0)//Position - 0x31796
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_398(int iParam0)//Position - 0x317B6
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_276(iParam0, 0, 0)) || func_276(iParam0, 1, 0)) || func_276(iParam0, 2, 0)) || func_412(iParam0) != 145) || func_411(iParam0)) || func_410(iParam0)) || func_352(iParam0)) || func_409(iParam0)) || !func_399(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_410(iParam0))
		{
		}
...
int func_399(int iParam0)//Position - 0x31893
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_400(int iParam0, bool bParam1, int iParam2)//Position - 0x31A51
{
	int iVar0;
	struct<2> Var1;
...
int func_401(int iParam0)//Position - 0x31BD6
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_403(int iParam0, int iParam1)//Position - 0x31CB9
{
	int iVar0;
	int iVar1;
...
int func_404()//Position - 0x31F0A
{
	return 0;
}

int func_405()//Position - 0x31F13
{
	return 1;
}

int func_406()//Position - 0x31F1C
{
	return 1;
}

int func_407()//Position - 0x31F25
{
...
int func_409(int iParam0)//Position - 0x31FF6
{
	int iVar0;
	char* sVar1;
...
int func_410(int iParam0)//Position - 0x3203D
{
	int iVar0;
...
int func_411(int iParam0)//Position - 0x320B9
{
	int iVar0;
...
int func_412(int iParam0)//Position - 0x321A1
{
	int iVar0;
...
void func_413(int iParam0, int iParam1)//Position - 0x32204
{
	int iVar0;
...
void func_414(int iParam0)//Position - 0x32286
{
	if (!func_415(*iParam0))
	{
...
bool func_415(int iParam0)//Position - 0x322B1
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_416(int iParam0, var uParam1, var uParam2)//Position - 0x322C0
{
	int iVar0;
	int iVar1;
	...
	if (func_380(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_419(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_419(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_418(iParam0);
	if (func_417(*iParam0))
	{
...
int func_417(int iParam0)//Position - 0x3249A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_419(int iParam0, int iParam1)//Position - 0x325CD
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_420(int iParam0, int iParam1)//Position - 0x326B6
{
	int iVar0;
...
int func_421(int iParam0, int iParam1, int iParam2)//Position - 0x32718
{
	if (!func_422() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_422()//Position - 0x3273C
{
	return 0;
}

int func_423(var uParam0, int iParam1)//Position - 0x32745
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_424(int iParam0, var uParam1, int iParam2)//Position - 0x32786
{
	int iVar0;
...
void func_425(int iParam0, int iParam1)//Position - 0x329E2
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98844[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98844[iVar0]) == func_426(iParam0, iParam1))
				{
...
int func_426(int iParam0, int iParam1)//Position - 0x32A80
{
	struct<82> Var0;
...
void func_427(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x32AC2
{
	int iVar0;
...
int func_430(int iParam0, int iParam1)//Position - 0x32D4D
{
	int iVar0;
...
int func_432(var uParam0, int iParam1)//Position - 0x32DCB
{
	int iVar0;
	int iVar1;
...
bool func_433(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x344BA
{
	if (bParam6)
	{
...
int func_434(struct<3> Param0, float fParam3)//Position - 0x34501
{
	return func_435(&(Global_107514.f_2890), Param0, fParam3, 0);
}

int func_435(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x3451B
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_436(int iParam0)//Position - 0x347CE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_437(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x34891
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_433(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
int func_438(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x34A99
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_439(int iParam0, int iParam1, bool bParam2)//Position - 0x34B14
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_440(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x34B75
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_396(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_396(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_396(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					...
					{
						MISC::SET_BIT(&(uParam1->f_77), func_396(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("surfer3"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_396(iVar5));
				}
				iVar5++;
			}
		}
		...
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar6 <= 2)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_396(iVar6));
				}
				iVar6++;
			}
		}
		...
		if ((((func_442() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_362(1)))
		{
...
int func_441(int iParam0, float fParam1)//Position - 0x3527A
{
	struct<3> Var0;
	float fVar3;
...
int func_443(var uParam0)//Position - 0x3537A
{
	int iVar0;
...
int func_444(int iParam0)//Position - 0x3539E
{
	int iVar0;
...
var func_446(var uParam0, var uParam1)//Position - 0x353D0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_447(int iParam0, int iParam1)//Position - 0x353F3
{
	int iVar0;
	int iVar1;
...
int func_449(int iParam0)//Position - 0x3547C
{
	int iVar0;
...
int func_450(int iParam0)//Position - 0x354C7
{
...
int func_451(int iParam0)//Position - 0x354E7
{
	switch (iParam0)
	{
		case 161:
...
int func_452(int iParam0)//Position - 0x3553A
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
...
int func_453(int iParam0)//Position - 0x355C1
{
...
int func_454(int iParam0)//Position - 0x355F3
{
...
int func_455(int iParam0)//Position - 0x35610
{
...
int func_456(int iParam0, int iParam1)//Position - 0x35633
{
	if (func_262(iParam0))
	{
...
int func_457(int iParam0)//Position - 0x35677
{
	if (func_262(iParam0))
	{
		if (func_456(iParam0, 0))
...
int func_458(int iParam0, int iParam1)//Position - 0x356A3
{
	int iVar0;
...
int func_459(var uParam0)//Position - 0x356F0
{
	if (func_460(uParam0))
	{
...
int func_460(var uParam0)//Position - 0x35725
{
...
int func_464(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x357C9
{
...
int func_466(int iParam0)//Position - 0x358CC
{
	switch (iParam0)
	{
		case joaat("police"):
...
int func_468(var uParam0)//Position - 0x3596F
{
	int iVar0[5];
	int iVar6[3];
	struct<3> Var10[3];
	...
	switch (iLocal_77)
	{
		...
		case 1:
			if (!func_473(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar30))
			{
				return 0;
			}
			iLocal_77 = 2;
		...
		case 2:
			...
			if (func_233(uParam0->f_28[0]))
			{
				...
				{
					func_469(&(uParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
...
void func_469(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x35EB6
{
	func_268(iParam0);
...
int func_470(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x35EDD
{
	if (func_471(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_471(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x35F39
{
	int iVar0;
...
int func_472(var uParam0, int iParam1)//Position - 0x35FC7
{
	int iVar0;
...
int func_473(int iParam0)//Position - 0x3600D
{
	int iVar0;
...
void func_475()//Position - 0x36062
{
	...
	func_488(&(iLocal_147[0]), 0);
	func_488(&(iLocal_147[1]), 0);
	func_488(&iLocal_145, 0);
	func_488(&iLocal_146, 0);
	...
	HUD::CLEAR_PRINTS();
	func_486(&(Local_83.f_28[0]), 1, 0, 1);
	func_476(&Local_83, 1, 0, 0);
...
void func_481(int* iParam0)//Position - 0x361D9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_482(int* iParam0)//Position - 0x36211
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_483(int iParam0)//Position - 0x362AD
{
	if (func_234(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_486(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3632A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_488(int* iParam0, bool bParam1)//Position - 0x36397
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_491(char* sParam0, int iParam1)//Position - 0x36543
{
	if (Global_101533 != 12)
	{
...
int func_492(char* sParam0, int iParam1, int iParam2)//Position - 0x3656B
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_498())
	{
		...
		{
			iVar33 = func_493(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_493(char* sParam0)//Position - 0x366FA
{
...
int func_495(char* sParam0, bool bParam1)//Position - 0x36778
{
	int iVar0;
	int iVar1;
...
int func_496(int iParam0, bool bParam1)//Position - 0x367A2
{
	int iVar0;
...
int func_512(int iParam0)//Position - 0x36B73
{
	if (!func_154(iParam0))
	{
		return func_153(iParam0);
