...
void func_254()//Position - 0x27FF7
{
	switch (iLocal_42)
	{
		...
		case 1:
			...
			{
				ENTITY::SET_ENTITY_COORDS(iLocal_45, -261.1132f, 294.1956f, 90.68612f, false, false, false, true);
...
int func_420(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x36FAF
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_422(iParam0, uVar1[iVar3], 1) && func_421(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
