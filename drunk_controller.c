...
void func_2()//Position - 0xE3
{
	...
	if (Global_45217 > iVar1 || Global_45217 == -1)
	{
		...
		{
			CAM::SHAKE_GAMEPLAY_CAM("DRUNK_SHAKE", ((Global_45220 * fVar3) * fVar5));
		}
		if ((MISC::GET_GAME_TIMER() % 100) == 0)
		{
			...
			else
			{
				...
				CAM::SET_GAMEPLAY_CAM_SHAKE_AMPLITUDE(((Global_45220 * fVar3) * fVar5));
				CAM::SET_GAMEPLAY_CAM_MOTION_BLUR_SCALING_THIS_UPDATE(((Global_45219 * fVar3) * fVar5));
				fLocal_26 = fVar3;
			}
		}
		if (((Global_45219 * fVar3) * fVar5) < 1f)
		{
			CAM::SET_GAMEPLAY_CAM_MAX_MOTION_BLUR_STRENGTH_THIS_UPDATE(((Global_45219 * fVar3) * fVar5));
		}
		else
		{
		...
		{
			CAM::SHAKE_CINEMATIC_CAM("DRUNK_SHAKE", (((Global_45220 * Global_45214) * fVar3) * fVar5));
		}
		CAM::SET_CINEMATIC_CAM_SHAKE_AMPLITUDE((((Global_45220 * Global_45214) * fVar3) * fVar5));
		if (CAM::DOES_CAM_EXIST(Global_45216))
		{
			if (CAM::IS_CAM_SHAKING(Global_45216))
			{
				CAM::SET_CAM_SHAKE_AMPLITUDE(Global_45216, ((Global_45220 * fVar3) * fVar5));
			}
		}
