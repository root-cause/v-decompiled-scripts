...
void func_2()//Position - 0xE3
{
	...
	if (Global_45089 > iVar1 || Global_45089 == -1)
	{
		...
		{
			fVar6 = (Global_45093 - Global_45092);
			Global_45092 = (Global_45092 + (fVar6 * 0.1f));
		...
		{
			CAM::SHAKE_GAMEPLAY_CAM("DRUNK_SHAKE", ((Global_45092 * fVar3) * fVar5));
		}
		if ((MISC::GET_GAME_TIMER() % 100) == 0)
		{
			...
			else
			{
				...
				CAM::SET_GAMEPLAY_CAM_SHAKE_AMPLITUDE(((Global_45092 * fVar3) * fVar5));
				CAM::SET_GAMEPLAY_CAM_MOTION_BLUR_SCALING_THIS_UPDATE(((Global_45091 * fVar3) * fVar5));
				fLocal_26 = fVar3;
			}
		}
		if (((Global_45091 * fVar3) * fVar5) < 1f)
		{
			CAM::SET_GAMEPLAY_CAM_MAX_MOTION_BLUR_STRENGTH_THIS_UPDATE(((Global_45091 * fVar3) * fVar5));
		}
		else
		{
		...
		{
			CAM::SHAKE_CINEMATIC_CAM("DRUNK_SHAKE", (((Global_45092 * Global_45086) * fVar3) * fVar5));
		}
		CAM::SET_CINEMATIC_CAM_SHAKE_AMPLITUDE((((Global_45092 * Global_45086) * fVar3) * fVar5));
		if (CAM::DOES_CAM_EXIST(Global_45088))
		{
			if (CAM::IS_CAM_SHAKING(Global_45088))
			{
				CAM::SET_CAM_SHAKE_AMPLITUDE(Global_45088, ((Global_45092 * fVar3) * fVar5));
			}
		}
		...
		if (Global_45095 > 0f)
		{
			...
			else
			{
				...
				iVar7 = (Global_45089 - iVar1);
				if (iVar7 <= (Global_45090 / 2) && Global_45089 != -1)
				{
					bVar8 = false;
...
float func_14()//Position - 0x71D
{
	...
	fVar1 = 1f;
	iVar2 = (Global_45089 - iVar0);
	if (iVar2 <= Global_45090)
	{
		if (Global_45089 != -1)
		{
			fVar1 = (SYSTEM::TO_FLOAT(iVar2) / SYSTEM::TO_FLOAT(Global_45090));
		}
	}
	return fVar1;
}
...
void func_16(int iParam0)//Position - 0x770
{
	...
	Global_44908[iVar0 /*5*/] = func_17();
	Global_44908[iVar0 /*5*/].f_1 = Global_44882[iParam0 /*5*/].f_1;
	Global_44908[iVar0 /*5*/].f_2 = 0;
	Var1 = { Global_44882[iParam0 /*5*/] };
...
void func_23()//Position - 0x9C8
{
	...
	{
		iVar0 = func_29(Global_44908[iLocal_14 /*5*/], 0);
		if (iVar0 == -1)
		{
...
void func_28(int iParam0)//Position - 0xABE
{
	...
	while (iVar0 < 16)
	{
		if (iParam0 == Global_44989[iVar0 /*6*/].f_1)
		{
			func_21(iVar0);
		}
		iVar0++;
...
int func_29(int iParam0, int iParam1)//Position - 0xAF0
{
	...
	while (iVar0 < 16)
	{
		if (iParam1 == Global_44989[iVar0 /*6*/].f_2)
		{
