...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	Local_78 = { -1593.813f, 5221.235f, 1.94482f };
	Local_79 = { -1603.986f, 5243.624f, 4.940323f };
...
void func_1()//Position - 0xF6
{
	switch (iLocal_87)
	{
		...
		case 4:
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				...
				if (func_306(PLAYER::PLAYER_PED_ID()) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
				{
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), -1606.534f, 5253.981f, 2.9994f, 1f, 20000, 0.25f, 0, 40000f);
				...
				if (func_306(iLocal_83) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Abigail", 0))
				{
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_83, -1581.559f, 5198.014f, 3.0091f, 1f, 20000, 0.25f, 0, 40000f);
				}
			}
			else
			{
		...
		case 5:
			...
			{
				if (func_226("DIVING_HELP" /* GXT: A Dinghy is now available at the Marina property to search for the missing submarine pieces. */))
				{
					HUD::CLEAR_HELP(true);
				}
			...
			else if (!func_226("DIVING_HELP" /* GXT: A Dinghy is now available at the Marina property to search for the missing submarine pieces. */))
			{
...
int func_34(int iParam0, int iParam1, int iParam2)//Position - 0x1986
{
	int iVar0;
...
int func_35(int iParam0)//Position - 0x1A12
{
	switch (iParam0)
	{
...
int func_36(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1A4D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_38(int iParam0, int iParam1, int iParam2)//Position - 0x22E7
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
int func_41(int iParam0, int iParam1, int iParam2)//Position - 0x29F1
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_42(int iParam0, int iParam1, int iParam2)//Position - 0x2A8A
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2E32
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_45(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x39E5
{
	int iVar0;
...
int func_46(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3CC9
{
	int iVar0;
...
int func_47(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3F90
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3FC7
{
	int iVar0;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x3FF0
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_55(int iParam0, int iParam1)//Position - 0x491E
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_56(int iParam0)//Position - 0x4CC5
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_58(int iParam0, int iParam1)//Position - 0x4E22
{
	int iVar0;
...
int func_60(int iParam0)//Position - 0x501B
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_61(int iParam0)//Position - 0x507A
{
	switch (iParam0)
	{
		case 0:
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5100
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_63(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x537D
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_65(int iParam0, int iParam1)//Position - 0x5A95
{
	int iVar0;
	int iVar1;
...
int func_67(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5B3B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_68(int iParam0)//Position - 0x5B92
{
...
void func_69(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x5C3E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_70(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x5C88
{
	int iVar0;
...
int func_71(var uParam0)//Position - 0x5CB8
{
	int iVar0;
	int iVar1;
...
int func_72(int iParam0, int iParam1, int iParam2)//Position - 0x5CEC
{
	int iVar0;
	var uVar1;
...
bool func_73(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x5D29
{
	int iVar0;
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x827C
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_75(int iParam0)//Position - 0x911F
{
	if (!BitTest(Global_78130[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x91FD
{
	switch (iParam0)
	{
		case 0:
...
void func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x9D06
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_81(int iParam0, int iParam1)//Position - 0x9D4E
{
	int iVar0;
	struct<17> Var1;
...
void func_82(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBB96
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var2;
...
int func_83(int iParam0)//Position - 0xBD80
{
	switch (iParam0)
	{
		case 0:
...
void func_84(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xBE30
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
void func_87(int iParam0)//Position - 0xBFE3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
bool func_89(int iParam0, int iParam1, var uParam2)//Position - 0xD5C2
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_90(int iParam0, int iParam1)//Position - 0xD9C7
{
	switch (iParam1)
	{
		case 0:
...
int func_91(int iParam0, int iParam1)//Position - 0xDDC2
{
	switch (iParam1)
	{
		case 0:
...
int func_92(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE1BD
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_93(int iParam0)//Position - 0xE1FC
{
	return Global_43052 == iParam0;
}

int func_94(int iParam0)//Position - 0xE20A
{
	switch (iParam0)
	{
		case -1:
...
void func_96(int iParam0)//Position - 0xE564
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_97(int iParam0)//Position - 0xE6B1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_98(int iParam0)//Position - 0xEBBE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(int iParam0)//Position - 0xECA5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_101(int iParam0)//Position - 0xED8C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149()//Position - 0x1F56C
{
...
int func_151(int iParam0)//Position - 0x1F83C
{
	int iVar0;
	int iVar1;
...
int func_152(int iParam0)//Position - 0x1F879
{
	if (func_154(iParam0))
	{
...
var func_153(int iParam0)//Position - 0x1F89E
{
	return Global_1998[iParam0 /*29*/];
}

bool func_154(int iParam0)//Position - 0x1F8AD
{
	return iParam0 < 3;
}

void func_155(char* sParam0, var uParam1)//Position - 0x1F8B9
{
...
void func_157()//Position - 0x1F950
{
	int iVar0;
...
struct<2> func_158(int iParam0)//Position - 0x1FA4D
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_159(int iParam0)//Position - 0x1FA84
{
	struct<2> Var0;
...
void func_160(int iParam0, int iParam1)//Position - 0x1FED0
{
...
void func_161(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x1FF1A
{
...
void func_162(int iParam0, bool bParam1, bool bParam2)//Position - 0x1FFB7
{
	struct<4> Var0;
	char* sVar1;
...
void func_163(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x1FFF6
{
...
void func_164(int iParam0, var uParam1)//Position - 0x2003B
{
	switch (iParam0)
	{
		case 0:
...
int func_166(int iParam0)//Position - 0x21281
{
	switch (iParam0)
	{
		case 0:
...
void func_167(int iParam0)//Position - 0x215C7
{
	Global_43603 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_168()//Position - 0x215D9
{
	if (Global_97753)
	{
		func_157();
...
char* func_169(var uParam0)//Position - 0x2160B
{
	uParam0 = uParam0;
	return "";
}

void func_170()//Position - 0x2161A
{
	char cVar0[24];
...
bool func_171()//Position - 0x2165D
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_172()//Position - 0x21673
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_173(int iParam0, int iParam1)//Position - 0x21689
{
	Global_97748 = iParam0;
	Global_97749 = iParam1;
}

void func_174()//Position - 0x2169D
{
	if (Global_78573 != 6)
	{
	}
...
void func_175(var uParam0)//Position - 0x216D5
{
	if (*uParam0 == -1)
	{
		return;
...
void func_176(int iParam0, bool bParam1)//Position - 0x21712
{
	struct<26> Var0;
	int iVar1;
	bool bVar2;
...
int func_177(int iParam0)//Position - 0x2188F
{
	switch (iParam0)
	{
		case 0:
...
void func_178(int iParam0)//Position - 0x21C16
{
	func_180(iParam0, 1);
...
int func_179()//Position - 0x21C4C
{
	return (Global_113386.f_10016.f_21 + Global_113386.f_18574.f_380);
}

void func_180(var uParam0, bool bParam1)//Position - 0x21C68
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_181(int iParam0)//Position - 0x21F8C
{
...
void func_182(int iParam0)//Position - 0x21FBF
{
	switch (iParam0)
	{
		case 30:
...
void func_184(int iParam0, int iParam1)//Position - 0x2204C
{
	switch (iParam0)
	{
		case 12:
...
void func_185(int iParam0, bool bParam1)//Position - 0x22135
{
	if (bParam1)
	{
...
bool func_186(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x2215E
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_188()//Position - 0x22ADD
{
	return Global_31960;
}

int func_189(var uParam0, int iParam1)//Position - 0x22AE8
{
	int iVar0;
...
int func_190(int iParam0)//Position - 0x26283
{
	switch (iParam0)
	{
		case 46:
...
void func_191(int iParam0, bool bParam1)//Position - 0x26372
{
	switch (iParam0)
	{
		case 46:
...
void func_192(int iParam0, bool bParam1)//Position - 0x263C3
{
	int iVar0;
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (!func_199(iParam0))
		{
			...
			if (!bParam1)
			{
				...
				if (!func_196(68))
				{
					func_193("DI_HLP_STRY" /* GXT: Story characters become available in Rockstar Editor's 'Director Mode' as the GTAV story progresses. */, 2, 0, 20000, 10000, 7, 0, 208, 0);
				}
			}
		}
	}
...
void func_195()//Position - 0x2661D
{
	int iVar0;
...
int func_196(int iParam0)//Position - 0x26734
{
	int iVar0;
	int iVar1;
...
void func_197(char* sParam0)//Position - 0x26774
{
...
char* func_198(int iParam0)//Position - 0x26798
{
	switch (iParam0)
	{
		case 0:
...
int func_199(int iParam0)//Position - 0x2696B
{
...
void func_200(int iParam0, int iParam1)//Position - 0x26995
{
...
int func_201(char* sParam0)//Position - 0x269D2
{
	int iVar0;
		...
		if (bParam2)
		{
			if (!Global_78319)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8795[iParam1 /*4*/] = { func_206(iParam0) };
					...
					{
						Global_8746[1 /*6*/] = { func_206(iParam0) };
...
void func_205()//Position - 0x26C04
{
	char cVar0[64];
	char cVar1[64];
	char* sVar2;
...
struct<4> func_206(int iParam0)//Position - 0x26C7F
{
	return Global_1998[iParam0 /*29*/].f_3;
}

int func_207(int iParam0, int iParam1)//Position - 0x26C92
{
...
int func_208(int iParam0, int iParam1)//Position - 0x26CBC
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_209(int iParam0, int iParam1, int iParam2)//Position - 0x26CE6
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_210(int iParam0, int iParam1, int iParam2)//Position - 0x26D2B
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_211()//Position - 0x26D70
{
	if (func_93(14))
	{
...
int func_212()//Position - 0x26E12
{
	func_157();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_213(int* iParam0)//Position - 0x26E2B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_214(var uParam0, bool bParam1, bool bParam2)//Position - 0x26E6C
{
	int iVar0;
...
int func_216(int iParam0)//Position - 0x2700B
{
	if (func_306(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
bool func_218()//Position - 0x2716E
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_219(int iParam0, int iParam1)//Position - 0x27188
{
	bool bVar0;
...
int func_220(int iParam0, bool bParam1)//Position - 0x271D3
{
	int iVar0;
	int iVar1;
...
int func_221(int iParam0)//Position - 0x27214
{
...
bool func_222()//Position - 0x27253
{
	return BitTest(Global_2621446, 3);
}

int func_223(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x27261
{
	int iVar0;
...
void func_225(int iParam0)//Position - 0x272BB
{
	if (iParam0 == 1)
	{
...
bool func_226(char* sParam0)//Position - 0x272DE
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

int func_227(int iParam0)//Position - 0x272F1
{
...
void func_229(int iParam0)//Position - 0x2736D
{
	if (iParam0 == -1)
	{
		return;
...
void func_231(int iParam0, int iParam1, bool bParam2)//Position - 0x273EF
{
	if (iParam0 == -1)
	{
		return;
...
int func_232(int iParam0, int iParam1)//Position - 0x2742A
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_233(int iParam0, bool bParam1)//Position - 0x2744A
{
...
Vector3 func_235(int iParam0)//Position - 0x27644
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_236(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x27657
{
	struct<3> Var0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103950.f_4))
	{
		...
		{
			if (func_284(24) != Global_103950.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_281(ENTITY::GET_ENTITY_COORDS(Global_103950.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_237(Global_103950.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_237(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x276D2
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_271(iParam3, &Var0, Param1, fParam2, func_274(iParam0));
...
void func_238(int iParam0, int iParam1, int iParam2)//Position - 0x277FB
{
	...
	if (!func_268(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_255(iParam0, 0, 0)) || func_255(iParam0, 1, 0)) || func_255(iParam0, 2, 0)) || func_274(iParam0) != 145) || func_254(iParam0)) || func_253(iParam0)) || func_252(iParam0)) || func_251(iParam0)) || !func_241(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_253(iParam0))
		{
		}
...
int func_243(int iParam0)//Position - 0x27F22
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_245(int iParam0)//Position - 0x28007
{
	int iVar0;
	int iVar1;
...
int func_246()//Position - 0x2B2D8
{
	return 0;
}

int func_247()//Position - 0x2B2E1
{
	return 1;
}

int func_248()//Position - 0x2B2EA
{
	return 1;
}

int func_249()//Position - 0x2B2F3
{
...
int func_252(int iParam0)//Position - 0x2B40A
{
	int iVar0;
...
int func_253(int iParam0)//Position - 0x2B445
{
	int iVar0;
...
int func_254(int iParam0)//Position - 0x2B4C1
{
	int iVar0;
...
int func_256(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2B617
{
...
void func_258(var uParam0, int iParam1)//Position - 0x2B735
{
	if (iParam1 <= 0)
	{
		return;
...
void func_259(var uParam0, int iParam1)//Position - 0x2B7BB
{
...
void func_260(var uParam0, int iParam1)//Position - 0x2B7EE
{
	int iVar0;
	int iVar1;
...
int func_261(int iParam0, int iParam1)//Position - 0x2B83F
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_262(int iParam0)//Position - 0x2B8E1
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_263(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_263(bool bParam0, int iParam1, int iParam2)//Position - 0x2B903
{
	if (bParam0)
	{
		return iParam1;
...
int func_264(var uParam0)//Position - 0x2B91A
{
	return uParam0 & 15;
}

void func_265(var uParam0, int iParam1)//Position - 0x2B927
{
...
void func_266(var uParam0, int iParam1)//Position - 0x2B961
{
...
void func_267(var uParam0, int iParam1)//Position - 0x2B99C
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_268(var uParam0, int iParam1)//Position - 0x2B9D8
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_275(Global_113386.f_32749.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_275(Global_113386.f_2363.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_275(Global_113386.f_2363.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_269(int iParam0, int iParam1)//Position - 0x2D0C7
{
	struct<82> Var0;
...
void func_270(int iParam0, var uParam1, int iParam2)//Position - 0x2D109
{
	int iVar0;
...
void func_271(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x2D365
{
	if (func_268(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_273(iParam0);
			func_272(uParam1, &(Global_113386.f_32749.f_69[Global_77137.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_272(var uParam0, var uParam1)//Position - 0x2D45E
{
...
int func_274(int iParam0)//Position - 0x2D5A1
{
	int iVar0;
...
bool func_275(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x2D604
{
	if (bParam2)
	{
...
int func_277(int iParam0)//Position - 0x2D8F6
{
	switch (iParam0)
	{
		case 1:
...
int func_278(int iParam0, var uParam1, var uParam2)//Position - 0x2D9A6
{
	int iVar0;
	int iVar1;
...
int func_279(int iParam0)//Position - 0x2DB99
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_281(struct<3> Param0, int iParam1, var uParam2, var uParam3)//Position - 0x2DBE0
{
	int iVar0;
...
int func_282(struct<3> Param0, int iParam1, int iParam2)//Position - 0x2DCF6
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_283(int iParam0)//Position - 0x2DD85
{
	return BitTest(Global_113386.f_7229[iParam0], 0);
}

int func_284(int iParam0)//Position - 0x2DD9A
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_287(struct<3> Param0)//Position - 0x2E1D5
{
...
int func_288(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x2E1FF
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_289(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x2E4F5
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_290(struct<3> Param0)//Position - 0x2E5A9
{
	float fVar0;
	float fVar1;
...
void func_291(int iParam0)//Position - 0x2E5E8
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_293(int iParam0, float fParam1, int iParam2)//Position - 0x2E66D
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_300(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
bool func_294()//Position - 0x2E741
{
	bool bVar0;
...
void func_295()//Position - 0x2E764
{
	Global_20471 = 0;
	func_296();
}

void func_296()//Position - 0x2E774
{
...
void func_298()//Position - 0x2E7ED
{
...
int func_299(int iParam0, int iParam1)//Position - 0x2E83E
{
	if (func_216(iParam0))
	{
...
int func_300(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2E871
{
...
void func_301(int iParam0)//Position - 0x2EA09
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
float func_303(int iParam0, int iParam1, bool bParam2)//Position - 0x2EAAB
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_306(int iParam0)//Position - 0x2EB5E
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_307()//Position - 0x2EB7F
{
	func_309(0);
	func_298();
	func_308();
...
void func_308()//Position - 0x2EB94
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_300(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_309(int iParam0)//Position - 0x2EBEC
{
	if (func_314())
	{
		return;
...
void func_310(int iParam0)//Position - 0x2EC1F
{
	if (func_314())
	{
		return;
...
void func_311(bool bParam0, bool bParam1)//Position - 0x2ECA9
{
	if (bParam0)
	{
		if (func_313(0))
...
bool func_312()//Position - 0x2ED1D
{
	return BitTest(Global_1958711, 5);
}

int func_313(int iParam0)//Position - 0x2ED2B
{
	if (iParam0 == 1)
	{
...
bool func_314()//Position - 0x2ED82
{
	...
	if (Global_78573 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_317(Global_78574, Global_78576, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
float func_316(char* sParam0)//Position - 0x2F076
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_317(int iParam0, int iParam1, int iParam2)//Position - 0x2F089
{
	struct<2> Var0;
	int iVar1;
...
char* func_318(int iParam0)//Position - 0x2F15F
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_319(int iParam0)//Position - 0x2F2B2
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_320(int iParam0)//Position - 0x2F2E5
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_321(int iParam0)//Position - 0x2F318
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_322(int iParam0)//Position - 0x2F34B
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_323(int iParam0)//Position - 0x2F37E
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_324(int iParam0)//Position - 0x2F3BB
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_325(int iParam0)//Position - 0x2F3EE
{
	struct<2> Var0;
...
int func_326(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2F457
{
	if (((!func_328(0) || Global_78588) || Global_78577 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78573)
...
bool func_327(bool bParam0)//Position - 0x2F56F
{
	if (bParam0)
	{
...
int func_328(int iParam0)//Position - 0x2F598
{
	if (Global_43052 == 15)
	{
		return 0;
...
bool func_329(int iParam0)//Position - 0x2F5BA
{
	return func_330(iParam0, Global_43052);
}

int func_330(int iParam0, int iParam1)//Position - 0x2F5CB
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_331(var uParam0, var uParam1)//Position - 0x2F7AC
{
	*uParam0 = *uParam1;
	*uParam1 = 0;
}
...
void func_333(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2F7E2
{
...
void func_336(int* iParam0, bool bParam1)//Position - 0x2F852
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_337(int* iParam0)//Position - 0x2F88D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_338(var uParam0, bool bParam1)//Position - 0x2F8B8
{
	func_339(&(uParam0->f_35), bParam1);
}

void func_339(var uParam0, bool bParam1)//Position - 0x2F8CA
{
	int iVar0;
...
void func_340(int* iParam0)//Position - 0x2F907
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_341(int* iParam0)//Position - 0x2F93F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_342(int iParam0)//Position - 0x2F9DB
{
	if (func_306(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_343(var uParam0, int iParam1)//Position - 0x2FA05
{
	func_344(&(uParam0->f_28), iParam1);
}

void func_344(var uParam0, int iParam1)//Position - 0x2FA17
{
	int iVar0;
...
void func_345(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2FA58
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_347(char* sParam0, int iParam1)//Position - 0x2FB78
{
	if (Global_100441 != 12)
	{
...
int func_349(char* sParam0)//Position - 0x2FD2F
{
...
int func_350()//Position - 0x2FD85
{
	...
	iVar0 = func_351(&(Global_100441.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_351(char* sParam0, bool bParam1)//Position - 0x2FDA9
{
	int iVar0;
	int iVar1;
...
int func_352(int iParam0, bool bParam1)//Position - 0x2FDD3
{
	int iVar0;
...
int func_354()//Position - 0x2FE59
{
	...
	{
		if (func_349(&(Global_100441.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_355(bool bParam0)//Position - 0x2FEC5
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_356(int iParam0)//Position - 0x2FED9
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_357(int iParam0)//Position - 0x2FF13
{
	if (iParam0 == 1)
	{
...
void func_358()//Position - 0x2FF4D
{
	Global_23011.f_5 = 1;
}

void func_359()//Position - 0x2FF5B
{
	Global_23011.f_5 = 0;
}

void func_360(bool bParam0)//Position - 0x2FF69
{
	if (bParam0)
	{
		func_361();
...
void func_361()//Position - 0x2FFCC
{
...
void func_362()//Position - 0x2FFF5
{
	Global_94617 = 0;
	Global_94618 = 0;
}

int func_363()//Position - 0x30008
{
...
void func_364()//Position - 0x30046
{
	Global_100476 = 1;
...
void func_365(char* sParam0)//Position - 0x30133
{
...
void func_367(var uParam0)//Position - 0x30165
{
	int iVar0;
...
int func_368(int iParam0)//Position - 0x3019F
{
	if (!func_154(iParam0))
	{
		return func_153(iParam0);
