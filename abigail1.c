...
void func_234(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x276E4
{
	int iVar0;
...
void func_236(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x278B5
{
	struct<3> Var0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104212.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104212.f_4, false))
		{
			if (func_284(24) != Global_104212.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_281(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
...
void func_237(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x27930
{
	struct<60> Var0;
...
void func_271(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x2D93A
{
	if (func_268(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
...
bool func_275(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x2DBD9
{
	if (bParam2)
	{
...
int func_281(struct<3> Param0, int iParam1, var uParam2, var uParam3)//Position - 0x2E1B5
{
	int iVar0;
...
int func_282(struct<3> Param0, int iParam1, int iParam2)//Position - 0x2E2CB
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_285(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x2E38B
{
	func_286(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_286(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x2E3B4
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_288(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x2E7D4
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_289(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x2EACA
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_315(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2F366
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_317(Global_78814, Global_78816, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
