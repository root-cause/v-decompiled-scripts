...
void __EntryFunction__()//Position - 0x0
{
	...
	func_331(&iLocal_149, &(Local_88.f_28[0]));
	while (true)
	{
		SYSTEM::WAIT(0);
		RECORDING::REPLAY_CHECK_FOR_EVENT_THIS_FRAME("SF_DAS", 0);
		func_315(Local_88.f_9, 0, 0, 0, 0, 0);
		func_1();
	}
}
...
void func_1()//Position - 0xF6
{
	switch (iLocal_153)
	{
		...
		case 1:
			func_302();
			if ((func_306(iLocal_149) && ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_149, "rcmabigail", "loop_2_cs", 3)) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_149, "rcmabigail", "loop_2_cs") > 0.99f)
			{
				iLocal_153++;
			}
			break;
		...
		case 4:
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(false))
				{
					...
					CAM::SET_CAM_PARAMS(iLocal_150, -1606.2491f, 5273.9644f, 5.199186f, -1.633685f, 0f, -175.27481f, 30.166092f, 0, 1, 1, 2);
					CAM::SET_CAM_PARAMS(iLocal_150, -1605.6807f, 5274.014f, 3.870102f, -2.089875f, 0f, -178.06396f, 30.166092f, 10000, 1, 1, 2);
				...
				if (func_306(iLocal_149) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Abigail", 0))
				{
					TASK::CLEAR_PED_TASKS(iLocal_149);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_149, -1581.5586f, 5198.0137f, 3.0091f, 1f, 20000, 0.25f, 0, 40000f);
				}
			}
			else
			{
...
void func_70(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x5C8B
{
	int iVar0;
...
int func_71(var uParam0)//Position - 0x5CBB
{
	int iVar0;
	int iVar1;
...
int func_72(int iParam0, int iParam1, int iParam2)//Position - 0x5CEF
{
	int iVar0;
	var uVar1;
...
bool func_73(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x5D2C
{
	int iVar0;
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8540
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_75(int iParam0)//Position - 0x93E3
{
	if (!BitTest(Global_78341[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x942B
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x94D6
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_78(int iParam0, int iParam1)//Position - 0x9586
{
	int iVar0;
	struct<10> Var1;
...
void func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9EB5
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x9FDF
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_81(int iParam0, int iParam1)//Position - 0xA027
{
	int iVar0;
	struct<17> Var1;
...
void func_82(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBE6F
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
struct<14> func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC17C
{
	func_149();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_88(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD4F8
{
	var uVar0;
	int iVar1;
...
int func_90(int iParam0, int iParam1)//Position - 0xDCA1
{
	switch (iParam1)
	{
		case 0:
...
int func_91(int iParam0, int iParam1)//Position - 0xE09C
{
	switch (iParam1)
	{
		case 0:
...
int func_92(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE497
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE5B8
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
int func_150(int iParam0, int iParam1, int iParam2)//Position - 0x1F835
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_151(int iParam0)//Position - 0x1FA8E
{
	int iVar0;
	int iVar1;
...
int func_152(int iParam0)//Position - 0x1FACB
{
	if (func_154(iParam0))
	{
...
var func_153(int iParam0)//Position - 0x1FAF0
{
	return Global_2028[iParam0 /*29*/];
}

bool func_154(int iParam0)//Position - 0x1FAFF
{
	return iParam0 < 3;
}

void func_155(char* sParam0, var uParam1)//Position - 0x1FB0B
{
...
void func_163(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x2024A
{
...
char* func_169(var uParam0)//Position - 0x2185E
{
	uParam0 = uParam0;
	return "";
}
...
void func_175(var uParam0)//Position - 0x21928
{
	if (*uParam0 == -1)
	{
		return;
...
void func_180(var uParam0, bool bParam1)//Position - 0x21EBB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_183(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x22247
{
	if (iParam0 != 198)
	{
		if (Global_78558)
...
void func_194(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2669E
{
	int iVar0;
...
int func_196(int iParam0)//Position - 0x26988
{
	int iVar0;
	int iVar1;
...
int func_199(int iParam0)//Position - 0x26BBF
{
...
int func_201(char* sParam0)//Position - 0x26C26
{
	int iVar0;
...
int func_203(char* sParam0, int iParam1)//Position - 0x26C97
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_204(int iParam0, int iParam1, bool bParam2)//Position - 0x26CE0
{
	int iVar0;
		...
		if (bParam2)
		{
			if (!Global_78558)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8912[iParam1 /*4*/] = { func_206(iParam0) };
					...
					{
						Global_8863[1 /*6*/] = { func_206(iParam0) };
...
struct<4> func_206(int iParam0)//Position - 0x26ED3
{
	return Global_2028[iParam0 /*29*/].f_3;
}

int func_207(int iParam0, int iParam1)//Position - 0x26EE6
{
...
int func_208(int iParam0, int iParam1)//Position - 0x26F10
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_209(int iParam0, int iParam1, int iParam2)//Position - 0x26F3A
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_210(int iParam0, int iParam1, int iParam2)//Position - 0x26F7F
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_211()//Position - 0x26FC4
{
	if (func_93(14))
	{
...
int func_212()//Position - 0x27066
{
	func_157();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_213(int* iParam0)//Position - 0x2707F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_216(int iParam0)//Position - 0x2725F
{
	if (func_306(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_217(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2727F
{
	if (bParam0)
	{
...
bool func_219(int iParam0, int iParam1)//Position - 0x273E6
{
	bool bVar0;
...
int func_221(int iParam0)//Position - 0x27472
{
...
int func_223(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x274BF
{
	int iVar0;
...
bool func_226(char* sParam0)//Position - 0x2753C
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

int func_227(int iParam0)//Position - 0x2754F
{
...
int func_232(int iParam0, int iParam1)//Position - 0x27688
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_234(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x276E4
{
	int iVar0;
...
Vector3 func_235(int iParam0)//Position - 0x278A2
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_236(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x278B5
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104212.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104212.f_4, false))
		{
			if (func_284(24) != Global_104212.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_281(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_237(Global_104212.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_237(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x27930
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_271(iParam5, &Var0, Param1, fParam4, func_274(iParam0));
		func_238(iParam5, iParam0, 0);
	}
}

void func_238(int iParam0, int iParam1, int iParam2)//Position - 0x27A59
{
	int iVar0;
...
void func_239(int iParam0, int iParam1)//Position - 0x27B70
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_240(int iParam0)//Position - 0x27D72
{
...
int func_241(int iParam0)//Position - 0x27E4F
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_242(int iParam0, bool bParam1, int iParam2)//Position - 0x28003
{
	int iVar0;
	struct<2> Var1;
...
int func_243(int iParam0)//Position - 0x28185
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_245(int iParam0, int iParam1)//Position - 0x28268
{
	int iVar0;
	int iVar1;
...
int func_246()//Position - 0x2B898
{
	return 0;
}

int func_247()//Position - 0x2B8A1
{
	return 1;
}

int func_248()//Position - 0x2B8AA
{
	return 1;
}

int func_249()//Position - 0x2B8B3
{
...
int func_251(int iParam0)//Position - 0x2B984
{
	int iVar0;
	char* sVar1;
...
int func_252(int iParam0)//Position - 0x2B9CB
{
	int iVar0;
...
int func_253(int iParam0)//Position - 0x2BA06
{
	int iVar0;
...
int func_254(int iParam0)//Position - 0x2BA82
{
	int iVar0;
...
int func_255(int iParam0, int iParam1, bool bParam2)//Position - 0x2BB6A
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_256(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2BBD8
{
...
var func_262(int iParam0)//Position - 0x2BEA2
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_263(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_263(bool bParam0, int iParam1, int iParam2)//Position - 0x2BEC4
{
	if (bParam0)
	{
		return iParam1;
...
int func_264(var uParam0)//Position - 0x2BEDB
{
	return uParam0 & 15;
}
...
int func_268(var uParam0, int iParam1)//Position - 0x2BF99
{
	int iVar0;
	int iVar1;
...
int func_269(int iParam0, int iParam1)//Position - 0x2D69C
{
	struct<82> Var0;
...
void func_270(int iParam0, var uParam1, int iParam2)//Position - 0x2D6DE
{
	int iVar0;
...
void func_271(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x2D93A
{
	if (func_268(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
...
int func_274(int iParam0)//Position - 0x2DB76
{
	int iVar0;
...
bool func_275(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2DBD9
{
	if (bParam6)
	{
...
void func_276(int iParam0, var uParam1)//Position - 0x2DC20
{
	int iVar0;
...
int func_278(int iParam0, var uParam1, var uParam2)//Position - 0x2DF7B
{
	int iVar0;
	int iVar1;
...
int func_279(int iParam0)//Position - 0x2E16E
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_281(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x2E1B5
{
	int iVar0;
	
	iVar0 = func_282(Param0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_282(struct<3> Param0, int iParam3, int iParam4)//Position - 0x2E2CB
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_283(int iParam0)//Position - 0x2E35A
{
	return BitTest(Global_113648.f_7231[iParam0], 0);
}

int func_284(int iParam0)//Position - 0x2E36F
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_285(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x2E38B
{
	func_286(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_286(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2E3B4
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_288(iVar0, Param0, Param3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_287(struct<3> Param0)//Position - 0x2E7AA
{
...
int func_288(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2E7D4
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_289(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var9) || func_289(Var18[0 /*3*/], Var18[1 /*3*/], Var9, Var15)) || func_289(Var18[0 /*3*/], Var18[1 /*3*/], Var12, Var15)) || func_289(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var12)) || func_289(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var9)) || func_289(Var18[1 /*3*/], Var18[3 /*3*/], Var9, Var15)) || func_289(Var18[1 /*3*/], Var18[3 /*3*/], Var12, Var15)) || func_289(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var12)) || func_289(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var9)) || func_289(Var18[3 /*3*/], Var18[2 /*3*/], Var9, Var15)) || func_289(Var18[3 /*3*/], Var18[2 /*3*/], Var12, Var15)) || func_289(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var12)) || func_289(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var9)) || func_289(Var18[2 /*3*/], Var18[0 /*3*/], Var9, Var15)) || func_289(Var18[2 /*3*/], Var18[0 /*3*/], Var12, Var15)) || func_289(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_289(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2EACA
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_290(struct<3> Param0)//Position - 0x2EB7E
{
	float fVar0;
	float fVar1;
...
void func_291(int iParam0)//Position - 0x2EBBD
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_293(int iParam0, float fParam1, int iParam2)//Position - 0x2EC42
{
	int iVar0;
...
int func_299(int iParam0, int iParam1)//Position - 0x2EE13
{
	if (func_216(iParam0))
	{
...
int func_300(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2EE46
{
...
void func_301(int iParam0)//Position - 0x2EFDE
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_302()//Position - 0x2F00A
{
	if (func_306(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (iLocal_154 == 0)
		{
			if (func_306(iLocal_149))
			{
				if (func_303(PLAYER::PLAYER_PED_ID(), iLocal_149, 1) < 4f || (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 2f && func_303(PLAYER::PLAYER_PED_ID(), iLocal_149, 1) < 6f))
				{
...
float func_303(int iParam0, int iParam1, bool bParam2)//Position - 0x2F080
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_306(int iParam0)//Position - 0x2F133
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_313(int iParam0)//Position - 0x2F300
{
	if (iParam0 == 1)
	{
...
void func_315(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2F366
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_317(Global_78814, Global_78816, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_316(char* sParam0)//Position - 0x2F64B
{
...
int func_326(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2FA2C
{
...
int func_328(int iParam0)//Position - 0x2FB6D
{
	if (Global_43257 == 15)
	{
		return 0;
...
bool func_329(int iParam0)//Position - 0x2FB8F
{
	return func_330(iParam0, Global_43257);
}

int func_330(int iParam0, int iParam1)//Position - 0x2FBA0
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_336(int* iParam0, bool bParam1)//Position - 0x2FE27
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_337(int* iParam0)//Position - 0x2FE62
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_340(int* iParam0)//Position - 0x2FEDC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_341(int* iParam0)//Position - 0x2FF14
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_342(int iParam0)//Position - 0x2FFB0
{
	if (func_306(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_345(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3002F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_347(char* sParam0, int iParam1)//Position - 0x3014F
{
	if (Global_100681 != 12)
	{
...
int func_348(char* sParam0, int iParam1, int iParam2)//Position - 0x30177
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_354())
	{
		...
		{
			iVar33 = func_349(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_352(int iParam0, bool bParam1)//Position - 0x303AA
{
	int iVar0;
...
int func_368(int iParam0)//Position - 0x30775
{
	if (!func_154(iParam0))
	{
		return func_153(iParam0);
