...
void __EntryFunction__()//Position - 0x0
{
	...
	func_335(&iLocal_147, &(Local_86.f_28[0]));
	while (true)
	{
		SYSTEM::WAIT(0);
		RECORDING::REPLAY_CHECK_FOR_EVENT_THIS_FRAME("SF_DAS", 0);
		func_319(Local_86.f_9, 0, 0, 0, 0, 0);
		func_1();
	}
}
...
void func_1()//Position - 0xF6
{
	switch (iLocal_151)
	{
		case 0:
			func_311();
			if (func_310(iLocal_147))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_147, "rcmabigail", "loop_talk", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_147, "rcmabigail", "loop_look", 3))
				{
					TASK::TASK_PLAY_ANIM(iLocal_147, "rcmabigail", "loop_2_cs", 8f, -8f, -1, 2, 0f, false, false, false);
				...
				{
					func_308("ABIGAIL_MCS_1_CONCAT", 1);
					iLocal_151 = 2;
				}
			}
			break;
		...
		case 1:
			func_306();
			if ((func_310(iLocal_147) && ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_147, "rcmabigail", "loop_2_cs", 3)) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_147, "rcmabigail", "loop_2_cs") > 0.99f)
			{
				iLocal_151++;
			}
			break;
		...
		case 2:
			...
			if (func_296(1, 1093140480, 0))
			{
				if (func_310(iLocal_147))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_147, "ABIGAIL", 0, 0, 0);
				}
				func_295();
		...
		case 3:
			...
			{
				func_288(-1608.1659f, 5246.844f, 1.97751f, -1604.4207f, 5238.246f, 4.996789f, 6f, -1596.4615f, 5232.455f, 2.9794f, 25.5125f, 1, 1, 1, 0, 0);
		...
		case 4:
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				...
				{
					iLocal_148 = CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", true);
					CAM::SET_CAM_PARAMS(iLocal_148, -1606.2491f, 5273.9644f, 5.199186f, -1.633685f, 0f, -175.27481f, 30.166092f, 0, 1, 1, 2);
					CAM::SET_CAM_PARAMS(iLocal_148, -1605.6807f, 5274.014f, 3.870102f, -2.089875f, 0f, -178.06396f, 30.166092f, 10000, 1, 1, 2);
					CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
					CAM::SHAKE_CAM(iLocal_148, "HAND_SHAKE", 0.3f);
				}
				if (func_310(PLAYER::PLAYER_PED_ID()) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
				{
				...
				if (func_310(iLocal_147) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Abigail", 0))
				{
					TASK::CLEAR_PED_TASKS(iLocal_147);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_147, -1581.5586f, 5198.0137f, 3.0091f, 1f, 20000, 0.25f, 0, 40000f);
				}
			}
			else
			{
		...
		case 5:
			if ((iLocal_153 == 0 && CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() == 4) && MISC::GET_GAME_TIMER() > (iLocal_150 - 300))
			{
			...
			{
				if (func_228("DIVING_HELP" /* GXT: A Dinghy is now available at the Marina property to search for the missing submarine pieces. */))
				{
					HUD::CLEAR_HELP(true);
				}
			...
			else if (!func_228("DIVING_HELP" /* GXT: A Dinghy is now available at the Marina property to search for the missing submarine pieces. */))
			{
				func_2("DIVING_HELP" /* GXT: A Dinghy is now available at the Marina property to search for the missing submarine pieces. */);
			}
			break;
	}
}
...
void func_4(int iParam0, bool bParam1)//Position - 0x557
{
	...
	{
		func_176(&(Global_113459[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
int func_6(bool bParam0)//Position - 0x6D6
{
...
void func_8()//Position - 0x7E4
{
	...
	{
		func_10(13, SYSTEM::FLOOR(Global_114372.f_10197.f_3853));
	}
...
void func_11(int iParam0, bool bParam1, int iParam2)//Position - 0xCFE
{
	if (iParam2 == -1)
	{
		iParam2 = func_12();
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x17CA
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	Global_79031[1 /*14*/] = { func_86(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_79031[1 /*14*/] = { func_86(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_78(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_78(iParam1), Global_79031[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_78(iParam1), Global_79031[1 /*14*/].f_3, Global_79031[1 /*14*/].f_4, 0);
		}
	}
...
int func_34(int iParam0, int iParam1, int iParam2)//Position - 0x1987
{
	int iVar0;
	...
	{
		if (!func_151(iParam0, Global_114372.f_2366.f_539[iVar0 /*65*/].f_64, Global_114372.f_2366.f_539[iVar0 /*65*/].f_63))
		{
...
int func_36(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1A63
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_79031[1 /*14*/] = { func_86(iVar10, iParam1, iParam2, -1) };
		if (!func_76(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_79031[1 /*14*/] = { func_86(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_79031[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_79031[1 /*14*/] = { func_86(iVar10, 14, uVar28[iVar1], -1) };
							func_52(iParam0, Global_79031[1 /*14*/].f_12, Global_79031[1 /*14*/].f_3, Global_79031[1 /*14*/].f_4);
							func_68(14);
							if (Global_79029 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_78(iVar0), Global_79031[1 /*14*/].f_3, Global_79031[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_78(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_78(iVar0), Global_79031[1 /*14*/].f_3, Global_79031[1 /*14*/].f_4, iParam4);
						}
						func_68(iVar0);
						if (Global_79029 == 1)
						{
			...
			{
				Global_79031[1 /*14*/] = { func_86(iVar10, iVar0, func_42(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_79031[1 /*14*/] = { func_86(iVar10, 14, uVar69[iVar1], -1) };
			func_52(iParam0, Global_79031[1 /*14*/].f_12, Global_79031[1 /*14*/].f_3, Global_79031[1 /*14*/].f_4);
			func_68(14);
			if (Global_79029 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_78(iParam1), Global_79031[1 /*14*/].f_3, Global_79031[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_78(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_78(iParam1), Global_79031[1 /*14*/].f_3, Global_79031[1 /*14*/].f_4, iParam4);
		}
		if (Global_79029 == 1)
		{
			iVar2 = 0;
...
int func_38(int iParam0, int iParam1, int iParam2)//Position - 0x22FE
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
{
	Global_79031[1 /*14*/] = { func_86(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_79031[1 /*14*/].f_6, 2);
}

int func_40(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x2404
{
	var uVar0;
	int iVar10;
...
int func_41(int iParam0, int iParam1, int iParam2)//Position - 0x2A08
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_42(int iParam0, int iParam1, int iParam2)//Position - 0x2AA1
{
	int iVar0;
	int iVar1;
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2B42
{
	int iVar0;
...
int func_44(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2E49
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_45(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x39FC
{
	int iVar0;
...
int func_48(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3FDE
{
	int iVar0;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x4008
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_50(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x42D2
{
	int iVar0;
...
void func_52(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x46B3
{
	int iVar0;
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x474D
{
	switch (iParam0)
	{
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4D3D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_58(int iParam0, int iParam1)//Position - 0x4E39
{
	int iVar0;
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5117
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_63(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5394
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_64(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x57B9
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_65(int iParam0, int iParam1)//Position - 0x5AAC
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0, int iParam1)//Position - 0x5AF3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_67(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5B53
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_71(int iParam0, var uParam1)//Position - 0x5CCC
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_72(uParam1));
}

int func_72(var uParam0)//Position - 0x5CE1
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8834
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_76(int iParam0)//Position - 0x96D7
{
	if (!BitTest(Global_79031[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x971F
{
	int iVar0;
	...
	{
		if (!func_151(iParam0, Global_114372.f_2366.f_539[iVar0 /*65*/].f_61, Global_114372.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_78(int iParam0)//Position - 0x97CA
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_79(int iParam0, int iParam1)//Position - 0x987A
{
	int iVar0;
	struct<10> Var1;
...
void func_80(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA1A9
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_81(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xA2D3
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_82(int iParam0, int iParam1)//Position - 0xA31B
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_85(&Var1, -99, -99, Global_114372.f_2366.f_539.f_196[0], Global_114372.f_2366.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_85(&Var1, -99, -99, Global_114372.f_2366.f_539.f_196[1], Global_114372.f_2366.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_85(&Var1, -99, -99, Global_114372.f_2366.f_539.f_196[2], Global_114372.f_2366.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_83(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC165
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
void func_85(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xC3FF
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC470
{
	func_150();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_87(int iParam0, int iParam1)//Position - 0xC4C2
{
	switch (iParam0)
	{
		case 0:
...
void func_88(int iParam0)//Position - 0xC5B2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_89(&(Global_79031[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_89(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD7EC
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_73(func_92(iParam1, uParam0->f_2), Global_79028);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_73(func_91(iParam1, uParam0->f_2), Global_79028);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_73(iVar1, Global_79028);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_90(int iParam0, int iParam1, var uParam2)//Position - 0xDB8D
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_91(int iParam0, int iParam1)//Position - 0xDF92
{
	switch (iParam1)
	{
		case 0:
...
int func_92(int iParam0, int iParam1)//Position - 0xE38D
{
	switch (iParam1)
	{
		case 0:
...
int func_93(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE788
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_94(int iParam0)//Position - 0xE7C6
{
	return Global_43922 == iParam0;
}

int func_95(int iParam0)//Position - 0xE7D4
{
	switch (iParam0)
	{
		case -1:
...
void func_96(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE8A8
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_89(&(Global_79031[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_89(&(Global_79031[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_89(&(Global_79031[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79229)
		{
			...
			func_89(&(Global_79031[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_97(int iParam0)//Position - 0xEB2E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_98(int iParam0)//Position - 0xEC7B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_99(int iParam0)//Position - 0xF188
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(int iParam0)//Position - 0xF1FC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_101(int iParam0)//Position - 0xF26F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_102(int iParam0)//Position - 0xF356
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_103(int iParam0)//Position - 0xF698
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_104(int iParam0)//Position - 0xF8A0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0xFAC0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(int iParam0)//Position - 0xFBC9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0)//Position - 0x1055C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0x110B4
{
	if (iParam0 < 136)
	{
		func_110(iParam0);
...
void func_109(int iParam0)//Position - 0x110E9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0)//Position - 0x11CED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0x12BED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0x12D1A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0, int iParam1)//Position - 0x12E11
{
	switch (iParam0)
	{
		case 0:
...
void func_114(int iParam0)//Position - 0x12F01
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0x143D0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x14517
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0x14A21
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x1508A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x150FD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0x151CD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0x156C8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0x15859
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0x16048
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0x16151
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0x17074
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x17D21
{
	if (iParam0 < 107)
	{
		func_129(iParam0);
...
void func_127(int iParam0)//Position - 0x17D67
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x1880D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0x195FB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x1A23A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x1A4B2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0, int iParam1)//Position - 0x1A5EE
{
	switch (iParam0)
	{
		case 0:
...
void func_133(int iParam0)//Position - 0x1A6DE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x1B43C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x1B5AB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x1BB1C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x1C046
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x1C0B9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x1C189
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x1C639
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x1C894
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x1CB54
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x1CD0F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x1D855
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x1E487
{
	if (iParam0 < 60)
	{
		func_147(iParam0);
...
void func_146(int iParam0)//Position - 0x1E4BC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x1F24F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x1F8D1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x1F9B7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150()//Position - 0x1FAAE
{
...
int func_151(int iParam0, int iParam1, int iParam2)//Position - 0x1FB26
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_151(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_151(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_79031[2 /*14*/] = { func_86(iVar0, 14, iVar4, -1) };
									if (Global_79031[2 /*14*/].f_12 == iVar3)
									{
										if (func_151(iParam0, 14, iVar4))
										{
											if (!func_40(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_79031[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_79031[2 /*14*/] = { func_86(iVar0, iVar2, iVar1, -1) };
						if (!func_40(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_79031[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_79031[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_78(iParam1)) && Global_79031[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_78(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_152(int iParam0)//Position - 0x1FD7F
{
	int iVar0;
	int iVar1;
...
int func_153(int iParam0)//Position - 0x1FDBC
{
	if (func_155(iParam0))
	{
...
var func_154(int iParam0)//Position - 0x1FDE1
{
	return Global_2139[iParam0 /*29*/];
}

bool func_155(int iParam0)//Position - 0x1FDF0
{
	return iParam0 < 3;
}

void func_156(char* sParam0, var uParam1)//Position - 0x1FDFC
{
...
void func_158()//Position - 0x1FE93
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_153(Global_114372.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_152(PLAYER::PLAYER_PED_ID());
			if (func_155(iVar0) && (!func_94(14) || Global_113320))
			{
				if (Global_114372.f_2366.f_539.f_4321 != iVar0 && func_155(Global_114372.f_2366.f_539.f_4321))
				{
...
struct<2> func_159(int iParam0)//Position - 0x1FF90
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_160(int iParam0)//Position - 0x1FFC7
{
	struct<2> Var0;
...
void func_161(int iParam0, int iParam1)//Position - 0x2043E
{
...
void func_162(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x20488
{
...
void func_163(int iParam0, bool bParam1, bool bParam2)//Position - 0x20525
{
	struct<4> Var0;
	char* sVar32;
	...
	if (iParam0 != -1)
	{
		...
		func_164(&sVar32, Var0.f_3, Global_101429, bParam1, bParam2);
	}
}

void func_164(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x20564
{
...
void func_165(int iParam0, var uParam1)//Position - 0x205A8
{
	switch (iParam0)
	{
		case 0:
...
int func_167(int iParam0)//Position - 0x217EE
{
	switch (iParam0)
	{
		case 0:
...
void func_168(int iParam0)//Position - 0x21B34
{
	Global_44473 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_169()//Position - 0x21B46
{
	if (Global_98684)
	{
		func_158();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_170(Global_114372.f_2366.f_539.f_4321));
	}
	else
	{
...
char* func_170(var uParam0)//Position - 0x21B78
{
	uParam0 = uParam0;
	return "";
}

void func_171()//Position - 0x21B87
{
	char cVar0[24];
...
bool func_172()//Position - 0x21BCA
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_173()//Position - 0x21BE0
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_174(int iParam0, int iParam1)//Position - 0x21BF6
{
	Global_98679 = iParam0;
	Global_98680 = iParam1;
}

void func_175()//Position - 0x21C0A
{
	if (Global_79503 != 6)
	{
	}
...
void func_176(var uParam0)//Position - 0x21C42
{
	if (*uParam0 == -1)
	{
		return;
...
void func_177(int iParam0, bool bParam1)//Position - 0x21C7F
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_178(int iParam0)//Position - 0x21DFC
{
	switch (iParam0)
	{
		case 0:
...
void func_179(int iParam0)//Position - 0x22183
{
	func_181(iParam0, 1);
	Global_114372.f_18577[iParam0 /*6*/].f_3 = func_180();
	Global_114372.f_18577.f_380++;
}

int func_180()//Position - 0x221B9
{
	return (Global_114372.f_10019.f_21 + Global_114372.f_18577.f_380);
}

void func_181(var uParam0, bool bParam1)//Position - 0x221D5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_182(int iParam0)//Position - 0x224F9
{
...
void func_183(int iParam0)//Position - 0x2252C
{
	switch (iParam0)
	{
		case 30:
...
void func_184(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x22561
{
	if (iParam0 != 198)
	{
		if (Global_79248)
...
void func_185(int iParam0, int iParam1)//Position - 0x225B9
{
	switch (iParam0)
	{
		case 12:
...
void func_186(int iParam0, bool bParam1)//Position - 0x226A2
{
	if (bParam1)
	{
...
bool func_187(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x226CB
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_189()//Position - 0x2304A
{
	return Global_32829;
}

int func_190(var uParam0, int iParam1)//Position - 0x23055
{
	int iVar0;
...
int func_191(int iParam0)//Position - 0x267F0
{
	switch (iParam0)
	{
		case 46:
...
void func_192(int iParam0, bool bParam1)//Position - 0x268DF
{
	switch (iParam0)
	{
		case 46:
...
void func_193(int iParam0, bool bParam1)//Position - 0x26930
{
	int iVar0;
...
void func_194(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x26996
{
	func_195(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_195(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x269B7
{
	int iVar0;
...
void func_196()//Position - 0x26B8A
{
	int iVar0;
...
int func_197(int iParam0)//Position - 0x26CA1
{
	int iVar0;
	int iVar1;
...
void func_198(char* sParam0)//Position - 0x26CE1
{
...
char* func_199(int iParam0)//Position - 0x26D05
{
	switch (iParam0)
	{
		case 0:
...
int func_200(int iParam0)//Position - 0x26ED8
{
...
void func_201(int iParam0, int iParam1)//Position - 0x26F02
{
...
int func_202(char* sParam0)//Position - 0x26F3F
{
	int iVar0;
...
int func_203()//Position - 0x26F9F
{
	return func_204(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_204(char* sParam0, int iParam1)//Position - 0x26FB0
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_205(int iParam0, int iParam1, bool bParam2)//Position - 0x26FF9
{
	int iVar0;
		...
		if (bParam2)
		{
			if (!Global_79248)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9342[iParam1 /*4*/] = { func_207(iParam0) };
					...
					{
						Global_9293[1 /*6*/] = { func_207(iParam0) };
...
void func_206()//Position - 0x27177
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
struct<4> func_207(int iParam0)//Position - 0x271F2
{
	return Global_2139[iParam0 /*29*/].f_3;
}

int func_208(int iParam0, int iParam1)//Position - 0x27205
{
...
int func_209(int iParam0, int iParam1)//Position - 0x2722F
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_210(int iParam0, int iParam1, int iParam2)//Position - 0x27259
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_211(int iParam0, int iParam1, int iParam2)//Position - 0x2729E
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_212()//Position - 0x272E3
{
	if (func_94(14))
	{
...
int func_213()//Position - 0x27385
{
	func_158();
	return Global_114372.f_2366.f_539.f_4321;
}

void func_214(int* iParam0)//Position - 0x2739E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_215(var uParam0, bool bParam1, bool bParam2)//Position - 0x273DF
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_310(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_310(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_310(uParam0->f_41[iVar0]))
		{
...
void func_216(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x274D4
{
	int iVar0;
...
int func_217(int iParam0)//Position - 0x2757E
{
	if (func_310(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_218(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2759E
{
	if (bParam0)
	{
...
bool func_219()//Position - 0x276EB
{
	return BitTest(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

bool func_220(int iParam0, int iParam1)//Position - 0x27705
{
	bool bVar0;
...
int func_221(int iParam0, bool bParam1)//Position - 0x2775E
{
	int iVar0;
	int iVar1;
...
int func_222(var uParam0)//Position - 0x2779F
{
	int iVar0;
...
int func_223(int iParam0)//Position - 0x277C1
{
...
bool func_224()//Position - 0x27800
{
	return BitTest(Global_2621446, 3);
}

int func_225(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x2780E
{
	int iVar0;
...
void func_227(int iParam0)//Position - 0x27868
{
	if (iParam0 == 1)
	{
...
bool func_228(char* sParam0)//Position - 0x2788B
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

int func_229(int iParam0)//Position - 0x2789E
{
...
void func_231(int iParam0)//Position - 0x2791A
{
	if (iParam0 == -1)
	{
		return;
...
void func_232(int iParam0, bool bParam1)//Position - 0x2793F
{
	if (iParam0 == -1)
	{
		return;
...
void func_233(int iParam0, int iParam1, bool bParam2)//Position - 0x2799C
{
	if (iParam0 == -1)
	{
		return;
...
int func_234(int iParam0, int iParam1)//Position - 0x279D7
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_235(int iParam0, bool bParam1)//Position - 0x279F7
{
...
void func_236(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x27A33
{
	int iVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_237(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
Vector3 func_237(int iParam0)//Position - 0x27BF1
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_238(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x27C04
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104933.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104933.f_4, false))
		{
			if (func_287(24) != Global_104933.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_284(ENTITY::GET_ENTITY_COORDS(Global_104933.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_239(Global_104933.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_239(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x27C7F
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_274(iParam5, &Var0, Param1, fParam4, func_277(iParam0));
		func_240(iParam5, iParam0, 0);
	}
}

void func_240(int iParam0, int iParam1, int iParam2)//Position - 0x27DA8
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_114372.f_32753.f_4801 = func_260();
			}
...
void func_241(int iParam0, int iParam1)//Position - 0x27EBF
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_279(iParam0, &(Global_114372.f_32753.f_5510));
}

int func_242(int iParam0)//Position - 0x280C3
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_258(iParam0, 0, 0)) || func_258(iParam0, 1, 0)) || func_258(iParam0, 2, 0)) || func_277(iParam0) != 145) || func_257(iParam0)) || func_256(iParam0)) || func_255(iParam0)) || func_254(iParam0)) || !func_243(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_256(iParam0))
		{
		}
		...
		if (func_258(iParam0, 0, 0))
		{
		}
		if (func_258(iParam0, 1, 0))
		{
		}
		if (func_258(iParam0, 2, 0))
		{
		}
...
int func_243(int iParam0)//Position - 0x281A0
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_244(int iParam0, bool bParam1, int iParam2)//Position - 0x2835E
{
	int iVar0;
	struct<2> Var1;
...
int func_245(int iParam0)//Position - 0x284E0
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_247(int iParam0, int iParam1)//Position - 0x285C3
{
	int iVar0;
	int iVar1;
...
int func_248(bool bParam0)//Position - 0x2DAFB
{
	if (bParam0)
	{
...
int func_249()//Position - 0x2DB15
{
	return 0;
}

int func_250()//Position - 0x2DB1E
{
	return 1;
}

int func_251()//Position - 0x2DB27
{
	return 1;
}

int func_252()//Position - 0x2DB30
{
...
int func_254(int iParam0)//Position - 0x2DC01
{
	int iVar0;
	char* sVar1;
...
int func_255(int iParam0)//Position - 0x2DC48
{
	int iVar0;
...
int func_256(int iParam0)//Position - 0x2DC83
{
	int iVar0;
...
int func_257(int iParam0)//Position - 0x2DCFF
{
	int iVar0;
...
int func_258(int iParam0, int iParam1, bool bParam2)//Position - 0x2DDE7
{
	int iVar0;
	char* sVar1;
	int iVar9;
	...
	iVar0 = 0;
	while (func_259(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_259(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2DE55
{
...
var func_260()//Position - 0x2DF2D
{
	var uVar0;
	
	func_270(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_269(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_268(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_263(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_262(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_261(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}

void func_261(var uParam0, int iParam1)//Position - 0x2DF73
{
	if (iParam1 <= 0)
	{
		return;
...
void func_262(var uParam0, int iParam1)//Position - 0x2DFF9
{
...
void func_263(var uParam0, int iParam1)//Position - 0x2E02C
{
	int iVar0;
	int iVar1;
...
int func_264(int iParam0, int iParam1)//Position - 0x2E07D
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_265(int iParam0)//Position - 0x2E11F
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_266(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_266(bool bParam0, int iParam1, int iParam2)//Position - 0x2E141
{
	if (bParam0)
	{
		return iParam1;
...
int func_267(var uParam0)//Position - 0x2E158
{
	return uParam0 & 15;
}

void func_268(var uParam0, int iParam1)//Position - 0x2E165
{
...
void func_269(var uParam0, int iParam1)//Position - 0x2E19F
{
...
void func_270(var uParam0, int iParam1)//Position - 0x2E1DA
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_271(var uParam0, int iParam1)//Position - 0x2E216
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_278(Global_114372.f_32753.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_278(Global_114372.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_278(Global_114372.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_272(int iParam0, int iParam1)//Position - 0x2F904
{
	struct<82> Var0;
...
void func_273(int iParam0, var uParam1, int iParam2)//Position - 0x2F946
{
	int iVar0;
...
void func_274(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x2FBA2
{
	if (func_271(&(Global_78038.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_276(iParam0);
			func_275(uParam1, &(Global_114372.f_32753.f_69[Global_78038.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_275(var uParam0, var uParam1)//Position - 0x2FC9B
{
...
void func_276(int iParam0)//Position - 0x2FD67
{
	if (iParam0 == -1)
	{
		return;
...
int func_277(int iParam0)//Position - 0x2FDDE
{
	int iVar0;
...
bool func_278(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2FE41
{
	if (bParam6)
	{
...
void func_279(int iParam0, var uParam1)//Position - 0x2FE88
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_280(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_280(int iParam0)//Position - 0x30134
{
	switch (iParam0)
	{
		case 1:
...
int func_281(int iParam0, var uParam1, var uParam2)//Position - 0x301E4
{
	int iVar0;
	int iVar1;
...
int func_282(int iParam0)//Position - 0x303D7
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_283(int iParam0)//Position - 0x303F7
{
...
int func_284(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x3041E
{
	int iVar0;
	
	iVar0 = func_285(Param0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_285(struct<3> Param0, int iParam3, int iParam4)//Position - 0x30534
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_286(int iParam0)//Position - 0x305C3
{
	return BitTest(Global_114372.f_7232[iParam0], 0);
}

int func_287(int iParam0)//Position - 0x305D8
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_288(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x305F4
{
	func_289(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_289(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x3061D
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_291(iVar0, Param0, Param3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_290(struct<3> Param0)//Position - 0x30A13
{
...
int func_291(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x30A3D
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_292(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var9) || func_292(Var18[0 /*3*/], Var18[1 /*3*/], Var9, Var15)) || func_292(Var18[0 /*3*/], Var18[1 /*3*/], Var12, Var15)) || func_292(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var12)) || func_292(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var9)) || func_292(Var18[1 /*3*/], Var18[3 /*3*/], Var9, Var15)) || func_292(Var18[1 /*3*/], Var18[3 /*3*/], Var12, Var15)) || func_292(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var12)) || func_292(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var9)) || func_292(Var18[3 /*3*/], Var18[2 /*3*/], Var9, Var15)) || func_292(Var18[3 /*3*/], Var18[2 /*3*/], Var12, Var15)) || func_292(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var12)) || func_292(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var9)) || func_292(Var18[2 /*3*/], Var18[0 /*3*/], Var9, Var15)) || func_292(Var18[2 /*3*/], Var18[0 /*3*/], Var12, Var15)) || func_292(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_292(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x30D33
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_293(struct<3> Param0)//Position - 0x30DE7
{
	float fVar0;
	float fVar1;
...
void func_294(int iParam0)//Position - 0x30E26
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_295()//Position - 0x30E8B
{
	int iVar0;
...
int func_296(int iParam0, float fParam1, int iParam2)//Position - 0x30EAB
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if ((!PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_BOAT(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = 0;
				if (!func_302(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")))
				{
...
bool func_297()//Position - 0x30F7F
{
	bool bVar0;
...
void func_298()//Position - 0x30FA2
{
	Global_21032 = 0;
	func_299();
}

void func_299()//Position - 0x30FB2
{
...
void func_301()//Position - 0x3102B
{
...
int func_302(int iParam0, int iParam1)//Position - 0x3107C
{
	if (func_217(iParam0))
	{
...
int func_303(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x310AF
{
...
void func_304(int iParam0)//Position - 0x31106
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_305(bool bParam0, bool bParam1)//Position - 0x31132
{
...
void func_306()//Position - 0x31283
{
	if (func_310(PLAYER::PLAYER_PED_ID()))
	{
		func_311();
		...
		if (iLocal_152 == 0)
		{
			if (func_310(iLocal_147))
			{
				if (func_307(PLAYER::PLAYER_PED_ID(), iLocal_147, 1) < 4f || (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 2f && func_307(PLAYER::PLAYER_PED_ID(), iLocal_147, 1) < 6f))
				{
...
float func_307(int iParam0, int iParam1, bool bParam2)//Position - 0x312F9
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_308(char* sParam0, bool bParam1)//Position - 0x31357
{
	func_309(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_309(bool bParam0)//Position - 0x3136D
{
	int iVar0;
...
int func_310(int iParam0)//Position - 0x313AC
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_311()//Position - 0x313CD
{
	func_313(0);
	func_301();
	func_312();
...
void func_312()//Position - 0x313E2
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_303(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_313(int iParam0)//Position - 0x3143A
{
	if (func_318())
	{
		return;
...
void func_314(int iParam0)//Position - 0x3146D
{
	if (func_318())
	{
		return;
...
void func_315(bool bParam0, bool bParam1)//Position - 0x314F7
{
	if (bParam0)
	{
		if (func_317(0))
...
bool func_316()//Position - 0x3156B
{
	return BitTest(Global_1956030, 5);
}

int func_317(int iParam0)//Position - 0x31579
{
	if (iParam0 == 1)
	{
...
bool func_318()//Position - 0x315D0
{
	return BitTest(Global_1956030, 19);
}

void func_319(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x315DF
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_79503 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_321(Global_79504, Global_79506, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_320(char* sParam0)//Position - 0x318C4
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_321(int iParam0, int iParam1, int iParam2)//Position - 0x318D7
{
	struct<2> Var0;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_322(iVar2), 8);
					break;
			}
			break;
...
char* func_322(int iParam0)//Position - 0x319AD
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_323(int iParam0)//Position - 0x31B00
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_324(int iParam0)//Position - 0x31B33
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_325(int iParam0)//Position - 0x31B66
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_326(int iParam0)//Position - 0x31B99
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_327(int iParam0)//Position - 0x31BCC
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_328(int iParam0)//Position - 0x31C09
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_329(int iParam0)//Position - 0x31C3C
{
	struct<2> Var0;
...
int func_330(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x31CA5
{
	...
	switch (Global_79503)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_317(0)) || func_331(1))
			{
			}
			else
			{
...
bool func_331(bool bParam0)//Position - 0x31DBD
{
	if (bParam0)
	{
...
int func_332(int iParam0)//Position - 0x31DE6
{
	if (Global_43922 == 15)
	{
		return 0;
...
bool func_333(int iParam0)//Position - 0x31E08
{
	return func_334(iParam0, Global_43922);
}

int func_334(int iParam0, int iParam1)//Position - 0x31E19
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_335(var uParam0, var uParam1)//Position - 0x31FFA
{
	*uParam0 = *uParam1;
	*uParam1 = 0;
}

void func_336()//Position - 0x3200C
{
	if (STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
	{
	...
	func_295();
	func_337(&Local_86, 0, 0, 0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_337(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x32030
{
...
void func_338(var uParam0, bool bParam1)//Position - 0x32050
{
	func_339(&(uParam0->f_41), bParam1);
}

void func_339(var uParam0, bool bParam1)//Position - 0x32062
{
	int iVar0;
...
void func_340(int* iParam0, bool bParam1)//Position - 0x320A0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_341(int* iParam0)//Position - 0x320DB
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_342(var uParam0, bool bParam1)//Position - 0x32106
{
	func_343(&(uParam0->f_35), bParam1);
}

void func_343(var uParam0, bool bParam1)//Position - 0x32118
{
	int iVar0;
...
void func_344(int* iParam0)//Position - 0x32155
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_345(int* iParam0)//Position - 0x3218D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_346(int iParam0)//Position - 0x32229
{
	if (func_310(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_347(var uParam0, int iParam1)//Position - 0x32253
{
	func_348(&(uParam0->f_28), iParam1);
}

void func_348(var uParam0, int iParam1)//Position - 0x32265
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_349(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_349(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x322A6
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_350(bool bParam0)//Position - 0x322F6
{
	int iVar0;
	...
	if (!func_367())
	{
		...
		{
			func_163(iVar0, 1, 0);
			func_351(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_113459[iVar0 /*10*/].f_9 == -1)
...
void func_351(char* sParam0, int iParam1)//Position - 0x323C6
{
	if (Global_101392 != 12)
	{
...
int func_352(char* sParam0, int iParam1, int iParam2)//Position - 0x323EE
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_358())
	{
		...
		{
			iVar33 = func_353(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_353(char* sParam0)//Position - 0x3257D
{
...
int func_354()//Position - 0x325D3
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_355(&(Global_101392.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_355(char* sParam0, bool bParam1)//Position - 0x325F7
{
	int iVar0;
	int iVar1;
...
int func_356(int iParam0, bool bParam1)//Position - 0x32621
{
	int iVar0;
...
void func_359(bool bParam0)//Position - 0x32713
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_360(int iParam0)//Position - 0x32727
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_361(int iParam0)//Position - 0x32761
{
	if (iParam0 == 1)
	{
...
void func_362()//Position - 0x3279B
{
	Global_23572.f_5 = 1;
}

void func_363()//Position - 0x327A9
{
	Global_23572.f_5 = 0;
}

void func_364(bool bParam0)//Position - 0x327B7
{
	if (bParam0)
	{
		func_365();
...
void func_365()//Position - 0x3281A
{
...
void func_366()//Position - 0x32843
{
	Global_95548 = 0;
	Global_95549 = 0;
}

int func_367()//Position - 0x32855
{
...
void func_368()//Position - 0x32893
{
	Global_101427 = 1;
...
void func_369(char* sParam0)//Position - 0x32980
{
...
void func_370(var uParam0)//Position - 0x32992
{
...
void func_371(var uParam0)//Position - 0x329B2
{
	int iVar0;
...
int func_372(int iParam0)//Position - 0x329EC
{
	if (!func_155(iParam0))
	{
		return func_154(iParam0);
