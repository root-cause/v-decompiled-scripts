...
int func_3(int* iParam0)//Position - 0x12C
{
	...
	if (!PED::IS_PED_INJURED(*iParam0))
	{
		...
		{
			case 0:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98010) || PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98011))
				{
			...
			case 1:
				...
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98011))
				{
					...
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_268, &cLocal_286, 2))
					{
						TASK::CLEAR_PED_TASKS(*iParam0);
					...
					else
					{
						...
						if (!ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_268, &cLocal_286, "WalkInterruptible", &fVar1, &uVar2))
						{
						}
						else
						{
				...
				else if (iLocal_67 != 151)
				{
					...
					{
						TASK::TASK_START_SCENARIO_AT_POSITION(*iParam0, &cLocal_295, Local_264 + Local_304, (fLocal_265 + fLocal_305), 0, false, true);
			...
			case 2:
				...
				else
				{
					...
					TASK::CLEAR_PED_TASKS(*iParam0);
					if (func_132(Local_266, 0f, 0f, 0f, 0))
					{
			...
			case 3:
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(*iParam0, joaat("SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD")) != 1)
				{
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), Local_264 + Local_266) < (fLocal_267 * fLocal_267))
					{
						if (fLocal_267 == 0f)
						{
							fLocal_267 = (SYSTEM::VMAG(Local_266) * 0.75f);
						}
						TASK::TASK_WANDER_IN_AREA(*iParam0, Local_264 + Local_266, fLocal_267, 3f, 6f);
						func_134(4, 0);
						return 1;
					}
				}
			...
			case 4:
				...
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), Local_264 + Local_266) < (fLocal_267 * fLocal_267))
				{
					if (TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_264 + Local_266, fLocal_267, true))
					{
						TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(*iParam0, Local_264 + Local_266, fLocal_267, 0);
						PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_307, false);
						func_134(5, 0);
						return 1;
					}
				}
			...
			case 5:
				...
				else
				{
					...
					Var4 = { func_4(Local_264 + Local_266, (fLocal_267 * 0.9f), 0f) };
					if (PATHFIND::GET_SAFE_COORD_FOR_PED(Var4, false, &Var5, 14))
					{
			...
			case 7:
				...
				func_7(*iParam0);
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_268, &cLocal_277, 2))
				{
				}
				else if (ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_268, &cLocal_286, 2))
				{
				}
				break;
...
Vector3 func_4(struct<3> Param0, float fParam1, float fParam2)//Position - 0x872
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
Vector3 func_5(struct<3> Param0, float fParam1, float fParam2)//Position - 0x8EB
{
	struct<3> Var0;
	float fVar1;
	...
	fVar1 = (fParam2 / 2f);
	Var0 = { func_6(Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1)) };
	Var0.f_2 = MISC::GET_RANDOM_FLOAT_IN_RANGE(-fVar1, fVar1);
	return Param0 + Var0;
}

Vector3 func_6(struct<3> Param0, float fParam1)//Position - 0x933
{
	float fVar0;
...
void func_7(int iParam0)//Position - 0x96A
{
	...
	if (PED::IS_PED_INJURED(iParam0))
	{
		if (!iLocal_310 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), true))
		{
			bVar0 = func_129(iParam0);
			iVar1 = func_126(bVar0);
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					if (!func_122(iVar2) || func_114(iVar2) == 6)
					{
						...
						if (func_46(Global_96415, bVar0, 2, 0, iVar3, iVar2, 75))
						{
							iLocal_310 = 1;
						}
					}
	...
	else
	{
		...
		if (iLocal_308 > 0)
		{
			if (iLocal_309 == 0)
			{
				if (iLocal_308 + 15000 < MISC::GET_GAME_TIMER())
				{
			...
			else if (iLocal_308 + 10000 < MISC::GET_GAME_TIMER())
			{
...
void func_8(int iParam0, char* sParam1, int iParam2)//Position - 0xAC1
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iParam0, sParam1, func_9(iParam2), 1);
}

int func_9(int iParam0)//Position - 0xAD8
{
	int iVar0;
...
int func_10(int iParam0, int iParam1, var uParam2, char* sParam3, var uParam4, int* iParam5, int iParam6)//Position - 0xCCD
{
	struct<3> Var0;
	struct<3> Var1;
	int iVar2;
...
void func_11(int* iParam0)//Position - 0x1073
{
	func_12(iParam0, 0f);
}

void func_12(int* iParam0, float fParam1)//Position - 0x1082
{
...
float func_13(bool bParam0)//Position - 0x10AD
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_14(char* sParam0, char* sParam1, var uParam2, int iParam3, var uParam4, char* sParam5)//Position - 0x1105
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_15(int iParam0)//Position - 0x121C
{
	Global_22736 = iParam0;
}

bool func_16(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1229
{
...
int func_17(char* sParam0, int iParam1, bool bParam2)//Position - 0x1277
{
	Global_21726 = 0;
...
bool func_20(int iParam0)//Position - 0x15DF
{
	return func_21(iParam0, 20);
}

var func_21(int iParam0, int iParam1)//Position - 0x15EF
{
	return BitTest(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

int func_22()//Position - 0x1607
{
	return -1;
}

void func_23()//Position - 0x1610
{
	int iVar0;
...
bool func_28(int iParam0)//Position - 0x1837
{
	return Global_43257 == iParam0;
}

void func_29()//Position - 0x1845
{
	int iVar0;
...
bool func_30(int iParam0, int iParam1)//Position - 0x189B
{
	switch (iParam0)
	{
		case 5:
...
void func_32(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x192A
{
...
int func_33(char* sParam0, int iParam1)//Position - 0x1980
{
...
void func_35(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x19E1
{
...
int func_36(char* sParam0, char* sParam1, var uParam2)//Position - 0x1A7C
{
	char cVar0[16];
	char cVar1[16];
	int iVar2;
...
int func_37(int iParam0)//Position - 0x2120
{
...
int func_38(int iParam0)//Position - 0x214D
{
	int iVar0;
...
int func_39(int iParam0)//Position - 0x226E
{
	if (func_41(iParam0))
	{
...
var func_40(int iParam0)//Position - 0x2293
{
	return Global_2028[iParam0 /*29*/];
}

bool func_41(int iParam0)//Position - 0x22A2
{
	return iParam0 < 3;
}

int func_42(int iParam0)//Position - 0x22AE
{
	if (!func_41(iParam0))
	{
		return func_40(iParam0);
...
int func_43()//Position - 0x22D4
{
	func_44();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_44()//Position - 0x22ED
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_39(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_41(iVar0) && (!func_28(14) || Global_112599))
			{
				if (Global_113648.f_2365.f_539.f_4321 != iVar0 && func_41(Global_113648.f_2365.f_539.f_4321))
				{
...
int func_45(int iParam0)//Position - 0x23EA
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2427
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam3 == 0)
	{
		if (func_110(iVar1, iParam2, -1, &iVar4, &iVar5))
		{
			...
			if (func_106(iParam5, iVar4, iVar5, iVar0, iVar2, bParam1, iVar3, 10000, iParam6, iParam4, iVar7, iVar6, 1))
			{
				return 1;
			}
			else
	...
	{
		if (func_87(bParam1, &sVar8, 1, 0, 0, 0, 0, 1, 0, 1))
		{
			if (iParam4 != 0)
			{
				switch (iParam4)
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x2613
{
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x2647
{
	float fVar0;
	bool bVar1;
	int iVar2;
...
void func_50(bool bParam0)//Position - 0x2C46
{
	int iVar0;
	int iVar1;
...
void func_51(int iParam0)//Position - 0x2EC8
{
	int iVar0;
...
void func_52(bool bParam0)//Position - 0x2F22
{
	bool bVar0;
	char cVar1[64];
	...
	else if (BitTest(Global_113648.f_20566.f_471, bParam0) || BitTest(Global_2359296[func_54() /*5568*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
char* func_53(bool bParam0)//Position - 0x30A0
{
	switch (bParam0)
	{
		case 0:
...
void func_55(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x31AE
{
	int iVar0;
...
int func_56(var uParam0)//Position - 0x31DE
{
	int iVar0;
	int iVar1;
...
int func_57()//Position - 0x3212
{
	return Global_1574918;
}

void func_58(int iParam0, bool bParam1, int iParam2)//Position - 0x321E
{
	if (iParam2 == -1)
	{
		iParam2 = func_57();
...
void func_59(int iParam0)//Position - 0x323C
{
	func_79(93, iParam0);
	func_79(29, iParam0);
	func_79(30, iParam0);
...
int func_60(int iParam0)//Position - 0x325C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_61(int iParam0, int iParam1, int iParam2)//Position - 0x3402
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 14192)
	{
		...
		iVar0 = Global_2805027[iParam0 /*3*/][func_56(iParam1)];
...
bool func_62(int iParam0, int iParam1)//Position - 0x343F
{
	if (iParam1 == -1)
	{
		iParam1 = func_57();
...
int func_63(bool bParam0)//Position - 0x345B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_64(int iParam0, int iParam1)//Position - 0x3512
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_65(int iParam0, int iParam1)//Position - 0x352D
{
	...
	if (func_75(&Global_4542597))
	{
		if (func_73(&Global_4542597, iParam0))
		{
			return 0;
		}
...
int func_66(var uParam0, int iParam1)//Position - 0x35CA
{
	int iVar0;
	var uVar1[78];
...
int func_67(var uParam0, int iParam1)//Position - 0x367B
{
	int iVar0;
...
bool func_68(var uParam0, int iParam1)//Position - 0x36F6
{
	return (*uParam0)[iParam1] == 78;
}

void func_69(var uParam0)//Position - 0x3707
{
	int iVar0;
	...
	func_71(uParam0, (Global_4542596 - 0.5f));
}

void func_70(var uParam0, int iParam1)//Position - 0x373B
{
	(*uParam0)[iParam1] = 78;
}

void func_71(var uParam0, float fParam1)//Position - 0x374B
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_72(var uParam0)//Position - 0x3768
{
	return uParam0->f_80;
}

bool func_73(var uParam0, int iParam1)//Position - 0x3774
{
	return func_74(uParam0, iParam1) != -1;
}

int func_74(var uParam0, int iParam1)//Position - 0x3786
{
	int iVar0;
...
bool func_75(var uParam0)//Position - 0x37B3
{
	return uParam0->f_79 == 1;
}

int func_76(int iParam0)//Position - 0x37C1
{
	switch (iParam0)
	{
		case 60:
...
int func_77(int iParam0, int iParam1)//Position - 0x3811
{
	int iVar0;
...
void func_78(int iParam0, int iParam1)//Position - 0x3862
{
	int iVar0;
...
void func_79(int iParam0, int iParam1)//Position - 0x3885
{
	int iVar0;
...
int func_81(int iParam0)//Position - 0x3957
{
	return Global_2028[iParam0 /*29*/].f_17;
}

int func_82(int iParam0)//Position - 0x3968
{
	var uVar0;
...
int func_87(bool bParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)//Position - 0x3AC8
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	sVar6 = "NULL";
	iVar7 = 3;
	if (func_89(bParam0, sParam1, iParam2, iVar0, sVar1, sVar3, iVar2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, iVar4, sVar5, sVar6, iVar7) == 1)
	{
		if (bParam7 == 1)
		{
			Global_8960 = iParam6;
			Global_8863[3 /*6*/] = { func_88(bParam0) };
			Global_8940 = bParam0;
...
struct<4> func_88(int iParam0)//Position - 0x3B57
{
	return Global_2028[iParam0 /*29*/].f_3;
}

int func_89(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)//Position - 0x3B6A
{
	int iVar0;
	bool bVar1;
...
void func_90(int iParam0, char* sParam1, bool bParam2, int iParam3)//Position - 0x4048
{
	if (!func_19())
	{
		return;
...
int func_91(int iParam0)//Position - 0x40A5
{
	return Global_1853910[iParam0 /*862*/].f_205.f_6;
}

void func_92(int iParam0)//Position - 0x40BA
{
	int iVar0;
	int iVar1;
	int iVar2;
					...
					if (iVar0 == Global_8260[iVar1 /*15*/].f_4)
					{
						if (Global_8822[iVar0] == 0)
						{
							...
							if (Global_2694519)
							{
								if (iVar1 == 14)
								{
									func_93(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8260[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22788), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8822[iVar0] = 1;
						}
					...
					if (iVar0 == Global_8260[iVar1 /*15*/].f_4)
					{
						if (Global_8822[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_93(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8260[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22793), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_78558)
								{
									...
									func_93(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8260[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20383)
									...
									func_93(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8260[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_8260[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_93(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8260[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_93(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8260[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8822[iVar0] = 1;
						}
					}
...
void func_93(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)//Position - 0x4654
{
...
void func_94(char* sParam0)//Position - 0x4707
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_95(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)//Position - 0x4719
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
bool func_96()//Position - 0x477C
{
	return Global_1575060;
}

void func_97(int iParam0)//Position - 0x4788
{
	var uVar0;
	var uVar1;
...
void func_98(int iParam0)//Position - 0x47A7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_99()//Position - 0x4839
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_100(Global_113648.f_14143[iVar2 /*104*/].f_18, Global_113648.f_14143[Global_22792 /*104*/].f_18))
		{
			Global_22792 = iVar2;
		}
		iVar2++;
...
int func_100(struct<6> Param0, struct<6> Param1)//Position - 0x4904
{
	struct<4> Var0;
	struct<4> Var1;
	int iVar2;
...
int func_102(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x4B57
{
	struct<4> Var0;
	struct<4> Var1[2];
	int iVar2;
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			...
			if (func_103(&(Var1[0 /*4*/]), iVar2))
			{
				iParam2 = 1;
			}
			else if (func_103(&(Var1[1 /*4*/]), iVar2))
			{
				iParam2 = 0;
			}
			else
...
int func_103(char* sParam0, int iParam1)//Position - 0x4C8F
{
	int iVar0;
	int iVar1;
...
int func_104(int iParam0)//Position - 0x4D03
{
	switch (iParam0)
	{
		case 0:
...
char* func_105(int iParam0)//Position - 0x4D65
{
	switch (iParam0)
	{
		case 0:
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x4DD8
{
	struct<14> Var0;
...
void func_107(bool bParam0)//Position - 0x4F13
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_108(int iParam0)//Position - 0x4FD1
{
	switch (iParam0)
	{
		case 0:
...
int func_109(bool bParam0)//Position - 0x503B
{
...
int func_110(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4)//Position - 0x5063
{
	struct<4> Var0[2];
	int iVar1;
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			if (func_102(iParam0, iParam1, 0, &(Var0[0 /*4*/])) && func_102(iParam0, iParam1, 1, &(Var0[1 /*4*/])))
			{
				...
				if (func_103(&(Var0[0 /*4*/]), iVar1))
				{
					iParam2 = 1;
				}
				else if (func_103(&(Var0[1 /*4*/]), iVar1))
				{
					iParam2 = 0;
				}
				else
...
int func_111(int iParam0, int iParam1)//Position - 0x5165
{
...
int func_112(int iParam0)//Position - 0x5213
{
	switch (iParam0)
	{
		case 0:
...
void func_113(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0x524A
{
	if (iParam0 == iParam3)
	{
		return;
...
int func_114(int iParam0)//Position - 0x5293
{
	int iVar0;
	int iVar1;
...
int func_115(int iParam0, int iParam1)//Position - 0x5349
{
	struct<10> Var0;
	bool bVar1;
	...
	if (bVar1)
	{
		if (Var0.f_3 < Global_113648.f_7690.f_919[func_116()])
		{
			return 5;
		}
	}
...
bool func_116()//Position - 0x53DE
{
	func_44();
	return Global_113648.f_2365.f_539.f_4321;
}

struct<10> func_117(int iParam0)//Position - 0x53F7
{
	int iVar0;
	struct<10> Var1;
...
int func_118(int iParam0, int iParam1)//Position - 0x5446
{
	struct<14> Var0;
	bool bVar1;
...
struct<14> func_119(int iParam0)//Position - 0x54D2
{
	int iVar0;
	struct<14> Var1;
...
int func_120(int iParam0, int iParam1)//Position - 0x5521
{
	struct<15> Var0;
	bool bVar1;
...
struct<15> func_121(int iParam0)//Position - 0x55C9
{
	int iVar0;
	struct<15> Var1;
...
int func_122(int iParam0)//Position - 0x5611
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0x570D
{
	struct<3> Var0;
...
int func_124(struct<3> Param0, bool bParam1)//Position - 0x57A0
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_125(int iParam0)//Position - 0x581A
{
	if (iParam0 == 0)
	{
...
int func_126(int iParam0)//Position - 0x5886
{
	if (iParam0 == 145)
	{
		return 7;
...
var func_127(int iParam0)//Position - 0x58DE
{
	return Global_2028[iParam0 /*29*/].f_11;
}

int func_128()//Position - 0x58EF
{
...
int func_129(int iParam0)//Position - 0x5911
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_130(int* iParam0)//Position - 0x5957
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_131(int iParam0, bool bParam1)//Position - 0x59B5
{
...
bool func_132(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x5A05
{
	if (bParam2)
	{
...
void func_133(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x5A4C
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_9(iParam3), false);
}

void func_134(int iParam0, char* sParam1)//Position - 0x5A65
{
	sParam1 = sParam1;
	iLocal_258 = iParam0;
}

int func_135()//Position - 0x5A76
{
	if (!func_137())
	{
		func_35(&uLocal_68, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		switch (func_38(Global_100402))
		{
			case 0:
				func_35(&uLocal_68, 1, Global_100402, func_136(0), 0, 1);
				break;
			
			case 1:
				func_35(&uLocal_68, 2, Global_100402, func_136(1), 0, 1);
				break;
			
			case 2:
				func_35(&uLocal_68, 3, Global_100402, func_136(2), 0, 1);
				break;
	...
	if (iLocal_261 != 0)
	{
		...
		{
			iLocal_260 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_264 + Local_262, 1f, iLocal_261, true, false, true);
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_260))
			{
				ENTITY::SET_ENTITY_COORDS(iLocal_260, Local_264 + Local_262, true, false, false, true);
				ENTITY::SET_ENTITY_ROTATION(iLocal_260, Vector(fLocal_265, 0f, 0f) + Local_263, 2, true);
...
char* func_136(int iParam0)//Position - 0x5B76
{
	switch (iParam0)
	{
		case 0:
...
int func_138(int iParam0, int iParam1)//Position - 0x5CCC
{
	struct<3> Var0;
	float fVar1;
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_139(Global_100402) && iParam1 != 0)
		{
			Global_100402 = 0;
		}
	}
...
int func_139(var uParam0)//Position - 0x5DB0
{
	return uParam0;
}

bool func_140(var uParam0, var uParam1)//Position - 0x5DBA
{
	return (uParam0 && uParam1) != 0;
}

int func_141()//Position - 0x5DC9
{
	func_44();
...
void func_143()//Position - 0x5E4F
{
	func_144((Global_100404 - 1));
}

void func_144(int iParam0)//Position - 0x5E61
{
	Global_100404 = iParam0;
}

void func_145()//Position - 0x5E6F
{
	func_144(0);
}

void func_146()//Position - 0x5E7C
{
	int iVar0;
	bool bVar1;
	...
	if (iLocal_259 != 0)
	{
		VEHICLE::REQUEST_VEHICLE_ASSET(iLocal_259, 3);
	}
	iVar0 = 0;
	bVar1 = false;
	while (!bVar1 && iVar0 < 400)
	{
		...
		if (iLocal_259 != 0)
		{
			if (!VEHICLE::HAS_VEHICLE_ASSET_LOADED(iLocal_259))
			{
				bVar1 = false;
			}
		}
	...
	ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_100402, true, true);
	func_147(&Global_100402, Global_95684);
	PED::SET_PED_CONFIG_FLAG(Global_100402, 132, true);
	PED::SET_PED_CONFIG_FLAG(Global_100402, 317, true);
}

void func_147(var uParam0, int iParam1)//Position - 0x5F12
{
...
void func_148()//Position - 0x5F48
{
	...
	func_166(iLocal_67, &Local_264, &fLocal_265, &cVar0);
	switch (iLocal_67)
	{
		case 98:
			Local_266 = { -25f, -35f, 0f };
			fLocal_267 = 30f;
			fLocal_306 = 0.73f;
			break;
		
		case 99:
			Local_266 = { Vector(24.3224f, -700.7733f, -1306.8362f) - Local_264 };
			fLocal_267 = 40f;
			iLocal_258 = 2;
			break;
		
		case 100:
			Local_266 = { Vector((82.0206f + 1f), 272.6104f, -566.2225f) - Local_264 };
			fLocal_267 = 30f;
			iLocal_258 = 2;
			break;
		
		case 101:
			Local_266 = { Vector((53.6418f + 1f), -217.321f, 77.2686f) - Local_264 };
			fLocal_267 = 25f;
			iLocal_258 = 2;
			break;
		
		case 102:
			Local_266 = { Vector((102.0191f + 1f), 313.2252f, 412.1519f) - Local_264 };
			fLocal_267 = 15f;
			iLocal_258 = 2;
			break;
		
		case 170:
			Local_266 = { Vector((37.8417f + 1f), -275.1926f, -616.7041f) - Local_264 };
			fLocal_267 = 30f;
			break;
		
		case 171:
			Local_266 = { Vector((56.8469f + 1f), -125.1416f, -106.3491f) - Local_264 };
			fLocal_267 = 25f;
			break;
		...
		case 94:
			Local_266 = { Vector((112.1615f + 1f), 328.301f, -16.8925f) - Local_264 };
			fLocal_267 = 25f;
			break;
		...
		case 152:
			...
			Local_304 = { 1.358f, 2.385f, -0.608f };
			fLocal_305 = 160f;
			iLocal_261 = joaat("prop_patio_lounger1");
			Local_262 = { Vector(63.082f, 357.697f, -1352.644f) - Vector(64.08f, 355.1845f, -1353.791f) };
			Local_263 = { 0f, 0f, (54.35f - 72f) };
			break;
		...
		case 151:
			...
			Local_262 = { 0.8706f, 2.0176f, -0.4948f };
			Local_263 = { 0f, 0f, 0f };
			break;
		
		default:
			Local_266 = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-50f, 50f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-50f, 50f), 0f };
			fLocal_267 = (SYSTEM::VMAG(Local_266) * 0.75f);
			break;
	}
	if ((iLocal_67 != 94 && iLocal_67 != 152) && iLocal_67 != 151)
	{
		...
		Var1.f_31 = 49;
		Var1.f_81 = 2;
		if (func_151(0, iLocal_67, &Var1, &uVar2, &uVar3, &uVar4, &uVar5))
		{
			iLocal_259 = Var1.f_0;
		}
	}
	...
	if (iLocal_258 == 0)
	{
		func_149(iLocal_67, &cLocal_268, &cLocal_277, &cLocal_286, &uVar6, &uVar7);
		iLocal_258 = 0;
	}
	else
	{
...
int func_149(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)//Position - 0x6281
{
	*uParam4 = 9;
	*uParam5 = 8;
	switch (iParam0)
...
void func_150(char* sParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)//Position - 0x699B
{
...
int func_151(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x69B5
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_84 = 255;
...
void func_152(int iParam0, var uParam1, int iParam2)//Position - 0x9E28
{
	int iVar0;
...
int func_153(int iParam0, var uParam1, int iParam2)//Position - 0xA084
{
	...
	if (!func_154(Global_100085[iParam0 /*98*/], 0, -1))
	{
		func_152(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
...
int func_154(int iParam0, bool bParam1, int iParam2)//Position - 0xA2BC
{
	int iVar0;
	struct<2> Var1;
	...
	{
		if ((func_159() || MISC::IS_PC_VERSION()) || func_158())
		{
		}
		else if (!func_161())
		{
...
int func_155(int iParam0)//Position - 0xA43E
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_157(int iParam0, int iParam1)//Position - 0xA521
{
	int iVar0;
	int iVar1;
...
bool func_158()//Position - 0xDB52
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_159()//Position - 0xDB68
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_160()//Position - 0xDB7E
{
	return 0;
}

int func_161()//Position - 0xDB87
{
	return 1;
}

int func_162()//Position - 0xDB90
{
	return 1;
}

int func_163()//Position - 0xDB99
{
...
int func_165(int iParam0)//Position - 0xDC6A
{
...
int func_166(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0xDEEA
{
	int iVar0;
	
	if (func_168(iParam0, uParam2, sParam3))
	{
		switch (iParam0)
		{
			case 0:
...
bool func_167(var uParam0)//Position - 0xE0D5
{
	int iVar0;
	struct<3> Var1;
	float fVar2;
...
int func_168(int iParam0, var uParam1, char* sParam2)//Position - 0xE18D
{
	struct<3> Var0;
	int iVar1;
	var uVar2;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[0];
			StringCopy(sParam2, func_172(Global_113648.f_2365.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[1];
			StringCopy(sParam2, func_172(Global_113648.f_2365.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_113648.f_2365.f_539.f_2310[2];
			StringCopy(sParam2, func_172(Global_113648.f_2365.f_539.f_2314[2]), 32);
			return 1;
			break;
		
		case 11:
			if (func_171(iParam0, &Var0, uParam1))
			{
		...
		case 9:
			return func_168(8, uParam1, sParam2);
			break;
		...
		case 23:
			return func_168(208, uParam1, sParam2);
			break;
	...
	switch (iParam0)
	{
		...
		case 224:
			return func_168(222, uParam1, sParam2);
			break;
		...
		case 294:
			return func_168(293, uParam1, sParam2);
			break;
		
		case 295:
			return func_168(292, uParam1, sParam2);
			break;
		...
		case 300:
			return func_168(303, uParam1, sParam2);
			break;
...
int func_169(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x1059A
{
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				...
				case 1:
					if (func_169(0, iParam1, uParam2, uParam3))
					{
		...
		case 21:
			...
			{
				case 0:
					if (func_169(0, 5, uParam2, uParam3))
					{
		...
		case 33:
			...
			{
				case 1:
					if (func_169(1, 32, uParam2, uParam3))
					{
						*uParam2 = { *uParam2 + Vector(0f, 0f, 0f) };
						*uParam3 = (*uParam3 + 0f);
						return 1;
		...
		case 46:
			return func_169(iParam0, 26, uParam2, uParam3);
			break;
		...
		case 60:
			if (func_169(iParam0, 59, uParam2, uParam3))
			{
		...
		case 77:
			if (func_169(iParam0, 47, uParam2, uParam3))
			{
				*uParam2 = { *uParam2 + Vector(0f, 0f, 0f) };
				*uParam3 = (*uParam3 + 0f);
				return 1;
		...
		case 131:
			...
			{
				case 13:
					if (func_169(iParam0, 130, uParam2, uParam3))
					{
						*uParam2 = { *uParam2 + Vector(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f)) };
						*uParam3 = (*uParam3 + MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f));
						return 1;
...
int func_171(int iParam0, var uParam1, var uParam2)//Position - 0x12505
{
	switch (iParam0)
	{
		case 11:
		...
		case 9:
			return func_171(8, uParam1, uParam2);
			break;
...
char* func_172(int iParam0)//Position - 0x12E74
{
	switch (iParam0)
	{
...
void func_173()//Position - 0x12F05
{
	if (iLocal_259 != 0)
	{
		VEHICLE::REMOVE_VEHICLE_ASSET(iLocal_259);
	}
