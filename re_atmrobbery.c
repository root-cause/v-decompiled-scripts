			...
			if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			{
				switch (iLocal_52)
				{
					...
					case 1:
						...
						if (iLocal_69 == 0)
						{
							iLocal_69 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(101 /*EVENT_SHOCKING_MUGGING*/, Local_53, 30000f);
						}
						...
						if (!PED::IS_PED_INJURED(iLocal_55))
						{
							...
							{
								TASK::TASK_SMART_FLEE_COORD(iLocal_55, Local_53, 200f, -1, false, false);
							...
							if (!PED::IS_PED_INJURED(iLocal_56))
							{
								if (CAM::IS_SPHERE_VISIBLE(Local_53, 2.5f))
								{
									if (bLocal_65 == 2)
									{
										if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 120f, 120f, 8f, false, true, 0) || func_193())
										{
											func_184();
										}
									}
									else if (bLocal_65 == 1)
									{
										if (SYSTEM::VDIST(Local_53, -203.758f, -861.738f, 29.2684f) < 5f)
										{
											if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 100f, 100f, 8f, false, true, 0) || func_193())
											{
												func_184();
											}
										}
										else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 170f, 170f, 8f, false, true, 0) || func_193())
										{
											func_184();
										}
									}
									...
									{
										if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 65f, 65f, 5f, false, true, 0) || func_193())
										{
											func_184();
										}
									}
									else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -712.9f, -819.32f, 22.73f, true) < 5f)
									{
										if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 50f, 50f, 5f, false, true, 0) || func_193())
										{
											func_184();
										}
									}
									else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, 24.13f, -946.84f, 28.36f, true) < 5f)
									{
										if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 60f, 60f, 5f, false, true, 0) || func_193())
										{
											func_184();
										}
									}
									else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 30f, 30f, 8f, false, true, 0) || func_193())
									{
										func_184();
									}
								}
						...
						else
						{
							...
							if (!PED::IS_PED_INJURED(iLocal_56))
							{
								TASK::TASK_SMART_FLEE_COORD(iLocal_56, Local_53, 200f, -1, false, false);
				...
				if (!PED::IS_PED_INJURED(iLocal_55))
				{
					if (func_180(iLocal_55, -251125078))
					{
						if (func_179(iLocal_55, Local_53, 1) >= 190f)
						{
							...
							TASK::TASK_SMART_FLEE_PED(iLocal_55, PLAYER::PLAYER_PED_ID(), 300f, -1, false, false);
						}
					}
				...
				if (!func_130() && !func_127())
				{
					...
					if (!iLocal_85 && !bLocal_90)
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
						{
							...
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 100f, 100f, 15f, false, true, 0))
								{
							...
							else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -203.72f, -861.8f, 29.27f, true) < 5f)
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 40f, 40f, 15f, false, true, 0))
								{
									if (func_120(&Local_107, cLocal_123, sLocal_115, 3, 0, 0, 0))
									{
										iLocal_85 = 1;
							...
							else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, 288.46f, -1256.71f, 28.44f, true) < 5f)
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 50f, 50f, 15f, false, true, 0))
								{
									if (func_120(&Local_107, cLocal_123, sLocal_115, 3, 0, 0, 0))
									{
										iLocal_85 = 1;
							...
							else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 50f, 50f, 15f, false, true, 0))
							{
								if (func_120(&Local_107, cLocal_123, sLocal_115, 3, 0, 0, 0))
								{
									iLocal_85 = 1;
					...
					if (HUD::DOES_BLIP_EXIST(iLocal_59))
					{
						if (!PED::IS_PED_INJURED(iLocal_55))
						{
							if (iLocal_126)
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_55, PLAYER::PLAYER_PED_ID(), fLocal_132, fLocal_132, fLocal_132, false, true, 0))
								{
							...
							{
								if ((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_55) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_55)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_55, PLAYER::PLAYER_PED_ID(), false))
								{
								...
								if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_73, false))
								{
									if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_73, PLAYER::PLAYER_PED_ID(), true))
									{
										...
										{
											TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_55, iLocal_73, PLAYER::PLAYER_PED_ID(), 8, 35f, 4, 10f, 10f, true);
										}
										else
										{
											TASK::TASK_SMART_FLEE_PED(iLocal_55, PLAYER::PLAYER_PED_ID(), 300f, -1, false, false);
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
							{
								if (!iLocal_87)
								{
									if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 15f, 15f, 10f, false, true, 0))
									{
								...
								else if (!iLocal_88)
								{
									if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 15f, 15f, 10f, false, true, 0))
									{
										if (((!PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_55) && !PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_55)) && !PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())) && func_116(iLocal_56, iLocal_55, 1) > 30f)
										{
							...
							if (func_112())
							{
								...
								if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
								{
									Var0 = { ENTITY::GET_ENTITY_COORDS(iLocal_56, true) };
								}
								if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_55, Var0, 25f, 25f, 25f, false, true, 0) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 12f, 12f, 12f, false, true, 0))
								{
									if (SYSTEM::TIMERA() > 20000)
									{
										if (func_110(iLocal_55) && !PED::IS_PED_RAGDOLL(iLocal_55))
										{
							...
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, Global_19, false, true, 0))
								{
								...
								else if (bLocal_130)
								{
									if (func_120(&Local_107, cLocal_123, sLocal_122, 4, 0, 0, 0))
									{
										...
										PED::FORCE_PED_MOTION_STATE(iLocal_56, joaat("MotionState_Walk"), false, 0, false);
										bLocal_127 = true;
										func_276();
									}
								}
						...
						{
							if ((PED::IS_PED_INJURED(iLocal_55) || PED::IS_PED_DEAD_OR_DYING(iLocal_55, true)) || func_180(iLocal_55, joaat("SCRIPT_TASK_WRITHE")))
							{
						...
						if (!bLocal_100)
						{
							if (!PED::IS_PED_INJURED(iLocal_56))
							{
								if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_56, false)) > (fLocal_82 + 100f))
								{
									...
									{
										TASK::TASK_SMART_FLEE_PED(iLocal_56, PLAYER::PLAYER_PED_ID(), 100f, -1, false, false);
										func_276();
									}
								}
	...
	if (!PED::IS_PED_INJURED(iLocal_56))
	{
		if (!bLocal_99)
		{
			if (iLocal_129)
			{
				if (!iLocal_131)
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 15f, 15f, 20f, false, true, 0))
					{
						func_114(iLocal_56, "GENERIC_HI", 5);
						iLocal_131 = 1;
					}
				}
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, 296.13f, -894.01f, 28.23f, true) < 5f)
				{
					if (fLocal_83 == 6f)
					{
						fLocal_83 = 5f;
				...
				else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -2072.88f, -317.19f, 12.32f, true) < 5f)
				{
					if (fLocal_83 == 6f)
					{
						fLocal_83 = 4f;
				...
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, fLocal_83, fLocal_83, fLocal_83, false, true, 0) && !func_98())
				{
					if (func_95(2))
					{
						HUD::CLEAR_HELP(true);
					...
					if (!func_127())
					{
						if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
						{
							if (func_94(1, 0, 1))
							{
								if (!BitTest(Global_8136, 11) || func_93())
								{
									if (!PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
									{
										...
										if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
										{
											ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_57, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
										}
										...
										if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
										{
											...
											{
												while ((!func_81(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fLocal_84, 1, 1056964608, 0, 1, 0) || func_92()) || !ENTITY::DOES_ENTITY_HAVE_DRAWABLE(iLocal_57))
												{
													if (!func_81(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fLocal_84, 1, 1056964608, 0, 1, 0))
													{
													}
													if (func_92())
													{
										...
										{
											while (func_92() || !ENTITY::DOES_ENTITY_HAVE_DRAWABLE(iLocal_57))
											{
												SYSTEM::WAIT(0);
											}
										}
										...
										if (!PED::IS_PED_INJURED(iLocal_56))
										{
											PED::SET_PED_CAN_RAGDOLL(iLocal_56, false);
										}
				...
				else
				{
					...
					if (!func_98())
					{
						if (!func_180(iLocal_56, joaat("SCRIPT_TASK_GO_TO_ENTITY")) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
						{
							TASK::CLEAR_PED_TASKS(iLocal_56);
							TASK::TASK_GO_TO_ENTITY(iLocal_56, PLAYER::PLAYER_PED_ID(), 20000, 0.5f, 1f, 2f, 0);
						}
					}
					else if (func_180(iLocal_56, joaat("SCRIPT_TASK_GO_TO_ENTITY")))
					{
						...
						TASK::TASK_PERFORM_SEQUENCE(iLocal_56, iLocal_61);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_61);
						PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_56, false, false);
					}
				}
			}
			else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 25f, 25f, 20f, false, true, 1) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 30f, 30f, 20f, false, true, 2))
			{
				if (!func_98())
				{
			...
			switch (iLocal_98)
			{
				case 0:
					if (((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_PRONE(PLAYER::PLAYER_PED_ID())) && !TASK::IS_PED_GETTING_UP(PLAYER::PLAYER_PED_ID()))
					{
						if (bLocal_80)
						{
							if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -712.9f, -819.32f, 22.73f, true) < 5f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -709.9229f, -824.0863f, 22.075096f, -715.21375f, -824.2247f, 25.01217f, 3.25f, false, true, 0))
							{
							...
							{
								Var7 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false) };
								...
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -203.72f, -861.8f, 29.27f, true) < 5f)
								{
								...
								else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -821.33f, -1082.43f, 10.14f, true) < 5f && OBJECT::IS_POINT_IN_ANGLED_AREA(Local_78, -826.17444f, -1083.9429f, 9.137519f, -811.65594f, -1075.567f, 13.887788f, 6f, false, true))
								{
									Local_78 = { -814.0593f, -1082.4833f, 10.0671f };
									Local_79.f_2 = 275.5752f;
								}
								else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -387.12f, 6045.79f, 30.5f, true) < 5f && OBJECT::IS_POINT_IN_ANGLED_AREA(Local_78, -377.57883f, 6033.821f, 29.291185f, -373.0138f, 6029.1396f, 33.753822f, 4.75f, false, true))
								{
									Local_78 = { -375.0627f, 6030.533f, 30.5313f };
									Local_79.f_2 = 222.9049f;
								}
								else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -387.12f, 6045.79f, 30.5f, true) < 5f && OBJECT::IS_POINT_IN_ANGLED_AREA(Local_78, -381.46072f, 6031.4814f, 29.249712f, -376.67657f, 6026.68f, 33.766556f, 3f, false, true))
								{
									Local_78 = { -379.7835f, 6029.4717f, 30.5014f };
									Local_79.f_2 = 213.2611f;
								}
								else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, 89.39f, 2f, 67.34f, true) < 5f)
								{
								...
								else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, 174.53f, 6637.64f, 30.57f, true) < 5f)
								{
								...
								else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -3044.11f, 594.34f, 6.73f, true) < 5f)
								{
								...
								Var4 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_142, sLocal_144, Local_78, Local_79, 0f, 2) };
								Var5 = { Var4 - Local_78 };
								Var5.f_2 = 0f;
								fVar10 = SYSTEM::VMAG(Var5);
								MISC::GET_GROUND_Z_FOR_3D_COORD(Var4, &(Var4.f_2), false, false);
								fVar9 = (Local_78.f_2 - Var4.f_2);
								Local_79.f_0 = MISC::ATAN2(fVar9, fVar10);
							...
							{
								if (OBJECT::IS_POINT_IN_ANGLED_AREA(Local_78, -538.4412f, -1214.9027f, 16.797941f, -520.32684f, -1223.2487f, 20.555996f, 6.5f, false, true))
								{
						...
						else if (bLocal_65 == 4)
						{
							...
							{
								Local_78 = { 183.6065f, 6636.6533f, 30.6299f };
								Local_79 = { 0f, 0f, 265f };
							}
							else
							{
						...
						else
						{
							...
							if (!PED::IS_PED_INJURED(iLocal_56))
							{
								Var2 = { ENTITY::GET_ENTITY_COORDS(iLocal_56, true) };
							}
							Var3 = { Var1 - Var2 };
							Local_78 = { Var1 };
							Local_78 = { Local_78.f_0, Local_78.f_1, (Local_78.f_2 - 1f) };
							Local_79 = { 0f, 0f, MISC::GET_HEADING_FROM_VECTOR_2D(Var3.f_0, Var3.f_1) };
						}
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_78, -535.795f, -1222.23f, 17.4567f, true) < 5f)
						{
						...
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
						{
							if (!VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
							{
								...
								MISC::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iVar0), &Local_136, &Local_137);
								if (ENTITY::IS_ENTITY_AT_COORD(iVar0, Local_78, (Local_137.f_1 + 1f), (Local_137.f_1 + 1f), 3f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(iVar0, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_142, sLocal_144, Local_78, Local_79, 0f, 2), (Local_137.f_1 + 1f), (Local_137.f_1 + 1f), 3f, false, true, 0))
								{
									if (func_67(Local_53, -526.58f, -1222.79f, 17.46f, 10f, 0) && (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -529.74774f, -1218.3987f, 16.78482f, -538.97784f, -1213.7561f, 20.536852f, 7.5f, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -529.74774f, -1218.3987f, 16.78482f, -520.9798f, -1222.3054f, 20.552042f, 7.5f, false, true, 0)))
									{
										...
										{
											Var6 = { 2.9f, 12f, 8f };
											Local_75 = { -522.4418f, -1214.5704f, 17.1848f };
											fLocal_77 = 246.7714f;
											bVar8 = true;
										}
										...
										if (bVar8)
										{
											if (func_66(iVar0))
											{
												ENTITY::SET_ENTITY_COORDS(iVar0, Local_75, true, false, false, true);
									...
									else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -203.72f, -861.8f, 29.27f, true) < 5f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -197.76158f, -865.97723f, 27.311165f, -191.161f, -849.0546f, 32.892746f, 10.25f, false, true, 0))
									{
										Var6 = { 2.9f, 12f, 8f };
									...
									else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -387.12f, 6045.79f, 30.5f, true) < 5f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -390.45358f, 6044.0503f, 29.998678f, -380.4771f, 6032.985f, 33.248787f, 6f, false, true, 0))
									{
										Var6 = { 2.9f, 12f, 8f };
									...
									else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -2956.78f, 488.19f, 14.47f, true) < 5f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -2955.2336f, 492.46262f, 13.803072f, -2967.1165f, 493.05115f, 17.056633f, 9.75f, false, true, 0))
									{
										Var6 = { 2.9f, 12f, 8f };
									...
									else
									{
										...
										Local_75 = { func_64(Local_78, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_142, sLocal_144, Local_78, Local_79, 0f, 2)) };
										if (func_63(0f, 0f, 0f, Local_75, 0))
										{
											Local_75 = { ENTITY::GET_ENTITY_COORDS(iVar0, true) };
										}
						...
						{
							MISC::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iVar0), &Local_136, &Local_137);
							if (ENTITY::IS_ENTITY_AT_COORD(iVar0, Local_78, (Local_137.f_1 + 1f), (Local_137.f_1 + 1f), 1f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(iVar0, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_142, sLocal_144, Local_78, Local_79, 0f, 2), (Local_137.f_1 + 1f), (Local_137.f_1 + 1f), 1f, false, true, 0))
							{
								ENTITY::SET_ENTITY_COORDS(iVar0, Local_140, true, false, false, true);
						...
						TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_68, cLocal_142, sLocal_143, 1000f, -1000f, 1024, 0, 1000f, 0);
						PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), false, false);
						if (!PED::IS_PED_INJURED(iLocal_56))
						{
							TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_56);
							TASK::TASK_SYNCHRONIZED_SCENE(iLocal_56, iLocal_68, cLocal_142, sLocal_144, 1000f, -4f, 0, 0, 1000f, 0);
						}
				...
				case 1:
					if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_68) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_68) == 1f) || func_47())
					{
						...
						if (!PED::IS_PED_INJURED(iLocal_56))
						{
							...
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_56, false);
							PED::SET_PED_MOVEMENT_CLIPSET(iLocal_56, sLocal_94, 0.25f);
						}
						if (CAM::IS_SCREEN_FADED_OUT())
						{
							...
							MISC::GET_GROUND_Z_FOR_3D_COORD(Var4, &(Var4.f_2), false, false);
							ENTITY::SET_ENTITY_COORDS(iLocal_56, Var4, true, false, false, true);
							Var4 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(cLocal_142, sLocal_144, Local_78, Local_79, 1f, 2) };
							ENTITY::SET_ENTITY_HEADING(iLocal_56, Var4.f_2);
						}
						Var4 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(cLocal_142, sLocal_144, Local_78, Local_79, 1f, 2) };
						if (func_67(Local_53, -526.58f, -1222.79f, 17.46f, 10f, 0))
						{
							...
							{
								TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_56, 0f, 3.5f, 0f), 1f, 20000, 0.25f, 5, 40000f);
						...
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_56, 0f, 2.5f, 0f), 1f, 20000, 0.25f, 5, 40000f);
							TASK::TASK_WANDER_STANDARD(0, ENTITY::GET_ENTITY_HEADING(iLocal_56), 1);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_61);
							TASK::TASK_PERFORM_SEQUENCE(iLocal_56, iLocal_61);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_61);
						}
						PED::FORCE_PED_MOTION_STATE(iLocal_56, joaat("MotionState_Walk"), true, 0, false);
						PED::SET_PED_CAN_RAGDOLL(iLocal_56, true);
						PED::SET_PED_KEEP_TASK(iLocal_56, true);
						func_45(&iLocal_73);
						SYSTEM::SETTIMERB(0);
					...
					else
					{
						...
						if (ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), joaat("detach")))
						{
							if (!PED::IS_PED_INJURED(iLocal_56) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
							{
								...
								{
									ENTITY::DETACH_ENTITY(iLocal_57, false, true);
									if (PED::IS_PED_MALE(iLocal_56))
									{
										ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_57, iLocal_56, PED::GET_PED_BONE_INDEX(iLocal_56, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
									}
									else
									{
										ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_57, iLocal_56, PED::GET_PED_BONE_INDEX(iLocal_56, 60309), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
									}
								}
							}
						}
...
void func_7(bool bParam0)//Position - 0x3303
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_9() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_9() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
void func_38()//Position - 0x3D49
{
	...
	{
		if (func_41(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_40(PLAYER::PLAYER_PED_ID());
			if (func_39(iVar0) && (!func_32(14) || Global_112337))
			{
...
bool func_63(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x4874
{
	if (bParam2)
	{
...
Vector3 func_64(struct<3> Param0, struct<3> Param1)//Position - 0x48BB
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var2;
...
Vector3 func_65(struct<3> Param0, float fParam1, struct<2> Param2, var uParam3)//Position - 0x4EBC
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
int func_67(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x4F33
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
float func_69(struct<2> Param0, Vector3 vParam1, struct<2> Param2, var uParam3, int iParam4)//Position - 0x5166
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_71(struct<3> Param0, float fParam1, float fParam2)//Position - 0x51F7
{
	bool bVar0;
	struct<3> Var1;
	float fVar2;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (func_72(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fVar2, 15f))
		{
			bVar0 = true;
		}
...
bool func_84()//Position - 0x585C
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_85(int iParam0, int iParam1)//Position - 0x5876
{
	bool bVar0;
...
int func_86(int iParam0, bool bParam1)//Position - 0x58C1
{
	int iVar0;
	int iVar1;
...
int func_87(int iParam0)//Position - 0x5902
{
...
bool func_88()//Position - 0x5941
{
	return BitTest(Global_2621446, 3);
}

int func_89(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x594F
{
	int iVar0;
...
void func_90(int iParam0)//Position - 0x5982
{
	if (iParam0 == 1)
	{
...
void func_91()//Position - 0x59A5
{
	Global_20471 = 0;
	func_60();
}

int func_92()//Position - 0x59B5
{
...
int func_94(bool bParam0, bool bParam1, bool bParam2)//Position - 0x59F8
{
	int iVar0;
...
bool func_95(int iParam0)//Position - 0x5ADD
{
	return func_96(func_97(iParam0));
}

bool func_96(char* sParam0)//Position - 0x5AEF
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

char* func_97(int iParam0)//Position - 0x5B02
{
	char* sVar0;
...
void func_100(int iParam0)//Position - 0x6129
{
	switch (iParam0)
	{
		case 0:
...
void func_101(char* sParam0, int iParam1)//Position - 0x6204
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

void func_102(var uParam0)//Position - 0x621B
{
	*uParam0 = -99;
}

int func_103(int iParam0, bool bParam1, int iParam2)//Position - 0x6229
{
	iParam2 = iParam2;
	return func_104(iParam0, bParam1, 145);
}

int func_104(int iParam0, bool bParam1, int iParam2)//Position - 0x623F
{
	int iVar0;
...
int func_105(int iParam0, bool bParam1, bool bParam2)//Position - 0x6289
{
	int iVar0;
...
float func_106(bool bParam0, float fParam1, float fParam2)//Position - 0x632D
{
	if (bParam0)
	{
		return fParam1;
...
void func_107()//Position - 0x6344
{
	...
	if (!bLocal_90)
	{
		...
		iLocal_89 = OBJECT::CREATE_PICKUP(iVar0, PED::GET_DEAD_PED_PICKUP_COORDS(iLocal_55, 1.2f, 1.5f), iVar1, iLocal_133, true, iLocal_101);
		bLocal_90 = true;
		iLocal_60 = func_108(iLocal_89);
	...
	else
	{
		if (!iLocal_91)
		{
			if (!func_180(iLocal_56, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) && !PED::IS_PED_INJURED(iLocal_56))
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
				if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_56, Local_138, 0.5f, 0.5f, 0.5f, false, true, 0))
				{
					TASK::TASK_GO_STRAIGHT_TO_COORD(0, Local_138, 1f, 20000, 40000f, 0.5f);
				}
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
		...
		if (iLocal_91)
		{
			if (!bLocal_95)
			{
				if (!PED::IS_PED_INJURED(iLocal_56))
				{
					...
					else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_56, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) == 7)
					{
						TASK::CLEAR_PED_TASKS(iLocal_56);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
...
int func_108(int iParam0)//Position - 0x664D
{
	return func_109(iParam0);
}

int func_109(int iParam0)//Position - 0x665B
{
	int iVar0;
...
int func_110(int iParam0)//Position - 0x6693
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_111()//Position - 0x66B4
{
	...
	switch (bLocal_65)
	{
		...
		case 2:
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_73, false) && PED::IS_PED_IN_VEHICLE(iLocal_55, iLocal_73, false))
			{
			...
			else if (!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_73, false) || !func_180(iLocal_55, joaat("SCRIPT_TASK_VEHICLE_MISSION")))
			{
				bVar0 = true;
			}
			if (!PED::IS_PED_FLEEING(iLocal_55))
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_55, joaat("SCRIPT_TASK_VEHICLE_MISSION")) == 7)
				{
					bVar0 = true;
				}
			}
			if (bVar0)
			{
				if (!iLocal_86)
				{
					if (PED::IS_PED_IN_VEHICLE(iLocal_55, iLocal_73, false))
					{
						if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_55, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_55, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) != 0)
						{
					...
					else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_55, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_55, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) != 0)
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_62);
						TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 300f, -1, false, false);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_62);
...
int func_112()//Position - 0x6842
{
	if (!PED::IS_PED_INJURED(iLocal_55))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 180f, 180f, 50f, false, true, 0) || !ENTITY::IS_ENTITY_OCCLUDED(iLocal_55))
		{
...
void func_113(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)//Position - 0x68EF
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_114(int iParam0, char* sParam1, int iParam2)//Position - 0x6A48
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iParam0, sParam1, func_115(iParam2), 1);
}

int func_115(int iParam0)//Position - 0x6A5F
{
	int iVar0;
...
float func_116(int iParam0, int iParam1, bool bParam2)//Position - 0x6C54
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_117(int iParam0, var uParam1)//Position - 0x6CB2
{
	if (HUD::DOES_BLIP_EXIST(iParam0))
	{
...
var func_118(int iParam0)//Position - 0x6D10
{
	return BitTest(Global_113382, iParam0);
}

void func_119()//Position - 0x6D1F
{
	switch (bLocal_65)
	{
		case 1:
		case 2:
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_73, false))
			{
				if (iLocal_126)
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(iLocal_55, iLocal_73) || TASK::GET_SCRIPT_TASK_STATUS(iLocal_55, joaat("SCRIPT_TASK_VEHICLE_MISSION")) == 1)
					{
						TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iLocal_55, iLocal_73, Local_53, 8, 35f, 786469, 10f, 10f, true);
					}
					else
					{
						TASK::TASK_SMART_FLEE_PED(iLocal_55, PLAYER::PLAYER_PED_ID(), 300f, -1, false, false);
				...
				else
				{
					if (!VEHICLE::DOES_VEHICLE_HAVE_STUCK_VEHICLE_CHECK(iLocal_73))
					{
						VEHICLE::ADD_VEHICLE_STUCK_CHECK_WITH_WARP(iLocal_73, 0.1f, 1000, false, false, false, -1);
					}
					TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iLocal_55, iLocal_73, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 8, 35f, 786469, 10f, 10f, true);
				}
			}
			else
			{
		...
		default:
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -3044.11f, 594.34f, 6.73f, true) < 5f)
			{
				TASK::TASK_SMART_FLEE_COORD(iLocal_55, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 300f, -1, false, false);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_61);
			}
			else if (iLocal_126)
			{
...
bool func_120(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6F16
{
...
int func_121(char* sParam0, int iParam1, bool bParam2)//Position - 0x6F64
{
	Global_21606 = 0;
	if (Global_21605 == 0 || Global_21607 == 2)
	{
...
bool func_124(int iParam0)//Position - 0x72CC
{
	return func_125(iParam0, 20);
}

var func_125(int iParam0, int iParam1)//Position - 0x72DC
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

int func_126()//Position - 0x72F4
{
	return -1;
}

bool func_127()//Position - 0x72FD
{
	bool bVar0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (!PED::IS_PED_INJURED(iLocal_56))
	{
		...
		if (MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_56, 31086, 0f, 0f, 0f), 2f, true))
		{
			bVar0 = true;
		}
		Var1 = { Var1 + PED::GET_PED_BONE_COORDS(iLocal_56, 31086, 0f, 0f, 0f) };
		Var2 = { Var2 + PED::GET_PED_BONE_COORDS(iLocal_56, 31086, 0f, 0f, 0f) };
	...
	if (bVar0)
	{
		...
		{
			bVar0 = false;
			if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_56, joaat("SCRIPT_TASK_COWER")) != 1)
			{
...
int func_128(int iParam0)//Position - 0x744E
{
	if (func_110(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
bool func_130()//Position - 0x7496
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
	{
		...
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_56, PLAYER::PLAYER_PED_ID(), true) && PED::IS_PED_RAGDOLL(iLocal_56))
			{
				bVar0 = true;
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_56);
			}
			if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_56, true), 1f, true))
			{
				bVar0 = true;
			}
...
int func_131(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x757B
{
	struct<3> Var0;
...
int func_132(int iParam0, float fParam1)//Position - 0x7636
{
	float fVar0;
...
bool func_133(int iParam0, float fParam1)//Position - 0x76AC
{
	return func_134(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_134(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x76C4
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
...
int func_135(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x7785
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_136(int iParam0, int iParam1)//Position - 0x78B1
{
	int iVar0;
...
int func_138(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x79C0
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	{
		Var1 = { func_140(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_139(struct<3> Param0, struct<3> Param1)//Position - 0x7A51
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_140(struct<3> Param0)//Position - 0x7A72
{
	float fVar0;
	float fVar1;
...
void func_141(var uParam0)//Position - 0x7AB1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_142(int iParam0, int iParam1)//Position - 0x7ACC
{
	int iVar0;
...
int func_143(int iParam0)//Position - 0x7B0B
{
...
bool func_144(int iParam0, int iParam1, float fParam2)//Position - 0x7B33
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_145(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x7B7A
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_146(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x7C75
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_147(int iParam0, float fParam1)//Position - 0x7D81
{
	var uVar0;
	struct<3> Var1;
...
int func_148(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0x7E16
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_149(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x7EA4
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_150()//Position - 0x7EEC
{
	if (bLocal_90 || ENTITY::IS_ENTITY_DEAD(iLocal_55, false))
	{
		func_178(&uLocal_152, 0, 0);
	}
	else
	{
		func_151(&uLocal_152, iLocal_55, "ATM_CHASEHINT" /* GXT: ~s~Press ~INPUT_VEH_CIN_CAM~ to toggle focus on the thief. */, 0, 1, 1, 1);
	}
}

void func_151(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x7F23
{
	func_152(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_152(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x7F3D
{
	func_153(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_153(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x7F5A
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
	{
...
void func_154(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x7F92
{
	int iVar0;
	int iVar1;
...
void func_155(var uParam0)//Position - 0x8301
{
...
int func_156(var uParam0)//Position - 0x836A
{
	int iVar0;
...
int func_157(bool bParam0)//Position - 0x8395
{
	switch (Global_43052)
	{
		case 0:
...
int func_158(char* sParam0)//Position - 0x843F
{
	if (!func_159(1, 1, 0))
	{
...
int func_159(bool bParam0, bool bParam1, bool bParam2)//Position - 0x84D8
{
	int iVar0;
	int iVar1;
	...
	if ((func_166() || func_165(Global_4718592.f_168757)) || func_164())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
...
int func_160(int iParam0)//Position - 0x8731
{
	if (iParam0 != func_126())
	{
		...
		else if ((Global_1575058 && iParam0 == PLAYER::PLAYER_ID()) && func_161(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
int func_161(int iParam0, bool bParam1, bool bParam2)//Position - 0x8797
{
	int iVar0;
...
int func_162(int iParam0, int iParam1)//Position - 0x87F7
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
...
int func_163(int iParam0, bool bParam1)//Position - 0x8859
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_164()//Position - 0x88DE
{
	return Global_2714762.f_19;
}

bool func_165(int iParam0)//Position - 0x88EC
{
	return iParam0 == 51;
}

var func_166()//Position - 0x88F9
{
	return Global_2714762.f_18;
}

bool func_167()//Position - 0x8907
{
	return MISC::GET_GAME_TIMER() <= Global_23150.f_6269 + 100;
}

void func_168(var uParam0, int iParam1, struct<3> Param2, int iParam3)//Position - 0x891C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_169()//Position - 0x8A2C
{
	return func_170(PLAYER::PLAYER_ID());
}

int func_170(int iParam0)//Position - 0x8A3C
{
...
int func_171(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x8A5B
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_172(bool bParam0, bool bParam1, bool bParam2)//Position - 0x8DC7
{
...
int func_173(bool bParam0, bool bParam1, bool bParam2)//Position - 0x8E19
{
	if (!func_159(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_174(bool bParam0, bool bParam1, bool bParam2)//Position - 0x8E62
{
	if (!func_159(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_175(bool bParam0, bool bParam1, bool bParam2)//Position - 0x8EC1
{
	if (!func_159(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_176(int iParam0)//Position - 0x8F17
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(iParam0))
...
void func_177()//Position - 0x8F72
{
	MISC::SET_BIT(&Global_8137, 4);
}

void func_178(var uParam0, int iParam1, bool bParam2)//Position - 0x8F82
{
	char* sVar0;
...
float func_179(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x905C
{
	struct<3> Var0;
...
int func_180(int iParam0, int iParam1)//Position - 0x9096
{
	if (func_128(iParam0))
	{
...
void func_181(char* sParam0)//Position - 0x90C9
{
	func_182(sParam0);
}

void func_182(char* sParam0)//Position - 0x90D7
{
...
void func_183(var uParam0, int iParam1)//Position - 0x90EA
{
...
void func_184()//Position - 0x9107
{
	...
	func_119();
	if ((SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iLocal_56, false), -2956.26f, 487.97f, 15.46f) > 5f && MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -203.72f, -861.8f, 29.27f, true) > 5f) && MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, 288.46f, -1256.71f, 28.44f, true) > 5f)
	{
		if (func_116(PLAYER::PLAYER_PED_ID(), iLocal_56, 1) < 50f)
		{
...
int func_185(int iParam0)//Position - 0x92BE
{
	if (func_187())
	{
		Global_113376 = 1;
		Global_113373 = MISC::GET_GAME_TIMER();
		if (func_186(Global_113375))
		{
			func_100(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /* GXT: Random Event */);
		if (iParam0 && func_186(Global_113375))
		{
...
int func_186(int iParam0)//Position - 0x9311
{
	switch (iParam0)
	{
		case 29:
...
int func_187()//Position - 0x9340
{
	switch (func_188(&Global_32019, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_188(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x9376
{
	int iVar0;
...
void func_189(var uParam0, int iParam1)//Position - 0x94AD
{
	int iVar0;
...
bool func_190(int iParam0)//Position - 0x94FC
{
	return func_191(iParam0, Global_43052);
}

int func_191(int iParam0, int iParam1)//Position - 0x950D
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_192(int iParam0)//Position - 0x96EE
{
	if (Global_43052 == 15)
	{
		return 0;
...
int func_193()//Position - 0x9710
{
	...
	if (HUD::DOES_BLIP_EXIST(iLocal_59))
	{
		if ((MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -3044.11f, 594.34f, 6.73f, true) > 5f && MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -712.9f, -819.32f, 22.73f, true) > 5f) && MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, 24.13f, -946.84f, 28.36f, true) > 5f)
		{
...
void func_194()//Position - 0x97FE
{
	if (SYSTEM::VDIST(Local_53, -3044.06f, 594.93f, 6.74f) < 5f)
	{
		if (!HUD::DOES_BLIP_EXIST(iLocal_59))
		{
			if (func_110(iLocal_56) && func_110(PLAYER::PLAYER_PED_ID()))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 60f, 90f, 12f, false, true, 0))
				{
					iLocal_59 = func_103(iLocal_55, 1, 0);
	...
	else if (!HUD::DOES_BLIP_EXIST(iLocal_59))
	{
		if (func_110(iLocal_56) && func_110(PLAYER::PLAYER_PED_ID()))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 90f, 90f, 8f, false, true, 0))
			{
				iLocal_59 = func_103(iLocal_55, 1, 0);
				HUD::SHOW_HEIGHT_ON_BLIP(iLocal_59, false);
			}
...
int func_195()//Position - 0x98E9
{
	...
	if (bLocal_65 == 1)
	{
		...
		if (SYSTEM::VDIST(Local_53, -203.758f, -861.738f, 29.2684f) < 5f)
		{
			...
			fLocal_77 = 160.391f;
			Local_136 = { -259.0351f, -865.71185f, 28f };
			Local_137 = { -130.39812f, -908.80963f, 40f };
	...
	else if (bLocal_65 == 2)
	{
		...
		fLocal_76 = 78.25f;
		Local_75 = { 288.9906f, -1248.4432f, 28.2847f };
		fLocal_77 = 75.9756f;
		Local_136 = { 266.36426f, -1313.8293f, 28.591026f };
		Local_137 = { 265.14893f, -1215.9318f, 36.20192f };
		STREAMING::REQUEST_MODEL(iLocal_106);
		while (!STREAMING::HAS_MODEL_LOADED(iLocal_106))
		{
			if (func_206())
	...
	{
		func_219();
		Local_75 = { -1587.1504f, -539.9152f, 34.3644f };
		fLocal_77 = 327f;
		Local_136 = { -1596.2025f, -474.88443f, 32f };
		Local_137 = { -1595.5721f, -565.8368f, 48f };
	}
	else if (bLocal_65 == 4)
	{
		func_219();
		Local_74 = { 181.2355f, 6632.6274f, 30.5732f };
		fLocal_76 = 182f;
		Local_75 = { 200.0727f, 6630.5874f, 30.517f };
		fLocal_77 = 165f;
		Local_136 = { 178.18172f, 6660.375f, 31f };
		Local_137 = { 179.12494f, 6530.043f, 38f };
	...
	if (func_197())
	{
		MISC::CLEAR_AREA(Local_53, Var2.f_0, false, false, false, false);
		iLocal_63 = PED::ADD_SCENARIO_BLOCKING_AREA(Local_53 - Var2, Local_53 + Var2, false, true, true, true);
		iLocal_56 = PED::CREATE_PED(5, iLocal_105, Local_53, fLocal_54, true, true);
		...
		iLocal_55 = PED::CREATE_PED(22, iLocal_104, Local_53, 0f, true, true);
		PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_55, 17, true);
		PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_55, 13, false);
		...
		PED::DISABLE_PED_INJURED_ON_GROUND_BEHAVIOUR(iLocal_55);
		AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_55, sLocal_146);
		PED::SET_PED_TARGET_LOSS_RESPONSE(iLocal_55, 1);
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_55, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_92, "b_atm_mugging", Var0, Var1, 0f, 2), false, false, true);
		Var3 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(cLocal_92, "b_atm_mugging", Var0, Var1, 0f, 2) };
		ENTITY::SET_ENTITY_HEADING(iLocal_55, Var3.f_2);
		if (func_110(iLocal_56))
		{
			if (PED::IS_PED_MALE(iLocal_56))
			{
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_56, PED::GET_ANIM_INITIAL_OFFSET_POSITION("random@atmrobberygen@male", "idle_a", Var0, Var1, 0f, 2), false, false, true);
				Var3 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION("random@atmrobberygen@male", "idle_a", Var0, Var1, 0f, 2) };
			}
			else
			{
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_56, PED::GET_ANIM_INITIAL_OFFSET_POSITION("random@atmrobberygen@female", "idle_a", Var0, Var1, 0f, 2), false, false, true);
				Var3 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION("random@atmrobberygen@female", "idle_a", Var0, Var1, 0f, 2) };
			}
			ENTITY::SET_ENTITY_HEADING(iLocal_56, Var3.f_2);
		}
		TASK::TASK_PLAY_ANIM(iLocal_55, cLocal_92, "b_atm_mugging", 1000f, -4f, -1, 1, 0f, false, false, false);
		if (PED::IS_PED_MALE(iLocal_56))
		{
			TASK::TASK_PLAY_ANIM(iLocal_56, "random@atmrobberygen@male", "idle_a", 1000f, -4f, -1, 1, 0f, false, false, false);
			STREAMING::REMOVE_ANIM_DICT("random@atmrobberygen@female");
		}
		else
		{
			TASK::TASK_PLAY_ANIM(iLocal_56, "random@atmrobberygen@female", "idle_a", 1000f, -4f, -1, 1, 0f, false, false, false);
			STREAMING::REMOVE_ANIM_DICT("random@atmrobberygen@male");
		}
		PED::SET_PED_AS_ENEMY(iLocal_55, true);
		...
		WEAPON::SET_PED_AMMO(iLocal_55, joaat("WEAPON_PISTOL"), 34, false);
		...
		func_196(&Local_107, 0, PLAYER::PLAYER_PED_ID(), sLocal_112, 0, 1);
		func_196(&Local_107, 1, iLocal_56, sLocal_114, 0, 1);
		func_196(&Local_107, 2, iLocal_55, "ATMRobber", 0, 1);
		if (bLocal_65 == 1 || bLocal_65 == 2)
		{
			iLocal_73 = VEHICLE::CREATE_VEHICLE(iLocal_106, Local_74, fLocal_76, true, true, false);
			...
			if (bLocal_65 == 2)
			{
				VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_73, 0, false, false);
			}
			else if (bLocal_65 == 1)
			{
				PED::SET_PED_HELMET(iLocal_55, false);
...
void func_196(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x9FA5
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
int func_197()//Position - 0xA040
{
	...
	if ((STREAMING::HAS_ANIM_DICT_LOADED("random@atmrobberygen@male") && STREAMING::HAS_ANIM_DICT_LOADED("random@atmrobberygen@female")) && func_198(&Local_164))
	{
		return 1;
	}
	return 0;
...
int func_198(var uParam0)//Position - 0xA0E5
{
	int iVar0;
...
bool func_199(var uParam0)//Position - 0xA141
{
	return func_200(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

int func_200(char* sParam0, char* sParam1, int iParam2)//Position - 0xA158
{
...
int func_201(var uParam0)//Position - 0xA243
{
	bool bVar0;
...
void func_202(var uParam0, char* sParam1)//Position - 0xA26C
{
	func_203(uParam0, 1, -1, sParam1, 0);
}

void func_203(var uParam0, bool bParam1, int iParam2, char* sParam3, int iParam4)//Position - 0xA27F
{
	int iVar0;
...
void func_204(var uParam0, int iParam1)//Position - 0xA35E
{
	func_203(uParam0, 0, iParam1, "NULL", 0);
}

void func_205(var uParam0, int iParam1)//Position - 0xA372
{
	if (iParam1 > 0)
	{
...
int func_206()//Position - 0xA389
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_51) < (75f * 75f))
		{
			return 1;
		}
...
int func_207(float fParam0, bool bParam1)//Position - 0xA40F
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_208(int iParam0, var uParam1)//Position - 0xA4C0
{
	switch (iParam0)
	{
		case 0:
...
void func_209(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0xB675
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_210(int iParam0)//Position - 0xB706
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_211(int iParam0)//Position - 0xBA4C
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_212(int iParam0)//Position - 0xBA83
{
	struct<2> Var0;
...
bool func_215()//Position - 0xBF47
{
	return Global_113104 > 0;
}

int func_216()//Position - 0xBF55
{
	if (Global_97363 != -1)
	{
		return 1;
...
void func_219()//Position - 0xBFAA
{
	...
	{
		bLocal_71 = MISC::GET_RANDOM_INT_IN_RANGE(1, 5);
	}
	else if (bLocal_65 != 5)
	{
		bLocal_71 = bLocal_65;
	...
	else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, 296.13f, -894.01f, 28.23f, true) < 5f)
	{
	...
	else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, 1077.69f, -775.73f, 57.21f, true) < 5f)
	{
	...
	else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -821.33f, -1082.43f, 10.14f, true) < 5f)
	{
	...
	else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -387.12f, 6045.79f, 30.5f, true) < 5f)
	{
	...
	else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -301.84f, -830.39f, 31.38f, true) < 5f)
	{
	...
	else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -254.3f, -691.96f, 32.61f, true) < 5f)
	{
	...
	else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -526.42f, -1222.51f, 17.46f, true) < 5f)
	{
	...
	else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_53, -2956.78f, 488.19f, 14.47f, true) < 5f)
	{
...
int func_222()//Position - 0xCB85
{
	if ((Global_113375 == func_223() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_113376)
	{
		return 1;
	}
	return 0;
...
int func_224(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0xCBCD
{
...
void func_225(var uParam0)//Position - 0xCDA7
{
	int iVar0;
...
void func_226(int* iParam0)//Position - 0xCE25
{
	func_227(iParam0, &(iParam0->f_2), iParam0->f_1);
}

void func_227(int* iParam0, char* sParam1, int iParam2)//Position - 0xCE3B
{
...
void func_228(int iParam0, var uParam1)//Position - 0xCF0C
{
	int iVar0;
	int iVar1;
...
void func_229()//Position - 0xCFAB
{
}

void func_230()//Position - 0xCFB3
{
}

void func_231(int iParam0)//Position - 0xCFBB
{
	if (iParam0 == -1)
	{
		iParam0 = func_223();
...
void func_233(int iParam0)//Position - 0xD02E
{
	Global_113375 = iParam0;
}

int func_234(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xD03C
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_269(Global_113386.f_24995.f_43[iParam1]))
		{
			return 0;
		}
...
bool func_235(int iParam0)//Position - 0xD3D6
{
	int iVar0;
...
int func_236(int iParam0)//Position - 0xD3F7
{
	return func_237(iParam0, 1);
}

int func_237(int iParam0, int iParam1)//Position - 0xD406
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_238(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xD459
{
	func_239(func_250(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_239(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xD477
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_240(float fParam0, float fParam1, float fParam2)//Position - 0xD678
{
	float fVar0;
...
int func_241(int iParam0, int iParam1)//Position - 0xD6BA
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_242(int iParam0)//Position - 0xD75C
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_243(int iParam0)//Position - 0xD76F
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_244(int iParam0)//Position - 0xD782
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_245(int iParam0)//Position - 0xD795
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_246(int iParam0)//Position - 0xD7A7
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_247(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_247(bool bParam0, int iParam1, int iParam2)//Position - 0xD7C9
{
	if (bParam0)
	{
		return iParam1;
...
int func_248(int iParam0)//Position - 0xD7E0
{
	return iParam0 & 15;
}

int func_249(int iParam0, int iParam1)//Position - 0xD7ED
{
	int iVar0;
	int iVar1;
...
void func_251(var uParam0, int iParam1)//Position - 0xD93F
{
	if (iParam1 <= 0)
	{
		return;
...
void func_252(var uParam0, int iParam1)//Position - 0xD9C5
{
...
void func_253(var uParam0, int iParam1)//Position - 0xD9F8
{
	int iVar0;
	int iVar1;
...
void func_254(var uParam0, int iParam1)//Position - 0xDA49
{
...
void func_255(var uParam0, int iParam1)//Position - 0xDA83
{
...
void func_256(var uParam0, int iParam1)//Position - 0xDABE
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_257(int iParam0)//Position - 0xDAFA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_258(int iParam0, bool bParam1)//Position - 0xDBD6
{
...
int func_259(int iParam0)//Position - 0xDBF6
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_267()) || Global_112433) || Global_31962) || func_266()) || func_59(8, -1)) || func_265()) || func_264()) || func_263()) || func_262()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_267()) || Global_31962) || func_266()) || func_59(8, -1)) || func_263()) || func_265()) || func_264()) || func_262()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_267()) || Global_112433) || Global_31962) || func_266()) || func_59(8, -1)) || func_263()) || func_265()) || func_264()) || func_262()) || Global_113386.f_7688.f_919[iVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_267()) || Global_112433) || Global_31962) || func_266()) || func_59(8, -1)) || func_265()) || func_264()) || func_262()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_267() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_59(8, -1)) || func_262()) || func_261()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_267()) || Global_31962) || func_266()) || func_59(8, -1)) || func_264()) || func_263()) || func_262()) || Global_113386.f_7688.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_267()) || func_264()) || Global_112433) || Global_31962) || func_266()) || Global_44238) || func_59(8, -1)) || func_263()) || func_261()) || func_262()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_267()) || Global_112433) || Global_31962) || func_266()) || func_59(8, -1)) || func_263()) || func_261()) || func_265()) || func_264()) || func_262())
						{
							return 0;
						}
						break;
...
var func_260()//Position - 0xE313
{
	return Global_100480.f_1;
}

int func_261()//Position - 0xE321
{
	if (Global_97363 != -1)
	{
...
bool func_264()//Position - 0xE388
{
	return Global_100493.f_376 > 0;
}

bool func_265()//Position - 0xE399
{
	return Global_100493.f_375 > 0;
}

var func_266()//Position - 0xE3AA
{
	return Global_1575058;
}

int func_267()//Position - 0xE3B6
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_269(int iParam0)//Position - 0xE3FA
{
	return func_249(func_250(), iParam0);
}

int func_270(int iParam0, int iParam1, int iParam2)//Position - 0xE40C
{
	int iVar0;
	int iVar1;
...
int func_271(int iParam0)//Position - 0xE4F0
{
	if (!func_39(iParam0))
	{
		return 7;
...
int func_272(int iParam0)//Position - 0xE514
{
	int iVar0;
	int iVar1;
...
int func_274(bool bParam0)//Position - 0xE5B0
{
...
void func_277(int iParam0)//Position - 0xE76C
{
	char cVar0[64];
	...
	if (func_222())
	{
		...
		func_281(30000);
		StringCopy(&cVar0, func_280(Global_113375, 1), 64);
		if (func_279(Global_113375) > 0)
		{
	...
	func_278(&Global_32019);
	Global_113376 = 0;
	func_233(-1);
}

void func_278(var uParam0)//Position - 0xE81E
{
	if (*uParam0 == -1)
	{
		return;
...
int func_279(int iParam0)//Position - 0xE85B
{
	int iVar0;
...
char* func_280(int iParam0, bool bParam1)//Position - 0xE90C
{
	switch (iParam0)
	{
		case 0:
...
void func_281(int iParam0)//Position - 0xEB55
{
	Global_43603 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_282(int iParam0)//Position - 0xEB67
{
	func_283(iParam0, 0, func_288(iParam0));
}

void func_283(int iParam0, int iParam1, int iParam2)//Position - 0xEB7C
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_284(var uParam0)//Position - 0xEBAB
{
	struct<16> Var0;
	int iVar1;
...
void func_285(int iParam0, var uParam1)//Position - 0xEC7B
{
	Global_113386.f_24995.f_43[iParam0] = *uParam1;
}

void func_286(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xEC93
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_287(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xEE15
{
...
int func_288(int iParam0)//Position - 0xEE4D
{
	int iVar0;
...
void func_289(var uParam0, bool bParam1)//Position - 0xEFF0
{
	int iVar0;
...
void func_290(var uParam0)//Position - 0xF02B
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
...
void func_291(var uParam0)//Position - 0xF044
{
	int iVar0;
...
void func_292(var uParam0)//Position - 0xF07A
{
	func_293(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

void func_293(int iParam0, char* sParam1, int iParam2)//Position - 0xF091
{
	if (BitTest(iParam0, 30))
	{
		switch (func_201(iParam0))
...
void func_294(bool bParam0)//Position - 0xF14B
{
	Global_113378 = { Local_53 };
	if (bParam0)
	{
		func_309(3);
	}
...
void func_295()//Position - 0xF180
{
	func_296();
}

int func_296()//Position - 0xF18D
{
	if (func_274(0))
	{
		return 0;
...
int func_297()//Position - 0xF1D8
{
	return 1;
}

void func_298(int iParam0, int iParam1)//Position - 0xF1E1
{
	if (iParam0 == -1)
	{
		iParam0 = func_223();
...
void func_299(int iParam0, var uParam1, var uParam2)//Position - 0xF2E5
{
	bool bVar0;
...
void func_300()//Position - 0xF3CB
{
	...
	{
		func_33(13, SYSTEM::FLOOR(Global_113386.f_10194.f_3853));
	}
...
int func_301()//Position - 0xF889
{
	return Global_31959;
}

int func_302(int iParam0, int iParam1)//Position - 0xF894
{
	switch (iParam0)
	{
		case 0:
...
void func_303(int iParam0)//Position - 0xFC08
{
	int iVar0;
	int iVar1;
...
void func_304(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0xFC4A
{
	func_305(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_305(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0xFC6B
{
	int iVar0;
...
int func_307(int iParam0)//Position - 0xFF55
{
	int iVar0;
	int iVar1;
...
void func_308(int iParam0, int iParam1)//Position - 0xFF95
{
	MISC::SET_BIT(&(Global_113386.f_24995.f_8[iParam0]), iParam1);
}

void func_309(int iParam0)//Position - 0xFFB0
{
