...
void __EntryFunction__()//Position - 0x0
{
	...
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_88(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
	...
	while (true)
	{
		...
		{
			fVar1 = 0f;
			if (MISC::GET_GROUND_Z_FOR_3D_COORD(ScriptParam_88.f_1[0 /*3*/], &fVar1, false, false))
			{
				if (fVar1 != 0f)
				{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_53) && !ENTITY::IS_ENTITY_DEAD(iLocal_53, false))
		{
			...
			fLocal_57 = SYSTEM::VDIST2(Local_55, ScriptParam_88.f_1[0 /*3*/]);
			fLocal_57 = fLocal_57;
			Local_75 = { Local_55 };
			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_74(3) && !Global_100475)
						{
							...
							{
								if ((!func_88(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_73())) && !Global_100475)
								{
									func_81(10);
									break;
								}
						...
						if (bVar3)
						{
							...
							if (bVar3)
							{
								...
								if (func_47(uLocal_54))
								{
									...
									else if (!func_88(uLocal_58, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_45(&iLocal_60);
				...
				case 6:
					...
					{
						STATS::PLAYSTATS_ODDJOB_DONE(SYSTEM::ROUND((func_13(&iLocal_71) * 1000f)), iLocal_63, false);
						func_12(&iLocal_71);
...
void func_12(int* iParam0)//Position - 0xC0F
{
	iParam0->f_1 = 0f;
	iParam0->f_2 = 0f;
	*iParam0 = 0;
...
float func_13(int* iParam0)//Position - 0xC25
{
	if (func_16(iParam0))
	{
		if (func_15(iParam0))
...
bool func_15(var uParam0)//Position - 0xCB9
{
	return BitTest(*uParam0, 2);
}

bool func_16(var uParam0)//Position - 0xCC6
{
...
int func_20(bool bParam0)//Position - 0xD25
{
...
void func_23(int* iParam0)//Position - 0xEE2
{
	if (!func_16(iParam0))
	{
		func_26(iParam0);
...
void func_24(int* iParam0)//Position - 0xF03
{
	func_25(iParam0, 0f);
}

void func_25(int* iParam0, float fParam1)//Position - 0xF12
{
...
void func_26(int* iParam0)//Position - 0xF3D
{
	if (!func_16(iParam0))
	{
		func_24(iParam0);
...
void func_29(int iParam0)//Position - 0xFA4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_31(int iParam0)//Position - 0x1080
{
	int iVar0;
...
int func_35(int iParam0, int iParam1, int iParam2)//Position - 0x1179
{
...
int func_37(int iParam0)//Position - 0x11E0
{
	int iVar0;
...
int func_39(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x12A6
{
	int iVar0;
...
int func_41(int iParam0)//Position - 0x142C
{
	if (Global_43052 == 15)
	{
		return 0;
...
int func_43(int iParam0, bool bParam1)//Position - 0x1481
{
	int iVar0;
...
void func_45(int iParam0)//Position - 0x1574
{
	int iVar0;
...
void func_46(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x15CB
{
	int iVar0;
...
int func_47(var uParam0)//Position - 0x16F6
{
	return 1;
}

var func_48()//Position - 0x16FF
{
	return Global_75485;
}

int func_49(int iParam0)//Position - 0x170B
{
	if (iParam0 == 1)
	{
...
var func_50(int iParam0, int iParam1)//Position - 0x1762
{
	switch (iParam0)
	{
		case 5:
...
void func_55(var uParam0, var uParam1)//Position - 0x1802
{
	*uParam0 = (*uParam0 || uParam1);
}

int func_56()//Position - 0x1813
{
	return 1;
}
...
int func_58(int iParam0)//Position - 0x1926
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_65()) || Global_112433) || Global_31962) || func_64()) || func_50(8, -1)) || func_63()) || func_62()) || func_61()) || func_52()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_65()) || Global_31962) || func_64()) || func_50(8, -1)) || func_61()) || func_63()) || func_62()) || func_52()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_65()) || Global_112433) || Global_31962) || func_64()) || func_50(8, -1)) || func_61()) || func_63()) || func_62()) || func_52()) || Global_113386.f_7688.f_919[iVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_65()) || Global_112433) || Global_31962) || func_64()) || func_50(8, -1)) || func_63()) || func_62()) || func_52()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_65() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_50(8, -1)) || func_52()) || func_60()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_65()) || Global_31962) || func_64()) || func_50(8, -1)) || func_62()) || func_61()) || func_52()) || Global_113386.f_7688.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_65()) || func_62()) || Global_112433) || Global_31962) || func_64()) || Global_44238) || func_50(8, -1)) || func_61()) || func_60()) || func_52()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_65()) || Global_112433) || Global_31962) || func_64()) || func_50(8, -1)) || func_61()) || func_60()) || func_63()) || func_62()) || func_52())
						{
							return 0;
						}
						break;
...
var func_59()//Position - 0x2043
{
	return Global_100480.f_1;
}

int func_60()//Position - 0x2051
{
	if (Global_97363 != -1)
	{
...
var func_64()//Position - 0x20C0
{
	return Global_1575058;
}

int func_65()//Position - 0x20CC
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_66(int iParam0)//Position - 0x20E8
{
	return iParam0 < 3;
}

var func_67()//Position - 0x20F4
{
	func_68();
...
int func_69(int iParam0)//Position - 0x220A
{
	int iVar0;
	int iVar1;
...
int func_70(int iParam0)//Position - 0x2247
{
	if (func_66(iParam0))
	{
...
var func_71(int iParam0)//Position - 0x226C
{
	return Global_1998[iParam0 /*29*/];
}

int func_72()//Position - 0x227B
{
...
var func_73()//Position - 0x2295
{
	return Global_96273;
}

int func_74(int iParam0)//Position - 0x22A1
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0, int iParam1)//Position - 0x24D3
{
	int iVar0;
...
bool func_86(int iParam0)//Position - 0x251D
{
	return func_87(iParam0, Global_43052);
}

int func_87(int iParam0, int iParam1)//Position - 0x252E
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_88(var uParam0, int iParam1)//Position - 0x270F
{
...
void func_90(var uParam0, int iParam1)//Position - 0x273B
{
	func_91(uParam0, iParam1);
}

void func_91(var uParam0, var uParam1)//Position - 0x274B
{
