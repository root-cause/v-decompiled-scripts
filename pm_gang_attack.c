	...
	switch (iLocal_34)
	{
		case 0:
			...
			if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				...
				while (iVar4 <= 5)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_112842.f_225[iVar4]))
					{
						uLocal_282[iVar4] = Global_112842.f_225[iVar4];
						Global_112842.f_225[iVar4] = 0;
				...
				while (iVar4 <= 1)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_112842.f_222[iVar4]))
					{
						uLocal_279[iVar4] = Global_112842.f_222[iVar4];
						Global_112842.f_222[iVar4] = 0;
...
int func_43(int iParam0)//Position - 0x18CB
{
	...
	if (((((((((((func_44(Global_112842.f_35, 134217728) || PED::CAN_PED_SEE_HATED_PED(uLocal_282[iParam0], PLAYER::PLAYER_PED_ID())) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), uLocal_282[iParam0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uLocal_282[iParam0])) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(uLocal_282[iParam0], true), 15f, true)) || MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(uLocal_282[iParam0], true), 15f, true, true)) || FIRE::IS_EXPLOSION_IN_SPHERE(21 /*EXP_TAG_BZGAS*/, ENTITY::GET_ENTITY_COORDS(uLocal_282[iParam0], true), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(10 /*EXP_TAG_BIKE*/, ENTITY::GET_ENTITY_COORDS(uLocal_282[iParam0], true), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(7 /*EXP_TAG_CAR*/, ENTITY::GET_ENTITY_COORDS(uLocal_282[iParam0], true), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(0 /*EXP_TAG_GRENADE*/, ENTITY::GET_ENTITY_COORDS(uLocal_282[iParam0], true), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(1 /*EXP_TAG_GRENADELAUNCHER*/, ENTITY::GET_ENTITY_COORDS(uLocal_282[iParam0], true), 15f)) || iLocal_278)
	{
		return 1;
	}
	return 0;
