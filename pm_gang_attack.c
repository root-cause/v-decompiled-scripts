	...
	switch (iLocal_34)
	{
		case 0:
			...
			if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				...
				while (iVar4 <= 5)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_112676.f_225[iVar4]))
					{
						uLocal_282[iVar4] = Global_112676.f_225[iVar4];
						Global_112676.f_225[iVar4] = 0;
				...
				while (iVar4 <= 1)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_112676.f_222[iVar4]))
					{
						uLocal_279[iVar4] = Global_112676.f_222[iVar4];
						Global_112676.f_222[iVar4] = 0;
