	...
	switch (iLocal_34)
	{
		case 0:
			...
			if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				...
				while (iVar4 <= 5)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_112519.f_225[iVar4]))
					{
						uLocal_282[iVar4] = Global_112519.f_225[iVar4];
						Global_112519.f_225[iVar4] = 0;
				...
				while (iVar4 <= 1)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_112519.f_222[iVar4]))
					{
						uLocal_279[iVar4] = Global_112519.f_222[iVar4];
						Global_112519.f_222[iVar4] = 0;
...
int func_46(int iParam0, bool bParam1)//Position - 0x23A7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_47()//Position - 0x242C
{
	func_62(1);
	func_61();
}

void func_48(char* sParam0, int iParam1, int iParam2)//Position - 0x243D
{
	iParam2 = iParam2;
...
int func_49(int iParam0, bool bParam1, int iParam2)//Position - 0x2456
{
	int iVar0;
...
int func_50(int iParam0, bool bParam1, bool bParam2)//Position - 0x24A0
{
	int iVar0;
...
float func_51(bool bParam0, float fParam1, float fParam2)//Position - 0x2544
{
	if (bParam0)
	{
		return fParam1;
...
void func_52(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7)//Position - 0x255B
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
char* func_55(int iParam0)//Position - 0x27B9
{
	switch (iParam0)
	{
		case 1:
...
char* func_56(int iParam0)//Position - 0x2804
{
	switch (iParam0)
	{
		case 1:
...
void func_57(var uParam0, int iParam1, int iParam2)//Position - 0x284F
{
	switch (iParam1)
	{
		case 11:
...
int func_58()//Position - 0x2FB6
{
	return func_59(Global_112519.f_20, Global_112519.f_29);
}

int func_59(var uParam0, int iParam1)//Position - 0x2FCE
{
	uParam0 = uParam0;
	switch (iParam1)
	{
...
void func_60(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2FFC
{
...
void func_62(int iParam0)//Position - 0x3166
{
