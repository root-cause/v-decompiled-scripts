...
void func_77(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x2C80
{
	int iVar0;
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2E8D
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						{
							uVar12 = { func_110(iVar10, uVar11[iVar0]) };
						}
						iVar1 = 0;
						while (iVar1 <= 8)
						{
	...
	{
		uVar15 = { func_110(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5E68
{
	...
	else
	{
		...
		iVar4 = (iParam1 - func_103(iParam0, func_90(iParam2)));
		if (iVar4 < 0)
		{
			return -1;
		}
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x65C4
{
	...
	else
	{
		...
		if (iVar4 != -1)
		{
			return (func_103(iParam0, func_90(iParam2)) + iVar4);
		}
	}
	return -99;
}
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.f_0 != 0 && Var2.f_0 != -1) && Var2.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_115(Var2.f_2)] = Var2.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_115(Var2.f_2)] = func_107(iParam1, Var2.f_0, func_115(Var2.f_2), iVar0);
					}
				}
				else if (Var2.f_1 != -1)
				{
					(*uParam0)[func_115(Var2.f_2)] = Var2.f_1;
				}
			}
			iVar4++;
		}
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_195(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar6 = { func_110(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
...
void func_198(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x2135C
{
	func_199(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_199(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x21385
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_203(iVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_203(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x218EC
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_204(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_204(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_204(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_204(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_204(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_204(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_204(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_204(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_204(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_204(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_204(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_204(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_204(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_204(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_204(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_204(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4))
		{
			return 1;
		}
	}
...
int func_204(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x21BE2
{
	float fVar0;
	float fVar1;
	float fVar2;
		...
		else if (MISC::GET_GAME_TIMER() < iLocal_270)
		{
			...
			if (func_222())
			{
				...
				if (bLocal_244)
				{
					...
					else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_68, PLAYER::PLAYER_PED_ID(), true) || func_215(iLocal_68, PLAYER::PLAYER_PED_ID(), 1.25f, 1))
					{
			...
			else
			{
				...
				if (!func_215(PLAYER::PLAYER_PED_ID(), iLocal_67, 200f, 1))
				{
					iLocal_52 = 2;
					iLocal_269 = 5;
				}
...
{
	if (!bLocal_244 && func_221(PLAYER::PLAYER_PED_ID(), Local_56, 150f, 1))
	{
...
int func_216(struct<3> Param0, bool bParam1)//Position - 0x22501
{
	return func_217(Param0, bParam1);
}

int func_217(struct<3> Param0, bool bParam1)//Position - 0x22513
{
	int iVar0;
...
bool func_221(int iParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x225F4
{
...
void func_234()//Position - 0x229FF
{
	switch (iLocal_54)
	{
		...
		case 3:
			...
			{
				if (func_236() && func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT2", 3, 0, 0, 0))
				{
					iLocal_59++;
				}
			}
			...
			{
				if (func_236() && func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT3", 3, 0, 0, 0))
				{
					iLocal_59++;
				}
			}
			...
			{
				if (func_236() && func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT4", 3, 0, 0, 0))
				{
					iLocal_59++;
				}
			}
			...
			{
				if (func_236() && func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT5", 3, 0, 0, 0))
				{
					iLocal_59++;
				}
			}
			...
			{
				if (func_236() && func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT6", 3, 0, 0, 0))
				{
					iLocal_59++;
				}
			}
			...
			{
				if (func_236() && func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT7", 3, 0, 0, 0))
				{
					iLocal_59++;
				}
			}
			...
			{
				if (func_236() && func_9(&uLocal_76, "RECRAAU", "RECRA_CHAT8", 3, 0, 0, 0))
				{
					iLocal_59++;
				}
			}
		...
		case 4:
			if (iLocal_59 == 0)
			{
				if (MISC::GET_GAME_TIMER() > iLocal_58 && !func_340())
				{
					if (func_222())
					{
	...
	switch (iLocal_63)
	{
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_67))
			{
				...
				Local_73 = { func_242() };
				Local_73.f_2 = func_241((fLocal_261 + 180f), 0f, 360f);
				...
				iLocal_266 = GRAPHICS::ADD_DECAL(1110, Local_260, 0f, 0f, -1f, func_205(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, false, false, false);
...
void func_243()//Position - 0x23B97
{
	if (!PED::IS_PED_INJURED(iLocal_67) && !func_261())
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_67, 80f, 80f, 15f, false, true, 0))
		{
			...
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_67, 2.5f, 2.5f, 2.5f, false, true, 1) && func_258(1, 0, 1))
			{
				PED::SET_PED_AS_GROUP_MEMBER(iLocal_67, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID()));
			...
			else if (func_215(PLAYER::PLAYER_PED_ID(), iLocal_67, 15f, 1) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 4f)
			{
				if (func_340())
				{
					func_256();
				...
				if (!HUD::DOES_BLIP_EXIST(iLocal_65))
				{
					iLocal_65 = func_255(iLocal_67, 1, 1, 5);
				}
			}
			else
			{
...
void func_262()//Position - 0x2455F
{
	...
	if (((((((((STREAMING::HAS_MODEL_LOADED(iLocal_246) && STREAMING::HAS_MODEL_LOADED(iLocal_248)) && STREAMING::HAS_MODEL_LOADED(iLocal_247)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_249)) && STREAMING::HAS_CLIP_SET_LOADED(sLocal_250)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_253)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_254)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_255)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_252)) && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		...
		func_214(&uLocal_76, 3, iLocal_67, "TALINA", 0, 1);
		...
		if (func_2() == 0)
		{
			func_214(&uLocal_76, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		}
		else if (func_2() == 1)
		{
			func_214(&uLocal_76, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		}
		else if (func_2() == 2)
		{
...
void func_266(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0x25D51
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_280(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x26751
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (func_5(func_2()))
		{
			if (!func_316(iParam1, bParam2, 145))
			{
				return 0;
			}
		}
		if (!func_315(Global_113648.f_24997.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (func_304(iParam1, bParam2) && !bParam3)
		{
			return 0;
		}
		...
		if ((iParam1 == 9 && (bParam2 == 2 || bParam2 == 5)) && !func_304(0, 0))
		{
			return 0;
		}
		if (Global_32310)
...
bool func_281(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x26AEB
{
	if (bParam2)
	{
