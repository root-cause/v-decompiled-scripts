...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x89F3
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_75(int iParam0)//Position - 0x9896
{
	if (!BitTest(Global_79172[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x98DE
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x9989
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_78(int iParam0, int iParam1)//Position - 0x9A39
{
	int iVar0;
	struct<10> Var1;
...
void func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA368
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xA492
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_81(int iParam0, int iParam1)//Position - 0xA4DA
{
	int iVar0;
	struct<17> Var1;
...
void func_82(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC325
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
int func_83(int iParam0)//Position - 0xC50F
{
	switch (iParam0)
	{
		case 0:
...
void func_84(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xC5BF
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC630
{
	func_149();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_86(int iParam0, int iParam1)//Position - 0xC682
{
	switch (iParam0)
	{
		case 0:
...
void func_87(int iParam0)//Position - 0xC772
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_88(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD9E9
{
	var uVar0;
	int iVar1;
...
bool func_89(int iParam0, int iParam1, var uParam2)//Position - 0xDD8B
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_90(int iParam0, int iParam1)//Position - 0xE190
{
	switch (iParam1)
	{
		case 0:
...
int func_91(int iParam0, int iParam1)//Position - 0xE58B
{
	switch (iParam1)
	{
		case 0:
...
int func_92(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE986
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_93(int iParam0)//Position - 0xE9C4
{
	return Global_44042 == iParam0;
}

int func_94(int iParam0)//Position - 0xE9D2
{
	switch (iParam0)
	{
		case -1:
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEAA6
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_96(int iParam0)//Position - 0xED2D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_97(int iParam0)//Position - 0xEE84
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_98(int iParam0)//Position - 0xF392
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_99(int iParam0)//Position - 0xF407
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(int iParam0)//Position - 0xF47B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_101(int iParam0)//Position - 0xF562
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_102(int iParam0)//Position - 0xF8C5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_103(int iParam0)//Position - 0xFAD6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_104(int iParam0)//Position - 0xFD06
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0xFE16
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
bool func_171()//Position - 0x22217
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_172()//Position - 0x2222D
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_173(int iParam0, int iParam1)//Position - 0x22243
{
	Global_98820 = iParam0;
	Global_98821 = iParam1;
}

void func_174()//Position - 0x22257
{
	if (Global_79644 != 6)
	{
	}
...
void func_175(var uParam0)//Position - 0x2228F
{
	if (*uParam0 == -1)
	{
		return;
...
void func_176(int iParam0, bool bParam1)//Position - 0x222CC
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_177(int iParam0)//Position - 0x2244A
{
	switch (iParam0)
	{
		case 0:
...
void func_178(int iParam0)//Position - 0x227D1
{
	func_180(iParam0, 1);
...
int func_179()//Position - 0x22807
{
	return (Global_113969.f_10019.f_21 + Global_113969.f_18577.f_380);
}

void func_180(var uParam0, bool bParam1)//Position - 0x22823
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_181(int iParam0)//Position - 0x22B47
{
...
void func_182(int iParam0)//Position - 0x22B7A
{
	switch (iParam0)
	{
		case 30:
...
void func_183(int iParam0, bool bParam1)//Position - 0x22BAF
{
	if (iParam0 == -1)
	{
		return;
...
void func_184(int iParam0, int iParam1, bool bParam2)//Position - 0x22C0C
{
	if (iParam0 == -1)
	{
		return;
...
int func_185(int iParam0, int iParam1)//Position - 0x22C47
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_186(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x22C67
{
	if (iParam0 != 198)
	{
		if (Global_79389)
...
void func_187(int iParam0, int iParam1)//Position - 0x22CBF
{
	switch (iParam0)
	{
		case 12:
...
void func_188(int iParam0, bool bParam1)//Position - 0x22DA8
{
	if (bParam1)
	{
...
bool func_189(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x22DD1
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_191()//Position - 0x23766
{
	return Global_32949;
}

int func_192(var uParam0, int iParam1)//Position - 0x23771
{
	int iVar0;
...
int func_193(int iParam0)//Position - 0x26FB0
{
	switch (iParam0)
	{
		case 46:
...
void func_194(int iParam0, bool bParam1)//Position - 0x2709F
{
	switch (iParam0)
	{
		case 46:
...
void func_195(int iParam0, bool bParam1)//Position - 0x270F0
{
	int iVar0;
...
void func_196(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x27156
{
	func_197(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_197(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x27178
{
	int iVar0;
...
void func_198()//Position - 0x2734C
{
	int iVar0;
...
int func_199(int iParam0)//Position - 0x27463
{
	int iVar0;
	int iVar1;
...
void func_200(char* sParam0)//Position - 0x274A3
{
...
char* func_201(int iParam0)//Position - 0x274C8
{
	switch (iParam0)
	{
		case 0:
...
int func_202(int iParam0)//Position - 0x2769B
{
...
void func_203(int iParam0, int iParam1)//Position - 0x276C5
{
...
int func_204(char* sParam0)//Position - 0x27702
{
	int iVar0;
...
int func_205()//Position - 0x27762
{
	return func_206(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_206(char* sParam0, int iParam1)//Position - 0x27773
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_207(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x277BC
{
	struct<14> Var0;
...
void func_208(bool bParam0)//Position - 0x278D4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_209(int iParam0)//Position - 0x27992
{
	switch (iParam0)
	{
		case 0:
...
void func_210(int iParam0, int iParam1, bool bParam2)//Position - 0x279FC
{
	int iVar0;
...
void func_211()//Position - 0x27B7A
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
struct<4> func_212(int iParam0)//Position - 0x27BF7
{
	return Global_2169[iParam0 /*29*/].f_3;
}

int func_213(int iParam0, int iParam1)//Position - 0x27C0A
{
...
int func_214(int iParam0, int iParam1)//Position - 0x27C34
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_215(int iParam0, int iParam1, int iParam2)//Position - 0x27C5E
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_216(int iParam0, int iParam1, int iParam2)//Position - 0x27CA3
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_217()//Position - 0x27CE8
{
	if (func_93(14))
	{
...
int func_218()//Position - 0x27D8A
{
	func_157();
	return Global_113969.f_2366.f_539.f_4321;
}

float func_219(int iParam0, int iParam1, bool bParam2)//Position - 0x27DA3
{
	struct<3> Var0;
	struct<3> Var3;
...
bool func_220(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x27E01
{
...
int func_221(char* sParam0, int iParam1, bool bParam2)//Position - 0x27E4F
{
	Global_22287 = 0;
...
void func_222()//Position - 0x2811F
{
	if (!func_223())
	{
		return;
...
bool func_224(int iParam0)//Position - 0x281B9
{
	return func_225(iParam0, 20);
}

var func_225(int iParam0, int iParam1)//Position - 0x281C9
{
	return BitTest(Global_1887305[iParam0 /*610*/].f_10.f_4, iParam1);
}

int func_226()//Position - 0x281E1
{
	return -1;
}

void func_227()//Position - 0x281EA
{
	int iVar0;
...
void func_228()//Position - 0x2821C
{
...
void func_231()//Position - 0x28371
{
	int iVar0;
...
bool func_232(int iParam0, int iParam1)//Position - 0x283C9
{
	switch (iParam0)
	{
		case 5:
...
void func_233()//Position - 0x28401
{
...
void func_234(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x28458
{
...
void func_235(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x284AE
{
...
void func_236(int iParam0, int iParam1, int iParam2)//Position - 0x28549
{
...
void func_237(int iParam0, bool bParam1)//Position - 0x2857D
{
...
void func_238(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x285B9
{
	int iVar0;
...
void func_239(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x28663
{
	if (bParam0)
	{
...
bool func_240()//Position - 0x287B0
{
	return BitTest(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

bool func_241(int iParam0, int iParam1)//Position - 0x287CA
{
	bool bVar0;
...
int func_242(int iParam0, bool bParam1)//Position - 0x28823
{
	int iVar0;
	int iVar1;
...
int func_243(var uParam0)//Position - 0x28864
{
	int iVar0;
...
int func_244(int iParam0)//Position - 0x28886
{
...
bool func_245()//Position - 0x288C5
{
	return BitTest(Global_2621446, 3);
}

int func_246(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x288D3
{
	int iVar0;
...
void func_247(int iParam0)//Position - 0x28906
{
	if (iParam0 == 1)
	{
...
void func_248(char* sParam0)//Position - 0x28929
{
	sParam0 = sParam0;
}

void func_249()//Position - 0x28935
{
	int iVar0;
	struct<3> Var1;
	float fVar4;
...
int func_250(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x28FBC
{
	bool bVar0;
	float fVar1;
...
void func_251(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x29018
{
	int iVar0;
...
Vector3 func_252(int iParam0)//Position - 0x291D6
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_253(bool bParam0)//Position - 0x291E9
{
	int iVar0;
...
void func_254(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x29228
{
	func_255(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_255(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x29252
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_256(struct<3> Param0)//Position - 0x29648
{
...
int func_257(int iParam0, int iParam1, bool bParam2)//Position - 0x29672
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_258(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x296E0
{
...
int func_259(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x297B9
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_260(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x29AAF
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_261(struct<3> Param0)//Position - 0x29B63
{
	float fVar0;
	float fVar1;
...
void func_262(int iParam0)//Position - 0x29BA2
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_263()//Position - 0x29C07
{
	int iVar0;
...
int func_264(int iParam0)//Position - 0x29C27
{
	if (func_299(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_265(int iParam0, float fParam1, int iParam2)//Position - 0x29C51
{
	int iVar0;
...
bool func_266()//Position - 0x29D25
{
	bool bVar0;
...
void func_267()//Position - 0x29D48
{
	Global_21152 = 0;
	func_233();
}

int func_268()//Position - 0x29D58
{
...
void func_269()//Position - 0x29D7A
{
...
int func_270(int iParam0, int iParam1)//Position - 0x29DCB
{
	if (func_300(iParam0))
	{
...
int func_271(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x29DFE
{
...
void func_272(int iParam0)//Position - 0x29E55
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_273(bool bParam0, bool bParam1)//Position - 0x29E81
{
...
void func_274()//Position - 0x29FD2
{
	func_275();
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
...
void func_275()//Position - 0x2A362
{
	func_277(0);
	func_269();
	func_276();
...
void func_276()//Position - 0x2A377
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_277(int iParam0)//Position - 0x2A3CF
{
	if (func_282())
	{
		return;
...
void func_278(int iParam0)//Position - 0x2A402
{
	if (func_282())
	{
		return;
...
void func_279(bool bParam0, bool bParam1)//Position - 0x2A48C
{
	if (bParam0)
	{
		if (func_281(0))
...
bool func_280()//Position - 0x2A500
{
	return BitTest(Global_1956920, 5);
}

int func_281(int iParam0)//Position - 0x2A50E
{
	if (iParam0 == 1)
	{
		if (Global_20930.f_1 > 3)
...
bool func_282()//Position - 0x2A565
{
	return BitTest(Global_1956920, 19);
}

void func_283(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2A574
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_285(Global_79645, Global_79647, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_284(char* sParam0)//Position - 0x2A859
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_285(int iParam0, int iParam1, int iParam2)//Position - 0x2A86C
{
	struct<2> Var0;
	int iVar2;
...
char* func_286(int iParam0)//Position - 0x2A943
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_287(int iParam0)//Position - 0x2AA96
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_288(int iParam0)//Position - 0x2AACA
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_289(int iParam0)//Position - 0x2AAFE
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_290(int iParam0)//Position - 0x2AB32
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_291(int iParam0)//Position - 0x2AB66
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_292(int iParam0)//Position - 0x2ABA4
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_293(int iParam0)//Position - 0x2ABD8
{
	struct<2> Var0;
...
int func_294(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2AC41
{
	if (((!func_296(0) || Global_79660) || Global_79648 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_79644)
...
bool func_295(bool bParam0)//Position - 0x2AD59
{
	if (bParam0)
	{
...
int func_296(int iParam0)//Position - 0x2AD82
{
	if (Global_44042 == 15)
	{
		return 0;
...
bool func_297(int iParam0)//Position - 0x2ADA4
{
	return func_298(iParam0, Global_44042);
}

int func_298(int iParam0, int iParam1)//Position - 0x2ADB5
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_299(int iParam0)//Position - 0x2AF96
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_300(int iParam0)//Position - 0x2AFB7
{
	if (func_299(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_301(var uParam0, bool bParam1, bool bParam2)//Position - 0x2AFD7
{
	int iVar0;
...
int func_302(var uParam0)//Position - 0x2B0CC
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
...
int func_303(bool bParam0, bool bParam1)//Position - 0x2B239
{
	int iVar0;
...
void func_304(int* iParam0, bool bParam1)//Position - 0x2B2A7
{
	struct<3> Var0;
	float fVar3;
...
void func_305(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x2B31B
{
	func_306(iParam0);
...
void func_306(int* iParam0)//Position - 0x2B35E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_307(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x2B3FA
{
...
int func_308(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2B456
{
	int iVar0;
...
int func_309(var uParam0, int iParam1)//Position - 0x2B4E4
{
	int iVar0;
...
int func_310(var uParam0)//Position - 0x2B52A
{
	if (func_311(uParam0))
	{
...
int func_311(var uParam0)//Position - 0x2B554
{
...
int func_312(int iParam0)//Position - 0x2B579
{
	int iVar0;
...
void func_313(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2B5AA
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
void func_315()//Position - 0x2B60A
{
	func_263();
	if (func_328())
	{
...
void func_316(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2B694
{
...
void func_317(var uParam0, bool bParam1)//Position - 0x2B6B4
{
	func_318(&(uParam0->f_41), bParam1);
}

void func_318(var uParam0, bool bParam1)//Position - 0x2B6C6
{
	int iVar0;
...
void func_319(int* iParam0, bool bParam1)//Position - 0x2B704
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_320(int* iParam0)//Position - 0x2B73F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_321(var uParam0, bool bParam1)//Position - 0x2B76A
{
	func_322(&(uParam0->f_35), bParam1);
}

void func_322(var uParam0, bool bParam1)//Position - 0x2B77C
{
	int iVar0;
...
void func_323(int* iParam0)//Position - 0x2B7B9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_324(var uParam0, int iParam1)//Position - 0x2B7F1
{
	func_325(&(uParam0->f_28), iParam1);
}

void func_325(var uParam0, int iParam1)//Position - 0x2B803
{
	int iVar0;
...
void func_326(int* iParam0)//Position - 0x2B844
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_327(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2B885
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_329(bool bParam0)//Position - 0x2B976
{
	int iVar0;
...
void func_330(char* sParam0, int iParam1)//Position - 0x2BA46
{
	if (Global_101533 != 12)
	{
...
int func_331(char* sParam0, int iParam1, int iParam2)//Position - 0x2BA6E
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_332(char* sParam0)//Position - 0x2BBFD
{
...
int func_334(char* sParam0, bool bParam1)//Position - 0x2BC77
{
	int iVar0;
	int iVar1;
...
int func_335(int iParam0, bool bParam1)//Position - 0x2BCA1
{
	int iVar0;
...
void func_338(bool bParam0)//Position - 0x2BD93
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_339(int iParam0)//Position - 0x2BDA7
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_340(int iParam0)//Position - 0x2BDE1
{
	if (iParam0 == 1)
	{
...
void func_341()//Position - 0x2BE1B
{
	Global_23692.f_5 = 1;
}

void func_342()//Position - 0x2BE29
{
	Global_23692.f_5 = 0;
}

void func_343(bool bParam0)//Position - 0x2BE37
{
	if (bParam0)
	{
		func_344();
...
void func_344()//Position - 0x2BE9A
{
...
void func_345()//Position - 0x2BEC3
{
	Global_95689 = 0;
	Global_95690 = 0;
}

int func_346()//Position - 0x2BED5
{
...
void func_347()//Position - 0x2BF13
{
	Global_101568 = 1;
...
void func_348(char* sParam0)//Position - 0x2C003
{
...
void func_349(var uParam0)//Position - 0x2C015
{
...
void func_350(var uParam0)//Position - 0x2C035
{
	int iVar0;
...
int func_351(int iParam0)//Position - 0x2C06F
{
	if (!func_154(iParam0))
	{
		return func_153(iParam0);
