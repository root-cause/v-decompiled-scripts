...
float func_160(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x9C13
{
	struct<3> Var0;
...
int func_191(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xC18D
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
