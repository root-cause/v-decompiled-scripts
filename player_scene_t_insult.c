		...
		switch (iLocal_239[iParam1])
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, &Local_344, &(Local_393[iParam1 /*16*/]), 2))
				{
					...
					{
						fVar2 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_98993);
						if (fVar2 > fVar0)
						{
					...
					else
					{
						...
						if (iLocal_255[0] == joaat("p_trev_rope_01_s") || iLocal_255[1] == joaat("p_trev_rope_01_s"))
						{
							...
							while (iVar11 < iLocal_252)
							{
								...
								OBJECT::SET_OBJECT_TARGETTABLE(iLocal_252[iVar11], false, 0);
								iVar11++;
							}
						}
						if (!func_31(iVar9, 16))
...
void func_27(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x15E5
{
...
int func_28(int iParam0)//Position - 0x1680
{
	int iVar0;
...
int func_29(int iParam0)//Position - 0x171C
{
	int iVar0;
	float fVar1;
...
void func_30(int iParam0, int iParam1)//Position - 0x17C7
{
...
bool func_32(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x17E7
{
	if (bParam6)
	{
...
void func_33(int iParam0, char* sParam1, char* sParam2, int iParam3, bool bParam4)//Position - 0x182E
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_34(iParam3), bParam4);
}

int func_34(int iParam0)//Position - 0x1848
{
	int iVar0;
...
int func_35(char* sParam0, char* sParam1, char* sParam2, float fParam3, float fParam4)//Position - 0x1A37
{
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98993))
		{
			...
			while (iVar0 < iLocal_236)
			{
				if (!PED::IS_PED_INJURED(iLocal_236[iVar0]))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_236[iVar0], Global_98993, &Local_344, &(Local_393[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
					iLocal_239[iVar0] = 0;
				}
				iVar0++;
			}
			...
			while (iVar0 < iLocal_252)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_252[iVar0]))
				{
					...
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_252[iVar0], Global_98993, &(Local_558[iVar0 /*16*/]), &Local_344, 8f, -1000f, 0, 1000f);
					}
				}
				iVar0++;
			}
...
int func_38()//Position - 0x1C65
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98992))
	{
		...
		while (iVar0 < iLocal_236)
		{
			if (!PED::IS_PED_INJURED(iLocal_236[iVar0]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_236[iVar0], Global_98992, &Local_344, &(Local_360[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_252)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_252[iVar0]))
			{
				...
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_252[iVar0], Global_98992, &(Local_525[iVar0 /*16*/]), &Local_344, 8f, -1000f, 0, 1000f);
				}
			}
			iVar0++;
		}
...
bool func_41(var uParam0, var uParam1)//Position - 0x1E4F
{
...
int func_53(int iParam0, var uParam1, char* sParam2)//Position - 0x4424
{
	struct<3> Var0;
	int iVar3;
	var uVar4;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114135.f_2367.f_539.f_2310[0];
			StringCopy(sParam2, func_57(Global_114135.f_2367.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_114135.f_2367.f_539.f_2310[1];
			StringCopy(sParam2, func_57(Global_114135.f_2367.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_114135.f_2367.f_539.f_2310[2];
			StringCopy(sParam2, func_57(Global_114135.f_2367.f_539.f_2314[2]), 32);
			return 1;
			break;
...
int func_54(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x6830
{
	switch (iParam1)
	{
		case 0:
...
int func_56(int iParam0, var uParam1, var uParam2)//Position - 0x879E
{
	switch (iParam0)
	{
		case 11:
