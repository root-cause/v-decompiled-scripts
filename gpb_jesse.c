...
bool func_19(int iParam0)//Position - 0x173B
{
	return iParam0 < 3;
}

int func_20(int iParam0)//Position - 0x1747
{
	int iVar0;
	int iVar1;
...
int func_21(int iParam0)//Position - 0x1784
{
	if (func_19(iParam0))
	{
...
var func_22(int iParam0)//Position - 0x17A9
{
...
bool func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B26
{
...
var func_38(int iParam0, int iParam1)//Position - 0x1EEC
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_39()//Position - 0x1F04
{
	return -1;
}
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21C2
{
...
void func_48(char[4] cParam0)//Position - 0x2218
{
	int iVar0;
...
void func_49(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2253
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_51(var uParam0)//Position - 0x2326
{
}

void func_52(var uParam0, int iParam1, float fParam2)//Position - 0x232E
{
}
...
void func_55(var uParam0)//Position - 0x23BB
{
}

void func_56(char* sParam0)//Position - 0x23C3
{
...
void func_70(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x26F5
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x29DE
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0)//Position - 0x2B24
{
	if (func_77(iParam0))
	{
...
int func_76(int iParam0)//Position - 0x2B48
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x2B78
{
...
void func_79(int* iParam0)//Position - 0x2C60
{
	if (iLocal_445 == 1)
	{
...
void func_80(int* iParam0, int iParam1, bool bParam2)//Position - 0x2C7F
{
	if (iLocal_445 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_81(int iParam0, bool bParam1, int iParam2)//Position - 0x2CD2
{
	int iVar0;
...
int func_82(int iParam0, bool bParam1, bool bParam2)//Position - 0x2D1C
{
	int iVar0;
...
float func_83(bool bParam0, float fParam1, float fParam2)//Position - 0x2DC0
{
	if (bParam0)
	{
		return fParam1;
...
float func_84(int iParam0, int iParam1, bool bParam2)//Position - 0x2DD7
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_85(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2E35
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_86(struct<3> Param0, struct<3> Param3)//Position - 0x2EC6
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_87(struct<3> Param0)//Position - 0x2EE7
{
	float fVar0;
	float fVar1;
...
int func_88(int iParam0)//Position - 0x2F26
{
	var uVar0;
...
int func_95()//Position - 0x2FBC
{
	return 1;
}

float func_96(int iParam0, int iParam1)//Position - 0x2FC5
{
...
void func_100(var uParam0, var uParam1)//Position - 0x30EB
{
...
int func_102(int iParam0)//Position - 0x316E
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_105()//Position - 0x31A3
{
	...
	StringCopy(&Local_232, "PBJS", 8);
	StringCopy(&Local_234, "JESSE", 16);
	StringCopy(&Local_200, "Special_Ped@jessie", 64);
	StringCopy(&Local_216, "Base", 64);
	bLocal_434 = true;
	iLocal_250 = 15;
	sLocal_301 = "PBJS_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to Jesse. */;
	StringCopy(&Local_310, "PBJS_CONV_GM", 16);
	StringCopy(&Local_314, "PBJS_CONV_GT", 16);
	StringCopy(&Local_318, "PBJS_CONV_GF", 16);
	StringCopy(&cLocal_322, "special_ped@jessie@base", 64);
	StringCopy(&cLocal_338, "special_ped@jessie@intro", 64);
	iLocal_249 = 7;
	iLocal_253[0] = 8;
	iLocal_253[1] = 6;
	iLocal_253[2] = 6;
...
int func_109()//Position - 0x32C9
{
	return 1;
}

bool func_110(var uParam0)//Position - 0x32D2
{
	return func_111(Global_114135.f_20121, uParam0);
}

bool func_111(var uParam0, var uParam1)//Position - 0x32E7
{
	return (uParam0 && uParam1) != 0;
}

int func_112(char* sParam0)//Position - 0x32F6
{
...
void func_114(int* iParam0)//Position - 0x34EC
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
