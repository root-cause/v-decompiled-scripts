...
int func_30(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xDD5
{
	...
	else
	{
		...
		iVar20 = 0;
		func_36(&iVar20);
		iVar21 = func_35(Var10, Global_114372.f_7691.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_33(Global_114372.f_7691.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_31(Global_114372.f_7691.f_765[iVar20 /*10*/]))
				{
					Global_114372.f_7691.f_765[iVar20 /*10*/] = { Var10 };
					func_32(&Var10);
					return 1;
...
void func_36(int iParam0)//Position - 0x10A9
{
	...
	*iParam0 = 0;
	...
	{
		if (func_35(Global_114372.f_7691.f_765[iVar0 /*10*/], Global_114372.f_7691.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
void func_41()//Position - 0x13AC
{
	...
	{
		func_43(13, SYSTEM::FLOOR(Global_114372.f_10197.f_3853));
	}
...
int func_123(int iParam0)//Position - 0x4843
{
	if (iParam0 != func_8())
	{
		...
		else if ((Global_1575079 && iParam0 == PLAYER::PLAYER_ID()) && func_124(iParam0, 1, 0))
		{
			return Global_2657921[iParam0 /*463*/].f_321.f_7 != -1;
		}
	}
...
int func_144(int iParam0)//Position - 0x529F
{
	if (func_147())
	{
		...
		if (func_47(Global_114361))
		{
			func_145(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /* GXT: Random Event */);
		if (iParam0 && func_47(Global_114361))
		{
...
{
	switch (func_148(&Global_32888, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_218()) || Global_32831) || func_217()) || func_22(8, -1)) || func_214()) || func_216()) || func_215()) || func_213()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_218()) || Global_113419) || Global_32831) || func_217()) || func_22(8, -1)) || func_216()) || func_215()) || func_213()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_218() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_22(8, -1)) || func_213()) || func_212()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_218()) || Global_32831) || func_217()) || func_22(8, -1)) || func_215()) || func_214()) || func_213()) || Global_114372.f_7691.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_218()) || func_215()) || Global_113419) || Global_32831) || func_217()) || Global_45122) || func_22(8, -1)) || func_214()) || func_212()) || func_213()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_230(int iParam0)//Position - 0x98CE
{
	...
	if (func_241())
	{
		...
		func_233(30000);
		StringCopy(&cVar0, func_232(Global_114361, 1), 64);
		if (func_55(Global_114361) > 0)
		{
...
{
	if ((Global_114361 == func_56() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_114362)
	{
		return 1;
	}
	return 0;
