		...
		case 0:
			...
			if (iLocal_144 == 1)
			{
				...
				if (func_17(iLocal_158))
				{
					...
					{
						if (func_14(iLocal_158, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 35f, 1))
						{
...
int func_2(int iParam0, int iParam1)//Position - 0x2DE
{
	if (func_17(iParam0))
	{
...
void func_4(int* iParam0)//Position - 0x34F
{
...
void func_5(int* iParam0, bool bParam1)//Position - 0x37A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_6(int* iParam0)//Position - 0x3B5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_8(char* sParam0, bool bParam1)//Position - 0x423
{
	func_9(sParam0);
	func_485(bParam1);
}

void func_9(char* sParam0)//Position - 0x437
{
...
int func_11(int iParam0)//Position - 0x5A7
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_12(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x5C8
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_13(iParam3), false);
}

int func_13(int iParam0)//Position - 0x5E1
{
	int iVar0;
...
bool func_14(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x7D6
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

void func_15(int iParam0, bool bParam1)//Position - 0x7F4
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_16(var uParam0, int iParam1)//Position - 0x865
{
...
int func_17(int iParam0)//Position - 0x882
{
	if (func_11(iParam0))
	{
...
void func_18()//Position - 0x8A2
{
	Global_20591 = 0;
	func_19();
}

void func_19()//Position - 0x8B2
{
...
void func_22()//Position - 0x95F
{
	Global_20591 = 0;
	func_23();
}

void func_23()//Position - 0x96F
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_24()//Position - 0x990
{
	Global_20591 = 0;
	func_25();
}

void func_25()//Position - 0x9A0
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
struct<6> func_26()//Position - 0x9C4
{
	struct<6> Var0;
		...
		case 1:
			...
			if (func_17(iLocal_158))
			{
				...
				if (!func_246(0))
				{
					...
					{
						func_242(Var0, Var3, 18000, 1101004800);
					}
				}
				else
				{
...
{
	func_238("BBONDS_UNLOCK" /* GXT: Bail bond missions are now available. Trevor will receive emails from Maude with further details. */, 1, 0, -1, 10000, 4, 0, 0, 1);
	func_229(62, 2, 1);
	func_29(107, 1);
	func_471();
}
...
void func_29(int iParam0, bool bParam1)//Position - 0xBD5
{
	...
	{
		func_200(&(Global_112735[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
	...
	func_185(0, 0);
	MemCopy(&sVar1, {func_183(iVar0)}, 4);
	func_180(&sVar1, func_181());
	func_57();
...
int func_31(bool bParam0)//Position - 0xD54
{
...
void func_32(int iParam0, int iParam1, int iParam2)//Position - 0xD7C
{
	bool bVar0;
...
void func_33()//Position - 0xE62
{
	...
	{
		func_35(13, SYSTEM::FLOOR(Global_113648.f_10196.f_3853));
	}
...
int func_34()//Position - 0x1320
{
	return Global_32163;
}

int func_35(int iParam0, int iParam1)//Position - 0x132B
{
	int iVar0;
...
void func_36(int iParam0, bool bParam1, int iParam2)//Position - 0x137C
{
	if (iParam2 == -1)
	{
		iParam2 = func_37();
...
int func_37()//Position - 0x139A
{
	return Global_1574918;
}

void func_38()//Position - 0x13A6
{
	func_55();
	func_47();
	func_43();
...
void func_39(int iParam0)//Position - 0x13FF
{
	if (iParam0 == 1)
	{
...
void func_41()//Position - 0x1446
{
	StringCopy(&Global_78791, "", 16);
	StringCopy(&Global_78795, "", 16);
}

void func_42()//Position - 0x1460
{
	int iVar0;
...
void func_46(int iParam0)//Position - 0x1532
{
	if (iParam0 == 1)
	{
		Global_43806 = 1;
...
void func_47()//Position - 0x154B
{
	func_48(&Global_107196);
}

void func_48(var uParam0)//Position - 0x155B
{
	int iVar0;
	int iVar1;
...
void func_49(var uParam0)//Position - 0x1AEB
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_50(var uParam0)//Position - 0x1B06
{
...
void func_51(var uParam0)//Position - 0x1B35
{
	int iVar0;
...
void func_52(var uParam0)//Position - 0x1BE5
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_53(var uParam0)//Position - 0x1C03
{
	int iVar0;
...
void func_54(var uParam0)//Position - 0x1CE3
{
	*uParam0 = -15;
}

void func_55()//Position - 0x1CF1
{
	StringCopy(&Global_104204, "", 32);
	func_48(&Global_104212);
}

void func_56()//Position - 0x1D0A
{
...
int func_58(int iParam0, int iParam1, int iParam2)//Position - 0x1E48
{
	...
	Global_78341[1 /*14*/] = { func_110(iVar0, iParam1, iParam2, -1) };
	...
	{
		uVar31 = { func_106(iVar0, 0) };
		Global_78341[1 /*14*/] = { func_110(iVar0, iParam1, uVar31[iParam1], -1) };
...
int func_59(int iParam0, int iParam1, int iParam2)//Position - 0x2005
{
	int iVar0;
	...
	{
		if (!func_175(iParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_64, Global_113648.f_2365.f_539[iVar0 /*65*/].f_63))
		{
...
int func_60(int iParam0)//Position - 0x2091
{
	switch (iParam0)
	{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x20CC
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_78341[1 /*14*/] = { func_110(iVar10, iParam1, iParam2, -1) };
		if (!func_100(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78341[1 /*14*/] = { func_110(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_110(iVar10, 14, uVar28[iVar1], -1) };
							func_77(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
							func_93(14);
							if (Global_78339 == 1)
							{
								iVar2 = 0;
			...
			{
				Global_78341[1 /*14*/] = { func_110(iVar10, iVar0, func_67(iParam0, iVar0, -1), -1) };
		...
		if (iParam7 == 1)
		{
			Var55 = { func_110(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var55 = { func_110(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var55 = { func_110(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var55 = { func_110(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var55 = { func_110(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_110(iVar10, 14, uVar69[iVar1], -1) };
			func_77(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_93(14);
			if (Global_78339 == 1)
			{
...
void func_62(int iParam0, int iParam1, int iParam2)//Position - 0x28DD
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0, int iParam1, int iParam2)//Position - 0x2967
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_64(int iParam0, int iParam1, int iParam2)//Position - 0x2A45
{
	Global_78341[1 /*14*/] = { func_110(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78341[1 /*14*/].f_6, 2);
}

int func_65(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x2A6D
{
	var uVar0;
	int iVar10;
...
int func_66(int iParam0, int iParam1, int iParam2)//Position - 0x3071
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_67(int iParam0, int iParam1, int iParam2)//Position - 0x310A
{
	int iVar0;
	int iVar1;
...
int func_68(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x31AB
{
	int iVar0;
...
int func_69(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x34B2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x4066
{
	int iVar0;
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x434A
{
	int iVar0;
...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4611
{
	int iVar0;
	int iVar1;
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4648
{
	int iVar0;
...
int func_74(int iParam0, int iParam1, int iParam2)//Position - 0x4671
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x493B
{
	int iVar0;
...
int func_76(int iParam0, int iParam1, int iParam2)//Position - 0x4BC5
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_77(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4D1C
{
	int iVar0;
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4DB6
{
	switch (iParam0)
	{
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4E84
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar36 = (iParam1 - func_80(iParam0, func_102(iParam2)));
		if (iVar36 < 0)
		{
			return -1;
		}
...
int func_80(int iParam0, int iParam1)//Position - 0x4F9E
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_81(int iParam0)//Position - 0x5345
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x53A6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_83(int iParam0, int iParam1)//Position - 0x54A2
{
	int iVar0;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x55E0
{
	struct<2> Var0;
	int iVar15;
	int iVar16;
	...
	else
	{
		...
		if (iVar18 != -1)
		{
			return (func_80(iParam0, func_102(iParam2)) + iVar18);
		}
	}
	return -99;
}

int func_85(int iParam0)//Position - 0x569B
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_86(int iParam0)//Position - 0x56FA
{
	switch (iParam0)
	{
		case 0:
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5780
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x59FD
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5E22
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_90(int iParam0, int iParam1)//Position - 0x6115
{
	int iVar0;
	int iVar1;
...
int func_91(int iParam0, int iParam1)//Position - 0x615C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x61BC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_93(int iParam0)//Position - 0x6213
{
	if (BitTest(Global_78341[1 /*14*/].f_6, 1) && !BitTest(Global_78341[1 /*14*/].f_6, 6))
	{
		func_99(iParam0, Global_78341[1 /*14*/].f_5, Global_78341[1 /*14*/].f_2, 2, Global_78341[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_78341[1 /*14*/].f_6, 1) && BitTest(Global_78341[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_94(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x62BF
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_98(iParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
		...
		func_95(iVar2, iVar3, iVar0, 1, 0);
	}
}

void func_95(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x6309
{
	int iVar0;
	...
	iVar0 = Global_2805027[iParam0 /*3*/][func_96(iParam2)];
	if (iVar0 != 0)
	{
...
int func_96(var uParam0)//Position - 0x6339
{
	int iVar0;
	int iVar1;
...
int func_97(int iParam0, int iParam1, int iParam2)//Position - 0x636D
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 14192)
	{
		...
		iVar0 = Global_2805027[iParam0 /*3*/][func_96(iParam1)];
...
bool func_98(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x63AA
{
	int iVar0;
...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8BBB
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_100(int iParam0)//Position - 0x9A5E
{
	if (!BitTest(Global_78341[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9AA6
{
	int iVar0;
	...
	{
		if (!func_175(iParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_61, Global_113648.f_2365.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_102(int iParam0)//Position - 0x9B51
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_103(int iParam0, int iParam1)//Position - 0x9C01
{
	int iVar0;
	struct<10> Var1;
...
void func_104(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA530
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xA65A
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_106(int iParam0, int iParam1)//Position - 0xA6A2
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_109(&Var1, -99, -99, Global_113648.f_2365.f_539.f_196[0], Global_113648.f_2365.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_109(&Var1, -99, -99, Global_113648.f_2365.f_539.f_196[1], Global_113648.f_2365.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_109(&Var1, -99, -99, Global_113648.f_2365.f_539.f_196[2], Global_113648.f_2365.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_107(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC4EC
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_108(Var16.f_2)] = func_84(iParam1, Var16.f_0, func_108(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
int func_108(int iParam0)//Position - 0xC6D6
{
	switch (iParam0)
	{
		case 0:
...
void func_109(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xC786
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_110(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC7F7
{
	func_174();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_111(int iParam0, int iParam1)//Position - 0xC849
{
	switch (iParam0)
	{
		case 0:
...
void func_112(int iParam0)//Position - 0xC939
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_120(iVar10, iParam0, 155, -1);
			return;
			break;
	}
	func_113(&(Global_78341[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_113(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xDBB0
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_97(func_116(iParam1, uParam0->f_2), Global_78338, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_97(func_115(iParam1, uParam0->f_2), Global_78338, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_97(iVar1, Global_78338, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_114(int iParam0, int iParam1, var uParam2)//Position - 0xDF55
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_115(int iParam0, int iParam1)//Position - 0xE35A
{
	switch (iParam1)
	{
		case 0:
...
int func_116(int iParam0, int iParam1)//Position - 0xE755
{
	switch (iParam1)
	{
		case 0:
...
int func_117(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xEB50
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_118(int iParam0)//Position - 0xEB8F
{
	return Global_43257 == iParam0;
}

int func_119(int iParam0)//Position - 0xEB9D
{
	switch (iParam0)
	{
		case -1:
...
void func_120(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEC71
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_113(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_113(&(Global_78341[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_113(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_113(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_121(int iParam0)//Position - 0xEEF8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0xF04F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0xF55D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0xF5D2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0xF646
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0xF72D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0xFA90
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0xFCA1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0xFED1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0xFFE1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x10982
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x114F5
{
	if (iParam0 < 136)
	{
		func_134(iParam0);
...
void func_133(int iParam0)//Position - 0x1152A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x1212E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x1303C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x13169
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0, int iParam1)//Position - 0x13267
{
	switch (iParam0)
	{
		case 0:
...
void func_138(int iParam0)//Position - 0x13357
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x1484A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x1499B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x14EA6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x15514
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x15588
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x15658
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x15B88
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x15D1F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x1651D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x1662D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x17558
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x18217
{
	if (iParam0 < 107)
	{
		func_153(iParam0);
...
void func_151(int iParam0)//Position - 0x1825D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x18D02
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x19AF1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1A73A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1A9B3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0, int iParam1)//Position - 0x1AAF9
{
	switch (iParam0)
	{
		case 0:
...
void func_157(int iParam0)//Position - 0x1ABE9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x1B973
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1BAED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1C065
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1C58F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x1C603
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x1C6D3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1CBAB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1CE14
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1D0EA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x1D2B3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x1DE07
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x1EA51
{
	if (iParam0 < 60)
	{
		func_171(iParam0);
...
void func_170(int iParam0)//Position - 0x1EA86
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x1F826
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x1FEB2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x1FF99
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174()//Position - 0x20097
{
...
int func_175(int iParam0, int iParam1, int iParam2)//Position - 0x20110
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_175(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_175(iParam0, 14, uVar22[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
									Global_78341[2 /*14*/] = { func_110(iVar0, 14, iVar4, -1) };
									if (Global_78341[2 /*14*/].f_12 == iVar3)
									{
										if (func_175(iParam0, 14, iVar4))
										{
											if (!func_65(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_78341[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_78341[2 /*14*/] = { func_110(iVar0, iVar2, iVar1, -1) };
						if (!func_65(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_78341[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar32 <= 8)
		{
			if (!func_175(iParam0, 14, uVar33[iVar32]))
			{
				return 0;
			}
			iVar32++;
	...
	else if (Global_78341[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_102(iParam1)) && Global_78341[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_102(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_176(int iParam0)//Position - 0x20369
{
	int iVar0;
	int iVar1;
...
int func_177(int iParam0)//Position - 0x203A6
{
	if (func_179(iParam0))
	{
...
var func_178(int iParam0)//Position - 0x203CB
{
	return Global_2028[iParam0 /*29*/];
}

bool func_179(int iParam0)//Position - 0x203DA
{
	return iParam0 < 3;
}

void func_180(char* sParam0, var uParam1)//Position - 0x203E6
{
...
void func_182()//Position - 0x2047D
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_177(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_176(PLAYER::PLAYER_PED_ID());
			if (func_179(iVar0) && (!func_118(14) || Global_112599))
			{
...
struct<2> func_183(int iParam0)//Position - 0x2057A
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_184(int iParam0)//Position - 0x205B1
{
	struct<2> Var0;
...
void func_185(int iParam0, int iParam1)//Position - 0x209FD
{
...
void func_186(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x20A47
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
	...
	if (iParam1 == 1)
	{
		func_187(iParam0, bParam2, bParam3);
	}
	HUD::SET_MISSION_NAME(false, 0);
}

void func_187(int iParam0, bool bParam1, bool bParam2)//Position - 0x20AE4
{
	struct<4> Var0;
	char* sVar32;
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&sVar32, {func_184(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&sVar32, 0, Global_100718, 0);
		func_188(&sVar32, Var0.f_3, Global_100718, bParam1, bParam2);
	}
}

void func_188(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x20B23
{
...
void func_189(int iParam0, var uParam1)//Position - 0x20B67
{
	switch (iParam0)
	{
		case 0:
			func_190(uParam1, "Abigail1", func_183(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0, "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 1:
			func_190(uParam1, "Abigail2", func_183(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, -1, 4, 1, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 2:
			func_190(uParam1, "Barry1", func_183(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1, 4, 1, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 3:
			func_190(uParam1, "Barry2", func_183(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_191(iParam0), 1, 1);
			break;
		
		case 4:
			func_190(uParam1, "Barry3", func_183(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 5:
			func_190(uParam1, "Barry3A", func_183(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 6:
			func_190(uParam1, "Barry3C", func_183(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 7:
			func_190(uParam1, "Barry4", func_183(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_191(iParam0), 0, 0);
			break;
		
		case 8:
			func_190(uParam1, "Dreyfuss1", func_183(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 9:
			func_190(uParam1, "Epsilon1", func_183(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1, 10, 4, 1, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 10:
			func_190(uParam1, "Epsilon2", func_183(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0, 11, 4, 1, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 11:
			func_190(uParam1, "Epsilon3", func_183(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars", 0, 0, 12, 4, 1, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 12:
			func_190(uParam1, "Epsilon4", func_183(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16, "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 13:
			func_190(uParam1, "Epsilon5", func_183(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16, "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 14:
			func_190(uParam1, "Epsilon6", func_183(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0, 15, 4, 1, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 15:
			func_190(uParam1, "Epsilon7", func_183(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 16:
			func_190(uParam1, "Epsilon8", func_183(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 17:
			func_190(uParam1, "Extreme1", func_183(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 18:
			func_190(uParam1, "Extreme2", func_183(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171, 0, 19, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 19:
			func_190(uParam1, "Extreme3", func_183(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 20:
			func_190(uParam1, "Extreme4", func_183(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, -1, 4, 2, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 21:
			func_190(uParam1, "Fanatic1", func_183(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, -1, 4, 1, 700, 2000, func_191(iParam0), 1, 0);
			break;
		
		case 22:
			func_190(uParam1, "Fanatic2", func_183(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1, -1, 4, 4, 700, 2000, func_191(iParam0), 1, 0);
			break;
		
		case 23:
			func_190(uParam1, "Fanatic3", func_183(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1, 4, 2, 700, 2000, func_191(iParam0), 0, 1);
			break;
		
		case 24:
			func_190(uParam1, "Hao1", func_183(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0, "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_191(iParam0), 0, 1);
			break;
		
		case 25:
			func_190(uParam1, "Hunting1", func_183(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 26:
			func_190(uParam1, "Hunting2", func_183(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, -1, 4, 4, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 27:
			func_190(uParam1, "Josh1", func_183(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 28:
			func_190(uParam1, "Josh2", func_183(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0, 29, 4, 4, 0, 2359, func_191(iParam0), 1, 1);
			break;
		
		case 29:
			func_190(uParam1, "Josh3", func_183(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_191(iParam0), 1, 1);
			break;
		
		case 30:
			func_190(uParam1, "Josh4", func_183(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1, 4, 4, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 31:
			func_190(uParam1, "Maude1", func_183(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0, "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 32:
			func_190(uParam1, "Minute1", func_183(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 33:
			func_190(uParam1, "Minute2", func_183(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 34:
			func_190(uParam1, "Minute3", func_183(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0, -1, 4, 4, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 35:
			func_190(uParam1, "MrsPhilips1", func_183(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0, "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 36:
			func_190(uParam1, "MrsPhilips2", func_183(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 37:
			func_190(uParam1, "Nigel1", func_183(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1, -1, 1, 4, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 38:
			func_190(uParam1, "Nigel1A", func_183(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_191(iParam0), 1, 1);
			break;
		
		case 39:
			func_190(uParam1, "Nigel1B", func_183(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_191(iParam0), 1, 1);
			break;
		
		case 40:
			func_190(uParam1, "Nigel1C", func_183(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_191(iParam0), 1, 1);
			break;
		
		case 41:
			func_190(uParam1, "Nigel1D", func_183(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_191(iParam0), 1, 1);
			break;
		
		case 42:
			func_190(uParam1, "Nigel2", func_183(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_191(iParam0), 1, 1);
			break;
		
		case 43:
			func_190(uParam1, "Nigel3", func_183(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16, "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_191(iParam0), 1, 1);
			break;
		
		case 44:
			func_190(uParam1, "Omega1", func_183(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 45:
			func_190(uParam1, "Omega2", func_183(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 46:
			func_190(uParam1, "Paparazzo1", func_183(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 47:
			func_190(uParam1, "Paparazzo2", func_183(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 48:
			func_190(uParam1, "Paparazzo3", func_183(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183, 1, -1, 2, 2, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 49:
			func_190(uParam1, "Paparazzo3A", func_183(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 50:
			func_190(uParam1, "Paparazzo3B", func_183(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 51:
			func_190(uParam1, "Paparazzo4", func_183(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1, -1, 4, 2, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 52:
			func_190(uParam1, "Rampage1", func_183(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 54:
			func_190(uParam1, "Rampage3", func_183(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 55:
			func_190(uParam1, "Rampage4", func_183(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 56:
			func_190(uParam1, "Rampage5", func_183(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 53:
			func_190(uParam1, "Rampage2", func_183(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0, "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 57:
			func_190(uParam1, "TheLastOne", func_183(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, -1, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 58:
			func_190(uParam1, "Tonya1", func_183(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 59:
			func_190(uParam1, "Tonya2", func_183(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 60:
			func_190(uParam1, "Tonya3", func_183(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 61:
			func_190(uParam1, "Tonya4", func_183(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 62:
			func_190(uParam1, "Tonya5", func_183(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0, -1, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
...
int func_191(int iParam0)//Position - 0x21DAD
{
	switch (iParam0)
	{
		case 0:
...
void func_192(int iParam0)//Position - 0x220F3
{
	Global_43808 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_193()//Position - 0x22105
{
	if (Global_97993)
	{
		func_182();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_194(Global_113648.f_2365.f_539.f_4321));
	}
	else
	{
...
char* func_194(var uParam0)//Position - 0x22137
{
	uParam0 = uParam0;
	return "";
}

void func_195()//Position - 0x22146
{
	char cVar0[24];
	
	if (MISC::IS_XBOX360_VERSION() || func_197())
	{
		NETWORK::NETWORK_SET_RICH_PRESENCE(StackVal, 0, 0, 0);
	}
	else if (MISC::IS_PS3_VERSION() || func_196())
	{
...
bool func_196()//Position - 0x22189
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_197()//Position - 0x2219F
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_198(int iParam0, int iParam1)//Position - 0x221B5
{
	Global_97988 = iParam0;
	Global_97989 = iParam1;
}

void func_199()//Position - 0x221C9
{
	if (Global_78813 != 6)
	{
	}
...
void func_200(var uParam0)//Position - 0x22201
{
	if (*uParam0 == -1)
	{
		return;
...
void func_201(int iParam0, bool bParam1)//Position - 0x2223E
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_202(int iParam0)//Position - 0x223BB
{
	switch (iParam0)
	{
		case 0:
...
void func_203(int iParam0)//Position - 0x22742
{
	func_205(iParam0, 1);
	Global_113648.f_18576[iParam0 /*6*/].f_3 = func_204();
	Global_113648.f_18576.f_380++;
}

int func_204()//Position - 0x22778
{
	return (Global_113648.f_10018.f_21 + Global_113648.f_18576.f_380);
}

void func_205(var uParam0, bool bParam1)//Position - 0x22794
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_206(int iParam0)//Position - 0x22AB8
{
...
void func_207(int iParam0)//Position - 0x22AEB
{
	switch (iParam0)
	{
		case 30:
...
void func_208(int iParam0, bool bParam1)//Position - 0x22B20
{
	if (iParam0 == -1)
	{
		return;
...
void func_209(int iParam0, int iParam1, bool bParam2)//Position - 0x22B7D
{
	if (iParam0 == -1)
	{
		return;
...
int func_210(int iParam0, int iParam1)//Position - 0x22BB8
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_211(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x22BD8
{
	if (iParam0 != 198)
	{
		if (Global_78558)
...
void func_212(int iParam0, int iParam1)//Position - 0x22C30
{
	switch (iParam0)
	{
		case 12:
...
void func_213(int iParam0, bool bParam1)//Position - 0x22D19
{
	if (bParam1)
	{
...
bool func_214(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x22D42
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_215()//Position - 0x23691
{
	if ((func_34() == -1 || func_34() == 999) && !func_216() == 0)
	{
		return 1;
	}
	return 0;
...
int func_216()//Position - 0x236C1
{
	return Global_32164;
}

int func_217(var uParam0, int iParam1)//Position - 0x236CC
{
	int iVar0;
...
int func_218(int iParam0)//Position - 0x26E68
{
	switch (iParam0)
	{
		case 46:
...
void func_219(int iParam0, bool bParam1)//Position - 0x26F57
{
	switch (iParam0)
	{
		case 46:
...
void func_220(int iParam0, bool bParam1)//Position - 0x26FA8
{
	int iVar0;
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (!func_224(iParam0))
		{
			...
			if (!bParam1)
			{
				func_222(func_223(iParam0));
				if (!func_221(68))
				{
					func_238("DI_HLP_STRY" /* GXT: Story characters become available in Rockstar Editor's 'Director Mode' as the GTAV story progresses. */, 2, 0, 20000, 10000, 7, 0, 208, 0);
				}
			}
		}
	}
...
int func_221(int iParam0)//Position - 0x2700E
{
	int iVar0;
	int iVar1;
...
void func_222(char* sParam0)//Position - 0x2704E
{
...
char* func_223(int iParam0)//Position - 0x27072
{
	switch (iParam0)
	{
		case 0:
...
int func_224(int iParam0)//Position - 0x27245
{
...
void func_225(int iParam0, int iParam1)//Position - 0x2726F
{
...
int func_226(char* sParam0)//Position - 0x272AC
{
	int iVar0;
...
int func_227()//Position - 0x2730C
{
	return func_228(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_228(char* sParam0, int iParam1)//Position - 0x2731D
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_229(int iParam0, int iParam1, bool bParam2)//Position - 0x27366
{
	int iVar0;
	...
	if (Global_117[iParam0 /*10*/].f_8 != 169)
	{
		...
		if (iParam1 == 4)
		{
			...
			func_234(iParam0, 1, 1);
			func_234(iParam0, 2, 1);
		}
		else
		{
			if (func_233(iParam0, iParam1) == 1 && func_232(iParam0, iParam1) == 1)
			{
				bParam2 = false;
			}
			iVar0 = iParam1;
			func_235(iParam0, iVar0, 1);
			func_234(iParam0, iVar0, 1);
		...
		if (bParam2)
		{
			if (!Global_78558)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8912[iParam1 /*4*/] = { func_231(iParam0) };
					...
					{
						Global_8863[1 /*6*/] = { func_231(iParam0) };
...
void func_230()//Position - 0x274DE
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
struct<4> func_231(int iParam0)//Position - 0x27559
{
	return Global_2028[iParam0 /*29*/].f_3;
}

int func_232(int iParam0, int iParam1)//Position - 0x2756C
{
...
int func_233(int iParam0, int iParam1)//Position - 0x27596
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_234(int iParam0, int iParam1, int iParam2)//Position - 0x275C0
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_235(int iParam0, int iParam1, int iParam2)//Position - 0x27605
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_236()//Position - 0x2764A
{
	if (func_118(14))
	{
...
int func_237()//Position - 0x276EC
{
	func_182();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_238(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x27705
{
	func_239(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_239(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x27726
{
	int iVar0;
...
void func_240()//Position - 0x278F9
{
	int iVar0;
...
bool func_241(char* sParam0, int iParam1, char* sParam2)//Position - 0x27A10
{
...
int func_242(struct<3> Param0, struct<3> Param3, int iParam6, float fParam7)//Position - 0x27A2E
{
	if (iLocal_153 < iLocal_151)
	{
		if (!func_20())
		{
			if (SYSTEM::VDIST2(Param3, Param0) < (fParam7 * fParam7))
			{
				...
				{
					func_245(&uLocal_163, 3, iLocal_158, "MAUDE", 0, 1);
					func_243(&uLocal_163, "MAUDEAU", "MAUDE_loiter", 7, 0, 0);
					iLocal_152 = MISC::GET_GAME_TIMER();
					iLocal_153++;
					return 1;
				}
...
void func_243(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27AA8
{
	func_244(uParam0, 145, sParam1, iParam4, iParam5, 0);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
...
void func_244(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27AE3
{
...
void func_245(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x27B39
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
int func_246(bool bParam0)//Position - 0x27BD4
{
	if (func_17(iLocal_158))
	{
		...
		if (func_254(iLocal_158, 1126825984))
		{
			return 1;
		}
		if (func_247(iLocal_158, 1, 0, 0, 0))
		{
			return 1;
		}
...
int func_247(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x27D19
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_11(PLAYER::PLAYER_PED_ID()) && func_11(iParam0))
	{
		...
		if (!bParam2)
		{
			...
			if (func_248(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_248(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x27E14
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_249(int iParam0, float fParam1)//Position - 0x27F20
{
	var uVar0;
	struct<3> Var1;
	...
	{
		if (func_250(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_250(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x27FB5
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_252(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_252(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_251(Var3, Var0);
...
float func_251(struct<3> Param0, struct<3> Param3)//Position - 0x28045
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_252(struct<3> Param0)//Position - 0x28066
{
	float fVar0;
	float fVar1;
...
int func_253(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x280A5
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_254(int iParam0, float fParam1)//Position - 0x280ED
{
	float fVar0;
	
	if (func_11(PLAYER::PLAYER_PED_ID()) && func_11(iParam0))
	{
		if (func_263(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_255(int iParam0, float fParam1)//Position - 0x28163
{
	return func_256(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_256(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2817B
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	uVar0 = func_257(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_257(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2823C
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_258(int iParam0, int iParam1)//Position - 0x28368
{
	int iVar0;
...
int func_260(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x28477
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_252(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
void func_261(var uParam0)//Position - 0x28508
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_262(int iParam0, int iParam1)//Position - 0x28523
{
	int iVar0;
...
int func_263(int iParam0)//Position - 0x28562
{
...
void func_264(char* sParam0, int iParam1, int iParam2)//Position - 0x2858A
{
	iParam2 = iParam2;
...
void func_265()//Position - 0x285A3
{
	int iVar0;
	...
	switch (iLocal_143)
	{
		case 0:
			...
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				if (func_352())
				{
					if (func_347(1, 1093140480, 0))
					{
						func_346(&Local_81, 0, 1);
						func_345(&iLocal_158, &(Local_81.f_28[0]));
						func_344(&iLocal_154, &(Local_81.f_41[0]));
						func_344(&iLocal_155, &(Local_81.f_41[1]));
						func_343();
...
void func_266()//Position - 0x28863
{
	int iVar0;
...
void func_267(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x288A5
{
	int iVar0;
...
void func_268(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2894F
{
	if (bParam0)
	{
	...
	else
	{
		...
		func_274(0, bParam3, iParam2, 0);
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_272(PLAYER::PLAYER_ID())) && !func_270(PLAYER::PLAYER_ID(), 0)) && !func_269()) && !bParam4) && !bParam5) && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
			{
...
bool func_269()//Position - 0x28A9C
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_270(int iParam0, int iParam1)//Position - 0x28AB6
{
	bool bVar0;
...
int func_271(int iParam0, bool bParam1)//Position - 0x28B01
{
	int iVar0;
	int iVar1;
...
int func_272(int iParam0)//Position - 0x28B42
{
...
bool func_273()//Position - 0x28B81
{
	return BitTest(Global_2621446, 3);
}

int func_274(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x28B8F
{
	int iVar0;
...
void func_276(int iParam0)//Position - 0x28BE9
{
	if (iParam0 == 1)
	{
...
void func_278(int iParam0, bool bParam1, bool bParam2)//Position - 0x28C3D
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_279()//Position - 0x28D3D
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (func_335(Var6, 0))
	{
		func_329(Var0, Var3, fVar9, 2719.87f, 4143.46f, 43.46f, 261.91f, 1, 1, 1, 0, 0);
		func_280(2719.87f, 4143.46f, 43.46f, 261.91f, 0, 145);
		Local_329 = { 2719.87f, 4143.46f, 43.46f };
	}
	else
	{
		func_329(Var0, Var3, fVar9, 2710.6646f, 4149.075f, 42.7026f, 180.9488f, 1, 1, 1, 0, 0);
		func_280(2710.6646f, 4149.075f, 42.7026f, 180.9488f, 0, 145);
		Local_329 = { 2710.6646f, 4149.075f, 42.7026f };
	}
}

void func_280(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x28E38
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104212.f_4))
	{
		...
		{
			if (func_328(24) != Global_104212.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_325(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_281(Global_104212.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_281(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x28EB3
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_315(iParam5, &Var0, Param1, fParam4, func_318(iParam0));
		func_282(iParam5, iParam0, 0);
	}
}

void func_282(int iParam0, int iParam1, int iParam2)//Position - 0x28FDC
{
	int iVar0;
	...
	if (!func_312(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_113648.f_32751.f_4801 = func_301();
			}
...
void func_283(int iParam0, int iParam1)//Position - 0x290F3
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_320(iParam0, &(Global_113648.f_32751.f_5510));
}

int func_284(int iParam0)//Position - 0x292F5
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_299(iParam0, 0, 0)) || func_299(iParam0, 1, 0)) || func_299(iParam0, 2, 0)) || func_318(iParam0) != 145) || func_298(iParam0)) || func_297(iParam0)) || func_296(iParam0)) || func_295(iParam0)) || !func_285(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_297(iParam0))
		{
		}
...
int func_285(int iParam0)//Position - 0x293D2
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_286(int iParam0, bool bParam1, int iParam2)//Position - 0x29584
{
	int iVar0;
	struct<2> Var1;
	...
	{
		if ((func_197() || MISC::IS_PC_VERSION()) || func_196())
		{
		}
		else if (!func_291())
		{
...
int func_287(int iParam0)//Position - 0x29706
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_289(int iParam0, int iParam1)//Position - 0x297E9
{
	int iVar0;
	int iVar1;
...
int func_290()//Position - 0x2CE1A
{
	return 0;
}

int func_291()//Position - 0x2CE23
{
	return 1;
}

int func_292()//Position - 0x2CE2C
{
	return 1;
}

int func_293()//Position - 0x2CE35
{
...
int func_295(int iParam0)//Position - 0x2CF06
{
	int iVar0;
	char* sVar1;
...
int func_296(int iParam0)//Position - 0x2CF4D
{
	int iVar0;
...
int func_297(int iParam0)//Position - 0x2CF88
{
	int iVar0;
...
int func_298(int iParam0)//Position - 0x2D004
{
	int iVar0;
...
int func_299(int iParam0, int iParam1, bool bParam2)//Position - 0x2D0EC
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_300(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2D15A
{
...
void func_302(var uParam0, int iParam1)//Position - 0x2D278
{
	if (iParam1 <= 0)
	{
		return;
...
void func_303(var uParam0, int iParam1)//Position - 0x2D2FE
{
...
void func_304(var uParam0, int iParam1)//Position - 0x2D331
{
	int iVar0;
	int iVar1;
...
int func_305(int iParam0, int iParam1)//Position - 0x2D382
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_306(int iParam0)//Position - 0x2D424
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_307(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_307(bool bParam0, int iParam1, int iParam2)//Position - 0x2D446
{
	if (bParam0)
	{
		return iParam1;
...
int func_308(var uParam0)//Position - 0x2D45D
{
	return uParam0 & 15;
}

void func_309(var uParam0, int iParam1)//Position - 0x2D46A
{
...
void func_310(var uParam0, int iParam1)//Position - 0x2D4A4
{
...
void func_311(var uParam0, int iParam1)//Position - 0x2D4DF
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_312(var uParam0, int iParam1)//Position - 0x2D51B
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_319(Global_113648.f_32751.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_319(Global_113648.f_2365.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_319(Global_113648.f_2365.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_313(int iParam0, int iParam1)//Position - 0x2EC09
{
	struct<82> Var0;
...
void func_314(int iParam0, var uParam1, int iParam2)//Position - 0x2EC4B
{
	int iVar0;
...
void func_315(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x2EEA7
{
	if (func_312(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_317(iParam0);
			func_316(uParam1, &(Global_113648.f_32751.f_69[Global_77348.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_316(var uParam0, var uParam1)//Position - 0x2EFA0
{
...
void func_317(int iParam0)//Position - 0x2F06C
{
	if (iParam0 == -1)
	{
		return;
...
int func_318(int iParam0)//Position - 0x2F0E3
{
	int iVar0;
...
bool func_319(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2F146
{
	if (bParam6)
	{
...
void func_320(int iParam0, var uParam1)//Position - 0x2F18D
{
	int iVar0;
...
int func_321(int iParam0)//Position - 0x2F438
{
	switch (iParam0)
	{
		case 1:
...
int func_322(int iParam0, var uParam1, var uParam2)//Position - 0x2F4E8
{
	int iVar0;
	int iVar1;
...
int func_323(int iParam0)//Position - 0x2F6DB
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_324(int iParam0)//Position - 0x2F6FB
{
...
int func_325(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x2F722
{
	int iVar0;
	
	iVar0 = func_326(Param0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_326(struct<3> Param0, int iParam3, int iParam4)//Position - 0x2F838
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_327(int iParam0)//Position - 0x2F8C7
{
	return BitTest(Global_113648.f_7231[iParam0], 0);
}

int func_328(int iParam0)//Position - 0x2F8DC
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_329(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x2F8F8
{
	func_330(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_330(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2F921
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_332(iVar0, Param0, Param3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_331(struct<3> Param0)//Position - 0x2FD17
{
...
int func_332(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2FD41
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_333(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var9) || func_333(Var18[0 /*3*/], Var18[1 /*3*/], Var9, Var15)) || func_333(Var18[0 /*3*/], Var18[1 /*3*/], Var12, Var15)) || func_333(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var12)) || func_333(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var9)) || func_333(Var18[1 /*3*/], Var18[3 /*3*/], Var9, Var15)) || func_333(Var18[1 /*3*/], Var18[3 /*3*/], Var12, Var15)) || func_333(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var12)) || func_333(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var9)) || func_333(Var18[3 /*3*/], Var18[2 /*3*/], Var9, Var15)) || func_333(Var18[3 /*3*/], Var18[2 /*3*/], Var12, Var15)) || func_333(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var12)) || func_333(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var9)) || func_333(Var18[2 /*3*/], Var18[0 /*3*/], Var9, Var15)) || func_333(Var18[2 /*3*/], Var18[0 /*3*/], Var12, Var15)) || func_333(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_333(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x30038
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_334(int iParam0)//Position - 0x300EC
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
bool func_335(struct<3> Param0, int iParam3)//Position - 0x30151
{
	return func_336(Global_104212.f_2890.f_12.f_66, Param0, iParam3);
}

int func_336(int iParam0, struct<3> Param1, int iParam4)//Position - 0x3016E
{
	struct<3> Var0;
	struct<3> Var3;
...
Vector3 func_337()//Position - 0x301D8
{
	return 2.55f, 5.665f, 2.55f;
}

void func_338(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x301EF
{
	int iVar0;
...
void func_339(int iParam0, bool bParam1)//Position - 0x303AD
{
...
Vector3 func_340(int iParam0)//Position - 0x303E9
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_341(bool bParam0)//Position - 0x303FC
{
	int iVar0;
	...
	func_268(1, 1, 0, 0, 0, 0, 0);
}

void func_342()//Position - 0x3043B
{
	int iVar0;
...
void func_343()//Position - 0x3045B
{
	struct<3> Var0;
	int iVar3;
...
void func_344(int* iParam0, var uParam1)//Position - 0x304C3
{
	*iParam0 = *uParam1;
	*uParam1 = 0;
}

void func_345(int* iParam0, var uParam1)//Position - 0x304D5
{
	*iParam0 = *uParam1;
	*uParam1 = 0;
}

void func_346(var uParam0, bool bParam1, bool bParam2)//Position - 0x304E7
{
	int iVar0;
...
int func_347(int iParam0, float fParam1, int iParam2)//Position - 0x305DC
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_350(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
bool func_348()//Position - 0x306B0
{
	bool bVar0;
...
void func_349()//Position - 0x306D3
{
...
int func_350(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x30724
{
...
void func_351(int iParam0)//Position - 0x308BC
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_352()//Position - 0x308E8
{
	if ((func_468() || func_31(0)) || func_354())
	{
		return 1;
	}
	if (iLocal_148 == 0)
	{
		...
		{
			if (!func_353(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 7f, 1))
			{
	...
	{
		if ((iLocal_149 == -1 || (MISC::GET_GAME_TIMER() - iLocal_149) > 3000) || (func_11(Local_81.f_28[0]) && func_353(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 4.5f, 1)))
		{
			return 1;
		}
	}
...
void func_356()//Position - 0x30A85
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_350(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_357(int iParam0)//Position - 0x30ADD
{
	if (func_362())
	{
		return;
...
void func_358(int iParam0)//Position - 0x30B10
{
	if (func_362())
	{
		return;
...
void func_359(bool bParam0, bool bParam1)//Position - 0x30B9A
{
	if (bParam0)
	{
		if (func_361(0))
...
bool func_360()//Position - 0x30C0E
{
	return BitTest(Global_1962996, 5);
}

int func_361(int iParam0)//Position - 0x30C1C
{
	if (iParam0 == 1)
	{
...
bool func_362()//Position - 0x30C73
{
	return BitTest(Global_1962996, 19);
}

void func_363(char* sParam0, bool bParam1)//Position - 0x30C82
{
	func_341(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_364()//Position - 0x30C98
{
	if (Global_94858)
	{
		func_378(&iLocal_328, 2662.6438f, 4284.5347f, 43.5787f, 19.8376f, 0, 0, 1, 0, 0, joaat("asterope"), 0, 145, 1);
		func_377(2672.462f, 4288.7773f, 43.607f, 78.1133f, 0, 0);
		func_375(1, 1);
		SYSTEM::WAIT(500);
		func_374(0, -1, 1);
		func_373(1, 1, 1);
	...
	else
	{
		...
		func_344(&iLocal_154, &(Local_81.f_41[0]));
		func_344(&iLocal_155, &(Local_81.f_41[1]));
		if (!ENTITY::DOES_ENTITY_EXIST(func_365()))
		{
			func_378(&iLocal_328, 2704.0776f, 4152.2397f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
		}
		func_377(2718.649f, 4147.2075f, 42.7043f, 76.7892f, 0, 0);
		func_375(1, 1);
		func_279();
		func_278(31, 1, 0);
		SYSTEM::WAIT(0);
...
var func_365()//Position - 0x30E10
{
	return Global_104212.f_4;
}

int func_366(var uParam0)//Position - 0x30E1E
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_79)
	{
		...
		case 1:
			if (!func_371(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_79 = 2;
		...
		case 2:
			...
			{
				func_370(&(uParam0->f_41[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				func_370(&(uParam0->f_41[1]), iVar0[2], 2727.686f, 4145.715f, 44.08f, 71f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_367(&(uParam0->f_28[0]), 62, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1))
				{
					bVar5 = false;
				}
			}
...
int func_367(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x310B0
{
	if (func_368(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_368(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x3110C
{
	int iVar0;
...
int func_369(var uParam0, int iParam1)//Position - 0x3119A
{
	int iVar0;
...
void func_370(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x311E0
{
	func_4(iParam0);
...
int func_371(int iParam0)//Position - 0x31207
{
	int iVar0;
...
int func_372(int iParam0)//Position - 0x31238
{
	if (!func_179(iParam0))
	{
		return func_178(iParam0);
...
void func_373(int iParam0, int iParam1, int iParam2)//Position - 0x3125E
{
...
void func_374(int iParam0, int iParam1, int iParam2)//Position - 0x31292
{
	if (func_468() && func_354())
	{
...
void func_375(bool bParam0, bool bParam1)//Position - 0x31356
{
	if (bParam0)
	{
		func_376(0, 1, 1);
...
void func_376(bool bParam0, int iParam1, int iParam2)//Position - 0x31389
{
	bool bVar0;
	...
	if (CUTSCENE::IS_CUTSCENE_ACTIVE())
	{
		...
		if (bParam0)
		{
			func_267(iParam1, iParam2, 1, 1);
		}
	}
}

void func_377(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x313E8
{
	if (func_468())
	{
...
void func_378(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x3147D
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_468() || !func_467())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	...
	else if (iParam9 == 1)
	{
		...
		if (func_179(iParam12))
		{
			func_429(iParam12, 0);
			while (!func_379(iParam0, iParam12, Param1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_379(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x31611
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_421(iParam0, &(Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_421(iParam0, &(Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5.f_0, Param2, fParam5, true, true, false);
				...
				func_421(iParam0, &(Var5.f_31), &(Var5.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_380(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x32431
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_179(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_384(*iParam1, 0, &uVar0))
		{
			func_322(iParam1, &(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_113648.f_20120[iParam0 /*43*/].f_31 = func_383(*iParam1);
				...
				func_381(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_113648.f_20120[iParam0 /*43*/].f_1));
				...
				func_381(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_113648.f_20120[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_381(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x33045
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_382(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x330B8
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_383(int iParam0)//Position - 0x3461A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_384(int iParam0, bool bParam1, var uParam2)//Position - 0x346CA
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_416(iVar0, bParam1, uParam2) && !func_415(PLAYER::PLAYER_ID())) && !func_396(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_393(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_390(iParam0)) && !bVar1) && !(func_389(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_385(PLAYER::PLAYER_ID())))
	{
...
int func_385(int iParam0)//Position - 0x34838
{
	if (iParam0 != func_388())
	{
		if (func_387(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_386(Global_2657589[iParam0 /*466*/].f_321.f_7) == 11;
			}
		}
	}
	return 0;
...
int func_386(int iParam0)//Position - 0x3487F
{
	switch (iParam0)
	{
		case 0:
...
int func_387(int iParam0, bool bParam1, bool bParam2)//Position - 0x34D33
{
	int iVar0;
...
int func_388()//Position - 0x34D93
{
	return -1;
}

int func_389(int iParam0)//Position - 0x34D9C
{
...
int func_390(int iParam0)//Position - 0x34DDE
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_391(int iParam0)//Position - 0x34EA6
{
	if (iParam0 != func_388())
	{
		if (func_387(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_386(Global_2657589[iParam0 /*466*/].f_321.f_7) == 26;
			}
		}
	}
	return 0;
...
int func_392(int iParam0)//Position - 0x34EED
{
	if (iParam0 != func_388())
	{
		if (func_387(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_386(Global_2657589[iParam0 /*466*/].f_321.f_7) == 13;
			}
		}
	}
	return 0;
...
int func_393(int iParam0)//Position - 0x34F34
{
	if (iParam0 != func_388())
	{
		if (func_387(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_386(Global_2657589[iParam0 /*466*/].f_321.f_7) == 7;
			}
		}
	}
	return 0;
...
int func_394(int iParam0)//Position - 0x34F7A
{
	if (iParam0 == joaat("oppressor2"))
	{
		return 0;
	}
	if ((!func_395(PLAYER::PLAYER_ID()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger"))
	{
		return 0;
	}
	return 1;
...
int func_395(int iParam0)//Position - 0x34FBB
{
	if (iParam0 != func_388())
	{
...
int func_396(int iParam0)//Position - 0x34FE1
{
	if (func_414(PLAYER::PLAYER_ID()) || func_413(PLAYER::PLAYER_ID()))
	{
		if (func_397(iParam0))
		{
			return 1;
...
int func_397(int iParam0)//Position - 0x35010
{
	...
	if (func_400(PLAYER::PLAYER_ID()) && (!func_394(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("thruster"))))
	{
		return 0;
	}
...
int func_398(int iParam0)//Position - 0x350C3
{
	int iVar0;
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_390(iParam0)) || func_399(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_399(int iParam0)//Position - 0x3513A
{
	switch (iParam0)
	{
		case joaat("mule"):
...
int func_400(int iParam0)//Position - 0x3518A
{
	if (iParam0 == func_388())
	{
		return 0;
	}
	if (func_415(iParam0) && Global_2657589[iParam0 /*466*/].f_321.f_10 == iParam0)
	{
		return 1;
	}
	return 0;
...
int func_401(int iParam0, bool bParam1)//Position - 0x351C3
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_403(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				if (Global_2793044.f_304 == iParam0)
				{
					return 1;
				}
				else if (func_402(iParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_402(int iParam0)//Position - 0x3521E
{
	int iVar0;
...
int func_403(int iParam0, int iParam1)//Position - 0x35257
{
	if (iParam1 == 0)
	{
...
int func_413(int iParam0)//Position - 0x35B3D
{
	if (iParam0 != func_388())
	{
		if (func_387(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1 && Global_2657589[iParam0 /*466*/].f_321.f_10 != func_388())
			{
				return func_386(Global_2657589[iParam0 /*466*/].f_321.f_7) == 5;
			}
		}
	}
	return 0;
...
int func_414(int iParam0)//Position - 0x35B9C
{
	if (iParam0 != func_388())
	{
		if (func_387(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1 && Global_2657589[iParam0 /*466*/].f_321.f_10 != func_388())
			{
				return func_386(Global_2657589[iParam0 /*466*/].f_321.f_7) == 8;
			}
		}
	}
	return 0;
...
int func_415(int iParam0)//Position - 0x35BFC
{
	if (iParam0 != func_388())
	{
		if (func_387(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_386(Global_2657589[iParam0 /*466*/].f_321.f_7) == 9;
			}
		}
	}
	return 0;
...
int func_416(int iParam0, bool bParam1, var uParam2)//Position - 0x35C43
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_393(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_417(int iParam0)//Position - 0x3608F
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_418(int iParam0, int iParam1)//Position - 0x360B8
{
	int iVar0;
...
void func_419(int iParam0)//Position - 0x3613A
{
	if (!func_420(*iParam0))
	{
...
bool func_420(int iParam0)//Position - 0x36165
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_421(int iParam0, var uParam1, var uParam2)//Position - 0x36174
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*iParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_426(*iParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_412(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_424(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_424(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_423(iParam0);
	if (func_422(*iParam0))
	{
...
int func_422(int iParam0)//Position - 0x3634E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_423(var uParam0)//Position - 0x3642C
{
...
int func_424(int iParam0, int iParam1)//Position - 0x36483
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		iVar0 = func_425(iParam0, 38) + 1;
		iVar1 = func_425(iParam0, 24) + 1;
...
int func_425(int iParam0, int iParam1)//Position - 0x3656C
{
	int iVar0;
	...
	while (iVar0 >= 0 && func_426(iParam0, iParam1, iVar0))
	{
		iVar0 = (iVar0 - 1);
	}
	return iVar0;
...
int func_426(int iParam0, int iParam1, int iParam2)//Position - 0x365CE
{
	if (!func_427() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_427()//Position - 0x365F2
{
	return 0;
}

int func_428(var uParam0, int iParam1)//Position - 0x365FB
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_429(int iParam0, int iParam1)//Position - 0x3663C
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98012[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98012[iVar0]) == func_313(iParam0, iParam1))
				{
...
void func_430(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x366DA
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_312(&(Global_77348.f_555[0 /*21*/]), iVar0))
		{
...
void func_431(int iParam0)//Position - 0x3672A
{
	bool bVar0;
	...
	if (func_312(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
		...
		if (BitTest(Global_77348.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_210(iParam0, 0)) && Global_78257.f_66 == 0) && Global_113648.f_32751.f_1958[Global_77348.f_555[0 /*21*/].f_14] != 0) && Global_113648.f_32751.f_1958[Global_77348.f_555[0 /*21*/].f_14] > 3) && (!func_432(0, Global_77348.f_555[0 /*21*/].f_12) || !func_432(1, Global_77348.f_555[0 /*21*/].f_12)))
			{
...
int func_432(int iParam0, int iParam1)//Position - 0x36899
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_433(&(Global_113648.f_32751.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_286(Global_113648.f_32751.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}

int func_433(var uParam0)//Position - 0x3690C
{
	return *uParam0;
}

int func_434(struct<3> Param0, float fParam3)//Position - 0x36917
{
	return func_435(&(Global_107196.f_2890), Param0, fParam3, 0);
}

int func_435(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x36931
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
		...
		if (func_459(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_418(iVar0, uParam0->f_11);
				}
				else if ((!func_437(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_436(int iParam0)//Position - 0x36BE4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_437(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x36CA7
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_439(iParam0, Global_77348.f_139[38], 0))
			{
				func_431(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_439(iParam0, Global_77348.f_139[43], 1))
			{
				func_431(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_439(iParam0, uVar1[iVar6], 1) && func_438(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.5635f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_319(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
int func_438(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x36EAF
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_439(int iParam0, int iParam1, bool bParam2)//Position - 0x36F2A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_440(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x36F8B
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		{
			iVar0 = 1;
			if (BitTest(uParam1->f_77, func_321(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (BitTest(uParam1->f_77, func_321(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_321(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				if (BitTest(uParam1->f_77, func_321(iVar2)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_321(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				if (BitTest(uParam1->f_77, func_321(iVar3)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_321(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (BitTest(uParam1->f_77, func_321(iVar4)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_77), func_321(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("surfer3"))
		{
			...
			while (iVar5 <= 2)
			{
				if (BitTest(uParam1->f_77, func_321(iVar5)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_321(iVar5));
				}
				iVar5++;
			}
		}
		...
		{
			if (BitTest(uParam1->f_77, func_321(4)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_321(4));
			}
		}
		...
		{
			MISC::SET_BIT(&(uParam1->f_77), func_321(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar6 <= 2)
			{
				if (BitTest(uParam1->f_77, func_321(iVar6)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_321(iVar6));
				}
				iVar6++;
			}
		}
		...
		if (bParam3)
		{
			func_421(&iParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar7 <= 11)
			{
				if (BitTest(uParam1->f_77, func_321(iVar7 + 1)))
				{
		...
		if (((func_441() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger")))
		{
...
int func_441()//Position - 0x37672
{
	...
	if (func_445(7))
	{
		if (func_443(Global_2672505.f_4.f_16) || func_442(Global_2672505.f_4.f_16))
		{
			return 0;
		}
	}
...
int func_442(var uParam0)//Position - 0x37701
{
	int iVar0;
...
int func_443(int iParam0)//Position - 0x37725
{
	int iVar0;
...
var func_444(int iParam0, int iParam1)//Position - 0x37743
{
	return BitTest(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

bool func_445(int iParam0)//Position - 0x3775B
{
	return func_446(&(Global_2672505.f_183), iParam0);
}

var func_446(var uParam0, var uParam1)//Position - 0x3776F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_447(int iParam0, int iParam1)//Position - 0x37792
{
	int iVar0;
	int iVar1;
...
bool func_448()//Position - 0x3780A
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

int func_449(int iParam0)//Position - 0x3781B
{
	int iVar0;
...
int func_450(int iParam0)//Position - 0x37866
{
	if (!func_427() && func_451(iParam0))
	{
		return 1;
	}
	return 0;
...
int func_451(int iParam0)//Position - 0x37886
{
	switch (iParam0)
	{
		case 161:
...
int func_452(int iParam0)//Position - 0x378D9
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (!func_458(PLAYER::PLAYER_ID(), -1))
		{
...
int func_453(int iParam0)//Position - 0x37960
{
...
int func_454(int iParam0)//Position - 0x37992
{
...
int func_455(int iParam0)//Position - 0x379AF
{
...
int func_456(int iParam0, int iParam1)//Position - 0x379D2
{
...
int func_457(int iParam0)//Position - 0x37A0D
{
	if (func_456(iParam0, 0))
	{
...
int func_458(int iParam0, int iParam1)//Position - 0x37A30
{
	int iVar0;
...
int func_459(var uParam0)//Position - 0x37A7D
{
	if (func_460(uParam0))
	{
...
int func_460(var uParam0)//Position - 0x37AB2
{
	if (uParam0->f_12.f_66 == 0)
	{
		return 0;
	}
	if (!func_286(uParam0->f_12.f_66, 0, -1))
	{
		return 0;
	}
...
bool func_461()//Position - 0x37B12
{
	return func_459(&(Global_107196.f_2890));
}

void func_462()//Position - 0x37B25
{
	func_463(&(Global_107196.f_2890));
}

void func_463(var uParam0)//Position - 0x37B38
{
	if (func_460(uParam0))
	{
...
int func_464(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x37B56
{
	...
	if (iParam2 == 0 && func_466(Global_107196.f_2890.f_12.f_66))
	{
		return 0;
	}
...
int func_466(int iParam0)//Position - 0x37C59
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_467()//Position - 0x37CB2
{
	return func_460(&(Global_107196.f_2890));
}

int func_468()//Position - 0x37CC5
{
...
void func_469()//Position - 0x37CE9
{
	iLocal_142 = 0;
	iLocal_143 = 0;
	iLocal_147 = -1;
...
void func_470()//Position - 0x37D16
{
	Global_94859 = 1;
}

void func_471()//Position - 0x37D23
{
	func_342();
	if (func_484())
	{
	...
	func_472(&Local_81, 1, 0, 0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_472(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x37D47
{
	func_480(uParam0, iParam1);
	func_475(uParam0, bParam2);
	func_473(uParam0, bParam3);
}

void func_473(var uParam0, bool bParam1)//Position - 0x37D67
{
	func_474(&(uParam0->f_41), bParam1);
}

void func_474(var uParam0, bool bParam1)//Position - 0x37D79
{
	int iVar0;
...
void func_475(var uParam0, bool bParam1)//Position - 0x37DB7
{
	func_476(&(uParam0->f_35), bParam1);
}

void func_476(var uParam0, bool bParam1)//Position - 0x37DC9
{
	int iVar0;
...
void func_477(int* iParam0)//Position - 0x37E06
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_478(int* iParam0)//Position - 0x37E3E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_479(int iParam0)//Position - 0x37EDA
{
	if (func_11(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_480(var uParam0, int iParam1)//Position - 0x37F04
{
	func_481(&(uParam0->f_28), iParam1);
}

void func_481(var uParam0, int iParam1)//Position - 0x37F16
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_482(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_482(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x37F57
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_483()//Position - 0x37FA7
{
	if (CAM::IS_GAMEPLAY_HINT_ACTIVE())
	{
		CAM::STOP_GAMEPLAY_HINT(false);
...
void func_485(bool bParam0)//Position - 0x38071
{
	int iVar0;
	...
	if (!func_502())
	{
		...
		{
			func_187(iVar0, 1, 0);
			func_486(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_112735[iVar0 /*10*/].f_9 == -1)
...
void func_486(char* sParam0, int iParam1)//Position - 0x38141
{
	if (Global_100681 != 12)
	{
...
int func_487(char* sParam0, int iParam1, int iParam2)//Position - 0x38169
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_493())
	{
		...
		{
			iVar33 = func_488(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_488(char* sParam0)//Position - 0x382F8
{
...
int func_489()//Position - 0x38352
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_490(&(Global_100681.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_490(char* sParam0, bool bParam1)//Position - 0x38376
{
	int iVar0;
	int iVar1;
	
	iVar0 = MISC::GET_HASH_KEY(sParam0);
	iVar1 = func_491(iVar0, 1);
	if (iVar1 == -1 && !bParam1)
	{
	}
	return iVar1;
...
int func_491(int iParam0, bool bParam1)//Position - 0x383A0
{
	int iVar0;
...
int func_493()//Position - 0x38426
{
	...
	{
		if (func_488(&(Global_100681.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_494(bool bParam0)//Position - 0x38492
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_495(int iParam0)//Position - 0x384A6
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_496(int iParam0)//Position - 0x384E0
{
	if (iParam0 == 1)
	{
...
void func_497()//Position - 0x3851A
{
	Global_23131.f_5 = 1;
}

void func_498()//Position - 0x38528
{
	Global_23131.f_5 = 0;
}

void func_499(bool bParam0)//Position - 0x38536
{
	if (bParam0)
	{
		func_500();
...
void func_500()//Position - 0x38599
{
...
void func_501()//Position - 0x385C2
{
	Global_94857 = 0;
	Global_94858 = 0;
}

int func_502()//Position - 0x385D4
{
	if (((Global_100681 == 13 || Global_100681 == 10) || Global_100681 == 11) || Global_100681 == 12)
	{
		return 0;
...
void func_503()//Position - 0x38612
{
	Global_100716 = 1;
...
void func_504(char* sParam0)//Position - 0x38705
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_505(var uParam0)//Position - 0x38717
{
	func_506(&(uParam0->f_28));
	func_506(&(uParam0->f_35));
	func_506(&(uParam0->f_41));
}

void func_506(var uParam0)//Position - 0x38737
{
	int iVar0;
