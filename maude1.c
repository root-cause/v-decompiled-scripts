...
void __EntryFunction__()//Position - 0x0
{
	...
	func_521(&Local_79);
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_79.f_59))
	{
		PED::TAKE_OWNERSHIP_OF_SYNCHRONIZED_SCENE(Local_79.f_59);
		iLocal_145 = Local_79.f_59;
	}
...
void func_1()//Position - 0x11F
{
	...
	switch (iLocal_141)
	{
		case 0:
			...
			{
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_153, false);
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_154))
			{
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_154, false);
			}
			if (iLocal_142 == 1)
			{
				...
				if (func_17(iLocal_156))
				{
					...
					func_15(iLocal_156, 0);
					if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_156))
					{
						if (func_14(iLocal_156, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 35f, 1))
						{
							AUDIO::STOP_PED_SPEAKING(iLocal_156, false);
			...
			else if (iLocal_142 == 1)
			{
				if (func_17(iLocal_156))
				{
					...
					else if (func_17(iLocal_156))
					{
						...
						{
							if (!PED::IS_PED_FLEEING(iLocal_156))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_156, "special_ped@maude@exit_flee", "female_Flee_Table_Left_Maude", 3))
								{
									PED::SET_PED_FLEE_ATTRIBUTES(iLocal_156, 2, false);
									PED::SET_PED_FLEE_ATTRIBUTES(iLocal_156, 64, false);
									PED::SET_PED_FLEE_ATTRIBUTES(iLocal_156, 128, false);
									PED::SET_PED_FLEE_ATTRIBUTES(iLocal_156, 8, false);
									PED::SET_PED_FLEE_ATTRIBUTES(iLocal_156, 1, false);
									PED::SET_PED_FLEE_ATTRIBUTES(iLocal_156, 32, false);
									PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_156, 5, false);
									PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_156, 17, true);
									TASK::TASK_SMART_FLEE_PED(iLocal_156, PLAYER::PLAYER_PED_ID(), 50f, -1, false, false);
...
int func_2(int iParam0, int iParam1)//Position - 0x2DF
{
	if (func_17(iParam0))
	{
...
void func_4(int* iParam0)//Position - 0x350
{
...
void func_5(int* iParam0, bool bParam1)//Position - 0x37B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_6(int* iParam0)//Position - 0x3B6
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_10()//Position - 0x477
{
	int iVar0;
	
	if (func_17(iLocal_156))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_156, "special_ped@maude@base", "base", 3))
		{
			if (!PED::IS_PED_RAGDOLL(iLocal_156) || TASK::IS_PED_GETTING_UP(iLocal_156))
			{
				STREAMING::REQUEST_ANIM_DICT("special_ped@maude@exit_flee");
				if (STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@exit_flee"))
				{
					...
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_156, -1000f, true);
					}
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_156, iLocal_148, "special_ped@maude@exit_flee", "female_Flee_Table_Left_Maude", 1000f, -4f, 4626, 0, 1000f, 0);
					PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_156, false, false);
					if (func_11(iLocal_152))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_152, "special_ped@maude@base", "base_chair", 3))
						{
							ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_152, -16f, false);
						}
						iVar0 = 0;
						iVar0 += 16;
						iVar0 += 64;
						iVar0 += 512;
						iVar0 += 4096;
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_152, iLocal_148, "Female_Flee_Table_Left_Maude_Chair", "special_ped@maude@exit_flee", 16f, -4f, iVar0, 1000f);
					}
					return 1;
				}
			}
...
int func_11(int iParam0)//Position - 0x5A8
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_12(int iParam0, char* sParam1, char* sParam2, int iParam3, bool bParam4)//Position - 0x5C9
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_13(iParam3), bParam4);
}

int func_13(int iParam0)//Position - 0x5E3
{
	int iVar0;
...
bool func_14(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x7D8
{
...
int func_17(int iParam0)//Position - 0x886
{
	if (func_11(iParam0))
	{
	...
	switch (iLocal_141)
	{
		case 0:
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_154))
			{
				...
				{
					iLocal_154 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2727.4f, 4145.56f, 43.68f, 10f, joaat("prop_table_03b"), true, false, true);
					if (func_11(iLocal_154))
					{
						ENTITY::SET_ENTITY_COORDS(iLocal_154, 2727.4f, 4145.56f, 43.68f, true, false, false, true);
						ENTITY::SET_ENTITY_HEADING(iLocal_154, -92.17f);
						ENTITY::FREEZE_ENTITY_POSITION(iLocal_154, true);
					}
				}
			}
			if (func_17(iLocal_156))
			{
				if (!PED::IS_PED_HEADTRACKING_PED(iLocal_156, PLAYER::PLAYER_PED_ID()))
				{
					TASK::TASK_LOOK_AT_ENTITY(iLocal_156, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				}
				PED::SET_PED_KEEP_TASK(iLocal_156, true);
			}
		...
		case 1:
			...
			if (func_17(iLocal_156))
			{
				Var0 = { ENTITY::GET_ENTITY_COORDS(iLocal_156, false) };
				if (!func_247(0))
				{
					if (SYSTEM::VDIST2(Var0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) > 14400f)
					{
						if (!CAM::IS_SPHERE_VISIBLE(Var0, 2.5f) || ENTITY::IS_ENTITY_OCCLUDED(iLocal_156))
						{
							iLocal_141 = 2;
						}
					}
					...
					{
						func_243(Var0, Var3, 18000, 1101004800);
					}
				}
				else
				{
			...
			else if (ENTITY::DOES_ENTITY_EXIST(iLocal_156))
			{
				iLocal_142 = 0;
				iLocal_140 = 2;
				iLocal_141 = 0;
...
{
	func_239("BBONDS_UNLOCK" /* GXT: Bail bond missions are now available. Trevor will receive emails from Maude with further details. */, 1, 0, -1, 10000, 4, 0, 0, 1);
	func_230(62, 2, 1);
	func_29(107, 1);
	func_487();
}
...
void func_29(int iParam0, bool bParam1)//Position - 0xBD9
{
	...
	{
		func_201(&(Global_113222[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
	...
	func_186(0, 0);
	MemCopy(&sVar1, {func_184(iVar0)}, 4);
	func_181(&sVar1, func_182());
	func_57();
...
int func_31(bool bParam0)//Position - 0xD58
{
...
void func_36(int iParam0, bool bParam1, int iParam2)//Position - 0x1380
{
	if (iParam2 == -1)
	{
		iParam2 = func_37();
...
int func_58(int iParam0, int iParam1, int iParam2)//Position - 0x1E4C
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	Global_79322[1 /*14*/] = { func_111(iVar0, iParam1, iParam2, -1) };
	...
	{
		uVar31 = { func_107(iVar0, 0) };
		Global_79322[1 /*14*/] = { func_111(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_103(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_103(iParam1), Global_79322[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_103(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, 0);
		}
	}
	if (func_102(iParam0, iVar0, &iVar48, 0))
	{
...
int func_59(int iParam0, int iParam1, int iParam2)//Position - 0x2009
{
	int iVar0;
	...
	{
		if (!func_176(iParam0, Global_114135.f_2367.f_539[iVar0 /*65*/].f_64, Global_114135.f_2367.f_539[iVar0 /*65*/].f_63))
		{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x20E5
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_79322[1 /*14*/] = { func_111(iVar10, iParam1, iParam2, -1) };
		if (!func_101(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_79322[1 /*14*/] = { func_111(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_79322[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						{
							uVar28 = { func_104(iVar10, uVar11[iVar0]) };
						}
						iVar1 = 0;
						while (iVar1 <= 8)
						{
							Global_79322[1 /*14*/] = { func_111(iVar10, 14, uVar28[iVar1], -1) };
							func_77(iParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
							func_93(14);
							if (Global_79320 == 1)
							{
								iVar2 = 0;
			...
			{
				Global_79322[1 /*14*/] = { func_111(iVar10, iVar0, func_67(iParam0, iVar0, -1), -1) };
		...
		if (iParam7 == 1)
		{
			Var55 = { func_111(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var55 = { func_111(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var55 = { func_111(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var55 = { func_111(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var55 = { func_111(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	{
		uVar69 = { func_104(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
			Global_79322[1 /*14*/] = { func_111(iVar10, 14, uVar69[iVar1], -1) };
			func_77(iParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
			func_93(14);
			if (Global_79320 == 1)
			{
...
int func_63(int iParam0, int iParam1, int iParam2)//Position - 0x2980
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x2A86
{
	var uVar0;
	int iVar10;
...
int func_66(int iParam0, int iParam1, int iParam2)//Position - 0x308A
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_67(int iParam0, int iParam1, int iParam2)//Position - 0x3123
{
	int iVar0;
	int iVar1;
...
int func_68(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x31C4
{
	int iVar0;
...
int func_69(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x34CB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x4080
{
	int iVar0;
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4662
{
	int iVar0;
...
int func_74(int iParam0, int iParam1, int iParam2)//Position - 0x468B
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4955
{
	int iVar0;
...
void func_77(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4D36
{
	int iVar0;
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4DD0
{
	switch (iParam0)
	{
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4E9E
{
	...
	else
	{
		...
		iVar36 = (iParam1 - func_80(iParam0, func_103(iParam2)));
		if (iVar36 < 0)
		{
			return -1;
		}
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x53C0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_83(int iParam0, int iParam1)//Position - 0x54BC
{
	int iVar0;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x55FA
{
	...
	else
	{
		...
		if (iVar18 != -1)
		{
			return (func_80(iParam0, func_103(iParam2)) + iVar18);
		}
	}
	return -99;
}
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x579A
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 14, 3), joaat("HAT_MENU"), 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 1, 3), joaat("HAT_MENU"), 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 14, 4), joaat("HAT_MENU"), 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 1, 4), joaat("HAT_MENU"), 0));
					}
					break;
			}
			break;
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5A17
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5E3C
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_90(int iParam0, int iParam1)//Position - 0x612F
{
	int iVar0;
	int iVar1;
...
int func_91(int iParam0, int iParam1)//Position - 0x6176
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x61D6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_94(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x62D9
{
	...
	{
		iVar3 = func_98(iVar2, iVar0);
		MISC::SET_BIT(&iVar3, iVar1);
		func_95(iVar2, iVar3, iVar0, 1);
	}
}
...
int func_96(int iParam0, var uParam1)//Position - 0x634F
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_97(uParam1));
}

int func_97(var uParam0)//Position - 0x6364
{
	int iVar0;
	int iVar1;
...
int func_100(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8FED
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_101(int iParam0)//Position - 0x9E90
{
	if (!BitTest(Global_79322[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9ED8
{
	int iVar0;
	...
	{
		if (!func_176(iParam0, Global_114135.f_2367.f_539[iVar0 /*65*/].f_61, Global_114135.f_2367.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA962
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_106(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xAA8C
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_110(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[0], Global_114135.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_110(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[1], Global_114135.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_110(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[2], Global_114135.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_109(Var16.f_2)] = Var16.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_109(Var16.f_2)] = func_84(iParam1, Var16.f_0, func_109(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
					(*uParam0)[func_109(Var16.f_2)] = Var16.f_1;
				}
			}
			iVar36++;
		}
...
void func_113(int iParam0)//Position - 0xCD6A
{
	...
	func_114(&(Global_79322[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_114(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xDFE1
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_98(func_117(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_98(func_116(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_98(iVar1, Global_79319);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_118(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xEF7E
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF09E
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_114(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_114(&(Global_79322[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_114(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79520)
		{
			...
			func_114(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_176(int iParam0, int iParam1, int iParam2)//Position - 0x205FB
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_176(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar22 = { func_104(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
							if (!func_176(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_79322[2 /*14*/] = { func_111(iVar0, 14, iVar4, -1) };
									if (Global_79322[2 /*14*/].f_12 == iVar3)
									{
										if (func_176(iParam0, 14, iVar4))
										{
											if (!func_65(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_79322[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_79322[2 /*14*/] = { func_111(iVar0, iVar2, iVar1, -1) };
						if (!func_65(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_79322[2 /*14*/])))
						{
							return 0;
						}
					}
...
int func_177(int iParam0)//Position - 0x20854
{
	int iVar0;
	int iVar1;
...
int func_178(int iParam0)//Position - 0x20891
{
	if (func_180(iParam0))
	{
...
var func_179(int iParam0)//Position - 0x208B6
{
	return Global_2201[iParam0 /*29*/];
}

bool func_180(int iParam0)//Position - 0x208C5
{
	return iParam0 < 3;
}

void func_181(char* sParam0, var uParam1)//Position - 0x208D1
{
...
void func_183()//Position - 0x20968
{
	...
	{
		if (func_178(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_177(PLAYER::PLAYER_PED_ID());
			if (func_180(iVar0) && (!func_119(14) || Global_113083))
			{
				if (Global_114135.f_2367.f_539.f_4321 != iVar0 && func_180(Global_114135.f_2367.f_539.f_4321))
				{
...
void func_188(int iParam0, bool bParam1, bool bParam2)//Position - 0x20FCF
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&sVar32, {func_185(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&sVar32, 0, Global_101725, 0);
		func_189(&sVar32, Var0.f_3, Global_101725, bParam1, bParam2);
	}
}

void func_189(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x2100E
{
...
void func_190(int iParam0, var uParam1)//Position - 0x21052
{
	switch (iParam0)
	{
		...
		case 5:
			func_191(uParam1, "Barry3A", func_184(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_192(iParam0), 0, 1);
			break;
		...
		case 8:
			func_191(uParam1, "Dreyfuss1", func_184(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_192(iParam0), 0, 0);
			break;
		...
		case 38:
			func_191(uParam1, "Nigel1A", func_184(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_192(iParam0), 1, 1);
			break;
		...
		case 49:
			func_191(uParam1, "Paparazzo3A", func_184(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_192(iParam0), 0, 1);
			break;
		...
		case 58:
			func_191(uParam1, "Tonya1", func_184(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_192(iParam0), 0, 1);
			break;
...
void func_194()//Position - 0x225F0
{
	...
	{
		func_183();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_195(Global_114135.f_2367.f_539.f_4321));
	}
	else
	{
...
char* func_195(var uParam0)//Position - 0x22622
{
	uParam0 = uParam0;
	return "";
}
...
void func_196()//Position - 0x22631
{
	...
	if (MISC::IS_XBOX360_VERSION() || func_198())
	{
		NETWORK::NETWORK_SET_RICH_PRESENCE(StackVal, 0, 0, 0);
	}
	else if ((MISC::IS_PS3_VERSION() || func_197()) || MISC::IS_PC_VERSION())
	{
...
void func_201(var uParam0)//Position - 0x226F6
{
	if (*uParam0 == -1)
	{
		return;
...
void func_206(var uParam0, bool bParam1)//Position - 0x22C89
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_211(int iParam0, int iParam1)//Position - 0x230AD
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_212(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x230CD
{
	if (iParam0 != 198)
	{
		if (Global_79539)
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (!func_225(iParam0))
		{
			...
			if (!bParam1)
			{
				...
				if (!func_222(68))
				{
					func_239("DI_HLP_STRY" /* GXT: Story characters become available in Rockstar Editor's Director Mode as the GTAV story progresses. */, 2, 0, 20000, 10000, 7, 0, 208, 0);
				}
			}
		}
	}
...
int func_222(int iParam0)//Position - 0x2787D
{
	int iVar0;
	int iVar1;
...
int func_225(int iParam0)//Position - 0x27AB4
{
...
int func_227(char* sParam0)//Position - 0x27B1B
{
	int iVar0;
...
int func_229(char* sParam0, int iParam1)//Position - 0x27B8C
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_230(int iParam0, int iParam1, bool bParam2)//Position - 0x27BD5
{
	int iVar0;
		...
		if (bParam2)
		{
			if (!Global_79539)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9595[iParam1 /*4*/] = { func_232(iParam0) };
					...
					{
						Global_9546[1 /*6*/] = { func_232(iParam0) };
...
struct<4> func_232(int iParam0)//Position - 0x27DCE
{
	return Global_2201[iParam0 /*29*/].f_3;
}

int func_233(int iParam0, int iParam1)//Position - 0x27DE1
{
...
int func_234(int iParam0, int iParam1)//Position - 0x27E0B
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_235(int iParam0, int iParam1, int iParam2)//Position - 0x27E35
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_236(int iParam0, int iParam1, int iParam2)//Position - 0x27E7A
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_237()//Position - 0x27EBF
{
	if (func_119(14))
	{
...
void func_240(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x27F9B
{
	int iVar0;
...
bool func_242(char* sParam0, int iParam1, char* sParam2)//Position - 0x28287
{
...
int func_243(struct<3> Param0, struct<3> Param3, int iParam6, float fParam7)//Position - 0x282A5
{
	if (iLocal_151 < iLocal_149)
	{
		if (!func_20())
		{
			if (SYSTEM::VDIST2(Param3, Param0) < (fParam7 * fParam7))
			{
				...
				{
					func_246(&uLocal_161, 3, iLocal_156, "MAUDE", 0, 1);
					func_244(&uLocal_161, "MAUDEAU", "MAUDE_loiter", 7, 0, 0);
					iLocal_150 = MISC::GET_GAME_TIMER();
					iLocal_151++;
					return 1;
				}
...
void func_244(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2831F
{
...
void func_246(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x283B0
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
int func_247(bool bParam0)//Position - 0x2844B
{
	if (func_17(iLocal_156))
	{
		if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_156) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(iLocal_156)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(iLocal_156))
		{
			return 1;
		}
		if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_152))
				{
					return 1;
				}
			}
		...
		if (PED::HAS_PED_RECEIVED_EVENT(iLocal_156, 61))
		{
			return 1;
		}
		if (PED::IS_PED_RAGDOLL(iLocal_156))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_156, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
			{
				return 1;
			}
		}
		if (PED::HAS_PED_RECEIVED_EVENT(iLocal_156, 51))
		{
			return 1;
		}
		...
		if (func_248(iLocal_156, 1, 0, 0, 0))
		{
			return 1;
		}
		if (FIRE::IS_EXPLOSION_IN_SPHERE(-1 /*EXP_TAG_DONTCARE*/, ENTITY::GET_ENTITY_COORDS(iLocal_156, true), 15f))
		{
			return 1;
		}
		if (PED::HAS_PED_RECEIVED_EVENT(iLocal_156, 73))
		{
			return 1;
		}
		if (bParam0)
...
int func_248(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x28590
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_249(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2868B
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_250(int iParam0, float fParam1)//Position - 0x28797
{
	var uVar0;
	struct<3> Var1;
...
int func_251(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x2882C
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_252(struct<3> Param0, struct<3> Param3)//Position - 0x288BA
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_253(struct<3> Param0)//Position - 0x288DB
{
	float fVar0;
	float fVar1;
...
int func_254(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2891A
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_255(int iParam0, float fParam1)//Position - 0x28962
{
	float fVar0;
	
	if (func_11(PLAYER::PLAYER_PED_ID()) && func_11(iParam0))
	{
		if (func_264(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_256(int iParam0, float fParam1)//Position - 0x289D8
{
	return func_257(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_257(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x289F0
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	
	iVar4 = func_263(iParam0, iParam1);
	if (!func_11(iParam0) || !func_11(iParam1))
	{
		if (iVar4 != -1)
		{
			func_262(&(Local_35[iVar4 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_258(&(Local_35[iVar4 /*4*/]), Var1, iParam1, &(Local_35[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar4 /*4*/].f_3) < iParam4);
}

int func_258(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x28AB1
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_259(int iParam0, int iParam1)//Position - 0x28BDD
{
	int iVar0;
...
int func_261(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x28CEC
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_263(int iParam0, int iParam1)//Position - 0x28D98
{
	int iVar0;
...
void func_265(char* sParam0, int iParam1, int iParam2)//Position - 0x28DFF
{
	iParam2 = iParam2;
	...
	switch (iLocal_141)
	{
		case 0:
			...
			if (func_11(iLocal_156))
			{
				...
				{
					CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED(sLocal_158, iLocal_156, 0);
				}
			}
			func_358();
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				if (func_355())
				{
					...
					{
						func_348(&Local_79, 0, 1);
						func_347(&iLocal_156, &(Local_79.f_28[0]));
						func_346(&iLocal_152, &(Local_79.f_41[0]));
						func_346(&iLocal_153, &(Local_79.f_41[1]));
						func_345();
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), sLocal_157, 0, 0, 0);
						if (func_11(iLocal_156))
						{
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_156, sLocal_158, 0, 0, 0);
						}
						if (func_11(iLocal_152))
						{
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_152, sLocal_159, 0, 0, 0);
						}
						if (func_11(iLocal_153))
						{
				...
				if (func_17(iLocal_156))
				{
					if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_158, 0) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_159, 0))
					{
						if (STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
						{
							...
							TASK::TASK_SYNCHRONIZED_SCENE(iLocal_156, iLocal_145, "special_ped@maude@base", "base", 1000f, -8f, 4688, 0, 1000f, 0);
							iVar0 = 0;
							iVar0 = 16;
							iVar0 = 64;
							iVar0 = 512;
							iVar0 = 4096;
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_152, iLocal_145, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar0, 1000f);
							PED::SET_PED_KEEP_TASK(iLocal_156, true);
						}
					}
				}
...
void func_267()//Position - 0x290D9
{
	...
	if (!func_11(iVar0))
	{
		iVar0 = VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(Local_327, 10f, 0, 16390);
		if (!func_11(iVar0))
		{
			return;
		}
...
void func_269(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x291C5
{
	if (bParam0)
	{
...
int func_273(var uParam0)//Position - 0x293C8
{
	int iVar0;
...
int func_274(int iParam0)//Position - 0x293EA
{
...
int func_276(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x29437
{
	int iVar0;
...
void func_280(int iParam0, bool bParam1, bool bParam2)//Position - 0x294E5
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				iLocal_78 = PED::ADD_SCENARIO_BLOCKING_AREA(Var0, Var3, false, true, true, true, 1);
...
void func_281()//Position - 0x295E6
{
	...
	Var3 = { 2719.126f, 4144.6914f, 47.88543f };
	fVar9 = 13f;
	Var6 = { 3f, 11f, 6f };
	if (func_337(Var6, 0))
	{
		func_331(Var0, Var3, fVar9, 2719.87f, 4143.46f, 43.46f, 261.91f, 1, 1, 1, 0, 0);
		func_282(2719.87f, 4143.46f, 43.46f, 261.91f, 0, 145);
		Local_327 = { 2719.87f, 4143.46f, 43.46f };
	}
	else
	{
		func_331(Var0, Var3, fVar9, 2710.6646f, 4149.075f, 42.7026f, 180.9488f, 1, 1, 1, 0, 0);
		func_282(2710.6646f, 4149.075f, 42.7026f, 180.9488f, 0, 145);
		Local_327 = { 2710.6646f, 4149.075f, 42.7026f };
	}
}

void func_282(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x296E1
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104696.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104696.f_4, false))
		{
			if (func_330(24) != Global_104696.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_327(ENTITY::GET_ENTITY_COORDS(Global_104696.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_283(Global_104696.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_283(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x2975C
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_317(iParam5, &Var0, Param1, fParam4, func_320(iParam0));
...
void func_285(int iParam0, int iParam1)//Position - 0x2999C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_286(int iParam0)//Position - 0x29B9E
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_301(iParam0, 0, 0)) || func_301(iParam0, 1, 0)) || func_301(iParam0, 2, 0)) || func_320(iParam0) != 145) || func_300(iParam0)) || func_299(iParam0)) || func_298(iParam0)) || func_297(iParam0)) || !func_287(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_299(iParam0))
		{
		}
...
int func_287(int iParam0)//Position - 0x29C7B
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_288(int iParam0, bool bParam1, int iParam2)//Position - 0x29E39
{
	int iVar0;
	struct<2> Var1;
	...
	else
	{
		...
		while (iVar0 < FILES::GET_NUM_DLC_VEHICLES())
		{
			if (FILES::GET_DLC_VEHICLE_DATA(iVar0, &Var1))
			{
				...
				{
					if ((func_198() || MISC::IS_PC_VERSION()) || func_197())
					{
					}
					else if (!func_293())
					{
...
int func_289(int iParam0)//Position - 0x29FBE
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_291(int iParam0, int iParam1)//Position - 0x2A0A1
{
	int iVar0;
	int iVar1;
...
int func_292()//Position - 0x2A2AA
{
	return 0;
}

int func_293()//Position - 0x2A2B3
{
	return 1;
}

int func_294()//Position - 0x2A2BC
{
	return 1;
}

int func_295()//Position - 0x2A2C5
{
...
int func_297(int iParam0)//Position - 0x2A396
{
	int iVar0;
	char* sVar1;
...
int func_298(int iParam0)//Position - 0x2A3DD
{
	int iVar0;
...
int func_299(int iParam0)//Position - 0x2A418
{
	int iVar0;
...
int func_300(int iParam0)//Position - 0x2A494
{
	int iVar0;
...
int func_301(int iParam0, int iParam1, bool bParam2)//Position - 0x2A57C
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_302(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2A5EA
{
...
var func_308(int iParam0)//Position - 0x2A8B4
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_309(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_309(bool bParam0, int iParam1, int iParam2)//Position - 0x2A8D6
{
	if (bParam0)
	{
		return iParam1;
...
int func_310(var uParam0)//Position - 0x2A8ED
{
	return uParam0 & 15;
}
...
int func_314(var uParam0, int iParam1)//Position - 0x2A9AB
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_321(Global_114135.f_32754.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_321(Global_114135.f_2367.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_321(Global_114135.f_2367.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_315(int iParam0, int iParam1)//Position - 0x2C09C
{
	struct<82> Var0;
...
void func_316(int iParam0, var uParam1, int iParam2)//Position - 0x2C0DE
{
	int iVar0;
...
void func_317(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x2C33A
{
	if (func_314(&(Global_78329.f_555[0 /*21*/]), iParam0))
	{
...
int func_320(int iParam0)//Position - 0x2C576
{
	int iVar0;
...
bool func_321(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2C5D9
{
	if (bParam6)
	{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_323(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_324(int iParam0, var uParam1, var uParam2)//Position - 0x2C97B
{
	int iVar0;
	int iVar1;
...
int func_325(int iParam0)//Position - 0x2CB6E
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_327(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x2CBB5
{
	int iVar0;
	
	iVar0 = func_328(Param0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_328(struct<3> Param0, int iParam3, int iParam4)//Position - 0x2CCCB
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_329(int iParam0)//Position - 0x2CD5A
{
...
void func_331(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x2CD8B
{
	func_332(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_332(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2CDB4
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_334(iVar0, Param0, Param3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_333(struct<3> Param0)//Position - 0x2D1AA
{
...
int func_334(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2D1D4
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_335(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var9) || func_335(Var18[0 /*3*/], Var18[1 /*3*/], Var9, Var15)) || func_335(Var18[0 /*3*/], Var18[1 /*3*/], Var12, Var15)) || func_335(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var12)) || func_335(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var9)) || func_335(Var18[1 /*3*/], Var18[3 /*3*/], Var9, Var15)) || func_335(Var18[1 /*3*/], Var18[3 /*3*/], Var12, Var15)) || func_335(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var12)) || func_335(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var9)) || func_335(Var18[3 /*3*/], Var18[2 /*3*/], Var9, Var15)) || func_335(Var18[3 /*3*/], Var18[2 /*3*/], Var12, Var15)) || func_335(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var12)) || func_335(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var9)) || func_335(Var18[2 /*3*/], Var18[0 /*3*/], Var9, Var15)) || func_335(Var18[2 /*3*/], Var18[0 /*3*/], Var12, Var15)) || func_335(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_335(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2D4CA
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_336(int iParam0)//Position - 0x2D57E
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
bool func_337(struct<3> Param0, int iParam3)//Position - 0x2D5E3
{
	return func_338(Global_104696.f_2890.f_12.f_66, Param0, iParam3);
}

int func_338(int iParam0, struct<3> Param1, int iParam4)//Position - 0x2D600
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_340(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x2D681
{
	int iVar0;
...
Vector3 func_342(int iParam0)//Position - 0x2D87B
{
...
void func_345()//Position - 0x2D8ED
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_155))
	{
		...
		if (func_14(PLAYER::PLAYER_PED_ID(), Var0, 150f, 1))
		{
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Var0, 10f, iVar3, false))
			{
				iLocal_155 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Var0, 10f, iVar3, true, false, true);
			}
		}
	}
}

void func_346(int* iParam0, var uParam1)//Position - 0x2D955
{
	*iParam0 = *uParam1;
	*uParam1 = 0;
}

void func_347(int* iParam0, var uParam1)//Position - 0x2D967
{
	*iParam0 = *uParam1;
	*uParam1 = 0;
}

void func_348(var uParam0, bool bParam1, bool bParam2)//Position - 0x2D979
{
	int iVar0;
...
int func_349(int iParam0, float fParam1, int iParam2)//Position - 0x2DA6F
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_352(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_352(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2DBB7
{
...
void func_353(int iParam0)//Position - 0x2DC0E
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_355()//Position - 0x2DD8B
{
	if ((func_484() || func_31(0)) || func_357())
	{
		return 1;
	}
	if (iLocal_146 == 0)
	{
		if (func_11(Local_79.f_28[0]))
		{
			if (!func_356(PLAYER::PLAYER_PED_ID(), Local_79.f_28[0], 7f, 1))
			{
				CAM::SET_GAMEPLAY_ENTITY_HINT(Local_79.f_28[0], 0f, 0f, 0f, true, -1, 2000, 2000, 0);
				...
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(PLAYER::PLAYER_PED_ID(), Local_79.f_28[0], 0f, 1.2f, 0f, 1f, -1, 0.1f, true);
				}
			...
			else
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_79.f_28[0], 0);
				}
				iLocal_147 = -1;
			}
			TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_79.f_28[0], 4000, 0, 2);
		}
		iLocal_146++;
	}
	else if (iLocal_146 == 1)
	{
		if ((iLocal_147 == -1 || (MISC::GET_GAME_TIMER() - iLocal_147) > 3000) || (func_11(Local_79.f_28[0]) && func_356(PLAYER::PLAYER_PED_ID(), Local_79.f_28[0], 4.5f, 1)))
		{
			return 1;
		}
	}
...
void func_359()//Position - 0x2DF28
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_352(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_364(int iParam0)//Position - 0x2E0BF
{
	if (iParam0 == 1)
	{
...
void func_367()//Position - 0x2E13B
{
	if (Global_95840)
	{
		func_381(&iLocal_326, 2662.6438f, 4284.5347f, 43.5787f, 19.8376f, 0, 0, 1, 0, 0, joaat("asterope"), 0, 145, 1);
	...
	else
	{
		...
		{
			func_381(&iLocal_326, 2704.0776f, 4152.2397f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
		}
...
int func_369(var uParam0)//Position - 0x2E2C1
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_77)
	{
		...
		case 1:
			if (!func_374(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_77 = 2;
...
int func_370(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x2E553
{
	if (func_371(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_371(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2E5AF
{
	int iVar0;
...
int func_372(var uParam0, int iParam1)//Position - 0x2E63D
{
	int iVar0;
...
void func_373(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x2E683
{
	func_4(iParam0);
...
int func_374(int iParam0)//Position - 0x2E6AA
{
	int iVar0;
...
int func_375(int iParam0)//Position - 0x2E6DB
{
	if (!func_180(iParam0))
	{
		return func_179(iParam0);
...
void func_380(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2E88B
{
	if (func_484())
	{
...
void func_381(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2E920
{
	int iVar0;
	...
	else if (iParam9 == 1)
	{
		...
		if (func_180(iParam12))
		{
			func_444(iParam12, 0);
			while (!func_382(iParam0, iParam12, Param1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_382(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2EAB4
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_114135.f_2367.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114135.f_2367.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114135.f_2367.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_435(iParam0, &(Global_114135.f_2367.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_114135.f_2367.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_114135.f_2367.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114135.f_2367.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114135.f_2367.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_435(iParam0, &(Global_114135.f_2367.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_114135.f_2367.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_383(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2F8D7
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_180(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_387(*iParam1, 0, &uVar0))
		{
			func_324(iParam1, &(Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_114135.f_20122[iParam0 /*43*/].f_31 = func_386(*iParam1);
				...
				func_384(Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_114135.f_20122[iParam0 /*43*/].f_1));
				...
				func_384(Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_114135.f_20122[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
float func_386(int iParam0)//Position - 0x31AC0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_387(int iParam0, bool bParam1, var uParam2)//Position - 0x31B70
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_430(iVar0, bParam1, uParam2) && !func_429(PLAYER::PLAYER_ID())) && !func_402(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_398(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if ((((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_395(iParam0)) && !bVar1) && !(func_394(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_393(PLAYER::PLAYER_ID()))) && !(func_392(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_388(PLAYER::PLAYER_ID())))
	{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_298(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_388(int iParam0)//Position - 0x31CFB
{
	if (iParam0 != func_391())
	{
		if (func_390(iParam0, 1, 1))
		{
			...
			{
				return func_389(Global_2657991[iParam0 /*467*/].f_324.f_8) == 30;
			}
		}
	}
	return 0;
...
int func_390(int iParam0, bool bParam1, bool bParam2)//Position - 0x3225E
{
	int iVar0;
...
int func_391()//Position - 0x322BE
{
	return -1;
}

int func_392(int iParam0)//Position - 0x322C7
{
...
int func_393(int iParam0)//Position - 0x322DE
{
	if (iParam0 != func_391())
	{
		if (func_390(iParam0, 1, 1))
		{
			if (Global_2657991[iParam0 /*467*/].f_324.f_8 != -1)
			{
				return func_389(Global_2657991[iParam0 /*467*/].f_324.f_8) == 11;
			}
		}
	}
	return 0;
...
int func_394(int iParam0)//Position - 0x32325
{
...
int func_395(int iParam0)//Position - 0x32367
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_396(int iParam0)//Position - 0x3242F
{
	if (iParam0 != func_391())
	{
		if (func_390(iParam0, 1, 1))
		{
			if (Global_2657991[iParam0 /*467*/].f_324.f_8 != -1)
			{
				return func_389(Global_2657991[iParam0 /*467*/].f_324.f_8) == 26;
			}
		}
	}
	return 0;
...
int func_397(int iParam0)//Position - 0x32476
{
	if (iParam0 != func_391())
	{
		if (func_390(iParam0, 1, 1))
		{
			if (Global_2657991[iParam0 /*467*/].f_324.f_8 != -1)
			{
				return func_389(Global_2657991[iParam0 /*467*/].f_324.f_8) == 13;
			}
		}
	}
	return 0;
...
int func_398(int iParam0)//Position - 0x324BD
{
	if (iParam0 != func_391())
	{
		if (func_390(iParam0, 1, 1))
		{
			if (Global_2657991[iParam0 /*467*/].f_324.f_8 != -1)
			{
				return func_389(Global_2657991[iParam0 /*467*/].f_324.f_8) == 7;
			}
		}
	}
	return 0;
...
int func_399(int iParam0)//Position - 0x32503
{
	bool bVar0;
	...
	if ((((!func_401(PLAYER::PLAYER_ID()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger")) && iParam0 != func_400(1)) && !bVar0)
	{
		return 0;
	}
	return 1;
...
int func_401(int iParam0)//Position - 0x325AE
{
	if (iParam0 != func_391())
	{
...
int func_402(int iParam0)//Position - 0x325D4
{
...
int func_403(int iParam0)//Position - 0x32603
{
	...
	if (func_406(PLAYER::PLAYER_ID()) && ((((!func_399(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("openwheel1"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("openwheel2"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("formula"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("formula2"))))
	{
		return 0;
	}
...
int func_404(int iParam0)//Position - 0x32771
{
	int iVar0;
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_395(iParam0)) || func_405(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_405(int iParam0)//Position - 0x327EE
{
	switch (iParam0)
	{
		case joaat("mule"):
...
int func_406(int iParam0)//Position - 0x3284A
{
	if (iParam0 == func_391())
	{
		return 0;
	}
	if (func_429(iParam0) && Global_2657991[iParam0 /*467*/].f_324.f_11 == iParam0)
	{
		return 1;
	}
	return 0;
...
int func_407(int iParam0, bool bParam1)//Position - 0x32883
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_409(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				if (Global_2739811.f_307 == iParam0)
				{
					return 1;
				}
				else if (func_408(iParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_408(int iParam0)//Position - 0x328DE
{
	int iVar0;
...
int func_409(int iParam0, int iParam1)//Position - 0x32917
{
	if (iParam1 == 0)
	{
...
int func_418(int iParam0, int iParam1)//Position - 0x32E12
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_419(int iParam0)//Position - 0x331F1
{
	if (PLAYER::PLAYER_ID() != func_391())
	{
		if (func_425() || func_424(PLAYER::PLAYER_ID()))
		{
			return 0;
		}
		if (((func_423(PLAYER::PLAYER_ID(), 1, 0) && Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_268.f_36 > 0) || BitTest(Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_268.f_34, 14)) || BitTest(Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_268.f_34, 11))
		{
			return 0;
		}
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("Player_Vehicle", 3))
		{
			if (DECORATOR::DECOR_EXIST_ON(iParam0, "Player_Vehicle"))
			{
				if (DECORATOR::DECOR_GET_INT(iParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
				{
					...
					{
						if (!func_420(iParam0) || ENTITY::GET_ENTITY_MODEL(iParam0) != Global_1586535[func_421() /*143*/].f_66)
						{
							return 1;
						}
					}
...
int func_420(int iParam0)//Position - 0x332ED
{
...
int func_423(int iParam0, bool bParam1, bool bParam2)//Position - 0x3332B
{
	if (iParam0 == func_391())
	{
		return 0;
...
int func_424(int iParam0)//Position - 0x3338F
{
...
int func_427(int iParam0)//Position - 0x333E6
{
	if (iParam0 != func_391())
	{
		if (func_390(iParam0, 1, 1))
		{
			if (Global_2657991[iParam0 /*467*/].f_324.f_8 != -1 && Global_2657991[iParam0 /*467*/].f_324.f_11 != func_391())
			{
				return func_389(Global_2657991[iParam0 /*467*/].f_324.f_8) == 5;
			}
		}
	}
	return 0;
...
int func_428(int iParam0)//Position - 0x33445
{
	if (iParam0 != func_391())
	{
		if (func_390(iParam0, 1, 1))
		{
			if (Global_2657991[iParam0 /*467*/].f_324.f_8 != -1 && Global_2657991[iParam0 /*467*/].f_324.f_11 != func_391())
			{
				return func_389(Global_2657991[iParam0 /*467*/].f_324.f_8) == 8;
			}
		}
	}
	return 0;
...
int func_429(int iParam0)//Position - 0x334A5
{
	if (iParam0 != func_391())
	{
		if (func_390(iParam0, 1, 1))
		{
			if (Global_2657991[iParam0 /*467*/].f_324.f_8 != -1)
			{
				return func_389(Global_2657991[iParam0 /*467*/].f_324.f_8) == 9;
			}
		}
	}
	return 0;
...
int func_430(int iParam0, bool bParam1, var uParam2)//Position - 0x334EC
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_398(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_431(int iParam0)//Position - 0x338E3
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_432(int iParam0, int iParam1)//Position - 0x33918
{
	int iVar0;
...
void func_433(int iParam0)//Position - 0x3399A
{
	if (!func_434(*iParam0))
	{
...
bool func_434(int iParam0)//Position - 0x339C5
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_435(int iParam0, var uParam1, var uParam2)//Position - 0x339D4
{
	int iVar0;
	int iVar1;
	...
	if (func_440(ENTITY::GET_ENTITY_MODEL(*iParam0)) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_438(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_438(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_437(iParam0);
	if (func_436(*iParam0))
	{
...
int func_436(int iParam0)//Position - 0x33BAD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_438(int iParam0, int iParam1)//Position - 0x33CE2
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		iVar0 = func_439(iParam0, 38) + 1;
		iVar1 = func_439(iParam0, 24) + 1;
...
int func_439(int iParam0, int iParam1)//Position - 0x33DCB
{
	int iVar0;
	...
	while (iVar0 >= 0 && func_441(iParam0, iParam1, iVar0))
	{
		iVar0 = (iVar0 - 1);
	}
	return iVar0;
...
int func_440(int iParam0)//Position - 0x33E2D
{
...
int func_441(int iParam0, int iParam1, int iParam2)//Position - 0x33E58
{
	if (!func_442() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_442()//Position - 0x33E7C
{
	return 0;
}

int func_443(var uParam0, int iParam1)//Position - 0x33E85
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_444(int iParam0, int iParam1)//Position - 0x33EC6
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98994[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98994[iVar0]) == func_315(iParam0, iParam1))
				{
...
void func_445(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x33F64
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_314(&(Global_78329.f_555[0 /*21*/]), iVar0))
		{
...
int func_447(int iParam0, int iParam1)//Position - 0x34124
{
	int iVar0;
	...
	return func_288(Global_114135.f_32754.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}
...
int func_449(struct<3> Param0, float fParam3)//Position - 0x341A2
{
	return func_450(&(Global_107680.f_2890), Param0, fParam3, 0);
}

int func_450(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x341BC
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_452(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x34532
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_454(iParam0, Global_78329.f_139[38], 0))
			{
				func_446(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_454(iParam0, Global_78329.f_139[43], 1))
			{
				func_446(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_321(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
int func_453(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x3473A
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_454(int iParam0, int iParam1, bool bParam2)//Position - 0x347B5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_455(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x34816
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_323(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_323(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_323(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					...
					{
						MISC::SET_BIT(&(uParam1->f_77), func_323(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("surfer3"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_323(iVar5));
				}
				iVar5++;
			}
		}
		...
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar6 <= 2)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_323(iVar6));
				}
				iVar6++;
			}
		}
		...
		if (((BitTest(uParam1->f_77, 15) || func_465(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_464())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if ((((func_457() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_400(1)))
		{
...
int func_456(int iParam0, float fParam1)//Position - 0x34F1B
{
	struct<3> Var0;
	float fVar3;
...
int func_458(var uParam0)//Position - 0x3501B
{
	int iVar0;
...
int func_459(int iParam0)//Position - 0x3503F
{
	int iVar0;
...
var func_460(int iParam0, int iParam1)//Position - 0x3505D
{
...
var func_462(var uParam0, var uParam1)//Position - 0x35089
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_463(int iParam0, int iParam1)//Position - 0x350AC
{
	int iVar0;
	int iVar1;
...
int func_465(int iParam0)//Position - 0x35135
{
	int iVar0;
...
int func_466(int iParam0)//Position - 0x35180
{
	if (!func_442() && func_467(iParam0))
	{
		return 1;
	}
	return 0;
...
int func_467(int iParam0)//Position - 0x351A0
{
	switch (iParam0)
	{
		case 161:
...
int func_468(int iParam0)//Position - 0x351F3
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (!func_474(PLAYER::PLAYER_ID(), -1))
		{
	...
	if (func_470(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
		{
...
int func_472(int iParam0, int iParam1)//Position - 0x352EC
{
	if (func_273(iParam0))
	{
...
int func_474(int iParam0, int iParam1)//Position - 0x3535C
{
	int iVar0;
...
int func_475(var uParam0)//Position - 0x353A9
{
	if (func_476(uParam0))
	{
...
int func_476(var uParam0)//Position - 0x353DE
{
...
int func_480(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x35482
{
...
int func_482(int iParam0)//Position - 0x35585
{
	switch (iParam0)
	{
		case joaat("police"):
...
void func_493(int* iParam0)//Position - 0x35781
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_494(int* iParam0)//Position - 0x357B9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_495(int iParam0)//Position - 0x35855
{
	if (func_11(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_497(var uParam0, int iParam1)//Position - 0x35891
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_498(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_498(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x358D2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_501(bool bParam0)//Position - 0x359EB
{
	...
	if (!func_518())
	{
		...
		{
			func_188(iVar0, 1, 0);
			func_502(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_113222[iVar0 /*10*/].f_9 == -1)
...
int func_503(char* sParam0, int iParam1, int iParam2)//Position - 0x35AE3
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_509())
	{
		...
		{
			iVar33 = func_504(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_505()//Position - 0x35CCC
{
	...
	iVar0 = func_506(&(Global_101688.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_507(int iParam0, bool bParam1)//Position - 0x35D1A
{
	int iVar0;
...
void func_510(bool bParam0)//Position - 0x35E0C
{
