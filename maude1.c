		...
		case 0:
			...
			if (iLocal_44 == 1)
			{
				...
				if (func_17(iLocal_58))
				{
					...
					{
						if (func_14(iLocal_58, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 35f, 1))
						{
		...
		case 1:
			...
			else if (iLocal_44 == 1)
			{
				if (func_17(iLocal_58))
				{
					...
					{
						if (!func_2(iLocal_58, joaat("SCRIPT_TASK_SMART_FLEE_PED")))
						{
		...
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_58, "special_ped@maude@base", "base", 3))
		{
			if (!PED::IS_PED_RAGDOLL(iLocal_58) || TASK::IS_PED_GETTING_UP(iLocal_58))
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@exit_flee"))
				{
					...
					if (func_2(iLocal_58, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE")))
					{
...
bool func_14(int iParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x7D6
{
...
int func_58(int iParam0, int iParam1, int iParam2)//Position - 0x1E48
{
	...
	else
	{
		...
		Global_78341[1 /*14*/] = { func_110(iVar0, iParam1, uVar6[iParam1], -1) };
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x20CC
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_110(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_110(iVar10, 14, uVar15[iVar1], -1) };
			func_77(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_93(14);
			if (Global_78339 == 1)
			{
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4E84
{
	...
	else
	{
		...
		iVar4 = (iParam1 - func_80(iParam0, func_102(iParam2)));
		if (iVar4 < 0)
		{
			return -1;
		}
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_102(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x55E0
{
	...
	else
	{
		...
		if (iVar4 != -1)
		{
			return (func_80(iParam0, func_102(iParam2)) + iVar4);
		}
	}
	return -99;
}
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.f_0 != 0 && Var2.f_0 != -1) && Var2.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_108(Var2.f_2)] = func_84(iParam1, Var2.f_0, func_108(Var2.f_2), iVar0);
					}
				}
				else if (Var2.f_1 != -1)
				{
...
void func_112(int iParam0)//Position - 0xC939
{
	...
	func_113(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_120(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEC71
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_113(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_113(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_102(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_187(int iParam0, bool bParam1, bool bParam2)//Position - 0x20AE4
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&sVar1, {func_184(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&sVar1, 0, Global_100718, 0);
		func_188(&sVar1, Var0.f_3, Global_100718, bParam1, bParam2);
	}
}
...
void func_190(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0x21D1C
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_242(struct<3> Param0, struct<3> Param1, int iParam2, float fParam3)//Position - 0x27A2E
{
	if (iLocal_53 < iLocal_51)
	{
		if (!func_20())
		{
			if (SYSTEM::VDIST2(Param1, Param0) < (fParam3 * fParam3))
			{
				...
				{
					func_245(&uLocal_63, 3, iLocal_58, "MAUDE", 0, 1);
					func_243(&uLocal_63, "MAUDEAU", "MAUDE_loiter", 7, 0, 0);
					iLocal_52 = MISC::GET_GAME_TIMER();
					iLocal_53++;
					return 1;
				}
...
int func_246(bool bParam0)//Position - 0x27BD4
{
	if (func_17(iLocal_58))
	{
		...
		if (func_254(iLocal_58, 1126825984))
		{
			return 1;
		}
		if (func_247(iLocal_58, 1, 0, 0, 0))
		{
			return 1;
		}
...
int func_250(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0x27FB5
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	{
		Var1 = { func_252(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_251(Var1, Var0);
...
float func_251(struct<3> Param0, struct<3> Param1)//Position - 0x28045
{
...
bool func_256(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2817B
{
	...
	iVar2 = func_262(iParam0, iParam1);
	if (!func_11(iParam0) || !func_11(iParam1))
	{
		if (iVar2 != -1)
		{
			func_261(&(Local_37[iVar2 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_257(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_257(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2823C
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
		...
		case 0:
			...
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				if (func_352())
				{
					...
					{
						func_346(&Local_41, 0, 1);
						func_345(&iLocal_58, &(Local_41.f_28[0]));
						func_344(&iLocal_54, &(Local_41.f_41[0]));
						func_344(&iLocal_55, &(Local_41.f_41[1]));
						func_343();
...
void func_279()//Position - 0x28D3D
{
	...
	if (func_335(Var2, 0))
	{
		func_329(Var0, Var1, fVar3, 2719.87f, 4143.46f, 43.46f, 261.91f, 1, 1, 1, 0, 0);
		func_280(2719.87f, 4143.46f, 43.46f, 261.91f, 0, 145);
		Local_229 = { 2719.87f, 4143.46f, 43.46f };
	}
	else
	{
		func_329(Var0, Var1, fVar3, 2710.6646f, 4149.075f, 42.7026f, 180.9488f, 1, 1, 1, 0, 0);
		func_280(2710.6646f, 4149.075f, 42.7026f, 180.9488f, 0, 145);
		Local_229 = { 2710.6646f, 4149.075f, 42.7026f };
	}
}

void func_280(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x28E38
{
	struct<3> Var0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104212.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104212.f_4, false))
		{
			if (func_328(24) != Global_104212.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_325(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_281(Global_104212.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}

void func_281(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x28EB3
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_315(iParam3, &Var0, Param1, fParam2, func_318(iParam0));
		func_282(iParam3, iParam0, 0);
	}
}
...
void func_315(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x2EEA7
{
	if (func_312(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
...
bool func_319(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x2F146
{
	if (bParam2)
	{
...
int func_325(struct<3> Param0, int iParam1, var uParam2, var uParam3)//Position - 0x2F722
{
	int iVar0;
	
	iVar0 = func_326(Param0, iParam1, 1);
	switch (iVar0)
	{
		case 0:
...
int func_326(struct<3> Param0, int iParam1, int iParam2)//Position - 0x2F838
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_329(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x2F8F8
{
	func_330(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_330(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x2F921
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_332(iVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_332(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x2FD41
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_333(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_333(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_333(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_333(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_333(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_333(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_333(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_333(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_333(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_333(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_333(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_333(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_333(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_333(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_333(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_333(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4))
		{
			return 1;
		}
	}
...
int func_333(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x30038
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_335(struct<3> Param0, int iParam1)//Position - 0x30151
{
	return func_336(Global_104212.f_2890.f_12.f_66, Param0, iParam1);
}

int func_336(int iParam0, struct<3> Param1, int iParam2)//Position - 0x3016E
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_338(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x301EF
{
	int iVar0;
...
int func_352()//Position - 0x308E8
{
	...
	if (iLocal_48 == 0)
	{
		...
		{
			if (!func_353(PLAYER::PLAYER_PED_ID(), Local_41.f_28[0], 7f, 1))
			{
	...
	{
		if ((iLocal_49 == -1 || (MISC::GET_GAME_TIMER() - iLocal_49) > 3000) || (func_11(Local_41.f_28[0]) && func_353(PLAYER::PLAYER_PED_ID(), Local_41.f_28[0], 4.5f, 1)))
		{
			return 1;
		}
	}
...
void func_364()//Position - 0x30C98
{
	if (Global_94858)
	{
		func_378(&iLocal_228, 2662.6438f, 4284.5347f, 43.5787f, 19.8376f, 0, 0, 1, 0, 0, joaat("asterope"), 0, 145, 1);
	...
	else
	{
		...
		{
			func_378(&iLocal_228, 2704.0776f, 4152.2397f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
		}
...
int func_367(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0x310B0
{
	if (func_368(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_368(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0x3110C
{
	int iVar0;
...
void func_370(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x311E0
{
	func_4(iParam0);
...
void func_377(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x313E8
{
	if (func_468())
	{
...
void func_378(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x3147D
{
	int iVar0;
	...
	else if (iParam7 == 1)
	{
		...
		if (func_179(iParam10))
		{
			func_429(iParam10, 0);
			while (!func_379(iParam0, iParam10, Param1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_379(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)//Position - 0x31611
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2.f_0, Param2, fParam3, true, true, false);
				...
				func_421(iParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_430(struct<3> Param0, float fParam1, bool bParam2)//Position - 0x366DA
{
	int iVar0;
...
int func_434(struct<3> Param0, float fParam1)//Position - 0x36917
{
	return func_435(&(Global_107196.f_2890), Param0, fParam1, 0);
}

int func_435(var uParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x36931
{
	int iVar0;
	struct<3> Var1;
	bool bVar2;
...
int func_437(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x36CA7
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_439(iParam0, uVar1[iVar3], 1) && func_438(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.5635f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_319(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
int func_438(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x36EAF
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_487(char* sParam0, int iParam1, int iParam2)//Position - 0x38169
{
	...
	if (func_493())
	{
		...
		{
			iVar2 = func_488(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
