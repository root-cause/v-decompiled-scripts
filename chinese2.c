			...
			switch (Local_2515[iVar0 /*6*/])
			{
				case 0:
					switch (Local_2515[iVar0 /*6*/].f_2)
					{
						...
						case 1:
							...
							if (func_74(iLocal_2506) && func_73(iLocal_2506, 1995.2018f, 3062.1565f, 46.0491f, 1) < 5f)
							{
				...
				case 22:
					switch (Local_2515[iVar0 /*6*/].f_2)
					{
						...
						case 0:
							iLocal_2678 = INTERIOR::GET_INTERIOR_AT_COORDS(2440.4924f, 4969.948f, 52.5247f);
							Local_2515[iVar0 /*6*/].f_2++;
							break;
				...
				case 7:
					if (Local_2515[iVar0 /*6*/].f_2 == 0)
					{
						...
						if (iVar2 != -1)
						{
							...
							{
								if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[iVar2 /*33*/], joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE")) == 7)
								{
									iVar2 = func_18(9);
									if (iVar2 != -1)
									{
				...
				case 17:
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2447.6714f, 4951.4385f, 43.255756f, 2454.6638f, 4957.856f, 47.891174f, 6.8125f, false, true, 0) && MISC::GET_GAME_TIMER() > Local_2515[iVar0 /*6*/].f_5)
					{
						if (HUD::DOES_BLIP_EXIST(iLocal_2677))
						{
							HUD::REMOVE_BLIP(&iLocal_2677);
				...
				case 20:
					...
					else if (!BitTest(Local_2515[iVar0 /*6*/].f_5, 2))
					{
						...
						if (!PED::IS_PED_INJURED(Local_755[iLocal_2885 /*33*/]))
						{
							...
							if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[iLocal_2885 /*33*/], joaat("SCRIPT_TASK_PLAY_ANIM")) == 2 || TASK::GET_SCRIPT_TASK_STATUS(Local_755[iLocal_2885 /*33*/], joaat("SCRIPT_TASK_PLAY_ANIM")) == 7)
							{
								MISC::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 2);
							}
					...
					else if (!BitTest(Local_2515[iVar0 /*6*/].f_5, 6))
					{
						...
						if (!PED::IS_PED_INJURED(Local_755[iLocal_2886 /*33*/]))
						{
							...
							if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[iLocal_2886 /*33*/], joaat("SCRIPT_TASK_PLAY_ANIM")) == 2 || TASK::GET_SCRIPT_TASK_STATUS(Local_755[iLocal_2886 /*33*/], joaat("SCRIPT_TASK_PLAY_ANIM")) == 7)
							{
								MISC::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 6);
							}
				...
				case 23:
					...
					{
						case 1:
							iLocal_2657[0] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2494.4958f, 4970.916f, 44.5112f, true, true, false);
							...
							iLocal_2657[2] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2494.8955f, 4970.4175f, 44.5475f, true, true, false);
							ENTITY::SET_ENTITY_ROTATION(iLocal_2657[2], -3.44f, 0f, 38.88f, 2, true);
							iLocal_2657[3] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2494.7954f, 4970.2456f, 44.5525f, true, true, false);
							...
							iLocal_2657[5] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2494.3716f, 4970.744f, 44.51f, true, true, false);
							ENTITY::SET_ENTITY_ROTATION(iLocal_2657[5], -3.44f, 0f, 38.88f, 2, true);
							iLocal_2657[6] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2494.3716f, 4971.092f, 44.4987f, true, true, false);
							ENTITY::SET_ENTITY_ROTATION(iLocal_2657[6], -3.44f, 0f, 38.88f, 2, true);
							iLocal_2657[7] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2493.7695f, 4971f, 44.6287f, true, true, false);
							ENTITY::SET_ENTITY_ROTATION(iLocal_2657[7], 3.955f, 0f, 139.68f, 2, true);
							iLocal_2657[8] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2493.9797f, 4971.2793f, 44.6038f, true, true, false);
							ENTITY::SET_ENTITY_ROTATION(iLocal_2657[8], 3.955f, 0f, 139.68f, 2, true);
							iLocal_2657[9] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2494.1042f, 4971.4375f, 44.5826f, true, true, false);
						...
						case 0:
							if (!ENTITY::DOES_ENTITY_EXIST(iLocal_2680) && !ENTITY::DOES_ENTITY_EXIST(iLocal_2681))
							{
								if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(2493.5f, 4969.2f, 43.9f, 1f, joaat("prop_barrel_pile_03"), false) && OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(2493.4f, 4971.8f, 43.6f, 1f, joaat("prop_pallet_pile_01"), false))
								{
									...
									iLocal_2681 = OBJECT::CREATE_OBJECT(joaat("prop_pallet_pile_01"), 2493.4275f, 4971.7285f, 43.543625f, true, true, false);
					...
					switch (Local_2515[iVar0 /*6*/].f_2)
					{
						...
						case 1:
							if (STREAMING::HAS_ANIM_DICT_LOADED("MISSChinese2_crystalMazeMCS1_IG"))
							{
								if (CUTSCENE::HAS_CUTSCENE_FINISHED() || !CUTSCENE::IS_CUTSCENE_PLAYING())
								{
									...
									{
										ENTITY::SET_ENTITY_COORDS(Local_755[13 /*33*/], 1986.0602f, 3051.7085f, 46.2151f, true, false, false, true);
									}
									if (ENTITY::DOES_ENTITY_EXIST(Local_755[14 /*33*/]) && !PED::IS_PED_INJURED(Local_755[14 /*33*/]))
									{
										ENTITY::SET_ENTITY_COORDS(Local_755[14 /*33*/], 1986.1051f, 3051.6592f, 46.2151f, true, false, false, true);
									}
									Local_2515[iVar0 /*6*/].f_2++;
								}
							}
						...
						case 2:
							if (TASK::DOES_SCENARIO_EXIST_IN_AREA(1984.89f, 3052.46f, 46.98f, 0.3f, true) && TASK::DOES_SCENARIO_EXIST_IN_AREA(1985.3221f, 3053.0872f, 46.98f, 0.3f, true))
							{
								...
								MISC::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 0);
								TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_755[13 /*33*/], 1985.3221f, 3053.0872f, 46.98f, 0.3f, 0);
						...
						case 3:
							...
							if (!PED::IS_PED_INJURED(Local_755[13 /*33*/]) && !PED::IS_PED_INJURED(Local_755[14 /*33*/]))
							{
								...
								{
									if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[13 /*33*/], joaat("SCRIPT_TASK_START_SCENARIO_IN_PLACE")) != 1)
									{
									...
									if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[14 /*33*/], joaat("SCRIPT_TASK_START_SCENARIO_IN_PLACE")) != 1)
									{
										if (TASK::DOES_SCENARIO_EXIST_IN_AREA(1985.3221f, 3053.0872f, 46.98f, 0.3f, true))
										{
											MISC::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 1);
											TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_755[14 /*33*/], 1985.3221f, 3053.0872f, 46.98f, 0.3f, 0);
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_755[14 /*33*/], false);
										}
									}
									else
...
void func_27()//Position - 0x6C5E
{
	...
	iLocal_2507 = VEHICLE::CREATE_VEHICLE(joaat("burrito"), 2479.5789f, 4980.503f, 44.8051f, 341.8158f, true, true, false);
	...
	if (iLocal_2511 == 7)
	{
		...
		Local_755[15 /*33*/] = PED::CREATE_PED(26, joaat("A_M_Y_MethHead_01"), 2436.9011f, 4959.0996f, 45.8106f, 209.7559f, true, true);
		...
		Local_755[17 /*33*/] = PED::CREATE_PED(26, joaat("A_M_M_Hillbilly_02"), 2443.4197f, 4974.5234f, 45.8106f, 121.834f, true, true);
		...
		Local_755[18 /*33*/] = PED::CREATE_PED(26, joaat("A_M_Y_MethHead_01"), 2448.8877f, 4971.5605f, 45.8106f, 194.7676f, true, true);
	...
	iLocal_2650 = OBJECT::CREATE_PICKUP(joaat("PICKUP_HEALTH_STANDARD"), 2446.8962f, 4990.972f, 45.5477f, iVar0, -1, true, 0);
	if (!PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(iLocal_2510))
	{
		iLocal_2510 = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(2464.9563f, 4990.051f, 44.48415f, 2.5f, 3.125f, 2.0625f, 0f, false, 7);
	}
	iLocal_2651[0] = OBJECT::CREATE_PICKUP_ROTATE(joaat("PICKUP_HEALTH_STANDARD"), 2444.4973f, 4975.956f, 50.565f, 0f, 0f, 100f, iVar0, -1, 2, true, 0);
	...
	MISC::SET_BIT(&iVar0, 1);
	MISC::SET_BIT(&iVar0, 3);
	iLocal_2651[2] = OBJECT::CREATE_PICKUP_ROTATE(joaat("PICKUP_WEAPON_SAWNOFFSHOTGUN"), 2438.7878f, 4970.7896f, 50.565f, 0f, 0f, 0f, iVar0, -1, 2, true, 0);
		...
		if ((!PED::IS_PED_INJURED(Local_755[iVar0 /*33*/]) && !PED::IS_PED_DEAD_OR_DYING(Local_755[iVar0 /*33*/], true)) || Local_1619[iVar0 /*24*/].f_3 == 1)
		{
			switch (Local_1619[iVar0 /*24*/].f_3)
			{
				case 1:
							...
							switch (Local_755[iVar0 /*33*/].f_2)
							{
								...
								case 4:
									if (iLocal_2511 == 3)
									{
										...
										{
											Local_755[iVar0 /*33*/].f_20 = OBJECT::CREATE_OBJECT(joaat("prop_cs_fertilizer"), 2460.098f, 4957.2827f, 44.1304f, true, true, false);
									...
									{
										func_106(&Local_1619, iVar0, Local_755[iVar0 /*33*/], 0, 0, 0);
										Local_755[iVar0 /*33*/].f_20 = OBJECT::CREATE_OBJECT(joaat("prop_cs_fertilizer"), 2478.4443f, 4976.9214f, 44.5614f, true, true, false);
										Local_755[iVar0 /*33*/].f_5 = 1;
								...
								case 5:
									if (iLocal_2511 == 3)
									{
										...
										{
											Local_755[iVar0 /*33*/].f_20 = OBJECT::CREATE_OBJECT(joaat("prop_cs_fertilizer"), 2455.7527f, 4952.7188f, 44.1445f, true, true, false);
											Local_755[iVar0 /*33*/].f_5 = 1;
											func_105(iVar0, 3, 0, 0);
										}
									}
									...
									{
										func_106(&Local_1619, iVar0, Local_755[iVar0 /*33*/], 0, 0, 0);
										Local_755[iVar0 /*33*/].f_20 = OBJECT::CREATE_OBJECT(joaat("prop_cs_fertilizer"), 2476.5815f, 4978.4917f, 44.5734f, true, true, false);
					...
					if (!PED::IS_PED_INJURED(Local_755[iVar0 /*33*/]))
					{
						ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_755[iVar0 /*33*/], true);
					...
					if (Local_1619[iVar0 /*24*/].f_3 <= 3)
					{
						switch (Local_755[iVar0 /*33*/].f_3)
						{
								...
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									case 0:
										if (ENTITY::DOES_ENTITY_EXIST(Local_755[iVar0 /*33*/].f_20))
										{
											...
											{
												ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_755[iVar0 /*33*/].f_20, Local_755[iVar0 /*33*/], PED::GET_PED_BONE_INDEX(Local_755[iVar0 /*33*/], 60309), 0f, 0f, 0f, 0f, 0f, 0f, true, true, false, false, 2, true, 0);
												Local_755[iVar0 /*33*/].f_5++;
											}
											if (ENTITY::DOES_ENTITY_EXIST(Local_755[iVar0 /*33*/].f_20))
											{
							...
							case 2:
								...
								{
									func_103(Local_755[iVar0 /*33*/], &(Local_755[iVar0 /*33*/].f_25), -1, 0, 1, 0, -1082130432, 0, -1, -1, 1, 0, 0);
								}
								...
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									...
									case 1:
										if (ENTITY::DOES_ENTITY_EXIST(Local_755[iVar0 /*33*/].f_20))
										{
											if (func_73(Local_755[iVar0 /*33*/], 2495.7786f, 5004.715f, 43.873367f, 1) < 99f)
											{
												if (Local_755[iVar0 /*33*/].f_2 == 4)
												{
													TASK::TASK_PLAY_ANIM(Local_755[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_B", 1000f, -1f, -1, 1, 0f, false, false, false);
									...
									case 2:
										...
										{
											Local_755[iVar0 /*33*/].f_6 = { 2466.9026f, 4996.254f, 45.5443f };
											Local_755[iVar0 /*33*/].f_5++;
										}
										break;
									...
									case 3:
										...
										{
											Local_755[iVar0 /*33*/].f_6 = { 2461.3323f, 4998.94f, 45.359f };
											Local_755[iVar0 /*33*/].f_5++;
										}
										break;
									...
									case 4:
										if (ENTITY::IS_ENTITY_AT_COORD(Local_755[iVar0 /*33*/], Local_755[iVar0 /*33*/].f_6, 1.5f, 1.5f, 2f, false, true, 0))
										{
											Local_755[iVar0 /*33*/].f_6 = { 2455.9841f, 4997.4043f, 45.2645f };
											Local_755[iVar0 /*33*/].f_5++;
										}
										break;
									...
									case 5:
										if (ENTITY::IS_ENTITY_AT_COORD(Local_755[iVar0 /*33*/], Local_755[iVar0 /*33*/].f_6, 1.5f, 1.5f, 2f, false, true, 0))
										{
											...
											{
												Local_755[iVar0 /*33*/].f_6 = { 2452.0906f, 4993.674f, 45.1404f };
												Local_755[iVar0 /*33*/].f_5++;
											}
											else
											{
												Local_755[iVar0 /*33*/].f_6 = { 2454.0906f, 4995.674f, 45.1404f };
												Local_755[iVar0 /*33*/].f_5++;
											}
										}
										break;
													...
													if (!VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_2507, 0, false))
													{
														...
														if (iVar1 >= 0)
														{
															if (!PED::IS_PED_INJURED(Local_755[iVar1 /*33*/]))
															{
																...
																{
																	func_99();
																	TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_2507, 2367.6677f, 5098.6445f, 46.8185f, 12f, 0, joaat("burrito"), 786599, 5f, 5f);
							...
							case 5:
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									...
									case 1:
										if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) == 7)
										{
							...
							case 6:
								if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], joaat("SCRIPT_TASK_START_SCENARIO_IN_PLACE")) == 7 && Local_755[iVar0 /*33*/].f_5 > 1)
								{
									Local_755[iVar0 /*33*/].f_5 = 0;
								}
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									...
									case 1:
										if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], joaat("SCRIPT_TASK_ACHIEVE_HEADING")) == 7)
										{
							...
							case 32:
								if (!PED::IS_PED_INJURED(Local_755[iVar0 /*33*/]))
								{
									...
									switch (Local_755[iVar0 /*33*/].f_5)
									{
										...
										case 12:
											if (PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), Local_755[iVar0 /*33*/]) && func_73(Local_755[iVar0 /*33*/], 2448.0027f, 4982.305f, 45.8519f, 1) < 10f)
											{
												if (MISC::GET_GAME_TIMER() > (Local_755[iVar0 /*33*/].f_14 - 3000))
												{
													TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_755[iVar0 /*33*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1f, 20000, 0.25f, 0, 40000f);
										...
										case 14:
											if (MISC::GET_GAME_TIMER() > Local_755[iVar0 /*33*/].f_14 || TASK::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) == 7)
											{
												Local_755[iVar0 /*33*/].f_5 = 0;
											}
											break;
										...
										case 16:
											if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], joaat("SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD")) == 7)
											{
												Local_755[iVar0 /*33*/].f_14 = MISC::GET_GAME_TIMER() + 3000;
							...
							case 7:
								...
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									...
									case 2:
										if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) == 7 || MISC::GET_GAME_TIMER() > Local_755[iVar0 /*33*/].f_15)
										{
									...
									case 4:
										if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], joaat("SCRIPT_TASK_SWAP_WEAPON")) == 7)
										{
											if (Local_755[iVar0 /*33*/].f_4 == 5)
											{
							...
							case 14:
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									...
									case 1:
										if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], joaat("SCRIPT_TASK_START_SCENARIO_IN_PLACE")) == 7)
										{
											Local_755[iVar0 /*33*/].f_5 = 0;
										}
										break;
							...
							case 25:
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									...
									case 1:
										if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], joaat("SCRIPT_TASK_USE_NEAREST_SCENARIO_TO_POS")) == 7)
										{
											Local_755[iVar0 /*33*/].f_5 = 0;
										}
										break;
							...
							case 28:
								...
								{
									case 0:
										if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_755[iVar0 /*33*/]) || (func_96(ENTITY::GET_ENTITY_COORDS(Local_755[iVar0 /*33*/], true), 1f, 1120403456) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2448.5833f, 4969.292f, 45.185604f, 2439.5383f, 4978.061f, 46.827618f, 5.75f, false, true, 0)))
										{
											TASK::TASK_HANDS_UP(Local_755[iVar0 /*33*/], 20000, 0, -1, 0);
							...
							case 30:
								...
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									...
									case 4:
										if (func_35("CHI2_DALE", 4, Local_755[iVar0 /*33*/], "ONEIL" /* GXT: O'Neil Way */, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
										{
											Local_755[iVar0 /*33*/].f_5++;
										}
									...
									case 7:
										if (func_35("CHI2_DALEG", 4, Local_755[iVar0 /*33*/], "ONEIL" /* GXT: O'Neil Way */, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
										{
											Local_755[iVar0 /*33*/].f_5++;
										}
										break;
									...
									case 10:
										if (!func_65())
										{
											if (func_35("CHI2_DALEA", 4, Local_755[iVar0 /*33*/], "ONEIL" /* GXT: O'Neil Way */, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
											{
												PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_755[iVar0 /*33*/], false);
												TASK::TASK_COMBAT_PED(Local_755[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
							...
							case 4:
								...
								if (Local_755[iVar0 /*33*/].f_2 == 8)
								{
									if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_755[iVar0 /*33*/].f_14))
									{
										if (Local_755[iVar0 /*33*/].f_5 == 0)
										{
											...
											{
												if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE")) == 1)
												{
								...
								{
									if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], joaat("SCRIPT_TASK_GO_STRAIGHT_TO_COORD")) == 7)
									{
										func_105(iVar0, 7, 0, 0);
									}
								}
					...
					if (Local_1619[iVar0 /*24*/].f_20)
					{
						switch (Local_755[iVar0 /*33*/].f_2)
						{
							...
							case 14:
								...
								{
									case 1:
										PED::SET_PED_ANGLED_DEFENSIVE_AREA(Local_755[iVar0 /*33*/], 2431.704f, 4961.6196f, 45.331356f, 2455.3765f, 4985.9336f, 48.68555f, 13.5625f, false, false);
										TASK::TASK_COMBAT_PED(Local_755[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
										PED::SET_PED_TARGET_LOSS_RESPONSE(Local_755[iVar0 /*33*/], 1);
							...
							case 15:
								...
								{
									case 1:
										PED::SET_PED_ANGLED_DEFENSIVE_AREA(Local_755[iVar0 /*33*/], 2437.982f, 4959.021f, 45.310574f, 2432.93f, 4961.9414f, 48.692562f, 3.1875f, false, false);
										TASK::TASK_COMBAT_PED(Local_755[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
										PED::SET_PED_TARGET_LOSS_RESPONSE(Local_755[iVar0 /*33*/], 1);
										Local_1619[iVar0 /*24*/].f_4++;
										break;
							...
							case 11:
								switch (Local_1619[iVar0 /*24*/].f_4)
								{
									case 1:
										...
										{
											PED::REMOVE_PED_DEFENSIVE_AREA(Local_755[iVar0 /*33*/], false);
											PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_755[iVar0 /*33*/], 2451.6775f, 4954.2515f, 44.988f, 3f, false, false);
											iLocal_1614++;
											Local_1619[iVar0 /*24*/].f_4++;
										}
										else
									...
									case 2:
										if (func_73(Local_755[iVar0 /*33*/], 2451.6775f, 4954.2515f, 44.988f, 1) < 3f)
										{
											PED::REMOVE_PED_DEFENSIVE_AREA(Local_755[iVar0 /*33*/], false);
											Local_1619[iVar0 /*24*/].f_4++;
										}
							...
							case 1:
								...
								{
									case 1:
										PED::SET_PED_ANGLED_DEFENSIVE_AREA(Local_755[iVar0 /*33*/], 2453.084f, 4969.897f, 50.442852f, 2460.9956f, 4977.822f, 53.380352f, 2.9375f, false, false);
										TASK::TASK_COMBAT_PED(Local_755[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
										PED::SET_PED_TARGET_LOSS_RESPONSE(Local_755[iVar0 /*33*/], 1);
										Local_1619[iVar0 /*24*/].f_4++;
										break;
							...
							case 0:
								...
								{
									case 1:
										PED::SET_PED_ANGLED_DEFENSIVE_AREA(Local_755[iVar0 /*33*/], 2442.9634f, 4964.2173f, 50.442852f, 2449.2507f, 4970.534f, 53.380352f, 2f, false, false);
										TASK::TASK_COMBAT_PED(Local_755[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
										PED::SET_PED_TARGET_LOSS_RESPONSE(Local_755[iVar0 /*33*/], 1);
										Local_1619[iVar0 /*24*/].f_4++;
										break;
							...
							case 2:
								...
								{
									case 1:
										PED::SET_PED_ANGLED_DEFENSIVE_AREA(Local_755[iVar0 /*33*/], 2461.3623f, 4976.084f, 50.442852f, 2448.7432f, 4988.7744f, 53.601433f, 2f, false, false);
										TASK::TASK_COMBAT_PED(Local_755[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
										PED::SET_PED_TARGET_LOSS_RESPONSE(Local_755[iVar0 /*33*/], 1);
										Local_1619[iVar0 /*24*/].f_4++;
										break;
...
int func_86(int iParam0)//Position - 0xC46B
{
	int iVar0;
	bool bVar1;
	...
	*iParam0 = MISC::GET_RANDOM_INT_IN_RANGE(0, 10);
	...
	while (!bVar1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_2657[*iParam0]) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_2657[*iParam0], 2495.017f, 4970.1704f, 44.218082f, 2493.5007f, 4971.556f, 45.40248f, 1.375f, false, true, 0))
		{
			return 1;
		}
		else
...
void func_87(bool bParam0)//Position - 0xC504
{
	iLocal_3491 = 0;
	if (bParam0)
	{
...
int func_88(char* sParam0)//Position - 0xC520
{
	struct<6> Var0;
...
struct<6> func_89()//Position - 0xC540
{
	struct<6> Var0;
...
bool func_90(char* sParam0, int iParam1, char* sParam2)//Position - 0xC564
{
...
void func_91()//Position - 0xC582
{
	Global_20591 = 0;
	func_92();
}

void func_92()//Position - 0xC592
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
int func_93(int iParam0)//Position - 0xC5B6
{
	int iVar0;
...
void func_94()//Position - 0xC606
{
	Global_20591 = 0;
	func_95();
}

void func_95()//Position - 0xC616
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_96(struct<3> Param0, float fParam3, float fParam4)//Position - 0xC637
{
...
int func_97(int iParam0, int iParam1)//Position - 0xC67F
{
	int iVar0;
...
void func_98(int iParam0, bool bParam1)//Position - 0xC6C9
{
	if (bParam1)
	{
...
void func_99()//Position - 0xC702
{
	TASK::OPEN_SEQUENCE_TASK(&iLocal_257);
}

void func_100(int iParam0)//Position - 0xC711
{
	...
	switch (Local_755[iParam0 /*33*/].f_2)
	{
		case 7:
			...
			{
				TASK::TASK_LOOK_AT_COORD(Local_755[iParam0 /*33*/], 2505.6335f, 4996.9937f, 46.6624f, 4000, 0, 2);
				MISC::SET_BIT(&(Local_755[iParam0 /*33*/].f_14), 0);
			}
			else if (Local_755[iParam0 /*33*/].f_15 > 8000 && !BitTest(Local_755[iParam0 /*33*/].f_14, 1))
			{
				TASK::TASK_LOOK_AT_COORD(Local_755[iParam0 /*33*/], 2472.2966f, 4962.6865f, 47.2297f, 6000, 0, 2);
		...
		case 5:
			...
			{
				TASK::TASK_LOOK_AT_COORD(Local_755[iParam0 /*33*/], 2494.6335f, 5001.9937f, 46.6624f, 7000, 0, 2);
				MISC::SET_BIT(&(Local_755[iParam0 /*33*/].f_14), 1);
			}
			else if (Local_755[iParam0 /*33*/].f_15 > 20000 && !BitTest(Local_755[iParam0 /*33*/].f_14, 2))
			{
				TASK::TASK_LOOK_AT_COORD(Local_755[iParam0 /*33*/], 2477.6335f, 4966.9937f, 46.6624f, 7000, 0, 2);
		...
		case 4:
			if (Local_755[iParam0 /*33*/].f_15 > 3000 && !BitTest(Local_755[iParam0 /*33*/].f_14, 0))
			{
				TASK::TASK_LOOK_AT_COORD(Local_755[iParam0 /*33*/], 2505.6335f, 4996.9937f, 46.6624f, 5000, 0, 2);
				MISC::SET_BIT(&(Local_755[iParam0 /*33*/].f_14), 0);
			}
			else if (Local_755[iParam0 /*33*/].f_15 > 10000 && !BitTest(Local_755[iParam0 /*33*/].f_14, 1))
			{
				TASK::TASK_LOOK_AT_COORD(Local_755[iParam0 /*33*/], 2461.4495f, 4977.4805f, 51.7483f, 6000, 0, 2);
				MISC::SET_BIT(&(Local_755[iParam0 /*33*/].f_14), 1);
			}
			else if (Local_755[iParam0 /*33*/].f_15 > 18000 && !BitTest(Local_755[iParam0 /*33*/].f_14, 2))
			{
				TASK::TASK_LOOK_AT_COORD(Local_755[iParam0 /*33*/], 2505.6335f, 4996.9937f, 46.6624f, 6000, 0, 2);
				MISC::SET_BIT(&(Local_755[iParam0 /*33*/].f_14), 2);
			}
			break;
	}
...
float func_101(float fParam0, float fParam1, float fParam2)//Position - 0xC9E7
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
float func_102(struct<2> Param0, float fParam2, struct<2> Param3, float fParam5, int iParam6)//Position - 0xCA0E
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_103(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)//Position - 0xCA73
{
	bool bVar0;
...
void func_104(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5)//Position - 0xCC67
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCCA3
{
...
void func_106(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCD37
{
...
int func_107(int iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6, bool bParam7, int iParam8)//Position - 0xCD72
{
	int iVar0;
	...
	ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_755[iParam0 /*33*/], true);
	PED::SET_PED_SHOULD_PLAY_DIRECTED_NORMAL_SCENARIO_EXIT(Local_755[iParam0 /*33*/], 0f, 0f, 0f);
	PED::SET_PED_SHOULD_IGNORE_SCENARIO_NAV_CHECKS(Local_755[iParam0 /*33*/], true);
	PED::SET_PED_SHOULD_PROBE_FOR_SCENARIO_EXITS_IN_ONE_FRAME(Local_755[iParam0 /*33*/], true);
	ENTITY::SET_ENTITY_HEALTH(Local_755[iParam0 /*33*/], 150, 0);
	return 1;
}

void func_108(int iParam0, bool bParam1)//Position - 0xD5A4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_109(var uParam0, var uParam1, struct<3> Param2, struct<3> Param5, struct<3> Param8, struct<3> Param11, struct<3> Param14, struct<3> Param17, struct<3> Param20, struct<3> Param23, struct<3> Param26, struct<3> Param29)//Position - 0xD63F
{
	if (iLocal_52 > 0)
	{
...
void func_110(var uParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, struct<3> Param10, struct<3> Param13, struct<3> Param16, struct<3> Param19)//Position - 0xD699
{
...
int func_111(char* sParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, char* sParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, char* sParam12, int iParam13)//Position - 0xD9A6
{
	func_64(sParam0, iParam1, iParam4, iParam7, iParam10);
...
void func_112(int iParam0, int iParam1, char* sParam2)//Position - 0xDA59
{
	int iVar0;
...
void func_113(var uParam0, var uParam1, struct<3> Param2, struct<3> Param5, struct<3> Param8)//Position - 0xDAB6
{
	int iVar0;
	float fVar1;
	int iVar2;
...
float func_114(float fParam0, float fParam1, float fParam2)//Position - 0xEB98
{
	if (fParam0 < fParam1)
	{
		return fParam1;
...
int func_115(int iParam0, var uParam1, char* sParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9, bool bParam12)//Position - 0xEBBC
{
...
int func_116(int iParam0, var uParam1, bool bParam2)//Position - 0xF020
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float func_117(int iParam0, int iParam1, int iParam2)//Position - 0xF112
{
	struct<3> Var0;
	struct<3> Var3;
...
float func_119(int iParam0, int iParam1)//Position - 0xF32D
{
...
float func_120(int iParam0, struct<3> Param1)//Position - 0xF35A
{
	float fVar0;
...
void func_121(var uParam0, struct<2> Param1, var uParam3, struct<2> Param4, var uParam6, struct<2> Param7, var uParam9, struct<2> Param10, var uParam12)//Position - 0xF398
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_122(int iParam0)//Position - 0xFBDC
{
...
struct<6> func_124()//Position - 0xFD75
{
	struct<6> Var0;
	int iVar6;
	int iVar7;
...
void func_127(int iParam0, bool bParam1)//Position - 0x100AB
{
	int iVar0;
...
void func_128(struct<3> Param0, bool bParam3)//Position - 0x10119
{
	if (iLocal_438 == 0)
	{
		bParam3 = false;
...
void func_129()//Position - 0x101A2
{
	int iVar0;
	int iVar1;
	float fVar2;
...
Vector3 func_130()//Position - 0x104B5
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
void func_131()//Position - 0x10526
{
	int iVar0;
...
void func_132()//Position - 0x105B4
{
	if (!iLocal_264)
	{
		iLocal_264 = 1;
...
void func_133()//Position - 0x105C7
{
	int iVar0;
	...
	if (iLocal_2511 >= 4)
	{
		...
		while (iVar0 < Local_755.f_0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_755[iVar0 /*33*/]))
			{
				...
				{
					func_103(Local_755[iVar0 /*33*/], &(Local_755[iVar0 /*33*/].f_25), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
				}
			}
...
void func_134(int* iParam0)//Position - 0x1067D
{
	bool bVar0;
	struct<8> Var1;
...
void func_135()//Position - 0x106EF
{
	int iVar0;
...
void func_136(char* sParam0)//Position - 0x107A1
{
...
void func_138(char* sParam0)//Position - 0x10829
{
	func_148(sParam0);
	func_139(0);
}

void func_139(int iParam0)//Position - 0x1083C
{
	int iVar0;
...
int func_140(int iParam0)//Position - 0x10881
{
	int iVar0;
	int iVar1;
...
void func_141(var uParam0, int iParam1)//Position - 0x10991
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_143(Global_113648.f_18535[iVar0], &Var2, &fVar5))
			{
...
void func_142(var uParam0)//Position - 0x10B57
{
	*uParam0 = -15;
}

int func_143(int iParam0, var uParam1, float fParam2)//Position - 0x10B65
{
	switch (iParam0)
	{
		case 11:
...
void func_144(int iParam0, bool bParam1)//Position - 0x114D4
{
	if (bParam1)
	{
...
void func_145()//Position - 0x11512
{
	Global_100716 = 1;
...
int func_147(bool bParam0)//Position - 0x11633
{
...
void func_148(char* sParam0)//Position - 0x1165B
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
...
void func_149()//Position - 0x1169B
{
	func_176(46, 52);
...
void func_150()//Position - 0x11729
{
	HUD::CLEAR_PRINTS();
	func_151(0, 0);
	func_457(0);
...
void func_151(bool bParam0, int iParam1)//Position - 0x11740
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_152(int iParam0)//Position - 0x11810
{
	switch (iParam0)
	{
		case 71:
...
int func_153(int iParam0, int iParam1)//Position - 0x1184E
{
...
void func_154()//Position - 0x11874
{
	struct<3> Var0;
...
void func_155(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x11CFE
{
	int iVar0;
	int iVar1;
								...
								if (!func_65())
								{
									if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) != 0)
									{
										if (!HUD::DOES_BLIP_EXIST(iLocal_2677))
										{
											HUD::CLEAR_PRINTS();
											func_7("FRMSHP", 7500, 1);
											iLocal_2677 = func_5(2454.8953f, 4950.8945f, 44.1488f, 0);
										}
									}
...
void func_156(char* sParam0, int iParam1, int iParam2)//Position - 0x12216
{
	iParam2 = iParam2;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
void func_157(char* sParam0, int iParam1)//Position - 0x1222F
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_158(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x12246
{
	bLocal_3118 = false;
	iLocal_3119 = 0;
...
int func_159(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x122A5
{
	switch (iParam2)
	{
		case 0:
...
void func_160(int iParam0)//Position - 0x123FE
{
	int iVar0;
...
int func_161(int iParam0)//Position - 0x1242A
{
	int iVar0;
...
int func_162(int iParam0)//Position - 0x1245D
{
	int iVar0;
...
void func_163(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x124B5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_165(int iParam0, int iParam1, int iParam2)//Position - 0x1393A
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_166(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x139C0
{
	bool bVar0;
	float fVar1;
	float fVar2;
		...
		if (bVar0 == 1)
		{
			...
			switch (Local_2917[iParam0 /*10*/])
			{
				...
				case 7:
					if ((!PED::IS_PED_INJURED(Local_755[12 /*33*/]) && !PED::IS_PED_INJURED(Local_755[13 /*33*/])) && !PED::IS_PED_INJURED(Local_755[14 /*33*/]))
					{
						if (func_175(6, 6) < 2)
						{
							...
							{
								if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[12 /*33*/], joaat("SCRIPT_TASK_LOOK_AT_ENTITY")) == 7)
								{
					...
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						...
						default:
							...
							while (bVar5 < Local_2889.f_0)
							{
								...
								{
									if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_2889[bVar5 /*3*/], 5f))
									{
										MISC::SET_BIT(&(Local_2917[iParam0 /*10*/].f_7), bVar5);
							...
							if (MISC::GET_GAME_TIMER() > Local_2917[iParam0 /*10*/].f_8)
							{
								...
								while (bVar5 < Local_2889.f_0)
								{
									...
									{
										FIRE::ADD_EXPLOSION(Local_2889[bVar5 /*3*/], 16, 1.5f, true, false, 1f, false);
										MISC::SET_BIT(&(Local_2917[iParam0 /*10*/].f_7), bVar5 + 9);
										bVar5 = 8;
				...
				case 41:
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						case 0:
							...
							{
								iLocal_2884 = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(1991.0813f, 3054.5166f, 46.714745f, 4f, 4f, 4f, 0f, false, 3);
							}
							Local_2917[iParam0 /*10*/].f_6++;
							break;
						...
						case 1:
							if ((STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze") && STREAMING::HAS_MODEL_LOADED(joaat("IG_TaoCheng"))) && STREAMING::HAS_MODEL_LOADED(joaat("IG_TaosTranslator")))
							{
								...
								if (!ENTITY::DOES_ENTITY_EXIST(Local_755[10 /*33*/]))
								{
									...
									PED::SET_PED_PROP_INDEX(Local_755[10 /*33*/], 1, 0, 1, false, 1);
								}
						...
						case 900:
							...
							if (!PED::IS_PED_INJURED(Local_755[10 /*33*/]))
							{
								if (((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_755[10 /*33*/], PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(Local_755[10 /*33*/])) || PED::IS_PED_INJURED(Local_755[11 /*33*/])) || (!PED::IS_PED_INJURED(Local_755[10 /*33*/]) && TASK::GET_SCRIPT_TASK_STATUS(Local_755[10 /*33*/], joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE")) == 2))
								{
									if (!BitTest(Local_2917[iParam0 /*10*/].f_8, 0))
									{
							...
							if (!PED::IS_PED_INJURED(Local_755[11 /*33*/]))
							{
								if (((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_755[11 /*33*/], PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(Local_755[11 /*33*/])) || BitTest(Local_2917[iParam0 /*10*/].f_8, 1)) || (!PED::IS_PED_INJURED(Local_755[11 /*33*/]) && TASK::GET_SCRIPT_TASK_STATUS(Local_755[11 /*33*/], joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE")) == 2))
								{
					...
					if (func_73(PLAYER::PLAYER_PED_ID(), 1995.1694f, 3062.1624f, 46.049f, 1) < 7f)
					{
						if (!PED::IS_PED_INJURED(Local_755[11 /*33*/]))
						{
							if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[11 /*33*/], joaat("SCRIPT_TASK_LOOK_AT_ENTITY")) != 1)
							{
						...
						if (!PED::IS_PED_INJURED(Local_755[10 /*33*/]))
						{
							if (TASK::GET_SCRIPT_TASK_STATUS(Local_755[10 /*33*/], joaat("SCRIPT_TASK_LOOK_AT_ENTITY")) != 1)
							{
				...
				case 16:
					...
					if (!OBJECT::DOES_PICKUP_EXIST(iLocal_2675))
					{
						iLocal_2675 = OBJECT::CREATE_PICKUP(joaat("PICKUP_WEAPON_PETROLCAN"), 2436.7747f, 4967.487f, 41.4f, iVar14, -1, true, 0);
				...
				case 21:
					...
					while (Local_2917[iParam0 /*10*/].f_7 < Local_755.f_0)
					{
						if (!PED::IS_PED_INJURED(Local_755[Local_2917[iParam0 /*10*/].f_7 /*33*/]))
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_755[Local_2917[iParam0 /*10*/].f_7 /*33*/], 2457.8848f, 4981.1694f, 50.00518f, 2441.5798f, 4965.0884f, 56.240055f, 34.3125f, false, true, 0))
							{
				...
				case 30:
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						...
						case 1:
							...
							{
								iLocal_2508 = VEHICLE::CREATE_VEHICLE(joaat("blazer"), 2478.5867f, 4941.803f, 43.6736f, 227.2903f, true, true, false);
				...
				case 39:
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						...
						case 1:
							if (func_73(Local_755[Local_2917[iParam0 /*10*/].f_7 /*33*/], 2454.8953f, 4950.8945f, 44.1488f, 1) > 100f && func_4(Local_755[Local_2917[iParam0 /*10*/].f_7 /*33*/], PLAYER::PLAYER_PED_ID(), 1) > 100f)
							{
								iVar16 = func_18(4);
...
void func_167()//Position - 0x1648B
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
bool func_168(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x1653E
{
	if (bParam6)
	{
...
void func_169(bool bParam0)//Position - 0x16585
{
	int iVar0;
...
int func_170(int iParam0)//Position - 0x166E3
{
	int iVar0;
...
void func_171(int iParam0)//Position - 0x1671B
{
	bool bVar0;
	int iVar1;
...
void func_172(bool bParam0)//Position - 0x1678C
{
	if (bParam0)
	{
...
int func_175(int iParam0, int iParam1)//Position - 0x16824
{
	if (Local_2917[iParam0 /*10*/] == iParam1)
	{
...
void func_176(int iParam0, int iParam1)//Position - 0x16845
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		switch (Local_3120[iVar3 /*8*/])
		{
				...
				switch (Local_3120[iVar3 /*8*/].f_4)
				{
					...
					case 1:
						if (ENTITY::DOES_ENTITY_EXIST(Local_755[Local_3120[iVar3 /*8*/].f_5 /*33*/]))
						{
							...
							{
								if (func_73(Local_755[Local_3120[iVar3 /*8*/].f_5 /*33*/], 2427.8506f, 4964.9717f, 43.1704f, 1) < 3f)
								{
									Local_3120[iVar3 /*8*/].f_2 = 1;
									Local_3120[iVar3 /*8*/].f_4++;
								}
			...
			case 26:
				if (func_73(PLAYER::PLAYER_PED_ID(), 2441.065f, 4968.8193f, 45.830746f, 1) < 2.75f)
				{
					if (!PED::IS_PED_INJURED(Local_755[15 /*33*/]))
					{
						if (func_73(Local_755[15 /*33*/], 2439.386f, 4962.0493f, 45.904697f, 1) < 3f)
						{
							Local_3120[iVar3 /*8*/].f_2 = 1;
						}
					}
					if (!PED::IS_PED_INJURED(Local_755[16 /*33*/]))
					{
						if (func_73(Local_755[16 /*33*/], 2439.386f, 4962.0493f, 45.904697f, 1) < 3f)
						{
							Local_3120[iVar3 /*8*/].f_2 = 1;
						}
					}
					if (!PED::IS_PED_INJURED(Local_755[17 /*33*/]))
					{
						if (func_73(Local_755[17 /*33*/], 2439.386f, 4962.0493f, 45.904697f, 1) < 3f)
						{
							Local_3120[iVar3 /*8*/].f_2 = 1;
						}
					}
...
int func_178(int iParam0)//Position - 0x177F2
{
...
int func_179()//Position - 0x17815
{
	return iLocal_280;
}

int func_180()//Position - 0x17820
{
	int iVar0;
...
void func_181()//Position - 0x1787F
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bLocal_2341)
	{
		...
		if (iLocal_2454 == -1 || ((iLocal_2454 != -1 && iLocal_2454 < 4) && fLocal_2453 > (Local_2380[iLocal_2454 /*18*/].f_13 / 1000f)))
		{
			...
			if (iLocal_2454 == 3)
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze"))
				{
					iLocal_2637 = CAM::CREATE_CAMERA(joaat("DEFAULT_ANIMATED_CAMERA"), true);
...
void func_182(int iParam0)//Position - 0x18618
{
	func_186();
	func_185();
	func_184();
...
void func_183()//Position - 0x18647
{
	int iVar0;
...
void func_184()//Position - 0x186A7
{
	int iVar0;
...
void func_185()//Position - 0x1875B
{
	int iVar0;
...
void func_186()//Position - 0x187B1
{
	int iVar0;
...
int func_187(bool bParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x187F3
{
	int iVar0;
...
void func_189(int iParam0, bool bParam1, int iParam2)//Position - 0x1883F
{
	int iVar0;
...
void func_190()//Position - 0x188E5
{
	int iVar0;
...
void func_191(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x1895A
{
	func_76(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_192(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x18983
{
	if (bParam0)
	{
...
bool func_193()//Position - 0x18AD0
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_194(int iParam0, int iParam1)//Position - 0x18AEA
{
	bool bVar0;
...
int func_195(int iParam0, bool bParam1)//Position - 0x18B35
{
	int iVar0;
	int iVar1;
...
int func_196()//Position - 0x18B76
{
	return Global_1574918;
}

int func_197(int iParam0)//Position - 0x18B82
{
...
bool func_198()//Position - 0x18BC1
{
	return BitTest(Global_2621446, 3);
}

void func_199(int iParam0)//Position - 0x18BCF
{
	if (iParam0 == 1)
	{
...
void func_202()//Position - 0x18DC1
{
	GRAPHICS::SET_DISABLE_PETROL_DECALS_RECYCLING_THIS_FRAME();
	func_176(28, 45);
...
void func_203(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x1901B
{
...
void func_204(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x190E3
{
	if (!Local_3358[iParam0 /*7*/].f_1)
	{
...
int func_205(int iParam0, int iParam1)//Position - 0x19119
{
	if (Local_3358[iParam0 /*7*/] == iParam1)
	{
		if (Local_3358[iParam0 /*7*/].f_1)
...
void func_206()//Position - 0x1914C
{
	func_176(5, 31);
...
void func_207()//Position - 0x19421
{
	struct<3> Var0;
	float fVar3;
	int iVar4;
	...
	switch (iLocal_2512)
	{
		case 0:
			if (STREAMING::IS_SRL_LOADED())
			{
				...
				iLocal_2642 = PED::CREATE_PED(26, joaat("A_M_Y_MethHead_01"), 2460.4495f, 4976.938f, 45.5765f, 243.4917f, true, true);
				...
				iLocal_2509 = VEHICLE::CREATE_VEHICLE(joaat("dubsta"), 2479.9612f, 4990f, 45.8f, -5.37f, true, true, false);
		...
		case 3:
			if (SYSTEM::TIMERA() > iLocal_2640)
			{
				CAM::DESTROY_ALL_CAMS(false);
				iLocal_2637 = CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", true);
				CAM::ADD_CAM_SPLINE_NODE(iLocal_2637, 2445.9443f, 4962.9863f, 51.4782f, 7.9159f, 0f, 34.5909f, 5000, 3, 2);
				CAM::ADD_CAM_SPLINE_NODE(iLocal_2637, 2445.6843f, 4963.3677f, 51.6659f, 3.6033f, 0f, 34.5909f, 3500, 3, 2);
		...
		case 4:
			if (SYSTEM::TIMERA() > iLocal_2640)
			{
				CAM::DESTROY_ALL_CAMS(false);
				iLocal_2637 = CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", true);
				CAM::ADD_CAM_SPLINE_NODE(iLocal_2637, 2465.0703f, 4946.6885f, 45.3372f, 7.1461f, 0f, 30.9281f, 5000, 3, 2);
				CAM::ADD_CAM_SPLINE_NODE(iLocal_2637, 2466.0112f, 4947.377f, 45.3509f, 7.1461f, 0f, 32.3761f, 3000, 3, 2);
				CAM::SET_CAM_FOV(iLocal_2637, 34f);
				CAM::SET_CAM_SPLINE_SMOOTHING_STYLE(iLocal_2637, 0);
				CAM::SHAKE_CAM(iLocal_2637, "Hand_shake", 0.5f);
				iLocal_2640 += 3000;
		...
		case 5:
			...
			if (SYSTEM::TIMERA() > iLocal_2640)
			{
				...
				CAM::DESTROY_ALL_CAMS(false);
				iLocal_2637 = CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", true);
				CAM::ADD_CAM_SPLINE_NODE(iLocal_2637, 2509.6912f, 4971.024f, 44.1325f, 7.2578f, 0f, 88.5226f, 5000, 3, 2);
				CAM::ADD_CAM_SPLINE_NODE(iLocal_2637, 2509.4146f, 4971.163f, 44.1674f, 6.6554f, 0f, 89.4229f, 2500, 3, 2);
...
void func_208()//Position - 0x1A4B0
{
	int iVar0;
	...
	func_209(&Local_1619, &uLocal_2708, cLocal_2338, 12f, 2482.1965f, 4975.3667f, 44.7288f, 121f, 1);
}

void func_209(var uParam0, var uParam1, char* sParam2, float fParam3, struct<3> Param4, float fParam7, int iParam8)//Position - 0x1A644
{
	int iVar0;
...
bool func_210()//Position - 0x1A73B
{
	bool bVar0;
...
void func_211(bool bParam0)//Position - 0x1A75E
{
	if (bParam0)
	{
		func_217();
...
void func_212(int iParam0)//Position - 0x1A7C1
{
	if (func_215())
	{
		return;
...
void func_213(bool bParam0, bool bParam1)//Position - 0x1A84B
{
	if (bParam0)
	{
		if (func_216(0))
...
bool func_214()//Position - 0x1A8BF
{
	return BitTest(Global_1962996, 5);
}

bool func_215()//Position - 0x1A8CD
{
	return BitTest(Global_1962996, 19);
}

int func_216(int iParam0)//Position - 0x1A8DC
{
	if (iParam0 == 1)
	{
		if (Global_20383.f_1 > 3)
...
void func_217()//Position - 0x1A933
{
...
void func_218(int* iParam0, bool bParam1, bool bParam2)//Position - 0x1A95C
{
	int iVar0;
...
int func_219()//Position - 0x1AB07
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

void func_220(int iParam0, var uParam1)//Position - 0x1AB17
{
	switch (iParam0)
	{
		case 0:
...
void func_221(int iParam0, var uParam1)//Position - 0x1AB5F
{
	switch (iParam0)
	{
		case 0:
...
void func_222(var uParam0)//Position - 0x1ABA7
{
...
float func_223(float fParam0)//Position - 0x1ABC2
{
	return (fParam0 * 57.29578f);
}

void func_224()//Position - 0x1ABD2
{
	int iVar0;
	...
	else
	{
		switch (iLocal_2512)
		{
			...
			case 1:
				if (func_228(&Local_2683, 2608.1511f, 4949.754f, 39.4f, 9f, 9f, 2f, 1, "FRMCHSE_1", 1, 1, -1))
				{
			...
			case 3:
				if (func_228(&Local_2683, 2573.6301f, 4983.677f, 50.6978f, 12f, 12f, 2f, 0, "FRMCHSE_5", 1, 1, -1))
				{
					if (AUDIO::IS_AUDIO_SCENE_ACTIVE("CHI_2_DRIVE_ROCK_RADIO"))
					{
						AUDIO::STOP_AUDIO_SCENE("CHI_2_DRIVE_ROCK_RADIO");
...
int func_225(int iParam0)//Position - 0x1AECB
{
	int iVar0;
...
int func_226(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x1AF0D
{
...
void func_227(int iParam0)//Position - 0x1B0A5
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
bool func_228(int* iParam0, struct<3> Param1, struct<3> Param4, bool bParam7, char* sParam8, bool bParam9, bool bParam10, int iParam11)//Position - 0x1B0D1
{
...
int func_229(int* iParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, struct<3> Param10, bool bParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, bool bParam25, bool bParam26, char* sParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, int iParam32, int iParam33, int iParam34, bool bParam35, float fParam36)//Position - 0x1B122
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_230(int iParam0, bool bParam1, bool bParam2)//Position - 0x1BA36
{
	return func_14(iParam0, !bParam1, bParam2);
}

int func_231(int* iParam0)//Position - 0x1BA49
{
...
int func_232(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1BA9E
{
	int iVar0;
...
int func_233(int iParam0)//Position - 0x1BB83
{
	float fVar0;
...
int func_234(int iParam0, int iParam1)//Position - 0x1BBBA
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
int func_235(int iParam0, int iParam1)//Position - 0x1BC25
{
	int iVar0;
...
int func_236(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x1BC6D
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_237(int iParam0, int* iParam1)//Position - 0x1BCE8
{
	if (HUD::DOES_BLIP_EXIST(iParam0))
	{
...
void func_238(int iParam0, char* sParam1, int iParam2)//Position - 0x1BD23
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iParam0, sParam1, func_239(iParam2), 1);
}

int func_239(int iParam0)//Position - 0x1BD3A
{
	int iVar0;
...
void func_240(int* iParam0, char* sParam1, bool bParam2)//Position - 0x1BF2F
{
	if (!bParam2)
	{
...
int func_241(int* iParam0)//Position - 0x1BF67
{
...
int func_242(int* iParam0, int iParam1)//Position - 0x1BF8B
{
...
int func_244(var uParam0)//Position - 0x1BFFA
{
	int iVar0;
	int iVar1;
...
int func_245(var uParam0, int iParam1)//Position - 0x1C01E
{
	int iVar0;
...
int func_246(int iParam0, var uParam1, int iParam2)//Position - 0x1C04F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_247(char* sParam0)//Position - 0x1C0E3
{
...
int func_248(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17)//Position - 0x1C0FB
{
	int iVar0;
	int iVar1;
	int iVar2;
						...
						if (func_246(uParam0->f_21, uParam0, iVar3))
						{
							...
							while (iVar0 < 3)
							{
								if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
								{
									...
									if (TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], joaat("SCRIPT_TASK_ENTER_VEHICLE")) == 7 && !func_263(uParam0->f_17[iVar0], uParam0->f_21))
									{
...
void func_249(int iParam0, var uParam1)//Position - 0x1D143
{
	switch (iParam0)
	{
		case 0:
...
void func_250(var uParam0, char* sParam1, char* sParam2, bool bParam3)//Position - 0x1D18B
{
	if (!bParam3)
	{
		if (!MISC::IS_STRING_NULL(sParam1))
...
void func_251(char* sParam0, char* sParam1, int iParam2, int iParam3)//Position - 0x1D1C5
{
	iParam3 = iParam3;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
int func_252(int iParam0, var uParam1)//Position - 0x1D1E4
{
	switch (iParam0)
	{
		case 0:
...
int func_253(int iParam0, float fParam1)//Position - 0x1D224
{
	int iVar0;
...
int func_254(int iParam0, int iParam1)//Position - 0x1D25B
{
	int iVar0;
...
int func_255(int iParam0, int iParam1)//Position - 0x1D2C2
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
void func_256(int iParam0, var uParam1)//Position - 0x1D2F7
{
	switch (iParam0)
	{
		case 0:
...
int func_257(int iParam0, var uParam1)//Position - 0x1D33F
{
	switch (iParam0)
	{
		case 0:
...
int func_258(int iParam0)//Position - 0x1D37F
{
	int iVar0;
	int iVar1;
...
int func_259(int iParam0, var uParam1)//Position - 0x1D40C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_260(var uParam0)//Position - 0x1D56C
{
	int iVar0;
...
int func_261(var uParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x1D59B
{
	int iVar0;
...
int func_262(int iParam0)//Position - 0x1D679
{
	float fVar0;
...
int func_263(int iParam0, int iParam1)//Position - 0x1D6B1
{
	int iVar0;
...
void func_264()//Position - 0x1D6E1
{
	int iVar0;
	int iVar1;
...
void func_265(var uParam0)//Position - 0x1D74E
{
	int iVar0;
...
void func_266(var uParam0)//Position - 0x1D7EE
{
	int iVar0;
...
Vector3 func_267()//Position - 0x1D884
{
	struct<3> Var0;
...
int func_268(int iParam0, int iParam1)//Position - 0x1D890
{
	int iVar0;
...
void func_269()//Position - 0x1D8D4
{
	int iVar0;
	int iVar1;
	...
	switch (iLocal_2512)
	{
		case 0:
			...
			if (func_210())
			{
				...
				{
					Local_755[14 /*33*/] = Global_97178.f_9[2];
					Local_755[13 /*33*/] = Global_97178.f_9[1];
					Local_755[11 /*33*/] = Global_97178.f_9[4];
					Local_755[10 /*33*/] = Global_97178.f_9[3];
					Local_755[12 /*33*/] = Global_97178.f_9[0];
...
void func_270(int iParam0)//Position - 0x1E04F
{
	if (Global_97603 != -1)
	{
...
void func_271()//Position - 0x1E073
{
	int iVar0;
...
void func_272()//Position - 0x1E126
{
	int iVar0;
	...
	switch (iLocal_2512)
	{
		case 0:
			...
			Local_2889[8 /*3*/] = { 2435.6372f, 4969.699f, 42.19639f };
			Local_444[0 /*5*/] = { 2450.3765f, 4955.8296f, 43.9394f };
			Local_444[1 /*5*/] = { 2449.815f, 4956.678f, 43.9894f };
			Local_444[2 /*5*/] = { 2449.606f, 4957.6753f, 44.0646f };
			Local_444[3 /*5*/] = { 2449.739f, 4958.7314f, 44.1544f };
			Local_444[4 /*5*/] = { 2450.1409f, 4959.745f, 44.2487f };
			Local_444[5 /*5*/] = { 2450.685f, 4960.5815f, 44.3219f };
			Local_444[6 /*5*/] = { 2451.4924f, 4961.333f, 44.4439f };
			Local_444[7 /*5*/] = { 2452.1736f, 4962.0986f, 44.5787f };
			Local_444[8 /*5*/] = { 2452.7166f, 4962.906f, 44.9141f };
			Local_444[9 /*5*/] = { 2453.3499f, 4963.5786f, 45.3558f };
			Local_444[10 /*5*/] = { 2453.754f, 4964.5654f, 45.5766f };
			Local_444[11 /*5*/] = { 2453.2256f, 4965.539f, 45.5766f };
			Local_444[12 /*5*/] = { 2452.4724f, 4966.293f, 45.5766f };
			Local_444[13 /*5*/] = { 2451.8691f, 4967.104f, 45.5766f };
			Local_444[14 /*5*/] = { 2451.529f, 4968.0825f, 45.5766f };
			Local_444[15 /*5*/] = { 2452.3271f, 4968.7124f, 45.5766f };
			Local_444[16 /*5*/] = { 2452.7961f, 4969.6426f, 45.8107f };
			Local_444[17 /*5*/] = { 2453.2607f, 4970.541f, 45.8106f };
			Local_444[18 /*5*/] = { 2453.5803f, 4971.5483f, 45.8104f };
			Local_444[19 /*5*/] = { 2452.8076f, 4972.2666f, 45.8306f };
			Local_444[20 /*5*/] = { 2452.0493f, 4972.928f, 45.8306f };
			Local_444[21 /*5*/] = { 2451.2407f, 4973.599f, 45.8306f };
			Local_444[22 /*5*/] = { 2450.248f, 4973.8887f, 45.8306f };
			Local_444[23 /*5*/] = { 2449.2073f, 4973.7837f, 45.8105f };
			Local_444[24 /*5*/] = { 2448.1724f, 4973.814f, 45.8106f };
			Local_444[25 /*5*/] = { 2447.1526f, 4973.7715f, 45.8106f };
			Local_444[26 /*5*/] = { 2446.138f, 4973.724f, 45.8106f };
			Local_444[27 /*5*/] = { 2445.1282f, 4973.6895f, 45.8106f };
			Local_444[28 /*5*/] = { 2444.2559f, 4973.0557f, 45.8106f };
			Local_444[29 /*5*/] = { 2443.6694f, 4972.194f, 45.8106f };
			Local_444[30 /*5*/] = { 2443.1191f, 4971.275f, 45.8106f };
			Local_444[31 /*5*/] = { 2442.6606f, 4970.3594f, 45.8106f };
			Local_444[32 /*5*/] = { 2442.2668f, 4969.4253f, 45.8106f };
			Local_444[33 /*5*/] = { 2441.7085f, 4968.5024f, 45.8306f };
			Local_444[34 /*5*/] = { 2441.2637f, 4967.5337f, 45.8106f };
			Local_444[35 /*5*/] = { 2440.8728f, 4966.5376f, 45.8106f };
			Local_444[36 /*5*/] = { 2440.3818f, 4965.6343f, 45.8106f };
			Local_444[37 /*5*/] = { 2439.7104f, 4964.8823f, 45.8106f };
			Local_444[38 /*5*/] = { 2438.9329f, 4964.1455f, 45.8106f };
			Local_444[39 /*5*/] = { 2438.1663f, 4963.5024f, 45.8106f };
			Local_444[40 /*5*/] = { 2437.5554f, 4962.7095f, 45.8106f };
			Local_444[41 /*5*/] = { 2436.9011f, 4961.95f, 45.8106f };
			Local_444[42 /*5*/] = { 2436.0752f, 4961.2573f, 45.8106f };
			Local_444[43 /*5*/] = { 2435.0796f, 4961.004f, 45.8118f };
			Local_444[44 /*5*/] = { 2434.0664f, 4960.7134f, 45.8181f };
			Local_444[45 /*5*/] = { 2433.045f, 4960.5938f, 45.8192f };
			Local_444[46 /*5*/] = { 2432.0647f, 4960.2495f, 45.813f };
			Local_444[47 /*5*/] = { 2431.233f, 4960.809f, 45.8089f };
			Local_444[48 /*5*/] = { 2430.5747f, 4961.5737f, 45.5917f };
			Local_444[49 /*5*/] = { 2429.8887f, 4962.028f, 44.9345f };
			Local_444[50 /*5*/] = { 2429.26f, 4962.5947f, 44.2774f };
			Local_444[51 /*5*/] = { 2428.6914f, 4963.2793f, 43.6202f };
			Local_444[52 /*5*/] = { 2428.073f, 4963.9106f, 42.9631f };
			Local_444[53 /*5*/] = { 2428.2388f, 4964.922f, 42.9631f };
			Local_444[54 /*5*/] = { 2428.9614f, 4965.4546f, 42.3059f };
			Local_444[55 /*5*/] = { 2429.45f, 4966.2236f, 41.8679f };
			Local_444[56 /*5*/] = { 2430.0728f, 4966.82f, 41.3476f };
			Local_444[57 /*5*/] = { 2431.097f, 4967.043f, 41.3476f };
			Local_444[58 /*5*/] = { 2431.8904f, 4966.403f, 41.3476f };
			Local_444[59 /*5*/] = { 2432.7676f, 4965.902f, 41.3476f };
			Local_444[60 /*5*/] = { 2433.7761f, 4965.6133f, 41.3476f };
			...
			Local_2274[0 /*3*/] = { 2552.6924f, 4978.5664f, 45.32309f };
			Local_2274[1 /*3*/] = { 2562.5337f, 5013.502f, 47.463024f };
			Local_2274[2 /*3*/] = { 2553.8848f, 4945.6606f, 47.493053f };
			Local_2274[3 /*3*/] = { 2515.5452f, 4936.428f, 42.883816f };
			Local_2274[4 /*3*/] = { 2497.3184f, 4967.818f, 43.595566f };
			Local_2274[5 /*3*/] = { 2481.3762f, 4951.766f, 43.99859f };
			Local_2274[6 /*3*/] = { 2522.0444f, 4956.3716f, 43.71605f };
			Local_2274[7 /*3*/] = { 2529.048f, 4985.6274f, 43.868477f };
			Local_2274[8 /*3*/] = { 2502.5034f, 4987.245f, 46.62669f };
			Local_2274[9 /*3*/] = { 2464.891f, 4939.9487f, 44.256462f };
			Local_2274[10 /*3*/] = { 2447.1602f, 4940.2725f, 44.15766f };
			Local_2274[11 /*3*/] = { 2376.5369f, 4946.3994f, 41.772324f };
			Local_2274[12 /*3*/] = { 2395.232f, 4995.63f, 44.689095f };
			Local_2274[13 /*3*/] = { 2419.819f, 4991.9355f, 45.369762f };
			Local_2274[14 /*3*/] = { 2436.3193f, 5011.725f, 45.846943f };
			Local_2274[15 /*3*/] = { 2407.7646f, 5023.0786f, 47.770912f };
			Local_2274[16 /*3*/] = { 2479.0159f, 5028.829f, 42.98806f };
			Local_2274[17 /*3*/] = { 2434.704f, 5042.713f, 45.34462f };
			Local_2274[18 /*3*/] = { 2513.93f, 5039.3325f, 51.021214f };
			Local_2274[19 /*3*/] = { 2477.8823f, 4986.437f, 44.995113f };
			Local_2274[20 /*3*/] = { 2450.058f, 5011.858f, 44.890316f };
			func_209(&Local_1619, &uLocal_2708, cLocal_2338, 12f, 2482.1965f, 4975.3667f, 44.7288f, 121f, 1);
			func_379(&Local_2244, "ONEILGUARD4", 5, "ONEILGUARD1");
			func_379(&Local_2247, "ONEILGUARD4", 5, "ONEILGUARD1");
			func_379(&Local_2259, "CHI2_nope", 8, "ONEILGUARD1");
			func_379(&Local_2250, "SEETREVOR", 3, "chin2goon1");
			func_379(&Local_2253, "CHI2_hear", 8, "ONEILGUARD1");
			func_379(&Local_2256, "CHI2_hear", 8, "ONEILGUARD1");
			func_379(&Local_2262, "ONEILGUARD3", 5, "ONEILGUARD1");
			func_379(&Local_2265, "ONEILGUARD2", 5, "ONEILGUARD1");
			func_379(&Local_2268, "ONEILGUARD4", 5, "ONEILGUARD1");
			func_379(&Local_2271, "GOON2TREV", 4, "CHIN2goon2");
			func_32(6, 1);
			func_32(25, 1);
...
void func_273(int iParam0, bool bParam1, bool bParam2)//Position - 0x1F102
{
	int iVar0;
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			while (!func_369(&(Local_755[11 /*33*/]), 21, 1985.6656f, 3052.6606f, 46.2151f, 0, 1))
			{
				SYSTEM::WAIT(0);
			}
		...
		case 2:
			if (bParam1)
			{
				func_368(1992.8784f, 3057.8464f, 46.0568f, 311f, 1, 0);
			}
			else
			{
				if (func_74(iLocal_2506))
				{
					ENTITY::SET_ENTITY_COORDS(iLocal_2506, 1994.3872f, 3061.9397f, 46.0491f, true, false, false, true);
		...
		case 3:
			if (bParam1)
			{
				func_368(2574.0486f, 4981.8237f, 50.44f, 50f, 1, 0);
			}
			else
			{
		...
		case 4:
			...
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_281(), 2570.5376f, 4982.0312f, 50.6239f, true) < 10f)
			{
		...
		case 6:
			if (bParam1)
			{
				func_368(2450.8713f, 4960.9985f, 44.3759f, 351f, 1, 0);
			}
			else
			{
		...
		case 7:
			if (bParam1)
			{
				func_368(2435.3193f, 4966.153f, 41.3476f, 104.2964f, 1, 0);
			}
			else
			{
			...
			iLocal_2678 = INTERIOR::GET_INTERIOR_AT_COORDS(2432.9817f, 4964.823f, 41.3476f);
		...
		case 9:
			if (bParam1)
			{
				func_368(2472.3f, 4948.1807f, 44.0937f, 220f, 1, 0);
			}
			else
			{
		...
		case 10:
			...
			if (bParam1)
			{
				func_368(2625.776f, 4802.2173f, 32.5747f, 206f, 1, 0);
			}
			else
			{
...
void func_274(int iParam0, int iParam1, int iParam2)//Position - 0x20016
{
	Local_3337[iParam0 /*4*/].f_1 = iParam2;
	Local_3337[iParam0 /*4*/] = iParam1;
}

void func_275(int iParam0, int iParam1, int iParam2)//Position - 0x20032
{
	Local_3358[iParam0 /*7*/].f_1 = iParam2;
	Local_3358[iParam0 /*7*/] = iParam1;
}

Vector3 func_276(int iParam0, struct<3> Param1)//Position - 0x2004E
{
	var uVar0;
...
bool func_277(int iParam0)//Position - 0x20094
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
bool func_278()//Position - 0x200B2
{
	return Global_107196.f_2890.f_8;
}

var func_279(int iParam0)//Position - 0x200C3
{
	if (Global_100718 > 0)
	{
...
float func_280()//Position - 0x200ED
{
	return Global_107196.f_2884.f_3;
}

Vector3 func_281()//Position - 0x200FE
{
	return Global_107196.f_2884;
}

void func_282(int iParam0, int iParam1, int iParam2)//Position - 0x2010F
{
...
void func_283(int iParam0)//Position - 0x201D3
{
	if (iParam0 == 1)
	{
...
var func_284()//Position - 0x201FC
{
	return BitTest(Global_100681.f_20, 13);
}

void func_285(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2020D
{
	if (bParam0)
	{
		if (func_367())
		{
			if (func_364(func_366(), 10f, 20f, 9f, 1))
			{
				...
				if (bParam2)
				{
					iLocal_2506 = func_361(1994.3872f, 3061.9397f, 46.0491f, 50f);
				}
				else
				{
					iLocal_2506 = func_361(0f, 0f, 0f, 0f);
				}
			}
		}
	}
...
int func_286(struct<3> Param0, float fParam3)//Position - 0x202D1
{
	return func_287(&(Global_107196.f_2890), Param0, fParam3, 0);
}

int func_287(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x202EB
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
void func_288(int iParam0, int iParam1)//Position - 0x2059D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_289(int iParam0, var uParam1)//Position - 0x2079F
{
	int iVar0;
...
int func_290(int iParam0)//Position - 0x20A4A
{
	switch (iParam0)
	{
		case 1:
...
int func_291(int iParam0, var uParam1, var uParam2)//Position - 0x20AFA
{
	int iVar0;
	int iVar1;
...
int func_292(int iParam0)//Position - 0x20CED
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_293(var uParam0)//Position - 0x20D0D
{
	int iVar0;
...
int func_294(int iParam0)//Position - 0x20DBE
{
...
int func_295(int iParam0)//Position - 0x20E9B
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_296(int iParam0, bool bParam1, int iParam2)//Position - 0x2104D
{
	int iVar0;
	struct<2> Var1;
...
int func_297(int iParam0)//Position - 0x211CF
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_299(int iParam0, int iParam1)//Position - 0x212B2
{
	int iVar0;
	int iVar1;
...
bool func_300()//Position - 0x248E3
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_301()//Position - 0x248F9
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_302()//Position - 0x2490F
{
	return 0;
}

int func_303()//Position - 0x24918
{
	return 1;
}

int func_304()//Position - 0x24921
{
	return 1;
}

int func_305()//Position - 0x2492A
{
...
int func_307(int iParam0)//Position - 0x249FB
{
	int iVar0;
	char* sVar1;
...
int func_308(int iParam0)//Position - 0x24A42
{
	int iVar0;
...
int func_309(int iParam0)//Position - 0x24A7D
{
	int iVar0;
...
int func_310(int iParam0)//Position - 0x24AF9
{
	int iVar0;
...
int func_311(int iParam0)//Position - 0x24BE1
{
	int iVar0;
...
void func_312(int iParam0, bool bParam1)//Position - 0x24C44
{
	if (iParam0 == -1)
	{
		return;
...
void func_313(int iParam0, int iParam1, bool bParam2)//Position - 0x24CA1
{
	if (iParam0 == -1)
	{
		return;
...
int func_314(int iParam0, int iParam1)//Position - 0x24CDC
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_315(int iParam0)//Position - 0x24CFC
{
	bool bVar0;
...
void func_316(var uParam0, var uParam1)//Position - 0x24E6B
{
...
int func_317(int iParam0, int iParam1)//Position - 0x24F37
{
	int iVar0;
...
int func_318(var uParam0)//Position - 0x24FAA
{
	return *uParam0;
}

int func_319(var uParam0, int iParam1)//Position - 0x24FB5
{
	int iVar0;
	int iVar1;
...
int func_320(int iParam0, int iParam1)//Position - 0x266A4
{
	struct<82> Var0;
...
void func_321(int iParam0, var uParam1, int iParam2)//Position - 0x266E6
{
	int iVar0;
...
int func_322(int iParam0)//Position - 0x26942
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_323(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x26A05
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_324(iParam0, uVar1[iVar6], 1) && func_236(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.5635f, 39.9702f, 5f, 0))
				{
...
int func_324(int iParam0, int iParam1, bool bParam2)//Position - 0x26C0D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_325(int iParam0, int iParam1)//Position - 0x26C6E
{
	int iVar0;
...
void func_326(int iParam0, int iParam1)//Position - 0x26CF0
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98012[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98012[iVar0]) == func_320(iParam0, iParam1))
				{
...
void func_327(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x26D8E
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar6 <= 2)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_290(iVar6));
				}
				iVar6++;
			}
		}
		...
		if (((func_328() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger")))
		{
...
int func_329(var uParam0)//Position - 0x27504
{
	int iVar0;
...
int func_330(int iParam0)//Position - 0x27528
{
	int iVar0;
...
bool func_331(int iParam0)//Position - 0x27546
{
	return func_332(&(Global_2672505.f_183), iParam0);
}

var func_332(var uParam0, var uParam1)//Position - 0x2755A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_333(int iParam0, var uParam1, var uParam2)//Position - 0x2757D
{
	int iVar0;
	int iVar1;
	...
	if (func_338(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_336(*iParam0, ((*uParam1)[38] - 1)))
	{
...
int func_334(int iParam0)//Position - 0x27757
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_335(var uParam0)//Position - 0x27833
{
...
int func_336(int iParam0, int iParam1)//Position - 0x2788A
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_337(int iParam0, int iParam1)//Position - 0x27973
{
	int iVar0;
...
int func_338(int iParam0, int iParam1)//Position - 0x279D5
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_339(int iParam0, int iParam1, int iParam2)//Position - 0x27DB4
{
	if (!func_340() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_340()//Position - 0x27DD8
{
	return 0;
}

void func_341(int iParam0, int iParam1)//Position - 0x27DE1
{
	int iVar0;
	int iVar1;
...
bool func_342()//Position - 0x27E59
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

int func_343(int iParam0)//Position - 0x27E6A
{
	int iVar0;
...
int func_344(int iParam0)//Position - 0x27EB2
{
...
int func_345(int iParam0)//Position - 0x27ED2
{
	switch (iParam0)
	{
		case 161:
...
int func_346(int iParam0)//Position - 0x27F25
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (!func_352(PLAYER::PLAYER_ID(), -1))
		{
...
int func_347(int iParam0)//Position - 0x27FAC
{
...
int func_348(int iParam0)//Position - 0x27FDB
{
...
int func_349(int iParam0)//Position - 0x27FF8
{
...
int func_350(int iParam0, int iParam1)//Position - 0x2801C
{
...
int func_351(int iParam0)//Position - 0x28057
{
	if (func_350(iParam0, 0))
	{
...
int func_352(int iParam0, int iParam1)//Position - 0x2807A
{
	int iVar0;
...
int func_353(int iParam0, bool bParam1, bool bParam2)//Position - 0x280C7
{
	int iVar0;
...
void func_354(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x28127
{
	int iVar0;
...
int func_355(var uParam0)//Position - 0x28177
{
	if (func_356(uParam0))
	{
...
int func_356(var uParam0)//Position - 0x281AC
{
...
bool func_357()//Position - 0x2820C
{
	return func_355(&(Global_107196.f_2890));
}

void func_358()//Position - 0x2821F
{
	func_359(&(Global_107196.f_2890));
}

void func_359(var uParam0)//Position - 0x28232
{
	if (func_356(uParam0))
	{
...
bool func_360()//Position - 0x28250
{
	return func_356(&(Global_107196.f_2890));
}

int func_361(struct<3> Param0, float fParam3)//Position - 0x28263
{
	return func_287(&(Global_104212.f_2890), Param0, fParam3, 0);
}

bool func_362()//Position - 0x2827D
{
	return func_355(&(Global_104212.f_2890));
}

void func_363()//Position - 0x28290
{
	func_359(&(Global_104212.f_2890));
}

int func_364(int iParam0, struct<3> Param1, int iParam4)//Position - 0x282A3
{
	struct<3> Var0;
	struct<3> Var3;
...
Vector3 func_365()//Position - 0x2830D
{
	return 2.55f, 5.665f, 2.55f;
}

int func_366()//Position - 0x28324
{
	return Global_104212.f_2890.f_12.f_66;
}

bool func_367()//Position - 0x28337
{
	return func_356(&(Global_104212.f_2890));
}

void func_368(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2834A
{
	if (func_378())
	{
...
int func_369(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x283DF
{
	int iVar0;
...
int func_370(var uParam0, int iParam1)//Position - 0x2846D
{
	int iVar0;
...
int func_371(int iParam0)//Position - 0x284B3
{
	if (!func_50(iParam0))
	{
		return func_53(iParam0);
...
void func_372(int iParam0)//Position - 0x284D9
{
	int iVar0;
	int iVar1;
	...
	{
		func_374(PLAYER::PLAYER_PED_ID(), 2);
	}
	iVar0 = 0;
	while (iVar0 < Local_755.f_0)
	{
...
void func_373()//Position - 0x28D1E
{
	EVENT::UNBLOCK_DECISION_MAKER_EVENT(joaat("DEFAULT"), 31 /*EVENT_INJURED_CRY_FOR_HELP*/);
}

void func_374(int iParam0, int iParam1)//Position - 0x28D31
{
	int iVar0;
...
int func_375(int iParam0, int iParam1)//Position - 0x28D97
{
	int iVar0;
...
void func_376()//Position - 0x28ECA
{
	int iVar0;
...
void func_379(var uParam0, char* sParam1, int iParam2, char* sParam3)//Position - 0x28F42
{
	*uParam0 = sParam3;
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam2;
...
void func_380()//Position - 0x28F5B
{
...
void func_381()//Position - 0x28FF1
{
	switch (iLocal_3688)
	{
		case 0:
...
void func_382(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x29104
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_454(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
			Global_113648.f_9087.f_330[iVar1 /*6*/].f_1 = 0;
			iVar2 = func_452(iVar1);
		...
		{
			iVar5 = func_447(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
				Global_113648.f_18576[iVar5 /*6*/].f_4 = 0;
				MemCopy(&uVar6, {func_446(iVar5)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar6, 0, Global_100718, iParam0);
			}
			else
			{
				iVar10 = func_445(&(Global_100681.f_3));
				if (iVar10 > -1)
				{
...
void func_383(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2927A
{
	func_384(&Global_107196, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_384(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x29296
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_48();
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_407(PLAYER::PLAYER_PED_ID());
		func_400(PLAYER::PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_399())
		{
			func_393(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
int func_385(var uParam0)//Position - 0x2A11F
{
...
void func_386(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2A141
{
	int iVar0;
...
int func_387(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A1C9
{
...
int func_388(int iParam0)//Position - 0x2A209
{
	int iVar0;
...
void func_389(var uParam0, int iParam1, int iParam2)//Position - 0x2A237
{
...
int func_390(int iParam0)//Position - 0x2A313
{
	int iVar0;
...
int func_391(int iParam0, int iParam1, int iParam2)//Position - 0x2A355
{
	int iVar0;
...
int func_392(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A3E3
{
	char* sVar0;
...
void func_393(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A512
{
	int iVar0;
	int iVar1;
...
int func_394(int iParam0, int iParam1, int iParam2)//Position - 0x2A6B2
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 14192)
	{
		...
		iVar0 = Global_2805027[iParam0 /*3*/][func_395(iParam1)];
...
int func_395(var uParam0)//Position - 0x2A6EF
{
	int iVar0;
	int iVar1;
...
int func_396(int iParam0, int iParam1)//Position - 0x2A723
{
	int iVar0;
	var uVar1;
	
	iVar0 = Global_2848280[iParam0 /*3*/][func_395(iParam1)];
...
void func_397(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2A74F
{
	int iVar0;
...
void func_398(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x2AC98
{
	int iVar0;
...
int func_399()//Position - 0x2AED9
{
	func_49();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_400(int iParam0, bool bParam1)//Position - 0x2AEF2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_401(int iParam0, var uParam1)//Position - 0x2AFE5
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_406(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_403(Var11.f_1)) && iVar72 < 51)
			{
...
int func_402(int iParam0)//Position - 0x2B26D
{
	switch (iParam0)
	{
...
int func_403(int iParam0)//Position - 0x2B30E
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_404(int iParam0, int iParam1)//Position - 0x2B4E8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_405(int iParam0, var* uParam1)//Position - 0x2C14D
{
	int iVar0;
	int iVar1;
...
int func_406(int iParam0)//Position - 0x2C188
{
	int iVar0;
...
void func_407(int iParam0)//Position - 0x2C3FC
{
	int iVar0;
...
void func_408(var uParam0, int iParam1)//Position - 0x2C438
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_409(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x2C987
{
	int iVar0;
	int iVar1;
...
bool func_410(int iParam0, var uParam1, var uParam2)//Position - 0x2C9CB
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
int func_411(var uParam0)//Position - 0x2D14A
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_34())
		{
			*uParam0 = func_416(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 6, -1, 0, 1, -1);
...
bool func_412(int iParam0)//Position - 0x2D1A5
{
	return func_413(iParam0, 0, 1);
}

int func_413(int iParam0, int iParam1, bool bParam2)//Position - 0x2D1B5
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_414(int iParam0)//Position - 0x2D216
{
	switch (iParam0)
	{
		case 0:
...
int func_415(int iParam0)//Position - 0x2D5AF
{
	return func_413(iParam0, 5, 1);
}

int func_416(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x2D5BF
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 59)
	{
		if (iParam3 == 6 || iParam3 == func_433(iVar0))
		{
			if (!bParam5 || func_432(iVar0))
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_417(iVar0, 0), true);
...
Vector3 func_417(int iParam0, bool bParam1)//Position - 0x2D661
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_418()//Position - 0x2DDB1
{
...
int func_419()//Position - 0x2E0AC
{
	return Global_2652258.f_2650;
}

int func_420(int iParam0)//Position - 0x2E0BB
{
	if (iParam0 != func_42())
	{
...
Vector3 func_421(int iParam0, int iParam1)//Position - 0x2E113
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_422(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2E1BD
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_423(struct<3> Param0, float fParam3)//Position - 0x2E252
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_424(int iParam0)//Position - 0x2E296
{
	struct<6> Var0;
...
struct<6> func_425(int iParam0)//Position - 0x2E41A
{
	return func_426(iParam0);
}

struct<6> func_426(int iParam0)//Position - 0x2E428
{
	struct<6> Var0;
...
int func_427(int iParam0, var uParam1)//Position - 0x2EEEF
{
	switch (iParam0)
	{
		case 0:
...
int func_428(int iParam0)//Position - 0x2EF71
{
	if (iParam0 != func_42())
	{
...
Vector3 func_429(int iParam0)//Position - 0x2EFC9
{
	switch (iParam0)
	{
		case 1:
...
int func_430()//Position - 0x2F240
{
	return func_431(PLAYER::PLAYER_ID());
}

int func_431(int iParam0)//Position - 0x2F250
{
	return MISC::GET_BITS_IN_RANGE(Global_2657589[iParam0 /*466*/].f_321.f_3, 28, 31);
}

int func_432(int iParam0)//Position - 0x2F26D
{
	return func_413(iParam0, 0, 0);
}

int func_433(int iParam0)//Position - 0x2F27D
{
	switch (iParam0)
	{
		case -1:
...
var func_434()//Position - 0x2F5A6
{
	var uVar0;
	
	func_444(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_443(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_442(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_437(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_436(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_435(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}

void func_435(var uParam0, int iParam1)//Position - 0x2F5EC
{
	if (iParam1 <= 0)
	{
		return;
...
void func_436(var uParam0, int iParam1)//Position - 0x2F672
{
...
void func_437(var uParam0, int iParam1)//Position - 0x2F6A5
{
	int iVar0;
	int iVar1;
...
int func_438(int iParam0, int iParam1)//Position - 0x2F6F6
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_439(int iParam0)//Position - 0x2F798
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_440(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_440(bool bParam0, int iParam1, int iParam2)//Position - 0x2F7BA
{
	if (bParam0)
	{
		return iParam1;
...
int func_441(var uParam0)//Position - 0x2F7D1
{
	return uParam0 & 15;
}

void func_442(var uParam0, int iParam1)//Position - 0x2F7DE
{
...
void func_443(var uParam0, int iParam1)//Position - 0x2F818
{
...
void func_444(var uParam0, int iParam1)//Position - 0x2F853
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_445(char* sParam0)//Position - 0x2F88F
{
...
struct<2> func_446(int iParam0)//Position - 0x2F8E5
{
	struct<2> Var0;
...
int func_447(char* sParam0, int iParam1)//Position - 0x2FD32
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_448(int iParam0, var uParam1)//Position - 0x2FD7B
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_449(uParam1, "Barry3A", func_451(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_450(iParam0), 0, 1);
			break;
		...
		case 8:
			func_449(uParam1, "Dreyfuss1", func_451(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_450(iParam0), 0, 0);
			break;
		...
		case 38:
			func_449(uParam1, "Nigel1A", func_451(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_450(iParam0), 1, 1);
			break;
		...
		case 49:
			func_449(uParam1, "Paparazzo3A", func_451(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_450(iParam0), 0, 1);
			break;
		...
		case 58:
			func_449(uParam1, "Tonya1", func_451(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_450(iParam0), 0, 1);
			break;
...
void func_449(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, struct<3> Param7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)//Position - 0x30FC5
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_450(int iParam0)//Position - 0x31056
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_451(int iParam0)//Position - 0x3139C
{
	struct<2> Var0;
	char[] cVar2[8];
	
	StringCopy(&Var0, "", 8);
	cVar2 = { func_446(iParam0) };
...
int func_452(int iParam0)//Position - 0x313D4
{
	switch (iParam0)
	{
		case 69:
...
int func_453(int iParam0)//Position - 0x31490
{
	switch (iParam0)
	{
		case 1:
...
int func_454(char* sParam0, bool bParam1)//Position - 0x314E4
{
	int iVar0;
	int iVar1;
...
int func_455(int iParam0, bool bParam1)//Position - 0x3150E
{
	int iVar0;
...
void func_456(bool bParam0)//Position - 0x31544
{
	int iVar0;
	int iVar1;
...
void func_457(int iParam0)//Position - 0x317C6
{
	func_372(iParam0);
	GRAPHICS::CASCADE_SHADOWS_ENABLE_ENTITY_TRACKER(true);
...
void func_458()//Position - 0x318DE
{
	int iVar0;
