...
void func_8()//Position - 0x970
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_11(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_9(iVar0) && (!func_13(14) || Global_112337))
			{
...
void func_17(int iParam0, var uParam1)//Position - 0xD96
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_18(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_91229[26 /*34*/].f_6) == 0)
			{
				Global_113386.f_7261[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_113386.f_7261[iParam0], true, true);
			}
...
int func_35(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x46C5
{
	...
	else
	{
		...
		iVar2 = 0;
		func_41(&iVar2);
		iVar3 = func_40(Var1, Global_113386.f_7688.f_765[iVar2 /*10*/]);
		if (iVar3 == 2)
		{
			func_38(Global_113386.f_7688.f_765[iVar2 /*10*/]);
		...
		else if (iVar3 == 1)
		{
			...
			{
				if (!func_36(Global_113386.f_7688.f_765[iVar2 /*10*/]))
				{
					Global_113386.f_7688.f_765[iVar2 /*10*/] = { Var1 };
					func_37(&Var1);
					return 1;
...
void func_41(int iParam0)//Position - 0x4999
{
	...
	*iParam0 = 0;
	...
	{
		if (func_40(Global_113386.f_7688.f_765[iVar0 /*10*/], Global_113386.f_7688.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
bool func_50()//Position - 0x4EBB
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_51(int iParam0, int iParam1)//Position - 0x4ED5
{
	bool bVar0;
...
int func_52(int iParam0, bool bParam1)//Position - 0x4F20
{
	int iVar0;
	int iVar1;
...
int func_53()//Position - 0x4F61
{
	return Global_1574918;
}

int func_54(int iParam0)//Position - 0x4F6D
{
...
bool func_55()//Position - 0x4FAC
{
	return BitTest(Global_2621446, 3);
}

int func_56(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x4FBA
{
	int iVar0;
...
void func_58(int iParam0)//Position - 0x5014
{
	if (iParam0 == 1)
	{
...
void func_59(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x5037
{
	int iVar0;
...
void func_60(int iParam0, bool bParam1)//Position - 0x51F5
{
...
Vector3 func_61(int iParam0)//Position - 0x5231
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_62(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x5244
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_78130[1 /*14*/] = { func_113(iVar10, iParam1, iParam2, -1) };
		if (!func_112(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78130[1 /*14*/] = { func_113(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_113(iVar10, 14, uVar12[iVar1], -1) };
							func_82(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
							func_105(14);
							if (Global_78128 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_72(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
						}
						func_105(iVar0);
						if (Global_78128 == 1)
						{
			...
			{
				Global_78130[1 /*14*/] = { func_113(iVar10, iVar0, func_71(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_113(iVar10, 14, uVar15[iVar1], -1) };
			func_82(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_105(14);
			if (Global_78128 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_72(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
		}
		if (Global_78128 == 1)
		{
			iVar2 = 0;
...
int func_63(int iParam0, int iParam1, int iParam2)//Position - 0x5A54
{
	int iVar0;
...
int func_64(int iParam0)//Position - 0x5AE0
{
	switch (iParam0)
	{
...
void func_65(int iParam0, int iParam1, int iParam2)//Position - 0x5B1B
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0, int iParam1, int iParam2)//Position - 0x5BA5
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_67(int iParam0, int iParam1, int iParam2)//Position - 0x5C83
{
	Global_78130[1 /*14*/] = { func_113(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78130[1 /*14*/].f_6, 2);
}

int func_68(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x5CAB
{
	var uVar0;
	int iVar1;
...
int func_69(int iParam0, int iParam1, int iParam2)//Position - 0x62AF
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6348
{
	int iVar0;
...
int func_71(int iParam0, int iParam1, int iParam2)//Position - 0x63DE
{
	int iVar0;
	int iVar1;
...
int func_72(int iParam0)//Position - 0x647F
{
	switch (iParam0)
	{
		case 0:
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x652F
{
	int iVar0;
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x6836
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x73E9
{
	int iVar0;
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x76CD
{
	int iVar0;
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7994
{
	int iVar0;
	int iVar1;
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x79CB
{
	int iVar0;
...
int func_79(int iParam0, int iParam1, int iParam2)//Position - 0x79F4
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7CBE
{
	int iVar0;
...
int func_81(int iParam0, int iParam1, int iParam2)//Position - 0x7F48
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x80A2
{
	int iVar0;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x813A
{
	switch (iParam0)
	{
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8208
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_85(int iParam0, int iParam1)//Position - 0x8322
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_86(int iParam0)//Position - 0x86C9
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x872A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_88(int iParam0, int iParam1)//Position - 0x8826
{
	int iVar0;
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8964
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_90(int iParam0)//Position - 0x8A1F
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_91(int iParam0)//Position - 0x8A7E
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_92(int iParam0, int iParam1)//Position - 0x8B04
{
	int iVar0;
	struct<10> Var1;
...
void func_93(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9433
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var2;
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x955D
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_95(int iParam0, int iParam1)//Position - 0x95A5
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_98(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[0], Global_113386.f_2363.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_98(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[1], Global_113386.f_2363.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_98(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[2], Global_113386.f_2363.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_96(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB3ED
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var2;
...
int func_97(int iParam0)//Position - 0xB5D7
{
	switch (iParam0)
	{
		case 0:
...
void func_98(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xB687
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB6F8
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_100(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB975
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBD9A
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_102(int iParam0, int iParam1)//Position - 0xC08E
{
	int iVar0;
	int iVar1;
...
int func_103(int iParam0, int iParam1)//Position - 0xC0D4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC134
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_105(int iParam0)//Position - 0xC18B
{
	if (BitTest(Global_78130[1 /*14*/].f_6, 1) && !BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
		func_111(iParam0, Global_78130[1 /*14*/].f_5, Global_78130[1 /*14*/].f_2, 2, Global_78130[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_78130[1 /*14*/].f_6, 1) && BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_106(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xC237
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_107(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xC281
{
	int iVar0;
	...
	iVar0 = Global_2826809[iParam0 /*3*/][func_108(iParam2)];
	if (iVar0 != 0)
	{
...
int func_108(var uParam0)//Position - 0xC2B1
{
	int iVar0;
	int iVar1;
...
int func_109(int iParam0, int iParam1, int iParam2)//Position - 0xC2E5
{
	int iVar0;
	var uVar1;
...
bool func_110(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xC322
{
	int iVar0;
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE873
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_112(int iParam0)//Position - 0xF716
{
	if (!BitTest(Global_78130[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_113(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF75E
{
	func_176();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_114(int iParam0, int iParam1)//Position - 0xF7B0
{
	switch (iParam0)
	{
		case 0:
...
void func_115(int iParam0)//Position - 0xF8A0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_116(&(Global_78130[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_116(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x10AD1
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_109(func_119(iParam1, uParam0->f_2), Global_78127, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_109(func_118(iParam1, uParam0->f_2), Global_78127, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_109(iVar1, Global_78127, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_117(int iParam0, int iParam1, var uParam2)//Position - 0x10E75
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_118(int iParam0, int iParam1)//Position - 0x1127A
{
	switch (iParam1)
	{
		case 0:
...
int func_119(int iParam0, int iParam1)//Position - 0x11675
{
	switch (iParam1)
	{
		case 0:
...
int func_120(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x11A70
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_121(int iParam0)//Position - 0x11AAF
{
	switch (iParam0)
	{
		case -1:
...
void func_122(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11B83
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar3 >= 0)
		{
			...
			if (iVar4 > iVar3)
			{
				...
				func_116(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_116(&(Global_78130[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_116(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_116(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
...
void func_123(int iParam0)//Position - 0x11E09
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0x11F56
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0x12463
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x124D7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0x1254A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x12631
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0x12973
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x12B7B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x12D9B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x12EA4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x13836
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x1438F
{
	if (iParam0 < 136)
	{
		func_136(iParam0);
...
void func_135(int iParam0)//Position - 0x143C4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x14FC8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x15EC8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x15FF5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0, int iParam1)//Position - 0x160EC
{
	switch (iParam0)
	{
		case 0:
...
void func_140(int iParam0)//Position - 0x161DC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x176A9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x177F0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x17CFA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x18365
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x183D8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x184A8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x189A3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x18B34
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x19323
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x1942C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1A34F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x1AFFC
{
	if (iParam0 < 107)
	{
		func_155(iParam0);
...
void func_153(int iParam0)//Position - 0x1B042
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1BAE6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1C8D7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1D516
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x1D78E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0, int iParam1)//Position - 0x1D8CA
{
	switch (iParam0)
	{
		case 0:
...
void func_159(int iParam0)//Position - 0x1D9BA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1E718
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1E887
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x1EDF8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x1F320
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1F393
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1F463
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1F913
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x1FB6E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x1FE2E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x1FFE9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x20B30
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x21762
{
	if (iParam0 < 60)
	{
		func_173(iParam0);
...
void func_172(int iParam0)//Position - 0x21797
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x2252A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x22BAC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x22C92
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176()//Position - 0x22D89
{
...
int func_177(int iParam0, int iParam1, int iParam2)//Position - 0x22E01
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_78130[1 /*14*/] = { func_113(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_78130[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_177(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_177(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_78130[2 /*14*/] = { func_113(iVar0, 14, iVar4, -1) };
									if (Global_78130[2 /*14*/].f_12 == iVar3)
									{
										if (func_177(iParam0, 14, iVar4))
										{
											if (!func_68(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_78130[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_78130[2 /*14*/] = { func_113(iVar0, iVar2, iVar1, -1) };
						if (!func_68(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_78130[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_78130[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_72(iParam1)) && Global_78130[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_72(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_178(bool bParam0)//Position - 0x23059
{
	int iVar0;
...
void func_179(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x23098
{
	func_180(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_180(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x230C1
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_181(struct<3> Param0)//Position - 0x234B7
{
...
int func_182(int iParam0, int iParam1, bool bParam2)//Position - 0x234E1
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_183(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2354F
{
...
int func_184(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x23628
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_185(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x2391E
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_186(struct<3> Param0)//Position - 0x239D2
{
	float fVar0;
	float fVar1;
...
void func_187(int iParam0)//Position - 0x23A11
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_188()//Position - 0x23A76
{
	int iVar0;
...
int func_189()//Position - 0x23A96
{
	return func_190(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_190(char* sParam0, int iParam1)//Position - 0x23AA7
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_191(int iParam0, var uParam1)//Position - 0x23AF0
{
	switch (iParam0)
	{
		case 0:
...
int func_193(int iParam0)//Position - 0x24DC9
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_194(int iParam0)//Position - 0x2510F
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_195(int iParam0)//Position - 0x25147
{
	struct<2> Var0;
...
void func_196(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x25593
{
...
void func_197(var uParam0, bool bParam1)//Position - 0x255B3
{
	func_198(&(uParam0->f_41), bParam1);
}

void func_198(var uParam0, bool bParam1)//Position - 0x255C5
{
	int iVar0;
...
void func_199(int* iParam0, bool bParam1)//Position - 0x25603
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_200(int* iParam0)//Position - 0x2563E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_201(var uParam0, bool bParam1)//Position - 0x25669
{
	func_202(&(uParam0->f_35), bParam1);
}

void func_202(var uParam0, bool bParam1)//Position - 0x2567B
{
	int iVar0;
...
void func_203(int* iParam0)//Position - 0x256B8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_204(int* iParam0)//Position - 0x256F0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_205(int iParam0)//Position - 0x2578C
{
	if (func_45(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_206(var uParam0, int iParam1)//Position - 0x257B6
{
	func_207(&(uParam0->f_28), iParam1);
}

void func_207(var uParam0, int iParam1)//Position - 0x257C8
{
	int iVar0;
...
void func_208(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x25809
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_209(int* iParam0)//Position - 0x25859
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_210(var uParam0, bool bParam1, bool bParam2)//Position - 0x2589A
{
	int iVar0;
...
int func_211(int iParam0, float fParam1, int iParam2)//Position - 0x2598F
{
	int iVar0;
...
bool func_212()//Position - 0x25A63
{
	bool bVar0;
...
void func_213()//Position - 0x25A86
{
	Global_20471 = 0;
	func_214();
}

void func_214()//Position - 0x25A96
{
...
void func_216()//Position - 0x25B0F
{
...
int func_217(int iParam0, int iParam1)//Position - 0x25B60
{
	if (func_48(iParam0))
	{
...
int func_218(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x25B93
{
...
void func_219(int iParam0)//Position - 0x25D2B
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_220(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x25D57
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78573 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_223(Global_78574, Global_78576, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
void func_221()//Position - 0x2603C
{
	if (Global_78573 != 6)
	{
	}
...
float func_222(char* sParam0)//Position - 0x26074
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_223(int iParam0, int iParam1, int iParam2)//Position - 0x26087
{
	struct<2> Var0;
	int iVar1;
...
char* func_224(int iParam0)//Position - 0x2615E
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_225(int iParam0)//Position - 0x262B1
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_226(int iParam0)//Position - 0x262E5
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_227(int iParam0)//Position - 0x26319
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_228(int iParam0)//Position - 0x2634D
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_229(int iParam0)//Position - 0x26381
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_230(int iParam0)//Position - 0x263BF
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_231(int iParam0)//Position - 0x263F3
{
	struct<2> Var0;
...
int func_232(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2645C
{
	if (((!func_235(0) || Global_78588) || Global_78577 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78573)
...
bool func_233(bool bParam0)//Position - 0x26574
{
	if (bParam0)
	{
...
int func_234(int iParam0)//Position - 0x2659D
{
	if (iParam0 == 1)
	{
...
int func_235(int iParam0)//Position - 0x265F4
{
	if (Global_43052 == 15)
	{
		return 0;
...
bool func_236(int iParam0)//Position - 0x26616
{
	return func_237(iParam0, Global_43052);
}

int func_237(int iParam0, int iParam1)//Position - 0x26627
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_238(char* sParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x26808
{
	int iVar0;
...
void func_239(char* sParam0, bool bParam1)//Position - 0x2686D
{
	func_178(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

int func_240(var uParam0)//Position - 0x26883
{
	switch (iLocal_80)
	{
		case 0:
...
void func_241(int iParam0, bool bParam1)//Position - 0x26948
{
	char* sVar0;
	int iVar1;
...
int func_242(int iParam0)//Position - 0x269EE
{
	struct<2> Var0;
...
struct<2> func_243(int iParam0)//Position - 0x26A1F
{
	struct<2> Var0;
...
void func_244(int iParam0, bool bParam1)//Position - 0x26A4C
{
	struct<2> Var0;
...
var func_245(int iParam0, int iParam1)//Position - 0x26A8F
{
	struct<5> Var0;
...
struct<5> func_246(int iParam0)//Position - 0x26AB4
{
	struct<5> Var0;
	struct<3> Var1;
...
struct<6> func_247(int iParam0, bool bParam1)//Position - 0x2932D
{
	struct<6> Var0;
...
void func_248(int iParam0, int iParam1)//Position - 0x29EE3
{
...
void func_250()//Position - 0x29F4C
{
	int iVar0;
...
int func_252(int iParam0, int iParam1, int iParam2, char* sParam3)//Position - 0x2A06E
{
	int iVar0;
	int iVar1;
	...
	while (iVar1 < 8)
	{
		...
		{
			if (Global_54980[iVar0 /*53*/] == iParam1 && Global_54980[iVar0 /*53*/].f_1 == iParam2)
			{
				if (iParam0 == Global_54980[iVar0 /*53*/].f_3)
				{
					Global_54980[iVar0 /*53*/].f_5 = 1;
					StringCopy(&(Global_54980[iVar0 /*53*/].f_6), sParam3, 16);
				}
				return 1;
			}
		}
...
int func_253(int iParam0, int iParam1, int iParam2)//Position - 0x2A0EA
{
	int iVar0;
	int iVar1;
...
int func_254(int iParam0, bool bParam1)//Position - 0x2A205
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
int func_255(int iParam0)//Position - 0x2A41D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_256()//Position - 0x2A481
{
	int iVar0;
...
void func_257(int iParam0, bool bParam1)//Position - 0x2A4BF
{
	int iVar0;
	char* sVar1;
	...
	{
		func_296(&(Global_112473[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_259(int iParam0, int iParam1, int iParam2)//Position - 0x2A63E
{
	bool bVar0;
...
void func_260()//Position - 0x2A724
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	{
		func_323(13, SYSTEM::FLOOR(Global_113386.f_10194.f_3853));
	}
...
void func_261(int iParam0, bool bParam1, int iParam2)//Position - 0x2ABE2
{
	if (iParam2 == -1)
	{
		iParam2 = func_53();
...
void func_262()//Position - 0x2AC00
{
	func_279();
	func_271();
	func_267();
...
void func_263(int iParam0)//Position - 0x2AC59
{
	if (iParam0 == 1)
	{
...
void func_264()//Position - 0x2AC82
{
...
void func_265()//Position - 0x2ACA0
{
	StringCopy(&Global_78551, "", 16);
	StringCopy(&Global_78555, "", 16);
}

void func_266()//Position - 0x2ACBC
{
	int iVar0;
...
void func_267()//Position - 0x2ACE1
{
	Global_100441 = 13;
	Global_100441.f_1 = -1;
	Global_100441.f_2 = 0;
...
void func_270(int iParam0)//Position - 0x2AD8E
{
	if (iParam0 == 1)
	{
		Global_43601 = 1;
...
void func_271()//Position - 0x2ADA7
{
	func_272(&Global_106934);
}

void func_272(var uParam0)//Position - 0x2ADB7
{
	int iVar0;
	int iVar1;
...
void func_273(var uParam0)//Position - 0x2B347
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_274(var uParam0)//Position - 0x2B362
{
...
void func_275(var uParam0)//Position - 0x2B391
{
	int iVar0;
...
void func_276(var uParam0)//Position - 0x2B442
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_277(var uParam0)//Position - 0x2B460
{
	int iVar0;
...
void func_278(var uParam0)//Position - 0x2B541
{
	*uParam0 = -15;
}

void func_279()//Position - 0x2B54F
{
	StringCopy(&Global_103942, "", 32);
	func_272(&Global_103950);
}

void func_280()//Position - 0x2B569
{
...
void func_281()//Position - 0x2B5E6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_282(int iParam0, int iParam1, int iParam2)//Position - 0x2B6A7
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	else
	{
		...
		Global_78130[1 /*14*/] = { func_113(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_72(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_72(iParam1), Global_78130[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, 0);
		}
	}
...
void func_283(char* sParam0, var uParam1)//Position - 0x2B863
{
...
void func_285(int iParam0, int iParam1)//Position - 0x2B8FA
{
...
void func_286(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2B944
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_287(int iParam0, bool bParam1, bool bParam2)//Position - 0x2B9E1
{
	struct<4> Var0;
	char* sVar1;
	...
	if (iParam0 != -1)
	{
		...
		func_288(&sVar1, Var0.f_3, Global_100478, bParam1, bParam2);
	}
}

void func_288(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x2BA20
{
...
void func_289(int iParam0)//Position - 0x2BA65
{
	Global_43603 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_290()//Position - 0x2BA77
{
	if (Global_97753)
	{
		func_8();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_291(Global_113386.f_2363.f_539.f_4321));
	}
	else
	{
...
char* func_291(var uParam0)//Position - 0x2BAAA
{
	uParam0 = uParam0;
	return "";
}

void func_292()//Position - 0x2BABA
{
	char cVar0[24];
...
bool func_293()//Position - 0x2BAFD
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_294()//Position - 0x2BB13
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_295(int iParam0, int iParam1)//Position - 0x2BB29
{
	Global_97748 = iParam0;
	Global_97749 = iParam1;
}

void func_296(var uParam0)//Position - 0x2BB3D
{
	if (*uParam0 == -1)
	{
		return;
...
void func_297(int iParam0, bool bParam1)//Position - 0x2BB7A
{
	struct<26> Var0;
	int iVar1;
	bool bVar2;
...
int func_298(int iParam0)//Position - 0x2BCF8
{
	switch (iParam0)
	{
		case 0:
...
void func_299(int iParam0)//Position - 0x2C07F
{
	func_301(iParam0, 1);
	Global_113386.f_18574[iParam0 /*6*/].f_3 = func_300();
	Global_113386.f_18574.f_380++;
}

int func_300()//Position - 0x2C0B5
{
	return (Global_113386.f_10016.f_21 + Global_113386.f_18574.f_380);
}

void func_301(var uParam0, bool bParam1)//Position - 0x2C0D1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_302(int iParam0)//Position - 0x2C3F5
{
...
void func_303(int iParam0)//Position - 0x2C428
{
	switch (iParam0)
	{
		case 30:
...
void func_304(int iParam0, bool bParam1)//Position - 0x2C45D
{
	if (iParam0 == -1)
	{
		return;
...
void func_305(int iParam0, int iParam1, bool bParam2)//Position - 0x2C4BA
{
	if (iParam0 == -1)
	{
		return;
...
int func_306(int iParam0, int iParam1)//Position - 0x2C4F5
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_307(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x2C515
{
	if (iParam0 != 198)
	{
		if (Global_78319)
...
void func_308(int iParam0, int iParam1)//Position - 0x2C56D
{
	switch (iParam0)
	{
		case 12:
...
void func_309(int iParam0, bool bParam1)//Position - 0x2C656
{
	if (bParam1)
	{
...
bool func_310(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x2C67F
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_311(var uParam0, int iParam1)//Position - 0x2CFE4
{
	int iVar0;
...
int func_312(int iParam0)//Position - 0x30860
{
	switch (iParam0)
	{
		case 46:
...
void func_313(int iParam0, bool bParam1)//Position - 0x3094F
{
	switch (iParam0)
	{
		case 46:
...
void func_314(int iParam0, bool bParam1)//Position - 0x309A0
{
	int iVar0;
...
void func_315(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x30A07
{
	func_316(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_316(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x30A29
{
	int iVar0;
...
void func_317()//Position - 0x30BFD
{
	int iVar0;
...
int func_318(int iParam0)//Position - 0x30D14
{
	int iVar0;
	int iVar1;
...
void func_319(char* sParam0)//Position - 0x30D54
{
...
char* func_320(int iParam0)//Position - 0x30D7C
{
	switch (iParam0)
	{
		case 0:
...
int func_321(int iParam0)//Position - 0x30F6C
{
...
int func_322(char* sParam0)//Position - 0x30F96
{
	int iVar0;
...
int func_323(int iParam0, int iParam1)//Position - 0x30FF6
{
	int iVar0;
...
void func_324(int iParam0, int iParam1, bool bParam2)//Position - 0x31047
{
	int iVar0;
...
void func_325()//Position - 0x311BF
{
	char cVar0[64];
	char cVar1[64];
	char* sVar2;
...
struct<4> func_326(int iParam0)//Position - 0x3123E
{
	return Global_1998[iParam0 /*29*/].f_3;
}

int func_327(int iParam0, int iParam1)//Position - 0x31251
{
...
int func_328(int iParam0, int iParam1)//Position - 0x3127B
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_329(int iParam0, int iParam1, int iParam2)//Position - 0x312A5
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_330(int iParam0, int iParam1, int iParam2)//Position - 0x312EA
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_331()//Position - 0x3132F
{
	if (func_13(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_332(bool bParam0)//Position - 0x313D1
{
	int iVar0;
...
void func_333(char* sParam0, int iParam1)//Position - 0x314A1
{
	if (Global_100441 != 12)
	{
...
int func_334(char* sParam0, int iParam1, int iParam2)//Position - 0x314C9
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
...
int func_335(char* sParam0)//Position - 0x31658
{
...
int func_336()//Position - 0x316B2
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_337(&(Global_100441.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_337(char* sParam0, bool bParam1)//Position - 0x316D6
{
	int iVar0;
	int iVar1;
...
int func_338(int iParam0, bool bParam1)//Position - 0x31700
{
	int iVar0;
...
int func_340()//Position - 0x31786
{
	...
	{
		if (func_335(&(Global_100441.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_341(bool bParam0)//Position - 0x317F2
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_342(int iParam0)//Position - 0x31806
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_343(int iParam0)//Position - 0x31840
{
	if (iParam0 == 1)
	{
...
void func_344()//Position - 0x3187A
{
	Global_23011.f_5 = 1;
}

void func_345()//Position - 0x31888
{
	Global_23011.f_5 = 0;
}

void func_346(bool bParam0)//Position - 0x31896
{
	if (bParam0)
	{
		func_347();
...
void func_347()//Position - 0x318F9
{
...
void func_348(int iParam0)//Position - 0x31922
{
	if (func_351())
	{
		return;
...
void func_349(bool bParam0, bool bParam1)//Position - 0x319AC
{
	if (bParam0)
	{
		if (func_234(0))
...
bool func_350()//Position - 0x31A20
{
	return BitTest(Global_1958711, 5);
}

bool func_351()//Position - 0x31A2E
{
	return BitTest(Global_1958711, 19);
}

void func_352()//Position - 0x31A3D
{
	Global_94617 = 0;
	Global_94618 = 0;
}

int func_353()//Position - 0x31A4F
{
...
void func_354()//Position - 0x31A8D
{
	Global_100476 = 1;
...
void func_355(char* sParam0)//Position - 0x31B82
{
...
void func_356(var uParam0)//Position - 0x31B94
{
...
void func_357(var uParam0)//Position - 0x31BB4
{
	int iVar0;
...
int func_358(int iParam0)//Position - 0x31BEE
{
	if (!func_9(iParam0))
	{
		return func_12(iParam0);
