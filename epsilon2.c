...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	uLocal_83 = func_358(60);
	uLocal_84 = func_358(14);
	...
	{
		func_355("Force cleanup [TERMINATING]");
		if (iLocal_147 != 1)
		{
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		func_220(Local_86.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_147)
		{
			case 0:
				func_46();
	...
	switch (iLocal_148)
	{
		...
		case 1:
			if (func_45(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!iLocal_155 && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 240.98317f, 358.86887f, 103.600464f, 246.0318f, 374.34146f, 109.65059f, 9f, false, true, 0))
				{
...
void func_8()//Position - 0x970
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_11(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_9(iVar0) && (!func_13(14) || Global_112599))
			{
...
void func_17(int iParam0, var uParam1)//Position - 0xD96
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_18(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_91469[26 /*34*/].f_6) == 0)
			{
				Global_113648.f_7263[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_113648.f_7263[iParam0], true, true);
			}
...
int func_35(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x46C5
{
	...
	else
	{
		...
		iVar20 = 0;
		func_41(&iVar20);
		iVar21 = func_40(Var10, Global_113648.f_7690.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_38(Global_113648.f_7690.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_36(Global_113648.f_7690.f_765[iVar20 /*10*/]))
				{
					Global_113648.f_7690.f_765[iVar20 /*10*/] = { Var10 };
					func_37(&Var10);
					return 1;
...
void func_41(int iParam0)//Position - 0x4999
{
	...
	*iParam0 = 0;
	...
	{
		if (func_40(Global_113648.f_7690.f_765[iVar0 /*10*/], Global_113648.f_7690.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
void func_46()//Position - 0x4AFC
{
	switch (iLocal_148)
	{
		case 0:
			...
			{
				func_210(&Local_86, 0, 1);
				func_196(&Local_86, 1, 0, 0);
				Global_8258 = 1;
				func_188();
				RECORDING::REPLAY_START_EVENT(1);
				CUTSCENE::START_CUTSCENE(0);
				SYSTEM::WAIT(0);
				func_179(237.43327f, 359.0111f, 104.15104f, 245.55893f, 356.5846f, 108.070114f, 6.5f, 233.9369f, 359.3106f, 104.7277f, 255.3827f, 1, 1, 1, 0, 0);
				func_179(241.85774f, 360.6711f, 104.23901f, 245.36505f, 372.3802f, 108.03018f, 10f, 233.9369f, 359.3106f, 104.7277f, 255.3827f, 1, 1, 1, 0, 0);
...
void func_49(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x4D78
{
	...
	else
	{
		...
		{
			if ((((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_54(PLAYER::PLAYER_ID())) && !func_51(PLAYER::PLAYER_ID(), 0)) && !func_50()) && !bParam4) && !bParam5) && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
			{
...
int func_52(int iParam0, bool bParam1)//Position - 0x4F2A
{
	int iVar0;
	int iVar1;
...
int func_53()//Position - 0x4F6B
{
	return Global_1574918;
}

int func_54(int iParam0)//Position - 0x4F77
{
...
bool func_55()//Position - 0x4FB6
{
	return BitTest(Global_2621446, 3);
}

int func_56(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x4FC4
{
	int iVar0;
...
void func_58(int iParam0)//Position - 0x501E
{
	if (iParam0 == 1)
	{
...
void func_59(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x5041
{
	int iVar0;
...
void func_60(int iParam0, bool bParam1)//Position - 0x51FF
{
...
Vector3 func_61(int iParam0)//Position - 0x523B
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_62(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x524E
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_78341[1 /*14*/] = { func_113(iVar10, iParam1, iParam2, -1) };
		if (!func_112(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		if (iParam7 == 1)
		{
			...
			{
				iVar5 = func_103(iParam0, 8);
				if (iVar5 != 9)
				{
					iVar5 = -99;
				}
			}
			iVar6 = func_103(iParam0, 9);
			...
			iVar7 = func_102(iParam0, 1);
			if (!func_101(iVar10, 14, iVar7, -1))
			{
				iVar7 = -99;
			}
			iVar8 = func_102(iParam0, 0);
			if (!func_100(iVar10, 14, iVar8, -1) && !func_99(iVar10, 14, iVar8, -1))
			{
				iVar8 = -99;
			}
			if (iVar10 == joaat("Player_One"))
			{
				iVar9 = func_102(iParam0, 2);
			}
		}
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78341[1 /*14*/] = { func_113(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						{
							uVar28 = { func_92(iVar10, uVar11[iVar0]) };
						}
						iVar1 = 0;
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_113(iVar10, 14, uVar28[iVar1], -1) };
							func_82(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
							func_105(14);
							if (Global_78339 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iVar0), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_72(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iVar0), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
						}
						func_105(iVar0);
						if (Global_78339 == 1)
						{
			...
			{
				Global_78341[1 /*14*/] = { func_113(iVar10, iVar0, func_71(iParam0, iVar0, -1), -1) };
		...
		if (iParam7 == 1)
		{
			Var55 = { func_113(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var55 = { func_113(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var55 = { func_113(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var55 = { func_113(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var55 = { func_113(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	{
		uVar69 = { func_92(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_113(iVar10, 14, uVar69[iVar1], -1) };
			func_82(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_105(14);
			if (Global_78339 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_72(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
		}
		if (Global_78339 == 1)
		{
			iVar2 = 0;
...
int func_63(int iParam0, int iParam1, int iParam2)//Position - 0x5A5F
{
	int iVar0;
	...
	{
		if (!func_177(iParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_64, Global_113648.f_2365.f_539[iVar0 /*65*/].f_63))
		{
...
int func_64(int iParam0)//Position - 0x5AEB
{
	switch (iParam0)
	{
...
void func_65(int iParam0, int iParam1, int iParam2)//Position - 0x5B26
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0, int iParam1, int iParam2)//Position - 0x5BB0
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_67(int iParam0, int iParam1, int iParam2)//Position - 0x5C8E
{
	Global_78341[1 /*14*/] = { func_113(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78341[1 /*14*/].f_6, 2);
}

int func_68(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x5CB6
{
	var uVar0;
	int iVar10;
	...
	if (iParam0 == joaat("Player_Zero"))
	{
		if (func_101(iParam0, iParam2, iParam3, -1))
		{
...
int func_69(int iParam0, int iParam1, int iParam2)//Position - 0x62BA
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6353
{
	int iVar0;
	...
	{
		if (!func_177(iParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_61, Global_113648.f_2365.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_71(int iParam0, int iParam1, int iParam2)//Position - 0x63FE
{
	int iVar0;
	int iVar1;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		else if (iParam1 == 14)
		{
			...
			{
				return func_102(iParam0, iParam2);
			}
		}
		else
		{
...
int func_72(int iParam0)//Position - 0x649F
{
	switch (iParam0)
	{
		case 0:
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x654F
{
	int iVar0;
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x6856
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam4 == 0)
	{
		...
		{
			case 2:
				iVar1 = func_103(iParam0, 1);
				iVar0 = func_81(iParam1, iParam3, iVar1);
				break;
			
			case 1:
				iVar2 = func_103(iParam0, 2);
				...
				switch (iParam4)
				{
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							{
								iVar5 = iParam3;
								iVar4 = func_103(iParam0, 3);
							}
							else if (iParam2 == 3)
							{
								iVar4 = iParam3;
								iVar5 = func_103(iParam0, 11);
								iVar5 = func_76(iParam1, iVar4, iVar5, 0);
							}
							iVar3 = func_103(iParam0, 8);
					...
					case 11:
						if (iParam2 == 3)
						{
							...
							{
								iVar7 = func_103(iParam0, 8);
								iVar8 = func_103(iParam0, 11);
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x7409
{
	int iVar0;
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x76ED
{
	int iVar0;
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x79B4
{
	int iVar0;
	int iVar1;
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x79EB
{
	int iVar0;
...
int func_79(int iParam0, int iParam1, int iParam2)//Position - 0x7A14
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7CDE
{
	int iVar0;
...
int func_81(int iParam0, int iParam1, int iParam2)//Position - 0x7F68
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x80C1
{
	int iVar0;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x815B
{
	switch (iParam0)
	{
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8229
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_85(int iParam0, int iParam1)//Position - 0x8343
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_86(int iParam0)//Position - 0x86EA
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x874B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_88(int iParam0, int iParam1)//Position - 0x8847
{
	int iVar0;
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8985
{
	struct<2> Var0;
	int iVar15;
	int iVar16;
	...
	else
	{
		...
		if (iVar18 != -1)
		{
			return (func_85(iParam0, func_72(iParam2)) + iVar18);
		}
	}
	return -99;
}

int func_90(int iParam0)//Position - 0x8A40
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_91(int iParam0)//Position - 0x8A9F
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_92(int iParam0, int iParam1)//Position - 0x8B25
{
	int iVar0;
	struct<10> Var1;
...
void func_93(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9454
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x957E
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_95(int iParam0, int iParam1)//Position - 0x95C6
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_98(&Var1, -99, -99, Global_113648.f_2365.f_539.f_196[0], Global_113648.f_2365.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_98(&Var1, -99, -99, Global_113648.f_2365.f_539.f_196[1], Global_113648.f_2365.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_98(&Var1, -99, -99, Global_113648.f_2365.f_539.f_196[2], Global_113648.f_2365.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_96(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB40E
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_97(Var16.f_2)] = Var16.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_97(Var16.f_2)] = func_89(iParam1, Var16.f_0, func_97(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
					(*uParam0)[func_97(Var16.f_2)] = Var16.f_1;
				}
			}
			iVar36++;
		}
...
int func_97(int iParam0)//Position - 0xB5F8
{
	switch (iParam0)
	{
		case 0:
...
void func_98(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xB6A8
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB719
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_84(iParam0, iParam2, 14, 3), joaat("HAT_MENU"), 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_84(iParam0, iParam2, 1, 3), joaat("HAT_MENU"), 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_84(iParam0, iParam2, 14, 4), joaat("HAT_MENU"), 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_84(iParam0, iParam2, 1, 4), joaat("HAT_MENU"), 0));
					}
					break;
			}
			break;
...
int func_100(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB996
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBDBB
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_102(int iParam0, int iParam1)//Position - 0xC0B0
{
	int iVar0;
	int iVar1;
...
int func_103(int iParam0, int iParam1)//Position - 0xC0F7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC157
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_105(int iParam0)//Position - 0xC1AE
{
	if (BitTest(Global_78341[1 /*14*/].f_6, 1) && !BitTest(Global_78341[1 /*14*/].f_6, 6))
	{
		func_111(iParam0, Global_78341[1 /*14*/].f_5, Global_78341[1 /*14*/].f_2, 2, Global_78341[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_78341[1 /*14*/].f_6, 1) && BitTest(Global_78341[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
		{
			func_106(Global_2883588, 2, 1, 1, -1);
		}
		else if (iParam0 == 13)
		{
		}
...
void func_106(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xC25A
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_110(iParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
		iVar3 = func_109(iVar2, iVar0, 0);
		MISC::SET_BIT(&iVar3, iVar1);
		func_107(iVar2, iVar3, iVar0, 1, 0);
	}
}

void func_107(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xC2A4
{
	int iVar0;
...
int func_108(var uParam0)//Position - 0xC2D4
{
	int iVar0;
	int iVar1;
...
int func_109(int iParam0, int iParam1, int iParam2)//Position - 0xC308
{
	int iVar0;
	var uVar1;
...
bool func_110(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xC345
{
	int iVar0;
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xEB54
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_112(int iParam0)//Position - 0xF9F7
{
	if (!BitTest(Global_78341[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_113(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xFA3F
{
	func_176();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_114(int iParam0, int iParam1)//Position - 0xFA91
{
	switch (iParam0)
	{
		case 0:
...
void func_115(int iParam0)//Position - 0xFB81
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_116(&(Global_78341[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_116(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x10DB1
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_120(Global_2883588, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_120(Global_2883588, 2, 1, 1, -1))
			{
	...
	else if (uParam0->f_5 >= 0 && uParam0->f_5 < 3)
	{
		MISC::SET_BIT(&(uParam0->f_6), 0);
		MISC::SET_BIT(&(uParam0->f_6), 5);
		if (func_111(iParam1, uParam0->f_5, uParam0->f_2, 0, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 1);
		}
		if (func_111(iParam1, uParam0->f_5, uParam0->f_2, 1, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 2);
		}
		if (!func_111(iParam1, uParam0->f_5, uParam0->f_2, 2, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 4);
		}
	}
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_109(func_119(iParam1, uParam0->f_2), Global_78338, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_109(func_118(iParam1, uParam0->f_2), Global_78338, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_109(iVar1, Global_78338, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_117(int iParam0, int iParam1, var uParam2)//Position - 0x11155
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_118(int iParam0, int iParam1)//Position - 0x1155A
{
	switch (iParam1)
	{
		case 0:
...
int func_119(int iParam0, int iParam1)//Position - 0x11955
{
	switch (iParam1)
	{
		case 0:
...
int func_120(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x11D50
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	{
		uVar3 = func_109(iVar2, iVar0, 0);
		return BitTest(uVar3, uVar1);
	}
	return 0;
}

int func_121(int iParam0)//Position - 0x11D8F
{
	switch (iParam0)
	{
		case -1:
...
void func_122(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11E63
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_116(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_116(&(Global_78341[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_116(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_116(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_123(int iParam0)//Position - 0x120E9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0x12236
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0x12743
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x127B7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0x1282A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x12911
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0x12C53
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x12E5B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x1307B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x13184
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x13B16
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x14670
{
	if (iParam0 < 136)
	{
		func_136(iParam0);
...
void func_135(int iParam0)//Position - 0x146A5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x152A9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x161A9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x162D6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0, int iParam1)//Position - 0x163CD
{
	switch (iParam0)
	{
		case 0:
...
void func_140(int iParam0)//Position - 0x164BD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x1798A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x17AD1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x17FDB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x18645
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x186B8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x18788
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x18C83
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x18E14
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x19603
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x1970C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1A62F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x1B2DC
{
	if (iParam0 < 107)
	{
		func_155(iParam0);
...
void func_153(int iParam0)//Position - 0x1B322
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1BDC6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1CDC7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1DA06
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x1DC7E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0, int iParam1)//Position - 0x1DDBA
{
	switch (iParam0)
	{
		case 0:
...
void func_159(int iParam0)//Position - 0x1DEAA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1EC08
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1ED77
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x1F2E8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x1F810
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1F883
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1F953
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1FE03
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x2005F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x2031F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x204DA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x21020
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x21C52
{
	if (iParam0 < 60)
	{
		func_173(iParam0);
...
void func_172(int iParam0)//Position - 0x21C87
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x22A1A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x2309C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x23182
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176()//Position - 0x23279
{
...
int func_177(int iParam0, int iParam1, int iParam2)//Position - 0x232F1
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_78341[1 /*14*/] = { func_113(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_78341[1 /*14*/].f_6, 0))
	{
		return 0;
	}
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_177(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar22 = { func_92(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
							if (!func_177(iParam0, 14, uVar22[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
									Global_78341[2 /*14*/] = { func_113(iVar0, 14, iVar4, -1) };
									if (Global_78341[2 /*14*/].f_12 == iVar3)
									{
										if (func_177(iParam0, 14, iVar4))
										{
											if (!func_68(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_78341[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					{
						iVar1 = func_103(iParam0, iVar2);
						Global_78341[2 /*14*/] = { func_113(iVar0, iVar2, iVar1, -1) };
						if (!func_68(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_78341[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	{
		uVar33 = { func_92(iVar0, iParam2) };
		iVar32 = 0;
		while (iVar32 <= 8)
		{
			if (!func_177(iParam0, 14, uVar33[iVar32]))
			{
				return 0;
			}
			iVar32++;
	...
	else if (Global_78341[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_72(iParam1)) && Global_78341[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_72(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_178(bool bParam0)//Position - 0x2354A
{
	int iVar0;
...
void func_179(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x23589
{
	func_180(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_180(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x235B2
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_184(iVar0, Param0, Param3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_181(struct<3> Param0)//Position - 0x239A8
{
...
int func_182(int iParam0, int iParam1, bool bParam2)//Position - 0x239D2
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_183(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x23A40
{
...
int func_184(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x23B19
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_185(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var9) || func_185(Var18[0 /*3*/], Var18[1 /*3*/], Var9, Var15)) || func_185(Var18[0 /*3*/], Var18[1 /*3*/], Var12, Var15)) || func_185(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var12)) || func_185(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var9)) || func_185(Var18[1 /*3*/], Var18[3 /*3*/], Var9, Var15)) || func_185(Var18[1 /*3*/], Var18[3 /*3*/], Var12, Var15)) || func_185(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var12)) || func_185(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var9)) || func_185(Var18[3 /*3*/], Var18[2 /*3*/], Var9, Var15)) || func_185(Var18[3 /*3*/], Var18[2 /*3*/], Var12, Var15)) || func_185(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var12)) || func_185(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var9)) || func_185(Var18[2 /*3*/], Var18[0 /*3*/], Var9, Var15)) || func_185(Var18[2 /*3*/], Var18[0 /*3*/], Var12, Var15)) || func_185(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_185(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x23E0F
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_186(struct<3> Param0)//Position - 0x23EC3
{
	float fVar0;
	float fVar1;
...
void func_187(int iParam0)//Position - 0x23F02
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_188()//Position - 0x23F67
{
	int iVar0;
...
int func_189()//Position - 0x23F87
{
	return func_190(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_190(char* sParam0, int iParam1)//Position - 0x23F98
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_191(int iParam0, var uParam1)//Position - 0x23FE1
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_192(uParam1, "Barry3A", func_194(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_193(iParam0), 0, 1);
			break;
		...
		case 8:
			func_192(uParam1, "Dreyfuss1", func_194(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_193(iParam0), 0, 0);
			break;
		...
		case 38:
			func_192(uParam1, "Nigel1A", func_194(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_193(iParam0), 1, 1);
			break;
		...
		case 49:
			func_192(uParam1, "Paparazzo3A", func_194(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_193(iParam0), 0, 1);
			break;
		...
		case 58:
			func_192(uParam1, "Tonya1", func_194(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_193(iParam0), 0, 1);
			break;
...
int func_193(int iParam0)//Position - 0x252D1
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_194(int iParam0)//Position - 0x25617
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_195(int iParam0)//Position - 0x2564F
{
	struct<2> Var0;
...
void func_196(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x25A9B
{
	func_206(uParam0, iParam1);
	func_201(uParam0, bParam2);
	func_197(uParam0, bParam3);
}

void func_197(var uParam0, bool bParam1)//Position - 0x25ABB
{
	func_198(&(uParam0->f_41), bParam1);
}

void func_198(var uParam0, bool bParam1)//Position - 0x25ACD
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_199(uParam0[iVar0], 0);
		}
		iVar0++;
	}
}

void func_199(int* iParam0, bool bParam1)//Position - 0x25B0B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_200(int* iParam0)//Position - 0x25B46
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_201(var uParam0, bool bParam1)//Position - 0x25B71
{
	func_202(&(uParam0->f_35), bParam1);
}

void func_202(var uParam0, bool bParam1)//Position - 0x25B83
{
	int iVar0;
...
void func_203(int* iParam0)//Position - 0x25BC0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_204(int* iParam0)//Position - 0x25BF8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_205(int iParam0)//Position - 0x25C94
{
	if (func_45(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_206(var uParam0, int iParam1)//Position - 0x25CBE
{
	func_207(&(uParam0->f_28), iParam1);
}

void func_207(var uParam0, int iParam1)//Position - 0x25CD0
{
	int iVar0;
...
void func_208(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x25D11
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_209(int* iParam0)//Position - 0x25D61
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_210(var uParam0, bool bParam1, bool bParam2)//Position - 0x25DA2
{
	int iVar0;
...
int func_211(int iParam0, float fParam1, int iParam2)//Position - 0x25E97
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_218(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_217(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")))
				{
...
bool func_212()//Position - 0x25F6B
{
	bool bVar0;
...
void func_213()//Position - 0x25F8E
{
	Global_20591 = 0;
	func_214();
}

void func_214()//Position - 0x25F9E
{
...
void func_216()//Position - 0x26017
{
...
int func_217(int iParam0, int iParam1)//Position - 0x26068
{
	if (func_48(iParam0))
	{
...
int func_218(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2609B
{
...
void func_219(int iParam0)//Position - 0x26233
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_220(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2625F
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_223(Global_78814, Global_78816, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
void func_221()//Position - 0x26544
{
	if (Global_78813 != 6)
	{
	}
...
float func_222(char* sParam0)//Position - 0x2657C
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_223(int iParam0, int iParam1, int iParam2)//Position - 0x2658F
{
	struct<2> Var0;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_224(iVar2), 8);
					break;
			}
			break;
...
char* func_224(int iParam0)//Position - 0x26666
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_225(int iParam0)//Position - 0x267B9
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_226(int iParam0)//Position - 0x267ED
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_227(int iParam0)//Position - 0x26821
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_228(int iParam0)//Position - 0x26855
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_229(int iParam0)//Position - 0x26889
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_230(int iParam0)//Position - 0x268C7
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_231(int iParam0)//Position - 0x268FB
{
	struct<2> Var0;
...
int func_232(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x26964
{
	if (((!func_235(0) || Global_78828) || Global_78817 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78813)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_234(0)) || func_233(1))
			{
			}
			else
			{
...
bool func_233(bool bParam0)//Position - 0x26A7C
{
	if (bParam0)
	{
...
int func_234(int iParam0)//Position - 0x26AA5
{
	if (iParam0 == 1)
	{
...
int func_235(int iParam0)//Position - 0x26AFC
{
	if (Global_43257 == 15)
	{
		return 0;
...
bool func_236(int iParam0)//Position - 0x26B1E
{
	return func_237(iParam0, Global_43257);
}

int func_237(int iParam0, int iParam1)//Position - 0x26B2F
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_238(char* sParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x26D10
{
	int iVar0;
...
void func_239(char* sParam0, bool bParam1)//Position - 0x26D75
{
	func_178(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

int func_240(var uParam0)//Position - 0x26D8B
{
	switch (iLocal_82)
	{
		case 0:
...
void func_241(int iParam0, bool bParam1)//Position - 0x26E50
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
int func_242(int iParam0)//Position - 0x26F17
{
	struct<2> Var0;
...
struct<2> func_243(int iParam0)//Position - 0x26F48
{
	struct<2> Var0;
...
void func_244(int iParam0, bool bParam1)//Position - 0x26F75
{
	struct<2> Var0;
...
var func_245(int iParam0, int iParam1)//Position - 0x26FB8
{
	struct<5> Var0;
...
struct<5> func_246(int iParam0)//Position - 0x26FDD
{
	struct<5> Var0;
	struct<3> Var5;
...
struct<6> func_247(int iParam0, bool bParam1)//Position - 0x2990A
{
	struct<6> Var0;
...
void func_248(int iParam0, int iParam1)//Position - 0x2A4C0
{
...
void func_250()//Position - 0x2A529
{
	int iVar0;
	
	func_188();
	if (!iLocal_153 && func_255(3) == -1)
	{
		func_254(3, 0);
		iVar0 = func_253(3, 8, 1);
		func_252(iVar0, 3, 8, "EPS_EMAIL5K" /* GXT: Please visit our website at ~b~<u>www.epsilonprogram.com</u>~s~ and donate $5000. */);
		iLocal_153 = 1;
	}
...
int func_252(int iParam0, int iParam1, int iParam2, char* sParam3)//Position - 0x2A64B
{
	int iVar0;
	int iVar1;
	...
	while (iVar1 < 8)
	{
		...
		{
			if (Global_55188[iVar0 /*53*/] == iParam1 && Global_55188[iVar0 /*53*/].f_1 == iParam2)
			{
				if (iParam0 == Global_55188[iVar0 /*53*/].f_3)
				{
					Global_55188[iVar0 /*53*/].f_5 = 1;
					StringCopy(&(Global_55188[iVar0 /*53*/].f_6), sParam3, 16);
				}
				return 1;
			}
		}
...
int func_253(int iParam0, int iParam1, int iParam2)//Position - 0x2A6C7
{
	int iVar0;
	int iVar1;
...
int func_254(int iParam0, bool bParam1)//Position - 0x2A7E2
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
int func_255(int iParam0)//Position - 0x2A9FA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_256()//Position - 0x2AA5E
{
	int iVar0;
...
void func_257(int iParam0, bool bParam1)//Position - 0x2AA9C
{
	int iVar0;
	char* sVar1;
	...
	{
		func_296(&(Global_112735[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
	...
	{
		func_259(iParam0, 406.38f, -1635.86f);
	}
	else if (iParam0 == 111)
	{
		func_259(iParam0, 1973.84f, 3814.89f);
	}
	else if (iParam0 != 322)
	{
...
void func_259(int iParam0, int iParam1, int iParam2)//Position - 0x2AC1B
{
	bool bVar0;
...
void func_260()//Position - 0x2AD01
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	{
		func_323(13, SYSTEM::FLOOR(Global_113648.f_10196.f_3853));
	}
...
void func_261(int iParam0, bool bParam1, int iParam2)//Position - 0x2B1BF
{
	if (iParam2 == -1)
	{
		iParam2 = func_53();
...
void func_262()//Position - 0x2B1DD
{
	func_279();
	func_271();
	func_267();
...
void func_263(int iParam0)//Position - 0x2B236
{
	if (iParam0 == 1)
	{
...
void func_264()//Position - 0x2B25F
{
...
void func_265()//Position - 0x2B27D
{
	StringCopy(&Global_78791, "", 16);
	StringCopy(&Global_78795, "", 16);
}

void func_266()//Position - 0x2B299
{
	int iVar0;
...
void func_267()//Position - 0x2B2BE
{
	Global_100681 = 13;
	Global_100681.f_1 = -1;
	Global_100681.f_2 = 0;
...
void func_270(int iParam0)//Position - 0x2B36B
{
	if (iParam0 == 1)
	{
		Global_43806 = 1;
...
void func_271()//Position - 0x2B384
{
	func_272(&Global_107196);
}

void func_272(var uParam0)//Position - 0x2B394
{
	int iVar0;
	int iVar1;
	
	*uParam0 = 145;
	func_278(&(uParam0->f_1));
	uParam0->f_6 = -1;
	uParam0->f_7 = -1;
	uParam0->f_8 = 0f;
	uParam0->f_2 = 0;
	...
	while (iVar1 < 3)
	{
		...
		func_277(&(uParam0->f_25[0 /*295*/][iVar1 /*98*/]));
		func_277(&(uParam0->f_25[1 /*295*/][iVar1 /*98*/]));
		iVar0 = 0;
		while (iVar0 < 12)
		{
	...
	func_276(&(uParam0->f_2884));
	func_274(&(uParam0->f_2890));
	func_273(&(uParam0->f_2980));
}

void func_273(var uParam0)//Position - 0x2B924
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_274(var uParam0)//Position - 0x2B93F
{
	func_275(&(uParam0->f_12));
	*uParam0 = { 0f, 0f, 0f };
...
void func_275(var uParam0)//Position - 0x2B96E
{
	int iVar0;
...
void func_276(var uParam0)//Position - 0x2BA1F
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_277(var uParam0)//Position - 0x2BA3D
{
	int iVar0;
...
void func_278(var uParam0)//Position - 0x2BB1E
{
	*uParam0 = -15;
}

void func_279()//Position - 0x2BB2C
{
	StringCopy(&Global_104204, "", 32);
	func_272(&Global_104212);
}

void func_280()//Position - 0x2BB46
{
...
void func_281()//Position - 0x2BBC3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_282(int iParam0, int iParam1, int iParam2)//Position - 0x2BC84
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	{
		uVar21 = { func_92(iVar0, iParam2) };
		iVar19 = 0;
		while (iVar19 <= 8)
		{
			if (!func_282(iParam0, 14, uVar21[iVar19]))
			{
				iVar20 = 0;
			}
			iVar19++;
	...
	{
		uVar31 = { func_95(iVar0, 0) };
		Global_78341[1 /*14*/] = { func_113(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_72(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_72(iParam1), Global_78341[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, 0);
		}
	}
...
void func_283(char* sParam0, var uParam1)//Position - 0x2BE41
{
...
void func_285(int iParam0, int iParam1)//Position - 0x2BED8
{
...
void func_286(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2BF22
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
	...
	if (iParam1 == 1)
	{
		func_287(iParam0, bParam2, bParam3);
	}
	HUD::SET_MISSION_NAME(false, 0);
}

void func_287(int iParam0, bool bParam1, bool bParam2)//Position - 0x2BFBF
{
	struct<4> Var0;
	char* sVar32;
	...
	if (iParam0 != -1)
	{
		...
		func_288(&sVar32, Var0.f_3, Global_100718, bParam1, bParam2);
	}
}

void func_288(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x2BFFE
{
...
void func_289(int iParam0)//Position - 0x2C045
{
	Global_43808 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_290()//Position - 0x2C057
{
	if (Global_97993)
	{
		func_8();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_291(Global_113648.f_2365.f_539.f_4321));
	}
	else
	{
...
char* func_291(var uParam0)//Position - 0x2C08A
{
	uParam0 = uParam0;
	return "";
}

void func_292()//Position - 0x2C09A
{
	char cVar0[24];
	
	if (MISC::IS_XBOX360_VERSION() || func_294())
	{
		NETWORK::NETWORK_SET_RICH_PRESENCE(StackVal, 0, 0, 0);
	}
	else if (MISC::IS_PS3_VERSION() || func_293())
	{
...
bool func_293()//Position - 0x2C0DD
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_294()//Position - 0x2C0F3
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_295(int iParam0, int iParam1)//Position - 0x2C109
{
	Global_97988 = iParam0;
	Global_97989 = iParam1;
}

void func_296(var uParam0)//Position - 0x2C11D
{
	if (*uParam0 == -1)
	{
		return;
...
void func_297(int iParam0, bool bParam1)//Position - 0x2C15A
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
	...
	func_313(iParam0, Global_78828);
	if (!bParam1)
	{
		iVar32 = func_312(iParam0);
		if (iVar32 != 0)
		{
	...
	if (!BitTest(Global_113648.f_18576[iParam0 /*6*/], 3))
	{
		...
		func_299(iParam0);
		iVar102 = func_298(iParam0);
		if (iVar102 != 322)
		{
			func_259(iVar102, 0, 0);
		}
	}
}

int func_298(int iParam0)//Position - 0x2C2D8
{
	switch (iParam0)
	{
		case 0:
...
void func_299(int iParam0)//Position - 0x2C65F
{
	func_301(iParam0, 1);
	Global_113648.f_18576[iParam0 /*6*/].f_3 = func_300();
	Global_113648.f_18576.f_380++;
}

int func_300()//Position - 0x2C695
{
	return (Global_113648.f_10018.f_21 + Global_113648.f_18576.f_380);
}

void func_301(var uParam0, bool bParam1)//Position - 0x2C6B1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_302(int iParam0)//Position - 0x2C9D5
{
...
void func_303(int iParam0)//Position - 0x2CA08
{
	switch (iParam0)
	{
		case 30:
...
void func_304(int iParam0, bool bParam1)//Position - 0x2CA3D
{
	if (iParam0 == -1)
	{
		return;
...
void func_305(int iParam0, int iParam1, bool bParam2)//Position - 0x2CA9A
{
	if (iParam0 == -1)
	{
		return;
...
int func_306(int iParam0, int iParam1)//Position - 0x2CAD5
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_307(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x2CAF5
{
	if (iParam0 != 198)
	{
		if (Global_78558)
		...
		func_310(iParam0, bParam3, iParam4, 0);
		func_308(iParam0, iParam1);
	}
}

void func_308(int iParam0, int iParam1)//Position - 0x2CB4D
{
	switch (iParam0)
	{
		case 12:
...
void func_309(int iParam0, bool bParam1)//Position - 0x2CC36
{
	if (bParam1)
	{
...
bool func_310(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x2CC5F
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_311(var uParam0, int iParam1)//Position - 0x2D5C4
{
	int iVar0;
...
int func_312(int iParam0)//Position - 0x30E46
{
	switch (iParam0)
	{
		case 46:
...
void func_313(int iParam0, bool bParam1)//Position - 0x30F35
{
	switch (iParam0)
	{
		case 46:
...
void func_314(int iParam0, bool bParam1)//Position - 0x30F86
{
	int iVar0;
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (!func_321(iParam0))
		{
			...
			if (!bParam1)
			{
				func_319(func_320(iParam0));
				if (!func_318(68))
				{
					func_315("DI_HLP_STRY" /* GXT: Story characters become available in Rockstar Editor's 'Director Mode' as the GTAV story progresses. */, 2, 0, 20000, 10000, 7, 0, 208, 0);
				}
			}
		}
	}
...
void func_315(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x30FED
{
	func_316(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_316(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x3100F
{
	int iVar0;
...
void func_317()//Position - 0x311E3
{
	int iVar0;
...
int func_318(int iParam0)//Position - 0x312FA
{
	int iVar0;
	int iVar1;
...
void func_319(char* sParam0)//Position - 0x3133A
{
...
char* func_320(int iParam0)//Position - 0x31362
{
	switch (iParam0)
	{
		case 0:
...
int func_321(int iParam0)//Position - 0x31552
{
...
int func_322(char* sParam0)//Position - 0x3157C
{
	int iVar0;
...
int func_323(int iParam0, int iParam1)//Position - 0x315DC
{
	int iVar0;
...
void func_324(int iParam0, int iParam1, bool bParam2)//Position - 0x3162D
{
	int iVar0;
		...
		if (bParam2)
		{
			if (!Global_78558)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8912[iParam1 /*4*/] = { func_326(iParam0) };
					...
					{
						Global_8863[1 /*6*/] = { func_326(iParam0) };
...
void func_325()//Position - 0x317A5
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
struct<4> func_326(int iParam0)//Position - 0x31824
{
	return Global_2028[iParam0 /*29*/].f_3;
}

int func_327(int iParam0, int iParam1)//Position - 0x31837
{
...
int func_328(int iParam0, int iParam1)//Position - 0x31861
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_329(int iParam0, int iParam1, int iParam2)//Position - 0x3188B
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_330(int iParam0, int iParam1, int iParam2)//Position - 0x318D0
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_331()//Position - 0x31915
{
	if (func_13(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_332(bool bParam0)//Position - 0x319B7
{
	int iVar0;
	...
	if (!func_353())
	{
		...
		{
			func_287(iVar0, 1, 0);
			func_333(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_112735[iVar0 /*10*/].f_9 == -1)
...
void func_333(char* sParam0, int iParam1)//Position - 0x31A87
{
	if (Global_100681 != 12)
	{
		if (func_334(sParam0, 6, iParam1))
		{
...
int func_334(char* sParam0, int iParam1, int iParam2)//Position - 0x31AAF
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_335(char* sParam0)//Position - 0x31C3E
{
...
int func_337(char* sParam0, bool bParam1)//Position - 0x31CBC
{
	int iVar0;
	int iVar1;
...
int func_338(int iParam0, bool bParam1)//Position - 0x31CE6
{
	int iVar0;
...
void func_341(bool bParam0)//Position - 0x31DD8
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_342(int iParam0)//Position - 0x31DEC
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_343(int iParam0)//Position - 0x31E26
{
	if (iParam0 == 1)
	{
...
void func_344()//Position - 0x31E60
{
	Global_23131.f_5 = 1;
}

void func_345()//Position - 0x31E6E
{
	Global_23131.f_5 = 0;
}

void func_346(bool bParam0)//Position - 0x31E7C
{
	if (bParam0)
	{
		func_347();
...
void func_347()//Position - 0x31EDF
{
...
void func_348(int iParam0)//Position - 0x31F08
{
	if (func_351())
	{
		return;
...
void func_349(bool bParam0, bool bParam1)//Position - 0x31F92
{
	if (bParam0)
	{
		if (func_234(0))
...
bool func_350()//Position - 0x32006
{
	return BitTest(Global_1962996, 5);
}

bool func_351()//Position - 0x32014
{
	return BitTest(Global_1962996, 19);
}

void func_352()//Position - 0x32023
{
	Global_94857 = 0;
	Global_94858 = 0;
}

int func_353()//Position - 0x32035
{
...
void func_354()//Position - 0x32073
{
	Global_100716 = 1;
...
void func_355(char* sParam0)//Position - 0x32168
{
...
void func_356(var uParam0)//Position - 0x3217A
{
	func_357(&(uParam0->f_28));
	func_357(&(uParam0->f_35));
	func_357(&(uParam0->f_41));
}

void func_357(var uParam0)//Position - 0x3219A
{
	int iVar0;
...
int func_358(int iParam0)//Position - 0x321D4
{
	if (!func_9(iParam0))
	{
		return func_12(iParam0);
