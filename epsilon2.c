...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_81 = func_358(60);
	uLocal_82 = func_358(14);
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		func_220(Local_84.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_85)
		{
			case 0:
				func_46();
	...
	switch (iLocal_86)
	{
		...
		case 1:
			if (func_45(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!iLocal_93 && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 240.98317f, 358.86887f, 103.600464f, 246.0318f, 374.34146f, 109.65059f, 9f, false, true, 0))
				{
...
int func_35(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x46C5
{
	...
	else
	{
		...
		iVar2 = 0;
		func_41(&iVar2);
		iVar3 = func_40(Var1, Global_113648.f_7690.f_765[iVar2 /*10*/]);
		if (iVar3 == 2)
		{
			func_38(Global_113648.f_7690.f_765[iVar2 /*10*/]);
		...
		else if (iVar3 == 1)
		{
			...
			{
				if (!func_36(Global_113648.f_7690.f_765[iVar2 /*10*/]))
				{
					Global_113648.f_7690.f_765[iVar2 /*10*/] = { Var1 };
					func_37(&Var1);
					return 1;
...
int func_36(struct<9> Param0, var uParam1)//Position - 0x48E4
{
	if (Param0.f_8 == 0)
	{
		return 0;
...
int func_40(struct<4> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, struct<4> Param7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13)//Position - 0x4968
{
	int iVar0;
	int iVar1;
...
void func_46()//Position - 0x4AFC
{
	switch (iLocal_86)
	{
		case 0:
			...
			{
				func_210(&Local_84, 0, 1);
				func_196(&Local_84, 1, 0, 0);
				Global_8258 = 1;
				func_188();
...
void func_59(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x5041
{
	int iVar0;
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x524E
{
	...
	if (iParam1 == 12)
	{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_113(iVar10, 14, uVar12[iVar1], -1) };
		...
		if (iParam7 == 1)
		{
			Var14 = { func_113(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var14 = { func_113(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var14 = { func_113(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var14 = { func_113(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var14 = { func_113(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_113(iVar10, 14, uVar15[iVar1], -1) };
			func_82(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_105(14);
			if (Global_78339 == 1)
			{
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8229
{
	...
	else
	{
		...
		iVar4 = (iParam1 - func_85(iParam0, func_72(iParam2)));
		if (iVar4 < 0)
		{
			return -1;
		}
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_72(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8985
{
	...
	else
	{
		...
		if (iVar4 != -1)
		{
			return (func_85(iParam0, func_72(iParam2)) + iVar4);
		}
	}
	return -99;
}
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1.f_0))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &Var2) && Var2.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var2.f_2] = func_89(iParam1, Var2.f_0, 14, iVar0);
					}
					else if (Var2.f_1 != -1)
					{
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.f_0 != 0 && Var2.f_0 != -1) && Var2.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_97(Var2.f_2)] = func_89(iParam1, Var2.f_0, func_97(Var2.f_2), iVar0);
					}
				}
				else if (Var2.f_1 != -1)
				{
...
void func_115(int iParam0)//Position - 0xFB81
{
	...
	func_116(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_122(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11E63
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_116(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_116(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_72(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_179(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x23589
{
	func_180(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_180(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x235B2
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_184(iVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_182(int iParam0, int iParam1, bool bParam2)//Position - 0x239D2
{
	...
	iVar0 = 0;
	while (func_183(iParam1, iVar0, &sVar1, &iVar2))
	{
...
int func_184(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x23B19
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_185(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_185(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_185(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_185(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_185(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_185(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_185(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_185(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_185(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_185(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_185(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_185(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_185(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_185(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_185(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_185(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4))
		{
			return 1;
		}
	}
...
int func_185(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x23E0F
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_220(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2625F
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_223(Global_78814, Global_78816, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_224(iVar1), 8);
					break;
			}
			break;
...
int func_282(int iParam0, int iParam1, int iParam2)//Position - 0x2BC84
{
	...
	else
	{
		...
		Global_78341[1 /*14*/] = { func_113(iVar0, iParam1, uVar6[iParam1], -1) };
...
void func_287(int iParam0, bool bParam1, bool bParam2)//Position - 0x2BFBF
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&sVar1, {func_195(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&sVar1, 0, Global_100718, 0);
		func_288(&sVar1, Var0.f_3, Global_100718, bParam1, bParam2);
	}
}
...
int func_334(char* sParam0, int iParam1, int iParam2)//Position - 0x31AAF
{
	...
	if (func_340())
	{
		...
		{
			iVar2 = func_335(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
