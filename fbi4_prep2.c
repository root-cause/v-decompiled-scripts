...
void func_8(int iParam0)//Position - 0x355
{
	...
	if (Global_113810.f_9088 || func_23(0))
	{
		iVar0 = func_22();
		if (!func_9(iVar0))
		{
...
void func_16()//Position - 0x112B
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_20(Global_113810.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_18(iVar0) && (!func_17(14) || Global_112760))
			{
...
void func_50(bool bParam0, int iParam1)//Position - 0x1B9C
{
	...
	if (bParam0)
	{
		if ((func_23(0) && Global_78936.f_1 == 1) && func_51(Global_78936))
		{
		}
		else
		{
...
int func_69(int iParam0)//Position - 0x235F
{
	...
	return Global_98291[func_70(iParam0)];
}
		...
		case 0:
			...
			else if (func_125(1, Local_219, 0))
			{
				if (!func_465())
				{
					...
					{
						iLocal_289 = PED::ADD_SCENARIO_BLOCKING_AREA(-417.19797f, -2155.8857f, 8.36266f, -383.49078f, -2188.5115f, 12.9213f, false, true, true, true);
						func_123(34);
						VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("trash"), true);
						VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("towtruck"), true);
...
void func_112(int iParam0, int iParam1, int iParam2)//Position - 0x399B
{
...
void func_113(int iParam0)//Position - 0x3A5F
{
	if (iParam0 == 1)
	{
...
bool func_114()//Position - 0x3A88
{
	return BitTest(Global_100833.f_20, 13);
}

void func_115(int iParam0, struct<3> Param1, float fParam4)//Position - 0x3A99
{
	if (func_452(iParam0))
	{
...
void func_117(int* iParam0, int iParam1, bool bParam2)//Position - 0x3B1C
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_118(int iParam0, bool bParam1, int iParam2)//Position - 0x3B3B
{
	int iVar0;
...
void func_119()//Position - 0x3B70
{
	func_120(&uLocal_291);
	func_88(&uLocal_291, 3, Local_250.f_0, "FIBP2TowGuy", 1, 1);
}

void func_120(var uParam0)//Position - 0x3B8F
{
	int iVar0;
	char* sVar1;
...
void func_121()//Position - 0x3BE5
{
	iLocal_94 = 1;
}

int func_122(int iParam0, int iParam1)//Position - 0x3BF0
{
	if (func_452(iParam0))
	{
...
void func_123(int iParam0)//Position - 0x3C23
{
	if (Global_97735 != -1)
	{
...
int func_125(int iParam0, struct<3> Param1, float fParam4)//Position - 0x3C9A
{
	switch (iParam0)
	{
		case 0:
		...
		case 3:
			if (ENTITY::DOES_ENTITY_EXIST(Global_97310.f_9[0]))
			{
				if (!PED::IS_PED_DEAD_OR_DYING(Global_97310.f_9[0], true))
				{
					...
					Local_250.f_0 = Global_97310.f_9[0];
					if (func_452(Local_250.f_0))
					{
...
int func_126(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x3F6F
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_127(int iParam0, bool bParam1)//Position - 0x3FF9
{
	if (bParam1)
	{
...
int func_128(int iParam0, char* sParam1, int iParam2)//Position - 0x4020
{
...
int func_129(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x404F
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_128(iParam1, "Loading", 0))
...
void func_130(int iParam0, int iParam1)//Position - 0x4102
{
	Global_100833.f_22[iParam1] = iParam0;
}

int func_131(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x4116
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_132(int* iParam0, int iParam1, int iParam2, int* iParam3, int* iParam4, struct<3> Param5, int iParam8, bool bParam9, float fParam10)//Position - 0x4191
{
	if (func_6(*iParam0))
	{
		switch (*iParam2)
...
void func_133(int* iParam0, var uParam1)//Position - 0x4345
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_134(int* iParam0)//Position - 0x4432
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_135(int* iParam0)//Position - 0x446A
{
	int iVar0;
...
int func_136(int iParam0)//Position - 0x44C7
{
	int iVar0;
...
int func_137(int iParam0)//Position - 0x4520
{
	int iVar0;
	int iVar1;
...
int func_138(int iParam0)//Position - 0x45A3
{
	int iVar0;
	int iVar1;
...
int func_141(int iParam0)//Position - 0x47C0
{
	bool bVar0;
...
int func_142(int iParam0)//Position - 0x4815
{
	bool bVar0;
...
int func_144(int iParam0, struct<3> Param1, int* iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, float fParam11)//Position - 0x487D
{
...
bool func_145()//Position - 0x4970
{
	return Global_100885.f_393 > 0;
}

void func_146()//Position - 0x4981
{
	int iVar0;
	int iVar1;
...
int func_147(int iParam0, int iParam1)//Position - 0x4A77
{
...
int func_148(int iParam0, int iParam1)//Position - 0x4B32
{
	struct<3> Var0;
	struct<3> Var3;
	char* sVar6;
...
bool func_149(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x4D13
{
...
int func_150(int iParam0, int iParam1)//Position - 0x4D61
{
	bool bVar0;
...
int func_153(int iParam0, int iParam1)//Position - 0x4E97
{
	if (!func_152())
	{
		if (func_452(Local_250.f_0))
...
int func_154(int iParam0)//Position - 0x4F10
{
	if (iParam0 == 0)
	{
...
void func_155(int iParam0, int iParam1)//Position - 0x4F82
{
	if (iParam0 != PLAYER::PLAYER_PED_ID())
	{
...
void func_156(bool bParam0)//Position - 0x5000
{
...
void func_158(int* iParam0)//Position - 0x57F0
{
	bool bVar0;
	struct<8> Var1;
...
int func_159(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)//Position - 0x5862
{
	bool bVar0;
...
void func_161(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x5A6D
{
	func_162(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_162(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x5A87
{
	uParam0->f_6 = 0;
	func_163(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_163(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x5AA9
{
	int iVar0;
	int iVar1;
...
void func_164(var uParam0)//Position - 0x5E16
{
...
int func_165(var uParam0)//Position - 0x5E7F
{
	int iVar0;
...
int func_166(bool bParam0)//Position - 0x5EAA
{
	switch (Global_43377)
	{
		case 0:
...
void func_167(char* sParam0, int iParam1)//Position - 0x5F54
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_168(char* sParam0)//Position - 0x5F6B
{
	if (!func_169(1, 1, 0))
	{
...
int func_169(bool bParam0, bool bParam1, bool bParam2)//Position - 0x6004
{
	int iVar0;
	int iVar1;
...
int func_170(int iParam0)//Position - 0x625D
{
	if (iParam0 != func_78())
	{
...
int func_171(int iParam0, bool bParam1, bool bParam2)//Position - 0x62C3
{
	int iVar0;
...
int func_172(int iParam0, int iParam1)//Position - 0x6323
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
...
int func_173(int iParam0, bool bParam1)//Position - 0x6385
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_174()//Position - 0x640A
{
	return Global_2683883.f_19;
}

bool func_175(int iParam0)//Position - 0x6418
{
	return iParam0 == 51;
}

var func_176()//Position - 0x6425
{
	return Global_2683883.f_18;
}

bool func_177()//Position - 0x6433
{
	return MISC::GET_GAME_TIMER() <= Global_23390.f_6321 + 100;
}

void func_178(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x6448
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_179()//Position - 0x6558
{
	return func_180(PLAYER::PLAYER_ID());
}

int func_180(int iParam0)//Position - 0x6568
{
...
bool func_181(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6587
{
	if (bParam6)
	{
...
int func_182(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x65CE
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_183(bool bParam0, bool bParam1, bool bParam2)//Position - 0x693A
{
...
int func_184(bool bParam0, bool bParam1, bool bParam2)//Position - 0x698C
{
	if (!func_169(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_185(bool bParam0, bool bParam1, bool bParam2)//Position - 0x69D5
{
	if (!func_169(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_186(bool bParam0, bool bParam1, bool bParam2)//Position - 0x6A34
{
	if (!func_169(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_187(int iParam0)//Position - 0x6A8A
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_188()//Position - 0x6AE5
{
	MISC::SET_BIT(&Global_8371, 4);
}

bool func_189(char* sParam0)//Position - 0x6AF5
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_190(var uParam0, int iParam1, bool bParam2)//Position - 0x6B08
{
	char* sVar0;
...
int func_191(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6)//Position - 0x6BE2
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var4;
...
float func_192(struct<3> Param0, struct<3> Param3)//Position - 0x6C93
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_193(struct<3> Param0)//Position - 0x6CB4
{
	float fVar0;
	float fVar1;
...
bool func_196(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x6E08
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_197(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x6EC9
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_198(int iParam0, int iParam1)//Position - 0x6FF5
{
	int iVar0;
...
int func_200(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x7104
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_201(var uParam0)//Position - 0x7195
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_202(int iParam0, int iParam1)//Position - 0x71B0
{
	int iVar0;
...
int func_203(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x71EF
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_204(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x72EA
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_205(int iParam0, float fParam1)//Position - 0x73F6
{
	var uVar0;
	struct<3> Var1;
...
int func_206(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x748B
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_207(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x7519
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_208(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x7561
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
bool func_210(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x765F
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), ENTITY::GET_ENTITY_COORDS(iParam1, bParam3)) <= (fParam2 * fParam2);
}

void func_211(int iParam0)//Position - 0x7681
{
	func_215(iParam0);
	func_212(iParam0);
...
void func_212(int iParam0)//Position - 0x76A1
{
	int iVar0;
	int iVar1;
	...
	switch (iParam0)
	{
		...
		case 3:
			if (!func_122(Local_250.f_0, joaat("SCRIPT_TASK_ENTER_VEHICLE")))
			{
				if (func_6(Local_280.f_0))
				{
					TASK::TASK_ENTER_VEHICLE(Local_250.f_0, Local_280.f_0, 60000, -1, 2f, 524296, 0);
				}
			}
			break;
		...
		case 6:
			if (!func_122(Local_250.f_0, joaat("SCRIPT_TASK_ENTER_VEHICLE")))
			{
				if (func_6(Local_268.f_0))
				{
					...
					{
						TASK::TASK_ENTER_VEHICLE(Local_250.f_0, Local_268.f_0, 60000, -1, 2f, 1, 0);
					}
				}
			}
			break;
		...
		case 7:
			if (!func_122(Local_250.f_0, joaat("SCRIPT_TASK_ENTER_VEHICLE")))
			{
				if (func_6(Local_280.f_0))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_250.f_0, false))
					{
						TASK::TASK_ENTER_VEHICLE(Local_250.f_0, Local_280.f_0, 60000, -1, 2f, 1, 0);
					}
				}
			}
			break;
		...
		case 8:
			...
			if (func_6(Local_274.f_0))
			{
				if (!func_122(Local_250.f_0, joaat("SCRIPT_TASK_ENTER_VEHICLE")))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_250.f_0, false))
					{
						TASK::TASK_ENTER_VEHICLE(Local_250.f_0, Local_274.f_0, 60000, -1, 2f, 1, 0);
					}
				}
			}
			break;
		...
		case 16:
			if (!func_122(Local_250.f_0, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
			{
				if (func_6(Local_280.f_0))
				{
					...
					if (!PED::IS_PED_IN_VEHICLE(Local_250.f_0, Local_280.f_0, false))
					{
						TASK::TASK_ENTER_VEHICLE(0, Local_280.f_0, 60000, -1, 2f, 1, 0);
					}
...
void func_213(var uParam0, var uParam1, var uParam2, var uParam3)//Position - 0x7B9C
{
	*uParam0 = 0;
	*uParam1 = 0;
	*uParam2 = 0;
...
void func_215(int iParam0)//Position - 0x7C02
{
	switch (iParam0)
	{
		case 1:
...
void func_216(char* sParam0)//Position - 0x7E2F
{
...
void func_218()//Position - 0x7E66
{
	Global_20711 = 0;
	func_219();
}

void func_219()//Position - 0x7E76
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22856 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_220(char* sParam0, int iParam1, int iParam2)//Position - 0x7E97
{
	struct<6> Var0;
...
void func_221(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x7F06
{
...
struct<6> func_222()//Position - 0x7F41
{
	struct<6> Var0;
...
void func_223(char* sParam0, bool bParam1, int iParam2)//Position - 0x7F65
{
	struct<6> Var0;
...
int func_224(int iParam0, float fParam1)//Position - 0x7FED
{
	if (iParam0 == 0)
	{
		return 1;
...
int func_225(int iParam0, int iParam1)//Position - 0x803E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_226(int iParam0, int iParam1, bool bParam2)//Position - 0x807B
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_231(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x8289
{
	struct<3> Var0;
...
int func_232(int iParam0, float fParam1)//Position - 0x8344
{
	float fVar0;
...
bool func_233(int iParam0, float fParam1)//Position - 0x83BA
{
	return func_196(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_234(int iParam0)//Position - 0x83D2
{
...
bool func_235(int iParam0, int iParam1, float fParam2)//Position - 0x83FA
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_237(int iParam0, float fParam1, float fParam2)//Position - 0x847B
{
	if (func_5(iParam0))
	{
...
int func_244(var uParam0)//Position - 0x8888
{
...
int func_248(int iParam0)//Position - 0x89E9
{
	if (Global_22960 == 0)
	{
		return 0;
...
void func_255(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x8DD5
{
	int iVar0;
	int iVar1;
...
void func_256()//Position - 0x8E45
{
	Global_23251.f_6 = 1;
}

void func_257(int iParam0)//Position - 0x8E53
{
	if (func_261())
	{
		return;
...
void func_258(int iParam0)//Position - 0x8E86
{
	if (func_261())
	{
		return;
...
void func_259(bool bParam0, bool bParam1)//Position - 0x8F10
{
	if (bParam0)
	{
		if (func_59(0))
...
bool func_260()//Position - 0x8F84
{
	return BitTest(Global_1963795, 5);
}

bool func_261()//Position - 0x8F92
{
	return BitTest(Global_1963795, 19);
}

void func_262(int iParam0)//Position - 0x8FA1
{
	func_270(1, 1);
	bLocal_38 = true;
	iLocal_90 = iParam0;
...
void func_263(bool bParam0)//Position - 0x8FDD
{
	struct<3> Var0;
...
void func_265()//Position - 0x90C2
{
}

void func_266()//Position - 0x90CA
{
	STREAMING::REMOVE_ANIM_DICT("mini@repair");
	STREAMING::REMOVE_ANIM_DICT("amb@code_human_cower@male@react_cowering");
}

void func_267()//Position - 0x90E2
{
}

void func_268()//Position - 0x90EA
{
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_280.f_5);
}

void func_269(bool bParam0, int iParam1, int iParam2)//Position - 0x90FB
{
	bool bVar0;
...
void func_270(bool bParam0, bool bParam1)//Position - 0x915A
{
	if (bParam0)
	{
		func_269(0, 1, 1);
...
void func_271(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x918D
{
	int iVar0;
...
Vector3 func_272(int iParam0)//Position - 0x934B
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_273(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x935E
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_78472[1 /*14*/] = { func_325(iVar10, iParam1, iParam2, -1) };
		if (!func_324(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78472[1 /*14*/] = { func_325(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78472[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78472[1 /*14*/] = { func_325(iVar10, 14, uVar28[iVar1], -1) };
							func_293(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
							func_316(14);
							if (Global_78470 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_283(iVar0), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_283(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_283(iVar0), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
						}
						func_316(iVar0);
						if (Global_78470 == 1)
						{
			...
			{
				Global_78472[1 /*14*/] = { func_325(iVar10, iVar0, func_282(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78472[1 /*14*/] = { func_325(iVar10, 14, uVar69[iVar1], -1) };
			func_293(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
			func_316(14);
			if (Global_78470 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_283(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_283(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_283(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
		}
		if (Global_78470 == 1)
		{
			iVar2 = 0;
...
int func_274(int iParam0, int iParam1, int iParam2)//Position - 0x9B6F
{
	int iVar0;
	...
	{
		if (!func_389(iParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_64, Global_113810.f_2366.f_539[iVar0 /*65*/].f_63))
		{
...
int func_275(int iParam0)//Position - 0x9BFB
{
	switch (iParam0)
	{
...
void func_276(int iParam0, int iParam1, int iParam2)//Position - 0x9C36
{
	int iVar0;
	int iVar1;
...
int func_277(int iParam0, int iParam1, int iParam2)//Position - 0x9CC0
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_278(int iParam0, int iParam1, int iParam2)//Position - 0x9D9E
{
	Global_78472[1 /*14*/] = { func_325(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78472[1 /*14*/].f_6, 2);
}

int func_279(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x9DC6
{
	var uVar0;
	int iVar10;
...
int func_280(int iParam0, int iParam1, int iParam2)//Position - 0xA3CA
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_281(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA463
{
	int iVar0;
	...
	{
		if (!func_389(iParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_61, Global_113810.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_282(int iParam0, int iParam1, int iParam2)//Position - 0xA50E
{
	int iVar0;
	int iVar1;
...
int func_283(int iParam0)//Position - 0xA5AF
{
	switch (iParam0)
	{
		case 0:
...
int func_284(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA65F
{
	int iVar0;
...
int func_285(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA966
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_286(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0xB519
{
	int iVar0;
...
int func_287(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB7FD
{
	int iVar0;
...
int func_288(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBAC4
{
	int iVar0;
	int iVar1;
...
int func_289(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBAFB
{
	int iVar0;
...
int func_290(int iParam0, int iParam1, int iParam2)//Position - 0xBB24
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_291(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBDEE
{
	int iVar0;
...
int func_292(int iParam0, int iParam1, int iParam2)//Position - 0xC079
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_293(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC1D0
{
	int iVar0;
...
int func_294(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC26A
{
	switch (iParam0)
	{
...
int func_295(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC338
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_296(int iParam0, int iParam1)//Position - 0xC452
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_297(int iParam0)//Position - 0xC7F9
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_298(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC85A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_299(int iParam0, int iParam1)//Position - 0xC956
{
	int iVar0;
...
int func_300(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCA94
{
	struct<2> Var0;
	int iVar15;
	int iVar16;
...
int func_301(int iParam0)//Position - 0xCB4F
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_302(int iParam0)//Position - 0xCBAE
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_303(int iParam0, int iParam1)//Position - 0xCC34
{
	int iVar0;
	struct<10> Var1;
...
void func_304(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD563
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_305(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xD68D
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_306(int iParam0, int iParam1)//Position - 0xD6D5
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_309(&Var1, -99, -99, Global_113810.f_2366.f_539.f_196[0], Global_113810.f_2366.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_309(&Var1, -99, -99, Global_113810.f_2366.f_539.f_196[1], Global_113810.f_2366.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_309(&Var1, -99, -99, Global_113810.f_2366.f_539.f_196[2], Global_113810.f_2366.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_307(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF51D
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
int func_308(int iParam0)//Position - 0xF707
{
	switch (iParam0)
	{
		case 0:
...
void func_309(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xF7B7
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_310(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF828
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_311(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xFAA5
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_312(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xFECA
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_313(int iParam0, int iParam1)//Position - 0x101BE
{
	int iVar0;
	int iVar1;
...
int func_314(int iParam0, int iParam1)//Position - 0x10205
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_315(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10265
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_316(int iParam0)//Position - 0x102BC
{
	if (BitTest(Global_78472[1 /*14*/].f_6, 1) && !BitTest(Global_78472[1 /*14*/].f_6, 6))
	{
		func_323(iParam0, Global_78472[1 /*14*/].f_5, Global_78472[1 /*14*/].f_2, 2, Global_78472[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_78472[1 /*14*/].f_6, 1) && BitTest(Global_78472[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_317(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x10368
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_318(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x103B0
{
	int iVar0;
...
int func_319(int iParam0, var uParam1)//Position - 0x103D3
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_320(uParam1));
}

int func_320(var uParam0)//Position - 0x103E8
{
	int iVar0;
	int iVar1;
...
int func_321(int iParam0, int iParam1)//Position - 0x1041C
{
	int iVar0;
	var uVar1;
...
bool func_322(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x1044B
{
	int iVar0;
...
int func_323(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x12E49
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_324(int iParam0)//Position - 0x13CEC
{
	if (!BitTest(Global_78472[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_325(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x13D34
{
	func_388();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_326(int iParam0, int iParam1)//Position - 0x13D86
{
	switch (iParam0)
	{
		case 0:
...
void func_327(int iParam0)//Position - 0x13E76
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_328(&(Global_78472[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_321(func_331(iParam1, uParam0->f_2), Global_78469);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_321(func_330(iParam1, uParam0->f_2), Global_78469);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_321(iVar1, Global_78469);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_334(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x162FE
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_328(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_328(&(Global_78472[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_328(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78670)
		{
			...
			func_328(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_389(int iParam0, int iParam1, int iParam2)//Position - 0x2779C
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_78472[1 /*14*/] = { func_325(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_78472[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_389(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_389(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_78472[2 /*14*/] = { func_325(iVar0, 14, iVar4, -1) };
									if (Global_78472[2 /*14*/].f_12 == iVar3)
									{
										if (func_389(iParam0, 14, iVar4))
										{
											if (!func_279(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_78472[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_78472[2 /*14*/] = { func_325(iVar0, iVar2, iVar1, -1) };
						if (!func_279(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_78472[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_78472[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_283(iParam1)) && Global_78472[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_283(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_395(int iParam0, int iParam1, int iParam2)//Position - 0x27C3A
{
	...
	if (!func_429(&(Global_77479.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_113810.f_32752.f_4801 = func_418();
			}
...
void func_396(int iParam0, int iParam1)//Position - 0x27D51
{
	...
	func_439(iParam0, &(Global_113810.f_32752.f_5510));
}
...
int func_399(int iParam0, bool bParam1, int iParam2)//Position - 0x281E3
{
	int iVar0;
	struct<2> Var1;
...
int func_400(int iParam0)//Position - 0x28365
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_402(int iParam0, int iParam1)//Position - 0x28448
{
	int iVar0;
	int iVar1;
...
int func_403(bool bParam0)//Position - 0x2D620
{
	if (bParam0)
	{
...
bool func_404()//Position - 0x2D63A
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_405()//Position - 0x2D650
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_406()//Position - 0x2D666
{
	return 0;
}

int func_407()//Position - 0x2D66F
{
	return 1;
}

int func_408()//Position - 0x2D678
{
	return 1;
}

int func_409()//Position - 0x2D681
{
...
int func_411(int iParam0)//Position - 0x2D752
{
	int iVar0;
	char* sVar1;
...
int func_412(int iParam0)//Position - 0x2D799
{
	int iVar0;
...
int func_413(int iParam0)//Position - 0x2D7D4
{
	int iVar0;
...
int func_414(int iParam0)//Position - 0x2D850
{
	int iVar0;
...
int func_415(int iParam0, int iParam1, bool bParam2)//Position - 0x2D938
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_416(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2D9A6
{
...
int func_417(int iParam0)//Position - 0x2DA7E
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_419(var uParam0, int iParam1)//Position - 0x2DAE0
{
	if (iParam1 <= 0)
	{
		return;
...
void func_420(var uParam0, int iParam1)//Position - 0x2DB66
{
...
void func_421(var uParam0, int iParam1)//Position - 0x2DB99
{
	int iVar0;
	int iVar1;
...
int func_422(int iParam0, int iParam1)//Position - 0x2DBEA
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_423(int iParam0)//Position - 0x2DC8C
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_424(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_424(bool bParam0, int iParam1, int iParam2)//Position - 0x2DCAE
{
	if (bParam0)
	{
		return iParam1;
...
int func_425(var uParam0)//Position - 0x2DCC5
{
	return uParam0 & 15;
}

void func_426(var uParam0, int iParam1)//Position - 0x2DCD2
{
...
void func_427(var uParam0, int iParam1)//Position - 0x2DD0C
{
...
void func_428(var uParam0, int iParam1)//Position - 0x2DD47
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_429(var uParam0, int iParam1)//Position - 0x2DD83
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_181(Global_113810.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_181(Global_113810.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_181(Global_113810.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_430(int iParam0, int iParam1)//Position - 0x2F471
{
	struct<82> Var0;
...
void func_431(int iParam0, var uParam1, int iParam2)//Position - 0x2F4B3
{
	int iVar0;
...
void func_432(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x2F70F
{
	if (func_429(&(Global_77479.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_437(iParam0);
			func_436(uParam1, &(Global_113810.f_32752.f_69[Global_77479.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_433(int iParam0, bool bParam1)//Position - 0x2F808
{
	if (iParam0 == -1)
	{
		return;
...
void func_434(int iParam0, int iParam1, bool bParam2)//Position - 0x2F865
{
	if (iParam0 == -1)
	{
		return;
...
int func_435(int iParam0, int iParam1)//Position - 0x2F8A0
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_436(var uParam0, var uParam1)//Position - 0x2F8C0
{
...
void func_437(int iParam0)//Position - 0x2F98C
{
	if (iParam0 == -1)
	{
		return;
...
int func_438(int iParam0)//Position - 0x2FA03
{
	int iVar0;
...
void func_439(int iParam0, var uParam1)//Position - 0x2FA66
{
	int iVar0;
...
int func_440(int iParam0)//Position - 0x2FD11
{
	switch (iParam0)
	{
		case 1:
...
int func_441(int iParam0, var uParam1, var uParam2)//Position - 0x2FDC1
{
	int iVar0;
	int iVar1;
...
int func_442(int iParam0)//Position - 0x2FFB4
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_443(var uParam0)//Position - 0x2FFD4
{
	int iVar0;
...
void func_444(int iParam0)//Position - 0x30085
{
...
void func_445()//Position - 0x300AC
{
	func_447();
	func_446();
}

void func_446()//Position - 0x300BC
{
	if (!iLocal_226)
	{
		if (func_6(iLocal_266))
...
void func_447()//Position - 0x300FA
{
}

void func_448()//Position - 0x30102
{
...
void func_449()//Position - 0x30123
{
	int iVar0;
...
int func_450(int iParam0)//Position - 0x302BE
{
	if (func_6(iParam0))
	{
...
void func_451(int iParam0)//Position - 0x30319
{
	HUD::CLEAR_PRINTS();
	func_52();
	switch (iParam0)
...
int func_452(int iParam0)//Position - 0x3036C
{
	if (func_5(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_453()//Position - 0x3038C
{
	if (!func_91(36))
	{
		func_454(21, 0, 0);
...
void func_454(int iParam0, bool bParam1, int iParam2)//Position - 0x303A6
{
	if (bParam1)
	{
...
void func_455(int iParam0)//Position - 0x30465
{
	Global_100885.f_205[iParam0] = 1;
	Global_100885.f_204 = 1;
}

void func_456(int iParam0, int iParam1, bool bParam2)//Position - 0x3047F
{
	int iVar0;
...
int func_457(int iParam0)//Position - 0x304EF
{
	switch (iParam0)
	{
		case 0:
...
int func_458()//Position - 0x30897
{
	return Global_32283;
}

void func_459(int iParam0, int iParam1, bool bParam2)//Position - 0x308A2
{
	int iVar0;
...
void func_460(int iParam0)//Position - 0x30912
{
...
bool func_461(int iParam0)//Position - 0x30939
{
	return func_463(iParam0, 5, 1);
}

int func_462(int iParam0)//Position - 0x30949
{
	switch (iParam0)
	{
		case -1:
...
int func_463(int iParam0, int iParam1, bool bParam2)//Position - 0x30C7F
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_464(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x30CDF
{
	if (func_465())
	{
...
void func_466()//Position - 0x30D98
{
	int iVar0;
...
void func_467()//Position - 0x30DD7
{
	PED::ADD_RELATIONSHIP_GROUP("ENEMY", &iLocal_286);
}

void func_468()//Position - 0x30DEB
{
	struct<3> Var0[5];
...
void func_469(var uParam0, int iParam1)//Position - 0x30E6D
{
	int iVar0;
...
void func_470(var uParam0, var uParam1, float fParam2)//Position - 0x30EB1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_471(var uParam0, struct<2> Param1, Vector3 vParam3)//Position - 0x30FBE
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_472(var uParam0)//Position - 0x3107A
{
	int iVar0;
	float fVar1;
...
void func_473(var uParam0, struct<3> Param1)//Position - 0x3111A
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_474(var uParam0)//Position - 0x3114B
{
	if (uParam0->f_51)
	{
	}
...
void func_475()//Position - 0x31172
{
	Local_250 = { func_476(-409.72052f, -2175.8582f, 9.31836f, 121.7754f, joaat("S_M_M_Trucker_01")) };
}

struct<16> func_476(struct<3> Param0, float fParam3, int iParam4)//Position - 0x3119C
{
	struct<16> Var0;
...
void func_477()//Position - 0x311C8
{
...
struct<6> func_478(struct<3> Param0, float fParam3, int iParam4)//Position - 0x31236
{
	struct<6> Var0;
...
void func_479()//Position - 0x31258
{
	func_156(1);
	func_482(1);
	func_54();
...
void func_480()//Position - 0x312A3
{
	func_454(21, 1, 0);
}

void func_481()//Position - 0x312B3
{
	Global_96668 = 0;
}

void func_482(int iParam0)//Position - 0x312C0
{
	Global_98119 = iParam0;
}

void func_483()//Position - 0x312CE
{
	int iVar0;
