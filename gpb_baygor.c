		...
		switch (iLocal_250)
		{
			...
			case 8:
				...
				else if (iLocal_440 == 1)
				{
					...
					{
						func_56(Global_113593[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_240, &Local_372, &Local_356));
					}
				}
				break;
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_504)
					{
						Global_113593[iLocal_251] = uLocal_503;
					}
					else
					{
...
void func_58()//Position - 0x2465
{
	...
	func_61(Global_113593[iLocal_251] + 1, &sVar0, &Var8);
	...
	PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_240, false, false);
	func_59(Global_113593[iLocal_251]);
}
...
void func_107()//Position - 0x3204
{
	...
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_448, iLocal_240, PED::GET_PED_BONE_INDEX(iLocal_240, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
	PED::SET_PED_PROP_INDEX(iLocal_240, 1, 0, 0, false, 1);
}
...
void func_108()//Position - 0x324C
{
	...
	bLocal_436 = !Global_3;
	iLocal_252 = 8;
	sLocal_303 = "PBBY_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to Baygor. */;
