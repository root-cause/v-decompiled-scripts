...
int func_64(int iParam0, int iParam1)//Position - 0x4871
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x55B2
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x55ED
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x5861
{
	bool bVar0;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5DEC
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x65AF
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x65F6
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x6661
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6A74
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A84
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x758F
{
...
int func_83()//Position - 0x75B9
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

Vector3 func_84(struct<3> Param0)//Position - 0x75D1
{
...
int func_86(int iParam0)//Position - 0x75FD
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x76FF
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x7794
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_93(int iParam0, var uParam1)//Position - 0x8433
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0)//Position - 0x84B5
{
	if (iParam0 != func_95())
	{
...
int func_98(int iParam0)//Position - 0x8792
{
	return MISC::GET_BITS_IN_RANGE(Global_2657971[iParam0 /*465*/].f_322.f_3, 28, 31);
}

int func_99(int iParam0)//Position - 0x87AF
{
...
var func_107(int iParam0)//Position - 0x8CF8
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8D1A
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8D31
{
	return uParam0 & 15;
}
...
bool func_115()//Position - 0x8E61
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_116()//Position - 0x8E77
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x8E8D
{
...
int func_118(bool bParam0)//Position - 0x8ECF
{
...
int func_123(var* uParam0)//Position - 0xA962
{
	int iVar0;
...
void func_127(int iParam0)//Position - 0xAB00
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0)//Position - 0xABDC
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xACD5
{
...
int func_135(int iParam0)//Position - 0xAD3C
{
	int iVar0;
...
int func_136(int iParam0)//Position - 0xAD85
{
	if (func_137(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xADA5
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_138(int iParam0)//Position - 0xADC6
{
	switch (iParam0)
	{
		case 5:
...
int func_140(int iParam0)//Position - 0xAE96
{
	switch (iParam0)
	{
		case 5:
...
void func_141(var uParam0, bool bParam1, bool bParam2)//Position - 0xAEE9
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0xAFDE
{
	switch (iParam0)
	{
		case 5:
...
void func_144(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB088
{
	if (bParam0)
	{
...
bool func_146(int iParam0, int iParam1)//Position - 0xB1EF
{
	bool bVar0;
...
int func_148(var uParam0)//Position - 0xB289
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xB2AB
{
...
int func_151(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB2F8
{
	int iVar0;
...
int func_154(char* sParam0)//Position - 0xB375
{
...
int func_160(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB4A8
{
...
void func_161(int iParam0)//Position - 0xB4FF
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_168(int iParam0)//Position - 0xB80C
{
	if (iParam0 == 1)
	{
...
int func_170(int iParam0)//Position - 0xB872
{
...
int func_171(int iParam0)//Position - 0xB8B3
{
	int iVar0;
...
int func_173(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB92A
{
	int iVar0;
...
void func_174(var uParam0, int iParam1)//Position - 0xBA61
{
	int iVar0;
...
bool func_175(int iParam0)//Position - 0xBAB0
{
	return func_176(iParam0, Global_44042);
}

int func_176(int iParam0, int iParam1)//Position - 0xBAC1
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_177(int iParam0)//Position - 0xBCA2
{
	if (Global_44042 == 15)
	{
		return 0;
...
int func_179(char* sParam0, int iParam1)//Position - 0xBCD5
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_181(int iParam0, int iParam1)//Position - 0xBD42
{
	switch (iParam0)
	{
		case 0:
...
int func_182(struct<3> Param0, bool bParam3)//Position - 0xC1B1
{
	int iVar0;
...
float func_183(bool bParam0, float fParam1, float fParam2)//Position - 0xC1DD
{
	if (bParam0)
	{
		return fParam1;
...
int func_184(int iParam0)//Position - 0xC1F4
{
	switch (iParam0)
	{
		case 0:
...
int func_185(var uParam0, int iParam1)//Position - 0xC283
{
	switch (uParam0->f_16)
	{
		case 0:
...
int func_187(var uParam0)//Position - 0xCA81
{
	float fVar0;
...
void func_188(int iParam0, int iParam1)//Position - 0xCB0F
{
	if (iParam0 == 1)
	{
		if (!func_140(iParam1))
...
int func_189(bool bParam0)//Position - 0xCB73
{
	int iVar0;
...
int func_190(int iParam0)//Position - 0xCC0A
{
	if (func_137(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_191(int iParam0)//Position - 0xCC34
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_199()) || Global_32951) || func_198()) || func_197(8, -1)) || func_195()) || func_101()) || func_196()) || func_194()) || Global_113969.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_199()) || Global_113016) || Global_32951) || func_198()) || func_197(8, -1)) || func_101()) || func_196()) || func_194()) || Global_113969.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_199() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_197(8, -1)) || func_194()) || func_193()) || Global_113969.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_192()//Position - 0xD351
{
	return Global_101572.f_1;
}

int func_193()//Position - 0xD35F
{
	if (Global_98435 != -1)
	{
...
var func_197(int iParam0, int iParam1)//Position - 0xD3D7
{
	switch (iParam0)
	{
		case 5:
...
var func_198()//Position - 0xD40F
{
	return Global_1575083;
}

int func_199()//Position - 0xD41B
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_200(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD437
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_203(int iParam0, int iParam1)//Position - 0xD59D
{
	bool bVar0;
	int iVar1;
...
float func_204(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD63B
{
	struct<3> Var0;
...
void func_206(int iParam0)//Position - 0xD681
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_207(iParam0);
...
void func_207(int iParam0)//Position - 0xD698
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_209(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD7A8
{
	var uVar0;
...
void func_210(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD830
{
...
void func_211(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD86B
{
...
void func_212(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD8C1
{
...
int func_213(var uParam0, bool bParam1)//Position - 0xD95C
{
	struct<27> Var0;
...
void func_214(int iParam0, var uParam1, int iParam2)//Position - 0xDBCC
{
	int iVar0;
	int iVar1;
...
int func_215(int iParam0)//Position - 0xDF24
{
...
int func_216(var uParam0)//Position - 0xDF44
{
...
int func_217(var uParam0)//Position - 0xDF5C
{
...
void func_219(int* iParam0)//Position - 0xE285
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_221(var uParam0, bool bParam1, bool bParam2)//Position - 0xE330
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_222(int iParam0, int iParam1)//Position - 0xE4EE
{
	int iVar0;
...
int func_223(var uParam0, bool bParam1, int iParam2)//Position - 0xE51E
{
	int iVar0;
	int iVar1;
...
int func_224(int iParam0)//Position - 0xE7DA
{
...
int func_225(int iParam0, float fParam1)//Position - 0xE80E
{
	float fVar0;
...
bool func_226(int iParam0, float fParam1)//Position - 0xE884
{
	return func_227(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_227(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE89C
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_228(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE95D
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_229(int iParam0, int iParam1)//Position - 0xEA89
{
	int iVar0;
...
int func_231(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEB98
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_232(struct<3> Param0, struct<3> Param3)//Position - 0xEC29
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_233(struct<3> Param0)//Position - 0xEC4A
{
	float fVar0;
	float fVar1;
...
int func_235(int iParam0, int iParam1)//Position - 0xECA4
{
	int iVar0;
...
int func_236(int iParam0)//Position - 0xECE3
{
...
int func_237(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xED0B
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_238(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEE06
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_239(int iParam0, float fParam1)//Position - 0xEF12
{
	var uVar0;
	struct<3> Var1;
...
int func_240(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xEFA7
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_241(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF035
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_242(int iParam0)//Position - 0xF07D
{
...
void func_243(int iParam0)//Position - 0xF0C7
{
	int iVar0;
...
int func_244(int iParam0)//Position - 0xF164
{
	if (iParam0 == -1)
	{
		iParam0 = func_178();
...
int func_245(int iParam0)//Position - 0xF1F9
{
...
int func_248(int iParam0)//Position - 0xF278
{
...
int func_250(int iParam0)//Position - 0xF2EA
{
	if (func_118(0))
	{
...
int func_252(int iParam0)//Position - 0xF341
{
	switch (*iParam0)
	{
		case 46:
...
int func_253(var uParam0)//Position - 0xF3E4
{
	int iVar0[7];
	char* sVar8;
	int iVar9;
...
void func_254(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF9A9
{
	func_219(iParam0);
...
void func_255(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF9D0
{
	func_256(iParam0);
...
void func_256(int* iParam0)//Position - 0xFA13
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_257(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xFAAF
{
	func_258(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_258(int* iParam0)//Position - 0xFAD0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_259(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xFB11
{
...
int func_260(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xFB6D
{
	int iVar0;
...
int func_261(var uParam0, int iParam1)//Position - 0xFBFB
{
	int iVar0;
...
int func_262(int iParam0)//Position - 0xFC41
{
	int iVar0;
...
int func_263(var uParam0)//Position - 0xFC72
{
	uParam0->f_16 = 3;
...
int func_264(var uParam0)//Position - 0xFCA6
{
	int iVar0[1];
	int iVar2;
...
int func_265(var uParam0)//Position - 0xFD91
{
	int iVar0[5];
	int iVar6[3];
	struct<3> Var10[3];
...
int func_266(var uParam0)//Position - 0x102D5
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
...
int func_267(var uParam0)//Position - 0x10617
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
...
int func_269(int iParam0)//Position - 0x109C6
{
	struct<27> Var0;
	bool bVar32;
...
int func_270(int iParam0)//Position - 0x10A17
{
	char* sVar0;
...
int func_271(int iParam0)//Position - 0x10AD0
{
	var uVar0;
...
int func_272(int iParam0)//Position - 0x10B91
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_274(int iParam0)//Position - 0x10CF8
{
...
int func_275(int iParam0)//Position - 0x10D23
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_276(int iParam0)//Position - 0x10D4E
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_277(int iParam0)//Position - 0x10D79
{
	if (func_245(iParam0))
	{
		return 0;
...
int func_279(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10DC8
{
	int iVar0;
...
int func_280(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10E2D
{
	int iVar0;
	struct<7> Var1;
...
int func_281(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10EA5
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_282(int iParam0, bool bParam1)//Position - 0x10F20
{
	if (bParam1)
	{
...
void func_287(int* iParam0, bool bParam1)//Position - 0x11134
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_290(int* iParam0)//Position - 0x111BE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_293(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x11249
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_294(var uParam0)//Position - 0x11299
{
	if (*uParam0 == -1)
	{
		return;
...
int func_298(int iParam0)//Position - 0x11335
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
