...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112735[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_287(&(Global_112735[Var0.f_0 /*10*/].f_9));
			}
		}
		func_275(&Var0, 1);
	}
	if (!func_272(&iVar64, &Var0, Var61, 5f))
	{
		func_271();
	...
	while (true)
	{
		...
		if (Var0.f_0 == 47)
		{
			func_202(&Var0, Var61, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		else if (Var0.f_0 == 51)
		{
			func_202(&Var0, Var61, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		func_201(Var0.f_0);
		func_193(&iLocal_95, &(Var0.f_9), Var61);
		if (func_178(&Var0, 0))
		{
			if (func_177(Var0.f_0))
			{
				func_174(Var0.f_0, &iLocal_97);
			}
			if (!func_2(&Var0))
			{
				func_275(&Var0, 1);
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x38FD
{
	int iVar0;
	var uVar1;
...
int func_50(var uParam0)//Position - 0x393A
{
	int iVar0;
	int iVar1;
...
int func_51()//Position - 0x396E
{
	return Global_1574918;
}

int func_52(int iParam0, int iParam1)//Position - 0x397A
{
	int iVar0;
	var uVar1;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39A6
{
	int iVar0;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EEF
{
	int iVar0;
...
int func_55()//Position - 0x4131
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_56()//Position - 0x414A
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x4247
{
	return Global_43257 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x4255
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x4348
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x45D0
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x4671
{
...
int func_62(int iParam0, int iParam1)//Position - 0x484B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x54AC
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x54E7
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x575B
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x5797
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5CE6
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5D2A
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x64A9
{
	if (bParam6)
	{
...
int func_70(var uParam0)//Position - 0x64F0
{
...
bool func_71(int iParam0)//Position - 0x654B
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x655B
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x65BC
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x6955
{
	return Global_32163;
}

int func_75(int iParam0)//Position - 0x6960
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6970
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x6A12
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_78()//Position - 0x7162
{
...
int func_79()//Position - 0x745D
{
	return Global_2652258.f_2650;
}

int func_80(struct<3> Param0)//Position - 0x746C
{
...
int func_81(int iParam0)//Position - 0x7496
{
	if (iParam0 != func_90())
	{
...
Vector3 func_82(int iParam0, int iParam1)//Position - 0x74EE
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_83(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7598
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_84(struct<3> Param0, float fParam3)//Position - 0x762D
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_85(int iParam0)//Position - 0x7671
{
	struct<6> Var0;
...
struct<6> func_86(int iParam0)//Position - 0x77F5
{
	return func_87(iParam0);
}

struct<6> func_87(int iParam0)//Position - 0x7803
{
	struct<6> Var0;
...
int func_118(var* uParam0)//Position - 0xA7FA
{
	int iVar0;
...
var func_190(int iParam0, int iParam1)//Position - 0xD230
{
	switch (iParam0)
	{
		case 5:
...
void func_193(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD290
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_194(int iParam0, bool bParam1)//Position - 0xD381
{
	if (iParam0 == -1)
	{
		return;
...
int func_195(int iParam0)//Position - 0xD3BD
{
	if (Global_78554 == iParam0)
	{
		if (Global_78555 == -1)
...
void func_196(int iParam0, int iParam1)//Position - 0xD3F6
{
	bool bVar0;
	int iVar1;
...
float func_197(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD494
{
	struct<3> Var0;
...
bool func_198()//Position - 0xD4CE
{
	return Global_97990;
}

void func_199(int iParam0)//Position - 0xD4DA
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_200(iParam0);
...
void func_200(int iParam0)//Position - 0xD4F1
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_201(int iParam0)//Position - 0xD5D9
{
	if (iParam0 == -1)
	{
		iParam0 = func_171();
...
int func_202(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD601
{
	var uVar0;
	
	if ((((func_132(PLAYER::PLAYER_PED_ID()) && func_132(iParam0->f_28[0])) && !func_151()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_197(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_203(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD689
{
...
void func_204(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD6C4
{
...
void func_205(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD71A
{
...
int func_206(var uParam0, bool bParam1)//Position - 0xD7B5
{
	struct<27> Var0;
	...
	if ((func_243(*uParam0) || func_241(*uParam0)) || Global_78804 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_207(int iParam0, var uParam1, int iParam2)//Position - 0xDA25
{
	int iVar0;
	int iVar1;
	...
	if (func_132(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_209(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_208(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_209(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_208(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
int func_208(int iParam0)//Position - 0xDD7D
{
...
int func_209(var uParam0)//Position - 0xDD9D
{
...
int func_210(var uParam0)//Position - 0xDDB5
{
...
void func_211(var uParam0)//Position - 0xDDDA
{
	int iVar0;
	int iVar1;
...
void func_212(int* iParam0)//Position - 0xE0DE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_213(var uParam0)//Position - 0xE109
{
	int iVar0;
...
int func_214(var uParam0, bool bParam1, bool bParam2)//Position - 0xE189
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_215(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_215(int iParam0, int iParam1)//Position - 0xE347
{
	int iVar0;
...
int func_216(var uParam0, bool bParam1, int iParam2)//Position - 0xE377
{
	int iVar0;
	int iVar1;
...
int func_217(int iParam0)//Position - 0xE633
{
...
int func_218(int iParam0, float fParam1)//Position - 0xE667
{
	float fVar0;
	
	if (func_132(PLAYER::PLAYER_PED_ID()) && func_132(iParam0))
	{
		if (func_229(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_219(int iParam0, float fParam1)//Position - 0xE6DD
{
	return func_220(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_220(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE6F5
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	uVar0 = func_221(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_221(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE7B6
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_222(int iParam0, int iParam1)//Position - 0xE8E2
{
	int iVar0;
...
int func_224(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE9F1
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_226(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_226(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_225(struct<3> Param0, struct<3> Param3)//Position - 0xEA82
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_226(struct<3> Param0)//Position - 0xEAA3
{
	float fVar0;
	float fVar1;
...
void func_227(var uParam0)//Position - 0xEAE2
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_228(int iParam0, int iParam1)//Position - 0xEAFD
{
	int iVar0;
...
int func_229(int iParam0)//Position - 0xEB3C
{
...
int func_230(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEB64
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_231(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEC5F
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_232(int iParam0, float fParam1)//Position - 0xED6B
{
	var uVar0;
	struct<3> Var1;
	...
	{
		if (func_233(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_233(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xEE00
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_226(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
int func_234(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEE8E
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_235(int iParam0)//Position - 0xEED6
{
...
void func_236(int iParam0)//Position - 0xEF20
{
	int iVar0;
...
int func_237(int iParam0)//Position - 0xEFBD
{
	if (iParam0 == -1)
	{
		iParam0 = func_171();
...
int func_238(int iParam0)//Position - 0xF052
{
...
int func_241(int iParam0)//Position - 0xF0D1
{
	if ((func_242() && Global_100681.f_11 == 6) && iParam0 == func_172(&(Global_100681.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_243(int iParam0)//Position - 0xF143
{
	if (func_113(0))
	{
...
int func_246(var uParam0)//Position - 0xF23C
{
	int iVar0[7];
	char* sVar8;
	int iVar9;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_255(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				if (func_252(&(uParam0->f_28[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
			...
			{
				func_250(&(uParam0->f_28[1]), iVar0[3], -498.16565f, 228.62839f, 82.09948f, 292.9763f, 26);
			...
			{
				func_250(&(uParam0->f_28[2]), iVar0[4], -498.30902f, 227.91116f, 82.105995f, 296.4216f, 26);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_248(&(uParam0->f_35[0]), iVar0[1], -497.99f, 224.97f, 82.67f, 266.5f);
				if (func_183(uParam0->f_35[0]))
				{
			...
			{
				func_248(&(uParam0->f_35[1]), iVar0[2], -501.55f, 230.7f, 83.1f, 233.93f);
				if (func_183(uParam0->f_35[1]))
				{
			...
			{
				func_247(&(uParam0->f_41[0]), iVar0[5], -490.11f, 233.15f, 82.1f, 0f);
				if (func_132(uParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
			...
			{
				func_247(&(uParam0->f_41[1]), iVar0[6], -490.11f, 233.15f, 82.1f, 0f);
				if (func_132(uParam0->f_28[1]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
				{
...
void func_247(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF801
{
	func_212(iParam0);
...
void func_248(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF828
{
	func_249(iParam0);
...
void func_249(int* iParam0)//Position - 0xF86A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xF906
{
	func_251(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_251(int* iParam0)//Position - 0xF927
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_252(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF968
{
...
int func_253(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF9C4
{
	int iVar0;
...
int func_254(var uParam0, int iParam1)//Position - 0xFA52
{
	int iVar0;
...
int func_255(int iParam0)//Position - 0xFA98
{
	int iVar0;
...
int func_256(var uParam0)//Position - 0xFAC9
{
	uParam0->f_16 = 3;
...
int func_257(var uParam0)//Position - 0xFAFD
{
	int iVar0[1];
	int iVar2;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			func_248(&(uParam0->f_35[0]), iVar0[0], 307.02f, 143.17f, 103.3f, 250.08f);
...
int func_258(var uParam0)//Position - 0xFBE8
{
	int iVar0[5];
	int iVar6[3];
	struct<3> Var10[3];
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_255(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar30))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_252(&(uParam0->f_28[0]), 50, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[0], true);
			...
			if (func_131(uParam0->f_28[0]))
			{
				...
				{
					func_247(&(uParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_132(uParam0->f_41[3]))
					{
...
int func_259(var uParam0)//Position - 0x10129
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_255(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo_2"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_252(&(uParam0->f_28[0]), 50, -71.283f, 301.557f, 106.711f, 4.659f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
				}
			...
			if (func_131(uParam0->f_28[0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
					func_247(&(uParam0->f_41[0]), iVar0[2], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_132(uParam0->f_41[0]))
					{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_248(&(uParam0->f_35[0]), iVar0[1], -78.0873f, 299.0679f, 105.3972f, 249.8696f);
		...
		case 3:
			if (func_132(uParam0->f_28[0]) && func_132(PLAYER::PLAYER_PED_ID()))
			{
...
int func_260(var uParam0)//Position - 0x1046B
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_252(&(uParam0->f_28[0]), 50, -149.75f, 285.81f, 93.67f, 135f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
				}
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_248(&(uParam0->f_35[0]), iVar0[1], -159.56f, 275.41f, 93.14f, 102.75f);
				if (func_183(uParam0->f_35[0]))
				{
...
void func_261(int iParam0, bool bParam1)//Position - 0x1078F
{
	switch (iParam0)
	{
		case 46:
...
int func_262(int iParam0)//Position - 0x1081A
{
	struct<27> Var0;
	bool bVar32;
...
int func_263(int iParam0)//Position - 0x1086B
{
	char* sVar0;
...
int func_264(int iParam0)//Position - 0x10924
{
	var uVar0;
...
int func_265(int iParam0)//Position - 0x109E5
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_266(int iParam0, char* sParam1)//Position - 0x10A6A
{
...
int func_267(int iParam0)//Position - 0x10B4C
{
...
int func_268(int iParam0)//Position - 0x10B77
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_269(int iParam0)//Position - 0x10BA2
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_270(int iParam0)//Position - 0x10BCD
{
	if (func_238(iParam0))
	{
		return 0;
...
void func_271()//Position - 0x10C02
{
	func_288("Running end routines.");
	Global_113366 = (Global_113366 - 1);
}

int func_272(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10C1C
{
	int iVar0;
...
int func_273(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10C81
{
	int iVar0;
	struct<7> Var1;
...
int func_274(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10CF9
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_275(int iParam0, bool bParam1)//Position - 0x10D74
{
	if (bParam1)
	{
		...
		switch (*iParam0)
		{
			...
			case 48:
				...
				func_212(&(iParam0->f_41[3]));
				func_277(iParam0, 1, 0, 0);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_PAPARAZZI", true);
				break;
	...
	if (!bParam1)
	{
		if (*iParam0 == 48)
		{
			func_288("SCRIPT TERMINATING: Holding on to launcher until Paparazzo 3 cleans up...");
...
int func_276(var uParam0)//Position - 0x10EE2
{
	if (func_210(uParam0))
	{
...
void func_277(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10F18
{
...
void func_278(var uParam0, bool bParam1)//Position - 0x10F38
{
	func_279(&(uParam0->f_41), bParam1);
}

void func_279(var uParam0, bool bParam1)//Position - 0x10F4A
{
	int iVar0;
...
void func_280(int* iParam0, bool bParam1)//Position - 0x10F88
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_281(var uParam0, bool bParam1)//Position - 0x10FC3
{
	func_282(&(uParam0->f_35), bParam1);
}

void func_282(var uParam0, bool bParam1)//Position - 0x10FD5
{
	int iVar0;
...
void func_283(int* iParam0)//Position - 0x11012
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_284(var uParam0, int iParam1)//Position - 0x1104A
{
	func_285(&(uParam0->f_28), iParam1);
}

void func_285(var uParam0, int iParam1)//Position - 0x1105C
{
	int iVar0;
...
void func_286(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1109D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_287(var uParam0)//Position - 0x110ED
{
	if (*uParam0 == -1)
	{
		return;
...
void func_288(char* sParam0)//Position - 0x1112A
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_289(var uParam0)//Position - 0x1113C
{
	*uParam0 = -1;
...
void func_290()//Position - 0x1116F
{
	func_288("Running start routines.");
	Global_113366++;
}

int func_291(int iParam0)//Position - 0x11189
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
