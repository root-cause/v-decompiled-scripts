...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112473[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_284(&(Global_112473[Var0.f_0 /*10*/].f_9));
			}
		}
		func_272(&Var0, 1);
	}
	if (!func_269(&iVar2, &Var0, Var1, 5f))
	{
		func_268();
	...
	while (true)
	{
		...
		if (Var0.f_0 == 47)
		{
			func_199(&Var0, Var1, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		else if (Var0.f_0 == 51)
		{
			func_199(&Var0, Var1, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		func_198(Var0.f_0);
		func_190(&iLocal_55, &(Var0.f_9), Var1);
		if (func_175(&Var0, 0))
		{
			if (func_174(Var0.f_0))
			{
				func_171(Var0.f_0, &iLocal_57);
			}
			if (!func_2(&Var0))
			{
				func_272(&Var0, 1);
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EEE
{
	int iVar0;
...
int func_55()//Position - 0x4130
{
	func_56();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_56()//Position - 0x4149
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x4246
{
	return Global_43052 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x4254
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x4347
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x45CF
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x466A
{
...
int func_62(int iParam0, int iParam1)//Position - 0x4832
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x53D3
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x540E
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x5682
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x56BE
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5C0D
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5C51
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x63D0
{
	if (bParam2)
	{
...
int func_70(var uParam0)//Position - 0x6417
{
...
bool func_71(int iParam0)//Position - 0x6472
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x6482
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x64E3
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x685E
{
	return Global_31959;
}

int func_75(int iParam0)//Position - 0x6869
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6879
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x691B
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x7040
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x7098
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7142
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
...
Vector3 func_81(struct<3> Param0, float fParam1)//Position - 0x71D7
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_82(int iParam0)//Position - 0x721B
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x739F
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x73AD
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7E74
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7EF6
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x7F4E
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x7F57
{
	switch (iParam0)
	{
		case 1:
...
int func_89()//Position - 0x81B4
{
	return func_90(PLAYER::PLAYER_ID());
}

int func_90(int iParam0)//Position - 0x81C4
{
	return MISC::GET_BITS_IN_RANGE(Global_2689235[iParam0 /*453*/].f_318.f_3, 28, 31);
}

int func_91(int iParam0)//Position - 0x81E1
{
	return func_72(iParam0, 0, 0);
}

int func_92(int iParam0)//Position - 0x81F1
{
	switch (iParam0)
	{
		case -1:
...
bool func_93()//Position - 0x8500
{
	return Global_100493.f_375 > 0;
}

var func_94()//Position - 0x8511
{
	var uVar0;
...
void func_95(var uParam0, int iParam1)//Position - 0x8557
{
	if (iParam1 <= 0)
	{
		return;
...
void func_96(var uParam0, int iParam1)//Position - 0x85DD
{
...
void func_97(var uParam0, int iParam1)//Position - 0x8610
{
	int iVar0;
	int iVar1;
...
int func_98(int iParam0, int iParam1)//Position - 0x8661
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_99(int iParam0)//Position - 0x8703
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_100(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_100(bool bParam0, int iParam1, int iParam2)//Position - 0x8725
{
	if (bParam0)
	{
		return iParam1;
...
int func_101(var uParam0)//Position - 0x873C
{
	return uParam0 & 15;
}

void func_102(var uParam0, int iParam1)//Position - 0x8749
{
...
void func_103(var uParam0, int iParam1)//Position - 0x8783
{
...
void func_104(var uParam0, int iParam1)//Position - 0x87BE
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_105()//Position - 0x87FA
{
	func_56();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_106(int iParam0)//Position - 0x8813
{
	var uVar0;
	char cVar1[24];
...
bool func_107()//Position - 0x886C
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_108()//Position - 0x8882
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_109(char* sParam0, int iParam1, int iParam2)//Position - 0x8898
{
...
int func_110(bool bParam0)//Position - 0x88DA
{
...
struct<2> func_111(int iParam0)//Position - 0x8902
{
	struct<2> Var0;
...
void func_112(int iParam0, var uParam1)//Position - 0x8D4F
{
	switch (iParam0)
	{
		case 0:
...
int func_114(int iParam0)//Position - 0xA027
{
	switch (iParam0)
	{
		case 0:
...
int func_115(var* uParam0)//Position - 0xA36D
{
	int iVar0;
...
void func_116(int iParam0)//Position - 0xA412
{
	struct<2> Var0;
...
void func_117(int iParam0)//Position - 0xA4AD
{
	if (iParam0 < 63)
	{
		func_118();
...
void func_119(int iParam0)//Position - 0xA50B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_120(int iParam0)//Position - 0xA564
{
...
int func_121(int iParam0)//Position - 0xA5E7
{
	int iVar0;
...
void func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA618
{
	func_123(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_123(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA62D
{
	int iVar0;
...
int func_125(int iParam0, int iParam1, int iParam2)//Position - 0xA6E0
{
...
int func_126(int iParam0, int iParam1, int iParam2)//Position - 0xA6FB
{
	int iVar0;
...
int func_127(int iParam0)//Position - 0xA747
{
	int iVar0;
...
int func_128(int iParam0)//Position - 0xA790
{
	if (func_129(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_129(int iParam0)//Position - 0xA7B0
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_130(int iParam0)//Position - 0xA7D1
{
	switch (iParam0)
	{
		case 5:
...
int func_132(int iParam0)//Position - 0xA8A1
{
	switch (iParam0)
	{
		case 5:
...
void func_133(var uParam0, bool bParam1, bool bParam2)//Position - 0xA8F4
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xA9E9
{
	switch (iParam0)
	{
		case 5:
...
void func_135(bool bParam0)//Position - 0xAA54
{
	int iVar0;
...
void func_136(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAA93
{
	if (bParam0)
	{
...
bool func_137()//Position - 0xABD6
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_138(int iParam0, int iParam1)//Position - 0xABF0
{
	bool bVar0;
...
int func_139(int iParam0, bool bParam1)//Position - 0xAC3B
{
	int iVar0;
	int iVar1;
...
int func_140(int iParam0)//Position - 0xAC7C
{
...
bool func_141()//Position - 0xACBB
{
	return BitTest(Global_2621446, 3);
}

int func_142(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xACC9
{
	int iVar0;
...
void func_144(int iParam0)//Position - 0xAD23
{
	if (iParam0 == 1)
	{
...
int func_145(char* sParam0)//Position - 0xAD46
{
...
void func_146()//Position - 0xAD83
{
	Global_20471 = 0;
	func_147();
}

void func_147()//Position - 0xAD93
{
...
int func_151(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAE79
{
...
void func_152(int iParam0)//Position - 0xB011
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_154(int iParam0)//Position - 0xB08E
{
	if (func_159())
	{
		return;
...
void func_155(int iParam0)//Position - 0xB0C1
{
	if (func_159())
	{
		return;
...
void func_156(bool bParam0, bool bParam1)//Position - 0xB14B
{
	if (bParam0)
	{
		if (func_158(0))
...
bool func_157()//Position - 0xB1BF
{
	return BitTest(Global_1958711, 5);
}

int func_158(int iParam0)//Position - 0xB1CD
{
	if (iParam0 == 1)
	{
...
bool func_159()//Position - 0xB224
{
	return BitTest(Global_1958711, 19);
}

int func_160(int iParam0)//Position - 0xB233
{
...
int func_161(int iParam0)//Position - 0xB274
{
	int iVar0;
...
void func_162(int iParam0)//Position - 0xB2B9
{
...
int func_163(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB2EB
{
	int iVar0;
...
void func_164(var uParam0, int iParam1)//Position - 0xB422
{
	int iVar0;
...
bool func_165(int iParam0)//Position - 0xB471
{
	return func_166(iParam0, Global_43052);
}

int func_166(int iParam0, int iParam1)//Position - 0xB482
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_167(int iParam0)//Position - 0xB663
{
	if (Global_43052 == 15)
	{
		return 0;
...
int func_168()//Position - 0xB685
{
	return func_169(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_169(char* sParam0, int iParam1)//Position - 0xB696
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_171(int iParam0, int iParam1)//Position - 0xB703
{
	switch (iParam0)
	{
		case 0:
...
int func_172(struct<3> Param0, bool bParam1)//Position - 0xBB72
{
	int iVar0;
...
float func_173(bool bParam0, float fParam1, float fParam2)//Position - 0xBB9E
{
	if (bParam0)
	{
		return fParam1;
...
int func_174(int iParam0)//Position - 0xBBB5
{
	switch (iParam0)
	{
		case 0:
...
int func_175(var uParam0, int iParam1)//Position - 0xBC44
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_176()//Position - 0xC428
{
	func_27(&(Global_103950.f_2890), &Global_103950, 0, 1, 1, 0);
}

int func_177(var uParam0)//Position - 0xC443
{
	float fVar0;
...
void func_178(int iParam0, int iParam1)//Position - 0xC4D1
{
	if (iParam0 == 1)
	{
		if (!func_132(iParam1))
...
int func_179(bool bParam0)//Position - 0xC535
{
	int iVar0;
...
int func_180(int iParam0)//Position - 0xC5CC
{
	if (func_129(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_181(int iParam0)//Position - 0xC5F6
{
	bool bVar0;
...
bool func_186()//Position - 0xCD88
{
	return Global_100493.f_376 > 0;
}

var func_187(int iParam0, int iParam1)//Position - 0xCD99
{
	switch (iParam0)
	{
		case 5:
...
var func_188()//Position - 0xCDD1
{
	return Global_1575058;
}

int func_189()//Position - 0xCDDD
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_190(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xCDF9
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_191(int iParam0, bool bParam1)//Position - 0xCEEA
{
	if (iParam0 == -1)
	{
		return;
...
int func_192(int iParam0)//Position - 0xCF26
{
	if (Global_78315 == iParam0)
	{
		if (Global_78316 == -1)
...
void func_193(int iParam0, int iParam1)//Position - 0xCF5F
{
	bool bVar0;
	int iVar1;
...
float func_194(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xCFFD
{
	struct<3> Var0;
...
bool func_195()//Position - 0xD037
{
	return Global_97750;
}

void func_196(int iParam0)//Position - 0xD043
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_197(iParam0);
...
void func_197(int iParam0)//Position - 0xD05A
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_198(int iParam0)//Position - 0xD142
{
	if (iParam0 == -1)
	{
		iParam0 = func_168();
...
int func_199(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xD16A
{
	var uVar0;
	
	if ((((func_129(PLAYER::PLAYER_PED_ID()) && func_129(iParam0->f_28[0])) && !func_148()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_194(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_200(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD1F2
{
...
void func_201(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD22D
{
...
void func_202(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD283
{
...
int func_203(var uParam0, bool bParam1)//Position - 0xD31E
{
	struct<27> Var0;
	...
	if ((func_240(*uParam0) || func_238(*uParam0)) || Global_78564 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_204(int iParam0, var uParam1, int iParam2)//Position - 0xD58E
{
	int iVar0;
	int iVar1;
...
int func_205(int iParam0)//Position - 0xD8E6
{
...
int func_206(var uParam0)//Position - 0xD906
{
...
int func_207(var uParam0)//Position - 0xD91E
{
...
void func_208(var uParam0)//Position - 0xD943
{
	int iVar0;
	int iVar1;
...
void func_209(int* iParam0)//Position - 0xDC47
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_210(var uParam0)//Position - 0xDC72
{
	int iVar0;
...
int func_211(var uParam0, bool bParam1, bool bParam2)//Position - 0xDCF2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_212(int iParam0, int iParam1)//Position - 0xDEB0
{
	int iVar0;
...
int func_213(var uParam0, bool bParam1, int iParam2)//Position - 0xDEE0
{
	int iVar0;
	int iVar1;
...
int func_214(int iParam0)//Position - 0xE19C
{
...
int func_215(int iParam0, float fParam1)//Position - 0xE1D0
{
	float fVar0;
...
bool func_216(int iParam0, float fParam1)//Position - 0xE246
{
	return func_217(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_217(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE25E
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_218(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_218(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE31F
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_219(int iParam0, int iParam1)//Position - 0xE44B
{
	int iVar0;
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE55A
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	{
		Var1 = { func_223(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_222(Var1, Var0);
...
float func_222(struct<3> Param0, struct<3> Param1)//Position - 0xE5EB
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_223(struct<3> Param0)//Position - 0xE60C
{
	float fVar0;
	float fVar1;
...
void func_224(var uParam0)//Position - 0xE64B
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_225(int iParam0, int iParam1)//Position - 0xE666
{
	int iVar0;
...
int func_226(int iParam0)//Position - 0xE6A5
{
...
int func_227(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE6CD
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_228(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE7C8
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_229(int iParam0, float fParam1)//Position - 0xE8D4
{
	var uVar0;
	struct<3> Var1;
...
int func_230(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xE969
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_231(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE9F7
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_232(int iParam0)//Position - 0xEA3F
{
...
void func_233(int iParam0)//Position - 0xEA89
{
	int iVar0;
...
int func_234(int iParam0)//Position - 0xEB26
{
	if (iParam0 == -1)
	{
		iParam0 = func_168();
...
int func_235(int iParam0)//Position - 0xEBBB
{
...
int func_238(int iParam0)//Position - 0xEC3A
{
	if ((func_239() && Global_100441.f_11 == 6) && iParam0 == func_169(&(Global_100441.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_240(int iParam0)//Position - 0xECAC
{
	if (func_110(0))
	{
...
int func_243(var uParam0)//Position - 0xEDA5
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_252(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar1))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				if (func_249(&(uParam0->f_28[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
			...
			{
				func_247(&(uParam0->f_28[1]), iVar0[3], -498.16565f, 228.62839f, 82.09948f, 292.9763f, 26);
			...
			{
				func_247(&(uParam0->f_28[2]), iVar0[4], -498.30902f, 227.91116f, 82.105995f, 296.4216f, 26);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_245(&(uParam0->f_35[0]), iVar0[1], -497.99f, 224.97f, 82.67f, 266.5f);
				if (func_180(uParam0->f_35[0]))
				{
			...
			{
				func_245(&(uParam0->f_35[1]), iVar0[2], -501.55f, 230.7f, 83.1f, 233.93f);
				if (func_180(uParam0->f_35[1]))
				{
			...
			{
				func_244(&(uParam0->f_41[0]), iVar0[5], -490.11f, 233.15f, 82.1f, 0f);
				if (func_129(uParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
			...
			{
				func_244(&(uParam0->f_41[1]), iVar0[6], -490.11f, 233.15f, 82.1f, 0f);
				if (func_129(uParam0->f_28[1]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
				{
...
void func_244(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xF36A
{
	func_209(iParam0);
...
void func_245(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xF391
{
	func_246(iParam0);
...
void func_246(int* iParam0)//Position - 0xF3D3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_247(int* iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0xF46F
{
	func_248(iParam0);
	*iParam0 = PED::CREATE_PED(iParam4, iParam1, Param2, fParam3, false, false);
}

void func_248(int* iParam0)//Position - 0xF490
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_249(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xF4D1
{
...
int func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xF52D
{
	int iVar0;
...
int func_251(var uParam0, int iParam1)//Position - 0xF5BB
{
	int iVar0;
...
int func_252(int iParam0)//Position - 0xF601
{
	int iVar0;
...
int func_253(var uParam0)//Position - 0xF632
{
	uParam0->f_16 = 3;
...
int func_254(var uParam0)//Position - 0xF666
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			func_245(&(uParam0->f_35[0]), iVar0[0], 307.02f, 143.17f, 103.3f, 250.08f);
...
int func_255(var uParam0)//Position - 0xF751
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_252(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar4))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_249(&(uParam0->f_28[0]), 50, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[0], true);
			...
			if (func_128(uParam0->f_28[0]))
			{
				...
				{
					func_244(&(uParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_129(uParam0->f_41[3]))
					{
...
int func_256(var uParam0)//Position - 0xFC91
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_252(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo_2"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_249(&(uParam0->f_28[0]), 50, -71.283f, 301.557f, 106.711f, 4.659f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
				}
			...
			if (func_128(uParam0->f_28[0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
					func_244(&(uParam0->f_41[0]), iVar0[2], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_129(uParam0->f_41[0]))
					{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_245(&(uParam0->f_35[0]), iVar0[1], -78.0873f, 299.0679f, 105.3972f, 249.8696f);
		...
		case 3:
			if (func_129(uParam0->f_28[0]) && func_129(PLAYER::PLAYER_PED_ID()))
			{
...
int func_257(var uParam0)//Position - 0xFFD3
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_249(&(uParam0->f_28[0]), 50, -149.75f, 285.81f, 93.67f, 135f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
				}
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_245(&(uParam0->f_35[0]), iVar0[1], -159.56f, 275.41f, 93.14f, 102.75f);
				if (func_180(uParam0->f_35[0]))
				{
...
int func_259(int iParam0)//Position - 0x10385
{
	struct<27> Var0;
	bool bVar1;
...
bool func_263(int iParam0, char* sParam1)//Position - 0x105D5
{
...
int func_264(int iParam0)//Position - 0x106B7
{
...
int func_265(int iParam0)//Position - 0x106E2
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_266(int iParam0)//Position - 0x1070D
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_267(int iParam0)//Position - 0x10738
{
	if (func_235(iParam0))
	{
		return 0;
...
void func_268()//Position - 0x1076D
{
	func_285("Running end routines.");
	Global_113104 = (Global_113104 - 1);
}

int func_269(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x10787
{
	int iVar0;
...
int func_270(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0x107EC
{
	int iVar0;
	struct<7> Var1;
...
int func_271(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x10864
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_272(int iParam0, bool bParam1)//Position - 0x108DF
{
	if (bParam1)
	{
		...
		switch (*iParam0)
		{
			...
			case 48:
				...
				func_209(&(iParam0->f_41[3]));
				func_274(iParam0, 1, 0, 0);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_PAPARAZZI", true);
				break;
	...
	if (!bParam1)
	{
		if (*iParam0 == 48)
		{
			func_285("SCRIPT TERMINATING: Holding on to launcher until Paparazzo 3 cleans up...");
...
int func_273(var uParam0)//Position - 0x10A4D
{
	if (func_207(uParam0))
	{
...
void func_274(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10A83
{
...
void func_275(var uParam0, bool bParam1)//Position - 0x10AA3
{
	func_276(&(uParam0->f_41), bParam1);
}

void func_276(var uParam0, bool bParam1)//Position - 0x10AB5
{
	int iVar0;
...
void func_277(int* iParam0, bool bParam1)//Position - 0x10AF3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_278(var uParam0, bool bParam1)//Position - 0x10B2E
{
	func_279(&(uParam0->f_35), bParam1);
}

void func_279(var uParam0, bool bParam1)//Position - 0x10B40
{
	int iVar0;
...
void func_280(int* iParam0)//Position - 0x10B7D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_281(var uParam0, int iParam1)//Position - 0x10BB5
{
	func_282(&(uParam0->f_28), iParam1);
}

void func_282(var uParam0, int iParam1)//Position - 0x10BC7
{
	int iVar0;
...
void func_283(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10C08
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_284(var uParam0)//Position - 0x10C58
{
	if (*uParam0 == -1)
	{
		return;
...
void func_285(char* sParam0)//Position - 0x10C95
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_286(var uParam0)//Position - 0x10CA7
{
	*uParam0 = -1;
...
void func_287()//Position - 0x10CDA
{
	func_285("Running start routines.");
	Global_113104++;
}

int func_288(int iParam0)//Position - 0x10CF4
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
