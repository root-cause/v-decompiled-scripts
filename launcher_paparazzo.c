...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112897[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_292(&(Global_112897[Var0.f_0 /*10*/].f_9));
			}
		}
		func_280(&Var0, 1);
	}
	if (!func_277(&iVar64, &Var0, Var61, 5f))
	{
		func_276();
	...
	while (true)
	{
		...
		if (Var0.f_0 == 47)
		{
			func_207(&Var0, Var61, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		else if (Var0.f_0 == 51)
		{
			func_207(&Var0, Var61, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		func_206(Var0.f_0);
		func_198(&iLocal_93, &(Var0.f_9), Var61);
		if (func_183(&Var0, 0))
		{
			if (func_182(Var0.f_0))
			{
				func_179(Var0.f_0, &iLocal_95);
			}
			if (!func_2(&Var0))
			{
				func_280(&Var0, 1);
...
int func_64(int iParam0, int iParam1)//Position - 0x485F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x5510
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x554B
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x57BF
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x57FB
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5D4A
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5D8E
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x650D
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x6554
{
...
bool func_73(int iParam0)//Position - 0x65AF
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x65BF
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x661F
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x69C7
{
	return Global_32283;
}

int func_77(int iParam0)//Position - 0x69D2
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x69E2
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6A84
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x71EF
{
...
int func_81()//Position - 0x74EA
{
	return Global_2652364.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x74F9
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x7523
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x7538
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x754F
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x75A7
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7651
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x76E6
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x772A
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x78AE
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x78BC
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x8384
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x8406
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x845E
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x8467
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x86D3
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x86E3
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x8700
{
	return func_74(iParam0, 0, 0);
}

int func_99(int iParam0)//Position - 0x8710
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x8A46
{
	return Global_100885.f_393 > 0;
}

var func_101()//Position - 0x8A57
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8A9D
{
	if (iParam1 <= 0)
	{
		return;
...
void func_103(var uParam0, int iParam1)//Position - 0x8B23
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8B56
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8BA7
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8C49
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8C6B
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8C82
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8C8F
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8CC9
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8D04
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8D40
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8D59
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8DB2
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8DC8
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8DDE
{
...
int func_117(bool bParam0)//Position - 0x8E20
{
...
struct<2> func_118(int iParam0)//Position - 0x8E48
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x9295
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA56D
{
	switch (iParam0)
	{
		case 0:
...
int func_122(var* uParam0)//Position - 0xA8B3
{
	int iVar0;
...
void func_123(int iParam0)//Position - 0xA958
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xA9F3
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xAA51
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xAAAA
{
...
int func_128(int iParam0)//Position - 0xAB2D
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAB5E
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAB73
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xAC26
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAC41
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xAC8D
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xACD6
{
	if (func_136(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xAD17
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xADE7
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xAE3A
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xAF2F
{
	switch (iParam0)
	{
		case 5:
...
void func_142(bool bParam0)//Position - 0xAF9A
{
	int iVar0;
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAFD9
{
	if (bParam0)
	{
...
bool func_144()//Position - 0xB126
{
	return BitTest(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_36.f_18, 14);
}

bool func_145(int iParam0, int iParam1)//Position - 0xB140
{
	bool bVar0;
...
int func_146(int iParam0, bool bParam1)//Position - 0xB199
{
	int iVar0;
	int iVar1;
...
int func_147(var uParam0)//Position - 0xB1DA
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB1FC
{
...
bool func_149()//Position - 0xB23B
{
	return BitTest(Global_2621446, 3);
}

int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB249
{
	int iVar0;
...
void func_152(int iParam0)//Position - 0xB2A3
{
	if (iParam0 == 1)
	{
...
int func_153(char* sParam0)//Position - 0xB2C6
{
...
void func_154()//Position - 0xB303
{
	Global_20711 = 0;
	func_155();
}

void func_155()//Position - 0xB313
{
...
int func_159(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB3F9
{
...
void func_160(int iParam0)//Position - 0xB591
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_162(int iParam0)//Position - 0xB60E
{
	if (func_167())
	{
		return;
...
void func_163(int iParam0)//Position - 0xB641
{
	if (func_167())
	{
		return;
...
void func_164(bool bParam0, bool bParam1)//Position - 0xB6CB
{
	if (bParam0)
	{
		if (func_166(0))
...
bool func_165()//Position - 0xB73F
{
	return BitTest(Global_1963795, 5);
}

int func_166(int iParam0)//Position - 0xB74D
{
	if (iParam0 == 1)
	{
...
bool func_167()//Position - 0xB7A4
{
	return BitTest(Global_1963795, 19);
}

int func_168(int iParam0)//Position - 0xB7B3
{
...
int func_169(int iParam0)//Position - 0xB7F4
{
	int iVar0;
...
void func_170(int iParam0)//Position - 0xB839
{
...
int func_171(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB86B
{
	int iVar0;
...
void func_172(var uParam0, int iParam1)//Position - 0xB9A2
{
	int iVar0;
...
bool func_173(int iParam0)//Position - 0xB9F1
{
	return func_174(iParam0, Global_43377);
}

int func_174(int iParam0, int iParam1)//Position - 0xBA02
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_175(int iParam0)//Position - 0xBBE3
{
	if (Global_43377 == 15)
	{
		return 0;
...
int func_176()//Position - 0xBC05
{
	return func_177(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_177(char* sParam0, int iParam1)//Position - 0xBC16
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_179(int iParam0, int iParam1)//Position - 0xBC83
{
	switch (iParam0)
	{
		case 0:
...
int func_180(struct<3> Param0, bool bParam3)//Position - 0xC0F3
{
	int iVar0;
...
float func_181(bool bParam0, float fParam1, float fParam2)//Position - 0xC11F
{
	if (bParam0)
	{
		return fParam1;
...
int func_182(int iParam0)//Position - 0xC136
{
	switch (iParam0)
	{
		case 0:
...
int func_183(var uParam0, int iParam1)//Position - 0xC1C5
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_184()//Position - 0xC9A8
{
	func_27(&(Global_104373.f_2890), &Global_104373, 0, 1, 1, 0);
}

int func_185(var uParam0)//Position - 0xC9C3
{
	float fVar0;
...
void func_186(int iParam0, int iParam1)//Position - 0xCA51
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_187(bool bParam0)//Position - 0xCAB5
{
	int iVar0;
...
int func_188(int iParam0)//Position - 0xCB4C
{
	if (func_136(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_189(int iParam0)//Position - 0xCB76
{
	bool bVar0;
...
var func_190()//Position - 0xD293
{
	return Global_100872.f_1;
}

int func_191()//Position - 0xD2A1
{
	if (Global_97735 != -1)
	{
...
bool func_194()//Position - 0xD308
{
	return Global_100885.f_394 > 0;
}

var func_195(int iParam0, int iParam1)//Position - 0xD319
{
	switch (iParam0)
	{
		case 5:
...
var func_196()//Position - 0xD351
{
	return Global_1575063;
}

int func_197()//Position - 0xD35D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_198(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD379
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_199(int iParam0, bool bParam1)//Position - 0xD46A
{
	if (iParam0 == -1)
	{
		return;
...
int func_200(int iParam0)//Position - 0xD4A6
{
	if (Global_78685 == iParam0)
	{
		if (Global_78686 == -1)
...
void func_201(int iParam0, int iParam1)//Position - 0xD4DF
{
	bool bVar0;
	int iVar1;
...
float func_202(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD57D
{
	struct<3> Var0;
...
bool func_203()//Position - 0xD5B7
{
	return Global_98122;
}

void func_204(int iParam0)//Position - 0xD5C3
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_205(iParam0);
...
void func_205(int iParam0)//Position - 0xD5DA
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_206(int iParam0)//Position - 0xD6C2
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
int func_207(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD6EA
{
	var uVar0;
	...
	{
		uVar0 = 16;
		func_210(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
		func_208(&uVar0, cParam4, sParam5, 7, 0, 0);
...
void func_208(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD772
{
...
void func_209(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD7AD
{
...
void func_210(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD803
{
...
int func_211(var uParam0, bool bParam1)//Position - 0xD89E
{
	struct<27> Var0;
	...
	if ((func_248(*uParam0) || func_246(*uParam0)) || Global_78935 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_212(int iParam0, var uParam1, int iParam2)//Position - 0xDB0E
{
	int iVar0;
	int iVar1;
...
int func_213(int iParam0)//Position - 0xDE66
{
...
int func_214(var uParam0)//Position - 0xDE86
{
...
int func_215(var uParam0)//Position - 0xDE9E
{
...
void func_216(var uParam0)//Position - 0xDEC3
{
	int iVar0;
	int iVar1;
...
void func_217(int* iParam0)//Position - 0xE1C7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_218(var uParam0)//Position - 0xE1F2
{
	int iVar0;
...
int func_219(var uParam0, bool bParam1, bool bParam2)//Position - 0xE272
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_220(int iParam0, int iParam1)//Position - 0xE430
{
	int iVar0;
...
int func_221(var uParam0, bool bParam1, int iParam2)//Position - 0xE460
{
	int iVar0;
	int iVar1;
...
int func_222(int iParam0)//Position - 0xE71C
{
...
int func_223(int iParam0, float fParam1)//Position - 0xE750
{
	float fVar0;
...
bool func_224(int iParam0, float fParam1)//Position - 0xE7C6
{
	return func_225(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_225(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE7DE
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_226(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE89F
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_227(int iParam0, int iParam1)//Position - 0xE9CB
{
	int iVar0;
...
int func_229(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEADA
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_230(struct<3> Param0, struct<3> Param3)//Position - 0xEB6B
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_231(struct<3> Param0)//Position - 0xEB8C
{
	float fVar0;
	float fVar1;
...
void func_232(var uParam0)//Position - 0xEBCB
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_233(int iParam0, int iParam1)//Position - 0xEBE6
{
	int iVar0;
...
int func_234(int iParam0)//Position - 0xEC25
{
...
int func_235(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEC4D
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_236(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xED48
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_237(int iParam0, float fParam1)//Position - 0xEE54
{
	var uVar0;
	struct<3> Var1;
...
int func_238(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xEEE9
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_239(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEF77
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_240(int iParam0)//Position - 0xEFBF
{
...
void func_241(int iParam0)//Position - 0xF009
{
	int iVar0;
...
int func_242(int iParam0)//Position - 0xF0A6
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
int func_243(int iParam0)//Position - 0xF13B
{
...
int func_246(int iParam0)//Position - 0xF1BA
{
	if ((func_247() && Global_100833.f_11 == 6) && iParam0 == func_177(&(Global_100833.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_248(int iParam0)//Position - 0xF22C
{
	if (func_117(0))
	{
...
int func_251(var uParam0)//Position - 0xF325
{
	int iVar0[7];
	char* sVar8;
	int iVar9;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_260(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar8))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			{
				if (func_257(&(uParam0->f_28[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
			...
			{
				func_255(&(uParam0->f_28[1]), iVar0[3], -498.16565f, 228.62839f, 82.09948f, 292.9763f, 26);
			...
			{
				func_255(&(uParam0->f_28[2]), iVar0[4], -498.30902f, 227.91116f, 82.105995f, 296.4216f, 26);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_253(&(uParam0->f_35[0]), iVar0[1], -497.99f, 224.97f, 82.67f, 266.5f);
				if (func_188(uParam0->f_35[0]))
				{
			...
			{
				func_253(&(uParam0->f_35[1]), iVar0[2], -501.55f, 230.7f, 83.1f, 233.93f);
				if (func_188(uParam0->f_35[1]))
				{
			...
			{
				func_252(&(uParam0->f_41[0]), iVar0[5], -490.11f, 233.15f, 82.1f, 0f);
			...
			{
				func_252(&(uParam0->f_41[1]), iVar0[6], -490.11f, 233.15f, 82.1f, 0f);
...
void func_252(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF8EA
{
	func_217(iParam0);
...
void func_253(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF911
{
	func_254(iParam0);
...
void func_254(int* iParam0)//Position - 0xF953
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_255(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xF9EF
{
	func_256(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_256(int* iParam0)//Position - 0xFA10
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_257(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xFA51
{
...
int func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xFAAD
{
	int iVar0;
...
int func_259(var uParam0, int iParam1)//Position - 0xFB3B
{
	int iVar0;
...
int func_260(int iParam0)//Position - 0xFB81
{
	int iVar0;
...
int func_261(var uParam0)//Position - 0xFBB2
{
	uParam0->f_16 = 3;
...
int func_262(var uParam0)//Position - 0xFBE6
{
	int iVar0[1];
	int iVar2;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			func_253(&(uParam0->f_35[0]), iVar0[0], 307.02f, 143.17f, 103.3f, 250.08f);
...
int func_263(var uParam0)//Position - 0xFCD1
{
	int iVar0[5];
	int iVar6[3];
	struct<3> Var10[3];
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_260(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar30))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_257(&(uParam0->f_28[0]), 50, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[0], true);
			...
			if (func_135(uParam0->f_28[0]))
			{
				...
				{
					func_252(&(uParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
...
int func_264(var uParam0)//Position - 0x10213
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_260(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo_2"))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_257(&(uParam0->f_28[0]), 50, -71.283f, 301.557f, 106.711f, 4.659f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
				}
			...
			if (func_135(uParam0->f_28[0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
					func_252(&(uParam0->f_41[0]), iVar0[2], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_136(uParam0->f_41[0]))
					{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_253(&(uParam0->f_35[0]), iVar0[1], -78.0873f, 299.0679f, 105.3972f, 249.8696f);
...
int func_265(var uParam0)//Position - 0x10555
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_260(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar7))
			{
				return 0;
			}
			func_266(46, 1);
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_257(&(uParam0->f_28[0]), 50, -149.75f, 285.81f, 93.67f, 135f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
				}
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_253(&(uParam0->f_35[0]), iVar0[1], -159.56f, 275.41f, 93.14f, 102.75f);
				if (func_188(uParam0->f_35[0]))
				{
...
void func_266(int iParam0, bool bParam1)//Position - 0x10879
{
	switch (iParam0)
	{
		case 46:
...
int func_267(int iParam0)//Position - 0x10904
{
	struct<27> Var0;
	bool bVar32;
...
int func_268(int iParam0)//Position - 0x10955
{
	char* sVar0;
...
int func_269(int iParam0)//Position - 0x10A0E
{
	var uVar0;
...
int func_270(int iParam0)//Position - 0x10ACF
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_271(int iParam0, char* sParam1)//Position - 0x10B54
{
...
int func_273(int iParam0)//Position - 0x10C61
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_274(int iParam0)//Position - 0x10C8C
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_275(int iParam0)//Position - 0x10CB7
{
	if (func_243(iParam0))
	{
		return 0;
...
void func_276()//Position - 0x10CEC
{
	func_293("Running end routines.");
	Global_113528 = (Global_113528 - 1);
}

int func_277(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10D06
{
	int iVar0;
...
int func_278(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10D6B
{
	int iVar0;
	struct<7> Var1;
...
int func_279(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10DE3
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_280(int iParam0, bool bParam1)//Position - 0x10E5E
{
	if (bParam1)
	{
		...
		switch (*iParam0)
		{
			...
			case 48:
				...
				func_217(&(iParam0->f_41[3]));
				func_282(iParam0, 1, 0, 0);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_PAPARAZZI", true);
				break;
	...
	if (!bParam1)
	{
		if (*iParam0 == 48)
		{
			func_293("SCRIPT TERMINATING: Holding on to launcher until Paparazzo 3 cleans up...");
...
int func_281(var uParam0)//Position - 0x10FCC
{
	if (func_215(uParam0))
	{
...
void func_282(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x11002
{
...
void func_283(var uParam0, bool bParam1)//Position - 0x11022
{
	func_284(&(uParam0->f_41), bParam1);
}

void func_284(var uParam0, bool bParam1)//Position - 0x11034
{
	int iVar0;
...
void func_285(int* iParam0, bool bParam1)//Position - 0x11072
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_286(var uParam0, bool bParam1)//Position - 0x110AD
{
	func_287(&(uParam0->f_35), bParam1);
}

void func_287(var uParam0, bool bParam1)//Position - 0x110BF
{
	int iVar0;
...
void func_288(int* iParam0)//Position - 0x110FC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_289(var uParam0, int iParam1)//Position - 0x11134
{
	func_290(&(uParam0->f_28), iParam1);
}

void func_290(var uParam0, int iParam1)//Position - 0x11146
{
	int iVar0;
...
void func_291(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x11187
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_292(var uParam0)//Position - 0x111D7
{
	if (*uParam0 == -1)
	{
		return;
...
void func_293(char* sParam0)//Position - 0x11214
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_294(var uParam0)//Position - 0x11226
{
	*uParam0 = -1;
...
void func_295()//Position - 0x11259
{
	func_293("Running start routines.");
	Global_113528++;
}

int func_296(int iParam0)//Position - 0x11273
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
