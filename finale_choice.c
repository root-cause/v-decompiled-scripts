...
void __EntryFunction__()//Position - 0x0
{
	...
	Global_8924 = 1;
	func_43();
	if (!func_42(joaat("CALL_FIN_CHOICE_1A")))
	{
		func_41(joaat("CALL_FIN_CHOICE_1A"), 2, 2, 2, 1, -1, 5);
	}
	if (!func_42(joaat("CALL_FIN_CHOICE_2A")))
	{
		func_41(joaat("CALL_FIN_CHOICE_2A"), 2, 0, 0, 1, -1, 5);
	}
	if (!func_42(joaat("CALL_FIN_CHOICE_3")))
	{
		func_41(joaat("CALL_FIN_CHOICE_3"), 2, 12, 3, 1, -1, 5);
	}
	bVar0 = false;
						...
						else
						{
							...
							switch (func_12())
							{
								case joaat("CALL_FIN_CHOICE_1A"):
									if (!func_42(joaat("CALL_FIN_CHOICE_1B")))
									{
								...
								case joaat("CALL_FIN_CHOICE_2A"):
									if (!func_42(joaat("CALL_FIN_CHOICE_2B")))
									{
...
void func_20()//Position - 0xBE8
{
	...
	if (Global_79539 == 0)
	{
		...
		while (iVar2 < 161)
		{
			if (func_26(iVar2, Global_21066) == 1)
			{
				iVar1 = 1;
			}
			iVar2++;
		...
		func_16(4, "CELL_23" /* GXT: Check List */, 2, "appChecklist", 39, 1, 1, 0, 0);
		if ((Global_44181 == 15 && func_2(0) == 0) && Global_8924 == 0)
		{
...
int func_26(int iParam0, int iParam1)//Position - 0x11A9
{
...
void func_35()//Position - 0x1364
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_37(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_10(iVar0) && (!func_17(14) || Global_113083))
			{
...
int func_36(int iParam0)//Position - 0x1461
{
	int iVar0;
	int iVar1;
...
int func_37(int iParam0)//Position - 0x149E
{
	if (func_10(iParam0))
	{
...
var func_38(int iParam0)//Position - 0x14C3
{
	return Global_2201[iParam0 /*29*/];
}

int func_39(int iParam0)//Position - 0x14D2
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
int func_40(int iParam0)//Position - 0x14FF
{
...
int func_41(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x152B
{
	struct<15> Var0;
...
int func_42(int iParam0)//Position - 0x162E
{
	int iVar0;
...
{
	func_48(joaat("CALL_FIN_CHOICE_1A"));
	func_48(joaat("CALL_FIN_CHOICE_1B"));
	func_48(joaat("CALL_FIN_CHOICE_2A"));
	func_48(joaat("CALL_FIN_CHOICE_2B"));
	func_48(joaat("CALL_FIN_CHOICE_3"));
	Global_8924 = 0;
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
...
void func_52(int iParam0)//Position - 0x1B93
{
	...
	while (iVar15 < Global_114135.f_7692.f_198)
	{
		...
		{
			func_53(Global_114135.f_7692.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
void func_59(int iParam0)//Position - 0x1DBF
{
	bool bVar0;
	var uVar1;
	struct<15> Var2;
