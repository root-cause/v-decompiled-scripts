...
int func_22(int iParam0, int iParam1)//Position - 0x113C
{
...
int func_32(int iParam0)//Position - 0x13F4
{
	int iVar0;
	int iVar1;
...
int func_33(int iParam0)//Position - 0x1431
{
	if (func_10(iParam0))
	{
...
var func_34(int iParam0)//Position - 0x1456
{
	return Global_2169[iParam0 /*29*/];
}

int func_35(int iParam0)//Position - 0x1465
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
int func_36(int iParam0)//Position - 0x1492
{
...
int func_37(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x14BE
{
	struct<15> Var0;
...
int func_38(int iParam0)//Position - 0x15C1
{
	int iVar0;
...
void func_45(int iParam0)//Position - 0x18F8
{
	int iVar0;
	struct<10> Var1;
...
void func_46(int iParam0)//Position - 0x19B1
{
	int iVar0;
	struct<14> Var1;
...
void func_48(int iParam0)//Position - 0x1B26
{
	...
	while (iVar15 < Global_113969.f_7691.f_198)
	{
		...
		{
			func_49(Global_113969.f_7691.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
int func_49(int iParam0)//Position - 0x1BE2
{
	int iVar0;
...
void func_50(int iParam0, int iParam1)//Position - 0x1C38
{
	int iVar0;
...
void func_51(int iParam0, int iParam1, int iParam2)//Position - 0x1C6D
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_52(int iParam0, int iParam1, int iParam2)//Position - 0x1CB2
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
int func_53(int iParam0, int iParam1)//Position - 0x1CF7
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_54(int iParam0, int iParam1, int iParam2)//Position - 0x1D21
{
...
void func_55(int iParam0)//Position - 0x1D52
{
	bool bVar0;
	var uVar1;
	struct<15> Var2;
