...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		while (iVar1 != 2)
		{
			if (func_13(&(Global_33428[iVar0 /*7*/])))
			{
				if (func_12(iVar0, Var2))
				{
					func_11(&(Global_33428[iVar0 /*7*/]), 2);
					if (Global_33428[iVar0 /*7*/].f_5 != 0)
					{
						if (SCRIPT::IS_THREAD_ACTIVE(Global_33428[iVar0 /*7*/].f_5))
						{
							PLAYER::FORCE_CLEANUP_FOR_THREAD_WITH_THIS_ID(Global_33428[iVar0 /*7*/].f_5, 1);
						}
						Global_33428[iVar0 /*7*/].f_5 = 0;
					}
				}
			}
			else if (!func_10(Global_33428[iVar0 /*7*/], 4))
			{
				if (func_5(&(Global_33428[iVar0 /*7*/]), Var2))
				{
					func_1(iVar0);
				}
			}
...
void func_1(int iParam0)//Position - 0x14A
{
	...
	if (HUD::GET_LENGTH_OF_LITERAL_STRING(sVar0) != 0)
	{
		if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(iVar1) == 0)
		{
			...
			Global_33428[iParam0 /*7*/].f_5 = SYSTEM::START_NEW_SCRIPT(sVar0, iVar2);
...
{
	Param1.f_2 = 0f;
	if (!SCRIPT::IS_THREAD_ACTIVE(Global_33428[iParam0 /*7*/].f_5))
	{
		return 1;
	}
	...
	if (SYSTEM::VDIST2(Global_33428[iParam0 /*7*/].f_2, Param1) > (Global_33428[iParam0 /*7*/].f_1 + 400f))
	{
		return 1;
	}
	return 0;
...
void func_14()//Position - 0x60E
{
	...
	while (iVar0 <= (5 - 1))
	{
		Global_33428[iVar0 /*7*/].f_2.f_2 = 0f;
		iVar0++;
	}
}
