...
void func_4(bool bParam0, int iParam1)//Position - 0x271
{
	...
	if (Global_114370.f_9088 || func_7(0))
	{
		iVar0 = func_5();
...
void func_25()//Position - 0x1150
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_28(Global_114370.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_26(iVar0) && (!func_30(14) || Global_113320))
			{
...
{
	if (func_96(Global_79489, 0f, 0f, 0f, 0))
	{
		Global_79489 = { Param0 };
...
int func_101(int iParam0)//Position - 0x4532
{
	...
	func_102(&(Global_114370.f_2366.f_539), iVar1);
...
void func_102(var uParam0, int iParam1)//Position - 0x4642
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_104(Global_114370.f_18536[iVar0], &Var2, &fVar5))
			{
...
void func_109(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x533A
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_199(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_192(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
				Global_114370.f_18577[iVar5 /*6*/].f_4 = 0;
				MemCopy(&uVar6, {func_191(iVar5)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar6, 0, Global_101429, iParam0);
			}
			else
			{
				iVar10 = func_190(&(Global_101392.f_3));
				if (iVar10 > -1)
				{
...
{
	func_111(&Global_107917, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_140(int iParam0, bool bParam1)//Position - 0x7BA6
{
	...
	if (func_26(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_141(iParam0, &(Global_114370.f_2366.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
int func_144(int iParam0, int iParam1)//Position - 0x81DB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_145(int iParam0, var* uParam1)//Position - 0x8EFC
{
	int iVar0;
	int iVar1;
...
int func_146(int iParam0)//Position - 0x8F37
{
	int iVar0;
...
void func_147(int iParam0)//Position - 0x91AB
{
	int iVar0;
...
void func_148(var uParam0, int iParam1)//Position - 0x91E7
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_149(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x9736
{
	int iVar0;
	int iVar1;
...
bool func_150(int iParam0, var uParam1, var uParam2)//Position - 0x977A
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
int func_151(var uParam0)//Position - 0x9EF9
{
...
bool func_152(int iParam0)//Position - 0x9F54
{
	return func_153(iParam0, 0, 1);
}

int func_153(int iParam0, int iParam1, bool bParam2)//Position - 0x9F64
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_154(int iParam0)//Position - 0x9FC4
{
	switch (iParam0)
	{
		case 0:
...
int func_155()//Position - 0xA36C
{
	return Global_32828;
}

int func_156(int iParam0)//Position - 0xA377
{
	return func_153(iParam0, 5, 1);
}

int func_157(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0xA387
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_158(int iParam0, bool bParam1)//Position - 0xA429
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_159()//Position - 0xAB94
{
	if (!func_161(Global_1948900))
	{
...
int func_160()//Position - 0xAE8F
{
	return Global_2652572.f_2650;
}

int func_161(struct<3> Param0)//Position - 0xAE9E
{
...
Vector3 func_162(struct<3> Param0)//Position - 0xAEC8
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_163(), 0f, Param0);
}

Vector3 func_163()//Position - 0xAEDD
{
	return -880f, -2770f, -50f;
}

int func_164(int iParam0)//Position - 0xAEF4
{
	if (iParam0 != func_18())
	{
...
Vector3 func_165(int iParam0, int iParam1)//Position - 0xAF4C
{
	struct<3> Var0;
	struct<3> Var6;
	...
	if (Global_1845093 != func_18())
	{
		if (iParam1 == 3)
		{
			if (func_166(iParam0, 1, &Var0, 0, 0))
			{
				Var6 = { Var0 };
			}
		}
		else if (iParam1 == 2)
		{
			...
			{
				if (func_166(iParam0, 2, &Var0, 0, 0))
				{
					Var6 = { Var0 };
				}
			}
...
int func_166(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0xAFF6
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
	...
	if (!func_171(iParam3, &Var0))
	{
		return 0;
	}
	if (!func_171(iParam1, &Var6))
	{
		return 0;
	}
	if (!bParam4)
	...
	Var18 = { Var12 - Var0 };
	Var18 = { func_167(Var18, -Var0.f_3.f_2) };
	Var18 = { func_167(Var18, Var6.f_3.f_2) };
	*uParam2 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Var6, 0f, Var18) };
	uParam2->f_3 = { Var12.f_3 };
	return 1;
}

Vector3 func_167(struct<3> Param0, float fParam3)//Position - 0xB08B
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_168(int iParam0)//Position - 0xB0CF
{
	struct<6> Var0;
...
struct<6> func_169(int iParam0)//Position - 0xB253
{
	return func_170(iParam0);
}

struct<6> func_170(int iParam0)//Position - 0xB261
{
	struct<6> Var0;
...
int func_171(int iParam0, var uParam1)//Position - 0xBD28
{
	switch (iParam0)
	{
		case 0:
...
int func_172(int iParam0)//Position - 0xBDAA
{
	if (iParam0 != func_18())
	{
...
Vector3 func_173(int iParam0)//Position - 0xBE02
{
	switch (iParam0)
	{
		case 1:
...
int func_174()//Position - 0xC06E
{
	return func_175(PLAYER::PLAYER_ID());
}

int func_175(int iParam0)//Position - 0xC07E
{
	return MISC::GET_BITS_IN_RANGE(Global_2657921[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_176(int iParam0)//Position - 0xC09B
{
	return func_153(iParam0, 0, 0);
}

int func_177(int iParam0)//Position - 0xC0AB
{
	switch (iParam0)
	{
		case -1:
...
bool func_178()//Position - 0xC3E1
{
	return Global_101444.f_393 > 0;
}

var func_179()//Position - 0xC3F2
{
	var uVar0;
...
void func_180(var uParam0, int iParam1)//Position - 0xC438
{
	if (iParam1 <= 0)
	{
		return;
...
void func_181(var uParam0, int iParam1)//Position - 0xC4BE
{
...
void func_182(var uParam0, int iParam1)//Position - 0xC4F1
{
	int iVar0;
	int iVar1;
...
int func_183(int iParam0, int iParam1)//Position - 0xC542
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_184(int iParam0)//Position - 0xC5E4
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_185(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_185(bool bParam0, int iParam1, int iParam2)//Position - 0xC606
{
	if (bParam0)
	{
		return iParam1;
...
int func_186(var uParam0)//Position - 0xC61D
{
	return uParam0 & 15;
}

void func_187(var uParam0, int iParam1)//Position - 0xC62A
{
...
void func_188(var uParam0, int iParam1)//Position - 0xC664
{
...
void func_189(var uParam0, int iParam1)//Position - 0xC69F
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_190(char* sParam0)//Position - 0xC6DB
{
...
struct<2> func_191(int iParam0)//Position - 0xC731
{
	struct<2> Var0;
...
int func_192(char* sParam0, int iParam1)//Position - 0xCB7D
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_193(int iParam0, var uParam1)//Position - 0xCBC6
{
	switch (iParam0)
	{
		case 0:
...
int func_195(int iParam0)//Position - 0xDE0C
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_196(int iParam0)//Position - 0xE152
{
	struct<2> Var0;
	char[] cVar2[8];
...
int func_197(int iParam0)//Position - 0xE189
{
	switch (iParam0)
	{
		case 69:
...
int func_198(int iParam0)//Position - 0xE245
{
	switch (iParam0)
	{
		case 1:
...
int func_199(char* sParam0, bool bParam1)//Position - 0xE299
{
	int iVar0;
	int iVar1;
...
int func_200(int iParam0, bool bParam1)//Position - 0xE2C3
{
	int iVar0;
...
void func_201(bool bParam0)//Position - 0xE2F9
{
	int iVar0;
	int iVar1;
...
void func_202()//Position - 0xE57B
{
	...
	switch (iLocal_2132)
	{
		case 0:
			...
			func_233(&Local_186, 324.76532f, -2974.4946f, -1f, 0.1f, 0.1f, 2f, 1, Local_53[0 /*2*/], "dkp1_tk1", "", "DKP1_SUBBK", 1, 0, 1, -1);
			if (STREAMING::HAS_MODEL_LOADED(joaat("packer")) && STREAMING::HAS_MODEL_LOADED(joaat("armytrailer")))
			{
				...
				func_232(587, 0);
				func_231(&uLocal_211, 1, 0, "FLOYD", 0, 1);
				func_230(6, 0);
		...
		case 1:
			if (func_229())
			{
				func_228(&uLocal_458, cLocal_47);
				func_228(&uLocal_458, cLocal_48);
				iLocal_394 = -1;
				iLocal_395 = 0;
				iLocal_2132++;
			}
		...
		case 2:
			...
			else
			{
				...
				if (HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
				{
					if (func_226("DKP1_SUBTURN") || func_226("SUB_HELP"))
					{
						HUD::CLEAR_HELP(true);
					}
				}
			...
			if (func_233(&Local_186, 324.76532f, -2974.4946f, -1.5f, 0.1f, 0.1f, 2f, 0, Local_53[0 /*2*/], "dkp1_tk1", "", "DKP1_SUBBK", 1, 0, 1, -1) || ((HUD::DOES_BLIP_EXIST(Local_186.f_5) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_53[0 /*2*/], 312.8557f, -2974.0032f, 1.19166f, 339.16544f, -2974.3477f, -6.70078f, 15f, false, true, 0)) && func_225(PLAYER::PLAYER_PED_ID(), Local_53[0 /*2*/])))
			{
				if (func_108(Local_53[2 /*2*/]) && func_108(Local_53[1 /*2*/]))
				{
					func_224(&Local_186, 0);
					func_223(6, 0);
		...
		case 3:
			if (func_83(Local_53[0 /*2*/]) || (MISC::GET_GAME_TIMER() - iLocal_450) > 3500)
			{
				...
				func_216(0, 340.6675f, -2964.0103f, 1.4937f, 1, 0, 1, 3000, 0, 1);
		...
		case 6:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(Local_62[3 /*10*/]))
			{
				if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Floyd", 0)))
				{
					...
					func_231(&uLocal_211, 1, Local_62[3 /*10*/], "FLOYD", 0, 1);
...
int func_203(int iParam0)//Position - 0xF05B
{
	if (iLocal_2130 == 0)
	{
		iLocal_2133 = iParam0;
...
void func_204(var uParam0)//Position - 0xF07B
{
	if (uParam0->f_890)
	{
...
void func_205(bool bParam0, bool bParam1, bool bParam2, int iParam3, int iParam4)//Position - 0xF0B3
{
	HUD::DISPLAY_RADAR(true);
	HUD::DISPLAY_HUD(true);
...
void func_206(int iParam0)//Position - 0xF103
{
	iLocal_444 = iParam0;
	iLocal_445 = iParam0;
	iLocal_446 = iParam0;
...
int func_207()//Position - 0xF129
{
	...
	switch (iLocal_408)
	{
		case 0:
			...
			func_214(&uLocal_458, 298.9806f, -2977.643f, 6.101f, Vector(7.886f, -2964.6653f, 298.5479f) - Vector(6.101f, -2977.643f, 298.9806f), 3000f, 0);
			iLocal_408++;
			break;
		...
		case 4:
			...
			{
				fVar0 = (1f - func_211((SYSTEM::TO_FLOAT((MISC::GET_GAME_TIMER() - iLocal_2138 + 1500)) / 3000f), 0f, 1f));
...
int func_208(int iParam0)//Position - 0xF69F
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
void func_210(var uParam0)//Position - 0xF71B
{
...
float func_211(float fParam0, float fParam1, float fParam2)//Position - 0xF737
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_212(bool bParam0, float fParam1)//Position - 0xF75E
{
	if (bParam0)
	{
...
void func_213(bool bParam0, float fParam1)//Position - 0xF7D0
{
	if (bParam0)
	{
...
int func_214(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7, int iParam8)//Position - 0xF81F
{
...
void func_216(bool bParam0, struct<3> Param1, bool bParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, bool bParam9)//Position - 0xF93B
{
...
void func_217(int iParam0)//Position - 0xF9B3
{
	if (func_221())
	{
		return;
...
void func_218(bool bParam0, bool bParam1)//Position - 0xFA3D
{
	if (bParam0)
	{
		if (func_219(0))
...
int func_219(int iParam0)//Position - 0xFAB1
{
	if (iParam0 == 1)
	{
		if (Global_20813.f_1 > 3)
...
bool func_220()//Position - 0xFB08
{
	return BitTest(Global_1956030, 5);
}

bool func_221()//Position - 0xFB16
{
	return BitTest(Global_1956030, 19);
}

void func_222(bool bParam0, int iParam1)//Position - 0xFB25
{
	int iVar0;
...
void func_223(bool bParam0, bool bParam1)//Position - 0xFBBF
{
...
void func_224(int* iParam0, bool bParam1)//Position - 0xFBF3
{
	func_42(iParam0, bParam1, 0);
}

int func_225(int iParam0, int iParam1)//Position - 0xFC04
{
...
bool func_226(char* sParam0)//Position - 0xFC48
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_227(char* sParam0, int iParam1)//Position - 0xFC5B
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

void func_228(var uParam0, char* sParam1)//Position - 0xFC72
{
	int iVar0;
...
void func_230(int iParam0, int iParam1)//Position - 0xFED7
{
...
void func_231(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xFEFE
{
...
void func_232(int iParam0, bool bParam1)//Position - 0xFF99
{
	int iVar0;
...
int func_233(int* iParam0, struct<3> Param1, struct<3> Param4, bool bParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11, bool bParam12, int iParam13, bool bParam14, int iParam15)//Position - 0xFFE3
{
	return func_50(iParam0, Param1, Param4, func_88(), func_88(), bParam7, 5, 0, 0, 0, iParam8, sParam9, func_234(), func_234(), func_234(), func_234(), sParam10, 0, bParam12, sParam11, 0, iParam13, bParam14, iParam15, 0, 0, 0, 1, 1065353216);
}

var func_234()//Position - 0x10033
{
	var uVar0;
...
void func_235(var uParam0, char* sParam1)//Position - 0x1003D
{
	int iVar0;
...
void func_236()//Position - 0x100B7
{
	int iVar0;
	struct<3> Var1;
			...
			if (iLocal_381)
			{
				...
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1249.1057f, -3007.908f, 10.84327f, 1249.9615f, -3007.8374f, 8.31909f, 1.68f, false, true, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) && !func_219(0))
				{
					if (PAD::IS_CONTROL_JUST_PRESSED(2 /*FRONTEND_CONTROL*/, 51 /*INPUT_CONTEXT*/))
					{
						...
						func_216(0, 1249.7866f, -3008.0159f, 8.52751f, 1, 0, 1, 3000, 0, 1);
		...
		case 4:
			if (!func_278())
			{
				if (func_24() == 2)
				{
					...
					{
						func_231(&uLocal_211, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
						func_231(&uLocal_211, 1, func_276(0), "MICHAEL", 0, 1);
					...
					{
						func_231(&uLocal_211, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
						func_231(&uLocal_211, 2, func_276(1), "FRANKLIN", 0, 1);
...
void func_237(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x11207
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104933.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104933.f_4, false))
		{
			if (func_270(24) != Global_104933.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_267(ENTITY::GET_ENTITY_COORDS(Global_104933.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_238(Global_104933.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_238(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x11282
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_239(iParam5, iParam0, 0);
	}
}

void func_239(int iParam0, int iParam1, int iParam2)//Position - 0x113AB
{
	int iVar0;
...
void func_240(int iParam0, int iParam1)//Position - 0x114C2
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_122(iParam0, &(Global_114370.f_32752.f_5510));
}

int func_241(int iParam0)//Position - 0x116C4
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_128(iParam0, 0, 0)) || func_128(iParam0, 1, 0)) || func_128(iParam0, 2, 0)) || func_118(iParam0) != 145) || func_258(iParam0)) || func_257(iParam0)) || func_256(iParam0)) || func_255(iParam0)) || !func_242(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_257(iParam0))
		{
		}
...
int func_242(int iParam0)//Position - 0x117A1
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_243(int iParam0, bool bParam1, int iParam2)//Position - 0x1195F
{
	int iVar0;
	struct<2> Var1;
...
int func_244(int iParam0)//Position - 0x11AE1
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_246(int iParam0, int iParam1)//Position - 0x11BC4
{
	int iVar0;
	int iVar1;
...
int func_247(bool bParam0)//Position - 0x170FD
{
	if (bParam0)
	{
...
bool func_248()//Position - 0x17117
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_249()//Position - 0x1712D
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_250()//Position - 0x17143
{
	return 0;
}

int func_251()//Position - 0x1714C
{
	return 1;
}

int func_252()//Position - 0x17155
{
	return 1;
}

int func_253()//Position - 0x1715E
{
...
int func_255(int iParam0)//Position - 0x1722F
{
	int iVar0;
	char* sVar1;
...
int func_256(int iParam0)//Position - 0x17276
{
	int iVar0;
...
int func_257(int iParam0)//Position - 0x172B1
{
	int iVar0;
...
int func_258(int iParam0)//Position - 0x1732D
{
	int iVar0;
...
int func_259(var uParam0, int iParam1)//Position - 0x17415
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_96(Global_114370.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_96(Global_114370.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_96(Global_114370.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_260(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x18B04
{
	if (func_259(&(Global_78038.f_555[0 /*21*/]), iParam0))
	{
...
void func_261(int iParam0, bool bParam1)//Position - 0x18BFD
{
	if (iParam0 == -1)
	{
		return;
...
void func_262(int iParam0, int iParam1, bool bParam2)//Position - 0x18C5A
{
	if (iParam0 == -1)
	{
		return;
...
int func_263(int iParam0, int iParam1)//Position - 0x18C95
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_264(var uParam0, var uParam1)//Position - 0x18CB5
{
...
void func_265(int iParam0)//Position - 0x18D81
{
	if (iParam0 == -1)
	{
		return;
...
void func_266(int iParam0)//Position - 0x18DF8
{
...
int func_267(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x18E1F
{
	int iVar0;
...
int func_268(struct<3> Param0, int iParam3, int iParam4)//Position - 0x18F35
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_269(int iParam0)//Position - 0x18FC4
{
	return BitTest(Global_114370.f_7232[iParam0], 0);
}

int func_270(int iParam0)//Position - 0x18FD9
{
	if (iParam0 == -1)
	{
		return 0;
...
bool func_271(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8)//Position - 0x18FF5
{
	var uVar0;
	var uVar11;
...
int func_272(var uParam0, var uParam1, int iParam2, bool bParam3)//Position - 0x1904E
{
	int iVar0;
...
void func_273(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16)//Position - 0x193B9
{
...
void func_274(int iParam0)//Position - 0x19441
{
	MISC::SET_BIT(&Global_97227, iParam0);
}

int func_275(int iParam0, int iParam1)//Position - 0x19453
{
	bool bVar0;
...
int func_276(int iParam0)//Position - 0x194AC
{
	if (iParam0 > 3)
	{
		return 0;
	...
	return Global_98850[func_277(iParam0)];
}

int func_277(int iParam0)//Position - 0x194DD
{
	if (iParam0 == 0)
	{
		return 0;
...
void func_279(char* sParam0)//Position - 0x19534
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, true, true, -1);
}

void func_280()//Position - 0x1954A
{
	int iVar0;
	bool bVar1;
...
void func_281(int iParam0)//Position - 0x1971D
{
	switch (iParam0)
	{
		case 0:
...
void func_282(var uParam0)//Position - 0x19858
{
	uParam0->f_890.f_2 = 0;
	if (!uParam0->f_890.f_1)
	{
...
void func_283(var uParam0)//Position - 0x1988C
{
	uParam0->f_894.f_2 = 0;
...
int func_284(var uParam0, char* sParam1)//Position - 0x198C0
{
	int iVar0;
	int iVar1;
...
int func_285(var uParam0, char* sParam1)//Position - 0x19987
{
	int iVar0;
	int iVar1;
...
int func_286(var uParam0, char* sParam1)//Position - 0x19A51
{
	int iVar0;
	int iVar1;
...
int func_287(int iParam0)//Position - 0x19B18
{
	return func_39(iParam0, 1, 0);
}

void func_288()//Position - 0x19B28
{
	int iVar0;
...
void func_289(int iParam0)//Position - 0x1A070
{
	bool bVar0;
	int iVar1;
...
void func_290(int iParam0, int iParam1)//Position - 0x1A0E1
{
	int iVar0;
...
void func_291()//Position - 0x1A14C
{
	switch (iLocal_397)
	{
		case 0:
		...
		case 1:
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.5132f, -2880.3557f, 2.10339f, 1240.5594f, -3057.2708f, 17.4f, 29.45f, false, true, 0))
			{
				if (func_108(Local_62[4 /*10*/]))
				{
					if (PED::CAN_PED_SEE_HATED_PED(Local_62[4 /*10*/], PLAYER::PLAYER_PED_ID()))
					{
						...
						func_231(&uLocal_211, 3, Local_62[4 /*10*/], "CONSTRUCTION2", 0, 1);
						iLocal_397 = 2;
					}
			...
			if (func_108(Local_62[4 /*10*/]))
			{
				...
				else
				{
					...
					{
						func_292(Local_62[4 /*10*/], "Sol1_EFAA", "CONSTRUCTION2", 3);
					...
					if (!iLocal_403)
					{
						...
						if (func_108(Local_62[4 /*10*/]))
						{
							...
							else if ((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_62[4 /*10*/]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_62[4 /*10*/])) && PED::IS_PED_FACING_PED(Local_62[4 /*10*/], PLAYER::PLAYER_PED_ID(), 160f))
							{
								if (WEAPON::GET_WEAPONTYPE_GROUP(iLocal_404) != joaat("GROUP_MELEE") && iLocal_404 != joaat("WEAPON_UNARMED"))
								{
									func_231(&uLocal_211, 4, Local_62[4 /*10*/], "CONSTRUCTION2", 0, 1);
...
void func_292(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x1B1BE
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_61(iParam3), false);
}

int func_293(int iParam0, int iParam1, bool bParam2)//Position - 0x1B1D7
{
	int iVar0;
...
void func_294()//Position - 0x1B21D
{
	switch (iLocal_457)
	{
		case 0:
		...
		case 3:
			if (func_108(Local_53[2 /*2*/]) && func_108(Local_62[3 /*10*/]))
			{
				switch (iLocal_456)
				{
					...
					case 1:
						func_292(Local_62[3 /*10*/], "DHP1_AIAA", "FLOYD", 24);
						iLocal_456 = 2;
						break;
...
bool func_295(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B854
{
...
void func_297()//Position - 0x1B8C6
{
	Global_21032 = 0;
	func_33();
}

void func_298(int iParam0)//Position - 0x1B8D6
{
	Global_23177 = iParam0;
}

void func_299()//Position - 0x1B8E3
{
	Global_21032 = 0;
	func_300();
}

void func_300()//Position - 0x1B8F3
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
int func_301(var uParam0)//Position - 0x1B917
{
...
void func_302(int* iParam0)//Position - 0x1B971
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_303(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)//Position - 0x1B9A9
{
	bool bVar0;
...
void func_304()//Position - 0x1BB9D
{
	struct<3> Var0;
	float fVar3;
...
void func_305()//Position - 0x1BCD4
{
	if (!func_108(Local_53[0 /*2*/]))
	{
...
void func_306(int iParam0, int iParam1, int iParam2)//Position - 0x1BEC4
{
...
void func_307(int iParam0)//Position - 0x1BF88
{
	if (iParam0 == 1)
	{
...
void func_309()//Position - 0x1BFD5
{
	if (!func_108(Local_53[0 /*2*/]))
	{
...
int func_310(int* iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x1C224
{
	int iVar0;
...
int func_311(var uParam0, int iParam1)//Position - 0x1C2A4
{
	int iVar0;
...
int func_312(int iParam0)//Position - 0x1C2EA
{
	if (!func_26(iParam0))
	{
		return func_29(iParam0);
...
void func_313()//Position - 0x1C310
{
...
void func_314()//Position - 0x1C39E
{
	if (!ENTITY::DOES_ENTITY_EXIST(Local_53[0 /*2*/]))
	{
...
void func_315(var uParam0, int iParam1)//Position - 0x1C604
{
	Global_101392.f_22[iParam1] = uParam0;
}

int func_316(var uParam0)//Position - 0x1C618
{
	if (func_317(uParam0))
	{
		return 1;
...
int func_317(var uParam0)//Position - 0x1C631
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_318(var uParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x1D001
{
...
void func_319(int iParam0, var uParam1, var uParam2)//Position - 0x1D0B9
{
	switch (iParam0)
	{
		case 0:
...
bool func_320()//Position - 0x1D158
{
	return BitTest(Global_101392.f_20, 13);
}

void func_321(var uParam0)//Position - 0x1D169
{
	int iVar0;
...
void func_322()//Position - 0x1D3C1
{
	if (CUTSCENE::IS_CUTSCENE_ACTIVE())
	{
...
void func_323(int iParam0)//Position - 0x1D5E1
{
	if (Global_98294 != -1)
	{
...
void func_324(int* iParam0)//Position - 0x1D605
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_325(int* iParam0)//Position - 0x1D630
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_326(int iParam0)//Position - 0x1D6CC
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_327(int iParam0)//Position - 0x1D6ED
{
	if (func_326(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_328(int iParam0)//Position - 0x1D717
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_329(int* iParam0)//Position - 0x1D7B3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_330(int* iParam0)//Position - 0x1D7F4
{
	bool bVar0;
	struct<8> Var1;
...
void func_331()//Position - 0x1D866
{
	switch (iLocal_2130)
	{
		case 1:
...
void func_332(var uParam0)//Position - 0x1D8CD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_333(var uParam0)//Position - 0x1DA2E
{
	int iVar0;
	int iVar1;
...
void func_334(var uParam0)//Position - 0x1DA9B
{
	func_317(uParam0);
}

void func_335()//Position - 0x1DAAA
{
	struct<3> Var0;
	var uVar3;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_62[4 /*10*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97869.f_9[0]))
		{
			...
			Local_62[4 /*10*/] = Global_97869.f_9[0];
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_62[4 /*10*/], iLocal_393);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_167[0 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97869.f_28[0]))
		{
			...
			Local_167[0 /*2*/] = Global_97869.f_28[0];
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_167[1 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97869.f_28[1]))
		{
			...
			Local_167[1 /*2*/] = Global_97869.f_28[1];
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_167[2 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97869.f_28[2]))
		{
			...
			Local_167[2 /*2*/] = Global_97869.f_28[2];
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_167[3 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97869.f_28[3]))
		{
			...
			Local_167[3 /*2*/] = Global_97869.f_28[3];
		}
	}
	if (Global_97869.f_357)
	{
		if (PHYSICS::DOES_ROPE_EXIST(&(Global_97869.f_37[0])))
		{
			...
			Local_143[0 /*5*/] = Global_97869.f_37[0];
		...
		if (PHYSICS::DOES_ROPE_EXIST(&(Global_97869.f_37[1])))
		{
			...
			Local_143[1 /*5*/] = Global_97869.f_37[1];
		...
		if (PHYSICS::DOES_ROPE_EXIST(&(Global_97869.f_37[2])))
		{
			...
			Local_143[2 /*5*/] = Global_97869.f_37[2];
		...
		if (PHYSICS::DOES_ROPE_EXIST(&(Global_97869.f_37[3])))
		{
			...
			Local_143[3 /*5*/] = Global_97869.f_37[3];
...
void func_336(int iParam0)//Position - 0x1DEA9
{
	Global_97227 = 0;
	switch (iParam0)
	{
...
void func_337(bool bParam0)//Position - 0x1DF37
{
	if (bParam0)
	{
		Global_22222 = 1;
...
void func_338(struct<3> Param0, var uParam3, int iParam4, int iParam5)//Position - 0x1DF4F
{
	if (func_308())
	{
...
void func_340()//Position - 0x1E00E
{
	if (CUTSCENE::IS_CUTSCENE_ACTIVE())
	{
		CUTSCENE::STOP_CUTSCENE_IMMEDIATELY();
...
void func_341()//Position - 0x1E24D
{
	Global_97227 = 0;
}

void func_342(bool bParam0)//Position - 0x1E25A
{
	if (bParam0)
	{
...
void func_343()//Position - 0x1E286
{
	int iVar0;
...
void func_345()//Position - 0x1E335
{
	func_95(787.0854f, -2973.8716f, 5.0585f, 256.91f);
}
