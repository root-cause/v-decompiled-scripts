...
void func_291(var uParam0)//Position - 0x33C1A
{
	...
	func_294(&uLocal_96, joaat("velum2"), "Smuggler_Plane");
	func_292(&uLocal_96, 3178.6318f, -4960.667f, 99.0647f, -3.4084f, -0.004f, -78.1044f, "HS4_VEL_LSA_ISD", 1, 1, 5, 0);
}

void func_292(var uParam0, struct<3> Param1, struct<3> Param4, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x33C65
{
	func_293(uParam0, sParam7, iParam8, iParam9, iParam10);
	uParam0->f_9 = { Param1 };
	uParam0->f_12 = { Param4 };
	uParam0->f_7 = iParam11;
}

void func_293(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x33C95
{
	uParam0->f_1 = uParam1;
	uParam0->f_2 = uParam3;
...
void func_294(var uParam0, int iParam1, char* sParam2)//Position - 0x33CC2
{
