...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113457[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_279(&(Global_113457[Var0.f_0 /*10*/].f_9));
			}
		}
		func_266(&Var0, 1);
	}
	if (!func_263(&iVar64, &Var0, Var61, 1f))
	{
		func_262();
	...
	while (true)
	{
		...
		func_209(Var0.f_0);
		func_202(&iLocal_91, &uLocal_92, &(Var0.f_9), Var61, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_195(&Var0, Var61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER" /* GXT: FH-1 Hunter */, 10000);
		if (func_180(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_1(int iParam0)//Position - 0x22E
{
...
int func_2(var* uParam0)//Position - 0x24C
{
	struct<4> Var0;
	char* sVar32;
...
void func_3(int iParam0, char* sParam1)//Position - 0x30D
{
	func_21(sParam1);
...
void func_17(int iParam0)//Position - 0xBCD
{
...
void func_21(char* sParam0)//Position - 0xC86
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xC99
{
	MISC::CLEAR_BIT(&(Global_101392.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xCB6
{
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x28C2
{
...
int func_29(int iParam0)//Position - 0x2902
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2930
{
...
int func_31(int iParam0)//Position - 0x2A0C
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2A4E
{
	int iVar0;
...
int func_33(int iParam0, bool bParam1, int iParam2)//Position - 0x2AB1
{
	int iVar0;
...
int func_34(bool bParam0, int iParam1)//Position - 0x2B3F
{
	struct<82> Var0;
...
void func_35(bool bParam0, var uParam1, int iParam2)//Position - 0x2B81
{
	int iVar0;
...
bool func_36(bool bParam0)//Position - 0x2DDD
{
	return bParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2DE9
{
	int iVar0;
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x3144
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x3337
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3408
{
	char* sVar0;
...
int func_43(int iParam0, bool bParam1, bool bParam2)//Position - 0x3537
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x35A5
{
...
int func_45(int iParam0)//Position - 0x367E
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x36BB
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x36E0
{
...
int func_50(int iParam0, var uParam1)//Position - 0x38B8
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(uParam1));
}

int func_51(var uParam0)//Position - 0x38CD
{
	int iVar0;
	int iVar1;
...
int func_53(int iParam0, int iParam1)//Position - 0x390D
{
	int iVar0;
	var uVar1;
...
int func_54(int iParam0, var uParam1)//Position - 0x3931
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(uParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3946
{
	int iVar0;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3E8F
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x4570
{
	switch (iParam0)
	{
...
int func_63(int iParam0)//Position - 0x4611
{
...
int func_64(int iParam0, int iParam1)//Position - 0x47FD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x551E
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x5559
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x57CD
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x5809
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5D58
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5D9C
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x651B
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x6562
{
...
bool func_73(int iParam0)//Position - 0x65BD
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x65CD
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_76()//Position - 0x69D5
{
	return Global_32828;
}

int func_77(int iParam0)//Position - 0x69E0
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x69F0
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6A92
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x71FD
{
...
int func_81()//Position - 0x74F8
{
	return Global_2652572.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x7507
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x7531
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x7546
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x755D
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x75B5
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x765F
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x76F4
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x7738
{
	struct<6> Var0;
...
struct<6> func_91(int iParam0)//Position - 0x78CA
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x8395
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x8417
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x846F
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x8478
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x86E4
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x86F4
{
	return MISC::GET_BITS_IN_RANGE(Global_2657921[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x8711
{
	return func_74(iParam0, 0, 0);
}

int func_99(int iParam0)//Position - 0x8721
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x8A57
{
	return Global_101444.f_393 > 0;
}

var func_101()//Position - 0x8A68
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8AAE
{
	if (iParam1 <= 0)
	{
		return;
...
void func_104(var uParam0, int iParam1)//Position - 0x8B67
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8BB8
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8C5A
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8C7C
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8C93
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8CA0
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8CDA
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8D15
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8D51
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8D6A
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8DC3
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8DD9
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8DEF
{
...
int func_117(bool bParam0)//Position - 0x8E31
{
...
struct<2> func_118(int iParam0)//Position - 0x8E59
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x92A6
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA57E
{
	switch (iParam0)
	{
		case 0:
...
int func_122(var* uParam0)//Position - 0xA8C4
{
	int iVar0;
...
void func_123(int iParam0)//Position - 0xA969
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xAA04
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xAA62
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xAABB
{
...
int func_128(int iParam0)//Position - 0xAB3E
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAB6F
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAB84
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xAC37
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAC52
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xAC9E
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xACE7
{
	if (func_136(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xAD07
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_137(int iParam0)//Position - 0xAD28
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xADF8
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xAE4B
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xAF40
{
	switch (iParam0)
	{
		case 5:
...
void func_142(bool bParam0)//Position - 0xAFAB
{
	int iVar0;
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAFEA
{
	if (bParam0)
	{
...
bool func_144()//Position - 0xB137
{
	return BitTest(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

bool func_145(int iParam0, int iParam1)//Position - 0xB151
{
	bool bVar0;
...
int func_146(int iParam0, bool bParam1)//Position - 0xB1AA
{
	int iVar0;
	int iVar1;
...
int func_147(var uParam0)//Position - 0xB1EB
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB20D
{
...
bool func_149()//Position - 0xB24C
{
	return BitTest(Global_2621446, 3);
}

int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB25A
{
	int iVar0;
...
void func_152(int iParam0)//Position - 0xB2B4
{
	if (iParam0 == 1)
	{
...
int func_153(char* sParam0)//Position - 0xB2D7
{
...
void func_154()//Position - 0xB314
{
	Global_21032 = 0;
	func_155();
}

void func_155()//Position - 0xB324
{
...
int func_159(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB40A
{
...
void func_160(int iParam0)//Position - 0xB461
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_161(bool bParam0, bool bParam1)//Position - 0xB48D
{
...
void func_163(int iParam0)//Position - 0xB62F
{
	if (func_168())
	{
		return;
...
void func_164(int iParam0)//Position - 0xB662
{
	if (func_168())
	{
		return;
...
void func_165(bool bParam0, bool bParam1)//Position - 0xB6EC
{
	if (bParam0)
	{
		if (func_167(0))
...
bool func_166()//Position - 0xB760
{
	return BitTest(Global_1956030, 5);
}

int func_167(int iParam0)//Position - 0xB76E
{
	if (iParam0 == 1)
	{
...
bool func_168()//Position - 0xB7C5
{
	return BitTest(Global_1956030, 19);
}

int func_169(int iParam0)//Position - 0xB7D4
{
...
int func_170(int iParam0)//Position - 0xB815
{
	int iVar0;
...
void func_171(int iParam0)//Position - 0xB85A
{
...
int func_172(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB88C
{
	int iVar0;
...
void func_173(var uParam0, int iParam1)//Position - 0xB9C3
{
	int iVar0;
...
bool func_174(int iParam0)//Position - 0xBA12
{
	return func_175(iParam0, Global_43922);
}

int func_175(int iParam0, int iParam1)//Position - 0xBA23
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_176(int iParam0)//Position - 0xBC04
{
	if (Global_43922 == 15)
	{
		return 0;
...
int func_177()//Position - 0xBC26
{
	return func_178(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_178(char* sParam0, int iParam1)//Position - 0xBC37
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_180(var uParam0, int iParam1)//Position - 0xBCA4
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_181()//Position - 0xC488
{
	func_27(&(Global_104933.f_2890), &Global_104933, 0, 1, 1, 0);
}

int func_182(var uParam0)//Position - 0xC4A3
{
	float fVar0;
...
void func_183(int iParam0, int iParam1)//Position - 0xC531
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_184(bool bParam0)//Position - 0xC595
{
	int iVar0;
...
int func_185(int iParam0)//Position - 0xC62C
{
	if (func_136(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_186(int iParam0)//Position - 0xC656
{
	bool bVar0;
...
var func_187()//Position - 0xCD73
{
	return Global_101431.f_1;
}

int func_188()//Position - 0xCD81
{
	if (Global_98294 != -1)
	{
...
bool func_191()//Position - 0xCDE8
{
	return Global_101444.f_394 > 0;
}

var func_192(int iParam0, int iParam1)//Position - 0xCDF9
{
	switch (iParam0)
	{
		case 5:
...
var func_193()//Position - 0xCE31
{
	return Global_1575079;
}

int func_194()//Position - 0xCE3D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_195(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)//Position - 0xCE59
{
	var uVar0;
	...
	if (func_186(2))
	{
		if (!func_156())
		{
			if (((func_136(PLAYER::PLAYER_PED_ID()) && func_136(uParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_201(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_200(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
...
int func_196(char* sParam0)//Position - 0xCF1B
{
	struct<6> Var0;
...
struct<6> func_197()//Position - 0xCF3B
{
	struct<6> Var0;
...
void func_198(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCF5F
{
...
void func_199(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCF9A
{
...
void func_200(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCFF0
{
...
float func_201(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD08B
{
	struct<3> Var0;
...
void func_202(int iParam0, var uParam1, char* sParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)//Position - 0xD0C5
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
		{
			...
			{
				if (func_201(PLAYER::PLAYER_PED_ID(), Param3, 1) <= 100f)
				{
					func_205(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_201(PLAYER::PLAYER_PED_ID(), Param6, 1);
					fVar1 = func_201(PLAYER::PLAYER_PED_ID(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
				...
				if (func_201(PLAYER::PLAYER_PED_ID(), Param3, 1) > 120f)
				{
					func_206(iParam0);
				}
			}
...
void func_203(int iParam0, bool bParam1)//Position - 0xD1E3
{
	if (iParam0 == -1)
	{
		return;
...
int func_204(int iParam0)//Position - 0xD21F
{
	if (Global_79244 == iParam0)
	{
		if (Global_79245 == -1)
...
void func_205(int iParam0, int iParam1)//Position - 0xD258
{
	bool bVar0;
	int iVar1;
...
void func_206(int iParam0)//Position - 0xD2F6
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_207(iParam0);
...
void func_207(int iParam0)//Position - 0xD30D
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool func_208()//Position - 0xD3F5
{
	return Global_98681;
}

void func_209(int iParam0)//Position - 0xD401
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_210(var uParam0, bool bParam1)//Position - 0xD429
{
	struct<27> Var0;
...
void func_211(int iParam0, var uParam1, int iParam2)//Position - 0xD699
{
	int iVar0;
	int iVar1;
...
int func_212(int iParam0)//Position - 0xD9F1
{
...
int func_213(var uParam0)//Position - 0xDA11
{
...
int func_214(var uParam0)//Position - 0xDA29
{
...
void func_215(var uParam0)//Position - 0xDA4E
{
	int iVar0;
	int iVar1;
...
void func_216(int* iParam0)//Position - 0xDD52
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_217(var uParam0)//Position - 0xDD7D
{
	int iVar0;
...
int func_218(var uParam0, bool bParam1, bool bParam2)//Position - 0xDDFD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_219(int iParam0, int iParam1)//Position - 0xDFBB
{
	int iVar0;
...
int func_220(var uParam0, bool bParam1, int iParam2)//Position - 0xDFEB
{
	int iVar0;
	int iVar1;
...
int func_221(int iParam0)//Position - 0xE2A7
{
...
int func_222(int iParam0, float fParam1)//Position - 0xE2DB
{
	float fVar0;
...
bool func_223(int iParam0, float fParam1)//Position - 0xE351
{
	return func_224(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_224(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE369
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_225(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE42A
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_226(int iParam0, int iParam1)//Position - 0xE556
{
	int iVar0;
...
int func_228(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE665
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_229(struct<3> Param0, struct<3> Param3)//Position - 0xE6F6
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_230(struct<3> Param0)//Position - 0xE717
{
	float fVar0;
	float fVar1;
...
void func_231(var uParam0)//Position - 0xE756
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_232(int iParam0, int iParam1)//Position - 0xE771
{
	int iVar0;
...
int func_233(int iParam0)//Position - 0xE7B0
{
...
int func_234(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE7D8
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_235(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE8D3
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_236(int iParam0, float fParam1)//Position - 0xE9DF
{
	var uVar0;
	struct<3> Var1;
...
int func_237(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xEA74
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_238(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEB02
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_239(int iParam0)//Position - 0xEB4A
{
...
void func_240(int iParam0)//Position - 0xEB94
{
	int iVar0;
...
int func_241(int iParam0)//Position - 0xEC31
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_242(int iParam0)//Position - 0xECC6
{
...
int func_245(int iParam0)//Position - 0xED45
{
...
int func_247(int iParam0)//Position - 0xEDB7
{
	if (func_117(0))
	{
...
int func_248(int iParam0)//Position - 0xEDDF
{
	if (!func_249(iParam0))
	{
		return 0;
...
int func_249(var uParam0)//Position - 0xEDFE
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (((!func_252(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmlastone1")) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("WEAPON_PUMPSHOTGUN"))) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("WEAPON_SNIPERRIFLE")))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			bVar5 = true;
			uParam0->f_28[0] = PED::CREATE_PED(25, iLocal_90, -1299.02f, 4639.86f, 106.66f, 345.7769f, true, true);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_250(&(uParam0->f_35[0]), iVar0[1], -1303.1628f, 4648.085f, 104.9664f, 293.1504f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
...
void func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xEFEA
{
	func_251(iParam0);
...
void func_251(int* iParam0)//Position - 0xF02D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_252(int iParam0)//Position - 0xF0C9
{
	int iVar0;
...
int func_253(int iParam0)//Position - 0xF0FA
{
	struct<27> Var0;
	bool bVar32;
...
int func_254(int iParam0)//Position - 0xF14B
{
	char* sVar0;
...
int func_255(int iParam0)//Position - 0xF204
{
	var uVar0;
...
int func_256(int iParam0)//Position - 0xF2C5
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_257(int iParam0, char* sParam1)//Position - 0xF34A
{
...
int func_258(int iParam0)//Position - 0xF42C
{
...
int func_259(int iParam0)//Position - 0xF457
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_260(int iParam0)//Position - 0xF482
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_261(int iParam0)//Position - 0xF4AD
{
	if (func_242(iParam0))
	{
		return 0;
...
void func_262()//Position - 0xF4E2
{
	func_280("Running end routines.");
	Global_114088 = (Global_114088 - 1);
}

int func_263(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF4FC
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_264((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_264((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_264(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xF561
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_265(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_265(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xF5D9
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_266(int iParam0, bool bParam1)//Position - 0xF654
{
	if (bParam1)
	{
		func_280("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_268(iParam0, 0, 0, 0);
	}
	func_267(&(iParam0->f_48));
	if (iLocal_91 != -1)
	{
...
int func_267(var uParam0)//Position - 0xF6AA
{
	if (func_214(uParam0))
	{
...
void func_268(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xF6E0
{
...
void func_269(var uParam0, bool bParam1)//Position - 0xF700
{
	func_270(&(uParam0->f_41), bParam1);
}

void func_270(var uParam0, bool bParam1)//Position - 0xF712
{
	int iVar0;
...
void func_271(int* iParam0, bool bParam1)//Position - 0xF750
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_272(var uParam0, bool bParam1)//Position - 0xF78B
{
	func_273(&(uParam0->f_35), bParam1);
}

void func_273(var uParam0, bool bParam1)//Position - 0xF79D
{
	int iVar0;
...
void func_274(int* iParam0)//Position - 0xF7DA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_275(var uParam0, int iParam1)//Position - 0xF812
{
	func_276(&(uParam0->f_28), iParam1);
}

void func_276(var uParam0, int iParam1)//Position - 0xF824
{
	int iVar0;
...
void func_277(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF865
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_278(int* iParam0)//Position - 0xF8B5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_279(var uParam0)//Position - 0xF8F6
{
	if (*uParam0 == -1)
	{
		return;
...
void func_280(char* sParam0)//Position - 0xF933
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_281(var uParam0)//Position - 0xF945
{
	*uParam0 = -1;
