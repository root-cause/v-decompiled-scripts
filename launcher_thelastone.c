...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		func_279("Force cleanup [TERMINATING]");
		if (Var0.f_0 != -1)
		{
			if (Global_112897[Var0.f_0 /*10*/].f_9 != -1)
			{
				func_279("Relinquishing candidate id...");
				func_278(&(Global_112897[Var0.f_0 /*10*/].f_9));
			}
		}
		func_265(&Var0, 1);
	}
	if (!func_262(&iVar64, &Var0, Var61, 1f))
	{
		func_261();
		func_279("SCRIPT TERMINATED");
	...
	while (!func_247(&Var0))
	{
		...
		{
			func_279("Player out of range [TERMINATING]");
			func_265(&Var0, 1);
		}
	}
	...
	while (true)
	{
		...
		func_208(Var0.f_0);
		func_201(&iLocal_91, &uLocal_92, &(Var0.f_9), Var61, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_194(&Var0, Var61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER" /* GXT: FH-1 Hunter */, 10000);
		if (func_179(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_2(var* uParam0)//Position - 0x24C
{
	...
	if (!func_178())
	{
		while (!func_169(*uParam0))
		{
			if (func_168(*uParam0))
			{
				func_157();
			}
			if (!func_209(uParam0, *uParam0 != 2))
			{
				func_279("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			SYSTEM::WAIT(0);
		}
	...
	if (!func_122(uParam0))
	{
		func_279("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
int func_64(int iParam0, int iParam1)//Position - 0x47F1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x54A2
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x54DD
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x5751
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x578D
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5CDC
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5D20
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x649F
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x64E6
{
...
bool func_73(int iParam0)//Position - 0x6541
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x6551
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x65B1
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x6959
{
	return Global_32283;
}

int func_77(int iParam0)//Position - 0x6964
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6974
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6A16
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x7181
{
...
int func_81()//Position - 0x747C
{
	return Global_2652364.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x748B
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x74B5
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x74CA
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x74E1
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x7539
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x75E3
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x7678
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x76BC
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x7840
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x784E
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x8316
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x8398
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x83F0
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x83F9
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x8665
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x8675
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x8692
{
	return func_74(iParam0, 0, 0);
}

int func_99(int iParam0)//Position - 0x86A2
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x89D8
{
	return Global_100885.f_393 > 0;
}

var func_101()//Position - 0x89E9
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8A2F
{
	if (iParam1 <= 0)
	{
		return;
...
void func_103(var uParam0, int iParam1)//Position - 0x8AB5
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8AE8
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8B39
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8BDB
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8BFD
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8C14
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8C21
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8C5B
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8C96
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8CD2
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8CEB
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8D44
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8D5A
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8D70
{
...
int func_117(bool bParam0)//Position - 0x8DB2
{
...
struct<2> func_118(int iParam0)//Position - 0x8DDA
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x9227
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA4FF
{
	switch (iParam0)
	{
		case 0:
...
int func_122(var* uParam0)//Position - 0xA845
{
	int iVar0;
	...
	if (func_153(&(uParam0->f_1)))
	{
		...
		{
			func_279("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::SET_SCRIPT_CAN_START_CUTSCENE(iVar0);
		}
		else
		{
			func_279("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_123(int iParam0)//Position - 0xA8EA
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xA985
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xA9E3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xAA3C
{
...
int func_128(int iParam0)//Position - 0xAABF
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAAF0
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAB05
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xABB8
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xABD3
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xAC1F
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xAC68
{
	if (func_136(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xAC88
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_137(int iParam0)//Position - 0xACA9
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xAD79
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xADCC
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xAEC1
{
	switch (iParam0)
	{
		case 5:
...
void func_142(bool bParam0)//Position - 0xAF2C
{
	int iVar0;
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAF6B
{
	if (bParam0)
	{
...
bool func_144()//Position - 0xB0B8
{
	return BitTest(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_36.f_18, 14);
}

bool func_145(int iParam0, int iParam1)//Position - 0xB0D2
{
	bool bVar0;
...
int func_146(int iParam0, bool bParam1)//Position - 0xB12B
{
	int iVar0;
	int iVar1;
...
int func_147(var uParam0)//Position - 0xB16C
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB18E
{
...
bool func_149()//Position - 0xB1CD
{
	return BitTest(Global_2621446, 3);
}

int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB1DB
{
	int iVar0;
...
void func_152(int iParam0)//Position - 0xB235
{
	if (iParam0 == 1)
	{
...
int func_153(char* sParam0)//Position - 0xB258
{
	...
	func_279("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}

void func_154()//Position - 0xB295
{
	Global_20711 = 0;
	func_155();
}

void func_155()//Position - 0xB2A5
{
...
int func_159(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB38B
{
...
void func_160(int iParam0)//Position - 0xB523
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_162(int iParam0)//Position - 0xB5A0
{
	if (func_167())
	{
		return;
...
void func_163(int iParam0)//Position - 0xB5D3
{
	if (func_167())
	{
		return;
...
void func_164(bool bParam0, bool bParam1)//Position - 0xB65D
{
	if (bParam0)
	{
		if (func_166(0))
...
bool func_165()//Position - 0xB6D1
{
	return BitTest(Global_1963795, 5);
}

int func_166(int iParam0)//Position - 0xB6DF
{
	if (iParam0 == 1)
	{
...
bool func_167()//Position - 0xB736
{
	return BitTest(Global_1963795, 19);
}

int func_168(int iParam0)//Position - 0xB745
{
...
int func_169(int iParam0)//Position - 0xB786
{
	int iVar0;
...
void func_170(int iParam0)//Position - 0xB7CB
{
...
int func_171(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB7FD
{
	int iVar0;
...
void func_172(var uParam0, int iParam1)//Position - 0xB934
{
	int iVar0;
...
bool func_173(int iParam0)//Position - 0xB983
{
	return func_174(iParam0, Global_43377);
}

int func_174(int iParam0, int iParam1)//Position - 0xB994
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_175(int iParam0)//Position - 0xBB75
{
	if (Global_43377 == 15)
	{
		return 0;
...
int func_176()//Position - 0xBB97
{
	return func_177(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_177(char* sParam0, int iParam1)//Position - 0xBBA8
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_179(var uParam0, int iParam1)//Position - 0xBC15
{
	switch (uParam0->f_16)
	{
		case 0:
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_185(2))
							{
								if (func_183(uParam0->f_27))
								{
									...
									func_279("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.88849f, 371.9034f, 103.98843f, 241.58984f, 359.64575f, 107.34612f, 1.25f, false, true, 0))
					{
						if (func_185(2))
						{
							...
							{
								func_182(uParam0->f_27, *uParam0);
								func_279("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.9482f, 4143.44f, 42.292946f, 2722.2134f, 4144.5215f, 45.431824f, 10f, false, true, 0))
				{
					if (func_185(2))
					{
						...
						{
							func_182(1, *uParam0);
							func_279("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.11035f, 68.460175f, -1028.5663f, 395.46133f, 94.57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.75565f, 68.02096f, -1021.4514f, 336.34583f, 93.18714f, 14.5f, false, true, 0))
						{
							if (func_185(2))
							{
								...
								{
									func_182(uParam0->f_27, *uParam0);
									func_279("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_180()//Position - 0xC3F8
{
	func_27(&(Global_104373.f_2890), &Global_104373, 0, 1, 1, 0);
}

int func_181(var uParam0)//Position - 0xC413
{
	float fVar0;
...
void func_182(int iParam0, int iParam1)//Position - 0xC4A1
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_279("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_279("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
int func_183(bool bParam0)//Position - 0xC505
{
	int iVar0;
...
int func_184(int iParam0)//Position - 0xC59C
{
	if (func_136(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_185(int iParam0)//Position - 0xC5C6
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_193()) || Global_112857) || Global_32286) || func_192()) || func_191(8, -1)) || func_100()) || func_190()) || func_189()) || func_188()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_193()) || Global_32286) || func_192()) || func_191(8, -1)) || func_189()) || func_100()) || func_190()) || func_188()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_193()) || Global_112857) || Global_32286) || func_192()) || func_191(8, -1)) || func_189()) || func_100()) || func_190()) || func_188()) || Global_113810.f_7691.f_919[bVar0] == 5) || Global_43924 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_193()) || Global_112857) || Global_32286) || func_192()) || func_191(8, -1)) || func_100()) || func_190()) || func_188()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_193() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_191(8, -1)) || func_188()) || func_187()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_193()) || Global_32286) || func_192()) || func_191(8, -1)) || func_190()) || func_189()) || func_188()) || Global_113810.f_7691.f_919[bVar0] == 5)
							{
								return 0;
							}
						}
...
var func_186()//Position - 0xCCE3
{
	return Global_100872.f_1;
}

int func_187()//Position - 0xCCF1
{
	if (Global_97735 != -1)
	{
...
bool func_190()//Position - 0xCD58
{
	return Global_100885.f_394 > 0;
}

var func_191(int iParam0, int iParam1)//Position - 0xCD69
{
	switch (iParam0)
	{
		case 5:
...
var func_192()//Position - 0xCDA1
{
	return Global_1575063;
}

int func_193()//Position - 0xCDAD
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_194(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)//Position - 0xCDC9
{
	var uVar0;
	...
	if (func_185(2))
	{
		if (!func_156())
		{
			if (((func_136(PLAYER::PLAYER_PED_ID()) && func_136(uParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_200(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_199(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
				func_197(&uVar0, cParam4, sParam5, 7, 0, 0);
				uParam0->f_60 = MISC::GET_GAME_TIMER();
				return 1;
			}
		}
		else if (func_195(sParam5))
		{
			if (func_136(PLAYER::PLAYER_PED_ID()))
			{
				if (func_200(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
				{
					func_154();
				}
			}
...
int func_195(char* sParam0)//Position - 0xCE8B
{
	struct<6> Var0;
...
struct<6> func_196()//Position - 0xCEAB
{
	struct<6> Var0;
...
void func_197(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCECF
{
...
void func_198(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCF0A
{
...
void func_199(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCF60
{
...
float func_200(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xCFFB
{
	struct<3> Var0;
...
void func_201(int iParam0, var uParam1, char* sParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)//Position - 0xD035
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
		{
			...
			{
				if (func_200(PLAYER::PLAYER_PED_ID(), Param3, 1) <= 100f)
				{
					func_204(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_200(PLAYER::PLAYER_PED_ID(), Param6, 1);
					fVar1 = func_200(PLAYER::PLAYER_PED_ID(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
				...
				if (func_200(PLAYER::PLAYER_PED_ID(), Param3, 1) > 120f)
				{
					func_205(iParam0);
				}
			}
...
void func_202(int iParam0, bool bParam1)//Position - 0xD153
{
	if (iParam0 == -1)
	{
		return;
...
int func_203(int iParam0)//Position - 0xD18F
{
	if (Global_78685 == iParam0)
	{
		if (Global_78686 == -1)
...
void func_204(int iParam0, int iParam1)//Position - 0xD1C8
{
	bool bVar0;
	int iVar1;
...
void func_205(int iParam0)//Position - 0xD266
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_206(iParam0);
...
void func_206(int iParam0)//Position - 0xD27D
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool func_207()//Position - 0xD365
{
	return Global_98122;
}

void func_208(int iParam0)//Position - 0xD371
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
int func_209(var uParam0, bool bParam1)//Position - 0xD399
{
	struct<27> Var0;
	
	if (Global_78689)
	{
		func_279("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_119(*uParam0, &Var0);
	...
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_279("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_240(*uParam0))
	{
		...
		func_279("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1)
	{
	...
	if (*uParam0 == 10)
	{
		...
		{
			func_279("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_279("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
...
void func_210(int iParam0, var uParam1, int iParam2)//Position - 0xD609
{
	int iVar0;
	int iVar1;
...
int func_211(int iParam0)//Position - 0xD961
{
...
int func_212(var uParam0)//Position - 0xD981
{
...
int func_213(var uParam0)//Position - 0xD999
{
...
void func_214(var uParam0)//Position - 0xD9BE
{
	int iVar0;
	int iVar1;
...
void func_215(int* iParam0)//Position - 0xDCC2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_216(var uParam0)//Position - 0xDCED
{
	int iVar0;
...
int func_217(var uParam0, bool bParam1, bool bParam2)//Position - 0xDD6D
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_135(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				{
					func_279("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[iVar0], false))
				{
					func_279("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[iVar0], PLAYER::PLAYER_PED_ID(), false))
				{
					func_279("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[iVar0]) < 850)
				{
					func_279("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							func_279("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_184(iVar2))
						{
							if (ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck") || ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck2"))
							{
								if (func_184(uParam0->f_35[iVar0]))
								{
									...
									{
										func_279("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_184(iVar3))
						{
							...
							{
								func_279("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							...
							{
								func_279("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
...
int func_218(int iParam0, int iParam1)//Position - 0xDF2B
{
	int iVar0;
...
int func_219(var uParam0, bool bParam1, int iParam2)//Position - 0xDF5B
{
	int iVar0;
	int iVar1;
	...
	if (func_135(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[iVar0]))
						{
							...
							func_279("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[iVar0]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[iVar0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[iVar0]))
					{
						...
						func_279("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[iVar0], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
						{
							...
							func_279("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_238(*uParam0))
					{
						if (!func_168(*uParam0))
						{
							if (func_233(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								...
								func_279("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[iVar0], true), 15f))
						{
							...
							func_279("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_221(uParam0->f_28[iVar0], 1126825984))
						{
							...
							func_279("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_220(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_279("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_279("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_136(uParam0->f_41[0]))
						{
...
int func_220(int iParam0)//Position - 0xE217
{
...
int func_221(int iParam0, float fParam1)//Position - 0xE24B
{
	float fVar0;
...
bool func_222(int iParam0, float fParam1)//Position - 0xE2C1
{
	return func_223(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_223(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE2D9
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_224(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE39A
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_225(int iParam0, int iParam1)//Position - 0xE4C6
{
	int iVar0;
...
int func_227(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE5D5
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_228(struct<3> Param0, struct<3> Param3)//Position - 0xE666
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_229(struct<3> Param0)//Position - 0xE687
{
	float fVar0;
	float fVar1;
...
void func_230(var uParam0)//Position - 0xE6C6
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_231(int iParam0, int iParam1)//Position - 0xE6E1
{
	int iVar0;
...
int func_232(int iParam0)//Position - 0xE720
{
...
int func_233(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE748
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_234(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE843
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_235(int iParam0, float fParam1)//Position - 0xE94F
{
	var uVar0;
	struct<3> Var1;
...
int func_236(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE9E4
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_237(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEA72
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_238(int iParam0)//Position - 0xEABA
{
...
void func_239(int iParam0)//Position - 0xEB04
{
	int iVar0;
...
int func_240(int iParam0)//Position - 0xEBA1
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
int func_241(int iParam0)//Position - 0xEC36
{
...
int func_244(int iParam0)//Position - 0xECB5
{
...
int func_246(int iParam0)//Position - 0xED27
{
	if (func_117(0))
	{
...
int func_247(int iParam0)//Position - 0xED4F
{
	if (!func_248(iParam0))
	{
		return 0;
	}
	func_279("Created initial scene");
	return 1;
}

int func_248(var uParam0)//Position - 0xED6E
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (((!func_251(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmlastone1")) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("WEAPON_PUMPSHOTGUN"))) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("WEAPON_SNIPERRIFLE")))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_249(&(uParam0->f_35[0]), iVar0[1], -1303.1628f, 4648.085f, 104.9664f, 293.1504f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
...
void func_249(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xEF5A
{
	func_250(iParam0);
...
void func_250(int* iParam0)//Position - 0xEF9C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_251(int iParam0)//Position - 0xF038
{
	int iVar0;
...
int func_252(int iParam0)//Position - 0xF069
{
	struct<27> Var0;
	bool bVar32;
...
int func_253(int iParam0)//Position - 0xF0BA
{
	char* sVar0;
	
	if (Global_78689)
	{
		func_279("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!Global_113810.f_9088 && !func_117(1))
	{
		func_279("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_254(iParam0))
	{
		Global_112897[iParam0 /*10*/].f_1 = 1;
		func_279("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_100833.f_11 == 6)
	{
		if (Global_100833 < 9)
		{
			...
			{
				func_279("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	...
	{
		Global_112897[iParam0 /*10*/].f_1 = 1;
		func_279("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}

int func_254(int iParam0)//Position - 0xF173
{
	var uVar0;
...
int func_255(int iParam0)//Position - 0xF234
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_256(int iParam0, char* sParam1)//Position - 0xF2B9
{
...
int func_257(int iParam0)//Position - 0xF39B
{
...
int func_258(int iParam0)//Position - 0xF3C6
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_259(int iParam0)//Position - 0xF3F1
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_260(int iParam0)//Position - 0xF41C
{
	if (func_241(iParam0))
	{
		return 0;
...
void func_261()//Position - 0xF451
{
	func_279("Running end routines.");
	Global_113528 = (Global_113528 - 1);
}

int func_262(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF46B
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_263((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_263((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
	...
	func_279("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}

int func_263(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xF4D0
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_264(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_264(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xF548
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_265(int iParam0, bool bParam1)//Position - 0xF5C3
{
	if (bParam1)
	{
		func_279("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_267(iParam0, 0, 0, 0);
	}
	func_266(&(iParam0->f_48));
	if (iLocal_91 != -1)
	{
		func_279("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_206(&iLocal_91);
	}
	if (bParam1)
	{
...
int func_266(var uParam0)//Position - 0xF619
{
	if (func_213(uParam0))
	{
...
void func_267(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xF64F
{
...
void func_268(var uParam0, bool bParam1)//Position - 0xF66F
{
	func_269(&(uParam0->f_41), bParam1);
}

void func_269(var uParam0, bool bParam1)//Position - 0xF681
{
	int iVar0;
...
void func_270(int* iParam0, bool bParam1)//Position - 0xF6BF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_271(var uParam0, bool bParam1)//Position - 0xF6FA
{
	func_272(&(uParam0->f_35), bParam1);
}

void func_272(var uParam0, bool bParam1)//Position - 0xF70C
{
	int iVar0;
...
void func_273(int* iParam0)//Position - 0xF749
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_274(var uParam0, int iParam1)//Position - 0xF781
{
	func_275(&(uParam0->f_28), iParam1);
}

void func_275(var uParam0, int iParam1)//Position - 0xF793
{
	int iVar0;
...
void func_276(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF7D4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_277(int* iParam0)//Position - 0xF824
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_278(var uParam0)//Position - 0xF865
{
	if (*uParam0 == -1)
	{
		return;
...
void func_279(char* sParam0)//Position - 0xF8A2
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_280(var uParam0)//Position - 0xF8B4
{
	*uParam0 = -1;
...
void func_281()//Position - 0xF8E7
{
	func_279("Running start routines.");
	Global_113528++;
}
