...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_530())
	{
		...
		{
			case 0:
				func_446(&iLocal_341, 509.6743f, 5532.435f, 776.0009f, 153.1431f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				func_445(Local_336, fLocal_118, 1, 0);
				iLocal_61 = 2;
				func_434(1, 0);
				break;
			
			case 1:
				func_446(&iLocal_341, 2704.0776f, 4152.2397f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				func_445(Local_331, 254.9762f, 0, 0);
				func_434(4, 0);
				break;
	...
	else if (func_433(0))
	{
		...
		{
			func_431(PLAYER::PLAYER_PED_ID(), Local_336, fLocal_118, 0, 0);
		...
		switch (iLocal_58)
		{
			case 0:
				if (iLocal_60 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER::PLAYER_PED_ID(), Local_337, fLocal_119, 0, 1);
			...
			case 1:
				...
				if (iLocal_60 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER::PLAYER_PED_ID(), Local_338, fLocal_120, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_105 == 0)
						{
			...
			case 2:
				...
				if (iLocal_60 == 1)
				{
					...
					func_431(Local_68.f_9, Local_334, 153.53f, 0, 0);
					if (!func_71())
					{
						TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
						func_431(PLAYER::PLAYER_PED_ID(), Local_334 + Vector(0f, -2f, -1f), -27.29f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_105 == 0)
						{
			...
			case 3:
				...
				if (iLocal_60 == 1)
				{
					func_431(Local_68.f_9, Local_331, 0f, 0, 0);
					if (!func_71())
					{
						func_431(PLAYER::PLAYER_PED_ID(), Local_331, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_105 == 0)
						{
...
bool func_4(struct<3> Param0, var* uParam1, float fParam2, bool bParam3)//Position - 0x697
{
	var uVar0;
	struct<3> Var1;
...
void func_10(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x76F
{
	int iVar0;
	int iVar1;
...
void func_19(int iParam0, struct<2> Param1, Vector3 vParam2)//Position - 0x9B9
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
int func_20(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)//Position - 0xA18
{
	bool bVar0;
	float fVar1;
...
bool func_28()//Position - 0xD58
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_29(int iParam0, int iParam1)//Position - 0xD72
{
	bool bVar0;
...
int func_30(int iParam0, bool bParam1)//Position - 0xDBD
{
	int iVar0;
	int iVar1;
...
int func_31()//Position - 0xDFE
{
	return Global_1574918;
}

int func_32(int iParam0)//Position - 0xE0A
{
...
bool func_33()//Position - 0xE49
{
	return BitTest(Global_2621446, 3);
}

int func_34(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xE57
{
	int iVar0;
...
{
	if (func_59(Local_332, Local_75.f_1, 210f))
	{
		if (!iLocal_112)
		{
		...
		{
			if (func_59(Local_332, Local_79.f_1, 150f))
			{
		...
		{
			if (func_59(Local_332, Local_80.f_1, 150f))
			{
...
void func_38(int* iParam0, bool bParam1)//Position - 0x10BE
{
	if (bParam1)
	{
		func_40(iParam0);
...
void func_39(int* iParam0, bool bParam1)//Position - 0x10DB
{
...
char* func_41()//Position - 0x1141
{
	return "special_ped@maude@base";
}

void func_42(int* iParam0, bool bParam1)//Position - 0x114C
{
	if (bParam1)
	{
		func_44(iParam0);
...
void func_43(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x116B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_44(int* iParam0)//Position - 0x11BB
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_45()//Position - 0x11FC
{
	return joaat("prop_radio_01");
}

float func_46()//Position - 0x1209
{
	return -92.17f;
}

Vector3 func_47()//Position - 0x1216
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_48()//Position - 0x122D
{
...
char* func_50()//Position - 0x1326
{
	return "base_chair";
}

char* func_51()//Position - 0x1331
{
	return "base";
}

Vector3 func_52()//Position - 0x133C
{
	return 0f, 0f, -92.17f;
}

Vector3 func_53()//Position - 0x134B
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_54(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x1362
{
...
void func_55(int iParam0, bool bParam1)//Position - 0x13E4
{
	if (iParam0 != 0)
	{
		if (bParam1)
...
int func_56(int iParam0)//Position - 0x140F
{
	if (iParam0 == 0)
	{
		return 1;
...
int func_57(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0x1435
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
bool func_59(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x150B
{
	return SYSTEM::VDIST2(Param0, Param1) <= (fParam2 * fParam2);
}

int func_60(int iParam0, float fParam1, int iParam2)//Position - 0x1525
{
	int iVar0;
...
int func_64(int iParam0, int iParam1)//Position - 0x168F
{
	if (func_23(iParam0))
	{
...
int func_65(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x16C2
{
...
void func_66(int iParam0)//Position - 0x185A
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_67()//Position - 0x1886
{
	if (func_432(Local_68.f_9))
	{
...
void func_68(char* sParam0)//Position - 0x18C8
{
	func_27(1, 1, 0, 0, 0, 0, 0);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_69(int iParam0, int iParam1, int iParam2)//Position - 0x18E3
{
	if (func_530() && func_71())
	{
...
void func_70(int iParam0)//Position - 0x19A7
{
	if (iParam0 == 1)
	{
	...
	switch (iLocal_60)
	{
		case 0:
			...
			if (iLocal_62 == 4)
			{
				if (func_23(Local_75.f_0))
				{
					...
					func_117(Local_75.f_0, 0);
					if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_75.f_0))
					{
						if (func_116(Local_75.f_0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 35f, 1))
						{
							AUDIO::STOP_PED_SPEAKING(Local_75.f_0, false);
							func_114(Local_75.f_0, "GENERIC_FRIGHTENED_HIGH", "MAUDE", 3);
						}
					}
				}
		...
		case 1:
			if (func_108())
			{
				...
				{
					func_106(1163.1494f, 4432.493f, 59.3682f, 266.3425f);
			...
			else
			{
				if (!iLocal_95)
				{
					...
					if (iLocal_62 == 4)
					{
						if (func_23(Local_75.f_0))
						{
							if (func_116(Local_75.f_0, Local_332, 35f, 1))
							{
				...
				if (iLocal_62 == 4)
				{
					...
					else if (func_23(Local_75.f_0))
					{
						if (!func_64(Local_75.f_0, joaat("SCRIPT_TASK_SMART_FLEE_PED")))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_75.f_0, func_113(), func_74(), 3))
								{
									func_73(&Local_75);
...
void func_73(int iParam0)//Position - 0x1CE3
{
	if (func_23(*iParam0))
	{
...
char* func_74()//Position - 0x1D4C
{
	return "female_Flee_Table_Left_Maude";
}

int func_75(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1D57
{
	if (iParam4 == 0)
	{
...
bool func_76(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1D94
{
...
int func_77(char* sParam0, int iParam1, bool bParam2)//Position - 0x1DE2
{
	Global_21606 = 0;
...
bool func_80(int iParam0)//Position - 0x214A
{
	return func_81(iParam0, 20);
}

var func_81(int iParam0, int iParam1)//Position - 0x215A
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

int func_82()//Position - 0x2172
{
	return -1;
}

void func_83()//Position - 0x217B
{
	int iVar0;
...
int func_87()//Position - 0x237C
{
	func_88();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_88()//Position - 0x2395
{
	int iVar0;
...
bool func_89(int iParam0)//Position - 0x2492
{
	return iParam0 < 3;
}

int func_90(int iParam0)//Position - 0x249E
{
	int iVar0;
	int iVar1;
...
int func_91(int iParam0)//Position - 0x24DB
{
	if (func_89(iParam0))
	{
...
var func_92(int iParam0)//Position - 0x2500
{
	return Global_1998[iParam0 /*29*/];
}

bool func_93(int iParam0)//Position - 0x250F
{
	return Global_43052 == iParam0;
}

void func_94()//Position - 0x251D
{
	int iVar0;
...
bool func_95(int iParam0, int iParam1)//Position - 0x2574
{
	switch (iParam0)
	{
		case 5:
...
void func_96(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x25AC
{
...
void func_97(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2602
{
...
void func_99(int* iParam0, bool bParam1)//Position - 0x2871
{
	if (bParam1)
	{
		func_101(iParam0);
...
void func_100(int* iParam0)//Position - 0x288D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_101(int* iParam0)//Position - 0x28C5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_102(int iParam0)//Position - 0x2961
{
	if (func_432(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_103(var uParam0)//Position - 0x298B
{
...
void func_104(struct<3> Param0, float fParam1)//Position - 0x29A4
{
	func_105(&(Global_106934.f_2890), Param0, fParam1);
}

void func_105(var uParam0, struct<3> Param1, var uParam2)//Position - 0x29BD
{
	*uParam0 = { Param1 };
	uParam0->f_6 = uParam2;
}

void func_106(struct<3> Param0, float fParam1)//Position - 0x29D3
{
	if (func_107(Global_78559, 0f, 0f, 0f, 0))
	{
		Global_78559 = { Param0 };
...
bool func_107(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x29FF
{
	if (bParam2)
	{
...
void func_109(char* sParam0)//Position - 0x2A73
{
...
void func_110(int iParam0, bool bParam1)//Position - 0x2AB2
{
	if (func_23(iParam0))
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(iParam0, 5, false);
...
int func_111(int iParam0, int iParam1, int iParam2)//Position - 0x2B2D
{
	int iVar0;
...
char* func_112()//Position - 0x2C79
{
	return "Female_Flee_Table_Left_Maude_Chair";
}

char* func_113()//Position - 0x2C84
{
	return "special_ped@maude@exit_flee";
}

void func_114(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2C90
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_115(iParam3), false);
}

int func_115(int iParam0)//Position - 0x2CA9
{
	int iVar0;
...
bool func_116(int iParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x2E9E
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), Param1) <= (fParam2 * fParam2);
}

void func_117(int iParam0, bool bParam1)//Position - 0x2EBC
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_118(var uParam0, int iParam1)//Position - 0x2F2D
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_120(int* iParam0)//Position - 0x2F6E
{
	bool bVar0;
	struct<8> Var1;
...
void func_121(int* iParam0)//Position - 0x2FE0
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_122(int iParam0)//Position - 0x3000
{
	int iVar0;
...
bool func_124(int iParam0, int iParam1)//Position - 0x30DA
{
...
void func_126(int iParam0, int iParam1, int iParam2)//Position - 0x3121
{
	bool bVar0;
...
void func_127()//Position - 0x3207
{
	...
	{
		func_130(13, SYSTEM::FLOOR(Global_113386.f_10194.f_3853));
	}
...
int func_129()//Position - 0x3710
{
	return Global_31959;
}

int func_130(int iParam0, int iParam1)//Position - 0x371B
{
	int iVar0;
...
void func_131(int iParam0, bool bParam1, int iParam2)//Position - 0x376C
{
	if (iParam2 == -1)
	{
		iParam2 = func_31();
...
int func_132(int iParam0)//Position - 0x378A
{
	int iVar0;
		...
		case 0:
			...
			if (func_37())
			{
				if (func_60(1, 10.5f, 1))
				{
					...
					if (func_196(Var2, 0))
					{
						func_189(Var0, Var1, fVar3, 2721.02f, 4140.34f, 43.66f, 257.67f, 1, 1, 1, 0, 0);
						func_135(2721.02f, 4140.34f, 43.66f, 257.67f, 0, 145);
					}
					else
					{
						func_189(Var0, Var1, fVar3, 2710.6646f, 4149.075f, 42.7026f, 180.9488f, 1, 1, 1, 0, 0);
...
void func_134(int iParam0)//Position - 0x3AAE
{
	iLocal_58 = iParam0;
	iLocal_60 = 0;
}

void func_135(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x3ABD
{
	struct<3> Var0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103950.f_4))
	{
		...
		{
			if (func_188(24) != Global_103950.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_185(ENTITY::GET_ENTITY_COORDS(Global_103950.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_136(Global_103950.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}

void func_136(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x3B38
{
	struct<60> Var0;
...
void func_137(int iParam0, int iParam1, int iParam2)//Position - 0x3C61
{
	int iVar0;
	...
	if (!func_169(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_113386.f_32749.f_4801 = func_158();
			}
...
void func_138(int iParam0, int iParam1)//Position - 0x3D78
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_179(iParam0, &(Global_113386.f_32749.f_5510));
}

int func_139(int iParam0)//Position - 0x3F7A
{
...
int func_140(int iParam0)//Position - 0x4058
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_141(int iParam0, bool bParam1)//Position - 0x4209
{
	int iVar0;
	struct<2> Var1;
...
int func_142(int iParam0)//Position - 0x4389
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_144(int iParam0)//Position - 0x446C
{
	int iVar0;
	int iVar1;
...
bool func_145()//Position - 0x773D
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_146()//Position - 0x7753
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_147()//Position - 0x7769
{
	return 0;
}

int func_148()//Position - 0x7772
{
	return 1;
}

int func_149()//Position - 0x777B
{
	return 1;
}

int func_150()//Position - 0x7784
{
...
int func_152(int iParam0)//Position - 0x7855
{
	int iVar0;
	char* sVar1;
...
int func_153(int iParam0)//Position - 0x789B
{
	int iVar0;
...
int func_154(int iParam0)//Position - 0x78D6
{
	int iVar0;
...
int func_155(int iParam0)//Position - 0x7952
{
	int iVar0;
...
int func_156(int iParam0, int iParam1, bool bParam2)//Position - 0x7A3A
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_157(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x7AA8
{
...
void func_159(var uParam0, int iParam1)//Position - 0x7BC6
{
	if (iParam1 <= 0)
	{
		return;
...
void func_160(var uParam0, int iParam1)//Position - 0x7C4C
{
...
void func_161(var uParam0, int iParam1)//Position - 0x7C7F
{
	int iVar0;
	int iVar1;
...
int func_162(int iParam0, int iParam1)//Position - 0x7CD0
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_163(int iParam0)//Position - 0x7D72
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_164(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_164(bool bParam0, int iParam1, int iParam2)//Position - 0x7D94
{
	if (bParam0)
	{
		return iParam1;
...
int func_165(var uParam0)//Position - 0x7DAB
{
	return uParam0 & 15;
}

void func_166(var uParam0, int iParam1)//Position - 0x7DB8
{
...
void func_167(var uParam0, int iParam1)//Position - 0x7DF2
{
...
void func_168(var uParam0, int iParam1)//Position - 0x7E2D
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_169(var uParam0, int iParam1)//Position - 0x7E69
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_107(Global_113386.f_32749.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_107(Global_113386.f_2363.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_107(Global_113386.f_2363.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_170(int iParam0, int iParam1)//Position - 0x969C
{
	struct<82> Var0;
...
void func_171(int iParam0, var uParam1, int iParam2)//Position - 0x96DE
{
	int iVar0;
...
void func_172(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x993A
{
	if (func_169(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_177(iParam0);
			func_176(uParam1, &(Global_113386.f_32749.f_69[Global_77137.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_173(int iParam0, bool bParam1)//Position - 0x9A33
{
	if (iParam0 == -1)
	{
		return;
...
void func_174(int iParam0, int iParam1, bool bParam2)//Position - 0x9A90
{
	if (iParam0 == -1)
	{
		return;
...
int func_175(int iParam0, int iParam1)//Position - 0x9ACB
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_176(var uParam0, var uParam1)//Position - 0x9AEB
{
...
void func_177(int iParam0)//Position - 0x9BB7
{
	if (iParam0 == -1)
	{
		return;
...
int func_178(int iParam0)//Position - 0x9C2E
{
	int iVar0;
...
void func_179(int iParam0, var uParam1)//Position - 0x9C91
{
	int iVar0;
...
int func_180(int iParam0)//Position - 0x9F3C
{
	switch (iParam0)
	{
		case 1:
...
int func_181(int iParam0, var uParam1, var uParam2)//Position - 0x9FEC
{
	int iVar0;
	int iVar1;
...
int func_182(int iParam0)//Position - 0xA1DF
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_183(var uParam0)//Position - 0xA1FF
{
	int iVar0;
...
void func_184(int iParam0)//Position - 0xA2AF
{
...
int func_185(struct<3> Param0, int iParam1, var uParam2, var uParam3)//Position - 0xA2D6
{
	int iVar0;
...
int func_186(struct<3> Param0, int iParam1, int iParam2)//Position - 0xA3EC
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_187(int iParam0)//Position - 0xA47B
{
	return BitTest(Global_113386.f_7229[iParam0], 0);
}

int func_188(int iParam0)//Position - 0xA490
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_189(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0xA4AC
{
	func_190(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_190(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0xA4D5
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_191(struct<3> Param0)//Position - 0xA8CB
{
...
int func_192(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0xA8F5
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_193(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0xABEB
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_194(struct<3> Param0)//Position - 0xAC9F
{
	float fVar0;
	float fVar1;
...
void func_195(int iParam0)//Position - 0xACDE
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
bool func_196(struct<3> Param0, int iParam1)//Position - 0xAD43
{
	return func_197(Global_103950.f_2890.f_12.f_66, Param0, iParam1);
}

int func_197(int iParam0, struct<3> Param1, int iParam2)//Position - 0xAD60
{
	struct<3> Var0;
	struct<3> Var1;
...
Vector3 func_198()//Position - 0xADCA
{
	return 2.55f, 5.665f, 2.55f;
}

Vector3 func_199()//Position - 0xADE1
{
	return 3.01f, 11.01f, 6.01f;
}

int func_200(var uParam0, var uParam1, var uParam2)//Position - 0xADF8
{
...
Vector3 func_202(int iParam0)//Position - 0xAFED
{
...
int func_203(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xB000
{
	...
	if (iParam5 == 0)
	{
		Global_78130[1 /*14*/] = { func_254(iVar10, iParam1, iParam2, -1) };
		if (!func_253(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78130[1 /*14*/] = { func_254(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_254(iVar10, 14, uVar12[iVar1], -1) };
							func_223(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
							func_246(14);
							if (Global_78128 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_213(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_213(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_213(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
						}
						func_246(iVar0);
						if (Global_78128 == 1)
						{
			...
			{
				Global_78130[1 /*14*/] = { func_254(iVar10, iVar0, func_212(iParam0, iVar0, -1), -1) };
		...
		if (iParam7 == 1)
		{
			Var14 = { func_254(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var14 = { func_254(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var14 = { func_254(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var14 = { func_254(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var14 = { func_254(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_254(iVar10, 14, uVar15[iVar1], -1) };
			func_223(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_246(14);
			if (Global_78128 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_213(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_213(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_213(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
		}
		if (Global_78128 == 1)
		{
			iVar2 = 0;
...
int func_205(int iParam0)//Position - 0xB89C
{
	switch (iParam0)
	{
...
void func_206(int iParam0, int iParam1, int iParam2)//Position - 0xB8D7
{
	int iVar0;
	int iVar1;
...
int func_207(int iParam0, int iParam1, int iParam2)//Position - 0xB961
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_208(int iParam0, int iParam1, int iParam2)//Position - 0xBA3F
{
	Global_78130[1 /*14*/] = { func_254(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78130[1 /*14*/].f_6, 2);
}

int func_209(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0xBA67
{
	var uVar0;
	int iVar1;
...
int func_210(int iParam0, int iParam1, int iParam2)//Position - 0xC06E
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_213(int iParam0)//Position - 0xC23E
{
	switch (iParam0)
	{
		case 0:
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC2EE
{
	int iVar0;
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC5F5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_216(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0xD1A8
{
	int iVar0;
...
int func_217(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD48C
{
	int iVar0;
...
int func_218(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD753
{
	int iVar0;
	int iVar1;
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD78A
{
	int iVar0;
...
int func_220(int iParam0, int iParam1, int iParam2)//Position - 0xD7B3
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_221(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDA7D
{
	int iVar0;
...
int func_222(int iParam0, int iParam1, int iParam2)//Position - 0xDD07
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_223(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDE5E
{
	int iVar0;
...
int func_224(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDEF6
{
	switch (iParam0)
	{
...
int func_225(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDFC4
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_213(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_226(int iParam0, int iParam1)//Position - 0xE0DE
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_227(int iParam0)//Position - 0xE485
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_228(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE4E6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_229(int iParam0, int iParam1)//Position - 0xE5E2
{
	int iVar0;
...
int func_230(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE720
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_231(int iParam0)//Position - 0xE7DB
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_232(int iParam0)//Position - 0xE83A
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_233(int iParam0, int iParam1)//Position - 0xE8C0
{
	int iVar0;
	struct<10> Var1;
...
void func_234(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF1EF
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var2;
...
void func_235(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xF319
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_236(int iParam0, int iParam1)//Position - 0xF361
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_239(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[0], Global_113386.f_2363.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_239(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[1], Global_113386.f_2363.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_239(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[2], Global_113386.f_2363.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_237(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x111AA
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var2;
...
int func_238(int iParam0)//Position - 0x11394
{
	switch (iParam0)
	{
		case 0:
...
void func_239(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x11444
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_240(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x114B5
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_225(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_225(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_225(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_225(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_241(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11732
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_242(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11B57
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_243(int iParam0, int iParam1)//Position - 0x11E4A
{
	int iVar0;
	int iVar1;
...
int func_244(int iParam0, int iParam1)//Position - 0x11E90
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_245(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11EF0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_246(int iParam0)//Position - 0x11F47
{
	if (BitTest(Global_78130[1 /*14*/].f_6, 1) && !BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
		func_252(iParam0, Global_78130[1 /*14*/].f_5, Global_78130[1 /*14*/].f_2, 2, Global_78130[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_78130[1 /*14*/].f_6, 1) && BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_247(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x11FF3
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		iVar3 = func_250(iVar2, iVar0, 0);
		MISC::SET_BIT(&iVar3, iVar1);
		func_248(iVar2, iVar3, iVar0, 1, 0);
	}
}

void func_248(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x1203D
{
	int iVar0;
	...
	iVar0 = Global_2826809[iParam0 /*3*/][func_249(iParam2)];
	if (iVar0 != 0)
	{
...
int func_249(var uParam0)//Position - 0x1206D
{
	int iVar0;
	int iVar1;
...
int func_250(int iParam0, int iParam1, int iParam2)//Position - 0x120A1
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 13122)
	{
		...
		iVar0 = Global_2826809[iParam0 /*3*/][func_249(iParam1)];
...
bool func_251(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x120DE
{
	int iVar0;
...
int func_252(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x14630
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_253(int iParam0)//Position - 0x154D3
{
	if (!BitTest(Global_78130[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_254(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1551B
{
	func_317();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_255(int iParam0, int iParam1)//Position - 0x1556D
{
	switch (iParam0)
	{
		case 0:
...
void func_256(int iParam0)//Position - 0x1565D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_263(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_257(&(Global_78130[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_257(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x168D4
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_261(Global_2883588, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_261(Global_2883588, 2, 1, 1, -1))
			{
	...
	else if (uParam0->f_5 >= 0 && uParam0->f_5 < 3)
	{
		MISC::SET_BIT(&(uParam0->f_6), 0);
		MISC::SET_BIT(&(uParam0->f_6), 5);
		if (func_252(iParam1, uParam0->f_5, uParam0->f_2, 0, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 1);
		}
		if (func_252(iParam1, uParam0->f_5, uParam0->f_2, 1, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 2);
		}
		if (!func_252(iParam1, uParam0->f_5, uParam0->f_2, 2, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 4);
		}
	}
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_250(func_260(iParam1, uParam0->f_2), Global_78127, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_250(func_259(iParam1, uParam0->f_2), Global_78127, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			if (func_258(iParam1, uParam0->f_2, &iVar1))
			{
				uVar0 = func_250(iVar1, Global_78127, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_258(int iParam0, int iParam1, var uParam2)//Position - 0x16C79
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_259(int iParam0, int iParam1)//Position - 0x1707E
{
	switch (iParam1)
	{
		case 0:
...
int func_260(int iParam0, int iParam1)//Position - 0x17479
{
	switch (iParam1)
	{
		case 0:
...
int func_261(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x17874
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	if (func_251(iParam0, iParam1, &iVar2, &uVar1, bParam2, bParam3))
	{
		uVar3 = func_250(iVar2, iVar0, 0);
		return BitTest(uVar3, uVar1);
	}
	return 0;
}

int func_262(int iParam0)//Position - 0x178B3
{
	switch (iParam0)
	{
		case -1:
...
void func_263(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x17987
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar3 >= 0)
		{
			...
			if (iVar4 > iVar3)
			{
				...
				func_257(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_257(&(Global_78130[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_257(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_257(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_213(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_264(int iParam0)//Position - 0x17C0E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_265(int iParam0)//Position - 0x17D65
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_266(int iParam0)//Position - 0x18275
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_267(int iParam0)//Position - 0x182EA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_268(int iParam0)//Position - 0x1835E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_269(int iParam0)//Position - 0x18445
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_270(int iParam0)//Position - 0x187A8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_271(int iParam0)//Position - 0x189B9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_272(int iParam0)//Position - 0x18BE9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_273(int iParam0)//Position - 0x18CF9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_274(int iParam0)//Position - 0x19698
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_275(int iParam0)//Position - 0x1A20B
{
	if (iParam0 < 136)
	{
		func_277(iParam0);
	...
	{
		func_263(3, iParam0, 242, -1);
	}
}

void func_276(int iParam0)//Position - 0x1A240
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_277(int iParam0)//Position - 0x1AE44
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_278(int iParam0)//Position - 0x1BD52
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_279(int iParam0)//Position - 0x1BE7F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_280(int iParam0, int iParam1)//Position - 0x1BF7D
{
	switch (iParam0)
	{
		case 0:
...
void func_281(int iParam0)//Position - 0x1C06F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_282(int iParam0)//Position - 0x1D560
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_283(int iParam0)//Position - 0x1D6B1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_284(int iParam0)//Position - 0x1DBBC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_285(int iParam0)//Position - 0x1E22A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_286(int iParam0)//Position - 0x1E29E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_287(int iParam0)//Position - 0x1E36E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_288(int iParam0)//Position - 0x1E89E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_289(int iParam0)//Position - 0x1EA35
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_290(int iParam0)//Position - 0x1F233
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_291(int iParam0)//Position - 0x1F343
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_292(int iParam0)//Position - 0x20271
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_293(int iParam0)//Position - 0x20F2E
{
	if (iParam0 < 107)
	{
		func_296(iParam0);
	...
	if (Global_78130[0 /*14*/].f_2 == -1)
	{
		func_263(3, iParam0, 318, -1);
	}
}

void func_294(int iParam0)//Position - 0x20F74
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_295(int iParam0)//Position - 0x21A19
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_296(int iParam0)//Position - 0x22808
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_297(int iParam0)//Position - 0x23451
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_298(int iParam0)//Position - 0x236CA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_299(int iParam0, int iParam1)//Position - 0x23810
{
	switch (iParam0)
	{
		case 0:
...
void func_300(int iParam0)//Position - 0x23900
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_301(int iParam0)//Position - 0x2468C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_302(int iParam0)//Position - 0x24806
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_303(int iParam0)//Position - 0x24D7D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_304(int iParam0)//Position - 0x252A7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_305(int iParam0)//Position - 0x2531B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_306(int iParam0)//Position - 0x253EB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_307(int iParam0)//Position - 0x258C3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_308(int iParam0)//Position - 0x25B2C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_309(int iParam0)//Position - 0x25E02
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_310(int iParam0)//Position - 0x25FCB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_311(int iParam0)//Position - 0x26B1F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_312(int iParam0)//Position - 0x27769
{
	if (iParam0 < 60)
	{
		func_314(iParam0);
	...
	if (Global_78130[0 /*14*/].f_2 == -1)
	{
		func_263(3, iParam0, 181, -1);
	}
}

void func_313(int iParam0)//Position - 0x2779E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_314(int iParam0)//Position - 0x28540
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_315(int iParam0)//Position - 0x28BCC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_316(int iParam0)//Position - 0x28CB3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_317()//Position - 0x28DB1
{
...
int func_318(int iParam0, int iParam1, int iParam2)//Position - 0x28E2A
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_78130[1 /*14*/] = { func_254(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_78130[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_318(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_318(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_78130[2 /*14*/] = { func_254(iVar0, 14, iVar4, -1) };
									if (Global_78130[2 /*14*/].f_12 == iVar3)
									{
										if (func_318(iParam0, 14, iVar4))
										{
											if (!func_209(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_78130[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_78130[2 /*14*/] = { func_254(iVar0, iVar2, iVar1, -1) };
						if (!func_209(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_78130[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_78130[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_213(iParam1)) && Global_78130[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_213(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_319(bool bParam0)//Position - 0x29082
{
	int iVar0;
...
void func_320()//Position - 0x290C1
{
	...
	if (func_23(Local_68.f_9))
	{
		...
		func_387(Local_68.f_9, &iLocal_133, 1126825984, 7);
		func_379(Local_68.f_9, &(Local_68.f_19), 1126825984, 7);
		func_367();
		switch (iLocal_60)
		{
			case 0:
				...
				if (func_23(Local_68.f_9))
				{
					...
					{
						Local_68.f_8 = func_364(Local_68.f_9, 1, 0, 5);
					}
				...
				func_363(&(Local_68.f_8), "", "", &iLocal_126, iLocal_127, 0);
				iLocal_60 = 1;
				break;
			...
			case 1:
				...
				{
					func_363(&(Local_68.f_8), "", "", &iLocal_126, iLocal_127, 0);
					func_335(&uLocal_44, Local_68.f_9, 0, 0, 1, 1, 1);
					if (Local_68.f_10 == 22 || Local_68.f_10 == 23)
					{
						if (iLocal_135 == -1)
						{
						...
						if (func_332(Local_68.f_9, Local_332, bVar0, 0, 1, iLocal_137))
						{
							if ((func_124(iLocal_135, 5000) || func_107(Local_340, 0f, 0f, 0f, 0)) || (!func_59(Var1, Local_340, 8.5f) && !func_59(Var1, Local_339, 8.5f)))
							{
								func_331();
								Local_68.f_17 = MISC::GET_GAME_TIMER();
								func_329(&uLocal_44, 0, 0);
								iLocal_109 = 1;
							}
						}
						else
						{
							if (!iLocal_81)
							{
								if (!func_124(iLocal_123, 2500))
								{
									if (!func_62())
									{
										if (func_116(Local_68.f_9, Local_332, 30f, 1))
										{
							...
							func_328(Local_68.f_9, Local_332, iLocal_135, 925353388);
						}
					}
					else
					{
				...
				{
					func_331();
					if (!func_116(Local_68.f_9, Local_332, 10f, 1))
					{
						if (!iLocal_98)
						{
							if (!func_326(sLocal_148, 1))
							{
								func_324(&(Local_68.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_126, &iLocal_127, 1, 1);
								iLocal_98 = 1;
							}
						}
						else
						{
							func_363(&(Local_68.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_126, iLocal_127, 1);
						}
					}
					else
					{
						if (!iLocal_82)
						{
							...
							{
								if (func_323("BBS_APPSUS", 0, 0) || func_323("BBS_APPSUS2", 0, 0))
								{
									HUD::CLEAR_PRINTS();
								}
								if (!func_62())
...
int func_321(var uParam0)//Position - 0x2959F
{
	struct<3> Var0;
...
int func_322(var uParam0)//Position - 0x295E4
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
...
bool func_323(char* sParam0, int iParam1, char* sParam2)//Position - 0x2961C
{
...
void func_324(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x2963A
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
		if (bParam5)
		{
			...
			if (iParam6 && !func_62())
			{
				if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_323(sParam2, 0, 0))
				{
					func_325(sParam1, 7500, 0);
				}
			}
		}
		else
		{
			...
			if (iParam6 && !func_62())
			{
				if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_323(sParam1, 0, 0))
				{
					func_325(sParam2, 7500, 0);
				}
			}
		}
...
void func_325(char* sParam0, int iParam1, int iParam2)//Position - 0x296E6
{
	iParam2 = iParam2;
...
int func_326(char* sParam0, bool bParam1)//Position - 0x296FF
{
	struct<6> Var0;
...
struct<6> func_327()//Position - 0x2973A
{
	struct<6> Var0;
...
void func_328(int iParam0, struct<3> Param1, int iParam2, float fParam3)//Position - 0x2975E
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_329(var uParam0, int iParam1, bool bParam2)//Position - 0x29843
{
	char* sVar0;
...
bool func_330(char* sParam0)//Position - 0x2991D
{
...
int func_332(int iParam0, struct<3> Param1, bool bParam2, bool bParam3, bool bParam4, int iParam5)//Position - 0x29A2B
{
	int iVar0;
	...
	if (func_23(iParam0))
	{
		...
		if (bParam3)
		{
			if (func_333(iParam0, Param1, 1112014848, 1084227584))
			{
				return 1;
			}
		}
		...
		if (bParam2)
		{
			if (func_116(iParam0, Param1, 5f, 1))
			{
				if (PED::IS_PED_RAGDOLL(iParam0))
				{
					return 1;
				}
				if (func_116(iParam0, Param1, 1f, 1))
				{
					return 1;
				}
			}
...
int func_333(int iParam0, struct<3> Param1, float fParam2, float fParam3)//Position - 0x29BA3
{
	if (func_116(iParam0, Param1, fParam2, 1))
	{
...
int func_334(int iParam0, struct<3> Param1)//Position - 0x29BDC
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (PLAYER::GET_TIME_SINCE_PLAYER_HIT_PED(PLAYER::PLAYER_ID()) >= 0 && PLAYER::GET_TIME_SINCE_PLAYER_HIT_PED(PLAYER::PLAYER_ID()) < 500)
		{
			if (func_116(iParam0, Param1, 3.5f, 1) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), iParam0))
			{
				return 1;
			}
		}
...
void func_335(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x29C3B
{
	func_336(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_336(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x29C55
{
	func_337(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_337(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x29C72
{
...
void func_338(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x29CAA
{
	int iVar0;
	int iVar1;
	...
	if (func_361(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_353(uParam0, iParam1, Param2, iParam4);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
void func_339(var uParam0)//Position - 0x2A017
{
...
int func_340(var uParam0)//Position - 0x2A080
{
	int iVar0;
...
int func_341(bool bParam0)//Position - 0x2A0AB
{
	switch (Global_43052)
	{
		case 0:
...
void func_342(char* sParam0, int iParam1)//Position - 0x2A155
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_343(char* sParam0)//Position - 0x2A16C
{
	if (!func_344(1, 1, 0))
	{
		if ((!MISC::IS_STRING_NULL_OR_EMPTY(sParam0) && func_330(sParam0)) || func_330("CMN_HINT" /* GXT: ~s~Press ~INPUT_VEH_CIN_CAM~ to toggle focus on the target. */))
		{
			HUD::CLEAR_HELP(true);
		}
		return 0;
...
int func_344(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2A205
{
	int iVar0;
	int iVar1;
	...
	if ((func_351() || func_350(Global_4718592.f_168757)) || func_349())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
			iVar1 = func_348(PLAYER::PLAYER_PED_ID(), 0);
			if (((VEHICLE::IS_TURRET_SEAT(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("riot2") && iVar1 == 0) && func_347(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_345(int iParam0)//Position - 0x2A45E
{
	if (iParam0 != func_82())
	{
		...
		else if ((Global_1575058 && iParam0 == PLAYER::PLAYER_ID()) && func_346(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
int func_346(int iParam0, bool bParam1, bool bParam2)//Position - 0x2A4C4
{
	int iVar0;
...
int func_347(int iParam0, int iParam1)//Position - 0x2A524
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_348(int iParam0, bool bParam1)//Position - 0x2A586
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_349()//Position - 0x2A60B
{
	return Global_2714762.f_19;
}

bool func_350(int iParam0)//Position - 0x2A619
{
	return iParam0 == 51;
}

var func_351()//Position - 0x2A626
{
	return Global_2714762.f_18;
}

bool func_352()//Position - 0x2A634
{
	return MISC::GET_GAME_TIMER() <= Global_23150.f_6269 + 100;
}

void func_353(var uParam0, int iParam1, struct<3> Param2, int iParam3)//Position - 0x2A649
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_354()//Position - 0x2A759
{
	return func_355(PLAYER::PLAYER_ID());
}

int func_355(int iParam0)//Position - 0x2A769
{
...
int func_356(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x2A788
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_357(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2AAF4
{
...
int func_358(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2AB46
{
	if (!func_344(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_359(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2AB8F
{
	if (!func_344(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_360(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2ABEE
{
	if (!func_344(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_361(int iParam0)//Position - 0x2AC44
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_362()//Position - 0x2AC9F
{
	MISC::SET_BIT(&Global_8137, 4);
}

void func_363(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2ACAF
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
	...
	{
		if (func_323(sParam1, 0, 0))
		{
			HUD::CLEAR_THIS_PRINT(sParam1);
		}
		if (func_323(sParam2, 0, 0))
		{
...
int func_364(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x2ADAA
{
	int iVar0;
	bool bVar1;
...
void func_366(var* uParam0, struct<3> Param1)//Position - 0x2AE44
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_367()//Position - 0x2AF21
{
	...
	if (func_23(Local_68.f_9))
	{
		if (iLocal_70 == 0)
		{
			func_378(&(Local_68.f_9), &bLocal_115);
			if (func_377())
			{
				if (iLocal_109 || iLocal_58 == 7)
				{
					if (bLocal_115)
					{
						PED::SET_PED_MOVEMENT_CLIPSET(Local_68.f_9, func_376(), 0.25f);
						iLocal_70 = 2;
					}
					else
					{
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				case 0:
					if (func_116(Local_68.f_9, Local_332, 20f, 1))
					{
				...
				case 6:
					if (!func_116(Local_68.f_9, Local_332, 3.5f, 1))
					{
				...
				case 13:
					if ((!PED::IS_PED_FALLING(Local_68.f_9) && !PED::IS_PED_RAGDOLL(Local_68.f_9)) && !PED::IS_PED_BEING_STUNNED(Local_68.f_9, 0))
					{
						if (func_124(Local_68.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
						{
							...
							TASK::OPEN_SEQUENCE_TASK(&iLocal_145);
							if (!func_116(Local_68.f_9, Local_68.f_13, 0.5f, 1))
							{
				...
				case 18:
					if (!func_116(Local_68.f_9, Local_63, 50f, 1))
					{
					...
					if ((!PED::IS_PED_FALLING(Local_68.f_9) && !PED::IS_PED_RAGDOLL(Local_68.f_9)) && !PED::IS_PED_BEING_STUNNED(Local_68.f_9, 0))
					{
						if (!TASK::IS_PED_GETTING_UP(Local_68.f_9))
						{
							...
							{
								if (!func_116(Local_68.f_9, Local_63, 25f, 1))
								{
									ENTITY::SET_ENTITY_HEALTH(Local_68.f_9, 0, 0);
								}
								else
				...
				case 20:
					...
					else if (PED::GET_PED_PARACHUTE_STATE(Local_68.f_9) == 2)
					{
						if (!iLocal_106)
						{
							if (!func_116(Local_68.f_9, Local_63, 220f, 1))
							{
				...
				case 24:
					...
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_71[0 /*6*/], false) && func_116(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f, 1)) && func_374(ENTITY::GET_ENTITY_HEADING(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f))
						{
				...
				case 25:
					...
					else if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_71[0 /*6*/], false) || PED::IS_PED_BEING_JACKED(Local_68.f_9)) || !func_116(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f, 1)) || !func_374(ENTITY::GET_ENTITY_HEADING(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f))
					{
						Local_68.f_10 = 22;
					}
				...
				case 30:
					if (func_372(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_371())
					{
						Local_68.f_10 = 32;
					}
					else if (PED::DOES_GROUP_EXIST(func_370()))
					{
						...
						if (!PED::IS_PED_GROUP_MEMBER(Local_68.f_9, func_370()))
						{
							PED::SET_PED_AS_GROUP_MEMBER(Local_68.f_9, func_370());
						}
						PED::SET_GROUP_FORMATION(func_370(), 0);
						PED::SET_GROUP_FORMATION_SPACING(func_370(), 1.5f, 3.5f, -1f);
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (func_369())
							{
								...
								if (!PED::IS_PED_IN_VEHICLE(Local_68.f_9, iVar1, false))
								{
									...
									if (fVar6 < 1.75f && func_116(Local_68.f_9, Local_332, 8f, 1))
									{
				...
				case 32:
					if (func_372(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_371())
					{
						...
						{
							TASK::TASK_LOOK_AT_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							if ((!func_368(Local_68.f_19, 10) && func_116(Local_68.f_9, Local_332, 50f, 1)) || !func_124(iLocal_142, 2000))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, false))
								{
									TASK::TASK_LEAVE_ANY_VEHICLE(Local_68.f_9, 0, 0);
								}
								else if (((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && !PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_68.f_9)) && !func_371()) || ENTITY::IS_ENTITY_IN_WATER(Local_68.f_9))
								{
									TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), -1);
								}
					...
					if (func_372(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_371())
					{
						if (!func_64(Local_68.f_9, joaat("SCRIPT_TASK_HANDS_UP")))
						{
							if (!func_64(Local_68.f_9, joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, false))
								{
									if (!func_368(Local_68.f_19, 10) && func_116(Local_68.f_9, Local_332, 50f, 1))
									{
										TASK::TASK_LEAVE_ANY_VEHICLE(Local_68.f_9, 0, 0);
										Local_68.f_10 = 32;
									}
							...
							else if (!func_368(Local_68.f_19, 10) && func_116(Local_68.f_9, Local_332, 50f, 1))
							{
								if ((WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_68.f_9)) || func_371())
								{
									Local_68.f_10 = 32;
								}
							}
...
bool func_368(int iParam0, int iParam1)//Position - 0x2C50E
{
	return (MISC::GET_FRAME_COUNT() - iParam0) > iParam1;
}

int func_369()//Position - 0x2C520
{
	int iVar0;
	int iVar1;
...
int func_370()//Position - 0x2C5A6
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_371()//Position - 0x2C5B6
{
	if (!iLocal_82)
	{
		return 1;
	}
	if (func_326(sLocal_148, 0))
	{
		return 1;
	}
...
int func_372(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)//Position - 0x2C623
{
	...
	if (func_23(iParam0))
	{
		...
		if (func_116(iParam0, Local_332, fParam2, 1))
		{
			if (!func_368(iParam1, 10))
			{
				if (bParam6)
				{
					if (func_373(1, 0, 1))
...
int func_373(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2C7DA
{
	int iVar0;
...
int func_374(float fParam0, float fParam1, float fParam2)//Position - 0x2C8D1
{
...
char* func_375()//Position - 0x2C8ED
{
	return "move_m@bail_bond_not_tazered";
}

char* func_376()//Position - 0x2C8F9
{
	return "move_m@bail_bond_tazered";
}

int func_377()//Position - 0x2C905
{
	STREAMING::REQUEST_ANIM_SET(func_375());
	STREAMING::REQUEST_ANIM_SET(func_376());
	if (STREAMING::HAS_CLIP_SET_LOADED(func_375()) && STREAMING::HAS_CLIP_SET_LOADED(func_376()))
	{
		return 1;
	}
	return 0;
...
void func_378(var uParam0, bool bParam1)//Position - 0x2C93A
{
...
void func_379(int iParam0, var uParam1, float fParam2, int iParam3)//Position - 0x2C951
{
	if (func_432(iParam0))
	{
		if (func_380(iParam0, PLAYER::PLAYER_PED_ID(), fParam2, 1, 250, iParam3))
		{
...
bool func_380(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2C97D
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (!func_432(iParam0) || !func_432(iParam1))
	{
		if (iVar2 != -1)
		{
	...
	uVar0 = func_381(&(Local_56[iVar2 /*4*/]), Var1, iParam1, &(Local_56[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_56[iVar2 /*4*/].f_3) < iParam4);
}

int func_381(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2CA3E
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_382(int iParam0, int iParam1)//Position - 0x2CB6A
{
	int iVar0;
...
int func_384(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2CC79
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
float func_385(struct<3> Param0, struct<3> Param1)//Position - 0x2CD0A
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

int func_386(int iParam0, int iParam1)//Position - 0x2CD2B
{
	int iVar0;
...
void func_387(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2CD6A
{
	if (func_432(iParam0))
	{
		if (func_380(PLAYER::PLAYER_PED_ID(), iParam0, fParam2, 1, 250, iParam3))
		{
...
{
	if (func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_331, 100f))
	{
		if (!func_389())
		{
	...
	{
		if (!func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_331, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
...
bool func_389()//Position - 0x2CE20
{
	return Global_97750;
}
	...
	if (func_23(Local_68.f_9))
	{
		...
		switch (iLocal_60)
		{
			...
			case 1:
				if (!iLocal_110)
				{
					if (func_323("BBS_05", 0, 0))
					{
						HUD::CLEAR_THIS_PRINT("BBS_05");
					}
					func_121(&(Local_68.f_8));
					if (!func_116(Local_68.f_9, Local_332, 25f, 1))
					{
					...
					{
						func_393();
						func_391(&Local_75, Local_332, &iLocal_125, 5000, 1101004800);
					}
				}
				else if (func_116(Local_68.f_9, Local_332, 8f, 1))
				{
				...
				else
				{
					...
					if (!HUD::DOES_BLIP_EXIST(Local_68.f_8))
					{
						Local_68.f_8 = func_364(Local_68.f_9, 1, 1, 5);
					}
					if (!iLocal_101)
					{
						func_325("BBS_05", 7500, 1);
						iLocal_101 = 1;
					}
				}
				if (func_321(&(Local_68.f_9)))
...
int func_391(int iParam0, struct<3> Param1, int iParam2, int iParam3, float fParam4)//Position - 0x2D142
{
	struct<3> Var0;
	var uVar1;
	char[] cVar2[8];
		...
		if (!func_62())
		{
			...
			if (SYSTEM::VDIST2(Param1, Var0) < (fParam4 * fParam4))
			{
				if (MISC::GET_GAME_TIMER() - *iParam2) > (iParam3 + MISC::GET_RANDOM_INT_IN_RANGE(0, 2000))
				{
					...
					cVar2 = "BBCAUD";
					sVar3 = "BBC_loiter";
					func_392(&uVar1, cVar2, sVar3, 4, 0, 0);
...
void func_392(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2D1CE
{
		...
		else
		{
			...
			if (PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!iLocal_89)
				{
					...
					else if (!func_326("BBC_T8", 1) && !func_326("BB3_WTF", 1))
					{
				...
				else if (!iLocal_93)
				{
					if (func_394(&iVar0))
					{
						if ((!func_326("BB3_JACK", 1) && !func_326("BBC_T6", 1)) && !func_326("BBC_T8", 1))
						{
			...
			else
			{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, false))
				{
					if (!iLocal_90)
					{
						if (!func_326("BBC_T7", 1) && !func_326("BB3_OUT", 1))
						{
							if (MISC::GET_RANDOM_INT_IN_RANGE(0, 11) < 5)
							{
				...
				else if (Local_68.f_10 == 33 && func_64(Local_68.f_9, joaat("SCRIPT_TASK_HANDS_UP")))
				{
					if (func_116(Local_68.f_9, Local_332, 25f, 1))
					{
						if (!func_326("BB3_J11", 1))
						{
...
int func_394(int iParam0)//Position - 0x2D687
{
	int iVar0;
...
void func_395(char* sParam0, bool bParam1)//Position - 0x2D6C0
{
	if (func_330(sParam0))
	{
	...
	if (func_23(Local_68.f_9))
	{
		...
		switch (iLocal_60)
		{
			...
			case 1:
				if (!iLocal_110)
				{
					...
					else
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_116))
						{
							if (iLocal_97)
							{
								iLocal_116 = func_400(Local_331, 5, 1);
							}
						}
						if (!iLocal_83)
						{
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (func_116(PLAYER::PLAYER_PED_ID(), Local_331, 6.5f, 1))
							{
								iLocal_60 = 2;
							}
						}
						else if (func_116(PLAYER::PLAYER_PED_ID(), Local_331, 2.5f, 1))
						{
							iLocal_60 = 2;
						}
					}
				...
				{
					func_121(&iLocal_116);
					if (func_323("BBS_DROP", 0, 0))
					{
						HUD::CLEAR_THIS_PRINT("BBS_DROP");
					}
					if (func_116(Local_68.f_9, Local_332, 8f, 1))
					{
						if (Local_68.f_10 == 34 || Local_68.f_10 == 35)
						{
							Local_68.f_18 = MISC::GET_GAME_TIMER();
...
bool func_399(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x2DBDD
{
	struct<3> Var0;
...
int func_400(struct<3> Param0, int iParam1, bool bParam2)//Position - 0x2DC07
{
	int iVar0;
			...
			case 1:
				...
				if (!iLocal_109)
				{
					...
					if (!iLocal_81)
					{
						...
						if (!func_62() && func_116(Local_68.f_9, Local_332, 35f, 1))
						{
					...
					else if (Local_68.f_10 == 22 || Local_68.f_10 == 23)
					{
						...
						if (func_332(Local_68.f_9, Local_332, bVar0, 0, 1, 170))
						{
							func_331();
							Local_68.f_17 = MISC::GET_GAME_TIMER();
							func_329(&uLocal_44, 0, 0);
						...
						{
							func_328(Local_68.f_9, Local_332, iLocal_134, 925353388);
						}
					}
					if (!func_62())
					{
...
void func_402(bool bParam0, var uParam1)//Position - 0x2E08C
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_403()//Position - 0x2E179
{
	if (func_23(Local_69[0 /*20*/]))
	{
		...
		{
			func_379(Local_69[0 /*20*/], &(Local_69[0 /*20*/].f_17), 160f, 7);
			...
			else if (ENTITY::DOES_ENTITY_EXIST(Local_73[0 /*9*/]))
			{
				...
				else
				{
					...
					if (!func_64(Local_69[0 /*20*/], joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")))
					{
						if (func_432(Local_68.f_9))
						{
		...
		{
			if (!func_64(Local_69[0 /*20*/], joaat("SCRIPT_TASK_SMART_FLEE_PED")))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_73[0 /*9*/]))
				{
					if (ENTITY::IS_ENTITY_ATTACHED(Local_73[0 /*9*/]))
...
void func_404()//Position - 0x2E347
{
	if (func_23(Local_68.f_9))
	{
		func_387(Local_68.f_9, &iLocal_133, 1126825984, 1);
		func_379(Local_68.f_9, &(Local_68.f_19), 1126825984, 7);
		func_367();
		func_403();
		switch (iLocal_60)
		{
			case 0:
				...
				func_324(&(Local_68.f_8), "", "", &iLocal_126, &iLocal_127, 1, 0);
				iLocal_60 = 1;
				break;
			...
			case 1:
				switch (iLocal_61)
				{
					case 2:
						...
						{
							if (!func_326("BBC_T14", 1))
							{
								func_324(&(Local_68.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_126, &iLocal_127, 1, 1);
								iLocal_99 = 1;
							}
						}
						else
						{
							func_363(&(Local_68.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_126, iLocal_127, 1);
							if (func_116(Local_68.f_9, Local_332, 25f, 1) && func_411(Local_68.f_9, Local_332, 10f))
							{
								if (PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false))
								{
									if (func_410(&(Local_68.f_19)))
									{
										iLocal_61 = 1;
										iLocal_91 = 0;
								...
								else if (func_116(Local_68.f_9, Local_332, 5f, 1))
								{
									iLocal_61 = 0;
								}
								else if (func_410(&(Local_68.f_19)))
								{
									if (func_116(Local_68.f_9, Local_332, (25f - 1.5f), 1))
									{
										iLocal_61 = 1;
										iLocal_91 = 0;
										if (Local_68.f_10 != 3 && Local_68.f_10 != 4)
					...
					case 1:
						if (!iLocal_91)
						{
							if (func_323("BBS_APHEND", 0, 0) || func_323("BBS_APHEND2", 0, 0))
							{
								HUD::CLEAR_PRINTS();
							}
							if (func_62())
						...
						{
							if (!func_326("BBC_T14", 1) && !func_326("BB3_J2", 1))
							{
								if (func_323("BBS_APHEND", 0, 0) || func_323("BBS_APHEND2", 0, 0))
								{
									HUD::CLEAR_PRINTS();
...
void func_406()//Position - 0x2E86F
{
	Global_20471 = 0;
	func_407();
}

void func_407()//Position - 0x2E87F
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_408()//Position - 0x2E8A3
{
	if (iLocal_139 < 10)
	{
		if (!iLocal_92)
		{
			if (!func_62())
			{
				if (func_116(Local_68.f_9, Local_332, (25f + 5f), 1))
				{
					iLocal_117 = 0;
					if (HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
...
int func_409(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)//Position - 0x2E945
{
	if (func_432(iParam0))
	{
		if (!func_368(iParam1, 10))
		{
			if (bParam2)
			{
				if (!func_116(Local_68.f_9, Local_332, fParam3, 1))
				{
					return 0;
				}
				if (!func_411(iParam0, Local_332, fParam4))
				{
					return 0;
				}
			}
...
int func_410(var uParam0)//Position - 0x2E9AC
{
	if (!func_368(*uParam0, 10))
	{
		return 1;
	}
	return 0;
...
int func_411(int iParam0, struct<3> Param1, float fParam2)//Position - 0x2E9C6
{
	struct<3> Var0;
	float fVar1;
...
void func_413(var uParam0, var uParam1)//Position - 0x2EC38
{
	if (!uParam0->f_7)
	{
		if (func_416(26, func_418(uParam0->f_4), 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if ((!func_62() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID())) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
					...
					if (func_76(uParam1, func_415(uParam0->f_4), func_414(uParam0->f_4), 4, 0, 0, 0))
					{
						uParam0->f_7 = 1;
					}
				}
...
char* func_414(int iParam0)//Position - 0x2ECC9
{
	switch (iParam0)
	{
		case 0:
...
char* func_415(int iParam0)//Position - 0x2ED0E
{
	switch (iParam0)
	{
		case 0:
...
int func_416(int iParam0, int iParam1, int iParam2)//Position - 0x2ED51
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_417(int iParam0)//Position - 0x2EE3B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_418(int iParam0)//Position - 0x2EE9F
{
	switch (iParam0)
	{
		case 0:
	...
	else if (ENTITY::DOES_ENTITY_EXIST(Local_68.f_9))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_68.f_9, false) && !PED::IS_PED_INJURED(Local_68.f_9))
		{
			if ((iLocal_58 == 2 || iLocal_58 == 1) || iLocal_58 == 7)
			{
				...
				if (!func_116(Local_68.f_9, Local_332, fVar0, 1))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_68.f_9))
					{
						iLocal_62 = 2;
				...
				{
					if (!func_116(Local_68.f_9, Local_332, 1000f, 1))
					{
						iLocal_62 = 2;
						return;
					}
			...
			{
				if (!func_116(Local_68.f_9, Local_332, 80f, 1))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_68.f_9))
					{
						iLocal_62 = 2;
...
int func_422(bool bParam0)//Position - 0x2F122
{
	if (func_23(Local_75.f_0))
	{
		...
		if (func_428(Local_75.f_0, 1126825984))
		{
			return 1;
		}
		if (func_423(Local_75.f_0, 1, 0, 0, 0))
		{
			return 1;
		}
...
int func_423(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2F27A
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_432(PLAYER::PLAYER_PED_ID()) && func_432(iParam0))
	{
		...
		if (!bParam2)
		{
			if (func_427(iParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_424(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_424(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2F375
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_425(int iParam0, float fParam1)//Position - 0x2F481
{
	var uVar0;
	struct<3> Var1;
	...
	{
		if (func_426(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_426(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0x2F516
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_427(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2F5A4
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_428(int iParam0, float fParam1)//Position - 0x2F5EC
{
	float fVar0;
	
	if (func_432(PLAYER::PLAYER_PED_ID()) && func_432(iParam0))
	{
		if (func_430(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_429(int iParam0, float fParam1)//Position - 0x2F662
{
	return func_380(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_430(int iParam0)//Position - 0x2F67A
{
...
void func_431(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)//Position - 0x2F6A2
{
...
int func_432(int iParam0)//Position - 0x2F6D0
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_433(bool bParam0)//Position - 0x2F6F1
{
...
void func_438()//Position - 0x2F957
{
	STREAMING::REMOVE_ANIM_SET(func_375());
	STREAMING::REMOVE_ANIM_SET(func_376());
}

void func_439(bool bParam0, int iParam1, int iParam2)//Position - 0x2F96F
{
	bool bVar0;
...
void func_440(int iParam0)//Position - 0x2F9CE
{
	Global_97747 = iParam0;
}

void func_441(bool bParam0)//Position - 0x2F9DC
{
	if (bParam0)
	{
...
void func_442(bool bParam0)//Position - 0x2FAB8
{
	if (bParam0)
	{
		func_443();
...
void func_443()//Position - 0x2FB1B
{
...
void func_445(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x2FB77
{
	if (func_530())
	{
...
void func_446(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x2FC0C
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_530() || !func_528())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	{
		if (!func_525(iParam4, iParam5, iParam6, iParam11))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_496(Param1, fParam2);
	}
	else if (iParam7 == 1)
	{
		if (func_107(Param1, 0f, 0f, 0f, 0))
		...
		func_492(Param1, 5f, 0);
		if (func_89(iParam10))
		{
			func_491(iParam10, 0);
			while (!func_447(iParam0, iParam10, Param1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_447(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)//Position - 0x2FDA0
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_113386.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113386.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113386.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_484(iParam0, &(Global_113386.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_113386.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_113386.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113386.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113386.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_484(iParam0, &(Global_113386.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_113386.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_448(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x30BC2
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_89(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_452(*iParam1, 0, &uVar0))
		{
			func_181(iParam1, &(Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_113386.f_20118[iParam0 /*43*/].f_31 = func_451(*iParam1);
				...
				func_449(Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_113386.f_20118[iParam0 /*43*/].f_1));
				...
				func_449(Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_113386.f_20118[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_449(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x317D6
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_450(iVar0, &sVar2, &iVar1, &iVar3, &iVar4))
	{
...
bool func_450(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x31849
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_451(int iParam0)//Position - 0x32D3B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_452(int iParam0, bool bParam1, var uParam2)//Position - 0x32DEB
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_479(iVar0, bParam1, uParam2) && !func_478(PLAYER::PLAYER_ID())) && !func_460(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_458(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_456(iParam0)) && !bVar1) && !(func_455(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_453(PLAYER::PLAYER_ID())))
	{
...
int func_453(int iParam0)//Position - 0x32F59
{
	if (iParam0 != func_82())
	{
		if (func_346(iParam0, 1, 1))
		{
			...
			{
				return func_454(Global_2689235[iParam0 /*453*/].f_318.f_6) == 11;
			}
		}
	}
	return 0;
...
int func_454(int iParam0)//Position - 0x32FA0
{
	switch (iParam0)
	{
		case 0:
...
int func_455(int iParam0)//Position - 0x33427
{
...
int func_456(int iParam0)//Position - 0x33469
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_457(int iParam0)//Position - 0x3350C
{
	if (iParam0 != func_82())
	{
		if (func_346(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1)
			{
				return func_454(Global_2689235[iParam0 /*453*/].f_318.f_6) == 13;
			}
		}
	}
	return 0;
...
int func_458(int iParam0)//Position - 0x33553
{
	if (iParam0 != func_82())
	{
		if (func_346(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1)
			{
				return func_454(Global_2689235[iParam0 /*453*/].f_318.f_6) == 7;
			}
		}
	}
	return 0;
...
int func_459(int iParam0)//Position - 0x33599
{
	return 1;
}

int func_460(int iParam0)//Position - 0x335A2
{
...
int func_461(int iParam0)//Position - 0x335D1
{
...
int func_462(int iParam0)//Position - 0x33641
{
	int iVar0;
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_456(iParam0)) || func_463(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_463(int iParam0)//Position - 0x336C4
{
	switch (iParam0)
	{
		case joaat("mule"):
...
int func_464(int iParam0, bool bParam1)//Position - 0x33714
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_466(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				if (Global_2815059.f_303 == iParam0)
				{
					return 1;
				}
				else if (func_465(iParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_465(int iParam0)//Position - 0x3376F
{
	int iVar0;
...
int func_466(int iParam0, int iParam1)//Position - 0x337A8
{
	if (iParam1 == 0)
	{
...
int func_476(int iParam0)//Position - 0x34090
{
	if (iParam0 != func_82())
	{
		if (func_346(iParam0, 1, 1))
		{
			...
			{
				return func_454(Global_2689235[iParam0 /*453*/].f_318.f_6) == 5;
			}
		}
	}
	return 0;
...
int func_477(int iParam0)//Position - 0x340EF
{
	if (iParam0 != func_82())
	{
		if (func_346(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1 && Global_2689235[iParam0 /*453*/].f_318.f_9 != func_82())
			{
				return func_454(Global_2689235[iParam0 /*453*/].f_318.f_6) == 8;
			}
		}
	}
	return 0;
...
int func_478(int iParam0)//Position - 0x3414F
{
	if (iParam0 != func_82())
	{
		if (func_346(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1)
			{
				return func_454(Global_2689235[iParam0 /*453*/].f_318.f_6) == 9;
			}
		}
	}
	return 0;
...
int func_479(int iParam0, bool bParam1, var uParam2)//Position - 0x34196
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_458(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_480(int iParam0)//Position - 0x345E2
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_481(int iParam0, int iParam1)//Position - 0x3460B
{
	int iVar0;
...
void func_482(int iParam0)//Position - 0x3468D
{
	if (!func_483(*iParam0))
	{
...
bool func_483(int iParam0)//Position - 0x346B8
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_484(int iParam0, var uParam1, var uParam2)//Position - 0x346C7
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*iParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_488(*iParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
...
int func_485(int iParam0)//Position - 0x348A1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_486(var uParam0)//Position - 0x3497D
{
...
int func_487(int iParam0, int iParam1)//Position - 0x349D4
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_488(int iParam0, int iParam1, int iParam2)//Position - 0x34AB9
{
	if (!func_489() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_489()//Position - 0x34ADD
{
	return 0;
}

int func_490(var uParam0, int iParam1)//Position - 0x34AE6
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_491(int iParam0, int iParam1)//Position - 0x34B27
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97772[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_97772[iVar0]) == func_170(iParam0, iParam1))
				{
...
void func_492(struct<3> Param0, float fParam1, bool bParam2)//Position - 0x34BC5
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_169(&(Global_77137.f_555[0 /*21*/]), iVar0))
		{
...
void func_493(int iParam0)//Position - 0x34C15
{
	bool bVar0;
	...
	if (func_169(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		...
		if (BitTest(Global_77137.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_175(iParam0, 0)) && Global_78046.f_66 == 0) && Global_113386.f_32749.f_1958[Global_77137.f_555[0 /*21*/].f_14] != 0) && Global_113386.f_32749.f_1958[Global_77137.f_555[0 /*21*/].f_14] > 3) && (!func_494(0, Global_77137.f_555[0 /*21*/].f_12) || !func_494(1, Global_77137.f_555[0 /*21*/].f_12)))
			{
				func_176(&(Global_113386.f_32749.f_69[Global_77137.f_555[0 /*21*/].f_14 /*78*/]), &Global_78046);
...
int func_494(int iParam0, int iParam1)//Position - 0x34D84
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_495(&(Global_113386.f_32749.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_141(Global_113386.f_32749.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}

int func_495(var uParam0)//Position - 0x34DF6
{
	return *uParam0;
}

int func_496(struct<3> Param0, float fParam1)//Position - 0x34E01
{
	return func_497(&(Global_106934.f_2890), Param0, fParam1, 0);
}

int func_497(var uParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x34E1B
{
	int iVar0;
	struct<3> Var1;
	bool bVar2;
	...
	if (func_521(uParam0))
	{
		...
		if (func_520(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_502(iVar0, &(uParam0->f_12), 0, 1);
				bVar2 = true;
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam3)
					{
						...
						{
							func_491(uParam0->f_11, 1);
						}
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
						{
							func_491(uParam0->f_11, 2);
						}
					}
				...
				else if ((!func_499(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar4 = func_498(iVar0);
					if (iVar4 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_498(int iParam0)//Position - 0x350CD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_499(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x35190
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_501(iParam0, Global_77137.f_139[38], 0))
			{
				func_493(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_501(iParam0, Global_77137.f_139[43], 1))
			{
				func_493(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_501(iParam0, uVar1[iVar3], 1) && func_500(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.5635f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_107(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_500(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x35398
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_501(int iParam0, int iParam1, bool bParam2)//Position - 0x35413
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_502(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x35474
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		{
			if (func_511(uParam1->f_5) || func_511(uParam1->f_6))
			{
			}
			else
			{
		...
		if (((BitTest(uParam1->f_77, 15) || func_510(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_509())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar6 <= 11)
			{
				if (BitTest(uParam1->f_77, func_180(iVar6 + 1)))
				{
		...
		if (((func_503() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger")))
		{
...
int func_503()//Position - 0x35B1B
{
	...
	if (func_506(7))
	{
		if (func_505(Global_2703735.f_4.f_16) || func_504(Global_2703735.f_4.f_16))
		{
			return 0;
		}
	}
...
int func_504(var uParam0)//Position - 0x35BAA
{
	int iVar0;
...
int func_505(int iParam0)//Position - 0x35BCE
{
	int iVar0;
...
bool func_506(int iParam0)//Position - 0x35BEC
{
	return func_507(&(Global_2703735.f_169), iParam0);
}

var func_507(var uParam0, var uParam1)//Position - 0x35C00
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_508(int iParam0, int iParam1)//Position - 0x35C23
{
	int iVar0;
	int iVar1;
...
bool func_509()//Position - 0x35C9B
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

int func_510(int iParam0)//Position - 0x35CAC
{
	int iVar0;
...
int func_511(int iParam0)//Position - 0x35CF4
{
	if (!func_489() && func_512(iParam0))
	{
		return 1;
	}
	return 0;
...
int func_512(int iParam0)//Position - 0x35D14
{
	switch (iParam0)
	{
		case 161:
...
int func_513(int iParam0)//Position - 0x35D67
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (!func_519(PLAYER::PLAYER_ID(), -1))
		{
	...
	if (func_515(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
		{
...
int func_514(int iParam0)//Position - 0x35DEE
{
...
int func_515(int iParam0)//Position - 0x35E1D
{
	if (func_518(iParam0) == 233)
	{
...
int func_516(int iParam0)//Position - 0x35E3A
{
...
int func_517(int iParam0, int iParam1)//Position - 0x35E5D
{
...
int func_518(int iParam0)//Position - 0x35E98
{
	if (func_517(iParam0, 0))
	{
...
int func_519(int iParam0, int iParam1)//Position - 0x35EBB
{
	int iVar0;
...
int func_520(var uParam0)//Position - 0x35F08
{
	if (func_521(uParam0))
	{
...
int func_521(var uParam0)//Position - 0x35F3D
{
	...
	if (uParam0->f_12.f_66 == joaat("stunt") && func_500(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
bool func_522()//Position - 0x35F9C
{
	return func_520(&(Global_106934.f_2890));
}

void func_523()//Position - 0x35FAF
{
	func_524(&(Global_106934.f_2890));
}

void func_524(var uParam0)//Position - 0x35FC2
{
	if (func_521(uParam0))
	{
...
int func_525(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x35FE0
{
	...
	if (iParam2 == 0 && func_527(Global_106934.f_2890.f_12.f_66))
	{
		return 0;
	}
...
int func_527(int iParam0)//Position - 0x360E3
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_528()//Position - 0x3613C
{
	return func_521(&(Global_106934.f_2890));
}

int func_529()//Position - 0x3614F
{
...
void func_531()//Position - 0x3619D
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("PLAYER"), iLocal_322);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_322, joaat("PLAYER"));
	Var0 = { func_538(Local_63) };
	Var1 = { func_537(Local_63) };
	PED::SET_PED_NON_CREATION_AREA(Var0, Var1);
...
void func_532()//Position - 0x362E2
{
	if (func_23(Local_68.f_9))
	{
		...
		func_365(Local_68.f_9);
		func_533(Local_68.f_9, "TARGET_", 0);
		Local_68.f_10 = 0;
		...
		if (func_23(Local_69[0 /*20*/]))
		{
			...
			func_533(Local_69[0 /*20*/], "BACKUP_", 0);
...
void func_533(int iParam0, char* sParam1, int iParam2)//Position - 0x365DA
{
	char cVar0[16];
...
int func_534()//Position - 0x365F6
{
	...
	if (iLocal_129 > 0)
	{
		...
		{
			if (func_536(&(Local_71[iVar2 /*6*/]), Local_71[iVar2 /*6*/].f_5, Local_71[iVar2 /*6*/].f_1, Local_71[iVar2 /*6*/].f_4, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	if (iLocal_131 > 0)
	{
		...
		{
			if (func_535(&(Local_74[iVar2 /*7*/]), Local_74[iVar2 /*7*/].f_5, Local_74[iVar2 /*7*/].f_2, Local_74[iVar2 /*7*/].f_6, Local_74[iVar2 /*7*/].f_1, 1))
			{
				iVar0++;
			}
			iVar2++;
...
int func_535(var uParam0, int iParam1, struct<3> Param2, int iParam3, int iParam4, bool bParam5)//Position - 0x36830
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam4))
...
int func_536(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0x368A1
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
Vector3 func_537(struct<5> Param0, var uParam1, var uParam2, var uParam3)//Position - 0x36940
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_538(struct<5> Param0, var uParam1, var uParam2, var uParam3)//Position - 0x369B4
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_539()//Position - 0x36A28
{
	...
	StringCopy(&Local_323, "", 24);
	Local_75.f_6 = func_550(62);
	Local_75.f_1 = { func_549() };
	Local_75.f_4 = func_548();
	Local_77.f_5 = func_547();
	Local_77.f_1 = { func_546() };
	Local_77.f_4 = func_545();
	Local_78.f_5 = func_544();
	Local_78.f_1 = { func_543() };
	Local_78.f_4 = func_542();
	Local_79.f_5 = func_48();
	Local_79.f_1 = { func_47() };
	Local_79.f_4 = func_46();
	Local_80.f_5 = func_45();
	Local_80.f_1 = { func_541() };
	Local_80.f_4 = func_540();
...
float func_540()//Position - 0x36DE5
{
	return 75.15f;
}

Vector3 func_541()//Position - 0x36DF2
{
	return 2727.29f, 4145.9f, 44.16f;
}

float func_542()//Position - 0x36E09
{
	return 71f;
}

Vector3 func_543()//Position - 0x36E16
{
	return 2727.686f, 4145.715f, 44.08f;
}

int func_544()//Position - 0x36E2D
{
	return joaat("prop_laptop_01a");
}

float func_545()//Position - 0x36E3A
{
	return -91.28f;
}

Vector3 func_546()//Position - 0x36E47
{
	return 2728.35f, 4145.59f, 43.3f;
}

int func_547()//Position - 0x36E5E
{
	return joaat("prop_table_03_chr");
}

float func_548()//Position - 0x36E6B
{
	return 89.19f;
}

Vector3 func_549()//Position - 0x36E78
{
	return 2728.33f, 4145.6f, 43.89f;
}

int func_550(int iParam0)//Position - 0x36E8F
{
	if (!func_89(iParam0))
	{
		return func_92(iParam0);
...
int func_551(bool bParam0)//Position - 0x36EB5
{
...
int func_555(int iParam0)//Position - 0x36FED
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_554()) || Global_112433) || Global_31962) || func_560()) || func_95(8, -1)) || func_559()) || func_558()) || func_552()) || func_553()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_554()) || Global_31962) || func_560()) || func_95(8, -1)) || func_552()) || func_559()) || func_558()) || func_553()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_554()) || Global_112433) || Global_31962) || func_560()) || func_95(8, -1)) || func_552()) || func_559()) || func_558()) || func_553()) || Global_113386.f_7688.f_919[iVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_554()) || Global_112433) || Global_31962) || func_560()) || func_95(8, -1)) || func_559()) || func_558()) || func_553()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_554() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_95(8, -1)) || func_553()) || func_557()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_95(8, -1) || func_559()) || func_558()) || func_557()) || func_556())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_554()) || Global_31962) || func_560()) || func_95(8, -1)) || func_558()) || func_552()) || func_553()) || Global_113386.f_7688.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_554()) || func_558()) || Global_112433) || Global_31962) || func_560()) || Global_44238) || func_95(8, -1)) || func_552()) || func_557()) || func_553()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_554()) || Global_112433) || Global_31962) || func_560()) || func_95(8, -1)) || func_552()) || func_557()) || func_559()) || func_558()) || func_553())
						{
							return 0;
						}
						break;
...
var func_556()//Position - 0x3770A
{
	return Global_100480.f_1;
}

int func_557()//Position - 0x37718
{
	if (Global_97363 != -1)
	{
...
bool func_558()//Position - 0x3773B
{
	return Global_100493.f_376 > 0;
}

bool func_559()//Position - 0x3774C
{
	return Global_100493.f_375 > 0;
}

var func_560()//Position - 0x3775D
{
	return Global_1575058;
}

bool func_561(int iParam0)//Position - 0x37769
{
	return func_562(iParam0, Global_43052);
}

int func_562(int iParam0, int iParam1)//Position - 0x3777A
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_563(int iParam0)//Position - 0x3795B
{
	func_588();
	if (!func_587())
	{
		...
		func_564(SCRIPT::GET_THIS_SCRIPT_NAME());
	}
}

void func_564(char* sParam0)//Position - 0x379A6
{
	if (Global_100441 != 12)
	{
		func_565(sParam0, 5, -1);
	}
}

int func_565(char* sParam0, int iParam1, int iParam2)//Position - 0x379C3
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
	...
	if (func_576())
	{
		...
		{
			iVar2 = func_566(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_566(char* sParam0)//Position - 0x37B52
{
...
void func_567(int iParam0, var uParam1)//Position - 0x37BA8
{
	switch (iParam0)
	{
		case 0:
			func_568(uParam1, "Abigail1", func_570(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0, "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_569(iParam0), 1, 0);
			break;
		
		case 1:
			func_568(uParam1, "Abigail2", func_570(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, -1, 4, 1, 0, 2359, func_569(iParam0), 1, 0);
			break;
		
		case 2:
			func_568(uParam1, "Barry1", func_570(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1, 4, 1, 0, 2359, func_569(iParam0), 1, 0);
			break;
		
		case 3:
			func_568(uParam1, "Barry2", func_570(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_569(iParam0), 1, 1);
			break;
		
		case 4:
			func_568(uParam1, "Barry3", func_570(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2, 0, 2359, func_569(iParam0), 0, 0);
			break;
		
		case 5:
			func_568(uParam1, "Barry3A", func_570(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 6:
			func_568(uParam1, "Barry3C", func_570(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 7:
			func_568(uParam1, "Barry4", func_570(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_569(iParam0), 0, 0);
			break;
		
		case 8:
			func_568(uParam1, "Dreyfuss1", func_570(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_569(iParam0), 0, 0);
			break;
		
		case 9:
			func_568(uParam1, "Epsilon1", func_570(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1, 10, 4, 1, 0, 2359, func_569(iParam0), 0, 0);
			break;
		
		case 10:
			func_568(uParam1, "Epsilon2", func_570(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0, 11, 4, 1, 0, 2359, func_569(iParam0), 1, 0);
			break;
		
		case 11:
			func_568(uParam1, "Epsilon3", func_570(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars", 0, 0, 12, 4, 1, 0, 2359, func_569(iParam0), 0, 0);
			break;
		
		case 12:
			func_568(uParam1, "Epsilon4", func_570(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16, "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_569(iParam0), 0, 0);
			break;
		
		case 13:
			func_568(uParam1, "Epsilon5", func_570(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16, "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_569(iParam0), 1, 0);
			break;
		
		case 14:
			func_568(uParam1, "Epsilon6", func_570(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0, 15, 4, 1, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 15:
			func_568(uParam1, "Epsilon7", func_570(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_569(iParam0), 0, 0);
			break;
		
		case 16:
			func_568(uParam1, "Epsilon8", func_570(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_569(iParam0), 1, 0);
			break;
		
		case 17:
			func_568(uParam1, "Extreme1", func_570(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 18:
			func_568(uParam1, "Extreme2", func_570(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171, 0, 19, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 19:
			func_568(uParam1, "Extreme3", func_570(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 20:
			func_568(uParam1, "Extreme4", func_570(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, -1, 4, 2, 0, 2359, func_569(iParam0), 0, 0);
			break;
		
		case 21:
			func_568(uParam1, "Fanatic1", func_570(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, -1, 4, 1, 700, 2000, func_569(iParam0), 1, 0);
			break;
		
		case 22:
			func_568(uParam1, "Fanatic2", func_570(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1, -1, 4, 4, 700, 2000, func_569(iParam0), 1, 0);
			break;
		
		case 23:
			func_568(uParam1, "Fanatic3", func_570(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1, 4, 2, 700, 2000, func_569(iParam0), 0, 1);
			break;
		
		case 24:
			func_568(uParam1, "Hao1", func_570(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0, "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_569(iParam0), 0, 1);
			break;
		
		case 25:
			func_568(uParam1, "Hunting1", func_570(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 26:
			func_568(uParam1, "Hunting2", func_570(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, -1, 4, 4, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 27:
			func_568(uParam1, "Josh1", func_570(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_569(iParam0), 1, 0);
			break;
		
		case 28:
			func_568(uParam1, "Josh2", func_570(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0, 29, 4, 4, 0, 2359, func_569(iParam0), 1, 1);
			break;
		
		case 29:
			func_568(uParam1, "Josh3", func_570(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_569(iParam0), 1, 1);
			break;
		
		case 30:
			func_568(uParam1, "Josh4", func_570(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1, 4, 4, 0, 2359, func_569(iParam0), 1, 0);
			break;
		
		case 31:
			func_568(uParam1, "Maude1", func_570(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0, "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 32:
			func_568(uParam1, "Minute1", func_570(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 33:
			func_568(uParam1, "Minute2", func_570(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 34:
			func_568(uParam1, "Minute3", func_570(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0, -1, 4, 4, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 35:
			func_568(uParam1, "MrsPhilips1", func_570(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0, "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_569(iParam0), 0, 0);
			break;
		
		case 36:
			func_568(uParam1, "MrsPhilips2", func_570(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_569(iParam0), 0, 0);
			break;
		
		case 37:
			func_568(uParam1, "Nigel1", func_570(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1, -1, 1, 4, 0, 2359, func_569(iParam0), 1, 0);
			break;
		
		case 38:
			func_568(uParam1, "Nigel1A", func_570(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_569(iParam0), 1, 1);
			break;
		
		case 39:
			func_568(uParam1, "Nigel1B", func_570(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_569(iParam0), 1, 1);
			break;
		
		case 40:
			func_568(uParam1, "Nigel1C", func_570(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_569(iParam0), 1, 1);
			break;
		
		case 41:
			func_568(uParam1, "Nigel1D", func_570(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_569(iParam0), 1, 1);
			break;
		
		case 42:
			func_568(uParam1, "Nigel2", func_570(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_569(iParam0), 1, 1);
			break;
		
		case 43:
			func_568(uParam1, "Nigel3", func_570(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16, "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_569(iParam0), 1, 1);
			break;
		
		case 44:
			func_568(uParam1, "Omega1", func_570(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_569(iParam0), 0, 0);
			break;
		
		case 45:
			func_568(uParam1, "Omega2", func_570(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_569(iParam0), 0, 0);
			break;
		
		case 46:
			func_568(uParam1, "Paparazzo1", func_570(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 47:
			func_568(uParam1, "Paparazzo2", func_570(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 48:
			func_568(uParam1, "Paparazzo3", func_570(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183, 1, -1, 2, 2, 0, 2359, func_569(iParam0), 0, 0);
			break;
		
		case 49:
			func_568(uParam1, "Paparazzo3A", func_570(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 50:
			func_568(uParam1, "Paparazzo3B", func_570(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 51:
			func_568(uParam1, "Paparazzo4", func_570(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1, -1, 4, 2, 0, 2359, func_569(iParam0), 0, 0);
			break;
		
		case 52:
			func_568(uParam1, "Rampage1", func_570(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_569(iParam0), 0, 0);
			break;
		
		case 54:
			func_568(uParam1, "Rampage3", func_570(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_569(iParam0), 1, 0);
			break;
		
		case 55:
			func_568(uParam1, "Rampage4", func_570(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_569(iParam0), 1, 0);
			break;
		
		case 56:
			func_568(uParam1, "Rampage5", func_570(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_569(iParam0), 0, 0);
			break;
		
		case 53:
			func_568(uParam1, "Rampage2", func_570(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0, "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_569(iParam0), 1, 0);
			break;
		
		case 57:
			func_568(uParam1, "TheLastOne", func_570(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, -1, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 58:
			func_568(uParam1, "Tonya1", func_570(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 59:
			func_568(uParam1, "Tonya2", func_570(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 60:
			func_568(uParam1, "Tonya3", func_570(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 61:
			func_568(uParam1, "Tonya4", func_570(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
		
		case 62:
			func_568(uParam1, "Tonya5", func_570(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0, -1, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
...
void func_568(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0x38D5F
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_569(int iParam0)//Position - 0x38DF0
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_570(int iParam0)//Position - 0x39136
{
	struct<2> Var0;
	char[] cVar1[8];
	
	StringCopy(&Var0, "", 8);
	cVar1 = { func_571(iParam0) };
...
struct<2> func_571(int iParam0)//Position - 0x3916D
{
	struct<2> Var0;
...
int func_572()//Position - 0x395B9
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_573(&(Global_100441.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_573(char* sParam0, bool bParam1)//Position - 0x395DD
{
	int iVar0;
	int iVar1;
	
	iVar0 = MISC::GET_HASH_KEY(sParam0);
	iVar1 = func_574(iVar0, 1);
	if (iVar1 == -1 && !bParam1)
	{
	}
	return iVar1;
...
int func_574(int iParam0, bool bParam1)//Position - 0x39607
{
	int iVar0;
...
int func_576()//Position - 0x3968D
{
	...
	{
		if (func_566(&(Global_100441.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_577(int iParam0)//Position - 0x396F9
{
	if (iParam0 == 1)
	{
		Global_43601 = 1;
...
void func_578(bool bParam0)//Position - 0x39712
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_579(int iParam0)//Position - 0x39726
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_580(int iParam0)//Position - 0x39760
{
	if (iParam0 == 1)
	{
...
void func_581()//Position - 0x3979A
{
	Global_23011.f_5 = 1;
}

void func_582()//Position - 0x397A8
{
	Global_23011.f_5 = 0;
}

void func_583()//Position - 0x397B6
{
	Global_94617 = 0;
	Global_94618 = 0;
}

void func_584()//Position - 0x397C8
{
	Global_100441 = 13;
	Global_100441.f_1 = -1;
	Global_100441.f_2 = 0;
...
void func_588()//Position - 0x398B3
{
	Global_100476 = 1;
