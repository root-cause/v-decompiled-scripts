...
int func_343(char* sParam0)//Position - 0x2A16C
{
	if (!func_344(1, 1, 0))
	{
		if ((!MISC::IS_STRING_NULL_OR_EMPTY(sParam0) && func_330(sParam0)) || func_330("CMN_HINT"))
		{
			HUD::CLEAR_HELP(true);
		}
		return 0;
...
void func_502(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x35474
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((func_503() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::_DOES_VEHICLE_HAVE_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger")))
		{
...
void func_567(int iParam0, var uParam1)//Position - 0x37BA8
{
	switch (iParam0)
	{
		...
		case 5:
			func_568(uParam1, "Barry3A", func_570(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
		...
		case 8:
			func_568(uParam1, "Dreyfuss1", func_570(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_569(iParam0), 0, 0);
			break;
		...
		case 38:
			func_568(uParam1, "Nigel1A", func_570(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_569(iParam0), 1, 1);
			break;
		...
		case 49:
			func_568(uParam1, "Paparazzo3A", func_570(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
		...
		case 58:
			func_568(uParam1, "Tonya1", func_570(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_569(iParam0), 0, 1);
			break;
