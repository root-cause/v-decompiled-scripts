...
int func_23()//Position - 0x82D
{
	...
	if (iLocal_90)
	{
		...
		{
			case 1:
				if ((((((iLocal_1307 == 0 && ENTITY::DOES_ENTITY_EXIST(Local_1320.f_0)) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1320.f_0, false)) && ENTITY::DOES_ENTITY_EXIST(Local_1310.f_0)) && !PED::IS_PED_INJURED(Local_1310.f_0)) && PED::IS_PED_IN_VEHICLE(Local_1310.f_0, Local_1320.f_0, false)) && func_134(&(Local_1104[0 /*8*/])))
				{
				...
				else if ((ENTITY::DOES_ENTITY_EXIST(iLocal_1321) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1321, false)) && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_1321, Local_1320.f_0))
				{
					...
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_1320.f_0, 692.9143f, -1003.556f, 21.50839f, 692.6511f, -1021.604f, 26.20675f, 9.75f, false, true, 0))
					{
				...
				else if (iLocal_1307 == 0)
				{
					...
					if (func_98(&iLocal_1105, Var0, 692.9143f, -1003.556f, 21.50839f, 692.6511f, -1021.604f, 26.20675f, 9.75f, 1, Local_1320.f_0, "JHP2A_RTNVAN", "", "", PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1320.f_0, false), 0, 1, -1))
					{
						iLocal_89 = 101;
					}
...
int func_115(int iParam0)//Position - 0x52D3
{
	if (iParam0 != func_32())
	{
		...
		else if ((Global_1575058 && iParam0 == PLAYER::PLAYER_ID()) && func_116(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103950.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_103950.f_4, false))
		{
			if (func_192(24) != Global_103950.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_189(ENTITY::GET_ENTITY_COORDS(Global_103950.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
...
int func_144(int iParam0, bool bParam1)//Position - 0x64C4
{
	int iVar0;
	struct<2> Var1;
...
int func_145(int iParam0)//Position - 0x6644
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_147(int iParam0)//Position - 0x6727
{
	int iVar0;
	int iVar1;
...
bool func_148()//Position - 0x99FA
{
	return (MISC::IS_ORBIS_VERSION() || MISC::_0x807ABE1AB65C24D2());
}

bool func_149()//Position - 0x9A10
{
	return (MISC::IS_DURANGO_VERSION() || MISC::_0xC545AB1CF97ABB34());
}

int func_150()//Position - 0x9A26
{
	return 0;
}

int func_151()//Position - 0x9A2F
{
	return 1;
}

int func_152()//Position - 0x9A38
{
	return 1;
}

int func_153()//Position - 0x9A41
{
...
int func_155(int iParam0)//Position - 0x9B12
{
	int iVar0;
	char* sVar1;
...
int func_156(int iParam0)//Position - 0x9B58
{
	int iVar0;
...
int func_157(int iParam0)//Position - 0x9B93
{
	int iVar0;
...
int func_158(int iParam0)//Position - 0x9C0F
{
	int iVar0;
...
int func_159(int iParam0, int iParam1, bool bParam2)//Position - 0x9CF7
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_160(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x9D65
{
...
void func_162(var uParam0, int iParam1)//Position - 0x9E83
{
	if (iParam1 <= 0)
	{
		return;
...
void func_163(var uParam0, int iParam1)//Position - 0x9F09
{
...
void func_164(var uParam0, int iParam1)//Position - 0x9F3C
{
	int iVar0;
	int iVar1;
...
int func_165(int iParam0, int iParam1)//Position - 0x9F8D
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_166(int iParam0)//Position - 0xA02F
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_167(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_167(bool bParam0, int iParam1, int iParam2)//Position - 0xA051
{
	if (bParam0)
	{
		return iParam1;
...
int func_168(var uParam0)//Position - 0xA068
{
	return uParam0 & 15;
}

void func_169(var uParam0, int iParam1)//Position - 0xA075
{
...
void func_170(var uParam0, int iParam1)//Position - 0xA0AF
{
...
void func_171(var uParam0, int iParam1)//Position - 0xA0EA
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_172(var uParam0, int iParam1)//Position - 0xA126
{
	int iVar0;
	int iVar1;
...
int func_173(int iParam0, int iParam1)//Position - 0xB814
{
	struct<82> Var0;
...
void func_174(int iParam0, var uParam1, int iParam2)//Position - 0xB856
{
	int iVar0;
...
bool func_175(int iParam0)//Position - 0xBAB2
{
	return iParam0 < 3;
}

void func_176(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0xBABE
{
	if (func_172(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_177(int iParam0, bool bParam1)//Position - 0xBBB7
{
	if (iParam0 == -1)
	{
		return;
...
void func_178(int iParam0, int iParam1, bool bParam2)//Position - 0xBC14
{
	if (iParam0 == -1)
	{
		return;
...
int func_179(int iParam0, int iParam1)//Position - 0xBC4F
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_180(var uParam0, var uParam1)//Position - 0xBC6F
{
...
void func_181(int iParam0)//Position - 0xBD3B
{
	if (iParam0 == -1)
	{
		return;
...
int func_182(int iParam0)//Position - 0xBDB2
{
	int iVar0;
...
void func_183(int iParam0, var uParam1)//Position - 0xBE15
{
	int iVar0;
...
int func_184(int iParam0)//Position - 0xC0C2
{
	switch (iParam0)
	{
		case 1:
...
int func_185(int iParam0, var uParam1, var uParam2)//Position - 0xC172
{
	int iVar0;
	int iVar1;
...
int func_186(int iParam0)//Position - 0xC365
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_187(var uParam0)//Position - 0xC385
{
	int iVar0;
...
void func_188(int iParam0)//Position - 0xC435
{
...
int func_189(struct<3> Param0, int iParam1, var uParam2, var uParam3)//Position - 0xC45C
{
	int iVar0;
...
int func_190(struct<3> Param0, int iParam1, int iParam2)//Position - 0xC572
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_191(int iParam0)//Position - 0xC601
{
	return BitTest(Global_113386.f_7229[iParam0], 0);
}

int func_192(int iParam0)//Position - 0xC616
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_193()//Position - 0xC632
{
	func_194();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_194()//Position - 0xC64B
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_196(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
int func_195(int iParam0)//Position - 0xC748
{
	int iVar0;
	int iVar1;
...
int func_196(int iParam0)//Position - 0xC785
{
	if (func_175(iParam0))
	{
...
var func_197(int iParam0)//Position - 0xC7AA
{
	return Global_1998[iParam0 /*29*/];
}

void func_198(char* sParam0, int iParam1)//Position - 0xC7B9
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

void func_199(char* sParam0, int iParam1, int iParam2)//Position - 0xC7D0
{
	iParam2 = iParam2;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
int func_200(int iParam0, bool bParam1, bool bParam2)//Position - 0xC7E9
{
	return func_51(iParam0, !bParam1, bParam2);
}
...
void func_202(var uParam0)//Position - 0xC861
{
	int iVar0;
...
void func_203()//Position - 0xC8D1
{
	...
	if (iLocal_88 == 0)
	{
		...
		{
			case 0:
				if ((ENTITY::DOES_ENTITY_EXIST(Local_1310.f_0) && !PED::IS_PED_INJURED(Local_1310.f_0)) && func_134(&(Local_1104[0 /*8*/])))
				{
					if (Local_1104[0 /*8*/].f_1 == 1)
					{
						if (func_204(PLAYER::PLAYER_PED_ID(), Local_1320.f_0, 1) > 500f)
						{
							func_320(1);
						}
					}
					...
					{
						if (func_204(PLAYER::PLAYER_PED_ID(), Local_1320.f_0, 1) > 250f)
						{
							func_320(1);
						}
					}
					else if (func_204(PLAYER::PLAYER_PED_ID(), Local_1320.f_0, 1) > 250f)
					{
						func_320(2);
					}
				}
			...
			case 2:
				if (!WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_BRIEFCASE"), false))
				{
					if (((((ENTITY::DOES_ENTITY_EXIST(Local_1323[0 /*2*/]) && func_204(PLAYER::PLAYER_PED_ID(), Local_1323[0 /*2*/], 1) > 250f) && ENTITY::DOES_ENTITY_EXIST(Local_1323[1 /*2*/])) && func_204(PLAYER::PLAYER_PED_ID(), Local_1323[1 /*2*/], 1) > 250f) && ENTITY::DOES_ENTITY_EXIST(Local_1323[2 /*2*/])) && func_204(PLAYER::PLAYER_PED_ID(), Local_1323[2 /*2*/], 1) > 250f)
					{
						func_320(3);
					}
				}
...
float func_204(int iParam0, int iParam1, bool bParam2)//Position - 0xCB3A
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_205(int iParam0, int iParam1)//Position - 0xCB98
{
	Global_63165 = iParam0;
	Global_63166 = iParam1;
}

void func_206(int iParam0, int iParam1)//Position - 0xCBAA
{
	int iVar0;
...
void func_207()//Position - 0xCC15
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_1320.f_0))
	{
		if (((!func_201(Local_1320.f_0) && ENTITY::IS_ENTITY_DEAD(Local_1320.f_0, false)) && iLocal_1339) && func_204(Local_1320.f_0, PLAYER::PLAYER_PED_ID(), 1) > 200f)
		{
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&Local_1320);
		}
	}
...
int func_208(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11)//Position - 0xCC96
{
	bool bVar0;
		...
		else
		{
			...
			switch (iLocal_88)
			{
				...
				case 1:
					if (!func_7(87))
					{
						Local_1320.f_0 = VEHICLE::CREATE_VEHICLE(joaat("boxville3"), 693.725f, -1006.302f, 21.8355f, 359.884f, true, true, false);
						VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_1320.f_0, false);
...
void func_210(int iParam0, int iParam1, int iParam2)//Position - 0xD171
{
...
void func_211(int iParam0)//Position - 0xD235
{
	if (iParam0 == 1)
	{
...
int func_214(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)//Position - 0xD38D
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
...
void func_215(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0xE1AD
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_216(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0xEDC1
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_217(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0xEE34
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_218(int iParam0)//Position - 0x10327
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_219(int iParam0, bool bParam1, var uParam2)//Position - 0x103D7
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_246(iVar0, bParam1, uParam2) && !func_245(PLAYER::PLAYER_ID())) && !func_227(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_225(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
...
int func_220(int iParam0)//Position - 0x10545
{
	if (iParam0 != func_32())
	{
		if (func_116(iParam0, 1, 1))
...
int func_221(int iParam0)//Position - 0x1058C
{
	switch (iParam0)
	{
		case 0:
...
int func_222(int iParam0)//Position - 0x10A13
{
...
int func_223(int iParam0)//Position - 0x10A55
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_224(int iParam0)//Position - 0x10AF8
{
	if (iParam0 != func_32())
	{
		if (func_116(iParam0, 1, 1))
...
int func_225(int iParam0)//Position - 0x10B3F
{
	if (iParam0 != func_32())
	{
		if (func_116(iParam0, 1, 1))
...
int func_226(int iParam0)//Position - 0x10B85
{
	return 1;
}

int func_227(int iParam0)//Position - 0x10B8E
{
...
int func_228(int iParam0)//Position - 0x10BBD
{
...
int func_229(int iParam0)//Position - 0x10C2D
{
	int iVar0;
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_223(iParam0)) || func_230(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_230(int iParam0)//Position - 0x10CB0
{
	switch (iParam0)
	{
		case joaat("mule"):
...
int func_231(int iParam0, bool bParam1)//Position - 0x10D00
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_233(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_232(int iParam0)//Position - 0x10D5B
{
	int iVar0;
...
int func_233(int iParam0, int iParam1)//Position - 0x10D94
{
	if (iParam1 == 0)
	{
...
int func_243(int iParam0)//Position - 0x1167A
{
	if (iParam0 != func_32())
	{
		if (func_116(iParam0, 1, 1))
...
int func_244(int iParam0)//Position - 0x116D9
{
	if (iParam0 != func_32())
	{
		if (func_116(iParam0, 1, 1))
...
int func_245(int iParam0)//Position - 0x11739
{
	if (iParam0 != func_32())
	{
		if (func_116(iParam0, 1, 1))
...
int func_246(int iParam0, bool bParam1, var uParam2)//Position - 0x11780
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_225(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_247(int iParam0)//Position - 0x11BCC
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_248(int iParam0, int iParam1)//Position - 0x11BF5
{
	int iVar0;
...
void func_249(int iParam0)//Position - 0x11C77
{
	if (!func_250(*iParam0))
	{
...
bool func_250(int iParam0)//Position - 0x11CA2
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_251(int iParam0, var uParam1, var uParam2)//Position - 0x11CB1
{
	int iVar0;
	int iVar1;
	...
	if (func_242(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_254(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_254(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_253(iParam0);
	if (func_252(*iParam0))
	{
...
int func_252(int iParam0)//Position - 0x11E8B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_253(var uParam0)//Position - 0x11F67
{
...
int func_254(int iParam0, int iParam1)//Position - 0x11FBE
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_255(int iParam0, int iParam1, int iParam2)//Position - 0x120A3
{
	if (!func_256() && VEHICLE::_IS_VEHICLE_MOD_HSW_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_256()//Position - 0x120C7
{
	return 0;
}

int func_257(var uParam0, int iParam1)//Position - 0x120D0
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_258(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x12111
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((func_259() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::_DOES_VEHICLE_HAVE_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger")))
		{
...
int func_260(var uParam0)//Position - 0x12847
{
	int iVar0;
...
int func_261(int iParam0)//Position - 0x1286B
{
	int iVar0;
...
bool func_262(int iParam0)//Position - 0x12889
{
	return func_263(&(Global_2703735.f_169), iParam0);
}

var func_263(var uParam0, var uParam1)//Position - 0x1289D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_264(int iParam0, int iParam1)//Position - 0x128C0
{
	int iVar0;
	bool bVar1;
...
bool func_265()//Position - 0x12938
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

int func_266(int iParam0)//Position - 0x12949
{
	int iVar0;
...
int func_267(int iParam0)//Position - 0x12991
{
...
int func_268(int iParam0)//Position - 0x129B1
{
	switch (iParam0)
	{
		case 161:
...
int func_269(int iParam0)//Position - 0x12A04
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
	...
	if (func_271(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
		{
...
int func_270(int iParam0)//Position - 0x12A8B
{
...
int func_271(int iParam0)//Position - 0x12ABA
{
...
int func_272(int iParam0)//Position - 0x12AD7
{
...
int func_273(int iParam0, int iParam1)//Position - 0x12AFA
{
...
int func_274(int iParam0)//Position - 0x12B35
{
	if (func_273(iParam0, 0))
	{
...
int func_275(int iParam0, int iParam1)//Position - 0x12B58
{
	int iVar0;
...
bool func_277()//Position - 0x12CFF
{
	return func_278(&(Global_103950.f_2890));
}

int func_278(var uParam0)//Position - 0x12D12
{
...
bool func_279()//Position - 0x12D71
{
...
void func_281(var uParam0, int iParam1)//Position - 0x1307D
{
	int iVar0;
...
void func_282(var uParam0)//Position - 0x130E2
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_1320.f_0))
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1323[0 /*2*/]))
		{
			...
			else
			{
				...
				ENTITY::_SET_ENTITY_CLEANUP_BY_ENGINE(Local_1323[0 /*2*/], true);
			}
		}
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1323[1 /*2*/]))
		{
			...
			else
			{
				...
				ENTITY::_SET_ENTITY_CLEANUP_BY_ENGINE(Local_1323[1 /*2*/], true);
			}
		}
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1323[2 /*2*/]))
		{
			...
			else
			{
				...
				ENTITY::_SET_ENTITY_CLEANUP_BY_ENGINE(Local_1323[2 /*2*/], true);
			}
		}
	}
}

int func_284(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x133DB
{
	if (*uParam0 == -1)
	{
		return 0;
...
void func_285(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1345B
{
...
void func_286(int iParam0, int iParam1)//Position - 0x134F6
{
	Global_100441.f_22[iParam1] = iParam0;
}

int func_287(var uParam0)//Position - 0x1350A
{
	if (func_295(uParam0))
	{
		return 1;
...
int func_288(var uParam0, char* sParam1)//Position - 0x13523
{
	int iVar0;
	int iVar1;
...
int func_289(var uParam0, int iParam1)//Position - 0x135EA
{
	int iVar0;
	int iVar1;
...
void func_290(var uParam0)//Position - 0x13693
{
	int iVar0;
...
int func_291(var uParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0x138EB
{
...
int func_292(struct<3> Param0)//Position - 0x139A3
{
...
bool func_294()//Position - 0x13A24
{
	return BitTest(Global_100441.f_20, 13);
}

int func_295(var uParam0)//Position - 0x13A35
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_296(var uParam0)//Position - 0x14406
{
...
{
	if (bLocal_93 && (func_298() || CAM::IS_SCREEN_FADED_OUT()))
	{
		func_8(1);
		SCRIPT::TERMINATE_THIS_THREAD();
	}
...
void func_299()//Position - 0x14478
{
	...
	func_301(88);
	func_285(&uLocal_1130, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
...
void func_300()//Position - 0x145EC
{
	Global_94619 = 1;
}

void func_301(int iParam0)//Position - 0x145F9
{
	Global_96296 = 0;
	switch (iParam0)
	{
...
void func_302(int iParam0)//Position - 0x14687
{
	MISC::SET_BIT(&Global_96296, iParam0);
}

int func_303(var uParam0, char* sParam1, int iParam2)//Position - 0x14699
{
...
void func_304(var uParam0)//Position - 0x1473D
{
	func_295(uParam0);
}

void func_305(struct<3> Param0, var uParam1, int iParam2, int iParam3)//Position - 0x1474C
{
	if (func_212())
	{
...
{
	func_314(&(Local_1104[0 /*8*/]), 85336/*func_315*/, "Van Driver Manager");
	func_314(&(Local_1104[1 /*8*/]), 83983/*func_307*/, "Cargo Manager");
}
...
int func_308(int iParam0)//Position - 0x14AFF
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_309(var uParam0, int iParam1, int iParam2)//Position - 0x14B20
{
	if (iParam2 > 0)
	{
		*uParam0 = 2;
...
int func_310(var uParam0, char* sParam1)//Position - 0x14B46
{
	int iVar0;
	int iVar1;
...
void func_311(var uParam0)//Position - 0x14C10
{
	if (*uParam0 != 4)
	{
		*uParam0 = 4;
...
void func_312(int iParam0, bool bParam1)//Position - 0x14C35
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		if (bParam1)
		{
			Var0 = { func_313(ENTITY::GET_ENTITY_COORDS(iParam0, true) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1320.f_0, MISC::GET_RANDOM_FLOAT_IN_RANGE(-0.15f, 0.15f), IntToFloat(-MISC::GET_RANDOM_INT_IN_RANGE(3, 6)), MISC::GET_RANDOM_FLOAT_IN_RANGE(-0.1f, 0.1f))) };
...
Vector3 func_313(struct<3> Param0)//Position - 0x14CF2
{
	float fVar0;
	float fVar1;
...
int func_314(var uParam0, int iParam1, char* sParam2)//Position - 0x14D31
{
	if (*uParam0 != -1)
	{
		return 0;
...
void func_315(var uParam0)//Position - 0x14D58
{
	...
	if (!func_135(uParam0))
	{
		if (((!ENTITY::DOES_ENTITY_EXIST(Local_1310.f_0) || PED::IS_PED_INJURED(Local_1310.f_0)) || (ENTITY::DOES_ENTITY_EXIST(Local_1320.f_0) && func_204(Local_1320.f_0, Local_1310.f_0, 1) > 200f)) || (!PED::IS_PED_IN_ANY_VEHICLE(Local_1310.f_0, false) && func_204(Local_1320.f_0, Local_1310.f_0, 1) > 200f))
		{
		...
		else
		{
			...
			else if ((uParam0->f_1 == 1 || uParam0->f_1 == 2) || uParam0->f_1 == 4)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					...
					Var1 = { func_313(ENTITY::GET_ENTITY_COORDS(iVar0, true) - ENTITY::GET_ENTITY_COORDS(Local_1320.f_0, true)) };
			...
			switch (uParam0->f_1)
			{
				case 1:
					...
					else
					{
						...
						if (!func_317(Local_1310.f_0, joaat("SCRIPT_TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING"), 1))
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_1320.f_0, -990.6312f, -2413.214f, 12.69471f, -996.0194f, -2422.608f, 16.05846f, 8.75f, false, true, 0))
							{
				...
				case 2:
					...
					else if (!func_317(Local_1310.f_0, joaat("SCRIPT_TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING"), 1))
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_1320.f_0, -1096.139f, -2467.117f, 12.69561f, -1101.641f, -2476.775f, 15.6304f, 7.8125f, false, true, 0))
						{
							iLocal_1332 = 0;
							iLocal_1333 = 0;
							StringCopy(&cLocal_1334, "", 24);
				...
				case 3:
					...
					{
						if (!func_317(Local_1310.f_0, joaat("SCRIPT_TASK_LEAVE_VEHICLE"), 1))
						{
				...
				case 4:
					...
					else if (!func_317(Local_1310.f_0, joaat("SCRIPT_TASK_VEHICLE_MISSION"), 1))
					{
				...
				case 5:
					if (ENTITY::DOES_ENTITY_EXIST(Local_1320.f_0) && !ENTITY::IS_ENTITY_DEAD(Local_1320.f_0, false))
					{
						if (PED::IS_PED_IN_VEHICLE(Local_1310.f_0, Local_1320.f_0, false))
						{
							...
							{
								if (!func_317(Local_1310.f_0, joaat("SCRIPT_TASK_VEHICLE_TEMP_ACTION"), 1))
								{
									TASK::CLEAR_PED_TASKS(Local_1310.f_0);
									TASK::TASK_VEHICLE_TEMP_ACTION(Local_1310.f_0, Local_1320.f_0, 5, -1);
								}
							}
							else if (!func_317(Local_1310.f_0, joaat("SCRIPT_TASK_LEAVE_VEHICLE"), 1))
							{
								TASK::TASK_LEAVE_VEHICLE(Local_1310.f_0, Local_1320.f_0, 256);
							}
						}
						else if (!func_317(Local_1310.f_0, joaat("SCRIPT_TASK_COMBAT"), 1))
						{
					...
					if (ENTITY::DOES_ENTITY_EXIST(Local_1320.f_0) && !ENTITY::IS_ENTITY_DEAD(Local_1320.f_0, false))
					{
						VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(Local_1320.f_0, 2, true);
						VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(Local_1320.f_0, 3, true);
					}
					break;
				}
		}
		if ((ENTITY::DOES_ENTITY_EXIST(Local_1310.f_0) && !PED::IS_PED_INJURED(Local_1310.f_0)) && !PED::IS_CONVERSATION_PED_DEAD(Local_1310.f_0))
		{
			switch (uParam0->f_1)
			{
				case 4:
					...
					{
						case 0:
							if (func_42() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_1310.f_0))
							{
						...
						case 1:
							...
							else if (func_42() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_1310.f_0))
							{
						...
						case 3:
							if (!func_43() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_1310.f_0))
							{
...
bool func_316(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x15A86
{
...
int func_317(int iParam0, int iParam1, bool bParam2)//Position - 0x15AD4
{
	int iVar0;
...
float func_318(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x15B1A
{
	struct<3> Var0;
...
float func_319(struct<3> Param0, struct<3> Param1)//Position - 0x15B54
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
void func_325(var uParam0)//Position - 0x15F4B
{
	*uParam0 = -15;
}
...
void func_327(int iParam0, bool bParam1)//Position - 0x168C8
{
	if (bParam1)
	{
...
void func_328()//Position - 0x16906
{
	Global_100476 = 1;
...
void func_329(char* sParam0, char* sParam1)//Position - 0x169F3
{
...
void func_331(char* sParam0)//Position - 0x16A44
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (HUD::GET_LENGTH_OF_LITERAL_STRING(sParam0) <= 16)
