...
void __EntryFunction__()//Position - 0x0
{
	...
	if (Global_78558)
	{
		...
		if (Global_4542574 == 0)
		{
			...
			if ((NETWORK::NETWORK_CLAN_PLAYER_IS_ACTIVE(&Var16) && NETWORK::NETWORK_HAVE_USER_CONTENT_PRIVILEGES(0)) && Global_4542577 == 0)
			{
...
void func_9()//Position - 0x211D
{
	...
	{
		Local_119 = { Global_20329[Global_20328 /*3*/] };
	}
	else
	{
		Local_119 = { Global_20336[Global_20328 /*3*/] };
	}
	fVar4 = func_15(Local_119, Global_20329[Global_20328 /*3*/], Global_20343, Var1, fVar0, 0);
...
float func_15(struct<3> Param0, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, bool bParam13)//Position - 0x277E
{
	struct<2> Var0;
	float fVar3;
	float fVar4;
	...
	if (fVar3 < 1f)
	{
		...
		Global_20311 = { func_16(Param0, Param3, fVar4) };
		Global_20314 = { func_16(Param6, Param9, fVar4) };
	}
	else
	{
		Global_20311 = { Param3 };
...
Vector3 func_16(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x288D
{
...
{
	if (BitTest(Global_8254, 10) || iLocal_122 == 1)
	{
...
void func_51()//Position - 0x456F
{
	...
	else
	{
		if (iLocal_82 == 0)
		{
			Local_83 = { Global_20336[Global_20328 /*3*/] };
			Local_83.f_0 = (Local_83.f_0 - 10f);
			Local_83.f_1 = (Local_83.f_1 + 20f);
			iLocal_82 = 1;
		}
		fVar1 = func_15(Global_20329[Global_20328 /*3*/], Local_83, -90f, 0f, 90f, -90f, 0f, 90f, 450f, 1);
		if (fVar1 >= 1f)
		{
			MISC::SET_BIT(&Global_8254, 8);
			MISC::SET_BIT(&Global_8253, 14);
...
int func_96(struct<3> Param0, int iParam3)//Position - 0x6BAB
{
	if (iParam3 != -1)
	{
		...
		{
			return func_96(Param0, Global_43258[iParam3 /*5*/].f_4);
		}
	}
	return 0;
}
...
void func_110()//Position - 0x70E3
{
	...
	if (iLocal_92 != Global_8256)
	{
		...
		{
			case 0:
				StringCopy(&Local_94, "CELL_920" /* GXT: Sun */, 16);
				break;
			
			case 1:
				StringCopy(&Local_94, "CELL_921" /* GXT: Mon */, 16);
				break;
			
			case 2:
				StringCopy(&Local_94, "CELL_922" /* GXT: Tue */, 16);
				break;
			
			case 3:
				StringCopy(&Local_94, "CELL_923" /* GXT: Wed */, 16);
				break;
			
			case 4:
				StringCopy(&Local_94, "CELL_924" /* GXT: Thu */, 16);
				break;
			
			case 5:
				StringCopy(&Local_94, "CELL_925" /* GXT: Fri */, 16);
				break;
			
			case 6:
				StringCopy(&Local_94, "CELL_926" /* GXT: Sat */, 16);
				break;
			
			default:
				StringCopy(&Local_94, "CELL_206" /* GXT: BACK */, 16);
				break;
		}
		func_81(Global_20364, "SET_TITLEBAR_TIME", SYSTEM::TO_FLOAT(iLocal_91), SYSTEM::TO_FLOAT(iLocal_92), -1f, -1f, -1f, &Local_94, 0, 0, 0, 0);
		if (Global_20326 == 0)
		{
			func_92();
		}
...
void func_116()//Position - 0x74FC
{
	...
	if (NETWORK::NETWORK_IS_SIGNED_ONLINE())
	{
		...
		else if (func_117(Global_2800025.f_20))
		{
