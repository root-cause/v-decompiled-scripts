...
float func_86(struct<3> Param0, struct<3> Param1)//Position - 0x2F12
{
...
void func_105()//Position - 0x31EF
{
	...
	bLocal_265 = !Global_3;
	iLocal_218 = 15;
	sLocal_226 = "PBAM_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to Andy Moon. */;
