...
bool func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B25
{
...
var func_38(int iParam0, int iParam1)//Position - 0x1EEB
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_39()//Position - 0x1F03
{
	return -1;
}
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21C1
{
...
void func_48(char[4] cParam0)//Position - 0x2217
{
	int iVar0;
...
void func_49(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2252
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_51(var uParam0)//Position - 0x2325
{
}

void func_52(var uParam0, int iParam1, float fParam2)//Position - 0x232D
{
}
...
void func_55(var uParam0)//Position - 0x23BA
{
}

void func_56(char* sParam0)//Position - 0x23C2
{
...
void func_70(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x267D
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x2966
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0)//Position - 0x2AAC
{
	if (func_77(iParam0))
	{
...
int func_76(int iParam0)//Position - 0x2AD0
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x2B00
{
...
void func_79(int* iParam0)//Position - 0x2BE8
{
	if (iLocal_445 == 1)
	{
...
void func_80(int* iParam0, int iParam1, bool bParam2)//Position - 0x2C07
{
	if (iLocal_445 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_81(int iParam0, bool bParam1, int iParam2)//Position - 0x2C5A
{
	int iVar0;
...
int func_82(int iParam0, bool bParam1, bool bParam2)//Position - 0x2CA4
{
	int iVar0;
...
float func_83(bool bParam0, float fParam1, float fParam2)//Position - 0x2D48
{
	if (bParam0)
	{
		return fParam1;
...
float func_84(int iParam0, int iParam1, bool bParam2)//Position - 0x2D5F
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_85(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2DBD
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_86(struct<3> Param0, struct<3> Param3)//Position - 0x2E4E
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_87(struct<3> Param0)//Position - 0x2E6F
{
	float fVar0;
	float fVar1;
...
int func_88(int iParam0)//Position - 0x2EAE
{
	var uVar0;
...
int func_95()//Position - 0x2F44
{
	return 1;
}

float func_96(int iParam0, int iParam1)//Position - 0x2F4D
{
...
void func_100(var uParam0, var uParam1)//Position - 0x3073
{
...
int func_102(int iParam0)//Position - 0x30F6
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_105()//Position - 0x312B
{
	...
	StringCopy(&Local_232, "PBMN", 8);
	StringCopy(&Local_234, "MANI", 16);
	StringCopy(&Local_200, "Special_Ped@mani", 64);
	StringCopy(&Local_216, "Base", 64);
	bLocal_434 = !Global_4;
	iLocal_250 = 8;
	sLocal_301 = "PBMN_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to Mani. */;
	StringCopy(&Local_310, "PBMN_CONV_GM", 16);
	StringCopy(&Local_314, "PBMN_CONV_GT", 16);
	StringCopy(&Local_318, "PBMN_CONV_GF", 16);
	StringCopy(&cLocal_322, "special_ped@mani@base", 64);
	StringCopy(&cLocal_338, "special_ped@mani@intro", 64);
	iLocal_249 = 8;
	iLocal_253[0] = 6;
	iLocal_253[1] = 6;
	iLocal_253[2] = 6;
...
int func_109()//Position - 0x3222
{
	return 1;
}

bool func_110(var uParam0)//Position - 0x322B
{
	return func_111(Global_114135.f_20121, uParam0);
}

bool func_111(var uParam0, var uParam1)//Position - 0x3240
{
	return (uParam0 && uParam1) != 0;
}

int func_112(char* sParam0)//Position - 0x324F
{
...
void func_114(int* iParam0)//Position - 0x3445
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
