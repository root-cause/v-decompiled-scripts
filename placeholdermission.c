...
void func_3()//Position - 0xFC
{
	...
	if (Global_114135.f_9089 || func_19(0))
	{
		if (!func_18())
		{
			iVar0 = func_17();
...
void func_6()//Position - 0x26B
{
	...
	{
		if (func_10(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_9(PLAYER::PLAYER_PED_ID());
			if (func_8(iVar0) && (!func_7(14) || Global_113083))
			{
...
var func_11(int iParam0)//Position - 0x3E4
{
	return Global_2201[iParam0 /*29*/];
}

int func_12(int iParam0)//Position - 0x3F3
{
	int iVar0;
	int iVar1;
...
int func_15(int iParam0, var uParam1, float fParam2)//Position - 0x6D7
{
	switch (iParam0)
	{
		case 11:
...
int func_19(bool bParam0)//Position - 0x10F4
{
