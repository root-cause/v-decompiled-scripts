...
void func_39()//Position - 0x140C
{
	...
	{
		func_41(13, SYSTEM::FLOOR(Global_114135.f_10198.f_3853));
	}
...
bool func_60(int iParam0, int iParam1)//Position - 0x251E
{
	bool bVar0;
...
int func_62(var uParam0)//Position - 0x25B8
{
	int iVar0;
...
int func_63(int iParam0)//Position - 0x25DA
{
...
int func_65(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x2627
{
	int iVar0;
...
int func_67(bool bParam0, bool bParam1, bool bParam2)//Position - 0x267D
{
	int iVar0;
...
int func_69(int iParam0, bool bParam1, bool bParam2)//Position - 0x28F1
{
	return func_70(iParam0, !bParam1, bParam2);
}

int func_70(int iParam0, bool bParam1, bool bParam2)//Position - 0x2904
{
	int iVar0;
...
int func_71(int iParam0, bool bParam1, int iParam2)//Position - 0x29A8
{
	int iVar0;
...
int func_76(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2D46
{
...
void func_79(int iParam0, bool bParam1)//Position - 0x2F27
{
	bool bVar0;
...
int func_88(bool bParam0, int iParam1, int iParam2)//Position - 0x3772
{
	if (bParam0)
	{
		return iParam1;
...
int func_94(char* sParam0)//Position - 0x3857
{
	var uVar0;
							...
							if ((bLocal_116 && ENTITY::IS_ENTITY_AT_COORD(iLocal_53, Local_97, 1f, 1f, 1f, false, true, 0)) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_53, false))
							{
								...
								if (ENTITY::IS_ENTITY_OCCLUDED(iLocal_53))
								{
									if (!PED::IS_PED_INJURED(iLocal_53))
									{
										...
										ENTITY::SET_ENTITY_INVINCIBLE(iLocal_53, true, false);
									...
									if (SYSTEM::TIMERA() > 15000)
									{
										if (!PED::IS_PED_INJURED(iLocal_53))
										{
											...
											ENTITY::SET_ENTITY_INVINCIBLE(iLocal_53, false, false);
...
void func_97(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x44FC
{
...
int func_104(int iParam0, int iParam1)//Position - 0x4D4C
{
...
int func_113(int iParam0)//Position - 0x5215
{
	if (func_117())
	{
		Global_114125 = 1;
		Global_114122 = MISC::GET_GAME_TIMER();
		if (func_45(Global_114124))
		{
			func_114(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /* GXT: Random Event */);
		if (iParam0 && func_45(Global_114124))
		{
...
void func_115(char* sParam0, int iParam1)//Position - 0x5343
{
...
int func_117()//Position - 0x539D
{
	switch (func_118(&Global_33147, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
bool func_120(int iParam0)//Position - 0x5559
{
	return func_121(iParam0, Global_44181);
}

int func_121(int iParam0, int iParam1)//Position - 0x556A
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_122(int iParam0)//Position - 0x574B
{
	if (Global_44181 == 15)
	{
		return 0;
...
int func_124(int iParam0)//Position - 0x5F3E
{
...
int func_132(int iParam0, var uParam1)//Position - 0x66E6
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_133(uParam1));
}

int func_133(var uParam0)//Position - 0x66FB
{
	int iVar0;
	int iVar1;
...
int func_137(int iParam0, int iParam1, bool bParam2)//Position - 0x6B85
{
	if (iParam0 == -1)
	{
		return 0;
...
{
	if ((Global_114124 == func_54() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_114125)
	{
		return 1;
	}
	return 0;
...
int func_155(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x8965
{
	...
	if (!bVar0)
	{
		...
		if (!func_178(Global_114135.f_24999.f_43[iParam3]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_176()) || Global_113182) || Global_33090) || func_175()) || func_24(8, -1)) || func_174()) || func_173()) || func_172()) || func_171()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_176()) || Global_33090) || func_175()) || func_24(8, -1)) || func_172()) || func_174()) || func_173()) || func_171()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_176()) || Global_113182) || Global_33090) || func_175()) || func_24(8, -1)) || func_172()) || func_174()) || func_173()) || func_171()) || Global_114135.f_7692.f_919[iVar0] == 5) || Global_44728 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_176()) || Global_113182) || Global_33090) || func_175()) || func_24(8, -1)) || func_174()) || func_173()) || func_171()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_176() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_24(8, -1)) || func_171()) || func_170()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_176()) || func_173()) || Global_113182) || Global_33090) || func_175()) || Global_45392) || func_24(8, -1)) || func_172()) || func_170()) || func_171()) || Global_114135.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_186(int iParam0)//Position - 0x9F0F
{
	...
	if (func_151())
	{
		...
		func_189(30000);
		StringCopy(&cVar0, func_188(Global_114124, 1), 64);
		if (func_53(Global_114124) > 0)
		{
...
void func_198(int iParam0, int iParam1)//Position - 0xA722
{
	...
	func_199(iParam0, &(Global_114135.f_32754.f_5510));
}
...
bool func_210()//Position - 0xB64E
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_211()//Position - 0xB664
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_212()//Position - 0xB67A
{
	return 0;
}

int func_213()//Position - 0xB683
{
	return 1;
}

int func_214()//Position - 0xB68C
{
	return 1;
}

int func_215()//Position - 0xB695
{
...
int func_217(int iParam0)//Position - 0xB6F5
{
	int iVar0;
...
int func_218(int iParam0)//Position - 0xB730
{
	int iVar0;
...
int func_219(int iParam0)//Position - 0xB7AC
{
	int iVar0;
...
int func_220(int iParam0)//Position - 0xB894
{
	int iVar0;
...
int func_221(int iParam0, int iParam1, bool bParam2)//Position - 0xB8F7
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_222(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0xB965
{
...
void func_223(bool bParam0)//Position - 0xBA3D
{
	int iVar0;
