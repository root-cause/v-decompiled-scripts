...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_33 = -1;
	Local_48 = { 2136.133f, 4780.5635f, 39.9702f };
	Local_53 = { 2149.737f, 4798.4717f, 40.1071f };
	fLocal_56 = 55.4847f;
	...
	while (true)
	{
		...
		if (func_183())
		{
			...
			{
				fLocal_29 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_30);
			}
			func_181(&iVar1);
			func_31(&iVar2);
			if (iLocal_45 > 3)
			{
				if (fLocal_29 < 600f)
				{
					if (func_28(0) == 0 && (MISC::GET_GAME_TIMER() - iLocal_79) > 2000)
					{
...
void func_23()//Position - 0x1144
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_25(Global_114370.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_13(iVar0) && (!func_24(14) || Global_113320))
			{
...
void func_31(int iParam0)//Position - 0x14D4
{
	...
	if (iLocal_51 != 9)
	{
		if (!Global_114370.f_19986.f_13)
		{
			if (Global_114370.f_19986.f_1 == 0 && Global_114370.f_19986.f_2 == 0)
			{
				...
				{
					func_177("MG_TRAF_AVAIL" /* GXT: Trevor can now do air and ground trafficking missions, available at ~BLIP_ARMS_DEALING_AIR~ and ~BLIP_ARMS_DEALING~ */, 0, 0, -1, 10000, 7, 0, 0, 0);
	...
	switch (iLocal_51)
	{
		...
		case 3:
			...
			{
				MISC::CLEAR_AREA_OF_VEHICLES(Local_53, 4f, false, false, false, false, false, false, 0);
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_52))
				{
					VEHICLE::DELETE_VEHICLE(&iLocal_52);
				}
				iLocal_52 = VEHICLE::CREATE_VEHICLE(func_172(), Local_53, fLocal_56, true, true, false);
				AUDIO::SET_VEHICLE_RADIO_ENABLED(iLocal_52, false);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_172());
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_52))
				{
					if (VEHICLE::DOES_EXTRA_EXIST(iLocal_52, 1))
					{
						VEHICLE::SET_VEHICLE_EXTRA(iLocal_52, 1, true);
					}
					if (VEHICLE::DOES_EXTRA_EXIST(iLocal_52, 2))
					{
						VEHICLE::SET_VEHICLE_EXTRA(iLocal_52, 2, false);
					}
					if (VEHICLE::DOES_EXTRA_EXIST(iLocal_52, 3))
					{
						VEHICLE::SET_VEHICLE_EXTRA(iLocal_52, 3, false);
					}
					VEHICLE::SET_VEHICLE_COLOURS(iLocal_52, 0, 0);
				}
				iLocal_51 = 4;
			}
			break;
		...
		case 4:
			...
			if (!bVar0 && !*iParam0)
			{
				...
				if (!iLocal_57)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_26, false))
					{
						iVar1 = PED::GET_VEHICLE_PED_IS_USING(iLocal_26);
						if (iVar1 == iLocal_52)
						{
							iLocal_57 = 1;
			...
			if (*iParam0)
			{
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !ENTITY::IS_ENTITY_DEAD(iLocal_52, false))
				{
					PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_52, -1);
				}
			}
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !ENTITY::IS_ENTITY_DEAD(iLocal_52, false))
			{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_52, false) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					...
					if (iVar2 == iLocal_52)
					{
						if (SYSTEM::VDIST2(Local_53, ENTITY::GET_ENTITY_COORDS(iLocal_26, true)) < 100f)
						{
							SCRIPT::REQUEST_SCRIPT("Traffick_Ground");
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_27) && !ENTITY::IS_ENTITY_DEAD(iLocal_27, false))
							{
								if (ENTITY::GET_ENTITY_MODEL(iLocal_27) != joaat("dune") && ENTITY::GET_ENTITY_MODEL(iLocal_27) != joaat("cuban800"))
								{
									func_142(iLocal_27, 2142.245f, 4823.463f, 40.2769f, 118.4428f, 24, 0);
								}
								else if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
								{
									VEHICLE::SET_PLAYERS_LAST_VEHICLE(iLocal_27);
								}
							}
							iLocal_51 = 6;
						}
		...
		case 6:
			if (SCRIPT::HAS_SCRIPT_LOADED("Traffick_Ground"))
			{
				...
				{
					iVar3 = func_140(&iLocal_33, 6, 9, 0, 0);
					iLocal_43 = 1;
				}
				if (iVar3 == 1)
				{
					...
					Var4.f_85 = 4;
					Var4.f_90 = 6;
					iLocal_28 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS("Traffick_Ground", &Var4, 97, 60500);
					func_81(16);
					SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("Traffick_Ground");
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_52, true, false);
					ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_52);
		...
		case 7:
			if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_28))
			{
				...
				else
				{
					...
					Global_114370.f_19986.f_12 = iVar101;
					func_1(106, 0, 0);
					Global_114370.f_19986.f_13 = 0;
				}
				*iParam0 = 0;
...
void func_85(char[4] cParam0, int iParam1, int iParam2)//Position - 0x2D59
{
	if (Global_101392 != 10 && Global_101392 != 9)
	{
		...
		func_87(&Global_104933, cParam0, 0, "Start", iParam1, iParam2);
		func_86();
		Global_95550 = 0;
	}
}
...
void func_87(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x3A31
{
	...
	*uParam0 = func_22();
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_99(PLAYER::PLAYER_PED_ID(), 0);
...
int func_91(int iParam0, var uParam1)//Position - 0x4AA6
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_92(uParam1));
}

int func_92(var uParam0)//Position - 0x4ABB
{
	int iVar0;
	int iVar1;
...
var func_93()//Position - 0x4AEF
{
	return Global_1574925;
}

int func_94(int iParam0, int iParam1)//Position - 0x4AFB
{
	int iVar0;
	var uVar1;
...
int func_95(int iParam0, var uParam1)//Position - 0x4B1F
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_92(uParam1));
}
...
void func_99(int iParam0, bool bParam1)//Position - 0x52D7
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_13(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_100(iParam0, &(Global_114370.f_2366.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_100(int iParam0, var uParam1)//Position - 0x53CA
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_105(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_102(Var11.f_1)) && iVar72 < 51)
			{
...
int func_101(int iParam0)//Position - 0x5652
{
	switch (iParam0)
	{
...
int func_102(int iParam0)//Position - 0x56F3
{
...
void func_106(int iParam0)//Position - 0x68AF
{
	int iVar0;
...
int func_108(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x6E38
{
	int iVar0;
	int iVar1;
...
bool func_110(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x75FB
{
	if (bParam6)
	{
...
int func_111(var uParam0)//Position - 0x7642
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_139())
		{
			*uParam0 = func_117(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 6, -1, 0, 1, -1);
...
int func_113(int iParam0, int iParam1, bool bParam2)//Position - 0x76AD
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_116(int iParam0)//Position - 0x7AC0
{
	return func_113(iParam0, 5, 1);
}

int func_117(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x7AD0
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 60)
	{
		if (iParam3 == 6 || iParam3 == func_138(iVar0))
		{
			if (!bParam5 || func_137(iVar0))
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_118(iVar0, 0), true);
...
int func_121(struct<3> Param0)//Position - 0x85E9
{
...
Vector3 func_122(struct<3> Param0)//Position - 0x8613
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_123(), 0f, Param0);
}
...
int func_124(int iParam0)//Position - 0x863F
{
	if (iParam0 != func_133())
	{
...
Vector3 func_125(int iParam0, int iParam1)//Position - 0x8697
{
	...
	if (Global_1845093 != func_133())
	{
		if (iParam1 == 3)
		{
			if (func_126(iParam0, 1, &Var0, 0, 0))
			{
				Var6 = { Var0 };
			}
		}
		else if (iParam1 == 2)
		{
			...
			{
				if (func_126(iParam0, 2, &Var0, 0, 0))
				{
					Var6 = { Var0 };
				}
			}
...
int func_126(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x8741
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
	...
	if (!func_131(iParam3, &Var0))
	{
		return 0;
	}
	if (!func_131(iParam1, &Var6))
	{
		return 0;
	}
	if (!bParam4)
	{
		Var12 = { func_129(iParam0) };
	}
	else
	{
	...
	Var18 = { Var12 - Var0 };
	Var18 = { func_127(Var18, -Var0.f_3.f_2) };
	Var18 = { func_127(Var18, Var6.f_3.f_2) };
	*uParam2 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Var6, 0f, Var18) };
	uParam2->f_3 = { Var12.f_3 };
	return 1;
}

Vector3 func_127(struct<3> Param0, float fParam3)//Position - 0x87D6
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_131(int iParam0, var uParam1)//Position - 0x9473
{
	switch (iParam0)
	{
		case 0:
...
int func_132(int iParam0)//Position - 0x94F5
{
	if (iParam0 != func_133())
	{
...
int func_137(int iParam0)//Position - 0x97EF
{
...
int func_140(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x9B46
{
	int iVar0;
...
void func_142(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x9CCC
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_163(iParam5, &Var0, Param1, fParam4, func_9(iParam0));
...
void func_144(int iParam0, int iParam1)//Position - 0x9F0C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_145(int iParam0)//Position - 0xA10E
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_20(iParam0, 0, 0)) || func_20(iParam0, 1, 0)) || func_20(iParam0, 2, 0)) || func_9(iParam0) != 145) || func_160(iParam0)) || func_159(iParam0)) || func_158(iParam0)) || func_157(iParam0)) || !func_146(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_159(iParam0))
		{
		}
...
int func_146(int iParam0)//Position - 0xA1EB
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_147(int iParam0, bool bParam1, int iParam2)//Position - 0xA3A9
{
	int iVar0;
	struct<2> Var1;
...
int func_148(int iParam0)//Position - 0xA52B
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_150(int iParam0, int iParam1)//Position - 0xA60E
{
	int iVar0;
	int iVar1;
...
int func_152()//Position - 0xFB61
{
	return 0;
}

int func_153()//Position - 0xFB6A
{
	return 1;
}

int func_154()//Position - 0xFB73
{
	return 1;
}

int func_155()//Position - 0xFB7C
{
...
int func_157(int iParam0)//Position - 0xFC4D
{
	int iVar0;
	char* sVar1;
...
int func_158(int iParam0)//Position - 0xFC94
{
	int iVar0;
...
int func_159(int iParam0)//Position - 0xFCCF
{
	int iVar0;
...
int func_160(int iParam0)//Position - 0xFD4B
{
	int iVar0;
...
int func_162(var uParam0, int iParam1)//Position - 0xFE4F
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_110(Global_114370.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_110(Global_114370.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_110(Global_114370.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_163(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x1169C
{
	if (func_162(&(Global_78038.f_555[0 /*21*/]), iParam0))
	{
...
int func_166(int iParam0, int iParam1)//Position - 0x1182D
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_171()//Position - 0x119C5
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_27))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_30) < 2500f)
			{
				iLocal_27 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_27))
				{
					iVar0 = ENTITY::GET_ENTITY_MODEL(iLocal_27);
					if (iVar0 == joaat("dune"))
					{
					}
				}
...
void func_175(var uParam0, int iParam1)//Position - 0x11B13
{
	func_176(uParam0, iParam1);
}

void func_176(var uParam0, var uParam1)//Position - 0x11B23
{
...
void func_178(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x11B55
{
	int iVar0;
...
bool func_180(var uParam0, int iParam1)//Position - 0x11E3F
{
	return (uParam0 && iParam1) != 0;
}

void func_181(int iParam0)//Position - 0x11E4E
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	switch (iLocal_45)
	{
		...
		case 3:
			...
			if (STREAMING::HAS_MODEL_LOADED(joaat("cuban800")))
			{
				...
				{
					MISC::CLEAR_AREA_OF_VEHICLES(Local_48, 8f, false, false, false, false, false, false, 0);
					iLocal_46 = VEHICLE::CREATE_VEHICLE(joaat("cuban800"), Local_48, 25.29f, true, true, false);
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("cuban800"));
					VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iLocal_46, 2);
		...
		case 4:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
			{
				if (ENTITY::IS_ENTITY_DEAD(iLocal_46, false) || ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
				{
					iLocal_45 = 9;
					return;
				}
			...
			else if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("traffick_ground")) == 0)
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_46, false))
				{
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_46, 1);
				}
			}
			if (!bLocal_35)
			{
			...
			if (!bVar0 && !*iParam0)
			{
				if (!iLocal_47)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_26, false))
					{
						...
						{
							iLocal_47 = 1;
							ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_46);
							iLocal_45 = 9;
						}
					}
				}
			...
			if (*iParam0)
			{
				PED::SET_PED_INTO_VEHICLE(iLocal_26, iLocal_46, -1);
			}
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !ENTITY::IS_ENTITY_DEAD(iLocal_46, false))
			{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					...
					if (iVar2 == iLocal_46)
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_27) && !ENTITY::IS_ENTITY_DEAD(iLocal_27, false))
						{
							if (ENTITY::GET_ENTITY_MODEL(iLocal_27) != joaat("dune") && ENTITY::GET_ENTITY_MODEL(iLocal_27) != joaat("cuban800"))
							{
								if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_27, 2137.1204f, 4799.97f, 39.678535f, 2116.64f, 4790.417f, 45.452946f, 25f, false, true, 0))
								{
									func_142(iLocal_27, 2142.245f, 4823.463f, 40.2769f, 118.4428f, 24, 0);
								}
							}
		...
		case 7:
			if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_28))
			{
				...
				else
				{
					...
					Global_114370.f_19986.f_11 = uVar4;
					func_1(105, 0, 0);
					Global_114370.f_19986.f_14 = 0;
					iLocal_45 = 9;
				}
...
int func_183()//Position - 0x123E9
{
	...
	iLocal_26 = PLAYER::PLAYER_PED_ID();
	if (ENTITY::IS_ENTITY_DEAD(iLocal_26, false))
	{
	}
	if (func_193())
	{
...
int func_187(int iParam0)//Position - 0x12599
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_192()) || Global_32831) || func_186()) || func_185(8, -1)) || func_184()) || func_139()) || func_191()) || func_190()) || Global_114370.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_192()) || Global_113417) || Global_32831) || func_186()) || func_185(8, -1)) || func_184()) || func_139()) || func_191()) || func_190()) || Global_114370.f_7691.f_919[iVar0] == 5) || Global_44469 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_192()) || Global_113417) || Global_32831) || func_186()) || func_185(8, -1)) || func_139()) || func_191()) || func_190()) || Global_114370.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_192() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_185(8, -1)) || func_190()) || func_189()) || Global_114370.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_192()) || Global_32831) || func_186()) || func_185(8, -1)) || func_191()) || func_184()) || func_190()) || Global_114370.f_7691.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_188()//Position - 0x12CB6
{
	return Global_101431.f_1;
}

int func_189()//Position - 0x12CC4
{
	if (Global_98294 != -1)
	{
...
int func_195(int iParam0, int iParam1)//Position - 0x12D9C
{
	int iVar0;
...
void func_197()//Position - 0x12E0D
{
	if (!iLocal_78)
	{
		iLocal_77 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(40.073f, 4788.5586f, 2157.109f) - Vector(25f, 25f, 25f), Vector(40.073f, 4788.5586f, 2157.109f) + Vector(25f, 25f, 25f), false, true, true, true, 1);
		iLocal_78 = 1;
	}
}
	...
	while (iVar0 < 8)
	{
		if (Global_98305[iVar0 /*17*/] && !Global_98305[iVar0 /*17*/].f_1)
		{
			if (Global_98305[iVar0 /*17*/].f_3 == 0)
			{
				...
				{
					func_201(Global_98305[iVar0 /*17*/].f_5, 1);
				}
			}
		}
		iVar0++;
...
void func_202()//Position - 0x12FAE
{
	...
	while (iVar0 < 5)
	{
		if (OBJECT::DOES_PICKUP_EXIST(uLocal_65[iVar0]))
		{
			OBJECT::REMOVE_PICKUP(uLocal_65[iVar0]);
		}
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_59[iVar0]))
		{
			OBJECT::DELETE_OBJECT(&(uLocal_59[iVar0]));
		}
		iVar0++;
	}
}
