...
int func_21(int iParam0)//Position - 0xB8C
{
	int iVar0;
...
void func_22(bool bParam0, int iParam1, int iParam2)//Position - 0xBBD
{
	int iVar0;
	int iVar1;
...
void func_23(int iParam0, bool bParam1)//Position - 0xC8D
{
	int iVar0;
...
int func_29(int iParam0)//Position - 0xD63
{
	if (func_8(iParam0, 0))
	{
		return 1;
...
int func_30()//Position - 0xDA2
{
	return BitTest(Global_2684504, 7);
}

int func_31()//Position - 0xDB0
{
...
void func_37(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xEA4
{
	if (bParam0)
	{
...
int func_39(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x100B
{
	int iVar0;
...
int func_47(int iParam0)//Position - 0x11F0
{
	if (iParam0 == 1)
	{
...
void func_53(var uParam0)//Position - 0x133B
{
	uParam0->f_1 = 0;
}
...
int func_57(var uParam0)//Position - 0x13A1
{
	func_279();
...
int func_58(var uParam0)//Position - 0x1404
{
	func_59();
	if (CAM::IS_SCREEN_FADED_OUT())
	{
...
void func_61(int iParam0)//Position - 0x14D3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8)//Position - 0x156F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63()//Position - 0x1653
{
	return -1;
}

int func_64(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x165C
{
	int iVar0;
...
int func_68(var uParam0)//Position - 0x18C6
{
	if (uParam0->f_20 == 0)
	{
		return 1;
...
int func_69()//Position - 0x1946
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

char* func_70(bool bParam0, char* sParam1, char* sParam2)//Position - 0x1956
{
	if (bParam0)
	{
		return sParam1;
...
void func_77(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x1C1E
{
	int iVar0;
	float fVar1;
...
bool func_78(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)//Position - 0x20FD
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

bool func_79(int iParam0)//Position - 0x210D
{
	return (func_133(iParam0) && !func_80(iParam0));
}

int func_80(int iParam0)//Position - 0x2127
{
	switch (iParam0)
	{
		case joaat("coureur"):
...
void func_82(int iParam0)//Position - 0x2263
{
	struct<3> Var0;
...
void func_83(struct<3> Param0)//Position - 0x22EE
{
	struct<4> Var0;
...
var func_84(int iParam0, bool bParam1)//Position - 0x232F
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_85(int iParam0)//Position - 0x2394
{
	int iVar0;
...
int func_87(int iParam0, int iParam1, bool bParam2)//Position - 0x23DF
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_89(int iParam0, var uParam1)//Position - 0x246E
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_90(uParam1));
}

int func_90(var uParam0)//Position - 0x2483
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, var* uParam1)//Position - 0x2BB1
{
	int iVar0;
	int iVar1;
...
int func_96(int iParam0)//Position - 0x2C2E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_97(int iParam0)//Position - 0x2CBB
{
	int iVar0;
...
int func_98(int iParam0, int iParam1)//Position - 0x2D17
{
	func_102();
...
bool func_99(var uParam0, int iParam1, int iParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, int iParam13, int iParam14)//Position - 0x2FC2
{
...
int func_100(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x2FEB
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		return 0;
...
bool func_101(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x8C2E
{
	if (bParam6)
	{
...
int func_103(int iParam0)//Position - 0x8CEE
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
...
int func_104(int iParam0)//Position - 0x8D26
{
	int iVar0;
...
int func_105(int iParam0, var* uParam1)//Position - 0x8D6E
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_106(int iParam0)//Position - 0x8ECB
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return 1;
...
int func_107(int iParam0)//Position - 0x91F2
{
...
int func_108(int iParam0)//Position - 0x921E
{
...
int func_109(int iParam0)//Position - 0x923B
{
...
int func_110(int iParam0, int iParam1)//Position - 0x925E
{
	if (func_11(iParam0))
	{
...
int func_111(int iParam0)//Position - 0x92A2
{
	if (func_11(iParam0))
	{
		if (func_110(iParam0, 0))
...
int func_114(int iParam0, bool bParam1)//Position - 0x92ED
{
	return func_115(iParam0, bParam1, 1);
}

int func_115(int iParam0, bool bParam1, int iParam2)//Position - 0x92FE
{
	int iVar0;
...
int func_116(int iParam0, int iParam1)//Position - 0x935A
{
	if (func_11(iParam0))
	{
...
int func_117(int iParam0, bool bParam1)//Position - 0x93A9
{
	var uVar0;
	int iVar1;
...
int func_120(var uParam0)//Position - 0x942B
{
	int iVar0;
	int iVar1;
...
int func_122(int iParam0)//Position - 0x9465
{
	if (iParam0 != func_63())
	{
...
int func_123(int iParam0)//Position - 0x949A
{
	if (iParam0 != func_63())
	{
...
void func_125(int iParam0, int iParam1)//Position - 0x99E1
{
	int iVar0;
	int iVar1;
...
struct<13> func_130()//Position - 0x9F8C
{
	struct<13> Var0;
...
int func_131(int iParam0)//Position - 0x9FA1
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("deathbike2"):
...
int func_133(int iParam0)//Position - 0xA2C3
{
	switch (iParam0)
	{
		case joaat("deity"):
...
void func_134(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0xA352
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_135(int iParam0, float fParam1)//Position - 0xAA55
{
	struct<3> Var0;
	float fVar3;
...
int func_136(bool bParam0)//Position - 0xAAC6
{
	if (bParam0)
	{
...
int func_138(var uParam0)//Position - 0xAB6F
{
	int iVar0;
...
int func_139(int iParam0)//Position - 0xAB93
{
	int iVar0;
...
var func_140(int iParam0, int iParam1)//Position - 0xABB1
{
...
var func_142(var uParam0, var uParam1)//Position - 0xABDD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_143(int iParam0, var uParam1, var uParam2)//Position - 0xAC00
{
	int iVar0;
	int iVar1;
...
int func_144(int iParam0)//Position - 0xADDA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_146(int iParam0, int iParam1)//Position - 0xAF0B
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_147(int iParam0, int iParam1)//Position - 0xAFF4
{
	int iVar0;
...
int func_148(int iParam0, int iParam1)//Position - 0xB056
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_149(int iParam0, int iParam1, int iParam2)//Position - 0xB435
{
...
int func_150()//Position - 0xB459
{
	return 0;
}

void func_151(int iParam0, int iParam1)//Position - 0xB462
{
	int iVar0;
	int iVar1;
...
int func_152(int iParam0)//Position - 0xB4DA
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_154(int iParam0)//Position - 0xB50B
{
	int iVar0;
...
int func_155(int iParam0)//Position - 0xB550
{
...
int func_156(int iParam0)//Position - 0xB570
{
	switch (iParam0)
	{
		case 161:
...
int func_158(int iParam0)//Position - 0xB673
{
...
int func_159(int iParam0, int iParam1)//Position - 0xB6FA
{
	int iVar0;
...
int func_160(int iParam0)//Position - 0xB747
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_165(int iParam0, var uParam1, bool bParam2, int iParam3)//Position - 0xB974
{
	struct<9> Var0;
	int iVar13;
	bool bVar14;
...
void func_166(int iParam0, int iParam1, int iParam2)//Position - 0xBADD
{
	switch (iParam1)
	{
...
void func_294(var uParam0, struct<3> Param1, struct<3> Param4, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x344F6
{
...
void func_295(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x34526
{
	uParam0->f_1 = uParam1;
	uParam0->f_2 = uParam3;
