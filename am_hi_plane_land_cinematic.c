...
void func_287()//Position - 0x33815
{
	...
	func_288(&uLocal_95, 3967.4226f, -4685.0845f, 11.7691f, -1.6326f, 0.4627f, -70.7491f, "HS4_NIMB_LSA_ISD_REPEAT", 1, 1, 3, 0);
}

void func_288(var uParam0, struct<3> Param1, struct<3> Param4, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x3385F
{
...
void func_289(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x3388F
{
	uParam0->f_1 = uParam1;
	uParam0->f_2 = uParam3;
...
void func_290(var uParam0, int iParam1, char* sParam2)//Position - 0x338BC
{
