				...
				case 3:
					...
					else
					{
						...
						if (!func_101(3) && !Global_101567)
						{
							...
							{
								if ((!func_117(uLocal_92, 1) || !ENTITY::DOES_ENTITY_EXIST(func_100())) && !Global_101567)
								{
									func_110(10);
									break;
								}
...
int func_44()//Position - 0x20DD
{
	func_45();
	return Global_113969.f_2366.f_539.f_4321;
}

void func_45()//Position - 0x20F6
{
	int iVar0;
...
bool func_46(bool bParam0)//Position - 0x21F3
{
	return bParam0 < 3;
}

int func_47(int iParam0)//Position - 0x21FF
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0)//Position - 0x223C
{
	if (func_46(iParam0))
	{
...
var func_49(int iParam0)//Position - 0x2261
{
	return Global_2169[iParam0 /*29*/];
}

int func_50(int iParam0)//Position - 0x2270
{
	bool bVar0;
...
int func_51(int iParam0)//Position - 0x2498
{
	int iVar0;
...
int func_52(int iParam0)//Position - 0x2504
{
	return iParam0;
}

void func_53(int iParam0, var uParam1)//Position - 0x250E
{
	int iVar0;
	int iVar1;
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_54(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_92301[26 /*34*/].f_6) == 0)
			{
				Global_113969.f_7264[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_113969.f_7264[iParam0], true, true);
			}
...
bool func_54(int iParam0)//Position - 0x2EA6
{
	struct<7> Var0;
	int iVar7;
...
int func_55(int iParam0)//Position - 0x2EDA
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

var func_56()//Position - 0x2EED
{
	var uVar0;
...
void func_57(var uParam0, int iParam1)//Position - 0x2F33
{
	if (iParam1 <= 0)
	{
		return;
...
void func_58(var uParam0, int iParam1)//Position - 0x2FB9
{
...
void func_59(var uParam0, int iParam1)//Position - 0x2FEC
{
	int iVar0;
	int iVar1;
...
int func_60(int iParam0, int iParam1)//Position - 0x303D
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_61(int iParam0)//Position - 0x30DF
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_62(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_62(bool bParam0, int iParam1, int iParam2)//Position - 0x3101
{
	if (bParam0)
	{
		return iParam1;
...
int func_63(var uParam0)//Position - 0x3118
{
	return uParam0 & 15;
}

void func_64(var uParam0, int iParam1)//Position - 0x3125
{
...
void func_65(var uParam0, int iParam1)//Position - 0x315F
{
...
void func_66(var uParam0, int iParam1)//Position - 0x319A
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
struct<7> func_67(int iParam0)//Position - 0x31D6
{
	struct<7> Var0;
...
int func_69()//Position - 0x5E11
{
	return Global_32949;
}

int func_70()//Position - 0x5E1C
{
	return Global_32948;
}

void func_71(int iParam0)//Position - 0x5E27
{
	if (iParam0 == 2)
	{
	}
...
Vector3 func_73(int iParam0)//Position - 0x5EA9
{
	switch (iParam0)
	{
		case 1:
...
int func_74()//Position - 0x5EEB
{
	return 1;
}

int func_75(int iParam0, bool bParam1)//Position - 0x5EF4
{
	int iVar0;
...
int func_76(int iParam0)//Position - 0x5FAC
{
	int iVar0;
...
void func_77(int iParam0)//Position - 0x5FE7
{
	int iVar0;
...
void func_78(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x603E
{
	int iVar0;
...
int func_79(var uParam0)//Position - 0x6169
{
	return 1;
}

int func_80(var uParam0, struct<3> Param1, struct<3> Param4, int iParam7)//Position - 0x6172
{
	int iVar0;
	var uVar1;
	var uVar4;
...
var func_81()//Position - 0x6216
{
	return Global_76498;
}

int func_82(int iParam0)//Position - 0x6222
{
	if (iParam0 == 1)
	{
...
var func_83(int iParam0, int iParam1)//Position - 0x6279
{
	switch (iParam0)
	{
		case 5:
...
bool func_84()//Position - 0x62B1
{
	return MISC::GET_GAME_TIMER() <= Global_23831.f_6481 + 100;
}

int func_85()//Position - 0x62C6
{
...
bool func_86(bool bParam0)//Position - 0x62E0
{
	if (bParam0)
	{
...
void func_87(var uParam0, int iParam1)//Position - 0x6309
{
	func_88(uParam0, iParam1);
}

void func_88(var uParam0, var uParam1)//Position - 0x6319
{
	*uParam0 = (*uParam0 || uParam1);
}

int func_89()//Position - 0x632A
{
	if (func_103(6) || func_103(7))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
int func_91(int iParam0)//Position - 0x6466
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_98()) || Global_113016) || Global_32951) || func_97()) || func_83(8, -1)) || func_96()) || func_95()) || func_94()) || func_85()) || Global_113969.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_98()) || Global_32951) || func_97()) || func_83(8, -1)) || func_94()) || func_96()) || func_95()) || func_85()) || Global_113969.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_98()) || Global_113016) || Global_32951) || func_97()) || func_83(8, -1)) || func_94()) || func_96()) || func_95()) || func_85()) || Global_113969.f_7691.f_919[iVar0] == 5) || Global_44589 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_98()) || Global_113016) || Global_32951) || func_97()) || func_83(8, -1)) || func_96()) || func_95()) || func_85()) || Global_113969.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_98() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_83(8, -1)) || func_85()) || func_93()) || Global_113969.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_98()) || Global_32951) || func_97()) || func_83(8, -1)) || func_95()) || func_94()) || func_85()) || Global_113969.f_7691.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_98()) || func_95()) || Global_113016) || Global_32951) || func_97()) || Global_45250) || func_83(8, -1)) || func_94()) || func_93()) || func_85()) || Global_113969.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_98()) || Global_113016) || Global_32951) || func_97()) || func_83(8, -1)) || func_94()) || func_93()) || func_96()) || func_95()) || func_85())
						{
							return 0;
						}
						break;
...
var func_92()//Position - 0x6B83
{
	return Global_101572.f_1;
}

int func_93()//Position - 0x6B91
{
	if (Global_98435 != -1)
	{
...
bool func_95()//Position - 0x6BDE
{
	return Global_101585.f_394 > 0;
}

bool func_96()//Position - 0x6BEF
{
	return Global_101585.f_393 > 0;
}

var func_97()//Position - 0x6C00
{
	return Global_1575083;
}

int func_98()//Position - 0x6C0C
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_100()//Position - 0x6C42
{
	return Global_97345;
}

int func_101(int iParam0)//Position - 0x6C4E
{
	switch (iParam0)
	{
		case 0:
...
bool func_102(int iParam0)//Position - 0x6CC0
{
	int iVar0;
...
bool func_103(int iParam0)//Position - 0x6CFC
{
	return Global_44042 == iParam0;
}

void func_104()//Position - 0x6D0A
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	...
	if (bLocal_144)
	{
		...
		if ((fVar6 > 45f || Global_113931) && !ENTITY::DOES_ENTITY_EXIST(iLocal_141))
		{
			if (Global_113931)
			{
				Global_113931 = 0;
...
float func_105(bool bParam0, float fParam1, float fParam2)//Position - 0x6EF4
{
	if (bParam0)
	{
		return fParam1;
...
Vector3 func_106(bool bParam0, struct<3> Param1, struct<3> Param4)//Position - 0x6F0B
{
	if (bParam0)
	{
		return Param1;
...
void func_109(var uParam0, int iParam1)//Position - 0x705E
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_110(int iParam0)//Position - 0x706F
{
	iLocal_93 = iParam0;
}

void func_111(int iParam0, bool bParam1, bool bParam2)//Position - 0x707B
{
	int iVar0;
	int iVar1;
...
int func_114(int iParam0, int iParam1)//Position - 0x71BB
{
	int iVar0;
...
bool func_115(int iParam0)//Position - 0x7205
{
	return func_116(iParam0, Global_44042);
}

int func_116(int iParam0, int iParam1)//Position - 0x7216
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_117(var uParam0, int iParam1)//Position - 0x73F7
{
	return (uParam0 && iParam1) != 0;
}

void func_118()//Position - 0x7406
{
	bool bVar0;
...
void func_119(var uParam0, int iParam1)//Position - 0x749D
{
	func_120(uParam0, iParam1);
}

void func_120(var uParam0, var uParam1)//Position - 0x74AD
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_121(bool bParam0)//Position - 0x74C2
{
	if (bParam0)
	{
		if (iLocal_103 != 263)
...
void func_124(int iParam0)//Position - 0x755D
{
	if (iParam0 != 263)
	{
