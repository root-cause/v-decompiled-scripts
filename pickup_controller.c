...
void func_14()//Position - 0x5B6
{
	switch (Global_32408)
	{
		...
		case 1:
			...
			{
				case 0:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_20[Global_32410]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_20[Global_32410]))
					{
						Global_32411 = 0;
					}
					else
				...
				case 1:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_86[Global_32410]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_86[Global_32410]))
					{
						Global_32411 = 0;
					}
					else
				...
				case 2:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_163[Global_32410]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_163[Global_32410]))
					{
						Global_32411 = 0;
					}
					else
