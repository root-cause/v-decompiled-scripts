		...
		case 1:
			if (iLocal_121 < MISC::GET_GAME_TIMER())
			{
				if (!PED::IS_PED_INJURED(iLocal_89[0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_92, false))
				{
					...
					TASK::TASK_ENTER_VEHICLE(0, iLocal_92, -1, -1, 1f, 1, 0);
				...
				if (iLocal_121 < MISC::GET_GAME_TIMER())
				{
					...
					if (func_67(&uLocal_171, "REDR2AU", "REDR2_DRV", 4, 0, 0, 0))
					{
						if ((!PED::IS_PED_INJURED(iLocal_89[0]) && !PED::IS_PED_INJURED(iLocal_89[1])) && ENTITY::DOES_ENTITY_EXIST(iLocal_92))
						{
							...
							TASK::TASK_ENTER_VEHICLE(0, iLocal_92, -1, 0, 1f, 1, 0);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_97);
							TASK::TASK_PERFORM_SEQUENCE(iLocal_89[1], iLocal_97);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_97);
							iLocal_61 = 0;
							...
							if (!func_4())
							{
								if (func_67(&uLocal_171, "REDR1AU", "REDR1_PLS", 4, 0, 0, 0))
								{
									...
									if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_92, false))
									{
										...
										if (!PED::IS_PED_INJURED(iLocal_89[0]))
										{
											TASK::TASK_ENTER_VEHICLE(iLocal_89[0], iLocal_92, -1, 0, 1f, 1, 0);
										}
									}
									iLocal_168++;
								}
			...
			if (iLocal_52 == 1)
			{
				...
				switch (iLocal_62)
				{
					...
					case 5:
						...
						if (!PED::IS_PED_INJURED(iLocal_89[0]))
						{
							if (ENTITY::IS_ENTITY_AT_COORD(iLocal_89[0], Local_79, Global_22, true, true, 0))
							{
				...
				switch (iLocal_62)
				{
					...
					case 1:
						if (!PED::IS_PED_INJURED(iLocal_89[0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_92, false))
						{
							...
							TASK::TASK_ENTER_VEHICLE(iLocal_89[0], iLocal_92, 30000, 2, 2f, 1, 0);
						}
						SYSTEM::SETTIMERA(0);
						iLocal_62++;
						break;
					...
					case 2:
						if (!PED::IS_PED_INJURED(iLocal_89[1]) && !ENTITY::IS_ENTITY_DEAD(iLocal_92, false))
						{
							...
							TASK::TASK_ENTER_VEHICLE(0, iLocal_92, 30000, 1, 2f, 1, 0);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_97);
							TASK::TASK_PERFORM_SEQUENCE(iLocal_89[1], iLocal_97);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_97);
						}
					...
					case 5:
						...
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_92, false))
						{
							...
							{
								if (ENTITY::IS_ENTITY_AT_COORD(iLocal_89[0], Local_79, Global_22, true, true, 0) && ENTITY::IS_ENTITY_AT_COORD(iLocal_89[1], Local_79, Global_22, false, true, 0))
								{
									iLocal_62++;
								}
							}
...
char* func_83(bool bParam0)//Position - 0x56AF
{
	switch (bParam0)
	{
		case 0:
...
int func_86(int iParam0, var uParam1)//Position - 0x57E0
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_87(uParam1));
}

int func_87(var uParam0)//Position - 0x57F5
{
	int iVar0;
	int iVar1;
...
int func_89(int iParam0)//Position - 0x5849
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_91(int iParam0, int iParam1)//Position - 0x5A18
{
	if (iParam1 == -1)
	{
		iParam1 = func_47();
...
int func_95(var uParam0, int iParam1)//Position - 0x5BA3
{
	int iVar0;
	var uVar1[78];
...
void func_100(var uParam0, float fParam1)//Position - 0x5D24
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
int func_105(int iParam0)//Position - 0x5D9A
{
	switch (iParam0)
	{
		case 60:
...
void func_106(int iParam0, int iParam1)//Position - 0x5DEA
{
	int iVar0;
...
int func_109(int iParam0)//Position - 0x5EDF
{
...
int func_112(int iParam0)//Position - 0x6785
{
...
void func_114(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x6801
{
	if (bParam0)
	{
...
bool func_116(int iParam0, int iParam1)//Position - 0x6968
{
	bool bVar0;
...
int func_118(var uParam0)//Position - 0x6A02
{
	int iVar0;
...
int func_119(int iParam0)//Position - 0x6A24
{
...
int func_121(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x6A71
{
	int iVar0;
...
int func_126(bool bParam0, bool bParam1, bool bParam2)//Position - 0x7110
{
	int iVar0;
...
int func_132(int iParam0)//Position - 0x7ACF
{
	int iVar0;
	int iVar1;
...
int func_134(struct<3> Param0)//Position - 0x7B9A
{
	if (func_22() == 2)
	{
...
void func_137(struct<3> Param0, int iParam3)//Position - 0x7E73
{
	struct<3> Var0;
	struct<3> Var3;
...
Vector3 func_138(struct<3> Param0, int iParam3)//Position - 0x8058
{
	struct<3> Var0;
...
void func_143(char* sParam0, int iParam1)//Position - 0x887A
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_144(struct<3> Param0, bool bParam3)//Position - 0x8891
{
	int iVar0;
...
float func_145(bool bParam0, float fParam1, float fParam2)//Position - 0x88BD
{
	if (bParam0)
	{
		return fParam1;
...
float func_147(int iParam0, int iParam1, bool bParam2)//Position - 0x89F8
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_149(int iParam0, var uParam1)//Position - 0x8A72
{
	switch (*uParam1)
	{
		case 0:
...
int func_152(int iParam0, bool bParam1, bool bParam2)//Position - 0x8D07
{
	return func_153(iParam0, !bParam1, bParam2);
}

int func_153(int iParam0, bool bParam1, bool bParam2)//Position - 0x8D1A
{
	int iVar0;
...
int func_159(int iParam0)//Position - 0x8EDA
{
	if (func_162())
	{
		Global_113800 = 1;
		...
		if (iParam0 && func_49(Global_113799))
		{
...
bool func_165(int iParam0)//Position - 0x9206
{
	return func_166(iParam0, Global_43377);
}

int func_166(int iParam0, int iParam1)//Position - 0x9217
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_167(int iParam0)//Position - 0x93F8
{
	if (Global_43377 == 15)
	{
		return 0;
...
int func_169(int iParam0, bool bParam1, int iParam2)//Position - 0x946D
{
	int iVar0;
...
void func_174()//Position - 0x971A
{
	if (!iLocal_59)
	{
		...
		PED::ADD_SCENARIO_BLOCKING_AREA(Local_66 - Vector(8f, 8f, 8f), Local_66 + Vector(8f, 8f, 8f), false, true, true, true);
		...
		if (iLocal_52 == 2)
		{
			PED::ADD_SCENARIO_BLOCKING_AREA(Local_79 - Vector(10f, 50f, 30f), Local_79 + Vector(10f, 50f, 30f), false, true, true, true);
...
void func_175(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x9BF8
{
...
int func_180(int iParam0, int iParam1, bool bParam2)//Position - 0xA152
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_200(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xC112
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
bool func_201(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xC4AC
{
	if (bParam6)
	{
...
bool func_202(int iParam0)//Position - 0xC4F3
{
	int iVar0;
...
int func_203(int iParam0)//Position - 0xC514
{
...
int func_214(bool bParam0, int iParam1, int iParam2)//Position - 0xC8E6
{
	if (bParam0)
	{
		return iParam1;
...
int func_216(int iParam0, int iParam1)//Position - 0xC90A
{
	int iVar0;
	int iVar1;
...
int func_224(int iParam0)//Position - 0xCC17
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_225(int iParam0, bool bParam1)//Position - 0xCCF3
{
...
int func_226(int iParam0)//Position - 0xCD13
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_234()) || Global_112857) || Global_32286) || func_233()) || func_30(8, -1)) || func_232()) || func_231()) || func_230()) || func_229()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_234()) || Global_32286) || func_233()) || func_30(8, -1)) || func_230()) || func_232()) || func_231()) || func_229()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_234()) || Global_112857) || Global_32286) || func_233()) || func_30(8, -1)) || func_230()) || func_232()) || func_231()) || func_229()) || Global_113810.f_7691.f_919[iVar0] == 5) || Global_43924 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_234()) || Global_112857) || Global_32286) || func_233()) || func_30(8, -1)) || func_232()) || func_231()) || func_229()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_234() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_30(8, -1)) || func_229()) || func_228()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_234()) || Global_32286) || func_233()) || func_30(8, -1)) || func_231()) || func_230()) || func_229()) || Global_113810.f_7691.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_227()//Position - 0xD430
{
	return Global_100872.f_1;
}

int func_228()//Position - 0xD43E
{
	if (Global_97735 != -1)
	{
...
var func_233()//Position - 0xD4C7
{
	return Global_1575063;
}

int func_234()//Position - 0xD4D3
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_237(int iParam0, int iParam1, int iParam2)//Position - 0xD529
{
	int iVar0;
	int iVar1;
...
int func_238(int iParam0)//Position - 0xD60D
{
	if (!func_24(iParam0))
	{
		return 7;
...
int func_239(int iParam0)//Position - 0xD631
{
	int iVar0;
	int iVar1;
...
void func_243(int iParam0)//Position - 0xDA19
{
	...
	if (func_196())
	{
		...
		func_246(30000);
		StringCopy(&cVar0, func_245(Global_113799, 1), 64);
...
int func_254(int iParam0, int iParam1, int iParam2)//Position - 0xE1EB
{
	var uVar0;
	char* sVar1;
...
void func_255(int iParam0, int iParam1)//Position - 0xE22B
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_256(iParam0, &(Global_113810.f_32752.f_5510));
}

void func_256(int iParam0, var uParam1)//Position - 0xE42D
{
	int iVar0;
...
int func_258(int iParam0, var uParam1, var uParam2)//Position - 0xE788
{
	int iVar0;
	int iVar1;
...
int func_259(int iParam0)//Position - 0xE97B
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_261(int iParam0)//Position - 0xEA4A
{
...
int func_262(int iParam0)//Position - 0xEB27
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_263(int iParam0, bool bParam1, int iParam2)//Position - 0xECD9
{
	int iVar0;
	struct<2> Var1;
...
int func_264(int iParam0)//Position - 0xEE5B
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_266(int iParam0, int iParam1)//Position - 0xEF3E
{
	int iVar0;
	int iVar1;
...
int func_267(bool bParam0)//Position - 0x14118
{
	if (bParam0)
	{
...
bool func_268()//Position - 0x14132
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_269()//Position - 0x14148
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_270()//Position - 0x1415E
{
	return 0;
}

int func_271()//Position - 0x14167
{
	return 1;
}

int func_272()//Position - 0x14170
{
	return 1;
}

int func_273()//Position - 0x14179
{
...
int func_274(int iParam0)//Position - 0x14192
{
	int iVar0;
	char* sVar1;
...
int func_275(int iParam0)//Position - 0x141D9
{
	int iVar0;
...
int func_276(int iParam0)//Position - 0x14214
{
	int iVar0;
...
int func_277(int iParam0)//Position - 0x14290
{
	int iVar0;
...
int func_278(int iParam0)//Position - 0x14378
{
	int iVar0;
...
int func_279(int iParam0, int iParam1, bool bParam2)//Position - 0x143DB
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_280(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x14449
{
