...
void func_1(var uParam0)//Position - 0xB3
{
	char* sVar0;
	char* sVar1;
	struct<3> Var2;
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			...
			{
				if ((((((((((((func_55(uParam0) || func_51(uParam0)) || func_50(uParam0)) || !func_49(uParam0)) || func_47(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) || BitTest(Global_1946250.f_4, 2)) || func_46(uParam0->f_16[uParam0->f_9 /*14*/].f_13))
				{
				...
				else
				{
					...
					if (uParam0->f_6 == -1)
					{
						...
						{
							if (func_41(uParam0->f_9) && !Global_262145.f_27059 /* Tunable: VC_PENTHOUSE_DISABLE_DCTL */)
							{
		...
		case 4:
			...
			Var2 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_31(uParam0), func_30(uParam0), 0f, 2) };
			Var3 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_31(uParam0), func_30(uParam0), 0f, 2) };
			fVar4 = Var3.f_2;
			fVar5 = 0.05f;
...
void func_2(var uParam0, bool bParam1)//Position - 0x6FF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_3(var uParam0)//Position - 0x81E
{
	int iVar0;
...
bool func_4()//Position - 0x8A5
{
	return func_5(PLAYER::PLAYER_ID());
}

int func_5(int iParam0)//Position - 0x8B5
{
...
int func_6(int iParam0)//Position - 0x8D4
{
	switch (iParam0)
	{
		case 0:
...
int func_7(bool bParam0, int iParam1, int iParam2)//Position - 0x915
{
	if (bParam0)
	{
		return iParam1;
...
void func_8(var uParam0)//Position - 0x92C
{
	struct<3> Var0;
	float fVar1;
	int iVar2;
...
int func_9(bool bParam0)//Position - 0xB40
{
...
int func_10(int iParam0)//Position - 0xC2B
{
	int iVar0;
...
bool func_12(var uParam0)//Position - 0xCA2
{
	return func_33(&(uParam0->f_7), 9);
}

void func_13(var uParam0)//Position - 0xCB4
{
	char* sVar0;
	char* sVar1;
...
void func_14(var uParam0)//Position - 0xD67
{
	char* sVar0;
...
var func_15()//Position - 0xDD1
{
	return BitTest(Global_1946250.f_3, 25);
}

int func_16(float fParam0, float fParam1, float fParam2)//Position - 0xDE2
{
	float fVar0;
	float fVar1;
...
void func_17(var uParam0)//Position - 0xE68
{
	int iVar0;
...
void func_18()//Position - 0xEFC
{
	Global_23011.f_6 = 1;
}

void func_19(bool bParam0)//Position - 0xF0A
{
	if (bParam0)
	{
		if (func_20())
...
bool func_20()//Position - 0xF2F
{
	return BitTest(Global_2714762.f_2, 11);
}

void func_21()//Position - 0xF40
{
	MISC::SET_BIT(&Global_8137, 4);
}

void func_22(int iParam0)//Position - 0xF50
{
	if (func_28())
	{
		return;
...
void func_23(int iParam0)//Position - 0xF83
{
	if (func_28())
	{
		return;
...
void func_25(bool bParam0, bool bParam1)//Position - 0x1034
{
	if (bParam0)
	{
		if (func_27(0))
...
bool func_26()//Position - 0x10A8
{
	return BitTest(Global_1958711, 5);
}

int func_27(int iParam0)//Position - 0x10B6
{
	if (iParam0 == 1)
	{
...
bool func_28()//Position - 0x110D
{
	return BitTest(Global_1958711, 19);
}

void func_29(int iParam0)//Position - 0x111C
{
	Global_2725432 = iParam0;
	Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_827 = iParam0;
}

Vector3 func_30(var uParam0)//Position - 0x113A
{
	struct<3> Var0;
...
Vector3 func_31(var uParam0)//Position - 0x1176
{
	return uParam0->f_16[uParam0->f_9 /*14*/];
}

void func_32(int* iParam0, int iParam1)//Position - 0x118A
{
	MISC::SET_BIT(iParam0, iParam1);
}

bool func_33(var uParam0, int iParam1)//Position - 0x119A
{
	return BitTest(*uParam0, iParam1);
}

void func_34(var uParam0, char* sParam1)//Position - 0x11A8
{
	if (uParam0->f_1.f_1 == 1)
	{
		if (func_4())
...
void func_35(var uParam0, char* sParam1)//Position - 0x14DA
{
...
void func_36(int iParam0)//Position - 0x1764
{
	int iVar0;
	...
	while (iVar0 < 3)
	{
		if (Global_2359296[func_37() /*5567*/].f_681.f_4241[iVar0 /*3*/] == iParam0)
		{
...
void func_38(var uParam0)//Position - 0x17D4
{
...
int func_39(var uParam0)//Position - 0x180C
{
	int iVar0;
...
int func_40(int iParam0)//Position - 0x18A4
{
	switch (iParam0)
	{
		case 1:
...
int func_41(int iParam0)//Position - 0x18DC
{
	switch (iParam0)
	{
		case 2:
...
void func_42(var uParam0)//Position - 0x191A
{
	if (uParam0->f_6 != -1)
	{
		func_43(&(uParam0->f_6));
...
void func_43(var uParam0)//Position - 0x193C
{
	int iVar0;
...
int func_44(int iParam0)//Position - 0x1993
{
	int iVar0;
...
void func_45(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x19CE
{
	int iVar0;
...
int func_46(int iParam0)//Position - 0x1AF9
{
	if (iParam0 != 4)
	{
		return 0;
...
bool func_47(int iParam0)//Position - 0x1B12
{
	return func_48(iParam0) == joaat("WEAPON_MINIGUN");
}

int func_48(int iParam0)//Position - 0x1B26
{
	return Global_1892703[iParam0 /*599*/].f_579;
}

bool func_49(var uParam0)//Position - 0x1B3A
{
...
int func_50(var uParam0)//Position - 0x1B64
{
	var uVar0[10];
	int iVar1;
...
int func_51(var uParam0)//Position - 0x1BDB
{
	int iVar0;
	int iVar1;
...
int func_53()//Position - 0x1C76
{
	return -1;
}

int func_54(int iParam0, bool bParam1, bool bParam2)//Position - 0x1C7F
{
	int iVar0;
...
bool func_55(var uParam0)//Position - 0x1CDF
{
	return uParam0->f_7 & 31 > 0;
}

int func_56(int iParam0, struct<3> Param1, int iParam2)//Position - 0x1CF0
{
...
void func_59(var uParam0, int iParam1)//Position - 0x1DE0
{
	uParam0->f_13 = iParam1;
}

void func_60(int* iParam0, int iParam1)//Position - 0x1DEE
{
	MISC::CLEAR_BIT(iParam0, iParam1);
}

void func_61(var uParam0)//Position - 0x1DFE
{
	if (uParam0->f_13 == 6)
	{
	}
...
float func_62()//Position - 0x1E51
{
	return 0.13f;
}

void func_63(var uParam0)//Position - 0x1E5E
{
...
void func_64(int* iParam0, int iParam1, bool bParam2)//Position - 0x1EB6
{
	int iVar0;
...
bool func_65()//Position - 0x1EDA
{
	return Global_75485;
}

int func_66()//Position - 0x1EE6
{
...
int func_68()//Position - 0x1F4E
{
	return Global_1574632.f_18;
}

int func_69()//Position - 0x1F5C
{
	if (Global_1575033 == 0)
	{
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_72()//Position - 0x2037
{
	return Global_31959;
}

bool func_73()//Position - 0x2042
{
	return Global_2714762.f_698;
}

int func_74(int iParam0)//Position - 0x2051
{
...
bool func_75()//Position - 0x2068
{
	return Global_2725403;
}

bool func_76()//Position - 0x2074
{
	return Global_2714762.f_693;
}

int func_77(int iParam0)//Position - 0x2083
{
...
int func_78(int iParam0)//Position - 0x20BC
{
	if (iParam0 != func_53() && func_54(iParam0, 1, 1))
	{
...
int func_79(int iParam0)//Position - 0x20ED
{
	if (iParam0 != func_53() && func_54(iParam0, 1, 1))
	{
...
int func_80(int iParam0)//Position - 0x211E
{
	if (iParam0 != func_53())
	{
		if (func_54(iParam0, 1, 1))
		{
			...
			{
				return func_81(Global_2689235[iParam0 /*453*/].f_318.f_6) == 14;
			}
		}
	}
	return 0;
...
int func_81(int iParam0)//Position - 0x2165
{
	switch (iParam0)
	{
		case 0:
...
void func_83()//Position - 0x25FE
{
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_84(var uParam0)//Position - 0x260A
{
	int iVar0;
...
void func_85(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2669
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool func_86(int iParam0)//Position - 0x2AF7
{
	return iParam0 == 17;
}

void func_87()//Position - 0x2B04
{
	struct<3> Var0;
...
int func_89(int iParam0)//Position - 0x2B8F
{
	int iVar0;
...
void func_90(bool bParam0, int iParam1, int iParam2)//Position - 0x2BC0
{
	int iVar0;
	int iVar1;
...
void func_91(int iParam0, bool bParam1)//Position - 0x2C90
{
	int iVar0;
...
bool func_93()//Position - 0x2D04
{
	return BitTest(Global_2621446, 3);
}

bool func_94(int iParam0, int iParam1)//Position - 0x2D12
{
	bool bVar0;
...
int func_95(int iParam0, bool bParam1)//Position - 0x2D5D
{
	int iVar0;
	int iVar1;
...
int func_96()//Position - 0x2D9E
{
	return Global_1574918;
}

int func_97()//Position - 0x2DAA
{
...
void func_99()//Position - 0x2E09
{
	func_100(0, &uLocal_109, 0, 1);
	func_100(1, &uLocal_109, 1, 1);
	func_100(2, &uLocal_109, 2, 1);
	func_100(3, &uLocal_109, 3, 1);
	func_100(4, &uLocal_109, 4, 1);
	func_100(5, &uLocal_109, 5, 1);
	func_100(6, &uLocal_109, 6, 1);
	func_100(7, &uLocal_109, 7, 1);
	func_100(8, &uLocal_109, 8, 1);
	func_100(9, &uLocal_109, 9, 1);
	func_100(10, &uLocal_109, 10, 1);
	func_100(11, &uLocal_109, 11, 1);
	func_100(12, &uLocal_109, 12, 1);
	func_100(13, &uLocal_109, 13, 1);
	func_100(14, &uLocal_109, 14, 1);
	func_100(15, &uLocal_109, 15, 1);
	func_100(16, &uLocal_109, 16, 1);
	func_100(17, &uLocal_109, 17, 1);
	func_100(18, &uLocal_109, 18, 1);
	func_100(19, &uLocal_109, 19, 1);
	func_100(20, &uLocal_109, 20, 1);
	func_100(21, &uLocal_109, 21, 1);
	func_100(22, &uLocal_109, 22, 1);
	func_100(23, &uLocal_109, 23, 1);
	func_100(24, &uLocal_109, 24, 1);
	func_100(25, &uLocal_109, 25, 1);
	func_100(26, &uLocal_109, 26, 1);
	func_100(27, &uLocal_109, 27, 1);
	func_100(28, &uLocal_109, 28, 1);
	func_100(29, &uLocal_109, 29, 1);
	func_100(30, &uLocal_109, 30, 1);
}

void func_100(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2F56
{
	struct<3> Var0;
	float fVar1;
...
Vector3 func_101()//Position - 0x2FE7
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_102(struct<3> Param0, float fParam1)//Position - 0x2FFA
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
float func_103(int iParam0, float fParam1)//Position - 0x303E
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_104()//Position - 0x3077
{
	return -0.5f, -0.5f, 0f;
}

void func_105(int iParam0, var uParam1, var uParam2)//Position - 0x308A
{
	if (func_4())
	{
		switch (iParam0)
...
void func_106()//Position - 0x3962
{
}

int func_107(int iParam0, int iParam1, bool bParam2)//Position - 0x396A
{
	int iVar0;
...
bool func_108(bool bParam0)//Position - 0x3A80
{
	if (bParam0)
	{
	}
