...
void func_1(var uParam0)//Position - 0xB3
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			...
			{
				if ((((((((((((func_55(uParam0) || func_51(uParam0)) || func_50(uParam0)) || !func_49(uParam0)) || func_47(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) || BitTest(Global_1950844.f_4, 2)) || func_46(uParam0->f_16[uParam0->f_9 /*14*/].f_13))
				{
				...
				else
				{
					...
					if (uParam0->f_6 == -1)
					{
						...
						{
							if (func_41(uParam0->f_9) && !Global_262145.f_27257 /* Tunable: VC_PENTHOUSE_DISABLE_DCTL */)
							{
...
int func_56(int iParam0, struct<3> Param1, int iParam4)//Position - 0x1CF0
{
...
int func_80(int iParam0)//Position - 0x211E
{
	if (iParam0 != func_53())
	{
		if (func_54(iParam0, 1, 1))
		{
			...
			{
				return func_81(Global_2657704[iParam0 /*463*/].f_321.f_7) == 14;
			}
		}
	}
	return 0;
...
void func_82()//Position - 0x2619
{
	func_84(&uLocal_112);
	func_83();
}

void func_83()//Position - 0x262B
{
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_84(var uParam0)//Position - 0x2637
{
	int iVar0;
...
void func_85(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2696
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || ((!func_95(PLAYER::PLAYER_ID(), 0) && !func_94()) && !func_93(PLAYER::PLAYER_ID())))
				{
			...
			else
			{
				if (!func_89(iVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar27))
				{
					...
					if (func_86(Global_4718592.f_171044))
					{
...
bool func_86(int iParam0)//Position - 0x2B32
{
	return iParam0 == 17;
}

void func_87()//Position - 0x2B3F
{
	struct<3> Var0;
...
int func_89(int iParam0)//Position - 0x2BCA
{
	int iVar0;
...
void func_90(bool bParam0, int iParam1, int iParam2)//Position - 0x2BFB
{
	int iVar0;
	int iVar1;
...
void func_91(int iParam0, bool bParam1)//Position - 0x2CCB
{
	int iVar0;
...
int func_93(int iParam0)//Position - 0x2D3F
{
...
bool func_94()//Position - 0x2D7E
{
	return BitTest(Global_2621446, 3);
}

bool func_95(int iParam0, int iParam1)//Position - 0x2D8C
{
	bool bVar0;
...
int func_96(int iParam0, bool bParam1)//Position - 0x2DE5
{
	int iVar0;
	int iVar1;
...
int func_97()//Position - 0x2E26
{
	return Global_1574918;
}

int func_98(var uParam0)//Position - 0x2E32
{
	int iVar0;
...
void func_101()//Position - 0x2EB3
{
	func_102(0, &uLocal_112, 0, 1);
	func_102(1, &uLocal_112, 1, 1);
	func_102(2, &uLocal_112, 2, 1);
	func_102(3, &uLocal_112, 3, 1);
	func_102(4, &uLocal_112, 4, 1);
	func_102(5, &uLocal_112, 5, 1);
	func_102(6, &uLocal_112, 6, 1);
	func_102(7, &uLocal_112, 7, 1);
	func_102(8, &uLocal_112, 8, 1);
	func_102(9, &uLocal_112, 9, 1);
	func_102(10, &uLocal_112, 10, 1);
	func_102(11, &uLocal_112, 11, 1);
	func_102(12, &uLocal_112, 12, 1);
	func_102(13, &uLocal_112, 13, 1);
	func_102(14, &uLocal_112, 14, 1);
	func_102(15, &uLocal_112, 15, 1);
	func_102(16, &uLocal_112, 16, 1);
	func_102(17, &uLocal_112, 17, 1);
	func_102(18, &uLocal_112, 18, 1);
	func_102(19, &uLocal_112, 19, 1);
	func_102(20, &uLocal_112, 20, 1);
	func_102(21, &uLocal_112, 21, 1);
	func_102(22, &uLocal_112, 22, 1);
	func_102(23, &uLocal_112, 23, 1);
	func_102(24, &uLocal_112, 24, 1);
	func_102(25, &uLocal_112, 25, 1);
	func_102(26, &uLocal_112, 26, 1);
	func_102(27, &uLocal_112, 27, 1);
	func_102(28, &uLocal_112, 28, 1);
	func_102(29, &uLocal_112, 29, 1);
	func_102(30, &uLocal_112, 30, 1);
}

void func_102(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3000
{
	struct<3> Var0;
	float fVar3;
...
Vector3 func_103()//Position - 0x3091
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_104(struct<3> Param0, float fParam3)//Position - 0x30A4
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
float func_105(int iParam0, float fParam1)//Position - 0x30E8
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_106()//Position - 0x3121
{
	return -0.5f, -0.5f, 0f;
}

void func_107(int iParam0, var uParam1, var uParam2)//Position - 0x3134
{
	if (func_4())
	{
		switch (iParam0)
...
void func_108()//Position - 0x3A0C
{
}

int func_109(int iParam0, int iParam1, bool bParam2)//Position - 0x3A14
{
	int iVar0;
...
bool func_110(bool bParam0)//Position - 0x3B2A
{
	if (bParam0)
	{
	}
