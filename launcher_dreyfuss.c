...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		func_203(Var0.f_0);
		func_196(&iLocal_56, &(Var0.f_9), Var1);
		if (Var0.f_0 == 8)
		{
			func_192(&Var0, Var1, "DREY1AU", "DREY1_IDLE", 3, "DREYFUSS", 5000, 1101004800);
		}
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5C9D
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x6460
{
	if (bParam2)
	{
...
int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6927
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_84(struct<3> Param0, float fParam1)//Position - 0x75E4
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
float func_176(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xBC23
{
	struct<3> Var0;
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xCE12
{
	var uVar0;
	
	if ((((func_132(PLAYER::PLAYER_PED_ID()) && func_132(iParam0->f_28[0])) && !func_151()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_176(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_219(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE2FE
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
float func_223(struct<3> Param0, struct<3> Param1)//Position - 0xE5CA
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_231(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xE948
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_244(var uParam0)//Position - 0xED00
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			{
				func_253(&(uParam0->f_35[0]), iVar0[1], Local_54, fLocal_55);
				if (func_132(uParam0->f_35[0]))
				{
...
void func_253(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x132B8
{
	func_254(iParam0);
...
int func_255(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0x13396
{
...
int func_256(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0x133F2
{
	int iVar0;
...
int func_271(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x1395F
{
	int iVar0;
...
int func_272(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0x139C4
{
	int iVar0;
	struct<7> Var1;
...
int func_273(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x13A3C
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
