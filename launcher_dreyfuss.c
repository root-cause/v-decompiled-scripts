...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113222[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_299(&(Global_113222[Var0.f_0 /*10*/].f_9));
			}
		}
		func_281(&Var0, 1);
	}
	iVar64[0] = 8;
	if (!func_278(&iVar64, &Var0, Var61, 1f))
	{
		func_277();
	...
	while (true)
	{
		...
		func_210(Var0.f_0);
		func_203(&iLocal_96, &(Var0.f_9), Var61);
		if (Var0.f_0 == 8)
		{
			func_199(&Var0, Var61, "DREY1AU", "DREY1_IDLE", 3, "DREYFUSS", 5000, 1101004800);
		}
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5DE9
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x65AC
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x65F3
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x665E
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6A80
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A90
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x75B6
{
...
Vector3 func_84(struct<3> Param0)//Position - 0x75F8
{
...
int func_86(int iParam0)//Position - 0x7624
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7726
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x77BB
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_93(int iParam0, var uParam1)//Position - 0x845C
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0)//Position - 0x84DE
{
	if (iParam0 != func_95())
	{
...
int func_99(int iParam0)//Position - 0x87F3
{
...
var func_107(int iParam0)//Position - 0x8D49
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8D6B
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8D82
{
	return uParam0 & 15;
}
...
void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x8EE8
{
...
int func_118(bool bParam0)//Position - 0x8F2A
{
...
int func_123(var* uParam0)//Position - 0xA9BD
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAD30
{
...
int func_136(int iParam0)//Position - 0xADE0
{
	if (func_137(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xAE00
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_138(int iParam0)//Position - 0xAE21
{
	switch (iParam0)
	{
		case 5:
...
int func_140(int iParam0)//Position - 0xAEF1
{
	switch (iParam0)
	{
		case 5:
...
void func_141(var uParam0, bool bParam1, bool bParam2)//Position - 0xAF44
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0xB03A
{
	switch (iParam0)
	{
		case 5:
...
void func_144(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB0E4
{
	if (bParam0)
	{
...
int func_148(var uParam0)//Position - 0xB2E7
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xB309
{
...
int func_151(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB356
{
	int iVar0;
...
int func_154(char* sParam0)//Position - 0xB3D3
{
...
int func_160(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB506
{
...
void func_161(int iParam0)//Position - 0xB55D
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_168(int iParam0)//Position - 0xB86A
{
	if (iParam0 == 1)
	{
...
int func_170(int iParam0)//Position - 0xB8D0
{
...
int func_171(int iParam0)//Position - 0xB911
{
	int iVar0;
...
int func_173(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB988
{
	int iVar0;
...
void func_174(var uParam0, int iParam1)//Position - 0xBABF
{
	int iVar0;
...
bool func_175(int iParam0)//Position - 0xBB0E
{
	return func_176(iParam0, Global_44181);
}

int func_176(int iParam0, int iParam1)//Position - 0xBB1F
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_177(int iParam0)//Position - 0xBD00
{
	if (Global_44181 == 15)
	{
		return 0;
...
int func_179(char* sParam0, int iParam1)//Position - 0xBD33
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_181()//Position - 0xBDA0
{
	if (func_184(2))
	{
		if (func_183(PLAYER::PLAYER_PED_ID(), -1459.68f, 485.26f, 116.22f, 1) < 6f && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
			...
			else if ((!func_182(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && func_137(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_160(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 1f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_182(int iParam0, int iParam1)//Position - 0xBE41
{
	if (func_136(iParam0))
	{
...
float func_183(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xBE74
{
	struct<3> Var0;
...
int func_184(int iParam0)//Position - 0xBEAE
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_192()) || Global_113182) || Global_33090) || func_191()) || func_190(8, -1)) || func_101()) || func_189()) || func_188()) || func_187()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_192()) || Global_33090) || func_191()) || func_190(8, -1)) || func_188()) || func_101()) || func_189()) || func_187()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_192()) || Global_113182) || Global_33090) || func_191()) || func_190(8, -1)) || func_188()) || func_101()) || func_189()) || func_187()) || Global_114135.f_7692.f_919[bVar0] == 5) || Global_44728 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_192()) || Global_113182) || Global_33090) || func_191()) || func_190(8, -1)) || func_101()) || func_189()) || func_187()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_192() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_190(8, -1)) || func_187()) || func_186()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_192()) || Global_33090) || func_191()) || func_190(8, -1)) || func_189()) || func_188()) || func_187()) || Global_114135.f_7692.f_919[bVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_192()) || func_189()) || Global_113182) || Global_33090) || func_191()) || Global_45392) || func_190(8, -1)) || func_188()) || func_186()) || func_187()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_185()//Position - 0xC5CF
{
	return Global_101727.f_1;
}

int func_186()//Position - 0xC5DD
{
	if (Global_98585 != -1)
	{
...
var func_190(int iParam0, int iParam1)//Position - 0xC655
{
	switch (iParam0)
	{
		case 5:
...
var func_191()//Position - 0xC68D
{
	return Global_1575084;
}

int func_192()//Position - 0xC699
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_193(int iParam0, int iParam1)//Position - 0xC6B5
{
	switch (iParam0->f_16)
	{
		case 0:
...
int func_195(var uParam0)//Position - 0xCEB3
{
	float fVar0;
...
void func_196(int iParam0, int iParam1)//Position - 0xCF41
{
	if (iParam0 == 1)
	{
		if (!func_140(iParam1))
...
int func_197(bool bParam0)//Position - 0xCFA5
{
	int iVar0;
...
int func_198(int iParam0)//Position - 0xD03C
{
	if (func_137(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_199(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD066
{
	var uVar0;
	
	if ((((func_137(PLAYER::PLAYER_PED_ID()) && func_137(iParam0->f_28[0])) && !func_157()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_183(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_200(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD0EE
{
...
void func_202(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD17F
{
...
void func_203(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD21A
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_183(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_206(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_183(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_208(iParam0);
				}
			}
...
void func_206(int iParam0, int iParam1)//Position - 0xD380
{
	bool bVar0;
	int iVar1;
...
void func_208(int iParam0)//Position - 0xD42A
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_209(iParam0);
...
void func_209(int iParam0)//Position - 0xD441
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_211(var uParam0, bool bParam1)//Position - 0xD551
{
	struct<27> Var0;
	...
	if ((func_248(*uParam0) || func_246(*uParam0)) || Global_79785 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
int func_213(int iParam0)//Position - 0xDB19
{
...
int func_214(var uParam0)//Position - 0xDB39
{
...
int func_215(var uParam0)//Position - 0xDB51
{
...
void func_217(int* iParam0)//Position - 0xDE7A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_219(var uParam0, bool bParam1, bool bParam2)//Position - 0xDF25
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_220(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_220(int iParam0, int iParam1)//Position - 0xE0E3
{
	int iVar0;
...
int func_221(var uParam0, bool bParam1, int iParam2)//Position - 0xE113
{
	int iVar0;
	int iVar1;
...
int func_222(int iParam0)//Position - 0xE3CF
{
...
int func_223(int iParam0, float fParam1)//Position - 0xE403
{
	float fVar0;
...
bool func_224(int iParam0, float fParam1)//Position - 0xE479
{
	return func_225(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_225(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE491
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	uVar0 = func_226(&(Local_35[iVar4 /*4*/]), Var1, iParam1, &(Local_35[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar4 /*4*/].f_3) < iParam4);
}

int func_226(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE552
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_227(int iParam0, int iParam1)//Position - 0xE67E
{
	int iVar0;
...
int func_229(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE78D
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_231(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_231(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_230(struct<3> Param0, struct<3> Param3)//Position - 0xE81E
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_231(struct<3> Param0)//Position - 0xE83F
{
	float fVar0;
	float fVar1;
...
int func_233(int iParam0, int iParam1)//Position - 0xE899
{
	int iVar0;
...
int func_234(int iParam0)//Position - 0xE8D8
{
...
int func_235(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE900
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_236(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE9FB
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_237(int iParam0, float fParam1)//Position - 0xEB07
{
	var uVar0;
	struct<3> Var1;
...
int func_238(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xEB9C
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_231(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
int func_239(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEC2A
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_240(int iParam0)//Position - 0xEC72
{
...
void func_241(int iParam0)//Position - 0xECBC
{
	int iVar0;
...
int func_242(int iParam0)//Position - 0xED59
{
	if (iParam0 == -1)
	{
		iParam0 = func_178();
...
int func_243(int iParam0)//Position - 0xEDEE
{
...
int func_246(int iParam0)//Position - 0xEE6D
{
...
int func_248(int iParam0)//Position - 0xEEDF
{
	if (func_118(0))
	{
...
int func_250(int iParam0)//Position - 0xEF36
{
	if (!func_251(iParam0))
	{
		return 0;
...
int func_251(var uParam0)//Position - 0xEF55
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_260(&(uParam0->f_35[0]), iVar0[1], Local_92, fLocal_95);
				if (func_137(uParam0->f_35[0]))
				{
...
void func_252(bool bParam0)//Position - 0xF170
{
...
void func_253(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xF1C2
{
	if (iParam0 != 198)
	{
		if (Global_79539)
...
void func_260(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x13777
{
	func_261(iParam0);
...
void func_261(int* iParam0)//Position - 0x137BA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_262(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x13856
{
...
int func_263(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x138B2
{
	int iVar0;
...
int func_264(var uParam0, int iParam1)//Position - 0x13940
{
	int iVar0;
...
int func_265(var uParam0)//Position - 0x13986
{
	if (func_215(uParam0))
	{
...
int func_266(int iParam0)//Position - 0x139B0
{
	int iVar0;
...
int func_268(int iParam0)//Position - 0x13A1D
{
	struct<27> Var0;
	bool bVar32;
...
int func_269(int iParam0)//Position - 0x13A6E
{
	char* sVar0;
...
int func_270(int iParam0)//Position - 0x13B27
{
	var uVar0;
...
int func_271(int iParam0)//Position - 0x13BE8
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_273(int iParam0)//Position - 0x13D4F
{
...
int func_274(int iParam0)//Position - 0x13D7A
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_275(int iParam0)//Position - 0x13DA5
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_276(int iParam0)//Position - 0x13DD0
{
	if (func_243(iParam0))
	{
		return 0;
...
int func_278(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x13E1F
{
	int iVar0;
...
int func_279(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x13E84
{
	int iVar0;
	struct<7> Var1;
...
int func_280(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x13EFC
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_281(int iParam0, bool bParam1)//Position - 0x13F77
{
	char* sVar0;
...
int func_285(char* sParam0)//Position - 0x14050
{
	struct<6> Var0;
...
void func_291(int* iParam0, bool bParam1)//Position - 0x1413A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_294(int* iParam0)//Position - 0x141C4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_297(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1424F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_298(int* iParam0)//Position - 0x1429F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_299(var uParam0)//Position - 0x142E0
{
	if (*uParam0 == -1)
	{
		return;
...
int func_303(int iParam0)//Position - 0x1437C
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
