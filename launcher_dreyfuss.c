...
void __EntryFunction__()//Position - 0x0
{
	...
	uLocal_90 = func_302(68);
	iLocal_91 = joaat("landstalker");
	Local_92 = { -1473.3762f, 517.8441f, 116.8854f };
	fLocal_95 = 97.3011f;
	iLocal_96 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113457[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_298(&(Global_113457[Var0.f_0 /*10*/].f_9));
			}
		}
		func_280(&Var0, 1);
	}
	iVar64[0] = 8;
	if (!func_277(&iVar64, &Var0, Var61, 1f))
	{
		func_276();
	...
	while (true)
	{
		...
		func_209(Var0.f_0);
		func_202(&iLocal_96, &(Var0.f_9), Var61);
		if (Var0.f_0 == 8)
		{
			func_198(&Var0, Var61, "DREY1AU", "DREY1_IDLE", 3, "DREYFUSS", 5000, 1101004800);
		}
		if (func_192(&Var0, 0) || func_180())
		{
			if (!func_2(&Var0))
			{
				func_280(&Var0, 1);
...
void func_17(int iParam0)//Position - 0xBF2
{
...
void func_21(char* sParam0)//Position - 0xCAB
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xCBE
{
	MISC::CLEAR_BIT(&(Global_101392.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xCDB
{
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x28E7
{
...
int func_29(int iParam0)//Position - 0x2927
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2955
{
...
int func_31(int iParam0)//Position - 0x2A31
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2A73
{
	int iVar0;
...
int func_33(int iParam0, bool bParam1, int iParam2)//Position - 0x2AD6
{
	int iVar0;
...
int func_34(bool bParam0, int iParam1)//Position - 0x2B64
{
	struct<82> Var0;
...
void func_35(bool bParam0, var uParam1, int iParam2)//Position - 0x2BA6
{
	int iVar0;
...
bool func_36(bool bParam0)//Position - 0x2E02
{
	return bParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E0E
{
	int iVar0;
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x3169
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x335C
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x342D
{
	char* sVar0;
...
int func_43(int iParam0, bool bParam1, bool bParam2)//Position - 0x355C
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x35CA
{
...
int func_45(int iParam0)//Position - 0x36A3
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x36E0
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x3705
{
...
int func_50(int iParam0, var uParam1)//Position - 0x38DD
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(uParam1));
}

int func_51(var uParam0)//Position - 0x38F2
{
	int iVar0;
	int iVar1;
...
int func_53(int iParam0, int iParam1)//Position - 0x3932
{
	int iVar0;
	var uVar1;
...
int func_54(int iParam0, var uParam1)//Position - 0x3956
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(uParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x396B
{
	int iVar0;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EB4
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x4595
{
	switch (iParam0)
	{
...
int func_63(int iParam0)//Position - 0x4636
{
...
int func_64(int iParam0, int iParam1)//Position - 0x4822
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x5543
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x557E
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x57F2
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x582E
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5D7D
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5DC1
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6540
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x6587
{
...
bool func_73(int iParam0)//Position - 0x65E2
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x65F2
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x6652
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x69FA
{
	return Global_32828;
}

int func_77(int iParam0)//Position - 0x6A05
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A15
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6AB7
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x7222
{
...
int func_81()//Position - 0x751D
{
	return Global_2652572.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x752C
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x7556
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x756B
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x7582
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x75DA
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7684
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x7719
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x775D
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x78E1
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x78EF
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x83B8
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x843A
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x8492
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x849B
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x8707
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x8717
{
	return MISC::GET_BITS_IN_RANGE(Global_2657921[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x8734
{
	return func_74(iParam0, 0, 0);
}

int func_99(int iParam0)//Position - 0x8744
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x8A7A
{
	return Global_101444.f_393 > 0;
}

var func_101()//Position - 0x8A8B
{
	var uVar0;
...
void func_103(var uParam0, int iParam1)//Position - 0x8B57
{
...
int func_105(int iParam0, int iParam1)//Position - 0x8BDB
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8C7D
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8C9F
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8CB6
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8CC3
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8CFD
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8D38
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8D74
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8D8D
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8DE6
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8DFC
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8E12
{
...
int func_117(bool bParam0)//Position - 0x8E54
{
...
struct<2> func_118(int iParam0)//Position - 0x8E7C
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x92C9
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA5A1
{
	switch (iParam0)
	{
		case 0:
...
int func_122(var* uParam0)//Position - 0xA8E7
{
	int iVar0;
...
void func_123(int iParam0)//Position - 0xA98C
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xAA27
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xAA85
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xAADE
{
...
int func_128(int iParam0)//Position - 0xAB61
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAB92
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xABA7
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xAC5A
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAC75
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xACC1
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xAD0A
{
	if (func_136(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xAD2A
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_137(int iParam0)//Position - 0xAD4B
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xAE1B
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xAE6E
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xAF63
{
	switch (iParam0)
	{
		case 5:
...
void func_142(bool bParam0)//Position - 0xAFCE
{
	int iVar0;
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB00D
{
	if (bParam0)
	{
...
bool func_144()//Position - 0xB15A
{
	return BitTest(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

bool func_145(int iParam0, int iParam1)//Position - 0xB174
{
	bool bVar0;
...
int func_146(int iParam0, bool bParam1)//Position - 0xB1CD
{
	int iVar0;
	int iVar1;
...
int func_147(var uParam0)//Position - 0xB20E
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB230
{
...
bool func_149()//Position - 0xB26F
{
	return BitTest(Global_2621446, 3);
}

int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB27D
{
	int iVar0;
...
void func_152(int iParam0)//Position - 0xB2D7
{
	if (iParam0 == 1)
	{
...
int func_153(char* sParam0)//Position - 0xB2FA
{
...
void func_154()//Position - 0xB337
{
	Global_21032 = 0;
	func_155();
}

void func_155()//Position - 0xB347
{
...
int func_159(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB42D
{
...
void func_160(int iParam0)//Position - 0xB484
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_161(bool bParam0, bool bParam1)//Position - 0xB4B0
{
...
void func_163(int iParam0)//Position - 0xB652
{
	if (func_168())
	{
		return;
...
void func_164(int iParam0)//Position - 0xB685
{
	if (func_168())
	{
		return;
...
void func_165(bool bParam0, bool bParam1)//Position - 0xB70F
{
	if (bParam0)
	{
		if (func_167(0))
...
bool func_166()//Position - 0xB783
{
	return BitTest(Global_1956030, 5);
}

int func_167(int iParam0)//Position - 0xB791
{
	if (iParam0 == 1)
	{
...
bool func_168()//Position - 0xB7E8
{
	return BitTest(Global_1956030, 19);
}

int func_169(int iParam0)//Position - 0xB7F7
{
...
int func_170(int iParam0)//Position - 0xB838
{
	int iVar0;
...
void func_171(int iParam0)//Position - 0xB87D
{
...
int func_172(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB8AF
{
	int iVar0;
...
void func_173(var uParam0, int iParam1)//Position - 0xB9E6
{
	int iVar0;
...
bool func_174(int iParam0)//Position - 0xBA35
{
	return func_175(iParam0, Global_43922);
}

int func_175(int iParam0, int iParam1)//Position - 0xBA46
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_176(int iParam0)//Position - 0xBC27
{
	if (Global_43922 == 15)
	{
		return 0;
...
int func_177()//Position - 0xBC49
{
	return func_178(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_178(char* sParam0, int iParam1)//Position - 0xBC5A
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_180()//Position - 0xBCC7
{
	if (func_183(2))
	{
		if (func_182(PLAYER::PLAYER_PED_ID(), -1459.68f, 485.26f, 116.22f, 1) < 6f && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
			...
			else if ((!func_181(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && func_136(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_159(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 1f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_181(int iParam0, int iParam1)//Position - 0xBD68
{
	if (func_135(iParam0))
	{
...
float func_182(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xBD9B
{
	struct<3> Var0;
...
int func_183(int iParam0)//Position - 0xBDD5
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_191()) || Global_32831) || func_190()) || func_189(8, -1)) || func_187()) || func_100()) || func_188()) || func_186()) || Global_114370.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_191()) || Global_113417) || Global_32831) || func_190()) || func_189(8, -1)) || func_100()) || func_188()) || func_186()) || Global_114370.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_191() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_189(8, -1)) || func_186()) || func_185()) || Global_114370.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_184()//Position - 0xC4F5
{
	return Global_101431.f_1;
}

int func_185()//Position - 0xC503
{
	if (Global_98294 != -1)
	{
...
bool func_188()//Position - 0xC56A
{
	return Global_101444.f_394 > 0;
}

var func_189(int iParam0, int iParam1)//Position - 0xC57B
{
	switch (iParam0)
	{
		case 5:
...
var func_190()//Position - 0xC5B3
{
	return Global_1575079;
}

int func_191()//Position - 0xC5BF
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_192(int iParam0, int iParam1)//Position - 0xC5DB
{
	switch (iParam0->f_16)
	{
		case 0:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.6306f, 4699.115f, 35.38089f, 1812.8776f, 4710.457f, 42.053535f, 23.75f, false, true, 0))
				{
					if (func_136(iParam0->f_28[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], true), true) < 3f)
						{
							if (func_183(2))
							{
								if (func_196(iParam0->f_27))
								{
									func_195(iParam0->f_27, *iParam0);
...
void func_193()//Position - 0xCDBE
{
	func_27(&(Global_104933.f_2890), &Global_104933, 0, 1, 1, 0);
}

int func_194(var uParam0)//Position - 0xCDD9
{
	float fVar0;
...
void func_195(int iParam0, int iParam1)//Position - 0xCE67
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_196(bool bParam0)//Position - 0xCECB
{
	int iVar0;
...
int func_197(int iParam0)//Position - 0xCF62
{
	if (func_136(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_198(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xCF8C
{
	var uVar0;
	
	if ((((func_136(PLAYER::PLAYER_PED_ID()) && func_136(iParam0->f_28[0])) && !func_156()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_182(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_199(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD014
{
...
void func_200(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD04F
{
...
void func_201(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD0A5
{
...
void func_202(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD140
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_182(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_205(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_182(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_207(iParam0);
				}
			}
...
void func_203(int iParam0, bool bParam1)//Position - 0xD231
{
	if (iParam0 == -1)
	{
		return;
...
int func_204(int iParam0)//Position - 0xD26D
{
	if (Global_79244 == iParam0)
	{
		if (Global_79245 == -1)
...
void func_205(int iParam0, int iParam1)//Position - 0xD2A6
{
	bool bVar0;
	int iVar1;
...
bool func_206()//Position - 0xD344
{
	return Global_98681;
}

void func_207(int iParam0)//Position - 0xD350
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_208(iParam0);
...
void func_208(int iParam0)//Position - 0xD367
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_209(int iParam0)//Position - 0xD44F
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_210(var uParam0, bool bParam1)//Position - 0xD477
{
	struct<27> Var0;
	...
	if ((func_247(*uParam0) || func_245(*uParam0)) || Global_79494 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_211(int iParam0, var uParam1, int iParam2)//Position - 0xD6E7
{
	int iVar0;
	int iVar1;
...
int func_212(int iParam0)//Position - 0xDA3F
{
...
int func_213(var uParam0)//Position - 0xDA5F
{
...
int func_214(var uParam0)//Position - 0xDA77
{
...
void func_215(var uParam0)//Position - 0xDA9C
{
	int iVar0;
	int iVar1;
...
void func_216(int* iParam0)//Position - 0xDDA0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_217(var uParam0)//Position - 0xDDCB
{
	int iVar0;
...
int func_218(var uParam0, bool bParam1, bool bParam2)//Position - 0xDE4B
{
	int iVar0;
	int iVar1;
	int iVar2;
				...
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						if (func_197(iVar2))
						{
							...
							{
								if (func_197(uParam0->f_35[iVar0]))
								{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_219(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_219(int iParam0, int iParam1)//Position - 0xE009
{
	int iVar0;
...
int func_220(var uParam0, bool bParam1, int iParam2)//Position - 0xE039
{
	int iVar0;
	int iVar1;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					...
					if (func_239(*uParam0))
					{
						if (!func_169(*uParam0))
						{
							if (func_234(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_215(uParam0);
						...
						if (func_222(uParam0->f_28[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_215(uParam0);
...
int func_221(int iParam0)//Position - 0xE2F5
{
...
int func_222(int iParam0, float fParam1)//Position - 0xE329
{
	float fVar0;
...
bool func_223(int iParam0, float fParam1)//Position - 0xE39F
{
	return func_224(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_224(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE3B7
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!func_136(iParam0) || !func_136(iParam1))
	{
		if (iVar4 != -1)
		{
			func_231(&(Local_35[iVar4 /*4*/]));
		}
		return 0;
	}
	if (!func_228(iParam0, iParam1, fParam2, iParam3))
	{
		return 0;
	}
	if (iVar4 == -1)
	...
	uVar0 = func_225(&(Local_35[iVar4 /*4*/]), Var1, iParam1, &(Local_35[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar4 /*4*/].f_3) < iParam4);
}

int func_225(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE478
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_226(int iParam0, int iParam1)//Position - 0xE5A4
{
	int iVar0;
...
int func_228(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE6B3
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_230(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_230(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_229(Var3, Var0);
...
float func_229(struct<3> Param0, struct<3> Param3)//Position - 0xE744
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_230(struct<3> Param0)//Position - 0xE765
{
	float fVar0;
	float fVar1;
...
void func_231(var uParam0)//Position - 0xE7A4
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_232(int iParam0, int iParam1)//Position - 0xE7BF
{
	int iVar0;
...
int func_233(int iParam0)//Position - 0xE7FE
{
...
int func_234(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE826
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_136(PLAYER::PLAYER_PED_ID()) && func_136(iParam0))
	{
		...
		if (!bParam2)
		{
			if (func_238(iParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_235(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_235(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE921
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_236(int iParam0, float fParam1)//Position - 0xEA2D
{
	var uVar0;
	struct<3> Var1;
	...
	{
		if (func_237(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_237(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xEAC2
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_230(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
int func_238(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEB50
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_239(int iParam0)//Position - 0xEB98
{
...
void func_240(int iParam0)//Position - 0xEBE2
{
	int iVar0;
...
int func_241(int iParam0)//Position - 0xEC7F
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_242(int iParam0)//Position - 0xED14
{
...
int func_245(int iParam0)//Position - 0xED93
{
...
int func_247(int iParam0)//Position - 0xEE05
{
	if (func_117(0))
	{
...
int func_249(int iParam0)//Position - 0xEE5C
{
	if (!func_250(iParam0))
	{
		return 0;
...
int func_250(var uParam0)//Position - 0xEE7B
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_265(&iVar0) || !func_264(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			{
				if (!func_261(&(uParam0->f_28[0]), 68, -1459.68f, 485.26f, 116.22f, -131.3f, "DREYFUSS LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
...
void func_251(bool bParam0)//Position - 0xF096
{
...
void func_252(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xF0E8
{
	if (iParam0 != 198)
	{
		if (Global_79248)
...
void func_253(int iParam0, int iParam1)//Position - 0xF140
{
	switch (iParam0)
	{
		case 12:
...
void func_254(int iParam0, bool bParam1)//Position - 0xF229
{
	if (bParam1)
	{
...
bool func_255(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0xF252
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_257()//Position - 0xFBE7
{
	return Global_32829;
}

int func_258(var uParam0, int iParam1)//Position - 0xFBF2
{
	int iVar0;
...
void func_259(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x13777
{
	func_260(iParam0);
...
void func_260(int* iParam0)//Position - 0x137BA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_261(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x13856
{
...
int func_262(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x138B2
{
	int iVar0;
...
int func_263(var uParam0, int iParam1)//Position - 0x13940
{
	int iVar0;
...
int func_264(var uParam0)//Position - 0x13986
{
	if (func_214(uParam0))
	{
...
int func_265(int iParam0)//Position - 0x139B0
{
	int iVar0;
...
void func_266(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x139E1
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_267(int iParam0)//Position - 0x13A1D
{
	struct<27> Var0;
	bool bVar32;
...
int func_268(int iParam0)//Position - 0x13A6E
{
	char* sVar0;
...
int func_269(int iParam0)//Position - 0x13B27
{
	var uVar0;
...
int func_270(int iParam0)//Position - 0x13BE8
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_271(int iParam0, char* sParam1)//Position - 0x13C6D
{
...
int func_272(int iParam0)//Position - 0x13D4F
{
...
int func_273(int iParam0)//Position - 0x13D7A
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_274(int iParam0)//Position - 0x13DA5
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_275(int iParam0)//Position - 0x13DD0
{
	if (func_242(iParam0))
	{
		return 0;
...
void func_276()//Position - 0x13E05
{
	func_299("Running end routines.");
	Global_114088 = (Global_114088 - 1);
}

int func_277(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x13E1F
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_278((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_278((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_278(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x13E84
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_279(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_279(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x13EFC
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_280(int iParam0, bool bParam1)//Position - 0x13F77
{
	char* sVar0;
	...
	if (bParam1)
	{
		...
		func_287(iParam0, 0, 0, 0);
	}
	func_286(&(iParam0->f_48));
	if (iLocal_96 != -1)
	{
	...
	func_281(sVar0);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_91, false);
...
void func_281(char* sParam0)//Position - 0x13FFC
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_284(sParam0))
...
void func_282()//Position - 0x1401F
{
	Global_21032 = 0;
	func_283();
}

void func_283()//Position - 0x1402F
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_284(char* sParam0)//Position - 0x14050
{
	struct<6> Var0;
...
struct<6> func_285()//Position - 0x14070
{
	struct<6> Var0;
...
int func_286(var uParam0)//Position - 0x14094
{
	if (func_214(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_287(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x140CA
{
...
void func_288(var uParam0, bool bParam1)//Position - 0x140EA
{
	func_289(&(uParam0->f_41), bParam1);
}

void func_289(var uParam0, bool bParam1)//Position - 0x140FC
{
	int iVar0;
...
void func_290(int* iParam0, bool bParam1)//Position - 0x1413A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_291(var uParam0, bool bParam1)//Position - 0x14175
{
	func_292(&(uParam0->f_35), bParam1);
}

void func_292(var uParam0, bool bParam1)//Position - 0x14187
{
	int iVar0;
...
void func_293(int* iParam0)//Position - 0x141C4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_294(var uParam0, int iParam1)//Position - 0x141FC
{
	func_295(&(uParam0->f_28), iParam1);
}

void func_295(var uParam0, int iParam1)//Position - 0x1420E
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_296(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_296(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1424F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_297(int* iParam0)//Position - 0x1429F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_298(var uParam0)//Position - 0x142E0
{
	if (*uParam0 == -1)
	{
		return;
...
void func_299(char* sParam0)//Position - 0x1431D
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_300(var uParam0)//Position - 0x1432F
{
	*uParam0 = -1;
...
void func_301()//Position - 0x14362
{
	func_299("Running start routines.");
	Global_114088++;
}

int func_302(int iParam0)//Position - 0x1437C
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
