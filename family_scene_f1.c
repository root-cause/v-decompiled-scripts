...
void __EntryFunction__()//Position - 0x0
{
	...
	while (iLocal_53)
	{
		...
		{
			func_36(&uLocal_111, &iLocal_112, &uLocal_115, &uLocal_116, Local_82, "v_franklinshouse");
			if (func_35(126))
			{
...
int func_1(int iParam0, var uParam1, struct<3> Param2, struct<3> Param3, var uParam4)//Position - 0xF3
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar0 < 3)
	{
		...
		if (!func_31(iVar1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_98159[iVar0]))
			{
	...
	if (Global_95704 != 8)
	{
		if (Global_95705 == -1)
		{
			...
			if (func_7())
			{
				...
				{
					Global_95705 = MISC::GET_GAME_TIMER();
					return 1;
				}
			}
			else
...
void func_8(struct<3> Param0, struct<3> Param1, var uParam2)//Position - 0x9E9
{
...
void func_9(struct<3> Param0, struct<3> Param1)//Position - 0xA64
{
	int iVar0;
...
void func_12(struct<3> Param0, struct<3> Param1, var uParam2)//Position - 0xBC2
{
...
void func_13(struct<3> Param0, struct<3> Param1)//Position - 0xC39
{
	int iVar0;
...
bool func_14(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0xC70
{
	if (bParam2)
	{
...
void func_23()//Position - 0xF9D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_26(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_29(iVar0) && (!func_24(14) || Global_112599))
			{
...
void func_36(var uParam0, int* iParam1, var uParam2, var uParam3, struct<3> Param4, char* sParam5)//Position - 0x1276
{
	int iVar0;
	struct<3> Var1;
	...
	else if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		*uParam2 = INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID());
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam5))
		{
			...
			{
				*uParam3 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(Param4, sParam5);
			}
		}
		func_38(iParam1);
		*uParam0 = 0;
...
int func_45(int iParam0, struct<3> Param1, float fParam2)//Position - 0x15F4
{
	if (!func_46(iParam0))
	{
		return 0;
...
int func_46(int iParam0)//Position - 0x1638
{
	...
	if (MISC::GET_RANDOM_EVENT_FLAG() && Global_113638)
	{
		return 0;
	}
	if (!func_31(iParam0))
	...
	if (!BitTest(Global_113648.f_9087.f_2[27 /*3*/], 1))
	{
		return 0;
	}
	return 1;
...
{
	return func_50(iParam0, Global_43257);
}
...
void func_51()//Position - 0x191F
{
	...
	func_52(&uLocal_121, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}
...
void func_54()//Position - 0x1A01
{
	...
	func_60(&uLocal_286, &uLocal_66, &uLocal_54, &uLocal_68, &uLocal_70, &uLocal_56, &uLocal_58, &uLocal_90, &uLocal_92, &uLocal_94);
	iVar0 = 0;
	while (iVar0 < 1)
	{
		iVar1 = func_59(iVar0);
		if (iVar1 < 15)
		{
			if (Global_95687[iVar1] != 141)
			{
				func_58(iVar1);
				Global_95687[iVar1] = 141;
			}
			func_55(iVar1);
		}
		iVar0++;
...
void func_65(int iParam0)//Position - 0x226A
{
	...
	while (iVar1 < Global_113648.f_7690.f_198)
	{
		...
		{
			func_66(Global_113648.f_7690.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
int func_66(int iParam0)//Position - 0x2326
{
	...
	{
		if (func_72(iParam0, Global_20383) == 1)
		{
			func_71(iParam0, Global_20383, 0);
			if (func_70(iParam0, Global_20383) == 0)
			{
				iVar0 = Global_20383;
...
{
	Global_32224[iParam0 /*11*/].f_10 = iParam1;
}
...
void func_79(int iParam0, bool bParam1)//Position - 0x2712
{
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_41953[iParam0 /*31*/].f_1), 6);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_41953[iParam0 /*31*/].f_1), 6);
	}
}
