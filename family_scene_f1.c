...
int func_1(int iParam0, var uParam1, struct<3> Param2, struct<3> Param5, var uParam8)//Position - 0xF3
{
	...
	while (iVar0 < 3)
	{
		...
		if (!func_31(iVar1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_98991[iVar0]))
			{
	...
	if (Global_96536 != 8)
	{
		if (Global_96537 == -1)
		{
			...
			if (func_7())
			{
				...
				{
					Global_96537 = MISC::GET_GAME_TIMER();
					return 1;
				}
			}
			else
...
int func_46(int iParam0)//Position - 0x1638
{
	...
	if (MISC::GET_RANDOM_EVENT_FLAG() && Global_113959)
	{
		return 0;
	}
	if (!func_31(iParam0))
...
void func_65(int iParam0)//Position - 0x226A
{
	...
	while (iVar15 < Global_113969.f_7691.f_198)
	{
		...
		{
			func_66(Global_113969.f_7691.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
