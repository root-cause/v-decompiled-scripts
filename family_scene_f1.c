...
void __EntryFunction__()//Position - 0x0
{
	...
	while (iLocal_51)
	{
		...
		{
			func_36(&uLocal_111, &iLocal_112, &uLocal_115, &uLocal_116, Local_80, "v_franklinshouse");
			if (func_35(126))
			{
...
int func_1(int iParam0, var uParam1, struct<3> Param2, struct<3> Param5, var uParam8)//Position - 0xF3
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar0 < 3)
	{
		...
		if (!func_31(iVar1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_99141[iVar0]))
			{
	...
	if (Global_96686 != 8)
	{
		if (Global_96687 == -1)
		{
			...
			if (func_7())
			{
				...
				{
					Global_96687 = MISC::GET_GAME_TIMER();
					return 1;
				}
			}
			else
...
int func_2(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x5C6
{
	struct<15> Var0;
	bool bVar15;
...
void func_3(bool bParam0)//Position - 0x740
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_5(bool bParam0)//Position - 0x868
{
...
int func_6(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x890
{
	struct<14> Var0;
...
void func_8(struct<3> Param0, struct<3> Param3, var uParam6)//Position - 0x9E9
{
...
void func_9(struct<3> Param0, struct<3> Param3)//Position - 0xA64
{
	int iVar0;
...
void func_10(var uParam0, var uParam1)//Position - 0xAA8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_11(int iParam0)//Position - 0xB5F
{
	int iVar0;
...
void func_12(struct<3> Param0, struct<3> Param3, var uParam6)//Position - 0xBC2
{
...
void func_13(struct<3> Param0, struct<3> Param3)//Position - 0xC39
{
	int iVar0;
...
bool func_14(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xC70
{
	if (bParam6)
	{
...
int func_15(int iParam0, int iParam1)//Position - 0xCB7
{
...
int func_16(int iParam0, int iParam1)//Position - 0xCE1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_19(int iParam0)//Position - 0xEF9
{
	if (iParam0 == 145)
	{
		return 7;
...
var func_20(int iParam0)//Position - 0xF51
{
	return Global_2201[iParam0 /*29*/].f_11;
}

int func_21()//Position - 0xF62
{
...
void func_23()//Position - 0xF9D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_26(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_29(iVar0) && (!func_24(14) || Global_113083))
			{
...
int func_25(int iParam0)//Position - 0x10A8
{
	int iVar0;
	int iVar1;
...
int func_26(int iParam0)//Position - 0x10E5
{
	if (func_29(iParam0))
	{
...
var func_27(int iParam0)//Position - 0x110A
{
	return Global_2201[iParam0 /*29*/];
}

int func_28(int iParam0)//Position - 0x1119
{
	if (func_29(iParam0))
	{
		if ((Global_114135.f_9089 || Global_4) || func_5(0))
		{
...
bool func_29(int iParam0)//Position - 0x1167
{
	return iParam0 < 3;
}

int func_30(int iParam0)//Position - 0x1173
{
	switch (iParam0)
	{
		case 0:
...
bool func_31(int iParam0)//Position - 0x11AA
{
	func_23();
	return iParam0 == Global_114135.f_2367.f_539.f_4321;
}

int func_32(int iParam0)//Position - 0x11C6
{
	if (iParam0 == 0)
	{
		return 0;
...
bool func_33(var uParam0, var uParam1)//Position - 0x11F4
{
...
int func_35(int iParam0)//Position - 0x1249
{
...
void func_36(var uParam0, int* iParam1, var uParam2, var uParam3, struct<3> Param4, char* sParam7)//Position - 0x1276
{
	int iVar0;
	struct<3> Var1;
	...
	if (INTERIOR::IS_VALID_INTERIOR(*uParam2) && INTERIOR::IS_INTERIOR_READY(*uParam2))
	{
		if (*uParam2 == *uParam3)
		{
			...
			if (PAD::IS_DISABLED_CONTROL_PRESSED(0 /*PLAYER_CONTROL*/, 37 /*INPUT_SELECT_WEAPON*/))
			{
...
void func_37(char* sParam0, int iParam1)//Position - 0x14D3
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

void func_38(int* iParam0)//Position - 0x14EA
{
	func_39(iParam0, 0f);
}

void func_39(int* iParam0, float fParam1)//Position - 0x14F9
{
...
int func_41(var uParam0, float fParam1)//Position - 0x157C
{
	if (func_44(uParam0))
	{
...
int func_45(int iParam0, struct<3> Param1, float fParam4)//Position - 0x15F4
{
	if (!func_46(iParam0))
	{
		return 0;
...
int func_46(int iParam0)//Position - 0x1638
{
	...
	if (MISC::GET_RANDOM_EVENT_FLAG() && Global_114125)
	{
		return 0;
	}
	if (!func_31(iParam0))
	...
	if (!BitTest(Global_114135.f_9089.f_2[27 /*3*/], 1))
	{
		return 0;
	}
	return 1;
...
int func_48(int iParam0)//Position - 0x170B
{
	if (Global_44181 == 15)
	{
		return 0;
...
bool func_49(int iParam0)//Position - 0x172D
{
	return func_50(iParam0, Global_44181);
}

int func_50(int iParam0, int iParam1)//Position - 0x173E
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_51()//Position - 0x191F
{
	...
	func_52(&uLocal_122, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}

void func_52(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1950
{
...
void func_53(struct<4> Param0)//Position - 0x19EB
{
	Local_80 = { Param0 };
	uLocal_83 = Param0.f_3;
}
...
void func_54()//Position - 0x1A01
{
	...
	while (iVar0 < 1)
	{
		...
		if (iVar1 < 15)
		{
			if (Global_96669[iVar1] != 141)
			{
				func_58(iVar1);
				Global_96669[iVar1] = 141;
			}
			func_55(iVar1);
		}
		iVar0++;
...
int func_56(int iParam0)//Position - 0x1AAD
{
	if (!func_29(iParam0))
	{
		return func_27(iParam0);
...
int func_57(int iParam0, int iParam1)//Position - 0x1AD3
{
	*iParam1 = 0;
	switch (iParam0)
	{
...
void func_65(int iParam0)//Position - 0x226A
{
	...
	while (iVar15 < Global_114135.f_7692.f_198)
	{
		...
		{
			func_66(Global_114135.f_7692.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
int func_77(int iParam0)//Position - 0x2604
{
	if (iParam0 != -1)
	{
...
void func_79(int iParam0, bool bParam1)//Position - 0x2712
{
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_42877[iParam0 /*31*/].f_1), 6);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_42877[iParam0 /*31*/].f_1), 6);
	}
}

void func_80(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, int iParam6)//Position - 0x273E
{
	switch (iParam0)
	{
		case 0:
...
int func_81(int iParam0, char* sParam1)//Position - 0x2A06
{
	switch (iParam0)
	{
		case 0:
...
void func_83(int* iParam0)//Position - 0x33A0
{
...
int func_85(int iParam0, int iParam1)//Position - 0x34AB
{
	int iVar0;
...
int func_86(int iParam0, char* sParam1, int iParam2)//Position - 0x34E4
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
