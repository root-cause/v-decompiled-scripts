...
int func_1(int iParam0, var uParam1, struct<3> Param2, struct<3> Param5, var uParam8)//Position - 0xF3
{
	...
	while (iVar0 < 3)
	{
		...
		if (!func_31(iVar1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_98850[iVar0]))
			{
...
void func_23()//Position - 0xF9D
{
	...
	{
		if (func_26(Global_114372.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_25(PLAYER::PLAYER_PED_ID());
			if (func_29(iVar0) && (!func_24(14) || Global_113320))
			{
...
int func_28(int iParam0)//Position - 0x1119
{
	if (func_29(iParam0))
	{
		if ((Global_114372.f_9088 || Global_4) || func_5(0))
		{
...
int func_46(int iParam0)//Position - 0x1638
{
	...
	if (MISC::GET_RANDOM_EVENT_FLAG() && Global_114362)
	{
		return 0;
	}
	if (!func_31(iParam0))
	...
	if (!BitTest(Global_114372.f_9088.f_2[27 /*3*/], 1))
	{
		return 0;
	}
	return 1;
...
void func_54()//Position - 0x1A01
{
	...
	while (iVar0 < 1)
	{
		...
		if (iVar1 < 15)
		{
			if (Global_96378[iVar1] != 141)
			{
				func_58(iVar1);
				Global_96378[iVar1] = 141;
			}
			func_55(iVar1);
		}
		iVar0++;
...
void func_65(int iParam0)//Position - 0x226A
{
	...
	while (iVar15 < Global_114372.f_7691.f_198)
	{
		...
		{
			func_66(Global_114372.f_7691.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
int func_66(int iParam0)//Position - 0x2326
{
	...
	{
		if (func_72(iParam0, Global_20813) == 1)
		{
			func_71(iParam0, Global_20813, 0);
			if (func_70(iParam0, Global_20813) == 0)
			{
				iVar0 = Global_20813;
