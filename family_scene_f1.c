...
void func_23()//Position - 0xF9D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_26(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_29(iVar0) && (!func_24(14) || Global_112337))
			{
...
int func_28(int iParam0)//Position - 0x1119
{
	if (func_29(iParam0))
	{
		if ((Global_113386.f_9085 || Global_3) || func_5(0))
		{
...
{
	return func_50(iParam0, Global_43052);
}
...
void func_54()//Position - 0x1A01
{
	...
	while (iVar0 < 1)
	{
		...
		if (iVar1 < 15)
		{
			if (Global_95447[iVar1] != 141)
			{
				func_58(iVar1);
				Global_95447[iVar1] = 141;
			}
			func_55(iVar1);
		}
		iVar0++;
...
void func_65(int iParam0)//Position - 0x226A
{
	...
	while (iVar1 < Global_113386.f_7688.f_198)
	{
		...
		{
			func_66(Global_113386.f_7688.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
int func_66(int iParam0)//Position - 0x2326
{
	...
	{
		if (func_72(iParam0, Global_20266) == 1)
		{
			func_71(iParam0, Global_20266, 0);
			if (func_70(iParam0, Global_20266) == 0)
			{
				iVar0 = Global_20266;
