		...
		if (iLocal_287 != -1)
		{
			if (!func_232())
			{
				*uParam0 = func_231(iLocal_287);
				...
				MISC::SET_BIT(&(Global_114135.f_18578[*uParam0 /*6*/]), 0);
				MISC::SET_BIT(&(Global_114135.f_18578[*uParam0 /*6*/]), 2);
				MISC::CLEAR_BIT(&(Global_114135.f_18578[*uParam0 /*6*/]), 3);
				Global_113222[*uParam0 /*10*/].f_1 = 0;
				if (!func_229(0))
				{
					Global_113222[*uParam0 /*10*/].f_3 = 0;
				}
				if (!func_221(*uParam0))
				{
...
void func_7(int iParam0)//Position - 0x49C
{
	...
	MemCopy(&Global_64323, {func_12(iParam0)}, 4);
	Global_64311 = 0;
	Global_64310 = 0;
	switch (iParam0)
	{
...
void func_26(char[4] cParam0, int iParam1, int iParam2)//Position - 0xD89
{
	if (Global_101688 != 10 && Global_101688 != 9)
	{
		...
		func_28(&Global_104696, cParam0, 0, "Start", iParam1, iParam2);
		func_27();
		Global_95841 = 0;
	}
}
...
void func_61()//Position - 0x41BD
{
	...
	{
		if (func_49(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_48(PLAYER::PLAYER_PED_ID());
			if (func_39(iVar0) && (!func_62(14) || Global_113083))
			{
...
void func_63(int iParam0, bool bParam1)//Position - 0x42C8
{
	...
	if (func_39(bVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_64(iParam0, &(Global_114135.f_2367.f_539.f_298[bVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
int func_72(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5E97
{
	int iVar0;
	int iVar1;
...
bool func_74(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x665A
{
	if (bParam6)
	{
...
int func_75(var uParam0)//Position - 0x66A1
{
...
int func_77(int iParam0, int iParam1, bool bParam2)//Position - 0x670C
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_80(int iParam0)//Position - 0x6B2E
{
	return func_77(iParam0, 5, 1);
}

int func_81(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6B3E
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_85(struct<3> Param0)//Position - 0x7664
{
...
Vector3 func_87(struct<3> Param0)//Position - 0x76A6
{
...
int func_89(int iParam0)//Position - 0x76D2
{
	if (iParam0 != func_98())
	{
...
int func_91(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x77D4
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_92(struct<3> Param0, float fParam3)//Position - 0x7869
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_96(int iParam0, var uParam1)//Position - 0x850B
{
	switch (iParam0)
	{
		case 0:
...
int func_97(int iParam0)//Position - 0x858D
{
	if (iParam0 != func_98())
	{
...
int func_102(int iParam0)//Position - 0x88A2
{
...
var func_110(int iParam0)//Position - 0x8DF8
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_111(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_111(bool bParam0, int iParam1, int iParam2)//Position - 0x8E1A
{
	if (bParam0)
	{
		return iParam1;
...
int func_112(var uParam0)//Position - 0x8E31
{
	return uParam0 & 15;
}
...
void func_116(int iParam0)//Position - 0x8EEF
{
	...
	else if ((MISC::IS_PS3_VERSION() || func_117()) || MISC::IS_PC_VERSION())
	{
...
void func_119(char* sParam0, int iParam1, int iParam2)//Position - 0x8F7E
{
...
int func_124(var* uParam0)//Position - 0xAA2B
{
	int iVar0;
...
int func_134(int iParam0, int iParam1, int iParam2)//Position - 0xAD9E
{
...
int func_137(int iParam0)//Position - 0xAE4E
{
	if (func_138(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_138(int iParam0)//Position - 0xAE6E
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_139(int iParam0)//Position - 0xAE8F
{
	switch (iParam0)
	{
		case 5:
...
int func_141(int iParam0)//Position - 0xAF5F
{
	switch (iParam0)
	{
		case 5:
...
void func_142(var uParam0, bool bParam1, bool bParam2)//Position - 0xAFB2
{
	int iVar0;
...
int func_143(int iParam0)//Position - 0xB0A8
{
	switch (iParam0)
	{
		case 5:
...
void func_145(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB152
{
	if (bParam0)
	{
...
int func_149(var uParam0)//Position - 0xB355
{
	int iVar0;
...
int func_150(int iParam0)//Position - 0xB377
{
...
int func_152(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB3C4
{
	int iVar0;
...
int func_155(char* sParam0)//Position - 0xB441
{
...
int func_159(var uParam0, bool bParam1)//Position - 0xB507
{
	struct<27> Var0;
	...
	func_121(*uParam0, &Var0);
	if ((func_201(*uParam0) || func_199(*uParam0)) || Global_79785 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
int func_161(int iParam0)//Position - 0xBACF
{
...
int func_162(var uParam0)//Position - 0xBAEF
{
...
int func_163(var uParam0)//Position - 0xBB07
{
...
void func_164(var uParam0)//Position - 0xBB2C
{
	int iVar0;
	int iVar1;
...
void func_165(int* iParam0)//Position - 0xBE30
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_166(var uParam0)//Position - 0xBE5B
{
	int iVar0;
...
int func_167(var uParam0, bool bParam1, bool bParam2)//Position - 0xBEDB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_168(int iParam0, int iParam1)//Position - 0xC09A
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0xC0CA
{
	if (func_138(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_170(var uParam0, bool bParam1, int iParam2)//Position - 0xC0F4
{
	int iVar0;
	int iVar1;
...
int func_171(int iParam0)//Position - 0xC3B0
{
...
int func_172(int iParam0, float fParam1)//Position - 0xC3E4
{
	float fVar0;
...
bool func_173(int iParam0, float fParam1)//Position - 0xC45A
{
	return func_174(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_174(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC472
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_175(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xC533
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_176(int iParam0, int iParam1)//Position - 0xC65F
{
	int iVar0;
...
int func_178(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xC76E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_179(struct<3> Param0, struct<3> Param3)//Position - 0xC7FF
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_180(struct<3> Param0)//Position - 0xC820
{
	float fVar0;
	float fVar1;
...
int func_182(int iParam0, int iParam1)//Position - 0xC87A
{
	int iVar0;
...
int func_183(int iParam0)//Position - 0xC8B9
{
...
int func_184(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xC8E1
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_185(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xC9DC
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_186(int iParam0, float fParam1)//Position - 0xCAE8
{
	var uVar0;
	struct<3> Var1;
...
int func_187(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xCB7D
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_188(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xCC0B
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_189(int iParam0)//Position - 0xCC53
{
...
void func_190(int iParam0)//Position - 0xCC9D
{
	int iVar0;
...
int func_191(int iParam0)//Position - 0xCD3A
{
	if (iParam0 == -1)
	{
		iParam0 = func_197();
...
int func_192(int iParam0)//Position - 0xCDCF
{
...
bool func_195(int iParam0)//Position - 0xCE4E
{
	return func_196(iParam0, Global_44181);
}

int func_196(int iParam0, int iParam1)//Position - 0xCE5F
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_198(char* sParam0, int iParam1)//Position - 0xD051
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_199(int iParam0)//Position - 0xD09A
{
...
int func_201(int iParam0)//Position - 0xD10C
{
	if (func_229(0))
	{
...
int func_204(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xD1A1
{
...
void func_205(int iParam0)//Position - 0xD1F8
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_212(int iParam0)//Position - 0xD505
{
	if (iParam0 == 1)
	{
...
int func_214(int iParam0)//Position - 0xD56B
{
...
int func_215(int iParam0)//Position - 0xD5AC
{
	int iVar0;
	...
	iVar0 = func_217(&(Global_113222[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
int func_219(int iParam0)//Position - 0xD7A9
{
	if (Global_44181 == 15)
	{
		return 0;
...
int func_221(int iParam0)//Position - 0xD7EF
{
	char* sVar0;
	...
	if (!Global_114135.f_9089 && !func_229(1))
	{
...
int func_222(int iParam0)//Position - 0xD8A8
{
	var uVar0;
...
int func_223(int iParam0)//Position - 0xD969
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_225(int iParam0)//Position - 0xDAD0
{
...
int func_226(int iParam0)//Position - 0xDAFB
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_227(int iParam0)//Position - 0xDB26
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_228(int iParam0)//Position - 0xDB51
{
	if (func_192(iParam0))
	{
		return 0;
...
int func_229(bool bParam0)//Position - 0xDB86
{
...
void func_236(char* sParam0, int iParam1)//Position - 0xDDB1
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

bool func_237(int iParam0)//Position - 0xDDC8
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
int func_238(float fParam0)//Position - 0xDDE6
{
	...
	while (iVar0 < 5)
	{
		Var1 = { Global_33467[(iLocal_285 + iVar0) /*23*/][0 /*3*/] };
...
bool func_239()//Position - 0xDE62
{
	func_61();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_240(var* uParam0, struct<3> Param1)//Position - 0xDE7B
{
	int iVar0;
	int iVar1[5];
	int iVar7;
	...
	iVar1[3] = 55;
	iVar1[4] = 56;
	if (!func_358(&iVar1, uParam0, Param1, 5f))
	{
...
void func_241(var* uParam0)//Position - 0xE352
{
	char* sVar0;
...
int func_243(char* sParam0, int iParam1, bool bParam2)//Position - 0xE609
{
	Global_22426 = 0;
...
var func_247(int iParam0, int iParam1)//Position - 0xE981
{
...
void func_255(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xEC81
{
...
float func_256(int iParam0, int iParam1, bool bParam2)//Position - 0xED1C
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_257(var* uParam0)//Position - 0xED7A
{
	func_202();
	if (iLocal_112 < 0)
	{
...
int func_258(var uParam0)//Position - 0xEF6F
{
	func_202();
	switch (iLocal_283)
	{
...
int func_261(var uParam0, int iParam1)//Position - 0xF0DD
{
	switch (uParam0->f_16)
	{
		case 0:
...
int func_263(var uParam0)//Position - 0xF8DB
{
	float fVar0;
...
void func_264(int iParam0, int iParam1)//Position - 0xF969
{
	if (iParam0 == 1)
	{
		if (!func_141(iParam1))
...
int func_265(bool bParam0)//Position - 0xF9CD
{
	int iVar0;
...
int func_266(int iParam0)//Position - 0xFA64
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_234()) || Global_113182) || Global_33090) || func_272()) || func_253(8, -1)) || func_104()) || func_271()) || func_270()) || func_269()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_234()) || Global_33090) || func_272()) || func_253(8, -1)) || func_270()) || func_104()) || func_271()) || func_269()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_234()) || Global_113182) || Global_33090) || func_272()) || func_253(8, -1)) || func_270()) || func_104()) || func_271()) || func_269()) || Global_114135.f_7692.f_919[bVar0] == 5) || Global_44728 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_234()) || Global_113182) || Global_33090) || func_272()) || func_253(8, -1)) || func_104()) || func_271()) || func_269()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_234() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_253(8, -1)) || func_269()) || func_268()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_234()) || Global_33090) || func_272()) || func_253(8, -1)) || func_271()) || func_270()) || func_269()) || Global_114135.f_7692.f_919[bVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_234()) || func_271()) || Global_113182) || Global_33090) || func_272()) || Global_45392) || func_253(8, -1)) || func_270()) || func_268()) || func_269()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_234()) || Global_113182) || Global_33090) || func_272()) || func_253(8, -1)) || func_270()) || func_268()) || func_104()) || func_271()) || func_269())
						{
							return 0;
						}
						break;
...
var func_267()//Position - 0x10182
{
	return Global_101727.f_1;
}

int func_268()//Position - 0x10190
{
	if (Global_98585 != -1)
	{
...
var func_272()//Position - 0x10208
{
	return Global_1575084;
}

void func_273(var uParam0, var uParam1)//Position - 0x10214
{
...
void func_274(int iParam0, char* sParam1, struct<3> Param2)//Position - 0x10409
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_277(int iParam0, int iParam1)//Position - 0x1056F
{
	bool bVar0;
	int iVar1;
...
float func_278(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x1060D
{
	struct<3> Var0;
...
void func_280(int iParam0)//Position - 0x10653
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_281(iParam0);
...
void func_281(int iParam0)//Position - 0x1066A
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_284(var uParam0)//Position - 0x1078C
{
	if (*uParam0 == 52)
	{
...
int func_285(var uParam0)//Position - 0x107FE
{
...
void func_286(var uParam0)//Position - 0x10838
{
	switch (*uParam0)
	{
		case 52:
...
void func_287(var uParam0)//Position - 0x108D9
{
	char* sVar0;
	int iVar1;
	int iVar2;
	...
	while (!func_341(&(uParam0->f_28[0]), iVar1, -1299.4f, 2506.24f, 21.07f, -122.79f, 0))
	{
		SYSTEM::WAIT(0);
	}
	func_340(&(uParam0->f_28[0]));
	...
	while (!func_341(&(uParam0->f_28[1]), iVar1, -1299.49f, 2505.53f, 21.05f, -101.94f, 0))
	{
		SYSTEM::WAIT(0);
	}
	func_340(&(uParam0->f_28[1]));
	...
	while (!func_339(&(uParam0->f_35[0]), iVar2, -1298.1597f, 2504.1533f, 21.062f, 165.48f))
	{
		SYSTEM::WAIT(0);
	}
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uParam0->f_35[0], 5f);
	func_338(&(uParam0->f_35[0]));
	...
	if (!func_288(&(uParam0->f_41[0]), joaat("WEAPON_GRENADELAUNCHER"), -1297.84f, 2505.91f, 19.34f, func_337(-0.5f)))
	{
	}
	else
	{
		...
		ENTITY::SET_ENTITY_HEADING(uParam0->f_41[0], func_337(-0.5f));
...
int func_288(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10D74
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_290(var uParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x10EA5
{
	...
	func_333(uParam0, 0, joaat("WAPInvalid"), 0, 0);
	if (func_332(iParam1))
	{
		return 0;
	}
	switch (iParam1)
	{
		...
		case joaat("WEAPON_COMBATPISTOL"):
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				switch (iParam2)
				{
					...
					case 5:
						func_333(uParam0, joaat("COMPONENT_COMBATPISTOL_VARMOD_XMAS23"), joaat("gun_root"), 2, 0);
						break;
				}
			}
			else
		...
		case joaat("WEAPON_MICROSMG"):
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				switch (iParam2)
				{
					...
					case 7:
						func_333(uParam0, joaat("COMPONENT_MICROSMG_VARMOD_XM3"), joaat("gun_root"), 3, 0);
						break;
					
					case 8:
						func_333(uParam0, joaat("COMPONENT_MICROSMG_VARMOD_FRN"), joaat("gun_root"), 4, 0);
						break;
				}
			}
			else
			...
			if (func_331(iLocal_104))
			{
				if (!func_328(joaat("COMPONENT_GUNRUN_MK2_UPGRADE"), joaat("WEAPON_CARBINERIFLE"), -1))
				{
					switch (iParam2)
					{
						...
						case 9:
							func_333(uParam0, joaat("COMPONENT_CARBINERIFLE_VARMOD_MICH"), joaat("gun_root"), 2, 0);
							break;
					}
				}
				else
			...
			if (func_331(iLocal_104))
			{
				if (!func_328(joaat("COMPONENT_GUNRUN_MK2_UPGRADE"), joaat("WEAPON_HEAVYSNIPER"), -1))
				{
					switch (iParam2)
					{
						...
						case 4:
							func_333(uParam0, joaat("COMPONENT_HEAVYSNIPER_VARMOD_XMAS23"), joaat("gun_root"), 1, 0);
							break;
					}
				}
				else
		...
		case joaat("WEAPON_PISTOL_MK2"):
			switch (iParam2)
			{
				...
				case 25:
					func_333(uParam0, joaat("COMPONENT_PISTOL_MK2_VARMOD_XM3"), joaat("gun_root"), 13, 0);
					break;
			}
			break;
			...
			if (func_331(iLocal_104))
			{
				if (!func_328(joaat("COMPONENT_GUNRUN_MK2_UPGRADE"), joaat("WEAPON_PUMPSHOTGUN"), -1))
				{
					switch (iParam2)
					{
						...
						case 5:
							func_333(uParam0, joaat("COMPONENT_PUMPSHOTGUN_VARMOD_XM3"), joaat("gun_root"), 3, 0);
							break;
					}
				}
				else
			...
			if (func_331(iLocal_104))
			{
				if (!func_328(joaat("COMPONENT_GUNRUN_MK2_UPGRADE"), joaat("WEAPON_SPECIALCARBINE"), -1))
				{
					switch (iParam2)
					{
						...
						case 9:
							func_333(uParam0, joaat("COMPONENT_SPECIALCARBINE_VARMOD_XMAS23"), joaat("gun_root"), 2, 0);
							break;
					}
				}
				else
		...
		case joaat("WEAPON_KNIFE"):
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				iVar38 = func_316(iParam1, &iVar0);
				if ((iVar38 > 0 && iParam2 >= 0) && iParam2 < iVar0)
				{
					switch (iVar0[iParam2])
					{
						case joaat("COMPONENT_KNIFE_VARMOD_XM3"):
							func_333(uParam0, iVar0[iParam2], joaat("gun_root"), 1, 0);
							break;
						
						case joaat("COMPONENT_KNIFE_VARMOD_XM3_01"):
							func_333(uParam0, iVar0[iParam2], joaat("gun_root"), 2, 0);
							break;
						
						case joaat("COMPONENT_KNIFE_VARMOD_XM3_02"):
							func_333(uParam0, iVar0[iParam2], joaat("gun_root"), 3, 0);
							break;
						
						case joaat("COMPONENT_KNIFE_VARMOD_XM3_03"):
							func_333(uParam0, iVar0[iParam2], joaat("gun_root"), 4, 0);
							break;
						
						case joaat("COMPONENT_KNIFE_VARMOD_XM3_04"):
							func_333(uParam0, iVar0[iParam2], joaat("gun_root"), 5, 0);
							break;
						
						case joaat("COMPONENT_KNIFE_VARMOD_XM3_05"):
							func_333(uParam0, iVar0[iParam2], joaat("gun_root"), 6, 0);
							break;
						
						case joaat("COMPONENT_KNIFE_VARMOD_XM3_06"):
							func_333(uParam0, iVar0[iParam2], joaat("gun_root"), 7, 0);
							break;
						
						case joaat("COMPONENT_KNIFE_VARMOD_XM3_07"):
							func_333(uParam0, iVar0[iParam2], joaat("gun_root"), 8, 0);
							break;
						
						case joaat("COMPONENT_KNIFE_VARMOD_XM3_08"):
							func_333(uParam0, iVar0[iParam2], joaat("gun_root"), 9, 0);
							break;
						
						case joaat("COMPONENT_KNIFE_VARMOD_XM3_09"):
							func_333(uParam0, iVar0[iParam2], joaat("gun_root"), 10, 0);
							break;
						}
					}
			}
		...
		case joaat("WEAPON_RPG"):
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				...
				{
					case 0:
						func_333(uParam0, joaat("COMPONENT_RPG_VARMOD_TVR"), joaat("gun_root"), 1, 0);
						break;
					}
			}
			break;
		...
		case joaat("WEAPON_BATTLERIFLE"):
			...
			{
				case 0:
					func_333(uParam0, joaat("COMPONENT_BATTLERIFLE_CLIP_01"), joaat("WAPClip"), 1, 1);
					break;
				
				case 1:
					func_333(uParam0, joaat("COMPONENT_BATTLERIFLE_CLIP_02"), joaat("WAPClip"), 2, 0);
					break;
		...
		case joaat("WEAPON_STUNGUN_MP"):
			...
			{
				case 0:
					func_333(uParam0, joaat("COMPONENT_STUNGUN_VARMOD_BAIL"), joaat("gun_root"), 1, 0);
					break;
			}
			break;
		...
		case joaat("WEAPON_STRICKLER"):
			...
			{
				case 0:
					func_333(uParam0, joaat("COMPONENT_STRICKLER_CLIP_01"), joaat("WAPClip"), 1, 1);
					break;
				
				case 1:
					func_333(uParam0, joaat("COMPONENT_STRICKLER_SIGHT"), joaat("WAPScop"), 2, 1);
					break;
				
				case 2:
					func_333(uParam0, joaat("COMPONENT_STRICKLER_FLSH"), joaat("WAPFlshLasr"), 3, 1);
					break;
			}
			break;
					...
					if (FILES::GET_DLC_WEAPON_COMPONENT_DATA(iVar51, iVar52, &Var93))
					{
						if (!func_65(Var93.f_3))
						{
							...
							if (iVar53 == iParam2)
							{
								...
								func_333(uParam0, Var93.f_3, Var93.f_0, iVar39, Var93.f_1);
							}
							iVar53++;
						}
					}
...
float func_292(int iParam0, int iParam1, float fParam2)//Position - 0x1A397
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_294(int iParam0, int iParam1)//Position - 0x1A6C3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_295(int iParam0, int iParam1)//Position - 0x1A7C7
{
	return Global_114135.f_19151[iParam1 /*271*/].f_3[iParam0 /*12*/].f_3;
}

float func_296()//Position - 0x1A7E3
{
	return Global_101740.f_2107;
}

void func_297(char* sParam0, char[8] cParam1, char[4] cParam3, char[4] cParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, bool bParam12, int iParam13)//Position - 0x1A7F2
{
...
var func_307(var uParam0)//Position - 0x1C041
{
	return uParam0;
}
...
int func_310(int iParam0)//Position - 0x1C07F
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		switch (iParam0)
...
int func_311(int iParam0)//Position - 0x1C0E1
{
	switch (iParam0)
	{
		case joaat("COMPONENT_PISTOL_MK2_CAMO_IND_01"):
...
int func_312()//Position - 0x1C140
{
	if (func_315() && (func_314() || func_313()))
	{
		return 1;
	}
	return 0;
...
int func_316(int iParam0, int iParam1)//Position - 0x1C40E
{
	int iVar0;
	var uVar1;
	var uVar2;
	...
	switch (iParam0)
	{
		case joaat("WEAPON_KNIFE"):
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				if (func_317(joaat("COMPONENT_KNIFE_VARMOD_XM3"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_KNIFE_VARMOD_XM3");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_KNIFE_VARMOD_XM3_01"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_KNIFE_VARMOD_XM3_01");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_KNIFE_VARMOD_XM3_02"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_KNIFE_VARMOD_XM3_02");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_KNIFE_VARMOD_XM3_03"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_KNIFE_VARMOD_XM3_03");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_KNIFE_VARMOD_XM3_04"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_KNIFE_VARMOD_XM3_04");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_KNIFE_VARMOD_XM3_05"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_KNIFE_VARMOD_XM3_05");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_KNIFE_VARMOD_XM3_06"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_KNIFE_VARMOD_XM3_06");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_KNIFE_VARMOD_XM3_07"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_KNIFE_VARMOD_XM3_07");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_KNIFE_VARMOD_XM3_08"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_KNIFE_VARMOD_XM3_08");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_KNIFE_VARMOD_XM3_09"), iParam0, &uVar1, &uVar2) && uVar1)
				{
		...
		case joaat("WEAPON_BAT"):
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				if (func_317(joaat("COMPONENT_BAT_VARMOD_XM3"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_BAT_VARMOD_XM3");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_BAT_VARMOD_XM3_01"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_BAT_VARMOD_XM3_01");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_BAT_VARMOD_XM3_02"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_BAT_VARMOD_XM3_02");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_BAT_VARMOD_XM3_03"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_BAT_VARMOD_XM3_03");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_BAT_VARMOD_XM3_04"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_BAT_VARMOD_XM3_04");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_BAT_VARMOD_XM3_05"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_BAT_VARMOD_XM3_05");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_BAT_VARMOD_XM3_06"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_BAT_VARMOD_XM3_06");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_BAT_VARMOD_XM3_07"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_BAT_VARMOD_XM3_07");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_BAT_VARMOD_XM3_08"), iParam0, &uVar1, &uVar2) && uVar1)
				{
					(*iParam1)[iVar0] = joaat("COMPONENT_BAT_VARMOD_XM3_08");
					iVar0++;
				}
				if (func_317(joaat("COMPONENT_BAT_VARMOD_XM3_09"), iParam0, &uVar1, &uVar2) && uVar1)
				{
...
int func_317(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x1C78A
{
	...
	*uParam3 = 0;
	...
	{
		case joaat("WEAPON_BAT"):
			if ((!Global_262145.f_33309 /* Tunable: 1490225691 */ && func_327(iLocal_104, 0)) || func_318(iParam0, iParam1, -1))
			{
				*uParam2 = 1;
				*uParam3 = 0;
				return 1;
			}
			if (Global_262145.f_33309 /* Tunable: 1490225691 */ || !func_327(iLocal_104, 0))
			{
				*uParam2 = 0;
				*uParam3 = 1;
				return 1;
			}
			if (!func_327(iLocal_104, 0))
			{
				return 0;
			}
			return 1;
...
int func_318(int iParam0, int iParam1, int iParam2)//Position - 0x1C884
{
	var uVar0;
	int iVar1;
	...
	uVar0 = func_322(iParam0, iParam1, iParam2);
	iVar1 = func_320(iParam0, iParam1);
	return BitTest(uVar0, func_319(iVar1));
}
...
var func_322(int iParam0, int iParam1, var uParam2)//Position - 0x1EEF2
{
	var uVar0;
	
	uVar0 = func_52(func_323(iParam0, iParam1), uParam2);
	return uVar0;
}
...
int func_327(int iParam0, bool bParam1)//Position - 0x1F0B0
{
	if (iParam0 == 58)
	{
		if (bParam1)
...
int func_328(int iParam0, int iParam1, int iParam2)//Position - 0x1F0D9
{
	var uVar0;
	int iVar1;
	...
	uVar0 = func_329(iParam0, iParam1, iParam2);
	iVar1 = func_320(iParam0, iParam1);
	return BitTest(uVar0, func_319(iVar1));
}

var func_329(int iParam0, int iParam1, var uParam2)//Position - 0x1F10B
{
	var uVar0;
	
	uVar0 = func_52(func_330(iParam0, iParam1), uParam2);
	return uVar0;
}
...
int func_331(int iParam0)//Position - 0x1F2A8
{
	switch (iParam0)
	{
		case 46:
...
int func_332(int iParam0)//Position - 0x1F2F8
{
	switch (iParam0)
	{
		case joaat("WEAPON_STRICKLER"):
...
int func_334(int iParam0)//Position - 0x1F334
{
...
int func_335(int iParam0)//Position - 0x1F358
{
	switch (iParam0)
	{
		case joaat("WEAPON_PISTOL_MK2"):
...
int func_336(int iParam0, int iParam1)//Position - 0x1F3B7
{
	struct<5> Var0;
	int iVar7;
...
int func_339(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x1F414
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_341(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x1F48D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
Vector3 func_342(int iParam0, struct<3> Param1)//Position - 0x1F50B
{
	var uVar0;
...
void func_344(var uParam0)//Position - 0x1F580
{
	int iVar0;
	char* sVar1;
	...
	while (!func_341(&(uParam0->f_28[0]), iVar0, -161.37f, -1669.63f, 33.1f, func_337(1.03f), 1))
	{
		SYSTEM::WAIT(0);
	}
	func_340(&(uParam0->f_28[0]));
	...
	while (!func_341(&(uParam0->f_28[1]), iVar0, -161.93f, -1670.39f, 33.14f, func_337(0.2f), 1))
	{
		SYSTEM::WAIT(0);
	}
	func_340(&(uParam0->f_28[1]));
...
void func_345(var uParam0)//Position - 0x1F857
{
	int iVar0;
	char* sVar1;
	...
	while (!func_341(&(uParam0->f_28[0]), iVar0, 464.6125f, -1848.7673f, 27.816f, 177.39f, 1))
	{
		SYSTEM::WAIT(0);
	}
	func_340(&(uParam0->f_28[0]));
	...
	while (!func_341(&(uParam0->f_28[1]), iVar0, 465.782f, -1849.073f, 27.817f, 129.92f, 1))
	{
		SYSTEM::WAIT(0);
	}
	func_340(&(uParam0->f_28[1]));
	...
	if (func_288(&(uParam0->f_41[0]), joaat("WEAPON_MICROSMG"), 467f, -1855.4f, 32f, func_337(-0.85f)))
	{
...
int func_347(struct<3> Param0, float fParam3)//Position - 0x1FB77
{
	struct<3> Var0;
...
void func_348(var uParam0)//Position - 0x1FBAA
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_352(&uLocal_111);
	while ((((!STREAMING::HAS_MODEL_LOADED(iVar0) || !STREAMING::HAS_MODEL_LOADED(iVar1)) || !STREAMING::HAS_MODEL_LOADED(iVar2)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar3)) || !func_351(&uLocal_111))
	{
		SYSTEM::WAIT(0);
	}
	...
	while (!func_341(&(uParam0->f_28[0]), iVar0, 1181.5474f, -400.0954f, 67.5757f, -124.292786f, 0))
	{
		SYSTEM::WAIT(0);
	}
	func_340(&(uParam0->f_28[0]));
	...
	PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
	PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 2, 0, 0, 0);
	func_350(&(uParam0->f_41[1]), iVar2, 1181.5474f, -400.0954f, 65.5757f, 0f);
	...
	if (!func_288(&(uParam0->f_41[0]), joaat("WEAPON_SAWNOFFSHOTGUN"), 1162.2f, -395.4f, 72.9f, func_337(-0.71f)))
	{
	}
...
void func_349(var uParam0, bool bParam1, int iParam2)//Position - 0x1FE76
{
	...
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0))
	{
		...
		GRAPHICS::DRAW_SCALEFORM_MOVIE(*uParam0, Global_20986, Global_20987, Global_20988, Global_20989, 255, 255, 255, 255, 0);
	}
}

void func_350(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x1FEF5
{
	func_165(iParam0);
...
int func_351(var uParam0)//Position - 0x1FF1C
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0))
	{
		return 1;
...
{
	*uParam0 = GRAPHICS::REQUEST_SCALEFORM_MOVIE(func_353());
}
...
void func_355(var uParam0)//Position - 0x1FF72
{
	struct<3> Var0;
	char* sVar3;
	int iVar4;
	...
	while (!func_341(&(uParam0->f_28[0]), iVar11, 907.998f, 3643.8264f, 32.292427f, -173.04526f, 0))
	{
		SYSTEM::WAIT(0);
	}
	if (func_138(uParam0->f_28[0]))
	{
		...
		PED::SET_PED_NAME_DEBUG(uParam0->f_28[0], "RAMP:PED 0");
		func_350(&(uParam0->f_41[1]), iVar13, Var0, 0f);
	...
	while (!func_341(&(uParam0->f_28[1]), iVar11, 909.3126f, 3643.5066f, 32.2952f, 153.0127f, 0))
	{
		SYSTEM::WAIT(0);
	}
	if (func_138(uParam0->f_28[1]))
	{
		...
		PED::SET_PED_NAME_DEBUG(uParam0->f_28[1], "RAMP:PED 1");
		func_350(&(uParam0->f_41[2]), iVar13, Var0, 0f);
	...
	if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		uParam0->f_59 = PED::CREATE_SYNCHRONIZED_SCENE(910.13f, 3643.74f, 31.69f, 0f, 0f, func_337(-0.26f), 2);
		if (func_138(uParam0->f_28[0]))
		{
...
int func_356(int iParam0)//Position - 0x20499
{
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		return 1;
...
int func_357(int iParam0)//Position - 0x204C6
{
	struct<27> Var0;
	bool bVar32;
...
int func_358(int iParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0x20517
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_359((*iParam0)[0], Param2, fParam5, uParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_359((*iParam0)[iVar0], Param2, fParam5, uParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_359(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x2057C
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_360(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_360(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x205F4
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_361(int iParam0)//Position - 0x2066F
{
...
void func_362(var* uParam0, bool bParam1)//Position - 0x2069C
{
	func_284(uParam0);
	if (bParam1)
	{
		func_377(" SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_365(uParam0, 0, 0, 0);
	}
	func_364(&(uParam0->f_48));
	if (iLocal_286 != -1)
	{
...
void func_368(int* iParam0, bool bParam1)//Position - 0x20804
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_371(int* iParam0)//Position - 0x2088E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_372(int* iParam0)//Position - 0x208C6
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_375(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x209B5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_376(int* iParam0)//Position - 0x20A05
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
