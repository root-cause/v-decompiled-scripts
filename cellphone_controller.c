...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (Global_78558 == 0)
		{
			...
			if (BitTest(Global_4542297, 12))
			{
				MISC::CLEAR_BIT(&Global_4542297, 12);
				MISC::SET_BIT(&Global_8254, 11);
			}
		}
		else if (BitTest(Global_4542297, 12))
		{
		...
		else if (Global_22790 || (Global_22788 > 0 && Global_22789 == 1))
		{
		...
		if (MISC::IS_PC_VERSION())
		{
			...
			{
				if (!BitTest(Global_4542297, 19))
				{
					MISC::SET_BIT(&Global_4542297, 19);
					MISC::SET_BIT(&Global_8254, 11);
				}
			}
			else if (BitTest(Global_4542297, 19))
			{
		...
		else if (!BitTest(Global_8253, 25))
		{
			STATS::STAT_GET_INT(joaat("SP_CELLPHONE_SLEEP_TIME"), &iLocal_92, -1);
		...
		if (BitTest(Global_8253, 7))
		{
			func_55();
			MISC::CLEAR_BIT(&Global_8253, 7);
		}
		if (BitTest(Global_8253, 0))
		{
			func_54();
		}
		if (BitTest(Global_4542297, 0))
		{
			func_53();
		}
		if (BitTest(Global_8254, 11))
		{
			Global_8957 = 0;
			if (BitTest(Global_8253, 25))
			{
...
int func_16()//Position - 0xBAA
{
	...
	if ((func_22(2, Global_20350, 0) && !HUD::IS_HUD_COMPONENT_ACTIVE(19)) && !MISC::IS_STUNT_JUMP_IN_PROGRESS())
	{
		...
		if (HUD::THEFEED_GET_LAST_SHOWN_PHONE_ACTIVATABLE_FEED_ID() == Global_22782 && HUD::THEFEED_GET_LAST_SHOWN_PHONE_ACTIVATABLE_FEED_ID() != -1)
		{
			...
			iLocal_76 = 0;
			iLocal_77 = 0;
			while (((func_20(2, Global_20350) && iLocal_76 < 250) && Global_20592 == 0) && !HUD::IS_HUD_COMPONENT_ACTIVE(19))
			{
				if (Global_8957 > 0)
				{
					func_17();
...
void func_17()//Position - 0xD63
{
	...
	else
	{
		if (MISC::IS_PC_VERSION())
		{
			...
			else if (BitTest(Global_8253, 13))
			{
				if (BitTest(Global_4542297, 19))
				{
					bLocal_38 = false;
		...
		else if (Global_2646729.f_1593 || BitTest(Global_8253, 13))
		{
			bLocal_38 = true;
		}
		else
		...
		case 4:
			...
			else
			{
				...
				else
				{
					...
					if (((Global_113648.f_14053[Global_20383 /*20*/].f_18 == 1 || Global_113648.f_14053[Global_20383 /*20*/].f_17 == 1) || bLocal_82 == 1) || Global_22784 != 0)
					{
						while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_20364) && Global_20366 == 0)
						{
							SYSTEM::WAIT(0);
...
void func_24()//Position - 0x1385
{
	...
	switch (Global_20383.f_1)
	{
		case 6:
			...
			if (Global_20371)
			{
				func_32(Global_20364, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205" /* GXT: SELECT */, 0, 0, 0, 0);
				func_32(Global_20364, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /* GXT: BACK */, 0, 0, 0, 0);
			}
			else
			{
			...
			else
			{
				if (Global_20585 == 1)
				{
					if (Global_20371)
					{
						func_32(Global_20364, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, "CELL_225" /* GXT: NEXT */, 0, 0, 0, 0);
					}
					else
					{
				...
				{
					func_32(Global_20364, "SET_SOFT_KEYS", 1f, 1f, 3f, -1f, -1f, "CELL_225" /* GXT: NEXT */, 0, 0, 0, 0);
				}
				else
				{
		...
		case 10:
			...
			{
				func_32(Global_20364, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_202" /* GXT: END CALL */, 0, 0, 0, 0);
				if (Global_20326)
				{
		...
		case 9:
			if (Global_20382 == 1)
			{
				...
				{
					func_32(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_117[Global_7568 /*10*/].f_4), "CELL_300" /* GXT: CHAR_DEFAULT */, "CELL_217" /* GXT: INCOMING CALL */, "CELL_195" /* GXT: Unknown */, 0);
				}
				else
				{
					func_32(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_2028[Global_7568 /*29*/].f_3), &(Global_2028[Global_7568 /*29*/].f_7), "CELL_217" /* GXT: INCOMING CALL */, &(Global_2028[Global_7568 /*29*/].f_3), 0);
				}
				func_35(Global_20364, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else if (Global_21725 == 4 || Global_21725 == 3)
			{
				...
				else
				{
					...
					if (func_27(Global_7568, Global_20383) == 0)
					{
						...
						func_32(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_7568 /*10*/].f_4), "CELL_300" /* GXT: CHAR_DEFAULT */, &cVar0, "CELL_195" /* GXT: Unknown */, 0);
					}
					else
					{
						func_35(Global_20364, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_32(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2028[Global_7568 /*29*/].f_3), &(Global_2028[Global_7568 /*29*/].f_7), &cVar0, &(Global_2028[Global_7568 /*29*/].f_3), 0);
					}
				}
				func_35(Global_20364, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
...
void func_25()//Position - 0x196A
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_20364))
	{
		...
		if (Global_20382 == 1)
		{
			if (Global_20371)
			{
				func_32(Global_20364, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, "CELL_203" /* GXT: ANSWER */, 0, 0, 0, 0);
			}
			else
			{
			...
			{
				func_32(Global_20364, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_204" /* GXT: REJECT */, 0, 0, 0, 0);
			}
			else
			{
				func_32(Global_20364, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
					...
					if (iVar0 == Global_8260[iVar1 /*15*/].f_4)
					{
						if (Global_8822[iVar0] == 0)
						{
							...
							if (Global_2694519)
							{
								if (iVar1 == 14)
								{
									func_32(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8260[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22788), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8822[iVar0] = 1;
						}
					...
					if (iVar0 == Global_8260[iVar1 /*15*/].f_4)
					{
						if (Global_8822[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_32(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8260[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22793), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_78558)
								{
									...
									func_32(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8260[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20383)
									...
									func_32(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8260[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_8260[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_32(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8260[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_32(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8260[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8822[iVar0] = 1;
						}
					}
...
{
	if (func_16() || BitTest(Global_8253, 8))
	{
...
void func_53()//Position - 0x2A1B
{
	...
	if (((((((Global_4541032[Global_4542281 /*104*/].f_32 == 4 || Global_4541032[Global_4542281 /*104*/].f_32 == 5) || Global_4541032[Global_4542281 /*104*/].f_32 == 6) || Global_4541032[Global_4542281 /*104*/].f_32 == 7) || Global_4541032[Global_4542281 /*104*/].f_32 == 8) || Global_4541032[Global_4542281 /*104*/].f_32 == 9) || Global_4541032[Global_4542281 /*104*/].f_32 == 10) || Global_4541032[Global_4542281 /*104*/].f_32 == 11)
	{
		...
		while (iVar16 < Global_4541032[Global_4542281 /*104*/].f_49)
		{
			switch (Global_4541032[Global_4542281 /*104*/].f_32)
			{
				...
				case 5:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1935188[iVar16 /*4*/]));
					break;
				
				case 6:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1935229[iVar16 /*4*/]));
					break;
				
				case 7:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1935250[iVar16 /*4*/]));
					break;
				
				case 8:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1935267[iVar16 /*4*/]));
					break;
				
				case 9:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1935280[iVar16 /*4*/]));
					break;
				
				case 10:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1935293[iVar16 /*4*/]));
					break;
				
				case 11:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1935306[iVar16 /*4*/]));
					break;
			}
			iVar16++;
		}
		StringCopy(&cVar17, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2028[Global_4541032[Global_4542281 /*104*/].f_17 /*29*/].f_3)), 64);
	...
	else
	{
		...
		if (Global_4541032[Global_4542281 /*104*/].f_17 == 145)
		{
			...
			StringConCat(&cVar33, &Global_8941, 64);
		...
		{
			StringCopy(&cVar49, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2028[Global_4541032[Global_4542281 /*104*/].f_17 /*29*/].f_3)), 64);
...
void func_55()//Position - 0x30E2
{
	if (BitTest(Global_8253, 1))
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			iLocal_53[Global_20383] = NETWORK::GET_NETWORK_TIME();
			iLocal_43[Global_20383] = 1;
		}
		else if (!BitTest(Global_8253, 10))
		{
			iLocal_48[Global_20383] = MISC::GET_GAME_TIMER();
			iLocal_43[Global_20383] = 1;
		}
		else
		{
...
void func_58()//Position - 0x321F
{
	...
	{
		iVar16 = 0;
		iVar17 = func_59(9, Global_113648.f_14143[Global_22792 /*104*/].f_49);
		switch (iVar17)
		{
			case 1:
				HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("CELL_CL01" /* GXT: ~a~ ~a~. */);
		...
		while (iVar16 < iVar17)
		{
			switch (Global_113648.f_14143[Global_22792 /*104*/].f_32)
			{
				...
				case 12:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1935319[iVar16 /*4*/]));
					break;
			}
			iVar16++;
		}
		StringCopy(&cVar18, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2028[Global_113648.f_14143[Global_22792 /*104*/].f_17 /*29*/].f_3)), 64);
		iLocal_64 = HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar0, &cVar0, false, 1, &cVar18, 0);
		Global_22783 = 3;
		Global_22782 = iLocal_64;
		Global_22786 = 0;
	}
	else
	{
		...
		if (Global_113648.f_14143[Global_22792 /*104*/].f_17 == 145)
		{
			...
			StringConCat(&cVar34, &Global_8941, 64);
			StringConCat(&cVar34, "</C>", 64);
			iLocal_64 = HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar0, &cVar0, false, 1, &cVar34, 0);
			Global_22783 = 3;
			Global_22782 = iLocal_64;
		}
		else
		{
			StringCopy(&cVar50, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2028[Global_113648.f_14143[Global_22792 /*104*/].f_17 /*29*/].f_3)), 64);
			if (Global_113648.f_14143[Global_22792 /*104*/].f_17 == 98)
			{
				...
				iLocal_64 = HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar0, &cVar0, false, 1, &cVar66, 0);
			}
			else
			{
				iLocal_64 = HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar0, &cVar0, false, 1, &cVar50, 0);
			}
			Global_22783 = 3;
			Global_22782 = iLocal_64;
			Global_22786 = 0;
...
void func_61()//Position - 0x3948
{
	if (iLocal_43[Global_20383] == 1)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			iLocal_63 = NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), iLocal_53[Global_20383]);
		}
		else
		{
			iLocal_58[Global_20383] = MISC::GET_GAME_TIMER();
			iLocal_63 = (iLocal_58[Global_20383] - iLocal_48[Global_20383]);
		}
		if (iLocal_63 > 300000)
		{
...
var func_71(int iParam0, int iParam1)//Position - 0x446C
{
	return BitTest(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

int func_72()//Position - 0x4484
{
	return -1;
}
...
int func_78(struct<6> Param0, struct<6> Param6)//Position - 0x462A
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
			...
			if (BitTest(Global_8254, 11))
			{
				if (iLocal_41)
				{
					...
					if (BitTest(Global_4542297, 19))
					{
						...
						GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(222f);
						if ((BitTest(Global_4542297, 12) || BitTest(Global_4542297, 11)) || BitTest(Global_8253, 25))
						{
...
void func_81(int iParam0, char* sParam1)//Position - 0x4A32
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
int func_86(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x4D50
{
	func_45();
	if (Global_78558 == 0)
	{
...
int func_96(bool bParam0)//Position - 0x54FC
{
	if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		return 0;
...
int func_99(int iParam0)//Position - 0x5633
{
	...
	else if ((iVar3 == Global_112619 || iVar3 == Global_112620) && func_107(67))
	{
		return 9;
	}
	iVar4 = 0;
...
void func_100(var uParam0)//Position - 0x5A5B
{
	int iVar0;
...
int func_102(int iParam0)//Position - 0x5DD1
{
	if (iParam0 >= 19)
	{
		return 0;
...
var func_103(int iParam0, var uParam1)//Position - 0x5DF2
{
	struct<5> Var0;
...
int func_106(int iParam0)//Position - 0x92F6
{
	int iVar0;
...
int func_107(int iParam0)//Position - 0x935E
{
	if (iParam0 == 94 || iParam0 == -1)
	{
		return 0;
...
Vector3 func_108(int iParam0)//Position - 0x938A
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_109()//Position - 0x939D
{
...
int func_116(int iParam0, int iParam1, bool bParam2)//Position - 0x95C0
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_117(int iParam0)//Position - 0x9621
{
	switch (iParam0)
	{
		case 0:
...
bool func_121(var uParam0, int iParam1)//Position - 0x99E7
{
	return (uParam0 && iParam1) != 0;
}

int func_122(bool bParam0)//Position - 0x99F6
{
...
int func_127(int iParam0)//Position - 0x9A77
{
...
int func_128(int iParam0, int iParam1, int iParam2)//Position - 0x9ADB
{
	int iVar0;
	var uVar1;
...
int func_129(var uParam0)//Position - 0x9B18
{
	int iVar0;
	int iVar1;
...
void func_131()//Position - 0x9B58
{
	if (Global_78558 == 0)
	{
		...
		if (Global_2694519)
		{
			if (func_34(14))
			{
				func_132(2, "CELL_2" /* GXT: Internet */, 2, "appInternet", 6, 1, 1, 0, 0);
				func_132(14, "CELL_29" /* GXT: Job List */, 7, "appMPJobListNEW", 12, 1, 1, 0, 0);
			}
			else
			{
				func_132(14, "CELL_29" /* GXT: Job List */, 2, "appMPJobListNEW", 12, 1, 1, 0, 0);
			}
		}
		else
		{
			func_132(4, "CELL_23" /* GXT: Check List */, 2, "appChecklist", 39, 1, 1, 0, 0);
		}
	}
}
...
void func_133()//Position - 0x9C9C
{
	...
	if (Global_78558 == 0)
	{
		...
		func_132(7, "CELL_5" /* GXT: Email */, 0, "appEmail", 4, 1, 1, 0, 0);
		func_132(1, "CELL_1" /* GXT: Texts */, 1, "appTextMessage", 2, 1, 1, 0, 0);
		func_132(4, "CELL_23" /* GXT: Check List */, 2, "appChecklist", 39, 1, 1, 0, 0);
		if ((Global_43257 == 15 && func_122(0) == 0) && Global_8258 == 0)
		{
			func_132(20, "CELL_32" /* GXT: Quick Save */, 3, "appSettings", 43, 1, 1, 0, 0);
			Global_20587 = 0;
			Global_8259 = 255;
		}
		else
		...
		if (iVar1 == 1)
		{
			func_132(0, "CELL_0" /* GXT: Contacts */, 4, "appContacts", 27, 1, 1, 0, 0);
		}
		else
		{
			func_132(0, "CELL_0" /* GXT: Contacts */, 4, "appContacts", 5, 1, 1, 0, 0);
		}
		func_132(10, "CELL_16" /* GXT: Settings */, 5, "appSettings", 24, 1, 1, 0, 0);
		func_132(3, "CELL_7" /* GXT: Snapmatic */, 6, "appCamera", 1, 1, 1, 0, 0);
		func_132(2, "CELL_2" /* GXT: Internet */, 7, "appInternet", 6, 1, 1, 0, 0);
		if (Global_113648.f_14053.f_89 == 1)
		{
			func_132(17, "CELL_28" /* GXT: Trackify */, 8, "appTrackify", 42, 1, 1, 0, 0);
		}
		if (Global_113648.f_14053.f_88 == 1)
		{
			func_132(16, "CELL_25" /* GXT: Sniper */, 0, "appContacts", 40, 2, 1, 0, 0);
		}
		func_132(25, "CELL_14" /* GXT: More Apps */, -99, "appContacts", 17, 2, 1, 0, 0);
		func_132(9, "CELL_13" /* GXT: BAWSAQ */, -99, "appContacts", 13, 2, 1, 0, 0);
		func_132(11, "CELL_14" /* GXT: More Apps */, -99, "appContacts", 8, 2, 1, 0, 0);
		func_132(27, "CELL_15" /* GXT: Spare */, -99, "appContacts", 17, 2, 1, 0, 0);
		func_132(28, "CELL_15" /* GXT: Spare */, -99, "appContacts", 17, 2, 1, 0, 0);
		func_132(29, "CELL_15" /* GXT: Spare */, -99, "appSettings", 17, 2, 1, 0, 0);
		func_132(30, "CELL_15" /* GXT: Spare */, -99, "appContacts", 17, 2, 1, 0, 0);
		func_132(31, "CELL_15" /* GXT: Spare */, -99, "appContacts", 17, 2, 1, 0, 0);
		func_132(32, "CELL_15" /* GXT: Spare */, -99, "appSettings", 17, 2, 1, 0, 0);
	}
	else
	{
		func_132(7, "CELL_5" /* GXT: Email */, 0, "appMPEmail", 4, 1, 1, 0, 0);
		func_132(10, "CELL_16" /* GXT: Settings */, 5, "appSettings", 24, 1, 1, 0, 0);
		func_132(1, "CELL_1" /* GXT: Texts */, 1, "appTextMessage", 2, 1, 1, 0, 0);
		func_132(3, "CELL_7" /* GXT: Snapmatic */, 6, "appCamera", 1, 1, 1, 0, 0);
		func_132(2, "CELL_2" /* GXT: Internet */, 7, "appInternet", 6, 1, 1, 0, 0);
		func_132(14, "CELL_29" /* GXT: Job List */, 4, "appMPJobListNEW", 12, 1, 1, 0, 0);
		func_132(0, "CELL_0" /* GXT: Contacts */, 2, "appContacts", 5, 1, 1, 0, 0);
		func_132(21, "CELL_37" /* GXT: Quick Join */, 3, "AppJIPMP", 14, 1, 1, 0, 0);
		if (BitTest(Global_4542297, 4) == 1)
		{
			func_132(17, "CELL_28" /* GXT: Trackify */, 8, "appTrackify", 42, 1, 1, 0, 0);
		}
		func_132(13, "CELL_35" /* GXT: Player List */, -99, "appMPCopBackup", 39, 1, 1, 0, 0);
		func_132(13, "CELL_20", -99, "appMPCopBackup", 16, 1, 1, 0, 0);
		func_132(15, "CELL_18" /* GXT: Map */, -99, "appContacts", 8, 1, 1, 0, 0);
		func_132(9, "CELL_13" /* GXT: BAWSAQ */, -99, "appContacts", 13, 2, 1, 0, 0);
		func_132(5, "CELL_4" /* GXT: Sidetasks */, -99, "appContacts", 12, 2, 1, 0, 0);
		func_132(23, "CELL_15" /* GXT: Spare */, 0, "appContacts", 17, 2, 1, 0, 0);
		func_132(24, "CELL_15" /* GXT: Spare */, 1, "appContacts", 17, 2, 1, 0, 0);
		func_132(25, "CELL_15" /* GXT: Spare */, 2, "appContacts", 17, 2, 1, 0, 0);
		func_132(26, "CELL_15" /* GXT: Spare */, 3, "appContacts", 17, 2, 1, 0, 0);
		func_132(27, "CELL_15" /* GXT: Spare */, 4, "appContacts", 17, 2, 1, 0, 0);
		func_132(28, "CELL_15" /* GXT: Spare */, 5, "appContacts", 17, 2, 1, 0, 0);
		func_132(29, "CELL_15" /* GXT: Spare */, 6, "appContacts", 17, 2, 1, 0, 0);
		func_132(30, "CELL_15" /* GXT: Spare */, 7, "appContacts", 17, 2, 1, 0, 0);
		func_132(31, "CELL_15" /* GXT: Spare */, 8, "appContacts", 17, 2, 1, 0, 0);
		func_132(32, "CELL_15" /* GXT: Spare */, 9, "appContacts", 17, 2, 1, 0, 0);
		func_132(33, "CELL_15" /* GXT: Spare */, 10, "appContacts", 17, 2, 1, 0, 0);
		if (!BitTest(Global_4542297, 4) == 1)
		{
			if (Global_1836102)
			{
				func_132(23, "CELL_CIRCBREAK" /* GXT: VLSI Unlock */, 8, "AppVLSI", 54, 1, 1, 0, 0);
			}
			else if (BitTest(Global_4542297, 20) == 1)
			{
				func_132(23, "CELL_SIGHTS" /* GXT: Sightseer */, 8, "AppSettings", 59, 1, 1, 0, 0);
			}
			else if (BitTest(Global_4542297, 22) == 1)
			{
				func_132(23, "CELL_EXTRACT" /* GXT: Extraction */, 8, "AppExtraction", 58, 1, 1, 0, 0);
			}
			else if (BitTest(Global_4542297, 26) == 1)
			{
				if (func_134())
				{
					func_132(23, "CELL_0" /* GXT: Contacts */, -99, "appContacts", 5, 1, 1, 0, 0);
				}
				else
				{
					func_132(23, "CELL_SECHACK" /* GXT: SecuroServ Hack */, 8, "AppSecuroHack", 57, 1, 1, 0, 0);
				}
			}
		}
		if ((((BitTest(Global_4542297, 4) == 0 && Global_1836102 == 0) && BitTest(Global_4542297, 20) == 0) && BitTest(Global_4542297, 22) == 0) && BitTest(Global_4542297, 26) == 0)
		{
			...
			{
				func_132(23, "CELL_BOSSAGE" /* GXT: SecuroServ */, 8, "appMPBossAgency", 57, 1, 1, 0, 0);
			}
		}
	}
}

int func_134()//Position - 0xA24C
{
	if (Global_78558)
	{
...
int func_135(int iParam0, int iParam1)//Position - 0xA273
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
