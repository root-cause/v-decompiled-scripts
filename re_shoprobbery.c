...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_41 = 49;
	iLocal_42 = 64;
	Local_71 = { -824.1719f, -187.654f, 36.5707f };
	Local_72 = { -1202.94f, -779.74f, 17.33f };
	Local_48 = { ScriptParam_316.f_1[0 /*3*/] };
	func_248();
	...
	if (func_202(Local_48, 5, bLocal_73, 0, 0))
	{
		func_199(5);
	}
	else
						...
						switch (iLocal_44)
						{
								...
								else
								{
									...
									if (func_172())
									{
										if (!iLocal_94)
										{
											if (iLocal_47 == 1)
											{
												if (func_171(&uLocal_151, "REROBAU", "REROB_CH2", "REROB_CH2_1", 4, 0, 0))
												{
													iLocal_94 = 1;
												}
											}
											...
											{
												if (func_171(&uLocal_151, "REROBAU", "REROB_CH", "REROB_CH_1", 4, 0, 0))
												{
													iLocal_94 = 1;
												}
											}
									...
									if (func_170())
									{
										...
										while (iVar0 < iLocal_66)
										{
											if (!PED::IS_PED_INJURED(iLocal_66[iVar0]))
											{
												...
												{
													uLocal_116[iVar0] = func_169(iLocal_66[iVar0], 1, 145);
												}
											}
											iVar0++;
										}
									...
									if (func_168())
									{
										func_161(1);
										SYSTEM::SETTIMERA(0);
										EVENT::ADD_SHOCKING_EVENT_AT_POSITION(90 /*EVENT_SHOCKING_GUN_FIGHT*/, Local_123, 15000f);
										iLocal_44 = 1;
									}
								}
								break;
							...
							case 1:
								...
								while (iVar1 < iLocal_67)
								{
									...
									{
										if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_67[iVar1], PLAYER::PLAYER_PED_ID(), true))
										{
											func_160();
										}
									}
								...
								while (iVar1 < iLocal_68)
								{
									...
									{
										if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_68[iVar1], PLAYER::PLAYER_PED_ID(), true))
										{
											func_160();
										}
									}
								...
								switch (iLocal_45)
								{
									...
									case 2:
										...
										if (MISC::IS_PROJECTILE_IN_AREA(Local_123 - Vector(20f, 20f, 20f), Local_123 + Vector(20f, 20f, 20f), false))
										{
											if (!PED::IS_PED_INJURED(iLocal_67[1]))
											{
												TASK::TASK_SMART_FLEE_COORD(iLocal_67[1], Local_59, 150f, -1, false, false);
											...
											{
												TASK::TASK_SMART_FLEE_COORD(iLocal_67[2], Local_59, 150f, -1, false, false);
											...
											while (iVar2 <= (iLocal_65 - 1))
											{
												if (!PED::IS_PED_INJURED(iLocal_68[iVar2]))
												{
													...
													TASK::TASK_SMART_FLEE_COORD(0, Local_59, 150f, -1, false, false);
										...
										if (func_148() || SYSTEM::TIMERA() > 20000)
										{
											if (!iLocal_99)
											{
												if (!ENTITY::IS_ENTITY_DEAD(iLocal_66[0], false))
												{
													...
													if (iLocal_47 == 1)
													{
														if (ENTITY::DOES_ENTITY_EXIST(iLocal_102))
														{
															ENTITY::SET_ENTITY_VISIBLE(iLocal_102, false, false);
															ENTITY::SET_ENTITY_COLLISION(iLocal_102, false, false);
														}
													}
													else if (iLocal_47 == 2)
													{
										...
										if (iLocal_47 == 1)
										{
											...
											if (!PED::IS_PED_INJURED(iLocal_66[0]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_106, false))
											{
												if (PED::IS_PED_IN_VEHICLE(iLocal_66[0], iLocal_106, false))
												{
													if (ENTITY::DOES_ENTITY_EXIST(iLocal_102))
													{
														OBJECT::DELETE_OBJECT(&iLocal_102);
											...
											if (func_113() && !iLocal_97)
											{
												...
												if (!PED::IS_PED_INJURED(iLocal_115))
												{
													...
													TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_115, iLocal_106, PLAYER::PLAYER_PED_ID(), 8, 16f, 786469, -1f, -1f, true);
											...
											{
												if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_106, false) && !PED::IS_PED_INJURED(iLocal_115))
												{
													if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_106, Local_51[0 /*3*/], 20f, 20f, 10f, false, true, 0))
													{
														TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_115, iLocal_106, PLAYER::PLAYER_PED_ID(), 8, 19f, 786469, -1f, -1f, true);
														iLocal_143 = 1;
													}
												}
											}
											if (func_110())
											{
												if (!PED::IS_PED_INJURED(iLocal_115))
												{
													if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_106, false))
													{
														if (!iLocal_98)
														{
															PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_115, 17, true);
															PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_115, 6, true);
															PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_115, 1, true);
															TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_115, iLocal_106, PLAYER::PLAYER_PED_ID(), 8, 17f, 786469, -1f, -1f, true);
															iLocal_98 = 1;
														}
												...
												while (iVar3 <= (iLocal_63 - 1))
												{
													if (!iLocal_80[iVar3])
													{
														if (!PED::IS_PED_INJURED(iLocal_66[iVar3]))
														{
															...
															else if (!HUD::DOES_BLIP_EXIST(iLocal_121))
															{
																...
																{
																	uLocal_116[iVar3] = func_169(iLocal_66[iVar3], 1, 145);
																}
																iLocal_80[iVar3] = 1;
															}
														}
													...
													if (!iLocal_81[iVar3])
													{
														if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_106, false))
														{
															if (!PED::IS_PED_INJURED(iLocal_66[iVar3]))
															{
																if ((PED::IS_PED_INJURED(iLocal_115) || VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_106, -1, false)) || FIRE::IS_ENTITY_ON_FIRE(iLocal_66[iVar3]))
																{
										...
										else if (iLocal_47 == 2)
										{
											...
											if (PED::IS_PED_INJURED(iLocal_66[0]))
											{
												if (ENTITY::DOES_ENTITY_EXIST(iLocal_102))
												{
													if (ENTITY::IS_ENTITY_ATTACHED(iLocal_102))
													{
														ENTITY::DETACH_ENTITY(iLocal_102, true, true);
													}
													OBJECT::DELETE_OBJECT(&iLocal_102);
													func_108();
													func_105();
											...
											else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_66[0], PLAYER::PLAYER_PED_ID(), true))
											{
												if (ENTITY::DOES_ENTITY_EXIST(iLocal_102))
												{
													if (ENTITY::IS_ENTITY_ATTACHED(iLocal_102))
									...
									case 10:
										...
										if (iLocal_47 == 1)
										{
											if (!iLocal_95)
											{
												...
												{
													ENTITY::SET_ENTITY_COORDS(iLocal_67[0], -818.5553f, -185.4815f, 36.5689f, true, false, false, true);
													ENTITY::SET_ENTITY_HEADING(iLocal_67[0], 47.0582f);
													TASK::TASK_PLAY_ANIM(iLocal_67[0], "random@robbery", "stand_worried_female", 8f, -8f, -1, 9, 0f, false, false, false);
													if (!PED::IS_PED_INJURED(iLocal_67[1]))
													{
														TASK::TASK_SMART_FLEE_COORD(iLocal_67[1], Local_59, 150f, -1, false, false);
														PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_67[1], false);
										...
										else if (iLocal_47 == 2)
										{
											if (!iLocal_95)
											{
												...
												{
													ENTITY::SET_ENTITY_COORDS(iLocal_67[0], -1197.4552f, -776.0289f, 16.3254f, true, false, false, true);
													...
													while (iVar5 <= (iLocal_65 - 1))
													{
														...
														{
															TASK::TASK_SMART_FLEE_COORD(iLocal_68[iVar5], Local_59, 150f, -1, false, false);
										...
										if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_248()) > (fLocal_124 + 150f))
										{
											iLocal_45 = 12;
										}
										...
										else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_67[0], PLAYER::PLAYER_PED_ID(), true))
										{
											func_73(2);
											func_53();
										}
...
void func_1()//Position - 0x122B
{
	...
	if (bLocal_112)
	{
		if (!iLocal_114)
		{
			...
			Local_125 = { ENTITY::GET_ENTITY_COORDS(iLocal_67[0], false) };
			if (iLocal_47 == 1)
			{
				Local_125 = { -820.77f, -186.514f, 36.569f };
				Local_127 = { 0f, 0f, -60f };
				fLocal_136 = 0.855f;
			...
			{
				Local_125 = { -1198.295f, -776.533f, 16.326f };
				Local_127 = { 0f, 0f, -60.25f };
				fLocal_136 = 0.785f;
				sLocal_130 = "random@robbery";
			...
			iLocal_135 = PED::CREATE_SYNCHRONIZED_SCENE(Local_125, Local_127, 2);
			...
			TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_135, sLocal_130, sLocal_131, 1000f, -2f, 5, 0, 1000f, 0);
			PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), false, false);
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_67[0]);
			TASK::TASK_SYNCHRONIZED_SCENE(iLocal_67[0], iLocal_135, sLocal_130, sLocal_132, 1000f, -2f, 4, 0, 1000f, 0);
			PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_67[0], false, false);
			...
			ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_102, iLocal_135, sLocal_133, sLocal_130, 1000f, 8f, 0, 1000f);
			if (!PED::IS_PED_INJURED(iLocal_67[0]))
			{
				func_52();
...
void func_2(int iParam0, bool bParam1, bool bParam2)//Position - 0x160D
{
	int iVar0;
...
void func_3(int iParam0, int iParam1, bool bParam2)//Position - 0x1679
{
	int iVar0;
...
void func_4(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x16EB
{
	int iVar0;
...
int func_5(var uParam0)//Position - 0x171B
{
	int iVar0;
	int iVar1;
...
int func_6()//Position - 0x174F
{
	return Global_1574918;
}

int func_7(int iParam0, int iParam1, int iParam2)//Position - 0x175B
{
	int iVar0;
	var uVar1;
...
int func_8(int iParam0)//Position - 0x1798
{
	switch (iParam0)
	{
		case 0:
...
int func_9()//Position - 0x1B31
{
	return Global_32163;
}

void func_10(int iParam0, int iParam1, bool bParam2)//Position - 0x1B3C
{
	int iVar0;
...
int func_11(int iParam0, int iParam1, bool bParam2)//Position - 0x1BAE
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_12(bool bParam0, int iParam1, int iParam2)//Position - 0x1C0F
{
...
int func_13(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x1C43
{
	float fVar0;
	bool bVar1;
	int iVar2;
...
void func_14(bool bParam0)//Position - 0x2242
{
	int iVar0;
	int iVar1;
...
void func_15(int iParam0)//Position - 0x24C4
{
	int iVar0;
...
void func_16(bool bParam0)//Position - 0x251E
{
	bool bVar0;
	char cVar1[64];
	...
	else if (BitTest(Global_113648.f_20566.f_471, bParam0) || BitTest(Global_2359296[func_18() /*5568*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_18() /*5568*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED" /* GXT: You have redeemed your promotion for ~a~ */);
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_17(bParam0));
		HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar1, &cVar1, true, 0, "", 0);
	}
}

char* func_17(bool bParam0)//Position - 0x269E
{
	switch (bParam0)
	{
		case 0:
...
void func_19(int iParam0, bool bParam1, int iParam2)//Position - 0x27AE
{
	if (iParam2 == -1)
	{
		iParam2 = func_6();
...
void func_20(int iParam0)//Position - 0x27CC
{
	func_39(93, iParam0);
	func_39(29, iParam0);
	func_39(30, iParam0);
...
int func_21(int iParam0)//Position - 0x27EC
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	return BitTest(Global_2359296[func_18() /*5568*/].f_681.f_10, iParam0);
}

bool func_22(int iParam0, int iParam1)//Position - 0x2992
{
	if (iParam1 == -1)
	{
		iParam1 = func_6();
...
int func_23(bool bParam0)//Position - 0x29AE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_24(int iParam0, int iParam1)//Position - 0x2A65
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_25(int iParam0, int iParam1)//Position - 0x2A80
{
...
int func_26(var uParam0, int iParam1)//Position - 0x2B1D
{
	int iVar0;
	var uVar1[78];
...
int func_27(var uParam0, int iParam1)//Position - 0x2BCE
{
	int iVar0;
...
bool func_28(var uParam0, int iParam1)//Position - 0x2C49
{
	return (*uParam0)[iParam1] == 78;
}

void func_29(var uParam0)//Position - 0x2C5A
{
	int iVar0;
	...
	func_31(uParam0, (Global_4542596 - 0.5f));
}

void func_30(var uParam0, int iParam1)//Position - 0x2C8E
{
	(*uParam0)[iParam1] = 78;
}

void func_31(var uParam0, float fParam1)//Position - 0x2C9E
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_32(var uParam0)//Position - 0x2CBB
{
	return uParam0->f_80;
}

bool func_33(var uParam0, int iParam1)//Position - 0x2CC7
{
	return func_34(uParam0, iParam1) != -1;
}

int func_34(var uParam0, int iParam1)//Position - 0x2CD9
{
	int iVar0;
...
bool func_35(var uParam0)//Position - 0x2D06
{
	return uParam0->f_79 == 1;
}

int func_36(int iParam0)//Position - 0x2D14
{
	switch (iParam0)
	{
		case 60:
...
bool func_37(int iParam0)//Position - 0x2D64
{
	return Global_43257 == iParam0;
}

int func_38(int iParam0, int iParam1)//Position - 0x2D72
{
	int iVar0;
...
void func_39(int iParam0, int iParam1)//Position - 0x2DC3
{
	int iVar0;
...
int func_41(int iParam0)//Position - 0x2E95
{
	return Global_2028[iParam0 /*29*/].f_17;
}

bool func_42()//Position - 0x2EA6
{
	func_43();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_43()//Position - 0x2EBF
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_46(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_44(iVar0) && (!func_37(14) || Global_112599))
			{
				if (Global_113648.f_2365.f_539.f_4321 != iVar0 && func_44(Global_113648.f_2365.f_539.f_4321))
				{
...
bool func_44(bool bParam0)//Position - 0x2FBC
{
	return bParam0 < 3;
}

int func_45(int iParam0)//Position - 0x2FC8
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x3005
{
	if (func_44(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x302A
{
	return Global_2028[iParam0 /*29*/];
}

void func_48(int iParam0, int iParam1)//Position - 0x3039
{
	int iVar0;
...
void func_49()//Position - 0x305C
{
	if (iLocal_47 == 1)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_68[2]))
		{
			...
			{
				ENTITY::SET_ENTITY_COORDS(iLocal_68[2], -820.424f, -181.9059f, 36.5687f, true, false, false, true);
...
void func_50()//Position - 0x3170
{
	Global_20591 = 0;
	func_51();
}

void func_51()//Position - 0x3180
{
...
int func_56(bool bParam0)//Position - 0x3389
{
...
void func_57(int iParam0, bool bParam1)//Position - 0x33B1
{
	if (iParam0 == -1)
	{
		iParam0 = func_70();
	...
	if (bParam1 <= func_69(iParam0))
	{
		...
		if (!func_67(51))
		{
			func_63("RE_REWARD" /* GXT: Some Random Events will reward the player with stat boosts or money. */, 1, 0, 4000, 10000, func_66(), 0, 138, 0);
			func_62(51);
		}
		if (func_61(iParam0))
		{
...
void func_58(int iParam0, var uParam1, var uParam2)//Position - 0x34B5
{
	bool bVar0;
...
void func_59()//Position - 0x359B
{
	...
	{
		func_38(13, SYSTEM::FLOOR(Global_113648.f_10196.f_3853));
	}
...
int func_60(int iParam0, int iParam1)//Position - 0x3A59
{
	switch (iParam0)
	{
		case 0:
...
int func_61(int iParam0)//Position - 0x3DCD
{
	switch (iParam0)
	{
		case 29:
...
void func_62(int iParam0)//Position - 0x3DFC
{
	int iVar0;
	int iVar1;
...
void func_63(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x3E3E
{
	func_64(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_64(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x3E60
{
	int iVar0;
...
int func_67(int iParam0)//Position - 0x4193
{
	int iVar0;
	int iVar1;
...
void func_68(int iParam0, int iParam1)//Position - 0x41D3
{
	MISC::SET_BIT(&(Global_113648.f_24997.f_8[iParam0]), iParam1);
}

int func_69(int iParam0)//Position - 0x41EE
{
	int iVar0;
...
int func_71(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x42BC
{
...
int func_72()//Position - 0x4496
{
	return 1;
}

void func_73(int iParam0)//Position - 0x449F
{
	Global_113634 = iParam0;
}

void func_74(int iParam0, int iParam1)//Position - 0x44AD
{
	int iVar0;
...
void func_75(int iParam0)//Position - 0x459A
{
...
void func_76(int iParam0)//Position - 0x45E5
{
	struct<7> Var0;
	bool bVar1;
	bool bVar2;
...
int func_78(int iParam0)//Position - 0x4B29
{
	bool bVar0;
...
int func_79(int iParam0)//Position - 0x4D51
{
	int iVar0;
...
int func_80(int iParam0)//Position - 0x4DBD
{
	return iParam0;
}

void func_81(int iParam0, var uParam1)//Position - 0x4DC7
{
	int iVar0;
	int iVar1;
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_82(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_91469[26 /*34*/].f_6) == 0)
			{
				Global_113648.f_7263[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_113648.f_7263[iParam0], true, true);
			}
...
bool func_82(int iParam0)//Position - 0x575F
{
	struct<7> Var0;
	int iVar1;
...
int func_83(int iParam0)//Position - 0x5793
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_84()//Position - 0x57A6
{
	var uVar0;
...
void func_85(var uParam0, int iParam1)//Position - 0x57EC
{
	if (iParam1 <= 0)
	{
		return;
...
void func_86(var uParam0, int iParam1)//Position - 0x5872
{
...
void func_87(var uParam0, int iParam1)//Position - 0x58A5
{
	int iVar0;
	int iVar1;
...
int func_88(int iParam0, int iParam1)//Position - 0x58F6
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_89(int iParam0)//Position - 0x5998
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_90(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_90(bool bParam0, int iParam1, int iParam2)//Position - 0x59BA
{
	if (bParam0)
	{
		return iParam1;
...
int func_91(int iParam0)//Position - 0x59D1
{
	return iParam0 & 15;
}

void func_92(var uParam0, int iParam1)//Position - 0x59DE
{
...
void func_93(var uParam0, int iParam1)//Position - 0x5A18
{
...
void func_94(var uParam0, int iParam1)//Position - 0x5A53
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
struct<7> func_95(int iParam0)//Position - 0x5A8F
{
	struct<7> Var0;
...
int func_97()//Position - 0x86C9
{
	return Global_32164;
}

void func_98(int iParam0, var uParam1)//Position - 0x86D4
{
	int iVar0;
	int iVar1;
...
void func_99(int iParam0)//Position - 0x8773
{
	switch (iParam0)
	{
		case 0:
...
void func_100(char* sParam0, int iParam1)//Position - 0x884E
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

char* func_101(int iParam0)//Position - 0x8865
{
	char* sVar0;
...
void func_102()//Position - 0x88A9
{
	if (OBJECT::HAS_PICKUP_BEEN_COLLECTED(iLocal_62))
	{
		...
		func_103(&uLocal_148);
		fLocal_124 = SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_248());
		SYSTEM::SETTIMERA(0);
		iLocal_45 = 10;
	}
...
void func_103(var uParam0)//Position - 0x892A
{
	*uParam0 = -99;
}

void func_104(var uParam0, int iParam1)//Position - 0x8938
{
	...
	if (!OBJECT::DOES_PICKUP_EXIST(iLocal_62))
	{
		...
		if (!bLocal_96)
		{
			if (ENTITY::IS_ENTITY_DEAD(iLocal_66[0], false))
			{
				...
				{
					Local_61 = { PED::GET_DEAD_PED_PICKUP_COORDS(iLocal_66[0], 1.2f, 1.5f) };
				}
			}
			else
			{
				Local_61 = { OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_66[0], true), 1.2f, 1.5f) };
			}
		}
...
int func_106(int iParam0)//Position - 0x8AF2
{
	int iVar0;
...
float func_107(bool bParam0, float fParam1, float fParam2)//Position - 0x8B2A
{
	if (bParam0)
	{
		return fParam1;
...
int func_109()//Position - 0x8BA0
{
	...
	else if (PED::IS_PED_INJURED(iLocal_115) || !PED::IS_PED_IN_ANY_VEHICLE(iLocal_115, false))
	{
		iLocal_86 = 1;
	}
...
int func_110()//Position - 0x8C3B
{
	...
	while (iVar0 <= (iLocal_63 - 1))
	{
		...
		{
			if (!PED::IS_PED_INJURED(iLocal_66[iVar0]) || ENTITY::IS_ENTITY_DEAD(iLocal_66[iVar0], false))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_66[iVar0], PLAYER::PLAYER_PED_ID(), true))
				{
					return 1;
				}
			}
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_66[iVar0]))
		{
			if (!PED::IS_PED_INJURED(iLocal_66[iVar0]))
			{
				if (PED::IS_PED_BEING_JACKED(iLocal_66[iVar0]))
				{
					...
					{
						ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_66[iVar0], true, 1);
						TASK::TASK_SMART_FLEE_PED(iLocal_66[iVar0], PLAYER::PLAYER_PED_ID(), 250f, -1, false, false);
						PED::SET_PED_KEEP_TASK(iLocal_66[iVar0], true);
						SYSTEM::WAIT(0);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_115))
	{
		if (!PED::IS_PED_INJURED(iLocal_115) || ENTITY::IS_ENTITY_DEAD(iLocal_115, false))
		{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_115))
	{
		if (!PED::IS_PED_INJURED(iLocal_115))
		{
			if (PED::IS_PED_BEING_JACKED(iLocal_115))
			{
				...
				{
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_115, true, 1);
					TASK::TASK_SMART_FLEE_PED(iLocal_115, PLAYER::PLAYER_PED_ID(), 250f, -1, false, false);
					PED::SET_PED_KEEP_TASK(iLocal_115, true);
					SYSTEM::WAIT(0);
	...
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_106, false) || ENTITY::IS_ENTITY_DEAD(iLocal_106, false))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_106, PLAYER::PLAYER_PED_ID(), true))
			{
				return 1;
			}
		}
...
int func_111(int iParam0, bool bParam1, bool bParam2)//Position - 0x8E05
{
	return func_112(iParam0, !bParam1, bParam2);
}

int func_112(int iParam0, bool bParam1, bool bParam2)//Position - 0x8E18
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_106, false))
	{
		if (!PED::IS_PED_INJURED(iLocal_66[0]))
		{
			if (PED::IS_PED_IN_VEHICLE(iLocal_66[0], iLocal_106, false))
			{
				if (!PED::IS_PED_INJURED(iLocal_66[1]))
				{
					if (PED::IS_PED_IN_VEHICLE(iLocal_66[1], iLocal_106, false))
					{
						return 1;
					}
				}
...
int func_115(int iParam0)//Position - 0x8F8B
{
	int iVar0;
	int iVar1;
...
bool func_116(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8FDB
{
...
int func_117(char* sParam0, int iParam1, bool bParam2)//Position - 0x9029
{
	Global_21726 = 0;
...
bool func_120(int iParam0)//Position - 0x9391
{
	return func_121(iParam0, 20);
}

var func_121(int iParam0, int iParam1)//Position - 0x93A1
{
	return BitTest(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

int func_122()//Position - 0x93B9
{
	return -1;
}

void func_123()//Position - 0x93C2
{
	int iVar0;
...
bool func_129(int iParam0, int iParam1)//Position - 0x9643
{
	switch (iParam0)
	{
		case 5:
...
void func_131(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x96D2
{
...
void func_133(bool bParam0)//Position - 0x974A
{
	if (bParam0)
	{
		func_139();
...
void func_134(int iParam0)//Position - 0x97AD
{
	if (func_137())
	{
		return;
...
void func_135(bool bParam0, bool bParam1)//Position - 0x9837
{
	if (bParam0)
	{
		if (func_138(0))
...
bool func_136()//Position - 0x98AB
{
	return BitTest(Global_1962996, 5);
}

bool func_137()//Position - 0x98B9
{
	return BitTest(Global_1962996, 19);
}

int func_138(int iParam0)//Position - 0x98C8
{
	if (iParam0 == 1)
	{
		if (Global_20383.f_1 > 3)
...
void func_140(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x9948
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_144(PLAYER::PLAYER_ID())) && !func_142(PLAYER::PLAYER_ID(), 0)) && !func_141()) && !bParam4) && !bParam5) && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
			{
...
bool func_141()//Position - 0x9A95
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_142(int iParam0, int iParam1)//Position - 0x9AAF
{
	bool bVar0;
...
int func_143(int iParam0, bool bParam1)//Position - 0x9AFA
{
	int iVar0;
	int iVar1;
...
int func_144(int iParam0)//Position - 0x9B3B
{
...
bool func_145()//Position - 0x9B7A
{
	return BitTest(Global_2621446, 3);
}

int func_146(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x9B88
{
	int iVar0;
...
void func_147(int iParam0)//Position - 0x9BBB
{
	if (iParam0 == 1)
	{
...
int func_148()//Position - 0x9BDE
{
	if (!PED::IS_PED_INJURED(iLocal_66[0]) && !PED::IS_PED_INJURED(iLocal_66[1]))
	{
		if (iLocal_47 == 1)
		{
			if (!iLocal_100)
			{
				if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_66[0], -823.5066f, -187.34647f, 40.36355f, -803.6377f, -175.94965f, 36.433704f, 11.9375f, false, true, 0))
				{
					iLocal_100 = 1;
				}
			}
			if (!iLocal_101)
			{
				if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_66[1], -823.5066f, -187.34647f, 40.36355f, -803.6377f, -175.94965f, 36.433704f, 11.9375f, false, true, 0))
				{
					iLocal_101 = 1;
				}
			}
		...
		else if (iLocal_47 == 2)
		{
			if (!iLocal_100)
			{
				if ((!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_66[0], -1204.0306f, -779.62897f, 16.335648f, -1174.7986f, -757.0704f, 21.012814f, 12.125f, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_66[0], -1206.5447f, -777.8941f, 21.203548f, -1204.3134f, -778.2245f, 16.08434f, 2.25f, false, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_66[0], -1202.9276f, -782.6883f, 21.203688f, -1202.583f, -780.50665f, 16.082426f, 2.25f, false, true, 0))
				{
					TASK::TASK_SMART_FLEE_PED(iLocal_66[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
					iLocal_100 = 1;
				}
			}
			if (!iLocal_101)
			{
				if ((!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_66[1], -1204.0306f, -779.62897f, 16.335648f, -1174.7986f, -757.0704f, 21.012814f, 12.125f, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_66[1], -1206.5447f, -777.8941f, 21.203548f, -1204.3134f, -778.2245f, 16.08434f, 2.25f, false, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_66[1], -1202.9276f, -782.6883f, 21.203688f, -1202.583f, -780.50665f, 16.082426f, 2.25f, false, true, 0))
				{
					TASK::TASK_SMART_FLEE_PED(iLocal_66[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
					iLocal_101 = 1;
				}
			}
		}
...
void func_149()//Position - 0x9E10
{
	struct<3> Var0;
	struct<3> Var1;
	
	Var0 = { ENTITY::GET_ENTITY_COORDS(iLocal_102, true) };
	Var1 = { ENTITY::GET_ENTITY_ROTATION(iLocal_102, 2) };
	OBJECT::DELETE_OBJECT(&iLocal_102);
	iLocal_102 = OBJECT::CREATE_OBJECT(joaat("prop_cs_duffel_01"), Var0, true, true, false);
	ENTITY::SET_ENTITY_ROTATION(iLocal_102, Var1, 2, true);
}

void func_150()//Position - 0x9E52
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_66[0]))
	{
	...
	if (!bLocal_79)
	{
		if (!func_132())
		{
			if (iLocal_90 && !iLocal_91)
			{
				if (iLocal_47 == 1)
				{
					if (func_171(&uLocal_151, "REROBAU", "REROB_CH2", "REROB_CH2_3", 4, 0, 0))
					{
						iLocal_91 = 1;
					}
				}
				...
				{
					if (func_171(&uLocal_151, "REROBAU", "REROB_CH", "REROB_CH_3", 4, 0, 0))
					{
						iLocal_91 = 1;
					}
				}
			...
			if (iLocal_47 == 1)
			{
				if (SYSTEM::TIMERA() > 14100)
				{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_106, false))
					{
						...
						if (!PED::IS_PED_INJURED(iLocal_66[1]))
						{
							PED::FORCE_PED_MOTION_STATE(iLocal_66[1], joaat("MotionState_Run"), true, 0, false);
							TASK::OPEN_SEQUENCE_TASK(&iLocal_87);
							TASK::TASK_CLEAR_LOOK_AT(0);
...
Vector3 func_155(int iParam0)//Position - 0xA690
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_156()//Position - 0xA6A3
{
	int iVar0;
	
	if (!iLocal_75 && func_159(1, 0, 1))
	{
		if (HUD::DOES_BLIP_EXIST(iLocal_122))
		{
			HUD::REMOVE_BLIP(&iLocal_122);
		...
		if (iLocal_47 == 1)
		{
			if (!iLocal_108)
			{
				iLocal_135 = PED::CREATE_SYNCHRONIZED_SCENE(Local_126, Local_128, 2);
				TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_135, "random@shop_robbery", "robbery_action_p", 8f, -8f, 1, 0, 1000f, 0);
				...
				{
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_66[0], iLocal_135, "random@shop_robbery", "robbery_action_b", 8f, -8f, 1, 0, 1000f, 0);
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_66[1], iLocal_135, "random@shop_robbery", "robbery_action_a", 8f, -8f, 1, 0, 1000f, 0);
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_67[0], iLocal_135, "random@shop_robbery", "robbery_action_f", 8f, -4f, 0, 0, 1000f, 0);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_102, iLocal_135, "robbery_action_bag", "random@shop_robbery", 8f, -8f, 0, 1000f);
				}
		...
		else if (iLocal_47 == 2)
		{
			...
			{
				TASK::CLEAR_PED_TASKS(iLocal_67[0]);
				TASK::TASK_PLAY_ANIM(iLocal_67[0], "random@robbery", "robbery_main_female", 2f, -2f, -1, 0, 0f, false, false, false);
			}
			STREAMING::NEW_LOAD_SCENE_START_SPHERE(-1195.0616f, -773.2098f, 16.324f, 20f, 4);
			iLocal_135 = PED::CREATE_SYNCHRONIZED_SCENE(Local_126, Local_128, 2);
			if (((!PED::IS_PED_INJURED(iLocal_66[0]) && !PED::IS_PED_INJURED(iLocal_66[1])) && !PED::IS_PED_INJURED(iLocal_67[0])) && ENTITY::DOES_ENTITY_EXIST(iLocal_102))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_66[0], iLocal_135, "random@shop_robbery", "robbery_action_b", 2f, -2f, 1, 0, 1000f, 0);
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_67[0], iLocal_135, "random@shop_robbery", "robbery_action_f", 2f, -2f, 0, 0, 1000f, 0);
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_103[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_103[1]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_103[0], iLocal_67[0], PED::GET_PED_BONE_INDEX(iLocal_67[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, true, true, false, false, 2, true, 0);
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_103[1], iLocal_67[0], PED::GET_PED_BONE_INDEX(iLocal_67[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, true, true, false, false, 2, true, 0);
				}
			}
			PED::SET_SYNCHRONIZED_SCENE_PHASE(iLocal_135, 0.05f);
			Local_126 = { -1199.369f, -776.1991f, 16.3235f };
			Local_128 = { 0f, 0f, -60f };
			iLocal_135 = PED::CREATE_SYNCHRONIZED_SCENE(Local_126, Local_128, 2);
			if (!PED::IS_PED_INJURED(iLocal_66[1]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_66[1], iLocal_135, "random@shop_robbery", "robbery_action_a", 2f, -2f, 1, 0, 1000f, 0);
			}
			PED::SET_SYNCHRONIZED_SCENE_PHASE(iLocal_135, 0.06f);
...
void func_157()//Position - 0xAADE
{
	...
	else if (STREAMING::HAS_MODEL_LOADED(iVar0))
	{
		if (func_158())
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_104, -828.3692f, -194.46695f, 36.413845f, -824.58014f, -201.13535f, 39.394363f, 4.3125f, false, true, 0))
			{
				Local_105 = { -822.1784f, -205.811f, 36.3444f };
			}
			else
			{
				Local_105 = { -826.2828f, -197.8547f, 36.3995f };
			}
		}
		else
		{
		...
		iLocal_106 = VEHICLE::CREATE_VEHICLE(iVar0, Local_105, 31.9252f, true, true, false);
...
int func_158()//Position - 0xAC24
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
	{
		if (ENTITY::IS_ENTITY_AT_COORD(iVar0, -829.3693f, -191.9869f, 36.4616f, 15f, 15f, 5f, false, true, 0))
		{
			...
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_104, true, false);
			}
			return 1;
		}
	}
...
int func_159(bool bParam0, bool bParam1, bool bParam2)//Position - 0xAC7D
{
	int iVar0;
...
void func_160()//Position - 0xAD62
{
	func_234();
}

int func_161(int iParam0)//Position - 0xAD6E
{
	if (func_162())
	{
		Global_113638 = 1;
		Global_113635 = MISC::GET_GAME_TIMER();
		if (func_61(Global_113637))
		{
			func_99(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /* GXT: Random Event */);
		if (iParam0 && func_61(Global_113637))
		{
...
int func_162()//Position - 0xADC1
{
	switch (func_163(&Global_32223, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_163(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xADF7
{
	int iVar0;
...
void func_164(var uParam0, int iParam1)//Position - 0xAF2E
{
	int iVar0;
...
bool func_165(int iParam0)//Position - 0xAF7D
{
	return func_166(iParam0, Global_43257);
}

int func_166(int iParam0, int iParam1)//Position - 0xAF8E
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_167(int iParam0)//Position - 0xB16F
{
	if (Global_43257 == 15)
	{
		return 0;
...
int func_169(int iParam0, bool bParam1, int iParam2)//Position - 0xB2E3
{
	int iVar0;
...
int func_170()//Position - 0xB32D
{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -823.1281f, -187.9591f, 36.6189f, 12f, 12f, 12f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1201.0172f, -777.5527f, 16.3398f, 12f, 12f, 12f, false, true, 0))
	{
		if (!PED::IS_PED_INJURED(iLocal_66[0]) && !PED::IS_PED_INJURED(iLocal_66[1]))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_66[0], PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_66[1], PLAYER::PLAYER_PED_ID(), true))
			{
				return 1;
			}
	...
	if (FIRE::IS_EXPLOSION_IN_AREA(-1, Local_123 - Vector(20f, 20f, 20f), Local_123 + Vector(20f, 20f, 20f)))
	{
		return 1;
	}
	if (ENTITY::IS_ENTITY_DEAD(iLocal_66[0], false) || ENTITY::IS_ENTITY_DEAD(iLocal_66[1], false))
	{
		return 1;
	}
	...
	if (!PED::IS_PED_INJURED(iLocal_66[0]) && !PED::IS_PED_INJURED(iLocal_66[1]))
	{
		if (((PED::IS_PED_SHOOTING_IN_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_66[1], true) - Vector(12f, 12f, 12f), ENTITY::GET_ENTITY_COORDS(iLocal_66[1], true) + Vector(12f, 12f, 12f), false, true) && !WEAPON::IS_PED_CURRENT_WEAPON_SILENCED(PLAYER::PLAYER_PED_ID())) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_66[0], true), 3f, true)) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_66[1], true), 3f, true))
		{
			return 1;
		}
	}
	...
	while (iVar0 < iLocal_67)
	{
		...
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_67[iVar0], PLAYER::PLAYER_PED_ID(), true))
			{
				return 1;
			}
		}
	...
	while (iVar0 < iLocal_68)
	{
		...
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_68[iVar0], PLAYER::PLAYER_PED_ID(), true))
			{
				return 1;
			}
		}
...
bool func_171(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0xB5FB
{
...
void func_173()//Position - 0xB6BB
{
	if (!PED::IS_PED_INJURED(iLocal_67[1]))
	{
		if (PED::IS_PED_MALE(iLocal_67[1]))
		{
			func_174(iLocal_67[1], "WHIMPER", "WAVELOAD_PAIN_MALE", 3);
		}
		else
		{
			func_174(iLocal_67[1], "WHIMPER", "WAVELOAD_PAIN_FEMALE", 3);
		}
		AUDIO::PLAY_PAIN(iLocal_67[1], 26, 0, 0);
	}
	if (!PED::IS_PED_INJURED(iLocal_68[1]))
	{
		func_174(iLocal_68[1], "SCREAM_PANIC", "WAVELOAD_PAIN_FEMALE", 3);
		AUDIO::PLAY_PAIN(iLocal_68[1], 3, 0, 0);
	}
}

void func_174(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xB73B
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_175(iParam3), false);
}

int func_175(int iParam0)//Position - 0xB754
{
	int iVar0;
...
void func_176()//Position - 0xB949
{
	...
	while (iVar0 <= (iLocal_63 - 1))
	{
		iLocal_66[iVar0] = PED::CREATE_PED(26, iLocal_141, Local_51[iVar0 /*3*/], fLocal_52[iVar0], true, true);
		...
		PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_66[iVar0], false);
	...
	if (func_42() == 0)
	{
		func_181(&uLocal_151, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	}
	else if (func_42() == 1)
	{
		func_181(&uLocal_151, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	else if (func_42() == 2)
	{
		func_181(&uLocal_151, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	}
	iLocal_102 = OBJECT::CREATE_OBJECT(iLocal_117, Local_57, true, true, false);
	if (iLocal_47 == 1)
	{
		PED::ADD_SCENARIO_BLOCKING_AREA(Local_71 - Vector(20f, 20f, 20f), Local_71 + Vector(20f, 20f, 20f), false, true, true, true);
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("baller"), true);
		iLocal_103[0] = OBJECT::CREATE_OBJECT(joaat("prop_anim_cash_pile_01"), Local_57, true, true, false);
		iLocal_103[1] = OBJECT::CREATE_OBJECT(joaat("prop_anim_cash_pile_01"), Local_57 - Vector(0.1f, 0f, 0f), true, true, false);
		...
		Local_126 = { -821.565f, -186.467f, 36.6f };
		Local_128 = { 0f, 0f, -59.96f };
		iLocal_135 = PED::CREATE_SYNCHRONIZED_SCENE(Local_126, Local_128, 2);
		PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_135, true);
		TASK::TASK_SYNCHRONIZED_SCENE(iLocal_66[1], iLocal_135, "random@shop_robbery", "robbery_intro_loop_a", 8f, -8f, 0, 0, 1000f, 0);
		ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_102, iLocal_135, "robbery_intro_loop_bag", "random@shop_robbery", 1000f, 8f, 0, 1000f);
		iVar0 = 0;
		while (iVar0 <= (iLocal_64 - 1))
		{
			iLocal_67[iVar0] = PED::CREATE_PED(26, iLocal_138, Local_53[iVar0 /*3*/], fLocal_54[iVar0], true, true);
		...
		iLocal_68[0] = PED::CREATE_PED(26, iLocal_139, Local_55[0 /*3*/], fLocal_56[0], true, true);
		...
		while (iVar0 <= 2)
		{
			iLocal_68[iVar0] = PED::CREATE_PED(26, iLocal_140, Local_55[iVar0 /*3*/], fLocal_56[iVar0], true, true);
		...
		TASK::TASK_SYNCHRONIZED_SCENE(iLocal_67[0], iLocal_135, "random@shop_robbery", "robbery_intro_loop_f", 8f, -8f, 0, 0, 1000f, 0);
		AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_67[0], "A_M_Y_BevHills_01_White_Mini_01");
		func_181(&uLocal_151, 5, iLocal_67[0], "REROBShopworker", 0, 1);
		...
		TASK::TASK_SYNCHRONIZED_SCENE(iLocal_68[0], iLocal_135, "random@robbery", "cower", 8f, -8f, 5, 0, 1000f, 0);
		...
		TASK::TASK_SYNCHRONIZED_SCENE(iLocal_68[1], iLocal_135, "random@robbery", "cower", 8f, -8f, 5, 0, 1000f, 0);
		...
		TASK::TASK_SYNCHRONIZED_SCENE(iLocal_68[2], iLocal_135, "random@robbery", "cower", 8f, -8f, 5, 0, 1000f, 0);
		PED::SET_PED_KEEP_TASK(iLocal_68[2], true);
		TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_66[0], iLocal_67[0], -1, false);
	...
	{
		PED::ADD_SCENARIO_BLOCKING_AREA(Local_72 - Vector(20f, 20f, 20f), Local_72 + Vector(20f, 20f, 20f), false, true, true, true);
		ENTITY::SET_ENTITY_ROTATION(iLocal_102, Local_58, 2, true);
		iLocal_67[0] = PED::CREATE_PED(26, iLocal_138, Local_53[0 /*3*/], fLocal_54[0], true, true);
		PED::SET_PED_NAME_DEBUG(iLocal_67[0], "pedWorker[0]");
		AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_67[0], "A_M_Y_BeachVesp_01_White_Mini_01");
		func_181(&uLocal_151, 6, iLocal_67[0], "REROBShopworker2", 0, 1);
		iLocal_67[1] = PED::CREATE_PED(26, iLocal_137, Local_53[1 /*3*/], fLocal_54[1], true, true);
		PED::SET_PED_NAME_DEBUG(iLocal_67[1], "pedWorker[1]");
		iVar0 = 0;
		while (iVar0 <= (iLocal_64 - 1))
		{
		...
		iLocal_68[0] = PED::CREATE_PED(26, iLocal_139, Local_55[0 /*3*/], fLocal_56[0], true, true);
		PED::SET_PED_NAME_DEBUG(iLocal_68[0], "pedShopper[0]");
		iLocal_68[1] = PED::CREATE_PED(26, iLocal_140, Local_55[1 /*3*/], fLocal_56[1], true, true);
		PED::SET_PED_NAME_DEBUG(iLocal_68[1], "pedShopper[1]");
		iVar0 = 0;
		...
		TASK::TASK_PLAY_ANIM(iLocal_67[0], "random@shop_robbery", "robbery_intro_loop_f", 4f, -4f, -1, 9, 0f, false, false, false);
		PED::SET_PED_KEEP_TASK(iLocal_67[0], true);
		TASK::TASK_PLAY_ANIM(iLocal_67[1], "random@robbery", "f_cower_02", 4f, -4f, -1, 9, 0f, false, false, false);
		PED::SET_PED_KEEP_TASK(iLocal_67[1], true);
		TASK::TASK_COWER(iLocal_68[0], -1);
		PED::SET_PED_KEEP_TASK(iLocal_68[0], true);
		TASK::TASK_PLAY_ANIM(iLocal_68[1], "random@robbery", "f_cower_01", 4f, -4f, -1, 9, 0f, false, false, false);
		PED::SET_PED_KEEP_TASK(iLocal_68[1], true);
		Local_126 = { -1192.01f, -768.929f, 16.358f };
		Local_128 = { 0f, 0f, -59.5f };
		iLocal_135 = PED::CREATE_SYNCHRONIZED_SCENE(Local_126, Local_128, 2);
		PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_135, true);
		TASK::TASK_SYNCHRONIZED_SCENE(iLocal_66[0], iLocal_135, "random@shop_robbery", "robbery_intro_loop_b", 2f, -2f, 0, 0, 1000f, 0);
		TASK::TASK_SYNCHRONIZED_SCENE(iLocal_67[0], iLocal_135, "random@shop_robbery", "robbery_intro_loop_f", 2f, -2f, 0, 0, 1000f, 0);
		TASK::TASK_PLAY_ANIM(iLocal_66[1], "random@shop_robbery", "robbery_intro_loop_a", 16f, -4f, -1, 9, 0f, false, false, false);
		func_180(14, 1);
		func_179(14);
		SYSTEM::WAIT(500);
		func_177(14, 0, 0);
...
void func_177(int iParam0, bool bParam1, bool bParam2)//Position - 0xC39D
{
	int iVar0;
	int iVar1;
...
int func_178(int iParam0, int iParam1)//Position - 0xC40A
{
	switch (iParam0)
	{
		case 0:
...
void func_179(int iParam0)//Position - 0xC88B
{
	func_10(iParam0, 9, 1);
}

void func_180(int iParam0, bool bParam1)//Position - 0xC89C
{
	if (bParam1)
	{
...
void func_181(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC8DA
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_182()//Position - 0xC975
{
	if (!iLocal_74)
	{
		iLocal_88 = INTERIOR::GET_INTERIOR_AT_COORDS(Local_51[0 /*3*/]);
		INTERIOR::PIN_INTERIOR_IN_MEMORY(iLocal_88);
		iLocal_74 = 1;
	}
}

void func_183()//Position - 0xC999
{
...
void func_184()//Position - 0xCABE
{
	...
	if (iLocal_47 == 1)
	{
		...
		iLocal_64 = 3;
		iLocal_65 = 3;
		Local_51[0 /*3*/] = { -821.4461f, -184.84744f, 37.566795f };
		fLocal_52[0] = 252.381f;
		Local_51[1 /*3*/] = { -819.4664f, -186.8146f, 36.5671f };
		fLocal_52[1] = -153.95622f;
		Local_53[0 /*3*/] = { -821.941f, -183.3325f, 36.5689f };
		fLocal_54[0] = 203.3684f;
		Local_53[1 /*3*/] = { -813.6672f, -185.5652f, 36.5689f };
		fLocal_54[1] = 90.1761f;
		Local_53[2 /*3*/] = { -816.1049f, -183.9966f, 36.5689f };
		fLocal_54[2] = 192.7338f;
		Local_55[0 /*3*/] = { -813.008f, -184.931f, 37.869f };
		fLocal_56[0] = 337.68f;
		Local_55[1 /*3*/] = { -817.5606f, -190.8273f, 37.3114f };
		fLocal_56[1] = 25.8399f;
		Local_55[2 /*3*/] = { -816.1862f, -182.897f, 37.6304f };
		fLocal_56[2] = 30f;
		Local_57 = { -822.2148f, -184.0822f, 37.7027f };
		Local_58 = { -1.8236f, 0.6172f, 75.8024f };
		Local_59 = { -808.5918f, -180.0378f, 36.5689f };
		iLocal_117 = joaat("prop_cs_duffel_01");
		iLocal_118 = 2000;
		Local_123 = { -822.8538f, -187.7645f, 36.5792f };
	}
	else if (iLocal_47 == 2)
	{
		...
		iLocal_64 = 2;
		iLocal_65 = 2;
		Local_51[0 /*3*/] = { -1193.045f, -769.304f, 16.321f };
		fLocal_52[0] = -85.5f;
		Local_51[1 /*3*/] = { -1199.0454f, -778.8358f, 16.3277f };
		fLocal_52[1] = 329.1899f;
		Local_53[0 /*3*/] = { -1193.8021f, -766.8922f, 16.331f };
		fLocal_54[0] = 221.3152f;
		Local_53[1 /*3*/] = { -1193.8497f, -771.4392f, 16.3227f };
		fLocal_54[1] = 247.1149f;
		Local_55[0 /*3*/] = { -1184.3588f, -767.0463f, 16.3468f };
		fLocal_56[0] = 103.3015f;
		Local_55[1 /*3*/] = { -1185.9325f, -770.624f, 16.344f };
		fLocal_56[1] = 43.215f;
		Local_57 = { -1192.9675f, -767.0651f, 17.2968f };
		Local_58 = { 0f, 0f, -128.52f };
		Local_59 = { -1180.4567f, -763.9163f, 16.3267f };
		iLocal_117 = joaat("prop_cs_duffel_01");
		iLocal_118 = 2000;
		Local_123 = { -1201.0062f, -777.4955f, 16.3235f };
	}
	bLocal_50 = true;
}

int func_185()//Position - 0xCD9D
{
...
int func_186(float fParam0, bool bParam1)//Position - 0xCE23
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_187(int iParam0, var uParam1)//Position - 0xCED4
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_188(uParam1, "Barry3A", func_190(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_189(iParam0), 0, 1);
			break;
		...
		case 8:
			func_188(uParam1, "Dreyfuss1", func_190(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_189(iParam0), 0, 0);
			break;
		...
		case 38:
			func_188(uParam1, "Nigel1A", func_190(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_189(iParam0), 1, 1);
			break;
		...
		case 49:
			func_188(uParam1, "Paparazzo3A", func_190(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_189(iParam0), 0, 1);
			break;
		...
		case 58:
			func_188(uParam1, "Tonya1", func_190(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_189(iParam0), 0, 1);
			break;
...
int func_189(int iParam0)//Position - 0xE1AC
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_190(int iParam0)//Position - 0xE4F2
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_191(int iParam0)//Position - 0xE52A
{
	struct<2> Var0;
...
bool func_193()//Position - 0xE9A9
{
	return Global_113366 > 0;
}

int func_194()//Position - 0xE9B7
{
	if (Global_97603 != -1)
	{
		return 1;
...
int func_198()//Position - 0xEA6E
{
	if ((Global_113637 == func_70() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_113638)
	{
		return 1;
	}
	return 0;
...
void func_199(int iParam0)//Position - 0xEA99
{
	if (iParam0 == -1)
	{
		iParam0 = func_70();
...
void func_201(int iParam0)//Position - 0xEB0C
{
	Global_113637 = iParam0;
}

int func_202(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEB1A
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (func_44(func_42()))
		{
			if (!func_227(iParam1, bParam2, 145))
			{
				return 0;
			}
		}
		if (!func_226(Global_113648.f_24997.f_43[iParam1]))
		{
			return 0;
		}
...
bool func_203(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0xEEB4
{
	if (bParam2)
	{
...
bool func_204(int iParam0)//Position - 0xEEFB
{
	int iVar0;
...
int func_205(int iParam0)//Position - 0xEF1C
{
	return func_206(iParam0, 1);
}

int func_206(int iParam0, int iParam1)//Position - 0xEF2B
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_207(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xEF7E
{
	func_208(func_84(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_208(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xEF9C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_209(float fParam0, float fParam1, float fParam2)//Position - 0xF19D
{
	float fVar0;
...
int func_210(int iParam0)//Position - 0xF1DF
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_211(int iParam0)//Position - 0xF1F2
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_212(int iParam0)//Position - 0xF205
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_213(int iParam0, int iParam1)//Position - 0xF217
{
	int iVar0;
	int iVar1;
...
int func_214(int iParam0)//Position - 0xF323
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_215(int iParam0, bool bParam1)//Position - 0xF3FF
{
...
int func_216(int iParam0)//Position - 0xF41F
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_224()) || Global_112695) || Global_32166) || func_223()) || func_129(8, -1)) || func_222()) || func_221()) || func_220()) || func_219()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_224()) || Global_32166) || func_223()) || func_129(8, -1)) || func_220()) || func_222()) || func_221()) || func_219()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_224()) || Global_112695) || Global_32166) || func_223()) || func_129(8, -1)) || func_220()) || func_222()) || func_221()) || func_219()) || Global_113648.f_7690.f_919[bVar0] == 5) || Global_43804 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_224()) || Global_112695) || Global_32166) || func_223()) || func_129(8, -1)) || func_222()) || func_221()) || func_219()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_224() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_129(8, -1)) || func_219()) || func_218()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_224()) || Global_32166) || func_223()) || func_129(8, -1)) || func_221()) || func_220()) || func_219()) || Global_113648.f_7690.f_919[bVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_224()) || func_221()) || Global_112695) || Global_32166) || func_223()) || Global_44446) || func_129(8, -1)) || func_220()) || func_218()) || func_219()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_217()//Position - 0xFB3C
{
	return Global_100720.f_1;
}

int func_218()//Position - 0xFB4A
{
	if (Global_97603 != -1)
	{
...
bool func_221()//Position - 0xFBB1
{
	return Global_100733.f_388 > 0;
}

bool func_222()//Position - 0xFBC2
{
	return Global_100733.f_387 > 0;
}

var func_223()//Position - 0xFBD3
{
	return Global_1575060;
}

int func_224()//Position - 0xFBDF
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_226(int iParam0)//Position - 0xFC23
{
	return func_213(func_84(), iParam0);
}

int func_227(int iParam0, int iParam1, int iParam2)//Position - 0xFC35
{
	int iVar0;
	bool bVar1;
...
int func_228(bool bParam0)//Position - 0xFD19
{
	if (!func_44(bParam0))
	{
		return 7;
	}
	return Global_113648.f_7690.f_919[bParam0];
}

int func_229(int iParam0)//Position - 0xFD3D
{
	int iVar0;
	int iVar1;
...
bool func_232(int iParam0)//Position - 0xFE91
{
	return func_11(iParam0, 0, 0);
}

bool func_233(int iParam0)//Position - 0xFEA1
{
	return func_11(iParam0, 7, 1);
}

void func_234()//Position - 0xFEB1
{
	int iVar0;
	...
	if (iLocal_142)
	{
		...
		while (iVar0 <= (iLocal_63 - 1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_66[iVar0]))
			{
				if (!PED::IS_PED_INJURED(iLocal_66[iVar0]) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_66[iVar0], false))
				{
					TASK::TASK_SMART_FLEE_COORD(iLocal_66[iVar0], Local_59, 150f, -1, false, false);
					PED::SET_PED_KEEP_TASK(iLocal_66[iVar0], true);
				}
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_66[iVar0]));
			}
				...
				if (!PED::IS_PED_INJURED(iLocal_67[iVar0]))
				{
					...
					if (iVar0 == 0)
					{
						if (!iLocal_114)
						{
							...
							TASK::TASK_SMART_FLEE_COORD(iLocal_67[iVar0], Local_59, 150f, -1, false, false);
						}
						else
						{
...
void func_235(int iParam0)//Position - 0x10204
{
	char cVar0[64];
	...
	if (func_198())
	{
		...
		func_238(30000);
		StringCopy(&cVar0, func_237(Global_113637, 1), 64);
		if (func_69(Global_113637) > 0)
		{
	...
	func_236(&Global_32223);
	Global_113638 = 0;
	func_201(-1);
}

void func_236(var uParam0)//Position - 0x102B6
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_237(int iParam0, bool bParam1)//Position - 0x102F3
{
	switch (iParam0)
	{
		case 0:
...
void func_238(int iParam0)//Position - 0x1053C
{
	Global_43808 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_239(int iParam0)//Position - 0x1054E
{
	func_240(iParam0, 0, func_245(iParam0));
}

void func_240(int iParam0, int iParam1, int iParam2)//Position - 0x10563
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_241(var uParam0)//Position - 0x10592
{
	struct<16> Var0;
	int iVar1;
...
void func_242(int iParam0, var uParam1)//Position - 0x10663
{
	Global_113648.f_24997.f_43[iParam0] = *uParam1;
}

void func_243(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1067B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_244(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x107FD
{
...
int func_245(int iParam0)//Position - 0x10835
{
	int iVar0;
...
void func_246()//Position - 0x109D8
{
	Global_20591 = 0;
	func_247();
}

void func_247()//Position - 0x109E8
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
Vector3 func_248()//Position - 0x10A0C
{
	float fVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		iLocal_70 = 1;
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_72, true) < fVar0)
		{
			fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_72, true);
			iLocal_70 = 2;
		}
		if (iLocal_70 == 1)
		{
