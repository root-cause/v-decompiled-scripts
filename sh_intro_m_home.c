		...
		switch (iLocal_37)
		{
			...
			case 2:
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					...
					Var0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
					if (func_222(Var0, Var3, 100f) || iLocal_40)
					{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		switch (iLocal_38)
		{
			...
			case 5:
				if (iLocal_44 == 0)
				{
					if (CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(CAM::GET_CAM_ACTIVE_VIEW_MODE_CONTEXT()) == 4 && (MISC::GET_GAME_TIMER() - iLocal_48) >= (iVar21 - 300))
					{
...
void func_11(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x10FE
{
	struct<60> Var0;
...
void func_13(int iParam0, int iParam1)//Position - 0x133E
{
	...
	func_57(iParam0, &(Global_113648.f_32751.f_5510));
}
...
int func_16(int iParam0, bool bParam1, int iParam2)//Position - 0x17CF
{
	int iVar0;
	struct<2> Var1;
...
int func_17(int iParam0)//Position - 0x1951
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_19(int iParam0, int iParam1)//Position - 0x1A31
{
	int iVar0;
	int iVar1;
...
bool func_20()//Position - 0x5064
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_21()//Position - 0x507A
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_22()//Position - 0x5090
{
	return 0;
}

int func_23()//Position - 0x5099
{
	return 1;
}

int func_24()//Position - 0x50A2
{
	return 1;
}

int func_25()//Position - 0x50AB
{
...
int func_27(int iParam0)//Position - 0x517C
{
	int iVar0;
	char* sVar1;
...
int func_28(int iParam0)//Position - 0x51C3
{
	int iVar0;
...
int func_29(int iParam0)//Position - 0x51FE
{
	int iVar0;
...
int func_30(int iParam0)//Position - 0x527A
{
	int iVar0;
...
int func_31(int iParam0, int iParam1, bool bParam2)//Position - 0x5362
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_32(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x53D0
{
...
int func_33(int iParam0)//Position - 0x54A9
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_35(var uParam0, int iParam1)//Position - 0x550B
{
	if (iParam1 <= 0)
	{
		return;
...
void func_36(var uParam0, int iParam1)//Position - 0x5591
{
...
void func_37(var uParam0, int iParam1)//Position - 0x55C4
{
	int iVar0;
	int iVar1;
...
int func_38(int iParam0, int iParam1)//Position - 0x5615
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_39(int iParam0)//Position - 0x56B7
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_40(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_40(bool bParam0, int iParam1, int iParam2)//Position - 0x56D9
{
	if (bParam0)
	{
		return iParam1;
...
int func_41(var uParam0)//Position - 0x56F0
{
	return uParam0 & 15;
}

void func_42(var uParam0, int iParam1)//Position - 0x56FD
{
...
void func_43(var uParam0, int iParam1)//Position - 0x5737
{
...
void func_44(var uParam0, int iParam1)//Position - 0x5772
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_45(var uParam0, int iParam1)//Position - 0x57AE
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_56(Global_113648.f_32751.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_56(Global_113648.f_2365.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_56(Global_113648.f_2365.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_46(int iParam0, int iParam1)//Position - 0x6E9D
{
	struct<82> Var0;
...
void func_47(int iParam0, var uParam1, int iParam2)//Position - 0x6EDF
{
	int iVar0;
...
bool func_48(int iParam0)//Position - 0x713B
{
	return iParam0 < 3;
}

void func_49(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x7147
{
	if (func_45(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
...
void func_50(int iParam0, bool bParam1)//Position - 0x7240
{
	if (iParam0 == -1)
	{
		return;
...
void func_51(int iParam0, int iParam1, bool bParam2)//Position - 0x729D
{
	if (iParam0 == -1)
	{
		return;
...
int func_52(int iParam0, int iParam1)//Position - 0x72D8
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_53(var uParam0, var uParam1)//Position - 0x72F8
{
...
void func_54(int iParam0)//Position - 0x73C4
{
	if (iParam0 == -1)
	{
		return;
...
int func_55(int iParam0)//Position - 0x743B
{
	int iVar0;
...
bool func_56(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x749E
{
	if (bParam6)
	{
...
void func_57(int iParam0, var uParam1)//Position - 0x74E5
{
	int iVar0;
...
int func_58(int iParam0)//Position - 0x7790
{
	switch (iParam0)
	{
		case 1:
...
int func_59(int iParam0, var uParam1, var uParam2)//Position - 0x7840
{
	int iVar0;
	int iVar1;
...
int func_60(int iParam0)//Position - 0x7A33
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_61(var uParam0)//Position - 0x7A53
{
	int iVar0;
...
void func_62(int iParam0)//Position - 0x7B04
{
...
Vector3 func_63(struct<3> Param0)//Position - 0x7B2B
{
	return (-SYSTEM::SIN(Param0.f_2) * SYSTEM::COS(Param0.f_0)), (SYSTEM::COS(Param0.f_2) * SYSTEM::COS(Param0.f_0)), SYSTEM::SIN(Param0.f_0);
}

void func_64(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x7B58
{
	int iVar0;
...
void func_65(int iParam0, bool bParam1)//Position - 0x7D16
{
	if (CAM::IS_SCREEN_FADED_OUT() || CAM::IS_SCREEN_FADING_OUT())
	{
...
Vector3 func_66(int iParam0)//Position - 0x7D52
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_67(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x7D65
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_78341[1 /*14*/] = { func_119(iVar10, iParam1, iParam2, -1) };
		if (!func_118(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78341[1 /*14*/] = { func_119(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_119(iVar10, 14, uVar28[iVar1], -1) };
							func_87(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
							func_110(14);
							if (Global_78339 == 1)
							{
								iVar2 = 0;
			...
			{
				Global_78341[1 /*14*/] = { func_119(iVar10, iVar0, func_76(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_119(iVar10, 14, uVar69[iVar1], -1) };
			func_87(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_110(14);
			if (Global_78339 == 1)
			{
...
int func_68(int iParam0, int iParam1, int iParam2)//Position - 0x8578
{
	int iVar0;
	...
	{
		if (!func_184(iParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_64, Global_113648.f_2365.f_539[iVar0 /*65*/].f_63))
		{
...
int func_69(int iParam0)//Position - 0x8604
{
	switch (iParam0)
	{
...
void func_70(int iParam0, int iParam1, int iParam2)//Position - 0x863F
{
	int iVar0;
	int iVar1;
...
int func_71(int iParam0, int iParam1, int iParam2)//Position - 0x86C9
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_72(int iParam0, int iParam1, int iParam2)//Position - 0x87A7
{
	Global_78341[1 /*14*/] = { func_119(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78341[1 /*14*/].f_6, 2);
}

int func_73(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x87CF
{
	var uVar0;
	int iVar10;
...
int func_74(int iParam0, int iParam1, int iParam2)//Position - 0x8DD3
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8E6C
{
	int iVar0;
	...
	{
		if (!func_184(iParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_61, Global_113648.f_2365.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_76(int iParam0, int iParam1, int iParam2)//Position - 0x8F17
{
	int iVar0;
	int iVar1;
...
int func_77(int iParam0)//Position - 0x8FB8
{
	switch (iParam0)
	{
		case 0:
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9068
{
	int iVar0;
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x936F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x9F22
{
	int iVar0;
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA206
{
	int iVar0;
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA4CD
{
	int iVar0;
	int iVar1;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA504
{
	int iVar0;
...
int func_84(int iParam0, int iParam1, int iParam2)//Position - 0xA52D
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA7F7
{
	int iVar0;
...
int func_86(int iParam0, int iParam1, int iParam2)//Position - 0xAA81
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xABD8
{
	int iVar0;
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAC72
{
	switch (iParam0)
	{
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAD40
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_90(int iParam0, int iParam1)//Position - 0xAE5A
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_91(int iParam0)//Position - 0xB201
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB262
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_93(int iParam0, int iParam1)//Position - 0xB35E
{
	int iVar0;
...
int func_94(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB49C
{
	struct<2> Var0;
	int iVar15;
	int iVar16;
...
int func_95(int iParam0)//Position - 0xB557
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_96(int iParam0)//Position - 0xB5B6
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_97(int iParam0, int iParam1)//Position - 0xB63C
{
	int iVar0;
	struct<10> Var1;
...
void func_98(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBF6B
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_99(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xC097
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_100(int iParam0, int iParam1)//Position - 0xC0DF
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_103(&Var1, -99, -99, Global_113648.f_2365.f_539.f_196[0], Global_113648.f_2365.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_103(&Var1, -99, -99, Global_113648.f_2365.f_539.f_196[1], Global_113648.f_2365.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_103(&Var1, -99, -99, Global_113648.f_2365.f_539.f_196[2], Global_113648.f_2365.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_101(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDF27
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
int func_102(int iParam0)//Position - 0xE111
{
	switch (iParam0)
	{
		case 0:
...
void func_103(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xE1C1
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE232
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE4AF
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE8D4
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_107(int iParam0, int iParam1)//Position - 0xEBC7
{
	int iVar0;
	int iVar1;
...
int func_108(int iParam0, int iParam1)//Position - 0xEC0E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEC6E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_110(int iParam0)//Position - 0xECC5
{
...
void func_111(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xED71
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_112(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xEDBB
{
	int iVar0;
	...
	iVar0 = Global_2805029[iParam0 /*3*/][func_113(iParam2)];
	if (iVar0 != 0)
	{
...
int func_113(var uParam0)//Position - 0xEDEB
{
	int iVar0;
	int iVar1;
...
int func_114()//Position - 0xEE1F
{
	return Global_1574918;
}

int func_115(int iParam0, int iParam1, int iParam2)//Position - 0xEE2B
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 14192)
	{
		...
		iVar0 = Global_2805029[iParam0 /*3*/][func_113(iParam1)];
...
bool func_116(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xEE68
{
	int iVar0;
...
int func_117(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x11677
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_118(int iParam0)//Position - 0x1251A
{
	if (!BitTest(Global_78341[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_119(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x12562
{
	func_183();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_120(int iParam0, int iParam1)//Position - 0x125B4
{
	switch (iParam0)
	{
		case 0:
...
void func_121(int iParam0)//Position - 0x126A4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_129(iVar10, iParam0, 155, -1);
			return;
			break;
	}
	func_122(&(Global_78341[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_122(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x1391B
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_115(func_125(iParam1, uParam0->f_2), Global_78338, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_115(func_124(iParam1, uParam0->f_2), Global_78338, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_115(iVar1, Global_78338, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_123(int iParam0, int iParam1, var uParam2)//Position - 0x13CC0
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_124(int iParam0, int iParam1)//Position - 0x140C8
{
	switch (iParam1)
	{
		case 0:
...
int func_125(int iParam0, int iParam1)//Position - 0x144C3
{
	switch (iParam1)
	{
		case 0:
...
int func_126(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x148BE
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_127(int iParam0)//Position - 0x148FD
{
	return Global_43257 == iParam0;
}

int func_128(int iParam0)//Position - 0x1490B
{
	switch (iParam0)
	{
		case -1:
...
void func_129(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x149DF
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_122(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_122(&(Global_78341[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_122(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_122(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_130(int iParam0)//Position - 0x14C66
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x14DBD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x152CB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x15340
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x153B4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x1549B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x157FE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x15A0F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x15C3F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x15D4F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x166EE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x17261
{
	if (iParam0 < 136)
	{
		func_143(iParam0);
...
void func_142(int iParam0)//Position - 0x17296
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x17E9A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x18EE7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x19014
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0, int iParam1)//Position - 0x19112
{
	switch (iParam0)
	{
		case 0:
...
void func_147(int iParam0)//Position - 0x19202
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x1A6F3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x1A844
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x1AD4F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1B3BD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x1B431
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1B501
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1BA31
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1BBC8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1C3C8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x1C4D8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x1D403
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1E0C0
{
	if (iParam0 < 107)
	{
		func_162(iParam0);
...
void func_160(int iParam0)//Position - 0x1E106
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1EBAB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x1F99A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x205E5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x2085E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0, int iParam1)//Position - 0x209A4
{
	switch (iParam0)
	{
		case 0:
...
void func_166(int iParam0)//Position - 0x20A94
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x2181E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x21998
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x21F0F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x22439
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x224AD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x2257D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x22A55
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x22CBE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x22F94
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x2315D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x23CB1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x248FD
{
	if (iParam0 < 60)
	{
		func_180(iParam0);
...
void func_179(int iParam0)//Position - 0x24932
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x256D2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x25D5E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x25E45
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183()//Position - 0x25F43
{
...
int func_184(int iParam0, int iParam1, int iParam2)//Position - 0x25FBC
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_78341[1 /*14*/] = { func_119(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_78341[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_184(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_184(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_78341[2 /*14*/] = { func_119(iVar0, 14, iVar4, -1) };
									if (Global_78341[2 /*14*/].f_12 == iVar3)
									{
										if (func_184(iParam0, 14, iVar4))
										{
											if (!func_73(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_78341[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_78341[2 /*14*/] = { func_119(iVar0, iVar2, iVar1, -1) };
						if (!func_73(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_78341[2 /*14*/])))
						{
							return 0;
						}
					}
...
int func_185()//Position - 0x26215
{
	func_186();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_186()//Position - 0x2622E
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_188(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_48(iVar0) && (!func_127(14) || Global_112599))
			{
...
int func_187(int iParam0)//Position - 0x2632B
{
	int iVar0;
	int iVar1;
...
int func_188(int iParam0)//Position - 0x26368
{
	if (func_48(iParam0))
	{
...
var func_189(int iParam0)//Position - 0x2638D
{
	return Global_2028[iParam0 /*29*/];
}

void func_190(bool bParam0)//Position - 0x2639C
{
	int iVar0;
...
void func_191(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x263DB
{
	if (bParam0)
	{
...
bool func_192()//Position - 0x26528
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_193(int iParam0, int iParam1)//Position - 0x26542
{
	bool bVar0;
...
int func_194(int iParam0, bool bParam1)//Position - 0x2658D
{
	int iVar0;
	int iVar1;
...
int func_195(int iParam0)//Position - 0x265CE
{
...
bool func_196()//Position - 0x2660D
{
	return BitTest(Global_2621446, 3);
}

int func_197(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x2661B
{
	int iVar0;
...
void func_199(int iParam0)//Position - 0x26675
{
	if (iParam0 == 1)
	{
...
void func_200()//Position - 0x26698
{
	Global_20591 = 0;
	func_201();
}

void func_201()//Position - 0x266A8
{
...
int func_202(int iParam0, float fParam1, int iParam2)//Position - 0x266C9
{
	int iVar0;
...
bool func_203()//Position - 0x2679D
{
	bool bVar0;
...
void func_204()//Position - 0x267C0
{
	Global_20591 = 0;
	func_205();
}

void func_205()//Position - 0x267D0
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
...
void func_207()//Position - 0x26849
{
...
int func_208(int iParam0, int iParam1)//Position - 0x2689A
{
	if (func_7(iParam0))
	{
...
int func_209(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x268CD
{
...
void func_210(int iParam0)//Position - 0x26A65
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_211()//Position - 0x26A91
{
	if (iLocal_41)
	{
		if (INTERIOR::IS_VALID_INTERIOR(iLocal_51))
...
void func_212(bool bParam0)//Position - 0x26AC7
{
	if (bParam0)
	{
		if (!iLocal_40)
...
int func_214(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x26B41
{
	int iVar0;
...
void func_215(var uParam0, int iParam1)//Position - 0x26C78
{
	int iVar0;
...
bool func_216(int iParam0)//Position - 0x26CC7
{
	return func_217(iParam0, Global_43257);
}

int func_217(int iParam0, int iParam1)//Position - 0x26CD8
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_218(int iParam0)//Position - 0x26EB9
{
	if (Global_43257 == 15)
	{
		return 0;
...
bool func_222(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x26F97
{
	struct<3> Var0;
...
bool func_223(var uParam0, struct<2> Param1, var uParam3)//Position - 0x26FC1
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_224(var uParam0)//Position - 0x2707D
{
	int iVar0;
	float fVar1;
...
void func_225(var uParam0, struct<3> Param1)//Position - 0x2711D
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_226(var uParam0)//Position - 0x2714E
{
	if (uParam0->f_51)
	{
	}
...
void func_227()//Position - 0x27175
{
	if (iLocal_47 != -1)
	{
		if (iLocal_39)
...
void func_228(int iParam0)//Position - 0x271F0
{
	if (*iParam0 == -1)
	{
		return;
...
int func_229(int iParam0)//Position - 0x2722D
{
	int iVar0;
	bool bVar1;
