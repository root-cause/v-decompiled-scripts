...
void func_49(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x7147
{
	if (func_45(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
...
bool func_56(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x749E
{
	if (bParam2)
	{
...
void func_64(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x7B58
{
	int iVar0;
...
int func_67(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x7D65
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_119(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_119(iVar10, 14, uVar15[iVar1], -1) };
			func_87(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_110(14);
			if (Global_78339 == 1)
			{
...
void func_121(int iParam0)//Position - 0x126A4
{
	...
	func_122(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_129(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x149DF
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_122(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_122(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
...
bool func_222(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x26F97
{
	struct<3> Var0;
...
bool func_223(var uParam0, struct<2> Param1, var uParam2)//Position - 0x26FC1
{
	bool bVar0;
	int iVar1;
	int iVar2;
