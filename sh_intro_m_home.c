...
int func_20(bool bParam0)//Position - 0x6C0B
{
	if (bParam0)
	{
...
bool func_21()//Position - 0x6C25
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_22()//Position - 0x6C3B
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_23()//Position - 0x6C51
{
	return 0;
}

int func_24()//Position - 0x6C5A
{
	return 1;
}

int func_25()//Position - 0x6C63
{
	return 1;
}

int func_26()//Position - 0x6C6C
{
...
int func_28(int iParam0)//Position - 0x6D3D
{
	int iVar0;
	char* sVar1;
...
int func_29(int iParam0)//Position - 0x6D84
{
	int iVar0;
...
int func_30(int iParam0)//Position - 0x6DBF
{
	int iVar0;
...
int func_31(int iParam0)//Position - 0x6E3B
{
	int iVar0;
...
int func_32(int iParam0, int iParam1, bool bParam2)//Position - 0x6F23
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_33(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x6F91
{
...
int func_34(int iParam0)//Position - 0x706A
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_36(var uParam0, int iParam1)//Position - 0x70CC
{
	if (iParam1 <= 0)
	{
		return;
...
void func_37(var uParam0, int iParam1)//Position - 0x7152
{
...
void func_38(var uParam0, int iParam1)//Position - 0x7185
{
	int iVar0;
	int iVar1;
...
int func_39(int iParam0, int iParam1)//Position - 0x71D6
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_40(int iParam0)//Position - 0x7278
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_41(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_41(bool bParam0, int iParam1, int iParam2)//Position - 0x729A
{
	if (bParam0)
	{
		return iParam1;
...
int func_42(var uParam0)//Position - 0x72B1
{
	return uParam0 & 15;
}

void func_43(var uParam0, int iParam1)//Position - 0x72BE
{
...
void func_44(var uParam0, int iParam1)//Position - 0x72F8
{
...
void func_45(var uParam0, int iParam1)//Position - 0x7333
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_46(var uParam0, int iParam1)//Position - 0x736F
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1)//Position - 0x8A61
{
	struct<82> Var0;
...
void func_48(int iParam0, var uParam1, int iParam2)//Position - 0x8AA3
{
	int iVar0;
...
bool func_49(int iParam0)//Position - 0x8CFF
{
	return iParam0 < 3;
}

void func_50(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x8D0B
{
	if (func_46(&(Global_77479.f_555[0 /*21*/]), iParam0))
	{
...
void func_51(int iParam0, bool bParam1)//Position - 0x8E04
{
	if (iParam0 == -1)
	{
		return;
...
void func_52(int iParam0, int iParam1, bool bParam2)//Position - 0x8E61
{
	if (iParam0 == -1)
	{
		return;
...
int func_53(int iParam0, int iParam1)//Position - 0x8E9C
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_54(var uParam0, var uParam1)//Position - 0x8EBC
{
...
void func_55(int iParam0)//Position - 0x8F88
{
	if (iParam0 == -1)
	{
		return;
...
int func_56(int iParam0)//Position - 0x8FFF
{
	int iVar0;
...
bool func_57(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x9062
{
	if (bParam6)
	{
...
void func_58(int iParam0, var uParam1)//Position - 0x90A9
{
	int iVar0;
...
int func_59(int iParam0)//Position - 0x9354
{
	switch (iParam0)
	{
		case 1:
...
int func_60(int iParam0, var uParam1, var uParam2)//Position - 0x9404
{
	int iVar0;
	int iVar1;
...
int func_61(int iParam0)//Position - 0x95F7
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_62(var uParam0)//Position - 0x9617
{
	int iVar0;
...
void func_63(int iParam0)//Position - 0x96C8
{
...
Vector3 func_64(struct<3> Param0)//Position - 0x96EF
{
	return (-SYSTEM::SIN(Param0.f_2) * SYSTEM::COS(Param0.f_0)), (SYSTEM::COS(Param0.f_2) * SYSTEM::COS(Param0.f_0)), SYSTEM::SIN(Param0.f_0);
}

void func_65(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x971C
{
	int iVar0;
...
void func_66(int iParam0, bool bParam1)//Position - 0x98DA
{
	if (CAM::IS_SCREEN_FADED_OUT() || CAM::IS_SCREEN_FADING_OUT())
	{
...
Vector3 func_67(int iParam0)//Position - 0x9916
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_68(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x9929
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_78472[1 /*14*/] = { func_121(iVar10, iParam1, iParam2, -1) };
		if (!func_120(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78472[1 /*14*/] = { func_121(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78472[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78472[1 /*14*/] = { func_121(iVar10, 14, uVar28[iVar1], -1) };
			...
			{
				Global_78472[1 /*14*/] = { func_121(iVar10, iVar0, func_77(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78472[1 /*14*/] = { func_121(iVar10, 14, uVar69[iVar1], -1) };
			func_88(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
			func_111(14);
			if (Global_78470 == 1)
			{
...
int func_69(int iParam0, int iParam1, int iParam2)//Position - 0xA13A
{
	int iVar0;
	...
	{
		if (!func_186(iParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_64, Global_113810.f_2366.f_539[iVar0 /*65*/].f_63))
		{
...
int func_70(int iParam0)//Position - 0xA1C6
{
	switch (iParam0)
	{
...
void func_71(int iParam0, int iParam1, int iParam2)//Position - 0xA201
{
	int iVar0;
	int iVar1;
...
int func_72(int iParam0, int iParam1, int iParam2)//Position - 0xA28B
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_73(int iParam0, int iParam1, int iParam2)//Position - 0xA369
{
	Global_78472[1 /*14*/] = { func_121(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78472[1 /*14*/].f_6, 2);
}

int func_74(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0xA391
{
	var uVar0;
	int iVar10;
...
int func_75(int iParam0, int iParam1, int iParam2)//Position - 0xA995
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAA2E
{
	int iVar0;
	...
	{
		if (!func_186(iParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_61, Global_113810.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_77(int iParam0, int iParam1, int iParam2)//Position - 0xAAD9
{
	int iVar0;
	int iVar1;
...
int func_78(int iParam0)//Position - 0xAB7A
{
	switch (iParam0)
	{
		case 0:
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAC2A
{
	int iVar0;
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAF31
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0xBAE4
{
	int iVar0;
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBDC8
{
	int iVar0;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC08F
{
	int iVar0;
	int iVar1;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC0C6
{
	int iVar0;
...
int func_85(int iParam0, int iParam1, int iParam2)//Position - 0xC0EF
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC3B9
{
	int iVar0;
...
int func_87(int iParam0, int iParam1, int iParam2)//Position - 0xC643
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC79A
{
	int iVar0;
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC834
{
	switch (iParam0)
	{
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC902
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_91(int iParam0, int iParam1)//Position - 0xCA1C
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_92(int iParam0)//Position - 0xCDC3
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCE24
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_94(int iParam0, int iParam1)//Position - 0xCF20
{
	int iVar0;
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD05E
{
	struct<2> Var0;
	int iVar15;
	int iVar16;
...
int func_96(int iParam0)//Position - 0xD119
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_97(int iParam0)//Position - 0xD178
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_98(int iParam0, int iParam1)//Position - 0xD1FE
{
	int iVar0;
	struct<10> Var1;
...
void func_99(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDB2D
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xDC57
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_101(int iParam0, int iParam1)//Position - 0xDC9F
{
	int iVar0;
	struct<17> Var1;
...
void func_102(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xFAE7
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
int func_103(int iParam0)//Position - 0xFCD1
{
	switch (iParam0)
	{
		case 0:
...
void func_104(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xFD81
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xFDF2
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10071
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10496
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_108(int iParam0, int iParam1)//Position - 0x10789
{
	int iVar0;
	int iVar1;
...
int func_109(int iParam0, int iParam1)//Position - 0x107D0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_110(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10830
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_111(int iParam0)//Position - 0x10887
{
...
void func_112(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x10933
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_113(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x1097B
{
	int iVar0;
...
int func_114(int iParam0, var uParam1)//Position - 0x1099E
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_115(uParam1));
}

int func_115(var uParam0)//Position - 0x109B3
{
	int iVar0;
	int iVar1;
...
int func_116()//Position - 0x109E7
{
	return Global_1574918;
}

int func_117(int iParam0, int iParam1)//Position - 0x109F3
{
	int iVar0;
	var uVar1;
...
bool func_118(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x10A22
{
	int iVar0;
...
int func_119(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x13420
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_120(int iParam0)//Position - 0x142C5
{
	if (!BitTest(Global_78472[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_121(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1430D
{
	func_185();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_122(int iParam0, int iParam1)//Position - 0x1435F
{
	switch (iParam0)
	{
		case 0:
...
void func_123(int iParam0)//Position - 0x1444F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_124(&(Global_78472[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_124(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x156C6
{
	var uVar0;
	int iVar1;
...
bool func_125(int iParam0, int iParam1, var uParam2)//Position - 0x15A68
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_126(int iParam0, int iParam1)//Position - 0x15E6D
{
	switch (iParam1)
	{
		case 0:
...
int func_127(int iParam0, int iParam1)//Position - 0x16268
{
	switch (iParam1)
	{
		case 0:
...
int func_128(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x16663
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_129(int iParam0)//Position - 0x166A1
{
	return Global_43377 == iParam0;
}

int func_130(int iParam0)//Position - 0x166AF
{
	switch (iParam0)
	{
		case -1:
...
void func_131(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x16783
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_124(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78670)
		{
			...
			func_124(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_132(int iParam0)//Position - 0x16A0A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x16B61
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x1706F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x170E4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x17158
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x1723F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x175A2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x177B3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x179E3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x17AF3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x18494
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x19007
{
	if (iParam0 < 136)
	{
		func_145(iParam0);
...
void func_144(int iParam0)//Position - 0x1903C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x19C40
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x1AB4E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x1AC7B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0, int iParam1)//Position - 0x1AD79
{
	switch (iParam0)
	{
		case 0:
...
void func_149(int iParam0)//Position - 0x1AE69
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x1C35B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1C4AC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x1C9B7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1D025
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1D099
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1D169
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1D699
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x1D830
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x1E02E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1E13E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1F069
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1FD26
{
	if (iParam0 < 107)
	{
		func_164(iParam0);
...
void func_162(int iParam0)//Position - 0x1FD6C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x20812
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x21601
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x2224A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x224C3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0, int iParam1)//Position - 0x22609
{
	switch (iParam0)
	{
		case 0:
...
void func_168(int iParam0)//Position - 0x226F9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x23483
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x235FD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x23B74
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x2409F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x24113
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x241E3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x246BB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x24924
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x24BFA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x24DC3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x25917
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x26561
{
	if (iParam0 < 60)
	{
		func_182(iParam0);
...
void func_181(int iParam0)//Position - 0x26596
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x27336
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x279C2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x27AA9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185()//Position - 0x27BA7
{
...
int func_186(int iParam0, int iParam1, int iParam2)//Position - 0x27C20
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_78472[1 /*14*/] = { func_121(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_78472[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_186(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_186(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_78472[2 /*14*/] = { func_121(iVar0, 14, iVar4, -1) };
					...
					else
					{
						...
						Global_78472[2 /*14*/] = { func_121(iVar0, iVar2, iVar1, -1) };
...
int func_187()//Position - 0x27E79
{
	func_188();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_188()//Position - 0x27E92
{
	int iVar0;
...
int func_189(int iParam0)//Position - 0x27F8F
{
	int iVar0;
	int iVar1;
...
int func_190(int iParam0)//Position - 0x27FCC
{
	if (func_49(iParam0))
	{
...
var func_191(int iParam0)//Position - 0x27FF1
{
	return Global_2058[iParam0 /*29*/];
}

void func_192(bool bParam0)//Position - 0x28000
{
	int iVar0;
...
void func_193(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2803F
{
	if (bParam0)
	{
...
bool func_194()//Position - 0x2818C
{
	return BitTest(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_36.f_18, 14);
}

bool func_195(int iParam0, int iParam1)//Position - 0x281A6
{
	bool bVar0;
...
int func_196(int iParam0, bool bParam1)//Position - 0x281FF
{
	int iVar0;
	int iVar1;
...
int func_197(var uParam0)//Position - 0x28240
{
	int iVar0;
...
int func_198(int iParam0)//Position - 0x28262
{
...
bool func_199()//Position - 0x282A1
{
	return BitTest(Global_2621446, 3);
}

int func_200(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x282AF
{
	int iVar0;
...
void func_202(int iParam0)//Position - 0x28309
{
	if (iParam0 == 1)
	{
...
void func_203()//Position - 0x2832C
{
	Global_20711 = 0;
	func_204();
}

void func_204()//Position - 0x2833C
{
...
int func_205(int iParam0, float fParam1, int iParam2)//Position - 0x2835D
{
	int iVar0;
...
bool func_206()//Position - 0x28431
{
	bool bVar0;
...
void func_207()//Position - 0x28454
{
	Global_20711 = 0;
	func_208();
}

void func_208()//Position - 0x28464
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22856 = 0;
...
void func_210()//Position - 0x284DD
{
...
int func_211(int iParam0, int iParam1)//Position - 0x2852E
{
	if (func_7(iParam0))
	{
...
int func_212(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x28561
{
...
void func_213(int iParam0)//Position - 0x286F9
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_214()//Position - 0x28725
{
	if (iLocal_39)
	{
		if (INTERIOR::IS_VALID_INTERIOR(iLocal_49))
...
void func_215(bool bParam0)//Position - 0x2875B
{
	if (bParam0)
	{
		if (!iLocal_38)
...
int func_217(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x287D5
{
	int iVar0;
...
void func_218(var uParam0, int iParam1)//Position - 0x2890C
{
	int iVar0;
...
bool func_219(int iParam0)//Position - 0x2895B
{
	return func_220(iParam0, Global_43377);
}

int func_220(int iParam0, int iParam1)//Position - 0x2896C
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_221(int iParam0)//Position - 0x28B4D
{
	if (Global_43377 == 15)
	{
		return 0;
...
bool func_225(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x28C2B
{
	struct<3> Var0;
...
bool func_226(var uParam0, struct<2> Param1, var uParam3)//Position - 0x28C55
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_227(var uParam0)//Position - 0x28D11
{
	int iVar0;
	float fVar1;
...
void func_228(var uParam0, struct<3> Param1)//Position - 0x28DB1
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_229(var uParam0)//Position - 0x28DE2
{
	if (uParam0->f_51)
	{
	}
...
void func_230()//Position - 0x28E09
{
	if (iLocal_45 != -1)
	{
		if (iLocal_37)
...
void func_231(int iParam0)//Position - 0x28E84
{
	if (*iParam0 == -1)
	{
		return;
...
int func_232(int iParam0)//Position - 0x28EC1
{
	int iVar0;
	bool bVar1;
