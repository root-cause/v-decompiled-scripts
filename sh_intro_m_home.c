...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_42 = 0;
	func_226(&uLocal_53);
	func_225(&uLocal_53, -844.1494f, 162.5587f, 65.89324f);
	func_225(&uLocal_53, -849.6625f, 166.8695f, 66.54545f);
	func_225(&uLocal_53, -846.0641f, 198.5984f, 76.9182f);
	func_225(&uLocal_53, -796.5247f, 194.1427f, 77.94861f);
	func_225(&uLocal_53, -774.8713f, 195.2026f, 77.13674f);
	func_225(&uLocal_53, -768.1328f, 190.1837f, 76.24245f);
	func_225(&uLocal_53, -761.3875f, 139.444f, 66.47416f);
	func_225(&uLocal_53, -764.7377f, 137.702f, 66.47416f);
	func_225(&uLocal_53, -800.0312f, 141.218f, 61.96946f);
	func_225(&uLocal_53, -851.1459f, 139.2239f, 60.13711f);
	func_225(&uLocal_53, -850.1609f, 150.5272f, 64.38181f);
	func_225(&uLocal_53, -844.149f, 155.8286f, 65.77842f);
	func_224(&uLocal_53);
	while (true)
	{
		switch (iLocal_37)
		{
			...
			case 2:
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					...
					Var0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
					if (func_222(Var0, Var1, 100f) || iLocal_40)
					{
						if (func_219() || iLocal_40)
						{
							...
							{
								if (func_223(&uLocal_53, Var0) || iLocal_40)
								{
		...
		switch (iLocal_38)
		{
			case 0:
				if (func_202(0, 1093140480, 0))
				{
					...
					if (CAM::DOES_CAM_EXIST(iLocal_46))
					{
						CAM::SET_CAM_PARAMS(iLocal_46, Var0[0 /*3*/], Var1[0 /*3*/], fVar2[0], iVar5, 1, 1, 2);
						CAM::SET_CAM_PARAMS(iLocal_46, Var0[1 /*3*/], Var1[1 /*3*/], fVar2[1], iVar5, 0, 0, 2);
					}
					CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
					STREAMING::NEW_LOAD_SCENE_STOP();
					func_10();
					iLocal_39 = 1;
					func_9("SHI_M_HOUSE_1" /* GXT: This is Michael's safehouse. You can save vehicles by parking them in the Garage. */, iVar5 + 10000);
			...
			case 1:
				...
				if (((((((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && INTERIOR::IS_VALID_INTERIOR(iLocal_51)) && INTERIOR::IS_VALID_INTERIOR(iLocal_52)) && INTERIOR::IS_INTERIOR_READY(iLocal_51)) && INTERIOR::IS_INTERIOR_READY(iLocal_52)) && (MISC::GET_GAME_TIMER() - iLocal_48) > iVar5) || (MISC::GET_GAME_TIMER() - iLocal_50) > iVar6)
				{
					if (CAM::DOES_CAM_EXIST(iLocal_46))
					{
						...
						CAM::SET_CAM_PARAMS(iLocal_46, Var0[1 /*3*/], Var1[1 /*3*/], fVar2[1], iVar5, 0, 0, 2);
						STREAMING::NEW_LOAD_SCENE_STOP();
						func_9("SHI_M_HOUSE_2" /* GXT: Sleep in the bed to save your game. */, iVar5 + 10000);
						iLocal_48 = MISC::GET_GAME_TIMER();
						iLocal_50 = MISC::GET_GAME_TIMER();
						iLocal_38 = 2;
					}
			...
			case 2:
				...
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (MISC::GET_GAME_TIMER() - iLocal_48) > iVar5) || (MISC::GET_GAME_TIMER() - iLocal_50) > iVar6)
				{
					...
					{
						CAM::SET_CAM_PARAMS(iLocal_46, Var0[0 /*3*/], Var1[0 /*3*/], fVar2[0], iVar5, 1, 1, 2);
						CAM::SET_CAM_PARAMS(iLocal_46, Var0[1 /*3*/], Var1[1 /*3*/], fVar2[1], iVar5, 1, 1, 2);
						STREAMING::NEW_LOAD_SCENE_STOP();
						func_9("SHI_M_HOUSE_3" /* GXT: You can change clothes in the wardrobe. */, iVar5 + 10000);
						iLocal_48 = MISC::GET_GAME_TIMER();
						iLocal_50 = MISC::GET_GAME_TIMER();
						iLocal_38 = 3;
					}
			...
			case 3:
				...
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (MISC::GET_GAME_TIMER() - iLocal_48) > iVar5) || (MISC::GET_GAME_TIMER() - iLocal_50) > iVar6)
				{
					if (CAM::DOES_CAM_EXIST(iLocal_46))
					{
						CAM::SET_CAM_PARAMS(iLocal_46, Var0[0 /*3*/], Var1[0 /*3*/], fVar2[0], (iVar5 / 2), 1, 1, 2);
						CAM::SET_CAM_PARAMS(iLocal_46, Var0[1 /*3*/], Var1[1 /*3*/], fVar2[1], (iVar5 / 2), 1, 1, 2);
						STREAMING::NEW_LOAD_SCENE_STOP();
						func_9("SHI_M_HOUSE_4" /* GXT: Walk around the house to find various activities to take part in. */, iVar5 + 10000);
						iLocal_48 = MISC::GET_GAME_TIMER();
						iLocal_50 = MISC::GET_GAME_TIMER();
						iLocal_38 = 4;
					}
			...
			case 5:
				if (iLocal_44 == 0)
				{
					if (CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(CAM::GET_CAM_ACTIVE_VIEW_MODE_CONTEXT()) == 4 && (MISC::GET_GAME_TIMER() - iLocal_48) >= (iVar5 - 300))
					{
...
void func_11(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x10FE
{
	struct<60> Var0;
...
void func_12(int iParam0, int iParam1, int iParam2)//Position - 0x1227
{
	int iVar0;
	...
	if (!func_45(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_113386.f_32749.f_4801 = func_34();
			}
...
void func_13(int iParam0, int iParam1)//Position - 0x133E
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_57(iParam0, &(Global_113386.f_32749.f_5510));
}

int func_14(int iParam0)//Position - 0x1540
{
...
int func_15(int iParam0)//Position - 0x161D
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_16(int iParam0, bool bParam1)//Position - 0x17CE
{
	int iVar0;
	struct<2> Var1;
...
int func_17(int iParam0)//Position - 0x194E
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_19(int iParam0)//Position - 0x1A2E
{
	int iVar0;
	int iVar1;
...
bool func_20()//Position - 0x4D02
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_21()//Position - 0x4D18
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_22()//Position - 0x4D2E
{
	return 0;
}

int func_23()//Position - 0x4D37
{
	return 1;
}

int func_24()//Position - 0x4D40
{
	return 1;
}

int func_25()//Position - 0x4D49
{
...
int func_27(int iParam0)//Position - 0x4E1A
{
	int iVar0;
	char* sVar1;
...
int func_28(int iParam0)//Position - 0x4E60
{
	int iVar0;
...
int func_29(int iParam0)//Position - 0x4E9B
{
	int iVar0;
...
int func_30(int iParam0)//Position - 0x4F17
{
	int iVar0;
...
int func_31(int iParam0, int iParam1, bool bParam2)//Position - 0x4FFF
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_32(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x506D
{
...
int func_33(int iParam0)//Position - 0x5146
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_35(var uParam0, int iParam1)//Position - 0x51A8
{
	if (iParam1 <= 0)
	{
		return;
...
void func_36(var uParam0, int iParam1)//Position - 0x522E
{
...
void func_37(var uParam0, int iParam1)//Position - 0x5261
{
	int iVar0;
	int iVar1;
...
int func_38(int iParam0, int iParam1)//Position - 0x52B2
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_39(int iParam0)//Position - 0x5354
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_40(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_40(bool bParam0, int iParam1, int iParam2)//Position - 0x5376
{
	if (bParam0)
	{
		return iParam1;
...
int func_41(var uParam0)//Position - 0x538D
{
	return uParam0 & 15;
}

void func_42(var uParam0, int iParam1)//Position - 0x539A
{
...
void func_43(var uParam0, int iParam1)//Position - 0x53D4
{
...
void func_44(var uParam0, int iParam1)//Position - 0x540F
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_45(var uParam0, int iParam1)//Position - 0x544B
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_56(Global_113386.f_32749.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_56(Global_113386.f_2363.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_56(Global_113386.f_2363.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_46(int iParam0, int iParam1)//Position - 0x6B3A
{
	struct<82> Var0;
...
void func_47(int iParam0, var uParam1, int iParam2)//Position - 0x6B7C
{
	int iVar0;
...
bool func_48(int iParam0)//Position - 0x6DD8
{
	return iParam0 < 3;
}

void func_49(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x6DE4
{
	if (func_45(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_54(iParam0);
			func_53(uParam1, &(Global_113386.f_32749.f_69[Global_77137.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_50(int iParam0, bool bParam1)//Position - 0x6EDD
{
	if (iParam0 == -1)
	{
		return;
...
void func_51(int iParam0, int iParam1, bool bParam2)//Position - 0x6F3A
{
	if (iParam0 == -1)
	{
		return;
...
int func_52(int iParam0, int iParam1)//Position - 0x6F75
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_53(var uParam0, var uParam1)//Position - 0x6F95
{
...
void func_54(int iParam0)//Position - 0x7061
{
	if (iParam0 == -1)
	{
		return;
...
int func_55(int iParam0)//Position - 0x70D8
{
	int iVar0;
...
bool func_56(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x713B
{
	if (bParam2)
	{
...
void func_57(int iParam0, var uParam1)//Position - 0x7182
{
	int iVar0;
...
int func_58(int iParam0)//Position - 0x742D
{
	switch (iParam0)
	{
		case 1:
...
int func_59(int iParam0, var uParam1, var uParam2)//Position - 0x74DD
{
	int iVar0;
	int iVar1;
...
int func_60(int iParam0)//Position - 0x76D0
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_61(var uParam0)//Position - 0x76F0
{
	int iVar0;
...
void func_62(int iParam0)//Position - 0x77A1
{
...
Vector3 func_63(struct<3> Param0)//Position - 0x77C8
{
	return (-SYSTEM::SIN(Param0.f_2) * SYSTEM::COS(Param0.f_0)), (SYSTEM::COS(Param0.f_2) * SYSTEM::COS(Param0.f_0)), SYSTEM::SIN(Param0.f_0);
}

void func_64(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x77F5
{
	int iVar0;
...
void func_65(int iParam0, bool bParam1)//Position - 0x79B3
{
	if (CAM::IS_SCREEN_FADED_OUT() || CAM::IS_SCREEN_FADING_OUT())
	{
...
Vector3 func_66(int iParam0)//Position - 0x79EF
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_67(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x7A02
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							...
							func_87(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
							func_110(14);
							if (Global_78128 == 1)
							{
								iVar2 = 0;
			...
			{
				Global_78130[1 /*14*/] = { func_119(iVar10, iVar0, func_76(iParam0, iVar0, -1), -1) };
...
int func_68(int iParam0, int iParam1, int iParam2)//Position - 0x8213
{
	int iVar0;
	...
	{
		if (!func_184(iParam0, Global_113386.f_2363.f_539[iVar0 /*65*/].f_64, Global_113386.f_2363.f_539[iVar0 /*65*/].f_63))
		{
...
int func_69(int iParam0)//Position - 0x829F
{
	switch (iParam0)
	{
...
void func_70(int iParam0, int iParam1, int iParam2)//Position - 0x82DA
{
	int iVar0;
	int iVar1;
...
int func_71(int iParam0, int iParam1, int iParam2)//Position - 0x8364
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_72(int iParam0, int iParam1, int iParam2)//Position - 0x8442
{
	Global_78130[1 /*14*/] = { func_119(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78130[1 /*14*/].f_6, 2);
}

int func_73(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x846A
{
	var uVar0;
	int iVar1;
...
int func_74(int iParam0, int iParam1, int iParam2)//Position - 0x8A6E
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8B07
{
	int iVar0;
	...
	{
		if (!func_184(iParam0, Global_113386.f_2363.f_539[iVar0 /*65*/].f_61, Global_113386.f_2363.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_76(int iParam0, int iParam1, int iParam2)//Position - 0x8B9D
{
	int iVar0;
	int iVar1;
...
int func_77(int iParam0)//Position - 0x8C3E
{
	switch (iParam0)
	{
		case 0:
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8CEE
{
	int iVar0;
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x8FF5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x9BA8
{
	int iVar0;
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9E8C
{
	int iVar0;
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA153
{
	int iVar0;
	int iVar1;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA18A
{
	int iVar0;
...
int func_84(int iParam0, int iParam1, int iParam2)//Position - 0xA1B3
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA47D
{
	int iVar0;
...
int func_86(int iParam0, int iParam1, int iParam2)//Position - 0xA707
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA85E
{
	int iVar0;
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA8F6
{
	switch (iParam0)
	{
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA9C4
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_90(int iParam0, int iParam1)//Position - 0xAADE
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_91(int iParam0)//Position - 0xAE85
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAEE6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_93(int iParam0, int iParam1)//Position - 0xAFE2
{
	int iVar0;
...
int func_94(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB120
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_95(int iParam0)//Position - 0xB1DB
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_96(int iParam0)//Position - 0xB23A
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_97(int iParam0, int iParam1)//Position - 0xB2C0
{
	int iVar0;
	struct<10> Var1;
...
void func_98(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBBEF
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var2;
...
void func_99(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xBD19
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_100(int iParam0, int iParam1)//Position - 0xBD61
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_103(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[0], Global_113386.f_2363.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_103(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[1], Global_113386.f_2363.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_103(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[2], Global_113386.f_2363.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_101(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDBAA
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var2;
...
int func_102(int iParam0)//Position - 0xDD94
{
	switch (iParam0)
	{
		case 0:
...
void func_103(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xDE44
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDEB5
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_89(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_89(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_89(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_89(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE132
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE557
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_107(int iParam0, int iParam1)//Position - 0xE84A
{
	int iVar0;
	int iVar1;
...
int func_108(int iParam0, int iParam1)//Position - 0xE890
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE8F0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_110(int iParam0)//Position - 0xE947
{
...
void func_111(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE9F3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_112(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xEA3D
{
	int iVar0;
...
int func_113(var uParam0)//Position - 0xEA6D
{
	int iVar0;
	int iVar1;
...
int func_114()//Position - 0xEAA1
{
	return Global_1574918;
}

int func_115(int iParam0, int iParam1, int iParam2)//Position - 0xEAAD
{
	int iVar0;
	var uVar1;
...
bool func_116(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xEAEA
{
	int iVar0;
...
int func_117(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x11067
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_118(int iParam0)//Position - 0x11F0A
{
	if (!BitTest(Global_78130[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_119(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11F52
{
	func_183();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_120(int iParam0, int iParam1)//Position - 0x11FA4
{
	switch (iParam0)
	{
		case 0:
...
void func_121(int iParam0)//Position - 0x12094
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x1330B
{
	var uVar0;
	int iVar1;
...
bool func_123(int iParam0, int iParam1, var uParam2)//Position - 0x136B0
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_124(int iParam0, int iParam1)//Position - 0x13AB5
{
	switch (iParam1)
	{
		case 0:
...
int func_125(int iParam0, int iParam1)//Position - 0x13EB0
{
	switch (iParam1)
	{
		case 0:
...
int func_126(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x142AC
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_127(int iParam0)//Position - 0x142EB
{
	return Global_43052 == iParam0;
}

int func_128(int iParam0)//Position - 0x142F9
{
	switch (iParam0)
	{
		case -1:
...
void func_129(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x143CD
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_130(int iParam0)//Position - 0x14654
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x147AB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x14CB9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x14D2E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x14DA2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x14E89
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x151EC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x153FD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x1562D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x1573D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x160DC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x16C4F
{
	if (iParam0 < 136)
	{
		func_143(iParam0);
...
void func_142(int iParam0)//Position - 0x16C84
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x17888
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x18798
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x188C5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0, int iParam1)//Position - 0x189C3
{
	switch (iParam0)
	{
		case 0:
...
void func_147(int iParam0)//Position - 0x18AB3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x19FA4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x1A0F5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x1A600
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1AC6E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x1ACE2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1ADB2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1B2E2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1B479
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1BC77
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x1BD87
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x1CF04
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1DBC1
{
	if (iParam0 < 107)
	{
		func_162(iParam0);
...
void func_160(int iParam0)//Position - 0x1DC07
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1E6AC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x1F49B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x200E6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x2035F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0, int iParam1)//Position - 0x204A5
{
	switch (iParam0)
	{
		case 0:
...
void func_166(int iParam0)//Position - 0x20595
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x2131F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x21499
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x21A10
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x21F3A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x21FAE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x2207E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x22556
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x227BF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x22A95
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x22C5E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x237B2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x243FD
{
	if (iParam0 < 60)
	{
		func_180(iParam0);
...
void func_179(int iParam0)//Position - 0x24432
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x251D2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x2585E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x25945
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183()//Position - 0x25A43
{
...
int func_184(int iParam0, int iParam1, int iParam2)//Position - 0x25ABC
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_184(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_184(iParam0, 14, uVar6[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
									...
									if (Global_78130[2 /*14*/].f_12 == iVar3)
									{
										...
										{
											if (!func_73(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_78130[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						if (!func_73(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_78130[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar7 <= 8)
		{
			if (!func_184(iParam0, 14, uVar8[iVar7]))
			{
				return 0;
			}
			iVar7++;
...
int func_185()//Position - 0x25D14
{
	func_186();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_186()//Position - 0x25D2D
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_188(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_187(PLAYER::PLAYER_PED_ID());
			if (func_48(iVar0) && (!func_127(14) || Global_112337))
			{
...
int func_187(int iParam0)//Position - 0x25E2A
{
	int iVar0;
	int iVar1;
...
int func_188(int iParam0)//Position - 0x25E67
{
	if (func_48(iParam0))
	{
...
var func_189(int iParam0)//Position - 0x25E8C
{
	return Global_1998[iParam0 /*29*/];
}

void func_190(bool bParam0)//Position - 0x25E9B
{
	int iVar0;
	...
	func_191(1, 1, 0, 0, 0, 0, 0);
}

void func_191(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x25EDA
{
	if (bParam0)
	{
...
bool func_192()//Position - 0x2601D
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_193(int iParam0, int iParam1)//Position - 0x26037
{
	bool bVar0;
...
int func_194(int iParam0, bool bParam1)//Position - 0x26082
{
	int iVar0;
	int iVar1;
...
int func_195(int iParam0)//Position - 0x260C3
{
...
bool func_196()//Position - 0x26102
{
	return BitTest(Global_2621446, 3);
}

int func_197(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x26110
{
	int iVar0;
...
void func_199(int iParam0)//Position - 0x2616A
{
	if (iParam0 == 1)
	{
...
void func_200()//Position - 0x2618D
{
	Global_20471 = 0;
	func_201();
}

void func_201()//Position - 0x2619D
{
...
int func_202(int iParam0, float fParam1, int iParam2)//Position - 0x261BE
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_209(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_208(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")))
				{
...
bool func_203()//Position - 0x26292
{
	bool bVar0;
...
void func_204()//Position - 0x262B5
{
	Global_20471 = 0;
	func_205();
}

void func_205()//Position - 0x262C5
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22616 = 0;
...
void func_207()//Position - 0x2633E
{
...
int func_208(int iParam0, int iParam1)//Position - 0x2638F
{
	if (func_7(iParam0))
	{
...
int func_209(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x263C2
{
...
void func_210(int iParam0)//Position - 0x2655A
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_211()//Position - 0x26586
{
	if (iLocal_41)
	{
		if (INTERIOR::IS_VALID_INTERIOR(iLocal_51))
...
void func_212(bool bParam0)//Position - 0x265BC
{
	if (bParam0)
	{
		if (!iLocal_40)
...
int func_213()//Position - 0x26617
{
	int iVar0;
	
	iVar0 = func_214(&iLocal_47, 0, 0, 0, 0);
	if (iVar0 == 1)
	{
		return 1;
	}
...
int func_214(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x26636
{
	int iVar0;
	...
	if (*iParam0 == -1)
	{
		...
		*iParam0 = Global_43016;
		...
		if (iParam4 != 0)
		{
			func_215(iParam0, iParam4);
		}
	}
	return 2;
}

void func_215(var uParam0, int iParam1)//Position - 0x2676D
{
	int iVar0;
...
bool func_216(int iParam0)//Position - 0x267BC
{
	return func_217(iParam0, Global_43052);
}

int func_217(int iParam0, int iParam1)//Position - 0x267CD
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_218(int iParam0)//Position - 0x269AE
{
	if (Global_43052 == 15)
	{
		return 0;
...
int func_219()//Position - 0x269D0
{
	...
	if (Global_43599 != -1)
	{
		if (Global_113386.f_7688[Global_43599 /*15*/].f_3 >= 2)
		{
			return 0;
		}
	}
...
bool func_222(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x26A8C
{
	struct<3> Var0;
...
bool func_223(var uParam0, struct<2> Param1, var uParam2)//Position - 0x26AB6
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_224(var uParam0)//Position - 0x26B72
{
	int iVar0;
	float fVar1;
...
void func_225(var uParam0, struct<3> Param1)//Position - 0x26C12
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_226(var uParam0)//Position - 0x26C43
{
	if (uParam0->f_51)
	{
	}
...
void func_227()//Position - 0x26C6A
{
	if (iLocal_47 != -1)
	{
		if (iLocal_39)
...
void func_228(int iParam0)//Position - 0x26CE5
{
	if (*iParam0 == -1)
	{
		return;
...
int func_229(int iParam0)//Position - 0x26D22
{
	int iVar0;
	bool bVar1;
