...
void func_34()//Position - 0x119A
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_37(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_35(iVar0) && (!func_7(14) || Global_113083))
			{
...
int func_47(int iParam0)//Position - 0x14B5
{
	...
	if ((((((HUD::IS_PAUSE_MENU_ACTIVE() || PLAYER::IS_SYSTEM_UI_BEING_DISPLAYED()) || func_45()) || Global_64302) || func_46(0)) || func_52(0)) || func_48(PLAYER::PLAYER_ID()))
	{
		return 0;
	}
	return 1;
...
int func_48(int iParam0)//Position - 0x151B
{
	if (func_51(iParam0))
	{
		return 1;
...
int func_49(int iParam0)//Position - 0x153E
{
	int iVar0;
...
var func_50(int iParam0, int iParam1)//Position - 0x155C
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_51(var uParam0)//Position - 0x1574
{
	int iVar0;
...
int func_52(int iParam0)//Position - 0x1597
{
	if (iParam0 == 1)
	{
...
void func_55(struct<3> Param0, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x1638
{
	int iVar0;
	float fVar1;
	struct<3> Var2;
...
void func_57(struct<3> Param0, struct<3> Param3, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x1713
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
Vector3 func_58(struct<3> Param0, struct<3> Param3)//Position - 0x1923
{
...
int func_61(int iParam0)//Position - 0x1A5A
{
...
int func_62(int iParam0)//Position - 0x1AC5
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_63(int iParam0)//Position - 0x1C56
{
	int iVar0;
...
int func_64(int iParam0)//Position - 0x1EB5
{
...
int func_65(int iParam0, bool bParam1)//Position - 0x20F6
{
	if (Global_79539)
	{
...
float func_66(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x2144
{
	struct<3> Var0;
...
void func_71(var uParam0, struct<3> Param1, float fParam4)//Position - 0x22CD
{
...
void func_73(var uParam0, int iParam1, char* sParam2, struct<3> Param3, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0x231D
{
	uParam0->f_5 = sParam2;
	uParam0->f_1 = { Param3 };
	uParam0->f_4 = sParam7;
...
bool func_75(int iParam0)//Position - 0x23AA
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
