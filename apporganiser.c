...
void func_4(int iParam0, bool bParam1)//Position - 0x25C
{
	...
	{
		iVar4 = iVar3;
		iVar3 = Global_98464[iVar0 /*25*/][iVar1];
		if (!iVar3 == iVar4)
		{
			if (!iVar3 == 0)
			{
		...
		if (iVar0 == Global_98463 && iVar1 == Global_98462)
		{
			bVar2 = false;
		}
	}
	...
	if (iVar11 > 0)
	{
		...
		if (iVar11 > 7)
		{
			...
			while (iVar8 < 7)
			{
				...
				while (iVar9 < 24)
				{
					if (!Global_98464[iVar6 /*25*/][iVar7] == 0)
					{
						Global_98459++;
						Global_98461 = (Global_98461 - 1);
					}
					Global_98464[iVar6 /*25*/][iVar7] = 0;
					iVar9++;
				}
				iVar8++;
			}
