...
void func_1()//Position - 0x15D
{
	switch (iLocal_83)
	{
		...
		case 5:
			...
			if (((!func_77(5) && iLocal_71 == 4) && func_72()) && !func_71(0))
			{
				func_69(5, 1, 0);
			}
			break;
		...
		if (bParam2)
		{
			if (!Global_79539)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9595[iParam1 /*4*/] = { func_9(iParam0) };
					...
					{
						Global_9546[1 /*6*/] = { func_9(iParam0) };
...
bool func_22(int iParam0)//Position - 0xA8A
{
	...
	iVar1 = MISC::GET_BITS_IN_RANGE(Global_114135.f_10053.f_133, 0, (iVar0 - 1));
...
void func_35()//Position - 0x14E9
{
	...
	switch (iLocal_70)
	{
		...
		case 2:
			...
			{
				func_46(24, 0);
				func_45(PLAYER::PLAYER_PED_ID(), Local_59, fLocal_62);
				...
				func_44(1);
				func_24(-1023.43915f, -479.5592f, 35.81806f, -1014.3829f, -495.12393f, 40.107964f, 18.5f, -1024.0964f, -485.1923f, 35.9779f, 209.0203f, func_43(), 1, 0, 1, 1, 0);
				...
				if (iLocal_84 <= MISC::GET_GAME_TIMER())
				{
					...
					func_45(PLAYER::PLAYER_PED_ID(), Local_55, fLocal_58);
					func_62(1, 800);
					iLocal_70 = 0;
				}
				else
...
struct<5> func_40(int iParam0)//Position - 0x1875
{
	...
	switch (iParam0)
	{
		...
		case 243:
			...
			Var0.f_3 = func_41(&(Global_4718592.f_225053[0 /*160*/]));
			Var0.f_4 = Var0.f_3;
			break;
		
		case 244:
			Var0 = { Global_4718592.f_225053[1 /*160*/].f_16 };
			Var0.f_3 = func_41(&(Global_4718592.f_225053[1 /*160*/]));
			Var0.f_4 = Var0.f_3;
			break;
		
		case 245:
			Var0 = { Global_4718592.f_225053[2 /*160*/].f_16 };
			Var0.f_3 = func_41(&(Global_4718592.f_225053[2 /*160*/]));
			Var0.f_4 = Var0.f_3;
			break;
		
		case 246:
			Var0 = { Global_4718592.f_225053[3 /*160*/].f_16 };
			Var0.f_3 = func_41(&(Global_4718592.f_225053[3 /*160*/]));
			Var0.f_4 = Var0.f_3;
			break;
		
		case 247:
			Var0 = { Global_4718592.f_225053[4 /*160*/].f_16 };
			Var0.f_3 = func_41(&(Global_4718592.f_225053[4 /*160*/]));
			Var0.f_4 = Var0.f_3;
			break;
...
void func_45(int iParam0, struct<3> Param1, float fParam4)//Position - 0x50C2
{
...
int func_47(int iParam0)//Position - 0x518C
{
	struct<2> Var0;
...
bool func_51(char* sParam0)//Position - 0x542A
{
...
bool func_53(int iParam0, int iParam1)//Position - 0x5458
{
	int iVar0;
...
int func_65(int iParam0)//Position - 0x5707
{
	if (!func_17(iParam0))
	{
		return 7;
...
int func_67(int iParam0)//Position - 0x576F
{
...
int func_68(int iParam0)//Position - 0x579B
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_69(int iParam0, bool bParam1, bool bParam2)//Position - 0x57BC
{
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_114135.f_10053.f_133), iParam0);
		if (!bParam2)
		{
	...
	{
		MISC::CLEAR_BIT(&(Global_114135.f_10053.f_133), iParam0);
	}
}
...
int func_71(bool bParam0)//Position - 0x584B
{
...
{
	return SYSTEM::VDIST2(func_76(iLocal_83), Local_80) < func_75(iLocal_83);
}
...
{
	return BitTest(Global_114135.f_10053.f_133, iParam0);
}

int func_78()//Position - 0x5A1A
{
	switch (iLocal_83)
	{
		case 0:
		...
		case 6:
			return (func_80() || (func_34(2) && func_79(Local_66)));
...
bool func_79(struct<3> Param0)//Position - 0x5ABD
{
	var uVar0;
	var uVar1;
...
{
	return SYSTEM::VDIST2(func_82(iLocal_83), Local_80) < func_81(iLocal_83);
}
...
void func_84(struct<3> Param0)//Position - 0x5C4F
{
	int iVar0;
	int iVar1;
...
void func_85()//Position - 0x5CB2
{
	switch (iLocal_83)
	{
		...
		case 4:
			...
			func_86(sLocal_86);
			iLocal_76 = PED::CREATE_PED(26, joaat("U_F_M_Drowned_01"), func_76(4), 184.5548f, true, true);
			...
			ENTITY::SET_ENTITY_INVINCIBLE(iLocal_76, true, false);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_76, joaat("PLAYER"));
			break;
		
		case 5:
			iLocal_73 = 731806707;
			OBJECT::ADD_DOOR_TO_SYSTEM(iLocal_73, joaat("v_ilev_sol_off_door01"), -1002.147f, -478.064f, 50.117f, true, true, false, 0);
		...
		case 6:
			...
			iLocal_74 = PED::CREATE_PED(26, joaat("U_M_O_FilmNoir"), func_76(6), 22.9631f, true, true);
			...
			iLocal_75 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_vintage_filmcan"), -543.71f, 1986.2f, 126.05f, true, true, false, 0);
			break;
	}
}
...
void func_88(int iParam0, struct<3> Param1, float fParam4)//Position - 0x5EAE
{
...
bool func_89(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x5ED4
{
	return SYSTEM::VDIST(Param0, Param3) <= fParam6;
}

int func_90()//Position - 0x5EEB
{
	int iVar0;
...
void func_92()//Position - 0x5FB7
{
	switch (iLocal_83)
	{
		...
		case 5:
			...
			if (func_51(sLocal_88) || func_51(sLocal_89))
			{
				HUD::CLEAR_HELP(true);
			}
			break;
