...
void func_24(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0xADF
{
	func_25(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_25(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0xB09
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_29(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x1068
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_30(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x135E
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	switch (iLocal_60)
	{
		...
		case 2:
			...
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (iLocal_72 <= MISC::GET_GAME_TIMER())
				{
					...
					func_44(PLAYER::PLAYER_PED_ID(), Local_53, fLocal_54);
					func_61(1, 800);
					iLocal_60 = 0;
				}
				else
		...
		case 3:
			...
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				func_43(0);
				func_37();
				func_36(Local_53, 30f, 12, 5000, 0, 0);
				func_61(1, 800);
				iLocal_60 = 0;
			}
			break;
...
void func_36(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x1792
{
	int iVar0;
	int iVar1;
...
void func_44(int iParam0, struct<3> Param1, float fParam2)//Position - 0x4D7B
{
...
int func_77()//Position - 0x56D3
{
	switch (iLocal_71)
	{
		...
		case 6:
			return (func_79() || (func_34(2) && func_78(Local_58)));
...
void func_84()//Position - 0x596B
{
	switch (iLocal_71)
	{
		...
		case 6:
			...
			PED::SET_PED_PROP_INDEX(iLocal_64, 0, 0, 0, false, 1);
...
void func_87(int iParam0, struct<3> Param1, float fParam2)//Position - 0x5B64
{
...
bool func_88(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x5B8A
{
