		...
		if (bParam2)
		{
			if (!Global_78319)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8795[iParam1 /*4*/] = { func_9(iParam0) };
					...
					{
						Global_8746[1 /*6*/] = { func_9(iParam0) };
...
struct<6> func_41(int iParam0, bool bParam1)//Position - 0x40EB
{
	struct<6> Var0;
...
Vector3 func_42()//Position - 0x4CA1
{
...
void func_44(int iParam0, struct<3> Param1, float fParam2)//Position - 0x4CCD
{
	ENTITY::SET_ENTITY_COORDS(iParam0, Param1, true, false, false, true);
	ENTITY::SET_ENTITY_HEADING(iParam0, fParam2);
}

void func_45(int iParam0, bool bParam1)//Position - 0x4CEB
{
	char* sVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x4D76
{
	struct<2> Var0;
...
struct<2> func_47(int iParam0)//Position - 0x4DA7
{
	struct<2> Var0;
...
void func_48(int iParam0, bool bParam1)//Position - 0x4DD4
{
	struct<2> Var0;
...
bool func_50(char* sParam0)//Position - 0x5014
{
...
bool func_52(int iParam0, int iParam1)//Position - 0x5042
{
	int iVar0;
...
void func_53(char* sParam0)//Position - 0x5062
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, true, true, -1);
}

void func_54(int iParam0)//Position - 0x5078
{
	if (func_59())
	{
		return;
...
void func_55(int iParam0)//Position - 0x50AB
{
	if (func_59())
	{
		return;
...
void func_57(bool bParam0, bool bParam1)//Position - 0x515C
{
	if (bParam0)
	{
		if (func_5(0))
...
bool func_58()//Position - 0x51D0
{
	return BitTest(Global_1958711, 5);
}

bool func_59()//Position - 0x51DE
{
	return BitTest(Global_1958711, 19);
}

void func_60()//Position - 0x51ED
{
	Global_23011.f_6 = 1;
}
...
int func_64(int iParam0)//Position - 0x52F1
{
	if (!func_17(iParam0))
	{
		return 7;
...
int func_66(int iParam0)//Position - 0x5359
{
...
int func_67(int iParam0)//Position - 0x5385
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_70(bool bParam0)//Position - 0x5435
{
...
void func_87(int iParam0, struct<3> Param1, float fParam2)//Position - 0x5A94
{
