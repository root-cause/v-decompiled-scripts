	...
	switch (Local_78.f_1.f_2)
	{
		...
		case 2:
			...
			else
			{
				...
				{
					if (func_4(&(Local_78.f_1.f_15), Global_262145.f_11111 /* Tunable: ISLANDBACKUPHELILIFESPANMS */, 0))
					{
						func_63(3);
					}
				}
		...
		if (func_39(Local_78.f_1.f_3[1 /*2*/].f_1) && func_39(iVar0))
		{
			if (!func_12(Local_78.f_1))
			{
				if (func_36(&(Local_78.f_1), Local_78.f_1.f_1, Local_78.f_1.f_8, 0f, 1, 1, 1, 0, 0, 1, 0, 0, 0, 0))
				{
					...
					func_35(iVar1, 4);
					Global_2672939.f_3880 = iVar1;
					ENTITY::SET_ENTITY_HEALTH(iVar1, Global_262145.f_11112 /* Tunable: ISLANDBACKUPHELIHEALTH */, 0, 0);
					if (func_34(&(Local_78.f_1.f_3[0 /*2*/]), Local_78.f_1, 4, iVar0, -1, 1, 1, 1))
					{
						...
						func_35(iVar2, 4);
						Global_2672939.f_3880.f_1[0] = iVar2;
						...
						if (func_34(&(Local_78.f_1.f_3[1 /*2*/]), Local_78.f_1, 4, Local_78.f_1.f_3[1 /*2*/].f_1, 1, 1, 1, 1))
						{
							...
							Global_2672939.f_3880.f_1[1] = NETWORK::NET_TO_PED(Local_78.f_1.f_3[1 /*2*/]);
...
int func_31(int iParam0, bool bParam1, bool bParam2)//Position - 0xC20
{
	if (bParam1)
	{
		if (func_32(iParam0))
...
var func_33(int iParam0)//Position - 0xC60
{
	return BitTest(Global_1845221[iParam0 /*889*/].f_11.f_1, 0);
}

int func_34(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0xC77
{
...
void func_35(int iParam0, int iParam1)//Position - 0xCFF
{
	int iVar0;
...
int func_36(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0xD32
{
	float fVar0;
	int iVar1;
...
void func_37(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0xE4A
{
	int iVar0;
...
int func_38(int iParam0, struct<3> Param1, int iParam4)//Position - 0xF1D
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
int func_40()//Position - 0xFD9
{
	struct<3> Var0;
	
	if (func_62(Local_78.f_1.f_8))
	{
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
			{
				Var0 = { func_60(func_61(PLAYER::PLAYER_ID()), 0f, (-200f * SYSTEM::SIN((SYSTEM::TO_FLOAT(Local_78.f_1.f_13) * 30f))), (200f * SYSTEM::COS((SYSTEM::TO_FLOAT(Local_78.f_1.f_13) * 30f))), 0f) };
...
int func_41(struct<3> Param0, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, bool bParam8, int iParam9, float fParam10, bool bParam11, int iParam12, bool bParam13, float fParam14, bool bParam15, float fParam16, bool bParam17, bool bParam18)//Position - 0x10CC
{
...
int func_42(struct<3> Param0, float fParam3, int iParam4, int iParam5, float fParam6, bool bParam7, int iParam8, float fParam9, bool bParam10)//Position - 0x11DE
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar0 < 32)
	{
		...
		if (func_52(iVar1, 1, 1))
		{
			if (!func_44(iVar1, 0) && NETWORK::NETWORK_ARE_PLAYERS_IN_SAME_TUTORIAL_SESSION(PLAYER::PLAYER_ID(), iVar1))
			{
				...
				{
					if ((func_43(iVar1) || !bParam10) && !Global_2657991[iVar1 /*467*/].f_273)
					{
						fVar2 = fParam6;
						if (fParam9 > 0f)
						{
...
int func_43(int iParam0)//Position - 0x1396
{
...
bool func_44(int iParam0, int iParam1)//Position - 0x13C2
{
	bool bVar0;
...
int func_47(int iParam0)//Position - 0x1468
{
	int iVar0;
...
Vector3 func_48(int iParam0)//Position - 0x148A
{
	int iVar0;
	
	iVar0 = iParam0;
	if ((func_51() && Global_1845221[iVar0 /*889*/].f_866) && !func_62(Global_1845221[iVar0 /*889*/].f_867))
	{
...
int func_52(int iParam0, bool bParam1, bool bParam2)//Position - 0x152C
{
	int iVar0;
...
int func_53(struct<3> Param0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8, var uParam9, int iParam10)//Position - 0x158C
{
	int iVar0;
	int iVar1;
...
int func_54(int iParam0)//Position - 0x1690
{
	if (func_59(PLAYER::PLAYER_ID(), iParam0))
	{
		return 1;
	}
	Global_2707651 = { func_58(iParam0) };
...
int func_55(int iParam0, int iParam1)//Position - 0x16D7
{
	int iVar0;
...
int func_56(int iParam0)//Position - 0x1700
{
	if (func_47(iParam0))
	{
...
int func_57()//Position - 0x1723
{
	return -1;
}

struct<13> func_58(int iParam0)//Position - 0x172C
{
	struct<13> Var0;
...
int func_59(int iParam0, int iParam1)//Position - 0x1743
{
	if (NETWORK::NETWORK_CLAN_SERVICE_IS_VALID())
	{
		Global_2707651 = { func_58(iParam0) };
		Global_2707664 = { func_58(iParam1) };
...
Vector3 func_60(struct<3> Param0, float fParam3, struct<2> Param4, float fParam6)//Position - 0x17B0
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
Vector3 func_61(int iParam0)//Position - 0x17FD
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_62(struct<3> Param0)//Position - 0x1810
{
...
void func_68(int iParam0, int iParam1)//Position - 0x18DD
{
	int iVar0;
...
void func_71()//Position - 0x1EDF
{
	...
	if (!func_11(Local_78.f_1.f_3[0 /*2*/]))
	{
		if (func_83(Local_78.f_1.f_3[0 /*2*/]))
		{
			if (NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_78.f_1.f_3[0 /*2*/]))
			{
				iVar0 = NETWORK::NET_TO_PED(Local_78.f_1.f_3[0 /*2*/]);
	...
	if (!func_11(Local_78.f_1.f_3[1 /*2*/]))
	{
		if (func_83(Local_78.f_1.f_3[1 /*2*/]))
		{
			if (NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_78.f_1.f_3[1 /*2*/]))
			{
				iVar0 = NETWORK::NET_TO_PED(Local_78.f_1.f_3[1 /*2*/]);
...
void func_72()//Position - 0x1F79
{
	...
	if (!func_6(&uLocal_74))
	{
		if (iLocal_76 != func_57() && func_80(iVar1))
		{
	...
	if (!func_4(&uLocal_74, Global_1957661, 0))
	{
		return;
	}
	func_73(&uLocal_74);
	...
	while (iVar2 < iVar3)
	{
		...
		if (func_80(iVar5) && PED::IS_PED_IN_COMBAT(iVar5, 0))
		{
			bVar4 = true;
		}
		else
...
void func_73(var uParam0)//Position - 0x207C
{
	uParam0->f_1 = 0;
}
...
void func_74()//Position - 0x2089
{
	...
	iVar5 = func_77(PLAYER::PLAYER_ID());
	iVar6 = PLAYER::GET_PLAYER_PED(iVar5);
	iLocal_76 = func_57();
	iLocal_77++;
	iLocal_77 = func_76(iLocal_77, 32);
	iVar0 = iLocal_77;
	if (iVar0 == func_57())
	{
		return;
	...
	if (func_80(iVar6))
	{
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iVar6, true), ENTITY::GET_ENTITY_COORDS(iVar2, true), false) > Global_1957663)
		{
			return;
		}
	}
	if (func_55(iVar1, iVar0) || func_75(iVar1, iVar0, -2, 0))
	{
...
bool func_75(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x218A
{
	if (iParam2 == -2)
	{
		if (iParam3 == 0)
...
int func_77(int iParam0)//Position - 0x2215
{
...
int func_78(int iParam0, bool bParam1)//Position - 0x2240
{
	if (!func_47(iParam0))
	{
		return 0;
...
int func_79(int iParam0)//Position - 0x2278
{
	if (func_47(iParam0))
	{
...
int func_80(int iParam0)//Position - 0x22AD
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_81(int iParam0)//Position - 0x22CE
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_83(int iParam0)//Position - 0x233F
{
...
void func_86()//Position - 0x237B
{
	...
	if (bVar0)
	{
		...
		if (fLocal_67 < Global_262145.f_11113 /* Tunable: ISLANDBACKUPHELIMINHEIGHT */)
		{
			fLocal_67 = Global_262145.f_11113 /* Tunable: ISLANDBACKUPHELIMINHEIGHT */;
		}
		func_73(&uLocal_68);
	}
}
...
{
	if (ENTITY::DOES_ENTITY_EXIST(Global_2672939.f_3880.f_1[0]))
	{
		PED::DELETE_PED(&(Global_2672939.f_3880.f_1[0]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Global_2672939.f_3880.f_1[1]))
	{
		PED::DELETE_PED(&(Global_2672939.f_3880.f_1[1]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Global_2672939.f_3880))
	{
		VEHICLE::DELETE_VEHICLE(&(Global_2672939.f_3880));
	}
...
int func_95(int iParam0)//Position - 0x258E
{
...
void func_99(struct<21> Param0)//Position - 0x25CD
{
	func_89(0);
	func_102(32, Param0);
...
int func_101(int iParam0, int iParam1, bool bParam2)//Position - 0x268B
{
	int iVar0;
...
void func_102(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)//Position - 0x27A1
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_88();
