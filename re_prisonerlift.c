...
void __EntryFunction__()//Position - 0x0
{
	...
	Local_59 = { 1492.31f, 2136.53f, 89.15f };
	Local_60 = { 1408.2397f, 2522.8027f, 41.0419f };
	Local_98 = { 370.25763f, -1597.4883f, 35.949543f };
	Local_99 = { 824.992f, -1289.2668f, 27.245644f };
	Local_100 = { 450.18887f, -981.6754f, 42.69174f };
	Local_101 = { -1088.3698f, -842.2911f, 30.275543f };
	Local_102 = { 608.9076f, 0.806411f, 100.24968f };
	Local_103 = { -562.01587f, -130.81131f, 37.4369f };
	Local_104 = { 1855.237f, 3683.236f, 33.29165f };
	Local_105 = { -443.50635f, 6016.231f, 30.717875f };
	Local_106 = { 1693.5181f, 2579.2097f, 44.957134f };
	Local_57 = { ScriptParam_279.f_1[0 /*3*/] };
	func_191();
	...
	if (func_134(Local_57, 22, bLocal_61, 0, 0))
	{
		func_131(22);
	}
	else
								...
								switch (iLocal_53)
								{
									...
									case 1:
										if (iLocal_54 == 0)
										{
											if (!PED::IS_PED_INJURED(iLocal_64))
											{
												if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 100f, 100f, 100f, false, true, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_64)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 20f, 20f, 8f, false, true, 0))
												{
													func_107();
													if (!func_130())
													{
												...
												if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 20f, 20f, 8f, false, true, 0))
												{
										...
										else if (iLocal_54 == 1)
										{
											if (!PED::IS_PED_INJURED(iLocal_64))
											{
												if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 105f, 105f, 105f, false, true, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_64)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 20f, 20f, 8f, false, true, 0))
												{
													func_107();
													if (!func_130())
													{
												...
												if (!ENTITY::IS_ENTITY_DEAD(iLocal_64, false))
												{
													if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 20f, 20f, 8f, false, true, 0))
													{
														if (HUD::DOES_BLIP_EXIST(iLocal_89))
												...
												if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
												{
													if (VEHICLE::IS_VEHICLE_DRIVEABLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
													{
														...
														{
															if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::GET_PLAYERS_LAST_VEHICLE(), iLocal_64, 40f, 40f, 20f, false, true, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_64, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 17))
															{
																TASK::CLEAR_PED_TASKS(iLocal_64);
																...
																TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_64, PLAYER::GET_PLAYERS_LAST_VEHICLE(), PLAYER::PLAYER_PED_ID(), 8, 22f, 786469, 1f, 1f, true);
																PED::SET_PED_KEEP_TASK(iLocal_64, true);
																iLocal_53 = 13;
															}
															else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 20f, 20f, 8f, false, true, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_64, PLAYER::PLAYER_PED_ID(), 17))
															{
										...
										if (!PED::IS_PED_INJURED(iLocal_64))
										{
											PED::SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(iLocal_64, false);
										}
										break;
									...
									case 6:
										if (!iLocal_88 && !PED::IS_PED_INJURED(iLocal_64))
										{
											...
											TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_77, 1f, -1, 0.25f, 0, 333.9002f);
										...
										if (func_65())
										{
											if (!PED::IS_PED_INJURED(iLocal_64))
											{
												...
												TASK::TASK_SMART_FLEE_COORD(iLocal_64, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 300f, -1, false, false);
												PED::SET_PED_KEEP_TASK(iLocal_64, true);
												SYSTEM::WAIT(0);
											}
											func_92();
									...
									case 11:
										...
										if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_67, false))
										{
											if (!func_72(iLocal_67))
											{
												if (!iLocal_85)
												{
													if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_64, false))
													{
														if (!PED::IS_PED_INJURED(iLocal_64))
														{
															if (!iLocal_87)
										...
										if (!PED::IS_PED_INJURED(iLocal_64))
										{
											if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 150f, 150f, 150f, false, true, 0))
											{
												TASK::OPEN_SEQUENCE_TASK(&iLocal_66);
												TASK::TASK_SMART_FLEE_COORD(0, 1449.0497f, 2507.2576f, 44.8843f, 1000f, -1, false, false);
												TASK::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 300f, -1, false, false);
									...
									case 12:
										...
										if (!PED::IS_PED_INJURED(iLocal_64))
										{
											if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_64, PLAYER::PLAYER_PED_ID(), true))
											{
												if (HUD::DOES_BLIP_EXIST(iLocal_89))
												{
											...
											if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_67, false))
											{
												if (!func_72(iLocal_67))
												{
													if (PED::IS_PED_IN_VEHICLE(iLocal_64, iLocal_67, false))
													{
														if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_67))
														{
															ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_67, true, false);
														}
														TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_64, iLocal_67, PLAYER::PLAYER_PED_ID(), 8, 22f, 786469, 1f, 1f, true);
														PED::SET_PED_KEEP_TASK(iLocal_64, true);
														iLocal_53 = 13;
													}
													else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_67, false))
													{
														if (bLocal_94)
														{
															TASK::TASK_COMBAT_PED(iLocal_64, PLAYER::PLAYER_PED_ID(), 0, 16);
									...
									case 13:
										...
										if (!PED::IS_PED_INJURED(iLocal_64))
										{
											...
											if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_64, false))
											{
												if (HUD::DOES_BLIP_EXIST(iLocal_89))
												{
													HUD::SET_BLIP_AS_FRIENDLY(iLocal_89, false);
												}
												if (VEHICLE::IS_VEHICLE_MODEL(PED::GET_VEHICLE_PED_IS_IN(iLocal_64, false), joaat("towtruck")) || VEHICLE::IS_VEHICLE_MODEL(PED::GET_VEHICLE_PED_IS_IN(iLocal_64, false), joaat("towtruck2")))
												{
													iLocal_71 = VEHICLE::GET_ENTITY_ATTACHED_TO_TOW_TRUCK(PED::GET_VEHICLE_PED_IS_IN(iLocal_64, false));
													if (ENTITY::DOES_ENTITY_EXIST(iLocal_71))
													{
														iLocal_70 = ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(iLocal_71);
														if (!ENTITY::IS_ENTITY_DEAD(PED::GET_VEHICLE_PED_IS_IN(iLocal_64, false), false) && !ENTITY::IS_ENTITY_DEAD(iLocal_70, false))
														{
															if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(PED::GET_VEHICLE_PED_IS_IN(iLocal_64, false), iLocal_70))
															{
																VEHICLE::DETACH_VEHICLE_FROM_TOW_TRUCK(PED::GET_VEHICLE_PED_IS_IN(iLocal_64, false), iLocal_70);
															}
														}
													}
												}
												if (PED::IS_PED_ON_SPECIFIC_VEHICLE(PLAYER::PLAYER_PED_ID(), PED::GET_VEHICLE_PED_IS_IN(iLocal_64, false)))
												{
													TASK::OPEN_SEQUENCE_TASK(&iLocal_66);
												...
												if (!iLocal_97)
												{
													if ((func_1(PED::GET_VEHICLE_PED_IS_IN(iLocal_64, false)) || !VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(iLocal_64, false), false)) || func_72(PED::GET_VEHICLE_PED_IS_IN(iLocal_64, false)))
													{
														if (HUD::DOES_BLIP_EXIST(iLocal_89))
														{
															HUD::SET_BLIP_AS_FRIENDLY(iLocal_89, false);
												...
												if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 245f, 245f, 245f, false, true, 0))
												{
													func_92();
												}
											}
											...
											else if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 200f, 200f, 200f, false, true, 0))
											{
												func_16();
											}
										}
...
int func_6(struct<3> Param0, bool bParam1)//Position - 0x1212
{
	int iVar0;
...
void func_10()//Position - 0x139C
{
	if (!PED::IS_PED_INJURED(iLocal_64))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 8f, 8f, 8f, false, true, 0))
		{
			if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (PED::IS_PED_IN_VEHICLE(iLocal_64, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false))
					{
						if (HUD::DOES_BLIP_EXIST(iLocal_89))
						{
							HUD::REMOVE_BLIP(&iLocal_89);
...
void func_13()//Position - 0x1579
{
	switch (iLocal_90)
	{
		...
		case 4:
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_67, false))
			{
				if (!PED::IS_PED_INJURED(iLocal_64) && !PED::IS_PED_IN_VEHICLE(iLocal_64, iLocal_67, false))
				{
					TASK::TASK_SMART_FLEE_COORD(iLocal_64, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 300f, -1, false, false);
					PED::SET_PED_KEEP_TASK(iLocal_64, true);
					func_52();
...
int func_14()//Position - 0x1736
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		iLocal_67 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_67, false))
		{
			if (!PED::IS_PED_INJURED(iLocal_64))
			{
...
{
	if ((!iLocal_88 && !PED::IS_PED_INJURED(iLocal_64)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_67, false))
	{
		PED::REMOVE_PED_FROM_GROUP(iLocal_64);
		TASK::OPEN_SEQUENCE_TASK(&iLocal_66);
		TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 5000, 2048, 2);
...
int func_19(bool bParam0)//Position - 0x1923
{
...
void func_20(int iParam0, bool bParam1)//Position - 0x194B
{
	if (iParam0 == -1)
	{
		iParam0 = func_44();
...
void func_21(int iParam0)//Position - 0x1A4E
{
	Global_113372 = iParam0;
}

void func_22(int iParam0, var uParam1, var uParam2)//Position - 0x1A5C
{
	bool bVar0;
...
int func_24()//Position - 0x2000
{
	return Global_31959;
}

int func_25(int iParam0, int iParam1)//Position - 0x200B
{
	int iVar0;
...
void func_26(int iParam0, bool bParam1, int iParam2)//Position - 0x205C
{
	if (iParam2 == -1)
	{
		iParam2 = func_27();
...
int func_27()//Position - 0x207A
{
	return Global_1574918;
}

int func_28(int iParam0, int iParam1)//Position - 0x2086
{
	switch (iParam0)
	{
		case 0:
...
int func_29(int iParam0)//Position - 0x23FA
{
	switch (iParam0)
	{
		case 29:
...
void func_30(int iParam0)//Position - 0x2429
{
	int iVar0;
	int iVar1;
...
void func_31(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x246B
{
	func_32(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_32(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x248C
{
	int iVar0;
...
bool func_36(int iParam0)//Position - 0x28B9
{
	return Global_43052 == iParam0;
}

bool func_37(int iParam0)//Position - 0x28C7
{
	return iParam0 < 3;
}

int func_38(int iParam0)//Position - 0x28D3
{
	int iVar0;
	int iVar1;
...
int func_39(int iParam0)//Position - 0x2910
{
	if (func_37(iParam0))
	{
...
var func_40(int iParam0)//Position - 0x2935
{
	return Global_1998[iParam0 /*29*/];
}

int func_41(int iParam0)//Position - 0x2944
{
	int iVar0;
	int iVar1;
...
void func_42(int iParam0, int iParam1)//Position - 0x2984
{
	MISC::SET_BIT(&(Global_113386.f_24995.f_8[iParam0]), iParam1);
}

int func_43(int iParam0)//Position - 0x299F
{
	int iVar0;
...
int func_45(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x2A6D
{
...
void func_46(int iParam0, int iParam1, int iParam2)//Position - 0x2C47
{
	int iVar0;
	int iVar1;
...
void func_47(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x2D37
{
	int iVar0;
	...
	iVar0 = Global_2826809[iParam0 /*3*/][func_48(iParam2)];
	if (iVar0 != 0)
	{
...
int func_48(var uParam0)//Position - 0x2D67
{
	int iVar0;
	int iVar1;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x2D9B
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 13122)
	{
		...
		iVar0 = Global_2826809[iParam0 /*3*/][func_48(iParam1)];
...
int func_50()//Position - 0x2DD8
{
	func_35();
	return Global_113386.f_2363.f_539.f_4321;
}

int func_51()//Position - 0x2DF1
{
	return 1;
}

void func_52()//Position - 0x2DFA
{
	Global_20471 = 0;
	func_53();
}

void func_53()//Position - 0x2E0A
{
...
void func_55()//Position - 0x2E80
{
	...
	if (func_60(PLAYER::PLAYER_PED_ID(), Local_57, 1) > 200f)
	{
		if (!bLocal_84)
		{
			...
			{
				iLocal_73 = VEHICLE::CREATE_VEHICLE(joaat("sheriff"), Var0[0 /*3*/], func_58(Var0[0 /*3*/], func_59(PLAYER::PLAYER_ID())), true, true, false);
				iLocal_72[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_73, 6, joaat("S_M_Y_Ranger_01"), -1, true, true);
				iLocal_72[1] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_73, 6, joaat("S_M_Y_Ranger_01"), 0, true, true);
			...
			{
				iLocal_73 = VEHICLE::CREATE_VEHICLE(joaat("sheriff"), Var0[1 /*3*/], func_58(Var0[1 /*3*/], func_59(PLAYER::PLAYER_ID())), true, true, false);
				iLocal_72[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_73, 6, joaat("S_M_Y_Ranger_01"), -1, true, true);
				iLocal_72[1] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_73, 6, joaat("S_M_Y_Ranger_01"), 0, true, true);
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_72[0], joaat("WEAPON_PISTOL"), -1, false, true);
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_72[1], joaat("WEAPON_PISTOL"), -1, false, true);
			...
			{
				iLocal_73 = VEHICLE::CREATE_VEHICLE(joaat("sheriff"), Var0[2 /*3*/], func_58(Var0[2 /*3*/], func_59(PLAYER::PLAYER_ID())), true, true, false);
				iLocal_72[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_73, 6, joaat("S_M_Y_Ranger_01"), -1, true, true);
				iLocal_72[1] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_73, 6, joaat("S_M_Y_Ranger_01"), 0, true, true);
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_72[0], joaat("WEAPON_PISTOL"), -1, false, true);
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_72[1], joaat("WEAPON_PISTOL"), -1, false, true);
			...
			{
				iLocal_73 = VEHICLE::CREATE_VEHICLE(joaat("sheriff"), Var0[3 /*3*/], func_58(Var0[3 /*3*/], func_59(PLAYER::PLAYER_ID())), true, true, false);
				iLocal_72[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_73, 6, joaat("S_M_Y_Ranger_01"), -1, true, true);
				iLocal_72[1] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_73, 6, joaat("S_M_Y_Ranger_01"), 0, true, true);
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_72[0], joaat("WEAPON_PISTOL"), -1, false, true);
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_72[1], joaat("WEAPON_PISTOL"), -1, false, true);
	...
	if (!PED::IS_PED_INJURED(iLocal_64))
	{
		if (((!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_64, 990.7705f, -105.594f, 73.3055f, 954.8849f, -145.3864f, 79.1073f, 8.8125f, false, true, 0)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 990.7705f, -105.594f, 73.3055f, 954.8849f, -145.3864f, 79.1073f, 8.8125f, false, true, 0)) || (ENTITY::IS_ENTITY_AT_COORD(iLocal_64, Local_74, Global_19, true, true, 0) && func_56(1, 0, 1)))
		{
			SYSTEM::SETTIMERA(0);
			if (func_14())
			{
...
int func_56(bool bParam0, bool bParam1, bool bParam2)//Position - 0x341F
{
	int iVar0;
...
float func_58(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3)//Position - 0x36F2
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param2.f_0 - Param0.f_0), (Param2.f_1 - Param0.f_1));
}

Vector3 func_59(int iParam0)//Position - 0x370C
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

float func_60(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x371F
{
	struct<3> Var0;
...
int func_63()//Position - 0x383D
{
	if (!PED::IS_PED_INJURED(iLocal_64))
	{
		if (PED::IS_PED_IN_GROUP(iLocal_64))
		{
			if ((((((((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_98, 50f, 50f, 50f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_99, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_100, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_101, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_102, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_103, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_104, 50f, 50f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_105, 50f, 50f, 50f, false, true, 0)) || func_60(PLAYER::PLAYER_PED_ID(), Local_106, 1) < 205f)
			{
				return 1;
			}
		}
...
void func_64()//Position - 0x3993
{
	if (!PED::IS_PED_INJURED(iLocal_64) && func_94())
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false))
		{
			if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) && PED::IS_PED_SITTING_IN_VEHICLE(iLocal_64, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
			{
				SYSTEM::SETTIMERA(0);
				if (!PED::IS_PED_IN_GROUP(iLocal_64))
				{
					...
					PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_64, true);
				}
				if (iLocal_54 == 0)
				{
					if (!func_89())
...
int func_65()//Position - 0x3ABE
{
	...
	if (!PED::IS_PED_INJURED(iLocal_64))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_64, PLAYER::GET_PLAYERS_LAST_VEHICLE(), true))
			{
				func_52();
				return 1;
			}
		...
		if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 250f, 250f, 250f, false, true, 0))
		{
			return 1;
		}
		if (iLocal_54 == 0)
		...
		if (iLocal_53 < 2)
		{
			...
			if (iLocal_54 == 0)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_69))
				{
					...
					{
						TASK::TASK_SMART_FLEE_PED(iLocal_64, PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
						PED::SET_PED_KEEP_TASK(iLocal_64, true);
						return 1;
					}
				}
			...
			if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_64, true), 20f, true))
			{
				return 1;
			}
			if ((MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_64, true) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_64, true) + Vector(15f, 15f, 15f), joaat("WEAPON_SMOKEGRENADE"), true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_64, true) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_64, true) + Vector(15f, 15f, 15f), joaat("WEAPON_GRENADE"), true)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_64, true) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_64, true) + Vector(15f, 15f, 15f), joaat("WEAPON_GRENADELAUNCHER"), true))
			{
				return 1;
			}
			...
			if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 20f, 20f, 8f, false, true, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_64, PLAYER::PLAYER_PED_ID())) && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
...
var func_66(int iParam0)//Position - 0x3E7C
{
	return Global_55405.f_25[iParam0];
}

int func_67()//Position - 0x3E8D
{
	return Global_55405.f_24;
}

bool func_68()//Position - 0x3E9A
{
	return Global_55405.f_24 > 0;
}

void func_69()//Position - 0x3EA9
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false))
	{
		if (!PED::IS_PED_INJURED(iLocal_64))
...
float func_70(int iParam0, int iParam1)//Position - 0x3F76
{
	return func_5(iParam0, iParam1, 1);
}

int func_71()//Position - 0x3F87
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		iLocal_67 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
...
int func_72(int iParam0)//Position - 0x3FB5
{
...
bool func_73(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x4029
{
...
int func_74(char* sParam0, int iParam1, bool bParam2)//Position - 0x4077
{
	Global_21606 = 0;
...
bool func_77(int iParam0)//Position - 0x43DF
{
	return func_78(iParam0, 20);
}

var func_78(int iParam0, int iParam1)//Position - 0x43EF
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

int func_79()//Position - 0x4407
{
	return -1;
}

void func_80()//Position - 0x4410
{
	int iVar0;
...
bool func_86(int iParam0, int iParam1)//Position - 0x468F
{
	switch (iParam0)
	{
		case 5:
...
void func_88(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x471E
{
...
void func_90()//Position - 0x4796
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_69, false))
	{
		if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_69, false) && !VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_69, -1, false))
		{
			AUDIO::SET_HORN_PERMANENTLY_ON_TIME(iLocal_69, 60000f);
			AUDIO::SET_HORN_PERMANENTLY_ON(iLocal_69);
		}
	}
}

void func_91()//Position - 0x47D7
{
	switch (iLocal_92)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_64))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 20f, 20f, 8f, false, true, 0))
				{
					if (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 2.5f || !(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 15f, 15f, 8f, false, true, 0)))
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_66);
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
			{
				if (func_94())
				{
					...
					if (ENTITY::GET_ENTITY_SPEED(iLocal_67) < 9f)
					{
						if (!PED::IS_PED_INJURED(iLocal_64))
						{
							if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_64, iLocal_67, 20f, 20f, 5f, false, true, 0))
							{
								iLocal_92++;
							}
						}
				...
				else if (!bLocal_94)
				{
					...
					TASK::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, (fLocal_93 - 3f), 1f, 2f, 0);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_66);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_64, iLocal_66);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_66);
					if (!func_89())
		...
		case 5:
			if (func_94())
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false))
				{
					if (!PED::IS_PED_INJURED(iLocal_64))
					{
						if (PED::IS_PED_SITTING_IN_VEHICLE(iLocal_64, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
						{
							if (HUD::DOES_BLIP_EXIST(iLocal_89))
							{
								HUD::REMOVE_BLIP(&iLocal_89);
...
void func_92()//Position - 0x4BE6
{
	func_176();
}

void func_93(var uParam0)//Position - 0x4BF2
{
	switch (*uParam0)
	{
		case 0:
...
void func_95()//Position - 0x4D31
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		iLocal_67 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
		if ((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_67, false) && !PED::IS_PED_INJURED(iLocal_64)) && !bLocal_83)
		{
			fLocal_93 = func_5(iLocal_64, PLAYER::PLAYER_PED_ID(), 1);
			if (fLocal_93 > 5f)
			{
			...
			if (iLocal_54 == 0)
			{
				...
				TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 1f, false, fLocal_93, 1f, true, false, joaat("FIRING_PATTERN_FULL_AUTO"));
			}
			else if (iLocal_54 == 1)
			{
...
void func_96(bool bParam0)//Position - 0x4E82
{
	if (bParam0)
	{
...
int func_97(int iParam0)//Position - 0x4EAE
{
	if (func_101())
	{
		Global_113376 = 1;
		Global_113373 = MISC::GET_GAME_TIMER();
		if (func_29(Global_113375))
		{
			func_98(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /* GXT: Random Event */);
		if (iParam0 && func_29(Global_113375))
		{
...
void func_98(int iParam0)//Position - 0x4F01
{
	switch (iParam0)
	{
		case 0:
...
void func_99(char* sParam0, int iParam1)//Position - 0x4FDC
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

char* func_100(int iParam0)//Position - 0x4FF3
{
	char* sVar0;
...
int func_102(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x506C
{
	int iVar0;
...
void func_103(var uParam0, int iParam1)//Position - 0x51A3
{
	int iVar0;
...
bool func_104(int iParam0)//Position - 0x51F2
{
	return func_105(iParam0, Global_43052);
}

int func_105(int iParam0, int iParam1)//Position - 0x5203
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_106(int iParam0)//Position - 0x53E4
{
	if (Global_43052 == 15)
	{
		return 0;
...
void func_108()//Position - 0x5439
{
	...
	iLocal_64 = PED::CREATE_PED(26, iLocal_76, Local_68, fLocal_75, true, true);
	...
	TASK::TASK_PLAY_ANIM(iLocal_64, "random@prisoner_lift", "loop2_idlelook2", 2f, -2f, -1, 1, 0f, false, false, false);
	...
	if (iLocal_54 == 0)
	{
		...
		MISC::CLEAR_AREA_OF_PEDS(Local_68, 50f, 0);
		MISC::CLEAR_AREA(Local_68, 10f, false, false, false, false);
		...
		iLocal_69 = VEHICLE::CREATE_VEHICLE(joaat("sheriff"), 1524.3323f, 2173.3474f, 79.0619f, 201.6806f, true, true, false);
		VEHICLE::SET_VEHICLE_ENGINE_HEALTH(iLocal_69, 0f);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_69, 4, false, false);
		VEHICLE::SET_VEHICLE_TYRE_BURST(iLocal_69, 0, false, 1000f);
		VEHICLE::SET_VEHICLE_INFLUENCES_WANTED_LEVEL(iLocal_69, false);
		...
		iVar0 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_69, 26, joaat("S_M_Y_Ranger_01"), -1, true, true);
...
void func_109(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x57D8
{
...
void func_110(int iParam0, bool bParam1)//Position - 0x5873
{
	if (bParam1)
	{
...
void func_111(int iParam0, int iParam1, bool bParam2)//Position - 0x58AA
{
	int iVar0;
...
int func_112(int iParam0)//Position - 0x591C
{
	switch (iParam0)
	{
		case 0:
...
void func_113(int iParam0, int iParam1, bool bParam2)//Position - 0x5C97
{
	int iVar0;
...
int func_114(int iParam0, int iParam1, bool bParam2)//Position - 0x5D09
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_116()//Position - 0x5E3D
{
	if (iLocal_58 == 1)
	{
		iLocal_76 = joaat("G_M_Y_Lost_02");
		Local_68 = { 1538.0898f, 2172.3438f, 77.826f };
		fLocal_75 = 142.0201f;
		Local_77 = { 984.3975f, -106.9935f, 73.3531f };
		Local_74 = { 960.1481f, -139.4141f, 73.476f };
	}
	if (iLocal_58 == 2)
	{
		iLocal_76 = joaat("S_M_Y_Prisoner_01");
		Local_68 = { 1401.6923f, 2528.085f, 40.3762f };
		fLocal_75 = 301.2458f;
		Local_77 = { 938.5384f, -2167.4197f, 29.5153f };
		Local_74 = { 928.9882f, -2173.248f, 29.2873f };
	}
	iLocal_56 = 1;
}

int func_117()//Position - 0x5EE2
{
...
int func_118(float fParam0, bool bParam1)//Position - 0x5F68
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_119(int iParam0, var uParam1)//Position - 0x6019
{
	switch (iParam0)
	{
		case 0:
...
void func_120(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0x71CE
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_121(int iParam0)//Position - 0x725F
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_122(int iParam0)//Position - 0x75A5
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_123(int iParam0)//Position - 0x75DC
{
	struct<2> Var0;
...
bool func_125()//Position - 0x7A5A
{
	return Global_113104 > 0;
}

int func_126()//Position - 0x7A68
{
	if (Global_97363 != -1)
	{
		return 1;
...
int func_130()//Position - 0x7B1F
{
	if ((Global_113375 == func_44() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_113376)
	{
		return 1;
	}
	return 0;
...
void func_131(int iParam0)//Position - 0x7B4A
{
	if (iParam0 == -1)
	{
		iParam0 = func_44();
...
void func_133(int iParam0)//Position - 0x7BBD
{
	Global_113375 = iParam0;
}

int func_134(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x7BCB
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
...
bool func_135(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x7F65
{
	if (bParam2)
	{
...
bool func_136(int iParam0)//Position - 0x7FAC
{
	int iVar0;
...
int func_137(int iParam0)//Position - 0x7FCD
{
	return func_138(iParam0, 1);
}

int func_138(int iParam0, int iParam1)//Position - 0x7FDC
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_139(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x8032
{
	func_140(func_151(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_140(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x8050
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_141(float fParam0, float fParam1, float fParam2)//Position - 0x8251
{
	float fVar0;
...
int func_142(int iParam0, int iParam1)//Position - 0x8293
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_143(int iParam0)//Position - 0x8335
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_144(int iParam0)//Position - 0x8348
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_145(int iParam0)//Position - 0x835B
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_146(int iParam0)//Position - 0x836E
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_147(int iParam0)//Position - 0x8380
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_148(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_148(bool bParam0, int iParam1, int iParam2)//Position - 0x83A2
{
	if (bParam0)
	{
		return iParam1;
...
int func_149(int iParam0)//Position - 0x83B9
{
	return iParam0 & 15;
}

int func_150(int iParam0, int iParam1)//Position - 0x83C6
{
	int iVar0;
	int iVar1;
...
void func_152(var uParam0, int iParam1)//Position - 0x8518
{
	if (iParam1 <= 0)
	{
		return;
...
void func_153(var uParam0, int iParam1)//Position - 0x859E
{
...
void func_154(var uParam0, int iParam1)//Position - 0x85D1
{
	int iVar0;
	int iVar1;
...
void func_155(var uParam0, int iParam1)//Position - 0x8622
{
...
void func_156(var uParam0, int iParam1)//Position - 0x865C
{
...
int func_158(int iParam0)//Position - 0x86D3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_159(int iParam0, bool bParam1)//Position - 0x87AF
{
...
int func_160(int iParam0)//Position - 0x87CF
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_168()) || Global_112433) || Global_31962) || func_167()) || func_86(8, -1)) || func_166()) || func_165()) || func_164()) || func_163()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_168()) || Global_31962) || func_167()) || func_86(8, -1)) || func_164()) || func_166()) || func_165()) || func_163()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_168()) || Global_112433) || Global_31962) || func_167()) || func_86(8, -1)) || func_164()) || func_166()) || func_165()) || func_163()) || Global_113386.f_7688.f_919[iVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_168()) || Global_112433) || Global_31962) || func_167()) || func_86(8, -1)) || func_166()) || func_165()) || func_163()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_168() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_86(8, -1)) || func_163()) || func_162()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_168()) || Global_31962) || func_167()) || func_86(8, -1)) || func_165()) || func_164()) || func_163()) || Global_113386.f_7688.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_168()) || func_165()) || Global_112433) || Global_31962) || func_167()) || Global_44238) || func_86(8, -1)) || func_164()) || func_162()) || func_163()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_168()) || Global_112433) || Global_31962) || func_167()) || func_86(8, -1)) || func_164()) || func_162()) || func_166()) || func_165()) || func_163())
						{
							return 0;
						}
						break;
...
var func_161()//Position - 0x8EEC
{
	return Global_100480.f_1;
}

int func_162()//Position - 0x8EFA
{
	if (Global_97363 != -1)
	{
...
bool func_165()//Position - 0x8F61
{
	return Global_100493.f_376 > 0;
}

bool func_166()//Position - 0x8F72
{
	return Global_100493.f_375 > 0;
}

var func_167()//Position - 0x8F83
{
	return Global_1575058;
}

int func_168()//Position - 0x8F8F
{
...
bool func_170(int iParam0)//Position - 0x8FD3
{
	return func_150(func_151(), iParam0);
}

int func_171(int iParam0, int iParam1, int iParam2)//Position - 0x8FE5
{
	int iVar0;
	int iVar1;
...
int func_172(int iParam0)//Position - 0x90C9
{
	if (!func_37(iParam0))
	{
		return 7;
...
int func_173(int iParam0)//Position - 0x90ED
{
	int iVar0;
	int iVar1;
...
void func_176()//Position - 0x9241
{
	if (iLocal_107)
	{
		...
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_68 - Vector(10f, 10f, 10f), Local_68 + Vector(10f, 10f, 10f), true, true);
		...
		if (!PED::IS_PED_INJURED(iLocal_64))
		{
			...
			else if (iLocal_54 == 1)
			{
				...
				else if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_67, false))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_66);
...
void func_177(int iParam0)//Position - 0x948E
{
	char cVar0[64];
	...
	if (func_130())
	{
		...
		func_180(30000);
		StringCopy(&cVar0, func_179(Global_113375, 1), 64);
		if (func_43(Global_113375) > 0)
		{
	...
	func_178(&Global_32019);
	Global_113376 = 0;
	func_133(-1);
}

void func_178(var uParam0)//Position - 0x9540
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_179(int iParam0, bool bParam1)//Position - 0x957D
{
	switch (iParam0)
	{
		case 0:
...
void func_180(int iParam0)//Position - 0x97C6
{
	Global_43603 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_181(int iParam0)//Position - 0x97D8
{
	func_182(iParam0, 0, func_187(iParam0));
}

void func_182(int iParam0, int iParam1, int iParam2)//Position - 0x97ED
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_183(var uParam0)//Position - 0x981C
{
	struct<16> Var0;
	int iVar1;
...
void func_184(int iParam0, var uParam1)//Position - 0x98EC
{
	Global_113386.f_24995.f_43[iParam0] = *uParam1;
}

void func_185(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x9904
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_186(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x9A86
{
...
int func_187(int iParam0)//Position - 0x9ABE
{
	int iVar0;
...
void func_188()//Position - 0x9C61
{
	Global_20471 = 0;
	func_189();
}

void func_189()//Position - 0x9C71
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_190(bool bParam0)//Position - 0x9C95
{
	int iVar0;
...
Vector3 func_191()//Position - 0x9CB8
{
	float fVar0;
	
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_59, true);
		iLocal_58 = 1;
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_60, true) < fVar0)
		{
			fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_60, true);
			iLocal_58 = 2;
		}
		if (iLocal_58 == 1)
		{
