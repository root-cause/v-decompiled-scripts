...
void func_19()//Position - 0x97D
{
	...
	{
		if (func_22(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_21(PLAYER::PLAYER_PED_ID());
			if (func_20(iVar0) && (!func_24(14) || Global_113083))
			{
				if (Global_114135.f_2367.f_539.f_4321 != iVar0 && func_20(Global_114135.f_2367.f_539.f_4321))
				{
	...
	switch (iLocal_141)
	{
		...
		case 1:
			...
			if (CUTSCENE::HAS_CUTSCENE_FINISHED())
			{
				...
				{
					iLocal_157 = OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_164, Local_158, true, true, false, 0);
					ENTITY::SET_ENTITY_ROTATION(iLocal_157, Local_161, 2, false);
				}
				func_48(18, 0);
				func_221(23, 0);
				Global_33338 = uLocal_336;
				iLocal_141 = 2;
			}
			break;
...
int func_51(var uParam0, int iParam1)//Position - 0x138E
{
	int iVar0;
	var uVar1[78];
...
void func_56(var uParam0, float fParam1)//Position - 0x150F
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
int func_61(int iParam0)//Position - 0x1585
{
	switch (iParam0)
	{
		case 60:
...
void func_62(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x15D5
{
	int iVar0;
...
Vector3 func_64(int iParam0)//Position - 0x17CF
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_65(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x17E2
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_79322[1 /*14*/] = { func_118(iVar10, iParam1, iParam2, -1) };
		if (!func_117(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_79322[1 /*14*/] = { func_118(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_79322[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_79322[1 /*14*/] = { func_118(iVar10, 14, uVar28[iVar1], -1) };
							func_85(iParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
							func_108(14);
							if (Global_79320 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iVar0), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_75(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iVar0), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
						}
						func_108(iVar0);
						if (Global_79320 == 1)
						{
			...
			{
				Global_79322[1 /*14*/] = { func_118(iVar10, iVar0, func_74(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_79322[1 /*14*/] = { func_118(iVar10, 14, uVar69[iVar1], -1) };
			func_85(iParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
			func_108(14);
			if (Global_79320 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_75(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
		}
		if (Global_79320 == 1)
		{
			iVar2 = 0;
...
int func_66(int iParam0, int iParam1, int iParam2)//Position - 0x1FF3
{
	int iVar0;
	...
	{
		if (!func_182(iParam0, Global_114135.f_2367.f_539[iVar0 /*65*/].f_64, Global_114135.f_2367.f_539[iVar0 /*65*/].f_63))
		{
...
int func_69(int iParam0, int iParam1, int iParam2)//Position - 0x2159
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x225F
{
	var uVar0;
	int iVar10;
...
int func_72(int iParam0, int iParam1, int iParam2)//Position - 0x2863
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x28FC
{
	int iVar0;
	...
	{
		if (!func_182(iParam0, Global_114135.f_2367.f_539[iVar0 /*65*/].f_61, Global_114135.f_2367.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_74(int iParam0, int iParam1, int iParam2)//Position - 0x29A7
{
	int iVar0;
	int iVar1;
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2AF8
{
	int iVar0;
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2DFF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x39B2
{
	int iVar0;
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3F94
{
	int iVar0;
...
int func_82(int iParam0, int iParam1, int iParam2)//Position - 0x3FBD
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4289
{
	int iVar0;
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x466A
{
	int iVar0;
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4704
{
	switch (iParam0)
	{
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4CF4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_91(int iParam0, int iParam1)//Position - 0x4DF0
{
	int iVar0;
...
void func_96(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x59FD
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_97(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x5B27
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7CC2
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_103(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7F3F
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8364
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_105(int iParam0, int iParam1)//Position - 0x8657
{
	int iVar0;
	int iVar1;
...
int func_106(int iParam0, int iParam1)//Position - 0x869E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x86FE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_111(int iParam0, var uParam1)//Position - 0x8877
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_112(uParam1));
}

int func_112(var uParam0)//Position - 0x888C
{
	int iVar0;
	int iVar1;
...
int func_116(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xB51E
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_120(int iParam0)//Position - 0xC54D
{
	...
	func_121(&(Global_79322[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_121(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD780
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_114(func_124(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_114(func_123(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_114(iVar1, Global_79319);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_125(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE71C
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE82E
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_121(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_121(&(Global_79322[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_121(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79520)
		{
			...
			func_121(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_182(int iParam0, int iParam1, int iParam2)//Position - 0x1FAAC
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_79322[1 /*14*/] = { func_118(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_79322[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_182(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_182(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_79322[2 /*14*/] = { func_118(iVar0, 14, iVar4, -1) };
									if (Global_79322[2 /*14*/].f_12 == iVar3)
									{
										if (func_182(iParam0, 14, iVar4))
										{
											if (!func_71(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_79322[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_79322[2 /*14*/] = { func_118(iVar0, iVar2, iVar1, -1) };
						if (!func_71(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_79322[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_79322[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_75(iParam1)) && Global_79322[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_75(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_184(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x1FD44
{
	if (bParam0)
	{
...
int func_188(var uParam0)//Position - 0x1FF47
{
	int iVar0;
...
int func_189(int iParam0)//Position - 0x1FF69
{
...
int func_191(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x1FFB6
{
	int iVar0;
...
void func_193(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x2000C
{
	func_194(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_194(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x20035
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_195(struct<3> Param0)//Position - 0x2042B
{
...
int func_196(int iParam0, int iParam1, bool bParam2)//Position - 0x20455
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_197(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x204C3
{
...
int func_198(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2059B
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_199(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x20891
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_200(struct<3> Param0)//Position - 0x20945
{
	float fVar0;
	float fVar1;
...
void func_201(int iParam0)//Position - 0x20984
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_204(char* sParam0, int iParam1)//Position - 0x20A1A
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_210(int iParam0, float fParam1, int iParam2)//Position - 0x22472
{
	int iVar0;
...
int func_215(int iParam0, int iParam1)//Position - 0x225EC
{
	if (func_216(iParam0))
	{
...
int func_216(int iParam0)//Position - 0x2261F
{
	if (func_29(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_217(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2263F
{
...
void func_218(int iParam0)//Position - 0x22696
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_225(int iParam0, int iParam1, bool bParam2)//Position - 0x229BE
{
...
int func_226(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x22A09
{
	struct<3> Var0;
...
int func_227(int iParam0, float fParam1)//Position - 0x22AC4
{
	float fVar0;
...
bool func_228(int iParam0, float fParam1)//Position - 0x22B3A
{
	return func_229(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_229(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x22B52
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_230(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x22C13
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_231(int iParam0, int iParam1)//Position - 0x22D3F
{
	int iVar0;
...
int func_233(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x22E4E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_234(struct<3> Param0, struct<3> Param3)//Position - 0x22EDF
{
...
int func_236(int iParam0, int iParam1)//Position - 0x22F1B
{
	int iVar0;
...
int func_237(int iParam0)//Position - 0x22F5A
{
...
bool func_238(int iParam0, int iParam1, float fParam2)//Position - 0x22F82
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_239(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x22FC9
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_240(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x230C4
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_241(int iParam0, float fParam1)//Position - 0x231D0
{
	var uVar0;
	struct<3> Var1;
...
int func_242(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x23265
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_243(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x232F3
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_251(int iParam0)//Position - 0x2359D
{
	if (iParam0 == 1)
	{
		if (Global_21066.f_1 > 3)
...
void func_255(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x23700
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_79794 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_258(Global_79795, Global_79797, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_257(char* sParam0)//Position - 0x23A1D
{
...
int func_267(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x23DFE
{
	if (((!func_269(0) || Global_79810) || Global_79798 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_79794)
...
int func_269(int iParam0)//Position - 0x23F3F
{
	if (Global_44181 == 15)
	{
		return 0;
...
bool func_270(int iParam0)//Position - 0x23F61
{
	return func_271(iParam0, Global_44181);
}

int func_271(int iParam0, int iParam1)//Position - 0x23F72
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_274(var uParam0)//Position - 0x242F7
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
...
void func_275(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x244C5
{
	func_38(iParam0);
...
int func_276(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x24508
{
...
int func_277(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x24564
{
	int iVar0;
...
int func_278(var uParam0, int iParam1)//Position - 0x245F2
{
	int iVar0;
...
int func_279(var uParam0)//Position - 0x24638
{
	if (func_280(uParam0))
	{
...
int func_280(var uParam0)//Position - 0x24662
{
...
int func_281(int iParam0)//Position - 0x24687
{
	int iVar0;
...
int func_286(bool bParam0)//Position - 0x2482E
{
...
void func_288(int iParam0, bool bParam1)//Position - 0x24865
{
	...
	{
		func_329(&(Global_113222[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
...
void func_294(int iParam0, bool bParam1, int iParam2)//Position - 0x24FE4
{
	if (iParam2 == -1)
	{
		iParam2 = func_113();
...
int func_315(int iParam0, int iParam1, int iParam2)//Position - 0x25AA4
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	else
	{
		...
		Global_79322[1 /*14*/] = { func_118(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_75(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_75(iParam1), Global_79322[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, 0);
		}
	}
...
void func_316(char* sParam0, var uParam1)//Position - 0x25C61
{
...
void func_320(int iParam0, bool bParam1, bool bParam2)//Position - 0x25DDF
{
	...
	if (iParam0 != -1)
	{
		...
		func_321(&sVar32, Var0.f_3, Global_101725, bParam1, bParam2);
	}
}

void func_321(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x25E1E
{
...
void func_323()//Position - 0x25E74
{
	...
	{
		func_19();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_324(Global_114135.f_2367.f_539.f_4321));
	}
	else
	{
...
char* func_324(var uParam0)//Position - 0x25EA6
{
	uParam0 = uParam0;
	return "";
}
...
void func_325()//Position - 0x25EB5
{
	...
	else if ((MISC::IS_PS3_VERSION() || func_326()) || MISC::IS_PC_VERSION())
	{
...
void func_329(var uParam0)//Position - 0x25F42
{
	if (*uParam0 == -1)
	{
		return;
...
void func_334(var uParam0, bool bParam1)//Position - 0x264D5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_339(int iParam0, int iParam1)//Position - 0x268F9
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_340(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x26919
{
	if (iParam0 != 198)
	{
		if (Global_79539)
...
void func_351(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2AD71
{
	int iVar0;
...
int func_353(int iParam0)//Position - 0x2B05B
{
	int iVar0;
	int iVar1;
...
int func_356(int iParam0)//Position - 0x2B292
{
...
int func_358(char* sParam0)//Position - 0x2B2F9
{
	int iVar0;
...
int func_361(char* sParam0, int iParam1, int iParam2)//Position - 0x2B451
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_363()//Position - 0x2B636
{
	...
	iVar0 = func_364(&(Global_101688.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_365(int iParam0, bool bParam1)//Position - 0x2B684
{
	int iVar0;
...
int func_381(int iParam0)//Position - 0x2BA4F
{
	if (!func_20(iParam0))
	{
		return func_23(iParam0);
