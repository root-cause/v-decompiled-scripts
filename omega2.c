...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x17E2
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_79172[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_79172[1 /*14*/] = { func_118(iVar10, 14, uVar28[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iVar0), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_75(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iVar0), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
						}
						func_108(iVar0);
						if (Global_79170 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_79172[1 /*14*/] = { func_118(iVar10, 14, uVar69[iVar1], -1) };
			func_85(iParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
			func_108(14);
			if (Global_79170 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_75(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
		}
		if (Global_79170 == 1)
		{
			iVar2 = 0;
...
int func_66(int iParam0, int iParam1, int iParam2)//Position - 0x1FF3
{
	...
	{
		if (!func_182(iParam0, Global_113969.f_2366.f_539[iVar0 /*65*/].f_64, Global_113969.f_2366.f_539[iVar0 /*65*/].f_63))
		{
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x28FC
{
	...
	{
		if (!func_182(iParam0, Global_113969.f_2366.f_539[iVar0 /*65*/].f_61, Global_113969.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_116(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xB47C
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_117(int iParam0)//Position - 0xC323
{
	if (!BitTest(Global_79172[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_118(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC36B
{
	func_181();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_119(int iParam0, int iParam1)//Position - 0xC3BD
{
	switch (iParam0)
	{
		case 0:
...
void func_120(int iParam0)//Position - 0xC4AD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_121(&(Global_79172[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_121(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD6E0
{
	var uVar0;
	int iVar1;
...
bool func_122(int iParam0, int iParam1, var uParam2)//Position - 0xDA81
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_123(int iParam0, int iParam1)//Position - 0xDE86
{
	switch (iParam1)
	{
		case 0:
...
int func_124(int iParam0, int iParam1)//Position - 0xE281
{
	switch (iParam1)
	{
		case 0:
...
int func_125(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE67C
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_126(int iParam0)//Position - 0xE6BA
{
	switch (iParam0)
	{
		case -1:
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE78E
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_121(&(Global_79172[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_121(&(Global_79172[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_128(int iParam0)//Position - 0xEA14
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0xEB61
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0xF06E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0xF0E2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0xF155
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0xF23C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0xF57E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0xF786
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0xF9A6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0xFAAF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x10442
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x10F9A
{
	if (iParam0 < 136)
	{
		func_141(iParam0);
...
void func_140(int iParam0)//Position - 0x10FCF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x11BD3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x12AD3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x12C00
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0, int iParam1)//Position - 0x12CF7
{
	switch (iParam0)
	{
		case 0:
...
void func_145(int iParam0)//Position - 0x12DE7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x142B6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x143FD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x14907
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x14F70
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x14FE3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x150B3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x155AE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1573F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x15F2E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x16037
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x16F5A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x17C07
{
	if (iParam0 < 107)
	{
		func_160(iParam0);
...
void func_158(int iParam0)//Position - 0x17C4D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x186F2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x194E0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1A11F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x1A397
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0, int iParam1)//Position - 0x1A4D3
{
	switch (iParam0)
	{
		case 0:
...
void func_164(int iParam0)//Position - 0x1A5C3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1B321
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1B490
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x1BA01
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x1BF29
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x1BF9C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x1C06D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x1C51D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x1C778
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x1CA38
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x1CBF3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x1D739
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x1E36B
{
	if (iParam0 < 60)
	{
		func_178(iParam0);
...
void func_177(int iParam0)//Position - 0x1E3A0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x1F133
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x1F7B5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x1F89B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181()//Position - 0x1F992
{
...
int func_182(int iParam0, int iParam1, int iParam2)//Position - 0x1FA0A
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else if (Global_79172[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_75(iParam1)) && Global_79172[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_75(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_183(bool bParam0)//Position - 0x1FC63
{
	int iVar0;
...
void func_184(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x1FCA2
{
	if (bParam0)
	{
...
bool func_185()//Position - 0x1FDEF
{
	return BitTest(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

bool func_186(int iParam0, int iParam1)//Position - 0x1FE09
{
	bool bVar0;
...
int func_187(int iParam0, bool bParam1)//Position - 0x1FE62
{
	int iVar0;
	int iVar1;
...
int func_188(var uParam0)//Position - 0x1FEA3
{
	int iVar0;
...
int func_189(int iParam0)//Position - 0x1FEC5
{
...
bool func_190()//Position - 0x1FF04
{
	return BitTest(Global_2621446, 3);
}

int func_191(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x1FF12
{
	int iVar0;
...
void func_192(int iParam0)//Position - 0x1FF45
{
	if (iParam0 == 1)
	{
...
void func_193(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x1FF68
{
	func_194(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_194(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x1FF91
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_195(struct<3> Param0)//Position - 0x2038B
{
...
int func_196(int iParam0, int iParam1, bool bParam2)//Position - 0x203B5
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_197(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x20423
{
...
int func_198(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x204FB
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_199(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x207F1
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_200(struct<3> Param0)//Position - 0x208A5
{
	float fVar0;
	float fVar1;
...
void func_201(int iParam0)//Position - 0x208E4
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_202()//Position - 0x20949
{
	int iVar0;
...
int func_203()//Position - 0x20969
{
	return func_204(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_204(char* sParam0, int iParam1)//Position - 0x2097A
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_205(int iParam0, var uParam1)//Position - 0x209C3
{
	switch (iParam0)
	{
		case 0:
...
int func_207(int iParam0)//Position - 0x21C09
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_208(int iParam0)//Position - 0x21F4F
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_209(int iParam0)//Position - 0x21F86
{
	struct<2> Var0;
...
int func_210(int iParam0, float fParam1, int iParam2)//Position - 0x223D2
{
	int iVar0;
...
bool func_211()//Position - 0x224A6
{
	bool bVar0;
...
void func_212()//Position - 0x224C9
{
	Global_21152 = 0;
	func_27();
}

int func_213()//Position - 0x224D9
{
...
void func_214()//Position - 0x224FB
{
...
int func_215(int iParam0, int iParam1)//Position - 0x2254C
{
	if (func_216(iParam0))
	{
...
int func_216(int iParam0)//Position - 0x2257F
{
	if (func_29(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_217(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2259F
{
...
void func_218(int iParam0)//Position - 0x225F6
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_219(bool bParam0, bool bParam1)//Position - 0x22622
{
...
void func_220(char* sParam0, bool bParam1)//Position - 0x22773
{
	func_183(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_221(int iParam0, bool bParam1)//Position - 0x22789
{
	if (bParam1)
	{
...
void func_222()//Position - 0x227AB
{
	func_245();
	func_244();
	if (func_224())
...
int func_225(int iParam0, int iParam1, bool bParam2)//Position - 0x2291E
{
...
int func_226(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x22969
{
	struct<3> Var0;
...
int func_227(int iParam0, float fParam1)//Position - 0x22A24
{
	float fVar0;
...
bool func_228(int iParam0, float fParam1)//Position - 0x22A9A
{
	return func_229(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_229(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x22AB2
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_230(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x22B73
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_231(int iParam0, int iParam1)//Position - 0x22C9F
{
	int iVar0;
...
int func_233(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x22DAE
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_234(struct<3> Param0, struct<3> Param3)//Position - 0x22E3F
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

void func_235(var uParam0)//Position - 0x22E60
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_236(int iParam0, int iParam1)//Position - 0x22E7B
{
	int iVar0;
...
int func_237(int iParam0)//Position - 0x22EBA
{
...
bool func_238(int iParam0, int iParam1, float fParam2)//Position - 0x22EE2
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_239(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x22F29
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_240(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x23024
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_241(int iParam0, float fParam1)//Position - 0x23130
{
	var uVar0;
	struct<3> Var1;
...
int func_242(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x231C5
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_243(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x23253
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_244()//Position - 0x2329B
{
	struct<3> Var0;
	float fVar3;
...
void func_245()//Position - 0x23351
{
	func_247(0);
	func_214();
	func_246();
...
void func_246()//Position - 0x23366
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_247(int iParam0)//Position - 0x233BE
{
	if (func_252())
	{
		return;
...
void func_248(int iParam0)//Position - 0x233F1
{
	if (func_252())
	{
		return;
...
void func_249(bool bParam0, bool bParam1)//Position - 0x2347B
{
	if (bParam0)
	{
		if (func_251(0))
...
bool func_250()//Position - 0x234EF
{
	return BitTest(Global_1956920, 5);
}

int func_251(int iParam0)//Position - 0x234FD
{
	if (iParam0 == 1)
	{
		if (Global_20930.f_1 > 3)
...
bool func_252()//Position - 0x23554
{
	return BitTest(Global_1956920, 19);
}

void func_253()//Position - 0x23563
{
	func_245();
	func_244();
...
void func_254()//Position - 0x235FB
{
...
void func_255(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x23660
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_258(Global_79645, Global_79647, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
void func_256()//Position - 0x23945
{
	if (Global_79644 != 6)
	{
	}
...
float func_257(char* sParam0)//Position - 0x2397D
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_258(int iParam0, int iParam1, int iParam2)//Position - 0x23990
{
	struct<2> Var0;
	int iVar2;
...
char* func_259(int iParam0)//Position - 0x23A66
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_260(int iParam0)//Position - 0x23BB9
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_261(int iParam0)//Position - 0x23BEC
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_262(int iParam0)//Position - 0x23C1F
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_263(int iParam0)//Position - 0x23C52
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_264(int iParam0)//Position - 0x23C85
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_265(int iParam0)//Position - 0x23CC2
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_266(int iParam0)//Position - 0x23CF5
{
	struct<2> Var0;
...
int func_267(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x23D5E
{
	if (((!func_269(0) || Global_79660) || Global_79648 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_79644)
...
bool func_268(bool bParam0)//Position - 0x23E76
{
	if (bParam0)
	{
...
int func_269(int iParam0)//Position - 0x23E9F
{
	if (Global_44042 == 15)
	{
		return 0;
...
bool func_270(int iParam0)//Position - 0x23EC1
{
	return func_271(iParam0, Global_44042);
}

int func_271(int iParam0, int iParam1)//Position - 0x23ED2
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_272(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x240B5
{
	int iVar0;
...
void func_273(var uParam0, bool bParam1, bool bParam2)//Position - 0x2415F
{
	int iVar0;
...
int func_274(var uParam0)//Position - 0x24254
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
...
void func_275(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x24422
{
	func_38(iParam0);
...
int func_276(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x24465
{
...
int func_277(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x244C1
{
	int iVar0;
...
int func_278(var uParam0, int iParam1)//Position - 0x2454F
{
	int iVar0;
...
int func_279(var uParam0)//Position - 0x24595
{
	if (func_280(uParam0))
	{
...
int func_280(var uParam0)//Position - 0x245BF
{
...
int func_281(int iParam0)//Position - 0x245E4
{
	int iVar0;
...
void func_282(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x24615
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
void func_284()//Position - 0x24675
{
	int iVar0;
...
int func_286(bool bParam0)//Position - 0x2478B
{
...
void func_287()//Position - 0x247B3
{
	func_288(67, 1);
}

void func_288(int iParam0, bool bParam1)//Position - 0x247C2
{
	int iVar0;
	char* sVar1;
...
void func_290(int iParam0, int iParam1, int iParam2)//Position - 0x24941
{
	bool bVar0;
...
void func_291()//Position - 0x24A27
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_292()//Position - 0x24EE5
{
	return Global_32948;
}

int func_293(int iParam0, int iParam1)//Position - 0x24EF0
{
	int iVar0;
...
void func_294(int iParam0, bool bParam1, int iParam2)//Position - 0x24F41
{
	if (iParam2 == -1)
	{
		iParam2 = func_113();
...
void func_295()//Position - 0x24F5F
{
	func_312();
	func_304();
	func_300();
...
void func_296(int iParam0)//Position - 0x24FB8
{
	if (iParam0 == 1)
	{
...
void func_297()//Position - 0x24FE1
{
...
void func_298()//Position - 0x24FFF
{
	StringCopy(&Global_79622, "", 16);
	StringCopy(&Global_79626, "", 16);
}

void func_299()//Position - 0x25019
{
	int iVar0;
...
void func_300()//Position - 0x2503E
{
	Global_101533 = 13;
	Global_101533.f_1 = -1;
	Global_101533.f_2 = 0;
...
void func_303(int iParam0)//Position - 0x250EB
{
	if (iParam0 == 1)
	{
		Global_44591 = 1;
...
void func_304()//Position - 0x25104
{
	func_305(&Global_107514);
}

void func_305(var uParam0)//Position - 0x25114
{
	int iVar0;
	int iVar1;
...
void func_306(var uParam0)//Position - 0x256A4
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_307(var uParam0)//Position - 0x256BF
{
...
void func_308(var uParam0)//Position - 0x256EE
{
	int iVar0;
...
void func_309(var uParam0)//Position - 0x2579E
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_310(var uParam0)//Position - 0x257BC
{
	int iVar0;
...
void func_311(var uParam0)//Position - 0x2589C
{
	*uParam0 = -15;
}

void func_312()//Position - 0x258AA
{
	StringCopy(&Global_104522, "", 32);
	func_305(&Global_104530);
}

void func_313()//Position - 0x258C3
{
...
void func_314()//Position - 0x25940
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_315(int iParam0, int iParam1, int iParam2)//Position - 0x25A01
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	else
	{
		...
		Global_79172[1 /*14*/] = { func_118(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_75(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_75(iParam1), Global_79172[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, 0);
		}
	}
...
void func_316(char* sParam0, var uParam1)//Position - 0x25BBE
{
...
void func_318(int iParam0, int iParam1)//Position - 0x25C55
{
...
void func_319(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x25C9F
{
...
void func_320(int iParam0, bool bParam1, bool bParam2)//Position - 0x25D3C
{
	struct<4> Var0;
	char* sVar32;
	...
	if (iParam0 != -1)
	{
		...
		func_321(&sVar32, Var0.f_3, Global_101570, bParam1, bParam2);
	}
}

void func_321(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x25D7B
{
...
void func_322(int iParam0)//Position - 0x25DBF
{
	Global_44593 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_323()//Position - 0x25DD1
{
	if (Global_98825)
	{
		func_19();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_324(Global_113969.f_2366.f_539.f_4321));
	}
	else
	{
...
char* func_324(var uParam0)//Position - 0x25E03
{
	uParam0 = uParam0;
	return "";
}

void func_325()//Position - 0x25E12
{
	char cVar0[24];
...
bool func_326()//Position - 0x25E55
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_327()//Position - 0x25E6B
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_328(int iParam0, int iParam1)//Position - 0x25E81
{
	Global_98820 = iParam0;
	Global_98821 = iParam1;
}

void func_329(var uParam0)//Position - 0x25E95
{
	if (*uParam0 == -1)
	{
		return;
...
void func_330(int iParam0, bool bParam1)//Position - 0x25ED2
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_331(int iParam0)//Position - 0x2604F
{
	switch (iParam0)
	{
		case 0:
...
void func_332(int iParam0)//Position - 0x263D6
{
	func_334(iParam0, 1);
...
int func_333()//Position - 0x2640C
{
	return (Global_113969.f_10019.f_21 + Global_113969.f_18577.f_380);
}

void func_334(var uParam0, bool bParam1)//Position - 0x26428
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_335(int iParam0)//Position - 0x2674C
{
...
void func_336(int iParam0)//Position - 0x2677F
{
	switch (iParam0)
	{
		case 30:
...
void func_337(int iParam0, bool bParam1)//Position - 0x267B4
{
	if (iParam0 == -1)
	{
		return;
...
void func_338(int iParam0, int iParam1, bool bParam2)//Position - 0x26811
{
	if (iParam0 == -1)
	{
		return;
...
int func_339(int iParam0, int iParam1)//Position - 0x2684C
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_340(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x2686C
{
	if (iParam0 != 198)
	{
		if (Global_79389)
...
void func_341(int iParam0, int iParam1)//Position - 0x268C4
{
	switch (iParam0)
	{
		case 12:
...
void func_342(int iParam0, bool bParam1)//Position - 0x269AD
{
	if (bParam1)
	{
...
bool func_343(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x269D6
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_345()//Position - 0x27355
{
	return Global_32949;
}

int func_346(var uParam0, int iParam1)//Position - 0x27360
{
	int iVar0;
...
int func_347(int iParam0)//Position - 0x2AAFD
{
	switch (iParam0)
	{
		case 46:
...
void func_348(int iParam0, bool bParam1)//Position - 0x2ABEC
{
	switch (iParam0)
	{
		case 46:
...
void func_349(int iParam0, bool bParam1)//Position - 0x2AC3D
{
	int iVar0;
...
void func_350(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2ACA3
{
	func_351(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_351(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2ACC4
{
	int iVar0;
...
void func_352()//Position - 0x2AE97
{
	int iVar0;
...
int func_353(int iParam0)//Position - 0x2AFAE
{
	int iVar0;
	int iVar1;
...
void func_354(char* sParam0)//Position - 0x2AFEE
{
...
char* func_355(int iParam0)//Position - 0x2B012
{
	switch (iParam0)
	{
		case 0:
...
int func_356(int iParam0)//Position - 0x2B1E5
{
...
void func_357(int iParam0, int iParam1)//Position - 0x2B20F
{
...
int func_358(char* sParam0)//Position - 0x2B24C
{
	int iVar0;
...
void func_359(bool bParam0)//Position - 0x2B2AC
{
	int iVar0;
...
void func_360(char* sParam0, int iParam1)//Position - 0x2B37C
{
	if (Global_101533 != 12)
	{
...
int func_361(char* sParam0, int iParam1, int iParam2)//Position - 0x2B3A4
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_362(char* sParam0)//Position - 0x2B533
{
...
int func_364(char* sParam0, bool bParam1)//Position - 0x2B5AD
{
	int iVar0;
	int iVar1;
...
int func_365(int iParam0, bool bParam1)//Position - 0x2B5D7
{
	int iVar0;
...
void func_368(bool bParam0)//Position - 0x2B6C9
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_369(int iParam0)//Position - 0x2B6DD
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_370(int iParam0)//Position - 0x2B717
{
	if (iParam0 == 1)
	{
...
void func_371()//Position - 0x2B751
{
	Global_23692.f_5 = 1;
}

void func_372()//Position - 0x2B75F
{
	Global_23692.f_5 = 0;
}

void func_373(bool bParam0)//Position - 0x2B76D
{
	if (bParam0)
	{
		func_374();
...
void func_374()//Position - 0x2B7D0
{
...
void func_375()//Position - 0x2B7F9
{
	Global_95689 = 0;
	Global_95690 = 0;
}

int func_376()//Position - 0x2B80B
{
...
void func_377()//Position - 0x2B849
{
	Global_101568 = 1;
...
void func_378(char* sParam0)//Position - 0x2B936
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_379(var uParam0)//Position - 0x2B948
{
...
void func_380(var uParam0)//Position - 0x2B968
{
	int iVar0;
...
int func_381(int iParam0)//Position - 0x2B9A2
{
	if (!func_20(iParam0))
	{
		return func_23(iParam0);
