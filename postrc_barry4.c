...
void func_1()//Position - 0xAB
{
	...
	{
		if (func_2(&uLocal_35, "BARR4AU", "BARR4_AMB", 8, 0, 0, 0))
		{
			func_30();
		}
	}
...
bool func_2(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD7
{
...
int func_3(char* sParam0, int iParam1, bool bParam2)//Position - 0x125
{
	Global_22167 = 0;
...
var func_7(int iParam0, int iParam1)//Position - 0x49D
{
	return BitTest(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_8()//Position - 0x4B5
{
	return -1;
}
...
bool func_16(int iParam0)//Position - 0x7FC
{
	return iParam0 < 3;
}

int func_17(int iParam0)//Position - 0x808
{
	int iVar0;
	int iVar1;
...
int func_18(int iParam0)//Position - 0x845
{
	if (func_16(iParam0))
	{
...
var func_19(int iParam0)//Position - 0x86A
{
...
void func_24(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x96D
{
...
void func_25()//Position - 0x9C3
{
	...
	func_26(&uLocal_35, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	iLocal_34 = 1;
}

void func_26(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x9E4
{
...
{
	if (((!func_14() == iParam0 || func_29()) || func_28()) || Global_79245 != -1)
	{
		if (!func_14() == 1)
		{
		}
