...
void func_4(bool bParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x153
{
	func_51();
	if (bParam0)
	{
...
void func_5()//Position - 0x225
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_16(&Global_2749774))
	{
		if (!func_14(&Global_2749774, 3500, 1) || NETWORK::NETWORK_IS_PLAYER_FADING(PLAYER::PLAYER_ID()))
		{
			if (!func_13())
			{
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					func_12(&Global_2749774, 1, 0);
				}
...
void func_6(int iParam0)//Position - 0x348
{
	if (BitTest(Global_2749778, iParam0) && NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (!func_14(&(Global_2749779[iParam0 /*2*/]), 3500, 1) || NETWORK::NETWORK_IS_PLAYER_FADING(iParam0))
		{
			if (!func_13())
			{
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					func_12(&(Global_2749779[iParam0 /*2*/]), 1, 0);
				}
		...
		else
		{
			...
			func_53(&(Global_2749779[iParam0 /*2*/]));
			MISC::CLEAR_BIT(&Global_2749778, iParam0);
		}
	}
}

int func_7(int iParam0, bool bParam1, bool bParam2)//Position - 0x417
{
	int iVar0;
...
bool func_8(int iParam0, int iParam1)//Position - 0x477
{
	bool bVar0;
...
int func_11(var uParam0)//Position - 0x51D
{
	int iVar0;
...
void func_12(var uParam0, bool bParam1, bool bParam2)//Position - 0x53F
{
...
int func_14(var uParam0, int iParam1, bool bParam2)//Position - 0x59A
{
	if (iParam1 == -1)
	{
		return 1;
...
void func_15(var uParam0, bool bParam1, bool bParam2)//Position - 0x5F8
{
	if (uParam0->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
...
var func_16(var uParam0)//Position - 0x63D
{
	return uParam0->f_1;
}

void func_17(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x649
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_21(int iParam0)//Position - 0xB95
{
	int iVar0;
...
void func_22(bool bParam0, int iParam1, int iParam2)//Position - 0xBC6
{
	int iVar0;
	int iVar1;
...
void func_23(int iParam0, bool bParam1)//Position - 0xC96
{
	int iVar0;
...
int func_29(int iParam0)//Position - 0xD6C
{
	if (func_8(iParam0, 0))
	{
		return 1;
...
void func_37(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xEAD
{
	if (bParam0)
	{
...
int func_59(int iParam0)//Position - 0x1494
{
...
int func_61(var uParam0)//Position - 0x151B
{
	func_288();
...
int func_62(var uParam0)//Position - 0x157E
{
	func_63();
	if (CAM::IS_SCREEN_FADED_OUT())
	{
...
void func_65(int iParam0)//Position - 0x164D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_66(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8)//Position - 0x16E9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_67()//Position - 0x17CD
{
	return -1;
}

int func_68(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x17D6
{
	int iVar0;
...
int func_72(var uParam0)//Position - 0x1A40
{
	if (uParam0->f_20 == 0)
	{
		return 1;
	...
	ENTITY::SET_ENTITY_INVINCIBLE(uParam0->f_22, true, false);
...
int func_73()//Position - 0x1AC1
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

char* func_74(bool bParam0, char* sParam1, char* sParam2)//Position - 0x1AD1
{
	if (bParam0)
	{
		return sParam1;
...
void func_81(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x1D99
{
	int iVar0;
	float fVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		if ((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iParam0)) || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			func_142(iParam0, uParam1, bParam2, bParam3);
			if (uParam1->f_102 != 0)
			{
				if (uParam1->f_102 == 2)
				{
			...
			if (func_141(ENTITY::GET_ENTITY_MODEL(iParam0)))
			{
				if (uParam1->f_9[44] == 2)
				{
			...
			if (func_140(ENTITY::GET_ENTITY_MODEL(iParam0)))
			{
				if (BitTest(uParam1->f_103, 0) || func_139(ENTITY::GET_ENTITY_MODEL(iParam0)))
				{
					VEHICLE::SET_VEHICLE_ALLOW_HOMING_MISSLE_LOCKON_SYNCED(iParam0, false, true);
					func_138(iParam0);
				}
...
bool func_82(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)//Position - 0x22BD
{
...
int func_84(int iParam0)//Position - 0x22E7
{
	switch (iParam0)
	{
		case joaat("coureur"):
...
int func_85(int iParam0)//Position - 0x231C
{
	switch (iParam0)
	{
		case joaat("pounder2"):
...
void func_86(int iParam0)//Position - 0x2423
{
	struct<3> Var0;
...
void func_87(struct<3> Param0)//Position - 0x24AE
{
	struct<4> Var0;
...
var func_88(int iParam0, bool bParam1)//Position - 0x24EF
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_89(int iParam0)//Position - 0x2554
{
	int iVar0;
...
int func_91(int iParam0, int iParam1, bool bParam2)//Position - 0x259F
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_93(int iParam0, var uParam1)//Position - 0x262E
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_94(uParam1));
}

int func_94(var uParam0)//Position - 0x2643
{
	int iVar0;
	int iVar1;
...
int func_99(int iParam0, var* uParam1)//Position - 0x2D8D
{
	int iVar0;
	int iVar1;
...
int func_100(int iParam0)//Position - 0x2E0A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_101(int iParam0)//Position - 0x2E97
{
	int iVar0;
...
int func_102(int iParam0, int iParam1)//Position - 0x2EF3
{
	func_106();
	...
	func_104(*iParam0, &Global_1943806, &(Global_1943806.f_1), &(Global_1943806.f_4), &(Global_1943806.f_7), &(Global_1943806.f_10));
	...
	{
		if (func_103(iParam0, iParam1, Global_1943806, Global_1943806.f_1, Global_1943806.f_4, Global_1943806.f_7, Global_1943806.f_10, 0, Global_1943806.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
	...
	else
	{
		...
		if (((Global_1943806.f_23 == 0 && func_103(iParam0, iParam1, Global_1943806, Global_1943806.f_1, Global_1943806.f_4, Global_1943806.f_7, Global_1943806.f_10, 0, Global_1943806.f_13)) || Global_1943806.f_23 != 0) && ((Global_1943806.f_24 == 0 && func_103(iParam0, iParam1, Global_1943806, Global_1943806.f_14, Global_1943806.f_17, Global_1943806.f_20, Global_1943806.f_10, 1, Global_1943806.f_13)) || Global_1943806.f_24 != 0))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				Global_1577965 = NETWORK::GET_NETWORK_TIME();
...
bool func_103(var uParam0, int iParam1, int iParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, int iParam13, int iParam14)//Position - 0x319E
{
...
int func_104(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x31C7
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		return 0;
	...
	*uParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iParam0, "chassis_dummy");
	if (((!func_105(Global_1943832, 0f, 0f, 0f, 0) && !func_105(Global_1943835, 0f, 0f, 0f, 0)) && !func_105(Global_1943838, 0f, 0f, 0f, 0)) && !Global_1943841 == 0f)
	{
...
bool func_105(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x8EDF
{
	if (bParam6)
	{
...
int func_107(int iParam0)//Position - 0x8F9F
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
...
int func_108(int iParam0)//Position - 0x8FD7
{
	int iVar0;
...
int func_109(int iParam0, var* uParam1)//Position - 0x901F
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	{
		iVar2 = Global_2359296[func_116() /*5571*/].f_681.f_2;
...
int func_110(int iParam0)//Position - 0x917C
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return 1;
...
int func_111(int iParam0)//Position - 0x94BB
{
...
int func_114(int iParam0, int iParam1)//Position - 0x9527
{
	if (func_11(iParam0))
	{
...
int func_118(int iParam0, bool bParam1)//Position - 0x95B6
{
	return func_119(iParam0, bParam1, 1);
}

int func_119(int iParam0, bool bParam1, int iParam2)//Position - 0x95C7
{
	int iVar0;
...
int func_120(int iParam0, int iParam1)//Position - 0x9623
{
	if (func_11(iParam0))
	{
...
int func_121(int iParam0, bool bParam1)//Position - 0x9672
{
	var uVar0;
	int iVar1;
...
int func_124(var uParam0)//Position - 0x96F4
{
	int iVar0;
	int iVar1;
...
int func_126(int iParam0)//Position - 0x972E
{
	if (iParam0 != func_67())
	{
		if (func_127(iParam0) && Global_2657991[iParam0 /*467*/].f_324.f_11 == iParam0)
		{
			return 1;
		}
	}
...
int func_127(int iParam0)//Position - 0x9763
{
	if (iParam0 != func_67())
	{
		if (func_7(iParam0, 1, 1))
		{
			...
			{
				return func_128(Global_2657991[iParam0 /*467*/].f_324.f_8) == 22;
			}
		}
	}
	return 0;
...
void func_129(int iParam0, int iParam1)//Position - 0x9CC6
{
	int iVar0;
	int iVar1;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xA047
{
	...
	if ((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_133()) && Global_1576240)
	{
...
struct<13> func_134()//Position - 0xA271
{
	struct<13> Var0;
...
int func_135(int iParam0)//Position - 0xA286
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("deathbike2"):
...
void func_137(int iParam0)//Position - 0xA5A8
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_138(int iParam0)//Position - 0xA5DA
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", 2))
...
int func_139(int iParam0)//Position - 0xA60E
{
	switch (iParam0)
	{
		case joaat("jester5"):
...
int func_140(int iParam0)//Position - 0xA62B
{
...
int func_141(int iParam0)//Position - 0xAB7C
{
	switch (iParam0)
	{
		case joaat("deity"):
...
void func_142(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0xAC0B
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		{
			iVar0 = 1;
			if (BitTest(uParam1->f_77, func_166(iVar0 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_166(iVar0 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			iVar1 = 1;
			if (BitTest(uParam1->f_77, func_166(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_166(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				if (BitTest(uParam1->f_77, func_166(iVar2)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_166(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				if (BitTest(uParam1->f_77, func_166(iVar3)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_166(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (BitTest(uParam1->f_77, func_166(iVar4)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_77), func_166(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("surfer3"))
		{
			...
			while (iVar5 <= 2)
			{
				if (BitTest(uParam1->f_77, func_166(iVar5)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_166(iVar5));
				}
				iVar5++;
			}
		}
		...
		{
			if (BitTest(uParam1->f_77, func_166(4)))
			{
			}
			else
			{
		...
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar6 <= 2)
			{
				if (BitTest(uParam1->f_77, func_166(iVar6)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_166(iVar6));
				}
				iVar6++;
			}
		}
		...
		if (((BitTest(uParam1->f_77, 15) || func_163(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_162())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar7 <= 11)
			{
				if (BitTest(uParam1->f_77, func_166(iVar7 + 1)))
				{
		...
		if ((((func_145() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_144(1)))
		{
			if (!BitTest(uParam1->f_77, 23))
			{
				if (!BitTest(uParam1->f_77, 22) && func_143(iParam0, 5f))
				{
...
int func_143(int iParam0, float fParam1)//Position - 0xB30E
{
	struct<3> Var0;
	float fVar3;
...
int func_146(var uParam0)//Position - 0xB428
{
	int iVar0;
...
int func_147(int iParam0)//Position - 0xB44C
{
	int iVar0;
...
var func_148(int iParam0, int iParam1)//Position - 0xB46A
{
...
var func_150(var uParam0, var uParam1)//Position - 0xB496
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_151(int iParam0, var uParam1, var uParam2)//Position - 0xB4B9
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*iParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_158(*iParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_156(ENTITY::GET_ENTITY_MODEL(*iParam0)) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_154(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_154(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_153(iParam0);
	if (func_152(*iParam0))
	{
...
int func_152(int iParam0)//Position - 0xB692
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_154(int iParam0, int iParam1)//Position - 0xB7C3
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		iVar0 = func_155(iParam0, 38) + 1;
		iVar1 = func_155(iParam0, 24) + 1;
...
int func_155(int iParam0, int iParam1)//Position - 0xB8AC
{
	int iVar0;
	...
	while (iVar0 >= 0 && func_158(iParam0, iParam1, iVar0))
	{
		iVar0 = (iVar0 - 1);
	}
	return iVar0;
...
int func_156(int iParam0)//Position - 0xB90E
{
...
int func_157(int iParam0, int iParam1)//Position - 0xB939
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_158(int iParam0, int iParam1, int iParam2)//Position - 0xBD18
{
	if (!func_159() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_159()//Position - 0xBD3C
{
	return 0;
}

void func_160(int iParam0, int iParam1)//Position - 0xBD45
{
	int iVar0;
	int iVar1;
...
int func_161(int iParam0)//Position - 0xBDBD
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_163(int iParam0)//Position - 0xBDEE
{
	int iVar0;
...
int func_164(int iParam0)//Position - 0xBE33
{
	if (!func_159() && func_165(iParam0))
	{
		return 1;
	}
	return 0;
...
int func_165(int iParam0)//Position - 0xBE53
{
	switch (iParam0)
	{
		case 161:
...
int func_167(int iParam0)//Position - 0xBF56
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (!func_168(PLAYER::PLAYER_ID(), -1))
		{
...
int func_168(int iParam0, int iParam1)//Position - 0xBFDD
{
	int iVar0;
...
{
	if (func_286(PLAYER::PLAYER_ID(), 0, 0))
	{
		return;
	}
...
int func_172(var uParam0)//Position - 0xC162
{
	...
	else
	{
		...
		func_173(uParam0->f_23, &(Global_1879882[iVar0 /*55*/]), 0, -1);
	}
	ENTITY::SET_ENTITY_VISIBLE(uParam0->f_23, uParam0->f_8, false);
	ENTITY::SET_ENTITY_INVINCIBLE(uParam0->f_23, true, false);
...
void func_173(int iParam0, var uParam1, bool bParam2, int iParam3)//Position - 0xC23A
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		iVar13 = func_279(iParam0);
		bVar14 = func_276(iParam0, 0);
		bVar15 = func_268(iParam0);
		bVar16 = func_191(iParam0, iParam3);
		if (bParam2)
		{
			bVar15 = true;
		}
		...
		while (iVar17 < 127)
		{
			...
			{
				if (func_182(&Var0, iVar17, iVar13, iParam0, -1))
				{
					if (func_175(iParam0, &Var0, iVar17, Var0.f_4, Var0.f_8, bVar14, bVar15, bParam2, bVar16))
					{
		...
		while (iVar18 < iVar19)
		{
			if (FILES::GET_TATTOO_SHOP_DLC_ITEM_DATA(iVar13, iVar18, &Var20))
			{
				if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20.f_0))
				{
					...
					{
						if (func_175(iParam0, &(Var20.f_7), iVar35, Var20.f_2, Var20.f_6, bVar14, bVar15, bParam2, bVar16))
						{
							PED::ADD_PED_DECORATION_FROM_HASHES_IN_CORONA(iParam0, Var20.f_2, Var20.f_3);
							func_174(iParam0, Var20.f_2, Var20.f_3);
						}
					}
				}
			}
...
int func_175(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)//Position - 0xD67A
{
	int iVar0;
	int iVar1;
	...
	if (iParam4 == 0)
	{
		iVar1 = func_181(iVar0, sParam1, iParam4);
		iParam4 = MISC::GET_HASH_KEY(func_180(iVar1));
	}
...
int func_176(int iParam0, int iParam1)//Position - 0xDEA0
{
	var uVar0;
	int iVar1;
...
int func_179(var uParam0)//Position - 0xDF30
{
	int iVar0;
	int iVar1;
...
int func_181(int iParam0, char* sParam1, int iParam2)//Position - 0xE912
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
bool func_182(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xF944
{
	...
	switch (iParam2)
	{
			...
			switch (iParam1)
			{
				...
				case 9:
					if (func_189() || func_188())
					{
						...
						func_190(sParam0, iParam1, iParam3, "TAT_MIC_12", "singleplayer_overlays", "MK_011", "", iParam2, iVar1, 2);
					}
					break;
			...
			switch (iParam1)
			{
				case 0:
					if (func_189() || func_188())
					{
						...
						func_190(sParam0, iParam1, iParam3, "TAT_FRA_01", "singleplayer_overlays", "fr_000", "", iParam2, iVar1, 0);
					}
					break;
			...
			switch (iParam1)
			{
				...
				case 5:
					if (func_189() || func_188())
					{
						...
						func_190(sParam0, iParam1, iParam3, "TAT_TRV_06", "singleplayer_overlays", "tp_005", "", iParam2, iVar1, 3);
					}
					break;
		...
		case 4:
			...
			{
				case 0:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_008", "multiplayer_overlays", "000", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(20000) * Global_262145.f_2825 /* Tunable: TATTOO_MP_FM_HEAD_BANGER_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 1:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_009", "multiplayer_overlays", "001", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1400) * Global_262145.f_2826 /* Tunable: TATTOO_MP_FM_SLAYER_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 2:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_010", "multiplayer_overlays", "002", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(9750) * Global_262145.f_2827 /* Tunable: TATTOO_MP_FM_GANGHIDEOUT_CLEAR_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 3:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_011", "multiplayer_overlays", "003", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2150) * Global_262145.f_2828 /* Tunable: TATTOO_MP_FM_ARMOURED_VAN_TAKEDOWN_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 4:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_012", "multiplayer_overlays", "004", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2829 /* Tunable: TATTOO_MP_FM_HUSTLER_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 54:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_013", "multiplayer_overlays", "005", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12400) * Global_262145.f_2830 /* Tunable: TATTOO_MP_FM_WIN_EVER_MODE_ONCE_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 5:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_014", "multiplayer_overlays", "006", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3500) * Global_262145.f_2831 /* Tunable: TATTOO_MP_FM_BOUNTY_KILLER_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 6:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_015", "multiplayer_overlays", "007", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4950) * Global_262145.f_2832 /* Tunable: TATTOO_MP_FM_HOLD_WORLD_RECORD_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 55:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_016", "multiplayer_overlays", "008", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1350) * Global_262145.f_2833 /* Tunable: TATTOO_MP_FM_FULL_MODDED_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 7:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_017", "multiplayer_overlays", "009", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1450) * Global_262145.f_2834 /* Tunable: TATTOO_MP_FM_REVENGE_KILL_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 8:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_018", "multiplayer_overlays", "010", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2700) * Global_262145.f_2835 /* Tunable: TATTOO_MP_FM_KILL_3_RACERS_EXPENDITURE_TUNABLE */)), 7);
					break;
				
				case 9:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_019", "multiplayer_overlays", "011", "rank", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1200) * Global_262145.f_2836 /* Tunable: TATTOO_MP_FM_REACH_RANK_1_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 10:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_020", "multiplayer_overlays", "012", "rank", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1500) * Global_262145.f_2837 /* Tunable: TATTOO_MP_FM_REACH_RANK_2_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 11:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_021", "multiplayer_overlays", "013", "rank", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2650) * Global_262145.f_2838 /* Tunable: TATTOO_MP_FM_REACH_RANK_3_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 56:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_022", "multiplayer_overlays", "014", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1900) * Global_262145.f_2839 /* Tunable: TATTOO_MP_FM_FMKILLCHEATER_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 12:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_023", "multiplayer_overlays", "015", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4950) * Global_262145.f_2840 /* Tunable: TATTOO_MP_FM_RACES_WON_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 57:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_024", "multiplayer_overlays", "016", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2400) * Global_262145.f_2841 /* Tunable: TATTOO_MP_FM_HOLD_UP_SHOPS_1_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 58:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_025", "multiplayer_overlays", "017", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5100) * Global_262145.f_2842 /* Tunable: TATTOO_MP_FM_HOLD_UP_SHOPS_2_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 59:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_026", "multiplayer_overlays", "018", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7400) * Global_262145.f_2843 /* Tunable: TATTOO_MP_FM_HOLD_UP_SHOPS_3_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 60:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_027", "multiplayer_overlays", "019", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2844 /* Tunable: TATTOO_MP_FM_HOLD_UP_SHOPS_4_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 17:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_201", "multiplayer_overlays", "005", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2400) * Global_262145.f_2849 /* Tunable: TATTOO_MP_FM_01_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 18:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_202", "multiplayer_overlays", "006", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5100) * Global_262145.f_2850 /* Tunable: TATTOO_MP_FM_02_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 19:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_203", "multiplayer_overlays", "015", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3600) * Global_262145.f_2851 /* Tunable: TATTOO_MP_FM_03_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 20:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_204", "multiplayer_overlays", "000", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2852 /* Tunable: TATTOO_MP_FM_04_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 21:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_205", "multiplayer_overlays", "001", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12500) * Global_262145.f_2853 /* Tunable: TATTOO_MP_FM_05_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 22:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_206", "multiplayer_overlays", "003", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2854 /* Tunable: TATTOO_MP_FM_06_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 23:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_207", "multiplayer_overlays", "014", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2855 /* Tunable: TATTOO_MP_FM_07_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 24:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_208", "multiplayer_overlays", "018", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2856 /* Tunable: TATTOO_MP_FM_08_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 25:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_209", "multiplayer_overlays", "002", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3750) * Global_262145.f_2857 /* Tunable: TATTOO_MP_FM_09_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 26:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_210", "multiplayer_overlays", "007", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3750) * Global_262145.f_2858 /* Tunable: TATTOO_MP_FM_10_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 27:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_211", "multiplayer_overlays", "008", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4800) * Global_262145.f_2859 /* Tunable: TATTOO_MP_FM_11_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 28:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_212", "multiplayer_overlays", "017", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3500) * Global_262145.f_2860 /* Tunable: TATTOO_MP_FM_12_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 61:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_213", "multiplayer_overlays", "009", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12350) * Global_262145.f_2861 /* Tunable: TATTOO_MP_FM_13_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 62:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_214", "multiplayer_overlays", "011", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1900) * Global_262145.f_2862 /* Tunable: TATTOO_MP_FM_14_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 63:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_215", "multiplayer_overlays", "013", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4500) * Global_262145.f_2863 /* Tunable: TATTOO_MP_FM_15_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 64:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_216", "multiplayer_overlays", "016", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12250) * Global_262145.f_2864 /* Tunable: TATTOO_MP_FM_16_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 65:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_217", "multiplayer_overlays", "019", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12300) * Global_262145.f_2865 /* Tunable: TATTOO_MP_FM_17_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 29:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_218", "multiplayer_overlays", "010", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2500) * Global_262145.f_2866 /* Tunable: TATTOO_MP_FM_18_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 30:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_219", "multiplayer_overlays", "004", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2867 /* Tunable: TATTOO_MP_FM_19_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 31:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_220", "multiplayer_overlays", "012", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2868 /* Tunable: TATTOO_MP_FM_20_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 66:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_221", "multiplayer_overlays", "020", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2869 /* Tunable: TATTOO_MP_FM_21_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 32:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_222", "multiplayer_overlays", "021", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2870 /* Tunable: TATTOO_MP_FM_22_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 33:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_223", "multiplayer_overlays", "022", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7300) * Global_262145.f_2871 /* Tunable: TATTOO_MP_FM_23_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 34:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_224", "multiplayer_overlays", "023", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7250) * Global_262145.f_2872 /* Tunable: TATTOO_MP_FM_24_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 35:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_225", "multiplayer_overlays", "024", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(11900) * Global_262145.f_2873 /* Tunable: TATTOO_MP_FM_25_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 36:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_226", "multiplayer_overlays", "025", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2750) * Global_262145.f_2874 /* Tunable: TATTOO_MP_FM_26_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 37:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_227", "multiplayer_overlays", "026", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1750) * Global_262145.f_2875 /* Tunable: TATTOO_MP_FM_27_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 38:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_228", "multiplayer_overlays", "027", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7300) * Global_262145.f_2876 /* Tunable: TATTOO_MP_FM_28_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 39:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_229", "multiplayer_overlays", "028", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3250) * Global_262145.f_2877 /* Tunable: TATTOO_MP_FM_29_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 40:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_230", "multiplayer_overlays", "029", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1000) * Global_262145.f_2878 /* Tunable: TATTOO_MP_FM_30_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 67:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_231", "multiplayer_overlays", "030", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2879 /* Tunable: TATTOO_MP_FM_31_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 41:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_232", "multiplayer_overlays", "031", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2880 /* Tunable: TATTOO_MP_FM_32_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 68:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_233", "multiplayer_overlays", "032", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5100) * Global_262145.f_2881 /* Tunable: TATTOO_MP_FM_33_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 42:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_234", "multiplayer_overlays", "033", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5050) * Global_262145.f_2882 /* Tunable: TATTOO_MP_FM_34_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 43:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_235", "multiplayer_overlays", "034", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2450) * Global_262145.f_2883 /* Tunable: TATTOO_MP_FM_35_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 44:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_236", "multiplayer_overlays", "035", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4950) * Global_262145.f_2884 /* Tunable: TATTOO_MP_FM_36_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 45:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_237", "multiplayer_overlays", "036", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5100) * Global_262145.f_2885 /* Tunable: TATTOO_MP_FM_37_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 46:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_238", "multiplayer_overlays", "037", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12250) * Global_262145.f_2886 /* Tunable: TATTOO_MP_FM_38_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 47:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_239", "multiplayer_overlays", "038", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1150) * Global_262145.f_2887 /* Tunable: TATTOO_MP_FM_39_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 48:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_240", "multiplayer_overlays", "039", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2888 /* Tunable: TATTOO_MP_FM_40_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 49:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_241", "multiplayer_overlays", "040", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7600) * Global_262145.f_2889 /* Tunable: TATTOO_MP_FM_41_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 50:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_242", "multiplayer_overlays", "041", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2600) * Global_262145.f_2890 /* Tunable: TATTOO_MP_FM_42_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 51:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_243", "multiplayer_overlays", "042", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2500) * Global_262145.f_2891 /* Tunable: TATTOO_MP_FM_43_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 52:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_244", "multiplayer_overlays", "043", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7450) * Global_262145.f_2892 /* Tunable: TATTOO_MP_FM_44_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 53:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_245", "multiplayer_overlays", "044", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2893 /* Tunable: TATTOO_MP_FM_45_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 69:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_246", "multiplayer_overlays", "045", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2894 /* Tunable: TATTOO_MP_FM_46_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 70:
					func_190(sParam0, iParam1, iParam3, "TAT_FM_247", "multiplayer_overlays", "047", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2500) * Global_262145.f_2895 /* Tunable: TATTOO_MP_FM_47_EXPENDITURE_TUNABLE */)), 2);
					break;
			}
			if (iVar0 == joaat("MP_M_Freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_190(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_000", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2896 /* Tunable: TSHIRT_TRANS_MP_FM_REDSKULL_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 88:
						func_190(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_001", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2897 /* Tunable: TSHIRT_TRANS_MP_FM_LSBELLE_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 89:
						func_190(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_002", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2898 /* Tunable: TSHIRT_TRANS_MP_FM_ROCKSTAR_EXPENDITURE_TUNABLE */)), 0);
						break;
					...
					case 13:
						func_190(sParam0, iParam1, iParam3, "TAT_FM_100" /* GXT: Crew Emblem Small */, "multiplayer_overlays", "000_A", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2845 /* Tunable: TATTOO_MP_FM_CREW_A_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 14:
						func_190(sParam0, iParam1, iParam3, "TAT_FM_101" /* GXT: Crew Emblem Large */, "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2846 /* Tunable: TATTOO_MP_FM_CREW_B_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 15:
						func_190(sParam0, iParam1, iParam3, "TAT_FMM_CLB" /* GXT: Crew Emblem Back */, "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2847 /* Tunable: TATTOO_MP_FM_CREW_C_EXPENDITURE_TUNABLE */)), 2);
						break;
					
					case 16:
						func_190(sParam0, iParam1, iParam3, "TAT_FM_100" /* GXT: Crew Emblem Small */, "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2848 /* Tunable: TATTOO_MP_FM_CREW_D_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 71:
						func_190(sParam0, iParam1, iParam3, "TAT_FM_101" /* GXT: Crew Emblem Large */, "multiplayer_overlays", "000_E", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2848 /* Tunable: TATTOO_MP_FM_CREW_D_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 72:
						func_190(sParam0, iParam1, iParam3, "TAT_FMM_CLB" /* GXT: Crew Emblem Back */, "multiplayer_overlays", "000_F", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2848 /* Tunable: TATTOO_MP_FM_CREW_D_EXPENDITURE_TUNABLE */)), 0);
						break;
				}
			}
			else if (iVar0 == joaat("MP_F_Freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_190(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_000", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2896 /* Tunable: TSHIRT_TRANS_MP_FM_REDSKULL_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 88:
						func_190(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_001", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2897 /* Tunable: TSHIRT_TRANS_MP_FM_LSBELLE_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 89:
						func_190(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_002", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2898 /* Tunable: TSHIRT_TRANS_MP_FM_ROCKSTAR_EXPENDITURE_TUNABLE */)), 0);
						break;
					...
					case 14:
						func_190(sParam0, iParam1, iParam3, "TAT_FM_100" /* GXT: Crew Emblem Small */, "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2846 /* Tunable: TATTOO_MP_FM_CREW_B_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 15:
						func_190(sParam0, iParam1, iParam3, "TAT_FM_101" /* GXT: Crew Emblem Large */, "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2847 /* Tunable: TATTOO_MP_FM_CREW_C_EXPENDITURE_TUNABLE */)), 2);
						break;
					
					case 16:
						func_190(sParam0, iParam1, iParam3, "TAT_FM_101" /* GXT: Crew Emblem Large */, "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2848 /* Tunable: TATTOO_MP_FM_CREW_D_EXPENDITURE_TUNABLE */)), 0);
						break;
					}
			}
			break;
...
int func_184()//Position - 0x12944
{
	if (func_187() && (func_186() || func_185()))
	{
		return 1;
	}
	return 0;
...
int func_191(int iParam0, int iParam1)//Position - 0x12ED9
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (ENTITY::GET_ENTITY_MODEL(iParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			if (iVar0 > 15)
			{
				iVar3 = func_196(iParam0, 11, -1);
				if (iVar3 >= 237)
				{
					iVar4 = func_192(joaat("MP_M_Freemode_01"), iVar3, 11, 3);
		...
		else if (ENTITY::GET_ENTITY_MODEL(iParam0) == joaat("MP_F_Freemode_01"))
		{
			...
			{
				iVar5 = func_196(iParam0, 11, -1);
				if (iVar5 >= 256)
				{
					iVar6 = func_192(joaat("MP_F_Freemode_01"), iVar5, 11, 4);
...
int func_192(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x13199
{
	...
	else if (iParam2 == 14)
	{
		...
		iVar17 = (iParam1 - func_195(iParam0));
		if (iVar17 < 0)
		{
			return -1;
		}
	...
	else
	{
		...
		iVar36 = (iParam1 - func_193(iParam0, func_194(iParam2)));
		if (iVar36 < 0)
		{
			return -1;
		}
		...
		iVar37 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_194(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_197(int iParam0, int iParam1)//Position - 0x1380C
{
	...
	return func_198(iParam0, iVar1, iVar2, iParam1);
}

int func_198(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1386C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_200(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1390A
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		if (iVar0 == joaat("MP_M_Freemode_01"))
		{
			return func_202(ENTITY::GET_ENTITY_MODEL(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("MP_F_Freemode_01"))
		{
			return func_202(ENTITY::GET_ENTITY_MODEL(iParam0), iVar1, 14, 4);
		}
	}
	...
	while (iVar4 <= (iVar2 - 1))
	{
		...
		else
		{
			...
			while (iVar5 <= (iVar6 - 1))
			{
				...
				{
					iVar3 = (iVar3 + func_201(iParam0, iParam3));
					return iVar3;
				}
				else
				{
...
int func_202(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x13B44
{
	...
	if (iParam2 == 12)
	{
		...
		while (iVar15 < iVar16)
		{
			...
			if (Var0.f_1 == iParam1)
			{
				return (func_203(iParam0) + iVar15);
			}
			iVar15++;
		}
	}
	...
	else if (iParam2 == 14)
	{
		...
		if (iVar17 != -1)
		{
			return (func_195(iParam0) + iVar17);
		}
	}
	else
	{
		...
		if (iVar18 != -1)
		{
			return (func_193(iParam0, func_194(iParam2)) + iVar18);
		}
	}
	return -99;
}
...
int func_205(int iParam0, int iParam1, int iParam2)//Position - 0x13CE4
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_79322[1 /*14*/] = { func_221(iVar0, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		while (iVar7 < 7)
		{
			...
			if (uVar8[iVar4] != -99)
			{
				if (!func_205(iParam0, iVar4, uVar8[iVar4]))
				{
					...
					if (iVar4 == 13)
					{
						uVar25 = { func_214(iVar0, uVar8[iVar4]) };
						iVar5 = 0;
						while (iVar5 <= 8)
						{
							if (!func_205(iParam0, 14, uVar25[iVar5]))
							{
								iVar6 = 0;
								while (iVar6 <= 19)
								{
									Global_79322[2 /*14*/] = { func_221(iVar0, 14, iVar6, -1) };
									if (Global_79322[2 /*14*/].f_12 == iVar5)
									{
										if (func_205(iParam0, 14, iVar6))
										{
											if (!func_209(iVar0, iParam2, 14, iVar6, &uVar8, &(Global_79322[2 /*14*/])))
											{
												Global_2883588 = uVar2;
												Global_2883589 = uVar3;
												return 0;
					...
					{
						iVar1 = func_197(iParam0, iVar4);
						Global_79322[2 /*14*/] = { func_221(iVar0, iVar4, iVar1, -1) };
						if (!func_209(iVar0, iParam2, iVar4, iVar1, &uVar8, &(Global_79322[2 /*14*/])))
						{
							Global_2883588 = uVar2;
							Global_2883589 = uVar3;
							return 0;
		...
		{
			if (func_92(1759, Global_79319) != uVar8[10])
			{
				Global_2883588 = uVar2;
				Global_2883589 = uVar3;
				return 0;
	...
	{
		uVar36 = { func_214(iVar0, iParam2) };
		iVar35 = 0;
		while (iVar35 <= 8)
		{
			if (!func_205(iParam0, 14, uVar36[iVar35]))
			{
				return 0;
			}
			iVar35++;
	...
	else if (iParam1 == 14)
	{
		...
		if (((Global_79322[1 /*14*/].f_12 == 0 && BitTest(Global_79322[1 /*14*/].f_6, 6)) && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Global_2883588, joaat("HELMET"), 1)) && FILES::GET_SHOP_PED_APPAREL_VARIANT_PROP_COUNT(Global_2883588) > 0)
		{
			...
			while (iVar46 < iVar50)
			{
				...
				if (iVar47 != 0 && iVar47 != joaat("0"))
				{
					...
					if (Var51.f_3 == PED::GET_PED_PROP_INDEX(iParam0, Global_79322[1 /*14*/].f_12, 1) && Var51.f_4 == PED::GET_PED_PROP_TEXTURE_INDEX(iParam0, Global_79322[1 /*14*/].f_12))
					{
						return 1;
					}
				}
	...
	{
		if (Global_79322[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_194(iParam1)) && Global_79322[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_194(iParam1)))
		{
			return 1;
		}
		if (iParam1 == 4)
		{
			...
			if (Global_79321 == 1)
			{
				if (func_208(iVar0, 11, func_197(iParam0, 11), -1))
				{
					if (func_207(iVar0, 4, iParam2, &uVar68))
					{
						return func_205(iParam0, 4, uVar68);
					}
				}
				else if (func_206(iVar0, 4, iParam2, &uVar68))
				{
					return func_205(iParam0, 4, uVar68);
				}
			}
...
int func_206(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x14141
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 4:
					if (iParam2 >= 256)
					{
						iVar0 = func_192(iParam0, iParam2, iParam1, 4);
						if (iVar0 != -1)
						{
							...
							while (iVar2 < iVar1)
							{
								...
								if (iVar5 == 4)
								{
									if (iVar3 != 0 && iVar3 != joaat("0"))
									{
										...
										{
											*uParam3 = func_202(iParam0, iVar3, iParam1, 4);
											return 1;
										}
									}
								}
...
int func_207(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x141EA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_208(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x14292
{
	switch (iParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
int func_209(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x142E5
{
	var uVar0;
	int iVar10;
	...
	if (iParam2 == 14)
	{
		uVar0 = { func_214(iParam0, (*uParam4)[13]) };
		iVar10 = 0;
		while (iVar10 <= 8)
		{
...
int func_210(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x148E9
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(iParam0, iParam2, 14, 3), joaat("HAT_MENU"), 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(iParam0, iParam2, 1, 3), joaat("HAT_MENU"), 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(iParam0, iParam2, 14, 4), joaat("HAT_MENU"), 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(iParam0, iParam2, 1, 4), joaat("HAT_MENU"), 0));
					}
					break;
			}
			break;
...
int func_211(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x14B66
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_212(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x14F8B
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_213(int iParam0, int iParam1, int iParam2)//Position - 0x1527E
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_214(int iParam0, int iParam1)//Position - 0x15317
{
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			...
			{
				case 31:
					func_216(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 0:
					func_216(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 1:
					func_216(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 2:
					func_216(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 3:
					func_216(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 4:
					func_216(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_216(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_216(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_216(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 8:
					func_216(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 9:
					func_216(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8);
					break;
				
				default:
					func_215(&Var1, iParam0, iParam1, 10);
					break;
			}
			break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 1:
					func_216(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8);
					break;
				
				case 2:
					func_216(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 4:
					func_216(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_216(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_216(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_216(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 8:
					func_216(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				default:
					func_215(&Var1, iParam0, iParam1, 9);
					break;
			}
			break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 0:
					func_216(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 1:
					func_216(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 3:
					func_216(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8);
					break;
				
				case 4:
					func_216(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_216(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_216(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_216(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 8:
					func_216(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				...
				case 0:
					func_216(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 1:
					func_216(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 2:
					func_216(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 3:
					func_216(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 4:
					func_216(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_216(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_216(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_216(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 8:
					func_216(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 9:
					func_216(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 10:
					func_216(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 12:
					func_216(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 13:
					func_216(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 14:
					func_216(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 15:
					func_216(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 16:
					func_216(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 17:
					func_216(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 18:
					func_216(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 19:
					func_216(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 20:
					func_216(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 21:
					func_216(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				default:
					func_215(&Var1, iParam0, iParam1, 25);
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				...
				case 0:
					func_216(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 1:
					func_216(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 2:
					func_216(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 3:
					func_216(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 4:
					func_216(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_216(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_216(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_216(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 9:
					func_216(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 10:
					func_216(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 11:
					func_216(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 12:
					func_216(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 13:
					func_216(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8);
					break;
				
				case 14:
					func_216(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 16:
					func_216(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 17:
					func_216(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 18:
					func_216(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 19:
					func_216(&Var1, 42, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 20:
					func_216(&Var1, 76, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 21:
					func_216(&Var1, 39, 235, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 22:
					func_216(&Var1, 41, 183, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 23:
					func_216(&Var1, 111, 194, 2, 3, 4, 5, 6, 7, 8);
					break;
...
void func_215(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x15C46
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1.f_0))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_202(iParam1, Var16.f_0, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
...
void func_216(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x15D70
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_217(int iParam0, int iParam1)//Position - 0x15DB8
{
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				case 0:
					...
					{
						func_220(&Var1, -99, -99, 1, 1, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					}
					else
					{
						func_220(&Var1, -99, -99, 0, 0, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					}
					break;
				
				case 1:
					func_220(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0);
					break;
				
				case 2:
					func_220(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8);
					break;
				
				case 3:
					func_220(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31);
					break;
				
				case 4:
					func_220(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2);
					break;
				
				case 5:
					func_220(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[0], Global_114135.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
				
				case 6:
					func_220(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 7:
					func_220(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 8:
					func_220(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 9:
					func_220(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 10:
					func_220(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4);
					break;
				
				case 11:
					func_220(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5);
					break;
				
				case 12:
					func_220(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31);
					break;
				
				case 13:
					func_220(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 14:
					func_220(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6);
					break;
				
				case 15:
					func_220(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31);
					break;
				
				case 16:
					func_220(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31);
					break;
				
				case 17:
					func_220(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 18:
					func_220(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7);
					break;
				
				case 19:
					func_220(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 20:
					func_220(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 21:
					func_220(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 22:
					func_220(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 23:
					func_220(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 24:
					func_220(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31);
					break;
				
				case 25:
					func_220(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 26:
					func_220(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 27:
					func_220(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 28:
					func_220(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
				
				case 29:
					func_220(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 30:
					func_220(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 31:
					func_220(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31);
					break;
				
				case 32:
					func_220(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 33:
					func_220(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 34:
					func_220(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31);
					break;
				
				case 35:
					func_220(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 36:
					func_220(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 37:
					func_220(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 38:
					func_220(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 39:
					func_220(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 40:
					func_220(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 41:
					func_220(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 42:
					func_220(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 43:
					func_220(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 44:
					func_220(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 45:
					func_220(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 46:
					func_220(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 47:
					func_220(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 48:
					func_220(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 49:
					func_220(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 50:
					func_220(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9);
					break;
				
				case 51:
					func_220(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 52:
					func_220(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		case joaat("Player_One"):
			...
			{
				case 0:
					func_220(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 1:
					func_220(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
				
				case 2:
					func_220(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[1], Global_114135.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
				
				case 3:
					func_220(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1);
					break;
				
				case 4:
					func_220(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2);
					break;
				
				case 5:
					func_220(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 6:
					func_220(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 7:
					func_220(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3);
					break;
				
				case 8:
					func_220(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5);
					break;
				
				case 9:
					func_220(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 10:
					func_220(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 11:
					func_220(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
				
				case 12:
					func_220(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 13:
					func_220(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 14:
					func_220(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 15:
					func_220(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 16:
					func_220(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 17:
					func_220(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 18:
					func_220(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31);
					break;
				
				case 19:
					func_220(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 20:
					func_220(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 21:
					func_220(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4);
					break;
				
				case 22:
					func_220(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31);
					break;
				
				case 23:
					func_220(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31);
					break;
				
				case 24:
					func_220(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31);
					break;
				
				case 25:
					func_220(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31);
					break;
				
				case 26:
					func_220(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31);
					break;
				
				case 27:
					func_220(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31);
					break;
				
				case 28:
					func_220(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31);
					break;
				
				case 29:
					func_220(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31);
					break;
				
				case 30:
					func_220(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31);
					break;
				
				case 31:
					func_220(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31);
					break;
				
				case 32:
					func_220(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31);
					break;
				
				case 33:
					func_220(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31);
					break;
				
				case 34:
					func_220(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31);
					break;
				
				case 35:
					func_220(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31);
					break;
				
				case 36:
					func_220(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31);
					break;
				
				case 37:
					func_220(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31);
					break;
				
				case 38:
					func_220(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 39:
					func_220(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 40:
					func_220(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 41:
					func_220(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 42:
					func_220(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 43:
					func_220(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6);
					break;
				
				case 44:
					func_220(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7);
					break;
				
				case 45:
					func_220(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8);
					break;
				
				case 46:
					func_220(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31);
					break;
		...
		case joaat("Player_Two"):
			...
			{
				case 0:
					func_220(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 1:
					func_220(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8);
					break;
				
				case 2:
					func_220(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1);
					break;
				
				case 3:
					func_220(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2);
					break;
				
				case 4:
					func_220(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[2], Global_114135.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 5:
					func_220(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6);
					break;
				
				case 6:
					func_220(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3);
					break;
				
				case 7:
					func_220(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4);
					break;
				
				case 8:
					func_220(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31);
					break;
				
				case 9:
					func_220(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 10:
					func_220(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 11:
					func_220(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5);
					break;
				
				case 12:
					func_220(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
				
				case 13:
					func_220(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 14:
					func_220(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31);
					break;
				
				case 15:
					func_220(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 16:
					func_220(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 17:
					func_220(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 18:
					func_220(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 19:
					func_220(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 20:
					func_220(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 21:
					func_220(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 22:
					func_220(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 23:
					func_220(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 24:
					func_220(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 25:
					func_220(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 26:
					func_220(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 27:
					func_220(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 28:
					func_220(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 29:
					func_220(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 30:
					func_220(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 31:
					func_220(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 32:
					func_220(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 33:
					func_220(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 34:
					func_220(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 35:
					func_220(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 36:
					func_220(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 37:
					func_220(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 38:
					func_220(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 39:
					func_220(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 40:
					func_220(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 41:
					func_220(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 42:
					func_220(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 43:
					func_220(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 44:
					func_220(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 45:
					func_220(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7);
					break;
				
				case 46:
					func_220(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 47:
					func_220(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31);
					break;
		...
		case joaat("MP_M_Freemode_01"):
			...
			{
				case 0:
					func_220(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31);
					break;
				
				case 1:
					func_220(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0);
					break;
				
				case 2:
					func_220(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1);
					break;
				
				case 3:
					func_220(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2);
					break;
				
				case 4:
					func_220(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3);
					break;
				
				case 5:
					func_220(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4);
					break;
				
				case 6:
					func_220(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5);
					break;
				
				case 7:
					func_220(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6);
					break;
				
				case 8:
					func_220(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7);
					break;
				
				case 9:
					func_220(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8);
					break;
				
				case 10:
					func_220(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9);
					break;
				
				case 11:
					func_220(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10);
					break;
				
				case 12:
					func_220(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11);
					break;
				
				case 13:
					func_220(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12);
					break;
				
				case 14:
					func_220(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13);
					break;
				
				case 15:
					func_220(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14);
					break;
				
				case 16:
					func_220(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15);
					break;
				
				case 17:
					func_220(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16);
					break;
				
				case 18:
					func_220(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17);
					break;
				
				case 19:
					func_220(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18);
					break;
				
				case 20:
					func_220(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19);
					break;
				
				case 21:
					func_220(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20);
					break;
				
				case 22:
					func_220(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21);
					break;
				
				case 23:
					func_220(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22);
					break;
				
				case 24:
					func_220(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23);
					break;
				
				case 25:
					func_220(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24);
					break;
		...
		case joaat("MP_F_Freemode_01"):
			...
			{
				case 0:
					func_220(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31);
					break;
				
				case 1:
					func_220(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31);
					break;
				
				case 2:
					func_220(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0);
					break;
				
				case 3:
					func_220(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1);
					break;
				
				case 4:
					func_220(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2);
					break;
				
				case 5:
					func_220(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3);
					break;
				
				case 6:
					func_220(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4);
					break;
				
				case 7:
					func_220(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5);
					break;
				
				case 8:
					func_220(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6);
					break;
				
				case 9:
					func_220(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7);
					break;
				
				case 10:
					func_220(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8);
					break;
				
				case 11:
					func_220(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9);
					break;
				
				case 12:
					func_220(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10);
					break;
				
				case 13:
					func_220(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31);
					break;
				
				case 14:
					func_220(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11);
					break;
				
				case 15:
					func_220(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12);
					break;
				
				case 16:
					func_220(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13);
					break;
				
				case 17:
					func_220(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14);
					break;
				
				case 18:
					func_220(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15);
					break;
				
				case 19:
					func_220(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16);
					break;
				
				case 20:
					func_220(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17);
					break;
				
				case 21:
					func_220(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31);
					break;
				
				case 22:
					func_220(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18);
					break;
				
				case 23:
					func_220(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19);
					break;
				
				case 24:
					func_220(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20);
					break;
				
				case 25:
					func_220(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21);
					break;
				
				case 26:
					func_220(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22);
					break;
				
				case 27:
					func_220(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23);
					break;
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_219(Var16.f_2)] = Var16.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_219(Var16.f_2)] = func_202(iParam1, Var16.f_0, func_219(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
					(*uParam0)[func_219(Var16.f_2)] = Var16.f_1;
				}
			}
			iVar36++;
		}
...
void func_223(int iParam0)//Position - 0x18059
{
	...
	func_224(&(Global_79322[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_224(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x18214
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_229(Global_2883588, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_229(Global_2883588, 2, 1, 1, -1))
			{
	...
	else if (uParam0->f_5 >= 0 && uParam0->f_5 < 3)
	{
		MISC::SET_BIT(&(uParam0->f_6), 0);
		MISC::SET_BIT(&(uParam0->f_6), 5);
		if (func_228(iParam1, uParam0->f_5, uParam0->f_2, 0, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 1);
		}
		if (func_228(iParam1, uParam0->f_5, uParam0->f_2, 1, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 2);
		}
		if (!func_228(iParam1, uParam0->f_5, uParam0->f_2, 2, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 4);
		}
	}
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_92(func_227(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_92(func_226(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			if (func_225(iParam1, uParam0->f_2, &iVar1))
			{
				uVar0 = func_92(iVar1, Global_79319);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_228(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x191B1
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_229(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x1A054
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	if (func_230(iParam0, iParam1, &iVar2, &uVar1, bParam2, bParam3))
	{
...
void func_233(int iParam0, int iParam1)//Position - 0x1CE13
{
	...
	func_234(iVar0, iParam0, 0, iParam1);
}
...
void func_234(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1CE33
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_224(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_224(&(Global_79322[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_224(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79520)
		{
			...
			func_224(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_194(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_235(int iParam0, int iParam1)//Position - 0x1D0BA
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 4;
			func_234(iVar10, iParam0, 9, iParam1);
			return;
			break;
	}
	...
	func_224(&(Global_79322[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_236(int iParam0, int iParam1)//Position - 0x1D1BD
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 4;
			func_234(iVar10, iParam0, 28, iParam1);
			return;
			break;
	}
	func_224(&(Global_79322[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
...
void func_237(int iParam0, int iParam1)//Position - 0x1D49C
{
	...
	{
		Global_79322[0 /*14*/].f_5 = 4;
		func_234(iVar10, iParam0, 327, iParam1);
...
void func_238(int iParam0, int iParam1)//Position - 0x20272
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 4;
			func_234(iVar10, iParam0, 6, iParam1);
			return;
			break;
	}
	func_224(&(Global_79322[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
...
void func_239(int iParam0, int iParam1)//Position - 0x20377
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 4;
			func_234(iVar10, iParam0, 55, iParam1);
			if (Global_79322[0 /*14*/].f_7 > 0)
			{
...
void func_240(int iParam0, int iParam1)//Position - 0x20B53
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 4;
			func_234(iVar10, iParam0, 26, iParam1);
			if (Global_79322[0 /*14*/].f_7 > 0)
			{
...
void func_241(int iParam0, int iParam1)//Position - 0x20E38
{
	...
	{
		Global_79322[0 /*14*/].f_5 = 4;
		func_234(iVar10, iParam0, 256, iParam1);
		if (Global_79322[0 /*14*/].f_7 > 0)
		{
...
void func_243(int iParam0, int iParam1)//Position - 0x23ABE
{
	...
	{
		Global_79322[0 /*14*/].f_5 = 4;
		func_234(iVar10, iParam0, 16, iParam1);
		return;
	}
	func_224(&(Global_79322[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_244(int iParam0, int iParam1)//Position - 0x23C19
{
	...
	{
		Global_79322[0 /*14*/].f_5 = 4;
		func_234(iVar10, iParam0, 36, iParam1);
		return;
	}
	func_224(&(Global_79322[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_245(int iParam0, int iParam1)//Position - 0x23E99
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 4;
			func_234(iVar10, iParam0, 136, iParam1);
			if (Global_79322[0 /*14*/].f_7 > 0)
			{
...
int func_246(int iParam0, int iParam1)//Position - 0x25384
{
	var uVar0;
	int iVar1;
...
var func_247(var uParam0, int iParam1)//Position - 0x253B3
{
	var uVar0;
	
	uVar0 = func_92(func_248(uParam0), iParam1);
	return uVar0;
}

int func_248(var uParam0)//Position - 0x253CB
{
	int iVar0;
	int iVar1;
...
void func_250(int iParam0, int iParam1)//Position - 0x26EAB
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 4;
			func_234(iVar10, iParam0, 92, iParam1);
			return;
			break;
	}
...
void func_257(int iParam0, int iParam1)//Position - 0x2B1E6
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 3;
			func_234(iVar10, iParam0, 7, iParam1);
			return;
			break;
	}
	func_224(&(Global_79322[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
...
void func_263(int iParam0, int iParam1)//Position - 0x2EC7F
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 3;
			func_234(iVar10, iParam0, 46, iParam1);
			return;
			break;
	}
	func_224(&(Global_79322[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
...
void func_264(int iParam0, int iParam1)//Position - 0x2EF9B
{
	...
	{
		Global_79322[0 /*14*/].f_5 = 3;
		func_234(iVar10, iParam0, 241, iParam1);
		if (Global_79322[0 /*14*/].f_7 > 0)
		{
...
void func_265(int iParam0, int iParam1)//Position - 0x3148D
{
	...
	{
		Global_79322[0 /*14*/].f_5 = 3;
		func_234(iVar10, iParam0, 237, iParam1);
		if (Global_79322[0 /*14*/].f_7 > 0)
		{
			Global_79322[0 /*14*/].f_7 = SYSTEM::ROUND((SYSTEM::TO_FLOAT(Global_79322[0 /*14*/].f_7) * Global_298510.f_10));
		}
...
void func_266(int iParam0, int iParam1)//Position - 0x32A18
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_79322[0 /*14*/].f_5 = 3;
			func_234(iVar10, iParam0, 91, iParam1);
			return;
			break;
	}
...
int func_268(int iParam0)//Position - 0x3394B
{
	int iVar0;
	
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
	{
		iVar0 = Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_97.f_28;
		if (iVar0 != -1 && iVar0 < 4)
		{
			if (func_269(iVar0) != -1 && func_269(iVar0) != 0)
			{
				return 1;
			}
		}
...
int func_270(bool bParam0)//Position - 0x339FE
{
...
var func_274(bool bParam0)//Position - 0x33A8F
{
	if (bParam0)
	{
		return (BitTest(Global_4718592.f_180429, 12) && func_275());
	}
	return BitTest(Global_4718592.f_180429, 12);
}

int func_275()//Position - 0x33AC5
{
...
int func_276(int iParam0, bool bParam1)//Position - 0x33AF3
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (ENTITY::GET_ENTITY_MODEL(iParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			switch (iVar0)
			{
				...
				case 1:
					switch (iVar1)
					{
						...
						case 7:
						case 12:
							iVar2 = func_277(joaat("MP_M_Freemode_01"), 11, func_196(iParam0, 11, -1), 0);
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_118(PLAYER::PLAYER_ID(), 1) && Global_1887549[PLAYER::PLAYER_ID() /*611*/].f_10.f_76.f_21 != 0)
						{
							return 1;
						}
					}
			...
			switch (iVar0)
			{
				...
				default:
					if (iVar0 > 15)
					{
						iVar5 = func_196(iParam0, 8, -1);
						if (iVar5 >= 241)
						{
							iVar6 = func_192(joaat("MP_M_Freemode_01"), iVar5, 8, 3);
			...
			switch (iVar0)
			{
				case 0:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar7 = func_277(joaat("MP_F_Freemode_01"), 11, func_196(iParam0, 11, -1), 0);
				...
				default:
					if (iVar0 > 15)
					{
						iVar8 = func_196(iParam0, 11, -1);
						if (iVar8 >= 256)
						{
							iVar9 = func_192(joaat("MP_F_Freemode_01"), iVar8, 11, 4);
			...
			switch (iVar0)
			{
				case 0:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar10 = func_277(joaat("MP_F_Freemode_01"), 11, func_196(iParam0, 11, -1), 0);
				...
				case 1:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar11 = func_277(joaat("MP_F_Freemode_01"), 11, func_196(iParam0, 11, -1), 0);
				...
				default:
					if (iVar0 > 15)
					{
						iVar12 = func_196(iParam0, 8, -1);
						if (iVar12 >= 136)
						{
							iVar13 = func_192(joaat("MP_F_Freemode_01"), iVar12, 8, 4);
...
int func_277(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3432D
{
	...
	if (iParam0 == joaat("MP_M_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				iVar0 = func_192(iParam0, iParam2, 11, 3);
				if (iVar0 != -1)
				{
		...
		else if (iParam1 == 8)
		{
			...
			{
				iVar6 = func_192(iParam0, iParam2, 8, 3);
				if (iVar6 != -1)
				{
	...
	else if (iParam0 == joaat("MP_F_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				iVar12 = func_192(iParam0, iParam2, 11, 4);
				if (iVar12 != -1)
				{
		...
		else if (iParam1 == 8)
		{
			...
			{
				iVar18 = func_192(iParam0, iParam2, 8, 4);
				if (iVar18 != -1)
				{
...
int func_283(int iParam0, bool bParam1)//Position - 0x34C17
{
	if (!func_11(iParam0))
	{
		return 0;
...
int func_284(int iParam0)//Position - 0x34C4F
{
	if (func_11(iParam0))
	{
		if (func_11(Global_1887549[iParam0 /*611*/].f_10))
...
int func_285()//Position - 0x34C84
{
	...
	if (func_282(1))
	{
		iVar0 = PLAYER::GET_PLAYER_PED(func_281());
	}
	return iVar0;
}

int func_286(int iParam0, bool bParam1, int iParam2)//Position - 0x34CA6
{
...
int func_294()//Position - 0x34E31
{
	...
	if (func_295() != 0)
	{
		if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(func_295()) == 0)
		{
			return 1;
		}
	}
...
int func_298(int iParam0)//Position - 0x34F1B
{
...
{
	return func_306(PLAYER::PLAYER_PED_ID());
}

int func_306(int iParam0)//Position - 0x35057
{
	int iVar0;
	int iVar1;
...
void func_307(int iParam0, bool bParam1, int iParam2)//Position - 0x35127
{
	if (iParam2 == -1)
	{
		iParam2 = func_10();
...
void func_308(var uParam0, struct<3> Param1, struct<3> Param4, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x35145
{
...
void func_309(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x35175
{
	uParam0->f_1 = uParam1;
	uParam0->f_2 = uParam3;
