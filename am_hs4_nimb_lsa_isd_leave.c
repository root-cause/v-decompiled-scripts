...
void func_5()//Position - 0x225
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_16(&Global_2748794))
	{
		if (!func_14(&Global_2748794, 3500, 1) || NETWORK::NETWORK_IS_PLAYER_FADING(PLAYER::PLAYER_ID()))
		{
			if (!func_13())
			{
...
{
	if (BitTest(Global_2748798, iParam0) && NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (!func_14(&(Global_2748799[iParam0 /*2*/]), 3500, 1) || NETWORK::NETWORK_IS_PLAYER_FADING(iParam0))
		{
			if (!func_13())
			{
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					func_12(&(Global_2748799[iParam0 /*2*/]), 1, 0);
				}
		...
		else
		{
			...
			func_53(&(Global_2748799[iParam0 /*2*/]));
			MISC::CLEAR_BIT(&Global_2748798, iParam0);
		}
	}
}
...
int func_21(int iParam0)//Position - 0xB94
{
	int iVar0;
...
void func_22(bool bParam0, int iParam1, int iParam2)//Position - 0xBC5
{
	int iVar0;
	int iVar1;
...
void func_23(int iParam0, bool bParam1)//Position - 0xC95
{
	int iVar0;
...
int func_29(int iParam0)//Position - 0xD6B
{
	if (func_8(iParam0, 0))
	{
		return 1;
...
int func_30()//Position - 0xDAA
{
	return BitTest(Global_2684504, 7);
}

int func_31()//Position - 0xDB8
{
...
void func_37(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xEAC
{
	if (bParam0)
	{
...
int func_39(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x1013
{
	int iVar0;
...
int func_47(int iParam0)//Position - 0x11F8
{
	if (iParam0 == 1)
	{
...
void func_53(var uParam0)//Position - 0x1343
{
	uParam0->f_1 = 0;
}
...
int func_59(int iParam0)//Position - 0x1491
{
...
int func_61(var uParam0)//Position - 0x1518
{
	func_282();
...
int func_62(var uParam0)//Position - 0x157B
{
	func_63();
	if (CAM::IS_SCREEN_FADED_OUT())
	{
...
void func_65(int iParam0)//Position - 0x164A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_66(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8)//Position - 0x16E6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_67()//Position - 0x17CA
{
	return -1;
}

int func_68(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x17D3
{
	int iVar0;
...
int func_72(var uParam0)//Position - 0x1A3D
{
	if (uParam0->f_20 == 0)
	{
		return 1;
...
int func_73()//Position - 0x1ABD
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

char* func_74(bool bParam0, char* sParam1, char* sParam2)//Position - 0x1ACD
{
	if (bParam0)
	{
		return sParam1;
...
void func_81(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x1D95
{
	int iVar0;
	float fVar1;
...
bool func_82(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)//Position - 0x2274
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

bool func_83(int iParam0)//Position - 0x2284
{
	return (func_137(iParam0) && !func_84(iParam0));
}

int func_84(int iParam0)//Position - 0x229E
{
	switch (iParam0)
	{
		case joaat("coureur"):
...
int func_85(int iParam0)//Position - 0x22D3
{
	switch (iParam0)
	{
		case joaat("pounder2"):
...
void func_86(int iParam0)//Position - 0x23DA
{
	struct<3> Var0;
...
void func_87(struct<3> Param0)//Position - 0x2465
{
	struct<4> Var0;
...
var func_88(int iParam0, bool bParam1)//Position - 0x24A6
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_89(int iParam0)//Position - 0x250B
{
	int iVar0;
...
int func_91(int iParam0, int iParam1, bool bParam2)//Position - 0x2556
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_93(int iParam0, var uParam1)//Position - 0x25E5
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_94(uParam1));
}

int func_94(var uParam0)//Position - 0x25FA
{
	int iVar0;
	int iVar1;
...
int func_99(int iParam0, var* uParam1)//Position - 0x2D28
{
	int iVar0;
	int iVar1;
...
int func_100(int iParam0)//Position - 0x2DA5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_101(int iParam0)//Position - 0x2E32
{
	int iVar0;
...
int func_102(int iParam0, int iParam1)//Position - 0x2E8E
{
	func_106();
	...
	func_104(*iParam0, &Global_1943409, &(Global_1943409.f_1), &(Global_1943409.f_4), &(Global_1943409.f_7), &(Global_1943409.f_10));
	...
	{
		if (func_103(iParam0, iParam1, Global_1943409, Global_1943409.f_1, Global_1943409.f_4, Global_1943409.f_7, Global_1943409.f_10, 0, Global_1943409.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
...
bool func_103(var uParam0, int iParam1, int iParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, int iParam13, int iParam14)//Position - 0x3139
{
...
int func_104(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x3162
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		return 0;
...
bool func_105(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x8DA7
{
	if (bParam6)
	{
...
int func_107(int iParam0)//Position - 0x8E67
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
...
int func_108(int iParam0)//Position - 0x8E9F
{
	int iVar0;
...
int func_109(int iParam0, var* uParam1)//Position - 0x8EE7
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_110(int iParam0)//Position - 0x9044
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return 1;
...
int func_111(int iParam0)//Position - 0x936B
{
...
int func_112(int iParam0)//Position - 0x9397
{
...
int func_113(int iParam0)//Position - 0x93B4
{
...
int func_114(int iParam0, int iParam1)//Position - 0x93D7
{
	if (func_11(iParam0))
	{
...
int func_115(int iParam0)//Position - 0x941B
{
	if (func_11(iParam0))
	{
		if (func_114(iParam0, 0))
...
int func_118(int iParam0, bool bParam1)//Position - 0x9466
{
	return func_119(iParam0, bParam1, 1);
}

int func_119(int iParam0, bool bParam1, int iParam2)//Position - 0x9477
{
	int iVar0;
...
int func_120(int iParam0, int iParam1)//Position - 0x94D3
{
	if (func_11(iParam0))
	{
...
int func_121(int iParam0, bool bParam1)//Position - 0x9522
{
	var uVar0;
	int iVar1;
...
int func_124(var uParam0)//Position - 0x95A4
{
	int iVar0;
	int iVar1;
...
int func_126(int iParam0)//Position - 0x95DE
{
	if (iParam0 != func_67())
	{
...
int func_127(int iParam0)//Position - 0x9613
{
	if (iParam0 != func_67())
	{
...
void func_129(int iParam0, int iParam1)//Position - 0x9B5A
{
	int iVar0;
	int iVar1;
...
struct<13> func_134()//Position - 0xA105
{
	struct<13> Var0;
...
int func_135(int iParam0)//Position - 0xA11A
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("deathbike2"):
...
int func_137(int iParam0)//Position - 0xA43C
{
	switch (iParam0)
	{
		case joaat("deity"):
...
void func_138(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0xA4CB
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("casco"))
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_161(iVar0 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_161(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_161(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_161(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					...
					{
						MISC::SET_BIT(&(uParam1->f_77), func_161(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("surfer3"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_161(iVar5));
				}
				iVar5++;
			}
		}
		...
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar6 <= 2)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_161(iVar6));
				}
				iVar6++;
			}
		}
...
int func_139(int iParam0, float fParam1)//Position - 0xABCE
{
	struct<3> Var0;
	float fVar3;
...
int func_140(bool bParam0)//Position - 0xAC3F
{
	if (bParam0)
	{
...
int func_142(var uParam0)//Position - 0xACE8
{
	int iVar0;
...
int func_143(int iParam0)//Position - 0xAD0C
{
	int iVar0;
...
var func_144(int iParam0, int iParam1)//Position - 0xAD2A
{
...
var func_146(var uParam0, var uParam1)//Position - 0xAD56
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_147(int iParam0, var uParam1, var uParam2)//Position - 0xAD79
{
	int iVar0;
	int iVar1;
	...
	if (func_152(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_150(*iParam0, ((*uParam1)[38] - 1)))
	{
...
int func_148(int iParam0)//Position - 0xAF53
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_150(int iParam0, int iParam1)//Position - 0xB084
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_151(int iParam0, int iParam1)//Position - 0xB16D
{
	int iVar0;
...
int func_152(int iParam0, int iParam1)//Position - 0xB1CF
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_153(int iParam0, int iParam1, int iParam2)//Position - 0xB5AE
{
...
int func_154()//Position - 0xB5D2
{
	return 0;
}

void func_155(int iParam0, int iParam1)//Position - 0xB5DB
{
	int iVar0;
	int iVar1;
...
int func_156(int iParam0)//Position - 0xB653
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_158(int iParam0)//Position - 0xB684
{
	int iVar0;
...
int func_159(int iParam0)//Position - 0xB6C9
{
...
int func_160(int iParam0)//Position - 0xB6E9
{
	switch (iParam0)
	{
		case 161:
...
int func_162(int iParam0)//Position - 0xB7EC
{
...
int func_163(int iParam0, int iParam1)//Position - 0xB873
{
	int iVar0;
...
{
	if (func_280(PLAYER::PLAYER_ID(), 0, 0))
	{
		return;
	}
...
void func_168(int iParam0, var uParam1, bool bParam2, int iParam3)//Position - 0xBACC
{
	struct<9> Var0;
	int iVar13;
	bool bVar14;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		bVar14 = func_270(iParam0, 0);
		bVar15 = func_262(iParam0);
		bVar16 = func_185(iParam0, iParam3);
		if (bParam2)
		{
			bVar15 = true;
		}
		...
		while (iVar17 < 127)
		{
			...
			{
				if (func_177(&Var0, iVar17, iVar13, iParam0, -1))
				{
					if (func_170(iParam0, &Var0, iVar17, Var0.f_4, Var0.f_8, bVar14, bVar15, bParam2, bVar16))
					{
		...
		while (iVar18 < iVar19)
		{
			if (FILES::GET_TATTOO_SHOP_DLC_ITEM_DATA(iVar13, iVar18, &Var20))
			{
				if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20.f_0))
				{
					...
					{
						if (func_170(iParam0, &(Var20.f_7), iVar35, Var20.f_2, Var20.f_6, bVar14, bVar15, bParam2, bVar16))
						{
							PED::ADD_PED_DECORATION_FROM_HASHES_IN_CORONA(iParam0, Var20.f_2, Var20.f_3);
							func_169(iParam0, Var20.f_2, Var20.f_3);
						}
					}
				}
			}
...
void func_169(int iParam0, int iParam1, int iParam2)//Position - 0xBC35
{
	switch (iParam1)
	{
...
int func_170(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)//Position - 0xCF10
{
	int iVar0;
	int iVar1;
	...
	if (iParam4 == 0)
	{
		...
		iParam4 = MISC::GET_HASH_KEY(func_175(iVar1));
	}
...
int func_171(int iParam0, int iParam1)//Position - 0xD736
{
	var uVar0;
	int iVar1;
...
int func_174(var uParam0)//Position - 0xD7C6
{
	int iVar0;
	int iVar1;
...
int func_176(int iParam0, char* sParam1, int iParam2)//Position - 0xE1A8
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
bool func_177(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xF1DA
{
	int iVar0;
	int iVar1;
	...
	switch (iParam2)
	{
		...
		case 4:
			...
			{
				case 0:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_008", "multiplayer_overlays", "000", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(20000) * Global_262145.f_2825 /* Tunable: TATTOO_MP_FM_HEAD_BANGER_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 1:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_009", "multiplayer_overlays", "001", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1400) * Global_262145.f_2826 /* Tunable: TATTOO_MP_FM_SLAYER_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 2:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_010", "multiplayer_overlays", "002", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(9750) * Global_262145.f_2827 /* Tunable: TATTOO_MP_FM_GANGHIDEOUT_CLEAR_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 3:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_011", "multiplayer_overlays", "003", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2150) * Global_262145.f_2828 /* Tunable: TATTOO_MP_FM_ARMOURED_VAN_TAKEDOWN_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 4:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_012", "multiplayer_overlays", "004", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2829 /* Tunable: TATTOO_MP_FM_HUSTLER_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 54:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_013", "multiplayer_overlays", "005", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12400) * Global_262145.f_2830 /* Tunable: TATTOO_MP_FM_WIN_EVER_MODE_ONCE_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 5:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_014", "multiplayer_overlays", "006", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3500) * Global_262145.f_2831 /* Tunable: TATTOO_MP_FM_BOUNTY_KILLER_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 6:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_015", "multiplayer_overlays", "007", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4950) * Global_262145.f_2832 /* Tunable: TATTOO_MP_FM_HOLD_WORLD_RECORD_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 55:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_016", "multiplayer_overlays", "008", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1350) * Global_262145.f_2833 /* Tunable: TATTOO_MP_FM_FULL_MODDED_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 7:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_017", "multiplayer_overlays", "009", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1450) * Global_262145.f_2834 /* Tunable: TATTOO_MP_FM_REVENGE_KILL_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 8:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_018", "multiplayer_overlays", "010", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2700) * Global_262145.f_2835 /* Tunable: TATTOO_MP_FM_KILL_3_RACERS_EXPENDITURE_TUNABLE */)), 7);
					break;
				
				case 9:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_019", "multiplayer_overlays", "011", "rank", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1200) * Global_262145.f_2836 /* Tunable: TATTOO_MP_FM_REACH_RANK_1_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 10:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_020", "multiplayer_overlays", "012", "rank", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1500) * Global_262145.f_2837 /* Tunable: TATTOO_MP_FM_REACH_RANK_2_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 11:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_021", "multiplayer_overlays", "013", "rank", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2650) * Global_262145.f_2838 /* Tunable: TATTOO_MP_FM_REACH_RANK_3_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 56:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_022", "multiplayer_overlays", "014", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1900) * Global_262145.f_2839 /* Tunable: TATTOO_MP_FM_FMKILLCHEATER_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 12:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_023", "multiplayer_overlays", "015", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4950) * Global_262145.f_2840 /* Tunable: TATTOO_MP_FM_RACES_WON_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 57:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_024", "multiplayer_overlays", "016", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2400) * Global_262145.f_2841 /* Tunable: TATTOO_MP_FM_HOLD_UP_SHOPS_1_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 58:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_025", "multiplayer_overlays", "017", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5100) * Global_262145.f_2842 /* Tunable: TATTOO_MP_FM_HOLD_UP_SHOPS_2_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 59:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_026", "multiplayer_overlays", "018", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7400) * Global_262145.f_2843 /* Tunable: TATTOO_MP_FM_HOLD_UP_SHOPS_3_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 60:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_027", "multiplayer_overlays", "019", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2844 /* Tunable: TATTOO_MP_FM_HOLD_UP_SHOPS_4_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 17:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_201", "multiplayer_overlays", "005", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2400) * Global_262145.f_2849 /* Tunable: TATTOO_MP_FM_01_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 18:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_202", "multiplayer_overlays", "006", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5100) * Global_262145.f_2850 /* Tunable: TATTOO_MP_FM_02_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 19:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_203", "multiplayer_overlays", "015", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3600) * Global_262145.f_2851 /* Tunable: TATTOO_MP_FM_03_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 20:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_204", "multiplayer_overlays", "000", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2852 /* Tunable: TATTOO_MP_FM_04_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 21:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_205", "multiplayer_overlays", "001", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12500) * Global_262145.f_2853 /* Tunable: TATTOO_MP_FM_05_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 22:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_206", "multiplayer_overlays", "003", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2854 /* Tunable: TATTOO_MP_FM_06_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 23:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_207", "multiplayer_overlays", "014", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2855 /* Tunable: TATTOO_MP_FM_07_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 24:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_208", "multiplayer_overlays", "018", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2856 /* Tunable: TATTOO_MP_FM_08_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 25:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_209", "multiplayer_overlays", "002", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3750) * Global_262145.f_2857 /* Tunable: TATTOO_MP_FM_09_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 26:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_210", "multiplayer_overlays", "007", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3750) * Global_262145.f_2858 /* Tunable: TATTOO_MP_FM_10_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 27:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_211", "multiplayer_overlays", "008", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4800) * Global_262145.f_2859 /* Tunable: TATTOO_MP_FM_11_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 28:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_212", "multiplayer_overlays", "017", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3500) * Global_262145.f_2860 /* Tunable: TATTOO_MP_FM_12_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 61:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_213", "multiplayer_overlays", "009", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12350) * Global_262145.f_2861 /* Tunable: TATTOO_MP_FM_13_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 62:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_214", "multiplayer_overlays", "011", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1900) * Global_262145.f_2862 /* Tunable: TATTOO_MP_FM_14_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 63:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_215", "multiplayer_overlays", "013", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4500) * Global_262145.f_2863 /* Tunable: TATTOO_MP_FM_15_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 64:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_216", "multiplayer_overlays", "016", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12250) * Global_262145.f_2864 /* Tunable: TATTOO_MP_FM_16_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 65:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_217", "multiplayer_overlays", "019", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12300) * Global_262145.f_2865 /* Tunable: TATTOO_MP_FM_17_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 29:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_218", "multiplayer_overlays", "010", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2500) * Global_262145.f_2866 /* Tunable: TATTOO_MP_FM_18_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 30:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_219", "multiplayer_overlays", "004", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2867 /* Tunable: TATTOO_MP_FM_19_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 31:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_220", "multiplayer_overlays", "012", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2868 /* Tunable: TATTOO_MP_FM_20_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 66:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_221", "multiplayer_overlays", "020", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2869 /* Tunable: TATTOO_MP_FM_21_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 32:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_222", "multiplayer_overlays", "021", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2870 /* Tunable: TATTOO_MP_FM_22_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 33:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_223", "multiplayer_overlays", "022", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7300) * Global_262145.f_2871 /* Tunable: TATTOO_MP_FM_23_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 34:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_224", "multiplayer_overlays", "023", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7250) * Global_262145.f_2872 /* Tunable: TATTOO_MP_FM_24_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 35:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_225", "multiplayer_overlays", "024", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(11900) * Global_262145.f_2873 /* Tunable: TATTOO_MP_FM_25_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 36:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_226", "multiplayer_overlays", "025", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2750) * Global_262145.f_2874 /* Tunable: TATTOO_MP_FM_26_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 37:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_227", "multiplayer_overlays", "026", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1750) * Global_262145.f_2875 /* Tunable: TATTOO_MP_FM_27_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 38:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_228", "multiplayer_overlays", "027", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7300) * Global_262145.f_2876 /* Tunable: TATTOO_MP_FM_28_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 39:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_229", "multiplayer_overlays", "028", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3250) * Global_262145.f_2877 /* Tunable: TATTOO_MP_FM_29_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 40:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_230", "multiplayer_overlays", "029", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1000) * Global_262145.f_2878 /* Tunable: TATTOO_MP_FM_30_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 67:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_231", "multiplayer_overlays", "030", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2879 /* Tunable: TATTOO_MP_FM_31_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 41:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_232", "multiplayer_overlays", "031", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2880 /* Tunable: TATTOO_MP_FM_32_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 68:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_233", "multiplayer_overlays", "032", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5100) * Global_262145.f_2881 /* Tunable: TATTOO_MP_FM_33_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 42:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_234", "multiplayer_overlays", "033", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5050) * Global_262145.f_2882 /* Tunable: TATTOO_MP_FM_34_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 43:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_235", "multiplayer_overlays", "034", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2450) * Global_262145.f_2883 /* Tunable: TATTOO_MP_FM_35_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 44:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_236", "multiplayer_overlays", "035", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4950) * Global_262145.f_2884 /* Tunable: TATTOO_MP_FM_36_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 45:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_237", "multiplayer_overlays", "036", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5100) * Global_262145.f_2885 /* Tunable: TATTOO_MP_FM_37_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 46:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_238", "multiplayer_overlays", "037", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12250) * Global_262145.f_2886 /* Tunable: TATTOO_MP_FM_38_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 47:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_239", "multiplayer_overlays", "038", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1150) * Global_262145.f_2887 /* Tunable: TATTOO_MP_FM_39_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 48:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_240", "multiplayer_overlays", "039", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2888 /* Tunable: TATTOO_MP_FM_40_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 49:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_241", "multiplayer_overlays", "040", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7600) * Global_262145.f_2889 /* Tunable: TATTOO_MP_FM_41_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 50:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_242", "multiplayer_overlays", "041", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2600) * Global_262145.f_2890 /* Tunable: TATTOO_MP_FM_42_EXPENDITURE_TUNABLE */)), 2);
					break;
				
				case 51:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_243", "multiplayer_overlays", "042", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2500) * Global_262145.f_2891 /* Tunable: TATTOO_MP_FM_43_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 52:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_244", "multiplayer_overlays", "043", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7450) * Global_262145.f_2892 /* Tunable: TATTOO_MP_FM_44_EXPENDITURE_TUNABLE */)), 3);
					break;
				
				case 53:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_245", "multiplayer_overlays", "044", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2893 /* Tunable: TATTOO_MP_FM_45_EXPENDITURE_TUNABLE */)), 0);
					break;
				
				case 69:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_246", "multiplayer_overlays", "045", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2894 /* Tunable: TATTOO_MP_FM_46_EXPENDITURE_TUNABLE */)), 1);
					break;
				
				case 70:
					func_184(sParam0, iParam1, iParam3, "TAT_FM_247", "multiplayer_overlays", "047", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2500) * Global_262145.f_2895 /* Tunable: TATTOO_MP_FM_47_EXPENDITURE_TUNABLE */)), 2);
					break;
			}
			if (iVar0 == joaat("MP_M_Freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_184(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_000", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2896 /* Tunable: TSHIRT_TRANS_MP_FM_REDSKULL_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 88:
						func_184(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_001", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2897 /* Tunable: TSHIRT_TRANS_MP_FM_LSBELLE_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 89:
						func_184(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_002", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2898 /* Tunable: TSHIRT_TRANS_MP_FM_ROCKSTAR_EXPENDITURE_TUNABLE */)), 0);
						break;
					...
					case 13:
						func_184(sParam0, iParam1, iParam3, "TAT_FM_100" /* GXT: Crew Emblem Small */, "multiplayer_overlays", "000_A", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2845 /* Tunable: TATTOO_MP_FM_CREW_A_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 14:
						func_184(sParam0, iParam1, iParam3, "TAT_FM_101" /* GXT: Crew Emblem Large */, "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2846 /* Tunable: TATTOO_MP_FM_CREW_B_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 15:
						func_184(sParam0, iParam1, iParam3, "TAT_FMM_CLB" /* GXT: Crew Emblem Back */, "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2847 /* Tunable: TATTOO_MP_FM_CREW_C_EXPENDITURE_TUNABLE */)), 2);
						break;
					
					case 16:
						func_184(sParam0, iParam1, iParam3, "TAT_FM_100" /* GXT: Crew Emblem Small */, "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2848 /* Tunable: TATTOO_MP_FM_CREW_D_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 71:
						func_184(sParam0, iParam1, iParam3, "TAT_FM_101" /* GXT: Crew Emblem Large */, "multiplayer_overlays", "000_E", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2848 /* Tunable: TATTOO_MP_FM_CREW_D_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 72:
						func_184(sParam0, iParam1, iParam3, "TAT_FMM_CLB" /* GXT: Crew Emblem Back */, "multiplayer_overlays", "000_F", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2848 /* Tunable: TATTOO_MP_FM_CREW_D_EXPENDITURE_TUNABLE */)), 0);
						break;
				}
			}
			else if (iVar0 == joaat("MP_F_Freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_184(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_000", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2896 /* Tunable: TSHIRT_TRANS_MP_FM_REDSKULL_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 88:
						func_184(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_001", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2897 /* Tunable: TSHIRT_TRANS_MP_FM_LSBELLE_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 89:
						func_184(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_002", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2898 /* Tunable: TSHIRT_TRANS_MP_FM_ROCKSTAR_EXPENDITURE_TUNABLE */)), 0);
						break;
					...
					case 14:
						func_184(sParam0, iParam1, iParam3, "TAT_FM_100" /* GXT: Crew Emblem Small */, "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2846 /* Tunable: TATTOO_MP_FM_CREW_B_EXPENDITURE_TUNABLE */)), 0);
						break;
					
					case 15:
						func_184(sParam0, iParam1, iParam3, "TAT_FM_101" /* GXT: Crew Emblem Large */, "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2847 /* Tunable: TATTOO_MP_FM_CREW_C_EXPENDITURE_TUNABLE */)), 2);
						break;
					
					case 16:
						func_184(sParam0, iParam1, iParam3, "TAT_FM_101" /* GXT: Crew Emblem Large */, "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2848 /* Tunable: TATTOO_MP_FM_CREW_D_EXPENDITURE_TUNABLE */)), 0);
						break;
					}
			}
			break;
...
void func_184(char* sParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9)//Position - 0x124CA
{
	char cVar0[32];
...
int func_185(int iParam0, int iParam1)//Position - 0x1277F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_186(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x12A3F
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else if (iParam2 == 14)
	{
		...
		iVar17 = (iParam1 - func_189(iParam0));
		if (iVar17 < 0)
		{
			return -1;
		}
	...
	else
	{
		...
		iVar36 = (iParam1 - func_187(iParam0, func_188(iParam2)));
		if (iVar36 < 0)
		{
			return -1;
		}
		...
		iVar37 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_188(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_187(int iParam0, int iParam1)//Position - 0x12B59
{
	switch (iParam0)
	{
...
int func_188(int iParam0)//Position - 0x12F00
{
	switch (iParam0)
	{
		case 0:
...
int func_189(int iParam0)//Position - 0x12FB0
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_190(int iParam0, int iParam1, int iParam2)//Position - 0x13011
{
	int iVar0;
	int iVar1;
...
int func_191(int iParam0, int iParam1)//Position - 0x130B2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_192(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x13112
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_193(int iParam0, int iParam1)//Position - 0x13169
{
	int iVar0;
	int iVar1;
...
int func_194(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x131B0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_195(int iParam0, int iParam1)//Position - 0x132AC
{
	int iVar0;
...
int func_196(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x133EA
{
	struct<2> Var0;
	int iVar15;
	int iVar16;
	...
	if (iParam2 == 12)
	{
		...
		while (iVar15 < iVar16)
		{
			...
			if (Var0.f_1 == iParam1)
			{
				return (func_197(iParam0) + iVar15);
			}
			iVar15++;
		}
	}
	...
	else if (iParam2 == 14)
	{
		...
		if (iVar17 != -1)
		{
			return (func_189(iParam0) + iVar17);
		}
	}
	else
	{
		...
		if (iVar18 != -1)
		{
			return (func_187(iParam0, func_188(iParam2)) + iVar18);
		}
	}
	return -99;
}

int func_197(int iParam0)//Position - 0x134A5
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_198(int iParam0)//Position - 0x13504
{
	switch (iParam0)
	{
		case 0:
...
int func_199(int iParam0, int iParam1, int iParam2)//Position - 0x1358A
{
	int iVar0;
	int iVar1;
	var uVar2;
		...
		while (iVar7 < 7)
		{
			...
			if (uVar8[iVar4] != -99)
			{
				if (!func_199(iParam0, iVar4, uVar8[iVar4]))
				{
					...
					if (iVar4 == 13)
					{
						uVar25 = { func_208(iVar0, uVar8[iVar4]) };
						iVar5 = 0;
						while (iVar5 <= 8)
						{
							if (!func_199(iParam0, 14, uVar25[iVar5]))
							{
								iVar6 = 0;
								while (iVar6 <= 19)
								{
	...
	{
		uVar36 = { func_208(iVar0, iParam2) };
		iVar35 = 0;
		while (iVar35 <= 8)
		{
			if (!func_199(iParam0, 14, uVar36[iVar35]))
			{
				return 0;
			}
			iVar35++;
	...
	else if (iParam1 == 14)
	{
		...
		if (((Global_79172[1 /*14*/].f_12 == 0 && BitTest(Global_79172[1 /*14*/].f_6, 6)) && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Global_2883588, joaat("HELMET"), 1)) && FILES::GET_SHOP_PED_APPAREL_VARIANT_PROP_COUNT(Global_2883588) > 0)
		{
			...
			while (iVar46 < iVar50)
			{
				...
				if (iVar47 != 0 && iVar47 != joaat("0"))
				{
					...
					if (Var51.f_3 == PED::GET_PED_PROP_INDEX(iParam0, Global_79172[1 /*14*/].f_12, 1) && Var51.f_4 == PED::GET_PED_PROP_TEXTURE_INDEX(iParam0, Global_79172[1 /*14*/].f_12))
					{
						return 1;
					}
				}
	...
	{
		if (Global_79172[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_188(iParam1)) && Global_79172[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_188(iParam1)))
		{
			return 1;
		}
		if (iParam1 == 4)
		{
			...
			if (Global_79171 == 1)
			{
				...
				{
					if (func_201(iVar0, 4, iParam2, &uVar68))
					{
						return func_199(iParam0, 4, uVar68);
					}
				}
				else if (func_200(iVar0, 4, iParam2, &uVar68))
				{
					return func_199(iParam0, 4, uVar68);
				}
			}
...
int func_200(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x139E5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_201(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x13A8E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_202(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x13B36
{
	switch (iParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
int func_203(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x13B89
{
	var uVar0;
	int iVar10;
...
int func_204(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1418E
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_186(iParam0, iParam2, 14, 3), joaat("HAT_MENU"), 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_186(iParam0, iParam2, 1, 3), joaat("HAT_MENU"), 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_186(iParam0, iParam2, 14, 4), joaat("HAT_MENU"), 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_186(iParam0, iParam2, 1, 4), joaat("HAT_MENU"), 0));
					}
					break;
			}
			break;
...
int func_205(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1440B
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_206(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x14830
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_207(int iParam0, int iParam1, int iParam2)//Position - 0x14B23
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_208(int iParam0, int iParam1)//Position - 0x14BBC
{
	int iVar0;
	struct<10> Var1;
...
void func_209(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x154EB
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1.f_0))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_196(iParam1, Var16.f_0, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
...
void func_210(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x15615
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_211(int iParam0, int iParam1)//Position - 0x1565D
{
	int iVar0;
	struct<17> Var1;
...
void func_212(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x174A5
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_213(Var16.f_2)] = Var16.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_213(Var16.f_2)] = func_196(iParam1, Var16.f_0, func_213(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
					(*uParam0)[func_213(Var16.f_2)] = Var16.f_1;
				}
			}
			iVar36++;
		}
...
struct<14> func_215(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x177B0
{
	func_261();
	if (iParam0 == joaat("MP_M_Freemode_01"))
	{
...
void func_216(int iParam0, int iParam1, int iParam2)//Position - 0x177F1
{
	switch (iParam0)
	{
		case 2:
...
void func_217(int iParam0)//Position - 0x178FD
{
	...
	func_218(&(Global_79172[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_218(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x17AB8
{
	var uVar0;
	int iVar1;
...
int func_222(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x18A65
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_223(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x19908
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_224(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x19946
{
	int iVar0;
...
void func_227(int iParam0, int iParam1)//Position - 0x1C5EB
{
	int iVar0;
...
void func_228(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1C60B
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_218(&(Global_79172[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_218(&(Global_79172[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_188(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_229(int iParam0, int iParam1)//Position - 0x1C892
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_218(&(Global_79172[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_230(int iParam0, int iParam1)//Position - 0x1C995
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_231(int iParam0, int iParam1)//Position - 0x1CC74
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_232(int iParam0, int iParam1)//Position - 0x1FA49
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_233(int iParam0, int iParam1)//Position - 0x1FB4E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_234(int iParam0, int iParam1)//Position - 0x2032B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_235(int iParam0, int iParam1)//Position - 0x20610
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_236(int iParam0, int iParam1)//Position - 0x21C37
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_237(int iParam0, int iParam1)//Position - 0x23296
{
	bool bVar0;
	int iVar1;
	char* sVar2;
...
void func_238(int iParam0, int iParam1)//Position - 0x233F1
{
	bool bVar0;
	int iVar1;
	char* sVar2;
	...
	{
		Global_79172[0 /*14*/].f_5 = 4;
		func_228(iVar10, iParam0, 36, iParam1);
		return;
	}
	func_218(&(Global_79172[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_239(int iParam0, int iParam1)//Position - 0x23671
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79172[0 /*14*/].f_5 = 4;
			func_228(iVar10, iParam0, 136, iParam1);
			if (Global_79172[0 /*14*/].f_7 > 0)
			{
...
int func_240(int iParam0, int iParam1)//Position - 0x24A14
{
	var uVar0;
	int iVar1;
...
var func_241(var uParam0, int iParam1)//Position - 0x24A43
{
	var uVar0;
...
int func_242(var uParam0)//Position - 0x24A5B
{
	int iVar0;
	int iVar1;
...
void func_243(int iParam0, int iParam1)//Position - 0x24DD6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_244(int iParam0, int iParam1)//Position - 0x2653B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79172[0 /*14*/].f_5 = 4;
			func_228(iVar10, iParam0, 92, iParam1);
			return;
			break;
	}
...
void func_245(int iParam0, int iParam1, int iParam2)//Position - 0x2740C
{
	switch (iParam0)
	{
		case 2:
...
void func_247(int iParam0, int iParam1)//Position - 0x276E2
{
	int iVar0;
...
void func_248(int iParam0, int iParam1)//Position - 0x27702
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_249(int iParam0, int iParam1)//Position - 0x27805
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_250(int iParam0, int iParam1)//Position - 0x27AB6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_251(int iParam0, int iParam1)//Position - 0x2A877
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79172[0 /*14*/].f_5 = 3;
			func_228(iVar10, iParam0, 7, iParam1);
			return;
			break;
	}
	func_218(&(Global_79172[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
...
void func_252(int iParam0, int iParam1)//Position - 0x2A998
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_253(int iParam0, int iParam1)//Position - 0x2B290
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_254(int iParam0, int iParam1)//Position - 0x2B547
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_255(int iParam0, int iParam1)//Position - 0x2CBA7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_256(int iParam0, int iParam1)//Position - 0x2E1DA
{
	bool bVar0;
	int iVar1;
	char* sVar2;
...
void func_257(int iParam0, int iParam1)//Position - 0x2E331
{
	bool bVar0;
	int iVar1;
	char* sVar2;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79172[0 /*14*/].f_5 = 3;
			func_228(iVar10, iParam0, 46, iParam1);
			return;
			break;
	}
	func_218(&(Global_79172[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
...
void func_258(int iParam0, int iParam1)//Position - 0x2E64D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	{
		Global_79172[0 /*14*/].f_5 = 3;
		func_228(iVar10, iParam0, 241, iParam1);
		if (Global_79172[0 /*14*/].f_7 > 0)
		{
...
void func_259(int iParam0, int iParam1)//Position - 0x30B40
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	{
		Global_79172[0 /*14*/].f_5 = 3;
		func_228(iVar10, iParam0, 237, iParam1);
		if (Global_79172[0 /*14*/].f_7 > 0)
		{
			Global_79172[0 /*14*/].f_7 = SYSTEM::ROUND((SYSTEM::TO_FLOAT(Global_79172[0 /*14*/].f_7) * Global_298067.f_10));
		}
...
void func_260(int iParam0, int iParam1)//Position - 0x320CB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79172[0 /*14*/].f_5 = 3;
			func_228(iVar10, iParam0, 91, iParam1);
			return;
			break;
	}
...
int func_262(int iParam0)//Position - 0x32FFE
{
	int iVar0;
	
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
	{
		iVar0 = Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_97.f_28;
		if (iVar0 != -1 && iVar0 < 4)
		{
...
int func_264(bool bParam0)//Position - 0x330B1
{
...
var func_268(bool bParam0)//Position - 0x33142
{
	if (bParam0)
	{
...
int func_270(int iParam0, bool bParam1)//Position - 0x331A6
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			switch (iVar0)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_118(PLAYER::PLAYER_ID(), 1) && Global_1887305[PLAYER::PLAYER_ID() /*610*/].f_10.f_76.f_21 != 0)
						{
							return 1;
						}
					}
...
int func_271(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x339E0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_272(int iParam0, int iParam1)//Position - 0x34203
{
	int iVar0;
...
int func_273(int iParam0)//Position - 0x34225
{
...
int func_277(int iParam0, bool bParam1)//Position - 0x342CD
{
	if (!func_11(iParam0))
	{
		return 0;
...
int func_278(int iParam0)//Position - 0x34305
{
	if (func_11(iParam0))
	{
		if (func_11(Global_1887305[iParam0 /*610*/].f_10))
...
int func_279()//Position - 0x3433A
{
	...
	if (func_276(1))
	{
		iVar0 = PLAYER::GET_PLAYER_PED(func_275());
	}
	return iVar0;
}

int func_280(int iParam0, bool bParam1, int iParam2)//Position - 0x3435C
{
...
int func_288()//Position - 0x344E7
{
	...
	if (func_289() != 0)
	{
		if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(func_289()) == 0)
		{
			return 1;
		}
	}
...
int func_292(int iParam0)//Position - 0x345D1
{
...
int func_300(int iParam0)//Position - 0x3470D
{
	int iVar0;
	int iVar1;
...
void func_301(int iParam0, bool bParam1, int iParam2)//Position - 0x347DD
{
	if (iParam2 == -1)
	{
		iParam2 = func_10();
...
void func_302(var uParam0, struct<3> Param1, struct<3> Param4, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x347FB
{
...
void func_303(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x3482B
{
	uParam0->f_1 = uParam1;
	uParam0->f_2 = uParam3;
