...
void __EntryFunction__()//Position - 0x0
{
	...
	if (!func_340())
	{
		if ((func_322(Local_80.f_28[0]) && func_322(PLAYER::PLAYER_PED_ID())) && !func_321(PLAYER::PLAYER_PED_ID(), Local_80.f_28[0], 4f, 1))
		{
			iLocal_381 = 1;
		}
	}
	while (true)
	{
		...
		func_304(Local_80.f_9, 0, 0, 0, 0, 0);
		...
		{
			if (func_322(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1668.8821f, -19.652481f, 172.67476f, 1653.8553f, 8.008027f, 175.02478f, 7f, false, true, 0))
			{
				if (func_322(Local_153.f_0))
				{
					if (func_321(PLAYER::PLAYER_PED_ID(), Local_153.f_0, 10f, 1))
					{
						func_302();
					}
				}
	...
	switch (iLocal_147)
	{
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_176))
			{
				...
				{
					if (func_321(PLAYER::PLAYER_PED_ID(), iLocal_176, 1f, 1))
					{
...
void func_76(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x5D0D
{
	int iVar0;
...
int func_77(int iParam0, var uParam1)//Position - 0x5D30
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_78(uParam1));
}

int func_78(var uParam0)//Position - 0x5D45
{
	int iVar0;
	int iVar1;
...
int func_79(int iParam0, int iParam1)//Position - 0x5D79
{
	int iVar0;
	var uVar1;
...
bool func_80(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x5DA8
{
	int iVar0;
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x87A7
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_82(int iParam0)//Position - 0x964A
{
	if (!BitTest(Global_78472[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9692
{
	int iVar0;
...
int func_84(int iParam0)//Position - 0x973D
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_85(int iParam0, int iParam1)//Position - 0x97ED
{
	int iVar0;
	struct<10> Var1;
...
void func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA11C
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_87(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xA246
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_88(int iParam0, int iParam1)//Position - 0xA28E
{
	int iVar0;
	struct<17> Var1;
...
void func_89(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC0D7
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
int func_90(int iParam0)//Position - 0xC2C1
{
	switch (iParam0)
	{
		case 0:
...
void func_91(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xC371
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_92(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC3E2
{
	func_156();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_93(int iParam0, int iParam1)//Position - 0xC434
{
	switch (iParam0)
	{
		case 0:
...
void func_94(int iParam0)//Position - 0xC524
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_95(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD751
{
	var uVar0;
	int iVar1;
...
bool func_96(int iParam0, int iParam1, var uParam2)//Position - 0xDAF2
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_97(int iParam0, int iParam1)//Position - 0xDEF7
{
	switch (iParam1)
	{
		case 0:
...
int func_98(int iParam0, int iParam1)//Position - 0xE2F2
{
	switch (iParam1)
	{
		case 0:
...
int func_99(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE6ED
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_100(int iParam0)//Position - 0xE72B
{
	return Global_43377 == iParam0;
}

int func_101(int iParam0)//Position - 0xE739
{
	switch (iParam0)
	{
		case -1:
...
void func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE80D
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_103(int iParam0)//Position - 0xEA93
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_104(int iParam0)//Position - 0xEBE0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0xF0ED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(int iParam0)//Position - 0xF161
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0)//Position - 0xF1D4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0xF2BB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0)//Position - 0xF5FD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0)//Position - 0xF805
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0xFA25
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0xFB2E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0x104C0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x11018
{
	if (iParam0 < 136)
	{
		func_116(iParam0);
...
void func_115(int iParam0)//Position - 0x1104D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x11C51
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0x12B51
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x12C7E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0, int iParam1)//Position - 0x12D75
{
	switch (iParam0)
	{
		case 0:
...
void func_120(int iParam0)//Position - 0x12E65
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0x14333
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0x1447A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0x14984
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0x14FED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0x15060
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x15130
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0x1562B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x157BC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0x15FAB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x160B4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x16FD7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x17C84
{
	if (iParam0 < 107)
	{
		func_135(iParam0);
...
void func_133(int iParam0)//Position - 0x17CCA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x1876F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x1955D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x1A19C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x1A414
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0, int iParam1)//Position - 0x1A550
{
	switch (iParam0)
	{
		case 0:
...
void func_139(int iParam0)//Position - 0x1A640
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x1B39E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x1B50D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x1BA7E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x1BFA6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x1C01A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x1C0EA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x1C59A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x1C7F5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x1CAB5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x1CC70
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x1D7B6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1E3E8
{
	if (iParam0 < 60)
	{
		func_153(iParam0);
...
void func_152(int iParam0)//Position - 0x1E41D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1F1B0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1F832
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1F918
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156()//Position - 0x1FA0F
{
...
int func_157(int iParam0, int iParam1, int iParam2)//Position - 0x1FA87
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_158(int iParam0)//Position - 0x1FCE0
{
	int iVar0;
	int iVar1;
...
int func_159(int iParam0)//Position - 0x1FD1D
{
	if (func_161(iParam0))
	{
...
var func_160(int iParam0)//Position - 0x1FD42
{
	return Global_2058[iParam0 /*29*/];
}

bool func_161(int iParam0)//Position - 0x1FD51
{
	return iParam0 < 3;
}

void func_162(char* sParam0, var uParam1)//Position - 0x1FD5D
{
...
void func_164()//Position - 0x1FDF4
{
	int iVar0;
...
struct<2> func_165(int iParam0)//Position - 0x1FEF1
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_166(int iParam0)//Position - 0x1FF28
{
	struct<2> Var0;
...
void func_167(int iParam0, int iParam1)//Position - 0x2043E
{
...
void func_168(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x20488
{
...
void func_169(int iParam0, bool bParam1, bool bParam2)//Position - 0x20525
{
	struct<4> Var0;
	char* sVar32;
...
void func_170(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x20564
{
...
void func_171(int iParam0, var uParam1)//Position - 0x205A8
{
	switch (iParam0)
	{
		case 0:
...
int func_173(int iParam0)//Position - 0x217EE
{
	switch (iParam0)
	{
		case 0:
...
void func_174(int iParam0)//Position - 0x21B34
{
	Global_43928 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_175()//Position - 0x21B46
{
	if (Global_98125)
	{
		func_164();
...
char* func_176(var uParam0)//Position - 0x21B78
{
	uParam0 = uParam0;
	return "";
}

void func_177()//Position - 0x21B87
{
	char cVar0[24];
...
bool func_178()//Position - 0x21BCA
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_179()//Position - 0x21BE0
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_180(int iParam0, int iParam1)//Position - 0x21BF6
{
	Global_98120 = iParam0;
	Global_98121 = iParam1;
}

void func_181()//Position - 0x21C0A
{
	if (Global_78944 != 6)
	{
	}
...
void func_182(var uParam0)//Position - 0x21C42
{
	if (*uParam0 == -1)
	{
		return;
...
void func_183(int iParam0, bool bParam1)//Position - 0x21C7F
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_184(int iParam0)//Position - 0x21DFC
{
	switch (iParam0)
	{
		case 0:
...
void func_185(int iParam0)//Position - 0x22183
{
	func_187(iParam0, 1);
...
int func_186()//Position - 0x221B9
{
	return (Global_113810.f_10019.f_21 + Global_113810.f_18577.f_380);
}

void func_187(var uParam0, bool bParam1)//Position - 0x221D5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_188(int iParam0)//Position - 0x224F9
{
...
void func_189(int iParam0)//Position - 0x2252C
{
	switch (iParam0)
	{
		case 30:
...
void func_190(int iParam0, bool bParam1)//Position - 0x22561
{
	if (iParam0 == -1)
	{
		return;
...
void func_191(int iParam0, int iParam1, bool bParam2)//Position - 0x225BE
{
	if (iParam0 == -1)
	{
		return;
...
int func_192(int iParam0, int iParam1)//Position - 0x225F9
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_193(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x22619
{
	if (iParam0 != 198)
	{
		if (Global_78689)
...
void func_194(int iParam0, int iParam1)//Position - 0x22671
{
	switch (iParam0)
	{
		case 12:
...
void func_195(int iParam0, bool bParam1)//Position - 0x2275A
{
	if (bParam1)
	{
...
bool func_196(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x22783
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_198()//Position - 0x23102
{
	return Global_32284;
}

int func_199(var uParam0, int iParam1)//Position - 0x2310D
{
	int iVar0;
...
int func_200(int iParam0)//Position - 0x268A8
{
	switch (iParam0)
	{
		case 46:
...
void func_201(int iParam0, bool bParam1)//Position - 0x26997
{
	switch (iParam0)
	{
		case 46:
...
void func_202(int iParam0, bool bParam1)//Position - 0x269E8
{
	int iVar0;
...
void func_203(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x26A4E
{
	func_204(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_204(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x26A6F
{
	int iVar0;
...
void func_205()//Position - 0x26C42
{
	int iVar0;
...
int func_206(int iParam0)//Position - 0x26D59
{
	int iVar0;
	int iVar1;
...
void func_207(char* sParam0)//Position - 0x26D99
{
...
char* func_208(int iParam0)//Position - 0x26DBD
{
	switch (iParam0)
	{
		case 0:
...
int func_209(int iParam0)//Position - 0x26F90
{
...
void func_210(int iParam0, int iParam1)//Position - 0x26FBA
{
...
int func_211(char* sParam0)//Position - 0x26FF7
{
	int iVar0;
...
int func_212()//Position - 0x27057
{
	return func_213(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_213(char* sParam0, int iParam1)//Position - 0x27068
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_214(int iParam0)//Position - 0x270B1
{
	bool bVar0;
	int iVar1;
...
bool func_215(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x27122
{
...
int func_216(char* sParam0, int iParam1, bool bParam2)//Position - 0x27170
{
	Global_21846 = 0;
...
void func_217()//Position - 0x2743E
{
	if (!func_218())
	{
		return;
...
bool func_219(int iParam0)//Position - 0x274D8
{
	return func_220(iParam0, 20);
}

var func_220(int iParam0, int iParam1)//Position - 0x274E8
{
	return BitTest(Global_1895156[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_221()//Position - 0x27500
{
	return -1;
}

void func_222()//Position - 0x27509
{
	int iVar0;
...
void func_223()//Position - 0x2753A
{
...
void func_226()//Position - 0x2768F
{
	if (func_100(14))
	{
...
int func_227()//Position - 0x27731
{
	func_164();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_228()//Position - 0x2774A
{
	int iVar0;
...
bool func_229(int iParam0, int iParam1)//Position - 0x277A1
{
	switch (iParam0)
	{
		case 5:
...
void func_230()//Position - 0x277D9
{
...
void func_231(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27830
{
...
int func_232(int iParam0)//Position - 0x27886
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_233()//Position - 0x278A7
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	if (func_322(Local_153.f_0))
	{
		if (iVar0 < 3)
		{
			ENTITY::SET_ENTITY_HEALTH(Local_153.f_0, 101, 0);
	...
	if (func_232(Local_153.f_0))
	{
		...
		ENTITY::SET_ENTITY_HEALTH(Local_153.f_0, 0, 0);
	}
	func_234(&uLocal_180, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_215(&uLocal_180, "EXT4AUD", "EXT4_DUMB", 7, 0, 0, 0);
}

void func_234(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x27F5B
{
...
void func_235(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x27FF6
{
	int iVar0;
...
void func_236(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x280A1
{
	if (bParam0)
	{
...
bool func_237()//Position - 0x281EE
{
	return BitTest(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_36.f_18, 14);
}

bool func_238(int iParam0, int iParam1)//Position - 0x28208
{
	bool bVar0;
...
int func_239(int iParam0, bool bParam1)//Position - 0x28261
{
	int iVar0;
	int iVar1;
...
int func_240(var uParam0)//Position - 0x282A2
{
	int iVar0;
...
int func_241(int iParam0)//Position - 0x282C4
{
...
bool func_242()//Position - 0x28303
{
	return BitTest(Global_2621446, 3);
}

int func_243(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x28311
{
	int iVar0;
...
void func_244(int iParam0)//Position - 0x28344
{
	if (iParam0 == 1)
	{
...
void func_245()//Position - 0x28367
{
	Global_20711 = 0;
	func_246();
}

void func_246()//Position - 0x28377
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22856 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_247(int iParam0)//Position - 0x28398
{
...
void func_249(int iParam0, bool bParam1)//Position - 0x28414
{
...
void func_250()//Position - 0x28450
{
	if (iLocal_147 < 2)
	{
			...
			if (!func_271())
			{
				if (func_265(1, 20f, 1))
				{
					if ((!iLocal_381 || MISC::GET_GAME_TIMER() > iLocal_382 + 3000) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, false, true, 0))
					{
						...
						iLocal_364 = PED::ADD_SCENARIO_BLOCKING_AREA(1636.6907f, -89.8127f, 150f, 1706.1459f, 58.721f, 190f, false, true, true, true);
						iLocal_147 = 1;
					}
				}
			}
...
void func_251(int iParam0)//Position - 0x28813
{
	iLocal_146 = iParam0;
	iLocal_147 = 0;
	iLocal_148 = 0;
...
void func_252(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x28825
{
	int iVar0;
...
Vector3 func_253(int iParam0)//Position - 0x289E3
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_254(bool bParam0)//Position - 0x289F6
{
	int iVar0;
...
void func_255(struct<3> Param0, float fParam3)//Position - 0x28A35
{
	int iVar0;
...
void func_256(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x28A84
{
	func_257(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_257(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x28AAD
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_258(struct<3> Param0)//Position - 0x28EA3
{
...
int func_259(int iParam0, int iParam1, bool bParam2)//Position - 0x28ECD
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_260(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x28F3B
{
...
int func_261(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x29013
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_262(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x29309
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_263(struct<3> Param0)//Position - 0x293BD
{
	float fVar0;
	float fVar1;
...
void func_264(int iParam0)//Position - 0x293FC
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_265(int iParam0, float fParam1, int iParam2)//Position - 0x29461
{
	int iVar0;
...
bool func_266()//Position - 0x29524
{
	bool bVar0;
...
void func_267()//Position - 0x29547
{
...
int func_268(int iParam0, int iParam1)//Position - 0x29598
{
	if (func_322(iParam0))
	{
...
int func_269(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x295CB
{
...
void func_270(int iParam0)//Position - 0x29763
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_272()//Position - 0x297B1
{
	...
	{
		case 0:
			if (func_322(Local_80.f_28[0]))
			{
				PED::SET_PED_COMBAT_ATTRIBUTES(Local_80.f_28[0], 17, true);
			}
			iLocal_366 = 0;
			iLocal_381 = 1;
			func_283("EXT4_01", 7500, 1);
			iLocal_168 = func_282(Local_153.f_0, 1, 1, 5);
			SYSTEM::SETTIMERA(0);
			iLocal_147 = 1;
			break;
		...
		case 1:
			...
			if (func_322(PLAYER::PLAYER_PED_ID()))
			{
				if (func_322(Local_153.f_0))
				{
					if (func_321(PLAYER::PLAYER_PED_ID(), Local_153.f_0, 100f, 1))
					{
						CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST("es_4_rcm_p2_concat", 6, 8);
						if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
						{
					...
					if (func_321(PLAYER::PLAYER_PED_ID(), Local_153.f_0, 32f, 1))
					{
						if (func_276(Local_153.f_0, 1, 0, 0, 0))
						{
							if (iLocal_167 == 0)
							{
								if (!func_271())
								{
									func_275(&uLocal_180, "EXT4AUD", "EXT4_ATTACK", "EXT4_ATTACK_1", 7, 0, 0);
									iLocal_167 = 1;
								}
							}
							else if (iLocal_167 == 1)
							{
								if (!func_271())
								{
									func_275(&uLocal_180, "EXT4AUD", "EXT4_ATTACK", "EXT4_ATTACK_2", 7, 0, 0);
									iLocal_167 = 2;
								}
							}
						}
						else
						{
							if (!iLocal_376)
							{
								if (func_321(PLAYER::PLAYER_PED_ID(), Local_153.f_0, 30f, 1) && !func_271())
								{
...
void func_273()//Position - 0x29AEF
{
	if (func_322(Local_153.f_0))
	{
...
void func_274()//Position - 0x29B17
{
	if (!func_271())
	{
		if (iLocal_366 < 5)
...
int func_275(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x29BC5
{
...
int func_276(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x29C19
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_232(PLAYER::PLAYER_PED_ID()) && func_232(iParam0))
	{
		...
		if (!bParam2)
		{
			if (func_281(iParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
...
int func_277(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x29D14
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_278(int iParam0, float fParam1)//Position - 0x29E20
{
	var uVar0;
	struct<3> Var1;
	...
	{
		if (func_279(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_279(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x29EB5
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_280(struct<3> Param0, struct<3> Param3)//Position - 0x29F43
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

int func_281(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x29F64
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_282(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x29FAC
{
	int iVar0;
	bool bVar1;
...
void func_283(char* sParam0, int iParam1, int iParam2)//Position - 0x29FFE
{
	iParam2 = iParam2;
...
void func_285()//Position - 0x2A030
{
	if (func_340() == 0)
	{
		func_296();
	...
	{
		func_295(1732.1328f, 91.9424f, 169.7872f, 128.6917f, 1, 0);
		func_293(0, -1, 1);
	...
	if (iLocal_150 == 1)
	{
		func_291(&Local_80, 0, 1);
		func_286();
	}
}

void func_286()//Position - 0x2A0E9
{
	if (func_232(Local_80.f_28[0]))
	{
		func_290(Local_80.f_28[0], 1737.4534f, 101.7498f, 170.0243f, 288.5211f, 0, 1);
	}
	else
	{
		func_287(&(Local_80.f_28[0]), 1737.4534f, 101.7498f, 170.0243f, 288.5211f);
	}
...
void func_287(int* iParam0, struct<3> Param1, float fParam4)//Position - 0x2A3EA
{
	func_288(iParam0, iLocal_79, Param1, fParam4, 26);
	PED::SET_PED_DEFAULT_COMPONENT_VARIATION(*iParam0);
	PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(*iParam0, false);
	PED::SET_PED_NAME_DEBUG(*iParam0, "EXTREME LAUNCHER RC");
}

void func_288(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x2A41C
{
	func_289(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_289(int* iParam0)//Position - 0x2A43D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_290(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2A47E
{
	bool bVar0;
	float fVar1;
...
void func_291(var uParam0, bool bParam1, bool bParam2)//Position - 0x2A4DA
{
	int iVar0;
...
void func_292(int iParam0, int iParam1, int iParam2)//Position - 0x2A5CF
{
...
void func_293(int iParam0, int iParam1, int iParam2)//Position - 0x2A603
{
	if (func_340() && func_294())
	{
...
var func_294()//Position - 0x2A6C7
{
	return BitTest(Global_100833.f_20, 13);
}

void func_295(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2A6D8
{
	if (func_340())
	{
...
void func_296()//Position - 0x2A76D
{
	switch (iLocal_148)
	{
		case 0:
			func_301();
			iLocal_149 = 0;
			func_300("es_4_rcm_p1", 0);
			if (func_298(1, 1093140480, 0))
			{
		...
		case 2:
			func_290(PLAYER::PLAYER_PED_ID(), 1732.2219f, 92.0087f, 169.7867f, 138.1854f, 0, 1);
			PED::FORCE_PED_MOTION_STATE(PLAYER::PLAYER_PED_ID(), joaat("MotionState_Walk"), false, 1, false);
			PED::SET_PED_MIN_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID(), 1f);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), 1723.4518f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
			CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
...
void func_297()//Position - 0x2A936
{
	int iVar0;
...
int func_298(int iParam0, float fParam1, int iParam2)//Position - 0x2A956
{
	int iVar0;
...
void func_299()//Position - 0x2AA2A
{
	Global_20711 = 0;
	func_230();
}

void func_300(char* sParam0, bool bParam1)//Position - 0x2AA3A
{
	func_254(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_301()//Position - 0x2AA50
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!func_340() && func_322(Local_80.f_28[0])) && func_322(PLAYER::PLAYER_PED_ID())) && iLocal_381 == 1)
	{
		...
		{
			if (func_321(PLAYER::PLAYER_PED_ID(), Local_80.f_28[0], 4f, 1))
			{
...
void func_302()//Position - 0x2AB5A
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_303()//Position - 0x2AC15
{
	float fVar0;
...
void func_304(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2ACE3
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_306(Global_78945, Global_78947, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_305(char* sParam0)//Position - 0x2AFC8
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_306(int iParam0, int iParam1, int iParam2)//Position - 0x2AFDB
{
	struct<2> Var0;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_307(iVar2), 8);
					break;
			}
			break;
...
char* func_307(int iParam0)//Position - 0x2B0B1
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_308(int iParam0)//Position - 0x2B204
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_309(int iParam0)//Position - 0x2B237
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_310(int iParam0)//Position - 0x2B26A
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_311(int iParam0)//Position - 0x2B29D
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_312(int iParam0)//Position - 0x2B2D0
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_313(int iParam0)//Position - 0x2B30D
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_314(int iParam0)//Position - 0x2B340
{
	struct<2> Var0;
...
int func_315(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2B3A9
{
	...
	switch (Global_78944)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_317(0)) || func_316(1))
			{
			}
			else
			{
...
bool func_316(bool bParam0)//Position - 0x2B4C1
{
	if (bParam0)
	{
...
int func_317(int iParam0)//Position - 0x2B4EA
{
	if (iParam0 == 1)
	{
		if (Global_20500.f_1 > 3)
...
int func_318(int iParam0)//Position - 0x2B541
{
	if (Global_43377 == 15)
	{
		return 0;
...
bool func_319(int iParam0)//Position - 0x2B563
{
	return func_320(iParam0, Global_43377);
}

int func_320(int iParam0, int iParam1)//Position - 0x2B574
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_321(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x2B755
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), ENTITY::GET_ENTITY_COORDS(iParam1, bParam3)) <= (fParam2 * fParam2);
}

int func_322(int iParam0)//Position - 0x2B777
{
	if (func_232(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_323()//Position - 0x2B797
{
	...
	{
		func_324(&Local_153, 52, Local_153.f_1, Local_153.f_4, "Ext4-Dom", 1);
...
int func_324(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x2B974
{
...
int func_325(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2B9D0
{
	int iVar0;
...
int func_326(var uParam0, int iParam1)//Position - 0x2BA5E
{
	int iVar0;
...
void func_327(int iParam0)//Position - 0x2BAA4
{
...
void func_328(int iParam0, int iParam1, bool bParam2)//Position - 0x2BB24
{
	int iVar0;
		...
		if (bParam2)
		{
			if (!Global_78689)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9029[iParam1 /*4*/] = { func_330(iParam0) };
					...
					{
						Global_8980[1 /*6*/] = { func_330(iParam0) };
...
void func_329()//Position - 0x2BCA2
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
struct<4> func_330(int iParam0)//Position - 0x2BD1D
{
	return Global_2058[iParam0 /*29*/].f_3;
}

int func_331(int iParam0, int iParam1)//Position - 0x2BD30
{
...
int func_332(int iParam0, int iParam1)//Position - 0x2BD5A
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_333(int iParam0, int iParam1, int iParam2)//Position - 0x2BD84
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_334(int iParam0, int iParam1, int iParam2)//Position - 0x2BDC9
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
int func_335(var uParam0)//Position - 0x2BE0E
{
	int iVar0[1];
	int iVar2;
	...
	switch (iLocal_77)
	{
		case 0:
			...
			func_339(&(uParam0->f_48), "rcmextreme4", "idle_a", "idle_c");
			iLocal_77 = 1;
			break;
		
		case 1:
			if (!func_338(&iVar0) || !func_336(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_77 = 2;
		...
		case 2:
			func_287(&(uParam0->f_28[0]), 1732.27f, 96.36f, 170.29f, -98.56f);
...
int func_336(var uParam0)//Position - 0x2BF12
{
	if (func_337(uParam0))
	{
...
int func_337(var uParam0)//Position - 0x2BF3C
{
...
int func_338(int iParam0)//Position - 0x2BF61
{
	int iVar0;
...
void func_339(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x2BF92
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
void func_341(int iParam0)//Position - 0x2BFF2
{
	func_297();
	if (func_355())
	{
	...
	func_353(&iLocal_174, 0);
	func_353(&iLocal_175, 0);
	func_353(&iLocal_176, 0);
	TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_BICYCLE_MOUNTAIN", true);
	func_342(&Local_80, 1, 0, 0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_342(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2C047
{
	func_350(uParam0, iParam1);
	func_345(uParam0, bParam2);
	func_343(uParam0, bParam3);
}

void func_343(var uParam0, bool bParam1)//Position - 0x2C067
{
	func_344(&(uParam0->f_41), bParam1);
}

void func_344(var uParam0, bool bParam1)//Position - 0x2C079
{
	int iVar0;
...
void func_345(var uParam0, bool bParam1)//Position - 0x2C0B7
{
	func_346(&(uParam0->f_35), bParam1);
}

void func_346(var uParam0, bool bParam1)//Position - 0x2C0C9
{
	int iVar0;
...
void func_347(int* iParam0)//Position - 0x2C106
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_348(int* iParam0)//Position - 0x2C13E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_349(int iParam0)//Position - 0x2C1DA
{
	if (func_232(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_350(var uParam0, int iParam1)//Position - 0x2C204
{
	func_351(&(uParam0->f_28), iParam1);
}

void func_351(var uParam0, int iParam1)//Position - 0x2C216
{
	int iVar0;
...
void func_352(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2C257
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_353(int* iParam0, bool bParam1)//Position - 0x2C2A7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_354()//Position - 0x2C2E2
{
	func_342(&Local_80, 1, 0, 0);
	func_352(&(Local_80.f_28[0]), 1, 0, 1);
	STREAMING::REMOVE_ANIM_DICT("rcmextreme4");
}

int func_355()//Position - 0x2C309
{
	int iVar0;
...
void func_356(bool bParam0)//Position - 0x2C3AA
{
	int iVar0;
...
void func_357(char* sParam0, int iParam1)//Position - 0x2C47A
{
	if (Global_100833 != 12)
	{
...
int func_358(char* sParam0, int iParam1, int iParam2)//Position - 0x2C4A2
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_364())
	{
		...
		{
			iVar33 = func_359(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_359(char* sParam0)//Position - 0x2C631
{
...
int func_360()//Position - 0x2C687
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_361(&(Global_100833.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_361(char* sParam0, bool bParam1)//Position - 0x2C6AB
{
	int iVar0;
	int iVar1;
...
int func_362(int iParam0, bool bParam1)//Position - 0x2C6D5
{
	int iVar0;
...
int func_364()//Position - 0x2C75B
{
	...
	{
		if (func_359(&(Global_100833.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_365(bool bParam0)//Position - 0x2C7C7
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_366(int iParam0)//Position - 0x2C7DB
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_367(int iParam0)//Position - 0x2C815
{
	if (iParam0 == 1)
	{
...
void func_368()//Position - 0x2C84F
{
	Global_23251.f_5 = 1;
}

void func_369()//Position - 0x2C85D
{
	Global_23251.f_5 = 0;
}

void func_370(bool bParam0)//Position - 0x2C86B
{
	if (bParam0)
	{
		func_371();
...
void func_371()//Position - 0x2C8CE
{
...
void func_372(int iParam0)//Position - 0x2C8F7
{
	if (func_375())
	{
		return;
...
void func_373(bool bParam0, bool bParam1)//Position - 0x2C981
{
	if (bParam0)
	{
		if (func_317(0))
...
bool func_374()//Position - 0x2C9F5
{
	return BitTest(Global_1963795, 5);
}

bool func_375()//Position - 0x2CA03
{
	return BitTest(Global_1963795, 19);
}

void func_376()//Position - 0x2CA12
{
	Global_94989 = 0;
	Global_94990 = 0;
}

int func_377()//Position - 0x2CA24
{
...
void func_378()//Position - 0x2CA62
{
	Global_100868 = 1;
...
void func_379(char* sParam0)//Position - 0x2CB4F
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_380(var uParam0)//Position - 0x2CB61
{
...
void func_381(var uParam0)//Position - 0x2CB81
{
	int iVar0;
...
int func_382(int iParam0)//Position - 0x2CBBB
{
	if (!func_161(iParam0))
	{
		return func_160(iParam0);
