...
void func_10(int iParam0, bool bParam1)//Position - 0x5DB
{
	...
	{
		func_182(&(Global_113457[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
int func_40(int iParam0, int iParam1, int iParam2)//Position - 0x1A0B
{
	...
	{
		if (!func_157(iParam0, Global_114370.f_2366.f_539[iVar0 /*65*/].f_64, Global_114370.f_2366.f_539[iVar0 /*65*/].f_63))
		{
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x97A3
{
	...
	{
		if (!func_157(iParam0, Global_114370.f_2366.f_539[iVar0 /*65*/].f_61, Global_114370.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_91(&Var1, -99, -99, Global_114370.f_2366.f_539.f_196[0], Global_114370.f_2366.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_91(&Var1, -99, -99, Global_114370.f_2366.f_539.f_196[1], Global_114370.f_2366.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_91(&Var1, -99, -99, Global_114370.f_2366.f_539.f_196[2], Global_114370.f_2366.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_164()//Position - 0x20106
{
	...
	{
		if (func_159(Global_114370.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
