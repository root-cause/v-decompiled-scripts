			...
			case 0:
				if ((BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() && !func_34()) && !func_12())
				{
					if (func_11())
					{
						...
						PED::SET_PED_PROP_INDEX(iLocal_91, 0, 0, 0, false, 1);
						iLocal_95 = 1;
					}
				}
				else
...
float func_2(struct<3> Param0, struct<3> Param1)//Position - 0x525
{
