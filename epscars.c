...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_48(&Local_41))
		{
			if (func_42(&Local_41))
			{
				if (VEHICLE::GET_LAST_DRIVEN_VEHICLE() == Global_78042)
				{
					Global_78042 = 0;
		...
		if (Global_113386.f_10049.f_104 != 0)
		{
			iLocal_49 = (Global_113386.f_10049.f_104 + 14 % func_18(CLOCK::GET_CLOCK_MONTH(), CLOCK::GET_CLOCK_YEAR()));
...
void func_49(var uParam0)//Position - 0x20E2
{
	...
	if (uParam0->f_5 == 2 && (uParam0->f_4 != 2 || uParam0->f_4 == 3))
	{
		...
		{
			AUDIO::PLAY_SOUND_FROM_COORD(iLocal_47, "CLOSING", *uParam0, "DOOR_GARAGE", false, 0, true);
			iLocal_48 = 1;
		}
	}
	if (uParam0->f_5 == 1 && (uParam0->f_4 != 1 || uParam0->f_4 == 4))
	{
		...
		{
			AUDIO::PLAY_SOUND_FROM_COORD(iLocal_47, "OPENING", *uParam0, "DOOR_GARAGE", false, 0, true);
			iLocal_48 = 1;
		}
	}
...
Vector3 func_50(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x22A2
{
	if (bParam3)
	{
...
float func_63(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x2FE0
{
	struct<3> Var0;
...
void func_76()//Position - 0x34DA
{
	...
	{
		if (func_79(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_87(struct<3> Param0, float fParam1, var uParam2, var uParam3)//Position - 0x3779
{
	struct<3> Var0;
...
void func_88(var uParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x37A5
{
	*(uParam0[0 /*3*/]) = { Param1 };
	*(uParam0[1 /*3*/]) = { Param2 };
	uParam0->f_7 = fParam3;
...
void func_90(var uParam0, int iParam1, struct<3> Param2, struct<3> Param3, struct<3> Param4, struct<3> Param5, float fParam6, struct<3> Param7, struct<3> Param8)//Position - 0x37D7
{
	uParam0->f_3 = iParam1;
	*uParam0 = { Param2 };
	uParam0->f_5 = 2;
