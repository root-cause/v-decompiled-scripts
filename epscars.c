...
void __EntryFunction__()//Position - 0x0
{
	...
	func_91(6);
	func_90(&Local_43, joaat("prop_ch2_09c_garage_door"), -689.81f, 510.34f, 109.98f, Local_40, -688.4919f, 507.25494f, 108.918564f, -691.8835f, 516.26886f, 113.43157f, 9.25f, -687.45526f, 507.51794f, 109.36351f, -690.94836f, 506.2783f, 109.36312f);
	func_89(&Local_43, 2);
	Local_43.f_4 = 3;
	MISC::CLEAR_AREA_OF_VEHICLES(Local_40, 5f, false, false, false, false, false, false, 0);
	func_88(&Local_109, -691.9059f, 515.8249f, 108.61385f, -684.06055f, 493.01712f, 110.850395f, 8.25f);
	...
	while (true)
	{
		...
		if (Global_113648.f_10051.f_104 != 0)
		{
			iLocal_97 = (Global_113648.f_10051.f_104 + 14 % func_18(CLOCK::GET_CLOCK_MONTH(), CLOCK::GET_CLOCK_YEAR()));
...
void func_1(int* iParam0, var uParam1, int iParam2)//Position - 0x3E6
{
	int iVar0;
...
void func_4(int iParam0)//Position - 0x595
{
	int iVar0;
...
void func_5(int iParam0)//Position - 0x631
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_6(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)//Position - 0x99E
{
	int iVar0;
	bool bVar1;
	char cVar2[64];
...
void func_7(int iParam0)//Position - 0xB84
{
...
char* func_8(int iParam0)//Position - 0xBB2
{
	switch (iParam0)
	{
		case 0:
...
char* func_9(int iParam0, int iParam1)//Position - 0xF1D
{
	*iParam1 = 1;
	switch (iParam0)
	{
...
struct<16> func_10(int iParam0)//Position - 0x12E8
{
	struct<16> Var0;
	struct<16> Var16;
...
int func_11(int iParam0)//Position - 0x1319
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_12(int iParam0, char* sParam1)//Position - 0x137D
{
	int iVar0;
	int iVar1;
...
char* func_13(int iParam0)//Position - 0x1432
{
...
int func_15(int iParam0)//Position - 0x14A0
{
	if (iParam0 < 0)
	{
		return 1;
...
int func_16()//Position - 0x14B9
{
	return (5 - func_3());
}

int func_17(int iParam0)//Position - 0x14C7
{
	if (iParam0 == 1)
	{
...
int func_18(int iParam0, int iParam1)//Position - 0x151E
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_20(int iParam0, int iParam1)//Position - 0x1602
{
	int iVar0;
...
bool func_21(char* sParam0)//Position - 0x1653
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

int func_22(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1666
{
...
int func_23(char* sParam0, int iParam1, bool bParam2)//Position - 0x16B4
{
	Global_21726 = 0;
...
bool func_26(int iParam0)//Position - 0x1A1C
{
	return func_27(iParam0, 20);
}

var func_27(int iParam0, int iParam1)//Position - 0x1A2C
{
	return BitTest(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

int func_28()//Position - 0x1A44
{
	return -1;
}

void func_29()//Position - 0x1A4D
{
	int iVar0;
...
bool func_34(int iParam0)//Position - 0x1C76
{
	return Global_43257 == iParam0;
}

void func_35()//Position - 0x1C84
{
	int iVar0;
...
bool func_36(int iParam0, int iParam1)//Position - 0x1CDC
{
	switch (iParam0)
	{
		case 5:
...
void func_38(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x1D6B
{
...
void func_39(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1DC1
{
...
int func_41(bool bParam0)//Position - 0x1EA7
{
...
int func_42(var uParam0)//Position - 0x1ECF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_43(int iParam0)//Position - 0x1F76
{
	int iVar0;
	int iVar1;
...
void func_44(int iParam0, bool bParam1)//Position - 0x1FD6
{
	if (bParam1)
	{
...
void func_45(int iParam0, bool bParam1)//Position - 0x1FFA
{
	if (bParam1)
	{
...
int func_46(int iParam0, int iParam1)//Position - 0x201E
{
...
bool func_47(int iParam0)//Position - 0x2080
{
	if (!func_81(iParam0))
	{
		return 1;
...
bool func_48(var uParam0)//Position - 0x20C9
{
	return (uParam0->f_5 == 2 && uParam0->f_4 == 2);
}

void func_49(var uParam0)//Position - 0x20E2
{
	struct<3> Var0;
...
Vector3 func_50(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x22A2
{
	if (bParam7)
	{
...
float func_51(float fParam0, float fParam1, float fParam2)//Position - 0x22CB
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_52(int iParam0)//Position - 0x22F2
{
	int iVar0;
...
void func_53(int iParam0, char* sParam1, bool bParam2)//Position - 0x232C
{
	int iVar0;
...
int func_54(int iParam0, int iParam1, bool bParam2)//Position - 0x2453
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_55(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x264F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_56(int iParam0, bool bParam1)//Position - 0x2A23
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void func_57(int iParam0)//Position - 0x2C3B
{
	int iVar0;
...
void func_59(char* sParam0, int iParam1)//Position - 0x2D6C
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

void func_60(int* iParam0)//Position - 0x2D83
{
...
void func_61(int iParam0)//Position - 0x2DA3
{
	int iVar0;
...
bool func_62(var uParam0)//Position - 0x2FB7
{
	return (!uParam0->f_26 && !MISC::IS_POSITION_OCCUPIED(uParam0->f_14, 6.2f, false, false, true, false, false, 0, false));
}

float func_63(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x2FE0
{
	struct<3> Var0;
...
void func_64(char* sParam0, int iParam1, int iParam2)//Position - 0x301A
{
	iParam2 = iParam2;
...
int func_65(int iParam0)//Position - 0x3033
{
	if (func_66(iParam0))
	{
...
int func_66(int iParam0)//Position - 0x305D
{
...
void func_67(int iParam0)//Position - 0x307E
{
	int iVar0;
...
void func_68(int iParam0)//Position - 0x3176
{
	switch (*iParam0)
	{
		case 1:
...
void func_69(int iParam0)//Position - 0x31F1
{
	switch (*iParam0)
	{
		case 1:
...
void func_73(var uParam0)//Position - 0x346E
{
	if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(*uParam0, 20f, uParam0->f_3, false))
	{
...
int func_75()//Position - 0x34C1
{
	func_76();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_76()//Position - 0x34DA
{
	int iVar0;
...
bool func_77(int iParam0)//Position - 0x35D7
{
	return iParam0 < 3;
}

int func_78(int iParam0)//Position - 0x35E3
{
	int iVar0;
	int iVar1;
...
int func_79(int iParam0)//Position - 0x3620
{
	if (func_77(iParam0))
	{
...
var func_80(int iParam0)//Position - 0x3645
{
	return Global_2028[iParam0 /*29*/];
}

bool func_81(int iParam0)//Position - 0x3654
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
void func_82(int iParam0)//Position - 0x3672
{
	iLocal_94 = iParam0;
	iLocal_93 = 1;
}

void func_83(bool bParam0)//Position - 0x3681
{
	func_84(44, bParam0);
	func_84(45, bParam0);
	func_84(46, bParam0);
...
void func_84(int iParam0, bool bParam1)//Position - 0x36C1
{
	if (iParam0 == -1)
	{
		return;
...
void func_85(int iParam0, int iParam1, bool bParam2)//Position - 0x371E
{
	if (iParam0 == -1)
	{
		return;
...
int func_86(int iParam0, int iParam1)//Position - 0x3759
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_87(struct<3> Param0, float fParam3, var uParam4, var uParam5)//Position - 0x3779
{
	struct<3> Var0;
...
void func_88(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x37A5
{
	*(uParam0[0 /*3*/]) = { Param1 };
	*(uParam0[1 /*3*/]) = { Param4 };
	uParam0->f_7 = fParam7;
...
void func_89(var uParam0, int iParam1)//Position - 0x37C9
{
	uParam0->f_5 = iParam1;
}

void func_90(var uParam0, int iParam1, struct<3> Param2, struct<3> Param5, struct<3> Param8, struct<3> Param11, float fParam14, struct<3> Param15, struct<3> Param18)//Position - 0x37D7
{
	uParam0->f_3 = iParam1;
	*uParam0 = { Param2 };
	uParam0->f_5 = 2;
...
int func_91(int iParam0)//Position - 0x382D
{
	int iVar0;
	bool bVar1;
...
bool func_92()//Position - 0x3884
{
	return func_3() == 5;
}

void func_93()//Position - 0x3892
{
	...
	Local_70[0 /*3*/] = 1;
	Local_70[0 /*3*/].f_1 = "EPS_GMAIL_G5" /* GXT: Brother,~n~~n~These are the vehicles that the higher beings require:~a~ ~a~ ~a~ ~a~ ~a~ ~n~Make sure these vehicles are delivered in a condition befitting the level of divine understanding that our thesis holders have reached.  Carry out this small task for us and you will be rewarded with knowledge of infinitely greater value.  Kraff be praised! */;
	Local_70[0 /*3*/].f_2 = "EPS_BMAIL_G5" /* GXT: Brother, ~n~~n~These are the vehicles that the higher beings require:~a~ ~a~ ~a~ ~a~ ~a~ ~n~Make sure these vehicles are delivered in a condition befitting the level of divine understanding that our thesis holders have reached.  Carry out this small task for us and you will be rewarded with knowledge of infinitely greater value.  Kraff be praised! */;
	Local_70[1 /*3*/] = 2;
	Local_70[1 /*3*/].f_1 = "EPS_GMAIL_G4" /* GXT: Kifflom Brother,~n~~n~The higher beings now require these vehicles:~a~ ~a~ ~a~ ~a~ ~n~The color is of no consequence.  We will judge you in many ways but none so superficial. ~n~~n~Kraff be praised! */;
	Local_70[1 /*3*/].f_2 = "EPS_BMAIL_G4" /* GXT: Very disappointing, Brother,~n~~n~The offering you made was not what we were expecting of you.  The higher beings have now requested these vehicles:~a~ ~a~ ~a~ ~a~ ~n~Accomplish this and you might still be Saveable.  Unlimit your limitations! ~n~~n~Kraff be praised! */;
	Local_70[2 /*3*/] = 3;
	Local_70[2 /*3*/].f_1 = "EPS_GMAIL_G3" /* GXT: Brother,~n~~n~Kraff desires these vehicles:~a~ ~a~ ~a~ ~n~Know that Cris and the other higher beings recognize your commitment to the divine truth.  Find these vehicles and you will be richly rewarded with powerful tools that you do not understand. ~n~~n~Kraff be praised! */;
	Local_70[2 /*3*/].f_2 = "EPS_BMAIL_G3" /* GXT: Have we over-estimated your capabilities? ~n~~n~Your last offering was not received well and the senior thesis holders now requested these vehicles:~a~ ~a~ ~a~ ~n~Carry out these wishes and prove that you are not an Objectionable Person.~n~~n~Kraff be praised! */;
	Local_70[3 /*3*/] = 4;
	Local_70[3 /*3*/].f_1 = "EPS_GMAIL_G2" /* GXT: Dear Brother,~n~~n~Cris has requested delivery of these vehicles as swiftly as possible:~a~ ~a~ ~n~Many are relying on you to fulfill these requirements.  Do not disappoint.~n~~n~Kraff be praised! */;
	Local_70[3 /*3*/].f_2 = "EPS_BMAIL_G2" /* GXT: Brother,~n~~n~All evidence points to you being an Unsaveable.  You have one more chance to prove us wrong by sourcing these vehicles:~a~ ~a~ ~n~Spare yourself the wrath of Kraff, for it will not spare you! */;
	Local_70[4 /*3*/] = 5;
	Local_70[4 /*3*/].f_1 = "EPS_GMAIL_G1" /* GXT: Kifflom Brother,~n~~n~One of our highest thesis holders has requested this vehicle:~a~ ~n~Prove to us that you are ready to understand the technology of your existence with this act of selflessness.~n~~n~Kraff be praised! */;
	Local_70[4 /*3*/].f_2 = "EPS_BMAIL_G1" /* GXT: Brother,~n~~n~Cris demands that you deliver this vehicle as a sign of your commitment to the divine truth:~a~ ~n~What would you rather do?  Carry out this simple task or die without ever knowing your eternal self?  The choice is yours.~n~~n~Kraff be praised! */;
}
...
int func_95(int iParam0)//Position - 0x397D
{
...
int func_97(int iParam0)//Position - 0x3A87
{
	int iVar0;
	bool bVar1;
...
void func_98(int iParam0, int iParam1)//Position - 0x3ADE
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return;
