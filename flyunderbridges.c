...
void func_1()//Position - 0x52F
{
	...
	if (bLocal_29 < 32)
	{
		bVar0 = BitTest(Global_114372.f_10052.f_96, bLocal_29);
	}
	else if (bLocal_29 < 64)
	{
		bVar0 = BitTest(Global_114372.f_10052.f_97, (bLocal_29 - 32));
	}
	else
	{
		bVar0 = BitTest(Global_114372.f_10052.f_98, (bLocal_29 - 64));
	}
	if (bVar0)
	{
	}
	else
	{
		...
		if (bLocal_29 < 32)
		{
			MISC::SET_BIT(&(Global_114372.f_10052.f_96), bLocal_29);
		}
		else if (bLocal_29 < 64)
		{
			MISC::SET_BIT(&(Global_114372.f_10052.f_97), (bLocal_29 - 32));
		}
		else
		{
			MISC::SET_BIT(&(Global_114372.f_10052.f_98), (bLocal_29 - 64));
		}
		Global_97817 = 1;
		func_31();
		iLocal_27 = 1;
...
int func_5(int iParam0, var uParam1)//Position - 0x770
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_6(uParam1));
}

int func_6(var uParam0)//Position - 0x785
{
	int iVar0;
	int iVar1;
...
bool func_11(int iParam0)//Position - 0x90A
{
	return iParam0 < 3;
}

int func_12(int iParam0)//Position - 0x916
{
	int iVar0;
	int iVar1;
...
int func_13(int iParam0)//Position - 0x953
{
	if (func_11(iParam0))
	{
...
var func_14(int iParam0)//Position - 0x978
{
...
void func_17()//Position - 0x9F3
{
	if ((MISC::GET_GAME_TIMER() - iLocal_266) > 500)
	{
		if (bLocal_29 == 29)
		{
			if (BitTest(Global_114372.f_10052.f_96, bLocal_29))
			{
				bLocal_265 = true;
			}
		}
...
void func_27()//Position - 0xD00
{
	...
	{
		if (BitTest(Global_114372.f_10052.f_97, (bLocal_29 - 32)))
		{
			bLocal_265 = true;
		}
	}
	else if (BitTest(Global_114372.f_10052.f_98, (bLocal_29 - 64)))
	{
		bLocal_265 = true;
	}
	if (bLocal_265)
...
void func_28(bool bParam0)//Position - 0xDBC
{
	switch (bParam0)
	{
		case 0:
...
int func_29(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x268B
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_34(var uParam0, int iParam1)//Position - 0x2EC2
{
	int iVar0;
	var uVar1[78];
...
void func_39(var uParam0, float fParam1)//Position - 0x3043
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
int func_44(int iParam0)//Position - 0x30B9
{
	switch (iParam0)
	{
		case 60:
...
void func_46()//Position - 0x31EF
{
	...
	{
		func_49(13, SYSTEM::FLOOR(Global_114372.f_10197.f_3853));
	}
...
void func_48(int iParam0, bool bParam1, int iParam2)//Position - 0x36B8
{
	if (iParam2 == -1)
	{
		iParam2 = func_7();
...
int func_50()//Position - 0x3727
{
	...
	while (bVar1 < 32)
	{
		if (BitTest(Global_114372.f_10052.f_96, bVar1))
		{
			if (func_51(bVar1))
			{
				iVar0++;
		...
		if (BitTest(Global_114372.f_10052.f_97, bVar1))
		{
			if (func_51(bVar1 + 32))
			{
				iVar0++;
		...
		if (BitTest(Global_114372.f_10052.f_98, bVar1))
		{
			if (func_51(bVar1 + 64))
			{
				iVar0++;
...
int func_51(bool bParam0)//Position - 0x37A2
{
	switch (bParam0)
	{
		case 33:
...
int func_53(bool bParam0)//Position - 0x3891
{
