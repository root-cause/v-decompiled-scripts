...
void func_1()//Position - 0x52F
{
	...
	else
	{
		...
		if (bLocal_29 < 32)
		{
			MISC::SET_BIT(&(Global_113969.f_10052.f_96), bLocal_29);
		}
		else if (bLocal_29 < 64)
		{
			MISC::SET_BIT(&(Global_113969.f_10052.f_97), (bLocal_29 - 32));
		}
		else
		{
			MISC::SET_BIT(&(Global_113969.f_10052.f_98), (bLocal_29 - 64));
		}
		Global_97958 = 1;
		func_31();
		iLocal_27 = 1;
