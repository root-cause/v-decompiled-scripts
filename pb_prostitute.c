...
void func_24()//Position - 0xD89
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_27(Global_113810.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_25(iVar0) && (!func_552(14) || Global_112760))
			{
...
int func_76(int iParam0)//Position - 0x2C24
{
	...
	if (func_23() == 0)
	{
		iVar0 = Global_113810.f_10052.f_1[iParam0 /*11*/][0];
	}
	else if (func_23() == 1)
	{
		iVar0 = Global_113810.f_10052.f_1[iParam0 /*11*/][1];
	}
	else if (func_23() == 2)
	{
		iVar0 = Global_113810.f_10052.f_1[iParam0 /*11*/][2];
	}
	return iVar0;
}
...
{
	if (PED::IS_PED_MODEL(iParam0, Global_113810.f_10052.f_1[iParam1 /*11*/].f_10))
	{
		return 1;
	}
	return 0;
...
int func_81(int iParam0, int iParam1)//Position - 0x2D5D
{
	if (func_75(iParam0))
	{
		return Global_113810.f_10052.f_1[iParam0 /*11*/].f_7[iParam1];
	}
	return -1;
}
...
int func_85(int iParam0, int iParam1)//Position - 0x2DFC
{
	if (func_75(iParam0))
	{
		return Global_113810.f_10052.f_1[iParam0 /*11*/].f_4[iParam1];
	}
	return -1;
}
...
int func_94(int iParam0, bool bParam1)//Position - 0x36BA
{
...
int func_95(int iParam0)//Position - 0x389D
{
	switch (iParam0)
	{
		case joaat("police"):
...
void func_96(int iParam0)//Position - 0x38F6
{
	iLocal_293 = iParam0;
}

void func_97()//Position - 0x3903
{
	if (func_551())
	{
		if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_94))
...
void func_98(var uParam0)//Position - 0x3970
{
...
void func_99(var uParam0)//Position - 0x3C5F
{
	if (!func_551())
	{
...
void func_100(int iParam0)//Position - 0x3CDC
{
}

var func_101(bool bParam0)//Position - 0x3CE4
{
	if (!func_491(iLocal_47, 32768))
	{
		if (bParam0)
...
int func_105(bool bParam0)//Position - 0x3EC3
{
...
void func_106(bool bParam0)//Position - 0x3EEB
{
	if (!PED::IS_PED_INJURED(iLocal_94))
	{
...
void func_107(int iParam0, bool bParam1)//Position - 0x3F15
{
	int iVar0;
	float fVar1;
...
var func_108(bool bParam0)//Position - 0x40E6
{
	if (!func_491(iLocal_47, 32768))
	{
		if (bParam0)
...
void func_109(int iParam0, int iParam1)//Position - 0x412C
{
...
var func_110(bool bParam0)//Position - 0x415E
{
	if (!func_491(iLocal_47, 32768))
	{
		if (bParam0)
...
void func_114(char* sParam0)//Position - 0x4315
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, true, true, -1);
}

void func_115(int* iParam0)//Position - 0x432B
{
	iParam0->f_1 = 0f;
	iParam0->f_2 = 0f;
	*iParam0 = 0;
...
void func_116(int iParam0)//Position - 0x4341
{
	int iVar0;
...
void func_117(int iParam0)//Position - 0x437C
{
	int iVar0;
	struct<3> Var1;
...
void func_118(int iParam0)//Position - 0x43C4
{
	int iVar0;
...
char* func_119(int iParam0)//Position - 0x43F2
{
	char* sVar0;
...
void func_120(var uParam0, int iParam1)//Position - 0x4481
{
...
float func_121(int* iParam0)//Position - 0x449E
{
	if (func_10(iParam0))
	{
		if (func_9(iParam0))
...
void func_122(var uParam0)//Position - 0x44D7
{
	bool bVar0;
	int iVar1;
...
void func_123(bool bParam0)//Position - 0x4565
{
	struct<3> Var0;
...
void func_124(var uParam0)//Position - 0x45E9
{
...
bool func_127(int iParam0)//Position - 0x4931
{
	int iVar0;
...
void func_131(char* sParam0)//Position - 0x49CC
{
	if (AUDIO::IS_AUDIO_SCENE_ACTIVE(sParam0))
	{
...
void func_136()//Position - 0x4F5A
{
	switch (func_26(PLAYER::PLAYER_PED_ID()))
	{
		case 0:
			Global_113810.f_10052.f_90[0]++;
			func_137(0, 1, 1);
			break;
		
		case 1:
			Global_113810.f_10052.f_90[1]++;
			func_137(1, 1, 1);
			break;
		
		case 2:
			Global_113810.f_10052.f_90[2]++;
			func_137(2, 1, 1);
			break;
...
void func_137(int iParam0, int iParam1, int iParam2)//Position - 0x4FFD
{
	int iVar0;
	int iVar1;
...
void func_138(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x50EB
{
	int iVar0;
...
int func_139(int iParam0, var uParam1)//Position - 0x510E
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_140(uParam1));
}

int func_140(var uParam0)//Position - 0x5123
{
	int iVar0;
	int iVar1;
...
int func_141()//Position - 0x5157
{
	return Global_1574918;
}

int func_142(int iParam0, int iParam1)//Position - 0x5163
{
	int iVar0;
	var uVar1;
...
void func_143(int iParam0)//Position - 0x5192
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Global_113810.f_10052.f_1[iVar0 /*11*/].f_10 = ENTITY::GET_ENTITY_MODEL(iParam0);
	iVar2 = 0;
	while (iVar2 < 2)
	{
		iVar1 = iVar2;
...
void func_144(int iParam0, int iParam1, var uParam2)//Position - 0x5231
{
	if (iParam0 > -1)
	{
		Global_113810.f_10052.f_1[iParam0 /*11*/].f_7[iParam1] = uParam2;
	}
}

int func_145(int iParam0, int iParam1)//Position - 0x5254
{
	return PED::GET_PED_TEXTURE_VARIATION(iParam0, func_82(iParam1));
}

void func_146(int iParam0, int iParam1, var uParam2)//Position - 0x5268
{
	if (iParam0 > -1)
	{
		Global_113810.f_10052.f_1[iParam0 /*11*/].f_4[iParam1] = uParam2;
	}
}

int func_147(int iParam0, int iParam1)//Position - 0x528B
{
	return PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_86(iParam1));
}

var func_148(int iParam0)//Position - 0x529F
{
	return func_149(iParam0);
}

char* func_149(int iParam0)//Position - 0x52AD
{
	char* sVar0;
...
void func_151(int iParam0)//Position - 0x5367
{
	if (iParam0 > -1)
	{
		if (func_23() == 0)
		{
			Global_113810.f_10052.f_1[iParam0 /*11*/][0]++;
		}
		else if (func_23() == 1)
		{
			Global_113810.f_10052.f_1[iParam0 /*11*/][1]++;
		}
		else if (func_23() == 2)
		{
			Global_113810.f_10052.f_1[iParam0 /*11*/][2]++;
		}
	}
}

void func_152(int iParam0, int iParam1, int iParam2)//Position - 0x53F9
{
	bool bVar0;
...
void func_153()//Position - 0x54DF
{
	...
	{
		func_155(13, SYSTEM::FLOOR(Global_113810.f_10197.f_3853));
	}
...
int func_154()//Position - 0x599D
{
	return Global_32283;
}

int func_155(int iParam0, int iParam1)//Position - 0x59A8
{
	int iVar0;
...
void func_156(int iParam0, bool bParam1, int iParam2)//Position - 0x59F9
{
	if (iParam2 == -1)
	{
		iParam2 = func_141();
...
void func_158(bool bParam0, bool bParam1)//Position - 0x5A58
{
	int iVar0;
...
void func_159(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, float fParam5, int iParam6, int iParam7, float fParam8, int iParam9)//Position - 0x5AD1
{
	if (func_551())
	{
...
void func_160(bool bParam0, bool bParam1)//Position - 0x5B01
{
	int iVar0;
...
void func_161(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, float fParam5, int iParam6, int iParam7, float fParam8)//Position - 0x5B8A
{
	if (func_551())
	{
...
void func_162(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x5BB0
{
	struct<3> Var0;
...
void func_163(int iParam0, struct<3> Param1, struct<3> Param4, bool bParam7)//Position - 0x5C16
{
	if (!func_551())
	{
...
void func_164(int iParam0, int iParam1, int iParam2)//Position - 0x5C36
{
...
int func_165(struct<3> Param0, struct<3> Param3, bool bParam6, bool bParam7, int iParam8)//Position - 0x5C69
{
	int iVar0;
...
void func_166(bool bParam0, bool bParam1)//Position - 0x5CC4
{
	int iVar0;
...
void func_167(bool bParam0, bool bParam1)//Position - 0x5D3D
{
	int iVar0;
...
int func_168(bool bParam0, int iParam1, int iParam2)//Position - 0x5DBD
{
	if (bParam0)
	{
		return iParam1;
...
var func_171(int iParam0, int iParam1)//Position - 0x5E35
{
	var uVar0;
	int iVar1;
...
var func_172(int iParam0, int iParam1)//Position - 0x5E53
{
	var uVar0;
	var uVar1;
...
void func_173(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x5E69
{
	switch (iParam0)
	{
		case 0:
...
void func_175(bool bParam0, bool bParam1)//Position - 0x610A
{
	int iVar0;
...
void func_176(bool bParam0, bool bParam1)//Position - 0x6183
{
	int iVar0;
...
void func_177(bool bParam0, bool bParam1)//Position - 0x6203
{
	int iVar0;
...
void func_178(bool bParam0, bool bParam1)//Position - 0x627C
{
	int iVar0;
...
float func_179(int iParam0)//Position - 0x62FC
{
	float fVar0;
...
void func_180(int iParam0)//Position - 0x6324
{
	if (!func_219(iParam0))
	{
		return;
...
void func_181(bool bParam0, bool bParam1)//Position - 0x6339
{
	int iVar0;
...
void func_182(bool bParam0, bool bParam1)//Position - 0x63B2
{
	int iVar0;
...
void func_183(int iParam0, int iParam1)//Position - 0x6433
{
...
void func_184(int iParam0)//Position - 0x6479
{
	var uVar0;
	var uVar1;
	struct<3> Var2;
...
void func_185(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x65E4
{
	uParam0->f_1 = { Param4 };
...
float func_186(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5)//Position - 0x6636
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param3.f_0 - Param0.f_0), (Param3.f_1 - Param0.f_1));
}

Vector3 func_187(int iParam0)//Position - 0x6650
{
	struct<3> Var0;
	var uVar3;
	struct<2> Var6;
...
Vector3 func_188()//Position - 0x6729
{
	struct<3> Var0;
	struct<3> Var3;
	struct<2> Var6;
...
void func_189(int iParam0, bool bParam1)//Position - 0x678D
{
	if (bParam1)
	{
...
void func_190(int iParam0)//Position - 0x67AF
{
...
void func_191(var uParam0)//Position - 0x687A
{
	if (*uParam0 < 3)
	{
		*uParam0++;
...
void func_193(var uParam0)//Position - 0x691F
{
	var uVar0[4];
	struct<3> Var5;
	float fVar8;
...
float func_194(float fParam0, float fParam1, float fParam2)//Position - 0x6AB9
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_195(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x6AE0
{
...
void func_197(int iParam0)//Position - 0x6F09
{
...
bool func_200(int iParam0)//Position - 0x6F8F
{
...
void func_205(int iParam0)//Position - 0x71A6
{
	switch (iParam0)
	{
		case 0:
...
int func_206(int iParam0)//Position - 0x722D
{
	if (!func_207(iParam0))
	{
		return 1;
...
int func_207(var uParam0)//Position - 0x725D
{
	int iVar0;
...
int func_209(float fParam0)//Position - 0x7316
{
	float fVar0;
...
int func_210(int iParam0, bool bParam1, bool bParam2)//Position - 0x7342
{
	int iVar0;
...
void func_211(bool bParam0, bool bParam1)//Position - 0x73A2
{
	if (!func_551())
	{
		return;
...
void func_212(int iParam0, int iParam1)//Position - 0x73DD
{
	int iVar0;
...
void func_213(int iParam0)//Position - 0x7404
{
	if (func_218())
	{
		return;
...
void func_214(int iParam0)//Position - 0x7437
{
	if (func_218())
	{
		return;
...
void func_215(bool bParam0, bool bParam1)//Position - 0x74C1
{
	if (bParam0)
	{
		if (func_217(0))
...
bool func_216()//Position - 0x7535
{
	return BitTest(Global_1963795, 5);
}

int func_217(int iParam0)//Position - 0x7543
{
	if (iParam0 == 1)
	{
		if (Global_20500.f_1 > 3)
...
bool func_218()//Position - 0x759A
{
	return BitTest(Global_1963795, 19);
}

bool func_219(int iParam0)//Position - 0x75A9
{
	bool bVar0;
...
float func_221()//Position - 0x7619
{
	switch (func_23())
	{
		case 0:
...
Vector3 func_222()//Position - 0x765E
{
	switch (func_23())
	{
		case 0:
...
float func_224()//Position - 0x771F
{
	switch (func_23())
	{
		case 0:
...
int func_225(int* iParam0, float fParam1)//Position - 0x7764
{
	if (func_10(iParam0))
	{
...
void func_226(var uParam0)//Position - 0x7786
{
	int iVar0;
	int iVar1;
...
void func_227(int iParam0, var uParam1)//Position - 0x77C5
{
	var uVar0;
...
void func_228(var uParam0, var uParam1)//Position - 0x77E3
{
...
void func_229(var uParam0)//Position - 0x7841
{
	int iVar0;
...
void func_230(var uParam0)//Position - 0x7890
{
	int iVar0;
...
void func_231(var uParam0)//Position - 0x78E3
{
	int iVar0;
	struct<3> Var1;
		...
		case 3:
			...
			if (MISC::IS_PC_VERSION())
			{
				if (PAD::IS_USING_CURSOR(2 /*FRONTEND_CONTROL*/))
				{
					...
					if (func_288())
					{
						if (Global_4541034 != iLocal_68)
						{
							AUDIO::PLAY_SOUND_FRONTEND(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
							iLocal_68 = Global_4541034;
...
int func_233(int iParam0)//Position - 0x7FCB
{
	if (MISC::IS_AUSSIE_VERSION())
	{
		if (iParam0 == 0)
...
void func_234(int iParam0)//Position - 0x8038
{
	var uVar0;
...
void func_235(int iParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0x807A
{
	int iVar0;
...
int func_236(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x893F
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_237(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x8AEC
{
	switch (iParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
void func_238(int iParam0)//Position - 0x8B24
{
	bool bVar0;
...
void func_239(var uParam0)//Position - 0x8B78
{
	uParam0->f_66 = 0;
...
void func_240(var uParam0)//Position - 0x8C88
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_241(int iParam0)//Position - 0x8CD0
{
...
void func_242(int iParam0, int iParam1)//Position - 0x8CFB
{
	Global_2697092 = iParam1;
	Global_2697091 = iParam0;
}

int func_243(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, int iParam10)//Position - 0x8D0F
{
	int iVar0;
...
void func_244(struct<67> Param0, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, int iParam85)//Position - 0x8E4C
{
	struct<3> Var0;
	int iVar36;
...
void func_245()//Position - 0x8EDE
{
	SCRIPT::REQUEST_SCRIPT("AM_ARENA_SHP");
}

var func_246(int iParam0)//Position - 0x8EEE
{
	var uVar0;
...
int func_248(int iParam0, int iParam1, int iParam2)//Position - 0x8F20
{
...
int func_249(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x8F54
{
	float fVar0;
	bool bVar1;
	int iVar2;
...
void func_250(bool bParam0)//Position - 0x9553
{
	int iVar0;
	int iVar1;
...
void func_251(int iParam0)//Position - 0x97D5
{
	int iVar0;
...
void func_252(bool bParam0)//Position - 0x982F
{
	bool bVar0;
	char cVar1[64];
	...
	else if (BitTest(Global_113810.f_20567.f_471, bParam0) || BitTest(Global_2359296[func_254() /*5568*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), bParam0);
...
char* func_253(bool bParam0)//Position - 0x99A9
{
	switch (bParam0)
	{
		case 0:
...
void func_255(int iParam0)//Position - 0x9AB9
{
	func_273(93, iParam0);
	func_273(29, iParam0);
	func_273(30, iParam0);
...
int func_256(int iParam0)//Position - 0x9AD9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_257(int iParam0, int iParam1)//Position - 0x9C79
{
	if (iParam1 == -1)
	{
		iParam1 = func_141();
...
int func_258(bool bParam0)//Position - 0x9C95
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_259(int iParam0, int iParam1)//Position - 0x9D4C
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_260(int iParam0, int iParam1)//Position - 0x9D67
{
	...
	if (func_270(&Global_4542602))
	{
		if (func_268(&Global_4542602, iParam0))
		{
			return 0;
		}
		if (func_261(&Global_4542602, iParam0))
		{
			return 1;
		}
	}
...
int func_261(var uParam0, int iParam1)//Position - 0x9E04
{
	int iVar0;
	var uVar1[78];
...
int func_262(var uParam0, int iParam1)//Position - 0x9EB5
{
	int iVar0;
...
bool func_263(var uParam0, int iParam1)//Position - 0x9F30
{
	return (*uParam0)[iParam1] == 78;
}

void func_264(var uParam0)//Position - 0x9F41
{
	int iVar0;
	...
	func_266(uParam0, (Global_4542601 - 0.5f));
}

void func_265(var uParam0, int iParam1)//Position - 0x9F75
{
	(*uParam0)[iParam1] = 78;
}

void func_266(var uParam0, float fParam1)//Position - 0x9F85
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_267(var uParam0)//Position - 0x9FA2
{
	return uParam0->f_80;
}

bool func_268(var uParam0, int iParam1)//Position - 0x9FAE
{
	return func_269(uParam0, iParam1) != -1;
}

int func_269(var uParam0, int iParam1)//Position - 0x9FC0
{
	int iVar0;
...
bool func_270(var uParam0)//Position - 0x9FED
{
	return uParam0->f_79 == 1;
}

int func_271(int iParam0)//Position - 0x9FFB
{
	switch (iParam0)
	{
		case 60:
...
void func_272(int iParam0, int iParam1)//Position - 0xA04B
{
	int iVar0;
...
void func_273(int iParam0, int iParam1)//Position - 0xA06E
{
	int iVar0;
...
int func_275(int iParam0)//Position - 0xA140
{
	return Global_2058[iParam0 /*29*/].f_17;
}

int func_276()//Position - 0xA151
{
	if (func_551())
	{
...
int func_277(int iParam0)//Position - 0xA176
{
	var uVar0;
...
var func_278(int iParam0)//Position - 0xA1CE
{
	var uVar0;
...
int func_279(int iParam0)//Position - 0xA1E0
{
	if (iParam0 > -1)
	{
...
int func_280(int iParam0)//Position - 0xA223
{
	if (!func_207(iParam0))
	{
		return 0;
...
void func_281(bool bParam0)//Position - 0xA242
{
...
void func_282()//Position - 0xA25F
{
	Global_23251.f_5 = 0;
}

void func_283(int iParam0, bool bParam1, int iParam2)//Position - 0xA26D
{
	int iVar0;
	int iVar1;
...
void func_286()//Position - 0xA45D
{
	iLocal_44++;
	iLocal_45 = 1;
}

void func_287()//Position - 0xA46E
{
	iLocal_43++;
	iLocal_45 = 1;
}

int func_288()//Position - 0xA47F
{
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(2 /*FRONTEND_CONTROL*/))
	{
		if (Global_4541034 > -1)
...
int func_289(int iParam0, int iParam1, bool bParam2)//Position - 0xA4A6
{
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(2 /*FRONTEND_CONTROL*/))
	{
		return 0;
...
void func_290(bool bParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0xA586
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (((fVar7 >= fVar0 && fVar7 <= fVar2) && fVar8 >= fVar1) && fVar8 <= fVar3)
	{
		...
		if (bParam3)
		{
			if (!bParam1 || iVar13 != 0)
			{
				GRAPHICS::SET_SCRIPT_GFX_ALIGN(76, 84);
				GRAPHICS::SET_SCRIPT_GFX_ALIGN_PARAMS(-0.05f, -0.05f, 0f, 0f);
				func_291(fVar4, (fVar5 + (IntToFloat(iVar13) * 0.034722f)), Global_23389, (0.034722f - 0.0015f), 255, 255, 255, iVar10);
				GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
			}
		}
...
void func_291(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0xA832
{
	GRAPHICS::DRAW_RECT((fParam0 + (fParam2 * 0.5f)), (fParam1 + (fParam3 * 0.5f)), fParam2, fParam3, iParam4, iParam5, iParam6, iParam7, false);
}

void func_292(bool bParam0)//Position - 0xA861
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (Global_4541034 == -2)
	{
		func_291(fVar0, fVar1, Global_23389, fVar2, 255, 255, 255, iVar3);
	}
	else if (Global_4541034 == -3)
	{
		func_291(fVar0, (fVar1 + fVar2), Global_23389, fVar2, 255, 255, 255, iVar3);
	}
	GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
}

void func_293()//Position - 0xA8EA
{
...
void func_294(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)//Position - 0xA932
{
...
void func_295(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7, int iParam8)//Position - 0xAA07
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		...
		{
			func_320(Global_23390.f_5661 + 1, "DFLT_MNU_OPT" /* GXT: Exit */, 0, 1, 0, 0, 0);
		...
		if (iVar5 == 1 && Global_23390.f_6171)
		{
			...
			else
			{
				if (Global_23390)
				{
					...
					{
						func_291(Global_23387, Global_23388, fParam5, fVar57, 0, 0, 0, 255);
				...
				func_291(Global_23387, (Global_23388 + fVar57), fParam5, 0.034722f, iVar1, iVar2, iVar3, iVar4);
				...
				{
					func_315();
					func_313((((Global_23387 + fParam5) - 0.00390625f) - func_314("CM_ITEM_COUNT" /* GXT: ~1~ / ~1~ */, Global_23390.f_6179, Global_23390.f_6180)), ((Global_23388 + fVar57) + 0.00416664f), "CM_ITEM_COUNT" /* GXT: ~1~ / ~1~ */, Global_23390.f_6179, Global_23390.f_6180);
				}
				else if (Global_23390.f_6174 > Global_23390.f_5668)
				{
					...
					{
						func_315();
						func_313((((Global_23387 + fParam5) - 0.00390625f) - func_314("CM_ITEM_COUNT" /* GXT: ~1~ / ~1~ */, Global_23390.f_6177, Global_23390.f_6176)), ((Global_23388 + fVar57) + 0.00416664f), "CM_ITEM_COUNT" /* GXT: ~1~ / ~1~ */, Global_23390.f_6177, Global_23390.f_6176);
					}
				}
			}
			...
			if (Global_23390.f_6174 > Global_23390.f_5668)
			{
				...
				func_291(Global_23387, (fVar51 + 0f), fParam5, 0.034722f, iVar1, iVar2, iVar3, iVar4);
			...
			if (MISC::GET_HASH_KEY(&(Global_23390.f_5081)) != 0 && Global_23390.f_5163 != -1)
			{
				...
				{
					func_326(Global_23390.f_5165, 1, 1, &fVar36, &fVar37, bParam7);
				...
				func_291(Global_23387, (fVar51 - 0.00277776f), fParam5, 0.00277776f, iVar1, iVar2, iVar3, iVar4);
				...
				{
					func_326(Global_23390.f_5165, 1, 1, &fVar36, &fVar37, bParam7);
					func_311(Global_23390.f_5165, 1, &iVar47, &iVar48, &iVar49, &iVar50);
					GRAPHICS::DRAW_SPRITE(func_319(Global_23390.f_5165), func_316(Global_23390.f_5165, 1), ((Global_23387 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false, 0);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_4540958.f_21)) != 0 && Global_4540958.f_65 != -1)
			{
				...
				{
					func_326(Global_4540958.f_67, 1, 1, &fVar36, &fVar37, bParam7);
					fVar42 = (((Global_23387 + fVar36) + (0.00078125f * 4f)) - (0.00078125f * 1f));
				}
				func_312(fVar42);
				...
				{
					func_326(Global_4540958.f_67, 1, 1, &fVar36, &fVar37, bParam7);
					func_311(Global_4540958.f_67, 1, &iVar47, &iVar48, &iVar49, &iVar50);
					GRAPHICS::DRAW_SPRITE(func_319(Global_4540958.f_67), func_316(Global_4540958.f_67, 1), ((Global_23387 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false, 0);
				}
				fVar51 = (fVar51 + (((HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
						...
						switch (Global_23390.f_5499[iVar8])
						{
								...
								if (bVar33)
								{
									if (!Global_23390.f_6172)
									{
										...
										if (MISC::GET_HASH_KEY(&(Global_23390.f_79[iVar24 /*6*/])) != 0)
										{
											...
											func_302(bVar32, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar55, iVar104, bVar53, bVar52);
										...
										if (iVar28 > 0)
										{
											...
											while (iVar14 < iVar28)
											{
												if (func_326(Global_23390.f_4824[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
									...
									if (MISC::GET_HASH_KEY(&(Global_23390.f_79[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										func_302(bVar32, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar55, 0, bVar53, bVar52);
									...
									while (iVar14 < 4)
									{
										...
										else if (Global_23390.f_2387[iVar24 /*5*/][iVar14] == 4)
										{
											...
											{
												if (func_326(Global_23390.f_4824[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													fVar42 = (fVar42 + (fVar36 * 0.5f));
													if (func_326(Global_23390.f_4824[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
													{
														func_311(Global_23390.f_4824[(iVar22 + iVar28)], bVar32, &iVar47, &iVar48, &iVar49, &iVar50);
														if (iVar5 == 1)
														{
															if (Global_23390.f_5526[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_319(Global_23390.f_4824[(iVar22 + iVar28)]), func_316(Global_23390.f_4824[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar42) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_319(Global_23390.f_4824[(iVar22 + iVar28)]), func_316(Global_23390.f_4824[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar42) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false, 0);
															}
														}
										...
										else
										{
											...
											if (func_300() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (iVar8 == 0)
												{
													...
													func_302(0, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar55, 0, bVar53, bVar52);
										...
										while (iVar14 < iVar28)
										{
											if ((Global_23390.f_4824[(iVar22 + iVar14)] != 2 && Global_23390.f_4824[(iVar22 + iVar14)] != 52) && Global_23390.f_4824[(iVar22 + iVar14)] != 62)
											{
												if (func_326(Global_23390.f_4824[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														if (func_326(Global_23390.f_4824[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															func_311(Global_23390.f_4824[(iVar22 + iVar14)], bVar32, &iVar47, &iVar48, &iVar49, &iVar50);
															if (Global_23390.f_4824[(iVar22 + iVar14)] == 30)
															{
																GRAPHICS::DRAW_SPRITE(func_319(Global_23390.f_4824[(iVar22 + iVar14)]), func_316(Global_23390.f_4824[(iVar22 + iVar14)], bVar32), (Global_23387 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false, 0);
															}
															else if (Global_23390.f_5526[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_319(Global_23390.f_4824[(iVar22 + iVar14)]), func_316(Global_23390.f_4824[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar42) + fVar43) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_319(Global_23390.f_4824[(iVar22 + iVar14)]), func_316(Global_23390.f_4824[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar42) + fVar43) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false, 0);
															}
														}
													}
							...
							case 2:
								if (bVar33)
								{
									if (!Global_23390.f_6172)
									{
										func_302(bVar32, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar55, 0, 0, 0);
										if (Global_23390.f_8888 && Global_23390.f_8889 == iVar6)
										{
											func_301(bVar32);
										}
									...
									{
										func_302(bVar32, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar55, 0, 0, 0);
										func_299((fVar34 + fVar42), fVar35, "NUMBER", Global_23390.f_4309[iVar20], 0);
									}
								}
								bVar41 = true;
								iVar20++;
							...
							case 3:
								if (bVar33)
								{
									...
									func_302(bVar32, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar55, 0, 0, 0);
									func_298((fVar34 + fVar42), fVar35, "NUMBER", Global_23390.f_4566[iVar21], Global_23390.f_4695[iVar21]);
								}
								bVar41 = true;
								iVar21++;
								break;
							...
							case 4:
								if (bVar33)
								{
									if (func_326(Global_23390.f_4824[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										if (!Global_23390.f_6172)
										{
											fVar44 = fVar36;
										...
										if (iVar5 == 1)
										{
											if (func_326(Global_23390.f_4824[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												func_311(Global_23390.f_4824[iVar22], bVar32, &iVar47, &iVar48, &iVar49, &iVar50);
												GRAPHICS::DRAW_SPRITE(func_319(Global_23390.f_4824[iVar22]), func_316(Global_23390.f_4824[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), (fVar36 * func_297(Global_23390.f_4824[iVar22])), (fVar37 * func_297(Global_23390.f_4824[iVar22])), 0f, iVar47, iVar48, iVar49, iVar50, false, 0);
											}
										}
									}
								}
...
void func_296(int iParam0)//Position - 0xDB64
{
	Global_1655612.f_1163 = iParam0;
}

float func_297(int iParam0)//Position - 0xDB75
{
	switch (iParam0)
	{
		case 35:
...
void func_298(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4)//Position - 0xDBE4
{
...
void func_299(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0xDC03
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
bool func_300()//Position - 0xDC21
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

void func_301(bool bParam0)//Position - 0xDC32
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_302(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xDC78
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam2)
	{
		if (bParam3)
		{
			func_303(Global_23390.f_6454[iParam4], &iVar0, &iVar1, &iVar2);
...
void func_303(int iParam0, var uParam1, var uParam2, var uParam3)//Position - 0xDE26
{
	switch (iParam0)
	{
		case 0:
...
void func_304(int* iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)//Position - 0xE0B0
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_23390.f_5166 != 0)
	{
		...
		if (!Global_23390.f_5167)
		{
			...
			if (MISC::GET_HASH_KEY(&(Global_4540958.f_16)) != MISC::GET_HASH_KEY(""))
			{
				...
				func_306(&Global_4540958);
				if (Global_4540958.f_20 == -1)
				{
					func_305(&(Global_4540958.f_16));
				}
				else
				{
...
void func_305(char* sParam0)//Position - 0xE5B5
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_306(char* sParam0)//Position - 0xE5C7
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
}

bool func_307(int iParam0, int iParam1)//Position - 0xE5D5
{
	bool bVar0;
...
int func_308(int iParam0, bool bParam1)//Position - 0xE62E
{
	int iVar0;
	int iVar1;
...
void func_311(int iParam0, bool bParam1, int* iParam2, int* iParam3, int* iParam4, int* iParam5)//Position - 0xE6F7
{
...
void func_312(float fParam0)//Position - 0xE818
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_313(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0xE877
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam3);
...
float func_314(char* sParam0, int iParam1, int iParam2)//Position - 0xE89A
{
...
var func_316(int iParam0, bool bParam1)//Position - 0xE966
{
	char* sVar0[2];
	var uVar3;
	struct<13> Var19;
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_23390.f_7488[iParam0 /*16*/])))
	{
		...
		{
			return func_317(&(Global_23390.f_7488[iParam0 /*16*/]));
		}
	}
	switch (iParam0)
	{
...
var func_317(var uParam0)//Position - 0xEE90
{
	return uParam0;
}

struct<13> func_318(int iParam0)//Position - 0xEE9A
{
	struct<13> Var0;
...
char* func_319(int iParam0)//Position - 0xEEB1
{
	var uVar0;
	struct<13> Var16;
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_23390.f_6463[iParam0 /*16*/])))
	{
		...
		{
			return func_317(&(Global_23390.f_6463[iParam0 /*16*/]));
		}
	}
	if (iParam0 == 52)
	{
...
void func_320(int iParam0, char* sParam1, int iParam2, bool bParam3, int iParam4, bool bParam5, int iParam6)//Position - 0xEF26
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	if (!bParam3)
	{
		func_323(Global_23390.f_5661, 1);
	}
	else
	{
		func_323(Global_23390.f_5661, 0);
	}
	if (iParam2 == 0)
	{
		fVar1 = func_322(&(Global_23390.f_79[Global_23390.f_5663 /*6*/]));
	...
	if (bParam5)
	{
		if (iParam2 == 0)
		{
			fVar4 = func_321(&(Global_23390.f_79[Global_23390.f_5663 /*6*/]));
...
float func_321(char* sParam0)//Position - 0xF142
{
...
float func_322(char* sParam0)//Position - 0xF15E
{
	if (!MISC::IS_STRING_NULL(sParam0))
	{
		if (MISC::GET_HASH_KEY(sParam0) == 0)
...
void func_323(int iParam0, bool bParam1)//Position - 0xF19B
{
	int iVar0;
...
void func_324(bool bParam0, int* iParam1, int* iParam2, float fParam3)//Position - 0xF1E7
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_325(int iParam0, int iParam1)//Position - 0xF26F
{
	return (SYSTEM::TO_FLOAT(iParam0) / SYSTEM::TO_FLOAT(iParam1)) > 3.5f;
}

int func_326(int iParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)//Position - 0xF28A
{
	char cVar0[64];
	char cVar16[64];
	int iVar32;
...
float func_327(int iParam0)//Position - 0xF3B6
{
	switch (iParam0)
	{
		case 33:
...
int func_328(bool bParam0, bool bParam1)//Position - 0xF48A
{
	if (Global_2672524.f_1685.f_701 != 0)
	{
		return 1;
	}
	if ((((((((!CAM::IS_SCREEN_FADED_IN() || (func_30(8, -1) && func_329() != 65)) || (HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1)) || (STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0)) || NETWORK::IS_COMMERCE_STORE_OPEN()) || Global_78950) || Global_23390.f_8891) || HUD::IS_WARNING_MESSAGE_ACTIVE()) || Global_100885.f_1482)
	{
		return 0;
	}
	return 1;
...
int func_329()//Position - 0xF527
{
	return Global_1574996;
}

int func_330(var uParam0, bool bParam1, int iParam2)//Position - 0xF533
{
	char cVar0[64];
	int iVar16;
	int iVar17;
...
bool func_332(int iParam0)//Position - 0xF64A
{
	return func_333(func_349(), iParam0);
}

int func_333(int iParam0, int iParam1)//Position - 0xF65C
{
	int iVar0;
	int iVar1;
...
int func_334(int iParam0)//Position - 0xF768
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_335(int iParam0)//Position - 0xF77B
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_336(int iParam0)//Position - 0xF78E
{
...
int func_338(int iParam0)//Position - 0xF7B3
{
	return iParam0 & 15;
}

var func_339(int iParam0)//Position - 0xF7C0
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_168(BitTest(iParam0, 31), -1, 1)) + 2011;
}

void func_340(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xF7E2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_341(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xF964
{
...
void func_342(var uParam0, int iParam1)//Position - 0xF99C
{
	if (iParam1 <= 0)
	{
		return;
...
void func_343(var uParam0, int iParam1)//Position - 0xFA22
{
	int iVar0;
	int iVar1;
...
void func_344(var uParam0, int iParam1)//Position - 0xFA73
{
...
void func_345(var uParam0, int iParam1)//Position - 0xFAA6
{
...
void func_346(var uParam0, int iParam1)//Position - 0xFAE0
{
...
void func_347(var uParam0, int iParam1)//Position - 0xFB1B
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_348(int iParam0, int iParam1)//Position - 0xFB57
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
void func_350(char* sParam0, int iParam1)//Position - 0xFC3F
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

void func_351()//Position - 0xFC56
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_352()//Position - 0xFD78
{
	Global_23251.f_5 = 1;
}

int func_353(int iParam0)//Position - 0xFD86
{
	int iVar0;
...
void func_354(int iParam0, bool bParam1)//Position - 0xFE74
{
	float fVar0;
	float fVar1;
	var uVar2;
...
float func_355()//Position - 0xFFAF
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar0 < iVar1)
	{
		...
		{
			if (func_326(Global_23390.f_4824[((Global_23390.f_5667 - iVar1) + iVar0)], 1, 0, &uVar3, &fVar4, 0))
			{
				if (fVar4 > fVar2)
				{
					fVar2 = fVar4;
...
float func_356()//Position - 0x10065
{
	float fVar0;
	float fVar1;
	var uVar2;
	...
	while (iVar7 < iVar5)
	{
		...
		{
			func_326(Global_23390.f_4824[((Global_23390.f_5667 - iVar5) + iVar7)], 1, 0, &fVar1, &uVar2, 0);
			fVar0 = (fVar0 + fVar1);
		}
		iVar7++;
	}
...
void func_357(int iParam0, char* sParam1, int iParam2, bool bParam3)//Position - 0x104AC
{
	char* sVar0;
...
void func_358(char* sParam0)//Position - 0x10561
{
	int iVar0;
...
void func_359(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x105AC
{
...
void func_360(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x105EB
{
...
void func_361(bool bParam0, bool bParam1)//Position - 0x10695
{
	int iVar0;
	int iVar1;
	float fVar2;
...
void func_362(bool bParam0)//Position - 0x10B88
{
	if (!bParam0)
	{
...
int func_363(char* sParam0, int iParam1)//Position - 0x10BA6
{
...
int func_364(int iParam0)//Position - 0x10BF0
{
	int iVar0;
...
int func_365(int iParam0, bool bParam1)//Position - 0x10C13
{
	int iVar0;
...
var func_366(bool bParam0)//Position - 0x10DA5
{
	if (!func_491(iLocal_47, 32768))
	{
		if (bParam0)
...
void func_367(int iParam0)//Position - 0x10DEB
{
	*iParam0 = -15;
}

int func_368(int iParam0)//Position - 0x10DF9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_369()//Position - 0x10ED5
{
	if (PED::IS_PED_INJURED(iLocal_94))
	{
		return;
...
bool func_371(char* sParam0, int iParam1, bool bParam2)//Position - 0x10F46
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	bVar2 = func_372(&(Global_23390.f_6103[iVar0 /*10*/]));
	if (!bVar1 || !bVar2)
	{
	}
	return (bVar1 && bVar2);
...
bool func_372(var uParam0)//Position - 0x1103C
{
	switch (uParam0->f_9)
	{
		case 0:
...
void func_373()//Position - 0x110DE
{
	if (!func_551())
	{
		return;
...
void func_374()//Position - 0x11102
{
	int iVar0;
...
void func_375(bool bParam0, int iParam1)//Position - 0x1114B
{
	int iVar0;
	...
	if (bParam0)
	{
		func_376(&(Global_23390.f_6103[iVar0 /*10*/]));
...
void func_376(int* iParam0)//Position - 0x11209
{
	if (iParam0->f_9 != 0)
	{
...
void func_378()//Position - 0x112AA
{
	if (iLocal_70 == 0)
	{
...
int func_379(int iParam0)//Position - 0x11332
{
	struct<3> Var0;
	struct<3> Var3;
	int iVar6;
	...
	if (iLocal_306[iParam0] == 0)
	{
		...
		else if (((ENTITY::GET_ENTITY_MODEL(iLocal_97) == joaat("casco") || ENTITY::GET_ENTITY_MODEL(iLocal_97) == joaat("feltzer3")) || ENTITY::GET_ENTITY_MODEL(iLocal_97) == joaat("fagaloa")) || ENTITY::GET_ENTITY_MODEL(iLocal_97) == joaat("warrener2"))
		{
...
void func_380(int iParam0)//Position - 0x1146B
{
	switch (iParam0)
	{
		case 0:
...
void func_381()//Position - 0x1150B
{
...
void func_382()//Position - 0x11546
{
	struct<7> Var0;
	struct<7> Var7;
...
void func_383(var uParam0, var uParam1)//Position - 0x115DC
{
	switch (func_23())
	{
		case 0:
...
void func_384(int iParam0)//Position - 0x11716
{
	int iVar0;
...
Vector3 func_385()//Position - 0x11775
{
	switch (func_23())
	{
		case 0:
...
Vector3 func_388()//Position - 0x11842
{
	switch (func_23())
	{
		case 0:
...
void func_389()//Position - 0x118A7
{
	func_331();
	func_404();
	if (!func_10(&iLocal_105))
...
void func_390()//Position - 0x11A59
{
	iLocal_49 = 0;
	iLocal_306[0] = 0;
	iLocal_306[1] = 0;
...
void func_391()//Position - 0x11A80
{
	if (PED::IS_PED_INJURED(iLocal_94))
	{
		return;
...
void func_393()//Position - 0x11ACE
{
	if (func_551())
	{
...
void func_394()//Position - 0x11AFF
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_398(struct<3> Param0)//Position - 0x11DA9
{
...
int func_399(struct<3> Param0)//Position - 0x11F11
{
...
int func_400(struct<3> Param0)//Position - 0x12024
{
	int iVar0;
...
int func_401(int iParam0, var* uParam1)//Position - 0x1210A
{
	struct<3> Var0[4];
...
bool func_402()//Position - 0x121D1
{
	return Global_75816;
}

int func_403()//Position - 0x121DD
{
...
void func_404()//Position - 0x12209
{
...
void func_405(int iParam0, bool bParam1)//Position - 0x1224F
{
	if (bParam1)
	{
...
void func_406(int iParam0, int iParam1, bool bParam2)//Position - 0x12286
{
	int iVar0;
...
int func_407(int iParam0)//Position - 0x122F6
{
	switch (iParam0)
	{
		case 0:
...
void func_408(int iParam0, int iParam1, bool bParam2)//Position - 0x1269E
{
	int iVar0;
...
int func_409(int iParam0, int iParam1, bool bParam2)//Position - 0x1270E
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_410(var uParam0)//Position - 0x1276E
{
	if (func_491(iLocal_47, 2))
	{
		if (!func_63())
...
void func_411()//Position - 0x127A5
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_94, false))
	{
...
bool func_412(float fParam0)//Position - 0x12B5B
{
	if (!func_10(&iLocal_111))
	{
		func_40(&iLocal_111);
...
float func_413(int iParam0, int iParam1, bool bParam2)//Position - 0x12B7C
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_414(int iParam0)//Position - 0x12BDA
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_415(int iParam0)//Position - 0x12C05
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_416(int iParam0)//Position - 0x12C30
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_417(int iParam0)//Position - 0x12C5B
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_418(int iParam0)//Position - 0x12C86
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_419(int iParam0)//Position - 0x12CB1
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_420(int iParam0)//Position - 0x12CDC
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_421(int iParam0)//Position - 0x12D07
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_422(int iParam0)//Position - 0x12D32
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_423(int iParam0)//Position - 0x12D63
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_424(int iParam0)//Position - 0x12D8E
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_425(int iParam0)//Position - 0x12DB9
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_426(int iParam0)//Position - 0x12DEA
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_427(int iParam0)//Position - 0x12E1B
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_428(int iParam0)//Position - 0x12E52
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
void func_429(var uParam0)//Position - 0x12ED7
{
	int iVar0;
...
void func_430()//Position - 0x13052
{
	char* sVar0;
	...
	if (iLocal_293 != 5 && func_363(&sVar0, 0))
	{
		...
		if (func_491(iLocal_47, 8192))
		{
			func_468();
			Global_32435 = 1;
			Global_2657704[PLAYER::PLAYER_ID() /*463*/].f_428 = 1;
			func_131("PROSTITUTES_SOLICIT_SCENE");
...
int func_431(int iParam0, bool bParam1)//Position - 0x1314D
{
	int iVar0;
...
int func_432(int iParam0)//Position - 0x13205
{
	int iVar0;
...
void func_433()//Position - 0x13240
{
	if (Global_32435)
	{
		if (HUD::IS_PAUSE_MENU_ACTIVE())
...
bool func_434(int iParam0, int iParam1)//Position - 0x132A2
{
	int iVar0;
	bool bVar1;
...
void func_435(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x13357
{
	int iVar0;
...
void func_436(int iParam0)//Position - 0x13482
{
	int iVar0;
...
int func_438(bool bParam0)//Position - 0x13690
{
	if (ENTITY::IS_ENTITY_DEAD(iLocal_94, false))
	{
		return 0;
	...
	if (!func_377())
	{
		if (!func_551())
		{
			if ((!iLocal_86 && !Global_112857) && func_440(PLAYER::PLAYER_PED_ID(), 0) == -1)
			{
...
void func_439()//Position - 0x137BB
{
...
int func_440(int iParam0, bool bParam1)//Position - 0x1380C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_441()//Position - 0x13891
{
	if (func_438(0))
	{
		func_430();
...
void func_442(var uParam0)//Position - 0x138F3
{
	if (func_438(0))
	{
		func_430();
...
void func_443(var uParam0)//Position - 0x1395C
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
void func_444(var uParam0, var uParam1)//Position - 0x13AAA
{
	int iVar0;
...
void func_445(var uParam0, char* sParam1)//Position - 0x13AE0
{
	func_446(uParam0, 1, -1, sParam1, 0);
}

void func_446(var uParam0, bool bParam1, int iParam2, char* sParam3, int iParam4)//Position - 0x13AF3
{
	int iVar0;
...
void func_447(var uParam0, bool bParam1)//Position - 0x13BD4
{
	int iVar0;
...
void func_448(var uParam0)//Position - 0x13C17
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
...
void func_449(var uParam0)//Position - 0x13C30
{
	int iVar0;
...
void func_450(var uParam0)//Position - 0x13C67
{
	func_451(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

void func_451(int iParam0, char* sParam1, int iParam2)//Position - 0x13C7E
{
...
int func_452(var uParam0)//Position - 0x13D38
{
	bool bVar0;
...
int func_453(var uParam0, char* sParam1)//Position - 0x13D61
{
	int iVar0;
	int iVar1;
...
int func_454(var uParam0)//Position - 0x13DC6
{
	int iVar0;
...
void func_455(var uParam0)//Position - 0x13DF5
{
	char* sVar0;
	...
	if (func_438(1))
	{
		...
		if (func_471(&iLocal_111, 2f) || func_491(iLocal_47, 8192))
		{
			...
			else
			{
				...
				func_5(&iLocal_47, 4);
				Global_32435 = 0;
				Global_2657704[PLAYER::PLAYER_ID() /*463*/].f_428 = 0;
			}
		}
	}
	else
...
void func_456()//Position - 0x13F17
{
	if (!func_524(64))
	{
		func_457(0, 31, 5);
...
void func_457(int iParam0, int iParam1, int iParam2)//Position - 0x13F37
{
	int iVar0;
...
bool func_459()//Position - 0x14033
{
	return Global_2695084;
}

bool func_460()//Position - 0x1403F
{
	return Global_2695872;
}

int func_461(int iParam0, bool bParam1, bool bParam2)//Position - 0x1404B
{
	if (bParam1)
	{
		if (func_462(iParam0))
...
bool func_462(int iParam0)//Position - 0x1407D
{
	return func_463(iParam0);
}

var func_463(int iParam0)//Position - 0x1408B
{
	return BitTest(Global_1853988[iParam0 /*867*/].f_11.f_1, 0);
}

void func_464(int iParam0)//Position - 0x140A2
{
...
bool func_465()//Position - 0x140D1
{
	return Global_2672524.f_2514[0 /*80*/].f_1 != 0;
}

void func_466(char* sParam0, int iParam1)//Position - 0x140E7
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, false, iParam1);
}

char* func_467(char* sParam0)//Position - 0x140FE
{
	return sParam0;
}

void func_468()//Position - 0x14108
{
	if (iLocal_72 != -1)
	{
		func_436(&iLocal_72);
...
void func_469(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1411C
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
bool func_470(char* sParam0)//Position - 0x141B7
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

int func_471(int* iParam0, float fParam1)//Position - 0x141CA
{
...
void func_472(int* iParam0)//Position - 0x141E8
{
	if (!func_10(iParam0))
	{
		func_40(iParam0);
...
void func_473(int iParam0)//Position - 0x14200
{
	bool bVar0;
...
var func_476()//Position - 0x142C3
{
	return Global_2683883.f_735;
}

var func_477()//Position - 0x142D2
{
	return BitTest(Global_2683883.f_2, 11);
}

var func_478()//Position - 0x142E3
{
	return BitTest(Global_2683883, 5);
}

var func_479()//Position - 0x142F1
{
	return BitTest(Global_2683883, 2);
}

var func_480()//Position - 0x142FF
{
	return BitTest(Global_2683883, 20);
}

var func_481()//Position - 0x1430E
{
	return Global_2683883.f_698;
}

void func_482(int iParam0, int iParam1)//Position - 0x1431D
{
	func_483(iParam0, iParam1);
}

void func_483(var uParam0, var uParam1)//Position - 0x1432D
{
	*uParam0 = (*uParam0 || uParam1);
}

int func_484()//Position - 0x1433E
{
	if (Global_32437)
	{
		return 0;
...
int func_486(int iParam0)//Position - 0x1444C
{
	if (!PED::IS_PED_INJURED(*iParam0))
	{
...
int func_487(int iParam0, bool bParam1)//Position - 0x1446E
{
	if (Global_78689)
	{
...
void func_490()//Position - 0x14527
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_94, false))
	{
...
bool func_491(int iParam0, int iParam1)//Position - 0x1458A
{
	return (iParam0 && iParam1) != 0;
}

void func_492(char* sParam0)//Position - 0x14599
{
}

int func_493()//Position - 0x145A1
{
	if (PED::IS_PED_INJURED(iLocal_94))
	{
		return 0;
...
int func_494()//Position - 0x145D7
{
	switch (iLocal_298)
	{
		case 0:
			...
			{
				func_453(&uLocal_285, func_67(iLocal_291));
				func_444(&uLocal_285, &uLocal_392);
...
bool func_495(var uParam0)//Position - 0x1473B
{
	return func_496(uParam0);
}

int func_496(var uParam0)//Position - 0x14749
{
	int iVar0;
...
bool func_497(var uParam0)//Position - 0x147A7
{
	return func_498(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

int func_498(char* sParam0, char* sParam1, int iParam2)//Position - 0x147BE
{
...
float func_500(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x14909
{
	struct<3> Var0;
...
void func_502()//Position - 0x149BC
{
	if (ENTITY::IS_ENTITY_DEAD(iLocal_94, false))
	{
		return;
...
void func_503(int iParam0)//Position - 0x149FB
{
	if (ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
		return;
...
void func_504()//Position - 0x14AAF
{
	if (Global_32435)
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_97, false))
	...
	{
		if (Global_32439 != SCRIPT::GET_ID_OF_THIS_THREAD() && func_491(iLocal_47, 32))
		{
			func_5(&iLocal_47, 32);
		}
		return;
	}
	if ((SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_94, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) < Global_32438 || Global_32438 == 0f) && iLocal_294 != 4)
	{
		Global_32438 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_94, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
		Global_32439 = SCRIPT::GET_ID_OF_THIS_THREAD();
		func_482(&iLocal_47, 32);
	}
	else if (Global_32439 == SCRIPT::GET_ID_OF_THIS_THREAD())
	{
		Global_32438 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_94, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
	}
	else
...
void func_505()//Position - 0x14BA8
{
	if (func_551())
	{
		if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_94))
...
void func_506(var uParam0)//Position - 0x14BD7
{
	if (!iLocal_293 == 12)
	{
...
void func_507()//Position - 0x14CB5
{
	if (PED::IS_PED_INJURED(iLocal_94))
	{
		return;
...
int func_513(int iParam0)//Position - 0x15079
{
	if (Global_43377 == 15)
	{
		return 0;
...
bool func_514(int iParam0)//Position - 0x1509B
{
	return func_515(iParam0, Global_43377);
}

int func_515(int iParam0, int iParam1)//Position - 0x150AC
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_516()//Position - 0x1528D
{
	int iVar0;
	int iVar1;
	struct<2> Var2;
...
void func_517()//Position - 0x152E1
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return;
...
bool func_518(int iParam0, bool bParam1, bool bParam2)//Position - 0x15321
{
	return func_519(0, iParam0, 1, bParam1, bParam2);
}

int func_519(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x15335
{
	int iVar0;
	int iVar1;
...
int func_520(int iParam0)//Position - 0x153FB
{
	switch (iParam0)
	{
		case 0:
...
int func_521(int iParam0)//Position - 0x15435
{
	switch (iParam0)
	{
		case 0:
...
int func_522(int iParam0, bool bParam1)//Position - 0x1547B
{
	int iVar0;
...
int func_523(int iParam0)//Position - 0x15518
{
	switch (iParam0)
	{
		case 0:
...
bool func_524(int iParam0)//Position - 0x15558
{
	return func_491(iLocal_50, iParam0);
}

void func_525(var uParam0)//Position - 0x15568
{
	int iVar0;
...
void func_526(int* iParam0)//Position - 0x155EA
{
	func_527(iParam0, &(iParam0->f_2), iParam0->f_1);
}

void func_527(int* iParam0, char* sParam1, int iParam2)//Position - 0x15600
{
	if (BitTest(*iParam0, 30))
	{
		switch (func_452(*iParam0))
...
void func_528(int iParam0)//Position - 0x156D1
{
	if (func_491(iLocal_50, iParam0))
	{
...
void func_529()//Position - 0x156EC
{
	func_2(0);
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_94))
	{
...
int func_530(int iParam0, int iParam1, bool bParam2)//Position - 0x15750
{
	int iVar0;
...
int func_531(int iParam0)//Position - 0x15866
{
...
bool func_532()//Position - 0x1587D
{
	return Global_2683883.f_693;
}

bool func_533(bool bParam0)//Position - 0x1588C
{
	if (bParam0)
	{
	}
...
void func_534()//Position - 0x1589D
{
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_535()//Position - 0x158A9
{
	func_197(1);
}

void func_536(var uParam0)//Position - 0x158B6
{
	func_540();
	if (func_48(0, 1))
	{
	...
	func_537();
	Global_32438 = 0f;
	if (!Global_1956878.f_5662 && !Global_1956878.f_5666)
	{
	...
	if (func_470("PROS_ACCEPT" /* GXT: Press ~INPUT_CONTEXT~ or honk your horn to invite the prostitute into the vehicle. */) && !Global_32435)
	{
		HUD::CLEAR_HELP(true);
	}
	if (Global_32439 == SCRIPT::GET_ID_OF_THIS_THREAD())
	{
		Global_32435 = 0;
		Global_2657704[PLAYER::PLAYER_ID() /*463*/].f_428 = 0;
	}
...
void func_537()//Position - 0x15A81
{
}

void func_538()//Position - 0x15A89
{
	if (Global_2672524.f_947.f_10)
	{
...
bool func_539()//Position - 0x15AA7
{
	return BitTest(Global_1963820, 3);
}

void func_540()//Position - 0x15AB5
{
}

void func_541(bool bParam0)//Position - 0x15ABD
{
	if (!PED::IS_PED_INJURED(iLocal_94))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_94, false))
...
void func_542()//Position - 0x15B2F
{
	if (!func_551())
	{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_97, false) && !ENTITY::IS_ENTITY_DEAD(iLocal_97, false))
	{
		if (func_551())
		{
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_97))
			{
				if (Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_267.f_33 <= 0 && !BitTest(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_267.f_31, 11))
				{
...
void func_543()//Position - 0x15E65
{
	struct<8> Var0[2];
	struct<6> Var17[2];
...
int func_544()//Position - 0x15EEA
{
	return iLocal_44;
}

int func_545()//Position - 0x15EF4
{
	return iLocal_43;
}

int func_546()//Position - 0x15EFE
{
	return 0;
}

int func_547(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x15F07
{
	struct<68> Var0;
	int iVar68;
	struct<13> Var69;
...
void func_549()//Position - 0x16061
{
	if (func_491(iLocal_47, 128))
	{
		func_405(39, 0);
...
void func_550(int iParam0)//Position - 0x160A6
{
	if (func_551())
	{
		if (func_219(iParam0))
...
bool func_551()//Position - 0x160C4
{
	return func_524(1);
}

bool func_552(int iParam0)//Position - 0x160D1
{
	return Global_43377 == iParam0;
}

int func_553(int iParam0, bool bParam1)//Position - 0x160DF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_554(int iParam0, bool bParam1)//Position - 0x16155
{
	if (bParam1)
	{
		if (func_462(iParam0))
