...
void __EntryFunction__()//Position - 0x0
{
	...
	uLocal_92 = func_324(64);
	uLocal_93 = func_324(63);
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		func_302(&Var0, &Var116, 1);
	}
	if (!func_299(&iVar126, &Var0, Var61, 1f))
	{
		func_298();
	...
	while (true)
	{
		...
		func_220(Var0.f_0);
		func_213(&iLocal_108, &(Var0.f_9), Var61);
		if (Var0.f_0 == 42)
		{
		...
		if (func_210(&uLocal_96) && Var0.f_0 == 37)
		{
			func_207(Var0.f_28[1], &uLocal_96, Var0.f_0);
		}
		if (Var0.f_0 == 37)
		{
			func_203(&Var0, Var61, "NIG1AAU", "NIG1A_AMB", 0, "NIGEL", 1, "MRSTHORNHILL", &uLocal_110);
		}
		else if (Var0.f_0 == 42)
		{
			func_198(&Var0, Var61, "NIG2AUD", "NIG2_AMB", 4, "NIGEL", 5000, 14f);
		}
		else if (Var0.f_0 == 43)
		{
			func_196(&Var116, &(Var0.f_35[0]), &(Var0.f_28[1]));
			func_198(&Var0, -44.75f, -1289.86f, 29.16f, "NIGE3AU", "NIGEL3_AMB", 4, "NIGEL", 8000, 1101004800);
		}
		bVar134 = false;
		if (Var0.f_0 == 41)
		{
			if (func_194(&Var0, &uVar64) || func_193(&Var0))
			{
				bVar134 = true;
			}
		}
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3FD3
{
	int iVar0;
...
void func_58(int iParam0, bool bParam1)//Position - 0x433A
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x442D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x46B5
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x4756
{
...
int func_62(int iParam0, int iParam1)//Position - 0x4930
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x5591
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x55CC
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x5840
{
	bool bVar0;
...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5DCB
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x658E
{
	if (bParam6)
	{
...
int func_70(var uParam0)//Position - 0x65D5
{
...
int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x6640
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x66A1
{
	switch (iParam0)
	{
		case 0:
...
int func_75(int iParam0)//Position - 0x6A45
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A55
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x6AF7
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_78()//Position - 0x7247
{
...
int func_80(struct<3> Param0)//Position - 0x7551
{
...
int func_81(int iParam0)//Position - 0x757B
{
	if (iParam0 != func_90())
	{
...
Vector3 func_82(int iParam0, int iParam1)//Position - 0x75D3
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_83(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x767D
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_84(struct<3> Param0, float fParam3)//Position - 0x7712
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_88(int iParam0, var uParam1)//Position - 0x83B0
{
	switch (iParam0)
	{
		case 0:
...
int func_89(int iParam0)//Position - 0x8432
{
	if (iParam0 != func_90())
	{
...
int func_90()//Position - 0x848A
{
	return -1;
}

Vector3 func_91(int iParam0)//Position - 0x8493
{
	switch (iParam0)
	{
		case 1:
...
int func_93(int iParam0)//Position - 0x871A
{
	return MISC::GET_BITS_IN_RANGE(Global_2657589[iParam0 /*466*/].f_321.f_3, 28, 31);
}

int func_94(int iParam0)//Position - 0x8737
{
...
var func_102(int iParam0)//Position - 0x8C73
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_103(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_103(bool bParam0, int iParam1, int iParam2)//Position - 0x8C95
{
	if (bParam0)
	{
		return iParam1;
...
int func_104(var uParam0)//Position - 0x8CAC
{
	return uParam0 & 15;
}
...
void func_112(char* sParam0, int iParam1, int iParam2)//Position - 0x8E08
{
...
int func_113(bool bParam0)//Position - 0x8E4A
{
...
int func_118(var* uParam0)//Position - 0xA8DD
{
	int iVar0;
...
void func_122(int iParam0)//Position - 0xAA7B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_124(int iParam0)//Position - 0xAB57
{
	int iVar0;
...
int func_128(int iParam0, int iParam1, int iParam2)//Position - 0xAC50
{
...
int func_130(int iParam0)//Position - 0xACB7
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0xAD00
{
	if (func_132(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_132(int iParam0)//Position - 0xAD20
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_133(int iParam0)//Position - 0xAD41
{
	switch (iParam0)
	{
		case 5:
...
int func_135(int iParam0)//Position - 0xAE11
{
	switch (iParam0)
	{
		case 5:
...
void func_136(var uParam0, bool bParam1, bool bParam2)//Position - 0xAE64
{
	int iVar0;
...
int func_137(int iParam0)//Position - 0xAF59
{
	switch (iParam0)
	{
		case 5:
...
void func_139(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB003
{
	if (bParam0)
	{
...
bool func_141(int iParam0, int iParam1)//Position - 0xB16A
{
	bool bVar0;
...
int func_143(int iParam0)//Position - 0xB1F6
{
...
int func_147(char* sParam0)//Position - 0xB28D
{
...
int func_153(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB3C0
{
...
void func_154(int iParam0)//Position - 0xB558
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_160(int iParam0)//Position - 0xB714
{
	if (iParam0 == 1)
	{
...
int func_162(int iParam0)//Position - 0xB77A
{
...
int func_163(int iParam0)//Position - 0xB7BB
{
	int iVar0;
...
int func_165(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB832
{
	int iVar0;
...
void func_166(var uParam0, int iParam1)//Position - 0xB969
{
	int iVar0;
...
bool func_167(int iParam0)//Position - 0xB9B8
{
	return func_168(iParam0, Global_43257);
}

int func_168(int iParam0, int iParam1)//Position - 0xB9C9
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_169(int iParam0)//Position - 0xBBAA
{
	if (Global_43257 == 15)
	{
		return 0;
...
int func_171(char* sParam0, int iParam1)//Position - 0xBBDD
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_173(int iParam0, int iParam1)//Position - 0xBC4A
{
	switch (iParam0)
	{
		case 0:
...
int func_174(struct<3> Param0, bool bParam3)//Position - 0xC0BC
{
	int iVar0;
...
float func_175(bool bParam0, float fParam1, float fParam2)//Position - 0xC0E8
{
	if (bParam0)
	{
		return fParam1;
...
int func_176(int iParam0)//Position - 0xC0FF
{
	switch (iParam0)
	{
		case 0:
...
int func_177(bool bParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0xC18E
{
	int iVar0;
...
int func_178(int iParam0, int iParam1)//Position - 0xC1C1
{
	switch (iParam0->f_16)
	{
		case 0:
...
int func_180(var uParam0)//Position - 0xC9BF
{
	float fVar0;
...
void func_181(int iParam0, int iParam1)//Position - 0xCA4D
{
	if (iParam0 == 1)
	{
		if (!func_135(iParam1))
...
int func_182(bool bParam0)//Position - 0xCAB1
{
	int iVar0;
...
int func_183(int iParam0)//Position - 0xCB48
{
	if (func_132(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_184(int iParam0)//Position - 0xCB72
{
	bool bVar0;
...
var func_185()//Position - 0xD28F
{
	return Global_100720.f_1;
}

int func_186()//Position - 0xD29D
{
	if (Global_97603 != -1)
	{
...
var func_190(int iParam0, int iParam1)//Position - 0xD315
{
	switch (iParam0)
	{
		case 5:
...
var func_191()//Position - 0xD34D
{
	return Global_1575060;
}

int func_192()//Position - 0xD359
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_193(int iParam0)//Position - 0xD375
{
	int iVar0;
...
int func_194(int iParam0, var uParam1)//Position - 0xD439
{
...
bool func_195(var uParam0, struct<2> Param1, Vector3 vParam3)//Position - 0xD476
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_196(int iParam0, var uParam1, var uParam2)//Position - 0xD532
{
	if (func_132(*uParam1))
	{
		switch (*iParam0)
		{
			...
			case 1:
				if ((MISC::GET_GAME_TIMER() - iParam0->f_2) > iParam0->f_3)
				{
					...
					AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_197(0), false);
...
int func_197(int iParam0)//Position - 0xD69D
{
	int iVar0;
...
int func_198(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD892
{
	var uVar0;
	
	if ((((func_132(PLAYER::PLAYER_PED_ID()) && func_132(iParam0->f_28[0])) && !func_150()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_202(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_199(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD91A
{
...
void func_201(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD9AB
{
...
float func_202(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xDA46
{
	struct<3> Var0;
...
int func_203(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)//Position - 0xDA80
{
	var uVar0;
	...
	if (!*uParam10 == 3)
	{
		if (func_184(2))
		{
			if (!func_150())
			{
				if (((func_132(PLAYER::PLAYER_PED_ID()) && func_132(iParam0->f_28[0])) && func_132(iParam0->f_28[1])) && func_202(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
			...
			else if (((func_205(sParam5) && !*uParam10 == 1) && func_132(PLAYER::PLAYER_PED_ID())) && func_202(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
			{
...
int func_205(char* sParam0)//Position - 0xDBD8
{
	struct<6> Var0;
...
void func_207(int iParam0, var uParam1, int iParam2)//Position - 0xDC1C
{
	int iVar0;
	int iVar1;
...
int func_208(int iParam0)//Position - 0xDF74
{
...
int func_209(var uParam0)//Position - 0xDF94
{
...
int func_210(var uParam0)//Position - 0xDFAC
{
...
void func_213(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xDFEA
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_216(int iParam0, int iParam1)//Position - 0xE150
{
	bool bVar0;
	int iVar1;
...
void func_218(int iParam0)//Position - 0xE1FA
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_219(iParam0);
...
void func_219(int iParam0)//Position - 0xE211
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_221(var uParam0, bool bParam1)//Position - 0xE321
{
	struct<27> Var0;
...
void func_223(int* iParam0)//Position - 0xE895
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_225(var uParam0, bool bParam1, bool bParam2)//Position - 0xE940
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_226(int iParam0, int iParam1)//Position - 0xEAFE
{
	int iVar0;
...
int func_227(var uParam0, bool bParam1, int iParam2)//Position - 0xEB2E
{
	int iVar0;
	int iVar1;
...
int func_228(int iParam0)//Position - 0xEDEA
{
...
int func_229(int iParam0, float fParam1)//Position - 0xEE1E
{
	float fVar0;
...
bool func_230(int iParam0, float fParam1)//Position - 0xEE94
{
	return func_231(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_231(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEEAC
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	uVar0 = func_232(&(Local_49[iVar4 /*4*/]), Var1, iParam1, &(Local_49[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_49[iVar4 /*4*/].f_3) < iParam4);
}

int func_232(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xEF6D
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_233(int iParam0, int iParam1)//Position - 0xF099
{
	int iVar0;
...
int func_235(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xF1A8
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_236(struct<3> Param0, struct<3> Param3)//Position - 0xF239
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_237(struct<3> Param0)//Position - 0xF25A
{
	float fVar0;
	float fVar1;
...
int func_239(int iParam0, int iParam1)//Position - 0xF2B4
{
	int iVar0;
...
int func_240(int iParam0)//Position - 0xF2F3
{
...
int func_241(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF31B
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_242(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF416
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_243(int iParam0, float fParam1)//Position - 0xF522
{
	var uVar0;
	struct<3> Var1;
...
int func_244(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF5B7
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_245(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF645
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_246(int iParam0)//Position - 0xF68D
{
...
void func_247(int iParam0)//Position - 0xF6D7
{
	int iVar0;
...
int func_248(int iParam0)//Position - 0xF774
{
	if (iParam0 == -1)
	{
		iParam0 = func_170();
...
int func_249(int iParam0)//Position - 0xF809
{
...
int func_252(int iParam0)//Position - 0xF888
{
...
int func_254(int iParam0)//Position - 0xF8FA
{
	if (func_113(0))
	{
...
int func_255(int iParam0, var uParam1)//Position - 0xF922
{
	switch (*iParam0)
	{
		case 37:
...
int func_256(var uParam0)//Position - 0xF9DE
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				func_258(&(uParam0->f_35[0]), iLocal_95, -39.9688f, -1285.9615f, 28.3505f, 181.02f);
				if (func_132(uParam0->f_35[0]))
				{
...
int func_257(var uParam0, var uParam1)//Position - 0xFBC5
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFC9A
{
	func_259(iParam0);
...
void func_259(int* iParam0)//Position - 0xFCDC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_260(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xFD78
{
...
int func_261(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xFDD4
{
	int iVar0;
...
int func_262(var uParam0, int iParam1)//Position - 0xFE62
{
	int iVar0;
...
int func_263(var uParam0)//Position - 0xFEA8
{
	if (func_210(uParam0))
	{
...
int func_264(int iParam0)//Position - 0xFED2
{
	int iVar0;
...
int func_266(var uParam0)//Position - 0xFF3F
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_258(&(uParam0->f_35[0]), iLocal_95, -1304.01f, -644.58f, 25.91f, 127.67f);
				if (func_132(uParam0->f_35[0]))
				{
					VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_35[0], 65, 0);
					VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(uParam0->f_35[0], 5, false);
...
int func_271(var uParam0, var uParam1)//Position - 0x10659
{
	int iVar0[7];
	char* sVar8;
	int iVar9;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_264(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
...
void func_273(var uParam0, struct<3> Param1)//Position - 0x10CEC
{
	if (uParam0->f_51 == 0)
	{
	}
...
int func_275(var uParam0)//Position - 0x10D44
{
	int iVar0[2];
	int iVar3;
	char* sVar4;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_264(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar4))
			{
				return 0;
			}
			iLocal_91 = 2;
...
int func_276(var uParam0)//Position - 0x11072
{
	int iVar0[6];
	int iVar7;
	char* sVar8;
...
void func_277(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x115D4
{
	func_223(iParam0);
...
void func_278(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x115FB
{
	func_279(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_279(int* iParam0)//Position - 0x1161C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_280(var uParam0)//Position - 0x1165D
{
	int iVar0[7];
	int iVar8;
	int iVar9;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_264(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48))
			{
				return 0;
			}
			iLocal_91 = 2;
...
int func_282(int iParam0)//Position - 0x11C72
{
	struct<2> Var0;
...
var func_285(int iParam0, int iParam1)//Position - 0x11D13
{
	struct<5> Var0;
...
int func_288(var uParam0)//Position - 0x15218
{
	int iVar0[3];
	int iVar4;
	int iVar5;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_258(&(uParam0->f_35[0]), iLocal_95, -1077.959f, 793.9361f, 164.6374f, 172.8563f);
				if (func_132(uParam0->f_35[0]))
				{
					VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_35[0], 65, 0);
					VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(uParam0->f_35[0], 5, false);
...
int func_289(int iParam0)//Position - 0x154B9
{
	struct<27> Var0;
	bool bVar32;
...
int func_290(int iParam0)//Position - 0x1550A
{
	char* sVar0;
...
int func_291(int iParam0)//Position - 0x155C3
{
	var uVar0;
...
int func_292(int iParam0)//Position - 0x15684
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_294(int iParam0)//Position - 0x157EB
{
...
int func_295(int iParam0)//Position - 0x15816
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_296(int iParam0)//Position - 0x15841
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_297(int iParam0)//Position - 0x1586C
{
	if (func_249(iParam0))
	{
		return 0;
...
int func_299(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x158BB
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_300((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_300((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_300(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x15920
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_301(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_301(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x15998
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_302(int iParam0, int iParam1, bool bParam2)//Position - 0x15A13
{
	char* sVar0;
...
void func_310(int* iParam0, bool bParam1)//Position - 0x15BF3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_313(int* iParam0)//Position - 0x15C7D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_316(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x15D08
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
int func_318(int iParam0, int iParam1)//Position - 0x15DA9
{
	if (func_131(iParam0))
	{
...
void func_320(var uParam0)//Position - 0x15E6B
{
	if (*uParam0 == -1)
	{
		return;
...
int func_324(int iParam0)//Position - 0x15F07
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
