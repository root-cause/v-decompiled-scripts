...
void __EntryFunction__()//Position - 0x0
{
	...
	uLocal_52 = func_321(64);
	uLocal_53 = func_321(63);
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112473[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_317(&(Global_112473[Var0.f_0 /*10*/].f_9));
			}
		}
		func_299(&Var0, &Var3, 1);
	}
	if (!func_296(&iVar4, &Var0, Var1, 1f))
	{
		func_295();
	...
	while (true)
	{
		...
		func_217(Var0.f_0);
		func_210(&iLocal_68, &(Var0.f_9), Var1);
		if (Var0.f_0 == 42)
		{
			if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
			{
				CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION(func_209(), 4, 0, 0, func_208());
				func_318("Nigel 2 : set Di Napoli's cutscene trousers variation in launcher");
			}
		}
		if (func_207(&uLocal_56) && Var0.f_0 == 37)
		{
			func_204(Var0.f_28[1], &uLocal_56, Var0.f_0);
		}
		if (Var0.f_0 == 37)
		{
			func_200(&Var0, Var1, "NIG1AAU", "NIG1A_AMB", 0, "NIGEL", 1, "MRSTHORNHILL", &uLocal_70);
		}
		else if (Var0.f_0 == 42)
		{
			func_195(&Var0, Var1, "NIG2AUD", "NIG2_AMB", 4, "NIGEL", 5000, 14f);
		}
		else if (Var0.f_0 == 43)
		{
			func_193(&Var3, &(Var0.f_35[0]), &(Var0.f_28[1]));
			func_195(&Var0, -44.75f, -1289.86f, 29.16f, "NIGE3AU", "NIGEL3_AMB", 4, "NIGEL", 8000, 1101004800);
		}
		bVar5 = false;
		if (Var0.f_0 == 41)
		{
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x39E1
{
	int iVar0;
	var uVar1;
...
int func_50(var uParam0)//Position - 0x3A1E
{
	int iVar0;
	int iVar1;
...
int func_52(int iParam0, int iParam1)//Position - 0x3A5E
{
	int iVar0;
	var uVar1;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3A8A
{
	int iVar0;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3FD2
{
	int iVar0;
...
int func_55()//Position - 0x4214
{
	func_56();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_56()//Position - 0x422D
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x432A
{
	return Global_43052 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x4338
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x442B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x46B3
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x474E
{
...
int func_62(int iParam0, int iParam1)//Position - 0x4916
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x54B7
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x54F2
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x5766
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x57A2
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5CF1
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5D35
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x64B4
{
	if (bParam2)
	{
...
int func_70(var uParam0)//Position - 0x64FB
{
...
bool func_71(int iParam0)//Position - 0x6556
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x6566
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x65C7
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x6942
{
	return Global_31959;
}

int func_75(int iParam0)//Position - 0x694D
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x695D
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x69FF
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x7124
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x717C
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7226
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
...
Vector3 func_81(struct<3> Param0, float fParam1)//Position - 0x72BB
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_82(int iParam0)//Position - 0x72FF
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x7483
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x7491
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7F58
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7FDA
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x8034
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x803D
{
	switch (iParam0)
	{
		case 1:
...
int func_89()//Position - 0x8299
{
	return func_90(PLAYER::PLAYER_ID());
}

int func_90(int iParam0)//Position - 0x82A9
{
	return MISC::GET_BITS_IN_RANGE(Global_2689235[iParam0 /*453*/].f_318.f_3, 28, 31);
}

int func_91(int iParam0)//Position - 0x82C6
{
	return func_72(iParam0, 0, 0);
}

int func_92(int iParam0)//Position - 0x82D6
{
	switch (iParam0)
	{
		case -1:
...
bool func_93()//Position - 0x85E5
{
	return Global_100493.f_375 > 0;
}

var func_94()//Position - 0x85F6
{
	var uVar0;
...
void func_95(var uParam0, int iParam1)//Position - 0x863C
{
	if (iParam1 <= 0)
	{
		return;
...
void func_96(var uParam0, int iParam1)//Position - 0x86C2
{
...
void func_97(var uParam0, int iParam1)//Position - 0x86F5
{
	int iVar0;
	int iVar1;
...
int func_98(int iParam0, int iParam1)//Position - 0x8746
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_99(int iParam0)//Position - 0x87E8
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_100(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_100(bool bParam0, int iParam1, int iParam2)//Position - 0x880A
{
	if (bParam0)
	{
		return iParam1;
...
int func_101(var uParam0)//Position - 0x8821
{
	return uParam0 & 15;
}

void func_102(var uParam0, int iParam1)//Position - 0x882E
{
...
void func_103(var uParam0, int iParam1)//Position - 0x8868
{
...
void func_104(var uParam0, int iParam1)//Position - 0x88A3
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_105()//Position - 0x88DF
{
	func_56();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_106(int iParam0)//Position - 0x88F8
{
	var uVar0;
	char cVar1[24];
...
bool func_107()//Position - 0x8951
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_108()//Position - 0x8967
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_109(char* sParam0, int iParam1, int iParam2)//Position - 0x897D
{
...
int func_110(bool bParam0)//Position - 0x89BF
{
...
struct<2> func_111(int iParam0)//Position - 0x89E7
{
	struct<2> Var0;
...
void func_112(int iParam0, var uParam1)//Position - 0x8E34
{
	switch (iParam0)
	{
		case 0:
...
int func_114(int iParam0)//Position - 0xA10C
{
	switch (iParam0)
	{
		case 0:
...
void func_116(int iParam0)//Position - 0xA4F7
{
	struct<2> Var0;
...
void func_117(int iParam0)//Position - 0xA592
{
	if (iParam0 < 63)
	{
		func_118();
...
void func_119(int iParam0)//Position - 0xA5F0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_120(int iParam0)//Position - 0xA649
{
...
int func_121(int iParam0)//Position - 0xA6CC
{
	int iVar0;
...
void func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA6FD
{
	func_123(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_123(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA712
{
	int iVar0;
...
int func_125(int iParam0, int iParam1, int iParam2)//Position - 0xA7C5
{
...
int func_126(int iParam0, int iParam1, int iParam2)//Position - 0xA7E0
{
	int iVar0;
...
int func_127(int iParam0)//Position - 0xA82C
{
	int iVar0;
...
int func_128(int iParam0)//Position - 0xA875
{
	if (func_129(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_129(int iParam0)//Position - 0xA895
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_130(int iParam0)//Position - 0xA8B6
{
	switch (iParam0)
	{
		case 5:
...
int func_132(int iParam0)//Position - 0xA986
{
	switch (iParam0)
	{
		case 5:
...
void func_133(var uParam0, bool bParam1, bool bParam2)//Position - 0xA9D9
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xAACE
{
	switch (iParam0)
	{
		case 5:
...
void func_135(bool bParam0)//Position - 0xAB39
{
	int iVar0;
...
void func_136(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAB78
{
	if (bParam0)
	{
...
bool func_137()//Position - 0xACBB
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_138(int iParam0, int iParam1)//Position - 0xACD5
{
	bool bVar0;
...
int func_139(int iParam0, bool bParam1)//Position - 0xAD20
{
	int iVar0;
	int iVar1;
...
int func_140(int iParam0)//Position - 0xAD61
{
...
bool func_141()//Position - 0xADA0
{
	return BitTest(Global_2621446, 3);
}

int func_142()//Position - 0xADAE
{
...
void func_143(int iParam0)//Position - 0xADD5
{
	if (iParam0 == 1)
	{
...
int func_144(char* sParam0)//Position - 0xADF8
{
...
void func_145()//Position - 0xAE35
{
	Global_20471 = 0;
	func_146();
}

void func_146()//Position - 0xAE45
{
...
int func_150(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAF2B
{
...
void func_151(int iParam0)//Position - 0xB0C3
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_153(int iParam0)//Position - 0xB140
{
	if (func_158())
	{
		return;
...
void func_154(int iParam0)//Position - 0xB173
{
	if (func_158())
	{
		return;
...
void func_155(bool bParam0, bool bParam1)//Position - 0xB1FD
{
	if (bParam0)
	{
		if (func_157(0))
...
bool func_156()//Position - 0xB271
{
	return BitTest(Global_1958711, 5);
}

int func_157(int iParam0)//Position - 0xB27F
{
	if (iParam0 == 1)
	{
...
bool func_158()//Position - 0xB2D6
{
	return BitTest(Global_1958711, 19);
}

int func_159(int iParam0)//Position - 0xB2E5
{
...
int func_160(int iParam0)//Position - 0xB326
{
	int iVar0;
...
void func_161(int iParam0)//Position - 0xB36B
{
...
int func_162(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB39D
{
	int iVar0;
...
void func_163(var uParam0, int iParam1)//Position - 0xB4D4
{
	int iVar0;
...
bool func_164(int iParam0)//Position - 0xB523
{
	return func_165(iParam0, Global_43052);
}

int func_165(int iParam0, int iParam1)//Position - 0xB534
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_166(int iParam0)//Position - 0xB715
{
	if (Global_43052 == 15)
	{
		return 0;
...
int func_167()//Position - 0xB737
{
	return func_168(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_168(char* sParam0, int iParam1)//Position - 0xB748
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_170(int iParam0, int iParam1)//Position - 0xB7B5
{
	switch (iParam0)
	{
		case 0:
...
int func_171(struct<3> Param0, bool bParam1)//Position - 0xBC24
{
	int iVar0;
...
float func_172(bool bParam0, float fParam1, float fParam2)//Position - 0xBC50
{
	if (bParam0)
	{
		return fParam1;
...
int func_173(int iParam0)//Position - 0xBC67
{
	switch (iParam0)
	{
		case 0:
...
int func_174(bool bParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0xBCF6
{
	int iVar0;
...
int func_175(int iParam0, int iParam1)//Position - 0xBD29
{
	switch (iParam0->f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
				...
				else if (func_129(iParam0->f_28[0]))
				{
					if (func_177(iParam0))
					{
						if (func_181(2))
...
void func_176()//Position - 0xC50F
{
	func_27(&(Global_103950.f_2890), &Global_103950, 0, 1, 1, 0);
}

int func_177(var uParam0)//Position - 0xC52A
{
	float fVar0;
...
void func_178(int iParam0, int iParam1)//Position - 0xC5B8
{
	if (iParam0 == 1)
	{
		if (!func_132(iParam1))
...
int func_179(bool bParam0)//Position - 0xC61C
{
	int iVar0;
...
int func_180(int iParam0)//Position - 0xC6B3
{
	if (func_129(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_181(int iParam0)//Position - 0xC6DD
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_189()) || Global_112433) || Global_31962) || func_188()) || func_187(8, -1)) || func_93()) || func_186()) || func_185()) || func_184()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_189()) || Global_31962) || func_188()) || func_187(8, -1)) || func_185()) || func_93()) || func_186()) || func_184()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_189()) || Global_112433) || Global_31962) || func_188()) || func_187(8, -1)) || func_185()) || func_93()) || func_186()) || func_184()) || Global_113386.f_7688.f_919[bVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_189()) || Global_112433) || Global_31962) || func_188()) || func_187(8, -1)) || func_93()) || func_186()) || func_184()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_189() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_187(8, -1)) || func_184()) || func_183()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_187(8, -1) || func_93()) || func_186()) || func_183()) || func_182())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_189()) || Global_31962) || func_188()) || func_187(8, -1)) || func_186()) || func_185()) || func_184()) || Global_113386.f_7688.f_919[bVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_189()) || func_186()) || Global_112433) || Global_31962) || func_188()) || Global_44238) || func_187(8, -1)) || func_185()) || func_183()) || func_184()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_189()) || Global_112433) || Global_31962) || func_188()) || func_187(8, -1)) || func_185()) || func_183()) || func_93()) || func_186()) || func_184())
						{
							return 0;
						}
						break;
...
var func_182()//Position - 0xCDFA
{
	return Global_100480.f_1;
}

int func_183()//Position - 0xCE08
{
	if (Global_97363 != -1)
	{
...
bool func_186()//Position - 0xCE6F
{
	return Global_100493.f_376 > 0;
}

var func_187(int iParam0, int iParam1)//Position - 0xCE80
{
	switch (iParam0)
	{
		case 5:
...
var func_188()//Position - 0xCEB8
{
	return Global_1575058;
}

int func_189()//Position - 0xCEC4
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_190(int iParam0)//Position - 0xCEE0
{
	...
	if (func_129(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= (iParam0->f_28 - 1))
		{
			...
			{
				if (func_129(iParam0->f_28[iVar0]))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0->f_28[iVar0], PLAYER::PLAYER_PED_ID(), true) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iParam0->f_28[iVar0], true), 7.5f, true))
					{
						...
						{
							func_318("Player damaged the N1D peds but it's not safe to trigger the mission!");
						}
					}
				}
				else if (func_181(2))
				...
				{
					func_318("Player killed a N1D ped but it's not safe to trigger the mission!");
				}
			}
			iVar0++;
		}
...
{
	if (func_192(uParam1, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
	{
		if (func_181(2))
		{
			if (func_179(iParam0->f_27))
...
bool func_192(var uParam0, struct<2> Param1, Vector3 vParam2)//Position - 0xCFE1
{
	bool bVar0;
	int iVar1;
	int iVar2;
		...
		switch (*iParam0)
		{
			...
			case 1:
				if ((MISC::GET_GAME_TIMER() - iParam0->f_2) > iParam0->f_3)
				{
					...
					AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_194(0), false);
...
int func_194(int iParam0)//Position - 0xD208
{
	int iVar0;
...
int func_195(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xD3FD
{
	var uVar0;
	
	if ((((func_129(PLAYER::PLAYER_PED_ID()) && func_129(iParam0->f_28[0])) && !func_147()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_199(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_198(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
...
void func_196(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD485
{
...
void func_197(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD4C0
{
...
void func_198(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD516
{
...
float func_199(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xD5B1
{
	struct<3> Var0;
...
int func_200(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)//Position - 0xD5EB
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_181(2))
		{
			if (!func_147())
			{
				if (((func_129(PLAYER::PLAYER_PED_ID()) && func_129(iParam0->f_28[0])) && func_129(iParam0->f_28[1])) && func_199(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
					func_318("start conversation");
					uVar0 = 16;
					if (*uParam8 == 0)
					{
						func_198(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
						func_198(&uVar0, iParam6, iParam0->f_28[1], sParam7, 0, 1);
						func_196(&uVar0, cParam2, sParam3, 7, 0, 0);
						*uParam8 = 2;
					}
					else if (*uParam8 == 2)
					{
						func_318("conversation ended");
						*uParam8 = 3;
						return 1;
					}
				}
			}
			else if (((func_202(sParam3) && !*uParam8 == 1) && func_129(PLAYER::PLAYER_PED_ID())) && func_199(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
			{
				func_318("pause conversation");
				func_201(1);
				*uParam8 = 1;
			}
			if (func_199(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam8 == 1)
			{
				func_318("unpause conversation");
				func_201(0);
				*uParam8 = 2;
			}
		}
...
void func_201(int iParam0)//Position - 0xD736
{
	Global_22616 = iParam0;
}

int func_202(char* sParam0)//Position - 0xD743
{
	struct<6> Var0;
...
struct<6> func_203()//Position - 0xD763
{
	struct<6> Var0;
...
void func_204(int iParam0, var uParam1, int iParam2)//Position - 0xD787
{
	int iVar0;
	int iVar1;
...
int func_205(int iParam0)//Position - 0xDADF
{
...
int func_206(var uParam0)//Position - 0xDAFF
{
...
int func_207(var uParam0)//Position - 0xDB17
{
...
int func_208()//Position - 0xDB3C
{
	return joaat("U_M_M_Aldinapoli");
}

char* func_209()//Position - 0xDB49
{
	return "Al_DiNapoli";
}

void func_210(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xDB55
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_211(int iParam0, bool bParam1)//Position - 0xDC46
{
	if (iParam0 == -1)
	{
		return;
...
int func_212(int iParam0)//Position - 0xDC82
{
	if (Global_78315 == iParam0)
	{
		if (Global_78316 == -1)
...
void func_213(int iParam0, int iParam1)//Position - 0xDCBB
{
	bool bVar0;
	int iVar1;
...
bool func_214()//Position - 0xDD59
{
	return Global_97750;
}

void func_215(int iParam0)//Position - 0xDD65
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_216(iParam0);
...
void func_216(int iParam0)//Position - 0xDD7C
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_217(int iParam0)//Position - 0xDE64
{
	if (iParam0 == -1)
	{
		iParam0 = func_167();
...
int func_218(var uParam0, bool bParam1)//Position - 0xDE8C
{
	...
	if ((func_251(*uParam0) || func_249(*uParam0)) || Global_78564 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_207(&(uParam0->f_48)) && bParam1)
	{
		func_204(uParam0->f_28[0], &(uParam0->f_48), *uParam0);
	}
	return 1;
}

void func_219(var uParam0)//Position - 0xE0FC
{
	int iVar0;
	int iVar1;
...
void func_220(int* iParam0)//Position - 0xE400
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_221(var uParam0)//Position - 0xE42B
{
	int iVar0;
...
int func_222(var uParam0, bool bParam1, bool bParam2)//Position - 0xE4AB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_223(int iParam0, int iParam1)//Position - 0xE669
{
	int iVar0;
...
int func_225(int iParam0)//Position - 0xE955
{
...
int func_226(int iParam0, float fParam1)//Position - 0xE989
{
	float fVar0;
...
bool func_227(int iParam0, float fParam1)//Position - 0xE9FF
{
	return func_228(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_228(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEA17
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_229(&(Local_49[iVar2 /*4*/]), Var1, iParam1, &(Local_49[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_49[iVar2 /*4*/].f_3) < iParam4);
}

int func_229(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xEAD8
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_230(int iParam0, int iParam1)//Position - 0xEC04
{
	int iVar0;
...
int func_232(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xED13
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	{
		Var1 = { func_234(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_233(struct<3> Param0, struct<3> Param1)//Position - 0xEDA4
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_234(struct<3> Param0)//Position - 0xEDC5
{
	float fVar0;
	float fVar1;
...
void func_235(var uParam0)//Position - 0xEE04
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_236(int iParam0, int iParam1)//Position - 0xEE1F
{
	int iVar0;
...
int func_237(int iParam0)//Position - 0xEE5E
{
...
int func_238(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEE86
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_239(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEF81
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_240(int iParam0, float fParam1)//Position - 0xF08D
{
	var uVar0;
	struct<3> Var1;
...
int func_241(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xF122
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_242(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF1B0
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_243(int iParam0)//Position - 0xF1F8
{
...
void func_244(int iParam0)//Position - 0xF242
{
	int iVar0;
...
int func_245(int iParam0)//Position - 0xF2DF
{
	if (iParam0 == -1)
	{
		iParam0 = func_167();
...
int func_246(int iParam0)//Position - 0xF374
{
...
int func_249(int iParam0)//Position - 0xF3F3
{
	if ((func_250() && Global_100441.f_11 == 6) && iParam0 == func_168(&(Global_100441.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_251(int iParam0)//Position - 0xF465
{
	if (func_110(0))
	{
...
int func_253(var uParam0)//Position - 0xF549
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_262(&(uParam0->f_48), "rcmnigel3", "base", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			{
				if (!func_257(&(uParam0->f_28[0]), 64, -44.6f, -1289.86f, 29.16f, 22.9f, "RC NIGEL", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_255(&(uParam0->f_35[0]), iLocal_55, -39.9688f, -1285.962f, 28.3505f, 181.02f);
				if (func_129(uParam0->f_35[0]))
				{
...
void func_255(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xF805
{
	func_256(iParam0);
...
void func_256(int* iParam0)//Position - 0xF847
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_257(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xF8E3
{
	if (func_258(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xF93F
{
	int iVar0;
...
int func_259(var uParam0, int iParam1)//Position - 0xF9CD
{
	int iVar0;
...
int func_260(var uParam0)//Position - 0xFA13
{
	if (func_207(uParam0))
	{
...
int func_261(int iParam0)//Position - 0xFA3D
{
	int iVar0;
...
void func_262(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xFA6E
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_263(var uParam0)//Position - 0xFAAA
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_264(42, 1);
			func_262(&(uParam0->f_48), "rcmnigel2", "base_nigel", "base_nigel");
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
				STREAMING::REQUEST_MODEL(iVar0[iVar1]);
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_257(&(uParam0->f_28[0]), 64, -1310.65f, -640.17f, 26.52f, 153.43f, "RC NIGEL", 1))
				{
					bVar2 = false;
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_255(&(uParam0->f_35[0]), iLocal_55, -1304.01f, -644.58f, 25.91f, 127.67f);
				if (func_129(uParam0->f_35[0]))
				{
					VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_35[0], 65, 0);
					VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(uParam0->f_35[0], 5, false);
			...
			{
				func_255(&(uParam0->f_35[1]), iVar0[2], -1290.73f, -634.603f, 26.1004f, 126.961f);
				if (func_129(uParam0->f_35[1]))
				{
...
void func_264(int iParam0, bool bParam1)//Position - 0xFCC5
{
	switch (iParam0)
	{
		...
		case 38:
			if (bParam1)
			{
				iLocal_67 = PED::ADD_SCENARIO_BLOCKING_AREA(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, false, true, true, true);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_GUARD_STAND", false);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_CLIPBOARD", false);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", false);
		...
		case 39:
			if (bParam1)
			{
				iLocal_67 = PED::ADD_SCENARIO_BLOCKING_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, false, true, true, true);
		...
		case 41:
			if (bParam1)
			{
				iLocal_67 = PED::ADD_SCENARIO_BLOCKING_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, false, true, true, true);
		...
		case 42:
			if (bParam1)
			{
				iLocal_67 = PED::ADD_SCENARIO_BLOCKING_AREA(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, false, true, true, true);
...
void func_265(bool bParam0)//Position - 0x100DD
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_268(var uParam0, var uParam1)//Position - 0x101C6
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_271(uParam1);
			func_270(uParam1, -1313.714f, -27.2202f, 48.0314f);
			func_270(uParam1, -1294.066f, -27.0136f, 47.5724f);
			func_270(uParam1, -1069.844f, -143.769f, 39.7493f);
			func_270(uParam1, -925.2529f, -89.9079f, 38.3457f);
			func_270(uParam1, -1010.948f, 40.0643f, 49.9277f);
			func_270(uParam1, -1122.838f, 233.7037f, 64.7587f);
			func_270(uParam1, -1282.578f, 188.8798f, 59.2769f);
			func_270(uParam1, -1328.153f, 192.0178f, 57.8136f);
			func_270(uParam1, -1386.75f, 167.32f, 57.11f);
			func_270(uParam1, -1411.5f, 109.64f, 51.49f);
			func_270(uParam1, -1379.52f, 111.05f, 54.28f);
			func_270(uParam1, -1371.77f, 24.07f, 52.88f);
			func_270(uParam1, -1342.27f, 16.92f, 52.16f);
			func_269(uParam1);
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
		...
		case 1:
			if ((!func_261(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar1))
			{
				return 0;
			}
			iLocal_51 = 2;
...
void func_269(var uParam0)//Position - 0x107B8
{
	int iVar0;
	float fVar1;
...
void func_270(var uParam0, struct<3> Param1)//Position - 0x10858
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_271(var uParam0)//Position - 0x10889
{
	if (uParam0->f_51)
	{
	}
...
int func_272(var uParam0)//Position - 0x108B0
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_261(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar2))
			{
				return 0;
			}
			iLocal_51 = 2;
...
int func_273(var uParam0)//Position - 0x10BDE
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if ((!func_261(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar2))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_255(&(uParam0->f_35[0]), iVar0[3], -1010.97f, 359.91f, 70.65f, 331.46f);
				if (func_129(uParam0->f_35[0]))
				{
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uParam0->f_35[0], 5f);
		...
		case 3:
			...
			func_255(&(uParam0->f_35[1]), iVar0[4], -1018.26f, 357.76f, 70.2f, 339.52f);
			if (func_129(uParam0->f_35[1]))
			{
				VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_35[1], 27, 27);
			}
			func_275(&(uParam0->f_28[0]), iVar0[0], -1054.7f, 355.94f, 68.35f, 23.67f, 26);
			...
			func_275(&(uParam0->f_28[1]), iVar0[1], -1058.43f, 362.78f, 69.86f, 130.45f, 26);
			...
			func_275(&(uParam0->f_28[2]), iVar0[2], -1012.57f, 357.48f, 70.62f, -28.55f, 26);
			if (func_128(uParam0->f_28[2]))
			{
			...
			func_274(&(uParam0->f_41[0]), iVar0[5], -1050.03f, 368.95f, 69.29f, -11.27f);
			if (func_129(uParam0->f_41[0]))
			{
...
void func_274(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x11140
{
	func_220(iParam0);
...
void func_275(int* iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x11167
{
	func_276(iParam0);
	*iParam0 = PED::CREATE_PED(iParam4, iParam1, Param2, fParam3, false, false);
}

void func_276(int* iParam0)//Position - 0x11188
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_277(var uParam0)//Position - 0x111C9
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			uParam0->f_27 = 1;
			func_278(4, 0);
			func_318(" SetupScene_NIGEL_1A - SET_INTERIOR_CAPPED(INTERIOR_V_ROCKCLUB, FALSE)	");
		...
		case 1:
			if (!func_261(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			func_275(&(uParam0->f_28[0]), iVar0[0], -552.66f, 287.75f, 82.18f, 123.75f, 26);
			func_275(&(uParam0->f_28[1]), iVar0[1], -553.46f, 287.34f, 82.18f, -65.86f, 26);
			if (func_128(uParam0->f_28[1]))
			{
			...
			func_275(&(uParam0->f_28[2]), iVar0[2], -559.94f, 285.99f, 85.38f, -59.06f, 26);
			func_275(&(uParam0->f_28[3]), iVar0[3], -558.87f, 289.79f, 85.38f, 162.44f, 26);
			func_275(&(uParam0->f_28[4]), iVar0[4], -559f, 286.09f, 85.38f, 65.92f, 26);
			func_275(&(uParam0->f_28[5]), iVar0[5], -558.84f, 288.97f, 85.38f, -7.72f, 26);
			if (func_128(uParam0->f_28[2]))
			{
			...
			func_255(&(uParam0->f_35[0]), iVar0[6], -553.55f, 308.61f, 82.81f, 202.78f);
			if (func_129(uParam0->f_35[0]))
			{
...
void func_278(int iParam0, bool bParam1)//Position - 0x11717
{
	char* sVar0;
	int iVar1;
...
int func_279(int iParam0)//Position - 0x117BD
{
	struct<2> Var0;
...
struct<2> func_280(int iParam0)//Position - 0x117EE
{
	struct<2> Var0;
...
void func_281(int iParam0, bool bParam1)//Position - 0x1181B
{
	struct<2> Var0;
...
var func_282(int iParam0, int iParam1)//Position - 0x1185E
{
	struct<5> Var0;
...
struct<5> func_283(int iParam0)//Position - 0x11883
{
	struct<5> Var0;
	struct<3> Var1;
...
struct<6> func_284(int iParam0, bool bParam1)//Position - 0x140FE
{
	struct<6> Var0;
...
int func_285(var uParam0)//Position - 0x14CB4
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_262(&(uParam0->f_48), "rcmnigel1", "base_nigel", "base_nigel");
			func_262(&uLocal_56, "rcmnigel1", "base_mrs_thornhill", "base_mrs_thornhill");
			iLocal_51 = 1;
			break;
		...
		case 2:
			bVar3 = true;
			if (!func_257(&(uParam0->f_28[0]), 64, -1100.5f, 789.8f, 164.34f, 1.82f, "RC: NIGEL", 1))
			{
				bVar3 = false;
			}
			if (!func_257(&(uParam0->f_28[1]), 63, -1099.35f, 789.15f, 164.47f, 0f, "RC: MRS THORNHILL", 1))
			{
				bVar3 = false;
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_255(&(uParam0->f_35[0]), iLocal_55, -1077.959f, 793.9361f, 164.6374f, 172.8563f);
				if (func_129(uParam0->f_35[0]))
				{
					VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_35[0], 65, 0);
					VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(uParam0->f_35[0], 5, false);
		...
		case 3:
			if (func_129(uParam0->f_28[0]) && func_129(uParam0->f_28[1]))
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[0], true);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[1], true);
...
int func_286(int iParam0)//Position - 0x14F55
{
	struct<27> Var0;
	bool bVar1;
...
bool func_290(int iParam0, char* sParam1)//Position - 0x151A5
{
...
int func_291(int iParam0)//Position - 0x15287
{
...
int func_292(int iParam0)//Position - 0x152B2
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_293(int iParam0)//Position - 0x152DD
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_294(int iParam0)//Position - 0x15308
{
	if (func_246(iParam0))
	{
		return 0;
...
void func_295()//Position - 0x1533D
{
	func_318("Running end routines.");
	Global_113104 = (Global_113104 - 1);
}

int func_296(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x15357
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_297((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_297((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_297(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0x153BC
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_298(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_298(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x15434
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_299(int iParam0, int iParam1, bool bParam2)//Position - 0x154AF
{
	...
	if (bParam2)
	{
		...
		if (*iParam0 == 38)
		{
			func_278(4, 1);
			func_316(iParam0);
			func_318(" Script_Cleanup - SET_INTERIOR_CAPPED(INTERIOR_V_ROCKCLUB, TRUE)");
		}
		else if (*iParam0 == 39)
		{
			func_314(iParam0);
...
void func_300(char* sParam0)//Position - 0x15599
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_202(sParam0))
...
void func_301()//Position - 0x155B8
{
	Global_20471 = 0;
	func_302();
}

void func_302()//Position - 0x155C8
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22616 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_303(var uParam0)//Position - 0x155E9
{
	if (func_207(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_304(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x1561F
{
	func_311(uParam0, iParam1);
	func_308(uParam0, bParam2);
	func_305(uParam0, bParam3);
}

void func_305(var uParam0, bool bParam1)//Position - 0x1563F
{
	func_306(&(uParam0->f_41), bParam1);
}

void func_306(var uParam0, bool bParam1)//Position - 0x15651
{
	int iVar0;
...
void func_307(int* iParam0, bool bParam1)//Position - 0x1568F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_308(var uParam0, bool bParam1)//Position - 0x156CA
{
	func_309(&(uParam0->f_35), bParam1);
}

void func_309(var uParam0, bool bParam1)//Position - 0x156DC
{
	int iVar0;
...
void func_310(int* iParam0)//Position - 0x15719
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_311(var uParam0, int iParam1)//Position - 0x15751
{
	func_312(&(uParam0->f_28), iParam1);
}

void func_312(var uParam0, int iParam1)//Position - 0x15763
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_313(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_313(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x157A4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
int func_315(int iParam0, int iParam1)//Position - 0x15845
{
	if (func_128(iParam0))
	{
...
void func_317(var uParam0)//Position - 0x15907
{
	if (*uParam0 == -1)
	{
		return;
...
void func_318(char* sParam0)//Position - 0x15944
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_319(var uParam0)//Position - 0x15956
{
	*uParam0 = -1;
...
void func_320()//Position - 0x15989
{
	func_318("Running start routines.");
	Global_113104++;
}

int func_321(int iParam0)//Position - 0x159A3
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
