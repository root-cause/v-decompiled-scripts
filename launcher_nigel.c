...
int func_253(var uParam0)//Position - 0xF549
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			{
				func_255(&(uParam0->f_35[0]), iLocal_55, -39.9688f, -1285.9615f, 28.3505f, 181.02f);
				if (func_129(uParam0->f_35[0]))
				{
...
int func_268(var uParam0, var uParam1)//Position - 0x101C6
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_271(uParam1);
			func_270(uParam1, -1313.7141f, -27.2202f, 48.0314f);
			func_270(uParam1, -1294.0658f, -27.0136f, 47.5724f);
			func_270(uParam1, -1069.8435f, -143.769f, 39.7493f);
			func_270(uParam1, -925.2529f, -89.9079f, 38.3457f);
			func_270(uParam1, -1010.9485f, 40.0643f, 49.9277f);
			func_270(uParam1, -1122.8375f, 233.7037f, 64.7587f);
			func_270(uParam1, -1282.5781f, 188.8798f, 59.2769f);
			func_270(uParam1, -1328.1532f, 192.0178f, 57.8136f);
