...
int func_170(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x8B14
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
...
bool func_171(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x8EAE
{
	if (bParam2)
	{
