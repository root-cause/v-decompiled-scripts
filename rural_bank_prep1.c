...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (((((iLocal_1508 == 0 && ENTITY::DOES_ENTITY_EXIST(Local_92[0 /*2*/])) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_92[0 /*2*/], false)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_92[0 /*2*/], false)) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_92[0 /*2*/], true)) < 5625f)
		{
			...
			if (!bVar0)
			{
				func_244(&Local_80, Local_92[0 /*2*/], 0, 0, 1, 1, 1);
			}
		}
		else
		{
			func_242(&Local_80, 0, 0);
		}
		func_241();
		func_208();
		if (!bLocal_1512)
...
void func_8()//Position - 0x497
{
	...
	switch (iLocal_1509)
	{
		...
		case 1:
			if (func_46(&Local_401, Local_47, 0.1f, 0.1f, 2f, 1, Local_92[0 /*2*/], "RHP_RTN", "", "RHP_BK", 1, 0, 1, -1) || (HUD::DOES_BLIP_EXIST(Local_401.f_5) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_92[0 /*2*/], 1359.4762f, 3614.326f, 36.87141f, 1356.748f, 3621.6047f, 33.72731f, 5f, false, true, 0)))
			{
...
void func_25()//Position - 0xE78
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_27(Global_113810.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_26(iVar0) && (!func_29(14) || Global_112760))
			{
...
int func_46(int* iParam0, struct<3> Param1, struct<3> Param4, bool bParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11, bool bParam12, int iParam13, bool bParam14, int iParam15)//Position - 0x16FF
{
...
int func_47(int* iParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, struct<3> Param10, bool bParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, bool bParam25, bool bParam26, char* sParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, int iParam32, int iParam33, int iParam34, bool bParam35, float fParam36)//Position - 0x174E
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_56(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x2346
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_58(struct<3> Param0, bool bParam3)//Position - 0x23FC
{
	int iVar0;
...
void func_91(int iParam0, int iParam1)//Position - 0x400C
{
	...
	func_92(iParam0, &(Global_113810.f_32752.f_5510));
}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_116(iParam0, 0, 0)) || func_116(iParam0, 1, 0)) || func_116(iParam0, 2, 0)) || func_115(iParam0) != 145) || func_114(iParam0)) || func_113(iParam0)) || func_112(iParam0)) || func_111(iParam0)) || !func_98(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_113(iParam0))
		{
		}
...
int func_99(int iParam0, bool bParam1, int iParam2)//Position - 0x4AB9
{
	...
	{
		if ((func_105() || MISC::IS_PC_VERSION()) || func_104())
		{
		}
		else if (!func_107())
		{
...
int func_103(bool bParam0)//Position - 0x9EF6
{
	if (bParam0)
	{
...
bool func_104()//Position - 0x9F10
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_105()//Position - 0x9F26
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_106()//Position - 0x9F3C
{
	return 0;
}

int func_107()//Position - 0x9F45
{
	return 1;
}

int func_108()//Position - 0x9F4E
{
	return 1;
}

int func_109()//Position - 0x9F57
{
...
int func_111(int iParam0)//Position - 0xA028
{
	int iVar0;
	char* sVar1;
...
int func_112(int iParam0)//Position - 0xA06F
{
	int iVar0;
...
int func_113(int iParam0)//Position - 0xA0AA
{
	int iVar0;
...
int func_114(int iParam0)//Position - 0xA126
{
	int iVar0;
...
int func_115(int iParam0)//Position - 0xA20E
{
	int iVar0;
...
int func_116(int iParam0, int iParam1, bool bParam2)//Position - 0xA271
{
	int iVar0;
	char* sVar1;
	int iVar9;
	...
	iVar0 = 0;
	while (func_117(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_117(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0xA2DF
{
...
void func_118()//Position - 0xA3B7
{
	...
	switch (iLocal_1509)
	{
			...
			while (iVar0 <= 8)
			{
				if (func_37(Local_109[iVar0 /*14*/]))
				{
					if (!iLocal_448)
					{
						...
						func_150();
						AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(Local_109[iVar0 /*14*/], "GENERIC_WAR_CRY", func_60(3), 1);
						iLocal_448 = 1;
					}
				}
				iVar0++;
		...
		case 1:
			...
			{
				Local_92[0 /*2*/].f_1 = func_119(Local_92[0 /*2*/], 0, 0);
			}
			break;
	}
}

int func_119(int iParam0, bool bParam1, bool bParam2)//Position - 0xA4D1
{
	return func_49(iParam0, !bParam1, bParam2);
}

int func_120(int iParam0)//Position - 0xA4E4
{
	if (iLocal_1507 == 0)
	{
		iLocal_1510 = iParam0;
...
void func_121(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0xA504
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104373.f_4))
	{
		...
		{
			if (func_149(24) != Global_104373.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_146(ENTITY::GET_ENTITY_COORDS(Global_104373.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_122(Global_104373.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_122(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0xA57F
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_138(iParam5, &Var0, Param1, fParam4, func_115(iParam0));
		func_123(iParam5, iParam0, 0);
	}
}

void func_123(int iParam0, int iParam1, int iParam2)//Position - 0xA6A8
{
	int iVar0;
	...
	if (!func_135(&(Global_77479.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_113810.f_32752.f_4801 = func_124();
			}
...
var func_124()//Position - 0xA7BF
{
	var uVar0;
	
	func_134(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_133(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_132(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_127(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_126(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_125(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}

void func_125(var uParam0, int iParam1)//Position - 0xA805
{
	if (iParam1 <= 0)
	{
		return;
...
void func_126(var uParam0, int iParam1)//Position - 0xA88B
{
...
void func_127(var uParam0, int iParam1)//Position - 0xA8BE
{
	int iVar0;
	int iVar1;
...
int func_128(int iParam0, int iParam1)//Position - 0xA90F
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_129(int iParam0)//Position - 0xA9B1
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_130(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_130(bool bParam0, int iParam1, int iParam2)//Position - 0xA9D3
{
	if (bParam0)
	{
		return iParam1;
...
int func_131(var uParam0)//Position - 0xA9EA
{
	return uParam0 & 15;
}

void func_132(var uParam0, int iParam1)//Position - 0xA9F7
{
...
void func_133(var uParam0, int iParam1)//Position - 0xAA31
{
...
void func_134(var uParam0, int iParam1)//Position - 0xAA6C
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_135(var uParam0, int iParam1)//Position - 0xAAA8
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_144(Global_113810.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_144(Global_113810.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_144(Global_113810.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_136(int iParam0, int iParam1)//Position - 0xC197
{
	struct<82> Var0;
...
void func_137(int iParam0, var uParam1, int iParam2)//Position - 0xC1D9
{
	int iVar0;
...
void func_138(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xC435
{
	if (func_135(&(Global_77479.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_143(iParam0);
			func_142(uParam1, &(Global_113810.f_32752.f_69[Global_77479.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_139(int iParam0, bool bParam1)//Position - 0xC52E
{
	if (iParam0 == -1)
	{
		return;
...
void func_140(int iParam0, int iParam1, bool bParam2)//Position - 0xC58B
{
	if (iParam0 == -1)
	{
		return;
...
int func_141(int iParam0, int iParam1)//Position - 0xC5C6
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_142(var uParam0, var uParam1)//Position - 0xC5E6
{
...
void func_143(int iParam0)//Position - 0xC6B2
{
	if (iParam0 == -1)
	{
		return;
...
bool func_144(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xC729
{
	if (bParam6)
	{
...
void func_145(int iParam0)//Position - 0xC770
{
...
int func_146(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0xC797
{
	int iVar0;
	
	iVar0 = func_147(Param0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_147(struct<3> Param0, int iParam3, int iParam4)//Position - 0xC8AD
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_148(int iParam0)//Position - 0xC93C
{
	return BitTest(Global_113810.f_7232[iParam0], 0);
}

int func_149(int iParam0)//Position - 0xC951
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_150()//Position - 0xC96D
{
	Global_20711 = 0;
	func_151();
}

void func_151()//Position - 0xC97D
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22856 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_153(char* sParam0, int iParam1)//Position - 0xCA73
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

void func_154()//Position - 0xCA8A
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	while (iLocal_445 <= (3 - 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_99[iLocal_445 /*2*/]))
		{
			...
			{
				func_207(&(Local_99[iLocal_445 /*2*/]), 1, 0, 1);
			}
		}
		iLocal_445++;
	}
	...
	while (iLocal_445 <= (3 - 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_92[iLocal_445 /*2*/]))
		{
			if (!VEHICLE::IS_VEHICLE_DRIVEABLE(Local_92[iLocal_445 /*2*/], false))
			{
				...
				func_195(&(Local_92[iLocal_445 /*2*/]));
			}
			else if (Local_92[iLocal_445 /*2*/] == Local_92[0 /*2*/])
			{
				if (func_194(&(Local_92[0 /*2*/])))
				{
					func_196(4);
					func_195(&(Local_92[0 /*2*/]));
				}
			}
		}
		iLocal_445++;
	...
	while (iLocal_445 <= (9 - 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_109[iLocal_445 /*14*/]))
		{
			if (bLocal_454)
			{
				func_193(Local_109[iLocal_445 /*14*/], &(Local_109[iLocal_445 /*14*/].f_2), -1, 0, 0, 0, 400f, 0, -1, -1, 1, 0, 0);
			}
		...
		if ((((func_37(Local_109[iLocal_445 /*14*/]) && (MISC::GET_GAME_TIMER() - iLocal_453) > 8000) && bLocal_454) && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_109[iLocal_445 /*14*/])) && !PED::IS_PED_IN_ANY_VEHICLE(Local_109[iLocal_445 /*14*/], false))
		{
			...
			{
				AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(Local_109[iLocal_445 /*14*/], "DYING_MOAN", func_60(3), 1);
				iLocal_453 = MISC::GET_GAME_TIMER();
			}
			else if (ENTITY::GET_ENTITY_HEALTH(Local_109[iLocal_445 /*14*/]) < 140)
			{
				AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(Local_109[iLocal_445 /*14*/], "DYING_HELP", func_60(3), 1);
				iLocal_453 = MISC::GET_GAME_TIMER();
			}
			else if (PED::IS_PED_GOING_INTO_COVER(Local_109[iLocal_445 /*14*/]))
			{
				AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(Local_109[iLocal_445 /*14*/], "TAKE_COVER", func_60(3), 1);
				iLocal_453 = MISC::GET_GAME_TIMER();
			}
			else if (TASK::IS_PED_RUNNING(Local_109[iLocal_445 /*14*/]))
			{
				AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(Local_109[iLocal_445 /*14*/], "COVER_ME", func_60(3), 1);
				iLocal_453 = MISC::GET_GAME_TIMER();
			}
			else if (PED::IS_PED_SHOOTING(Local_109[iLocal_445 /*14*/]))
			{
				AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(Local_109[iLocal_445 /*14*/], "COVER_YOU", func_60(3), 1);
				iLocal_453 = MISC::GET_GAME_TIMER();
			}
			else if (!WEAPON::IS_PED_WEAPON_READY_TO_SHOOT(Local_109[iLocal_445 /*14*/]))
			{
				AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(Local_109[iLocal_445 /*14*/], "RELOADING", func_60(3), 1);
				iLocal_453 = MISC::GET_GAME_TIMER();
			}
			else if (func_191(Local_109[iLocal_445 /*14*/], joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE"), 1) || func_191(Local_109[iLocal_445 /*14*/], joaat("SCRIPT_TASK_LEAVE_VEHICLE"), 1))
			{
				AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(Local_109[iLocal_445 /*14*/], "GENERIC_WAR_CRY", func_60(3), 1);
				iLocal_453 = MISC::GET_GAME_TIMER();
			}
		}
		iLocal_445++;
	...
	if (!iLocal_442)
	{
		...
		if (fLocal_439 < 3f)
		{
			...
			iVar2 = 0;
			while (iVar2 < Global_97310)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_97310[iVar2]))
				{
					if (ENTITY::IS_ENTITY_DEAD(Global_97310[iVar2], false) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97310[iVar2], false))
					{
						iVar4 = VEHICLE::GET_VEHICLE_CAUSE_OF_DESTRUCTION(Global_97310[iVar2]);
	...
	if (!iLocal_441)
	{
		if (func_157(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 3, 0, 0))
		{
			iLocal_441 = 1;
	...
	else if (!func_157(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 3, 0, 0))
	{
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
		{
...
void func_155(int iParam0, int iParam1)//Position - 0xD286
{
	Global_63496 = iParam0;
	Global_63497 = iParam1;
}

void func_156(int iParam0, int iParam1)//Position - 0xD298
{
	int iVar0;
...
int func_157(struct<3> Param0, int iParam3, int iParam4, bool bParam5)//Position - 0xD303
{
	struct<3> Var0[15];
	struct<3> Var46[15];
	float fVar92[15];
	...
	else if (iLocal_1508 >= 1)
	{
		if (AUDIO::IS_AUDIO_SCENE_ACTIVE("PS_PREP_INTERCEPT_CONVOY"))
		{
			...
			while (iVar2 <= 3)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_97310[iVar2]))
				{
					AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(Global_97310[iVar2], 0f);
				}
				iVar2++;
			}
		}
...
void func_159()//Position - 0xE160
{
	...
	if (iLocal_435 == 3 || iLocal_435 == 1)
	{
		...
		OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Global_42073[20 /*31*/], fLocal_437, false, true);
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_42073[20 /*31*/], 4, false, true);
	}
}

float func_160(float fParam0, float fParam1, float fParam2)//Position - 0xE25E
{
	float fVar0;
	
	fVar0 = ((1f - SYSTEM::COS(func_161((fParam2 * 3.1415927f)))) * 0.5f);
	return ((fParam0 * (1f - fVar0)) + (fParam1 * fVar0));
}

float func_161(float fParam0)//Position - 0xE28D
{
	return (fParam0 * 57.29578f);
}

int func_162()//Position - 0xE29D
{
	int iVar0;
...
void func_163()//Position - 0xE30E
{
	...
	while (iVar0 < 3)
	{
		...
		if (!PED::IS_PED_INJURED(iVar1))
		{
			...
			else if (func_168(iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, true))
			{
			...
			else if (func_166(iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, true))
			{
...
int func_164(int iParam0)//Position - 0xE4D0
{
	bool bVar0;
...
int func_165(int iParam0, int iParam1)//Position - 0xE525
{
	bool bVar0;
...
int func_166(int iParam0)//Position - 0xE5A6
{
	if (!func_167())
	{
...
int func_168(int iParam0)//Position - 0xE630
{
	if (!func_167())
	{
...
int func_169(int iParam0, int iParam1)//Position - 0xE6C6
{
	bool bVar0;
...
int func_170(int iParam0)//Position - 0xE71F
{
	bool bVar0;
...
int func_171(int iParam0)//Position - 0xE765
{
	if (iParam0 > 3)
	{
		return 0;
	...
	return Global_98291[func_172(iParam0)];
}

int func_172(int iParam0)//Position - 0xE796
{
	if (iParam0 == 0)
	{
		return 0;
		...
		case 0:
			if (!bLocal_454)
			{
				...
				if (((((func_37(Local_109[4 /*14*/]) && func_37(Local_109[0 /*14*/])) && func_37(Local_109[5 /*14*/])) && func_37(Local_92[1 /*2*/])) && func_37(Local_92[2 /*2*/])) && func_37(Local_92[0 /*2*/]))
				{
					...
					fVar2 = func_182((((-11f / (100f - 40f)) * fVar1) + fVar3), 0f, 11f);
		...
		case 2:
			if (!bLocal_454)
			{
				...
				if (((((func_37(Local_109[4 /*14*/]) && func_37(Local_109[0 /*14*/])) && func_37(Local_109[5 /*14*/])) && func_37(Local_92[1 /*2*/])) && func_37(Local_92[2 /*2*/])) && func_37(Local_92[0 /*2*/]))
				{
					...
					{
						case 0:
							if (!func_191(Local_109[0 /*14*/], joaat("SCRIPT_TASK_PERFORM_SEQUENCE"), 1))
							{
							...
							if (!func_191(Local_109[4 /*14*/], joaat("SCRIPT_TASK_VEHICLE_MISSION"), 1))
							{
								TASK::TASK_VEHICLE_ESCORT(Local_109[4 /*14*/], Local_92[0 /*2*/], Local_92[1 /*2*/], -1, 11f, 786603, -1f, 20, 0f);
							}
							if (!func_191(Local_109[5 /*14*/], joaat("SCRIPT_TASK_VEHICLE_MISSION"), 1))
							{
							...
							if (ENTITY::IS_ENTITY_AT_COORD(Local_109[0 /*14*/], -1885.8746f, 3006.1519f, 31.81027f, 5f, 5f, 5f, false, true, 0))
							{
								...
								while (iVar0 <= (9 - 1))
								{
									if (func_37(Local_109[iVar0 /*14*/]))
									{
										...
										func_207(&(Local_109[iVar0 /*14*/]), 1, 1, 1);
									}
									iVar0++;
								}
								iLocal_469++;
		...
		case 1:
			...
			switch (iLocal_433)
			{
				case 0:
					...
					{
						case 0:
							iLocal_434 = func_181(Local_92[0 /*2*/]);
							break;
				...
				case 2:
					...
					while (iVar0 <= (9 - 1))
					{
						if (func_37(Local_109[iVar0 /*14*/]) && func_37(PLAYER::PLAYER_PED_ID()))
						{
							...
							if (!func_191(Local_109[iVar0 /*14*/], joaat("SCRIPT_TASK_COMBAT"), 1))
							{
								TASK::TASK_COMBAT_PED(Local_109[iVar0 /*14*/], PLAYER::PLAYER_PED_ID(), 0, 16);
							}
						}
				...
				case 4:
					if (func_178(PLAYER::PLAYER_PED_ID(), Local_47, 1) < 30f)
					{
						iVar7 = 1;
					}
					iVar0 = 0;
					while (iVar0 <= (9 - 1))
					{
						...
						{
							if (iVar7 && func_178(Local_109[iVar0 /*14*/], Local_47, 1) < 30f)
							{
							...
							else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_92[0 /*2*/], false) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_92[0 /*2*/], false), ENTITY::GET_ENTITY_COORDS(Local_109[iVar0 /*14*/], false), true) > (120f / 2f))
							{
								...
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_109[iVar0 /*14*/], false), true) > (120f * 2f))
								{
									...
									{
										iVar9 = func_177(Local_109[iVar0 /*14*/]);
										if (func_37(iVar9))
										{
											iVar8 = -1;
											...
											if (func_176(iVar9))
											{
												...
												{
													TASK::TASK_ENTER_VEHICLE(Local_109[iVar0 /*14*/], iVar9, 1000, iVar8, 2f, 16, 0);
												}
								...
								{
									if (func_175(PLAYER::PLAYER_PED_ID(), Local_109[iVar0 /*14*/], 1) < 35f)
									{
										if (func_174(Local_109[iVar0 /*14*/], PED::GET_VEHICLE_PED_IS_IN(Local_109[iVar0 /*14*/], false)) == -1)
										{
											...
											if (bLocal_468)
											{
												if (!func_191(Local_109[iVar0 /*14*/], joaat("SCRIPT_TASK_VEHICLE_MISSION"), 1))
												{
										...
										if (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 2f && func_175(PLAYER::PLAYER_PED_ID(), Local_109[iVar0 /*14*/], 1) < 20f)
										{
											PED::SET_PED_COMBAT_ATTRIBUTES(Local_109[iVar0 /*14*/], 3, true);
										}
										else
...
int func_174(int iParam0, int iParam1)//Position - 0xFA13
{
...
float func_175(int iParam0, int iParam1, bool bParam2)//Position - 0xFA85
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_176(int iParam0)//Position - 0xFAE3
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
var func_177(int iParam0)//Position - 0xFB33
{
	var uVar0;
	float fVar1;
	...
	{
		if (func_175(iParam0, Local_92[1 /*2*/], 1) < fVar1)
		{
			fVar1 = func_175(iParam0, Local_92[1 /*2*/], 1);
			if (func_176(Local_92[1 /*2*/]))
			{
				uVar0 = Local_92[1 /*2*/];
			}
			else
	...
	{
		if (func_175(iParam0, Local_92[2 /*2*/], 1) < fVar1)
		{
			fVar1 = func_175(iParam0, Local_92[2 /*2*/], 1);
			if (func_176(Local_92[2 /*2*/]))
			{
				uVar0 = Local_92[2 /*2*/];
			}
			else
...
float func_178(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xFBDD
{
	struct<3> Var0;
...
int func_179()//Position - 0xFC17
{
	if (func_37(PLAYER::PLAYER_PED_ID()) && func_37(Local_92[0 /*2*/]))
	{
		if (func_178(Local_92[0 /*2*/], Local_458, 1) > 120f)
		{
			return 4;
		}
		else if (func_178(PLAYER::PLAYER_PED_ID(), Local_458, 1) <= 120f)
		{
			return 2;
		}
		else if (func_178(PLAYER::PLAYER_PED_ID(), Local_458, 1) > 120f && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_92[0 /*2*/], false))
		{
			return 3;
		}
	}
...
void func_180(int iParam0)//Position - 0xFCA5
{
	int iVar0;
	struct<3> Var1;
	float fVar4;
...
int func_181(int iParam0)//Position - 0x1026B
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_182(float fParam0, float fParam1, float fParam2)//Position - 0x1033D
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_183()//Position - 0x10364
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var4;
	...
	if (func_37(Local_92[1 /*2*/]))
	{
		...
		if (func_187(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(Local_92[1 /*2*/], false), 30f, 0))
		{
			bLocal_454 = true;
		}
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			Var1 = { func_186(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false) - ENTITY::GET_ENTITY_COORDS(Local_92[1 /*2*/], false)) };
	...
	if (func_37(Local_92[2 /*2*/]))
	{
		...
		if (func_187(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(Local_92[2 /*2*/], false), 30f, 0))
		{
			bLocal_454 = true;
		}
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			Var7 = { func_186(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false) - ENTITY::GET_ENTITY_COORDS(Local_92[2 /*2*/], false)) };
			...
			fLocal_463 = func_185(Var10, Var7);
		}
	}
	else
	{
	...
	if (func_37(Local_92[0 /*2*/]))
	{
		if (func_175(PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 1) < 45f && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
		{
			bLocal_454 = true;
		}
		if (func_187(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(Local_92[0 /*2*/], false), 30f, 0))
		{
			bLocal_454 = true;
		}
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			Var13 = { func_186(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false) - ENTITY::GET_ENTITY_COORDS(Local_92[0 /*2*/], false)) };
			...
			fLocal_462 = func_185(Var16, Var13);
		}
		if (func_184())
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar19, false))
			{
				...
				Var20 = { func_186(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false) - ENTITY::GET_ENTITY_COORDS(Local_92[0 /*2*/], false)) };
				...
				fLocal_462 = func_185(Var23, Var20);
			}
		}
	}
	else
...
bool func_184()//Position - 0x10931
{
	return BitTest(Global_2794162.f_853, 2);
}

float func_185(struct<3> Param0, struct<3> Param3)//Position - 0x10942
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_186(struct<3> Param0)//Position - 0x10963
{
	float fVar0;
	float fVar1;
...
int func_187(struct<3> Param0, struct<3> Param3, struct<3> Param6, float fParam9, bool bParam10)//Position - 0x109A2
{
	int iVar0;
	
	iVar0 = 0;
	if (!func_188(Param0 + Param3))
	{
...
int func_188(struct<3> Param0)//Position - 0x10DAD
{
...
void func_189()//Position - 0x10DD7
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	{
		Var0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_92[0 /*2*/], 0f, func_182(func_175(Local_92[0 /*2*/], Local_92[1 /*2*/], 1), 3f, 25f), 5.5f) };
		...
		Var12 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_92[2 /*2*/], 0f, func_182(func_175(Local_92[2 /*2*/], Local_92[0 /*2*/], 1), 3f, 25f), 5f) };
				...
				if ((!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Var0, Var3, 9f, false, true, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Var6, Var9, 9f, false, true, 0)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Var12, Var15, 9f, false, true, 0))
				{
					...
					if (SYSTEM::TIMERA() > 3000)
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_472, false))
						{
							...
							{
								TASK::TASK_ENTER_VEHICLE(iLocal_472, Local_92[0 /*2*/], 20000, -1, 2f, 1, 0);
							}
							else if (iLocal_472 == Local_109[0 /*14*/])
							{
								TASK::TASK_ENTER_VEHICLE(iLocal_472, Local_92[1 /*2*/], 20000, -1, 2f, 1, 0);
							}
							else if (iLocal_472 == Local_109[5 /*14*/])
							{
								TASK::TASK_ENTER_VEHICLE(iLocal_472, Local_92[2 /*2*/], 20000, -1, 2f, 1, 0);
							}
						}
						iLocal_431 = 2;
					}
...
void func_190(int iParam0)//Position - 0x11799
{
	bool bVar0;
	int iVar1;
...
int func_191(int iParam0, int iParam1, bool bParam2)//Position - 0x1180A
{
	int iVar0;
...
void func_192(int iParam0, int iParam1, bool bParam2)//Position - 0x11850
{
	int iVar0;
...
int func_193(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)//Position - 0x118FA
{
	bool bVar0;
...
int func_194(var uParam0)//Position - 0x11AEE
{
...
void func_195(int* iParam0)//Position - 0x11B48
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_196(int iParam0)//Position - 0x11B80
{
	char* sVar0;
...
void func_198(char* sParam0)//Position - 0x11C6B
{
	func_206(sParam0);
	func_199(0);
}

void func_199(int iParam0)//Position - 0x11C7E
{
	int iVar0;
...
int func_200(int iParam0)//Position - 0x11CC3
{
	int iVar0;
	int iVar1;
	...
	func_201(&(Global_113810.f_2366.f_539), iVar1);
...
void func_201(var uParam0, int iParam1)//Position - 0x11DD3
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_203(Global_113810.f_18536[iVar0], &Var2, &fVar5))
			{
...
void func_202(var uParam0)//Position - 0x11F99
{
	*uParam0 = -15;
}

int func_203(int iParam0, var uParam1, float fParam2)//Position - 0x11FA7
{
	switch (iParam0)
	{
		case 11:
...
void func_204(int iParam0, bool bParam1)//Position - 0x12916
{
	if (bParam1)
	{
...
void func_205()//Position - 0x12954
{
	Global_100868 = 1;
...
void func_206(char* sParam0)//Position - 0x12A41
{
...
void func_207(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x12A80
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_208()//Position - 0x12AD0
{
	struct<3> Var0;
	float fVar3;
	...
	if (bLocal_1512 == 1)
	{
		...
		else if (iLocal_1507 == 3)
		{
			...
			if (!func_231())
			{
				func_230(iLocal_1513, &Var0, &fVar3);
				...
				func_229(&uLocal_492, Var0, 50f, 0);
			}
...
void func_209()//Position - 0x12BE1
{
...
void func_210(int iParam0, int iParam1, int iParam2)//Position - 0x12C1F
{
...
void func_211(int iParam0)//Position - 0x12CE3
{
	if (iParam0 == 1)
	{
...
void func_213(struct<3> Param0, float fParam3)//Position - 0x12D30
{
	Local_92[0 /*2*/] = VEHICLE::CREATE_VEHICLE(joaat("barracks"), Param0, fParam3, true, true, false);
	ENTITY::SET_ENTITY_HEALTH(Local_92[0 /*2*/], ENTITY::GET_ENTITY_HEALTH(Local_92[0 /*2*/]) * 2, 0);
...
void func_214(var uParam0, int iParam1)//Position - 0x12E72
{
	Global_100833.f_22[iParam1] = uParam0;
}

void func_215()//Position - 0x12E86
{
...
void func_216()//Position - 0x12EC4
{
	int iVar0;
	...
	while (iVar0 <= 3)
	{
		func_219(iVar0, Local_92[1 /*2*/]);
		func_218(Local_109[iVar0 /*14*/], 0);
		iVar0++;
	}
	func_213(-248.6621f, 2950.0369f, 28.9996f, 93.5394f);
...
void func_217(struct<3> Param0, float fParam3)//Position - 0x12F83
{
...
void func_218(int iParam0, bool bParam1)//Position - 0x12FB0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_219(int iParam0, int iParam1)//Position - 0x1304B
{
	int iVar0;
	int iVar1;
...
void func_220(struct<3> Param0, float fParam3)//Position - 0x131FD
{
...
void func_221()//Position - 0x1322A
{
	int iVar0;
	...
	{
		func_219(4, Local_92[0 /*2*/]);
		TASK::TASK_VEHICLE_ESCORT(Local_109[4 /*14*/], Local_92[0 /*2*/], Local_92[1 /*2*/], -1, 11f, 786603, -1f, 20, 0f);
		func_218(Local_109[4 /*14*/], 0);
	}
	if (!func_37(Local_92[2 /*2*/]))
	{
...
int func_222(var uParam0)//Position - 0x133BB
{
	if (func_223(uParam0))
	{
		return 1;
...
int func_223(var uParam0)//Position - 0x133D4
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_224(var uParam0)//Position - 0x13DA4
{
...
void func_225(var uParam0)//Position - 0x13DC0
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_226(int iParam0)//Position - 0x13DDB
{
	switch (iParam0)
	{
		case 0:
			...
			func_227(&uLocal_492, &cLocal_473);
...
int func_227(var uParam0, char* sParam1)//Position - 0x13EB2
{
	int iVar0;
	int iVar1;
...
int func_228(var uParam0, int iParam1)//Position - 0x13F79
{
	int iVar0;
	int iVar1;
...
int func_229(var uParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x14023
{
	if (func_188(Param1) || fParam4 <= 0f)
	{
		return 0;
	}
	if (uParam0->f_898)
	{
		if (func_144(uParam0->f_898.f_4, Param1, 0) && uParam0->f_898.f_10 == fParam4)
		{
			uParam0->f_898.f_2 = 0;
			if (!uParam0->f_898.f_1)
			{
...
void func_230(int iParam0, var uParam1, var uParam2)//Position - 0x140DB
{
	switch (iParam0)
	{
		case 0:
...
bool func_231()//Position - 0x14176
{
	return BitTest(Global_100833.f_20, 13);
}

void func_232(var uParam0)//Position - 0x14187
{
	int iVar0;
...
void func_233()//Position - 0x143DF
{
	iLocal_445 = 0;
	while (iLocal_445 <= (3 - 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_99[iLocal_445 /*2*/]) && !PED::IS_PED_INJURED(Local_99[iLocal_445 /*2*/]))
		{
			...
			func_240(&(Local_99[iLocal_445 /*2*/]));
		}
		iLocal_445++;
	}
	iLocal_445 = 0;
	while (iLocal_445 <= (9 - 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_109[iLocal_445 /*14*/]))
		{
			func_239(&(Local_109[iLocal_445 /*14*/].f_2));
			...
			if (!PED::IS_PED_INJURED(Local_109[iLocal_445 /*14*/]))
			{
				...
				func_240(&(Local_109[iLocal_445 /*14*/]));
			}
		}
		iLocal_445++;
	}
	...
	while (iLocal_445 <= (2 - 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_106[iLocal_445]))
		{
			func_238(&(iLocal_106[iLocal_445]));
		}
		iLocal_445++;
	}
	iLocal_445 = 0;
	while (iLocal_445 <= (3 - 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_92[iLocal_445 /*2*/]))
		{
			func_237(Local_92[iLocal_445 /*2*/]);
			func_234(&(Local_92[iLocal_445 /*2*/]));
		}
		iLocal_445++;
	}
	HUD::CLEAR_PRINTS();
...
void func_234(int* iParam0)//Position - 0x145C9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_235(int iParam0)//Position - 0x14665
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
int func_236(int iParam0)//Position - 0x14686
{
	if (func_235(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
void func_237(int iParam0)//Position - 0x146B0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_238(int* iParam0)//Position - 0x1474C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_239(int* iParam0)//Position - 0x14777
{
	bool bVar0;
	struct<8> Var1;
...
void func_240(int* iParam0)//Position - 0x147E9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_241()//Position - 0x1482A
{
	switch (iLocal_1507)
	{
		case 1:
...
void func_242(var uParam0, int iParam1, bool bParam2)//Position - 0x14891
{
	char* sVar0;
...
bool func_243(char* sParam0)//Position - 0x1496B
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_244(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x1497E
{
	func_245(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_245(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x14998
{
	uParam0->f_6 = 0;
	func_246(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_246(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x149BA
{
	int iVar0;
	int iVar1;
...
void func_247(var uParam0)//Position - 0x14D27
{
...
int func_248(var uParam0)//Position - 0x14D90
{
	int iVar0;
...
int func_249(bool bParam0)//Position - 0x14DBB
{
	switch (Global_43377)
	{
		case 0:
...
int func_250(char* sParam0)//Position - 0x14E65
{
	if (!func_251(1, 1, 0))
	{
		if ((!MISC::IS_STRING_NULL_OR_EMPTY(sParam0) && func_243(sParam0)) || func_243("CMN_HINT" /* GXT: ~s~Press ~INPUT_VEH_CIN_CAM~ to toggle focus on the target. */))
		{
			HUD::CLEAR_HELP(true);
		}
		return 0;
...
int func_251(bool bParam0, bool bParam1, bool bParam2)//Position - 0x14EFE
{
	int iVar0;
	int iVar1;
	...
	if ((func_258() || func_257(Global_4718592.f_171044)) || func_256())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
...
int func_252(int iParam0)//Position - 0x15157
{
	if (iParam0 != func_18())
	{
		...
		else if ((Global_1575063 && iParam0 == PLAYER::PLAYER_ID()) && func_253(iParam0, 1, 0))
		{
			return Global_2657704[iParam0 /*463*/].f_321.f_7 != -1;
		}
	}
...
int func_253(int iParam0, bool bParam1, bool bParam2)//Position - 0x151BD
{
	int iVar0;
...
int func_254(int iParam0, int iParam1)//Position - 0x1521D
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_255(int iParam0, bool bParam1)//Position - 0x1527F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_256()//Position - 0x15304
{
	return Global_2683883.f_19;
}

bool func_257(int iParam0)//Position - 0x15312
{
	return iParam0 == 51;
}

var func_258()//Position - 0x1531F
{
	return Global_2683883.f_18;
}

bool func_259()//Position - 0x1532D
{
	return MISC::GET_GAME_TIMER() <= Global_23390.f_6321 + 100;
}

int func_260(int iParam0)//Position - 0x15342
{
	if (iParam0 == 1)
	{
		if (Global_20500.f_1 > 3)
...
void func_261(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x15399
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_262()//Position - 0x154A9
{
	return func_263(PLAYER::PLAYER_ID());
}

int func_263(int iParam0)//Position - 0x154B9
{
...
int func_264(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x154D8
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_265(bool bParam0, bool bParam1, bool bParam2)//Position - 0x15844
{
...
int func_266(bool bParam0, bool bParam1, bool bParam2)//Position - 0x15896
{
	if (!func_251(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_267(bool bParam0, bool bParam1, bool bParam2)//Position - 0x158DF
{
	if (!func_251(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_268(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1593E
{
	if (!func_251(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_269(int iParam0)//Position - 0x15994
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(iParam0))
...
void func_270()//Position - 0x159EF
{
	MISC::SET_BIT(&Global_8371, 4);
}

void func_271(var uParam0)//Position - 0x159FF
{
	func_223(uParam0);
}

void func_272()//Position - 0x15A0E
{
	struct<3> Var0;
	var uVar3;
	...
	iLocal_443 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(35.394558f, 3600.5378f, 1375.234f) - Vector(0f, 7f, 14.25f), Vector(35.394558f, 3600.5378f, 1375.234f) + Vector(3f, 7f, 14.25f), false, true, true, true);
	...
	if (func_212() || func_7(0))
	{
		...
		if (func_212())
		{
			func_230(iLocal_1513, &Var0, &uVar3);
			func_348(Var0, uVar3, 1, 0);
		}
		bLocal_1512 = true;
	}
	else
...
void func_273(int iParam0)//Position - 0x15C1D
{
	Global_96668 = 0;
	switch (iParam0)
	{
...
void func_274(int iParam0)//Position - 0x15CAB
{
	MISC::SET_BIT(&Global_96668, iParam0);
}

void func_275(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x15CBD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_276(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x15E32
{
	func_277(&Global_107357, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_277(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x15E4E
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_24();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_295())
		{
			func_286(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
int func_278(var uParam0)//Position - 0x16CD7
{
...
void func_279(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x16CF9
{
	int iVar0;
...
int func_280(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x16D81
{
...
int func_281(int iParam0)//Position - 0x16DC1
{
	int iVar0;
...
void func_282(var uParam0, int iParam1, int iParam2)//Position - 0x16DEF
{
...
int func_283(int iParam0)//Position - 0x16ECB
{
	int iVar0;
...
int func_284(int iParam0, int iParam1, int iParam2)//Position - 0x16F0D
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98144[iVar0]))
		{
			if (Global_98144[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || ENTITY::GET_ENTITY_MODEL(iParam0) == func_136(iParam1, iParam2))
					{
						return 1;
					}
				}
...
int func_285(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x16F9B
{
	char* sVar0;
...
void func_286(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x170C8
{
	int iVar0;
	int iVar1;
...
int func_287(int iParam0, int iParam1)//Position - 0x17262
{
	int iVar0;
	var uVar1;
...
int func_288(int iParam0, var uParam1)//Position - 0x17291
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_289(uParam1));
}

int func_289(var uParam0)//Position - 0x172A6
{
	int iVar0;
	int iVar1;
...
var func_290()//Position - 0x172DA
{
	return Global_1574918;
}

int func_291(int iParam0, int iParam1)//Position - 0x172E6
{
	int iVar0;
	var uVar1;
...
int func_292(int iParam0, var uParam1)//Position - 0x1730A
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_289(uParam1));
}

void func_293(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x1731F
{
	int iVar0;
...
void func_294(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x17868
{
	int iVar0;
...
int func_295()//Position - 0x17AA9
{
	func_25();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_296(int iParam0, bool bParam1)//Position - 0x17AC2
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_26(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_297(iParam0, &(Global_113810.f_2366.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_297(int iParam0, var uParam1)//Position - 0x17BB5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_298(int iParam0)//Position - 0x17E3D
{
	switch (iParam0)
	{
...
int func_299(int iParam0)//Position - 0x17EDE
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_300(int iParam0, int iParam1)//Position - 0x181CF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_301(int iParam0, var* uParam1)//Position - 0x18E80
{
	int iVar0;
	int iVar1;
...
int func_302(int iParam0)//Position - 0x18EBB
{
	int iVar0;
...
void func_303(int iParam0)//Position - 0x1912F
{
	int iVar0;
...
void func_304(var uParam0, int iParam1)//Position - 0x1916B
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_305(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x196BA
{
	int iVar0;
	int iVar1;
...
bool func_306(int iParam0, var uParam1, var uParam2)//Position - 0x196FE
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
int func_307(var uParam0)//Position - 0x19E7D
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_333())
		{
			*uParam0 = func_313(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 6, -1, 0, 1, -1);
...
bool func_308(int iParam0)//Position - 0x19ED8
{
	return func_309(iParam0, 0, 1);
}

int func_309(int iParam0, int iParam1, bool bParam2)//Position - 0x19EE8
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_310(int iParam0)//Position - 0x19F48
{
	switch (iParam0)
	{
		case 0:
...
int func_311()//Position - 0x1A2F0
{
	return Global_32283;
}

int func_312(int iParam0)//Position - 0x1A2FB
{
	return func_309(iParam0, 5, 1);
}

int func_313(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x1A30B
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 60)
	{
		if (iParam3 == 6 || iParam3 == func_332(iVar0))
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_314(iVar0, 0), true);
...
Vector3 func_314(int iParam0, bool bParam1)//Position - 0x1A3AD
{
	switch (iParam0)
	{
		case -1:
		...
		case 45:
			return func_328(Global_102986);
			break;
		
		case 46:
			if (Global_1853823 != func_18())
			{
				if (func_327(Global_1853823))
				{
					return func_320(2, 2);
				}
				else if (func_319(Global_1853823))
				{
...
Vector3 func_315()//Position - 0x1AB18
{
	if (!func_188(Global_1956855))
	{
...
int func_316()//Position - 0x1AE13
{
	return Global_2652364.f_2650;
}

Vector3 func_317(struct<3> Param0)//Position - 0x1AE22
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_318(), 0f, Param0);
}

Vector3 func_318()//Position - 0x1AE37
{
	return -880f, -2770f, -50f;
}

int func_319(int iParam0)//Position - 0x1AE4E
{
	if (iParam0 != func_18())
	{
...
Vector3 func_320(int iParam0, int iParam1)//Position - 0x1AEA6
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_321(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x1AF50
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_322(struct<3> Param0, float fParam3)//Position - 0x1AFE5
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_323(int iParam0)//Position - 0x1B029
{
	struct<6> Var0;
...
struct<6> func_324(int iParam0)//Position - 0x1B1AD
{
	return func_325(iParam0);
}

struct<6> func_325(int iParam0)//Position - 0x1B1BB
{
	struct<6> Var0;
...
int func_326(int iParam0, var uParam1)//Position - 0x1BC82
{
	switch (iParam0)
	{
		case 0:
...
int func_327(int iParam0)//Position - 0x1BD04
{
	if (iParam0 != func_18())
	{
...
Vector3 func_328(int iParam0)//Position - 0x1BD5C
{
	switch (iParam0)
	{
		case 1:
...
int func_329()//Position - 0x1BFC8
{
	return func_330(PLAYER::PLAYER_ID());
}

int func_330(int iParam0)//Position - 0x1BFD8
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_331(int iParam0)//Position - 0x1BFF5
{
	return func_309(iParam0, 0, 0);
}

int func_332(int iParam0)//Position - 0x1C007
{
	switch (iParam0)
	{
		case -1:
...
bool func_333()//Position - 0x1C33D
{
	return Global_100885.f_393 > 0;
}

int func_334(char* sParam0)//Position - 0x1C34E
{
...
struct<2> func_335(int iParam0)//Position - 0x1C3A4
{
	struct<2> Var0;
...
int func_336(char* sParam0, int iParam1)//Position - 0x1C7F0
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_337(int iParam0, var uParam1)//Position - 0x1C839
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_338(uParam1, "Barry3A", func_340(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_339(iParam0), 0, 1);
			break;
		...
		case 8:
			func_338(uParam1, "Dreyfuss1", func_340(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_339(iParam0), 0, 0);
			break;
		...
		case 38:
			func_338(uParam1, "Nigel1A", func_340(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_339(iParam0), 1, 1);
			break;
		...
		case 49:
			func_338(uParam1, "Paparazzo3A", func_340(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_339(iParam0), 0, 1);
			break;
		...
		case 58:
			func_338(uParam1, "Tonya1", func_340(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_339(iParam0), 0, 1);
			break;
...
int func_339(int iParam0)//Position - 0x1DA7F
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_340(int iParam0)//Position - 0x1DDC5
{
	struct<2> Var0;
	char[] cVar2[8];
...
int func_341(int iParam0)//Position - 0x1DDFC
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_342(Global_113810.f_9088.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_342(Global_113810.f_9088.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_342(Global_113810.f_9088.f_99.f_205[11]);
			break;
		
		case 90:
			return func_342(Global_113810.f_9088.f_99.f_205[7]);
			break;
		
		case 93:
			return func_342(Global_113810.f_9088.f_99.f_205[9]);
			break;
	}
	return 0;
}

int func_342(int iParam0)//Position - 0x1DEB8
{
	switch (iParam0)
	{
		case 1:
...
int func_343(char* sParam0, bool bParam1)//Position - 0x1DF0C
{
	int iVar0;
	int iVar1;
...
int func_344(int iParam0, bool bParam1)//Position - 0x1DF36
{
	int iVar0;
...
void func_345(bool bParam0)//Position - 0x1DF6C
{
	int iVar0;
	int iVar1;
...
int func_346()//Position - 0x1E1EE
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_92[0 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97310[0]))
		{
			...
			Local_92[0 /*2*/] = Global_97310[0];
			AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(Global_97310[0], 0f);
			AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(Local_92[0 /*2*/], "PS_PREP_VEHICLES_GROUP", 0f);
			func_214(Local_92[0 /*2*/], 0);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_92[1 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97310[1]))
		{
			...
			Local_92[1 /*2*/] = Global_97310[1];
			AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(Global_97310[1], 0f);
			AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(Local_92[1 /*2*/], "PS_PREP_VEHICLES_GROUP", 0f);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_92[2 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97310[2]))
		{
			...
			Local_92[2 /*2*/] = Global_97310[2];
			AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(Global_97310[2], 0f);
			AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(Local_92[2 /*2*/], "PS_PREP_VEHICLES_GROUP", 0f);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_109[4 /*14*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97310.f_9[0]))
		{
			...
			Local_109[4 /*14*/] = Global_97310.f_9[0];
			func_218(Local_109[4 /*14*/], 0);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_109[0 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97310.f_9[2], true, true);
			Local_109[0 /*14*/] = Global_97310.f_9[2];
			func_218(Local_109[0 /*14*/], 0);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_109[1 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97310.f_9[3], true, true);
			Local_109[1 /*14*/] = Global_97310.f_9[3];
			func_218(Local_109[1 /*14*/], 0);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_109[2 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97310.f_9[4], true, true);
			Local_109[2 /*14*/] = Global_97310.f_9[4];
			func_218(Local_109[2 /*14*/], 0);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_109[3 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97310.f_9[5], true, true);
			Local_109[3 /*14*/] = Global_97310.f_9[5];
			func_218(Local_109[3 /*14*/], 0);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_109[5 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97310.f_9[6], true, true);
			Local_109[5 /*14*/] = Global_97310.f_9[6];
			func_218(Local_109[5 /*14*/], 0);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_109[6 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97310.f_9[7], true, true);
			Local_109[6 /*14*/] = Global_97310.f_9[7];
			func_218(Local_109[6 /*14*/], 0);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_109[7 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97310.f_9[8], true, true);
			Local_109[7 /*14*/] = Global_97310.f_9[8];
			func_218(Local_109[7 /*14*/], 0);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_109[8 /*14*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97310.f_9[9]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97310.f_9[9], true, true);
			Local_109[8 /*14*/] = Global_97310.f_9[9];
			func_218(Local_109[8 /*14*/], 0);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_106[0]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97310.f_28[0]))
		{
			...
			iLocal_106[0] = Global_97310.f_28[0];
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_106[1]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97310.f_28[1]))
		{
			...
			iLocal_106[1] = Global_97310.f_28[1];
		}
	}
	iVar0 = 0;
	while (iVar0 <= (9 - 1))
	...
	cLocal_473 = { Global_97711 };
	StringCopy(&Global_97711, "", 64);
	func_347(229, 0f, 0f, 2000f);
...
void func_347(int iParam0, struct<3> Param1)//Position - 0x1E70A
{
	int iVar0;
...
void func_348(struct<3> Param0, var uParam3, int iParam4, int iParam5)//Position - 0x1E759
{
	if (func_212())
	{
...
void func_350()//Position - 0x1E818
{
	func_39(&Local_401, 1, 0);
	iLocal_445 = 0;
	while (iLocal_445 <= (3 - 1))
	...
	while (iLocal_445 <= (9 - 1))
	{
		...
		{
			func_207(&(Local_109[iLocal_445 /*14*/]), 1, 0, 1);
	...
	while (iLocal_445 <= (2 - 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_106[iLocal_445]))
		{
			func_353(&(iLocal_106[iLocal_445]), 0);
		}
		iLocal_445++;
	}
	iLocal_445 = 0;
...
void func_351()//Position - 0x1EA3B
{
	Global_96668 = 0;
}

void func_352(bool bParam0)//Position - 0x1EA48
{
	if (bParam0)
	{
...
void func_353(int* iParam0, bool bParam1)//Position - 0x1EA74
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_354()//Position - 0x1EAAF
{
	int iVar0;
