...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			...
			{
				func_289("Relinquishing candidate id...");
				func_288(&(Global_112735[Var0.f_0 /*10*/].f_9));
			}
		}
		func_273(&Var0, 1);
	}
	...
	iVar1[1] = 59;
	iVar1[2] = 62;
	if (!func_270(&iVar1, &Var0, Local_52, 1f))
	{
		func_289("SCRIPT TERMINATED");
	...
	if (func_260(43))
	{
		func_289("SP_MISSION_LAMAR is available... [TERMINATING]");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	else if (func_260(47))
	{
		func_289("SP_MISSION_MICHAEL_2 is available... [TERMINATING]");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	else if (func_260(40))
	{
		func_289("SP_MISSION_FRANKLIN_0 is available... [TERMINATING]");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	else if (func_260(41))
	{
		func_289("SP_MISSION_FRANKLIN_1 is available... [TERMINATING]");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	while (!func_258(&Var0))
	{
		...
		{
			func_289("Player out of range [TERMINATING]");
			func_273(&Var0, 1);
		}
	}
	...
	{
		SYSTEM::WAIT(0);
		if (!func_220(&Var0, 1) || func_261(Var0.f_0))
		{
			func_273(&Var0, 1);
		}
		if (func_260(43))
		{
			func_289("SP_MISSION_LAMAR became available... [TERMINATING]");
			func_273(&Var0, 1);
		}
		else if (func_260(47))
		{
			func_289("SP_MISSION_MICHAEL_2 became available... [TERMINATING]");
			func_273(&Var0, 1);
		}
		else if (func_260(40))
		{
			func_289("SP_MISSION_FRANKLIN_0 became available... [TERMINATING]");
			func_273(&Var0, 1);
		}
		else if (func_260(41))
		{
			func_289("SP_MISSION_FRANKLIN_1 became available... [TERMINATING]");
			func_273(&Var0, 1);
		}
		func_219(Var0.f_0);
		func_211(&iLocal_227, &(Var0.f_9), Local_52);
		func_189(&Var0);
		if (func_174(&Var0, 0))
		{
			if (!func_2(&Var0))
...
int func_2(int iParam0)//Position - 0x2E0
{
	...
	if (!func_173())
	{
		while (!func_164(*iParam0))
		{
			...
			{
				func_289("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			SYSTEM::WAIT(0);
		}
	...
	if (!func_118(iParam0))
	{
		func_289("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x3925
{
	int iVar0;
	var uVar1;
...
int func_50(var uParam0)//Position - 0x3962
{
	int iVar0;
	int iVar1;
...
int func_51()//Position - 0x3996
{
	return Global_1574918;
}

int func_52(int iParam0, int iParam1)//Position - 0x39A2
{
	int iVar0;
	var uVar1;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39CE
{
	int iVar0;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F17
{
	int iVar0;
...
int func_55()//Position - 0x4158
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_56()//Position - 0x4171
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x426E
{
	return Global_43257 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x427C
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x436F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x45F7
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x4698
{
...
int func_62(int iParam0, int iParam1)//Position - 0x4872
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x54D3
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x550E
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x5782
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x57BE
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5D0D
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5D51
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x64D0
{
	if (bParam2)
	{
...
int func_70(var uParam0)//Position - 0x6517
{
...
bool func_71(int iParam0)//Position - 0x6572
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x6582
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x65E3
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x697C
{
	return Global_32163;
}

int func_75(int iParam0)//Position - 0x6987
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6997
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x6A39
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_78()//Position - 0x7189
{
...
int func_79()//Position - 0x7484
{
	return Global_2652258.f_2650;
}

int func_80(struct<3> Param0)//Position - 0x7493
{
...
int func_81(int iParam0)//Position - 0x74BD
{
	if (iParam0 != func_90())
	{
...
Vector3 func_82(int iParam0, int iParam1)//Position - 0x7515
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_83(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x75BF
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
...
Vector3 func_84(struct<3> Param0, float fParam1)//Position - 0x7654
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_85(int iParam0)//Position - 0x7698
{
	struct<6> Var0;
...
struct<6> func_86(int iParam0)//Position - 0x781C
{
	return func_87(iParam0);
}

struct<6> func_87(int iParam0)//Position - 0x782A
{
	struct<6> Var0;
...
int func_88(int iParam0, var uParam1)//Position - 0x82F3
{
	switch (iParam0)
	{
		case 0:
...
int func_89(int iParam0)//Position - 0x8375
{
	if (iParam0 != func_90())
	{
...
int func_90()//Position - 0x83CD
{
	return -1;
}

Vector3 func_91(int iParam0)//Position - 0x83D6
{
	switch (iParam0)
	{
		case 1:
...
int func_92()//Position - 0x864D
{
	return func_93(PLAYER::PLAYER_ID());
}

int func_93(int iParam0)//Position - 0x865D
{
...
int func_95(int iParam0)//Position - 0x868A
{
	switch (iParam0)
	{
		case -1:
...
bool func_96()//Position - 0x89B3
{
	return Global_100733.f_387 > 0;
}

var func_97()//Position - 0x89C4
{
	var uVar0;
...
void func_98(var uParam0, int iParam1)//Position - 0x8A0A
{
	if (iParam1 <= 0)
	{
		return;
...
void func_99(var uParam0, int iParam1)//Position - 0x8A90
{
...
void func_100(var uParam0, int iParam1)//Position - 0x8AC3
{
	int iVar0;
	int iVar1;
...
int func_101(int iParam0, int iParam1)//Position - 0x8B14
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_102(int iParam0)//Position - 0x8BB6
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_103(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_103(bool bParam0, int iParam1, int iParam2)//Position - 0x8BD8
{
	if (bParam0)
	{
		return iParam1;
...
int func_104(var uParam0)//Position - 0x8BEF
{
	return uParam0 & 15;
}

void func_105(var uParam0, int iParam1)//Position - 0x8BFC
{
...
void func_106(var uParam0, int iParam1)//Position - 0x8C36
{
...
void func_107(var uParam0, int iParam1)//Position - 0x8C71
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_108()//Position - 0x8CAD
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_109(int iParam0)//Position - 0x8CC6
{
	var uVar0;
	char cVar1[24];
...
bool func_110()//Position - 0x8D1F
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_111()//Position - 0x8D35
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_112(char* sParam0, int iParam1, int iParam2)//Position - 0x8D4B
{
...
int func_113(bool bParam0)//Position - 0x8D8D
{
...
struct<2> func_114(int iParam0)//Position - 0x8DB5
{
	struct<2> Var0;
...
void func_115(int iParam0, var uParam1)//Position - 0x9202
{
	switch (iParam0)
	{
		case 0:
...
int func_117(int iParam0)//Position - 0xA4DA
{
	switch (iParam0)
	{
		case 0:
...
int func_118(int iParam0)//Position - 0xA820
{
	int iVar0;
	
	if (func_148(&(iParam0->f_1)))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&(iParam0->f_9)))
		{
			func_138(1);
			func_136(iParam0, 1, func_137(*iParam0));
		}
		if (iParam0->f_27)
		{
			if (func_135(*iParam0))
		...
		{
			func_289("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::SET_SCRIPT_CAN_START_CUTSCENE(iVar0);
		}
		else
		{
			func_289("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_119(int iParam0)//Position - 0xA8C5
{
	struct<2> Var0;
...
void func_120(int iParam0)//Position - 0xA960
{
	if (iParam0 < 63)
	{
		func_121();
...
void func_122(int iParam0)//Position - 0xA9BE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_123(int iParam0)//Position - 0xAA17
{
...
int func_124(int iParam0)//Position - 0xAA9A
{
	int iVar0;
...
void func_125(int iParam0, int iParam1, int iParam2)//Position - 0xAACB
{
	func_126(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_126(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAAE0
{
	int iVar0;
...
int func_128(int iParam0, int iParam1, int iParam2)//Position - 0xAB93
{
...
int func_129(int iParam0, int iParam1, int iParam2)//Position - 0xABAE
{
	int iVar0;
...
int func_130(int iParam0)//Position - 0xABFA
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0xAC43
{
	if (func_132(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_132(int iParam0)//Position - 0xAC63
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_133(int iParam0)//Position - 0xAC84
{
	switch (iParam0)
	{
		case 5:
...
int func_135(int iParam0)//Position - 0xAD54
{
	switch (iParam0)
	{
		case 5:
...
void func_136(var uParam0, bool bParam1, bool bParam2)//Position - 0xADA7
{
	int iVar0;
...
int func_137(int iParam0)//Position - 0xAE9C
{
	switch (iParam0)
	{
		case 5:
...
void func_138(bool bParam0)//Position - 0xAF07
{
	int iVar0;
...
void func_139(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAF46
{
	if (bParam0)
	{
...
bool func_140()//Position - 0xB093
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_141(int iParam0, int iParam1)//Position - 0xB0AD
{
	bool bVar0;
...
int func_142(int iParam0, bool bParam1)//Position - 0xB0F8
{
	int iVar0;
	int iVar1;
...
int func_143(int iParam0)//Position - 0xB139
{
...
bool func_144()//Position - 0xB178
{
	return BitTest(Global_2621446, 3);
}

int func_145(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB186
{
	int iVar0;
...
void func_147(int iParam0)//Position - 0xB1E0
{
	if (iParam0 == 1)
	{
...
int func_148(char* sParam0)//Position - 0xB203
{
	...
	func_289("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}

void func_149()//Position - 0xB240
{
	Global_20591 = 0;
	func_150();
}

void func_150()//Position - 0xB250
{
...
void func_153()//Position - 0xB2DE
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_154(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_154(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB336
{
...
void func_155(int iParam0)//Position - 0xB4CE
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_157(int iParam0)//Position - 0xB54B
{
	if (func_162())
	{
		return;
...
void func_158(int iParam0)//Position - 0xB57E
{
	if (func_162())
	{
		return;
...
void func_159(bool bParam0, bool bParam1)//Position - 0xB608
{
	if (bParam0)
	{
		if (func_161(0))
...
bool func_160()//Position - 0xB67C
{
	return BitTest(Global_1962996, 5);
}

int func_161(int iParam0)//Position - 0xB68A
{
	if (iParam0 == 1)
	{
...
bool func_162()//Position - 0xB6E1
{
	return BitTest(Global_1962996, 19);
}

int func_163(int iParam0)//Position - 0xB6F0
{
...
int func_164(int iParam0)//Position - 0xB731
{
	int iVar0;
...
void func_165(int iParam0)//Position - 0xB776
{
...
int func_166(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB7A8
{
	int iVar0;
...
void func_167(var uParam0, int iParam1)//Position - 0xB8DF
{
	int iVar0;
...
bool func_168(int iParam0)//Position - 0xB92E
{
	return func_169(iParam0, Global_43257);
}

int func_169(int iParam0, int iParam1)//Position - 0xB93F
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_170(int iParam0)//Position - 0xBB20
{
	if (Global_43257 == 15)
	{
		return 0;
...
int func_171()//Position - 0xBB42
{
	return func_172(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_172(char* sParam0, int iParam1)//Position - 0xBB53
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_174(var uParam0, int iParam1)//Position - 0xBBC0
{
	switch (uParam0->f_16)
	{
		case 0:
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_180(2))
							{
								if (func_178(uParam0->f_27))
								{
									...
									func_289("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_132(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
					{
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.88849f, 371.9034f, 103.98843f, 241.58984f, 359.64575f, 107.34612f, 1.25f, false, true, 0))
					{
						if (func_180(2))
						{
							...
							{
								func_177(uParam0->f_27, *uParam0);
								func_289("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.9482f, 4143.44f, 42.292946f, 2722.2134f, 4144.5215f, 45.431824f, 10f, false, true, 0))
				{
					if (func_180(2))
					{
						...
						{
							func_177(1, *uParam0);
							func_289("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.11035f, 68.460175f, -1028.5663f, 395.46133f, 94.57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.75565f, 68.02096f, -1021.4514f, 336.34583f, 93.18714f, 14.5f, false, true, 0))
						{
							if (func_180(2))
							{
								...
								{
									func_177(uParam0->f_27, *uParam0);
									func_289("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_175()//Position - 0xC3A5
{
	func_27(&(Global_104212.f_2890), &Global_104212, 0, 1, 1, 0);
}

int func_176(var uParam0)//Position - 0xC3C0
{
	float fVar0;
...
void func_177(int iParam0, int iParam1)//Position - 0xC44E
{
	if (iParam0 == 1)
	{
		if (!func_135(iParam1))
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_289("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_289("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
int func_178(bool bParam0)//Position - 0xC4B2
{
	int iVar0;
...
int func_179(int iParam0)//Position - 0xC549
{
	if (func_132(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_180(int iParam0)//Position - 0xC573
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_188()) || Global_112695) || Global_32166) || func_187()) || func_186(8, -1)) || func_96()) || func_185()) || func_184()) || func_183()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_188()) || Global_32166) || func_187()) || func_186(8, -1)) || func_184()) || func_96()) || func_185()) || func_183()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_188()) || Global_112695) || Global_32166) || func_187()) || func_186(8, -1)) || func_96()) || func_185()) || func_183()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_188()) || func_185()) || Global_112695) || Global_32166) || func_187()) || Global_44446) || func_186(8, -1)) || func_184()) || func_182()) || func_183()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_181()//Position - 0xCC90
{
	return Global_100720.f_1;
}

int func_182()//Position - 0xCC9E
{
	if (Global_97603 != -1)
	{
...
bool func_185()//Position - 0xCD05
{
	return Global_100733.f_388 > 0;
}

bool func_186(int iParam0, int iParam1)//Position - 0xCD16
{
	switch (iParam0)
	{
		case 5:
...
var func_187()//Position - 0xCD4E
{
	return Global_1575060;
}

int func_188()//Position - 0xCD5A
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_189(var uParam0)//Position - 0xCD76
{
	float fVar0;
	
	if (func_183() || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		AUDIO::STOP_SCRIPTED_CONVERSATION(false);
		return;
	}
		...
		if (fVar0 < (20f * 20f) && iLocal_56)
		{
			switch (iLocal_57)
			{
				case 0:
					if (!func_151())
					{
						func_210(&uLocal_58, 3, uParam0->f_28[0], "TONYA", 0, 1);
						if (*uParam0 == 58)
						{
							func_209(&uLocal_58, "TOWAUD", "TONYA_BECK_1", 4, 0, 0, 0);
						...
						{
							func_197(&uLocal_58, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_1", 4, 0, 0);
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
							{
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
						...
						{
							func_197(&uLocal_58, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_1", 4, 0, 0);
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
							{
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
				...
				case 2:
					if (func_196(&iLocal_223))
					{
						if (func_190(&iLocal_223) > MISC::GET_RANDOM_FLOAT_IN_RANGE(9f, 15f))
						{
							iLocal_226++;
							switch (iLocal_226)
							{
								case 1:
									if (*uParam0 == 58)
									{
										func_209(&uLocal_58, "TOWAUD", "TONYA_BECK_2", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_197(&uLocal_58, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_2", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_197(&uLocal_58, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_2", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
								...
								case 2:
									if (*uParam0 == 58)
									{
										func_209(&uLocal_58, "TOWAUD", "TONYA_BECK_3", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_197(&uLocal_58, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_3", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_197(&uLocal_58, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_3", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
								...
								case 3:
									if (*uParam0 == 58)
									{
										func_209(&uLocal_58, "TOWAUD", "TONYA_BECK_4", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_197(&uLocal_58, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_4", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_197(&uLocal_58, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_4", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
								...
								case 4:
									if (*uParam0 == 58)
									{
										func_209(&uLocal_58, "TOWAUD", "TONYA_BECK_5", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_197(&uLocal_58, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_5", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_197(&uLocal_58, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_5", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
...
float func_190(int* iParam0)//Position - 0xDB27
{
	if (func_196(iParam0))
	{
		if (func_192(iParam0))
		...
		{
			return (func_191(BitTest(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}

float func_191(bool bParam0)//Position - 0xDB63
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_192(int* iParam0)//Position - 0xDBBB
{
	return BitTest(*iParam0, 2);
}

void func_193(int* iParam0)//Position - 0xDBC8
{
	func_194(iParam0, 0f);
}

void func_194(int* iParam0, float fParam1)//Position - 0xDBD7
{
...
void func_195(int* iParam0)//Position - 0xDC02
{
	if (!func_196(iParam0))
	{
		func_193(iParam0);
...
bool func_196(int* iParam0)//Position - 0xDC1A
{
	return BitTest(*iParam0, 1);
}

int func_197(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0xDC27
{
	...
	Global_2883585 = 0;
	return func_198(sParam2, iParam4, 0);
}

int func_198(char* sParam0, int iParam1, bool bParam2)//Position - 0xDC7B
{
	Global_21726 = 0;
...
bool func_201(int iParam0)//Position - 0xDFE3
{
	return func_202(iParam0, 20);
}

var func_202(int iParam0, int iParam1)//Position - 0xDFF3
{
	return BitTest(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

void func_203()//Position - 0xE00B
{
	int iVar0;
...
void func_208(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE265
{
...
int func_209(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE2BB
{
	...
	Global_22722 = 0;
	Global_2883585 = 0;
	return func_198(sParam2, iParam3, 0);
}

void func_210(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xE309
{
...
void func_211(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xE3A4
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_215(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_214(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_215(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_217(iParam0);
				}
			}
...
void func_212(int iParam0, bool bParam1)//Position - 0xE495
{
	if (iParam0 == -1)
	{
		return;
...
int func_213(int iParam0)//Position - 0xE4D1
{
	if (Global_78554 == iParam0)
	{
		if (Global_78555 == -1)
...
void func_214(int iParam0, int iParam1)//Position - 0xE50A
{
	bool bVar0;
	int iVar1;
...
float func_215(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xE5A8
{
	struct<3> Var0;
...
bool func_216()//Position - 0xE5E2
{
	return Global_97990;
}

void func_217(int iParam0)//Position - 0xE5EE
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_218(iParam0);
...
void func_218(int iParam0)//Position - 0xE605
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_219(int iParam0)//Position - 0xE6ED
{
	if (iParam0 == -1)
	{
		iParam0 = func_171();
...
int func_220(int iParam0, bool bParam1)//Position - 0xE715
{
	struct<27> Var0;
	
	if (Global_78558)
	{
		func_289("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_115(*iParam0, &Var0);
	if ((func_257(*iParam0) || func_255(*iParam0)) || Global_78804 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_289("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_251(*iParam0))
	{
		if (*iParam0 == 19)
		{
			func_250(iParam0->f_28[0]);
		}
		func_289("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (iParam0->f_25 == 1)
	{
		if (!func_230(iParam0, 1, 0))
		{
			return 0;
		}
	}
	...
	if (*iParam0 == 10)
	{
		...
		{
			func_289("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_289("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
	if (func_224(&(iParam0->f_48)) && bParam1)
	{
		func_221(iParam0->f_28[0], &(iParam0->f_48), *iParam0);
	}
	return 1;
}

void func_221(int iParam0, var uParam1, int iParam2)//Position - 0xE985
{
	int iVar0;
	int iVar1;
...
int func_222(int iParam0)//Position - 0xECDD
{
...
int func_223(var uParam0)//Position - 0xECFD
{
...
int func_224(var uParam0)//Position - 0xED15
{
...
void func_225(var uParam0)//Position - 0xED3A
{
	int iVar0;
	int iVar1;
...
void func_226(int* iParam0)//Position - 0xF03E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_227(var uParam0)//Position - 0xF069
{
	int iVar0;
...
int func_228(var uParam0, bool bParam1, bool bParam2)//Position - 0xF0E9
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_131(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				{
					func_289("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[iVar0], false))
				{
					func_289("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[iVar0], PLAYER::PLAYER_PED_ID(), false))
				{
					func_289("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[iVar0]) < 850)
				{
					func_289("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							func_289("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_179(iVar2))
						{
							if (ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck") || ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck2"))
							{
								if (func_179(uParam0->f_35[iVar0]))
								{
									...
									{
										func_289("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_179(iVar3))
						{
							...
							{
								func_289("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							...
							{
								func_289("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
...
int func_229(int iParam0, int iParam1)//Position - 0xF2A7
{
	int iVar0;
...
int func_230(var uParam0, bool bParam1, int iParam2)//Position - 0xF2D7
{
	int iVar0;
	int iVar1;
	...
	if (func_131(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[iVar0]))
						{
							...
							func_289("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[iVar0]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[iVar0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[iVar0]))
					{
						...
						func_289("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[iVar0], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
						{
							...
							func_289("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_249(*uParam0))
					{
						if (!func_163(*uParam0))
						{
							if (func_244(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								...
								func_289("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[iVar0], true), 15f))
						{
							...
							func_289("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_232(uParam0->f_28[iVar0], 1126825984))
						{
							...
							func_289("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_231(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_289("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_289("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_132(uParam0->f_41[0]))
						{
...
int func_231(int iParam0)//Position - 0xF593
{
...
int func_232(int iParam0, float fParam1)//Position - 0xF5C7
{
	float fVar0;
...
bool func_233(int iParam0, float fParam1)//Position - 0xF63D
{
	return func_234(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_234(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF655
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_235(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_235(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xF716
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_236(int iParam0, int iParam1)//Position - 0xF842
{
	int iVar0;
...
int func_238(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xF951
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	{
		Var1 = { func_240(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_239(struct<3> Param0, struct<3> Param1)//Position - 0xF9E2
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_240(struct<3> Param0)//Position - 0xFA03
{
	float fVar0;
	float fVar1;
...
void func_241(var uParam0)//Position - 0xFA42
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_242(int iParam0, int iParam1)//Position - 0xFA5D
{
	int iVar0;
...
int func_243(int iParam0)//Position - 0xFA9C
{
...
int func_244(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xFAC4
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_245(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xFBBF
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_246(int iParam0, float fParam1)//Position - 0xFCCB
{
	var uVar0;
	struct<3> Var1;
...
int func_247(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xFD60
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_248(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xFDEE
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_249(int iParam0)//Position - 0xFE36
{
...
void func_250(int iParam0)//Position - 0xFE80
{
	int iVar0;
...
int func_251(int iParam0)//Position - 0xFF1D
{
	if (iParam0 == -1)
	{
		iParam0 = func_171();
...
int func_252(int iParam0)//Position - 0xFFB2
{
...
int func_255(int iParam0)//Position - 0x10034
{
	if ((func_256() && Global_100681.f_11 == 6) && iParam0 == func_172(&(Global_100681.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_257(int iParam0)//Position - 0x100A6
{
	if (func_113(0))
	{
...
int func_258(int iParam0)//Position - 0x100CE
{
	if (!func_259(iParam0))
	{
		return 0;
	...
	iLocal_55 = 1;
	func_289("Created initial scene");
	return 1;
}

int func_259(var uParam0)//Position - 0x10122
{
	bool bVar0;
	int iVar1;
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_132(uParam0->f_28[0]) && PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				TASK::CLEAR_SEQUENCE_TASK(&iVar1);
				TASK::OPEN_SEQUENCE_TASK(&iVar1);
...
int func_260(int iParam0)//Position - 0x103D8
{
	int iVar0;
...
int func_261(int iParam0)//Position - 0x10440
{
	struct<27> Var0;
	bool bVar1;
...
int func_262(int iParam0)//Position - 0x10491
{
	char* sVar0;
	
	if (Global_78558)
	{
		func_289("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!Global_113648.f_9087 && !func_113(1))
	{
		func_289("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_263(iParam0))
	{
		Global_112735[iParam0 /*10*/].f_1 = 1;
		func_289("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_100681.f_11 == 6)
	{
		if (Global_100681 < 9)
		{
			...
			{
				func_289("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	...
	{
		Global_112735[iParam0 /*10*/].f_1 = 1;
		func_289("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}

int func_263(int iParam0)//Position - 0x1054A
{
	var uVar0;
...
int func_264(int iParam0)//Position - 0x1060B
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_265(int iParam0, char* sParam1)//Position - 0x10690
{
...
int func_266(int iParam0)//Position - 0x10772
{
...
int func_267(int iParam0)//Position - 0x1079D
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_268(int iParam0)//Position - 0x107C8
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_269(int iParam0)//Position - 0x107F3
{
	if (func_252(iParam0))
	{
		return 0;
...
int func_270(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x10828
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_271((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_271((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
	...
	func_289("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}

int func_271(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0x1088D
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_272(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_272(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x10905
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_273(int iParam0, bool bParam1)//Position - 0x10980
{
	func_286();
	if (bParam1)
	{
		func_289("SCRIPT TERMINATING: Cleaning up entities in Launcher");
	...
	if (iLocal_227 != -1)
	{
		func_289("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_218(&iLocal_227);
	}
	if (iLocal_55)
	{
...
void func_274(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10A54
{
...
void func_275(var uParam0, bool bParam1)//Position - 0x10A74
{
	func_276(&(uParam0->f_41), bParam1);
}

void func_276(var uParam0, bool bParam1)//Position - 0x10A86
{
	int iVar0;
...
void func_277(int* iParam0, bool bParam1)//Position - 0x10AC4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_278(var uParam0, bool bParam1)//Position - 0x10AFF
{
	func_279(&(uParam0->f_35), bParam1);
}

void func_279(var uParam0, bool bParam1)//Position - 0x10B11
{
	int iVar0;
...
void func_280(int* iParam0)//Position - 0x10B4E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_281(int* iParam0)//Position - 0x10B86
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_282(var uParam0, int iParam1)//Position - 0x10C22
{
	func_283(&(uParam0->f_28), iParam1);
}

void func_283(var uParam0, int iParam1)//Position - 0x10C34
{
	int iVar0;
...
void func_284(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10C75
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_285(int* iParam0)//Position - 0x10CC5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_286()//Position - 0x10D06
{
	Global_20591 = 0;
	func_287();
}

void func_287()//Position - 0x10D16
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_288(var uParam0)//Position - 0x10D37
{
	if (*uParam0 == -1)
	{
		return;
...
void func_289(char* sParam0)//Position - 0x10D74
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_290(var uParam0)//Position - 0x10D86
{
	*uParam0 = -1;
