...
void __EntryFunction__()//Position - 0x0
{
	...
	iVar61[1] = 59;
	iVar61[2] = 62;
	if (!func_270(&iVar61, &Var0, Local_92, 1f))
	{
	...
	while (true)
	{
		...
		func_219(Var0.f_0);
		func_211(&iLocal_269, &(Var0.f_9), Local_92);
		func_189(&Var0);
		if (func_174(&Var0, 0))
		{
			if (!func_2(&Var0))
...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5D0D
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x64D0
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6997
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_84(struct<3> Param0, float fParam3)//Position - 0x7654
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
		...
		if (fVar0 < (20f * 20f) && iLocal_98)
		{
			switch (iLocal_99)
			{
				case 0:
					if (!func_151())
					{
						func_210(&uLocal_100, 3, uParam0->f_28[0], "TONYA", 0, 1);
						if (*uParam0 == 58)
						{
							func_209(&uLocal_100, "TOWAUD", "TONYA_BECK_1", 4, 0, 0, 0);
						...
						{
							func_197(&uLocal_100, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_1", 4, 0, 0);
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
							{
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_96);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_96);
						...
						{
							func_197(&uLocal_100, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_1", 4, 0, 0);
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
							{
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_96);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_96);
				...
				case 2:
					if (func_196(&iLocal_265))
					{
						if (func_190(&iLocal_265) > MISC::GET_RANDOM_FLOAT_IN_RANGE(9f, 15f))
						{
							iLocal_268++;
							switch (iLocal_268)
							{
								case 1:
									if (*uParam0 == 58)
									{
										func_209(&uLocal_100, "TOWAUD", "TONYA_BECK_2", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_96);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_96);
									...
									{
										func_197(&uLocal_100, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_2", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_96);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_96);
									...
									{
										func_197(&uLocal_100, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_2", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_96);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_96);
								...
								case 2:
									if (*uParam0 == 58)
									{
										func_209(&uLocal_100, "TOWAUD", "TONYA_BECK_3", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_96);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_96);
									...
									{
										func_197(&uLocal_100, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_3", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_96);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_96);
									...
									{
										func_197(&uLocal_100, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_3", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_96);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_96);
								...
								case 3:
									if (*uParam0 == 58)
									{
										func_209(&uLocal_100, "TOWAUD", "TONYA_BECK_4", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_96);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_96);
									...
									{
										func_197(&uLocal_100, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_4", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_96);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_96);
									...
									{
										func_197(&uLocal_100, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_4", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_96);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_96);
								...
								case 4:
									if (*uParam0 == 58)
									{
										func_209(&uLocal_100, "TOWAUD", "TONYA_BECK_5", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_96);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_96);
									...
									{
										func_197(&uLocal_100, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_5", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_96);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_96);
									...
									{
										func_197(&uLocal_100, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_5", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_96);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_96);
...
float func_215(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xE5A8
{
	struct<3> Var0;
...
int func_235(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xF716
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_239(struct<3> Param0, struct<3> Param3)//Position - 0xF9E2
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_247(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xFD60
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_270(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10828
{
	int iVar0;
...
int func_271(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x1088D
{
	int iVar0;
	struct<7> Var1;
...
int func_272(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10905
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
