...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113457[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_294(&(Global_113457[Var0.f_0 /*10*/].f_9));
			}
		}
		func_279(&Var0, 1);
	}
	...
	iVar61[1] = 59;
	iVar61[2] = 62;
	if (!func_276(&iVar61, &Var0, Local_90, 1f))
	{
	...
	MISC::CLEAR_AREA(Local_90, 5f, true, false, false, false);
	while (true)
	{
		SYSTEM::WAIT(0);
		if (!func_226(&Var0, 1) || func_267(Var0.f_0))
		{
			func_279(&Var0, 1);
		}
		if (func_266(43))
		...
		func_225(Var0.f_0);
		func_217(&iLocal_267, &(Var0.f_9), Local_90);
		func_195(&Var0);
		if (func_180(&Var0, 0))
		{
			if (!func_2(&Var0))
...
int func_1(int iParam0)//Position - 0x2C2
{
...
int func_2(int iParam0)//Position - 0x2E0
{
	struct<4> Var0;
	char* sVar32;
...
void func_3(int iParam0, char* sParam1)//Position - 0x3A3
{
	func_21(sParam1);
...
void func_17(int iParam0)//Position - 0xC63
{
...
void func_21(char* sParam0)//Position - 0xD1C
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xD2F
{
	MISC::CLEAR_BIT(&(Global_101392.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xD4C
{
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2958
{
...
int func_29(int iParam0)//Position - 0x2998
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x29C6
{
...
int func_31(int iParam0)//Position - 0x2AA2
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2AE4
{
	int iVar0;
...
int func_33(int iParam0, bool bParam1, int iParam2)//Position - 0x2B47
{
	int iVar0;
...
int func_34(bool bParam0, int iParam1)//Position - 0x2BD5
{
	struct<82> Var0;
...
void func_35(bool bParam0, var uParam1, int iParam2)//Position - 0x2C17
{
	int iVar0;
...
bool func_36(bool bParam0)//Position - 0x2E73
{
	return bParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E7F
{
	int iVar0;
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x31DA
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x33CD
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x349E
{
	char* sVar0;
...
int func_43(int iParam0, bool bParam1, bool bParam2)//Position - 0x35CD
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x363B
{
...
int func_45(int iParam0)//Position - 0x3714
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x3751
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x3776
{
...
int func_50(int iParam0, var uParam1)//Position - 0x394E
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(uParam1));
}

int func_51(var uParam0)//Position - 0x3963
{
	int iVar0;
	int iVar1;
...
int func_53(int iParam0, int iParam1)//Position - 0x39A3
{
	int iVar0;
	var uVar1;
...
int func_54(int iParam0, var uParam1)//Position - 0x39C7
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(uParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39DC
{
	int iVar0;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F25
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x4606
{
	switch (iParam0)
	{
...
int func_63(int iParam0)//Position - 0x46A7
{
...
int func_64(int iParam0, int iParam1)//Position - 0x4893
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x55B4
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x55EF
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x5863
{
	bool bVar0;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5DEE
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x65B1
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x65F8
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x6663
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6A76
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A86
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_80()//Position - 0x7293
{
...
int func_81()//Position - 0x758E
{
	return Global_2652572.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x759D
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x75C7
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x75DC
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x75F3
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x764B
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x76F5
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x778A
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x77CE
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x7952
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x7960
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x842B
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x84AD
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x8505
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x850E
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x877A
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x878A
{
	return MISC::GET_BITS_IN_RANGE(Global_2657921[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x87A7
{
	return func_74(iParam0, 0, 0);
}

int func_99(int iParam0)//Position - 0x87B7
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x8AED
{
	return Global_101444.f_393 > 0;
}

var func_101()//Position - 0x8AFE
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8B44
{
	if (iParam1 <= 0)
	{
		return;
...
void func_103(var uParam0, int iParam1)//Position - 0x8BCA
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8BFD
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8C4E
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8CF0
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8D12
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8D29
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8D36
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8D70
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8DAB
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8DE7
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8E00
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8E59
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8E6F
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8E85
{
...
int func_117(bool bParam0)//Position - 0x8EC7
{
...
struct<2> func_118(int iParam0)//Position - 0x8EEF
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x933C
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA614
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0)//Position - 0xA95A
{
	int iVar0;
...
void func_123(int iParam0)//Position - 0xA9FF
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xAA9A
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xAAF8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xAB51
{
...
int func_128(int iParam0)//Position - 0xABD4
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAC05
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAC1A
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xACCD
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xACE8
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xAD34
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xAD7D
{
	if (func_136(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xAD9D
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_137(int iParam0)//Position - 0xADBE
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xAE8E
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xAEE1
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xAFD6
{
	switch (iParam0)
	{
		case 5:
...
void func_142(bool bParam0)//Position - 0xB041
{
	int iVar0;
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB080
{
	if (bParam0)
	{
...
bool func_144()//Position - 0xB1CD
{
	return BitTest(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

bool func_145(int iParam0, int iParam1)//Position - 0xB1E7
{
	bool bVar0;
...
int func_146(int iParam0, bool bParam1)//Position - 0xB240
{
	int iVar0;
	int iVar1;
...
int func_147(var uParam0)//Position - 0xB281
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB2A3
{
...
bool func_149()//Position - 0xB2E2
{
	return BitTest(Global_2621446, 3);
}

int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB2F0
{
	int iVar0;
...
void func_152(int iParam0)//Position - 0xB34A
{
	if (iParam0 == 1)
	{
...
int func_153(char* sParam0)//Position - 0xB36D
{
...
void func_154()//Position - 0xB3AA
{
	Global_21032 = 0;
	func_155();
}

void func_155()//Position - 0xB3BA
{
...
int func_159(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB4A0
{
...
void func_160(int iParam0)//Position - 0xB4F7
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_161(bool bParam0, bool bParam1)//Position - 0xB523
{
...
void func_163(int iParam0)//Position - 0xB6C5
{
	if (func_168())
	{
		return;
...
void func_164(int iParam0)//Position - 0xB6F8
{
	if (func_168())
	{
		return;
...
void func_165(bool bParam0, bool bParam1)//Position - 0xB782
{
	if (bParam0)
	{
		if (func_167(0))
...
bool func_166()//Position - 0xB7F6
{
	return BitTest(Global_1956030, 5);
}

int func_167(int iParam0)//Position - 0xB804
{
	if (iParam0 == 1)
	{
...
bool func_168()//Position - 0xB85B
{
	return BitTest(Global_1956030, 19);
}

int func_169(int iParam0)//Position - 0xB86A
{
...
int func_170(int iParam0)//Position - 0xB8AB
{
	int iVar0;
...
void func_171(int iParam0)//Position - 0xB8F0
{
...
int func_172(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB922
{
	int iVar0;
...
void func_173(var uParam0, int iParam1)//Position - 0xBA59
{
	int iVar0;
...
bool func_174(int iParam0)//Position - 0xBAA8
{
	return func_175(iParam0, Global_43922);
}

int func_175(int iParam0, int iParam1)//Position - 0xBAB9
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_176(int iParam0)//Position - 0xBC9A
{
	if (Global_43922 == 15)
	{
		return 0;
...
int func_177()//Position - 0xBCBC
{
	return func_178(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_178(char* sParam0, int iParam1)//Position - 0xBCCD
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_180(var uParam0, int iParam1)//Position - 0xBD3A
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_181()//Position - 0xC51F
{
	func_27(&(Global_104933.f_2890), &Global_104933, 0, 1, 1, 0);
}

int func_182(var uParam0)//Position - 0xC53A
{
	float fVar0;
...
void func_183(int iParam0, int iParam1)//Position - 0xC5C8
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_184(bool bParam0)//Position - 0xC62C
{
	int iVar0;
...
int func_185(int iParam0)//Position - 0xC6C3
{
	if (func_136(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_186(int iParam0)//Position - 0xC6ED
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_194()) || Global_32831) || func_193()) || func_192(8, -1)) || func_190()) || func_100()) || func_191()) || func_189()) || Global_114370.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_194()) || Global_113417) || Global_32831) || func_193()) || func_192(8, -1)) || func_190()) || func_100()) || func_191()) || func_189()) || Global_114370.f_7691.f_919[bVar0] == 5) || Global_44469 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_194()) || Global_113417) || Global_32831) || func_193()) || func_192(8, -1)) || func_100()) || func_191()) || func_189()) || Global_114370.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_194() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_192(8, -1)) || func_189()) || func_188()) || Global_114370.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_187()//Position - 0xCE0A
{
	return Global_101431.f_1;
}

int func_188()//Position - 0xCE18
{
	if (Global_98294 != -1)
	{
...
bool func_191()//Position - 0xCE7F
{
	return Global_101444.f_394 > 0;
}

bool func_192(int iParam0, int iParam1)//Position - 0xCE90
{
	switch (iParam0)
	{
		case 5:
...
var func_193()//Position - 0xCEC8
{
	return Global_1575079;
}

int func_194()//Position - 0xCED4
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_195(var uParam0)//Position - 0xCEF0
{
	float fVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_90);
		if (fVar0 < (20f * 20f) && iLocal_96)
		{
			switch (iLocal_97)
			{
				case 0:
					if (!func_156())
					{
						func_216(&uLocal_98, 3, uParam0->f_28[0], "TONYA", 0, 1);
						if (*uParam0 == 58)
						{
							func_215(&uLocal_98, "TOWAUD", "TONYA_BECK_1", 4, 0, 0, 0);
				...
				case 2:
					if (func_202(&iLocal_263))
					{
						if (func_196(&iLocal_263) > MISC::GET_RANDOM_FLOAT_IN_RANGE(9f, 15f))
						{
							iLocal_266++;
							switch (iLocal_266)
							{
								case 1:
									if (*uParam0 == 58)
									{
										func_215(&uLocal_98, "TOWAUD", "TONYA_BECK_2", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
								...
								case 2:
									if (*uParam0 == 58)
									{
										func_215(&uLocal_98, "TOWAUD", "TONYA_BECK_3", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
								...
								case 3:
									if (*uParam0 == 58)
									{
										func_215(&uLocal_98, "TOWAUD", "TONYA_BECK_4", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
								...
								case 4:
									if (*uParam0 == 58)
									{
										func_215(&uLocal_98, "TOWAUD", "TONYA_BECK_5", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
...
float func_196(int* iParam0)//Position - 0xDCA1
{
	if (func_202(iParam0))
	{
		if (func_198(iParam0))
		...
		{
			return (func_197(BitTest(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}

float func_197(bool bParam0)//Position - 0xDCDD
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_198(int* iParam0)//Position - 0xDD35
{
	return BitTest(*iParam0, 2);
}

void func_199(int* iParam0)//Position - 0xDD42
{
	func_200(iParam0, 0f);
}

void func_200(int* iParam0, float fParam1)//Position - 0xDD51
{
	iParam0->f_1 = (func_197(BitTest(*iParam0, 4)) - fParam1);
	MISC::SET_BIT(iParam0, 1);
	MISC::CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}

void func_201(int* iParam0)//Position - 0xDD7C
{
	if (!func_202(iParam0))
	{
		func_199(iParam0);
...
bool func_202(int* iParam0)//Position - 0xDD94
{
	return BitTest(*iParam0, 1);
}

int func_203(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0xDDA1
{
	...
	Global_2883585 = 0;
	return func_204(sParam2, iParam4, 0);
}

int func_204(char* sParam0, int iParam1, bool bParam2)//Position - 0xDDF5
{
	Global_22167 = 0;
...
bool func_207(int iParam0)//Position - 0xE15D
{
	return func_208(iParam0, 20);
}

var func_208(int iParam0, int iParam1)//Position - 0xE16D
{
	return BitTest(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

void func_209()//Position - 0xE185
{
	int iVar0;
...
void func_214(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE3DF
{
...
int func_215(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE435
{
...
void func_216(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xE483
{
...
void func_217(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xE51E
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_221(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_220(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_221(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_223(iParam0);
				}
			}
...
void func_218(int iParam0, bool bParam1)//Position - 0xE60F
{
	if (iParam0 == -1)
	{
		return;
...
int func_219(int iParam0)//Position - 0xE64B
{
	if (Global_79244 == iParam0)
	{
		if (Global_79245 == -1)
...
void func_220(int iParam0, int iParam1)//Position - 0xE684
{
	bool bVar0;
	int iVar1;
...
float func_221(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xE722
{
	struct<3> Var0;
...
bool func_222()//Position - 0xE75C
{
	return Global_98681;
}

void func_223(int iParam0)//Position - 0xE768
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_224(iParam0);
...
void func_224(int iParam0)//Position - 0xE77F
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_225(int iParam0)//Position - 0xE867
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_226(int iParam0, bool bParam1)//Position - 0xE88F
{
	struct<27> Var0;
	...
	func_119(*iParam0, &Var0);
	if ((func_263(*iParam0) || func_261(*iParam0)) || Global_79494 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_227(int iParam0, var uParam1, int iParam2)//Position - 0xEAFF
{
	int iVar0;
	int iVar1;
	...
	if (func_136(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_229(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_228(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_229(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_228(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
int func_228(int iParam0)//Position - 0xEE57
{
...
int func_229(var uParam0)//Position - 0xEE77
{
...
int func_230(var uParam0)//Position - 0xEE8F
{
...
void func_231(var uParam0)//Position - 0xEEB4
{
	int iVar0;
	int iVar1;
...
void func_232(int* iParam0)//Position - 0xF1B8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_233(var uParam0)//Position - 0xF1E3
{
	int iVar0;
...
int func_234(var uParam0, bool bParam1, bool bParam2)//Position - 0xF263
{
	int iVar0;
	int iVar1;
	int iVar2;
				...
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						if (func_185(iVar2))
						{
							...
							{
								if (func_185(uParam0->f_35[iVar0]))
								{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_235(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_235(int iParam0, int iParam1)//Position - 0xF421
{
	int iVar0;
...
int func_236(var uParam0, bool bParam1, int iParam2)//Position - 0xF451
{
	int iVar0;
	int iVar1;
...
int func_237(int iParam0)//Position - 0xF70D
{
...
int func_238(int iParam0, float fParam1)//Position - 0xF741
{
	float fVar0;
	
	if (func_136(PLAYER::PLAYER_PED_ID()) && func_136(iParam0))
	{
		if (func_249(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_239(int iParam0, float fParam1)//Position - 0xF7B7
{
	return func_240(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_240(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF7CF
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	
	iVar4 = func_248(iParam0, iParam1);
	if (!func_136(iParam0) || !func_136(iParam1))
	{
		if (iVar4 != -1)
		{
			func_247(&(Local_35[iVar4 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_241(&(Local_35[iVar4 /*4*/]), Var1, iParam1, &(Local_35[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar4 /*4*/].f_3) < iParam4);
}

int func_241(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xF890
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_242(int iParam0, int iParam1)//Position - 0xF9BC
{
	int iVar0;
...
int func_244(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xFACB
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_246(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_246(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_245(Var3, Var0);
...
float func_245(struct<3> Param0, struct<3> Param3)//Position - 0xFB5C
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_246(struct<3> Param0)//Position - 0xFB7D
{
	float fVar0;
	float fVar1;
...
void func_247(var uParam0)//Position - 0xFBBC
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_248(int iParam0, int iParam1)//Position - 0xFBD7
{
	int iVar0;
...
int func_249(int iParam0)//Position - 0xFC16
{
...
int func_250(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xFC3E
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_251(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xFD39
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_252(int iParam0, float fParam1)//Position - 0xFE45
{
	var uVar0;
	struct<3> Var1;
...
int func_253(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xFEDA
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_246(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
int func_254(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xFF68
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_255(int iParam0)//Position - 0xFFB0
{
...
void func_256(int iParam0)//Position - 0xFFFA
{
	int iVar0;
...
int func_257(int iParam0)//Position - 0x10098
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_258(int iParam0)//Position - 0x1012D
{
...
int func_261(int iParam0)//Position - 0x101AC
{
...
int func_263(int iParam0)//Position - 0x1021E
{
	if (func_117(0))
	{
...
int func_264(int iParam0)//Position - 0x10246
{
	if (!func_265(iParam0))
	{
		return 0;
	}
	iLocal_93 = PED::ADD_SCENARIO_BLOCKING_AREA(Local_90 - Vector(10f, 10f, 10f), Local_90 + Vector(10f, 10f, 10f), false, true, true, true, 1);
	iLocal_95 = 1;
	func_295("Created initial scene");
	return 1;
}

int func_265(var uParam0)//Position - 0x1029B
{
	bool bVar0;
	int iVar1;
	...
	switch (iLocal_89)
	{
		...
		case 3:
			if (func_136(uParam0->f_28[0]) && PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				TASK::CLEAR_SEQUENCE_TASK(&iVar1);
				TASK::OPEN_SEQUENCE_TASK(&iVar1);
...
int func_266(int iParam0)//Position - 0x10551
{
	int iVar0;
...
int func_267(int iParam0)//Position - 0x105B9
{
	struct<27> Var0;
	bool bVar32;
...
int func_268(int iParam0)//Position - 0x1060A
{
	char* sVar0;
...
int func_269(int iParam0)//Position - 0x106C3
{
	var uVar0;
...
int func_270(int iParam0)//Position - 0x10784
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_271(int iParam0, char* sParam1)//Position - 0x10809
{
...
int func_272(int iParam0)//Position - 0x108EB
{
...
int func_273(int iParam0)//Position - 0x10916
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_274(int iParam0)//Position - 0x10941
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_275(int iParam0)//Position - 0x1096C
{
	if (func_258(iParam0))
	{
		return 0;
...
int func_276(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x109A1
{
	int iVar0;
...
int func_277(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10A06
{
	int iVar0;
	struct<7> Var1;
...
int func_278(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10A7E
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_279(int iParam0, bool bParam1)//Position - 0x10AF9
{
	func_292();
	if (bParam1)
	{
		func_295("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_280(iParam0, 0, 0, 0);
	}
...
void func_280(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10BCD
{
...
void func_281(var uParam0, bool bParam1)//Position - 0x10BED
{
	func_282(&(uParam0->f_41), bParam1);
}

void func_282(var uParam0, bool bParam1)//Position - 0x10BFF
{
	int iVar0;
...
void func_283(int* iParam0, bool bParam1)//Position - 0x10C3D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_284(var uParam0, bool bParam1)//Position - 0x10C78
{
	func_285(&(uParam0->f_35), bParam1);
}

void func_285(var uParam0, bool bParam1)//Position - 0x10C8A
{
	int iVar0;
...
void func_286(int* iParam0)//Position - 0x10CC7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_287(int* iParam0)//Position - 0x10CFF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_288(var uParam0, int iParam1)//Position - 0x10D9B
{
	func_289(&(uParam0->f_28), iParam1);
}

void func_289(var uParam0, int iParam1)//Position - 0x10DAD
{
	int iVar0;
...
void func_290(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10DEE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_291(int* iParam0)//Position - 0x10E3E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_292()//Position - 0x10E7F
{
	Global_21032 = 0;
	func_293();
}

void func_293()//Position - 0x10E8F
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_294(var uParam0)//Position - 0x10EB0
{
	if (*uParam0 == -1)
	{
		return;
...
void func_295(char* sParam0)//Position - 0x10EED
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_296(var uParam0)//Position - 0x10EFF
{
	*uParam0 = -1;
