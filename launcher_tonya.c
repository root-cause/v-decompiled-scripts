...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113222[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_295(&(Global_113222[Var0.f_0 /*10*/].f_9));
			}
		}
		func_280(&Var0, 1);
	}
	...
	iVar61[1] = 59;
	iVar61[2] = 62;
	if (!func_277(&iVar61, &Var0, Local_90, 1f))
	{
	...
	while (true)
	{
		...
		func_226(Var0.f_0);
		func_218(&iLocal_267, &(Var0.f_9), Local_90);
		func_196(&Var0);
		if (func_181(&Var0, 0))
		{
			if (!func_2(&Var0))
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5E5A
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x661D
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x6664
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x66CF
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6AF1
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6B01
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x7627
{
...
Vector3 func_84(struct<3> Param0)//Position - 0x7669
{
...
int func_86(int iParam0)//Position - 0x7695
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7797
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x782C
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_93(int iParam0, var uParam1)//Position - 0x84CA
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0)//Position - 0x854C
{
	if (iParam0 != func_95())
	{
...
int func_99(int iParam0)//Position - 0x8861
{
...
var func_107(int iParam0)//Position - 0x8DB7
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8DD9
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8DF0
{
	return uParam0 & 15;
}
...
void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x8F56
{
...
int func_118(bool bParam0)//Position - 0x8F98
{
...
int func_123(int iParam0)//Position - 0xAA2B
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAD9E
{
...
int func_136(int iParam0)//Position - 0xAE4E
{
	if (func_137(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xAE6E
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_138(int iParam0)//Position - 0xAE8F
{
	switch (iParam0)
	{
		case 5:
...
int func_140(int iParam0)//Position - 0xAF5F
{
	switch (iParam0)
	{
		case 5:
...
void func_141(var uParam0, bool bParam1, bool bParam2)//Position - 0xAFB2
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0xB0A8
{
	switch (iParam0)
	{
		case 5:
...
void func_144(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB152
{
	if (bParam0)
	{
...
int func_148(var uParam0)//Position - 0xB355
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xB377
{
...
int func_151(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB3C4
{
	int iVar0;
...
int func_154(char* sParam0)//Position - 0xB441
{
...
int func_160(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB574
{
...
void func_161(int iParam0)//Position - 0xB5CB
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_168(int iParam0)//Position - 0xB8D8
{
	if (iParam0 == 1)
	{
...
int func_170(int iParam0)//Position - 0xB93E
{
...
int func_171(int iParam0)//Position - 0xB97F
{
	int iVar0;
...
int func_173(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB9F6
{
	int iVar0;
...
void func_174(var uParam0, int iParam1)//Position - 0xBB2D
{
	int iVar0;
...
bool func_175(int iParam0)//Position - 0xBB7C
{
	return func_176(iParam0, Global_44181);
}

int func_176(int iParam0, int iParam1)//Position - 0xBB8D
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_177(int iParam0)//Position - 0xBD6E
{
	if (Global_44181 == 15)
	{
		return 0;
...
int func_179(char* sParam0, int iParam1)//Position - 0xBDA1
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_181(var uParam0, int iParam1)//Position - 0xBE0E
{
	switch (uParam0->f_16)
	{
		case 0:
...
int func_183(var uParam0)//Position - 0xC60D
{
	float fVar0;
...
void func_184(int iParam0, int iParam1)//Position - 0xC69B
{
	if (iParam0 == 1)
	{
		if (!func_140(iParam1))
...
int func_185(bool bParam0)//Position - 0xC6FF
{
	int iVar0;
...
int func_186(int iParam0)//Position - 0xC796
{
	if (func_137(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_187(int iParam0)//Position - 0xC7C0
{
	bool bVar0;
...
var func_188()//Position - 0xCEDD
{
	return Global_101727.f_1;
}

int func_189()//Position - 0xCEEB
{
	if (Global_98585 != -1)
	{
...
var func_194()//Position - 0xCF9B
{
	return Global_1575084;
}

int func_195()//Position - 0xCFA7
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		if (fVar0 < (20f * 20f) && iLocal_96)
		{
			switch (iLocal_97)
			{
				case 0:
					if (!func_157())
					{
						func_217(&uLocal_98, 3, uParam0->f_28[0], "TONYA", 0, 1);
						if (*uParam0 == 58)
						{
							func_216(&uLocal_98, "TOWAUD", "TONYA_BECK_1", 4, 0, 0, 0);
				...
				case 2:
					if (func_203(&iLocal_263))
					{
						if (func_197(&iLocal_263) > MISC::GET_RANDOM_FLOAT_IN_RANGE(9f, 15f))
						{
							iLocal_266++;
							switch (iLocal_266)
							{
								case 1:
									if (*uParam0 == 58)
									{
										func_216(&uLocal_98, "TOWAUD", "TONYA_BECK_2", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
								...
								case 2:
									if (*uParam0 == 58)
									{
										func_216(&uLocal_98, "TOWAUD", "TONYA_BECK_3", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
								...
								case 3:
									if (*uParam0 == 58)
									{
										func_216(&uLocal_98, "TOWAUD", "TONYA_BECK_4", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
								...
								case 4:
									if (*uParam0 == 58)
									{
										func_216(&uLocal_98, "TOWAUD", "TONYA_BECK_5", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
...
float func_197(int* iParam0)//Position - 0xDD74
{
	if (func_203(iParam0))
	{
		if (func_199(iParam0))
		...
		{
			return (func_198(BitTest(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
bool func_199(int* iParam0)//Position - 0xDE08
{
	return BitTest(*iParam0, 2);
}

void func_200(int* iParam0)//Position - 0xDE15
{
	func_201(iParam0, 0f);
}

void func_201(int* iParam0, float fParam1)//Position - 0xDE24
{
	iParam0->f_1 = (func_198(BitTest(*iParam0, 4)) - fParam1);
	MISC::SET_BIT(iParam0, 1);
	MISC::CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}

void func_202(int* iParam0)//Position - 0xDE4F
{
	if (!func_203(iParam0))
	{
		func_200(iParam0);
...
bool func_203(int* iParam0)//Position - 0xDE67
{
...
var func_209(int iParam0, int iParam1)//Position - 0xE240
{
...
int func_216(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE508
{
...
void func_217(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xE556
{
...
void func_218(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xE5F1
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_221(int iParam0, int iParam1)//Position - 0xE757
{
	bool bVar0;
	int iVar1;
...
float func_222(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xE7F5
{
	struct<3> Var0;
...
void func_224(int iParam0)//Position - 0xE83B
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_225(iParam0);
...
void func_225(int iParam0)//Position - 0xE852
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_227(int iParam0, bool bParam1)//Position - 0xE962
{
	struct<27> Var0;
	...
	func_120(*iParam0, &Var0);
	if ((func_264(*iParam0) || func_262(*iParam0)) || Global_79785 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_228(int iParam0, var uParam1, int iParam2)//Position - 0xEBD2
{
	...
	if (func_137(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_230(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_229(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_230(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_229(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
int func_229(int iParam0)//Position - 0xEF2A
{
...
int func_230(var uParam0)//Position - 0xEF4A
{
...
int func_231(var uParam0)//Position - 0xEF62
{
...
void func_233(int* iParam0)//Position - 0xF28B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_235(var uParam0, bool bParam1, bool bParam2)//Position - 0xF336
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_236(int iParam0, int iParam1)//Position - 0xF4F4
{
	int iVar0;
...
int func_237(var uParam0, bool bParam1, int iParam2)//Position - 0xF524
{
	int iVar0;
	int iVar1;
...
int func_238(int iParam0)//Position - 0xF7E0
{
...
int func_239(int iParam0, float fParam1)//Position - 0xF814
{
	float fVar0;
...
bool func_240(int iParam0, float fParam1)//Position - 0xF88A
{
	return func_241(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_241(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF8A2
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_242(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xF963
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_243(int iParam0, int iParam1)//Position - 0xFA8F
{
	int iVar0;
...
int func_245(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xFB9E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_246(struct<3> Param0, struct<3> Param3)//Position - 0xFC2F
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_247(struct<3> Param0)//Position - 0xFC50
{
	float fVar0;
	float fVar1;
...
int func_249(int iParam0, int iParam1)//Position - 0xFCAA
{
	int iVar0;
...
int func_250(int iParam0)//Position - 0xFCE9
{
...
int func_251(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xFD11
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_252(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xFE0C
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_253(int iParam0, float fParam1)//Position - 0xFF18
{
	var uVar0;
	struct<3> Var1;
...
int func_254(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xFFAD
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_255(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x1003D
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_256(int iParam0)//Position - 0x10085
{
...
void func_257(int iParam0)//Position - 0x100CF
{
	int iVar0;
...
int func_258(int iParam0)//Position - 0x1016C
{
	if (iParam0 == -1)
	{
		iParam0 = func_178();
...
int func_259(int iParam0)//Position - 0x10201
{
...
int func_262(int iParam0)//Position - 0x10280
{
...
int func_264(int iParam0)//Position - 0x102F2
{
	if (func_118(0))
	{
...
int func_265(int iParam0)//Position - 0x1031A
{
	if (!func_266(iParam0))
	{
		return 0;
...
int func_266(var uParam0)//Position - 0x1036F
{
	bool bVar0;
	int iVar1;
	...
	switch (iLocal_89)
	{
		...
		case 3:
			if (func_137(uParam0->f_28[0]) && PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				TASK::CLEAR_SEQUENCE_TASK(&iVar1);
				TASK::OPEN_SEQUENCE_TASK(&iVar1);
...
int func_267(int iParam0)//Position - 0x10625
{
	int iVar0;
...
int func_268(int iParam0)//Position - 0x1068D
{
	struct<27> Var0;
	bool bVar32;
...
int func_269(int iParam0)//Position - 0x106DE
{
	char* sVar0;
...
int func_270(int iParam0)//Position - 0x10797
{
	var uVar0;
...
int func_271(int iParam0)//Position - 0x10858
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_273(int iParam0)//Position - 0x109BF
{
...
int func_274(int iParam0)//Position - 0x109EA
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_275(int iParam0)//Position - 0x10A15
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_276(int iParam0)//Position - 0x10A40
{
	if (func_259(iParam0))
	{
		return 0;
...
int func_277(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10A75
{
	int iVar0;
...
int func_278(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10ADA
{
	int iVar0;
	struct<7> Var1;
...
int func_279(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10B52
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_280(int iParam0, bool bParam1)//Position - 0x10BCD
{
	func_293();
	if (bParam1)
	{
...
void func_284(int* iParam0, bool bParam1)//Position - 0x10D11
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_287(int* iParam0)//Position - 0x10D9B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_288(int* iParam0)//Position - 0x10DD3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_291(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10EC2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_292(int* iParam0)//Position - 0x10F12
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_295(var uParam0)//Position - 0x10F84
{
	if (*uParam0 == -1)
	{
		return;
