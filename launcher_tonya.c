...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112897[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_293(&(Global_112897[Var0.f_0 /*10*/].f_9));
			}
		}
		func_278(&Var0, 1);
	}
	...
	iVar61[1] = 59;
	iVar61[2] = 62;
	if (!func_275(&iVar61, &Var0, Local_90, 1f))
	{
	...
	if (func_265(43))
	{
		func_294("SP_MISSION_LAMAR is available... [TERMINATING]");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	else if (func_265(47))
	{
		func_294("SP_MISSION_MICHAEL_2 is available... [TERMINATING]");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	else if (func_265(40))
	{
		func_294("SP_MISSION_FRANKLIN_0 is available... [TERMINATING]");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	else if (func_265(41))
	{
		func_294("SP_MISSION_FRANKLIN_1 is available... [TERMINATING]");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	while (!func_263(&Var0))
	{
	...
	{
		SYSTEM::WAIT(0);
		if (!func_225(&Var0, 1) || func_266(Var0.f_0))
		{
			func_278(&Var0, 1);
		}
		if (func_265(43))
		{
			func_294("SP_MISSION_LAMAR became available... [TERMINATING]");
			func_278(&Var0, 1);
		}
		else if (func_265(47))
		{
			func_294("SP_MISSION_MICHAEL_2 became available... [TERMINATING]");
			func_278(&Var0, 1);
		}
		else if (func_265(40))
		{
			func_294("SP_MISSION_FRANKLIN_0 became available... [TERMINATING]");
			func_278(&Var0, 1);
		}
		else if (func_265(41))
		{
			func_294("SP_MISSION_FRANKLIN_1 became available... [TERMINATING]");
			func_278(&Var0, 1);
		}
		func_224(Var0.f_0);
		func_216(&iLocal_267, &(Var0.f_9), Local_90);
		func_194(&Var0);
		if (func_179(&Var0, 0))
		{
			if (!func_2(&Var0))
...
int func_64(int iParam0, int iParam1)//Position - 0x4887
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x5538
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x5573
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x57E7
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x5823
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5D72
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5DB6
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6535
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x657C
{
...
bool func_73(int iParam0)//Position - 0x65D7
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x65E7
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x6647
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x69EF
{
	return Global_32283;
}

int func_77(int iParam0)//Position - 0x69FA
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A0A
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6AAC
{
	switch (iParam0)
	{
		case -1:
...
int func_82(struct<3> Param0)//Position - 0x7521
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x754B
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x7560
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x7577
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x75CF
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7679
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x770E
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x7752
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x78D6
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x78E4
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x83AD
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x842F
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x8487
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x8490
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x86FC
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x870C
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x8729
{
	return func_74(iParam0, 0, 0);
}

int func_99(int iParam0)//Position - 0x8739
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x8A6F
{
	return Global_100885.f_393 > 0;
}

var func_101()//Position - 0x8A80
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8AC6
{
	if (iParam1 <= 0)
	{
		return;
...
void func_104(var uParam0, int iParam1)//Position - 0x8B7F
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8BD0
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8C72
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8C94
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8CAB
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8CB8
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8CF2
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8D2D
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8D69
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8D82
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8DDB
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8DF1
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8E07
{
...
int func_117(bool bParam0)//Position - 0x8E49
{
...
struct<2> func_118(int iParam0)//Position - 0x8E71
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x92BE
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA596
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0)//Position - 0xA8DC
{
	int iVar0;
...
void func_123(int iParam0)//Position - 0xA981
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xAA1C
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xAA7A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xAAD3
{
...
int func_128(int iParam0)//Position - 0xAB56
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAB87
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAB9C
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xAC4F
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAC6A
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xACB6
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xACFF
{
	if (func_136(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xAD1F
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_137(int iParam0)//Position - 0xAD40
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xAE10
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xAE63
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xAF58
{
	switch (iParam0)
	{
		case 5:
...
void func_142(bool bParam0)//Position - 0xAFC3
{
	int iVar0;
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB002
{
	if (bParam0)
	{
...
bool func_144()//Position - 0xB14F
{
	return BitTest(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_36.f_18, 14);
}

bool func_145(int iParam0, int iParam1)//Position - 0xB169
{
	bool bVar0;
...
int func_146(int iParam0, bool bParam1)//Position - 0xB1C2
{
	int iVar0;
	int iVar1;
...
int func_147(var uParam0)//Position - 0xB203
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB225
{
...
bool func_149()//Position - 0xB264
{
	return BitTest(Global_2621446, 3);
}

int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB272
{
	int iVar0;
...
void func_152(int iParam0)//Position - 0xB2CC
{
	if (iParam0 == 1)
	{
...
int func_153(char* sParam0)//Position - 0xB2EF
{
...
void func_154()//Position - 0xB32C
{
	Global_20711 = 0;
	func_155();
}

void func_155()//Position - 0xB33C
{
...
int func_159(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB422
{
...
void func_160(int iParam0)//Position - 0xB5BA
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_162(int iParam0)//Position - 0xB637
{
	if (func_167())
	{
		return;
...
void func_163(int iParam0)//Position - 0xB66A
{
	if (func_167())
	{
		return;
...
void func_164(bool bParam0, bool bParam1)//Position - 0xB6F4
{
	if (bParam0)
	{
		if (func_166(0))
...
bool func_165()//Position - 0xB768
{
	return BitTest(Global_1963795, 5);
}

int func_166(int iParam0)//Position - 0xB776
{
	if (iParam0 == 1)
	{
...
bool func_167()//Position - 0xB7CD
{
	return BitTest(Global_1963795, 19);
}

int func_168(int iParam0)//Position - 0xB7DC
{
...
int func_169(int iParam0)//Position - 0xB81D
{
	int iVar0;
...
void func_170(int iParam0)//Position - 0xB862
{
...
int func_171(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB894
{
	int iVar0;
...
void func_172(var uParam0, int iParam1)//Position - 0xB9CB
{
	int iVar0;
...
bool func_173(int iParam0)//Position - 0xBA1A
{
	return func_174(iParam0, Global_43377);
}

int func_174(int iParam0, int iParam1)//Position - 0xBA2B
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_175(int iParam0)//Position - 0xBC0C
{
	if (Global_43377 == 15)
	{
		return 0;
...
int func_176()//Position - 0xBC2E
{
	return func_177(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_177(char* sParam0, int iParam1)//Position - 0xBC3F
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_179(var uParam0, int iParam1)//Position - 0xBCAC
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_180()//Position - 0xC491
{
	func_27(&(Global_104373.f_2890), &Global_104373, 0, 1, 1, 0);
}

int func_181(var uParam0)//Position - 0xC4AC
{
	float fVar0;
...
void func_182(int iParam0, int iParam1)//Position - 0xC53A
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_183(bool bParam0)//Position - 0xC59E
{
	int iVar0;
...
int func_184(int iParam0)//Position - 0xC635
{
	if (func_136(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_185(int iParam0)//Position - 0xC65F
{
	bool bVar0;
...
var func_186()//Position - 0xCD7C
{
	return Global_100872.f_1;
}

int func_187()//Position - 0xCD8A
{
	if (Global_97735 != -1)
	{
...
bool func_190()//Position - 0xCDF1
{
	return Global_100885.f_394 > 0;
}

bool func_191(int iParam0, int iParam1)//Position - 0xCE02
{
	switch (iParam0)
	{
		case 5:
...
var func_192()//Position - 0xCE3A
{
	return Global_1575063;
}

int func_193()//Position - 0xCE46
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_194(var uParam0)//Position - 0xCE62
{
	float fVar0;
	
	if (func_188() || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		AUDIO::STOP_SCRIPTED_CONVERSATION(false);
		return;
	}
		...
		if (fVar0 < (20f * 20f) && iLocal_96)
		{
			switch (iLocal_97)
			{
				case 0:
					if (!func_156())
					{
						func_215(&uLocal_98, 3, uParam0->f_28[0], "TONYA", 0, 1);
						if (*uParam0 == 58)
						{
							func_214(&uLocal_98, "TOWAUD", "TONYA_BECK_1", 4, 0, 0, 0);
						...
						{
							func_202(&uLocal_98, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_1", 4, 0, 0);
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
							{
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
						...
						{
							func_202(&uLocal_98, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_1", 4, 0, 0);
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
							{
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
				...
				case 2:
					if (func_201(&iLocal_263))
					{
						if (func_195(&iLocal_263) > MISC::GET_RANDOM_FLOAT_IN_RANGE(9f, 15f))
						{
							iLocal_266++;
							switch (iLocal_266)
							{
								case 1:
									if (*uParam0 == 58)
									{
										func_214(&uLocal_98, "TOWAUD", "TONYA_BECK_2", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
									...
									{
										func_202(&uLocal_98, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_2", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
									...
									{
										func_202(&uLocal_98, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_2", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
								...
								case 2:
									if (*uParam0 == 58)
									{
										func_214(&uLocal_98, "TOWAUD", "TONYA_BECK_3", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
									...
									{
										func_202(&uLocal_98, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_3", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
									...
									{
										func_202(&uLocal_98, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_3", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
								...
								case 3:
									if (*uParam0 == 58)
									{
										func_214(&uLocal_98, "TOWAUD", "TONYA_BECK_4", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
									...
									{
										func_202(&uLocal_98, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_4", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
									...
									{
										func_202(&uLocal_98, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_4", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
								...
								case 4:
									if (*uParam0 == 58)
									{
										func_214(&uLocal_98, "TOWAUD", "TONYA_BECK_5", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
									...
									{
										func_202(&uLocal_98, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_5", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
									...
									{
										func_202(&uLocal_98, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_5", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_94);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_94);
...
float func_195(int* iParam0)//Position - 0xDC13
{
	if (func_201(iParam0))
	{
		if (func_197(iParam0))
		...
		{
			return (func_196(BitTest(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}

float func_196(bool bParam0)//Position - 0xDC4F
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_197(int* iParam0)//Position - 0xDCA7
{
	return BitTest(*iParam0, 2);
}

void func_198(int* iParam0)//Position - 0xDCB4
{
	func_199(iParam0, 0f);
}

void func_199(int* iParam0, float fParam1)//Position - 0xDCC3
{
	iParam0->f_1 = (func_196(BitTest(*iParam0, 4)) - fParam1);
	MISC::SET_BIT(iParam0, 1);
	MISC::CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}

void func_200(int* iParam0)//Position - 0xDCEE
{
	if (!func_201(iParam0))
	{
		func_198(iParam0);
...
bool func_201(int* iParam0)//Position - 0xDD06
{
	return BitTest(*iParam0, 1);
}

int func_202(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0xDD13
{
	func_213(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
		if (iParam4 < 12)
		{
	...
	Global_2883585 = 0;
	return func_203(sParam2, iParam4, 0);
}

int func_203(char* sParam0, int iParam1, bool bParam2)//Position - 0xDD67
{
	Global_21846 = 0;
...
bool func_206(int iParam0)//Position - 0xE0CF
{
	return func_207(iParam0, 20);
}

var func_207(int iParam0, int iParam1)//Position - 0xE0DF
{
	return BitTest(Global_1895156[iParam0 /*609*/].f_10.f_4, iParam1);
}

void func_208()//Position - 0xE0F7
{
	int iVar0;
...
void func_213(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE351
{
...
int func_214(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE3A7
{
	...
	Global_22842 = 0;
	Global_2883585 = 0;
	return func_203(sParam2, iParam3, 0);
}

void func_215(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xE3F5
{
...
void func_216(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xE490
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_220(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_219(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_220(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_222(iParam0);
				}
			}
...
void func_217(int iParam0, bool bParam1)//Position - 0xE581
{
	if (iParam0 == -1)
	{
		return;
...
int func_218(int iParam0)//Position - 0xE5BD
{
	if (Global_78685 == iParam0)
	{
		if (Global_78686 == -1)
...
void func_219(int iParam0, int iParam1)//Position - 0xE5F6
{
	bool bVar0;
	int iVar1;
...
float func_220(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xE694
{
	struct<3> Var0;
...
bool func_221()//Position - 0xE6CE
{
	return Global_98122;
}

void func_222(int iParam0)//Position - 0xE6DA
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_223(iParam0);
...
void func_223(int iParam0)//Position - 0xE6F1
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_224(int iParam0)//Position - 0xE7D9
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
int func_225(int iParam0, bool bParam1)//Position - 0xE801
{
	struct<27> Var0;
	...
	func_119(*iParam0, &Var0);
	if ((func_262(*iParam0) || func_260(*iParam0)) || Global_78935 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_226(int iParam0, var uParam1, int iParam2)//Position - 0xEA71
{
	int iVar0;
	int iVar1;
...
int func_227(int iParam0)//Position - 0xEDC9
{
...
int func_228(var uParam0)//Position - 0xEDE9
{
...
int func_229(var uParam0)//Position - 0xEE01
{
...
void func_230(var uParam0)//Position - 0xEE26
{
	int iVar0;
	int iVar1;
...
void func_231(int* iParam0)//Position - 0xF12A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_232(var uParam0)//Position - 0xF155
{
	int iVar0;
...
int func_233(var uParam0, bool bParam1, bool bParam2)//Position - 0xF1D5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_234(int iParam0, int iParam1)//Position - 0xF393
{
	int iVar0;
...
int func_235(var uParam0, bool bParam1, int iParam2)//Position - 0xF3C3
{
	int iVar0;
	int iVar1;
...
int func_236(int iParam0)//Position - 0xF67F
{
...
int func_237(int iParam0, float fParam1)//Position - 0xF6B3
{
	float fVar0;
...
bool func_238(int iParam0, float fParam1)//Position - 0xF729
{
	return func_239(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_239(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF741
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_240(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xF802
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_241(int iParam0, int iParam1)//Position - 0xF92E
{
	int iVar0;
...
int func_243(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xFA3D
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_244(struct<3> Param0, struct<3> Param3)//Position - 0xFACE
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_245(struct<3> Param0)//Position - 0xFAEF
{
	float fVar0;
	float fVar1;
...
void func_246(var uParam0)//Position - 0xFB2E
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_247(int iParam0, int iParam1)//Position - 0xFB49
{
	int iVar0;
...
int func_248(int iParam0)//Position - 0xFB88
{
...
int func_249(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xFBB0
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_250(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xFCAB
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_251(int iParam0, float fParam1)//Position - 0xFDB7
{
	var uVar0;
	struct<3> Var1;
...
int func_252(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xFE4C
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_253(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xFEDA
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_254(int iParam0)//Position - 0xFF22
{
...
void func_255(int iParam0)//Position - 0xFF6C
{
	int iVar0;
...
int func_256(int iParam0)//Position - 0x1000D
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
int func_257(int iParam0)//Position - 0x100A2
{
...
int func_260(int iParam0)//Position - 0x10121
{
	if ((func_261() && Global_100833.f_11 == 6) && iParam0 == func_177(&(Global_100833.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_262(int iParam0)//Position - 0x10193
{
	if (func_117(0))
	{
...
int func_263(int iParam0)//Position - 0x101BB
{
	if (!func_264(iParam0))
	{
		return 0;
	}
	iLocal_93 = PED::ADD_SCENARIO_BLOCKING_AREA(Local_90 - Vector(10f, 10f, 10f), Local_90 + Vector(10f, 10f, 10f), false, true, true, true);
	iLocal_95 = 1;
	func_294("Created initial scene");
	return 1;
}

int func_264(var uParam0)//Position - 0x1020F
{
	bool bVar0;
	int iVar1;
...
int func_265(int iParam0)//Position - 0x104C5
{
	int iVar0;
...
int func_266(int iParam0)//Position - 0x1052D
{
	struct<27> Var0;
	bool bVar32;
...
int func_267(int iParam0)//Position - 0x1057E
{
	char* sVar0;
...
int func_268(int iParam0)//Position - 0x10637
{
	var uVar0;
...
int func_269(int iParam0)//Position - 0x106F8
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_270(int iParam0, char* sParam1)//Position - 0x1077D
{
...
int func_271(int iParam0)//Position - 0x1085F
{
...
int func_272(int iParam0)//Position - 0x1088A
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_273(int iParam0)//Position - 0x108B5
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_274(int iParam0)//Position - 0x108E0
{
	if (func_257(iParam0))
	{
		return 0;
...
int func_275(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10915
{
	int iVar0;
...
int func_276(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x1097A
{
	int iVar0;
	struct<7> Var1;
...
int func_277(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x109F2
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_278(int iParam0, bool bParam1)//Position - 0x10A6D
{
	func_291();
	if (bParam1)
	{
...
void func_279(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10B41
{
...
void func_280(var uParam0, bool bParam1)//Position - 0x10B61
{
	func_281(&(uParam0->f_41), bParam1);
}

void func_281(var uParam0, bool bParam1)//Position - 0x10B73
{
	int iVar0;
...
void func_282(int* iParam0, bool bParam1)//Position - 0x10BB1
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_283(var uParam0, bool bParam1)//Position - 0x10BEC
{
	func_284(&(uParam0->f_35), bParam1);
}

void func_284(var uParam0, bool bParam1)//Position - 0x10BFE
{
	int iVar0;
...
void func_285(int* iParam0)//Position - 0x10C3B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_286(int* iParam0)//Position - 0x10C73
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_287(var uParam0, int iParam1)//Position - 0x10D0F
{
	func_288(&(uParam0->f_28), iParam1);
}

void func_288(var uParam0, int iParam1)//Position - 0x10D21
{
	int iVar0;
...
void func_289(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10D62
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_290(int* iParam0)//Position - 0x10DB2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_291()//Position - 0x10DF3
{
	Global_20711 = 0;
	func_292();
}

void func_292()//Position - 0x10E03
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22856 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_293(var uParam0)//Position - 0x10E24
{
	if (*uParam0 == -1)
	{
		return;
...
void func_294(char* sParam0)//Position - 0x10E61
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_295(var uParam0)//Position - 0x10E73
{
	*uParam0 = -1;
