...
int func_64(int iParam0, int iParam1)//Position - 0x4899
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x55DA
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x5615
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x5889
{
	bool bVar0;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5E14
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x65D7
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x661E
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x6689
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6A9C
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6AAC
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x75B7
{
...
int func_83()//Position - 0x75E1
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

Vector3 func_84(struct<3> Param0)//Position - 0x75F9
{
...
int func_86(int iParam0)//Position - 0x7625
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7727
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x77BC
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_99(int iParam0)//Position - 0x87D8
{
...
bool func_115()//Position - 0x8E8A
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_116()//Position - 0x8EA0
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x8EB6
{
...
int func_118(bool bParam0)//Position - 0x8EF8
{
...
int func_123(int iParam0)//Position - 0xA98B
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xAC05
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xACFE
{
...
int func_135(int iParam0)//Position - 0xAD65
{
	int iVar0;
...
int func_136(int iParam0)//Position - 0xADAE
{
	if (func_137(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xADCE
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_138(int iParam0)//Position - 0xADEF
{
	switch (iParam0)
	{
		case 5:
...
int func_140(int iParam0)//Position - 0xAEBF
{
	switch (iParam0)
	{
		case 5:
...
void func_141(var uParam0, bool bParam1, bool bParam2)//Position - 0xAF12
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0xB007
{
	switch (iParam0)
	{
		case 5:
...
void func_144(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB0B1
{
	if (bParam0)
	{
...
bool func_146(int iParam0, int iParam1)//Position - 0xB218
{
	bool bVar0;
...
int func_148(var uParam0)//Position - 0xB2B2
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xB2D4
{
...
int func_151(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB321
{
	int iVar0;
...
int func_154(char* sParam0)//Position - 0xB39E
{
...
int func_160(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB4D1
{
...
void func_161(int iParam0)//Position - 0xB528
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_168(int iParam0)//Position - 0xB835
{
	if (iParam0 == 1)
	{
...
int func_170(int iParam0)//Position - 0xB89B
{
...
int func_171(int iParam0)//Position - 0xB8DC
{
	int iVar0;
...
int func_173(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB953
{
	int iVar0;
...
void func_174(var uParam0, int iParam1)//Position - 0xBA8A
{
	int iVar0;
...
bool func_175(int iParam0)//Position - 0xBAD9
{
	return func_176(iParam0, Global_44042);
}

int func_176(int iParam0, int iParam1)//Position - 0xBAEA
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_177(int iParam0)//Position - 0xBCCB
{
	if (Global_44042 == 15)
	{
		return 0;
...
int func_179(char* sParam0, int iParam1)//Position - 0xBCFE
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_181(var uParam0, int iParam1)//Position - 0xBD6B
{
	switch (uParam0->f_16)
	{
		case 0:
...
int func_183(var uParam0)//Position - 0xC56B
{
	float fVar0;
...
void func_184(int iParam0, int iParam1)//Position - 0xC5F9
{
	if (iParam0 == 1)
	{
		if (!func_140(iParam1))
...
int func_185(bool bParam0)//Position - 0xC65D
{
	int iVar0;
...
int func_186(int iParam0)//Position - 0xC6F4
{
	if (func_137(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_187(int iParam0)//Position - 0xC71E
{
	bool bVar0;
...
var func_188()//Position - 0xCE3B
{
	return Global_101572.f_1;
}

int func_189()//Position - 0xCE49
{
	if (Global_98435 != -1)
	{
...
var func_194()//Position - 0xCEF9
{
	return Global_1575083;
}

int func_195()//Position - 0xCF05
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
float func_197(int* iParam0)//Position - 0xDCD2
{
	if (func_203(iParam0))
	{
		if (func_199(iParam0))
...
bool func_199(int* iParam0)//Position - 0xDD66
{
	return BitTest(*iParam0, 2);
}

void func_200(int* iParam0)//Position - 0xDD73
{
	func_201(iParam0, 0f);
}

void func_201(int* iParam0, float fParam1)//Position - 0xDD82
{
...
void func_202(int* iParam0)//Position - 0xDDAD
{
	if (!func_203(iParam0))
	{
		func_200(iParam0);
...
bool func_203(int* iParam0)//Position - 0xDDC5
{
...
bool func_208(int iParam0)//Position - 0xE18E
{
	return func_209(iParam0, 20);
}

var func_209(int iParam0, int iParam1)//Position - 0xE19E
{
...
void func_215(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE410
{
...
int func_216(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE466
{
...
void func_217(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xE4B4
{
...
void func_218(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xE54F
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_221(int iParam0, int iParam1)//Position - 0xE6B5
{
	bool bVar0;
	int iVar1;
...
float func_222(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xE753
{
	struct<3> Var0;
...
void func_224(int iParam0)//Position - 0xE799
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_225(iParam0);
...
void func_225(int iParam0)//Position - 0xE7B0
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_227(int iParam0, bool bParam1)//Position - 0xE8C0
{
	struct<27> Var0;
...
void func_228(int iParam0, var uParam1, int iParam2)//Position - 0xEB30
{
	int iVar0;
	int iVar1;
...
int func_229(int iParam0)//Position - 0xEE88
{
...
int func_230(var uParam0)//Position - 0xEEA8
{
...
int func_231(var uParam0)//Position - 0xEEC0
{
...
void func_233(int* iParam0)//Position - 0xF1E9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_235(var uParam0, bool bParam1, bool bParam2)//Position - 0xF294
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_236(int iParam0, int iParam1)//Position - 0xF452
{
	int iVar0;
...
int func_237(var uParam0, bool bParam1, int iParam2)//Position - 0xF482
{
	int iVar0;
	int iVar1;
...
int func_238(int iParam0)//Position - 0xF73E
{
...
int func_239(int iParam0, float fParam1)//Position - 0xF772
{
	float fVar0;
...
bool func_240(int iParam0, float fParam1)//Position - 0xF7E8
{
	return func_241(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_241(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF800
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_242(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xF8C1
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_243(int iParam0, int iParam1)//Position - 0xF9ED
{
	int iVar0;
...
int func_245(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xFAFC
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_246(struct<3> Param0, struct<3> Param3)//Position - 0xFB8D
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_247(struct<3> Param0)//Position - 0xFBAE
{
	float fVar0;
	float fVar1;
...
int func_249(int iParam0, int iParam1)//Position - 0xFC08
{
	int iVar0;
...
int func_250(int iParam0)//Position - 0xFC47
{
...
int func_251(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xFC6F
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_252(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xFD6A
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_253(int iParam0, float fParam1)//Position - 0xFE76
{
	var uVar0;
	struct<3> Var1;
...
int func_254(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xFF0B
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_255(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xFF99
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_256(int iParam0)//Position - 0xFFE1
{
...
void func_257(int iParam0)//Position - 0x1002C
{
	int iVar0;
...
int func_258(int iParam0)//Position - 0x100C9
{
	if (iParam0 == -1)
	{
		iParam0 = func_178();
...
int func_259(int iParam0)//Position - 0x1015E
{
...
int func_262(int iParam0)//Position - 0x101DD
{
...
int func_264(int iParam0)//Position - 0x1024F
{
	if (func_118(0))
	{
...
int func_265(int iParam0)//Position - 0x10277
{
	if (!func_266(iParam0))
	{
		return 0;
...
int func_266(var uParam0)//Position - 0x102CC
{
	bool bVar0;
	int iVar1;
...
int func_267(int iParam0)//Position - 0x10582
{
	int iVar0;
...
int func_268(int iParam0)//Position - 0x105EA
{
	struct<27> Var0;
	bool bVar32;
...
int func_269(int iParam0)//Position - 0x1063B
{
	char* sVar0;
...
int func_270(int iParam0)//Position - 0x106F4
{
	var uVar0;
...
int func_271(int iParam0)//Position - 0x107B5
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_273(int iParam0)//Position - 0x1091C
{
...
int func_274(int iParam0)//Position - 0x10947
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_275(int iParam0)//Position - 0x10972
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_276(int iParam0)//Position - 0x1099D
{
	if (func_259(iParam0))
	{
		return 0;
...
int func_277(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x109D2
{
	int iVar0;
...
int func_278(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10A37
{
	int iVar0;
	struct<7> Var1;
...
int func_279(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10AAF
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_280(int iParam0, bool bParam1)//Position - 0x10B2A
{
	func_293();
	if (bParam1)
	{
...
void func_284(int* iParam0, bool bParam1)//Position - 0x10C6E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_287(int* iParam0)//Position - 0x10CF8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_288(int* iParam0)//Position - 0x10D30
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_291(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10E1F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_292(int* iParam0)//Position - 0x10E6F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_295(var uParam0)//Position - 0x10EE1
{
	if (*uParam0 == -1)
	{
		return;
