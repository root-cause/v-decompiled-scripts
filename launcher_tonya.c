...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		func_286("Force cleanup [TERMINATING]");
		if (Var0.f_0 != -1)
		{
			if (Global_112473[Var0.f_0 /*10*/].f_9 != -1)
			{
				func_286("Relinquishing candidate id...");
				func_285(&(Global_112473[Var0.f_0 /*10*/].f_9));
			}
		}
		func_270(&Var0, 1);
	}
	...
	iVar1[1] = 59;
	iVar1[2] = 62;
	if (!func_267(&iVar1, &Var0, Local_52, 1f))
	{
		func_286("SCRIPT TERMINATED");
	...
	if (func_257(43))
	{
		func_286("SP_MISSION_LAMAR is available... [TERMINATING]");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	else if (func_257(47))
	{
		func_286("SP_MISSION_MICHAEL_2 is available... [TERMINATING]");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	else if (func_257(40))
	{
		func_286("SP_MISSION_FRANKLIN_0 is available... [TERMINATING]");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	else if (func_257(41))
	{
		func_286("SP_MISSION_FRANKLIN_1 is available... [TERMINATING]");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	while (!func_255(&Var0))
	{
		...
		{
			func_286("Player out of range [TERMINATING]");
			func_270(&Var0, 1);
		}
	}
	...
	{
		SYSTEM::WAIT(0);
		if (!func_217(&Var0, 1) || func_258(Var0.f_0))
		{
			func_270(&Var0, 1);
		}
		if (func_257(43))
		{
			func_286("SP_MISSION_LAMAR became available... [TERMINATING]");
			func_270(&Var0, 1);
		}
		else if (func_257(47))
		{
			func_286("SP_MISSION_MICHAEL_2 became available... [TERMINATING]");
			func_270(&Var0, 1);
		}
		else if (func_257(40))
		{
			func_286("SP_MISSION_FRANKLIN_0 became available... [TERMINATING]");
			func_270(&Var0, 1);
		}
		else if (func_257(41))
		{
			func_286("SP_MISSION_FRANKLIN_1 became available... [TERMINATING]");
			func_270(&Var0, 1);
		}
		func_216(Var0.f_0);
		func_208(&iLocal_227, &(Var0.f_9), Local_52);
		func_186(&Var0);
		if (func_171(&Var0, 0))
		{
			if (!func_2(&Var0))
...
int func_2(int iParam0)//Position - 0x2E0
{
	...
	if (!func_170())
	{
		while (!func_161(*iParam0))
		{
			...
			{
				func_286("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			SYSTEM::WAIT(0);
		}
	...
	if (!func_115(iParam0))
	{
		func_286("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F16
{
	int iVar0;
...
int func_61(int iParam0)//Position - 0x4692
{
...
int func_62(int iParam0, int iParam1)//Position - 0x485A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x53FB
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x5436
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x56AA
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x56E6
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5C35
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5C79
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x63F8
{
	if (bParam2)
	{
...
int func_70(var uParam0)//Position - 0x643F
{
...
bool func_71(int iParam0)//Position - 0x649A
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x64AA
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x650B
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x6886
{
	return Global_31959;
}

int func_75(int iParam0)//Position - 0x6891
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x68A1
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x6943
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x7068
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x70C0
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x716A
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
...
Vector3 func_81(struct<3> Param0, float fParam1)//Position - 0x71FF
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_82(int iParam0)//Position - 0x7243
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x73C7
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x73D5
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7E9C
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7F1E
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x7F76
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x7F7F
{
	switch (iParam0)
	{
		case 1:
...
int func_89()//Position - 0x81DB
{
	return func_90(PLAYER::PLAYER_ID());
}

int func_90(int iParam0)//Position - 0x81EB
{
	return MISC::GET_BITS_IN_RANGE(Global_2689235[iParam0 /*453*/].f_318.f_3, 28, 31);
}

int func_91(int iParam0)//Position - 0x8208
{
	return func_72(iParam0, 0, 0);
}

int func_92(int iParam0)//Position - 0x8218
{
	switch (iParam0)
	{
		case -1:
...
bool func_93()//Position - 0x8527
{
	return Global_100493.f_375 > 0;
}

var func_94()//Position - 0x8538
{
	var uVar0;
...
void func_95(var uParam0, int iParam1)//Position - 0x857E
{
	if (iParam1 <= 0)
	{
		return;
...
void func_96(var uParam0, int iParam1)//Position - 0x8604
{
...
void func_97(var uParam0, int iParam1)//Position - 0x8637
{
	int iVar0;
	int iVar1;
...
int func_98(int iParam0, int iParam1)//Position - 0x8688
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_99(int iParam0)//Position - 0x872A
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_100(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_100(bool bParam0, int iParam1, int iParam2)//Position - 0x874C
{
	if (bParam0)
	{
		return iParam1;
...
int func_101(var uParam0)//Position - 0x8763
{
	return uParam0 & 15;
}

void func_102(var uParam0, int iParam1)//Position - 0x8770
{
...
void func_103(var uParam0, int iParam1)//Position - 0x87AA
{
...
void func_104(var uParam0, int iParam1)//Position - 0x87E5
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_105()//Position - 0x8821
{
	func_56();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_106(int iParam0)//Position - 0x883A
{
	var uVar0;
	char cVar1[24];
...
bool func_107()//Position - 0x8893
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_108()//Position - 0x88A9
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_109(char* sParam0, int iParam1, int iParam2)//Position - 0x88BF
{
...
int func_110(bool bParam0)//Position - 0x8901
{
...
struct<2> func_111(int iParam0)//Position - 0x8929
{
	struct<2> Var0;
...
void func_112(int iParam0, var uParam1)//Position - 0x8D76
{
	switch (iParam0)
	{
		case 0:
...
int func_114(int iParam0)//Position - 0xA04E
{
	switch (iParam0)
	{
		case 0:
...
int func_115(int iParam0)//Position - 0xA394
{
	int iVar0;
	
	if (func_145(&(iParam0->f_1)))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&(iParam0->f_9)))
		{
			func_135(1);
			func_133(iParam0, 1, func_134(*iParam0));
		}
		if (iParam0->f_27)
		{
			if (func_132(*iParam0))
		...
		{
			func_286("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::SET_SCRIPT_CAN_START_CUTSCENE(iVar0);
		}
		else
		{
			func_286("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_116(int iParam0)//Position - 0xA439
{
	struct<2> Var0;
...
void func_117(int iParam0)//Position - 0xA4D4
{
	if (iParam0 < 63)
	{
		func_118();
...
void func_119(int iParam0)//Position - 0xA532
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_120(int iParam0)//Position - 0xA58B
{
...
int func_121(int iParam0)//Position - 0xA60E
{
	int iVar0;
...
void func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA63F
{
	func_123(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_123(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA654
{
	int iVar0;
...
int func_125(int iParam0, int iParam1, int iParam2)//Position - 0xA707
{
...
int func_126(int iParam0, int iParam1, int iParam2)//Position - 0xA722
{
	int iVar0;
...
int func_127(int iParam0)//Position - 0xA76E
{
	int iVar0;
...
int func_128(int iParam0)//Position - 0xA7B7
{
	if (func_129(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_129(int iParam0)//Position - 0xA7D7
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_130(int iParam0)//Position - 0xA7F8
{
	switch (iParam0)
	{
		case 5:
...
int func_132(int iParam0)//Position - 0xA8C8
{
	switch (iParam0)
	{
		case 5:
...
void func_133(var uParam0, bool bParam1, bool bParam2)//Position - 0xA91B
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xAA10
{
	switch (iParam0)
	{
		case 5:
...
void func_135(bool bParam0)//Position - 0xAA7B
{
	int iVar0;
...
void func_136(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAABA
{
	if (bParam0)
	{
...
bool func_137()//Position - 0xABFD
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_138(int iParam0, int iParam1)//Position - 0xAC17
{
	bool bVar0;
...
int func_139(int iParam0, bool bParam1)//Position - 0xAC62
{
	int iVar0;
	int iVar1;
...
int func_140(int iParam0)//Position - 0xACA3
{
...
bool func_141()//Position - 0xACE2
{
	return BitTest(Global_2621446, 3);
}

int func_142(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xACF0
{
	int iVar0;
...
void func_144(int iParam0)//Position - 0xAD4A
{
	if (iParam0 == 1)
	{
...
int func_145(char* sParam0)//Position - 0xAD6D
{
	...
	func_286("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}

void func_146()//Position - 0xADAA
{
	Global_20471 = 0;
	func_147();
}

void func_147()//Position - 0xADBA
{
...
int func_151(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAEA0
{
...
void func_152(int iParam0)//Position - 0xB038
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_154(int iParam0)//Position - 0xB0B5
{
	if (func_159())
	{
		return;
...
void func_155(int iParam0)//Position - 0xB0E8
{
	if (func_159())
	{
		return;
...
void func_156(bool bParam0, bool bParam1)//Position - 0xB172
{
	if (bParam0)
	{
		if (func_158(0))
...
bool func_157()//Position - 0xB1E6
{
	return BitTest(Global_1958711, 5);
}

int func_158(int iParam0)//Position - 0xB1F4
{
	if (iParam0 == 1)
	{
...
bool func_159()//Position - 0xB24B
{
	return BitTest(Global_1958711, 19);
}

int func_160(int iParam0)//Position - 0xB25A
{
...
int func_161(int iParam0)//Position - 0xB29B
{
	int iVar0;
...
void func_162(int iParam0)//Position - 0xB2E0
{
...
int func_163(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB312
{
	int iVar0;
...
void func_164(var uParam0, int iParam1)//Position - 0xB449
{
	int iVar0;
...
bool func_165(int iParam0)//Position - 0xB498
{
	return func_166(iParam0, Global_43052);
}

int func_166(int iParam0, int iParam1)//Position - 0xB4A9
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_167(int iParam0)//Position - 0xB68A
{
	if (Global_43052 == 15)
	{
		return 0;
...
int func_168()//Position - 0xB6AC
{
	return func_169(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_169(char* sParam0, int iParam1)//Position - 0xB6BD
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_171(var uParam0, int iParam1)//Position - 0xB72A
{
	switch (uParam0->f_16)
	{
		case 0:
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_177(2))
							{
								if (func_175(uParam0->f_27))
								{
									...
									func_286("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.88849f, 371.9034f, 103.98843f, 241.58984f, 359.64575f, 107.34612f, 1.25f, false, true, 0))
					{
						if (func_177(2))
						{
							...
							{
								func_174(uParam0->f_27, *uParam0);
								func_286("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.9482f, 4143.44f, 42.292946f, 2722.2134f, 4144.5215f, 45.431824f, 10f, false, true, 0))
				{
					if (func_177(2))
					{
						...
						{
							func_174(1, *uParam0);
							func_286("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.11035f, 68.460175f, -1028.5663f, 395.46133f, 94.57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.75565f, 68.02096f, -1021.4514f, 336.34583f, 93.18714f, 14.5f, false, true, 0))
						{
							if (func_177(2))
							{
								...
								{
									func_174(uParam0->f_27, *uParam0);
									func_286("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_172()//Position - 0xBF0D
{
	func_27(&(Global_103950.f_2890), &Global_103950, 0, 1, 1, 0);
}

int func_173(var uParam0)//Position - 0xBF28
{
	float fVar0;
...
void func_174(int iParam0, int iParam1)//Position - 0xBFB6
{
	if (iParam0 == 1)
	{
		if (!func_132(iParam1))
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_286("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_286("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
int func_175(bool bParam0)//Position - 0xC01B
{
	int iVar0;
...
int func_176(int iParam0)//Position - 0xC0B2
{
	if (func_129(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_177(int iParam0)//Position - 0xC0DC
{
	bool bVar0;
...
var func_178()//Position - 0xC7F9
{
	return Global_100480.f_1;
}

int func_179()//Position - 0xC807
{
	if (Global_97363 != -1)
	{
...
bool func_182()//Position - 0xC86E
{
	return Global_100493.f_376 > 0;
}

bool func_183(int iParam0, int iParam1)//Position - 0xC87F
{
	switch (iParam0)
	{
		case 5:
...
var func_184()//Position - 0xC8B7
{
	return Global_1575058;
}

int func_185()//Position - 0xC8C3
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_186(var uParam0)//Position - 0xC8DF
{
	...
	if (func_180() || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		AUDIO::STOP_SCRIPTED_CONVERSATION(false);
		return;
	}
		...
		if (fVar0 < (20f * 20f) && iLocal_56)
		{
			switch (iLocal_57)
			{
				case 0:
					if (!func_148())
					{
						func_207(&uLocal_58, 3, uParam0->f_28[0], "TONYA", 0, 1);
						if (*uParam0 == 58)
						{
							func_206(&uLocal_58, "TOWAUD", "TONYA_BECK_1", 4, 0, 0, 0);
						...
						{
							func_194(&uLocal_58, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_1", 4, 0, 0);
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
							{
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
						...
						{
							func_194(&uLocal_58, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_1", 4, 0, 0);
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
							{
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
				...
				case 2:
					if (func_193(&iLocal_223))
					{
						if (func_187(&iLocal_223) > MISC::GET_RANDOM_FLOAT_IN_RANGE(9f, 15f))
						{
							iLocal_226++;
							switch (iLocal_226)
							{
								case 1:
									if (*uParam0 == 58)
									{
										func_206(&uLocal_58, "TOWAUD", "TONYA_BECK_2", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_194(&uLocal_58, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_2", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_194(&uLocal_58, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_2", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
								...
								case 2:
									if (*uParam0 == 58)
									{
										func_206(&uLocal_58, "TOWAUD", "TONYA_BECK_3", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_194(&uLocal_58, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_3", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_194(&uLocal_58, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_3", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
								...
								case 3:
									if (*uParam0 == 58)
									{
										func_206(&uLocal_58, "TOWAUD", "TONYA_BECK_4", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_194(&uLocal_58, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_4", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_194(&uLocal_58, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_4", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
								...
								case 4:
									if (*uParam0 == 58)
									{
										func_206(&uLocal_58, "TOWAUD", "TONYA_BECK_5", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_194(&uLocal_58, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_5", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
									...
									{
										func_194(&uLocal_58, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_5", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
...
float func_187(int* iParam0)//Position - 0xD690
{
	if (func_193(iParam0))
	{
		if (func_189(iParam0))
		...
		{
			return (func_188(BitTest(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}

float func_188(bool bParam0)//Position - 0xD6CC
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_189(int* iParam0)//Position - 0xD724
{
	return BitTest(*iParam0, 2);
}

void func_190(int* iParam0)//Position - 0xD731
{
	func_191(iParam0, 0f);
}

void func_191(int* iParam0, float fParam1)//Position - 0xD740
{
	iParam0->f_1 = (func_188(BitTest(*iParam0, 4)) - fParam1);
	MISC::SET_BIT(iParam0, 1);
	MISC::CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}

void func_192(int* iParam0)//Position - 0xD76B
{
	if (!func_193(iParam0))
	{
		func_190(iParam0);
...
bool func_193(int* iParam0)//Position - 0xD783
{
	return BitTest(*iParam0, 1);
}

int func_194(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD790
{
	...
	Global_2883585 = 0;
	return func_195(sParam2, iParam4, 0);
}

int func_195(char* sParam0, int iParam1, bool bParam2)//Position - 0xD7E4
{
	Global_21606 = 0;
...
bool func_198(int iParam0)//Position - 0xDB4C
{
	return func_199(iParam0, 20);
}

var func_199(int iParam0, int iParam1)//Position - 0xDB5C
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

void func_200()//Position - 0xDB74
{
	int iVar0;
...
void func_205(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDDCE
{
...
int func_206(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xDE24
{
...
void func_207(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xDE72
{
...
void func_208(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xDF0D
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_209(int iParam0, bool bParam1)//Position - 0xDFFE
{
	if (iParam0 == -1)
	{
		return;
...
int func_210(int iParam0)//Position - 0xE03A
{
	if (Global_78315 == iParam0)
	{
		if (Global_78316 == -1)
...
void func_211(int iParam0, int iParam1)//Position - 0xE073
{
	bool bVar0;
	int iVar1;
...
float func_212(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xE111
{
	struct<3> Var0;
...
bool func_213()//Position - 0xE14B
{
	return Global_97750;
}

void func_214(int iParam0)//Position - 0xE157
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_215(iParam0);
...
void func_215(int iParam0)//Position - 0xE16E
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_216(int iParam0)//Position - 0xE256
{
	if (iParam0 == -1)
	{
		iParam0 = func_168();
...
int func_217(int iParam0, bool bParam1)//Position - 0xE27E
{
	struct<27> Var0;
	
	if (Global_78319)
	{
		func_286("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_112(*iParam0, &Var0);
	if ((func_254(*iParam0) || func_252(*iParam0)) || Global_78564 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_286("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_248(*iParam0))
	{
		if (*iParam0 == 19)
		{
			func_247(iParam0->f_28[0]);
		}
		func_286("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (iParam0->f_25 == 1)
	{
	...
	if (*iParam0 == 10)
	{
		...
		{
			func_286("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_286("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
	if (func_221(&(iParam0->f_48)) && bParam1)
	{
		func_218(iParam0->f_28[0], &(iParam0->f_48), *iParam0);
	}
	return 1;
}

void func_218(int iParam0, var uParam1, int iParam2)//Position - 0xE4EE
{
	int iVar0;
	int iVar1;
...
int func_219(int iParam0)//Position - 0xE846
{
...
int func_220(var uParam0)//Position - 0xE866
{
...
int func_221(var uParam0)//Position - 0xE87E
{
...
void func_222(var uParam0)//Position - 0xE8A3
{
	int iVar0;
	int iVar1;
...
void func_223(int* iParam0)//Position - 0xEBA7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_224(var uParam0)//Position - 0xEBD2
{
	int iVar0;
...
int func_225(var uParam0, bool bParam1, bool bParam2)//Position - 0xEC52
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_128(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				{
					func_286("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[iVar0], false))
				{
					func_286("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[iVar0], PLAYER::PLAYER_PED_ID(), false))
				{
					func_286("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[iVar0]) < 850)
				{
					func_286("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							func_286("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_176(iVar2))
						{
							if (ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck") || ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck2"))
							{
								if (func_176(uParam0->f_35[iVar0]))
								{
									...
									{
										func_286("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_176(iVar3))
						{
							...
							{
								func_286("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							...
							{
								func_286("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
...
int func_226(int iParam0, int iParam1)//Position - 0xEE10
{
	int iVar0;
...
int func_227(var uParam0, bool bParam1, int iParam2)//Position - 0xEE40
{
	int iVar0;
	int iVar1;
	...
	if (func_128(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[iVar0]))
						{
							...
							func_286("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[iVar0]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[iVar0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[iVar0]))
					{
						...
						func_286("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[iVar0], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
						{
							...
							func_286("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_246(*uParam0))
					{
						if (!func_160(*uParam0))
						{
							if (func_241(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								...
								func_286("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[iVar0], true), 15f))
						{
							...
							func_286("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_229(uParam0->f_28[iVar0], 1126825984))
						{
							...
							func_286("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_228(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_286("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_286("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_129(uParam0->f_41[0]))
						{
...
int func_228(int iParam0)//Position - 0xF0FC
{
...
int func_229(int iParam0, float fParam1)//Position - 0xF130
{
	float fVar0;
...
bool func_230(int iParam0, float fParam1)//Position - 0xF1A6
{
	return func_231(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_231(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF1BE
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_232(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_232(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xF27F
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_233(int iParam0, int iParam1)//Position - 0xF3AB
{
	int iVar0;
...
int func_235(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xF4BA
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	{
		Var1 = { func_237(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_236(struct<3> Param0, struct<3> Param1)//Position - 0xF54B
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_237(struct<3> Param0)//Position - 0xF56C
{
	float fVar0;
	float fVar1;
...
void func_238(var uParam0)//Position - 0xF5AB
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_239(int iParam0, int iParam1)//Position - 0xF5C6
{
	int iVar0;
...
int func_240(int iParam0)//Position - 0xF605
{
...
int func_241(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF62D
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_242(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF728
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_243(int iParam0, float fParam1)//Position - 0xF834
{
	var uVar0;
	struct<3> Var1;
...
int func_244(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xF8C9
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_245(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF957
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_246(int iParam0)//Position - 0xF99F
{
...
void func_247(int iParam0)//Position - 0xF9E9
{
	int iVar0;
...
int func_248(int iParam0)//Position - 0xFA86
{
	if (iParam0 == -1)
	{
		iParam0 = func_168();
...
int func_249(int iParam0)//Position - 0xFB1B
{
...
int func_252(int iParam0)//Position - 0xFB9A
{
	if ((func_253() && Global_100441.f_11 == 6) && iParam0 == func_169(&(Global_100441.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_254(int iParam0)//Position - 0xFC0C
{
	if (func_110(0))
	{
...
int func_255(int iParam0)//Position - 0xFC34
{
	...
	iLocal_55 = 1;
	func_286("Created initial scene");
	return 1;
}
...
int func_256(var uParam0)//Position - 0xFC88
{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_129(uParam0->f_28[0]) && PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				TASK::CLEAR_SEQUENCE_TASK(&iVar1);
				TASK::OPEN_SEQUENCE_TASK(&iVar1);
...
int func_257(int iParam0)//Position - 0xFF3E
{
	int iVar0;
...
int func_258(int iParam0)//Position - 0xFFA6
{
	struct<27> Var0;
	bool bVar1;
...
int func_259(int iParam0)//Position - 0xFFF7
{
	...
	if (Global_78319)
	{
		func_286("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!Global_113386.f_9085 && !func_110(1))
	{
		func_286("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_260(iParam0))
	{
		Global_112473[iParam0 /*10*/].f_1 = 1;
		func_286("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_100441.f_11 == 6)
	{
		if (Global_100441 < 9)
		{
			...
			{
				func_286("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	...
	{
		Global_112473[iParam0 /*10*/].f_1 = 1;
		func_286("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}
...
bool func_262(int iParam0, char* sParam1)//Position - 0x101FA
{
...
int func_263(int iParam0)//Position - 0x102DC
{
...
int func_264(int iParam0)//Position - 0x10307
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_265(int iParam0)//Position - 0x10332
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_266(int iParam0)//Position - 0x1035D
{
	if (func_249(iParam0))
	{
		return 0;
...
int func_267(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x10392
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_268((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_268((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
	...
	func_286("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}

int func_268(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0x103F7
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_269(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_269(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x1046F
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_270(int iParam0, bool bParam1)//Position - 0x104EA
{
	...
	if (bParam1)
	{
		func_286("SCRIPT TERMINATING: Cleaning up entities in Launcher");
	...
	if (iLocal_227 != -1)
	{
		func_286("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_215(&iLocal_227);
	}
	if (iLocal_55)
	{
...
void func_271(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x105BE
{
...
void func_272(var uParam0, bool bParam1)//Position - 0x105DE
{
	func_273(&(uParam0->f_41), bParam1);
}

void func_273(var uParam0, bool bParam1)//Position - 0x105F0
{
	int iVar0;
...
void func_274(int* iParam0, bool bParam1)//Position - 0x1062E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_275(var uParam0, bool bParam1)//Position - 0x10669
{
	func_276(&(uParam0->f_35), bParam1);
}

void func_276(var uParam0, bool bParam1)//Position - 0x1067B
{
	int iVar0;
...
void func_277(int* iParam0)//Position - 0x106B8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_278(int* iParam0)//Position - 0x106F0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_279(var uParam0, int iParam1)//Position - 0x1078C
{
	func_280(&(uParam0->f_28), iParam1);
}

void func_280(var uParam0, int iParam1)//Position - 0x1079E
{
	int iVar0;
...
void func_281(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x107DF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_282(int* iParam0)//Position - 0x1082F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_283()//Position - 0x10870
{
	Global_20471 = 0;
	func_284();
}

void func_284()//Position - 0x10880
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22616 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_285(var uParam0)//Position - 0x108A1
{
	if (*uParam0 == -1)
	{
		return;
...
void func_286(char* sParam0)//Position - 0x108DE
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_287(var uParam0)//Position - 0x108F0
{
	*uParam0 = -1;
