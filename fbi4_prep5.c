...
void func_195(struct<3> Param0, float fParam3, bool bParam4)//Position - 0xD7CF
{
	int iVar0;
...
bool func_204(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xF27E
{
	if (bParam6)
	{
...
int func_205(struct<3> Param0, float fParam3)//Position - 0xF2C5
{
	return func_206(&(Global_107196.f_2890), Param0, fParam3, 0);
}

int func_206(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0xF2DF
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_208(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xF654
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
bool func_237(struct<3> Param0, int iParam3)//Position - 0x105DA
{
	return func_238(Global_107196.f_2890.f_12.f_66, Param0, iParam3);
}

int func_238(int iParam0, struct<3> Param1, int iParam4)//Position - 0x105F7
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_294(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x1242E
{
	if (func_295())
	{
...
bool func_369(var uParam0, struct<2> Param1, Vector3 vParam3)//Position - 0x2984C
{
	bool bVar0;
	int iVar1;
	int iVar2;
