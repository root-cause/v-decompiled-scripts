...
void __EntryFunction__()//Position - 0x0
{
	...
	sLocal_190 = "FBIPRE";
	Local_199 = { 0f, 0f, 0f };
	Local_200 = { 20.8336f, -1113.793f, 28.797f };
	sLocal_202 = "FBIPRAU";
	iLocal_373 = -1;
	...
	if (func_291())
	{
		func_290(16.5342f, -1122.583f, 27.8635f, 354.7487f, 1, 0);
	}
	func_285();
	if (func_284(0))
	{
...
{
	if (!func_186() && VEHICLE::_IS_VEHICLE_MOD_HSW_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_204(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xF0FF
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_205(iParam0, uVar1[iVar3], 1) && func_97(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
