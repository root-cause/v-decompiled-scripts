...
void func_118(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x3BA4
{
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_216(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
...
int func_129(int iParam0, bool bParam1, bool bParam2)//Position - 0x7668
{
	int iVar0;
...
int func_130(int iParam0)//Position - 0x76C8
{
...
int func_131(int iParam0)//Position - 0x770A
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_132(int iParam0)//Position - 0x77D2
{
	if (iParam0 != func_69())
	{
		if (func_129(iParam0, 1, 1))
...
int func_133(int iParam0)//Position - 0x7819
{
	if (iParam0 != func_69())
	{
		if (func_129(iParam0, 1, 1))
...
int func_134(int iParam0)//Position - 0x7860
{
	if (iParam0 != func_69())
	{
		if (func_129(iParam0, 1, 1))
...
int func_135(int iParam0)//Position - 0x78A6
{
	bool bVar0;
...
int func_136(bool bParam0)//Position - 0x7937
{
	if (bParam0)
	{
...
int func_137(int iParam0)//Position - 0x7951
{
	if (iParam0 != func_69())
	{
...
int func_138(int iParam0)//Position - 0x7977
{
...
int func_139(int iParam0)//Position - 0x79A6
{
...
int func_140(int iParam0)//Position - 0x7AEB
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0x7B68
{
	switch (iParam0)
	{
		case joaat("mule"):
...
int func_142(int iParam0)//Position - 0x7BC4
{
	if (iParam0 == func_69())
	{
		return 0;
...
int func_143(int iParam0, bool bParam1)//Position - 0x7BFD
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_144(int iParam0)//Position - 0x7C58
{
	int iVar0;
...
int func_145(int iParam0, int iParam1)//Position - 0x7C91
{
	if (iParam1 == 0)
	{
...
int func_154(int iParam0, int iParam1)//Position - 0x818D
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_155(int iParam0)//Position - 0x856C
{
	if (PLAYER::PLAYER_ID() != func_69())
	{
		...
		if (((func_159(PLAYER::PLAYER_ID(), 1, 0) && Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_268.f_35 > 0) || BitTest(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_268.f_33, 14)) || BitTest(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_268.f_33, 11))
		{
			return 0;
		}
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("Player_Vehicle", 3))
		{
			if (DECORATOR::DECOR_EXIST_ON(iParam0, "Player_Vehicle"))
			{
				if (DECORATOR::DECOR_GET_INT(iParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
				{
					...
					{
						if (!func_156(iParam0) || ENTITY::GET_ENTITY_MODEL(iParam0) != Global_1586521[func_157() /*142*/].f_66)
						{
							return 1;
						}
					}
...
int func_156(int iParam0)//Position - 0x8665
{
...
int func_159(int iParam0, bool bParam1, bool bParam2)//Position - 0x86A3
{
	if (iParam0 == func_69())
	{
		return 0;
...
int func_160(int iParam0)//Position - 0x8707
{
...
int func_162()//Position - 0x8746
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

int func_163(int iParam0)//Position - 0x875E
{
	if (iParam0 != func_69())
	{
		if (func_129(iParam0, 1, 1))
...
int func_164(int iParam0)//Position - 0x87BD
{
	if (iParam0 != func_69())
	{
		if (func_129(iParam0, 1, 1))
...
int func_165(int iParam0)//Position - 0x881D
{
	if (iParam0 != func_69())
	{
		if (func_129(iParam0, 1, 1))
...
int func_166(int iParam0, bool bParam1, var uParam2)//Position - 0x8864
{
	bool bVar0;
...
int func_167(int iParam0)//Position - 0x8C5B
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_168(int iParam0, int iParam1)//Position - 0x8C90
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_169(int iParam0, var uParam1)//Position - 0x8E92
{
	int iVar0;
...
int func_171(int iParam0)//Position - 0x91ED
{
	switch (iParam0)
	{
		case joaat("granger"):
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_190(iParam0, 0, 0)) || func_190(iParam0, 1, 0)) || func_190(iParam0, 2, 0)) || func_189(iParam0) != 145) || func_188(iParam0)) || func_187(iParam0)) || func_126(iParam0)) || func_186(iParam0)) || !func_174(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_187(iParam0))
		{
		}
...
int func_174(int iParam0)//Position - 0x939A
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_175(int iParam0, bool bParam1, int iParam2)//Position - 0x9558
{
	int iVar0;
	struct<2> Var1;
...
int func_176(int iParam0)//Position - 0x96DD
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_178(int iParam0, int iParam1)//Position - 0x97C0
{
	int iVar0;
	int iVar1;
...
bool func_179()//Position - 0x9A11
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_180()//Position - 0x9A27
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_181()//Position - 0x9A3D
{
	return 0;
}

int func_182()//Position - 0x9A46
{
	return 1;
}

int func_183()//Position - 0x9A4F
{
	return 1;
}

int func_184()//Position - 0x9A58
{
...
int func_186(int iParam0)//Position - 0x9B29
{
	int iVar0;
	char* sVar1;
...
int func_187(int iParam0)//Position - 0x9B70
{
	int iVar0;
...
int func_188(int iParam0)//Position - 0x9BEC
{
	int iVar0;
...
int func_189(int iParam0)//Position - 0x9CD4
{
	int iVar0;
...
int func_190(int iParam0, int iParam1, bool bParam2)//Position - 0x9D37
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_191(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x9DA5
{
...
void func_192(int iParam0, int iParam1)//Position - 0x9E7D
{
	int iVar0;
...
void func_193(int iParam0)//Position - 0x9EFF
{
	if (!func_194(*iParam0))
	{
...
bool func_194(int iParam0)//Position - 0x9F2A
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_195(int iParam0, var uParam1, var uParam2)//Position - 0x9F39
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*iParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_200(*iParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_154(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_198(*iParam0, ((*uParam1)[38] - 1)))
	{
...
int func_196(int iParam0)//Position - 0xA113
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_198(int iParam0, int iParam1)//Position - 0xA246
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_199(int iParam0, int iParam1)//Position - 0xA32F
{
	int iVar0;
...
int func_200(int iParam0, int iParam1, int iParam2)//Position - 0xA391
{
	if (!func_201() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_201()//Position - 0xA3B5
{
	return 0;
}

int func_202(var uParam0, int iParam1)//Position - 0xA3BE
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_203(int iParam0, var uParam1, int iParam2)//Position - 0xA3FF
{
	int iVar0;
...
void func_204(int iParam0, int iParam1)//Position - 0xA65B
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98844[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98844[iVar0]) == func_205(iParam0, iParam1))
				{
...
int func_205(int iParam0, int iParam1)//Position - 0xA6F9
{
	struct<82> Var0;
...
void func_206(struct<3> Param0, float fParam3, bool bParam4)//Position - 0xA73B
{
	int iVar0;
...
int func_211(int iParam0, int iParam1)//Position - 0xAA5E
{
	int iVar0;
...
int func_213(int iParam0, int iParam1)//Position - 0xAADC
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_214(var uParam0, int iParam1)//Position - 0xAAFC
{
	int iVar0;
	int iVar1;
...
bool func_215(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xC1EB
{
	if (bParam6)
	{
...
int func_216(struct<3> Param0, float fParam3)//Position - 0xC232
{
	return func_217(&(Global_107514.f_2890), Param0, fParam3, 0);
}

int func_217(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0xC24C
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (func_241(uParam0))
	{
		...
		if (func_240(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_219(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_218(iVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_218(int iParam0)//Position - 0xC4FE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_219(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xC5C1
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_220(iParam0, uVar1[iVar6], 1) && func_99(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.5635f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_215(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
int func_220(int iParam0, int iParam1, bool bParam2)//Position - 0xC7C9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_221(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0xC82A
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if ((((func_223() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_136(1)))
		{
...
int func_222(int iParam0, float fParam1)//Position - 0xCF2F
{
	struct<3> Var0;
	float fVar3;
...
int func_224(var uParam0)//Position - 0xD02F
{
	int iVar0;
...
int func_225(int iParam0)//Position - 0xD053
{
	int iVar0;
...
var func_227(var uParam0, var uParam1)//Position - 0xD085
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_228(int iParam0, int iParam1)//Position - 0xD0A8
{
	int iVar0;
	int iVar1;
...
int func_230(int iParam0)//Position - 0xD131
{
	int iVar0;
...
int func_231(int iParam0)//Position - 0xD179
{
...
int func_232(int iParam0)//Position - 0xD199
{
	switch (iParam0)
	{
		case 161:
...
int func_233(int iParam0)//Position - 0xD1EC
{
...
int func_234(int iParam0)//Position - 0xD273
{
...
int func_235(int iParam0)//Position - 0xD2A2
{
...
int func_236(int iParam0)//Position - 0xD2BF
{
...
int func_237(int iParam0, int iParam1)//Position - 0xD2E2
{
	if (func_33(iParam0))
	{
...
int func_238(int iParam0)//Position - 0xD326
{
	if (func_33(iParam0))
	{
		if (func_237(iParam0, 0))
...
int func_239(int iParam0, int iParam1)//Position - 0xD352
{
	int iVar0;
...
int func_240(var uParam0)//Position - 0xD39F
{
	if (func_241(uParam0))
	{
...
int func_241(var uParam0)//Position - 0xD3D4
{
...
int func_245(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD478
{
...
int func_247(int iParam0)//Position - 0xD57B
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_249(struct<3> Param0, int iParam3)//Position - 0xD61E
{
	return func_250(Global_107514.f_2890.f_12.f_66, Param0, iParam3);
}

int func_250(int iParam0, struct<3> Param1, int iParam4)//Position - 0xD63B
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_253(char* sParam0, bool bParam1)//Position - 0xD775
{
	if (!*bParam1)
	{
		func_96(sParam0, 7500, 0);
...
int func_254()//Position - 0xD792
{
	...
	if (!func_255(bLocal_194, iVar0) && !bLocal_194)
	{
		return 0;
	}
	return 1;
...
int func_255(bool bParam0, int iParam1)//Position - 0xD7CF
{
	int iVar0;
...
void func_262(char* sParam0, char* sParam1, char* sParam2)//Position - 0xDAAE
{
...
int func_265(int iParam0)//Position - 0xDB3B
{
	if (func_27(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_267(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xDBAB
{
	int iVar0;
	int iVar1;
...
void func_271(bool bParam0)//Position - 0xE558
{
	bool bVar0;
	char cVar1[64];
	...
	else if (BitTest(Global_113969.f_20567.f_471, bParam0) || BitTest(Global_2359296[func_158() /*5570*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_113969.f_20567.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_158() /*5570*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
char* func_272(bool bParam0)//Position - 0xE6D1
{
	switch (bParam0)
	{
		case 0:
...
void func_274(int iParam0, bool bParam1, int iParam2)//Position - 0xE801
{
	if (iParam2 == -1)
	{
		iParam2 = func_32();
...
int func_276(int iParam0)//Position - 0xE83F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_277(int iParam0, int iParam1)//Position - 0xE9DF
{
	if (iParam1 == -1)
	{
		iParam1 = func_32();
...
int func_281(var uParam0, int iParam1)//Position - 0xEB6A
{
	int iVar0;
	var uVar1[78];
...
void func_286(var uParam0, float fParam1)//Position - 0xECEB
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
int func_291(int iParam0)//Position - 0xED61
{
	switch (iParam0)
	{
		case 60:
...
int func_292(int iParam0, int iParam1)//Position - 0xEDB1
{
	int iVar0;
...
void func_293(int iParam0, int iParam1)//Position - 0xEE02
{
	int iVar0;
...
int func_296(int iParam0)//Position - 0xEEF7
{
...
void func_298(int iParam0, int iParam1, bool bParam2)//Position - 0xEF2F
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_94() == 0)
		{
			...
			func_273(func_93(iParam0), iVar0, -1, 1);
		}
	}
	else
	{
...
int func_299(bool bParam0)//Position - 0xEF9F
{
...
void func_301(int iParam0, bool bParam1, int iParam2)//Position - 0xEFE1
{
	if (bParam1)
	{
...
void func_305(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0xF460
{
	if (func_306())
	{
...
int func_309(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xF63E
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_312(int iParam0)//Position - 0x10626
{
	...
	func_313(&(Global_79172[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_313(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x1189D
{
	var uVar0;
	int iVar1;
...
int func_317(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x1283A
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_318(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x12878
{
	int iVar0;
...
void func_320(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x154E9
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_313(&(Global_79172[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_313(&(Global_79172[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_321(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_378(var uParam0, int iParam1)//Position - 0x26C41
{
	...
	{
		func_382(&uLocal_85, *(uParam0[iVar0 /*3*/]));
		iVar0++;
	}
	func_381(&uLocal_85);
...
void func_379(var uParam0, var uParam1, float fParam2)//Position - 0x26C85
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_380(uParam1, *(uParam1[iVar1 /*3*/]) + Var9))
		{
			Var9 = { -Var9 };
		}
...
bool func_380(var uParam0, struct<2> Param1, Vector3 vParam3)//Position - 0x26D92
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_382(var uParam0, struct<3> Param1)//Position - 0x26EEE
{
	if (uParam0->f_51 == 0)
	{
	}
