...
int func_64(int iParam0, int iParam1)//Position - 0x48B0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x55F1
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x562C
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x58A0
{
	bool bVar0;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5E2B
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x65EE
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x6635
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x66A0
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6AB3
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6AC3
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x75CE
{
...
int func_83()//Position - 0x75F8
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

Vector3 func_84(struct<3> Param0)//Position - 0x7610
{
...
int func_86(int iParam0)//Position - 0x763C
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x773E
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x77D3
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_93(int iParam0, var uParam1)//Position - 0x8471
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0)//Position - 0x84F3
{
	if (iParam0 != func_95())
	{
...
int func_98(int iParam0)//Position - 0x87D0
{
	return MISC::GET_BITS_IN_RANGE(Global_2657971[iParam0 /*465*/].f_322.f_3, 28, 31);
}

int func_99(int iParam0)//Position - 0x87ED
{
...
var func_107(int iParam0)//Position - 0x8D36
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8D58
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8D6F
{
	return uParam0 & 15;
}
...
bool func_115()//Position - 0x8E9F
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_116()//Position - 0x8EB5
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x8ECB
{
...
int func_118(bool bParam0)//Position - 0x8F0D
{
...
int func_123(var* uParam0)//Position - 0xA9A0
{
	int iVar0;
...
void func_127(int iParam0)//Position - 0xAB3E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0)//Position - 0xAC1A
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAD13
{
...
int func_135(int iParam0)//Position - 0xAD7A
{
	int iVar0;
...
int func_136(int iParam0)//Position - 0xADC3
{
	if (func_210(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xADE3
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xAEB3
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xAF06
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xAFFB
{
	switch (iParam0)
	{
		case 5:
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB0A5
{
	if (bParam0)
	{
...
bool func_145(int iParam0, int iParam1)//Position - 0xB20C
{
	bool bVar0;
...
int func_147(var uParam0)//Position - 0xB2A6
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB2C8
{
...
int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB315
{
	int iVar0;
...
int func_153(char* sParam0)//Position - 0xB392
{
...
int func_159(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB4C5
{
...
void func_160(int iParam0)//Position - 0xB51C
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_167(int iParam0)//Position - 0xB829
{
	if (iParam0 == 1)
	{
...
int func_169(int iParam0)//Position - 0xB88F
{
...
int func_172(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB947
{
	int iVar0;
...
void func_173(var uParam0, int iParam1)//Position - 0xBA7E
{
	int iVar0;
...
bool func_174(int iParam0)//Position - 0xBACD
{
	return func_175(iParam0, Global_44042);
}

int func_175(int iParam0, int iParam1)//Position - 0xBADE
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_176(int iParam0)//Position - 0xBCBF
{
	if (Global_44042 == 15)
	{
		return 0;
...
int func_178(char* sParam0, int iParam1)//Position - 0xBCF2
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_180(int iParam0, int iParam1)//Position - 0xBD5F
{
	switch (iParam0)
	{
		case 0:
...
int func_181(struct<3> Param0, bool bParam3)//Position - 0xC1D0
{
	int iVar0;
...
float func_182(bool bParam0, float fParam1, float fParam2)//Position - 0xC1FC
{
	if (bParam0)
	{
		return fParam1;
...
int func_183(int iParam0)//Position - 0xC213
{
	switch (iParam0)
	{
		case 0:
...
int func_184(int iParam0, int iParam1)//Position - 0xC2A2
{
	switch (iParam0->f_16)
	{
		case 0:
...
int func_186(var uParam0)//Position - 0xCAA0
{
	float fVar0;
...
void func_187(int iParam0, int iParam1)//Position - 0xCB2E
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_188(bool bParam0)//Position - 0xCB92
{
	int iVar0;
...
int func_189(int iParam0)//Position - 0xCC29
{
	if (func_210(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_190(int iParam0)//Position - 0xCC53
{
	bool bVar0;
...
var func_191()//Position - 0xD370
{
	return Global_101572.f_1;
}

int func_192()//Position - 0xD37E
{
	if (Global_98435 != -1)
	{
...
var func_196(int iParam0, int iParam1)//Position - 0xD3F6
{
	switch (iParam0)
	{
		case 5:
...
var func_197()//Position - 0xD42E
{
	return Global_1575083;
}

int func_198()//Position - 0xD43A
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_199(int iParam0)//Position - 0xD456
{
	if (iLocal_95 == -1)
	{
...
void func_200(int iParam0, char* sParam1, char* sParam2, int iParam3, bool bParam4)//Position - 0xD4A7
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_201(iParam3), bParam4);
}

int func_201(int iParam0)//Position - 0xD4C1
{
	int iVar0;
...
int func_202(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD6B6
{
	var uVar0;
...
void func_203(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD73E
{
...
void func_204(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD779
{
...
void func_205(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD7CF
{
...
float func_206(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD86A
{
	struct<3> Var0;
...
int func_207(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)//Position - 0xD8A4
{
	var uVar0;
...
int func_208(char* sParam0)//Position - 0xD966
{
	struct<6> Var0;
...
int func_210(int iParam0)//Position - 0xD9AA
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_211(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD9CB
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_214(int iParam0, int iParam1)//Position - 0xDB31
{
	bool bVar0;
	int iVar1;
...
void func_216(int iParam0)//Position - 0xDBDB
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_217(iParam0);
...
void func_217(int iParam0)//Position - 0xDBF2
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_219(var uParam0, bool bParam1)//Position - 0xDD02
{
	struct<27> Var0;
...
void func_220(int iParam0, var uParam1, int iParam2)//Position - 0xDF72
{
	int iVar0;
	int iVar1;
...
int func_221(int iParam0)//Position - 0xE2CA
{
...
int func_222(var uParam0)//Position - 0xE2EA
{
...
int func_223(var uParam0)//Position - 0xE302
{
...
void func_225(int* iParam0)//Position - 0xE62B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_227(var uParam0, bool bParam1, bool bParam2)//Position - 0xE6D6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_228(int iParam0, int iParam1)//Position - 0xE894
{
	int iVar0;
...
int func_229(var uParam0, bool bParam1, int iParam2)//Position - 0xE8C4
{
	int iVar0;
	int iVar1;
...
int func_230(int iParam0)//Position - 0xEB80
{
...
int func_231(int iParam0, float fParam1)//Position - 0xEBB4
{
	float fVar0;
...
bool func_232(int iParam0, float fParam1)//Position - 0xEC2A
{
	return func_233(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_233(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEC42
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_234(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xED03
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_235(int iParam0, int iParam1)//Position - 0xEE2F
{
	int iVar0;
...
int func_237(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEF3E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_238(struct<3> Param0, struct<3> Param3)//Position - 0xEFCF
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_239(struct<3> Param0)//Position - 0xEFF0
{
	float fVar0;
	float fVar1;
...
int func_241(int iParam0, int iParam1)//Position - 0xF04A
{
	int iVar0;
...
int func_242(int iParam0)//Position - 0xF089
{
...
int func_243(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF0B1
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_244(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF1AC
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_245(int iParam0, float fParam1)//Position - 0xF2B8
{
	var uVar0;
	struct<3> Var1;
...
int func_246(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF34D
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_247(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF3DB
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_248(int iParam0)//Position - 0xF423
{
...
void func_249(int iParam0)//Position - 0xF46D
{
	int iVar0;
...
int func_250(int iParam0)//Position - 0xF50A
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_251(int iParam0)//Position - 0xF59F
{
...
int func_254(int iParam0)//Position - 0xF61E
{
...
int func_256(int iParam0)//Position - 0xF690
{
	if (func_118(0))
	{
...
int func_257(int iParam0)//Position - 0xF6B8
{
	switch (*iParam0)
	{
		case 21:
...
int func_259(var uParam0)//Position - 0xF76C
{
	int iVar0[5];
	int iVar6;
	bool bVar7;
...
int func_260(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xFB2C
{
...
int func_261(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xFB88
{
	int iVar0;
...
int func_262(var uParam0, int iParam1)//Position - 0xFC16
{
	int iVar0;
...
int func_263(var uParam0)//Position - 0xFC5C
{
	if (func_223(uParam0))
	{
...
int func_264(int iParam0)//Position - 0xFC86
{
	int iVar0;
...
int func_266(var uParam0)//Position - 0xFCF3
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
...
void func_268(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x1003C
{
	func_269(iParam0);
...
void func_269(int* iParam0)//Position - 0x1007F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_270(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x1011B
{
	func_271(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_271(int* iParam0)//Position - 0x1013C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_272(var uParam0)//Position - 0x1017D
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
...
int func_273(int iParam0)//Position - 0x102D8
{
	struct<27> Var0;
	bool bVar32;
...
int func_274(int iParam0)//Position - 0x10329
{
	char* sVar0;
...
int func_275(int iParam0)//Position - 0x103E2
{
	var uVar0;
...
int func_276(int iParam0)//Position - 0x104A3
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_278(int iParam0)//Position - 0x1060A
{
...
int func_279(int iParam0)//Position - 0x10635
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_280(int iParam0)//Position - 0x10660
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_281(int iParam0)//Position - 0x1068B
{
	if (func_251(iParam0))
	{
		return 0;
...
int func_283(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x106DA
{
	int iVar0;
...
int func_284(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x1073F
{
	int iVar0;
	struct<7> Var1;
...
int func_285(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x107B7
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_286(int iParam0, bool bParam1)//Position - 0x10832
{
	char* sVar0;
...
void func_294(int* iParam0, bool bParam1)//Position - 0x109CC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_297(int* iParam0)//Position - 0x10A56
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_300(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10AE1
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_301(var uParam0)//Position - 0x10B31
{
	if (*uParam0 == -1)
	{
		return;
...
int func_305(int iParam0)//Position - 0x10BCD
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
