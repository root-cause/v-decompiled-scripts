	...
	while (true)
	{
		...
		if (iLocal_93 == 0)
		{
			if (Var0.f_0 == 22)
			{
				...
				{
					if (func_208(Var0.f_28[1]))
					{
						func_300("Trying to set Mary Ann boyfriend component variation");
		...
		if (Var0.f_0 == 21)
		{
			func_205(&Var0, Var61, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		}
		else if (Var0.f_0 == 22)
		{
			func_200(&Var0, Var61, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		}
		else if (Var0.f_0 == 23)
		{
			if (iLocal_94 == 0)
			{
				if (func_205(&Var0, Var61, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
				{
					iLocal_94 = 1;
				}
			}
...
int func_64(int iParam0, int iParam1)//Position - 0x489E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x554F
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x558A
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x57FE
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x583A
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5D89
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5DCD
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x654C
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x6593
{
...
bool func_73(int iParam0)//Position - 0x65EE
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x65FE
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x665E
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x6A06
{
	return Global_32283;
}

int func_77(int iParam0)//Position - 0x6A11
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A21
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6AC3
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x722E
{
...
int func_81()//Position - 0x7529
{
	return Global_2652364.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x7538
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x7562
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x7577
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x758E
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x75E6
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7690
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x7725
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x7769
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x78ED
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x78FB
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x83C2
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x8444
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x849C
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x84A5
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x8711
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x8721
{
	return MISC::GET_BITS_IN_RANGE(Global_2657704[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x873E
{
	return func_74(iParam0, 0, 0);
}

int func_99(int iParam0)//Position - 0x874E
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x8A84
{
	return Global_100885.f_393 > 0;
}

var func_101()//Position - 0x8A95
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8ADB
{
	if (iParam1 <= 0)
	{
		return;
...
void func_103(var uParam0, int iParam1)//Position - 0x8B61
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8B94
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8BE5
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8C87
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8CA9
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8CC0
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8CCD
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8D07
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8D42
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8D7E
{
	func_58();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8D97
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8DF0
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8E06
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8E1C
{
...
int func_117(bool bParam0)//Position - 0x8E5E
{
...
struct<2> func_118(int iParam0)//Position - 0x8E86
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x92D3
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA5AB
{
	switch (iParam0)
	{
		case 0:
...
int func_122(var* uParam0)//Position - 0xA8F1
{
	int iVar0;
...
void func_123(int iParam0)//Position - 0xA996
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xAA31
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xAA8F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xAAE8
{
...
int func_128(int iParam0)//Position - 0xAB6B
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAB9C
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xABB1
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xAC64
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAC7F
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xACCB
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xAD14
{
	if (func_208(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xAD34
{
	switch (iParam0)
	{
		case 5:
...
int func_138(int iParam0)//Position - 0xAE04
{
	switch (iParam0)
	{
		case 5:
...
void func_139(var uParam0, bool bParam1, bool bParam2)//Position - 0xAE57
{
	int iVar0;
...
int func_140(int iParam0)//Position - 0xAF4C
{
	switch (iParam0)
	{
		case 5:
...
void func_141(bool bParam0)//Position - 0xAFB7
{
	int iVar0;
...
void func_142(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAFF6
{
	if (bParam0)
	{
...
bool func_143()//Position - 0xB143
{
	return BitTest(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_36.f_18, 14);
}

bool func_144(int iParam0, int iParam1)//Position - 0xB15D
{
	bool bVar0;
...
int func_145(int iParam0, bool bParam1)//Position - 0xB1B6
{
	int iVar0;
	int iVar1;
...
int func_146(var uParam0)//Position - 0xB1F7
{
	int iVar0;
...
int func_147(int iParam0)//Position - 0xB219
{
...
bool func_148()//Position - 0xB258
{
	return BitTest(Global_2621446, 3);
}

int func_149(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB266
{
	int iVar0;
...
void func_151(int iParam0)//Position - 0xB2C0
{
	if (iParam0 == 1)
	{
...
int func_152(char* sParam0)//Position - 0xB2E3
{
...
void func_153()//Position - 0xB320
{
	Global_20711 = 0;
	func_154();
}

void func_154()//Position - 0xB330
{
...
int func_158(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB416
{
...
void func_159(int iParam0)//Position - 0xB5AE
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_161(int iParam0)//Position - 0xB62B
{
	if (func_166())
	{
		return;
...
void func_162(int iParam0)//Position - 0xB65E
{
	if (func_166())
	{
		return;
...
void func_163(bool bParam0, bool bParam1)//Position - 0xB6E8
{
	if (bParam0)
	{
		if (func_165(0))
...
bool func_164()//Position - 0xB75C
{
	return BitTest(Global_1963795, 5);
}

int func_165(int iParam0)//Position - 0xB76A
{
	if (iParam0 == 1)
	{
...
bool func_166()//Position - 0xB7C1
{
	return BitTest(Global_1963795, 19);
}

int func_167(int iParam0)//Position - 0xB7D0
{
...
int func_168(int iParam0)//Position - 0xB811
{
	int iVar0;
...
void func_169(int iParam0)//Position - 0xB856
{
...
int func_170(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB888
{
	int iVar0;
...
void func_171(var uParam0, int iParam1)//Position - 0xB9BF
{
	int iVar0;
...
bool func_172(int iParam0)//Position - 0xBA0E
{
	return func_173(iParam0, Global_43377);
}

int func_173(int iParam0, int iParam1)//Position - 0xBA1F
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_174(int iParam0)//Position - 0xBC00
{
	if (Global_43377 == 15)
	{
		return 0;
...
int func_175()//Position - 0xBC22
{
	return func_176(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_176(char* sParam0, int iParam1)//Position - 0xBC33
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_178(int iParam0, int iParam1)//Position - 0xBCA0
{
	switch (iParam0)
	{
		case 0:
...
int func_179(struct<3> Param0, bool bParam3)//Position - 0xC113
{
	int iVar0;
...
float func_180(bool bParam0, float fParam1, float fParam2)//Position - 0xC13F
{
	if (bParam0)
	{
		return fParam1;
...
int func_181(int iParam0)//Position - 0xC156
{
	switch (iParam0)
	{
		case 0:
...
int func_182(int iParam0, int iParam1)//Position - 0xC1E5
{
	switch (iParam0->f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
				...
				else if (func_208(iParam0->f_28[0]))
				{
					if (func_184(iParam0))
					{
						if (func_188(2))
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_208(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
					{
...
void func_183()//Position - 0xC9C8
{
	func_27(&(Global_104373.f_2890), &Global_104373, 0, 1, 1, 0);
}

int func_184(var uParam0)//Position - 0xC9E3
{
	float fVar0;
...
void func_185(int iParam0, int iParam1)//Position - 0xCA71
{
	if (iParam0 == 1)
	{
		if (!func_138(iParam1))
...
int func_186(bool bParam0)//Position - 0xCAD5
{
	int iVar0;
...
int func_187(int iParam0)//Position - 0xCB6C
{
	if (func_208(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_188(int iParam0)//Position - 0xCB96
{
	bool bVar0;
...
var func_189()//Position - 0xD2B3
{
	return Global_100872.f_1;
}

int func_190()//Position - 0xD2C1
{
	if (Global_97735 != -1)
	{
...
bool func_193()//Position - 0xD328
{
	return Global_100885.f_394 > 0;
}

var func_194(int iParam0, int iParam1)//Position - 0xD339
{
	switch (iParam0)
	{
		case 5:
...
var func_195()//Position - 0xD371
{
	return Global_1575063;
}

int func_196()//Position - 0xD37D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_197(int iParam0)//Position - 0xD399
{
	if (iLocal_95 == -1)
	{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_95) >= 900)
	{
		if (func_208(iParam0->f_28[0]))
		{
			if (!func_155())
			{
				func_198(iParam0->f_28[0], "PUSHUP_BREATH", "MARYANN", 6);
				iLocal_95 = MISC::GET_GAME_TIMER();
			}
		}
	}
...
void func_198(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xD3E9
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_199(iParam3), false);
}

int func_199(int iParam0)//Position - 0xD402
{
	int iVar0;
...
int func_200(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD5F7
{
	var uVar0;
	
	if ((((func_208(PLAYER::PLAYER_PED_ID()) && func_208(iParam0->f_28[0])) && !func_155()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_204(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_203(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
...
void func_201(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD67F
{
...
void func_202(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD6BA
{
...
void func_203(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD710
{
...
float func_204(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD7AB
{
	struct<3> Var0;
...
int func_205(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)//Position - 0xD7E5
{
	var uVar0;
	...
	if (func_188(2))
	{
		if (!func_155())
		{
			if (((func_208(PLAYER::PLAYER_PED_ID()) && func_208(iParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_204(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_203(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
				func_201(&uVar0, cParam4, sParam5, 7, 0, 0);
		...
		else if (func_206(sParam5))
		{
			if (func_208(PLAYER::PLAYER_PED_ID()))
			{
				if (func_204(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
				{
					func_153();
				}
			}
...
int func_206(char* sParam0)//Position - 0xD8A7
{
	struct<6> Var0;
...
struct<6> func_207()//Position - 0xD8C7
{
	struct<6> Var0;
...
int func_208(int iParam0)//Position - 0xD8EB
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_209(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD90C
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_210(int iParam0, bool bParam1)//Position - 0xD9FD
{
	if (iParam0 == -1)
	{
		return;
...
int func_211(int iParam0)//Position - 0xDA39
{
	if (Global_78685 == iParam0)
	{
		if (Global_78686 == -1)
...
void func_212(int iParam0, int iParam1)//Position - 0xDA72
{
	bool bVar0;
	int iVar1;
...
bool func_213()//Position - 0xDB10
{
	return Global_98122;
}

void func_214(int iParam0)//Position - 0xDB1C
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_215(iParam0);
...
void func_215(int iParam0)//Position - 0xDB33
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_216(int iParam0)//Position - 0xDC1B
{
	if (iParam0 == -1)
	{
		iParam0 = func_175();
...
int func_217(var uParam0, bool bParam1)//Position - 0xDC43
{
	struct<27> Var0;
...
void func_218(int iParam0, var uParam1, int iParam2)//Position - 0xDEB3
{
	int iVar0;
	int iVar1;
...
int func_219(int iParam0)//Position - 0xE20B
{
...
int func_220(var uParam0)//Position - 0xE22B
{
...
int func_221(var uParam0)//Position - 0xE243
{
...
void func_222(var uParam0)//Position - 0xE268
{
	int iVar0;
	int iVar1;
...
void func_223(int* iParam0)//Position - 0xE56C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_224(var uParam0)//Position - 0xE597
{
	int iVar0;
...
int func_225(var uParam0, bool bParam1, bool bParam2)//Position - 0xE617
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_226(int iParam0, int iParam1)//Position - 0xE7D5
{
	int iVar0;
...
int func_227(var uParam0, bool bParam1, int iParam2)//Position - 0xE805
{
	int iVar0;
	int iVar1;
...
int func_228(int iParam0)//Position - 0xEAC1
{
...
int func_229(int iParam0, float fParam1)//Position - 0xEAF5
{
	float fVar0;
...
bool func_230(int iParam0, float fParam1)//Position - 0xEB6B
{
	return func_231(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_231(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEB83
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_232(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xEC44
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_233(int iParam0, int iParam1)//Position - 0xED70
{
	int iVar0;
...
int func_235(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEE7F
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_236(struct<3> Param0, struct<3> Param3)//Position - 0xEF10
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_237(struct<3> Param0)//Position - 0xEF31
{
	float fVar0;
	float fVar1;
...
void func_238(var uParam0)//Position - 0xEF70
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_239(int iParam0, int iParam1)//Position - 0xEF8B
{
	int iVar0;
...
int func_240(int iParam0)//Position - 0xEFCA
{
...
int func_241(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEFF2
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_242(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF0ED
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_243(int iParam0, float fParam1)//Position - 0xF1F9
{
	var uVar0;
	struct<3> Var1;
...
int func_244(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF28E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_245(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF31C
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_246(int iParam0)//Position - 0xF364
{
...
void func_247(int iParam0)//Position - 0xF3AE
{
	int iVar0;
...
int func_248(int iParam0)//Position - 0xF44B
{
	if (iParam0 == -1)
	{
		iParam0 = func_175();
...
int func_249(int iParam0)//Position - 0xF4E0
{
...
int func_252(int iParam0)//Position - 0xF55F
{
	if ((func_253() && Global_100833.f_11 == 6) && iParam0 == func_176(&(Global_100833.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_254(int iParam0)//Position - 0xF5D1
{
	if (func_117(0))
	{
...
int func_255(int iParam0)//Position - 0xF5F9
{
	switch (*iParam0)
	{
		case 21:
...
int func_257(var uParam0)//Position - 0xF6AC
{
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_263(&(uParam0->f_48), "rcmfanatic3", "ef_3_rcm_loop_maryann", 0);
			iLocal_89 = 1;
			break;
		...
		case 2:
			...
			{
				if (func_258(&(uParam0->f_28[0]), 61, -915.6f, 6139.192f, 5.525f, 111.24f, "FANATIC LAUNCHER RC", 1))
				{
...
int func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xFA6C
{
...
int func_259(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xFAC8
{
	int iVar0;
...
int func_260(var uParam0, int iParam1)//Position - 0xFB56
{
	int iVar0;
...
int func_261(var uParam0)//Position - 0xFB9C
{
	if (func_221(uParam0))
	{
...
int func_262(int iParam0)//Position - 0xFBC6
{
	int iVar0;
...
void func_263(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xFBF7
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_264(var uParam0)//Position - 0xFC33
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_263(&(uParam0->f_48), "rcm_fanatic2", "ef_2_rcm__maryann_biking_maryann", 0);
			iLocal_89 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_258(&(uParam0->f_28[0]), 61, 809.66f, 1279.76f, 360.49f, 122.53f, "FANATIC LAUNCHER RC", 1))
				{
					bVar5 = false;
				}
			}
			...
			{
				func_268(&(uParam0->f_28[1]), iVar0[1], 808.43f, 1279.16f, 360.47f, -79.11f, 26);
				if (func_208(uParam0->f_28[1]))
				{
			...
			{
				func_266(&(uParam0->f_35[0]), iVar0[2], 808.35f, 1277.2f, 360.15f, 216.5f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_266(&(uParam0->f_35[1]), iVar0[2], 807.89f, 1275.73f, 360.18f, 208.2f);
			}
			if (bVar5)
			{
				iLocal_89 = 3;
		...
		case 3:
			...
			while (iVar4 <= 1)
			{
				if (func_208(uParam0->f_35[iVar4]))
				{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcm_fanatic2"))
			{
				if (func_208(uParam0->f_28[1]))
				{
					...
					func_300("Playing Mary Ann's friend anim...");
				}
			}
			func_265();
			iVar4 = 0;
...
void func_266(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFF78
{
	func_267(iParam0);
...
void func_267(int* iParam0)//Position - 0xFFBA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_268(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x10058
{
	func_269(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_269(int* iParam0)//Position - 0x10079
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_270(var uParam0)//Position - 0x100BA
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_263(&(uParam0->f_48), "rcmfanatic1", "ef_1_rcm_mary_ann_streching_base", 0);
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_258(&(uParam0->f_28[0]), 61, -1878.27f, -440.55f, 46.23f, 165.94f, "FANATIC LAUNCHER RC", 1))
				{
...
int func_271(int iParam0)//Position - 0x10215
{
	struct<27> Var0;
	bool bVar32;
...
int func_272(int iParam0)//Position - 0x10266
{
	char* sVar0;
...
int func_273(int iParam0)//Position - 0x1031F
{
	var uVar0;
...
int func_274(int iParam0)//Position - 0x103E0
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_275(int iParam0, char* sParam1)//Position - 0x10465
{
...
int func_276(int iParam0)//Position - 0x10547
{
...
int func_277(int iParam0)//Position - 0x10572
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_278(int iParam0)//Position - 0x1059D
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_279(int iParam0)//Position - 0x105C8
{
	if (func_249(iParam0))
	{
		return 0;
...
void func_280()//Position - 0x105FD
{
	func_300("Running end routines.");
	Global_113528 = (Global_113528 - 1);
}

int func_281(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10617
{
	int iVar0;
...
int func_282(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x1067C
{
	int iVar0;
	struct<7> Var1;
...
int func_283(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x106F4
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_284(int iParam0, bool bParam1)//Position - 0x1076F
{
	char* sVar0;
...
void func_285(char* sParam0)//Position - 0x10813
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_206(sParam0))
...
void func_286()//Position - 0x10832
{
	Global_20711 = 0;
	func_287();
}

void func_287()//Position - 0x10842
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22856 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_288(var uParam0)//Position - 0x10863
{
	if (func_221(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_289(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10899
{
...
void func_290(var uParam0, bool bParam1)//Position - 0x108B9
{
	func_291(&(uParam0->f_41), bParam1);
}

void func_291(var uParam0, bool bParam1)//Position - 0x108CB
{
	int iVar0;
...
void func_292(int* iParam0, bool bParam1)//Position - 0x10909
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_293(var uParam0, bool bParam1)//Position - 0x10944
{
	func_294(&(uParam0->f_35), bParam1);
}

void func_294(var uParam0, bool bParam1)//Position - 0x10956
{
	int iVar0;
...
void func_295(int* iParam0)//Position - 0x10993
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_296(var uParam0, int iParam1)//Position - 0x109CB
{
	func_297(&(uParam0->f_28), iParam1);
}

void func_297(var uParam0, int iParam1)//Position - 0x109DD
{
	int iVar0;
...
void func_298(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10A1E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_299(var uParam0)//Position - 0x10A6E
{
	if (*uParam0 == -1)
	{
		return;
...
void func_300(char* sParam0)//Position - 0x10AAB
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_301(var uParam0)//Position - 0x10ABD
{
	*uParam0 = -1;
...
void func_302()//Position - 0x10AF0
{
	func_300("Running start routines.");
	Global_113528++;
}

int func_303(int iParam0)//Position - 0x10B0A
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
