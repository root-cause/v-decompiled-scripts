...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112735[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_294(&(Global_112735[Var0.f_0 /*10*/].f_9));
			}
		}
		func_279(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_211(Var0.f_0);
		func_204(&iLocal_94, &(Var0.f_9), Var61);
		if (iLocal_95 == 0)
		{
			if (Var0.f_0 == 22)
			{
				...
				{
					if (func_203(Var0.f_28[1]))
					{
						func_295("Trying to set Mary Ann boyfriend component variation");
		...
		if (Var0.f_0 == 21)
		{
			func_200(&Var0, Var61, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		}
		else if (Var0.f_0 == 22)
		{
			func_195(&Var0, Var61, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		}
		else if (Var0.f_0 == 23)
		{
			if (iLocal_96 == 0)
			{
				if (func_200(&Var0, Var61, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
				{
					iLocal_96 = 1;
				}
			}
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x393C
{
	int iVar0;
	var uVar1;
...
int func_50(var uParam0)//Position - 0x3979
{
	int iVar0;
	int iVar1;
...
int func_51()//Position - 0x39AD
{
	return Global_1574918;
}

int func_52(int iParam0, int iParam1)//Position - 0x39B9
{
	int iVar0;
	var uVar1;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39E5
{
	int iVar0;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F2E
{
	int iVar0;
...
int func_55()//Position - 0x4172
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_56()//Position - 0x418B
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x4288
{
	return Global_43257 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x4296
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x4389
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x4611
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x46B2
{
...
int func_62(int iParam0, int iParam1)//Position - 0x488C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x54ED
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x5528
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x579C
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x57D8
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5D27
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5D6B
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x64EA
{
	if (bParam6)
	{
...
int func_70(var uParam0)//Position - 0x6531
{
...
bool func_71(int iParam0)//Position - 0x658C
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x659C
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x65FD
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x6996
{
	return Global_32163;
}

int func_75(int iParam0)//Position - 0x69A1
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x69B1
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x6A53
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_78()//Position - 0x71A3
{
...
int func_79()//Position - 0x749E
{
	return Global_2652258.f_2650;
}

int func_80(struct<3> Param0)//Position - 0x74AD
{
...
int func_81(int iParam0)//Position - 0x74D7
{
	if (iParam0 != func_90())
	{
...
Vector3 func_82(int iParam0, int iParam1)//Position - 0x752F
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_83(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x75D9
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_84(struct<3> Param0, float fParam3)//Position - 0x766E
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_85(int iParam0)//Position - 0x76B2
{
	struct<6> Var0;
...
struct<6> func_86(int iParam0)//Position - 0x7836
{
	return func_87(iParam0);
}

struct<6> func_87(int iParam0)//Position - 0x7844
{
	struct<6> Var0;
...
int func_88(int iParam0, var uParam1)//Position - 0x830E
{
	switch (iParam0)
	{
		case 0:
...
int func_89(int iParam0)//Position - 0x8390
{
	if (iParam0 != func_90())
	{
...
int func_90()//Position - 0x83E8
{
	return -1;
}

Vector3 func_91(int iParam0)//Position - 0x83F1
{
	switch (iParam0)
	{
		case 1:
...
int func_92()//Position - 0x8668
{
	return func_93(PLAYER::PLAYER_ID());
}

int func_93(int iParam0)//Position - 0x8678
{
	return MISC::GET_BITS_IN_RANGE(Global_2657589[iParam0 /*466*/].f_321.f_3, 28, 31);
}

int func_94(int iParam0)//Position - 0x8695
{
	return func_72(iParam0, 0, 0);
}

int func_95(int iParam0)//Position - 0x86A5
{
	switch (iParam0)
	{
		case -1:
...
bool func_96()//Position - 0x89CE
{
	return Global_100733.f_387 > 0;
}

var func_97()//Position - 0x89DF
{
	var uVar0;
...
void func_98(var uParam0, int iParam1)//Position - 0x8A25
{
	if (iParam1 <= 0)
	{
		return;
...
void func_99(var uParam0, int iParam1)//Position - 0x8AAB
{
...
void func_100(var uParam0, int iParam1)//Position - 0x8ADE
{
	int iVar0;
	int iVar1;
...
int func_101(int iParam0, int iParam1)//Position - 0x8B2F
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_102(int iParam0)//Position - 0x8BD1
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_103(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_103(bool bParam0, int iParam1, int iParam2)//Position - 0x8BF3
{
	if (bParam0)
	{
		return iParam1;
...
int func_104(var uParam0)//Position - 0x8C0A
{
	return uParam0 & 15;
}

void func_105(var uParam0, int iParam1)//Position - 0x8C17
{
...
void func_106(var uParam0, int iParam1)//Position - 0x8C51
{
...
void func_107(var uParam0, int iParam1)//Position - 0x8C8C
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_108()//Position - 0x8CC8
{
	func_56();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_109(int iParam0)//Position - 0x8CE1
{
	var uVar0;
	char cVar1[24];
...
bool func_110()//Position - 0x8D3A
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_111()//Position - 0x8D50
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_112(char* sParam0, int iParam1, int iParam2)//Position - 0x8D66
{
...
int func_113(bool bParam0)//Position - 0x8DA8
{
...
struct<2> func_114(int iParam0)//Position - 0x8DD0
{
	struct<2> Var0;
...
void func_115(int iParam0, var uParam1)//Position - 0x921D
{
	switch (iParam0)
	{
		case 0:
...
int func_117(int iParam0)//Position - 0xA4F5
{
	switch (iParam0)
	{
		case 0:
...
int func_118(var* uParam0)//Position - 0xA83B
{
	int iVar0;
...
void func_119(int iParam0)//Position - 0xA8E0
{
	struct<2> Var0;
...
void func_120(int iParam0)//Position - 0xA97B
{
	if (iParam0 < 63)
	{
		func_121();
...
void func_122(int iParam0)//Position - 0xA9D9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_123(int iParam0)//Position - 0xAA32
{
...
int func_124(int iParam0)//Position - 0xAAB5
{
	int iVar0;
...
void func_125(int iParam0, int iParam1, int iParam2)//Position - 0xAAE6
{
	func_126(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_126(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAAFB
{
	int iVar0;
...
int func_128(int iParam0, int iParam1, int iParam2)//Position - 0xABAE
{
...
int func_129(int iParam0, int iParam1, int iParam2)//Position - 0xABC9
{
	int iVar0;
...
int func_130(int iParam0)//Position - 0xAC15
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0xAC5E
{
	if (func_203(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_132(int iParam0)//Position - 0xAC7E
{
	switch (iParam0)
	{
		case 5:
...
int func_134(int iParam0)//Position - 0xAD4E
{
	switch (iParam0)
	{
		case 5:
...
void func_135(var uParam0, bool bParam1, bool bParam2)//Position - 0xADA1
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_203(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_203(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_203(uParam0->f_41[iVar0]))
		{
...
int func_136(int iParam0)//Position - 0xAE96
{
	switch (iParam0)
	{
		case 5:
...
void func_137(bool bParam0)//Position - 0xAF01
{
	int iVar0;
...
void func_138(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAF40
{
	if (bParam0)
	{
...
bool func_139()//Position - 0xB08D
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_140(int iParam0, int iParam1)//Position - 0xB0A7
{
	bool bVar0;
...
int func_141(int iParam0, bool bParam1)//Position - 0xB0F2
{
	int iVar0;
	int iVar1;
...
int func_142(int iParam0)//Position - 0xB133
{
...
bool func_143()//Position - 0xB172
{
	return BitTest(Global_2621446, 3);
}

int func_144(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB180
{
	int iVar0;
...
void func_146(int iParam0)//Position - 0xB1DA
{
	if (iParam0 == 1)
	{
...
int func_147(char* sParam0)//Position - 0xB1FD
{
...
void func_148()//Position - 0xB23A
{
	Global_20591 = 0;
	func_149();
}

void func_149()//Position - 0xB24A
{
...
int func_153(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB330
{
...
void func_154(int iParam0)//Position - 0xB4C8
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_156(int iParam0)//Position - 0xB545
{
	if (func_161())
	{
		return;
...
void func_157(int iParam0)//Position - 0xB578
{
	if (func_161())
	{
		return;
...
void func_158(bool bParam0, bool bParam1)//Position - 0xB602
{
	if (bParam0)
	{
		if (func_160(0))
...
bool func_159()//Position - 0xB676
{
	return BitTest(Global_1962996, 5);
}

int func_160(int iParam0)//Position - 0xB684
{
	if (iParam0 == 1)
	{
...
bool func_161()//Position - 0xB6DB
{
	return BitTest(Global_1962996, 19);
}

int func_162(int iParam0)//Position - 0xB6EA
{
...
int func_163(int iParam0)//Position - 0xB72B
{
	int iVar0;
...
void func_164(int iParam0)//Position - 0xB770
{
...
int func_165(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB7A2
{
	int iVar0;
...
void func_166(var uParam0, int iParam1)//Position - 0xB8D9
{
	int iVar0;
...
bool func_167(int iParam0)//Position - 0xB928
{
	return func_168(iParam0, Global_43257);
}

int func_168(int iParam0, int iParam1)//Position - 0xB939
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_169(int iParam0)//Position - 0xBB1A
{
	if (Global_43257 == 15)
	{
		return 0;
...
int func_170()//Position - 0xBB3C
{
	return func_171(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_171(char* sParam0, int iParam1)//Position - 0xBB4D
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_173(int iParam0, int iParam1)//Position - 0xBBBA
{
	switch (iParam0)
	{
		case 0:
...
int func_174(struct<3> Param0, bool bParam3)//Position - 0xC02B
{
	int iVar0;
...
float func_175(bool bParam0, float fParam1, float fParam2)//Position - 0xC057
{
	if (bParam0)
	{
		return fParam1;
...
int func_176(int iParam0)//Position - 0xC06E
{
	switch (iParam0)
	{
		case 0:
...
int func_177(int iParam0, int iParam1)//Position - 0xC0FD
{
	switch (iParam0->f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
				...
				else if (func_203(iParam0->f_28[0]))
				{
					if (func_179(iParam0))
					{
						if (func_183(2))
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_203(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
					{
...
void func_178()//Position - 0xC8E0
{
	func_27(&(Global_104212.f_2890), &Global_104212, 0, 1, 1, 0);
}

int func_179(var uParam0)//Position - 0xC8FB
{
	float fVar0;
...
void func_180(int iParam0, int iParam1)//Position - 0xC989
{
	if (iParam0 == 1)
	{
		if (!func_134(iParam1))
...
int func_181(bool bParam0)//Position - 0xC9ED
{
	int iVar0;
...
int func_182(int iParam0)//Position - 0xCA84
{
	if (func_203(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_183(int iParam0)//Position - 0xCAAE
{
	bool bVar0;
...
var func_184()//Position - 0xD1CB
{
	return Global_100720.f_1;
}

int func_185()//Position - 0xD1D9
{
	if (Global_97603 != -1)
	{
...
bool func_188()//Position - 0xD240
{
	return Global_100733.f_388 > 0;
}

var func_189(int iParam0, int iParam1)//Position - 0xD251
{
	switch (iParam0)
	{
		case 5:
...
var func_190()//Position - 0xD289
{
	return Global_1575060;
}

int func_191()//Position - 0xD295
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_192(int iParam0)//Position - 0xD2B1
{
	if (iLocal_97 == -1)
	{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_97) >= 900)
	{
		if (func_203(iParam0->f_28[0]))
		{
			if (!func_150())
			{
				func_193(iParam0->f_28[0], "PUSHUP_BREATH", "MARYANN", 6);
				iLocal_97 = MISC::GET_GAME_TIMER();
			}
		}
	}
...
void func_193(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xD301
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_194(iParam3), false);
}

int func_194(int iParam0)//Position - 0xD31A
{
	int iVar0;
...
int func_195(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD50F
{
	var uVar0;
	
	if ((((func_203(PLAYER::PLAYER_PED_ID()) && func_203(iParam0->f_28[0])) && !func_150()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_199(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_196(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD597
{
...
void func_197(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD5D2
{
...
void func_198(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD628
{
...
float func_199(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD6C3
{
	struct<3> Var0;
...
int func_200(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)//Position - 0xD6FD
{
	var uVar0;
	...
	if (func_183(2))
	{
		if (!func_150())
		{
			if (((func_203(PLAYER::PLAYER_PED_ID()) && func_203(iParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_199(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_198(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
				func_196(&uVar0, cParam4, sParam5, 7, 0, 0);
...
int func_201(char* sParam0)//Position - 0xD7BF
{
	struct<6> Var0;
...
struct<6> func_202()//Position - 0xD7DF
{
	struct<6> Var0;
...
int func_203(int iParam0)//Position - 0xD803
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_204(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD824
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_205(int iParam0, bool bParam1)//Position - 0xD915
{
	if (iParam0 == -1)
	{
		return;
...
int func_206(int iParam0)//Position - 0xD951
{
	if (Global_78554 == iParam0)
	{
		if (Global_78555 == -1)
...
void func_207(int iParam0, int iParam1)//Position - 0xD98A
{
	bool bVar0;
	int iVar1;
...
bool func_208()//Position - 0xDA28
{
	return Global_97990;
}

void func_209(int iParam0)//Position - 0xDA34
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_210(iParam0);
...
void func_210(int iParam0)//Position - 0xDA4B
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_211(int iParam0)//Position - 0xDB33
{
	if (iParam0 == -1)
	{
		iParam0 = func_170();
...
int func_212(var uParam0, bool bParam1)//Position - 0xDB5B
{
	struct<27> Var0;
	...
	if ((func_249(*uParam0) || func_247(*uParam0)) || Global_78804 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_213(int iParam0, var uParam1, int iParam2)//Position - 0xDDCB
{
	int iVar0;
	int iVar1;
...
int func_214(int iParam0)//Position - 0xE123
{
...
int func_215(var uParam0)//Position - 0xE143
{
...
int func_216(var uParam0)//Position - 0xE15B
{
...
void func_217(var uParam0)//Position - 0xE180
{
	int iVar0;
	int iVar1;
...
void func_218(int* iParam0)//Position - 0xE484
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_219(var uParam0)//Position - 0xE4AF
{
	int iVar0;
...
int func_220(var uParam0, bool bParam1, bool bParam2)//Position - 0xE52F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_221(int iParam0, int iParam1)//Position - 0xE6ED
{
	int iVar0;
...
int func_222(var uParam0, bool bParam1, int iParam2)//Position - 0xE71D
{
	int iVar0;
	int iVar1;
...
int func_223(int iParam0)//Position - 0xE9D9
{
...
int func_224(int iParam0, float fParam1)//Position - 0xEA0D
{
	float fVar0;
	
	if (func_203(PLAYER::PLAYER_PED_ID()) && func_203(iParam0))
	{
...
bool func_225(int iParam0, float fParam1)//Position - 0xEA83
{
	return func_226(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_226(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEA9B
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!func_203(iParam0) || !func_203(iParam1))
	{
		if (iVar4 != -1)
		{
			func_233(&(Local_37[iVar4 /*4*/]));
		}
		return 0;
	}
...
int func_227(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xEB5C
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_228(int iParam0, int iParam1)//Position - 0xEC88
{
	int iVar0;
...
int func_230(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xED97
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_231(struct<3> Param0, struct<3> Param3)//Position - 0xEE28
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_232(struct<3> Param0)//Position - 0xEE49
{
	float fVar0;
	float fVar1;
...
void func_233(var uParam0)//Position - 0xEE88
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_234(int iParam0, int iParam1)//Position - 0xEEA3
{
	int iVar0;
...
int func_235(int iParam0)//Position - 0xEEE2
{
...
int func_236(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEF0A
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_237(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF005
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_238(int iParam0, float fParam1)//Position - 0xF111
{
	var uVar0;
	struct<3> Var1;
...
int func_239(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF1A6
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_240(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF234
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_241(int iParam0)//Position - 0xF27C
{
...
void func_242(int iParam0)//Position - 0xF2C6
{
	int iVar0;
...
int func_243(int iParam0)//Position - 0xF363
{
	if (iParam0 == -1)
	{
		iParam0 = func_170();
...
int func_244(int iParam0)//Position - 0xF3F8
{
...
int func_247(int iParam0)//Position - 0xF477
{
	if ((func_248() && Global_100681.f_11 == 6) && iParam0 == func_171(&(Global_100681.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_249(int iParam0)//Position - 0xF4E9
{
	if (func_113(0))
	{
...
int func_250(int iParam0)//Position - 0xF511
{
	switch (*iParam0)
	{
		case 21:
...
int func_252(var uParam0)//Position - 0xF5C4
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_258(&(uParam0->f_48), "rcmfanatic3", "ef_3_rcm_loop_maryann", 0);
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_257(&iVar0) || !func_256(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				if (func_253(&(uParam0->f_28[0]), 61, -915.6f, 6139.192f, 5.525f, 111.24f, "FANATIC LAUNCHER RC", 1))
				{
...
int func_253(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF984
{
...
int func_254(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF9E0
{
	int iVar0;
...
int func_255(var uParam0, int iParam1)//Position - 0xFA6E
{
	int iVar0;
...
int func_256(var uParam0)//Position - 0xFAB4
{
	if (func_216(uParam0))
	{
...
int func_257(int iParam0)//Position - 0xFADE
{
	int iVar0;
...
void func_258(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xFB0F
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_259(var uParam0)//Position - 0xFB4B
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_258(&(uParam0->f_48), "rcm_fanatic2", "ef_2_rcm__maryann_biking_maryann", 0);
			iLocal_91 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_253(&(uParam0->f_28[0]), 61, 809.66f, 1279.76f, 360.49f, 122.53f, "FANATIC LAUNCHER RC", 1))
				{
					bVar5 = false;
				}
			}
			...
			{
				func_263(&(uParam0->f_28[1]), iVar0[1], 808.43f, 1279.16f, 360.47f, -79.11f, 26);
				if (func_203(uParam0->f_28[1]))
				{
			...
			{
				func_261(&(uParam0->f_35[0]), iVar0[2], 808.35f, 1277.2f, 360.15f, 216.5f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_261(&(uParam0->f_35[1]), iVar0[2], 807.89f, 1275.73f, 360.18f, 208.2f);
			}
			if (bVar5)
			{
				iLocal_91 = 3;
		...
		case 3:
			...
			while (iVar4 <= 1)
			{
				if (func_203(uParam0->f_35[iVar4]))
				{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcm_fanatic2"))
			{
				if (func_203(uParam0->f_28[1]))
				{
					...
					func_295("Playing Mary Ann's friend anim...");
				}
			}
			func_260();
			iVar4 = 0;
...
void func_261(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFE90
{
	func_262(iParam0);
...
void func_262(int* iParam0)//Position - 0xFED2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_263(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xFF6E
{
	func_264(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_264(int* iParam0)//Position - 0xFF8F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_265(var uParam0)//Position - 0xFFD0
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_258(&(uParam0->f_48), "rcmfanatic1", "ef_1_rcm_mary_ann_streching_base", 0);
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_253(&(uParam0->f_28[0]), 61, -1878.27f, -440.55f, 46.23f, 165.94f, "FANATIC LAUNCHER RC", 1))
				{
...
int func_266(int iParam0)//Position - 0x1012B
{
	struct<27> Var0;
	bool bVar32;
...
int func_267(int iParam0)//Position - 0x1017C
{
	char* sVar0;
...
int func_268(int iParam0)//Position - 0x10235
{
	var uVar0;
...
int func_269(int iParam0)//Position - 0x102F6
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_270(int iParam0, char* sParam1)//Position - 0x1037B
{
...
int func_271(int iParam0)//Position - 0x1045D
{
...
int func_272(int iParam0)//Position - 0x10488
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_273(int iParam0)//Position - 0x104B3
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_274(int iParam0)//Position - 0x104DE
{
	if (func_244(iParam0))
	{
		return 0;
...
void func_275()//Position - 0x10513
{
	func_295("Running end routines.");
	Global_113366 = (Global_113366 - 1);
}

int func_276(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x1052D
{
	int iVar0;
...
int func_277(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10592
{
	int iVar0;
	struct<7> Var1;
...
int func_278(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x1060A
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_279(int iParam0, bool bParam1)//Position - 0x10685
{
	char* sVar0;
...
void func_280(char* sParam0)//Position - 0x10729
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_201(sParam0))
...
void func_281()//Position - 0x10748
{
	Global_20591 = 0;
	func_282();
}

void func_282()//Position - 0x10758
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_283(var uParam0)//Position - 0x10779
{
	if (func_216(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_284(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x107AF
{
...
void func_285(var uParam0, bool bParam1)//Position - 0x107CF
{
	func_286(&(uParam0->f_41), bParam1);
}

void func_286(var uParam0, bool bParam1)//Position - 0x107E1
{
	int iVar0;
...
void func_287(int* iParam0, bool bParam1)//Position - 0x1081F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_288(var uParam0, bool bParam1)//Position - 0x1085A
{
	func_289(&(uParam0->f_35), bParam1);
}

void func_289(var uParam0, bool bParam1)//Position - 0x1086C
{
	int iVar0;
...
void func_290(int* iParam0)//Position - 0x108A9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_291(var uParam0, int iParam1)//Position - 0x108E1
{
	func_292(&(uParam0->f_28), iParam1);
}

void func_292(var uParam0, int iParam1)//Position - 0x108F3
{
	int iVar0;
...
void func_293(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10934
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_294(var uParam0)//Position - 0x10984
{
	if (*uParam0 == -1)
	{
		return;
...
void func_295(char* sParam0)//Position - 0x109C1
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_296(var uParam0)//Position - 0x109D3
{
	*uParam0 = -1;
...
void func_297()//Position - 0x10A06
{
	func_295("Running start routines.");
	Global_113366++;
}

int func_298(int iParam0)//Position - 0x10A20
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
