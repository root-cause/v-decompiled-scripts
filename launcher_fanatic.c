...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		func_211(Var0.f_0);
		func_204(&iLocal_54, &(Var0.f_9), Var1);
		if (iLocal_55 == 0)
		{
			if (Var0.f_0 == 22)
			{
		...
		if (Var0.f_0 == 21)
		{
			func_200(&Var0, Var1, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		}
		else if (Var0.f_0 == 22)
		{
			func_195(&Var0, Var1, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		}
		else if (Var0.f_0 == 23)
		{
			if (iLocal_56 == 0)
			{
				if (func_200(&Var0, Var1, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
				{
					iLocal_56 = 1;
				}
			}
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5D27
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x64EA
{
	if (bParam2)
	{
...
int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x69B1
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_84(struct<3> Param0, float fParam1)//Position - 0x766E
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
int func_174(struct<3> Param0, bool bParam1)//Position - 0xC02B
{
	int iVar0;
...
int func_195(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xD50F
{
	var uVar0;
	
	if ((((func_203(PLAYER::PLAYER_PED_ID()) && func_203(iParam0->f_28[0])) && !func_150()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_199(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_199(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xD6C3
{
	struct<3> Var0;
...
int func_200(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)//Position - 0xD6FD
{
	var uVar0;
	...
	if (func_183(2))
	{
		if (!func_150())
		{
			if (((func_203(PLAYER::PLAYER_PED_ID()) && func_203(iParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_199(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_198(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
				func_196(&uVar0, cParam2, sParam3, 7, 0, 0);
...
bool func_226(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEA9B
{
	...
	uVar0 = func_227(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_227(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xEB5C
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_230(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xED97
{
	...
	{
		Var1 = { func_232(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_231(struct<3> Param0, struct<3> Param1)//Position - 0xEE28
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_239(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xF1A6
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_253(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xF984
{
	if (func_254(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_254(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xF9E0
{
	int iVar0;
...
int func_259(var uParam0)//Position - 0xFB4B
{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			...
			while (iVar1 <= 1)
			{
				if (func_203(uParam0->f_35[iVar1]))
				{
...
void func_261(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xFE90
{
	func_262(iParam0);
...
void func_263(int* iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0xFF6E
{
	func_264(iParam0);
...
int func_276(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x1052D
{
	int iVar0;
...
int func_277(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0x10592
{
	int iVar0;
	struct<7> Var1;
...
int func_278(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x1060A
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
