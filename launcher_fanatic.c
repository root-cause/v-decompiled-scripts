...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113222[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_301(&(Global_113222[Var0.f_0 /*10*/].f_9));
			}
		}
		func_286(&Var0, 1);
	}
	if (!func_283(&iVar64, &Var0, Var61, 1f))
	{
		func_282();
	...
	while (true)
	{
		...
		func_218(Var0.f_0);
		func_211(&iLocal_92, &(Var0.f_9), Var61);
		if (iLocal_93 == 0)
		{
			if (Var0.f_0 == 22)
			{
		...
		if (Var0.f_0 == 21)
		{
			func_207(&Var0, Var61, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		}
		else if (Var0.f_0 == 22)
		{
			func_202(&Var0, Var61, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		}
		else if (Var0.f_0 == 23)
		{
			if (iLocal_94 == 0)
			{
				if (func_207(&Var0, Var61, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
				{
					iLocal_94 = 1;
				}
			}
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5E71
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6634
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x667B
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x66E6
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6B08
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6B18
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x763E
{
...
Vector3 func_84(struct<3> Param0)//Position - 0x7680
{
...
int func_86(int iParam0)//Position - 0x76AC
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x77AE
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x7843
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_93(int iParam0, var uParam1)//Position - 0x84E2
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0)//Position - 0x8564
{
	if (iParam0 != func_95())
	{
...
int func_99(int iParam0)//Position - 0x8879
{
...
var func_107(int iParam0)//Position - 0x8DCF
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8DF1
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8E08
{
	return uParam0 & 15;
}
...
void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x8F6E
{
...
int func_118(bool bParam0)//Position - 0x8FB0
{
...
int func_123(var* uParam0)//Position - 0xAA43
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xADB6
{
...
int func_136(int iParam0)//Position - 0xAE66
{
	if (func_210(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xAE86
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xAF56
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xAFA9
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xB09F
{
	switch (iParam0)
	{
		case 5:
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB149
{
	if (bParam0)
	{
...
int func_147(var uParam0)//Position - 0xB34C
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB36E
{
...
int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB3BB
{
	int iVar0;
...
int func_153(char* sParam0)//Position - 0xB438
{
...
int func_159(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB56B
{
...
void func_160(int iParam0)//Position - 0xB5C2
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_167(int iParam0)//Position - 0xB8CF
{
	if (iParam0 == 1)
	{
...
int func_170(int iParam0)//Position - 0xB976
{
	int iVar0;
...
int func_172(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB9ED
{
	int iVar0;
...
void func_173(var uParam0, int iParam1)//Position - 0xBB24
{
	int iVar0;
...
bool func_174(int iParam0)//Position - 0xBB73
{
	return func_175(iParam0, Global_44181);
}

int func_175(int iParam0, int iParam1)//Position - 0xBB84
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_176(int iParam0)//Position - 0xBD65
{
	if (Global_44181 == 15)
	{
		return 0;
...
int func_178(char* sParam0, int iParam1)//Position - 0xBD98
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_180(int iParam0, int iParam1)//Position - 0xBE05
{
	switch (iParam0)
	{
		case 0:
...
int func_181(struct<3> Param0, bool bParam3)//Position - 0xC277
{
	int iVar0;
...
float func_182(bool bParam0, float fParam1, float fParam2)//Position - 0xC2A3
{
	if (bParam0)
	{
		return fParam1;
...
int func_183(int iParam0)//Position - 0xC2BA
{
	switch (iParam0)
	{
		case 0:
...
int func_184(int iParam0, int iParam1)//Position - 0xC349
{
	switch (iParam0->f_16)
	{
		case 0:
...
int func_186(var uParam0)//Position - 0xCB47
{
	float fVar0;
...
void func_187(int iParam0, int iParam1)//Position - 0xCBD5
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_188(bool bParam0)//Position - 0xCC39
{
	int iVar0;
...
int func_189(int iParam0)//Position - 0xCCD0
{
	if (func_210(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_190(int iParam0)//Position - 0xCCFA
{
	bool bVar0;
...
var func_191()//Position - 0xD417
{
	return Global_101727.f_1;
}

int func_192()//Position - 0xD425
{
	if (Global_98585 != -1)
	{
...
var func_196(int iParam0, int iParam1)//Position - 0xD49D
{
	switch (iParam0)
	{
		case 5:
...
var func_197()//Position - 0xD4D5
{
	return Global_1575084;
}

int func_198()//Position - 0xD4E1
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_199(int iParam0)//Position - 0xD4FD
{
	if (iLocal_95 == -1)
	{
...
void func_200(int iParam0, char* sParam1, char* sParam2, int iParam3, bool bParam4)//Position - 0xD54E
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_201(iParam3), bParam4);
}

int func_201(int iParam0)//Position - 0xD568
{
	int iVar0;
...
int func_202(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD75D
{
	var uVar0;
	
	if ((((func_210(PLAYER::PLAYER_PED_ID()) && func_210(iParam0->f_28[0])) && !func_156()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_206(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_203(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD7E5
{
...
void func_205(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD876
{
...
float func_206(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD911
{
	struct<3> Var0;
...
int func_207(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)//Position - 0xD94B
{
	var uVar0;
	...
	if (func_190(2))
	{
		if (!func_156())
		{
			if (((func_210(PLAYER::PLAYER_PED_ID()) && func_210(iParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_206(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_205(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
				func_203(&uVar0, cParam4, sParam5, 7, 0, 0);
		...
		else if (func_208(sParam5))
		{
			...
			{
				if (func_206(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
				{
					func_154();
				}
			}
...
int func_208(char* sParam0)//Position - 0xDA0D
{
	struct<6> Var0;
...
int func_210(int iParam0)//Position - 0xDA51
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_211(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xDA72
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_214(int iParam0, int iParam1)//Position - 0xDBD8
{
	bool bVar0;
	int iVar1;
...
void func_217(int iParam0)//Position - 0xDC99
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_219(var uParam0, bool bParam1)//Position - 0xDDA9
{
	struct<27> Var0;
	...
	if ((func_256(*uParam0) || func_254(*uParam0)) || Global_79785 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_220(int iParam0, var uParam1, int iParam2)//Position - 0xE019
{
	...
	if (func_210(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_222(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_221(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_222(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_221(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
int func_221(int iParam0)//Position - 0xE371
{
...
int func_222(var uParam0)//Position - 0xE391
{
...
int func_223(var uParam0)//Position - 0xE3A9
{
...
void func_225(int* iParam0)//Position - 0xE6D2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_227(var uParam0, bool bParam1, bool bParam2)//Position - 0xE77D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_228(int iParam0, int iParam1)//Position - 0xE93B
{
	int iVar0;
...
int func_229(var uParam0, bool bParam1, int iParam2)//Position - 0xE96B
{
	int iVar0;
	int iVar1;
...
int func_230(int iParam0)//Position - 0xEC27
{
...
int func_231(int iParam0, float fParam1)//Position - 0xEC5B
{
	float fVar0;
...
bool func_232(int iParam0, float fParam1)//Position - 0xECD1
{
	return func_233(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_233(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xECE9
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_234(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xEDAA
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_235(int iParam0, int iParam1)//Position - 0xEED6
{
	int iVar0;
...
int func_237(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEFE5
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_238(struct<3> Param0, struct<3> Param3)//Position - 0xF076
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_239(struct<3> Param0)//Position - 0xF097
{
	float fVar0;
	float fVar1;
...
int func_241(int iParam0, int iParam1)//Position - 0xF0F1
{
	int iVar0;
...
int func_242(int iParam0)//Position - 0xF130
{
...
int func_243(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF158
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_244(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF253
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_245(int iParam0, float fParam1)//Position - 0xF35F
{
	var uVar0;
	struct<3> Var1;
...
int func_246(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF3F4
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_247(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF482
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_248(int iParam0)//Position - 0xF4CA
{
...
void func_249(int iParam0)//Position - 0xF514
{
	int iVar0;
...
int func_250(int iParam0)//Position - 0xF5B1
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_251(int iParam0)//Position - 0xF646
{
...
int func_254(int iParam0)//Position - 0xF6C5
{
...
int func_256(int iParam0)//Position - 0xF737
{
	if (func_118(0))
	{
...
int func_257(int iParam0)//Position - 0xF75F
{
	switch (*iParam0)
	{
		case 21:
...
int func_259(var uParam0)//Position - 0xF813
{
	int iVar0[5];
	int iVar6;
	bool bVar7;
...
int func_260(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xFBD3
{
	if (func_261(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_261(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xFC2F
{
	int iVar0;
...
int func_262(var uParam0, int iParam1)//Position - 0xFCBD
{
	int iVar0;
...
int func_263(var uParam0)//Position - 0xFD03
{
	if (func_223(uParam0))
	{
...
int func_264(int iParam0)//Position - 0xFD2D
{
	int iVar0;
...
int func_266(var uParam0)//Position - 0xFD9A
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_89)
	{
		...
		case 3:
			...
			while (iVar4 <= 1)
			{
				if (func_210(uParam0->f_35[iVar4]))
				{
...
void func_268(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x100E1
{
	func_269(iParam0);
...
void func_269(int* iParam0)//Position - 0x10124
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_270(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x101C0
{
	func_271(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_271(int* iParam0)//Position - 0x101E1
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_272(var uParam0)//Position - 0x10222
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
...
int func_273(int iParam0)//Position - 0x1037D
{
	struct<27> Var0;
	bool bVar32;
...
int func_274(int iParam0)//Position - 0x103CE
{
	char* sVar0;
...
int func_275(int iParam0)//Position - 0x10487
{
	var uVar0;
...
int func_276(int iParam0)//Position - 0x10548
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_278(int iParam0)//Position - 0x106AF
{
...
int func_279(int iParam0)//Position - 0x106DA
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_280(int iParam0)//Position - 0x10705
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_281(int iParam0)//Position - 0x10730
{
	if (func_251(iParam0))
	{
		return 0;
...
int func_283(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x1077F
{
	int iVar0;
...
int func_284(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x107E4
{
	int iVar0;
	struct<7> Var1;
...
int func_285(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x1085C
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_286(int iParam0, bool bParam1)//Position - 0x108D7
{
	char* sVar0;
...
void func_294(int* iParam0, bool bParam1)//Position - 0x10A71
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_297(int* iParam0)//Position - 0x10AFB
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_300(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10B86
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_301(var uParam0)//Position - 0x10BD6
{
	if (*uParam0 == -1)
	{
		return;
...
int func_305(int iParam0)//Position - 0x10C72
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
