...
void __EntryFunction__()//Position - 0x0
{
	...
	if (!func_282(&iVar64, &Var0, Var61, 1f))
	{
		func_281();
	...
	while (true)
	{
		...
		func_217(Var0.f_0);
		func_210(&iLocal_92, &(Var0.f_9), Var61);
		if (iLocal_93 == 0)
		{
			if (Var0.f_0 == 22)
			{
		...
		if (Var0.f_0 == 21)
		{
			func_206(&Var0, Var61, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		}
		else if (Var0.f_0 == 22)
		{
			func_201(&Var0, Var61, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		}
		else if (Var0.f_0 == 23)
		{
			if (iLocal_94 == 0)
			{
				if (func_206(&Var0, Var61, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
				{
					iLocal_94 = 1;
				}
			}
...
int func_1(int iParam0)//Position - 0x2DA
{
...
int func_2(int iParam0)//Position - 0x2F8
{
	struct<4> Var0;
	char* sVar32;
...
void func_3(int iParam0, char* sParam1)//Position - 0x3BA
{
	func_21(sParam1);
...
void func_17(int iParam0)//Position - 0xC7A
{
...
void func_21(char* sParam0)//Position - 0xD33
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xD46
{
	MISC::CLEAR_BIT(&(Global_101392.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xD63
{
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x296F
{
...
int func_29(int iParam0)//Position - 0x29AF
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x29DD
{
...
int func_31(int iParam0)//Position - 0x2AB9
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2AFB
{
	int iVar0;
...
int func_33(int iParam0, bool bParam1, int iParam2)//Position - 0x2B5E
{
	int iVar0;
...
int func_34(bool bParam0, int iParam1)//Position - 0x2BEC
{
	struct<82> Var0;
...
void func_35(bool bParam0, var uParam1, int iParam2)//Position - 0x2C2E
{
	int iVar0;
...
bool func_36(bool bParam0)//Position - 0x2E8A
{
	return bParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E96
{
	int iVar0;
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x31F1
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x33E4
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x34B5
{
	char* sVar0;
...
int func_43(int iParam0, bool bParam1, bool bParam2)//Position - 0x35E4
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3652
{
...
int func_45(int iParam0)//Position - 0x372B
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x3768
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x378D
{
...
int func_50(int iParam0, var uParam1)//Position - 0x3965
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(uParam1));
}

int func_51(var uParam0)//Position - 0x397A
{
	int iVar0;
	int iVar1;
...
int func_53(int iParam0, int iParam1)//Position - 0x39BA
{
	int iVar0;
	var uVar1;
...
int func_54(int iParam0, var uParam1)//Position - 0x39DE
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(uParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39F3
{
	int iVar0;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F3C
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x461D
{
	switch (iParam0)
	{
...
int func_63(int iParam0)//Position - 0x46BE
{
...
int func_64(int iParam0, int iParam1)//Position - 0x48AA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x55CB
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x5606
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x587A
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x58B6
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5E05
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5E49
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x65C8
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x660F
{
...
bool func_73(int iParam0)//Position - 0x666A
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x667A
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x66DA
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x6A82
{
	return Global_32828;
}

int func_77(int iParam0)//Position - 0x6A8D
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A9D
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6B3F
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x72AA
{
...
int func_81()//Position - 0x75A5
{
	return Global_2652572.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x75B4
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x75DE
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x75F3
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x760A
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x7662
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x770C
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x77A1
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x77E5
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x7969
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x7977
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x843F
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x84C1
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x8519
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x8522
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x878E
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x879E
{
	return MISC::GET_BITS_IN_RANGE(Global_2657921[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x87BB
{
	return func_74(iParam0, 0, 0);
}

int func_99(int iParam0)//Position - 0x87CB
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x8B01
{
	return Global_101444.f_393 > 0;
}

var func_101()//Position - 0x8B12
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8B58
{
	if (iParam1 <= 0)
	{
		return;
...
void func_104(var uParam0, int iParam1)//Position - 0x8C11
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x8C62
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8D04
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8D26
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8D3D
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8D4A
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8D84
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8DBF
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8DFB
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8E14
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8E6D
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8E83
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8E99
{
...
int func_117(bool bParam0)//Position - 0x8EDB
{
...
struct<2> func_118(int iParam0)//Position - 0x8F03
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x9350
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA628
{
	switch (iParam0)
	{
		case 0:
...
int func_122(var* uParam0)//Position - 0xA96E
{
	int iVar0;
...
void func_123(int iParam0)//Position - 0xAA13
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xAAAE
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xAB0C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xAB65
{
...
int func_128(int iParam0)//Position - 0xABE8
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAC19
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAC2E
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xACE1
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xACFC
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xAD48
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xAD91
{
	if (func_209(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xADB1
{
	switch (iParam0)
	{
		case 5:
...
int func_138(int iParam0)//Position - 0xAE81
{
	switch (iParam0)
	{
		case 5:
...
void func_139(var uParam0, bool bParam1, bool bParam2)//Position - 0xAED4
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_209(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_209(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_209(uParam0->f_41[iVar0]))
		{
...
int func_140(int iParam0)//Position - 0xAFC9
{
	switch (iParam0)
	{
		case 5:
...
void func_141(bool bParam0)//Position - 0xB034
{
	int iVar0;
...
void func_142(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB073
{
	if (bParam0)
	{
...
bool func_143()//Position - 0xB1C0
{
	return BitTest(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

bool func_144(int iParam0, int iParam1)//Position - 0xB1DA
{
	bool bVar0;
...
int func_145(int iParam0, bool bParam1)//Position - 0xB233
{
	int iVar0;
	int iVar1;
...
int func_146(var uParam0)//Position - 0xB274
{
	int iVar0;
...
int func_147(int iParam0)//Position - 0xB296
{
...
bool func_148()//Position - 0xB2D5
{
	return BitTest(Global_2621446, 3);
}

int func_149(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB2E3
{
	int iVar0;
...
void func_151(int iParam0)//Position - 0xB33D
{
	if (iParam0 == 1)
	{
...
int func_152(char* sParam0)//Position - 0xB360
{
...
void func_153()//Position - 0xB39D
{
	Global_21032 = 0;
	func_154();
}

void func_154()//Position - 0xB3AD
{
...
int func_158(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB493
{
...
void func_159(int iParam0)//Position - 0xB4EA
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_160(bool bParam0, bool bParam1)//Position - 0xB516
{
...
void func_162(int iParam0)//Position - 0xB6B8
{
	if (func_167())
	{
		return;
...
void func_163(int iParam0)//Position - 0xB6EB
{
	if (func_167())
	{
		return;
...
void func_164(bool bParam0, bool bParam1)//Position - 0xB775
{
	if (bParam0)
	{
		if (func_166(0))
...
bool func_165()//Position - 0xB7E9
{
	return BitTest(Global_1956030, 5);
}

int func_166(int iParam0)//Position - 0xB7F7
{
	if (iParam0 == 1)
	{
...
bool func_167()//Position - 0xB84E
{
	return BitTest(Global_1956030, 19);
}

int func_168(int iParam0)//Position - 0xB85D
{
...
int func_169(int iParam0)//Position - 0xB89E
{
	int iVar0;
...
void func_170(int iParam0)//Position - 0xB8E3
{
...
int func_171(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB915
{
	int iVar0;
...
void func_172(var uParam0, int iParam1)//Position - 0xBA4C
{
	int iVar0;
...
bool func_173(int iParam0)//Position - 0xBA9B
{
	return func_174(iParam0, Global_43922);
}

int func_174(int iParam0, int iParam1)//Position - 0xBAAC
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_175(int iParam0)//Position - 0xBC8D
{
	if (Global_43922 == 15)
	{
		return 0;
...
int func_176()//Position - 0xBCAF
{
	return func_177(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_177(char* sParam0, int iParam1)//Position - 0xBCC0
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_179(int iParam0, int iParam1)//Position - 0xBD2D
{
	switch (iParam0)
	{
		case 0:
...
int func_180(struct<3> Param0, bool bParam3)//Position - 0xC19D
{
	int iVar0;
...
float func_181(bool bParam0, float fParam1, float fParam2)//Position - 0xC1C9
{
	if (bParam0)
	{
		return fParam1;
...
int func_182(int iParam0)//Position - 0xC1E0
{
	switch (iParam0)
	{
		case 0:
...
int func_183(int iParam0, int iParam1)//Position - 0xC26F
{
	switch (iParam0->f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
				...
				else if (func_209(iParam0->f_28[0]))
				{
					if (func_185(iParam0))
					{
						if (func_189(2))
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_209(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
					{
...
void func_184()//Position - 0xCA52
{
	func_27(&(Global_104933.f_2890), &Global_104933, 0, 1, 1, 0);
}

int func_185(var uParam0)//Position - 0xCA6D
{
	float fVar0;
...
void func_186(int iParam0, int iParam1)//Position - 0xCAFB
{
	if (iParam0 == 1)
	{
		if (!func_138(iParam1))
...
int func_187(bool bParam0)//Position - 0xCB5F
{
	int iVar0;
...
int func_188(int iParam0)//Position - 0xCBF6
{
	if (func_209(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_189(int iParam0)//Position - 0xCC20
{
	bool bVar0;
...
var func_190()//Position - 0xD33D
{
	return Global_101431.f_1;
}

int func_191()//Position - 0xD34B
{
	if (Global_98294 != -1)
	{
...
bool func_194()//Position - 0xD3B2
{
	return Global_101444.f_394 > 0;
}

var func_195(int iParam0, int iParam1)//Position - 0xD3C3
{
	switch (iParam0)
	{
		case 5:
...
var func_196()//Position - 0xD3FB
{
	return Global_1575079;
}

int func_197()//Position - 0xD407
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_198(int iParam0)//Position - 0xD423
{
	if (iLocal_95 == -1)
	{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_95) >= 900)
	{
		if (func_209(iParam0->f_28[0]))
		{
			if (!func_155())
			{
				func_199(iParam0->f_28[0], "PUSHUP_BREATH", "MARYANN", 6);
				iLocal_95 = MISC::GET_GAME_TIMER();
			}
		}
	}
...
void func_199(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xD473
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_200(iParam3), false);
}

int func_200(int iParam0)//Position - 0xD48C
{
	int iVar0;
...
int func_201(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD681
{
	var uVar0;
	
	if ((((func_209(PLAYER::PLAYER_PED_ID()) && func_209(iParam0->f_28[0])) && !func_155()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_205(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_204(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
		func_202(&uVar0, cParam4, sParam5, 7, 0, 0);
...
void func_202(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD709
{
...
void func_203(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD744
{
...
void func_204(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD79A
{
...
float func_205(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD835
{
	struct<3> Var0;
...
int func_206(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)//Position - 0xD86F
{
	var uVar0;
	...
	if (func_189(2))
	{
		if (!func_155())
		{
			if (((func_209(PLAYER::PLAYER_PED_ID()) && func_209(iParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_205(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_204(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
				func_202(&uVar0, cParam4, sParam5, 7, 0, 0);
		...
		else if (func_207(sParam5))
		{
			...
			{
				if (func_205(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
				{
					func_153();
				}
			}
...
int func_207(char* sParam0)//Position - 0xD931
{
	struct<6> Var0;
...
struct<6> func_208()//Position - 0xD951
{
	struct<6> Var0;
...
int func_209(int iParam0)//Position - 0xD975
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_210(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD996
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_205(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_213(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_205(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_215(iParam0);
				}
			}
...
void func_211(int iParam0, bool bParam1)//Position - 0xDA87
{
	if (iParam0 == -1)
	{
		return;
...
int func_212(int iParam0)//Position - 0xDAC3
{
	if (Global_79244 == iParam0)
	{
		if (Global_79245 == -1)
...
void func_213(int iParam0, int iParam1)//Position - 0xDAFC
{
	bool bVar0;
	int iVar1;
...
bool func_214()//Position - 0xDB9A
{
	return Global_98681;
}

void func_215(int iParam0)//Position - 0xDBA6
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_216(iParam0);
...
void func_216(int iParam0)//Position - 0xDBBD
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_217(int iParam0)//Position - 0xDCA5
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
int func_218(var uParam0, bool bParam1)//Position - 0xDCCD
{
	struct<27> Var0;
...
void func_219(int iParam0, var uParam1, int iParam2)//Position - 0xDF3D
{
	int iVar0;
	int iVar1;
...
int func_220(int iParam0)//Position - 0xE295
{
...
int func_221(var uParam0)//Position - 0xE2B5
{
...
int func_222(var uParam0)//Position - 0xE2CD
{
...
void func_223(var uParam0)//Position - 0xE2F2
{
	int iVar0;
	int iVar1;
...
void func_224(int* iParam0)//Position - 0xE5F6
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_225(var uParam0)//Position - 0xE621
{
	int iVar0;
...
int func_226(var uParam0, bool bParam1, bool bParam2)//Position - 0xE6A1
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_227(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_227(int iParam0, int iParam1)//Position - 0xE85F
{
	int iVar0;
...
int func_228(var uParam0, bool bParam1, int iParam2)//Position - 0xE88F
{
	int iVar0;
	int iVar1;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					...
					if (func_247(*uParam0))
					{
						if (!func_168(*uParam0))
						{
							if (func_242(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_223(uParam0);
						...
						if (func_230(uParam0->f_28[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_223(uParam0);
...
int func_229(int iParam0)//Position - 0xEB4B
{
...
int func_230(int iParam0, float fParam1)//Position - 0xEB7F
{
	float fVar0;
	
	if (func_209(PLAYER::PLAYER_PED_ID()) && func_209(iParam0))
	{
		if (func_241(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_231(int iParam0, float fParam1)//Position - 0xEBF5
{
	return func_232(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_232(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEC0D
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	
	iVar4 = func_240(iParam0, iParam1);
	if (!func_209(iParam0) || !func_209(iParam1))
	{
		if (iVar4 != -1)
		{
			func_239(&(Local_35[iVar4 /*4*/]));
		}
		return 0;
	}
	if (!func_236(iParam0, iParam1, fParam2, iParam3))
	{
		return 0;
	}
	if (iVar4 == -1)
	...
	uVar0 = func_233(&(Local_35[iVar4 /*4*/]), Var1, iParam1, &(Local_35[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar4 /*4*/].f_3) < iParam4);
}

int func_233(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xECCE
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_234(int iParam0, int iParam1)//Position - 0xEDFA
{
	int iVar0;
...
int func_236(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEF09
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_238(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
float func_237(struct<3> Param0, struct<3> Param3)//Position - 0xEF9A
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_238(struct<3> Param0)//Position - 0xEFBB
{
	float fVar0;
	float fVar1;
...
void func_239(var uParam0)//Position - 0xEFFA
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_240(int iParam0, int iParam1)//Position - 0xF015
{
	int iVar0;
...
int func_241(int iParam0)//Position - 0xF054
{
...
int func_242(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF07C
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_209(PLAYER::PLAYER_PED_ID()) && func_209(iParam0))
	{
		...
		if (!bParam2)
		{
			if (func_246(iParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_243(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_243(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF177
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_244(int iParam0, float fParam1)//Position - 0xF283
{
	var uVar0;
	struct<3> Var1;
	...
	{
		if (func_245(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_245(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF318
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_246(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF3A6
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_247(int iParam0)//Position - 0xF3EE
{
...
void func_248(int iParam0)//Position - 0xF438
{
	int iVar0;
...
int func_249(int iParam0)//Position - 0xF4D5
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
int func_250(int iParam0)//Position - 0xF56A
{
...
int func_253(int iParam0)//Position - 0xF5E9
{
...
int func_255(int iParam0)//Position - 0xF65B
{
	if (func_117(0))
	{
...
int func_256(int iParam0)//Position - 0xF683
{
	switch (*iParam0)
	{
		case 21:
...
int func_258(var uParam0)//Position - 0xF737
{
	int iVar0[5];
	int iVar6;
	bool bVar7;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				if (func_259(&(uParam0->f_28[0]), 61, -915.6f, 6139.192f, 5.525f, 111.24f, "FANATIC LAUNCHER RC", 1))
				{
			...
			{
				Var8 = { -915.4199f, 6137.8555f, 4.6221f };
...
int func_259(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xFAF7
{
	if (func_260(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_260(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xFB53
{
	int iVar0;
...
int func_261(var uParam0, int iParam1)//Position - 0xFBE1
{
	int iVar0;
...
int func_262(var uParam0)//Position - 0xFC27
{
	if (func_222(uParam0))
	{
...
int func_263(int iParam0)//Position - 0xFC51
{
	int iVar0;
...
void func_264(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xFC82
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_265(var uParam0)//Position - 0xFCBE
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_259(&(uParam0->f_28[0]), 61, 809.66f, 1279.76f, 360.49f, 122.53f, "FANATIC LAUNCHER RC", 1))
				{
					bVar5 = false;
				}
			}
			...
			{
				func_269(&(uParam0->f_28[1]), iVar0[1], 808.43f, 1279.16f, 360.47f, -79.11f, 26);
			...
			{
				func_267(&(uParam0->f_35[0]), iVar0[2], 808.35f, 1277.2f, 360.15f, 216.5f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_267(&(uParam0->f_35[1]), iVar0[2], 807.89f, 1275.73f, 360.18f, 208.2f);
			}
			if (bVar5)
			{
				iLocal_89 = 3;
		...
		case 3:
			...
			while (iVar4 <= 1)
			{
				if (func_209(uParam0->f_35[iVar4]))
				{
...
void func_267(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10004
{
	func_268(iParam0);
...
void func_268(int* iParam0)//Position - 0x10047
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_269(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x100E3
{
	func_270(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

void func_270(int* iParam0)//Position - 0x10104
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_271(var uParam0)//Position - 0x10145
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_259(&(uParam0->f_28[0]), 61, -1878.27f, -440.55f, 46.23f, 165.94f, "FANATIC LAUNCHER RC", 1))
				{
...
int func_272(int iParam0)//Position - 0x102A0
{
	struct<27> Var0;
	bool bVar32;
...
int func_273(int iParam0)//Position - 0x102F1
{
	char* sVar0;
...
int func_274(int iParam0)//Position - 0x103AA
{
	var uVar0;
...
int func_275(int iParam0)//Position - 0x1046B
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_276(int iParam0, char* sParam1)//Position - 0x104F0
{
...
int func_277(int iParam0)//Position - 0x105D2
{
...
int func_278(int iParam0)//Position - 0x105FD
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_279(int iParam0)//Position - 0x10628
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_280(int iParam0)//Position - 0x10653
{
	if (func_250(iParam0))
	{
		return 0;
...
void func_281()//Position - 0x10688
{
	func_301("Running end routines.");
	Global_114088 = (Global_114088 - 1);
}

int func_282(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x106A2
{
	int iVar0;
...
int func_283(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10707
{
	int iVar0;
	struct<7> Var1;
...
int func_284(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x1077F
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_285(int iParam0, bool bParam1)//Position - 0x107FA
{
	char* sVar0;
...
void func_286(char* sParam0)//Position - 0x1089E
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_207(sParam0))
...
void func_287()//Position - 0x108BD
{
	Global_21032 = 0;
	func_288();
}

void func_288()//Position - 0x108CD
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_289(var uParam0)//Position - 0x108EE
{
	if (func_222(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_290(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10924
{
...
void func_291(var uParam0, bool bParam1)//Position - 0x10944
{
	func_292(&(uParam0->f_41), bParam1);
}

void func_292(var uParam0, bool bParam1)//Position - 0x10956
{
	int iVar0;
...
void func_293(int* iParam0, bool bParam1)//Position - 0x10994
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_294(var uParam0, bool bParam1)//Position - 0x109CF
{
	func_295(&(uParam0->f_35), bParam1);
}

void func_295(var uParam0, bool bParam1)//Position - 0x109E1
{
	int iVar0;
...
void func_296(int* iParam0)//Position - 0x10A1E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_297(var uParam0, int iParam1)//Position - 0x10A56
{
	func_298(&(uParam0->f_28), iParam1);
}

void func_298(var uParam0, int iParam1)//Position - 0x10A68
{
	int iVar0;
...
void func_299(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10AA9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_300(var uParam0)//Position - 0x10AF9
{
	if (*uParam0 == -1)
	{
		return;
...
void func_301(char* sParam0)//Position - 0x10B36
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_302(var uParam0)//Position - 0x10B48
{
	*uParam0 = -1;
...
void func_303()//Position - 0x10B7B
{
	func_301("Running start routines.");
	Global_114088++;
}

int func_304(int iParam0)//Position - 0x10B95
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
