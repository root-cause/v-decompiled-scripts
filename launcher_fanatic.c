...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F2D
{
	int iVar0;
...
int func_55()//Position - 0x416F
{
	func_56();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_56()//Position - 0x4188
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x4285
{
	return Global_43052 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x4293
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x4386
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x460E
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x46A9
{
...
int func_62(int iParam0, int iParam1)//Position - 0x4871
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x5412
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x544D
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x56C1
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x56FD
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5C4C
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5C90
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x640F
{
	if (bParam2)
	{
...
int func_70(var uParam0)//Position - 0x6456
{
...
bool func_71(int iParam0)//Position - 0x64B1
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x64C1
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x6522
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x689D
{
	return Global_31959;
}

int func_75(int iParam0)//Position - 0x68A8
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x68B8
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x695A
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x707F
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x70D7
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7181
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
...
Vector3 func_81(struct<3> Param0, float fParam1)//Position - 0x7216
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_82(int iParam0)//Position - 0x725A
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x73DE
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x73EC
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7EB3
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7F35
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x7F8D
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x7F96
{
	switch (iParam0)
	{
		case 1:
...
var func_186(int iParam0, int iParam1)//Position - 0xCE19
{
	switch (iParam0)
	{
		case 5:
...
void func_190(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xCEC9
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_191(iParam3), false);
}

int func_191(int iParam0)//Position - 0xCEE2
{
	int iVar0;
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xD0D7
{
	var uVar0;
	
	if ((((func_200(PLAYER::PLAYER_PED_ID()) && func_200(iParam0->f_28[0])) && !func_147()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_193(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD15F
{
...
void func_194(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD19A
{
...
void func_195(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD1F0
{
...
float func_196(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xD28B
{
	struct<3> Var0;
...
int func_197(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)//Position - 0xD2C5
{
	...
	if (func_180(2))
	{
		if (!func_147())
		{
			if (((func_200(PLAYER::PLAYER_PED_ID()) && func_200(iParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_195(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
				func_193(&uVar0, cParam2, sParam3, 7, 0, 0);
...
int func_198(char* sParam0)//Position - 0xD387
{
	struct<6> Var0;
...
struct<6> func_199()//Position - 0xD3A7
{
	struct<6> Var0;
...
int func_200(int iParam0)//Position - 0xD3CB
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_201(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD3EC
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_202(int iParam0, bool bParam1)//Position - 0xD4DD
{
	if (iParam0 == -1)
	{
		return;
...
int func_203(int iParam0)//Position - 0xD519
{
	if (Global_78315 == iParam0)
	{
		if (Global_78316 == -1)
...
void func_204(int iParam0, int iParam1)//Position - 0xD552
{
	bool bVar0;
	int iVar1;
...
bool func_205()//Position - 0xD5F0
{
	return Global_97750;
}

void func_206(int iParam0)//Position - 0xD5FC
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_207(iParam0);
...
void func_207(int iParam0)//Position - 0xD613
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_208(int iParam0)//Position - 0xD6FB
{
	if (iParam0 == -1)
	{
		iParam0 = func_167();
...
int func_209(var uParam0, bool bParam1)//Position - 0xD723
{
	struct<27> Var0;
...
void func_210(int iParam0, var uParam1, int iParam2)//Position - 0xD993
{
	int iVar0;
	int iVar1;
...
int func_211(int iParam0)//Position - 0xDCEB
{
...
int func_212(var uParam0)//Position - 0xDD0B
{
...
int func_213(var uParam0)//Position - 0xDD23
{
...
void func_214(var uParam0)//Position - 0xDD48
{
	int iVar0;
	int iVar1;
...
void func_215(int* iParam0)//Position - 0xE04C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_216(var uParam0)//Position - 0xE077
{
	int iVar0;
...
int func_217(var uParam0, bool bParam1, bool bParam2)//Position - 0xE0F7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_218(int iParam0, int iParam1)//Position - 0xE2B5
{
	int iVar0;
...
int func_219(var uParam0, bool bParam1, int iParam2)//Position - 0xE2E5
{
	int iVar0;
	int iVar1;
...
int func_220(int iParam0)//Position - 0xE5A1
{
...
int func_221(int iParam0, float fParam1)//Position - 0xE5D5
{
	float fVar0;
...
bool func_222(int iParam0, float fParam1)//Position - 0xE64B
{
	return func_223(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_223(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE663
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_224(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_224(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE724
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_225(int iParam0, int iParam1)//Position - 0xE850
{
	int iVar0;
...
int func_227(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE95F
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	{
		Var1 = { func_229(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_228(struct<3> Param0, struct<3> Param1)//Position - 0xE9F0
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_229(struct<3> Param0)//Position - 0xEA11
{
	float fVar0;
	float fVar1;
...
void func_230(var uParam0)//Position - 0xEA50
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_231(int iParam0, int iParam1)//Position - 0xEA6B
{
	int iVar0;
...
int func_232(int iParam0)//Position - 0xEAAA
{
...
int func_233(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEAD2
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_234(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEBCD
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_235(int iParam0, float fParam1)//Position - 0xECD9
{
	var uVar0;
	struct<3> Var1;
...
int func_236(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xED6E
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_237(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEDFC
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_238(int iParam0)//Position - 0xEE44
{
...
void func_239(int iParam0)//Position - 0xEE8E
{
	int iVar0;
...
int func_240(int iParam0)//Position - 0xEF2B
{
	if (iParam0 == -1)
	{
		iParam0 = func_167();
...
int func_241(int iParam0)//Position - 0xEFC0
{
...
int func_244(int iParam0)//Position - 0xF03F
{
...
int func_246(int iParam0)//Position - 0xF0B1
{
	if (func_110(0))
	{
...
int func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xF54C
{
	if (func_251(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_251(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xF5A8
{
	int iVar0;
...
int func_252(var uParam0, int iParam1)//Position - 0xF636
{
	int iVar0;
...
int func_253(var uParam0)//Position - 0xF67C
{
	if (func_213(uParam0))
	{
...
int func_254(int iParam0)//Position - 0xF6A6
{
	int iVar0;
...
void func_255(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xF6D7
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_256(var uParam0)//Position - 0xF713
{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			...
			while (iVar1 <= 1)
			{
				if (func_200(uParam0->f_35[iVar1]))
				{
...
void func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xFA57
{
	func_259(iParam0);
...
void func_259(int* iParam0)//Position - 0xFA99
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_260(int* iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0xFB35
{
	func_261(iParam0);
	*iParam0 = PED::CREATE_PED(iParam4, iParam1, Param2, fParam3, false, false);
}

void func_261(int* iParam0)//Position - 0xFB56
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_263(int iParam0)//Position - 0xFCF2
{
	struct<27> Var0;
	bool bVar1;
...
bool func_267(int iParam0, char* sParam1)//Position - 0xFF42
{
...
int func_268(int iParam0)//Position - 0x10024
{
...
int func_269(int iParam0)//Position - 0x1004F
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_270(int iParam0)//Position - 0x1007A
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_271(int iParam0)//Position - 0x100A5
{
	if (func_241(iParam0))
	{
		return 0;
...
void func_272()//Position - 0x100DA
{
	func_292("Running end routines.");
	Global_113104 = (Global_113104 - 1);
}

int func_273(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x100F4
{
	int iVar0;
...
int func_274(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0x10159
{
	int iVar0;
	struct<7> Var1;
...
int func_275(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x101D1
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_277(char* sParam0)//Position - 0x102F0
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_198(sParam0))
...
void func_278()//Position - 0x1030F
{
	Global_20471 = 0;
	func_279();
}

void func_279()//Position - 0x1031F
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22616 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_280(var uParam0)//Position - 0x10340
{
	if (func_213(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_281(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10376
{
...
void func_282(var uParam0, bool bParam1)//Position - 0x10396
{
	func_283(&(uParam0->f_41), bParam1);
}

void func_283(var uParam0, bool bParam1)//Position - 0x103A8
{
	int iVar0;
...
void func_284(int* iParam0, bool bParam1)//Position - 0x103E6
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_285(var uParam0, bool bParam1)//Position - 0x10421
{
	func_286(&(uParam0->f_35), bParam1);
}

void func_286(var uParam0, bool bParam1)//Position - 0x10433
{
	int iVar0;
...
void func_287(int* iParam0)//Position - 0x10470
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_288(var uParam0, int iParam1)//Position - 0x104A8
{
	func_289(&(uParam0->f_28), iParam1);
}

void func_289(var uParam0, int iParam1)//Position - 0x104BA
{
	int iVar0;
...
void func_290(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x104FB
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_291(var uParam0)//Position - 0x1054B
{
	if (*uParam0 == -1)
	{
		return;
...
void func_292(char* sParam0)//Position - 0x10588
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_293(var uParam0)//Position - 0x1059A
{
	*uParam0 = -1;
...
void func_294()//Position - 0x105CD
{
	func_292("Running start routines.");
	Global_113104++;
}

int func_295(int iParam0)//Position - 0x105E7
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
