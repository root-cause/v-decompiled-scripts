...
int func_80(int iParam0)//Position - 0x211E
{
	if (iParam0 != func_53())
	{
		if (func_54(iParam0, 1, 1))
		{
			...
			{
				return func_81(Global_2657921[iParam0 /*463*/].f_321.f_7) == 19;
			}
		}
	}
	return 0;
...
void func_83()//Position - 0x2656
{
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_84(var uParam0)//Position - 0x2662
{
	int iVar0;
...
void func_85(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x26C1
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool func_86(int iParam0)//Position - 0x2B73
{
	return iParam0 == 17;
}

void func_87()//Position - 0x2B80
{
	struct<3> Var0;
...
int func_89(int iParam0)//Position - 0x2C0B
{
	int iVar0;
...
void func_90(bool bParam0, int iParam1, int iParam2)//Position - 0x2C3C
{
	int iVar0;
	int iVar1;
...
void func_91(int iParam0, bool bParam1)//Position - 0x2D0C
{
	int iVar0;
...
int func_93(int iParam0)//Position - 0x2D80
{
...
bool func_94()//Position - 0x2DBF
{
	return BitTest(Global_2621446, 3);
}

bool func_95(int iParam0, int iParam1)//Position - 0x2DCD
{
	bool bVar0;
...
int func_96(int iParam0, bool bParam1)//Position - 0x2E26
{
	int iVar0;
	int iVar1;
...
int func_97()//Position - 0x2E67
{
	return Global_1574925;
}

int func_98(var uParam0)//Position - 0x2E73
{
	int iVar0;
...
void func_102(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2F70
{
	struct<3> Var0;
	float fVar3;
...
Vector3 func_103()//Position - 0x3001
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_104(struct<3> Param0, float fParam3)//Position - 0x3014
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
float func_105(int iParam0, float fParam1)//Position - 0x3058
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_106()//Position - 0x3091
{
	return -0.5f, -0.5f, 0f;
}

void func_107(int iParam0, var uParam1, var uParam2)//Position - 0x30A4
{
	if (func_4())
	{
		switch (iParam0)
...
void func_108()//Position - 0x33F4
{
}

int func_109(int iParam0, int iParam1, bool bParam2)//Position - 0x33FC
{
	int iVar0;
...
bool func_110(bool bParam0)//Position - 0x3512
{
	if (bParam0)
	{
	}
