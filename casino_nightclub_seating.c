...
int func_80(int iParam0)//Position - 0x211E
{
	if (iParam0 != func_53())
	{
		if (func_54(iParam0, 1, 1))
		{
			...
			{
				return func_81(Global_2657704[iParam0 /*463*/].f_321.f_7) == 19;
			}
		}
	}
	return 0;
...
void func_83()//Position - 0x2630
{
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_84(var uParam0)//Position - 0x263C
{
	int iVar0;
...
void func_85(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x269B
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool func_86(int iParam0)//Position - 0x2B37
{
	return iParam0 == 17;
}

void func_87()//Position - 0x2B44
{
	struct<3> Var0;
...
int func_89(int iParam0)//Position - 0x2BCF
{
	int iVar0;
...
void func_90(bool bParam0, int iParam1, int iParam2)//Position - 0x2C00
{
	int iVar0;
	int iVar1;
...
void func_91(int iParam0, bool bParam1)//Position - 0x2CD0
{
	int iVar0;
...
int func_93(int iParam0)//Position - 0x2D44
{
...
bool func_94()//Position - 0x2D83
{
	return BitTest(Global_2621446, 3);
}

bool func_95(int iParam0, int iParam1)//Position - 0x2D91
{
	bool bVar0;
...
int func_96(int iParam0, bool bParam1)//Position - 0x2DEA
{
	int iVar0;
	int iVar1;
...
int func_97()//Position - 0x2E2B
{
	return Global_1574918;
}

int func_98(var uParam0)//Position - 0x2E37
{
	int iVar0;
...
void func_102(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2F34
{
	struct<3> Var0;
	float fVar3;
...
Vector3 func_103()//Position - 0x2FC5
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_104(struct<3> Param0, float fParam3)//Position - 0x2FD8
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
float func_105(int iParam0, float fParam1)//Position - 0x301C
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_106()//Position - 0x3055
{
	return -0.5f, -0.5f, 0f;
}

void func_107(int iParam0, var uParam1, var uParam2)//Position - 0x3068
{
	if (func_4())
	{
		switch (iParam0)
...
void func_108()//Position - 0x33B8
{
}

int func_109(int iParam0, int iParam1, bool bParam2)//Position - 0x33C0
{
	int iVar0;
...
bool func_110(bool bParam0)//Position - 0x34D6
{
	if (bParam0)
	{
	}
