...
int func_80(int iParam0)//Position - 0x2121
{
	if (iParam0 != func_53())
	{
		if (func_54(iParam0, 1, 1))
		{
			...
			{
				return func_81(Global_2657991[iParam0 /*467*/].f_324.f_8) == 19;
			}
		}
	}
	return 0;
...
void func_85(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2706
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_89(int iParam0)//Position - 0x2C52
{
	int iVar0;
...
void func_90(bool bParam0, int iParam1, int iParam2)//Position - 0x2C83
{
	int iVar0;
	int iVar1;
...
void func_91(int iParam0, bool bParam1)//Position - 0x2D53
{
	int iVar0;
...
int func_93(int iParam0)//Position - 0x2DC7
{
...
int func_98(var uParam0)//Position - 0x2EBA
{
	int iVar0;
...
Vector3 func_104(struct<3> Param0, float fParam3)//Position - 0x305B
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_109(int iParam0, int iParam1, bool bParam2)//Position - 0x3443
{
	int iVar0;
