...
int func_74(int iParam0)//Position - 0x2054
{
...
int func_77(int iParam0)//Position - 0x2086
{
...
int func_78(int iParam0)//Position - 0x20BF
{
	if (iParam0 != func_53() && func_54(iParam0, 1, 1))
	{
...
int func_79(int iParam0)//Position - 0x20F0
{
	if (iParam0 != func_53() && func_54(iParam0, 1, 1))
	{
...
int func_80(int iParam0)//Position - 0x2121
{
	if (iParam0 != func_53())
	{
...
void func_83()//Position - 0x267F
{
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_84(var uParam0)//Position - 0x268B
{
	int iVar0;
...
void func_85(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x26EA
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool func_86(int iParam0)//Position - 0x2B9D
{
	return iParam0 == 17;
}

void func_87()//Position - 0x2BAA
{
	struct<3> Var0;
...
int func_89(int iParam0)//Position - 0x2C35
{
	int iVar0;
...
void func_90(bool bParam0, int iParam1, int iParam2)//Position - 0x2C66
{
	int iVar0;
	int iVar1;
...
void func_91(int iParam0, bool bParam1)//Position - 0x2D36
{
	int iVar0;
...
int func_93(int iParam0)//Position - 0x2DAA
{
...
bool func_94()//Position - 0x2DE9
{
	return BitTest(Global_2621446, 3);
}

bool func_95(int iParam0, int iParam1)//Position - 0x2DF7
{
	bool bVar0;
...
int func_96(int iParam0, bool bParam1)//Position - 0x2E50
{
	int iVar0;
	int iVar1;
...
int func_97()//Position - 0x2E91
{
	return Global_1574926;
}

int func_98(var uParam0)//Position - 0x2E9D
{
	int iVar0;
...
void func_102(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2F9A
{
	struct<3> Var0;
	float fVar3;
...
Vector3 func_103()//Position - 0x302B
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_104(struct<3> Param0, float fParam3)//Position - 0x303E
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
float func_105(int iParam0, float fParam1)//Position - 0x3082
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_106()//Position - 0x30BB
{
	return -0.5f, -0.5f, 0f;
}

void func_107(int iParam0, var uParam1, var uParam2)//Position - 0x30CE
{
	if (func_4())
	{
		switch (iParam0)
...
void func_108()//Position - 0x341E
{
}

int func_109(int iParam0, int iParam1, bool bParam2)//Position - 0x3426
{
	int iVar0;
...
bool func_110(bool bParam0)//Position - 0x353C
{
	if (bParam0)
	{
	}
