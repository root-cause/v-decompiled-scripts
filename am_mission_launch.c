...
void func_268()//Position - 0x8883
{
	...
	{
		if (func_271(Global_114372.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_270(PLAYER::PLAYER_PED_ID());
			if (func_269(iVar0) && (!func_213(14) || Global_113320))
			{
				if (Global_114372.f_2366.f_539.f_4321 != iVar0 && func_269(Global_114372.f_2366.f_539.f_4321))
				{
...
void func_293()//Position - 0x9624
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_294(Global_114372.f_14144[iVar2 /*104*/].f_18, Global_114372.f_14144[Global_23233 /*104*/].f_18))
		{
			Global_23233 = iVar2;
		}
		iVar2++;
