...
int func_5(bool bParam0)//Position - 0x443
{
...
void func_10(int iParam0, bool bParam1, int iParam2)//Position - 0xA6B
{
	if (iParam2 == -1)
	{
		iParam2 = func_11();
...
int func_32(int iParam0, int iParam1, int iParam2)//Position - 0x1537
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x16F4
{
	int iVar0;
...
int func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x17D0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_37(int iParam0, int iParam1, int iParam2)//Position - 0x206B
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
int func_39(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x2171
{
	var uVar0;
	int iVar10;
...
int func_40(int iParam0, int iParam1, int iParam2)//Position - 0x2775
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_41(int iParam0, int iParam1, int iParam2)//Position - 0x280E
{
	int iVar0;
	int iVar1;
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x28AF
{
	int iVar0;
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2BB6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x3769
{
	int iVar0;
...
int func_47(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3D4B
{
	int iVar0;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x3D74
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x403F
{
	int iVar0;
...
void func_51(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4420
{
	int iVar0;
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x44BA
{
	switch (iParam0)
	{
...
int func_56(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4AAA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_57(int iParam0, int iParam1)//Position - 0x4BA6
{
	int iVar0;
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4E84
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5101
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_63(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5526
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_64(int iParam0, int iParam1)//Position - 0x5819
{
	int iVar0;
	int iVar1;
...
int func_65(int iParam0, int iParam1)//Position - 0x5860
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x58C0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_70(int iParam0, var uParam1)//Position - 0x5A39
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_71(uParam1));
}

int func_71(var uParam0)//Position - 0x5A4E
{
	int iVar0;
	int iVar1;
...
void func_88(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD6EC
{
	var uVar0;
	int iVar1;
...
int func_92(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE688
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_150(int iParam0, int iParam1, int iParam2)//Position - 0x1FA23
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_151(int iParam0)//Position - 0x1FC7C
{
	int iVar0;
	int iVar1;
...
int func_152(int iParam0)//Position - 0x1FCB9
{
	if (func_154(iParam0))
	{
...
var func_153(int iParam0)//Position - 0x1FCDE
{
	return Global_2201[iParam0 /*29*/];
}

bool func_154(int iParam0)//Position - 0x1FCED
{
	return iParam0 < 3;
}

void func_155(char* sParam0, var uParam1)//Position - 0x1FCF9
{
...
int func_208(int iParam0)//Position - 0x271B4
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_210(int iParam0)//Position - 0x2727F
{
	if (func_208(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_211(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2729F
{
	if (bParam0)
	{
...
int func_215(var uParam0)//Position - 0x274A2
{
	int iVar0;
...
int func_216(int iParam0)//Position - 0x274C4
{
...
int func_218(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x27511
{
	int iVar0;
...
int func_221(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2758E
{
	bool bVar0;
	float fVar1;
...
void func_222(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x275EA
{
	int iVar0;
...
Vector3 func_223(int iParam0)//Position - 0x277A8
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_224()//Position - 0x277BB
{
	func_157();
...
int func_228(int iParam0, float fParam1, int iParam2)//Position - 0x2786F
{
	int iVar0;
...
int func_234(int iParam0, int iParam1)//Position - 0x27A40
{
	if (func_210(iParam0))
	{
...
int func_235(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x27A73
{
...
void func_236(int iParam0)//Position - 0x27ACA
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_239(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x27C5D
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_79794 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_241(Global_79795, Global_79797, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_240(char* sParam0)//Position - 0x27F42
{
...
int func_250(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x28325
{
	if (((!func_253(0) || Global_79810) || Global_79798 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_79794)
...
int func_252(int iParam0)//Position - 0x28466
{
	if (iParam0 == 1)
	{
...
int func_253(int iParam0)//Position - 0x284BD
{
	if (Global_44181 == 15)
	{
		return 0;
...
bool func_254(int iParam0)//Position - 0x284DF
{
	return func_255(iParam0, Global_44181);
}

int func_255(int iParam0, int iParam1)//Position - 0x284F0
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_260(int* iParam0, bool bParam1)//Position - 0x28761
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_261(int* iParam0)//Position - 0x2879C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_264(int* iParam0)//Position - 0x28816
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_265(int* iParam0)//Position - 0x2884E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_266(int iParam0)//Position - 0x288EA
{
	if (func_208(iParam0))
	{
...
void func_269(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x28967
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_270(int* iParam0)//Position - 0x289B7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_274(char* sParam0, int iParam1, int iParam2)//Position - 0x28B91
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_276()//Position - 0x28D76
{
	...
	iVar0 = func_277(&(Global_101688.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_278(int iParam0, bool bParam1)//Position - 0x28DC4
{
	int iVar0;
