...
void func_9()//Position - 0x1515
{
	...
	{
		PED::SET_PED_MOVEMENT_CLIPSET(iLocal_238, sLocal_446, 0.25f);
	}
}
...
bool func_19(int iParam0)//Position - 0x1753
{
	return iParam0 < 3;
}

int func_20(int iParam0)//Position - 0x175F
{
	int iVar0;
	int iVar1;
...
int func_21(int iParam0)//Position - 0x179C
{
	if (func_19(iParam0))
	{
...
var func_22(int iParam0)//Position - 0x17C1
{
...
bool func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B3E
{
...
var func_38(int iParam0, int iParam1)//Position - 0x1F04
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_39()//Position - 0x1F1C
{
	return -1;
}
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21DA
{
...
void func_48(char[4] cParam0)//Position - 0x2230
{
	int iVar0;
...
void func_49(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x226B
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_51(var uParam0)//Position - 0x233E
{
}

void func_52(var uParam0, int iParam1, float fParam2)//Position - 0x2346
{
}
...
void func_55(var uParam0)//Position - 0x23D3
{
}

void func_56(char* sParam0)//Position - 0x23DB
{
...
void func_70(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2685
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x296E
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0)//Position - 0x2AB4
{
	if (func_77(iParam0))
	{
...
int func_76(int iParam0)//Position - 0x2AD8
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x2B08
{
...
void func_79(int* iParam0)//Position - 0x2BF0
{
	if (iLocal_445 == 1)
	{
...
void func_80(int* iParam0, int iParam1, bool bParam2)//Position - 0x2C0F
{
	if (iLocal_445 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_81(int iParam0, bool bParam1, int iParam2)//Position - 0x2C62
{
	int iVar0;
...
int func_82(int iParam0, bool bParam1, bool bParam2)//Position - 0x2CAC
{
	int iVar0;
...
float func_83(bool bParam0, float fParam1, float fParam2)//Position - 0x2D50
{
	if (bParam0)
	{
		return fParam1;
...
float func_84(int iParam0, int iParam1, bool bParam2)//Position - 0x2D67
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_85(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2DC5
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_86(struct<3> Param0, struct<3> Param3)//Position - 0x2E56
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_87(struct<3> Param0)//Position - 0x2E77
{
	float fVar0;
	float fVar1;
...
int func_88(int iParam0)//Position - 0x2EB6
{
	var uVar0;
...
int func_95()//Position - 0x2F4C
{
	return 1;
}

float func_96(int iParam0, int iParam1)//Position - 0x2F55
{
...
void func_100(var uParam0, var uParam1)//Position - 0x307B
{
...
int func_102(int iParam0)//Position - 0x30FE
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_105()//Position - 0x3167
{
	...
	StringCopy(&Local_232, "PBJA", 8);
	StringCopy(&Local_234, "JANE", 16);
	StringCopy(&Local_200, "Special_Ped@jane", 64);
	StringCopy(&Local_216, "Base", 64);
	bLocal_434 = !Global_4;
	iLocal_250 = 7;
	sLocal_301 = "PBJA_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to Jane. */;
	StringCopy(&Local_310, "PBJA_CONV_GM", 16);
	StringCopy(&Local_314, "PBJA_CONV_GT", 16);
	StringCopy(&Local_318, "PBJA_CONV_GF", 16);
	StringCopy(&cLocal_322, "special_ped@jane@base", 64);
	StringCopy(&cLocal_338, "special_ped@jane@intro", 64);
...
int func_110(int iParam0)//Position - 0x3273
{
...
bool func_111(var uParam0)//Position - 0x329F
{
	return func_112(Global_114135.f_20121, uParam0);
}

bool func_112(var uParam0, var uParam1)//Position - 0x32B4
{
	return (uParam0 && uParam1) != 0;
}

int func_113(char* sParam0)//Position - 0x32C3
{
...
void func_115(int* iParam0)//Position - 0x34B9
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
