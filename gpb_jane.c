...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_284 = 49;
	iLocal_285 = 64;
	Local_210 = { ScriptParam_334.f_1[0 /*3*/] };
	func_119();
	...
	iLocal_208 = PED::CREATE_PED(25, iLocal_36, Local_210, ScriptParam_334.f_17[0], false, true);
	func_103();
	...
	while (iVar0 == 1)
	{
		...
		switch (iLocal_216)
		{
			...
			case 5:
				...
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_208, Local_210, 1f, -1, 1f, 1024, ScriptParam_334.f_17[0]);
					iLocal_216 = 6;
				}
				break;
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_266))
				{
					if (bLocal_331)
					{
						Global_113331[iLocal_217] = uLocal_330;
					}
					else
					{
...
void func_9()//Position - 0x1515
{
	...
	{
		PED::SET_PED_MOVEMENT_CLIPSET(iLocal_208, sLocal_277, 0.25f);
	}
}
...
float func_86(struct<3> Param0, struct<3> Param1)//Position - 0x2E56
{
...
void func_105()//Position - 0x3166
{
	...
	bLocal_265 = !Global_3;
	iLocal_218 = 7;
	sLocal_226 = "PBJA_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to Jane. */;
...
int func_110(int iParam0)//Position - 0x3272
{
...
bool func_111(var uParam0)//Position - 0x329E
{
	return func_112(Global_113386.f_20117, uParam0);
}

bool func_112(var uParam0, var uParam1)//Position - 0x32B3
{
	return (uParam0 && uParam1) != 0;
}

int func_113(char* sParam0)//Position - 0x32C2
{
...
void func_114(int iParam0)//Position - 0x33E9
{
	var uVar0;
...
void func_115(int* iParam0)//Position - 0x34B8
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_116()//Position - 0x34D8
{
	struct<6> Var0;
...
void func_117()//Position - 0x34FC
{
	func_118();
}

void func_118()//Position - 0x3508
{
	if (iLocal_278 == 1)
	{
