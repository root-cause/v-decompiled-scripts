...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_363 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(93.3633f, 82.5239f, 276.3459f) + Vector(10f, 10f, 10f), Vector(93.3633f, 82.5239f, 276.3459f) - Vector(10f, 10f, 10f), false, true, true, true, 1);
	iLocal_364 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(188.5935f, 675.8706f, 227.8598f) + Vector(4f, 4f, 4f), Vector(188.5935f, 675.8706f, 227.8598f) - Vector(4f, 4f, 4f), false, true, true, true, 1);
	iLocal_365 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(93.8361f, 92.1704f, 246.1673f) + Vector(6f, 6f, 6f), Vector(93.8361f, 92.1704f, 246.1673f) - Vector(6f, 6f, 6f), false, true, true, true, 1);
	if (Global_4)
	{
		...
		if (!func_233())
		{
			if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			{
				switch (iLocal_367)
				{
					...
					case 1:
						if ((func_203() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_89, false))
						{
						...
						{
							func_193(1);
							iLocal_358 = func_192(iLocal_84, 0, 145);
...
void func_3(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x98B
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_4(iParam3), false);
}

int func_4(int iParam0)//Position - 0x9A4
{
	int iVar0;
...
bool func_5(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xB96
{
...
int func_6(char* sParam0, int iParam1, bool bParam2)//Position - 0xBE4
{
	Global_22167 = 0;
...
bool func_9(int iParam0)//Position - 0xF4C
{
	return func_10(iParam0, 20);
}

var func_10(int iParam0, int iParam1)//Position - 0xF5C
{
	return BitTest(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_11()//Position - 0xF74
{
	return -1;
}

void func_12()//Position - 0xF7D
{
	int iVar0;
...
bool func_17(int iParam0)//Position - 0x11A4
{
	return Global_43922 == iParam0;
}

void func_18()//Position - 0x11B2
{
	int iVar0;
...
bool func_19(int iParam0, int iParam1)//Position - 0x1208
{
	switch (iParam0)
	{
		case 5:
...
void func_21(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x1297
{
...
void func_22(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x12ED
{
...
void func_23(var uParam0, int iParam1)//Position - 0x1388
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
int func_24()//Position - 0x13A5
{
	func_25();
	return Global_114372.f_2366.f_539.f_4321;
}

void func_25()//Position - 0x13BE
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_28(Global_114372.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_27(PLAYER::PLAYER_PED_ID());
			if (func_26(iVar0) && (!func_17(14) || Global_113320))
			{
...
bool func_26(int iParam0)//Position - 0x14BB
{
	return iParam0 < 3;
}

int func_27(int iParam0)//Position - 0x14C7
{
	int iVar0;
	int iVar1;
...
int func_28(int iParam0)//Position - 0x1504
{
	if (func_26(iParam0))
	{
...
var func_29(int iParam0)//Position - 0x1529
{
	return Global_2139[iParam0 /*29*/];
}

int func_30()//Position - 0x1538
{
	int iVar0;
	int iVar1;
	float fVar2;
				...
				case 1:
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_84) && !PED::IS_PED_INJURED(iLocal_84))
					{
						...
						if (Global_4 || bLocal_68)
						{
							if (!PED::IS_PED_INJURED(func_63(1, 0)))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(func_63(1, 0), Local_585, Global_23, false, true, 0))
								{
							...
							if (!PED::IS_PED_INJURED(func_63(1, 1)))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(func_63(1, 1), Local_588, Global_23, false, true, 0))
								{
							...
							if (!PED::IS_PED_INJURED(func_63(0, 1)))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(func_63(0, 1), Local_588, Global_23, false, true, 0))
								{
					...
					{
						if (ENTITY::IS_ENTITY_AT_COORD(func_63(2, 1), Local_579, Global_23, false, true, 0))
						{
							func_51(iLocal_84, func_66(2));
						}
						if (ENTITY::IS_ENTITY_AT_COORD(func_63(3, 1), Local_582, Global_23, false, true, 0))
						{
							func_51(iLocal_84, func_66(3));
						}
						if (ENTITY::IS_ENTITY_AT_COORD(func_63(0, 1), Local_582, Global_23, false, true, 0))
						{
							func_51(iLocal_84, func_66(0));
						}
					}
								...
								if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_129[iVar0 /*18*/], false))
								{
									if (!PED::IS_PED_INJURED(Local_202[iVar2 /*18*/]))
									{
										if (!PED::IS_PED_IN_VEHICLE(Local_202[iVar2 /*18*/], Local_129[iVar0 /*18*/], false))
										{
											...
											{
												TASK::TASK_ENTER_VEHICLE(Local_202[iVar2 /*18*/], Local_129[iVar0 /*18*/], -1, -1, 2f, 1, 0, 0);
											}
										}
									}
									if (iVar3 != -1)
									{
										if (!PED::IS_PED_INJURED(Local_202[iVar3 /*18*/]))
										{
											if (!PED::IS_PED_IN_VEHICLE(Local_202[iVar3 /*18*/], Local_129[iVar0 /*18*/], false))
											{
												...
												{
													TASK::TASK_ENTER_VEHICLE(Local_202[iVar3 /*18*/], Local_129[iVar0 /*18*/], -1, 0, 2f, 1, 0, 0);
												}
											}
										}
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_129[iVar0 /*18*/], false))
					{
						if (!PED::IS_PED_INJURED(Local_202[iVar5 /*18*/]))
						{
							if (!PED::IS_PED_IN_VEHICLE(Local_202[iVar5 /*18*/], Local_129[iVar0 /*18*/], false))
							{
								...
								{
									TASK::TASK_ENTER_VEHICLE(Local_202[iVar5 /*18*/], Local_129[iVar0 /*18*/], -1, -1, 2f, 1, 0, 0);
								}
							}
						}
						if (iVar6 != -1)
						{
							if (!PED::IS_PED_INJURED(Local_202[iVar6 /*18*/]))
							{
								if (!PED::IS_PED_IN_VEHICLE(Local_202[iVar6 /*18*/], Local_129[iVar0 /*18*/], false))
								{
									...
									{
										TASK::TASK_ENTER_VEHICLE(Local_202[iVar6 /*18*/], Local_129[iVar0 /*18*/], -1, 0, 2f, 1, 0, 0);
									}
								}
							}
...
int func_32(int iParam0, int iParam1)//Position - 0x2C9D
{
...
char* func_33(int iParam0)//Position - 0x2D0F
{
	switch (iParam0)
	{
		case 0:
...
void func_34(int iParam0)//Position - 0x2D85
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_36(int iParam0)//Position - 0x305D
{
	bool bVar0;
	struct<3> Var1;
	struct<3> Var4;
...
void func_37(int iParam0, bool bParam1)//Position - 0x314D
{
	if (bParam1 < 15)
	{
...
int func_38(bool bParam0)//Position - 0x3201
{
	return (bParam0 - 5);
}

bool func_39(bool bParam0)//Position - 0x320D
{
	int iVar0;
...
float func_40(struct<3> Param0, struct<3> Param3)//Position - 0x322A
{
	float fVar0;
...
Vector3 func_41(struct<3> Param0)//Position - 0x3290
{
	float fVar0;
	float fVar1;
...
bool func_42(int iParam0)//Position - 0x32CF
{
	bool bVar0;
	bool bVar1;
...
void func_43(int iParam0)//Position - 0x3311
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0, float fParam1)//Position - 0x33DF
{
	int iVar0;
...
float func_45(float fParam0, float fParam1, float fParam2)//Position - 0x34D8
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_46(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, struct<3> Param7, int iParam10, float fParam11)//Position - 0x34FF
{
...
int func_47(struct<3> Param0)//Position - 0x36D0
{
...
float func_48(int iParam0, int iParam1, bool bParam2)//Position - 0x36FA
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_49(int iParam0, int iParam1, int iParam2, struct<3> Param3, struct<3> Param6)//Position - 0x3758
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var4;
...
void func_51(int iParam0, int iParam1)//Position - 0x3A31
{
...
void func_52(int iParam0, int iParam1)//Position - 0x3AE1
{
	struct<3> Var0;
...
void func_53(struct<3> Param0, int iParam3, int iParam4)//Position - 0x3C32
{
	struct<3> Var0;
	float fVar3;
...
Vector3 func_54(int iParam0)//Position - 0x3CCC
{
	switch (iParam0)
	{
		case 0:
...
void func_55()//Position - 0x3DB9
{
	...
	while (iVar0 < Local_202.f_0)
	{
		...
		{
			Local_202[iVar0 /*18*/].f_1 = func_192(Local_202[iVar0 /*18*/], 1, 145);
...
int func_56(struct<3> Param0, bool bParam3)//Position - 0x3F98
{
	int iVar0;
...
float func_57(bool bParam0, float fParam1, float fParam2)//Position - 0x3FC4
{
	if (bParam0)
	{
		return fParam1;
...
int func_58(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8)//Position - 0x3FDB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0, bool bParam1, bool bParam2)//Position - 0x40C1
{
	int iVar0;
...
int func_60(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x4121
{
	int iVar0;
...
void func_61(int iParam0, struct<3> Param1, float fParam4, char* sParam5, char* sParam6, char* sParam7)//Position - 0x41BC
{
...
float func_62(float fParam0)//Position - 0x4396
{
	if (fParam0 >= 180f)
	{
...
var func_63(int iParam0, int iParam1)//Position - 0x43CA
{
	if (iParam1 == 0)
	{
...
void func_64(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x43F2
{
	if ((iParam0 % 2) == 1)
	{
...
void func_65(int iParam0, struct<3> Param1, float fParam4)//Position - 0x450D
{
	...
	ENTITY::SET_ENTITY_HEALTH(Local_202[iParam0 /*18*/], 300, 0, 0);
	...
	if (Global_4 || bLocal_68)
	{
		...
		ENTITY::SET_ENTITY_HEALTH(Local_202[iParam0 /*18*/], 500, 0, 0);
	}
...
int func_66(int iParam0)//Position - 0x46D3
{
	return iParam0 * 2 + 1;
}

void func_67(int iParam0)//Position - 0x46E1
{
	if ((iParam0 % 2) == 1)
	{
...
int func_68(int iParam0)//Position - 0x470E
{
	return iParam0 * 2;
}

void func_69(int iParam0)//Position - 0x471A
{
	Local_129[iParam0 /*18*/].f_17 = 0;
}

int func_70()//Position - 0x472B
{
	bool bVar0;
	bool bVar1;
...
int func_71(int iParam0)//Position - 0x48E8
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_75(int iParam0, int iParam1, bool bParam2)//Position - 0x4A8A
{
	struct<3> Var0;
	int iVar3;
...
int func_76(struct<3> Param0, int iParam3)//Position - 0x4BE3
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
float func_77(struct<3> Param0, struct<3> Param3)//Position - 0x4C33
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

void func_78()//Position - 0x4C54
{
	if (iLocal_45 != 11)
	{
...
void func_79(char* sParam0)//Position - 0x4CED
{
...
void func_83()//Position - 0x4F51
{
	func_84();
}

int func_84()//Position - 0x4F5E
{
	if (func_85(0))
	{
		return 0;
...
int func_85(bool bParam0)//Position - 0x4FA9
{
...
void func_86(int iParam0, int iParam1)//Position - 0x4FD1
{
	if (iParam0 == -1)
	{
		iParam0 = func_104();
...
void func_87(int iParam0)//Position - 0x50D5
{
	Global_114358 = iParam0;
}

void func_88(int iParam0, var uParam1, var uParam2)//Position - 0x50E3
{
	bool bVar0;
...
void func_89()//Position - 0x51C9
{
	...
	{
		func_91(13, SYSTEM::FLOOR(Global_114372.f_10197.f_3853));
	}
...
int func_90()//Position - 0x5687
{
	return Global_32828;
}

int func_91(int iParam0, int iParam1)//Position - 0x5692
{
	int iVar0;
...
void func_92(int iParam0, bool bParam1, int iParam2)//Position - 0x56E3
{
	if (iParam2 == -1)
	{
		iParam2 = func_93();
...
int func_93()//Position - 0x5701
{
	return Global_1574925;
}

int func_94(int iParam0, int iParam1)//Position - 0x570D
{
	switch (iParam0)
	{
		case 0:
...
int func_95(int iParam0)//Position - 0x5A81
{
	switch (iParam0)
	{
		case 29:
...
void func_96(int iParam0)//Position - 0x5AB0
{
	int iVar0;
	int iVar1;
...
void func_97(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x5AF2
{
	func_98(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_98(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x5B12
{
	int iVar0;
...
int func_101(int iParam0)//Position - 0x5E41
{
	int iVar0;
	int iVar1;
...
void func_102(int iParam0, int iParam1)//Position - 0x5E81
{
	MISC::SET_BIT(&(Global_114372.f_24998.f_8[iParam0]), iParam1);
}

int func_103(int iParam0)//Position - 0x5E9C
{
	int iVar0;
...
int func_105(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x5F6A
{
...
void func_108(char* sParam0)//Position - 0x6716
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_109()//Position - 0x6C81
{
	Global_21032 = 0;
	func_110();
}

void func_110()//Position - 0x6C91
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_113()//Position - 0x6EBA
{
	return 1;
}

void func_114(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x6EC3
{
	int iVar0;
	int iVar1;
...
int func_115(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x6F95
{
	float fVar0;
	bool bVar1;
	int iVar2;
...
void func_116(bool bParam0)//Position - 0x7594
{
	int iVar0;
	int iVar1;
...
void func_117(int iParam0)//Position - 0x7816
{
	int iVar0;
...
void func_118(bool bParam0)//Position - 0x7870
{
	bool bVar0;
	char cVar1[64];
	...
	else if (BitTest(Global_114372.f_20567.f_471, bParam0) || BitTest(Global_2359296[func_120() /*5569*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_114372.f_20567.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_120() /*5569*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
char* func_119(bool bParam0)//Position - 0x79E8
{
	switch (bParam0)
	{
		case 0:
...
void func_121(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x7AF6
{
	int iVar0;
...
int func_122(int iParam0, var uParam1)//Position - 0x7B24
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_123(uParam1));
}

int func_123(var uParam0)//Position - 0x7B39
{
	int iVar0;
	int iVar1;
...
void func_124(int iParam0)//Position - 0x7B6D
{
	func_143(93, iParam0);
	func_143(29, iParam0);
	func_143(30, iParam0);
...
int func_125(int iParam0)//Position - 0x7B8D
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	return BitTest(Global_2359296[func_120() /*5569*/].f_681.f_10, iParam0);
}

int func_126(int iParam0, int iParam1)//Position - 0x7D2D
{
	int iVar0;
	var uVar1;
...
bool func_127(int iParam0, int iParam1)//Position - 0x7D5C
{
	if (iParam1 == -1)
	{
		iParam1 = func_93();
...
int func_128(bool bParam0)//Position - 0x7D78
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0, int iParam1)//Position - 0x7E2F
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_130(int iParam0, int iParam1)//Position - 0x7E4A
{
...
int func_131(var uParam0, int iParam1)//Position - 0x7EE7
{
	int iVar0;
	var uVar1[78];
...
int func_132(var uParam0, int iParam1)//Position - 0x7F98
{
	int iVar0;
...
bool func_133(var uParam0, int iParam1)//Position - 0x8015
{
	return (*uParam0)[iParam1] == 78;
}

void func_134(var uParam0)//Position - 0x8026
{
	int iVar0;
...
void func_135(var uParam0, int iParam1)//Position - 0x805A
{
	(*uParam0)[iParam1] = 78;
}

void func_136(var uParam0, float fParam1)//Position - 0x806A
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_137(var uParam0)//Position - 0x8087
{
	return uParam0->f_80;
}

bool func_138(var uParam0, int iParam1)//Position - 0x8093
{
	return func_139(uParam0, iParam1) != -1;
}

int func_139(var uParam0, int iParam1)//Position - 0x80A5
{
	int iVar0;
...
bool func_140(var uParam0)//Position - 0x80D2
{
	return uParam0->f_79 == 1;
}

int func_141(int iParam0)//Position - 0x80E0
{
	switch (iParam0)
	{
		case 60:
...
void func_142(int iParam0, int iParam1)//Position - 0x8130
{
	int iVar0;
...
void func_143(int iParam0, int iParam1)//Position - 0x8153
{
	int iVar0;
...
int func_145(int iParam0)//Position - 0x8225
{
	return Global_2139[iParam0 /*29*/].f_17;
}

void func_146(bool bParam0)//Position - 0x8236
{
	if (!PED::IS_PED_INJURED(iLocal_84))
	{
		if (iLocal_619 > 1)
...
bool func_149(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x87A1
{
...
void func_150()//Position - 0x87F5
{
	Global_21032 = 0;
	func_151();
}

void func_151()//Position - 0x8805
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_152(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x8829
{
	if (bParam0)
	{
...
bool func_153()//Position - 0x8976
{
	return BitTest(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

bool func_154(int iParam0, int iParam1)//Position - 0x8990
{
	bool bVar0;
...
int func_155(int iParam0, bool bParam1)//Position - 0x89E9
{
	int iVar0;
	int iVar1;
...
int func_156(var uParam0)//Position - 0x8A2A
{
	int iVar0;
...
int func_157(int iParam0)//Position - 0x8A4C
{
...
bool func_158()//Position - 0x8A8B
{
	return BitTest(Global_2621446, 3);
}

int func_159(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x8A99
{
	int iVar0;
...
void func_160(int iParam0)//Position - 0x8ACC
{
	if (iParam0 == 1)
	{
	...
	if (bLocal_366 && !PED::IS_PED_INJURED(iLocal_84))
	{
		...
		else if (iLocal_367 != 100)
		{
			...
			else if (!PED::IS_PED_IN_VEHICLE(iLocal_84, iLocal_89, false))
			{
				...
				{
					TASK::TASK_ENTER_VEHICLE(iLocal_84, iLocal_89, -1, func_180(iLocal_89), 2f, 8388608, 0, 0);
				}
			}
		}
	}
...
var func_162()//Position - 0x92FC
{
	return Global_33067;
}

int func_163(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x9307
{
...
void func_164(int iParam0)//Position - 0x935E
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_165(bool bParam0, bool bParam1)//Position - 0x938A
{
...
int func_166(char* sParam0)//Position - 0x94DB
{
	struct<3> Var0;
...
int func_167(char* sParam0, bool bParam1)//Position - 0x952F
{
	if (bParam1)
	{
		if (!iLocal_70)
		...
		{
			if (func_169(&Local_393, cLocal_370, sParam0, &Local_73, 4, 0, 0))
			{
				iLocal_71 = 0;
			}
		}
...
struct<6> func_168()//Position - 0x95DF
{
	struct<6> Var0;
	int iVar6;
	int iVar7;
...
bool func_169(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x968B
{
	func_21(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_171()//Position - 0x9740
{
	if (func_24() == 2)
	{
		...
		{
			func_174();
			iLocal_362 = func_173(-1034.6f, 4918.6f, 205.9f, 0);
...
int func_173(struct<3> Param0, bool bParam3)//Position - 0x97A0
{
	return func_56(Param0, bParam3);
}

void func_174()//Position - 0x97B2
{
	if (func_24() == 2)
	{
		if (!Global_33069)
		{
			func_175("CULT_BLIP_HELP" /* GXT: Trevor can sometimes deliver Random Event passengers to the Altruist Cult, located at ~BLIP_ALTRUIST~ */, -1);
			Global_33069 = 1;
		}
	}
}

void func_175(char* sParam0, int iParam1)//Position - 0x97D6
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_176()//Position - 0x97ED
{
...
void func_177(bool bParam0)//Position - 0x9809
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_89, false) && !PED::IS_PED_INJURED(iLocal_84))
	{
		...
		else
		{
			...
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_89, false))
			{
				if (!HUD::DOES_BLIP_EXIST(iLocal_359))
				{
					iLocal_359 = func_178(iLocal_89, 0, 0);
				}
			}
			if (!PED::IS_PED_IN_VEHICLE(iLocal_84, iLocal_89, false))
			{
...
int func_178(int iParam0, bool bParam1, bool bParam2)//Position - 0x98DD
{
	return func_179(iParam0, !bParam1, bParam2);
}

int func_179(int iParam0, bool bParam1, bool bParam2)//Position - 0x98F0
{
	int iVar0;
...
int func_180(int iParam0)//Position - 0x9994
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_181(bool bParam0, bool bParam1, bool bParam2)//Position - 0x99DE
{
	int iVar0;
...
int func_182(int iParam0)//Position - 0x9AC3
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_183(int iParam0)//Position - 0x9B13
{
	...
	else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iParam0, Global_20, false, true, 0))
	{
		...
		switch (iLocal_367)
		{
			...
			case 2:
				...
				else
				{
					...
					{
						case 0:
							if (((!bLocal_666 && func_170()) && !func_81()) && !func_80())
							{
	...
	if (!PED::IS_PED_INJURED(iLocal_84))
	{
		...
		switch (iLocal_367)
		{
			...
			case 4:
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_89, false))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_89, iLocal_84, Global_20 + Vector(2f, 12f, 12f), false, true, 0) && !bLocal_366)
					{
						...
						else
						{
							...
							func_188(259.2552f, 122.2986f, 100.441f, 0);
						}
					}
					else
					{
					...
					if ((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_89, iLocal_84, Global_20, false, true, 0) && func_182(iLocal_89)) && (SYSTEM::TIMERA() > 6000 || !bLocal_366))
					{
						if (!iLocal_621)
						{
							func_109();
						...
						else
						{
							...
							TASK::CLEAR_PED_TASKS(iLocal_84);
							TASK::TASK_ENTER_VEHICLE(iLocal_84, iLocal_89, -1, func_180(iLocal_89), 1f, 8388608, 0, 0);
						}
					}
				}
				break;
			...
			case 101:
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_89, false))
				{
					if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_89, false) && func_189())
					{
						bLocal_366 = true;
						iLocal_72 = 1;
						iLocal_89 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
...
void func_188(struct<3> Param0, bool bParam3)//Position - 0xB438
{
...
int func_192(int iParam0, bool bParam1, int iParam2)//Position - 0xB5B7
{
	int iVar0;
	
	iVar0 = func_179(iParam0, !bParam1, 0);
...
int func_193(int iParam0)//Position - 0xB601
{
	if (func_196())
	{
		Global_114362 = 1;
		Global_114359 = MISC::GET_GAME_TIMER();
		if (func_95(Global_114361))
		{
			func_194(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /* GXT: Random Event */);
		if (iParam0 && func_95(Global_114361))
		{
...
void func_194(int iParam0)//Position - 0xB654
{
	switch (iParam0)
	{
		case 0:
...
char* func_195(int iParam0)//Position - 0xB72F
{
	char* sVar0;
...
int func_196()//Position - 0xB771
{
	switch (func_197(&Global_32888, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_197(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB7A7
{
	int iVar0;
...
void func_198(var uParam0, int iParam1)//Position - 0xB8DE
{
	int iVar0;
...
bool func_199(int iParam0)//Position - 0xB92D
{
	return func_200(iParam0, Global_43922);
}

int func_200(int iParam0, int iParam1)//Position - 0xB93E
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_201(int iParam0)//Position - 0xBB1F
{
	if (Global_43922 == 15)
	{
		return 0;
...
int func_205(float fParam0, bool bParam1)//Position - 0xBD3E
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_206(int iParam0, var uParam1)//Position - 0xBDEF
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_207(uParam1, "Barry3A", func_209(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_208(iParam0), 0, 1);
			break;
		...
		case 8:
			func_207(uParam1, "Dreyfuss1", func_209(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_208(iParam0), 0, 0);
			break;
		...
		case 38:
			func_207(uParam1, "Nigel1A", func_209(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_208(iParam0), 1, 1);
			break;
		...
		case 49:
			func_207(uParam1, "Paparazzo3A", func_209(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_208(iParam0), 0, 1);
			break;
		...
		case 58:
			func_207(uParam1, "Tonya1", func_209(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_208(iParam0), 0, 1);
			break;
...
int func_208(int iParam0)//Position - 0xCFF7
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_209(int iParam0)//Position - 0xD33D
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_210(int iParam0)//Position - 0xD373
{
	struct<2> Var0;
...
bool func_212()//Position - 0xD7F0
{
	return Global_114090 > 0;
}

int func_213()//Position - 0xD7FE
{
	if (Global_98294 != -1)
	{
		return 1;
...
int func_217(struct<3> Param0)//Position - 0xDABD
{
	int iVar0;
...
void func_218(int iParam0, bool bParam1)//Position - 0xDADF
{
	if (bParam1)
	{
...
void func_219(int iParam0, int iParam1, bool bParam2)//Position - 0xDB16
{
	int iVar0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_90() == 0)
		{
			iVar0 = func_126(func_220(iParam0), -1);
			MISC::CLEAR_BIT(&iVar0, iParam1);
			func_121(func_220(iParam0), iVar0, -1, 1);
		}
	}
	else
	{
...
int func_220(int iParam0)//Position - 0xDB86
{
	switch (iParam0)
	{
		case 0:
...
void func_221(int iParam0, int iParam1, bool bParam2)//Position - 0xDF2E
{
	int iVar0;
...
int func_222(int iParam0, int iParam1, bool bParam2)//Position - 0xDF9E
{
	if (iParam0 == -1)
	{
		return 0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_90() == 0)
		{
			return BitTest(func_126(func_220(iParam0), -1), iParam1);
		}
	}
	else
	{
...
int func_224(var uParam0)//Position - 0xE139
{
	int iVar0;
...
bool func_225(var uParam0)//Position - 0xE195
{
	return func_226(*uParam0, "NULL", uParam0->f_1);
}

int func_226(char* sParam0, char* sParam1, int iParam2)//Position - 0xE1AA
{
	if (BitTest(sParam0, 30))
	{
		if (BitTest(sParam0, 29))
		{
			switch (func_227(sParam0))
			{
				case 0:
...
int func_227(var uParam0)//Position - 0xE295
{
	bool bVar0;
...
void func_228(var uParam0)//Position - 0xE2BE
{
	func_229(uParam0, 9, -1, 0);
}

void func_229(var uParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xE2D0
{
	int iVar0;
...
int func_230(int iParam0)//Position - 0xE38A
{
	switch (iParam0)
	{
		case -1:
...
void func_231(var uParam0, int iParam1)//Position - 0xE429
{
	func_229(uParam0, 0, iParam1, 0);
}

int func_232()//Position - 0xE43B
{
	if (!func_199(5))
	{
		return 1;
...
int func_233()//Position - 0xE49D
{
	if ((Global_114361 == func_104() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_114362)
	{
		return 1;
	}
	return 0;
...
void func_234(var uParam0)//Position - 0xE4C8
{
	int iVar0;
...
void func_235(int* iParam0)//Position - 0xE546
{
	func_236(iParam0, "NULL", iParam0->f_1);
}

void func_236(int* iParam0, char* sParam1, int iParam2)//Position - 0xE55A
{
...
void func_237(int iParam0)//Position - 0xE62B
{
	if (iParam0 == -1)
	{
		iParam0 = func_104();
...
void func_239(int iParam0)//Position - 0xE69E
{
	Global_114361 = iParam0;
}

int func_240(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xE6AC
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (func_26(func_24()))
		{
			if (func_278(func_24()) == 4 || func_278(func_24()) == 5)
			{
				return 0;
			}
		}
		if (func_26(func_24()))
		{
			if (!func_277(iParam3, bParam4, 145))
			{
				return 0;
			}
		}
		if (!func_276(Global_114372.f_24998.f_43[iParam3]))
		{
			return 0;
		}
		...
		if (func_265(iParam3, bParam4) && !bParam5)
		{
			return 0;
		}
		...
		if ((iParam3 == 9 && (bParam4 == 2 || bParam4 == 5)) && !func_265(0, 0))
		{
			return 0;
		}
		if (Global_32975)
...
bool func_241(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xEA46
{
	if (bParam6)
	{
...
bool func_242(int iParam0)//Position - 0xEA8D
{
	int iVar0;
...
int func_243(int iParam0)//Position - 0xEAAE
{
	return func_244(iParam0, 1);
}

int func_244(int iParam0, int iParam1)//Position - 0xEABD
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	func_245(iParam0, &uVar0, &uVar1, &iVar2, &iVar3, &iVar4, &iVar5);
...
void func_245(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xEB10
{
	func_246(func_257(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_246(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xEB2E
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_256(iParam0, iParam1))
	{
		...
		iVar2 = (func_253(iParam0) - func_253(iParam1));
		iVar3 = (func_255(iParam0) - func_255(iParam1));
		iVar4 = (func_252(iParam0) - func_252(iParam1));
		iVar5 = (func_251(iParam0) - func_251(iParam1));
		iVar6 = (func_250(iParam0) - func_250(iParam1));
		iVar7 = (func_249(iParam0) - func_249(iParam1));
	}
	else
	{
		iVar0 = func_255(iParam0);
		iVar1 = func_253(iParam1);
		iVar2 = (func_253(iParam1) - func_253(iParam0));
		iVar3 = (func_255(iParam1) - func_255(iParam0));
		iVar4 = (func_252(iParam1) - func_252(iParam0));
		iVar5 = (func_251(iParam1) - func_251(iParam0));
		iVar6 = (func_250(iParam1) - func_250(iParam0));
		iVar7 = (func_249(iParam1) - func_249(iParam0));
	}
	while (iVar7 < 0)
	{
		iVar7 += 60;
	...
	while (iVar4 < 0)
	{
		...
		iVar4 = (iVar4 + func_248(iVar0, iVar1));
		iVar3 = (iVar3 - 1);
		iVar0 = SYSTEM::ROUND(func_247(SYSTEM::TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
float func_247(float fParam0, float fParam1, float fParam2)//Position - 0xED2F
{
	float fVar0;
...
int func_248(int iParam0, int iParam1)//Position - 0xED71
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_249(int iParam0)//Position - 0xEE13
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_250(int iParam0)//Position - 0xEE26
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_251(int iParam0)//Position - 0xEE39
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_252(int iParam0)//Position - 0xEE4C
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_253(int iParam0)//Position - 0xEE5E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_254(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_254(bool bParam0, int iParam1, int iParam2)//Position - 0xEE80
{
	if (bParam0)
	{
		return iParam1;
...
int func_255(int iParam0)//Position - 0xEE97
{
	return iParam0 & 15;
}

int func_256(int iParam0, int iParam1)//Position - 0xEEA4
{
	int iVar0;
	int iVar1;
...
void func_258(var uParam0, int iParam1)//Position - 0xEFF6
{
	if (iParam1 <= 0)
	{
		return;
...
void func_259(var uParam0, int iParam1)//Position - 0xF07C
{
...
void func_260(var uParam0, int iParam1)//Position - 0xF0AF
{
	int iVar0;
	int iVar1;
	...
	if (iParam1 < 1 || iParam1 > func_248(iVar0, iVar1))
	{
		return;
	}
...
void func_261(var uParam0, int iParam1)//Position - 0xF100
{
...
void func_262(var uParam0, int iParam1)//Position - 0xF13A
{
...
void func_263(var uParam0, int iParam1)//Position - 0xF175
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_264(int iParam0)//Position - 0xF1B1
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar5 < 1 || iVar5 > func_248(iVar4, iVar3))
	{
		return 0;
	}
	return 1;
...
int func_265(int iParam0, bool bParam1)//Position - 0xF28D
{
...
int func_266(int iParam0)//Position - 0xF2AD
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_274()) || Global_113419) || Global_32831) || func_273()) || func_19(8, -1)) || func_272()) || func_271()) || func_270()) || func_269()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_274()) || Global_32831) || func_273()) || func_19(8, -1)) || func_270()) || func_272()) || func_271()) || func_269()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_274()) || Global_113419) || Global_32831) || func_273()) || func_19(8, -1)) || func_270()) || func_272()) || func_271()) || func_269()) || Global_114372.f_7691.f_919[iVar0] == 5) || Global_44469 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_274()) || Global_113419) || Global_32831) || func_273()) || func_19(8, -1)) || func_272()) || func_271()) || func_269()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_274() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_19(8, -1)) || func_269()) || func_268()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_274()) || func_271()) || Global_113419) || Global_32831) || func_273()) || Global_45122) || func_19(8, -1)) || func_270()) || func_268()) || func_269()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_274()) || Global_113419) || Global_32831) || func_273()) || func_19(8, -1)) || func_270()) || func_268()) || func_272()) || func_271()) || func_269())
						{
							return 0;
						}
						break;
...
var func_267()//Position - 0xF9CA
{
	return Global_101431.f_1;
}

int func_268()//Position - 0xF9D8
{
	if (Global_98294 != -1)
	{
...
bool func_271()//Position - 0xFA3F
{
	return Global_101444.f_394 > 0;
}

bool func_272()//Position - 0xFA50
{
	return Global_101444.f_393 > 0;
}

var func_273()//Position - 0xFA61
{
	return Global_1575079;
}

int func_274()//Position - 0xFA6D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_276(int iParam0)//Position - 0xFAB1
{
	return func_256(func_257(), iParam0);
}

int func_277(int iParam0, int iParam1, int iParam2)//Position - 0xFAC3
{
	int iVar0;
	int iVar1;
...
int func_278(int iParam0)//Position - 0xFBA7
{
	if (!func_26(iParam0))
	{
		return 7;
...
int func_279(int iParam0)//Position - 0xFBCB
{
	int iVar0;
	int iVar1;
...
void func_282(var uParam0, int iParam1)//Position - 0xFD1F
{
	if (iParam1 > 0)
	{
...
void func_285(int iParam0)//Position - 0xFEA6
{
	char cVar0[64];
	...
	if (func_233())
	{
		...
		func_288(30000);
		StringCopy(&cVar0, func_287(Global_114361, 1), 64);
		if (func_103(Global_114361) > 0)
		{
...
void func_286(var uParam0)//Position - 0xFF58
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_287(int iParam0, bool bParam1)//Position - 0xFF95
{
	switch (iParam0)
	{
		case 0:
...
struct<16> func_291(var uParam0)//Position - 0x10298
{
	...
	StringConCat(&Var0, "/", 64);
	StringIntConCat(&Var0, func_253(*uParam0), 64);
	return Var0;
}
...
void func_293(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1037F
{
	...
	iVar2 = func_252(*uParam0);
	iVar3 = func_251(*uParam0);
	iVar4 = func_250(*uParam0);
...
void func_300(int iParam0, char* sParam1, int iParam2)//Position - 0x10778
{
	if (BitTest(iParam0, 30))
	{
		switch (func_227(iParam0))
