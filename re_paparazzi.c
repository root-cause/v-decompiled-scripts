...
void func_25()//Position - 0x13BB
{
	...
	{
		if (func_28(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_118(bool bParam0)//Position - 0x7868
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_120() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_120() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
bool func_152()//Position - 0x896A
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_153(int iParam0, int iParam1)//Position - 0x8984
{
	bool bVar0;
...
int func_154(int iParam0, bool bParam1)//Position - 0x89CF
{
	int iVar0;
	int iVar1;
...
int func_155(int iParam0)//Position - 0x8A10
{
...
bool func_156()//Position - 0x8A4F
{
	return BitTest(Global_2621446, 3);
}

int func_157(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x8A5D
{
	int iVar0;
...
void func_158(int iParam0)//Position - 0x8A90
{
	if (iParam0 == 1)
	{
...
var func_160()//Position - 0x92BF
{
	return Global_32197;
}

int func_161(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x92CA
{
...
void func_162(int iParam0)//Position - 0x9462
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_163(char* sParam0)//Position - 0x948E
{
	struct<3> Var0;
...
int func_164(char* sParam0, bool bParam1)//Position - 0x94E2
{
	if (bParam1)
	{
		if (!iLocal_58)
...
struct<6> func_165()//Position - 0x9592
{
	struct<6> Var0;
	int iVar1;
	int iVar2;
...
bool func_166(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x963E
{
	func_21(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
int func_170(struct<3> Param0, bool bParam1)//Position - 0x9753
{
	return func_56(Param0, bParam1);
}

void func_171()//Position - 0x9765
{
	if (func_24() == 2)
	{
		if (!Global_32199)
...
void func_172(char* sParam0, int iParam1)//Position - 0x9789
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_173()//Position - 0x97A0
{
...
void func_174(bool bParam0)//Position - 0x97BC
{
...
int func_175(int iParam0, bool bParam1, bool bParam2)//Position - 0x9890
{
	return func_176(iParam0, !bParam1, bParam2);
}

int func_176(int iParam0, bool bParam1, bool bParam2)//Position - 0x98A3
{
	int iVar0;
...
int func_177(int iParam0)//Position - 0x9947
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_178(bool bParam0, bool bParam1, bool bParam2)//Position - 0x9991
{
	int iVar0;
...
int func_179(int iParam0)//Position - 0x9A76
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_180(int iParam0)//Position - 0x9AC6
{
...
void func_185(struct<3> Param0, bool bParam1)//Position - 0xB3E8
{
...
int func_189(int iParam0, bool bParam1, int iParam2)//Position - 0xB567
{
	int iVar0;
...
int func_190(int iParam0)//Position - 0xB5B1
{
	if (func_193())
	{
		Global_113376 = 1;
...
void func_191(int iParam0)//Position - 0xB604
{
	switch (iParam0)
	{
		case 0:
...
char* func_192(int iParam0)//Position - 0xB6DF
{
	char* sVar0;
...
int func_193()//Position - 0xB721
{
	switch (func_194(&Global_32019, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_194(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB757
{
	int iVar0;
...
void func_195(var uParam0, int iParam1)//Position - 0xB88E
{
	int iVar0;
...
bool func_196(int iParam0)//Position - 0xB8DD
{
	return func_197(iParam0, Global_43052);
}

int func_197(int iParam0, int iParam1)//Position - 0xB8EE
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_198(int iParam0)//Position - 0xBACF
{
	if (Global_43052 == 15)
	{
		return 0;
...
int func_202(float fParam0, bool bParam1)//Position - 0xBCEE
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_203(int iParam0, var uParam1)//Position - 0xBD9F
{
	switch (iParam0)
	{
		case 0:
...
int func_205(int iParam0)//Position - 0xCFA6
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_206(int iParam0)//Position - 0xD2EC
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_207(int iParam0)//Position - 0xD322
{
	struct<2> Var0;
...
bool func_209()//Position - 0xD79F
{
	return Global_113104 > 0;
}

int func_210()//Position - 0xD7AD
{
	if (Global_97363 != -1)
	{
		return 1;
...
int func_214(struct<3> Param0)//Position - 0xDA6C
{
	int iVar0;
...
void func_215(int iParam0, bool bParam1)//Position - 0xDA8E
{
	if (bParam1)
	{
...
void func_216(int iParam0, int iParam1, bool bParam2)//Position - 0xDAC5
{
	int iVar0;
...
int func_217(int iParam0)//Position - 0xDB37
{
	switch (iParam0)
	{
		case 0:
...
void func_218(int iParam0, int iParam1, bool bParam2)//Position - 0xDEB2
{
	int iVar0;
...
int func_219(int iParam0, int iParam1, bool bParam2)//Position - 0xDF24
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_221(var uParam0)//Position - 0xE0C0
{
	int iVar0;
...
bool func_222(var uParam0)//Position - 0xE11C
{
	return func_223(*uParam0, "NULL", uParam0->f_1);
}

int func_223(char* sParam0, char* sParam1, int iParam2)//Position - 0xE131
{
...
int func_224(var uParam0)//Position - 0xE21C
{
	bool bVar0;
...
void func_225(var uParam0)//Position - 0xE245
{
	func_226(uParam0, 9, -1, 0);
}

void func_226(var uParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xE257
{
	int iVar0;
...
int func_227(int iParam0)//Position - 0xE311
{
	switch (iParam0)
	{
		case -1:
...
void func_228(var uParam0, int iParam1)//Position - 0xE3B0
{
	func_226(uParam0, 0, iParam1, 0);
}

int func_229()//Position - 0xE3C2
{
	if (!func_196(5))
	{
		return 1;
...
int func_230()//Position - 0xE424
{
	if ((Global_113375 == func_104() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_113376)
	{
		return 1;
	}
	return 0;
...
void func_231(var uParam0)//Position - 0xE44F
{
	int iVar0;
...
void func_232(int* iParam0)//Position - 0xE4CD
{
	func_233(iParam0, "NULL", iParam0->f_1);
}

void func_233(int* iParam0, char* sParam1, int iParam2)//Position - 0xE4E1
{
...
void func_234(int iParam0)//Position - 0xE5B2
{
	if (iParam0 == -1)
	{
		iParam0 = func_104();
...
void func_236(int iParam0)//Position - 0xE625
{
	Global_113375 = iParam0;
}

int func_237(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE633
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
...
bool func_238(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0xE9CD
{
	if (bParam2)
	{
...
bool func_239(int iParam0)//Position - 0xEA14
{
	int iVar0;
...
int func_240(int iParam0)//Position - 0xEA35
{
	return func_241(iParam0, 1);
}

int func_241(int iParam0, int iParam1)//Position - 0xEA44
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_242(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xEA97
{
	func_243(func_254(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_243(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xEAB5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_244(float fParam0, float fParam1, float fParam2)//Position - 0xECB6
{
	float fVar0;
...
int func_245(int iParam0, int iParam1)//Position - 0xECF8
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_246(int iParam0)//Position - 0xED9A
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_247(int iParam0)//Position - 0xEDAD
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_248(int iParam0)//Position - 0xEDC0
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_249(int iParam0)//Position - 0xEDD3
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_250(int iParam0)//Position - 0xEDE5
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_251(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_251(bool bParam0, int iParam1, int iParam2)//Position - 0xEE07
{
	if (bParam0)
	{
		return iParam1;
...
int func_252(int iParam0)//Position - 0xEE1E
{
	return iParam0 & 15;
}

int func_253(int iParam0, int iParam1)//Position - 0xEE2B
{
	int iVar0;
	int iVar1;
...
void func_255(var uParam0, int iParam1)//Position - 0xEF7D
{
	if (iParam1 <= 0)
	{
		return;
...
void func_256(var uParam0, int iParam1)//Position - 0xF003
{
...
void func_257(var uParam0, int iParam1)//Position - 0xF036
{
	int iVar0;
	int iVar1;
...
void func_258(var uParam0, int iParam1)//Position - 0xF087
{
...
void func_259(var uParam0, int iParam1)//Position - 0xF0C1
{
...
void func_260(var uParam0, int iParam1)//Position - 0xF0FC
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_261(int iParam0)//Position - 0xF138
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_262(int iParam0, bool bParam1)//Position - 0xF214
{
...
int func_263(int iParam0)//Position - 0xF234
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_271()) || Global_31962) || func_270()) || func_19(8, -1)) || func_267()) || func_269()) || func_268()) || func_266()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_271()) || Global_112433) || Global_31962) || func_270()) || func_19(8, -1)) || func_269()) || func_268()) || func_266()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_271() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_19(8, -1)) || func_266()) || func_265()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_271()) || Global_31962) || func_270()) || func_19(8, -1)) || func_268()) || func_267()) || func_266()) || Global_113386.f_7688.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_264()//Position - 0xF951
{
	return Global_100480.f_1;
}

int func_265()//Position - 0xF95F
{
	if (Global_97363 != -1)
	{
...
bool func_268()//Position - 0xF9C6
{
	return Global_100493.f_376 > 0;
}

bool func_269()//Position - 0xF9D7
{
	return Global_100493.f_375 > 0;
}

var func_270()//Position - 0xF9E8
{
	return Global_1575058;
}

int func_271()//Position - 0xF9F4
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_273(int iParam0)//Position - 0xFA38
{
	return func_253(func_254(), iParam0);
}

int func_274(int iParam0, int iParam1, int iParam2)//Position - 0xFA4A
{
	int iVar0;
	int iVar1;
...
int func_275(int iParam0)//Position - 0xFB2E
{
	if (!func_26(iParam0))
	{
		return 7;
...
int func_276(int iParam0)//Position - 0xFB52
{
	int iVar0;
	int iVar1;
...
void func_279(var uParam0, int iParam1)//Position - 0xFCA6
{
	if (iParam1 > 0)
	{
...
void func_282(int iParam0)//Position - 0xFE2D
{
	char cVar0[64];
...
void func_283(var uParam0)//Position - 0xFEDF
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_284(int iParam0, bool bParam1)//Position - 0xFF1C
{
	switch (iParam0)
	{
		case 0:
...
void func_285(int iParam0)//Position - 0x10167
{
	Global_43603 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_286(int iParam0)//Position - 0x10179
{
	func_287(iParam0, 0, func_292(iParam0));
}

void func_287(int iParam0, int iParam1, int iParam2)//Position - 0x1018E
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_288(var uParam0)//Position - 0x101BD
{
	struct<16> Var0;
	int iVar1;
...
void func_289(int iParam0, var uParam1)//Position - 0x1028C
{
	Global_113386.f_24995.f_43[iParam0] = *uParam1;
}

void func_290(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x102A4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_291(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x10426
{
...
int func_292(int iParam0)//Position - 0x1045E
{
	int iVar0;
...
void func_293(var uParam0, bool bParam1)//Position - 0x10601
{
	int iVar0;
...
void func_294(var uParam0)//Position - 0x10641
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
}

void func_295(var uParam0)//Position - 0x10652
{
	int iVar0;
...
void func_296(var uParam0)//Position - 0x10688
{
	func_297(*uParam0, "NULL", uParam0->f_1);
}

void func_297(int iParam0, char* sParam1, int iParam2)//Position - 0x1069D
{
	if (BitTest(iParam0, 30))
	{
		switch (func_224(iParam0))
...
void func_298(bool bParam0)//Position - 0x10757
{
	int iVar0;
