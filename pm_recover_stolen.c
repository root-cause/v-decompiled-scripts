...
void func_1()//Position - 0xBA
{
	...
	switch (iLocal_34)
	{
		case 0:
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_112842.f_222[0]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112842.f_222[0], false))
				{
				...
				if (ENTITY::DOES_ENTITY_EXIST(Global_112842.f_225[1]))
				{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_243) && !PED::IS_PED_INJURED(iLocal_243))
	{
		...
		else if (((func_33(iLocal_243, joaat("SCRIPT_TASK_PERFORM_SEQUENCE"), 1) && TASK::GET_SEQUENCE_PROGRESS(iLocal_243) < 1) && !iLocal_67) && (((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_35, Local_35.f_3, Local_35.f_6, false, true, 0) || PED::HAS_PED_RECEIVED_EVENT(iLocal_243, 124)) || PED::HAS_PED_RECEIVED_EVENT(iLocal_243, 125)) || PED::HAS_PED_RECEIVED_EVENT(iLocal_243, 126)) || PED::HAS_PED_RECEIVED_EVENT(iLocal_243, 23)) || func_32(Global_112842.f_35, 134217728)))
		{
...
int func_53(int iParam0)//Position - 0x2775
{
	if (iParam0 != func_13())
	{
		...
		else if ((Global_1575084 && iParam0 == PLAYER::PLAYER_ID()) && func_54(iParam0, 1, 0))
		{
			return Global_2657991[iParam0 /*467*/].f_324.f_8 != -1;
		}
	}
