	...
	while (true)
	{
		if (Global_113969.f_20413.f_145 > 0 || Global_112606)
		{
				...
				if (!Global_112605)
				{
					if (Global_113969.f_20413.f_145 > 0)
					{
						if (func_20(&(Global_113969.f_20413[iLocal_35 /*16*/])))
						{
							if (func_18(func_19()))
							{
								if (BitTest(Global_113969.f_20413[iLocal_35 /*16*/].f_11, func_12()))
								{
									if (Global_113969.f_20413[iLocal_35 /*16*/].f_12 == Global_113969.f_20413.f_146[func_12()])
									{
										if (MISC::GET_GAME_TIMER() > Global_112608)
										{
											if (MISC::GET_GAME_TIMER() > Global_113969.f_20413[iLocal_35 /*16*/].f_8)
											{
												...
												Local_18 = { Global_113969.f_20413[iLocal_35 /*16*/] };
												Local_18.f_4 = { Global_113969.f_20413[iLocal_35 /*16*/].f_4 };
												Local_18.f_8 = Global_113969.f_20413[iLocal_35 /*16*/].f_8;
												Local_18.f_10 = Global_113969.f_20413[iLocal_35 /*16*/].f_10;
												Local_18.f_9 = Global_113969.f_20413[iLocal_35 /*16*/].f_9;
												Local_18.f_11 = Global_113969.f_20413[iLocal_35 /*16*/].f_11;
												Local_18.f_12 = Global_113969.f_20413[iLocal_35 /*16*/].f_12;
												Local_18.f_13 = Global_113969.f_20413[iLocal_35 /*16*/].f_13;
												Local_18.f_14 = Global_113969.f_20413[iLocal_35 /*16*/].f_14;
												Local_18.f_15 = Global_113969.f_20413[iLocal_35 /*16*/].f_15;
												Local_18.f_16 = 0;
			...
			else if (!func_4())
			{
				...
				if ((MISC::GET_GAME_TIMER() - Global_112607) > 4000 || Local_18.f_16)
				{
					if (Local_18.f_14 != 0)
					{
			...
			if (!MISC::ARE_STRINGS_EQUAL(&(Global_113969.f_20413[iLocal_35 /*16*/]), &Local_18) && !MISC::ARE_STRINGS_EQUAL(&(Global_113969.f_20413[iLocal_35 /*16*/]), ""))
			{
...
int func_4()//Position - 0x670
{
	...
	if (Local_18.f_9 != -1 && (MISC::GET_GAME_TIMER() - Global_112607) > Local_18.f_9)
	{
		return 0;
	}
	if (Global_112605)
