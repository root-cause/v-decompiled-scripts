	...
	while (true)
	{
		if (Global_114135.f_20414.f_145 > 0 || Global_112772)
		{
				...
				if (!Global_112771)
				{
					if (Global_114135.f_20414.f_145 > 0)
					{
						if (func_20(&(Global_114135.f_20414[iLocal_35 /*16*/])))
						{
							if (func_18(func_19()))
							{
								if (BitTest(Global_114135.f_20414[iLocal_35 /*16*/].f_11, func_12()))
								{
									if (Global_114135.f_20414[iLocal_35 /*16*/].f_12 == Global_114135.f_20414.f_146[func_12()])
									{
										if (MISC::GET_GAME_TIMER() > Global_112774)
										{
											if (MISC::GET_GAME_TIMER() > Global_114135.f_20414[iLocal_35 /*16*/].f_8)
											{
												if (MISC::ARE_STRINGS_EQUAL(&(Global_114135.f_20414[iLocal_35 /*16*/].f_4), ""))
												{
												...
												Local_18 = { Global_114135.f_20414[iLocal_35 /*16*/] };
												Local_18.f_4 = { Global_114135.f_20414[iLocal_35 /*16*/].f_4 };
												Local_18.f_8 = Global_114135.f_20414[iLocal_35 /*16*/].f_8;
												Local_18.f_10 = Global_114135.f_20414[iLocal_35 /*16*/].f_10;
												Local_18.f_9 = Global_114135.f_20414[iLocal_35 /*16*/].f_9;
												Local_18.f_11 = Global_114135.f_20414[iLocal_35 /*16*/].f_11;
												Local_18.f_12 = Global_114135.f_20414[iLocal_35 /*16*/].f_12;
												Local_18.f_13 = Global_114135.f_20414[iLocal_35 /*16*/].f_13;
												Local_18.f_14 = Global_114135.f_20414[iLocal_35 /*16*/].f_14;
												Local_18.f_15 = Global_114135.f_20414[iLocal_35 /*16*/].f_15;
												Local_18.f_16 = 0;
												Global_112775 = { Global_114135.f_20414[iLocal_35 /*16*/] };
												Global_112773 = MISC::GET_GAME_TIMER();
												iVar0 = iLocal_35;
												while (iVar0 <= (Global_114135.f_20414.f_145 - 2))
												{
			...
			else if (!func_4())
			{
				...
				if ((MISC::GET_GAME_TIMER() - Global_112773) > 4000 || Local_18.f_16)
				{
					if (Local_18.f_14 != 0)
					{
			...
			if (!MISC::ARE_STRINGS_EQUAL(&(Global_114135.f_20414[iLocal_35 /*16*/]), &Local_18) && !MISC::ARE_STRINGS_EQUAL(&(Global_114135.f_20414[iLocal_35 /*16*/]), ""))
			{
				if (Global_114135.f_20414[iLocal_35 /*16*/].f_10 != -1)
				{
					if (MISC::GET_GAME_TIMER() > Global_114135.f_20414[iLocal_35 /*16*/].f_10)
					{
						iVar2 = iLocal_35;
						while (iVar2 <= (Global_114135.f_20414.f_145 - 2))
						{
...
int func_4()//Position - 0x670
{
	...
	if (Local_18.f_9 != -1 && (MISC::GET_GAME_TIMER() - Global_112773) > Local_18.f_9)
	{
		return 0;
	}
	if (Global_112771)
...
void func_13()//Position - 0xA60
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_16(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_18(iVar0) && (!func_14(14) || Global_113083))
			{
