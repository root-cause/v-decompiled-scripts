...
void __EntryFunction__()//Position - 0x0
{
	...
	if (!func_268(31))
	{
		iLocal_35 = Global_114372.f_10052.f_128;
		if (iLocal_35 == 2)
		{
			MISC::SET_BIT(&uLocal_103, 10);
			Local_108 = { func_267(25) };
			fLocal_111 = func_266(25);
			if (func_265(&Local_112, 25))
			{
	...
	{
		func_263("AM_H_PREP8" /* GXT: A getaway vehicle is required for this setup. */, 2, 0, -1, 10000, 7, 0, 0, 0);
		Global_114372.f_10052.f_128 = iLocal_35;
	}
	...
	func_246(2);
	Local_104 = { -166.1555f, -621.9833f, 31.4281f };
	while (true)
	{
		if (func_245(85))
		{
			func_241("AM_H_PREP8" /* GXT: A getaway vehicle is required for this setup. */, 1);
			func_251(31, 0);
		}
...
void func_21(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x9DE
{
	struct<60> Var0;
...
void func_22(int iParam0, int iParam1, int iParam2)//Position - 0xB07
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_114372.f_32753.f_4801 = func_44();
			}
...
void func_23(int iParam0, int iParam1)//Position - 0xC1E
{
	...
	func_65(iParam0, &(Global_114372.f_32753.f_5510));
}
...
int func_26(int iParam0, bool bParam1, int iParam2)//Position - 0x10BB
{
	int iVar0;
	struct<2> Var1;
...
int func_27(int iParam0)//Position - 0x123D
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_29(int iParam0, int iParam1)//Position - 0x131A
{
	int iVar0;
	int iVar1;
...
int func_30(bool bParam0)//Position - 0x6853
{
	if (bParam0)
	{
...
bool func_31()//Position - 0x686D
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_32()//Position - 0x6883
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_33()//Position - 0x6899
{
	return 0;
}

int func_34()//Position - 0x68A2
{
	return 1;
}

int func_35()//Position - 0x68AB
{
	return 1;
}

int func_36()//Position - 0x68B4
{
...
int func_38(int iParam0)//Position - 0x6985
{
	int iVar0;
	char* sVar1;
...
int func_39(int iParam0)//Position - 0x69CC
{
	int iVar0;
...
int func_40(int iParam0)//Position - 0x6A07
{
	int iVar0;
...
int func_41(int iParam0)//Position - 0x6A83
{
	int iVar0;
...
int func_42(int iParam0, int iParam1, bool bParam2)//Position - 0x6B6B
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_43(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x6BD9
{
...
void func_45(var uParam0, int iParam1)//Position - 0x6CF6
{
	if (iParam1 <= 0)
	{
		return;
...
void func_46(var uParam0, int iParam1)//Position - 0x6D7C
{
...
void func_47(var uParam0, int iParam1)//Position - 0x6DAF
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1)//Position - 0x6E00
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_49(int iParam0)//Position - 0x6EA2
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_50(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_50(bool bParam0, int iParam1, int iParam2)//Position - 0x6EC4
{
	if (bParam0)
	{
		return iParam1;
...
int func_51(var uParam0)//Position - 0x6EDB
{
	return uParam0 & 15;
}

void func_52(var uParam0, int iParam1)//Position - 0x6EE8
{
...
void func_53(var uParam0, int iParam1)//Position - 0x6F22
{
...
void func_54(var uParam0, int iParam1)//Position - 0x6F5D
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_55(var uParam0, int iParam1)//Position - 0x6F99
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_80(Global_114372.f_32753.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_80(Global_114372.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_80(Global_114372.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_56(int iParam0, int iParam1)//Position - 0x8686
{
	struct<82> Var0;
...
void func_57(int iParam0, var uParam1, int iParam2)//Position - 0x86C8
{
	int iVar0;
...
bool func_58(int iParam0)//Position - 0x8924
{
	return iParam0 < 3;
}

void func_59(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x8930
{
	if (func_55(&(Global_78038.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_63(iParam0);
			func_62(uParam1, &(Global_114372.f_32753.f_69[Global_78038.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_60(int iParam0, bool bParam1)//Position - 0x8A29
{
	if (iParam0 == -1)
	{
		return;
...
void func_61(int iParam0, int iParam1, bool bParam2)//Position - 0x8A86
{
	if (iParam0 == -1)
	{
		return;
...
void func_62(var uParam0, var uParam1)//Position - 0x8AC1
{
...
void func_63(int iParam0)//Position - 0x8B8D
{
	if (iParam0 == -1)
	{
		return;
...
int func_64(int iParam0)//Position - 0x8C04
{
	int iVar0;
...
void func_65(int iParam0, var uParam1)//Position - 0x8C67
{
	int iVar0;
...
int func_66(int iParam0)//Position - 0x8F12
{
	switch (iParam0)
	{
		case 1:
...
int func_67(int iParam0, var uParam1, var uParam2)//Position - 0x8FC2
{
	int iVar0;
	int iVar1;
...
int func_68(int iParam0)//Position - 0x91B5
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_69(var uParam0)//Position - 0x91D5
{
	int iVar0;
...
void func_70(int iParam0)//Position - 0x9284
{
...
void func_71(bool bParam0)//Position - 0x92AB
{
	if (BitTest(uLocal_103, 14))
	{
...
void func_72(int iParam0)//Position - 0x938F
{
	int iVar0;
...
int func_73(int iParam0)//Position - 0x93AF
{
	int iVar0;
	int iVar1;
...
int func_74(int iParam0)//Position - 0x93EC
{
	if (func_58(iParam0))
	{
...
var func_75(int iParam0)//Position - 0x9411
{
	return Global_2139[iParam0 /*29*/];
}

int func_76(int iParam0, int iParam1)//Position - 0x9420
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x9440
{
	if (iParam0 == -1)
	{
		return 0;
...
bool func_79(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x9478
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

bool func_80(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x9496
{
	if (bParam6)
	{
...
void func_81(int iParam0, bool bParam1)//Position - 0x94DD
{
	Global_114372.f_10052.f_128 = iParam0;
	iLocal_35 = iParam0;
	if (bParam1)
	{
		return;
...
int func_83(bool bParam0)//Position - 0x954C
{
...
void func_84(char* sParam0, var uParam1)//Position - 0x9574
{
...
void func_86()//Position - 0x960B
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_74(Global_114372.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
bool func_87(int iParam0)//Position - 0x9708
{
	return Global_43922 == iParam0;
}

int func_88(int iParam0)//Position - 0x9716
{
	if (func_89(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_89(int iParam0)//Position - 0x9740
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_90(int iParam0, int iParam1)//Position - 0x9761
{
...
void func_91(bool bParam0)//Position - 0x979E
{
	char* sVar0;
...
bool func_92()//Position - 0x9811
{
	func_86();
	return Global_114372.f_2366.f_539.f_4321;
}

void func_93(char* sParam0)//Position - 0x982A
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_94(int iParam0, int iParam1)//Position - 0x983C
{
...
void func_95()//Position - 0x9881
{
	Global_114372.f_10019.f_21++;
	if (iLocal_40 == 0)
	{
		STATS::STAT_SET_INT(joaat("FL_CO_FB4P3"), Global_114372.f_10019.f_21, true);
		if (func_104())
		{
...
void func_97(int iParam0, int iParam1, int iParam2)//Position - 0x9917
{
	bool bVar0;
...
int func_99()//Position - 0x9EBB
{
	return Global_32828;
}

int func_100(int iParam0, int iParam1)//Position - 0x9EC6
{
	int iVar0;
...
void func_101(int iParam0, bool bParam1, int iParam2)//Position - 0x9F17
{
	if (iParam2 == -1)
	{
		iParam2 = func_102();
...
int func_102()//Position - 0x9F35
{
	return Global_1574925;
}

int func_103()//Position - 0x9F41
{
...
int func_106(int iParam0)//Position - 0x9FD0
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
int func_110(int iParam0, int iParam1)//Position - 0xA05B
{
	int iVar0;
	int iVar1;
...
void func_111(int iParam0)//Position - 0xA09C
{
	Global_79509 = iParam0;
	Global_79510 = iParam0;
}

void func_112()//Position - 0xA0B0
{
	struct<6> Var0;
...
void func_113(bool bParam0)//Position - 0xA223
{
	if (bParam0)
	{
...
int func_114(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0xA294
{
	struct<15> Var0;
	int iVar15;
...
void func_115(bool bParam0)//Position - 0xA3E5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_116(int iParam0)//Position - 0xA4A3
{
	switch (iParam0)
	{
		case 0:
...
void func_117(int iParam0)//Position - 0xA50D
{
...
void func_118(int iParam0, int iParam1, int iParam2)//Position - 0xA553
{
...
void func_119(int iParam0, int iParam1, int iParam2)//Position - 0xA598
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_121(struct<6> Param0)//Position - 0xA602
{
	if (iLocal_40 == 0)
	{
		func_126(Param0);
...
void func_122(struct<6> Param0)//Position - 0xA629
{
	if (func_104())
	{
		func_123(Param0, 1);
...
void func_123(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)//Position - 0xA64D
{
	struct<4> Var0;
...
struct<4> func_124(bool bParam0)//Position - 0xA6BD
{
	struct<4> Var0;
...
struct<4> func_125(bool bParam0)//Position - 0xA727
{
	struct<4> Var0;
...
void func_126(struct<6> Param0)//Position - 0xA791
{
	if (func_104())
	{
		if (func_127())
...
void func_129(bool bParam0)//Position - 0xA848
{
...
void func_130(char* sParam0, char* sParam1)//Position - 0xA85C
{
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		Global_22223 = 1;
...
struct<6> func_131()//Position - 0xA87D
{
	struct<6> Var0;
...
void func_132()//Position - 0xA8A1
{
	func_133();
}

void func_133()//Position - 0xA8AD
{
	func_137();
	func_134();
}

void func_134()//Position - 0xA8BD
{
	if (func_136() == 85)
	{
...
int func_136()//Position - 0xA91E
{
	return Global_79511;
}

void func_137()//Position - 0xA92A
{
	if (!func_80(Local_108, 0f, 0f, 0f, 0) && func_136() != func_138())
	{
...
void func_139()//Position - 0xA9D6
{
	func_17();
	func_112();
}

void func_140()//Position - 0xA9E6
{
	func_154();
	func_150();
	func_147();
	func_112();
	if (func_79(PLAYER::PLAYER_PED_ID(), Local_104, 150f, 1) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -176.9431f, -651.257f, 31.2136f, -150.9563f, -579.7476f, 35.4245f, 50f, false, true, 0))
	{
		MISC::CLEAR_AREA_OF_VEHICLES(Local_104, 6f, false, true, false, false, false, false, 0);
	...
	if (!BitTest(uLocal_103, 18))
	{
		...
		{
			func_146(sLocal_51[4], 7500, 0);
			MISC::SET_BIT(&uLocal_103, 18);
		}
	}
	if (BitTest(uLocal_103, 0))
	{
		if (BitTest(uLocal_103, 1))
		{
			...
			if (func_88(iLocal_107))
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_107, false))
				{
					if (VEHICLE::IS_VEHICLE_STOPPED(iLocal_107))
					{
						func_142();
...
void func_141(var uParam0)//Position - 0xABAD
{
	if (*uParam0 == -1)
	{
		return;
...
int func_143(int iParam0)//Position - 0xAC4A
{
...
bool func_144(char* sParam0, int iParam1, char* sParam2)//Position - 0xAC7A
{
...
void func_145(int* iParam0)//Position - 0xAC98
{
...
void func_146(char* sParam0, int iParam1, int iParam2)//Position - 0xACB8
{
	iParam2 = iParam2;
...
void func_147()//Position - 0xACD1
{
	switch (iLocal_36)
	{
		case 0:
			if (((!HUD::DOES_BLIP_EXIST(iLocal_1436) && BitTest(uLocal_103, 0)) && !BitTest(uLocal_103, 1)) && BitTest(uLocal_103, 18))
			{
				iLocal_1436 = func_148(Local_104, 1);
...
int func_148(struct<3> Param0, bool bParam3)//Position - 0xAD40
{
	int iVar0;
	
	iVar0 = HUD::ADD_BLIP_FOR_COORD(Param0);
	HUD::SET_BLIP_SCALE(iVar0, func_149(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
	HUD::SET_BLIP_ROUTE(iVar0, bParam3);
	return iVar0;
}

float func_149(bool bParam0, float fParam1, float fParam2)//Position - 0xAD6C
{
	if (bParam0)
	{
		return fParam1;
	...
	if (func_106(35))
	{
		if (iLocal_36 == 0)
		{
			if (!BitTest(uLocal_103, 1))
			{
				if (func_88(iLocal_107))
				{
					ENTITY::IS_ENTITY_AT_COORD(iLocal_107, Local_104, 4f, 4f, 2f, true, true, 0);
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_107, -168.81618f, -619.9002f, 31.42446f, -162.64235f, -622.0781f, 33.42446f, 4.14f, false, true, 0))
					{
						func_153(24, 46);
						if (func_152(iLocal_107))
						{
			...
			{
				if (!func_79(iLocal_107, Local_104, 10f, 1) || ENTITY::IS_ENTITY_UPSIDEDOWN(iLocal_107))
				{
					MISC::CLEAR_BIT(&uLocal_103, 1);
				}
			}
...
int func_151(float fParam0, int iParam1)//Position - 0xAE40
{
	int iVar0;
...
int func_152(int iParam0)//Position - 0xAEC4
{
	struct<3> Var0;
...
void func_153(bool bParam0, bool bParam1)//Position - 0xAF79
{
	func_4(bParam0);
								...
								if (!func_171(iVar0))
								{
									if (func_164(iVar0) && !func_163())
									{
										if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(iVar0))
										{
											...
											{
												func_72(9);
												MISC::SET_BIT(&uLocal_103, 19);
											}
											else if (func_73(PLAYER::PLAYER_PED_ID()) == 0)
											{
												func_72(17);
											}
											else
...
int func_155(int iParam0)//Position - 0xB295
{
...
void func_156(int iParam0)//Position - 0xB2C6
{
	if (func_160())
	{
		return;
...
void func_158(bool bParam0, bool bParam1)//Position - 0xB377
{
	if (bParam0)
	{
		if (func_15(0))
...
bool func_159()//Position - 0xB3EB
{
	return BitTest(Global_1956030, 5);
}

bool func_160()//Position - 0xB3F9
{
	return BitTest(Global_1956030, 19);
}

void func_161()//Position - 0xB408
{
	MISC::CLEAR_BIT(&uLocal_103, 0);
	MISC::CLEAR_BIT(&uLocal_103, 8);
	MISC::CLEAR_BIT(&uLocal_103, 7);
...
int func_162(int iParam0)//Position - 0xB426
{
...
int func_164(int iParam0)//Position - 0xB4AE
{
...
int func_165(int iParam0)//Position - 0xB4D8
{
	int iVar0;
...
int func_166(int iParam0)//Position - 0xB4F9
{
...
int func_167(int iParam0)//Position - 0xB526
{
	int iVar0;
...
int func_168(int iParam0)//Position - 0xB57A
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0xB5BF
{
	int iVar0;
...
int func_171(int iParam0)//Position - 0xB681
{
	if (DECORATOR::DECOR_EXIST_ON(iParam0, "GetawayVehicleValid"))
	{
		return 1;
...
void func_173()//Position - 0xB6BD
{
	...
	if (func_209())
	{
		if (func_203(&uLocal_1437) && func_174(&iVar0))
		{
			func_254(0);
			if (iVar0 == 1)
			{
...
int func_174(var uParam0)//Position - 0xB709
{
	char* sVar0;
...
int func_175()//Position - 0xB749
{
	if (func_177(&uLocal_1271, Local_42.f_8, sLocal_1270, Local_42.f_4, 9, 1, 0, 0, 0))
	{
		iLocal_38 = 1;
...
void func_176(int iParam0, struct<3> Param1)//Position - 0xB783
{
	int iVar0;
...
bool func_177(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0xB7D2
{
...
int func_178(char* sParam0, int iParam1, bool bParam2)//Position - 0xB831
{
	Global_22167 = 0;
...
bool func_181(int iParam0)//Position - 0xBB99
{
	return func_182(iParam0, 20);
}

var func_182(int iParam0, int iParam1)//Position - 0xBBA9
{
	return BitTest(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_183()//Position - 0xBBC1
{
	return -1;
}

void func_184()//Position - 0xBBCA
{
	int iVar0;
...
bool func_189(int iParam0, int iParam1)//Position - 0xBE20
{
	switch (iParam0)
	{
		case 5:
...
void func_191(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xBEAF
{
...
void func_193(bool bParam0, var uParam1)//Position - 0xBF1F
{
	int iVar0;
	...
	func_194(&uLocal_1271, Local_42.f_0, PLAYER::PLAYER_PED_ID(), Local_42.f_1, 0, 1);
	func_194(&uLocal_1271, Local_42.f_2, 0, Local_42.f_3, 0, 1);
	Local_42.f_4 = uParam1;
}

void func_194(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC096
{
...
void func_195(int iParam0, int iParam1, bool bParam2)//Position - 0xC131
{
	int iVar0;
		...
		if (bParam2)
		{
			if (!Global_79248)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9342[iParam1 /*4*/] = { func_197(iParam0) };
					...
					{
						Global_9293[1 /*6*/] = { func_197(iParam0) };
...
struct<4> func_197(int iParam0)//Position - 0xC328
{
	return Global_2139[iParam0 /*29*/].f_3;
}

int func_198(int iParam0, int iParam1)//Position - 0xC33B
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
int func_199(int iParam0, int iParam1)//Position - 0xC365
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
char* func_202(bool bParam0)//Position - 0xDC3D
{
	char* sVar0;
...
int func_203(var uParam0)//Position - 0xDD47
{
...
int func_204(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xDD99
{
	int iVar0;
...
void func_205(var uParam0, int iParam1)//Position - 0xDED0
{
	int iVar0;
...
bool func_206(int iParam0)//Position - 0xDF1F
{
	return func_207(iParam0, Global_43922);
}

int func_207(int iParam0, int iParam1)//Position - 0xDF30
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_208(int iParam0)//Position - 0xE111
{
	if (Global_43922 == 15)
	{
		return 0;
...
int func_210(int iParam0)//Position - 0xE159
{
	if (Global_23281 == 0)
	{
		return 0;
...
void func_212()//Position - 0xE1CF
{
	int iVar0;
	bool bVar1;
	
	if (((((((Global_43922 == 15 && iLocal_35 != 3) && BitTest(uLocal_103, 5)) && !func_172()) && Global_79245 == -1) && !func_222()) && !func_87(9)) || func_106(35))
	{
		func_221();
		func_220();
		switch (iLocal_37)
		{
			...
			case 3:
			case 4:
				func_214(bLocal_98, 1);
				break;
		}
	}
	else if (((((((Global_43922 != 15 || Global_43922 != 0) || Global_43922 != 2) || Global_43922 != 4) || Global_43922 != 17) || func_172()) || Global_79245 == -1) || Global_113427)
	{
		bVar1 = false;
		if (func_213())
		{
...
bool func_213()//Position - 0xE357
{
	return SCRIPT::IS_THREAD_ACTIVE(Global_114372.f_18106.f_395);
}

void func_214(bool bParam0, bool bParam1)//Position - 0xE36D
{
	switch (iLocal_37)
	{
		case 1:
...
void func_215(char* sParam0, int iParam1)//Position - 0xE477
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_216()//Position - 0xE48E
{
...
int func_217(bool bParam0)//Position - 0xE4A8
{
	int iVar0;
	...
	if (func_58(bParam0))
	{
		if (func_218(bParam0))
		{
			...
			while (iVar0 < Global_114372.f_7691.f_136)
			{
				if (Global_114372.f_7691[iVar0 /*15*/].f_3 == 5)
				{
					return 1;
				}
				iVar0++;
...
int func_218(bool bParam0)//Position - 0xE4F2
{
	int iVar0;
	...
	{
		if (BitTest(Global_114372.f_7691.f_651[iVar0 /*14*/].f_2, bParam0))
		{
			return 1;
		}
		iVar0++;
	...
	{
		if (BitTest(Global_114372.f_7691.f_765[iVar0 /*10*/].f_2, bParam0))
		{
			return 1;
		}
		iVar0++;
...
void func_219(var uParam0, int iParam1)//Position - 0xE5A0
{
	bool bVar0;
	...
	if (iLocal_35 == 0 || iLocal_35 == 1)
	{
		switch (iLocal_36)
		{
			case 0:
				...
				{
					if (((((((!func_2(func_3(7)) && !func_2(func_3(8))) && !func_2(func_3(10))) && !func_2(func_3(11))) && !func_2(func_3(12))) && !func_2(func_3(13))) && !func_213()) && !Global_113009)
					{
						MISC::SET_BIT(&uLocal_103, 15);
						HUD::CLEAR_HELP(true);
					}
...
int func_230()//Position - 0xEAC3
{
	if (((((Global_43922 == 15 && !func_172()) && Global_79245 == -1) && !func_213()) && !func_231(1112014848)) && !Global_113427)
	{
		return 1;
	}
	return 0;
...
int func_231(float fParam0)//Position - 0xEB11
{
	if (iLocal_40 == 1)
	{
...
int func_234(int iParam0)//Position - 0xEC1D
{
	return func_235(iParam0, 6, 1);
}

int func_235(int iParam0, int iParam1, bool bParam2)//Position - 0xEC2D
{
	if (iParam0 == -1)
	{
		return 0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_99() == 0)
		{
			return BitTest(func_236(func_239(iParam0), -1), iParam1);
		}
	}
	else
	{
...
int func_236(int iParam0, int iParam1)//Position - 0xEC8D
{
	int iVar0;
	var uVar1;
...
int func_237(int iParam0, var uParam1)//Position - 0xECBC
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_238(uParam1));
}

int func_238(var uParam0)//Position - 0xECD1
{
	int iVar0;
	int iVar1;
...
int func_239(int iParam0)//Position - 0xED05
{
	switch (iParam0)
	{
		case 0:
...
int func_240(int iParam0)//Position - 0xF0AD
{
	if (func_89(iParam0))
	{
...
void func_241(char* sParam0, int iParam1)//Position - 0xF0CD
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < Global_114372.f_20413.f_145)
	{
		if (MISC::ARE_STRINGS_EQUAL(sParam0, &(Global_114372.f_20413[iVar0 /*16*/])))
		{
			...
			func_243((Global_114372.f_20413.f_145 - 1));
...
void func_243(int iParam0)//Position - 0xF291
{
...
void func_244(int iParam0, int iParam1)//Position - 0xF329
{
...
int func_245(int iParam0)//Position - 0xF439
{
...
void func_246(int iParam0)//Position - 0xF465
{
	iLocal_40 = iParam0;
	if (iLocal_40 == 0)
	{
...
void func_247()//Position - 0xF52B
{
	...
	sLocal_51[7] = func_248(7);
	sLocal_51[8] = func_248(8);
	sLocal_51[9] = "PRC_USEFIRST";
	sLocal_51[10] = func_248(10);
	sLocal_51[11] = func_248(11);
	sLocal_51[13] = func_248(13);
	sLocal_51[12] = func_248(12);
	sLocal_51[14] = "PRC_UNUSE";
	sLocal_51[15] = "PRC_SEATS";
	sLocal_51[16] = "PRC_CBOBVAL";
	sLocal_51[17] = func_248(17);
	sLocal_51[18] = func_248(18);
	sLocal_51[20] = func_248(20);
...
char* func_248(int iParam0)//Position - 0xF708
{
	char* sVar0;
...
void func_249()//Position - 0xF8CE
{
	...
	Local_202[0 /*261*/][0 /*8*/] = { func_250("DELBE" /* GXT: Del Perro Beach */, -1615.2574f, -952.59436f, 20.01716f, -2160.7058f, -423f, -1.28679f, 327.8f) };
	Local_202[0 /*261*/][1 /*8*/] = { func_250("DELBE" /* GXT: Del Perro Beach */, -1521.7163f, -914.56757f, 20.17247f, -1855.7148f, -1325.784f, -44.79295f, 254.8f) };
	Local_202[0 /*261*/][2 /*8*/] = { func_250("BEACH" /* GXT: Vespucci Beach */, -1162.3699f, -1815.0084f, 15.33822f, -1553.2072f, -1098.6849f, 0.46467f, 253.91f) };
	Local_202[0 /*261*/][3 /*8*/] = { func_250("BEACH" /* GXT: Vespucci Beach */, -1464.2185f, -1136.7828f, 0.32167f, -2241.5664f, -358.88486f, 20.32481f, 282.21f) };
	Local_202[0 /*261*/][4 /*8*/] = { func_250("PBOX" /* GXT: Pillbox Hill */, 156.41087f, -1042.6412f, 22.31273f, 238.63815f, -821.1217f, 35.10069f, 176.96f) };
	Local_202[0 /*261*/][5 /*8*/] = { func_250("CHIL" /* GXT: Vinewood Hills */, 883.1121f, 534.72833f, 115.72503f, 559.7425f, 644.602f, 150.59714f, 301.08f) };
	Local_202[0 /*261*/][6 /*8*/] = { func_250("EAST_V" /* GXT: East Vinewood */, 941.45306f, -329.4256f, 60.77003f, 727.76514f, -200.95193f, 75.59085f, 88.89f) };
	Local_202[0 /*261*/][7 /*8*/] = { func_250("EAST_V" /* GXT: East Vinewood */, 689.1177f, -273.14056f, 60.21559f, 834.7326f, -352.1655f, 50.92442f, 81.23f) };
	Local_202[0 /*261*/][8 /*8*/] = { func_250("MIRR" /* GXT: Mirror Park */, 1048.4985f, -357.0332f, 60.92149f, 1401.5808f, -783.8975f, 75.7477f, 325.93f) };
	Local_202[0 /*261*/][9 /*8*/] = { func_250("MIRR" /* GXT: Mirror Park */, 892.28357f, -461.57523f, 70.86029f, 1161.3007f, -829.8299f, 45.90131f, 184.12f) };
	Local_202[0 /*261*/][10 /*8*/] = { func_250("VCANA" /* GXT: Vespucci Canals */, -1161.3606f, -1143.7163f, -5.71593f, -864.9714f, -981.12573f, 21.09691f, 328.65f) };
	Local_202[0 /*261*/][11 /*8*/] = { func_250("BAYTRE" /* GXT: Baytree Canyon */, 251.40108f, 1068.3472f, 280.6663f, 189.60123f, 1272.3522f, 143.80351f, 160.32f) };
	Local_202[0 /*261*/][13 /*8*/] = { func_250("OBSERV" /* GXT: Galileo Observatory */, -450.98346f, 1048.4084f, 252.94498f, -389.56403f, 1244.5039f, 370.24692f, 199.93f) };
	Local_202[0 /*261*/][14 /*8*/] = { func_250("AIRP" /* GXT: Los Santos International Airport */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[0 /*261*/][15 /*8*/] = { func_250("TERMINA" /* GXT: Terminal */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[0 /*261*/][16 /*8*/] = { func_250("STAD" /* GXT: Maze Bank Arena */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[0 /*261*/][17 /*8*/] = { func_250("MOVIE" /* GXT: Richards Majestic */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[0 /*261*/][18 /*8*/] = { func_250("GOLF" /* GXT: GWC and Golfing Society */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[0 /*261*/][19 /*8*/] = { func_250("HORS" /* GXT: Vinewood Racetrack */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[0 /*261*/][20 /*8*/] = { func_250("PBOX" /* GXT: Pillbox Hill */, -28.39781f, -1071.2449f, 50.21438f, -49.8352f, -1131.2766f, 20.02555f, 55.12f) };
	Local_202[0 /*261*/][21 /*8*/] = { func_250("LOSSF" /* GXT: Los Santos Freeway */, 843.19617f, 25.93548f, 65.16061f, 1138.6865f, 363.05872f, 105.41279f, 61.11f) };
	Local_202[0 /*261*/][22 /*8*/] = { func_250("ROCKF" /* GXT: Rockford Hills */, -992.56384f, -199.7673f, 30.74956f, -687.9904f, -43.23445f, 80.93306f, 80.53f) };
	Local_202[0 /*261*/][23 /*8*/] = { func_250("ROCKF" /* GXT: Rockford Hills */, -251.8548f, -446.2141f, 29.5887f, -362.685f, -434.7425f, 90.931f, 50f) };
	Local_202[0 /*261*/][24 /*8*/] = { func_250("ALTA" /* GXT: Alta */, 180.2637f, -404.9771f, 40.1713f, 289.9432f, -445.1485f, 124.3793f, 100f) };
	Local_202[0 /*261*/][25 /*8*/] = { func_250("ALTA" /* GXT: Alta */, 343.8481f, -323.1273f, 80.7749f, 427.08f, -361.0469f, 45.3411f, 85f) };
	Local_202[0 /*261*/][26 /*8*/] = { func_250("RANCHO" /* GXT: Rancho */, 414.5057f, -2092.0999f, 19.8533f, 350.8093f, -2158.395f, 12.3916f, 55f) };
	Local_202[0 /*261*/][27 /*8*/] = { func_250("RANCHO" /* GXT: Rancho */, 283.7474f, -2103.9177f, 12.9242f, 391.8871f, -1983.2037f, 33.0042f, 100f) };
	Local_202[0 /*261*/][28 /*8*/] = { func_250("PBOX" /* GXT: Pillbox Hill */, 85.038f, -670.3274f, 42.8642f, 227.8234f, -722.2458f, 274f, 175f) };
	Local_202[0 /*261*/][29 /*8*/] = { func_250("PBOX" /* GXT: Pillbox Hill */, -107.2516f, -906.36f, 28.2051f, -49.9007f, -752.925f, 330f, 125f) };
	Local_202[0 /*261*/][30 /*8*/] = { func_250("TEXTI" /* GXT: Textile City */, 456.8563f, -683.8335f, 32.2903f, 457.5504f, -819.4669f, 25.9553f, 14.4f) };
	Local_202[0 /*261*/][31 /*8*/] = { func_250("ROCKF" /* GXT: Rockford Hills */, -699.7205f, -227.3646f, 67.818f, -645.1068f, -332.5107f, 30.9132f, 127.1f) };
	Local_202[0 /*261*/].f_260 = 0;
	Local_202[0 /*261*/].f_257 = 32;
	Local_202[2 /*261*/][0 /*8*/] = { func_250("PBOX" /* GXT: Pillbox Hill */, -25.50944f, -932.38464f, 20.41711f, 119.94056f, -523.43976f, 33.07988f, 363.4f) };
	Local_202[2 /*261*/][1 /*8*/] = { func_250("DOWNT" /* GXT: Downtown */, -25.50944f, -932.38464f, 20.41711f, 119.94056f, -523.43976f, 33.07988f, 363.4f) };
	Local_202[2 /*261*/][2 /*8*/] = { func_250("COSI" /* GXT: Countryside */, 1426.9344f, 1225.1151f, 90.76305f, 1429.9823f, 1006.8307f, 120.66425f, 259.89f) };
	Local_202[2 /*261*/][3 /*8*/] = { func_250("COSI" /* GXT: Countryside */, 3503.5603f, 3546.4026f, 20.18748f, 3513.9546f, 3875.7952f, 72.94806f, 393.78f) };
	Local_202[2 /*261*/][4 /*8*/] = { func_250("SKID" /* GXT: Mission Row */, 403.54044f, -864.46936f, 20.33799f, 396.34406f, -1127.3247f, 35.49262f, 325.93f) };
	Local_202[2 /*261*/][5 /*8*/] = { func_250("JAIL" /* GXT: Bolingbroke Penitentiary */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[2 /*261*/][6 /*8*/] = { func_250("ARMYB" /* GXT: Fort Zancudo */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[2 /*261*/].f_260 = 2;
	Local_202[2 /*261*/].f_257 = 7;
	Local_202[1 /*261*/][0 /*8*/] = { func_250("PALETO" /* GXT: Paleto Bay */, -422.86185f, 6068.399f, 20.34662f, -282.74524f, 6206.324f, 50.46586f, 196.61f) };
	Local_202[1 /*261*/][1 /*8*/] = { func_250("ROCKF" /* GXT: Rockford Hills */, -755.2506f, 147.4266f, 75.41048f, -1079.0332f, 169.38055f, 50.46801f, 179.12f) };
	Local_202[1 /*261*/][2 /*8*/] = { func_250("ROCKF" /* GXT: Rockford Hills */, -752.36743f, 90.76733f, 65.5171f, -938.79803f, -15.91457f, 35.48347f, 205.78f) };
	Local_202[1 /*261*/][3 /*8*/] = { func_250("ROCKF" /* GXT: Rockford Hills */, -890.4999f, 431.1449f, 90.29848f, -875.3576f, 232.3266f, 60.20724f, 263.82f) };
	Local_202[1 /*261*/][4 /*8*/] = { func_250("ROCKF" /* GXT: Rockford Hills */, -752.36743f, 90.76733f, 65.5171f, -938.79803f, -15.91457f, 35.48347f, 205.78f) };
	Local_202[1 /*261*/][5 /*8*/] = { func_250("ROCKF" /* GXT: Rockford Hills */, -1198.1826f, 638.63666f, 115.10664f, -444.509f, 750.9377f, 198.29713f, 473.88f) };
	Local_202[1 /*261*/][6 /*8*/] = { func_250("ROCKF" /* GXT: Rockford Hills */, -844.40753f, 400.9413f, 80.433f, -109.53111f, 420.5014f, 120.2088f, 256.03f) };
	Local_202[1 /*261*/][7 /*8*/] = { func_250("ROCKF" /* GXT: Rockford Hills */, -518.62134f, 648.82654f, 130.93524f, -64.0709f, 582.45044f, 215.30841f, 162.72f) };
	Local_202[1 /*261*/][8 /*8*/] = { func_250("RICHM" /* GXT: Richman */, -934.98016f, 349.61014f, 85.77298f, -1432.4509f, 269.98038f, 50.7303f, 185.03f) };
	Local_202[1 /*261*/][9 /*8*/] = { func_250("RICHM" /* GXT: Richman */, -1633.8134f, -69.53224f, 65.10236f, -1446.8229f, 69.71544f, 48.23926f, 214.92f) };
	Local_202[1 /*261*/][10 /*8*/] = { func_250("RICHM" /* GXT: Richman */, -1732.258f, 444.13525f, 130.12581f, -2065.6904f, 412.21207f, 98.09863f, 175.17f) };
	Local_202[1 /*261*/][11 /*8*/] = { func_250("RICHM" /* GXT: Richman */, -1618.0363f, 50.95197f, 70.95364f, -1396.5143f, 221.1004f, 50.84464f, 161.61f) };
	Local_202[1 /*261*/][12 /*8*/] = { func_250("RICHM" /* GXT: Richman */, -1801.285f, 106.8786f, 72.12892f, -1541.7401f, 263.37378f, 50.44112f, 155.88f) };
	Local_202[1 /*261*/][13 /*8*/] = { func_250("PELUFF", -2208.5627f, 146.41006f, 150.93246f, -2350.1223f, 486.60657f, 200.5952f, 299.18f) };
	Local_202[1 /*261*/][14 /*8*/] = { func_250("PELUFF", -1852.3263f, 134.41718f, 70.06226f, -1994.3872f, 299.62833f, 100.96516f, 182.04f) };
	Local_202[1 /*261*/][15 /*8*/] = { func_250("CHIL" /* GXT: Vinewood Hills */, -1982.6697f, 505.9648f, 100.93644f, -1918.8427f, 713.6382f, 150.73953f, 168.9f) };
	Local_202[1 /*261*/][16 /*8*/] = { func_250("CHIL" /* GXT: Vinewood Hills */, -1455.7506f, 887.3351f, 191.97572f, -1663.2073f, 767.3684f, 160.81076f, 239.65f) };
	Local_202[1 /*261*/][17 /*8*/] = { func_250("CHIL" /* GXT: Vinewood Hills */, -1570.2218f, 508.20563f, 140.38838f, -808.95325f, 526.43335f, 90.18556f, 238.43f) };
	Local_202[1 /*261*/][18 /*8*/] = { func_250("CHIL" /* GXT: Vinewood Hills */, 242.62039f, 583.59045f, 159.40428f, 268.04242f, 827.4494f, 201.69531f, 105.09f) };
	Local_202[1 /*261*/][19 /*8*/] = { func_250("CHIL" /* GXT: Vinewood Hills */, -21.10285f, 706.8648f, 150.72626f, -210.43822f, 1056.2755f, 280.31824f, 290.15f) };
	Local_202[1 /*261*/][20 /*8*/] = { func_250("RGLEN" /* GXT: Richman Glen */, -1837.5383f, 774.2984f, 120.56287f, -1765.8419f, 831.0044f, 160.35838f, 68.09f) };
	Local_202[1 /*261*/][21 /*8*/] = { func_250("DIVINE", -372.0849f, 372.71826f, 100.60433f, 390.2198f, 532.5167f, 180.53801f, 305.88f) };
	Local_202[1 /*261*/].f_260 = 1;
	Local_202[1 /*261*/].f_257 = 22;
	Local_202[3 /*261*/][0 /*8*/] = { func_250("MTCHIL" /* GXT: Mount Chiliad */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[3 /*261*/][1 /*8*/] = { func_250("MTGORDO" /* GXT: Mount Gordo */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[3 /*261*/][2 /*8*/] = { func_250("SANCHIA" /* GXT: San Chianski Mountain Range */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[3 /*261*/][3 /*8*/] = { func_250("TATAMO" /* GXT: Tataviam Mountains */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[3 /*261*/][4 /*8*/] = { func_250("ELYSIAN" /* GXT: Elysian Island */, 531.2397f, -3019.2666f, 50f, 530.1656f, -3393.6226f, -22.4165f, 210f) };
	Local_202[3 /*261*/][5 /*8*/] = { func_250("ELYSIAN" /* GXT: Elysian Island */, 569.1023f, -2913.018f, 15.891f, 420.8226f, -2912.775f, -15.0372f, 25f) };
	Local_202[3 /*261*/][6 /*8*/] = { func_250("ELYSIAN" /* GXT: Elysian Island */, 495.1012f, -2833.1753f, 5.164f, 460.1983f, -2813.5283f, 0.4269f, 12f) };
	Local_202[3 /*261*/][7 /*8*/] = { func_250("ELYSIAN" /* GXT: Elysian Island */, 675.2973f, -2747.4504f, 4.952f, 689.2358f, -2747.3955f, 10.9001f, 4.3f) };
	Local_202[3 /*261*/][8 /*8*/] = { func_250("CYPRE" /* GXT: Cypress Flats */, 533.437f, -2693.2793f, 17.4952f, 588.6345f, -2693.4624f, 5.3007f, 15f) };
	Local_202[3 /*261*/][9 /*8*/] = { func_250("CYPRE" /* GXT: Cypress Flats */, 534.9656f, -2699.1365f, 4.9004f, 560.1779f, -2662.1921f, 9.0007f, 15f) };
	Local_202[3 /*261*/][10 /*8*/] = { func_250("CYPRE" /* GXT: Cypress Flats */, 583.903f, -2689.2068f, 16.9771f, 549.8469f, -2665.3176f, 3.9007f, 17.3f) };
	Local_202[3 /*261*/][11 /*8*/] = { func_250("CYPRE" /* GXT: Cypress Flats */, 683.428f, -2635.1343f, 9.3367f, 694.4725f, -2679.6597f, 4.7815f, 10f) };
	Local_202[3 /*261*/][12 /*8*/] = { func_250("CYPRE" /* GXT: Cypress Flats */, 695.2171f, -2694.7688f, 5.9815f, 695.5035f, -2679.1677f, 4.8365f, 10f) };
	Local_202[3 /*261*/][13 /*8*/] = { func_250("CYPRE" /* GXT: Cypress Flats */, 731.7991f, -2659.5796f, 4.7713f, 732.5307f, -2678.4001f, 10.5065f, 25f) };
	Local_202[3 /*261*/][14 /*8*/] = { func_250("ELYSIAN" /* GXT: Elysian Island */, 86.1885f, -2430.6963f, -0.1888f, 119.1515f, -2453.121f, 2.8614f, 13f) };
	Local_202[3 /*261*/][15 /*8*/] = { func_250("ELYSIAN" /* GXT: Elysian Island */, 260.3166f, -2426.7773f, 21.2819f, 313.7871f, -2433.6558f, 6.5609f, 20.5f) };
	Local_202[3 /*261*/][16 /*8*/] = { func_250("ELYSIAN" /* GXT: Elysian Island */, 260.3166f, -2426.7773f, 21.2819f, 313.7871f, -2433.6558f, 6.5609f, 20.5f) };
	Local_202[3 /*261*/][17 /*8*/] = { func_250("ELYSIAN" /* GXT: Elysian Island */, 283.1514f, -2456.7773f, 19.4609f, 290.2325f, -2403.6113f, 4.2465f, 20.5f) };
	Local_202[3 /*261*/][18 /*8*/] = { func_250("ELYSIAN" /* GXT: Elysian Island */, 266.0341f, -2446.724f, 19.4623f, 308.3783f, -2414.5442f, 4.5423f, 20.5f) };
	Local_202[3 /*261*/][19 /*8*/] = { func_250("ELYSIAN" /* GXT: Elysian Island */, 303.5269f, -2451.4456f, 19.4091f, 270.9798f, -2409.4517f, 4.4609f, 20.5f) };
	Local_202[3 /*261*/][20 /*8*/] = { func_250("RANCHO" /* GXT: Rancho */, 515.026f, -1653.5404f, 37.2615f, 582.571f, -1577.8248f, 26.3365f, 100f) };
	Local_202[3 /*261*/][21 /*8*/] = { func_250("BURTON" /* GXT: Burton */, -150.7403f, -419.0541f, 28.6163f, -52.8669f, -453.5552f, 39.4051f, 100f) };
	Local_202[3 /*261*/][22 /*8*/] = { func_250("SanAnd" /* GXT: San Andreas */, 50.2035f, -470.7132f, 36.9003f, 102.0394f, -322.0089f, 115f, 130f) };
	Local_202[3 /*261*/][23 /*8*/] = { func_250("ALTA" /* GXT: Alta */, 499.1769f, -241.2495f, 47.3462f, 393.5317f, -205.7358f, 79.3132f, 120f) };
	Local_202[3 /*261*/][24 /*8*/] = { func_250("DTVINE" /* GXT: Downtown Vinewood */, 422.3247f, 62.118f, 113.2905f, 478.494f, 43.322f, 83.4541f, 80f) };
	Local_202[3 /*261*/][25 /*8*/] = { func_250("DTVINE" /* GXT: Downtown Vinewood */, 385.4908f, 56.1423f, 159.58f, 332.458f, -87.6805f, 63.3657f, 80f) };
	Local_202[3 /*261*/][26 /*8*/] = { func_250("DTVINE" /* GXT: Downtown Vinewood */, 213.6192f, 90.2228f, 98.9357f, 203.3067f, 61.8088f, 86.9197f, 60f) };
	Local_202[3 /*261*/][27 /*8*/] = { func_250("DTVINE" /* GXT: Downtown Vinewood */, 192.813f, -14.9451f, 85.3158f, 149.2689f, 0.6803f, 67.0343f, 40f) };
	Local_202[3 /*261*/][28 /*8*/] = { func_250("WVINE" /* GXT: West Vinewood */, 16.1659f, 61.8685f, 70.8467f, -17.1751f, 74.3771f, 76.88f, 4.5f) };
	Local_202[3 /*261*/][29 /*8*/] = { func_250("WVINE" /* GXT: West Vinewood */, -86.5425f, 84.8701f, 80.2147f, -50.4826f, 67.7335f, 70.297f, 20f) };
	Local_202[3 /*261*/][30 /*8*/] = { func_250("ELGORL" /* GXT: El Gordo Lighthouse */, 3449.839f, 5173.9814f, 0.0662f, 3412.309f, 5166.8896f, 14.8342f, 33.7f) };
...
struct<8> func_250(char* sParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x10C0D
{
	struct<8> Var0;
...
void func_251(int iParam0, bool bParam1)//Position - 0x10C38
{
	if (func_88(iLocal_107))
	{
		func_20(&iLocal_107);
...
int func_252(int iParam0)//Position - 0x10C60
{
	int iVar0;
	bool bVar1;
...
void func_253()//Position - 0x10CB7
{
	if (func_106(35))
	{
		func_94(35, 0);
...
void func_254(bool bParam0)//Position - 0x10CDD
{
	char* sVar0;
...
void func_255()//Position - 0x10DA7
{
...
void func_256()//Position - 0x10DBD
{
...
void func_257()//Position - 0x10DD3
{
...
void func_258()//Position - 0x10DE9
{
...
void func_259(char* sParam0)//Position - 0x10DFF
{
	StringCopy(&(Global_8521[0 /*16*/].f_8), sParam0, 32);
}

void func_260(char* sParam0)//Position - 0x10E13
{
	StringCopy(&(Global_8521[2 /*16*/].f_8), sParam0, 32);
}

void func_261(char* sParam0)//Position - 0x10E27
{
	StringCopy(&(Global_8521[1 /*16*/].f_8), sParam0, 32);
}

void func_262(char* sParam0)//Position - 0x10E3B
{
	StringCopy(&(Global_8521[3 /*16*/].f_8), sParam0, 32);
}

void func_263(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x10E4F
{
	func_264(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_264(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x10E6F
{
	int iVar0;
...
int func_265(var uParam0, int iParam1)//Position - 0x11041
{
	if (iParam1 == -1)
	{
		return 0;
	...
	{
		func_62(&(Global_114372.f_32753.f_69[Global_78038.f_555[0 /*21*/].f_14 /*78*/]), uParam0);
	}
	return 1;
}

float func_266(int iParam0)//Position - 0x1108C
{
	if (iParam0 == -1)
	{
		return 0f;
...
Vector3 func_267(int iParam0)//Position - 0x110C2
{
	if (iParam0 == -1)
	{
		return 0f, 0f, 0f;
...
int func_268(int iParam0)//Position - 0x110FC
{
	int iVar0;
	bool bVar1;
