...
bool func_30()//Position - 0x45DD
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_31()//Position - 0x45F3
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_32()//Position - 0x4609
{
	return 0;
}

int func_33()//Position - 0x4612
{
	return 1;
}

int func_34()//Position - 0x461B
{
	return 1;
}

int func_35()//Position - 0x4624
{
...
int func_37(int iParam0)//Position - 0x46F5
{
	int iVar0;
	char* sVar1;
...
int func_38(int iParam0)//Position - 0x473B
{
	int iVar0;
...
int func_39(int iParam0)//Position - 0x4776
{
	int iVar0;
...
int func_40(int iParam0)//Position - 0x47F2
{
	int iVar0;
...
int func_41(int iParam0, int iParam1, bool bParam2)//Position - 0x48DA
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_42(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x4948
{
...
void func_44(var uParam0, int iParam1)//Position - 0x4A65
{
	if (iParam1 <= 0)
	{
		return;
...
void func_45(var uParam0, int iParam1)//Position - 0x4AEB
{
...
void func_46(var uParam0, int iParam1)//Position - 0x4B1E
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1)//Position - 0x4B6F
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_48(int iParam0)//Position - 0x4C11
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_49(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_49(bool bParam0, int iParam1, int iParam2)//Position - 0x4C33
{
	if (bParam0)
	{
		return iParam1;
...
int func_50(var uParam0)//Position - 0x4C4A
{
	return uParam0 & 15;
}

void func_51(var uParam0, int iParam1)//Position - 0x4C57
{
...
void func_52(var uParam0, int iParam1)//Position - 0x4C91
{
...
void func_53(var uParam0, int iParam1)//Position - 0x4CCC
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_54(var uParam0, int iParam1)//Position - 0x4D08
{
	int iVar0;
	int iVar1;
...
int func_55(int iParam0, int iParam1)//Position - 0x63F5
{
	struct<82> Var0;
...
void func_56(int iParam0, var uParam1, int iParam2)//Position - 0x6437
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x6693
{
	return iParam0 < 3;
}

void func_58(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x669F
{
	if (func_54(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_59(int iParam0, bool bParam1)//Position - 0x6798
{
	if (iParam0 == -1)
	{
		return;
...
void func_60(int iParam0, int iParam1, bool bParam2)//Position - 0x67F5
{
	if (iParam0 == -1)
	{
		return;
...
void func_61(var uParam0, var uParam1)//Position - 0x6830
{
...
void func_62(int iParam0)//Position - 0x68FC
{
	if (iParam0 == -1)
	{
		return;
...
void func_64(int iParam0, var uParam1)//Position - 0x69D6
{
	int iVar0;
...
int func_65(int iParam0)//Position - 0x6C81
{
	switch (iParam0)
	{
		case 1:
...
int func_66(int iParam0, var uParam1, var uParam2)//Position - 0x6D31
{
	int iVar0;
	int iVar1;
...
int func_67(int iParam0)//Position - 0x6F24
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_68(var uParam0)//Position - 0x6F44
{
	int iVar0;
...
void func_69(int iParam0)//Position - 0x6FF3
{
...
void func_70(bool bParam0)//Position - 0x701A
{
	if (BitTest(uLocal_49, 14))
	{
...
void func_71(int iParam0)//Position - 0x70FE
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x711E
{
	int iVar0;
	int iVar1;
...
int func_73(int iParam0)//Position - 0x715B
{
	if (func_57(iParam0))
	{
...
var func_74(int iParam0)//Position - 0x7180
{
	return Global_1998[iParam0 /*29*/];
}

int func_75(int iParam0, int iParam1)//Position - 0x718F
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_76(int iParam0)//Position - 0x71AF
{
	if (iParam0 == -1)
	{
		return 0;
...
bool func_78(int iParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x71E7
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), Param1) <= (fParam2 * fParam2);
}

bool func_79(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x7205
{
	if (bParam2)
	{
...
void func_80(int iParam0, bool bParam1)//Position - 0x724C
{
...
int func_82(bool bParam0)//Position - 0x72BB
{
...
void func_83(char* sParam0, var uParam1)//Position - 0x72E3
{
...
bool func_86(int iParam0)//Position - 0x7477
{
	return Global_43052 == iParam0;
}

int func_87(int iParam0)//Position - 0x7485
{
	if (func_88(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_88(int iParam0)//Position - 0x74AF
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_89(int iParam0, int iParam1)//Position - 0x74D0
{
...
void func_90(bool bParam0)//Position - 0x750D
{
	char* sVar0;
...
bool func_91()//Position - 0x7580
{
	func_85();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_92(char* sParam0)//Position - 0x7599
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_93(int iParam0, int iParam1)//Position - 0x75AB
{
...
void func_96(int iParam0, int iParam1, int iParam2)//Position - 0x7686
{
	bool bVar0;
...
int func_98()//Position - 0x7C2A
{
	return Global_31959;
}

int func_99(int iParam0, int iParam1)//Position - 0x7C35
{
	int iVar0;
...
void func_100(int iParam0, bool bParam1, int iParam2)//Position - 0x7C86
{
	if (iParam2 == -1)
	{
		iParam2 = func_101();
...
int func_101()//Position - 0x7CA4
{
	return Global_1574918;
}

int func_102()//Position - 0x7CB0
{
...
int func_105(int iParam0)//Position - 0x7D3F
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
int func_109(int iParam0, int iParam1)//Position - 0x7DCA
{
	int iVar0;
	int iVar1;
...
void func_110(int iParam0)//Position - 0x7E0B
{
...
void func_112(bool bParam0)//Position - 0x7F92
{
	if (bParam0)
	{
...
int func_113(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x8004
{
	struct<15> Var0;
	int iVar1;
...
void func_114(bool bParam0)//Position - 0x8155
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_115(int iParam0)//Position - 0x8213
{
	switch (iParam0)
	{
		case 0:
...
void func_116(int iParam0)//Position - 0x827D
{
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0x82C3
{
...
void func_118(int iParam0, int iParam1, int iParam2)//Position - 0x8308
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_120(struct<6> Param0)//Position - 0x8372
{
	if (iLocal_42 == 0)
	{
		func_125(Param0);
...
void func_121(struct<6> Param0)//Position - 0x8399
{
	if (func_103())
	{
		func_122(Param0, 1);
...
void func_122(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)//Position - 0x83BD
{
	struct<4> Var0;
...
struct<4> func_123(bool bParam0)//Position - 0x842D
{
	struct<4> Var0;
...
struct<4> func_124(bool bParam0)//Position - 0x8497
{
	struct<4> Var0;
...
void func_125(struct<6> Param0)//Position - 0x8501
{
	if (func_103())
	{
		if (func_126())
...
void func_128(bool bParam0)//Position - 0x85B8
{
...
void func_129(char* sParam0, char* sParam1)//Position - 0x85CC
{
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		Global_21662 = 1;
...
struct<6> func_130()//Position - 0x85ED
{
	struct<6> Var0;
...
int func_135()//Position - 0x868E
{
	return Global_78581;
}

void func_136()//Position - 0x869A
{
...
void func_140(var uParam0)//Position - 0x891D
{
	if (*uParam0 == -1)
	{
		return;
...
int func_142(int iParam0)//Position - 0x89BA
{
...
bool func_143(char* sParam0, int iParam1, char* sParam2)//Position - 0x89EA
{
...
void func_144(int* iParam0)//Position - 0x8A08
{
...
void func_145(char* sParam0, int iParam1, int iParam2)//Position - 0x8A28
{
	iParam2 = iParam2;
...
int func_147(struct<3> Param0, bool bParam1)//Position - 0x8AB0
{
	int iVar0;
...
float func_148(bool bParam0, float fParam1, float fParam2)//Position - 0x8ADC
{
	if (bParam0)
	{
		return fParam1;
		...
		if (iLocal_38 == 0)
		{
			if (!BitTest(uLocal_49, 1))
			{
				if (func_87(iLocal_51))
				{
					...
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_51, -168.8162f, -619.9002f, 31.42446f, -162.6423f, -622.0781f, 33.42446f, 4.14f, false, true, 0))
					{
						func_152(24, 46);
...
int func_150(float fParam0, int iParam1)//Position - 0x8BB0
{
	int iVar0;
...
int func_151(int iParam0)//Position - 0x8C34
{
	struct<3> Var0;
...
void func_152(bool bParam0, bool bParam1)//Position - 0x8CE9
{
	func_4(bParam0);
...
void func_153()//Position - 0x8D38
{
	...
	if ((Global_43052 == 15 && !func_171()) || func_105(35))
	{
		if (iLocal_38 == 0)
		{
...
int func_154(int iParam0)//Position - 0x9005
{
...
void func_155(int iParam0)//Position - 0x9036
{
	if (func_159())
	{
		return;
...
void func_157(bool bParam0, bool bParam1)//Position - 0x90E7
{
	if (bParam0)
	{
		if (func_15(0))
...
bool func_158()//Position - 0x915B
{
	return BitTest(Global_1958711, 5);
}

bool func_159()//Position - 0x9169
{
	return BitTest(Global_1958711, 19);
}

void func_160()//Position - 0x9178
{
	MISC::CLEAR_BIT(&uLocal_49, 0);
	MISC::CLEAR_BIT(&uLocal_49, 8);
	MISC::CLEAR_BIT(&uLocal_49, 7);
...
int func_161(int iParam0)//Position - 0x9196
{
...
int func_167(int iParam0)//Position - 0x92EA
{
	int iVar0;
...
int func_168(int iParam0)//Position - 0x932F
{
	int iVar0;
...
int func_170(int iParam0)//Position - 0x93F1
{
	if (DECORATOR::DECOR_EXIST_ON(iParam0, "GetawayVehicleValid"))
	{
		return 1;
...
int func_173(var uParam0)//Position - 0x9479
{
	char* sVar0;
...
void func_175(int iParam0, struct<3> Param1)//Position - 0x94F3
{
	int iVar0;
...
bool func_176(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x9542
{
...
int func_177(char* sParam0, int iParam1, bool bParam2)//Position - 0x95A1
{
	Global_21606 = 0;
...
bool func_180(int iParam0)//Position - 0x9909
{
	return func_181(iParam0, 20);
}

var func_181(int iParam0, int iParam1)//Position - 0x9919
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

int func_182()//Position - 0x9931
{
	return -1;
}

void func_183()//Position - 0x993A
{
	int iVar0;
...
bool func_188(int iParam0, int iParam1)//Position - 0x9B90
{
	switch (iParam0)
	{
		case 5:
...
void func_190(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x9C1F
{
...
void func_192(bool bParam0, var uParam1)//Position - 0x9C8F
{
	int iVar0;
...
void func_193(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x9E05
{
...
void func_194(int iParam0, int iParam1, bool bParam2)//Position - 0x9EA0
{
	int iVar0;
		...
		if (bParam2)
		{
			if (!Global_78319)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8795[iParam1 /*4*/] = { func_196(iParam0) };
					...
					{
						Global_8746[1 /*6*/] = { func_196(iParam0) };
...
struct<4> func_196(int iParam0)//Position - 0xA091
{
	return Global_1998[iParam0 /*29*/].f_3;
}

int func_197(int iParam0, int iParam1)//Position - 0xA0A4
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
int func_198(int iParam0, int iParam1)//Position - 0xA0CE
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
char* func_201(bool bParam0)//Position - 0xB9A6
{
	char* sVar0;
...
int func_203(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xBB02
{
	int iVar0;
...
void func_204(var uParam0, int iParam1)//Position - 0xBC39
{
	int iVar0;
...
bool func_205(int iParam0)//Position - 0xBC88
{
	return func_206(iParam0, Global_43052);
}

int func_206(int iParam0, int iParam1)//Position - 0xBC99
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_207(int iParam0)//Position - 0xBE7A
{
	if (Global_43052 == 15)
	{
		return 0;
...
int func_209(int iParam0)//Position - 0xBEC2
{
	if (Global_22720 == 0)
	{
		return 0;
...
void func_211()//Position - 0xBF38
{
	int iVar0;
	bool bVar1;
	
	if (((((((Global_43052 == 15 && iLocal_37 != 3) && BitTest(uLocal_49, 5)) && !func_171()) && Global_78316 == -1) && !func_221()) && !func_86(9)) || func_105(35))
	{
		func_220();
		func_219();
		switch (iLocal_39)
	...
	else if (((((((Global_43052 != 15 || Global_43052 != 0) || Global_43052 != 2) || Global_43052 != 4) || Global_43052 != 17) || func_171()) || Global_78316 == -1) || Global_112441)
	{
		bVar1 = false;
		if (func_212())
		{
...
bool func_212()//Position - 0xC0C1
{
	return SCRIPT::IS_THREAD_ACTIVE(Global_113386.f_18103.f_395);
}

void func_213(bool bParam0, bool bParam1)//Position - 0xC0D7
{
	switch (iLocal_39)
	{
		case 1:
...
void func_214(char* sParam0, int iParam1)//Position - 0xC1E1
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_215()//Position - 0xC1F8
{
...
int func_216(bool bParam0)//Position - 0xC212
{
	int iVar0;
...
int func_217(bool bParam0)//Position - 0xC25C
{
	int iVar0;
...
void func_218(var uParam0, int iParam1)//Position - 0xC30A
{
	bool bVar0;
	...
	if (iLocal_37 == 0 || iLocal_37 == 1)
	{
		switch (iLocal_38)
		{
			case 0:
				...
				{
					if (((((((!func_2(func_3(7)) && !func_2(func_3(8))) && !func_2(func_3(10))) && !func_2(func_3(11))) && !func_2(func_3(12))) && !func_2(func_3(13))) && !func_212()) && !Global_112026)
					{
						MISC::SET_BIT(&uLocal_49, 15);
						HUD::CLEAR_HELP(true);
					}
...
int func_229()//Position - 0xC82D
{
	if (((((Global_43052 == 15 && !func_171()) && Global_78316 == -1) && !func_212()) && !func_230(1112014848)) && !Global_112441)
	{
		return 1;
	}
	return 0;
...
int func_230(float fParam0)//Position - 0xC87B
{
	if (iLocal_42 == 1)
	{
...
int func_233(int iParam0)//Position - 0xC987
{
	return func_234(iParam0, 6, 1);
}

int func_234(int iParam0, int iParam1, bool bParam2)//Position - 0xC997
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_235(int iParam0, int iParam1, int iParam2)//Position - 0xC9F8
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 13122)
	{
		...
		iVar0 = Global_2826809[iParam0 /*3*/][func_236(iParam1)];
...
int func_236(var uParam0)//Position - 0xCA35
{
	int iVar0;
	int iVar1;
...
int func_237(int iParam0)//Position - 0xCA69
{
	switch (iParam0)
	{
		case 0:
...
int func_238(int iParam0)//Position - 0xCDE4
{
	if (func_88(iParam0))
	{
...
void func_239(char* sParam0, int iParam1)//Position - 0xCE04
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < Global_113386.f_20410.f_145)
	{
		if (MISC::ARE_STRINGS_EQUAL(sParam0, &(Global_113386.f_20410[iVar0 /*16*/])))
		{
			...
			func_241((Global_113386.f_20410.f_145 - 1));
...
void func_241(int iParam0)//Position - 0xCFC8
{
...
void func_242(int iParam0, int iParam1)//Position - 0xD060
{
...
int func_243(int iParam0)//Position - 0xD170
{
...
void func_244(int iParam0)//Position - 0xD19C
{
	iLocal_42 = iParam0;
	if (iLocal_42 == 0)
	{
...
char* func_246(int iParam0)//Position - 0xD43F
{
	char* sVar0;
...
void func_247()//Position - 0xD605
{
	...
	Local_68[0 /*261*/][0 /*8*/] = { func_248("DELBE" /* GXT: Del Perro Beach */, -1615.257f, -952.5944f, 20.01716f, -2160.706f, -423f, -1.28679f, 327.8f) };
	Local_68[0 /*261*/][1 /*8*/] = { func_248("DELBE" /* GXT: Del Perro Beach */, -1521.716f, -914.5676f, 20.17247f, -1855.715f, -1325.784f, -44.79295f, 254.8f) };
	Local_68[0 /*261*/][2 /*8*/] = { func_248("BEACH" /* GXT: Vespucci Beach */, -1162.37f, -1815.008f, 15.33822f, -1553.207f, -1098.685f, 0.46467f, 253.91f) };
	Local_68[0 /*261*/][3 /*8*/] = { func_248("BEACH" /* GXT: Vespucci Beach */, -1464.219f, -1136.783f, 0.32167f, -2241.566f, -358.8849f, 20.32481f, 282.21f) };
	Local_68[0 /*261*/][4 /*8*/] = { func_248("PBOX" /* GXT: Pillbox Hill */, 156.4109f, -1042.641f, 22.31273f, 238.6382f, -821.1217f, 35.10069f, 176.96f) };
	Local_68[0 /*261*/][5 /*8*/] = { func_248("CHIL" /* GXT: Vinewood Hills */, 883.1121f, 534.7283f, 115.725f, 559.7425f, 644.602f, 150.5971f, 301.08f) };
	Local_68[0 /*261*/][6 /*8*/] = { func_248("EAST_V" /* GXT: East Vinewood */, 941.4531f, -329.4256f, 60.77003f, 727.7651f, -200.9519f, 75.59085f, 88.89f) };
	Local_68[0 /*261*/][7 /*8*/] = { func_248("EAST_V" /* GXT: East Vinewood */, 689.1177f, -273.1406f, 60.21559f, 834.7326f, -352.1655f, 50.92442f, 81.23f) };
	Local_68[0 /*261*/][8 /*8*/] = { func_248("MIRR" /* GXT: Mirror Park */, 1048.499f, -357.0332f, 60.92149f, 1401.581f, -783.8975f, 75.7477f, 325.93f) };
	Local_68[0 /*261*/][9 /*8*/] = { func_248("MIRR" /* GXT: Mirror Park */, 892.2836f, -461.5752f, 70.86029f, 1161.301f, -829.8299f, 45.90131f, 184.12f) };
	Local_68[0 /*261*/][10 /*8*/] = { func_248("VCANA" /* GXT: Vespucci Canals */, -1161.361f, -1143.716f, -5.71593f, -864.9714f, -981.1257f, 21.09691f, 328.65f) };
	Local_68[0 /*261*/][11 /*8*/] = { func_248("BAYTRE" /* GXT: Baytree Canyon */, 251.4011f, 1068.347f, 280.6663f, 189.6012f, 1272.352f, 143.8035f, 160.32f) };
	Local_68[0 /*261*/][13 /*8*/] = { func_248("OBSERV" /* GXT: Galileo Observatory */, -450.9835f, 1048.408f, 252.945f, -389.564f, 1244.504f, 370.2469f, 199.93f) };
	...
	Local_68[0 /*261*/][20 /*8*/] = { func_248("PBOX" /* GXT: Pillbox Hill */, -28.39781f, -1071.245f, 50.21438f, -49.8352f, -1131.277f, 20.02555f, 55.12f) };
	Local_68[0 /*261*/][21 /*8*/] = { func_248("LOSSF" /* GXT: Los Santos Freeway */, 843.1962f, 25.93548f, 65.16061f, 1138.687f, 363.0587f, 105.4128f, 61.11f) };
	Local_68[0 /*261*/][22 /*8*/] = { func_248("ROCKF" /* GXT: Rockford Hills */, -992.5638f, -199.7673f, 30.74956f, -687.9904f, -43.23445f, 80.93306f, 80.53f) };
	...
	Local_68[0 /*261*/][26 /*8*/] = { func_248("RANCHO" /* GXT: Rancho */, 414.5057f, -2092.1f, 19.8533f, 350.8093f, -2158.395f, 12.3916f, 55f) };
	Local_68[0 /*261*/][27 /*8*/] = { func_248("RANCHO" /* GXT: Rancho */, 283.7474f, -2103.918f, 12.9242f, 391.8871f, -1983.204f, 33.0042f, 100f) };
	...
	Local_68[2 /*261*/][0 /*8*/] = { func_248("PBOX" /* GXT: Pillbox Hill */, -25.50944f, -932.3846f, 20.41711f, 119.9406f, -523.4398f, 33.07988f, 363.4f) };
	Local_68[2 /*261*/][1 /*8*/] = { func_248("DOWNT" /* GXT: Downtown */, -25.50944f, -932.3846f, 20.41711f, 119.9406f, -523.4398f, 33.07988f, 363.4f) };
	Local_68[2 /*261*/][2 /*8*/] = { func_248("COSI" /* GXT: Countryside */, 1426.934f, 1225.115f, 90.76305f, 1429.982f, 1006.831f, 120.6643f, 259.89f) };
	Local_68[2 /*261*/][3 /*8*/] = { func_248("COSI" /* GXT: Countryside */, 3503.56f, 3546.403f, 20.18748f, 3513.955f, 3875.795f, 72.94806f, 393.78f) };
	Local_68[2 /*261*/][4 /*8*/] = { func_248("SKID" /* GXT: Mission Row */, 403.5404f, -864.4694f, 20.33799f, 396.3441f, -1127.325f, 35.49262f, 325.93f) };
	...
	Local_68[1 /*261*/][0 /*8*/] = { func_248("PALETO" /* GXT: Paleto Bay */, -422.8618f, 6068.399f, 20.34662f, -282.7452f, 6206.324f, 50.46586f, 196.61f) };
	Local_68[1 /*261*/][1 /*8*/] = { func_248("ROCKF" /* GXT: Rockford Hills */, -755.2506f, 147.4266f, 75.41048f, -1079.033f, 169.3806f, 50.46801f, 179.12f) };
	Local_68[1 /*261*/][2 /*8*/] = { func_248("ROCKF" /* GXT: Rockford Hills */, -752.3674f, 90.76733f, 65.5171f, -938.798f, -15.91457f, 35.48347f, 205.78f) };
	Local_68[1 /*261*/][3 /*8*/] = { func_248("ROCKF" /* GXT: Rockford Hills */, -890.4999f, 431.1449f, 90.29848f, -875.3576f, 232.3266f, 60.20724f, 263.82f) };
	Local_68[1 /*261*/][4 /*8*/] = { func_248("ROCKF" /* GXT: Rockford Hills */, -752.3674f, 90.76733f, 65.5171f, -938.798f, -15.91457f, 35.48347f, 205.78f) };
	Local_68[1 /*261*/][5 /*8*/] = { func_248("ROCKF" /* GXT: Rockford Hills */, -1198.183f, 638.6367f, 115.1066f, -444.509f, 750.9377f, 198.2971f, 473.88f) };
	Local_68[1 /*261*/][6 /*8*/] = { func_248("ROCKF" /* GXT: Rockford Hills */, -844.4075f, 400.9413f, 80.433f, -109.5311f, 420.5014f, 120.2088f, 256.03f) };
	Local_68[1 /*261*/][7 /*8*/] = { func_248("ROCKF" /* GXT: Rockford Hills */, -518.6213f, 648.8265f, 130.9352f, -64.0709f, 582.4504f, 215.3084f, 162.72f) };
	Local_68[1 /*261*/][8 /*8*/] = { func_248("RICHM" /* GXT: Richman */, -934.9802f, 349.6101f, 85.77298f, -1432.451f, 269.9804f, 50.7303f, 185.03f) };
	Local_68[1 /*261*/][9 /*8*/] = { func_248("RICHM" /* GXT: Richman */, -1633.813f, -69.53224f, 65.10236f, -1446.823f, 69.71544f, 48.23926f, 214.92f) };
	Local_68[1 /*261*/][10 /*8*/] = { func_248("RICHM" /* GXT: Richman */, -1732.258f, 444.1353f, 130.1258f, -2065.69f, 412.2121f, 98.09863f, 175.17f) };
	Local_68[1 /*261*/][11 /*8*/] = { func_248("RICHM" /* GXT: Richman */, -1618.036f, 50.95197f, 70.95364f, -1396.514f, 221.1004f, 50.84464f, 161.61f) };
	Local_68[1 /*261*/][12 /*8*/] = { func_248("RICHM" /* GXT: Richman */, -1801.285f, 106.8786f, 72.12892f, -1541.74f, 263.3738f, 50.44112f, 155.88f) };
	...
	Local_68[1 /*261*/][15 /*8*/] = { func_248("CHIL" /* GXT: Vinewood Hills */, -1982.67f, 505.9648f, 100.9364f, -1918.843f, 713.6382f, 150.7395f, 168.9f) };
	Local_68[1 /*261*/][16 /*8*/] = { func_248("CHIL" /* GXT: Vinewood Hills */, -1455.751f, 887.3351f, 191.9757f, -1663.207f, 767.3684f, 160.8108f, 239.65f) };
	Local_68[1 /*261*/][17 /*8*/] = { func_248("CHIL" /* GXT: Vinewood Hills */, -1570.222f, 508.2056f, 140.3884f, -808.9532f, 526.4333f, 90.18556f, 238.43f) };
	Local_68[1 /*261*/][18 /*8*/] = { func_248("CHIL" /* GXT: Vinewood Hills */, 242.6204f, 583.5905f, 159.4043f, 268.0424f, 827.4494f, 201.6953f, 105.09f) };
	Local_68[1 /*261*/][19 /*8*/] = { func_248("CHIL" /* GXT: Vinewood Hills */, -21.10285f, 706.8648f, 150.7263f, -210.4382f, 1056.276f, 280.3182f, 290.15f) };
	Local_68[1 /*261*/][20 /*8*/] = { func_248("RGLEN" /* GXT: Richman Glen */, -1837.538f, 774.2984f, 120.5629f, -1765.842f, 831.0044f, 160.3584f, 68.09f) };
	...
	Local_68[3 /*261*/][4 /*8*/] = { func_248("ELYSIAN" /* GXT: Elysian Island */, 531.2397f, -3019.267f, 50f, 530.1656f, -3393.623f, -22.4165f, 210f) };
	Local_68[3 /*261*/][5 /*8*/] = { func_248("ELYSIAN" /* GXT: Elysian Island */, 569.1023f, -2913.018f, 15.891f, 420.8226f, -2912.775f, -15.0372f, 25f) };
	Local_68[3 /*261*/][6 /*8*/] = { func_248("ELYSIAN" /* GXT: Elysian Island */, 495.1012f, -2833.175f, 5.164f, 460.1983f, -2813.528f, 0.4269f, 12f) };
	Local_68[3 /*261*/][7 /*8*/] = { func_248("ELYSIAN" /* GXT: Elysian Island */, 675.2973f, -2747.45f, 4.952f, 689.2358f, -2747.396f, 10.9001f, 4.3f) };
	Local_68[3 /*261*/][8 /*8*/] = { func_248("CYPRE" /* GXT: Cypress Flats */, 533.437f, -2693.279f, 17.4952f, 588.6345f, -2693.462f, 5.3007f, 15f) };
	Local_68[3 /*261*/][9 /*8*/] = { func_248("CYPRE" /* GXT: Cypress Flats */, 534.9656f, -2699.136f, 4.9004f, 560.1779f, -2662.192f, 9.0007f, 15f) };
	Local_68[3 /*261*/][10 /*8*/] = { func_248("CYPRE" /* GXT: Cypress Flats */, 583.903f, -2689.207f, 16.9771f, 549.8469f, -2665.318f, 3.9007f, 17.3f) };
	Local_68[3 /*261*/][11 /*8*/] = { func_248("CYPRE" /* GXT: Cypress Flats */, 683.428f, -2635.134f, 9.3367f, 694.4725f, -2679.66f, 4.7815f, 10f) };
	Local_68[3 /*261*/][12 /*8*/] = { func_248("CYPRE" /* GXT: Cypress Flats */, 695.2171f, -2694.769f, 5.9815f, 695.5035f, -2679.168f, 4.8365f, 10f) };
	Local_68[3 /*261*/][13 /*8*/] = { func_248("CYPRE" /* GXT: Cypress Flats */, 731.7991f, -2659.58f, 4.7713f, 732.5307f, -2678.4f, 10.5065f, 25f) };
	Local_68[3 /*261*/][14 /*8*/] = { func_248("ELYSIAN" /* GXT: Elysian Island */, 86.1885f, -2430.696f, -0.1888f, 119.1515f, -2453.121f, 2.8614f, 13f) };
	Local_68[3 /*261*/][15 /*8*/] = { func_248("ELYSIAN" /* GXT: Elysian Island */, 260.3166f, -2426.777f, 21.2819f, 313.7871f, -2433.656f, 6.5609f, 20.5f) };
	Local_68[3 /*261*/][16 /*8*/] = { func_248("ELYSIAN" /* GXT: Elysian Island */, 260.3166f, -2426.777f, 21.2819f, 313.7871f, -2433.656f, 6.5609f, 20.5f) };
	Local_68[3 /*261*/][17 /*8*/] = { func_248("ELYSIAN" /* GXT: Elysian Island */, 283.1514f, -2456.777f, 19.4609f, 290.2325f, -2403.611f, 4.2465f, 20.5f) };
	Local_68[3 /*261*/][18 /*8*/] = { func_248("ELYSIAN" /* GXT: Elysian Island */, 266.0341f, -2446.724f, 19.4623f, 308.3783f, -2414.544f, 4.5423f, 20.5f) };
	Local_68[3 /*261*/][19 /*8*/] = { func_248("ELYSIAN" /* GXT: Elysian Island */, 303.5269f, -2451.446f, 19.4091f, 270.9798f, -2409.452f, 4.4609f, 20.5f) };
	Local_68[3 /*261*/][20 /*8*/] = { func_248("RANCHO" /* GXT: Rancho */, 515.026f, -1653.54f, 37.2615f, 582.571f, -1577.825f, 26.3365f, 100f) };
	...
	Local_68[3 /*261*/][30 /*8*/] = { func_248("ELGORL" /* GXT: El Gordo Lighthouse */, 3449.839f, 5173.981f, 0.0662f, 3412.309f, 5166.89f, 14.8342f, 33.7f) };
...
struct<8> func_248(char* sParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0xE93F
{
	struct<8> Var0;
...
void func_249(int iParam0, bool bParam1)//Position - 0xE96A
{
	if (func_87(iLocal_51))
	{
		func_20(&iLocal_51);
...
int func_250(int iParam0)//Position - 0xE992
{
	int iVar0;
	bool bVar1;
...
void func_252(bool bParam0)//Position - 0xEA0F
{
	char* sVar0;
...
void func_257(char* sParam0)//Position - 0xEB31
{
	StringCopy(&(Global_7974[0 /*16*/].f_8), sParam0, 32);
}

void func_258(char* sParam0)//Position - 0xEB45
{
	StringCopy(&(Global_7974[2 /*16*/].f_8), sParam0, 32);
}

void func_259(char* sParam0)//Position - 0xEB59
{
	StringCopy(&(Global_7974[1 /*16*/].f_8), sParam0, 32);
}

void func_260(char* sParam0)//Position - 0xEB6D
{
	StringCopy(&(Global_7974[3 /*16*/].f_8), sParam0, 32);
}

void func_261(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0xEB81
{
	func_262(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_262(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0xEBA1
{
	int iVar0;
...
int func_263(var uParam0, int iParam1)//Position - 0xED73
{
	if (iParam1 == -1)
	{
		return 0;
...
float func_264(int iParam0)//Position - 0xEDBE
{
	if (iParam0 == -1)
	{
		return 0f;
...
Vector3 func_265(int iParam0)//Position - 0xEDF4
{
	if (iParam0 == -1)
	{
		return 0f, 0f, 0f;
...
int func_266(int iParam0)//Position - 0xEE2E
{
	int iVar0;
	bool bVar1;
