...
void __EntryFunction__()//Position - 0x0
{
	...
	if (!func_267(31))
	{
		...
		if (iLocal_35 == 2)
		{
			...
			Local_108 = { func_266(25) };
			fLocal_111 = func_265(25);
			if (func_264(&Local_112, 25))
			{
	...
	{
		func_262("AM_H_PREP8" /* GXT: A getaway vehicle is required for this setup. */, 2, 0, -1, 10000, 7, 0, 0, 0);
	...
	while (true)
	{
		if (func_244(85))
		{
			func_240("AM_H_PREP8" /* GXT: A getaway vehicle is required for this setup. */, 1);
			func_250(31, 0);
		}
...
int func_27(int iParam0)//Position - 0x1240
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_29(int iParam0, int iParam1)//Position - 0x131D
{
	int iVar0;
	int iVar1;
...
bool func_30()//Position - 0x156E
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_31()//Position - 0x1584
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_32()//Position - 0x159A
{
	return 0;
}

int func_33()//Position - 0x15A3
{
	return 1;
}

int func_34()//Position - 0x15AC
{
	return 1;
}

int func_35()//Position - 0x15B5
{
...
int func_37(int iParam0)//Position - 0x1686
{
	int iVar0;
	char* sVar1;
...
int func_38(int iParam0)//Position - 0x16CD
{
	int iVar0;
...
int func_39(int iParam0)//Position - 0x1708
{
	int iVar0;
...
int func_40(int iParam0)//Position - 0x1784
{
	int iVar0;
...
int func_41(int iParam0, int iParam1, bool bParam2)//Position - 0x186C
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_42(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x18DA
{
...
void func_44(var uParam0, int iParam1)//Position - 0x19F7
{
	if (iParam1 <= 0)
	{
		return;
...
void func_45(var uParam0, int iParam1)//Position - 0x1A7D
{
...
void func_46(var uParam0, int iParam1)//Position - 0x1AB0
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1)//Position - 0x1B01
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_48(int iParam0)//Position - 0x1BA3
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_49(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_49(bool bParam0, int iParam1, int iParam2)//Position - 0x1BC5
{
	if (bParam0)
	{
		return iParam1;
...
int func_50(var uParam0)//Position - 0x1BDC
{
	return uParam0 & 15;
}

void func_51(var uParam0, int iParam1)//Position - 0x1BE9
{
...
void func_52(var uParam0, int iParam1)//Position - 0x1C23
{
...
void func_53(var uParam0, int iParam1)//Position - 0x1C5E
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_54(var uParam0, int iParam1)//Position - 0x1C9A
{
	int iVar0;
	int iVar1;
...
int func_55(int iParam0, int iParam1)//Position - 0x3387
{
	struct<82> Var0;
...
void func_56(int iParam0, var uParam1, int iParam2)//Position - 0x33C9
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x3625
{
	return iParam0 < 3;
}

void func_58(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x3631
{
	if (func_54(&(Global_78179.f_555[0 /*21*/]), iParam0))
	{
...
void func_59(int iParam0, bool bParam1)//Position - 0x372A
{
	if (iParam0 == -1)
	{
		return;
...
void func_60(int iParam0, int iParam1, bool bParam2)//Position - 0x3787
{
	if (iParam0 == -1)
	{
		return;
...
void func_61(var uParam0, var uParam1)//Position - 0x37C2
{
...
void func_62(int iParam0)//Position - 0x388E
{
	if (iParam0 == -1)
	{
		return;
...
int func_63(int iParam0)//Position - 0x3905
{
	int iVar0;
...
void func_64(int iParam0, var uParam1)//Position - 0x3968
{
	int iVar0;
...
int func_65(int iParam0)//Position - 0x3C13
{
	switch (iParam0)
	{
		case 1:
...
int func_66(int iParam0, var uParam1, var uParam2)//Position - 0x3CC3
{
	int iVar0;
	int iVar1;
...
int func_67(int iParam0)//Position - 0x3EB6
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_68(var uParam0)//Position - 0x3ED6
{
	int iVar0;
...
void func_69(int iParam0)//Position - 0x3F85
{
...
void func_70(bool bParam0)//Position - 0x3FAC
{
	if (BitTest(uLocal_103, 14))
	{
...
void func_71(int iParam0)//Position - 0x4090
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x40B0
{
	int iVar0;
	int iVar1;
...
int func_73(int iParam0)//Position - 0x40ED
{
	if (func_57(iParam0))
	{
...
var func_74(int iParam0)//Position - 0x4112
{
	return Global_2169[iParam0 /*29*/];
}

int func_75(int iParam0, int iParam1)//Position - 0x4121
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_76(int iParam0)//Position - 0x4141
{
	if (iParam0 == -1)
	{
		return 0;
...
bool func_78(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x4179
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

bool func_79(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x4197
{
	if (bParam6)
	{
...
void func_80(int iParam0, bool bParam1)//Position - 0x41DE
{
...
int func_82(bool bParam0)//Position - 0x424D
{
...
void func_83(char* sParam0, var uParam1)//Position - 0x4275
{
...
bool func_86(int iParam0)//Position - 0x4409
{
	return Global_44042 == iParam0;
}

int func_87(int iParam0)//Position - 0x4417
{
	if (func_88(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_88(int iParam0)//Position - 0x4441
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_89(int iParam0, int iParam1)//Position - 0x4462
{
...
void func_90(bool bParam0)//Position - 0x449F
{
	char* sVar0;
...
bool func_91()//Position - 0x4512
{
	func_85();
	return Global_113969.f_2366.f_539.f_4321;
}

void func_92(char* sParam0)//Position - 0x452B
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_93(int iParam0, int iParam1)//Position - 0x453D
{
...
void func_96(int iParam0, int iParam1, int iParam2)//Position - 0x4618
{
	bool bVar0;
...
int func_98()//Position - 0x4BBC
{
	return Global_32948;
}

int func_99(int iParam0, int iParam1)//Position - 0x4BC7
{
	int iVar0;
...
void func_100(int iParam0, bool bParam1, int iParam2)//Position - 0x4C18
{
	if (iParam2 == -1)
	{
		iParam2 = func_101();
...
int func_101()//Position - 0x4C36
{
	return Global_1574926;
}

int func_102()//Position - 0x4C42
{
...
int func_105(int iParam0)//Position - 0x4CD1
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
int func_109(int iParam0, int iParam1)//Position - 0x4D5C
{
	int iVar0;
	int iVar1;
...
void func_110(int iParam0)//Position - 0x4D9D
{
	Global_79650 = iParam0;
	Global_79651 = iParam0;
}

void func_111()//Position - 0x4DB1
{
	struct<6> Var0;
...
void func_112(bool bParam0)//Position - 0x4F24
{
	if (bParam0)
	{
...
int func_113(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x4F95
{
	struct<15> Var0;
	int iVar15;
...
void func_114(bool bParam0)//Position - 0x50E6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_115(int iParam0)//Position - 0x51A4
{
	switch (iParam0)
	{
		case 0:
...
void func_116(int iParam0)//Position - 0x520E
{
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0x5254
{
...
void func_118(int iParam0, int iParam1, int iParam2)//Position - 0x5299
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_120(struct<6> Param0)//Position - 0x5303
{
	if (iLocal_40 == 0)
	{
		func_125(Param0);
...
void func_121(struct<6> Param0)//Position - 0x532A
{
	if (func_103())
	{
		func_122(Param0, 1);
...
void func_122(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)//Position - 0x534E
{
	struct<4> Var0;
...
struct<4> func_123(bool bParam0)//Position - 0x53BE
{
	struct<4> Var0;
...
struct<4> func_124(bool bParam0)//Position - 0x5428
{
	struct<4> Var0;
...
void func_125(struct<6> Param0)//Position - 0x5492
{
	if (func_103())
	{
		if (func_126())
...
void func_128(bool bParam0)//Position - 0x5549
{
...
void func_129(char* sParam0, char* sParam1)//Position - 0x555D
{
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		Global_22343 = 1;
...
struct<6> func_130()//Position - 0x557E
{
	struct<6> Var0;
...
void func_131()//Position - 0x55A2
{
	func_132();
}

void func_132()//Position - 0x55AE
{
	func_136();
	func_133();
}

void func_133()//Position - 0x55BE
{
	if (func_135() == 85)
	{
...
int func_135()//Position - 0x561F
{
	return Global_79652;
}

void func_136()//Position - 0x562B
{
	if (!func_79(Local_108, 0f, 0f, 0f, 0) && func_135() != func_137())
	{
...
void func_138()//Position - 0x56D7
{
	func_17();
	func_111();
}

void func_139()//Position - 0x56E7
{
	func_153();
	func_149();
	func_146();
	func_111();
	if (func_78(PLAYER::PLAYER_PED_ID(), Local_104, 150f, 1) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -176.9431f, -651.257f, 31.2136f, -150.9563f, -579.7476f, 35.4245f, 50f, false, true, 0))
	{
...
void func_140(var uParam0)//Position - 0x58AE
{
	if (*uParam0 == -1)
	{
		return;
...
int func_142(int iParam0)//Position - 0x594B
{
...
bool func_143(char* sParam0, int iParam1, char* sParam2)//Position - 0x597B
{
...
void func_144(int* iParam0)//Position - 0x5999
{
...
void func_145(char* sParam0, int iParam1, int iParam2)//Position - 0x59B9
{
	iParam2 = iParam2;
...
void func_146()//Position - 0x59D2
{
	switch (iLocal_36)
	{
		case 0:
			...
			{
				iLocal_1436 = func_147(Local_104, 1);
...
int func_147(struct<3> Param0, bool bParam3)//Position - 0x5A41
{
	int iVar0;
...
float func_148(bool bParam0, float fParam1, float fParam2)//Position - 0x5A6D
{
	if (bParam0)
	{
		return fParam1;
...
void func_149()//Position - 0x5A84
{
	if (func_105(35))
	{
		if (iLocal_36 == 0)
		{
			...
			{
				if (!func_78(iLocal_107, Local_104, 10f, 1) || ENTITY::IS_ENTITY_UPSIDEDOWN(iLocal_107))
				{
					MISC::CLEAR_BIT(&uLocal_103, 1);
				}
			}
...
int func_150(float fParam0, int iParam1)//Position - 0x5B41
{
	int iVar0;
...
int func_151(int iParam0)//Position - 0x5BC5
{
	struct<3> Var0;
...
void func_152(bool bParam0, bool bParam1)//Position - 0x5C7A
{
	func_4(bParam0);
...
int func_154(int iParam0)//Position - 0x5F96
{
...
void func_155(int iParam0)//Position - 0x5FC7
{
	if (func_159())
	{
		return;
...
void func_157(bool bParam0, bool bParam1)//Position - 0x6078
{
	if (bParam0)
	{
		if (func_15(0))
...
bool func_158()//Position - 0x60EC
{
	return BitTest(Global_1956920, 5);
}

bool func_159()//Position - 0x60FA
{
	return BitTest(Global_1956920, 19);
}

void func_160()//Position - 0x6109
{
	MISC::CLEAR_BIT(&uLocal_103, 0);
	MISC::CLEAR_BIT(&uLocal_103, 8);
	MISC::CLEAR_BIT(&uLocal_103, 7);
...
int func_161(int iParam0)//Position - 0x6127
{
...
int func_163(int iParam0)//Position - 0x61AF
{
...
int func_164(int iParam0)//Position - 0x61D9
{
	int iVar0;
...
int func_165(int iParam0)//Position - 0x61FA
{
...
int func_166(int iParam0)//Position - 0x6227
{
	int iVar0;
...
int func_167(int iParam0)//Position - 0x627B
{
	int iVar0;
...
int func_168(int iParam0)//Position - 0x62C0
{
	int iVar0;
...
int func_170(int iParam0)//Position - 0x6382
{
	if (DECORATOR::DECOR_EXIST_ON(iParam0, "GetawayVehicleValid"))
	{
		return 1;
...
void func_172()//Position - 0x63BE
{
	...
	if (func_208())
	{
		if (func_202(&uLocal_1437) && func_173(&iVar0))
		{
			func_253(0);
			if (iVar0 == 1)
			{
...
int func_173(var uParam0)//Position - 0x640A
{
	char* sVar0;
...
int func_174()//Position - 0x644A
{
	if (func_176(&uLocal_1271, Local_42.f_8, sLocal_1270, Local_42.f_4, 9, 1, 0, 0, 0))
	{
		iLocal_38 = 1;
...
void func_175(int iParam0, struct<3> Param1)//Position - 0x6484
{
	int iVar0;
...
bool func_176(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x64D3
{
...
int func_177(char* sParam0, int iParam1, bool bParam2)//Position - 0x6532
{
	Global_22287 = 0;
...
bool func_180(int iParam0)//Position - 0x689A
{
	return func_181(iParam0, 20);
}

var func_181(int iParam0, int iParam1)//Position - 0x68AA
{
	return BitTest(Global_1887305[iParam0 /*610*/].f_10.f_4, iParam1);
}

int func_182()//Position - 0x68C2
{
	return -1;
}

void func_183()//Position - 0x68CB
{
	int iVar0;
...
bool func_188(int iParam0, int iParam1)//Position - 0x6B21
{
	switch (iParam0)
	{
		case 5:
...
void func_190(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x6BB0
{
...
void func_192(bool bParam0, var uParam1)//Position - 0x6C20
{
	int iVar0;
	...
	func_193(&uLocal_1271, Local_42.f_0, PLAYER::PLAYER_PED_ID(), Local_42.f_1, 0, 1);
	func_193(&uLocal_1271, Local_42.f_2, 0, Local_42.f_3, 0, 1);
	Local_42.f_4 = uParam1;
}

void func_193(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x6D96
{
...
void func_194(int iParam0, int iParam1, bool bParam2)//Position - 0x6E31
{
	int iVar0;
...
struct<4> func_196(int iParam0)//Position - 0x7028
{
	return Global_2169[iParam0 /*29*/].f_3;
}

int func_197(int iParam0, int iParam1)//Position - 0x703B
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
int func_198(int iParam0, int iParam1)//Position - 0x7065
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
char* func_201(bool bParam0)//Position - 0x893F
{
	char* sVar0;
...
int func_202(var uParam0)//Position - 0x8A49
{
...
int func_203(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x8A9B
{
	int iVar0;
...
void func_204(var uParam0, int iParam1)//Position - 0x8BD2
{
	int iVar0;
...
bool func_205(int iParam0)//Position - 0x8C21
{
	return func_206(iParam0, Global_44042);
}

int func_206(int iParam0, int iParam1)//Position - 0x8C32
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_207(int iParam0)//Position - 0x8E13
{
	if (Global_44042 == 15)
	{
		return 0;
...
int func_209(int iParam0)//Position - 0x8E5B
{
	if (Global_23401 == 0)
	{
		return 0;
...
void func_211()//Position - 0x8ED1
{
	int iVar0;
	bool bVar1;
	
	if (((((((Global_44042 == 15 && iLocal_35 != 3) && BitTest(uLocal_103, 5)) && !func_171()) && Global_79386 == -1) && !func_221()) && !func_86(9)) || func_105(35))
	{
		func_220();
		func_219();
		switch (iLocal_37)
...
bool func_212()//Position - 0x9059
{
	return SCRIPT::IS_THREAD_ACTIVE(Global_113969.f_18106.f_395);
}

void func_213(bool bParam0, bool bParam1)//Position - 0x906F
{
	switch (iLocal_37)
	{
		case 1:
...
void func_214(char* sParam0, int iParam1)//Position - 0x9179
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_215()//Position - 0x9190
{
...
int func_216(bool bParam0)//Position - 0x91AA
{
	int iVar0;
...
int func_217(bool bParam0)//Position - 0x91F4
{
	int iVar0;
...
void func_218(var uParam0, int iParam1)//Position - 0x92A2
{
	bool bVar0;
...
int func_230(float fParam0)//Position - 0x9813
{
	if (iLocal_40 == 1)
	{
...
int func_233(int iParam0)//Position - 0x991F
{
	return func_234(iParam0, 6, 1);
}

int func_234(int iParam0, int iParam1, bool bParam2)//Position - 0x992F
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_235(int iParam0, int iParam1)//Position - 0x998F
{
	int iVar0;
	var uVar1;
...
int func_236(int iParam0, var uParam1)//Position - 0x99BE
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_237(uParam1));
}

int func_237(var uParam0)//Position - 0x99D3
{
	int iVar0;
	int iVar1;
...
int func_238(int iParam0)//Position - 0x9A07
{
	switch (iParam0)
	{
		case 0:
...
int func_239(int iParam0)//Position - 0x9DAF
{
	if (func_88(iParam0))
	{
...
void func_240(char* sParam0, int iParam1)//Position - 0x9DCF
{
	int iVar0;
	int iVar1;
...
void func_242(int iParam0)//Position - 0x9F93
{
...
void func_243(int iParam0, int iParam1)//Position - 0xA02B
{
...
int func_244(int iParam0)//Position - 0xA13B
{
...
void func_245(int iParam0)//Position - 0xA167
{
	iLocal_40 = iParam0;
	if (iLocal_40 == 0)
	{
...
void func_246()//Position - 0xA22D
{
	...
	sLocal_51[7] = func_247(7);
	sLocal_51[8] = func_247(8);
	sLocal_51[9] = "PRC_USEFIRST";
	sLocal_51[10] = func_247(10);
	sLocal_51[11] = func_247(11);
	sLocal_51[13] = func_247(13);
	sLocal_51[12] = func_247(12);
	sLocal_51[14] = "PRC_UNUSE";
	sLocal_51[15] = "PRC_SEATS";
	sLocal_51[16] = "PRC_CBOBVAL";
	sLocal_51[17] = func_247(17);
	sLocal_51[18] = func_247(18);
	sLocal_51[20] = func_247(20);
...
char* func_247(int iParam0)//Position - 0xA40A
{
	char* sVar0;
...
void func_248()//Position - 0xA5D0
{
	...
	Local_202[0 /*261*/][0 /*8*/] = { func_249("DELBE" /* GXT: Del Perro Beach */, -1615.2574f, -952.59436f, 20.01716f, -2160.7058f, -423f, -1.28679f, 327.8f) };
	Local_202[0 /*261*/][1 /*8*/] = { func_249("DELBE" /* GXT: Del Perro Beach */, -1521.7163f, -914.56757f, 20.17247f, -1855.7148f, -1325.784f, -44.79295f, 254.8f) };
	Local_202[0 /*261*/][2 /*8*/] = { func_249("BEACH" /* GXT: Vespucci Beach */, -1162.3699f, -1815.0084f, 15.33822f, -1553.2072f, -1098.6849f, 0.46467f, 253.91f) };
	Local_202[0 /*261*/][3 /*8*/] = { func_249("BEACH" /* GXT: Vespucci Beach */, -1464.2185f, -1136.7828f, 0.32167f, -2241.5664f, -358.88486f, 20.32481f, 282.21f) };
	Local_202[0 /*261*/][4 /*8*/] = { func_249("PBOX" /* GXT: Pillbox Hill */, 156.41087f, -1042.6412f, 22.31273f, 238.63815f, -821.1217f, 35.10069f, 176.96f) };
	Local_202[0 /*261*/][5 /*8*/] = { func_249("CHIL" /* GXT: Vinewood Hills */, 883.1121f, 534.72833f, 115.72503f, 559.7425f, 644.602f, 150.59714f, 301.08f) };
	Local_202[0 /*261*/][6 /*8*/] = { func_249("EAST_V" /* GXT: East Vinewood */, 941.45306f, -329.4256f, 60.77003f, 727.76514f, -200.95193f, 75.59085f, 88.89f) };
	Local_202[0 /*261*/][7 /*8*/] = { func_249("EAST_V" /* GXT: East Vinewood */, 689.1177f, -273.14056f, 60.21559f, 834.7326f, -352.1655f, 50.92442f, 81.23f) };
	Local_202[0 /*261*/][8 /*8*/] = { func_249("MIRR" /* GXT: Mirror Park */, 1048.4985f, -357.0332f, 60.92149f, 1401.5808f, -783.8975f, 75.7477f, 325.93f) };
	Local_202[0 /*261*/][9 /*8*/] = { func_249("MIRR" /* GXT: Mirror Park */, 892.28357f, -461.57523f, 70.86029f, 1161.3007f, -829.8299f, 45.90131f, 184.12f) };
	Local_202[0 /*261*/][10 /*8*/] = { func_249("VCANA" /* GXT: Vespucci Canals */, -1161.3606f, -1143.7163f, -5.71593f, -864.9714f, -981.12573f, 21.09691f, 328.65f) };
	Local_202[0 /*261*/][11 /*8*/] = { func_249("BAYTRE" /* GXT: Baytree Canyon */, 251.40108f, 1068.3472f, 280.6663f, 189.60123f, 1272.3522f, 143.80351f, 160.32f) };
	Local_202[0 /*261*/][13 /*8*/] = { func_249("OBSERV" /* GXT: Galileo Observatory */, -450.98346f, 1048.4084f, 252.94498f, -389.56403f, 1244.5039f, 370.24692f, 199.93f) };
	Local_202[0 /*261*/][14 /*8*/] = { func_249("AIRP" /* GXT: Los Santos International Airport */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[0 /*261*/][15 /*8*/] = { func_249("TERMINA" /* GXT: Terminal */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[0 /*261*/][16 /*8*/] = { func_249("STAD" /* GXT: Maze Bank Arena */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[0 /*261*/][17 /*8*/] = { func_249("MOVIE" /* GXT: Richards Majestic */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[0 /*261*/][18 /*8*/] = { func_249("GOLF" /* GXT: GWC and Golfing Society */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[0 /*261*/][19 /*8*/] = { func_249("HORS" /* GXT: Vinewood Racetrack */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[0 /*261*/][20 /*8*/] = { func_249("PBOX" /* GXT: Pillbox Hill */, -28.39781f, -1071.2449f, 50.21438f, -49.8352f, -1131.2766f, 20.02555f, 55.12f) };
	Local_202[0 /*261*/][21 /*8*/] = { func_249("LOSSF" /* GXT: Los Santos Freeway */, 843.19617f, 25.93548f, 65.16061f, 1138.6865f, 363.05872f, 105.41279f, 61.11f) };
	Local_202[0 /*261*/][22 /*8*/] = { func_249("ROCKF" /* GXT: Rockford Hills */, -992.56384f, -199.7673f, 30.74956f, -687.9904f, -43.23445f, 80.93306f, 80.53f) };
	Local_202[0 /*261*/][23 /*8*/] = { func_249("ROCKF" /* GXT: Rockford Hills */, -251.8548f, -446.2141f, 29.5887f, -362.685f, -434.7425f, 90.931f, 50f) };
	Local_202[0 /*261*/][24 /*8*/] = { func_249("ALTA" /* GXT: Alta */, 180.2637f, -404.9771f, 40.1713f, 289.9432f, -445.1485f, 124.3793f, 100f) };
	Local_202[0 /*261*/][25 /*8*/] = { func_249("ALTA" /* GXT: Alta */, 343.8481f, -323.1273f, 80.7749f, 427.08f, -361.0469f, 45.3411f, 85f) };
	Local_202[0 /*261*/][26 /*8*/] = { func_249("RANCHO" /* GXT: Rancho */, 414.5057f, -2092.0999f, 19.8533f, 350.8093f, -2158.395f, 12.3916f, 55f) };
	Local_202[0 /*261*/][27 /*8*/] = { func_249("RANCHO" /* GXT: Rancho */, 283.7474f, -2103.9177f, 12.9242f, 391.8871f, -1983.2037f, 33.0042f, 100f) };
	Local_202[0 /*261*/][28 /*8*/] = { func_249("PBOX" /* GXT: Pillbox Hill */, 85.038f, -670.3274f, 42.8642f, 227.8234f, -722.2458f, 274f, 175f) };
	Local_202[0 /*261*/][29 /*8*/] = { func_249("PBOX" /* GXT: Pillbox Hill */, -107.2516f, -906.36f, 28.2051f, -49.9007f, -752.925f, 330f, 125f) };
	Local_202[0 /*261*/][30 /*8*/] = { func_249("TEXTI" /* GXT: Textile City */, 456.8563f, -683.8335f, 32.2903f, 457.5504f, -819.4669f, 25.9553f, 14.4f) };
	Local_202[0 /*261*/][31 /*8*/] = { func_249("ROCKF" /* GXT: Rockford Hills */, -699.7205f, -227.3646f, 67.818f, -645.1068f, -332.5107f, 30.9132f, 127.1f) };
	Local_202[0 /*261*/].f_260 = 0;
	Local_202[0 /*261*/].f_257 = 32;
	Local_202[2 /*261*/][0 /*8*/] = { func_249("PBOX" /* GXT: Pillbox Hill */, -25.50944f, -932.38464f, 20.41711f, 119.94056f, -523.43976f, 33.07988f, 363.4f) };
	Local_202[2 /*261*/][1 /*8*/] = { func_249("DOWNT" /* GXT: Downtown */, -25.50944f, -932.38464f, 20.41711f, 119.94056f, -523.43976f, 33.07988f, 363.4f) };
	Local_202[2 /*261*/][2 /*8*/] = { func_249("COSI" /* GXT: Countryside */, 1426.9344f, 1225.1151f, 90.76305f, 1429.9823f, 1006.8307f, 120.66425f, 259.89f) };
	Local_202[2 /*261*/][3 /*8*/] = { func_249("COSI" /* GXT: Countryside */, 3503.5603f, 3546.4026f, 20.18748f, 3513.9546f, 3875.7952f, 72.94806f, 393.78f) };
	Local_202[2 /*261*/][4 /*8*/] = { func_249("SKID" /* GXT: Mission Row */, 403.54044f, -864.46936f, 20.33799f, 396.34406f, -1127.3247f, 35.49262f, 325.93f) };
	Local_202[2 /*261*/][5 /*8*/] = { func_249("JAIL" /* GXT: Bolingbroke Penitentiary */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[2 /*261*/][6 /*8*/] = { func_249("ARMYB" /* GXT: Fort Zancudo */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[2 /*261*/].f_260 = 2;
	Local_202[2 /*261*/].f_257 = 7;
	Local_202[1 /*261*/][0 /*8*/] = { func_249("PALETO" /* GXT: Paleto Bay */, -422.86185f, 6068.399f, 20.34662f, -282.74524f, 6206.324f, 50.46586f, 196.61f) };
	Local_202[1 /*261*/][1 /*8*/] = { func_249("ROCKF" /* GXT: Rockford Hills */, -755.2506f, 147.4266f, 75.41048f, -1079.0332f, 169.38055f, 50.46801f, 179.12f) };
	Local_202[1 /*261*/][2 /*8*/] = { func_249("ROCKF" /* GXT: Rockford Hills */, -752.36743f, 90.76733f, 65.5171f, -938.79803f, -15.91457f, 35.48347f, 205.78f) };
	Local_202[1 /*261*/][3 /*8*/] = { func_249("ROCKF" /* GXT: Rockford Hills */, -890.4999f, 431.1449f, 90.29848f, -875.3576f, 232.3266f, 60.20724f, 263.82f) };
	Local_202[1 /*261*/][4 /*8*/] = { func_249("ROCKF" /* GXT: Rockford Hills */, -752.36743f, 90.76733f, 65.5171f, -938.79803f, -15.91457f, 35.48347f, 205.78f) };
	Local_202[1 /*261*/][5 /*8*/] = { func_249("ROCKF" /* GXT: Rockford Hills */, -1198.1826f, 638.63666f, 115.10664f, -444.509f, 750.9377f, 198.29713f, 473.88f) };
	Local_202[1 /*261*/][6 /*8*/] = { func_249("ROCKF" /* GXT: Rockford Hills */, -844.40753f, 400.9413f, 80.433f, -109.53111f, 420.5014f, 120.2088f, 256.03f) };
	Local_202[1 /*261*/][7 /*8*/] = { func_249("ROCKF" /* GXT: Rockford Hills */, -518.62134f, 648.82654f, 130.93524f, -64.0709f, 582.45044f, 215.30841f, 162.72f) };
	Local_202[1 /*261*/][8 /*8*/] = { func_249("RICHM" /* GXT: Richman */, -934.98016f, 349.61014f, 85.77298f, -1432.4509f, 269.98038f, 50.7303f, 185.03f) };
	Local_202[1 /*261*/][9 /*8*/] = { func_249("RICHM" /* GXT: Richman */, -1633.8134f, -69.53224f, 65.10236f, -1446.8229f, 69.71544f, 48.23926f, 214.92f) };
	Local_202[1 /*261*/][10 /*8*/] = { func_249("RICHM" /* GXT: Richman */, -1732.258f, 444.13525f, 130.12581f, -2065.6904f, 412.21207f, 98.09863f, 175.17f) };
	Local_202[1 /*261*/][11 /*8*/] = { func_249("RICHM" /* GXT: Richman */, -1618.0363f, 50.95197f, 70.95364f, -1396.5143f, 221.1004f, 50.84464f, 161.61f) };
	Local_202[1 /*261*/][12 /*8*/] = { func_249("RICHM" /* GXT: Richman */, -1801.285f, 106.8786f, 72.12892f, -1541.7401f, 263.37378f, 50.44112f, 155.88f) };
	Local_202[1 /*261*/][13 /*8*/] = { func_249("PELUFF", -2208.5627f, 146.41006f, 150.93246f, -2350.1223f, 486.60657f, 200.5952f, 299.18f) };
	Local_202[1 /*261*/][14 /*8*/] = { func_249("PELUFF", -1852.3263f, 134.41718f, 70.06226f, -1994.3872f, 299.62833f, 100.96516f, 182.04f) };
	Local_202[1 /*261*/][15 /*8*/] = { func_249("CHIL" /* GXT: Vinewood Hills */, -1982.6697f, 505.9648f, 100.93644f, -1918.8427f, 713.6382f, 150.73953f, 168.9f) };
	Local_202[1 /*261*/][16 /*8*/] = { func_249("CHIL" /* GXT: Vinewood Hills */, -1455.7506f, 887.3351f, 191.97572f, -1663.2073f, 767.3684f, 160.81076f, 239.65f) };
	Local_202[1 /*261*/][17 /*8*/] = { func_249("CHIL" /* GXT: Vinewood Hills */, -1570.2218f, 508.20563f, 140.38838f, -808.95325f, 526.43335f, 90.18556f, 238.43f) };
	Local_202[1 /*261*/][18 /*8*/] = { func_249("CHIL" /* GXT: Vinewood Hills */, 242.62039f, 583.59045f, 159.40428f, 268.04242f, 827.4494f, 201.69531f, 105.09f) };
	Local_202[1 /*261*/][19 /*8*/] = { func_249("CHIL" /* GXT: Vinewood Hills */, -21.10285f, 706.8648f, 150.72626f, -210.43822f, 1056.2755f, 280.31824f, 290.15f) };
	Local_202[1 /*261*/][20 /*8*/] = { func_249("RGLEN" /* GXT: Richman Glen */, -1837.5383f, 774.2984f, 120.56287f, -1765.8419f, 831.0044f, 160.35838f, 68.09f) };
	Local_202[1 /*261*/][21 /*8*/] = { func_249("DIVINE", -372.0849f, 372.71826f, 100.60433f, 390.2198f, 532.5167f, 180.53801f, 305.88f) };
	Local_202[1 /*261*/].f_260 = 1;
	Local_202[1 /*261*/].f_257 = 22;
	Local_202[3 /*261*/][0 /*8*/] = { func_249("MTCHIL" /* GXT: Mount Chiliad */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[3 /*261*/][1 /*8*/] = { func_249("MTGORDO" /* GXT: Mount Gordo */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[3 /*261*/][2 /*8*/] = { func_249("SANCHIA" /* GXT: San Chianski Mountain Range */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[3 /*261*/][3 /*8*/] = { func_249("TATAMO" /* GXT: Tataviam Mountains */, 0f, 0f, 0f, 0f, 0f, 0f, 0f) };
	Local_202[3 /*261*/][4 /*8*/] = { func_249("ELYSIAN" /* GXT: Elysian Island */, 531.2397f, -3019.2666f, 50f, 530.1656f, -3393.6226f, -22.4165f, 210f) };
	Local_202[3 /*261*/][5 /*8*/] = { func_249("ELYSIAN" /* GXT: Elysian Island */, 569.1023f, -2913.018f, 15.891f, 420.8226f, -2912.775f, -15.0372f, 25f) };
	Local_202[3 /*261*/][6 /*8*/] = { func_249("ELYSIAN" /* GXT: Elysian Island */, 495.1012f, -2833.1753f, 5.164f, 460.1983f, -2813.5283f, 0.4269f, 12f) };
	Local_202[3 /*261*/][7 /*8*/] = { func_249("ELYSIAN" /* GXT: Elysian Island */, 675.2973f, -2747.4504f, 4.952f, 689.2358f, -2747.3955f, 10.9001f, 4.3f) };
	Local_202[3 /*261*/][8 /*8*/] = { func_249("CYPRE" /* GXT: Cypress Flats */, 533.437f, -2693.2793f, 17.4952f, 588.6345f, -2693.4624f, 5.3007f, 15f) };
	Local_202[3 /*261*/][9 /*8*/] = { func_249("CYPRE" /* GXT: Cypress Flats */, 534.9656f, -2699.1365f, 4.9004f, 560.1779f, -2662.1921f, 9.0007f, 15f) };
	Local_202[3 /*261*/][10 /*8*/] = { func_249("CYPRE" /* GXT: Cypress Flats */, 583.903f, -2689.2068f, 16.9771f, 549.8469f, -2665.3176f, 3.9007f, 17.3f) };
	Local_202[3 /*261*/][11 /*8*/] = { func_249("CYPRE" /* GXT: Cypress Flats */, 683.428f, -2635.1343f, 9.3367f, 694.4725f, -2679.6597f, 4.7815f, 10f) };
	Local_202[3 /*261*/][12 /*8*/] = { func_249("CYPRE" /* GXT: Cypress Flats */, 695.2171f, -2694.7688f, 5.9815f, 695.5035f, -2679.1677f, 4.8365f, 10f) };
	Local_202[3 /*261*/][13 /*8*/] = { func_249("CYPRE" /* GXT: Cypress Flats */, 731.7991f, -2659.5796f, 4.7713f, 732.5307f, -2678.4001f, 10.5065f, 25f) };
	Local_202[3 /*261*/][14 /*8*/] = { func_249("ELYSIAN" /* GXT: Elysian Island */, 86.1885f, -2430.6963f, -0.1888f, 119.1515f, -2453.121f, 2.8614f, 13f) };
	Local_202[3 /*261*/][15 /*8*/] = { func_249("ELYSIAN" /* GXT: Elysian Island */, 260.3166f, -2426.7773f, 21.2819f, 313.7871f, -2433.6558f, 6.5609f, 20.5f) };
	Local_202[3 /*261*/][16 /*8*/] = { func_249("ELYSIAN" /* GXT: Elysian Island */, 260.3166f, -2426.7773f, 21.2819f, 313.7871f, -2433.6558f, 6.5609f, 20.5f) };
	Local_202[3 /*261*/][17 /*8*/] = { func_249("ELYSIAN" /* GXT: Elysian Island */, 283.1514f, -2456.7773f, 19.4609f, 290.2325f, -2403.6113f, 4.2465f, 20.5f) };
	Local_202[3 /*261*/][18 /*8*/] = { func_249("ELYSIAN" /* GXT: Elysian Island */, 266.0341f, -2446.724f, 19.4623f, 308.3783f, -2414.5442f, 4.5423f, 20.5f) };
	Local_202[3 /*261*/][19 /*8*/] = { func_249("ELYSIAN" /* GXT: Elysian Island */, 303.5269f, -2451.4456f, 19.4091f, 270.9798f, -2409.4517f, 4.4609f, 20.5f) };
	Local_202[3 /*261*/][20 /*8*/] = { func_249("RANCHO" /* GXT: Rancho */, 515.026f, -1653.5404f, 37.2615f, 582.571f, -1577.8248f, 26.3365f, 100f) };
	Local_202[3 /*261*/][21 /*8*/] = { func_249("BURTON" /* GXT: Burton */, -150.7403f, -419.0541f, 28.6163f, -52.8669f, -453.5552f, 39.4051f, 100f) };
	Local_202[3 /*261*/][22 /*8*/] = { func_249("SanAnd" /* GXT: San Andreas */, 50.2035f, -470.7132f, 36.9003f, 102.0394f, -322.0089f, 115f, 130f) };
	Local_202[3 /*261*/][23 /*8*/] = { func_249("ALTA" /* GXT: Alta */, 499.1769f, -241.2495f, 47.3462f, 393.5317f, -205.7358f, 79.3132f, 120f) };
	Local_202[3 /*261*/][24 /*8*/] = { func_249("DTVINE" /* GXT: Downtown Vinewood */, 422.3247f, 62.118f, 113.2905f, 478.494f, 43.322f, 83.4541f, 80f) };
	Local_202[3 /*261*/][25 /*8*/] = { func_249("DTVINE" /* GXT: Downtown Vinewood */, 385.4908f, 56.1423f, 159.58f, 332.458f, -87.6805f, 63.3657f, 80f) };
	Local_202[3 /*261*/][26 /*8*/] = { func_249("DTVINE" /* GXT: Downtown Vinewood */, 213.6192f, 90.2228f, 98.9357f, 203.3067f, 61.8088f, 86.9197f, 60f) };
	Local_202[3 /*261*/][27 /*8*/] = { func_249("DTVINE" /* GXT: Downtown Vinewood */, 192.813f, -14.9451f, 85.3158f, 149.2689f, 0.6803f, 67.0343f, 40f) };
	Local_202[3 /*261*/][28 /*8*/] = { func_249("WVINE" /* GXT: West Vinewood */, 16.1659f, 61.8685f, 70.8467f, -17.1751f, 74.3771f, 76.88f, 4.5f) };
	Local_202[3 /*261*/][29 /*8*/] = { func_249("WVINE" /* GXT: West Vinewood */, -86.5425f, 84.8701f, 80.2147f, -50.4826f, 67.7335f, 70.297f, 20f) };
	Local_202[3 /*261*/][30 /*8*/] = { func_249("ELGORL" /* GXT: El Gordo Lighthouse */, 3449.839f, 5173.9814f, 0.0662f, 3412.309f, 5166.8896f, 14.8342f, 33.7f) };
...
struct<8> func_249(char* sParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0xB90A
{
	struct<8> Var0;
...
void func_250(int iParam0, bool bParam1)//Position - 0xB935
{
	if (func_87(iLocal_107))
	{
		func_20(&iLocal_107);
...
int func_251(int iParam0)//Position - 0xB95D
{
	int iVar0;
	bool bVar1;
...
void func_253(bool bParam0)//Position - 0xB9DA
{
	char* sVar0;
...
void func_258(char* sParam0)//Position - 0xBAFC
{
	StringCopy(&(Global_8638[0 /*16*/].f_8), sParam0, 32);
}

void func_259(char* sParam0)//Position - 0xBB10
{
	StringCopy(&(Global_8638[2 /*16*/].f_8), sParam0, 32);
}

void func_260(char* sParam0)//Position - 0xBB24
{
	StringCopy(&(Global_8638[1 /*16*/].f_8), sParam0, 32);
}

void func_261(char* sParam0)//Position - 0xBB38
{
	StringCopy(&(Global_8638[3 /*16*/].f_8), sParam0, 32);
}

void func_262(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0xBB4C
{
	func_263(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_263(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0xBB6C
{
	int iVar0;
...
int func_264(var uParam0, int iParam1)//Position - 0xBD3E
{
	if (iParam1 == -1)
	{
		return 0;
...
float func_265(int iParam0)//Position - 0xBD89
{
	if (iParam0 == -1)
	{
		return 0f;
...
Vector3 func_266(int iParam0)//Position - 0xBDBF
{
	if (iParam0 == -1)
	{
		return 0f, 0f, 0f;
...
int func_267(int iParam0)//Position - 0xBDF9
{
	int iVar0;
	bool bVar1;
