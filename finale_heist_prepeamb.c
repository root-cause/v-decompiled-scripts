...
int func_30(bool bParam0)//Position - 0x64E5
{
	if (bParam0)
	{
...
bool func_31()//Position - 0x64FF
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_32()//Position - 0x6515
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_33()//Position - 0x652B
{
	return 0;
}

int func_34()//Position - 0x6534
{
	return 1;
}

int func_35()//Position - 0x653D
{
	return 1;
}

int func_36()//Position - 0x6546
{
...
int func_38(int iParam0)//Position - 0x6617
{
	int iVar0;
	char* sVar1;
...
int func_39(int iParam0)//Position - 0x665E
{
	int iVar0;
...
int func_40(int iParam0)//Position - 0x6699
{
	int iVar0;
...
int func_41(int iParam0)//Position - 0x6715
{
	int iVar0;
...
int func_42(int iParam0, int iParam1, bool bParam2)//Position - 0x67FD
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_43(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x686B
{
...
void func_45(var uParam0, int iParam1)//Position - 0x6988
{
	if (iParam1 <= 0)
	{
		return;
...
void func_46(var uParam0, int iParam1)//Position - 0x6A0E
{
...
void func_47(var uParam0, int iParam1)//Position - 0x6A41
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1)//Position - 0x6A92
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_49(int iParam0)//Position - 0x6B34
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_50(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_50(bool bParam0, int iParam1, int iParam2)//Position - 0x6B56
{
	if (bParam0)
	{
		return iParam1;
...
int func_51(var uParam0)//Position - 0x6B6D
{
	return uParam0 & 15;
}

void func_52(var uParam0, int iParam1)//Position - 0x6B7A
{
...
void func_53(var uParam0, int iParam1)//Position - 0x6BB4
{
...
void func_54(var uParam0, int iParam1)//Position - 0x6BEF
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_55(var uParam0, int iParam1)//Position - 0x6C2B
{
	int iVar0;
	int iVar1;
...
int func_56(int iParam0, int iParam1)//Position - 0x8319
{
	struct<82> Var0;
...
void func_57(int iParam0, var uParam1, int iParam2)//Position - 0x835B
{
	int iVar0;
...
bool func_58(int iParam0)//Position - 0x85B7
{
	return iParam0 < 3;
}

void func_59(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x85C3
{
	if (func_55(&(Global_77479.f_555[0 /*21*/]), iParam0))
	{
...
void func_60(int iParam0, bool bParam1)//Position - 0x86BC
{
	if (iParam0 == -1)
	{
		return;
...
void func_61(int iParam0, int iParam1, bool bParam2)//Position - 0x8719
{
	if (iParam0 == -1)
	{
		return;
...
void func_62(var uParam0, var uParam1)//Position - 0x8754
{
...
void func_63(int iParam0)//Position - 0x8820
{
	if (iParam0 == -1)
	{
		return;
...
int func_64(int iParam0)//Position - 0x8897
{
	int iVar0;
...
void func_65(int iParam0, var uParam1)//Position - 0x88FA
{
	int iVar0;
...
int func_66(int iParam0)//Position - 0x8BA5
{
	switch (iParam0)
	{
		case 1:
...
int func_67(int iParam0, var uParam1, var uParam2)//Position - 0x8C55
{
	int iVar0;
	int iVar1;
...
int func_68(int iParam0)//Position - 0x8E48
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_69(var uParam0)//Position - 0x8E68
{
	int iVar0;
...
void func_70(int iParam0)//Position - 0x8F17
{
...
void func_71(bool bParam0)//Position - 0x8F3E
{
	if (BitTest(uLocal_103, 14))
	{
...
void func_72(int iParam0)//Position - 0x9022
{
	int iVar0;
...
int func_73(int iParam0)//Position - 0x9042
{
	int iVar0;
	int iVar1;
...
int func_74(int iParam0)//Position - 0x907F
{
	if (func_58(iParam0))
	{
...
var func_75(int iParam0)//Position - 0x90A4
{
	return Global_2058[iParam0 /*29*/];
}

int func_76(int iParam0, int iParam1)//Position - 0x90B3
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x90D3
{
	if (iParam0 == -1)
	{
		return 0;
...
bool func_79(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x910B
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

bool func_80(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x9129
{
	if (bParam6)
	{
...
void func_81(int iParam0, bool bParam1)//Position - 0x9170
{
...
int func_83(bool bParam0)//Position - 0x91DF
{
...
void func_84(char* sParam0, var uParam1)//Position - 0x9207
{
...
bool func_87(int iParam0)//Position - 0x939B
{
	return Global_43377 == iParam0;
}

int func_88(int iParam0)//Position - 0x93A9
{
	if (func_89(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_89(int iParam0)//Position - 0x93D3
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_90(int iParam0, int iParam1)//Position - 0x93F4
{
...
void func_91(bool bParam0)//Position - 0x9431
{
	char* sVar0;
...
bool func_92()//Position - 0x94A4
{
	func_86();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_93(char* sParam0)//Position - 0x94BD
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_94(int iParam0, int iParam1)//Position - 0x94CF
{
...
void func_97(int iParam0, int iParam1, int iParam2)//Position - 0x95AA
{
	bool bVar0;
...
int func_99()//Position - 0x9B4E
{
	return Global_32283;
}

int func_100(int iParam0, int iParam1)//Position - 0x9B59
{
	int iVar0;
...
void func_101(int iParam0, bool bParam1, int iParam2)//Position - 0x9BAA
{
	if (iParam2 == -1)
	{
		iParam2 = func_102();
...
int func_102()//Position - 0x9BC8
{
	return Global_1574918;
}

int func_103()//Position - 0x9BD4
{
...
int func_106(int iParam0)//Position - 0x9C63
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
int func_110(int iParam0, int iParam1)//Position - 0x9CEE
{
	int iVar0;
	int iVar1;
...
void func_111(int iParam0)//Position - 0x9D2F
{
	Global_78950 = iParam0;
	Global_78951 = iParam0;
}

void func_112()//Position - 0x9D43
{
	struct<6> Var0;
...
void func_113(bool bParam0)//Position - 0x9EB6
{
	if (bParam0)
	{
...
int func_114(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x9F27
{
	struct<15> Var0;
	int iVar15;
...
void func_115(bool bParam0)//Position - 0xA078
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_116(int iParam0)//Position - 0xA136
{
	switch (iParam0)
	{
		case 0:
...
void func_117(int iParam0)//Position - 0xA1A0
{
...
void func_118(int iParam0, int iParam1, int iParam2)//Position - 0xA1E6
{
...
void func_119(int iParam0, int iParam1, int iParam2)//Position - 0xA22B
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_121(struct<6> Param0)//Position - 0xA295
{
	if (iLocal_40 == 0)
	{
		func_126(Param0);
...
void func_122(struct<6> Param0)//Position - 0xA2BC
{
	if (func_104())
	{
		func_123(Param0, 1);
...
void func_123(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)//Position - 0xA2E0
{
	struct<4> Var0;
...
struct<4> func_124(bool bParam0)//Position - 0xA350
{
	struct<4> Var0;
...
struct<4> func_125(bool bParam0)//Position - 0xA3BA
{
	struct<4> Var0;
...
void func_126(struct<6> Param0)//Position - 0xA424
{
	if (func_104())
	{
		if (func_127())
...
void func_129(bool bParam0)//Position - 0xA4DB
{
...
void func_130(char* sParam0, char* sParam1)//Position - 0xA4EF
{
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		Global_21902 = 1;
...
struct<6> func_131()//Position - 0xA510
{
	struct<6> Var0;
...
void func_132()//Position - 0xA534
{
	func_133();
}

void func_133()//Position - 0xA540
{
	func_137();
	func_134();
}

void func_134()//Position - 0xA550
{
	if (func_136() == 85)
	{
...
int func_136()//Position - 0xA5B1
{
	return Global_78952;
}

void func_137()//Position - 0xA5BD
{
...
void func_139()//Position - 0xA669
{
	func_17();
	func_112();
}

void func_140()//Position - 0xA679
{
	func_154();
	func_150();
	func_147();
...
void func_141(var uParam0)//Position - 0xA840
{
	if (*uParam0 == -1)
	{
		return;
...
int func_143(int iParam0)//Position - 0xA8DD
{
...
bool func_144(char* sParam0, int iParam1, char* sParam2)//Position - 0xA90D
{
...
void func_145(int* iParam0)//Position - 0xA92B
{
...
void func_146(char* sParam0, int iParam1, int iParam2)//Position - 0xA94B
{
	iParam2 = iParam2;
...
int func_148(struct<3> Param0, bool bParam3)//Position - 0xA9D3
{
	int iVar0;
...
float func_149(bool bParam0, float fParam1, float fParam2)//Position - 0xA9FF
{
	if (bParam0)
	{
		return fParam1;
...
int func_151(float fParam0, int iParam1)//Position - 0xAAD3
{
	int iVar0;
...
int func_152(int iParam0)//Position - 0xAB57
{
	struct<3> Var0;
...
void func_153(bool bParam0, bool bParam1)//Position - 0xAC0C
{
	func_4(bParam0);
...
int func_155(int iParam0)//Position - 0xAF28
{
...
void func_156(int iParam0)//Position - 0xAF59
{
	if (func_160())
	{
		return;
...
void func_158(bool bParam0, bool bParam1)//Position - 0xB00A
{
	if (bParam0)
	{
		if (func_15(0))
...
bool func_159()//Position - 0xB07E
{
	return BitTest(Global_1963795, 5);
}

bool func_160()//Position - 0xB08C
{
	return BitTest(Global_1963795, 19);
}

void func_161()//Position - 0xB09B
{
	MISC::CLEAR_BIT(&uLocal_103, 0);
	MISC::CLEAR_BIT(&uLocal_103, 8);
	MISC::CLEAR_BIT(&uLocal_103, 7);
...
int func_162(int iParam0)//Position - 0xB0B9
{
...
int func_164(int iParam0)//Position - 0xB141
{
...
int func_165(int iParam0)//Position - 0xB16B
{
	int iVar0;
...
int func_166(int iParam0)//Position - 0xB18C
{
...
int func_167(int iParam0)//Position - 0xB1B9
{
	int iVar0;
...
int func_168(int iParam0)//Position - 0xB20D
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0xB252
{
	int iVar0;
...
int func_171(int iParam0)//Position - 0xB314
{
	if (DECORATOR::DECOR_EXIST_ON(iParam0, "GetawayVehicleValid"))
	{
		return 1;
...
int func_174(var uParam0)//Position - 0xB39C
{
	char* sVar0;
...
void func_176(int iParam0, struct<3> Param1)//Position - 0xB416
{
	int iVar0;
...
bool func_177(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0xB465
{
...
int func_178(char* sParam0, int iParam1, bool bParam2)//Position - 0xB4C4
{
	Global_21846 = 0;
...
bool func_181(int iParam0)//Position - 0xB82C
{
	return func_182(iParam0, 20);
}

var func_182(int iParam0, int iParam1)//Position - 0xB83C
{
	return BitTest(Global_1895156[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_183()//Position - 0xB854
{
	return -1;
}

void func_184()//Position - 0xB85D
{
	int iVar0;
...
bool func_189(int iParam0, int iParam1)//Position - 0xBAB3
{
	switch (iParam0)
	{
		case 5:
...
void func_191(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xBB42
{
...
void func_193(bool bParam0, var uParam1)//Position - 0xBBB2
{
	int iVar0;
...
void func_194(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xBD28
{
...
void func_195(int iParam0, int iParam1, bool bParam2)//Position - 0xBDC3
{
	int iVar0;
		...
		if (bParam2)
		{
			if (!Global_78689)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9029[iParam1 /*4*/] = { func_197(iParam0) };
					...
					{
						Global_8980[1 /*6*/] = { func_197(iParam0) };
...
struct<4> func_197(int iParam0)//Position - 0xBFBA
{
	return Global_2058[iParam0 /*29*/].f_3;
}

int func_198(int iParam0, int iParam1)//Position - 0xBFCD
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
int func_199(int iParam0, int iParam1)//Position - 0xBFF7
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
char* func_202(bool bParam0)//Position - 0xD8D0
{
	char* sVar0;
...
int func_203(var uParam0)//Position - 0xD9DA
{
...
int func_204(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xDA2C
{
	int iVar0;
...
void func_205(var uParam0, int iParam1)//Position - 0xDB63
{
	int iVar0;
...
bool func_206(int iParam0)//Position - 0xDBB2
{
	return func_207(iParam0, Global_43377);
}

int func_207(int iParam0, int iParam1)//Position - 0xDBC3
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_208(int iParam0)//Position - 0xDDA4
{
	if (Global_43377 == 15)
	{
		return 0;
...
int func_210(int iParam0)//Position - 0xDDEC
{
	if (Global_22960 == 0)
	{
		return 0;
...
void func_212()//Position - 0xDE62
{
	int iVar0;
	bool bVar1;
	
	if (((((((Global_43377 == 15 && iLocal_35 != 3) && BitTest(uLocal_103, 5)) && !func_172()) && Global_78686 == -1) && !func_222()) && !func_87(9)) || func_106(35))
	{
		func_221();
		func_220();
		switch (iLocal_37)
	...
	else if (((((((Global_43377 != 15 || Global_43377 != 0) || Global_43377 != 2) || Global_43377 != 4) || Global_43377 != 17) || func_172()) || Global_78686 == -1) || Global_112865)
	{
		bVar1 = false;
		if (func_213())
		{
...
bool func_213()//Position - 0xDFEA
{
	return SCRIPT::IS_THREAD_ACTIVE(Global_113810.f_18106.f_395);
}

void func_214(bool bParam0, bool bParam1)//Position - 0xE000
{
	switch (iLocal_37)
	{
		case 1:
...
void func_215(char* sParam0, int iParam1)//Position - 0xE10A
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_216()//Position - 0xE121
{
...
int func_217(bool bParam0)//Position - 0xE13B
{
	int iVar0;
...
int func_218(bool bParam0)//Position - 0xE185
{
	int iVar0;
...
void func_219(var uParam0, int iParam1)//Position - 0xE233
{
	bool bVar0;
...
int func_231(float fParam0)//Position - 0xE7A4
{
	if (iLocal_40 == 1)
	{
...
int func_234(int iParam0)//Position - 0xE8B0
{
	return func_235(iParam0, 6, 1);
}

int func_235(int iParam0, int iParam1, bool bParam2)//Position - 0xE8C0
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_236(int iParam0, int iParam1)//Position - 0xE920
{
	int iVar0;
	var uVar1;
...
int func_237(int iParam0, var uParam1)//Position - 0xE94F
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_238(uParam1));
}

int func_238(var uParam0)//Position - 0xE964
{
	int iVar0;
	int iVar1;
...
int func_239(int iParam0)//Position - 0xE998
{
	switch (iParam0)
	{
		case 0:
...
int func_240(int iParam0)//Position - 0xED40
{
	if (func_89(iParam0))
	{
...
void func_241(char* sParam0, int iParam1)//Position - 0xED60
{
	int iVar0;
	int iVar1;
...
void func_243(int iParam0)//Position - 0xEF24
{
...
void func_244(int iParam0, int iParam1)//Position - 0xEFBC
{
...
int func_245(int iParam0)//Position - 0xF0CC
{
...
void func_246(int iParam0)//Position - 0xF0F8
{
	iLocal_40 = iParam0;
	if (iLocal_40 == 0)
	{
...
char* func_248(int iParam0)//Position - 0xF39B
{
	char* sVar0;
...
struct<8> func_250(char* sParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x1089E
{
	struct<8> Var0;
...
void func_251(int iParam0, bool bParam1)//Position - 0x108C9
{
	if (func_88(iLocal_107))
	{
		func_20(&iLocal_107);
...
int func_252(int iParam0)//Position - 0x108F1
{
	int iVar0;
	bool bVar1;
...
void func_253()//Position - 0x10948
{
	if (func_106(35))
	{
		func_94(35, 0);
...
void func_254(bool bParam0)//Position - 0x1096E
{
	char* sVar0;
...
void func_255()//Position - 0x10A38
{
...
void func_256()//Position - 0x10A4E
{
...
void func_257()//Position - 0x10A64
{
...
void func_258()//Position - 0x10A7A
{
...
void func_259(char* sParam0)//Position - 0x10A90
{
	StringCopy(&(Global_8208[0 /*16*/].f_8), sParam0, 32);
}

void func_260(char* sParam0)//Position - 0x10AA4
{
	StringCopy(&(Global_8208[2 /*16*/].f_8), sParam0, 32);
}

void func_261(char* sParam0)//Position - 0x10AB8
{
	StringCopy(&(Global_8208[1 /*16*/].f_8), sParam0, 32);
}

void func_262(char* sParam0)//Position - 0x10ACC
{
	StringCopy(&(Global_8208[3 /*16*/].f_8), sParam0, 32);
}

void func_263(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x10AE0
{
	func_264(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_264(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x10B00
{
	int iVar0;
...
int func_265(var uParam0, int iParam1)//Position - 0x10CD2
{
	if (iParam1 == -1)
	{
		return 0;
...
float func_266(int iParam0)//Position - 0x10D1D
{
	if (iParam0 == -1)
	{
		return 0f;
...
Vector3 func_267(int iParam0)//Position - 0x10D53
{
	if (iParam0 == -1)
	{
		return 0f, 0f, 0f;
...
int func_268(int iParam0)//Position - 0x10D8D
{
	int iVar0;
	bool bVar1;
