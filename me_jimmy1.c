#region Local Var
	...
	int iLocal_297 = 0;
	bool bLocal_298 = 0;
	char* sLocal_299[8] = { NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL };
	int iLocal_308 = 0;
	int iLocal_309 = 0;
	int iLocal_310 = 0;
	bool bLocal_311 = 0;
	...
	int iLocal_321 = 0;
	int iLocal_322 = 0;
	char* sLocal_323[6] = { NULL, NULL, NULL, NULL, NULL, NULL };
	int iLocal_330 = 0;
	int iLocal_331 = 0;
	char* sLocal_332[3] = { NULL, NULL, NULL };
	char* sLocal_336[3] = { NULL, NULL, NULL };
	int iLocal_340 = 0;
	int iLocal_341 = 0;
	int iLocal_342 = 0;
	...
	int iLocal_347 = 0;
	int iLocal_348 = 0;
	char* sLocal_349[4] = { NULL, NULL, NULL, NULL };
	int iLocal_354 = 0;
	int iLocal_355 = 0;
	int iLocal_356 = 0;
	char* sLocal_357[12] = { NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL };
	int iLocal_370 = 0;
	int iLocal_371 = 0;
	int iLocal_372 = 0;
	int iLocal_373 = 0;
	...
	int iLocal_390 = 0;
	int iLocal_391 = 0;
	int iLocal_392[3] = { 0, 0, 0 };
	int iLocal_396[3] = { 0, 0, 0 };
	int iLocal_400 = 0;
	int iLocal_401 = 0;
	int iLocal_402 = 0;
...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_277 = -1;
	iLocal_278 = -1;
	Local_285 = { -814.3175f, 179.01758f, 71.159195f };
	Local_288 = { -806.1814f, 184.28976f, 71.347694f };
	Local_291 = { -801.9036f, 182.9307f, 71.6055f };
	Local_294 = { -1368.2787f, 355.90182f, 63.08109f };
	iLocal_308 = -1;
	iLocal_309 = -1;
	iLocal_310 = -1;
	iLocal_313 = 1;
	...
	iLocal_373 = 1;
	bLocal_374 = true;
	Local_375 = { -2271.74f, 1070.36f, 198.2f };
	Local_378 = { -825.50354f, 179.02661f, 70.36901f };
	Local_381 = { -1378.4454f, 367.812f, 63.0445f };
	fLocal_384 = 800f;
	fLocal_385 = 100f;
	iLocal_400 = joaat("A_M_M_GenFat_01");
	iLocal_402 = joaat("landstalker");
	Local_403 = { -2271.74f, 1070.36f, 198.2f };
	fLocal_406 = 135.06f;
	Local_407 = { -2223.2158f, 1009.2747f, 163.51175f };
	Local_410 = { -2226.5881f, 1147.9331f, 270.95654f };
	Local_413 = { -2269.847f, 891.10675f, 192.30278f };
	Local_416 = { -2161.119f, 1225.7269f, 500.54352f };
	Local_419 = { -2402.3289f, 1057.2286f, 189.97539f };
	Local_422 = { -2410.82f, 1005.2604f, 200.85915f };
	Local_425 = { -2328.859f, 892.1643f, 196.73659f };
	Local_428 = { -2333.4116f, 1221.6926f, 495.6477f };
	fLocal_431 = 90f;
	fLocal_432 = 200f;
	iLocal_433 = 1;
	iLocal_434 = 1;
	iLocal_436 = 1;
	Local_440 = { -826.6968f, 178.02092f, 69.18726f };
	Local_443 = { -817.75287f, 185.95036f, 72.3539f };
	fLocal_446 = 7f;
	Local_447 = { -826f, 157.66f, 69.06f };
	fLocal_450 = 273.51f;
	fLocal_453 = 0f;
...
void func_1()//Position - 0x340
{
	...
	while (iVar0 < 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_392[iVar0]))
		{
			if (PED::IS_PED_INJURED(iLocal_392[iVar0]))
			{
				func_2(5);
			}
		}
...
void func_3()//Position - 0x39F
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_390) && PED::IS_PED_INJURED(iLocal_390))
	{
		func_2(2);
	}
	else if (func_42(iLocal_390) && func_42(PLAYER::PLAYER_PED_ID()))
	{
		if (FIRE::IS_EXPLOSION_IN_SPHERE(-1 /*EXP_TAG_DONTCARE*/, ENTITY::GET_ENTITY_COORDS(iLocal_390, true), 2f) && !FIRE::IS_EXPLOSION_IN_SPHERE(13 /*EXP_TAG_DIR_WATER_HYDRANT*/, ENTITY::GET_ENTITY_COORDS(iLocal_390, true), 2f))
		{
			...
			ENTITY::SET_ENTITY_HEALTH(iLocal_390, 99, 0, 0);
			ENTITY::SET_ENTITY_COLLISION(iLocal_390, true, false);
			func_2(2);
		}
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_390, PLAYER::PLAYER_PED_ID(), true))
		{
			if (WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(iLocal_390, 0, 2) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(iLocal_390))
			{
				PED::REMOVE_PED_FROM_GROUP(iLocal_390);
				TASK::OPEN_SEQUENCE_TASK(&iVar0);
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_390, false))
				{
					TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 4416);
				}
				TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
				TASK::CLOSE_SEQUENCE_TASK(iVar0);
				TASK::TASK_PERFORM_SEQUENCE(iLocal_390, iVar0);
		...
		{
			if (func_41(iLocal_401) && (((((PED::IS_PED_IN_VEHICLE(iLocal_390, iLocal_401, false) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_390, sLocal_270, "back", 2)) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_390, sLocal_270, "base", 2)) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_390, sLocal_270, "enter_back", 2)) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_390, sLocal_270, "enter_backseat", 2)) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_390, sLocal_270, "exit_back", 2)))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(iLocal_401))
				{
					func_2(1);
				}
			}
			if (((PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()) && func_40(PLAYER::PLAYER_PED_ID(), iLocal_390, 50f, 1)) && func_39(iLocal_390, 1126825984)) && func_30(PLAYER::PLAYER_PED_ID(), iLocal_390, 90f, 1, 250, 7))
			{
				if (iLocal_354 < 4 && MISC::GET_GAME_TIMER() > iLocal_348)
				{
					...
					if (!func_27())
					{
						if (func_4(&uLocal_105, "MEJ1AUD", "MEJ1_INJURE", sLocal_349[iLocal_354], 7, 0, 0))
						{
							iLocal_354++;
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_390, joaat("SCRIPT_TASK_HANDS_UP")) != 1)
				{
					TASK::TASK_HANDS_UP(iLocal_390, -1, 0, -1, 0);
				}
			}
			else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_390, joaat("SCRIPT_TASK_HANDS_UP")) == 1)
			{
				TASK::CLEAR_PED_TASKS(iLocal_390);
			}
		}
	}
}
...
int func_5(char* sParam0, int iParam1, bool bParam2)//Position - 0x668
{
	Global_22426 = 0;
...
var func_9(int iParam0, int iParam1)//Position - 0x9E0
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_10()//Position - 0x9F8
{
	return -1;
}
...
void func_17()//Position - 0xC42
{
	...
	{
		if (func_20(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_19(PLAYER::PLAYER_PED_ID());
			if (func_18(iVar0) && (!func_22(14) || Global_113083))
			{
				if (Global_114135.f_2367.f_539.f_4321 != iVar0 && func_18(Global_114135.f_2367.f_539.f_4321))
				{
...
bool func_18(int iParam0)//Position - 0xD3F
{
	return iParam0 < 3;
}

int func_19(int iParam0)//Position - 0xD4B
{
	int iVar0;
	int iVar1;
...
int func_20(int iParam0)//Position - 0xD88
{
	if (func_18(iParam0))
	{
...
var func_21(int iParam0)//Position - 0xDAD
{
...
bool func_30(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF59
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	uVar0 = func_31(&(Local_50[iVar4 /*4*/]), Var1, iParam1, &(Local_50[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_50[iVar4 /*4*/].f_3) < iParam4);
}

int func_31(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x101A
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_34(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x1255
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_35(struct<3> Param0, struct<3> Param3)//Position - 0x12E6
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_36(struct<3> Param0)//Position - 0x1307
{
	float fVar0;
	float fVar1;
...
int func_38(int iParam0, int iParam1)//Position - 0x1361
{
	int iVar0;
...
bool func_39(int iParam0, float fParam1)//Position - 0x13A0
{
	return func_30(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_40(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x13B8
{
...
int func_42(int iParam0)//Position - 0x13FB
{
	if (func_41(iParam0))
	{
		...
		case 1:
			...
			else if (iLocal_437 == 0)
			{
				if (func_42(iLocal_390))
				{
					if (!func_27())
					{
						if (func_45(&uLocal_105, "MEJ1AUD", "MEJ1_INJURE", 7, 1, 0, 0) || func_44(&iLocal_455, 5000))
						{
							iLocal_437 = 1;
						}
					}
...
int func_44(int iParam0, int iParam1)//Position - 0x1524
{
	if (*iParam0 < 0)
	{
...
bool func_45(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x154F
{
...
void func_46(bool bParam0, bool bParam1)//Position - 0x159D
{
	...
	{
		if (func_42(iLocal_390) && PED::IS_PED_IN_GROUP(iLocal_390))
		{
			PED::REMOVE_PED_FROM_GROUP(iLocal_390);
		}
		if (bParam1)
		...
		else if (func_42(iLocal_390) && ENTITY::IS_ENTITY_AT_COORD(iLocal_390, Local_378, 50f, 50f, 50f, false, true, 0))
		{
			func_50(iLocal_390);
		}
		else
	...
	else
	{
		...
		while (iVar0 < 3)
		{
			func_53(&(iLocal_392[iVar0]), 1, 0, 1);
			iVar0++;
		}
	}
	func_67(&iLocal_389);
	...
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_401, 0f);
	}
	if (bParam0)
	{
		func_48(&iLocal_401);
...
void func_47(int* iParam0)//Position - 0x16A0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_48(int* iParam0)//Position - 0x16D8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_49(int iParam0)//Position - 0x1774
{
	if (func_41(iParam0))
	{
...
int func_50(int iParam0)//Position - 0x179E
{
	int iVar0;
...
int func_52(int iParam0)//Position - 0x1922
{
	if (!func_18(iParam0))
	{
		return func_21(iParam0);
...
void func_53(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1948
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_54(int* iParam0)//Position - 0x1998
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_58(int iParam0)//Position - 0x1A58
{
	int iVar0;
	
	if (Global_114135.f_9089 || func_66(0))
	{
		iVar0 = func_65();
		if (!func_59(iVar0))
		{
...
int func_59(int iParam0)//Position - 0x1A9D
{
	int iVar0;
	int iVar1;
	...
	func_60(&(Global_114135.f_2367.f_539), iVar1);
...
void func_60(var uParam0, int iParam1)//Position - 0x1BAD
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_62(Global_114135.f_18537[iVar0], &Var2, &fVar5))
			{
...
int func_62(int iParam0, var uParam1, float fParam2)//Position - 0x1D81
{
	switch (iParam0)
	{
		case 11:
...
int func_66(bool bParam0)//Position - 0x2847
{
...
void func_67(int* iParam0)//Position - 0x286F
{
...
void func_68()//Position - 0x288F
{
	...
	if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_390))
	{
		PED::SET_PED_RESET_FLAG(iLocal_390, 60, true);
		...
		switch (iLocal_387)
		{
			case 0:
				...
				TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_390, -1, 2050, 4);
				if (func_49(iVar0))
				{
				...
				{
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_390, 0);
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_294, 1f, 20000, 0.25f, 0, 40000f);
					TASK::CLOSE_SEQUENCE_TASK(iVar1);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_390, iVar1);
				...
				iLocal_455 = -1;
				bLocal_298 = false;
				if ((((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) && !PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID())) || (PED::IS_PED_IN_ANY_VEHICLE(iLocal_390, true) && !PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_390))) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(iLocal_390))
				{
					func_87(500, 1);
					SYSTEM::WAIT(1000);
					...
					if (func_42(iLocal_390))
					{
						ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_390, -1375.82f, 362.3f, 64.17f, false, false, true);
						ENTITY::SET_ENTITY_HEADING(iLocal_390, -49.27f);
					}
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_390, 0);
					...
					TASK::TASK_PERFORM_SEQUENCE(iLocal_390, iVar2);
			...
			case 1:
				...
				if (!func_27())
				{
					if (((func_49(iLocal_401) && func_42(iLocal_390)) && PED::IS_PED_IN_VEHICLE(iLocal_390, iLocal_401, false)) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_401, 0, false))
					{
						if (func_45(&uLocal_105, "MEJ1AUD", "MEJ1_HOME2", 7, 0, 0, 0) || func_44(&iLocal_455, 5000))
						{
							iLocal_387 = 2;
						}
					}
					else if (func_45(&uLocal_105, "MEJ1AUD", "MEJ1_HOME", 7, 0, 0, 0) || func_44(&iLocal_455, 5000))
					{
						iLocal_387 = 2;
					}
				}
			...
			case 2:
				if (func_49(iVar0))
				{
					...
					if (VEHICLE::IS_VEHICLE_STOPPED(iVar0))
					{
						...
						TASK::TASK_PERFORM_SEQUENCE(iLocal_390, iVar3);
			...
			case 3:
				...
				if (((!func_27() && func_83(iLocal_390, Local_294, 4f)) || bLocal_298) || MISC::GET_GAME_TIMER() > iLocal_297)
				{
					if (bLocal_298)
					{
						if (func_27())
...
void func_70(bool bParam0, int iParam1)//Position - 0x2D24
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (bParam0)
	{
		if ((func_66(0) && Global_79786.f_1 == 1) && func_71(Global_79786))
		{
		}
		else
		{
...
void func_73(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2EDC
{
	if (bParam0)
	{
...
int func_78(var uParam0)//Position - 0x30EB
{
	int iVar0;
...
int func_79(int iParam0)//Position - 0x310D
{
...
int func_81(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x315A
{
	int iVar0;
...
bool func_83(int iParam0, struct<3> Param1, float fParam4)//Position - 0x31B0
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_84(int iParam0)//Position - 0x31E5
{
...
int func_88(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x32CF
{
...
void func_91(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x34A3
{
	int iVar0;
...
Vector3 func_92(int iParam0)//Position - 0x3661
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_93(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x3674
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_79322[1 /*14*/] = { func_145(iVar10, iParam1, iParam2, -1) };
		if (!func_144(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_79322[1 /*14*/] = { func_145(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_79322[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_79322[1 /*14*/] = { func_145(iVar10, 14, uVar28[iVar1], -1) };
							func_113(iParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
							func_136(14);
							if (Global_79320 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_103(iVar0), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_103(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_103(iVar0), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
						}
						func_136(iVar0);
						if (Global_79320 == 1)
						{
			...
			{
				Global_79322[1 /*14*/] = { func_145(iVar10, iVar0, func_102(iParam0, iVar0, -1), -1) };
		...
		if (iParam7 == 1)
		{
			Var55 = { func_145(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var55 = { func_145(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var55 = { func_145(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var55 = { func_145(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var55 = { func_145(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_79322[1 /*14*/] = { func_145(iVar10, 14, uVar69[iVar1], -1) };
			func_113(iParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
			func_136(14);
			if (Global_79320 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_103(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_103(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_103(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
		}
		if (Global_79320 == 1)
		{
			iVar2 = 0;
...
int func_94(int iParam0, int iParam1, int iParam2)//Position - 0x3E85
{
	int iVar0;
	...
	{
		if (!func_209(iParam0, Global_114135.f_2367.f_539[iVar0 /*65*/].f_64, Global_114135.f_2367.f_539[iVar0 /*65*/].f_63))
		{
...
int func_97(int iParam0, int iParam1, int iParam2)//Position - 0x3FEB
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x40F4
{
	var uVar0;
	int iVar10;
...
int func_100(int iParam0, int iParam1, int iParam2)//Position - 0x46F8
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4791
{
	int iVar0;
	...
	{
		if (!func_209(iParam0, Global_114135.f_2367.f_539[iVar0 /*65*/].f_61, Global_114135.f_2367.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_102(int iParam0, int iParam1, int iParam2)//Position - 0x483C
{
	int iVar0;
	int iVar1;
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x498D
{
	int iVar0;
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x4C94
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x5847
{
	int iVar0;
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5E29
{
	int iVar0;
...
int func_110(int iParam0, int iParam1, int iParam2)//Position - 0x5E52
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x611C
{
	int iVar0;
...
void func_113(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x64FD
{
	int iVar0;
...
int func_114(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6597
{
	switch (iParam0)
	{
...
int func_118(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6B87
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_119(int iParam0, int iParam1)//Position - 0x6C83
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6DC1
{
	...
	if (iParam2 == 12)
	{
		...
		while (iVar15 < iVar16)
		{
			...
			if (Var0.f_1 == iParam1)
			{
				return (func_121(iParam0) + iVar15);
			}
			iVar15++;
		}
	}
	...
	else if (iParam2 == 14)
	{
		...
		if (iVar17 != -1)
		{
			return (func_117(iParam0) + iVar17);
		}
	}
	else
	{
		...
		if (iVar18 != -1)
		{
			return (func_116(iParam0, func_103(iParam2)) + iVar18);
		}
	}
	return -99;
}
...
void func_124(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7890
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_125(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x79BA
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_129(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[0], Global_114135.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_129(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[1], Global_114135.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_129(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[2], Global_114135.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_128(Var16.f_2)] = func_120(iParam1, Var16.f_0, func_128(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9B56
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_115(iParam0, iParam2, 14, 3), joaat("HAT_MENU"), 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_115(iParam0, iParam2, 1, 3), joaat("HAT_MENU"), 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_115(iParam0, iParam2, 14, 4), joaat("HAT_MENU"), 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_115(iParam0, iParam2, 1, 4), joaat("HAT_MENU"), 0));
					}
					break;
			}
			break;
...
int func_131(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9DD3
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_132(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA1F8
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_133(int iParam0, int iParam1)//Position - 0xA4EB
{
	int iVar0;
	int iVar1;
...
int func_134(int iParam0, int iParam1)//Position - 0xA532
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_135(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA592
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_139(int iParam0, var uParam1)//Position - 0xA70B
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_140(uParam1));
}

int func_140(var uParam0)//Position - 0xA720
{
	int iVar0;
	int iVar1;
...
int func_143(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD3A7
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_144(int iParam0)//Position - 0xE24A
{
	if (!BitTest(Global_79322[1 /*14*/].f_6, 0))
	{
		return 0;
...
void func_147(int iParam0)//Position - 0xE3D4
{
	...
	switch (iParam0)
	{
		...
		default:
			func_154(iVar10, iParam0, 155, -1);
			return;
			break;
	}
	func_148(&(Global_79322[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_148(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xF64B
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_141(func_151(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_141(func_150(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_141(iVar1, Global_79319);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_152(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x105F3
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_154(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10705
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_148(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_148(&(Global_79322[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_148(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79520)
		{
			...
			func_148(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_209(int iParam0, int iParam1, int iParam2)//Position - 0x21BCD
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_79322[1 /*14*/] = { func_145(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_79322[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_209(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_209(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_79322[2 /*14*/] = { func_145(iVar0, 14, iVar4, -1) };
									if (Global_79322[2 /*14*/].f_12 == iVar3)
									{
										if (func_209(iParam0, 14, iVar4))
										{
											if (!func_99(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_79322[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_79322[2 /*14*/] = { func_145(iVar0, iVar2, iVar1, -1) };
						if (!func_99(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_79322[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_79322[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_103(iParam1)) && Global_79322[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_103(iParam1)))
	{
		return 1;
	}
	return 0;
	...
	if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_390))
	{
		...
		switch (iLocal_387)
		{
			case 0:
				...
				{
					func_216(Local_440, Local_443, fLocal_446, Local_447, fLocal_450, func_224(), 1, 1, 1, 0, 0);
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_390, 0);
					TASK::OPEN_SEQUENCE_TASK(&iVar1);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2f, 20000, 0.25f, 0, 40000f);
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_291, 1f, 20000, 0.25f, 0, 40000f);
					TASK::CLOSE_SEQUENCE_TASK(iVar1);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_390, iVar1);
					TASK::CLEAR_SEQUENCE_TASK(&iVar1);
				}
			...
			case 1:
				...
				if (!func_27())
				{
					if (func_40(PLAYER::PLAYER_PED_ID(), iLocal_390, 5f, 1))
					{
						if (((func_49(iLocal_401) && func_42(iLocal_390)) && PED::IS_PED_IN_VEHICLE(iLocal_390, iLocal_401, false)) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_401, 0, false))
						{
							if (func_45(&uLocal_105, "MEJ1AUD", "MEJ1_HOME2", 7, 0, 0, 0) || func_44(&iLocal_455, 5000))
			...
			case 3:
				...
				if (((!func_27() && (func_83(iLocal_390, Local_285, 2f) || func_83(iLocal_390, Local_288, 2f))) || bLocal_298) || MISC::GET_GAME_TIMER() > iLocal_297)
				{
					if (bLocal_298)
					{
						if (func_27())
						...
						{
							TASK::CLEAR_PED_TASKS(iLocal_390);
							ENTITY::SET_ENTITY_COORDS(iLocal_390, Local_291, true, false, false, true);
							ENTITY::SET_ENTITY_HEADING(iLocal_390, 90f);
						}
						SYSTEM::WAIT(1000);
					}
					if (func_42(PLAYER::PLAYER_PED_ID()))
...
void func_216(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x222AC
{
	func_217(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_217(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x222D6
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_221(iVar0, Param0, Param3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_218(struct<3> Param0)//Position - 0x226CC
{
...
int func_219(int iParam0, int iParam1, bool bParam2)//Position - 0x226F6
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_220(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x22764
{
...
int func_221(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2283C
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_222(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var9) || func_222(Var18[0 /*3*/], Var18[1 /*3*/], Var9, Var15)) || func_222(Var18[0 /*3*/], Var18[1 /*3*/], Var12, Var15)) || func_222(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var12)) || func_222(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var9)) || func_222(Var18[1 /*3*/], Var18[3 /*3*/], Var9, Var15)) || func_222(Var18[1 /*3*/], Var18[3 /*3*/], Var12, Var15)) || func_222(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var12)) || func_222(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var9)) || func_222(Var18[3 /*3*/], Var18[2 /*3*/], Var9, Var15)) || func_222(Var18[3 /*3*/], Var18[2 /*3*/], Var12, Var15)) || func_222(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var12)) || func_222(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var9)) || func_222(Var18[2 /*3*/], Var18[0 /*3*/], Var9, Var15)) || func_222(Var18[2 /*3*/], Var18[0 /*3*/], Var12, Var15)) || func_222(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_222(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x22B32
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_223(int iParam0)//Position - 0x22BE6
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
{
	func_245();
	func_240(&uLocal_457, &uLocal_105, "MEJ1AUD", &sLocal_458, &cLocal_464);
	switch (iLocal_387)
	{
		case 0:
			func_67(&iLocal_389);
			...
			func_238(&uLocal_457);
			if (func_42(iLocal_390) && !PED::IS_PED_GROUP_MEMBER(iLocal_390, func_237()))
			{
				PED::SET_PED_AS_GROUP_MEMBER(iLocal_390, func_237());
				PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_390, 0);
				PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_390, true);
				PED::SET_PED_DIES_INSTANTLY_IN_WATER(iLocal_390, false);
			}
			iLocal_387 = 1;
			break;
		...
		case 1:
			if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_390))
			{
				...
				if (func_229(PLAYER::PLAYER_PED_ID(), iLocal_390) > 15f)
				{
					func_28();
					iLocal_387 = 0;
					iLocal_386 = 4;
	...
	if (func_42(iLocal_390))
	{
		PED::SET_PED_RESET_FLAG(iLocal_390, 124, true);
	}
}
...
void func_226()//Position - 0x22D65
{
	if (func_42(iLocal_390) && func_49(iLocal_401))
	{
		...
		{
			case 0:
				if (iLocal_275 || !VEHICLE::IS_VEHICLE_WINDOW_INTACT(iLocal_401, 7))
				{
					iLocal_272 = 15;
				}
				break;
			...
			case 2:
				...
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_271, iLocal_401, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_401, sLocal_273));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_390, iLocal_271, sLocal_270, "enter_back", 8f, -8f, 4, iLocal_274, 1000f, 0);
				iLocal_320 = 0;
				iLocal_321 = -1;
				iLocal_272 = 12;
				break;
			...
			case 4:
				...
				PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_271, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_271, iLocal_401, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_401, sLocal_273));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_390, iLocal_271, sLocal_270, "enter_left", 8f, -8f, 4, iLocal_274, 1000f, 0);
				iLocal_272 = 5;
				break;
			...
			case 5:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_271))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_271) >= 0.9f)
					{
						...
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_271, iLocal_401, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_401, sLocal_273));
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_390, iLocal_271, sLocal_270, "left", 8f, -8f, 4, iLocal_274, 1000f, 0);
						iLocal_272 = 6;
					}
				}
				break;
			...
			case 7:
				...
				PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_271, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_271, iLocal_401, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_401, sLocal_273));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_390, iLocal_271, sLocal_270, "exit_left", 8f, -8f, 4, iLocal_274, 1000f, 0);
				if (iLocal_275 || (func_49(iLocal_401) && !VEHICLE::IS_VEHICLE_WINDOW_INTACT(iLocal_401, 7)))
				{
					iLocal_272 = 13;
				}
				else
			...
			case 8:
				...
				PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_271, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_271, iLocal_401, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_401, sLocal_273));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_390, iLocal_271, sLocal_270, "enter_right", 8f, -8f, 4, iLocal_274, 1000f, 0);
				iLocal_272 = 9;
				break;
			...
			case 9:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_271))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_271) >= 0.9f)
					{
						...
						PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_271, false);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_271, iLocal_401, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_401, sLocal_273));
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_390, iLocal_271, sLocal_270, "right", 8f, -8f, 4, iLocal_274, 1000f, 0);
						iLocal_272 = 10;
					}
				}
				break;
			...
			case 11:
				...
				PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_271, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_271, iLocal_401, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_401, sLocal_273));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_390, iLocal_271, sLocal_270, "exit_right", 8f, -8f, 4, iLocal_274, 1000f, 0);
				if (iLocal_275 || !VEHICLE::IS_VEHICLE_WINDOW_INTACT(iLocal_401, 7))
				{
					iLocal_272 = 13;
				}
			...
			case 12:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_271))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_271) >= 0.9f)
					{
						...
						PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_271, false);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_271, iLocal_401, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_401, sLocal_273));
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_390, iLocal_271, sLocal_270, "back", 8f, -8f, 4, iLocal_274, 1000f, 0);
						iLocal_272 = 3;
					}
				}
				break;
			...
			case 14:
				...
				PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_271, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_271, iLocal_401, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_401, sLocal_273));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_390, iLocal_271, sLocal_270, "exit_back", 4f, -8f, 4, iLocal_274, 1000f, 0);
				iLocal_272 = 15;
				break;
			...
			case 15:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_271))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_271) >= 0.95f)
					{
						...
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_390, iLocal_271, sLocal_270, "enter_backseat", 8f, -8f, 4, iLocal_274, 1000f, 0);
						iLocal_272 = 16;
					}
				}
				else
			...
			case 16:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_271))
				{
					...
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_390, -4f, true);
						func_227(iLocal_390, iLocal_401, 2, 0);
						iLocal_272 = 17;
					}
				}
				else
			...
			case 17:
				if (PED::IS_PED_IN_VEHICLE(iLocal_390, iLocal_401, false) && iLocal_275)
				{
					if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_401, false))
					{
						TASK::TASK_LEAVE_ANY_VEHICLE(iLocal_390, 0, 65536);
...
int func_228()//Position - 0x23525
{
	...
	if (func_49(iLocal_401) && func_40(iLocal_401, PLAYER::PLAYER_PED_ID(), 10f, 1))
	{
		Var0 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_401, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) };
		if (Var0.f_1 < -1f)
		{
			return 1;
		}
...
float func_229(int iParam0, int iParam1)//Position - 0x23592
{
	return func_230(iParam0, iParam1, 1);
}

float func_230(int iParam0, int iParam1, bool bParam2)//Position - 0x235A3
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_231()//Position - 0x23601
{
	...
	if (func_42(iLocal_390))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_390, false))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(iLocal_390, false);
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false) && ENTITY::IS_ENTITY_IN_WATER(iVar0))
				{
					TASK::TASK_LEAVE_ANY_VEHICLE(iLocal_390, 0, 4416);
				}
			}
		}
	}
	...
	if ((iLocal_347 < 3 && MISC::GET_GAME_TIMER() > iLocal_341) && (func_235() || func_234()))
	{
		if (PED::IS_PED_STOPPED(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (iLocal_342 > 60)
			{
				if (!func_27() && func_233())
				{
					if (func_4(&uLocal_105, "MEJ1AUD", "MEJ1_STILL", sLocal_343[iLocal_347], 7, 0, 0))
					{
						iLocal_347++;
						iLocal_342 = 0;
...
int func_234()//Position - 0x23709
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) || PED::IS_PED_IN_ANY_VEHICLE(iLocal_390, false))
	{
		return 0;
	}
	return 1;
...
int func_235()//Position - 0x23730
{
	...
	{
		iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
		if (func_49(iVar0) && PED::IS_PED_IN_VEHICLE(iLocal_390, iVar0, false))
		{
			return 1;
		}
	}
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_STOPPED(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_49(iVar0))
			{
				if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iVar0))
				{
					...
					if (func_233())
					{
						bVar1 = func_4(&uLocal_105, "MEJ1AUD", "MEJ1_CRASH", sLocal_323[iLocal_330], 7, 0, 0);
					}
					else
					{
						bVar1 = func_4(&uLocal_105, "MEJ1AUD", "MEJ1_CRASH", sLocal_323[iLocal_330], 7, 1, 0);
					}
					if (bVar1)
					{
						iLocal_330++;
...
void func_239(char* sParam0, int iParam1, int iParam2)//Position - 0x2385B
{
	iParam2 = iParam2;
...
void func_246()//Position - 0x23B26
{
	...
	switch (iLocal_387)
	{
		case 0:
			func_67(&iLocal_389);
			iLocal_389 = func_248(iLocal_390, 1, 1, 5);
			if (iLocal_434)
			{
		...
		case 1:
			...
			if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_390))
			{
				if (func_229(PLAYER::PLAYER_PED_ID(), iLocal_390) < 5f)
				{
...
void func_247()//Position - 0x23BE5
{
	if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_390))
	{
		if (func_229(PLAYER::PLAYER_PED_ID(), iLocal_390) > fLocal_384)
		{
...
int func_248(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x23C35
{
	int iVar0;
	bool bVar1;
...
void func_249()//Position - 0x23C87
{
	...
	switch (iLocal_387)
	{
		case 0:
			...
			if (func_346() == 1)
			{
				iLocal_389 = func_345(Local_381, 5, 1);
				VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_381 - Vector(10f, 10f, 10f), Local_381 + Vector(10f, 10f, 10f), false, true);
				MISC::CLEAR_AREA_OF_VEHICLES(Local_381, 10f, false, false, false, false, false, false, 0);
			}
			else
			{
				iLocal_389 = func_345(Local_378, 5, 1);
			}
			...
			if (func_42(iLocal_390) && !PED::IS_PED_GROUP_MEMBER(iLocal_390, func_237()))
			{
				...
				PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_390, true);
				PED::SET_PED_DIES_INSTANTLY_IN_WATER(iLocal_390, false);
				ENTITY::SET_ENTITY_PROOFS(iLocal_390, true, false, false, false, true, false, false, false);
				PED::SET_PED_CAN_RAGDOLL(iLocal_390, true);
			}
	...
	if (func_42(PLAYER::PLAYER_PED_ID()) && MISC::GET_GAME_TIMER() > iLocal_372)
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			if (iVar0 != iLocal_371)
			{
				...
				{
					ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_371);
				}
				iLocal_371 = iVar0;
			}
		}
...
void func_252()//Position - 0x23F7C
{
	...
	{
		if ((!func_27() && func_233()) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
		{
			if (func_45(&uLocal_105, "MEJ1AUD", "MEJ1_SHOOT", 7, 0, 0, 0))
			{
...
void func_253()//Position - 0x23FCA
{
	if ((iLocal_370 < 12 && MISC::GET_GAME_TIMER() > iLocal_356) && func_42(iLocal_392[0]))
	{
		if (func_229(PLAYER::PLAYER_PED_ID(), iLocal_392[0]) < 30f)
		{
			if (!func_27() && func_233())
			{
				if (func_4(&uLocal_105, "MEJ1AUD", "MEJ1_FLEE", sLocal_357[iLocal_370], 7, 0, 0))
				{
					iLocal_370++;
	...
	if ((iLocal_340 < 3 && MISC::GET_GAME_TIMER() > iLocal_331) && (func_235() || func_234()))
	{
		if (PLAYER::HAS_PLAYER_DAMAGED_AT_LEAST_ONE_PED(PLAYER::PLAYER_ID()))
		{
			if (bLocal_374)
			{
				...
				if (func_233())
				{
					bVar0 = func_4(&uLocal_105, "MEJ1AUD", "MEJ1_NOKILL", sLocal_336[iLocal_340], 7, 0, 0);
				}
				else
				{
					bVar0 = func_4(&uLocal_105, "MEJ1AUD", "MEJ1_NOKILL", sLocal_336[iLocal_340], 7, 1, 0);
				}
				if (bVar0)
				{
					iLocal_340++;
			...
			{
				if (func_4(&uLocal_105, "MEJ1AUD", "MEJ1_HITKILL", sLocal_332[iLocal_340], 7, 0, 0))
				{
					iLocal_340++;
					iLocal_331 = MISC::GET_GAME_TIMER() + 9000;
					PLAYER::CLEAR_PLAYER_HAS_DAMAGED_AT_LEAST_ONE_PED(PLAYER::PLAYER_ID());
...
void func_255()//Position - 0x24137
{
	if (iLocal_276 == 0)
	{
		if (((iLocal_278 == -1 && !func_27()) && func_233()) && func_235())
		{
			...
			{
				if (func_45(&uLocal_105, "MEJ1AUD", "MEJ1_DRIVE1", 7, 0, 0, 0))
				{
	...
	{
		if (((!func_27() && func_233()) && func_235()) && MISC::GET_GAME_TIMER() > iLocal_317)
		{
			if (func_241(&uLocal_105, "MEJ1AUD", "MEJ1_DRIVE1", &sLocal_279, 7, 0, 0))
			{
				iLocal_276 = 2;
			}
		}
...
{
	if (((((iLocal_373 && ENTITY::DOES_ENTITY_EXIST(iLocal_392[0])) && ENTITY::DOES_ENTITY_EXIST(iLocal_392[1])) && ENTITY::DOES_ENTITY_EXIST(iLocal_392[2])) && func_42(iLocal_390)) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
	{
		if (func_45(&uLocal_105, "MEJ1AUD", "MEJ1_THANK", 7, 0, 0, 0))
		{
			PLAYER::CLEAR_PLAYER_HAS_DAMAGED_AT_LEAST_ONE_PED(PLAYER::PLAYER_ID());
			iLocal_373 = 0;
		}
...
void func_257(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2426C
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_333(&(Global_101688.f_3));
				if (iVar10 > -1)
				{
...
void func_258(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x243E1
{
	func_259(&Global_107680, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_259(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x243FD
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_16();
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_282(PLAYER::PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_281())
		{
			func_276(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
int func_262(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x25330
{
...
int func_263(int iParam0)//Position - 0x25370
{
	int iVar0;
...
void func_264(var uParam0, int iParam1, int iParam2)//Position - 0x2539E
{
...
int func_265(int iParam0)//Position - 0x2547A
{
	int iVar0;
...
int func_266(int iParam0)//Position - 0x254BC
{
	int iVar0;
...
int func_267(int iParam0, int iParam1, int iParam2)//Position - 0x2551F
{
	int iVar0;
...
int func_268(int iParam0, int iParam1)//Position - 0x255AD
{
	struct<82> Var0;
...
void func_269(int iParam0, var uParam1, int iParam2)//Position - 0x255EF
{
	int iVar0;
...
void func_270(int iParam0, var uParam1)//Position - 0x2584B
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_271(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_272(int iParam0, var uParam1, var uParam2)//Position - 0x25BA6
{
	int iVar0;
	int iVar1;
...
int func_273(int iParam0)//Position - 0x25D99
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_275(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x25E69
{
	char* sVar0;
...
int func_277(int iParam0, int iParam1)//Position - 0x26132
{
	int iVar0;
	var uVar1;
...
int func_278(int iParam0, var uParam1)//Position - 0x26156
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_140(uParam1));
}

void func_279(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2616B
{
	int iVar0;
...
void func_280(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x266B4
{
	int iVar0;
...
int func_281()//Position - 0x268F5
{
	func_17();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_282(int iParam0, bool bParam1)//Position - 0x2690E
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_18(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_283(iParam0, &(Global_114135.f_2367.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_283(int iParam0, var uParam1)//Position - 0x26A01
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_288(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_285(Var11.f_1)) && iVar72 < 51)
			{
...
int func_284(int iParam0)//Position - 0x26C89
{
	switch (iParam0)
	{
...
int func_285(int iParam0)//Position - 0x26D2A
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_289(int iParam0)//Position - 0x27F52
{
	int iVar0;
...
int func_291(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x284DE
{
	int iVar0;
	int iVar1;
...
bool func_293(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x28CA1
{
	if (bParam6)
	{
...
int func_294(var uParam0)//Position - 0x28CE8
{
...
int func_296(int iParam0, int iParam1, bool bParam2)//Position - 0x28D53
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_299(int iParam0)//Position - 0x29175
{
	return func_296(iParam0, 5, 1);
}

int func_300(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x29185
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_305(struct<3> Param0)//Position - 0x29CC3
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_306(), 0f, Param0);
}
...
int func_307(int iParam0)//Position - 0x29CEF
{
	if (iParam0 != func_10())
	{
...
int func_309(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x29DF1
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
	...
	{
		Var12 = { func_311(iParam0) };
	}
	Var18 = { Var12 - Var0 };
	Var18 = { func_310(Var18, -Var0.f_3.f_2) };
	Var18 = { func_310(Var18, Var6.f_3.f_2) };
	*uParam2 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Var6, 0f, Var18) };
	uParam2->f_3 = { Var12.f_3 };
	return 1;
}

Vector3 func_310(struct<3> Param0, float fParam3)//Position - 0x29E86
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_314(int iParam0, var uParam1)//Position - 0x2AB23
{
	switch (iParam0)
	{
		case 0:
...
int func_315(int iParam0)//Position - 0x2ABA5
{
	if (iParam0 != func_10())
	{
...
int func_319(int iParam0)//Position - 0x2AEB1
{
...
var func_322()//Position - 0x2B215
{
	...
	func_332(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_331(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_330(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_325(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_324(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_323(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}
...
var func_327(int iParam0)//Position - 0x2B407
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_328(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_328(bool bParam0, int iParam1, int iParam2)//Position - 0x2B429
{
	if (bParam0)
	{
		return iParam1;
...
int func_329(var uParam0)//Position - 0x2B440
{
	return uParam0 & 15;
}
...
int func_333(char* sParam0)//Position - 0x2B4FE
{
...
int func_335(char* sParam0, int iParam1)//Position - 0x2B9A0
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_336(int iParam0, var uParam1)//Position - 0x2B9E9
{
	switch (iParam0)
	{
		...
		case 5:
			func_337(uParam1, "Barry3A", func_339(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_338(iParam0), 0, 1);
			break;
		...
		case 8:
			func_337(uParam1, "Dreyfuss1", func_339(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_338(iParam0), 0, 0);
			break;
		...
		case 38:
			func_337(uParam1, "Nigel1A", func_339(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_338(iParam0), 1, 1);
			break;
		...
		case 49:
			func_337(uParam1, "Paparazzo3A", func_339(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_338(iParam0), 0, 1);
			break;
		...
		case 58:
			func_337(uParam1, "Tonya1", func_339(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_338(iParam0), 0, 1);
			break;
...
int func_342(char* sParam0, bool bParam1)//Position - 0x2D0BE
{
	int iVar0;
	int iVar1;
...
int func_343(int iParam0, bool bParam1)//Position - 0x2D0E8
{
	int iVar0;
...
int func_345(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x2D3A0
{
	int iVar0;
...
int func_347(int iParam0)//Position - 0x2D44C
{
...
int func_348(int iParam0)//Position - 0x2D479
{
...
void func_349()//Position - 0x2D4A5
{
	...
	switch (iLocal_387)
	{
		case 0:
			func_28();
			func_67(&iLocal_389);
			if ((((func_49(iLocal_401) && func_42(iLocal_392[0])) && func_42(iLocal_392[1])) && func_42(iLocal_392[2])) && func_42(iLocal_390))
			{
				ENTITY::SET_ENTITY_VISIBLE(iLocal_401, true, false);
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(iLocal_401, true);
				iVar0 = 0;
				iVar0 = 0;
				while (iVar0 < 3)
				{
					ENTITY::SET_ENTITY_VISIBLE(iLocal_392[iVar0], true, false);
					iVar0++;
				}
				ENTITY::SET_ENTITY_VISIBLE(iLocal_390, true, false);
				PED::SET_PED_DIES_INSTANTLY_IN_WATER(iLocal_390, true);
				VEHICLE::SET_VEHICLE_FORWARD_SPEED(iLocal_401, 12f);
				TASK::TASK_VEHICLE_DRIVE_WANDER(iLocal_392[0], iLocal_401, 12f, 786468);
				VEHICLE::REQUEST_VEHICLE_ASSET(iLocal_402, 3);
		...
		case 1:
			...
			func_393();
			func_391();
			func_390(iLocal_389, iLocal_390, fLocal_384, 1061158912, 0);
			if (func_49(iLocal_401) && ENTITY::DOES_ENTITY_EXIST(iLocal_392[0]))
			{
				if (iLocal_320 && MISC::GET_GAME_TIMER() > iLocal_321)
				{
					VEHICLE::SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(iLocal_401, true);
					iLocal_320 = 0;
				}
				func_363(&uLocal_38, iLocal_401, 0, 0, 1, 1, 1);
				if ((((((((((ENTITY::GET_ENTITY_HEALTH(iLocal_401) < 850 || func_362()) || func_360()) || func_359(iLocal_401, &uLocal_452, &uLocal_454, &uLocal_451, &fLocal_453, 6, 1082130432)) || VEHICLE::GET_VEHICLE_ENGINE_HEALTH(iLocal_401) < 50f) || VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(iLocal_401) < 50f) || (func_42(iLocal_392[0]) && !PED::IS_PED_IN_VEHICLE(iLocal_392[0], iLocal_401, false))) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_401, 2, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_401, 3, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_401, 0, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_401, 1, 5000))
				{
					if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
					{
						func_211();
					...
					{
						TASK::TASK_VEHICLE_TEMP_ACTION(iLocal_392[0], iLocal_401, 20, 1000);
					}
					VEHICLE::BRING_VEHICLE_TO_HALT(iLocal_401, 20f, 1, false);
			...
			else if (ENTITY::DOES_ENTITY_EXIST(iLocal_401))
			{
				STREAMING::REMOVE_ANIM_DICT("missfam3");
				if (FIRE::IS_ENTITY_ON_FIRE(iLocal_401))
				{
		...
		case 2:
			...
			if (func_49(iLocal_401))
			{
				if (VEHICLE::IS_VEHICLE_STOPPED(iLocal_401))
				{
					iVar2 = 0;
					iVar2 = 0;
					while (iVar2 < 3)
					{
						if (func_42(iLocal_392[iVar2]))
						{
							TASK::OPEN_SEQUENCE_TASK(&iVar3);
							TASK::TASK_PAUSE(0, iVar2 * 1000);
							if (PED::IS_PED_IN_VEHICLE(iLocal_392[iVar2], iLocal_401, false))
							{
								TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 257);
							}
							TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
							TASK::CLOSE_SEQUENCE_TASK(iVar3);
							TASK::TASK_PERFORM_SEQUENCE(iLocal_392[iVar2], iVar3);
							TASK::CLEAR_SEQUENCE_TASK(&iVar3);
							if (iVar2 == 0 && !func_360())
							{
								func_28();
							...
							else if (((iVar2 == 1 && !func_42(iLocal_392[0])) || ((iVar2 == 2 && !func_42(iLocal_392[0])) && !func_42(iLocal_392[1]))) && !func_360())
							{
								func_358(&uLocal_105, 6, iLocal_392[iVar2], "MEJimmyKidnapper2", 1, 1);
								func_28();
								func_4(&uLocal_105, "MEJ1AUD", "MEJ1_NERD", "MEJ1_NERD_2", 7, 0, 0);
							}
							else if ((iVar2 == 1 && func_42(iLocal_392[0])) || (iVar2 == 2 && (func_42(iLocal_392[0]) || func_42(iLocal_392[1]))))
							{
								func_355(iLocal_392[iVar2], 1);
							}
						}
						iVar2++;
					}
					func_67(&iLocal_389);
					ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_401, false);
					func_353(&uLocal_38, 0, 0);
					iLocal_370 = 0;
					iLocal_356 = MISC::GET_GAME_TIMER() + 9000;
					if (func_42(iLocal_390) && (((VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_401, 2, 5000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_401, 3, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_401, 0, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_401, 1, 5000)))
					{
						if (func_229(PLAYER::PLAYER_PED_ID(), iLocal_390) > (5f + 1f))
						{
							iLocal_389 = func_248(iLocal_390, 1, 1, 5);
					...
					else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_401, false))
					{
						iLocal_275 = 1;
						if (AUDIO::IS_AUDIO_SCENE_ACTIVE("M_E_JIMMY_STOP_KIDNAPPERS"))
						{
		...
		case 3:
			func_253();
			func_350();
			if ((func_49(iLocal_401) && func_42(PLAYER::PLAYER_PED_ID())) && func_42(iLocal_390))
			{
				if (iLocal_436 && func_229(PLAYER::PLAYER_PED_ID(), iLocal_390) > fLocal_385)
				{
				...
				if (bLocal_435)
				{
					if (func_229(PLAYER::PLAYER_PED_ID(), iLocal_390) < 5f)
					{
						TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_390);
						func_351();
					}
				}
				else if (func_230(PLAYER::PLAYER_PED_ID(), iLocal_401, 1) < (5f - 1f))
				{
					iLocal_275 = 1;
					func_351();
				}
	...
	if (func_42(iLocal_390))
	{
		PED::SET_PED_RESET_FLAG(iLocal_390, 249, true);
		PED::SET_PED_RESET_FLAG(iLocal_390, 248, true);
		PED::SET_PED_RESET_FLAG(iLocal_390, 124, true);
	}
	func_226();
	func_247();
...
void func_350()//Position - 0x2DC6E
{
	if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_390))
	{
		if (MISC::GET_GAME_TIMER() > iLocal_316)
		{
			...
			{
				if (func_45(&uLocal_105, "MEJ1AUD", "MEJ1_HERE", 7, 0, 0, 0))
				{
...
void func_353(var uParam0, int iParam1, bool bParam2)//Position - 0x2DD3C
{
	char* sVar0;
...
bool func_354(char* sParam0)//Position - 0x2DE16
{
...
void func_356(int iParam0, char* sParam1, char* sParam2, int iParam3, bool bParam4)//Position - 0x2DE9C
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_357(iParam3), bParam4);
}

int func_357(int iParam0)//Position - 0x2DEB6
{
	int iVar0;
...
void func_358(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2E0AB
{
...
int func_359(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, float fParam6)//Position - 0x2E146
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var4;
...
int func_360()//Position - 0x2E1F7
{
	int iVar0;
	int iVar1;
	
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && func_49(iLocal_401))
	{
		iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
		if (func_49(iVar0))
		{
			...
			{
				if (VEHICLE::IS_VEHICLE_SIREN_ON(iVar0) && func_40(iVar0, iLocal_401, 15f, 1))
				{
					return 1;
				}
			}
...
int func_361(int iParam0)//Position - 0x2E296
{
	switch (iParam0)
	{
		case joaat("police"):
...
int func_362()//Position - 0x2E33E
{
	...
	{
		iVar0 = 0;
		if (VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_401, 0, false))
		{
			iVar0++;
		}
		if (VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_401, 1, false))
		{
			iVar0++;
		}
		if (VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_401, 4, false))
		{
			iVar0++;
		}
		if (VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_401, 5, false))
		{
			iVar0++;
		}
		if (iVar0 > 2)
...
void func_363(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x2E3BD
{
	func_364(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_364(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x2E3D7
{
	uParam0->f_6 = 0;
	func_365(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_365(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2E3F9
{
	int iVar0;
	int iVar1;
	...
	if (func_388(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		iVar1 = 0;
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			if (func_383(uParam0, bParam7, bParam9, 0))
			{
				func_380(uParam0, iParam1, Param2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
int func_367(var uParam0)//Position - 0x2E7CF
{
	int iVar0;
...
int func_369(char* sParam0)//Position - 0x2E8A4
{
	if (!func_370(1, 1, 0))
	{
		if ((!MISC::IS_STRING_NULL_OR_EMPTY(sParam0) && func_354(sParam0)) || func_354("CMN_HINT" /* GXT: ~s~Press ~INPUT_VEH_CIN_CAM~ to toggle focus on the target. */))
		{
			HUD::CLEAR_HELP(true);
		}
		return 0;
...
int func_370(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2E93D
{
	int iVar0;
	int iVar1;
	...
	if ((func_377() || func_376(Global_4718592.f_187633)) || func_375())
	{
		...
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
			iVar1 = func_374(PLAYER::PLAYER_PED_ID(), 0);
			if (((VEHICLE::IS_TURRET_SEAT(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("riot2") && iVar1 == 0) && func_373(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_371(int iParam0)//Position - 0x2EB96
{
	if (iParam0 != func_10())
	{
		...
		else if ((Global_1575084 && iParam0 == PLAYER::PLAYER_ID()) && func_372(iParam0, 1, 0))
		{
			return Global_2657991[iParam0 /*467*/].f_324.f_8 != -1;
		}
	}
...
int func_372(int iParam0, bool bParam1, bool bParam2)//Position - 0x2EBFC
{
	int iVar0;
...
int func_373(int iParam0, int iParam1)//Position - 0x2EC5C
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_374(int iParam0, bool bParam1)//Position - 0x2ECBE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_379(int iParam0)//Position - 0x2ED81
{
	if (iParam0 == 1)
	{
		if (Global_21066.f_1 > 3)
...
void func_380(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x2EDD8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_382(int iParam0)//Position - 0x2EEF8
{
...
int func_383(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x2EF17
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_384(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2F283
{
...
int func_385(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2F2D5
{
	if (!func_370(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_386(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2F31E
{
	if (!func_370(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_387(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2F37D
{
	if (!func_370(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_388(int iParam0)//Position - 0x2F3D3
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_390(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)//Position - 0x2F43E
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_391()//Position - 0x2F597
{
	if (iLocal_310 > 0 && MISC::GET_GAME_TIMER() > iLocal_310)
	{
		if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_390))
		{
			if ((func_229(PLAYER::PLAYER_PED_ID(), iLocal_390) < 50f && !func_27()) && !func_392("MEJ1_02", 0, 0))
			{
				if (iLocal_313)
				{
					if (func_45(&uLocal_105, "MEJ1AUD", "MEJ1_DONT", 7, 0, 0, 0))
					{
						iLocal_310 = MISC::GET_GAME_TIMER() + 10000;
						iLocal_313 = 0;
					}
				}
				else if (func_45(&uLocal_105, "MEJ1AUD", "MEJ1_CALL", 7, 0, 0, 0))
				{
					iLocal_310 = MISC::GET_GAME_TIMER() + 10000;
				}
			}
...
bool func_392(char* sParam0, int iParam1, char* sParam2)//Position - 0x2F642
{
...
void func_393()//Position - 0x2F660
{
	...
	if ((func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_392[0])) && func_49(iLocal_401))
	{
		if (iLocal_308 == -1 && iLocal_309 == -1)
		{
			if (!bLocal_311)
			{
				bLocal_311 = ENTITY::IS_ENTITY_TOUCHING_ENTITY(iLocal_401, PLAYER::PLAYER_PED_ID());
			}
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_401, PLAYER::PLAYER_PED_ID(), true) || bLocal_311)
			{
				func_211();
				func_28();
				if (func_4(&uLocal_105, "MEJ1AUD", "MEJ1_RAM", "MEJ1_RAM_3", 7, 0, 0))
				{
					...
					TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_392[0], iLocal_401, PLAYER::PLAYER_PED_ID(), 8, 25f, 786468, 100f, 1f, true);
					RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 0f, 3);
					iLocal_272 = 2;
					fLocal_384 = 200f;
					fLocal_385 = 500f;
			...
			else if (func_229(PLAYER::PLAYER_PED_ID(), iLocal_392[0]) < 50f && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_401))
			{
				if (MISC::GET_GAME_TIMER() > iLocal_318)
				{
					...
					if (HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
						bVar0 = func_45(&uLocal_105, "MEJ1AUD", "MEJ1_SEES", 7, 1, 0, 0);
					}
					else
					{
						bVar0 = func_45(&uLocal_105, "MEJ1AUD", "MEJ1_SEES", 7, 0, 0, 0);
					}
					if (iLocal_315)
					{
						RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 0f, 3);
		...
		else if (iLocal_314)
		{
			if (!func_27())
			{
				if (func_394(&uLocal_105, 14, "MEJ1AUD", "MEJ1_DAD", 7, 0, 0, 1))
				{
					iLocal_314 = 0;
				}
			}
		}
		else if (((iLocal_308 < 8 && func_229(PLAYER::PLAYER_PED_ID(), iLocal_392[0]) < 50f) && !func_27()) && !func_392("MEJ1_02", 0, 0))
		{
			if (!iLocal_312 && func_45(&uLocal_105, "MEJ1AUD", "MEJ1_DSPOT", 7, 0, 0, 0))
			{
			...
			{
				if (func_4(&uLocal_105, "MEJ1AUD", "MEJ1_MRAM", sLocal_299[iLocal_308], 7, 0, 0))
				{
...
void func_395()//Position - 0x2F8F9
{
	...
	if (STREAMING::HAS_ANIM_DICT_LOADED("missfam3"))
	{
		...
		{
			Var0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_401, 0f, -20f, 0f) };
			if (func_398(PLAYER::PLAYER_PED_ID(), Var0, 20f, 1))
			{
				iVar3 = MISC::GET_RANDOM_INT_IN_RANGE(1, iLocal_392);
				iVar4 = MISC::GET_RANDOM_INT_IN_RANGE(1, 6);
				iVar4 *= 1000;
				func_396(iLocal_392[iVar3], iVar4, 0);
				iLocal_319 = (MISC::GET_GAME_TIMER() + iVar4);
			}
		}
	}
}

void func_396(int iParam0, int iParam1, int iParam2)//Position - 0x2F96E
{
	char* sVar0;
	char* sVar1;
	char* sVar2;
...
int func_397(int iParam0, int iParam1)//Position - 0x2FA74
{
...
bool func_398(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2FAE6
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

void func_399(var uParam0, var uParam1, var uParam2, float fParam3)//Position - 0x2FB04
{
	*uParam0 = 0;
	*uParam1 = 0;
	*uParam2 = 0;
...
void func_400(char* sParam0, int iParam1)//Position - 0x2FB1C
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_401(int iParam0, bool bParam1, int iParam2)//Position - 0x2FB33
{
	int iVar0;
...
void func_402()//Position - 0x2FB68
{
	...
	switch (iLocal_387)
	{
		case 0:
			func_67(&iLocal_389);
			iLocal_389 = func_345(Local_375, 5, 0);
			HUD::SET_BLIP_COLOUR(iLocal_389, 3);
			HUD::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_389, "MEJ1_JIM");
			HUD::SET_BLIP_ROUTE(iLocal_389, true);
		...
		case 1:
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_375, true) < 1400f)
			{
				iLocal_387 = 2;
			}
			break;
		...
		case 2:
			...
			if (func_403())
			{
				if (func_45(&uLocal_105, "MEJ1AUD", "MEJ1_RAM2", 7, 0, 0, 0) || func_27())
				{
					iLocal_387 = 0;
					iLocal_386 = 2;
				}
			}
			if (func_42(iLocal_390) && func_42(iLocal_392[0]))
			{
				if (func_398(PLAYER::PLAYER_PED_ID(), Local_375, 150f, 1) || func_394(&uLocal_105, 14, "MEJ1AUD", "MEJ1_CLOSE", 7, 0, 0, 1))
				{
					iLocal_387 = 3;
				}
			}
...
int func_403()//Position - 0x2FD10
{
	if (((func_49(iLocal_401) && func_42(PLAYER::PLAYER_PED_ID())) && func_42(iLocal_392[0])) && func_42(iLocal_390))
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_407, Local_410, fLocal_431, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_413, Local_416, fLocal_432, false, true, 0))
		{
			ENTITY::SET_ENTITY_COORDS(iLocal_401, Local_403, true, false, false, true);
			ENTITY::SET_ENTITY_HEADING(iLocal_401, fLocal_406);
			return 1;
		}
		else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_419, Local_422, fLocal_431, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_425, Local_428, fLocal_432, false, true, 0))
		{
			ENTITY::SET_ENTITY_COORDS(iLocal_401, Local_403, true, false, false, true);
			ENTITY::SET_ENTITY_HEADING(iLocal_401, fLocal_406);
			return 1;
...
void func_404()//Position - 0x2FDFC
{
	...
	if (func_49(iLocal_401))
	{
		...
		while (iVar0 < 3)
		{
			if (!func_42(iLocal_392[iVar0]))
			{
				if (STREAMING::HAS_MODEL_LOADED(iLocal_400))
				{
					iLocal_392[iVar0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_401, 4, iLocal_400, iLocal_396[iVar0], true, true);
					PED::SET_PED_COMPONENT_VARIATION(iLocal_392[iVar0], 0, iVar0, iVar0, 0);
					PED::SET_PED_COMPONENT_VARIATION(iLocal_392[iVar0], 2, iVar0, iVar0, 0);
					PED::SET_PED_COMPONENT_VARIATION(iLocal_392[iVar0], 3, iVar0, iVar0, 0);
					PED::SET_PED_COMPONENT_VARIATION(iLocal_392[iVar0], 4, iVar0, iVar0, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_392[iVar0], true);
					ENTITY::SET_ENTITY_VISIBLE(iLocal_392[iVar0], false, false);
					PED::SET_PED_FLEE_ATTRIBUTES(iLocal_392[iVar0], 2, false);
					PED::SET_PED_FLEE_ATTRIBUTES(iLocal_392[iVar0], 128, false);
					PED::SET_PED_FLEE_ATTRIBUTES(iLocal_392[iVar0], 65536, true);
					PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_392[iVar0], 17, true);
					ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_392[iVar0], true);
					if (iVar0 == 0)
					{
						func_358(&uLocal_105, 5, iLocal_392[iVar0], "MEJimmyKidnapper", 1, 1);
					}
				}
			}
			iVar0++;
		...
		if (!func_42(iLocal_390))
		{
			if (STREAMING::HAS_MODEL_LOADED(func_52(14)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_270))
			{
				func_405(&iLocal_390, Local_403, fLocal_406, 1);
				ENTITY::SET_ENTITY_VISIBLE(iLocal_390, false, false);
				PED::SET_PED_CAN_BE_TARGETTED(iLocal_390, false);
				PED::SET_PED_CONFIG_FLAG(iLocal_390, 29, false);
				PED::SET_PED_CONFIG_FLAG(iLocal_390, 116, false);
				PED::SET_PED_CONFIG_FLAG(iLocal_390, 104, true);
				TASK::SET_PED_PATH_CAN_USE_CLIMBOVERS(iLocal_390, true);
				TASK::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_390, true);
				PED::SET_PED_HELMET(iLocal_390, false);
				ENTITY::SET_ENTITY_PROOFS(iLocal_390, true, false, false, true, true, false, false, false);
				PED::SET_PED_CAN_RAGDOLL(iLocal_390, false);
				PED::SET_PED_RESET_FLAG(iLocal_390, 249, true);
				PED::SET_PED_RESET_FLAG(iLocal_390, 248, true);
				PED::SET_PED_RESET_FLAG(iLocal_390, 124, true);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_390, true);
				PED::SET_PED_DIES_IN_WATER(iLocal_390, true);
				PED::SET_PED_DIES_IN_SINKING_VEHICLE(iLocal_390, true);
				func_358(&uLocal_105, 3, iLocal_390, "JIMMY", 1, 1);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID(), iLocal_391);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_390, iLocal_391);
				ENTITY::SET_ENTITY_COLLISION(iLocal_390, false, false);
				iLocal_271 = PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_271, true);
				PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_271, false);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_271, iLocal_401, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_401, sLocal_273));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_390, iLocal_271, sLocal_270, "base", 8f, -8f, 4, iLocal_274, 1000f, 0);
				iLocal_272 = 0;
			}
		}
	}
	else if (STREAMING::HAS_MODEL_LOADED(iLocal_402))
	{
		iLocal_401 = VEHICLE::CREATE_VEHICLE(iLocal_402, Local_403, fLocal_406, true, true, false);
		VEHICLE::SET_VEHICLE_COLOURS(iLocal_401, 22, 22);
		VEHICLE::SET_VEHICLE_EXTRA_COLOURS(iLocal_401, 0, 8);
		ENTITY::SET_ENTITY_VISIBLE(iLocal_401, false, false);
		ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_401, true);
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_402, true);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_402);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_401, true, 1);
		VEHICLE::SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(iLocal_401, false);
		iLocal_320 = 0;
		iLocal_321 = -1;
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_401, "M_E_JIMMY_ENEMY_VEHICLE_GROUP", 0f);
	}
}

int func_405(int* iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x300E1
{
	int iVar0;
...
bool func_408(int iParam0)//Position - 0x3019C
{
	if (iParam0 == 0)
	{
		return 1;
...
void func_409(int* iParam0, struct<3> Param1, float fParam4)//Position - 0x301BA
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_410()//Position - 0x301E3
{
	...
	if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		if (func_42(PLAYER::PLAYER_PED_ID()))
		{
			func_358(&uLocal_105, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 1, 1);
		}
		func_358(&uLocal_105, 4, 0, "JIMMY", 0, 1);
		if (func_42(PLAYER::PLAYER_PED_ID()))
		{
			iLocal_391 = PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
		}
		func_553(1);
		MISC::SET_INSTANCE_PRIORITY_HINT(2);
		STREAMING::REQUEST_ANIM_DICT(sLocal_270);
		sLocal_299[0] = "MEJ1_MRAM_1";
		sLocal_299[1] = "MEJ1_MRAM_2";
		sLocal_299[2] = "MEJ1_MRAM_3";
		sLocal_299[3] = "MEJ1_MRAM_4";
		sLocal_299[4] = "MEJ1_MRAM_5";
		sLocal_299[2] = "MEJ1_MRAM_6";
		sLocal_299[3] = "MEJ1_MRAM_7";
		sLocal_299[4] = "MEJ1_MRAM_8";
		sLocal_323[0] = "MEJ1_CRASH_1";
		sLocal_323[1] = "MEJ1_CRASH_2";
		sLocal_323[2] = "MEJ1_CRASH_3";
		sLocal_323[3] = "MEJ1_CRASH_4";
		sLocal_323[4] = "MEJ1_CRASH_5";
		sLocal_323[5] = "MEJ1_CRASH_6";
		sLocal_332[0] = "MEJ1_HITKILL_1";
		sLocal_332[1] = "MEJ1_HITKILL_2";
		sLocal_332[2] = "MEJ1_HITKILL_3";
		sLocal_336[0] = "MEJ1_NOKILL_1";
		sLocal_336[1] = "MEJ1_NOKILL_2";
		sLocal_336[2] = "MEJ1_NOKILL_3";
		sLocal_343[0] = "MEJ1_STILL_1";
		sLocal_343[1] = "MEJ1_STILL_2";
		sLocal_343[2] = "MEJ1_STILL_3";
		sLocal_349[0] = "MEJ1_INJURE_1";
		sLocal_349[1] = "MEJ1_INJURE_2";
		sLocal_349[2] = "MEJ1_INJURE_3";
		sLocal_349[3] = "MEJ1_INJURE_4";
		sLocal_357[0] = "MEJ1_FLEE_1";
		sLocal_357[1] = "MEJ1_FLEE_2";
		sLocal_357[2] = "MEJ1_FLEE_3";
		sLocal_357[3] = "MEJ1_FLEE_4";
		sLocal_357[4] = "MEJ1_FLEE_5";
		sLocal_357[5] = "MEJ1_FLEE_6";
		sLocal_357[6] = "MEJ1_FLEE_7";
		sLocal_357[7] = "MEJ1_FLEE_8";
		sLocal_357[8] = "MEJ1_FLEE_9";
		sLocal_357[9] = "MEJ1_FLEE_10";
		sLocal_357[10] = "MEJ1_FLEE_11";
		sLocal_357[11] = "MEJ1_FLEE_12";
		iLocal_396[0] = -1;
		iLocal_396[1] = 0;
		iLocal_396[2] = 1;
		if (func_66(0) && func_42(PLAYER::PLAYER_PED_ID()))
		{
			...
			func_448(&iVar0, Var1, fVar4, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
		}
		if (func_406())
		{
			iVar5 = func_447();
			...
			{
				case 0:
					func_429(&iVar6, 1, 1, 1, 1, iLocal_456, 0, 145);
					if (func_398(iVar6, -811.34375f, 187.43669f, 71.47861f, 6f, 1))
					{
				...
				case 3:
					func_411(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1112014848, 12, 5000, 0, 0);
...
void func_411(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x30562
{
	int iVar0;
	int iVar1;
...
void func_419(bool bParam0)//Position - 0x30762
{
	...
	if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_390))
	{
		...
		if (bParam0)
		{
			if ((func_49(iLocal_401) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_401, -1, false)) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_401, 0, false))
			{
				PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_401, -1);
				PED::SET_PED_INTO_VEHICLE(iLocal_390, iLocal_401, 0);
				VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_401, true, true, false);
			}
		}
		else
		{
			Var2 = { func_421() };
			func_420(&Var2, &fVar5);
			func_448(&iVar1, Var2, fVar5, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
			if ((func_49(iVar1) && VEHICLE::IS_VEHICLE_SEAT_FREE(iVar1, 0, false)) && func_42(iLocal_390))
			{
				PED::SET_PED_INTO_VEHICLE(iLocal_390, iVar1, 0);
...
int func_423(int iParam0)//Position - 0x30A35
{
	if (*iParam0 < 0)
	{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_390))
	{
		return 0;
	}
	return 1;
...
int func_424(int iParam0)//Position - 0x30AB4
{
	if (*iParam0 < 0)
	{
		*iParam0 = MISC::GET_GAME_TIMER() + 1000;
...
void func_427()//Position - 0x30BA1
{
	...
	if (func_42(PLAYER::PLAYER_PED_ID()))
	{
		func_46(1, 0);
		func_407();
		func_448(&iVar0, -2086.9126f, 951.6347f, 183.7526f, 75.8f, 1, 1, 0, 1, 1, iLocal_456, 0, 145, 1);
		if (func_49(iVar0))
		{
		...
		PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), false);
		func_404();
		while (((!func_42(iLocal_390) && !func_42(iLocal_392[0])) && !func_42(iLocal_392[1])) && !func_42(iLocal_392[2]))
		{
			func_404();
			SYSTEM::WAIT(0);
		}
...
void func_429(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x30CD8
{
	struct<3> Var0;
	float fVar3;
	...
	if (func_446() && func_430(iParam1, iParam2, iParam3, 1))
	{
		Var0 = { 0f, 0f, 0f };
		fVar3 = 0f;
		func_448(iParam0, Var0, fVar3, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
	}
...
int func_430(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x30D69
{
...
int func_433(var uParam0)//Position - 0x30E7F
{
...
int func_434(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x30EDF
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_435(int iParam0, bool bParam1, int iParam2)//Position - 0x30F5A
{
	int iVar0;
	struct<2> Var1;
	...
	else
	{
		...
		while (iVar0 < FILES::GET_NUM_DLC_VEHICLES())
		{
			if (FILES::GET_DLC_VEHICLE_DATA(iVar0, &Var1))
			{
				...
				{
					if ((func_440() || MISC::IS_PC_VERSION()) || func_439())
					{
					}
					else if (!func_442())
					{
...
int func_436(int iParam0)//Position - 0x310DF
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_438(int iParam0, int iParam1)//Position - 0x311C2
{
	int iVar0;
	int iVar1;
...
int func_441()//Position - 0x313F7
{
	return 0;
}

int func_442()//Position - 0x31400
{
	return 1;
}

int func_443()//Position - 0x31409
{
	return 1;
}

int func_444()//Position - 0x31412
{
...
void func_448(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x3151E
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_525(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
...
int func_449(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x316B2
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_450(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x324D5
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_18(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		{
			func_272(iParam1, &(Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_114135.f_20122[iParam0 /*43*/].f_31 = func_453(*iParam1);
				...
				func_451(Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_114135.f_20122[iParam0 /*43*/].f_1));
				...
				func_451(Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_114135.f_20122[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
float func_453(int iParam0)//Position - 0x3464F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_454(int iParam0, bool bParam1, var uParam2)//Position - 0x346FF
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_495(iVar0, bParam1, uParam2) && !func_494(PLAYER::PLAYER_ID())) && !func_468(iParam0))
	{
		return 0;
	}
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_455(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_455(int iParam0)//Position - 0x3488A
{
	int iVar0;
...
int func_456(int iParam0)//Position - 0x348C5
{
	if (iParam0 != func_10())
	{
		if (func_372(iParam0, 1, 1))
...
int func_458(int iParam0)//Position - 0x34E28
{
...
int func_459(int iParam0)//Position - 0x34E3F
{
	if (iParam0 != func_10())
	{
		if (func_372(iParam0, 1, 1))
...
int func_460(int iParam0)//Position - 0x34E86
{
...
int func_461(int iParam0)//Position - 0x34EC8
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_462(int iParam0)//Position - 0x34F90
{
	if (iParam0 != func_10())
	{
		if (func_372(iParam0, 1, 1))
...
int func_463(int iParam0)//Position - 0x34FD7
{
	if (iParam0 != func_10())
	{
		if (func_372(iParam0, 1, 1))
...
int func_464(int iParam0)//Position - 0x3501E
{
	if (iParam0 != func_10())
	{
		if (func_372(iParam0, 1, 1))
...
int func_465(int iParam0)//Position - 0x35064
{
	bool bVar0;
...
int func_467(int iParam0)//Position - 0x3510F
{
	if (iParam0 != func_10())
	{
...
int func_468(int iParam0)//Position - 0x35135
{
...
int func_469(int iParam0)//Position - 0x35164
{
...
int func_470(int iParam0)//Position - 0x352CC
{
	int iVar0;
...
int func_471(int iParam0)//Position - 0x35349
{
	switch (iParam0)
	{
		case joaat("mule"):
...
int func_472(int iParam0)//Position - 0x353A5
{
	if (iParam0 == func_10())
	{
		return 0;
	}
	if (func_494(iParam0) && Global_2657991[iParam0 /*467*/].f_324.f_11 == iParam0)
	{
		return 1;
	}
	return 0;
...
int func_473(int iParam0, bool bParam1)//Position - 0x353DE
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_474(int iParam0)//Position - 0x35439
{
	int iVar0;
...
int func_475(int iParam0, int iParam1)//Position - 0x35472
{
	if (iParam1 == 0)
	{
...
int func_484(int iParam0, int iParam1)//Position - 0x3596D
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_485(int iParam0)//Position - 0x35D4C
{
	if (PLAYER::PLAYER_ID() != func_10())
	{
...
int func_486(int iParam0)//Position - 0x35E45
{
...
int func_489(int iParam0, bool bParam1, bool bParam2)//Position - 0x35E83
{
	if (iParam0 == func_10())
	{
		return 0;
...
int func_490(int iParam0)//Position - 0x35EE7
{
...
int func_492(int iParam0)//Position - 0x35F26
{
	if (iParam0 != func_10())
	{
		if (func_372(iParam0, 1, 1))
		{
			if (Global_2657991[iParam0 /*467*/].f_324.f_8 != -1 && Global_2657991[iParam0 /*467*/].f_324.f_11 != func_10())
			{
...
int func_493(int iParam0)//Position - 0x35F85
{
	if (iParam0 != func_10())
	{
		if (func_372(iParam0, 1, 1))
...
int func_494(int iParam0)//Position - 0x35FE5
{
	if (iParam0 != func_10())
	{
		if (func_372(iParam0, 1, 1))
...
int func_495(int iParam0, bool bParam1, var uParam2)//Position - 0x3602C
{
	bool bVar0;
...
int func_496(int iParam0)//Position - 0x36423
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_497(int iParam0, int iParam1)//Position - 0x36458
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_270(iParam0, &(Global_114135.f_32754.f_5510));
}

int func_498(int iParam0)//Position - 0x3665A
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_219(iParam0, 0, 0)) || func_219(iParam0, 1, 0)) || func_219(iParam0, 2, 0)) || func_266(iParam0) != 145) || func_502(iParam0)) || func_501(iParam0)) || func_455(iParam0)) || func_500(iParam0)) || !func_499(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_501(iParam0))
		{
		}
...
int func_499(int iParam0)//Position - 0x36737
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_500(int iParam0)//Position - 0x368F5
{
	int iVar0;
	char* sVar1;
...
int func_501(int iParam0)//Position - 0x3693C
{
	int iVar0;
...
int func_502(int iParam0)//Position - 0x369B8
{
	int iVar0;
...
void func_503(int iParam0, int iParam1)//Position - 0x36AA0
{
	int iVar0;
...
void func_504(int iParam0)//Position - 0x36B22
{
	if (!func_505(*iParam0))
	{
...
bool func_505(int iParam0)//Position - 0x36B4D
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_506(int iParam0, var uParam1, var uParam2)//Position - 0x36B5C
{
	int iVar0;
	int iVar1;
...
int func_507(int iParam0)//Position - 0x36D35
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_509(int iParam0, int iParam1)//Position - 0x36E68
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_510(int iParam0, int iParam1)//Position - 0x36F51
{
	int iVar0;
...
int func_511(int iParam0)//Position - 0x36FB3
{
...
int func_512(int iParam0, int iParam1, int iParam2)//Position - 0x36FDE
{
...
int func_513()//Position - 0x37002
{
	return 0;
}

int func_514(var uParam0, int iParam1)//Position - 0x3700B
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_515(int iParam0, int iParam1)//Position - 0x3704C
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98994[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98994[iVar0]) == func_268(iParam0, iParam1))
				{
...
void func_516(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x370EA
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_524(&(Global_78329.f_555[0 /*21*/]), iVar0))
		{
...
void func_518(int iParam0, bool bParam1)//Position - 0x372A9
{
	...
	if (bParam1)
	{
		...
		{
			func_519(iParam0, 1, 0);
			func_519(iParam0, 2, 0);
			func_519(iParam0, 3, 0);
			func_519(iParam0, 4, 0);
			func_519(iParam0, 0, 1);
			Global_78329[iParam0] = 1;
		}
	}
	else
...
int func_521(int iParam0, int iParam1)//Position - 0x3740D
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_522(&(Global_114135.f_32754.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_435(Global_114135.f_32754.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}
...
int func_523(int iParam0, int iParam1)//Position - 0x3748B
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_524(var uParam0, int iParam1)//Position - 0x374AB
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_293(Global_114135.f_32754.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_293(Global_114135.f_2367.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_293(Global_114135.f_2367.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_525(struct<3> Param0, float fParam3)//Position - 0x38B9B
{
	return func_526(&(Global_107680.f_2890), Param0, fParam3, 0);
}

int func_526(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x38BB5
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (func_433(uParam0))
	{
		...
		if (func_549(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_530(iVar0, &(uParam0->f_12), 0, 1);
				bVar4 = true;
				...
				else if ((!func_528(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_527(iVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_527(int iParam0)//Position - 0x38E67
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_528(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x38F2A
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_529(iParam0, Global_78329.f_139[38], 0))
			{
				func_517(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_529(iParam0, Global_78329.f_139[43], 1))
			{
				func_517(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_529(iParam0, uVar1[iVar6], 1) && func_434(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.5635f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_293(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_529(int iParam0, int iParam1, bool bParam2)//Position - 0x39132
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_530(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x39193
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_271(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_271(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_271(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					...
					{
						MISC::SET_BIT(&(uParam1->f_77), func_271(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("surfer3"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_271(iVar5));
				}
				iVar5++;
			}
		}
		...
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar6 <= 2)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_271(iVar6));
				}
				iVar6++;
			}
		}
		...
		if (((BitTest(uParam1->f_77, 15) || func_539(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_538())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if ((((func_532() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_466(1)))
		{
			if (!BitTest(uParam1->f_77, 23))
			{
				if (!BitTest(uParam1->f_77, 22) && func_531(iParam0, 5f))
				{
...
int func_531(int iParam0, float fParam1)//Position - 0x39898
{
	struct<3> Var0;
	float fVar3;
...
int func_533(var uParam0)//Position - 0x39998
{
	int iVar0;
...
int func_534(int iParam0)//Position - 0x399BC
{
	int iVar0;
...
var func_536(var uParam0, var uParam1)//Position - 0x399EE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_537(int iParam0, int iParam1)//Position - 0x39A11
{
	int iVar0;
	int iVar1;
...
int func_539(int iParam0)//Position - 0x39A9A
{
	int iVar0;
...
int func_540(int iParam0)//Position - 0x39AE2
{
	if (!func_513() && func_541(iParam0))
	{
		return 1;
	}
	return 0;
...
int func_541(int iParam0)//Position - 0x39B02
{
	switch (iParam0)
	{
		case 161:
...
int func_542(int iParam0)//Position - 0x39B55
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (!func_548(PLAYER::PLAYER_ID(), -1))
		{
	...
	if (func_544(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
		{
...
int func_543(int iParam0)//Position - 0x39BDC
{
...
int func_546(int iParam0, int iParam1)//Position - 0x39C4B
{
	if (func_78(iParam0))
	{
...
int func_548(int iParam0, int iParam1)//Position - 0x39CBB
{
	int iVar0;
...
int func_549(var uParam0)//Position - 0x39D08
{
	if (func_433(uParam0))
	{
...
void func_554(bool bParam0)//Position - 0x39DAD
{
	...
	CAM::SET_WIDESCREEN_BORDERS(false, 0);
	VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_381 - Vector(10f, 10f, 10f), Local_381 + Vector(10f, 10f, 10f), true, true);
	func_553(0);
