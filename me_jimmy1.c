...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_239 = -1;
	iLocal_240 = -1;
	Local_247 = { -814.3175f, 179.0176f, 71.15919f };
	Local_248 = { -806.1814f, 184.2898f, 71.34769f };
	Local_249 = { -801.9036f, 182.9307f, 71.6055f };
	Local_250 = { -1368.279f, 355.9018f, 63.08109f };
	iLocal_254 = -1;
	iLocal_255 = -1;
	iLocal_256 = -1;
	iLocal_259 = 1;
	...
	Local_291 = { -825.5035f, 179.0266f, 70.36901f };
	Local_292 = { -1378.445f, 367.812f, 63.0445f };
	fLocal_293 = 800f;
	fLocal_294 = 100f;
	...
	fLocal_307 = 135.06f;
	Local_308 = { -2223.216f, 1009.275f, 163.5117f };
	Local_309 = { -2226.588f, 1147.933f, 270.9565f };
	Local_310 = { -2269.847f, 891.1068f, 192.3028f };
	Local_311 = { -2161.119f, 1225.727f, 500.5435f };
	Local_312 = { -2402.329f, 1057.229f, 189.9754f };
	Local_313 = { -2410.82f, 1005.26f, 200.8591f };
	Local_314 = { -2328.859f, 892.1643f, 196.7366f };
	Local_315 = { -2333.412f, 1221.693f, 495.6477f };
	fLocal_316 = 90f;
	fLocal_317 = 200f;
	iLocal_318 = 1;
	iLocal_319 = 1;
	iLocal_321 = 1;
	Local_325 = { -826.6968f, 178.0209f, 69.18726f };
	Local_326 = { -817.7529f, 185.9504f, 72.3539f };
	fLocal_327 = 7f;
...
bool func_4(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x613
{
...
int func_5(char* sParam0, int iParam1, bool bParam2)//Position - 0x667
{
	Global_21606 = 0;
...
bool func_8(int iParam0)//Position - 0x9CF
{
	return func_9(iParam0, 20);
}

var func_9(int iParam0, int iParam1)//Position - 0x9DF
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

int func_10()//Position - 0x9F7
{
	return -1;
}

void func_11()//Position - 0xA00
{
	int iVar0;
...
int func_16()//Position - 0xC28
{
	func_17();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_17()//Position - 0xC41
{
	int iVar0;
...
bool func_18(int iParam0)//Position - 0xD3E
{
	return iParam0 < 3;
}

int func_19(int iParam0)//Position - 0xD4A
{
	int iVar0;
	int iVar1;
...
int func_20(int iParam0)//Position - 0xD87
{
	if (func_18(iParam0))
	{
...
var func_21(int iParam0)//Position - 0xDAC
{
	return Global_1998[iParam0 /*29*/];
}

bool func_22(int iParam0)//Position - 0xDBB
{
	return Global_43052 == iParam0;
}

void func_23()//Position - 0xDC9
{
	int iVar0;
...
bool func_24(int iParam0, int iParam1)//Position - 0xE20
{
	switch (iParam0)
	{
		case 5:
...
void func_26(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEAF
{
...
void func_28()//Position - 0xF27
{
	Global_20471 = 0;
	func_29();
}

void func_29()//Position - 0xF37
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22616 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
bool func_30(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF58
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_31(&(Local_52[iVar2 /*4*/]), Var1, iParam1, &(Local_52[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_52[iVar2 /*4*/].f_3) < iParam4);
}

int func_31(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x1019
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_32(int iParam0, int iParam1)//Position - 0x1145
{
	int iVar0;
...
int func_34(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x1254
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	{
		Var1 = { func_36(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_35(struct<3> Param0, struct<3> Param1)//Position - 0x12E5
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_36(struct<3> Param0)//Position - 0x1306
{
	float fVar0;
	float fVar1;
...
void func_37(var uParam0)//Position - 0x1345
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_38(int iParam0, int iParam1)//Position - 0x1360
{
	int iVar0;
...
int func_42(int iParam0)//Position - 0x13FA
{
	if (func_41(iParam0))
	{
...
int func_44(int iParam0, int iParam1)//Position - 0x1523
{
	if (*iParam0 < 0)
	{
...
bool func_45(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x154E
{
...
void func_46(bool bParam0, bool bParam1)//Position - 0x159C
{
	...
	else
	{
		...
		else if (func_42(iLocal_299) && ENTITY::IS_ENTITY_AT_COORD(iLocal_299, Local_291, 50f, 50f, 50f, false, true, 0))
		{
			func_50(iLocal_299);
		}
		else
...
void func_47(int* iParam0)//Position - 0x169F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_48(int* iParam0)//Position - 0x16D7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_49(int iParam0)//Position - 0x1773
{
	if (func_41(iParam0))
	{
...
int func_50(int iParam0)//Position - 0x179D
{
	int iVar0;
...
int func_51(int iParam0)//Position - 0x1800
{
	int iVar0;
...
int func_52(int iParam0)//Position - 0x1921
{
	if (!func_18(iParam0))
	{
		return func_21(iParam0);
...
void func_53(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1947
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_54(int* iParam0)//Position - 0x1997
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_57(char* sParam0)//Position - 0x1A18
{
...
void func_58(int iParam0)//Position - 0x1A57
{
	...
	if (Global_113386.f_9085 || func_66(0))
	{
		iVar0 = func_65();
		if (!func_59(iVar0))
		{
...
void func_61(var uParam0)//Position - 0x1D72
{
	*uParam0 = -15;
}
...
void func_63(int iParam0, bool bParam1)//Position - 0x26EF
{
	if (bParam1)
	{
...
int func_66(bool bParam0)//Position - 0x2846
{
...
void func_67(int* iParam0)//Position - 0x286E
{
		...
		switch (iLocal_296)
		{
			case 0:
				...
				else
				{
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_250, 1f, 20000, 0.25f, false, 40000f);
			...
			case 1:
				...
				if (!func_27())
				{
					if (((func_49(iLocal_304) && func_42(iLocal_299)) && PED::IS_PED_IN_VEHICLE(iLocal_299, iLocal_304, false)) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_304, 0, false))
					{
			...
			case 3:
				...
				if (((!func_27() && func_82(iLocal_299, Local_250, 4f)) || bLocal_252) || MISC::GET_GAME_TIMER() > iLocal_251)
				{
					if (bLocal_252)
					{
						if (func_27())
...
void func_70(bool bParam0, int iParam1)//Position - 0x2D23
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (bParam0)
	{
		if ((func_66(0) && Global_78565.f_1 == 1) && func_71(Global_78565))
		{
		}
		else
		{
...
int func_71(int iParam0)//Position - 0x2DF3
{
	switch (iParam0)
	{
		case 71:
...
void func_72(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2E31
{
	int iVar0;
...
void func_73(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x2EDB
{
	if (bParam0)
	{
...
bool func_74()//Position - 0x301E
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_75(int iParam0, int iParam1)//Position - 0x3038
{
	bool bVar0;
...
int func_76(int iParam0, bool bParam1)//Position - 0x3083
{
	int iVar0;
	int iVar1;
...
int func_77()//Position - 0x30C4
{
	return Global_1574918;
}

int func_78(int iParam0)//Position - 0x30D0
{
...
bool func_79()//Position - 0x310F
{
	return BitTest(Global_2621446, 3);
}

int func_80(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x311D
{
	int iVar0;
...
void func_81(int iParam0)//Position - 0x3150
{
	if (iParam0 == 1)
	{
...
bool func_82(int iParam0, struct<3> Param1, float fParam2)//Position - 0x3173
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_83(int iParam0)//Position - 0x31A8
{
...
void func_85(int iParam0, bool bParam1)//Position - 0x3224
{
...
void func_86(int iParam0, bool bParam1)//Position - 0x3260
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
int func_87(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x3292
{
...
void func_88(int iParam0)//Position - 0x342A
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
Vector3 func_90(int iParam0)//Position - 0x3614
{
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x3627
{
	...
	if (iParam5 == 0)
	{
		Global_78130[1 /*14*/] = { func_142(iVar10, iParam1, iParam2, -1) };
		if (!func_141(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		{
			uVar11 = { func_124(iVar10, iParam2) };
		}
		iVar0 = 0;
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78130[1 /*14*/] = { func_142(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						{
							uVar12 = { func_121(iVar10, uVar11[iVar0]) };
						}
						iVar1 = 0;
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_142(iVar10, 14, uVar12[iVar1], -1) };
							func_111(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
							func_134(14);
							if (Global_78128 == 1)
							{
								iVar2 = 0;
			...
			{
				Global_78130[1 /*14*/] = { func_142(iVar10, iVar0, func_100(iParam0, iVar0, -1), -1) };
		...
		if (iParam7 == 1)
		{
			Var14 = { func_142(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var14 = { func_142(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var14 = { func_142(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var14 = { func_142(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var14 = { func_142(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	{
		uVar15 = { func_121(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_142(iVar10, 14, uVar15[iVar1], -1) };
			func_111(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_134(14);
			if (Global_78128 == 1)
			{
...
int func_93(int iParam0)//Position - 0x3EC3
{
	switch (iParam0)
	{
...
void func_94(int iParam0, int iParam1, int iParam2)//Position - 0x3EFE
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1, int iParam2)//Position - 0x3F88
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 4)
...
bool func_96(int iParam0, int iParam1, int iParam2)//Position - 0x4068
{
	Global_78130[1 /*14*/] = { func_142(iParam0, iParam1, iParam2, -1) };
	return BitTest(Global_78130[1 /*14*/].f_6, 2);
}

int func_97(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x4090
{
	var uVar0;
	int iVar1;
	...
	if (iParam2 == 14)
	{
		uVar0 = { func_121(iParam0, (*uParam4)[13]) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
...
int func_98(int iParam0, int iParam1, int iParam2)//Position - 0x4694
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_101(int iParam0)//Position - 0x4864
{
	switch (iParam0)
	{
		case 0:
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4914
{
	int iVar0;
...
int func_103(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x4C1B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x57CE
{
	int iVar0;
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5AB2
{
	int iVar0;
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5D79
{
	int iVar0;
	int iVar1;
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5DB0
{
	int iVar0;
...
int func_108(int iParam0, int iParam1, int iParam2)//Position - 0x5DD9
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x60A3
{
	int iVar0;
...
int func_110(int iParam0, int iParam1, int iParam2)//Position - 0x632D
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_111(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6484
{
	int iVar0;
...
int func_112(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x651C
{
	switch (iParam0)
	{
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x65EA
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else if (iParam2 == 14)
	{
		...
		iVar1 = (iParam1 - func_115(iParam0));
		if (iVar1 < 0)
		{
			return -1;
		}
	...
	else
	{
		...
		iVar4 = (iParam1 - func_114(iParam0, func_101(iParam2)));
		if (iVar4 < 0)
		{
			return -1;
		}
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_101(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_114(int iParam0, int iParam1)//Position - 0x6704
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_115(int iParam0)//Position - 0x6AAB
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_116(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6B0C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_117(int iParam0, int iParam1)//Position - 0x6C08
{
	int iVar0;
...
int func_118(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6D46
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		if (iVar4 != -1)
		{
			return (func_114(iParam0, func_101(iParam2)) + iVar4);
		}
	}
	return -99;
}

int func_119(int iParam0)//Position - 0x6E01
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_120(int iParam0)//Position - 0x6E60
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_121(int iParam0, int iParam1)//Position - 0x6EE6
{
	int iVar0;
	struct<10> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			...
			{
				case 31:
					func_123(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 0:
					func_123(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 1:
					func_123(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 2:
					func_123(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 3:
					func_123(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 4:
					func_123(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_123(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_123(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_123(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 8:
					func_123(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 9:
					func_123(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8);
					break;
				
				default:
					func_122(&Var1, iParam0, iParam1, 10);
					break;
			}
			break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 1:
					func_123(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8);
					break;
				
				case 2:
					func_123(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 4:
					func_123(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_123(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_123(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_123(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 8:
					func_123(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				default:
					func_122(&Var1, iParam0, iParam1, 9);
					break;
			}
			break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 0:
					func_123(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 1:
					func_123(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 3:
					func_123(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8);
					break;
				
				case 4:
					func_123(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_123(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_123(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_123(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 8:
					func_123(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				...
				case 0:
					func_123(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 1:
					func_123(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 2:
					func_123(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 3:
					func_123(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 4:
					func_123(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_123(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_123(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_123(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 8:
					func_123(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 9:
					func_123(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 10:
					func_123(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 12:
					func_123(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 13:
					func_123(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 14:
					func_123(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 15:
					func_123(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 16:
					func_123(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 17:
					func_123(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 18:
					func_123(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 19:
					func_123(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 20:
					func_123(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 21:
					func_123(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				default:
					func_122(&Var1, iParam0, iParam1, 25);
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				...
				case 0:
					func_123(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 1:
					func_123(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 2:
					func_123(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 3:
					func_123(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 4:
					func_123(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_123(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_123(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_123(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 9:
					func_123(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 10:
					func_123(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 11:
					func_123(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 12:
					func_123(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 13:
					func_123(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8);
					break;
				
				case 14:
					func_123(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 16:
					func_123(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 17:
					func_123(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 18:
					func_123(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 19:
					func_123(&Var1, 42, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 20:
					func_123(&Var1, 76, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 21:
					func_123(&Var1, 39, 235, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 22:
					func_123(&Var1, 41, 183, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 23:
					func_123(&Var1, 111, 194, 2, 3, 4, 5, 6, 7, 8);
					break;
...
void func_122(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7815
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var2;
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1.f_0))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &Var2) && Var2.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var2.f_2] = func_118(iParam1, Var2.f_0, 14, iVar0);
					}
					else if (Var2.f_1 != -1)
					{
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x793F
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_124(int iParam0, int iParam1)//Position - 0x7987
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				case 0:
					...
					{
						func_127(&Var1, -99, -99, 1, 1, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					}
					else
					{
						func_127(&Var1, -99, -99, 0, 0, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					}
					break;
				
				case 1:
					func_127(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0);
					break;
				
				case 2:
					func_127(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8);
					break;
				
				case 3:
					func_127(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31);
					break;
				
				case 4:
					func_127(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2);
					break;
				
				case 5:
					func_127(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[0], Global_113386.f_2363.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
				
				case 6:
					func_127(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 7:
					func_127(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 8:
					func_127(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 9:
					func_127(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 10:
					func_127(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4);
					break;
				
				case 11:
					func_127(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5);
					break;
				
				case 12:
					func_127(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31);
					break;
				
				case 13:
					func_127(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 14:
					func_127(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6);
					break;
				
				case 15:
					func_127(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31);
					break;
				
				case 16:
					func_127(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31);
					break;
				
				case 17:
					func_127(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 18:
					func_127(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7);
					break;
				
				case 19:
					func_127(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 20:
					func_127(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 21:
					func_127(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 22:
					func_127(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 23:
					func_127(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 24:
					func_127(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31);
					break;
				
				case 25:
					func_127(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 26:
					func_127(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 27:
					func_127(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 28:
					func_127(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
				
				case 29:
					func_127(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 30:
					func_127(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 31:
					func_127(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31);
					break;
				
				case 32:
					func_127(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 33:
					func_127(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 34:
					func_127(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31);
					break;
				
				case 35:
					func_127(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 36:
					func_127(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 37:
					func_127(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 38:
					func_127(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 39:
					func_127(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 40:
					func_127(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 41:
					func_127(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 42:
					func_127(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 43:
					func_127(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 44:
					func_127(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 45:
					func_127(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 46:
					func_127(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 47:
					func_127(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 48:
					func_127(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 49:
					func_127(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 50:
					func_127(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9);
					break;
				
				case 51:
					func_127(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 52:
					func_127(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				default:
					func_125(&Var1, iParam0, iParam1, 53);
					break;
			}
			break;
		...
		case joaat("Player_One"):
			...
			{
				case 0:
					func_127(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 1:
					func_127(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
				
				case 2:
					func_127(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[1], Global_113386.f_2363.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
				
				case 3:
					func_127(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1);
					break;
				
				case 4:
					func_127(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2);
					break;
				
				case 5:
					func_127(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 6:
					func_127(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 7:
					func_127(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3);
					break;
				
				case 8:
					func_127(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5);
					break;
				
				case 9:
					func_127(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 10:
					func_127(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 11:
					func_127(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
				
				case 12:
					func_127(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 13:
					func_127(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 14:
					func_127(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 15:
					func_127(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 16:
					func_127(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 17:
					func_127(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 18:
					func_127(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31);
					break;
				
				case 19:
					func_127(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 20:
					func_127(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 21:
					func_127(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4);
					break;
				
				case 22:
					func_127(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31);
					break;
				
				case 23:
					func_127(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31);
					break;
				
				case 24:
					func_127(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31);
					break;
				
				case 25:
					func_127(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31);
					break;
				
				case 26:
					func_127(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31);
					break;
				
				case 27:
					func_127(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31);
					break;
				
				case 28:
					func_127(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31);
					break;
				
				case 29:
					func_127(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31);
					break;
				
				case 30:
					func_127(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31);
					break;
				
				case 31:
					func_127(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31);
					break;
				
				case 32:
					func_127(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31);
					break;
				
				case 33:
					func_127(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31);
					break;
				
				case 34:
					func_127(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31);
					break;
				
				case 35:
					func_127(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31);
					break;
				
				case 36:
					func_127(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31);
					break;
				
				case 37:
					func_127(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31);
					break;
				
				case 38:
					func_127(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 39:
					func_127(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 40:
					func_127(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 41:
					func_127(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 42:
					func_127(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 43:
					func_127(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6);
					break;
				
				case 44:
					func_127(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7);
					break;
				
				case 45:
					func_127(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8);
					break;
				
				case 46:
					func_127(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31);
					break;
				
				default:
					func_125(&Var1, iParam0, iParam1, 47);
					break;
			}
			break;
		...
		case joaat("Player_Two"):
			...
			{
				case 0:
					func_127(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 1:
					func_127(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8);
					break;
				
				case 2:
					func_127(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1);
					break;
				
				case 3:
					func_127(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2);
					break;
				
				case 4:
					func_127(&Var1, -99, -99, Global_113386.f_2363.f_539.f_196[2], Global_113386.f_2363.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 5:
					func_127(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6);
					break;
				
				case 6:
					func_127(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3);
					break;
				
				case 7:
					func_127(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4);
					break;
				
				case 8:
					func_127(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31);
					break;
				
				case 9:
					func_127(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 10:
					func_127(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 11:
					func_127(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5);
					break;
				
				case 12:
					func_127(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
				
				case 13:
					func_127(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 14:
					func_127(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31);
					break;
				
				case 15:
					func_127(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 16:
					func_127(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 17:
					func_127(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 18:
					func_127(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 19:
					func_127(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 20:
					func_127(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 21:
					func_127(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 22:
					func_127(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 23:
					func_127(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 24:
					func_127(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 25:
					func_127(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 26:
					func_127(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 27:
					func_127(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 28:
					func_127(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 29:
					func_127(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 30:
					func_127(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 31:
					func_127(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 32:
					func_127(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 33:
					func_127(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 34:
					func_127(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 35:
					func_127(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 36:
					func_127(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 37:
					func_127(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 38:
					func_127(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 39:
					func_127(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 40:
					func_127(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 41:
					func_127(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 42:
					func_127(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 43:
					func_127(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 44:
					func_127(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 45:
					func_127(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7);
					break;
				
				case 46:
					func_127(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 47:
					func_127(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				default:
					func_125(&Var1, iParam0, iParam1, 48);
					break;
			}
			break;
		...
		case joaat("MP_M_Freemode_01"):
			...
			{
				case 0:
					func_127(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31);
					break;
				
				case 1:
					func_127(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0);
					break;
				
				case 2:
					func_127(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1);
					break;
				
				case 3:
					func_127(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2);
					break;
				
				case 4:
					func_127(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3);
					break;
				
				case 5:
					func_127(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4);
					break;
				
				case 6:
					func_127(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5);
					break;
				
				case 7:
					func_127(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6);
					break;
				
				case 8:
					func_127(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7);
					break;
				
				case 9:
					func_127(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8);
					break;
				
				case 10:
					func_127(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9);
					break;
				
				case 11:
					func_127(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10);
					break;
				
				case 12:
					func_127(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11);
					break;
				
				case 13:
					func_127(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12);
					break;
				
				case 14:
					func_127(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13);
					break;
				
				case 15:
					func_127(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14);
					break;
				
				case 16:
					func_127(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15);
					break;
				
				case 17:
					func_127(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16);
					break;
				
				case 18:
					func_127(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17);
					break;
				
				case 19:
					func_127(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18);
					break;
				
				case 20:
					func_127(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19);
					break;
				
				case 21:
					func_127(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20);
					break;
				
				case 22:
					func_127(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21);
					break;
				
				case 23:
					func_127(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22);
					break;
				
				case 24:
					func_127(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23);
					break;
				
				case 25:
					func_127(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24);
					break;
				
				default:
					func_125(&Var1, iParam0, iParam1, 26);
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			...
			{
				case 0:
					func_127(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31);
					break;
				
				case 1:
					func_127(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31);
					break;
				
				case 2:
					func_127(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0);
					break;
				
				case 3:
					func_127(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1);
					break;
				
				case 4:
					func_127(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2);
					break;
				
				case 5:
					func_127(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3);
					break;
				
				case 6:
					func_127(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4);
					break;
				
				case 7:
					func_127(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5);
					break;
				
				case 8:
					func_127(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6);
					break;
				
				case 9:
					func_127(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7);
					break;
				
				case 10:
					func_127(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8);
					break;
				
				case 11:
					func_127(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9);
					break;
				
				case 12:
					func_127(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10);
					break;
				
				case 13:
					func_127(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31);
					break;
				
				case 14:
					func_127(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11);
					break;
				
				case 15:
					func_127(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12);
					break;
				
				case 16:
					func_127(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13);
					break;
				
				case 17:
					func_127(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14);
					break;
				
				case 18:
					func_127(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15);
					break;
				
				case 19:
					func_127(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16);
					break;
				
				case 20:
					func_127(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17);
					break;
				
				case 21:
					func_127(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31);
					break;
				
				case 22:
					func_127(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18);
					break;
				
				case 23:
					func_127(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19);
					break;
				
				case 24:
					func_127(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20);
					break;
				
				case 25:
					func_127(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21);
					break;
				
				case 26:
					func_127(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22);
					break;
				
				case 27:
					func_127(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23);
					break;
				
				default:
					func_125(&Var1, iParam0, iParam1, 28);
					break;
			}
			break;
	}
...
void func_125(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x97D1
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var2;
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.f_0 != 0 && Var2.f_0 != -1) && Var2.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_126(Var2.f_2)] = func_118(iParam1, Var2.f_0, func_126(Var2.f_2), iVar0);
					}
				}
				else if (Var2.f_1 != -1)
				{
...
int func_126(int iParam0)//Position - 0x99BB
{
	switch (iParam0)
	{
		case 0:
...
void func_127(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x9A6B
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_128(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9ADC
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_129(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9D59
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA17E
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_131(int iParam0, int iParam1)//Position - 0xA471
{
	int iVar0;
	int iVar1;
...
int func_132(int iParam0, int iParam1)//Position - 0xA4B7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_133(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA517
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_134(int iParam0)//Position - 0xA56E
{
	if (BitTest(Global_78130[1 /*14*/].f_6, 1) && !BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
		func_140(iParam0, Global_78130[1 /*14*/].f_5, Global_78130[1 /*14*/].f_2, 2, Global_78130[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_78130[1 /*14*/].f_6, 1) && BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
		{
			func_135(Global_2883588, 2, 1, 1, -1);
		}
		else if (iParam0 == 13)
		{
		}
...
void func_135(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xA61A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_136(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xA664
{
	int iVar0;
	...
	iVar0 = Global_2826809[iParam0 /*3*/][func_137(iParam2)];
	if (iVar0 != 0)
	{
...
int func_137(var uParam0)//Position - 0xA694
{
	int iVar0;
	int iVar1;
...
int func_138(int iParam0, int iParam1, int iParam2)//Position - 0xA6C8
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 13122)
	{
		...
		iVar0 = Global_2826809[iParam0 /*3*/][func_137(iParam1)];
...
bool func_139(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xA705
{
	int iVar0;
...
int func_140(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xCC57
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_141(int iParam0)//Position - 0xDAFA
{
	if (!BitTest(Global_78130[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_142(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDB42
{
	func_205();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_143(int iParam0, int iParam1)//Position - 0xDB94
{
	switch (iParam0)
	{
		case 0:
...
void func_144(int iParam0)//Position - 0xDC84
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_151(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_145(&(Global_78130[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_145(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xEEFB
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_149(Global_2883588, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_149(Global_2883588, 2, 1, 1, -1))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_138(func_148(iParam1, uParam0->f_2), Global_78127, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_138(func_147(iParam1, uParam0->f_2), Global_78127, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_138(iVar1, Global_78127, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_146(int iParam0, int iParam1, var uParam2)//Position - 0xF2A0
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_147(int iParam0, int iParam1)//Position - 0xF6A5
{
	switch (iParam1)
	{
		case 0:
...
int func_148(int iParam0, int iParam1)//Position - 0xFAA0
{
	switch (iParam1)
	{
		case 0:
...
int func_149(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xFE9B
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_150(int iParam0)//Position - 0xFEDA
{
	switch (iParam0)
	{
		case -1:
...
void func_151(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xFFAE
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar3 >= 0)
		{
			...
			if (iVar4 > iVar3)
			{
				...
				func_145(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_145(&(Global_78130[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_145(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_145(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_101(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_152(int iParam0)//Position - 0x10237
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1038E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1089C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x10911
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x10985
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x10A6C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x10DCF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x10FE0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x11210
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x11320
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x11CBF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x12832
{
	if (iParam0 < 136)
	{
		func_165(iParam0);
	...
	{
		func_151(3, iParam0, 242, -1);
	}
}

void func_164(int iParam0)//Position - 0x12867
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1346B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1437B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x144A8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0, int iParam1)//Position - 0x145A6
{
	switch (iParam0)
	{
		case 0:
...
void func_169(int iParam0)//Position - 0x14696
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x15B87
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x15CD8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x161E3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x16851
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x168C5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x16995
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x16EC5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x1705C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x1785A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x1796A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x18896
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x19553
{
	if (iParam0 < 107)
	{
		func_184(iParam0);
	...
	if (Global_78130[0 /*14*/].f_2 == -1)
	{
		func_151(3, iParam0, 318, -1);
	}
}

void func_182(int iParam0)//Position - 0x19599
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x1A03E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x1AE2D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185(int iParam0)//Position - 0x1BA76
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186(int iParam0)//Position - 0x1BCEF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_187(int iParam0, int iParam1)//Position - 0x1BE35
{
	switch (iParam0)
	{
		case 0:
...
void func_188(int iParam0)//Position - 0x1BF25
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_189(int iParam0)//Position - 0x1CD62
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_190(int iParam0)//Position - 0x1CEDC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_191(int iParam0)//Position - 0x1D453
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_192(int iParam0)//Position - 0x1D97D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_193(int iParam0)//Position - 0x1D9F1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_194(int iParam0)//Position - 0x1DAC1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_195(int iParam0)//Position - 0x1DF99
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_196(int iParam0)//Position - 0x1E202
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_197(int iParam0)//Position - 0x1E4D8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_198(int iParam0)//Position - 0x1E6A1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_199(int iParam0)//Position - 0x1F1F5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_200(int iParam0)//Position - 0x1FE3F
{
	if (iParam0 < 60)
	{
		func_202(iParam0);
	...
	if (Global_78130[0 /*14*/].f_2 == -1)
	{
		func_151(3, iParam0, 181, -1);
	}
}

void func_201(int iParam0)//Position - 0x1FE74
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_202(int iParam0)//Position - 0x20D79
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_203(int iParam0)//Position - 0x21405
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_204(int iParam0)//Position - 0x214EC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_205()//Position - 0x215EA
{
...
int func_206(int iParam0, int iParam1, int iParam2)//Position - 0x21663
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_78130[1 /*14*/] = { func_142(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_78130[1 /*14*/].f_6, 0))
	{
		return 0;
	}
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_206(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar6 = { func_121(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
							if (!func_206(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_78130[2 /*14*/] = { func_142(iVar0, 14, iVar4, -1) };
									if (Global_78130[2 /*14*/].f_12 == iVar3)
									{
										if (func_206(iParam0, 14, iVar4))
										{
											if (!func_97(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_78130[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_78130[2 /*14*/] = { func_142(iVar0, iVar2, iVar1, -1) };
						if (!func_97(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_78130[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_78130[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_101(iParam1)) && Global_78130[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_101(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_207(bool bParam0)//Position - 0x218BB
{
	int iVar0;
...
void func_208()//Position - 0x218FA
{
	Global_20471 = 0;
	func_209();
}

void func_209()//Position - 0x2190A
{
...
void func_210()//Position - 0x21941
{
	Global_20471 = 0;
	func_211();
}

void func_211()//Position - 0x21951
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
	...
	if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_299))
	{
		...
		switch (iLocal_296)
		{
			case 0:
				...
				{
					func_213(Local_325, Local_326, fLocal_327, Local_328, fLocal_329, func_221(), 1, 1, 1, 0, 0);
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_299, 0);
					TASK::OPEN_SEQUENCE_TASK(&iVar1);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2f, 20000, 0.25f, false, 40000f);
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_249, 1f, 20000, 0.25f, false, 40000f);
					TASK::CLOSE_SEQUENCE_TASK(iVar1);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_299, iVar1);
					TASK::CLEAR_SEQUENCE_TASK(&iVar1);
				}
			...
			case 3:
				...
				if (((!func_27() && (func_82(iLocal_299, Local_247, 2f) || func_82(iLocal_299, Local_248, 2f))) || bLocal_252) || MISC::GET_GAME_TIMER() > iLocal_251)
				{
					if (bLocal_252)
					{
						if (func_27())
...
void func_213(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x21D41
{
	func_214(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_214(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x21D6B
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_218(iVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_215(struct<3> Param0)//Position - 0x22161
{
...
int func_216(int iParam0, int iParam1, bool bParam2)//Position - 0x2218B
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_217(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x221F9
{
...
int func_218(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x222D1
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_219(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_219(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_219(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_219(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_219(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_219(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_219(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_219(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_219(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_219(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_219(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_219(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_219(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_219(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_219(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_219(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4))
		{
			return 1;
		}
	}
...
int func_219(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x225C7
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_220(int iParam0)//Position - 0x2267B
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
Vector3 func_221()//Position - 0x226E0
{
...
{
	func_242();
	func_237(&uLocal_336, &uLocal_67, "MEJ1AUD", &sLocal_337, &cLocal_343);
	switch (iLocal_296)
	{
		case 0:
			func_67(&iLocal_298);
			func_236("MEJ1_06", 7500, 1);
			func_235(&uLocal_336);
			if (func_42(iLocal_299) && !PED::IS_PED_GROUP_MEMBER(iLocal_299, func_234()))
			{
				PED::SET_PED_AS_GROUP_MEMBER(iLocal_299, func_234());
		...
		case 1:
			if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_299))
			{
				...
				if (func_226(PLAYER::PLAYER_PED_ID(), iLocal_299) > 15f)
				{
					func_28();
					iLocal_296 = 0;
					iLocal_295 = 4;
			...
			case 16:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_233))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_233) >= 0.85f)
					{
						...
						func_224(iLocal_299, iLocal_304, 2, 0);
						iLocal_234 = 17;
					}
				}
				else
...
void func_224(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x22F58
{
	if (func_42(iParam0))
	{
		if (func_41(iParam1))
...
float func_226(int iParam0, int iParam1)//Position - 0x23027
{
	return func_227(iParam0, iParam1, 1);
}

float func_227(int iParam0, int iParam1, bool bParam2)//Position - 0x23038
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_232()//Position - 0x231C5
{
	...
	{
		iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
		if (func_49(iVar0) && PED::IS_PED_IN_VEHICLE(iLocal_299, iVar0, false))
		{
			return 1;
		}
	}
...
int func_234()//Position - 0x232B6
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

void func_235(var uParam0)//Position - 0x232C6
{
...
void func_236(char* sParam0, int iParam1, int iParam2)//Position - 0x232F0
{
	iParam2 = iParam2;
...
void func_237(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)//Position - 0x23309
{
	switch (*uParam0)
	{
		case 0:
		...
		case 2:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
			{
				...
				{
					if (func_238(uParam1, sParam2, sParam3, sParam4, 8, 1, 0))
					{
						*uParam0 = 3;
					}
				}
		...
		case 4:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && func_238(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
bool func_238(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2341A
{
	func_26(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_239()//Position - 0x2346E
{
	Global_20471 = 0;
	func_25();
}

struct<6> func_240()//Position - 0x2347E
{
	struct<6> Var0;
	int iVar1;
	int iVar2;
...
struct<6> func_241()//Position - 0x2352A
{
	struct<6> Var0;
...
void func_242()//Position - 0x2354E
{
	int iVar0;
	int iVar1;
...
void func_243()//Position - 0x235BB
{
	...
	switch (iLocal_296)
	{
		case 0:
			func_67(&iLocal_298);
			iLocal_298 = func_245(iLocal_299, 1, 1, 5);
			if (iLocal_319)
			{
				func_236("MEJ1_05", 7500, 1);
				func_235(&uLocal_336);
				iLocal_319 = 0;
			}
			iLocal_296 = 1;
		...
		case 1:
			...
			if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_299))
			{
				if (func_226(PLAYER::PLAYER_PED_ID(), iLocal_299) < 5f)
				{
...
void func_244()//Position - 0x2367A
{
	if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_299))
	{
		if (func_226(PLAYER::PLAYER_PED_ID(), iLocal_299) > fLocal_293)
		{
...
int func_245(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x236CA
{
	int iVar0;
	bool bVar1;
...
void func_246()//Position - 0x2371C
{
	...
	switch (iLocal_296)
	{
		case 0:
			...
			if (func_337() == 1)
			{
				iLocal_298 = func_336(Local_292, 5, 1);
			...
			{
				iLocal_298 = func_336(Local_291, 5, 1);
			}
...
void func_249()//Position - 0x23A11
{
	...
	{
		if ((!func_27() && func_230()) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
		{
...
void func_250()//Position - 0x23A5F
{
	...
	{
		if (func_226(PLAYER::PLAYER_PED_ID(), iLocal_301[0]) < 30f)
		{
			if (!func_27() && func_230())
			{
...
void func_252()//Position - 0x23BCA
{
	if (iLocal_238 == 0)
	{
		if (((iLocal_240 == -1 && !func_27()) && func_230()) && func_232())
		{
	...
	{
		if (((!func_27() && func_230()) && func_232()) && MISC::GET_GAME_TIMER() > iLocal_263)
		{
			if (func_238(&uLocal_67, "MEJ1AUD", "MEJ1_DRIVE1", &sLocal_241, 7, 0, 0))
			{
				iLocal_238 = 2;
			}
		}
...
void func_254(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x23CFF
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_326(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
				Global_113386.f_18574[iVar4 /*6*/].f_4 = 0;
				MemCopy(&uVar5, {func_325(iVar4)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar5, 0, Global_100478, iParam0);
			}
			else
			{
				iVar6 = func_324(&(Global_100441.f_3));
				if (iVar6 > -1)
				{
...
void func_255(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x23E74
{
	func_256(&Global_106934, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_256(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x23E90
{
	int iVar0;
	int iVar1;
	
	*uParam0 = func_16();
	uParam0->f_1 = func_313();
...
int func_257(var uParam0)//Position - 0x24D1B
{
...
void func_258(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x24D3D
{
	int iVar0;
	...
	if (func_272(iParam2, &iVar0, iParam3, iParam5))
	{
...
int func_259(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x24DC5
{
...
int func_260(int iParam0)//Position - 0x24E05
{
	int iVar0;
...
void func_261(var uParam0, int iParam1, int iParam2)//Position - 0x24E33
{
...
int func_262(int iParam0)//Position - 0x24F0F
{
	int iVar0;
...
int func_263(int iParam0)//Position - 0x24F51
{
	int iVar0;
...
int func_264(int iParam0, int iParam1, int iParam2)//Position - 0x24FB4
{
	int iVar0;
...
int func_265(int iParam0, int iParam1)//Position - 0x25042
{
	struct<82> Var0;
...
void func_266(int iParam0, var uParam1, int iParam2)//Position - 0x25084
{
	int iVar0;
...
void func_267(int iParam0, var uParam1)//Position - 0x252E0
{
	int iVar0;
...
int func_268(int iParam0)//Position - 0x2558B
{
	switch (iParam0)
	{
		case 1:
...
int func_269(int iParam0, var uParam1, var uParam2)//Position - 0x2563B
{
	int iVar0;
	int iVar1;
...
int func_270(int iParam0)//Position - 0x2582E
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_271(var uParam0)//Position - 0x2584E
{
	int iVar0;
...
int func_272(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x258FE
{
	char* sVar0;
...
void func_273(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x25A2D
{
	int iVar0;
	int iVar1;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && ENTITY::GET_ENTITY_MODEL(iParam0) == ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				uParam1->f_59 = func_138(2053, iParam3, 0);
			}
			else
			{
				uParam1->f_59 = func_138(753, iParam3, 0);
			}
			uParam1->f_60 = func_138(754, iParam3, 0);
			uParam1->f_61 = func_138(755, iParam3, 0);
		}
...
int func_274(int iParam0, int iParam1)//Position - 0x25BCD
{
	int iVar0;
	var uVar1;
	
	iVar0 = Global_2866852[iParam0 /*3*/][func_137(iParam1)];
...
void func_275(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x25BF9
{
	int iVar0;
...
void func_276(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x26141
{
	int iVar0;
...
int func_277()//Position - 0x26382
{
	func_17();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_278(int iParam0, bool bParam1)//Position - 0x2639B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_279(int iParam0, var uParam1)//Position - 0x2648E
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_281(Var7.f_1)) && iVar9 < 51)
			{
...
int func_280(int iParam0)//Position - 0x26716
{
	switch (iParam0)
	{
...
int func_281(int iParam0)//Position - 0x267B1
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_282(int iParam0, int iParam1)//Position - 0x26979
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_283(int iParam0, var* uParam1)//Position - 0x2751A
{
	int iVar0;
	int iVar1;
...
int func_284(int iParam0)//Position - 0x27555
{
	int iVar0;
...
void func_285(int iParam0)//Position - 0x277C9
{
	int iVar0;
...
void func_286(var uParam0, int iParam1)//Position - 0x27805
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_287(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x27D54
{
	int iVar0;
	int iVar1;
...
bool func_288(int iParam0, var uParam1, var uParam2)//Position - 0x27D98
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_289(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x2851C
{
	if (bParam2)
	{
...
int func_290(var uParam0)//Position - 0x28563
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_312())
		{
			*uParam0 = func_296(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 6, -1, 0, 1, -1);
...
bool func_291(int iParam0)//Position - 0x285BE
{
	return func_292(iParam0, 0, 1);
}

int func_292(int iParam0, int iParam1, bool bParam2)//Position - 0x285CE
{
	if (iParam0 == -1)
	{
		return 0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_294() == 0)
		{
			return BitTest(func_138(func_293(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_293(int iParam0)//Position - 0x2862F
{
	switch (iParam0)
	{
		case 0:
...
int func_294()//Position - 0x289AA
{
	return Global_31959;
}

int func_295(int iParam0)//Position - 0x289B5
{
	return func_292(iParam0, 5, 1);
}

int func_296(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x289C5
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 57)
	{
		if (iParam1 == 6 || iParam1 == func_311(iVar0))
		{
			if (!bParam3 || func_310(iVar0))
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_297(iVar0, 0), true);
...
Vector3 func_297(int iParam0, bool bParam1)//Position - 0x28A67
{
	switch (iParam0)
	{
		case -1:
		...
		case 45:
			return func_307(Global_102568);
			break;
		
		case 46:
			if (Global_1853185 != func_10())
			{
				if (func_306(Global_1853185))
				{
					return func_299(2, 2);
				}
				else if (func_298(Global_1853185))
				{
					return func_299(45, 3);
				}
				else
				{
...
int func_298(int iParam0)//Position - 0x2918C
{
	if (iParam0 != func_10())
	{
...
Vector3 func_299(int iParam0, int iParam1)//Position - 0x291E4
{
	struct<3> Var0;
	struct<3> Var1;
	...
	if (Global_1853185 != func_10())
	{
		if (iParam1 == 3)
		{
			if (func_300(iParam0, 1, &Var0, 0, 0))
			{
				Var1 = { Var0 };
			}
		}
		else if (iParam1 == 2)
		{
			...
			{
				if (func_300(iParam0, 2, &Var0, 0, 0))
				{
					Var1 = { Var0 };
				}
			}
...
int func_300(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2928E
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
	...
	if (!func_305(iParam3, &Var0))
	{
		return 0;
	}
	if (!func_305(iParam1, &Var1))
	{
		return 0;
	}
	if (!bParam4)
	{
		Var2 = { func_303(iParam0) };
	}
	else
	{
	...
	Var3 = { Var2 - Var0 };
	Var3 = { func_301(Var3, -Var0.f_3.f_2) };
	Var3 = { func_301(Var3, Var1.f_3.f_2) };
	*uParam2 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Var1, 0f, Var3) };
	uParam2->f_3 = { Var2.f_3 };
	return 1;
}

Vector3 func_301(struct<3> Param0, float fParam1)//Position - 0x29323
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_302(int iParam0)//Position - 0x29367
{
	struct<6> Var0;
...
struct<6> func_303(int iParam0)//Position - 0x294EB
{
	return func_304(iParam0);
}

struct<6> func_304(int iParam0)//Position - 0x294F9
{
	struct<6> Var0;
...
int func_305(int iParam0, var uParam1)//Position - 0x29FC0
{
	switch (iParam0)
	{
		case 0:
...
int func_306(int iParam0)//Position - 0x2A042
{
	if (iParam0 != func_10())
	{
...
Vector3 func_307(int iParam0)//Position - 0x2A09A
{
	switch (iParam0)
	{
		case 1:
...
int func_308()//Position - 0x2A2F6
{
	return func_309(PLAYER::PLAYER_ID());
}

int func_309(int iParam0)//Position - 0x2A306
{
	return MISC::GET_BITS_IN_RANGE(Global_2689235[iParam0 /*453*/].f_318.f_3, 28, 31);
}

int func_310(int iParam0)//Position - 0x2A323
{
	return func_292(iParam0, 0, 0);
}

int func_311(int iParam0)//Position - 0x2A333
{
	switch (iParam0)
	{
		case -1:
...
bool func_312()//Position - 0x2A642
{
	return Global_100493.f_375 > 0;
}

var func_313()//Position - 0x2A653
{
	var uVar0;
	
	func_323(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_322(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_321(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_316(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_315(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_314(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}

void func_314(var uParam0, int iParam1)//Position - 0x2A699
{
	if (iParam1 <= 0)
	{
		return;
...
void func_315(var uParam0, int iParam1)//Position - 0x2A71F
{
...
void func_316(var uParam0, int iParam1)//Position - 0x2A752
{
	int iVar0;
	int iVar1;
...
int func_317(int iParam0, int iParam1)//Position - 0x2A7A3
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_318(int iParam0)//Position - 0x2A845
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_319(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_319(bool bParam0, int iParam1, int iParam2)//Position - 0x2A867
{
	if (bParam0)
	{
		return iParam1;
...
int func_320(var uParam0)//Position - 0x2A87E
{
	return uParam0 & 15;
}

void func_321(var uParam0, int iParam1)//Position - 0x2A88B
{
...
void func_322(var uParam0, int iParam1)//Position - 0x2A8C5
{
...
void func_323(var uParam0, int iParam1)//Position - 0x2A900
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_324(char* sParam0)//Position - 0x2A93C
{
...
struct<2> func_325(int iParam0)//Position - 0x2A992
{
	struct<2> Var0;
...
int func_326(char* sParam0, int iParam1)//Position - 0x2ADDE
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_327(int iParam0, var uParam1)//Position - 0x2AE27
{
	switch (iParam0)
	{
		case 0:
...
void func_328(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0x2BFDC
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_329(int iParam0)//Position - 0x2C06F
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_330(int iParam0)//Position - 0x2C3B5
{
	struct<2> Var0;
	char[] cVar1[8];
	
	StringCopy(&Var0, "", 8);
	cVar1 = { func_325(iParam0) };
...
int func_331(int iParam0)//Position - 0x2C3EC
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_332(Global_113386.f_9085.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_332(Global_113386.f_9085.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_332(Global_113386.f_9085.f_99.f_205[11]);
			break;
		
		case 90:
			return func_332(Global_113386.f_9085.f_99.f_205[7]);
			break;
		
		case 93:
			return func_332(Global_113386.f_9085.f_99.f_205[9]);
			break;
	}
	return 0;
}

int func_332(int iParam0)//Position - 0x2C4A8
{
	switch (iParam0)
	{
		case 1:
...
int func_333(char* sParam0, bool bParam1)//Position - 0x2C4FC
{
	int iVar0;
	int iVar1;
...
int func_334(int iParam0, bool bParam1)//Position - 0x2C526
{
	int iVar0;
...
void func_335(bool bParam0)//Position - 0x2C55C
{
	int iVar0;
	int iVar1;
...
int func_336(struct<3> Param0, int iParam1, bool bParam2)//Position - 0x2C7DE
{
	int iVar0;
...
int func_338(int iParam0)//Position - 0x2C88A
{
...
int func_339(int iParam0)//Position - 0x2C8B7
{
	...
	switch (iLocal_296)
	{
		case 0:
			...
			if ((((func_49(iLocal_304) && func_42(iLocal_301[0])) && func_42(iLocal_301[1])) && func_42(iLocal_301[2])) && func_42(iLocal_299))
			{
				...
				iLocal_298 = func_392(iLocal_304, 0, 5);
				func_236("MEJ1_02", 7500, 1);
				func_235(&uLocal_336);
				func_391("MEJ1_WARN", -1);
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
			...
			iLocal_237 = 0;
			iLocal_261 = 1;
			func_390(&uLocal_331, &uLocal_333, &uLocal_330, &fLocal_332);
			fLocal_293 = 800f;
			fLocal_294 = 100f;
			PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.1f);
			STREAMING::REQUEST_ANIM_DICT("missfam3");
			func_254(1, "Rescue Jimmy", 0, 0, 0, 1);
			iLocal_296 = 1;
			break;
		...
		case 1:
			...
			func_384();
			func_382();
			func_381(iLocal_298, iLocal_299, fLocal_293, 1061158912, 0);
				...
				if (VEHICLE::IS_VEHICLE_STOPPED(iLocal_304))
				{
					...
					while (iVar2 < 3)
					{
						if (func_42(iLocal_301[iVar2]))
						{
							...
							else if (((iVar2 == 1 && !func_42(iLocal_301[0])) || ((iVar2 == 2 && !func_42(iLocal_301[0])) && !func_42(iLocal_301[1]))) && !func_351())
							{
								func_349(&uLocal_67, 6, iLocal_301[iVar2], "MEJimmyKidnapper2", 1, 1);
								func_28();
					...
					{
						if (func_226(PLAYER::PLAYER_PED_ID(), iLocal_299) > (5f + 1f))
						{
							iLocal_298 = func_245(iLocal_299, 1, 1, 5);
							func_236("MEJ1_07", 7500, 1);
							func_235(&uLocal_336);
							if (AUDIO::IS_AUDIO_SCENE_ACTIVE("M_E_JIMMY_STOP_KIDNAPPERS"))
							{
								AUDIO::STOP_AUDIO_SCENE("M_E_JIMMY_STOP_KIDNAPPERS");
					...
					{
						iLocal_298 = func_392(iLocal_304, 1, 5);
						func_236("MEJ1_03", 7500, 1);
						func_235(&uLocal_336);
						if (AUDIO::IS_AUDIO_SCENE_ACTIVE("M_E_JIMMY_STOP_KIDNAPPERS"))
						{
							AUDIO::STOP_AUDIO_SCENE("M_E_JIMMY_STOP_KIDNAPPERS");
		...
		case 3:
			...
			{
				if (iLocal_321 && func_226(PLAYER::PLAYER_PED_ID(), iLocal_299) > fLocal_294)
				{
					func_236("MEJ1_08", 7500, 1);
					func_235(&uLocal_336);
					iLocal_321 = 0;
				}
				if (bLocal_320)
				...
				else if (func_227(PLAYER::PLAYER_PED_ID(), iLocal_304, 1) < (5f - 1f))
				{
					iLocal_237 = 1;
					func_342();
				}
...
void func_344(var uParam0, int iParam1, bool bParam2)//Position - 0x2D178
{
	char* sVar0;
...
bool func_345(char* sParam0)//Position - 0x2D252
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_346(int iParam0, bool bParam1)//Position - 0x2D265
{
	char* sVar0;
	int iVar1;
	int iVar2;
	...
	if (func_42(iParam0))
	{
		...
		{
			func_347(iParam0, sVar0, "WAVELOAD_PAIN_MALE", 24);
		}
		else
		{
			func_347(iParam0, sVar0, "WAVELOAD_PAIN_FEMALE", 24);
		}
	}
}

void func_347(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2D2D6
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_348(iParam3), false);
}

int func_348(int iParam0)//Position - 0x2D2EF
{
	int iVar0;
...
void func_349(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2D4E4
{
...
int func_350(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, float fParam6)//Position - 0x2D57F
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_351()//Position - 0x2D630
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && func_49(iLocal_304))
	{
		iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
		if (func_49(iVar0))
		{
			iVar1 = ENTITY::GET_ENTITY_MODEL(iVar0);
			if ((((func_352(iVar1) || iVar1 == joaat("police4")) || iVar1 == joaat("policeold1")) || iVar1 == joaat("policeold2")) || iVar1 == joaat("fbi"))
			{
...
int func_352(int iParam0)//Position - 0x2D6CF
{
	switch (iParam0)
	{
		case joaat("police"):
...
void func_354(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x2D7A7
{
	func_355(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_355(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x2D7C1
{
	uParam0->f_6 = 0;
	func_356(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_356(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x2D7E3
{
	int iVar0;
	int iVar1;
	...
	{
		func_344(uParam0, iVar0, 0);
	}
}

void func_357(var uParam0)//Position - 0x2DB50
{
...
int func_358(var uParam0)//Position - 0x2DBB9
{
	int iVar0;
...
int func_359(bool bParam0)//Position - 0x2DBE4
{
	switch (Global_43052)
	{
		case 0:
...
int func_360(char* sParam0)//Position - 0x2DC8E
{
	if (!func_361(1, 1, 0))
	{
		if ((!MISC::IS_STRING_NULL_OR_EMPTY(sParam0) && func_345(sParam0)) || func_345("CMN_HINT"))
		{
			HUD::CLEAR_HELP(true);
		}
		return 0;
...
int func_361(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2DD27
{
	int iVar0;
	int iVar1;
	...
	if ((func_368() || func_367(Global_4718592.f_168757)) || func_366())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
			iVar1 = func_365(PLAYER::PLAYER_PED_ID(), 0);
			if (((VEHICLE::IS_TURRET_SEAT(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("riot2") && iVar1 == 0) && func_364(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_362(int iParam0)//Position - 0x2DF80
{
	if (iParam0 != func_10())
	{
		if (func_363(iParam0, 1, 1))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
		else if ((Global_1575058 && iParam0 == PLAYER::PLAYER_ID()) && func_363(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
int func_363(int iParam0, bool bParam1, bool bParam2)//Position - 0x2DFE6
{
	int iVar0;
...
int func_364(int iParam0, int iParam1)//Position - 0x2E046
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_365(int iParam0, bool bParam1)//Position - 0x2E0A8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_366()//Position - 0x2E12D
{
	return Global_2714762.f_19;
}

bool func_367(int iParam0)//Position - 0x2E13B
{
	return iParam0 == 51;
}

var func_368()//Position - 0x2E148
{
	return Global_2714762.f_18;
}

bool func_369()//Position - 0x2E156
{
	return MISC::GET_GAME_TIMER() <= Global_23150.f_6269 + 100;
}

int func_370(int iParam0)//Position - 0x2E16B
{
	if (iParam0 == 1)
	{
		if (Global_20266.f_1 > 3)
...
void func_371(var uParam0, int iParam1, struct<3> Param2, int iParam3)//Position - 0x2E1C2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_372()//Position - 0x2E2D2
{
	return func_373(PLAYER::PLAYER_ID());
}

int func_373(int iParam0)//Position - 0x2E2E2
{
...
int func_374(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x2E301
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_375(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2E66D
{
	if (!func_361(bParam0, bParam1, bParam2))
	{
		return 0;
	}
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
int func_376(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2E6BF
{
	if (!func_361(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_377(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2E708
{
	if (!func_361(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_378(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2E767
{
	if (!func_361(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_379(int iParam0)//Position - 0x2E7BD
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_380()//Position - 0x2E818
{
	MISC::SET_BIT(&Global_8137, 4);
}

void func_381(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)//Position - 0x2E828
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_382()//Position - 0x2E981
{
	if (iLocal_256 > 0 && MISC::GET_GAME_TIMER() > iLocal_256)
	{
		if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_299))
		{
			if ((func_226(PLAYER::PLAYER_PED_ID(), iLocal_299) < 50f && !func_27()) && !func_383("MEJ1_02", 0, 0))
			{
				if (iLocal_259)
				{
...
bool func_383(char* sParam0, int iParam1, char* sParam2)//Position - 0x2EA2C
{
...
void func_384()//Position - 0x2EA4A
{
	...
	if ((func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_301[0])) && func_49(iLocal_304))
	{
		if (iLocal_254 == -1 && iLocal_255 == -1)
		{
			...
			else if (func_226(PLAYER::PLAYER_PED_ID(), iLocal_301[0]) < 50f && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_304))
			{
		...
		else if (iLocal_260)
		{
			if (!func_27())
			{
				if (func_385(&uLocal_67, 14, "MEJ1AUD", "MEJ1_DAD", 7, 0, 0, 1))
				{
					iLocal_260 = 0;
				}
			}
		}
		else if (((iLocal_254 < 8 && func_226(PLAYER::PLAYER_PED_ID(), iLocal_301[0]) < 50f) && !func_27()) && !func_383("MEJ1_02", 0, 0))
		{
...
bool func_385(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)//Position - 0x2EC95
{
...
void func_386()//Position - 0x2ECE3
{
	...
	if (STREAMING::HAS_ANIM_DICT_LOADED("missfam3"))
	{
		if (MISC::GET_GAME_TIMER() > iLocal_265)
		{
			...
			if (func_389(PLAYER::PLAYER_PED_ID(), Var0, 20f, 1))
			{
...
int func_388(int iParam0, int iParam1)//Position - 0x2EE5E
{
...
bool func_389(int iParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x2EED0
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), Param1) <= (fParam2 * fParam2);
}

void func_390(var uParam0, var uParam1, var uParam2, float fParam3)//Position - 0x2EEEE
{
	*uParam0 = 0;
	*uParam1 = 0;
	*uParam2 = 0;
...
void func_391(char* sParam0, int iParam1)//Position - 0x2EF06
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

int func_392(int iParam0, bool bParam1, int iParam2)//Position - 0x2EF1D
{
	int iVar0;
...
void func_393()//Position - 0x2EF52
{
	...
	switch (iLocal_296)
	{
		...
		case 2:
			...
			{
				if (func_389(PLAYER::PLAYER_PED_ID(), Local_290, 150f, 1) || func_385(&uLocal_67, 14, "MEJ1AUD", "MEJ1_CLOSE", 7, 0, 0, 1))
				{
					iLocal_296 = 3;
				}
			}
	...
	if (func_49(iLocal_304))
	{
		...
		while (iVar0 < 3)
		{
			if (!func_42(iLocal_301[iVar0]))
			{
				if (STREAMING::HAS_MODEL_LOADED(iLocal_303))
				{
					...
					if (iVar0 == 0)
					{
						func_349(&uLocal_67, 5, iLocal_301[iVar0], "MEJimmyKidnapper", 1, 1);
					}
				}
			}
			iVar0++;
		...
		if (!func_42(iLocal_299))
		{
			if (STREAMING::HAS_MODEL_LOADED(func_52(14)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_232))
			{
				...
				func_349(&uLocal_67, 3, iLocal_299, "JIMMY", 1, 1);
...
bool func_399(int iParam0)//Position - 0x2F584
{
	if (iParam0 == 0)
	{
		return 1;
...
void func_400(int* iParam0, struct<3> Param1, float fParam2)//Position - 0x2F5A2
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_401()//Position - 0x2F5CB
{
	...
	if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		if (func_42(PLAYER::PLAYER_PED_ID()))
		{
			func_349(&uLocal_67, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 1, 1);
		}
		func_349(&uLocal_67, 4, 0, "JIMMY", 0, 1);
		if (func_42(PLAYER::PLAYER_PED_ID()))
		{
		...
		if (func_66(0) && func_42(PLAYER::PLAYER_PED_ID()))
		{
			...
			func_439(&iVar0, Var1, fVar2, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
		}
		if (func_397())
		{
			iVar3 = func_438();
			...
			{
				case 0:
					func_420(&iVar4, 1, 1, 1, 1, iLocal_335, 0, 145);
					if (func_389(iVar4, -811.3438f, 187.4367f, 71.47861f, 6f, 1))
					{
				...
				case 3:
					func_402(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1112014848, 12, 5000, 0, 0);
...
void func_402(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x2F94A
{
	int iVar0;
	int iVar1;
...
void func_403()//Position - 0x2F9BA
{
	Global_23011.f_6 = 1;
}

void func_404(int iParam0)//Position - 0x2F9C8
{
	if (func_408())
	{
		return;
...
void func_405(int iParam0)//Position - 0x2F9FB
{
	if (func_408())
	{
		return;
...
void func_406(bool bParam0, bool bParam1)//Position - 0x2FA85
{
	if (bParam0)
	{
		if (func_370(0))
...
bool func_407()//Position - 0x2FAF9
{
	return BitTest(Global_1958711, 5);
}

bool func_408()//Position - 0x2FB07
{
	return BitTest(Global_1958711, 19);
}

void func_409(int iParam0, int iParam1, int iParam2)//Position - 0x2FB16
{
...
void func_410(bool bParam0)//Position - 0x2FB4A
{
	...
	if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_299))
	{
		...
		if (bParam0)
		{
			if ((func_49(iLocal_304) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_304, -1, false)) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_304, 0, false))
			{
		...
		else
		{
			Var2 = { func_412() };
			func_411(&Var2, &fVar3);
			func_439(&iVar1, Var2, fVar3, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
			if ((func_49(iVar1) && VEHICLE::IS_VEHICLE_SEAT_FREE(iVar1, 0, false)) && func_42(iLocal_299))
			{
...
Vector3 func_412()//Position - 0x2FDCE
{
...
void func_417(bool bParam0, int iParam1, int iParam2)//Position - 0x2FF2A
{
	bool bVar0;
...
void func_418()//Position - 0x2FF89
{
	...
	if (func_42(PLAYER::PLAYER_PED_ID()))
	{
		func_46(1, 0);
		func_398();
		func_439(&iVar0, -2086.913f, 951.6347f, 183.7526f, 75.8f, 1, 1, 0, 1, 1, iLocal_335, 0, 145, 1);
		if (func_49(iVar0))
		{
...
void func_419()//Position - 0x3008A
{
	int iVar0;
	int iVar1;
...
void func_420(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x300C1
{
	struct<3> Var0;
	float fVar1;
	...
	if (func_437() && func_421(iParam1, iParam2, iParam3, 1))
	{
		Var0 = { 0f, 0f, 0f };
		fVar1 = 0f;
		func_439(iParam0, Var0, fVar1, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
	}
...
int func_421(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x30152
{
	...
	if (iParam2 == 0 && func_352(Global_106934.f_2890.f_12.f_66))
	{
		return 0;
	}
...
bool func_423()//Position - 0x30255
{
	return func_424(&(Global_106934.f_2890));
}

int func_424(var uParam0)//Position - 0x30268
{
	if (uParam0->f_12.f_66 == 0)
	{
		return 0;
	}
	if (!func_426(uParam0->f_12.f_66, 0))
	{
		return 0;
	}
	if (uParam0->f_12.f_66 == joaat("stunt") && func_425(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
int func_425(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x302C7
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_426(int iParam0, bool bParam1)//Position - 0x30342
{
	int iVar0;
	struct<2> Var1;
	...
	{
		if ((((!func_435() && !func_434()) && !func_433()) && !func_432()) && !func_436())
		{
			return 0;
		}
	}
	...
	{
		if ((func_431() || MISC::IS_PC_VERSION()) || func_430())
		{
		}
		else if (!func_433())
		{
...
int func_427(int iParam0)//Position - 0x304C2
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_429(int iParam0)//Position - 0x305A5
{
	int iVar0;
	int iVar1;
...
bool func_430()//Position - 0x33876
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_431()//Position - 0x3388C
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_432()//Position - 0x338A2
{
	return 0;
}

int func_433()//Position - 0x338AB
{
	return 1;
}

int func_434()//Position - 0x338B4
{
	return 1;
}

int func_435()//Position - 0x338BD
{
...
var func_437()//Position - 0x3398E
{
	return Global_103950.f_2890.f_8;
}

int func_438()//Position - 0x3399F
{
	if (!Global_100441 == 10 && !Global_100441 == 9)
	{
		return 0;
...
void func_439(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x339C9
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_397() || !func_423())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	{
		if (!func_421(iParam4, iParam5, iParam6, iParam11))
		{
			iVar0 = 0;
		}
	}
	...
	else if (iParam7 == 1)
	{
		...
		{
			func_491(iParam10, 0);
			while (!func_440(iParam0, iParam10, Param1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_440(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)//Position - 0x33B5D
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
...
void func_441(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x34980
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_18(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_445(*iParam1, 0, &uVar0))
		{
			func_269(iParam1, &(Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_113386.f_20118[iParam0 /*43*/].f_31 = func_444(*iParam1);
				...
				func_442(Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_113386.f_20118[iParam0 /*43*/].f_1));
				...
				func_442(Global_113386.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_113386.f_20118[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_442(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x35594
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_443(iVar0, &sVar2, &iVar1, &iVar3, &iVar4))
	{
...
bool func_443(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x35607
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_444(int iParam0)//Position - 0x36AF9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_445(int iParam0, bool bParam1, var uParam2)//Position - 0x36BA9
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_473(iVar0, bParam1, uParam2) && !func_472(PLAYER::PLAYER_ID())) && !func_454(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_452(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_450(iParam0)) && !bVar1) && !(func_449(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_447(PLAYER::PLAYER_ID())))
	{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_446(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_446(int iParam0)//Position - 0x36D17
{
	int iVar0;
...
int func_447(int iParam0)//Position - 0x36D52
{
	if (iParam0 != func_10())
	{
		if (func_363(iParam0, 1, 1))
		{
			...
			{
				return func_448(Global_2689235[iParam0 /*453*/].f_318.f_6) == 11;
			}
		}
	}
	return 0;
...
int func_448(int iParam0)//Position - 0x36D99
{
	switch (iParam0)
	{
		case 0:
...
int func_449(int iParam0)//Position - 0x37220
{
...
int func_450(int iParam0)//Position - 0x37262
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_451(int iParam0)//Position - 0x37305
{
	if (iParam0 != func_10())
	{
		if (func_363(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1)
			{
				return func_448(Global_2689235[iParam0 /*453*/].f_318.f_6) == 13;
			}
		}
	}
	return 0;
...
int func_452(int iParam0)//Position - 0x3734C
{
	if (iParam0 != func_10())
	{
		if (func_363(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1)
			{
				return func_448(Global_2689235[iParam0 /*453*/].f_318.f_6) == 7;
			}
		}
	}
	return 0;
...
int func_453(int iParam0)//Position - 0x37392
{
	return 1;
}

int func_454(int iParam0)//Position - 0x3739B
{
...
int func_455(int iParam0)//Position - 0x373CA
{
...
int func_456(int iParam0)//Position - 0x3743A
{
	int iVar0;
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_450(iParam0)) || func_457(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_457(int iParam0)//Position - 0x374BD
{
	switch (iParam0)
	{
		case joaat("mule"):
...
int func_458(int iParam0, bool bParam1)//Position - 0x3750D
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_460(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				...
				else if (func_459(iParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_459(int iParam0)//Position - 0x37568
{
	int iVar0;
...
int func_460(int iParam0, int iParam1)//Position - 0x375A1
{
	if (iParam1 == 0)
	{
...
int func_470(int iParam0)//Position - 0x37E87
{
	if (iParam0 != func_10())
	{
		if (func_363(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1 && Global_2689235[iParam0 /*453*/].f_318.f_9 != func_10())
			{
				return func_448(Global_2689235[iParam0 /*453*/].f_318.f_6) == 5;
			}
		}
	}
	return 0;
...
int func_471(int iParam0)//Position - 0x37EE6
{
	if (iParam0 != func_10())
	{
		if (func_363(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1 && Global_2689235[iParam0 /*453*/].f_318.f_9 != func_10())
			{
				return func_448(Global_2689235[iParam0 /*453*/].f_318.f_6) == 8;
			}
		}
	}
	return 0;
...
int func_472(int iParam0)//Position - 0x37F46
{
	if (iParam0 != func_10())
	{
		if (func_363(iParam0, 1, 1))
		{
			if (Global_2689235[iParam0 /*453*/].f_318.f_6 != -1)
			{
				return func_448(Global_2689235[iParam0 /*453*/].f_318.f_6) == 9;
			}
		}
	}
	return 0;
...
int func_473(int iParam0, bool bParam1, var uParam2)//Position - 0x37F8D
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_452(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_474(int iParam0)//Position - 0x383DE
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_475(int iParam0, int iParam1)//Position - 0x38407
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_267(iParam0, &(Global_113386.f_32749.f_5510));
}

int func_476(int iParam0)//Position - 0x38609
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_216(iParam0, 0, 0)) || func_216(iParam0, 1, 0)) || func_216(iParam0, 2, 0)) || func_263(iParam0) != 145) || func_480(iParam0)) || func_479(iParam0)) || func_446(iParam0)) || func_478(iParam0)) || !func_477(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_479(iParam0))
		{
		}
...
int func_477(int iParam0)//Position - 0x386E6
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_478(int iParam0)//Position - 0x38897
{
	int iVar0;
	char* sVar1;
...
int func_479(int iParam0)//Position - 0x388DD
{
	int iVar0;
...
int func_480(int iParam0)//Position - 0x38959
{
	int iVar0;
...
void func_481(int iParam0, int iParam1)//Position - 0x38A41
{
	int iVar0;
...
void func_482(int iParam0)//Position - 0x38AC3
{
	if (!func_483(*iParam0))
	{
...
bool func_483(int iParam0)//Position - 0x38AEE
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_484(int iParam0, var uParam1, var uParam2)//Position - 0x38AFD
{
	int iVar0;
	int iVar1;
	...
	if (func_469(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_487(*iParam0, ((*uParam1)[38] - 1)))
	{
...
int func_485(int iParam0)//Position - 0x38CD7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_486(var uParam0)//Position - 0x38DB3
{
...
int func_487(int iParam0, int iParam1)//Position - 0x38E0A
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_489()//Position - 0x38F13
{
	return 0;
}

int func_490(var uParam0, int iParam1)//Position - 0x38F1C
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_491(int iParam0, int iParam1)//Position - 0x38F5D
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97772[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_97772[iVar0]) == func_265(iParam0, iParam1))
				{
...
void func_492(struct<3> Param0, float fParam1, bool bParam2)//Position - 0x38FFB
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_500(&(Global_77137.f_555[0 /*21*/]), iVar0))
		{
...
void func_493(int iParam0)//Position - 0x3904B
{
	bool bVar0;
	...
	if (func_500(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_499(iParam0, 0)) && Global_78046.f_66 == 0) && Global_113386.f_32749.f_1958[Global_77137.f_555[0 /*21*/].f_14] != 0) && Global_113386.f_32749.f_1958[Global_77137.f_555[0 /*21*/].f_14] > 3) && (!func_497(0, Global_77137.f_555[0 /*21*/].f_12) || !func_497(1, Global_77137.f_555[0 /*21*/].f_12)))
			{
				func_496(&(Global_113386.f_32749.f_69[Global_77137.f_555[0 /*21*/].f_14 /*78*/]), &Global_78046);
...
void func_494(int iParam0, bool bParam1)//Position - 0x391BA
{
	if (iParam0 == -1)
	{
		return;
...
void func_495(int iParam0, int iParam1, bool bParam2)//Position - 0x39217
{
	if (iParam0 == -1)
	{
		return;
...
void func_496(var uParam0, var uParam1)//Position - 0x39252
{
...
int func_497(int iParam0, int iParam1)//Position - 0x3931E
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_498(&(Global_113386.f_32749.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_426(Global_113386.f_32749.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}

int func_498(var uParam0)//Position - 0x39390
{
	return *uParam0;
}

int func_499(int iParam0, int iParam1)//Position - 0x3939B
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_500(var uParam0, int iParam1)//Position - 0x393BB
{
	int iVar0;
	int iVar1;
...
int func_501(struct<3> Param0, float fParam1)//Position - 0x3AAA9
{
	return func_502(&(Global_106934.f_2890), Param0, fParam1, 0);
}

int func_502(var uParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x3AAC3
{
	int iVar0;
	struct<3> Var1;
	bool bVar2;
...
int func_503(int iParam0)//Position - 0x3AD75
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_504(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x3AE38
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_505(iParam0, uVar1[iVar3], 1) && func_425(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_289(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_505(int iParam0, int iParam1, bool bParam2)//Position - 0x3B040
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_506(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x3B0A1
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		{
			iVar0 = 1;
			if (BitTest(uParam1->f_77, func_268(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (BitTest(uParam1->f_77, func_268(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_268(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				if (BitTest(uParam1->f_77, func_268(iVar2)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_268(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				if (BitTest(uParam1->f_77, func_268(iVar3)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_268(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (BitTest(uParam1->f_77, func_268(iVar4)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_77), func_268(iVar4));
					}
				}
				iVar4++;
			}
		...
		{
			if (BitTest(uParam1->f_77, func_268(4)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_268(4));
			}
		}
		...
		{
			MISC::SET_BIT(&(uParam1->f_77), func_268(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar5 <= 2)
			{
				if (BitTest(uParam1->f_77, func_268(iVar5)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_268(iVar5));
				}
				iVar5++;
			}
		}
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar6 <= 11)
			{
				if (BitTest(uParam1->f_77, func_268(iVar6 + 1)))
				{
...
int func_508(var uParam0)//Position - 0x3B7D7
{
	int iVar0;
...
int func_509(int iParam0)//Position - 0x3B7FB
{
	int iVar0;
...
bool func_510(int iParam0)//Position - 0x3B819
{
	return func_511(&(Global_2703735.f_169), iParam0);
}

var func_511(var uParam0, var uParam1)//Position - 0x3B82D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_512(int iParam0, int iParam1)//Position - 0x3B850
{
	int iVar0;
	bool bVar1;
...
bool func_513()//Position - 0x3B8C8
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

int func_514(int iParam0)//Position - 0x3B8D9
{
	int iVar0;
...
int func_515(int iParam0)//Position - 0x3B921
{
	if (!func_489() && func_516(iParam0))
	{
		return 1;
	}
	return 0;
...
int func_516(int iParam0)//Position - 0x3B941
{
	switch (iParam0)
	{
		case 161:
...
int func_517(int iParam0)//Position - 0x3B994
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
...
int func_518(int iParam0)//Position - 0x3BA1B
{
...
int func_519(int iParam0)//Position - 0x3BA4A
{
...
int func_520(int iParam0)//Position - 0x3BA67
{
...
int func_521(int iParam0, int iParam1)//Position - 0x3BA8A
{
...
int func_522(int iParam0)//Position - 0x3BAC5
{
	if (func_521(iParam0, 0))
	{
...
int func_523(int iParam0, int iParam1)//Position - 0x3BAE8
{
	int iVar0;
...
int func_524(var uParam0)//Position - 0x3BB35
{
	if (func_424(uParam0))
	{
...
bool func_525()//Position - 0x3BB6A
{
	return func_524(&(Global_106934.f_2890));
}

void func_526()//Position - 0x3BB7D
{
	func_527(&(Global_106934.f_2890));
}

void func_527(var uParam0)//Position - 0x3BB90
{
	if (func_424(uParam0))
	{
...
void func_528(bool bParam0)//Position - 0x3BBAE
{
	if (bParam0)
	{
