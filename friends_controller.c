...
void __EntryFunction__()//Position - 0x0
{
	...
	while (iVar0 < 9)
	{
		if (Global_97519[iVar0 /*2*/] == -1)
		{
			if (BitTest(Global_114135.f_18107.f_175[iVar0 /*19*/].f_18, 1))
			{
				func_472(iVar0, 0);
				Global_97398++;
			}
	...
	while (iLocal_93)
	{
		...
		else
		{
			...
			{
				if (func_470(iLocal_95, &iVar1))
				{
					func_421(iLocal_95, iVar1);
				}
				...
				if (!Global_114135.f_18107.f_398)
				{
					...
					{
						switch (func_419("AM_H_NOFRND" /* GXT: Friends will not always be available to Hang Out when you call. They may have things to do or could even be asleep. */))
						{
							case 2:
								func_418("AM_H_NOFRND" /* GXT: Friends will not always be available to Hang Out when you call. They may have things to do or could even be asleep. */, 2, 0, 1000, 7500, 7, 0, 0, 0);
								break;
				...
				{
					if (!SCRIPT::IS_THREAD_ACTIVE(Global_114135.f_18107.f_395))
					{
...
void func_2(var uParam0, var uParam1)//Position - 0x2CB
{
	...
	if (func_408() || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		if (uParam0->f_49 == 0)
		{
			if (func_407(Global_99141.f_45) && !PED::IS_PED_INJURED((uParam0[Global_99141.f_45 /*15*/])->f_2))
			{
				TASK::CLEAR_PED_TASKS((uParam0[Global_99141.f_45 /*15*/])->f_2);
			}
			func_406(uParam0);
			func_405(uParam0, 0);
			iVar0 = 0;
...
void func_6(var uParam0)//Position - 0x721
{
	...
	func_22(Global_97397, uParam0->f_74, &sVar41, &cVar57);
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
int func_16(var uParam0)//Position - 0xB6B
{
	int iVar0;
...
int func_17(int iParam0)//Position - 0xB8D
{
...
int func_19(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xBDA
{
	int iVar0;
...
void func_22(int iParam0, int iParam1, char* sParam2, char* sParam3)//Position - 0xC57
{
	if (iParam0 == 0)
	{
		if (iParam1 == 1)
...
void func_24(int iParam0, int iParam1, int iParam2)//Position - 0xDA2
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar2 != 10)
	{
		func_25(&(Global_114135.f_18107.f_175[iVar2 /*19*/].f_5));
		Global_114135.f_18107.f_175[iVar2 /*19*/].f_8 = iParam2;
	}
}

void func_25(int* iParam0)//Position - 0xDEF
{
	func_26(iParam0, 0f);
}

void func_26(int* iParam0, float fParam1)//Position - 0xDFE
{
...
int func_29(int iParam0)//Position - 0x100B
{
	if (iParam0 == 145)
	{
		return 7;
...
var func_30(int iParam0)//Position - 0x1063
{
...
void func_32(var uParam0, var uParam1)//Position - 0x1096
{
	...
	switch (uParam0->f_50)
	{
		...
		case 2:
			if (func_90(uParam0, uParam1, Global_97397, uParam0->f_51, 31, 0))
			{
				func_92(uParam0, 3);
				uParam0->f_47 = 1;
			}
		...
		case 4:
			if (uParam0->f_47 || func_90(uParam0, uParam1, Global_97397, uParam0->f_51, 11, 1))
			{
				func_92(uParam0, 5);
				uParam0->f_47 = 1;
			}
		...
		case 6:
			if (uParam0->f_47 || func_90(uParam0, uParam1, Global_97397, uParam0->f_51, 13, 1))
			{
				func_92(uParam0, 7);
				uParam0->f_47 = 1;
			}
		...
		case 13:
			if (func_90(uParam0, uParam1, uParam0->f_51, Global_97397, 21, 1))
			{
				func_3(uParam0, uParam0[uParam0->f_51 /*15*/]);
			}
			break;
		...
		case 15:
			func_68(uParam0);
			if ((uParam0->f_47 || uParam0->f_48) || func_90(uParam0, uParam1, Global_97397, uParam0->f_51, func_66(uParam0, 0), 1))
			{
				func_92(uParam0, 16);
				uParam0->f_47 = 1;
			}
		...
		case 14:
			...
			{
				if ((uParam0->f_47 || uParam0->f_48) || func_90(uParam0, uParam1, uParam0->f_51, Global_97397, func_66(uParam0, 0), 1))
				{
					func_92(uParam0, 16);
					uParam0->f_47 = 1;
				}
			}
			else if ((uParam0->f_47 || uParam0->f_48) || func_90(uParam0, uParam1, Global_97397, uParam0->f_51, func_66(uParam0, 1), 1))
			{
				func_92(uParam0, 16);
				uParam0->f_47 = 1;
			}
		...
		case 16:
			func_68(uParam0);
			if (uParam0->f_48 || func_90(uParam0, uParam1, Global_97397, uParam0->f_51, 16, 1))
			{
		...
		case 18:
			if (func_90(uParam0, uParam1, Global_97397, uParam0->f_51, 19, 1))
			{
				func_92(uParam0, 19);
			}
			func_68(uParam0);
		...
		case 19:
			if (func_90(uParam0, uParam1, Global_97397, uParam0->f_51, 20, 1))
			{
				func_3(uParam0, uParam0[uParam0->f_51 /*15*/]);
				func_55(uParam0);
			}
		...
		case 20:
			func_68(uParam0);
			if (func_90(uParam0, uParam1, Global_97397, uParam0->f_51, 17, 1))
			{
				func_92(uParam0, 21);
			}
			break;
		...
		case 21:
			func_68(uParam0);
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) || func_90(uParam0, uParam1, Global_97397, uParam0->f_51, 18, 1))
			{
				func_92(uParam0, 22);
			}
			break;
		...
		case 22:
			func_68(uParam0);
			if (func_54(Global_97397, uParam0->f_51, &iVar0) && func_53(iVar0) == 0)
			{
				func_472(iVar0, 3);
				func_52(iVar0, 3);
				uParam0->f_48 = 1;
		...
		case 23:
			func_68(uParam0);
			if (!func_54(Global_97397, uParam0->f_51, &iVar0) || (func_53(iVar0) != 3 && func_53(iVar0) != 4))
			{
				func_3(uParam0, uParam0[uParam0->f_51 /*15*/]);
			}
			break;
		...
		case 25:
			if (uParam0->f_47 || func_90(uParam0, uParam1, Global_97397, uParam0->f_51, func_66(uParam0, 0), 1))
			{
				func_92(uParam0, 26);
				uParam0->f_47 = 1;
			}
		...
		case 24:
			if (!func_65(uParam0[uParam0->f_51 /*15*/]))
			{
				if (uParam0->f_47 || func_90(uParam0, uParam1, uParam0->f_51, Global_97397, func_66(uParam0, 0), 1))
				{
					func_92(uParam0, 26);
					uParam0->f_47 = 1;
				}
			}
			else if (uParam0->f_47 || func_90(uParam0, uParam1, Global_97397, uParam0->f_51, func_66(uParam0, 1), 1))
			{
				func_92(uParam0, 26);
				uParam0->f_47 = 1;
			}
		...
		case 26:
			if (func_90(uParam0, uParam1, Global_97397, uParam0->f_51, 14, 1))
			{
				func_92(uParam0, 27);
			}
			break;
		...
		case 27:
			if (func_90(uParam0, uParam1, uParam0->f_51, Global_97397, 20, 1))
			{
				func_40(uParam0);
			}
			break;
		...
		case 30:
			if (func_90(uParam0, uParam1, Global_97397, uParam0->f_51, 15, 1))
			{
				func_92(uParam0, 31);
			}
			break;
...
int func_37(int iParam0)//Position - 0x19D9
{
	if (iParam0 == 1)
	{
...
int func_41(var uParam0)//Position - 0x1ACF
{
	...
	if (func_54(Global_97397, uParam0->f_1, &iVar0))
	{
		...
		{
			if (!BitTest(Global_114135.f_18107.f_410, 0))
			{
				return 4;
			}
			else
		...
		{
			if (!BitTest(Global_114135.f_18107.f_410, 1))
			{
				return 6;
			}
			else
		...
		{
			if (!BitTest(Global_114135.f_18107.f_410, 2))
			{
				return 10;
			}
			else
		...
		{
			if (!BitTest(Global_114135.f_18107.f_410, 3))
			{
				return 8;
			}
			else
...
int func_42(var uParam0)//Position - 0x1C64
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if ((((Global_97509 == 0 || BitTest(Global_97511, uParam0->f_1)) && !func_49(Global_97397, uParam0->f_1, 1)) && !func_49(Global_97397, uParam0->f_1, 2)) && Global_114135.f_7692.f_919[Global_97397] != 5)
	{
		if (func_54(Global_97397, uParam0->f_1, &iVar0))
		{
			iVar2 = func_45(&iVar1);
			if (iVar1 != iVar0)
			{
				...
				else if (iVar2 == 1)
				{
					...
					{
						if (Global_114135.f_18107.f_175[iVar3 /*19*/].f_2 == 0)
						{
							return 1;
						}
					}
...
int func_43(int iParam0, int iParam1, var uParam2)//Position - 0x1D26
{
	int iVar0;
	int iVar1;
	...
	{
		iVar0 = Global_114135.f_18107.f_175[iParam0 /*19*/].f_1;
		iVar1 = Global_114135.f_18107.f_175[iParam1 /*19*/].f_1;
	}
	else if (Global_114135.f_18107.f_175[iParam0 /*19*/].f_1 == Global_114135.f_18107.f_175[iParam1 /*19*/].f_1)
	{
		iVar0 = Global_114135.f_18107.f_175[iParam0 /*19*/];
		iVar1 = Global_114135.f_18107.f_175[iParam1 /*19*/];
	}
...
int func_44(int iParam0)//Position - 0x1E73
{
	switch (iParam0)
	{
		case 0:
...
int func_45(var uParam0)//Position - 0x1ED5
{
	...
	*uParam0 = 10;
	...
	while (iVar1 < 9)
	{
		if (Global_97519[iVar1 /*2*/] == 3 || Global_97519[iVar1 /*2*/] == 4)
		{
			if (*uParam0 == 10)
			{
				*uParam0 = iVar1;
...
int func_48(int iParam0, int iParam1)//Position - 0x215A
{
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x21B1
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	return BitTest(Global_114135.f_18107.f_175[iVar2 /*19*/].f_2, iParam2);
}

int func_50(int iParam0)//Position - 0x21F0
{
...
int func_51(int iParam0)//Position - 0x221D
{
...
int func_54(int iParam0, int iParam1, int iParam2)//Position - 0x2285
{
	int iVar0;
	int iVar1;
...
bool func_56(int iParam0, int iParam1)//Position - 0x2336
{
	int iVar0;
	bool bVar1;
...
int func_58(int iParam0, bool bParam1)//Position - 0x2426
{
	int iVar0;
...
void func_59(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x24DE
{
	int iVar0;
...
void func_60(var uParam0)//Position - 0x2609
{
	int iVar0;
...
int func_61(var uParam0, float fParam1)//Position - 0x2660
{
	if (func_63(uParam0))
	{
...
int func_65(var uParam0)//Position - 0x270F
{
	if (func_47(1))
	{
		if (Global_97397 == 0 && uParam0->f_1 == 2)
		{
			return 1;
		}
		if (Global_97397 == 2 && uParam0->f_1 == 0)
		{
			return 1;
		}
	}
...
int func_67(var uParam0)//Position - 0x277E
{
	int iVar0;
	
	iVar0 = func_93(Global_97397, uParam0->f_1);
	if (iVar0 == 1 || iVar0 == 2)
	{
...
int func_70(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2898
{
	char* sVar0;
	char[] cVar4[8];
	...
	if (uParam0->f_52)
	{
		...
		{
			MISC::SET_BIT(&(Global_114135.f_18107.f_410), iParam5);
			uParam0->f_52 = 0;
		}
	}
	else if (!func_71())
...
bool func_72(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2914
{
...
int func_73(char* sParam0, int iParam1, bool bParam2)//Position - 0x2962
{
	Global_22426 = 0;
...
var func_77(int iParam0, int iParam1)//Position - 0x2CDA
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_78()//Position - 0x2CF2
{
	return -1;
}
...
void func_86(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2FE4
{
...
int func_87(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4)//Position - 0x303A
{
	int iVar0;
	int iVar1;
...
int func_90(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x31FF
{
	char* sVar0;
	char[] cVar4[8];
...
int func_91(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4)//Position - 0x3259
{
	int iVar0;
	int iVar1;
...
int func_93(int iParam0, int iParam1)//Position - 0x3777
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar2 < 9)
	{
		return Global_114135.f_18107.f_175[iVar2 /*19*/].f_8;
	}
	return 1;
}

float func_94(int iParam0, int iParam1)//Position - 0x37B6
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar2 < 9)
	{
		if (func_63(&(Global_114135.f_18107.f_175[iVar2 /*19*/].f_5)))
		{
			return func_62(&(Global_114135.f_18107.f_175[iVar2 /*19*/].f_5));
		}
	}
	return 0f;
}
...
int func_96()//Position - 0x38A3
{
	if (((((((PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || Global_113182) || func_99()) || func_84(8, -1)) || func_98()) || func_97()) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
	{
		return 0;
	}
	return 1;
		...
		if (PED::IS_PED_INJURED(uParam1->f_2))
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam1->f_2) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (SYSTEM::VDIST2(Var3, Var6) < 150f)
				{
					...
					if (iVar9 < 6)
					{
						func_370("FR_X_INJ_1m" /* GXT: ~a~ was injured. */, &(Global_2201[uParam1->f_1 /*29*/].f_3), 3, 0, 20000, 10000, 7, 0, 0, 0);
					}
				}
			}
			iVar10 = func_29(uParam1->f_1);
			iVar11 = func_369(iVar10);
			func_367(iVar10, iVar11);
			if (!func_366(uParam1, 0))
			{
				if (iVar11 != -1)
				{
					iVar12 = func_364(uParam1->f_2);
					if (iVar12 != 0)
					{
						if (!func_363(iVar11) || func_351(iVar11) == 6)
						{
							func_290(Global_97397, uParam1->f_1, 2, 0, iVar12, iVar11, -1);
						}
					}
				}
			}
...
int func_103(var uParam0, var uParam1)//Position - 0x41E2
{
	...
	func_22(Global_97397, uParam1->f_1, &sVar40, &cVar56);
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x480A
{
	...
	if (iParam5 == 0)
	{
		Global_79322[1 /*14*/] = { func_161(iVar10, iParam1, iParam2, -1) };
		if (!func_160(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_79322[1 /*14*/] = { func_161(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_79322[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_79322[1 /*14*/] = { func_161(iVar10, 14, uVar28[iVar1], -1) };
							func_129(iParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
							func_152(14);
							if (Global_79320 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iVar0), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_119(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iVar0), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
						}
						func_152(iVar0);
						if (Global_79320 == 1)
						{
			...
			{
				Global_79322[1 /*14*/] = { func_161(iVar10, iVar0, func_118(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_79322[1 /*14*/] = { func_161(iVar10, 14, uVar69[iVar1], -1) };
			func_129(iParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
			func_152(14);
			if (Global_79320 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_119(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
		}
		if (Global_79320 == 1)
		{
			iVar2 = 0;
...
int func_110(int iParam0, int iParam1, int iParam2)//Position - 0x501B
{
	...
	{
		if (!func_225(iParam0, Global_114135.f_2367.f_539[iVar0 /*65*/].f_64, Global_114135.f_2367.f_539[iVar0 /*65*/].f_63))
		{
...
int func_117(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5924
{
	...
	{
		if (!func_225(iParam0, Global_114135.f_2367.f_539[iVar0 /*65*/].f_61, Global_114135.f_2367.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_145(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[0], Global_114135.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_145(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[1], Global_114135.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_145(&Var1, -99, -99, Global_114135.f_2367.f_539.f_196[2], Global_114135.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
int func_159(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE642
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_160(int iParam0)//Position - 0xF4E5
{
	if (!BitTest(Global_79322[1 /*14*/].f_6, 0))
	{
		return 0;
...
void func_163(int iParam0)//Position - 0xF66F
{
	...
	func_164(&(Global_79322[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_164(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x108E8
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_157(func_167(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_157(func_166(iParam1, uParam0->f_2), Global_79319);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_157(iVar1, Global_79319);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_168(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x11885
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_170(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11997
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_164(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_164(&(Global_79322[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_164(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79520)
		{
			...
			func_164(&(Global_79322[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_225(int iParam0, int iParam1, int iParam2)//Position - 0x22E36
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_79322[1 /*14*/] = { func_161(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_79322[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_225(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_225(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_79322[2 /*14*/] = { func_161(iVar0, 14, iVar4, -1) };
									if (Global_79322[2 /*14*/].f_12 == iVar3)
									{
										if (func_225(iParam0, 14, iVar4))
										{
											if (!func_115(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_79322[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_79322[2 /*14*/] = { func_161(iVar0, iVar2, iVar1, -1) };
						if (!func_115(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_79322[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_79322[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_119(iParam1)) && Global_79322[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_119(iParam1)))
	{
		return 1;
	}
	return 0;
					...
					if (func_241(uParam0))
					{
						if (func_94(Global_97397, uParam1->f_1) > 15f)
						{
							if (fParam3 < (8f * 8f))
							{
								if (func_366(uParam1, 0))
								{
									func_91(Global_97397, uParam1->f_1, 29, &sVar6, &cVar2);
								}
								else
								{
									func_91(Global_97397, uParam1->f_1, 22, &sVar6, &cVar2);
								}
					...
					if (func_241(uParam0))
					{
						if (func_94(Global_97397, uParam1->f_1) > 10f)
						{
							if (fParam3 < (8f * 8f))
							{
								...
								{
									func_91(Global_97397, uParam1->f_1, 23, &sVar6, &cVar2);
								}
								func_237(uParam2, uParam1->f_1, uParam1->f_2, 0);
								if (func_72(uParam2, &sVar6, &cVar2, 4, 0, 0, 0))
								{
					...
					if (func_241(uParam0))
					{
						if (func_94(Global_97397, uParam1->f_1) > 10f)
						{
							if (fParam3 < (8f * 8f))
							{
								...
								{
									func_91(Global_97397, uParam1->f_1, 24, &sVar6, &cVar2);
								}
								func_237(uParam2, uParam1->f_1, uParam1->f_2, 0);
								if (func_72(uParam2, &sVar6, &cVar2, 4, 0, 0, 0))
								{
...
int func_274(var uParam0)//Position - 0x256C3
{
	...
	if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_2, PLAYER::PLAYER_PED_ID(), true)) || ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && ENTITY::DOES_ENTITY_EXIST(iVar0)) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iVar0, PLAYER::PLAYER_PED_ID(), true))) || func_275(uParam0->f_2, 0, 0, 0, 0)) || FIRE::IS_ENTITY_ON_FIRE(uParam0->f_2)) || (FIRE::IS_EXPLOSION_IN_SPHERE(-1 /*EXP_TAG_DONTCARE*/, Var1, 20f) && !((FIRE::IS_EXPLOSION_IN_SPHERE(11 /*EXP_TAG_DIR_STEAM*/, Var1, 20f) || FIRE::IS_EXPLOSION_IN_SPHERE(13 /*EXP_TAG_DIR_WATER_HYDRANT*/, Var1, 20f)) || FIRE::IS_EXPLOSION_IN_SPHERE(14 /*EXP_TAG_DIR_GAS_CANISTER*/, Var1, 20f))))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
...
int func_286(int iParam0)//Position - 0x25EB4
{
	...
	iVar0 = 0;
	while (iVar0 < Global_101613)
	{
		if (Global_101613[iVar0] == iParam0)
		{
			return 1;
		}
		iVar0++;
...
int func_287(var uParam0, var uParam1, var uParam2)//Position - 0x25EE3
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (!PED::IS_PED_INJURED(Global_97501[uParam1->f_1]))
		{
		...
		else
		{
			...
			uParam1->f_2 = Global_99141[bVar0];
			if (!PED::IS_PED_INJURED(uParam1->f_2))
			{
				if (BitTest(Global_99141.f_47, bVar0))
				{
				}
				else if (func_286(uParam1->f_2))
				{
				}
				else if (func_54(Global_97397, uParam1->f_1, &iVar1) && func_53(iVar1) == 0)
				{
					sVar2 = "";
					iVar3 = 0;
...
void func_289(var uParam0, var uParam1, var uParam2)//Position - 0x261A1
{
	...
	if (!PED::IS_PED_INJURED(uParam1->f_2))
	{
		...
		func_237(uParam2, Global_97397, PLAYER::PLAYER_PED_ID(), 0);
		func_237(uParam2, uParam1->f_1, uParam1->f_2, 0);
...
void func_296(bool bParam0)//Position - 0x26D96
{
	...
	else if (BitTest(Global_114135.f_20568.f_471, bParam0) || BitTest(Global_2359296[func_298() /*5571*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_114135.f_20568.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_298() /*5571*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
int func_301(int iParam0)//Position - 0x2705E
{
	...
	return BitTest(Global_2359296[func_298() /*5571*/].f_681.f_10, iParam0);
}
...
int func_327(bool bParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)//Position - 0x27887
{
	...
	if (func_329(bParam0, sParam1, iParam2, iVar0, sVar1, sVar3, iVar2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, iVar4, sVar5, sVar6, iVar7) == 1)
	{
		...
		{
			Global_9643 = iParam6;
			Global_9546[3 /*6*/] = { func_328(bParam0) };
			Global_9623 = bParam0;
...
void func_330(int iParam0, char* sParam1, bool bParam2, var uParam3)//Position - 0x27E10
{
	struct<14> Var0;
					...
					if (iVar0 == Global_8926[iVar1 /*15*/].f_4)
					{
						if (Global_9504[iVar0] == 0)
						{
							...
							if (Global_2696411)
							{
								if (iVar1 == 14)
								{
									func_333(Global_21047, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8926[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_23488), -1f, &(Global_8926[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_9504[iVar0] = 1;
						}
					...
					if (iVar0 == Global_8926[iVar1 /*15*/].f_4)
					{
						if (Global_9504[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_333(Global_21047, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8926[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_23493), -1f, &(Global_8926[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_79539)
								{
									...
									func_333(Global_21047, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8926[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_8926[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_21066)
									...
									func_333(Global_21047, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8926[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_8926[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_8926[iVar1 /*15*/].f_10 == 57 && iVar1 == 24)
							{
								...
								func_333(Global_21047, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8926[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_8926[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_333(Global_21047, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8926[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_8926[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_9504[iVar0] = 1;
						}
					}
...
void func_333(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)//Position - 0x28449
{
...
void func_334(char* sParam0)//Position - 0x284FC
{
...
void func_336(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)//Position - 0x28531
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
void func_339()//Position - 0x28645
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_340(Global_114135.f_14145[iVar2 /*104*/].f_18, Global_114135.f_14145[Global_23492 /*104*/].f_18))
		{
			Global_23492 = iVar2;
		}
		iVar2++;
...
int func_340(struct<6> Param0, struct<6> Param6)//Position - 0x28710
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
int func_342(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x28963
{
	struct<4> Var0;
	struct<4> Var4[2];
	int iVar13;
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			...
			if (func_343(&(Var4[0 /*4*/]), iVar13))
			{
				iParam2 = 1;
			}
			else if (func_343(&(Var4[1 /*4*/]), iVar13))
			{
				iParam2 = 0;
			}
			else
...
int func_343(char* sParam0, int iParam1)//Position - 0x28A9B
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 35)
	{
		if (!MISC::IS_STRING_NULL(&(Global_114135.f_14145[iVar0 /*104*/])))
		{
			...
			{
				if (Global_114135.f_14145[iVar0 /*104*/].f_99[iParam1])
				{
					iVar1 = 1;
				}
			}
...
int func_344(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x28B0F
{
	struct<14> Var0;
...
void func_345(bool bParam0)//Position - 0x28C4A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_347(bool bParam0)//Position - 0x28D72
{
...
int func_348(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4)//Position - 0x28D9A
{
	struct<4> Var0[2];
	int iVar9;
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			if (func_342(iParam0, iParam1, 0, &(Var0[0 /*4*/])) && func_342(iParam0, iParam1, 1, &(Var0[1 /*4*/])))
			{
				...
				if (func_343(&(Var0[0 /*4*/]), iVar9))
				{
					iParam2 = 1;
				}
				else if (func_343(&(Var0[1 /*4*/]), iVar9))
				{
					iParam2 = 0;
				}
				else
...
int func_350(int iParam0)//Position - 0x28F4A
{
	switch (iParam0)
	{
		case 0:
...
int func_351(int iParam0)//Position - 0x28F81
{
	...
	iVar1 = 0;
	while (iVar1 < Global_114135.f_7692.f_136)
	{
		if (Global_114135.f_7692[iVar1 /*15*/] == iParam0)
		{
	...
	iVar1 = 0;
	while (iVar1 < Global_114135.f_7692.f_764)
	{
		if (Global_114135.f_7692.f_651[iVar1 /*14*/] == iParam0)
		{
	...
	iVar1 = 0;
	while (iVar1 < Global_114135.f_7692.f_866)
	{
		if (Global_114135.f_7692.f_765[iVar1 /*10*/] == iParam0)
		{
...
int func_352(int iParam0, int iParam1)//Position - 0x29037
{
	struct<10> Var0;
	bool bVar10;
	...
	if (bVar10)
	{
		if (Var0.f_3 < Global_114135.f_7692.f_919[func_353()])
		{
			return 5;
		}
	}
	if (Var0.f_6 != 144)
	{
		if (Global_44733[Var0.f_6] > iParam1)
		{
			return 3;
		}
	}
	if (Global_44732 > iParam1)
	{
		return 2;
	}
	return 1;
...
bool func_353()//Position - 0x290CC
{
	func_354();
...
void func_354()//Position - 0x290E5
{
	...
	{
		if (func_356(Global_114135.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_355(PLAYER::PLAYER_PED_ID());
			if (func_407(iVar0) && (!func_417(14) || Global_113083))
			{
				if (Global_114135.f_2367.f_539.f_4321 != iVar0 && func_407(Global_114135.f_2367.f_539.f_4321))
				{
...
int func_355(int iParam0)//Position - 0x291E2
{
	int iVar0;
	int iVar1;
...
int func_356(int iParam0)//Position - 0x2921F
{
	if (func_407(iParam0))
	{
...
var func_357(int iParam0)//Position - 0x29244
{
...
struct<10> func_358(int iParam0)//Position - 0x29253
{
	...
	while (iVar0 < Global_114135.f_7692.f_866)
	{
		...
		{
			return Global_114135.f_7692.f_765[iVar0 /*10*/];
		}
		iVar0++;
	}
	return Var1;
...
int func_359(int iParam0, int iParam1)//Position - 0x292A2
{
	struct<14> Var0;
	bool bVar14;
...
struct<14> func_360(int iParam0)//Position - 0x2932E
{
	...
	while (iVar0 < Global_114135.f_7692.f_764)
	{
		...
		{
			return Global_114135.f_7692.f_651[iVar0 /*14*/];
		}
		iVar0++;
	}
	return Var1;
...
int func_361(int iParam0, int iParam1)//Position - 0x2937D
{
	struct<15> Var0;
	bool bVar15;
...
struct<15> func_362(int iParam0)//Position - 0x29425
{
	...
	while (iVar0 < Global_114135.f_7692.f_136)
	{
		...
		{
			return Global_114135.f_7692[iVar0 /*15*/];
		}
		iVar0++;
	}
	return Var1;
...
int func_363(int iParam0)//Position - 0x2946D
{
	int iVar0;
...
int func_364(int iParam0)//Position - 0x29569
{
	struct<3> Var0;
...
int func_365(struct<3> Param0, bool bParam3)//Position - 0x295FC
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= (5 - 1))
	{
		if (Global_96866[iVar0 /*9*/].f_7 != 263)
		{
			if (!bParam3 || BitTest(Global_114135.f_7233.f_11[iVar0], 0))
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, Global_96866[iVar0 /*9*/].f_3, true);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
int func_366(var uParam0, bool bParam1)//Position - 0x29676
{
	if ((uParam0->f_1 == 1 && Global_97397 == 2) || (uParam0->f_1 == 2 && Global_97397 == 1))
	{
		if (!func_51(30))
		{
			if (bParam1)
...
void func_368(int* iParam0)//Position - 0x2974B
{
	if (func_63(iParam0))
	{
		if (!func_413(iParam0))
...
void func_371(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2980E
{
	int iVar0;
...
void func_374(var uParam0)//Position - 0x29BB4
{
	int iVar0;
	int iVar1;
	...
	iVar0 = -1;
	iVar1 = 0;
	while (iVar1 < Global_101613)
	{
		if (iVar0 < 0)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(Global_101613[iVar1]))
			{
				iVar0 = iVar1;
			}
		}
	...
	if (iVar0 < 0 || iVar0 > Global_101613)
	{
		iVar0 = 0;
	}
	Global_101613[iVar0] = uParam0;
}
...
var func_381(int iParam0)//Position - 0x29E39
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_382(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_382(bool bParam0, int iParam1, int iParam2)//Position - 0x29E5B
{
	if (bParam0)
	{
		return iParam1;
...
int func_383(var uParam0)//Position - 0x29E72
{
	return uParam0 & 15;
}
...
void func_387(int iParam0)//Position - 0x29F30
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
	...
	Var1 = { Global_114135.f_2367.f_539.f_2300[iVar0 /*3*/] };
	uVar4 = Global_114135.f_2367.f_539.f_2310[iVar0];
	uVar5 = Global_114135.f_2367.f_539.f_2314[iVar0];
	Var6 = { Global_114135.f_2367.f_539.f_2318[iVar0 /*3*/] };
	func_389(iParam0, 0);
	if (!func_388(Var1, 0f, 0f, 0f, 0))
	{
		fVar9 = MISC::ABSF((Global_114135.f_2367.f_539.f_2300[iVar0 /*3*/].f_2 - Var1.f_2));
		fVar10 = SYSTEM::VDIST2(Var1, Global_114135.f_2367.f_539.f_2300[iVar0 /*3*/]);
		fVar11 = SYSTEM::VMAG(Global_114135.f_2367.f_539.f_2318[iVar0 /*3*/]);
		bVar12 = false;
		if (fVar11 > 25f)
		{
			if (fVar9 > 25f)
		...
		if (bVar12)
		{
			Global_114135.f_2367.f_539.f_2300[iVar0 /*3*/] = { Var1 };
			Global_114135.f_2367.f_539.f_2310[iVar0] = uVar4;
			Global_114135.f_2367.f_539.f_2314[iVar0] = uVar5;
			Global_114135.f_2367.f_539.f_2318[iVar0 /*3*/] = { Var6 };
		}
	}
}

bool func_388(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2A0AF
{
	if (bParam6)
	{
...
void func_389(int iParam0, bool bParam1)//Position - 0x2A0F6
{
	func_402(iParam0);
...
void func_390(int iParam0)//Position - 0x2A12A
{
	int iVar0;
	
	iVar0 = func_355(iParam0);
	if (func_407(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
...
void func_391(int iParam0)//Position - 0x2A171
{
	int iVar0;
...
void func_392(int iParam0)//Position - 0x2A1AF
{
	int iVar0;
...
void func_393(int iParam0)//Position - 0x2A33C
{
	int iVar0;
...
void func_394(int iParam0)//Position - 0x2A378
{
	int iVar0;
...
void func_395(int iParam0, bool bParam1)//Position - 0x2A3D5
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_407(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_396(iParam0, &(Global_114135.f_2367.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_396(int iParam0, var uParam1)//Position - 0x2A4C8
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_401(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_398(Var11.f_1)) && iVar72 < 51)
			{
...
int func_397(int iParam0)//Position - 0x2A750
{
	switch (iParam0)
	{
...
int func_398(int iParam0)//Position - 0x2A7F1
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_402(int iParam0)//Position - 0x2BA19
{
	int iVar0;
	...
	if (func_407(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		Global_114135.f_2367.f_539.f_2296[iVar0] = func_376();
	}
}
...
void func_405(var uParam0, bool bParam1)//Position - 0x2BB1D
{
	if (uParam0->f_50 != 0)
	{
...
bool func_407(int iParam0)//Position - 0x2BB88
{
	return iParam0 < 3;
}

int func_408()//Position - 0x2BB94
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_410(int* iParam0)//Position - 0x2BC0E
{
	if (func_63(iParam0))
	{
		if (func_413(iParam0))
...
int func_412(int iParam0)//Position - 0x2BC91
{
	int iVar0;
...
int func_420(char* sParam0)//Position - 0x2BDE9
{
	int iVar0;
...
void func_421(int iParam0, int iParam1)//Position - 0x2BE24
{
	int iVar0;
	bool bVar1;
	bool bVar2;
			...
			if (func_469(iVar0))
			{
				if (!func_233(6))
				{
					if (func_431(iVar0, &bVar1, &bVar2, &bVar3))
					{
						...
						{
							Global_114135.f_18107.f_175[iParam0 /*19*/].f_16 = iParam1;
							func_430(iParam0, 2, 0);
	...
	else if (iVar4 == 2)
	{
		if (func_429(iParam0, 3) && func_407(iVar0))
		{
			if (!func_469(iVar0))
			{
				if (Global_114135.f_18107.f_406 == 0)
				{
	...
	else if (iVar4 == 3)
	{
		...
		if (!SCRIPT::IS_THREAD_ACTIVE(Global_114135.f_18107.f_395))
		{
			...
			else
			{
				...
				Global_114135.f_18107.f_395 = iVar13;
...
void func_422(int iParam0, int iParam1, int iParam2)//Position - 0x2C0A5
{
	switch (iParam2)
	{
		case 0:
...
void func_423(int iParam0, int iParam1, int iParam2)//Position - 0x2C14F
{
	func_424(iParam0, iParam1, (func_425(iParam0, iParam1) + iParam2));
}

void func_424(int iParam0, int iParam1, int iParam2)//Position - 0x2C16A
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar1 = func_29(iParam1);
	iVar2 = func_28(iVar0, iVar1);
	Global_114135.f_18107.f_175[iVar2 /*19*/].f_17 = iParam2;
	if (Global_114135.f_18107.f_175[iVar2 /*19*/].f_17 < 0)
	{
		Global_114135.f_18107.f_175[iVar2 /*19*/].f_17 = 0;
	}
	if (Global_114135.f_18107.f_175[iVar2 /*19*/].f_17 > 100)
	{
		Global_114135.f_18107.f_175[iVar2 /*19*/].f_17 = 100;
	}
}

int func_425(int iParam0, int iParam1)//Position - 0x2C1E5
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar1 = func_29(iParam1);
	iVar2 = func_28(iVar0, iVar1);
	return Global_114135.f_18107.f_175[iVar2 /*19*/].f_17;
}
...
int func_429(int iParam0, int iParam1)//Position - 0x2C275
{
	if (iParam0 < 9)
	{
		return BitTest(Global_114135.f_18107.f_175[iParam0 /*19*/].f_18, iParam1);
	}
	return 0;
}
...
void func_430(int iParam0, int iParam1, bool bParam2)//Position - 0x2C29D
{
	if (iParam0 < 9)
	{
		if (bParam2)
		{
			MISC::SET_BIT(&(Global_114135.f_18107.f_175[iParam0 /*19*/].f_18), iParam1);
		}
		else
		{
			MISC::CLEAR_BIT(&(Global_114135.f_18107.f_175[iParam0 /*19*/].f_18), iParam1);
		}
	}
}

int func_431(int iParam0, var uParam1, var uParam2, var uParam3)//Position - 0x2C2E1
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		if (func_407(iParam0) || func_456(&uLocal_179, iParam0))
		{
			*uParam1 = 0;
			*uParam2 = 1;
			return 1;
	...
	{
		func_451(iVar1, &iVar28, &iVar29);
		func_443(iVar1, iVar2, &iVar30, &iVar31, 1);
		func_442(iVar0, iParam0, iVar28, &sVar3, &cVar7);
		func_442(iVar0, iParam0, iVar29, &sVar3, &cVar11);
		func_442(iVar0, iParam0, iVar30, &sVar3, &cVar15);
		func_442(iVar0, iParam0, iVar31, &sVar3, &cVar23);
		cVar19 = { cVar15 };
		if (iVar30 == 9)
		{
			StringConCat(&cVar19, "_1", 16);
		}
		if (func_437(&uLocal_179, func_44(iVar2), &sVar3, &cVar7, &cVar7, &cVar11, &cVar11, &cVar15, &cVar19, &cVar23, &cVar23, 12, iVar27, 0, 0, 0))
		{
			if (iVar30 == 12)
			{
				*uParam3 = 1;
	...
	else if (!func_436(iVar2))
	{
		...
		if (iVar32 == 0)
		{
			func_442(iVar0, iParam0, 35, &sVar3, &cVar7);
		}
		else if (iVar32 == 1)
		{
			func_442(iVar0, iParam0, 36, &sVar3, &cVar7);
		}
		else
		{
			func_442(iVar0, iParam0, 37, &sVar3, &cVar7);
		}
		if (func_435(&uLocal_179, func_44(iVar2), &sVar3, &cVar7, 12, iVar27, 0, 0, 0))
		{
			*uParam1 = 0;
			*uParam2 = 0;
			return 1;
	...
	{
		func_451(iVar1, &iVar33, &iVar34);
		func_432(iVar1, iVar2, &iVar35, &iVar36);
		func_442(iVar0, iParam0, iVar33, &sVar3, &cVar7);
		func_442(iVar0, iParam0, iVar34, &sVar3, &cVar11);
		func_442(iVar0, iParam0, iVar35, &sVar3, &cVar15);
		func_442(iVar0, iParam0, iVar36, &sVar3, &cVar23);
		if (func_437(&uLocal_179, func_44(iVar2), &sVar3, &cVar7, &cVar7, &cVar11, &cVar11, &cVar15, &cVar15, &cVar23, &cVar23, 12, iVar27, 0, 0, 0))
		{
			*uParam1 = 0;
			*uParam2 = 0;
			return 1;
...
int func_434(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x2C59F
{
	int iVar0;
	int iVar1;
...
bool func_435(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x2C5E0
{
...
int func_436(int iParam0)//Position - 0x2C63F
{
	int iVar0;
...
bool func_437(var uParam0, int iParam1, char* sParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15)//Position - 0x2C685
{
	var uVar0;
	var uVar11;
	...
	uVar0 = 10;
	uVar11 = 10;
	func_439(4, &uVar0, &uVar11, cParam3, cParam4, cParam5, cParam6, cParam7, cParam8, cParam9, cParam10, 0, 0, 0, 0, 0, 0);
	return func_438(&uVar0, &uVar11, iParam11, bParam15);
}

int func_438(var uParam0, var uParam1, int iParam2, bool bParam3)//Position - 0x2C6E8
{
	int iVar0;
...
void func_440(var uParam0)//Position - 0x2CAC3
{
...
int func_442(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4)//Position - 0x2CB22
{
	int iVar0;
	int iVar1;
...
int func_443(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4)//Position - 0x2CE0A
{
	int iVar0;
	...
	else if (Global_114135.f_18107.f_175[iVar0 /*19*/].f_17 < 30)
	{
		*uParam2 = 10;
		*uParam3 = 13;
		return 1;
	}
	else if (func_450(&(Global_114135.f_18107.f_175[iVar0 /*19*/].f_5)))
	{
		*uParam2 = 8;
		*uParam3 = 13;
		return 1;
	}
	else if (func_449(&(Global_114135.f_18107.f_175[iVar0 /*19*/].f_5)))
	{
		*uParam2 = 7;
		*uParam3 = 13;
		return 1;
	}
	else if (((((iParam4 && MISC::GET_RANDOM_INT_IN_RANGE(0, 100) < 15) && !(iParam0 == 2 && iParam1 == 0)) && !(iParam0 == 0 && iParam1 == 5)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && func_444(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
	{
		*uParam2 = 12;
		*uParam3 = 14;
		return 1;
...
int func_444(struct<3> Param0)//Position - 0x2CF26
{
	struct<3> Var0;
	float fVar3;
	var uVar4;
	...
	if (func_448())
	{
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, Global_96964[0 /*18*/], true) < 10f)
		{
			return 1;
		}
		else
	...
	if (!func_446())
	{
		if (Global_98591 == 0)
		{
			if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(Param0, 1, &Var0, &fVar3, &uVar4, 4, 3f, 0f))
			{
				...
				Global_96964[0 /*18*/] = { Var5 };
				Global_96964[0 /*18*/].f_3 = { Var26 - Var5 };
				Global_96964[0 /*18*/].f_6 = { Var29 - Var5 };
				Global_96964[0 /*18*/].f_9 = { 0f, 0f, 0f };
				Global_96964[0 /*18*/].f_12 = 0f;
				Global_96964[0 /*18*/].f_13 = { Var23 };
...
float func_445(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)//Position - 0x2D1E3
{
	return ((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1));
}
...
int func_449(var uParam0)//Position - 0x2D236
{
...
int func_450(var uParam0)//Position - 0x2D257
{
...
int func_451(int iParam0, var uParam1, var uParam2)//Position - 0x2D278
{
	...
	if (func_45(&iVar1) > 0)
	{
		iVar2 = Global_114135.f_18107.f_175[iVar1 /*19*/];
		iVar3 = Global_114135.f_18107.f_175[iVar1 /*19*/].f_1;
		if (iVar2 == iParam0)
		{
			iVar0 = iVar3;
		}
...
int func_452(int iParam0, int iParam1)//Position - 0x2D31A
{
	var uVar0;
	var uVar1;
...
int func_453(int iParam0, int iParam1)//Position - 0x2D381
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_54(iVar0, iVar1, &iVar2))
	{
		...
		else if (iVar5 == 1)
		{
			...
			{
				if (Global_114135.f_18107.f_175[iVar4 /*19*/].f_2 == 0)
				{
					return 1;
				}
			}
...
int func_454(int iParam0, int iParam1)//Position - 0x2D3E6
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_28(iParam0, iParam1);
	iVar1 = Global_114135.f_18107.f_175[iVar0 /*19*/].f_16;
	if (iParam0 == iVar1)
	{
		return 1;
	}
...
int func_456(var uParam0, int iParam1)//Position - 0x2D42F
{
	int iVar0;
	char* sVar1;
	char[] cVar5[8];
	...
	iVar0 = 0;
	func_457(func_29(iParam1), &sVar1, &cVar5);
	if (func_435(uParam0, iParam1, &sVar1, &cVar5, 2, iVar0, 0, 0, 0))
	{
		return 1;
	}
	return 0;
...
int func_458(int iParam0, int iParam1)//Position - 0x2D500
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int func_459(int iParam0, var uParam1, var uParam2, var uParam3)//Position - 0x2D596
{
...
int func_461(int iParam0, int iParam1)//Position - 0x2D695
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_462(int iParam0, int iParam1)//Position - 0x2D721
{
	int iVar0;
	...
	if (iVar0 < 6)
	{
		if (Global_114135.f_18107.f_175[iParam0 /*19*/] == iVar0 || Global_114135.f_18107.f_175[iParam0 /*19*/].f_1 == iVar0)
		{
			return 1;
		}
	}
...
int func_464(int iParam0)//Position - 0x2D781
{
	if (func_465(iParam0))
	{
		return 0;
...
int func_465(int iParam0)//Position - 0x2D797
{
	if (iParam0 < 6)
	{
...
int func_467(int iParam0)//Position - 0x2D80E
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!func_468(iVar0))
	{
		...
		else
		{
			...
			if (iVar3 < 3)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_97497[iVar3]))
				{
					return 0;
				}
			}
...
bool func_468(int iParam0)//Position - 0x2D879
{
	func_354();
	return iParam0 == Global_114135.f_2367.f_539.f_4321;
}

int func_469(int iParam0)//Position - 0x2D895
{
	if (Global_23539 == 0)
	{
		return 0;
...
int func_470(int iParam0, var uParam1)//Position - 0x2D8E9
{
	int iVar0;
	
	iVar0 = func_29(Global_97397);
	if (Global_114135.f_18107.f_175[iParam0 /*19*/].f_1 == iVar0)
	{
		*uParam1 = Global_114135.f_18107.f_175[iParam0 /*19*/];
		return 1;
	}
	if (Global_114135.f_18107.f_175[iParam0 /*19*/] == iVar0)
	{
...
void func_480(struct<3> Param0, float fParam3, struct<3> Param4)//Position - 0x2E43D
{
	Global_96964[iLocal_92 /*18*/].f_9 = { Param0 };
	Global_96964[iLocal_92 /*18*/].f_12 = fParam3;
	Global_96964[iLocal_92 /*18*/].f_13 = { Param4 };
}

void func_481(int iParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, int iParam10)//Position - 0x2E471
{
	iLocal_92 = iParam0;
	Global_96964[iLocal_92 /*18*/] = { Param1 };
	Global_96964[iLocal_92 /*18*/].f_3 = { Param4 };
	Global_96964[iLocal_92 /*18*/].f_6 = { Param7 };
...
void func_482()//Position - 0x2E4C2
{
	...
	while (iVar0 < 9)
	{
		if ((Global_97519[iVar0 /*2*/] == 1 || Global_97519[iVar0 /*2*/] == 2) || Global_97519[iVar0 /*2*/] == 3)
		{
			func_472(iVar0, 0);
		}
		iVar0++;
	}
	func_403(&uLocal_97, 0);
	iVar1 = 0;
	while (iVar1 < 3)
	{
		if (!PED::IS_PED_INJURED(Global_97501[iVar1]))
		{
			func_374(Global_97501[iVar1]);
			Global_97501[iVar1] = 0;
		}
		iVar1++;
	}
