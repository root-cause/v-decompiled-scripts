...
void __EntryFunction__()//Position - 0x0
{
	...
	if (!func_275(&iVar64, &Var0, Var61, 1f))
	{
		func_274();
	...
	while (true)
	{
		...
		func_213(Var0.f_0);
		func_206(&iLocal_91, &(Var0.f_9), Var61);
		if (Var0.f_0 == 44)
		{
			func_198(&Var0, Var61, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_92);
			func_197();
		}
		else if (Var0.f_0 == 45)
		{
			func_198(&Var0, Var61, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_93);
			func_195(&Var0);
		}
		if (func_180(&Var0, 0))
		{
...
int func_1(int iParam0)//Position - 0x260
{
...
int func_2(int iParam0)//Position - 0x27E
{
	struct<4> Var0;
	char* sVar32;
...
void func_3(int iParam0, char* sParam1)//Position - 0x33F
{
	func_21(sParam1);
...
void func_17(int iParam0)//Position - 0xBFF
{
...
void func_21(char* sParam0)//Position - 0xCB8
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xCCB
{
	MISC::CLEAR_BIT(&(Global_101392.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xCE8
{
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x28F4
{
...
int func_29(int iParam0)//Position - 0x2934
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2962
{
...
int func_31(int iParam0)//Position - 0x2A3E
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2A80
{
	int iVar0;
...
int func_33(int iParam0, bool bParam1, int iParam2)//Position - 0x2AE3
{
	int iVar0;
...
int func_34(bool bParam0, int iParam1)//Position - 0x2B71
{
	struct<82> Var0;
...
void func_35(bool bParam0, var uParam1, int iParam2)//Position - 0x2BB3
{
	int iVar0;
...
bool func_36(bool bParam0)//Position - 0x2E0F
{
	return bParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E1B
{
	int iVar0;
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x3176
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x3369
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x343A
{
	char* sVar0;
...
int func_43(int iParam0, bool bParam1, bool bParam2)//Position - 0x3569
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x35D7
{
...
int func_45(int iParam0)//Position - 0x36B0
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x36ED
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x3712
{
...
int func_50(int iParam0, var uParam1)//Position - 0x38EA
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(uParam1));
}

int func_51(var uParam0)//Position - 0x38FF
{
	int iVar0;
	int iVar1;
...
int func_53(int iParam0, int iParam1)//Position - 0x393F
{
	int iVar0;
	var uVar1;
...
int func_54(int iParam0, var uParam1)//Position - 0x3963
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(uParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3978
{
	int iVar0;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EC1
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x45A3
{
	switch (iParam0)
	{
...
int func_63(int iParam0)//Position - 0x4644
{
...
int func_65(int iParam0, var* uParam1)//Position - 0x5551
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x558C
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x5800
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x583C
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5D8B
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5DCF
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x654E
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x6595
{
...
bool func_73(int iParam0)//Position - 0x65F0
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x6600
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x6660
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x6A08
{
	return Global_32828;
}

int func_77(int iParam0)//Position - 0x6A13
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A23
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6AC5
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x7230
{
...
int func_81()//Position - 0x752B
{
	return Global_2652572.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x753A
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x7564
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x7579
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x7590
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x75E8
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7692
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x7727
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x776B
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x78EF
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x78FD
{
	struct<6> Var0;
...
int func_92(int iParam0, var uParam1)//Position - 0x83C5
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x8447
{
	if (iParam0 != func_94())
	{
...
int func_94()//Position - 0x849F
{
	return -1;
}

Vector3 func_95(int iParam0)//Position - 0x84A8
{
	switch (iParam0)
	{
		case 1:
...
int func_96()//Position - 0x8714
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x8724
{
	return MISC::GET_BITS_IN_RANGE(Global_2657921[iParam0 /*463*/].f_321.f_3, 28, 31);
}

int func_98(int iParam0)//Position - 0x8741
{
	return func_74(iParam0, 0, 0);
}

int func_99(int iParam0)//Position - 0x8751
{
	switch (iParam0)
	{
		case -1:
...
bool func_100()//Position - 0x8A87
{
	return Global_101444.f_393 > 0;
}

var func_101()//Position - 0x8A98
{
	var uVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x8ADE
{
	if (iParam1 <= 0)
	{
		return;
...
void func_103(var uParam0, int iParam1)//Position - 0x8B64
{
...
int func_105(int iParam0, int iParam1)//Position - 0x8BE8
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x8C8A
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x8CAC
{
	if (bParam0)
	{
		return iParam1;
...
int func_108(var uParam0)//Position - 0x8CC3
{
	return uParam0 & 15;
}

void func_109(var uParam0, int iParam1)//Position - 0x8CD0
{
...
void func_110(var uParam0, int iParam1)//Position - 0x8D0A
{
...
void func_111(var uParam0, int iParam1)//Position - 0x8D45
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_112()//Position - 0x8D81
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_113(int iParam0)//Position - 0x8D9A
{
	var uVar0;
	char cVar1[24];
...
bool func_114()//Position - 0x8DF3
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_115()//Position - 0x8E09
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_116(char* sParam0, int iParam1, int iParam2)//Position - 0x8E1F
{
...
int func_117(bool bParam0)//Position - 0x8E61
{
...
struct<2> func_118(int iParam0)//Position - 0x8E89
{
	struct<2> Var0;
...
void func_119(int iParam0, var uParam1)//Position - 0x92D6
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0)//Position - 0xA5AE
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0)//Position - 0xA8F4
{
	int iVar0;
...
void func_123(int iParam0)//Position - 0xA999
{
	struct<2> Var0;
...
void func_124(int iParam0)//Position - 0xAA34
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_126(int iParam0)//Position - 0xAA92
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xAAEB
{
...
int func_128(int iParam0)//Position - 0xAB6E
{
	int iVar0;
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0xAB9F
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xABB4
{
	int iVar0;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0xAC67
{
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xAC82
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xACCE
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0xAD17
{
	if (func_136(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_136(int iParam0)//Position - 0xAD37
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_137(int iParam0)//Position - 0xAD58
{
	switch (iParam0)
	{
		case 5:
...
int func_139(int iParam0)//Position - 0xAE28
{
	switch (iParam0)
	{
		case 5:
...
void func_140(var uParam0, bool bParam1, bool bParam2)//Position - 0xAE7B
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0xAF70
{
	switch (iParam0)
	{
		case 5:
...
void func_142(bool bParam0)//Position - 0xAFDB
{
	int iVar0;
...
void func_143(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB01A
{
	if (bParam0)
	{
...
bool func_144()//Position - 0xB167
{
	return BitTest(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

bool func_145(int iParam0, int iParam1)//Position - 0xB181
{
	bool bVar0;
...
int func_146(int iParam0, bool bParam1)//Position - 0xB1DA
{
	int iVar0;
	int iVar1;
...
int func_147(var uParam0)//Position - 0xB21B
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB23D
{
...
bool func_149()//Position - 0xB27C
{
	return BitTest(Global_2621446, 3);
}

int func_150(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB28A
{
	int iVar0;
...
void func_152(int iParam0)//Position - 0xB2E4
{
	if (iParam0 == 1)
	{
...
int func_153(char* sParam0)//Position - 0xB307
{
...
void func_154()//Position - 0xB344
{
	Global_21032 = 0;
	func_155();
}

void func_155()//Position - 0xB354
{
...
int func_159(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB43A
{
...
void func_160(int iParam0)//Position - 0xB491
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_161(bool bParam0, bool bParam1)//Position - 0xB4BD
{
...
void func_163(int iParam0)//Position - 0xB65F
{
	if (func_168())
	{
		return;
...
void func_165(bool bParam0, bool bParam1)//Position - 0xB71C
{
	if (bParam0)
	{
		if (func_167(0))
...
bool func_166()//Position - 0xB790
{
	return BitTest(Global_1956030, 5);
}

int func_167(int iParam0)//Position - 0xB79E
{
	if (iParam0 == 1)
	{
...
bool func_168()//Position - 0xB7F5
{
	return BitTest(Global_1956030, 19);
}

int func_169(int iParam0)//Position - 0xB804
{
...
int func_170(int iParam0)//Position - 0xB845
{
	int iVar0;
...
void func_171(int iParam0)//Position - 0xB88A
{
...
int func_172(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB8BC
{
	int iVar0;
...
void func_173(var uParam0, int iParam1)//Position - 0xB9F3
{
	int iVar0;
...
bool func_174(int iParam0)//Position - 0xBA42
{
	return func_175(iParam0, Global_43922);
}

int func_175(int iParam0, int iParam1)//Position - 0xBA53
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_176(int iParam0)//Position - 0xBC34
{
	if (Global_43922 == 15)
	{
		return 0;
...
int func_177()//Position - 0xBC56
{
	return func_178(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_178(char* sParam0, int iParam1)//Position - 0xBC67
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_180(int iParam0, int iParam1)//Position - 0xBCD4
{
	switch (iParam0->f_16)
	{
		case 0:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.6306f, 4699.115f, 35.38089f, 1812.8776f, 4710.457f, 42.053535f, 23.75f, false, true, 0))
				{
					if (func_136(iParam0->f_28[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], true), true) < 3f)
						{
							if (func_186(2))
							{
								if (func_184(iParam0->f_27))
								{
									func_183(iParam0->f_27, *iParam0);
...
void func_181()//Position - 0xC4B9
{
	func_27(&(Global_104933.f_2890), &Global_104933, 0, 1, 1, 0);
}

int func_182(var uParam0)//Position - 0xC4D4
{
	float fVar0;
...
void func_183(int iParam0, int iParam1)//Position - 0xC562
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_184(bool bParam0)//Position - 0xC5C6
{
	int iVar0;
...
int func_185(int iParam0)//Position - 0xC65D
{
	if (func_136(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_186(int iParam0)//Position - 0xC687
{
	bool bVar0;
...
var func_187()//Position - 0xCDA4
{
	return Global_101431.f_1;
}

int func_188()//Position - 0xCDB2
{
	if (Global_98294 != -1)
	{
...
bool func_191()//Position - 0xCE19
{
	return Global_101444.f_394 > 0;
}

var func_192(int iParam0, int iParam1)//Position - 0xCE2A
{
	switch (iParam0)
	{
		case 5:
...
var func_193()//Position - 0xCE62
{
	return Global_1575079;
}

int func_194()//Position - 0xCE6E
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_195(int iParam0)//Position - 0xCE8A
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	...
	{
		if (func_136(iParam0->f_28[0]) && !ENTITY::IS_ENTITY_ON_SCREEN(iParam0->f_28[0]))
		{
			if (func_136(PLAYER::PLAYER_PED_ID()) && !func_196(PLAYER::PLAYER_PED_ID(), iParam0->f_28[0], 50f, 1))
			{
...
void func_197()//Position - 0xCF95
{
	...
	GRAPHICS::DRAW_SCALEFORM_MOVIE(iLocal_94, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((MISC::GET_GAME_TIMER() - iLocal_96) > 1250)
	{
...
int func_198(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)//Position - 0xD087
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_186(2))
		{
			if (!func_156())
			{
				if ((func_136(PLAYER::PLAYER_PED_ID()) && func_136(iParam0->f_28[0])) && func_205(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
			...
			if (func_205(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
void func_199(int iParam0)//Position - 0xD1A9
{
	Global_23177 = iParam0;
}

int func_200(char* sParam0)//Position - 0xD1B6
{
	struct<6> Var0;
...
struct<6> func_201()//Position - 0xD1D6
{
	struct<6> Var0;
...
void func_202(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD1FA
{
...
void func_203(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD235
{
...
void func_204(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD28B
{
...
float func_205(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD326
{
	struct<3> Var0;
...
void func_206(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD360
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_207(int iParam0, bool bParam1)//Position - 0xD451
{
	if (iParam0 == -1)
	{
		return;
...
int func_208(int iParam0)//Position - 0xD48D
{
	if (Global_79244 == iParam0)
	{
		if (Global_79245 == -1)
...
void func_209(int iParam0, int iParam1)//Position - 0xD4C6
{
	bool bVar0;
	int iVar1;
...
bool func_210()//Position - 0xD564
{
	return Global_98681;
}

void func_211(int iParam0)//Position - 0xD570
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_212(iParam0);
...
void func_212(int iParam0)//Position - 0xD587
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_213(int iParam0)//Position - 0xD66F
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_214(int iParam0, bool bParam1)//Position - 0xD697
{
	struct<27> Var0;
	...
	func_119(*iParam0, &Var0);
	if ((func_251(*iParam0) || func_249(*iParam0)) || Global_79494 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_215(int iParam0, var uParam1, int iParam2)//Position - 0xD907
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0)//Position - 0xDC5F
{
...
int func_217(var uParam0)//Position - 0xDC7F
{
...
int func_218(var uParam0)//Position - 0xDC97
{
...
void func_219(var uParam0)//Position - 0xDCBC
{
	int iVar0;
	int iVar1;
...
void func_220(int* iParam0)//Position - 0xDFC0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_221(var uParam0)//Position - 0xDFEB
{
	int iVar0;
...
int func_222(var uParam0, bool bParam1, bool bParam2)//Position - 0xE06B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_223(int iParam0, int iParam1)//Position - 0xE229
{
	int iVar0;
...
int func_224(var uParam0, bool bParam1, int iParam2)//Position - 0xE259
{
	int iVar0;
	int iVar1;
...
int func_225(int iParam0)//Position - 0xE515
{
...
int func_226(int iParam0, float fParam1)//Position - 0xE549
{
	float fVar0;
...
bool func_227(int iParam0, float fParam1)//Position - 0xE5BF
{
	return func_228(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_228(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE5D7
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_229(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE698
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_230(int iParam0, int iParam1)//Position - 0xE7C4
{
	int iVar0;
...
int func_232(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE8D3
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_233(struct<3> Param0, struct<3> Param3)//Position - 0xE964
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_234(struct<3> Param0)//Position - 0xE985
{
	float fVar0;
	float fVar1;
...
int func_236(int iParam0, int iParam1)//Position - 0xE9DF
{
	int iVar0;
...
int func_237(int iParam0)//Position - 0xEA1E
{
...
int func_238(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEA46
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_239(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEB41
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_240(int iParam0, float fParam1)//Position - 0xEC4D
{
	var uVar0;
	struct<3> Var1;
...
int func_241(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xECE2
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_242(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xED70
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_243(int iParam0)//Position - 0xEDB8
{
...
void func_244(int iParam0)//Position - 0xEE02
{
	int iVar0;
...
int func_245(int iParam0)//Position - 0xEE9F
{
	if (iParam0 == -1)
	{
		iParam0 = func_177();
...
int func_246(int iParam0)//Position - 0xEF34
{
...
int func_249(int iParam0)//Position - 0xEFB3
{
...
int func_251(int iParam0)//Position - 0xF025
{
	if (func_117(0))
	{
...
void func_252()//Position - 0xF04D
{
	iLocal_96 = MISC::GET_GAME_TIMER();
}

void func_253()//Position - 0xF05B
{
...
int func_254(int iParam0)//Position - 0xF0C3
{
	switch (*iParam0)
	{
		case 44:
...
int func_255(var uParam0)//Position - 0xF10A
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_262(&iVar0) || !func_261(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			{
				if (!func_258(&(uParam0->f_28[0]), 69, 2319.443f, 2583.5881f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
			...
			{
				func_256(&(uParam0->f_35[0]), iVar0[1], 2331.08f, 2573.53f, 46.13f, 358.61f);
			}
			if (bVar4)
			{
				iLocal_89 = 3;
...
void func_256(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF2D9
{
	func_257(iParam0);
...
void func_257(int* iParam0)//Position - 0xF31C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF3B8
{
...
int func_259(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF414
{
	int iVar0;
...
int func_260(var uParam0, int iParam1)//Position - 0xF4A2
{
	int iVar0;
...
int func_261(var uParam0)//Position - 0xF4E8
{
	if (func_218(uParam0))
	{
...
int func_262(int iParam0)//Position - 0xF512
{
	int iVar0;
...
void func_263(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xF543
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_264(var uParam0)//Position - 0xF57F
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_258(&(uParam0->f_28[0]), 69, 2468.51f, 3437.39f, 49.9f, 180f, "OMEGA LAUNCHER RC", 1))
				{
					bVar5 = false;
				}
			}
			...
			if ((func_136(uParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0])) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
...
int func_265(int iParam0)//Position - 0xF803
{
	struct<27> Var0;
	bool bVar32;
...
int func_266(int iParam0)//Position - 0xF854
{
	char* sVar0;
...
int func_267(int iParam0)//Position - 0xF90D
{
	var uVar0;
...
int func_268(int iParam0)//Position - 0xF9CE
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_269(int iParam0, char* sParam1)//Position - 0xFA53
{
...
int func_270(int iParam0)//Position - 0xFB35
{
...
int func_271(int iParam0)//Position - 0xFB60
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_272(int iParam0)//Position - 0xFB8B
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_273(int iParam0)//Position - 0xFBB6
{
	if (func_246(iParam0))
	{
		return 0;
...
void func_274()//Position - 0xFBEB
{
	func_295("Running end routines.");
	Global_114088 = (Global_114088 - 1);
}

int func_275(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFC05
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_276((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_276((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_276(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xFC6A
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_277(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_277(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xFCE2
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_278(int iParam0, bool bParam1)//Position - 0xFD5D
{
	char* sVar0;
...
void func_279(char* sParam0)//Position - 0xFE2D
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_200(sParam0))
...
void func_280()//Position - 0xFE4C
{
	Global_21032 = 0;
	func_281();
}

void func_281()//Position - 0xFE5C
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_282(var uParam0)//Position - 0xFE7D
{
	if (func_218(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_283(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFEB3
{
...
void func_284(var uParam0, bool bParam1)//Position - 0xFED3
{
	func_285(&(uParam0->f_41), bParam1);
}

void func_285(var uParam0, bool bParam1)//Position - 0xFEE5
{
	int iVar0;
...
void func_286(int* iParam0, bool bParam1)//Position - 0xFF23
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_287(var uParam0, bool bParam1)//Position - 0xFF5E
{
	func_288(&(uParam0->f_35), bParam1);
}

void func_288(var uParam0, bool bParam1)//Position - 0xFF70
{
	int iVar0;
...
void func_289(int* iParam0)//Position - 0xFFAD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_290(var uParam0, int iParam1)//Position - 0xFFE5
{
	func_291(&(uParam0->f_28), iParam1);
}

void func_291(var uParam0, int iParam1)//Position - 0xFFF7
{
	int iVar0;
...
void func_292(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10039
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_293(int* iParam0)//Position - 0x10089
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_294(var uParam0)//Position - 0x100CA
{
	if (*uParam0 == -1)
	{
		return;
...
void func_295(char* sParam0)//Position - 0x10107
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_296(var uParam0)//Position - 0x10119
{
	*uParam0 = -1;
...
void func_297()//Position - 0x1014C
{
	func_295("Running start routines.");
	Global_114088++;
}

int func_298(int iParam0)//Position - 0x10166
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
