...
void __EntryFunction__()//Position - 0x0
{
	...
	if (!func_266(&iVar2, &Var0, Var1, 1f))
	{
		func_265();
	...
	while (true)
	{
		...
		func_204(Var0.f_0);
		func_197(&iLocal_53, &(Var0.f_9), Var1);
		if (Var0.f_0 == 44)
		{
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EB2
{
	int iVar0;
...
int func_55()//Position - 0x40F4
{
	func_56();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_56()//Position - 0x410D
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x420A
{
	return Global_43052 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x4218
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x430B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x4593
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x462E
{
...
int func_62(int iParam0, int iParam1)//Position - 0x47F6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x5397
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x53D2
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x5646
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x5682
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5BD1
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5C15
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x6394
{
	if (bParam2)
	{
...
int func_70(var uParam0)//Position - 0x63DB
{
...
bool func_71(int iParam0)//Position - 0x6436
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x6446
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x64A7
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x6822
{
	return Global_31959;
}

int func_75(int iParam0)//Position - 0x682D
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x683D
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x68DF
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x7004
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x705C
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7106
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
...
Vector3 func_81(struct<3> Param0, float fParam1)//Position - 0x719B
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_82(int iParam0)//Position - 0x71DF
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x7363
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x7371
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7E38
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7EBA
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x7F12
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x7F1B
{
	switch (iParam0)
	{
		case 1:
...
int func_89()//Position - 0x817A
{
	return func_90(PLAYER::PLAYER_ID());
}

int func_90(int iParam0)//Position - 0x818A
{
	return MISC::GET_BITS_IN_RANGE(Global_2689235[iParam0 /*453*/].f_318.f_3, 28, 31);
}

int func_91(int iParam0)//Position - 0x81A7
{
	return func_72(iParam0, 0, 0);
}

int func_92(int iParam0)//Position - 0x81B7
{
	switch (iParam0)
	{
		case -1:
...
bool func_93()//Position - 0x84C6
{
	return Global_100493.f_375 > 0;
}

var func_94()//Position - 0x84D7
{
	var uVar0;
...
void func_95(var uParam0, int iParam1)//Position - 0x851D
{
	if (iParam1 <= 0)
	{
		return;
...
void func_96(var uParam0, int iParam1)//Position - 0x85A3
{
...
void func_97(var uParam0, int iParam1)//Position - 0x85D6
{
	int iVar0;
	int iVar1;
...
int func_98(int iParam0, int iParam1)//Position - 0x8627
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_99(int iParam0)//Position - 0x86C9
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_100(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_100(bool bParam0, int iParam1, int iParam2)//Position - 0x86EB
{
	if (bParam0)
	{
		return iParam1;
...
int func_101(var uParam0)//Position - 0x8702
{
	return uParam0 & 15;
}

void func_102(var uParam0, int iParam1)//Position - 0x870F
{
...
void func_103(var uParam0, int iParam1)//Position - 0x8749
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8784
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
bool func_105()//Position - 0x87C0
{
	func_56();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_106(int iParam0)//Position - 0x87D9
{
	var uVar0;
	char cVar1[24];
...
bool func_107()//Position - 0x8832
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_108()//Position - 0x8848
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_109(char* sParam0, int iParam1, int iParam2)//Position - 0x885E
{
...
int func_110(bool bParam0)//Position - 0x88A0
{
...
struct<2> func_111(int iParam0)//Position - 0x88C8
{
	struct<2> Var0;
...
void func_112(int iParam0, var uParam1)//Position - 0x8D15
{
	switch (iParam0)
	{
		case 0:
...
int func_114(int iParam0)//Position - 0x9FED
{
	switch (iParam0)
	{
		case 0:
...
int func_115(int iParam0)//Position - 0xA333
{
	int iVar0;
...
void func_116(int iParam0)//Position - 0xA3D8
{
	struct<2> Var0;
...
void func_117(int iParam0)//Position - 0xA473
{
	if (iParam0 < 63)
	{
		func_118();
...
void func_119(int iParam0)//Position - 0xA4D1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_120(int iParam0)//Position - 0xA52A
{
...
int func_121(int iParam0)//Position - 0xA5AD
{
	int iVar0;
...
void func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA5DE
{
	func_123(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_123(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA5F3
{
	int iVar0;
...
int func_125(int iParam0, int iParam1, int iParam2)//Position - 0xA6A6
{
...
int func_126(int iParam0, int iParam1, int iParam2)//Position - 0xA6C1
{
	int iVar0;
...
int func_127(int iParam0)//Position - 0xA70D
{
	int iVar0;
...
int func_128(int iParam0)//Position - 0xA756
{
	if (func_129(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_129(int iParam0)//Position - 0xA776
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_130(int iParam0)//Position - 0xA797
{
	switch (iParam0)
	{
		case 5:
...
int func_132(int iParam0)//Position - 0xA867
{
	switch (iParam0)
	{
		case 5:
...
void func_133(var uParam0, bool bParam1, bool bParam2)//Position - 0xA8BA
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0xA9AF
{
	switch (iParam0)
	{
		case 5:
...
void func_135(bool bParam0)//Position - 0xAA1A
{
	int iVar0;
...
void func_136(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAA59
{
	if (bParam0)
	{
...
bool func_137()//Position - 0xAB9C
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_138(int iParam0, int iParam1)//Position - 0xABB6
{
	bool bVar0;
...
int func_139(int iParam0, bool bParam1)//Position - 0xAC01
{
	int iVar0;
	int iVar1;
...
int func_140(int iParam0)//Position - 0xAC42
{
...
bool func_141()//Position - 0xAC81
{
	return BitTest(Global_2621446, 3);
}

int func_142(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xAC8F
{
	int iVar0;
...
void func_144(int iParam0)//Position - 0xACE9
{
	if (iParam0 == 1)
	{
...
int func_145(char* sParam0)//Position - 0xAD0C
{
...
void func_146()//Position - 0xAD49
{
	Global_20471 = 0;
	func_147();
}

void func_147()//Position - 0xAD59
{
...
int func_151(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xAE3F
{
...
void func_152(int iParam0)//Position - 0xAFD7
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_154(int iParam0)//Position - 0xB054
{
	if (func_159())
	{
		return;
...
void func_155(int iParam0)//Position - 0xB087
{
	if (func_159())
	{
		return;
...
void func_156(bool bParam0, bool bParam1)//Position - 0xB111
{
	if (bParam0)
	{
		if (func_158(0))
...
bool func_157()//Position - 0xB185
{
	return BitTest(Global_1958711, 5);
}

int func_158(int iParam0)//Position - 0xB193
{
	if (iParam0 == 1)
	{
...
bool func_159()//Position - 0xB1EA
{
	return BitTest(Global_1958711, 19);
}

int func_160(int iParam0)//Position - 0xB1F9
{
...
int func_161(int iParam0)//Position - 0xB23A
{
	int iVar0;
...
void func_162(int iParam0)//Position - 0xB27F
{
...
int func_163(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB2B1
{
	int iVar0;
...
void func_164(var uParam0, int iParam1)//Position - 0xB3E8
{
	int iVar0;
...
bool func_165(int iParam0)//Position - 0xB437
{
	return func_166(iParam0, Global_43052);
}

int func_166(int iParam0, int iParam1)//Position - 0xB448
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_167(int iParam0)//Position - 0xB629
{
	if (Global_43052 == 15)
	{
		return 0;
...
int func_168()//Position - 0xB64B
{
	return func_169(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_169(char* sParam0, int iParam1)//Position - 0xB65C
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_171(int iParam0, int iParam1)//Position - 0xB6C9
{
	switch (iParam0->f_16)
	{
		case 0:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.6306f, 4699.115f, 35.38089f, 1812.8776f, 4710.457f, 42.053535f, 23.75f, false, true, 0))
				{
					if (func_129(iParam0->f_28[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], true), true) < 3f)
						{
							if (func_177(2))
							{
								if (func_175(iParam0->f_27))
								{
									func_174(iParam0->f_27, *iParam0);
...
void func_172()//Position - 0xBEAC
{
	func_27(&(Global_103950.f_2890), &Global_103950, 0, 1, 1, 0);
}

int func_173(var uParam0)//Position - 0xBEC7
{
	float fVar0;
...
void func_174(int iParam0, int iParam1)//Position - 0xBF55
{
	if (iParam0 == 1)
	{
		if (!func_132(iParam1))
...
int func_175(bool bParam0)//Position - 0xBFB9
{
	int iVar0;
...
int func_176(int iParam0)//Position - 0xC051
{
	if (func_129(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_177(int iParam0)//Position - 0xC07B
{
	bool bVar0;
...
var func_178()//Position - 0xC798
{
	return Global_100480.f_1;
}

int func_179()//Position - 0xC7A6
{
	if (Global_97363 != -1)
	{
...
bool func_182()//Position - 0xC80D
{
	return Global_100493.f_376 > 0;
}

var func_183(int iParam0, int iParam1)//Position - 0xC81E
{
	switch (iParam0)
	{
		case 5:
...
var func_184()//Position - 0xC856
{
	return Global_1575058;
}

int func_185()//Position - 0xC862
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_186(int iParam0)//Position - 0xC87E
{
	...
	{
		if (func_129(iParam0->f_28[0]) && !ENTITY::IS_ENTITY_ON_SCREEN(iParam0->f_28[0]))
		{
			if (func_129(PLAYER::PLAYER_PED_ID()) && !func_187(PLAYER::PLAYER_PED_ID(), iParam0->f_28[0], 50f, 1))
			{
...
bool func_187(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0xC967
{
...
int func_189(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)//Position - 0xCA7B
{
	...
	if (!*uParam6 == 3)
	{
		if (func_177(2))
		{
			if (!func_148())
			{
				if ((func_129(PLAYER::PLAYER_PED_ID()) && func_129(iParam0->f_28[0])) && func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
					func_286("start conversation");
					uVar0 = 16;
					if (*uParam6 == 0)
					{
					...
					{
						func_286("conversation ended");
						*uParam6 = 3;
						return 1;
					}
				}
			}
			else if (func_191(sParam3))
			{
				if (!*uParam6 == 1)
				{
					if (func_129(PLAYER::PLAYER_PED_ID()))
					{
						if (func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
						{
							func_286("pause conversation");
							func_190(1);
							*uParam6 = 1;
						}
					}
			...
			if (func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam6 == 1)
			{
				func_286("unpause conversation");
				func_190(0);
				*uParam6 = 2;
			}
		}
...
void func_190(int iParam0)//Position - 0xCB9D
{
	Global_22616 = iParam0;
}

int func_191(char* sParam0)//Position - 0xCBAA
{
	struct<6> Var0;
...
struct<6> func_192()//Position - 0xCBCA
{
	struct<6> Var0;
...
void func_193(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCBEE
{
...
void func_194(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCC29
{
...
void func_195(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCC7F
{
...
float func_196(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xCD1A
{
	struct<3> Var0;
...
void func_197(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xCD54
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_198(int iParam0, bool bParam1)//Position - 0xCE45
{
	if (iParam0 == -1)
	{
		return;
...
int func_199(int iParam0)//Position - 0xCE81
{
	if (Global_78315 == iParam0)
	{
		if (Global_78316 == -1)
...
void func_200(int iParam0, int iParam1)//Position - 0xCEBA
{
	bool bVar0;
	int iVar1;
...
bool func_201()//Position - 0xCF58
{
	return Global_97750;
}

void func_202(int iParam0)//Position - 0xCF64
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_203(iParam0);
...
void func_203(int iParam0)//Position - 0xCF7B
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_204(int iParam0)//Position - 0xD063
{
	if (iParam0 == -1)
	{
		iParam0 = func_168();
...
int func_205(int iParam0, bool bParam1)//Position - 0xD08B
{
	struct<27> Var0;
	...
	func_112(*iParam0, &Var0);
	if ((func_242(*iParam0) || func_240(*iParam0)) || Global_78564 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_206(int iParam0, var uParam1, int iParam2)//Position - 0xD2FB
{
	int iVar0;
	int iVar1;
...
int func_207(int iParam0)//Position - 0xD653
{
...
int func_208(var uParam0)//Position - 0xD673
{
...
int func_209(var uParam0)//Position - 0xD68B
{
...
void func_210(var uParam0)//Position - 0xD6B0
{
	int iVar0;
	int iVar1;
...
void func_211(int* iParam0)//Position - 0xD9B4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_212(var uParam0)//Position - 0xD9DF
{
	int iVar0;
...
int func_213(var uParam0, bool bParam1, bool bParam2)//Position - 0xDA5F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_214(int iParam0, int iParam1)//Position - 0xDC1D
{
	int iVar0;
...
int func_215(var uParam0, bool bParam1, int iParam2)//Position - 0xDC4D
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0)//Position - 0xDF09
{
...
int func_217(int iParam0, float fParam1)//Position - 0xDF3D
{
	float fVar0;
...
bool func_218(int iParam0, float fParam1)//Position - 0xDFB3
{
	return func_219(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDFCB
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_220(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_220(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE08C
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_221(int iParam0, int iParam1)//Position - 0xE1B8
{
	int iVar0;
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE2C7
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	{
		Var1 = { func_225(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_224(struct<3> Param0, struct<3> Param1)//Position - 0xE358
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_225(struct<3> Param0)//Position - 0xE379
{
	float fVar0;
	float fVar1;
...
void func_226(var uParam0)//Position - 0xE3B8
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_227(int iParam0, int iParam1)//Position - 0xE3D3
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0xE412
{
...
int func_229(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE43A
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_230(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE535
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_231(int iParam0, float fParam1)//Position - 0xE641
{
	var uVar0;
	struct<3> Var1;
...
int func_232(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xE6D6
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_233(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE764
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_234(int iParam0)//Position - 0xE7AC
{
...
void func_235(int iParam0)//Position - 0xE7F6
{
	int iVar0;
...
int func_236(int iParam0)//Position - 0xE893
{
	if (iParam0 == -1)
	{
		iParam0 = func_168();
...
int func_237(int iParam0)//Position - 0xE928
{
...
int func_240(int iParam0)//Position - 0xE9A7
{
	if ((func_241() && Global_100441.f_11 == 6) && iParam0 == func_169(&(Global_100441.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_242(int iParam0)//Position - 0xEA19
{
	if (func_110(0))
	{
...
int func_246(var uParam0)//Position - 0xEAFE
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_254(&(uParam0->f_48), "rcmrc_omega_2", "omega_idle_looking_around", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			{
				if (!func_249(&(uParam0->f_28[0]), 69, 2319.443f, 2583.5881f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_247(&(uParam0->f_35[0]), iVar0[1], 2331.08f, 2573.53f, 46.13f, 358.61f);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
...
void func_247(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xECCD
{
	func_248(iParam0);
...
void func_248(int* iParam0)//Position - 0xED0F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_249(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xEDAB
{
	if (func_250(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xEE07
{
	int iVar0;
...
int func_251(var uParam0, int iParam1)//Position - 0xEE95
{
	int iVar0;
...
int func_252(var uParam0)//Position - 0xEEDB
{
	if (func_209(uParam0))
	{
...
int func_253(int iParam0)//Position - 0xEF05
{
	int iVar0;
...
void func_254(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xEF36
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_255(var uParam0)//Position - 0xEF72
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_254(&(uParam0->f_48), "rcmrc_omega_1", "omega_idle_geiger_counter", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_249(&(uParam0->f_28[0]), 69, 2468.51f, 3437.39f, 49.9f, 180f, "OMEGA LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			if ((func_129(uParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0])) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
...
int func_256(int iParam0)//Position - 0xF1F6
{
	struct<27> Var0;
	bool bVar1;
...
bool func_260(int iParam0, char* sParam1)//Position - 0xF446
{
...
int func_261(int iParam0)//Position - 0xF528
{
...
int func_262(int iParam0)//Position - 0xF553
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_263(int iParam0)//Position - 0xF57E
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_264(int iParam0)//Position - 0xF5A9
{
	if (func_237(iParam0))
	{
		return 0;
...
void func_265()//Position - 0xF5DE
{
	func_286("Running end routines.");
	Global_113104 = (Global_113104 - 1);
}

int func_266(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xF5F8
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_267((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_267((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_267(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xF65D
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_268(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_268(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0xF6D5
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_270(char* sParam0)//Position - 0xF820
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_191(sParam0))
...
void func_271()//Position - 0xF83F
{
	Global_20471 = 0;
	func_272();
}

void func_272()//Position - 0xF84F
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22616 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_273(var uParam0)//Position - 0xF870
{
	if (func_209(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_274(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xF8A6
{
...
void func_275(var uParam0, bool bParam1)//Position - 0xF8C6
{
	func_276(&(uParam0->f_41), bParam1);
}

void func_276(var uParam0, bool bParam1)//Position - 0xF8D8
{
	int iVar0;
...
void func_277(int* iParam0, bool bParam1)//Position - 0xF916
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_278(var uParam0, bool bParam1)//Position - 0xF951
{
	func_279(&(uParam0->f_35), bParam1);
}

void func_279(var uParam0, bool bParam1)//Position - 0xF963
{
	int iVar0;
...
void func_280(int* iParam0)//Position - 0xF9A0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_281(var uParam0, int iParam1)//Position - 0xF9D8
{
	func_282(&(uParam0->f_28), iParam1);
}

void func_282(var uParam0, int iParam1)//Position - 0xF9EA
{
	int iVar0;
...
void func_283(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFA2B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_284(int* iParam0)//Position - 0xFA7B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_285(var uParam0)//Position - 0xFABC
{
	if (*uParam0 == -1)
	{
		return;
...
void func_286(char* sParam0)//Position - 0xFAF9
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_287(var uParam0)//Position - 0xFB0B
{
	*uParam0 = -1;
...
void func_288()//Position - 0xFB3E
{
	func_286("Running start routines.");
	Global_113104++;
}

int func_289(int iParam0)//Position - 0xFB58
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
