...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		RECORDING::REPLAY_CHECK_FOR_EVENT_THIS_FRAME("M_DD", 0);
...
void func_232(int iParam0, var uParam1)//Position - 0x2357C
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_234(Var7.f_1)) && iVar9 < 51)
			{
...
{
	if (!func_394() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
void func_434()//Position - 0x36181
{
	...
	{
		RECORDING::REPLAY_RECORD_BACK_FOR_TIME((2.5f + 8f), 2f, 3);
		iLocal_280 = 1;
	}
	if (!bLocal_278 && (MISC::GET_GAME_TIMER() - iLocal_281) > 2000)
	{
		RECORDING::REPLAY_RECORD_BACK_FOR_TIME((2.5f + 2f), 2f, 3);
		iLocal_280 = 1;
	}
}
...
void func_485(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x38878
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((func_486() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger")))
		{
