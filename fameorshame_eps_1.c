...
int func_13(var uParam0)//Position - 0x488
{
	int iVar0;
...
int func_14(int iParam0)//Position - 0x4AA
{
...
int func_16(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x4F7
{
	int iVar0;
...
void func_25(var uParam0, struct<3> Param1, struct<3> Param4, int iParam7, float fParam8, float fParam9)//Position - 0x2427
{
	uParam0->f_1 = { Param1 };
	uParam0->f_4 = { Param4 };
	uParam0->f_7 = iParam7;
...
void func_26(var uParam0, int iParam1, struct<3> Param2, struct<3> Param5, int iParam8, int iParam9, int iParam10)//Position - 0x2459
{
...
void func_27(var uParam0, var uParam1, struct<3> Param2, struct<3> Param5, var uParam8, var uParam9, var uParam10)//Position - 0x2494
{
	*uParam0 = { Param2 };
	uParam0->f_3 = { Param5 };
	uParam0->f_6 = uParam8;
...
void func_34(int iParam0, int iParam1)//Position - 0x26EB
{
...
int func_41(int iParam0)//Position - 0x2993
{
	if (iParam0 == 1)
	{
...
void func_45(int iParam0)//Position - 0x2B24
{
...
void func_52(int* iParam0)//Position - 0x2C95
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_54(int* iParam0)//Position - 0x2CFF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
