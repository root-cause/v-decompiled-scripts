...
int func_2()//Position - 0x10C
{
	...
	if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_72) > 100f)
	{
		return 1;
	}
	return 0;
...
int func_7(int iParam0, int iParam1)//Position - 0x431
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_8(Global_100162) && iParam1 != 0)
		{
			Global_100162 = 0;
		}
	}
...
void func_11()//Position - 0x574
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_14(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_12(iVar0) && (!func_16(14) || Global_112337))
			{
...
void func_21()//Position - 0x769
{
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			iLocal_68[iVar0] = PED::CREATE_PED(4, iLocal_69[iVar0], Local_72 + Local_74[iVar0 /*3*/], 0f, true, true);
			...
			PED::SET_PED_CAN_RAGDOLL(iLocal_68[iVar0], false);
		}
		iVar0++;
	}
}
...
void func_22()//Position - 0x896
{
	...
	func_26(iLocal_66, &Local_72, &fLocal_73, &cVar0);
	Var1.f_1 = -1;
	Var1.f_17 = 4;
	Var1.f_17.f_8 = 4;
	Var1.f_17.f_13 = 4;
	...
	{
		case 97:
			Local_74[0 /*3*/] = { Vector(45.5004f, -205.8167f, -1416.5402f) - Local_72 };
			Local_74[1 /*3*/] = { Vector(45.5004f, -207.5375f, -1423.8984f) - Local_72 };
			Local_74[2 /*3*/] = { Vector(45.5004f, -210.4254f, -1428.5013f) - Local_72 };
			Local_74[3 /*3*/] = { Vector(45.5004f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-205.8167f, -210.4254f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1416.5402f, -1428.5013f)) - Local_72 };
		...
		case 158:
			Local_74[0 /*3*/] = { 1.2712f, 6.071f, -0.75f };
			Local_74[1 /*3*/] = { 3.8061f, 5.7599f, -0.5f };
			Local_74[2 /*3*/] = { 4.541f, 7.8487f, -0.4f };
			Local_74[3 /*3*/] = { 3.1051f, 13.7474f, -0.3463f };
		...
		default:
			Local_74[0 /*3*/] = { 0f, 0f, 0f };
			Local_74[1 /*3*/] = { 0f, 0f, 0f };
			Local_74[2 /*3*/] = { 0f, 0f, 0f };
			Local_74[3 /*3*/] = { 0f, 0f, 0f };
			fLocal_75[0] = 0f;
			fLocal_75[1] = 0f;
			fLocal_75[2] = 0f;
			fLocal_75[3] = 0f;
...
int func_23(struct<109> Param0, var uParam1)//Position - 0xBE6
{
	uParam1->f_119 = 0;
	switch (Param0.f_2)
	{
...
void func_24(var uParam0, int iParam1, int iParam2, int iParam3, struct<3> Param4, float fParam5)//Position - 0x3F60
{
...
bool func_28(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x4254
{
	if (bParam2)
	{
