...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112473[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_273(&(Global_112473[Var0.f_0 /*10*/].f_9));
			}
		}
		func_261(&Var0, 1);
	}
	iVar2[0] = 24;
	if (!func_258(&iVar2, &Var0, Var1, 1f))
	{
		func_257();
	...
	if (func_247(41))
	{
		func_274("SP_MISSION_FRANKLIN_1 is available... [TERMINATING]");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	else
	{
		func_274("SP_MISSION_FRANKLIN_1 is not available...");
	}
	while (!func_238(&Var0))
	{
		SYSTEM::WAIT(0);
	...
	iLocal_54 = PED::ADD_SCENARIO_BLOCKING_AREA(-103.0011f, -1281.636f, 26.3686f, -23.246f, -1241.361f, 30.335f, false, true, true, true);
	...
	while (true)
	{
		...
		if (func_247(41))
		{
			func_274("SP_MISSION_FRANKLIN_1 became available... [TERMINATING]");
			func_261(&Var0, 1);
		}
		else
		{
		...
		if (func_202(Var0.f_35[0]))
		{
			if (!func_201(-72.323f, -1258.643f, 28.648f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[0], true), 1056964608))
			{
				func_274("Player has moved HAO's vehicle [TERMINATING]");
				func_198(&Var0);
				func_261(&Var0, 1);
			}
		}
		func_197(Var0.f_0);
		func_190(&iLocal_53, &(Var0.f_9), Var1);
		func_185(&Var0, Var1, "HAO1AU", "HAO1_HCO", 3, "HAO", 5000, 1101004800);
		if (func_171(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_1(int iParam0)//Position - 0x2C9
{
...
int func_2(var* uParam0)//Position - 0x2E7
{
	struct<4> Var0;
	char* sVar1;
...
void func_3(int iParam0, char* sParam1)//Position - 0x3AA
{
	func_21(sParam1);
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1A2C
{
	int iVar0;
	int iVar1;
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28D7
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x295F
{
...
int func_29(int iParam0)//Position - 0x299F
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x29CD
{
...
int func_31(int iParam0)//Position - 0x2AA9
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2AEB
{
	int iVar0;
...
int func_33(int iParam0, bool bParam1, int iParam2)//Position - 0x2B4E
{
	int iVar0;
...
int func_34(bool bParam0, int iParam1)//Position - 0x2BDC
{
	struct<82> Var0;
...
void func_35(bool bParam0, var uParam1, int iParam2)//Position - 0x2C1E
{
	int iVar0;
...
bool func_36(bool bParam0)//Position - 0x2E7A
{
	return bParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E86
{
	int iVar0;
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x31E1
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x33D4
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x34A5
{
	char* sVar0;
...
int func_43(int iParam0, bool bParam1, bool bParam2)//Position - 0x35D4
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3642
{
...
int func_45(int iParam0)//Position - 0x371B
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x3758
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x377D
{
	return Global_1998[iParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x378C
{
	bool bVar0;
	int iVar1;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x392C
{
	int iVar0;
	var uVar1;
...
int func_50(var uParam0)//Position - 0x3969
{
	int iVar0;
	int iVar1;
...
int func_52(int iParam0, int iParam1)//Position - 0x39A9
{
	int iVar0;
	var uVar1;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39D5
{
	int iVar0;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F1D
{
	int iVar0;
...
int func_55()//Position - 0x415F
{
	func_56();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_56()//Position - 0x4178
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x4275
{
	return Global_43052 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x4283
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x4376
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x45FE
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x4699
{
...
int func_62(int iParam0, int iParam1)//Position - 0x4861
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x5402
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x543D
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x56B1
{
	bool bVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x56ED
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5C3C
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5C80
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x63FF
{
	if (bParam2)
	{
...
int func_70(var uParam0)//Position - 0x6446
{
...
bool func_71(int iParam0)//Position - 0x64A1
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x64B1
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x6512
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x688D
{
	return Global_31959;
}

int func_75(int iParam0)//Position - 0x6898
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x68A8
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x694A
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x706F
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x70C7
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7171
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
...
Vector3 func_81(struct<3> Param0, float fParam1)//Position - 0x7206
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_82(int iParam0)//Position - 0x724A
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x73CE
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x73DC
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7EA3
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7F25
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x7F7D
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x7F86
{
	switch (iParam0)
	{
		case 1:
...
int func_115(var* uParam0)//Position - 0xA40E
{
	int iVar0;
...
int func_171(var uParam0, int iParam1)//Position - 0xB7A4
{
	switch (uParam0->f_16)
	{
		case 0:
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_176(2))
							{
								if (func_175(uParam0->f_27))
								{
									...
									func_274("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.8885f, 371.9034f, 103.9884f, 241.5898f, 359.6458f, 107.3461f, 1.25f, false, true, 0))
					{
						if (func_176(2))
						{
							...
							{
								func_174(uParam0->f_27, *uParam0);
								func_274("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.948f, 4143.44f, 42.29295f, 2722.213f, 4144.521f, 45.43182f, 10f, false, true, 0))
				{
					if (func_176(2))
					{
						...
						{
							func_174(1, *uParam0);
							func_274("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.1104f, 68.46017f, -1028.566f, 395.4613f, 94.57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.7556f, 68.02096f, -1021.451f, 336.3458f, 93.18714f, 14.5f, false, true, 0))
						{
							if (func_176(2))
							{
								...
								{
									func_174(uParam0->f_27, *uParam0);
									func_274("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_174(int iParam0, int iParam1)//Position - 0xC031
{
	if (iParam0 == 1)
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_274("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_274("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_184()) || Global_112433) || Global_31962) || func_183()) || func_182(8, -1)) || func_93()) || func_181()) || func_180()) || func_179()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_184()) || Global_31962) || func_183()) || func_182(8, -1)) || func_180()) || func_93()) || func_181()) || func_179()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_184()) || Global_112433) || Global_31962) || func_183()) || func_182(8, -1)) || func_180()) || func_93()) || func_181()) || func_179()) || Global_113386.f_7688.f_919[bVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_184()) || Global_112433) || Global_31962) || func_183()) || func_182(8, -1)) || func_93()) || func_181()) || func_179()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_184() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_182(8, -1)) || func_179()) || func_178()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_182(8, -1) || func_93()) || func_181()) || func_178()) || func_177())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_184()) || Global_31962) || func_183()) || func_182(8, -1)) || func_181()) || func_180()) || func_179()) || Global_113386.f_7688.f_919[bVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_184()) || func_181()) || Global_112433) || Global_31962) || func_183()) || Global_44238) || func_182(8, -1)) || func_180()) || func_178()) || func_179()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_184()) || Global_112433) || Global_31962) || func_183()) || func_182(8, -1)) || func_180()) || func_178()) || func_93()) || func_181()) || func_179())
						{
							return 0;
						}
						break;
...
var func_177()//Position - 0xC849
{
	return Global_100480.f_1;
}

int func_178()//Position - 0xC857
{
	if (Global_97363 != -1)
	{
...
bool func_181()//Position - 0xC8BE
{
	return Global_100493.f_376 > 0;
}

var func_182(int iParam0, int iParam1)//Position - 0xC8CF
{
	switch (iParam0)
	{
		case 5:
...
var func_183()//Position - 0xC907
{
	return Global_1575058;
}

int func_184()//Position - 0xC913
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_185(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xC92F
{
	var uVar0;
	
	if ((((func_129(PLAYER::PLAYER_PED_ID()) && func_129(uParam0->f_28[0])) && !func_148()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam6) && func_189(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_188(&uVar0, iParam4, uParam0->f_28[0], sParam5, 0, 1);
		func_186(&uVar0, cParam2, sParam3, 7, 0, 0);
...
void func_186(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC9B7
{
	func_187(uParam0, 145, sParam1, iParam4, iParam5, 0);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
...
void func_187(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC9F2
{
...
void func_188(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCA48
{
...
float func_189(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xCAE3
{
	struct<3> Var0;
...
void func_190(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xCB1D
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_189(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_193(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_189(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_195(iParam0);
				}
			}
...
void func_191(int iParam0, bool bParam1)//Position - 0xCC0E
{
	if (iParam0 == -1)
	{
		return;
...
int func_192(int iParam0)//Position - 0xCC4A
{
	if (Global_78315 == iParam0)
	{
		if (Global_78316 == -1)
...
void func_193(int iParam0, int iParam1)//Position - 0xCC83
{
	bool bVar0;
	int iVar1;
...
bool func_194()//Position - 0xCD21
{
	return Global_97750;
}

void func_195(int iParam0)//Position - 0xCD2D
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_196(iParam0);
...
void func_196(int iParam0)//Position - 0xCD44
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_197(int iParam0)//Position - 0xCE2C
{
	if (iParam0 == -1)
	{
		iParam0 = func_168();
...
void func_198(var uParam0)//Position - 0xCE54
{
	int iVar0;
	int iVar1;
...
void func_199(int iParam0)//Position - 0xD158
{
	int iVar0;
...
void func_200(int* iParam0)//Position - 0xD1F5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_201(struct<2> Param0, float fParam1, struct<2> Param2, Vector3 vParam3, float fParam4)//Position - 0xD220
{
	if (fParam4 < 0f)
	{
		fParam4 = 0f;
...
int func_202(int iParam0)//Position - 0xD259
{
	if (func_129(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_203(var uParam0, bool bParam1)//Position - 0xD283
{
	struct<27> Var0;
	
	if (Global_78319)
	{
		func_274("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_112(*uParam0, &Var0);
	if ((func_237(*uParam0) || func_235(*uParam0)) || Global_78564 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_274("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_231(*uParam0))
	{
		if (*uParam0 == 19)
		{
			func_199(uParam0->f_28[0]);
		}
		func_274("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1)
	{
	...
	if (*uParam0 == 10)
	{
		...
		{
			func_274("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_274("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
...
void func_204(int iParam0, var uParam1, int iParam2)//Position - 0xD4F3
{
	int iVar0;
	int iVar1;
...
int func_205(int iParam0)//Position - 0xD84B
{
...
int func_206(var uParam0)//Position - 0xD86B
{
...
int func_207(var uParam0)//Position - 0xD883
{
...
void func_208(var uParam0)//Position - 0xD8A8
{
	int iVar0;
...
int func_209(var uParam0, bool bParam1, bool bParam2)//Position - 0xD928
{
	int iVar0;
	int iVar1;
	int iVar2;
				...
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						if (func_202(iVar2))
						{
							...
							{
								if (func_202(uParam0->f_35[iVar0]))
								{
...
int func_210(int iParam0, int iParam1)//Position - 0xDAE6
{
	int iVar0;
...
int func_211(var uParam0, bool bParam1, int iParam2)//Position - 0xDB16
{
	int iVar0;
	int iVar1;
...
int func_212(int iParam0)//Position - 0xDDD2
{
...
int func_213(int iParam0, float fParam1)//Position - 0xDE06
{
	float fVar0;
...
bool func_214(int iParam0, float fParam1)//Position - 0xDE7C
{
	return func_215(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_215(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDE94
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_216(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_216(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xDF55
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_217(int iParam0, int iParam1)//Position - 0xE081
{
	int iVar0;
...
int func_219(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE190
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	{
		Var1 = { func_221(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_220(Var1, Var0);
...
float func_220(struct<3> Param0, struct<3> Param1)//Position - 0xE221
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_221(struct<3> Param0)//Position - 0xE242
{
	float fVar0;
	float fVar1;
...
void func_222(var uParam0)//Position - 0xE281
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_223(int iParam0, int iParam1)//Position - 0xE29C
{
	int iVar0;
...
int func_224(int iParam0)//Position - 0xE2DB
{
...
int func_225(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE303
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_226(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE3FE
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_227(int iParam0, float fParam1)//Position - 0xE50A
{
	var uVar0;
	struct<3> Var1;
...
int func_228(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xE59F
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_229(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE62D
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_230(int iParam0)//Position - 0xE675
{
...
int func_231(int iParam0)//Position - 0xE6BF
{
	if (iParam0 == -1)
	{
		iParam0 = func_168();
...
int func_232(int iParam0)//Position - 0xE754
{
...
int func_235(int iParam0)//Position - 0xE7D3
{
	if ((func_236() && Global_100441.f_11 == 6) && iParam0 == func_169(&(Global_100441.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_237(int iParam0)//Position - 0xE845
{
	if (func_110(0))
	{
...
int func_239(var uParam0)//Position - 0xE88C
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_246(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar3))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				if (!func_243(&(uParam0->f_28[0]), 53, -71.93684f, -1259.7f, 28.19359f, -177.55f, "HAO LAUNCHER RC - HAO", 1))
				{
					bVar4 = false;
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_241(&(uParam0->f_35[0]), iVar0[1], -72.3226f, -1258.643f, 28.1915f, 90.8326f);
			...
			{
				func_241(&(uParam0->f_35[1]), iVar0[3], -91.07f, -1273.45f, 28.86f, 0.57f);
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_35[1], 10);
			}
			if (func_129(uParam0->f_28[0]))
			{
				func_240(&(uParam0->f_41[0]), iVar0[2], -71.93684f, -1259.078f, 28.19359f, -177.55f);
		...
		case 3:
			if (func_128(uParam0->f_28[0]) && func_202(uParam0->f_35[0]))
			{
...
void func_240(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xECF6
{
	func_200(iParam0);
...
void func_241(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xED1D
{
	func_242(iParam0);
...
void func_242(int* iParam0)//Position - 0xED5F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_243(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xEDFB
{
	if (func_244(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_244(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xEE57
{
	int iVar0;
...
int func_245(var uParam0, int iParam1)//Position - 0xEEE5
{
	int iVar0;
...
int func_246(int iParam0)//Position - 0xEF2B
{
	int iVar0;
...
int func_247(int iParam0)//Position - 0xEF5C
{
	int iVar0;
...
int func_248(int iParam0)//Position - 0xEFC4
{
	struct<27> Var0;
	bool bVar1;
...
bool func_252(int iParam0, char* sParam1)//Position - 0xF214
{
...
int func_253(int iParam0)//Position - 0xF2F6
{
...
int func_254(int iParam0)//Position - 0xF321
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_255(int iParam0)//Position - 0xF34C
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_256(int iParam0)//Position - 0xF377
{
	if (func_232(iParam0))
	{
		return 0;
...
void func_257()//Position - 0xF3AC
{
	func_274("Running end routines.");
	Global_113104 = (Global_113104 - 1);
}

int func_258(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xF3C6
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_259((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_259((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_259(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xF42B
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_260(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_260(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0xF4A3
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_261(int iParam0, bool bParam1)//Position - 0xF51E
{
	if (bParam1)
	{
		func_274("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_262(iParam0, 0, 0, 0);
	}
	if (iLocal_53 != -1)
	{
		func_274("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_196(&iLocal_53);
	}
...
void func_262(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xF572
{
...
void func_263(var uParam0, bool bParam1)//Position - 0xF592
{
	func_264(&(uParam0->f_41), bParam1);
}

void func_264(var uParam0, bool bParam1)//Position - 0xF5A4
{
	int iVar0;
...
void func_265(int* iParam0, bool bParam1)//Position - 0xF5E2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_266(var uParam0, bool bParam1)//Position - 0xF61D
{
	func_267(&(uParam0->f_35), bParam1);
}

void func_267(var uParam0, bool bParam1)//Position - 0xF62F
{
	int iVar0;
...
void func_268(int* iParam0)//Position - 0xF66C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_269(var uParam0, int iParam1)//Position - 0xF6A4
{
	func_270(&(uParam0->f_28), iParam1);
}

void func_270(var uParam0, int iParam1)//Position - 0xF6B6
{
	int iVar0;
...
void func_271(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF6F7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_272(int* iParam0)//Position - 0xF747
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_273(var uParam0)//Position - 0xF788
{
	if (*uParam0 == -1)
	{
		return;
...
void func_274(char* sParam0)//Position - 0xF7C5
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_275(var uParam0)//Position - 0xF7D7
{
	*uParam0 = -1;
...
void func_276()//Position - 0xF80A
{
	func_274("Running start routines.");
	Global_113104++;
}

int func_277(int iParam0)//Position - 0xF824
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
