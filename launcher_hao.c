...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112897[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_281(&(Global_112897[Var0.f_0 /*10*/].f_9));
			}
		}
		func_269(&Var0, 1);
	}
	...
	if (func_255(41))
	{
		func_282("SP_MISSION_FRANKLIN_1 is available... [TERMINATING]");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	else
	{
		func_282("SP_MISSION_FRANKLIN_1 is not available...");
	}
	while (!func_246(&Var0))
	{
		SYSTEM::WAIT(0);
	...
	iLocal_92 = PED::ADD_SCENARIO_BLOCKING_AREA(-103.0011f, -1281.6357f, 26.3686f, -23.246f, -1241.361f, 30.335f, false, true, true, true);
	...
	while (true)
	{
		...
		if (func_255(41))
		{
			func_282("SP_MISSION_FRANKLIN_1 became available... [TERMINATING]");
			func_269(&Var0, 1);
		}
		else
		{
		...
		if (func_210(Var0.f_35[0]))
		{
			if (!func_209(-72.323f, -1258.643f, 28.648f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[0], true), 1056964608))
			{
				func_282("Player has moved HAO's vehicle [TERMINATING]");
				func_206(&Var0);
				func_269(&Var0, 1);
			}
		}
		func_205(Var0.f_0);
		func_198(&iLocal_91, &(Var0.f_9), Var61);
		func_193(&Var0, Var61, "HAO1AU", "HAO1_HCO", 3, "HAO", 5000, 1101004800);
		if (func_179(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_49(int iParam0, int iParam1)//Position - 0x3926
{
	int iVar0;
	var uVar1;
...
int func_50(int iParam0, var uParam1)//Position - 0x3955
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(uParam1));
}

int func_51(var uParam0)//Position - 0x396A
{
	int iVar0;
	int iVar1;
...
int func_52()//Position - 0x399E
{
	return Global_1574918;
}

int func_53(int iParam0, int iParam1)//Position - 0x39AA
{
	int iVar0;
	var uVar1;
...
int func_54(int iParam0, var uParam1)//Position - 0x39CE
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(uParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39E3
{
	int iVar0;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F2C
{
	int iVar0;
...
int func_64(int iParam0, int iParam1)//Position - 0x488F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, var* uParam1)//Position - 0x5540
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0)//Position - 0x557B
{
	int iVar0;
...
void func_67(int iParam0)//Position - 0x57EF
{
	bool bVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x582B
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5D7A
{
	int iVar0;
	int iVar1;
...
bool func_70(int iParam0, var uParam1, var uParam2)//Position - 0x5DBE
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x653D
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x6584
{
...
bool func_73(int iParam0)//Position - 0x65DF
{
	return func_74(iParam0, 0, 1);
}

int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x65EF
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_75(int iParam0)//Position - 0x664F
{
	switch (iParam0)
	{
		case 0:
...
int func_76()//Position - 0x69F7
{
	return Global_32283;
}

int func_77(int iParam0)//Position - 0x6A02
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A12
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_79(int iParam0, bool bParam1)//Position - 0x6AB4
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80()//Position - 0x721F
{
...
int func_81()//Position - 0x751A
{
	return Global_2652364.f_2650;
}

int func_82(struct<3> Param0)//Position - 0x7529
{
...
Vector3 func_83(struct<3> Param0)//Position - 0x7553
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, Param0);
}

Vector3 func_84()//Position - 0x7568
{
	return -880f, -2770f, -50f;
}

int func_85(int iParam0)//Position - 0x757F
{
	if (iParam0 != func_94())
	{
...
Vector3 func_86(int iParam0, int iParam1)//Position - 0x75D7
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_87(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7681
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_88(struct<3> Param0, float fParam3)//Position - 0x7716
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_89(int iParam0)//Position - 0x775A
{
	struct<6> Var0;
...
struct<6> func_90(int iParam0)//Position - 0x78DE
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0)//Position - 0x78EC
{
	struct<6> Var0;
...
void func_160(int iParam0)//Position - 0xB5C5
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
void func_162(int iParam0)//Position - 0xB642
{
	if (func_167())
	{
		return;
...
void func_163(int iParam0)//Position - 0xB675
{
	if (func_167())
	{
		return;
...
void func_164(bool bParam0, bool bParam1)//Position - 0xB6FF
{
	if (bParam0)
	{
		if (func_166(0))
...
bool func_165()//Position - 0xB773
{
	return BitTest(Global_1963795, 5);
}

int func_166(int iParam0)//Position - 0xB781
{
	if (iParam0 == 1)
	{
...
bool func_167()//Position - 0xB7D8
{
	return BitTest(Global_1963795, 19);
}

int func_168(int iParam0)//Position - 0xB7E7
{
...
int func_169(int iParam0)//Position - 0xB828
{
	int iVar0;
...
void func_170(int iParam0)//Position - 0xB86D
{
...
int func_171(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB89F
{
	int iVar0;
...
void func_172(var uParam0, int iParam1)//Position - 0xB9D6
{
	int iVar0;
...
bool func_173(int iParam0)//Position - 0xBA25
{
	return func_174(iParam0, Global_43377);
}

int func_174(int iParam0, int iParam1)//Position - 0xBA36
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_175(int iParam0)//Position - 0xBC17
{
	if (Global_43377 == 15)
	{
		return 0;
...
int func_176()//Position - 0xBC39
{
	return func_177(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_177(char* sParam0, int iParam1)//Position - 0xBC4A
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_179(var uParam0, int iParam1)//Position - 0xBCB7
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_180()//Position - 0xC49C
{
	func_27(&(Global_104373.f_2890), &Global_104373, 0, 1, 1, 0);
}

int func_181(var uParam0)//Position - 0xC4B7
{
	float fVar0;
...
void func_182(int iParam0, int iParam1)//Position - 0xC545
{
	if (iParam0 == 1)
	{
		if (!func_139(iParam1))
...
int func_183(bool bParam0)//Position - 0xC5A9
{
	int iVar0;
...
int func_184(int iParam0)//Position - 0xC640
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_192()) || Global_112857) || Global_32286) || func_191()) || func_190(8, -1)) || func_100()) || func_189()) || func_188()) || func_187()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_192()) || Global_32286) || func_191()) || func_190(8, -1)) || func_188()) || func_100()) || func_189()) || func_187()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_192()) || Global_112857) || Global_32286) || func_191()) || func_190(8, -1)) || func_188()) || func_100()) || func_189()) || func_187()) || Global_113810.f_7691.f_919[bVar0] == 5) || Global_43924 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_192()) || Global_112857) || Global_32286) || func_191()) || func_190(8, -1)) || func_100()) || func_189()) || func_187()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_192() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_190(8, -1)) || func_187()) || func_186()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_190(8, -1) || func_100()) || func_189()) || func_186()) || func_185())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_192()) || Global_32286) || func_191()) || func_190(8, -1)) || func_189()) || func_188()) || func_187()) || Global_113810.f_7691.f_919[bVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_192()) || func_189()) || Global_112857) || Global_32286) || func_191()) || Global_44569) || func_190(8, -1)) || func_188()) || func_186()) || func_187()) || Global_113810.f_7691.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_192()) || Global_112857) || Global_32286) || func_191()) || func_190(8, -1)) || func_188()) || func_186()) || func_100()) || func_189()) || func_187())
						{
							return 0;
						}
						break;
...
var func_185()//Position - 0xCD5D
{
	return Global_100872.f_1;
}

int func_186()//Position - 0xCD6B
{
	if (Global_97735 != -1)
	{
...
bool func_189()//Position - 0xCDD2
{
	return Global_100885.f_394 > 0;
}

var func_190(int iParam0, int iParam1)//Position - 0xCDE3
{
	switch (iParam0)
	{
		case 5:
...
var func_191()//Position - 0xCE1B
{
	return Global_1575063;
}

int func_192()//Position - 0xCE27
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_193(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xCE43
{
	var uVar0;
	
	if ((((func_136(PLAYER::PLAYER_PED_ID()) && func_136(uParam0->f_28[0])) && !func_156()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_197(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_194(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCECB
{
...
void func_195(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCF06
{
...
void func_196(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCF5C
{
...
float func_197(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xCFF7
{
	struct<3> Var0;
...
void func_198(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD031
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_199(int iParam0, bool bParam1)//Position - 0xD122
{
	if (iParam0 == -1)
	{
		return;
...
int func_200(int iParam0)//Position - 0xD15E
{
	if (Global_78685 == iParam0)
	{
		if (Global_78686 == -1)
...
void func_201(int iParam0, int iParam1)//Position - 0xD197
{
	bool bVar0;
	int iVar1;
...
bool func_202()//Position - 0xD235
{
	return Global_98122;
}

void func_203(int iParam0)//Position - 0xD241
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_204(iParam0);
...
void func_204(int iParam0)//Position - 0xD258
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_205(int iParam0)//Position - 0xD340
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
void func_206(var uParam0)//Position - 0xD368
{
	int iVar0;
	int iVar1;
...
void func_207(int iParam0)//Position - 0xD66C
{
	int iVar0;
...
void func_208(int* iParam0)//Position - 0xD709
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_209(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)//Position - 0xD734
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_210(int iParam0)//Position - 0xD76D
{
	if (func_136(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_211(var uParam0, bool bParam1)//Position - 0xD797
{
	struct<27> Var0;
	...
	func_119(*uParam0, &Var0);
	if ((func_245(*uParam0) || func_243(*uParam0)) || Global_78935 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_212(int iParam0, var uParam1, int iParam2)//Position - 0xDA07
{
	int iVar0;
	int iVar1;
...
int func_213(int iParam0)//Position - 0xDD5F
{
...
int func_214(var uParam0)//Position - 0xDD7F
{
...
int func_215(var uParam0)//Position - 0xDD97
{
...
void func_216(var uParam0)//Position - 0xDDBC
{
	int iVar0;
...
int func_217(var uParam0, bool bParam1, bool bParam2)//Position - 0xDE3C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_218(int iParam0, int iParam1)//Position - 0xDFFA
{
	int iVar0;
...
int func_219(var uParam0, bool bParam1, int iParam2)//Position - 0xE02A
{
	int iVar0;
	int iVar1;
...
int func_220(int iParam0)//Position - 0xE2E6
{
...
int func_221(int iParam0, float fParam1)//Position - 0xE31A
{
	float fVar0;
...
bool func_222(int iParam0, float fParam1)//Position - 0xE390
{
	return func_223(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_223(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE3A8
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_224(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE469
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_225(int iParam0, int iParam1)//Position - 0xE595
{
	int iVar0;
...
int func_227(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE6A4
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_228(struct<3> Param0, struct<3> Param3)//Position - 0xE735
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_229(struct<3> Param0)//Position - 0xE756
{
	float fVar0;
	float fVar1;
...
void func_230(var uParam0)//Position - 0xE795
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_231(int iParam0, int iParam1)//Position - 0xE7B0
{
	int iVar0;
...
int func_232(int iParam0)//Position - 0xE7EF
{
...
int func_233(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE817
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_234(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE912
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_235(int iParam0, float fParam1)//Position - 0xEA1E
{
	var uVar0;
	struct<3> Var1;
...
int func_236(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xEAB3
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_237(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEB41
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_238(int iParam0)//Position - 0xEB89
{
...
int func_239(int iParam0)//Position - 0xEBD3
{
	if (iParam0 == -1)
	{
		iParam0 = func_176();
...
int func_240(int iParam0)//Position - 0xEC68
{
...
int func_243(int iParam0)//Position - 0xECE7
{
	if ((func_244() && Global_100833.f_11 == 6) && iParam0 == func_177(&(Global_100833.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_245(int iParam0)//Position - 0xED59
{
	if (func_117(0))
	{
...
int func_246(int iParam0)//Position - 0xED81
{
	if (!func_247(iParam0))
	{
		return 0;
...
int func_247(var uParam0)//Position - 0xEDA0
{
	int iVar0[4];
	int iVar5;
	int iVar6;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_254(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar7))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			{
				if (!func_251(&(uParam0->f_28[0]), 53, -71.936844f, -1259.7f, 28.193594f, -177.55f, "HAO LAUNCHER RC - HAO", 1))
				{
					bVar8 = false;
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_249(&(uParam0->f_35[0]), iVar0[1], -72.3226f, -1258.6433f, 28.1915f, 90.8326f);
			...
			{
				func_249(&(uParam0->f_35[1]), iVar0[3], -91.07f, -1273.45f, 28.86f, 0.57f);
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_35[1], 10);
			}
			if (func_136(uParam0->f_28[0]))
			{
				func_248(&(uParam0->f_41[0]), iVar0[2], -71.936844f, -1259.0775f, 28.193594f, -177.55f);
		...
		case 3:
			if (func_135(uParam0->f_28[0]) && func_210(uParam0->f_35[0]))
			{
...
void func_248(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF20A
{
	func_208(iParam0);
...
void func_249(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF231
{
	func_250(iParam0);
...
void func_250(int* iParam0)//Position - 0xF273
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_251(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF30F
{
...
int func_252(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF36B
{
	int iVar0;
...
int func_253(var uParam0, int iParam1)//Position - 0xF3F9
{
	int iVar0;
...
int func_254(int iParam0)//Position - 0xF43F
{
	int iVar0;
...
int func_255(int iParam0)//Position - 0xF470
{
	int iVar0;
...
int func_256(int iParam0)//Position - 0xF4D8
{
	struct<27> Var0;
	bool bVar32;
...
int func_257(int iParam0)//Position - 0xF529
{
	char* sVar0;
...
int func_258(int iParam0)//Position - 0xF5E2
{
	var uVar0;
...
int func_259(int iParam0)//Position - 0xF6A3
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_260(int iParam0, char* sParam1)//Position - 0xF728
{
...
int func_261(int iParam0)//Position - 0xF80A
{
...
int func_262(int iParam0)//Position - 0xF835
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_263(int iParam0)//Position - 0xF860
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_264(int iParam0)//Position - 0xF88B
{
	if (func_240(iParam0))
	{
		return 0;
...
void func_265()//Position - 0xF8C0
{
	func_282("Running end routines.");
	Global_113528 = (Global_113528 - 1);
}

int func_266(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF8DA
{
	int iVar0;
...
int func_267(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xF93F
{
	int iVar0;
	struct<7> Var1;
...
int func_268(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xF9B7
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_269(int iParam0, bool bParam1)//Position - 0xFA32
{
	if (bParam1)
	{
...
void func_270(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFA86
{
...
void func_271(var uParam0, bool bParam1)//Position - 0xFAA6
{
	func_272(&(uParam0->f_41), bParam1);
}

void func_272(var uParam0, bool bParam1)//Position - 0xFAB8
{
	int iVar0;
...
void func_273(int* iParam0, bool bParam1)//Position - 0xFAF6
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_274(var uParam0, bool bParam1)//Position - 0xFB31
{
	func_275(&(uParam0->f_35), bParam1);
}

void func_275(var uParam0, bool bParam1)//Position - 0xFB43
{
	int iVar0;
...
void func_276(int* iParam0)//Position - 0xFB80
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_277(var uParam0, int iParam1)//Position - 0xFBB8
{
	func_278(&(uParam0->f_28), iParam1);
}

void func_278(var uParam0, int iParam1)//Position - 0xFBCA
{
	int iVar0;
...
void func_279(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFC0B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_280(int* iParam0)//Position - 0xFC5B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_281(var uParam0)//Position - 0xFC9C
{
	if (*uParam0 == -1)
	{
		return;
...
void func_282(char* sParam0)//Position - 0xFCD9
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_283(var uParam0)//Position - 0xFCEB
{
	*uParam0 = -1;
...
void func_284()//Position - 0xFD1E
{
	func_282("Running start routines.");
	Global_113528++;
}

int func_285(int iParam0)//Position - 0xFD38
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
