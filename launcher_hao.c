...
int func_67(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5D15
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x64D8
{
	if (bParam2)
	{
...
int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x699F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_84(struct<3> Param0, float fParam1)//Position - 0x765C
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
int func_188(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xCD57
{
	var uVar0;
	
	if ((((func_132(PLAYER::PLAYER_PED_ID()) && func_132(uParam0->f_28[0])) && !func_151()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam6) && func_192(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_192(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xCF0B
{
	struct<3> Var0;
...
int func_204(struct<2> Param0, float fParam1, struct<2> Param2, Vector3 vParam3, float fParam4)//Position - 0xD648
{
	if (fParam4 < 0f)
	{
		fParam4 = 0f;
...
int func_219(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE37D
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
float func_223(struct<3> Param0, struct<3> Param1)//Position - 0xE649
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_231(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xE9C7
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_242(var uParam0)//Position - 0xECB4
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_249(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar3))
			{
				return 0;
			}
			iLocal_51 = 2;
...
void func_243(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xF11E
{
	func_203(iParam0);
...
void func_244(int* iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xF145
{
	func_245(iParam0);
...
int func_246(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xF223
{
	if (func_247(iParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_247(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xF27F
{
	int iVar0;
...
int func_261(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xF7EE
{
	int iVar0;
...
int func_262(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xF853
{
	int iVar0;
	struct<7> Var1;
...
int func_263(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0xF8CB
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
