...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113222[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_283(&(Global_113222[Var0.f_0 /*10*/].f_9));
			}
		}
		func_271(&Var0, 1);
	}
	...
	while (true)
	{
		...
		{
			if (!func_211(-72.323f, -1258.643f, 28.648f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[0], true), 1056964608))
			{
		...
		func_207(Var0.f_0);
		func_200(&iLocal_91, &(Var0.f_9), Var61);
		func_195(&Var0, Var61, "HAO1AU", "HAO1_HCO", 3, "HAO", 5000, 1101004800);
		if (func_181(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5E62
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6625
{
	if (bParam6)
	{
...
int func_72(var uParam0)//Position - 0x666C
{
...
int func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x66D7
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_77(int iParam0)//Position - 0x6AF9
{
	return func_74(iParam0, 5, 1);
}

int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6B09
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_82(struct<3> Param0)//Position - 0x762F
{
...
Vector3 func_84(struct<3> Param0)//Position - 0x7671
{
...
int func_86(int iParam0)//Position - 0x769D
{
	if (iParam0 != func_95())
	{
...
int func_88(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x779F
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_89(struct<3> Param0, float fParam3)//Position - 0x7834
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_93(int iParam0, var uParam1)//Position - 0x84D5
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0)//Position - 0x8557
{
	if (iParam0 != func_95())
	{
...
var func_107(int iParam0)//Position - 0x8DC2
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_108(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_108(bool bParam0, int iParam1, int iParam2)//Position - 0x8DE4
{
	if (bParam0)
	{
		return iParam1;
...
int func_109(var uParam0)//Position - 0x8DFB
{
	return uParam0 & 15;
}
...
void func_117(char* sParam0, int iParam1, int iParam2)//Position - 0x8F61
{
...
int func_118(bool bParam0)//Position - 0x8FA3
{
...
int func_123(var* uParam0)//Position - 0xAA36
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0xADA9
{
...
int func_136(int iParam0)//Position - 0xAE59
{
	if (func_137(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_137(int iParam0)//Position - 0xAE79
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_138(int iParam0)//Position - 0xAE9A
{
	switch (iParam0)
	{
		case 5:
...
int func_140(int iParam0)//Position - 0xAF6A
{
	switch (iParam0)
	{
		case 5:
...
void func_141(var uParam0, bool bParam1, bool bParam2)//Position - 0xAFBD
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0xB0B3
{
	switch (iParam0)
	{
		case 5:
...
void func_144(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB15D
{
	if (bParam0)
	{
...
int func_148(var uParam0)//Position - 0xB360
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xB382
{
...
int func_151(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0xB3CF
{
	int iVar0;
...
int func_154(char* sParam0)//Position - 0xB44C
{
...
int func_160(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB57F
{
...
void func_161(int iParam0)//Position - 0xB5D6
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
...
int func_168(int iParam0)//Position - 0xB8E3
{
	if (iParam0 == 1)
	{
...
int func_170(int iParam0)//Position - 0xB949
{
...
int func_171(int iParam0)//Position - 0xB98A
{
	int iVar0;
...
int func_173(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xBA01
{
	int iVar0;
...
void func_174(var uParam0, int iParam1)//Position - 0xBB38
{
	int iVar0;
...
bool func_175(int iParam0)//Position - 0xBB87
{
	return func_176(iParam0, Global_44181);
}

int func_176(int iParam0, int iParam1)//Position - 0xBB98
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_177(int iParam0)//Position - 0xBD79
{
	if (Global_44181 == 15)
	{
		return 0;
...
int func_179(char* sParam0, int iParam1)//Position - 0xBDAC
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_181(var uParam0, int iParam1)//Position - 0xBE19
{
	switch (uParam0->f_16)
	{
		case 0:
...
int func_183(var uParam0)//Position - 0xC618
{
	float fVar0;
...
void func_184(int iParam0, int iParam1)//Position - 0xC6A6
{
	if (iParam0 == 1)
	{
		if (!func_140(iParam1))
...
int func_185(bool bParam0)//Position - 0xC70A
{
	int iVar0;
...
int func_186(int iParam0)//Position - 0xC7A1
{
	bool bVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_194()) || Global_113182) || Global_33090) || func_193()) || func_192(8, -1)) || func_101()) || func_191()) || func_190()) || func_189()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_194()) || Global_33090) || func_193()) || func_192(8, -1)) || func_190()) || func_101()) || func_191()) || func_189()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_194()) || Global_113182) || Global_33090) || func_193()) || func_192(8, -1)) || func_190()) || func_101()) || func_191()) || func_189()) || Global_114135.f_7692.f_919[bVar0] == 5) || Global_44728 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_194()) || Global_113182) || Global_33090) || func_193()) || func_192(8, -1)) || func_101()) || func_191()) || func_189()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_194() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_192(8, -1)) || func_189()) || func_188()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_194()) || Global_33090) || func_193()) || func_192(8, -1)) || func_191()) || func_190()) || func_189()) || Global_114135.f_7692.f_919[bVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_194()) || func_191()) || Global_113182) || Global_33090) || func_193()) || Global_45392) || func_192(8, -1)) || func_190()) || func_188()) || func_189()) || Global_114135.f_7692.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_187()//Position - 0xCEBE
{
	return Global_101727.f_1;
}

int func_188()//Position - 0xCECC
{
	if (Global_98585 != -1)
	{
...
var func_192(int iParam0, int iParam1)//Position - 0xCF44
{
	switch (iParam0)
	{
		case 5:
...
var func_193()//Position - 0xCF7C
{
	return Global_1575084;
}

int func_194()//Position - 0xCF88
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_195(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xCFA4
{
	var uVar0;
	
	if ((((func_137(PLAYER::PLAYER_PED_ID()) && func_137(uParam0->f_28[0])) && !func_157()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_199(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_198(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
...
void func_196(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD02C
{
...
void func_198(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD0BD
{
...
float func_199(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD158
{
	struct<3> Var0;
...
void func_200(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xD192
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_203(int iParam0, int iParam1)//Position - 0xD2F8
{
	bool bVar0;
	int iVar1;
...
void func_205(int iParam0)//Position - 0xD3A2
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_206(iParam0);
...
void func_206(int iParam0)//Position - 0xD3B9
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_209(int iParam0)//Position - 0xD7CD
{
	int iVar0;
...
void func_210(int* iParam0)//Position - 0xD86A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_211(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)//Position - 0xD895
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_212(int iParam0)//Position - 0xD8CE
{
	if (func_137(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_213(var uParam0, bool bParam1)//Position - 0xD8F8
{
	struct<27> Var0;
	...
	func_120(*uParam0, &Var0);
	if ((func_247(*uParam0) || func_245(*uParam0)) || Global_79785 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
int func_215(int iParam0)//Position - 0xDEC0
{
...
int func_216(var uParam0)//Position - 0xDEE0
{
...
int func_217(var uParam0)//Position - 0xDEF8
{
...
int func_219(var uParam0, bool bParam1, bool bParam2)//Position - 0xDF9D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_220(int iParam0, int iParam1)//Position - 0xE15B
{
	int iVar0;
...
int func_221(var uParam0, bool bParam1, int iParam2)//Position - 0xE18B
{
	int iVar0;
	int iVar1;
...
int func_222(int iParam0)//Position - 0xE447
{
...
int func_223(int iParam0, float fParam1)//Position - 0xE47B
{
	float fVar0;
...
bool func_224(int iParam0, float fParam1)//Position - 0xE4F1
{
	return func_225(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_225(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE509
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_226(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE5CA
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_227(int iParam0, int iParam1)//Position - 0xE6F6
{
	int iVar0;
...
int func_229(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE805
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_230(struct<3> Param0, struct<3> Param3)//Position - 0xE896
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_231(struct<3> Param0)//Position - 0xE8B7
{
	float fVar0;
	float fVar1;
...
int func_233(int iParam0, int iParam1)//Position - 0xE911
{
	int iVar0;
...
int func_234(int iParam0)//Position - 0xE950
{
...
int func_235(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE978
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_236(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEA73
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_237(int iParam0, float fParam1)//Position - 0xEB7F
{
	var uVar0;
	struct<3> Var1;
...
int func_238(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xEC14
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_239(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xECA2
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_240(int iParam0)//Position - 0xECEA
{
...
int func_241(int iParam0)//Position - 0xED34
{
	if (iParam0 == -1)
	{
		iParam0 = func_178();
...
int func_242(int iParam0)//Position - 0xEDC9
{
...
int func_245(int iParam0)//Position - 0xEE48
{
...
int func_247(int iParam0)//Position - 0xEEBA
{
	if (func_118(0))
	{
...
int func_248(int iParam0)//Position - 0xEEE2
{
	if (!func_249(iParam0))
	{
		return 0;
...
int func_249(var uParam0)//Position - 0xEF01
{
	int iVar0[4];
	int iVar5;
	int iVar6;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_256(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar7))
			{
				return 0;
			}
			iLocal_89 = 2;
		...
		case 2:
			...
			{
				if (!func_253(&(uParam0->f_28[0]), 53, -71.936844f, -1259.7f, 28.193594f, -177.55f, "HAO LAUNCHER RC - HAO", 1))
				{
					bVar8 = false;
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_251(&(uParam0->f_35[0]), iVar0[1], -72.3226f, -1258.6433f, 28.1915f, 90.8326f);
			...
			if (func_137(uParam0->f_28[0]))
			{
				func_250(&(uParam0->f_41[0]), iVar0[2], -71.936844f, -1259.0775f, 28.193594f, -177.55f);
...
void func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF36B
{
	func_210(iParam0);
...
void func_251(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF392
{
	func_252(iParam0);
...
void func_252(int* iParam0)//Position - 0xF3D5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_253(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF471
{
	if (func_254(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_254(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF4CD
{
	int iVar0;
...
int func_255(var uParam0, int iParam1)//Position - 0xF55B
{
	int iVar0;
...
int func_256(int iParam0)//Position - 0xF5A1
{
	int iVar0;
...
int func_257(int iParam0)//Position - 0xF5D2
{
	int iVar0;
...
int func_258(int iParam0)//Position - 0xF63A
{
	struct<27> Var0;
	bool bVar32;
...
int func_259(int iParam0)//Position - 0xF68B
{
	char* sVar0;
...
int func_260(int iParam0)//Position - 0xF744
{
	var uVar0;
...
int func_261(int iParam0)//Position - 0xF805
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_263(int iParam0)//Position - 0xF96C
{
...
int func_264(int iParam0)//Position - 0xF997
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_265(int iParam0)//Position - 0xF9C2
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_266(int iParam0)//Position - 0xF9ED
{
	if (func_242(iParam0))
	{
		return 0;
...
int func_268(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFA3C
{
	int iVar0;
...
int func_269(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xFAA1
{
	int iVar0;
	struct<7> Var1;
...
int func_270(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xFB19
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_271(int iParam0, bool bParam1)//Position - 0xFB94
{
	if (bParam1)
	{
...
void func_275(int* iParam0, bool bParam1)//Position - 0xFC58
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_278(int* iParam0)//Position - 0xFCE2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_281(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFD6D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_282(int* iParam0)//Position - 0xFDBD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_283(var uParam0)//Position - 0xFDFE
{
	if (*uParam0 == -1)
	{
		return;
...
int func_287(int iParam0)//Position - 0xFE9A
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
