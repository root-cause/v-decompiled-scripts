...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		{
			if (!func_204(-72.323f, -1258.643f, 28.648f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[0], true), 1056964608))
			{
		...
		func_200(Var0.f_0);
		func_193(&iLocal_93, &(Var0.f_9), Var61);
		func_188(&Var0, Var61, "HAO1AU", "HAO1_HCO", 3, "HAO", 5000, 1101004800);
		if (func_174(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F1E
{
	int iVar0;
...
void func_58(int iParam0, bool bParam1)//Position - 0x4284
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x4377
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x45FF
{
	switch (iParam0)
	{
...
int func_61(int iParam0)//Position - 0x46A0
{
...
int func_62(int iParam0, int iParam1)//Position - 0x487A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var* uParam1)//Position - 0x54DB
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x5516
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x578A
{
	bool bVar0;
...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5D15
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x64D8
{
	if (bParam6)
	{
...
int func_70(var uParam0)//Position - 0x651F
{
...
int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x658A
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x65EB
{
	switch (iParam0)
	{
		case 0:
...
int func_75(int iParam0)//Position - 0x698F
{
	return func_72(iParam0, 5, 1);
}

int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x699F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x6A41
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_78()//Position - 0x7191
{
...
int func_80(struct<3> Param0)//Position - 0x749B
{
...
int func_81(int iParam0)//Position - 0x74C5
{
	if (iParam0 != func_90())
	{
...
Vector3 func_82(int iParam0, int iParam1)//Position - 0x751D
{
	struct<3> Var0;
	struct<3> Var6;
...
int func_83(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x75C7
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
Vector3 func_84(struct<3> Param0, float fParam3)//Position - 0x765C
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_118(var* uParam0)//Position - 0xA82B
{
	int iVar0;
...
int func_174(var uParam0, int iParam1)//Position - 0xBBCB
{
	switch (uParam0->f_16)
	{
		case 0:
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_187()) || Global_32166) || func_186()) || func_185(8, -1)) || func_183()) || func_96()) || func_184()) || func_182()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_187()) || Global_112695) || Global_32166) || func_186()) || func_185(8, -1)) || func_96()) || func_184()) || func_182()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_187() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_185(8, -1)) || func_182()) || func_181()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_187()) || Global_32166) || func_186()) || func_185(8, -1)) || func_184()) || func_183()) || func_182()) || Global_113648.f_7690.f_919[bVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_187()) || func_184()) || Global_112695) || Global_32166) || func_186()) || Global_44446) || func_185(8, -1)) || func_183()) || func_181()) || func_182()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_180()//Position - 0xCC71
{
	return Global_100720.f_1;
}

int func_181()//Position - 0xCC7F
{
	if (Global_97603 != -1)
	{
...
var func_185(int iParam0, int iParam1)//Position - 0xCCF7
{
	switch (iParam0)
	{
		case 5:
...
var func_186()//Position - 0xCD2F
{
	return Global_1575060;
}

int func_187()//Position - 0xCD3B
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_188(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xCD57
{
	var uVar0;
	
	if ((((func_132(PLAYER::PLAYER_PED_ID()) && func_132(uParam0->f_28[0])) && !func_151()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_192(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_189(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCDDF
{
...
void func_191(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCE70
{
...
float func_192(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xCF0B
{
	struct<3> Var0;
...
void func_193(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xCF45
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_196(int iParam0, int iParam1)//Position - 0xD0AB
{
	bool bVar0;
	int iVar1;
...
void func_198(int iParam0)//Position - 0xD155
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_199(iParam0);
...
void func_199(int iParam0)//Position - 0xD16C
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_202(int iParam0)//Position - 0xD580
{
	int iVar0;
...
void func_203(int* iParam0)//Position - 0xD61D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_204(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)//Position - 0xD648
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_205(int iParam0)//Position - 0xD681
{
	if (func_132(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
...
int func_206(var uParam0, bool bParam1)//Position - 0xD6AB
{
	struct<27> Var0;
...
void func_207(int iParam0, var uParam1, int iParam2)//Position - 0xD91B
{
	int iVar0;
	int iVar1;
...
int func_208(int iParam0)//Position - 0xDC73
{
...
int func_209(var uParam0)//Position - 0xDC93
{
...
int func_210(var uParam0)//Position - 0xDCAB
{
...
int func_212(var uParam0, bool bParam1, bool bParam2)//Position - 0xDD50
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_213(int iParam0, int iParam1)//Position - 0xDF0E
{
	int iVar0;
...
int func_214(var uParam0, bool bParam1, int iParam2)//Position - 0xDF3E
{
	int iVar0;
	int iVar1;
...
int func_215(int iParam0)//Position - 0xE1FA
{
...
int func_216(int iParam0, float fParam1)//Position - 0xE22E
{
	float fVar0;
...
bool func_217(int iParam0, float fParam1)//Position - 0xE2A4
{
	return func_218(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_218(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE2BC
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_219(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE37D
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_220(int iParam0, int iParam1)//Position - 0xE4A9
{
	int iVar0;
...
int func_222(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE5B8
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_223(struct<3> Param0, struct<3> Param3)//Position - 0xE649
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_224(struct<3> Param0)//Position - 0xE66A
{
	float fVar0;
	float fVar1;
...
int func_226(int iParam0, int iParam1)//Position - 0xE6C4
{
	int iVar0;
...
int func_227(int iParam0)//Position - 0xE703
{
...
int func_228(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE72B
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_229(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE826
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_230(int iParam0, float fParam1)//Position - 0xE932
{
	var uVar0;
	struct<3> Var1;
...
int func_231(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE9C7
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_232(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEA55
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_233(int iParam0)//Position - 0xEA9D
{
...
int func_234(int iParam0)//Position - 0xEAE7
{
	if (iParam0 == -1)
	{
		iParam0 = func_171();
...
int func_235(int iParam0)//Position - 0xEB7C
{
...
int func_238(int iParam0)//Position - 0xEBFB
{
...
int func_240(int iParam0)//Position - 0xEC6D
{
	if (func_113(0))
	{
...
int func_241(int iParam0)//Position - 0xEC95
{
	if (!func_242(iParam0))
	{
		return 0;
...
int func_242(var uParam0)//Position - 0xECB4
{
	int iVar0[4];
	int iVar5;
	int iVar6;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_249(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar7))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				if (!func_246(&(uParam0->f_28[0]), 53, -71.936844f, -1259.7f, 28.193594f, -177.55f, "HAO LAUNCHER RC - HAO", 1))
				{
					bVar8 = false;
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_244(&(uParam0->f_35[0]), iVar0[1], -72.3226f, -1258.6433f, 28.1915f, 90.8326f);
			...
			if (func_132(uParam0->f_28[0]))
			{
				func_243(&(uParam0->f_41[0]), iVar0[2], -71.936844f, -1259.0775f, 28.193594f, -177.55f);
...
void func_243(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF11E
{
	func_203(iParam0);
...
void func_244(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF145
{
	func_245(iParam0);
...
void func_245(int* iParam0)//Position - 0xF187
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_246(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF223
{
	if (func_247(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_247(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF27F
{
	int iVar0;
...
int func_248(var uParam0, int iParam1)//Position - 0xF30D
{
	int iVar0;
...
int func_249(int iParam0)//Position - 0xF353
{
	int iVar0;
...
int func_250(int iParam0)//Position - 0xF384
{
	int iVar0;
...
int func_251(int iParam0)//Position - 0xF3EC
{
	struct<27> Var0;
	bool bVar32;
...
int func_252(int iParam0)//Position - 0xF43D
{
	char* sVar0;
...
int func_253(int iParam0)//Position - 0xF4F6
{
	var uVar0;
...
int func_254(int iParam0)//Position - 0xF5B7
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_256(int iParam0)//Position - 0xF71E
{
...
int func_257(int iParam0)//Position - 0xF749
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_258(int iParam0)//Position - 0xF774
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_259(int iParam0)//Position - 0xF79F
{
	if (func_235(iParam0))
	{
		return 0;
...
int func_261(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF7EE
{
	int iVar0;
...
int func_262(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xF853
{
	int iVar0;
	struct<7> Var1;
...
int func_263(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xF8CB
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_264(int iParam0, bool bParam1)//Position - 0xF946
{
	if (bParam1)
	{
...
void func_268(int* iParam0, bool bParam1)//Position - 0xFA0A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_271(int* iParam0)//Position - 0xFA94
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_274(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFB1F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_275(int* iParam0)//Position - 0xFB6F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_276(var uParam0)//Position - 0xFBB0
{
	if (*uParam0 == -1)
	{
		return;
...
int func_280(int iParam0)//Position - 0xFC4C
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
