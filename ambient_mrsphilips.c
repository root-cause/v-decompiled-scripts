...
int func_3()//Position - 0x1B8
{
	...
	while (!func_145(36))
	{
		if (func_134(36))
		{
			func_133("LAUNCH_RC_MISSION - Script denied by RC Controller");
			return 0;
		}
		SYSTEM::WAIT(0);
	}
...
int func_50(int iParam0, int iParam1, int iParam2)//Position - 0x378D
{
	int iVar0;
	var uVar1;
...
int func_51(var uParam0)//Position - 0x37CA
{
	int iVar0;
	int iVar1;
...
var func_52()//Position - 0x37FE
{
	return Global_1574918;
}

int func_53(int iParam0, int iParam1)//Position - 0x380A
{
	int iVar0;
	var uVar1;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3836
{
	int iVar0;
...
void func_55(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3D7E
{
	int iVar0;
...
int func_56()//Position - 0x3FBF
{
	func_57();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_57()//Position - 0x3FD8
{
	int iVar0;
...
void func_59(int iParam0, bool bParam1)//Position - 0x40E6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_60(int iParam0, var uParam1)//Position - 0x41D9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_61(int iParam0)//Position - 0x4461
{
	switch (iParam0)
	{
...
int func_62(int iParam0)//Position - 0x44FC
{
...
int func_63(int iParam0, int iParam1)//Position - 0x46C4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_64(int iParam0, var* uParam1)//Position - 0x5265
{
	int iVar0;
	int iVar1;
...
int func_65(int iParam0)//Position - 0x52A0
{
	int iVar0;
...
void func_66(int iParam0)//Position - 0x5514
{
	int iVar0;
...
void func_67(var uParam0, int iParam1)//Position - 0x5550
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_68(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5A9F
{
	int iVar0;
	int iVar1;
...
bool func_69(int iParam0, var uParam1, var uParam2)//Position - 0x5AE3
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_70(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x6262
{
	if (bParam2)
	{
...
int func_71(var uParam0)//Position - 0x62A9
{
...
bool func_72(int iParam0)//Position - 0x6304
{
	return func_73(iParam0, 0, 1);
}

int func_73(int iParam0, int iParam1, bool bParam2)//Position - 0x6314
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_74(int iParam0)//Position - 0x6375
{
	switch (iParam0)
	{
		case 0:
...
int func_75()//Position - 0x66F0
{
	return Global_31959;
}

int func_76(int iParam0)//Position - 0x66FB
{
	return func_73(iParam0, 5, 1);
}

int func_77(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x670B
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_78(int iParam0, bool bParam1)//Position - 0x67AD
{
	switch (iParam0)
	{
		case -1:
...
int func_79(int iParam0)//Position - 0x6ED2
{
	if (iParam0 != func_88())
	{
...
Vector3 func_80(int iParam0, int iParam1)//Position - 0x6F2A
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_81(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6FD4
{
	struct<4> Var0;
	struct<3> Var1;
	struct<4> Var2;
...
Vector3 func_82(struct<3> Param0, float fParam1)//Position - 0x7069
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
struct<6> func_83(int iParam0)//Position - 0x70AD
{
	struct<6> Var0;
...
struct<6> func_84(int iParam0)//Position - 0x7231
{
	return func_85(iParam0);
}

struct<6> func_85(int iParam0)//Position - 0x723F
{
	struct<6> Var0;
...
int func_86(int iParam0, var uParam1)//Position - 0x7D06
{
	switch (iParam0)
	{
		case 0:
...
int func_87(int iParam0)//Position - 0x7D88
{
	if (iParam0 != func_88())
	{
...
int func_88()//Position - 0x7DE0
{
	return -1;
}

Vector3 func_89(int iParam0)//Position - 0x7DE9
{
	switch (iParam0)
	{
		case 1:
...
int func_90()//Position - 0x8047
{
	return func_91(PLAYER::PLAYER_ID());
}

int func_91(int iParam0)//Position - 0x8057
{
	return MISC::GET_BITS_IN_RANGE(Global_2689235[iParam0 /*453*/].f_318.f_3, 28, 31);
}

int func_92(int iParam0)//Position - 0x8074
{
	return func_73(iParam0, 0, 0);
}

int func_93(int iParam0)//Position - 0x8084
{
	switch (iParam0)
	{
		case -1:
...
bool func_94()//Position - 0x8393
{
	return Global_100493.f_375 > 0;
}

var func_95()//Position - 0x83A4
{
	var uVar0;
...
void func_96(var uParam0, int iParam1)//Position - 0x83EA
{
	if (iParam1 <= 0)
	{
		return;
...
void func_97(var uParam0, int iParam1)//Position - 0x8470
{
...
void func_98(var uParam0, int iParam1)//Position - 0x84A3
{
	int iVar0;
	int iVar1;
...
int func_99(int iParam0, int iParam1)//Position - 0x84F4
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_100(int iParam0)//Position - 0x8596
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_101(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_101(bool bParam0, int iParam1, int iParam2)//Position - 0x85B8
{
	if (bParam0)
	{
		return iParam1;
...
int func_102(var uParam0)//Position - 0x85CF
{
	return uParam0 & 15;
}

void func_103(var uParam0, int iParam1)//Position - 0x85DC
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8616
{
...
void func_105(var uParam0, int iParam1)//Position - 0x8651
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
void func_107(int iParam0)//Position - 0x86B1
{
	var uVar0;
	char cVar1[24];
...
bool func_108()//Position - 0x870A
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_109()//Position - 0x8720
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_110(char* sParam0, int iParam1, int iParam2)//Position - 0x8736
{
	...
	STATS::PLAYSTATS_MISSION_STARTED(sParam0, iParam1, iParam2, func_111(0));
}

int func_111(bool bParam0)//Position - 0x8777
{
...
struct<2> func_112(int iParam0)//Position - 0x879F
{
	struct<2> Var0;
...
void func_113(int iParam0, var uParam1)//Position - 0x8BEB
{
	switch (iParam0)
	{
		case 0:
			func_114(uParam1, "Abigail1", func_10(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0, "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_115(iParam0), 1, 0);
			break;
		
		case 1:
			func_114(uParam1, "Abigail2", func_10(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, -1, 4, 1, 0, 2359, func_115(iParam0), 1, 0);
			break;
		
		case 2:
			func_114(uParam1, "Barry1", func_10(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1, 4, 1, 0, 2359, func_115(iParam0), 1, 0);
			break;
		
		case 3:
			func_114(uParam1, "Barry2", func_10(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_115(iParam0), 1, 1);
			break;
		
		case 4:
			func_114(uParam1, "Barry3", func_10(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2, 0, 2359, func_115(iParam0), 0, 0);
			break;
		
		case 5:
			func_114(uParam1, "Barry3A", func_10(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 6:
			func_114(uParam1, "Barry3C", func_10(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 7:
			func_114(uParam1, "Barry4", func_10(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_115(iParam0), 0, 0);
			break;
		
		case 8:
			func_114(uParam1, "Dreyfuss1", func_10(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_115(iParam0), 0, 0);
			break;
		
		case 9:
			func_114(uParam1, "Epsilon1", func_10(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1, 10, 4, 1, 0, 2359, func_115(iParam0), 0, 0);
			break;
		
		case 10:
			func_114(uParam1, "Epsilon2", func_10(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0, 11, 4, 1, 0, 2359, func_115(iParam0), 1, 0);
			break;
		
		case 11:
			func_114(uParam1, "Epsilon3", func_10(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars", 0, 0, 12, 4, 1, 0, 2359, func_115(iParam0), 0, 0);
			break;
		
		case 12:
			func_114(uParam1, "Epsilon4", func_10(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16, "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_115(iParam0), 0, 0);
			break;
		
		case 13:
			func_114(uParam1, "Epsilon5", func_10(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16, "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_115(iParam0), 1, 0);
			break;
		
		case 14:
			func_114(uParam1, "Epsilon6", func_10(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0, 15, 4, 1, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 15:
			func_114(uParam1, "Epsilon7", func_10(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_115(iParam0), 0, 0);
			break;
		
		case 16:
			func_114(uParam1, "Epsilon8", func_10(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_115(iParam0), 1, 0);
			break;
		
		case 17:
			func_114(uParam1, "Extreme1", func_10(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 18:
			func_114(uParam1, "Extreme2", func_10(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171, 0, 19, 4, 2, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 19:
			func_114(uParam1, "Extreme3", func_10(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20, 4, 2, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 20:
			func_114(uParam1, "Extreme4", func_10(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, -1, 4, 2, 0, 2359, func_115(iParam0), 0, 0);
			break;
		
		case 21:
			func_114(uParam1, "Fanatic1", func_10(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, -1, 4, 1, 700, 2000, func_115(iParam0), 1, 0);
			break;
		
		case 22:
			func_114(uParam1, "Fanatic2", func_10(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1, -1, 4, 4, 700, 2000, func_115(iParam0), 1, 0);
			break;
		
		case 23:
			func_114(uParam1, "Fanatic3", func_10(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1, 4, 2, 700, 2000, func_115(iParam0), 0, 1);
			break;
		
		case 24:
			func_114(uParam1, "Hao1", func_10(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0, "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_115(iParam0), 0, 1);
			break;
		
		case 25:
			func_114(uParam1, "Hunting1", func_10(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 26:
			func_114(uParam1, "Hunting2", func_10(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, -1, 4, 4, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 27:
			func_114(uParam1, "Josh1", func_10(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_115(iParam0), 1, 0);
			break;
		
		case 28:
			func_114(uParam1, "Josh2", func_10(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0, 29, 4, 4, 0, 2359, func_115(iParam0), 1, 1);
			break;
		
		case 29:
			func_114(uParam1, "Josh3", func_10(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_115(iParam0), 1, 1);
			break;
		
		case 30:
			func_114(uParam1, "Josh4", func_10(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1, 4, 4, 0, 2359, func_115(iParam0), 1, 0);
			break;
		
		case 31:
			func_114(uParam1, "Maude1", func_10(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0, "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 32:
			func_114(uParam1, "Minute1", func_10(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 33:
			func_114(uParam1, "Minute2", func_10(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 34:
			func_114(uParam1, "Minute3", func_10(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0, -1, 4, 4, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 35:
			func_114(uParam1, "MrsPhilips1", func_10(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0, "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_115(iParam0), 0, 0);
			break;
		
		case 36:
			func_114(uParam1, "MrsPhilips2", func_10(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_115(iParam0), 0, 0);
			break;
		
		case 37:
			func_114(uParam1, "Nigel1", func_10(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1, -1, 1, 4, 0, 2359, func_115(iParam0), 1, 0);
			break;
		
		case 38:
			func_114(uParam1, "Nigel1A", func_10(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_115(iParam0), 1, 1);
			break;
		
		case 39:
			func_114(uParam1, "Nigel1B", func_10(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_115(iParam0), 1, 1);
			break;
		
		case 40:
			func_114(uParam1, "Nigel1C", func_10(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_115(iParam0), 1, 1);
			break;
		
		case 41:
			func_114(uParam1, "Nigel1D", func_10(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_115(iParam0), 1, 1);
			break;
		
		case 42:
			func_114(uParam1, "Nigel2", func_10(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_115(iParam0), 1, 1);
			break;
		
		case 43:
			func_114(uParam1, "Nigel3", func_10(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16, "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_115(iParam0), 1, 1);
			break;
		
		case 44:
			func_114(uParam1, "Omega1", func_10(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_115(iParam0), 0, 0);
			break;
		
		case 45:
			func_114(uParam1, "Omega2", func_10(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_115(iParam0), 0, 0);
			break;
		
		case 46:
			func_114(uParam1, "Paparazzo1", func_10(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 47:
			func_114(uParam1, "Paparazzo2", func_10(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 48:
			func_114(uParam1, "Paparazzo3", func_10(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183, 1, -1, 2, 2, 0, 2359, func_115(iParam0), 0, 0);
			break;
		
		case 49:
			func_114(uParam1, "Paparazzo3A", func_10(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 50:
			func_114(uParam1, "Paparazzo3B", func_10(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 51:
			func_114(uParam1, "Paparazzo4", func_10(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1, -1, 4, 2, 0, 2359, func_115(iParam0), 0, 0);
			break;
		
		case 52:
			func_114(uParam1, "Rampage1", func_10(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_115(iParam0), 0, 0);
			break;
		
		case 54:
			func_114(uParam1, "Rampage3", func_10(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_115(iParam0), 1, 0);
			break;
		
		case 55:
			func_114(uParam1, "Rampage4", func_10(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_115(iParam0), 1, 0);
			break;
		
		case 56:
			func_114(uParam1, "Rampage5", func_10(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_115(iParam0), 0, 0);
			break;
		
		case 53:
			func_114(uParam1, "Rampage2", func_10(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0, "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_115(iParam0), 1, 0);
			break;
		
		case 57:
			func_114(uParam1, "TheLastOne", func_10(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, -1, 4, 2, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 58:
			func_114(uParam1, "Tonya1", func_10(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 59:
			func_114(uParam1, "Tonya2", func_10(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 60:
			func_114(uParam1, "Tonya3", func_10(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 61:
			func_114(uParam1, "Tonya4", func_10(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_115(iParam0), 0, 1);
			break;
		
		case 62:
			func_114(uParam1, "Tonya5", func_10(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0, -1, 4, 2, 0, 2359, func_115(iParam0), 0, 1);
			break;
...
int func_115(int iParam0)//Position - 0x9E30
{
	switch (iParam0)
	{
		case 0:
...
void func_117(int iParam0)//Position - 0xA1B8
{
	struct<2> Var0;
...
void func_118(int iParam0)//Position - 0xA253
{
	if (iParam0 < 63)
	{
		func_119();
...
void func_120(int iParam0)//Position - 0xA2B1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_121(int iParam0)//Position - 0xA30A
{
...
int func_122(int iParam0)//Position - 0xA38D
{
	int iVar0;
...
void func_124(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA3D3
{
	int iVar0;
...
int func_126(int iParam0, int iParam1, int iParam2)//Position - 0xA486
{
...
int func_127(int iParam0, int iParam1, int iParam2)//Position - 0xA4A1
{
	int iVar0;
...
int func_128(int iParam0)//Position - 0xA4ED
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xA536
{
	if (func_130(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_130(int iParam0)//Position - 0xA556
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_131(int iParam0)//Position - 0xA577
{
	switch (iParam0)
	{
		case 5:
...
void func_133(char* sParam0)//Position - 0xA647
{
...
int func_134(int iParam0)//Position - 0xA659
{
	if (iParam0 == -1)
	{
		iParam0 = func_144();
...
int func_135(int iParam0)//Position - 0xA6EE
{
...
int func_138(int iParam0)//Position - 0xA76D
{
	if ((func_140() && Global_100441.f_11 == 6) && iParam0 == func_139(&(Global_100441.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_139(char* sParam0, int iParam1)//Position - 0xA7A1
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_141(int iParam0)//Position - 0xA828
{
	return func_142(iParam0, Global_43052);
}

int func_142(int iParam0, int iParam1)//Position - 0xA839
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_143(int iParam0)//Position - 0xAA1A
{
	if (func_111(0))
	{
...
int func_144()//Position - 0xAA42
{
	return func_139(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_145(int iParam0)//Position - 0xAA53
{
	int iVar0;
	...
	iVar0 = func_147(&(Global_112473[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
void func_146(int iParam0)//Position - 0xAA98
{
...
int func_147(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAACA
{
	int iVar0;
...
void func_148(var uParam0, int iParam1)//Position - 0xAC01
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xAC50
{
	if (Global_43052 == 15)
	{
		return 0;
...
int func_150(int iParam0)//Position - 0xAC72
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_158()) || Global_31962) || func_157()) || func_156(8, -1)) || func_154()) || func_94()) || func_155()) || func_153()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_158()) || Global_112433) || Global_31962) || func_157()) || func_156(8, -1)) || func_154()) || func_94()) || func_155()) || func_153()) || Global_113386.f_7688.f_919[iVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_158()) || Global_112433) || Global_31962) || func_157()) || func_156(8, -1)) || func_94()) || func_155()) || func_153()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_158() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_156(8, -1)) || func_153()) || func_152()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_156(8, -1) || func_94()) || func_155()) || func_152()) || func_151())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_158()) || Global_31962) || func_157()) || func_156(8, -1)) || func_155()) || func_154()) || func_153()) || Global_113386.f_7688.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_158()) || func_155()) || Global_112433) || Global_31962) || func_157()) || Global_44238) || func_156(8, -1)) || func_154()) || func_152()) || func_153()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_151()//Position - 0xB38F
{
	return Global_100480.f_1;
}

int func_152()//Position - 0xB39D
{
	if (Global_97363 != -1)
	{
...
bool func_155()//Position - 0xB404
{
	return Global_100493.f_376 > 0;
}

var func_156(int iParam0, int iParam1)//Position - 0xB415
{
	switch (iParam0)
	{
		case 5:
...
var func_157()//Position - 0xB44D
{
	return Global_1575058;
}

int func_158()//Position - 0xB459
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_159()//Position - 0xB475
{
	...
	switch (iLocal_80)
	{
		...
		case 1:
			if (!func_164(25) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
			{
				func_161("MRSP_01_HELP" /* GXT: Find a van with the Deludamol pharmaceuticals logo. */, 1, 0, -1, 10000, 4, 0, 0, 0);
				func_160(25);
			}
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
...
void func_160(int iParam0)//Position - 0xB4F2
{
	int iVar0;
	int iVar1;
...
void func_161(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0xB534
{
	func_162(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_162(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0xB555
{
	int iVar0;
...
int func_164(int iParam0)//Position - 0xB83F
{
	int iVar0;
	int iVar1;
...
void func_167(int iParam0, bool bParam1)//Position - 0xB8C9
{
	if (iParam0 == -1)
	{
		return;
	...
	if (bParam1)
	{
		...
		{
			func_168(iParam0, 1, 0);
			func_168(iParam0, 2, 0);
			func_168(iParam0, 3, 0);
			func_168(iParam0, 4, 0);
			func_168(iParam0, 0, 1);
			Global_77137[iParam0] = 1;
		}
	}
	else
	{
		func_168(iParam0, 0, 0);
	}
}

void func_168(int iParam0, int iParam1, bool bParam2)//Position - 0xB926
{
	if (iParam0 == -1)
	{
		return;
...
int func_169(int iParam0, int iParam1)//Position - 0xB961
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_171(int iParam0)//Position - 0xB9A8
{
...
int func_172()//Position - 0xB9D3
{
	func_57();
	return Global_113386.f_2363.f_539.f_4321;
}

int func_173(int iParam0)//Position - 0xB9EC
{
	int iVar0;
	bool bVar1;
...
int func_175(int iParam0)//Position - 0xBA64
{
	int iVar0;
	bool bVar1;
