...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_328())
	{
		...
		Global_78564 = 0;
		func_318(1843.172f, 4701.249f, 37.5487f, 320.2838f, 1, 0);
		func_317(0);
	}
	if (!func_328())
	{
	...
	switch (iLocal_84)
	{
		case 0:
			...
			else if (func_272(1, 1093140480, 0))
			{
				...
				func_261(1842.19f, 4707.64f, 36.87587f, 1845.486f, 4701.726f, 40.28056f, 9f, 1819.401f, 4707.289f, 38.1416f, 274.5804f, 1, 1, 1, 0, 0);
