...
void func_1()//Position - 0xD6
{
	...
	if (iLocal_40)
	{
		if (func_50(iLocal_42))
		{
			if ((((!func_49() && !PED::IS_PED_FLEEING(iLocal_42)) && !PED::IS_PED_RAGDOLL(iLocal_42)) && !PED::IS_PED_PRONE(iLocal_42)) && !PED::IS_PED_INJURED(iLocal_42))
			{
				if (func_48(iLocal_42, PLAYER::PLAYER_PED_ID(), 1) <= 3f)
				{
					if ((MISC::GET_GAME_TIMER() - iLocal_41) > 8000)
					{
						if (func_25(&uLocal_43, "JOSH1AU", "JOSH1_AMB2", 7, 0, 0, 0))
						{
			...
			if (func_48(iLocal_42, PLAYER::PLAYER_PED_ID(), 1) > 150f)
			{
				func_24(&iLocal_42);
			}
		}
	...
	while (bVar0 < 15)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_208[bVar0 /*11*/]))
		{
			if (OBJECT::HAS_OBJECT_BEEN_BROKEN(Local_208[bVar0 /*11*/], 0) || func_22(Local_208[bVar0 /*11*/]))
			{
				MISC::SET_BIT(&(Global_114372.f_10052.f_108), bVar0);
				func_19(bVar0);
				ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(Local_208[bVar0 /*11*/]));
				bLocal_37 = true;
				func_18(1, 0);
				func_16();
			}
			...
			{
				func_14(&(Local_208[bVar0 /*11*/]), &(Local_208[bVar0 /*11*/].f_10));
			}
		}
		else if (!BitTest(Global_114372.f_10052.f_108, bVar0))
		{
			func_11(&(Local_208[bVar0 /*11*/]), iLocal_36, 0, 200f);
		}
		bVar0++;
	}
	func_9();
...
int func_2(int iParam0)//Position - 0x248
{
	int iVar0;
	...
	else
	{
		...
		{
			if (!BitTest(Global_114372.f_10052.f_108, func_3(func_4(iParam0), iVar0)))
			{
				return 0;
			}
			iVar0++;
...
int func_5(int iParam0)//Position - 0x310
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (BitTest(Global_114372.f_10052.f_108, func_3(func_4(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
void func_11(var uParam0, int iParam1, bool bParam2, float fParam3)//Position - 0x5B0
{
	...
	{
		if (func_13(PLAYER::PLAYER_PED_ID(), uParam0->f_3, fParam3, 1) && !ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
...
void func_12(struct<3> Param0)//Position - 0x642
{
	int iVar0;
...
void func_15(int* iParam0)//Position - 0x6E8
{
...
int func_17(bool bParam0)//Position - 0x75E
{
...
void func_21(int iParam0, bool bParam1, int iParam2)//Position - 0x7E9
{
	if (iParam2 == -1)
	{
		iParam2 = func_7();
...
void func_23(int* iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x858
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_24(int* iParam0)//Position - 0x8A8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
bool func_25(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8E9
{
...
int func_26(char* sParam0, int iParam1, bool bParam2)//Position - 0x937
{
	Global_22167 = 0;
...
var func_30(int iParam0, int iParam1)//Position - 0xCAF
{
	return BitTest(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_31()//Position - 0xCC7
{
	return -1;
}
...
void func_38()//Position - 0xF11
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_41(Global_114372.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_39(iVar0) && (!func_43(14) || Global_113320))
			{
...
bool func_39(int iParam0)//Position - 0x100E
{
	return iParam0 < 3;
}

int func_40(int iParam0)//Position - 0x101A
{
	int iVar0;
	int iVar1;
...
int func_41(int iParam0)//Position - 0x1057
{
	if (func_39(iParam0))
	{
...
var func_42(int iParam0)//Position - 0x107C
{
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x117F
{
...
int func_50(int iParam0)//Position - 0x1255
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_51()//Position - 0x1276
{
	...
	if (!func_2(2))
	{
		Local_208[0 /*11*/].f_3 = { -1569.525f, 444.04f, 108.135f };
		Local_208[0 /*11*/].f_9 = 80f;
		Local_208[1 /*11*/].f_3 = { -1352.88f, 613.77f, 134.34f };
		Local_208[1 /*11*/].f_9 = 198f;
		Local_208[2 /*11*/].f_3 = { -1467f, -5.5f, 53.105f };
		Local_208[2 /*11*/].f_9 = 104f;
		Local_208[3 /*11*/].f_3 = { -1632.8329f, -413.8573f, 39.9441f };
		Local_208[3 /*11*/].f_9 = 321.5f;
		Local_208[4 /*11*/].f_3 = { -1765.6779f, -423.9763f, 41.5f };
		Local_208[4 /*11*/].f_9 = 256.25f;
		Local_208[5 /*11*/].f_3 = { -380.75f, 427.79f, 110.97f };
		Local_208[5 /*11*/].f_9 = 286.5f;
		Local_208[6 /*11*/].f_3 = { -163.2826f, 989.2324f, 234.0641f };
		Local_208[6 /*11*/].f_9 = 0f;
		Local_208[7 /*11*/].f_3 = { -493.083f, 588.6333f, 122.48499f };
		Local_208[7 /*11*/].f_9 = 177.2061f;
		Local_208[8 /*11*/].f_3 = { -818.84f, 434.74f, 88.15f };
		Local_208[8 /*11*/].f_9 = 91.5f;
		Local_208[9 /*11*/].f_3 = { -913.24f, 785.4f, 184.66f };
		Local_208[9 /*11*/].f_9 = 96.26f;
		Local_208[10 /*11*/].f_3 = { -825.92f, -26.67f, 38.68f };
		Local_208[10 /*11*/].f_9 = 15f;
		Local_208[11 /*11*/].f_3 = { -1103.5f, 587.29f, 103.25f };
		Local_208[11 /*11*/].f_9 = 305.5f;
		Local_208[12 /*11*/].f_3 = { -1253.4395f, 491.05f, 94.3706f };
		Local_208[12 /*11*/].f_9 = 0f;
		Local_208[13 /*11*/].f_3 = { 160.29f, 486.71f, 142.96f };
		Local_208[13 /*11*/].f_9 = 95f;
		Local_208[14 /*11*/].f_3 = { -1163.859f, 319.19f, 67.96f };
		Local_208[14 /*11*/].f_9 = 40f;
		iLocal_35 = 1;
	}
	else
	{
	...
	while (iVar1 < iVar0)
	{
		if (func_50(uVar2[iVar1]))
		{
			if (ENTITY::GET_ENTITY_MODEL(uVar2[iVar1]) == func_54(58))
			{
				...
				PED::SET_PED_NAME_DEBUG(iLocal_42, "POSTJOSH");
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_42, joaat("PLAYER"));
				func_53(&uLocal_43, 5, iLocal_42, "JOSH", 1, 1);
				return 1;
			}
		}
		iVar1++;
...
void func_53(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1560
{
...
int func_54(int iParam0)//Position - 0x15FB
{
	if (!func_39(iParam0))
	{
		return func_42(iParam0);
...
void func_57()//Position - 0x16A5
{
	...
	while (iVar0 < 15)
	{
		func_70(&(Local_208[iVar0 /*11*/].f_2));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 15)
	{
		func_69(&(Local_208[iVar0 /*11*/]), 0);
		iVar0++;
	}
...
int func_58(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x174C
{
	struct<14> Var0;
...
void func_59(bool bParam0)//Position - 0x1864
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_61(char* sParam0)//Position - 0x198C
{
	...
	while (iVar0 < 35)
	{
		if (!MISC::IS_STRING_NULL(&(Global_114372.f_14144[iVar0 /*104*/])))
		{
			...
			{
				if (Global_114372.f_14144[iVar0 /*104*/].f_24 == 2)
				{
				}
				else
				{
					func_36();
					Global_114372.f_14144[iVar0 /*104*/].f_99[Global_20813] = 0;
					if (func_62(iVar0))
					{
					}
					else
					{
						...
						Global_114372.f_14144[iVar0 /*104*/].f_29 = 0;
					}
...
int func_62(int iParam0)//Position - 0x1A40
{
...
void func_63(char* sParam0, int iParam1)//Position - 0x1A95
{
	...
	while (iVar0 < 35)
	{
		if (!MISC::IS_STRING_NULL(&(Global_114372.f_14144[iVar0 /*104*/])))
		{
			if (MISC::ARE_STRINGS_EQUAL(&(Global_114372.f_14144[iVar0 /*104*/]), sParam0))
			{
				if (Global_114372.f_14144[iVar0 /*104*/].f_24 == 0)
				{
				}
				Global_114372.f_14144[iVar0 /*104*/].f_24 = 1;
				if (Global_114372.f_14144[iVar0 /*104*/].f_25 == 1)
				{
					if (Global_114372.f_14144[iVar0 /*104*/].f_99[0] == 1)
					{
						Global_114372.f_14054[0 /*20*/].f_17 = 0;
					}
					if (Global_114372.f_14144[iVar0 /*104*/].f_99[1] == 1)
					{
						Global_114372.f_14054[1 /*20*/].f_17 = 0;
					}
					if (Global_114372.f_14144[iVar0 /*104*/].f_99[2] == 1)
					{
					...
					Global_114372.f_14144[iVar0 /*104*/].f_25 = 0;
					if (iParam1 == 1)
					{
						Global_114372.f_14144[iVar0 /*104*/].f_27 = 1;
					}
				}
			}
		}
...
void func_66()//Position - 0x1CEA
{
	...
	{
		func_68(13, SYSTEM::FLOOR(Global_114372.f_10197.f_3853));
	}
...
void func_69(int* iParam0, bool bParam1)//Position - 0x2204
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_70(int* iParam0)//Position - 0x223F
{
