...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_71 = -1;
	iLocal_72 = -1;
	sLocal_74 = "CC_SUBSTR" /* GXT: ~INPUT_CONTEXT~ */;
	fLocal_75 = 125f;
	iLocal_76 = 1;
	iLocal_78 = 263;
	fLocal_89 = 0f;
	bLocal_91 = true;
	bLocal_93 = true;
	Local_65 = { ScriptParam_100.f_1[0 /*3*/] };
	Local_65 = { Local_65 };
	uLocal_63 = uLocal_63;
	cLocal_53 = { cLocal_53 };
	bVar0 = false;
	...
	if (!func_183(uLocal_67, 8))
	{
		if (!func_181(iLocal_73))
		{
			if (func_180(0, iLocal_72))
			{
				func_191(0);
			}
			else
	...
	if (func_183(uLocal_67, 8388608))
	{
		func_191(1);
	}
	if (func_183(uLocal_67, 524288) && (func_179() && !func_178()))
	{
		func_191(1);
	}
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_183(uLocal_67, 4194304))
	{
		if (iLocal_78 != 263)
		{
			func_177(iLocal_78, 1, 0);
			iLocal_78 = 263;
		}
		func_176(10);
	}
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_62) && !ENTITY::IS_ENTITY_DEAD(iLocal_62, false))
		{
			Local_64 = { ENTITY::GET_ENTITY_COORDS(iLocal_62, true) };
			fLocal_66 = SYSTEM::VDIST2(Local_64, ScriptParam_100.f_1[0 /*3*/]);
			fLocal_66 = fLocal_66;
			Local_84 = { Local_64 };
			...
			{
				case 0:
					if (func_181(iLocal_73) || (func_183(uLocal_67, 16) && !func_183(uLocal_67, 524288)))
					{
						iLocal_71 = -1;
						func_175();
						func_176(1);
				...
				case 3:
					...
					if (!func_181(iLocal_73))
					{
						...
						{
							bVar1 = true;
							if (MISC::ARE_STRINGS_EQUAL(&(Global_100681.f_3), &cLocal_53))
							{
								cLocal_53 = { Local_52 };
								bVar1 = false;
							}
					...
					if (!func_183(uLocal_67, 4))
					{
						func_172();
						func_171(&uLocal_67, 4);
					}
					if (fLocal_83 > (fLocal_75 * fLocal_75) && !Global_100715)
					{
						if (iLocal_78 != 263)
						{
							if (func_170(6) && !func_169(iLocal_78))
							{
							}
							else
							{
					...
					{
						cLocal_53 = { Local_52 };
						bVar2 = !func_183(uLocal_67, 64);
						func_189(&uLocal_67, 128);
						if (!func_168(3) && !Global_100715)
						{
							if (func_183(uLocal_67, 2097152))
							{
								if ((!func_183(uLocal_67, 1) || !ENTITY::DOES_ENTITY_EXIST(func_167())) && !Global_100715)
								{
									func_176(10);
									break;
								}
						...
						if (bVar2)
						{
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_86, Local_87, fLocal_88, true, false, iLocal_76) || (fLocal_90 > 0f && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_142(Local_86, Local_87, 0.5f), false) > fLocal_90))
							{
								bVar2 = false;
							}
							...
							if (bVar2)
							{
								...
								if (func_141(uLocal_63))
								{
									if (iLocal_69 == -1)
									{
										func_140(&iLocal_69, 4, sLocal_74, 0, 0, 0, 0);
										func_153(&uLocal_67, 2048);
									}
									else if (!func_183(uLocal_67, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_139(&iLocal_69);
										func_189(&uLocal_67, 2048);
									}
									if (func_137(iLocal_69, 1))
									{
										sLocal_74 = sLocal_74;
										func_139(&iLocal_69);
										func_189(&uLocal_67, 2048);
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&cLocal_53))
					{
						...
						if (iVar3 != 1)
						{
							iVar3 = func_37(&iLocal_71, 6, iLocal_73, 0, 0);
						}
						if (iVar3 == 1)
						{
							...
							func_153(&uLocal_67, 2);
							func_176(6);
							func_23(&iLocal_80);
							if (iLocal_72 != -1)
							{
								func_22(iLocal_72);
								func_19(func_21(iLocal_72), 0, 0);
							}
						}
						else if (iVar3 == 2)
						{
				...
				case 6:
					...
					if (func_183(uLocal_67, 2097152))
					{
						if (!func_168(3) && !SCRIPT::IS_THREAD_ACTIVE(iLocal_51))
						{
							func_176(10);
						}
					}
					...
					{
						STATS::PLAYSTATS_ODDJOB_DONE(SYSTEM::ROUND((func_13(&iLocal_80) * 1000f)), iLocal_72, false);
						func_12(&iLocal_80);
						func_189(&uLocal_67, 256);
						func_9();
						if (bVar0)
						{
							func_189(&uLocal_67, 2);
						}
						else if (func_183(uLocal_67, 2))
						{
						...
						if (iLocal_72 != -1)
						{
							if (func_183(Global_112299, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_21(iLocal_72), 0, Global_100718, 0);
								func_7(func_21(iLocal_72), 0, Global_100718, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_21(iLocal_72), 0, Global_100718, 0);
								func_7(func_21(iLocal_72), 0, Global_100718, 0, 0);
							}
						}
						func_6();
						func_189(&Global_112299, 0);
						if (func_183(uLocal_67, 16777216))
						{
							func_191(1);
						}
						if (iLocal_72 != -1)
					...
					if ((iLocal_77 % 150) == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (iLocal_79 == 2)
							{
								if (iLocal_79 == 2)
								{
									if (func_181(iLocal_73) && func_180(0, iLocal_72))
									{
										func_184();
										if (iLocal_78 != 263)
										{
...
void func_59(int iParam0)//Position - 0x2924
{
	...
	func_60(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_70(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8267
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_60(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_60(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_53(iParam0));
			if (iVar11 > iVar10)
			{
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.f_0 != 0 && Var2.f_0 != -1) && Var2.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_125(Var2.f_2)] = Var2.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_125(Var2.f_2)] = func_51(iParam1, Var2.f_0, func_125(Var2.f_2), iVar0);
					}
				}
				else if (Var2.f_1 != -1)
				{
					(*uParam0)[func_125(Var2.f_2)] = Var2.f_1;
				}
			}
			iVar4++;
		}
...
Vector3 func_142(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x1BB18
{
...
void func_172()//Position - 0x1C94D
{
	...
	if (bLocal_93 && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("tennis_ambient")) == 0)
	{
		if (iLocal_92 == 1)
		{
			...
			{
				iVar2[iVar3] = func_173(&iVar2, 3, 2, 7);
				iVar3++;
			}
			iVar3 = 0;
			while (iVar3 < iVar1 && iVar3 < 3)
...
void func_184()//Position - 0x1CE37
{
	...
	iLocal_70 = 54000;
	func_171(&uLocal_67, 1);
	sLocal_74 = "PLAY_TENNIS" /* GXT: Press ~INPUT_CONTEXT~ to play Tennis. */;
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		iLocal_92 = func_150(Local_65);
	}
	iLocal_78 = func_187(Local_65);
	bLocal_93 = true;
	iVar0 = func_133(PLAYER::PLAYER_PED_ID());
	if (iVar0 == 1)
	{
		func_171(&uLocal_67, 8388608);
		return;
	}
	...
	switch (iLocal_92)
	{
		case 2:
			...
			bLocal_93 = true;
			Local_86 = { -765.014f, 154.244f, 67.25f };
			Local_87 = { -782.014f, 154.244f, 67.25f };
			fLocal_88 = 28f;
			fLocal_89 = 2f;
			break;
		...
		case 8:
			...
			Local_86 = { -1373.602f, -83.734f, 50f };
			Local_87 = { -1369.198f, -120.774f, 50f };
			fLocal_88 = 20.84f;
			fLocal_89 = 5f;
			fLocal_90 = 19.6f;
			break;
