...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_97 = -1;
	iLocal_98 = -1;
	sLocal_100 = "CC_SUBSTR" /* GXT: ~INPUT_CONTEXT~ */;
	fLocal_101 = 125f;
	iLocal_102 = 1;
	iLocal_104 = 263;
	fLocal_123 = 0f;
	...
	iLocal_84 = PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
	iLocal_94 = 0;
	func_190(&Global_113020, 0);
	func_185();
	if (func_184(uLocal_93, 1))
	{
		iLocal_99 = 10;
	}
	else
	...
	if (!func_184(uLocal_93, 8))
	{
		if (!func_182(iLocal_99))
		{
	...
	if (func_184(uLocal_93, 8388608))
	{
		func_192(1);
	}
	if (func_184(uLocal_93, 524288) && (func_180() && !func_179()))
	{
		func_192(1);
	}
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_184(uLocal_93, 4194304))
	{
		if (iLocal_104 != 263)
		{
			func_178(iLocal_104, 1, 0);
			iLocal_104 = 263;
		}
		func_177(10);
	}
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_84) && !ENTITY::IS_ENTITY_DEAD(iLocal_84, false))
		{
			Local_86 = { ENTITY::GET_ENTITY_COORDS(iLocal_84, true) };
			...
			{
				case 0:
					if (func_182(iLocal_99) || (func_184(uLocal_93, 16) && !func_184(uLocal_93, 524288)))
					{
						iLocal_97 = -1;
						func_176();
						func_177(1);
				...
				case 3:
					...
					if (!func_182(iLocal_99))
					{
						...
						{
							bVar1 = true;
							if (MISC::ARE_STRINGS_EQUAL(&(Global_101392.f_3), &cLocal_68))
							{
								cLocal_68 = { Local_52 };
								bVar1 = false;
							}
					...
					if (!func_184(uLocal_93, 4))
					{
						func_173();
						func_172(&uLocal_93, 4);
					}
					...
					{
						cLocal_68 = { Local_52 };
						bVar2 = !func_184(uLocal_93, 64);
						func_190(&uLocal_93, 128);
						if (!func_169(3) && !Global_101426)
						{
							if (func_184(uLocal_93, 2097152))
							{
								if ((!func_184(uLocal_93, 1) || !ENTITY::DOES_ENTITY_EXIST(func_168())) && !Global_101426)
								{
									func_177(10);
									break;
								}
						...
						if ((!func_157(6) || Global_113419) || func_156())
						{
							bVar2 = false;
						}
						if (!bLocal_125)
						{
							func_154(&uLocal_93, 128);
							bVar2 = false;
						}
						if (func_184(uLocal_93, 1))
						{
						...
						if (bVar2)
						{
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_116, Local_119, fLocal_122, true, false, iLocal_102) || (fLocal_124 > 0f && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_143(Local_116, Local_119, 0.5f), false) > fLocal_124))
							{
								bVar2 = false;
							}
							else if (fLocal_123 > 0f)
							{
								if (MISC::ABSF((Local_86.f_2 - Local_116.f_2)) > fLocal_123)
								{
									bVar2 = false;
								}
							}
							...
							if (bVar2)
							{
								...
								if (func_142(uLocal_85))
								{
									if (iLocal_95 == -1)
									{
										func_141(&iLocal_95, 4, sLocal_100, 0, 0, 0, 0);
										func_154(&uLocal_93, 2048);
									}
									else if (!func_184(uLocal_93, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_140(&iLocal_95);
										func_190(&uLocal_93, 2048);
									}
									if (func_138(iLocal_95, 1))
									{
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&cLocal_68))
					{
						...
						if (iVar3 != 1)
						{
							iVar3 = func_37(&iLocal_97, 6, iLocal_99, 0, 0);
						}
						if (iVar3 == 1)
						{
							...
							iLocal_51 = SYSTEM::START_NEW_SCRIPT(&cLocal_68, iLocal_96);
							SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&cLocal_68);
							Local_52 = { cLocal_68 };
							StringCopy(&cLocal_68, "", 64);
							func_154(&uLocal_93, 2);
							func_177(6);
							func_23(&iLocal_106);
							if (iLocal_98 != -1)
							{
				...
				case 6:
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_51))
					{
						...
						if (bVar0)
						{
							func_190(&uLocal_93, 2);
						}
						else if (func_184(uLocal_93, 2))
						{
						...
						if (iLocal_98 != -1)
						{
							if (func_184(Global_113020, 0))
							{
								...
								func_7(func_21(iLocal_98), 0, Global_101429, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_21(iLocal_98), 0, Global_101429, 0);
								func_7(func_21(iLocal_98), 0, Global_101429, 0, 0);
							}
						}
						func_6();
						func_190(&Global_113020, 0);
						if (func_184(uLocal_93, 16777216))
						{
							func_192(1);
						}
						if (iLocal_98 != -1)
					...
					if ((iLocal_103 % 150) == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (iLocal_105 == 2)
							{
								if (iLocal_105 == 2)
								{
									if (func_182(iLocal_99) && func_181(0, iLocal_98))
									{
										func_185();
										if (iLocal_104 != 263)
										{
...
bool func_1(char* sParam0)//Position - 0xA60
{
...
void func_7(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xAD1
{
...
void func_8(int iParam0)//Position - 0xB15
{
	if (*iParam0 == -1)
	{
		return;
...
bool func_10()//Position - 0xB94
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_11()//Position - 0xBAA
{
...
float func_13(int* iParam0)//Position - 0xBD6
{
	if (func_16(iParam0))
	{
		if (func_15(iParam0))
...
float func_14(bool bParam0)//Position - 0xC12
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_15(var uParam0)//Position - 0xC6A
{
	return BitTest(*uParam0, 2);
}

bool func_16(var uParam0)//Position - 0xC77
{
	return BitTest(*uParam0, 1);
}

int func_17()//Position - 0xC84
{
	return 1;
}

void func_18()//Position - 0xC8D
{
}

void func_19(char* sParam0, int iParam1, int iParam2)//Position - 0xC95
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_98442))
	{
...
int func_20(bool bParam0)//Position - 0xCD6
{
...
char* func_21(int iParam0)//Position - 0xCFE
{
	switch (iParam0)
	{
		case 0:
...
void func_22(int iParam0)//Position - 0xE3C
{
	var uVar0;
	char cVar1[24];
...
void func_23(int* iParam0)//Position - 0xE93
{
	if (!func_16(iParam0))
	{
		func_26(iParam0);
...
void func_24(int* iParam0)//Position - 0xEB4
{
	func_25(iParam0, 0f);
}

void func_25(int* iParam0, float fParam1)//Position - 0xEC3
{
...
void func_26(int* iParam0)//Position - 0xEEE
{
	if (!func_16(iParam0))
	{
		func_24(iParam0);
...
void func_27(int iParam0)//Position - 0xF06
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_28(int iParam0)//Position - 0xF5F
{
...
int func_29(int iParam0)//Position - 0xFE2
{
	int iVar0;
...
void func_30(int iParam0, int iParam1, int iParam2)//Position - 0x1013
{
	func_31(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_31(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x1028
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x10DB
{
...
int func_34(int iParam0, int iParam1, int iParam2)//Position - 0x10F6
{
	int iVar0;
...
int func_35(int iParam0)//Position - 0x1142
{
	int iVar0;
...
int func_37(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x1208
{
	int iVar0;
...
void func_38(var uParam0, int iParam1)//Position - 0x133F
{
	int iVar0;
...
int func_39(int iParam0)//Position - 0x138E
{
	if (Global_43922 == 15)
	{
		return 0;
...
int func_42(int iParam0)//Position - 0x14C0
{
...
int func_44(int iParam0)//Position - 0x1502
{
	return Global_96378[iParam0];
}

void func_45(int iParam0, int iParam1)//Position - 0x1512
{
	int iVar0;
	struct<17> Var1;
	...
	func_46(iParam0, iVar0, &Var1);
}

void func_46(int iParam0, int iParam1, var uParam2)//Position - 0x1539
{
	int iVar0;
	struct<14> Var1;
	int iVar15;
	...
	uVar19 = { func_49(iParam1, (*uParam2)[13]) };
	iVar15 = 0;
	while (iVar15 <= 8)
	{
		iVar16 = iVar15;
		iVar17 = func_48(iVar16);
		iVar18 = func_47(iVar17);
		if (uVar19[iVar15] != iVar18)
		{
			Var1 = { func_57(iParam1, 14, uVar19[iVar15], -1) };
...
int func_47(int iParam0)//Position - 0x1615
{
	switch (iParam0)
	{
		case 0:
...
int func_48(int iParam0)//Position - 0x169B
{
	switch (iParam0)
	{
		case -1:
...
struct<10> func_49(int iParam0, int iParam1)//Position - 0x176F
{
	int iVar0;
	struct<10> Var1;
...
void func_50(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x209E
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
int func_51(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x21C8
{
	struct<2> Var0;
	int iVar15;
	int iVar16;
	...
	else
	{
		...
		if (iVar18 != -1)
		{
			return (func_52(iParam0, func_53(iParam2)) + iVar18);
		}
	}
	return -99;
}

int func_52(int iParam0, int iParam1)//Position - 0x2283
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_53(int iParam0)//Position - 0x262A
{
	switch (iParam0)
	{
		case 0:
...
int func_54(int iParam0)//Position - 0x26DA
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_55(int iParam0)//Position - 0x273B
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_56(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x279A
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<14> func_57(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x27E2
{
	func_125();
...
void func_58(int iParam0, int iParam1)//Position - 0x2834
{
	switch (iParam0)
	{
		case 0:
...
void func_59(int iParam0)//Position - 0x2924
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_60(&(Global_79031[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_60(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x3B59
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_63(func_67(iParam1, uParam0->f_2), Global_79028);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_63(func_62(iParam1, uParam0->f_2), Global_79028);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_63(iVar1, Global_79028);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_61(int iParam0, int iParam1, var uParam2)//Position - 0x3EFA
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_62(int iParam0, int iParam1)//Position - 0x42FF
{
	switch (iParam1)
	{
		case 0:
...
int func_63(int iParam0, int iParam1)//Position - 0x46FA
{
	int iVar0;
	var uVar1;
...
int func_64(int iParam0, var uParam1)//Position - 0x4729
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_65(uParam1));
}

int func_65(var uParam0)//Position - 0x473E
{
	int iVar0;
	int iVar1;
...
var func_66()//Position - 0x4772
{
	return Global_1574925;
}

int func_67(int iParam0, int iParam1)//Position - 0x477E
{
	switch (iParam1)
	{
		case 0:
...
int func_68(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x4B79
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_69(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x5A1C
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_70(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x5A5A
{
	int iVar0;
...
void func_71(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8549
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_60(&(Global_79031[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_60(&(Global_79031[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_60(&(Global_79031[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79229)
		{
			...
			func_60(&(Global_79031[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_53(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_72(int iParam0)//Position - 0x87CF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_73(int iParam0)//Position - 0x891C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_74(int iParam0)//Position - 0x8E29
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_75(int iParam0)//Position - 0x8E9D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_76(int iParam0)//Position - 0x8F10
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_77(int iParam0)//Position - 0x8FF7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_78(int iParam0)//Position - 0x9339
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_79(int iParam0)//Position - 0x9541
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_80(int iParam0)//Position - 0x9761
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_81(int iParam0)//Position - 0x986A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_82(int iParam0)//Position - 0xA1FC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_83(int iParam0)//Position - 0xAD54
{
	if (iParam0 < 136)
	{
		func_85(iParam0);
...
void func_84(int iParam0)//Position - 0xAD89
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_85(int iParam0)//Position - 0xB98D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_86(int iParam0)//Position - 0xC88E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_87(int iParam0)//Position - 0xC9BB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_88(int iParam0, int iParam1)//Position - 0xCAB2
{
	switch (iParam0)
	{
		case 0:
...
void func_89(int iParam0)//Position - 0xCBA2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_90(int iParam0)//Position - 0xE06F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_91(int iParam0)//Position - 0xE1B6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_92(int iParam0)//Position - 0xE6C0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_93(int iParam0)//Position - 0xED29
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_94(int iParam0)//Position - 0xED9C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_95(int iParam0)//Position - 0xEE6C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_96(int iParam0)//Position - 0xF367
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_97(int iParam0)//Position - 0xF4F8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_98(int iParam0)//Position - 0xFCE7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_99(int iParam0)//Position - 0xFDF0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(int iParam0)//Position - 0x10EFC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_101(int iParam0)//Position - 0x11BA9
{
	if (iParam0 < 107)
	{
		func_104(iParam0);
...
void func_102(int iParam0)//Position - 0x11BEF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_103(int iParam0)//Position - 0x12693
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_104(int iParam0)//Position - 0x13481
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0x140C2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(int iParam0)//Position - 0x1433A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0, int iParam1)//Position - 0x14476
{
	switch (iParam0)
	{
		case 0:
...
void func_108(int iParam0)//Position - 0x14566
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0)//Position - 0x152C4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0)//Position - 0x15433
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0x159A4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0x15ECC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0x15F3F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x1600F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0x164BF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x1671A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0x169DA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x16B95
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x176DB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0x1830D
{
	if (iParam0 < 60)
	{
		func_122(iParam0);
...
void func_121(int iParam0)//Position - 0x18342
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0x190D5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0x19757
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0x1983D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125()//Position - 0x19934
{
...
int func_126(int iParam0)//Position - 0x199AC
{
	switch (iParam0)
	{
		case 0:
...
struct<17> func_127(int iParam0, int iParam1)//Position - 0x19A5C
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_129(&Var1, -99, -99, Global_114372.f_2366.f_539.f_196[0], Global_114372.f_2366.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_129(&Var1, -99, -99, Global_114372.f_2366.f_539.f_196[1], Global_114372.f_2366.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_129(&Var1, -99, -99, Global_114372.f_2366.f_539.f_196[2], Global_114372.f_2366.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_128(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1B8A4
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_126(Var16.f_2)] = Var16.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_126(Var16.f_2)] = func_51(iParam1, Var16.f_0, func_126(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
					(*uParam0)[func_126(Var16.f_2)] = Var16.f_1;
				}
			}
			iVar36++;
		}
...
void func_129(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1BA8E
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
void func_130(int iParam0)//Position - 0x1BAFF
{
	Global_113458 = (Global_113458 || iParam0);
}

bool func_131(int iParam0)//Position - 0x1BB12
{
	return (Global_113458 && iParam0) != 0;
}

void func_132(int iParam0)//Position - 0x1BB23
{
	if (iLocal_94 < 5)
	{
		if (iParam0 != 263)
...
int func_134(int iParam0)//Position - 0x1BB86
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0x1BBC3
{
	if (func_137(iParam0))
	{
...
var func_136(int iParam0)//Position - 0x1BBE8
{
	return Global_2139[iParam0 /*29*/];
}

bool func_137(int iParam0)//Position - 0x1BBF7
{
	return iParam0 < 3;
}

int func_138(int iParam0, bool bParam1)//Position - 0x1BC03
{
	int iVar0;
...
int func_139(int iParam0)//Position - 0x1BCBB
{
	int iVar0;
...
void func_140(int iParam0)//Position - 0x1BCF6
{
	int iVar0;
...
void func_141(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x1BD4D
{
	int iVar0;
...
int func_142(var uParam0)//Position - 0x1BE78
{
	return 1;
}

Vector3 func_143(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x1BE81
{
	return FtoV((1f - fParam6)) * Param0 + Vector(fParam6, fParam6, fParam6) * Param3;
}

var func_144()//Position - 0x1BE9C
{
	return Global_76369;
}

int func_145(int iParam0)//Position - 0x1BEA8
{
	if (iParam0 == 1)
	{
...
var func_146(int iParam0, int iParam1)//Position - 0x1BEFF
{
	switch (iParam0)
	{
		case 5:
...
bool func_147()//Position - 0x1BF37
{
	return MISC::GET_GAME_TIMER() <= Global_23711.f_6481 + 100;
}

int func_148()//Position - 0x1BF4C
{
...
bool func_149(bool bParam0)//Position - 0x1BF66
{
	if (bParam0)
	{
...
int func_151(struct<3> Param0)//Position - 0x1C05F
{
	float fVar0;
	float fVar1;
	int iVar2;
...
Vector3 func_152(int iParam0)//Position - 0x1C0A3
{
	int iVar0;
...
Vector3 func_153(int iParam0, int iParam1)//Position - 0x1C181
{
	int iVar0;
...
void func_154(var uParam0, int iParam1)//Position - 0x1C1BF
{
	func_155(uParam0, iParam1);
}

void func_155(var uParam0, var uParam1)//Position - 0x1C1CF
{
	*uParam0 = (*uParam0 || uParam1);
}

bool func_156()//Position - 0x1C1E0
{
	int iVar0;
	bool bVar1;
...
int func_157(int iParam0)//Position - 0x1C2EA
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_164()) || Global_113419) || Global_32831) || func_163()) || func_146(8, -1)) || func_162()) || func_161()) || func_160()) || func_148()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_164()) || Global_32831) || func_163()) || func_146(8, -1)) || func_160()) || func_162()) || func_161()) || func_148()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_164()) || Global_113419) || Global_32831) || func_163()) || func_146(8, -1)) || func_160()) || func_162()) || func_161()) || func_148()) || Global_114372.f_7691.f_919[iVar0] == 5) || Global_44469 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_164()) || Global_113419) || Global_32831) || func_163()) || func_146(8, -1)) || func_162()) || func_161()) || func_148()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_164() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_146(8, -1)) || func_148()) || func_159()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_164()) || func_161()) || Global_113419) || Global_32831) || func_163()) || Global_45122) || func_146(8, -1)) || func_160()) || func_159()) || func_148()) || Global_114372.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_158()//Position - 0x1CA07
{
	return Global_101431.f_1;
}

int func_159()//Position - 0x1CA15
{
	if (Global_98294 != -1)
	{
...
bool func_161()//Position - 0x1CA62
{
	return Global_101444.f_394 > 0;
}

bool func_162()//Position - 0x1CA73
{
	return Global_101444.f_393 > 0;
}

var func_163()//Position - 0x1CA84
{
	return Global_1575079;
}

int func_164()//Position - 0x1CA90
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_165()//Position - 0x1CAAC
{
	func_166();
	return Global_114372.f_2366.f_539.f_4321;
}

void func_166()//Position - 0x1CAC5
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			iVar0 = func_134(PLAYER::PLAYER_PED_ID());
			if (func_137(iVar0) && (!func_171(14) || Global_113320))
			{
				if (Global_114372.f_2366.f_539.f_4321 != iVar0 && func_137(Global_114372.f_2366.f_539.f_4321))
				{
...
var func_168()//Position - 0x1CBDC
{
	return Global_97204;
}

int func_169(int iParam0)//Position - 0x1CBE8
{
	switch (iParam0)
	{
		case 0:
...
bool func_170(int iParam0)//Position - 0x1CC5A
{
	int iVar0;
...
bool func_171(int iParam0)//Position - 0x1CC96
{
	return Global_43922 == iParam0;
}

void func_172(var uParam0, int iParam1)//Position - 0x1CCA4
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_173()//Position - 0x1CCB5
{
	var uVar0;
	int iVar4;
	int iVar5[3];
	...
	if (bLocal_127 && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("tennis_ambient")) == 0)
	{
		if (iLocal_126 == 1)
		{
			...
			{
				iVar5[iVar9] = func_174(&iVar5, 3, 2, 7);
				iVar9++;
			}
			iVar9 = 0;
			while (iVar9 < iVar4 && iVar9 < 3)
...
int func_174(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1CD5B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_176()//Position - 0x1CDED
{
	if (bLocal_127)
	{
		if (iLocal_126 == 1)
...
void func_177(int iParam0)//Position - 0x1CE08
{
	iLocal_94 = iParam0;
}

void func_178(int iParam0, bool bParam1, bool bParam2)//Position - 0x1CE14
{
	int iVar0;
	int iVar1;
...
int func_181(int iParam0, int iParam1)//Position - 0x1CF54
{
	int iVar0;
...
bool func_182(int iParam0)//Position - 0x1CF9E
{
	return func_183(iParam0, Global_43922);
}

int func_183(int iParam0, int iParam1)//Position - 0x1CFAF
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_184(var uParam0, int iParam1)//Position - 0x1D190
{
	return (uParam0 && iParam1) != 0;
}

void func_185()//Position - 0x1D19F
{
	int iVar0;
	int iVar1;
	...
	iLocal_96 = 60500;
	func_172(&uLocal_93, 1);
	sLocal_100 = "PLAY_TENNIS" /* GXT: Press ~INPUT_CONTEXT~ to play Tennis. */;
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		iLocal_126 = func_151(Local_89);
	}
	iLocal_104 = func_188(Local_89);
	bLocal_127 = true;
	iVar0 = func_134(PLAYER::PLAYER_PED_ID());
	if (iVar0 == 1)
	{
		func_172(&uLocal_93, 8388608);
		return;
	}
	...
	switch (iLocal_126)
	{
		case 2:
			...
			bLocal_127 = true;
			Local_116 = { -765.014f, 154.244f, 67.25f };
			Local_119 = { -782.014f, 154.244f, 67.25f };
			fLocal_122 = 28f;
			fLocal_123 = 2f;
			break;
		...
		case 1:
			...
			Local_116 = { -1164.9576f, -1667.2617f, 4.28f };
			Local_119 = { -1200.9193f, -1615.8724f, 4.28f };
			fLocal_122 = 65.5f;
			fLocal_123 = 5f;
			break;
		...
		case 3:
			...
			Local_116 = { 491.2348f, -206.72147f, 52.788494f };
			Local_119 = { 469.6835f, -266.50696f, 53.786392f };
			fLocal_122 = 14f;
			fLocal_123 = 5f;
			break;
		...
		case 4:
			...
			Local_116 = { -1218.9388f, 321.685f, 79.02952f };
			Local_119 = { -1228.746f, 355.2947f, 79.985886f };
			fLocal_122 = 20f;
			fLocal_123 = 2f;
			break;
		...
		case 5:
			...
			Local_116 = { -1250.0034f, 367.62833f, 79.94628f };
			Local_119 = { -1216.3693f, 377.55026f, 80.10213f };
			fLocal_122 = 20f;
			fLocal_123 = 2f;
			break;
		...
		case 6:
			...
			Local_116 = { -1610.8618f, 249.70062f, 60.116802f };
			Local_119 = { -1626.5161f, 282.9467f, 59.83001f };
			fLocal_122 = 32f;
			fLocal_123 = 5f;
			break;
		...
		case 7:
			...
			Local_116 = { -942.1958f, -1251.2074f, 7.1391f };
			Local_119 = { -930.3892f, -1271.5867f, 8.0366f };
			fLocal_122 = 12f;
			fLocal_123 = 5f;
			break;
		...
		case 8:
			...
			Local_116 = { -1373.602f, -83.734f, 50f };
			Local_119 = { -1369.198f, -120.774f, 50f };
			fLocal_122 = 20.84f;
			fLocal_123 = 5f;
			fLocal_124 = 19.6f;
			break;
		...
		case 9:
			...
			Local_116 = { -2860.7622f, 13.3794f, 10.6083f };
			Local_119 = { -2924.066f, 31.5452f, 10.6083f };
			fLocal_122 = 28f;
			fLocal_123 = 5f;
			break;
	}
...
int func_187(int iParam0)//Position - 0x1D5EF
{
	if (func_137(iParam0))
	{
		if ((Global_114372.f_9088 || Global_4) || func_20(0))
		{
...
int func_188(struct<3> Param0)//Position - 0x1D63D
{
	return func_189(func_151(Param0));
}

int func_189(var uParam0)//Position - 0x1D651
{
	int iVar0;
...
void func_190(var uParam0, int iParam1)//Position - 0x1D6C9
{
	func_191(uParam0, iParam1);
}

void func_191(var uParam0, var uParam1)//Position - 0x1D6D9
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_192(bool bParam0)//Position - 0x1D6EE
{
	if (bParam0)
	{
		if (iLocal_104 != 263)
...
void func_193()//Position - 0x1D737
{
	func_190(&uLocal_93, 4);
	func_194();
	if (SCRIPT::IS_THREAD_ACTIVE(iLocal_51))
	{
...
void func_194()//Position - 0x1D774
{
	func_4(128);
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
