...
void func_22(char* sParam0)//Position - 0x18D5
{
	...
	*sParam0 = { Var0 };
	...
	StringIntConCat(sParam0, iLocal_297[func_23()], 16);
}

int func_23()//Position - 0x1900
{
	func_24();
...
void func_24()//Position - 0x1919
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_28(Global_114372.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_26(iVar0) && (!func_25(14) || Global_113320))
			{
...
bool func_26(int iParam0)//Position - 0x1A24
{
	return iParam0 < 3;
}

int func_27(int iParam0)//Position - 0x1A30
{
	int iVar0;
	int iVar1;
...
int func_28(int iParam0)//Position - 0x1A6D
{
	if (func_26(iParam0))
	{
...
var func_29(int iParam0)//Position - 0x1A92
{
...
bool func_34(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B3F
{
...
var func_39(int iParam0, int iParam1)//Position - 0x1F05
{
	return BitTest(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_40()//Position - 0x1F1D
{
	return -1;
}
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21DB
{
...
void func_49(char[4] cParam0)//Position - 0x2231
{
	int iVar0;
...
void func_50(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x226C
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_52(var uParam0)//Position - 0x233F
{
}

void func_53(var uParam0, int iParam1, float fParam2)//Position - 0x2347
{
}
...
void func_56(var uParam0)//Position - 0x23D4
{
}

void func_57(char* sParam0)//Position - 0x23DC
{
...
void func_71(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x270E
{
	int iVar0;
...
int func_73(int iParam0)//Position - 0x29F7
{
	int iVar0;
	int iVar1;
...
int func_76(int iParam0)//Position - 0x2B3D
{
	if (func_78(iParam0))
	{
...
int func_77(int iParam0)//Position - 0x2B61
{
	int iVar0;
...
int func_78(int iParam0)//Position - 0x2B91
{
...
void func_80(int* iParam0)//Position - 0x2C79
{
	if (iLocal_445 == 1)
	{
...
void func_81(int* iParam0, int iParam1, bool bParam2)//Position - 0x2C98
{
	if (iLocal_445 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_82(int iParam0, bool bParam1, int iParam2)//Position - 0x2CEB
{
	int iVar0;
...
int func_83(int iParam0, bool bParam1, bool bParam2)//Position - 0x2D35
{
	int iVar0;
...
float func_84(bool bParam0, float fParam1, float fParam2)//Position - 0x2DD9
{
	if (bParam0)
	{
		return fParam1;
...
float func_85(int iParam0, int iParam1, bool bParam2)//Position - 0x2DF0
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_86(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2E4E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_87(struct<3> Param0, struct<3> Param3)//Position - 0x2EDF
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_88(struct<3> Param0)//Position - 0x2F00
{
	float fVar0;
	float fVar1;
...
int func_89(int iParam0)//Position - 0x2F3F
{
	var uVar0;
...
int func_96()//Position - 0x2FD5
{
	return 1;
}

float func_97(int iParam0, int iParam1)//Position - 0x2FDE
{
...
void func_101(var uParam0, var uParam1)//Position - 0x3104
{
...
int func_103(int iParam0)//Position - 0x3187
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_106()//Position - 0x31BC
{
	...
	StringCopy(&Local_232, "PBCL", 8);
	StringCopy(&Local_234, "CLINTON", 16);
	...
	iLocal_250 = 15;
	iLocal_251 = 5;
	sLocal_301 = "PBCL_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to Clinton. */;
	StringCopy(&Local_310, "PBCL_CONV_M1", 16);
	StringCopy(&Local_314, "PBCL_CONV_T1", 16);
	StringCopy(&Local_318, "PBCL_CONV_F1", 16);
	StringCopy(&cLocal_322, "special_ped@Clinton@base", 64);
	StringCopy(&cLocal_338, "special_ped@clinton@intro", 64);
	iLocal_249 = 3;
	iLocal_245 = 0;
	iLocal_253[0] = 6;
	iLocal_253[1] = 5;
...
int func_110()//Position - 0x3310
{
	return 1;
}

bool func_111(var uParam0)//Position - 0x3319
{
	return func_112(Global_114372.f_20120, uParam0);
}

bool func_112(var uParam0, var uParam1)//Position - 0x332E
{
	return (uParam0 && uParam1) != 0;
}

int func_113(char* sParam0)//Position - 0x333D
{
...
void func_115(int* iParam0)//Position - 0x3533
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
