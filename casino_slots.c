...
bool func_137(var uParam0, int iParam1, int iParam2)//Position - 0x588E
{
	...
	if (func_155())
	{
		if (*uParam0 == 0)
		{
			...
			if (func_150(78225582, 1950528552, iVar3, iVar5, iParam2, iVar1, 0, 4, 0, 3))
			{
				if (func_150(78225582, 1845931212, iVar4, iVar5, 1, 0, 0, 4, 0, 3))
				{
					if (func_145())
					{
						*uParam0 = 1;
...
int func_152(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5)//Position - 0x660C
{
	...
	*iParam0 = 0;
	...
	{
		*iParam0 = func_153(uVar3, iParam1, -2085313189, iParam3, iParam2, 0, 1, iParam4, uParam5, 0, bVar0);
		return 1;
	}
	return 0;
}
