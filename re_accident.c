					...
					if (FIRE::IS_ENTITY_ON_FIRE(iLocal_317))
					{
						...
						if (!PED::IS_PED_INJURED(iLocal_315))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_315, false))
							{
								...
								if (!PED::IS_PED_INJURED(iLocal_315))
								{
									ENTITY::SET_ENTITY_HEALTH(iLocal_315, 99, 0);
								}
								if (!ENTITY::IS_ENTITY_DEAD(iLocal_317, false))
								{
									ENTITY::FREEZE_ENTITY_POSITION(iLocal_317, false);
...
int func_25(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x158E
{
...
int func_26(char* sParam0, int iParam1, bool bParam2)//Position - 0x15DC
{
	Global_21846 = 0;
...
bool func_29(int iParam0)//Position - 0x1944
{
	return func_30(iParam0, 20);
}

var func_30(int iParam0, int iParam1)//Position - 0x1954
{
	return BitTest(Global_1895156[iParam0 /*609*/].f_10.f_4, iParam1);
}

int func_31()//Position - 0x196C
{
	return -1;
}

void func_32()//Position - 0x1975
{
	int iVar0;
...
int func_36()//Position - 0x1B76
{
	func_37();
	return Global_113810.f_2366.f_539.f_4321;
}

void func_37()//Position - 0x1B8F
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_40(Global_113810.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_39(PLAYER::PLAYER_PED_ID());
			if (func_38(iVar0) && (!func_42(14) || Global_112760))
			{
...
bool func_38(int iParam0)//Position - 0x1C8C
{
	return iParam0 < 3;
}

int func_39(int iParam0)//Position - 0x1C98
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x1CD5
{
	if (func_38(iParam0))
	{
...
var func_41(int iParam0)//Position - 0x1CFA
{
	return Global_2058[iParam0 /*29*/];
}

bool func_42(int iParam0)//Position - 0x1D09
{
	return Global_43377 == iParam0;
}

void func_43()//Position - 0x1D17
{
	int iVar0;
...
bool func_44(int iParam0, int iParam1)//Position - 0x1D6E
{
	switch (iParam0)
	{
		case 5:
...
void func_46(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x1DFD
{
...
void func_47()//Position - 0x1E53
{
	Global_20711 = 0;
	func_48();
}

void func_48()//Position - 0x1E63
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22856 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_51()//Position - 0x223D
{
	iLocal_46 = 1;
}

int func_52()//Position - 0x2248
{
	if (iLocal_220 == 1)
	{
		return 1;
...
void func_55()//Position - 0x2893
{
	func_56();
}

int func_56()//Position - 0x28A0
{
	if (func_57(0))
	{
		return 0;
...
int func_57(bool bParam0)//Position - 0x28EB
{
...
void func_58(int iParam0, int iParam1)//Position - 0x2913
{
	if (iParam0 == -1)
	{
		iParam0 = func_75();
...
void func_59(int iParam0)//Position - 0x2A17
{
	Global_113796 = iParam0;
}

void func_60(int iParam0, var uParam1, var uParam2)//Position - 0x2A25
{
	bool bVar0;
...
void func_61()//Position - 0x2B0B
{
	...
	{
		func_63(13, SYSTEM::FLOOR(Global_113810.f_10197.f_3853));
	}
...
int func_62()//Position - 0x2FC9
{
	return Global_32283;
}

int func_63(int iParam0, int iParam1)//Position - 0x2FD4
{
	int iVar0;
...
void func_64(int iParam0, bool bParam1, int iParam2)//Position - 0x3025
{
	if (iParam2 == -1)
	{
		iParam2 = func_6();
...
int func_65(int iParam0, int iParam1)//Position - 0x3043
{
	switch (iParam0)
	{
		case 0:
...
int func_66(int iParam0)//Position - 0x33B7
{
	switch (iParam0)
	{
		case 29:
...
void func_67(int iParam0)//Position - 0x33E6
{
	int iVar0;
	int iVar1;
...
void func_68(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x3428
{
	func_69(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_69(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x3449
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x3779
{
	int iVar0;
	int iVar1;
...
void func_73(int iParam0, int iParam1)//Position - 0x37B9
{
	MISC::SET_BIT(&(Global_113810.f_24998.f_8[iParam0]), iParam1);
}

int func_74(int iParam0)//Position - 0x37D4
{
	int iVar0;
...
int func_76(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x38A2
{
...
void func_77(int iParam0, int iParam1, int iParam2)//Position - 0x3A7C
{
	int iVar0;
	int iVar1;
...
void func_78(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x3B6A
{
	int iVar0;
...
int func_79(int iParam0, var uParam1)//Position - 0x3B8D
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_80(uParam1));
}

int func_80(var uParam0)//Position - 0x3BA2
{
	int iVar0;
	int iVar1;
...
int func_81(int iParam0, int iParam1)//Position - 0x3BD6
{
	int iVar0;
	var uVar1;
...
int func_82()//Position - 0x3C05
{
	return 1;
}

int func_83(int iParam0, bool bParam1, int iParam2)//Position - 0x3C0E
{
	int iVar0;
...
int func_84(int iParam0, bool bParam1, bool bParam2)//Position - 0x3C58
{
	int iVar0;
...
float func_85(bool bParam0, float fParam1, float fParam2)//Position - 0x3CFC
{
	if (bParam0)
	{
		return fParam1;
...
int func_86(int iParam0)//Position - 0x3D13
{
	if (func_90())
	{
		Global_113800 = 1;
		Global_113797 = MISC::GET_GAME_TIMER();
		if (func_66(Global_113799))
		{
			func_87(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /* GXT: Random Event */);
		if (iParam0 && func_66(Global_113799))
		{
...
void func_87(int iParam0)//Position - 0x3D66
{
	switch (iParam0)
	{
		case 0:
...
void func_88(char* sParam0, int iParam1)//Position - 0x3E41
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

char* func_89(int iParam0)//Position - 0x3E58
{
	char* sVar0;
...
int func_90()//Position - 0x3E9B
{
	switch (func_91(&Global_32343, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_91(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x3ED1
{
	int iVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x400A
{
	int iVar0;
...
bool func_93(int iParam0)//Position - 0x4059
{
	return func_94(iParam0, Global_43377);
}

int func_94(int iParam0, int iParam1)//Position - 0x406A
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_95(int iParam0)//Position - 0x424B
{
	if (Global_43377 == 15)
	{
		return 0;
...
int func_96(bool bParam0, bool bParam1, bool bParam2)//Position - 0x426D
{
	int iVar0;
...
void func_97()//Position - 0x4352
{
	AUDIO::TRIGGER_MUSIC_EVENT("RE14A_FAIL");
	iLocal_299 = 2;
}

int func_98(int iParam0, bool bParam1, bool bParam2)//Position - 0x4366
{
	return func_84(iParam0, !bParam1, bParam2);
}

void func_99()//Position - 0x4379
{
	if (func_102(1000))
	{
		func_47();
...
void func_100(int iParam0)//Position - 0x4EC5
{
...
void func_101()//Position - 0x4EDD
{
	AUDIO::START_PRELOADED_CONVERSATION();
	Global_22837 = 0;
}

int func_102(int iParam0)//Position - 0x4EED
{
...
int func_104(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x4F69
{
	func_46(uParam0, 145, sParam1, iParam4, iParam5, iParam6);
	if (iParam3 > 7)
	{
...
void func_105(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x4FBC
{
...
int func_106(var uParam0)//Position - 0x5057
{
	int iVar0;
...
bool func_107(var uParam0)//Position - 0x50B3
{
	return func_108(*uParam0, "NULL", uParam0->f_1);
}

int func_108(char* sParam0, char* sParam1, int iParam2)//Position - 0x50C8
{
...
int func_109(var uParam0)//Position - 0x51B3
{
	bool bVar0;
...
void func_110(var uParam0)//Position - 0x51DC
{
	func_111(uParam0, 9, -1, 0);
}

void func_111(var uParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x51EE
{
	int iVar0;
...
int func_112(int iParam0)//Position - 0x52A8
{
	switch (iParam0)
	{
		case -1:
...
void func_113(var uParam0, int iParam1)//Position - 0x5347
{
	func_111(uParam0, 0, iParam1, 0);
}

void func_114(var uParam0)//Position - 0x5359
{
	int iVar0;
...
void func_115(int* iParam0)//Position - 0x53D7
{
	func_116(iParam0, "NULL", iParam0->f_1);
}

void func_116(int* iParam0, char* sParam1, int iParam2)//Position - 0x53EB
{
...
void func_117()//Position - 0x54BC
{
	...
	if (func_106(&Local_535))
	{
		...
		PED::ADD_SCENARIO_BLOCKING_AREA(Local_303 + Vector(50f, 50f, 50f), Local_303 - Vector(50f, 50f, 50f), false, true, true, true);
...
void func_118(var uParam0, bool bParam1)//Position - 0x57A2
{
	int iVar0;
...
void func_119(var uParam0)//Position - 0x57E2
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
}

void func_120(var uParam0)//Position - 0x57F3
{
	int iVar0;
...
void func_121(var uParam0)//Position - 0x5829
{
	func_122(*uParam0, "NULL", uParam0->f_1);
}

void func_122(int iParam0, char* sParam1, int iParam2)//Position - 0x583E
{
	if (BitTest(iParam0, 30))
	{
		switch (func_109(iParam0))
...
int func_124(float fParam0, bool bParam1)//Position - 0x597E
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_125(int iParam0, var uParam1)//Position - 0x5A2F
{
	switch (iParam0)
	{
		case 0:
...
int func_127(int iParam0)//Position - 0x6C75
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_128(int iParam0)//Position - 0x6FBB
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_129(int iParam0)//Position - 0x6FF2
{
	struct<2> Var0;
...
bool func_131()//Position - 0x7470
{
	return Global_113528 > 0;
}

int func_132()//Position - 0x747E
{
	if (Global_97735 != -1)
	{
		return 1;
...
int func_136()//Position - 0x7535
{
	if ((Global_113799 == func_75() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_113800)
	{
		return 1;
	}
	return 0;
...
void func_137(int iParam0)//Position - 0x7560
{
	if (iParam0 == -1)
	{
		iParam0 = func_75();
...
void func_139(int iParam0)//Position - 0x75D3
{
	Global_113799 = iParam0;
}

int func_140(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x75E1
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (!func_176(Global_113810.f_24998.f_43[iParam3]))
		{
			return 0;
		}
...
bool func_141(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x797B
{
	if (bParam6)
	{
...
bool func_142(int iParam0)//Position - 0x79C2
{
	int iVar0;
...
int func_143(int iParam0)//Position - 0x79E3
{
	return func_144(iParam0, 1);
}

int func_144(int iParam0, int iParam1)//Position - 0x79F2
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_145(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x7A45
{
	func_146(func_157(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_146(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x7A63
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_147(float fParam0, float fParam1, float fParam2)//Position - 0x7C64
{
	float fVar0;
...
int func_148(int iParam0, int iParam1)//Position - 0x7CA6
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_149(int iParam0)//Position - 0x7D48
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_150(int iParam0)//Position - 0x7D5B
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_151(int iParam0)//Position - 0x7D6E
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_152(int iParam0)//Position - 0x7D81
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_153(int iParam0)//Position - 0x7D93
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_154(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_154(bool bParam0, int iParam1, int iParam2)//Position - 0x7DB5
{
	if (bParam0)
	{
		return iParam1;
...
int func_155(int iParam0)//Position - 0x7DCC
{
	return iParam0 & 15;
}

int func_156(int iParam0, int iParam1)//Position - 0x7DD9
{
	int iVar0;
	int iVar1;
...
void func_158(var uParam0, int iParam1)//Position - 0x7F2B
{
	if (iParam1 <= 0)
	{
		return;
...
void func_159(var uParam0, int iParam1)//Position - 0x7FB1
{
...
void func_160(var uParam0, int iParam1)//Position - 0x7FE4
{
	int iVar0;
	int iVar1;
...
void func_161(var uParam0, int iParam1)//Position - 0x8036
{
...
void func_162(var uParam0, int iParam1)//Position - 0x8070
{
...
void func_163(var uParam0, int iParam1)//Position - 0x80AB
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_164(int iParam0)//Position - 0x80E7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_165(int iParam0, bool bParam1)//Position - 0x81C3
{
...
int func_166(int iParam0)//Position - 0x81E3
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_174()) || Global_32286) || func_173()) || func_44(8, -1)) || func_170()) || func_172()) || func_171()) || func_169()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_174()) || Global_112857) || Global_32286) || func_173()) || func_44(8, -1)) || func_170()) || func_172()) || func_171()) || func_169()) || Global_113810.f_7691.f_919[iVar0] == 5) || Global_43924 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_174()) || Global_112857) || Global_32286) || func_173()) || func_44(8, -1)) || func_172()) || func_171()) || func_169()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_174() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_44(8, -1)) || func_169()) || func_168()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_174()) || func_171()) || Global_112857) || Global_32286) || func_173()) || Global_44569) || func_44(8, -1)) || func_170()) || func_168()) || func_169()) || Global_113810.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_167()//Position - 0x8900
{
	return Global_100872.f_1;
}

int func_168()//Position - 0x890E
{
	if (Global_97735 != -1)
	{
...
bool func_171()//Position - 0x8975
{
	return Global_100885.f_394 > 0;
}

bool func_172()//Position - 0x8986
{
	return Global_100885.f_393 > 0;
}

var func_173()//Position - 0x8997
{
	return Global_1575063;
}

int func_174()//Position - 0x89A3
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_176(int iParam0)//Position - 0x89E7
{
	return func_156(func_157(), iParam0);
}

int func_177(int iParam0, int iParam1, int iParam2)//Position - 0x89F9
{
	int iVar0;
	int iVar1;
...
int func_178(int iParam0)//Position - 0x8ADD
{
	if (!func_38(iParam0))
	{
		return 7;
...
void func_183(int iParam0)//Position - 0x8E42
{
	char cVar0[64];
	...
	if (func_136())
	{
		...
		func_186(30000);
		StringCopy(&cVar0, func_185(Global_113799, 1), 64);
		if (func_74(Global_113799) > 0)
		{
	...
	func_184(&Global_32343);
	Global_113800 = 0;
	func_139(-1);
}

void func_184(var uParam0)//Position - 0x8EF4
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_185(int iParam0, bool bParam1)//Position - 0x8F31
{
	switch (iParam0)
	{
		case 0:
...
void func_186(int iParam0)//Position - 0x917A
{
	Global_43928 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_187(int iParam0)//Position - 0x918C
{
	func_188(iParam0, 0, func_193(iParam0));
}

void func_188(int iParam0, int iParam1, int iParam2)//Position - 0x91A1
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_189(var uParam0)//Position - 0x91D0
{
	struct<16> Var0;
	int iVar16;
...
void func_190(int iParam0, var uParam1)//Position - 0x92A0
{
	Global_113810.f_24998.f_43[iParam0] = *uParam1;
}

void func_191(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x92B8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_192(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x943A
{
...
int func_193(int iParam0)//Position - 0x9472
{
	int iVar0;
...
int func_194(int iParam0, int iParam1, int iParam2)//Position - 0x9615
{
	var uVar0;
	char* sVar1;
...
void func_195(int iParam0, int iParam1)//Position - 0x9655
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_196(iParam0, &(Global_113810.f_32752.f_5510));
}

void func_196(int iParam0, var uParam1)//Position - 0x9857
{
	int iVar0;
...
int func_197(int iParam0)//Position - 0x9B02
{
	switch (iParam0)
	{
		case 1:
...
int func_198(int iParam0, var uParam1, var uParam2)//Position - 0x9BB2
{
	int iVar0;
	int iVar1;
...
int func_199(int iParam0)//Position - 0x9DA5
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_200(var uParam0)//Position - 0x9DC5
{
	int iVar0;
...
int func_201(int iParam0)//Position - 0x9E75
{
...
int func_202(int iParam0)//Position - 0x9F52
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_203(int iParam0, bool bParam1, int iParam2)//Position - 0xA104
{
	int iVar0;
	struct<2> Var1;
...
int func_204(int iParam0)//Position - 0xA286
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_206(int iParam0, int iParam1)//Position - 0xA369
{
	int iVar0;
	int iVar1;
...
int func_207(bool bParam0)//Position - 0xF541
{
	if (bParam0)
	{
...
bool func_208()//Position - 0xF55B
{
	return (MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION());
}

bool func_209()//Position - 0xF571
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

int func_210()//Position - 0xF587
{
	return 0;
}

int func_211()//Position - 0xF590
{
	return 1;
}

int func_212()//Position - 0xF599
{
	return 1;
}

int func_213()//Position - 0xF5A2
{
...
int func_214(int iParam0)//Position - 0xF5BB
{
	int iVar0;
	char* sVar1;
...
int func_215(int iParam0)//Position - 0xF602
{
	int iVar0;
...
int func_216(int iParam0)//Position - 0xF63D
{
	int iVar0;
...
int func_217(int iParam0)//Position - 0xF6B9
{
	int iVar0;
...
int func_218(int iParam0)//Position - 0xF7A1
{
	int iVar0;
...
int func_219(int iParam0, int iParam1, bool bParam2)//Position - 0xF804
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_220(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0xF872
{
...
void func_221()//Position - 0xF94A
{
	Global_20711 = 0;
	func_222();
}

void func_222()//Position - 0xF95A
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
