			...
			case 10:
				...
				if (((bVar96 || bVar97) || bVar99) || (func_462(&iVar21) && func_461(&iVar21) > 0.25f))
				{
					...
					else if ((bVar97 || bVar99) || iVar8 >= 2)
					{
						...
						{
							func_221(&Var6, 27, 1);
							func_214(&Var6, 0, 201, "BJ_CONTINUE", 203, "BJ_RETRY", 211, "HUD_INPUT68", 363, 0);
						}
						iVar7 = 12;
					}
					func_458(&iVar18);
			...
			case 11:
				...
				if (!bVar96 && !bVar97)
				{
					if (func_213() && !func_263(&Var6, 26))
					{
						...
						{
							func_214(&Var6, 0, 215, "BJ_CONTINUE", 216, "BJ_RETRY", 211, "HUD_INPUT68", 363, 0);
							func_221(&Var6, 26, 1);
						}
					}
				}
	...
	if (SYSTEM::TIMERA() > 1000)
	{
		if (*iParam9)
		{
			...
			else if (func_81(&iLocal_510, 0))
			{
				iLocal_510 = 0;
				*iParam9 = 0;
				func_214(iParam1, 0, 215, "BJ_CONTINUE", 216, "BJ_RETRY", 211, "HUD_INPUT68", 363, 0);
			}
		}
		else
		{
		...
		if (*iParam9)
		{
			if (PLAYER::IS_PLAYER_ONLINE())
			{
				if (!func_263(iParam1, 28) && func_80(&uLocal_73))
				{
					...
					func_214(iParam1, 0, 202, "HUD_INPUT53", 217, "SCLB_PROFILE", 363, 0, 363, 0);
				}
			}
			...
			*iParam9 = 1;
			if (PLAYER::IS_PLAYER_ONLINE())
			{
				...
				else
				{
					...
					func_214(iParam1, 0, 202, "HUD_INPUT53", 363, 0, 363, 0, 363, 0);
				}
			}
		}
	}
