...
void __EntryFunction__()//Position - 0x0
{
	...
	bVar112 = false;
	bVar113 = false;
	if (ENTITY::DOES_ENTITY_EXIST(ScriptParam_516.f_1))
	{
	...
	bVar111 = WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("GADGET_PARACHUTE"), false);
	...
	if (bVar112)
	{
		PLAYER::GET_PLAYER_RESERVE_PARACHUTE_TINT_INDEX(PLAYER::PLAYER_ID(), &iVar88);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iVar40))
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iVar40, true, true);
	}
	...
	{
		func_560(&Var3, &uVar51, &iVar33, &iVar34, &iVar36, &iVar39, &iVar40, &uVar32, &iVar42, &iVar43, &iVar44, iVar85, &iVar80, iVar45, iVar46, bVar13, &iVar41, bVar111);
	}
	if (bVar77 < 0)
	{
		return;
	}
	if (BitTest(Global_113648.f_18969.f_1, bVar77))
	{
		fVar65 = 0.1f;
	}
	bVar13 = bVar77;
	...
	func_532(&Var3, bVar13);
	if (ENTITY::DOES_ENTITY_EXIST(iVar42))
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iVar42, true, true);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iVar33))
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iVar33, true, true);
		if (func_531(&Var3) != 0 && ENTITY::GET_ENTITY_MODEL(iVar33) == func_531(&Var3))
		{
			iVar36 = iVar33;
			iVar33 = 0;
		}
	...
	while (true)
	{
		...
		func_511(&uVar4);
		func_507(&Var6, iVar7);
		func_503(&Var6, iVar7, bVar13, bVar93);
		switch (iVar7)
		{
			case 0:
				func_502();
				...
				func_496();
				func_495(1);
				func_491("AM_H_BASEJ" /* GXT: Parachuting now available at ~BLIP_BASE_JUMP~ */, 1);
				HUD::CLEAR_PRINTS();
				HUD::CLEAR_HELP(true);
				if (bVar13 == 0)
				{
					PATHFIND::SET_ROADS_IN_ANGLED_AREA(-832.271f, -1525.112f, -100f, -1187.833f, -1876.646f, 100f, 50f, true, false, true);
					iVar41 = VEHICLE::ADD_VEHICLE_COMBAT_ANGLED_AVOIDANCE_AREA(-832.271f, -1525.112f, -100f, -1187.833f, -1876.646f, 100f, 50f);
				}
				else if (bVar13 == 5)
				{
				...
				{
					if (ENTITY::DOES_ENTITY_EXIST(ScriptParam_516.f_2))
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(ScriptParam_516.f_2, true, true);
						OBJECT::DELETE_OBJECT(&(ScriptParam_516.f_2));
					}
					func_477(&uVar5, &Var3, bVar13, bVar13 == 6);
					bVar102 = true;
				}
				iVar7 = 1;
				break;
			...
			case 1:
				if (CAM::IS_SCREEN_FADED_OUT() || (((bVar13 == 5 || bVar13 == 6) || bVar13 == 12) && !bVar93))
				{
					if (!bVar93)
					{
						if ((bVar13 != 5 && bVar13 != 6) && bVar13 != 12)
						{
							Var57 = { func_476(bVar13) };
							Var57 = { func_475(SYSTEM::COS(Var57.f_2), SYSTEM::SIN(Var57.f_2), MISC::TAN(Var57.f_0)) };
							if (func_474(bVar13))
							{
								STREAMING::NEW_LOAD_SCENE_START(func_473(bVar13), Var57, 4000f, 0);
							}
						}
						func_467(&Var3, bVar13, &uVar0, &iVar1, &iVar2, &uVar51, &iVar84);
					}
					else if (func_465(func_466(bVar13)))
					{
						Var62 = { Vector(1.2f, 1.2f, 1.2f) * Vector(0f, -SYSTEM::COS((-97.4239f + func_464(&Var3))), SYSTEM::SIN((-97.4239f + func_464(&Var3)))) };
						Var61 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iVar33, 1.12046f, -0.317773f, 1.3385f) };
						Var62 = { func_463(Var62, 8.909f) };
						if (func_474(bVar13))
						{
							STREAMING::NEW_LOAD_SCENE_START(Var61 + Var62, Var62, 4000f, 0);
						}
					}
					else
					{
						Var57 = { -10f, 0f, func_464(&Var3) };
						Var57 = { func_475(SYSTEM::COS(Var57.f_2), SYSTEM::SIN(Var57.f_2), MISC::TAN(Var57.f_0)) };
						if (func_474(bVar13))
						{
							STREAMING::NEW_LOAD_SCENE_START(func_473(bVar13), Var57, 4000f, 0);
					...
					if (((bVar93 || bVar13 == 4) || bVar13 == 8) || bVar13 == 3)
					{
						...
						ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_473(bVar13), false, false, false, true);
						ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), func_464(&Var3));
						ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), true);
						PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
					}
					iVar7 = 2;
				}
				else if (!CAM::IS_SCREEN_FADING_OUT() && (!func_462(&iVar23) || func_461(&iVar23) > 0.05f))
				{
			...
			case 2:
				if (func_459(&uVar0, &iVar16, &uVar51, bVar13, iVar84, ((bVar13 != 5 && bVar13 != 6) && bVar13 != 12)))
				{
					func_458(&iVar16);
					func_435(&Var3, &uVar32, &iVar72, &iVar33, &iVar34, &iVar36, &iVar35, &iVar37, &iVar42, &iVar43, iVar1, iVar2, &iVar19, bVar13, &iVar81);
					PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), true, false);
					if (!bVar93 && !bVar102)
					{
						func_477(&uVar5, &Var3, bVar13, 0);
					}
					iVar7 = 3;
				}
				break;
			...
			case 3:
				if (!func_462(&iVar16) && !bVar93)
				{
					func_434(0, 0, 1);
					func_486(&iVar16);
				}
				else if ((func_462(&iVar16) && func_461(&iVar16) > 0.2f) || bVar93)
				{
					if (func_465(func_466(bVar13)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "oddjobs@basejump@", "Heli_door_loop", 3))
					{
					}
					else if (bVar93)
					{
					...
					else
					{
						...
						{
							SYSTEM::WAIT(1000);
							CAM::SET_CAM_ACTIVE_WITH_INTERP(func_433(&uVar5, 1), func_433(&uVar5, 0), 10000, 1, 1);
							CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
							CAM::DO_SCREEN_FADE_IN(800);
						}
						STREAMING::NEW_LOAD_SCENE_STOP();
						if (func_465(func_466(bVar13)))
						{
							Var62 = { Vector(1.2f, 1.2f, 1.2f) * Vector(0f, -SYSTEM::COS((-97.4239f + func_464(&Var3))), SYSTEM::SIN((-97.4239f + func_464(&Var3)))) };
							Var61 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iVar33, 1.12046f, -0.317773f, 1.3385f) };
							Var62 = { func_463(Var62, 8.909f) };
						...
						if (!func_431(func_432(bVar13)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
						{
							...
							ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_432(bVar13), true, false, false, true);
							ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), func_430(func_432(bVar13), func_473(bVar13)));
							PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, true);
							if (func_428() == 0)
							{
							...
							if (func_427(bVar13) > 0)
							{
								TASK::TASK_STAND_STILL(0, func_427(bVar13));
							}
							TASK::TASK_GO_STRAIGHT_TO_COORD(0, func_473(bVar13), 1f, -1, func_464(&Var3), 0.5f);
						...
						if (!func_465(func_466(bVar13)))
						{
							...
							while (iVar82 < iVar39)
							{
								if (ENTITY::DOES_ENTITY_EXIST(iVar39[iVar82]) && !ENTITY::IS_ENTITY_DEAD(iVar39[iVar82], false))
								{
			...
			case 4:
				...
				else if (CAM::IS_SCREEN_FADED_OUT())
				{
					...
					if (func_465(func_466(bVar13)))
					{
						func_417(&uVar5, &Var3, &Var56, &Var61, &Var62, iVar33, &uVar63, &uVar64);
				...
				else
				{
					if (!bVar104)
					{
						...
						else if (func_461(&iVar30) > 4f || (func_465(func_466(bVar13)) && func_461(&iVar30) > 0.5f))
						{
							func_401(&uVar32, "OJBJAUD", func_416(&Var3), 8, 0, 0, 0);
							bVar104 = true;
						}
					}
					if (!CAM::IS_SCREEN_FADING_OUT() && !bVar93)
					{
						if (func_379(&Var3, bVar13, &iVar36, &uVar5, &uVar4, &iVar17, &iVar18, &iVar22, &iVar28, iVar84, &bVar94, &bVar106, bVar98))
						{
							HUD::CLEAR_HELP(true);
							bVar98 = false;
							if (func_378(&Var3))
			...
			case 5:
				...
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					if (bVar93 && bVar103)
					{
						CLOCK::SET_CLOCK_TIME(func_374(iVar15), func_373(iVar15), func_372(iVar15));
					}
					SYSTEM::WAIT(2000);
					if (bVar93)
					{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iVar34) && !ENTITY::IS_ENTITY_DEAD(iVar34, false))
				{
					iVar45 = HUD::ADD_BLIP_FOR_COORD(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iVar34, func_370(&Var3)));
				...
				{
					iVar45 = HUD::ADD_BLIP_FOR_COORD(func_369(&Var3, 0));
					HUD::SET_BLIP_COLOUR(iVar45, 5);
					if (iVar72 == 1)
					{
						HUD::SET_BLIP_NAME_FROM_TEXT_FILE(iVar45, "BJ_BLIP_TGT");
				...
				if (iVar72 > 1)
				{
					iVar46 = HUD::ADD_BLIP_FOR_COORD(func_369(&Var3, 1));
				...
				if (ENTITY::DOES_ENTITY_EXIST(iVar34) && !ENTITY::IS_ENTITY_DEAD(iVar34, false))
				{
					...
					if (func_367(func_368(&Var3)))
					{
						VEHICLE::DELETE_MISSION_TRAIN(&iVar34);
					}
					else
					{
						ENTITY::SET_ENTITY_COORDS(iVar34, func_369(&Var3, 0), true, false, false, true);
					}
				}
				if (BitTest(Global_113648.f_18969.f_1, (func_366(&Var3) - 125)))
				{
				...
				if (!func_378(&Var3))
				{
					...
					{
						if ((func_361(&Var3) && !bVar106) && !bVar93)
						{
							CAM::STOP_RENDERING_SCRIPT_CAMS_USING_CATCH_UP(true, 0f, 3, 0);
						}
						else if (bVar13 == 4 && !func_360())
						{
							CAM::SET_CAM_COORD(func_433(&uVar5, 0), -76.7226f, -829.9866f, 326.0427f);
							CAM::SET_CAM_ROT(func_433(&uVar5, 0), 0.8541f, 0f, -17.012f, 2);
							CAM::SET_CAM_FOV(func_433(&uVar5, 0), 53.883f);
							CAM::SET_CAM_ACTIVE(func_433(&uVar5, 0), true);
						}
						else
						{
							if (CAM::IS_SCRIPT_GLOBAL_SHAKING())
				...
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (bVar111)
					{
						...
						if (bVar112)
						{
							...
							PED::SET_PED_RESERVE_PARACHUTE_TINT_INDEX(PLAYER::PLAYER_PED_ID(), iVar88);
						}
					}
					else
					{
			...
			case 6:
				...
				else if ((bVar97 || bVar96) || func_359(&Var3, bVar13, &bVar99))
				{
					HUD::CLEAR_HELP(true);
					HUD::CLEAR_PRINTS();
					iVar7 = 10;
				...
				else
				{
					...
					if (bVar98)
					{
						Var58 = { func_369(&Var3, (iVar72 - 1)) };
						Var58.f_2 = (Var58.f_2 + 100f);
						ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Var58, true, false, false, true);
						bVar98 = false;
					}
					if (!bVar101)
					{
					...
					func_358(&iVar19);
					func_348(&Var3, iVar34, iVar42, &iVar44, &iVar49, &iVar50, &iVar71, &iVar73, &iVar74, iVar72, &iVar75, &iVar45, &iVar46, &iVar70, &iVar14, &uVar66, &uVar67, &uVar68, &uVar95, 0, 1, fVar65);
					func_347(&iVar52);
					if (func_462(&iVar16))
					{
						if (func_461(&iVar16) > 10f)
						{
							func_343(&iVar20, &iVar80);
						}
					}
					else
					{
					...
					if (ENTITY::DOES_ENTITY_EXIST(iVar36) && !ENTITY::IS_ENTITY_DEAD(iVar36, false))
					{
						...
						{
							iVar114 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(iVar36, -1, false);
					...
					if (!BitTest(uVar78, 0))
					{
						if (HUD::IS_MESSAGE_BEING_DISPLAYED() || !func_462(&iVar31))
						{
							func_371(&iVar31);
						}
						else if (func_461(&iVar31) > 0.25f)
						{
							Var55 = { func_341(bVar13) };
							func_340(&Var55, 7500, 0);
							func_458(&iVar31);
							MISC::SET_BIT(&uVar78, 0);
						}
					}
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						func_339(&Var6, 1);
						iVar38 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), true);
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar38, false) && ENTITY::IS_ENTITY_IN_AIR(iVar38))
						{
							if (!BitTest(uVar78, 1))
							{
								if (!func_462(&iVar24))
								...
								else if (func_461(&iVar24) > 0.15f)
								{
									func_338("BJ_VEHHELP", -1);
									func_458(&iVar24);
									MISC::SET_BIT(&uVar78, 1);
								}
							}
						}
						else
						{
							MISC::CLEAR_BIT(&uVar78, 1);
			...
			case 7:
				...
				else
				{
					...
					func_348(&Var3, iVar34, iVar42, &iVar44, &iVar49, &iVar50, &iVar71, &iVar73, &iVar74, iVar72, &iVar75, &iVar45, &iVar46, &iVar70, &iVar14, &uVar66, &uVar67, &uVar68, &uVar95, 0, 1, fVar65);
					func_347(&iVar52);
					if (func_465(func_466(bVar13)) && !ENTITY::IS_ENTITY_DEAD(iVar33, false))
					{
						func_336(iVar33, func_473(bVar13));
					}
					if (func_462(&iVar16))
					{
						if (func_461(&iVar16) > 10f)
					...
					if (func_332(&Var3, &uVar5, &uVar4, &iVar18, &Var56, &uVar60, Var61, Var62) || bVar98)
					{
						func_458(&iVar16);
						HUD::CLEAR_HELP(true);
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iVar33) && !ENTITY::IS_ENTITY_DEAD(iVar33, false))
							{
								ENTITY::SET_ENTITY_COORDS(iVar33, func_473(bVar13), true, false, false, true);
								ENTITY::SET_ENTITY_HEADING(iVar33, func_464(&Var3));
								...
								TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iVar81, "oddjobs@basejump@", "Heli_jump", 4f, -4f, 7, 0, 1000f, 0);
								PED::SET_SYNCHRONIZED_SCENE_PHASE(iVar81, 0.6f);
								func_330(iVar33, &uVar5, &iVar17);
								STREAMING::NEW_LOAD_SCENE_STOP();
							}
						}
						if (bVar109)
			...
			case 8:
				...
				if (ENTITY::DOES_ENTITY_EXIST(iVar33))
				{
					if (func_329(&uVar5, &iVar17, Var61, Var62, Var56, &uVar63, &uVar64))
					{
			...
			case 9:
				...
				else if (func_328(&uVar4, 3, 1000) && !Global_23131.f_135)
				{
					...
					{
						func_348(&Var3, iVar34, iVar43, &iVar44, &iVar49, &iVar50, &iVar71, &iVar73, &iVar74, iVar72, &iVar75, &iVar45, &iVar46, &iVar70, &iVar14, &uVar66, &uVar67, &uVar68, &uVar95, 0, 1, fVar65);
						SYSTEM::WAIT(0);
					}
					func_282(&Var3, &uVar51, &Var6, &uVar78, &iVar43, &iVar44, &iVar40, &iVar34, &iVar35, &iVar36, &iVar39, &iVar49, &iVar50, iVar45, iVar46, &iVar71, &iVar73, &iVar74, &iVar80, &iVar75, bVar13, &iVar8, &iVar14, &iVar21, &Var27, &uVar60, &uVar66, &uVar67, &uVar68, &uVar95, &bVar94, &bVar96, &bVar97, &bVar98, &bVar100, &iVar92, &iVar41);
					bVar93 = true;
					iVar7 = 0;
				}
				else
				{
					func_279(&iVar26, &iVar44);
					if (bVar98)
					{
						Var58 = { func_369(&Var3, (iVar72 - 1)) };
						func_277(PLAYER::PLAYER_PED_ID(), Var58);
						bVar98 = false;
					}
					func_358(&iVar19);
					if (func_367(func_368(&Var3)))
					{
						if (!ENTITY::DOES_ENTITY_EXIST(iVar34) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_369(&Var3, 0), false) <= 200f)
						{
							iVar34 = VEHICLE::CREATE_MISSION_TRAIN(6, func_369(&Var3, 0), true, 0, 0);
							if (!ENTITY::IS_ENTITY_DEAD(iVar34, false))
							{
								VEHICLE::SET_TRAIN_CRUISE_SPEED(iVar34, 7.5f);
							}
						}
					}
					else if ((ENTITY::DOES_ENTITY_EXIST(iVar34) && !ENTITY::IS_ENTITY_DEAD(iVar34, false)) && !func_431(func_369(&Var3, 0)))
					{
						PED::IS_PED_INJURED(iVar43);
						if (func_276(PLAYER::PLAYER_PED_ID(), iVar34, 0) <= 325f)
						{
							if (bVar13 == 5)
							{
							...
							{
								Var115 = { -819.7591f, -1512.2285f, 0.1336f };
							}
							if (TASK::GET_SCRIPT_TASK_STATUS(iVar43, joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 1)
							{
								if (bVar13 == 5)
								{
									TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iVar43, iVar34, Var115, 4, 5f, 16785408, 5f, 10f, true);
								}
								else
								{
									TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iVar43, iVar34, Var115, 4, 5f, 16777216, 4f, -1f, true);
								}
							}
							else
							{
					...
					iVar8 = func_348(&Var3, iVar34, iVar43, &iVar44, &iVar49, &iVar50, &iVar71, &iVar73, &iVar74, iVar72, &iVar75, &iVar45, &iVar46, &iVar70, &iVar14, &uVar66, &uVar67, &uVar68, &uVar95, 1, 1, fVar65);
					if (iVar8 == 1 || iVar8 >= 2)
					{
						...
						{
							if (ENTITY::DOES_ENTITY_EXIST(iVar44[iVar116]) && !ENTITY::IS_ENTITY_DEAD(iVar44[iVar116], false))
							{
					...
					func_270(&Var6, &Var3, bVar13, iVar72);
				}
				break;
			...
			case 10:
				...
				if ((!bVar96 && !bVar97) && !bVar99)
				{
					...
					if (func_368(&Var3) == 0)
					{
						func_269(func_369(&Var3, (iVar72 - 1)), Var27);
					}
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (((((ENTITY::DOES_ENTITY_EXIST(iVar34) && !ENTITY::IS_ENTITY_DEAD(iVar34, false)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iVar34, Var59, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_369(&Var3, iVar71), Var59, false, true, 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()))
						{
							bVar117 = false;
							...
							if (bVar117)
							{
								if (func_328(&uVar4, 3, 1000) && !Global_23131.f_135)
								{
									ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), true);
									PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 256);
									CAM::DO_SCREEN_FADE_OUT(800);
				...
				if (((bVar96 || bVar97) || bVar99) || (func_462(&iVar21) && func_461(&iVar21) > 0.25f))
				{
					if (func_462(&iVar21) && func_461(&iVar21) > 0.25f)
					{
						func_265(func_369(&Var3, iVar71), iVar34, iVar43, &iVar8, &iVar75, &fVar69);
					}
					func_458(&iVar21);
					if (bVar96 || iVar8 == 1)
					{
						...
						if (bVar13 == 0)
						{
							...
							{
								func_401(&uVar32, "OJBJAUD", "BJ_01D", 8, 1, 1, 0);
							}
						}
						iVar7 = 11;
						if (!func_263(&Var6, 7))
						{
							iVar79 = 125;
							MISC::SET_BIT(&(Global_113648.f_18969.f_1), (func_366(&Var3) - iVar79));
							func_262(func_366(&Var3), 1);
							iVar89 = 1;
							bVar90 = true;
							bVar91 = true;
							bVar83 = false;
							while (bVar83 < 13)
							{
								if (!BitTest(Global_113648.f_18969.f_1, bVar83))
								{
									if (func_465(func_466(bVar83)))
									{
										bVar91 = false;
									}
									else
					...
					else if ((bVar97 || bVar99) || iVar8 >= 2)
					{
						...
						{
							func_214(&Var6, 0, 201, "BJ_CONTINUE", 203, "BJ_RETRY", 363, 0, 363, 0);
						}
						else
						{
							func_221(&Var6, 27, 1);
							func_214(&Var6, 0, 201, "BJ_CONTINUE", 203, "BJ_RETRY", 211, "HUD_INPUT68" /* GXT: Online Leaderboard */, 363, 0);
						}
						iVar7 = 12;
					}
					func_458(&iVar18);
			...
			case 11:
				...
				if (!bVar96 && !bVar97)
				{
					if (func_213() && !func_263(&Var6, 26))
					{
						func_202(bVar13);
						if (func_190(bVar13, iVar75, fVar69, iVar76))
						{
							func_214(&Var6, 0, 215, "BJ_CONTINUE", 216, "BJ_RETRY", 211, "HUD_INPUT68" /* GXT: Online Leaderboard */, 363, 0);
							func_221(&Var6, 26, 1);
						}
					}
				}
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					bVar108 = PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false);
				}
				if (func_368(&Var3) == 0)
				{
					func_269(func_369(&Var3, (iVar72 - 1)), Var27);
				...
				if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					...
					func_78(&Var3, &uVar51, &iVar33, &iVar34, &iVar36, &iVar39, iVar40, &uVar32, &iVar42, &iVar43, &iVar44, iVar85, &iVar80, iVar45, iVar46, bVar13, &iVar41, bVar111);
				}
				else if (!CAM::IS_SCREEN_FADING_OUT() && (!func_77() || func_461(&iVar25) >= 2f))
				{
					...
					if (func_462(&iVar18))
					{
						if ((iVar9 == 1 || func_461(&iVar18) >= 60f) || ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID())) || (!bVar108 && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))))
						{
							if (!bVar113)
							{
								func_76(&(Var6.f_26));
			...
			case 12:
				...
				if (bVar107)
				{
					...
					else
					{
						...
						func_2(bVar103, &Var3, &uVar51, &iVar33, &iVar34, &iVar36, &iVar39, iVar40, &uVar32, &iVar42, &iVar43, &iVar44, iVar85, &iVar80, iVar45, iVar46, bVar13, &iVar41, bVar111);
					}
					func_1(&iVar10);
				}
				iVar8 = 0;
...
var func_58(int iParam0, bool bParam1)//Position - 0x5671
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_23270.f_7488[iParam0 /*16*/])))
	{
		...
		{
			return func_59(&(Global_23270.f_7488[iParam0 /*16*/]));
		}
	}
	switch (iParam0)
	{
...
char* func_61(int iParam0)//Position - 0x5BBA
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_23270.f_6463[iParam0 /*16*/])))
	{
		...
		{
			Var1 = { func_60(PLAYER::PLAYER_ID()) };
			NETWORK::NETWORK_CLAN_GET_EMBLEM_TXD_NAME(&Var1, &uVar0);
			return func_59(&uVar0);
		}
		else
		{
			return func_59(&(Global_23270.f_6463[iParam0 /*16*/]));
		}
	}
	if (iParam0 == 52)
	{
...
int func_79(bool bParam0, int* iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, float fParam8, int iParam9)//Position - 0x6522
{
	if (!func_263(iParam1, 5))
	{
		...
		func_214(iParam1, 0, 215, "BJ_CONTINUE", 216, "BJ_RETRY", 363, 0, 363, 0);
	...
	if (SYSTEM::TIMERA() > 1000)
	{
		if (*iParam9)
		{
			...
			else if (func_81(&iLocal_510, 0))
			{
				iLocal_510 = 0;
				*iParam9 = 0;
				func_214(iParam1, 0, 215, "BJ_CONTINUE", 216, "BJ_RETRY", 211, "HUD_INPUT68" /* GXT: Online Leaderboard */, 363, 0);
			}
		}
		else
		{
		...
		if (*iParam9)
		{
			if (PLAYER::IS_PLAYER_ONLINE())
			{
				if (!func_263(iParam1, 28) && func_80(&uLocal_73))
				{
					func_221(iParam1, 28, 1);
					func_214(iParam1, 0, 202, "HUD_INPUT53" /* GXT: Back */, 217, "SCLB_PROFILE" /* GXT: View Profile */, 363, 0, 363, 0);
				}
			}
			...
			*iParam9 = 1;
			if (PLAYER::IS_PLAYER_ONLINE())
			{
				...
				else
				{
					...
					func_214(iParam1, 0, 202, "HUD_INPUT53" /* GXT: Back */, 363, 0, 363, 0, 363, 0);
				}
			}
		}
	}
...
void func_100(var uParam0, var uParam1)//Position - 0x7098
{
	...
	Var10 = { func_60(PLAYER::PLAYER_ID()) };
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0))
	{
				...
				if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_2097536.f_2780.f_1)))
				{
					if (!func_169(uParam1->f_44))
					{
						if (Global_2097536.f_2780.f_26 > 0)
						{
							...
							func_168(*uParam0, &(Global_2097536.f_2780.f_1), &cVar7, &Var6, Global_2097536.f_2780.f_25, Global_2097536.f_2780.f_26);
						}
						else
						{
					...
					else if (!Global_2097536.f_2780.f_27)
					{
						...
						if (Global_2097536.f_2780.f_26 > 0)
						{
							func_168(*uParam0, &(Global_2097536.f_2780.f_1), &Var6, &(Global_2097536.f_2780.f_9), Global_2097536.f_2780.f_25, Global_2097536.f_2780.f_26);
						}
						else
						{
							func_168(*uParam0, &(Global_2097536.f_2780.f_1), &Var6, &(Global_2097536.f_2780.f_9), Global_2097536.f_2780.f_25, -1);
						}
					}
					else
					{
				...
				if (!BitTest(uParam1->f_42, 0))
				{
					...
					if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_2097536.f_2780.f_1)))
					{
						if (!func_169(uParam1->f_44))
						{
							...
							{
								Var6 = { Global_2097536.f_2780.f_9 };
								func_168(*uParam0, &(Global_2097536.f_2780.f_1), &cVar7, &Var6, 1, Global_2097536.f_2780.f_26);
							}
							else
							{
								func_168(*uParam0, &(Global_2097536.f_2780.f_1), &cVar7, &(Global_2097536.f_2780.f_9), Global_2097536.f_2780.f_25, -1);
							...
							if (func_120(Global_2101867[iVar0 /*100*/].f_32))
							{
								...
								if (!bVar14)
								{
									...
									if (func_169(uParam1->f_44))
									{
										...
										func_118(*uParam0, iVar3, iVar9, Global_2101867[iVar0 /*100*/].f_59, &Var6, &(Global_2101867[iVar0 /*100*/].f_80));
...
void func_106(struct<30> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, bool bParam14, float fParam15, bool bParam16)//Position - 0x8598
{
...
void func_109(struct<30> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, bool bParam14, int iParam15, bool bParam16, bool bParam17)//Position - 0x86DA
{
	struct<4> Var0;
	...
	switch (Param0.f_29[bParam14])
	{
		...
		case 8:
			...
			{
				GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(func_114(func_117(iParam15), 0));
				GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
			}
			else
			{
		...
		case 22:
			...
			{
				GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("NUMBER");
				HUD::ADD_TEXT_COMPONENT_INTEGER(func_110(iParam15));
				GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
			}
			else
			{
...
var func_115(var uParam0)//Position - 0x9AEF
{
	return uParam0;
}

int func_116(int iParam0, var* uParam1)//Position - 0x9AF9
{
	int iVar0;
	int iVar1;
...
int func_117(int iParam0)//Position - 0x9B34
{
	if (iParam0 == 600)
	{
...
void func_118(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, char* sParam5)//Position - 0x9CA7
{
...
int func_119(var* uParam0, var* uParam1)//Position - 0x9CF9
{
	if (!func_120(*uParam0))
	{
		return 0;
...
bool func_120(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)//Position - 0x9D33
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

void func_121(var uParam0, var uParam1)//Position - 0x9D43
{
	int iVar0;
	int iVar1;
	struct<75> Var2;
...
void func_122(var uParam0, var uParam1)//Position - 0x9EAE
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void func_123(var uParam0)//Position - 0x9F5D
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void func_124(var uParam0)//Position - 0xA16E
{
	struct<13> Var0;
	int iVar1;
...
int func_125(var uParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA1E2
{
	int iVar0;
...
void func_126(var uParam0)//Position - 0xA48B
{
	struct<13> Var0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0, int iParam1, int iParam2, char* sParam3)//Position - 0xA56A
{
...
int func_128(var uParam0)//Position - 0xA59E
{
	if (!Global_2097532)
	{
...
void func_129(var uParam0)//Position - 0xA757
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
Vector3 func_130(int iParam0)//Position - 0xA93D
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_131(int iParam0, int iParam1)//Position - 0xA950
{
	int iVar0;
...
int func_132(int iParam0)//Position - 0xA9CC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_133(var uParam0)//Position - 0xAA5F
{
	int iVar0;
	int iVar1;
...
int func_134(var uParam0, var uParam1, var* uParam2, var uParam3)//Position - 0xAC0C
{
	var* uVar0;
	int iVar1;
...
void func_135(var* uParam0, char* sParam1)//Position - 0xACC5
{
	NETWORK::NETWORK_CLAN_GET_UI_FORMATTED_TAG(uParam0, 35, sParam1);
}

int func_136(var* uParam0, var uParam1)//Position - 0xACD7
{
	int iVar0;
...
bool func_137()//Position - 0xAD16
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_138(var uParam0)//Position - 0xAD2C
{
	int iVar0;
...
void func_139(var uParam0)//Position - 0xAD9C
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_140(var uParam0)//Position - 0xADE4
{
	int iVar0;
...
int func_141(var uParam0, var* uParam1, char* sParam2)//Position - 0xAE52
{
	if (*uParam0 == 2)
	{
		return 1;
...
int func_142(var uParam0)//Position - 0xAF63
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_143(var uParam0)//Position - 0xB0F8
{
	int iVar0;
...
int func_144(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, char* sParam17)//Position - 0xB195
{
	struct<13> Var0;
...
int func_145(var uParam0, char* sParam1, char* sParam2, int iParam3, var uParam4)//Position - 0xB2B7
{
	int iVar0;
	struct<13> Var1[1];
...
int func_146(var uParam0)//Position - 0xB3BC
{
	struct<97> Var0;
	struct<6> Var1;
	int iVar2;
	...
	iVar5 = -1;
	iVar9 = 2;
	Var12 = { func_60(PLAYER::PLAYER_ID()) };
	switch ((*uParam0)[iVar9])
	{
					...
					if (Var1.f_3 > 0)
					{
						...
						if (Var0.f_96 <= 1)
						{
							if (Global_2097536.f_2704[iVar9] < 11)
							{
								if (func_159() && iVar5 == 0)
								{
									func_155(uParam0, &(Global_2097536[iVar9 /*901*/][Global_2097536.f_2704[iVar9] /*75*/]), Var0.f_96);
						...
						while (iVar7 <= (Var1.f_3 - 1))
						{
							...
							if (Global_2097536.f_2704[iVar9] < 11 && Var0.f_96 > 1)
							{
								...
								{
									if (!func_119(&(Global_2097536[iVar9 /*901*/][0 /*75*/].f_32), &Var12))
									{
										func_155(uParam0, &(Global_2097536[iVar9 /*901*/][Global_2097536.f_2704[iVar9] /*75*/]), Var0.f_96);
								...
								{
									if (func_120(Var0) && !func_119(&Var0, &(Global_2097536[iVar9 /*901*/][0 /*75*/].f_32)))
									{
										if (func_119(&Var0, &Var12))
										{
						...
						if (bVar8)
						{
							if (Global_2097536.f_2775[iVar9] == -1 && func_159())
							{
								if (Global_2097536.f_2704[iVar9] >= 1)
								{
									func_155(uParam0, &(Global_2097536[iVar9 /*901*/][Global_2097536.f_2704[iVar9] /*75*/]), Global_2097536[iVar9 /*901*/][(Global_2097536.f_2704[iVar9] - 1) /*75*/].f_59 + 1);
								}
								else
								{
									func_155(uParam0, &(Global_2097536[iVar9 /*901*/][Global_2097536.f_2704[iVar9] /*75*/]), 1);
								}
								Global_2097536.f_2775[iVar9] = Global_2097536.f_2704[iVar9];
								Global_2097536.f_2704[iVar9]++;
							}
		...
		case 3:
			func_147(iVar9, Global_2097157.f_374);
			(*uParam0)[iVar9] = 4;
			break;
...
void func_147(int iParam0, int iParam1)//Position - 0xC1E2
{
	int iVar0;
...
int func_148(var uParam0, var uParam1, var* uParam2, int iParam3, int iParam4)//Position - 0xC307
{
	switch (*uParam0)
	{
		case 0:
...
void func_153(var uParam0, var uParam1, var uParam2)//Position - 0xC463
{
	*uParam0 = 0;
	*uParam1 = 0;
	Global_2097152 = 0;
...
int func_154(int iParam0)//Position - 0xC48F
{
...
void func_155(var uParam0, char* sParam1, int iParam2)//Position - 0xC4ED
{
	int iVar0;
	int iVar1;
...
void func_156(var uParam0)//Position - 0xC5F7
{
	int iVar0;
...
void func_157(var uParam0, var uParam1)//Position - 0xC6A0
{
	*uParam0 = *uParam1;
...
int func_158(var uParam0, var uParam1, var* uParam2, int iParam3, var* uParam4, bool bParam5, bool bParam6, int iParam7, int iParam8)//Position - 0xC6BB
{
	int iVar0;
	float fVar1;
...
int func_160(var uParam0)//Position - 0xC80D
{
	struct<20> Var0;
	struct<6> Var1;
	int iVar2;
				...
				if (func_161(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44), &(uParam0->f_113), uParam0->f_113[0 /*66*/], bVar8, 0, 100))
				{
					...
					if (uParam0->f_5 && STATS::LEADERBOARDS2_READ_GET_ROW_DATA_START(&Var1))
					{
						...
						if (Var1.f_3 > 0)
						{
							...
							else if (func_120(Var0) && Global_2097536.f_2704[iVar9] < 11)
							{
						...
						while (iVar6 <= (Var1.f_3 - 1))
						{
							...
							if (Global_2097536.f_2704[iVar9] < 11 && Var0.f_96 > 1)
							{
								...
								{
									if (!func_119(&(Global_2097536[iVar9 /*901*/][0 /*75*/].f_32), &Var10))
									{
										func_155(uParam0, &(Global_2097536[iVar9 /*901*/][Global_2097536.f_2704[iVar9] /*75*/]), Var0.f_96);
...
int func_161(var uParam0, var uParam1, var* uParam2, var* uParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0xD207
{
	switch (*uParam0)
	{
		case 0:
...
int func_162(var uParam0)//Position - 0xD2C3
{
	struct<13> Var0;
	struct<97> Var1;
	struct<6> Var2;
	...
	switch ((*uParam0)[iVar10])
	{
					...
					if (Var2.f_3 > 0)
					{
						...
						if (Var1.f_96 <= 1)
						{
							if (Global_2097536.f_2704[iVar10] < 11)
							{
								if (func_159() && iVar6 == 0)
								{
									func_155(uParam0, &(Global_2097536[iVar10 /*901*/][Global_2097536.f_2704[iVar10] /*75*/]), Var1.f_96);
						...
						while (iVar8 <= (Var2.f_3 - 1))
						{
							...
							if (Global_2097536.f_2704[iVar10] < 11 && Var1.f_96 > 1)
							{
								...
								{
									if (!func_119(&(Global_2097536[iVar10 /*901*/][0 /*75*/].f_32), &Var1))
									{
										func_155(uParam0, &(Global_2097536[iVar10 /*901*/][Global_2097536.f_2704[iVar10] /*75*/]), Var1.f_96);
								...
								{
									if (func_120(Var1) && !func_119(&(Global_2097536[iVar10 /*901*/][0 /*75*/].f_32), &Var1))
									{
										if (func_119(&Var1, &Var0))
										{
						...
						if (bVar9)
						{
							if (Global_2097536.f_2775[iVar10] == -1 && func_159())
							{
								if (Global_2097536.f_2704[iVar10] >= 1)
								{
									func_155(uParam0, &(Global_2097536[iVar10 /*901*/][Global_2097536.f_2704[iVar10] /*75*/]), Global_2097536[iVar10 /*901*/][(Global_2097536.f_2704[iVar10] - 1) /*75*/].f_59 + 1);
								}
								else
								{
									func_155(uParam0, &(Global_2097536[iVar10 /*901*/][Global_2097536.f_2704[iVar10] /*75*/]), 1);
								}
								Global_2097536.f_2775[iVar10] = Global_2097536.f_2704[iVar10];
								Global_2097536.f_2704[iVar10]++;
							}
		...
		case 2:
			func_147(iVar10, Global_2097157.f_374);
			(*uParam0)[iVar10] = 3;
			break;
...
int func_163(struct<4> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65)//Position - 0xE0EF
{
	int iVar0;
...
void func_164(var uParam0)//Position - 0xE187
{
	int iVar0;
...
void func_165(int iParam0)//Position - 0xE1D7
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iParam0))
	{
		GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iParam0, 255, 255, 255, 0, 0);
...
void func_166(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xE1F7
{
	char* sVar0;
	struct<2> Var1;
	struct<16> Var2;
...
void func_167(int iParam0, char* sParam1, var uParam2, int iParam3)//Position - 0xE4CE
{
	int iVar0;
...
void func_168(int iParam0, char* sParam1, char* sParam2, char* sParam3, bool bParam4, int iParam5)//Position - 0xE510
{
...
int func_169(int iParam0)//Position - 0xE5A0
{
...
void func_170(int iParam0, int iParam1)//Position - 0xE5C2
{
...
int func_171()//Position - 0xE5DF
{
	return GRAPHICS::REQUEST_SCALEFORM_MOVIE("SC_LEADERBOARD");
}

bool func_172()//Position - 0xE5EF
{
	return func_173(PLAYER::PLAYER_ID());
}

int func_173(int iParam0)//Position - 0xE5FF
{
...
int func_174(int iParam0)//Position - 0xE65F
{
	return Global_1853910[iParam0 /*862*/].f_192;
}

void func_175(int iParam0)//Position - 0xE672
{
	Global_1577898 = iParam0;
}

void func_176(int iParam0)//Position - 0xE680
{
	Global_1655472.f_1163 = iParam0;
}

void func_177(bool bParam0)//Position - 0xE691
{
	if (bParam0)
	{
		func_179();
...
void func_178(int iParam0, int iParam1)//Position - 0xE6E2
{
...
void func_179()//Position - 0xE718
{
	Global_2793044.f_4629 = 0;
}

void func_180(var uParam0, bool bParam1, bool bParam2)//Position - 0xE728
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
	{
		if (!bParam2)
...
int func_181(var uParam0, bool bParam1, int iParam2)//Position - 0xE765
{
...
void func_182(var uParam0)//Position - 0xE904
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "CLEAR_ALL");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	if (MISC::IS_PC_VERSION())
...
void func_183(var uParam0)//Position - 0xE9C9
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_184(var uParam0)//Position - 0xEAD1
{
	uParam0->f_547 = 1f;
	uParam0->f_546 = 0;
	uParam0->f_572 = 0f;
...
void func_185(int* iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, var uParam5, float fParam6)//Position - 0xEB50
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_186(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0xECA3
{
	int iVar0;
...
void func_187(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xED16
{
...
void func_188(var uParam0)//Position - 0xED39
{
	func_184(uParam0);
	uParam0->f_574 = 0;
	uParam0->f_31 = 0;
...
char* func_189(int iParam0)//Position - 0xED63
{
	switch (iParam0)
	{
		case 0:
...
int func_190(bool bParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEE1E
{
...
int func_191(var uParam0)//Position - 0xEE61
{
	struct<98> Var0;
	struct<4> Var1;
	struct<37> Var2;
	...
	switch (Global_2097157)
	{
		case 0:
			if (func_198(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44), &Var3))
			{
				...
				{
					if (!func_197(uParam0->f_44, iVar4))
					{
						if (func_196(uParam0->f_44, 4, iVar4))
						{
...
bool func_192()//Position - 0xF284
{
	return BitTest(Global_1048576.f_10, 1);
}

var func_193()//Position - 0xF294
{
	return Global_2692733.f_3;
}

int func_194(int iParam0)//Position - 0xF2A2
{
	switch (iParam0)
	{
		case 817:
...
int func_196(int iParam0, int iParam1, int iParam2)//Position - 0xF3D3
{
	int iVar0;
...
int func_197(int iParam0, int iParam1)//Position - 0xF4D5
{
...
int func_198(var uParam0, var uParam1, var* uParam2, var* uParam3)//Position - 0xF530
{
	switch (*uParam0)
	{
		case 0:
...
void func_199(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xF5E4
{
	struct<6> Var0[1];
	struct<8> Var1[1];
...
void func_200(int iParam0, int iParam1, int iParam2, float fParam3, bool bParam4)//Position - 0xF773
{
	int iVar0;
	int iVar1;
...
int func_201(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xF88E
{
	struct<68> Var0;
	int iVar1;
	struct<13> Var2;
...
void func_202(bool bParam0)//Position - 0xF9C2
{
	struct<3> Var0;
	...
	func_203(&uLocal_73, 85, &Var0, func_189(bParam0), bParam0, -1, 0, 0);
}

void func_203(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0xFAC3
{
	struct<8> Var0;
	struct<8> Var1;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 0:
			...
			else
			{
				...
				if (func_210(Global_4718592.f_166301) || func_207(Global_4718592.f_166301))
				{
					StringCopy(&(Global_2097536.f_2717[0 /*6*/]), "SCLB_C_SCORE" /* GXT: SCORE */, 24);
				...
				else if (func_206(Global_4718592.f_166301))
				{
					StringCopy(&(Global_2097536.f_2717[0 /*6*/]), "SCLB_C_SCORE" /* GXT: SCORE */, 24);
					StringCopy(&(Global_2097536.f_2717[1 /*6*/]), "SCLB_C_DEATH" /* GXT: DEATHS */, 24);
					StringCopy(&(Global_2097536.f_2717[2 /*6*/]), "SCLB_C_RANK" /* GXT: POSITION */, 24);
...
int func_204(struct<8> Param0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)//Position - 0x14B12
{
	char cVar0[64];
...
struct<6> func_205(int iParam0)//Position - 0x14B84
{
	struct<6> Var0;
...
bool func_206(int iParam0)//Position - 0x14C33
{
	return iParam0 == 74;
}

var func_207(int iParam0)//Position - 0x14C40
{
	return (func_209(iParam0) || func_208(iParam0));
}

bool func_208(int iParam0)//Position - 0x14C5A
{
	return iParam0 == 44;
}

bool func_209(int iParam0)//Position - 0x14C67
{
	return iParam0 == 45;
}

bool func_210(int iParam0)//Position - 0x14C74
{
	return iParam0 == 12;
}

struct<6> func_211(int iParam0)//Position - 0x14C81
{
	struct<6> Var0;
...
bool func_213()//Position - 0x14F07
{
	return NETWORK::NETWORK_IS_SIGNED_ONLINE();
}

void func_214(int* iParam0, bool bParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x14F13
{
	if (*iParam0 == 0)
	{
	...
	iParam0->f_3[6] = 363;
	iParam0->f_3[7] = 363;
	iParam0->f_12[0] = func_215(iParam2 != 363, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2 /*FRONTEND_CONTROL*/, iParam2, true), "");
	iParam0->f_12[1] = func_215(iParam4 != 363, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2 /*FRONTEND_CONTROL*/, iParam4, true), "");
	iParam0->f_12[2] = func_215(iParam6 != 363, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2 /*FRONTEND_CONTROL*/, iParam6, true), "");
	iParam0->f_12[3] = func_215(iParam8 != 363, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2 /*FRONTEND_CONTROL*/, iParam8, true), "");
	iParam0->f_12[4] = 0;
	iParam0->f_12[5] = 0;
	iParam0->f_12[6] = 0;
	iParam0->f_12[7] = 0;
...
char* func_215(bool bParam0, char* sParam1, char* sParam2)//Position - 0x15057
{
	if (bParam0)
	{
		return sParam1;
...
void func_216()//Position - 0x1506E
{
	func_217(PLAYER::PLAYER_PED_ID(), "GENERIC_CURSE_MED", 24);
}

void func_217(int iParam0, char* sParam1, int iParam2)//Position - 0x15084
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iParam0, sParam1, func_218(iParam2), 1);
}

int func_218(int iParam0)//Position - 0x1509B
{
	int iVar0;
...
void func_220(int iParam0, int iParam1)//Position - 0x152DB
{
	Global_100720.f_7 = iParam0;
	Global_100720.f_8 = iParam1;
}

void func_221(int* iParam0, int iParam1, bool bParam2)//Position - 0x152F3
{
	if (bParam2)
	{
...
int func_222(var uParam0, int iParam1, var uParam2, var uParam3, float fParam4)//Position - 0x15319
{
	int iVar0;
...
void func_223(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x15387
{
	int iVar0;
	int iVar1;
...
int func_224(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x15459
{
	float fVar0;
	bool bVar1;
	int iVar2;
...
void func_225(bool bParam0)//Position - 0x15A58
{
	int iVar0;
	int iVar1;
...
void func_226(int iParam0)//Position - 0x15CDA
{
	int iVar0;
...
void func_227(bool bParam0)//Position - 0x15D34
{
	bool bVar0;
	char cVar1[64];
	...
	else if (BitTest(Global_113648.f_20566.f_471, bParam0) || BitTest(Global_2359296[func_229() /*5568*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_229() /*5568*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
char* func_228(bool bParam0)//Position - 0x15EB3
{
	switch (bParam0)
	{
		case 0:
...
void func_230(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x15FC2
{
	int iVar0;
	...
	iVar0 = Global_2805027[iParam0 /*3*/][func_231(iParam2)];
	if (iVar0 != 0)
	{
...
int func_231(var uParam0)//Position - 0x15FF2
{
	int iVar0;
	int iVar1;
...
int func_232()//Position - 0x16026
{
	return Global_1574918;
}

void func_233(int iParam0, bool bParam1, int iParam2)//Position - 0x16032
{
	if (iParam2 == -1)
	{
		iParam2 = func_232();
...
void func_234(int iParam0)//Position - 0x16050
{
	func_363(93, iParam0);
	func_363(29, iParam0);
	func_363(30, iParam0);
...
int func_235(int iParam0)//Position - 0x16070
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	return BitTest(Global_2359296[func_229() /*5568*/].f_681.f_10, iParam0);
}

int func_236(int iParam0, int iParam1, int iParam2)//Position - 0x16216
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 != 14192)
	{
		...
		iVar0 = Global_2805027[iParam0 /*3*/][func_231(iParam1)];
...
bool func_237(int iParam0, int iParam1)//Position - 0x16253
{
	if (iParam1 == -1)
	{
		iParam1 = func_232();
...
int func_238(bool bParam0)//Position - 0x1626F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_239(int iParam0, int iParam1)//Position - 0x16326
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_240(int iParam0, int iParam1)//Position - 0x16341
{
	...
	if (func_250(&Global_4542597))
	{
		if (func_248(&Global_4542597, iParam0))
		{
			return 0;
		}
		if (func_241(&Global_4542597, iParam0))
		{
			return 1;
		}
	}
...
int func_241(var uParam0, int iParam1)//Position - 0x163DE
{
	int iVar0;
	var uVar1[78];
...
int func_242(var uParam0, int iParam1)//Position - 0x1648F
{
	int iVar0;
...
bool func_243(var uParam0, int iParam1)//Position - 0x1650A
{
	return (*uParam0)[iParam1] == 78;
}

void func_244(var uParam0)//Position - 0x1651B
{
	int iVar0;
	...
	func_246(uParam0, (Global_4542596 - 0.5f));
}

void func_245(var uParam0, int iParam1)//Position - 0x1654F
{
	(*uParam0)[iParam1] = 78;
}

void func_246(var uParam0, float fParam1)//Position - 0x1655F
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_247(var uParam0)//Position - 0x1657C
{
	return uParam0->f_80;
}

bool func_248(var uParam0, int iParam1)//Position - 0x16588
{
	return func_249(uParam0, iParam1) != -1;
}

int func_249(var uParam0, int iParam1)//Position - 0x1659A
{
	int iVar0;
...
bool func_250(var uParam0)//Position - 0x165C7
{
	return uParam0->f_79 == 1;
}

int func_251(int iParam0)//Position - 0x165D5
{
	switch (iParam0)
	{
		case 60:
...
bool func_252(int iParam0)//Position - 0x16625
{
	return Global_43257 == iParam0;
}

int func_253(int iParam0, int iParam1)//Position - 0x16633
{
	int iVar0;
...
void func_254(int iParam0, int iParam1)//Position - 0x16684
{
	int iVar0;
...
void func_255()//Position - 0x166A7
{
	int iVar0;
...
int func_256(int iParam0)//Position - 0x1671C
{
	return Global_2028[iParam0 /*29*/].f_17;
}

void func_257(int iParam0, int iParam1, int iParam2)//Position - 0x1672D
{
	bool bVar0;
...
void func_258()//Position - 0x16813
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	{
		func_253(13, SYSTEM::FLOOR(Global_113648.f_10196.f_3853));
	}
...
int func_259()//Position - 0x16CD1
{
	return Global_32163;
}

void func_260(int iParam0, int iParam1)//Position - 0x16CDC
{
...
int func_261(int iParam0)//Position - 0x16D21
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
void func_262(int iParam0, bool bParam1)//Position - 0x16D4E
{
	int iVar0;
...
bool func_263(int* iParam0, int iParam1)//Position - 0x16DD4
{
	return BitTest(iParam0->f_607, iParam1);
}

int func_264()//Position - 0x16DE4
{
	return GRAPHICS::REQUEST_SCALEFORM_MOVIE("MP_BIG_MESSAGE_FREEMODE");
}

void func_265(struct<3> Param0, int iParam1, int iParam2, int iParam3, var uParam4, float fParam5)//Position - 0x16DF4
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (bVar12)
	{
		...
		*fParam5 = fVar15;
		...
		{
			*uParam4 = func_268(SYSTEM::CEIL(((100f * (15f - fVar15)) / 15f)) + 4, 0, 100);
			*iParam3 = 1;
		}
		else
		{
	...
	if (bVar10)
	{
		...
		Var17 = { ENTITY::GET_ENTITY_COORDS(iVar0, true) };
		Var18 = { ENTITY::GET_ENTITY_COORDS(iVar16, true) };
	}
}

int func_266(int iParam0, int iParam1)//Position - 0x16F8B
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
	...
	if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && ENTITY::DOES_ENTITY_EXIST(iParam0)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iVar0, false))
			{
				...
				{
					Var5 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) };
					Var5.f_0 = func_267((MISC::ABSF(Var5.f_0) - 1.305f), 0f);
					if (Var5.f_1 >= 0f)
					{
						Var5.f_1 = func_267((Var5.f_1 - 5.98f), 0f);
					}
					else
					{
						Var5.f_1 = func_267((-Var5.f_1 - 6.21f), 0f);
					}
...
float func_267(float fParam0, float fParam1)//Position - 0x1713E
{
	if (fParam0 > fParam1)
	{
		return fParam0;
...
int func_268(int iParam0, int iParam1, int iParam2)//Position - 0x17155
{
	if (iParam0 > iParam2)
	{
		return iParam2;
...
void func_269(struct<3> Param0, int* iParam1, var uParam2, var uParam3)//Position - 0x1717A
{
	float fVar0;
	int iVar1;
...
void func_270(int* iParam0, var uParam1, bool bParam2, int iParam3)//Position - 0x17231
{
	int iVar0;
	...
	if (func_337("BJ_FALLHLP") && Global_23131.f_135)
	{
		HUD::CLEAR_HELP(true);
		func_221(iParam0, 1, 0);
	}
	if (!func_263(iParam0, 1) && !Global_23131.f_135)
	{
...
void func_271(int iParam0)//Position - 0x17393
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam0, false))
	{
		Var2 = { ENTITY::GET_ENTITY_COORDS(*iParam0, true) };
		Var2.f_2 = 0f;
		Var6 = { ENTITY::GET_ENTITY_VELOCITY(*iParam0) };
	}
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam0, false))
	{
		ENTITY::GET_ENTITY_MATRIX(*iParam0, &Var3, &uVar5, &uVar5, &uVar5);
		Var3.f_2 = 0f;
	}
	Var4 = { Var1 - Var2 };
	Var4.f_2 = 0f;
	fVar9 = MISC::ABSF(func_275(Var4, Var3));
	if (func_274(*iParam0))
	{
	...
	fVar10 = func_49(func_272(Var6.f_1, fVar8, 0.5f), Var6.f_1, fVar7);
	Var6.f_1 = func_272(Var6.f_1, fVar8, 0.5f);
	if (((ENTITY::DOES_ENTITY_EXIST(*iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam0, false)) && Var6.f_1 > 2f) && Var6.f_1 < VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(*iParam0))
	{
		TASK::SET_DRIVE_TASK_MAX_CRUISE_SPEED(VEHICLE::GET_PED_IN_VEHICLE_SEAT(*iParam0, -1, false), fVar10);
	}
}

float func_272(float fParam0, float fParam1, float fParam2)//Position - 0x17506
{
	float fVar0;
	
	fVar0 = ((1f - SYSTEM::COS(func_273((fParam2 * 3.1415927f)))) * 0.5f);
	return ((fParam0 * (1f - fVar0)) + (fParam1 * fVar0));
}

float func_273(float fParam0)//Position - 0x17535
{
	return (fParam0 * 57.29578f);
}

int func_274(int iParam0)//Position - 0x17545
{
	struct<3> Var0;
	struct<3> Var1;
	var uVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		ENTITY::GET_ENTITY_MATRIX(iParam0, &Var4, &uVar2, &uVar2, &Var1);
	}
	Var3 = { Var0 - Var1 };
	Var3.f_2 = 0f;
	Var4.f_2 = 0f;
	fVar5 = func_275(Var3, Var4);
	if (fVar5 < 0f)
	{
		return 1;
	}
...
float func_275(struct<3> Param0, struct<3> Param1)//Position - 0x175AF
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

float func_276(int iParam0, int iParam1, bool bParam2)//Position - 0x175D0
{
	struct<3> Var0;
	struct<3> Var1;
...
Vector3 func_277(int iParam0, struct<3> Param1)//Position - 0x1762E
{
	var uVar0;
...
bool func_278(int iParam0)//Position - 0x17674
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
void func_279(int* iParam0, var uParam1)//Position - 0x17692
{
	var uVar0[6];
	int iVar1;
	struct<3> Var2;
	...
	while (iVar5 < 6)
	{
		if ((ENTITY::DOES_ENTITY_EXIST((*uParam1)[iVar5]) && !ENTITY::IS_ENTITY_DEAD((*uParam1)[iVar5], false)) && !PED::IS_PED_INJURED((*uParam1)[iVar5]))
		{
			if (func_281((*uParam1)[iVar5], &uVar0) == -1)
			{
				func_280(uParam1[iVar5]);
			}
			else
			{
				Var2 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - ENTITY::GET_ENTITY_COORDS((*uParam1)[iVar5], true) };
	...
	if (iVar4 > 0)
	{
		...
		while (iVar5 < iVar4)
		{
			if ((((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar5]) && !ENTITY::IS_ENTITY_DEAD(uVar0[iVar5], false)) && !PED::IS_PED_INJURED(uVar0[iVar5])) && PED::IS_PED_HUMAN(uVar0[iVar5])) && !PED::IS_PED_IN_ANY_VEHICLE(uVar0[iVar5], true))
			{
				if (func_281(uVar0[iVar5], uParam1) == -1)
				{
					Var2 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - ENTITY::GET_ENTITY_COORDS(uVar0[iVar5], true) };
					fVar3 = ((Var2.f_0 * Var2.f_0) + (Var2.f_1 * Var2.f_1));
					if (Var2.f_2 * Var2.f_2) > (3f * fVar3)
					{
						bVar7 = false;
...
void func_280(var uParam0)//Position - 0x178D5
{
...
int func_281(int iParam0, var uParam1)//Position - 0x17906
{
	int iVar0;
...
void func_283()//Position - 0x17C27
{
	Global_32308 = 1;
}

void func_284()//Position - 0x17C33
{
	int iVar0;
...
void func_285(int* iParam0)//Position - 0x17CA3
{
	iParam0->f_607 = 0;
}

void func_286(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x17CB1
{
	struct<60> Var0;
...
void func_287(int iParam0, int iParam1, int iParam2)//Position - 0x17DDA
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_113648.f_32751.f_4801 = func_520();
			}
...
void func_288(int iParam0, int iParam1)//Position - 0x17EF1
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_318(iParam0, &(Global_113648.f_32751.f_5510));
}

int func_289(int iParam0)//Position - 0x180F7
{
...
int func_290(int iParam0)//Position - 0x181D4
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_291(int iParam0, bool bParam1, int iParam2)//Position - 0x18386
{
	int iVar0;
	struct<2> Var1;
...
int func_292(int iParam0)//Position - 0x18508
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_294(int iParam0, int iParam1)//Position - 0x185EB
{
	int iVar0;
	int iVar1;
...
int func_295()//Position - 0x1BC1B
{
	return 0;
}

int func_296()//Position - 0x1BC24
{
	return 1;
}

int func_297()//Position - 0x1BC2D
{
	return 1;
}

int func_298()//Position - 0x1BC36
{
...
int func_300(int iParam0)//Position - 0x1BD07
{
	int iVar0;
	char* sVar1;
...
int func_301(int iParam0)//Position - 0x1BD4E
{
	int iVar0;
...
int func_302(int iParam0)//Position - 0x1BD89
{
	int iVar0;
...
int func_303(int iParam0)//Position - 0x1BE05
{
	int iVar0;
...
int func_304(int iParam0, int iParam1, bool bParam2)//Position - 0x1BEED
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_305(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x1BF5B
{
...
int func_306(int iParam0)//Position - 0x1C034
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_307(var uParam0, int iParam1)//Position - 0x1C050
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_317(Global_113648.f_32751.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_317(Global_113648.f_2365.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_317(Global_113648.f_2365.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_308(int iParam0, int iParam1)//Position - 0x1D73E
{
	struct<82> Var0;
...
void func_309(int iParam0, var uParam1, int iParam2)//Position - 0x1D780
{
	int iVar0;
...
void func_310(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x1D9DC
{
	if (func_307(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_315(iParam0);
			func_314(uParam1, &(Global_113648.f_32751.f_69[Global_77348.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_311(int iParam0, bool bParam1)//Position - 0x1DAD5
{
	if (iParam0 == -1)
	{
		return;
...
void func_312(int iParam0, int iParam1, bool bParam2)//Position - 0x1DB32
{
	if (iParam0 == -1)
	{
		return;
...
int func_313(int iParam0, int iParam1)//Position - 0x1DB6D
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_314(var uParam0, var uParam1)//Position - 0x1DB8D
{
...
void func_315(int iParam0)//Position - 0x1DC59
{
	if (iParam0 == -1)
	{
		return;
...
int func_316(int iParam0)//Position - 0x1DCD0
{
	int iVar0;
...
bool func_317(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x1DD33
{
	if (bParam2)
	{
...
void func_318(int iParam0, var uParam1)//Position - 0x1DD7A
{
	int iVar0;
...
int func_319(int iParam0)//Position - 0x1E025
{
	switch (iParam0)
	{
		case 1:
...
int func_320(int iParam0, var uParam1, var uParam2)//Position - 0x1E0D5
{
	int iVar0;
	int iVar1;
...
int func_321(int iParam0)//Position - 0x1E2C8
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_322(var uParam0)//Position - 0x1E2E8
{
	int iVar0;
...
void func_323(int iParam0)//Position - 0x1E398
{
...
float func_324(int iParam0)//Position - 0x1E3BF
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_325(int iParam0)//Position - 0x1E489
{
	switch (iParam0)
	{
		case 0:
...
int func_326(int iParam0)//Position - 0x1E5D9
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_327(int* iParam0)//Position - 0x1E61C
{
	if (*iParam0 != 0)
	{
		GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(iParam0);
...
int func_328(var uParam0, bool bParam1, int iParam2)//Position - 0x1E6EF
{
...
int func_329(var uParam0, int* iParam1, struct<3> Param2, struct<3> Param3, struct<3> Param4, var uParam5, var uParam6)//Position - 0x1E747
{
	struct<3> Var0;
	...
	switch (uParam0->f_3)
	{
		case 0:
			if (func_461(iParam1) >= 0f)
			{
				...
				Var0 = { func_463(Param3, Param4.f_2) };
				CAM::SET_CAM_PARAMS(func_433(uParam0, 0), Param2 + Var0, *uParam5, *uParam6, 300, 1, 1, 2);
...
void func_330(int iParam0, var uParam1, int* iParam2)//Position - 0x1E85B
{
	struct<3> Var0;
	int iVar1;
	int iVar2;
	...
	iVar1 = func_433(uParam1, 0);
	iVar2 = func_433(uParam1, 1);
	CAM::SET_CAM_NEAR_CLIP(iVar2, func_331());
	Var3 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, 2f, -0.3f, -7.7824f) };
	CAM::SET_CAM_COORD(iVar2, Var3);
	Var0 = { CAM::GET_CAM_ROT(iVar1, 2) };
	Var0.f_0 = 0f;
	CAM::SET_CAM_ROT(iVar2, Var0, 2);
...
float func_331()//Position - 0x1E8DA
{
	if (MISC::IS_PC_VERSION())
	{
		return 0.5f;
...
int func_332(var uParam0, var uParam1, var uParam2, int* iParam3, var uParam4, var uParam5, struct<3> Param6, struct<3> Param7)//Position - 0x1E8F6
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var2;
	...
	*uParam4 = (*uParam4 + (*uParam5 * MISC::GET_FRAME_TIME()));
	...
	Var2 = { func_463(Param7, uParam4->f_2) };
	CAM::SET_CAM_COORD(iVar0, Param6 + Var2);
...
bool func_333(var uParam0, bool bParam1)//Position - 0x1EB34
{
	return (BitTest(uParam0->f_2, bParam1) && !BitTest(uParam0->f_3, bParam1));
}

void func_334(char* sParam0)//Position - 0x1EB50
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, true, true, -1);
}

Vector3 func_335(var uParam0)//Position - 0x1EB66
{
	return *uParam0, uParam0->f_1, 0f;
}

void func_336(int iParam0, struct<3> Param1)//Position - 0x1EB76
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_337(char* sParam0)//Position - 0x1EC02
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_338(char* sParam0, int iParam1)//Position - 0x1EC15
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

void func_339(var uParam0, bool bParam1)//Position - 0x1EC2C
{
	if (bParam1)
	{
...
void func_340(char* sParam0, int iParam1, int iParam2)//Position - 0x1EC74
{
	iParam2 = iParam2;
...
struct<4> func_341(bool bParam0)//Position - 0x1EC8D
{
	struct<4> Var0;
...
void func_342(int* iParam0, float fParam1)//Position - 0x1ECF3
{
	if (!func_462(iParam0))
	{
...
void func_343(int* iParam0, int iParam1)//Position - 0x1ED0D
{
	if (func_462(iParam0))
	{
...
int func_345(int* iParam0, float fParam1)//Position - 0x1ED7B
{
...
int func_346(int* iParam0, float fParam1)//Position - 0x1ED99
{
	if (func_462(iParam0))
	{
...
void func_347(int* iParam0)//Position - 0x1EDBB
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
int func_348(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, var uParam8, int iParam9, var uParam10, int* iParam11, int* iParam12, int iParam13, int iParam14, var uParam15, var uParam16, var uParam17, var uParam18, bool bParam19, bool bParam20, float fParam21)//Position - 0x1EE61
{
	struct<3> Var0;
	var uVar1;
	var uVar2;
	...
	if (bVar15)
	{
		...
		{
			GRAPHICS::DRAW_MARKER(6, Var9, 0f, 0f, 1f, 0f, 0f, 0f, 4f, 4f, 4f, 240, 200, 80, func_357(Var9, 170, 200), false, false, 2, false, 0, 0, false);
			GRAPHICS::DRAW_MARKER(6, Var9, 0f, 0f, 1f, 0f, 0f, 0f, 9f, 9f, 9f, 240, 200, 80, func_357(Var9, 170, 200), false, false, 2, false, 0, 0, false);
			GRAPHICS::DRAW_MARKER(6, Var9, 0f, 0f, 1f, 0f, 0f, 0f, 14f, 14f, 14f, 240, 200, 80, func_357(Var9, 170, 200), false, false, 2, false, 0, 0, false);
		}
		if (*iParam7 != -1)
		{
	...
	else
	{
		...
		Var6 = { Var3 - Var4 };
		Var5 = { func_369(uParam0, *iParam6 + 1) };
		GRAPHICS::DRAW_MARKER(6, Var4, func_475(Var6), 0f, 0f, 0f, 14f, 14f, 14f, 240, 200, 80, func_357(Var4, 25, 200), false, false, 2, false, 0, 0, false);
		if (*iParam7 != *iParam6)
		{
			if (*iParam7 >= 0)
			{
			...
			*iParam4 = GRAPHICS::CREATE_CHECKPOINT(17, Var4, Var5, 9f, iVar17, iVar18, iVar19, func_357(Var9, 25, SYSTEM::CEIL((200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170))))), 0);
			if (*iParam6 < (iParam9 - 2))
			{
				*iParam5 = GRAPHICS::CREATE_CHECKPOINT(17, Var5, func_369(uParam0, *iParam6 + 2), (9f * 0.5f), iVar17, iVar18, iVar19, func_357(Var9, 25, SYSTEM::CEIL((200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170))))), 0);
			}
			*iParam7 = *iParam6;
		}
		if (*iParam6 + 1 == (iParam9 - 1))
		{
			GRAPHICS::DRAW_MARKER(6, Var5, 0f, 0f, 1f, 0f, 0f, 0f, (0.5f * 4f), (0.5f * 4f), (0.5f * 4f), 240, 200, 80, func_357(Var5, 170, 200), false, false, 2, false, 0, 0, false);
			GRAPHICS::DRAW_MARKER(6, Var5, 0f, 0f, 1f, 0f, 0f, 0f, (0.5f * 9f), (0.5f * 9f), (0.5f * 9f), 240, 200, 80, func_357(Var5, 170, 200), false, false, 2, false, 0, 0, false);
			GRAPHICS::DRAW_MARKER(6, Var5, 0f, 0f, 1f, 0f, 0f, 0f, (0.5f * 14f), (0.5f * 14f), (0.5f * 14f), 240, 200, 80, func_357(Var5, 170, 200), false, false, 2, false, 0, 0, false);
		}
		else
		{
			GRAPHICS::DRAW_MARKER(6, Var5, func_475(Var3 - Var5), 0f, 0f, 0f, (0.5f * 14f), (0.5f * 14f), (0.5f * 14f), 240, 200, 80, func_357(Var5, 25, 200), false, false, 2, false, 0, 0, false);
		}
		if (*iParam4 != 0)
		{
			GRAPHICS::SET_CHECKPOINT_RGBA(*iParam4, iVar17, iVar18, iVar19, func_357(Var4, 25, SYSTEM::CEIL((200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170))))));
		}
		if (*iParam5 != 0)
		{
			GRAPHICS::SET_CHECKPOINT_RGBA(*iParam5, iVar17, iVar18, iVar19, func_357(Var5, 25, SYSTEM::CEIL((200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170))))));
		}
	}
	if (!bParam19)
	{
	...
	{
		if (!GRAPHICS::GET_SCREEN_COORD_FROM_WORLD_COORD(Var4, &uVar21, &uVar22))
		{
			if (iLocal_511)
			{
				func_355(Var4, uParam15, uParam16, uParam17);
				if (func_462(&iLocal_513))
				{
					func_458(&iLocal_513);
				}
			}
			else if (func_462(&iLocal_513))
			{
				if (func_353(&iLocal_513) > 0.5f)
				{
					func_458(&iLocal_513);
					iLocal_511 = 1;
				}
	...
	if (func_352(iParam14, uParam18, &iParam1))
	{
		...
		if (((Var6.f_2 < 5f && Var6.f_2 > -2f) && fVar12 < 15f) || func_266(iParam1, iParam2))
		{
			*uParam10 = func_268(SYSTEM::CEIL(((100f * (15f - fVar12)) / 15f)) + 4, 0, 100);
			return 1;
		}
		else
		{
	...
	else if (!bVar15)
	{
		...
		if (fVar11 < (22f * 22f))
		{
			...
			else if (func_275(Var0, -Var6 / FtoV(SYSTEM::SQRT(fVar11))) < 0.08f)
			{
				bVar16 = true;
			}
			if (bVar16)
		...
		{
			Var8 = { ENTITY::GET_ENTITY_FORWARD_VECTOR(PLAYER::PLAYER_PED_ID()) };
			Var8.f_2 = 0f;
			Var8 = { func_475(Var8) };
			Var7 = { -Var6.f_0, -Var6.f_1, 0f };
			Var7 = { func_475(Var7) };
			fVar13 = ((Var3.f_2 - 32f) + (32f * func_349(Var8, Var7)));
			fVar12 = SYSTEM::SQRT(((Var6.f_0 * Var6.f_0) + (Var6.f_1 * Var6.f_1)));
...
float func_349(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3)//Position - 0x1F75D
{
	return ((Param0.f_0 * Param2.f_0) + (Param0.f_1 * Param2.f_1));
}

void func_350(var uParam0, bool bParam1)//Position - 0x1F774
{
...
bool func_352(var uParam0, var uParam1, int iParam2)//Position - 0x1F80F
{
	int iVar0;
	int iVar1;
...
float func_353(int* iParam0)//Position - 0x1F8C8
{
	if (func_462(iParam0))
	{
		if (func_354(iParam0))
...
bool func_354(int* iParam0)//Position - 0x1F901
{
	return BitTest(*iParam0, 2);
}

void func_355(struct<3> Param0, var uParam1, var uParam2, var uParam3)//Position - 0x1F90E
{
	var uVar0;
	var uVar1;
	float fVar2;
...
void func_356(struct<3> Param0, var uParam1, var uParam2)//Position - 0x1FA7E
{
	float fVar0;
	float fVar1;
	struct<3> Var2;
...
int func_357(struct<3> Param0, int iParam1, int iParam2)//Position - 0x1FB65
{
	float fVar0;
	int iVar1;
	float fVar2;
...
void func_358(int* iParam0)//Position - 0x1FBD1
{
...
int func_359(var uParam0, bool bParam1, var uParam2)//Position - 0x1FBF9
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
	{
		...
		else if (!MISC::GET_GROUND_Z_FOR_3D_COORD(ENTITY::GET_ENTITY_COORDS(iVar0, true), &fVar3, false, false))
		{
			return 0;
		}
	...
	else if (!MISC::GET_GROUND_Z_FOR_3D_COORD(Var1, &fVar3, false, false))
	{
		return 0;
	}
	else if (Var1.f_2 >= (fVar3 + 1.5f))
...
var func_361(var uParam0)//Position - 0x1FD8F
{
	return uParam0->f_84;
}

void func_362(int* iParam0, bool bParam1)//Position - 0x1FD9B
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
	...
	TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, *iParam0, Var2 + Vector(5f, 5f, 5f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(*iParam0) + Vector(20f, 0f, 0f), 4, (0.3f * fVar4), 786469, 5f, 10f, true);
	Var3 = { Vector(1000f, 1000f, 1000f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(*iParam0) };
	Var3.f_2 = 200f;
	TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, *iParam0, Var2 + Var3, 4, fVar4, 262144, 15f, 10f, true);
...
void func_363(int iParam0, int iParam1)//Position - 0x1FE8A
{
	int iVar0;
...
void func_364(bool bParam0, bool bParam1, int iParam2)//Position - 0x1FEE7
{
	if (bParam0)
	{
...
int func_365(int iParam0)//Position - 0x1FF25
{
	switch (iParam0)
	{
		case joaat("bmx"):
...
int func_366(var uParam0)//Position - 0x1FFA5
{
	return *uParam0;
}

int func_367(int iParam0)//Position - 0x1FFB0
{
	switch (iParam0)
	{
		case joaat("freight"):
...
int func_368(var uParam0)//Position - 0x1FFD0
{
	return uParam0->f_1;
}

Vector3 func_369(var uParam0, int iParam1)//Position - 0x1FFDC
{
...
Vector3 func_370(var uParam0)//Position - 0x20008
{
	return uParam0->f_6;
}

void func_371(int* iParam0)//Position - 0x20016
{
	func_42(iParam0, 0f);
}

int func_372(int iParam0)//Position - 0x20025
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_373(int iParam0)//Position - 0x20038
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_374(int iParam0)//Position - 0x2004B
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

void func_375()//Position - 0x2005E
{
	int iVar0;
...
void func_376()//Position - 0x20087
{
	struct<68> Var0;
...
void func_377(var uParam0)//Position - 0x20129
{
	int iVar0;
...
bool func_378(var uParam0)//Position - 0x20164
{
	return uParam0->f_83;
}

int func_379(var uParam0, bool bParam1, int* iParam2, var uParam3, var uParam4, int* iParam5, int* iParam6, int* iParam7, int* iParam8, int iParam9, var uParam10, var uParam11, var uParam12)//Position - 0x20170
{
...
void func_380()//Position - 0x20331
{
	struct<6> Var0;
	int iVar1;
	
	iVar1 = Global_113648.f_18969;
	func_381(Var0, 0, 0, 0, 0, iVar1);
}

void func_381(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x20350
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_384(Global_78814, Global_78816, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
void func_382()//Position - 0x20635
{
	if (Global_78813 != 6)
	{
	}
...
float func_383(char* sParam0)//Position - 0x2066D
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_384(int iParam0, int iParam1, int iParam2)//Position - 0x20680
{
	struct<2> Var0;
	int iVar1;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_385(iVar1), 8);
					break;
			}
			break;
...
char* func_385(int iParam0)//Position - 0x20756
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_386(int iParam0)//Position - 0x208A9
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_387(int iParam0)//Position - 0x208DC
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_388(int iParam0)//Position - 0x2090F
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_389(int iParam0)//Position - 0x20942
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_390(int iParam0)//Position - 0x20975
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_391(int iParam0)//Position - 0x209B2
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_392(int iParam0)//Position - 0x209E5
{
	struct<2> Var0;
	char[] cVar1[8];
	
	StringCopy(&Var0, "", 8);
	cVar1 = { func_393(iParam0) };
	if (MISC::IS_STRING_NULL_OR_EMPTY(&cVar1))
	{
	}
	else
...
struct<2> func_393(int iParam0)//Position - 0x20A1C
{
	struct<2> Var0;
...
struct<2> func_394(int iParam0)//Position - 0x20E68
{
	struct<2> Var0;
...
int func_395(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x20ED1
{
	if (((!func_397(0) || Global_78828) || Global_78817 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78813)
...
bool func_396(bool bParam0)//Position - 0x20FE9
{
	if (bParam0)
	{
...
int func_397(int iParam0)//Position - 0x21012
{
	if (Global_43257 == 15)
	{
		return 0;
...
bool func_398(int iParam0)//Position - 0x21034
{
	return func_399(iParam0, Global_43257);
}

int func_399(int iParam0, int iParam1)//Position - 0x21045
{
	if (iParam1 == 15)
	{
		return 1;
...
float func_400(var uParam0)//Position - 0x21226
{
	return uParam0->f_80;
}

int func_401(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x21232
{
...
int func_402(char* sParam0, int iParam1, bool bParam2)//Position - 0x21280
{
	Global_21726 = 0;
...
void func_403()//Position - 0x2154E
{
	if (!func_404())
	{
		return;
...
bool func_405(int iParam0)//Position - 0x215E8
{
	return func_406(iParam0, 20);
}

var func_406(int iParam0, int iParam1)//Position - 0x215F8
{
	return BitTest(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

int func_407()//Position - 0x21610
{
	return -1;
}

void func_408()//Position - 0x21619
{
	int iVar0;
...
void func_409()//Position - 0x2164A
{
...
void func_411()//Position - 0x21778
{
	if (func_252(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_412()//Position - 0x2181A
{
	int iVar0;
...
bool func_413(int iParam0, int iParam1)//Position - 0x21871
{
	switch (iParam0)
	{
		case 5:
...
void func_414()//Position - 0x218A9
{
...
void func_415(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21900
{
...
var func_416(var uParam0)//Position - 0x21956
{
	return uParam0->f_4;
}

void func_417(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, var uParam6, var uParam7)//Position - 0x21962
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam5) && !ENTITY::IS_ENTITY_DEAD(iParam5, false))
	{
		...
		*uParam7 = 26f;
		...
		CAM::SET_CAM_COORD(iVar0, Var3);
		CAM::SET_CAM_ROT(iVar0, Var2, 2);
...
void func_418(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x21A6D
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_422(PLAYER::PLAYER_ID())) && !func_420(PLAYER::PLAYER_ID(), 0)) && !func_419()) && !bParam4) && !bParam5) && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
			{
...
bool func_419()//Position - 0x21BBA
{
	return BitTest(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

bool func_420(int iParam0, int iParam1)//Position - 0x21BD4
{
	bool bVar0;
...
int func_421(int iParam0, bool bParam1)//Position - 0x21C1F
{
	int iVar0;
	int iVar1;
...
int func_422(int iParam0)//Position - 0x21C60
{
...
bool func_423()//Position - 0x21C9F
{
	return BitTest(Global_2621446, 3);
}

int func_424(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x21CAD
{
	int iVar0;
...
void func_425(int iParam0)//Position - 0x21CE0
{
	if (iParam0 == 1)
	{
...
float func_426(bool bParam0, int iParam1)//Position - 0x21D03
{
	switch (bParam0)
	{
		case 3:
...
int func_427(bool bParam0)//Position - 0x21D9D
{
	switch (bParam0)
	{
		case 5:
...
int func_428()//Position - 0x21DD1
{
	func_429();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_429()//Position - 0x21DEA
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_37(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_36(PLAYER::PLAYER_PED_ID());
			if (func_39(iVar0) && (!func_252(14) || Global_112599))
			{
...
float func_430(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3)//Position - 0x21EE7
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param2.f_0 - Param0.f_0), (Param2.f_1 - Param0.f_1));
}

int func_431(struct<3> Param0)//Position - 0x21F01
{
...
Vector3 func_432(bool bParam0)//Position - 0x21F2B
{
	switch (bParam0)
	{
		case 5:
...
int func_433(var uParam0, int iParam1)//Position - 0x21F85
{
	if (iParam1 >= 2)
	{
		return 0;
...
void func_434(int iParam0, bool bParam1, int iParam2)//Position - 0x21F9D
{
...
void func_435(var uParam0, var uParam1, var uParam2, int* iParam3, int* iParam4, int* iParam5, int* iParam6, int* iParam7, int* iParam8, int* iParam9, int iParam10, int iParam11, int* iParam12, bool bParam13, int iParam14)//Position - 0x21FF6
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
	...
	while (iVar3 < 12)
	{
		if (!func_431(func_369(uParam0, iVar3)))
		{
			*uParam2 = iVar3 + 1;
		}
		else
	...
	else
	{
		...
		if (func_378(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(*iParam3))
			{
				...
				{
					if (!VEHICLE::IS_VEHICLE_SEAT_FREE(*iParam3, iVar4, false))
					{
						iVar5 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(*iParam3, iVar4, false);
...
void func_436(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x22AA9
{
...
void func_437(int iParam0, bool bParam1)//Position - 0x22B44
{
	if (ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
		return;
...
int func_438(int iParam0)//Position - 0x22C18
{
	switch (iParam0)
	{
		case joaat("seashark"):
...
int func_439(int iParam0)//Position - 0x22C62
{
	switch (iParam0)
	{
		case joaat("hauler"):
...
var func_440(var uParam0)//Position - 0x22CA0
{
	return uParam0->f_77;
}

void func_441(var uParam0, int* iParam1)//Position - 0x22CAC
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam1))
	{
...
var func_442(var uParam0)//Position - 0x22D15
{
	return uParam0->f_79;
}

Vector3 func_443(var uParam0)//Position - 0x22D21
{
	return uParam0->f_9;
}

int func_444(var uParam0)//Position - 0x22D2F
{
	return uParam0->f_3;
}

void func_445(var uParam0, var uParam1, bool bParam2)//Position - 0x22D3B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_446(var uParam0)//Position - 0x22EA8
{
	return uParam0->f_78;
}

Vector3 func_447(var uParam0)//Position - 0x22EB4
{
	return uParam0->f_70;
}

int func_448(bool bParam0)//Position - 0x22EC2
{
	switch (bParam0)
	{
		case 0:
...
int func_449(int iParam0, int iParam1)//Position - 0x22F42
{
...
void func_450(var uParam0, int iParam1, char* sParam2)//Position - 0x22FB4
{
	int iVar0;
...
char* func_452()//Position - 0x23011
{
	int iVar0;
...
void func_453(var uParam0, int iParam1, char* sParam2)//Position - 0x23054
{
	int iVar0;
...
char* func_454(bool bParam0)//Position - 0x23087
{
	return "EXT1HELIPILOT";
}

void func_455(int iParam0, bool bParam1)//Position - 0x23093
{
	if (ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
		return;
...
Vector3 func_456(var uParam0)//Position - 0x2313D
{
	return uParam0->f_67;
}

Vector3 func_457(var uParam0)//Position - 0x2314B
{
	return uParam0->f_64;
}

void func_458(int* iParam0)//Position - 0x23159
{
	iParam0->f_1 = 0f;
	iParam0->f_2 = 0f;
	*iParam0 = 0;
...
int func_459(var uParam0, int* iParam1, var uParam2, bool bParam3, int iParam4, bool bParam5)//Position - 0x2316F
{
	char cVar0[64];
...
int func_460(var uParam0)//Position - 0x232A6
{
	int iVar0;
...
float func_461(int* iParam0)//Position - 0x232ED
{
	if (func_462(iParam0))
	{
		if (func_354(iParam0))
...
bool func_462(int* iParam0)//Position - 0x23329
{
	return BitTest(*iParam0, 1);
}

Vector3 func_463(struct<3> Param0, float fParam1)//Position - 0x23336
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
float func_464(var uParam0)//Position - 0x2337A
{
	return uParam0->f_76;
}

int func_465(int iParam0)//Position - 0x23386
{
	switch (iParam0)
	{
...
int func_466(bool bParam0)//Position - 0x233D0
{
	switch (bParam0)
	{
		case 0:
...
void func_467(var uParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x23426
{
	int iVar0;
	int iVar1;
...
void func_468(var uParam0)//Position - 0x236C1
{
	int iVar0;
...
int func_469(bool bParam0)//Position - 0x236F1
{
	switch (bParam0)
	{
		case 0:
...
int func_470(var uParam0, int iParam1)//Position - 0x2372B
{
	int iVar0;
	int iVar1;
...
int func_471(var uParam0)//Position - 0x23788
{
	int iVar0;
...
void func_472(int iParam0, int iParam1)//Position - 0x237B4
{
...
Vector3 func_473(bool bParam0)//Position - 0x237DB
{
	switch (bParam0)
	{
		case 0:
...
int func_474(bool bParam0)//Position - 0x23925
{
	if (CAM::IS_SCREEN_FADED_OUT())
	{
...
Vector3 func_475(struct<3> Param0)//Position - 0x23995
{
	float fVar0;
	float fVar1;
...
Vector3 func_476(bool bParam0)//Position - 0x239D4
{
	switch (bParam0)
	{
		case 0:
...
void func_477(var uParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x23AFE
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	else
	{
		...
		CAM::SET_CAM_ROT(func_433(uParam0, 0), Var1, 2);
	}
	CAM::SET_CAM_FOV(func_433(uParam0, 0), fVar2);
	CAM::SET_CAM_ACTIVE(func_433(uParam0, 0), true);
	if (bParam3)
	{
		Var3 = { Var0 };
		Var3.f_2 = (Var3.f_2 + 8f);
		CAM::SET_CAM_PARAMS(func_433(uParam0, 0), Var3, Var1, fVar2, func_481(bParam2), 1, 1, 2);
	}
	Var0 = { func_480(uParam1) };
	Var1 = { func_479(uParam1) };
	...
	else
	{
		...
		CAM::SET_CAM_ROT(func_433(uParam0, 1), Var1, 2);
	}
	CAM::SET_CAM_FOV(func_433(uParam0, 1), fVar2);
	if (!CAM::IS_SCREEN_FADED_OUT())
	{
...
float func_478(var uParam0)//Position - 0x23C84
{
	return uParam0->f_82;
}

Vector3 func_479(var uParam0)//Position - 0x23C90
{
	return uParam0->f_58;
}

Vector3 func_480(var uParam0)//Position - 0x23C9E
{
	return uParam0->f_55;
}

int func_481(int iParam0)//Position - 0x23CAC
{
	switch (iParam0)
	{
		case 5:
...
void func_482(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x23CD9
{
	if (iParam1 >= 2)
	{
		return;
...
var func_483(var uParam0)//Position - 0x23D06
{
	return uParam0->f_81;
}

Vector3 func_484(var uParam0)//Position - 0x23D12
{
	return uParam0->f_52;
}

Vector3 func_485(var uParam0)//Position - 0x23D20
{
	return uParam0->f_49;
}

void func_486(int* iParam0)//Position - 0x23D2E
{
	if (!func_462(iParam0))
	{
		func_371(iParam0);
...
void func_487(struct<3> Param0, float fParam1, bool bParam2)//Position - 0x23D46
{
	int iVar0;
...
void func_488(int iParam0)//Position - 0x23D96
{
	bool bVar0;
	...
	if (func_307(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
		...
		if (BitTest(Global_77348.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_313(iParam0, 0)) && Global_78257.f_66 == 0) && Global_113648.f_32751.f_1958[Global_77348.f_555[0 /*21*/].f_14] != 0) && Global_113648.f_32751.f_1958[Global_77348.f_555[0 /*21*/].f_14] > 3) && (!func_489(0, Global_77348.f_555[0 /*21*/].f_12) || !func_489(1, Global_77348.f_555[0 /*21*/].f_12)))
			{
				func_314(&(Global_113648.f_32751.f_69[Global_77348.f_555[0 /*21*/].f_14 /*78*/]), &Global_78257);
...
int func_489(int iParam0, int iParam1)//Position - 0x23F05
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_490(&(Global_113648.f_32751.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_291(Global_113648.f_32751.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}

int func_490(var uParam0)//Position - 0x23F78
{
	return *uParam0;
}

void func_491(char* sParam0, int iParam1)//Position - 0x23F83
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < Global_113648.f_20412.f_145)
	{
		if (MISC::ARE_STRINGS_EQUAL(sParam0, &(Global_113648.f_20412[iVar0 /*16*/])))
		{
			...
			func_493((Global_113648.f_20412.f_145 - 1));
...
void func_492()//Position - 0x24032
{
	int iVar0;
...
void func_493(int iParam0)//Position - 0x24149
{
...
void func_494(int iParam0, int iParam1)//Position - 0x241E3
{
...
void func_495(bool bParam0)//Position - 0x242F3
{
	if (bParam0)
	{
...
void func_496()//Position - 0x24335
{
	func_497(&uLocal_73, 0);
}

void func_497(var uParam0, int iParam1)//Position - 0x24344
{
	if (uParam0->f_4 != 0)
	{
		func_153(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44));
...
void func_498()//Position - 0x243EF
{
	int iVar0;
	int iVar1;
	struct<75> Var2;
...
void func_499(var uParam0)//Position - 0x2455A
{
	int iVar0;
...
void func_500(var uParam0)//Position - 0x245B0
{
	int iVar0;
	struct<13> Var1;
...
void func_501(var uParam0)//Position - 0x24638
{
	int iVar0;
	struct<35> Var1;
...
void func_502()//Position - 0x24702
{
	Global_23131.f_5 = 1;
}

void func_503(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x24710
{
	int iVar0;
...
void func_504(char* sParam0, int* iParam1, bool bParam2)//Position - 0x2488E
{
...
int func_505(char* sParam0, char* sParam1, int* iParam2, bool bParam3)//Position - 0x248AE
{
...
char* func_506(int iParam0, int iParam1)//Position - 0x248FC
{
	char* sVar0;
...
void func_507(var uParam0, int iParam1)//Position - 0x2498C
{
	if (iParam1 < 11)
	{
...
int func_508(char* sParam0, int* iParam1, bool bParam2)//Position - 0x24A92
{
	if (!BitTest(*iParam1, bParam2))
	{
...
int func_509(char* sParam0, int* iParam1, bool bParam2)//Position - 0x24AD0
{
	if (!BitTest(*iParam1, bParam2))
	{
		if (AUDIO::PREPARE_MUSIC_EVENT(sParam0))
...
char* func_510(int iParam0)//Position - 0x24AFF
{
	switch (iParam0)
	{
		case 15:
...
void func_511(var uParam0)//Position - 0x24B5D
{
	struct<2> Var0;
	var uVar1;
	var uVar2;
	...
	func_518(&uVar1, &uVar2, &iVar3, &iVar4, PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()), PAD::IS_USING_KEYBOARD_AND_MOUSE(2 /*FRONTEND_CONTROL*/));
...
void func_513(var uParam0, int iParam1, bool bParam2)//Position - 0x24CA4
{
	if (bParam2)
	{
...
void func_514(var uParam0)//Position - 0x24CC8
{
	uParam0->f_3 = uParam0->f_2;
	uParam0->f_2 = 0;
}

void func_515(var uParam0, var uParam1, var uParam2)//Position - 0x24CDD
{
	func_517(uParam0, uParam1);
	func_516(uParam0, uParam2);
}

void func_516(var uParam0, var uParam1)//Position - 0x24CF5
{
	uParam0->f_1 = uParam1;
}

void func_517(var uParam0, var uParam1)//Position - 0x24D03
{
	*uParam0 = uParam1;
}

void func_518(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x24D10
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_519()//Position - 0x24DFD
{
...
void func_521(var uParam0, int iParam1)//Position - 0x24EF0
{
	if (iParam1 <= 0)
	{
		return;
...
void func_522(var uParam0, int iParam1)//Position - 0x24F76
{
...
void func_523(var uParam0, int iParam1)//Position - 0x24FA9
{
	int iVar0;
	int iVar1;
...
int func_524(int iParam0, int iParam1)//Position - 0x24FFA
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_525(int iParam0)//Position - 0x2509C
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_526(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_526(bool bParam0, int iParam1, int iParam2)//Position - 0x250BE
{
	if (bParam0)
	{
		return iParam1;
...
int func_527(var uParam0)//Position - 0x250D5
{
	return uParam0 & 15;
}

void func_528(var uParam0, int iParam1)//Position - 0x250E2
{
...
void func_529(var uParam0, int iParam1)//Position - 0x2511C
{
...
void func_530(var uParam0, int iParam1)//Position - 0x25157
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_531(var uParam0)//Position - 0x25193
{
	return uParam0->f_2;
}

void func_532(var uParam0, bool bParam1)//Position - 0x2519F
{
	int iVar0;
	...
	switch (bParam1)
	{
		case 0:
			...
			func_548(uParam0, 0f);
			func_547(uParam0, 0, -1039.7124f, -1731.1447f, 1f);
			...
			func_539(uParam0, -1151.4016f, -1864.3694f, 214.9385f);
		...
		case 2:
			...
			func_547(uParam0, 3, 2273.7869f, 1885.168f, 152.702f);
			func_547(uParam0, 4, 2111.9119f, 1887.4564f, 92.5308f);
			func_546(uParam0, 0f);
			func_545(uParam0, 0f, 0f, 0f);
			...
			func_539(uParam0, 2038.8071f, 1971.5627f, 591.7618f);
		...
		case 3:
			...
			func_553(uParam0, 402.6013f, 5736.4507f, 696.3928f);
			...
			func_539(uParam0, 409.9299f, 5701.4766f, 696.7185f);
		...
		case 6:
			...
			func_549(uParam0, -1310.9476f, 4330.1265f, 7.2444f);
			...
			func_539(uParam0, -1242.7314f, 4536.298f, 186.6862f);
		...
		case 7:
			...
			func_549(uParam0, 0f, 0f, 0f);
			func_548(uParam0, 0f);
			func_547(uParam0, 0, -487.5452f, 4252.1924f, 87.712f);
			...
			func_539(uParam0, -337.5233f, 4110.1597f, 315.6679f);
		...
		case 8:
			...
			func_549(uParam0, 0f, 0f, 0f);
			func_548(uParam0, 0f);
			func_547(uParam0, 0, -1154.4427f, 204.1726f, 64.4915f);
			func_546(uParam0, 0f);
			func_545(uParam0, 0f, 0f, 0f);
			if (iVar0 == 0)
			{
		...
		case 9:
			...
			func_551(uParam0, 0f);
			func_550(uParam0, joaat("blazer"));
			func_549(uParam0, -818.3042f, 4405.6753f, 20.1095f);
			...
			func_547(uParam0, 5, -1063.995f, 4246.1367f, 163.291f);
			func_547(uParam0, 6, -938.541f, 4360.14f, 82.372f);
			func_547(uParam0, 7, -828.1418f, 4413.5615f, 20.062f);
			func_546(uParam0, 0f);
			func_545(uParam0, 0f, 0f, 0f);
			...
			func_539(uParam0, -1286.9763f, 3660.1375f, 1082.208f);
		...
		case 10:
			...
			func_547(uParam0, 9, 2473.3438f, 4715.347f, 33.524f);
			func_546(uParam0, 0f);
			func_545(uParam0, 0f, 0f, 0f);
			...
			func_539(uParam0, 1012.6727f, 3960.4355f, 1367.7009f);
		...
		case 11:
			...
			func_549(uParam0, 1280.9326f, -50.6157f, 61.8195f);
			...
			func_539(uParam0, 1628.1558f, -431.2605f, 1332.7611f);
		...
		case 12:
			...
			func_551(uParam0, 0f);
			func_550(uParam0, joaat("sanchez"));
			func_549(uParam0, -885.2659f, 4433.5923f, 20.381f);
			func_548(uParam0, 104.35f);
			func_547(uParam0, 0, -771.9196f, 4400.4526f, 60.5786f);
...
void func_533(var uParam0, struct<3> Param1)//Position - 0x26379
{
	uParam0->f_67 = { Param1 };
}

void func_534(var uParam0, struct<3> Param1)//Position - 0x2638B
{
	uParam0->f_64 = { Param1 };
}

void func_535(var uParam0, int iParam1)//Position - 0x2639D
{
	uParam0->f_84 = iParam1;
}

void func_536(var uParam0, int iParam1)//Position - 0x263AB
{
	uParam0->f_83 = iParam1;
}

void func_537(var uParam0, float fParam1)//Position - 0x263B9
{
	uParam0->f_82 = fParam1;
}

void func_538(var uParam0, struct<3> Param1)//Position - 0x263C7
{
	uParam0->f_58 = { Param1 };
}

void func_539(var uParam0, struct<3> Param1)//Position - 0x263D9
{
	uParam0->f_55 = { Param1 };
}

void func_540(var uParam0, float fParam1)//Position - 0x263EB
{
	uParam0->f_81 = fParam1;
}

void func_541(var uParam0, struct<3> Param1)//Position - 0x263F9
{
	uParam0->f_52 = { Param1 };
}

void func_542(var uParam0, struct<3> Param1)//Position - 0x2640B
{
	uParam0->f_49 = { Param1 };
}

Vector3 func_543(int iParam0)//Position - 0x2641D
{
	switch (iParam0)
	{
		case 0:
...
void func_544(var uParam0, char* sParam1)//Position - 0x26567
{
	uParam0->f_4 = sParam1;
}

void func_545(var uParam0, struct<3> Param1)//Position - 0x26575
{
	uParam0->f_6 = { Param1 };
}

void func_546(var uParam0, float fParam1)//Position - 0x26587
{
	uParam0->f_77 = fParam1;
}

void func_547(var uParam0, int iParam1, struct<3> Param2)//Position - 0x26595
{
	if (iParam1 < 0 || iParam1 >= 12)
	{
		return;
...
void func_548(var uParam0, float fParam1)//Position - 0x265C0
{
	uParam0->f_79 = fParam1;
}

void func_549(var uParam0, struct<3> Param1)//Position - 0x265CE
{
	uParam0->f_9 = { Param1 };
}

void func_550(var uParam0, int iParam1)//Position - 0x265E0
{
	uParam0->f_3 = iParam1;
}

void func_551(var uParam0, float fParam1)//Position - 0x265EE
{
	uParam0->f_80 = fParam1;
}

void func_552(var uParam0, float fParam1)//Position - 0x265FC
{
	uParam0->f_78 = fParam1;
}

void func_553(var uParam0, struct<3> Param1)//Position - 0x2660A
{
	uParam0->f_70 = { Param1 };
}

void func_554(var uParam0, int iParam1)//Position - 0x2661C
{
	uParam0->f_2 = iParam1;
}

void func_555(var uParam0, float fParam1)//Position - 0x2662A
{
	uParam0->f_76 = fParam1;
}

void func_556(var uParam0, int iParam1)//Position - 0x26638
{
	uParam0->f_1 = iParam1;
}

void func_557(var uParam0, int iParam1)//Position - 0x26646
{
	*uParam0 = iParam1;
}

void func_558(int iParam0, bool bParam1)//Position - 0x26653
{
	if (bParam1)
	{
...
void func_559(int iParam0)//Position - 0x26675
{
	func_382();
...
void func_560(var uParam0, var uParam1, int* iParam2, int* iParam3, int* iParam4, var uParam5, int iParam6, var uParam7, int* iParam8, var uParam9, var uParam10, var uParam11, int iParam12, int iParam13, int iParam14, int iParam15, var uParam16, bool bParam17)//Position - 0x26691
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	*iParam12 = 1;
	...
	func_561();
	SCRIPT::SET_NO_LOADING_SCREEN(false);
	Global_113648.f_18969 = -1;
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_561()//Position - 0x26A59
{
	Global_23131.f_5 = 0;
}

void func_562(var uParam0)//Position - 0x26A67
{
	func_563(uParam0, 0);
	func_563(uParam0, 1);
	func_563(uParam0, 2);
...
void func_563(var uParam0, int iParam1)//Position - 0x26A84
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_564(bool bParam0, bool bParam1)//Position - 0x26AA1
{
...
void func_565(var uParam0)//Position - 0x26AD5
{
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uParam0);
}

void func_566(var uParam0)//Position - 0x26AE3
{
	func_565(*uParam0);
}
