...
void __EntryFunction__()//Position - 0x0
{
	...
	if (BitTest(Global_113386.f_18967.f_1, bVar77))
	{
		fVar65 = 0.1f;
	}
	bVar13 = bVar77;
	...
	while (true)
	{
		...
		switch (iVar7)
		{
			...
			case 5:
				...
				if (BitTest(Global_113386.f_18967.f_1, (func_366(&Var3) - 125)))
				{
			...
			case 9:
				...
				else if (func_328(&uVar4, 3, 1000) && !Global_23011.f_135)
				{
			...
			case 10:
				...
				if ((!bVar96 && !bVar97) && !bVar99)
				{
					...
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (((((ENTITY::DOES_ENTITY_EXIST(iVar34) && !ENTITY::IS_ENTITY_DEAD(iVar34, false)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iVar34, Var59, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_369(&Var3, iVar71), Var59, false, true, 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()))
						{
							...
							if (bVar117)
							{
								if (func_328(&uVar4, 3, 1000) && !Global_23011.f_135)
								{
									ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), true);
									PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 256);
									CAM::DO_SCREEN_FADE_OUT(800);
				...
				if (((bVar96 || bVar97) || bVar99) || (func_462(&iVar21) && func_461(&iVar21) > 0.25f))
				{
					...
					if (bVar96 || iVar8 == 1)
					{
						...
						{
							iVar79 = 125;
							MISC::SET_BIT(&(Global_113386.f_18967.f_1), (func_366(&Var3) - iVar79));
							...
							while (bVar83 < 13)
							{
								if (!BitTest(Global_113386.f_18967.f_1, bVar83))
								{
...
var func_58(int iParam0, bool bParam1)//Position - 0x5671
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_23150.f_7420[iParam0 /*16*/])))
	{
		...
		{
			return func_59(&(Global_23150.f_7420[iParam0 /*16*/]));
		}
	}
	switch (iParam0)
	{
...
char* func_61(int iParam0)//Position - 0x5BBA
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_23150.f_6411[iParam0 /*16*/])))
	{
		...
		{
			return func_59(&(Global_23150.f_6411[iParam0 /*16*/]));
		}
	}
	if (iParam0 == 51)
	{
...
var func_115(var uParam0)//Position - 0x9A92
{
	return uParam0;
}

int func_116(int iParam0, var* uParam1)//Position - 0x9A9C
{
	int iVar0;
	int iVar1;
...
int func_117(int iParam0)//Position - 0x9AD7
{
	if (iParam0 == 600)
	{
...
void func_118(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, char* sParam5)//Position - 0x9C4A
{
...
int func_119(var* uParam0, var* uParam1)//Position - 0x9C9C
{
	if (!func_120(*uParam0))
	{
		return 0;
...
bool func_120(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)//Position - 0x9CD6
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

void func_121(var uParam0, var uParam1)//Position - 0x9CE6
{
	int iVar0;
	int iVar1;
	struct<75> Var2;
...
void func_122(var uParam0, var uParam1)//Position - 0x9E51
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void func_123(var uParam0)//Position - 0x9F00
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void func_124(var uParam0)//Position - 0xA111
{
	struct<13> Var0;
	int iVar1;
...
int func_125(var uParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA185
{
	int iVar0;
...
void func_126(var uParam0)//Position - 0xA42E
{
	struct<13> Var0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0, int iParam1, int iParam2, char* sParam3)//Position - 0xA50D
{
...
int func_128(var uParam0)//Position - 0xA541
{
	if (!Global_2097532)
	{
...
void func_129(var uParam0)//Position - 0xA6FA
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
Vector3 func_130(int iParam0)//Position - 0xA8E0
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_131(int iParam0, int iParam1)//Position - 0xA8F3
{
	int iVar0;
...
int func_132(int iParam0)//Position - 0xA96F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_133(var uParam0)//Position - 0xAA02
{
	int iVar0;
	int iVar1;
...
int func_134(var uParam0, var uParam1, var* uParam2, var uParam3)//Position - 0xABAF
{
	var* uVar0;
	int iVar1;
...
void func_135(var* uParam0, char* sParam1)//Position - 0xAC68
{
	NETWORK::NETWORK_CLAN_GET_UI_FORMATTED_TAG(uParam0, 35, sParam1);
}

int func_136(var* uParam0, var uParam1)//Position - 0xAC7A
{
	int iVar0;
...
bool func_137()//Position - 0xACB9
{
	return (MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION());
}

void func_138(var uParam0)//Position - 0xACCF
{
	int iVar0;
...
void func_139(var uParam0)//Position - 0xAD3F
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_140(var uParam0)//Position - 0xAD87
{
	int iVar0;
...
int func_141(var uParam0, var* uParam1, char* sParam2)//Position - 0xADF5
{
	if (*uParam0 == 2)
	{
		return 1;
...
int func_142(var uParam0)//Position - 0xAF06
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_143(var uParam0)//Position - 0xB09B
{
	int iVar0;
...
int func_144(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, char* sParam17)//Position - 0xB138
{
	struct<13> Var0;
...
int func_145(var uParam0, char* sParam1, char* sParam2, int iParam3, var uParam4)//Position - 0xB25A
{
	int iVar0;
	struct<13> Var1[1];
...
int func_146(var uParam0)//Position - 0xB35F
{
	struct<97> Var0;
	struct<6> Var1;
	int iVar2;
...
void func_147(int iParam0, int iParam1)//Position - 0xC184
{
	int iVar0;
...
int func_148(var uParam0, var uParam1, var* uParam2, int iParam3, int iParam4)//Position - 0xC2A9
{
	switch (*uParam0)
	{
		case 0:
...
void func_153(var uParam0, var uParam1, var uParam2)//Position - 0xC405
{
	*uParam0 = 0;
	*uParam1 = 0;
	Global_2097152 = 0;
...
int func_154(int iParam0)//Position - 0xC431
{
...
void func_155(var uParam0, char* sParam1, int iParam2)//Position - 0xC48F
{
	int iVar0;
	int iVar1;
...
void func_156(var uParam0)//Position - 0xC599
{
	int iVar0;
...
void func_157(var uParam0, var uParam1)//Position - 0xC642
{
	*uParam0 = *uParam1;
...
int func_158(var uParam0, var uParam1, var* uParam2, int iParam3, var* uParam4, bool bParam5, bool bParam6, int iParam7, int iParam8)//Position - 0xC65D
{
	int iVar0;
	float fVar1;
...
int func_160(var uParam0)//Position - 0xC7AF
{
	struct<20> Var0;
	struct<6> Var1;
	int iVar2;
...
int func_161(var uParam0, var uParam1, var* uParam2, var* uParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0xD1A9
{
	switch (*uParam0)
	{
		case 0:
...
int func_162(var uParam0)//Position - 0xD265
{
	struct<13> Var0;
	struct<97> Var1;
	struct<6> Var2;
...
int func_163(struct<4> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65)//Position - 0xE091
{
	int iVar0;
...
void func_164(var uParam0)//Position - 0xE129
{
	int iVar0;
...
void func_165(int iParam0)//Position - 0xE179
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iParam0))
	{
		GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iParam0, 255, 255, 255, 0, 0);
...
void func_166(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xE199
{
	char* sVar0;
	struct<2> Var1;
	struct<16> Var2;
...
void func_167(int iParam0, char* sParam1, var uParam2, int iParam3)//Position - 0xE470
{
	int iVar0;
...
void func_168(int iParam0, char* sParam1, char* sParam2, char* sParam3, bool bParam4, int iParam5)//Position - 0xE4B2
{
...
int func_169(int iParam0)//Position - 0xE542
{
...
void func_170(int iParam0, int iParam1)//Position - 0xE564
{
...
int func_171()//Position - 0xE581
{
	return GRAPHICS::REQUEST_SCALEFORM_MOVIE("SC_LEADERBOARD");
}

bool func_172()//Position - 0xE591
{
	return func_173(PLAYER::PLAYER_ID());
}

int func_173(int iParam0)//Position - 0xE5A1
{
...
int func_174(int iParam0)//Position - 0xE601
{
	return Global_1853348[iParam0 /*834*/].f_192;
}

void func_175(int iParam0)//Position - 0xE614
{
	Global_1577896 = iParam0;
}

void func_176(int iParam0)//Position - 0xE622
{
	Global_1649593.f_1163 = iParam0;
}

void func_177(bool bParam0)//Position - 0xE633
{
	if (bParam0)
	{
		func_179();
...
void func_178(int iParam0, int iParam1)//Position - 0xE684
{
...
void func_179()//Position - 0xE6BA
{
	Global_2815059.f_4599 = 0;
}

void func_180(var uParam0, bool bParam1, bool bParam2)//Position - 0xE6CA
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
	{
		if (!bParam2)
...
int func_181(var uParam0, bool bParam1, int iParam2)//Position - 0xE707
{
...
void func_182(var uParam0)//Position - 0xE8A6
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "CLEAR_ALL");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	if (MISC::IS_PC_VERSION())
...
void func_183(var uParam0)//Position - 0xE96B
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_184(var uParam0)//Position - 0xEA73
{
	uParam0->f_547 = 1f;
	uParam0->f_546 = 0;
	uParam0->f_572 = 0f;
...
void func_185(int* iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, var uParam5, float fParam6)//Position - 0xEAF2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_186(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0xEC45
{
	int iVar0;
...
void func_187(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xECB8
{
...
void func_188(var uParam0)//Position - 0xECDB
{
	func_184(uParam0);
	uParam0->f_574 = 0;
	uParam0->f_31 = 0;
...
char* func_189(int iParam0)//Position - 0xED05
{
	switch (iParam0)
	{
		case 0:
...
int func_190(bool bParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEDC0
{
...
int func_191(var uParam0)//Position - 0xEE03
{
	struct<98> Var0;
	struct<4> Var1;
	struct<37> Var2;
...
bool func_192()//Position - 0xF226
{
	return BitTest(Global_1048576.f_10, 1);
}

var func_193()//Position - 0xF236
{
	return Global_2723612.f_3;
}

int func_194(int iParam0)//Position - 0xF244
{
	switch (iParam0)
	{
		case 817:
...
int func_196(int iParam0, int iParam1, int iParam2)//Position - 0xF375
{
	int iVar0;
...
int func_197(int iParam0, int iParam1)//Position - 0xF477
{
...
int func_198(var uParam0, var uParam1, var* uParam2, var* uParam3)//Position - 0xF4D2
{
	switch (*uParam0)
	{
		case 0:
...
void func_199(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xF586
{
	struct<6> Var0[1];
	struct<8> Var1[1];
...
void func_200(int iParam0, int iParam1, int iParam2, float fParam3, bool bParam4)//Position - 0xF715
{
	int iVar0;
	int iVar1;
...
int func_201(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xF830
{
	struct<68> Var0;
	int iVar1;
	struct<13> Var2;
...
void func_202(bool bParam0)//Position - 0xF964
{
	struct<3> Var0;
...
void func_203(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0xFA65
{
	struct<8> Var0;
	struct<8> Var1;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 0:
			...
			else
			{
				...
				if (func_210(Global_4718592.f_168757) || func_207(Global_4718592.f_168757))
				{
					StringCopy(&(Global_2097536.f_2717[0 /*6*/]), "SCLB_C_SCORE" /* GXT: SCORE */, 24);
				...
				else if (func_206(Global_4718592.f_168757))
				{
					StringCopy(&(Global_2097536.f_2717[0 /*6*/]), "SCLB_C_SCORE" /* GXT: SCORE */, 24);
					StringCopy(&(Global_2097536.f_2717[1 /*6*/]), "SCLB_C_DEATH" /* GXT: DEATHS */, 24);
					StringCopy(&(Global_2097536.f_2717[2 /*6*/]), "SCLB_C_RANK" /* GXT: POSITION */, 24);
...
int func_204(struct<8> Param0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)//Position - 0x14AB2
{
	char cVar0[64];
...
struct<6> func_205(int iParam0)//Position - 0x14B24
{
	struct<6> Var0;
...
bool func_206(int iParam0)//Position - 0x14BD3
{
	return iParam0 == 74;
}

var func_207(int iParam0)//Position - 0x14BE0
{
	return (func_209(iParam0) || func_208(iParam0));
}

bool func_208(int iParam0)//Position - 0x14BFA
{
	return iParam0 == 44;
}

bool func_209(int iParam0)//Position - 0x14C07
{
	return iParam0 == 45;
}

bool func_210(int iParam0)//Position - 0x14C14
{
	return iParam0 == 12;
}

struct<6> func_211(int iParam0)//Position - 0x14C21
{
	struct<6> Var0;
...
bool func_213()//Position - 0x14EA7
{
	return NETWORK::NETWORK_IS_SIGNED_ONLINE();
}

void func_214(int* iParam0, bool bParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x14EB3
{
	if (*iParam0 == 0)
	{
...
char* func_215(bool bParam0, char* sParam1, char* sParam2)//Position - 0x14FF7
{
	if (bParam0)
	{
		return sParam1;
...
void func_216()//Position - 0x1500E
{
	func_217(PLAYER::PLAYER_PED_ID(), "GENERIC_CURSE_MED", 24);
}

void func_217(int iParam0, char* sParam1, int iParam2)//Position - 0x15024
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iParam0, sParam1, func_218(iParam2), 1);
}

int func_218(int iParam0)//Position - 0x1503B
{
	int iVar0;
...
void func_220(int iParam0, int iParam1)//Position - 0x1527B
{
	Global_100480.f_7 = iParam0;
	Global_100480.f_8 = iParam1;
}

void func_221(int* iParam0, int iParam1, bool bParam2)//Position - 0x15293
{
	if (bParam2)
	{
...
int func_222(var uParam0, int iParam1, var uParam2, var uParam3, float fParam4)//Position - 0x152B9
{
	int iVar0;
...
void func_223(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x15327
{
	int iVar0;
	int iVar1;
...
int func_224(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x153F9
{
	float fVar0;
	bool bVar1;
	int iVar2;
...
void func_225(bool bParam0)//Position - 0x159F8
{
	int iVar0;
	int iVar1;
...
void func_226(int iParam0)//Position - 0x15C7A
{
	int iVar0;
...
void func_227(bool bParam0)//Position - 0x15CD4
{
	bool bVar0;
	char cVar1[64];
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_229() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_229() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
char* func_228(bool bParam0)//Position - 0x15E53
{
	switch (bParam0)
	{
		case 0:
...
void func_230(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x15F62
{
	int iVar0;
...
int func_231(var uParam0)//Position - 0x15F92
{
	int iVar0;
	int iVar1;
...
int func_232()//Position - 0x15FC6
{
	return Global_1574918;
}

void func_233(int iParam0, bool bParam1, int iParam2)//Position - 0x15FD2
{
	if (iParam2 == -1)
	{
		iParam2 = func_232();
...
void func_234(int iParam0)//Position - 0x15FF0
{
	func_363(93, iParam0);
	func_363(29, iParam0);
	func_363(30, iParam0);
...
int func_235(int iParam0)//Position - 0x16010
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	return BitTest(Global_2359296[func_229() /*5567*/].f_681.f_10, iParam0);
}

int func_236(int iParam0, int iParam1, int iParam2)//Position - 0x161B6
{
	int iVar0;
	var uVar1;
...
bool func_237(int iParam0, int iParam1)//Position - 0x161F3
{
	if (iParam1 == -1)
	{
		iParam1 = func_232();
...
int func_238(bool bParam0)//Position - 0x1620F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_239(int iParam0, int iParam1)//Position - 0x162C6
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_240(int iParam0, int iParam1)//Position - 0x162E1
{
	...
	if (func_250(&Global_4541529))
	{
		if (func_248(&Global_4541529, iParam0))
		{
			return 0;
		}
		if (func_241(&Global_4541529, iParam0))
		{
			return 1;
		}
	}
...
int func_241(var uParam0, int iParam1)//Position - 0x1637E
{
	int iVar0;
	var uVar1[78];
...
int func_242(var uParam0, int iParam1)//Position - 0x1642F
{
	int iVar0;
...
bool func_243(var uParam0, int iParam1)//Position - 0x164AA
{
	return (*uParam0)[iParam1] == 78;
}

void func_244(var uParam0)//Position - 0x164BB
{
	int iVar0;
	...
	func_246(uParam0, (Global_4541528 - 0.5f));
}

void func_245(var uParam0, int iParam1)//Position - 0x164EF
{
	(*uParam0)[iParam1] = 78;
}

void func_246(var uParam0, float fParam1)//Position - 0x164FF
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_247(var uParam0)//Position - 0x1651C
{
	return uParam0->f_80;
}

bool func_248(var uParam0, int iParam1)//Position - 0x16528
{
	return func_249(uParam0, iParam1) != -1;
}

int func_249(var uParam0, int iParam1)//Position - 0x1653A
{
	int iVar0;
...
bool func_250(var uParam0)//Position - 0x16567
{
	return uParam0->f_79 == 1;
}

int func_251(int iParam0)//Position - 0x16575
{
	switch (iParam0)
	{
		case 60:
...
bool func_252(int iParam0)//Position - 0x165C5
{
	return Global_43052 == iParam0;
}

int func_253(int iParam0, int iParam1)//Position - 0x165D3
{
	int iVar0;
...
void func_254(int iParam0, int iParam1)//Position - 0x16624
{
	int iVar0;
...
void func_255()//Position - 0x16647
{
	int iVar0;
...
int func_256(int iParam0)//Position - 0x166BC
{
	return Global_1998[iParam0 /*29*/].f_17;
}

void func_257(int iParam0, int iParam1, int iParam2)//Position - 0x166CD
{
	bool bVar0;
...
void func_258()//Position - 0x167B3
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	{
		func_253(13, SYSTEM::FLOOR(Global_113386.f_10194.f_3853));
	}
...
int func_259()//Position - 0x16C71
{
	return Global_31959;
}

void func_260(int iParam0, int iParam1)//Position - 0x16C7C
{
...
int func_261(int iParam0)//Position - 0x16CC1
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
void func_262(int iParam0, bool bParam1)//Position - 0x16CEE
{
	int iVar0;
...
bool func_263(int* iParam0, int iParam1)//Position - 0x16D74
{
	return BitTest(iParam0->f_607, iParam1);
}

int func_264()//Position - 0x16D84
{
	return GRAPHICS::REQUEST_SCALEFORM_MOVIE("MP_BIG_MESSAGE_FREEMODE");
}

void func_265(struct<3> Param0, int iParam1, int iParam2, int iParam3, var uParam4, float fParam5)//Position - 0x16D94
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
int func_266(int iParam0, int iParam1)//Position - 0x16F2B
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
float func_267(float fParam0, float fParam1)//Position - 0x170DE
{
	if (fParam0 > fParam1)
	{
		return fParam0;
...
int func_268(int iParam0, int iParam1, int iParam2)//Position - 0x170F5
{
	if (iParam0 > iParam2)
	{
		return iParam2;
...
void func_269(struct<3> Param0, int* iParam1, var uParam2, var uParam3)//Position - 0x1711A
{
	float fVar0;
	int iVar1;
...
void func_270(int* iParam0, var uParam1, bool bParam2, int iParam3)//Position - 0x171D1
{
	int iVar0;
	...
	if (func_337("BJ_FALLHLP") && Global_23011.f_135)
	{
		HUD::CLEAR_HELP(true);
		func_221(iParam0, 1, 0);
	}
	if (!func_263(iParam0, 1) && !Global_23011.f_135)
	{
...
void func_271(int iParam0)//Position - 0x17333
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
float func_272(float fParam0, float fParam1, float fParam2)//Position - 0x174A6
{
	float fVar0;
...
float func_273(float fParam0)//Position - 0x174D5
{
	return (fParam0 * 57.29578f);
}

int func_274(int iParam0)//Position - 0x174E5
{
	struct<3> Var0;
	struct<3> Var1;
	var uVar2;
...
float func_275(struct<3> Param0, struct<3> Param1)//Position - 0x1754F
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

float func_276(int iParam0, int iParam1, bool bParam2)//Position - 0x17570
{
	struct<3> Var0;
	struct<3> Var1;
...
Vector3 func_277(int iParam0, struct<3> Param1)//Position - 0x175CE
{
	var uVar0;
...
bool func_278(int iParam0)//Position - 0x17614
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
void func_279(int* iParam0, var uParam1)//Position - 0x17632
{
	var uVar0[6];
	int iVar1;
	struct<3> Var2;
...
void func_280(var uParam0)//Position - 0x17875
{
...
int func_281(int iParam0, var uParam1)//Position - 0x178A6
{
	int iVar0;
...
void func_283()//Position - 0x17BC7
{
	Global_32104 = 1;
}

void func_284()//Position - 0x17BD3
{
	int iVar0;
...
void func_285(int* iParam0)//Position - 0x17C43
{
	iParam0->f_607 = 0;
}

void func_286(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x17C51
{
	struct<60> Var0;
...
void func_287(int iParam0, int iParam1, int iParam2)//Position - 0x17D7A
{
	int iVar0;
	...
	if (!func_307(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_113386.f_32749.f_4801 = func_520();
			}
...
void func_288(int iParam0, int iParam1)//Position - 0x17E91
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_318(iParam0, &(Global_113386.f_32749.f_5510));
}

int func_289(int iParam0)//Position - 0x18096
{
...
int func_290(int iParam0)//Position - 0x18173
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_291(int iParam0, bool bParam1)//Position - 0x18324
{
	int iVar0;
	struct<2> Var1;
...
int func_292(int iParam0)//Position - 0x184A4
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_294(int iParam0)//Position - 0x18587
{
	int iVar0;
	int iVar1;
...
int func_295()//Position - 0x1B858
{
	return 0;
}

int func_296()//Position - 0x1B861
{
	return 1;
}

int func_297()//Position - 0x1B86A
{
	return 1;
}

int func_298()//Position - 0x1B873
{
...
int func_300(int iParam0)//Position - 0x1B944
{
	int iVar0;
	char* sVar1;
...
int func_301(int iParam0)//Position - 0x1B98A
{
	int iVar0;
...
int func_302(int iParam0)//Position - 0x1B9C5
{
	int iVar0;
...
int func_303(int iParam0)//Position - 0x1BA41
{
	int iVar0;
...
int func_304(int iParam0, int iParam1, bool bParam2)//Position - 0x1BB29
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_305(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x1BB97
{
...
int func_306(int iParam0)//Position - 0x1BC6F
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_307(var uParam0, int iParam1)//Position - 0x1BC8B
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_317(Global_113386.f_32749.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_317(Global_113386.f_2363.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_317(Global_113386.f_2363.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_308(int iParam0, int iParam1)//Position - 0x1D37A
{
	struct<82> Var0;
...
void func_309(int iParam0, var uParam1, int iParam2)//Position - 0x1D3BC
{
	int iVar0;
...
void func_310(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x1D618
{
	if (func_307(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_315(iParam0);
			func_314(uParam1, &(Global_113386.f_32749.f_69[Global_77137.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_311(int iParam0, bool bParam1)//Position - 0x1D711
{
	if (iParam0 == -1)
	{
		return;
...
void func_312(int iParam0, int iParam1, bool bParam2)//Position - 0x1D76E
{
	if (iParam0 == -1)
	{
		return;
...
int func_313(int iParam0, int iParam1)//Position - 0x1D7A9
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_314(var uParam0, var uParam1)//Position - 0x1D7C9
{
...
void func_315(int iParam0)//Position - 0x1D895
{
	if (iParam0 == -1)
	{
		return;
...
int func_316(int iParam0)//Position - 0x1D90C
{
	int iVar0;
...
bool func_317(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x1D96F
{
	if (bParam2)
	{
...
void func_318(int iParam0, var uParam1)//Position - 0x1D9B6
{
	int iVar0;
...
int func_319(int iParam0)//Position - 0x1DC61
{
	switch (iParam0)
	{
		case 1:
...
int func_320(int iParam0, var uParam1, var uParam2)//Position - 0x1DD11
{
	int iVar0;
	int iVar1;
...
int func_321(int iParam0)//Position - 0x1DF04
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_322(var uParam0)//Position - 0x1DF24
{
	int iVar0;
...
void func_323(int iParam0)//Position - 0x1DFD4
{
...
float func_324(int iParam0)//Position - 0x1DFFB
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_325(int iParam0)//Position - 0x1E0C5
{
	switch (iParam0)
	{
		case 0:
...
int func_326(int iParam0)//Position - 0x1E215
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (ENTITY::IS_ENTITY_DEAD(iParam0, false))
...
void func_327(int* iParam0)//Position - 0x1E258
{
	if (*iParam0 != 0)
	{
		GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(iParam0);
...
int func_328(var uParam0, bool bParam1, int iParam2)//Position - 0x1E32B
{
...
int func_329(var uParam0, int* iParam1, struct<3> Param2, struct<3> Param3, struct<3> Param4, var uParam5, var uParam6)//Position - 0x1E383
{
	struct<3> Var0;
...
void func_330(int iParam0, var uParam1, int* iParam2)//Position - 0x1E497
{
	struct<3> Var0;
	int iVar1;
	int iVar2;
...
float func_331()//Position - 0x1E516
{
	if (MISC::IS_PC_VERSION())
	{
		return 0.5f;
...
int func_332(var uParam0, var uParam1, var uParam2, int* iParam3, var uParam4, var uParam5, struct<3> Param6, struct<3> Param7)//Position - 0x1E532
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var2;
...
bool func_333(var uParam0, bool bParam1)//Position - 0x1E770
{
	return (BitTest(uParam0->f_2, bParam1) && !BitTest(uParam0->f_3, bParam1));
}

void func_334(char* sParam0)//Position - 0x1E78C
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, true, true, -1);
}

Vector3 func_335(var uParam0)//Position - 0x1E7A2
{
	return *uParam0, uParam0->f_1, 0f;
}

void func_336(int iParam0, struct<3> Param1)//Position - 0x1E7B2
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_337(char* sParam0)//Position - 0x1E83E
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_338(char* sParam0, int iParam1)//Position - 0x1E851
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
}

void func_339(var uParam0, bool bParam1)//Position - 0x1E868
{
	if (bParam1)
	{
...
void func_340(char* sParam0, int iParam1, int iParam2)//Position - 0x1E8B0
{
	iParam2 = iParam2;
...
struct<4> func_341(bool bParam0)//Position - 0x1E8C9
{
	struct<4> Var0;
...
void func_342(int* iParam0, float fParam1)//Position - 0x1E92F
{
	if (!func_462(iParam0))
	{
...
void func_343(int* iParam0, int iParam1)//Position - 0x1E949
{
	if (func_462(iParam0))
	{
...
int func_345(int* iParam0, float fParam1)//Position - 0x1E9B7
{
...
int func_346(int* iParam0, float fParam1)//Position - 0x1E9D5
{
	if (func_462(iParam0))
	{
...
void func_347(int* iParam0)//Position - 0x1E9F7
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
float func_349(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3)//Position - 0x1F399
{
	return ((Param0.f_0 * Param2.f_0) + (Param0.f_1 * Param2.f_1));
}

void func_350(var uParam0, bool bParam1)//Position - 0x1F3B0
{
...
bool func_352(var uParam0, var uParam1, int iParam2)//Position - 0x1F44B
{
	int iVar0;
	int iVar1;
...
float func_353(int* iParam0)//Position - 0x1F504
{
	if (func_462(iParam0))
	{
		if (func_354(iParam0))
...
bool func_354(int* iParam0)//Position - 0x1F53D
{
	return BitTest(*iParam0, 2);
}

void func_355(struct<3> Param0, var uParam1, var uParam2, var uParam3)//Position - 0x1F54A
{
	var uVar0;
	var uVar1;
	float fVar2;
...
void func_356(struct<3> Param0, var uParam1, var uParam2)//Position - 0x1F6BA
{
	float fVar0;
	float fVar1;
	struct<3> Var2;
...
int func_357(struct<3> Param0, int iParam1, int iParam2)//Position - 0x1F7A1
{
	float fVar0;
	int iVar1;
	float fVar2;
...
void func_358(int* iParam0)//Position - 0x1F80D
{
...
int func_359(var uParam0, bool bParam1, var uParam2)//Position - 0x1F835
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var2;
...
var func_361(var uParam0)//Position - 0x1F9CB
{
	return uParam0->f_84;
}

void func_362(int* iParam0, bool bParam1)//Position - 0x1F9D7
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
void func_363(int iParam0, int iParam1)//Position - 0x1FAC6
{
	int iVar0;
...
void func_364(bool bParam0, bool bParam1, int iParam2)//Position - 0x1FB23
{
	if (bParam0)
	{
...
int func_365(int iParam0)//Position - 0x1FB61
{
	switch (iParam0)
	{
		case joaat("bmx"):
...
int func_366(var uParam0)//Position - 0x1FBE1
{
	return *uParam0;
}

int func_367(int iParam0)//Position - 0x1FBEC
{
	switch (iParam0)
	{
		case joaat("freight"):
...
int func_368(var uParam0)//Position - 0x1FC0C
{
	return uParam0->f_1;
}

Vector3 func_369(var uParam0, int iParam1)//Position - 0x1FC18
{
...
Vector3 func_370(var uParam0)//Position - 0x1FC42
{
	return uParam0->f_6;
}

void func_371(int* iParam0)//Position - 0x1FC50
{
	func_42(iParam0, 0f);
}

int func_372(int iParam0)//Position - 0x1FC5F
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_373(int iParam0)//Position - 0x1FC72
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_374(int iParam0)//Position - 0x1FC85
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

void func_375()//Position - 0x1FC98
{
	int iVar0;
...
void func_376()//Position - 0x1FCC1
{
	struct<68> Var0;
...
void func_377(var uParam0)//Position - 0x1FD63
{
	int iVar0;
...
bool func_378(var uParam0)//Position - 0x1FD9E
{
	return uParam0->f_83;
}

int func_379(var uParam0, bool bParam1, int* iParam2, var uParam3, var uParam4, int* iParam5, int* iParam6, int* iParam7, int* iParam8, int iParam9, var uParam10, var uParam11, var uParam12)//Position - 0x1FDAA
{
...
void func_380()//Position - 0x1FF6B
{
	struct<6> Var0;
	int iVar1;
	
	iVar1 = Global_113386.f_18967;
	func_381(Var0, 0, 0, 0, 0, iVar1);
}

void func_381(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x1FF8A
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78573 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_384(Global_78574, Global_78576, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
void func_382()//Position - 0x20270
{
	if (Global_78573 != 6)
	{
	}
...
float func_383(char* sParam0)//Position - 0x202A8
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_384(int iParam0, int iParam1, int iParam2)//Position - 0x202BB
{
	struct<2> Var0;
	int iVar1;
...
char* func_385(int iParam0)//Position - 0x20391
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_386(int iParam0)//Position - 0x204E4
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_387(int iParam0)//Position - 0x20517
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_388(int iParam0)//Position - 0x2054A
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_389(int iParam0)//Position - 0x2057D
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_390(int iParam0)//Position - 0x205B0
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_391(int iParam0)//Position - 0x205ED
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_392(int iParam0)//Position - 0x20620
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_393(int iParam0)//Position - 0x20657
{
	struct<2> Var0;
...
struct<2> func_394(int iParam0)//Position - 0x20AA3
{
	struct<2> Var0;
...
int func_395(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x20B0C
{
	if (((!func_397(0) || Global_78588) || Global_78577 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78573)
...
bool func_396(bool bParam0)//Position - 0x20C24
{
	if (bParam0)
	{
...
int func_397(int iParam0)//Position - 0x20C4D
{
	if (Global_43052 == 15)
	{
		return 0;
...
bool func_398(int iParam0)//Position - 0x20C6F
{
	return func_399(iParam0, Global_43052);
}

int func_399(int iParam0, int iParam1)//Position - 0x20C80
{
	if (iParam1 == 15)
	{
		return 1;
...
float func_400(var uParam0)//Position - 0x20E61
{
	return uParam0->f_80;
}

int func_401(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x20E6D
{
...
int func_402(char* sParam0, int iParam1, bool bParam2)//Position - 0x20EBB
{
	Global_21606 = 0;
...
void func_403()//Position - 0x21189
{
	if (!func_404())
	{
		return;
...
bool func_405(int iParam0)//Position - 0x21223
{
	return func_406(iParam0, 20);
}

var func_406(int iParam0, int iParam1)//Position - 0x21233
{
	return BitTest(Global_1892703[iParam0 /*599*/].f_10.f_4, iParam1);
}

int func_407()//Position - 0x2124B
{
	return -1;
}

void func_408()//Position - 0x21254
{
	int iVar0;
...
void func_409()//Position - 0x21285
{
...
void func_411()//Position - 0x213B3
{
	if (func_252(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_412()//Position - 0x21455
{
	int iVar0;
...
bool func_413(int iParam0, int iParam1)//Position - 0x214AC
{
	switch (iParam0)
	{
		case 5:
...
void func_414()//Position - 0x214E4
{
...
void func_415(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x2153B
{
...
var func_416(var uParam0)//Position - 0x21591
{
	return uParam0->f_4;
}

void func_417(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, var uParam6, var uParam7)//Position - 0x2159D
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var2;
...
void func_418(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x216A8
{
	if (bParam0)
	{
...
bool func_419()//Position - 0x217EB
{
	return BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 14);
}

bool func_420(int iParam0, int iParam1)//Position - 0x21805
{
	bool bVar0;
...
int func_421(int iParam0, bool bParam1)//Position - 0x21850
{
	int iVar0;
	int iVar1;
...
int func_422(int iParam0)//Position - 0x21891
{
...
bool func_423()//Position - 0x218D0
{
	return BitTest(Global_2621446, 3);
}

int func_424(bool bParam0, bool bParam1, var uParam2, bool bParam3)//Position - 0x218DE
{
	int iVar0;
...
void func_425(int iParam0)//Position - 0x21911
{
	if (iParam0 == 1)
	{
...
float func_426(bool bParam0, int iParam1)//Position - 0x21934
{
	switch (bParam0)
	{
		case 3:
...
int func_427(bool bParam0)//Position - 0x219CE
{
	switch (bParam0)
	{
		case 5:
...
int func_428()//Position - 0x21A02
{
	func_429();
	return Global_113386.f_2363.f_539.f_4321;
}

void func_429()//Position - 0x21A1B
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_37(Global_113386.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_39(iVar0) && (!func_252(14) || Global_112337))
			{
...
float func_430(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3)//Position - 0x21B18
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param2.f_0 - Param0.f_0), (Param2.f_1 - Param0.f_1));
}

int func_431(struct<3> Param0)//Position - 0x21B32
{
...
Vector3 func_432(bool bParam0)//Position - 0x21B5C
{
	switch (bParam0)
	{
		case 5:
...
int func_433(var uParam0, int iParam1)//Position - 0x21BB6
{
	if (iParam1 >= 2)
	{
		return 0;
...
void func_434(int iParam0, bool bParam1, int iParam2)//Position - 0x21BCE
{
...
void func_435(var uParam0, var uParam1, var uParam2, int* iParam3, int* iParam4, int* iParam5, int* iParam6, int* iParam7, int* iParam8, int* iParam9, int iParam10, int iParam11, int* iParam12, bool bParam13, int iParam14)//Position - 0x21C27
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
void func_436(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x226DA
{
...
void func_437(int iParam0, bool bParam1)//Position - 0x22775
{
	if (ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
		return;
...
int func_438(int iParam0)//Position - 0x22844
{
	switch (iParam0)
	{
		case joaat("seashark"):
...
int func_439(int iParam0)//Position - 0x2288E
{
	switch (iParam0)
	{
		case joaat("hauler"):
...
var func_440(var uParam0)//Position - 0x228CC
{
	return uParam0->f_77;
}

void func_441(var uParam0, int* iParam1)//Position - 0x228D8
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam1))
	{
...
var func_442(var uParam0)//Position - 0x22941
{
	return uParam0->f_79;
}

Vector3 func_443(var uParam0)//Position - 0x2294D
{
	return uParam0->f_9;
}

int func_444(var uParam0)//Position - 0x2295B
{
	return uParam0->f_3;
}

void func_445(var uParam0, var uParam1, bool bParam2)//Position - 0x22967
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_446(var uParam0)//Position - 0x22AD2
{
	return uParam0->f_78;
}

Vector3 func_447(var uParam0)//Position - 0x22ADE
{
	return uParam0->f_70;
}

int func_448(bool bParam0)//Position - 0x22AEC
{
	switch (bParam0)
	{
		case 0:
...
int func_449(int iParam0, int iParam1)//Position - 0x22B6C
{
...
void func_450(var uParam0, int iParam1, char* sParam2)//Position - 0x22BDE
{
	int iVar0;
...
char* func_452()//Position - 0x22C3B
{
	int iVar0;
...
void func_453(var uParam0, int iParam1, char* sParam2)//Position - 0x22C7E
{
	int iVar0;
...
char* func_454(bool bParam0)//Position - 0x22CB1
{
	return "EXT1HELIPILOT";
}

void func_455(int iParam0, bool bParam1)//Position - 0x22CBD
{
	if (ENTITY::IS_ENTITY_DEAD(iParam0, false))
	{
		return;
...
Vector3 func_456(var uParam0)//Position - 0x22D64
{
	return uParam0->f_67;
}

Vector3 func_457(var uParam0)//Position - 0x22D72
{
	return uParam0->f_64;
}

void func_458(int* iParam0)//Position - 0x22D80
{
	iParam0->f_1 = 0f;
	iParam0->f_2 = 0f;
	*iParam0 = 0;
...
int func_459(var uParam0, int* iParam1, var uParam2, bool bParam3, int iParam4, bool bParam5)//Position - 0x22D96
{
	char cVar0[64];
...
int func_460(var uParam0)//Position - 0x22ECD
{
	int iVar0;
...
float func_461(int* iParam0)//Position - 0x22F14
{
	if (func_462(iParam0))
	{
		if (func_354(iParam0))
...
bool func_462(int* iParam0)//Position - 0x22F50
{
	return BitTest(*iParam0, 1);
}

Vector3 func_463(struct<3> Param0, float fParam1)//Position - 0x22F5D
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
float func_464(var uParam0)//Position - 0x22FA1
{
	return uParam0->f_76;
}

int func_465(int iParam0)//Position - 0x22FAD
{
	switch (iParam0)
	{
...
int func_466(bool bParam0)//Position - 0x22FF7
{
	switch (bParam0)
	{
		case 0:
...
void func_467(var uParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2304D
{
	int iVar0;
	int iVar1;
...
void func_468(var uParam0)//Position - 0x232E8
{
	int iVar0;
...
int func_469(bool bParam0)//Position - 0x23318
{
	switch (bParam0)
	{
		case 0:
...
int func_470(var uParam0, int iParam1)//Position - 0x23352
{
	int iVar0;
	int iVar1;
...
int func_471(var uParam0)//Position - 0x233AF
{
	int iVar0;
...
void func_472(int iParam0, int iParam1)//Position - 0x233DB
{
...
Vector3 func_473(bool bParam0)//Position - 0x23402
{
	switch (bParam0)
	{
		case 0:
...
int func_474(bool bParam0)//Position - 0x2354C
{
	if (CAM::IS_SCREEN_FADED_OUT())
	{
...
Vector3 func_475(struct<3> Param0)//Position - 0x235BC
{
	float fVar0;
	float fVar1;
...
Vector3 func_476(bool bParam0)//Position - 0x235FB
{
	switch (bParam0)
	{
		case 0:
...
void func_477(var uParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x23725
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
float func_478(var uParam0)//Position - 0x238AB
{
	return uParam0->f_82;
}

Vector3 func_479(var uParam0)//Position - 0x238B7
{
	return uParam0->f_58;
}

Vector3 func_480(var uParam0)//Position - 0x238C5
{
	return uParam0->f_55;
}

int func_481(int iParam0)//Position - 0x238D3
{
	switch (iParam0)
	{
		case 5:
...
void func_482(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x23900
{
	if (iParam1 >= 2)
	{
		return;
...
var func_483(var uParam0)//Position - 0x2392D
{
	return uParam0->f_81;
}

Vector3 func_484(var uParam0)//Position - 0x23939
{
	return uParam0->f_52;
}

Vector3 func_485(var uParam0)//Position - 0x23947
{
	return uParam0->f_49;
}

void func_486(int* iParam0)//Position - 0x23955
{
	if (!func_462(iParam0))
	{
		func_371(iParam0);
...
void func_487(struct<3> Param0, float fParam1, bool bParam2)//Position - 0x2396D
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_307(&(Global_77137.f_555[0 /*21*/]), iVar0))
		{
...
void func_488(int iParam0)//Position - 0x239BD
{
	bool bVar0;
	...
	if (func_307(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		...
		if (BitTest(Global_77137.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_313(iParam0, 0)) && Global_78046.f_66 == 0) && Global_113386.f_32749.f_1958[Global_77137.f_555[0 /*21*/].f_14] != 0) && Global_113386.f_32749.f_1958[Global_77137.f_555[0 /*21*/].f_14] > 3) && (!func_489(0, Global_77137.f_555[0 /*21*/].f_12) || !func_489(1, Global_77137.f_555[0 /*21*/].f_12)))
			{
				func_314(&(Global_113386.f_32749.f_69[Global_77137.f_555[0 /*21*/].f_14 /*78*/]), &Global_78046);
...
int func_489(int iParam0, int iParam1)//Position - 0x23B2C
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_490(&(Global_113386.f_32749.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_291(Global_113386.f_32749.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}

int func_490(var uParam0)//Position - 0x23B9E
{
	return *uParam0;
}

void func_491(char* sParam0, int iParam1)//Position - 0x23BA9
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < Global_113386.f_20410.f_145)
	{
		if (MISC::ARE_STRINGS_EQUAL(sParam0, &(Global_113386.f_20410[iVar0 /*16*/])))
		{
			...
			func_493((Global_113386.f_20410.f_145 - 1));
...
void func_492()//Position - 0x23C56
{
	int iVar0;
...
void func_493(int iParam0)//Position - 0x23D6D
{
...
void func_494(int iParam0, int iParam1)//Position - 0x23E07
{
...
void func_495(bool bParam0)//Position - 0x23F17
{
	if (bParam0)
	{
...
void func_496()//Position - 0x23F59
{
	func_497(&uLocal_73, 0);
}

void func_497(var uParam0, int iParam1)//Position - 0x23F68
{
	if (uParam0->f_4 != 0)
	{
		func_153(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44));
...
void func_498()//Position - 0x24015
{
	int iVar0;
	int iVar1;
	struct<75> Var2;
...
void func_499(var uParam0)//Position - 0x24180
{
	int iVar0;
...
void func_500(var uParam0)//Position - 0x241D6
{
	int iVar0;
	struct<13> Var1;
...
void func_501(var uParam0)//Position - 0x2425E
{
	int iVar0;
	struct<35> Var1;
...
void func_502()//Position - 0x24328
{
	Global_23011.f_5 = 1;
}

void func_503(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x24336
{
	int iVar0;
...
void func_504(char* sParam0, int* iParam1, bool bParam2)//Position - 0x244B4
{
...
int func_505(char* sParam0, char* sParam1, int* iParam2, bool bParam3)//Position - 0x244D4
{
...
char* func_506(int iParam0, int iParam1)//Position - 0x24522
{
	char* sVar0;
...
void func_507(var uParam0, int iParam1)//Position - 0x245B2
{
	if (iParam1 < 11)
	{
...
int func_508(char* sParam0, int* iParam1, bool bParam2)//Position - 0x246B8
{
	if (!BitTest(*iParam1, bParam2))
	{
...
int func_509(char* sParam0, int* iParam1, bool bParam2)//Position - 0x246F6
{
	if (!BitTest(*iParam1, bParam2))
	{
		if (AUDIO::PREPARE_MUSIC_EVENT(sParam0))
...
char* func_510(int iParam0)//Position - 0x24725
{
	switch (iParam0)
	{
		case 15:
...
void func_511(var uParam0)//Position - 0x24783
{
	struct<2> Var0;
	var uVar1;
	var uVar2;
...
void func_513(var uParam0, int iParam1, bool bParam2)//Position - 0x248CA
{
	if (bParam2)
	{
...
void func_514(var uParam0)//Position - 0x248EE
{
	uParam0->f_3 = uParam0->f_2;
	uParam0->f_2 = 0;
}

void func_515(var uParam0, var uParam1, var uParam2)//Position - 0x24903
{
	func_517(uParam0, uParam1);
	func_516(uParam0, uParam2);
}

void func_516(var uParam0, var uParam1)//Position - 0x2491B
{
	uParam0->f_1 = uParam1;
}

void func_517(var uParam0, var uParam1)//Position - 0x24929
{
	*uParam0 = uParam1;
}

void func_518(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x24936
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_519()//Position - 0x24A23
{
...
void func_521(var uParam0, int iParam1)//Position - 0x24B16
{
	if (iParam1 <= 0)
	{
		return;
...
void func_522(var uParam0, int iParam1)//Position - 0x24B9C
{
...
void func_523(var uParam0, int iParam1)//Position - 0x24BCF
{
	int iVar0;
	int iVar1;
...
int func_524(int iParam0, int iParam1)//Position - 0x24C20
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_525(int iParam0)//Position - 0x24CC2
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_526(BitTest(iParam0, 31), -1, 1)) + 2011;
}

int func_526(bool bParam0, int iParam1, int iParam2)//Position - 0x24CE4
{
	if (bParam0)
	{
		return iParam1;
...
int func_527(var uParam0)//Position - 0x24CFB
{
	return uParam0 & 15;
}

void func_528(var uParam0, int iParam1)//Position - 0x24D08
{
...
void func_529(var uParam0, int iParam1)//Position - 0x24D42
{
...
void func_530(var uParam0, int iParam1)//Position - 0x24D7D
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_531(var uParam0)//Position - 0x24DB9
{
	return uParam0->f_2;
}

void func_532(var uParam0, bool bParam1)//Position - 0x24DC5
{
	int iVar0;
...
void func_533(var uParam0, struct<3> Param1)//Position - 0x25F9F
{
	uParam0->f_67 = { Param1 };
}

void func_534(var uParam0, struct<3> Param1)//Position - 0x25FB1
{
	uParam0->f_64 = { Param1 };
}

void func_535(var uParam0, int iParam1)//Position - 0x25FC3
{
	uParam0->f_84 = iParam1;
}

void func_536(var uParam0, int iParam1)//Position - 0x25FD1
{
	uParam0->f_83 = iParam1;
}

void func_537(var uParam0, float fParam1)//Position - 0x25FDF
{
	uParam0->f_82 = fParam1;
}

void func_538(var uParam0, struct<3> Param1)//Position - 0x25FED
{
	uParam0->f_58 = { Param1 };
}

void func_539(var uParam0, struct<3> Param1)//Position - 0x25FFF
{
	uParam0->f_55 = { Param1 };
}

void func_540(var uParam0, float fParam1)//Position - 0x26011
{
	uParam0->f_81 = fParam1;
}

void func_541(var uParam0, struct<3> Param1)//Position - 0x2601F
{
	uParam0->f_52 = { Param1 };
}

void func_542(var uParam0, struct<3> Param1)//Position - 0x26031
{
	uParam0->f_49 = { Param1 };
}

Vector3 func_543(int iParam0)//Position - 0x26043
{
	switch (iParam0)
	{
		case 0:
...
void func_544(var uParam0, char* sParam1)//Position - 0x2618D
{
	uParam0->f_4 = sParam1;
}

void func_545(var uParam0, struct<3> Param1)//Position - 0x2619B
{
	uParam0->f_6 = { Param1 };
}

void func_546(var uParam0, float fParam1)//Position - 0x261AD
{
	uParam0->f_77 = fParam1;
}

void func_547(var uParam0, int iParam1, struct<3> Param2)//Position - 0x261BB
{
	if (iParam1 < 0 || iParam1 >= 12)
	{
		return;
...
void func_548(var uParam0, float fParam1)//Position - 0x261E6
{
	uParam0->f_79 = fParam1;
}

void func_549(var uParam0, struct<3> Param1)//Position - 0x261F4
{
	uParam0->f_9 = { Param1 };
}

void func_550(var uParam0, int iParam1)//Position - 0x26206
{
	uParam0->f_3 = iParam1;
}

void func_551(var uParam0, float fParam1)//Position - 0x26214
{
	uParam0->f_80 = fParam1;
}

void func_552(var uParam0, float fParam1)//Position - 0x26222
{
	uParam0->f_78 = fParam1;
}

void func_553(var uParam0, struct<3> Param1)//Position - 0x26230
{
	uParam0->f_70 = { Param1 };
}

void func_554(var uParam0, int iParam1)//Position - 0x26242
{
	uParam0->f_2 = iParam1;
}

void func_555(var uParam0, float fParam1)//Position - 0x26250
{
	uParam0->f_76 = fParam1;
}

void func_556(var uParam0, int iParam1)//Position - 0x2625E
{
	uParam0->f_1 = iParam1;
}

void func_557(var uParam0, int iParam1)//Position - 0x2626C
{
	*uParam0 = iParam1;
}

void func_558(int iParam0, bool bParam1)//Position - 0x26279
{
	if (bParam1)
	{
...
void func_559(int iParam0)//Position - 0x2629B
{
	func_382();
...
void func_560(var uParam0, var uParam1, int* iParam2, int* iParam3, int* iParam4, var uParam5, int iParam6, var uParam7, int* iParam8, var uParam9, var uParam10, var uParam11, int iParam12, int iParam13, int iParam14, int iParam15, var uParam16, bool bParam17)//Position - 0x262B7
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	*iParam12 = 1;
	...
	func_561();
	SCRIPT::SET_NO_LOADING_SCREEN(false);
	Global_113386.f_18967 = -1;
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_561()//Position - 0x2667F
{
	Global_23011.f_5 = 0;
}

void func_562(var uParam0)//Position - 0x2668D
{
	func_563(uParam0, 0);
	func_563(uParam0, 1);
	func_563(uParam0, 2);
...
void func_563(var uParam0, int iParam1)//Position - 0x266AA
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_564(bool bParam0, bool bParam1)//Position - 0x266C7
{
...
void func_565(var uParam0)//Position - 0x266FB
{
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uParam0);
}

void func_566(var uParam0)//Position - 0x26709
{
	func_565(*uParam0);
}
