...
void func_214(int* iParam0, bool bParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x14EB3
{
	...
	iParam0->f_3[6] = 363;
	iParam0->f_3[7] = 363;
	iParam0->f_12[0] = func_215(iParam2 != 363, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, iParam2, true), "");
	iParam0->f_12[1] = func_215(iParam4 != 363, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, iParam4, true), "");
	iParam0->f_12[2] = func_215(iParam6 != 363, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, iParam6, true), "");
	iParam0->f_12[3] = func_215(iParam8 != 363, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, iParam8, true), "");
	iParam0->f_12[4] = 0;
	iParam0->f_12[5] = 0;
	iParam0->f_12[6] = 0;
	iParam0->f_12[7] = 0;
...
void func_511(var uParam0)//Position - 0x24783
{
	...
	func_518(&uVar1, &uVar2, &iVar3, &iVar4, PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()), PAD::_IS_USING_KEYBOARD(2));
