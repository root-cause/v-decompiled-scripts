...
bool func_4(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x4FF
{
...
int func_5(char* sParam0, int iParam1, bool bParam2)//Position - 0x54D
{
	Global_22426 = 0;
...
var func_9(int iParam0, int iParam1)//Position - 0x8C5
{
	return BitTest(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

int func_10()//Position - 0x8DD
{
	return -1;
}
...
bool func_18(int iParam0)//Position - 0xC24
{
	return iParam0 < 3;
}

int func_19(int iParam0)//Position - 0xC30
{
	int iVar0;
	int iVar1;
...
int func_20(int iParam0)//Position - 0xC6D
{
	if (func_18(iParam0))
	{
...
var func_21(int iParam0)//Position - 0xC92
{
...
void func_26(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0xD95
{
...
int func_29(struct<3> Param0)//Position - 0xF43
{
...
void func_31(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1026
{
...
int func_32(int iParam0, int iParam1)//Position - 0x10C1
{
	int iVar0;
