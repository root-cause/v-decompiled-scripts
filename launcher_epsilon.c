...
int func_438(var uParam0)//Position - 0x33E0C
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			func_441(&(uParam0->f_35[1]), iVar0[1], -697.3215f, 39.0406f, 42.86736f, -66.98854f);
			...
			func_439(&(uParam0->f_28[0]), iVar0[2], -726.4555f, 33.33568f, 43.22695f, -147.8099f, 26);
			...
			func_439(&(uParam0->f_28[1]), iVar0[2], -666.5512f, 49.19759f, 42.07154f, -171.6803f, 26);
...
int func_445(var uParam0)//Position - 0x34484
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			func_439(&(uParam0->f_28[0]), iVar0[1], -2881.755f, 3188.125f, 10.1136f, 254.1723f, 26);
