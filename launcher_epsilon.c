	...
	if (*iParam1)
	{
		switch (*uParam0)
		{
			case 15:
				...
				func_173("BADSUIT_HELP", "OUTFIT_P0_11", -1);
				*iParam1 = 0;
				break;
			
			case 16:
				func_495("Need robes and $ to launch Epsilon 8...");
				func_172("NOCASH_HELP", "OUTFIT_P0_11", 50000, -1);
				*iParam1 = 0;
				break;
	...
	if (func_392(iParam0->f_28[0]))
	{
		switch (iLocal_232)
		{
			...
			case 1:
				...
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0->f_28[0], Local_234[iLocal_233 /*3*/], 1f, 20000, 0.25f, false, 40000f);
