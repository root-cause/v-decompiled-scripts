					...
					if (fVar2 > 43681f)
					{
						if (!func_7(iVar1))
						{
							if (!Global_113622[bVar0])
							{
								func_3(iVar1);
								func_2(iVar1, 1, 1);
								MISC::CLEAR_BIT(&(Global_113648.f_24981.f_3), bVar0);
							}
							else if ((MISC::GET_GAME_TIMER() - Global_113628[bVar0]) > 60000)
							{
								Global_113622[bVar0] = 0;
								Global_113628[bVar0] = MISC::GET_GAME_TIMER();
								func_3(iVar1);
								func_2(iVar1, 1, 1);
								MISC::CLEAR_BIT(&(Global_113648.f_24981.f_3), bVar0);
							}
				...
				if (fVar2 > 43681f)
				{
					if (!func_7(iVar1))
					{
						if (!Global_113612[bVar0])
						{
							func_3(iVar1);
							func_2(iVar1, 1, 1);
							MISC::CLEAR_BIT(&(Global_113648.f_24978.f_2), bVar0);
						}
						else if ((MISC::GET_GAME_TIMER() - Global_113617[bVar0]) > 60000)
						{
							Global_113612[bVar0] = 0;
							Global_113617[bVar0] = MISC::GET_GAME_TIMER();
							func_3(iVar1);
							func_2(iVar1, 1, 1);
							MISC::CLEAR_BIT(&(Global_113648.f_24978.f_2), bVar0);
						}
...
void func_30()//Position - 0xCED
{
	...
	while (iVar0 <= (4 - 1))
	{
		...
		Global_113617[iVar0] = MISC::GET_GAME_TIMER();
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= (5 - 1))
