...
void func_1()//Position - 0xE5
{
	...
	if (func_11(8))
	{
		...
		{
			iVar1 = func_10(bVar0);
			if (BitTest(Global_113810.f_24982.f_1, bVar0))
			{
				if (BitTest(Global_113810.f_24982.f_3, bVar0))
				{
					...
					if (fVar2 > 43681f)
					{
						if (!func_7(iVar1))
						{
							...
							else if ((MISC::GET_GAME_TIMER() - Global_113790[bVar0]) > 60000)
							{
...
{
	return BitTest(Global_113810.f_9088.f_99.f_219[0], iParam0);
}
...
void func_19()//Position - 0x7BE
{
	...
	if (func_11(7))
	{
		...
		{
			iVar1 = func_22(bVar0);
			if (BitTest(Global_113810.f_24979.f_2, bVar0))
			{
				fVar2 = SYSTEM::VDIST2(func_9(PLAYER::PLAYER_ID()), func_8(iVar1, 0));
				if (fVar2 > 43681f)
				{
					if (!func_7(iVar1))
					{
						...
						else if ((MISC::GET_GAME_TIMER() - Global_113779[bVar0]) > 60000)
						{
