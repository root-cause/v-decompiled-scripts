...
void func_1()//Position - 0xD6
{
	...
	if (Global_113969.f_10052.f_107 < fLocal_210)
	{
		if (iLocal_222 == 0)
		{
		...
		if (func_142(0))
		{
			if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
						...
						if (func_140(PLAYER::PLAYER_PED_ID(), 12, iLocal_35))
						{
							if (func_139() && !func_167())
							{
								...
								if (fVar0 > 0.01f)
								{
									...
									Global_113969.f_10052.f_107 = (Global_113969.f_10052.f_107 + fVar0);
									if (func_134())
									{
										if (Global_113969.f_10052.f_107 >= 8000f)
										{
											Global_113969.f_10052.f_107 = fLocal_210;
										}
									}
									if (Global_113969.f_10052.f_107 < (1609f * 5f) && ((1609f * 5f) - Global_113969.f_10052.f_107) < (fLocal_208 - 160.9f))
									{
										if (func_134())
										{
											fVar2 = func_133(Global_113969.f_10052.f_107);
											fLocal_218 = fVar2;
										}
										else
										{
											fVar3 = (Global_113969.f_10052.f_107 / 160.9f);
											iVar4 = SYSTEM::FLOOR(fVar3);
											fVar5 = SYSTEM::TO_FLOAT(iVar4);
											fVar5 = (fVar5 / 10f);
											fLocal_218 = fVar5;
										}
										fLocal_208 = ((1609f * 5f) - Global_113969.f_10052.f_107);
										if (func_134())
										{
											if (fLocal_218 >= 7.95f)
											{
				...
				if (iLocal_214)
				{
					Global_113969.f_10052.f_107 = (Global_113969.f_10052.f_107 + (160.9f - 5f));
					iLocal_214 = 0;
				}
			}
			else
			...
			if (bLocal_211)
			{
				func_10(0.8f, 0.3f, "EPSDES_D0", (fLocal_210 - Global_113969.f_10052.f_107), 1);
...
void func_4()//Position - 0x888
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_8(Global_113969.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_7(PLAYER::PLAYER_PED_ID());
			if (func_6(iVar0) && (!func_5(14) || Global_112917))
			{
...
int func_11(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xA2F
{
	...
	if (iParam5 == 0)
	{
		Global_79172[1 /*14*/] = { func_64(iVar10, iParam1, iParam2, -1) };
		if (!func_63(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_79172[1 /*14*/] = { func_64(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_79172[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_79172[1 /*14*/] = { func_64(iVar10, 14, uVar28[iVar1], -1) };
							func_31(iParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
							func_54(14);
							if (Global_79170 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_21(iVar0), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_21(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_21(iVar0), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
						}
						func_54(iVar0);
						if (Global_79170 == 1)
						{
			...
			{
				Global_79172[1 /*14*/] = { func_64(iVar10, iVar0, func_20(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_79172[1 /*14*/] = { func_64(iVar10, 14, uVar69[iVar1], -1) };
			func_31(iParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
			func_54(14);
			if (Global_79170 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_21(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_21(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_21(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
		}
		if (Global_79170 == 1)
		{
			iVar2 = 0;
...
int func_12(int iParam0, int iParam1, int iParam2)//Position - 0x1240
{
	...
	{
		if (!func_140(iParam0, Global_113969.f_2366.f_539[iVar0 /*65*/].f_64, Global_113969.f_2366.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_79172[1 /*14*/] = { func_64(iParam0, iParam1, iParam2, -1) };
...
int func_19(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1B49
{
	...
	{
		if (!func_140(iParam0, Global_113969.f_2366.f_539[iVar0 /*65*/].f_61, Global_113969.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_54(int iParam0)//Position - 0x79A2
{
	...
	{
		func_62(iParam0, Global_79172[1 /*14*/].f_5, Global_79172[1 /*14*/].f_2, 2, Global_79172[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_79172[1 /*14*/].f_6, 1) && BitTest(Global_79172[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xA702
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_63(int iParam0)//Position - 0xB5A5
{
	if (!BitTest(Global_79172[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_64(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB5ED
{
	func_127();
	if (iParam0 == joaat("Player_Zero"))
	{
...
void func_65(int iParam0, int iParam1)//Position - 0xB63F
{
	switch (iParam0)
	{
		case 0:
...
void func_66(int iParam0)//Position - 0xB72F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_67(&(Global_79172[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_67(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xC969
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_60(func_70(iParam1, uParam0->f_2), Global_79169);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_60(func_69(iParam1, uParam0->f_2), Global_79169);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_60(iVar1, Global_79169);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_68(int iParam0, int iParam1, var uParam2)//Position - 0xCD0A
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_69(int iParam0, int iParam1)//Position - 0xD10F
{
	switch (iParam1)
	{
		case 0:
...
int func_70(int iParam0, int iParam1)//Position - 0xD50A
{
	switch (iParam1)
	{
		case 0:
...
int func_71(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xD905
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_72(int iParam0)//Position - 0xD943
{
	switch (iParam0)
	{
		case -1:
...
void func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDA17
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_67(&(Global_79172[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_67(&(Global_79172[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_67(&(Global_79172[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_67(&(Global_79172[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_74(int iParam0)//Position - 0xDC9D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_75(int iParam0)//Position - 0xDDEA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_76(int iParam0)//Position - 0xE2F7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_77(int iParam0)//Position - 0xE36B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_78(int iParam0)//Position - 0xE3DE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_79(int iParam0)//Position - 0xE4C5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_80(int iParam0)//Position - 0xE807
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_81(int iParam0)//Position - 0xEA0F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_82(int iParam0)//Position - 0xEC2F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_83(int iParam0)//Position - 0xED38
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_84(int iParam0)//Position - 0xF6CA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_85(int iParam0)//Position - 0x10223
{
	if (iParam0 < 136)
	{
		func_87(iParam0);
...
void func_86(int iParam0)//Position - 0x10258
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_87(int iParam0)//Position - 0x10E5C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_88(int iParam0)//Position - 0x11D5C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_89(int iParam0)//Position - 0x11E89
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_90(int iParam0, int iParam1)//Position - 0x11F80
{
	switch (iParam0)
	{
		case 0:
...
void func_91(int iParam0)//Position - 0x12070
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_92(int iParam0)//Position - 0x1353D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_93(int iParam0)//Position - 0x13684
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_94(int iParam0)//Position - 0x13B8E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_95(int iParam0)//Position - 0x141F8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_96(int iParam0)//Position - 0x1426B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_97(int iParam0)//Position - 0x1433B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_98(int iParam0)//Position - 0x14836
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_99(int iParam0)//Position - 0x149C7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(int iParam0)//Position - 0x151B6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_101(int iParam0)//Position - 0x152BF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_102(int iParam0)//Position - 0x161E2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_103(int iParam0)//Position - 0x16E8F
{
	if (iParam0 < 107)
	{
		func_106(iParam0);
...
void func_104(int iParam0)//Position - 0x16ED5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0x17979
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(int iParam0)//Position - 0x18769
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0)//Position - 0x193A8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0x19620
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0, int iParam1)//Position - 0x1975C
{
	switch (iParam0)
	{
		case 0:
...
void func_110(int iParam0)//Position - 0x1984C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0x1A5AA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0x1A719
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0x1AC8A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x1B1B2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0x1B225
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x1B2F5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0x1B7A5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x1BA00
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x1BCC0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0x1BE7B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
int func_140(int iParam0, int iParam1, int iParam2)//Position - 0x1F493
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_79172[1 /*14*/] = { func_64(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_79172[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_140(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_140(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_79172[2 /*14*/] = { func_64(iVar0, 14, iVar4, -1) };
									if (Global_79172[2 /*14*/].f_12 == iVar3)
									{
										if (func_140(iParam0, 14, iVar4))
										{
											if (!func_17(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_79172[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_64(iVar0, iVar2, iVar1, -1) };
						if (!func_17(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_79172[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_79172[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_21(iParam1)) && Global_79172[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_21(iParam1)))
	{
		return 1;
	}
	return 0;
...
{
	Global_113969.f_10052.f_107 = 0f;
	fLocal_218 = 0f;
	fLocal_208 = (1609f * 5f);
}
...
void func_169()//Position - 0x200D3
{
	if (Global_113969.f_10052.f_107 < fLocal_210)
	{
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			...
			fLocal_218 = (Global_113969.f_10052.f_107 / 160.9f);
			fLocal_208 = (1609f * 5f);
			iLocal_209 = 1;
			fLocal_232 = MISC::GET_RANDOM_FLOAT_IN_RANGE(120000f, 240000f);
			iLocal_233 = MISC::GET_GAME_TIMER();
...
void func_177()//Position - 0x204BC
{
	...
	if (Global_113969.f_10052.f_107 >= fLocal_210 || func_175(94) == 1)
	{
		func_132();
		func_184(94, 1);
...
void func_179()//Position - 0x2060E
{
	...
	{
		func_183(13, SYSTEM::FLOOR(Global_113969.f_10197.f_3853));
	}
