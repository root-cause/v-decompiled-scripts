...
void func_1()//Position - 0xD6
{
	...
	if (Global_113648.f_10051.f_107 < fLocal_212)
	{
		if (iLocal_224 == 0)
		{
			if (!func_167(Local_221) && !func_166())
			{
...
int func_11(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xA2F
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_63(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_63(iVar10, 14, uVar69[iVar1], -1) };
			func_31(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_54(14);
			if (Global_78339 == 1)
			{
...
void func_65(int iParam0)//Position - 0xB3BD
{
	...
	switch (iParam0)
	{
		...
		default:
			func_72(iVar10, iParam0, 155, -1);
			return;
			break;
	}
	func_66(&(Global_78341[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_72(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD6A8
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_66(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_66(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_138()//Position - 0x1F003
{
	...
	if (((((((((MISC::ARE_STRINGS_EQUAL(sLocal_239, "DESRT" /* GXT: Grand Senora Desert */) || MISC::ARE_STRINGS_EQUAL(sLocal_239, "SENORA" /* GXT: Senora Fwy */)) || MISC::ARE_STRINGS_EQUAL(sLocal_239, "HARMO" /* GXT: Harmony */)) || MISC::ARE_STRINGS_EQUAL(sLocal_239, "RTRAK" /* GXT: Redwood Lights Track */)) || MISC::ARE_STRINGS_EQUAL(sLocal_239, "SANDY" /* GXT: Sandy Shores */)) || MISC::ARE_STRINGS_EQUAL(sLocal_239, "Zancudo" /* GXT: Zancudo River */)) || MISC::ARE_STRINGS_EQUAL(sLocal_239, "Alamo" /* GXT: Alamo Sea */)) || MISC::ARE_STRINGS_EQUAL(sLocal_239, "Jail" /* GXT: Bolingbroke Penitentiary */)) || MISC::ARE_STRINGS_EQUAL(sLocal_239, "zQ_UAR" /* GXT: Davis Quartz */)) || MISC::ARE_STRINGS_EQUAL(sLocal_239, "COSI" /* GXT: Countryside */))
	{
		return 1;
	}
	return 0;
...
int func_139(int iParam0, int iParam1, int iParam2)//Position - 0x1F0B7
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_139(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_139(iParam0, 14, uVar22[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar32 <= 8)
		{
			if (!func_139(iParam0, 14, uVar33[iVar32]))
			{
				return 0;
			}
			iVar32++;
...
void func_168()//Position - 0x1FCF6
{
	if (Global_113648.f_10051.f_107 < fLocal_212)
	{
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			...
			fLocal_220 = (Global_113648.f_10051.f_107 / 160.9f);
			fLocal_210 = (1609f * 5f);
			iLocal_211 = 1;
			fLocal_234 = MISC::GET_RANDOM_FLOAT_IN_RANGE(120000f, 240000f);
			iLocal_235 = MISC::GET_GAME_TIMER();
