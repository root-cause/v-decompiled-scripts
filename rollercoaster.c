...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_56(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_14(&Local_169, Var1, ENTITY::GET_ENTITY_ROTATION(Local_164.f_9, 2), 50f, Local_169.f_20, Local_169.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
...
float func_3(struct<3> Param0, struct<3> Param1)//Position - 0x7BB
{
...
void func_6()//Position - 0x833
{
	...
	if (Local_192[iLocal_191 /*3*/].f_1 < Local_192[iVar3 /*3*/].f_1)
	{
		fLocal_190 = func_7(fLocal_190, Local_192[iLocal_191 /*3*/].f_1, Local_192[iVar3 /*3*/].f_1);
	}
	else
	{
		fLocal_190 = func_7(fLocal_190, Local_192[iVar3 /*3*/].f_1, Local_192[iLocal_191 /*3*/].f_1);
	}
}
...
void func_9(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, float fParam7, bool bParam8)//Position - 0x9AD
{
	...
	{
		iParam0->f_14 = (iParam0->f_14 + func_7(((((Var6.f_0 - iParam0->f_14) * 0.05f) * fVar5) * fParam7), -3f, 3f));
		iParam0->f_14.f_1 = (iParam0->f_14.f_1 + func_7(((((Var6.f_1 - iParam0->f_14.f_1) * 0.05f) * fVar5) * fParam7), -3f, 3f));
		iParam0->f_14.f_2 = (iParam0->f_14.f_2 + func_7(((((Var6.f_2 - iParam0->f_14.f_2) * 0.05f) * fVar5) * fParam7), -3f, 3f));
	}
	if (iParam0->f_26)
	{
...
void func_12(struct<3> Param0, struct<3> Param1, var uParam2, var uParam3, int iParam4)//Position - 0x102A
{
	struct<3> Var0;
...
void func_13(struct<3> Param0, var uParam1, var uParam2, int iParam3)//Position - 0x104D
{
	float fVar0;
...
void func_14(var uParam0, struct<3> Param1, struct<3> Param2, float fParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, float fParam10, bool bParam11)//Position - 0x10F2
{
	uParam0->f_1 = { Param1 };
	uParam0->f_4 = { Param2 };
	uParam0->f_7 = fParam3;
...
void func_34(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x2B73
{
	func_35(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_35(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x2B9C
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_46(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x329F
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_47(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x3595
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6DFB
{
	...
	else
	{
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_71(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
void func_122(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10A8D
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_71(iParam0));
			if (iVar11 > iVar10)
			{
