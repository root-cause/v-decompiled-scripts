			...
			switch (iLocal_58)
			{
				...
				case 1:
					...
					else if (func_321())
					{
						...
						{
							iLocal_128 = func_310(iLocal_78, 1, 0);
...
void func_37()//Position - 0x1001
{
	if (iLocal_62 == 1)
	{
		func_38(iLocal_78, &uLocal_93, -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
		func_38(iLocal_79, &uLocal_101, -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
		func_38(iLocal_80, &uLocal_109, -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
		func_38(iLocal_81, &uLocal_117, -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
		func_38(iLocal_90[0], &(Local_125[0 /*8*/]), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
		func_38(iLocal_90[1], &(Local_125[1 /*8*/]), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
		func_38(iLocal_91[0], &(Local_126[0 /*8*/]), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
		func_38(iLocal_91[1], &(Local_126[1 /*8*/]), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
	}
}
	...
	if (func_1(PLAYER::PLAYER_PED_ID()) && func_1(iLocal_83))
	{
		switch (iLocal_152)
		{
			case 0:
				...
				if (!func_1(iLocal_92) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
			...
			case 1:
				...
				func_217(0);
				func_216();
				if (((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) && !func_215()) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_169)) && STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_wallet_01")))
				{
					if (iLocal_523 == -1)
					{
					...
					if (!PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_83) || (MISC::GET_GAME_TIMER() - iLocal_523) > 2000)
					{
						...
						{
							case 0:
								func_97(&uLocal_345, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
								func_96(&uLocal_345, "REAR1AU", "REAR1_REM", "REAR1_REM_1", 4, 0, 0);
								break;
							
							case 1:
								func_97(&uLocal_345, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
								func_96(&uLocal_345, "REAR1AU", "REAR1_REF", "REAR1_REF_1", 4, 0, 0);
								break;
							
							case 2:
								func_97(&uLocal_345, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
								func_96(&uLocal_345, "REAR1AU", "REAR1_RET", "REAR1_RET_1", 4, 0, 0);
								break;
						}
						iLocal_152++;
					}
			...
			case 2:
				...
				else
				{
					...
					{
						if ((ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_127, PLAYER::PLAYER_PED_ID()) && iLocal_179 == 0) && func_96(&uLocal_180, "RECHAAU", sVar2, sVar3, 4, 0, 0))
						{
					...
					{
						if (iLocal_179 == 0 && func_96(&uLocal_180, "RECHAAU", sVar2, sVar3, 4, 0, 0))
						{
							iLocal_179 = 1;
						}
			...
			case 3:
				if (iLocal_70 == 0)
				{
					if (!func_215() && func_5(&uLocal_180, "RECHAAU", "RECHA_RESP", 4, 0, 0, 0))
					{
						iLocal_70 = 1;
					}
				}
...
{
	if (func_1(iLocal_83) && !func_91(iLocal_83, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
	{
		func_90(iLocal_83, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PLAYER::PLAYER_PED_ID(), 0f, 2f, 1f), fLocal_132, 1, 1);
		PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_83, false, false);
		TASK::OPEN_SEQUENCE_TASK(&iLocal_136);
		if (func_89(Local_134) || !func_1(iLocal_133))
		{
...
int func_90(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)//Position - 0x316C
{
	bool bVar0;
	float fVar1;
...
void func_99(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x33F2
{
	int iVar0;
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x35C3
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						{
							uVar12 = { func_131(iVar10, uVar11[iVar0]) };
						}
						iVar1 = 0;
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_149(iVar10, 14, uVar12[iVar1], -1) };
	...
	{
		uVar15 = { func_131(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_149(iVar10, 14, uVar15[iVar1], -1) };
			func_121(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_144(14);
			if (Global_78339 == 1)
			{
...
int func_123(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x659D
{
	...
	else
	{
		...
		iVar4 = (iParam1 - func_124(iParam0, func_111(iParam2)));
		if (iVar4 < 0)
		{
			return -1;
		}
		...
		iVar5 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_111(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_128(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6CF9
{
	...
	else
	{
		...
		if (iVar4 != -1)
		{
			return (func_124(iParam0, func_111(iParam2)) + iVar4);
		}
	}
	return -99;
}
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.f_0 != 0 && Var2.f_0 != -1) && Var2.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_136(Var2.f_2)] = Var2.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_136(Var2.f_2)] = func_128(iParam1, Var2.f_0, func_136(Var2.f_2), iVar0);
					}
				}
				else if (Var2.f_1 != -1)
				{
					(*uParam0)[func_136(Var2.f_2)] = Var2.f_1;
				}
			}
			iVar4++;
		}
...
void func_151(int iParam0)//Position - 0xDE55
{
	...
	func_152(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_158(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10182
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_152(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_152(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_111(iParam0));
			if (iVar11 > iVar10)
			{
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_213(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar6 = { func_131(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
...
void func_229()//Position - 0x21D7C
{
	if (func_1(iLocal_83))
	{
		func_237(iLocal_129, &uLocal_524);
		func_235();
		if (func_234(func_17()) < iLocal_149)
		{
			func_2(2);
			func_421();
		}
	...
	if (func_1(iLocal_83))
	{
		...
		switch (iLocal_75)
		{
			case 0:
				if (!PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_83))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 30f, 30f, 30f, false, false, 0) && func_96(&uLocal_180, "RECHAAU", "RECHA_TK", "RECHA_TK_1", 4, 0, 0))
					{
						iLocal_75++;
					}
				}
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 40f, 40f, 40f, false, false, 0) && func_5(&uLocal_180, "RECHAAU", "RECHA_WT", 4, 0, 0, 0))
				{
					iLocal_75++;
				}
				break;
...
{
	if (!PED::IS_PED_FACING_PED(iLocal_83, PLAYER::PLAYER_PED_ID(), 20f) && !func_91(iLocal_83, joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")))
	{
...
void func_238()//Position - 0x221E9
{
	if (iLocal_67 == 0 && func_1(iLocal_83))
	{
		if (iLocal_64 == 1)
		{
			if ((!func_215() && SYSTEM::TIMERA() > 8000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 12f, 12f, 5f, false, false, 0))
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_136);
		...
		else if (SYSTEM::TIMERA() > 1000)
		{
			...
			TASK::TASK_PERFORM_SEQUENCE(iLocal_83, iLocal_136);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_136);
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 12f, 12f, 5f, false, false, 0) && func_5(&uLocal_180, "RECHAAU", "RECHA_SRDN", 4, 0, 0, 0))
			{
				iLocal_64 = 1;
			}
			SYSTEM::SETTIMERA(0);
	...
	if (OBJECT::HAS_PICKUP_BEEN_COLLECTED(iLocal_520))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_83))
		{
			if (!PED::IS_PED_INJURED(iLocal_83))
			{
				...
				{
					func_246();
					iLocal_129 = func_310(iLocal_83, 0, 0);
					func_245(&uLocal_524);
					iLocal_58 = 5;
				}
			}
...
void func_247()//Position - 0x22777
{
	...
	if (iLocal_68 == 1)
	{
		if ((iLocal_148 == 0 && !func_215()) && func_96(&uLocal_180, "RECHAAU", "RECHA_TK", "RECHA_TK_1", 4, 0, 0))
		{
			iLocal_148 = 1;
		}
	...
	else if ((((bLocal_65 == 0 && OBJECT::DOES_PICKUP_EXIST(iLocal_520)) && func_1(iLocal_83)) && ENTITY::IS_ENTITY_AT_COORD(iLocal_83, OBJECT::GET_PICKUP_COORDS(iLocal_520), 15f, 15f, 2f, false, true, 0)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_83, sLocal_515, sLocal_516, 3))
	{
		...
		{
			iLocal_67 = 1;
			if (!func_91(iLocal_83, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_136);
...
void func_249()//Position - 0x229B8
{
	...
	else if (func_298())
	{
		...
		func_246();
		iLocal_130 = func_295(iLocal_520);
	...
	else
	{
		if (func_1(iLocal_78))
		{
			func_267(&uLocal_21, iLocal_78, 0, 0, 1, 1, 1);
		}
		func_256();
		if (iLocal_143 == 0)
		{
			if (!func_215() && func_5(&uLocal_180, "RECHAAU", "RECHA_HLP", 4, 0, 0, 0))
			{
				SYSTEM::SETTIMERA(0);
				iLocal_143 = 1;
			}
		...
		{
			func_255(iLocal_128, iLocal_78, fLocal_522, 1061158912, 0);
			if (((((iLocal_69 == 0 && func_1(PLAYER::PLAYER_PED_ID())) && !func_215()) && func_1(iLocal_86)) && func_254(PLAYER::PLAYER_PED_ID(), iLocal_86, 1) < 30f) && func_5(&uLocal_180, "RECHAAU", "RECHA_SPOT", 4, 0, 0, 0))
			{
				iLocal_69 = 1;
			}
		}
...
{
	if ((func_1(iLocal_83) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_83, sLocal_515, sLocal_516, 3)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_83, joaat("SCRIPT_TASK_COWER")) == 7)
	{
...
void func_251()//Position - 0x22B5D
{
	if (func_1(iLocal_83))
	{
		...
		{
			case 0:
				if (((iLocal_147 == 0 && !func_215()) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 40f, 40f, 40f, false, false, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_GET", 4, 0, 0, 0))
				{
					iLocal_147 = 1;
				}
				...
				{
					func_239(iLocal_83, "GENERIC_CURSE_MED", 24);
					func_223(1);
			...
			case 1:
				if (((!func_215() && (MISC::GET_GAME_TIMER() - iLocal_74) > 1000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 20f, 20f, 20f, false, false, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_PCA", 4, 0, 0, 0))
				{
					iLocal_74 = MISC::GET_GAME_TIMER();
					iLocal_162 = 2;
					iLocal_73++;
			...
			case 2:
				if (((!func_215() && (MISC::GET_GAME_TIMER() - iLocal_74) > 5000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 20f, 20f, 20f, false, false, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_PCB", 4, 0, 0, 0))
				{
					iLocal_74 = MISC::GET_GAME_TIMER();
					iLocal_162 = 3;
					iLocal_73++;
			...
			case 3:
				if (((!func_215() && (MISC::GET_GAME_TIMER() - iLocal_74) > 6000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 20f, 20f, 20f, false, false, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_PCC", 4, 0, 0, 0))
				{
					iLocal_74 = MISC::GET_GAME_TIMER();
					iLocal_162 = 4;
					iLocal_73++;
			...
			case 4:
				if (((!func_215() && (MISC::GET_GAME_TIMER() - iLocal_74) > 6000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 15f, 15f, 15f, false, false, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_PCD", 4, 0, 0, 0))
				{
					iLocal_162 = 5;
					iLocal_73++;
				}
			...
			case 6:
				if (!func_215() && func_5(&uLocal_180, "RECHAAU", "RECHA_SRP", 4, 0, 0, 0))
				{
					iLocal_73++;
				}
				break;
			...
			case 7:
				if (!func_215() && func_5(&uLocal_180, "RECHAAU", "RECHA_GO", 4, 0, 0, 0))
				{
					func_223(0);
					iLocal_73 = 100;
				}
			...
			case 8:
				iLocal_142 = 1;
				if (!func_215() && func_5(&uLocal_180, "RECHAAU", "RECHA_INT", 4, 0, 0, 0))
				{
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_83, PLAYER::PLAYER_PED_ID(), 0);
					iLocal_73++;
				}
			...
			case 9:
				if (!func_215() && func_5(&uLocal_180, "RECHAAU", "RECHA_RES", 4, 0, 0, 0))
				{
					iLocal_74 = MISC::GET_GAME_TIMER();
...
void func_256()//Position - 0x2319D
{
	...
	{
		case 0:
			if ((func_1(iLocal_78) && func_1(iLocal_79)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_86, false))
			{
		...
		case 3:
			...
			if (((((((iLocal_71 < 4 && (MISC::GET_GAME_TIMER() - iLocal_72) > 10000) && func_1(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) && !func_215()) && !PED::IS_PED_INJURED(iLocal_78)) && func_254(PLAYER::PLAYER_PED_ID(), iLocal_78, 1) < 40f) && func_5(&uLocal_180, "RECHAAU", "RECHA_YELL", 4, 0, 0, 0))
			{
				iLocal_71++;
				iLocal_72 = MISC::GET_GAME_TIMER();
			}
...
{
	if (((((((iLocal_141 == 1 && (MISC::GET_GAME_TIMER() - iLocal_76) > 8000) && !func_215()) && func_1(iLocal_78)) && func_1(iLocal_83)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_78, 20f, 20f, 20f, false, true, 0)) && !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_78, iLocal_83, 30f, 30f, 30f, false, true, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_taunt", 4, 0, 0, 0))
	{
		iLocal_76 = MISC::GET_GAME_TIMER();
	}
}
...
void func_258()//Position - 0x2345D
{
	if (iLocal_62 == 0)
	{
		...
		if (PED::IS_PED_INJURED(iLocal_78) && !PED::IS_PED_INJURED(iLocal_79))
		{
			func_239(iLocal_79, "GENERIC_FUCK_YOU", 24);
		}
		func_259();
	}
}
...
int func_261()//Position - 0x23642
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_89[0], false) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_89[1], false))
	{
		...
		{
			func_239(iLocal_90[0], "GENERIC_FUCK_YOU", 24);
...
void func_265()//Position - 0x23A7F
{
	if (iLocal_62 == 0)
	{
		if ((func_1(iLocal_78) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_78, false)) && !PED::IS_PED_IN_COMBAT(iLocal_78, 0))
		{
			TASK::TASK_DRIVE_BY(iLocal_78, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 100f, 60, false, joaat("FIRING_PATTERN_BURST_FIRE_DRIVEBY"));
		}
		if ((((func_1(iLocal_79) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_79, false)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_79, joaat("SCRIPT_TASK_VEHICLE_MISSION")) == 1) && !TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(iLocal_79)) && !PED::IS_PED_IN_COMBAT(iLocal_79, 0))
		{
			TASK::TASK_DRIVE_BY(iLocal_79, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 30f, 60, true, joaat("FIRING_PATTERN_BURST_FIRE_DRIVEBY"));
			TASK::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_79, 40f);
		}
		if ((func_1(iLocal_80) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_80, false)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_80, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) == 7)
		{
			TASK::TASK_DRIVE_BY(iLocal_80, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 100f, 60, false, joaat("FIRING_PATTERN_BURST_FIRE_DRIVEBY"));
		}
		if ((func_1(iLocal_81) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_81, false)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_81, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) == 7)
		{
...
void func_268(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x23C1D
{
	...
	uParam0->f_6 = 2;
	func_269(uParam0, iParam1, Param2, sParam3, iParam4, bParam5, uParam6, bParam7);
}

void func_269(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x23C55
{
	int iVar0;
	int iVar1;
	...
	if (func_292(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		...
		{
			if (func_287(uParam0, bParam5, bParam7, 0))
			{
				func_283(uParam0, iParam1, Param2, iParam4);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
void func_283(var uParam0, int iParam1, struct<3> Param2, int iParam3)//Position - 0x245DE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_286(struct<3> Param0, struct<3> Param1, bool bParam2)//Position - 0x2471D
{
	if (bParam2)
	{
...
void func_303()//Position - 0x24F67
{
	...
	else
	{
		...
		if (func_1(iLocal_83))
		{
			if ((!func_215() && func_5(&uLocal_180, "RECHAAU", "RECHA_STO", 4, 0, 0, 0)) || func_254(PLAYER::PLAYER_PED_ID(), iLocal_83, 1) < 20f)
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_136);
...
void func_306()//Position - 0x25242
{
	...
	else
	{
		if (HUD::DOES_BLIP_EXIST(iLocal_128))
		{
			...
			func_307(iLocal_128, &uLocal_140);
		}
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_86, false))
		{
...
void func_325(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0x26EB9
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
void func_335()//Position - 0x277EE
{
	...
	if (func_17() == 0)
	{
		func_97(&uLocal_180, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		iLocal_69 = 1;
		iLocal_71 = 9;
		iLocal_70 = 1;
	}
	if (func_17() == 1)
	{
		func_97(&uLocal_180, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		iLocal_69 = 1;
		iLocal_71 = 9;
		iLocal_70 = 1;
	}
	if (func_17() == 2)
	{
		func_97(&uLocal_180, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		iLocal_69 = 0;
		iLocal_71 = 0;
		iLocal_70 = 0;
	}
	func_97(&uLocal_180, 3, iLocal_83, "ChaseWorker", 0, 1);
	func_97(&uLocal_180, 4, iLocal_78, "ChaseThief", 0, 1);
	if (bLocal_153 == 2)
	{
	}
	else
...
int func_337()//Position - 0x27DF1
{
	...
	func_343(&Local_526, iLocal_164);
	func_343(&Local_526, iLocal_165);
	func_343(&Local_526, iLocal_166);
	func_343(&Local_526, iLocal_167);
	func_343(&Local_526, iLocal_168);
	func_342(&Local_526, 2);
	if ((((STREAMING::HAS_ANIM_DICT_LOADED(sLocal_512) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_515)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_518)) && VEHICLE::HAS_VEHICLE_ASSET_LOADED(iLocal_166)) && func_338(&Local_526))
	{
		return 1;
	}
	return 0;
...
int func_359(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x289B8
{
	...
	if (!bVar0)
	{
		...
		if (func_19(func_17()))
		{
			if (!func_394(iParam1, bParam2, 145))
			{
				return 0;
			}
		}
		if (!func_393(Global_113648.f_24997.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (func_353(iParam1, bParam2) && !bParam3)
		{
			return 0;
		}
		...
		if ((iParam1 == 9 && (bParam2 == 2 || bParam2 == 5)) && !func_353(0, 0))
		{
			return 0;
		}
		if (Global_32310)
...
void func_401()//Position - 0x2A0DA
{
	...
	if (func_1(iLocal_83))
	{
		...
		if (((iLocal_152 == 0 && iLocal_68 == 0) && !func_91(iLocal_83, joaat("SCRIPT_TASK_SMART_FLEE_PED"))) && !PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_83))
		{
	...
	func_309(0);
	func_420(&uLocal_180, 0);
	func_420(&uLocal_180, 1);
	func_420(&uLocal_180, 2);
	func_420(&uLocal_180, 3);
	func_420(&uLocal_180, 4);
	func_246();
	func_230();
	func_260(&iLocal_86);
	func_260(&iLocal_133);
	func_260(&iLocal_92);
	func_232(&iLocal_83, 1, 0, 1);
	func_87(&iLocal_127);
	if (iLocal_511 != 0)
	{
		EVENT::REMOVE_SHOCKING_EVENT(iLocal_511);
