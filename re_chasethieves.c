	...
	else
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(joaat("hexer")))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (VEHICLE::_0xA4822F1CF23F4810(&Var2, &Var0, &Var1, 0, 1127481344, 75f, 0, 1, 1))
				{
					iLocal_138 = 0;
					while (iLocal_138 < 2)
					{
...
int func_273(char* sParam0)//Position - 0x24101
{
	if (!func_274(1, 1, 0))
	{
		if ((!MISC::IS_STRING_NULL_OR_EMPTY(sParam0) && func_227(sParam0)) || func_227("CMN_HINT"))
		{
			HUD::CLEAR_HELP(true);
		}
		return 0;
...
void func_422(int iParam0, int iParam1)//Position - 0x2ACA8
{
	...
	if (iParam1 <= func_404(iParam0))
	{
		...
		if (!func_432(51))
		{
			func_429("RE_REWARD", 1, 0, 4000, 10000, func_329(), 0, 138, 0);
			func_428(51);
		}
		if (func_314(iParam0))
		{
