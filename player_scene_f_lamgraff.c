...
int func_2()//Position - 0x12B
{
	...
	if (!PED::IS_PED_INJURED(Global_101409))
	{
		...
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_101409, &sLocal_244, &cLocal_276, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_101409))
				{
					TASK::STOP_ANIM_PLAYBACK(Global_101409, 0, false);
					TASK::CLEAR_PED_TASKS(Global_101409);
					return 0;
				}
				fVar0 = PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_292);
				if (!iLocal_237)
				{
					if (func_3(&uLocal_71, "PRSAUD", "FRAS_IG_7x", 3, 0, 0, 0))
					{
						iLocal_237 = 1;
					}
				}
				...
				else if (fVar0 < 0.4778f)
				{
					if (iLocal_293 == 0)
					{
						iLocal_293 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_lamgraff_paint_spray", iLocal_238, 0f, 0f, 0f, 0f, 0f, 0f, 1f, false, false, false);
...
int func_26()//Position - 0xB81
{
	...
	if (!PED::IS_PED_INJURED(Global_101409))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_238))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_101409, &sLocal_244, &cLocal_260, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_101409))
				{
					TASK::STOP_ANIM_PLAYBACK(Global_101409, 0, false);
				...
				else
				{
					...
					{
						iLocal_292 = PED::CREATE_SYNCHRONIZED_SCENE(Local_240, 0f, 0f, fLocal_243, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_292, true);
					}
					TASK::TASK_SYNCHRONIZED_SCENE(Global_101409, iLocal_292, &sLocal_244, &cLocal_276, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
			{
				...
				{
					TASK::CLEAR_PED_TASKS(Global_101409);
					PED::CLEAR_RAGDOLL_BLOCKING_FLAGS(Global_101409, 16);
					if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_292))
					{
						iLocal_292 = PED::CREATE_SYNCHRONIZED_SCENE(Local_240, 0f, 0f, fLocal_243, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_292, true);
...
{
	STREAMING::REQUEST_MODEL(iLocal_239);
	STREAMING::REQUEST_PTFX_ASSET();
	while (!ENTITY::DOES_ENTITY_EXIST(Global_101409) || !STREAMING::HAS_MODEL_LOADED(iLocal_239))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_101409))
	{
		if (!PED::IS_PED_INJURED(Global_101409))
		{
			TASK::TASK_STAND_STILL(Global_101409, -1);
		}
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_101409, joaat("PLAYER"));
	}
	ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_101409, true, true);
	PED::SET_PED_CONFIG_FLAG(Global_101409, 132, true);
	PED::SET_RAGDOLL_BLOCKING_FLAGS(Global_101409, 16);
	func_39(&Global_101409, Global_96667);
	func_38(&uLocal_71, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	iLocal_238 = OBJECT::CREATE_OBJECT(iLocal_239, ENTITY::GET_ENTITY_COORDS(Global_101409, true), true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_238, Global_101409, PED::GET_PED_BONE_INDEX(Global_101409, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
}
...
void func_40()//Position - 0x1163
{
	...
	func_46(iLocal_70, &Local_240, &fLocal_243, &cVar0);
	...
	func_43(Var8, &Var117);
	func_41(iLocal_70, &sLocal_244, &cVar237, &cLocal_260, &uVar253, &uVar254);
	StringCopy(&cLocal_276, "Lamar_tagging_EXIT_LOOP_LAMAR", 64);
}
...
int func_43(struct<109> Param0, var uParam109)//Position - 0x198A
{
	uParam109->f_119 = 0;
	switch (Param0.f_2)
	{
...
void func_44(var uParam0, int iParam1, int iParam2, int iParam3, struct<3> Param4, float fParam7)//Position - 0x4D08
{
...
bool func_48(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x4FFB
{
	if (bParam6)
	{
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114135.f_2367.f_539.f_2310[0];
			StringCopy(sParam2, func_53(Global_114135.f_2367.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_114135.f_2367.f_539.f_2310[1];
			StringCopy(sParam2, func_53(Global_114135.f_2367.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_114135.f_2367.f_539.f_2310[2];
			StringCopy(sParam2, func_53(Global_114135.f_2367.f_539.f_2314[2]), 32);
			return 1;
			break;
