...
float func_86(struct<3> Param0, struct<3> Param1)//Position - 0x2EF0
{
...
void func_104()//Position - 0x31C5
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_208, false))
	{
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_208, "MAG_2_RAGE_PED_GROUP", 0f);
	}
}
...
void func_105()//Position - 0x31E3
{
	...
	iLocal_218 = 15;
	iLocal_219 = 6;
	sLocal_226 = "PBSH_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to Impotent Rage. */;
